...
const AMENDMENT_DOCS = {
  ...
  DisallowIncoming:     { purpose:'Block unsolicited ledger-object creation',           intro:'rippled 1.10',  desc:'New account flags let you individually block incoming trustlines, Check objects, NFToken offers, and Payment Channels.',                        impact:'Four new AccountSet flags; existing incoming objects are unaffected.' },
