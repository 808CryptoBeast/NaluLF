 ...
 * nalulf_activity_log localStorage key the legacy page writes to) plus a
 * redirect card into Inspector for full on-chain forensic history.
 */
export function ActivityPanel({ activeWalletLabel, activeWalletAddress }: Props) {
