import{a as qr,b as Co,c as Pn,d as It,e as x,f as Xe,g as y,h as He,i as _,j as z,k as Q,l as Z,m as vt,n as ge,o as ne,p as he,q as Wt,r as X,s as ga,v as Ee,w as Vr}from"./chunk-R7KFE7J7.js";function Mn(e){Pn.includes(e)||(e="gold"),X.currentTheme=e,Pn.forEach(t=>document.body.classList.remove(`theme-${t}`)),document.body.classList.add(`theme-${e}`),Z(Co,e)}function Po(){let e=Pn.indexOf(X.currentTheme);Mn(Pn[(e+1)%Pn.length])}function Gr(){let e=Q(Co);Mn(Pn.includes(e)?e:"gold")}var Kr={landing:"landing-page",dashboard:"dashboard",inspector:"inspector",profile:"dashboard"};function Mo(e){document.body.classList.remove("modal-open"),Object.values(Kr).forEach(i=>document.body.classList.remove(i)),document.body.classList.add(Kr[e]||"dashboard");let t=x("landing"),n=x("dashboard"),s=x("profile-page");t&&(t.style.display=e==="landing"?"":"none"),n&&(n.style.display=e==="dashboard"?"":"none"),s&&(s.style.display=e==="profile"?"":"none");let a=e==="landing",o={landingActions:x("navbar-landing-actions"),dashActions:x("navbar-dash-actions"),navConn:x("navbar-conn"),cmdkHint:x("cmdk-hint"),helpBtn:x("help-trigger")};o.landingActions&&(o.landingActions.style.display=a?"":"none"),o.dashActions&&(o.dashActions.style.display=a?"none":""),o.navConn&&(o.navConn.style.display=a?"none":""),o.cmdkHint&&(o.cmdkHint.style.display=a?"none":""),o.helpBtn&&(o.helpBtn.style.display=a?"none":""),X.currentPage=e,window.scrollTo({top:0,behavior:"smooth"}),window.dispatchEvent(new CustomEvent("naluxrp:pagechange",{detail:{pageId:e}}))}function Ln(){Mo("landing")}function An(){Mo("dashboard")}function Lo(){Mo("profile")}function En(e,t){Xe(".dash-tab").forEach(n=>{n.classList.toggle("active",n===e),n.setAttribute("aria-selected",String(n===e))}),["stream","inspector","network"].forEach(n=>{let s=x(`tab-${n}`);s&&(s.style.display=n===t?"":"none")}),t==="inspector"?(document.body.classList.remove("dashboard"),document.body.classList.add("inspector")):(document.body.classList.remove("inspector"),document.body.classList.add("dashboard")),X.currentTab=t,window.dispatchEvent(new CustomEvent("naluxrp:tabchange",{detail:{tabId:t}}))}var Yr="naluxrp_tour_seen",rn=[{title:"Welcome to NaluLF \u{1F30A}",body:"A 20-second tour of the three things people miss most. Skip anytime."},{selector:"#cmdk-hint",title:"Jump anywhere, instantly",body:"Press <kbd>Ctrl</kbd>+<kbd>K</kbd> (or <kbd>/</kbd>) from any page. Paste an address in and it offers to inspect it directly \u2014 no need to navigate first."},{selector:"#dash-tab-inspector",title:"Inspect any wallet",body:"Full forensic suite \u2014 trust lines, fund flow, convergence signals, AI-assisted explanations \u2014 for any XRPL address, not just your own."},{selector:".user-chip",title:"Your Profile has more than wallets",body:"Portfolio analytics, activity history, and Project Intelligence \u2014 liquidity depth, holder concentration, and issuer-risk scoring for any token \u2014 all live there."}],at=0,Eo=!1,Ms=null,Ft=null;function Qr(){Q(Yr)||setTimeout(No,700)}function No(){Eo||(Eo=!0,at=0,Vm(),Ro())}function Vm(){if(x("tourOverlay"))return;let e=document.createElement("div");e.id="tourOverlay",e.className="tour-overlay",e.innerHTML='<div class="tour-card" id="tour-card"></div>',document.body.appendChild(e),e.addEventListener("click",t=>{t.target===e&&va()})}function Ao(e){if(!e)return null;let t=document.querySelector(e);if(!t)return null;let n=t.getBoundingClientRect();return n.width>0||n.height>0?t:null}function Zr(){Ms==null||Ms.classList.remove("tour-highlight"),Ms=null}function Ro(){for(;at<rn.length&&rn[at].selector&&!Ao(rn[at].selector);)at++;if(at>=rn.length)return _o();let e=rn[at],t=x("tourOverlay"),n=x("tour-card");t.classList.add("show"),Zr();let s=Ao(e.selector);s&&(s.scrollIntoView({block:"center",behavior:"smooth"}),s.classList.add("tour-highlight"),Ms=s),n.innerHTML=`
    ...
    </div>`}function U(){var h,b;let e=document.querySelector("#profile-page .profile-wrap");if(!e)return;let t=document.getElementById("xpd-tv-widget"),n=!!(t&&ee.chart);t&&t.remove();let s=document.getElementById("xpd-chart-atmosphere"),a=!!(s&&Je.renderer);s&&s.remove();let o=Nt(),i=(o==null?void 0:o.address)||"",r=Hf(),l=localStorage.getItem(mn),c=oe.some(w=>!w.watchOnly),d=Q(ti)==="1",u=(h=et[i])==null?void 0:h.xrp,p=Object.values(et).reduce((w,k)=>w+((k==null?void 0:k.xrp)||0),0),m=(b=Te.data)!=null&&b.priceUsd?p*Te.data.priceUsd:0,f=On.map(w=>`<option value="${y(w.id)}" ${M.pair===w.id?"selected":""}>${y(w.label)}</option>`).join(""),g=On.map(w=>`<option value="${y(w.id)}" ${M.comparePair===w.id?"selected":""}>${y(w.label)}</option>`).join(""),v=ac.map(w=>`<option value="${y(w.value)}" ${M.interval===w.value?"selected":""}>${y(w.label)}</option>`).join("");if(e.innerHTML=`
    ...
    </div>`,n){let w=document.getElementById("xpd-tv-widget");w&&w.replaceWith(t)}if(a){let w=document.getElementById("xpd-chart-atmosphere");w&&w.replaceWith(s)}Jh(),mg(),fg(),Si(),Xs()}function Hf(){let e=String(X.currentNetwork||"").toLowerCase();return e.includes("testnet")?{label:"XRPL Testnet",kind:"testnet"}:e.includes("mainnet")?{label:"XRPL Mainnet",kind:"mainnet"}:e.includes("xahau")?{label:"Xahau Network",kind:"xahau"}:{label:`Network: ${y(X.currentNetwork||"Unknown")}`,kind:"unknown"}}function zf(){let e=String(M.indicatorQuery||"").trim().toLowerCase(),t=[{key:"trend",label:"Trend",icon:"\u{1F4C8}"},{key:"momentum",label:"Momentum",icon:"\u26A1"},{key:"volume",label:"Volume",icon:"\u{1F4CA}"},{key:"volatility",label:"Volatility",icon:"\u{1F32A}\uFE0F"},{key:"advanced",label:"Custom",icon:"\u{1F9E0}"}];return`
    <div class="xpd-indicator-menu-wrap">
      ...
      ${M.indicatorMenuOpen?`
        <div class="xpd-indicator-menu" role="menu" aria-label="Indicator menu">
          ...
          ${t.map(n=>{let s=(Af[n.key]||[]).filter(a=>{var i;return e?(((i=Vt[a])==null?void 0:i.name)||a).toLowerCase().includes(e):!0});return s.length?`
    ...
    <div class="xpd-indicator-row">
      ${s.length?s.map(f=>{var g,v;return`<div class="xpd-indicator-chip-wrap"><div class="xpd-indicator-chip" title="${y(((g=Vt[f])==null?void 0:g.what)||"")}"><span>${y(((v=Vt[f])==null?void 0:v.name)||f)}</span><button class="xpd-mini-btn" onclick="event.stopPropagation(); openIndicatorSettings('${f}')">\u2699</button><button class="xpd-mini-btn" onclick="removeIndicator('${f}')">\u2715</button></div>${Yh(f)}</div>`}).join(""):'<span class="xpd-empty">No indicators enabled. Use + Indicator.</span>'}
    </div>
    ...
    <p class="xpd-note">Professional chart controls: wheel zoom, hold-and-drag pan, horizontal price-line marking, and token-focused context ribbons for faster execution decisions.</p>`}function Wf(){let e=M.selectedIndicator||"sma20",t=Vt[e]||Vt.sma20,n=Ef[e]||null,s=M.educationCollapsed;return`
    ...
    <div class="xpd-token-strip">
      ${Lf.map(n=>`<div class="xpd-token-pill" title="${y(`${n.symbol} ${n.name}`)}"><span class="sym xpd-pill-text">${n.symbol}</span><span class="xpd-pill-text">${y(n.name)}</span><span class="cap xpd-pill-text">${n.marketCap}</span></div>`).join("")}
    </div>
    <p class="xpd-note">Top XRPL token cards are static examples when direct DEX market-cap feeds are unavailable.</p>`}function qf(e){return e?bt.loading?'<div class="xpd-loading">Loading account NFTs...</div>':bt.error?`<div class="xpd-error">${y(bt.error)}</div>`:bt.items.length?`<div class="xpd-nft-grid">${bt.items.map(Vf).join("")}</div>`:'<div class="xpd-empty">No NFTs found for this wallet.</div>':'<div class="xpd-empty">Select or create a wallet to load NFTs.</div>'}function Vf(e){let t=`${e.id.slice(0,12)}...${e.id.slice(-10)}`;return`<article class="xpd-nft-card">
        ...
        <div class="xpd-token-list">${a.map(c=>{let d=Ve(c),u=Ls(d),p=String(e||"").trim();return`
          <div class="xpd-token-row xpd-token-row--clickable" title="${y(`${c.symbol} ${c.name}`)}" onclick="openTokenOnChart(decodeURIComponent('${u}'))">
            <div class="xpd-token-main">
              <strong>${Fl(c.symbol,p)}</strong>
              <span>${Fl(c.name,p)}</span>
    ...
    </div>`}function uc(){let e=document.getElementById("xpd-lookup-currency");if(!e){he("Token Discovery hasn't loaded yet \u2014 give it a moment and try again.");return}e.scrollIntoView({behavior:"smooth",block:"center"}),setTimeout(()=>e.focus(),350)}async function wi(e){let t=String(e||"").trim();if(!t)return;let n=t.includes("|")?W.tokens.find(s=>Ve(s)===t):W.tokens.find(s=>String(s.symbol||"").toUpperCase()===t.toUpperCase());if(!(n!=null&&n.issuer)){he("Project Intelligence needs a token with a known issuer.");return}ze={loading:!0,error:"",data:null,tokenKey:Ve(n),expandedSubScore:"",graphView:"list"},U(),setTimeout(()=>{var s;return(s=document.getElementById("xpd-project-intel-section"))==null?void 0:s.scrollIntoView({behavior:"smooth",block:"start"})},30);try{ze={loading:!1,error:"",data:await Cl(n),tokenKey:Ve(n),expandedSubScore:"",graphView:"list"}}catch(s){ze={loading:!1,error:(s==null?void 0:s.message)||"Could not load project intelligence.",data:null,tokenKey:Ve(n),expandedSubScore:"",graphView:"list"}}U()}function mc(e){ze.expandedSubScore=ze.expandedSubScore===e?"":e,U()}var Yf=768;function fc(){return window.innerWidth>=Yf}function hc(e){e==="graph"&&!fc()||(ze.graphView=e==="graph"?"graph":"list",U())}function gc(){ze={loading:!1,error:"",data:null,tokenKey:"",expandedSubScore:"",graphView:"list"},U()}var vc={liquidity:{label:"Liquidity",icon:"\u{1F4A7}"},distribution:{label:"Distribution",icon:"\u{1F9EE}"},marketQuality:{label:"Market Quality",icon:"\u{1F4CA}"},lpStability:{label:"LP Stability",icon:"\u{1F3E6}"},issuerRisk:{label:"Issuer Risk",icon:"\u{1F6E1}"}};function Jo(e){return e>=75?"#50fa7b":e>=50?"#f1fa8c":e>=25?"#ffb86c":"#ff5555"}function bc(e){return e>=75?"STRONG":e>=50?"MODERATE":e>=25?"WEAK":"VERY WEAK"}function Qf(){if(ze.loading)return`<div class="xpd-section-head"><h2>\u{1F52C} Project Intelligence</h2></div>
    ...
    <div class="pi-cards-grid">
      ...
      ${eh(e.issuerRisk)}
    </div>`}function Da(e){return e.replace(/([A-Z])/g," $1").replace(/^./,t=>t.toUpperCase()).trim()}function yc(e){return e==null?"\u2014":typeof e=="boolean"?e?"Yes":"No":typeof e=="number"?Number.isInteger(e)?String(e):_(e,2):String(e)}function Zf(e){var i;let t=e.amm,n=e.orderBook,s=t!=null&&t.exists?`
  ...
  `:'<div class="inspect-empty-note">No live order book found for this pair.</div>';return`
    ...
    ${n?ih(e):sh(e)}`}function sh(e){let t=new Map(e.nodes.map(u=>[u.id,u])),n=u=>e.edges.filter(p=>p.from===u||p.to===u),s=u=>{let p=ai[u.type]||{icon:"\u2022",color:"rgba(255,255,255,0.3)"},m=n(u.id).map(f=>`<div class="pig-fact"><span class="pig-fact-badge">PROVEN</span>${y(f.factLabel)}</div>`).join("");return`
      <div class="pig-node" style="border-left-color:${p.color}">
        <div class="pig-node-hdr">
          ...
          ${u.address?`<a href="https://xrpscan.com/account/${y(u.address)}" target="_blank" rel="noopener" class="mono pig-node-addr">${y(th(u.address))}</a>`:""}
        </div>
        ${m}
    ...
    <div class="pig-list">
    ...
    </div>`}var wc={token:0,issuer:0,amm:1,auction:1,vote:1,whale:2,lp:2},xc=[20,270,520],Yo=220,Pa=34,kc=46;function ah(e,t){return e.length>t?e.slice(0,t-1)+"\u2026":e}function oh(e){let t=[[],[],[]];e.nodes.forEach(s=>{s.type!=="project"&&t[wc[s.type]??1].push(s)});let n=[];return t.forEach((s,a)=>s.forEach((o,i)=>n.push({...o,x:xc[a],y:16+i*kc}))),n}function ih(e){let t=oh(e),n=new Map(t.map(c=>[c.id,c])),s=[0,1,2].map(c=>t.filter(d=>(wc[d.type]??1)===c).length),a=xc[2]+Yo+20,o=32+Math.max(1,...s)*kc,i=e.edges.map(c=>{let d=n.get(c.from),u=n.get(c.to);if(!d||!u)return"";let p=d.x+Yo,m=d.y+Pa/2,f=u.x,g=u.y+Pa/2,v=(p+f)/2;return`<path d="M${p},${m} C${v},${m} ${v},${g} ${f},${g}" stroke="rgba(255,255,255,0.25)" stroke-width="1.5" fill="none"/>`}).join(""),r=t.map(c=>{let d=ai[c.type]||{icon:"\u2022",color:"rgba(255,255,255,0.3)"},u=`${d.icon} ${c.label}`;return`
      <g class="pig-svg-node">
        ...
        <text x="${c.x+10}" y="${c.y+Pa/2+4}" font-size="11" fill="#fff">${y(ah(u,26))}</text>
    ...
    <div class="pig-svg-legend">${l}</div>`}function $c(){let e=ze.data;e&&Ha(rh(e))}function Dl(e,t){if(!(e!=null&&e.length))return"";let n=e.map(s=>`    ${s.pct}% impact: ${_(s.xrpAtOffer,1)} XRP / ${qe(s.tokenAtOffer)} tokens${s.bookExhausted?" (book exhausted before this level \u2014 real depth may be less than shown)":""}`).join(`
`);return`  ${t}:
...
`)}function Fl(e,t){let n=String(e||""),s=String(t||"").trim();if(!s)return y(n);let a=n.toLowerCase().indexOf(s.toLowerCase());if(a<0)return y(n);let o=y(n.slice(0,a)),i=y(n.slice(a,a+s.length)),r=y(n.slice(a+s.length));return`${o}<mark class="xpd-hit">${i}</mark>${r}`}function lh(e){var a,o;let t=Object.values(et).reduce((i,r)=>i+((r==null?void 0:r.xrp)||0),0),n=(a=Te.data)!=null&&a.priceUsd?t*Te.data.priceUsd:0,s=Mt.items.slice(0,8);return`
    ...
    </div>`}function ch(e){return e?yt.loading?'<div class="xpd-amm-card"><h3>Your liquidity positions</h3><div class="xpd-loading">Loading account_objects and LP balances...</div></div>':yt.error?`<div class="xpd-amm-card"><h3>Your liquidity positions</h3><div class="xpd-error">${y(yt.error)}</div></div>`:yt.pools.length?`<div class="xpd-amm-card"><h3>Your liquidity positions</h3><div class="xpd-pool-list">${yt.pools.map(t=>`
    ...
    </div>`).join("")}</div></div>`:'<div class="xpd-amm-card"><h3>Your liquidity positions</h3><div class="xpd-empty">No AMM entries or LP-token balances detected for this wallet yet.</div></div>':'<div class="xpd-amm-card"><h3>Your liquidity positions</h3><div class="xpd-empty">No active wallet.</div></div>'}function dh(){return Lt.loading?'<div class="xpd-amm-card"><h3>General pool explorer</h3><div class="xpd-loading">Loading amm_info for known pools...</div></div>':Lt.error?`<div class="xpd-amm-card"><h3>General pool explorer</h3><div class="xpd-error">${y(Lt.error)}</div></div>`:Lt.pools.length?`<div class="xpd-amm-card"><h3>General pool explorer</h3><div class="xpd-pool-list">${Lt.pools.map(e=>`
    <div class="xpd-pool-item">
    ...
    </div>`).join("")}</div></div>`:'<div class="xpd-amm-card"><h3>General pool explorer</h3><div class="xpd-empty">No seeded pools returned on this network.</div></div>'}function ph(){return`<div class="xpd-amm-card">
  ...
  </div>`}function qe(e){return Number.isFinite(Number(e))?new Intl.NumberFormat("en-US",{notation:"compact",maximumFractionDigits:2}).format(Number(e)):"\u2014"}function as(e){return typeof e=="string"?`${_(Number(e)/1e6,4)} XRP`:e&&typeof e=="object"?`${_(Number(e.value||0),4)} ${e.currency||"UNK"}`:"\u2014"}function uh(e){if(!e||typeof e!="string")return"";try{let t=e.trim();if(!/^[0-9A-Fa-f]+$/.test(t)||t.length%2!==0)return t;let n=new Uint8Array(t.length/2);for(let s=0;s<t.length;s+=2)n[s/2]=parseInt(t.slice(s,s+2),16);return new TextDecoder().decode(n)}catch{return""}}function Ol(e){return e?e.startsWith("ipfs://")?`https://ipfs.io/ipfs/${e.slice(7)}`:e.startsWith("ar://")?`https://arweave.net/${e.slice(5)}`:e:""}async function mh(e){let t=Ol(uh(e.URI||e.uri||""));if(!t)return"";if(/\.(png|jpg|jpeg|gif|webp|svg)$/i.test(t))return t;try{let n=await fetch(t,{method:"GET"});if(!n.ok)return"";let s=await n.json(),a=(s==null?void 0:s.image)||(s==null?void 0:s.image_url)||(s==null?void 0:s.thumbnail);return Ol(a||"")}catch{return""}}async function At(e,{timeoutMs:t=9e3,allowProxy:n=!0}={}){let s=async a=>{let o=typeof(AbortSignal==null?void 0:AbortSignal.timeout)=="function"?AbortSignal.timeout(t):void 0,i=await fetch(a,{method:"GET",mode:"cors",cache:"no-store",signal:o});if(!i.ok)throw new Error(`HTTP ${i.status}`);return await i.json()};try{return await s(e)}catch(a){if(!n)throw a;for(let o of mf)try{return await s(o(e))}catch{}throw a}}async function Sc(){var e;Te.loading=!0,Te.error="",U();try{let t=await At("https://api.exchange.coinbase.com/products/XRP-USD/ticker"),n=await At("https://api.exchange.coinbase.com/products/XRP-USD/candles?granularity=86400"),s=Array.isArray(n)&&n.length?n[0]:null,a=Number((t==null?void 0:t.price)||0),o=s?Number(s[3]||0):a,i=s?Number(s[2]||a):a,r=s?Number(s[1]||a):a,l=s?Number(s[5]||0):0;Te.data={priceUsd:a,change24h:o?(a-o)/o*100:0,volume24h:l*a,marketCap:Number(((e=Te.data)==null?void 0:e.marketCap)||0),high24h:i,low24h:r}}catch(t){Te.error=(t==null?void 0:t.message)||"Could not load market data right now.",Te.data=null}finally{Te.loading=!1,U()}}async function Tc(e){if(bt.loading=!0,bt.error="",bt.items=[],U(),!e){bt.loading=!1,U();return}try{let t,n=[];do{let a=await ot({method:"account_nfts",params:[{account:e,limit:100,...t?{marker:t}:{}}]});n.push(...(a==null?void 0:a.account_nfts)||[]),t=a==null?void 0:a.marker}while(t);let s=await Promise.all(n.slice(0,80).map(async a=>({id:a.NFTokenID||a.nf_token_id||"Unknown",image:await mh(a)})));bt.items=s}catch(t){bt.error=(t==null?void 0:t.message)||"Could not load NFTs for this wallet."}finally{bt.loading=!1,U()}}async function Cc(e){if(yt.loading=!0,yt.error="",yt.pools=[],U(),!e){yt.loading=!1,U();return}try{let t=[],n;do{let o=await ot({method:"account_objects",params:[{account:e,type:"amm",limit:200,...n?{marker:n}:{}}]});((o==null?void 0:o.account_objects)||[]).forEach(r=>{let l=as(r.Asset||r.amount),c=as(r.Asset2||r.amount2),d=l.split(" ").pop()||"AssetA",u=c.split(" ").pop()||"AssetB";t.push({pair:`${d}/${u}`,lpBalance:r.LPTokenBalance?as(r.LPTokenBalance):"Not reported",estimatedValue:"Estimate unavailable",tradingFee:r.TradingFee!=null?`${r.TradingFee} bps`:"\u2014",tvl:"Unavailable"})}),n=o==null?void 0:o.marker}while(n);let s=await ot({method:"account_lines",params:[{account:e,limit:200}]});((s==null?void 0:s.lines)||[]).filter(o=>typeof o.currency=="string"&&o.currency.length>=16&&Number(o.balance)>0).forEach(o=>{t.push({pair:`LP Token ${o.currency.slice(0,8)}...`,lpBalance:`${_(Number(o.balance),4)} ${o.currency.slice(0,8)}...`,estimatedValue:"Estimate unavailable",tradingFee:"\u2014",tvl:"Unavailable"})}),yt.pools=t}catch(t){yt.error=(t==null?void 0:t.message)||"Could not load account AMM objects."}finally{yt.loading=!1,U()}}async function Pc(e){try{let t=await ot({method:"amm_info",params:[{asset:e.asset,asset2:e.asset2}]}),n=t==null?void 0:t.amm;return n?{label:e.label,reserveA:as(n.amount),reserveB:as(n.amount2),tradingFee:String(n.trading_fee??"\u2014"),totalLp:as(n.lp_token||n.lp_token_balance),tvl:fh(n.amount,n.amount2)}:null}catch{return null}}function fh(e,t){let n=a=>typeof a=="string"?Number(a)/1e6:a&&typeof a=="object"?Number(a.value||0):0,s=n(e)+n(t);return!Number.isFinite(s)||s<=0?"Unavailable":`${_(s,4)} (asset units)`}async function Mc(){Lt.loading=!0,Lt.error="",U();try{let e=await Promise.all(Rf.map(Pc));Lt.pools=e.filter(Boolean)}catch(e){Lt.error=(e==null?void 0:e.message)||"Could not load AMM explorer data.",Lt.pools=[]}finally{Lt.loading=!1,U()}}async function Lc(){var r,l,c,d;let e=(((r=document.getElementById("xpd-asset1-currency"))==null?void 0:r.value)||"").trim().toUpperCase(),t=(((l=document.getElementById("xpd-asset1-issuer"))==null?void 0:l.value)||"").trim(),n=(((c=document.getElementById("xpd-asset2-currency"))==null?void 0:c.value)||"").trim().toUpperCase(),s=(((d=document.getElementById("xpd-asset2-issuer"))==null?void 0:d.value)||"").trim();if(!e||!n){Fe.error="Enter both asset currency codes first.",U();return}let a=e==="XRP"?{currency:"XRP"}:{currency:e,issuer:t},o=n==="XRP"?{currency:"XRP"}:{currency:n,issuer:s};if(e!=="XRP"&&!t||n!=="XRP"&&!s){Fe.error="Issuer is required for non-XRP assets.",U();return}Fe.loading=!0,Fe.error="",Fe.pool=null,U();let i=await Pc({label:`${e}/${n}`,asset:a,asset2:o});Fe.loading=!1,i?Fe.pool=i:Fe.error="Pool not found or unavailable on this network.",U()}function Ia(){return On.find(e=>e.id===M.pair)||On[0]}function xi(e){if(e==="D")return 1440;if(e==="W")return 10080;if(e==="M")return 43200;let t=Number(e);return Number.isFinite(t)&&t>0?t:60}function hh(e){if(e==="M")return"W";if(e==="D"||e==="W")return e;let t=xi(e);for(let n of[5,15,60,240])if(t<=n)return String(n);return"D"}async function gh(e,t,n,s=200){var d;let a=t?`${e}.${t}`:e,o=hh(n),i=Math.min(2e3,Math.max(20,Number(s)||200)),r=`https://api.onthedex.live/public/v1/ohlc?base=${encodeURIComponent(a)}&quote=XRP&interval=${o}&bars=${i}`,l=await At(r,{timeoutMs:1e4});return(Array.isArray((d=l==null?void 0:l.data)==null?void 0:d.ohlc)?l.data.ohlc:[]).map(u=>({time:Number(u.t),open:Number(u.o),high:Number(u.h),low:Number(u.l),close:Number(u.c),volume:Number(u.vb||0)})).filter(u=>Number.isFinite(u.time)&&[u.open,u.high,u.low,u.close].every(Number.isFinite)).sort((u,p)=>u.time-p.time)}function Ac(e){return{xrpusd:"XRP-USD",XRPUSDT:"XRP-USD",ETHUSDT:"ETH-USD",BTCUSDT:"BTC-USD",SOLUSDT:"SOL-USD"}[e]||null}function vh(e){return{XRP:"XRP-USD",BTC:"BTC-USD",ETH:"ETH-USD",SOL:"SOL-USD",USDC:"USDC-USD"}[String(e||"").toUpperCase()]||null}var Qo=new Map;async function bh(e,t){if(!e)return null;let n=`${Ve(e)}:${t}`,s=Qo.get(n);if(s)return s;let a=yh(e,t);Qo.set(n,a);try{return await a}finally{Qo.delete(n)}}async function yh(e,t){var o,i;let n=String(e.symbol||"").toUpperCase();if(!n||n==="XRP")return null;let s=vh(n);if(s)try{let r=Rc(t),l=r===86400?Zl:ec,{candles:c,reachedStart:d}=await li(s,r,l);if(c.length){let u=d?`${new Date(c[0].time*1e3).getUTCFullYear()}\u2013present`:`last ${c.length} bars`;return{candles:c,source:`Coinbase direct (${s}, ${u})`,mode:"token-direct"}}}catch{}let a=String(e.issuer||"").trim();if(a)try{let r=await gh(n,a,t,2e3);if(r.length){let l=Number(((o=M.stats)==null?void 0:o.xrplSpot)||((i=M.stats)==null?void 0:i.price)||0);return{candles:l>0?r.map(d=>({time:d.time,open:d.open*l,high:d.high*l,low:d.low*l,close:d.close*l,volume:d.volume})):r,source:`OnTheDex XRPL DEX (${n}/XRP)`,mode:"token-direct"}}}catch{}return null}function wh(e,{mode:t="pair",source:n="Source pending",tokenKey:s=""}={}){let a=Array.isArray(e)?e:[];if(!a.length){M.chartMeta={tokenKey:s||M.tokenFocusKey||"XRP|",symbol:s&&s.split("|")[0]||"XRP",source:n,last:null,high:null,low:null,mode:t};return}let o=a[a.length-1],i=a.map(c=>Number(c.high)).filter(c=>Number.isFinite(c)),r=a.map(c=>Number(c.low)).filter(c=>Number.isFinite(c)),l=s||M.tokenFocusKey||"XRP|";M.chartMeta={tokenKey:l,symbol:l.split("|")[0]||"XRP",source:n,last:Number(o.close),high:i.length?Math.max(...i):Number(o.high),low:r.length?Math.min(...r):Number(o.low),mode:t}}async function Os(){var t;let e=Ia();M.loading=!0,M.error="";try{let n=Ac(e.ticker);if(n){let s=await At(`https://api.exchange.coinbase.com/products/${n}/ticker`),a=await At(`https://api.exchange.coinbase.com/products/${n}/candles?granularity=86400`),o=Array.isArray(a)&&a.length?a[0]:null,i=Number(s.price||0),r=o?Number(o[3]):i;M.stats={price:i,high:o?Number(o[2]):i,low:o?Number(o[1]):i,changePct:r?(i-r)/r*100:0,baseSource:"Coinbase",source:"Coinbase"},await Ec(),!Te.data&&M.stats.price&&(Te.data={priceUsd:M.stats.price,change24h:M.stats.changePct,volume24h:o?Number(o[5]||0)*M.stats.price:0,marketCap:Number(((t=Te.data)==null?void 0:t.marketCap)||0)});return}throw new Error("Chart stats unavailable for selected pair.")}catch(n){M.error=(n==null?void 0:n.message)||"DEX chart stats unavailable right now."}finally{M.loading=!1}}async function Ec(){var e,t,n;try{let s=await ot({method:"book_offers",params:[{taker_gets:{currency:"USD",issuer:"rhub8VRN55s94qWKDv6jmDy1pUykJzF3wq"},taker_pays:{currency:"XRP"},limit:1}]}),a=(e=s==null?void 0:s.offers)==null?void 0:e[0];if(!a)return;let o=Number(((t=a.TakerGets)==null?void 0:t.value)||0),i=typeof a.TakerPays=="string"?Number(a.TakerPays)/1e6:Number(((n=a.TakerPays)==null?void 0:n.value)||0);if(o>0&&i>0){let r=o/i;if(Ql=Date.now(),M.stats||(M.stats={}),M.stats.xrplSpot=r,String(Ia().symbol||"XRP").toUpperCase()==="XRP"){M.stats.price=r;let l=M.stats.baseSource||M.stats.source||"Market feed";M.stats.source=`${l} + XRPL live`,Te.data&&(Te.data.priceUsd=r)}}}catch{}}async function xh(){var e,t;return(e=window.LightweightCharts)!=null&&e.createChart?!0:(Ta||(Ta=new Promise((n,s)=>{let a=document.querySelector('script[data-lw-chart="1"]');if(a){a.addEventListener("load",()=>n(!0),{once:!0}),a.addEventListener("error",()=>s(new Error("Chart library failed to load.")),{once:!0});return}let o=document.createElement("script");o.src="https://unpkg.com/lightweight-charts@4.2.2/dist/lightweight-charts.standalone.production.js",o.async=!0,o.defer=!0,o.dataset.lwChart="1",o.onload=()=>n(!0),o.onerror=()=>s(new Error("Chart library failed to load.")),document.head.appendChild(o)}).finally(()=>{var n;(n=window.LightweightCharts)!=null&&n.createChart||(Ta=null)})),await Ta,!!((t=window.LightweightCharts)!=null&&t.createChart))}async function kh(){var e,t;return(e=window.THREE)!=null&&e.Scene?!0:(Ca||(Ca=new Promise((n,s)=>{let a=document.querySelector('script[data-three-chart="1"]');if(a){a.addEventListener("load",()=>n(!0),{once:!0}),a.addEventListener("error",()=>s(new Error("Three.js failed to load.")),{once:!0});return}let o=document.createElement("script");o.src="https://unpkg.com/three@0.166.1/build/three.min.js",o.async=!0,o.defer=!0,o.dataset.threeChart="1",o.onload=()=>n(!0),o.onerror=()=>s(new Error("Three.js failed to load.")),document.head.appendChild(o)}).finally(()=>{var n;(n=window.THREE)!=null&&n.Scene||(Ca=null)})),await Ca,!!((t=window.THREE)!=null&&t.Scene))}function Bs(){var e,t;if(Je.resizeHandler)try{window.removeEventListener("resize",Je.resizeHandler)}catch{}if(Je.raf&&cancelAnimationFrame(Je.raf),(t=(e=Je.renderer)==null?void 0:e.domElement)!=null&&t.parentElement)try{Je.renderer.domElement.parentElement.removeChild(Je.renderer.domElement)}catch{}if(Je.renderer)try{Je.renderer.dispose()}catch{}Je={renderer:null,scene:null,camera:null,points:null,raf:0,host:null,resizeHandler:null}}async function $h(){var t;let e=document.getElementById("xpd-chart-atmosphere");if(e&&!(Je.renderer&&e.contains(Je.renderer.domElement))&&!((navigator.hardwareConcurrency||4)<=3))try{if(await kh(),!((t=window.THREE)!=null&&t.Scene))return;Bs();let n=window.THREE,s=Math.max(1,e.clientWidth||640),a=Math.max(1,e.clientHeight||460),o=new n.Scene,i=new n.PerspectiveCamera(52,s/a,.1,1e3);i.position.z=46;let r=new n.WebGLRenderer({alpha:!0,antialias:!0});r.setPixelRatio(Math.min(2,window.devicePixelRatio||1)),r.setSize(s,a),e.appendChild(r.domElement);let l=900,c=new Float32Array(l*3);for(let h=0;h<l;h+=1){let b=h*3;c[b]=(Math.random()-.5)*90,c[b+1]=(Math.random()-.5)*40,c[b+2]=(Math.random()-.5)*24}let d=new n.BufferGeometry;d.setAttribute("position",new n.BufferAttribute(c,3));let u=new n.PointsMaterial({color:5101823,size:.25,transparent:!0,opacity:.26,depthWrite:!1}),p=new n.Points(d,u);o.add(p);let m=0,f=0,g=()=>{var $;m+=1;let h=Number((($=M.stats)==null?void 0:$.changePct)||0),b=Math.min(4,Math.max(.35,Math.abs(h)/2.2)),w=h>0?16758874:16739999;u.color.setHex(Math.abs(h)>1.5?w:5101823),p.rotation.y+=9e-4*b,p.rotation.x=Math.sin(m*.0015*b)*.08,p.position.y=Math.sin(m*.003*b)*.7,(!document.hidden||Date.now()-f>350)&&(r.render(o,i),f=Date.now()),Je.raf=requestAnimationFrame(g)},v=()=>{let h=Math.max(1,e.clientWidth||640),b=Math.max(1,e.clientHeight||460);i.aspect=h/b,i.updateProjectionMatrix(),r.setSize(h,b)};window.addEventListener("resize",v,{passive:!0}),Je={renderer:r,scene:o,camera:i,points:p,raf:0,host:e,resizeHandler:v},g()}catch{}}function Nc(e){return xi(e)*60}function Rc(e){let t=xi(e);return t<=1?60:t<=5?300:t<=15?900:t<=60?3600:t<=360?21600:86400}function _c(){let e=String(M.tokenFocusKey||"");if(!e)return null;let t=e.includes("|")?e.split("|")[0]:e;return W.tokens.find(n=>Ve(n)===e)||W.tokens.find(n=>String(n.symbol||"").toUpperCase()===String(t||"").toUpperCase())||null}function Dc(){var a,o;let e=_c(),t=Number((e==null?void 0:e.price)||0);if(Number.isFinite(t)&&t>0)return t;let n=Number(((a=M.stats)==null?void 0:a.xrplSpot)||0);if(Number.isFinite(n)&&n>0)return n;let s=Number(((o=M.stats)==null?void 0:o.price)||0);return Number.isFinite(s)&&s>0?s:1}function Ic(e,t=1,n=220){let s=Math.max(60,Nc(e)),a=Math.floor(Date.now()/1e3),o=Math.floor(a/s)*s-n*s,i=Math.max(1e-6,Number(t)||1),r=[];for(let l=0;l<n;l+=1){let c=o+l*s,d=i,u=Math.sin((l+1)/9)*.004+Math.cos((l+3)/17)*.002;i=Math.max(1e-6,d*(1+u));let p=Math.max(d,i)*(1+Math.abs(u)*.55+.0015),m=Math.min(d,i)*Math.max(1e-6,1-(Math.abs(u)*.55+.0015));r.push({time:c,open:Number(d),high:Number(p),low:Number(m),close:Number(i),volume:Math.max(0,Math.round(Math.abs(u)*12e3+l%13*55))})}return r}function oi(e){if(!e.length)return e;let t=[];for(let n=0;n<e.length;n+=1){let s=e[n],a=(s.open+s.high+s.low+s.close)/4,o=t[n-1],i=o?(o.open+o.close)/2:(s.open+s.close)/2,r=Math.max(s.high,i,a),l=Math.min(s.low,i,a);t.push({...s,open:i,high:r,low:l,close:a})}return t}function ii(e,t){let n=[],s=0;for(let a=0;a<e.length;a+=1)s+=e[a].close,a>=t&&(s-=e[a-t].close),a>=t-1&&n.push({time:e[a].time,value:s/t});return n}function Is(e,t){let n=[];if(!e.length)return n;let s=2/(t+1),a=e[0].close;for(let o=0;o<e.length;o+=1)a=o===0?e[o].close:e[o].close*s+a*(1-s),o>=t-1&&n.push({time:e[o].time,value:a});return n}function Sh(e,t){let n=[],s=t*(t+1)/2;for(let a=t-1;a<e.length;a+=1){let o=0;for(let i=0;i<t;i+=1)o+=e[a-i].close*(t-i);n.push({time:e[a].time,value:o/s})}return n}function Th(e,t=20,n=2){let s=ii(e,t),a=[],o=[];for(let i=t-1;i<e.length;i+=1){let r=e.slice(i-t+1,i+1),l=s[i-(t-1)].value,c=r.reduce((u,p)=>u+Math.pow(p.close-l,2),0)/t,d=Math.sqrt(c);a.push({time:e[i].time,value:l+d*n}),o.push({time:e[i].time,value:l-d*n})}return{upper:a,lower:o}}function Ch(e){let t=[],n=0,s=0;for(let a=0;a<e.length;a+=1){let o=(e[a].high+e[a].low+e[a].close)/3;n+=o*(e[a].volume||0),s+=e[a].volume||0,s>0&&t.push({time:e[a].time,value:n/s})}return t}function Ph(e,t=14){let n=[];if(e.length<=t)return n;let s=0,a=0;for(let r=1;r<=t;r+=1){let l=e[r].close-e[r-1].close;s+=l>0?l:0,a+=l<0?-l:0}let o=s/t,i=a/t;for(let r=t+1;r<e.length;r+=1){let l=e[r].close-e[r-1].close;o=(o*(t-1)+(l>0?l:0))/t,i=(i*(t-1)+(l<0?-l:0))/t;let c=i>0?o/i:100;n.push({time:e[r].time,value:100-100/(1+c)})}return n}function ki(e,t=14){let n=[];for(let o=0;o<e.length;o+=1){let i=o>0?e[o-1].close:e[o].close;n.push(Math.max(e[o].high-e[o].low,Math.abs(e[o].high-i),Math.abs(e[o].low-i)))}let s=[],a=n.slice(0,t).reduce((o,i)=>o+i,0)/Math.max(1,t);for(let o=t;o<e.length;o+=1)a=(a*(t-1)+n[o])/t,s.push({time:e[o].time,value:a});return s}function Mh(e,t=14,n=3){let s=[];for(let o=t-1;o<e.length;o+=1){let i=e.slice(o-t+1,o+1),r=Math.max(...i.map(d=>d.high)),l=Math.min(...i.map(d=>d.low)),c=r!==l?(e[o].close-l)/(r-l)*100:50;s.push({time:e[o].time,value:c})}let a=[];for(let o=n-1;o<s.length;o+=1){let i=s.slice(o-n+1,o+1).reduce((r,l)=>r+l.value,0)/n;a.push({time:s[o].time,value:i})}return{k:s,d:a}}function Lh(e,t=12,n=26,s=9){let a=Is(e,t),o=Is(e,n),i=new Map(o.map(u=>[u.time,u.value])),r=a.filter(u=>i.has(u.time)).map(u=>({time:u.time,value:u.value-i.get(u.time)})),l=[];if(r.length){let u=2/(s+1),p=r[0].value;for(let m=0;m<r.length;m+=1)p=m===0?r[m].value:r[m].value*u+p*(1-u),m>=s-1&&l.push({time:r[m].time,value:p})}let c=new Map(l.map(u=>[u.time,u.value])),d=r.filter(u=>c.has(u.time)).map(u=>({time:u.time,value:u.value-c.get(u.time)}));return{line:r,signal:l,hist:d}}function Fc(e,t=9,n=26,s=52){let a=u=>{let p=[];for(let m=u-1;m<e.length;m+=1){let f=e.slice(m-u+1,m+1);p.push({time:e[m].time,value:(Math.max(...f.map(g=>g.high))+Math.min(...f.map(g=>g.low)))/2})}return p},o=a(t),i=a(n),r=new Map(i.map(u=>[u.time,u.value])),l=o.filter(u=>r.has(u.time)).map(u=>({time:u.time,value:(u.value+r.get(u.time))/2})),c=a(s),d=e.map(u=>({time:u.time,value:u.close}));return{tenkan:o,kijun:i,senkouA:l,senkouB:c,chikou:d}}function Ah(e,t=20){let n=[],s=[],a=[];for(let o=t-1;o<e.length;o+=1){let i=e.slice(o-t+1,o+1),r=Math.max(...i.map(c=>c.high)),l=Math.min(...i.map(c=>c.low));n.push({time:e[o].time,value:r}),s.push({time:e[o].time,value:l}),a.push({time:e[o].time,value:(r+l)/2})}return{upper:n,lower:s,mid:a}}function Eh(e,t=20,n=2){let s=Is(e,t),a=ki(e,t),o=new Map(a.map(l=>[l.time,l.value])),i=[],r=[];return s.forEach(l=>{if(o.has(l.time)){let c=o.get(l.time)*n;i.push({time:l.time,value:l.value+c}),r.push({time:l.time,value:l.value-c})}}),{upper:i,lower:r,mid:s}}function Nh(e){let t=[],n=[],s=0,a=0;for(let o=0;o<e.length;o+=1){if(o>0){let l=e[o-1];e[o].close>l.close&&(s+=e[o].volume||0),e[o].close<l.close&&(s-=e[o].volume||0)}let i=e[o].high-e[o].low||1,r=(e[o].close-e[o].low-(e[o].high-e[o].close))/i;a+=r*(e[o].volume||0),t.push({time:e[o].time,value:s}),n.push({time:e[o].time,value:a})}return{obv:t,adline:n}}function Rh(e,t=14){if(e.length<t+2)return{adx:[],plusDi:[],minusDi:[]};let n=[],s=[],a=[];for(let p=1;p<e.length;p+=1){let m=e[p].high-e[p-1].high,f=e[p-1].low-e[p].low;s.push(m>f&&m>0?m:0),a.push(f>m&&f>0?f:0),n.push(Math.max(e[p].high-e[p].low,Math.abs(e[p].high-e[p-1].close),Math.abs(e[p].low-e[p-1].close)))}let o=n.slice(0,t).reduce((p,m)=>p+m,0),i=s.slice(0,t).reduce((p,m)=>p+m,0),r=a.slice(0,t).reduce((p,m)=>p+m,0),l=[],c=[],d=[];for(let p=t;p<n.length;p+=1){o=o-o/t+n[p],i=i-i/t+s[p],r=r-r/t+a[p];let m=o>0?100*i/o:0,f=o>0?100*r/o:0,g=m+f>0?100*Math.abs(m-f)/(m+f):0,v=e[p+1].time;l.push({time:v,value:m}),c.push({time:v,value:f}),d.push({time:v,value:g})}let u=[];if(d.length>=t){let p=d.slice(0,t).reduce((m,f)=>m+f.value,0)/t;for(let m=t;m<d.length;m+=1)p=(p*(t-1)+d[m].value)/t,u.push({time:d[m].time,value:p})}return{adx:u,plusDi:l,minusDi:c}}function _h(e,t=14){let n=[],s=[];for(let a=t-1;a<e.length;a+=1){let o=e.slice(a-t+1,a+1),i=0,r=0;for(let d=1;d<o.length;d+=1)o[d].high>=o[i].high&&(i=d),o[d].low<=o[r].low&&(r=d);let l=t-1-i,c=t-1-r;n.push({time:e[a].time,value:(t-l)/t*100}),s.push({time:e[a].time,value:(t-c)/t*100})}return{up:n,down:s}}function Dh(e,t=14){let n=[],s=[];if(e.length<t+2)return{plus:n,minus:s};for(let a=t;a<e.length;a+=1){let o=0,i=0,r=0;for(let l=a-t+1;l<=a;l+=1){let c=e[l-1],d=e[l];o+=Math.max(d.high-d.low,Math.abs(d.high-c.close),Math.abs(d.low-c.close)),i+=Math.abs(d.high-c.low),r+=Math.abs(d.low-c.high)}n.push({time:e[a].time,value:o>0?i/o:0}),s.push({time:e[a].time,value:o>0?r/o:0})}return{plus:n,minus:s}}function Ih(e,t=10,n=3){let s=ki(e,t),a=new Map(s.map(c=>[c.time,c.value])),o=[],i=0,r=0,l=!0;return e.forEach((c,d)=>{if(d===0||!a.has(c.time))return;let u=(c.high+c.low)/2,p=a.get(c.time),m=u+n*p,f=u-n*p;d>1&&(m>i&&e[d-1].close<=i&&(m=i),f<r&&e[d-1].close>=r&&(f=r));let g=c.close>m?!0:c.close<f?!1:l,v=g?f:m;o.push({time:c.time,value:v,trendUp:g?1:0}),i=m,r=f,l=g}),o}function Fh(e,t=14){let n=[];if(e.length<=t)return n;let s=e.map((a,o)=>{let i=(a.high+a.low+a.close)/3,r=o>0?(e[o-1].high+e[o-1].low+e[o-1].close)/3:i,l=i*(a.volume||0);return{time:a.time,pos:i>=r?l:0,neg:i<r?l:0}});for(let a=t;a<s.length;a+=1){let o=s.slice(a-t+1,a+1),i=o.reduce((c,d)=>c+d.pos,0),r=o.reduce((c,d)=>c+d.neg,0),l=r>0?i/r:100;n.push({time:s[a].time,value:100-100/(1+l)})}return n}function Oh(e,t=14){let n=[];for(let s=t-1;s<e.length;s+=1){let a=e.slice(s-t+1,s+1),o=Math.max(...a.map(l=>l.high)),i=Math.min(...a.map(l=>l.low)),r=o!==i?(o-e[s].close)/(o-i)*-100:-50;n.push({time:e[s].time,value:r})}return n}function Bh(e,t=20){let n=[],s=e.map(a=>({time:a.time,value:(a.high+a.low+a.close)/3}));for(let a=t-1;a<s.length;a+=1){let o=s.slice(a-t+1,a+1),i=o.reduce((c,d)=>c+d.value,0)/t,r=o.reduce((c,d)=>c+Math.abs(d.value-i),0)/t,l=r>0?(s[a].value-i)/(.015*r):0;n.push({time:s[a].time,value:l})}return n}function Xh(e){if(e.length<30)return[];let t=[],n=[];for(let o=1;o<e.length;o+=1){let i=e[o-1].close,r=Math.min(e[o].low,i),l=Math.max(e[o].high,i);t.push({time:e[o].time,value:e[o].close-r}),n.push({time:e[o].time,value:l-r})}let s=(o,i,r)=>o.slice(i-r+1,i+1).reduce((l,c)=>l+c.value,0),a=[];for(let o=27;o<t.length;o+=1){let i=s(t,o,7)/Math.max(1e-9,s(n,o,7)),r=s(t,o,14)/Math.max(1e-9,s(n,o,14)),l=s(t,o,28)/Math.max(1e-9,s(n,o,28));a.push({time:t[o].time,value:100*(4*i+2*r+l)/7})}return a}function Hh(e,t=20){let n=[],s=e.map(a=>{let o=a.high-a.low||1,i=(a.close-a.low-(a.high-a.close))/o;return{time:a.time,value:i*(a.volume||0),volume:a.volume||0}});for(let a=t-1;a<s.length;a+=1){let o=s.slice(a-t+1,a+1),i=o.reduce((l,c)=>l+c.value,0),r=o.reduce((l,c)=>l+c.volume,0);n.push({time:s[a].time,value:r>0?i/r:0})}return n}function zh(e){return(Array.isArray(e)?e:[]).map(t=>({time:Number(t[0]),low:Number(t[1]),high:Number(t[2]),open:Number(t[3]),close:Number(t[4]),volume:Number(t[5])})).filter(t=>Number.isFinite(t.time)&&[t.open,t.high,t.low,t.close].every(Number.isFinite))}function ri(e,t){let n=new Map;for(let s of e)n.set(s.time,s);for(let s of t)n.set(s.time,s);return Array.from(n.values()).sort((s,a)=>s.time-a.time)}async function li(e,t,n){let s=[],a=Math.floor(Date.now()/1e3),o=!1;for(let i=0;i<n;i+=1){let r=a-t*300,l=`https://api.exchange.coinbase.com/products/${e}/candles?granularity=${t}&start=${new Date(r*1e3).toISOString()}&end=${new Date(a*1e3).toISOString()}`,c;try{c=await At(l,{timeoutMs:1e4})}catch{break}let d=zh(c);if(!d.length){o=!0;break}s.push(...d),a=r,i<n-1&&await Mf(Pf)}return{candles:ri(s,[]),reachedStart:o}}async function jh(e,t,n){if(!e||!Number.isFinite(t)||!Number.isFinite(n)||n<=t)return[];try{let s=`https://api.coingecko.com/api/v3/coins/${e}/market_chart/range?vs_currency=usd&from=${t}&to=${n}`,a=await At(s,{timeoutMs:15e3});return(Array.isArray(a==null?void 0:a.prices)?a.prices:[]).map(([i,r])=>({time:Math.floor(Number(i)/1e3/86400)*86400,open:Number(r),high:Number(r),low:Number(r),close:Number(r),volume:0})).filter(i=>Number.isFinite(i.time)&&Number.isFinite(i.close)&&i.close>0).sort((i,r)=>i.time-r.time)}catch{return[]}}async function Wh(e,t,n){var u;let s=Rc(n),a=s===86400,o=`${Cf}${e.id}:${s}`,i=ge(Q(o));if((u=i==null?void 0:i.candles)!=null&&u.length&&i.reachedStart){let p=await li(t,s,1),m=ri(i.candles,p.candles);return Z(o,JSON.stringify({candles:m,reachedStart:!0,source:i.source,cachedAt:Date.now()})),{candles:m,source:i.source}}let l=await li(t,s,a?Zl:ec),c=l.candles,d=c.length?`Coinbase (${new Date(c[0].time*1e3).getUTCFullYear()}\u2013present, ${c.length} bars)`:"Coinbase";if(a&&l.reachedStart&&e.coingeckoId&&c.length){let p=c[0].time,m=await jh(e.coingeckoId,0,p);m.length&&(c=ri(m,c),d=`CoinGecko (${new Date(c[0].time*1e3).getUTCFullYear()}+) + Coinbase (${new Date(p*1e3).getUTCFullYear()}\u2013present)`)}else!a&&!l.reachedStart&&(d=`Coinbase (last ${c.length} bars \u2014 full inception history is daily/weekly/monthly only)`);return c.length&&Z(o,JSON.stringify({candles:c,reachedStart:l.reachedStart,source:d,cachedAt:Date.now()})),{candles:c,source:d}}var Zo=new Map;async function Oc(e,t){let n=`${e.id}:${t}`,s=Ns.get(n);if(s&&Date.now()-s.ts<6e4&&Array.isArray(s.data)&&s.data.length)return s.data;let a=Zo.get(n);if(a)return a;let o=(async()=>{let i=[],r="",l=Ac(e.ticker);if(l)try{let c=await Wh(e,l,t);i=c.candles,r=c.source}catch{i=[]}if(!Array.isArray(i)||!i.length){let c=Ic(t,Dc());return Ns.set(n,{ts:Date.now(),data:c,sourceLabel:""}),c}return Ns.set(n,{ts:Date.now(),data:i,sourceLabel:r}),i})();Zo.set(n,o);try{return await o}finally{Zo.delete(n)}}async function Uh(){var u,p,m,f,g,v,h,b;let e=Ia(),t=await Oc(e,M.interval),s=((u=Ns.get(`${e.id}:${M.interval}`))==null?void 0:u.sourceLabel)||String(((p=M.stats)==null?void 0:p.source)||"Coinbase + XRPL live"),a="pair",o=_c(),i=String((o==null?void 0:o.symbol)||"").toUpperCase(),r=o?Ve(o):`${e.symbol||"XRP"}|`;if(o&&i&&i!=="XRP"){let w=await bh(o,M.interval);(m=w==null?void 0:w.candles)!=null&&m.length&&(t=w.candles,s=w.source,a=w.mode)}let l=String(e.symbol||"XRP").toUpperCase()==="XRP",c=Number((l?(f=M.stats)==null?void 0:f.xrplSpot:null)??((g=M.stats)==null?void 0:g.price)??0);if(a==="pair"&&Number.isFinite(c)&&c>0&&t.length){let w=Math.max(60,Nc(M.interval)),k=Math.floor(Date.now()/1e3),$=Math.floor(k/w)*w,T=t[t.length-1];T.time===$?(T.high=Math.max(T.high,c),T.low=Math.min(T.low,c),T.close=c):T.time<$&&t.push({time:$,open:T.close,high:Math.max(T.close,c),low:Math.min(T.close,c),close:c,volume:0})}let d=Number((o==null?void 0:o.price)||0);if(a==="pair"&&o&&i&&i!=="XRP"&&Number.isFinite(d)&&d>0&&t.length){let w=Number((l?(v=M.stats)==null?void 0:v.xrplSpot:null)??((h=M.stats)==null?void 0:h.price)??((b=t[t.length-1])==null?void 0:b.close)??0);if(Number.isFinite(w)&&w>0){let k=d/w;Number.isFinite(k)&&k>0&&(t=t.map($=>({...$,open:$.open*k,high:$.high*k,low:$.low*k,close:$.close*k})),s="Coinbase pair + token spot proxy",a="token-proxy")}}return t.length||(t=Ic(M.interval,Dc()),s=o&&i!=="XRP"?"Synthetic fallback (token-focused)":"Synthetic fallback",a="fallback"),o&&i!=="XRP"&&(a==="pair"||a==="fallback")?Ko!==r&&(Ko=r,he(`No market data found for ${o.symbol} yet \u2014 showing ${e.symbol||"XRP"} for reference.`)):r&&(Ko=""),M.chartType==="heikin_ashi"&&(t=oi(t)),wh(t,{mode:a,source:s,tokenKey:r||"XRP|"}),t}function Bl(e){if(!Array.isArray(e))return[];let t=e.map(s=>({time:Number(s.time),open:Number(s.open),high:Number(s.high),low:Number(s.low),close:Number(s.close),volume:Number(s.volume||0)})).filter(s=>Number.isFinite(s.time)&&Number.isFinite(s.open)&&Number.isFinite(s.high)&&Number.isFinite(s.low)&&Number.isFinite(s.close)&&s.time>0).sort((s,a)=>s.time-a.time),n=[];for(let s=0;s<t.length;s+=1){let a=t[s],o=n[n.length-1];o&&o.time===a.time?n[n.length-1]=a:n.push(a)}return n}function qh(e,t,n){var i;let s=Number(((i=e==null?void 0:e[e.length-1])==null?void 0:i.close)||0);if(!Number.isFinite(s)||s<=0)return 6;let o=Math.max(1e-12,Math.abs(Number(n)-Number(t)))/Math.max(1e-12,Math.abs(s));return s>=1e3?o<.01?4:2:s>=1?o<.01?6:4:s>=.01?o<.03?8:6:8}function Vh(){if(ee.resizeObserver)try{ee.resizeObserver.disconnect()}catch{}ee.chart&&(ee.chart.remove(),ee={chart:null,volumeSeries:null,activeSeries:null,compareSeries:null,indicatorSeries:[],indicatorPriceLines:[],priceLines:[],resizeObserver:null,chartType:"",configKey:"",legendEl:null,renderLegend:null,ichimokuData:null,indicatorLegendItems:[],alertPriceLines:[]})}function Xl(e,t){var d;let{addOverlay:n,addOsc:s,addOscHist:a,addPriceLevel:o}=t,i=(u,p)=>{var f,g;let m=Number((g=(f=M.indicatorSettings)==null?void 0:f[u])==null?void 0:g.length);return Number.isFinite(m)&&m>1?Math.min(500,Math.max(2,m)):p},r=(u,p,m)=>{var v,h;let f=(h=(v=M.indicatorSettings)==null?void 0:v[u])==null?void 0:h[p];if(f==null||f==="")return m;let g=(gi[u]||[]).find(b=>b.id===p);if((g==null?void 0:g.type)==="number"){let b=Number(f);return Number.isFinite(b)&&b>1?Math.min(500,Math.max(2,b)):m}return f},l=M.indicators;if(l.sma20&&n(ii(e,i("sma20",20)),r("sma20","color","#f1c40f"),1.2,!1,"SMA"),l.ema20&&n(Is(e,i("ema20",20)),r("ema20","color","#ffb86c"),1.2,!1,"EMA"),l.wma20&&n(Sh(e,i("wma20",20)),r("wma20","color","#bd93f9"),1.2,!1,"WMA"),l.vwap&&n(Ch(e),r("vwap","color","#80ffea"),1.2,!1,"VWAP"),l.bb20){let u=r("bb20","color","#ff79c6"),p=Th(e,i("bb20",20),2);n(p.upper,u,1,!0,"BB Upper"),n(p.lower,u,1,!0,"BB Lower")}if(l.ichimoku){let u=Fc(e,r("ichimoku","tenkanLen",9),r("ichimoku","kijunLen",26),r("ichimoku","senkouBLen",52));n(u.tenkan,r("ichimoku","tenkanColor","#ffde59"),1.2,!1,"Tenkan"),n(u.kijun,r("ichimoku","kijunColor","#6ecbff"),1.2,!1,"Kijun"),n(u.senkouA,"rgba(70,255,160,0.8)",1,!0,"Senkou A"),n(u.senkouB,"rgba(255,120,120,0.8)",1,!0,"Senkou B"),n(u.chikou,"rgba(220,220,255,0.6)",.9,!0,"Chikou")}if(l.donchian){let u=r("donchian","color","#9cfb8c"),p=Ah(e,i("donchian",20));n(p.upper,u,1,!0,"Donchian Upper"),n(p.lower,u,1,!0,"Donchian Lower"),n(p.mid,"rgba(156,251,140,0.6)",1.2,!1,"Donchian Mid")}if(l.keltner){let u=r("keltner","color","#7ee7ff"),p=Eh(e,i("keltner",20),2);n(p.upper,u,1,!0,"Keltner Upper"),n(p.lower,u,1,!0,"Keltner Lower"),n(p.mid,"rgba(126,231,255,0.66)",1.2,!1,"Keltner Mid")}if(l.pivots&&e.length>=2){let u=e[e.length-2],p=(u.high+u.low+u.close)/3,m=2*p-u.low,f=2*p-u.high,g=p+(u.high-u.low),v=p-(u.high-u.low);o(p,"#f6f6f6","P"),o(m,"#61ffb0","R1"),o(f,"#ff8f8f","S1"),o(g,"rgba(97,255,176,0.6)","R2"),o(v,"rgba(255,143,143,0.6)","S2")}if(l.supertrend||l.sar||l.elderRay){let u=Is(e,14);if(l.supertrend&&n(Ih(e,10,3),r("supertrend","color","#8bffde"),1.3,!1,"Supertrend"),l.sar&&n(u.map(p=>({time:p.time,value:p.value*.998})),r("sar","color","#ffaf7a"),1,!0,"SAR"),l.elderRay){let p=new Map(u.map(g=>[g.time,g.value])),m=e.filter(g=>p.has(g.time)).map(g=>({time:g.time,value:g.high-p.get(g.time)})),f=e.filter(g=>p.has(g.time)).map(g=>({time:g.time,value:g.low-p.get(g.time)}));s(m,r("elderRay","bullColor","#5fff9d"),"Elder Bull"),s(f,r("elderRay","bearColor","#ff9d9d"),"Elder Bear")}}if(l.rsi&&s(Ph(e,i("rsi",14)),r("rsi","color","#a6ff4d"),"RSI"),l.atr&&s(ki(e,i("atr",14)),r("atr","color","#ffb86c"),"ATR"),l.stdev){let u=ii(e,20),p=new Map(u.map(f=>[f.time,f.value])),m=e.filter(f=>p.has(f.time)).map(f=>({time:f.time,value:Math.abs(f.close-p.get(f.time))}));s(m,r("stdev","color","#b2a3ff"),"StdDev")}if(l.stoch){let u=Mh(e,i("stoch",14),3);s(u.k,r("stoch","kColor","#9ee8ff"),"%K"),s(u.d,r("stoch","dColor","#ffd86b"),"%D")}if(l.macd){let u=Lh(e,r("macd","fastLen",12),r("macd","slowLen",26),r("macd","signalLen",9));s(u.line,r("macd","lineColor","#8fd9ff"),"MACD"),s(u.signal,r("macd","signalColor","#ffcf8e"),"Signal"),(d=u.hist)!=null&&d.length&&a(u.hist)}let c=Nh(e);if(l.obv&&s(c.obv,r("obv","color","#8cf9ff"),"OBV"),l.adline&&s(c.adline,r("adline","color","#ffb7ff"),"A/D"),l.cmf&&s(Hh(e,i("cmf",20)),r("cmf","color","#f8ff87"),"CMF"),l.williamsr&&s(Oh(e,i("williamsr",14)),r("williamsr","color","#ff9adf"),"Williams %R"),l.cci&&s(Bh(e,i("cci",20)),r("cci","color","#b8ff8e"),"CCI"),l.mfi&&s(Fh(e,i("mfi",14)),r("mfi","color","#7bffd2"),"MFI"),l.uo&&s(Xh(e),r("uo","color","#ffd36f"),"UO"),l.adx){let u=Rh(e,i("adx",14));s(u.adx,r("adx","adxColor","#9fd8ff"),"ADX"),s(u.plusDi,r("adx","plusColor","#73ffc0"),"+DI"),s(u.minusDi,r("adx","minusColor","#ff9797"),"-DI")}if(l.aroon){let u=_h(e,i("aroon",14));s(u.up,r("aroon","upColor","#6cffb0"),"Aroon Up"),s(u.down,r("aroon","downColor","#ff8f8f"),"Aroon Down")}if(l.vortex){let u=Dh(e,i("vortex",14));s(u.plus.map(p=>({time:p.time,value:p.value*100})),r("vortex","plusColor","#d6a8ff"),"VI+"),s(u.minus.map(p=>({time:p.time,value:p.value*100})),r("vortex","minusColor","#ffb0f3"),"VI-")}}function Gh(e){let t=e.querySelector(":scope > svg.xpd-ichimoku-cloud-svg");return t||(t=document.createElementNS("http://www.w3.org/2000/svg","svg"),t.setAttribute("class","xpd-ichimoku-cloud-svg"),e.appendChild(t)),t}function Kh(e){var t;(t=e==null?void 0:e.querySelector(":scope > svg.xpd-ichimoku-cloud-svg"))==null||t.remove()}function Bc(e,t,n,s,a){var v;if(!e||!t||!n)return;let o=n.clientWidth||0,i=n.clientHeight||0;if(!o||!i||!(s!=null&&s.length)||!(a!=null&&a.length))return;let r=Gh(n);r.setAttribute("width",o),r.setAttribute("height",i),r.setAttribute("viewBox",`0 0 ${o} ${i}`);let l=((v=M.indicatorSettings)==null?void 0:v.ichimoku)||{},c=l.bullColor||"#46ffa0",d=l.bearColor||"#ff7878",u=new Map(a.map(h=>[h.time,h.value])),p=e.timeScale(),m=[];for(let h of s){let b=u.get(h.time);if(b==null)continue;let w=p.timeToCoordinate(h.time),k=t.priceToCoordinate(h.value),$=t.priceToCoordinate(b);w==null||k==null||$==null||m.push({x:w,ya:k,yb:$,bullish:h.value>=b})}let f="",g=0;for(let h=1;h<=m.length;h+=1){if(!(h===m.length||m[h].bullish!==m[g].bullish))continue;let w=m.slice(g,h);if(w.length>=2){let k=w.map(S=>`${S.x.toFixed(1)},${S.ya.toFixed(1)}`).join(" "),$=w.slice().reverse().map(S=>`${S.x.toFixed(1)},${S.yb.toFixed(1)}`).join(" "),T=w[0].bullish?c:d;f+=`<polygon points="${k} ${$}" fill="${y(T)}" opacity="0.22" />`}g=h}r.innerHTML=f}function Hl(e,t,n,s){var i;if(!M.indicators.ichimoku){Kh(s),ee.ichimokuData=null;return}let a=((i=M.indicatorSettings)==null?void 0:i.ichimoku)||{},o=Fc(e,Number(a.tenkanLen)||9,Number(a.kijunLen)||26,Number(a.senkouBLen)||52);ee.ichimokuData={senkouA:o.senkouA,senkouB:o.senkouB},Bc(t,n,s,o.senkouA,o.senkouB)}function ci(){let e=ee.ichimokuData,t=document.getElementById("xpd-tv-widget");e&&ee.chart&&ee.activeSeries&&t&&Bc(ee.chart,ee.activeSeries,t,e.senkouA,e.senkouB)}async function Jh(){var n,s,a,o;let e=++_n,t=document.getElementById("xpd-tv-widget");if(t){ee.chart||(t.innerHTML='<div class="xpd-loading">Loading full price history\u2026</div>');try{M.threeEnabled?$h():Bs();let i=await Uh(),r=Bl(i);if(e!==_n)return;if(!r.length)throw new Error("No chart bars returned for selected pair/timeframe.");Qh(r);let l=JSON.stringify({pair:M.pair,interval:M.interval,chartType:M.chartType,comparePair:M.comparePair,indicators:M.indicators,indicatorSettings:M.indicatorSettings,threeEnabled:M.threeEnabled});if(!M.comparePair&&!(M.drawings||[]).length&&ee.chart&&ee.configKey===l){let B=M.chartType==="heikin_ashi"?oi(r):r;M.chartType==="line"||M.chartType==="area"?ee.activeSeries.setData(B.map(Y=>({time:Y.time,value:Y.close}))):ee.activeSeries.setData(B),ee.volumeSeries.setData(r.map(Y=>({time:Y.time,value:Y.volume||0,color:Y.close>=Y.open?"rgba(38,166,154,0.5)":"rgba(239,83,80,0.5)"})));let q=0,J=0,ue=[];Xl(r,{addOverlay:(Y,Ce,Qe,Se,Pt)=>{let jt=ee.indicatorSeries[q++];Y!=null&&Y.length&&(jt==null||jt.setData(Y),Pt&&jt&&ue.push({label:Pt,color:Ce,series:jt,points:Y}))},addOsc:(Y,Ce,Qe)=>{let Se=ee.indicatorSeries[q++];Y!=null&&Y.length&&(Se==null||Se.setData(Y),Qe&&Se&&ue.push({label:Qe,color:Ce,series:Se,points:Y}))},addOscHist:Y=>{let Ce=ee.indicatorSeries[q++];Y!=null&&Y.length&&(Ce==null||Ce.setData(Y.map(Qe=>({time:Qe.time,value:Qe.value,color:Qe.value>=0?"rgba(99,255,157,0.45)":"rgba(255,126,126,0.45)"}))))},addPriceLevel:Y=>{let Ce=ee.indicatorPriceLines[J++];Number.isFinite(Y)&&(Ce==null||Ce.applyOptions({price:Y}))}}),ee.indicatorLegendItems=ue,Hl(r,ee.chart,ee.activeSeries,t),zl(ee.activeSeries);let Ie=r[r.length-1];(n=ee.renderLegend)==null||n.call(ee,Ie.open,Ie.high,Ie.low,Ie.close,Ie.volume);return}if(!await xh())throw new Error("Chart library failed to load.");if(e!==_n)return;let d=document.getElementById("xpd-tv-widget");if(!d||e!==_n)return;let u=null;try{u=((s=ee.chart)==null?void 0:s.timeScale().getVisibleLogicalRange())||null}catch{}Vh(),d.innerHTML="";let p=window.LightweightCharts,m=Math.max(320,d.clientWidth||((a=d.parentElement)==null?void 0:a.clientWidth)||320),f=Math.max(360,d.clientHeight||460),g=r.map(B=>B.low),v=r.map(B=>B.high),h=qh(r,Math.min(...g),Math.max(...v)),b={type:"price",precision:h,minMove:Math.pow(10,-h)},w="#26a69a",k="#ef5350",$=p.createChart(d,{width:m,height:f,layout:{background:{type:p.ColorType.Solid,color:"#131722"},textColor:"#d1d4dc"},grid:{vertLines:{color:"#242832"},horzLines:{color:"#242832"}},rightPriceScale:{borderColor:"rgba(197,203,206,0.3)"},leftPriceScale:{visible:!1,borderColor:"rgba(197,203,206,0.3)"},timeScale:{borderColor:"rgba(197,203,206,0.3)",timeVisible:!0,secondsVisible:!1},crosshair:{mode:p.CrosshairMode.Normal},handleScroll:!0,handleScale:!0}),T=M.chartType==="heikin_ashi"?oi(r):r,S;if(M.chartType==="line")S=$.addLineSeries({color:"#2962ff",lineWidth:2,priceFormat:b}),S.setData(T.map(B=>({time:B.time,value:B.close})));else if(M.chartType==="area")S=$.addAreaSeries({lineColor:"#2962ff",topColor:"rgba(41,98,255,0.36)",bottomColor:"rgba(41,98,255,0.04)",lineWidth:2,priceFormat:b}),S.setData(T.map(B=>({time:B.time,value:B.close})));else if(M.chartType==="bars")S=$.addBarSeries({upColor:w,downColor:k,priceFormat:b}),S.setData(T);else{let B=M.chartType==="hollow_candles";S=$.addCandlestickSeries({upColor:B?"rgba(0,0,0,0)":w,downColor:k,borderUpColor:w,borderDownColor:k,wickUpColor:w,wickDownColor:k,borderVisible:!0,priceFormat:b}),S.setData(T)}let E=$.addHistogramSeries({priceFormat:{type:"volume"},priceScaleId:"vol"});$.priceScale("vol").applyOptions({scaleMargins:{top:.85,bottom:0}}),E.setData(r.map(B=>({time:B.time,value:B.volume||0,color:B.close>=B.open?"rgba(38,166,154,0.5)":"rgba(239,83,80,0.5)"})));let P=document.createElement("div");P.className="xpd-chart-legend",d.appendChild(P);let C=B=>Number.isFinite(B)?B.toFixed(h):"\u2014",R=(B,q,J,ue,$e,Me)=>{let We=ue>=B,De=(Me||[]).map(Ie=>`<span style="color:${y(Ie.color)}">${y(Ie.label)} <b>${C(Ie.value)}</b></span>`).join("");P.innerHTML=`
        <span>O <b>${C(B)}</b></span>
        <span>H <b>${C(q)}</b></span>
        <span>L <b>${C(J)}</b></span>
    ...
    </div>`:"",n=oe.filter(a=>!ns||a.label.toLowerCase().includes(ns.toLowerCase())||a.address.toLowerCase().includes(ns.toLowerCase())),s=n.map((a,o)=>rg(a,oe.indexOf(a))).join("");e.innerHTML=t+(n.length?s:`<div class="wcard-empty">No wallets match "${y(ns)}"</div>`)+`
    ...
    </div>`,Ra("stat-wallets-val",oe.length)}function rg(e,t){let n=e.id===pt,s=!!e.watchOnly,a=et[e.address],o=As[e.address],r=!0||s,l=(o==null?void 0:o.ownerCount)||0,c=La+l*Aa,d=r?a?_(a.xrp,2):"\u2014":"\u2022\u2022\u2022\u2022",u=a&&r?Math.max(0,a.xrp-c):null,p=(a==null?void 0:a.tokens)||[],m=a!=null&&a.fetchedAt?cc(a.fetchedAt):null,f=e.address.slice(0,8)+"\u2026"+e.address.slice(-6),g=Ci(e.address);return`
  <div class="wcard ${n?"wcard--active":""} ${s?"wcard--watch":""}" id="wallet-item-${e.id}" style="--i:${t}">
    ...
    ${p.length&&r?`<div class="wcard-token-row">
      ${p.slice(0,6).map(v=>{let h=v.currency.length>4?Ni(v.currency)||v.currency.slice(0,4)+"\u2026":v.currency;return`<div class="wcard-token-chip" onclick="openTokenDetailsModal('${y(v.currency)}','${y(v.issuer)}','${y(e.address)}')" title="${y(v.currency)}">
  ...
  </div>`}function Vd(e){var n;let t=oe[e];t&&(oe.splice(e,1),Ds(),pt===t.id&&(pt=((n=oe[0])==null?void 0:n.id)||null,pt&&Z(Rs,pt)),$t(),Bt(),kt("wallet_removed",t.label),lg(`Wallet "${t.label}" removed`,()=>{oe.splice(e,0,t),Ds(),pt||(pt=t.id,Z(Rs,t.id)),$t(),Bt(),kt("wallet_created",t.label+" (restored)")},()=>{t.address&&vt(pi+t.address)}))}function lg(e,t,n){let s=document.getElementById("undo-toast");s&&s.remove();let a=document.createElement("div");a.id="undo-toast",a.className="undo-toast",a.innerHTML=`<span class="undo-msg">${y(e)}</span><button class="undo-btn">Undo</button>`,document.body.appendChild(a),requestAnimationFrame(()=>a.classList.add("show"));let o=setTimeout(()=>{a.classList.remove("show"),setTimeout(()=>a.remove(),300),n==null||n()},5e3);a.querySelector(".undo-btn").addEventListener("click",()=>{clearTimeout(o),t(),a.classList.remove("show"),setTimeout(()=>a.remove(),300),ne("Wallet restored")})}function Gd(e){var n,s;let t=x("inspect-addr");t&&(t.value=e),(n=window.switchTab)==null||n.call(window,document.querySelector('[data-tab="inspector"]'),"inspector"),(s=window.showDashboard)==null||s.call(window)}function Kd(e){Dn=Dn===e?null:e,Dn&&!un[e]&&(un[e]="txns"),$t(),Dn&&setTimeout(()=>Ti(e,un[e]),60)}function Jd(e,t){un[e]=t;let n=document.getElementById(`wcard-drawer-${e}`);n&&(n.querySelectorAll(".wdt-btn").forEach(s=>s.classList.toggle("active",s.textContent.toLowerCase().includes(t==="txns"?"trans":t==="nfts"?"nft":t==="orders"?"dex":"amm"))),Ti(e,t))}async function Ti(e,t){var a,o,i;let n=oe.find(r=>r.id===e),s=document.getElementById(`wcard-drawer-body-${e}`);if(!(!n||!s)){s.innerHTML='<div class="wdd-loading"><div class="spinner"></div> Loading\u2026</div>';try{t==="txns"?s.innerHTML=cg(((a=mi[n.address])==null?void 0:a.txns)||await Pi(n.address),n.address):t==="nfts"?s.innerHTML=dg(((o=Jl[n.address])==null?void 0:o.nfts)||await kg(n.address),n.address):t==="orders"?s.innerHTML=pg(((i=fi[n.address])==null?void 0:i.offers)||await $g(n.address),n.id,n.address):t==="amm"&&(s.innerHTML=await ug(n.address))}catch(r){s.innerHTML=`<div class="wdd-error">\u26A0\uFE0F ${y(r.message)}</div>`}}}function Yd(e){return{Payment:"\u{1F4B8}",OfferCreate:"\u{1F4CA}",OfferCancel:"\u2715",TrustSet:"\u{1F517}",NFTokenMint:"\u{1F3A8}",NFTokenBurn:"\u{1F525}",NFTokenCreateOffer:"\u{1F3AF}",NFTokenAcceptOffer:"\u2705",AMMCreate:"\u{1F30A}",AMMDeposit:"\u{1F4E5}",AMMWithdraw:"\u{1F4E4}",AMMVote:"\u{1F5F3}",AMMBid:"\u{1F4A1}",EscrowCreate:"\u23F3",EscrowFinish:"\u2705",EscrowCancel:"\u2715",AccountSet:"\u2699",SetRegularKey:"\u{1F511}",SignerListSet:"\u{1F4CB}"}[e]||"\u{1F4C4}"}function di(e){return e?typeof e=="string"?`${_(Number(e)/1e6,4)} XRP`:`${_(parseFloat(e.value||0),4)} ${(e.currency||"?").length>4?e.currency.slice(0,4)+"\u2026":e.currency}`:"\u2014"}function cg(e,t){return e!=null&&e.length?`<div class="wdd-tx-list">
  ...
  </div>`:'<div class="wdd-empty"><div class="wdd-empty-icon">\u{1F4CB}</div><div>No transactions yet.</div><div class="wdd-empty-sub">Fund with 10 XRP to activate.</div></div>'}function dg(e,t){return e!=null&&e.length?`<div class="wdd-nft-header"><span>${e.length} NFT${e.length>1?"s":""}</span>
    ...
    ${e.length>24?`<div class="wdd-more-note">${e.length-24} more on XRPScan</div>`:""}`:'<div class="wdd-empty"><div class="wdd-empty-icon">\u{1F3A8}</div><div>No NFTs in this wallet.</div></div>'}function pg(e,t,n){return e!=null&&e.length?`<div class="wdd-orders-header"><span>${e.length} open order${e.length>1?"s":""}</span></div>
    ...
    </div>`:'<div class="wdd-empty"><div class="wdd-empty-icon">\u{1F4CA}</div><div>No open DEX orders.</div></div>'}async function ug(e){try{let n=(ui[e]||[]).filter(s=>{var a;return((a=s.currency)==null?void 0:a.length)===40});return n.length?`<div class="wdd-amm-list">
    ...
    <div class="act-section-row">
      <div class="act-section">
        ...
        ${t.length?`<div class="act-timeline">${t.slice(0,20).map(s=>`
            <div class="act-entry">
              <div class="act-entry-icon">${_f[s.type]||"\u25CF"}</div>
    ...
    <div class="settings-card settings-card--danger">
      ...
      <div class="analytics-card analytics-card--wide">
        ...
        ${n?gg(i):'<div class="analytics-empty">Activate a wallet to see activity.</div>'}
      </div>
      ...
      <div class="analytics-card">
        ...
        ${n&&i.length?yg(i,n.address):`<div class="analytics-empty-chart"><div class="aec-icon">\u{1F4B0}</div><div>${n?"XRP flow needs at least one transaction to estimate.":"Activate a wallet to see XRP flow."}</div></div>`}
      </div>
      ...
      <div class="analytics-card">
        ...
        ${o.length?bg(o):'<div class="analytics-empty-chart"><div class="aec-icon">\u{1FA99}</div><div>No token trustlines held by any wallet yet.</div></div>'}
      </div>
    </div>`}catch(n){Of(e,"analytics",n)}}}function Zd(e,t,n,s){if(e.length<2)return`<svg width="${t}" height="${n}"><line x1="0" y1="${n/2}" x2="${t}" y2="${n/2}" stroke="${s}" stroke-opacity=".2" stroke-width="1" stroke-dasharray="3 2"/></svg>`;let a=e.map(u=>u.xrp),o=Math.min(...a),i=Math.max(...a),r=i-o||1,l=a.map((u,p)=>`${3+p/(a.length-1)*(t-6)},${3+(1-(u-o)/r)*(n-6)}`),[c,d]=l[l.length-1].split(",");return`<svg width="${t}" height="${n}" viewBox="0 0 ${t} ${n}">
  ...
  </svg>`}function hg(e){let t=Ci(e);if(t.length<2)return`<div class="analytics-empty-chart"><div class="aec-icon">\u{1F4CA}</div><div>Balance history builds up as you refresh your wallet over time.</div><div class="aec-sub">${t.length} snapshot${t.length!==1?"s":""} recorded.</div></div>`;let n=560,s=130,a=52,o=12,i=14,r=30,l=t.map(R=>R.xrp),c=t.map(R=>R.ts),d=Math.min(...l),u=Math.max(...l),p=u-d||1,m=c[0],f=c[c.length-1],g=f-m||1,v=R=>a+(R-m)/g*(n-a-o),h=R=>i+(1-(R-d)/p)*(s-i-r),b=t.map(R=>`${v(R.ts).toFixed(1)},${h(R.xrp).toFixed(1)}`),w=v(c[0]),k=v(c[c.length-1]),$=l[l.length-1]-l[0],T=$>=0,S=l[0]?Math.abs($/l[0]*100).toFixed(2):"0.00",E=T?"#00d4ff":"#ff5555",P=[d,(d+u)/2,u].map(R=>({v:R,y:h(R),l:_(R,2)})),C=[0,.5,1].map(R=>({x:a+R*(n-a-o),l:new Date(m+R*g).toLocaleDateString("en-US",{month:"short",day:"numeric"})}));return`
  ...
  <div class="xrf-note">Based on ${e.length} fetched Payment TXs. Excludes fees and DEX fills.</div>`}async function ot(e){var n,s;try{if(((n=X.wsConn)==null?void 0:n.readyState)===1){let{wsSend:a}=await import("./xrpl-6AERZ5KD.js"),o={command:e==null?void 0:e.method,...((s=e==null?void 0:e.params)==null?void 0:s[0])||{}},i=await a(o);if((i==null?void 0:i.status)==="error")throw new Error(i.error_message||i.error||"XRPL RPC error");return(i==null?void 0:i.result)||null}}catch{}let t=async a=>{let o=await fetch(a,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(e),mode:"cors"});if(!o.ok)throw new Error(`HTTP ${o.status}`);return(await o.json()).result};try{return await t(pf)}catch{return await t(uf)}}async function Bn(e){var t;try{let n=[],s;do{let l=await ot({method:"account_lines",params:[{account:e,ledger_index:"current",limit:400,...s?{marker:s}:{}}]});if(!l||l.error)break;n.push(...l.lines||[]),s=l.marker}while(s);let a=await ot({method:"account_info",params:[{account:e,ledger_index:"current"}]});if(a!=null&&a.error)return null;let o=Number(a.account_data.Balance)/1e6,i=n.map(l=>({currency:l.currency,issuer:l.account,balance:l.balance,limit:l.limit}));et[e]={xrp:o,tokens:i,fetchedAt:Date.now()},ui[e]=i,xg(e,o);let r=document.getElementById("awb-balance");return r&&e===((t=Nt())==null?void 0:t.address)&&Xg(r.querySelector(".awb-xrp-num")||r,o,2,600),et[e]}catch{return null}}async function wg(){await Promise.allSettled(oe.map(e=>Bn(e.address))),$t(),Bt(),Fs()}function xg(e,t){let n=pi+e,s=ge(Q(n))||[],a=Date.now();s.length&&a-s[s.length-1].ts<5*6e4?s[s.length-1]={xrp:t,ts:a}:s.push({xrp:t,ts:a}),s.length>90&&s.splice(0,s.length-90),Z(n,JSON.stringify(s))}function Ci(e){return ge(Q(pi+e))||[]}async function Pi(e,t=25){let n=await ot({method:"account_tx",params:[{account:e,limit:t,ledger_index_min:-1,ledger_index_max:-1}]}),s=((n==null?void 0:n.transactions)||[]).map(a=>a.tx||a.transaction||a);return mi[e]={txns:s,fetchedAt:Date.now()},s}async function kg(e){let t=await ot({method:"account_nfts",params:[{account:e,limit:50}]}),n=(t==null?void 0:t.account_nfts)||[];return Jl[e]={nfts:n,fetchedAt:Date.now()},n}async function $g(e){let t=await ot({method:"account_offers",params:[{account:e,limit:50}]}),n=(t==null?void 0:t.offers)||[];return fi[e]={offers:n,fetchedAt:Date.now()},n}async function Sg(e){let t=await ot({method:"account_info",params:[{account:e,ledger_index:"current"}]});return(t==null?void 0:t.account_data)||null}async function Tg(){let e=await ot({method:"ledger",params:[{ledger_index:"current"}]});return(e==null?void 0:e.ledger_current_index)||0}function Cg(e){let t=(e==null?void 0:e.engine_result)||"";return t==="tesSUCCESS"||t.startsWith("tes")||(e==null?void 0:e.engine_result_code)===0}function Pg(e){let t=(e==null?void 0:e.engine_result)||"";return kf[t]||(e==null?void 0:e.engine_result_message)||t||"Unknown error"}async function Mg(e,t,n){if(await _a(),!window.xrpl)throw new Error("xrpl.js library not loaded. Cannot sign transactions.");let s=oe.find(i=>i.id===e);if(!s)throw new Error("Wallet not found.");if(s.watchOnly)throw new Error("Watch-only wallets cannot sign transactions.");let a=await Tf(s,n),o;try{o=window.xrpl.Wallet.fromSeed(a,{algorithm:s.algo==="secp256k1"?"secp256k1":"ed25519"})}catch(i){throw new Error("Invalid seed phrase: "+i.message)}if(o.classicAddress!==s.address)throw new Error("Seed does not match this wallet address.");try{let[i,r]=await Promise.all([Sg(s.address),Tg()]);if(!i)throw new Error("Account not found on-chain. Fund with at least 10 XRP first (base reserve requirement).");let l={...t,Account:s.address,Fee:"12",Sequence:i.Sequence,LastLedgerSequence:r+20},{tx_blob:c,hash:d}=o.sign(l);return{...await ot({method:"submit",params:[{tx_blob:c}]}),tx_hash:d}}finally{}}async function Lg(e,t,n){return Mg(e,{TransactionType:"OfferCancel",OfferSequence:parseInt(t)},n)}function Ag(){if(x("send-modal-overlay"))return;let e=document.createElement("div");e.innerHTML=`
  <!-- Send -->
  ...
  <div class="generic-modal-overlay" id="token-details-modal">
    ...
    </div>`,s.classList.add("show")}function Sp(){let e=x("token-details-modal");e&&(e.classList.remove("show"),e.style.display="")}function Tp(){var s;(s=document.getElementById("pub-profile-overlay"))==null||s.remove();let e=localStorage.getItem(mn),t=os.filter(a=>Ye[a.id]),n=document.createElement("div");n.id="pub-profile-overlay",n.className="pub-profile-overlay",n.innerHTML=`
    ...
    </div>`,document.body.appendChild(n),requestAnimationFrame(()=>requestAnimationFrame(()=>n.classList.add("show"))),n.addEventListener("click",a=>{a.target===n&&n.remove()})}function Cp(e){Mn(e),Xs(),kt("theme_changed",e)}function Pp(e){Z("nalulf_pref_currency",e),Xs(),ne(`Display currency: ${e}`)}function Mp(e){Z("nalulf_pref_network",e),Xs(),ne(`Default network: ${e}`)}function Lp(e){Z("nalulf_pref_autolock",e),Xs(),ne(`Auto-lock: ${e} minutes`)}window._profileWipeAllData=()=>{confirm("Clear all profile, wallet list, social, and activity data? Encrypted wallet seeds saved on this device will be deleted.")&&(["nalulf_profile","nalulf_wallets","nalulf_social","nalulf_activity_log","nalulf_avatar_img","nalulf_banner_img","naluxrp_active_wallet"].forEach(e=>localStorage.removeItem(e)),oe=[],Ye={},pt=null,et={},ui={},si(),U(),vi("wallets"),ne("Local data cleared"))};function Fg(){var e,t,n;(e=x("profile-editor-modal"))==null||e.addEventListener("click",s=>{s.target===s.currentTarget&&Hs()}),(t=x("wallet-creator-overlay"))==null||t.addEventListener("click",s=>{s.target===s.currentTarget&&zs()}),(n=x("social-modal"))==null||n.addEventListener("click",s=>{s.target===s.currentTarget&&rs()})}function Og(){let e=[{done:!!ce.displayName&&ce.displayName!=="Anonymous",label:"Display name"},{done:!!ce.bio,label:"Bio"},{done:ce.avatar!=="\u{1F30A}"||!!localStorage.getItem(mn),label:"Custom avatar"},{done:!!localStorage.getItem(Fn),label:"Custom banner"},{done:oe.length>0,label:"Wallet added"},{done:Object.keys(Ye).length>=1,label:"Social connected"},{done:!!ce.location,label:"Location set"},{done:!!ce.website,label:"Website added"}],t=e.filter(n=>n.done).length;return{pct:Math.round(t/e.length*100),done:t,total:e.length,checks:e}}function Bg(){let e=document.getElementById("profile-completeness");if(!e)return;let{pct:t,checks:n}=Og(),s=t===100?"#50fa7b":t>=60?"#00fff0":"#ffb86c",a=2*Math.PI*16,o=t/100*a,i=n.filter(r=>!r.done).map(r=>r.label);e.title=t===100?"Profile complete \u2713":`${t}% \u2014 Missing: ${i.join(", ")}`,e.innerHTML=`
    <div class="pc-wrap">
  ...
  `}function pv(e){var g,v,h,b;let t=e.ledgerIndex?Number(e.ledgerIndex):null;V("d2-ledger-index",t?t.toLocaleString():"\u2014");let n=((g=e.latestLedger)==null?void 0:g.closeTimeSec)!=null?Number(e.latestLedger.closeTimeSec):null,s=x("d2-ledger-age");if(s&&(n!=null?(s.textContent=`${n<2?n.toFixed(2):n.toFixed(1)}s close`,s.style.color=n<=3?"#50fa7b":n<=6?"#ffb86c":"#ff6e6e"):(s.textContent="Waiting\u2026",s.style.color="")),n!=null&&(Ja.push(n),Ja.length>cv&&Ja.shift(),uv()),zi=Date.now(),mv(),e.tps!=null){let w=Number(e.tps),k=x("d2-tps");k&&(k.textContent=w.toFixed(1),k.style.color=w<10?"rgba(255,255,255,.65)":w<40?"#50fa7b":w<80?"#ffb86c":"#ff6e6e");let $=x("d2-tps-trend");if($){let T=X.tpsHistory||[],S=T.length>2?(T.slice(-10).reduce((P,C)=>P+C,0)/Math.min(T.length,10)).toFixed(1):null,E=w<10?"Low":w<40?"Normal":w<80?"High":"Peak";$.textContent=S?`${E} \xB7 avg ${S}`:E,$.style.color=w<10?"rgba(255,255,255,.55)":w<40?"#50fa7b":w<80?"#ffb86c":"#ff6e6e"}}let a=(((v=e.latestLedger)==null?void 0:v.totalTx)??e.txPerLedger)||0,o=x("d2-tx-per-ledger");o&&(o.textContent=a>0?a.toLocaleString():"\u2014",o.style.color=a<10?"rgba(255,255,255,.65)":a<150?"#50fa7b":a<400?"#ffb86c":"#ff6e6e");let i=x("d2-tx-spread");i&&a>0&&(i.textContent=a<10?"Very light":a<50?"Light":a<150?"Normal":a<400?"High volume":"Very high volume",i.style.color=a<150?"":a<400?"#ffb86c":"#ff6e6e");let r=e.avgFee!=null?Number(e.avgFee):((h=e.latestLedger)==null?void 0:h.avgFee)!=null?Number(e.latestLedger.avgFee):null;if(r!=null){let w=Math.round(r*1e6),k=x("d2-fee-value");k&&(k.textContent=gn(r),k.style.color=w<=15?"#50fa7b":w<=50?"rgba(255,255,255,.9)":w<=200?"#ffb86c":"#ff6e6e");let $=x("d2-fee-delta");if($)if(Ii!=null){let S=r/Ii;S>1.05?($.textContent="\u2191",$.style.color="#ff6e6e",$.title=`+${((S-1)*100).toFixed(0)}% vs prev ledger`):S<.95?($.textContent="\u2193",$.style.color="#50fa7b",$.title=`-${((1-S)*100).toFixed(0)}% vs prev ledger`):($.textContent="\u2192",$.style.color="rgba(255,255,255,.35)",$.title="Stable vs prev ledger")}else $.textContent="";Ii=r;let T=x("d2-fee-pressure");if(T){let S=w<=15?"Base fee":w<=50?`${w} drops`:w<=200?`${w} drops \xB7 Elevated`:`${w} drops \xB7 Surge`;T.textContent=S,T.style.color=w<=50?"":w<=200?"#ffb86c":"#ff6e6e"}}let l=e.successRate!=null?Number(e.successRate):((b=e.latestLedger)==null?void 0:b.successRate)!=null?Number(e.latestLedger.successRate):null;if(l!=null){let w=x("d2-success-rate");w&&(w.textContent=`${l.toFixed(1)}%`,w.style.color=l>=90?"#50fa7b":l>=75?"#ffb86c":"#ff6e6e");let k=x("d2-success-note");if(k){let $=(100-l).toFixed(1);k.textContent=l>=90?`${$}% failed \xB7 Normal`:l>=75?`${$}% failed \xB7 Watch`:`${$}% failed \xB7 Alert`,k.style.color=l>=90?"":l>=75?"#ffb86c":"#ff6e6e"}}let c=a>0?Math.min(100,a/500*100):null,d=x("d2-network-capacity"),u=x("d2-capacity-note");c!=null&&(d&&(d.textContent=`${c.toFixed(1)}%`,d.style.color=c<20?"rgba(255,255,255,.65)":c<50?"#50fa7b":c<80?"#ffb86c":"#ff6e6e"),u&&(u.textContent=c<20?"Low usage":c<50?"Moderate":c<80?"Heavy":"Near capacity",u.style.color=c<50?"":c<80?"#ffb86c":"#ff6e6e"));let p=e.txTypes||{},m=Object.entries(p).sort(([,w],[,k])=>k-w);if(m.length){let[w,k]=m[0],$=m.reduce((C,[,R])=>C+R,0)||1,T=(k/$*100).toFixed(0),S=typeof It<"u"?It:{},E=x("d2-dominant-type");E&&(E.textContent=w,E.style.color=S[w]||"rgba(255,255,255,.9)");let P=x("d2-dominance-score");if(P){let C=m[1];P.textContent=C?`${T}% \xB7 2nd: ${C[0]}`:`${T}% of txs`}}let f=x("stream-loading");f&&(f.style.display="none")}function uv(){let e=x("d2-close-sparkline");if(!e||!e.getContext)return;let t=Ja;if(t.length<2)return;let n=e.width,s=e.height,a=e.getContext("2d");a.clearRect(0,0,n,s);let o=Math.max(...t,4),i=Math.floor((n-(t.length-1))/t.length),r=1;t.forEach((l,c)=>{let d=Math.max(3,Math.round(l/o*(s-2))),u=c*(i+r),p=s-d,m=l<=3?"rgba(80,250,123,.80)":l<=6?"rgba(255,184,108,.80)":"rgba(255,110,110,.85)";a.fillStyle=m;let f=Math.min(2,i/2);a.beginPath(),a.moveTo(u+f,p),a.lineTo(u+i-f,p),a.quadraticCurveTo(u+i,p,u+i,p+f),a.lineTo(u+i,s),a.lineTo(u,s),a.lineTo(u,p+f),a.quadraticCurveTo(u,p,u+f,p),a.closePath(),a.fill(),c===t.length-1&&(a.fillStyle="rgba(255,255,255,.18)",a.fillRect(u,p,i,Math.min(3,d)))})}function mv(){if(Ws&&cancelAnimationFrame(Ws),!Yt())return;let e=0,t=n=>{if(!Yt()){Ws=null;return}if(n-e>=120){e=n;let s=x("d2-ledger-age-timer");if(s&&zi>0){let a=(Date.now()-zi)/1e3;s.textContent=`${a.toFixed(1)}s ago`,s.style.color=a<4?"rgba(255,255,255,.55)":a<7?"#ffb86c":"#ff6e6e",s.style.opacity=a>=7?(.6+.4*Math.sin(Date.now()/300)).toFixed(2):"1"}}Ws=requestAnimationFrame(t)};Ws=requestAnimationFrame(t)}function fv(){let e=x("tx-mix");if(!e)return;let t=Object.entries(X.txMixAccum||{}).filter(([,s])=>s>0).sort(([,s],[,a])=>a-s).slice(0,10),n=t.reduce((s,[,a])=>s+a,0);n&&(e.innerHTML=t.map(([s,a])=>{let o=(a/n*100).toFixed(1),i=It[s]||"#6b7280";return`
      ...
      </div>`}).join(""))}var St=class{constructor(t,n="#00fff0",s="area"){this.canvasId=t,this.canvas=x(t),this.color=n,this.mode=s}_resolveCanvas(){return this.canvas||(this.canvas=x(this.canvasId)),this.canvas}draw(t){let n=this._resolveCanvas();if(!n||!(t!=null&&t.length))return;let s=n.getContext("2d");if(!s)return;let a=n.width=n.offsetWidth||300,o=n.height=n.offsetHeight||180;if(s.clearRect(0,0,a,o),t.length<2)return;let i=Math.min(...t)*.9,r=Math.max(...t)*1.05||1,l=v=>1-(v-i)/(r-i||1),c={l:10,r:10,t:10,b:12},d=a-c.l-c.r,u=o-c.t-c.b,p=d/(t.length-1),m=t.map((v,h)=>[c.l+h*p,c.t+l(v)*u]),f=bn(t);if(f!=null){let v=c.t+l(f)*u;s.beginPath(),s.moveTo(c.l,v),s.lineTo(c.l+d,v),s.strokeStyle="rgba(255,255,255,0.16)",s.lineWidth=1,s.stroke()}if(t.length>=Rp+2){let h=tv(t,Rp).map((b,w)=>[c.l+w*p,c.t+l(b)*u]);s.beginPath(),h.forEach(([b,w],k)=>k===0?s.moveTo(b,w):s.lineTo(b,w)),s.strokeStyle="rgba(255,255,255,0.22)",s.lineWidth=1.5,s.stroke()}if(this.mode==="bar"){let v=Math.max(1,p-3);t.forEach((h,b)=>{let w=(1-l(h))*u,k=c.l+b*p-v/2,$=s.createLinearGradient(0,c.t,0,c.t+u);$.addColorStop(0,this.color),$.addColorStop(1,this.color+"33"),s.fillStyle=$,s.fillRect(k,c.t+u-w,v,w)});return}let g=s.createLinearGradient(0,c.t,0,c.t+u);g.addColorStop(0,this.color+"aa"),g.addColorStop(1,this.color+"11"),s.beginPath(),m.forEach(([v,h],b)=>b===0?s.moveTo(v,h):s.lineTo(v,h)),s.lineTo(m.at(-1)[0],c.t+u),s.lineTo(m[0][0],c.t+u),s.closePath(),s.fillStyle=g,s.fill(),s.beginPath(),m.forEach(([v,h],b)=>b===0?s.moveTo(v,h):s.lineTo(v,h)),s.strokeStyle=this.color,s.lineWidth=2,s.lineJoin="round",s.stroke()}},ye={};function hv(){ye.tps=new St("chart-tps","#50fa7b","area"),ye.fee=new St("chart-fee","#ffb86c","area"),ye.tps2=new St("chart-tps2","#50fa7b","bar"),ye.fee2=new St("chart-fee2","#ffb86c","area"),ye.dexPressure=new St("chart-dex-pressure","#00d4ff","bar"),ye.nftMints=new St("chart-nft-mints","#bd93f9","bar"),ye.nftBurns=new St("chart-nft-burns","#ff5555","bar"),ye.autoBridge=new St("chart-autobridge","#f1fa8c","bar"),ye.marketPrice=new St("chart-market-price","#50fa7b","area"),ye.marketVol=new St("chart-market-vol","#8be9fd","bar")}function Ht(e,t=Qt){let n=ev(e,t).filter(r=>Number.isFinite(r));if(!n.length)return{cur:null,avg:null,deltaPct:null,vol:null};let s=n.at(-1),a=bn(n),o=Vi(n),i=a&&a!==0?(s-a)/a*100:null;return{cur:s,avg:a,deltaPct:i,vol:o}}function gv(){if(Bp)return;Bp=!0;let e=(t,n)=>{let s=x(t);if(!s)return;let a=s.closest(".widget-card"),o=a==null?void 0:a.querySelector(".widget-header");if(!o||document.getElementById(n))return;let i=document.createElement("div");i.className="trend-mini",i.id=n,i.innerHTML=`
    ...
    `,o.appendChild(i)};e("chart-tps","tpsTrendMini"),e("chart-fee","feeTrendMini"),e("chart-tps2","tpsTrendMini2"),e("chart-fee2","feeTrendMini2")}function qa(e,t,n,s){let a=document.getElementById(e);if(!a)return;let o=(i,r)=>{let l=a.querySelector(`[data-k="${i}"]`);l&&(l.textContent=r)};if(t.cur==null){o("now","\u2014"),o("avg","\u2014"),o("delta","\u2014"),o("sigma","\u2014");return}o("now",`${Number(t.cur).toFixed(n)}${s}`),o("avg",t.avg!=null?`${Number(t.avg).toFixed(n)}${s}`:"\u2014"),o("delta",t.deltaPct==null?"\u2014":yn(t.deltaPct,0)),o("sigma",t.vol==null?"\u2014":`${Number(t.vol).toFixed(Math.max(0,n-1))}${s}`)}function vv(){var n,s,a,o,i,r,l,c,d,u;(n=ye.tps)==null||n.draw(X.tpsHistory),(s=ye.fee)==null||s.draw(X.feeHistory),(a=ye.tps2)==null||a.draw(X.tpsHistory),(o=ye.fee2)==null||o.draw(X.feeHistory);let e=Ht(X.tpsHistory,Qt),t=Ht(X.feeHistory,Qt);qa("tpsTrendMini",e,2,""),qa("tpsTrendMini2",e,2,""),qa("feeTrendMini",t,0,"d"),qa("feeTrendMini2",t,0,"d"),(i=ye.dexPressure)==null||i.draw(fe.dexPressure),(r=ye.nftMints)==null||r.draw(fe.nftMints),(l=ye.nftBurns)==null||l.draw(fe.nftBurns),(c=ye.autoBridge)==null||c.draw(fe.autoBridge),(d=ye.marketPrice)==null||d.draw(fe.marketPrice),(u=ye.marketVol)==null||u.draw(fe.marketVol)}function bv(){let e=x("ledger-log"),t=x("ledger-log-loading"),n=x("ledger-log-count");if(!e||!(X.ledgerLog||[]).length)return;t&&(t.style.display="none"),n&&(n.textContent=X.ledgerLog.length);let s=x("tab-network");!s||s.style.display==="none"||(e.innerHTML=`<div class="ledger-log-row log-head">
      ...
      </div>`).join(""))}var Xt=[],Ya=new Set,Ge=0,Va=null,Us=0,Kt=0,ut=0,Jt=!0,Ga=0,_t=!1,Za=0,ji=!1,Vs=null,vn=0,fs=0,no=!1,yv=.18;function wv(){xv(),kv()}function xv(){let e=x("ledgerStreamParticles");if(e){e.innerHTML="";for(let t=0;t<14;t++){let n=document.createElement("div");n.className="ledger-particle",n.style.left=Math.random()*100+"%",n.style.top=20+Math.random()*60+"%",n.style.animationDuration=6+Math.random()*8+"s",n.style.animationDelay=Math.random()*5+"s",e.appendChild(n)}}}function kv(){if(Va)return;let e=x("ledgerStreamShell");e&&(e.addEventListener("mouseenter",()=>{_t=!0}),e.addEventListener("mouseleave",()=>{Gs||(_t=!1)}));let t=x("ledgerStreamTrack");t&&t.addEventListener("click",s=>{let a=s.target.closest("article.ledger-card");if(!a)return;let o=Number(a.dataset.ledgerIndex);Number.isFinite(o)&&(s.shiftKey?Vs===o?(Vs=null,Gs||(_t=!1),su()):(Vs=o,_t=!0,su()):$v(o))});let n=s=>{Us||(Us=s);let a=Math.min(.05,(s-Us)/1e3);Us=s;let o=Yt()?x("ledgerStreamTrack"):null;if(o&&Ge>0){if(Jt){let i=o.scrollWidth||0;if(i>100)ut=Math.floor(i/2),Jt=!1,Ga=0,Ge>0&&(vn=ut/Ge);else{Ga++,Ga>30&&(Jt=!1,Ga=0),Va=requestAnimationFrame(n);return}}if(ut>0&&!_t&&no){let i=Math.min(1,a/yv);Kt+=(fs-Kt)*i,Math.abs(fs-Kt)<.5&&(Kt=fs);let r=Kt%ut;o.style.transform=`translateX(${-r}px)`}if(!_t&&Math.floor(s/250)!==Math.floor((s-a*1e3)/250)){let i=Date.now(),r=o.querySelectorAll("article.ledger-card[data-arrival-ts]"),l=12e4;r.forEach(c=>{let d=i-Number(c.dataset.arrivalTs||i),u=Math.max(.52,1-d/l*.48);c.style.opacity=u.toFixed(3)})}if(Za>0){let i=Date.now()-Za>Kg;eo(i)}}Va=requestAnimationFrame(n)};Va=requestAnimationFrame(n),window.addEventListener("resize",()=>{Jt=!0})}function wu(){if(vn<=0||ut<=0||Ge===0)return Kt;let e=x("ledgerStreamShell"),t=e&&e.offsetWidth||800,n=vn-14,a=(Ge-1)*vn+n-t+18;a=Math.max(0,a);let i=Math.floor(Kt/ut)*ut+a;return i<Kt-2&&(i+=ut),i}function eo(e,t){if(e===ji)return;ji=e;let n=x("ledgerStreamShell");if(!n)return;let s=n.querySelector(".stream-stall-overlay");e?(s||(s=document.createElement("div"),s.className="stream-stall-overlay",n.appendChild(s)),s.innerHTML=`<span class="stream-stall-dot"></span> ${y(t||"Waiting for ledgers\u2026")}`):s==null||s.remove()}function su(){document.querySelectorAll(".ledger-card").forEach(e=>{let t=Number(e.dataset.ledgerIndex);e.classList.toggle("ledger-card--pinned",t===Vs)})}function $v(e){let t=document.querySelector('.dash-tab[data-tab="inspector"]');typeof window.switchTab=="function"&&t?window.switchTab(t,"inspector"):t==null||t.click();let n=document.getElementById("inspect-addr");n&&(n.placeholder=`Ledger #${e.toLocaleString()} \u2014 paste an address`,n.focus())}function Sv(){var t;let e=x("ledgerStreamShell");e&&(e.classList.remove("stream-reconnect-flash"),e.offsetWidth,e.classList.add("stream-reconnect-flash"),setTimeout(()=>e.classList.remove("stream-reconnect-flash"),1200),Zg=((t=us.at(-1))==null?void 0:t.li)??0,Tv())}function Tv(){let e=document.getElementById("reconnect-banner");if(!e){e=document.createElement("div"),e.id="reconnect-banner",e.className="reconnect-banner";let s=document.querySelector(".dashboard-col-main");s&&s.prepend(e)}e.style.display="",e.innerHTML=`
    ...
    <button onclick="document.getElementById('reconnect-banner').style.display='none'"
      style="margin-left:auto;background:none;border:none;color:inherit;opacity:.5;cursor:pointer;font-size:.9rem">\u2715</button>`;let t=3,n=setInterval(()=>{let s=document.getElementById("reconnect-countdown");if(s&&(s.textContent=t),t--,t<0){clearInterval(n);let a=document.getElementById("reconnect-banner");a&&(a.style.display="none")}},4e3)}function au(){let e=x("ledgerStreamTrack"),t=x("ledgerStreamShell"),n=x("stream-loading");if(!e||!t)return;if(n&&(n.style.display="none"),Xt.length===0){e.innerHTML='<div style="padding:40px;opacity:.6">Waiting for ledgers\u2026</div>',Ge=0,Jt=!0;return}let s=[...Xt].sort((o,i)=>o.ledgerIndex-i.ledgerIndex),a=s.map((o,i)=>ku(o,{prevIndex:i>0?s[i-1].ledgerIndex:null}));e.innerHTML=a.concat(a).join(""),Ge=s.length,Jt=!0,requestAnimationFrame(()=>{var i;let o=((i=x("ledgerStreamTrack"))==null?void 0:i.scrollWidth)||0;o>100&&(ut=Math.floor(o/2),vn=Ge>0?ut/Ge:0,fs=wu(),no=!0,Jt=!1)})}function Cv(e){var f,g;if(!e)return;let t=Number(e.ledgerIndex??NaN);if(!Number.isFinite(t)||Ya.has(t))return;Ya.add(t),Xt.push(e);let n=0;if(Xt.length>Ip){let v=Xt.splice(0,Xt.length-Ip);v.forEach(h=>Ya.delete(h.ledgerIndex)),n=v.length}Za=Date.now(),eo(!1),Mv(e.avgFee!=null?Number(e.avgFee):null);let{auraClass:s,domColor:a}=Lv(e);Su(s,a);let o=x("stream-loading");o&&(o.style.display="none");let i=x("ledgerStreamTrack");if(!i)return;if(Ge===0){au();return}let r=Xt.length>=2?Xt[Xt.length-2].ledgerIndex:0;if(t<r){au();return}let l=Ge,c=ku(e),d=document.createElement("template");d.innerHTML=c;let u=d.content.firstElementChild,p=i.children[l];p?i.insertBefore(u,p):i.appendChild(u);let m=document.createElement("template");if(m.innerHTML=c,i.appendChild(m.content.firstElementChild),Ge=l+1,n>0){for(let h=0;h<n;h++)(f=i.children[0])==null||f.remove();let v=Ge-n;for(let h=0;h<n;h++)(g=i.children[v])==null||g.remove();Ge-=n}Jt=!0,requestAnimationFrame(()=>{vn<=0&&ut>0&&Ge>0&&(vn=ut/Ge),fs=wu(),no=!0})}var hs=[],Pv=20;function Mv(e){e==null||!Number.isFinite(e)||(hs.push(e),hs.length>Pv&&hs.shift())}function xu(){return hs.length===0?null:hs.reduce((e,t)=>e+t,0)/hs.length}function ku(e,t={}){let{ledgerIndex:n,closeTimeSec:s,totalTx:a,txTypes:o,avgFee:i}=e,r=o||{},l=a??0,c=Object.entries(r).sort(([,D],[,F])=>F-D)[0],d=(c==null?void 0:c[0])||"Other",u=$u(d),p=typeof It<"u"?It:{},m=D=>p[D]||"#6b7280",f=m(d),g=ms(f,.45)||f,v=ms(f,.14)||f,h=s==null?"\u2014":s<2?`${Number(s).toFixed(2)}s`:`${Number(s).toFixed(1)}s`,b=l>0&&s>0?(l/s).toFixed(1):null,w=i!=null?Number(i):null,k=w!=null?gn(w):"\u2014",$=xu(),T=w!=null&&$!=null&&w>$*3,S=t.prevIndex!=null?Number(n)-t.prevIndex-1:0,E=S>0?`<div class="stream-gap-badge" title="${S} ledger(s) missing">\xB7\xB7\xB7&nbsp;${S} gap</div>`:"",P=D=>l>0?`${(D/l*100).toFixed(1)}%`:"0%",C=(D,F,O)=>F?`<div class="ledger-type-row">
    ...
    <div class="gateway-item gateway-row">
    ...
    </div>`).join("")}function zv(e){let t=x("d2-cluster-list"),n=x("d2-cluster-persistence");if(t){if(!e.length){t.innerHTML='<div class="gateway-item" style="opacity:.6">Building clusters\u2026 (needs repeated activity)</div>',n&&(n.textContent="\u2014");return}n&&(n.textContent=`${e.length} group${e.length!==1?"s":""}`),t.innerHTML=e.slice(0,6).map((s,a)=>{let i=`hsl(${(a*67+120)%360},70%,60%)`,r=s.members.slice(0,4);return`
      ...
      </div>`}).join("")}}function jv(e){let t=x("d2-delta-narratives");if(!t)return;if(!e.length){t.innerHTML='<div class="gateway-item" style="opacity:.6">Building baseline \u2014 narratives appear after 1\u20132 ledgers\u2026</div>';return}let n={up:"#50fa7b",down:"#ff5555",new:"#00d4ff",warn:"#ffb86c",ok:"rgba(255,255,255,.85)"};t.innerHTML=e.map(s=>{let a=n[s.sentiment]||"rgba(255,255,255,.85)",o=s.addr&&He(s.addr)?`<button class="addr-link narrative-addr" data-addr="${y(s.addr)}">Peek</button>`:"";return`
  ...
  `,t?t.insertAdjacentElement("afterend",s):n?n.insertAdjacentElement("afterend",s):e.prepend(s)}function qv(){if(Xp)return;Xp=!0;let e=document.querySelector(".dashboard-col-main");if(!e)return;let t=document.createElement("section");t.className="widget-card",t.id="landscape-card",t.setAttribute("aria-label","Landscape brief"),t.innerHTML=`
  ...
  `,e.prepend(t)}function Jv(e){var p,m;if(!document.getElementById("dex-pattern-card"))return;let t=e.window.total||0,n=t?Math.round(e.window.cancelRatio*100):0,s=t?Math.round(e.topShare*100):0;V("dexp-badge",t?`${t} offer tx \xB7 ${n}% cancels`:"Quiet");let a=x("dexp-cancel-bar");a&&(a.style.width=`${we(n,0,100)}%`),V("dexp-cancel-val",t?`${n}%`:"\u2014");let o=x("dexp-topshare-bar");o&&(o.style.width=`${we(s,0,100)}%`),V("dexp-topshare-val",t?`${s}%`:"\u2014");let i=e.burstPct,r=i==null?0:Math.min(100,Math.abs(i)),l=x("dexp-burst-bar");l&&(l.style.width=`${r}%`),V("dexp-burst-val",i==null?"\u2014":yn(i,0)),V("dexp-cpm",e.now.cancelsPerMin==null?"\u2014":e.now.cancelsPerMin.toFixed(1)),V("dexp-hhi",t?e.actorHHI.toFixed(2):"\u2014"),V("dexp-totalwin",t?`${t}`:"\u2014");let c=x("dexp-signals");c&&(c.innerHTML=e.signals.length?e.signals.map(f=>`<span class="sig-pill warn">${y(f)}</span>`).join(""):'<span class="sig-pill ok">No strong DEX signals</span>');let d=x("dexp-cancellers");d&&(d.innerHTML=(p=e.topCanceller)!=null&&p.length?e.topCanceller.slice(0,5).map(f=>`
        ...
        <div class="dex-rowline">
          <button class="addr-link mono cut" data-addr="${y(f.acct)}">${y(z(f.acct))}</button>
          <span class="mono">${f.count}</span>
        </div>`).join(""):'<div style="opacity:.7">\u2014</div>')}function Yv(){if(zp)return;zp=!0;let e=document.querySelector(".dashboard-col-main");if(!e)return;let t=document.createElement("section");t.className="widget-card",t.id="risk-card",t.setAttribute("aria-label","Risk panel"),t.innerHTML=`
    <div class="widget-header">
  ...
  `,e.appendChild(t),(s=x("spam-copy-hash"))==null||s.addEventListener("click",()=>{var i;return iu(((i=x("spam-proof-hash"))==null?void 0:i.textContent)||"")}),(a=x("spam-copy-json"))==null||a.addEventListener("click",()=>{var i;return iu(((i=x("spam-proof-json"))==null?void 0:i.textContent)||"")}),(o=x("spam-print-proof"))==null||o.addEventListener("click",mb),_renderBondSim()}window._toggleBondSim=function(){let e=x("spam-sim-panel");if(!e)return;let t=e.style.display!=="none";e.style.display=t?"none":"";let n=x("spam-sim-toggle");n&&(n.style.color=t?"":"#00d4ff")};window._renderBondSim=function(){let e=document.getElementById("sim-base"),t=document.getElementById("sim-growth"),n=document.getElementById("sim-table");if(!n)return;let s=Number((e==null?void 0:e.value)||vs),a=Number((t==null?void 0:t.value)||bs),o=fe.marketPrice.at(-1)??null;document.getElementById("sim-base-val")&&(document.getElementById("sim-base-val").textContent=s+" XRP"),document.getElementById("sim-growth-val")&&(document.getElementById("sim-growth-val").textContent=a+"\xD7");let i="";for(let r=0;r<=Ys;r++){let l=Math.round(s*a**r),c=o?"$"+(l*o).toLocaleString(void 0,{maximumFractionDigits:0}):"",d=r<3?"#50fa7b":r<6?"#ffb86c":"#ff5555";i+=`<div style="padding:5px;border-radius:6px;background:rgba(255,255,255,.03);border:1px solid rgba(255,255,255,.07)">
      ...
      ${c?`<div style="font-size:.62rem;opacity:.45">${c}</div>`:""}
          ...
          <div class="spam-card" data-spam-addr="${y(d.addr)}">
            ...
            <div class="spam-breakdown" id="spam-bd-${y(d.addr.slice(0,10))}" style="display:none">
              ${ib(d.breakdown,d.strikes)}
            </div>
          </div>`}).join(""):r.innerHTML=`<div class="spam-empty">No suspects flagged \u2014 allow-list has ${hu.size} known-good entities.</div>`),Wi||rb(),ie.selectedAddr){let d=ie.byAddr.get(ie.selectedAddr);d?Ji(ie.selectedAddr,d,e.s.ledgerIndex).then(u=>gs(u)):gs(null)}((l=document.getElementById("spam-sim-panel"))==null?void 0:l.style.display)!=="none"&&((c=window._renderBondSim)==null||c.call(window))}function ob(e){if(!(e!=null&&e.length))return"";let t=42,n=14,s=1,a=t/Math.max(1,e.length-1),o=e.map((l,c)=>`${(c*a).toFixed(1)},${(n-2-l/s*(n-4)).toFixed(1)}`).join(" "),i=e.at(-1)??0,r=i>=.7?"#ff5555":i>=.4?"#ffb86c":"#50fa7b";return`<svg width="${t}" height="${n}" xmlns="http://www.w3.org/2000/svg" style="overflow:visible">
    ...
    <circle cx="${((e.length-1)*a).toFixed(1)}" cy="${(n-2-i/s*(n-4)).toFixed(1)}"
      r="2" fill="${r}"/>
  </svg>`}function ib(e={},t=0){let n=[{label:"Bot timing",val:e.bot??0,desc:e.botType?`Type: ${e.botType}`:"Low variance in repeated ledger appearances"},{label:"DEX dominance",val:e.dexDom??0,desc:"Share of offer tx window controlled by this address"},{label:"Cancel pattern",val:e.cancelPat??0,desc:"Heavy OfferCancel activity relative to creates"},{label:"Ping-pong loop",val:e.pingPong??0,desc:"Bidirectional repeated payments between two addresses"},{label:"Path routing",val:e.pathRoute??0,desc:"High path-payment count \u2014 common in arb bots"},{label:"Self-transfer",val:e.selfTrade??0,desc:"Payments where sender = receiver"},{label:"Round-number pay",val:e.roundPay??0,desc:"Unusual bias toward exact round-number payment amounts"}].filter(s=>s.val>.001);return n.length?`
    ...
    </div>`:'<div style="opacity:.5;font-size:.78rem;padding:6px 0">No significant signal breakdown available yet.</div>'}var Wi=!1;function rb(){Wi||(Wi=!0,document.addEventListener("click",e=>{var a,o,i,r;let t=(o=(a=e.target).closest)==null?void 0:o.call(a,"button[data-action][data-spam-addr]");if(!t)return;let n=t.getAttribute("data-action"),s=t.getAttribute("data-spam-addr");if(s){if(n==="proof"){let l=ie.byAddr.get(s);if(!l)return;ie.selectedAddr=s;let c=x("spam-proof");if(c){c.style.display="";let d=x("spam-proof-hash");d&&(d.textContent="Computing SHA-512Half\u2026")}Ji(s,l,((r=(i=X.ledgerLog)==null?void 0:i[0])==null?void 0:r.ledgerIndex)||null).then(d=>{ie.selectedProof=d,gs(d)}).catch(d=>he("Proof build failed: "+d.message));return}if(n==="clear"){ie.byAddr.delete(s),ie.selectedAddr===s&&gs(null),ne("Cleared from session");return}if(n==="allow"){Pu(s),ie.byAddr.delete(s),ie.selectedAddr===s&&gs(null);return}if(n==="expand"){let l=s.slice(0,10),c=document.getElementById("spam-bd-"+l);if(!c)return;let d=c.style.display!=="none";c.style.display=d?"none":"",t.textContent=d?"\u25BE Detail":"\u25B4 Hide";return}}}))}function gs(e){let t=x("spam-proof");if(!t)return;if(!e){t.style.display="none";return}t.style.display="",V("spam-proof-hash",e.hash);let n=x("spam-proof-json");n&&(n.textContent=e.canonicalJson);let s=x("spam-cred-step");s&&(s.innerHTML=`
      <div style="opacity:.9">
    ...
    `)}function lb(e){var o,i,r,l,c;ie.allowList.size||Ki();let t=new Set;(((o=e.behavior)==null?void 0:o.bots)||[]).forEach(d=>t.add(d.acct)),(((i=e.dexPatterns)==null?void 0:i.topActor)||[]).forEach(d=>t.add(d.acct)),(((r=e.dexPatterns)==null?void 0:r.topCanceller)||[]).forEach(d=>t.add(d.acct)),(((l=e.dexPatterns)==null?void 0:l.topMaker)||[]).forEach(d=>t.add(d.acct)),(e.breadcrumbs||[]).forEach(d=>{t.add(d.from),t.add(d.to)}),(e.clusters||[]).forEach(d=>{t.add(d.hub),(d.members||[]).forEach(u=>t.add(u))}),(((c=e.advanced)==null?void 0:c.topPathActors)||[]).forEach(d=>t.add(d.acct));let n=Number(e.s.ledgerIndex||0)||null,s=e.txs||[],a=[];if(n&&n%50===0){let d=Ka*24;for(let[u,p]of ie.byAddr)n-(p.lastSeenLedger||0)>d&&ie.byAddr.delete(u)}for(let d of t){if(!He(d)||hu.has(d)||ie.allowList.has(d))continue;let{score:u,breakdown:p}=db(d,e),m=cb(p),f=ie.byAddr.get(d)||{strikes:0,level:0,score:0,verifiedLedger:null,lastSeenLedger:null,scoreHistory:[],threatType:"Unknown",signalBreakdown:{}},g=f.strikes||0;u>=uu?g+=1:u<=Oi&&(g=Math.max(0,g-1));let v=f.lastSeenLedger||n,h=n?n-v:0;if(h>Ka&&u<Oi){let S=Math.floor(h/Ka);g=Math.max(0,g-S)}let b=we(Math.floor(g/pu),0,Ys),w=[...f.scoreHistory||[],u].slice(-10),k=ie.verifiedCache.get(d),$=f.verifiedLedger??(k==null?void 0:k.ledgerIndex)??null;$||($=pb(d,b,s,n),$&&ub(d,b,n));let T={score:u,strikes:g,level:b,verifiedLedger:$,lastSeenLedger:n,scoreHistory:w,threatType:m,signalBreakdown:p};ie.byAddr.set(d,T),a.push({addr:d,score:u,strikes:g,level:b,verified:!!$,verifiedLedger:$,scoreHistory:w,threatType:m,breakdown:p})}return a.sort((d,u)=>u.level-d.level||u.score-d.score),a.slice(0,Jg)}function cb(e){let{bot:t=0,dexDom:n=0,cancelPat:s=0,pingPong:a=0,pathRoute:o=0,selfTrade:i=0,roundPay:r=0}=e,l=n+s;return t>.25&&(e.botType==="Flood / Spam"||r>.05)?"Payment Flooder":t>.2&&l>.15?"DEX Bot":l>.3&&s>.1?"Quote Stuffer":a>.1?"Wash Trader":o>.1?"Arb Router":t>.2?"Periodic Bot":"Multi-Signal"}function db(e,t){var m,f,g,v,h;let n={bot:0,botType:null,dexDom:0,cancelPat:0,pingPong:0,pathRoute:0,selfTrade:0,roundPay:0},s=(((m=t.behavior)==null?void 0:m.bots)||[]).find(b=>b.acct===e);if(s){let b=we((.35-s.cv)/.35,0,1);n.bot=+(.4*(.5+.5*b)).toFixed(3),n.botType=s.botType||"Periodic"}let a=t.dexPatterns,o=((g=(f=a==null?void 0:a.topActor)==null?void 0:f[0])==null?void 0:g.acct)===e&&a.topShare||0;o>0&&(n.dexDom=+(.3*we((o-.2)/.4,0,1)).toFixed(3));let i=((a==null?void 0:a.topCanceller)||[]).find(b=>b.acct===e);i&&(n.cancelPat=+(.2*we(i.count/20,0,1)).toFixed(3));let r=t.breadcrumbs||[],l=r.find(b=>b.from===e&&b.to===e);l&&(n.selfTrade=+(.2*we(l.count/20,0,1)).toFixed(3));let c=r[0];if(c&&(c.from===e||c.to===e)){let b=r.find(w=>w.from===c.to&&w.to===c.from);b&&b.count>=3&&c.count>=3&&(n.pingPong=.15)}let d=(((v=t.advanced)==null?void 0:v.topPathActors)||[]).find(b=>b.acct===e);d&&(n.pathRoute=+(.15*we(d.count/25,0,1)).toFixed(3));let u=(h=t.advanced)==null?void 0:h.roundnessIdx;return u!=null&&u>=45&&(d||s)&&(n.roundPay=+(.1*we((u-45)/35,0,1)).toFixed(3)),{score:we(n.bot+n.dexDom+n.cancelPat+n.pingPong+n.pathRoute+n.selfTrade+n.roundPay,0,1),breakdown:n}}function pb(e,t,n,s){if(!(n!=null&&n.length))return null;let a=ps+t;for(let o of n)if((o==null?void 0:o.account)===e){if(o.type==="EscrowCreate"&&o.destination===e){let i=typeof o.amountXrp=="number"?o.amountXrp:null,r=Ks(t);if(i!=null&&i>=r&&Ui(o.memos).startsWith(hn))return s}if(o.type==="Payment"&&o.destination===e&&Number(o.destinationTag)===a&&Ui(o.memos).startsWith(hn))return s}return null}async function ub(e,t,n){var a;let s=ie.byAddr.get(e);if(s)try{let o=await Ji(e,s,n),i=hn+o.hash;if((((a=X.ledgerLog)==null?void 0:a.flatMap(c=>c.transactions||[]))||[]).some(c=>(c==null?void 0:c.account)!==e?!1:Ui(c.memos).startsWith(i))){let c=Mu();c[e]={ledgerIndex:n,hash:o.hash,level:t},sb(c),ie.verifiedCache.set(e,{ledgerIndex:n,hash:o.hash}),ne(`\u2714 Credential verified for ${z(e)} at L${t}`)}}catch{}}function Ui(e){if(!Array.isArray(e))return"";let t=[];for(let n of e){let s=(n==null?void 0:n.Memo)||(n==null?void 0:n.memo)||null;if(!s)continue;let a=s.MemoData||s.memo_data||"";try{if(typeof a=="string"&&/^[0-9A-Fa-f]+$/.test(a)&&a.length%2===0){let o=Uint8Array.from(a.match(/../g),i=>parseInt(i,16));t.push(new TextDecoder().decode(o))}else typeof a=="string"&&t.push(a)}catch{}}return t.join(" ")}async function Ji(e,t,n){let s=t.level||0,a=Ks(s),o=fe.marketPrice.at(-1)??null,i=o?(a*o).toFixed(2):null,r={hashAlgorithm:"SHA-512Half",ratchetMax:Ys,strikesToLevel:pu,strikeUp:uu,strikeDown:Oi,decayLedgers:Ka,bondBaseXrp:vs,bondGrowthFactor:bs,bondRequiredXrp:a,bondRequiredUsd:i,credTagBase:ps,memoPrefix:hn,credentialTag:ps+s},l={v:2,hashAlg:"SHA-512Half",network:X.currentNetwork||"xrpl-mainnet",address:e,ledgerIndex:n!=null?Number(n):null,level:s,threatType:t.threatType||"Unknown",score:Number((t.score||0).toFixed(4)),strikes:Number(t.strikes||0),signalBreakdown:t.signalBreakdown||{},credential:{destinationTag:ps+s,memoFormat:hn+"<SHA-512Half-of-this-proof>",verifiedLedger:t.verifiedLedger??null},policy:r,note:"Generated by NaluXRP Spam Defense POC. Hash uses XRPL-native SHA-512Half (first 256 bits of SHA-512). A gateway or relayer policy can require the indicated bond/credential before providing service to this address.",generatedAt:new Date().toISOString()},c=JSON.stringify(l,Object.keys(l).sort(),0),d=await nv(c);l.credential.memoFormat=hn+d;let u=JSON.stringify(l,null,2);return{hash:d,canonicalJson:u,level:s,policy:r,threatType:t.threatType}}function mb(){let e=ie.selectedProof;if(!e){he("Generate a proof first using the Proof button.");return}let t=ie.selectedAddr||"\u2014",n=fe.marketPrice.at(-1)??null,s=e.policy.bondRequiredXrp,a=n?` (~$${(s*n).toFixed(0)} USD)`:"",o=e.hash.startsWith("FALLBACK")?'<div style="padding:8px 12px;background:#fff3cd;border:1px solid #f0ad4e;border-radius:4px;margin-bottom:12px">\u26A0 Hash is non-cryptographic (SubtleCrypto unavailable). Do NOT use for enforcement.</div>':"",i=window.open("","_blank","width=760,height=660");i.document.write(`<!DOCTYPE html><html><head>
    ...
    </body></html>`),i.document.close()}var Au=null;function fb(){if(Bi)return;Bi=!0;let e=document.querySelector('[aria-label="Pattern detection"]');if(!e){e=document.createElement("section"),e.className="widget-card",e.setAttribute("aria-label","Pattern detection");let t=document.querySelector(".dashboard-col-main");if(!t)return;let n=t.querySelector(".dashboard-metrics");n?n.insertAdjacentElement("afterend",e):t.prepend(e)}e.innerHTML=`
    <div class="widget-header">
    ...
    </div>`,Au=document.getElementById("pattern-donut-canvas")}function hb(e,t){if(!Bi)return;let n=typeof It<"u"?It:{},s=Object.entries(e||{}).filter(([,m])=>m>0).sort(([,m],[,f])=>f-m);if(!s.length)return;let a=s.reduce((m,[,f])=>m+f,0)||1,[o,i]=s[0],r=Math.round(i/a*100),l=s[1],c=x("pattern-badge");c&&(c.textContent=o+" \xB7 "+r+"%");let d=x("pattern-dom-type");if(d&&(d.textContent=o,d.style.color=n[o]||"rgba(255,255,255,.9)"),V("pattern-dom-pct",r+"% of ledger"),l){let m=Math.round(l[1]/a*100),f=x("pattern-2nd-type");f&&(f.textContent=l[0]+" ("+m+"%)",f.style.color=n[l[0]]||"rgba(255,255,255,.7)")}else V("pattern-2nd-type","\u2014");let u=x("pattern-hhi");u&&t!=null&&(u.textContent=t.toFixed(3),u.style.color=t>=.35?"#ff5555":t>=.25?"#ffb86c":"#50fa7b");let p=x("pattern-donut-center");p&&(p.innerHTML='<span style="color:'+(n[o]||"#fff")+';font-size:1.15rem">'+r+"%</span>"),gb(s,a,n)}function gb(e,t,n){let s=Au||x("pattern-donut-canvas");if(!(s!=null&&s.getContext))return;let a=s.getContext("2d"),o=s.width/2,i=s.height/2,r=Math.min(s.width,s.height)/2-6,l=r*.56;a.clearRect(0,0,s.width,s.height);let c=e.slice(0,7),d=e.slice(7).reduce((m,[,f])=>m+f,0),u=d>0?[...c,["Other",d]]:[...c],p=-Math.PI/2;for(let[m,f]of u){let g=f/t*Math.PI*2,v=ms(n[m]||"#6b7280",.88)||"#6b7280";a.beginPath(),a.moveTo(o+Math.cos(p)*l,i+Math.sin(p)*l),a.arc(o,i,r,p,p+g),a.arc(o,i,l,p+g,p,!0),a.closePath(),a.fillStyle=v,a.fill(),a.strokeStyle="rgba(0,8,20,0.85)",a.lineWidth=2,a.stroke(),p+=g}a.beginPath(),a.arc(o,i,l-1,0,Math.PI*2),a.fillStyle="rgba(0,21,36,0.94)",a.fill()}function vb(e,t){let n=!1;for(let s of e){if((s==null?void 0:s.type)!=="Payment")continue;let a=typeof(s==null?void 0:s.amountXrp)=="number"?s.amountXrp:null;a==null||a<Hn.whaleTxXrp||(Dt.unshift({ts:Date.now(),ledgerIndex:t,from:s.account||"\u2014",to:s.destination||"\u2014",amtXrp:a,hash:s.hash||""}),tt.whaleCount++,n=!0)}if(n){for(;Dt.length>Yg;)Dt.pop();yb()}}function bb(){if(Jp)return;Jp=!0;let e=document.querySelector(".dashboard-col-side");if(!e)return;let t=document.createElement("section");t.className="widget-card",t.id="whale-feed-card",t.setAttribute("aria-label","Whale alert feed"),t.innerHTML=`
    <div class="widget-header">
    ...
    </div>`,e.prepend(t)}function yb(){let e=x("whale-feed-list");if(!e)return;let t=x("whale-badge");if(t&&(t.textContent=Dt.length?`${Dt.length} alerts`:"Watching\u2026"),!Dt.length){e.innerHTML='<div style="opacity:.5;font-size:.82rem;padding:8px 0">No whale transactions yet.</div>';return}e.innerHTML=Dt.slice(0,20).map(n=>{let s=n.amtXrp>=1e6?`${(n.amtXrp/1e6).toFixed(2)}M`:n.amtXrp>=1e3?`${(n.amtXrp/1e3).toFixed(0)}K`:n.amtXrp.toFixed(0),a=Math.floor((Date.now()-n.ts)/1e3),o=a<60?`${a}s`:a<3600?`${Math.floor(a/60)}m`:`${Math.floor(a/3600)}h`;return`<div style="border-bottom:1px solid rgba(255,255,255,.05);padding:7px 0">
    ...
    </div>`}).join("")}function wb(){if(Yp)return;Yp=!0;let e=document.querySelector(".dashboard-col-main");if(!e)return;let t=document.createElement("section");t.className="widget-card",t.id="network-health-card",t.setAttribute("aria-label","Network health"),t.innerHTML=`
    <div class="widget-header">
    ...
    <div style="display:flex;align-items:center;gap:16px;padding:8px 0 12px">
      ...
      </div>`}).join(""))}function kb(){if(Qp)return;Qp=!0;let e=document.querySelector(".dashboard-col-side");if(!e)return;let t=document.createElement("section");t.className="widget-card",t.id="session-stats-card",t.setAttribute("aria-label","Session stats"),t.innerHTML=`
    <div class="widget-header">
    ...
    </div>`,e.appendChild(t)}function $b(){if(!document.getElementById("session-stats-card"))return;let e=Math.floor((Date.now()-tt.startTime)/6e4);V("ss-ledgers",tt.ledgersProcessed.toLocaleString()),V("ss-tx",tt.totalTx.toLocaleString()),V("ss-whales",tt.whaleCount),V("ss-feespikes",tt.feeSpikes),V("ss-bots",tt.botDetections),V("ss-dexalerts",tt.dexAlerts),V("ss-time",`${e}m`),V("ss-badge",`${tt.ledgersProcessed} ledgers`)}function Sb(e,t){var o,i,r,l,c,d,u,p;if(gu=t,Dt.length&&Dt[0].ledgerIndex===t){let m=Dt[0],f=m.amtXrp>=1e6?`${(m.amtXrp/1e6).toFixed(1)}M`:`${(m.amtXrp/1e3).toFixed(0)}K`;ne(`\u{1F40B} Whale: ${f} XRP  ${z(m.from)} \u2192 ${z(m.to)}`)}let n=xu(),s=(o=X.feeHistory)==null?void 0:o.at(-1);s&&n&&s>n*Hn.feeSpikeMultiple&&(tt.feeSpikes++,he(`\u{1F525} Fee spike: ${gn(s)} (${Math.round(s/n)}\xD7 baseline)`));let a=(((i=e.behavior)==null?void 0:i.bots)||[]).filter(m=>m.cv<Hn.botCvThreshold&&m.total>8);a.length&&(tt.botDetections=Math.max(tt.botDetections,a.length),a[0].botType==="Flood / Spam"&&he(`\u{1F916} Spam bot: ${z(a[0].acct)} (CV ${a[0].cv.toFixed(2)})`)),((l=(r=e.dexPatterns)==null?void 0:r.window)==null?void 0:l.cancelRatio)>=Hn.dexCancelAlert&&((d=(c=e.dexPatterns)==null?void 0:c.window)==null?void 0:d.total)>=20&&(tt.dexAlerts++,he(`\u{1F9E0} DEX: ${Math.round(e.dexPatterns.window.cancelRatio*100)}% cancel ratio \u2014 possible quote-stuffing`)),((p=(u=e.clusters)==null?void 0:u[0])==null?void 0:p.size)>=Hn.clusterMinSize&&ne(`\u{1F578} Cluster: ${e.clusters[0].size} wallets around ${z(e.clusters[0].hub)}`),e.friction>=75&&e.regime==="Manipulated"&&he(`\u26A0\uFE0F Risk score: ${e.friction}/100 \u2014 ${e.regime} regime`),xb(e.s)}function Tb(){var n,s,a,o;if(Zp)return;Zp=!0;let e=document.createElement("button");e.id="customize-btn",e.className="customize-btn",e.setAttribute("aria-pressed","false"),e.innerHTML="\u2699 Customize",(n=document.querySelector(".dashboard-header"))==null||n.appendChild(e);let t=document.createElement("div");t.id="customize-panel",t.className="customize-panel",t.setAttribute("aria-label","Dashboard customizer"),t.innerHTML=`
  ...
  `;t.innerHTML=n+a+s+f}var Fu=["#00d4ff","#bd93f9","#50fa7b","#ffb86c","#8be9fd","#ff79c6","#f1fa8c","#6272a4"],Ou=8;function Hy(e){let t=document.getElementById("inspect-volconc-body");if(!t)return;let n=e.signals.map(Tt).join(""),s=(e.concentrations||[]).filter(a=>{var o;return(o=a.shares)==null?void 0:o.length}).map(a=>{let o=a.shares.slice(0,Ou),i=a.shares.slice(Ou).reduce((c,d)=>c+d,0),l=[...o.map((c,d)=>({pct:c*100,color:Fu[d%Fu.length],label:`Cluster #${d+1}`})),...i>1e-4?[{pct:i*100,color:"rgba(255,255,255,.12)",label:`Other (${a.shares.length-o.length} cluster(s))`}]:[]].map(c=>`<div class="volconc-seg" style="width:${c.pct.toFixed(2)}%;background:${c.color}" data-tooltip="${y(`${c.label}: ${c.pct.toFixed(1)}% of volume`)}"></div>`).join("");return`
      <div class="volconc-card">
        <div class="volconc-card-hdr">
          <span class="mono">${y(a.currency.slice(0,10))}</span>
    ...
    ${h}`}function Vy(e,t,n,s,a,o,i,r=null,l=null,c=!1){let d=x("inspect-addr-badge");d&&(d.textContent=e.length>20?e.slice(0,10)+"\u2026"+e.slice(-8):e,d.title=e,d.dataset.fullAddr=e);let u=x("inspect-risk-score");u&&(u.textContent=i,u.className="irb-score-val "+sr(i));let p=x("inspect-risk-label");p&&(p.textContent=i<20?"Low Risk":i<45?"Moderate":i<70?"High Risk":"Critical",p.className="irb-score-label "+sr(i));let m=x("inspect-acct-grid");if(!m)return;let f=Math.max(0,n-s),g=Number(t.Flags||0),v=r!=null?r===0?"Created today":r===1?"1 day old":r<30?`${r} days old`:r<365?`${Math.floor(r/30)} months old`:`${(r/365).toFixed(1)} years old`:"\u2014",h=l?new Date(l).toLocaleDateString("en-US",{year:"numeric",month:"short",day:"numeric"}):null,b=h?c?`Created ${h}`:`Created ${h} (estimated \u2014 full history not confirmed)`:null,w=xn(n),k=xn(f),$=[{label:"XRP Balance",value:`${_(n,6)} XRP${w}`,mono:!0},{label:"Spendable",value:`${_(f,6)} XRP${k}`,mono:!0,note:`${s} XRP reserved`},{label:"Wallet Age",value:v,note:b,highlight:r!=null&&r<7?"new":null},{label:"Owner Count",value:a,note:`${a*2} XRP tied up`},{label:"Sequence",value:o,mono:!0},{label:"Regular Key",value:t.RegularKey?z(t.RegularKey):"None",warn:!!t.RegularKey,mono:!0},{label:"Master Key",value:g&_e.lsfDisableMaster?"Disabled":"Active",warn:!!(g&_e.lsfDisableMaster)}];m.innerHTML=$.map(T=>`
...
${I.type||""}`;return`<circle cx="${w(I.date).toFixed(1)}" cy="${k(I.balanceAfter).toFixed(1)}" r="2.2" fill="#00d4ff" opacity=".55" data-tooltip="${y(D)}" style="cursor:pointer"></circle>`}).join(""),R=Object.keys(ao).some(I=>(t||[]).some(D=>D.classification===I))?`<div class="balance-chart-legend">${Object.entries(ao).filter(([I])=>(t||[]).some(D=>D.classification===I)).map(([I,D])=>`<span class="balance-chart-legend-item"><span class="balance-chart-legend-swatch" style="background:${D}"></span>${y(I)}</span>`).join("")}</div>`:"";s.innerHTML=`
    <div style="font-size:.65rem;color:rgba(255,255,255,.35);text-transform:uppercase;letter-spacing:.08em;margin-bottom:6px">
      Balance Reconstruction \u2014 ${$(p)} to ${$(m)} \xB7 peak ${_(h,2)} XRP
    </div>
    ...
    ${R}`}function Jy(e,t,n,s){let a=x("inspect-drain-body");if(!a)return;let o={low:"#50fa7b",medium:"#ffb86c",high:"#ff8c42",critical:"#ff5555",none:"#50fa7b"},i={low:"\u2713",medium:"\u26A0",high:"\u26A0",critical:"\u26D4",none:"\u2713"},r=e.compromiseRiskLevel??e.riskLevel,l=e.assetDrainSeverity??"none";a.innerHTML=`
  ...
  `,Ky(e.balanceHistory,e.episodes,"inspect-drain-chart"),T0("badge-drain",e.riskLevel)}function Yy(e,t){let n=x("inspect-nft-body");n&&(n.innerHTML=`
    <div class="audit-items">
    ...
    `:""}
  `,po("badge-nft",e.flags))}function Qy(e){let t=Number(e.Flags||0),n=!!(t&Nu.lsfTransferable),s=!!(t&Nu.lsfBurnable),a=e.NFTokenTaxon||0,o=e.TransferFee?`${(e.TransferFee/1e3).toFixed(1)}%`:"0%";return`
    <div class="nft-card">
    ...
    </div>`}function Zy(e){let t=x("inspect-wash-body");if(!t)return;let n=e.verdict==="clean"||e.verdict==="low-risk"?"#50fa7b":e.verdict==="suspicious"?"#ffb86c":"#ff5555";t.innerHTML=`
  ...
  `;let s=x("badge-wash");if(s){let a=e.verdict==="clean"||e.verdict==="low-risk"?"ok":e.verdict==="suspicious"?"warn":"crit";s.textContent=e.verdict.replace("-"," "),s.className="section-badge section-badge--"+a}}function Qs(e,t){return`<div class="wash-stat"><span class="wash-stat-label">${y(e)}</span><span class="wash-stat-val">${t}</span></div>`}function e0(e,t){let n=x("inspect-issuer-body");if(!n)return;let s=t.filter(a=>a.currency&&(a.currency.length===3||a.currency.length===40));n.innerHTML=`
    <div class="audit-items">
      ${e.signals.map(a=>Un(a)).join("")}
    </div>
    ${s.length?`
  ...
  `,po("badge-issuer",e.signals)}function t0(e){let n=e.tvl!=null&&e.tvl2!=null?`
    ...
    <div class="amm-owner-gauge"><div class="amm-owner-gauge-fill" style="width:${Math.min(100,e.ownerPct).toFixed(2)}%"></div></div>`:"",a=[e.feeRate!=null?`<div class="wash-stat-row"><span>Trading fee</span><span class="mono">${e.feeRate.toFixed(2)}%</span></div>`:"",e.costBasisXrp!=null?`<div class="wash-stat-row"><span>Net contributed (cost basis)</span><span class="mono">${_(e.costBasisXrp,2)} XRP</span></div>`:""].join("");return n||s||a?`<div class="amm-position-visual">${n}${s}${a}</div>`:""}function n0(e,t){let n=x("inspect-amm-body");n&&(n.innerHTML=`
    <div class="audit-items">
  ...
  `,po("badge-amm",e.signals))}function s0(e){let t=x("trust-count-badge");t&&(t.textContent=e.length);let n=x("inspect-trust-body");n&&(n.innerHTML=e.length?e.map(s=>{let a=s.freeze?'<span class="trustline-frozen">Frozen</span>':"",o=s.freeze_peer?'<span class="trustline-frozen trustline-frozen--peer">Issuer Frozen</span>':"",i=s.no_ripple?'<span class="trustline-norip">NoRipple</span>':"";return`
          <div class="trustline-row">
          ...
          </div>`}).join(""):'<div class="inspect-empty-note">No transactions found.</div>',e.length>s&&(n.innerHTML+=`<div class="tx-more">Showing ${s} of ${e.length} transactions</div>`)}function em(e,t,n){let s=Number((n==null?void 0:n.totalIn)||0),a=Number((t==null?void 0:t.totalOut)||0),o=Number(e||0);if(s<=0&&a<=0)return'<div class="inspect-empty-note">No inbound or outbound XRP flow found in the analysed transaction history.</div>';let i=new Set(((t==null?void 0:t.blackHoleDests)||[]).map(k=>k.addr)),r=new Set(((t==null?void 0:t.exchangeDests)||[]).map(k=>k.addr)),l=new Set(((t==null?void 0:t.newWalletDests)||[]).map(k=>k.addr)),c=0,d=0,u=0,p=0;for(let k of(t==null?void 0:t.destinations)||[])i.has(k.addr)?c+=k.totalXrp:r.has(k.addr)?d+=k.totalXrp:l.has(k.addr)?u+=k.totalXrp:p+=k.totalXrp;let m=Math.max(s,a,o,1),f=k=>(k>0?Math.max(1.5,k/m*100):0).toFixed(1),g=[{label:"Black hole",xrp:c,color:wn.blackhole},{label:"Exchange",xrp:d,color:wn.exchange},{label:"New wallet",xrp:u,color:wn.newWallet},{label:"Other",xrp:p,color:wn.other}].filter(k=>k.xrp>0),v=a>0?Math.max(1.5,a/m*100):0,h=g.map(k=>`<div style="width:${(a>0?k.xrp/a*100:0).toFixed(1)}%;background:${k.color};height:100%" title="${y(k.label)}: ${_(k.xrp,2)} XRP"></div>`).join(""),b=(k,$,T,S,E)=>`
          ...
          <div class="flow-dest-row">
            ...
            <div class="flow-dest-info">
              ...
              <div class="flow-dest-meta">
                ...
                ${c.txCount>1?`<span class="flow-dest-span">${tm(c.firstSeen,c.lastSeen)}</span>`:""}
              </div>
            </div>
          </div>`}).join("")}
    </div>
  ...
  `,a){let c=e.blackHoleDests.length||e.exchangeDests.length>2;a.textContent=`${e.uniqueDests} dests`,a.className=`section-badge section-badge--${c?"crit":e.uniqueDests>0?"warn":"ok"}`}}function tm(e,t){if(!e||!t)return"";let n=new Date(e*1e3).toLocaleDateString(),s=new Date(t*1e3).toLocaleDateString();return n===s?n:`${n} \u2013 ${s}`}function i0(e,t){let n=x("inspect-issuer-connections-body");if(!n)return;let s=e.totalIssued,a=x("badge-issuer-connections");if(n.innerHTML=`
    <div class="audit-items">
  ...
  `,a){let o=e.signals.some(i=>i.sev==="critical")?"crit":e.signals.some(i=>i.sev==="warn")?"warn":e.signals.some(i=>i.sev==="info")?"neutral":"ok";a.className=`section-badge section-badge--${o}`,a.textContent=s>0?`${e.holderCount} holders`:"No issuance"}}function r0(e){var c;let t=document.getElementById("inspect-fee-analysis-body");if(!t||!e)return;let n=(e.signals||[]).map(Tt).join(""),s=e.avgFeeMultiplier!=null?`
    ...
    ${e.selfRoutedCount?`<div class="wash-stat-row"><span>Self-routed payments</span><span class="mono risk-text-high">${e.selfRoutedCount}</span></div>`:""}`;if(n.innerHTML=a+o,s){let r=e.signals.some(c=>c.sev==="critical"),l=e.signals.some(c=>c.sev==="warn");s.textContent=r?"Critical":l?"Check":"Normal",s.className=`section-badge section-badge--${r?"crit":l?"warn":"ok"}`}}function d0(e){var i,r,l;let t=x("inspect-inbound-body");if(!t)return;let n=(e.signals||[]).map(Tt).join(""),s=`
    ...
    </div>`}).join("");n.innerHTML=s+`<div style="margin-top:10px">${a}</div>`;let o=x("badge-checks");o&&(o.textContent=`${e.checks.length} check${e.checks.length!==1?"s":""}`,o.className="section-badge section-badge--neutral")}function f0(e){let t=x("section-livebook"),n=x("inspect-livebook-body");if(t&&(t.style.display=""),!n)return;if(!(e!=null&&e.hasData)){n.innerHTML='<div class="inspect-empty-note">No live order book activity found for this wallet.</div>';let i=x("badge-livebook");i&&(i.textContent="None",i.className="section-badge section-badge--neutral");return}let s=(e.signals||[]).map(Tt).join(""),a=`
    <div class="wash-stat-row" style="margin-top:10px">
    ...
    ${e.wallShare>.3?`<div class="wash-stat-row"><span>Largest single order share</span><span class="mono ${e.wallShare>.4?"risk-text-high":"risk-text-med"}">${(e.wallShare*100).toFixed(1)}%</span></div>`:""}`;n.innerHTML=s+a;let o=x("badge-livebook");if(o){let i=(e.signals||[]).some(l=>l.sev==="critical"),r=(e.signals||[]).some(l=>l.sev==="warn");o.textContent=i?"Wall order":r?"Check":"Normal",o.className=`section-badge section-badge--${i?"crit":r?"warn":"ok"}`}}function h0(e,...t){let n=x("inspect-risk-breakdown");if(!n)return;let s=Fy(e,...t);if(!s.length){n.innerHTML="";return}let a=Math.max(1,s.reduce((o,i)=>o+i.pts,0));n.innerHTML=`
    ...
    </div>`}function nm(e,t,n,s){let a=(o,i,r,l)=>l&&l.length?`<div class="audit-evidence-group audit-epistemic-group audit-epistemic--${o}">
    ...
    <div class="audit-row audit-row--${e}">
      ...
      <div class="audit-text">
        ...
        ${o!=null&&o.length||i!=null&&i.length||r?nm(a,o,i,r):p("Observed",a)}
    ...
    <div class="finding finding--${e.sev}">
      ...
      <div class="finding-body">
        ...
        ${(s=e.calculated)!=null&&s.length||(a=e.inferred)!=null&&a.length||e.hypothesis?nm(e.observed,e.calculated,e.inferred,e.hypothesis):n("Observed",e.observed)}
    ...
    <div class="report-wrap">
      ...
      <div class="report-section">
        ...
        <div style="margin-bottom:16px">${Z0(f,e)}</div>
        ${em(n,p,E)}
      </div>
  ...
  `).join(""))}function cr(){let e=document.getElementById("isd-wallets-section"),t=document.getElementById("isd-wallet-list");if(!e||!t)return;let n=ge(Q(M0))||[];if(!n.length){e.style.display="none";return}e.style.display="",t.innerHTML=n.map(s=>{let a=s.color||"#50fa7b",o=s.emoji||"\u{1F48E}",i=s.label||"Wallet",r=s.address||"",l=r?r.slice(0,8)+"\u2026"+r.slice(-6):"\u2014",c=s.testnet?'<span class="isd-wallet-testnet">TESTNET</span>':"";return`
    ...
    `}).join("")}function dr(){let e=document.getElementById("isd-recent-section"),t=document.getElementById("isd-recent-list");if(!e||!t)return;let n=uo();if(!n.length){e.style.display="none";return}e.style.display="",t.innerHTML=n.map((s,a)=>{let o=s.addr?s.addr.slice(0,10)+"\u2026"+s.addr.slice(-8):"\u2014",i=s.riskScore!=null?`<span class="isd-risk-pill isd-risk-pill--${im(s.riskScore)}">${s.riskScore}</span>`:"";return`
...
`),a=new Blob([s],{type:"text/csv;charset=utf-8;"}),o=URL.createObjectURL(a),i=document.createElement("a"),r=((c=(l=document.getElementById("inspect-addr-badge"))==null?void 0:l.dataset)==null?void 0:c.fullAddr)||"wallet";i.href=o,i.download=`naluxrp_${r.slice(0,10)}_${new Date().toISOString().slice(0,10)}.csv`,document.body.appendChild(i),i.click(),document.body.removeChild(i),URL.revokeObjectURL(o)};function F0(e,t){let s=uo().find(o=>o.addr===e);if(!s||s.riskScore==null||t==null)return null;let a=t-s.riskScore;return{prev:s.riskScore,curr:t,diff:a,ts:s.ts}}function O0(e,t){let n=F0(e,t);if(!n||Math.abs(n.diff)<2)return;let s=document.getElementById("inspect-risk-score");if(!s)return;let a=n.diff>0?`<span style="color:#ff5555;font-size:.7rem;font-weight:700"> \u2191${n.diff}</span>`:`<span style="color:#50fa7b;font-size:.7rem;font-weight:700"> \u2193${Math.abs(n.diff)}</span>`,o=mo(n.ts);s.insertAdjacentHTML("afterend",`<span class="risk-score-diff" title="Changed from ${n.prev} \u2192 ${n.curr} since ${o}">${a} vs ${o}</span>`)}window._inspectMaxTx||(window._inspectMaxTx=5e3);window._debugBalanceDeltas=Uu;window._debugOfferLifecycles=Qu;window._debugReconstructBalanceHistory=qu;window._debugFindDrainEpisodes=Vu;window._debugDrainRisk=Yu;window.inspectorLoadAddr=function(e){let t=x("inspect-addr");t&&(t.value=e),ks()};window.inspectWalletAddr=function(e){var n,s;window.inspectorLoadAddr(e);let t=document.querySelector('[data-tab="inspector"]');t&&((n=window.switchTab)==null||n.call(window,t,"inspector")),(s=window.showDashboard)==null||s.call(window)};window.printInspectorReport=function(){var s,a;let e=document.getElementById("inspect-report-body");if(!e)return;let t=((a=(s=document.getElementById("inspect-addr-badge"))==null?void 0:s.dataset)==null?void 0:a.fullAddr)||"wallet",n=window.open("","_blank","width=900,height=700");n.document.write(`<!DOCTYPE html><html><head>
    ...
    ${e.innerHTML}
  </body></html>`),n.document.close()};window.exportInspectorReport=function(){var n;let e=document.getElementById("inspect-report-body");if(!e)return;let t=e.innerText||e.textContent||"";(n=navigator.clipboard)==null||n.writeText(t).then(()=>{let s=document.getElementById("report-export-btn");s&&(s.textContent="\u2713 Copied!",setTimeout(()=>{s.textContent="\u{1F4CB} Copy Report"},2e3))}).catch(()=>{let s=document.createRange();s.selectNodeContents(e);let a=window.getSelection();a.removeAllRanges(),a.addRange(s)})};window.inspectorClearHistory=function(){vt(lr);let e=document.getElementById("isd-recent-section");e&&(e.style.display="none")};window.inspectorClearWatchlist=function(){vt(na),aa()};function uo(){return ge(Q(lr))||[]}function B0(e,t,n=[]){let s=uo();s=s.filter(o=>o.addr!==e);let a=n.filter(o=>o.sev==="critical"||o.sev==="warn").map(o=>o.module+":"+o.headline.slice(0,40)).sort().join("|");s.unshift({addr:e,riskScore:t,ts:Date.now(),fingerprint:a}),s=s.slice(0,12),Z(lr,JSON.stringify(s))}function sa(){return ge(Q(na))||[]}function X0(e,t){let n=sa().filter(s=>s.addr!==e);n.unshift({addr:e,label:t||z(e),addedTs:Date.now(),lastScore:null,lastTs:null}),Z(na,JSON.stringify(n.slice(0,50)))}function om(e){Z(na,JSON.stringify(sa().filter(t=>t.addr!==e)))}function or(e){return sa().some(t=>t.addr===e)}function H0(e,t){let n=sa().map(s=>s.addr===e?{...s,lastScore:t,lastTs:Date.now()}:s);Z(na,JSON.stringify(n))}function mo(e){let t=Date.now()-e;return t<6e4?"just now":t<36e5?Math.floor(t/6e4)+"m ago":t<864e5?Math.floor(t/36e5)+"h ago":Math.floor(t/864e5)+"d ago"}function im(e){return sr(e).replace("risk-","")}var en=!1;function rm(){en=localStorage.getItem(am)==="true",pr()}function pr(){let e=document.getElementById("inspect-result");if(!e)return;e.classList.toggle("mode-advanced",en),e.classList.toggle("mode-simple",!en);let t=document.getElementById("analyst-mode-btn");t&&(t.textContent=en?"\u2697 Advanced":"\u{1F441} Simple",t.title=en?"Switch to Simple view":"Switch to Advanced (analyst) view",t.setAttribute("aria-pressed",String(en)))}window.toggleAnalystMode=function(){en=!en,localStorage.setItem(am,en),pr()};var z0=new Set(["section-overview","section-report"]),j0=new Set(["section-security","section-drain","section-fundflow","section-inbound"]);function W0(){let e=document.getElementById("inspect-result");if(!e)return;let t=[...e.querySelectorAll(".inspector-section")],n={crit:0,warn:1,neutral:2,ok:3,"":4},s=t.filter(i=>!z0.has(i.id)&&!j0.has(i.id));s.sort((i,r)=>{let l=c=>{let d=c.querySelector(".section-badge");if(!d)return"";let u=d.className;return u.includes("crit")?"crit":u.includes("warn")?"warn":u.includes("neutral")?"neutral":u.includes("ok")?"ok":""};return(n[l(i)]??4)-(n[l(r)]??4)});let a=document.getElementById("section-inbound")||document.getElementById("section-drain");if(!a)return;let o=a;for(let i of s)o.after(i),o=i}var U0=new Set(["section-overview","section-evidence-matrix"]);function q0(){document.querySelectorAll("#inspect-result .inspector-section").forEach(e=>{if(U0.has(e.id))return;let t=e.querySelector(".section-header");if(!t)return;let n=e.querySelector(".section-badge"),s=!!n&&(n.classList.contains("section-badge--crit")||n.classList.contains("section-badge--warn"));e.classList.toggle("collapsed",!s),t.setAttribute("aria-expanded",String(s))})}function ur(e){let t=(e||[]).filter(s=>s.confidence!=null);if(!t.length)return null;let n=t.reduce((s,a)=>s+a.confidence,0)/t.length;return n>=.7?"Strong":n>=.4?"Moderate":"Weak"}var zn={sev:"all",category:"all"};function V0(e,t){zn[e]=t,lm(window._lastAllFindings||[])}function lm(e){let t=document.getElementById("inspect-evidence-matrix-body");if(!t)return;let n=document.getElementById("badge-evidence-matrix"),s=e.filter(d=>!(zn.sev!=="all"&&d.sev!==zn.sev||zn.category!=="all"&&(d.category||ro[d.module]||"security")!==zn.category));n&&(n.textContent=`${s.length} of ${e.length}`);let a=["all","critical","warn","info"],o={all:"All",critical:"Critical",warn:"Warning",info:"Info"},i=["all",...io],r=`
    ...
    <div class="acct-peek-stat" style="grid-column:1 / -1"><span>Evidence Strength</span><b>${y(a)}</b></div>`,document.getElementById("evInspectorDetail").innerHTML=Tt({...t,label:t.headline||t.label}),n.style.display="flex"}function Y0(e,t,n,s,a={},o=!1,i=null){let r=document.getElementById("quick-verdict-body");if(!r)return;let l=t.filter(C=>C.sev==="critical"),c=t.filter(C=>C.sev==="warn"),d=e<20?"#50fa7b":e<45?"#ffb86c":e<70?"#ff8c42":"#ff5555",u=e<20?"Low Risk":e<45?"Moderate":e<70?"High Risk":"Critical",p=(C,R)=>(R.confidence??.5)-(C.confidence??.5),m=[...l].sort(p),f=[...c].sort(p),g="",v="";if(l.length===0&&c.length===0)g=`No elevated signals found across ${s.toLocaleString()} transactions${n!=null?` and ${n} days of history`:""}.`,v="This wallet appears to operate within normal parameters.";else{let C=m.slice(0,2).map(I=>I.headline).join("; "),R=f.slice(0,2).map(I=>I.headline).join("; ");g=l.length?`${l.length} critical issue${l.length>1?"s":""}: ${C}.`:`${c.length} warning${c.length>1?"s":""}: ${R}.`,v=l.length?"Review the highlighted sections below. Scroll to the Report for full recommendations.":"Review the flagged sections below for context before drawing conclusions."}let h=io.filter(C=>C!=="external-exposure").map(C=>({cat:C,...a[C]})).filter(C=>C.score>0).sort((C,R)=>R.score-C.score),b=a["external-exposure"],w=(b==null?void 0:b.score)>0?`
    ...
    </div>`}function aa(){let e=document.getElementById("isd-watchlist-section"),t=document.getElementById("isd-watchlist-list");if(!e||!t)return;let n=sa();if(!n.length){e.style.display="none";return}e.style.display="",t.innerHTML=n.map(s=>{let a=s.addr.slice(0,8)+"\u2026"+s.addr.slice(-6),o=s.lastScore!=null?`<span class="isd-risk-pill isd-risk-pill--${im(s.lastScore)}">${s.lastScore}</span>`:"",i=s.lastTs?mo(s.lastTs):"never checked";return`
...
${$}`;return`<rect x="${v*(c+d)}" y="${b}" width="${c}" height="${h}" fill="${k}" opacity=".8" rx="1" data-tooltip="${y(T)}" style="cursor:pointer"></rect>`}).join("");n.innerHTML=`
    ...
    </div>`}function dm(e,t){let n=new Map;for(let{tx:s,meta:a}of e){let o=s.Account===t,i=s.Destination===t;if(!o&&!i)continue;let r=o?s.Destination:s.Account;if(!r||r===t)continue;let l=tn(s);n.has(r)||n.set(r,{cnt:0,xrpOut:0,xrpIn:0,entity:Wn(r),firstSeen:l,lastSeen:l});let c=n.get(r);c.cnt++,l&&(c.firstSeen=c.firstSeen?Math.min(c.firstSeen,l):l,c.lastSeen=Math.max(c.lastSeen,l));let d=(a==null?void 0:a.delivered_amount)||s.Amount,u=typeof d=="string"?Number(d)/1e6:0;o?c.xrpOut+=u:c.xrpIn+=u}return n}function Z0(e,t,n=15){let s=dm(e,t),a=[...s.entries()].sort((r,l)=>l[1].xrpOut+l[1].xrpIn-(r[1].xrpOut+r[1].xrpIn)||l[1].cnt-r[1].cnt).slice(0,n);if(!a.length)return'<div class="inspect-empty-note">No counterparty interactions found.</div>';let o=Math.max(...a.map(([,r])=>r.xrpOut+r.xrpIn),1),i=a.map(([r,l],c)=>{var h;let d=l.xrpOut+l.xrpIn,u=Math.max(1.5,d/o*100),p=wn[(h=l.entity)==null?void 0:h.type]||wn.other,m=d>0?l.xrpOut/d:.5,f=m>.65?"\u2192 out":m<.35?"\u2190 in":"\u21C4 both",g=l.entity?`<span style="font-size:.64rem;color:${p};border:1px solid ${p};border-radius:999px;padding:1px 7px;margin-left:6px">${y(l.entity.name)}</span>`:"",v=tm(l.firstSeen,l.lastSeen);return`
    ...
    ${i}`}function ew(e,t,n,s,a="inspect-network-map"){let o=document.getElementById(a);if(!o)return;let r=[...dm(e,t).entries()].sort((S,E)=>E[1].xrpOut+E[1].xrpIn-(S[1].xrpOut+S[1].xrpIn)||E[1].cnt-S[1].cnt).slice(0,20);if(r.length<2){o.style.display="",o.innerHTML=`<div class="inspect-empty-note">${r.length===0?"No counterparty interactions found.":"Only one counterparty found \u2014 not enough to chart a network map."}</div>`;return}o.style.display="";let l=560,c=340,d=l/2,u=c/2,p=95,m=7,f=155,g=13,v=r[0][1].xrpOut+r[0][1].xrpIn||1,h=r[0][1].cnt||1,b=[{id:t,x:d,y:u,r:13,main:!0,label:z(t),color:"#00d4ff",xrpOut:0,xrpIn:0,cnt:0}];r.forEach(([S,E],P)=>{let C=P<m?p:f,R=P<m?m:g,D=(P<m?P:P-m)/R*2*Math.PI-Math.PI/2,F=E.xrpOut+E.xrpIn,O=Math.max(5,Math.min(14,4+F/v*10)),H=E.entity,N=wn[H==null?void 0:H.type]||wn.other,j=F>0?E.xrpOut/F:.5,se=j>.65?"out":j<.35?"in":"both";b.push({id:S,x:d+C*Math.cos(D),y:u+C*Math.sin(D),r:O,color:N,label:(H==null?void 0:H.name)||z(S),ent:H,xrpOut:E.xrpOut,xrpIn:E.xrpIn,cnt:E.cnt,dir:se,vol:F,ring:C})});let w=`<defs>
    ...
    </div>`}function tw(){let e=window._lastInspectResult,t=window._lastAllFindings||[];if(!e)return null;let n=t.length?t.map(a=>`- [${a.sev.toUpperCase()}] ${a.module}: ${a.headline}${a.detail?" \u2014 "+a.detail:""}`).join(`
...
You are acting as a security analyst explaining automated blockchain forensics findings to someone who isn't a blockchain expert. Write a clear, plain-English explanation of what this account's activity suggests. Synthesize the findings above into a coherent read of the account rather than restating them one by one \u2014 call out which ones reinforce each other and which are weak signals on their own. Be direct about how concerning (or not) this looks, and be skeptical of your own confidence where the evidence is thin rather than overstating it. Do not repeat the address or risk score back verbatim; the reader can already see those above your response.`}window.copyInspectorAnalysisForAi=function(){let e=document.getElementById("ai-explanation-body"),t=tw();if(!t){e&&(e.innerHTML='<p style="font-size:.82rem;color:#ff5555">Run an inspection first.</p>');return}js(t)};window.exportInspectorJSON=function(){var o,i;let e=window._lastInspectResult;if(!e){alert("Run an inspection first.");return}let t=new Blob([JSON.stringify(e,null,2)],{type:"application/json"}),n=URL.createObjectURL(t),s=document.createElement("a"),a=((i=(o=document.getElementById("inspect-addr-badge"))==null?void 0:o.dataset)==null?void 0:i.fullAddr)||"wallet";s.href=n,s.download=`naluxrp_${a.slice(0,10)}_${new Date().toISOString().slice(0,10)}.json`,document.body.appendChild(s),s.click(),document.body.removeChild(s),URL.revokeObjectURL(n)};var nw=6e4,sw=1e4,aw=12e4,ow=8e3,iw=12e4,rw=300,km="nalulf_net_baseline_v2",lw=80,cw=5,ra="/api/v1/validatorregistry",$m="/api/v1/validator";var dw=5*60*1e3,Sm=10*60*1e3,pm=1e4,Tm=8e3,gr=new Map,vr=new Map;var sn={quorumTight:{w:3,label:"Quorum within 3 validators of failure threshold"},nUnlActive:{w:2,label:"Negative UNL active \u2014 validators currently being ignored"},amendVeto:{w:1,label:"Amendment veto clustering \u2014 protocol governance dispute"},feeSpike:{w:2,label:"Open ledger fee 10\xD7 minimum \u2014 DDoS / spam attack likely"},burnAnomaly:{w:2,label:"XRP burn rate z-score > 3\u03C3 \u2014 resource exhaustion pattern"},peerSaturate:{w:2,label:"Inbound peers > 80% of connections \u2014 Eclipse Attack risk"},eclipseRisk:{w:3,label:"Peer count < 6 \u2014 node highly vulnerable to isolation"},dexSpike:{w:1,label:"DEX volume > 3\xD7 AMM baseline \u2014 unusual event-driven flow"},reserveSpike:{w:1,label:"New account rate > 3\xD7 baseline \u2014 possible bot creation"},slowConverge:{w:2,label:"Consensus convergence > 6s \u2014 network agreement degraded"},lowProposers:{w:2,label:"Proposer count below quorum \u2014 validator participation low"},queuePressure:{w:2,label:"TX queue > 80% full \u2014 fee surge imminent"},spamLedger:{w:1,label:"Ledger > 2\xD7 expected size \u2014 ledger spam in progress"},ioStressed:{w:1,label:"Node IO latency > 5ms \u2014 storage or network I/O stress"},peerChurn:{w:1,label:"Elevated peer disconnect rate \u2014 DDoS or instability"},staleLedger:{w:3,label:"Ledger age > 10s \u2014 validation appears stalled"}},Cm={MultiSign:{purpose:"Multi-signature authorization",intro:"rippled 0.31",desc:"Lets multiple keys jointly authorize one transaction. Essential for institutional custody and hardware-wallet setups.",impact:"New transaction: SignerListSet. All signers submit their signature; the last one broadcasts."},MultiSignReserve:{purpose:"Cheaper signer-list reserve",intro:"rippled 1.2",desc:"Cuts the owner reserve for SignerList objects from 5 owner-items (10 XRP) down to 1 owner-item (2 XRP).",impact:"Existing SignerLists do not gain the reduction automatically; delete and re-create the list."},DepositAuth:{purpose:"Block unsolicited incoming payments",intro:"rippled 0.90",desc:"An account can set lsfDepositAuth so it only receives payments explicitly pre-authorized via DepositPreauth.",impact:"Senders to un-authorized accounts receive tecNO_PERMISSION."},DeletableAccounts:{purpose:"Permanent account deletion + reserve reclaim",intro:"rippled 1.4",desc:"An account with no objects and sequence \u2265 (current ledger \u2212 256) can permanently delete itself and recover the base reserve.",impact:"New transaction: AccountDelete. Sends all XRP minus fees to a destination."},NegativeUNL:{purpose:"Fault-tolerant consensus during outages",intro:"rippled 1.6",desc:"When validators are persistently offline, the network may add them to the Negative UNL so they do not count against quorum.",impact:"Enables the network to survive planned outages of up to 20% of trusted validators."},Checks:{purpose:"Deferred, cancellable payments",intro:"rippled 1.0",desc:"The sender creates a Check; the recipient can later cash it up to the authorized amount or let it expire. The sender can cancel at any time.",impact:"New transactions: CheckCreate, CheckCash, CheckCancel. Each open Check uses one owner-reserve slot."},AMM:{purpose:"Native Automated Market Maker DEX",intro:"rippled 1.12",desc:"Adds a Constant-Product (x*y=k) AMM directly in the ledger. Anyone can deposit two assets to earn LP tokens and a share of swap fees.",impact:"New transactions: AMMCreate, AMMDeposit, AMMWithdraw, AMMVote, AMMBid, AMMDelete."},XChainBridge:{purpose:"Cross-chain bridge protocol",intro:"rippled 2.0",desc:"Lets assets move between XRPL Mainnet, sidechains, and EVM chains via a locking/minting bridge secured by Witness servers.",impact:"New ledger objects: Bridge, XChainOwnedCreateAccountClaimID, etc. Requires Witness infrastructure."},Clawback:{purpose:"Token-issuer recovery",intro:"rippled 1.12",desc:"Issuers who set lsfAllowTrustLineClawback before issuing tokens can claw back tokens from any holder.",impact:"Must be enabled on a fresh account before any trust lines are created."},NonFungibleTokensV1:{purpose:"Native NFT support",intro:"rippled 1.9",desc:"Adds NFTokenMint, NFTokenBurn, and offer-based transfer mechanics for non-fungible tokens stored in NFTokenPage objects.",impact:"Each NFTokenPage holds up to 32 tokens and costs one owner-reserve slot. Royalties up to 50%."},NonFungibleTokensV1_1:{purpose:"NFT V1 corrections",intro:"rippled 1.10",desc:"Fixes pagination bugs, transfer-fee edge cases, and minting with the URI field that were present in V1.",impact:"Breaking fix for some V1 edge cases. Wallets built for V1 should test V1_1 compatibility."},PayChan:{purpose:"Payment channels for streaming micropayments",intro:"rippled 0.33",desc:"Sender deposits XRP into a channel, then issues signed claims off-ledger. Recipient submits the highest claim at any time to settle on-ledger.",impact:"New transactions: PaymentChannelCreate, PaymentChannelFund, PaymentChannelClaim."},Escrow:{purpose:"Time-locked and condition-based XRP transfers",intro:"rippled 0.60",desc:"Lock XRP until a future time OR a cryptographic fulfillment (PREIMAGE-SHA-256) is revealed, enabling vesting schedules and atomic swaps.",impact:"New transactions: EscrowCreate, EscrowFinish, EscrowCancel. Locked XRP counts against reserves."},DisallowIncoming:{purpose:"Block unsolicited ledger-object creation",intro:"rippled 1.10",desc:"New account flags let you individually block incoming Trust Lines, Check objects, NFToken offers, and Payment Channels.",impact:"Four new AccountSet flags; existing incoming objects are unaffected."},ExpandedSignerList:{purpose:"Larger multi-sig signer lists",intro:"rippled 1.9.1",desc:"Increases the maximum signers per SignerList from 8 to 32, enabling more complex institutional multi-sig and DAO governance.",impact:"Reserve cost scales with signer count. Requires MultiSignReserve to be cost-effective."},OwnerPaysFee:{purpose:"Correct fee payer in PayChan",intro:"rippled 0.33",desc:"Fixes a spec inconsistency where the channel owner correctly pays the transaction fee when closing or expiring channels.",impact:"Purely a fee-accounting fix; no user-visible behavior changes."},fixMasterKeyAsRegularKey:{purpose:"Master-key mis-use bug fix",intro:"rippled 0.90",desc:"Prevents accounts from setting their master key as their regular key \u2014 an operation that could create an unusable account state.",impact:"No application changes needed; existing accounts are not affected."},TrustSetAuth:{purpose:"Authorized trust lines",intro:"rippled 0.30",desc:"Issuers can require explicit authorization before anyone can hold their token \u2014 a prerequisite for regulatory-grade stablecoins.",impact:"New flow: issuer sends TrustSet with tfSetfAuth to approve each holder."}},um=new Set(["xrpscan.com","xrpl.aesthetes.art","xrpkuwait.com","xrpgoat.com","xrp.vet","xrp.unic.ac.cy","xrp-validator.interledger.org","xpmarket.com","verum.eminence.im","validator.xrpl.robertswarthout.com","validator.xrpl-labs.com","validator.poli.usp.br","validator.gatehub.net","validator.aspired.nz","v2.xrpl-commons.org","tequ.dev","squidrouter.com","ripple.ittc.ku.edu","ripple.com","peersyst.cloud","onxrp.com","katczynski.net","jon-nilsen.no","ekiserrepe.es","cabbit.tech","bithomp.com","aureusox.com","arrington-xrp-capital.blockdaemon.com","anodos.finance","bitso.com","ripple.kenan-flagler.unc.edu","ripplevalidator.uwaterloo.ca","shadow.haas.berkeley.edu","www.bitrue.com","xrp-col.anu.edu.au"]),pw=new Set(["nHBu3iuq1SQ9Z686pYwWYVKpScSMDWfpUJHdNEQRxn5XyETui7Db","nHDwBbubxJswoweWQKEgWLNRJv2hNRCTR4GGApJmbtCcbtYNSpdB","nHU2FpRbPrvVcyQQpkqrAUDJDTRHZpjij8DpKeSC481PYY9ikYkb","nHUbmg8QNzEGjHzgnt99e9YE2scU3DZGH7FsF6MCcK5eiPt3AtaH","nHUxBD1UPb383SdWgJx62GGQ7W2WKvgpUtUXLjiGGRRcPb3nbSXd","nHUP6rfQfgzg6tKga3k9ziEvtjwn1PB32gcr5dLcamqzmitszYv2","nHBT58yHyDdPdJ6gzaBMT7gqwTMpj5ERji1s9SvfKKtfoZUS89WX","nHBxsUzx3Bbf6J4yJ3fLQ3VizPtdREVwTJ6mdqkuDTjLcVbggVbk","nHUeUNSn3zce2xQZWNghQvd9WRH6FWEnCBKYVJu2vAizMxnXegfJ","nHUCAdca6VoWWYVdBH1bwCUQggEX2e5acQSqxM3DwyuhsFknxmh3","nHDDiwQBqXhEL1CFoRHdMXD33x9K7rpYJfniXxL7kFavpPd21EGe","nHBipbbREjNEiCs4hpy3K2489dRf27MPnxdivTTWKSd8ZUhfRvn8","nHDDe5uAdiv6RA59MA1oM4JLDtVSYKNShgjEqq1KsdJXZiR47CQT","nHBbiP5ua5dUqCTz5i5vd3ia9jg3KJthohDjgKxnc7LxtmnauW7Z","nHBQ3CT3EWYZ4uzbnL3k6TRf9bBPhWRFVcK1F5NjtwCBksMEt5yy","nHU16DF2kq7TmbR1Y5z8yKNXiLEf3oHT19HVpVXv7unFLfxa17nT","nHUC23NnutZyYeQxQbAbPUpKoVGj5aisBxf2zzcZzJ43fcw5rc9z","nHUgdMvuchx7AWG4ATMQdNNuMryo1SFoNptLCEVt2Dn7wEc625mF","nHUhQVE93dajM3srxubsEj1mK1gzRwJob14QSrJefY1FdLs6r7WJ","nHUU8xBczYzW6kZ6Ei9DsggzTJXRFkN3wE3FP5H4SLYzhbodeYcG","nHUGqooyfGqFkyH6uskbaEi6y2MjXjdA7QdbmyZ6p9etL5isRKLT","nHDp1ZXxEn7eo5YaUtiagaxSLwXudnKZDx68C96p4tdVLGLLLUFn","nHBcLEB4S6moQGrhMjJo1jbp58WL5psHY9EMDWNAtdqykUYiA1rF","nHUAECq1v1cKwn3NsYVyD7v6BNbfqyXmNVSF3e4XCVxPgBHRWkvv","nHUif4sukXu9pJGyyBaeVMwmE8L1fJ5KJj4X4ksgTKhgjG6k96s2","nHUVJR7SeT3nn6JPTz46JHqYRf7vX2if1sdTxnceywmSBWa167pt","nHUEYz4TtTv7yebjhY3aDib5KYPHnKjnY5mPYK5y4QuKdocwS5tD","nHUN5n2S3nQ8bzKm7bqeFMiQeDijh1LMgEocyNyQbb4mREazVdZ5","nHUgchANqM3giYSSvY5HsafFW6qxmG5jJ3CvPiv7n8gjNQuNm8Uz","nHDUqGoM7KR1pgbdYBRgKpGKdFLhpnMzVbECs8RE73RGZm3Va6MJ","nHUVxTi8XfXjaaJppw7mLSrYDRpkDpf8H9ypzgVKxfSXShcWwAoK","nHBveTxA1NaBj5AayRAU91f6YopuFWt9rmxfGaEh77a32Q6ZzzHc"]),uw=new Set(["validator.pftperry.com","rip973.com","preaware.org","postfiat.org","pftmeech.xyz","pft.xbtseal.com","pft.wizbubba.xyz","pft.permanentupperclass.com","pft.g.money","pft.akirax.xyz","jollydinger.com","auri0x.io","app.w.ai"]);function Pm(e,t){let n=(t||"").toLowerCase().replace(/^www\./,"");return pw.has(e)||uw.has(n)?{chain:"test",isUnl:!1}:um.has(n)||um.has("www."+n)?{chain:"main",isUnl:!0}:{chain:"main",isUnl:!1}}var Tr={"xrpscan.com":{label:"XRP Scan",domain:"xrpscan.com",chain:"main",category:"unl"},"xrpl.aesthetes.art":{label:"Aesthetes",domain:"xrpl.aesthetes.art",chain:"main",category:"unl"},"xrpkuwait.com":{label:"XRP Kuwait",domain:"xrpkuwait.com",chain:"main",category:"unl"},"xrpgoat.com":{label:"XRP Goat",domain:"xrpgoat.com",chain:"main",category:"unl"},"xrp.vet":{label:"XRP Vet",domain:"xrp.vet",chain:"main",category:"unl"},"xrp.unic.ac.cy":{label:"Univ. of Nicosia",domain:"xrp.unic.ac.cy",chain:"main",category:"unl"},"xrp-validator.interledger.org":{label:"Interledger",domain:"xrp-validator.interledger.org",chain:"main",category:"unl"},"xpmarket.com":{label:"XPMarket",domain:"xpmarket.com",chain:"main",category:"unl"},"verum.eminence.im":{label:"Eminence",domain:"verum.eminence.im",chain:"main",category:"unl"},"validator.xrpl.robertswarthout.com":{label:"R. Swarthout",domain:"validator.xrpl.robertswarthout.com",chain:"main",category:"unl"},"validator.xrpl-labs.com":{label:"XRPL Labs",domain:"validator.xrpl-labs.com",chain:"main",category:"unl"},"validator.poli.usp.br":{label:"USP",domain:"validator.poli.usp.br",chain:"main",category:"unl"},"validator.gatehub.net":{label:"Gatehub",domain:"validator.gatehub.net",chain:"main",category:"unl"},"validator.aspired.nz":{label:"Aspired NZ",domain:"validator.aspired.nz",chain:"main",category:"unl"},"v2.xrpl-commons.org":{label:"XRPL Commons",domain:"v2.xrpl-commons.org",chain:"main",category:"unl"},"tequ.dev":{label:"Tequ",domain:"tequ.dev",chain:"main",category:"unl"},"squidrouter.com":{label:"Squid Router",domain:"squidrouter.com",chain:"main",category:"unl"},"ripple.ittc.ku.edu":{label:"Univ. of Kansas",domain:"ripple.ittc.ku.edu",chain:"main",category:"unl"},"ripple.com":{label:"Ripple",domain:"ripple.com",chain:"main",category:"unl"},"peersyst.cloud":{label:"Peersyst",domain:"peersyst.cloud",chain:"main",category:"unl"},"onxrp.com":{label:"OnXRP",domain:"onxrp.com",chain:"main",category:"unl"},"katczynski.net":{label:"Katczynski",domain:"katczynski.net",chain:"main",category:"unl"},"jon-nilsen.no":{label:"Jon Nilsen",domain:"jon-nilsen.no",chain:"main",category:"unl"},"ekiserrepe.es":{label:"Ekiserrepe",domain:"ekiserrepe.es",chain:"main",category:"unl"},"cabbit.tech":{label:"Cabbit",domain:"cabbit.tech",chain:"main",category:"unl"},"bithomp.com":{label:"Bithomp",domain:"bithomp.com",chain:"main",category:"unl"},"aureusox.com":{label:"Aureus Ox",domain:"aureusox.com",chain:"main",category:"unl"},"arrington-xrp-capital.blockdaemon.com":{label:"Arrington / Blockdaemon",domain:"arrington-xrp-capital.blockdaemon.com",chain:"main",category:"unl"},"anodos.finance":{label:"Anodos Finance",domain:"anodos.finance",chain:"main",category:"unl"},"bitso.com":{label:"Bitso",domain:"bitso.com",chain:"main",category:"unl"},"ripple.kenan-flagler.unc.edu":{label:"UNC Kenan-Flagler",domain:"ripple.kenan-flagler.unc.edu",chain:"main",category:"unl"},"ripplevalidator.uwaterloo.ca":{label:"Univ. of Waterloo",domain:"ripplevalidator.uwaterloo.ca",chain:"main",category:"unl"},"shadow.haas.berkeley.edu":{label:"UC Berkeley Haas",domain:"shadow.haas.berkeley.edu",chain:"main",category:"unl"},"www.bitrue.com":{label:"Bitrue",domain:"www.bitrue.com",chain:"main",category:"unl"},"xrp-col.anu.edu.au":{label:"ANU",domain:"xrp-col.anu.edu.au",chain:"main",category:"unl"},"xrpval.rawsec.de":{label:"Rawsec",domain:"xrpval.rawsec.de",chain:"main",category:"other"},"xrplvl.carbonvibe.com":{label:"Carbon Vibe",domain:"xrplvl.carbonvibe.com",chain:"main",category:"other"},"xrplvalidator.alloy.ee":{label:"Alloy",domain:"xrplvalidator.alloy.ee",chain:"main",category:"other"},"xrpl.uni.lu":{label:"Univ. of Luxembourg",domain:"xrpl.uni.lu",chain:"main",category:"other"},"xrpl.to":{label:"XRPL.to",domain:"xrpl.to",chain:"main",category:"other"},"xrpl.su":{label:"XRPL.su",domain:"xrpl.su",chain:"main",category:"other"},"xrpl.sbivc.co.jp":{label:"SBI VC Trade",domain:"xrpl.sbivc.co.jp",chain:"main",category:"other"},"xrpl-verification.flare.network":{label:"Flare Network",domain:"xrpl-verification.flare.network",chain:"main",category:"other"},"xrpl-validator.7rev.dev":{label:"7Rev",domain:"xrpl-validator.7rev.dev",chain:"main",category:"other"},"xrp.teacopula.com":{label:"Teacopula",domain:"xrp.teacopula.com",chain:"main",category:"other"},"xrp.moneymindedapes.com":{label:"MoneyMindedApes",domain:"xrp.moneymindedapes.com",chain:"main",category:"other"},"xrp.hazza-systems.de":{label:"Hazza Systems",domain:"xrp.hazza-systems.de",chain:"main",category:"other"},"xrp.cs.uoregon.edu":{label:"Univ. of Oregon",domain:"xrp.cs.uoregon.edu",chain:"main",category:"other"},"xrp.bpsqn.com":{label:"BPSQN",domain:"xrp.bpsqn.com",chain:"main",category:"other"},"xrp-validator.grapedrop.xyz":{label:"Grapedrop",domain:"xrp-validator.grapedrop.xyz",chain:"main",category:"other"},"xaodao.io":{label:"XaoDAO",domain:"xaodao.io",chain:"main",category:"other"},"vl.xrpsalute.com":{label:"XRP Salute",domain:"vl.xrpsalute.com",chain:"main",category:"other"},"validator.xrpl.app":{label:"XRPL App",domain:"validator.xrpl.app",chain:"main",category:"other"},"validator.ukcbt.org":{label:"UKCBT",domain:"validator.ukcbt.org",chain:"main",category:"other"},"validator.sugarxrpl.com":{label:"SugarXRPL",domain:"validator.sugarxrpl.com",chain:"main",category:"other"},"validator.boscaern.digital":{label:"Boscaern",domain:"validator.boscaern.digital",chain:"main",category:"other"},"trimaera.tech":{label:"Trimaera",domain:"trimaera.tech",chain:"main",category:"other"},"textrp.io":{label:"TextRP",domain:"textrp.io",chain:"main",category:"other"},"tesbert.com":{label:"Tesbert",domain:"tesbert.com",chain:"main",category:"other"},"tachyon-xrpl-validator.github.io":{label:"Tachyon",domain:"tachyon-xrpl-validator.github.io",chain:"main",category:"other"},"solonation.io":{label:"SoloNation",domain:"solonation.io",chain:"main",category:"other"},"smokydrip.com":{label:"SmokyDrip",domain:"smokydrip.com",chain:"main",category:"other"},"rippled-validator.us":{label:"rippled-validator.us",domain:"rippled-validator.us",chain:"main",category:"other"},"rippleat.snt.uni.lu":{label:"Univ. Luxembourg (SNT)",domain:"rippleat.snt.uni.lu",chain:"main",category:"other"},"ripple.uni.lu":{label:"Univ. Luxembourg",domain:"ripple.uni.lu",chain:"main",category:"other"},"ripple.j2b.com":{label:"J2B",domain:"ripple.j2b.com",chain:"main",category:"other"},"rich-list.info":{label:"Rich List",domain:"rich-list.info",chain:"main",category:"other"},"proptoexchange.com":{label:"ProPtoExchange",domain:"proptoexchange.com",chain:"main",category:"other"},"printscierge.com":{label:"Printscierge",domain:"printscierge.com",chain:"main",category:"other"},"opulencex.io":{label:"OpulenceX",domain:"opulencex.io",chain:"main",category:"other"},"onledger.net":{label:"OnLedger",domain:"onledger.net",chain:"main",category:"other"},"oclost.art":{label:"Oclost",domain:"oclost.art",chain:"main",category:"other"},"managednetwork.us":{label:"ManagedNetwork",domain:"managednetwork.us",chain:"main",category:"other"},"joshuahamsa.com":{label:"Joshua Hamsa",domain:"joshuahamsa.com",chain:"main",category:"other"},"grimmsxrpflow.jwscott.net":{label:"Grimm XRP Flow",domain:"grimmsxrpflow.jwscott.net",chain:"main",category:"other"},"getlol.xyz":{label:"GetLol",domain:"getlol.xyz",chain:"main",category:"other"},"gen3labs.xyz":{label:"Gen3 Labs",domain:"gen3labs.xyz",chain:"main",category:"other"},"garveyvalid.com":{label:"Garvey",domain:"garveyvalid.com",chain:"main",category:"other"},"easynpl.kr":{label:"EasyNPL",domain:"easynpl.kr",chain:"main",category:"other"},"diseb.ewi.tudelft.nl":{label:"TU Delft",domain:"diseb.ewi.tudelft.nl",chain:"main",category:"other"},"datamossa.com":{label:"DataMossa",domain:"datamossa.com",chain:"main",category:"other"},"crypto.unibe.ch":{label:"Univ. of Bern",domain:"crypto.unibe.ch",chain:"main",category:"other"},"commonprefix.com":{label:"Common Prefix",domain:"commonprefix.com",chain:"main",category:"other"},"catalyze-research.com":{label:"Catalyze Research",domain:"catalyze-research.com",chain:"main",category:"other"},"catalog.org":{label:"Catalog",domain:"catalog.org",chain:"main",category:"other"},"blockchain.korea.ac.kr":{label:"Korea Univ.",domain:"blockchain.korea.ac.kr",chain:"main",category:"other"},"astatiumprotocol.com":{label:"Astatium Protocol",domain:"astatiumprotocol.com",chain:"main",category:"other"},"ladykxrpl.mywire.org":{label:"LadyK XRPL",domain:"LadyKXRPL.mywire.org",chain:"main",category:"other"},"eelap-p1201-xrp.abudhabi.nyu.edu":{label:"NYU Abu Dhabi",domain:"EELAP-P1201-XRP.ABUDHABI.NYU.EDU",chain:"main",category:"other"},"589.clouds.hspeed.ch":{label:"HSpeed",domain:"589.clouds.hspeed.ch",chain:"main",category:"other"},"validator.pftperry.com":{label:"PFT Perry",domain:"validator.pftperry.com",chain:"test",category:"other"},"rip973.com":{label:"rip973",domain:"rip973.com",chain:"test",category:"other"},"preaware.org":{label:"Preaware",domain:"preaware.org",chain:"test",category:"other"},"postfiat.org":{label:"PostFiat",domain:"postfiat.org",chain:"test",category:"other"},"pftmeech.xyz":{label:"PFT Meech",domain:"pftmeech.xyz",chain:"test",category:"other"},"pft.xbtseal.com":{label:"PFT XBT Seal",domain:"pft.xbtseal.com",chain:"test",category:"other"},"pft.wizbubba.xyz":{label:"PFT Wizbubba",domain:"pft.wizbubba.xyz",chain:"test",category:"other"},"pft.permanentupperclass.com":{label:"PFT Perm Upper Class",domain:"pft.permanentupperclass.com",chain:"test",category:"other"},"pft.g.money":{label:"PFT G.Money",domain:"pft.g.money",chain:"test",category:"other"},"pft.akirax.xyz":{label:"PFT Akirax",domain:"pft.akirax.xyz",chain:"test",category:"other"},"jollydinger.com":{label:"Jollydinger",domain:"jollydinger.com",chain:"test",category:"other"},"auri0x.io":{label:"Auri0x",domain:"auri0x.io",chain:"test",category:"other"},"app.w.ai":{label:"W.ai",domain:"app.w.ai",chain:"test",category:"other"}},yo={nHB8QMKGt9VB4Vg71VszjBVQnDW3v3QudM4436zXRZgiuUBBSWJe:{lat:37.77,lng:-122.42,city:"San Francisco",org:"Ripple"},nHUon2tpyJEHHYGmxqNd3h3oGNQwNyX8PNS3aHe3bNpCrNXZlHo:{lat:37.77,lng:-122.41,city:"San Francisco",org:"Ripple"},nHUpwrafS45zmi6eT72XS5ijpkW5JwfL5mLdPhEibrqUvtRcMAjU:{lat:37.78,lng:-122.4,city:"San Francisco",org:"Ripple"},nHUkp7WhouVMobBUKGrV5FNqjsdD9zKP5jpGnnLfQXCMNe4dkDqo:{lat:37.76,lng:-122.43,city:"San Francisco",org:"Ripple"},nHUryiyDqEtyWVtFG24AAhaYjMf9FRLietZGBWYwUTojmugMsx3o:{lat:37.79,lng:-122.38,city:"San Francisco",org:"Ripple"},nHUpcmNsxAw47yt2ADDoNoQrzLyTJPgnyq16u6Qx2kRPA17oUNHz:{lat:37.8,lng:-122.39,city:"San Francisco",org:"Ripple"},nHUnhRJK3csknycNK5SXRFi8jvDp3sKoWvS9wKWLq1ATBBGgPBjp:{lat:37.75,lng:-122.44,city:"San Francisco",org:"Ripple"},nHUq9tJvk5QTDkwurB7EzbzkZ2uuoHjS3GKjP6pZiU3DJGnobNYK:{lat:39.04,lng:-77.49,city:"Ashburn, VA",org:"AWS (Coil)"},nHUvcCcmoH1FJMMC6NtF9KKA4LpCWhjsxk2reCQidsp5AHQ7QY9H:{lat:49.45,lng:11.08,city:"Nuremberg",org:"Hetzner (Gatehub)"},nHDH7bQJpVfDhVSqdui3Z8GPvKEBQpo6AKHcnXe21zoD4nABA6xj:{lat:52.37,lng:4.9,city:"Amsterdam",org:"GCP (XRPL Labs)"},nHUED59jjpQ5QbNtesAbB6Es3uUPv3c9Ri5MNNgfMv5t5Lhb5ndW:{lat:19.43,lng:-99.13,city:"Mexico City",org:"AWS (Bitso)"},nHBidG3pZK11zqjeVos6hFxTDPGYuqfRFZ5gu9b7tQFdB8nPZujG:{lat:35.69,lng:139.69,city:"Tokyo",org:"NTT (Digital Garage)"},nHDB2PAPYqF86j9j3c6w1F1ZqwvQfiWcFShZ9Pokg9q4ohNDSkAz:{lat:47.61,lng:-122.33,city:"Seattle, WA",org:"Azure (Arrington)"},nHUdphn3LXa31w5sLd39MQdPEKQNrNYL3DQFByijVXiNQ3G6BYBZ:{lat:1.35,lng:103.82,city:"Singapore",org:"AWS (Tokenize)"},nHUFCyRCrUjvtZmKiLeF8ReopzKuSkVzdl1VsMCqm75aqyohLYEg:{lat:48.86,lng:2.35,city:"Paris",org:"OVH (XRPL Commons)"},nHULqGBkJtWeNFjhTzYeAsHA3qKKS7HoBh8CV3BAGTGMZuepEhWC:{lat:40.71,lng:-74.01,city:"New York",org:"Equinix (Blockchain LLC)"},nHBdXSF6YHAHSZUk7rvox6jwbvvyqBnsWGcewBtq8x1XuH6KXKXr:{lat:37.79,lng:-122.4,city:"San Francisco",org:"Cloudflare (XRP Scan)"}},mm={"xrpscan.com":{lat:51.51,lng:-.13,city:"London",org:"XRPScan"},"xrpl.aesthetes.art":{lat:52.37,lng:4.9,city:"Amsterdam",org:"Aesthetes"},"xrpkuwait.com":{lat:29.37,lng:47.98,city:"Kuwait City",org:"XRP Kuwait"},"xrpgoat.com":{lat:39.04,lng:-77.49,city:"Ashburn, VA",org:"XRP Goat"},"xrp.vet":{lat:48.86,lng:2.35,city:"Paris",org:"XRP Vet"},"xrp.unic.ac.cy":{lat:35.17,lng:33.37,city:"Nicosia",org:"Univ. of Nicosia"},"xrp-validator.interledger.org":{lat:40.71,lng:-74.01,city:"New York",org:"Interledger Foundation"},"xpmarket.com":{lat:52.37,lng:4.9,city:"Amsterdam",org:"XPMarket"},"verum.eminence.im":{lat:51.51,lng:-.13,city:"London",org:"Eminence"},"validator.xrpl.robertswarthout.com":{lat:52.37,lng:4.9,city:"Amsterdam",org:"R. Swarthout"},"validator.xrpl-labs.com":{lat:52.37,lng:4.9,city:"Amsterdam",org:"XRPL Labs"},"validator.xrpl.app":{lat:52.37,lng:4.9,city:"Amsterdam",org:"XRPL App"},"validator.poli.usp.br":{lat:-23.55,lng:-46.63,city:"S\xE3o Paulo",org:"USP"},"validator.gatehub.net":{lat:46.05,lng:14.51,city:"Ljubljana",org:"Gatehub"},"validator.aspired.nz":{lat:-36.86,lng:174.76,city:"Auckland",org:"Aspired NZ"},"v2.xrpl-commons.org":{lat:48.86,lng:2.35,city:"Paris",org:"XRPL Commons"},"tequ.dev":{lat:60.17,lng:24.94,city:"Helsinki",org:"Tequ"},"squidrouter.com":{lat:37.77,lng:-122.42,city:"San Francisco",org:"Squid Router"},"ripple.ittc.ku.edu":{lat:38.97,lng:-95.24,city:"Lawrence, KS",org:"Univ. of Kansas"},"ripple.com":{lat:37.77,lng:-122.42,city:"San Francisco",org:"Ripple"},"peersyst.cloud":{lat:41.39,lng:2.15,city:"Barcelona",org:"Peersyst"},"onxrp.com":{lat:51.51,lng:-.13,city:"London",org:"OnXRP"},"katczynski.net":{lat:52.23,lng:21.01,city:"Warsaw",org:"Katczynski"},"jon-nilsen.no":{lat:59.91,lng:10.75,city:"Oslo",org:"Jon Nilsen"},"ekiserrepe.es":{lat:40.42,lng:-3.7,city:"Madrid",org:"Ekiserrepe"},"cabbit.tech":{lat:51.51,lng:-.13,city:"London",org:"Cabbit"},"bithomp.com":{lat:59.33,lng:18.07,city:"Stockholm",org:"Bithomp"},"aureusox.com":{lat:40.71,lng:-74.01,city:"New York",org:"Aureus Ox"},"arrington-xrp-capital.blockdaemon.com":{lat:40.71,lng:-74.01,city:"New York",org:"Blockdaemon"},"anodos.finance":{lat:37.98,lng:23.73,city:"Athens",org:"Anodos Finance"},"bitso.com":{lat:19.43,lng:-99.13,city:"Mexico City",org:"Bitso"},"ripple.kenan-flagler.unc.edu":{lat:35.9,lng:-79.05,city:"Chapel Hill, NC",org:"UNC Kenan-Flagler"},"ripplevalidator.uwaterloo.ca":{lat:43.47,lng:-80.54,city:"Waterloo, ON",org:"Univ. of Waterloo"},"shadow.haas.berkeley.edu":{lat:37.87,lng:-122.26,city:"Berkeley, CA",org:"UC Berkeley Haas"},"www.bitrue.com":{lat:1.35,lng:103.82,city:"Singapore",org:"Bitrue"},"xrp-col.anu.edu.au":{lat:-35.28,lng:149.13,city:"Canberra",org:"ANU"},"xrpval.rawsec.de":{lat:51.17,lng:10.45,city:"Germany",org:"Rawsec"},"xrplvl.carbonvibe.com":{lat:51.51,lng:-.13,city:"London",org:"Carbon Vibe"},"xrplvalidator.alloy.ee":{lat:59.44,lng:24.75,city:"Tallinn",org:"Alloy"},"xrpl.uni.lu":{lat:49.61,lng:6.13,city:"Luxembourg",org:"Univ. of Luxembourg"},"xrpl.to":{lat:48.86,lng:2.35,city:"Paris",org:"XRPL.to"},"xrpl.su":{lat:55.75,lng:37.62,city:"Moscow",org:"XRPL.su"},"xrpl.sbivc.co.jp":{lat:35.69,lng:139.69,city:"Tokyo",org:"SBI VC Trade"},"xrpl-verification.flare.network":{lat:51.51,lng:-.13,city:"London",org:"Flare Network"},"xrpl-validator.7rev.dev":{lat:52.52,lng:13.4,city:"Berlin",org:"7Rev"},"xrp.teacopula.com":{lat:39.04,lng:-77.49,city:"Ashburn, VA",org:"Teacopula"},"xrp.moneymindedapes.com":{lat:39.04,lng:-77.49,city:"Ashburn, VA",org:"MoneyMindedApes"},"xrp.hazza-systems.de":{lat:52.52,lng:13.4,city:"Berlin",org:"Hazza Systems"},"xrp.cs.uoregon.edu":{lat:44.05,lng:-123.08,city:"Eugene, OR",org:"Univ. of Oregon"},"xrp.bpsqn.com":{lat:37.77,lng:-122.42,city:"San Francisco",org:"BPSQN"},"xrp-validator.grapedrop.xyz":{lat:52.37,lng:4.9,city:"Amsterdam",org:"Grapedrop"},"xaodao.io":{lat:1.35,lng:103.82,city:"Singapore",org:"XaoDAO"},"vl.xrpsalute.com":{lat:40.71,lng:-74.01,city:"New York",org:"XRP Salute"},"validator.ukcbt.org":{lat:51.51,lng:-.13,city:"London",org:"UKCBT"},"validator.sugarxrpl.com":{lat:37.77,lng:-122.42,city:"San Francisco",org:"SugarXRPL"},"validator.boscaern.digital":{lat:53.33,lng:-6.25,city:"Dublin",org:"Boscaern"},"trimaera.tech":{lat:48.86,lng:2.35,city:"Paris",org:"Trimaera"},"textrp.io":{lat:1.35,lng:103.82,city:"Singapore",org:"TextRP"},"tesbert.com":{lat:39.04,lng:-77.49,city:"Ashburn, VA",org:"Tesbert"},"tachyon-xrpl-validator.github.io":{lat:37.77,lng:-122.42,city:"San Francisco",org:"Tachyon"},"solonation.io":{lat:1.35,lng:103.82,city:"Singapore",org:"SoloNation"},"smokydrip.com":{lat:39.04,lng:-77.49,city:"Ashburn, VA",org:"SmokyDrip"},"rippled-validator.us":{lat:39.04,lng:-77.49,city:"Ashburn, VA",org:"rippled-validator.us"},"rippleat.snt.uni.lu":{lat:49.61,lng:6.13,city:"Luxembourg",org:"Univ. of Luxembourg"},"ripple.uni.lu":{lat:49.61,lng:6.13,city:"Luxembourg",org:"Univ. of Luxembourg"},"ripple.j2b.com":{lat:37.77,lng:-122.42,city:"San Francisco",org:"J2B"},"rich-list.info":{lat:51.51,lng:-.13,city:"London",org:"Rich List"},"proptoexchange.com":{lat:39.04,lng:-77.49,city:"Ashburn, VA",org:"ProPtoExchange"},"printscierge.com":{lat:39.04,lng:-77.49,city:"Ashburn, VA",org:"Printscierge"},"opulencex.io":{lat:1.35,lng:103.82,city:"Singapore",org:"OpulenceX"},"onledger.net":{lat:52.37,lng:4.9,city:"Amsterdam",org:"OnLedger"},"oclost.art":{lat:48.86,lng:2.35,city:"Paris",org:"Oclost"},"managednetwork.us":{lat:39.04,lng:-77.49,city:"Ashburn, VA",org:"ManagedNetwork"},"joshuahamsa.com":{lat:37.77,lng:-122.42,city:"San Francisco",org:"Joshua Hamsa"},"grimmsxrpflow.jwscott.net":{lat:39.04,lng:-77.49,city:"Ashburn, VA",org:"Grimm XRP Flow"},"getlol.xyz":{lat:39.04,lng:-77.49,city:"Ashburn, VA",org:"GetLol"},"gen3labs.xyz":{lat:37.77,lng:-122.42,city:"San Francisco",org:"Gen3 Labs"},"garveyvalid.com":{lat:40.71,lng:-74.01,city:"New York",org:"Garvey"},"easynpl.kr":{lat:37.57,lng:126.98,city:"Seoul",org:"EasyNPL"},"diseb.ewi.tudelft.nl":{lat:52,lng:4.36,city:"Delft",org:"TU Delft"},"datamossa.com":{lat:48.86,lng:2.35,city:"Paris",org:"DataMossa"},"crypto.unibe.ch":{lat:46.95,lng:7.45,city:"Bern",org:"Univ. of Bern"},"commonprefix.com":{lat:37.98,lng:23.73,city:"Athens",org:"Common Prefix"},"catalyze-research.com":{lat:51.51,lng:-.13,city:"London",org:"Catalyze Research"},"catalog.org":{lat:37.77,lng:-122.42,city:"San Francisco",org:"Catalog"},"blockchain.korea.ac.kr":{lat:37.57,lng:126.98,city:"Seoul",org:"Korea Univ."},"astatiumprotocol.com":{lat:1.35,lng:103.82,city:"Singapore",org:"Astatium Protocol"},"ladykxrpl.mywire.org":{lat:39.04,lng:-77.49,city:"Ashburn, VA",org:"LadyK XRPL"},"eelap-p1201-xrp.abudhabi.nyu.edu":{lat:24.47,lng:54.37,city:"Abu Dhabi",org:"NYU Abu Dhabi"},"589.clouds.hspeed.ch":{lat:47.38,lng:8.54,city:"Zurich",org:"HSpeed"},"www.payonline.financial":{lat:55.75,lng:37.62,city:"Moscow",org:"PayOnline"}};function Cr(e){if(!e)return null;let t=e.toLowerCase().replace(/^www\./,"");return mm[t]??mm["www."+t]??null}var mw=[{lat:37.34,lng:-121.89,label:"s1.ripple.com",city:"San Jose, CA",org:"Ripple"},{lat:37.34,lng:-121.87,label:"s2.ripple.com",city:"San Jose, CA",org:"Ripple"},{lat:52.37,lng:4.91,label:"xrplcluster.com",city:"Amsterdam",org:"Cluster"},{lat:52.36,lng:4.89,label:"xrpl.ws",city:"Amsterdam",org:"Cluster"}],Oe={nunl:{hex:"#ff5555",glow:"rgba(255,85,85,.4)",label:"Negative UNL"},both:{hex:"#50fa7b",glow:"rgba(80,250,123,.4)",label:"UNL + dUNL"},unl:{hex:"#00fff0",glow:"rgba(0,255,240,.35)",label:"UNL"},dunl:{hex:"#bd93f9",glow:"rgba(189,147,249,.4)",label:"dUNL only"},other:{hex:"#ffb86c",glow:"rgba(255,184,108,.4)",label:"Other"},pub:{hex:"#50fa7b",glow:"rgba(80,250,123,.4)",label:"Public Node"}},br="https://api.xrpscan.com/api/v1/validatorregistry",ke=new Map,kn={},vo=0,Gn=!1,$n="fallback";function Mm(){if(!Gn){ke.clear();for(let[e,t]of Object.entries(Tr)){let n=t.domain??e,s=Pm("",n),a=Cr(n)??null;ke.set(e,{key:e,label:t.label,domain:n,domainVerified:!1,provider:t.provider??(a==null?void 0:a.org)??null,lists:t.lists??[],category:s.isUnl?"unl":"other",chain:s.chain,unl:s.isUnl,dunl:!1,geo:a,meta:{},agreement:{"1h":null,"24h":null,"30d":null}})}$n="fallback",Pr({ok:!1,source:"fallback",error:"using hardcoded data \u2014 mount /api/v1 router"})}}var yr=0,fw=5*60*1e3;function fm(e,t){var s,a;let n=Array.isArray(e)?e:e.validators??e.data??[];if(!n.length)throw new Error("Empty validators array");ke.clear();for(let o of n){let i=o.key??o.validation_public_key??o.master_key??o.signing_key??null;if(!i)continue;let r=o.domain??null,l=r?r.toLowerCase().replace(/^www\./,""):null,c=o.unl===!0||o.unl===1||o.unl==="true",d=Pm(i,l),u=c||d.isUnl,p=d.chain,m=u?"unl":"other",f=Object.values(Tr).find(w=>w.domain&&w.domain.toLowerCase().replace(/^www\./,"")===l),g=(f==null?void 0:f.label)??o.label??o.account_name??o.name??l??null??`${i.slice(0,8)}\u2026${i.slice(-6)}`,v=yo[i]??Cr(l)??null,b=(((s=o.geo)==null?void 0:s.lat)!=null&&((a=o.geo)==null?void 0:a.lng)!=null?o.geo:null)??v;ke.set(i,{key:i,label:g,domain:r??null,domainVerified:!!(o.domainVerified??o.domain_verified),provider:o.provider??(b==null?void 0:b.org)??(f==null?void 0:f.provider)??null,lists:Array.isArray(o.lists)?o.lists:[],category:m,chain:p,unl:u,dunl:!1,geo:b,version:o.version??o.build_version??null,baseFee:o.base_fee_xrp??o.base_fee??null,ownerReserve:o.reserve_inc_xrp??o.owner_reserve??null,meta:o.meta??{},agreement:o.agreement??{"1h":mr(o.agreement_1h??o.agr_1h),"24h":mr(o.agreement_24h??o.agr_24h),"30d":mr(o.agreement_30d??o.agr_30d)}})}kn=e.lists??{},vo=Date.now(),Gn=!0,$n=t,yr=0,Pr({ok:!0,count:ke.size,lists:kn,source:t})}function mr(e){if(!e)return null;let t=Number(e.total??e.ledgers??0),n=Number(e.missed??0),s=t-n,a=t>0?(s/t*100).toFixed(1):null;return{total:t,missed:n,hit:s,score:a?`${a}%`:null,scoreRaw:e.score??null}}async function go(e=!1){let t=Date.now();if(!e&&Gn&&t-vo<dw)return!0;if(!e&&!Gn&&t-yr<fw)return!1;let n=typeof ra=="string"&&ra.startsWith("/api/"),s=location.protocol==="file:"||location.hostname==="127.0.0.1"||location.hostname==="localhost";if(!(n&&s))try{let a=new AbortController,o=setTimeout(()=>a.abort(),pm),i=await fetch(ra,{signal:a.signal,headers:{Accept:"application/json"}});if(clearTimeout(o),!i.ok)throw new Error(`HTTP ${i.status}`);let r=await i.json();return fm(r,"proxy"),!0}catch(a){console.warn("[registry] tier 1 (proxy) failed:",a.message)}try{let a=new AbortController,o=setTimeout(()=>a.abort(),pm),i=await fetch(br,{signal:a.signal});if(clearTimeout(o),!i.ok)throw new Error(`HTTP ${i.status}`);let r=await i.text(),l=JSON.parse(r);return fm(l,"xrpscan"),!0}catch(a){console.warn("[registry] tier 2 (xrpscan direct) failed:",a.message),(a.message.includes("Failed to fetch")||a.message.includes("CORS"))&&console.warn("[registry] CORS blocked \u2014 mount the backend proxy route (see validatorregistry.js)")}return console.warn("[registry] all sources failed \u2014 showing",Object.keys(Tr).length,"hardcoded validators"),yr=Date.now(),Gn||Mm(),Pr({ok:!1,source:"fallback",error:"all sources failed \u2014 mount /api/v1 router"}),!1}window.debugRegistry=async function(){console.group("\u{1F50D} Registry debug"),console.log("Current source:",$n),console.log("Validators loaded:",ke.size),console.log("Registry ok:",Gn),console.log("Last fetch:",vo?new Date(vo).toLocaleTimeString():"never"),console.log(""),console.log("Testing proxy \u2192",ra);try{let e=await fetch(ra),t=await e.text();console.log("  Status:",e.status,"\u2014 body preview:",t.slice(0,300))}catch(e){console.warn("  Failed:",e.message)}console.log(""),console.log("Testing XRPScan direct \u2192",br);try{let e=await fetch(br),t=await e.text();console.log("  Status:",e.status,"\u2014 body preview:",t.slice(0,300))}catch(e){console.warn("  Failed:",e.message)}return console.groupEnd(),{source:$n,size:ke.size,ok:Gn}};function rt(e){return ke.get(e)??{key:e,label:`${e.slice(0,10)}\u2026${e.slice(-6)}`,domain:null,provider:null,lists:[],category:"other",geo:yo[e]??null,meta:{}}}function Sn(e){var n;if(!e)return null;if(((n=e.geo)==null?void 0:n.lat)!=null)return e.geo;let t=yo[e.key];return t||Cr(e.domain)}function Lm(){return[...ke.values()].filter(e=>(e.category==="unl"||e.category==="both")&&e.chain!=="test").map(e=>e.key)}function hw(){return[...ke.values()].filter(e=>(e.category==="dunl"||e.category==="both")&&e.chain!=="test").map(e=>e.key)}function gw(){return[...ke.values()].filter(e=>e.category==="other"&&e.chain!=="test").map(e=>e.key)}function vw(){return[...ke.values()].filter(e=>e.chain==="test").map(e=>e.key)}function Pr({ok:e,count:t,lists:n,source:s,error:a}){let o=x("m1-registry-badge");if(o)if(e){let i=[...ke.values()].filter(c=>c.category==="unl").length,r=[...ke.values()].filter(c=>c.chain==="test").length,l=t-r;o.textContent=`${l} mainnet \xB7 ${i} UNL \xB7 ${r} testnet \xB7 live`,o.className="registry-badge registry-badge--ok"}else o.textContent=s==="fallback"?`Fallback data \xB7 ${ke.size} known \xB7 ${a??"endpoint unreachable"}`:"Refreshing\u2026",o.className="registry-badge registry-badge--warn"}var bo=null,hm=!1,fr=!1,gm=0,vm=0,bm=0,hr=0,Am=!0,st=null,Vn=null,da=null,zt=null,je={},fo=null,wr={},nt=null,nn=[],ho=null,xr={},oa="unl",ft={fees:[],burnDrops:[],dexOffers:[],ammSwaps:[],newAccounts:[],converge:[],proposers:[],peerCounts:[],peerDiscon:[]};function Em(){var t,n;if(hm)return;hm=!0,Ww(),Mm(),go(!0),Hw(),zw(),window.addEventListener("xrpl-connected",()=>{ia(),Ts()&&(la({force:!0}),ca({force:!1}))}),window.addEventListener("xrpl-disconnected",()=>{kr(),Sr(null)}),window.addEventListener("xrpl-connection",s=>{var a;((a=s==null?void 0:s.detail)==null?void 0:a.state)==="connecting"&&(kr(),Sr(null,"Switching networks\u2026"))}),window.addEventListener("xrpl-ledger",s=>{Ow(s.detail),Ts()&&Bw(s.detail)}),(t=x("btn-network-refresh"))==null||t.addEventListener("click",()=>{la({force:!0}),go(!0),ca({force:!0})}),(n=document.querySelector('.dash-tab[data-tab="network"]'))==null||n.addEventListener("click",()=>{ia(),la({force:!0}),go(!1),ca({force:!1})});let e=x("tab-network");e&&new MutationObserver(ia).observe(e,{attributes:!0,attributeFilter:["style","class"]}),document.addEventListener("visibilitychange",ia)}function Ts(){let e=x("tab-network"),t=e?e.style.display!=="none":!1;return Am&&X.currentPage==="dashboard"&&X.currentTab==="network"&&t&&!document.hidden}function ia(){Ts()?bw():kr()}function Nm(e){Am=!!e,ia()}function bw(){bo||(la({force:!1}),bo=setInterval(()=>{Ts()&&la({force:!1})},nw))}function kr(){clearInterval(bo),bo=null}async function la({force:e=!1}={}){var n;if(!Ts()&&!e)return;let t=Date.now();if(!(!e&&(t-gm<sw||fr||t<vm))){fr=!0,gm=t,je={},ym(!0);try{await Promise.allSettled([go(!1),yw(),ww(),xw(),kw(),$w()]),Sw(),Mw(),Lw(),Aw(),Iw(),Sr({info:st,fee:Vn,vals:da}),Uw()}catch(s){String((s==null?void 0:s.message)??"").toLowerCase().includes("too much load")&&(vm=Date.now()+aw,(n=he)==null||n("Rate-limited \u2014 backing off 2 min."))}finally{ym(!1),fr=!1}}}function ym(e){var t;(t=x("btn-network-refresh"))==null||t.classList.toggle("spinning",e)}async function yw(){var n,s,a;let e=await Ee({command:"server_info"});if(st=((n=e==null?void 0:e.result)==null?void 0:n.info)??null,!st)return;it("converge",Number(((s=st.last_close)==null?void 0:s.converge_time_s)??0)),it("proposers",Number(((a=st.last_close)==null?void 0:a.proposers)??0)),it("peerCounts",Number(st.peers??0));let t=Number(st.peer_disconnects_resources??0);fo!==null&&t>fo&&it("peerDiscon",t-fo),fo=t}async function ww(){var t;let e=await Ee({command:"fee"});Vn=(e==null?void 0:e.result)??null,((t=Vn==null?void 0:Vn.drops)==null?void 0:t.open_ledger_fee)!=null&&it("fees",Number(Vn.drops.open_ledger_fee))}async function xw(){try{let e=await Ee({command:"validators"});da=(e==null?void 0:e.result)??null}catch{da=null}}async function kw(){var e;try{let t=await Ee({command:"peers"});zt=Array.isArray((e=t==null?void 0:t.result)==null?void 0:e.peers)?t.result.peers:null}catch{zt=null}}async function $w(){var e;try{let t=await Ee({command:"feature"});(e=t==null?void 0:t.result)!=null&&e.features&&(Ew(t.result.features),_m(t.result.features))}catch{}}function Sw(){var P,C,R,I,D,F;let e=st,t=da,n=(t==null?void 0:t.trusted_validator_keys)??[],s=Lm(),a=hw(),o=n.length?n:s,i=a,r=Number((t==null?void 0:t.validation_quorum)??(e==null?void 0:e.validation_quorum)??0),l=o.length,c=l-r,d=l>0?r/l*100:0,u=o.filter(O=>ke.has(O)).length,p=l>0?Math.round(u/l*100):0,m=Number(((P=e==null?void 0:e.last_close)==null?void 0:P.converge_time_s)??0),f=Number(((C=e==null?void 0:e.last_close)==null?void 0:C.proposers)??0),g=r>0?Math.round(f/r*100):0,v=Array.isArray(e==null?void 0:e.negative_unl)?e.negative_unl:[],h=!!da;c>=0&&c<=3&&(je.quorumTight=!0),v.length>0&&(je.nUnlActive=!0),m>6&&(je.slowConverge=!0),f>0&&r>0&&f<r&&(je.lowProposers=!0),K("m1-active",h?l:"\u2014"),K("m1-quorum",r>0?r:"\u2014"),K("m1-margin",h?c>=0?c:`\u2212${Math.abs(c)}`:"\u2014"),K("m1-overlap",h?`${p}%`:"\u2014"),K("m1-known",h?`${u} / ${l} identified`:"\u2014 (validators cmd unavailable)"),K("m1-proposers",((R=e==null?void 0:e.last_close)==null?void 0:R.proposers)!=null?f:"\u2014"),K("m1-particip",r>0&&((I=e==null?void 0:e.last_close)==null?void 0:I.proposers)!=null?`${g}%`:"\u2014"),K("m1-converge",((D=e==null?void 0:e.last_close)==null?void 0:D.converge_time_s)!=null?`${m.toFixed(2)}s`:"\u2014"),K("m1-converge-avg",pa("converge")>0?`avg ${pa("converge").toFixed(2)}s`:"\u2014"),Ct("m1-qbar",d,d>90?"bar-danger":d>80?"bar-warn":"bar-ok"),Ct("m1-obar",p,p<40?"bar-danger":p<70?"bar-warn":"bar-ok"),Ct("m1-pbar",g,g<80?"bar-danger":g<95?"bar-warn":"bar-ok"),Ct("m1-cvgbar",Math.min(100,m/10*100),m>6?"bar-danger":m>4?"bar-warn":"bar-ok"),Pw({active:l,quorum:r,margin:c,nUnl:v,valsAvail:h});let b=(F=t==null?void 0:t.publisher_lists)==null?void 0:F[0],w=(kn==null?void 0:kn.ripple)??(kn==null?void 0:kn.xrplf)??null,k=(b==null?void 0:b.uri)??(w==null?void 0:w.uri)??"\u2014",$=(b==null?void 0:b.seq)??(w==null?void 0:w.seq)??"\u2014";if(K("m1-vl-uri",k),K("m1-vl-seq",$),b!=null&&b.expiration||w!=null&&w.expiration){let O=x("m1-vl-expiry");if(O){let H=(b==null?void 0:b.expiration)??(w==null?void 0:w.expiration),N=Math.floor((new Date(H)-Date.now())/864e5);O.textContent=N>0?`Expires ${N}d`:"\u26A0 EXPIRED",O.className=`expiry-pill ${N>30?"pill-ok":N>7?"pill-warn":"pill-bad"}`,O.style.display=""}}let T=x("m1-nunl-list");if(K("m1-nunl-count",v.length||"0"),T)if(!v.length)T.innerHTML='<div class="nunl-empty">\u2713 No validators on Negative UNL</div>';else{let O={};T.innerHTML=v.map(N=>{let j=rt(N);return j.provider&&(O[j.provider]=(O[j.provider]||0)+1),`<div class="nunl-entry">
        ...
        </div>`}).join("");let H=Object.entries(O).sort((N,j)=>j[1]-N[1])[0];(H==null?void 0:H[1])>1&&(T.innerHTML+=`<div class="nunl-alert">\u26A0 ${H[1]} offline validators share <b>${y(H[0])}</b> \u2014 likely provider outage</div>`)}Rm(o,i,r,v,h);let S=Number((st==null?void 0:st.peers)??0);K("wm-stat-val",h?`${l} validators`:`${ke.size} in registry`),K("wm-stat-nunl",`${v.length} on nUNL`),K("wm-stat-peers",`${zt?zt.length:S} peers`);let E=[...ke.keys()];Rw(o,i,v,zt,!h)}function Rm(e,t,n,s,a){let o=x("m1-val-grid");if(!o)return;let i=new Set(e),r=new Set(t),l=new Set(s),c=Lm(),d=vw(),u=gw(),p=e.length?e:c,m=[...ke.keys()],f=m.filter(D=>{var F;return(((F=ke.get(D))==null?void 0:F.chain)??"main")==="main"}),g=d,v=u,h=p.filter(D=>!!rt(D).domain),b=p.filter(D=>!rt(D).domain),w=v.filter(D=>!!rt(D).domain),k=v.filter(D=>!rt(D).domain),$=m.filter(D=>!!Sn(rt(D))),T=[{id:"unl",label:"UNL",count:p.length,dot:"unl"},{id:"others",label:"Others",count:v.length,dot:"other"},{id:"all",label:"All",count:f.length,dot:null},{id:"test",label:"Testnet",count:g.length,dot:null}],S={unl:"#00fff0",dunl:"#bd93f9",both:"#50fa7b",nunl:"#ff5555",other:"#ffb86c"},E='<div class="vg-tabs" role="tablist">'+T.map(D=>`<button class="vg-tab ${oa===D.id?"vg-tab--active":""}" data-vgtab="${D.id}">
        ${D.dot?`<span class="vg-tab-dot" style="background:${S[D.dot]}"></span>`:""}
        ${y(D.label)}
        <span class="vg-tab-count">${D.count}</span>
      </button>`).join("")+"</div>",P=[],C="";if(oa==="unl"){let D=p.filter(N=>l.has(N)),F=h.filter(N=>!l.has(N)),O=b.filter(N=>!l.has(N));D.length&&P.push({title:`\u26A0 Negative UNL (${D.length})`,keys:D,cls:"vgs-warn"}),P.push({title:`Named UNL validators \xB7 ${F.length}`,keys:F}),O.length&&P.push({title:`Key-only UNL validators \xB7 ${O.length}`,keys:O,collapsed:!0}),p.length||P.push({title:"No UNL data",keys:[],notice:"Registry not loaded yet"});let H=a?"live rippled":`registry (${$n})`;C=`${p.length} trusted \xB7 quorum ${n} \xB7 ${s.length} on nUNL \xB7 source: ${H}`}else if(oa==="others")P.push({title:`Named mainnet (non-UNL) \xB7 ${w.length}`,keys:w}),k.length&&P.push({title:`Key-only mainnet \xB7 ${k.length}`,keys:k,collapsed:!0}),C=`${v.length} mainnet validators not on UNL \xB7 source: ${$n}`;else if(oa==="test"){let D=g.filter(O=>!!rt(O).domain),F=g.filter(O=>!rt(O).domain);D.length&&P.push({title:`Named testnet \xB7 ${D.length}`,keys:D}),F.length&&P.push({title:`Key-only testnet \xB7 ${F.length}`,keys:F,collapsed:!0}),C=`${g.length} testnet validators`}else P.push({title:`\u2B50 UNL \xB7 ${p.length}`,keys:p}),P.push({title:`Other mainnet \xB7 ${v.length}`,keys:v,collapsed:!0}),g.length&&P.push({title:`Testnet \xB7 ${g.length}`,keys:g,collapsed:!0}),C=`${f.length} mainnet \xB7 ${g.length} testnet \xB7 ${$.length} geo-located \xB7 source: ${$n}`;function R(D,F){var $e;let O=rt(D),H=l.has(D),N=i.has(D),j=r.has(D),se=O.chain==="test",re,pe,ae;H?(re="vp-nunl",pe="nUNL",ae=S.nunl):N&&j?(re="vp-both",pe="UNL+dUNL",ae=S.both):N?(re="vp-unl",pe="UNL",ae=S.unl):j?(re="vp-dunl",pe="dUNL",ae=S.dunl):(re="vp-other",pe="Other",ae=S.other);let te=Sn(O),de=!!te,le=te?`\u{1F4CD} ${te.city??""}`:"",Pe=O.domain?O.domain.replace(/^www\./,"").replace(/^validator\./,"").replace(/^xrp\./,""):null,B=`${D.slice(0,8)}\u2026${D.slice(-6)}`,q=N&&F!=null?`<span class="vg-num">${F+1}</span>`:"",J=($e=O.agreement)==null?void 0:$e["24h"],ue=J!=null&&J.score?`<span class="vg-agr" style="color:${parseFloat(J.score)>=99?"#50fa7b":parseFloat(J.score)>=95?"#ffb86c":"#ff5555"}" title="24h agreement">${J.score}</span>`:"";return`<div class="vpill ${re} ${de?"vp-locatable":""}"
      ...
      </div>`}),I||(I='<div class="nunl-empty">No validators in this view.</div>'),o.innerHTML=E+I,K("m1-val-summary",C),o.querySelectorAll(".vg-tab").forEach(D=>{D.addEventListener("click",F=>{F.stopPropagation();let O=D.getAttribute("data-vgtab");O&&(oa=O,Rm(e,t,n,s,a))})})}async function Tw(e){let t=gr.get(e);if(t&&Date.now()-t.cachedAt<Sm)return t.data;try{let n=new AbortController,s=setTimeout(()=>n.abort(),Tm),a=await fetch(`${$m}/${encodeURIComponent(e)}`,{signal:n.signal});if(clearTimeout(s),!a.ok)throw new Error(`HTTP ${a.status}`);let o=await a.json();return gr.set(e,{data:o,cachedAt:Date.now()}),o}catch{return null}}async function Cw(e){let t=vr.get(e);if(t&&Date.now()-t.cachedAt<Sm)return t.data;try{let n=new AbortController,s=setTimeout(()=>n.abort(),Tm),a=await fetch(`${$m}/${encodeURIComponent(e)}/reports`,{signal:n.signal});if(clearTimeout(s),!a.ok)throw new Error(`HTTP ${a.status}`);let o=await a.json(),i=o.reports??o??[];return vr.set(e,{data:i,cachedAt:Date.now()}),i}catch{return[]}}window.focusValidator=async function(e){let t=rt(e),n=Sn(t);document.querySelectorAll(".vpill").forEach(o=>o.classList.remove("vp-active"));let s=document.querySelector(`.vpill[data-key="${CSS.escape(e)}"]`);if(s&&(s.classList.add("vp-active"),s.scrollIntoView({behavior:"smooth",block:"nearest"})),$r(e,t,null),Tw(e).then(o=>{o&&$r(e,t,o)}),!n){let o=x("world-map-container");if(o){let i=o.querySelector(".wm-no-geo");i&&i.remove();let r=document.createElement("div");r.className="wm-no-geo",r.textContent=`\u{1F4CD} ${t.label} \u2014 geographic location unknown`,o.appendChild(r),setTimeout(()=>r.remove(),3500)}return}let a=x("world-map-container");a&&a.scrollIntoView({behavior:"smooth",block:"nearest"}),nt&&(nt.flyTo([n.lat,n.lng],6,{duration:1.2}),setTimeout(()=>{let o=xr[e];o&&o.openPopup()},1300))};function $r(e,t,n){var P,C,R,I,D;let s=x("amend-modal-overlay"),a=x("amend-modal-body");if(!s||!a)return;let o=n??{},i=t.label??o.label??o.account_name??e.slice(0,16)+"\u2026",r=t.domain??o.domain??null,l=t.chain??o.chain??"main",c=t.category??"other",d=Oe[c]??Oe.other,u=Sn(t),p=t.unl||c==="unl"||c==="both",m=t.dunl||c==="dunl"||c==="both",f=t.domainVerified||o.domain_verified?"\u2713 Verified":r?"Unverified":"\u2014",g=t.agreement??o.agreement??{},v=!n&&!((P=t.agreement)!=null&&P["24h"]);function h(F,O){if(!O||!O.total)return`<div class="adm-mi"><span class="adm-mk">${F}</span><span class="adm-mv" style="opacity:.5">\u2014</span></div>`;let H=parseFloat(O.score)||0,N=H>=99?"color:#50fa7b":H>=95?"color:#ffb86c":"color:#ff5555";return`<div class="adm-mi">
    ...
    <div class="qr-wrap">
      ...
      </div>`}).join("")+`<div class="vd-summary">${r} geo-located \xB7 <span style="color:${h}">${v}</span> (HHI ${g.toFixed(2)})</div>`}let c={};for(let m of ke.values()){if(m.chain==="test")continue;let f=Sn(m),g=m.provider??(f==null?void 0:f.org)??"Unknown",v=g.match(/AWS|Amazon/i)?"AWS":g.match(/Azure|Microsoft/i)?"Azure":g.match(/GCP|Google/i)?"GCP":g.match(/Hetzner/i)?"Hetzner":g.match(/OVH/i)?"OVH":g.match(/Cloudflare/i)?"Cloudflare":g.match(/Equinix/i)?"Equinix":g.match(/NTT/i)?"NTT":g.match(/Ripple/i)?"Ripple":"Other";c[v]=(c[v]??0)+1}let d=x("m4-provider-dist");if(d){let m=Object.values(c).reduce((f,g)=>f+g,0);if(m>0){let f=Object.entries(c).sort((v,h)=>h[1]-v[1]),g=["#ff5555","#ffb86c","#50fa7b","#00fff0","#bd93f9","#8be9fd","#6272a4"];d.innerHTML=f.slice(0,7).map(([v,h],b)=>{let w=Math.round(h/m*100),k=g[b%g.length],$=w>33?"\u26A0 ":"";return`<div class="vd-row">
      ...
      ${l.length?`<div class="ap-near-bar">\u{1F4C8} ${l.length} amendment${l.length>1?"s":""} approaching 80% threshold</div>`:""}`,n.querySelectorAll(".ap-tab").forEach(u=>{u.onclick=()=>{$s=u.dataset.aptab,_m(e)}})}let c=$s==="active"?a:$s==="vetoed"?i:$s==="all"?s.sort((d,u)=>d.enabled!==u.enabled?d.enabled?1:-1:d.vetoed!==u.vetoed?d.vetoed?1:-1:(u.count??0)-(d.count??0)):o;if(!c.length){t.innerHTML=`<div class="amend-empty">${$s==="vetoed"?"No vetoed amendments":"No data"}</div>`;return}t.innerHTML=c.map(d=>{var S;let u=d.count??0,p=d.threshold??28,m=Math.min(100,Math.round(u/p*100)),f=d.name??`${d.hash.slice(0,10)}...`,g=!!d.enabled,v=!!d.vetoed,h=!!d.majority,b=Cm[f]??{},w=(S=ft.amendMomentum)==null?void 0:S[d.hash],k="";if(h&&!g&&d.majority){let E=Date.now()-new Date(d.majority).getTime(),P=E>0?Math.floor(E/864e5):0,C=Math.max(0,14-P),R=Math.min(100,Math.round(P/14*100));k=`<div class="ap-countdown">
      ...
      </div>`}let $=g?"#50fa7b":v?"#ff5555":h?"#ffb86c":m>=80?"#8be9fd":"rgba(255,255,255,.3)",T=g?"Active":v?"Vetoed":h?"Majority":m>=80?"Near":"Voting";return`<div class="ap-row" onclick="window.showAmendDetail('${y(d.hash)}')">
    ...
    </div>`}).join("")}function Ew(e){wr={},Object.entries(e).forEach(([t,n])=>{wr[t]={hash:t,...n}})}window.showAmendDetail=function(e){let t=wr[e];if(!t)return;let n=t.name||`${e.slice(0,16)}...`,s=Cm[n]||{},a=t.count??0,o=t.threshold??28,i=Math.min(100,Math.round(a/o*100)),r=t.enabled?"Active on Ledger":t.vetoed?"Vetoed":t.majority?"Majority Reached":"Voting in Progress",l=t.enabled?"adm-s-ok":t.vetoed?"adm-s-bad":t.majority?"adm-s-warn":"adm-s-info",c=t.enabled?"bar-ok":t.vetoed?"bar-danger":t.majority?"bar-warn":"bar-info",d=t.majority&&!t.enabled?`
    ...
    <div class="adm-footer">
      ...
      <a class="adm-link" href="https://xrpl.org/consensus.html" target="_blank" rel="noopener noreferrer">Consensus Docs</a>
    </div>`,u.style.display="flex",u.addEventListener("click",m=>{m.target===u&&window.closeAmendModal()},{once:!0}))};window.closeAmendModal=function(){let e=x("amend-modal-overlay");e&&(e.style.display="none")};function Nw(e){if(window.L){e();return}if(!document.querySelector("#leaflet-css")){let n=document.createElement("link");n.id="leaflet-css",n.rel="stylesheet",n.href="https://cdnjs.cloudflare.com/ajax/libs/leaflet/1.9.4/leaflet.min.css",document.head.appendChild(n)}let t=document.createElement("script");t.src="https://cdnjs.cloudflare.com/ajax/libs/leaflet/1.9.4/leaflet.min.js",t.onload=e,document.head.appendChild(t)}function Rw(e,t,n,s,a=!1){x("world-map-container")&&Nw(()=>_w(e,t,n,s,a))}function _w(e,t,n,s,a=!1){let o=x("world-map-container");if(!o)return;let i=new Set(n||[]),r=new Set(e||[]),l=new Set(t||[]),c=X.currentNetwork||"xrpl-mainnet";if(nt&&ho!==c&&(nt.remove(),nt=null,nn=[],ho=null),!nt){o.innerHTML="";let k=document.createElement("div");k.id="wm-leaflet",k.style.cssText="width:100%;height:440px;",o.appendChild(k),nt=L.map("wm-leaflet",{center:[25,5],zoom:2,minZoom:1,maxZoom:12,zoomControl:!0,attributionControl:!0,worldCopyJump:!0}),L.tileLayer("https://{s}.basemaps.cartocdn.com/dark_all/{z}/{x}/{y}{r}.png",{attribution:'&copy; <a href="https://carto.com">CARTO</a> &copy; <a href="https://openstreetmap.org">OSM</a>',subdomains:"abcd",maxZoom:19}).addTo(nt),ho=c}nn.forEach(k=>{try{k.remove()}catch{}}),nn=[];function d(k){return i.has(k)?"nunl":r.has(k)&&l.has(k)?"both":r.has(k)?"unl":l.has(k)?"dunl":"other"}xr={};let u={};for(let[k,$]of ke){let T=Sn($);if(!(T!=null&&T.lat)||!(T!=null&&T.lng))continue;let S=`${(Math.round(T.lat*2)/2).toFixed(1)},${(Math.round(T.lng*2)/2).toFixed(1)}`;u[S]||(u[S]={lat:T.lat,lng:T.lng,keys:[],city:T.city,org:T.org}),u[S].keys.push(k)}if(Object.values(u).forEach(k=>{let $=k.keys.length,T=k.keys.map(d),S=["nunl","both","unl","dunl","other"].find(I=>T.includes(I))||"other",E=Oe[S],P=$>5?13:$>2?10:7,C=L.divIcon({html:`<div class="wm-lmarker wm-lmarker-val ${S==="nunl"?"wm-lmarker-nunl":""} ${a?"wm-lmarker-ref":""}"
      ...
      </div>`,className:"",iconSize:[(P+8)*2,(P+8)*2],iconAnchor:[P+8,P+8]}),R=L.marker([k.lat,k.lng],{icon:C}).bindPopup(Dw(k.keys,k.city,k.org,i,r,l,a),{maxWidth:380,className:"wm-popup-wrap"}).addTo(nt);k.keys.forEach(I=>{xr[I]=R}),nn.push(R)}),a){let k=L.control({position:"bottomleft"});k.onAdd=()=>{let $=L.DomUtil.create("div","wm-ref-banner");return $.innerHTML="\u{1F4E1} Reference positions \xB7 live validator list unavailable from endpoint",$},k.addTo(nt),nn.push(k)}let p=[...ke.keys()].filter(k=>{var T;return((T=ke.get(k).geo)==null?void 0:T.lat)!=null||yo[k]}).length,m=ke.size-p;if(m>0){let k=L.control({position:"bottomright"});k.onAdd=()=>{let $=L.DomUtil.create("div","wm-unknown-ctrl");return $.innerHTML=`+ ${m} validators \xB7 location unknown`,$},k.addTo(nt),nn.push(k)}mw.forEach(k=>{let $=L.divIcon({html:`<div class="wm-lmarker wm-lmarker-pub">
        <div class="wm-lring"></div>
        ...
        </div>`,{maxWidth:260,className:"wm-popup-wrap"}).addTo(nt);nn.push(T)});let f=Array.isArray(s)?s:[],g=f.filter(k=>k.inbound===!0).length,v=f.length-g,h=f.length>0?`${f.length} peers (${g}\u2193 ${v}\u2191)`:`${Number((st==null?void 0:st.peers)??0)} peers`,b=L.control({position:"topleft"});b.onAdd=()=>{let k=L.DomUtil.create("div","wm-legend-ctrl");return k.innerHTML=`
      ...
      </div>`,k},b.addTo(nt),nn.push(b);let w=nn.filter(k=>k&&typeof k.getLatLng=="function");if(w.length>=2)try{let k=L.latLngBounds(w.map($=>$.getLatLng()));k.isValid()&&nt.fitBounds(k.pad(.15),{maxZoom:6})}catch{}try{window.dispatchEvent(new CustomEvent("nalulf-network-map",{detail:{map:nt,networkId:ho}}))}catch{}}function Dw(e,t,n,s,a,o,i=!1){let r=e.length>1,l=e.map(d=>{let u=rt(d),p=s.has(d),m=a.has(d),f=o.has(d),g=d.slice(0,20)+"...",v,h;return p?(v=Oe.nunl.hex,h="Negative UNL"):m&&f?(v=Oe.both.hex,h="UNL + dUNL"):m?(v=Oe.unl.hex,h="UNL"):f?(v=Oe.dunl.hex,h="dUNL"):(v=Oe.other.hex,h="Other"),`<div class="wm-popup-val-row">
    ...
    <div class="wm-popup-vals">${l}</div>
      ...
      ${p.map(f=>{let g=sn[f]??{w:1,label:f},v=g.label.split(" \u2014 "),h=v[0],b=v[1]||"";return`<div class="adv-sig-card adv-sig-${g.w>=3?"critical":g.w>=2?"elevated":"monitor"}">
  ...
  `,document.body.appendChild(e),e.addEventListener("click",t=>{t.target===e&&ua()}),document.addEventListener("keydown",t=>{t.key==="Escape"&&e.classList.contains("show")&&ua()})}function ex(e){let t=Kw[e];if(!t)return;Zw();let n=document.getElementById("learnModalOverlay"),s=document.getElementById("learnModalTitle"),a=document.getElementById("learnModalSub"),o=document.getElementById("learnModalBody"),i=document.getElementById("learnModalLinks"),r=document.getElementById("learnModalCtas");!n||!s||!a||!o||!i||!r||(s.textContent=t.title,a.textContent=t.subtitle||"",o.innerHTML=(t.sections||[]).map(l=>`
  ...
  `).join(""),n.classList.add("show"),document.body.classList.add("modal-open"))}function ua(){var e;(e=document.getElementById("learnModalOverlay"))==null||e.classList.remove("show"),document.body.classList.remove("modal-open")}function tx(e){var t,n,s;if(e==="modal:close")return ua();if(e==="auth:signup"){ua(),(t=window.openAuth)==null||t.call(window,"signup");return}if(e==="auth:login"){ua(),(n=window.openAuth)==null||n.call(window,"login");return}if(e.startsWith("topic:"))return ex(e.split(":")[1]);if(e.startsWith("scroll:")){let a=e.split(":")[1];(s=document.getElementById(a))==null||s.scrollIntoView({behavior:"smooth",block:"start"})}}function nx(){Dm||(Dm=!0,document.addEventListener("click",e=>{var s,a;let t=(a=(s=e.target).closest)==null?void 0:a.call(s,"[data-action]");if(!t)return;let n=t.getAttribute("data-action")||"";n&&(e.preventDefault(),tx(n))}))}function Im(){var l,c,d,u,p;nx(),(l=document.querySelector(".landing-features"))==null||l.setAttribute("id","learn"),(c=document.querySelector(".landing-simple-value"))==null||c.setAttribute("id","use-cases"),(d=document.querySelector(".landing-cta"))==null||d.setAttribute("id","about"),(u=document.querySelector(".landing-tagline"))==null||u.classList.add("tagline-pill");let e=document.querySelector(".landing-stats-strip");e&&(e.classList.add("landing-learn-strip"),e.innerHTML=Jw.map(m=>`
    ...
    `).join(""));let t=x("features-grid");t&&(t.innerHTML=Yw.map(m=>`
    ...
    `).join(""));let n=document.querySelector(".landing-simple-value"),s=n==null?void 0:n.querySelector("h2");s&&(s.textContent="What you can do with NaluLF");let a=x("value-grid");a&&(a.innerHTML=Qw.map(m=>`
