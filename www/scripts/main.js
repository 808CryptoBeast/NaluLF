import{a as qr,b as To,c as Pn,d as It,e as x,f as Xe,g as y,h as He,i as _,j as z,k as Q,l as Z,m as bt,n as ge,o as ne,p as he,q as Wt,r as X,s as ga,v as Ee,w as Ur}from"./chunk-R7KFE7J7.js";function Mn(e){Pn.includes(e)||(e="gold"),X.currentTheme=e,Pn.forEach(t=>document.body.classList.remove(`theme-${t}`)),document.body.classList.add(`theme-${e}`),Z(To,e)}function Co(){let e=Pn.indexOf(X.currentTheme);Mn(Pn[(e+1)%Pn.length])}function Vr(){let e=Q(To);Mn(Pn.includes(e)?e:"gold")}var Gr={landing:"landing-page",dashboard:"dashboard",inspector:"inspector",profile:"dashboard"};function Po(e){document.body.classList.remove("modal-open"),Object.values(Gr).forEach(i=>document.body.classList.remove(i)),document.body.classList.add(Gr[e]||"dashboard");let t=x("landing"),n=x("dashboard"),s=x("profile-page");t&&(t.style.display=e==="landing"?"":"none"),n&&(n.style.display=e==="dashboard"?"":"none"),s&&(s.style.display=e==="profile"?"":"none");let a=e==="landing",o={landingActions:x("navbar-landing-actions"),dashActions:x("navbar-dash-actions"),navConn:x("navbar-conn"),cmdkHint:x("cmdk-hint"),helpBtn:x("help-trigger")};o.landingActions&&(o.landingActions.style.display=a?"":"none"),o.dashActions&&(o.dashActions.style.display=a?"none":""),o.navConn&&(o.navConn.style.display=a?"none":""),o.cmdkHint&&(o.cmdkHint.style.display=a?"none":""),o.helpBtn&&(o.helpBtn.style.display=a?"none":""),X.currentPage=e,window.scrollTo({top:0,behavior:"smooth"}),window.dispatchEvent(new CustomEvent("naluxrp:pagechange",{detail:{pageId:e}}))}function Ln(){Po("landing")}function An(){Po("dashboard")}function Mo(){Po("profile")}function En(e,t){Xe(".dash-tab").forEach(n=>{n.classList.toggle("active",n===e),n.setAttribute("aria-selected",String(n===e))}),["stream","inspector","network"].forEach(n=>{let s=x(`tab-${n}`);s&&(s.style.display=n===t?"":"none")}),t==="inspector"?(document.body.classList.remove("dashboard"),document.body.classList.add("inspector")):(document.body.classList.remove("inspector"),document.body.classList.add("dashboard")),X.currentTab=t,window.dispatchEvent(new CustomEvent("naluxrp:tabchange",{detail:{tabId:t}}))}var Jr="naluxrp_tour_seen",rn=[{title:"Welcome to NaluLF \u{1F30A}",body:"A 20-second tour of the three things people miss most. Skip anytime."},{selector:"#cmdk-hint",title:"Jump anywhere, instantly",body:"Press <kbd>Ctrl</kbd>+<kbd>K</kbd> (or <kbd>/</kbd>) from any page. Paste an address in and it offers to inspect it directly \u2014 no need to navigate first."},{selector:"#dash-tab-inspector",title:"Inspect any wallet",body:"Full forensic suite \u2014 trust lines, fund flow, convergence signals, AI-assisted explanations \u2014 for any XRPL address, not just your own."},{selector:".user-chip",title:"Your Profile has more than wallets",body:"Portfolio analytics, activity history, and Project Intelligence \u2014 liquidity depth, holder concentration, and issuer-risk scoring for any token \u2014 all live there."}],at=0,Ao=!1,Ms=null,Ft=null;function Yr(){Q(Jr)||setTimeout(Eo,700)}function Eo(){Ao||(Ao=!0,at=0,Wm(),No())}function Wm(){if(x("tourOverlay"))return;let e=document.createElement("div");e.id="tourOverlay",e.className="tour-overlay",e.innerHTML='<div class="tour-card" id="tour-card"></div>',document.body.appendChild(e),e.addEventListener("click",t=>{t.target===e&&ba()})}function Lo(e){if(!e)return null;let t=document.querySelector(e);if(!t)return null;let n=t.getBoundingClientRect();return n.width>0||n.height>0?t:null}function Qr(){Ms==null||Ms.classList.remove("tour-highlight"),Ms=null}function No(){for(;at<rn.length&&rn[at].selector&&!Lo(rn[at].selector);)at++;if(at>=rn.length)return Ro();let e=rn[at],t=x("tourOverlay"),n=x("tour-card");t.classList.add("show"),Qr();let s=Lo(e.selector);s&&(s.scrollIntoView({block:"center",behavior:"smooth"}),s.classList.add("tour-highlight"),Ms=s),n.innerHTML=`
    <div class="tour-step-count">${at+1} / ${rn.length}</div>
    ...
    </div>`}function q(){var h,v;let e=document.querySelector("#profile-page .profile-wrap");if(!e)return;let t=document.getElementById("xpd-tv-widget"),n=!!(t&&ee.chart);t&&t.remove();let s=document.getElementById("xpd-chart-atmosphere"),a=!!(s&&Je.renderer);s&&s.remove();let o=Nt(),i=(o==null?void 0:o.address)||"",r=Of(),l=localStorage.getItem(mn),c=oe.some(w=>!w.watchOnly),d=Q(ei)==="1",u=(h=et[i])==null?void 0:h.xrp,p=Object.values(et).reduce((w,k)=>w+((k==null?void 0:k.xrp)||0),0),m=(v=Te.data)!=null&&v.priceUsd?p*Te.data.priceUsd:0,f=On.map(w=>`<option value="${y(w.id)}" ${M.pair===w.id?"selected":""}>${y(w.label)}</option>`).join(""),g=On.map(w=>`<option value="${y(w.id)}" ${M.comparePair===w.id?"selected":""}>${y(w.label)}</option>`).join(""),b=sc.map(w=>`<option value="${y(w.value)}" ${M.interval===w.value?"selected":""}>${y(w.label)}</option>`).join("");if(e.innerHTML=`
              ...
              <div class="xpd-chart-toolbar">
                ...
                <div class="xpd-toolbar-group">
                  ...
                  <select class="xpd-input" onchange="setDrawingTool(this.value)">
                    ${ac.map(w=>`<option value="${w.key}" ${M.drawingTool===w.key?"selected":""}>Draw: ${w.label}</option>`).join("")}
                  </select>
    ...
    </div>`,n){let w=document.getElementById("xpd-tv-widget");w&&w.replaceWith(t)}if(a){let w=document.getElementById("xpd-chart-atmosphere");w&&w.replaceWith(s)}Vh(),dg(),pg(),$i(),Xs()}function Of(){let e=String(X.currentNetwork||"").toLowerCase();return e.includes("testnet")?{label:"XRPL Testnet",kind:"testnet"}:e.includes("mainnet")?{label:"XRPL Mainnet",kind:"mainnet"}:e.includes("xahau")?{label:"Xahau Network",kind:"xahau"}:{label:`Network: ${y(X.currentNetwork||"Unknown")}`,kind:"unknown"}}function Bf(){let e=String(M.indicatorQuery||"").trim().toLowerCase(),t=[{key:"trend",label:"Trend",icon:"\u{1F4C8}"},{key:"momentum",label:"Momentum",icon:"\u26A1"},{key:"volume",label:"Volume",icon:"\u{1F4CA}"},{key:"volatility",label:"Volatility",icon:"\u{1F32A}\uFE0F"},{key:"advanced",label:"Custom",icon:"\u{1F9E0}"}];return`
    <div class="xpd-indicator-menu-wrap">
      ...
      ${M.indicatorMenuOpen?`
        <div class="xpd-indicator-menu" role="menu" aria-label="Indicator menu">
          ...
          ${t.map(n=>{let s=(Pf[n.key]||[]).filter(a=>{var i;return e?(((i=Vt[a])==null?void 0:i.name)||a).toLowerCase().includes(e):!0});return s.length?`
    ...
    <p class="xpd-note">Professional chart controls: wheel zoom, hold-and-drag pan, horizontal price-line marking, and token-focused context ribbons for faster execution decisions.</p>`}function Hf(){let e=M.selectedIndicator||"sma20",t=Vt[e]||Vt.sma20,n=Mf[e]||null,s=M.educationCollapsed;return`
    <div class="xpd-edu-panel ${s?"collapsed":""}">
      ...
      ${s?"":`
        ...
        `:""}
      `}
    </div>`}function dt(e,t){return`<div class="xpd-edu-row"><span class="xpd-edu-label">${y(e)}</span><span class="xpd-edu-value">${y(t)}</span></div>`}function zf(){if(Te.loading)return'<div class="xpd-loading">Loading XRP market snapshot...</div>';if(Te.error)return`<div class="xpd-error">${y(Te.error)}</div>`;let e=Te.data;if(!e)return'<div class="xpd-empty">Market data is not available yet.</div>';let t=e.change24h>=0;return`
    ...
    <div class="xpd-token-strip">
      ${Cf.map(n=>`<div class="xpd-token-pill" title="${y(`${n.symbol} ${n.name}`)}"><span class="sym xpd-pill-text">${n.symbol}</span><span class="xpd-pill-text">${y(n.name)}</span><span class="cap xpd-pill-text">${n.marketCap}</span></div>`).join("")}
    </div>
    <p class="xpd-note">Top XRPL token cards are static examples when direct DEX market-cap feeds are unavailable.</p>`}function jf(e){return e?vt.loading?'<div class="xpd-loading">Loading account NFTs...</div>':vt.error?`<div class="xpd-error">${y(vt.error)}</div>`:vt.items.length?`<div class="xpd-nft-grid">${vt.items.map(Wf).join("")}</div>`:'<div class="xpd-empty">No NFTs found for this wallet.</div>':'<div class="xpd-empty">Select or create a wallet to load NFTs.</div>'}function Wf(e){let t=`${e.id.slice(0,12)}...${e.id.slice(-10)}`;return`<article class="xpd-nft-card">
  ...
  </article>`}function qf(e){let t=ih(e),n=rh(),s=lh();return`<div class="xpd-amm-columns">${t}${n}${s}</div>`}function vi(){return(ge(Q(ec))||[]).filter(Boolean)}function dc(e){let t=[...new Set((e||[]).filter(Boolean))];Z(ec,JSON.stringify(t))}function Uf(e,t){return t.has(e)?t.get(e):W.tokens.find(s=>s.symbol===e)||null}function Vf(){let e=W.query||"",t=vi(),n=W.filtered,s=Math.max(120,Number(W.listLimit||240)),a=n.slice(0,s),o=W.trending.slice(0,14),i=new Map(W.tokens.map(c=>[Ve(c),c])),r=i.get(W.selectedTokenKey)||null,l=W.filters||{type:"all",minCap:0,minVol:0,hasDex:!1};return`
    <div class="xpd-token-grid">
        ...
        <div class="xpd-token-list">${a.map(c=>{let d=Ve(c),u=Ls(d),p=String(e||"").trim();return`
          <div class="xpd-token-row xpd-token-row--clickable" title="${y(`${c.symbol} ${c.name}`)}" onclick="openTokenOnChart(decodeURIComponent('${u}'))">
            <div class="xpd-token-main">
              <strong>${Il(c.symbol,p)}</strong>
              <span>${Il(c.name,p)}</span>
    ...
    </div>`}function pc(){let e=document.getElementById("xpd-lookup-currency");if(!e){he("Token Discovery hasn't loaded yet \u2014 give it a moment and try again.");return}e.scrollIntoView({behavior:"smooth",block:"center"}),setTimeout(()=>e.focus(),350)}async function yi(e){let t=String(e||"").trim();if(!t)return;let n=t.includes("|")?W.tokens.find(s=>Ve(s)===t):W.tokens.find(s=>String(s.symbol||"").toUpperCase()===t.toUpperCase());if(!(n!=null&&n.issuer)){he("Project Intelligence needs a token with a known issuer.");return}ze={loading:!0,error:"",data:null,tokenKey:Ve(n),expandedSubScore:"",graphView:"list"},q(),setTimeout(()=>{var s;return(s=document.getElementById("xpd-project-intel-section"))==null?void 0:s.scrollIntoView({behavior:"smooth",block:"start"})},30);try{ze={loading:!1,error:"",data:await Tl(n),tokenKey:Ve(n),expandedSubScore:"",graphView:"list"}}catch(s){ze={loading:!1,error:(s==null?void 0:s.message)||"Could not load project intelligence.",data:null,tokenKey:Ve(n),expandedSubScore:"",graphView:"list"}}q()}function uc(e){ze.expandedSubScore=ze.expandedSubScore===e?"":e,q()}var Gf=768;function mc(){return window.innerWidth>=Gf}function fc(e){e==="graph"&&!mc()||(ze.graphView=e==="graph"?"graph":"list",q())}function hc(){ze={loading:!1,error:"",data:null,tokenKey:"",expandedSubScore:"",graphView:"list"},q()}var gc={liquidity:{label:"Liquidity",icon:"\u{1F4A7}"},distribution:{label:"Distribution",icon:"\u{1F9EE}"},marketQuality:{label:"Market Quality",icon:"\u{1F4CA}"},lpStability:{label:"LP Stability",icon:"\u{1F3E6}"},issuerRisk:{label:"Issuer Risk",icon:"\u{1F6E1}"}};function Ko(e){return e>=75?"#50fa7b":e>=50?"#f1fa8c":e>=25?"#ffb86c":"#ff5555"}function bc(e){return e>=75?"STRONG":e>=50?"MODERATE":e>=25?"WEAK":"VERY WEAK"}function Kf(){if(ze.loading)return`<div class="xpd-section-head"><h2>\u{1F52C} Project Intelligence</h2></div>
      ...
      <div class="xpd-error">${y(ze.error)}</div>`;let e=ze.data;if(!e)return"";let t=e.strength,n=Ko(t.overall),s=t.dimensionsLive.map(a=>{let o=gc[a],i=t.subScores[a],r=ze.expandedSubScore===a;return`
      <div class="pi-subscore ${r?"pi-subscore--open":""}" onclick="toggleProjectIntelSubScore('${a}')">
        <div class="pi-subscore-row">
          ...
          <span class="pi-subscore-val" style="color:${Ko(i.score)}">${i.score}</span>
        </div>
        <div class="pi-subscore-bar"><div class="pi-subscore-fill" style="width:${i.score}%;background:${Ko(i.score)}"></div></div>
        ${r?`<div class="pi-subscore-detail">${Object.entries(i.inputs).map(([l,c])=>`
          <div class="pi-kv"><span>${y(Da(l))}</span><span class="mono">${y(vc(c))}</span></div>
        `).join("")}</div>`:""}
      </div>`}).join("");return`
    <div class="xpd-section-head">
    ...
    <div class="pi-cards-grid">
      ${Jf(e)}
      ${Rl("Holder Concentration",e.holders,"\u{1F465}")}
      ${Rl("LP Token Concentration",e.lp,"\u{1F3E6}")}
      ${Yf(e.issuerRisk)}
    </div>`}function Da(e){return e.replace(/([A-Z])/g," $1").replace(/^./,t=>t.toUpperCase()).trim()}function vc(e){return e==null?"\u2014":typeof e=="boolean"?e?"Yes":"No":typeof e=="number"?Number.isInteger(e)?String(e):_(e,2):String(e)}function Jf(e){var i;let t=e.amm,n=e.orderBook,s=t!=null&&t.exists?`
  ...
  `:'<div class="inspect-empty-note">No live order book found for this pair.</div>';return`
    <div class="sec-card pi-card">
      ...
      <hr class="pi-hr" />
      ${o}
    </div>`}function Rl(e,t,n){if(!(t!=null&&t.exists))return`
    <div class="sec-card pi-card">
    ...
    </div>`}var si={project:{icon:"\u{1F4C1}",color:"#8be9fd"},token:{icon:"\u{1FA99}",color:"#f1fa8c"},issuer:{icon:"\u{1F3DB}",color:"#ff79c6"},amm:{icon:"\u{1F4A7}",color:"#50fa7b"},auction:{icon:"\u{1F39F}",color:"#ffb86c"},vote:{icon:"\u{1F5F3}",color:"#bd93f9"},whale:{icon:"\u{1F40B}",color:"#6272a4"},lp:{icon:"\u{1F3E6}",color:"#69bff8"}};function Qf(e){return e?`${e.slice(0,8)}\u2026${e.slice(-5)}`:""}function Zf(e){let t=mc(),n=t&&ze.graphView==="graph";return`
    ...
    ${n?sh(e):eh(e)}`}function eh(e){let t=new Map(e.nodes.map(u=>[u.id,u])),n=u=>e.edges.filter(p=>p.from===u||p.to===u),s=u=>{let p=si[u.type]||{icon:"\u2022",color:"rgba(255,255,255,0.3)"},m=n(u.id).map(f=>`<div class="pig-fact"><span class="pig-fact-badge">PROVEN</span>${y(f.factLabel)}</div>`).join("");return`
      <div class="pig-node" style="border-left-color:${p.color}">
        <div class="pig-node-hdr">
          ...
          ${u.address?`<a href="https://xrpscan.com/account/${y(u.address)}" target="_blank" rel="noopener" class="mono pig-node-addr">${y(Qf(u.address))}</a>`:""}
        </div>
        ${m}
    ...
    <div class="pig-list">
    ...
    </div>`}var yc={token:0,issuer:0,amm:1,auction:1,vote:1,whale:2,lp:2},wc=[20,270,520],Jo=220,Pa=34,xc=46;function th(e,t){return e.length>t?e.slice(0,t-1)+"\u2026":e}function nh(e){let t=[[],[],[]];e.nodes.forEach(s=>{s.type!=="project"&&t[yc[s.type]??1].push(s)});let n=[];return t.forEach((s,a)=>s.forEach((o,i)=>n.push({...o,x:wc[a],y:16+i*xc}))),n}function sh(e){let t=nh(e),n=new Map(t.map(c=>[c.id,c])),s=[0,1,2].map(c=>t.filter(d=>(yc[d.type]??1)===c).length),a=wc[2]+Jo+20,o=32+Math.max(1,...s)*xc,i=e.edges.map(c=>{let d=n.get(c.from),u=n.get(c.to);if(!d||!u)return"";let p=d.x+Jo,m=d.y+Pa/2,f=u.x,g=u.y+Pa/2,b=(p+f)/2;return`<path d="M${p},${m} C${b},${m} ${b},${g} ${f},${g}" stroke="rgba(255,255,255,0.25)" stroke-width="1.5" fill="none"/>`}).join(""),r=t.map(c=>{let d=si[c.type]||{icon:"\u2022",color:"rgba(255,255,255,0.3)"},u=`${d.icon} ${c.label}`;return`
      <g class="pig-svg-node">
        ...
        <text x="${c.x+10}" y="${c.y+Pa/2+4}" font-size="11" fill="#fff">${y(th(u,26))}</text>
        <title>${y(c.label)}${c.address?" \u2014 "+y(c.address):""}</title>
      </g>`}).join(""),l=Object.entries(si).filter(([c])=>c!=="project").map(([c,d])=>`<span class="pig-legend-item"><span class="pig-legend-swatch" style="background:${d.color}"></span>${d.icon} ${Da(c)}</span>`).join("");return`
    <div class="pig-svg-wrap"><svg viewBox="0 0 ${a} ${o}" width="${a}" height="${o}" class="pig-svg">${i}${r}</svg></div>
    <div class="pig-svg-legend">${l}</div>`}function kc(){let e=ze.data;e&&Ha(ah(e))}function _l(e,t){if(!(e!=null&&e.length))return"";let n=e.map(s=>`    ${s.pct}% impact: ${_(s.xrpAtOffer,1)} XRP / ${Ue(s.tokenAtOffer)} tokens${s.bookExhausted?" (book exhausted before this level \u2014 real depth may be less than shown)":""}`).join(`
`);return`  ${t}:
${n}`}function Dl(e,t){let n=[`${e}:`];return t!=null&&t.exists?(n.push(`  Holder count: ${t.holderCount}${t.sampleOnly?" (sampled, capped)":""}`),n.push(`  Top 1 holds: ${_(t.top1Pct,1)}%`),n.push(`  Top 5 hold: ${_(t.top5Pct,1)}%`),n.push(`  Top 10 hold: ${_(t.top10Pct,1)}%`),(t.topHolders||[]).slice(0,10).forEach((s,a)=>{let o=t.totalSampled>0?_(s.balance/t.totalSampled*100,2):"0.00";n.push(`    #${a+1} ${s.address}: ${Ue(s.balance)} (${o}%)`)}),n.join(`
`)):(n.push("  No data found."),n.join(`
`))}function ah(e){var l;let t=e.strength,n=e.amm,s=e.orderBook,a=e.issuerRisk,o=[];if(o.push(`XRPL TOKEN ANALYSIS \u2014 ${e.token.symbol}${e.token.name?` (${e.token.name})`:""}`),o.push(`Issuer: ${e.token.issuer}`),o.push(`Currency code: ${e.token.currency}`),o.push(`Snapshot taken: ${new Date(e.fetchedAt).toISOString()}`),o.push(""),o.push(`OVERALL STRENGTH SCORE: ${t.overall}/100 (${bc(t.overall)})`),o.push("Methodology note: this score covers only 5 point-in-time-computable dimensions (Liquidity, Distribution, Market Quality, LP Stability, Issuer Risk). Network Activity, Treasury Health, and Project Transparency are NOT included \u2014 they would require historical tracking this tool does not do."),o.push(""),o.push("SUB-SCORES:"),t.dimensionsLive.forEach(c=>{let d=gc[c],u=t.subScores[c];o.push(`- ${d.label}: ${u.score}/100`),Object.entries(u.inputs||{}).forEach(([p,m])=>{o.push(`    ${Da(p)}: ${vc(m)}`)})}),o.push(""),o.push("LIQUIDITY \u2014 AMM POOL:"),n!=null&&n.exists?(o.push(`  XRP reserve: ${_(n.xrpReserve,2)}`),o.push(`  Token reserve: ${_(n.tokenReserve,2)}`),o.push(`  LP token supply: ${_(n.lpSupply,2)}`),o.push(`  Trading fee: ${_(n.tradingFeePct,3)}%`),n.auctionSlot&&o.push(`  Auction slot discounted fee: ${_(n.auctionSlot.discountedFeePct,3)}%`),(l=n.voteSlots)!=null&&l.length&&o.push(`  Fee-vote participants: ${n.voteSlots.length}`)):o.push("  No AMM pool found for this pair."),o.push(""),o.push("LIQUIDITY \u2014 LIVE ORDER BOOK (DEX):"),s!=null&&s.exists){o.push(`  Buy price: ${_(s.buyPriceXrp,6)} XRP`),o.push(`  Sell price: ${_(s.sellPriceXrp,6)} XRP`),o.push(`  Spread: ${s.spreadPct!=null?_(s.spreadPct,2)+"%":"\u2014"}`);let c=_l(s.buyDepth,"Depth buying with XRP"),d=_l(s.sellDepth,"Depth selling for XRP");c&&o.push(c),d&&o.push(d)}else o.push("  No live order book found for this pair.");o.push(""),o.push(Dl("HOLDER CONCENTRATION",e.holders)),o.push(""),o.push(Dl("LP TOKEN CONCENTRATION",e.lp)),o.push(""),o.push("ISSUER RISK FLAGS:"),a!=null&&a.exists?(o.push(`  Clawback enabled: ${a.clawbackEnabled?"YES":"No"} \u2014 ${xt.clawbackEnabled}`),o.push(`  Global freeze active: ${a.globalFreeze?"YES":"No"} \u2014 ${xt.globalFreeze}`),o.push(`  Freeze-capable: ${a.freezeCapable?"YES":"No"} \u2014 ${xt.freezeCapable}`),o.push(`  Requires auth to hold: ${a.requireAuth?"YES":"No"} \u2014 ${xt.requireAuth}`),o.push(`  Issuer blackholed: ${a.blackholed?"YES":"No"} \u2014 ${xt.blackholed}`)):o.push("  Could not load issuer account state."),o.push("");let i=qo(e);o.push("PROVEN ON-LEDGER RELATIONSHIPS (Project Intelligence Graph):");let r=new Map(i.nodes.map(c=>[c.id,c]));return i.edges.forEach(c=>{let d=r.get(c.from),u=r.get(c.to);o.push(`  ${(d==null?void 0:d.label)||c.from} \u2192 ${(u==null?void 0:u.label)||c.to} [${c.type}]: ${c.factLabel}`)}),o.push(""),o.push("---"),o.push("Please analyze this XRPL token's on-chain data above. Explain in plain language what these metrics suggest about the token's liquidity health, holder/LP concentration risk, and issuer-side control risk. Point out anything that looks like a red flag or an unusually strong/weak signal, and note any limits in what this data can and can't tell me (e.g. it's a point-in-time snapshot, not history)."),o.join(`
`)}function Il(e,t){let n=String(e||""),s=String(t||"").trim();if(!s)return y(n);let a=n.toLowerCase().indexOf(s.toLowerCase());if(a<0)return y(n);let o=y(n.slice(0,a)),i=y(n.slice(a,a+s.length)),r=y(n.slice(a+s.length));return`${o}<mark class="xpd-hit">${i}</mark>${r}`}function oh(e){var a,o;let t=Object.values(et).reduce((i,r)=>i+((r==null?void 0:r.xrp)||0),0),n=(a=Te.data)!=null&&a.priceUsd?t*Te.data.priceUsd:0,s=Mt.items.slice(0,8);return`
    <div class="xpd-token-grid">
      <div class="xpd-token-col">
        <div class="xpd-market-grid">
    ...
    </div>`}function ih(e){return e?yt.loading?'<div class="xpd-amm-card"><h3>Your liquidity positions</h3><div class="xpd-loading">Loading account_objects and LP balances...</div></div>':yt.error?`<div class="xpd-amm-card"><h3>Your liquidity positions</h3><div class="xpd-error">${y(yt.error)}</div></div>`:yt.pools.length?`<div class="xpd-amm-card"><h3>Your liquidity positions</h3><div class="xpd-pool-list">${yt.pools.map(t=>`
    ...
    </div>`).join("")}</div></div>`:'<div class="xpd-amm-card"><h3>Your liquidity positions</h3><div class="xpd-empty">No AMM entries or LP-token balances detected for this wallet yet.</div></div>':'<div class="xpd-amm-card"><h3>Your liquidity positions</h3><div class="xpd-empty">No active wallet.</div></div>'}function rh(){return Lt.loading?'<div class="xpd-amm-card"><h3>General pool explorer</h3><div class="xpd-loading">Loading amm_info for known pools...</div></div>':Lt.error?`<div class="xpd-amm-card"><h3>General pool explorer</h3><div class="xpd-error">${y(Lt.error)}</div></div>`:Lt.pools.length?`<div class="xpd-amm-card"><h3>General pool explorer</h3><div class="xpd-pool-list">${Lt.pools.map(e=>`
    <div class="xpd-pool-item">
    ...
    </div>`).join("")}</div></div>`:'<div class="xpd-amm-card"><h3>General pool explorer</h3><div class="xpd-empty">No seeded pools returned on this network.</div></div>'}function lh(){return`<div class="xpd-amm-card">
    ...
    ${Fe.pool?`<div class="xpd-pool-item">
      ...
      <div class="xpd-pool-row"><span class="xpd-pool-row-label">TVL</span><span class="xpd-pool-row-value">${y(Fe.pool.tvl||"Unavailable")}</span></div>
  ...
  </div>`}function Ue(e){return Number.isFinite(Number(e))?new Intl.NumberFormat("en-US",{notation:"compact",maximumFractionDigits:2}).format(Number(e)):"\u2014"}function as(e){return typeof e=="string"?`${_(Number(e)/1e6,4)} XRP`:e&&typeof e=="object"?`${_(Number(e.value||0),4)} ${e.currency||"UNK"}`:"\u2014"}function ch(e){if(!e||typeof e!="string")return"";try{let t=e.trim();if(!/^[0-9A-Fa-f]+$/.test(t)||t.length%2!==0)return t;let n=new Uint8Array(t.length/2);for(let s=0;s<t.length;s+=2)n[s/2]=parseInt(t.slice(s,s+2),16);return new TextDecoder().decode(n)}catch{return""}}function Fl(e){return e?e.startsWith("ipfs://")?`https://ipfs.io/ipfs/${e.slice(7)}`:e.startsWith("ar://")?`https://arweave.net/${e.slice(5)}`:e:""}async function dh(e){let t=Fl(ch(e.URI||e.uri||""));if(!t)return"";if(/\.(png|jpg|jpeg|gif|webp|svg)$/i.test(t))return t;try{let n=await fetch(t,{method:"GET"});if(!n.ok)return"";let s=await n.json(),a=(s==null?void 0:s.image)||(s==null?void 0:s.image_url)||(s==null?void 0:s.thumbnail);return Fl(a||"")}catch{return""}}async function At(e,{timeoutMs:t=9e3,allowProxy:n=!0}={}){let s=async a=>{let o=typeof(AbortSignal==null?void 0:AbortSignal.timeout)=="function"?AbortSignal.timeout(t):void 0,i=await fetch(a,{method:"GET",mode:"cors",cache:"no-store",signal:o});if(!i.ok)throw new Error(`HTTP ${i.status}`);return await i.json()};try{return await s(e)}catch(a){if(!n)throw a;for(let o of df)try{return await s(o(e))}catch{}throw a}}async function $c(){var e;Te.loading=!0,Te.error="",q();try{let t=await At("https://api.exchange.coinbase.com/products/XRP-USD/ticker"),n=await At("https://api.exchange.coinbase.com/products/XRP-USD/candles?granularity=86400"),s=Array.isArray(n)&&n.length?n[0]:null,a=Number((t==null?void 0:t.price)||0),o=s?Number(s[3]||0):a,i=s?Number(s[2]||a):a,r=s?Number(s[1]||a):a,l=s?Number(s[5]||0):0;Te.data={priceUsd:a,change24h:o?(a-o)/o*100:0,volume24h:l*a,marketCap:Number(((e=Te.data)==null?void 0:e.marketCap)||0),high24h:i,low24h:r}}catch(t){Te.error=(t==null?void 0:t.message)||"Could not load market data right now.",Te.data=null}finally{Te.loading=!1,q()}}async function Sc(e){if(vt.loading=!0,vt.error="",vt.items=[],q(),!e){vt.loading=!1,q();return}try{let t,n=[];do{let a=await ot({method:"account_nfts",params:[{account:e,limit:100,...t?{marker:t}:{}}]});n.push(...(a==null?void 0:a.account_nfts)||[]),t=a==null?void 0:a.marker}while(t);let s=await Promise.all(n.slice(0,80).map(async a=>({id:a.NFTokenID||a.nf_token_id||"Unknown",image:await dh(a)})));vt.items=s}catch(t){vt.error=(t==null?void 0:t.message)||"Could not load NFTs for this wallet."}finally{vt.loading=!1,q()}}async function Tc(e){if(yt.loading=!0,yt.error="",yt.pools=[],q(),!e){yt.loading=!1,q();return}try{let t=[],n;do{let o=await ot({method:"account_objects",params:[{account:e,type:"amm",limit:200,...n?{marker:n}:{}}]});((o==null?void 0:o.account_objects)||[]).forEach(r=>{let l=as(r.Asset||r.amount),c=as(r.Asset2||r.amount2),d=l.split(" ").pop()||"AssetA",u=c.split(" ").pop()||"AssetB";t.push({pair:`${d}/${u}`,lpBalance:r.LPTokenBalance?as(r.LPTokenBalance):"Not reported",estimatedValue:"Estimate unavailable",tradingFee:r.TradingFee!=null?`${r.TradingFee} bps`:"\u2014",tvl:"Unavailable"})}),n=o==null?void 0:o.marker}while(n);let s=await ot({method:"account_lines",params:[{account:e,limit:200}]});((s==null?void 0:s.lines)||[]).filter(o=>typeof o.currency=="string"&&o.currency.length>=16&&Number(o.balance)>0).forEach(o=>{t.push({pair:`LP Token ${o.currency.slice(0,8)}...`,lpBalance:`${_(Number(o.balance),4)} ${o.currency.slice(0,8)}...`,estimatedValue:"Estimate unavailable",tradingFee:"\u2014",tvl:"Unavailable"})}),yt.pools=t}catch(t){yt.error=(t==null?void 0:t.message)||"Could not load account AMM objects."}finally{yt.loading=!1,q()}}async function Cc(e){try{let t=await ot({method:"amm_info",params:[{asset:e.asset,asset2:e.asset2}]}),n=t==null?void 0:t.amm;return n?{label:e.label,reserveA:as(n.amount),reserveB:as(n.amount2),tradingFee:String(n.trading_fee??"\u2014"),totalLp:as(n.lp_token||n.lp_token_balance),tvl:ph(n.amount,n.amount2)}:null}catch{return null}}function ph(e,t){let n=a=>typeof a=="string"?Number(a)/1e6:a&&typeof a=="object"?Number(a.value||0):0,s=n(e)+n(t);return!Number.isFinite(s)||s<=0?"Unavailable":`${_(s,4)} (asset units)`}async function Pc(){Lt.loading=!0,Lt.error="",q();try{let e=await Promise.all(Af.map(Cc));Lt.pools=e.filter(Boolean)}catch(e){Lt.error=(e==null?void 0:e.message)||"Could not load AMM explorer data.",Lt.pools=[]}finally{Lt.loading=!1,q()}}async function Mc(){var r,l,c,d;let e=(((r=document.getElementById("xpd-asset1-currency"))==null?void 0:r.value)||"").trim().toUpperCase(),t=(((l=document.getElementById("xpd-asset1-issuer"))==null?void 0:l.value)||"").trim(),n=(((c=document.getElementById("xpd-asset2-currency"))==null?void 0:c.value)||"").trim().toUpperCase(),s=(((d=document.getElementById("xpd-asset2-issuer"))==null?void 0:d.value)||"").trim();if(!e||!n){Fe.error="Enter both asset currency codes first.",q();return}let a=e==="XRP"?{currency:"XRP"}:{currency:e,issuer:t},o=n==="XRP"?{currency:"XRP"}:{currency:n,issuer:s};if(e!=="XRP"&&!t||n!=="XRP"&&!s){Fe.error="Issuer is required for non-XRP assets.",q();return}Fe.loading=!0,Fe.error="",Fe.pool=null,q();let i=await Cc({label:`${e}/${n}`,asset:a,asset2:o});Fe.loading=!1,i?Fe.pool=i:Fe.error="Pool not found or unavailable on this network.",q()}function Ia(){return On.find(e=>e.id===M.pair)||On[0]}function wi(e){if(e==="D")return 1440;if(e==="W")return 10080;if(e==="M")return 43200;let t=Number(e);return Number.isFinite(t)&&t>0?t:60}function uh(e){if(e==="M")return"W";if(e==="D"||e==="W")return e;let t=wi(e);for(let n of[5,15,60,240])if(t<=n)return String(n);return"D"}async function mh(e,t,n,s=200){var d;let a=t?`${e}.${t}`:e,o=uh(n),i=Math.min(2e3,Math.max(20,Number(s)||200)),r=`https://api.onthedex.live/public/v1/ohlc?base=${encodeURIComponent(a)}&quote=XRP&interval=${o}&bars=${i}`,l=await At(r,{timeoutMs:1e4});return(Array.isArray((d=l==null?void 0:l.data)==null?void 0:d.ohlc)?l.data.ohlc:[]).map(u=>({time:Number(u.t),open:Number(u.o),high:Number(u.h),low:Number(u.l),close:Number(u.c),volume:Number(u.vb||0)})).filter(u=>Number.isFinite(u.time)&&[u.open,u.high,u.low,u.close].every(Number.isFinite)).sort((u,p)=>u.time-p.time)}function Lc(e){return{xrpusd:"XRP-USD",XRPUSDT:"XRP-USD",ETHUSDT:"ETH-USD",BTCUSDT:"BTC-USD",SOLUSDT:"SOL-USD"}[e]||null}function fh(e){return{XRP:"XRP-USD",BTC:"BTC-USD",ETH:"ETH-USD",SOL:"SOL-USD",USDC:"USDC-USD"}[String(e||"").toUpperCase()]||null}var Yo=new Map;async function hh(e,t){if(!e)return null;let n=`${Ve(e)}:${t}`,s=Yo.get(n);if(s)return s;let a=gh(e,t);Yo.set(n,a);try{return await a}finally{Yo.delete(n)}}async function gh(e,t){var o,i;let n=String(e.symbol||"").toUpperCase();if(!n||n==="XRP")return null;let s=fh(n);if(s)try{let r=Nc(t),l=r===86400?Ql:Zl,{candles:c,reachedStart:d}=await ri(s,r,l);if(c.length){let u=d?`${new Date(c[0].time*1e3).getUTCFullYear()}\u2013present`:`last ${c.length} bars`;return{candles:c,source:`Coinbase direct (${s}, ${u})`,mode:"token-direct"}}}catch{}let a=String(e.issuer||"").trim();if(a)try{let r=await mh(n,a,t,2e3);if(r.length){let l=Number(((o=M.stats)==null?void 0:o.xrplSpot)||((i=M.stats)==null?void 0:i.price)||0);return{candles:l>0?r.map(d=>({time:d.time,open:d.open*l,high:d.high*l,low:d.low*l,close:d.close*l,volume:d.volume})):r,source:`OnTheDex XRPL DEX (${n}/XRP)`,mode:"token-direct"}}}catch{}return null}function bh(e,{mode:t="pair",source:n="Source pending",tokenKey:s=""}={}){let a=Array.isArray(e)?e:[];if(!a.length){M.chartMeta={tokenKey:s||M.tokenFocusKey||"XRP|",symbol:s&&s.split("|")[0]||"XRP",source:n,last:null,high:null,low:null,mode:t};return}let o=a[a.length-1],i=a.map(c=>Number(c.high)).filter(c=>Number.isFinite(c)),r=a.map(c=>Number(c.low)).filter(c=>Number.isFinite(c)),l=s||M.tokenFocusKey||"XRP|";M.chartMeta={tokenKey:l,symbol:l.split("|")[0]||"XRP",source:n,last:Number(o.close),high:i.length?Math.max(...i):Number(o.high),low:r.length?Math.min(...r):Number(o.low),mode:t}}async function Os(){var t;let e=Ia();M.loading=!0,M.error="";try{let n=Lc(e.ticker);if(n){let s=await At(`https://api.exchange.coinbase.com/products/${n}/ticker`),a=await At(`https://api.exchange.coinbase.com/products/${n}/candles?granularity=86400`),o=Array.isArray(a)&&a.length?a[0]:null,i=Number(s.price||0),r=o?Number(o[3]):i;M.stats={price:i,high:o?Number(o[2]):i,low:o?Number(o[1]):i,changePct:r?(i-r)/r*100:0,baseSource:"Coinbase",source:"Coinbase"},await Ac(),!Te.data&&M.stats.price&&(Te.data={priceUsd:M.stats.price,change24h:M.stats.changePct,volume24h:o?Number(o[5]||0)*M.stats.price:0,marketCap:Number(((t=Te.data)==null?void 0:t.marketCap)||0)});return}throw new Error("Chart stats unavailable for selected pair.")}catch(n){M.error=(n==null?void 0:n.message)||"DEX chart stats unavailable right now."}finally{M.loading=!1}}async function Ac(){var e,t,n;try{let s=await ot({method:"book_offers",params:[{taker_gets:{currency:"USD",issuer:"rhub8VRN55s94qWKDv6jmDy1pUykJzF3wq"},taker_pays:{currency:"XRP"},limit:1}]}),a=(e=s==null?void 0:s.offers)==null?void 0:e[0];if(!a)return;let o=Number(((t=a.TakerGets)==null?void 0:t.value)||0),i=typeof a.TakerPays=="string"?Number(a.TakerPays)/1e6:Number(((n=a.TakerPays)==null?void 0:n.value)||0);if(o>0&&i>0){let r=o/i;if(Yl=Date.now(),M.stats||(M.stats={}),M.stats.xrplSpot=r,String(Ia().symbol||"XRP").toUpperCase()==="XRP"){M.stats.price=r;let l=M.stats.baseSource||M.stats.source||"Market feed";M.stats.source=`${l} + XRPL live`,Te.data&&(Te.data.priceUsd=r)}}}catch{}}async function vh(){var e,t;return(e=window.LightweightCharts)!=null&&e.createChart?!0:(Ta||(Ta=new Promise((n,s)=>{let a=document.querySelector('script[data-lw-chart="1"]');if(a){a.addEventListener("load",()=>n(!0),{once:!0}),a.addEventListener("error",()=>s(new Error("Chart library failed to load.")),{once:!0});return}let o=document.createElement("script");o.src="https://unpkg.com/lightweight-charts@4.2.2/dist/lightweight-charts.standalone.production.js",o.async=!0,o.defer=!0,o.dataset.lwChart="1",o.onload=()=>n(!0),o.onerror=()=>s(new Error("Chart library failed to load.")),document.head.appendChild(o)}).finally(()=>{var n;(n=window.LightweightCharts)!=null&&n.createChart||(Ta=null)})),await Ta,!!((t=window.LightweightCharts)!=null&&t.createChart))}async function yh(){var e,t;return(e=window.THREE)!=null&&e.Scene?!0:(Ca||(Ca=new Promise((n,s)=>{let a=document.querySelector('script[data-three-chart="1"]');if(a){a.addEventListener("load",()=>n(!0),{once:!0}),a.addEventListener("error",()=>s(new Error("Three.js failed to load.")),{once:!0});return}let o=document.createElement("script");o.src="https://unpkg.com/three@0.166.1/build/three.min.js",o.async=!0,o.defer=!0,o.dataset.threeChart="1",o.onload=()=>n(!0),o.onerror=()=>s(new Error("Three.js failed to load.")),document.head.appendChild(o)}).finally(()=>{var n;(n=window.THREE)!=null&&n.Scene||(Ca=null)})),await Ca,!!((t=window.THREE)!=null&&t.Scene))}function Bs(){var e,t;if(Je.resizeHandler)try{window.removeEventListener("resize",Je.resizeHandler)}catch{}if(Je.raf&&cancelAnimationFrame(Je.raf),(t=(e=Je.renderer)==null?void 0:e.domElement)!=null&&t.parentElement)try{Je.renderer.domElement.parentElement.removeChild(Je.renderer.domElement)}catch{}if(Je.renderer)try{Je.renderer.dispose()}catch{}Je={renderer:null,scene:null,camera:null,points:null,raf:0,host:null,resizeHandler:null}}async function wh(){var t;let e=document.getElementById("xpd-chart-atmosphere");if(e&&!(Je.renderer&&e.contains(Je.renderer.domElement))&&!((navigator.hardwareConcurrency||4)<=3))try{if(await yh(),!((t=window.THREE)!=null&&t.Scene))return;Bs();let n=window.THREE,s=Math.max(1,e.clientWidth||640),a=Math.max(1,e.clientHeight||460),o=new n.Scene,i=new n.PerspectiveCamera(52,s/a,.1,1e3);i.position.z=46;let r=new n.WebGLRenderer({alpha:!0,antialias:!0});r.setPixelRatio(Math.min(2,window.devicePixelRatio||1)),r.setSize(s,a),e.appendChild(r.domElement);let l=900,c=new Float32Array(l*3);for(let h=0;h<l;h+=1){let v=h*3;c[v]=(Math.random()-.5)*90,c[v+1]=(Math.random()-.5)*40,c[v+2]=(Math.random()-.5)*24}let d=new n.BufferGeometry;d.setAttribute("position",new n.BufferAttribute(c,3));let u=new n.PointsMaterial({color:5101823,size:.25,transparent:!0,opacity:.26,depthWrite:!1}),p=new n.Points(d,u);o.add(p);let m=0,f=0,g=()=>{var $;m+=1;let h=Number((($=M.stats)==null?void 0:$.changePct)||0),v=Math.min(4,Math.max(.35,Math.abs(h)/2.2)),w=h>0?16758874:16739999;u.color.setHex(Math.abs(h)>1.5?w:5101823),p.rotation.y+=9e-4*v,p.rotation.x=Math.sin(m*.0015*v)*.08,p.position.y=Math.sin(m*.003*v)*.7,(!document.hidden||Date.now()-f>350)&&(r.render(o,i),f=Date.now()),Je.raf=requestAnimationFrame(g)},b=()=>{let h=Math.max(1,e.clientWidth||640),v=Math.max(1,e.clientHeight||460);i.aspect=h/v,i.updateProjectionMatrix(),r.setSize(h,v)};window.addEventListener("resize",b,{passive:!0}),Je={renderer:r,scene:o,camera:i,points:p,raf:0,host:e,resizeHandler:b},g()}catch{}}function Ec(e){return wi(e)*60}function Nc(e){let t=wi(e);return t<=1?60:t<=5?300:t<=15?900:t<=60?3600:t<=360?21600:86400}function Rc(){let e=String(M.tokenFocusKey||"");if(!e)return null;let t=e.includes("|")?e.split("|")[0]:e;return W.tokens.find(n=>Ve(n)===e)||W.tokens.find(n=>String(n.symbol||"").toUpperCase()===String(t||"").toUpperCase())||null}function _c(){var a,o;let e=Rc(),t=Number((e==null?void 0:e.price)||0);if(Number.isFinite(t)&&t>0)return t;let n=Number(((a=M.stats)==null?void 0:a.xrplSpot)||0);if(Number.isFinite(n)&&n>0)return n;let s=Number(((o=M.stats)==null?void 0:o.price)||0);return Number.isFinite(s)&&s>0?s:1}function Dc(e,t=1,n=220){let s=Math.max(60,Ec(e)),a=Math.floor(Date.now()/1e3),o=Math.floor(a/s)*s-n*s,i=Math.max(1e-6,Number(t)||1),r=[];for(let l=0;l<n;l+=1){let c=o+l*s,d=i,u=Math.sin((l+1)/9)*.004+Math.cos((l+3)/17)*.002;i=Math.max(1e-6,d*(1+u));let p=Math.max(d,i)*(1+Math.abs(u)*.55+.0015),m=Math.min(d,i)*Math.max(1e-6,1-(Math.abs(u)*.55+.0015));r.push({time:c,open:Number(d),high:Number(p),low:Number(m),close:Number(i),volume:Math.max(0,Math.round(Math.abs(u)*12e3+l%13*55))})}return r}function ai(e){if(!e.length)return e;let t=[];for(let n=0;n<e.length;n+=1){let s=e[n],a=(s.open+s.high+s.low+s.close)/4,o=t[n-1],i=o?(o.open+o.close)/2:(s.open+s.close)/2,r=Math.max(s.high,i,a),l=Math.min(s.low,i,a);t.push({...s,open:i,high:r,low:l,close:a})}return t}function oi(e,t){let n=[],s=0;for(let a=0;a<e.length;a+=1)s+=e[a].close,a>=t&&(s-=e[a-t].close),a>=t-1&&n.push({time:e[a].time,value:s/t});return n}function Is(e,t){let n=[];if(!e.length)return n;let s=2/(t+1),a=e[0].close;for(let o=0;o<e.length;o+=1)a=o===0?e[o].close:e[o].close*s+a*(1-s),o>=t-1&&n.push({time:e[o].time,value:a});return n}function xh(e,t){let n=[],s=t*(t+1)/2;for(let a=t-1;a<e.length;a+=1){let o=0;for(let i=0;i<t;i+=1)o+=e[a-i].close*(t-i);n.push({time:e[a].time,value:o/s})}return n}function kh(e,t=20,n=2){let s=oi(e,t),a=[],o=[];for(let i=t-1;i<e.length;i+=1){let r=e.slice(i-t+1,i+1),l=s[i-(t-1)].value,c=r.reduce((u,p)=>u+Math.pow(p.close-l,2),0)/t,d=Math.sqrt(c);a.push({time:e[i].time,value:l+d*n}),o.push({time:e[i].time,value:l-d*n})}return{upper:a,lower:o}}function $h(e){let t=[],n=0,s=0;for(let a=0;a<e.length;a+=1){let o=(e[a].high+e[a].low+e[a].close)/3;n+=o*(e[a].volume||0),s+=e[a].volume||0,s>0&&t.push({time:e[a].time,value:n/s})}return t}function Sh(e,t=14){let n=[];if(e.length<=t)return n;let s=0,a=0;for(let r=1;r<=t;r+=1){let l=e[r].close-e[r-1].close;s+=l>0?l:0,a+=l<0?-l:0}let o=s/t,i=a/t;for(let r=t+1;r<e.length;r+=1){let l=e[r].close-e[r-1].close;o=(o*(t-1)+(l>0?l:0))/t,i=(i*(t-1)+(l<0?-l:0))/t;let c=i>0?o/i:100;n.push({time:e[r].time,value:100-100/(1+c)})}return n}function xi(e,t=14){let n=[];for(let o=0;o<e.length;o+=1){let i=o>0?e[o-1].close:e[o].close;n.push(Math.max(e[o].high-e[o].low,Math.abs(e[o].high-i),Math.abs(e[o].low-i)))}let s=[],a=n.slice(0,t).reduce((o,i)=>o+i,0)/Math.max(1,t);for(let o=t;o<e.length;o+=1)a=(a*(t-1)+n[o])/t,s.push({time:e[o].time,value:a});return s}function Th(e,t=14,n=3){let s=[];for(let o=t-1;o<e.length;o+=1){let i=e.slice(o-t+1,o+1),r=Math.max(...i.map(d=>d.high)),l=Math.min(...i.map(d=>d.low)),c=r!==l?(e[o].close-l)/(r-l)*100:50;s.push({time:e[o].time,value:c})}let a=[];for(let o=n-1;o<s.length;o+=1){let i=s.slice(o-n+1,o+1).reduce((r,l)=>r+l.value,0)/n;a.push({time:s[o].time,value:i})}return{k:s,d:a}}function Ch(e,t=12,n=26,s=9){let a=Is(e,t),o=Is(e,n),i=new Map(o.map(u=>[u.time,u.value])),r=a.filter(u=>i.has(u.time)).map(u=>({time:u.time,value:u.value-i.get(u.time)})),l=[];if(r.length){let u=2/(s+1),p=r[0].value;for(let m=0;m<r.length;m+=1)p=m===0?r[m].value:r[m].value*u+p*(1-u),m>=s-1&&l.push({time:r[m].time,value:p})}let c=new Map(l.map(u=>[u.time,u.value])),d=r.filter(u=>c.has(u.time)).map(u=>({time:u.time,value:u.value-c.get(u.time)}));return{line:r,signal:l,hist:d}}function Ic(e,t=9,n=26,s=52){let a=u=>{let p=[];for(let m=u-1;m<e.length;m+=1){let f=e.slice(m-u+1,m+1);p.push({time:e[m].time,value:(Math.max(...f.map(g=>g.high))+Math.min(...f.map(g=>g.low)))/2})}return p},o=a(t),i=a(n),r=new Map(i.map(u=>[u.time,u.value])),l=o.filter(u=>r.has(u.time)).map(u=>({time:u.time,value:(u.value+r.get(u.time))/2})),c=a(s),d=e.map(u=>({time:u.time,value:u.close}));return{tenkan:o,kijun:i,senkouA:l,senkouB:c,chikou:d}}function Ph(e,t=20){let n=[],s=[],a=[];for(let o=t-1;o<e.length;o+=1){let i=e.slice(o-t+1,o+1),r=Math.max(...i.map(c=>c.high)),l=Math.min(...i.map(c=>c.low));n.push({time:e[o].time,value:r}),s.push({time:e[o].time,value:l}),a.push({time:e[o].time,value:(r+l)/2})}return{upper:n,lower:s,mid:a}}function Mh(e,t=20,n=2){let s=Is(e,t),a=xi(e,t),o=new Map(a.map(l=>[l.time,l.value])),i=[],r=[];return s.forEach(l=>{if(o.has(l.time)){let c=o.get(l.time)*n;i.push({time:l.time,value:l.value+c}),r.push({time:l.time,value:l.value-c})}}),{upper:i,lower:r,mid:s}}function Lh(e){let t=[],n=[],s=0,a=0;for(let o=0;o<e.length;o+=1){if(o>0){let l=e[o-1];e[o].close>l.close&&(s+=e[o].volume||0),e[o].close<l.close&&(s-=e[o].volume||0)}let i=e[o].high-e[o].low||1,r=(e[o].close-e[o].low-(e[o].high-e[o].close))/i;a+=r*(e[o].volume||0),t.push({time:e[o].time,value:s}),n.push({time:e[o].time,value:a})}return{obv:t,adline:n}}function Ah(e,t=14){if(e.length<t+2)return{adx:[],plusDi:[],minusDi:[]};let n=[],s=[],a=[];for(let p=1;p<e.length;p+=1){let m=e[p].high-e[p-1].high,f=e[p-1].low-e[p].low;s.push(m>f&&m>0?m:0),a.push(f>m&&f>0?f:0),n.push(Math.max(e[p].high-e[p].low,Math.abs(e[p].high-e[p-1].close),Math.abs(e[p].low-e[p-1].close)))}let o=n.slice(0,t).reduce((p,m)=>p+m,0),i=s.slice(0,t).reduce((p,m)=>p+m,0),r=a.slice(0,t).reduce((p,m)=>p+m,0),l=[],c=[],d=[];for(let p=t;p<n.length;p+=1){o=o-o/t+n[p],i=i-i/t+s[p],r=r-r/t+a[p];let m=o>0?100*i/o:0,f=o>0?100*r/o:0,g=m+f>0?100*Math.abs(m-f)/(m+f):0,b=e[p+1].time;l.push({time:b,value:m}),c.push({time:b,value:f}),d.push({time:b,value:g})}let u=[];if(d.length>=t){let p=d.slice(0,t).reduce((m,f)=>m+f.value,0)/t;for(let m=t;m<d.length;m+=1)p=(p*(t-1)+d[m].value)/t,u.push({time:d[m].time,value:p})}return{adx:u,plusDi:l,minusDi:c}}function Eh(e,t=14){let n=[],s=[];for(let a=t-1;a<e.length;a+=1){let o=e.slice(a-t+1,a+1),i=0,r=0;for(let d=1;d<o.length;d+=1)o[d].high>=o[i].high&&(i=d),o[d].low<=o[r].low&&(r=d);let l=t-1-i,c=t-1-r;n.push({time:e[a].time,value:(t-l)/t*100}),s.push({time:e[a].time,value:(t-c)/t*100})}return{up:n,down:s}}function Nh(e,t=14){let n=[],s=[];if(e.length<t+2)return{plus:n,minus:s};for(let a=t;a<e.length;a+=1){let o=0,i=0,r=0;for(let l=a-t+1;l<=a;l+=1){let c=e[l-1],d=e[l];o+=Math.max(d.high-d.low,Math.abs(d.high-c.close),Math.abs(d.low-c.close)),i+=Math.abs(d.high-c.low),r+=Math.abs(d.low-c.high)}n.push({time:e[a].time,value:o>0?i/o:0}),s.push({time:e[a].time,value:o>0?r/o:0})}return{plus:n,minus:s}}function Rh(e,t=10,n=3){let s=xi(e,t),a=new Map(s.map(c=>[c.time,c.value])),o=[],i=0,r=0,l=!0;return e.forEach((c,d)=>{if(d===0||!a.has(c.time))return;let u=(c.high+c.low)/2,p=a.get(c.time),m=u+n*p,f=u-n*p;d>1&&(m>i&&e[d-1].close<=i&&(m=i),f<r&&e[d-1].close>=r&&(f=r));let g=c.close>m?!0:c.close<f?!1:l,b=g?f:m;o.push({time:c.time,value:b,trendUp:g?1:0}),i=m,r=f,l=g}),o}function _h(e,t=14){let n=[];if(e.length<=t)return n;let s=e.map((a,o)=>{let i=(a.high+a.low+a.close)/3,r=o>0?(e[o-1].high+e[o-1].low+e[o-1].close)/3:i,l=i*(a.volume||0);return{time:a.time,pos:i>=r?l:0,neg:i<r?l:0}});for(let a=t;a<s.length;a+=1){let o=s.slice(a-t+1,a+1),i=o.reduce((c,d)=>c+d.pos,0),r=o.reduce((c,d)=>c+d.neg,0),l=r>0?i/r:100;n.push({time:s[a].time,value:100-100/(1+l)})}return n}function Dh(e,t=14){let n=[];for(let s=t-1;s<e.length;s+=1){let a=e.slice(s-t+1,s+1),o=Math.max(...a.map(l=>l.high)),i=Math.min(...a.map(l=>l.low)),r=o!==i?(o-e[s].close)/(o-i)*-100:-50;n.push({time:e[s].time,value:r})}return n}function Ih(e,t=20){let n=[],s=e.map(a=>({time:a.time,value:(a.high+a.low+a.close)/3}));for(let a=t-1;a<s.length;a+=1){let o=s.slice(a-t+1,a+1),i=o.reduce((c,d)=>c+d.value,0)/t,r=o.reduce((c,d)=>c+Math.abs(d.value-i),0)/t,l=r>0?(s[a].value-i)/(.015*r):0;n.push({time:s[a].time,value:l})}return n}function Fh(e){if(e.length<30)return[];let t=[],n=[];for(let o=1;o<e.length;o+=1){let i=e[o-1].close,r=Math.min(e[o].low,i),l=Math.max(e[o].high,i);t.push({time:e[o].time,value:e[o].close-r}),n.push({time:e[o].time,value:l-r})}let s=(o,i,r)=>o.slice(i-r+1,i+1).reduce((l,c)=>l+c.value,0),a=[];for(let o=27;o<t.length;o+=1){let i=s(t,o,7)/Math.max(1e-9,s(n,o,7)),r=s(t,o,14)/Math.max(1e-9,s(n,o,14)),l=s(t,o,28)/Math.max(1e-9,s(n,o,28));a.push({time:t[o].time,value:100*(4*i+2*r+l)/7})}return a}function Oh(e,t=20){let n=[],s=e.map(a=>{let o=a.high-a.low||1,i=(a.close-a.low-(a.high-a.close))/o;return{time:a.time,value:i*(a.volume||0),volume:a.volume||0}});for(let a=t-1;a<s.length;a+=1){let o=s.slice(a-t+1,a+1),i=o.reduce((l,c)=>l+c.value,0),r=o.reduce((l,c)=>l+c.volume,0);n.push({time:s[a].time,value:r>0?i/r:0})}return n}function Bh(e){return(Array.isArray(e)?e:[]).map(t=>({time:Number(t[0]),low:Number(t[1]),high:Number(t[2]),open:Number(t[3]),close:Number(t[4]),volume:Number(t[5])})).filter(t=>Number.isFinite(t.time)&&[t.open,t.high,t.low,t.close].every(Number.isFinite))}function ii(e,t){let n=new Map;for(let s of e)n.set(s.time,s);for(let s of t)n.set(s.time,s);return Array.from(n.values()).sort((s,a)=>s.time-a.time)}async function ri(e,t,n){let s=[],a=Math.floor(Date.now()/1e3),o=!1;for(let i=0;i<n;i+=1){let r=a-t*300,l=`https://api.exchange.coinbase.com/products/${e}/candles?granularity=${t}&start=${new Date(r*1e3).toISOString()}&end=${new Date(a*1e3).toISOString()}`,c;try{c=await At(l,{timeoutMs:1e4})}catch{break}let d=Bh(c);if(!d.length){o=!0;break}s.push(...d),a=r,i<n-1&&await Tf(Sf)}return{candles:ii(s,[]),reachedStart:o}}async function Xh(e,t,n){if(!e||!Number.isFinite(t)||!Number.isFinite(n)||n<=t)return[];try{let s=`https://api.coingecko.com/api/v3/coins/${e}/market_chart/range?vs_currency=usd&from=${t}&to=${n}`,a=await At(s,{timeoutMs:15e3});return(Array.isArray(a==null?void 0:a.prices)?a.prices:[]).map(([i,r])=>({time:Math.floor(Number(i)/1e3/86400)*86400,open:Number(r),high:Number(r),low:Number(r),close:Number(r),volume:0})).filter(i=>Number.isFinite(i.time)&&Number.isFinite(i.close)&&i.close>0).sort((i,r)=>i.time-r.time)}catch{return[]}}async function Hh(e,t,n){var u;let s=Nc(n),a=s===86400,o=`${$f}${e.id}:${s}`,i=ge(Q(o));if((u=i==null?void 0:i.candles)!=null&&u.length&&i.reachedStart){let p=await ri(t,s,1),m=ii(i.candles,p.candles);return Z(o,JSON.stringify({candles:m,reachedStart:!0,source:i.source,cachedAt:Date.now()})),{candles:m,source:i.source}}let l=await ri(t,s,a?Ql:Zl),c=l.candles,d=c.length?`Coinbase (${new Date(c[0].time*1e3).getUTCFullYear()}\u2013present, ${c.length} bars)`:"Coinbase";if(a&&l.reachedStart&&e.coingeckoId&&c.length){let p=c[0].time,m=await Xh(e.coingeckoId,0,p);m.length&&(c=ii(m,c),d=`CoinGecko (${new Date(c[0].time*1e3).getUTCFullYear()}+) + Coinbase (${new Date(p*1e3).getUTCFullYear()}\u2013present)`)}else!a&&!l.reachedStart&&(d=`Coinbase (last ${c.length} bars \u2014 full inception history is daily/weekly/monthly only)`);return c.length&&Z(o,JSON.stringify({candles:c,reachedStart:l.reachedStart,source:d,cachedAt:Date.now()})),{candles:c,source:d}}var Qo=new Map;async function Fc(e,t){let n=`${e.id}:${t}`,s=Ns.get(n);if(s&&Date.now()-s.ts<6e4&&Array.isArray(s.data)&&s.data.length)return s.data;let a=Qo.get(n);if(a)return a;let o=(async()=>{let i=[],r="",l=Lc(e.ticker);if(l)try{let c=await Hh(e,l,t);i=c.candles,r=c.source}catch{i=[]}if(!Array.isArray(i)||!i.length){let c=Dc(t,_c());return Ns.set(n,{ts:Date.now(),data:c,sourceLabel:""}),c}return Ns.set(n,{ts:Date.now(),data:i,sourceLabel:r}),i})();Qo.set(n,o);try{return await o}finally{Qo.delete(n)}}async function zh(){var u,p,m,f,g,b,h,v;let e=Ia(),t=await Fc(e,M.interval),s=((u=Ns.get(`${e.id}:${M.interval}`))==null?void 0:u.sourceLabel)||String(((p=M.stats)==null?void 0:p.source)||"Coinbase + XRPL live"),a="pair",o=Rc(),i=String((o==null?void 0:o.symbol)||"").toUpperCase(),r=o?Ve(o):`${e.symbol||"XRP"}|`;if(o&&i&&i!=="XRP"){let w=await hh(o,M.interval);(m=w==null?void 0:w.candles)!=null&&m.length&&(t=w.candles,s=w.source,a=w.mode)}let l=String(e.symbol||"XRP").toUpperCase()==="XRP",c=Number((l?(f=M.stats)==null?void 0:f.xrplSpot:null)??((g=M.stats)==null?void 0:g.price)??0);if(a==="pair"&&Number.isFinite(c)&&c>0&&t.length){let w=Math.max(60,Ec(M.interval)),k=Math.floor(Date.now()/1e3),$=Math.floor(k/w)*w,T=t[t.length-1];T.time===$?(T.high=Math.max(T.high,c),T.low=Math.min(T.low,c),T.close=c):T.time<$&&t.push({time:$,open:T.close,high:Math.max(T.close,c),low:Math.min(T.close,c),close:c,volume:0})}let d=Number((o==null?void 0:o.price)||0);if(a==="pair"&&o&&i&&i!=="XRP"&&Number.isFinite(d)&&d>0&&t.length){let w=Number((l?(b=M.stats)==null?void 0:b.xrplSpot:null)??((h=M.stats)==null?void 0:h.price)??((v=t[t.length-1])==null?void 0:v.close)??0);if(Number.isFinite(w)&&w>0){let k=d/w;Number.isFinite(k)&&k>0&&(t=t.map($=>({...$,open:$.open*k,high:$.high*k,low:$.low*k,close:$.close*k})),s="Coinbase pair + token spot proxy",a="token-proxy")}}return t.length||(t=Dc(M.interval,_c()),s=o&&i!=="XRP"?"Synthetic fallback (token-focused)":"Synthetic fallback",a="fallback"),o&&i!=="XRP"&&(a==="pair"||a==="fallback")?Go!==r&&(Go=r,he(`No market data found for ${o.symbol} yet \u2014 showing ${e.symbol||"XRP"} for reference.`)):r&&(Go=""),M.chartType==="heikin_ashi"&&(t=ai(t)),bh(t,{mode:a,source:s,tokenKey:r||"XRP|"}),t}function Ol(e){if(!Array.isArray(e))return[];let t=e.map(s=>({time:Number(s.time),open:Number(s.open),high:Number(s.high),low:Number(s.low),close:Number(s.close),volume:Number(s.volume||0)})).filter(s=>Number.isFinite(s.time)&&Number.isFinite(s.open)&&Number.isFinite(s.high)&&Number.isFinite(s.low)&&Number.isFinite(s.close)&&s.time>0).sort((s,a)=>s.time-a.time),n=[];for(let s=0;s<t.length;s+=1){let a=t[s],o=n[n.length-1];o&&o.time===a.time?n[n.length-1]=a:n.push(a)}return n}function jh(e,t,n){var i;let s=Number(((i=e==null?void 0:e[e.length-1])==null?void 0:i.close)||0);if(!Number.isFinite(s)||s<=0)return 6;let o=Math.max(1e-12,Math.abs(Number(n)-Number(t)))/Math.max(1e-12,Math.abs(s));return s>=1e3?o<.01?4:2:s>=1?o<.01?6:4:s>=.01?o<.03?8:6:8}function Wh(){if(ee.resizeObserver)try{ee.resizeObserver.disconnect()}catch{}ee.chart&&(ee.chart.remove(),ee={chart:null,volumeSeries:null,activeSeries:null,compareSeries:null,indicatorSeries:[],indicatorPriceLines:[],priceLines:[],resizeObserver:null,chartType:"",configKey:"",legendEl:null,renderLegend:null,ichimokuData:null,indicatorLegendItems:[],alertPriceLines:[]})}function Bl(e,t){var d;let{addOverlay:n,addOsc:s,addOscHist:a,addPriceLevel:o}=t,i=(u,p)=>{var f,g;let m=Number((g=(f=M.indicatorSettings)==null?void 0:f[u])==null?void 0:g.length);return Number.isFinite(m)&&m>1?Math.min(500,Math.max(2,m)):p},r=(u,p,m)=>{var b,h;let f=(h=(b=M.indicatorSettings)==null?void 0:b[u])==null?void 0:h[p];if(f==null||f==="")return m;let g=(hi[u]||[]).find(v=>v.id===p);if((g==null?void 0:g.type)==="number"){let v=Number(f);return Number.isFinite(v)&&v>1?Math.min(500,Math.max(2,v)):m}return f},l=M.indicators;if(l.sma20&&n(oi(e,i("sma20",20)),r("sma20","color","#f1c40f"),1.2,!1,"SMA"),l.ema20&&n(Is(e,i("ema20",20)),r("ema20","color","#ffb86c"),1.2,!1,"EMA"),l.wma20&&n(xh(e,i("wma20",20)),r("wma20","color","#bd93f9"),1.2,!1,"WMA"),l.vwap&&n($h(e),r("vwap","color","#80ffea"),1.2,!1,"VWAP"),l.bb20){let u=r("bb20","color","#ff79c6"),p=kh(e,i("bb20",20),2);n(p.upper,u,1,!0,"BB Upper"),n(p.lower,u,1,!0,"BB Lower")}if(l.ichimoku){let u=Ic(e,r("ichimoku","tenkanLen",9),r("ichimoku","kijunLen",26),r("ichimoku","senkouBLen",52));n(u.tenkan,r("ichimoku","tenkanColor","#ffde59"),1.2,!1,"Tenkan"),n(u.kijun,r("ichimoku","kijunColor","#6ecbff"),1.2,!1,"Kijun"),n(u.senkouA,"rgba(70,255,160,0.8)",1,!0,"Senkou A"),n(u.senkouB,"rgba(255,120,120,0.8)",1,!0,"Senkou B"),n(u.chikou,"rgba(220,220,255,0.6)",.9,!0,"Chikou")}if(l.donchian){let u=r("donchian","color","#9cfb8c"),p=Ph(e,i("donchian",20));n(p.upper,u,1,!0,"Donchian Upper"),n(p.lower,u,1,!0,"Donchian Lower"),n(p.mid,"rgba(156,251,140,0.6)",1.2,!1,"Donchian Mid")}if(l.keltner){let u=r("keltner","color","#7ee7ff"),p=Mh(e,i("keltner",20),2);n(p.upper,u,1,!0,"Keltner Upper"),n(p.lower,u,1,!0,"Keltner Lower"),n(p.mid,"rgba(126,231,255,0.66)",1.2,!1,"Keltner Mid")}if(l.pivots&&e.length>=2){let u=e[e.length-2],p=(u.high+u.low+u.close)/3,m=2*p-u.low,f=2*p-u.high,g=p+(u.high-u.low),b=p-(u.high-u.low);o(p,"#f6f6f6","P"),o(m,"#61ffb0","R1"),o(f,"#ff8f8f","S1"),o(g,"rgba(97,255,176,0.6)","R2"),o(b,"rgba(255,143,143,0.6)","S2")}if(l.supertrend||l.sar||l.elderRay){let u=Is(e,14);if(l.supertrend&&n(Rh(e,10,3),r("supertrend","color","#8bffde"),1.3,!1,"Supertrend"),l.sar&&n(u.map(p=>({time:p.time,value:p.value*.998})),r("sar","color","#ffaf7a"),1,!0,"SAR"),l.elderRay){let p=new Map(u.map(g=>[g.time,g.value])),m=e.filter(g=>p.has(g.time)).map(g=>({time:g.time,value:g.high-p.get(g.time)})),f=e.filter(g=>p.has(g.time)).map(g=>({time:g.time,value:g.low-p.get(g.time)}));s(m,r("elderRay","bullColor","#5fff9d"),"Elder Bull"),s(f,r("elderRay","bearColor","#ff9d9d"),"Elder Bear")}}if(l.rsi&&s(Sh(e,i("rsi",14)),r("rsi","color","#a6ff4d"),"RSI"),l.atr&&s(xi(e,i("atr",14)),r("atr","color","#ffb86c"),"ATR"),l.stdev){let u=oi(e,20),p=new Map(u.map(f=>[f.time,f.value])),m=e.filter(f=>p.has(f.time)).map(f=>({time:f.time,value:Math.abs(f.close-p.get(f.time))}));s(m,r("stdev","color","#b2a3ff"),"StdDev")}if(l.stoch){let u=Th(e,i("stoch",14),3);s(u.k,r("stoch","kColor","#9ee8ff"),"%K"),s(u.d,r("stoch","dColor","#ffd86b"),"%D")}if(l.macd){let u=Ch(e,r("macd","fastLen",12),r("macd","slowLen",26),r("macd","signalLen",9));s(u.line,r("macd","lineColor","#8fd9ff"),"MACD"),s(u.signal,r("macd","signalColor","#ffcf8e"),"Signal"),(d=u.hist)!=null&&d.length&&a(u.hist)}let c=Lh(e);if(l.obv&&s(c.obv,r("obv","color","#8cf9ff"),"OBV"),l.adline&&s(c.adline,r("adline","color","#ffb7ff"),"A/D"),l.cmf&&s(Oh(e,i("cmf",20)),r("cmf","color","#f8ff87"),"CMF"),l.williamsr&&s(Dh(e,i("williamsr",14)),r("williamsr","color","#ff9adf"),"Williams %R"),l.cci&&s(Ih(e,i("cci",20)),r("cci","color","#b8ff8e"),"CCI"),l.mfi&&s(_h(e,i("mfi",14)),r("mfi","color","#7bffd2"),"MFI"),l.uo&&s(Fh(e),r("uo","color","#ffd36f"),"UO"),l.adx){let u=Ah(e,i("adx",14));s(u.adx,r("adx","adxColor","#9fd8ff"),"ADX"),s(u.plusDi,r("adx","plusColor","#73ffc0"),"+DI"),s(u.minusDi,r("adx","minusColor","#ff9797"),"-DI")}if(l.aroon){let u=Eh(e,i("aroon",14));s(u.up,r("aroon","upColor","#6cffb0"),"Aroon Up"),s(u.down,r("aroon","downColor","#ff8f8f"),"Aroon Down")}if(l.vortex){let u=Nh(e,i("vortex",14));s(u.plus.map(p=>({time:p.time,value:p.value*100})),r("vortex","plusColor","#d6a8ff"),"VI+"),s(u.minus.map(p=>({time:p.time,value:p.value*100})),r("vortex","minusColor","#ffb0f3"),"VI-")}}function qh(e){let t=e.querySelector(":scope > svg.xpd-ichimoku-cloud-svg");return t||(t=document.createElementNS("http://www.w3.org/2000/svg","svg"),t.setAttribute("class","xpd-ichimoku-cloud-svg"),e.appendChild(t)),t}function Uh(e){var t;(t=e==null?void 0:e.querySelector(":scope > svg.xpd-ichimoku-cloud-svg"))==null||t.remove()}function Oc(e,t,n,s,a){var b;if(!e||!t||!n)return;let o=n.clientWidth||0,i=n.clientHeight||0;if(!o||!i||!(s!=null&&s.length)||!(a!=null&&a.length))return;let r=qh(n);r.setAttribute("width",o),r.setAttribute("height",i),r.setAttribute("viewBox",`0 0 ${o} ${i}`);let l=((b=M.indicatorSettings)==null?void 0:b.ichimoku)||{},c=l.bullColor||"#46ffa0",d=l.bearColor||"#ff7878",u=new Map(a.map(h=>[h.time,h.value])),p=e.timeScale(),m=[];for(let h of s){let v=u.get(h.time);if(v==null)continue;let w=p.timeToCoordinate(h.time),k=t.priceToCoordinate(h.value),$=t.priceToCoordinate(v);w==null||k==null||$==null||m.push({x:w,ya:k,yb:$,bullish:h.value>=v})}let f="",g=0;for(let h=1;h<=m.length;h+=1){if(!(h===m.length||m[h].bullish!==m[g].bullish))continue;let w=m.slice(g,h);if(w.length>=2){let k=w.map(S=>`${S.x.toFixed(1)},${S.ya.toFixed(1)}`).join(" "),$=w.slice().reverse().map(S=>`${S.x.toFixed(1)},${S.yb.toFixed(1)}`).join(" "),T=w[0].bullish?c:d;f+=`<polygon points="${k} ${$}" fill="${y(T)}" opacity="0.22" />`}g=h}r.innerHTML=f}function Xl(e,t,n,s){var i;if(!M.indicators.ichimoku){Uh(s),ee.ichimokuData=null;return}let a=((i=M.indicatorSettings)==null?void 0:i.ichimoku)||{},o=Ic(e,Number(a.tenkanLen)||9,Number(a.kijunLen)||26,Number(a.senkouBLen)||52);ee.ichimokuData={senkouA:o.senkouA,senkouB:o.senkouB},Oc(t,n,s,o.senkouA,o.senkouB)}function li(){let e=ee.ichimokuData,t=document.getElementById("xpd-tv-widget");e&&ee.chart&&ee.activeSeries&&t&&Oc(ee.chart,ee.activeSeries,t,e.senkouA,e.senkouB)}async function Vh(){var n,s,a,o;let e=++_n,t=document.getElementById("xpd-tv-widget");if(t){ee.chart||(t.innerHTML='<div class="xpd-loading">Loading full price history\u2026</div>');try{M.threeEnabled?wh():Bs();let i=await zh(),r=Ol(i);if(e!==_n)return;if(!r.length)throw new Error("No chart bars returned for selected pair/timeframe.");Kh(r);let l=JSON.stringify({pair:M.pair,interval:M.interval,chartType:M.chartType,comparePair:M.comparePair,indicators:M.indicators,indicatorSettings:M.indicatorSettings,threeEnabled:M.threeEnabled});if(!M.comparePair&&!(M.drawings||[]).length&&ee.chart&&ee.configKey===l){let B=M.chartType==="heikin_ashi"?ai(r):r;M.chartType==="line"||M.chartType==="area"?ee.activeSeries.setData(B.map(Y=>({time:Y.time,value:Y.close}))):ee.activeSeries.setData(B),ee.volumeSeries.setData(r.map(Y=>({time:Y.time,value:Y.volume||0,color:Y.close>=Y.open?"rgba(38,166,154,0.5)":"rgba(239,83,80,0.5)"})));let U=0,J=0,ue=[];Bl(r,{addOverlay:(Y,Ce,Qe,Se,Pt)=>{let jt=ee.indicatorSeries[U++];Y!=null&&Y.length&&(jt==null||jt.setData(Y),Pt&&jt&&ue.push({label:Pt,color:Ce,series:jt,points:Y}))},addOsc:(Y,Ce,Qe)=>{let Se=ee.indicatorSeries[U++];Y!=null&&Y.length&&(Se==null||Se.setData(Y),Qe&&Se&&ue.push({label:Qe,color:Ce,series:Se,points:Y}))},addOscHist:Y=>{let Ce=ee.indicatorSeries[U++];Y!=null&&Y.length&&(Ce==null||Ce.setData(Y.map(Qe=>({time:Qe.time,value:Qe.value,color:Qe.value>=0?"rgba(99,255,157,0.45)":"rgba(255,126,126,0.45)"}))))},addPriceLevel:Y=>{let Ce=ee.indicatorPriceLines[J++];Number.isFinite(Y)&&(Ce==null||Ce.applyOptions({price:Y}))}}),ee.indicatorLegendItems=ue,Xl(r,ee.chart,ee.activeSeries,t),Hl(ee.activeSeries);let Ie=r[r.length-1];(n=ee.renderLegend)==null||n.call(ee,Ie.open,Ie.high,Ie.low,Ie.close,Ie.volume);return}if(!await vh())throw new Error("Chart library failed to load.");if(e!==_n)return;let d=document.getElementById("xpd-tv-widget");if(!d||e!==_n)return;let u=null;try{u=((s=ee.chart)==null?void 0:s.timeScale().getVisibleLogicalRange())||null}catch{}Wh(),d.innerHTML="";let p=window.LightweightCharts,m=Math.max(320,d.clientWidth||((a=d.parentElement)==null?void 0:a.clientWidth)||320),f=Math.max(360,d.clientHeight||460),g=r.map(B=>B.low),b=r.map(B=>B.high),h=jh(r,Math.min(...g),Math.max(...b)),v={type:"price",precision:h,minMove:Math.pow(10,-h)},w="#26a69a",k="#ef5350",$=p.createChart(d,{width:m,height:f,layout:{background:{type:p.ColorType.Solid,color:"#131722"},textColor:"#d1d4dc"},grid:{vertLines:{color:"#242832"},horzLines:{color:"#242832"}},rightPriceScale:{borderColor:"rgba(197,203,206,0.3)"},leftPriceScale:{visible:!1,borderColor:"rgba(197,203,206,0.3)"},timeScale:{borderColor:"rgba(197,203,206,0.3)",timeVisible:!0,secondsVisible:!1},crosshair:{mode:p.CrosshairMode.Normal},handleScroll:!0,handleScale:!0}),T=M.chartType==="heikin_ashi"?ai(r):r,S;if(M.chartType==="line")S=$.addLineSeries({color:"#2962ff",lineWidth:2,priceFormat:v}),S.setData(T.map(B=>({time:B.time,value:B.close})));else if(M.chartType==="area")S=$.addAreaSeries({lineColor:"#2962ff",topColor:"rgba(41,98,255,0.36)",bottomColor:"rgba(41,98,255,0.04)",lineWidth:2,priceFormat:v}),S.setData(T.map(B=>({time:B.time,value:B.close})));else if(M.chartType==="bars")S=$.addBarSeries({upColor:w,downColor:k,priceFormat:v}),S.setData(T);else{let B=M.chartType==="hollow_candles";S=$.addCandlestickSeries({upColor:B?"rgba(0,0,0,0)":w,downColor:k,borderUpColor:w,borderDownColor:k,wickUpColor:w,wickDownColor:k,borderVisible:!0,priceFormat:v}),S.setData(T)}let N=$.addHistogramSeries({priceFormat:{type:"volume"},priceScaleId:"vol"});$.priceScale("vol").applyOptions({scaleMargins:{top:.85,bottom:0}}),N.setData(r.map(B=>({time:B.time,value:B.volume||0,color:B.close>=B.open?"rgba(38,166,154,0.5)":"rgba(239,83,80,0.5)"})));let P=document.createElement("div");P.className="xpd-chart-legend",d.appendChild(P);let C=B=>Number.isFinite(B)?B.toFixed(h):"\u2014",R=(B,U,J,ue,$e,Me)=>{let We=ue>=B,De=(Me||[]).map(Ie=>`<span style="color:${y(Ie.color)}">${y(Ie.label)} <b>${C(Ie.value)}</b></span>`).join("");P.innerHTML=`
        <span>O <b>${C(B)}</b></span>
        <span>H <b>${C(U)}</b></span>
        <span>L <b>${C(J)}</b></span>
        ...
        ${De}
      `},O=T[T.length-1],D=(o=r[r.length-1])==null?void 0:o.volume,I=()=>{if(!O)return;let B=O.open??O.value,U=O.high??O.value,J=O.low??O.value,ue=O.close??O.value,$e=(ee.indicatorLegendItems||[]).map(Me=>{var We,De;return{label:Me.label,color:Me.color,value:(De=(We=Me.points)==null?void 0:We[Me.points.length-1])==null?void 0:De.value}}).filter(Me=>Number.isFinite(Me.value));R(B,U,J,ue,D,$e)};I(),$.subscribeCrosshairMove(B=>{var Ie,Y;if(!B.time){I();return}let U=(Ie=B.seriesData)==null?void 0:Ie.get(S);if(!U){I();return}let J=(Y=B.seriesData)==null?void 0:Y.get(N),ue=U.open??U.value,$e=U.high??U.value,Me=U.low??U.value,We=U.close??U.value,De=(ee.indicatorLegendItems||[]).map(Ce=>{var Qe,Se;return{label:Ce.label,color:Ce.color,value:(Se=(Qe=B.seriesData)==null?void 0:Qe.get(Ce.series))==null?void 0:Se.value}}).filter(Ce=>Number.isFinite(Ce.value));R(ue,$e,Me,We,J==null?void 0:J.value,De)});let F=!1,H=()=>{F||(F=!0,$.priceScale("osc").applyOptions({scaleMargins:{top:.65,bottom:.18}}))},E=[],j=[],se=[];Bl(r,{addOverlay:(B,U,J=1.2,ue=!1,$e="")=>{if(!(B!=null&&B.length))return;let Me=$.addLineSeries({color:U,lineWidth:J,lineStyle:ue?p.LineStyle.Dashed:p.LineStyle.Solid,priceLineVisible:!1,lastValueVisible:!1});Me.setData(B),E.push(Me),$e&&se.push({label:$e,color:U,series:Me,points:B})},addOsc:(B,U,J="")=>{if(!(B!=null&&B.length))return;H();let ue=$.addLineSeries({color:U,lineWidth:1.2,priceScaleId:"osc",title:J,priceLineVisible:!1,lastValueVisible:!1});ue.setData(B),E.push(ue),J&&se.push({label:J,color:U,series:ue,points:B})},addOscHist:B=>{if(!(B!=null&&B.length))return;H();let U=$.addHistogramSeries({priceScaleId:"osc",priceLineVisible:!1,lastValueVisible:!1});U.setData(B.map(J=>({time:J.time,value:J.value,color:J.value>=0?"rgba(99,255,157,0.45)":"rgba(255,126,126,0.45)"}))),E.push(U)},addPriceLevel:(B,U,J="")=>{Number.isFinite(B)&&j.push(S.createPriceLine({price:B,color:U,lineWidth:1,lineStyle:p.LineStyle.Dashed,axisLabelVisible:!0,title:J}))}}),Xl(r,$,S,d),$.timeScale().subscribeVisibleLogicalRangeChange(li);let de=null;if(M.comparePair){let B=On.find(U=>U.id===M.comparePair);if(B){let U=Ol(await Fc(B,M.interval));if(e===_n&&U.length){let J=U[0].close||1;de=$.addLineSeries({color:"#ffd166",lineWidth:1.4,priceScaleId:"left",priceLineVisible:!1,lastValueVisible:!0,priceFormat:{type:"custom",formatter:ue=>`${ue>=0?"+":""}${ue.toFixed(2)}%`,minMove:.01}}),$.priceScale("left").applyOptions({visible:!0,borderColor:"rgba(255,209,102,0.35)"}),de.setData(U.map(ue=>({time:ue.time,value:(ue.close/J-1)*100})))}}}else $.priceScale("left").applyOptions({visible:!1});if(e!==_n){try{$.remove()}catch{}return}let le=(M.drawings||[]).filter(B=>Number.isFinite(B==null?void 0:B.price)).map(B=>S.createPriceLine({price:B.price,color:"#78e5ff",lineWidth:2,lineStyle:p.LineStyle.Dashed,axisLabelVisible:!0,title:"Line"}));if($.subscribeClick(B=>{if(M.drawingTool!=="hline"||!B.point)return;let U=S.coordinateToPrice(B.point.y);Number.isFinite(U)&&(M.drawings=[...M.drawings||[],{price:U}].slice(-50),le.push(S.createPriceLine({price:U,color:"#78e5ff",lineWidth:2,lineStyle:p.LineStyle.Dashed,axisLabelVisible:!0,title:"Line"})))}),u&&Number.isFinite(u.from)&&Number.isFinite(u.to))try{$.timeScale().setVisibleLogicalRange(u)}catch{$.timeScale().fitContent()}else $.timeScale().fitContent();let Pe=new ResizeObserver(()=>{$.applyOptions({width:Math.max(320,d.clientWidth||320)}),li()});Pe.observe(d),ee={chart:$,volumeSeries:N,activeSeries:S,compareSeries:de,indicatorSeries:E,indicatorPriceLines:j,priceLines:le,resizeObserver:Pe,chartType:M.chartType,configKey:l,legendEl:P,renderLegend:R,indicatorLegendItems:se,alertPriceLines:[]},Hl(S)}catch(i){if(e!==_n)return;if(M.error=(i==null?void 0:i.message)||"Could not initialize chart widget.",ee.chart){he(M.error);return}let r=document.getElementById("xpd-tv-widget");r&&(r.innerHTML=`<div class="xpd-error">${y(M.error)}</div>`)}}}function Bc(){let e=Q(ei)==="1"?"0":"1";Z(ei,e),q()}async function Xc(e){On.some(t=>t.id===e)&&(M.pair=e,await Os(),Et(),q())}async function Hc(e){M.interval=e,await Os(),Et(),q()}function zc(e){M.chartType=e,Et(),q()}async function jc(){await Os(),q()}function Wc(e,t){e in M.indicators&&(M.indicators[e]=!!t,t&&(M.selectedIndicator=e,M.selectedEducationTab="indicator"),Et(),q())}function qc(){M.indicatorMenuOpen=!M.indicatorMenuOpen,q()}function Uc(){M.moreMenuOpen=!M.moreMenuOpen,q()}function Vc(e){M.indicatorQuery=String(e||""),M.indicatorMenuOpen||(M.indicatorMenuOpen=!0),q()}function Gc(e){let t=String(e||"").trim();t in M.indicators&&(M.indicators[t]=!0,M.selectedIndicator=t,M.selectedEducationTab="indicator",Et(),q())}function Kc(e){let t=String(e||"").trim();t in M.indicators&&(M.indicators[t]=!1,Et(),q())}function Gh(e){var s,a;if(M.settingsOpenFor!==e)return"";let t=M.indicatorSettings[e]||{},n=hi[e]||[];return`
    ...
    </div>`}function Jc(e){let t=String(e||"").trim();t in M.indicators&&(M.settingsOpenFor=M.settingsOpenFor===t?null:t,q())}function Yc(){M.settingsOpenFor=null,q()}function Qc(e){let t=String(e||"").trim();if(!(t in M.indicators))return;let n=M.indicatorSettings[t]||{},s={...n};for(let a of hi[t]||[]){let o=document.getElementById(`xpd-ind-${a.id}-${t}`);o&&(a.type==="number"?s[a.id]=Math.max(2,Math.min(500,Number(o.value)||n[a.id]||a.default)):s[a.id]=o.value)}M.indicatorSettings[t]=s,M.settingsOpenFor=null,q()}function Zc(e){let t=String(e||"").trim();delete M.indicatorSettings[t],M.settingsOpenFor=null,q()}function ed(){Et(),js(window.location.href),ne("Chart link copied.")}function td(){M.threeEnabled=!M.threeEnabled,Z(fi,M.threeEnabled?"1":"0"),M.threeEnabled||Bs(),q()}function nd(e){let t=!!e;M.threeEnabled!==t&&(M.threeEnabled=t,Z(fi,M.threeEnabled?"1":"0"),M.threeEnabled||Bs(),q())}function sd(e){M.comparePair=e||"",Et(),q()}function ad(e){let t=String(e||"").trim();!t||!(t in M.indicators)||(M.indicators[t]=!0,M.selectedIndicator=t,q())}function od(e){let t=String(e||"none");ac.some(n=>n.key===t)&&(M.drawingTool=t,M.educationHint=Lf[t]||"",q())}function Fa(){var e;return((e=M.chartMeta)==null?void 0:e.tokenKey)||M.tokenFocusKey||`${Ia().symbol||"XRP"}|`}function id(){var s,a;let e=Number((s=M.chartMeta)==null?void 0:s.last),t=prompt(`Alert me when ${((a=M.chartMeta)==null?void 0:a.symbol)||"price"} crosses:`,Number.isFinite(e)?e.toFixed(6):"");if(t==null)return;let n=Number(t);if(!Number.isFinite(n)||n<=0){he("Enter a valid price.");return}M.alerts=[...M.alerts||[],{id:`alert_${Date.now()}`,tokenKey:Fa(),price:n,createdAt:new Date().toISOString()}],bi(),q(),ne(`Alert set at $${_(n,6)}`)}function rd(e){M.alerts=(M.alerts||[]).filter(t=>t.id!==e),bi(),q()}function Hl(e){if(!e)return;let t=window.LightweightCharts;for(let s of ee.alertPriceLines||[])try{e.removePriceLine(s)}catch{}let n=(M.alerts||[]).filter(s=>s.tokenKey===Fa());ee.alertPriceLines=n.map(s=>{var a;return e.createPriceLine({price:s.price,color:"#ffb703",lineWidth:2,lineStyle:((a=t==null?void 0:t.LineStyle)==null?void 0:a.Dotted)??2,axisLabelVisible:!0,title:"\u{1F514} Alert"})})}function Kh(e){var r,l;if(e.length<2)return;let t=Fa(),n=(M.alerts||[]).filter(c=>c.tokenKey===t);if(!n.length)return;let s=e[e.length-2].close,a=e[e.length-1].close,o=[],i=!1;for(let c of n){let d=s<c.price&&a>=c.price,u=s>c.price&&a<=c.price;d||u?(ne(`\u{1F514} ${((r=M.chartMeta)==null?void 0:r.symbol)||"Price"} crossed $${_(c.price,6)} (${d?"\u2191":"\u2193"} now $${_(a,6)})`),i=!0,(l=document.querySelector(`.xpd-indicator-chip[data-alert-id="${c.id}"]`))==null||l.remove()):o.push(c)}i&&(M.alerts=[...(M.alerts||[]).filter(c=>c.tokenKey!==t),...o],bi())}function ld(){let e=ee.activeSeries;if(e)for(let t of ee.priceLines||[])try{e.removePriceLine(t)}catch{}ee.priceLines=[],M.drawings=[]}function Oa(e,t=0){var i;let n=(i=ee.chart)==null?void 0:i.timeScale();if(!n)return;let s=n.getVisibleLogicalRange();if(!s)return;let a=(s.to-s.from)*e,o=(s.to+s.from)/2+(s.to-s.from)*t;n.setVisibleLogicalRange({from:o-a/2,to:o+a/2})}function cd(){Oa(.8)}function dd(){Oa(1.25)}function pd(){Oa(1,-.2)}function ud(){Oa(1,.2)}function md(){M.educationCollapsed=!M.educationCollapsed,q()}function fd(e){["indicator","psychology","practice"].includes(e)&&(M.selectedEducationTab=e,q())}function hd(){let e=document.body.classList.contains("theme-gold");Mn(e?"cosmic":"gold"),q()}var zl=!1;function Jh(){let e=document.getElementById("xpd-tv-widget");e&&ee.chart&&(ee.chart.applyOptions({width:Math.max(320,e.clientWidth||320),height:Math.max(320,e.clientHeight||460)}),li())}function gd(){var t;let e=document.querySelector(".xpd-chart-wrap");e&&(zl||(zl=!0,document.addEventListener("fullscreenchange",()=>{requestAnimationFrame(()=>requestAnimationFrame(Jh))})),document.fullscreenElement?document.exitFullscreen():(t=e.requestFullscreen)==null||t.call(e))}function bd(){let e=ee.chart;if(!e){he("Chart image is not ready yet.");return}let t=e.takeScreenshot(),n=document.createElement("a");n.download=`xrpl-chart-${Date.now()}.png`,n.href=t.toDataURL("image/png"),n.click()}function vd(){return M.tokenFocusKey||M.pair||"default"}function yd(){var n;let e=ge(Q(ti))||{},t=vd();e[t]={interval:M.interval,chartType:M.chartType,comparePair:M.comparePair,indicators:M.indicators,indicatorSettings:M.indicatorSettings},Z(ti,JSON.stringify(e)),ne(`Chart layout saved for ${((n=M.chartMeta)==null?void 0:n.symbol)||t}.`)}function wd(){var s;let e=ge(Q(ti))||{},t=vd(),n=e[t];if(!n){he(`No saved layout for ${((s=M.chartMeta)==null?void 0:s.symbol)||t} yet.`);return}M.interval=n.interval||M.interval,M.chartType=n.chartType||M.chartType,M.comparePair=n.comparePair||"",M.indicators={...M.indicators,...n.indicators||{}},M.indicatorSettings={...M.indicatorSettings,...n.indicatorSettings||{}},Et(),q()}function Ba(e){let t=String(e||"").trim();if(/^[0-9A-F]{40}$/i.test(t)){let n=t.replace(/(00)+$/g,"");if(/^[0-9A-F]+$/i.test(n)&&n.length%2===0)try{let s=new Uint8Array(n.length/2);for(let o=0;o<n.length;o+=2)s[o/2]=parseInt(n.slice(o,o+2),16);let a=new TextDecoder().decode(s).replace(/\0/g,"").trim();if(a)return a.toUpperCase()}catch{}}return t.toUpperCase()}function Ve(e){return`${e.symbol}|${e.issuer||""}`}function Ls(e){return encodeURIComponent(e).replace(/'/g,"%27")}function Yh(e){var l,c,d,u,p,m,f,g,b,h;let t=Ba(e.code||e.currency||""),n=String(e.issuer||((l=e.IssuingAccount)==null?void 0:l.account)||"").trim(),s=Number(e.price??((c=e.metrics)==null?void 0:c.price)??0),a=Number(e.marketcap??((d=e.metrics)==null?void 0:d.marketcap)??0),o=Number(((u=e.metrics)==null?void 0:u.volume_24h)??0),i=((m=(p=e.meta)==null?void 0:p.token)==null?void 0:m.name)||((f=e.IssuingAccount)==null?void 0:f.name)||t||"Unknown Token",r=Number(e.holders??((g=e.metrics)==null?void 0:g.holders)??((b=e.metrics)==null?void 0:b.trustlines)??0);return{symbol:t,name:i,issuer:n,tokenId:e.id||`${t}.${n}`,price:Number.isFinite(s)&&s>0?s:null,marketCap:Number.isFinite(a)&&a>0?a:null,volume24h:Number.isFinite(o)?o:null,holders:Number.isFinite(r)?r:null,change24h:null,verified:!!((h=e.IssuingAccount)!=null&&h.verified),score:Number(e.score||0)||null}}function Qh(e){let t=Ba((e==null?void 0:e.symbol)||""),n=String((e==null?void 0:e.name)||t||"Unknown Token"),s=Number((e==null?void 0:e.current_price)||0),a=Number((e==null?void 0:e.market_cap)||0),o=Number((e==null?void 0:e.total_volume)||0),i=Number((e==null?void 0:e.price_change_percentage_24h)||0);return{symbol:t,name:n,issuer:"",tokenId:`cg:${(e==null?void 0:e.id)||t}`,price:Number.isFinite(s)&&s>0?s:null,marketCap:Number.isFinite(a)&&a>0?a:null,volume24h:Number.isFinite(o)&&o>0?o:null,holders:null,change24h:Number.isFinite(i)?i:null,verified:!1,score:null}}function Zh(e){var r;let t=Ba((e==null?void 0:e.currency)||(e==null?void 0:e.token)||""),n=String((e==null?void 0:e.issuer)||(e==null?void 0:e.account)||"").trim(),s=String((e==null?void 0:e.name)||t||"Unknown Token"),a=Number((e==null?void 0:e.price)||((r=e==null?void 0:e.market)==null?void 0:r.price)||0),o=Number((e==null?void 0:e.marketcap)||(e==null?void 0:e.marketCap)||0),i=Number((e==null?void 0:e.volume24h)||(e==null?void 0:e.volume)||0);return{symbol:t,name:s,issuer:n,tokenId:`bithomp:${t}.${n||"na"}`,price:Number.isFinite(a)&&a>0?a:null,marketCap:Number.isFinite(o)&&o>0?o:null,volume24h:Number.isFinite(i)&&i>0?i:null,holders:Number.isFinite(Number((e==null?void 0:e.holders)||0))?Number((e==null?void 0:e.holders)||0):null,change24h:Number.isFinite(Number((e==null?void 0:e.change24h)||0))?Number((e==null?void 0:e.change24h)||0):null,verified:!!(e!=null&&e.verified),score:null}}function eg(e){let t=Ba((e==null?void 0:e.symbol)||(e==null?void 0:e.currency)||""),n=String((e==null?void 0:e.issuer)||(e==null?void 0:e.issuerAddress)||"").trim(),s=String((e==null?void 0:e.name)||t||"Unknown Token"),a=Number((e==null?void 0:e.price)||0),o=Number((e==null?void 0:e.volume24h)||0);return{symbol:t,name:s,issuer:n,tokenId:`xrplto:${t}.${n||"na"}`,price:Number.isFinite(a)&&a>0?a:null,marketCap:Number.isFinite(Number((e==null?void 0:e.marketCap)||0))?Number((e==null?void 0:e.marketCap)||0):null,volume24h:Number.isFinite(o)&&o>0?o:null,holders:Number.isFinite(Number((e==null?void 0:e.holders)||0))?Number((e==null?void 0:e.holders)||0):null,change24h:Number.isFinite(Number((e==null?void 0:e.change24h)||0))?Number((e==null?void 0:e.change24h)||0):null,verified:!!(e!=null&&e.verified),score:null}}async function xd(){var e,t,n,s,a,o;if(Na()){W.loading=!0,W.error="";try{let i=Date.now(),r=Ml.get("tokens");if(r&&i-r.ts<6e4){W.tokens=r.data,W.total=r.total||r.data.length,W.lastSyncAt=r.ts,W.filtered=is(W.query,r.data),W.trending=jl(r.data),W.loading=!1;return}let l=500,c=12,d=[];for(let T=1;T<=c;T+=1){let S=await At(`${pf}?page=${T}&limit=${l}`,{allowProxy:!1,timeoutMs:12e3});if(!Array.isArray(S)||!S.length||(d.push(...S),S.length<l))break}let u=d.map(Yh).filter(T=>!!T.symbol&&!!T.issuer),p=[At(`${uf}?vs_currency=usd&order=market_cap_desc&per_page=250&page=1&sparkline=false`,{timeoutMs:12e3}).catch(()=>[]),Date.now()<(El.xrplto||0)?Promise.resolve([]):At(ff,{timeoutMs:12e3,allowProxy:!1}).catch(T=>(String((T==null?void 0:T.message)||"").includes("429")&&(El.xrplto=Date.now()+5*60*1e3),[]))];hf&&p.push(At(mf,{timeoutMs:12e3,allowProxy:!1}).catch(()=>[]));let[m,f,g=[]]=await Promise.all(p),b=Array.isArray(m)?m.map(Qh).filter(T=>!!T.symbol):[],h=Array.isArray(g)?g.map(Zh).filter(T=>!!T.symbol):[],v=Array.isArray(f)?f.map(eg).filter(T=>!!T.symbol):[],w={symbol:"XRP",name:"XRP Ledger Native",issuer:"",tokenId:"XRP",price:((e=Te.data)==null?void 0:e.priceUsd)||((t=M.stats)==null?void 0:t.price)||null,marketCap:((n=Te.data)==null?void 0:n.marketCap)||null,volume24h:((s=Te.data)==null?void 0:s.volume24h)||null,holders:null,change24h:((a=Te.data)==null?void 0:a.change24h)||((o=M.stats)==null?void 0:o.changePct)||null,verified:!0,score:1},k=new Map;[w,...u,...h,...v,...b].forEach(T=>{let S=Ve(T);k.has(S)||k.set(S,T)});let $=[...k.values()];Ml.set("tokens",{ts:i,data:$,total:$.length}),W.tokens=$,W.total=$.length,W.lastSyncAt=i,W.filtered=is(W.query,$),W.trending=jl($)}catch(i){W.error=(i==null?void 0:i.message)||"Could not load XRPL token discovery data."}finally{W.loading=!1}}}function is(e,t){let n=String(e||"").trim().toLowerCase(),s=W.filters||{type:"all",minCap:0,minVol:0,hasDex:!1};return t.filter(a=>{if(n&&!`${a.symbol} ${a.name} ${a.issuer} ${a.tokenId||""}`.toLowerCase().includes(n)||Number(s.minCap||0)>0&&Number(a.marketCap||0)<Number(s.minCap||0)||Number(s.minVol||0)>0&&Number(a.volume24h||0)<Number(s.minVol||0)||s.hasDex&&!(Number(a.volume24h||0)>0||Number(a.holders||0)>100))return!1;if(s.type&&s.type!=="all"){let o=String(a.symbol||"").toLowerCase(),i=String(a.name||"").toLowerCase(),r=/usd|usdc|usdt|rlusd|eur|gbp/.test(o)||/stable/.test(i),l=/meme|dog|cat|frog|shib|pepe/.test(o)||/meme/.test(i),c=/mpt/.test(o)||/multi-purpose/.test(i);if(s.type==="stablecoin"&&!r||s.type==="meme"&&!l||s.type==="mpt"&&!c||s.type==="standard"&&(r||l||c))return!1}return!0})}function jl(e){return[...e].sort((t,n)=>{let s=Number(t.volume24h||0),a=Number(n.volume24h||0);if(a!==s)return a-s;let o=Number(t.marketCap||0);return Number(n.marketCap||0)-o}).slice(0,24)}async function kd(e){if(Mt.loading=!0,Mt.error="",Mt.items=[],!e){Mt.loading=!1;return}try{let t=await Ci(e,20);Mt.items=t||[]}catch(t){Mt.error=(t==null?void 0:t.message)||"Could not load recent transactions."}finally{Mt.loading=!1}}function $d(e){W.query=e,Es&&clearTimeout(Es),Es=setTimeout(()=>{W.listLimit=240,W.filtered=is(W.query,W.tokens),q()},300)}function Sd(e,t){W.filters={...W.filters,[e]:t},W.listLimit=240,W.filtered=is(W.query,W.tokens),q()}function Td(){Es&&clearTimeout(Es),W.query="",W.filters={type:"all",minCap:0,minVol:0,hasDex:!1},W.listLimit=240,W.filtered=is("",W.tokens),q()}function Cd(){W.listLimit=Math.min(5e3,Number(W.listLimit||240)+240),q()}function Pd(){let e=W.filtered;W.listLimit=Math.min(5e3,Math.max(240,e.length)),q()}function Md(){W.listLimit=240,q()}function Ld(e){W.selectedTokenKey=e||"",q()}function Ad(e){let t=String(e||"").trim();if(!t)return;let n=vi();n.includes(t)||n.push(t),dc(n),q()}function Ed(e){let t=String(e||"").trim(),n=vi().filter(s=>s!==t);dc(n),q()}async function Xa(e){let t=String(e||"").trim();if(!t)return;let n=String(t.includes("|")?t.split("|")[0]:t).toUpperCase(),s=t.includes("|")?W.tokens.find(o=>Ve(o)===t):W.tokens.find(o=>String(o.symbol||"").toUpperCase()===String(n||"").toUpperCase());W.selectedTokenKey=s?Ve(s):t.includes("|")?t:W.selectedTokenKey,M.tokenFocusKey=W.selectedTokenKey||t;let a={BTC:"BINANCE:BTCUSDT",ETH:"BINANCE:ETHUSDT",SOL:"BINANCE:SOLUSDT"};M.pair=a[n]||"BITSTAMP:XRPUSD",Et(),q(),setTimeout(()=>Rf(),20),await Os(),Et(),q()}async function Nd(e){return Xa(e)}async function Rd(){await xd(),q()}async function ki(){let e=document.getElementById("xpd-lookup-currency"),t=document.getElementById("xpd-lookup-issuer"),n=String((e==null?void 0:e.value)||"").trim().toUpperCase(),s=String((t==null?void 0:t.value)||"").trim();if(!n){he("Enter a currency code first.");return}if(!s||!He(s)){he("Enter a valid XRPL issuer address.");return}let a=`${n}|${s}`,o=W.tokens.find(i=>Ve(i)===a);o||(o={symbol:n,name:n,issuer:s,price:null,marketCap:null,volume24h:null,holders:null,tokenId:""},W.tokens=[...W.tokens,o],W.filtered=is(W.query,W.tokens)),W.selectedTokenKey=a,e&&(e.value=""),t&&(t.value=""),await Xa(a)}async function _d(){var s,a;let e=String(((s=document.getElementById("xpd-lookup-currency"))==null?void 0:s.value)||"").trim().toUpperCase(),t=String(((a=document.getElementById("xpd-lookup-issuer"))==null?void 0:a.value)||"").trim();if(!e){he("Enter a currency code first.");return}if(!t||!He(t)){he("Enter a valid XRPL issuer address.");return}let n=`${e}|${t}`;await ki(),await yi(n)}async function Dd(){var t;let e=((t=Nt())==null?void 0:t.address)||"";await kd(e),q()}async function ss({silent:e=!1,force:t=!1}={}){var s;if(!t&&!Na())return;let n=((s=Nt())==null?void 0:s.address)||"";e||ne("Refreshing XRPL dashboard data..."),await Promise.allSettled([Os(),$c(),xd(),kd(n),Sc(n),Tc(n),Pc()]),q()}function Id(){return $c()}function Fd(){var e;return Sc(((e=Nt())==null?void 0:e.address)||"")}function Od(){var e;return Tc(((e=Nt())==null?void 0:e.address)||"")}function Bd(){return Pc()}function Xd(e){ne(`NFT ${e.slice(0,12)}... selected. Send flow can be wired to NFTokenCreateOffer.`)}function Fs(){let e=x("profile-metrics-row");if(!e)return;let t=!1,n=Object.values(et).reduce((u,p)=>u+((p==null?void 0:p.xrp)||0),0),s=Hd(),a=Object.values(et).flatMap(u=>(u==null?void 0:u.tokens)||[]),o=Nt(),i=o?As[o.address]:null,r=(i==null?void 0:i.ownerCount)||0,l=La+r*Aa,c=o!=null&&o.createdAt?ng(new Date(o.createdAt)):"\u2014",d=(i==null?void 0:i.sequence)!=null?i.sequence:"\u2014";e.innerHTML=`
    ...
    <div class="pmetric pmetric-reserve" title="${r} owned objects \xD7 ${Aa} XRP + ${La} XRP base">
      ...
      <div class="pmetric-label">Reserved</div></div>`:""}`,o&&(!As[o.address]||Date.now()-As[o.address].fetchedAt>6e4)&&tg(o.address).then(()=>Fs())}async function tg(e){try{let t=await ot({method:"account_info",params:[{account:e,ledger_index:"validated"}]});t!=null&&t.account_data&&(As[e]={sequence:t.account_data.Sequence,ownerCount:t.account_data.OwnerCount||0,fetchedAt:Date.now()})}catch{}}function ng(e){let t=Math.floor((Date.now()-e.getTime())/864e5);if(t<1)return"Today";if(t<30)return`${t}d`;if(t<365)return`${Math.floor(t/30)}mo`;let n=Math.floor(t/365),s=Math.floor(t%365/30);return s?`${n}y ${s}mo`:`${n}y`}function Hd(){var t;if(Array.isArray((t=window.__dashSeries)==null?void 0:t.marketPrice)){let n=window.__dashSeries.marketPrice.at(-1);if(n!=null&&Number.isFinite(n))return n}let e=document.getElementById("mkt-price");if(e){let n=parseFloat(e.textContent.replace("$",""));if(!isNaN(n))return n}return 0}function sg(){let e=oe.length>0,t=Object.values(Ye).some(Boolean),n=!!ce.bio,s=!!localStorage.getItem("naluxrp_last_backup_ts"),a=[e,t,n,s].filter(Boolean).length;return a===4?"":`
  ...
  </div>`}function $i(){let e=x("profile-tab-social");if(!e)return;let t=Object.values(Ye).filter(Boolean).length;e.innerHTML=`
    ...
    </div>`:""}`,Ra("stat-socials-val",t)}function zd(e){let t=os.find(l=>l.id===e);if(!t)return;let n=x("social-modal");if(!n)return;let s=x("social-modal-icon"),a=x("social-modal-title"),o=x("social-modal-sub"),i=x("social-modal-input"),r=x("social-modal-delete");s&&(s.className=`social-platform-icon-lg social-icon ${t.id}`,s.textContent=t.icon),a&&(a.textContent=`Connect ${t.label}`),o&&(o.textContent=`Enter your ${t.label} ${t.id==="discord"?"user ID or username":"username"}.`),i&&(i.value=Ye[e]||"",i.placeholder=`Your ${t.label} handle`),r&&(r.style.display=Ye[e]?"":"none"),n.dataset.platform=e,n.classList.add("show"),setTimeout(()=>i==null?void 0:i.focus(),80)}function jd(){let e=x("social-modal"),t=e==null?void 0:e.dataset.platform,n=x("social-modal-input");if(!t||!n)return;let s=n.value.trim().replace(/^@/,"");s?Ye[t]=s:delete Ye[t],rc(),$i(),rs();let a=os.find(o=>o.id===t);Ig(),kt("social_connected",`${(a==null?void 0:a.label)||t} @${s||"(removed)"}`),ne(`${a==null?void 0:a.label} updated`)}function Wd(){var t;let e=(t=x("social-modal"))==null?void 0:t.dataset.platform;e&&(delete Ye[e],rc(),$i(),rs(),kt("social_removed",e),ne("Social connection removed"))}function qd(e){let t=os.find(n=>n.id===e);t&&Ye[e]&&window.open(`${t.prefix}${Ye[e]}`,"_blank","noopener")}function rs(){var e;(e=x("social-modal"))==null||e.classList.remove("show")}function $t(){let e=x("profile-tab-wallets");if(!e)return;if(oe.length===0){e.innerHTML=sg()+`
    ...
    </div>`:"",n=oe.filter(a=>!ns||a.label.toLowerCase().includes(ns.toLowerCase())||a.address.toLowerCase().includes(ns.toLowerCase())),s=n.map((a,o)=>ag(a,oe.indexOf(a))).join("");e.innerHTML=t+(n.length?s:`<div class="wcard-empty">No wallets match "${y(ns)}"</div>`)+`
    ...
    </div>`,Ra("stat-wallets-val",oe.length)}function ag(e,t){let n=e.id===pt,s=!!e.watchOnly,a=et[e.address],o=As[e.address],r=!0||s,l=(o==null?void 0:o.ownerCount)||0,c=La+l*Aa,d=r?a?_(a.xrp,2):"\u2014":"\u2022\u2022\u2022\u2022",u=a&&r?Math.max(0,a.xrp-c):null,p=(a==null?void 0:a.tokens)||[],m=a!=null&&a.fetchedAt?lc(a.fetchedAt):null,f=e.address.slice(0,8)+"\u2026"+e.address.slice(-6),g=Ti(e.address);return`
  <div class="wcard ${n?"wcard--active":""} ${s?"wcard--watch":""}" id="wallet-item-${e.id}" style="--i:${t}">
    <div class="wcard-top">
      ...
      <div class="wcard-balance-col">
        ${g.length>=2?`<div class="wcard-sparkline">${Qd(g,70,22,e.color||"#00fff0")}</div>`:""}
    ...
    ${p.length&&r?`<div class="wcard-token-row">
      ${p.slice(0,6).map(b=>{let h=b.currency.length>4?Ei(b.currency)||b.currency.slice(0,4)+"\u2026":b.currency;return`<div class="wcard-token-chip" onclick="openTokenDetailsModal('${y(b.currency)}','${y(b.issuer)}','${y(e.address)}')" title="${y(b.currency)}">
    ...
    <div class="wcard-actions">
      ...
      <button class="wcard-btn wcard-btn--expand ${Dn===e.id?"wcard-btn--expand-open":""}" onclick="toggleWalletDrawer('${e.id}')">${Dn===e.id?"\u25B2 Hide":"\u25BC Details"}</button>
    ...
    <div class="wcard-drawer" id="wcard-drawer-${e.id}">
      <div class="wcard-drawer-tabs">
        <button class="wdt-btn ${(un[e.id]||"txns")==="txns"?"active":""}" onclick="switchWalletDrawerTab('${e.id}','txns')">\u{1F4CB} Transactions</button>
        <button class="wdt-btn ${(un[e.id]||"txns")==="nfts"?"active":""}" onclick="switchWalletDrawerTab('${e.id}','nfts')">\u{1F3A8} NFTs</button>
        <button class="wdt-btn ${(un[e.id]||"txns")==="orders"?"active":""}" onclick="switchWalletDrawerTab('${e.id}','orders')">\u{1F4CA} DEX</button>
        <button class="wdt-btn ${(un[e.id]||"txns")==="amm"?"active":""}" onclick="switchWalletDrawerTab('${e.id}','amm')">\u{1F30A} AMM</button>
      </div>
      <div class="wcard-drawer-body" id="wcard-drawer-body-${e.id}">
        <div class="wdd-loading"><div class="spinner"></div> Loading\u2026</div>
      </div>
    </div>`:""}
  </div>`}function Ud(e){var n;let t=oe[e];t&&(oe.splice(e,1),Ds(),pt===t.id&&(pt=((n=oe[0])==null?void 0:n.id)||null,pt&&Z(Rs,pt)),$t(),Bt(),kt("wallet_removed",t.label),og(`Wallet "${t.label}" removed`,()=>{oe.splice(e,0,t),Ds(),pt||(pt=t.id,Z(Rs,t.id)),$t(),Bt(),kt("wallet_created",t.label+" (restored)")},()=>{t.address&&bt(di+t.address)}))}function og(e,t,n){let s=document.getElementById("undo-toast");s&&s.remove();let a=document.createElement("div");a.id="undo-toast",a.className="undo-toast",a.innerHTML=`<span class="undo-msg">${y(e)}</span><button class="undo-btn">Undo</button>`,document.body.appendChild(a),requestAnimationFrame(()=>a.classList.add("show"));let o=setTimeout(()=>{a.classList.remove("show"),setTimeout(()=>a.remove(),300),n==null||n()},5e3);a.querySelector(".undo-btn").addEventListener("click",()=>{clearTimeout(o),t(),a.classList.remove("show"),setTimeout(()=>a.remove(),300),ne("Wallet restored")})}function Vd(e){var n,s;let t=x("inspect-addr");t&&(t.value=e),(n=window.switchTab)==null||n.call(window,document.querySelector('[data-tab="inspector"]'),"inspector"),(s=window.showDashboard)==null||s.call(window)}function Gd(e){Dn=Dn===e?null:e,Dn&&!un[e]&&(un[e]="txns"),$t(),Dn&&setTimeout(()=>Si(e,un[e]),60)}function Kd(e,t){un[e]=t;let n=document.getElementById(`wcard-drawer-${e}`);n&&(n.querySelectorAll(".wdt-btn").forEach(s=>s.classList.toggle("active",s.textContent.toLowerCase().includes(t==="txns"?"trans":t==="nfts"?"nft":t==="orders"?"dex":"amm"))),Si(e,t))}async function Si(e,t){var a,o,i;let n=oe.find(r=>r.id===e),s=document.getElementById(`wcard-drawer-body-${e}`);if(!(!n||!s)){s.innerHTML='<div class="wdd-loading"><div class="spinner"></div> Loading\u2026</div>';try{t==="txns"?s.innerHTML=ig(((a=ui[n.address])==null?void 0:a.txns)||await Ci(n.address),n.address):t==="nfts"?s.innerHTML=rg(((o=Kl[n.address])==null?void 0:o.nfts)||await yg(n.address),n.address):t==="orders"?s.innerHTML=lg(((i=mi[n.address])==null?void 0:i.offers)||await wg(n.address),n.id,n.address):t==="amm"&&(s.innerHTML=await cg(n.address))}catch(r){s.innerHTML=`<div class="wdd-error">\u26A0\uFE0F ${y(r.message)}</div>`}}}function Jd(e){return{Payment:"\u{1F4B8}",OfferCreate:"\u{1F4CA}",OfferCancel:"\u2715",TrustSet:"\u{1F517}",NFTokenMint:"\u{1F3A8}",NFTokenBurn:"\u{1F525}",NFTokenCreateOffer:"\u{1F3AF}",NFTokenAcceptOffer:"\u2705",AMMCreate:"\u{1F30A}",AMMDeposit:"\u{1F4E5}",AMMWithdraw:"\u{1F4E4}",AMMVote:"\u{1F5F3}",AMMBid:"\u{1F4A1}",EscrowCreate:"\u23F3",EscrowFinish:"\u2705",EscrowCancel:"\u2715",AccountSet:"\u2699",SetRegularKey:"\u{1F511}",SignerListSet:"\u{1F4CB}"}[e]||"\u{1F4C4}"}function ci(e){return e?typeof e=="string"?`${_(Number(e)/1e6,4)} XRP`:`${_(parseFloat(e.value||0),4)} ${(e.currency||"?").length>4?e.currency.slice(0,4)+"\u2026":e.currency}`:"\u2014"}function ig(e,t){return e!=null&&e.length?`<div class="wdd-tx-list">
    ${e.slice(0,25).map(n=>{var c,d;let s=n.TransactionType||"?",a=n.Account===t,o=!(((c=n.metaData)==null?void 0:c.TransactionResult)||((d=n.meta)==null?void 0:d.TransactionResult)||"").match(/^tec|^tem|^tef|^tel/),i=n.date?(n.date+946684800)*1e3:0,r=i?new Date(i).toLocaleDateString("en-US",{month:"short",day:"numeric",hour:"2-digit",minute:"2-digit"}):"\u2014",l=n.hash||n.tx_hash||"";return`<div class="wdd-tx-row ${o?"":"wdd-tx-failed"}">
        <div class="wdd-tx-icon">${Jd(s)}</div>
        <div class="wdd-tx-body">
          ...
          <div class="wdd-tx-detail">
            ...
            ${n.Destination?`<span class="wdd-tx-dest mono">${Jl[n.Destination]||n.Destination.slice(0,8)+"\u2026"+n.Destination.slice(-5)}</span>`:""}
          </div>
        </div>
  ...
  </div>`:'<div class="wdd-empty"><div class="wdd-empty-icon">\u{1F4CB}</div><div>No transactions yet.</div><div class="wdd-empty-sub">Fund with 10 XRP to activate.</div></div>'}function rg(e,t){return e!=null&&e.length?`<div class="wdd-nft-header"><span>${e.length} NFT${e.length>1?"s":""}</span>
    ...
    <div class="wdd-nft-grid">
      ${e.slice(0,24).map(n=>{var i;let s=n.nft_serial??((i=n.NFTokenID)==null?void 0:i.slice(-6))??"?",a=n.URI&&Ei(n.URI)||"",o=a.startsWith("ipfs://")?`https://cloudflare-ipfs.com/ipfs/${a.slice(7)}`:"";return`<div class="wdd-nft-card">
    ...
    ${e.length>24?`<div class="wdd-more-note">${e.length-24} more on XRPScan</div>`:""}`:'<div class="wdd-empty"><div class="wdd-empty-icon">\u{1F3A8}</div><div>No NFTs in this wallet.</div></div>'}function lg(e,t,n){return e!=null&&e.length?`<div class="wdd-orders-header"><span>${e.length} open order${e.length>1?"s":""}</span></div>
    ...
    </div>`:'<div class="wdd-empty"><div class="wdd-empty-icon">\u{1F4CA}</div><div>No open DEX orders.</div></div>'}async function cg(e){try{let n=(pi[e]||[]).filter(s=>{var a;return((a=s.currency)==null?void 0:a.length)===40});return n.length?`<div class="wdd-amm-list">
    ...
    <div class="act-section-row">
      <div class="act-section">
        ...
        ${t.length?`<div class="act-timeline">${t.slice(0,20).map(s=>`
            <div class="act-entry">
              <div class="act-entry-icon">${Ef[s.type]||"\u25CF"}</div>
              <div class="act-entry-body">
                <div class="act-entry-detail">${y(s.detail)}</div>
                <div class="act-entry-time">${lc(s.ts)}</div>
              </div>
    ...
    <div class="settings-card settings-card--danger">
  ...
  </div>`}async function pg(){var t;let e=x("profile-tab-analytics");if(e){e.innerHTML='<div class="analytics-grid"><div class="skeleton-card analytics-card--wide" style="height:80px"></div><div class="skeleton-card" style="height:160px"></div><div class="skeleton-card" style="height:160px"></div></div>';try{let n=Nt(),s=Object.values(et).reduce((r,l)=>r+((l==null?void 0:l.xrp)||0),0),a=Hd(),o=Object.values(et).flatMap(r=>(r==null?void 0:r.tokens)||[]),i=[];if(n)try{i=((t=ui[n.address])==null?void 0:t.txns)||await Ci(n.address,100)}catch{}e.innerHTML=`<div class="analytics-grid">
      <div class="analytics-card analytics-card--wide">
        ...
        <div class="portfolio-summary-row">
          ${oe.length?oe.map(r=>{let l=et[r.address],c=l?_(l.xrp,2):"\u2014",d=l&&a?`$${_(l.xrp*a,2)}`:"",u=Ti(r.address);return`<div class="portfolio-wallet-row">
                ...
                <div class="pwr-sparkline">${Qd(u,80,28,r.color||"#00fff0")}</div>
      ...
      <div class="analytics-card analytics-card--wide">
        ...
        ${n?mg(i):'<div class="analytics-empty">Activate a wallet to see activity.</div>'}
      </div>
      ...
      <div class="analytics-card">
        ...
        ${i.length?fg(i):'<div class="analytics-empty-chart"><div class="aec-icon">\u{1F4CA}</div><div>Transaction breakdown builds up as this wallet transacts.</div></div>'}
      </div>
      ...
      <div class="analytics-card">
        ...
        ${n&&i.length?gg(i,n.address):`<div class="analytics-empty-chart"><div class="aec-icon">\u{1F4B0}</div><div>${n?"XRP flow needs at least one transaction to estimate.":"Activate a wallet to see XRP flow."}</div></div>`}
      </div>
      ...
      <div class="analytics-card">
        ...
        ${o.length?hg(o):'<div class="analytics-empty-chart"><div class="aec-icon">\u{1FA99}</div><div>No token trustlines held by any wallet yet.</div></div>'}
      </div>
    </div>`}catch(n){Df(e,"analytics",n)}}}function Qd(e,t,n,s){if(e.length<2)return`<svg width="${t}" height="${n}"><line x1="0" y1="${n/2}" x2="${t}" y2="${n/2}" stroke="${s}" stroke-opacity=".2" stroke-width="1" stroke-dasharray="3 2"/></svg>`;let a=e.map(u=>u.xrp),o=Math.min(...a),i=Math.max(...a),r=i-o||1,l=a.map((u,p)=>`${3+p/(a.length-1)*(t-6)},${3+(1-(u-o)/r)*(n-6)}`),[c,d]=l[l.length-1].split(",");return`<svg width="${t}" height="${n}" viewBox="0 0 ${t} ${n}">
  ...
  </svg>`}function ug(e){let t=Ti(e);if(t.length<2)return`<div class="analytics-empty-chart"><div class="aec-icon">\u{1F4CA}</div><div>Balance history builds up as you refresh your wallet over time.</div><div class="aec-sub">${t.length} snapshot${t.length!==1?"s":""} recorded.</div></div>`;let n=560,s=130,a=52,o=12,i=14,r=30,l=t.map(R=>R.xrp),c=t.map(R=>R.ts),d=Math.min(...l),u=Math.max(...l),p=u-d||1,m=c[0],f=c[c.length-1],g=f-m||1,b=R=>a+(R-m)/g*(n-a-o),h=R=>i+(1-(R-d)/p)*(s-i-r),v=t.map(R=>`${b(R.ts).toFixed(1)},${h(R.xrp).toFixed(1)}`),w=b(c[0]),k=b(c[c.length-1]),$=l[l.length-1]-l[0],T=$>=0,S=l[0]?Math.abs($/l[0]*100).toFixed(2):"0.00",N=T?"#00d4ff":"#ff5555",P=[d,(d+u)/2,u].map(R=>({v:R,y:h(R),l:_(R,2)})),C=[0,.5,1].map(R=>({x:a+R*(n-a-o),l:new Date(m+R*g).toLocaleDateString("en-US",{month:"short",day:"numeric"})}));return`
  ...
  </svg></div>`}function fg(e){let t=new Map;e.forEach(a=>t.set(a.TransactionType||"?",(t.get(a.TransactionType||"?")||0)+1));let n=[...t.entries()].sort((a,o)=>o[1]-a[1]),s=e.length;return`<div class="tx-breakdown-list">${n.slice(0,8).map(([a,o])=>`<div class="txb-row"><div class="txb-icon">${Jd(a)}</div><div class="txb-type">${a}</div><div class="txb-bar-wrap"><div class="txb-bar" style="width:${(o/s*100).toFixed(0)}%"></div></div><div class="txb-count">${o}</div></div>`).join("")}</div>`}function hg(e){let t=new Map;e.forEach(o=>{let i=Math.abs(parseFloat(o.balance||0));t.set(o.currency,(t.get(o.currency)||0)+i)});let n=[...t.entries()].sort((o,i)=>i[1]-o[1]).slice(0,8),s=n.reduce((o,[,i])=>o+i,0)||1,a=["#00fff0","#00d4ff","#bd93f9","#50fa7b","#ffb86c","#ff79c6","#f1fa8c","#ff5555"];return`<div class="token-alloc-list">${n.map(([o,i],r)=>{let l=(i/s*100).toFixed(1),c=a[r%a.length],d=o.length>4?o.slice(0,4)+"\u2026":o;return`<div class="ta-row"><div class="ta-swatch" style="background:${c}"></div><div class="ta-cur mono">${d}</div><div class="ta-bar-wrap"><div class="ta-bar" style="width:${l}%;background:${c}20;border-color:${c}55"></div></div><div class="ta-pct">${l}%</div></div>`}).join("")}</div>`}function gg(e,t){let n=0,s=0;e.forEach(i=>{var c,d;if(i.TransactionType!=="Payment"||!((((c=i.metaData)==null?void 0:c.TransactionResult)||((d=i.meta)==null?void 0:d.TransactionResult))==="tesSUCCESS")||typeof i.Amount!="string")return;let l=Number(i.Amount)/1e6;i.Destination===t&&(n+=l),i.Account===t&&(s+=l)});let a=n-s,o=a>=0;return`<div class="xrp-flow-grid">
  ...
  <div class="xrf-note">Based on ${e.length} fetched Payment TXs. Excludes fees and DEX fills.</div>`}async function ot(e){var n,s;try{if(((n=X.wsConn)==null?void 0:n.readyState)===1){let{wsSend:a}=await import("./xrpl-6AERZ5KD.js"),o={command:e==null?void 0:e.method,...((s=e==null?void 0:e.params)==null?void 0:s[0])||{}},i=await a(o);if((i==null?void 0:i.status)==="error")throw new Error(i.error_message||i.error||"XRPL RPC error");return(i==null?void 0:i.result)||null}}catch{}let t=async a=>{let o=await fetch(a,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(e),mode:"cors"});if(!o.ok)throw new Error(`HTTP ${o.status}`);return(await o.json()).result};try{return await t(lf)}catch{return await t(cf)}}async function Bn(e){var t;try{let n=[],s;do{let l=await ot({method:"account_lines",params:[{account:e,ledger_index:"current",limit:400,...s?{marker:s}:{}}]});if(!l||l.error)break;n.push(...l.lines||[]),s=l.marker}while(s);let a=await ot({method:"account_info",params:[{account:e,ledger_index:"current"}]});if(a!=null&&a.error)return null;let o=Number(a.account_data.Balance)/1e6,i=n.map(l=>({currency:l.currency,issuer:l.account,balance:l.balance,limit:l.limit}));et[e]={xrp:o,tokens:i,fetchedAt:Date.now()},pi[e]=i,vg(e,o);let r=document.getElementById("awb-balance");return r&&e===((t=Nt())==null?void 0:t.address)&&Fg(r.querySelector(".awb-xrp-num")||r,o,2,600),et[e]}catch{return null}}async function bg(){await Promise.allSettled(oe.map(e=>Bn(e.address))),$t(),Bt(),Fs()}function vg(e,t){let n=di+e,s=ge(Q(n))||[],a=Date.now();s.length&&a-s[s.length-1].ts<5*6e4?s[s.length-1]={xrp:t,ts:a}:s.push({xrp:t,ts:a}),s.length>90&&s.splice(0,s.length-90),Z(n,JSON.stringify(s))}function Ti(e){return ge(Q(di+e))||[]}async function Ci(e,t=25){let n=await ot({method:"account_tx",params:[{account:e,limit:t,ledger_index_min:-1,ledger_index_max:-1}]}),s=((n==null?void 0:n.transactions)||[]).map(a=>a.tx||a.transaction||a);return ui[e]={txns:s,fetchedAt:Date.now()},s}async function yg(e){let t=await ot({method:"account_nfts",params:[{account:e,limit:50}]}),n=(t==null?void 0:t.account_nfts)||[];return Kl[e]={nfts:n,fetchedAt:Date.now()},n}async function wg(e){let t=await ot({method:"account_offers",params:[{account:e,limit:50}]}),n=(t==null?void 0:t.offers)||[];return mi[e]={offers:n,fetchedAt:Date.now()},n}async function xg(e){let t=await ot({method:"account_info",params:[{account:e,ledger_index:"current"}]});return(t==null?void 0:t.account_data)||null}async function kg(){let e=await ot({method:"ledger",params:[{ledger_index:"current"}]});return(e==null?void 0:e.ledger_current_index)||0}function $g(e){let t=(e==null?void 0:e.engine_result)||"";return t==="tesSUCCESS"||t.startsWith("tes")||(e==null?void 0:e.engine_result_code)===0}function Sg(e){let t=(e==null?void 0:e.engine_result)||"";return yf[t]||(e==null?void 0:e.engine_result_message)||t||"Unknown error"}async function Tg(e,t,n){if(await _a(),!window.xrpl)throw new Error("xrpl.js library not loaded. Cannot sign transactions.");let s=oe.find(i=>i.id===e);if(!s)throw new Error("Wallet not found.");if(s.watchOnly)throw new Error("Watch-only wallets cannot sign transactions.");let a=await kf(s,n),o;try{o=window.xrpl.Wallet.fromSeed(a,{algorithm:s.algo==="secp256k1"?"secp256k1":"ed25519"})}catch(i){throw new Error("Invalid seed phrase: "+i.message)}if(o.classicAddress!==s.address)throw new Error("Seed does not match this wallet address.");try{let[i,r]=await Promise.all([xg(s.address),kg()]);if(!i)throw new Error("Account not found on-chain. Fund with at least 10 XRP first (base reserve requirement).");let l={...t,Account:s.address,Fee:"12",Sequence:i.Sequence,LastLedgerSequence:r+20},{tx_blob:c,hash:d}=o.sign(l);return{...await ot({method:"submit",params:[{tx_blob:c}]}),tx_hash:d}}finally{}}async function Cg(e,t,n){return Tg(e,{TransactionType:"OfferCancel",OfferSequence:parseInt(t)},n)}function Pg(){if(x("send-modal-overlay"))return;let e=document.createElement("div");e.innerHTML=`
  <!-- Send -->
  ...
  <div class="generic-modal-overlay" id="token-details-modal">
  ...
  </div>`,document.body.appendChild(e),["send-modal-overlay","receive-modal-overlay","trustline-modal-overlay","import-address-modal","import-seed-modal","token-details-modal"].forEach(t=>{let n=document.getElementById(t);n==null||n.addEventListener("click",s=>{s.target===n&&(n.classList.remove("show"),n.style.display="")})})}function Zd(){var o;["displayName","handle","bio","location","website"].forEach(i=>{let r=x(`edit-${i}`);r&&(r.value=ce[i]||"")});let e=x("editor-avatar-preview");if(e){let i=localStorage.getItem(mn);e.innerHTML=i?`<img src="${i}" class="profile-avatar-img"/>`:ce.avatar||"\u{1F30A}"}let t=x("avatar-remove-btn");t&&(t.style.display=localStorage.getItem(mn)?"":"none");let n=x("editor-banner-preview");if(n){let i=localStorage.getItem(Fn);n.style.backgroundImage=i?`url(${i})`:"",n.style.backgroundSize="cover",n.style.backgroundPosition="center",_s.forEach(r=>n.classList.remove(r)),i||n.classList.add(ce.banner||"banner-ocean")}let s=x("avatar-picker-grid");s&&(s.innerHTML=gf.map(i=>`<div class="avatar-option ${ce.avatar===i?"active":""}" onclick="selectAvatar('${i}')">${i}</div>`).join(""));let a=x("banner-picker-grid");a&&(a.innerHTML=_s.map(i=>`<div class="banner-option ${i} ${ce.banner===i?"active":""}" onclick="selectBanner('${i}')"></div>`).join("")),(o=x("profile-editor-modal"))==null||o.classList.add("show")}function Hs(){var e;(e=x("profile-editor-modal"))==null||e.classList.remove("show")}function ep(){var e,t,n,s,a;ce.displayName=((e=x("edit-displayName"))==null?void 0:e.value.trim())||ce.displayName,ce.handle=(((t=x("edit-handle"))==null?void 0:t.value.trim())||ce.handle).replace(/^@/,"").replace(/\s+/g,"_").toLowerCase(),ce.bio=((n=x("edit-bio"))==null?void 0:n.value.trim())||"",ce.location=((s=x("edit-location"))==null?void 0:s.value.trim())||"",ce.website=((a=x("edit-website"))==null?void 0:a.value.trim())||"",ic(),kt("profile_saved","Profile details updated"),q(),Hs(),ne("Profile saved")}function tp(e){localStorage.removeItem(mn),ce.avatar=e,Xe(".avatar-option").forEach(s=>s.classList.toggle("active",s.textContent===e));let t=x("editor-avatar-preview");t&&(t.innerHTML=e);let n=x("avatar-remove-btn");n&&(n.style.display="none")}function np(e){localStorage.removeItem(Fn),ce.banner=e,Xe(".banner-option").forEach(n=>n.classList.toggle("active",n.classList.contains(e)));let t=x("editor-banner-preview");t&&(t.style.backgroundImage="",_s.forEach(n=>t.classList.remove(n)),t.classList.add(e)),q()}function sp(e){var s;let t=(s=e==null?void 0:e.files)==null?void 0:s[0];if(!t)return;if(t.size>2*1024*1024){he("Image too large \u2014 max 2 MB");return}let n=new FileReader;n.onload=a=>{let o=new Image;o.onload=()=>{let i=document.createElement("canvas");i.width=i.height=200;let r=i.getContext("2d"),l=Math.min(o.width,o.height);r.drawImage(o,(o.width-l)/2,(o.height-l)/2,l,l,0,0,200,200);let c=i.toDataURL("image/jpeg",.85);localStorage.setItem(mn,c);let d=x("editor-avatar-preview");d&&(d.innerHTML=`<img src="${c}" class="profile-avatar-img"/>`);let u=x("avatar-remove-btn");u&&(u.style.display=""),q(),ne("Profile photo updated")},o.src=a.target.result},n.readAsDataURL(t),e.value=""}function ap(){localStorage.removeItem(mn);let e=x("editor-avatar-preview");e&&(e.innerHTML=ce.avatar||"\u{1F30A}");let t=x("avatar-remove-btn");t&&(t.style.display="none"),q()}function op(e){var s;let t=(s=e==null?void 0:e.files)==null?void 0:s[0];if(!t)return;if(t.size>5*1024*1024){he("Image too large \u2014 max 5 MB");return}let n=new FileReader;n.onload=a=>{let o=new Image;o.onload=()=>{let i=document.createElement("canvas");i.width=900,i.height=180;let r=i.getContext("2d"),l=Math.max(900/o.width,180/o.height);r.drawImage(o,(900-o.width*l)/2,(180-o.height*l)/2,o.width*l,o.height*l);let c=i.toDataURL("image/jpeg",.88);localStorage.setItem(Fn,c);let d=x("editor-banner-preview");d&&(d.style.backgroundImage=`url(${c})`,d.style.backgroundSize="cover",d.style.backgroundPosition="center",_s.forEach(p=>d.classList.remove(p)));let u=x("banner-remove-btn");u&&(u.style.display=""),q(),ne("Banner updated")},o.src=a.target.result},n.readAsDataURL(t),e.value=""}function ip(){localStorage.removeItem(Fn);let e=x("editor-banner-preview");e&&(e.style.backgroundImage="",_s.forEach(n=>e.classList.remove(n)),e.classList.add(ce.banner||"banner-ocean"));let t=x("banner-remove-btn");t&&(t.style.display="none"),q()}function Mg(){let e=oe.map(({id:n,label:s,address:a,algo:o,emoji:i,color:r,testnet:l,watchOnly:c,createdAt:d})=>({id:n,label:s,address:a,algo:o,emoji:i,color:r,testnet:l,watchOnly:c,createdAt:d})),t=document.createElement("a");t.href="data:application/json;charset=utf-8,"+encodeURIComponent(JSON.stringify(e,null,2)),t.download=`nalulf-wallets-${new Date().toISOString().slice(0,10)}.json`,t.click(),kt("backup_exported","Wallet addresses exported"),ne("Wallet addresses exported")}function rp(){Mg()}function Pi(){var e;wt=1,ve={algo:"ed25519",label:"",emoji:"\u{1F48E}",color:"#50fa7b",seed:"",address:"",passphrase:""},In.clear(),Mi(1),Ag(),Lg(),(e=x("wallet-creator-overlay"))==null||e.classList.add("show"),setTimeout(()=>{var t;return(t=x("wallet-label-input"))==null?void 0:t.focus()},80)}function zs(){var e;(e=x("wallet-creator-overlay"))==null||e.classList.remove("show"),ve.seed=ve.address=ve.passphrase=""}function Lg(){let e=x("wizard-security-banner");e&&(e.innerHTML=`<div class="wsb-icon">\u{1F510}</div>
    ...
    </div>`).join("")}async function Rg(){var n;let e=await Gl(ve.seed,ve.passphrase),t={id:crypto.randomUUID(),label:ve.label,address:ve.address,algo:ve.algo,emoji:ve.emoji,color:ve.color,testnet:((n=x("wallet-testnet-check"))==null?void 0:n.checked)||!1,watchOnly:!1,encSeed:e,createdAt:new Date().toISOString()};oe.push(t),Ds(),pt||(pt=t.id,Z(Rs,t.id)),$t(),Bt(),Ra("wallet-success-address",ve.address),setTimeout(()=>{ve.seed="",ve.address="",ve.passphrase=""},100),kt("wallet_created",ve.label||"New XRPL Wallet"),ne("Wallet created and encrypted locally"),Bn(t.address).then(()=>$t())}function dp(e){ve.algo=e,Xe(".algo-card").forEach(t=>t.classList.toggle("active",t.dataset.algo===e))}function pp(e){ve.emoji=e,Xe(".wallet-emoji-opt").forEach(t=>t.classList.toggle("active",t.textContent===e))}function up(e){ve.color=e,Xe(".color-swatch").forEach(t=>t.classList.toggle("active",t.style.background===e||t.dataset.color===e))}function mp(e){let t=document.querySelector(`.security-check-${e}`);if(!t)return;let n=t.querySelector(".check-box");In.has(e)?(In.delete(e),t.classList.remove("checked"),n&&(n.textContent="")):(In.add(e),t.classList.add("checked"),n&&(n.textContent="\u2713")),fp()}function fp(){let e=x("wizard-next-btn");e&&wt===2&&(e.disabled=In.size<4)}function hp(){var t;(t=x("wizard-seed-value"))==null||t.classList.remove("blur");let e=x("seed-reveal-hint");e&&(e.style.display="none"),setTimeout(()=>{var n;return(n=x("wizard-seed-value"))==null?void 0:n.classList.add("blur")},3e4)}function gp(){let e=x("wizard-seed-value");if(!e)return;Ha(e.textContent,3e4);let t=x("btn-copy-seed");t&&(t.textContent="Copied!",t.classList.add("copied"),setTimeout(()=>{t.textContent="Copy Seed",t.classList.remove("copied")},2e3))}function bp(){let e=x("wizard-address-value")||x("wallet-success-address");if(!e)return;Ha(e.textContent);let t=x("btn-copy-addr");t&&(t.textContent="Copied!",t.classList.add("copied"),setTimeout(()=>{t.textContent="Copy",t.classList.remove("copied")},2e3))}function vp(){let e=x("import-address-modal");if(!e)return;e.querySelector("#inp-import-address").value="",e.querySelector("#inp-import-label").value="";let t=e.querySelector("#import-address-error");t&&(t.textContent=""),e.classList.add("show"),setTimeout(()=>{var n;return(n=e.querySelector("#inp-import-address"))==null?void 0:n.focus()},80)}function Li(){var e;(e=x("import-address-modal"))==null||e.classList.remove("show")}function yp(){var s,a;let e=(((s=x("inp-import-address"))==null?void 0:s.value)||"").trim(),t=(((a=x("inp-import-label"))==null?void 0:a.value)||"").trim()||"Watch Wallet",n=x("import-address-error");if(!He(e)){n&&(n.textContent="Enter a valid XRPL address (starts with r\u2026)");return}if(oe.find(o=>o.address===e)){n&&(n.textContent="This address is already in your list.");return}oe.push({id:"watch_"+Date.now(),label:t,address:e,algo:"\u2014",emoji:"\u{1F441}",color:"#8be9fd",testnet:!1,createdAt:new Date().toISOString(),watchOnly:!0}),Ds(),kt("watch_added",`${t} (${e.slice(0,8)}\u2026)`),Li(),$t(),Bt(),Fs(),Bn(e).then(()=>{$t(),Fs()}),ne(`\u{1F441} Watch-only wallet added: ${t}`)}function wp(){let e=x("import-seed-modal");if(!e)return;e.querySelector("#inp-import-seed").value="",e.querySelector("#inp-import-seed-pass").value="",e.querySelector("#inp-import-seed-pass-confirm").value="",e.querySelector("#inp-import-seed-label").value="";let t=e.querySelector("#import-seed-error");t&&(t.textContent=""),e.classList.add("show"),setTimeout(()=>{var n;return(n=e.querySelector("#inp-import-seed"))==null?void 0:n.focus()},80)}function Ai(){var e;(e=x("import-seed-modal"))==null||e.classList.remove("show")}async function xp(){var r,l,c,d,u;let e=(((r=x("inp-import-seed"))==null?void 0:r.value)||"").trim(),t=(((l=x("inp-import-seed-label"))==null?void 0:l.value)||"").trim()||"Imported Wallet",n=(((c=x("inp-import-seed-pass"))==null?void 0:c.value)||"").trim(),s=(((d=x("inp-import-seed-pass-confirm"))==null?void 0:d.value)||"").trim(),a=x("import-seed-error"),o=x("import-seed-btn"),i=p=>{a&&(a.textContent=p)};if(i(""),!e)return i("Enter your seed phrase.");if(n.length<10)return i("Use a wallet password with at least 10 characters.");if(n!==s)return i("Wallet password confirmation does not match.");if(await _a(),!window.xrpl)return i("xrpl.js not loaded \u2014 cannot derive address from seed.");o&&(o.disabled=!0,o.textContent="Importing\u2026");try{let p=window.xrpl.Wallet.fromSeed(e),m=p.address,f=(u=p.algorithm)!=null&&u.toLowerCase().includes("ed")?"ed25519":"secp256k1";if(oe.find(w=>w.address===m))return i("This address is already in your vault.");let g="imp_"+Date.now(),b="\u{1F511}",h="#bd93f9",v=await Gl(e,n);oe.push({id:g,label:t,address:m,algo:f,emoji:b,color:h,testnet:!1,watchOnly:!1,encSeed:v,createdAt:new Date().toISOString()}),Ds(),kt("wallet_imported",`${t} (${m.slice(0,8)}\u2026)`),Ai(),$t(),Bt(),Bn(m).then(()=>{$t(),Fs()}),ne(`\u{1F511} Wallet imported: ${t}`)}catch(p){i("Invalid seed: "+(p.message||"Could not derive wallet."))}finally{o&&(o.disabled=!1,o.textContent="Import Wallet \u2192");let p=document.getElementById("inp-import-seed");p&&(p.value="");let m=document.getElementById("inp-import-seed-pass");m&&(m.value="");let f=document.getElementById("inp-import-seed-pass-confirm");f&&(f.value="")}}function kp(e,t,n){var d;let s=x("token-details-modal");if(!s)return;let a=s.querySelector(".generic-modal");if(!a)return;let o=et[n],i=(d=o==null?void 0:o.tokens)==null?void 0:d.find(u=>u.currency===e&&u.issuer===t),r=i?_(parseFloat(i.balance||0),6):"\u2014",l=i!=null&&i.limit?_(parseFloat(i.limit),2):"Unlimited",c=e.length>4&&Ei(e)||e;a.innerHTML=`
    <div class="tdm-hdr">
    ...
    </div>`,s.classList.add("show")}function $p(){let e=x("token-details-modal");e&&(e.classList.remove("show"),e.style.display="")}function Sp(){var s;(s=document.getElementById("pub-profile-overlay"))==null||s.remove();let e=localStorage.getItem(mn),t=os.filter(a=>Ye[a.id]),n=document.createElement("div");n.id="pub-profile-overlay",n.className="pub-profile-overlay",n.innerHTML=`
    <div class="pub-profile-modal">
      <div class="pub-banner ${ce.banner||"banner-ocean"}" ${localStorage.getItem(Fn)?`style="background-image:url(${localStorage.getItem(Fn)});background-size:cover;background-position:center;"`:""}>
      </div>
      <div class="pub-hdr">
    ...
    </div>`,document.body.appendChild(n),requestAnimationFrame(()=>requestAnimationFrame(()=>n.classList.add("show"))),n.addEventListener("click",a=>{a.target===n&&n.remove()})}function Tp(e){Mn(e),Xs(),kt("theme_changed",e)}function Cp(e){Z("nalulf_pref_currency",e),Xs(),ne(`Display currency: ${e}`)}function Pp(e){Z("nalulf_pref_network",e),Xs(),ne(`Default network: ${e}`)}function Mp(e){Z("nalulf_pref_autolock",e),Xs(),ne(`Auto-lock: ${e} minutes`)}window._profileWipeAllData=()=>{confirm("Clear all profile, wallet list, social, and activity data? Encrypted wallet seeds saved on this device will be deleted.")&&(["nalulf_profile","nalulf_wallets","nalulf_social","nalulf_activity_log","nalulf_avatar_img","nalulf_banner_img","naluxrp_active_wallet"].forEach(e=>localStorage.removeItem(e)),oe=[],Ye={},pt=null,et={},pi={},ni(),q(),gi("wallets"),ne("Local data cleared"))};function _g(){var e,t,n;(e=x("profile-editor-modal"))==null||e.addEventListener("click",s=>{s.target===s.currentTarget&&Hs()}),(t=x("wallet-creator-overlay"))==null||t.addEventListener("click",s=>{s.target===s.currentTarget&&zs()}),(n=x("social-modal"))==null||n.addEventListener("click",s=>{s.target===s.currentTarget&&rs()})}function Dg(){let e=[{done:!!ce.displayName&&ce.displayName!=="Anonymous",label:"Display name"},{done:!!ce.bio,label:"Bio"},{done:ce.avatar!=="\u{1F30A}"||!!localStorage.getItem(mn),label:"Custom avatar"},{done:!!localStorage.getItem(Fn),label:"Custom banner"},{done:oe.length>0,label:"Wallet added"},{done:Object.keys(Ye).length>=1,label:"Social connected"},{done:!!ce.location,label:"Location set"},{done:!!ce.website,label:"Website added"}],t=e.filter(n=>n.done).length;return{pct:Math.round(t/e.length*100),done:t,total:e.length,checks:e}}function Ig(){let e=document.getElementById("profile-completeness");if(!e)return;let{pct:t,checks:n}=Dg(),s=t===100?"#50fa7b":t>=60?"#00fff0":"#ffb86c",a=2*Math.PI*16,o=t/100*a,i=n.filter(r=>!r.done).map(r=>r.label);e.title=t===100?"Profile complete \u2713":`${t}% \u2014 Missing: ${i.join(", ")}`,e.innerHTML=`
    <div class="pc-wrap">
  ...
  `,document.body.appendChild(e);let t=()=>{e.style.display="none",e.removeAttribute("data-addr"),document.body.classList.remove("modal-open"),Gs=!1,_t=!1};e.addEventListener("click",a=>{a.target===e&&t()}),(n=x("acctPeekClose"))==null||n.addEventListener("click",t),(s=x("acctPeekInspect"))==null||s.addEventListener("click",async()=>{let a=e.getAttribute("data-addr");a&&await ab(a),t()})}function tb(){qp||(qp=!0,document.addEventListener("click",e=>{var s,a;let t=(a=(s=e.target).closest)==null?void 0:a.call(s,"[data-addr]");if(!t)return;let n=t.getAttribute("data-addr");n&&(e.preventDefault(),sb(n))}))}function tu(e){var r,l,c;if(!e||!((r=Re==null?void 0:Re.window)!=null&&r.length))return null;let t=0,n=0,s=0;for(let d of Re.window)s+=Number(d.total||0),t+=Number(((l=d.byActorCreate)==null?void 0:l.get(e))||0),n+=Number(((c=d.byActorCancel)==null?void 0:c.get(e))||0);let a=t+n;if(!a)return null;let o=a?n/a:0,i=s?a/s:null;return{create:t,cancel:n,total:a,cancelRatio:o,share:i}}function nb(e){var o;let t=(o=Rt==null?void 0:Rt.acct)==null?void 0:o.get(e);if(!t||!t.intervals||t.intervals.length<6)return null;let n=vn(t.intervals),s=Ui(t.intervals);return!n||s==null?null:{cv:s/n,total:t.total||0}}async function sb(e){var i,r,l;if(!He(e))return;let t=document.getElementById("acctPeekOverlay");if(!t)return;t.style.display="flex",t.setAttribute("data-addr",e),document.body.classList.add("modal-open"),Gs=!0,_t=!0,V("acctPeekAddr",e),V("acctPeekBal","\u2026"),V("acctPeekSeq","\u2026"),V("acctPeekOwner","\u2026"),V("acctPeekFlags","\u2026");let n=x("acctPeekNote"),s=x("acctPeekCtx");n&&(n.textContent="Fetching account_info\u2026"),s&&(s.textContent="Building context\u2026");let a=Rt.acct.get(e),o=((i=a==null?void 0:a.ledgers)==null?void 0:i.length)||0;try{if(!X.wsConn||X.wsConn.readyState!==1){n&&(n.textContent="Not connected to XRPL. Connect first.");return}let c=await Ee({command:"account_info",account:e,ledger_index:"validated",strict:!0}),d=(r=c==null?void 0:c.result)==null?void 0:r.account_data,u=Number((d==null?void 0:d.Balance)??NaN),p=Number.isFinite(u)?u/1e6:null;if(V("acctPeekBal",p==null?"\u2014":`${p.toLocaleString(void 0,{maximumFractionDigits:6})} XRP`),V("acctPeekSeq",(d==null?void 0:d.Sequence)??"\u2014"),V("acctPeekOwner",(d==null?void 0:d.OwnerCount)??"\u2014"),V("acctPeekFlags",(d==null?void 0:d.Flags)!=null?`0x${Number(d.Flags).toString(16)}`:"\u2014"),n){let m=[];p!=null&&p>=Hg&&m.push("Large balance (whale-sized).");let f=nb(e);f&&f.cv<.35&&f.total>10&&m.push(`Bot-like timing signal (CV ${f.cv.toFixed(2)}).`);let g=tu(e);if(g){let h=Math.round(g.cancelRatio*100),v=g.share!=null?Math.round(g.share*100):null;m.push(`DEX activity: ${g.total} offer tx in window.`),m.push(`Creates ${g.create}, cancels ${g.cancel} (${h}% cancels).`),v!=null&&m.push(`~${v}% of window activity.`)}let b=ie.byAddr.get(e);if(b){let h=Ks(b.level);m.push(`Spam-defense: score ${(b.score*100).toFixed(0)}% \xB7 level L${b.level} \xB7 bond ${h.toLocaleString()} XRP.`),b.verifiedLedger!=null&&m.push(`Credential verified at ledger #${Number(b.verifiedLedger).toLocaleString()}.`)}o>=6&&m.push(`Shows up often in recent ledgers (${o} times).`),m.length||m.push("No obvious red flags from this quick read."),n.textContent=m.join(" ")}if(s){let m=(l=a==null?void 0:a.ledgers)==null?void 0:l.at(-1),f=tu(e),g=f?`DEX window: ${f.total} (creates ${f.create}, cancels ${f.cancel})`:null,b=Dt.filter(k=>k.from===e||k.to===e).slice(0,3),h=b.length?`${b.length} whale tx in session (${b.map(k=>(k.amtXrp>=1e6?(k.amtXrp/1e6).toFixed(1)+"M":(k.amtXrp/1e3).toFixed(0)+"K")+" XRP").join(", ")})`:null,v=ie.byAddr.get(e),w=v?`Spam-defense: L${v.level} \xB7 score ${Math.round(v.score*100)}%`:null;s.textContent=[m?`Last seen around ledger #${Number(m).toLocaleString()}`:"Not in recent window.",g,h,w].filter(Boolean).join(" \xB7 ")}}catch(c){n&&(n.textContent=`Lookup failed: ${String((c==null?void 0:c.message)||c)}`),s&&(s.textContent="\u2014")}}async function ab(e){if(!He(e))return;let t=document.querySelector('.dash-tab[data-tab="inspector"]'),n=document.getElementById("tab-inspector"),s=async()=>n&&n.style.display!=="none"?!0:(typeof window.switchTab=="function"&&t?window.switchTab(t,"inspector"):t==null||t.click(),await new Promise(o=>setTimeout(o,80)),n?n.style.display!=="none":!0);for(let o=0;o<6&&!await s();o++)await new Promise(r=>setTimeout(r,80));let a=document.getElementById("inspect-addr");a&&(a.value=e,a.focus()),await new Promise(o=>setTimeout(o,60)),typeof window.runInspect=="function"?window.runInspect():he("Inspector not ready yet.")}function ob(){Xe(".net-btn[data-network]").forEach(e=>{e.addEventListener("click",()=>{let t=e.getAttribute("data-network");Xe(".net-btn").forEach(s=>{s.classList.toggle("active",s===e),s.setAttribute("aria-pressed",String(s===e))}),Rt.acct.clear(),Us.window=[],Us.totals=new Map,Re.window=[],Re.smoothCancelPerMin=null,Re.smoothBurst=null,Xt.length=0,Ya.clear(),Ge=0,Kt=0,ut=0,qs=0,Jt=!0,Za=0,zi=!1,Vs=null,_t=!1,bn=0,fs=0,no=!1;let n=x("ledgerStreamTrack");n&&(n.innerHTML="",n.style.transform="translateX(0px)"),$u(null,null),Yb(),ie.byAddr.clear(),ie.selectedAddr=null,ie.selectedProof=null,Gi(),Mu(),gs(null),Ur(t),to({force:!0})})})}var Ja=[],ib=8,Di=null,Hi=0,Ws=null;function rb(){let e=document.querySelector(".dashboard-metric-grid");if(!e)return;let t=e.closest(".dashboard-metrics")||e.parentElement;t&&t.classList.add("dashboard-sticky-strip"),e.innerHTML=`
  ...
  `}function lb(e){var g,b,h,v;let t=e.ledgerIndex?Number(e.ledgerIndex):null;V("d2-ledger-index",t?t.toLocaleString():"\u2014");let n=((g=e.latestLedger)==null?void 0:g.closeTimeSec)!=null?Number(e.latestLedger.closeTimeSec):null,s=x("d2-ledger-age");if(s&&(n!=null?(s.textContent=`${n<2?n.toFixed(2):n.toFixed(1)}s close`,s.style.color=n<=3?"#50fa7b":n<=6?"#ffb86c":"#ff6e6e"):(s.textContent="Waiting\u2026",s.style.color="")),n!=null&&(Ja.push(n),Ja.length>ib&&Ja.shift(),cb()),Hi=Date.now(),db(),e.tps!=null){let w=Number(e.tps),k=x("d2-tps");k&&(k.textContent=w.toFixed(1),k.style.color=w<10?"rgba(255,255,255,.65)":w<40?"#50fa7b":w<80?"#ffb86c":"#ff6e6e");let $=x("d2-tps-trend");if($){let T=X.tpsHistory||[],S=T.length>2?(T.slice(-10).reduce((P,C)=>P+C,0)/Math.min(T.length,10)).toFixed(1):null,N=w<10?"Low":w<40?"Normal":w<80?"High":"Peak";$.textContent=S?`${N} \xB7 avg ${S}`:N,$.style.color=w<10?"rgba(255,255,255,.55)":w<40?"#50fa7b":w<80?"#ffb86c":"#ff6e6e"}}let a=(((b=e.latestLedger)==null?void 0:b.totalTx)??e.txPerLedger)||0,o=x("d2-tx-per-ledger");o&&(o.textContent=a>0?a.toLocaleString():"\u2014",o.style.color=a<10?"rgba(255,255,255,.65)":a<150?"#50fa7b":a<400?"#ffb86c":"#ff6e6e");let i=x("d2-tx-spread");i&&a>0&&(i.textContent=a<10?"Very light":a<50?"Light":a<150?"Normal":a<400?"High volume":"Very high volume",i.style.color=a<150?"":a<400?"#ffb86c":"#ff6e6e");let r=e.avgFee!=null?Number(e.avgFee):((h=e.latestLedger)==null?void 0:h.avgFee)!=null?Number(e.latestLedger.avgFee):null;if(r!=null){let w=Math.round(r*1e6),k=x("d2-fee-value");k&&(k.textContent=gn(r),k.style.color=w<=15?"#50fa7b":w<=50?"rgba(255,255,255,.9)":w<=200?"#ffb86c":"#ff6e6e");let $=x("d2-fee-delta");if($)if(Di!=null){let S=r/Di;S>1.05?($.textContent="\u2191",$.style.color="#ff6e6e",$.title=`+${((S-1)*100).toFixed(0)}% vs prev ledger`):S<.95?($.textContent="\u2193",$.style.color="#50fa7b",$.title=`-${((1-S)*100).toFixed(0)}% vs prev ledger`):($.textContent="\u2192",$.style.color="rgba(255,255,255,.35)",$.title="Stable vs prev ledger")}else $.textContent="";Di=r;let T=x("d2-fee-pressure");if(T){let S=w<=15?"Base fee":w<=50?`${w} drops`:w<=200?`${w} drops \xB7 Elevated`:`${w} drops \xB7 Surge`;T.textContent=S,T.style.color=w<=50?"":w<=200?"#ffb86c":"#ff6e6e"}}let l=e.successRate!=null?Number(e.successRate):((v=e.latestLedger)==null?void 0:v.successRate)!=null?Number(e.latestLedger.successRate):null;if(l!=null){let w=x("d2-success-rate");w&&(w.textContent=`${l.toFixed(1)}%`,w.style.color=l>=90?"#50fa7b":l>=75?"#ffb86c":"#ff6e6e");let k=x("d2-success-note");if(k){let $=(100-l).toFixed(1);k.textContent=l>=90?`${$}% failed \xB7 Normal`:l>=75?`${$}% failed \xB7 Watch`:`${$}% failed \xB7 Alert`,k.style.color=l>=90?"":l>=75?"#ffb86c":"#ff6e6e"}}let c=a>0?Math.min(100,a/500*100):null,d=x("d2-network-capacity"),u=x("d2-capacity-note");c!=null&&(d&&(d.textContent=`${c.toFixed(1)}%`,d.style.color=c<20?"rgba(255,255,255,.65)":c<50?"#50fa7b":c<80?"#ffb86c":"#ff6e6e"),u&&(u.textContent=c<20?"Low usage":c<50?"Moderate":c<80?"Heavy":"Near capacity",u.style.color=c<50?"":c<80?"#ffb86c":"#ff6e6e"));let p=e.txTypes||{},m=Object.entries(p).sort(([,w],[,k])=>k-w);if(m.length){let[w,k]=m[0],$=m.reduce((C,[,R])=>C+R,0)||1,T=(k/$*100).toFixed(0),S=typeof It<"u"?It:{},N=x("d2-dominant-type");N&&(N.textContent=w,N.style.color=S[w]||"rgba(255,255,255,.9)");let P=x("d2-dominance-score");if(P){let C=m[1];P.textContent=C?`${T}% \xB7 2nd: ${C[0]}`:`${T}% of txs`}}let f=x("stream-loading");f&&(f.style.display="none")}function cb(){let e=x("d2-close-sparkline");if(!e||!e.getContext)return;let t=Ja;if(t.length<2)return;let n=e.width,s=e.height,a=e.getContext("2d");a.clearRect(0,0,n,s);let o=Math.max(...t,4),i=Math.floor((n-(t.length-1))/t.length),r=1;t.forEach((l,c)=>{let d=Math.max(3,Math.round(l/o*(s-2))),u=c*(i+r),p=s-d,m=l<=3?"rgba(80,250,123,.80)":l<=6?"rgba(255,184,108,.80)":"rgba(255,110,110,.85)";a.fillStyle=m;let f=Math.min(2,i/2);a.beginPath(),a.moveTo(u+f,p),a.lineTo(u+i-f,p),a.quadraticCurveTo(u+i,p,u+i,p+f),a.lineTo(u+i,s),a.lineTo(u,s),a.lineTo(u,p+f),a.quadraticCurveTo(u,p,u+f,p),a.closePath(),a.fill(),c===t.length-1&&(a.fillStyle="rgba(255,255,255,.18)",a.fillRect(u,p,i,Math.min(3,d)))})}function db(){if(Ws&&cancelAnimationFrame(Ws),!Yt())return;let e=0,t=n=>{if(!Yt()){Ws=null;return}if(n-e>=120){e=n;let s=x("d2-ledger-age-timer");if(s&&Hi>0){let a=(Date.now()-Hi)/1e3;s.textContent=`${a.toFixed(1)}s ago`,s.style.color=a<4?"rgba(255,255,255,.55)":a<7?"#ffb86c":"#ff6e6e",s.style.opacity=a>=7?(.6+.4*Math.sin(Date.now()/300)).toFixed(2):"1"}}Ws=requestAnimationFrame(t)};Ws=requestAnimationFrame(t)}function pb(){let e=x("tx-mix");if(!e)return;let t=Object.entries(X.txMixAccum||{}).filter(([,s])=>s>0).sort(([,s],[,a])=>a-s).slice(0,10),n=t.reduce((s,[,a])=>s+a,0);n&&(e.innerHTML=t.map(([s,a])=>{let o=(a/n*100).toFixed(1),i=It[s]||"#6b7280";return`
    ...
    `,o.appendChild(i)};e("chart-tps","tpsTrendMini"),e("chart-fee","feeTrendMini"),e("chart-tps2","tpsTrendMini2"),e("chart-fee2","feeTrendMini2")}function Ua(e,t,n,s){let a=document.getElementById(e);if(!a)return;let o=(i,r)=>{let l=a.querySelector(`[data-k="${i}"]`);l&&(l.textContent=r)};if(t.cur==null){o("now","\u2014"),o("avg","\u2014"),o("delta","\u2014"),o("sigma","\u2014");return}o("now",`${Number(t.cur).toFixed(n)}${s}`),o("avg",t.avg!=null?`${Number(t.avg).toFixed(n)}${s}`:"\u2014"),o("delta",t.deltaPct==null?"\u2014":yn(t.deltaPct,0)),o("sigma",t.vol==null?"\u2014":`${Number(t.vol).toFixed(Math.max(0,n-1))}${s}`)}function fb(){var n,s,a,o,i,r,l,c,d,u;(n=ye.tps)==null||n.draw(X.tpsHistory),(s=ye.fee)==null||s.draw(X.feeHistory),(a=ye.tps2)==null||a.draw(X.tpsHistory),(o=ye.fee2)==null||o.draw(X.feeHistory);let e=Ht(X.tpsHistory,Qt),t=Ht(X.feeHistory,Qt);Ua("tpsTrendMini",e,2,""),Ua("tpsTrendMini2",e,2,""),Ua("feeTrendMini",t,0,"d"),Ua("feeTrendMini2",t,0,"d"),(i=ye.dexPressure)==null||i.draw(fe.dexPressure),(r=ye.nftMints)==null||r.draw(fe.nftMints),(l=ye.nftBurns)==null||l.draw(fe.nftBurns),(c=ye.autoBridge)==null||c.draw(fe.autoBridge),(d=ye.marketPrice)==null||d.draw(fe.marketPrice),(u=ye.marketVol)==null||u.draw(fe.marketVol)}function hb(){let e=x("ledger-log"),t=x("ledger-log-loading"),n=x("ledger-log-count");if(!e||!(X.ledgerLog||[]).length)return;t&&(t.style.display="none"),n&&(n.textContent=X.ledgerLog.length);let s=x("tab-network");!s||s.style.display==="none"||(e.innerHTML=`<div class="ledger-log-row log-head">
      ...
      </div>`).join(""))}var Xt=[],Ya=new Set,Ge=0,Va=null,qs=0,Kt=0,ut=0,Jt=!0,Ga=0,_t=!1,Za=0,zi=!1,Vs=null,bn=0,fs=0,no=!1,gb=.18;function bb(){vb(),yb()}function vb(){let e=x("ledgerStreamParticles");if(e){e.innerHTML="";for(let t=0;t<14;t++){let n=document.createElement("div");n.className="ledger-particle",n.style.left=Math.random()*100+"%",n.style.top=20+Math.random()*60+"%",n.style.animationDuration=6+Math.random()*8+"s",n.style.animationDelay=Math.random()*5+"s",e.appendChild(n)}}}function yb(){if(Va)return;let e=x("ledgerStreamShell");e&&(e.addEventListener("mouseenter",()=>{_t=!0}),e.addEventListener("mouseleave",()=>{Gs||(_t=!1)}));let t=x("ledgerStreamTrack");t&&t.addEventListener("click",s=>{let a=s.target.closest("article.ledger-card");if(!a)return;let o=Number(a.dataset.ledgerIndex);Number.isFinite(o)&&(s.shiftKey?Vs===o?(Vs=null,Gs||(_t=!1),nu()):(Vs=o,_t=!0,nu()):wb(o))});let n=s=>{qs||(qs=s);let a=Math.min(.05,(s-qs)/1e3);qs=s;let o=Yt()?x("ledgerStreamTrack"):null;if(o&&Ge>0){if(Jt){let i=o.scrollWidth||0;if(i>100)ut=Math.floor(i/2),Jt=!1,Ga=0,Ge>0&&(bn=ut/Ge);else{Ga++,Ga>30&&(Jt=!1,Ga=0),Va=requestAnimationFrame(n);return}}if(ut>0&&!_t&&no){let i=Math.min(1,a/gb);Kt+=(fs-Kt)*i,Math.abs(fs-Kt)<.5&&(Kt=fs);let r=Kt%ut;o.style.transform=`translateX(${-r}px)`}if(!_t&&Math.floor(s/250)!==Math.floor((s-a*1e3)/250)){let i=Date.now(),r=o.querySelectorAll("article.ledger-card[data-arrival-ts]"),l=12e4;r.forEach(c=>{let d=i-Number(c.dataset.arrivalTs||i),u=Math.max(.52,1-d/l*.48);c.style.opacity=u.toFixed(3)})}if(Za>0){let i=Date.now()-Za>Ug;eo(i)}}Va=requestAnimationFrame(n)};Va=requestAnimationFrame(n),window.addEventListener("resize",()=>{Jt=!0})}function yu(){if(bn<=0||ut<=0||Ge===0)return Kt;let e=x("ledgerStreamShell"),t=e&&e.offsetWidth||800,n=bn-14,a=(Ge-1)*bn+n-t+18;a=Math.max(0,a);let i=Math.floor(Kt/ut)*ut+a;return i<Kt-2&&(i+=ut),i}function eo(e,t){if(e===zi)return;zi=e;let n=x("ledgerStreamShell");if(!n)return;let s=n.querySelector(".stream-stall-overlay");e?(s||(s=document.createElement("div"),s.className="stream-stall-overlay",n.appendChild(s)),s.innerHTML=`<span class="stream-stall-dot"></span> ${y(t||"Waiting for ledgers\u2026")}`):s==null||s.remove()}function nu(){document.querySelectorAll(".ledger-card").forEach(e=>{let t=Number(e.dataset.ledgerIndex);e.classList.toggle("ledger-card--pinned",t===Vs)})}function wb(e){let t=document.querySelector('.dash-tab[data-tab="inspector"]');typeof window.switchTab=="function"&&t?window.switchTab(t,"inspector"):t==null||t.click();let n=document.getElementById("inspect-addr");n&&(n.placeholder=`Ledger #${e.toLocaleString()} \u2014 paste an address`,n.focus())}function xb(){var t;let e=x("ledgerStreamShell");e&&(e.classList.remove("stream-reconnect-flash"),e.offsetWidth,e.classList.add("stream-reconnect-flash"),setTimeout(()=>e.classList.remove("stream-reconnect-flash"),1200),Jg=((t=us.at(-1))==null?void 0:t.li)??0,kb())}function kb(){let e=document.getElementById("reconnect-banner");if(!e){e=document.createElement("div"),e.id="reconnect-banner",e.className="reconnect-banner";let s=document.querySelector(".dashboard-col-main");s&&s.prepend(e)}e.style.display="",e.innerHTML=`
    ...
    <button onclick="document.getElementById('reconnect-banner').style.display='none'"
      style="margin-left:auto;background:none;border:none;color:inherit;opacity:.5;cursor:pointer;font-size:.9rem">\u2715</button>`;let t=3,n=setInterval(()=>{let s=document.getElementById("reconnect-countdown");if(s&&(s.textContent=t),t--,t<0){clearInterval(n);let a=document.getElementById("reconnect-banner");a&&(a.style.display="none")}},4e3)}function su(){let e=x("ledgerStreamTrack"),t=x("ledgerStreamShell"),n=x("stream-loading");if(!e||!t)return;if(n&&(n.style.display="none"),Xt.length===0){e.innerHTML='<div style="padding:40px;opacity:.6">Waiting for ledgers\u2026</div>',Ge=0,Jt=!0;return}let s=[...Xt].sort((o,i)=>o.ledgerIndex-i.ledgerIndex),a=s.map((o,i)=>xu(o,{prevIndex:i>0?s[i-1].ledgerIndex:null}));e.innerHTML=a.concat(a).join(""),Ge=s.length,Jt=!0,requestAnimationFrame(()=>{var i;let o=((i=x("ledgerStreamTrack"))==null?void 0:i.scrollWidth)||0;o>100&&(ut=Math.floor(o/2),bn=Ge>0?ut/Ge:0,fs=yu(),no=!0,Jt=!1)})}function $b(e){var f,g;if(!e)return;let t=Number(e.ledgerIndex??NaN);if(!Number.isFinite(t)||Ya.has(t))return;Ya.add(t),Xt.push(e);let n=0;if(Xt.length>Dp){let b=Xt.splice(0,Xt.length-Dp);b.forEach(h=>Ya.delete(h.ledgerIndex)),n=b.length}Za=Date.now(),eo(!1),Tb(e.avgFee!=null?Number(e.avgFee):null);let{auraClass:s,domColor:a}=Cb(e);$u(s,a);let o=x("stream-loading");o&&(o.style.display="none");let i=x("ledgerStreamTrack");if(!i)return;if(Ge===0){su();return}let r=Xt.length>=2?Xt[Xt.length-2].ledgerIndex:0;if(t<r){su();return}let l=Ge,c=xu(e),d=document.createElement("template");d.innerHTML=c;let u=d.content.firstElementChild,p=i.children[l];p?i.insertBefore(u,p):i.appendChild(u);let m=document.createElement("template");if(m.innerHTML=c,i.appendChild(m.content.firstElementChild),Ge=l+1,n>0){for(let h=0;h<n;h++)(f=i.children[0])==null||f.remove();let b=Ge-n;for(let h=0;h<n;h++)(g=i.children[b])==null||g.remove();Ge-=n}Jt=!0,requestAnimationFrame(()=>{bn<=0&&ut>0&&Ge>0&&(bn=ut/Ge),fs=yu(),no=!0})}var hs=[],Sb=20;function Tb(e){e==null||!Number.isFinite(e)||(hs.push(e),hs.length>Sb&&hs.shift())}function wu(){return hs.length===0?null:hs.reduce((e,t)=>e+t,0)/hs.length}function xu(e,t={}){let{ledgerIndex:n,closeTimeSec:s,totalTx:a,txTypes:o,avgFee:i}=e,r=o||{},l=a??0,c=Object.entries(r).sort(([,D],[,I])=>I-D)[0],d=(c==null?void 0:c[0])||"Other",u=ku(d),p=typeof It<"u"?It:{},m=D=>p[D]||"#6b7280",f=m(d),g=ms(f,.45)||f,b=ms(f,.14)||f,h=s==null?"\u2014":s<2?`${Number(s).toFixed(2)}s`:`${Number(s).toFixed(1)}s`,v=l>0&&s>0?(l/s).toFixed(1):null,w=i!=null?Number(i):null,k=w!=null?gn(w):"\u2014",$=wu(),T=w!=null&&$!=null&&w>$*3,S=t.prevIndex!=null?Number(n)-t.prevIndex-1:0,N=S>0?`<div class="stream-gap-badge" title="${S} ledger(s) missing">\xB7\xB7\xB7&nbsp;${S} gap</div>`:"",P=D=>l>0?`${(D/l*100).toFixed(1)}%`:"0%",C=(D,I,F)=>I?`<div class="ledger-type-row">
      <span class="ledger-type-label cut">${y(D)}</span>
      <div class="ledger-type-bar"><div class="ledger-type-fill" style="width:${P(I)};background:${F}"></div></div>
      <span class="ledger-type-count">${I}</span>
    </div>`:"",R=(r.AMMCreate||0)+(r.AMMDeposit||0)+(r.AMMWithdraw||0)+(r.AMMVote||0),O=Date.now();return`${N}<article class="ledger-card ledger-card--${u} ledger-card--entry${T?" ledger-card--fee-spike":""}"
  ...
  </article>`}function ku(e){let t=String(e||"");return t==="Payment"?"payment":t.startsWith("Offer")?"offer":t.startsWith("NFToken")?"nft":t==="TrustSet"?"trust":t.startsWith("AMM")?"amm":"other"}function Cb(e){var o;let n=((o=Object.entries(e.txTypes||{}).sort(([,i],[,r])=>r-i)[0])==null?void 0:o[0])||"Other",s=ku(n),a=It[n]||It.Other||"#6b7280";return{dominantTx:n,auraClass:s,domColor:a}}function $u(e,t){let n=x("ledgerStreamShell");if(!n)return;if(!e||!t){n.style.removeProperty("--streamTintStrong"),n.style.removeProperty("--streamTintSoft"),n.style.removeProperty("--streamTintBorder");return}let s=ms(t,.16)||"rgba(0,255,240,0.14)",a=ms(t,.06)||"rgba(0,255,240,0.06)",o=ms(t,.22)||"rgba(0,255,240,0.22)";n.style.setProperty("--streamTintStrong",s),n.style.setProperty("--streamTintSoft",a),n.style.setProperty("--streamTintBorder",o),n.dataset.tint=e}function Pb(e){var b,h;let t=Array.isArray(e.recentTransactions)?e.recentTransactions.slice(0,Xg):[],n=e.txTypes||{},s=Number(e.ledgerIndex||0),a=Object.values(n).reduce((v,w)=>v+w,0)||1,o=0;for(let v of Object.values(n)){let w=v/a;o+=w*w}let i=Mb(t);Lb(Us,i);let r=Ab(Us.totals,i),l=Eb(Us.totals),c=Nb(s,t),d=Rb(s,(b=e.latestLedger)==null?void 0:b.closeTimeSec,t),u=_b({txs:t,txTypes:n,dexPatterns:d}),p=r.filter(v=>v.count>=2).length,m=Db({hhi:o,repeats:p,dex:d,bots:((h=c.bots)==null?void 0:h.length)||0,advanced:u}),f=Ib({friction:m,tps:Ht(X.tpsHistory),fee:Ht(X.feeHistory)}),g=Fb({s:e,txTypes:n,hhi:o,dexPatterns:d,behavior:c,friction:m,regime:f,breadcrumbs:r,clusters:l,advanced:u});return{s:e,txs:t,txTypes:n,hhi:o,behavior:c,dexPatterns:d,friction:m,regime:f,breadcrumbs:r,clusters:l,narratives:g,advanced:u}}function Mb(e){let t=new Map;for(let n of e){let s=n==null?void 0:n.account,a=n==null?void 0:n.destination;if(!s||!a)continue;let o=`${s}|${a}`;t.set(o,(t.get(o)||0)+1)}return t}function Lb(e,t){e.window.unshift(t);for(let[n,s]of t.entries())e.totals.set(n,(e.totals.get(n)||0)+s);for(;e.window.length>e.maxLedgers;){let n=e.window.pop();for(let[s,a]of n.entries()){let o=(e.totals.get(s)||0)-a;o<=0?e.totals.delete(s):e.totals.set(s,o)}}}function Ab(e,t){let s=[...e.entries()].map(([o,i])=>({k:o,c:i})).sort((o,i)=>i.c-o.c).filter(o=>o.c>=2);return(s.length?s:[...t.entries()].map(([o,i])=>({k:o,c:i}))).slice(0,10).map(({k:o,c:i})=>{let[r,l]=o.split("|");return{from:r,to:l,count:i}})}function Eb(e){let t=[...e.entries()].filter(([,i])=>i>=2),n=t.length?t:[...e.entries()],s=new Map;for(let[i]of n){let[r,l]=i.split("|");!r||!l||(s.has(r)||s.set(r,new Set),s.has(l)||s.set(l,new Set),s.get(r).add(l),s.get(l).add(r))}let a=new Set,o=[];for(let i of s.keys()){if(a.has(i))continue;let r=[i],l=[];for(a.add(i);r.length;){let u=r.pop();l.push(u);for(let p of s.get(u)||[])a.has(p)||(a.add(p),r.push(p))}if(l.length<2)continue;let c=l[0],d=-1;for(let u of l){let p=(s.get(u)||new Set).size;p>d&&(d=p,c=u)}o.push({members:l,size:l.length,hub:c})}return o.sort((i,r)=>r.size-i.size),o.slice(0,6)}function Nb(e,t){let n=new Map;for(let a of t){let o=a==null?void 0:a.account;o&&n.set(o,(n.get(o)||0)+1)}for(let[a,o]of n.entries()){Rt.acct.has(a)||Rt.acct.set(a,{ledgers:[],intervals:[],total:0});let i=Rt.acct.get(a),r=i.ledgers.at(-1);i.ledgers.push(e),r!=null&&e>r&&i.intervals.push(e-r),i.ledgers.length>30&&i.ledgers.shift(),i.intervals.length>29&&i.intervals.shift(),i.total+=o}let s=[];for(let[a,o]of Rt.acct.entries()){if(o.intervals.length<6)continue;let i=vn(o.intervals),r=Ui(o.intervals);if(!i||r==null)continue;let l=r/i;l<.35&&o.total>10&&s.push({acct:a,cv:l,total:o.total})}if(s.sort((a,o)=>a.cv-o.cv||o.total-a.total),e%50===0)for(let[a,o]of Rt.acct){let i=o.ledgers.at(-1)??e;e-i>1e3&&Rt.acct.delete(a)}return{bots:s.slice(0,6),uniqueActors:n.size}}function Rb(e,t,n){var N;let s=0,a=0,o=new Map,i=new Map,r=new Map;for(let P of n){let C=P==null?void 0:P.type,R=P==null?void 0:P.account;R&&(C==="OfferCreate"?(s+=1,o.set(R,(o.get(R)||0)+1),i.set(R,(i.get(R)||0)+1)):C==="OfferCancel"&&(a+=1,o.set(R,(o.get(R)||0)+1),r.set(R,(r.get(R)||0)+1)))}let l=s+a,c=l?a/l:0,d=t!=null&&Number(t)>0?a/Number(t)*60:null;for(Re.smoothCancelPerMin=eu(Re.smoothCancelPerMin,d,.45),Re.window.unshift({li:e,closeTimeSec:t??null,create:s,cancel:a,total:l,cancelRatio:c,cancelsPerMin:Re.smoothCancelPerMin,byActor:o,byActorCreate:i,byActorCancel:r});Re.window.length>zg;)Re.window.pop();let u={create:0,cancel:0,total:0},p=new Map,m=new Map,f=new Map;for(let P of Re.window){u.create+=P.create,u.cancel+=P.cancel,u.total+=P.total;for(let[C,R]of P.byActor.entries())p.set(C,(p.get(C)||0)+R);for(let[C,R]of P.byActorCancel.entries())m.set(C,(m.get(C)||0)+R);for(let[C,R]of P.byActorCreate.entries())f.set(C,(f.get(C)||0)+R)}let g=Ii(p,5),b=Ii(m,5),h=Ii(f,5),v=u.total?(((N=g[0])==null?void 0:N.count)||0)/u.total:0,w=0;if(u.total)for(let P of p.values()){let C=P/u.total;w+=C*C}let k=Re.window.map(P=>P.total).filter(Number.isFinite),$=vn(k)||0,T=$>0?(l-$)/$*100:null;Re.smoothBurst=eu(Re.smoothBurst,T,.4);let S=[];return u.total>=Ri&&c>=.65&&S.push("Lots of cancels (looks like quote-stuffing/spam)"),u.total>=Ri&&v>=.35&&S.push("One actor dominates DEX activity"),u.total>=Ri&&(Re.smoothCancelPerMin||0)>=18&&S.push("Fast cancelling (high churn)"),Re.smoothBurst!=null&&Math.abs(Re.smoothBurst)>=45&&S.push("Sudden DEX burst"),{now:{li:e,create:s,cancel:a,total:l,cancelRatio:c,cancelsPerMin:Re.smoothCancelPerMin},window:{...u,cancelRatio:u.total?u.cancel/u.total:0},topShare:v,actorHHI:w,burstPct:Re.smoothBurst,topActor:g,topCanceller:b,topMaker:h,signals:S}}function Ii(e,t){return[...e.entries()].sort((n,s)=>s[1]-n[1]).slice(0,t).map(([n,s])=>({acct:n,count:s}))}function _b({txs:e,txTypes:t,dexPatterns:n}){var H;let s=Number((t==null?void 0:t.OfferCreate)||0)+Number((t==null?void 0:t.OfferCancel)||0),a=Number((t==null?void 0:t.NFTokenMint)||0),o=Number((t==null?void 0:t.NFTokenBurn)||0),i=0,r=new Map,l=new Map;for(let E of e){if((E==null?void 0:E.type)!=="Payment")continue;let j=(E==null?void 0:E.paths)||(E==null?void 0:E.Paths),se=Array.isArray(j)&&j.length>0,re=(E==null?void 0:E.sendmax)!=null||(E==null?void 0:E.SendMax)!=null,pe=(E==null?void 0:E.delivermax)!=null||(E==null?void 0:E.DeliverMax)!=null;if(!(se||re||pe))continue;i+=1;let te=E==null?void 0:E.account,de=E==null?void 0:E.destination;if(te&&r.set(te,(r.get(te)||0)+1),te&&de){let le=`${te}|${de}`;l.set(le,(l.get(le)||0)+1)}}let c=[...r.entries()].sort((E,j)=>j[1]-E[1]).slice(0,5).map(([E,j])=>({acct:E,count:j})),d=[...l.entries()].sort((E,j)=>j[1]-E[1]).slice(0,5).map(([E,j])=>{let[se,re]=E.split("|");return{from:se,to:re,count:j}}),u=(H=n==null?void 0:n.now)!=null&&H.total?Math.round((n.now.cancelRatio||0)*100):0,p=(n==null?void 0:n.topShare)!=null?Math.round(n.topShare*100):0,m=e.filter(E=>(E==null?void 0:E.type)==="Payment").map(E=>typeof(E==null?void 0:E.amountXrp)=="number"?E.amountXrp:null).filter(E=>E!=null&&E>0&&Number.isFinite(E)),f=[100,1e3,1e4],g=m.filter(E=>f.some(j=>Math.abs(E%j)<1e-9&&E/j>=1)).length,b=m.length>=5?Math.round(g/m.length*100):null,h=e.filter(E=>(E==null?void 0:E.type)==="Payment"&&(E==null?void 0:E.account)&&(E==null?void 0:E.destination)&&E.account===E.destination).length,v=Number((t==null?void 0:t.AMMCreate)||0),w=Number((t==null?void 0:t.AMMDeposit)||0),k=Number((t==null?void 0:t.AMMWithdraw)||0),$=Number((t==null?void 0:t.AMMVote)||0),T=Number((t==null?void 0:t.AMMBid)||0),S=Number((t==null?void 0:t.AMMDelete)||0),N=v+w+k+$+T+S,P=w-k,C=w+k>0?Math.round(w/(w+k)*100):null,R=new Set;for(let E of e)["AMMCreate","AMMDeposit","AMMWithdraw","AMMVote","AMMBid"].includes(E==null?void 0:E.type)&&(E!=null&&E.account)&&R.add(E.account);let O=R.size,D=0,I=0;for(let E of e)(E==null?void 0:E.type)==="Payment"&&Array.isArray(E==null?void 0:E.paths)&&E.paths.length>0&&(D+=E.paths.length,I++);let F=I>0?(D/I).toFixed(1):null;return{offerTotal:s,dexCancelPct:u,dexTopSharePct:p,mints:a,burns:o,pathPays:i,topPathActors:c,topPathPairs:d,roundnessIdx:b,selfTradeCount:h,ammCreate:v,ammDeposit:w,ammWithdraw:k,ammVote:$,ammBid:T,ammDelete:S,lpTotal:N,lpNetFlow:P,lpRatio:C,lpUniqueActors:O,avgPathDepth:F}}function Db({hhi:e,repeats:t,dex:n,bots:s,advanced:a}){var h,v;let o=we((e-.22)/.25,0,1)*22,i=we((t-2)/6,0,1)*12,r=((h=n==null?void 0:n.window)==null?void 0:h.cancelRatio)??0,l=(n==null?void 0:n.topShare)??0,c=((v=n==null?void 0:n.now)==null?void 0:v.cancelsPerMin)??0,d=we((r-.5)/.5,0,1)*18,u=we((l-.25)/.5,0,1)*18,p=we(c/25,0,1)*10,m=we(s/6,0,1)*10,f=(a==null?void 0:a.roundnessIdx)!=null?we((a.roundnessIdx-30)/40,0,1)*8:0,g=(a==null?void 0:a.selfTradeCount)>0?Math.min(8,a.selfTradeCount*4):0,b=(a==null?void 0:a.pathPays)!=null?we(a.pathPays/30,0,1)*6:0;return Math.round(o+i+d+u+p+m+f+g+b)}function Ib({friction:e,tps:t,fee:n}){let s=(n==null?void 0:n.deltaPct)!=null&&Math.abs(n.deltaPct)>=35,a=(t==null?void 0:t.deltaPct)!=null&&Math.abs(t.deltaPct)>=25;return e>=75?"Manipulated":s||a?"Stressed":((t==null?void 0:t.cur)??0)>=12||((t==null?void 0:t.avg)??0)>=10?"Active":"Quiet"}function Fb({s:e,txTypes:t,hhi:n,dexPatterns:s,behavior:a,friction:o,regime:i,breadcrumbs:r,clusters:l,advanced:c}){var h,v,w,k,$;let d=[],u=Ht(X.tpsHistory,Qt),p=Ht(X.feeHistory,Qt),m=((h=Object.entries(t||{}).sort(([,T],[,S])=>S-T)[0])==null?void 0:h[0])||"\u2014",f=Number(e.txPerLedger||0);d.push({sentiment:i==="Manipulated"||i==="Stressed"?"warn":i==="Active"?"up":"ok",title:`Overall: ${i} \xB7 Risk score ${o}/100`,detail:"Heuristic score from concentration, repeats, DEX churn, bot-like timing, and routing indicators. It's a signal, not proof."}),d.push({sentiment:"ok",title:`Ledger snapshot: #${Number(e.ledgerIndex||0).toLocaleString()} \xB7 ${f} tx \xB7 most common: ${m}`,detail:`TPS ${cs(u.cur,2)} (avg ${cs(u.avg,2)} \xB7 ${yn(u.deltaPct,0)}). Fee ${p.cur!=null?gn(p.cur):"\u2014"} (avg ${p.avg!=null?gn(p.avg):"\u2014"} \xB7 ${yn(p.deltaPct,0)}).`});let g=n>=.35?"high":n>=.25?"medium":"low";if(d.push({sentiment:n>=.35?"warn":"ok",title:`Transaction mix: ${g} concentration (HHI ${n.toFixed(2)})`,detail:n>=.35?"A few tx types dominate. Patterns look \u201Cstronger,\u201D but can be misleading.":"Mix is broad. Strong signals usually come from behavior, not just tx type."}),s.window.total){let T=Math.round(s.window.cancelRatio*100),S=Math.round(s.topShare*100);d.push({sentiment:s.signals.length?"warn":"ok",title:`DEX monitor: ${s.window.total} offer tx (window) \xB7 cancels ${T}% \xB7 top actor ~${S}%`,detail:s.signals.length?`Signals: ${s.signals.join(" \xB7 ")}`:"No strong DEX-pattern signals right now.",addr:((v=s.topActor[0])==null?void 0:v.acct)||null})}let b=r.filter(T=>T.count>=2).length;if(b>=2&&d.push({sentiment:"new",title:`Repeating counterparties: ${b} recurring pair(s)`,detail:"Repeated interactions can be routing loops, bots, or coordinated flows. Click addresses for a quick read."}),l!=null&&l.length&&((w=l[0])==null?void 0:w.size)>=3&&d.push({sentiment:"new",title:`Cluster forming: ${l[0].size} wallets \xB7 hub ${z(l[0].hub)}`,detail:"Clusters are co-activity groups (not identity proof). Use as \u201Clikely related behavior.\u201D",addr:l[0].hub}),(k=a.bots)!=null&&k.length){let T=a.bots[0];d.push({sentiment:"warn",title:`Bot-like timing: ${a.bots.length} candidate(s)`,detail:`Low variance in repeated appearances. Top: ${z(T.acct)} (CV ${T.cv.toFixed(2)}).`,addr:T.acct})}if(c!=null&&c.pathPays){let T=($=c.topPathActors)==null?void 0:$[0];d.push({sentiment:c.pathPays>=18?"warn":"ok",title:`Autobridge-ish routing: ${c.pathPays} path payments (ledger sample)`,detail:T?`Most active routing wallet: ${z(T.acct)} (${T.count}).`:"Paths/SendMax/DeliverMax appear frequently in the sample.",addr:(T==null?void 0:T.acct)||null})}return c!=null&&c.selfTradeCount&&d.push({sentiment:"warn",title:`Self-transfer signal: ${c.selfTradeCount} payment(s) where sender = receiver`,detail:"Self-transfers can be benign (housekeeping) or used to fake activity. Treat as a watch signal."}),((c==null?void 0:c.roundnessIdx)??0)>=45&&d.push({sentiment:"warn",title:`Round-number bias: ${c.roundnessIdx}% of payments are exact multiples of 100/1,000/10,000`,detail:"Round-number bias often shows scripted behavior (bots) rather than human payments."}),d.slice(0,12)}function Ob(e){let t=x("d2-breadcrumb-list"),n=x("d2-breadcrumb-meta");if(!t)return;if(!e.length){t.innerHTML='<div class="gateway-item" style="opacity:.6">Watching for repeated interactions\u2026</div>',n&&(n.textContent="\u2014");return}let s=e.filter(a=>a.count>=2).length;n&&(n.textContent=s?`${s} repeats`:"Top interactions"),t.innerHTML=e.slice(0,10).map(a=>`
    <div class="gateway-item gateway-row">
    ...
    </div>`).join("")}function Bb(e){let t=x("d2-cluster-list"),n=x("d2-cluster-persistence");if(t){if(!e.length){t.innerHTML='<div class="gateway-item" style="opacity:.6">Building clusters\u2026 (needs repeated activity)</div>',n&&(n.textContent="\u2014");return}n&&(n.textContent=`${e.length} group${e.length!==1?"s":""}`),t.innerHTML=e.slice(0,6).map((s,a)=>{let i=`hsl(${(a*67+120)%360},70%,60%)`,r=s.members.slice(0,4);return`
      ...
      </div>`}).join("")}}function Xb(e){let t=x("d2-delta-narratives");if(!t)return;if(!e.length){t.innerHTML='<div class="gateway-item" style="opacity:.6">Building baseline \u2014 narratives appear after 1\u20132 ledgers\u2026</div>';return}let n={up:"#50fa7b",down:"#ff5555",new:"#00d4ff",warn:"#ffb86c",ok:"rgba(255,255,255,.85)"};t.innerHTML=e.map(s=>{let a=n[s.sentiment]||"rgba(255,255,255,.85)",o=s.addr&&He(s.addr)?`<button class="addr-link narrative-addr" data-addr="${y(s.addr)}">Peek</button>`:"";return`
  ...
  `,t?t.insertAdjacentElement("afterend",s):n?n.insertAdjacentElement("afterend",s):e.prepend(s)}function jb(){if(Bp)return;Bp=!0;let e=document.querySelector(".dashboard-col-main");if(!e)return;let t=document.createElement("section");t.className="widget-card",t.id="landscape-card",t.setAttribute("aria-label","Landscape brief"),t.innerHTML=`
  ...
  `,e.prepend(t)}function Wb(e){var v,w,k,$,T,S,N,P,C,R,O,D,I,F,H;let t=x("landscape-badge");t&&(t.textContent=`${e.regime} \xB7 Risk ${e.friction}/100`);let n=e.s,s=e.txTypes||{},a=((v=Object.entries(s).sort(([,E],[,j])=>j-E)[0])==null?void 0:v[0])||"\u2014",o=Ht(X.tpsHistory,Qt),i=Ht(X.feeHistory,Qt),r=e.dexPatterns,l=(w=r==null?void 0:r.window)!=null&&w.total?Math.round(r.window.cancelRatio*100):0,c=x("landscape-text");if(c){let E=Number(n.ledgerIndex||0).toLocaleString(),j=Number(n.txPerLedger||0),se=((k=n.latestLedger)==null?void 0:k.closeTimeSec)!=null?Number(n.latestLedger.closeTimeSec).toFixed(2)+"s":"\u2014",re=o.cur!=null?`${cs(o.cur,2)} TPS`:"\u2014",pe=i.cur!=null?`${gn(i.cur)} fee`:"\u2014",ae=n.successRate!=null?`${Number(n.successRate).toFixed(1)}% success`:"\u2014",te=($=r==null?void 0:r.window)!=null&&$.total?`DEX offers are <b>${r.window.total}</b> (window), with <b>${l}% cancels</b>.`:"DEX offers look quiet right now.";c.innerHTML=`
      <b>Right now:</b> Ledger <b>#${E}</b> closed in <b>${se}</b> with <b>${j}</b> transactions.
      Network is at <b>${re}</b>, with <b>${pe}</b>, and <b>${ae}</b>.
      Most common activity was <b>${y(a)}</b>. ${te}
    `}let d=x("landscape-why"),u=x("landscape-watchlist"),p=x("landscape-now"),m=x("landscape-watch"),f=[],g=[],b=[];if(e.regime==="Manipulated"?b.push("Risk score is very high. Patterns like churn, loops, or single-actor dominance often correlate with manipulated activity."):e.regime==="Stressed"?b.push("The network is behaving \u201Cabnormally\u201D (spikes in TPS or fees). This can be organic bursts or bots pushing volume."):e.regime==="Active"?b.push("The network is busy. Patterns are easier to detect because there\u2019s more data per minute."):b.push("The network is quiet. Signals are weaker; a few bots can dominate a small sample."),(T=r==null?void 0:r.signals)!=null&&T.length&&b.push(`DEX churn signals: <b>${y(r.signals.join(" \xB7 "))}</b>. Heavy OfferCreate/Cancel churn can indicate quote-stuffing/spoofing-like behavior.`),((S=e.advanced)==null?void 0:S.selfTradeCount)>0&&b.push(`Detected <b>${e.advanced.selfTradeCount}</b> self-transfer payment(s) in the sample. Can be benign, but can also be used to fake activity.`),(((N=e.advanced)==null?void 0:N.roundnessIdx)??0)>=45&&b.push(`Round-number bias is high (<b>${e.advanced.roundnessIdx}%</b>). That often indicates automation rather than human behavior.`),((P=e.advanced)==null?void 0:P.pathPays)>=18&&b.push(`Path payments are heavy (<b>${e.advanced.pathPays}</b> in sample). Lots of routing can mean arbitrage bots or automated bridge traffic.`),d&&(d.innerHTML=b.map(E=>`<div class="landscape-row">${E}</div>`).join("")),f.push(`Overall mode: <b>${y(e.regime)}</b> (risk score <b>${e.friction}/100</b>).`),f.push(`Traffic: <b>${cs(o.cur,2)}</b> TPS (avg ${cs(o.avg,2)} \xB7 ${yn(o.deltaPct,0)}).`),f.push(`Fees: <b>${i.cur!=null?gn(i.cur):"\u2014"}</b> (avg ${i.avg!=null?gn(i.avg):"\u2014"} \xB7 ${yn(i.deltaPct,0)}).`),(C=r==null?void 0:r.window)!=null&&C.total){let E=(R=r.topActor)==null?void 0:R[0];f.push(`DEX activity: <b>${r.window.total}</b> offer tx (window) \xB7 cancels <b>${l}%</b> \xB7 churn <b>${cs(r.now.cancelsPerMin,1)}</b>/min.`),E&&f.push(`Most active DEX wallet: <button class="addr-link mono" data-addr="${y(E.acct)}">${y(z(E.acct))}</button> (${E.count}).`)}else f.push("DEX activity: <b>quiet</b> (few OfferCreate/OfferCancel).");let h=e.breadcrumbs.filter(E=>E.count>=2).length;if(h&&g.push(`Repeating interactions: <b>${h}</b> pair(s) keep showing up.`),(D=(O=e.behavior)==null?void 0:O.bots)!=null&&D.length){let E=e.behavior.bots[0];g.push(`Bot-like timing: top candidate <button class="addr-link mono" data-addr="${y(E.acct)}">${y(z(E.acct))}</button> (CV ${E.cv.toFixed(2)}).`)}if((I=r==null?void 0:r.signals)!=null&&I.length&&g.push(`DEX signals: <b>${y(r.signals.join(" \xB7 "))}</b>`),(F=e.clusters)!=null&&F.length&&g.push(`Largest cluster: <b>${e.clusters[0].size}</b> wallets \xB7 hub <button class="addr-link mono" data-addr="${y(e.clusters[0].hub)}">${y(z(e.clusters[0].hub))}</button>.`),(H=e.advanced)!=null&&H.pathPays&&g.push(`Autobridge/path flow: <b>${e.advanced.pathPays}</b> path payments detected in sample.`),g.length||g.push("Nothing urgent stands out in the current window."),p&&(p.innerHTML=f.map(E=>`<div class="landscape-row">${E}</div>`).join("")),m&&(m.innerHTML=g.map(E=>`<div class="landscape-row">${E}</div>`).join("")),u){let E=qb(e);u.innerHTML=E.length?E.map(j=>`
  ...
  `,e.prepend(t)}function Vb(e){var p,m;if(!document.getElementById("dex-pattern-card"))return;let t=e.window.total||0,n=t?Math.round(e.window.cancelRatio*100):0,s=t?Math.round(e.topShare*100):0;V("dexp-badge",t?`${t} offer tx \xB7 ${n}% cancels`:"Quiet");let a=x("dexp-cancel-bar");a&&(a.style.width=`${we(n,0,100)}%`),V("dexp-cancel-val",t?`${n}%`:"\u2014");let o=x("dexp-topshare-bar");o&&(o.style.width=`${we(s,0,100)}%`),V("dexp-topshare-val",t?`${s}%`:"\u2014");let i=e.burstPct,r=i==null?0:Math.min(100,Math.abs(i)),l=x("dexp-burst-bar");l&&(l.style.width=`${r}%`),V("dexp-burst-val",i==null?"\u2014":yn(i,0)),V("dexp-cpm",e.now.cancelsPerMin==null?"\u2014":e.now.cancelsPerMin.toFixed(1)),V("dexp-hhi",t?e.actorHHI.toFixed(2):"\u2014"),V("dexp-totalwin",t?`${t}`:"\u2014");let c=x("dexp-signals");c&&(c.innerHTML=e.signals.length?e.signals.map(f=>`<span class="sig-pill warn">${y(f)}</span>`).join(""):'<span class="sig-pill ok">No strong DEX signals</span>');let d=x("dexp-cancellers");d&&(d.innerHTML=(p=e.topCanceller)!=null&&p.length?e.topCanceller.slice(0,5).map(f=>`
        ...
        <div class="dex-rowline">
          <button class="addr-link mono cut" data-addr="${y(f.acct)}">${y(z(f.acct))}</button>
          <span class="mono">${f.count}</span>
        </div>`).join(""):'<div style="opacity:.7">\u2014</div>')}function Gb(){if(Hp)return;Hp=!0;let e=document.querySelector(".dashboard-col-main");if(!e)return;let t=document.createElement("section");t.className="widget-card",t.id="risk-card",t.setAttribute("aria-label","Risk panel"),t.innerHTML=`
    <div class="widget-header">
  ...
  `,t.querySelectorAll(".risk-box-toggle").forEach(n=>{var a;n.addEventListener("click",()=>{let o=n.getAttribute("data-target"),i=document.getElementById(o);if(!i)return;let r=n.getAttribute("aria-expanded")!=="false";n.setAttribute("aria-expanded",r?"false":"true"),i.classList.toggle("risk-collapsed",r),n.querySelector(".risk-box-chevron").textContent=r?"\u25B8":"\u25BE";try{localStorage.setItem("risk_collapsed_"+o,r?"1":"0")}catch{}});let s=n.getAttribute("data-target");try{localStorage.getItem("risk_collapsed_"+s)==="1"&&(n.setAttribute("aria-expanded","false"),(a=document.getElementById(s))==null||a.classList.add("risk-collapsed"),n.querySelector(".risk-box-chevron").textContent="\u25B8")}catch{}}),e.appendChild(t)}function Kb(e){var r,l,c,d,u,p,m,f,g,b;if(!document.getElementById("risk-card"))return;V("risk-badge",`Risk ${e.friction}/100`),V("risk-regime",e.regime),V("risk-friction",`${e.friction}/100`);let t=[];e.hhi>=.35&&t.push({cls:"warn",t:"High concentration"}),e.breadcrumbs.filter(h=>h.count>=2).length>=3&&t.push({cls:"new",t:"Repeating counterparties"}),(l=(r=e.behavior)==null?void 0:r.bots)!=null&&l.length&&t.push({cls:"warn",t:"Bot-like timing"}),(d=(c=e.dexPatterns)==null?void 0:c.signals)!=null&&d.length&&t.push({cls:"warn",t:"DEX churn signals"}),((u=e.advanced)==null?void 0:u.selfTradeCount)>0&&t.push({cls:"warn",t:`Self-transfer: ${e.advanced.selfTradeCount}`}),(((p=e.advanced)==null?void 0:p.roundnessIdx)??0)>=45&&t.push({cls:"warn",t:`Round-number bias ${e.advanced.roundnessIdx}%`}),((m=e.advanced)==null?void 0:m.pathPays)>0&&t.push({cls:"warn",t:`Path flow: ${e.advanced.pathPays}`}),V("risk-signalcount",`${t.length}`);let n=x("risk-pills");n&&(n.innerHTML=t.length?t.map(h=>`<span class="sig-pill ${h.cls}">${y(h.t)}</span>`).join(""):'<span class="sig-pill ok">No elevated signals</span>');let s=x("risk-bots");if(s){let h=((f=e.behavior)==null?void 0:f.bots)||[];if(h.length){let v={};for(let k of h){let $=k.botType||"Periodic";v[$]||(v[$]=[]),v[$].push(k)}let w=["Market Maker","Arbitrage","Flood / Spam","Periodic"];s.innerHTML=w.filter(k=>v[k]).map(k=>{let $=v[k];return`<div class="bot-type-group">
          ...
          `).join("")}
        </div>`}).join("")}else s.innerHTML='<div style="opacity:.7;font-size:.84rem">No periodic bots detected yet</div>'}let a=x("risk-amm");if(a){let h=e.advanced||{},{ammCreate:v=0,ammDeposit:w=0,ammWithdraw:k=0,ammVote:$=0,ammBid:T=0,lpTotal:S=0,lpNetFlow:N=0,lpRatio:P,lpUniqueActors:C=0}=h;if(S===0)a.innerHTML='<div style="opacity:.6;font-size:.84rem">No AMM activity in this ledger</div>';else{let R=N>0?"#50fa7b":N<0?"#ff5555":"rgba(255,255,255,.5)";a.innerHTML=`
        <div class="amm-chips">
    ...
    `,e.prepend(t)}}}function Yb(){fe.dexPressure=[],fe.nftMints=[],fe.nftBurns=[],fe.autoBridge=[],Xi.clear(),Object.keys(Bi).forEach(e=>delete Bi[e]),Su({offerTotal:null,dexCancelPct:null,dexTopSharePct:null,mints:null,burns:null,pathPays:null,topPathActors:[],topPathPairs:[]})}function ds(e,t,n){for(e.push(Number(t||0));e.length>n;)e.shift()}function Qb(e){var n,s,a,o;let t=e==null?void 0:e.advanced;t&&(ds(fe.dexPressure,t.offerTotal,jg),ds(fe.nftMints,t.mints,_p),ds(fe.nftBurns,t.burns,_p),ds(fe.autoBridge,t.pathPays,Wg),Su(t),(n=ye.dexPressure)==null||n.draw(fe.dexPressure),(s=ye.nftMints)==null||s.draw(fe.nftMints),(a=ye.nftBurns)==null||a.draw(fe.nftBurns),(o=ye.autoBridge)==null||o.draw(fe.autoBridge))}function Su(e){var t,n,s;if(document.getElementById("dex-pressure-card")&&(V("dexP-badge",e.offerTotal==null?"Waiting\u2026":`${e.offerTotal} offer tx`),V("dexP-now",e.offerTotal==null?"\u2014":e.offerTotal),V("dexP-cancel",e.dexCancelPct==null?"\u2014":`${e.dexCancelPct}%`),V("dexP-share",e.dexTopSharePct==null?"\u2014":`${e.dexTopSharePct}%`)),document.getElementById("autobridge-card")){V("ab-badge",e.pathPays==null?"Waiting\u2026":`${e.pathPays} path pays`),V("ab-now",e.pathPays==null?"\u2014":e.pathPays);let a=(t=e.topPathActors)==null?void 0:t[0];V("ab-top-actor",a?z(a.acct):"\u2014"),V("ab-pairs",(n=e.topPathPairs)!=null&&n.length?e.topPathPairs.length:"\u2014");let o=x("ab-top-pairs");o&&(o.innerHTML=(s=e.topPathPairs)!=null&&s.length?e.topPathPairs.map(i=>`
          <div class="dex-rowline">
            <span class="mono cut">${y(z(i.from))}</span>
            <span style="opacity:.7">\u2192</span>
            <span class="mono cut">${y(z(i.to))}</span>
            <span class="mono">${i.count}</span>
          </div>`).join(""):'<div style="opacity:.7">\u2014</div>')}if(document.getElementById("nft-mint-card")){let a=Number(e.mints||0)-Number(e.burns||0);V("nft-badge",e.mints==null&&e.burns==null?"Waiting\u2026":`${e.mints||0} mints \xB7 ${e.burns||0} burns`),V("nft-mints-now",e.mints==null?"\u2014":e.mints),V("nft-burns-now",e.burns==null?"\u2014":e.burns),V("nft-net-now",`${a}`)}}function to({force:e=!1}={}){if(!Yt()){Vi();return}fn&&!e||(fn&&(clearInterval(fn),fn=null),au(),fn=setInterval(()=>{Yt()&&au()},qg))}function Vi(){fn&&(clearInterval(fn),fn=null)}async function au(){var t,n,s,a,o,i,r,l,c,d;let e=++_i;V("mkt-badge","Loading\u2026");try{let p=await fetch("https://api.exchange.coinbase.com/products/XRP-USD/candles?granularity=3600",{cache:"no-store"});if(!p.ok)throw new Error("market history failed");let m=await p.json();if(!Array.isArray(m)||m.length<10)throw new Error("no history");if(e!==_i)return;let f=[...m].sort((k,$)=>Number(k[0])-Number($[0])),g=f.map(k=>Number(k[4])).filter(Number.isFinite),b=f.map(k=>Number(k[5])).filter(Number.isFinite);fe.marketPrice=g.slice(-Wa),fe.marketVol=b.slice(-Wa);let h=fe.marketPrice.at(-1),v=fe.marketPrice.length>24?fe.marketPrice.at(-25):fe.marketPrice.at(0),w=v&&h?(h-v)/v*100:null;V("mkt-badge",h?`$${h.toFixed(4)}`:"\u2014"),V("mkt-price",h?`$${h.toFixed(4)}`:"\u2014"),V("mkt-chg",w==null?"\u2014":yn(w,2)),V("mkt-upd",new Date().toLocaleTimeString()),(t=ye.marketPrice)==null||t.draw(fe.marketPrice),(n=ye.marketVol)==null||n.draw(fe.marketVol);return}catch{}try{let u=await fetch("https://api.coinpaprika.com/v1/tickers/xrp-xrp",{cache:"no-store"});if(!u.ok)throw new Error("tick failed");let p=await u.json();if(e!==_i)return;let m=Number((a=(s=p==null?void 0:p.quotes)==null?void 0:s.USD)==null?void 0:a.price),f=Number((i=(o=p==null?void 0:p.quotes)==null?void 0:o.USD)==null?void 0:i.volume_24h),g=Number((l=(r=p==null?void 0:p.quotes)==null?void 0:r.USD)==null?void 0:l.percent_change_24h);Number.isFinite(m)&&(ds(fe.marketPrice,m,Wa),Number.isFinite(f)&&ds(fe.marketVol,f,Wa)),V("mkt-badge",Number.isFinite(m)?`$${m.toFixed(4)}`:"\u2014"),V("mkt-price",Number.isFinite(m)?`$${m.toFixed(4)}`:"\u2014"),V("mkt-chg",Number.isFinite(g)?`${g>=0?"\u2191":"\u2193"}${Math.abs(g).toFixed(2)}%`:"\u2014"),V("mkt-upd",new Date().toLocaleTimeString()),(c=ye.marketPrice)==null||c.draw(fe.marketPrice),(d=ye.marketVol)==null||d.draw(fe.marketVol)}catch{V("mkt-badge","Unavailable")}}function Zb(){var n,s,a,o;if(Gp)return;Gp=!0;let e=document.querySelector(".dashboard-fullwidth");if(!e){e=document.createElement("div"),e.className="dashboard-fullwidth";let i=document.querySelector(".dashboard-columns");i?i.insertAdjacentElement("afterend",e):(n=document.querySelector(".dashboard-page"))==null||n.appendChild(e)}if(document.getElementById("spam-defense-card"))return;let t=document.createElement("section");t.className="widget-card",t.id="spam-defense-card",t.setAttribute("aria-label","Spam defense"),Gi(),Mu(),t.innerHTML=`
  ...
  `,e.appendChild(t),(s=x("spam-copy-hash"))==null||s.addEventListener("click",()=>{var i;return ou(((i=x("spam-proof-hash"))==null?void 0:i.textContent)||"")}),(a=x("spam-copy-json"))==null||a.addEventListener("click",()=>{var i;return ou(((i=x("spam-proof-json"))==null?void 0:i.textContent)||"")}),(o=x("spam-print-proof"))==null||o.addEventListener("click",dv),_renderBondSim()}window._toggleBondSim=function(){let e=x("spam-sim-panel");if(!e)return;let t=e.style.display!=="none";e.style.display=t?"none":"";let n=x("spam-sim-toggle");n&&(n.style.color=t?"":"#00d4ff")};window._renderBondSim=function(){let e=document.getElementById("sim-base"),t=document.getElementById("sim-growth"),n=document.getElementById("sim-table");if(!n)return;let s=Number((e==null?void 0:e.value)||bs),a=Number((t==null?void 0:t.value)||vs),o=fe.marketPrice.at(-1)??null;document.getElementById("sim-base-val")&&(document.getElementById("sim-base-val").textContent=s+" XRP"),document.getElementById("sim-growth-val")&&(document.getElementById("sim-growth-val").textContent=a+"\xD7");let i="";for(let r=0;r<=Ys;r++){let l=Math.round(s*a**r),c=o?"$"+(l*o).toLocaleString(void 0,{maximumFractionDigits:0}):"",d=r<3?"#50fa7b":r<6?"#ffb86c":"#ff5555";i+=`<div style="padding:5px;border-radius:6px;background:rgba(255,255,255,.03);border:1px solid rgba(255,255,255,.07)">
      ...
      ${c?`<div style="font-size:.62rem;opacity:.45">${c}</div>`:""}
    </div>`}n.innerHTML=i};async function ou(e){try{await navigator.clipboard.writeText(String(e||"")),ne("Copied")}catch{he("Copy failed (browser blocked clipboard).")}}function Ks(e){let t=we(Number(e)||0,0,Ys);return Math.round(bs*vs**t)}function Gi(){try{let e=JSON.parse(localStorage.getItem(mu)||"[]");ie.allowList=new Set(e)}catch{ie.allowList=new Set}}function Tu(){try{localStorage.setItem(mu,JSON.stringify([...ie.allowList]))}catch{}}function Cu(e){He(e)&&(ie.allowList.add(e),Tu(),ie.byAddr.delete(e),ne(`${z(e)} added to allow-list \u2014 will no longer be flagged`))}window._spamAllowAddr=Cu;function Pu(){try{return JSON.parse(localStorage.getItem(uu)||"{}")}catch{return{}}}function ev(e){try{localStorage.setItem(uu,JSON.stringify(e))}catch{}}function Mu(){let e=Pu();for(let[t,n]of Object.entries(e))ie.verifiedCache.set(t,n)}window.exportSpamReputation=function(){let e=[...ie.byAddr.entries()].map(([o,i])=>({addr:o,level:i.level,strikes:i.strikes,score:+(i.score||0).toFixed(4),threatType:i.threatType||"Unknown",verified:!!i.verifiedLedger,verifiedLedger:i.verifiedLedger??null,lastSeen:i.lastSeenLedger??null})),t={v:2,network:X.currentNetwork||"xrpl-mainnet",exportedAt:new Date().toISOString(),allowList:[...ie.allowList],suspects:e,policy:{bondBaseXrp:bs,bondGrowth:vs,ratchetMax:Ys}},n=new Blob([JSON.stringify(t,null,2)],{type:"application/json"}),s=URL.createObjectURL(n),a=document.createElement("a");a.href=s,a.download=`naluxrp_reputation_${new Date().toISOString().slice(0,10)}.json`,document.body.appendChild(a),a.click(),document.body.removeChild(a),URL.revokeObjectURL(s),ne("Reputation list exported")};window.importSpamReputation=function(e){if(!e)return;let t=new FileReader;t.onload=n=>{var s;try{let a=JSON.parse(n.target.result);if(!a.suspects)throw new Error("Invalid format");let o=0;for(let i of a.suspects){if(!He(i.addr))continue;let r=ie.byAddr.get(i.addr)||{};ie.byAddr.set(i.addr,{...r,level:i.level??0,strikes:i.strikes??0,score:i.score??0,threatType:i.threatType??"Unknown",verifiedLedger:i.verifiedLedger??null,lastSeenLedger:i.lastSeen??null,scoreHistory:[],signalBreakdown:{}}),o++}if((s=a.allowList)!=null&&s.length){for(let i of a.allowList)He(i)&&ie.allowList.add(i);Tu()}ne(`Imported ${o} reputation entries`)}catch(a){he("Import failed: "+a.message)}},t.readAsText(e)};function tv(e){var l,c;if(!document.getElementById("spam-defense-card"))return;let t=ov(e),n=t.reduce((d,u)=>Math.max(d,u.level),0),s=t.filter(d=>d.verified).length,a=fe.marketPrice.at(-1)??null,o=t.reduce((d,u)=>d+Ks(u.level),0),i=a?`~$${(o*a).toLocaleString(void 0,{maximumFractionDigits:0})}`:`${o} XRP`;V("spam-count",t.length),V("spam-maxlvl",`L${n}`),V("spam-verified",s),V("spam-allowcount",ie.allowList.size),V("spam-bondusd",i),V("spam-badge",t.length?`${t.length} tracked \xB7 max L${n}`:"Quiet");let r=x("spam-list");if(r&&(t.length?r.innerHTML=t.map(d=>{let u=Ks(d.level),p=a?` (~$${(u*a).toFixed(0)})`:"",m=d.level>=6?"#ff5555":d.level>=3?"#ffb86c":"#50fa7b",f=d.score>=.7?"#ff5555":d.score>=.4?"#ffb86c":"#50fa7b",g={"Payment Flooder":"#ff5555","Quote Stuffer":"#ff5555","Wash Trader":"#ff5555","DEX Bot":"#ffb86c","Arb Router":"#00d4ff","Periodic Bot":"#bd93f9"}[d.threatType]||"rgba(255,255,255,.6)",b=d.verified?`<span class="spam-cred-chip">\u2714 L${d.level} verified</span>`:"",h=nv(d.scoreHistory||[]);return`
          <div class="spam-card" data-spam-addr="${y(d.addr)}">
            ...
            <div class="spam-breakdown" id="spam-bd-${y(d.addr.slice(0,10))}" style="display:none">
              ${sv(d.breakdown,d.strikes)}
            </div>
          </div>`}).join(""):r.innerHTML=`<div class="spam-empty">No suspects flagged \u2014 allow-list has ${fu.size} known-good entities.</div>`),ji||av(),ie.selectedAddr){let d=ie.byAddr.get(ie.selectedAddr);d?Ki(ie.selectedAddr,d,e.s.ledgerIndex).then(u=>gs(u)):gs(null)}((l=document.getElementById("spam-sim-panel"))==null?void 0:l.style.display)!=="none"&&((c=window._renderBondSim)==null||c.call(window))}function nv(e){if(!(e!=null&&e.length))return"";let t=42,n=14,s=1,a=t/Math.max(1,e.length-1),o=e.map((l,c)=>`${(c*a).toFixed(1)},${(n-2-l/s*(n-4)).toFixed(1)}`).join(" "),i=e.at(-1)??0,r=i>=.7?"#ff5555":i>=.4?"#ffb86c":"#50fa7b";return`<svg width="${t}" height="${n}" xmlns="http://www.w3.org/2000/svg" style="overflow:visible">
    ...
    <circle cx="${((e.length-1)*a).toFixed(1)}" cy="${(n-2-i/s*(n-4)).toFixed(1)}"
      r="2" fill="${r}"/>
  </svg>`}function sv(e={},t=0){let n=[{label:"Bot timing",val:e.bot??0,desc:e.botType?`Type: ${e.botType}`:"Low variance in repeated ledger appearances"},{label:"DEX dominance",val:e.dexDom??0,desc:"Share of offer tx window controlled by this address"},{label:"Cancel pattern",val:e.cancelPat??0,desc:"Heavy OfferCancel activity relative to creates"},{label:"Ping-pong loop",val:e.pingPong??0,desc:"Bidirectional repeated payments between two addresses"},{label:"Path routing",val:e.pathRoute??0,desc:"High path-payment count \u2014 common in arb bots"},{label:"Self-transfer",val:e.selfTrade??0,desc:"Payments where sender = receiver"},{label:"Round-number pay",val:e.roundPay??0,desc:"Unusual bias toward exact round-number payment amounts"}].filter(s=>s.val>.001);return n.length?`
    <div style="margin-top:8px;border-top:1px solid rgba(255,255,255,.06);padding-top:8px">
    ...
    </div>`:'<div style="opacity:.5;font-size:.78rem;padding:6px 0">No significant signal breakdown available yet.</div>'}var ji=!1;function av(){ji||(ji=!0,document.addEventListener("click",e=>{var a,o,i,r;let t=(o=(a=e.target).closest)==null?void 0:o.call(a,"button[data-action][data-spam-addr]");if(!t)return;let n=t.getAttribute("data-action"),s=t.getAttribute("data-spam-addr");if(s){if(n==="proof"){let l=ie.byAddr.get(s);if(!l)return;ie.selectedAddr=s;let c=x("spam-proof");if(c){c.style.display="";let d=x("spam-proof-hash");d&&(d.textContent="Computing SHA-512Half\u2026")}Ki(s,l,((r=(i=X.ledgerLog)==null?void 0:i[0])==null?void 0:r.ledgerIndex)||null).then(d=>{ie.selectedProof=d,gs(d)}).catch(d=>he("Proof build failed: "+d.message));return}if(n==="clear"){ie.byAddr.delete(s),ie.selectedAddr===s&&gs(null),ne("Cleared from session");return}if(n==="allow"){Cu(s),ie.byAddr.delete(s),ie.selectedAddr===s&&gs(null);return}if(n==="expand"){let l=s.slice(0,10),c=document.getElementById("spam-bd-"+l);if(!c)return;let d=c.style.display!=="none";c.style.display=d?"none":"",t.textContent=d?"\u25BE Detail":"\u25B4 Hide";return}}}))}function gs(e){let t=x("spam-proof");if(!t)return;if(!e){t.style.display="none";return}t.style.display="",V("spam-proof-hash",e.hash);let n=x("spam-proof-json");n&&(n.textContent=e.canonicalJson);let s=x("spam-cred-step");s&&(s.innerHTML=`
      <div style="opacity:.9">
      ...
      <ul style="margin:8px 0 0 18px;opacity:.9">
        ...
        <li>Include a Memo that starts with <span class="mono">${hn}</span> and then the proof hash.</li>
    ...
    `)}function ov(e){var o,i,r,l,c;ie.allowList.size||Gi();let t=new Set;(((o=e.behavior)==null?void 0:o.bots)||[]).forEach(d=>t.add(d.acct)),(((i=e.dexPatterns)==null?void 0:i.topActor)||[]).forEach(d=>t.add(d.acct)),(((r=e.dexPatterns)==null?void 0:r.topCanceller)||[]).forEach(d=>t.add(d.acct)),(((l=e.dexPatterns)==null?void 0:l.topMaker)||[]).forEach(d=>t.add(d.acct)),(e.breadcrumbs||[]).forEach(d=>{t.add(d.from),t.add(d.to)}),(e.clusters||[]).forEach(d=>{t.add(d.hub),(d.members||[]).forEach(u=>t.add(u))}),(((c=e.advanced)==null?void 0:c.topPathActors)||[]).forEach(d=>t.add(d.acct));let n=Number(e.s.ledgerIndex||0)||null,s=e.txs||[],a=[];if(n&&n%50===0){let d=Ka*24;for(let[u,p]of ie.byAddr)n-(p.lastSeenLedger||0)>d&&ie.byAddr.delete(u)}for(let d of t){if(!He(d)||fu.has(d)||ie.allowList.has(d))continue;let{score:u,breakdown:p}=rv(d,e),m=iv(p),f=ie.byAddr.get(d)||{strikes:0,level:0,score:0,verifiedLedger:null,lastSeenLedger:null,scoreHistory:[],threatType:"Unknown",signalBreakdown:{}},g=f.strikes||0;u>=pu?g+=1:u<=Fi&&(g=Math.max(0,g-1));let b=f.lastSeenLedger||n,h=n?n-b:0;if(h>Ka&&u<Fi){let S=Math.floor(h/Ka);g=Math.max(0,g-S)}let v=we(Math.floor(g/du),0,Ys),w=[...f.scoreHistory||[],u].slice(-10),k=ie.verifiedCache.get(d),$=f.verifiedLedger??(k==null?void 0:k.ledgerIndex)??null;$||($=lv(d,v,s,n),$&&cv(d,v,n));let T={score:u,strikes:g,level:v,verifiedLedger:$,lastSeenLedger:n,scoreHistory:w,threatType:m,signalBreakdown:p};ie.byAddr.set(d,T),a.push({addr:d,score:u,strikes:g,level:v,verified:!!$,verifiedLedger:$,scoreHistory:w,threatType:m,breakdown:p})}return a.sort((d,u)=>u.level-d.level||u.score-d.score),a.slice(0,Vg)}function iv(e){let{bot:t=0,dexDom:n=0,cancelPat:s=0,pingPong:a=0,pathRoute:o=0,selfTrade:i=0,roundPay:r=0}=e,l=n+s;return t>.25&&(e.botType==="Flood / Spam"||r>.05)?"Payment Flooder":t>.2&&l>.15?"DEX Bot":l>.3&&s>.1?"Quote Stuffer":a>.1?"Wash Trader":o>.1?"Arb Router":t>.2?"Periodic Bot":"Multi-Signal"}function rv(e,t){var m,f,g,b,h;let n={bot:0,botType:null,dexDom:0,cancelPat:0,pingPong:0,pathRoute:0,selfTrade:0,roundPay:0},s=(((m=t.behavior)==null?void 0:m.bots)||[]).find(v=>v.acct===e);if(s){let v=we((.35-s.cv)/.35,0,1);n.bot=+(.4*(.5+.5*v)).toFixed(3),n.botType=s.botType||"Periodic"}let a=t.dexPatterns,o=((g=(f=a==null?void 0:a.topActor)==null?void 0:f[0])==null?void 0:g.acct)===e&&a.topShare||0;o>0&&(n.dexDom=+(.3*we((o-.2)/.4,0,1)).toFixed(3));let i=((a==null?void 0:a.topCanceller)||[]).find(v=>v.acct===e);i&&(n.cancelPat=+(.2*we(i.count/20,0,1)).toFixed(3));let r=t.breadcrumbs||[],l=r.find(v=>v.from===e&&v.to===e);l&&(n.selfTrade=+(.2*we(l.count/20,0,1)).toFixed(3));let c=r[0];if(c&&(c.from===e||c.to===e)){let v=r.find(w=>w.from===c.to&&w.to===c.from);v&&v.count>=3&&c.count>=3&&(n.pingPong=.15)}let d=(((b=t.advanced)==null?void 0:b.topPathActors)||[]).find(v=>v.acct===e);d&&(n.pathRoute=+(.15*we(d.count/25,0,1)).toFixed(3));let u=(h=t.advanced)==null?void 0:h.roundnessIdx;return u!=null&&u>=45&&(d||s)&&(n.roundPay=+(.1*we((u-45)/35,0,1)).toFixed(3)),{score:we(n.bot+n.dexDom+n.cancelPat+n.pingPong+n.pathRoute+n.selfTrade+n.roundPay,0,1),breakdown:n}}function lv(e,t,n,s){if(!(n!=null&&n.length))return null;let a=ps+t;for(let o of n)if((o==null?void 0:o.account)===e){if(o.type==="EscrowCreate"&&o.destination===e){let i=typeof o.amountXrp=="number"?o.amountXrp:null,r=Ks(t);if(i!=null&&i>=r&&Wi(o.memos).startsWith(hn))return s}if(o.type==="Payment"&&o.destination===e&&Number(o.destinationTag)===a&&Wi(o.memos).startsWith(hn))return s}return null}async function cv(e,t,n){var a;let s=ie.byAddr.get(e);if(s)try{let o=await Ki(e,s,n),i=hn+o.hash;if((((a=X.ledgerLog)==null?void 0:a.flatMap(c=>c.transactions||[]))||[]).some(c=>(c==null?void 0:c.account)!==e?!1:Wi(c.memos).startsWith(i))){let c=Pu();c[e]={ledgerIndex:n,hash:o.hash,level:t},ev(c),ie.verifiedCache.set(e,{ledgerIndex:n,hash:o.hash}),ne(`\u2714 Credential verified for ${z(e)} at L${t}`)}}catch{}}function Wi(e){if(!Array.isArray(e))return"";let t=[];for(let n of e){let s=(n==null?void 0:n.Memo)||(n==null?void 0:n.memo)||null;if(!s)continue;let a=s.MemoData||s.memo_data||"";try{if(typeof a=="string"&&/^[0-9A-Fa-f]+$/.test(a)&&a.length%2===0){let o=Uint8Array.from(a.match(/../g),i=>parseInt(i,16));t.push(new TextDecoder().decode(o))}else typeof a=="string"&&t.push(a)}catch{}}return t.join(" ")}async function Ki(e,t,n){let s=t.level||0,a=Ks(s),o=fe.marketPrice.at(-1)??null,i=o?(a*o).toFixed(2):null,r={hashAlgorithm:"SHA-512Half",ratchetMax:Ys,strikesToLevel:du,strikeUp:pu,strikeDown:Fi,decayLedgers:Ka,bondBaseXrp:bs,bondGrowthFactor:vs,bondRequiredXrp:a,bondRequiredUsd:i,credTagBase:ps,memoPrefix:hn,credentialTag:ps+s},l={v:2,hashAlg:"SHA-512Half",network:X.currentNetwork||"xrpl-mainnet",address:e,ledgerIndex:n!=null?Number(n):null,level:s,threatType:t.threatType||"Unknown",score:Number((t.score||0).toFixed(4)),strikes:Number(t.strikes||0),signalBreakdown:t.signalBreakdown||{},credential:{destinationTag:ps+s,memoFormat:hn+"<SHA-512Half-of-this-proof>",verifiedLedger:t.verifiedLedger??null},policy:r,note:"Generated by NaluXRP Spam Defense POC. Hash uses XRPL-native SHA-512Half (first 256 bits of SHA-512). A gateway or relayer policy can require the indicated bond/credential before providing service to this address.",generatedAt:new Date().toISOString()},c=JSON.stringify(l,Object.keys(l).sort(),0),d=await Zg(c);l.credential.memoFormat=hn+d;let u=JSON.stringify(l,null,2);return{hash:d,canonicalJson:u,level:s,policy:r,threatType:t.threatType}}function dv(){let e=ie.selectedProof;if(!e){he("Generate a proof first using the Proof button.");return}let t=ie.selectedAddr||"\u2014",n=fe.marketPrice.at(-1)??null,s=e.policy.bondRequiredXrp,a=n?` (~$${(s*n).toFixed(0)} USD)`:"",o=e.hash.startsWith("FALLBACK")?'<div style="padding:8px 12px;background:#fff3cd;border:1px solid #f0ad4e;border-radius:4px;margin-bottom:12px">\u26A0 Hash is non-cryptographic (SubtleCrypto unavailable). Do NOT use for enforcement.</div>':"",i=window.open("","_blank","width=760,height=660");i.document.write(`<!DOCTYPE html><html><head>
    ...
    <div class="section">
      ...
      <p style="font-size:.85rem"><b>Option A (Bond Escrow):</b> EscrowCreate from suspect address to itself,
        ${s.toLocaleString()} XRP, finish ~25,000 ledgers from now, memo = <code>${hn}${e.hash}</code></p>
    ...
    </body></html>`),i.document.close()}var Lu=null;function pv(){if(Oi)return;Oi=!0;let e=document.querySelector('[aria-label="Pattern detection"]');if(!e){e=document.createElement("section"),e.className="widget-card",e.setAttribute("aria-label","Pattern detection");let t=document.querySelector(".dashboard-col-main");if(!t)return;let n=t.querySelector(".dashboard-metrics");n?n.insertAdjacentElement("afterend",e):t.prepend(e)}e.innerHTML=`
    <div class="widget-header">
    ...
    </div>`,e.prepend(t)}function gv(){let e=x("whale-feed-list");if(!e)return;let t=x("whale-badge");if(t&&(t.textContent=Dt.length?`${Dt.length} alerts`:"Watching\u2026"),!Dt.length){e.innerHTML='<div style="opacity:.5;font-size:.82rem;padding:8px 0">No whale transactions yet.</div>';return}e.innerHTML=Dt.slice(0,20).map(n=>{let s=n.amtXrp>=1e6?`${(n.amtXrp/1e6).toFixed(2)}M`:n.amtXrp>=1e3?`${(n.amtXrp/1e3).toFixed(0)}K`:n.amtXrp.toFixed(0),a=Math.floor((Date.now()-n.ts)/1e3),o=a<60?`${a}s`:a<3600?`${Math.floor(a/60)}m`:`${Math.floor(a/3600)}h`;return`<div style="border-bottom:1px solid rgba(255,255,255,.05);padding:7px 0">
    ...
    </div>`}).join("")}function bv(){if(Jp)return;Jp=!0;let e=document.querySelector(".dashboard-col-main");if(!e)return;let t=document.createElement("section");t.className="widget-card",t.id="network-health-card",t.setAttribute("aria-label","Network health"),t.innerHTML=`
    <div class="widget-header">
    ...
    <div style="display:flex;align-items:center;gap:16px;padding:8px 0 12px">
      ...
      </div>`}).join(""))}function yv(){if(Yp)return;Yp=!0;let e=document.querySelector(".dashboard-col-side");if(!e)return;let t=document.createElement("section");t.className="widget-card",t.id="session-stats-card",t.setAttribute("aria-label","Session stats"),t.innerHTML=`
    <div class="widget-header">
    ...
    </div>`,e.appendChild(t)}function wv(){if(!document.getElementById("session-stats-card"))return;let e=Math.floor((Date.now()-tt.startTime)/6e4);V("ss-ledgers",tt.ledgersProcessed.toLocaleString()),V("ss-tx",tt.totalTx.toLocaleString()),V("ss-whales",tt.whaleCount),V("ss-feespikes",tt.feeSpikes),V("ss-bots",tt.botDetections),V("ss-dexalerts",tt.dexAlerts),V("ss-time",`${e}m`),V("ss-badge",`${tt.ledgersProcessed} ledgers`)}function xv(e,t){var o,i,r,l,c,d,u,p;if(hu=t,Dt.length&&Dt[0].ledgerIndex===t){let m=Dt[0],f=m.amtXrp>=1e6?`${(m.amtXrp/1e6).toFixed(1)}M`:`${(m.amtXrp/1e3).toFixed(0)}K`;ne(`\u{1F40B} Whale: ${f} XRP  ${z(m.from)} \u2192 ${z(m.to)}`)}let n=wu(),s=(o=X.feeHistory)==null?void 0:o.at(-1);s&&n&&s>n*Hn.feeSpikeMultiple&&(tt.feeSpikes++,he(`\u{1F525} Fee spike: ${gn(s)} (${Math.round(s/n)}\xD7 baseline)`));let a=(((i=e.behavior)==null?void 0:i.bots)||[]).filter(m=>m.cv<Hn.botCvThreshold&&m.total>8);a.length&&(tt.botDetections=Math.max(tt.botDetections,a.length),a[0].botType==="Flood / Spam"&&he(`\u{1F916} Spam bot: ${z(a[0].acct)} (CV ${a[0].cv.toFixed(2)})`)),((l=(r=e.dexPatterns)==null?void 0:r.window)==null?void 0:l.cancelRatio)>=Hn.dexCancelAlert&&((d=(c=e.dexPatterns)==null?void 0:c.window)==null?void 0:d.total)>=20&&(tt.dexAlerts++,he(`\u{1F9E0} DEX: ${Math.round(e.dexPatterns.window.cancelRatio*100)}% cancel ratio \u2014 possible quote-stuffing`)),((p=(u=e.clusters)==null?void 0:u[0])==null?void 0:p.size)>=Hn.clusterMinSize&&ne(`\u{1F578} Cluster: ${e.clusters[0].size} wallets around ${z(e.clusters[0].hub)}`),e.friction>=75&&e.regime==="Manipulated"&&he(`\u26A0\uFE0F Risk score: ${e.friction}/100 \u2014 ${e.regime} regime`),vv(e.s)}function kv(){var n,s,a,o;if(Qp)return;Qp=!0;let e=document.createElement("button");e.id="customize-btn",e.className="customize-btn",e.setAttribute("aria-pressed","false"),e.innerHTML="\u2699 Customize",(n=document.querySelector(".dashboard-header"))==null||n.appendChild(e);let t=document.createElement("div");t.id="customize-panel",t.className="customize-panel",t.setAttribute("aria-label","Dashboard customizer"),t.innerHTML=`
    ...
    </div>`,document.body.appendChild(t),e.addEventListener("click",()=>iu()),(s=document.getElementById("customize-close"))==null||s.addEventListener("click",()=>iu(!1)),(a=document.getElementById("customize-reset"))==null||a.addEventListener("click",()=>{try{localStorage.removeItem(Qa),localStorage.removeItem(ys)}catch{}ru(),qi(),Ji()}),(o=document.getElementById("customize-export"))==null||o.addEventListener("click",()=>{var i;try{let r={order:JSON.parse(localStorage.getItem(Qa)||"[]"),hidden:JSON.parse(localStorage.getItem(ys)||"[]"),alertConfig:Hn};(i=navigator.clipboard)==null||i.writeText(JSON.stringify(r,null,2)),ne("Config copied to clipboard")}catch{he("Export failed")}}),ru(),qi()}function iu(e){var s;let t=document.getElementById("customize-panel"),n=document.getElementById("customize-btn");!t||!n||(Xn=e??!Xn,t.classList.toggle("customize-panel--open",Xn),n.setAttribute("aria-pressed",String(Xn)),n.textContent=Xn?"\u2715 Close":"\u2699 Customize",Xn&&Ji(),(s=document.querySelector(".dashboard-col-side"))==null||s.classList.toggle("customize-mode",Xn))}function Js(){var e;return[...((e=document.querySelector(".dashboard-col-side"))==null?void 0:e.querySelectorAll(":scope > .widget-card"))||[]]}function ws(e){return e.id||e.getAttribute("aria-label")||""}function $v(e){var t,n;return((n=(t=e.querySelector(".widget-title"))==null?void 0:t.textContent)==null?void 0:n.trim())||ws(e)}function ru(){let e=document.querySelector(".dashboard-col-side");if(!e)return;let t;try{t=JSON.parse(localStorage.getItem(Qa)||"null")}catch{t=null}if(!Array.isArray(t)||!t.length)return;let n=new Map(Js().map(s=>[ws(s),s]));t.forEach(s=>{let a=n.get(s);a&&e.appendChild(a)})}function qi(){let e;try{e=JSON.parse(localStorage.getItem(ys)||"[]")}catch{e=[]}Js().forEach(t=>t.classList.toggle("widget-hidden",e.includes(ws(t))))}function Sv(){try{localStorage.setItem(Qa,JSON.stringify(Js().map(e=>ws(e))))}catch{}}function Tv(e){let t;try{t=JSON.parse(localStorage.getItem(ys)||"[]")}catch{t=[]}t=t.includes(e)?t.filter(n=>n!==e):[...t,e];try{localStorage.setItem(ys,JSON.stringify(t))}catch{}qi(),Ji()}function Ji(){let e=document.getElementById("customize-list");if(!e)return;let t;try{t=JSON.parse(localStorage.getItem(ys)||"[]")}catch{t=[]}e.innerHTML="",Js().forEach(n=>{var r;let s=ws(n),a=$v(n),o=!t.includes(s),i=document.createElement("div");i.className="customize-row",i.setAttribute("draggable","true"),i.dataset.widgetId=s,i.innerHTML=`
      <span class="customize-drag-handle" title="Drag to reorder">\u283F</span>
      <span class="customize-row-title">${y(a)}</span>
      <button class="customize-vis-btn ${o?"vis-on":"vis-off"}" data-id="${y(s)}">${o?"\u{1F441} Visible":"\u{1F6AB} Hidden"}</button>`,i.addEventListener("dragstart",l=>{ls=i,l.dataTransfer.effectAllowed="move",i.classList.add("customize-dragging")}),i.addEventListener("dragend",()=>{i.classList.remove("customize-dragging"),e.querySelectorAll(".customize-row").forEach(d=>d.classList.remove("customize-over"));let l=[...e.querySelectorAll(".customize-row")].map(d=>d.dataset.widgetId),c=document.querySelector(".dashboard-col-side");if(c){let d=new Map(Js().map(u=>[ws(u),u]));l.forEach(u=>{let p=d.get(u);p&&c.appendChild(p)})}Sv()}),i.addEventListener("dragover",l=>{if(l.preventDefault(),l.dataTransfer.dropEffect="move",ls&&ls!==i){e.querySelectorAll(".customize-row").forEach(d=>d.classList.remove("customize-over")),i.classList.add("customize-over");let c=[...e.querySelectorAll(".customize-row")];c.indexOf(ls)<c.indexOf(i)?e.insertBefore(ls,i.nextSibling):e.insertBefore(ls,i)}}),i.addEventListener("dragleave",()=>i.classList.remove("customize-over")),i.addEventListener("drop",l=>l.preventDefault()),(r=i.querySelector(".customize-vis-btn"))==null||r.addEventListener("click",()=>Tv(s)),e.appendChild(i)})}function Cv(){if(Zp)return;Zp=!0;let e=document.querySelector(".dashboard-header");if(!e||document.getElementById("global-pause-btn"))return;let t=document.createElement("button");t.id="global-pause-btn",t.className="global-pause-btn",t.setAttribute("aria-pressed","false"),t.title="Pause all updates \u2014 numbers stop changing so you can read",t.innerHTML="\u23F8 Live",t.addEventListener("click",()=>{Gt=!Gt,t.setAttribute("aria-pressed",String(Gt)),t.innerHTML=Gt?"\u25B6 Paused":"\u23F8 Live",t.classList.toggle("global-pause-btn--paused",Gt),_t=Gt&&!Gs?Gt:_t;let s=document.querySelector(".dashboard-sticky-strip");s&&s.classList.toggle("metrics-paused",Gt)});let n=document.getElementById("customize-btn");n?e.insertBefore(t,n):e.appendChild(t)}var lu=!1;function Pv(){if(lu)return;lu=!0;let e=(t=0)=>{let n=document.querySelector("#risk-card .widget-header"),s=document.querySelector("#landscape-card .widget-header");if(!n&&!s&&t<20){setTimeout(()=>e(t+1),300);return}if(n&&!n.querySelector(".friction-sparkline-wrap")){let a=document.createElement("div");a.className="friction-sparkline-wrap",a.title="Risk score \u2014 last 30 ledgers",a.innerHTML='<canvas id="friction-sparkline-canvas" width="80" height="22"></canvas>',n.appendChild(a)}if(s&&!s.querySelector(".friction-sparkline-wrap")){let a=document.createElement("div");a.className="friction-sparkline-wrap",a.title="Risk score history",a.innerHTML='<canvas id="friction-sparkline-canvas-2" width="60" height="18"></canvas>',s.appendChild(a)}Au()};e()}function Au(){us.length&&(cu("friction-sparkline-canvas",80,22),cu("friction-sparkline-canvas-2",60,18))}function cu(e,t,n){let s=document.getElementById(e);if(!(s!=null&&s.getContext))return;let a=s.getContext("2d");a.clearRect(0,0,t,n);let o=us;if(o.length<2)return;let i=100,r=t/(o.length-1),l=o.map((g,b)=>[b*r,n-2-g.friction/i*(n-4)]),c=n-2-60/i*(n-4);a.fillStyle="rgba(255,85,85,.07)",a.fillRect(0,0,t,c);let d=a.createLinearGradient(0,0,0,n);d.addColorStop(0,"rgba(255,184,108,.35)"),d.addColorStop(1,"rgba(255,184,108,.05)"),a.beginPath(),l.forEach(([g,b],h)=>h===0?a.moveTo(g,b):a.lineTo(g,b)),a.lineTo(l.at(-1)[0],n),a.lineTo(0,n),a.closePath(),a.fillStyle=d,a.fill();let u=o.at(-1).friction,p=u<26?"#50fa7b":u<61?"#ffb86c":"#ff5555";a.beginPath(),l.forEach(([g,b],h)=>h===0?a.moveTo(g,b):a.lineTo(g,b)),a.strokeStyle=p,a.lineWidth=1.5,a.lineJoin="round",a.stroke();let[m,f]=l.at(-1);a.beginPath(),a.arc(m,f,2.5,0,Math.PI*2),a.fillStyle=p,a.fill()}window.printLandscapeReport=function(){var i,r,l,c;if(!document.getElementById("landscape-card"))return;let t=((i=document.getElementById("d2-ledger-index"))==null?void 0:i.textContent)||"\u2014",n=((r=document.getElementById("landscape-badge"))==null?void 0:r.textContent)||"",s=new Date().toLocaleString(),a=window.open("","_blank","width=860,height=700");a.document.write(`<!DOCTYPE html><html><head>
  ...
  `,document.body.appendChild(e);let t=s=>{var a;return(a=document.querySelector(`.dash-tab[data-tab="${s}"]`))==null?void 0:a.click()};e.addEventListener("click",s=>{let a=s.target.closest("button[data-go]");if(!a)return;let o=a.dataset.go;if(o==="profile"){typeof window.showProfile=="function"&&window.showProfile();return}if(X.currentPage!=="dashboard"&&typeof window.showDashboard=="function"&&window.showDashboard(),o==="stream"||o==="inspector"||o==="network"){t(o);return}t("stream"),setTimeout(()=>{var r;let i=o==="dex"?"dex-pattern-card":"risk-card";(r=document.getElementById(i))==null||r.scrollIntoView({behavior:"smooth",block:"start"})},80)});let n=()=>{let s=X.currentPage==="profile",a=X.currentPage==="landing";e.style.display=a?"none":"",e.querySelectorAll(".bn-btn").forEach(o=>{let i=o.dataset.go,r=s?i==="profile":i===X.currentTab;o.classList.toggle("bn-btn--active",r)})};window.addEventListener("naluxrp:pagechange",n),window.addEventListener("naluxrp:tabchange",n),n()}function Lv(){var a,o;if(jp)return;jp=!0;let e=document.querySelector(".dashboard-header");if(!e||document.getElementById("compactToggleBtn"))return;let t=document.createElement("button");t.id="compactToggleBtn",t.type="button",t.className="dash-accordion-toggle",t.textContent="Compact: OFF",e.appendChild(t);let n=(i,r=!0)=>{if(document.body.classList.toggle("dash-accordion",i),t.textContent=i?"Compact: ON":"Compact: OFF",r)try{localStorage.setItem(Rp,i?"1":"0")}catch{}if(i){let l=document.querySelector(".dashboard-col-side .widget-card");l&&l.classList.add("is-open")}else document.querySelectorAll(".dashboard-col-side .widget-card.is-open").forEach(l=>l.classList.remove("is-open"))},s=null;try{s=localStorage.getItem(Rp)}catch{}n(s==="1"?!0:s==="0"?!1:((o=(a=window.matchMedia)==null?void 0:a.call(window,"(max-width: 600px)"))==null?void 0:o.matches)??!1,!1),t.addEventListener("click",()=>n(!document.body.classList.contains("dash-accordion"),!0))}function Av(){if(Wp)return;Wp=!0;let e=document.querySelector(".dashboard-col-side");e&&e.addEventListener("click",t=>{var o,i;if(!document.body.classList.contains("dash-accordion"))return;let n=t.target;if((o=n==null?void 0:n.closest)!=null&&o.call(n,"button, a, input, textarea, select, kbd"))return;let s=(i=n==null?void 0:n.closest)==null?void 0:i.call(n,".widget-card");if(!s)return;let a=s.classList.contains("is-open");e.querySelectorAll(".widget-card.is-open").forEach(r=>{r!==s&&r.classList.remove("is-open")}),s.classList.toggle("is-open",!a)})}var _e={lsfPasswordSpent:65536,lsfRequireDestTag:131072,lsfRequireAuth:262144,lsfDisallowXRP:524288,lsfDisableMaster:1048576,lsfNoFreeze:2097152,lsfGlobalFreeze:4194304,lsfDefaultRipple:8388608,lsfDepositAuth:16777216},Eu={lsfBurnable:1,lsfOnlyXRP:2,lsfTrustLine:4,lsfTransferable:8},Ev=new Set(["SetRegularKey","SignerListSet","AccountSet","AccountDelete","EscrowCreate","PaymentChannelCreate","DepositPreauth"]),wn={blackhole:"#ff5555",exchange:"#00d4ff",newWallet:"#ff79c6",issuer:"#ffb86c",wallet:"#bd93f9",other:"#8be9fd"},Nv=.55,Rv=.15,or=20,Fu=946684800;function xe({module:e,category:t=null,sev:n,confidence:s=null,headline:a,detail:o="",observed:i=[],calculated:r=[],inferred:l=[],hypothesis:c=null,alternativeExplanations:d=[],evidenceAgainstBenign:u=[],classification:p=null,hashes:m=[]}={}){return{module:e,category:t,sev:n,confidence:s,headline:a,label:a,detail:o,observed:i,calculated:r,inferred:l,hypothesis:c,alternativeExplanations:d,evidenceAgainstBenign:u,classification:p,hashes:m}}var _v=new Map([["rPVMhWBsfF9iMXYj3aAzJVkPDTFNSyWdKy",{name:"Bitstamp",type:"exchange"}],["rvYAfWj5gh67oV6fW32ZzP3Aw4Eubs59B",{name:"Bitstamp",type:"exchange"}],["rrpNnNLKrartuEqfJGpqyDwPj1BBN1ih7",{name:"Bitstamp",type:"exchange"}],["rN7n3473SaZBCG4dFL83w7PB9judJ7qdDo",{name:"Binance",type:"exchange"}],["rEb8TK3gBgk5auZkwc6sHnwrGVJH8DuaLh",{name:"Binance",type:"exchange"}],["rBKPS4oLSaV2KVVuHH8EpQqMGgGefGFQs7",{name:"Bitso",type:"exchange"}],["rfk5bwaKCoNU84fTzdqWQowqnNaZorDmiV",{name:"Gate.io",type:"exchange"}],["rGFuMiw48HdbnrUbkRYDTvT5i9imC5fvv9",{name:"Gate.io",type:"exchange"}],["rwYHCs2EYBMBvRXFmxDrCUSorPsuqCck7t",{name:"Kraken",type:"exchange"}],["rLHzPsX6oXkzU2qL12kHCH8G8cnZv1rBJh",{name:"Kraken",type:"exchange"}],["ra5nK24KXen9AHvsdFTKHSANinZseWnPcX",{name:"Uphold",type:"exchange"}],["rGWrZyax5eXbi5gs49MRZKkE9eKNL9p4B",{name:"Bittrex",type:"exchange"}],["rDsbeomae4FXwgQTJp9Rs64Qg9vDiTCdBv",{name:"Coinone",type:"exchange"}],["rHsMUQFzBb7S6GnQFVgNirqvHRcLpAn5dU",{name:"Bithumb",type:"exchange"}],["rMQ98K56yXJbDGv49ZSmW51sLn94Xe1mu1",{name:"Huobi",type:"exchange"}],["rHcFoo6a9qT5NHiVn1THwX3B4QF2VQKWZ",{name:"Huobi",type:"exchange"}],["rKiCet8SdvWxPXnAgYarFUXMh1zCPz432Y",{name:"Coinbase",type:"exchange"}],["rHb9CJAWyB4rj91VRWn96DkukG4bwdtyTh",{name:"Coinbase",type:"exchange"}],["r9mhdcT2K7FdCGDEPqfbMJwVXsXCqEr5bP",{name:"OKX",type:"exchange"}],["r32U8WFxhqEAVkKcTb1GGRR1VH2oaFdexN",{name:"OKX",type:"exchange"}],["r4GDFMLGJUKMjNEycBKPGnRSNXyNVLQLHi",{name:"Bybit",type:"exchange"}],["rBETszU65yYoFcYdRkiGqFaYmhZpHWC7sj",{name:"Bybit",type:"exchange"}],["rMWUykAmNQDaM9poSes8VLDZDDkEoutilities",{name:"KuCoin",type:"exchange"}],["rUA1S9qobBkxLqzdfGEzh5wm5KdLfbf8bx",{name:"KuCoin",type:"exchange"}],["rHtbQzmN4BDaEBnGSXp3AZaZAuZamNVsME",{name:"MEXC",type:"exchange"}],["rDN1gPWW3XQFXVJFQSiJxPHGZiRLMVSi7K",{name:"MEXC",type:"exchange"}],["rB3gZey7VWHoDokMt3tCiXBSRmaZi5xJi9",{name:"Crypto.com",type:"exchange"}],["rhub8VRN55s94qWKDv6jmDy1pUykJzF3wq",{name:"GateHub",type:"exchange"}],["razqnFn6FqBaYBdNaGnVzmGaNE6XPRQ9bG",{name:"GateHub",type:"exchange"}],["rGQdkxNBQeQC1WTQDQ2F2QoGBZxYcMxBBg",{name:"GateHub",type:"exchange"}],["rpXTzCuXtjiPDFysxq8uNmtZBe9Xo97JbW",{name:"Bitbank",type:"exchange"}],["rsuUjfWxrACCAwGQDsNeZUhpzXf1n1NK5Z",{name:"Bitbank",type:"exchange"}],["r9oxUGJqMfMEhGBxrMJnmNvVh1LKkMv7fz",{name:"Coincheck",type:"exchange"}],["rHb9CJAWyB4rj91VRWn96DkukG4bwdtyTh",{name:"Genesis (Black Hole)",type:"blackhole"}],["r9cZA1mLK5R5Am25ArfXFmqgNwjZgnfk59",{name:"Black Hole #2",type:"blackhole"}],["rHb9CJAWyB4rj91VRWn96DkukG4bwdtyTh",{name:"Genesis Wallet",type:"ripple"}],["rHb9CJAWyB4rj91VRWn96DkukG4bwdtyTh",{name:"Ripple Labs Ops",type:"ripple"}],["rPEPPER7kfTD9w2To4CQk6UCfuHM9c6GDY",{name:"XAMAN (XUMM)",type:"wallet"}],["rBj4eVRWn6mCELVTNkVFDfGNByE9VFTM3R",{name:"XAMAN",type:"wallet"}],["rHb9CJAWyB4rj91VRWn96DkukG4bwdtyTh",{name:"XRPL AMM Engine",type:"dex"}],["rsoLo2S1kiGeCcn6hCUXVrCpGMWLrRrLZz",{name:"SOLO Issuer",type:"issuer"}],["rcoreNywaoz2ZCVt2sc3JiEi7G7MpZxZgm",{name:"CORE Token",type:"issuer"}],["rhXo4TcWbLY4GqTSmscMpgZ1KMXFBi9V55",{name:"XRPL DeFi Pool",type:"issuer"}],["rHb9CJAWyB4rj91VRWn96DkukG4bwdtyTh",{name:"UNL Validator Set",type:"validator"}]]);function Wn(e){return _v.get(e)||null}var Dv=null,mt=!1;var xs=null,Nu=!1,Zi=!0;function ao(){return Zi&&X.currentPage==="dashboard"&&X.currentTab==="inspector"&&!document.hidden}async function Iv(e){let t=[s=>`https://corsproxy.io/?${encodeURIComponent(s)}`,s=>`https://api.allorigins.win/raw?url=${encodeURIComponent(s)}`],n=async s=>{let a=typeof(AbortSignal==null?void 0:AbortSignal.timeout)=="function"?AbortSignal.timeout(6e3):void 0,o=await fetch(s,{mode:"cors",cache:"no-store",signal:a});if(!o.ok)throw new Error(`HTTP ${o.status}`);return await o.json()};try{return await n(e)}catch{for(let s of t)try{return await n(s(e))}catch{}throw new Error("Price feed unavailable")}}async function Fv(){if(Nu)return xs;Nu=!0;try{let e=await Iv("https://api.exchange.coinbase.com/products/XRP-USD/ticker");xs=Number((e==null?void 0:e.price)||0)||null}catch{xs=null}return xs}function xn(e){if(!xs||!e)return"";let t=e*xs;return t>=1e6?` (~$${(t/1e6).toFixed(2)}M)`:t>=1e3?` (~$${(t/1e3).toFixed(1)}K)`:` (~$${t.toFixed(2)})`}var Zs=null;function Ou(){return Zs||(Zs={input:()=>document.getElementById("inspect-addr"),err:document.getElementById("inspect-err"),result:document.getElementById("inspect-result"),empty:document.getElementById("inspect-empty"),loading:document.getElementById("inspect-loading"),loadMsg:document.getElementById("inspect-loading-msg"),warn:document.getElementById("inspect-warn"),badge:document.getElementById("inspect-addr-badge"),score:document.getElementById("inspect-risk-score"),label:document.getElementById("inspect-risk-label")},Zs)}function Ov(){Zs=null,Ou()}function Bu(){var n,s,a,o,i;g0(),b0(),v0(),(n=x("inspect-addr"))==null||n.addEventListener("keydown",r=>{r.key==="Enter"&&ks()}),(s=x("inspect-addr"))==null||s.addEventListener("paste",()=>{setTimeout(()=>{var l;let r=(l=x("inspect-addr"))==null?void 0:l.value.trim();r&&He(r)&&ks()},60)});let e=r=>{let l=r==null?void 0:r.closest(".inspector-section");if(!l)return;let c=l.classList.toggle("collapsed");r.setAttribute("aria-expanded",String(!c))};(a=document.getElementById("tab-inspector"))==null||a.addEventListener("click",r=>{if(r.target.closest("button"))return;let l=r.target.closest(".section-header");l&&e(l)}),(o=document.getElementById("tab-inspector"))==null||o.addEventListener("keydown",r=>{var c,d;if(r.key!=="Enter"&&r.key!==" ")return;let l=(d=(c=r.target).closest)==null?void 0:d.call(c,".section-header");l&&(r.preventDefault(),e(l))}),(i=document.getElementById("inspector-nav"))==null||i.addEventListener("click",r=>{var d;let l=r.target.closest("[data-jump]");if(!l)return;let c=document.getElementById("section-"+l.dataset.jump);c&&(c.classList.remove("collapsed"),(d=c.querySelector(".section-header"))==null||d.setAttribute("aria-expanded","true"),c.scrollIntoView({behavior:"smooth",block:"start"})),em(l.dataset.jump)});let t=!1;window.addEventListener("scroll",()=>{ao()&&(t||(t=!0,requestAnimationFrame(()=>{y0(),t=!1})))},{passive:!0}),window.runInspect=ks,window.inspectorCopyAddr=x0,window.showInspectorHowTo=k0,window.hideInspectorHowTo=sr,window.setEvidenceMatrixFilter=z0,window.openEvidenceInspector=W0,Ov(),C0(),window.addEventListener("naluxrp:tabchange",r=>{var l;((l=r.detail)==null?void 0:l.tabId)==="inspector"&&ao()&&(lr(),cr(),aa(),ro())})}function Xu(e){Zi=!!e,Zi||(mt=!0)}async function ks(){var a,o,i,r,l,c,d,u,p,m,f,g,b,h,v;if(!ao())return;let e=Ou(),t=((a=e.input())==null?void 0:a.value.trim())||"";if([e.err,e.result,e.empty,e.warn].forEach(w=>w&&(w.style.display="none")),mt=!0,!t){e.empty&&(e.empty.style.display="");return}if(!He(t)){e.err&&(e.err.textContent=`\u26A0 Invalid address: ${y(t)}`,e.err.style.display="");return}if(X.connectionState!=="connected"){e.warn&&(e.warn.style.display="");return}Dv=t,mt=!1;let n=w=>{e.loading&&(e.loading.style.display="",e.loadMsg&&(e.loadMsg.textContent=w))};n("Fetching account data\u2026");let s=w=>new Promise(k=>setTimeout(k,w));try{n("Fetching account data\u2026");let[w,k,$]=await Promise.all([Ee({command:"account_info",account:t,ledger_index:"validated"}),Ee({command:"account_offers",account:t,ledger_index:"validated"}),Ee({command:"account_nfts",account:t,ledger_index:"validated"}).catch(()=>null)]);if(mt)return;let T=((o=w==null?void 0:w.result)==null?void 0:o.account_data)||{},S=((i=k==null?void 0:k.result)==null?void 0:i.offers)||[],N=((r=$==null?void 0:$.result)==null?void 0:r.account_nfts)||[];n("Fetching trustlines\u2026");let P=[],C,R=0;do{R++;let G={command:"account_lines",account:t,ledger_index:"validated",limit:400};C&&(G.marker=C);let me=await Ee(G).catch(()=>null);if(mt)return;let be=((l=me==null?void 0:me.result)==null?void 0:l.lines)||[];P.push(...be),C=((c=me==null?void 0:me.result)==null?void 0:c.marker)||null,R>1&&await s(50)}while(C&&P.length<4e3);n("Fetching account objects\u2026");let O=[],D,I=0;do{I++;let G={command:"account_objects",account:t,ledger_index:"validated",limit:400};D&&(G.marker=D);let me=await Ee(G).catch(()=>null);if(mt)return;let be=((d=me==null?void 0:me.result)==null?void 0:d.account_objects)||[];O.push(...be),D=((u=me==null?void 0:me.result)==null?void 0:u.marker)||null,I>1&&await s(50)}while(D&&O.length<2e3);n("Fetching token supply, AMM data & price\u2026");let F=15,H=P.filter(G=>G.currency&&Number(G.balance)!==0&&G.currency.startsWith("03")&&G.currency.length===40),[E,,...j]=await Promise.all([Ee({command:"gateway_balances",account:t,ledger_index:"validated"}).catch(()=>null),Fv(),...H.slice(0,F).map(G=>Ee({command:"amm_info",amm_account:G.account,ledger_index:"validated"}).catch(()=>null))]);if(mt)return;let se=(E==null?void 0:E.result)||null,re=new Map;H.slice(0,F).forEach((G,me)=>{var be,qe;(qe=(be=j[me])==null?void 0:be.result)!=null&&qe.amm&&re.set(G.currency,j[me].result.amm)});let pe=400,ae=250,te=window._inspectMaxTx||5e3,de=Math.ceil(te/pe),le=[],Pe=new Set,B=G=>{var me,be;for(let qe of G||[]){let ht=((me=qe.tx_json)==null?void 0:me.hash)||((be=qe.tx)==null?void 0:be.hash)||qe.hash||null;ht&&Pe.has(ht)||(ht&&Pe.add(ht),le.push(qe))}},U={newestToOldestComplete:!1,oldestToNewestFetched:!1,hitTxCap:!1,hitPageCap:!1,fetchErrorOccurred:!1},J,ue=0;for(let G=1;G<=de&&le.length<te;G++){if(ue=G,mt)return;n(`Fetching transactions \u2014 page ${G} (${le.length.toLocaleString()} so far)\u2026`);let me={command:"account_tx",account:t,limit:pe,ledger_index_min:-1,ledger_index_max:-1,forward:!1};J&&(me.marker=J);let be=await Ee(me).catch(()=>null);if(mt)return;if(be==null&&(U.fetchErrorOccurred=!0),B((p=be==null?void 0:be.result)==null?void 0:p.transactions),J=((m=be==null?void 0:be.result)==null?void 0:m.marker)||null,!J)break;G<de&&le.length<te&&await s(ae)}if(U.hitTxCap=le.length>=te,U.hitPageCap=!!J&&ue>=de,U.newestToOldestComplete=!J,le.length<te){if(mt)return;n("Fetching oldest transactions (anchoring history start)\u2026");let G=await Ee({command:"account_tx",account:t,limit:pe,ledger_index_min:-1,ledger_index_max:-1,forward:!0}).catch(()=>null);if(mt)return;G==null&&(U.fetchErrorOccurred=!0),B((f=G==null?void 0:G.result)==null?void 0:f.transactions),U.oldestToNewestFetched=G!=null&&!((g=G==null?void 0:G.result)!=null&&g.marker),await s(ae)}e.loading&&(e.loading.style.display="none");let $e=Bv(le).sort((G,me)=>(G.tx.date??0)-(me.tx.date??0)),Me=946684800,We=null,De=null,Ie=U.newestToOldestComplete||U.oldestToNewestFetched;if($e.length>0){let G=$e[0].tx;G!=null&&G.date&&(De=(G.date+Me)*1e3,We=Math.floor((Date.now()-De)/864e5))}let Y=new Map;for(let{tx:G}of $e){if(G.TransactionType!=="OfferCreate"||!G.TakerPays||!G.TakerGets)continue;let me=qe=>typeof qe=="string"?"XRP":`${qe.currency}+${qe.issuer||""}`,be=[me(G.TakerPays),me(G.TakerGets)].sort().join("\u2194");Y.set(be,(Y.get(be)||0)+1)}let Ce=null;if(Y.size>0){let G=[...Y.entries()].sort((an,ma)=>ma[1]-an[1])[0][0],[me,be]=G.split("\u2194"),qe=an=>an==="XRP"?{currency:"XRP"}:{currency:an.split("+")[0],issuer:an.split("+")[1]},ht=await Ee({command:"book_offers",taker_pays:qe(me),taker_gets:qe(be),limit:20,ledger_index:"validated"}).catch(()=>null);(h=(b=ht==null?void 0:ht.result)==null?void 0:b.offers)!=null&&h.length&&(Ce={pair:G,offers:ht.result.offers})}let Qe=[...new Set($e.filter(({tx:G})=>G.TransactionType==="Payment"&&G.Account===t&&G.Destination).map(({tx:G})=>G.Destination))].slice(0,6),Se=new Map;for(let G of Qe){if(mt)return;let me=await Ee({command:"account_info",account:G,ledger_index:"validated"}).catch(()=>null),be=(v=me==null?void 0:me.result)==null?void 0:v.account_data;be&&Se.set(G,{sequence:be.Sequence||0,balance:Number(be.Balance||0)/1e6}),await s(80)}Vv(t,T,P,S,N,O,$e,{gatewayBalances:se,ammInfoMap:re,destAgeMap:Se,walletAgeDays:We,walletCreatedTs:De,walletAgeVerified:Ie,historyCoverage:U,liveOrderBook:Ce}),e.result&&(e.result.style.display="",dr());let Pt=e.score?Number(e.score.textContent):null;R0(t,isNaN(Pt)?null:Pt);let jt=window._lastAllFindings||[];_0(t,isNaN(Pt)?null:Pt,jt),U0(t,jt),ar(t)&&I0(t,isNaN(Pt)?null:Pt),B0()}catch(w){if(mt)return;e.loading&&(e.loading.style.display="none"),e.err&&(e.err.textContent=`Error: ${y(w.message)}`,e.err.style.display="")}}function Bv(e){return e.map(t=>{let n=t.tx_json||t.tx||t.transaction||{},s=t.metadata||t.meta||{};return n.date==null&&t.date!=null&&(n.date=t.date),!n.hash&&t.hash&&(n.hash=t.hash),{tx:n,meta:s}})}function Zt(e){if(e==null)return null;if(typeof e=="string")return Number(e)/1e6;let t=Number(e.value);return Number.isFinite(t)?t:null}function er(e){return typeof e=="string"?"XRP":(e==null?void 0:e.currency)||null}function Hu(e){return typeof e=="string"&&e.length===40&&e.startsWith("03")}var Xv=new Set(["Escrow","Check","PayChannel","Offer","SignerList","Ticket"]);function ir(e,t,n){var a,o,i,r,l,c,d,u,p,m,f,g;let s={xrpDelta:0,tokenDeltas:[],tokenDeltaMap:new Map,lpDeltas:[],lpDeltaMap:new Map,economicActions:[]};if(!((a=t==null?void 0:t.AffectedNodes)!=null&&a.length))return s;for(let b of t.AffectedNodes){let h=b.CreatedNode,v=b.ModifiedNode,w=b.DeletedNode,k=h||v||w;if(k){if(k.LedgerEntryType==="AccountRoot"){if((((o=k.FinalFields)==null?void 0:o.Account)||((i=k.NewFields)==null?void 0:i.Account))!==n)continue;let T=Number(((r=k.FinalFields||k.NewFields)==null?void 0:r.Balance)??0),S=h?0:Number(((l=k.PreviousFields)==null?void 0:l.Balance)??T),N=(T-S)/1e6;N&&(s.xrpDelta+=N);continue}if(k.LedgerEntryType==="RippleState"){let $=k.FinalFields||k.NewFields,T=(c=$==null?void 0:$.LowLimit)==null?void 0:c.issuer,S=(d=$==null?void 0:$.HighLimit)==null?void 0:d.issuer,N=T===n;if(!N&&!(S===n))continue;let C=N?1:-1,R=N?S:T,O=(u=$==null?void 0:$.Balance)==null?void 0:u.currency,D=w?0:Number(((p=$==null?void 0:$.Balance)==null?void 0:p.value)??0),I=h?0:Number(((f=(m=k.PreviousFields)==null?void 0:m.Balance)==null?void 0:f.value)??(w?((g=$==null?void 0:$.Balance)==null?void 0:g.value)??0:D)),F=(D-I)*C;if(!F||!O)continue;let H=Hu(O)?s.lpDeltaMap:s.tokenDeltaMap,E=`${O}.${R}`,j=H.get(E)||{currency:O,issuer:R,delta:0};j.delta+=F,H.set(E,j);continue}if(Xv.has(k.LedgerEntryType)){let $=k.FinalFields||k.NewFields;(($==null?void 0:$.Account)||($==null?void 0:$.Owner))===n&&(h?s.economicActions.push("RESERVE_LOCK"):w&&s.economicActions.push("RESERVE_RELEASE"))}}}return s.tokenDeltas=[...s.tokenDeltaMap.values()],s.lpDeltas=[...s.lpDeltaMap.values()],delete s.tokenDeltaMap,delete s.lpDeltaMap,s.xrpDelta>0?s.economicActions.push("XRP_INFLOW"):s.xrpDelta<0&&s.economicActions.push("XRP_OUTFLOW"),e.TransactionType==="AMMDeposit"?s.economicActions.push("AMM_DEPOSIT"):e.TransactionType==="AMMWithdraw"?s.economicActions.push("AMM_WITHDRAWAL"):s.xrpDelta!==0&&(s.tokenDeltas.length||s.lpDeltas.length)&&s.economicActions.push("DEX_TRADE"),s}function zu(e,t){return e.map(({tx:n,meta:s})=>{let a=ir(n,s,t);return{txHash:n.hash,date:n.date,type:n.TransactionType,result:(s==null?void 0:s.TransactionResult)||null,xrpDelta:a.xrpDelta,tokenDeltas:a.tokenDeltas,lpDeltas:a.lpDeltas,economicActions:a.economicActions}})}function ju(e,t,n){let s=zu(e,t),a=n,o=new Array(s.length);for(let i=s.length-1;i>=0;i--){let r=a;a-=s[i].xrpDelta,o[i]={...s[i],balanceBefore:a,balanceAfter:r}}return o}var Hv=[86400,3*86400],zv=.5,jv=10;function Wv(e){return Math.max(0,Math.min(1,e))}function qv({grossOutflowXrp:e,grossInflowXrp:t,actualDepletionPct:n}){let s=e>0?t/e:0;return n<.2&&s>=.6?"pass-through":n>=.5&&s<.15?"sweep":n>=.5?"potential-drain":"partial-outflow"}function Wu(e,t,n,s={}){var d,u;let a=[],o=e.length,i=t.filter(({tx:p})=>["SetRegularKey","SignerListSet"].includes(p.TransactionType)).map(({tx:p})=>p.date).filter(p=>p!=null);for(let p of Hv)for(let m=0;m<o;m++){let f=e[m];if(f.date==null||f.balanceBefore<=0)continue;let g=0,b=0,h=f.balanceBefore,v=m;for(;v<o&&e[v].date!=null&&e[v].date-f.date<=p;){let P=e[v];P.xrpDelta<0?g+=-P.xrpDelta:P.xrpDelta>0&&(b+=P.xrpDelta),P.balanceAfter>h&&(h=P.balanceAfter),v++}let w=Math.min(v,o)-1,k=f.balanceBefore,$=((d=e[w])==null?void 0:d.balanceAfter)??k,T=k>0?g/k:0,S=k>0?Wv((k-Math.min($,k))/k):0,N=g-b;T>=zv&&g>jv&&a.push({windowSec:p,startDate:f.date,endDate:((u=e[w])==null?void 0:u.date)??f.date,openingBalanceXrp:k,peakBalanceXrp:h,closingBalanceXrp:$,grossOutflowXrp:g,grossInflowXrp:b,netOutflowXrp:N,grossTurnoverPct:T,actualDepletionPct:S,classification:qv({grossOutflowXrp:g,grossInflowXrp:b,actualDepletionPct:S}),startIdx:m,endIdx:w,triggeredByAuthChange:i.some(P=>P<=f.date&&f.date-P<=p)})}let r=300;a.sort((p,m)=>m.actualDepletionPct-p.actualDepletionPct);let l=[];for(let p of a)l.some(f=>f.windowSec===p.windowSec&&p.startDate<=f.endDate+r&&p.endDate>=f.startDate-r)||l.push(p);l.sort((p,m)=>p.startDate-m.startDate);let c=s.fetchErrorOccurred?"possibly-incomplete":"complete";return l.map(p=>({...p,dataCompleteness:c}))}function Uv(e,t,n,s){let a=t.slice(e.startIdx,e.endIdx+1).filter(P=>P.xrpDelta<0),o=new Set(a.map(P=>P.txHash)),i=n.filter(({tx:P})=>o.has(P.hash)&&P.TransactionType==="Payment"),r=new Set(n.filter(({tx:P})=>P.TransactionType==="Payment"&&P.Account===s&&P.date<e.startDate).map(({tx:P})=>P.Destination).filter(Boolean)),l=[...new Set(i.map(({tx:P})=>P.Destination).filter(Boolean))],c=l.filter(P=>!r.has(P)),d=l.length?c.length/l.length:null,u=new Map;for(let{tx:P}of i){let C=typeof P.Amount=="string"?Number(P.Amount)/1e6:0;u.set(P.Destination,(u.get(P.Destination)||0)+C)}let p=[...u.entries()].sort((P,C)=>C[1]-P[1]),m=e.grossOutflowXrp>0&&p[0]?p[0][1]/e.grossOutflowXrp:null,f=p.map(([P,C])=>({addr:P,xrp:C,entity:Wn(P)})),g=n.filter(({tx:P})=>P.TransactionType==="Payment"&&P.Account===s&&(P.date<e.startDate||P.date>e.endDate)&&typeof P.Amount=="string").map(({tx:P})=>Number(P.Amount)/1e6).filter(P=>P>0),b=P=>{let C=[...P].sort((R,O)=>R-O);return C.length?C[Math.floor(C.length/2)]:null},h=b(g),v=i.map(({tx:P})=>Number(P.Amount)/1e6).filter(P=>P>0),w=b(v),k=h&&w?w/h>=5:!1,$=new Map;for(let P of t.slice(e.startIdx,e.endIdx+1))for(let C of P.tokenDeltas){if(C.delta>=0)continue;let R=`${C.currency}.${C.issuer}`;$.set(R,($.get(R)||0)+-C.delta)}let T=[...$.entries()].map(([P,C])=>({key:P,amount:C})),N=t.filter(P=>P.date!=null&&P.date<e.startDate&&e.startDate-P.date<=172800).some(P=>P.xrpDelta>0&&P.tokenDeltas.some(C=>C.delta<0));return{...e,newRecipientPct:d,newDestCount:c.length,episodeDestCount:l.length,topDestShare:m,destinations:f.slice(0,5),transferSizeAnomaly:k,historicalMedianXrp:h,episodeMedianXrp:w,trustlineLiquidations:T,dexConversionPrecedingWithdrawal:N}}function Vv(e,t,n,s,a,o,i,r={}){let{gatewayBalances:l=null,ammInfoMap:c=new Map,destAgeMap:d=new Map,walletAgeDays:u=null,walletCreatedTs:p=null,walletAgeVerified:m=!1,historyCoverage:f=null,liveOrderBook:g=null}=r,b=Number(t.Balance||0)/1e6,h=Number(t.OwnerCount||0),v=10+h*2,w=Number(t.Flags||0),k=t.Sequence??"\u2014",$=o.filter(Y=>Y.LedgerEntryType==="SignerList"),T=o.filter(Y=>Y.LedgerEntryType==="Escrow"),S=o.filter(Y=>Y.LedgerEntryType==="PayChannel"),N=o.filter(Y=>Y.LedgerEntryType==="DepositPreauth"),P=o.filter(Y=>Y.LedgerEntryType==="Check"),C=Qv(t,w,$,i,f),R=Gu(t,w,$,i,S,T,e,b,f),O=ty(a,i,e),D=Ry(g,e),I=Ku(i,e,f||{}),F=sy(I,e),H=cy(i,e,n,I,F,D),E=Sy(t,n,w,i),j=Ty(n,i,o,c,e),se=fy(i),re=$y(i,e),pe=hy(i,e),ae=gy(i,e),te=by(i),de=vy(i,e),le=Gv(i,e,d),Pe=Cy(i),B=Py(i,e),U=My(i,e),J=Kv(i,e,n,l),ue=Ly(i,e),$e=Ay(i,e),Me=Ey(o,i,e),We=Ny(o),De=Iy(C,R,O,H,se,re,pe,ae,te,de,Pe);Wy(e,t,b,v,h,k,De,u,p,m),qy(C,t,w,$,N),Uy(R,S,T,P),e0(le,b,ue),Vy(O,a),Ky(H),Fy(se),Oy(re),By(pe),Xy(ae),Hy(te),zy(de),jy(se,pe,ae,te,de),Jy(E,n),t0(J,n),n0(Pe),s0(B),a0(U),Yy(j,n),o0(ue),i0($e),r0(Me),l0(We),c0(D),d0(De,C,R,O,H,se,re,pe,ae,te,de,Pe,ue,$e),Qy(n),Zy(i,e),Iu(i),G0(i,e,le,ue),window._lastTxList=i,window._lastBalXrp=b,window._lastHistoryCoverage=f;let Ie=x("inspect-report-body");Ie&&(h0(Ie,e,t,b,De,C,R,O,H,se,re,E,j,le,J,i,pe,ae,te,de,{feeAnalysis:Pe,destTagAnalysis:B,pathDepthAnalysis:U,gatewayBalances:l,inboundFlowAnalysis:ue,memoAnalysis:$e,escrowDepthAnalysis:Me,checkAnalysis:We,liveBookAnalysis:D,walletAgeDays:u,walletCreatedTs:p,walletAgeVerified:m,historyCoverage:f}),Iu(i,"inspect-report-activity-chart"),q0(De,window._lastAllFindings||[],u,i.length,window._lastCategoryRisk||{},m,f),om(window._lastAllFindings||[]),H0(),window._lastInspectResult={addr:e,riskScore:De,walletAgeDays:u,walletAgeVerified:m,historyCoverage:f,txCount:i.length,findings:window._lastAllFindings||[],timestamp:new Date().toISOString()},am(),im(e))}function Gv(e,t,n=new Map){let s=new Map,a=[];for(let{tx:p,meta:m}of e){if(p.TransactionType!=="Payment"||p.Account!==t)continue;let f=p.Destination;if(!f)continue;let g=0,b=null,h=p.Amount;typeof h=="string"?g=Number(h)/1e6:h!=null&&h.value&&(b={value:Number(h.value),currency:jn(h.currency),issuer:h.issuer});let v=Array.isArray(p.Paths)&&p.Paths.length>0,w=p.SendMax!=null,k=v||w,$=v?p.Paths.reduce((P,C)=>Math.max(P,(C||[]).length+1),1):k?2:1,T=tn(p),S={dest:f,amtXrp:g,amtToken:b,ts:T,isPathPay:k,hopCount:$,hash:p.hash||p.Hash||"",ledger:p.ledger_index||p.LedgerIndex||0,destTag:p.DestinationTag};a.push(S),s.has(f)||s.set(f,{addr:f,totalXrp:0,txCount:0,firstSeen:T,lastSeen:T,entity:Wn(f)||null,pathCount:0,maxHops:1,tokens:new Map});let N=s.get(f);if(N.totalXrp+=g,N.txCount++,N.lastSeen=Math.max(N.lastSeen,T),N.firstSeen=Math.min(N.firstSeen,T),k&&(N.pathCount++,N.maxHops=Math.max(N.maxHops,$)),b){let P=`${b.currency}.${z(b.issuer||"")}`;N.tokens.set(P,(N.tokens.get(P)||0)+b.value)}}let o=[...s.values()].sort((p,m)=>m.totalXrp-p.totalXrp||m.txCount-p.txCount).slice(0,10).map(p=>({...p,tokens:[...p.tokens.entries()].map(([m,f])=>({k:m,v:f}))})),i=o.reduce((p,m)=>p+m.totalXrp,0),r=a.filter(p=>p.isPathPay).length,l=o.filter(p=>{let m=n.get(p.addr);return m&&m.sequence<10&&p.totalXrp>10}),c=o.filter(p=>{var m;return((m=p.entity)==null?void 0:m.type)==="exchange"}),d=o.filter(p=>{var m;return((m=p.entity)==null?void 0:m.type)==="blackhole"});return{timeline:[...a].filter(p=>p.amtXrp>.01||p.amtToken).sort((p,m)=>p.ts-m.ts).slice(0,30),destinations:o,totalOut:i,totalPathPay:r,uniqueDests:s.size,exchangeDests:c,blackHoleDests:d,newWalletDests:l}}function Kv(e,t,n,s=null){var N,P;let a=null;if(s!=null&&s.obligations){let C=Object.values(s.obligations);C.length===1?a=Number(C[0])||null:C.length>1&&(a=null)}let o=[],i=new Map,r=new Map,l=new Set,c=new Set(n.filter(C=>Number(C.balance)<0).map(C=>jn(C.currency)));for(let{tx:C,meta:R}of e)if(C.Account===t&&C.TransactionType==="Payment"){((P=(N=R==null?void 0:R.AffectedNodes)==null?void 0:N.some)==null?void 0:P.call(N,I=>{var F,H,E;return((F=I.CreatedNode)==null?void 0:F.LedgerEntryType)==="AccountRoot"&&((E=(H=I.CreatedNode)==null?void 0:H.NewFields)==null?void 0:E.Account)===C.Destination}))&&C.Destination&&l.add(C.Destination);let D=C.Amount;if(typeof D=="object"&&(D!=null&&D.value)&&(D!=null&&D.currency)){let I=jn(D.currency);if(c.has(I)){let F=Number(D.value),H=C.Destination;i.has(H)||(i.set(H,0),r.set(H,tn(C))),i.set(H,i.get(H)+F)}}}let d=[...i.entries()].sort((C,R)=>R[1]-C[1]),u=[];if(d.length>=3){let C=new Map;for(let[R,O]of d){if(O<=0)continue;let D=Math.pow(10,Math.floor(Math.log10(O))),F=(Math.round(O/D/.1)*.1*D).toPrecision(2);C.has(F)||C.set(F,[]),C.get(F).push({addr:R,amt:O})}for(let[,R]of C.entries())if(R.length>=3){let O=R.reduce((D,I)=>D+I.amt,0)/R.length;u.push({approxAmt:O,accounts:R}),o.push({sev:"warn",label:`${R.length} accounts each received ~${_(O,0)} tokens`,detail:"Highly similar token amounts suggest coordinated wallets, pre-arranged airdrop clusters, or sybil accounts."})}}let p=[...r.values()].sort();if(p.length>=5){let C=p[p.length-1]-p[0];C<3600&&p.length>=10&&o.push({sev:"warn",label:`${p.length} accounts funded within ${Math.ceil(C/60)} minutes`,detail:"Rapid token distribution to many wallets in a narrow time window. Matches pre-sale airdrop or coordinated distribution for wash trading."})}l.size>0&&o.push({sev:l.size>10?"warn":"info",label:`${l.size} account(s) created by this address`,detail:"This issuer funded the activation of these accounts. They may be controlled by the same entity."});let m=n.filter(C=>Number(C.balance)<0),f=a,g=m.reduce((C,R)=>C+Math.abs(Number(R.balance)),0),b=f??g,h=f==null&&m.length>0,v=h?` (based on ${m.length} visible trustlines \u2014 actual total supply may be higher if there are more holders)`:"",w=m.map(C=>({addr:C.account,balance:Math.abs(Number(C.balance)),currency:jn(C.currency)})).sort((C,R)=>R.balance-C.balance).slice(0,10),k=new Set;for(let{tx:C}of e){if(C.TransactionType!=="Payment")continue;let R=C.Amount;typeof R!="object"||!(R!=null&&R.currency)||(C.Account===t&&C.Destination&&k.add(C.Destination),C.Destination===t&&C.Account&&k.add(C.Account))}w.forEach(C=>{C.activeWithIssuer=k.has(C.addr)});let $=w.filter(C=>C.activeWithIssuer).length;w.length>=3&&o.push(xe({module:"Issuer Connections",category:"issuer",sev:"info",confidence:.35,headline:`${$} of top ${w.length} holders have transacted directly with the issuer`,detail:`${w.length-$} show no direct payment activity with this issuer in the fetched history.`,observed:[`Direct-contact holders: ${$}/${w.length}`,"Measures direct issuer contact only \u2014 holders active via DEX trades or peer-to-peer transfers are not visible from this account's own history alone"],classification:"This distinguishes holders who have engaged with the issuer directly from those who haven't \u2014 it is not a general on-chain activity/dormancy check."}));let T=f??g,S=T>0&&(f!=null||m.length>=50);if(w.length>=2&&S){let C=w[0].balance/T*100,R=f!=null?"":" (of visible sample)";C>50?o.push({sev:"critical",label:`Top holder controls ${C.toFixed(0)}%${R} of supply`,detail:`${z(w[0].addr)} holds ${_(w[0].balance,0)} of ${_(T,0)} total${v}. `+(f!=null?"Extreme dump risk \u2014 one wallet could sell everything.":"Check gateway_balances or a block explorer to confirm the full supply picture.")}):C>25&&o.push({sev:"warn",label:`Top holder controls ${C.toFixed(0)}%${R} of supply`,detail:`Large single-holder concentration${v}. Monitor for coordinated sell events.`});let D=w.slice(0,5).reduce((I,F)=>I+F.balance,0)/T*100;D>75&&o.push({sev:"warn",label:`Top 5 holders own ${D.toFixed(0)}%${R} of supply`,detail:`Supply heavily concentrated in a few wallets${v}. This pattern is common in pre-launch setups or tokens with limited real distribution.`})}else m.length>0&&!S&&o.push({sev:"info",label:`${m.length} trustline holder(s) visible \u2014 supply data limited`,detail:`Only ${m.length} trustlines returned by account_lines. The true holder count and total supply cannot be determined from this data alone. Use a block explorer (XRPScan, Bithomp) for a complete holder distribution.`});return o.length===0&&b===0&&o.push({sev:"info",label:"No token issuance detected",detail:"This account does not appear to be an active token issuer."}),{signals:o,totalIssued:b,holderCount:m.length,topHolders:w,mirrorGroups:u,createdAccts:[...l],distributions:d.slice(0,10),isSampleOnly:h}}var Jv=new Set(["rrrrrrrrrrrrrrrrrrrrrhoLvTp","rrrrrrrrrrrrrrrrrrrrBZbvji","rrrrrrrrrrrrrrrrrNAMEtxvNvQ","rHb9CJAWyB4rj91VRWn96DkukG4bwdtyTh","r9cZA1mLK5R5Am25ArfXFmqgNwjZgnfk59"]);function qu(e){return!!e&&Jv.has(e)}function Uu(e,t,n=[],s=[]){let a=!!(t&_e.lsfDisableMaster),o=(e==null?void 0:e.RegularKey)||"",i=Array.isArray(n)&&n.length>0,r=qu(o);return!!(a&&r&&!i)}function Vu(e,t,n=[]){let s=!!(t&_e.lsfDefaultRipple),a=!!(t&_e.lsfRequireAuth),o=!!(t&_e.lsfGlobalFreeze),i=!!(t&_e.lsfNoFreeze),r=n.filter(({tx:c})=>c.TransactionType==="TrustSet").length,l=n.filter(({tx:c})=>{var d;return c.TransactionType==="Payment"&&typeof c.Amount=="object"&&((d=c.Amount)==null?void 0:d.currency)}).length;return s||a||o||i||r>=3||l>=5}var Be={NORMAL:"Normal",REGULAR_KEY:"Regular-Key Controlled",MULTISIG:"Multisig Controlled",BLACKHOLED:"Blackholed",RECOVERABLE:"Recoverable",MISCONFIGURED:"Potentially Misconfigured",UNKNOWN:"Unknown"},Yi=4;function Yv(e,t,n,s,a={}){let o=!!(t&_e.lsfDisableMaster),i=!!e.RegularKey,r=n.length>0,l=qu(e.RegularKey),c=s.filter(({tx:g})=>g.TransactionType==="AccountSet"&&g.Account===e.Account&&(g.SetFlag===Yi||g.ClearFlag===Yi)).map(({tx:g})=>({date:g.date,hash:g.hash,action:g.SetFlag===Yi?"disabled":"enabled"})).sort((g,b)=>(g.date??0)-(b.date??0)),d=c.some((g,b)=>g.action==="enabled"&&c.slice(0,b).some(h=>h.action==="disabled")),u=n.filter(g=>(g.SignerEntries||[]).reduce((v,w)=>{var k;return v+Number(((k=w.SignerEntry)==null?void 0:k.SignerWeight)||0)},0)<Number(g.SignerQuorum||1)),p,m,f;return u.length?(p=Be.MISCONFIGURED,m="blocked \u2014 quorum exceeds total signer weight, unreachable as configured",f=.9):r?(p=Be.MULTISIG,m="controlled by signer quorum",f=.85):o&&i&&l?(p=Be.BLACKHOLED,m="none \u2014 regular key points to a provably unusable address",f=.85):o&&!i?(p=Be.BLACKHOLED,m="none \u2014 no working key exists",f=.75):o&&i&&d?(p=Be.RECOVERABLE,m="proven historically \u2014 master key has been re-enabled from this state before",f=.7):o&&i?(p=Be.REGULAR_KEY,m="possible \u2014 whoever holds the regular key can re-enable the master key or act directly",f=.6):o?(p=Be.UNKNOWN,m="undetermined",f=.3):(p=Be.NORMAL,m="full \u2014 master key is active",f=.9),a!=null&&a.fetchErrorOccurred&&!(a!=null&&a.newestToOldestComplete)&&(f=Math.min(f,.5)),{state:p,reversibility:m,confidence:f,masterDisabled:o,hasRegularKey:i,hasSignerList:r,masterKeyHistory:c,wasEverReenabled:d,misconfiguredSignerListCount:u.length}}function Qv(e,t,n,s,a={}){let o=[],i=100,r=!!(t&_e.lsfDisableMaster),l=!!e.RegularKey,c=n.length>0,d=Uu(e,t,n,s),u=Vu(e,t,s),p=Yv(e,t,n,s,a);{let f={[Be.BLACKHOLED]:"info",[Be.MISCONFIGURED]:"critical",[Be.REGULAR_KEY]:"info",[Be.MULTISIG]:"info",[Be.RECOVERABLE]:"info",[Be.NORMAL]:"ok",[Be.UNKNOWN]:"warn"};o.push(xe({module:"Security",category:"security",sev:f[p.state]||"info",confidence:p.confidence,headline:`Account Control State: ${p.state}`,detail:`Reversibility: ${p.reversibility}`,observed:[`Master key: ${p.masterDisabled?"disabled":"active"}`,`Regular key: ${p.hasRegularKey?e.RegularKey:"not set"}`,`Signer list: ${p.hasSignerList?`${n.length} list(s)`:"none"}`,p.wasEverReenabled?"Master key has been re-enabled from a disabled state at least once in fetched history":null].filter(Boolean),classification:p.state===Be.MISCONFIGURED?"Signer quorum cannot be reached with the current signer weights as configured \u2014 this account may be functionally stuck regardless of anyone's intent.":p.state===Be.REGULAR_KEY?"A disabled master key with an active regular key is not the same as a locked/irreversible account \u2014 the regular key holder retains full control, including the ability to re-enable the master key.":null})),p.state===Be.BLACKHOLED&&(i-=40),p.state===Be.MISCONFIGURED&&(i-=30),d&&u&&o.push({sev:"warn",label:"Blackholed issuer caution",detail:"This account appears issuer-like and intentionally blackholed. Sending issued tokens back here may make them unrecoverable or effectively burn them."})}if(l){let f=s.find(({tx:b})=>b.TransactionType==="SetRegularKey"),g=f&&Date.now()/1e3-tn(f.tx)<86400*30;d?o.push({sev:"info",label:"Regular key points to blackhole address",detail:e.RegularKey}):g?(o.push({sev:"warn",label:"Regular key set recently",detail:`Key: ${e.RegularKey} \u2014 changed within 30 days. Verify you intended this.`}),i-=15):o.push({sev:"info",label:"Regular key active",detail:e.RegularKey})}n.forEach(f=>{let g=f.SignerEntries||[],b=f.SignerQuorum||1;o.push({sev:"info",label:`Multisig: ${g.length} signers, quorum ${b}`,detail:g.map(h=>{var v;return z(((v=h.SignerEntry)==null?void 0:v.Account)||"")}).join(", ")})}),t&_e.lsfGlobalFreeze&&(o.push({sev:"warn",label:"Global Freeze active",detail:"This issuer has frozen all token balances."}),i-=10),t&_e.lsfDepositAuth&&o.push({sev:"ok",label:"Deposit Authorization enabled",detail:"Only pre-authorized senders can deposit."}),t&_e.lsfDefaultRipple&&o.push({sev:"info",label:"Default Ripple enabled",detail:"Balances can ripple through this account (issuer behaviour)."});let m=s.filter(({tx:f})=>f.TransactionType==="AccountDelete");return m.length&&(o.push({sev:"warn",label:`${m.length} AccountDelete attempt(s)`,detail:"Account deletion was attempted."}),i-=5),t&_e.lsfRequireAuth&&o.push({sev:"info",label:"Require Auth enabled",detail:"This account must individually approve each trustline before it can hold a balance \u2014 restricts who can hold what it issues."}),t&_e.lsfNoFreeze&&o.push({sev:"info",label:"No Freeze enabled",detail:"This account has permanently given up the ability to freeze trustlines \u2014 an irreversible choice, typically made to reassure holders."}),t&_e.lsfRequireDestTag&&o.push({sev:"info",label:"Require Destination Tag enabled",detail:"Payments to this account must include a destination tag \u2014 common for exchange/custodial deposit accounts."}),t&_e.lsfDisallowXRP&&o.push({sev:"info",label:"Disallow XRP flag set",detail:"A client-side hint requesting senders avoid sending XRP to this account. Not enforced by the protocol \u2014 XRP can still be sent."}),t&_e.lsfPasswordSpent&&o.push({sev:"info",label:"Password Spent flag set",detail:"This account has already used its one free SetRegularKey transaction; further regular-key changes will cost the standard transaction fee."}),o.length===0&&o.push({sev:"ok",label:"No security issues detected",detail:"Master key active, no regular key or signer list overrides, no risky flags set."}),{findings:o,score:Math.max(0,i),controlState:p}}function Zv(e,t,n,s,a,o){let i=[],r="low",l=!!(t&_e.lsfDisableMaster),c=Uu(e,t,n,s),d=Vu(e,t,s);c?(i.push({sev:"info",label:"Intentional blackhole detected",detail:`Master key is disabled and regular key ${e.RegularKey} is a known blackhole address. This is typical for a permanently locked issuer/account, not a classic drain setup.`}),d&&i.push({sev:"warn",label:"Caution: sending assets back may burn them",detail:"Because this account appears to be an intentionally blackholed issuer, sending issued tokens back to it may strand or effectively burn those tokens."})):l&&e.RegularKey&&(i.push({sev:"critical",label:"Classic drain setup detected",detail:`Master key disabled. Regular key ${e.RegularKey} controls the account. If this key was set by an attacker, funds are at risk.`}),r="critical");let u=s.filter(({tx:m})=>m.TransactionType==="SetRegularKey"&&m.Account!==e.Account);if(!c&&u.length&&(i.push({sev:"critical",label:"Regular key set by external account",detail:`${u.length} key change(s) where sender \u2260 account owner. This is unusual.`}),r="critical"),a.length){let m=a.reduce((f,g)=>f+Number(g.Amount||0)/1e6,0);i.push({sev:"warn",label:`${a.length} open payment channel(s) \u2014 ${_(m,2)} XRP locked`,detail:`Destination(s): ${a.map(f=>z(f.Destination)).join(", ")}`}),r==="low"&&(r="medium")}if(o.length){let m=o.reduce((f,g)=>f+Number(g.Amount||0)/1e6,0);i.push({sev:"info",label:`${o.length} open escrow(s) \u2014 ${_(m,2)} XRP escrowed`,detail:`Escrow(s): ${o.map(f=>f.Destination?z(f.Destination):"self-escrow").join(", ")}`})}let p=s.filter(({tx:m})=>m.TransactionType==="DepositPreauth"&&m.Authorize);return p.length>5&&(i.push({sev:"warn",label:`${p.length} DepositPreauth grants issued`,detail:"Account pre-authorized many senders. Review if all are trusted."}),r==="low"&&(r="medium")),i.length===0&&i.push({sev:"ok",label:"No compromise-risk patterns detected",detail:"Auth structure looks intact."}),{signals:i,riskLevel:r}}function ey(e,t,n,s={}){let a=ju(e,t,n),i=Wu(a,e,t,s).map(c=>Uv(c,a,e,t)),r=[],l="none";for(let c of i){let d=c.windowSec===86400?"24h":`${Math.round(c.windowSec/86400)}d`,u=c.dataCompleteness!=="complete",p=[`${_(c.grossOutflowXrp,2)} XRP gross outflow and ${_(c.grossInflowXrp,2)} XRP gross inflow within ${d} (opening balance ${_(c.openingBalanceXrp,2)} XRP, closing ${_(c.closingBalanceXrp,2)} XRP)`,c.newRecipientPct!=null?`${c.newDestCount} of ${c.episodeDestCount} destinations were first-time recipients`:null,c.trustlineLiquidations.length?`${c.trustlineLiquidations.length} token position(s) liquidated shortly before/during this window`:null,c.dexConversionPrecedingWithdrawal?"A token\u2192XRP conversion occurred in the 48h before this outflow began":null,c.triggeredByAuthChange?"A regular-key or signer-list change occurred immediately before this window":null].filter(Boolean),m=[`Actual balance depletion: ${(c.actualDepletionPct*100).toFixed(1)}% (opening ${_(c.openingBalanceXrp,2)} \u2192 closing ${_(c.closingBalanceXrp,2)} XRP)`,`Gross turnover: ${(c.grossTurnoverPct*100).toFixed(0)}% of opening balance \u2014 this measures volume moved, not wealth lost, and can exceed 100% for a wallet that passes funds through`,c.newRecipientPct!=null?`${(c.newRecipientPct*100).toFixed(0)}% of destinations were first-time recipients`:null,c.topDestShare!=null?`${(c.topDestShare*100).toFixed(0)}% of the outflow went to a single destination`:null,c.transferSizeAnomaly?`Transfer sizes in this window are ${(c.episodeMedianXrp/c.historicalMedianXrp).toFixed(1)}x this account's own historical median transfer size`:null].filter(Boolean),f=[c.transferSizeAnomaly?"This transfer pattern is unusual relative to this account's own established behavior, not just large in absolute terms":null,c.classification==="sweep"?"The balance trajectory is consistent with an intentional consolidation of most available funds, not incidental turnover":null,c.classification==="potential-drain"?"The balance trajectory is consistent with a substantial, non-recovered loss of previously-held funds":null].filter(Boolean),g=c.classification==="potential-drain"||c.classification==="sweep"&&c.triggeredByAuthChange?c.triggeredByAuthChange?"This movement may represent unauthorized depletion following account-control changes.":"This movement may represent unauthorized depletion, though a deliberate self-directed transfer remains equally consistent with the same ledger evidence.":null,b=[];c.classification==="pass-through"&&b.push("Balance depletion is minimal \u2014 inflow within the window nearly offset the outflow, consistent with funds passing through rather than being lost"),c.newRecipientPct!=null&&c.newRecipientPct>.7&&b.push("Nearly all destinations are first-time recipients, not established counterparties"),c.triggeredByAuthChange&&b.push("Outflow immediately follows an authorization change \u2014 the classic compromise-then-drain sequence"),c.dexConversionPrecedingWithdrawal&&c.trustlineLiquidations.length&&b.push("Assets were converted to XRP shortly before leaving, consistent with liquidating a position specifically to withdraw everything");let h=c.destinations.some(T=>T.entity),v;c.classification==="pass-through"?v="info":c.triggeredByAuthChange||c.actualDepletionPct>=.9?v="critical":c.classification==="sweep"||c.classification==="potential-drain"?v="warn":v="info",v==="critical"?l="critical":v==="warn"&&l!=="critical"&&(l=l==="none"||l==="low"?"high":l);let w=c.triggeredByAuthChange?.75:.5,k=u?w*.6:w,$={sweep:"Sweep \u2014 most of the opening balance left with little offsetting inflow.","pass-through":"Pass-through \u2014 funds moved through the account; little of its own opening balance was actually lost.","potential-drain":"Potential drain \u2014 a substantial share of the opening balance is genuinely gone by the end of this window.","partial-outflow":"Partial outflow \u2014 a moderate, ambiguous balance change."}[c.classification]||"";r.push(xe({module:"Asset Drain Behavior",category:"security",sev:v,confidence:k,headline:`${$.split(" \u2014 ")[0]}: ${_(c.grossOutflowXrp,2)} XRP gross outflow, ${(c.actualDepletionPct*100).toFixed(0)}% actual depletion within ${d}`,detail:`Sliding-window balance reconstruction (gross outflow, gross inflow, and opening-vs-closing balance tracked separately).${u?" Confidence reduced: transaction history for this period could not be fully verified as complete.":""}`,observed:p,calculated:m,inferred:f,hypothesis:g,alternativeExplanations:["A planned, deliberate transfer by the account's own owner (exchange withdrawal, consolidation, moving to a new wallet)",h?"Destination is a known exchange or labeled entity, consistent with a routine cash-out":"Destination(s) not in the known-entity registry \u2014 inconclusive either way"],evidenceAgainstBenign:b,classification:`${$} ${c.triggeredByAuthChange?"Outflow following an authorization change is a strong compromise-and-drain signal, but ledger data alone cannot distinguish an attacker from an owner who changed their own key and then withdrew funds themselves.":"This describes behavior, not intent \u2014 see Account Compromise Risk above for whether the account's access controls show separate signs of being compromised."}`}))}return r.length||r.push(xe({module:"Asset Drain Behavior",category:"security",sev:"ok",headline:"No abnormal depletion detected",detail:"No window scanned showed a large, fast balance drop relative to this account's own history."})),{episodes:i,findings:r,severity:l}}var Ru={low:0,medium:1,high:2,critical:3,none:-1};function Gu(e,t,n,s,a,o,i,r,l){let c=Zv(e,t,n,s,a,o),d=ey(s,i,r,l),u=d.severity==="none"?"low":d.severity==="high"?"critical":d.severity,p=Ru[u]>Ru[c.riskLevel]?u:c.riskLevel;return{signals:[...c.signals,...d.findings],riskLevel:p,compromiseRiskLevel:c.riskLevel,assetDrainSeverity:d.severity,episodes:d.episodes}}function ty(e,t,n){let s=[],a=new Map(e.map(m=>[m.NFTokenID,m])),i=t.filter(({tx:m})=>m.TransactionType==="NFTokenCreateOffer"&&m.Account===n).filter(({tx:m})=>{let f=m.Amount;return f?typeof f=="string"?Number(f)<1e6:!1:!0});i.length&&s.push({sev:"critical",label:`${i.length} NFT offer(s) created for \u22641 XRP`,detail:"You created sell offers at near-zero price. This is a common NFT drain vector \u2014 attackers trick victims into listing their NFTs for free."});let r=t.filter(({tx:m})=>m.TransactionType==="NFTokenAcceptOffer"&&m.Account===n);r.length&&s.push({sev:"warn",label:`${r.length} NFT offer(s) accepted`,detail:"Review these transactions to confirm they were intentional sales/purchases."});let l=t.filter(({tx:m})=>m.TransactionType==="NFTokenBurn"&&m.Account===n);l.length&&s.push({sev:"warn",label:`${l.length} NFT(s) burned`,detail:"Burned NFTs cannot be recovered. Confirm these were intentional."});let c=t.filter(({tx:m})=>m.TransactionType==="NFTokenMint"&&m.Account===n),d=t.filter(({tx:m})=>m.TransactionType==="NFTokenCreateOffer"||m.TransactionType==="NFTokenAcceptOffer");c.length>0&&d.length>0&&s.push({sev:"info",label:`${c.length} NFT(s) minted \xB7 ${d.length} transfer event(s)`,detail:"This account has minting activity."});let u=e.filter(m=>m.TransferFee&&m.TransferFee>0);if(u.length){let m=u.reduce((f,g)=>f+g.TransferFee,0)/u.length;s.push({sev:"info",label:`${u.length} NFT(s) carry transfer fees (avg ${(m/1e3).toFixed(1)}%)`,detail:"These NFTs pay royalties on each transfer."})}let p=e.filter(m=>!m.URI);return p.length>2&&s.push({sev:"warn",label:`${p.length} NFT(s) have no URI / metadata`,detail:"NFTs without a URI may be spam or placeholder tokens used in scams."}),s.length===0&&e.length===0?s.push({sev:"ok",label:"No NFT activity detected",detail:"This account holds no NFTs."}):s.length===0&&s.push({sev:"ok",label:`${e.length} NFT(s) held \u2014 no risk signals`,detail:"NFT posture looks normal."}),{flags:s,nftCount:e.length,mintCount:c.length}}var so={tfPassive:65536,tfImmediateOrCancel:131072,tfFillOrKill:262144,tfSell:524288};function ny(e,t){var n;for(let s of(e==null?void 0:e.AffectedNodes)||[]){let a=s.CreatedNode;if((a==null?void 0:a.LedgerEntryType)==="Offer"&&((n=a.NewFields)==null?void 0:n.Account)===t)return a}return null}function Ku(e,t,n={}){var r,l,c,d,u,p,m;let s=new Map,a=[],o=n.newestToOldestComplete||n.oldestToNewestFetched?"complete":"possibly-truncated";e.forEach((f,g)=>{var C,R,O,D,I;let{tx:b,meta:h}=f;if(b.TransactionType!=="OfferCreate"||b.Account!==t||(h==null?void 0:h.TransactionResult)!=="tesSUCCESS")return;let v={currency:er(b.TakerGets),issuer:typeof b.TakerGets=="object"?b.TakerGets.issuer:null,value:Zt(b.TakerGets)},w={currency:er(b.TakerPays),issuer:typeof b.TakerPays=="object"?b.TakerPays.issuer:null,value:Zt(b.TakerPays)},k=ny(h,t),$=k?{gets:Zt((C=k.NewFields)==null?void 0:C.TakerGets),pays:Zt((R=k.NewFields)==null?void 0:R.TakerPays)}:null,T={gets:Math.max(0,(v.value??0)-(($==null?void 0:$.gets)??0)),pays:Math.max(0,(w.value??0)-(($==null?void 0:$.pays)??0))},S=[];for(let F of h.AffectedNodes||[]){let H=F.DeletedNode||F.ModifiedNode;if(!H||H.LedgerEntryType!=="Offer")continue;let E=(O=H.FinalFields)==null?void 0:O.Account;!E||E===t||S.push({account:E,gets:Zt((D=H.FinalFields)==null?void 0:D.TakerGets),pays:Zt((I=H.FinalFields)==null?void 0:I.TakerPays)})}let N=Number(b.Flags||0),P={offerId:`${t}:${b.Sequence}`,createHash:b.hash,createDate:b.date,createLedgerIndex:(k==null?void 0:k.LedgerIndex)||null,takerGetsOriginal:v,takerPaysOriginal:w,offerSequence:b.Sequence,replacesOfferSeq:b.OfferSequence||null,flags:{passive:!!(N&so.tfPassive),immediateOrCancel:!!(N&so.tfImmediateOrCancel),fillOrKill:!!(N&so.tfFillOrKill),sell:!!(N&so.tfSell)},expiration:b.Expiration||null,crossedAtCreation:T,counterpartiesAtCreation:S,restingAmount:$,status:k?"resting":"filled-immediately",consumedEvents:[],cancelHash:null,cancelDate:null,timeRestingSeconds:null,realizedFillPct:null,expiryUncertain:!1,dataCompleteness:o,_createIdx:g};s.set(P.offerId,P),a.push(P)});for(let f of a){if(!f.createLedgerIndex)continue;for(let h=f._createIdx+1;h<e.length;h++){let{tx:v,meta:w}=e[h];if((w==null?void 0:w.TransactionResult)!=="tesSUCCESS"&&(w==null?void 0:w.TransactionResult)!=="tecKILLED"&&!((r=w==null?void 0:w.AffectedNodes)!=null&&r.length))continue;let k=null;for(let $ of(w==null?void 0:w.AffectedNodes)||[]){let T=$.CreatedNode,S=$.ModifiedNode,N=$.DeletedNode,P=T||S||N;if(!(!P||P.LedgerEntryType!=="Offer")&&P.LedgerIndex===f.createLedgerIndex){k={node:P,kind:N?"deleted":S?"modified":"created"};break}}if(k){if(k.kind==="deleted"){let $=v.Account===t&&v.TransactionType==="OfferCancel"&&v.OfferSequence===f.offerSequence,T=v.Account===t&&v.TransactionType==="OfferCreate"&&v.OfferSequence===f.offerSequence;if($||T)f.status="cancelled",f.cancelHash=v.hash,f.cancelDate=v.date;else{let S=ir(v,w,t);S.xrpDelta!==0||S.tokenDeltas.some(P=>P.delta!==0)?(f.status="consumed-later",f.consumedEvents.push({hash:v.hash,date:v.date,counterpartyAccount:v.Account!==t?v.Account:null})):(f.status="expired",f.expiryUncertain=!0)}f.timeRestingSeconds=(v.date??f.createDate)-f.createDate,f.dataCompleteness=f.dataCompleteness;break}if(k.kind==="modified"){let $=Zt((l=k.node.FinalFields)==null?void 0:l.TakerGets),T=Zt((c=k.node.FinalFields)==null?void 0:c.TakerPays);f.consumedEvents.push({hash:v.hash,date:v.date,counterpartyAccount:v.Account!==t?v.Account:null,gets:Math.max(0,(((d=f.restingAmount)==null?void 0:d.gets)??0)-($??0)),pays:Math.max(0,(((u=f.restingAmount)==null?void 0:u.pays)??0)-(T??0))}),f.restingAmount={gets:$,pays:T},f.status="partially-filled-then-resting"}}}if(f.status==="resting"||f.status==="partially-filled-then-resting"){let h=Math.floor(Date.now()/1e3)-Fu,v=((m=(p=e[e.length-1])==null?void 0:p.tx)==null?void 0:m.date)??h;f.expiration!=null&&f.expiration<=v?(f.status="expired",f.expiryUncertain=!0):f.status="unknown-open",f.timeRestingSeconds=v-f.createDate,f.dataCompleteness}let g=f.consumedEvents.reduce((h,v)=>h+(v.gets||0),0),b=f.crossedAtCreation.gets+g;f.realizedFillPct=f.takerGetsOriginal.value?Math.min(100,b/f.takerGetsOriginal.value*100):null,delete f._createIdx}let i={total:a.length,filledImmediately:a.filter(f=>f.status==="filled-immediately").length,cancelled:a.filter(f=>f.status==="cancelled").length,consumedLater:a.filter(f=>f.status==="consumed-later").length,partiallyFilled:a.filter(f=>f.status==="partially-filled-then-resting").length,expired:a.filter(f=>f.status==="expired").length,unknownOpen:a.filter(f=>f.status==="unknown-open").length};return{byOfferId:s,list:a,stats:i}}function sy(e,t){let n=e.list,s=n.length,a=n.filter(v=>v.status==="filled-immediately").length,o=n.filter(v=>v.status==="resting"||v.status==="partially-filled-then-resting"||v.status==="unknown-open").length,i=n.filter(v=>v.status==="consumed-later").length,r=n.filter(v=>v.status==="cancelled").length,l=n.filter(v=>v.status==="expired").length,c=n.filter(v=>v.status==="unknown-open").length,d=n.map(v=>v.timeRestingSeconds).filter(v=>v!=null),u=d.length?d.reduce((v,w)=>v+w,0)/d.length:null,p=[...d].sort((v,w)=>v-w),m=p.length?p[Math.floor(p.length/2)]:null,f=n.map(v=>v.realizedFillPct).filter(v=>v!=null),g=f.length?f.reduce((v,w)=>v+w,0)/f.length:null,b=new Map;for(let v of n){let w=[v.takerGetsOriginal.currency||"?",v.takerPaysOriginal.currency||"?"].sort().join("\u2194"),k=b.get(w)||{created:0,filled:0,cancelled:0,fillPctSum:0,fillPctCount:0};k.created++,(v.status==="filled-immediately"||v.status==="consumed-later")&&k.filled++,v.status==="cancelled"&&k.cancelled++,v.realizedFillPct!=null&&(k.fillPctSum+=v.realizedFillPct,k.fillPctCount++),b.set(w,k)}for(let v of b.values())v.avgFillPct=v.fillPctCount?v.fillPctSum/v.fillPctCount:null;let h=[];if(s>=10){let v=r/s;g!=null&&g<5&&v>.5?h.push(xe({module:"Offer Fill Rate",category:"liquidity",sev:"warn",confidence:.6,headline:`Low realized fill rate: ${g.toFixed(1)}% across ${s} offers`,detail:`${r} of ${s} offers were cancelled, most with minimal execution before cancellation.`,observed:[`${r} cancelled (${(v*100).toFixed(0)}%)`,`${i} consumed by a counterparty after resting`,`${l} expired/removed unfunded`,`${c} still open as of the last analyzed transaction`,`Average time resting before resolution: ${u!=null?u.toFixed(0)+"s":"unknown"}`],alternativeExplanations:["Active order management \u2014 repricing as the market moves","Automated market-making that requeues orders frequently"],evidenceAgainstBenign:g<1?["Realized fill percentage is near zero, not just below average"]:[],classification:"A low fill rate is observed. On its own this does not establish intent \u2014 see the Spoofing and Market-Maker Automation scores for further context."})):h.push(xe({module:"Offer Fill Rate",category:"liquidity",sev:"ok",confidence:.7,headline:`${g!=null?g.toFixed(1)+"%":"Normal"} realized fill rate across ${s} offers`,detail:`${a} filled immediately, ${i} consumed after resting, ${r} cancelled, ${l} expired.`}))}else h.push(xe({module:"Offer Fill Rate",category:"liquidity",sev:"info",headline:`Only ${s} offer(s) placed \u2014 insufficient sample for fill-rate analysis`,detail:"Need at least 10 OfferCreate transactions for a meaningful fill-rate read."}));return{createdCount:s,immediateFillCount:a,restingCount:o,laterConsumedCount:i,cancelledCount:r,expiredCount:l,unknownOpenCount:c,avgTimeRestingSeconds:u,medianTimeRestingSeconds:m,realizedFillPctOverall:g,byPair:b,findings:h}}function ay(e,t,n){let s=e.list,a=s.map(h=>h.createDate).filter(h=>h!=null).sort((h,v)=>h-v),o=h=>{if(!a.length)return 0;let v=1;for(let w=0;w<a.length;w++){let k=1;for(let $=w+1;$<a.length&&a[$]-a[w]<=h;$++)k++;v=Math.max(v,k)}return v},i={thirtySec:o(30),oneHour:o(3600)},r=s.map(h=>h.takerGetsOriginal.value).filter(h=>h!=null&&h>0),l=null;if(r.length>=or){let h=r.reduce((w,k)=>w+k,0)/r.length,v=Math.sqrt(r.reduce((w,k)=>w+(k-h)**2,0)/r.length);l=h>0?v/h:null}let c=[100,1e3,1e4,1e5],d=r.filter(h=>c.some(v=>Math.abs(h%v)<1e-6&&h/v>=1)).length,u=r.length?d/r.length:0,p=new Map;s.forEach(h=>{let v=[h.takerGetsOriginal.currency||"?",h.takerPaysOriginal.currency||"?"].sort().join("\u2194");p.set(v,(p.get(v)||0)+1)});let m=[...p.entries()].sort((h,v)=>v[1]-h[1])[0]||null,f=m&&s.length?m[1]/s.length:0,g=s.length?s.filter(h=>h.status==="cancelled").length/s.length:0,b=s.map(h=>h.timeRestingSeconds).filter(h=>h!=null);return{burstWindows:i,sizeCV:l,roundNumberPct:u,pairConcentration:f,dominantPair:m,cancelRatio:g,restingTimes:b,createdCount:s.length}}function oy(e,t,n){let s=n.filter(({tx:m})=>m.Account===e&&m.Destination===t&&typeof m.Amount=="string").map(({tx:m})=>({amtXrp:Number(m.Amount)/1e6,ts:tn(m)})).filter(m=>m.amtXrp>0&&m.ts!=null).sort((m,f)=>m.ts-f.ts),a=n.filter(({tx:m})=>m.Destination===e&&m.Account===t&&typeof m.Amount=="string").map(({tx:m})=>({amtXrp:Number(m.Amount)/1e6,ts:tn(m)})).filter(m=>m.amtXrp>0&&m.ts!=null).sort((m,f)=>m.ts-f.ts),o=[],i=0;for(let m of s){for(;i<a.length&&a[i].ts<m.ts;)i++;if(i>=a.length)break;let f=a[i],g=1-Math.abs(m.amtXrp-f.amtXrp)/Math.max(m.amtXrp,f.amtXrp);o.push({sentXrp:m.amtXrp,returnedXrp:f.amtXrp,elapsedSec:Math.max(0,f.ts-m.ts),similarity:Math.max(0,g)}),i++}if(!o.length)return null;let r=m=>{let f=[...m].sort((g,b)=>g-b);return f[Math.floor(f.length/2)]},l=r(o.map(m=>m.elapsedSec)),c=r(o.map(m=>m.similarity)),d=Math.min(1,o.length/5),u=1/(1+l/86400),p=(d+c+u)/3;return{counterparty:t,occurrences:o.length,medianElapsedSec:l,medianSimilarity:c,qualityScore:p}}function iy(e,t,n,s){let a=[],o=0,i=n.filter(({tx:u})=>u.TransactionType==="Payment"),r=new Set(i.filter(({tx:u})=>u.Account===s&&u.Destination).map(({tx:u})=>u.Destination)),l=new Set(i.filter(({tx:u})=>u.Destination===s&&u.Account).map(({tx:u})=>u.Account)),c=[...r].filter(u=>l.has(u));if(c.length>0&&i.length>=or){let u=c.length/r.size;if(u>Rv){let p=new Set;for(let k of t.list){for(let $ of k.counterpartiesAtCreation)p.add($.account);for(let $ of k.consumedEvents)$.counterpartyAccount&&p.add($.counterpartyAccount)}let m=c.filter(k=>p.has(k)),f=c.map(k=>oy(s,k,i)).filter(Boolean).sort((k,$)=>$.qualityScore-k.qualityScore),g=f[0]||null,b=f.filter(k=>k.qualityScore>=.6),h=g&&g.qualityScore>=.6?"warn":"info",v=m.length?.55:.4,w=g?Math.max(.15,v*(.4+.6*g.qualityScore)):v*.5;a.push(xe({module:"Wash Execution",category:"market-integrity",sev:h,confidence:w,headline:g?`${c.length} round-trip payment counterpart(s); strongest: ${g.occurrences} cycle(s), ${(g.medianSimilarity*100).toFixed(0)}% amount match, ${_(g.medianElapsedSec/60,1)} min median turnaround`:`${c.length} round-trip payment counterpart(s) detected`,detail:`${(u*100).toFixed(1)}% of payment recipients also sent back to this account.`,observed:[`${c.length} of ${r.size} outbound recipients also sent payments back`,b.length?`${b.length} partner(s) show a strong pattern: frequent, closely-matched, fast-turnaround round-trips`:"No partner shows a strong frequent/matched/fast round-trip pattern \u2014 evidence is weak even where a round-trip exists",m.length?`${m.length} of those also traded directly on the DEX with this account`:"No overlap found with DEX trading counterparties"],alternativeExplanations:["Ordinary reciprocal business/personal payments","Exchange deposit/withdrawal cycling through the same account"],evidenceAgainstBenign:[...m.length?["Payment round-trip AND direct DEX trading with the same counterparty(ies)"]:[],...b.length?[`${b.length} counterpart(y/ies) show frequent, near-identical-amount, fast round-trips \u2014 closer to a scripted cycle than an isolated reciprocal payment`]:[]],classification:b.length?"Frequent, closely-matched, fast round-trips are meaningfully stronger evidence than a single reciprocal payment \u2014 still cannot confirm circular multi-account flow (A\u2192B\u2192C\u2192A) from this account's history alone, which would require the counterparties' own transaction histories.":"A round-trip relationship exists but is infrequent, loosely amount-matched, and/or slow to return \u2014 this is weak evidence on its own and commonly reflects ordinary reciprocal payments rather than wash execution."})),o+=(m.length?25:15)*(g?Math.max(.3,g.qualityScore):.5)}}let d=i.filter(({tx:u})=>u.Account===s&&u.Destination===s);return d.length>0&&(a.push(xe({module:"Wash Execution",category:"market-integrity",sev:"critical",confidence:.85,headline:`${d.length} self-payment(s): sender = receiver`,detail:"Payments where origin and destination are the same address.",observed:[`${d.length} Payment transaction(s) with Account === Destination`],alternativeExplanations:["A no-op transaction used to mark an account active, or to test a memo/path"],evidenceAgainstBenign:d.length>2?["Repeated, not a single isolated instance"]:[],classification:"Confirmed self-payment. Creates recorded volume with zero net economic transfer \u2014 this is a fact about the transaction, not an inference."})),o+=30),a.length||a.push(xe({module:"Wash Execution",category:"market-integrity",sev:"ok",headline:"No wash-execution signals",detail:`${t.list.length} offers, ${d.length} self-payments \u2014 patterns look normal.`})),{score:Math.min(100,o),findings:a,stats:{roundTrip:c.length,selfTrades:d.length}}}function ry(e,t,n,s,a){var u;let o=[],i=0,r=t.list,l=t.byOfferId,c=0,d=0;for(let p of r){if(!p.replacesOfferSeq)continue;let m=l.get(`${s}:${p.replacesOfferSeq}`);if(!m)continue;c++;let f=m.takerPaysOriginal.value&&m.takerGetsOriginal.value?m.takerPaysOriginal.value/m.takerGetsOriginal.value:null,g=p.takerPaysOriginal.value&&p.takerGetsOriginal.value?p.takerPaysOriginal.value/p.takerGetsOriginal.value:null;f&&g&&Math.abs(g-f)/f<.02&&d++}if(c>=5&&d/c>.6&&(o.push(xe({module:"Spoofing",category:"market-integrity",sev:"warn",confidence:.45,headline:`${d} of ${c} order replacements kept nearly the same price`,detail:"Cancel-and-immediately-recreate at a near-identical price, repeated \u2014 a quote-management pattern worth a closer look.",observed:[`${c} create-and-replace chains found`,`${d} replaced within 2% of the prior price`],alternativeExplanations:["Routine order refresh/repricing by an active trader or market maker","Bumping sequence to avoid an unrelated conflict"],classification:"Replacement pattern observed. On its own this is common in both legitimate quote maintenance and layering \u2014 see Market-Maker Automation for the explanatory read."})),i+=15),r.length>=10){let p=r.filter(m=>m.takerGetsOriginal.currency==="XRP"&&m.takerGetsOriginal.value!=null);if(p.length>=10){let m=p.map(v=>v.takerGetsOriginal.value).sort((v,w)=>w-v),f=m[Math.floor(m.length*.05)]||0,g=p.filter(v=>v.takerGetsOriginal.value>=f),b=g.filter(v=>v.status==="cancelled"||v.status==="expired"),h=g.length>=5?b.length/g.length:0;h>=.95&&(o.push(xe({module:"Spoofing",category:"market-integrity",sev:"warn",confidence:.3,headline:`${(h*100).toFixed(0)}% of this wallet's largest orders were cancelled without meaningful fill (own-history proxy)`,detail:`${b.length} of ${g.length} top-5%-by-this-wallet's-own-size orders cancelled or expired.`,observed:["Sizing is relative to this wallet's own order history, not current book depth",`${b.length}/${g.length} cancelled or expired without fill`],alternativeExplanations:["A large order sized appropriately for a genuinely deep, liquid market","Cancelled for unrelated reasons (funding change, strategy shift)"],classification:"Own-history size proxy only \u2014 true book-depth-relative sizing and price-distance-from-executable checks need historical order-book state this app cannot reliably obtain from public XRPL nodes. Treat as a weaker signal than a book-relative measurement would be."})),i+=10)}}if((u=a==null?void 0:a.signals)!=null&&u.length)for(let p of a.signals)(p.sev==="critical"||p.sev==="warn")&&(o.push(p),i+=p.sev==="critical"?20:10);return o.length||o.push(xe({module:"Spoofing",category:"market-integrity",sev:"ok",headline:"No spoofing signals",detail:"No large-order cancel pattern, replacement pattern, or live book wall detected."})),{score:Math.min(100,i),findings:o}}function ly(e,t,n,s,a){let o=[],i=!1,r=e.cancelRatio>Nv,l=e.sizeCV!=null&&e.sizeCV<.2,c=e.burstWindows.thirtySec>=8||e.burstWindows.oneHour>100,d=(a==null?void 0:a.realizedFillPctOverall)!=null&&a.realizedFillPctOverall>=5;return e.createdCount>=or&&r&&(l||c)?(i=!0,o.push(xe({module:"Market-Maker Automation",category:"automation",sev:"info",confidence:d?.6:.4,headline:"Behavior consistent with automated market-making / quote maintenance",detail:`${(e.cancelRatio*100).toFixed(0)}% cancel ratio, ${e.sizeCV!=null?"CV "+e.sizeCV.toFixed(2):"no size-uniformity read"}, max ${e.burstWindows.thirtySec} offers/30s.`,observed:[`Cancel ratio: ${(e.cancelRatio*100).toFixed(0)}%`,e.sizeCV!=null?`Order-size coefficient of variation: ${e.sizeCV.toFixed(2)}`:null,`Burst: up to ${e.burstWindows.thirtySec} offers in 30s, ${e.burstWindows.oneHour} in 1h`,d?`Realized fill rate: ${a.realizedFillPctOverall.toFixed(1)}% \u2014 not zero, consistent with a working market-making strategy`:"Realized fill rate is low or unknown"].filter(Boolean),alternativeExplanations:["Spoofing/layering dressed up with uniform sizing to look automated"],evidenceAgainstBenign:d?[]:["Fill rate is low despite the high order volume \u2014 automation alone does not explain that combination"],classification:d?"High cancel/burst/uniformity plus a non-trivial realized fill rate is the expected signature of legitimate automated market-making. This explanation should reduce confidence in Wash Execution and Spoofing findings above, not add to them.":"High cancel/burst/uniformity WITHOUT meaningful fills is less consistent with genuine market-making \u2014 weigh the Spoofing and Wash Execution findings above accordingly."}))):o.push(xe({module:"Market-Maker Automation",category:"automation",sev:"ok",headline:"No strong automation signature",detail:"Order behavior does not show the high-cancel/tight-sizing/burst pattern typical of automated market-making."})),{automationLikely:i,findings:o}}function cy(e,t,n,s,a,o){let i=ay(s,e,t),r=iy(i,s,e,t),l=ry(i,s,e,t,o),c=ly(i,s,e,t,a),d=[...r.findings,...l.findings,...c.findings,...(a==null?void 0:a.findings)||[]],u=Math.min(100,r.score+l.score),p=u===0?"clean":u<25?"low-risk":u<50?"suspicious":"high-risk";return{signals:d,score:u,verdict:p,executionScore:r.score,spoofingScore:l.score,automationLikely:c.automationLikely,stats:{creates:s.list.length,cancels:s.list.filter(m=>m.status==="cancelled").length,fills:(a==null?void 0:a.immediateFillCount)??0,payments:e.filter(({tx:m})=>m.TransactionType==="Payment").length,roundTrip:r.stats.roundTrip,selfTrades:r.stats.selfTrades}}}var dy=[0,.301,.176,.125,.097,.079,.067,.058,.051,.046];function py(e){let t=new Map;for(let{tx:n}of e){let s=n.TransactionType==="Payment"?"Payment":n.TransactionType==="OfferCreate"||n.TransactionType==="OfferCancel"?"Offer":null;if(!s)continue;let a=[n.Amount,n.TakerGets,n.TakerPays,n.SendMax,n.DeliverMin];for(let o of a){let i=er(o),r=Zt(o);if(r==null||r<=0||!Number.isFinite(r)||!i)continue;let l=`${i}|${s}`;t.has(l)||t.set(l,{currency:i,txClass:s,values:[]}),t.get(l).values.push(r)}}return t}function uy(e){let t=e.length,n=[];if(t<50)return{level:"LOW",reasons:[`Only ${t} observations in this group (need \u226550)`],n:t};let s=[...e].sort((u,p)=>u-p),a=s[0],o=s[s.length-1],i=a>0?Math.log10(o/a):0,r=[100,1e3,1e4,1e5],c=e.filter(u=>r.some(p=>Math.abs(u%p)<1e-6&&u/p>=1)).length/t,d="HIGH";return i<1?(d="LOW",n.push(`Values span only ${i.toFixed(1)} orders of magnitude \u2014 Benford needs a wide spread to be meaningful`)):i<2&&(d="MEDIUM",n.push(`Narrow magnitude spread (${i.toFixed(1)} orders of magnitude)`)),c>.5?(d="LOW",n.push(`${(c*100).toFixed(0)}% round-number amounts \u2014 suggests fixed lot sizes or tick constraints, not organically-generated values`)):c>.25&&d==="HIGH"&&(d="MEDIUM",n.push(`${(c*100).toFixed(0)}% round-number amounts`)),t<100&&d==="HIGH"&&(d="MEDIUM",n.push(`Sample size (${t}) clears the minimum but is still modest`)),n.length||n.push("Sufficient sample size, wide magnitude spread, low round-number concentration"),{level:d,reasons:n,magnitudeSpread:i,roundPct:c,n:t}}function my(e){let t=e.length,n=new Array(10).fill(0);for(let o of e){let i=o.toFixed(6).replace(/^0+\.?0*/,""),r=parseInt(i[0],10);r>=1&&r<=9&&n[r]++}let s=0,a=[];for(let o=1;o<=9;o++){let i=n[o]/t,r=dy[o];s+=t*Math.pow(i-r,2)/r,a.push({digit:o,obs:(i*100).toFixed(1),exp:(r*100).toFixed(1),delta:((i-r)*100).toFixed(1)})}return{chiSq:s,digitBreakdown:a,n:t}}function Ju(e){if((e==null?void 0:e.chiSq)==null)return 0;let t={HIGH:1,MEDIUM:.5,LOW:.15}[e.overallApplicability]??.15;return Math.min(10,e.chiSq/20.09*10)*t}function fy(e){let t=py(e),n=[];for(let[i,r]of t){if(r.values.length<50)continue;let l=uy(r.values),c=my(r.values);n.push({key:i,currency:r.currency,txClass:r.txClass,...c,applicability:l})}if(n.sort((i,r)=>r.n-i.n),!n.length)return{signals:[{sev:"info",label:"Insufficient data for Benford's Law",detail:"No single currency/transaction-class group reached the 50-observation minimum \u2014 amounts are too fragmented across assets to test any one distribution meaningfully."}],results:[],overallApplicability:"LOW",chiSq:null,verdict:"insufficient",digitBreakdown:[],sampleSize:0};let s=n.map(i=>xe({module:"Benford's Law",category:"market-integrity",sev:i.applicability.level==="LOW"?"info":i.chiSq>20.09?"warn":"ok",confidence:{HIGH:.7,MEDIUM:.4,LOW:.15}[i.applicability.level],headline:`${i.currency==="XRP"?"XRP":z(i.currency)} ${i.txClass} amounts: \u03C7\xB2=${i.chiSq.toFixed(1)}, Applicability ${i.applicability.level}`,detail:`n=${i.n} observations`,observed:[`Benford Applicability: ${i.applicability.level}`,...i.applicability.reasons,`Chi-square statistic: ${i.chiSq.toFixed(2)} (critical values: 15.51 at p<0.05, 20.09 at p<0.01)`],classification:i.applicability.level==="LOW"?"Benford's Law is not reliably applicable to this group (narrow magnitude spread and/or high round-number concentration) \u2014 a deviation here says nothing about whether amounts were fabricated.":i.chiSq>20.09?"Amount-generation pattern is non-natural under this model. This describes the shape of the distribution, not a conclusion about intent \u2014 fixed pricing tiers, algorithmic strategies, and token denomination conventions are common legitimate causes of Benford deviation.":"First-digit distribution is consistent with organic, unconstrained amount generation."})),a=n[0],o=n.some(i=>i.applicability.level==="HIGH")?"HIGH":n.some(i=>i.applicability.level==="MEDIUM")?"MEDIUM":"LOW";return{signals:s,results:n,overallApplicability:o,chiSq:a.chiSq,verdict:a.chiSq>20.09?"high-deviation":a.chiSq>15.51?"moderate-deviation":"normal",digitBreakdown:a.digitBreakdown,sampleSize:a.n}}function hy(e,t){let s=[],a=[];for(let{tx:b}of e){let h=[b.Amount,b.TakerGets,b.TakerPays];for(let v of h){let w=typeof v=="string"?Number(v)/1e6:v!=null&&v.value?Number(v.value):null;w&&w>0&&Number.isFinite(w)&&a.push(w)}}let o=a.length>=30?(()=>{let b=new Array(12).fill(0);for(let h of a){let v=Math.min(11,Math.max(0,Math.floor(Math.log10(h+1)*2)));b[v]++}return ea(b)})():null,i={};for(let{tx:b}of e){let h=b.Account===t?b.Destination:b.Account;h&&h!==t&&(i[h]=(i[h]||0)+1)}let r=Object.values(i),l=r.length>=3?ea(r):null,c=new Array(24).fill(0),d=!1;for(let{tx:b}of e)if(b.date){let v=new Date((b.date+946684800)*1e3).getUTCHours();c[v]++,d=!0}let u=d&&e.length>=30?ea(c):null,p={};for(let{tx:b}of e)p[b.TransactionType]=(p[b.TransactionType]||0)+1;let m=ea(Object.values(p)),f="normal",g=0;if(o!==null&&(o<1.5?(f="low-entropy",g+=18,s.push({sev:"warn",label:`Amount entropy critically low (H=${o.toFixed(2)} bits)`,detail:"Transaction amounts are highly repetitive. A bot or scripted actor tends to reuse the same values. Organic wallets show entropy \u22652.4 bits across amount magnitudes."})):o<2.2?(g+=8,s.push({sev:"info",label:`Amount entropy below natural range (H=${o.toFixed(2)} bits)`,detail:"Some amount repetition detected. Could indicate automated activity mixed with organic transactions."})):o>4.5?(g+=10,s.push({sev:"info",label:`Amount entropy abnormally high (H=${o.toFixed(2)} bits)`,detail:"Transaction amounts are maximally varied \u2014 more than organic activity typically shows. This can indicate amounts were artificially randomized to evade Benford detection."})):s.push({sev:"ok",label:`Amount entropy normal (H=${o.toFixed(2)} bits)`,detail:"Transaction amount diversity is consistent with organic financial activity."})),l!==null&&(l<1&&r.length<4?(g+=14,s.push({sev:"warn",label:`Counterparty entropy very low (H=${l.toFixed(2)} bits)`,detail:"This wallet transacts with very few unique addresses and with high repetition \u2014 a structural signature of round-trip wash trading rings."})):l<2?(g+=5,s.push({sev:"info",label:`Counterparty entropy low (H=${l.toFixed(2)} bits)`,detail:"Most interactions are concentrated among a small set of counterparties."})):s.push({sev:"ok",label:`Counterparty diversity healthy (H=${l.toFixed(2)} bits)`,detail:"Counterparty distribution reflects diverse interaction patterns."})),u!==null){let b=Math.log2(24),h=u/b;h<.45?(g+=10,s.push({sev:"warn",label:`Time-of-day entropy low (H=${u.toFixed(2)} bits, ${(h*100).toFixed(0)}% of max)`,detail:"Transactions cluster heavily in a few hours of the day. Bots typically run at fixed UTC hours; organic users spread activity across the day."})):s.push({sev:"ok",label:`Time-of-day distribution natural (H=${u.toFixed(2)} bits)`,detail:"Transaction timing is distributed across hours in a pattern consistent with human activity."})}return s.length||s.push({sev:"info",label:"Insufficient data for entropy analysis",detail:`Need \u226530 transactions. Found ${e.length}.`}),g>=18?f="anomalous":g>=8&&(f="elevated"),{signals:s,verdict:f,riskPenalty:g,amountEntropy:o,counterpartyEntropy:l,timeEntropy:u,typeEntropy:m,uniqueCounterparties:r.length,sampleSize:e.length}}function ea(e){let t=e.reduce((n,s)=>n+s,0);return t?-e.reduce((n,s)=>{if(!s)return n;let a=s/t;return n+a*Math.log2(a)},0):0}function gy(e,t){let s=[],a={};for(let{tx:P}of e){let C=P.Account===t?P.Destination:P.Account;C&&C!==t&&(a[C]=(a[C]||0)+1)}let o=Object.values(a).sort((P,C)=>C-P);if(o.length<8)return{signals:[{sev:"info",label:`Insufficient counterparties for Zipf's Law (need \u22658, found ${o.length})`,detail:"Zipf analysis becomes meaningful with a broader counterparty network."}],verdict:"insufficient",zipfExponent:null,riskPenalty:0,freqTable:[],uniqueCounterparties:o.length};let i=o.length,r=0,l=0,c=0,d=0,u=o.map((P,C)=>({rank:C+1,freq:P,lx:Math.log(C+1),ly:Math.log(P)}));for(let{lx:P,ly:C}of u)r+=P,l+=C,c+=P*C,d+=P*P;let p=i*d-r*r,m=p!==0?(i*c-r*l)/p:null,f=m!==null?Math.abs(m):null,g=l/i,b=0,h=0,v=(l-m*r)/i;for(let{lx:P,ly:C}of u)b+=Math.pow(C-g,2),h+=Math.pow(C-(m*P+v),2);let w=b>0?1-h/b:0,k="normal",$=0;f!==null&&(w<.55?($+=12,s.push({sev:"warn",label:`Counterparty distribution doesn't follow Zipf's Law (R\xB2=${w.toFixed(2)})`,detail:`Natural networks follow a power-law rank-frequency relationship. This wallet's counterparty network has poor Zipf fit (R\xB2=${w.toFixed(2)}), suggesting artificial or script-driven interaction structure.`}),k="anomalous"):f<.4?($+=15,s.push({sev:"warn",label:`Zipf exponent too flat (s=${f.toFixed(2)}, expected 0.8\u20131.3)`,detail:"A very flat Zipf exponent means counterparties are used with surprisingly equal frequency. In organic networks, you transact far more often with a few key addresses. Flat distribution is consistent with round-trip wash trading rings."}),k="anomalous"):f>2.2?($+=10,s.push({sev:"warn",label:`Zipf exponent hyper-concentrated (s=${f.toFixed(2)}, expected 0.8\u20131.3)`,detail:"Extreme concentration on one or two counterparties with steep dropoff. While not unusual for simple wallets, combined with other signals this suggests coordinated narrow-ring activity."}),k="elevated"):s.push({sev:"ok",label:`Counterparty network follows Zipf's Law (s=${f.toFixed(2)}, R\xB2=${w.toFixed(2)})`,detail:"The rank-frequency distribution of counterparties follows the expected natural power-law pattern. This is consistent with organic wallet activity."}));let T={};for(let{tx:P}of e){let C=typeof P.Amount=="string"?Math.round(Number(P.Amount)/1e4)*10:null;C&&C>0&&(T[C]=(T[C]||0)+1)}let S=Object.values(T).sort((P,C)=>C-P),N=S.length?S[0]/S.reduce((P,C)=>P+C,0):0;return N>.45&&($+=8,s.push({sev:"warn",label:`Single amount dominates ${(N*100).toFixed(0)}% of transactions`,detail:"One transaction amount value accounts for nearly half of all payments. Round-number dominance is a hallmark of scripted or wash-trading activity."})),s.length||s.push({sev:"info",label:"Zipf analysis: no anomalies detected",detail:"Counterparty distribution consistent with natural activity."}),{signals:s,verdict:k,riskPenalty:$,zipfExponent:f,rSquared:w,freqTable:o.slice(0,12),uniqueCounterparties:o.length}}function by(e){if(e.length<20)return{signals:[{sev:"info",label:`Insufficient transactions for time series analysis (need \u226520, found ${e.length})`,detail:"Time series analysis requires a longer transaction history."}],verdict:"insufficient",riskPenalty:0,intervalCV:null,autocorrelation:null,burstScore:null,periodicityScore:null};let s=e.filter(({tx:T})=>T.date!=null).map(({tx:T})=>(T.date+946684800)*1e3).sort((T,S)=>T-S);if(s.length<20)return{signals:[{sev:"info",label:"No timestamp data available",detail:"Time series requires date-stamped transactions."}],verdict:"insufficient",riskPenalty:0,intervalCV:null,autocorrelation:null,burstScore:null,periodicityScore:null};let a=[];for(let T=1;T<s.length;T++){let S=(s[T]-s[T-1])/1e3;S>0&&S<86400*30&&a.push(S)}let o=null;if(a.length>=5){let T=a.reduce((N,P)=>N+P,0)/a.length,S=Math.sqrt(a.reduce((N,P)=>N+Math.pow(P-T,2),0)/a.length);o=T>0?S/T:null}let i={};for(let T of s){let S=new Date(T).toISOString().slice(0,10);i[S]=(i[S]||0)+1}let r=Object.values(i),l=0;if(r.length>=4){let T=r.reduce((P,C)=>P+C,0)/r.length,S=Math.sqrt(r.reduce((P,C)=>P+Math.pow(C-T,2),0)/r.length),N=Math.max(...r);l=S>0?(N-T)/S:0}let c=null;if(r.length>=6){let T=r.reduce((P,C)=>P+C,0)/r.length,S=r.map(P=>P-T),N=S.reduce((P,C)=>P+C*C,0);N>0&&(c=S.slice(0,-1).reduce((C,R,O)=>C+R*S[O+1],0)/N)}let d=new Array(7).fill(0);for(let T of s)d[new Date(T).getUTCDay()]++;let u=ea(d),p=Math.log2(7),m=0;if(a.length>=10){let T=[...a].sort((P,C)=>P-C),S=T[Math.floor(T.length/2)];m=a.filter(P=>Math.abs(P-S)/S<.2).length/a.length}let f=Object.entries(i).sort((T,S)=>T[0].localeCompare(S[0])),g=null;if(f.length>=8){let T=Math.floor(f.length/2),S=f.slice(0,T),N=f.slice(T),P=D=>D.reduce((I,[,F])=>I+F,0)/D.length,C=P(S),R=P(N),O=C>0&&R>0?Math.max(C,R)/Math.min(C,R):null;O!=null&&O>=3&&(g={transitionDate:N[0][0],beforeRate:C,afterRate:R,ratio:O,direction:R>C?"increase":"decrease"})}let b=0;o!==null&&(b+=Math.max(0,(.6-o)/.6)*60),b+=m*40,b=Math.min(100,Math.round(b));let h=[],v="normal",w=0;if(b>=60?(h.push({sev:"info",label:`Automation Probability: ${b}% (interval CV=${o!=null?o.toFixed(2):"\u2014"}, periodicity=${(m*100).toFixed(0)}%)`,detail:"Transaction timing is consistent with scripted/automated execution. This describes HOW the account operates, not whether it's risky \u2014 automation alone is common and legitimate (market makers, subscription payments, scheduled treasury operations)."}),w+=6):b>=30?h.push({sev:"ok",label:`Automation Probability: ${b}%`,detail:"Some timing regularity, within a range common to both scheduled tools and habitual human usage."}):h.push({sev:"ok",label:`Automation Probability: ${b}%`,detail:"Transaction timing shows natural, human-like variance."}),g&&(w+=4,h.push({sev:"info",label:`Regime Change detected around ${g.transitionDate}`,detail:`Daily transaction rate ${g.direction}d roughly ${g.ratio.toFixed(1)}x (${g.beforeRate.toFixed(1)} \u2192 ${g.afterRate.toFixed(1)} tx/day). A simple split-half comparison, not a formal changepoint test \u2014 treat the transition date as approximate.`})),l>3.5){let T=f.length?f.reduce((S,N)=>N[1]>S[1]?N:S)[0]:null;h.push({sev:"info",label:`Burst Event: peak day z-score ${l.toFixed(1)}${T?` (${T})`:""}`,detail:"One day had extreme transaction volume relative to this account's own baseline. Consistent with a coordinated event, an account-recovery sweep, or simply a busy day \u2014 timing and other signals (Fund Flow, Fee Spikes) provide the context this alone can't."})}c!==null&&c>.6&&(w+=4,h.push({sev:"info",label:`Volume Autocorrelation: HIGH (\u03C1=${c.toFixed(2)})`,detail:"Day-to-day transaction volume is strongly self-correlated \u2014 consistent with a routine that maintains a steady pace, not inherently risky on its own."}));let k=u/p;k<.7&&s.length>30&&h.push({sev:"info",label:`Unusual Relative to Account Baseline: day-of-week activity concentrated (${(k*100).toFixed(0)}% of max entropy)`,detail:"Transactions cluster on specific days of the week relative to this account's own history. Both maximally-flat (every day) and business-hours-only patterns can produce this \u2014 direction matters more than the raw number."}),h.length<=1&&b<30&&h.push({sev:"ok",label:"No temporal anomalies detected",detail:"Transaction timing patterns are consistent with organic human activity."}),w>=10&&(v="elevated");let $=s.length>=2?Math.round((s[s.length-1]-s[0])/864e5):null;return{signals:h,verdict:v,riskPenalty:w,intervalCV:o,autocorrelation:c,burstScore:l,periodicityScore:m,automationProbability:b,regimeChange:g,dowEntropy:u,dowBins:d,dailyVolume:Object.entries(i).slice(-30),activeSpanDays:$,totalTimestamped:s.length}}function vy(e,t){let s=[];if(e.length<20)return{signals:[{sev:"info",label:`Insufficient data for offer/flow coupling analysis (need \u226520, found ${e.length})`,detail:"Testing for lead-lag correlation requires enough temporal observations."}],verdict:"insufficient",riskPenalty:0,offerCancelCausality:null,inflowOutflowCausality:null};let o=12*3600*1e3,i=I=>I.date?Math.floor((I.date+946684800)*1e3/o):null,r={},l=I=>{r[I]||(r[I]={offerCreate:0,offerCancel:0,inflow:0,outflow:0,nftList:0,nftAccept:0})};for(let{tx:I,meta:F}of e){let H=i(I);if(H===null)continue;l(H);let E=r[H],j=I.TransactionType;j==="OfferCreate"?E.offerCreate++:j==="OfferCancel"&&E.offerCancel++,j==="NFTokenCreateOffer"?E.nftList++:j==="NFTokenAcceptOffer"&&E.nftAccept++;let se=(F==null?void 0:F.delivered_amount)||I.Amount,re=typeof se=="string"?Number(se)/1e6:0;re>0&&(I.Destination===t?E.inflow+=re:I.Account===t&&(E.outflow+=re))}let c=Object.keys(r).map(Number).sort((I,F)=>I-F);if(c.length<6)return{signals:[{sev:"info",label:"Insufficient temporal windows for coupling analysis",detail:"Need activity spread across multiple time windows."}],verdict:"insufficient",riskPenalty:0,offerCancelCausality:null,inflowOutflowCausality:null};let d=I=>c.map(F=>r[F][I]||0),u=(I,F,H=4)=>{let E=I.length,j=I.reduce((de,le)=>de+le,0)/E,se=F.reduce((de,le)=>de+le,0)/E,re=I.map(de=>de-j),pe=F.map(de=>de-se),ae=Math.sqrt(re.reduce((de,le)=>de+le*le,0)/E),te=Math.sqrt(pe.reduce((de,le)=>de+le*le,0)/E);return!ae||!te?Array(H+1).fill(0):Array.from({length:H+1},(de,le)=>{let Pe=0,B=0;for(let U=0;U+le<E;U++)Pe+=re[U]*pe[U+le],B++;return B>0?Pe/(B*ae*te):0})},p="normal",m=0,f=d("offerCreate"),g=d("offerCancel"),b=u(f,g),h=b.indexOf(Math.max(...b)),v=Math.max(...b),w={ccf:b,maxCorr:v,maxLag:h};v>.55&&h<=2?(m+=18,p="strong-coupling",s.push(xe({module:"Offer Coupling",category:"market-integrity",sev:"warn",confidence:.4,headline:`Offer Creation/Cancellation Coupling: HIGH (\u03C1=${v.toFixed(2)}, lag=${h} window${h===1?"":"s"})`,detail:`Offer creation and cancellation are strongly correlated ${h} window(s) apart (${h*12}h).`,observed:[`Cross-correlation \u03C1=${v.toFixed(2)} at a ${h}-window lag`,"Correlation, not a causality test \u2014 no autoregressive model or significance test was run"],alternativeExplanations:["Active order management/repricing that naturally pairs creates with cancels","A market maker's normal quote-refresh cycle"],classification:"Statistical coupling observed between offer creation and cancellation timing. This is the kind of pattern wash trading can produce, but correlation at a lag is not proof of it \u2014 see Wash Execution and Spoofing for behavior-level evidence."}))):v>.35?(m+=6,s.push(xe({module:"Offer Coupling",category:"market-integrity",sev:"info",confidence:.25,headline:`Offer Creation/Cancellation Coupling: MODERATE (\u03C1=${v.toFixed(2)}, lag=${h})`,detail:"A mild temporal link between creating and cancelling offers."}))):s.push({sev:"ok",label:"Offer Creation/Cancellation Coupling: LOW",detail:"Offer creation and cancellation timing appear independent."});let k=d("inflow"),$=d("outflow"),T=u(k,$),S=T.indexOf(Math.max(...T)),N=Math.max(...T),P={ccf:T,maxCorr:N,maxLag:S};N>.65&&S===0?(m+=12,s.push(xe({module:"Offer Coupling",category:"market-integrity",sev:"warn",confidence:.4,headline:`Inflow/Outflow Contemporaneous Correlation: HIGH (\u03C1=${N.toFixed(2)})`,detail:"Funds entering and leaving the wallet in the same 12h window are strongly correlated.",observed:[`Zero-lag correlation \u03C1=${N.toFixed(2)} \u2014 same-window co-movement, not a lead-lag relationship`,"A lag-0 result cannot show which direction (if either) leads the other"],alternativeExplanations:["Pass-through/consolidation behavior (an intermediary account by design)","Routine deposit-then-forward operational pattern"],classification:"Same-window co-movement between inflow and outflow, not a demonstrated lead-lag pattern. Consistent with pass-through/round-trip activity, but zero lag means the data alone cannot establish which value moved first."}))):N>.55&&S<=1?(m+=8,s.push(xe({module:"Offer Coupling",category:"market-integrity",sev:"info",confidence:.3,headline:`Inflow/Outflow Coupling: MODERATE (\u03C1=${N.toFixed(2)}, lag=${S})`,detail:"Incoming funds are correlated with outgoing funds at a short lag."}))):s.push({sev:"ok",label:"Inflow/Outflow Coupling: LOW",detail:"Inflow and outflow timing are not predictably linked."});let C=d("nftList"),R=d("nftAccept"),O=C.reduce((I,F)=>I+F,0),D=R.reduce((I,F)=>I+F,0);if(O>3&&D>3){let I=u(C,R),F=Math.max(...I),H=I.indexOf(F);F>.6&&H<=1&&(m+=8,s.push(xe({module:"Offer Coupling",category:"market-integrity",sev:"warn",confidence:.3,headline:`NFT Listing/Acceptance Coupling: HIGH (\u03C1=${F.toFixed(2)}, lag=${H})`,detail:"NFT sell-offer creation is closely correlated with acceptance timing.",alternativeExplanations:["A pre-arranged legitimate sale between known parties"],classification:"Timing coupling only \u2014 combined with the NFT trap detection module's own evidence, this can support (but does not by itself prove) a coordinated-acceptance pattern."})))}return s.some(I=>I.sev==="warn"||I.sev==="critical")||s.length||s.push({sev:"ok",label:"No coupling anomalies detected",detail:"Temporal relationships between transaction types show no notable lead-lag or contemporaneous correlation."}),m>=18?p="strong-coupling":m>=8&&(p="elevated"),{signals:s,verdict:p,riskPenalty:m,offerCancelCausality:w,inflowOutflowCausality:P,windowCount:c.length}}function yy(e){if(!e)return"";try{let t="";for(let n=0;n<e.length;n+=2){let s=parseInt(e.slice(n,n+2),16);s>=32&&s<127&&(t+=String.fromCharCode(s))}return t.length>4?t.toLowerCase().trim():""}catch{return""}}function wy(e){let t=Array.from({length:e},(a,o)=>o),n=a=>t[a]===a?a:t[a]=n(t[a]);return{find:n,union:(a,o)=>{let i=n(a),r=n(o);i!==r&&(t[i]=r)}}}function xy(e){let t=e.length,{find:n,union:s}=wy(t);for(let o=0;o<t;o++)for(let i=o+1;i<t;i++){let r=e[o],l=e[i];if(r.memos.size&&[...r.memos].some(p=>l.memos.has(p))){s(o,i);continue}let d=0;for(let p of r.timestamps)for(let m of l.timestamps)Math.abs(p-m)<=30&&d++;let u=Math.min(r.timestamps.length,l.timestamps.length);d>=3&&d>=u*.5&&s(o,i)}let a=new Map;for(let o=0;o<t;o++){let i=n(o);a.has(i)||a.set(i,[]),a.get(i).push(e[o])}return[...a.values()]}function ky(e){let t=e.reduce((l,c)=>l+c,0);if(t<=0||!e.length)return null;let n=e.map(l=>l/t).sort((l,c)=>c-l),s=n.reduce((l,c)=>l+c*c,0)*1e4,a=[...e].sort((l,c)=>l-c),o=a.length,i=0;a.forEach((l,c)=>{i+=(c+1)*l});let r=o>1&&t>0?Math.max(0,2*i/(o*t)-(o+1)/o):0;return{hhi:s,gini:r,top1Share:n[0]||0,top5Share:n.slice(0,5).reduce((l,c)=>l+c,0),effectiveParticipants:s>0?1e4/s:o}}var _u=200,Du=50;function $y(e,t){let n=new Map;for(let{tx:o}of e){let i=[o.TakerGets,o.Amount],r=(o.Memos||[]).map(l=>{var c;return yy(((c=l.Memo)==null?void 0:c.MemoData)||"")}).filter(Boolean);for(let l of i){if(!l||typeof l!="object")continue;let c=l.currency,d=Number(l.value||0),u=o.Account;if(!c||!u||d<=0||!Number.isFinite(d))continue;n.has(c)||n.set(c,{senderMap:new Map,vol:0,trades:0});let p=n.get(c);p.vol+=d,p.trades++,p.senderMap.has(u)||p.senderMap.set(u,{sender:u,vol:0,memos:new Set,timestamps:[]});let m=p.senderMap.get(u);m.vol+=d,m.timestamps.push(tn(o));for(let f of r)m.memos.add(f)}}let s=[],a=[];for(let[o,i]of n.entries()){if(i.trades<8)continue;let r=[...i.senderMap.values()],l=r.length,c=l>_u,d=c?r.map(f=>[f]):xy(r),u=d.map(f=>f.reduce((g,b)=>g+b.vol,0)),p=ky(u);if(!p)continue;let m=l-d.length;if(a.push({currency:o,rawActorCount:l,estimatedActorClusters:d.length,vol:i.vol,trades:i.trades,...p}),p.hhi>1500){let f=i.trades<Du,g=p.hhi>2500?"critical":"warn",b=f?g==="critical"?"warn":"info":g;s.push(xe({module:"Volume Concentration",category:"market-integrity",sev:b,confidence:c?.3:m>0?.45:.3,headline:`${o}: ~${d.length} estimated economic actor(s) (${l} raw addresses), HHI ${Math.round(p.hhi)}`,detail:`${i.trades} trades totalling ${_(i.vol,2)} ${o}.`,observed:[`Raw distinct addresses: ${l}`,c?`Address count exceeded the clustering cap (${_u}) for this pass \u2014 shown as raw addresses, not clustered`:m>0?`${m} address(es) merged into fewer likely-same-controller clusters via shared memo text or synchronized timing`:"No clustering signal found \u2014 each address treated as a separate actor",`HHI: ${Math.round(p.hhi)} (${p.hhi>2500?"highly concentrated":"moderately concentrated"} by standard antitrust bands: <1500 unconcentrated, 1500-2500 moderate, >2500 high)`,`Gini coefficient: ${p.gini.toFixed(2)}`,`Top-1 actor share: ${(p.top1Share*100).toFixed(0)}% \xB7 Top-5: ${(p.top5Share*100).toFixed(0)}%`,`Effective participant count (10000/HHI): ${p.effectiveParticipants.toFixed(1)}`,f?`Severity capped: only ${i.trades} trades observed (below the ${Du}-trade bar for trusting an extreme severity label) \u2014 a tiny illiquid market can mathematically produce the same HHI as a well-sampled, genuinely concentrated one`:null].filter(Boolean),alternativeExplanations:m>0?["One legitimate market participant operating multiple wallets for ordinary reasons (custody segregation, accounting)"]:["A genuinely thin, low-participation market rather than coordinated activity"],classification:f?`Concentration is mathematically ${p.hhi>2500?"EXTREME":"moderate-to-high"} by HHI, but the sample (${i.trades} trades) is too small to distinguish coordinated activity from a simply illiquid, thinly-traded market \u2014 manipulation evidence is INSUFFICIENT at this sample size, not confirmed.`:"Clustering here is best-effort \u2014 shared memo text or tightly synchronized timing only. It cannot detect a shared funding source or off-chain relationships between addresses, so the true number of distinct economic actors may be lower than shown, not higher."}))}}return a.length?s.length||s.push({sev:"ok",label:"Volume concentration normal",detail:`${a.length} token(s) analysed \u2014 all show broad, unconcentrated participation (HHI < 1500).`}):s.push({sev:"info",label:"No IOU/token volume data",detail:"No token-denominated transactions found in history (XRP-only activity)."}),{signals:s,concentrations:a}}function Sy(e,t,n,s){let a=[],o=!!(n&_e.lsfDefaultRipple)||t.some(h=>h.account===e.Account),i=t.filter(h=>Number(h.balance)<0),r=i.reduce((h,v)=>h+Math.abs(Number(v.balance)),0);i.length>0&&a.push({sev:"info",label:`Token issuer: ${i.length} outstanding currency lines`,detail:`Total outstanding: ${_(r,2)} across ${i.length} holder(s).`});let l=t.filter(h=>h.freeze),c=t.filter(h=>h.freeze_peer);l.length&&a.push({sev:"warn",label:`${l.length} trustline(s) frozen by this account`,detail:"This account has frozen specific trustlines."}),c.length&&a.push({sev:"critical",label:`${c.length} of your trustline(s) frozen by issuer`,detail:`Frozen currencies: ${c.map(h=>h.currency).join(", ")}. You cannot transfer these tokens.`}),n&_e.lsfGlobalFreeze&&a.push({sev:"critical",label:"Global Freeze \u2014 all token transfers suspended",detail:"No holders can transfer tokens issued by this account."}),n&_e.lsfNoFreeze&&a.push({sev:"ok",label:"NoFreeze flag set \u2014 issuer cannot freeze balances",detail:"Token holders are protected against future freeze actions."});let d={requireAuth:2,noFreeze:6,globalFreeze:7,defaultRipple:8,depositAuth:9},u=s.filter(({tx:h})=>h.TransactionType==="AccountSet"&&h.Account===e.Account&&(h.SetFlag!=null||h.ClearFlag!=null)).map(({tx:h})=>({date:h.date,hash:h.hash,setFlag:h.SetFlag??null,clearFlag:h.ClearFlag??null})).sort((h,v)=>(h.date??0)-(v.date??0)),p=h=>u.filter(v=>v.setFlag===h||v.clearFlag===h).length,m=p(d.globalFreeze),f=p(d.requireAuth);if(m>0){let h=u.filter(v=>v.setFlag===d.globalFreeze||v.clearFlag===d.globalFreeze).slice(-1)[0];a.push(xe({module:"Token Issuer",category:"issuer",sev:m>1?"warn":"info",confidence:.5,headline:`Global Freeze toggled ${m} time(s) in fetched history`,detail:`Most recent change: ${h.setFlag!=null?"frozen":"unfrozen"}.`,observed:[`${m} AccountSet transaction(s) setting or clearing Global Freeze`],alternativeExplanations:["A brief, disclosed freeze for a migration, exploit response, or contract upgrade"],classification:m>1?"Repeated freeze/unfreeze cycles show the issuer actively exercises this control, not just holds it theoretically \u2014 worth understanding why, from the project's own communications.":"A single freeze event in this account's history \u2014 check whether it was disclosed and time-bound."}))}f>0&&a.push({sev:"info",label:`Require Auth toggled ${f} time(s) in fetched history`,detail:"The issuer has changed whether new trustlines require its approval at least once."});let g=Number(e.Balance||0)/1e6,b=10+Number(e.OwnerCount||0)*2;return i.length>0&&g<b+1&&a.push({sev:"warn",label:"Issuer balance near reserve \u2014 possible black hole",detail:"Issuer with outstanding tokens has almost no XRP above reserve. Tokens may be stranded."}),a.length===0&&a.push({sev:"ok",label:"No token issuer flags",detail:"This account does not appear to be a token issuer."}),{signals:a,isIssuer:o,obligationCount:i.length,issuerFlagHistory:u}}function Ty(e,t,n,s=new Map,a=null){var f,g,b;let o=[],i=[],r=e.filter(h=>h.currency&&Number(h.balance)!==0&&Hu(h.currency)),l=t.filter(({tx:h})=>h.TransactionType==="AMMDeposit"),c=t.filter(({tx:h})=>h.TransactionType==="AMMWithdraw"),d=t.filter(({tx:h})=>h.TransactionType==="AMMCreate"),u=t.filter(({tx:h})=>h.TransactionType==="AMMVote"),p=t.filter(({tx:h})=>h.TransactionType==="AMMBid");if(r.forEach(h=>{let v=Number(h.balance),w=Number(h.limit);i.push({currency:h.currency,issuer:h.account,balance:v,limit:w})}),a)for(let h of i){let v=[...l,...c].filter(({tx:T,meta:S})=>{var N,P;return(P=(N=S==null?void 0:S.AffectedNodes)==null?void 0:N.some)==null?void 0:P.call(N,C=>{var R;return((R=C.CreatedNode||C.ModifiedNode||C.DeletedNode)==null?void 0:R.LedgerEntryType)==="RippleState"&&[C.CreatedNode,C.ModifiedNode,C.DeletedNode].some(O=>{var D,I,F,H;return((I=(D=O==null?void 0:O.FinalFields)==null?void 0:D.Balance)==null?void 0:I.currency)===h.currency||((H=(F=O==null?void 0:O.NewFields)==null?void 0:F.Balance)==null?void 0:H.currency)===h.currency})})}),w=0,k=[],$=[];for(let{tx:T,meta:S}of v){let N=ir(T,S,a),P=N.lpDeltas.find(R=>R.currency===h.currency);if(!P)continue;let C={hash:T.hash,date:T.date,lpTokenDelta:P.delta,xrpDelta:N.xrpDelta,tokenDeltas:N.tokenDeltas};T.TransactionType==="AMMDeposit"?(k.push(C),w+=-N.xrpDelta):($.push(C),w-=-N.xrpDelta)}(k.length||$.length)&&(h.depositEvents=k,h.withdrawEvents=$,h.costBasisXrp=w>0?w:null)}if(i.length){o.push({sev:"info",label:`${i.length} LP token position(s)`,detail:`Active liquidity provider in ${i.length} AMM pool(s).`});for(let h of i){let v=s.get(h.currency);if(v){if(h.tvl=v.amount?Number(v.amount)/1e6:null,h.tvl2=(f=v.amount2)!=null&&f.value?Number(v.amount2.value):null,h.feeRate=v.trading_fee!=null?v.trading_fee/1e3:null,h.lpSupply=(g=v.lp_token)!=null&&g.value?Number(v.lp_token.value):null,h.lpSupply&&h.balance){let w=Math.abs(h.balance)/h.lpSupply*100;h.ownerPct=w,w>50&&o.push({sev:"warn",label:`Dominant AMM position: ${w.toFixed(0)}% of pool`,detail:`This account controls ${w.toFixed(0)}% of the LP token supply for pool ${z(h.currency)}. Withdrawing all at once would severely impact pool liquidity and anyone currently trading in it.`})}h.tvl!=null&&o.push({sev:"info",label:`Pool TVL: ${_(h.tvl,2)} XRP${h.tvl2?` + ${_(h.tvl2,2)} tokens`:""} \xB7 Fee: ${((b=h.feeRate)==null?void 0:b.toFixed(2))??"?"}%`,detail:`Actual pool context from amm_info. Your LP position represents ${h.ownerPct!=null?h.ownerPct.toFixed(1)+"% of the pool.":"an unknown share of the pool."}`})}}}return d.length&&o.push({sev:"info",label:`Created ${d.length} AMM pool(s)`,detail:"This account bootstrapped one or more liquidity pools."}),(l.length||c.length)&&o.push({sev:"info",label:`${l.length} deposit(s) \xB7 ${c.length} withdrawal(s)`,detail:"LP activity history."}),u.length&&o.push({sev:"info",label:`${u.length} AMM fee vote(s)`,detail:"This account has voted on AMM trading fee parameters."}),p.length&&o.push({sev:"info",label:`${p.length} continuous auction bid(s)`,detail:"Bid for the AMM auction slot (reduced fee trading window)."}),i.filter(h=>Math.abs(h.balance)>1e3).length&&o.push({sev:"warn",label:"Large LP positions \u2014 impermanent loss risk",detail:"Significant liquidity positions carry exposure to price divergence between pool assets."}),o.length===0&&o.push({sev:"ok",label:"No AMM positions",detail:"This account is not a liquidity provider."}),{signals:o,positions:i,deposits:l.length,withdrawals:c.length}}function Cy(e){let t=[],s=e.filter(({tx:p})=>p.Fee&&Number(p.Fee)>0);if(s.length<10)return{signals:[],verdict:"insufficient",riskPenalty:0,avgFeeMultiplier:null,spikeCount:0,topFeeHashes:[]};let a=s.map(({tx:p})=>Number(p.Fee)/12),o=a.reduce((p,m)=>p+m,0)/a.length,r=s.filter(({tx:p})=>Number(p.Fee)/12>100).length,l=r/s.length,c=0,d="normal",u=[...s].sort((p,m)=>Number(m.tx.Fee)-Number(p.tx.Fee)).slice(0,5).map(({tx:p})=>({hash:p.hash,mult:(Number(p.Fee)/12).toFixed(0),fee:Number(p.Fee)}));return l>.15&&r>=5?(c=10,d="elevated",t.push({sev:"warn",label:`Fee spike pattern: ${r} txs paid >100x base fee (${(l*100).toFixed(0)}% of history)`,detail:`Average fee multiplier: ${o.toFixed(0)}x. In XRPL, bots often pay elevated fees to guarantee same-ledger execution as a counterparty \u2014 a technique used in coordinated wash trading and sandwich attacks. Organic users rarely pay more than 2\u20135x the base fee. Top hashes: ${u.slice(0,3).map(p=>z(p.hash)).join(", ")}.`,hashes:u.map(p=>p.hash)})):o>20?(c=4,t.push({sev:"info",label:`Elevated average fee (${o.toFixed(0)}x base fee)`,detail:"This wallet consistently pays above-average fees. Could indicate priority execution requirements or automated trading."})):t.push({sev:"ok",label:`Fee levels normal (avg ${o.toFixed(1)}x base fee)`,detail:"Transaction fees are within typical organic ranges."}),{signals:t,verdict:d,riskPenalty:c,avgFeeMultiplier:+o.toFixed(2),spikeCount:r,topFeeHashes:u}}function Py(e,t){let n=[],s=new Map;for(let{tx:d}of e){if(d.TransactionType!=="Payment"||d.Account!==t)continue;let u=d.Destination,p=d.DestinationTag;u&&(s.has(u)||s.set(u,new Set),p!=null&&s.get(u).add(p))}let a=[...s.entries()].filter(([d])=>{let u=Wn(d);return(u==null?void 0:u.type)==="exchange"}),o=e.filter(({tx:d})=>d.TransactionType==="Payment"&&d.Account===t&&d.Destination).length,i=e.filter(({tx:d})=>d.TransactionType==="Payment"&&d.Account===t&&d.Destination&&d.DestinationTag!=null).length,r=o>0?i/o*100:null,l=0,c=[];for(let[d,u]of s.entries()){let p=Wn(d),m=(p==null?void 0:p.name)||z(d),f=u.size,g=e.filter(({tx:h})=>h.Account===t&&h.Destination===d).length,b=!p&&f>=8&&g>=10;c.push({dest:d,name:m,uniqueTags:f,txCount:g,looksCustodial:b,tags:[...u].slice(0,10)}),f===1&&g>=5&&(p==null?void 0:p.type)==="exchange"?n.push({sev:"info",label:`${m}: ${g} payments all using tag ${[...u][0]}`,detail:`Single destination tag used across all ${g} payments to ${m}. This is the normal pattern for one person funding their own exchange account.`}):f>10&&(p==null?void 0:p.type)==="exchange"?(l=Math.max(l,8),n.push({sev:"warn",label:`${m}: ${f} different destination tags used`,detail:`${g} payments to ${m} used ${f} different tags \u2014 each tag typically identifies a different customer account. Funding many exchange sub-accounts can indicate either a service (legitimate) or coordinated deposit layering where funds are spread across many exchange wallets to avoid detection.`})):f===0&&g>=2&&(p==null?void 0:p.type)==="exchange"?n.push({sev:"warn",label:`${m}: ${g} payments with no destination tag`,detail:"Payments to exchange addresses without a destination tag may not be credited. Most exchanges require a tag to identify which customer account receives the funds."}):b&&n.push(xe({module:"Destination Tags",category:"counterparty",sev:"info",confidence:.4,headline:`${z(d)}: unlabeled destination behaves like a custodial service (${f} distinct tags, ${g} payments)`,detail:"Not in the known-entity registry, but its tag-usage pattern matches an exchange/custodial routing scheme.",observed:[`${f} distinct destination tags across ${g} payments`,"Pattern matches per-customer sub-account routing, whoever operates it"],alternativeExplanations:["An exchange or custodial service not yet in this app's known-entity registry","A payment processor or merchant service using tags as invoice/order references"],classification:"Behavioral inference from tag-usage shape only \u2014 not a confirmed entity identification."}))}return r!=null&&o>=10&&n.push({sev:"ok",label:`Destination Tag usage: ${r.toFixed(0)}% of outbound payments (${i}/${o})`,detail:"Overall tag-usage rate across all outbound payments \u2014 context for the per-destination findings above, not a signal on its own."}),n.length===0&&s.size>0?n.push({sev:"ok",label:"Destination tag patterns normal",detail:"Payment routing tags are consistent with regular outbound payments."}):s.size===0&&n.push({sev:"info",label:"No outbound payments to analyse for destination tags",detail:"No outbound Payment transactions found in history."}),{signals:n,riskPenalty:l,tagProfiles:c}}function My(e,t){var c,d;let n=[],s=e.filter(({tx:u})=>u.TransactionType==="Payment"&&u.Account===t&&(Array.isArray(u.Paths)&&u.Paths.length>0||u.SendMax!=null));if(s.length===0)return{signals:[],riskPenalty:0,roundTripCount:0,deepHopCount:0,selfRoutedCount:0,noData:!0};let a=s.length<5?` (small sample: ${s.length} path payments found \u2014 patterns may not be statistically significant)`:"",o=s.filter(({tx:u})=>{let p=typeof u.Amount=="string",m=typeof u.SendMax=="string";return p&&m}),i=s.filter(({tx:u})=>Array.isArray(u.Paths)?u.Paths.some(p=>Array.isArray(p)&&p.length>=3):!1),r=s.filter(({tx:u})=>u.Destination===t),l=0;return o.length>=1&&(l+=12,n.push({sev:"warn",label:`${o.length} XRP\u2192IOU\u2192XRP round-trip path payments`,detail:`Sending XRP and receiving XRP via intermediate token pairs means the payment routes through the DEX and creates trading volume without changing economic position. ${o.length} occurrences suggests this is deliberate. This is the classic cross-currency wash-trading arb pattern on XRPL. Example hash: ${(d=(c=o[0])==null?void 0:c.tx)!=null&&d.hash?z(o[0].tx.hash):"N/A"}.`,hashes:o.slice(0,5).map(({tx:u})=>u.hash).filter(Boolean)})),i.length>=1&&(l+=6,n.push({sev:"info",label:`${i.length} path payments with \u22653 intermediate hops`,detail:"Deep routing chains (3+ hops) can indicate: legitimate arbitrage, liquidity optimization, or deliberate obfuscation of fund origin. Check each transaction for the intermediate issuers in the path."})),r.length>0&&(l+=15,n.push({sev:"critical",label:`${r.length} path payment(s) where sender = destination`,detail:`Money sent to your own address via a multi-hop path creates DEX trading volume with no net change in balance. This is a direct wash-trading technique: the path through the order book generates artificial volume on every intermediate pair. Hashes: ${r.slice(0,3).map(({tx:u})=>z(u.hash||"")).join(", ")}.`,hashes:r.slice(0,5).map(({tx:u})=>u.hash).filter(Boolean)})),n.length===0&&n.push({sev:"ok",label:`${s.length} path payment(s) \u2014 no suspicious routing patterns${a}`,detail:"No circular routing (XRP\u2192IOU\u2192XRP), self-routing, or unusual deep hop chains detected."}),{signals:n,riskPenalty:l,roundTripCount:o.length,deepHopCount:i.length,selfRoutedCount:r.length}}function Ly(e,t){var g;let n=new Map,s=[];for(let{tx:b,meta:h}of e){if(b.TransactionType!=="Payment"||b.Destination!==t)continue;let v=b.Account;if(!v||v===t)continue;let w=0,k=null,$=(h==null?void 0:h.delivered_amount)||b.Amount;typeof $=="string"?w=Number($)/1e6:$!=null&&$.value&&(k={value:Number($.value),currency:jn($.currency),issuer:$.issuer});let T=tn(b);s.push({src:v,amtXrp:w,amtToken:k,ts:T,hash:b.hash||"",destTag:b.DestinationTag}),n.has(v)||n.set(v,{addr:v,totalXrp:0,txCount:0,firstSeen:T,lastSeen:T,entity:Wn(v)||null});let S=n.get(v);S.totalXrp+=w,S.txCount++,S.lastSeen=Math.max(S.lastSeen,T),S.firstSeen=Math.min(S.firstSeen,T)}let a=[...n.values()].sort((b,h)=>h.totalXrp-b.totalXrp||h.txCount-b.txCount).slice(0,10),o=a.reduce((b,h)=>b+h.totalXrp,0),i=a.filter(b=>{var h;return((h=b.entity)==null?void 0:h.type)==="exchange"}),r=1,l={};for(let b of s){if(b.amtXrp<=0)continue;let h=Math.round(b.amtXrp/10)*10;l[h]=(l[h]||0)+1}let c=Object.entries(l).sort((b,h)=>h[1]-b[1])[0],d=c&&c[1]>=5&&c[1]/s.length>.4,u=d?Number(c[0])>=r:null,p=d&&u===!0,m=d&&u===!1,f=[];if(i.length){let b=[...new Set(i.map(h=>h.entity.name))].join(", ");f.push({sev:"info",label:`Funding from ${i.length} known exchange(s): ${b}`,detail:`${_(i.reduce((h,v)=>h+v.totalXrp,0),2)} XRP received from exchange withdrawals \u2014 typical for a personal trading wallet.`})}if(p&&f.push({sev:"warn",label:`Structured inbound pattern: ${c[1]} payments near ~${c[0]} XRP`,detail:`Over 40% of inbound payments cluster around the same amount (~${c[0]} XRP), and that amount is economically meaningful. Structured deposits can indicate layering \u2014 deliberately splitting large amounts into smaller equal transfers to avoid detection.`}),m&&f.push({sev:"info",label:`Dust/spam cluster: ${c[1]} negligible-value payments near ~${c[0]} XRP`,detail:`${c[1]} inbound payments cluster around the same negligible amount (~${c[0]} XRP, below the ${r} XRP materiality threshold) \u2014 economically too small to represent structured/layered funds. Classified as a dust or spam campaign rather than possible layering; see Memo Analysis for any accompanying phishing-style text.`}),n.size===1&&s.length>=5){let b=a[0];f.push({sev:"info",label:`Single funding source: all ${s.length} inbound payments from one address`,detail:`${((g=b.entity)==null?void 0:g.name)||z(b.addr)} is the sole funding source. This is normal for a personal wallet but notable for a wallet claiming broad community usage.`})}return!f.length&&s.length>0&&f.push({sev:"ok",label:`${s.length} inbound payment(s) from ${n.size} source(s)`,detail:`Total received: ${_(o,2)} XRP. No unusual inbound patterns.`}),s.length===0&&f.push({sev:"info",label:"No inbound payments found in analysed history",detail:"Wallet may be funded via DEX activity or in ledgers outside the analysed range."}),{signals:f,topSources:a,totalIn:o,uniqueSources:n.size,timeline:s.slice(-20).reverse(),exchangeSrcs:i,structuredFlag:!!p,dustClusterFlag:!!m,materialityGate:u}}function Ay(e,t){var u,p;let n=[],s=[],a=[/airdrop/i,/claim.*reward/i,/free.*xrp/i,/verify.*wallet/i,/support.*team/i,/urgent/i,/suspended/i,/confirm.*seed/i,/your.*account.*hold/i,/unlock/i];for(let{tx:m}of e)if((u=m.Memos)!=null&&u.length)for(let f of m.Memos){let g=((p=f.Memo)==null?void 0:p.MemoData)||"";if(!g)continue;let b="";try{b=decodeURIComponent(g.replace(/../g,v=>"%"+v))}catch{b=g}if(!b||b===g)try{let v="";for(let w=0;w<g.length;w+=2){let k=parseInt(g.slice(w,w+2),16);k>=32&&k<127&&(v+=String.fromCharCode(k))}v.length>4&&(b=v)}catch{}let h=m.Account===t?m.Destination:m.Account;s.push({tx:m.hash||"",type:m.TransactionType,sender:m.Account,counterparty:h,date:m.date,text:b.slice(0,200),raw:g})}if(s.length===0)return{signals:[],allMemos:[],scamMemos:[],repeatedMemos:[],fingerprints:[]};let o=s.filter(m=>a.some(f=>f.test(m.text))),i=o.filter(m=>m.sender===t),r=o.filter(m=>m.sender!==t);i.length&&n.push(xe({module:"Memo Analysis",category:"security",sev:"critical",headline:`${i.length} outbound memo(s) match known scam patterns`,detail:`This account SENT payments containing phrases like "airdrop", "claim reward", "verify wallet", or "urgent" \u2014 patterns used in social engineering attacks. Examples: ${i.slice(0,2).map(m=>'"'+m.text.slice(0,40)+'"').join(", ")}`,observed:[`${i.length} outbound scam-pattern memo(s)`,`Sent to ${new Set(i.map(m=>m.counterparty)).size} distinct recipient(s)`],classification:"Outbound scam-pattern memos are evidence about this account's own behavior \u2014 sending phishing/spam-style payments to others."})),r.length&&n.push(xe({module:"Memo Analysis",category:"external-exposure",sev:"warn",headline:`${r.length} inbound memo(s) match known scam patterns`,detail:`This account RECEIVED payments containing phrases like "airdrop", "claim reward", "verify wallet", or "urgent" \u2014 this account was targeted, not the source. Examples: ${r.slice(0,2).map(m=>'"'+m.text.slice(0,40)+'"').join(", ")}`,observed:[`${r.length} inbound scam-pattern memo(s)`,`Sent from ${new Set(r.map(m=>m.sender)).size} distinct sender(s)`],evidenceAgainstBenign:[],classification:"This account was the target of a phishing/spam campaign, not its source \u2014 this reflects exposure, not this account's own behavior, and should not inflate its own risk score."}));let l=new Map;for(let m of s){let f=m.text.slice(0,50).trim().toLowerCase();f.length<=3||(l.has(f)||l.set(f,[]),l.get(f).push(m))}let c=[...l.entries()].filter(([,m])=>m.length>=3).map(([m,f])=>{let g=[...new Set(f.map(v=>v.type))],b=new Set(f.map(v=>v.counterparty).filter(Boolean)),h=new Set(f.map(v=>v.sender));return{text:m,count:f.length,types:g,counterpartyCount:b.size,senderCount:h.size,crossAccount:h.size>1,occurrences:f}}).sort((m,f)=>f.count-m.count);for(let m of c.slice(0,5)){let f=Math.min(.9,.3+m.count*.05+(m.crossAccount?.15:0));n.push(xe({module:"Memo Analysis",category:"automation",sev:"info",confidence:f,headline:`Automation Fingerprint Detected: "${m.text.slice(0,40)}" \u2014 ${Math.round(f*100)}% confidence`,detail:`Appears ${m.count} time(s) across ${m.counterpartyCount} counterpart(y/ies) and ${m.types.length} transaction type(s).`,observed:[`${m.count} occurrences`,`Transaction types: ${m.types.join(", ")}`,`Distinct counterparties: ${m.counterpartyCount}`,m.crossAccount?`Sent by ${m.senderCount} different accounts, not just this one \u2014 likely shared tooling/infrastructure rather than something unique to this wallet`:"Only sent by this account in the fetched history"],alternativeExplanations:["Standard software/bot signature (exchange withdrawal tooling, a trading bot's build tag, issuer distribution tooling)","A recurring invoice or reference code used for ordinary bookkeeping"],classification:"Repeated identical memo text is a fingerprint of shared tooling or a scripted process, not inherently suspicious on its own \u2014 useful for identifying infrastructure, bots, or coordinated actors, but needs other evidence to say which."}))}let d=[...new Set(s.filter(m=>/\bv?\d+\.\d+(\.\d+)?\b/i.test(m.text)).map(m=>m.text))];return d.length>=2&&n.push({sev:"info",label:`${d.length} distinct version-like memo tag(s) observed`,detail:`Tags: ${d.slice(0,5).join(", ")}. Consistent with an automated tool's memo tag being bumped across software versions over time.`}),n.length||n.push({sev:"ok",label:`${s.length} memo(s) found \u2014 no suspicious patterns`,detail:"Memo content looks normal."}),{signals:n,allMemos:s,scamMemos:o,repeatedMemos:c.slice(0,5).map(m=>[m.text,m.count]),fingerprints:c}}function Ey(e,t,n){let s=e.filter(u=>u.LedgerEntryType==="Escrow");if(!s.length)return{signals:[],escrows:[],hasThirdParty:!1};let a=[],o=Math.floor(Date.now()/1e3),i=946684800,r=s.map(u=>{let p=u.Account||null,m=u.Destination||null,f=Number(u.Amount||0)/1e6,g=u.FinishAfter?u.FinishAfter+i:null,b=u.CancelAfter?u.CancelAfter+i:null,h=p&&p!==n&&m===n,v=p===n&&m===n,w=g?Math.ceil((g-o)/86400):null;return{creator:p,dest:m,amtXrp:f,finishAfter:g,cancelAfter:b,isThirdParty:h,isSelfEscrow:v,daysToFinish:w,conditional:!!u.Condition}}),l=r.filter(u=>u.isThirdParty),c=r.reduce((u,p)=>u+p.amtXrp,0);l.length&&a.push({sev:"warn",label:`${l.length} escrow(s) created by external account(s) \u2014 funds locked to this address`,detail:`${_(l.reduce((u,p)=>u+p.amtXrp,0),2)} XRP in escrows that an outside party controls. The creator sets the conditions. Escrows created by attackers just before a drain attempt have been observed in some compromise patterns \u2014 verify who created these.`});let d=r.filter(u=>u.daysToFinish!=null&&u.daysToFinish>=0&&u.daysToFinish<=7);return d.length&&a.push({sev:"info",label:`${d.length} escrow(s) mature within 7 days`,detail:`${_(d.reduce((u,p)=>u+p.amtXrp,0),2)} XRP will become claimable soon. If these are third-party escrows, the creator can claim funds once the condition is met.`}),a.length||a.push({sev:"ok",label:`${s.length} self-escrow(s) \u2014 ${_(c,2)} XRP locked`,detail:"All escrows appear to be self-controlled time-locks. No third-party escrow risk."}),{signals:a,escrows:r,hasThirdParty:l.length>0,totalLocked:c}}function Ny(e){let t=e.filter(l=>l.LedgerEntryType==="Check");if(!t.length)return{signals:[],checks:[]};let n=[],s=946684800,a=Math.floor(Date.now()/1e3),o=t.map(l=>{let c=typeof l.SendMax=="string"?Number(l.SendMax)/1e6:null,d=typeof l.SendMax=="object"?l.SendMax:null,u=l.Expiration?l.Expiration+s:null,p=(l.ledger_index,null),m=u&&u<a;return{sender:l.Account,dest:l.Destination,amtXrp:c,amtToken:d,expiry:u,expired:m,id:l.index||""}}),i=o.filter(l=>l.amtXrp&&l.amtXrp>100),r=o.filter(l=>l.expired);return i.length&&n.push({sev:"info",label:`${i.length} large uncashed check(s) \u2014 ${_(i.reduce((l,c)=>l+(c.amtXrp||0),0),2)} XRP pending`,detail:"Open checks can be cashed by the recipient at any time before expiry. Large uncashed checks represent a future outflow commitment."}),r.length&&n.push({sev:"info",label:`${r.length} expired check(s) \u2014 should be cancelled to reclaim reserve`,detail:"Expired checks still occupy owner reserve slots (2 XRP each). Cancelling them returns the reserved XRP."}),n.length||n.push({sev:"ok",label:`${t.length} check(s) found \u2014 no unusual patterns`,detail:"Check amounts are within normal range."}),{signals:n,checks:o}}function Ry(e,t){var m,f,g;if(!e||!((m=e.offers)!=null&&m.length))return{signals:[],hasData:!1};let{pair:n,offers:s}=e,a=[],o=new Map;for(let b of s){let h=b.Account,v=typeof b.TakerGets=="string"?Number(b.TakerGets)/1e6:Number(((f=b.TakerGets)==null?void 0:f.value)||0);o.set(h,(o.get(h)||0)+v)}let i=[...o.values()].reduce((b,h)=>b+h,0),r=o.get(t)||0,l=i>0?r/i:0,d=[...s].sort((b,h)=>{var k,$;let v=typeof b.TakerGets=="string"?Number(b.TakerGets)/1e6:Number(((k=b.TakerGets)==null?void 0:k.value)||0);return(typeof h.TakerGets=="string"?Number(h.TakerGets)/1e6:Number((($=h.TakerGets)==null?void 0:$.value)||0))-v})[0],u=typeof(d==null?void 0:d.TakerGets)=="string"?Number(d.TakerGets)/1e6:Number(((g=d==null?void 0:d.TakerGets)==null?void 0:g.value)||0),p=i>0?u/i:0;return p>.4&&(d==null?void 0:d.Account)===t?a.push({sev:"critical",label:`Active wall order: this wallet controls ${(p*100).toFixed(0)}% of current book depth`,detail:`A single order from this address represents ${(p*100).toFixed(0)}% of the visible order book depth on pair ${n}. Large orders placed to make a market look deeper than it is \u2014 without intent to fill \u2014 is spoofing. This order is live right now.`}):p>.4&&a.push({sev:"warn",label:`Wall order present: ${(p*100).toFixed(0)}% of book depth in one order`,detail:`A single address controls ${(p*100).toFixed(0)}% of the current order book for pair ${n}. Wall orders dominate book depth and can be removed instantly \u2014 they create false liquidity signals.`}),l>.25&&a.push({sev:"info",label:`This wallet controls ${(l*100).toFixed(0)}% of current order book depth`,detail:`${_(r,2)} of ${_(i,2)} total book volume on pair ${n}.`}),a.length||a.push({sev:"ok",label:`Live order book looks normal (${s.length} orders, pair: ${n.split("\u2194").map(b=>b.split("+")[0]).join("\u2194")})`,detail:"No wall orders or unusual depth concentration detected in the current order book."}),{signals:a,hasData:!0,pair:n,offerCount:s.length,ourShare:l,wallShare:p}}function _y(e,t,n,s,a,o,i,r,l,c,d,u,p,m){var g,b;return[{label:"Security",pts:Math.round((100-t.score)*.4),max:40,color:"#ff5555",icon:"\u{1F510}"},{label:"Drain Risk",pts:{low:0,medium:10,high:25,critical:35}[n.riskLevel]||0,max:35,color:"#ff5555",icon:"\u26A0\uFE0F"},{label:"Wash Trading",pts:Math.min(15,Math.round((a.score||0)*.15)),max:15,color:"#ffb86c",icon:"\u{1F4CA}"},{label:"NFT Risk",pts:Math.min(15,s.flags.filter(h=>h.sev==="critical").length*8+s.flags.filter(h=>h.sev==="warn").length*3),max:15,color:"#bd93f9",icon:"\u{1F3A8}"},{label:"Benford's",pts:Math.round(Ju(o)),max:10,color:"#f1fa8c",icon:"\u{1F4D0}"},{label:"Forensic Suite",pts:Math.min(20,Math.min(8,Math.round(((r==null?void 0:r.riskPenalty)||0)*.35))+Math.min(8,Math.round(((l==null?void 0:l.riskPenalty)||0)*.4))+Math.min(8,Math.round(((c==null?void 0:c.riskPenalty)||0)*.35))+Math.min(8,Math.round(((d==null?void 0:d.riskPenalty)||0)*.35))),max:20,color:"#00d4ff",icon:"\u{1F9EC}"},{label:"Vol Conc",pts:Math.min(10,(((g=i==null?void 0:i.signals)==null?void 0:g.filter(h=>h.sev==="critical").length)||0)*6+(((b=i==null?void 0:i.signals)==null?void 0:b.filter(h=>h.sev==="warn").length)||0)*3),max:10,color:"#ffb86c",icon:"\u{1FAE7}"},{label:"Fee Spikes",pts:Math.min(5,(u==null?void 0:u.riskPenalty)||0),max:5,color:"#ffb86c",icon:"\u{1F4B8}"}].filter(h=>h.pts>0)}var oo=["security","market-integrity","counterparty","issuer","liquidity","automation","external-exposure"],ta={security:"Security Risk","market-integrity":"Market Integrity Risk",counterparty:"Counterparty Risk",issuer:"Issuer Risk",liquidity:"Liquidity Risk",automation:"Automation Probability","external-exposure":"External Exposure"},io={Security:"security","Drain Risk":"security",NFT:"security","Wash Trading":"market-integrity","Benford's Law":"market-integrity","Offer/Flow Coupling":"market-integrity","Volume Concentration":"market-integrity","Shannon's Entropy":"market-integrity","Zipf's Law":"market-integrity","Time Series":"market-integrity","Live Order Book":"market-integrity","Token Issuer":"issuer","Issuer Connections":"issuer",AMM:"liquidity","Fund Flow":"counterparty","Destination Tags":"counterparty","Path Payments":"counterparty","Inbound Flow":"counterparty","Escrow Depth":"counterparty","Fee Spikes":"automation","Memo Analysis":"automation"},tr={critical:40,warn:15,info:3,ok:0};function Dy(e){let t={};for(let n of oo)t[n]={score:0,findings:[]};for(let n of e){if(n.sev==="ok"||!n.sev)continue;let s=n.category||io[n.module]||"security";if(!t[s])continue;let a=n.confidence??.5;t[s].score+=(tr[n.sev]??0)*a,t[s].findings.push(n)}for(let n of oo)t[n].score=Math.round(Math.min(100,t[n].score));return t}function Iy(e,t,n,s,a,o,i,r,l,c,d=null){let u=0;u+=Math.round((100-e.score)*.4),u+={low:0,medium:10,high:25,critical:35}[t.riskLevel]||0;let m=n.flags.filter(g=>g.sev==="critical").length,f=n.flags.filter(g=>g.sev==="warn").length;if(u+=Math.min(15,m*8+f*3),u+=Math.min(15,Math.round(s.score*.15)),u+=Ju(a),o!=null&&o.signals){let g=o.signals.filter(h=>h.sev==="critical").length,b=o.signals.filter(h=>h.sev==="warn").length;u+=Math.min(10,g*6+b*3)}return i!=null&&i.riskPenalty&&(u+=Math.min(8,Math.round(i.riskPenalty*.35))),r!=null&&r.riskPenalty&&(u+=Math.min(8,Math.round(r.riskPenalty*.4))),l!=null&&l.riskPenalty&&(u+=Math.min(8,Math.round(l.riskPenalty*.35))),c!=null&&c.riskPenalty&&(u+=Math.min(8,Math.round(c.riskPenalty*.35))),d!=null&&d.riskPenalty&&(u+=Math.min(5,d.riskPenalty)),Math.round(Math.min(100,u))}function Fy(e){var g;let t=document.getElementById("inspect-benfords-body");if(!t)return;let n=e.signals.map(Tt).join(""),s=(g=e.digitBreakdown)!=null&&g.length?`
    <div class="benford-grid">
      ...
      ${e.digitBreakdown.map(b=>{let h=parseFloat(b.obs),v=parseFloat(b.exp),w=h-v,k=Math.abs(w)>5?"#ff5555":Math.abs(w)>2.5?"#ffb86c":"#50fa7b",$=`<div style="height:6px;border-radius:3px;background:rgba(255,255,255,.08);overflow:hidden">
          <div style="height:100%;width:${Math.min(100,h*3.3).toFixed(0)}%;background:${k};border-radius:3px"></div>
                ...
                <div class="mono" style="color:${k}">${b.obs}%</div>
  ...
  `;t.innerHTML=n+a+s+f}function Oy(e){var a;let t=document.getElementById("inspect-volconc-body");if(!t)return;let n=e.signals.map(Tt).join(""),s=(a=e.concentrations)!=null&&a.length?`
    ...
    </table>`:"";t.innerHTML=n+s}function lo(e,t,n){let s=document.getElementById(e);if(!s)return;let a=t.signals.map(Tt).join("");s.innerHTML=a+(n||"")}function By(e){let t=[["Sample size",e.sampleSize],["Amount entropy",e.amountEntropy!=null?e.amountEntropy.toFixed(2)+" bits":"\u2014",e.amountEntropy!=null&&e.amountEntropy<2?"risk-text-high":""],["Counterparty entropy",e.counterpartyEntropy!=null?e.counterpartyEntropy.toFixed(2)+" bits":"\u2014"],["Time-of-day entropy",e.timeEntropy!=null?e.timeEntropy.toFixed(2)+" bits":"\u2014"],["Unique counterparties",e.uniqueCounterparties],["Verdict",e.verdict,e.verdict==="anomalous"?"risk-text-high":e.verdict==="elevated"?"risk-text-med":""]];lo("inspect-entropy-body",e,'<div class="wash-stat-row" style="margin-top:10px"><span>Metric</span><span class="mono" style="opacity:.45">Value</span></div>'+t.map(([n,s,a])=>`<div class="wash-stat-row"><span>${n}</span><span class="mono ${a||""}">${s}</span></div>`).join(""))}function Xy(e){var s;let t=[["Unique counterparties",e.uniqueCounterparties],["Zipf exponent (s)",e.zipfExponent!=null?e.zipfExponent.toFixed(3):"\u2014",e.zipfExponent!=null&&(e.zipfExponent<.4||e.zipfExponent>2.2)?"risk-text-high":""],["Fit quality (R\xB2)",e.rSquared!=null?e.rSquared.toFixed(3):"\u2014",e.rSquared!=null&&e.rSquared<.55?"risk-text-high":""],["Natural range","s \u2248 0.8\u20131.3, R\xB2 > 0.55"],["Verdict",e.verdict,e.verdict==="anomalous"?"risk-text-high":e.verdict==="elevated"?"risk-text-med":""]],n=((s=e.freqTable)==null?void 0:s.slice(0,10).map((a,o)=>{let i=e.freqTable[0]||1,r=(a/i*100).toFixed(0),l=e.freqTable[0]?(e.freqTable[0]/Math.pow(o+1,e.zipfExponent||1)).toFixed(1):0;return`<div class="wash-stat-row">
    ...
    </div>`}).join(""))||"";lo("inspect-zipf-body",e,t.map(([a,o,i])=>`<div class="wash-stat-row" style="margin-top:${a==="Unique counterparties"?10:0}px"><span>${a}</span><span class="mono ${i||""}">${o}</span></div>`).join("")+(n?`<div style="margin-top:14px;opacity:.75;font-size:.72rem;letter-spacing:.08em;color:rgba(255,255,255,.45);margin-bottom:6px">COUNTERPARTY RANK\u2013FREQUENCY</div>${n}`:""))}function Hy(e){let t=[["Transactions timed",e.totalTimestamped||"\u2014"],["Active span",e.activeSpanDays!=null?e.activeSpanDays+" days":"\u2014"],["Interval CV",e.intervalCV!=null?e.intervalCV.toFixed(3):"\u2014",e.intervalCV!=null&&e.intervalCV<.5?"risk-text-high":""],["Periodicity score",e.periodicityScore!=null?(e.periodicityScore*100).toFixed(0)+"%":"\u2014",e.periodicityScore>.55?"risk-text-high":""],["Burst score (z)",e.burstScore!=null?e.burstScore.toFixed(2):"\u2014"],["Lag-1 autocorrelation",e.autocorrelation!=null?e.autocorrelation.toFixed(3):"\u2014",e.autocorrelation>.6?"risk-text-med":""],["Day-of-week entropy",e.dowEntropy!=null?e.dowEntropy.toFixed(2)+" bits":"\u2014"],["Verdict",e.verdict,e.verdict==="elevated"?"risk-text-med":""]],n=["Sun","Mon","Tue","Wed","Thu","Fri","Sat"],s=e.dowBins?Math.max(...e.dowBins,1):1,a=e.dowBins?`
    ...
    ${h}`}function Wy(e,t,n,s,a,o,i,r=null,l=null,c=!1){let d=x("inspect-addr-badge");d&&(d.textContent=e.length>20?e.slice(0,10)+"\u2026"+e.slice(-8):e,d.title=e,d.dataset.fullAddr=e);let u=x("inspect-risk-score");u&&(u.textContent=i,u.className="irb-score-val "+nr(i));let p=x("inspect-risk-label");p&&(p.textContent=i<20?"Low Risk":i<45?"Moderate":i<70?"High Risk":"Critical",p.className="irb-score-label "+nr(i));let m=x("inspect-acct-grid");if(!m)return;let f=Math.max(0,n-s),g=Number(t.Flags||0),b=r!=null?r===0?"Created today":r===1?"1 day old":r<30?`${r} days old`:r<365?`${Math.floor(r/30)} months old`:`${(r/365).toFixed(1)} years old`:"\u2014",h=l?new Date(l).toLocaleDateString("en-US",{year:"numeric",month:"short",day:"numeric"}):null,v=h?c?`Created ${h}`:`Created ${h} (estimated \u2014 full history not confirmed)`:null,w=xn(n),k=xn(f),$=[{label:"XRP Balance",value:`${_(n,6)} XRP${w}`,mono:!0},{label:"Spendable",value:`${_(f,6)} XRP${k}`,mono:!0,note:`${s} XRP reserved`},{label:"Wallet Age",value:b,note:v,highlight:r!=null&&r<7?"new":null},{label:"Owner Count",value:a,note:`${a*2} XRP tied up`},{label:"Sequence",value:o,mono:!0},{label:"Regular Key",value:t.RegularKey?z(t.RegularKey):"None",warn:!!t.RegularKey,mono:!0},{label:"Master Key",value:g&_e.lsfDisableMaster?"Disabled":"Active",warn:!!(g&_e.lsfDisableMaster)}];m.innerHTML=$.map(T=>`
  ...
  `,co("badge-security",e.findings)}function Uy(e,t,n,s){let a=x("inspect-drain-body");if(!a)return;let o={low:"#50fa7b",medium:"#ffb86c",high:"#ff8c42",critical:"#ff5555",none:"#50fa7b"},i={low:"\u2713",medium:"\u26A0",high:"\u26A0",critical:"\u26D4",none:"\u2713"},r=e.compromiseRiskLevel??e.riskLevel,l=e.assetDrainSeverity??"none";a.innerHTML=`
  ...
  `,w0("badge-drain",e.riskLevel)}function Vy(e,t){let n=x("inspect-nft-body");n&&(n.innerHTML=`
    <div class="audit-items">
      ${e.flags.map(s=>qn(s)).join("")}
    </div>
    ${t.length?`
    <div class="nft-grid">
      ${t.slice(0,12).map(s=>Gy(s)).join("")}
    </div>
    ${t.length>12?`<div class="nft-more">+${t.length-12} more NFTs</div>`:""}
    `:""}
  `,co("badge-nft",e.flags))}function Gy(e){let t=Number(e.Flags||0),n=!!(t&Eu.lsfTransferable),s=!!(t&Eu.lsfBurnable),a=e.NFTokenTaxon||0,o=e.TransferFee?`${(e.TransferFee/1e3).toFixed(1)}%`:"0%";return`
    <div class="nft-card">
    ...
    </div>`}function Ky(e){let t=x("inspect-wash-body");if(!t)return;let n=e.verdict==="clean"||e.verdict==="low-risk"?"#50fa7b":e.verdict==="suspicious"?"#ffb86c":"#ff5555";t.innerHTML=`
  ...
  `;let s=x("badge-wash");if(s){let a=e.verdict==="clean"||e.verdict==="low-risk"?"ok":e.verdict==="suspicious"?"warn":"crit";s.textContent=e.verdict.replace("-"," "),s.className="section-badge section-badge--"+a}}function Qs(e,t){return`<div class="wash-stat"><span class="wash-stat-label">${y(e)}</span><span class="wash-stat-val">${t}</span></div>`}function Jy(e,t){let n=x("inspect-issuer-body");if(!n)return;let s=t.filter(a=>a.currency&&(a.currency.length===3||a.currency.length===40));n.innerHTML=`
    <div class="audit-items">
      ${e.signals.map(a=>qn(a)).join("")}
    </div>
    ${s.length?`
    <div class="trustline-list">
      ${s.slice(0,10).map(a=>`
        <div class="trustline-row">
          <span class="trustline-currency">${y(jn(a.currency))}</span>
  ...
  `,co("badge-issuer",e.signals)}function Yy(e,t){let n=x("inspect-amm-body");n&&(n.innerHTML=`
    <div class="audit-items">
  ...
  `,co("badge-amm",e.signals))}function Qy(e){let t=x("trust-count-badge");t&&(t.textContent=e.length);let n=x("inspect-trust-body");n&&(n.innerHTML=e.length?e.map(s=>{let a=s.freeze?'<span class="trustline-frozen">Frozen</span>':"",o=s.freeze_peer?'<span class="trustline-frozen trustline-frozen--peer">Issuer Frozen</span>':"",i=s.no_ripple?'<span class="trustline-norip">NoRipple</span>':"";return`
          <div class="trustline-row">
            <span class="trustline-currency">${y(jn(s.currency))}</span>
          ...
          </div>`}).join(""):'<div class="inspect-empty-note">No transactions found.</div>',e.length>s&&(n.innerHTML+=`<div class="tx-more">Showing ${s} of ${e.length} transactions</div>`)}function Yu(e,t,n){let s=Number((n==null?void 0:n.totalIn)||0),a=Number((t==null?void 0:t.totalOut)||0),o=Number(e||0);if(s<=0&&a<=0)return'<div class="inspect-empty-note">No inbound or outbound XRP flow found in the analysed transaction history.</div>';let i=new Set(((t==null?void 0:t.blackHoleDests)||[]).map(k=>k.addr)),r=new Set(((t==null?void 0:t.exchangeDests)||[]).map(k=>k.addr)),l=new Set(((t==null?void 0:t.newWalletDests)||[]).map(k=>k.addr)),c=0,d=0,u=0,p=0;for(let k of(t==null?void 0:t.destinations)||[])i.has(k.addr)?c+=k.totalXrp:r.has(k.addr)?d+=k.totalXrp:l.has(k.addr)?u+=k.totalXrp:p+=k.totalXrp;let m=Math.max(s,a,o,1),f=k=>(k>0?Math.max(1.5,k/m*100):0).toFixed(1),g=[{label:"Black hole",xrp:c,color:wn.blackhole},{label:"Exchange",xrp:d,color:wn.exchange},{label:"New wallet",xrp:u,color:wn.newWallet},{label:"Other",xrp:p,color:wn.other}].filter(k=>k.xrp>0),b=a>0?Math.max(1.5,a/m*100):0,h=g.map(k=>`<div style="width:${(a>0?k.xrp/a*100:0).toFixed(1)}%;background:${k.color};height:100%" title="${y(k.label)}: ${_(k.xrp,2)} XRP"></div>`).join(""),v=(k,$,T,S,N)=>`
    <div style="display:flex;align-items:center;gap:10px;margin-bottom:8px">
      ...
      <div style="flex:1;height:16px;border-radius:5px;overflow:hidden;background:rgba(255,255,255,.05)">
        <div style="width:${T}%;height:100%;display:flex">${S||`<div style="width:100%;height:100%;background:${N}"></div>`}</div>
      </div>
  ...
  `,a){let c=e.blackHoleDests.length||e.exchangeDests.length>2;a.textContent=`${e.uniqueDests} dests`,a.className=`section-badge section-badge--${c?"crit":e.uniqueDests>0?"warn":"ok"}`}}function Qu(e,t){if(!e||!t)return"";let n=new Date(e*1e3).toLocaleDateString(),s=new Date(t*1e3).toLocaleDateString();return n===s?n:`${n} \u2013 ${s}`}function t0(e,t){let n=x("inspect-issuer-connections-body");if(!n)return;let s=e.totalIssued,a=x("badge-issuer-connections");if(n.innerHTML=`
    <div class="audit-items">
  ...
  `,a){let o=e.signals.some(i=>i.sev==="critical")?"crit":e.signals.some(i=>i.sev==="warn")?"warn":e.signals.some(i=>i.sev==="info")?"neutral":"ok";a.className=`section-badge section-badge--${o}`,a.textContent=s>0?`${e.holderCount} holders`:"No issuance"}}function n0(e){var c;let t=document.getElementById("inspect-fee-analysis-body");if(!t||!e)return;let n=(e.signals||[]).map(Tt).join(""),s=e.avgFeeMultiplier!=null?`
    ...
    ${e.selfRoutedCount?`<div class="wash-stat-row"><span>Self-routed payments</span><span class="mono risk-text-high">${e.selfRoutedCount}</span></div>`:""}`;if(n.innerHTML=a+o,s){let r=e.signals.some(c=>c.sev==="critical"),l=e.signals.some(c=>c.sev==="warn");s.textContent=r?"Critical":l?"Check":"Normal",s.className=`section-badge section-badge--${r?"crit":l?"warn":"ok"}`}}function o0(e){var i,r,l;let t=x("inspect-inbound-body");if(!t)return;let n=(e.signals||[]).map(Tt).join(""),s=`
    ...
    ${e.wallShare>.3?`<div class="wash-stat-row"><span>Largest single order share</span><span class="mono ${e.wallShare>.4?"risk-text-high":"risk-text-med"}">${(e.wallShare*100).toFixed(1)}%</span></div>`:""}`;n.innerHTML=s+a;let o=x("badge-livebook");if(o){let i=(e.signals||[]).some(l=>l.sev==="critical"),r=(e.signals||[]).some(l=>l.sev==="warn");o.textContent=i?"Wall order":r?"Check":"Normal",o.className=`section-badge section-badge--${i?"crit":r?"warn":"ok"}`}}function d0(e,...t){let n=x("inspect-risk-breakdown");if(!n)return;let s=_y(e,...t);if(!s.length){n.innerHTML="";return}let a=Math.max(1,s.reduce((o,i)=>o+i.pts,0));n.innerHTML=`
    ...
    </div>`}function Zu(e,t,n,s){let a=(o,i,r,l)=>l&&l.length?`<div class="audit-evidence-group audit-epistemic-group audit-epistemic--${o}">
    ...
    <div class="audit-row audit-row--${e}">
      ...
      <div class="audit-text">
        ...
        ${o!=null&&o.length||i!=null&&i.length||r?Zu(a,o,i,r):p("Observed",a)}
    ...
    <div class="finding finding--${e.sev}">
      ...
      <div class="finding-body">
        ...
        ${(s=e.calculated)!=null&&s.length||(a=e.inferred)!=null&&a.length||e.hypothesis?Zu(e.observed,e.calculated,e.inferred,e.hypothesis):n("Observed",e.observed)}
    ...
    <div class="report-wrap">
      ...
      <div class="report-section">
        ...
        <div style="margin-bottom:16px">${V0(f,e)}</div>
        ${Yu(n,p,N)}
      </div>
  ...
  `}function h0(e,...t){e.innerHTML=f0(...t)}function g0(){let e=document.getElementById("tab-inspector");e&&(e.querySelector("[data-inspector-v2]")||(e.innerHTML=`
    <style>
  ...
  `))}function b0(){if(document.getElementById("inspector-nav"))return;let e=document.createElement("nav");e.id="inspector-nav",e.setAttribute("aria-label","Inspector navigation"),e.innerHTML=`
  ...
  `;let t=document.getElementById("tab-inspector");t&&t.appendChild(e)}function v0(){if(document.getElementById("inspector-howto"))return;let e=document.createElement("div");e.id="inspector-howto",e.className="howto-overlay",e.style.display="none",e.innerHTML=`
  ...
  `).join(""))}function M0(){let e=document.getElementById("isd-cap-grid");e&&(e.innerHTML=T0.map(t=>`
  ...
  `).join(""))}function lr(){let e=document.getElementById("isd-wallets-section"),t=document.getElementById("isd-wallet-list");if(!e||!t)return;let n=ge(Q($0))||[];if(!n.length){e.style.display="none";return}e.style.display="",t.innerHTML=n.map(s=>{let a=s.color||"#50fa7b",o=s.emoji||"\u{1F48E}",i=s.label||"Wallet",r=s.address||"",l=r?r.slice(0,8)+"\u2026"+r.slice(-6):"\u2014",c=s.testnet?'<span class="isd-wallet-testnet">TESTNET</span>':"";return`
    ...
    `}).join("")}function cr(){let e=document.getElementById("isd-recent-section"),t=document.getElementById("isd-recent-list");if(!e||!t)return;let n=po();if(!n.length){e.style.display="none";return}e.style.display="",t.innerHTML=n.map((s,a)=>{let o=s.addr?s.addr.slice(0,10)+"\u2026"+s.addr.slice(-8):"\u2014",i=s.riskScore!=null?`<span class="isd-risk-pill isd-risk-pill--${sm(s.riskScore)}">${s.riskScore}</span>`:"";return`
      <button class="isd-recent-row" onclick="inspectorLoadAddr('${y(s.addr)}')" type="button">
        ...
        <div class="isd-recent-right">
          ${i}
          <span class="isd-recent-time">${uo(s.ts)}</span>
        </div>
      </button>
    `}).join("")}function L0(){ro(),window.addEventListener("xrpl-ledger",A0),window.addEventListener("xrpl-connection",ro)}function A0(e){ao()&&ro(e.detail)}var Qi=null;function E0(){return Qi||(Qi={idx:document.getElementById("isd-ledger-idx"),age:document.getElementById("isd-ledger-age"),tps:document.getElementById("isd-tps"),tpsTrnd:document.getElementById("isd-tps-trend"),fee:document.getElementById("isd-fee"),feeLv:document.getElementById("isd-fee-level"),close:document.getElementById("isd-close-time"),dot:document.getElementById("isd-conn-dot"),connLbl:document.getElementById("isd-conn-label"),pill:document.getElementById("isd-conn-pill"),domTx:document.getElementById("isd-dom-tx"),domPct:document.getElementById("isd-dom-pct"),bar:document.getElementById("isd-fee-bar"),barLbl:document.getElementById("isd-fee-bar-label")})}function ro(){let{idx:e,age:t,tps:n,tpsTrnd:s,fee:a,feeLv:o,close:i,dot:r,connLbl:l,pill:c,domTx:d,domPct:u,bar:p,barLbl:m}=E0(),f=X.connectionState||"disconnected",g={connected:{label:"Connected",cls:"conn--live"},connecting:{label:"Connecting\u2026",cls:"conn--warn"},disconnected:{label:"Disconnected",cls:"conn--dead"}},b=g[f]||g.disconnected;r&&(r.className="isd-conn-dot"),l&&(l.textContent=b.label),c&&(c.className=`isd-conn-pill ${b.cls}`);let h=X.ledgerLog||[];if(h.length&&e){let T=h[0];if(e.textContent=Number(T.ledgerIndex||0).toLocaleString(),t&&(t.textContent=T.closeTimeSec!=="\u2014"?T.closeTimeSec+"s close":"\u2014"),i){let S=parseFloat(T.closeTimeSec);i.textContent=isNaN(S)?"\u2014":S.toFixed(1)}}let v=X.tpsHistory||[];if(v.length&&n){let T=v.slice(-5),S=T.reduce((N,P)=>N+P,0)/T.length;if(n.textContent=S.toFixed(1),s&&v.length>=6){let N=v.slice(-10,-5),P=N.reduce((R,O)=>R+O,0)/N.length,C=S-P;s.textContent=C>.5?"\u2191 rising":C<-.5?"\u2193 falling":"\u2192 stable",s.className=`isd-metric-sub ${C>.5?"isd-up":C<-.5?"isd-down":""}`}}let w=X.feeHistory||[];if(w.length&&a){let T=w.slice(-5),S=T.reduce((C,R)=>C+R,0)/T.length,N=S/1e6;a.textContent=S<5e3?S.toFixed(0)+" drops":N.toFixed(5)+" XRP";let P=S<20?{lbl:"Low",cls:"fee-low",pct:10}:S<100?{lbl:"Normal",cls:"fee-normal",pct:28}:S<500?{lbl:"Elevated",cls:"fee-elevated",pct:60}:S<2e3?{lbl:"High",cls:"fee-high",pct:82}:{lbl:"Congested",cls:"fee-congest",pct:100};o&&(o.textContent=P.lbl,o.className=`isd-metric-sub ${P.cls}`),p&&(p.style.width=P.pct+"%",p.className=`isd-fee-bar-fill ${P.cls}`),m&&(m.textContent=P.lbl,m.className=`isd-fee-bar-level ${P.cls}`)}let k=X.txMixAccum||{},$=Object.entries(k).filter(([,T])=>T>0).sort(([,T],[,S])=>S-T);if($.length&&d){let T=$.reduce((P,[,C])=>P+C,0),[S,N]=$[0];d.textContent=S,u&&(u.textContent=(N/T*100).toFixed(0)+"% of traffic")}}window.exportTxCSV=function(e){var l,c;if(!e||!e.length){alert("No transaction data to export. Run an inspection first.");return}let t=946684800,s=[["Hash","Date","Type","Account","Destination","Amount_XRP","Amount_Token","Currency","Fee_Drops","DestinationTag","Result","LedgerIndex"],...e.map(({tx:d,meta:u})=>{var h,v;let p=d.date?new Date((d.date+t)*1e3).toISOString():"",m=typeof d.Amount=="string"?(Number(d.Amount)/1e6).toFixed(6):"",f=(h=d.Amount)!=null&&h.value?d.Amount.value:"",g=((v=d.Amount)==null?void 0:v.currency)||(typeof d.Amount=="string"?"XRP":""),b=(u==null?void 0:u.TransactionResult)||"";return[d.hash||"",p,d.TransactionType||"",d.Account||"",d.Destination||"",m,f,g,d.Fee||"",d.DestinationTag??"",b,d.ledger_index||""]})].map(d=>d.map(u=>{let p=String(u);return p.includes(",")||p.includes('"')||p.includes(`
`)?'"'+p.replace(/"/g,'""')+'"':p}).join(",")).join(`
`),a=new Blob([s],{type:"text/csv;charset=utf-8;"}),o=URL.createObjectURL(a),i=document.createElement("a"),r=((c=(l=document.getElementById("inspect-addr-badge"))==null?void 0:l.dataset)==null?void 0:c.fullAddr)||"wallet";i.href=o,i.download=`naluxrp_${r.slice(0,10)}_${new Date().toISOString().slice(0,10)}.csv`,document.body.appendChild(i),i.click(),document.body.removeChild(i),URL.revokeObjectURL(o)};function N0(e,t){let s=po().find(o=>o.addr===e);if(!s||s.riskScore==null||t==null)return null;let a=t-s.riskScore;return{prev:s.riskScore,curr:t,diff:a,ts:s.ts}}function R0(e,t){let n=N0(e,t);if(!n||Math.abs(n.diff)<2)return;let s=document.getElementById("inspect-risk-score");if(!s)return;let a=n.diff>0?`<span style="color:#ff5555;font-size:.7rem;font-weight:700"> \u2191${n.diff}</span>`:`<span style="color:#50fa7b;font-size:.7rem;font-weight:700"> \u2193${Math.abs(n.diff)}</span>`,o=uo(n.ts);s.insertAdjacentHTML("afterend",`<span class="risk-score-diff" title="Changed from ${n.prev} \u2192 ${n.curr} since ${o}">${a} vs ${o}</span>`)}window._inspectMaxTx||(window._inspectMaxTx=5e3);window._debugBalanceDeltas=zu;window._debugOfferLifecycles=Ku;window._debugReconstructBalanceHistory=ju;window._debugFindDrainEpisodes=Wu;window._debugDrainRisk=Gu;window.inspectorLoadAddr=function(e){let t=x("inspect-addr");t&&(t.value=e),ks()};window.inspectWalletAddr=function(e){var n,s;window.inspectorLoadAddr(e);let t=document.querySelector('[data-tab="inspector"]');t&&((n=window.switchTab)==null||n.call(window,t,"inspector")),(s=window.showDashboard)==null||s.call(window)};window.printInspectorReport=function(){var s,a;let e=document.getElementById("inspect-report-body");if(!e)return;let t=((a=(s=document.getElementById("inspect-addr-badge"))==null?void 0:s.dataset)==null?void 0:a.fullAddr)||"wallet",n=window.open("","_blank","width=900,height=700");n.document.write(`<!DOCTYPE html><html><head>
    ...
    ${e.innerHTML}
  </body></html>`),n.document.close()};window.exportInspectorReport=function(){var n;let e=document.getElementById("inspect-report-body");if(!e)return;let t=e.innerText||e.textContent||"";(n=navigator.clipboard)==null||n.writeText(t).then(()=>{let s=document.getElementById("report-export-btn");s&&(s.textContent="\u2713 Copied!",setTimeout(()=>{s.textContent="\u{1F4CB} Copy Report"},2e3))}).catch(()=>{let s=document.createRange();s.selectNodeContents(e);let a=window.getSelection();a.removeAllRanges(),a.addRange(s)})};window.inspectorClearHistory=function(){bt(rr);let e=document.getElementById("isd-recent-section");e&&(e.style.display="none")};window.inspectorClearWatchlist=function(){bt(na),aa()};function po(){return ge(Q(rr))||[]}function _0(e,t,n=[]){let s=po();s=s.filter(o=>o.addr!==e);let a=n.filter(o=>o.sev==="critical"||o.sev==="warn").map(o=>o.module+":"+o.headline.slice(0,40)).sort().join("|");s.unshift({addr:e,riskScore:t,ts:Date.now(),fingerprint:a}),s=s.slice(0,12),Z(rr,JSON.stringify(s))}function sa(){return ge(Q(na))||[]}function D0(e,t){let n=sa().filter(s=>s.addr!==e);n.unshift({addr:e,label:t||z(e),addedTs:Date.now(),lastScore:null,lastTs:null}),Z(na,JSON.stringify(n.slice(0,50)))}function nm(e){Z(na,JSON.stringify(sa().filter(t=>t.addr!==e)))}function ar(e){return sa().some(t=>t.addr===e)}function I0(e,t){let n=sa().map(s=>s.addr===e?{...s,lastScore:t,lastTs:Date.now()}:s);Z(na,JSON.stringify(n))}function uo(e){let t=Date.now()-e;return t<6e4?"just now":t<36e5?Math.floor(t/6e4)+"m ago":t<864e5?Math.floor(t/36e5)+"h ago":Math.floor(t/864e5)+"d ago"}function sm(e){return nr(e).replace("risk-","")}var en=!1;function am(){en=localStorage.getItem(tm)==="true",dr()}function dr(){let e=document.getElementById("inspect-result");if(!e)return;e.classList.toggle("mode-advanced",en),e.classList.toggle("mode-simple",!en);let t=document.getElementById("analyst-mode-btn");t&&(t.textContent=en?"\u2697 Advanced":"\u{1F441} Simple",t.title=en?"Switch to Simple view":"Switch to Advanced (analyst) view",t.setAttribute("aria-pressed",String(en)))}window.toggleAnalystMode=function(){en=!en,localStorage.setItem(tm,en),dr()};var F0=new Set(["section-overview","section-report"]),O0=new Set(["section-security","section-drain","section-fundflow","section-inbound"]);function B0(){let e=document.getElementById("inspect-result");if(!e)return;let t=[...e.querySelectorAll(".inspector-section")],n={crit:0,warn:1,neutral:2,ok:3,"":4},s=t.filter(i=>!F0.has(i.id)&&!O0.has(i.id));s.sort((i,r)=>{let l=c=>{let d=c.querySelector(".section-badge");if(!d)return"";let u=d.className;return u.includes("crit")?"crit":u.includes("warn")?"warn":u.includes("neutral")?"neutral":u.includes("ok")?"ok":""};return(n[l(i)]??4)-(n[l(r)]??4)});let a=document.getElementById("section-inbound")||document.getElementById("section-drain");if(!a)return;let o=a;for(let i of s)o.after(i),o=i}var X0=new Set(["section-overview","section-evidence-matrix"]);function H0(){document.querySelectorAll("#inspect-result .inspector-section").forEach(e=>{if(X0.has(e.id))return;let t=e.querySelector(".section-header");if(!t)return;let n=e.querySelector(".section-badge"),s=!!n&&(n.classList.contains("section-badge--crit")||n.classList.contains("section-badge--warn"));e.classList.toggle("collapsed",!s),t.setAttribute("aria-expanded",String(s))})}function pr(e){let t=(e||[]).filter(s=>s.confidence!=null);if(!t.length)return null;let n=t.reduce((s,a)=>s+a.confidence,0)/t.length;return n>=.7?"Strong":n>=.4?"Moderate":"Weak"}var zn={sev:"all",category:"all"};function z0(e,t){zn[e]=t,om(window._lastAllFindings||[])}function om(e){let t=document.getElementById("inspect-evidence-matrix-body");if(!t)return;let n=document.getElementById("badge-evidence-matrix"),s=e.filter(d=>!(zn.sev!=="all"&&d.sev!==zn.sev||zn.category!=="all"&&(d.category||io[d.module]||"security")!==zn.category));n&&(n.textContent=`${s.length} of ${e.length}`);let a=["all","critical","warn","info"],o={all:"All",critical:"Critical",warn:"Warning",info:"Info"},i=["all",...oo],r=`
    <div class="evmatrix-filters">
      <div class="evmatrix-filter-group">
        ${a.map(d=>`<button class="evmatrix-filter-btn ${zn.sev===d?"evmatrix-filter-btn--active":""}" onclick="setEvidenceMatrixFilter('sev','${d}')">${o[d]}</button>`).join("")}
      </div>
      <div class="evmatrix-filter-group">
        ${i.map(d=>`<button class="evmatrix-filter-btn ${zn.category===d?"evmatrix-filter-btn--active":""}" onclick="setEvidenceMatrixFilter('category','${d}')">${d==="all"?"All Categories":y(ta[d]||d)}</button>`).join("")}
      </div>
    </div>`;if(!e.length){t.innerHTML='<div class="inspect-empty-note">No findings recorded for this inspection yet \u2014 run an inspection first.</div>';return}if(!s.length){t.innerHTML=r+'<div class="inspect-empty-note">No findings match this filter.</div>';return}let l={critical:"\u26D4",warn:"\u26A0",info:"\u2139",ok:"\u2713"},c=s.sort((d,u)=>(u.confidence??0)*(tr[u.sev]??0)-(d.confidence??0)*(tr[d.sev]??0)).map(d=>{let u=e.indexOf(d),p=d.category||io[d.module]||"security",m=pr([d])||"\u2014";return`
      <tr class="evmatrix-row evmatrix-row--${d.sev}" onclick="openEvidenceInspector(${u})" tabindex="0" role="button">
        <td class="evmatrix-finding">${y(d.headline||d.label||"")}</td>
        <td>${y(ta[p]||p)}</td>
        <td class="evmatrix-sev evmatrix-sev--${d.sev}">${l[d.sev]||""} ${(d.sev||"").toUpperCase()}</td>
        <td class="mono">${d.confidence!=null?Math.round(d.confidence*100)+"%":"\u2014"}</td>
        <td>${y(m)}</td>
      </tr>`}).join("");t.innerHTML=`
    ${r}
    ...
    </div>`}function j0(){var n;if(document.getElementById("evidenceInspectorOverlay"))return;let e=document.createElement("div");e.id="evidenceInspectorOverlay",e.className="acct-peek-overlay",e.style.display="none",e.innerHTML=`
    ...
    </div>`,document.body.appendChild(e);let t=()=>{e.style.display="none"};e.addEventListener("click",s=>{s.target===e&&t()}),(n=document.getElementById("evInspectorClose"))==null||n.addEventListener("click",t)}function W0(e){j0();let t=(window._lastAllFindings||[])[e],n=document.getElementById("evidenceInspectorOverlay");if(!t||!n)return;let s=t.category||io[t.module]||"security",a=pr([t])||"\u2014";document.getElementById("evInspectorHeadline").textContent=t.headline||t.label||"",document.getElementById("evInspectorGrid").innerHTML=`
    ...
    <div class="acct-peek-stat" style="grid-column:1 / -1"><span>Evidence Strength</span><b>${y(a)}</b></div>`,document.getElementById("evInspectorDetail").innerHTML=Tt({...t,label:t.headline||t.label}),n.style.display="flex"}function q0(e,t,n,s,a={},o=!1,i=null){let r=document.getElementById("quick-verdict-body");if(!r)return;let l=t.filter(C=>C.sev==="critical"),c=t.filter(C=>C.sev==="warn"),d=e<20?"#50fa7b":e<45?"#ffb86c":e<70?"#ff8c42":"#ff5555",u=e<20?"Low Risk":e<45?"Moderate":e<70?"High Risk":"Critical",p=(C,R)=>(R.confidence??.5)-(C.confidence??.5),m=[...l].sort(p),f=[...c].sort(p),g="",b="";if(l.length===0&&c.length===0)g=`No elevated signals found across ${s.toLocaleString()} transactions${n!=null?` and ${n} days of history`:""}.`,b="This wallet appears to operate within normal parameters.";else{let C=m.slice(0,2).map(O=>O.headline).join("; "),R=f.slice(0,2).map(O=>O.headline).join("; ");g=l.length?`${l.length} critical issue${l.length>1?"s":""}: ${C}.`:`${c.length} warning${c.length>1?"s":""}: ${R}.`,b=l.length?"Review the highlighted sections below. Scroll to the Report for full recommendations.":"Review the flagged sections below for context before drawing conclusions."}let h=oo.filter(C=>C!=="external-exposure").map(C=>({cat:C,...a[C]})).filter(C=>C.score>0).sort((C,R)=>R.score-C.score),v=a["external-exposure"],w=(v==null?void 0:v.score)>0?`
    ...
    <div style="margin-top:10px;padding-top:10px;border-top:1px solid rgba(255,255,255,.06)">
      ...
      <div style="display:flex;flex-direction:column;gap:4px">
        ${h.map(C=>{let R=pr(C.findings);return`
          <div style="display:flex;align-items:center;gap:8px;font-size:.76rem">
    ...
    <div style="margin-top:10px;padding-top:10px;border-top:1px solid rgba(255,255,255,.06)">
      ...
      <div style="display:flex;flex-direction:column;gap:3px;font-size:.76rem;color:rgba(255,255,255,.55)">
        <div><span style="color:${N?"#50fa7b":"#ffb86c"}">${N?"\u2713":"\u26A0"}</span> ${y(S)} (${s.toLocaleString()} transactions)</div>
    ...
    ${T}
    ${w}
    ${P}`}function U0(e,t){let n=document.getElementById("change-banner");if(!n)return;n.style.display="none";let a=po().find(u=>u.addr===e);if(!(a!=null&&a.fingerprint))return;let o=new Set(t.filter(u=>u.sev==="critical"||u.sev==="warn").map(u=>u.module+":"+u.headline.slice(0,40))),i=new Set((a.fingerprint||"").split("|").filter(Boolean)),r=[...o].filter(u=>!i.has(u)),l=[...i].filter(u=>!o.has(u));if(!r.length&&!l.length)return;let c=uo(a.ts),d=[];r.length&&d.push(`<span style="color:#ff5555">+${r.length} new finding${r.length>1?"s":""}</span>`),l.length&&d.push(`<span style="color:#50fa7b">${l.length} resolved</span>`),n.style.display="",n.innerHTML=`
    ...
    </div>`}function aa(){let e=document.getElementById("isd-watchlist-section"),t=document.getElementById("isd-watchlist-list");if(!e||!t)return;let n=sa();if(!n.length){e.style.display="none";return}e.style.display="",t.innerHTML=n.map(s=>{let a=s.addr.slice(0,8)+"\u2026"+s.addr.slice(-6),o=s.lastScore!=null?`<span class="isd-risk-pill isd-risk-pill--${sm(s.lastScore)}">${s.lastScore}</span>`:"",i=s.lastTs?uo(s.lastTs):"never checked";return`
    ...
    </div>`}function rm(e,t){let n=new Map;for(let{tx:s,meta:a}of e){let o=s.Account===t,i=s.Destination===t;if(!o&&!i)continue;let r=o?s.Destination:s.Account;if(!r||r===t)continue;let l=tn(s);n.has(r)||n.set(r,{cnt:0,xrpOut:0,xrpIn:0,entity:Wn(r),firstSeen:l,lastSeen:l});let c=n.get(r);c.cnt++,l&&(c.firstSeen=c.firstSeen?Math.min(c.firstSeen,l):l,c.lastSeen=Math.max(c.lastSeen,l));let d=(a==null?void 0:a.delivered_amount)||s.Amount,u=typeof d=="string"?Number(d)/1e6:0;o?c.xrpOut+=u:c.xrpIn+=u}return n}function V0(e,t,n=15){let s=rm(e,t),a=[...s.entries()].sort((r,l)=>l[1].xrpOut+l[1].xrpIn-(r[1].xrpOut+r[1].xrpIn)||l[1].cnt-r[1].cnt).slice(0,n);if(!a.length)return'<div class="inspect-empty-note">No counterparty interactions found.</div>';let o=Math.max(...a.map(([,r])=>r.xrpOut+r.xrpIn),1),i=a.map(([r,l],c)=>{var h;let d=l.xrpOut+l.xrpIn,u=Math.max(1.5,d/o*100),p=wn[(h=l.entity)==null?void 0:h.type]||wn.other,m=d>0?l.xrpOut/d:.5,f=m>.65?"\u2192 out":m<.35?"\u2190 in":"\u21C4 both",g=l.entity?`<span style="font-size:.64rem;color:${p};border:1px solid ${p};border-radius:999px;padding:1px 7px;margin-left:6px">${y(l.entity.name)}</span>`:"",b=Qu(l.firstSeen,l.lastSeen);return`
    ...
    ${i}`}function G0(e,t,n,s,a="inspect-network-map"){let o=document.getElementById(a);if(!o)return;let r=[...rm(e,t).entries()].sort((S,N)=>N[1].xrpOut+N[1].xrpIn-(S[1].xrpOut+S[1].xrpIn)||N[1].cnt-S[1].cnt).slice(0,20);if(r.length<2){o.style.display="",o.innerHTML=`<div class="inspect-empty-note">${r.length===0?"No counterparty interactions found.":"Only one counterparty found \u2014 not enough to chart a network map."}</div>`;return}o.style.display="";let l=560,c=340,d=l/2,u=c/2,p=95,m=7,f=155,g=13,b=r[0][1].xrpOut+r[0][1].xrpIn||1,h=r[0][1].cnt||1,v=[{id:t,x:d,y:u,r:13,main:!0,label:z(t),color:"#00d4ff",xrpOut:0,xrpIn:0,cnt:0}];r.forEach(([S,N],P)=>{let C=P<m?p:f,R=P<m?m:g,D=(P<m?P:P-m)/R*2*Math.PI-Math.PI/2,I=N.xrpOut+N.xrpIn,F=Math.max(5,Math.min(14,4+I/b*10)),H=N.entity,E=wn[H==null?void 0:H.type]||wn.other,j=I>0?N.xrpOut/I:.5,se=j>.65?"out":j<.35?"in":"both";v.push({id:S,x:d+C*Math.cos(D),y:u+C*Math.sin(D),r:F,color:E,label:(H==null?void 0:H.name)||z(S),ent:H,xrpOut:N.xrpOut,xrpIn:N.xrpIn,cnt:N.cnt,dir:se,vol:I,ring:C})});let w=`<defs>
    ...
    <filter id="glow-red">
  ...
  </defs>`,k=v.slice(1).map(S=>{let N=S.vol/b,P=Math.max(.8,N*3),C=.12+N*.45,R=S.dir==="out"?"rgba(80,250,123,":S.dir==="in"?"rgba(0,212,255,":"rgba(255,184,108,",O=S.dir==="out"?`rgba(80,250,123,${C})`:S.dir==="in"?`rgba(0,212,255,${C})`:`rgba(255,184,108,${C})`,D=S.dir==="in"?"5,3":"none",I=`marker-end="url(#arrow-${S.dir})"`,F=S.x-d,H=S.y-u,E=Math.sqrt(F*F+H*H),j=(S.r+2)/E,se=d+F*(1-j),re=u+H*(1-j),pe=`${S.xrpOut>0?"\u2192 "+_(S.xrpOut,2)+" XRP out":""}${S.xrpIn>0?(S.xrpOut>0?" / ":"")+"\u2190 "+_(S.xrpIn,2)+" XRP in":""}, ${S.cnt} tx`;return`<line x1="${d}" y1="${u}" x2="${se.toFixed(1)}" y2="${re.toFixed(1)}"
      stroke="${O}" stroke-width="${P.toFixed(1)}" stroke-dasharray="${D}" ${I}>
      <title>${pe}</title></line>`}).join(""),$=v.map(S=>{var H,E;if(S.main){let j=z(S.id);return`<g>
      ...
      </g>`}let N=((H=S.ent)==null?void 0:H.type)==="blackhole",P=((E=S.ent)==null?void 0:E.type)==="exchange",C=N?'filter="url(#glow-red)"':"",R=S.dir==="out"?"rgba(80,250,123,.5)":S.dir==="in"?"rgba(0,212,255,.5)":"rgba(255,184,108,.5)",O=1.5,D=S.label.length>14?S.label.slice(0,14)+"\u2026":S.label,I=S.vol>0?S.xrpOut>0&&S.xrpIn>0?`\u21C4 ${_(S.vol,0)} XRP`:S.xrpOut>0?`\u2192 ${_(S.xrpOut,0)} XRP`:`\u2190 ${_(S.xrpIn,0)} XRP`:`${S.cnt} tx`,F=S.id+(S.ent?" ("+S.ent.name+")":"")+" | "+(S.xrpOut>0?"Sent: "+_(S.xrpOut,2)+" XRP"+xn(S.xrpOut)+" | ":"")+(S.xrpIn>0?"Received: "+_(S.xrpIn,2)+" XRP"+xn(S.xrpIn)+" | ":"")+"Interactions: "+S.cnt;return`<g style="cursor:pointer" onclick="inspectorLoadAddr('${S.id}')">
      <title>${F}</title>
      ${N?`<circle cx="${S.x}" cy="${S.y}" r="${S.r+4}" fill="rgba(255,85,85,.1)" stroke="rgba(255,85,85,.4)" stroke-width="1" stroke-dasharray="3,2"/>`:""}
    ...
    </div>`}function K0(){let e=window._lastInspectResult,t=window._lastAllFindings||[];if(!e)return null;let n=t.length?t.map(a=>`- [${a.sev.toUpperCase()}] ${a.module}: ${a.headline}${a.detail?" \u2014 "+a.detail:""}`).join(`
...
You are acting as a security analyst explaining automated blockchain forensics findings to someone who isn't a blockchain expert. Write a clear, plain-English explanation of what this account's activity suggests. Synthesize the findings above into a coherent read of the account rather than restating them one by one \u2014 call out which ones reinforce each other and which are weak signals on their own. Be direct about how concerning (or not) this looks, and be skeptical of your own confidence where the evidence is thin rather than overstating it. Do not repeat the address or risk score back verbatim; the reader can already see those above your response.`}window.copyInspectorAnalysisForAi=function(){let e=document.getElementById("ai-explanation-body"),t=K0();if(!t){e&&(e.innerHTML='<p style="font-size:.82rem;color:#ff5555">Run an inspection first.</p>');return}js(t)};window.exportInspectorJSON=function(){var o,i;let e=window._lastInspectResult;if(!e){alert("Run an inspection first.");return}let t=new Blob([JSON.stringify(e,null,2)],{type:"application/json"}),n=URL.createObjectURL(t),s=document.createElement("a"),a=((i=(o=document.getElementById("inspect-addr-badge"))==null?void 0:o.dataset)==null?void 0:i.fullAddr)||"wallet";s.href=n,s.download=`naluxrp_${a.slice(0,10)}_${new Date().toISOString().slice(0,10)}.json`,document.body.appendChild(s),s.click(),document.body.removeChild(s),URL.revokeObjectURL(n)};var J0=6e4,Y0=1e4,Q0=12e4,Z0=8e3,ew=12e4,tw=300,ym="nalulf_net_baseline_v2",nw=80,sw=5,ra="/api/v1/validatorregistry",wm="/api/v1/validator";var aw=5*60*1e3,xm=10*60*1e3,lm=1e4,km=8e3,hr=new Map,gr=new Map;var sn={quorumTight:{w:3,label:"Quorum within 3 validators of failure threshold"},nUnlActive:{w:2,label:"Negative UNL active \u2014 validators currently being ignored"},amendVeto:{w:1,label:"Amendment veto clustering \u2014 protocol governance dispute"},feeSpike:{w:2,label:"Open ledger fee 10\xD7 minimum \u2014 DDoS / spam attack likely"},burnAnomaly:{w:2,label:"XRP burn rate z-score > 3\u03C3 \u2014 resource exhaustion pattern"},peerSaturate:{w:2,label:"Inbound peers > 80% of connections \u2014 Eclipse Attack risk"},eclipseRisk:{w:3,label:"Peer count < 6 \u2014 node highly vulnerable to isolation"},dexSpike:{w:1,label:"DEX volume > 3\xD7 AMM baseline \u2014 unusual event-driven flow"},reserveSpike:{w:1,label:"New account rate > 3\xD7 baseline \u2014 possible bot creation"},slowConverge:{w:2,label:"Consensus convergence > 6s \u2014 network agreement degraded"},lowProposers:{w:2,label:"Proposer count below quorum \u2014 validator participation low"},queuePressure:{w:2,label:"TX queue > 80% full \u2014 fee surge imminent"},spamLedger:{w:1,label:"Ledger > 2\xD7 expected size \u2014 ledger spam in progress"},ioStressed:{w:1,label:"Node IO latency > 5ms \u2014 storage or network I/O stress"},peerChurn:{w:1,label:"Elevated peer disconnect rate \u2014 DDoS or instability"},staleLedger:{w:3,label:"Ledger age > 10s \u2014 validation appears stalled"}},$m={MultiSign:{purpose:"Multi-signature authorization",intro:"rippled 0.31",desc:"Lets multiple keys jointly authorize one transaction. Essential for institutional custody and hardware-wallet setups.",impact:"New transaction: SignerListSet. All signers submit their signature; the last one broadcasts."},MultiSignReserve:{purpose:"Cheaper signer-list reserve",intro:"rippled 1.2",desc:"Cuts the owner reserve for SignerList objects from 5 owner-items (10 XRP) down to 1 owner-item (2 XRP).",impact:"Existing SignerLists do not gain the reduction automatically; delete and re-create the list."},DepositAuth:{purpose:"Block unsolicited incoming payments",intro:"rippled 0.90",desc:"An account can set lsfDepositAuth so it only receives payments explicitly pre-authorized via DepositPreauth.",impact:"Senders to un-authorized accounts receive tecNO_PERMISSION."},DeletableAccounts:{purpose:"Permanent account deletion + reserve reclaim",intro:"rippled 1.4",desc:"An account with no objects and sequence \u2265 (current ledger \u2212 256) can permanently delete itself and recover the base reserve.",impact:"New transaction: AccountDelete. Sends all XRP minus fees to a destination."},NegativeUNL:{purpose:"Fault-tolerant consensus during outages",intro:"rippled 1.6",desc:"When validators are persistently offline, the network may add them to the Negative UNL so they do not count against quorum.",impact:"Enables the network to survive planned outages of up to 20% of trusted validators."},Checks:{purpose:"Deferred, cancellable payments",intro:"rippled 1.0",desc:"The sender creates a Check; the recipient can later cash it up to the authorized amount or let it expire. The sender can cancel at any time.",impact:"New transactions: CheckCreate, CheckCash, CheckCancel. Each open Check uses one owner-reserve slot."},AMM:{purpose:"Native Automated Market Maker DEX",intro:"rippled 1.12",desc:"Adds a Constant-Product (x*y=k) AMM directly in the ledger. Anyone can deposit two assets to earn LP tokens and a share of swap fees.",impact:"New transactions: AMMCreate, AMMDeposit, AMMWithdraw, AMMVote, AMMBid, AMMDelete."},XChainBridge:{purpose:"Cross-chain bridge protocol",intro:"rippled 2.0",desc:"Lets assets move between XRPL Mainnet, sidechains, and EVM chains via a locking/minting bridge secured by Witness servers.",impact:"New ledger objects: Bridge, XChainOwnedCreateAccountClaimID, etc. Requires Witness infrastructure."},Clawback:{purpose:"Token-issuer recovery",intro:"rippled 1.12",desc:"Issuers who set lsfAllowTrustLineClawback before issuing tokens can claw back tokens from any holder.",impact:"Must be enabled on a fresh account before any trust lines are created."},NonFungibleTokensV1:{purpose:"Native NFT support",intro:"rippled 1.9",desc:"Adds NFTokenMint, NFTokenBurn, and offer-based transfer mechanics for non-fungible tokens stored in NFTokenPage objects.",impact:"Each NFTokenPage holds up to 32 tokens and costs one owner-reserve slot. Royalties up to 50%."},NonFungibleTokensV1_1:{purpose:"NFT V1 corrections",intro:"rippled 1.10",desc:"Fixes pagination bugs, transfer-fee edge cases, and minting with the URI field that were present in V1.",impact:"Breaking fix for some V1 edge cases. Wallets built for V1 should test V1_1 compatibility."},PayChan:{purpose:"Payment channels for streaming micropayments",intro:"rippled 0.33",desc:"Sender deposits XRP into a channel, then issues signed claims off-ledger. Recipient submits the highest claim at any time to settle on-ledger.",impact:"New transactions: PaymentChannelCreate, PaymentChannelFund, PaymentChannelClaim."},Escrow:{purpose:"Time-locked and condition-based XRP transfers",intro:"rippled 0.60",desc:"Lock XRP until a future time OR a cryptographic fulfillment (PREIMAGE-SHA-256) is revealed, enabling vesting schedules and atomic swaps.",impact:"New transactions: EscrowCreate, EscrowFinish, EscrowCancel. Locked XRP counts against reserves."},DisallowIncoming:{purpose:"Block unsolicited ledger-object creation",intro:"rippled 1.10",desc:"New account flags let you individually block incoming Trust Lines, Check objects, NFToken offers, and Payment Channels.",impact:"Four new AccountSet flags; existing incoming objects are unaffected."},ExpandedSignerList:{purpose:"Larger multi-sig signer lists",intro:"rippled 1.9.1",desc:"Increases the maximum signers per SignerList from 8 to 32, enabling more complex institutional multi-sig and DAO governance.",impact:"Reserve cost scales with signer count. Requires MultiSignReserve to be cost-effective."},OwnerPaysFee:{purpose:"Correct fee payer in PayChan",intro:"rippled 0.33",desc:"Fixes a spec inconsistency where the channel owner correctly pays the transaction fee when closing or expiring channels.",impact:"Purely a fee-accounting fix; no user-visible behavior changes."},fixMasterKeyAsRegularKey:{purpose:"Master-key mis-use bug fix",intro:"rippled 0.90",desc:"Prevents accounts from setting their master key as their regular key \u2014 an operation that could create an unusable account state.",impact:"No application changes needed; existing accounts are not affected."},TrustSetAuth:{purpose:"Authorized trust lines",intro:"rippled 0.30",desc:"Issuers can require explicit authorization before anyone can hold their token \u2014 a prerequisite for regulatory-grade stablecoins.",impact:"New flow: issuer sends TrustSet with tfSetfAuth to approve each holder."}},cm=new Set(["xrpscan.com","xrpl.aesthetes.art","xrpkuwait.com","xrpgoat.com","xrp.vet","xrp.unic.ac.cy","xrp-validator.interledger.org","xpmarket.com","verum.eminence.im","validator.xrpl.robertswarthout.com","validator.xrpl-labs.com","validator.poli.usp.br","validator.gatehub.net","validator.aspired.nz","v2.xrpl-commons.org","tequ.dev","squidrouter.com","ripple.ittc.ku.edu","ripple.com","peersyst.cloud","onxrp.com","katczynski.net","jon-nilsen.no","ekiserrepe.es","cabbit.tech","bithomp.com","aureusox.com","arrington-xrp-capital.blockdaemon.com","anodos.finance","bitso.com","ripple.kenan-flagler.unc.edu","ripplevalidator.uwaterloo.ca","shadow.haas.berkeley.edu","www.bitrue.com","xrp-col.anu.edu.au"]),ow=new Set(["nHBu3iuq1SQ9Z686pYwWYVKpScSMDWfpUJHdNEQRxn5XyETui7Db","nHDwBbubxJswoweWQKEgWLNRJv2hNRCTR4GGApJmbtCcbtYNSpdB","nHU2FpRbPrvVcyQQpkqrAUDJDTRHZpjij8DpKeSC481PYY9ikYkb","nHUbmg8QNzEGjHzgnt99e9YE2scU3DZGH7FsF6MCcK5eiPt3AtaH","nHUxBD1UPb383SdWgJx62GGQ7W2WKvgpUtUXLjiGGRRcPb3nbSXd","nHUP6rfQfgzg6tKga3k9ziEvtjwn1PB32gcr5dLcamqzmitszYv2","nHBT58yHyDdPdJ6gzaBMT7gqwTMpj5ERji1s9SvfKKtfoZUS89WX","nHBxsUzx3Bbf6J4yJ3fLQ3VizPtdREVwTJ6mdqkuDTjLcVbggVbk","nHUeUNSn3zce2xQZWNghQvd9WRH6FWEnCBKYVJu2vAizMxnXegfJ","nHUCAdca6VoWWYVdBH1bwCUQggEX2e5acQSqxM3DwyuhsFknxmh3","nHDDiwQBqXhEL1CFoRHdMXD33x9K7rpYJfniXxL7kFavpPd21EGe","nHBipbbREjNEiCs4hpy3K2489dRf27MPnxdivTTWKSd8ZUhfRvn8","nHDDe5uAdiv6RA59MA1oM4JLDtVSYKNShgjEqq1KsdJXZiR47CQT","nHBbiP5ua5dUqCTz5i5vd3ia9jg3KJthohDjgKxnc7LxtmnauW7Z","nHBQ3CT3EWYZ4uzbnL3k6TRf9bBPhWRFVcK1F5NjtwCBksMEt5yy","nHU16DF2kq7TmbR1Y5z8yKNXiLEf3oHT19HVpVXv7unFLfxa17nT","nHUC23NnutZyYeQxQbAbPUpKoVGj5aisBxf2zzcZzJ43fcw5rc9z","nHUgdMvuchx7AWG4ATMQdNNuMryo1SFoNptLCEVt2Dn7wEc625mF","nHUhQVE93dajM3srxubsEj1mK1gzRwJob14QSrJefY1FdLs6r7WJ","nHUU8xBczYzW6kZ6Ei9DsggzTJXRFkN3wE3FP5H4SLYzhbodeYcG","nHUGqooyfGqFkyH6uskbaEi6y2MjXjdA7QdbmyZ6p9etL5isRKLT","nHDp1ZXxEn7eo5YaUtiagaxSLwXudnKZDx68C96p4tdVLGLLLUFn","nHBcLEB4S6moQGrhMjJo1jbp58WL5psHY9EMDWNAtdqykUYiA1rF","nHUAECq1v1cKwn3NsYVyD7v6BNbfqyXmNVSF3e4XCVxPgBHRWkvv","nHUif4sukXu9pJGyyBaeVMwmE8L1fJ5KJj4X4ksgTKhgjG6k96s2","nHUVJR7SeT3nn6JPTz46JHqYRf7vX2if1sdTxnceywmSBWa167pt","nHUEYz4TtTv7yebjhY3aDib5KYPHnKjnY5mPYK5y4QuKdocwS5tD","nHUN5n2S3nQ8bzKm7bqeFMiQeDijh1LMgEocyNyQbb4mREazVdZ5","nHUgchANqM3giYSSvY5HsafFW6qxmG5jJ3CvPiv7n8gjNQuNm8Uz","nHDUqGoM7KR1pgbdYBRgKpGKdFLhpnMzVbECs8RE73RGZm3Va6MJ","nHUVxTi8XfXjaaJppw7mLSrYDRpkDpf8H9ypzgVKxfSXShcWwAoK","nHBveTxA1NaBj5AayRAU91f6YopuFWt9rmxfGaEh77a32Q6ZzzHc"]),iw=new Set(["validator.pftperry.com","rip973.com","preaware.org","postfiat.org","pftmeech.xyz","pft.xbtseal.com","pft.wizbubba.xyz","pft.permanentupperclass.com","pft.g.money","pft.akirax.xyz","jollydinger.com","auri0x.io","app.w.ai"]);function Sm(e,t){let n=(t||"").toLowerCase().replace(/^www\./,"");return ow.has(e)||iw.has(n)?{chain:"test",isUnl:!1}:cm.has(n)||cm.has("www."+n)?{chain:"main",isUnl:!0}:{chain:"main",isUnl:!1}}var Sr={"xrpscan.com":{label:"XRP Scan",domain:"xrpscan.com",chain:"main",category:"unl"},"xrpl.aesthetes.art":{label:"Aesthetes",domain:"xrpl.aesthetes.art",chain:"main",category:"unl"},"xrpkuwait.com":{label:"XRP Kuwait",domain:"xrpkuwait.com",chain:"main",category:"unl"},"xrpgoat.com":{label:"XRP Goat",domain:"xrpgoat.com",chain:"main",category:"unl"},"xrp.vet":{label:"XRP Vet",domain:"xrp.vet",chain:"main",category:"unl"},"xrp.unic.ac.cy":{label:"Univ. of Nicosia",domain:"xrp.unic.ac.cy",chain:"main",category:"unl"},"xrp-validator.interledger.org":{label:"Interledger",domain:"xrp-validator.interledger.org",chain:"main",category:"unl"},"xpmarket.com":{label:"XPMarket",domain:"xpmarket.com",chain:"main",category:"unl"},"verum.eminence.im":{label:"Eminence",domain:"verum.eminence.im",chain:"main",category:"unl"},"validator.xrpl.robertswarthout.com":{label:"R. Swarthout",domain:"validator.xrpl.robertswarthout.com",chain:"main",category:"unl"},"validator.xrpl-labs.com":{label:"XRPL Labs",domain:"validator.xrpl-labs.com",chain:"main",category:"unl"},"validator.poli.usp.br":{label:"USP",domain:"validator.poli.usp.br",chain:"main",category:"unl"},"validator.gatehub.net":{label:"Gatehub",domain:"validator.gatehub.net",chain:"main",category:"unl"},"validator.aspired.nz":{label:"Aspired NZ",domain:"validator.aspired.nz",chain:"main",category:"unl"},"v2.xrpl-commons.org":{label:"XRPL Commons",domain:"v2.xrpl-commons.org",chain:"main",category:"unl"},"tequ.dev":{label:"Tequ",domain:"tequ.dev",chain:"main",category:"unl"},"squidrouter.com":{label:"Squid Router",domain:"squidrouter.com",chain:"main",category:"unl"},"ripple.ittc.ku.edu":{label:"Univ. of Kansas",domain:"ripple.ittc.ku.edu",chain:"main",category:"unl"},"ripple.com":{label:"Ripple",domain:"ripple.com",chain:"main",category:"unl"},"peersyst.cloud":{label:"Peersyst",domain:"peersyst.cloud",chain:"main",category:"unl"},"onxrp.com":{label:"OnXRP",domain:"onxrp.com",chain:"main",category:"unl"},"katczynski.net":{label:"Katczynski",domain:"katczynski.net",chain:"main",category:"unl"},"jon-nilsen.no":{label:"Jon Nilsen",domain:"jon-nilsen.no",chain:"main",category:"unl"},"ekiserrepe.es":{label:"Ekiserrepe",domain:"ekiserrepe.es",chain:"main",category:"unl"},"cabbit.tech":{label:"Cabbit",domain:"cabbit.tech",chain:"main",category:"unl"},"bithomp.com":{label:"Bithomp",domain:"bithomp.com",chain:"main",category:"unl"},"aureusox.com":{label:"Aureus Ox",domain:"aureusox.com",chain:"main",category:"unl"},"arrington-xrp-capital.blockdaemon.com":{label:"Arrington / Blockdaemon",domain:"arrington-xrp-capital.blockdaemon.com",chain:"main",category:"unl"},"anodos.finance":{label:"Anodos Finance",domain:"anodos.finance",chain:"main",category:"unl"},"bitso.com":{label:"Bitso",domain:"bitso.com",chain:"main",category:"unl"},"ripple.kenan-flagler.unc.edu":{label:"UNC Kenan-Flagler",domain:"ripple.kenan-flagler.unc.edu",chain:"main",category:"unl"},"ripplevalidator.uwaterloo.ca":{label:"Univ. of Waterloo",domain:"ripplevalidator.uwaterloo.ca",chain:"main",category:"unl"},"shadow.haas.berkeley.edu":{label:"UC Berkeley Haas",domain:"shadow.haas.berkeley.edu",chain:"main",category:"unl"},"www.bitrue.com":{label:"Bitrue",domain:"www.bitrue.com",chain:"main",category:"unl"},"xrp-col.anu.edu.au":{label:"ANU",domain:"xrp-col.anu.edu.au",chain:"main",category:"unl"},"xrpval.rawsec.de":{label:"Rawsec",domain:"xrpval.rawsec.de",chain:"main",category:"other"},"xrplvl.carbonvibe.com":{label:"Carbon Vibe",domain:"xrplvl.carbonvibe.com",chain:"main",category:"other"},"xrplvalidator.alloy.ee":{label:"Alloy",domain:"xrplvalidator.alloy.ee",chain:"main",category:"other"},"xrpl.uni.lu":{label:"Univ. of Luxembourg",domain:"xrpl.uni.lu",chain:"main",category:"other"},"xrpl.to":{label:"XRPL.to",domain:"xrpl.to",chain:"main",category:"other"},"xrpl.su":{label:"XRPL.su",domain:"xrpl.su",chain:"main",category:"other"},"xrpl.sbivc.co.jp":{label:"SBI VC Trade",domain:"xrpl.sbivc.co.jp",chain:"main",category:"other"},"xrpl-verification.flare.network":{label:"Flare Network",domain:"xrpl-verification.flare.network",chain:"main",category:"other"},"xrpl-validator.7rev.dev":{label:"7Rev",domain:"xrpl-validator.7rev.dev",chain:"main",category:"other"},"xrp.teacopula.com":{label:"Teacopula",domain:"xrp.teacopula.com",chain:"main",category:"other"},"xrp.moneymindedapes.com":{label:"MoneyMindedApes",domain:"xrp.moneymindedapes.com",chain:"main",category:"other"},"xrp.hazza-systems.de":{label:"Hazza Systems",domain:"xrp.hazza-systems.de",chain:"main",category:"other"},"xrp.cs.uoregon.edu":{label:"Univ. of Oregon",domain:"xrp.cs.uoregon.edu",chain:"main",category:"other"},"xrp.bpsqn.com":{label:"BPSQN",domain:"xrp.bpsqn.com",chain:"main",category:"other"},"xrp-validator.grapedrop.xyz":{label:"Grapedrop",domain:"xrp-validator.grapedrop.xyz",chain:"main",category:"other"},"xaodao.io":{label:"XaoDAO",domain:"xaodao.io",chain:"main",category:"other"},"vl.xrpsalute.com":{label:"XRP Salute",domain:"vl.xrpsalute.com",chain:"main",category:"other"},"validator.xrpl.app":{label:"XRPL App",domain:"validator.xrpl.app",chain:"main",category:"other"},"validator.ukcbt.org":{label:"UKCBT",domain:"validator.ukcbt.org",chain:"main",category:"other"},"validator.sugarxrpl.com":{label:"SugarXRPL",domain:"validator.sugarxrpl.com",chain:"main",category:"other"},"validator.boscaern.digital":{label:"Boscaern",domain:"validator.boscaern.digital",chain:"main",category:"other"},"trimaera.tech":{label:"Trimaera",domain:"trimaera.tech",chain:"main",category:"other"},"textrp.io":{label:"TextRP",domain:"textrp.io",chain:"main",category:"other"},"tesbert.com":{label:"Tesbert",domain:"tesbert.com",chain:"main",category:"other"},"tachyon-xrpl-validator.github.io":{label:"Tachyon",domain:"tachyon-xrpl-validator.github.io",chain:"main",category:"other"},"solonation.io":{label:"SoloNation",domain:"solonation.io",chain:"main",category:"other"},"smokydrip.com":{label:"SmokyDrip",domain:"smokydrip.com",chain:"main",category:"other"},"rippled-validator.us":{label:"rippled-validator.us",domain:"rippled-validator.us",chain:"main",category:"other"},"rippleat.snt.uni.lu":{label:"Univ. Luxembourg (SNT)",domain:"rippleat.snt.uni.lu",chain:"main",category:"other"},"ripple.uni.lu":{label:"Univ. Luxembourg",domain:"ripple.uni.lu",chain:"main",category:"other"},"ripple.j2b.com":{label:"J2B",domain:"ripple.j2b.com",chain:"main",category:"other"},"rich-list.info":{label:"Rich List",domain:"rich-list.info",chain:"main",category:"other"},"proptoexchange.com":{label:"ProPtoExchange",domain:"proptoexchange.com",chain:"main",category:"other"},"printscierge.com":{label:"Printscierge",domain:"printscierge.com",chain:"main",category:"other"},"opulencex.io":{label:"OpulenceX",domain:"opulencex.io",chain:"main",category:"other"},"onledger.net":{label:"OnLedger",domain:"onledger.net",chain:"main",category:"other"},"oclost.art":{label:"Oclost",domain:"oclost.art",chain:"main",category:"other"},"managednetwork.us":{label:"ManagedNetwork",domain:"managednetwork.us",chain:"main",category:"other"},"joshuahamsa.com":{label:"Joshua Hamsa",domain:"joshuahamsa.com",chain:"main",category:"other"},"grimmsxrpflow.jwscott.net":{label:"Grimm XRP Flow",domain:"grimmsxrpflow.jwscott.net",chain:"main",category:"other"},"getlol.xyz":{label:"GetLol",domain:"getlol.xyz",chain:"main",category:"other"},"gen3labs.xyz":{label:"Gen3 Labs",domain:"gen3labs.xyz",chain:"main",category:"other"},"garveyvalid.com":{label:"Garvey",domain:"garveyvalid.com",chain:"main",category:"other"},"easynpl.kr":{label:"EasyNPL",domain:"easynpl.kr",chain:"main",category:"other"},"diseb.ewi.tudelft.nl":{label:"TU Delft",domain:"diseb.ewi.tudelft.nl",chain:"main",category:"other"},"datamossa.com":{label:"DataMossa",domain:"datamossa.com",chain:"main",category:"other"},"crypto.unibe.ch":{label:"Univ. of Bern",domain:"crypto.unibe.ch",chain:"main",category:"other"},"commonprefix.com":{label:"Common Prefix",domain:"commonprefix.com",chain:"main",category:"other"},"catalyze-research.com":{label:"Catalyze Research",domain:"catalyze-research.com",chain:"main",category:"other"},"catalog.org":{label:"Catalog",domain:"catalog.org",chain:"main",category:"other"},"blockchain.korea.ac.kr":{label:"Korea Univ.",domain:"blockchain.korea.ac.kr",chain:"main",category:"other"},"astatiumprotocol.com":{label:"Astatium Protocol",domain:"astatiumprotocol.com",chain:"main",category:"other"},"ladykxrpl.mywire.org":{label:"LadyK XRPL",domain:"LadyKXRPL.mywire.org",chain:"main",category:"other"},"eelap-p1201-xrp.abudhabi.nyu.edu":{label:"NYU Abu Dhabi",domain:"EELAP-P1201-XRP.ABUDHABI.NYU.EDU",chain:"main",category:"other"},"589.clouds.hspeed.ch":{label:"HSpeed",domain:"589.clouds.hspeed.ch",chain:"main",category:"other"},"validator.pftperry.com":{label:"PFT Perry",domain:"validator.pftperry.com",chain:"test",category:"other"},"rip973.com":{label:"rip973",domain:"rip973.com",chain:"test",category:"other"},"preaware.org":{label:"Preaware",domain:"preaware.org",chain:"test",category:"other"},"postfiat.org":{label:"PostFiat",domain:"postfiat.org",chain:"test",category:"other"},"pftmeech.xyz":{label:"PFT Meech",domain:"pftmeech.xyz",chain:"test",category:"other"},"pft.xbtseal.com":{label:"PFT XBT Seal",domain:"pft.xbtseal.com",chain:"test",category:"other"},"pft.wizbubba.xyz":{label:"PFT Wizbubba",domain:"pft.wizbubba.xyz",chain:"test",category:"other"},"pft.permanentupperclass.com":{label:"PFT Perm Upper Class",domain:"pft.permanentupperclass.com",chain:"test",category:"other"},"pft.g.money":{label:"PFT G.Money",domain:"pft.g.money",chain:"test",category:"other"},"pft.akirax.xyz":{label:"PFT Akirax",domain:"pft.akirax.xyz",chain:"test",category:"other"},"jollydinger.com":{label:"Jollydinger",domain:"jollydinger.com",chain:"test",category:"other"},"auri0x.io":{label:"Auri0x",domain:"auri0x.io",chain:"test",category:"other"},"app.w.ai":{label:"W.ai",domain:"app.w.ai",chain:"test",category:"other"}},vo={nHB8QMKGt9VB4Vg71VszjBVQnDW3v3QudM4436zXRZgiuUBBSWJe:{lat:37.77,lng:-122.42,city:"San Francisco",org:"Ripple"},nHUon2tpyJEHHYGmxqNd3h3oGNQwNyX8PNS3aHe3bNpCrNXZlHo:{lat:37.77,lng:-122.41,city:"San Francisco",org:"Ripple"},nHUpwrafS45zmi6eT72XS5ijpkW5JwfL5mLdPhEibrqUvtRcMAjU:{lat:37.78,lng:-122.4,city:"San Francisco",org:"Ripple"},nHUkp7WhouVMobBUKGrV5FNqjsdD9zKP5jpGnnLfQXCMNe4dkDqo:{lat:37.76,lng:-122.43,city:"San Francisco",org:"Ripple"},nHUryiyDqEtyWVtFG24AAhaYjMf9FRLietZGBWYwUTojmugMsx3o:{lat:37.79,lng:-122.38,city:"San Francisco",org:"Ripple"},nHUpcmNsxAw47yt2ADDoNoQrzLyTJPgnyq16u6Qx2kRPA17oUNHz:{lat:37.8,lng:-122.39,city:"San Francisco",org:"Ripple"},nHUnhRJK3csknycNK5SXRFi8jvDp3sKoWvS9wKWLq1ATBBGgPBjp:{lat:37.75,lng:-122.44,city:"San Francisco",org:"Ripple"},nHUq9tJvk5QTDkwurB7EzbzkZ2uuoHjS3GKjP6pZiU3DJGnobNYK:{lat:39.04,lng:-77.49,city:"Ashburn, VA",org:"AWS (Coil)"},nHUvcCcmoH1FJMMC6NtF9KKA4LpCWhjsxk2reCQidsp5AHQ7QY9H:{lat:49.45,lng:11.08,city:"Nuremberg",org:"Hetzner (Gatehub)"},nHDH7bQJpVfDhVSqdui3Z8GPvKEBQpo6AKHcnXe21zoD4nABA6xj:{lat:52.37,lng:4.9,city:"Amsterdam",org:"GCP (XRPL Labs)"},nHUED59jjpQ5QbNtesAbB6Es3uUPv3c9Ri5MNNgfMv5t5Lhb5ndW:{lat:19.43,lng:-99.13,city:"Mexico City",org:"AWS (Bitso)"},nHBidG3pZK11zqjeVos6hFxTDPGYuqfRFZ5gu9b7tQFdB8nPZujG:{lat:35.69,lng:139.69,city:"Tokyo",org:"NTT (Digital Garage)"},nHDB2PAPYqF86j9j3c6w1F1ZqwvQfiWcFShZ9Pokg9q4ohNDSkAz:{lat:47.61,lng:-122.33,city:"Seattle, WA",org:"Azure (Arrington)"},nHUdphn3LXa31w5sLd39MQdPEKQNrNYL3DQFByijVXiNQ3G6BYBZ:{lat:1.35,lng:103.82,city:"Singapore",org:"AWS (Tokenize)"},nHUFCyRCrUjvtZmKiLeF8ReopzKuSkVzdl1VsMCqm75aqyohLYEg:{lat:48.86,lng:2.35,city:"Paris",org:"OVH (XRPL Commons)"},nHULqGBkJtWeNFjhTzYeAsHA3qKKS7HoBh8CV3BAGTGMZuepEhWC:{lat:40.71,lng:-74.01,city:"New York",org:"Equinix (Blockchain LLC)"},nHBdXSF6YHAHSZUk7rvox6jwbvvyqBnsWGcewBtq8x1XuH6KXKXr:{lat:37.79,lng:-122.4,city:"San Francisco",org:"Cloudflare (XRP Scan)"}},dm={"xrpscan.com":{lat:51.51,lng:-.13,city:"London",org:"XRPScan"},"xrpl.aesthetes.art":{lat:52.37,lng:4.9,city:"Amsterdam",org:"Aesthetes"},"xrpkuwait.com":{lat:29.37,lng:47.98,city:"Kuwait City",org:"XRP Kuwait"},"xrpgoat.com":{lat:39.04,lng:-77.49,city:"Ashburn, VA",org:"XRP Goat"},"xrp.vet":{lat:48.86,lng:2.35,city:"Paris",org:"XRP Vet"},"xrp.unic.ac.cy":{lat:35.17,lng:33.37,city:"Nicosia",org:"Univ. of Nicosia"},"xrp-validator.interledger.org":{lat:40.71,lng:-74.01,city:"New York",org:"Interledger Foundation"},"xpmarket.com":{lat:52.37,lng:4.9,city:"Amsterdam",org:"XPMarket"},"verum.eminence.im":{lat:51.51,lng:-.13,city:"London",org:"Eminence"},"validator.xrpl.robertswarthout.com":{lat:52.37,lng:4.9,city:"Amsterdam",org:"R. Swarthout"},"validator.xrpl-labs.com":{lat:52.37,lng:4.9,city:"Amsterdam",org:"XRPL Labs"},"validator.xrpl.app":{lat:52.37,lng:4.9,city:"Amsterdam",org:"XRPL App"},"validator.poli.usp.br":{lat:-23.55,lng:-46.63,city:"S\xE3o Paulo",org:"USP"},"validator.gatehub.net":{lat:46.05,lng:14.51,city:"Ljubljana",org:"Gatehub"},"validator.aspired.nz":{lat:-36.86,lng:174.76,city:"Auckland",org:"Aspired NZ"},"v2.xrpl-commons.org":{lat:48.86,lng:2.35,city:"Paris",org:"XRPL Commons"},"tequ.dev":{lat:60.17,lng:24.94,city:"Helsinki",org:"Tequ"},"squidrouter.com":{lat:37.77,lng:-122.42,city:"San Francisco",org:"Squid Router"},"ripple.ittc.ku.edu":{lat:38.97,lng:-95.24,city:"Lawrence, KS",org:"Univ. of Kansas"},"ripple.com":{lat:37.77,lng:-122.42,city:"San Francisco",org:"Ripple"},"peersyst.cloud":{lat:41.39,lng:2.15,city:"Barcelona",org:"Peersyst"},"onxrp.com":{lat:51.51,lng:-.13,city:"London",org:"OnXRP"},"katczynski.net":{lat:52.23,lng:21.01,city:"Warsaw",org:"Katczynski"},"jon-nilsen.no":{lat:59.91,lng:10.75,city:"Oslo",org:"Jon Nilsen"},"ekiserrepe.es":{lat:40.42,lng:-3.7,city:"Madrid",org:"Ekiserrepe"},"cabbit.tech":{lat:51.51,lng:-.13,city:"London",org:"Cabbit"},"bithomp.com":{lat:59.33,lng:18.07,city:"Stockholm",org:"Bithomp"},"aureusox.com":{lat:40.71,lng:-74.01,city:"New York",org:"Aureus Ox"},"arrington-xrp-capital.blockdaemon.com":{lat:40.71,lng:-74.01,city:"New York",org:"Blockdaemon"},"anodos.finance":{lat:37.98,lng:23.73,city:"Athens",org:"Anodos Finance"},"bitso.com":{lat:19.43,lng:-99.13,city:"Mexico City",org:"Bitso"},"ripple.kenan-flagler.unc.edu":{lat:35.9,lng:-79.05,city:"Chapel Hill, NC",org:"UNC Kenan-Flagler"},"ripplevalidator.uwaterloo.ca":{lat:43.47,lng:-80.54,city:"Waterloo, ON",org:"Univ. of Waterloo"},"shadow.haas.berkeley.edu":{lat:37.87,lng:-122.26,city:"Berkeley, CA",org:"UC Berkeley Haas"},"www.bitrue.com":{lat:1.35,lng:103.82,city:"Singapore",org:"Bitrue"},"xrp-col.anu.edu.au":{lat:-35.28,lng:149.13,city:"Canberra",org:"ANU"},"xrpval.rawsec.de":{lat:51.17,lng:10.45,city:"Germany",org:"Rawsec"},"xrplvl.carbonvibe.com":{lat:51.51,lng:-.13,city:"London",org:"Carbon Vibe"},"xrplvalidator.alloy.ee":{lat:59.44,lng:24.75,city:"Tallinn",org:"Alloy"},"xrpl.uni.lu":{lat:49.61,lng:6.13,city:"Luxembourg",org:"Univ. of Luxembourg"},"xrpl.to":{lat:48.86,lng:2.35,city:"Paris",org:"XRPL.to"},"xrpl.su":{lat:55.75,lng:37.62,city:"Moscow",org:"XRPL.su"},"xrpl.sbivc.co.jp":{lat:35.69,lng:139.69,city:"Tokyo",org:"SBI VC Trade"},"xrpl-verification.flare.network":{lat:51.51,lng:-.13,city:"London",org:"Flare Network"},"xrpl-validator.7rev.dev":{lat:52.52,lng:13.4,city:"Berlin",org:"7Rev"},"xrp.teacopula.com":{lat:39.04,lng:-77.49,city:"Ashburn, VA",org:"Teacopula"},"xrp.moneymindedapes.com":{lat:39.04,lng:-77.49,city:"Ashburn, VA",org:"MoneyMindedApes"},"xrp.hazza-systems.de":{lat:52.52,lng:13.4,city:"Berlin",org:"Hazza Systems"},"xrp.cs.uoregon.edu":{lat:44.05,lng:-123.08,city:"Eugene, OR",org:"Univ. of Oregon"},"xrp.bpsqn.com":{lat:37.77,lng:-122.42,city:"San Francisco",org:"BPSQN"},"xrp-validator.grapedrop.xyz":{lat:52.37,lng:4.9,city:"Amsterdam",org:"Grapedrop"},"xaodao.io":{lat:1.35,lng:103.82,city:"Singapore",org:"XaoDAO"},"vl.xrpsalute.com":{lat:40.71,lng:-74.01,city:"New York",org:"XRP Salute"},"validator.ukcbt.org":{lat:51.51,lng:-.13,city:"London",org:"UKCBT"},"validator.sugarxrpl.com":{lat:37.77,lng:-122.42,city:"San Francisco",org:"SugarXRPL"},"validator.boscaern.digital":{lat:53.33,lng:-6.25,city:"Dublin",org:"Boscaern"},"trimaera.tech":{lat:48.86,lng:2.35,city:"Paris",org:"Trimaera"},"textrp.io":{lat:1.35,lng:103.82,city:"Singapore",org:"TextRP"},"tesbert.com":{lat:39.04,lng:-77.49,city:"Ashburn, VA",org:"Tesbert"},"tachyon-xrpl-validator.github.io":{lat:37.77,lng:-122.42,city:"San Francisco",org:"Tachyon"},"solonation.io":{lat:1.35,lng:103.82,city:"Singapore",org:"SoloNation"},"smokydrip.com":{lat:39.04,lng:-77.49,city:"Ashburn, VA",org:"SmokyDrip"},"rippled-validator.us":{lat:39.04,lng:-77.49,city:"Ashburn, VA",org:"rippled-validator.us"},"rippleat.snt.uni.lu":{lat:49.61,lng:6.13,city:"Luxembourg",org:"Univ. of Luxembourg"},"ripple.uni.lu":{lat:49.61,lng:6.13,city:"Luxembourg",org:"Univ. of Luxembourg"},"ripple.j2b.com":{lat:37.77,lng:-122.42,city:"San Francisco",org:"J2B"},"rich-list.info":{lat:51.51,lng:-.13,city:"London",org:"Rich List"},"proptoexchange.com":{lat:39.04,lng:-77.49,city:"Ashburn, VA",org:"ProPtoExchange"},"printscierge.com":{lat:39.04,lng:-77.49,city:"Ashburn, VA",org:"Printscierge"},"opulencex.io":{lat:1.35,lng:103.82,city:"Singapore",org:"OpulenceX"},"onledger.net":{lat:52.37,lng:4.9,city:"Amsterdam",org:"OnLedger"},"oclost.art":{lat:48.86,lng:2.35,city:"Paris",org:"Oclost"},"managednetwork.us":{lat:39.04,lng:-77.49,city:"Ashburn, VA",org:"ManagedNetwork"},"joshuahamsa.com":{lat:37.77,lng:-122.42,city:"San Francisco",org:"Joshua Hamsa"},"grimmsxrpflow.jwscott.net":{lat:39.04,lng:-77.49,city:"Ashburn, VA",org:"Grimm XRP Flow"},"getlol.xyz":{lat:39.04,lng:-77.49,city:"Ashburn, VA",org:"GetLol"},"gen3labs.xyz":{lat:37.77,lng:-122.42,city:"San Francisco",org:"Gen3 Labs"},"garveyvalid.com":{lat:40.71,lng:-74.01,city:"New York",org:"Garvey"},"easynpl.kr":{lat:37.57,lng:126.98,city:"Seoul",org:"EasyNPL"},"diseb.ewi.tudelft.nl":{lat:52,lng:4.36,city:"Delft",org:"TU Delft"},"datamossa.com":{lat:48.86,lng:2.35,city:"Paris",org:"DataMossa"},"crypto.unibe.ch":{lat:46.95,lng:7.45,city:"Bern",org:"Univ. of Bern"},"commonprefix.com":{lat:37.98,lng:23.73,city:"Athens",org:"Common Prefix"},"catalyze-research.com":{lat:51.51,lng:-.13,city:"London",org:"Catalyze Research"},"catalog.org":{lat:37.77,lng:-122.42,city:"San Francisco",org:"Catalog"},"blockchain.korea.ac.kr":{lat:37.57,lng:126.98,city:"Seoul",org:"Korea Univ."},"astatiumprotocol.com":{lat:1.35,lng:103.82,city:"Singapore",org:"Astatium Protocol"},"ladykxrpl.mywire.org":{lat:39.04,lng:-77.49,city:"Ashburn, VA",org:"LadyK XRPL"},"eelap-p1201-xrp.abudhabi.nyu.edu":{lat:24.47,lng:54.37,city:"Abu Dhabi",org:"NYU Abu Dhabi"},"589.clouds.hspeed.ch":{lat:47.38,lng:8.54,city:"Zurich",org:"HSpeed"},"www.payonline.financial":{lat:55.75,lng:37.62,city:"Moscow",org:"PayOnline"}};function Tr(e){if(!e)return null;let t=e.toLowerCase().replace(/^www\./,"");return dm[t]??dm["www."+t]??null}var rw=[{lat:37.34,lng:-121.89,label:"s1.ripple.com",city:"San Jose, CA",org:"Ripple"},{lat:37.34,lng:-121.87,label:"s2.ripple.com",city:"San Jose, CA",org:"Ripple"},{lat:52.37,lng:4.91,label:"xrplcluster.com",city:"Amsterdam",org:"Cluster"},{lat:52.36,lng:4.89,label:"xrpl.ws",city:"Amsterdam",org:"Cluster"}],Oe={nunl:{hex:"#ff5555",glow:"rgba(255,85,85,.4)",label:"Negative UNL"},both:{hex:"#50fa7b",glow:"rgba(80,250,123,.4)",label:"UNL + dUNL"},unl:{hex:"#00fff0",glow:"rgba(0,255,240,.35)",label:"UNL"},dunl:{hex:"#bd93f9",glow:"rgba(189,147,249,.4)",label:"dUNL only"},other:{hex:"#ffb86c",glow:"rgba(255,184,108,.4)",label:"Other"},pub:{hex:"#50fa7b",glow:"rgba(80,250,123,.4)",label:"Public Node"}},br="https://api.xrpscan.com/api/v1/validatorregistry",ke=new Map,kn={},go=0,Gn=!1,$n="fallback";function Tm(){if(!Gn){ke.clear();for(let[e,t]of Object.entries(Sr)){let n=t.domain??e,s=Sm("",n),a=Tr(n)??null;ke.set(e,{key:e,label:t.label,domain:n,domainVerified:!1,provider:t.provider??(a==null?void 0:a.org)??null,lists:t.lists??[],category:s.isUnl?"unl":"other",chain:s.chain,unl:s.isUnl,dunl:!1,geo:a,meta:{},agreement:{"1h":null,"24h":null,"30d":null}})}$n="fallback",Cr({ok:!1,source:"fallback",error:"using hardcoded data \u2014 mount /api/v1 router"})}}var vr=0,lw=5*60*1e3;function pm(e,t){var s,a;let n=Array.isArray(e)?e:e.validators??e.data??[];if(!n.length)throw new Error("Empty validators array");ke.clear();for(let o of n){let i=o.key??o.validation_public_key??o.master_key??o.signing_key??null;if(!i)continue;let r=o.domain??null,l=r?r.toLowerCase().replace(/^www\./,""):null,c=o.unl===!0||o.unl===1||o.unl==="true",d=Sm(i,l),u=c||d.isUnl,p=d.chain,m=u?"unl":"other",f=Object.values(Sr).find(w=>w.domain&&w.domain.toLowerCase().replace(/^www\./,"")===l),g=(f==null?void 0:f.label)??o.label??o.account_name??o.name??l??null??`${i.slice(0,8)}\u2026${i.slice(-6)}`,b=vo[i]??Tr(l)??null,v=(((s=o.geo)==null?void 0:s.lat)!=null&&((a=o.geo)==null?void 0:a.lng)!=null?o.geo:null)??b;ke.set(i,{key:i,label:g,domain:r??null,domainVerified:!!(o.domainVerified??o.domain_verified),provider:o.provider??(v==null?void 0:v.org)??(f==null?void 0:f.provider)??null,lists:Array.isArray(o.lists)?o.lists:[],category:m,chain:p,unl:u,dunl:!1,geo:v,version:o.version??o.build_version??null,baseFee:o.base_fee_xrp??o.base_fee??null,ownerReserve:o.reserve_inc_xrp??o.owner_reserve??null,meta:o.meta??{},agreement:o.agreement??{"1h":ur(o.agreement_1h??o.agr_1h),"24h":ur(o.agreement_24h??o.agr_24h),"30d":ur(o.agreement_30d??o.agr_30d)}})}kn=e.lists??{},go=Date.now(),Gn=!0,$n=t,vr=0,Cr({ok:!0,count:ke.size,lists:kn,source:t})}function ur(e){if(!e)return null;let t=Number(e.total??e.ledgers??0),n=Number(e.missed??0),s=t-n,a=t>0?(s/t*100).toFixed(1):null;return{total:t,missed:n,hit:s,score:a?`${a}%`:null,scoreRaw:e.score??null}}async function ho(e=!1){let t=Date.now();if(!e&&Gn&&t-go<aw)return!0;if(!e&&!Gn&&t-vr<lw)return!1;let n=typeof ra=="string"&&ra.startsWith("/api/"),s=location.protocol==="file:"||location.hostname==="127.0.0.1"||location.hostname==="localhost";if(!(n&&s))try{let a=new AbortController,o=setTimeout(()=>a.abort(),lm),i=await fetch(ra,{signal:a.signal,headers:{Accept:"application/json"}});if(clearTimeout(o),!i.ok)throw new Error(`HTTP ${i.status}`);let r=await i.json();return pm(r,"proxy"),!0}catch(a){console.warn("[registry] tier 1 (proxy) failed:",a.message)}try{let a=new AbortController,o=setTimeout(()=>a.abort(),lm),i=await fetch(br,{signal:a.signal});if(clearTimeout(o),!i.ok)throw new Error(`HTTP ${i.status}`);let r=await i.text(),l=JSON.parse(r);return pm(l,"xrpscan"),!0}catch(a){console.warn("[registry] tier 2 (xrpscan direct) failed:",a.message),(a.message.includes("Failed to fetch")||a.message.includes("CORS"))&&console.warn("[registry] CORS blocked \u2014 mount the backend proxy route (see validatorregistry.js)")}return console.warn("[registry] all sources failed \u2014 showing",Object.keys(Sr).length,"hardcoded validators"),vr=Date.now(),Gn||Tm(),Cr({ok:!1,source:"fallback",error:"all sources failed \u2014 mount /api/v1 router"}),!1}window.debugRegistry=async function(){console.group("\u{1F50D} Registry debug"),console.log("Current source:",$n),console.log("Validators loaded:",ke.size),console.log("Registry ok:",Gn),console.log("Last fetch:",go?new Date(go).toLocaleTimeString():"never"),console.log(""),console.log("Testing proxy \u2192",ra);try{let e=await fetch(ra),t=await e.text();console.log("  Status:",e.status,"\u2014 body preview:",t.slice(0,300))}catch(e){console.warn("  Failed:",e.message)}console.log(""),console.log("Testing XRPScan direct \u2192",br);try{let e=await fetch(br),t=await e.text();console.log("  Status:",e.status,"\u2014 body preview:",t.slice(0,300))}catch(e){console.warn("  Failed:",e.message)}return console.groupEnd(),{source:$n,size:ke.size,ok:Gn}};function rt(e){return ke.get(e)??{key:e,label:`${e.slice(0,10)}\u2026${e.slice(-6)}`,domain:null,provider:null,lists:[],category:"other",geo:vo[e]??null,meta:{}}}function Sn(e){var n;if(!e)return null;if(((n=e.geo)==null?void 0:n.lat)!=null)return e.geo;let t=vo[e.key];return t||Tr(e.domain)}function Cm(){return[...ke.values()].filter(e=>(e.category==="unl"||e.category==="both")&&e.chain!=="test").map(e=>e.key)}function cw(){return[...ke.values()].filter(e=>(e.category==="dunl"||e.category==="both")&&e.chain!=="test").map(e=>e.key)}function dw(){return[...ke.values()].filter(e=>e.category==="other"&&e.chain!=="test").map(e=>e.key)}function pw(){return[...ke.values()].filter(e=>e.chain==="test").map(e=>e.key)}function Cr({ok:e,count:t,lists:n,source:s,error:a}){let o=x("m1-registry-badge");if(o)if(e){let i=[...ke.values()].filter(c=>c.category==="unl").length,r=[...ke.values()].filter(c=>c.chain==="test").length,l=t-r;o.textContent=`${l} mainnet \xB7 ${i} UNL \xB7 ${r} testnet \xB7 live`,o.className="registry-badge registry-badge--ok"}else o.textContent=s==="fallback"?`Fallback data \xB7 ${ke.size} known \xB7 ${a??"endpoint unreachable"}`:"Refreshing\u2026",o.className="registry-badge registry-badge--warn"}var bo=null,um=!1,mr=!1,mm=0,fm=0,hm=0,fr=0,Pm=!0,st=null,Vn=null,da=null,zt=null,je={},mo=null,yr={},nt=null,nn=[],fo=null,wr={},oa="unl",ft={fees:[],burnDrops:[],dexOffers:[],ammSwaps:[],newAccounts:[],converge:[],proposers:[],peerCounts:[],peerDiscon:[]};function Mm(){var t,n;if(um)return;um=!0,Ow(),Tm(),ho(!0),Dw(),Iw(),window.addEventListener("xrpl-connected",()=>{ia(),Ts()&&(la({force:!0}),ca({force:!1}))}),window.addEventListener("xrpl-disconnected",()=>{xr(),$r(null)}),window.addEventListener("xrpl-connection",s=>{var a;((a=s==null?void 0:s.detail)==null?void 0:a.state)==="connecting"&&(xr(),$r(null,"Switching networks\u2026"))}),window.addEventListener("xrpl-ledger",s=>{Nw(s.detail),Ts()&&Rw(s.detail)}),(t=x("btn-network-refresh"))==null||t.addEventListener("click",()=>{la({force:!0}),ho(!0),ca({force:!0})}),(n=document.querySelector('.dash-tab[data-tab="network"]'))==null||n.addEventListener("click",()=>{ia(),la({force:!0}),ho(!1),ca({force:!1})});let e=x("tab-network");e&&new MutationObserver(ia).observe(e,{attributes:!0,attributeFilter:["style","class"]}),document.addEventListener("visibilitychange",ia)}function Ts(){let e=x("tab-network"),t=e?e.style.display!=="none":!1;return Pm&&X.currentPage==="dashboard"&&X.currentTab==="network"&&t&&!document.hidden}function ia(){Ts()?uw():xr()}function Lm(e){Pm=!!e,ia()}function uw(){bo||(la({force:!1}),bo=setInterval(()=>{Ts()&&la({force:!1})},J0))}function xr(){clearInterval(bo),bo=null}async function la({force:e=!1}={}){var n;if(!Ts()&&!e)return;let t=Date.now();if(!(!e&&(t-mm<Y0||mr||t<fm))){mr=!0,mm=t,je={},gm(!0);try{await Promise.allSettled([ho(!1),mw(),fw(),hw(),gw(),bw()]),vw(),kw(),$w(),Sw(),Aw(),$r({info:st,fee:Vn,vals:da}),Bw()}catch(s){String((s==null?void 0:s.message)??"").toLowerCase().includes("too much load")&&(fm=Date.now()+Q0,(n=he)==null||n("Rate-limited \u2014 backing off 2 min."))}finally{gm(!1),mr=!1}}}function gm(e){var t;(t=x("btn-network-refresh"))==null||t.classList.toggle("spinning",e)}async function mw(){var n,s,a;let e=await Ee({command:"server_info"});if(st=((n=e==null?void 0:e.result)==null?void 0:n.info)??null,!st)return;it("converge",Number(((s=st.last_close)==null?void 0:s.converge_time_s)??0)),it("proposers",Number(((a=st.last_close)==null?void 0:a.proposers)??0)),it("peerCounts",Number(st.peers??0));let t=Number(st.peer_disconnects_resources??0);mo!==null&&t>mo&&it("peerDiscon",t-mo),mo=t}async function fw(){var t;let e=await Ee({command:"fee"});Vn=(e==null?void 0:e.result)??null,((t=Vn==null?void 0:Vn.drops)==null?void 0:t.open_ledger_fee)!=null&&it("fees",Number(Vn.drops.open_ledger_fee))}async function hw(){try{let e=await Ee({command:"validators"});da=(e==null?void 0:e.result)??null}catch{da=null}}async function gw(){var e;try{let t=await Ee({command:"peers"});zt=Array.isArray((e=t==null?void 0:t.result)==null?void 0:e.peers)?t.result.peers:null}catch{zt=null}}async function bw(){var e;try{let t=await Ee({command:"feature"});(e=t==null?void 0:t.result)!=null&&e.features&&(Tw(t.result.features),Em(t.result.features))}catch{}}function vw(){var P,C,R,O,D,I;let e=st,t=da,n=(t==null?void 0:t.trusted_validator_keys)??[],s=Cm(),a=cw(),o=n.length?n:s,i=a,r=Number((t==null?void 0:t.validation_quorum)??(e==null?void 0:e.validation_quorum)??0),l=o.length,c=l-r,d=l>0?r/l*100:0,u=o.filter(F=>ke.has(F)).length,p=l>0?Math.round(u/l*100):0,m=Number(((P=e==null?void 0:e.last_close)==null?void 0:P.converge_time_s)??0),f=Number(((C=e==null?void 0:e.last_close)==null?void 0:C.proposers)??0),g=r>0?Math.round(f/r*100):0,b=Array.isArray(e==null?void 0:e.negative_unl)?e.negative_unl:[],h=!!da;c>=0&&c<=3&&(je.quorumTight=!0),b.length>0&&(je.nUnlActive=!0),m>6&&(je.slowConverge=!0),f>0&&r>0&&f<r&&(je.lowProposers=!0),K("m1-active",h?l:"\u2014"),K("m1-quorum",r>0?r:"\u2014"),K("m1-margin",h?c>=0?c:`\u2212${Math.abs(c)}`:"\u2014"),K("m1-overlap",h?`${p}%`:"\u2014"),K("m1-known",h?`${u} / ${l} identified`:"\u2014 (validators cmd unavailable)"),K("m1-proposers",((R=e==null?void 0:e.last_close)==null?void 0:R.proposers)!=null?f:"\u2014"),K("m1-particip",r>0&&((O=e==null?void 0:e.last_close)==null?void 0:O.proposers)!=null?`${g}%`:"\u2014"),K("m1-converge",((D=e==null?void 0:e.last_close)==null?void 0:D.converge_time_s)!=null?`${m.toFixed(2)}s`:"\u2014"),K("m1-converge-avg",pa("converge")>0?`avg ${pa("converge").toFixed(2)}s`:"\u2014"),Ct("m1-qbar",d,d>90?"bar-danger":d>80?"bar-warn":"bar-ok"),Ct("m1-obar",p,p<40?"bar-danger":p<70?"bar-warn":"bar-ok"),Ct("m1-pbar",g,g<80?"bar-danger":g<95?"bar-warn":"bar-ok"),Ct("m1-cvgbar",Math.min(100,m/10*100),m>6?"bar-danger":m>4?"bar-warn":"bar-ok"),xw({active:l,quorum:r,margin:c,nUnl:b,valsAvail:h});let v=(I=t==null?void 0:t.publisher_lists)==null?void 0:I[0],w=(kn==null?void 0:kn.ripple)??(kn==null?void 0:kn.xrplf)??null,k=(v==null?void 0:v.uri)??(w==null?void 0:w.uri)??"\u2014",$=(v==null?void 0:v.seq)??(w==null?void 0:w.seq)??"\u2014";if(K("m1-vl-uri",k),K("m1-vl-seq",$),v!=null&&v.expiration||w!=null&&w.expiration){let F=x("m1-vl-expiry");if(F){let H=(v==null?void 0:v.expiration)??(w==null?void 0:w.expiration),E=Math.floor((new Date(H)-Date.now())/864e5);F.textContent=E>0?`Expires ${E}d`:"\u26A0 EXPIRED",F.className=`expiry-pill ${E>30?"pill-ok":E>7?"pill-warn":"pill-bad"}`,F.style.display=""}}let T=x("m1-nunl-list");if(K("m1-nunl-count",b.length||"0"),T)if(!b.length)T.innerHTML='<div class="nunl-empty">\u2713 No validators on Negative UNL</div>';else{let F={};T.innerHTML=b.map(E=>{let j=rt(E);return j.provider&&(F[j.provider]=(F[j.provider]||0)+1),`<div class="nunl-entry">
        ...
        </div>`}).join("");let H=Object.entries(F).sort((E,j)=>j[1]-E[1])[0];(H==null?void 0:H[1])>1&&(T.innerHTML+=`<div class="nunl-alert">\u26A0 ${H[1]} offline validators share <b>${y(H[0])}</b> \u2014 likely provider outage</div>`)}Am(o,i,r,b,h);let S=Number((st==null?void 0:st.peers)??0);K("wm-stat-val",h?`${l} validators`:`${ke.size} in registry`),K("wm-stat-nunl",`${b.length} on nUNL`),K("wm-stat-peers",`${zt?zt.length:S} peers`);let N=[...ke.keys()];Pw(o,i,b,zt,!h)}function Am(e,t,n,s,a){let o=x("m1-val-grid");if(!o)return;let i=new Set(e),r=new Set(t),l=new Set(s),c=Cm(),d=pw(),u=dw(),p=e.length?e:c,m=[...ke.keys()],f=m.filter(D=>{var I;return(((I=ke.get(D))==null?void 0:I.chain)??"main")==="main"}),g=d,b=u,h=p.filter(D=>!!rt(D).domain),v=p.filter(D=>!rt(D).domain),w=b.filter(D=>!!rt(D).domain),k=b.filter(D=>!rt(D).domain),$=m.filter(D=>!!Sn(rt(D))),T=[{id:"unl",label:"UNL",count:p.length,dot:"unl"},{id:"others",label:"Others",count:b.length,dot:"other"},{id:"all",label:"All",count:f.length,dot:null},{id:"test",label:"Testnet",count:g.length,dot:null}],S={unl:"#00fff0",dunl:"#bd93f9",both:"#50fa7b",nunl:"#ff5555",other:"#ffb86c"},N='<div class="vg-tabs" role="tablist">'+T.map(D=>`<button class="vg-tab ${oa===D.id?"vg-tab--active":""}" data-vgtab="${D.id}">
        ${D.dot?`<span class="vg-tab-dot" style="background:${S[D.dot]}"></span>`:""}
        ${y(D.label)}
        <span class="vg-tab-count">${D.count}</span>
      </button>`).join("")+"</div>",P=[],C="";if(oa==="unl"){let D=p.filter(E=>l.has(E)),I=h.filter(E=>!l.has(E)),F=v.filter(E=>!l.has(E));D.length&&P.push({title:`\u26A0 Negative UNL (${D.length})`,keys:D,cls:"vgs-warn"}),P.push({title:`Named UNL validators \xB7 ${I.length}`,keys:I}),F.length&&P.push({title:`Key-only UNL validators \xB7 ${F.length}`,keys:F,collapsed:!0}),p.length||P.push({title:"No UNL data",keys:[],notice:"Registry not loaded yet"});let H=a?"live rippled":`registry (${$n})`;C=`${p.length} trusted \xB7 quorum ${n} \xB7 ${s.length} on nUNL \xB7 source: ${H}`}else if(oa==="others")P.push({title:`Named mainnet (non-UNL) \xB7 ${w.length}`,keys:w}),k.length&&P.push({title:`Key-only mainnet \xB7 ${k.length}`,keys:k,collapsed:!0}),C=`${b.length} mainnet validators not on UNL \xB7 source: ${$n}`;else if(oa==="test"){let D=g.filter(F=>!!rt(F).domain),I=g.filter(F=>!rt(F).domain);D.length&&P.push({title:`Named testnet \xB7 ${D.length}`,keys:D}),I.length&&P.push({title:`Key-only testnet \xB7 ${I.length}`,keys:I,collapsed:!0}),C=`${g.length} testnet validators`}else P.push({title:`\u2B50 UNL \xB7 ${p.length}`,keys:p}),P.push({title:`Other mainnet \xB7 ${b.length}`,keys:b,collapsed:!0}),g.length&&P.push({title:`Testnet \xB7 ${g.length}`,keys:g,collapsed:!0}),C=`${f.length} mainnet \xB7 ${g.length} testnet \xB7 ${$.length} geo-located \xB7 source: ${$n}`;function R(D,I){var $e;let F=rt(D),H=l.has(D),E=i.has(D),j=r.has(D),se=F.chain==="test",re,pe,ae;H?(re="vp-nunl",pe="nUNL",ae=S.nunl):E&&j?(re="vp-both",pe="UNL+dUNL",ae=S.both):E?(re="vp-unl",pe="UNL",ae=S.unl):j?(re="vp-dunl",pe="dUNL",ae=S.dunl):(re="vp-other",pe="Other",ae=S.other);let te=Sn(F),de=!!te,le=te?`\u{1F4CD} ${te.city??""}`:"",Pe=F.domain?F.domain.replace(/^www\./,"").replace(/^validator\./,"").replace(/^xrp\./,""):null,B=`${D.slice(0,8)}\u2026${D.slice(-6)}`,U=E&&I!=null?`<span class="vg-num">${I+1}</span>`:"",J=($e=F.agreement)==null?void 0:$e["24h"],ue=J!=null&&J.score?`<span class="vg-agr" style="color:${parseFloat(J.score)>=99?"#50fa7b":parseFloat(J.score)>=95?"#ffb86c":"#ff5555"}" title="24h agreement">${J.score}</span>`:"";return`<div class="vpill ${re} ${de?"vp-locatable":""}"
    ...
    </div>`}let O="";P.forEach(D=>{if(!D.keys.length)return;let I=D.keys.some(j=>i.has(j)),F=D.keys.map((j,se)=>R(j,I?se:null)).join(""),H=`vgs-${Math.random().toString(36).slice(2,8)}`,E=!D.collapsed;O+=`
      ...
      </div>`}),O||(O='<div class="nunl-empty">No validators in this view.</div>'),o.innerHTML=N+O,K("m1-val-summary",C),o.querySelectorAll(".vg-tab").forEach(D=>{D.addEventListener("click",I=>{I.stopPropagation();let F=D.getAttribute("data-vgtab");F&&(oa=F,Am(e,t,n,s,a))})})}async function yw(e){let t=hr.get(e);if(t&&Date.now()-t.cachedAt<xm)return t.data;try{let n=new AbortController,s=setTimeout(()=>n.abort(),km),a=await fetch(`${wm}/${encodeURIComponent(e)}`,{signal:n.signal});if(clearTimeout(s),!a.ok)throw new Error(`HTTP ${a.status}`);let o=await a.json();return hr.set(e,{data:o,cachedAt:Date.now()}),o}catch{return null}}async function ww(e){let t=gr.get(e);if(t&&Date.now()-t.cachedAt<xm)return t.data;try{let n=new AbortController,s=setTimeout(()=>n.abort(),km),a=await fetch(`${wm}/${encodeURIComponent(e)}/reports`,{signal:n.signal});if(clearTimeout(s),!a.ok)throw new Error(`HTTP ${a.status}`);let o=await a.json(),i=o.reports??o??[];return gr.set(e,{data:i,cachedAt:Date.now()}),i}catch{return[]}}window.focusValidator=async function(e){let t=rt(e),n=Sn(t);document.querySelectorAll(".vpill").forEach(o=>o.classList.remove("vp-active"));let s=document.querySelector(`.vpill[data-key="${CSS.escape(e)}"]`);if(s&&(s.classList.add("vp-active"),s.scrollIntoView({behavior:"smooth",block:"nearest"})),kr(e,t,null),yw(e).then(o=>{o&&kr(e,t,o)}),!n){let o=x("world-map-container");if(o){let i=o.querySelector(".wm-no-geo");i&&i.remove();let r=document.createElement("div");r.className="wm-no-geo",r.textContent=`\u{1F4CD} ${t.label} \u2014 geographic location unknown`,o.appendChild(r),setTimeout(()=>r.remove(),3500)}return}let a=x("world-map-container");a&&a.scrollIntoView({behavior:"smooth",block:"nearest"}),nt&&(nt.flyTo([n.lat,n.lng],6,{duration:1.2}),setTimeout(()=>{let o=wr[e];o&&o.openPopup()},1300))};function kr(e,t,n){var P,C,R,O,D;let s=x("amend-modal-overlay"),a=x("amend-modal-body");if(!s||!a)return;let o=n??{},i=t.label??o.label??o.account_name??e.slice(0,16)+"\u2026",r=t.domain??o.domain??null,l=t.chain??o.chain??"main",c=t.category??"other",d=Oe[c]??Oe.other,u=Sn(t),p=t.unl||c==="unl"||c==="both",m=t.dunl||c==="dunl"||c==="both",f=t.domainVerified||o.domain_verified?"\u2713 Verified":r?"Unverified":"\u2014",g=t.agreement??o.agreement??{},b=!n&&!((P=t.agreement)!=null&&P["24h"]);function h(I,F){if(!F||!F.total)return`<div class="adm-mi"><span class="adm-mk">${I}</span><span class="adm-mv" style="opacity:.5">\u2014</span></div>`;let H=parseFloat(F.score)||0,E=H>=99?"color:#50fa7b":H>=95?"color:#ffb86c":"color:#ff5555";return`<div class="adm-mi">
    ...
    </div>`}function v(I,F,H=!1){return!F&&F!==0?"":`<div class="adm-mi"><span class="adm-mk">${I}</span><span class="adm-mv ${H?"mono":""}">${y(String(F))}</span></div>`}let w=gr.get(e),k=((C=w==null?void 0:w.data)==null?void 0:C.slice(-14))??[],$=k.length?`<div class="adm-section">
    ...
    </div>`,s.style.display="flex",s.addEventListener("click",I=>{I.target===s&&window.closeAmendModal()},{once:!0})}window._loadValidatorReports=async function(e){var n;let t=rt(e);await ww(e),kr(e,t,((n=hr.get(e))==null?void 0:n.data)??null)};function xw({active:e,quorum:t,margin:n,nUnl:s,valsAvail:a}){let o=x("m1-quorum-ring");if(!o)return;if(!a||!t||!e){o.innerHTML='<div style="opacity:.4;font-size:12px;text-align:center;padding:16px">Connect to view quorum</div>';return}let i=44,r=2*Math.PI*i,l=new Set(s),c=e-s.length,d=s.length,u=Math.max(0,e-t),p=t,m=n<=0?"#ff5555":n<=3?"#ffb86c":"#50fa7b",f=e>0?c/e:0,g=e>0?d/e:0,b=e>0?t/e:0,h=e>0?Math.max(0,n)/e:0,v=e>0?d/e:0;function w(k,$,T,S=8){if($<=0)return"";let N=k*r,P=$*r;return`<circle r="${i}" cx="50" cy="50" fill="none"
    ...
    <div class="qr-wrap">
    ...
    </div>`}function kw(){var F,H,E;let e=st,t=(e==null?void 0:e.server_state)??"unknown",n=(e==null?void 0:e.build_version)??"\u2014",s=Number((e==null?void 0:e.uptime)??0),a=e==null?void 0:e.network_id,o=Number((e==null?void 0:e.io_latency_ms)??0),i=String((e==null?void 0:e.jq_trans_overflow)??"0"),r=Number((e==null?void 0:e.peer_disconnects_resources)??0),l=Number((e==null?void 0:e.load_factor)??1),c=Number((e==null?void 0:e.load_factor_net)??1),d=Number((e==null?void 0:e.load_factor_server)??(e==null?void 0:e.load_factor_local)??1),u=Number(((F=e==null?void 0:e.validated_ledger)==null?void 0:F.age)??0),p=(H=e==null?void 0:e.validated_ledger)==null?void 0:H.seq,m=(e==null?void 0:e.complete_ledgers)??"",f=(e==null?void 0:e.state_accounting)??null;u>10&&(je.staleLedger=!0),o>5&&(je.ioStressed=!0),pa("peerDiscon")>5&&(je.peerChurn=!0);let g=x("m2-state");if(g){g.textContent=t;let j=["full","proposing","validating"].includes(t),se=["syncing","tracking","connected"].includes(t);g.className=`state-pill state-${j?"ok":se?"warn":"bad"}`}K("m2-version",n),K("m2-uptime",Hw(s)),K("m2-netid",a===0?"0 (Mainnet)":a===1?"1 (Testnet)":a??"\u2014"),K("m2-ledger-seq",p!=null?Number(p).toLocaleString():"\u2014"),K("m2-ledger-age",u>0?`${u}s`:"< 1s"),K("m2-io-ms",o>0?`${o}ms`:"< 1ms"),K("m2-jq",i==="0"?"0 (clean)":`\u26A0 ${i}`),K("m2-discon",r.toLocaleString());let b=x("m2-ledger-age");b&&(b.className=`kv-v ${u>10?"text-danger":u>5?"text-warn":""}`);let h=Math.min(100,(l-1)/49*100);Ct("m2-load-bar",h,l>5?"bar-danger":l>2?"bar-warn":"bar-ok"),K("m2-load-total",`${l.toFixed(2)}\xD7`),K("m2-load-net",`${c.toFixed(2)}\xD7`),K("m2-load-local",`${d.toFixed(2)}\xD7`);let v=d>c*1.5?"Local node stressed":c>d*1.5?"Network-wide stress":l>1.2?"Distributed":"Normal";K("m2-load-src",v);let w=X.tpsHistory.length?X.tpsHistory[X.tpsHistory.length-1]:null;K("m2-tps",w!=null?w.toFixed(1):"\u2014"),K("m2-txcount",((E=X.ledgerLog[0])==null?void 0:E.txCount)??"\u2014");let k=m==="entire ledger"||m.startsWith("32570"),$=k?100:Xw(m);if(K("m2-ledger-range",m||"\u2014"),K("m2-hist-type",k?"Full History Node":"Pruned / Partial"),K("m2-hist-score",`${$}%`),Ct("m2-hist-bar",$,$<30?"bar-danger":$<70?"bar-warn":"bar-ok"),f){let j=x("m2-state-acct");if(j){let se=["full","syncing","tracking","connected","disconnected"],re=0,pe={};se.forEach(ae=>{var te;pe[ae]=Number(((te=f[ae])==null?void 0:te.duration_us)??0),re+=pe[ae]}),j.innerHTML=re>0?se.map(ae=>{let te=Math.round(pe[ae]/re*100);return te?`<div class="sa-row"><span class="sa-lbl">${ae}</span>
          <div class="bar-track sa-bar"><div class="bar-fill ${ae==="full"?"bar-ok":ae==="syncing"?"bar-warn":"bar-danger"}" style="width:${te}%"></div></div>
          <span class="sa-pct">${te}%</span></div>`:""}).join(""):'<span class="dim">No data</span>'}}let T=(e==null?void 0:e.peers)!=null?Number(e.peers):null,S=T!=null,N=0,P=0,C=!1;zt&&(zt.forEach(j=>{j.inbound===!0?N++:P++}),C=!0);let R=C&&N+P>0?Math.round(N/(N+P)*100):0,O=C?zt.length:T??0,D=O<6?"HIGH":O<15?"MEDIUM":"LOW";O<6&&(je.eclipseRisk=!0),R>80&&(je.peerSaturate=!0),K("m2-peers",S?O:"\u2014"),K("m2-inbound",C?N:S?"\u2014 (cmd restricted)":"\u2014"),K("m2-outbound",C?P:S?"\u2014 (cmd restricted)":"\u2014"),K("m2-ib-pct",C?`${R}%`:"\u2014"),Ct("m2-peer-bar",Math.min(100,O/21*100),O>18?"bar-danger":O>15?"bar-warn":"bar-ok"),Ct("m2-ib-bar",R,R>80?"bar-danger":R>60?"bar-warn":"bar-ok");let I=x("m2-eclipse");I&&(I.textContent=D,I.className=`risk-badge risk-${D.toLowerCase()}`)}function $w(){var P,C,R,O;let e=Vn,t=Number(((P=e==null?void 0:e.drops)==null?void 0:P.minimum_fee)??10),n=Number(((C=e==null?void 0:e.drops)==null?void 0:C.open_ledger_fee)??10),s=Number(((R=e==null?void 0:e.drops)==null?void 0:R.median_fee)??10),a=Number(((O=e==null?void 0:e.drops)==null?void 0:O.base_fee)??10),o=Number((e==null?void 0:e.current_ledger_size)??0),i=Number((e==null?void 0:e.expected_ledger_size)??1),r=Number((e==null?void 0:e.current_queue_size)??0),l=Number((e==null?void 0:e.max_queue_size)??1),c=l>0?Math.round(r/l*100):0,d=i>0?o/i:1,u=pa("fees"),p=u>0?Math.round((n-u)/u*100):0,m=Math.min(100,Math.round(Math.log2(Math.max(1,n/10))*14));n>t*10&&(je.feeSpike=!0),c>80&&(je.queuePressure=!0),d>2&&(je.spamLedger=!0);let f=ft.burnDrops.slice(-10),g=f.length?f.reduce((D,I)=>D+I,0)/f.length:0,b=Fw(ft.burnDrops),h=pa("burnDrops"),v=b>0&&ft.burnDrops.length>5?((g-h)/b).toFixed(2):"0.00",w=Math.min(100,Math.abs(Number(v))*20);Math.abs(Number(v))>3&&(je.burnAnomaly=!0);let k=n>5e3?"Severe":n>500?"High":n>100?"Elevated":n>20?"Normal":"Minimal",T={Severe:"#ff5555",High:"#ff9955",Elevated:"#ffb86c",Normal:"#50fa7b",Minimal:"#6272a4"}[k]??"#50fa7b",S=x("m3-pressure");S&&(S.textContent=k,S.className=`pressure-badge p-${k.toLowerCase()}`),K("m3-open",`${n} drops`),K("m3-med",`${s} drops`),K("m3-base",`${a} drops`),K("m3-devpct",`${p>0?"+":""}${p}% vs baseline`),K("m3-spam",`${m} / 100`),K("m3-qsize",`${r} / ${l}`),K("m3-qpct",`${c}%`),K("m3-szratio",`${d.toFixed(2)}\xD7`),K("m3-curledger",`${o} txs`),K("m3-expledger",`${i} expected`),K("m3-burn",g>0?`${(g/1e6).toFixed(4)} XRP / ledger`:"\u2014"),K("m3-burnz",`z = ${v}`),Ct("m3-spam-bar",m,m>70?"bar-danger":m>40?"bar-warn":"bar-ok"),Ct("m3-q-bar",c,c>80?"bar-danger":c>50?"bar-warn":"bar-ok"),Ct("m3-sz-bar",Math.min(100,d*50),d>2?"bar-danger":d>1.5?"bar-warn":"bar-ok"),Ct("m3-burn-bar",w,w>60?"bar-danger":w>30?"bar-warn":"bar-ok");let N=x("m3-congestion-summary");if(N){let D=[];d>2&&D.push({icon:"\u{1F6A8}",txt:`Ledger ${d.toFixed(1)}\xD7 normal size \u2014 possible spam burst`,col:"#ff5555"}),c>80&&D.push({icon:"\u26A0",txt:`TX queue ${c}% full \u2014 fee surge imminent`,col:"#ffb86c"}),m>70&&D.push({icon:"\u26A0",txt:`Spam index ${m}/100 \u2014 elevated DDoS risk`,col:"#ffb86c"}),Math.abs(Number(v))>3&&D.push({icon:"\u{1F4C9}",txt:`Burn rate z=${v} \u2014 resource exhaustion pattern`,col:"#ff9955"}),p>200&&D.push({icon:"\u{1F4B8}",txt:`Open fee ${p}% above baseline \u2014 network stress`,col:"#ffb86c"}),N.innerHTML=D.length?D.map(I=>`<div class="cong-line"><span>${I.icon}</span><span style="color:${I.col}">${y(I.txt)}</span></div>`).join(""):'<div class="cong-clear"><span style="color:#50fa7b">\u2713</span> No congestion signals \u2014 network traffic is normal</div>'}}function Sw(){var u,p;let e={},t=0;for(let m of ke.values()){if(m.chain==="test")continue;let f=m.version??"unknown";e[f]=(e[f]??0)+1,t++}let n={},s=0;if(Array.isArray(zt))for(let m of zt){let f=(m.version??"unknown").replace(/rippled-/i,"").split(" ")[0];n[f]=(n[f]??0)+1,s++}let a=x("m4-version-dist");if(a&&t>0){let m=Object.entries(e).sort((h,v)=>v[1]-h[1]),f=((u=m[0])==null?void 0:u[0])??"?",g=t>0?Math.round((((p=m[0])==null?void 0:p[1])??0)/t*100):0,b=["#00fff0","#50fa7b","#ffb86c","#bd93f9","#ff5555","#8be9fd"];a.innerHTML=m.slice(0,6).map(([h,v],w)=>{let k=Math.round(v/t*100),$=b[w%b.length],T=h.includes("beta")||h.includes("rc")||h.includes("RC");return`<div class="vd-row">
      ...
      ${l.length?`<div class="ap-near-bar">\u{1F4C8} ${l.length} amendment${l.length>1?"s":""} approaching 80% threshold</div>`:""}`,n.querySelectorAll(".ap-tab").forEach(u=>{u.onclick=()=>{$s=u.dataset.aptab,Em(e)}})}let c=$s==="active"?a:$s==="vetoed"?i:$s==="all"?s.sort((d,u)=>d.enabled!==u.enabled?d.enabled?1:-1:d.vetoed!==u.vetoed?d.vetoed?1:-1:(u.count??0)-(d.count??0)):o;if(!c.length){t.innerHTML=`<div class="amend-empty">${$s==="vetoed"?"No vetoed amendments":"No data"}</div>`;return}t.innerHTML=c.map(d=>{var S;let u=d.count??0,p=d.threshold??28,m=Math.min(100,Math.round(u/p*100)),f=d.name??`${d.hash.slice(0,10)}...`,g=!!d.enabled,b=!!d.vetoed,h=!!d.majority,v=$m[f]??{},w=(S=ft.amendMomentum)==null?void 0:S[d.hash],k="";if(h&&!g&&d.majority){let N=Date.now()-new Date(d.majority).getTime(),P=N>0?Math.floor(N/864e5):0,C=Math.max(0,14-P),R=Math.min(100,Math.round(P/14*100));k=`<div class="ap-countdown">
    ...
    </div>`}).join("")}function Tw(e){yr={},Object.entries(e).forEach(([t,n])=>{yr[t]={hash:t,...n}})}window.showAmendDetail=function(e){let t=yr[e];if(!t)return;let n=t.name||`${e.slice(0,16)}...`,s=$m[n]||{},a=t.count??0,o=t.threshold??28,i=Math.min(100,Math.round(a/o*100)),r=t.enabled?"Active on Ledger":t.vetoed?"Vetoed":t.majority?"Majority Reached":"Voting in Progress",l=t.enabled?"adm-s-ok":t.vetoed?"adm-s-bad":t.majority?"adm-s-warn":"adm-s-info",c=t.enabled?"bar-ok":t.vetoed?"bar-danger":t.majority?"bar-warn":"bar-info",d=t.majority&&!t.enabled?`
    ...
    <div class="adm-footer">
      ...
      <a class="adm-link" href="https://xrpl.org/consensus.html" target="_blank" rel="noopener noreferrer">Consensus Docs</a>
    </div>`,u.style.display="flex",u.addEventListener("click",m=>{m.target===u&&window.closeAmendModal()},{once:!0}))};window.closeAmendModal=function(){let e=x("amend-modal-overlay");e&&(e.style.display="none")};function Cw(e){if(window.L){e();return}if(!document.querySelector("#leaflet-css")){let n=document.createElement("link");n.id="leaflet-css",n.rel="stylesheet",n.href="https://cdnjs.cloudflare.com/ajax/libs/leaflet/1.9.4/leaflet.min.css",document.head.appendChild(n)}let t=document.createElement("script");t.src="https://cdnjs.cloudflare.com/ajax/libs/leaflet/1.9.4/leaflet.min.js",t.onload=e,document.head.appendChild(t)}function Pw(e,t,n,s,a=!1){x("world-map-container")&&Cw(()=>Mw(e,t,n,s,a))}function Mw(e,t,n,s,a=!1){let o=x("world-map-container");if(!o)return;let i=new Set(n||[]),r=new Set(e||[]),l=new Set(t||[]),c=X.currentNetwork||"xrpl-mainnet";if(nt&&fo!==c&&(nt.remove(),nt=null,nn=[],fo=null),!nt){o.innerHTML="";let k=document.createElement("div");k.id="wm-leaflet",k.style.cssText="width:100%;height:440px;",o.appendChild(k),nt=L.map("wm-leaflet",{center:[25,5],zoom:2,minZoom:1,maxZoom:12,zoomControl:!0,attributionControl:!0,worldCopyJump:!0}),L.tileLayer("https://{s}.basemaps.cartocdn.com/dark_all/{z}/{x}/{y}{r}.png",{attribution:'&copy; <a href="https://carto.com">CARTO</a> &copy; <a href="https://openstreetmap.org">OSM</a>',subdomains:"abcd",maxZoom:19}).addTo(nt),fo=c}nn.forEach(k=>{try{k.remove()}catch{}}),nn=[];function d(k){return i.has(k)?"nunl":r.has(k)&&l.has(k)?"both":r.has(k)?"unl":l.has(k)?"dunl":"other"}wr={};let u={};for(let[k,$]of ke){let T=Sn($);if(!(T!=null&&T.lat)||!(T!=null&&T.lng))continue;let S=`${(Math.round(T.lat*2)/2).toFixed(1)},${(Math.round(T.lng*2)/2).toFixed(1)}`;u[S]||(u[S]={lat:T.lat,lng:T.lng,keys:[],city:T.city,org:T.org}),u[S].keys.push(k)}if(Object.values(u).forEach(k=>{let $=k.keys.length,T=k.keys.map(d),S=["nunl","both","unl","dunl","other"].find(O=>T.includes(O))||"other",N=Oe[S],P=$>5?13:$>2?10:7,C=L.divIcon({html:`<div class="wm-lmarker wm-lmarker-val ${S==="nunl"?"wm-lmarker-nunl":""} ${a?"wm-lmarker-ref":""}"
                  style="--mc:${N.hex};--mg:${N.glow};"
                  title="${k.keys.map(O=>rt(O).label).join(", ")}">
        <div class="wm-lring"></div>
        <div class="wm-ldot" style="width:${P*2}px;height:${P*2}px;">${$>1?`<span>${$}</span>`:""}</div>
      </div>`,className:"",iconSize:[(P+8)*2,(P+8)*2],iconAnchor:[P+8,P+8]}),R=L.marker([k.lat,k.lng],{icon:C}).bindPopup(Lw(k.keys,k.city,k.org,i,r,l,a),{maxWidth:380,className:"wm-popup-wrap"}).addTo(nt);k.keys.forEach(O=>{wr[O]=R}),nn.push(R)}),a){let k=L.control({position:"bottomleft"});k.onAdd=()=>{let $=L.DomUtil.create("div","wm-ref-banner");return $.innerHTML="\u{1F4E1} Reference positions \xB7 live validator list unavailable from endpoint",$},k.addTo(nt),nn.push(k)}let p=[...ke.keys()].filter(k=>{var T;return((T=ke.get(k).geo)==null?void 0:T.lat)!=null||vo[k]}).length,m=ke.size-p;if(m>0){let k=L.control({position:"bottomright"});k.onAdd=()=>{let $=L.DomUtil.create("div","wm-unknown-ctrl");return $.innerHTML=`+ ${m} validators \xB7 location unknown`,$},k.addTo(nt),nn.push(k)}rw.forEach(k=>{let $=L.divIcon({html:`<div class="wm-lmarker wm-lmarker-pub">
        <div class="wm-lring"></div>
        ...
        </div>`,{maxWidth:260,className:"wm-popup-wrap"}).addTo(nt);nn.push(T)});let f=Array.isArray(s)?s:[],g=f.filter(k=>k.inbound===!0).length,b=f.length-g,h=f.length>0?`${f.length} peers (${g}\u2193 ${b}\u2191)`:`${Number((st==null?void 0:st.peers)??0)} peers`,v=L.control({position:"topleft"});v.onAdd=()=>{let k=L.DomUtil.create("div","wm-legend-ctrl");return k.innerHTML=`
      ...
      <div class="wm-leg-src" style="opacity:.55;font-size:10px;margin-top:4px;">
        Registry: ${$n==="live"?"\u{1F7E2} live":"\u{1F7E1} fallback"}
      </div>`,k},v.addTo(nt),nn.push(v);let w=nn.filter(k=>k&&typeof k.getLatLng=="function");if(w.length>=2)try{let k=L.latLngBounds(w.map($=>$.getLatLng()));k.isValid()&&nt.fitBounds(k.pad(.15),{maxZoom:6})}catch{}try{window.dispatchEvent(new CustomEvent("nalulf-network-map",{detail:{map:nt,networkId:fo}}))}catch{}}function Lw(e,t,n,s,a,o,i=!1){let r=e.length>1,l=e.map(d=>{let u=rt(d),p=s.has(d),m=a.has(d),f=o.has(d),g=d.slice(0,20)+"...",b,h;return p?(b=Oe.nunl.hex,h="Negative UNL"):m&&f?(b=Oe.both.hex,h="UNL + dUNL"):m?(b=Oe.unl.hex,h="UNL"):f?(b=Oe.dunl.hex,h="dUNL"):(b=Oe.other.hex,h="Other"),`<div class="wm-popup-val-row">
    ...
    </div>`}).join(""),c=[...new Set(e.map(d=>{var p;let u=rt(d);return u.provider??((p=Sn(u))==null?void 0:p.org)??null}).filter(Boolean))];return`<div class="wm-popup-inner">
    ...
    <div class="wm-popup-vals">${l}</div>
  </div>`}var Ss=[];function Aw(){let e=Object.keys(je),t=e.reduce((r,l)=>{var c;return r+(((c=sn[l])==null?void 0:c.w)??1)},0),n=t>=sw;for(e.forEach(r=>{var l,c;Ss.find(d=>d.key===r&&Date.now()-d.ts<3e5)||Ss.push({key:r,label:((l=sn[r])==null?void 0:l.label)??r,ts:Date.now(),weight:((c=sn[r])==null?void 0:c.w)??1})});Ss.length>20;)Ss.shift();let s=x("adversarial-alert");s&&(s.classList.toggle("adv-active",n),s.classList.toggle("adv-inactive",!n));let a=x("adversarial-score");if(a){let r=t===0?"All Clear":t<3?"Monitor":t<5?"Elevated":t<10?"High":"Critical",l=t===0?"#50fa7b":t<3?"#8be9fd":t<5?"#ffb86c":t<10?"#ff9955":"#ff5555";a.innerHTML=`<span style="color:${l};font-weight:700">${r}</span>
      ...
      <div>
        ...
        <div class="adv-clear-sub">All ${Object.keys(sn).length} threat indicators are nominal</div>
      </div>
    </div>`;else{let r=e.filter(u=>{var p;return(((p=sn[u])==null?void 0:p.w)??1)>=3}),l=e.filter(u=>{var p;return(((p=sn[u])==null?void 0:p.w)??1)===2}),c=e.filter(u=>{var p;return(((p=sn[u])==null?void 0:p.w)??1)===1}),d=(u,p,m)=>p.length===0?"":`
      <div class="adv-group-title" style="color:${m}">${u} (${p.length})</div>
      ${p.map(f=>{let g=sn[f]??{w:1,label:f},b=g.label.split(" \u2014 "),h=b[0],v=b[1]||"";return`<div class="adv-sig-card adv-sig-${g.w>=3?"critical":g.w>=2?"elevated":"monitor"}">
        ...
        </div>`}).join("")}`;o.innerHTML=d("Critical",r,"#ff5555")+d("Elevated",l,"#ffb86c")+d("Monitor",c,"#8be9fd")}let i=x("adversarial-history");if(i&&Ss.length){let r=Date.now();i.innerHTML=Ss.slice(-8).reverse().map(l=>{let c=Math.round((r-l.ts)/6e4),d=e.includes(l.key);return`<div class="adv-hist-row ${d?"adv-hist-active":"adv-hist-resolved"}">
  ...
  `,document.body.appendChild(e),e.addEventListener("click",t=>{t.target===e&&ua()}),document.addEventListener("keydown",t=>{t.key==="Escape"&&e.classList.contains("show")&&ua()})}function Gw(e){let t=jw[e];if(!t)return;Vw();let n=document.getElementById("learnModalOverlay"),s=document.getElementById("learnModalTitle"),a=document.getElementById("learnModalSub"),o=document.getElementById("learnModalBody"),i=document.getElementById("learnModalLinks"),r=document.getElementById("learnModalCtas");!n||!s||!a||!o||!i||!r||(s.textContent=t.title,a.textContent=t.subtitle||"",o.innerHTML=(t.sections||[]).map(l=>`
  ...
  `).join(""),n.classList.add("show"),document.body.classList.add("modal-open"))}function ua(){var e;(e=document.getElementById("learnModalOverlay"))==null||e.classList.remove("show"),document.body.classList.remove("modal-open")}function Kw(e){var t,n,s;if(e==="modal:close")return ua();if(e==="auth:signup"){ua(),(t=window.openAuth)==null||t.call(window,"signup");return}if(e==="auth:login"){ua(),(n=window.openAuth)==null||n.call(window,"login");return}if(e.startsWith("topic:"))return Gw(e.split(":")[1]);if(e.startsWith("scroll:")){let a=e.split(":")[1];(s=document.getElementById(a))==null||s.scrollIntoView({behavior:"smooth",block:"start"})}}function Jw(){Nm||(Nm=!0,document.addEventListener("click",e=>{var s,a;let t=(a=(s=e.target).closest)==null?void 0:a.call(s,"[data-action]");if(!t)return;let n=t.getAttribute("data-action")||"";n&&(e.preventDefault(),Kw(n))}))}function Rm(){var l,c,d,u,p;Jw(),(l=document.querySelector(".landing-features"))==null||l.setAttribute("id","learn"),(c=document.querySelector(".landing-simple-value"))==null||c.setAttribute("id","use-cases"),(d=document.querySelector(".landing-cta"))==null||d.setAttribute("id","about"),(u=document.querySelector(".landing-tagline"))==null||u.classList.add("tagline-pill");let e=document.querySelector(".landing-stats-strip");e&&(e.classList.add("landing-learn-strip"),e.innerHTML=Ww.map(m=>`
    ...
    `).join(""));let t=x("features-grid");t&&(t.innerHTML=qw.map(m=>`
    ...
    `).join(""));let n=document.querySelector(".landing-simple-value"),s=n==null?void 0:n.querySelector("h2");s&&(s.textContent="What you can do with NaluLF");let a=x("value-grid");a&&(a.innerHTML=Uw.map(m=>`
    ...
    `)}function _m(){let e=new IntersectionObserver(t=>t.forEach(n=>{n.isIntersecting&&n.target.classList.add("visible")}),{threshold:.12});document.querySelectorAll(".reveal").forEach(t=>e.observe(t))}function Dm(){let e=document.getElementById("particle-canvas");if(!e)return;let t=e.getContext("2d"),n,s,a=[],o=80,i=120;function r(){n=e.width=window.innerWidth,s=e.height=window.innerHeight}function l(){return{x:Math.random()*n,y:Math.random()*s,vx:(Math.random()-.5)*.4,vy:(Math.random()-.5)*.4,r:Math.random()*1.5+.5,alpha:Math.random()*.5+.1}}function c(){r(),a=Array.from({length:o},l)}function d(){return getComputedStyle(document.body).getPropertyValue("--accent-secondary").trim()||"#ffd700"}function u(){t.clearRect(0,0,n,s);let g=d();for(let b=0;b<a.length;b++)for(let h=b+1;h<a.length;h++){let v=a[b].x-a[h].x,w=a[b].y-a[h].y,k=Math.sqrt(v*v+w*w);k<i&&(t.beginPath(),t.moveTo(a[b].x,a[b].y),t.lineTo(a[h].x,a[h].y),t.strokeStyle=`rgba(255,255,255,${(1-k/i)*.06})`,t.lineWidth=1,t.stroke())}a.forEach(b=>{t.beginPath(),t.arc(b.x,b.y,b.r,0,Math.PI*2),t.fillStyle=`rgba(255,255,255,${b.alpha*.6})`,t.fill()})}function p(){a.forEach(g=>{g.x+=g.vx,g.y+=g.vy,(g.x<0||g.x>n)&&(g.vx*=-1),(g.y<0||g.y>s)&&(g.vy*=-1)})}let m;function f(){p(),u(),m=requestAnimationFrame(f)}c(),f(),document.addEventListener("visibilitychange",()=>{document.hidden?(m&&cancelAnimationFrame(m),m=null):!m&&X.currentPage==="landing"&&f()}),window.addEventListener("naluxrp:pagechange",g=>{var b;((b=g==null?void 0:g.detail)==null?void 0:b.pageId)!=="landing"?(m&&cancelAnimationFrame(m),m=null):m||f()}),window.addEventListener("resize",()=>{r(),a.forEach(g=>{g.x=Math.min(g.x,n),g.y=Math.min(g.y,s)})}),e.style.cssText=`
    position: fixed; inset: 0;
    width: 100%; height: 100%;
    pointer-events: none;
    z-index: 0; opacity: 0.4;
  `}function Cs(e){var t;(t=window.showProfile)==null||t.call(window),setTimeout(()=>e==null?void 0:e(),250)}var Pr=[{label:"\u{1F30A} Live Stream",hint:"Dashboard \u2192 Stream tab",action:()=>En(document.querySelector('[data-tab="stream"]'),"stream")},{label:"\u{1F50D} Inspector",hint:"Dashboard \u2192 Inspector tab",action:()=>En(document.querySelector('[data-tab="inspector"]'),"inspector")},{label:"\u{1F4E1} Network Health",hint:"Dashboard \u2192 Network tab",action:()=>En(document.querySelector('[data-tab="network"]'),"network")},{label:"\u{1F464} Profile",hint:"View your profile",action:()=>{var e;return(e=window.showProfile)==null?void 0:e.call(window)}},{label:"\u{1F48E} Wallets",hint:"Profile \u2192 Wallets",action:()=>Cs(()=>{var e;return(e=window.switchProfileTab)==null?void 0:e.call(window,"wallets")})},{label:"\u{1F4CA} Portfolio Analytics",hint:"Profile \u2192 Balance history, heatmap, flow",action:()=>Cs(()=>{var e;return(e=window.switchProfileTab)==null?void 0:e.call(window,"analytics")})},{label:"\u{1F517} Social Links",hint:"Profile \u2192 Connect Discord, X, GitHub\u2026",action:()=>Cs(()=>{var e;return(e=window.switchProfileTab)==null?void 0:e.call(window,"social")})},{label:"\u{1F4DC} Activity Log",hint:"Profile \u2192 Recent account activity",action:()=>Cs(()=>{var e;return(e=window.switchProfileTab)==null?void 0:e.call(window,"activity")})},{label:"\u2699\uFE0F Settings",hint:"Profile \u2192 Preferences & AI Explanations",action:()=>Cs(()=>{var e;return(e=window.switchProfileTab)==null?void 0:e.call(window,"settings")})},{label:"\u{1F52C} Analyze a Project",hint:"Liquidity depth, holder/LP concentration, issuer risk",action:()=>Cs(()=>{var e;return(e=window.jumpToProjectIntelLookup)==null?void 0:e.call(window)})},{label:"\u{1F9ED} Replay App Tour",hint:"Retake the onboarding walkthrough",action:()=>{var e;(e=window.showDashboard)==null||e.call(window),setTimeout(()=>{var t;return(t=window.startTour)==null?void 0:t.call(window)},300)}},{label:"\u2753 Help & Glossary",hint:"Search app features and on-chain terms",action:()=>{var e;return(e=window.openHelp)==null?void 0:e.call(window)}},{label:"\u{1F511} Sign In",hint:"Open auth",action:()=>{var e;return(e=window._openAuth)==null?void 0:e.call(window,"login")}},{label:"\u2728 Sign Up",hint:"Create account",action:()=>{var e;return(e=window._openAuth)==null?void 0:e.call(window,"signup")}},{label:"\u{1F3E0} Landing Page",hint:"Go home",action:()=>{var e;return(e=window._goHome)==null?void 0:e.call(window)}},{label:"\u{1F3A8} Cycle Theme",hint:"gold \u2192 cosmic \u2192 starry \u2192",action:()=>{var e;return(e=window._cycleTheme)==null?void 0:e.call(window)}}];function Yw(e){let t=e.trim();return He(t)?[{label:`\u{1F50D} Inspect ${t.slice(0,8)}\u2026${t.slice(-6)}`,hint:"Run the full account inspection on this address",action:()=>{En(document.querySelector('[data-tab="inspector"]'),"inspector"),setTimeout(()=>{var s;let n=document.getElementById("inspect-addr");n&&(n.value=t),(s=window.runInspect)==null||s.call(window)},200)}}]:[]}var Kn=0,yo=[...Pr];function wo(e=""){let t=x("cmdkOverlay"),n=x("cmdkInput");!t||!n||(t.classList.add("show"),n.value=e||"",Om(e),n.focus())}function Ps(){var e;(e=x("cmdkOverlay"))==null||e.classList.remove("show")}function Fm(){let e=x("cmdkOverlay"),t=x("cmdkInput");!e||!t||(t.addEventListener("input",()=>Om(t.value)),t.addEventListener("keydown",n=>{n.key==="ArrowDown"&&(n.preventDefault(),Im(1)),n.key==="ArrowUp"&&(n.preventDefault(),Im(-1)),n.key==="Enter"&&(n.preventDefault(),Qw()),n.key==="Escape"&&Ps()}),e.addEventListener("click",n=>{n.target===e&&Ps()}))}function Om(e=""){let t=x("cmdkList");if(!t)return;let n=e.toLowerCase().trim(),s=Yw(e);yo=n?[...s,...Pr.filter(a=>a.label.toLowerCase().includes(n)||a.hint.toLowerCase().includes(n))]:[...s,...Pr],Kn=0,t.innerHTML=yo.length?yo.map((a,o)=>`
        <button class="cmdk-item${o===0?" is-active":""}" data-index="${o}">
          <span class="cmdk-label">${y(a.label)}</span>
          <span class="cmdk-hint2">${y(a.hint)}</span>
        </button>`).join(""):'<div class="cmdk-section-label">No results</div>',t.querySelectorAll(".cmdk-item").forEach(a=>{a.addEventListener("click",()=>Bm(Number(a.dataset.index)))})}function Im(e){var n,s,a;let t=Xe("#cmdkList .cmdk-item");t.length&&((n=t[Kn])==null||n.classList.remove("is-active"),Kn=(Kn+e+t.length)%t.length,(s=t[Kn])==null||s.classList.add("is-active"),(a=t[Kn])==null||a.scrollIntoView({block:"nearest"}))}function Bm(e){let t=yo[e];t&&(Ps(),t.action())}function Qw(){Bm(Kn)}var xo=!1;function Mr(){let e=X.currentPage,t=X.currentTab,n=e==="dashboard"&&t==="stream",s=e==="dashboard"&&t==="inspector",a=e==="dashboard"&&t==="network";vu(n),Xu(s),Lm(a)}function Xm(){xo||(bu(),Bu(),Mm(),oc(),Mr(),xo=!0)}window.openAuth=e=>Bo(e);window.closeAuth=()=>cn();window.showAuthView=e=>ln(e);window.authKeydown=e=>bl(e);window.submitSignIn=()=>Ho();window.submitSignUp=()=>zo();window.refreshCaptcha=()=>sl();window.showForgotView=()=>ll();window.forgotRestoreFromFile=()=>cl();window.forgotWipeConfirm=()=>dl();window.forgotWipeExecute=()=>pl();window.forgotBackToOptions=()=>ul();window.submitSyncImport=()=>jo();window.exportVaultSyncCode=()=>ml();window.syncImportFromFile=()=>fl();window.signupNext=()=>Xo();window.signupBack=()=>nl();window.logout=()=>hl();window.goHome=()=>Ln();window.showLandingPage=()=>Ln();window.showDashboard=()=>An();window.showProfile=()=>Mo();window.switchTab=(e,t)=>En(e,t);window.runInspect=()=>ks();window.closeCommandPalette=()=>Ps();window.openCmdk=()=>wo();window.setTheme=e=>Mn(e);window.cycleTheme=()=>Co();window.measureLatency=()=>ca();window.switchProfileTab=e=>gi(e);window.openProfileEditor=()=>Zd();window.closeProfileEditor=()=>Hs();window.saveProfileEditor=()=>ep();window.selectAvatar=e=>tp(e);window.selectBanner=e=>np(e);window.uploadAvatarImage=e=>sp(e);window.removeAvatarImage=()=>ap();window.uploadBannerImage=e=>op(e);window.removeBannerImage=()=>ip();window.prefSetTheme=e=>Tp(e);window.setPrefCurrency=e=>Cp(e);window.setPrefNetwork=e=>Pp(e);window.setPrefAutoLock=e=>Mp(e);window.openPublicProfilePreview=()=>Sp();window.exportVaultBackup=()=>rp();window.logActivity=(e,t)=>kt(e,t);window.toggleWalletDrawer=e=>Gd(e);window.switchWalletDrawerTab=(e,t)=>Kd(e,t);window.cancelOffer=(e,t,n)=>Yd(e,t,n);window.fetchBalance=e=>Bn(e);window.setActiveWallet=e=>cc(e);window.openImportAddressModal=()=>vp();window.closeImportAddressModal=()=>Li();window.importWatchOnlyWallet=()=>yp();window.openImportSeedModal=()=>wp();window.closeImportSeedModal=()=>Ai();window.executeImportFromSeed=()=>xp();window.openTokenDetailsModal=(e,t,n)=>kp(e,t,n);window.closeTokenDetailsModal=()=>$p();window.refreshXrplDashboard=()=>ss();window.refreshMarketData=()=>Id();window.refreshNftGallery=()=>Fd();window.refreshAmmPools=()=>Od();window.refreshPoolExplorer=()=>Bd();window.loadCustomAmmPool=()=>Mc();window.sendNft=e=>Xd(e);window.toggleSeedBackupStatus=()=>Bc();window.setDexPair=e=>Xc(e);window.setDexInterval=e=>Hc(e);window.setDexChartType=e=>zc(e);window.refreshDexChart=()=>jc();window.setComparePair=e=>sd(e);window.toggleIndicator=(e,t)=>Wc(e,t);window.toggleTerminalTheme=()=>hd();window.toggleChartFullscreen=()=>gd();window.exportChartPng=()=>bd();window.saveChartLayoutPreset=()=>yd();window.loadChartLayoutPreset=()=>wd();window.setIndicatorFromDropdown=e=>ad(e);window.toggleIndicatorMenu=()=>qc();window.toggleChartMoreMenu=()=>Uc();window.setIndicatorQuery=e=>Vc(e);window.addIndicatorFromMenu=e=>Gc(e);window.removeIndicator=e=>Kc(e);window.openIndicatorSettings=e=>Jc(e);window.closeIndicatorSettings=()=>Yc();window.applyIndicatorSettings=e=>Qc(e);window.resetIndicatorSettings=e=>Zc(e);window.copyChartLink=()=>ed();window.toggleThreeEffects=()=>td();window.setThreeEffects=e=>nd(e);window.setDrawingTool=e=>od(e);window.clearAllDrawings=()=>ld();window.addPriceAlert=()=>id();window.removePriceAlert=e=>rd(e);window.zoomChartIn=()=>cd();window.zoomChartOut=()=>dd();window.panChartLeft=()=>pd();window.panChartRight=()=>ud();window.toggleEducationPanel=()=>md();window.selectEducationTab=e=>fd(e);window.searchTokens=e=>$d(e);window.lookupIssuedAsset=()=>ki();window.lookupAndAnalyzeProject=()=>_d();window.addTokenToWatchlist=e=>Ad(e);window.removeTokenFromWatchlist=e=>Ed(e);window.openTokenOnChart=e=>Xa(e);window.loadToken=e=>Nd(e);window.refreshTokenDiscovery=()=>Rd();window.refreshRecentTransactions=()=>Dd();window.setTokenFilter=(e,t)=>Sd(e,t);window.clearTokenFilters=()=>Td();window.selectTokenDetails=e=>Ld(e);window.openProjectIntel=e=>yi(e);window.jumpToProjectIntelLookup=()=>pc();window.toggleProjectIntelSubScore=e=>uc(e);window.setProjectGraphView=e=>fc(e);window.copyProjectIntelForAi=()=>kc();window.closeProjectIntel=()=>hc();window.showMoreIssuedTokens=()=>Cd();window.showAllIssuedTokens=()=>Pd();window.resetIssuedTokenLimit=()=>Md();window.openWalletCreator=()=>Pi();window.closeWalletCreator=()=>zs();window.wizardNext=()=>lp();window.wizardBack=()=>cp();window.selectAlgo=e=>dp(e);window.selectWalletEmoji=e=>pp(e);window.selectWalletColor=e=>up(e);window.toggleSecurityCheck=e=>mp(e);window.revealSeed=()=>hp();window.copySeed=()=>gp();window.copyAddress=()=>bp();window.copyToClipboard=e=>js(e);window.deleteWallet=e=>Ud(e);window.inspectWalletAddr=e=>Vd(e);window.openSocialModal=e=>zd(e);window.closeSocialModal=()=>rs();window.saveSocialModal=()=>jd();window.deleteSocial=()=>Wd();window.viewSocial=e=>qd(e);window.connectXRPL=()=>import("./xrpl-6AERZ5KD.js").then(({connectXRPL:e})=>e());window._openAuth=Bo;window._goHome=Ln;window._cycleTheme=Co;window._showProfile=Mo;window.startTour=()=>Eo();window.tourNext=()=>Zr();window.tourPrev=()=>el();window.tourSkip=()=>ba();window.openHelp=()=>Lp();window.closeHelp=()=>ja();window.filterHelp=e=>Ni(e);document.addEventListener("DOMContentLoaded",()=>{var e;console.log("\u{1F30A} NaluLF: booting\u2026"),Vr(),Ln(),Rm(),_m(),Dm(),Fm(),Ap(),Zw(),window.addEventListener("naluxrp:pagechange",t=>{var s;let n=(s=t==null?void 0:t.detail)==null?void 0:s.pageId;(n==="dashboard"||n==="inspector"||n==="profile")&&Xm(),xo&&Mr()}),window.addEventListener("naluxrp:tabchange",()=>{xo&&Mr()}),document.addEventListener("keydown",t=>{var s;let n=["INPUT","TEXTAREA"].includes((s=document.activeElement)==null?void 0:s.tagName);if((t.ctrlKey||t.metaKey)&&t.key==="k"){t.preventDefault(),wo();return}if(t.key==="/"&&!n){t.preventDefault(),wo();return}t.key==="Escape"&&(Ps(),cn(),Hs(),zs(),rs(),ba(),ja())}),(e=document.getElementById("auth-overlay"))==null||e.addEventListener("click",t=>{t.target===t.currentTarget&&cn()}),gl()&&(Xm(),An(),import("./xrpl-6AERZ5KD.js").then(({connectXRPL:t})=>t())),console.log("\u2705 NaluLF: ready")});function Zw(){zm(),setInterval(()=>{document.hidden||zm()},3e4)}async function Hm(e){let t=[s=>`https://corsproxy.io/?${encodeURIComponent(s)}`,s=>`https://api.allorigins.win/raw?url=${encodeURIComponent(s)}`],n=async s=>{let a=typeof(AbortSignal==null?void 0:AbortSignal.timeout)=="function"?AbortSignal.timeout(7e3):void 0,o=await fetch(s,{mode:"cors",cache:"no-store",signal:a});if(!o.ok)throw new Error(`HTTP ${o.status}`);return await o.json()};try{return await n(e)}catch{for(let s of t)try{return await n(s(e))}catch{}throw new Error("Price feed unreachable")}}async function zm(){try{let e=await Hm("https://api.exchange.coinbase.com/products/XRP-USD/ticker"),t=await Hm("https://api.exchange.coinbase.com/products/XRP-USD/candles?granularity=86400");if(e!=null&&e.price){let n=Number(e.price),s=Array.isArray(t)&&t.length?t[0]:null,a=s?Number(s[3]||n):n,o=a?(n-a)/a*100:0,i=document.getElementById("xrpPrice"),r=document.getElementById("xrpChange");if(i&&(i.textContent=`$${Number(n).toFixed(3)}`),r){let l=o>=0;r.textContent=`${l?"+":""}${Number(o).toFixed(2)}%`,r.className=`xrp-price-change ${Math.abs(o)<.1?"flat":l?"up":"down"}`}}}catch{}}
