import{a as Mr,b as vo,c as Tn,d as Dt,e as x,f as Ie,g as y,h as Fe,i as R,j,k as Q,l as Z,m as ht,n as ve,o as ae,p as ge,q as zt,r as X,s as ua,v as Me,w as Ar}from"./chunk-R7KFE7J7.js";function Cn(e){Tn.includes(e)||(e="gold"),X.currentTheme=e,Tn.forEach(t=>document.body.classList.remove(`theme-${t}`)),document.body.classList.add(`theme-${e}`),Z(vo,e)}function bo(){let e=Tn.indexOf(X.currentTheme);Cn(Tn[(e+1)%Tn.length])}function Er(){let e=Q(vo);Cn(Tn.includes(e)?e:"gold")}var Nr={landing:"landing-page",dashboard:"dashboard",inspector:"inspector",profile:"dashboard"};function yo(e){document.body.classList.remove("modal-open"),Object.values(Nr).forEach(i=>document.body.classList.remove(i)),document.body.classList.add(Nr[e]||"dashboard");let t=x("landing"),n=x("dashboard"),s=x("profile-page");t&&(t.style.display=e==="landing"?"":"none"),n&&(n.style.display=e==="dashboard"?"":"none"),s&&(s.style.display=e==="profile"?"":"none");let a=e==="landing",o={landingActions:x("navbar-landing-actions"),dashActions:x("navbar-dash-actions"),navConn:x("navbar-conn"),cmdkHint:x("cmdk-hint"),helpBtn:x("help-trigger")};o.landingActions&&(o.landingActions.style.display=a?"":"none"),o.dashActions&&(o.dashActions.style.display=a?"none":""),o.navConn&&(o.navConn.style.display=a?"none":""),o.cmdkHint&&(o.cmdkHint.style.display=a?"none":""),o.helpBtn&&(o.helpBtn.style.display=a?"none":""),X.currentPage=e,window.scrollTo({top:0,behavior:"smooth"}),window.dispatchEvent(new CustomEvent("naluxrp:pagechange",{detail:{pageId:e}}))}function Pn(){yo("landing")}function Ln(){yo("dashboard")}function wo(){yo("profile")}function Mn(e,t){Ie(".dash-tab").forEach(n=>{n.classList.toggle("active",n===e),n.setAttribute("aria-selected",String(n===e))}),["stream","inspector","network"].forEach(n=>{let s=x(`tab-${n}`);s&&(s.style.display=n===t?"":"none")}),t==="inspector"?(document.body.classList.remove("dashboard"),document.body.classList.add("inspector")):(document.body.classList.remove("inspector"),document.body.classList.add("dashboard")),X.currentTab=t,window.dispatchEvent(new CustomEvent("naluxrp:tabchange",{detail:{tabId:t}}))}var Rr="naluxrp_tour_seen",nn=[{title:"Welcome to NaluLF \u{1F30A}",body:"A 20-second tour of the three things people miss most. Skip anytime."},{selector:"#cmdk-hint",title:"Jump anywhere, instantly",body:"Press <kbd>Ctrl</kbd>+<kbd>K</kbd> (or <kbd>/</kbd>) from any page. Paste an address in and it offers to inspect it directly \u2014 no need to navigate first."},{selector:"#dash-tab-inspector",title:"Inspect any wallet",body:"Full forensic suite \u2014 trust lines, fund flow, convergence signals, AI-assisted explanations \u2014 for any XRPL address, not just your own."},{selector:".user-chip",title:"Your Profile has more than wallets",body:"Portfolio analytics, activity history, and Project Intelligence \u2014 liquidity depth, holder concentration, and issuer-risk scoring for any token \u2014 all live there."}],et=0,ko=!1,Ts=null,It=null;function Dr(){Q(Rr)||setTimeout($o,700)}function $o(){ko||(ko=!0,et=0,dm(),So())}function dm(){if(x("tourOverlay"))return;let e=document.createElement("div");e.id="tourOverlay",e.className="tour-overlay",e.innerHTML='<div class="tour-card" id="tour-card"></div>',document.body.appendChild(e),e.addEventListener("click",t=>{t.target===e&&ma()})}function xo(e){if(!e)return null;let t=document.querySelector(e);if(!t)return null;let n=t.getBoundingClientRect();return n.width>0||n.height>0?t:null}function Ir(){Ts==null||Ts.classList.remove("tour-highlight"),Ts=null}function So(){for(;et<nn.length&&nn[et].selector&&!xo(nn[et].selector);)et++;if(et>=nn.length)return To();let e=nn[et],t=x("tourOverlay"),n=x("tour-card");t.classList.add("show"),Ir();let s=xo(e.selector);s&&(s.scrollIntoView({block:"center",behavior:"smooth"}),s.classList.add("tour-highlight"),Ts=s),n.innerHTML=`
  ...
  </div>`}function tf(){document.addEventListener("keydown",e=>{if(e.key==="Escape")for(let t of["profile-editor-modal","wallet-creator-overlay","social-modal","send-modal-overlay","receive-modal-overlay","trustline-modal-overlay","import-address-modal","import-seed-modal","token-details-modal","pub-profile-overlay"]){let n=x(t)||document.getElementById(t);if(n!=null&&n.classList.contains("show")||(n==null?void 0:n.style.display)==="flex"){n.classList.remove("show"),n.style.display==="flex"&&(n.style.display="none");return}}e.key==="k"&&(e.ctrlKey||e.metaKey)&&(e.preventDefault(),vi())})}function qo(){var t,n;let e=ve(Q(Cl));e&&Object.assign(de,e),Ue=ve(Q(Pl))||{},re=ve(Q(Tl))||[],El=ve(Q(Cm))||{},C.alerts=ve(Q(Fl))||[],lt=Q(As)||((t=re[0])==null?void 0:t.id)||null,!de.displayName&&((n=X.session)!=null&&n.name)&&(de.displayName=X.session.name,de.handle=X.session.name.toLowerCase().replace(/\s+/g,"_"),Hl())}function Hl(){Z(Cl,JSON.stringify(de))}function Ns(){Z(Tl,JSON.stringify(re))}function zl(){Z(Pl,JSON.stringify(Ue))}function ii(){Z(Fl,JSON.stringify(C.alerts||[]))}function wt(e,t){let n=ve(Q(jo))||[];n.unshift({type:e,detail:t,ts:Date.now()}),n.length>ml&&(n.length=ml),Z(jo,JSON.stringify(n))}function nf(){return ve(Q(jo))||[]}function jl(e){let t=(Date.now()-e)/1e3;return t<60?"just now":t<3600?`${Math.floor(t/60)}m ago`:t<86400?`${Math.floor(t/3600)}h ago`:`${Math.floor(t/86400)}d ago`}function Mt(){return re.find(e=>e.id===lt)||re[0]||null}function Wl(e){re.find(t=>t.id===e)&&(lt=e,Z(As,e),xt(),Ot(),window.dispatchEvent(new CustomEvent("naluxrp:active-wallet-changed",{detail:Mt()})),ae("Active wallet switched"))}window.addEventListener("naluxrp:active-wallet-changed",e=>{let t=e.detail;if(!t)return;let n=x("inspect-addr");n&&!n.value&&(n.value=t.address),X.activeWalletAddress=t.address});function Ot(){var o;let e=x("active-wallet-bar");if(!e)return;let t=Mt();if(!t){e.innerHTML='<div class="awb-empty">No wallet \u2014 <button class="awb-link" onclick="openWalletCreator()">create one</button></div>';return}let n=Ke[t.address],s=n?R(n.xrp,2)+" XRP":"\u2014 XRP",a=(o=n==null?void 0:n.tokens)!=null&&o.length?`\xB7 ${n.tokens.length} token${n.tokens.length>1?"s":""}`:"";e.innerHTML=`
    <div class="awb-left">
    ...
    </div>`}function U(){var h,g;let e=document.querySelector("#profile-page .profile-wrap");if(!e)return;let t=document.getElementById("xpd-tv-widget"),n=!!(t&&ee.chart);t&&t.remove();let s=document.getElementById("xpd-chart-atmosphere"),a=!!(s&&We.renderer);s&&s.remove();let o=Mt(),i=(o==null?void 0:o.address)||"",r=sf(),l=localStorage.getItem(cn),c=re.some(w=>!w.watchOnly),d=Q(Wo)==="1",u=(h=Ke[i])==null?void 0:h.xrp,p=Object.values(Ke).reduce((w,k)=>w+((k==null?void 0:k.xrp)||0),0),m=(g=Ce.data)!=null&&g.priceUsd?p*Ce.data.priceUsd:0,f=In.map(w=>`<option value="${y(w.id)}" ${C.pair===w.id?"selected":""}>${y(w.label)}</option>`).join(""),v=In.map(w=>`<option value="${y(w.id)}" ${C.comparePair===w.id?"selected":""}>${y(w.label)}</option>`).join(""),b=Ol.map(w=>`<option value="${y(w.value)}" ${C.interval===w.value?"selected":""}>${y(w.label)}</option>`).join("");if(e.innerHTML=`
              ...
              <div class="xpd-chart-toolbar">
                ...
                <div class="xpd-toolbar-group">
                  ...
                  <select class="xpd-input" onchange="setDrawingTool(this.value)">
                    ${Xl.map(w=>`<option value="${w.key}" ${C.drawingTool===w.key?"selected":""}>Draw: ${w.label}</option>`).join("")}
                  </select>
    ...
    </div>`,n){let w=document.getElementById("xpd-tv-widget");w&&w.replaceWith(t)}if(a){let w=document.getElementById("xpd-chart-atmosphere");w&&w.replaceWith(s)}ih(),$h(),Sh(),mi(),Fs()}function sf(){let e=String(X.currentNetwork||"").toLowerCase();return e.includes("testnet")?{label:"XRPL Testnet",kind:"testnet"}:e.includes("mainnet")?{label:"XRPL Mainnet",kind:"mainnet"}:e.includes("xahau")?{label:"Xahau Network",kind:"xahau"}:{label:`Network: ${y(X.currentNetwork||"Unknown")}`,kind:"unknown"}}function af(){let e=String(C.indicatorQuery||"").trim().toLowerCase(),t=[{key:"trend",label:"Trend",icon:"\u{1F4C8}"},{key:"momentum",label:"Momentum",icon:"\u26A1"},{key:"volume",label:"Volume",icon:"\u{1F4CA}"},{key:"volatility",label:"Volatility",icon:"\u{1F32A}\uFE0F"},{key:"advanced",label:"Custom",icon:"\u{1F9E0}"}];return`
    <div class="xpd-indicator-menu-wrap">
      ...
      ${C.indicatorMenuOpen?`
        <div class="xpd-indicator-menu" role="menu" aria-label="Indicator menu">
          <input class="xpd-input xpd-indicator-search" placeholder="Search indicators..." value="${y(C.indicatorQuery||"")}" oninput="setIndicatorQuery(this.value)" />
          ${t.map(n=>{let s=(qm[n.key]||[]).filter(a=>{var i;return e?(((i=Ut[a])==null?void 0:i.name)||a).toLowerCase().includes(e):!0});return s.length?`
    ...
    <div class="xpd-indicator-row">
      ${s.length?s.map(f=>{var v,b;return`<div class="xpd-indicator-chip-wrap"><div class="xpd-indicator-chip" title="${y(((v=Ut[f])==null?void 0:v.what)||"")}"><span>${y(((b=Ut[f])==null?void 0:b.name)||f)}</span><button class="xpd-mini-btn" onclick="event.stopPropagation(); openIndicatorSettings('${f}')">\u2699</button><button class="xpd-mini-btn" onclick="removeIndicator('${f}')">\u2715</button></div>${rh(f)}</div>`}).join(""):'<span class="xpd-empty">No indicators enabled. Use + Indicator.</span>'}
    </div>
    ${(()=>{let f=Ea(),v=(C.alerts||[]).filter(b=>b.tokenKey===f);return v.length?`
      <div class="xpd-indicator-row">
        ${v.map(b=>`
    ...
    ${C.educationHint?`<div class="xpd-note">${y(C.educationHint)}</div>`:""}
    ...
    <p class="xpd-note">Professional chart controls: wheel zoom, hold-and-drag pan, horizontal price-line marking, and token-focused context ribbons for faster execution decisions.</p>`}function rf(){let e=C.selectedIndicator||"sma20",t=Ut[e]||Ut.sma20,n=Vm[e]||null,s=C.educationCollapsed;return`
    <div class="xpd-edu-panel ${s?"collapsed":""}">
      ...
      ${s?"":`
        ...
        `:""}
      `}
    </div>`}function rt(e,t){return`<div class="xpd-edu-row"><span class="xpd-edu-label">${y(e)}</span><span class="xpd-edu-value">${y(t)}</span></div>`}function lf(){if(Ce.loading)return'<div class="xpd-loading">Loading XRP market snapshot...</div>';if(Ce.error)return`<div class="xpd-error">${y(Ce.error)}</div>`;let e=Ce.data;if(!e)return'<div class="xpd-empty">Market data is not available yet.</div>';let t=e.change24h>=0;return`
    <div class="xpd-market-grid">
      ...
      <article class="xpd-stat-card">
        ...
        <strong class="xpd-stat-value">$${Be(e.volume24h)}</strong>
      </article>
      <article class="xpd-stat-card">
        <span class="xpd-stat-label">Market Cap</span>
        <strong class="xpd-stat-value">$${Be(e.marketCap)}</strong>
      </article>
    </div>
    <div class="xpd-token-strip">
      ${Um.map(n=>`<div class="xpd-token-pill" title="${y(`${n.symbol} ${n.name}`)}"><span class="sym xpd-pill-text">${n.symbol}</span><span class="xpd-pill-text">${y(n.name)}</span><span class="cap xpd-pill-text">${n.marketCap}</span></div>`).join("")}
    </div>
    <p class="xpd-note">Top XRPL token cards are static examples when direct DEX market-cap feeds are unavailable.</p>`}function cf(e){return e?gt.loading?'<div class="xpd-loading">Loading account NFTs...</div>':gt.error?`<div class="xpd-error">${y(gt.error)}</div>`:gt.items.length?`<div class="xpd-nft-grid">${gt.items.map(df).join("")}</div>`:'<div class="xpd-empty">No NFTs found for this wallet.</div>':'<div class="xpd-empty">Select or create a wallet to load NFTs.</div>'}function df(e){let t=`${e.id.slice(0,12)}...${e.id.slice(-10)}`;return`<article class="xpd-nft-card">
  ...
  </article>`}function pf(e){let t=yf(e),n=wf(),s=xf();return`<div class="xpd-amm-columns">${t}${n}${s}</div>`}function ri(){return(ve(Q(Dl))||[]).filter(Boolean)}function Ul(e){let t=[...new Set((e||[]).filter(Boolean))];Z(Dl,JSON.stringify(t))}function uf(e,t){return t.has(e)?t.get(e):W.tokens.find(s=>s.symbol===e)||null}function mf(){let e=W.query||"",t=ri(),n=W.filtered,s=Math.max(120,Number(W.listLimit||240)),a=n.slice(0,s),o=W.trending.slice(0,14),i=new Map(W.tokens.map(c=>[He(c),c])),r=i.get(W.selectedTokenKey)||null,l=W.filters||{type:"all",minCap:0,minVol:0,hasDex:!1};return`
    <div class="xpd-token-grid">
      <div class="xpd-token-col">
        <div class="xpd-search-row">
          ...
          <div class="xpd-note">Loaded ${Be(W.total||n.length)} issued tokens \xB7 showing ${Be(a.length)} of ${Be(n.length)}${W.lastSyncAt?` \xB7 synced ${new Date(W.lastSyncAt).toLocaleTimeString()}`:""}</div>
        ...
        <div class="xpd-token-list">${a.map(c=>{let d=He(c),u=Cs(d),p=String(e||"").trim();return`
          <div class="xpd-token-row xpd-token-row--clickable" title="${y(`${c.symbol} ${c.name}`)}" onclick="openTokenOnChart(decodeURIComponent('${u}'))">
            ...
            <div class="xpd-token-actions">
              ...
              ${Number.isFinite(c.holders)?`<span title="Holders">${Be(c.holders)} holders</span>`:""}
      ...
      <div class="xpd-token-col">
        ${r?`<div class="xpd-token-detail-card">
          ...
          <div class="pool-meta">Price: ${r.price!=null?`$${R(r.price,6)}`:"\u2014"} \xB7 24h Vol: ${r.volume24h!=null?`$${Be(r.volume24h)}`:"\u2014"}</div>
          <div class="pool-meta">Market Cap: ${r.marketCap!=null?`$${Be(r.marketCap)}`:"\u2014"} \xB7 Holders: ${r.holders!=null?Be(r.holders):"\u2014"}</div>
      ...
      <div class="xpd-error">${y(Ge.error)}</div>`;let e=Ge.data;if(!e)return"";let t=e.strength,n=Bo(t.overall),s=t.dimensionsLive.map(a=>{let o=Kl[a],i=t.subScores[a],r=Ge.expandedSubScore===a;return`
      <div class="pi-subscore ${r?"pi-subscore--open":""}" onclick="toggleProjectIntelSubScore('${a}')">
        <div class="pi-subscore-row">
          ...
          <span class="pi-subscore-val" style="color:${Bo(i.score)}">${i.score}</span>
        </div>
        <div class="pi-subscore-bar"><div class="pi-subscore-fill" style="width:${i.score}%;background:${Bo(i.score)}"></div></div>
    ...
    <div class="pi-cards-grid">
      ...
      ${gf(e.issuerRisk)}
    </div>`}function ci(e){return e.replace(/([A-Z])/g," $1").replace(/^./,t=>t.toUpperCase()).trim()}function Yl(e){return e==null?"\u2014":typeof e=="boolean"?e?"Yes":"No":typeof e=="number"?Number.isInteger(e)?String(e):R(e,2):String(e)}function hf(e){var i;let t=e.amm,n=e.orderBook,s=t!=null&&t.exists?`
  ...
  `:'<div class="inspect-empty-note">No AMM pool found for this pair.</div>',a=(r,l)=>r!=null&&r.length?`
    ...
    ${r.map(c=>`<tr><td>${c.pct}%</td><td class="mono">${R(c.xrpAtOffer,1)}</td><td class="mono">${Be(c.tokenAtOffer)}${c.bookExhausted?' <span title="Visible order book fully consumed before reaching this price-impact level \u2014 real depth may be less than shown, book is thin.">\u26A0</span>':""}</td></tr>`).join("")}
  ...
  `:'<div class="inspect-empty-note">No live order book found for this pair.</div>';return`
    ...
    <div class="pi-holder-row">
      ...
      <span class="mono">${Be(a.balance)}</span>
      <span class="mono pi-holder-pct">${t.totalSampled>0?R(a.balance/t.totalSampled*100,1):"0.0"}%</span>
    </div>`).join("");return`
    <div class="sec-card pi-card">
      <div class="sec-card-hdr"><span class="sec-card-icon">${n}</span><div><div class="sec-card-title">${y(e)}</div><div class="sec-card-sub">${Be(t.holderCount)} holders${t.sampleOnly?" (sampled, capped)":""}</div></div></div>
    ...
    <div class="finding finding--${s?a?"ok":"warn":"ok"}">
      ...
      <div class="finding-body">
        ...
        <div class="finding-detail">${y(yt[n]||"")}</div>
      </div>
    </div>`;return`
    <div class="sec-card pi-card">
    ...
    </div>`}function Ql(){let e=Ge.data;e&&Da(vf(e))}function hl(e,t){if(!(e!=null&&e.length))return"";let n=e.map(s=>`    ${s.pct}% impact: ${R(s.xrpAtOffer,1)} XRP / ${Be(s.tokenAtOffer)} tokens${s.bookExhausted?" (book exhausted before this level \u2014 real depth may be less than shown)":""}`).join(`
`);return`  ${t}:
${n}`}function gl(e,t){let n=[`${e}:`];return t!=null&&t.exists?(n.push(`  Holder count: ${t.holderCount}${t.sampleOnly?" (sampled, capped)":""}`),n.push(`  Top 1 holds: ${R(t.top1Pct,1)}%`),n.push(`  Top 5 hold: ${R(t.top5Pct,1)}%`),n.push(`  Top 10 hold: ${R(t.top10Pct,1)}%`),(t.topHolders||[]).slice(0,10).forEach((s,a)=>{let o=t.totalSampled>0?R(s.balance/t.totalSampled*100,2):"0.00";n.push(`    #${a+1} ${s.address}: ${Be(s.balance)} (${o}%)`)}),n.join(`
`)):(n.push("  No data found."),n.join(`
`))}function vf(e){var i;let t=e.strength,n=e.amm,s=e.orderBook,a=e.issuerRisk,o=[];if(o.push(`XRPL TOKEN ANALYSIS \u2014 ${e.token.symbol}${e.token.name?` (${e.token.name})`:""}`),o.push(`Issuer: ${e.token.issuer}`),o.push(`Currency code: ${e.token.currency}`),o.push(`Snapshot taken: ${new Date(e.fetchedAt).toISOString()}`),o.push(""),o.push(`OVERALL STRENGTH SCORE: ${t.overall}/100 (${Jl(t.overall)})`),o.push("Methodology note: this score covers only 5 point-in-time-computable dimensions (Liquidity, Distribution, Market Quality, LP Stability, Issuer Risk). Network Activity, Treasury Health, and Project Transparency are NOT included \u2014 they would require historical tracking this tool does not do."),o.push(""),o.push("SUB-SCORES:"),t.dimensionsLive.forEach(r=>{let l=Kl[r],c=t.subScores[r];o.push(`- ${l.label}: ${c.score}/100`),Object.entries(c.inputs||{}).forEach(([d,u])=>{o.push(`    ${ci(d)}: ${Yl(u)}`)})}),o.push(""),o.push("LIQUIDITY \u2014 AMM POOL:"),n!=null&&n.exists?(o.push(`  XRP reserve: ${R(n.xrpReserve,2)}`),o.push(`  Token reserve: ${R(n.tokenReserve,2)}`),o.push(`  LP token supply: ${R(n.lpSupply,2)}`),o.push(`  Trading fee: ${R(n.tradingFeePct,3)}%`),n.auctionSlot&&o.push(`  Auction slot discounted fee: ${R(n.auctionSlot.discountedFeePct,3)}%`),(i=n.voteSlots)!=null&&i.length&&o.push(`  Fee-vote participants: ${n.voteSlots.length}`)):o.push("  No AMM pool found for this pair."),o.push(""),o.push("LIQUIDITY \u2014 LIVE ORDER BOOK (DEX):"),s!=null&&s.exists){o.push(`  Buy price: ${R(s.buyPriceXrp,6)} XRP`),o.push(`  Sell price: ${R(s.sellPriceXrp,6)} XRP`),o.push(`  Spread: ${s.spreadPct!=null?R(s.spreadPct,2)+"%":"\u2014"}`);let r=hl(s.buyDepth,"Depth buying with XRP"),l=hl(s.sellDepth,"Depth selling for XRP");r&&o.push(r),l&&o.push(l)}else o.push("  No live order book found for this pair.");return o.push(""),o.push(gl("HOLDER CONCENTRATION",e.holders)),o.push(""),o.push(gl("LP TOKEN CONCENTRATION",e.lp)),o.push(""),o.push("ISSUER RISK FLAGS:"),a!=null&&a.exists?(o.push(`  Clawback enabled: ${a.clawbackEnabled?"YES":"No"} \u2014 ${yt.clawbackEnabled}`),o.push(`  Global freeze active: ${a.globalFreeze?"YES":"No"} \u2014 ${yt.globalFreeze}`),o.push(`  Freeze-capable: ${a.freezeCapable?"YES":"No"} \u2014 ${yt.freezeCapable}`),o.push(`  Requires auth to hold: ${a.requireAuth?"YES":"No"} \u2014 ${yt.requireAuth}`),o.push(`  Issuer blackholed: ${a.blackholed?"YES":"No"} \u2014 ${yt.blackholed}`)):o.push("  Could not load issuer account state."),o.push(""),o.push("---"),o.push("Please analyze this XRPL token's on-chain data above. Explain in plain language what these metrics suggest about the token's liquidity health, holder/LP concentration risk, and issuer-side control risk. Point out anything that looks like a red flag or an unusually strong/weak signal, and note any limits in what this data can and can't tell me (e.g. it's a point-in-time snapshot, not history)."),o.join(`
`)}function vl(e,t){let n=String(e||""),s=String(t||"").trim();if(!s)return y(n);let a=n.toLowerCase().indexOf(s.toLowerCase());if(a<0)return y(n);let o=y(n.slice(0,a)),i=y(n.slice(a,a+s.length)),r=y(n.slice(a+s.length));return`${o}<mark class="xpd-hit">${i}</mark>${r}`}function bf(e){var a,o;let t=Object.values(Ke).reduce((i,r)=>i+((r==null?void 0:r.xrp)||0),0),n=(a=Ce.data)!=null&&a.priceUsd?t*Ce.data.priceUsd:0,s=Tt.items.slice(0,8);return`
    <div class="xpd-token-grid">
      <div class="xpd-token-col">
        <div class="xpd-market-grid">
      ...
      <div class="xpd-token-col">
        ${Tt.loading?'<div class="xpd-loading">Loading recent transactions...</div>':""}
        ${Tt.error?`<div class="xpd-error">${y(Tt.error)}</div>`:""}
    ...
    </div>`}function yf(e){return e?vt.loading?'<div class="xpd-amm-card"><h3>Your liquidity positions</h3><div class="xpd-loading">Loading account_objects and LP balances...</div></div>':vt.error?`<div class="xpd-amm-card"><h3>Your liquidity positions</h3><div class="xpd-error">${y(vt.error)}</div></div>`:vt.pools.length?`<div class="xpd-amm-card"><h3>Your liquidity positions</h3><div class="xpd-pool-list">${vt.pools.map(t=>`
    ...
    </div>`).join("")}</div></div>`:'<div class="xpd-amm-card"><h3>Your liquidity positions</h3><div class="xpd-empty">No AMM entries or LP-token balances detected for this wallet yet.</div></div>':'<div class="xpd-amm-card"><h3>Your liquidity positions</h3><div class="xpd-empty">No active wallet.</div></div>'}function wf(){return Ct.loading?'<div class="xpd-amm-card"><h3>General pool explorer</h3><div class="xpd-loading">Loading amm_info for known pools...</div></div>':Ct.error?`<div class="xpd-amm-card"><h3>General pool explorer</h3><div class="xpd-error">${y(Ct.error)}</div></div>`:Ct.pools.length?`<div class="xpd-amm-card"><h3>General pool explorer</h3><div class="xpd-pool-list">${Ct.pools.map(e=>`
    <div class="xpd-pool-item">
    ...
    </div>`).join("")}</div></div>`:'<div class="xpd-amm-card"><h3>General pool explorer</h3><div class="xpd-empty">No seeded pools returned on this network.</div></div>'}function xf(){return`<div class="xpd-amm-card">
  ...
  </div>`}function Be(e){return Number.isFinite(Number(e))?new Intl.NumberFormat("en-US",{notation:"compact",maximumFractionDigits:2}).format(Number(e)):"\u2014"}function es(e){return typeof e=="string"?`${R(Number(e)/1e6,4)} XRP`:e&&typeof e=="object"?`${R(Number(e.value||0),4)} ${e.currency||"UNK"}`:"\u2014"}function kf(e){if(!e||typeof e!="string")return"";try{let t=e.trim();if(!/^[0-9A-Fa-f]+$/.test(t)||t.length%2!==0)return t;let n=new Uint8Array(t.length/2);for(let s=0;s<t.length;s+=2)n[s/2]=parseInt(t.slice(s,s+2),16);return new TextDecoder().decode(n)}catch{return""}}function bl(e){return e?e.startsWith("ipfs://")?`https://ipfs.io/ipfs/${e.slice(7)}`:e.startsWith("ar://")?`https://arweave.net/${e.slice(5)}`:e:""}async function $f(e){let t=bl(kf(e.URI||e.uri||""));if(!t)return"";if(/\.(png|jpg|jpeg|gif|webp|svg)$/i.test(t))return t;try{let n=await fetch(t,{method:"GET"});if(!n.ok)return"";let s=await n.json(),a=(s==null?void 0:s.image)||(s==null?void 0:s.image_url)||(s==null?void 0:s.thumbnail);return bl(a||"")}catch{return""}}async function Pt(e,{timeoutMs:t=9e3,allowProxy:n=!0}={}){let s=async a=>{let o=typeof(AbortSignal==null?void 0:AbortSignal.timeout)=="function"?AbortSignal.timeout(t):void 0,i=await fetch(a,{method:"GET",mode:"cors",cache:"no-store",signal:o});if(!i.ok)throw new Error(`HTTP ${i.status}`);return await i.json()};try{return await s(e)}catch(a){if(!n)throw a;for(let o of Mm)try{return await s(o(e))}catch{}throw a}}async function Zl(){var e;Ce.loading=!0,Ce.error="",U();try{let t=await Pt("https://api.exchange.coinbase.com/products/XRP-USD/ticker"),n=await Pt("https://api.exchange.coinbase.com/products/XRP-USD/candles?granularity=86400"),s=Array.isArray(n)&&n.length?n[0]:null,a=Number((t==null?void 0:t.price)||0),o=s?Number(s[3]||0):a,i=s?Number(s[2]||a):a,r=s?Number(s[1]||a):a,l=s?Number(s[5]||0):0;Ce.data={priceUsd:a,change24h:o?(a-o)/o*100:0,volume24h:l*a,marketCap:Number(((e=Ce.data)==null?void 0:e.marketCap)||0),high24h:i,low24h:r}}catch(t){Ce.error=(t==null?void 0:t.message)||"Could not load market data right now.",Ce.data=null}finally{Ce.loading=!1,U()}}async function ec(e){if(gt.loading=!0,gt.error="",gt.items=[],U(),!e){gt.loading=!1,U();return}try{let t,n=[];do{let a=await tt({method:"account_nfts",params:[{account:e,limit:100,...t?{marker:t}:{}}]});n.push(...(a==null?void 0:a.account_nfts)||[]),t=a==null?void 0:a.marker}while(t);let s=await Promise.all(n.slice(0,80).map(async a=>({id:a.NFTokenID||a.nf_token_id||"Unknown",image:await $f(a)})));gt.items=s}catch(t){gt.error=(t==null?void 0:t.message)||"Could not load NFTs for this wallet."}finally{gt.loading=!1,U()}}async function tc(e){if(vt.loading=!0,vt.error="",vt.pools=[],U(),!e){vt.loading=!1,U();return}try{let t=[],n;do{let o=await tt({method:"account_objects",params:[{account:e,type:"amm",limit:200,...n?{marker:n}:{}}]});((o==null?void 0:o.account_objects)||[]).forEach(r=>{let l=es(r.Asset||r.amount),c=es(r.Asset2||r.amount2),d=l.split(" ").pop()||"AssetA",u=c.split(" ").pop()||"AssetB";t.push({pair:`${d}/${u}`,lpBalance:r.LPTokenBalance?es(r.LPTokenBalance):"Not reported",estimatedValue:"Estimate unavailable",tradingFee:r.TradingFee!=null?`${r.TradingFee} bps`:"\u2014",tvl:"Unavailable"})}),n=o==null?void 0:o.marker}while(n);let s=await tt({method:"account_lines",params:[{account:e,limit:200}]});((s==null?void 0:s.lines)||[]).filter(o=>typeof o.currency=="string"&&o.currency.length>=16&&Number(o.balance)>0).forEach(o=>{t.push({pair:`LP Token ${o.currency.slice(0,8)}...`,lpBalance:`${R(Number(o.balance),4)} ${o.currency.slice(0,8)}...`,estimatedValue:"Estimate unavailable",tradingFee:"\u2014",tvl:"Unavailable"})}),vt.pools=t}catch(t){vt.error=(t==null?void 0:t.message)||"Could not load account AMM objects."}finally{vt.loading=!1,U()}}async function nc(e){try{let t=await tt({method:"amm_info",params:[{asset:e.asset,asset2:e.asset2}]}),n=t==null?void 0:t.amm;return n?{label:e.label,reserveA:es(n.amount),reserveB:es(n.amount2),tradingFee:String(n.trading_fee??"\u2014"),totalLp:es(n.lp_token||n.lp_token_balance),tvl:Sf(n.amount,n.amount2)}:null}catch{return null}}function Sf(e,t){let n=a=>typeof a=="string"?Number(a)/1e6:a&&typeof a=="object"?Number(a.value||0):0,s=n(e)+n(t);return!Number.isFinite(s)||s<=0?"Unavailable":`${R(s,4)} (asset units)`}async function sc(){Ct.loading=!0,Ct.error="",U();try{let e=await Promise.all(Km.map(nc));Ct.pools=e.filter(Boolean)}catch(e){Ct.error=(e==null?void 0:e.message)||"Could not load AMM explorer data.",Ct.pools=[]}finally{Ct.loading=!1,U()}}async function ac(){var r,l,c,d;let e=(((r=document.getElementById("xpd-asset1-currency"))==null?void 0:r.value)||"").trim().toUpperCase(),t=(((l=document.getElementById("xpd-asset1-issuer"))==null?void 0:l.value)||"").trim(),n=(((c=document.getElementById("xpd-asset2-currency"))==null?void 0:c.value)||"").trim().toUpperCase(),s=(((d=document.getElementById("xpd-asset2-issuer"))==null?void 0:d.value)||"").trim();if(!e||!n){_e.error="Enter both asset currency codes first.",U();return}let a=e==="XRP"?{currency:"XRP"}:{currency:e,issuer:t},o=n==="XRP"?{currency:"XRP"}:{currency:n,issuer:s};if(e!=="XRP"&&!t||n!=="XRP"&&!s){_e.error="Issuer is required for non-XRP assets.",U();return}_e.loading=!0,_e.error="",_e.pool=null,U();let i=await nc({label:`${e}/${n}`,asset:a,asset2:o});_e.loading=!1,i?_e.pool=i:_e.error="Pool not found or unavailable on this network.",U()}function Aa(){return In.find(e=>e.id===C.pair)||In[0]}function di(e){if(e==="D")return 1440;if(e==="W")return 10080;if(e==="M")return 43200;let t=Number(e);return Number.isFinite(t)&&t>0?t:60}function Tf(e){if(e==="M")return"W";if(e==="D"||e==="W")return e;let t=di(e);for(let n of[5,15,60,240])if(t<=n)return String(n);return"D"}async function Cf(e,t,n,s=200){var d;let a=t?`${e}.${t}`:e,o=Tf(n),i=Math.min(2e3,Math.max(20,Number(s)||200)),r=`https://api.onthedex.live/public/v1/ohlc?base=${encodeURIComponent(a)}&quote=XRP&interval=${o}&bars=${i}`,l=await Pt(r,{timeoutMs:1e4});return(Array.isArray((d=l==null?void 0:l.data)==null?void 0:d.ohlc)?l.data.ohlc:[]).map(u=>({time:Number(u.t),open:Number(u.o),high:Number(u.h),low:Number(u.l),close:Number(u.c),volume:Number(u.vb||0)})).filter(u=>Number.isFinite(u.time)&&[u.open,u.high,u.low,u.close].every(Number.isFinite)).sort((u,p)=>u.time-p.time)}function oc(e){return{xrpusd:"XRP-USD",XRPUSDT:"XRP-USD",ETHUSDT:"ETH-USD",BTCUSDT:"BTC-USD",SOLUSDT:"SOL-USD"}[e]||null}function Pf(e){return{XRP:"XRP-USD",BTC:"BTC-USD",ETH:"ETH-USD",SOL:"SOL-USD",USDC:"USDC-USD"}[String(e||"").toUpperCase()]||null}var Ho=new Map;async function Lf(e,t){if(!e)return null;let n=`${He(e)}:${t}`,s=Ho.get(n);if(s)return s;let a=Mf(e,t);Ho.set(n,a);try{return await a}finally{Ho.delete(n)}}async function Mf(e,t){var o,i;let n=String(e.symbol||"").toUpperCase();if(!n||n==="XRP")return null;let s=Pf(n);if(s)try{let r=lc(t),l=r===86400?_l:Rl,{candles:c,reachedStart:d}=await Jo(s,r,l);if(c.length){let u=d?`${new Date(c[0].time*1e3).getUTCFullYear()}\u2013present`:`last ${c.length} bars`;return{candles:c,source:`Coinbase direct (${s}, ${u})`,mode:"token-direct"}}}catch{}let a=String(e.issuer||"").trim();if(a)try{let r=await Cf(n,a,t,2e3);if(r.length){let l=Number(((o=C.stats)==null?void 0:o.xrplSpot)||((i=C.stats)==null?void 0:i.price)||0);return{candles:l>0?r.map(d=>({time:d.time,open:d.open*l,high:d.high*l,low:d.low*l,close:d.close*l,volume:d.volume})):r,source:`OnTheDex XRPL DEX (${n}/XRP)`,mode:"token-direct"}}}catch{}return null}function Af(e,{mode:t="pair",source:n="Source pending",tokenKey:s=""}={}){let a=Array.isArray(e)?e:[];if(!a.length){C.chartMeta={tokenKey:s||C.tokenFocusKey||"XRP|",symbol:s&&s.split("|")[0]||"XRP",source:n,last:null,high:null,low:null,mode:t};return}let o=a[a.length-1],i=a.map(c=>Number(c.high)).filter(c=>Number.isFinite(c)),r=a.map(c=>Number(c.low)).filter(c=>Number.isFinite(c)),l=s||C.tokenFocusKey||"XRP|";C.chartMeta={tokenKey:l,symbol:l.split("|")[0]||"XRP",source:n,last:Number(o.close),high:i.length?Math.max(...i):Number(o.high),low:r.length?Math.min(...r):Number(o.low),mode:t}}async function Ds(){var t;let e=Aa();C.loading=!0,C.error="";try{let n=oc(e.ticker);if(n){let s=await Pt(`https://api.exchange.coinbase.com/products/${n}/ticker`),a=await Pt(`https://api.exchange.coinbase.com/products/${n}/candles?granularity=86400`),o=Array.isArray(a)&&a.length?a[0]:null,i=Number(s.price||0),r=o?Number(o[3]):i;C.stats={price:i,high:o?Number(o[2]):i,low:o?Number(o[1]):i,changePct:r?(i-r)/r*100:0,baseSource:"Coinbase",source:"Coinbase"},await ic(),!Ce.data&&C.stats.price&&(Ce.data={priceUsd:C.stats.price,change24h:C.stats.changePct,volume24h:o?Number(o[5]||0)*C.stats.price:0,marketCap:Number(((t=Ce.data)==null?void 0:t.marketCap)||0)});return}throw new Error("Chart stats unavailable for selected pair.")}catch(n){C.error=(n==null?void 0:n.message)||"DEX chart stats unavailable right now."}finally{C.loading=!1}}async function ic(){var e,t,n;try{let s=await tt({method:"book_offers",params:[{taker_gets:{currency:"USD",issuer:"rhub8VRN55s94qWKDv6jmDy1pUykJzF3wq"},taker_pays:{currency:"XRP"},limit:1}]}),a=(e=s==null?void 0:s.offers)==null?void 0:e[0];if(!a)return;let o=Number(((t=a.TakerGets)==null?void 0:t.value)||0),i=typeof a.TakerPays=="string"?Number(a.TakerPays)/1e6:Number(((n=a.TakerPays)==null?void 0:n.value)||0);if(o>0&&i>0){let r=o/i;if(Nl=Date.now(),C.stats||(C.stats={}),C.stats.xrplSpot=r,String(Aa().symbol||"XRP").toUpperCase()==="XRP"){C.stats.price=r;let l=C.stats.baseSource||C.stats.source||"Market feed";C.stats.source=`${l} + XRPL live`,Ce.data&&(Ce.data.priceUsd=r)}}}catch{}}async function Ef(){var e,t;return(e=window.LightweightCharts)!=null&&e.createChart?!0:(xa||(xa=new Promise((n,s)=>{let a=document.querySelector('script[data-lw-chart="1"]');if(a){a.addEventListener("load",()=>n(!0),{once:!0}),a.addEventListener("error",()=>s(new Error("Chart library failed to load.")),{once:!0});return}let o=document.createElement("script");o.src="https://unpkg.com/lightweight-charts@4.2.2/dist/lightweight-charts.standalone.production.js",o.async=!0,o.defer=!0,o.dataset.lwChart="1",o.onload=()=>n(!0),o.onerror=()=>s(new Error("Chart library failed to load.")),document.head.appendChild(o)}).finally(()=>{var n;(n=window.LightweightCharts)!=null&&n.createChart||(xa=null)})),await xa,!!((t=window.LightweightCharts)!=null&&t.createChart))}async function Nf(){var e,t;return(e=window.THREE)!=null&&e.Scene?!0:(ka||(ka=new Promise((n,s)=>{let a=document.querySelector('script[data-three-chart="1"]');if(a){a.addEventListener("load",()=>n(!0),{once:!0}),a.addEventListener("error",()=>s(new Error("Three.js failed to load.")),{once:!0});return}let o=document.createElement("script");o.src="https://unpkg.com/three@0.166.1/build/three.min.js",o.async=!0,o.defer=!0,o.dataset.threeChart="1",o.onload=()=>n(!0),o.onerror=()=>s(new Error("Three.js failed to load.")),document.head.appendChild(o)}).finally(()=>{var n;(n=window.THREE)!=null&&n.Scene||(ka=null)})),await ka,!!((t=window.THREE)!=null&&t.Scene))}function Is(){var e,t;if(We.resizeHandler)try{window.removeEventListener("resize",We.resizeHandler)}catch{}if(We.raf&&cancelAnimationFrame(We.raf),(t=(e=We.renderer)==null?void 0:e.domElement)!=null&&t.parentElement)try{We.renderer.domElement.parentElement.removeChild(We.renderer.domElement)}catch{}if(We.renderer)try{We.renderer.dispose()}catch{}We={renderer:null,scene:null,camera:null,points:null,raf:0,host:null,resizeHandler:null}}async function _f(){var t;let e=document.getElementById("xpd-chart-atmosphere");if(e&&!(We.renderer&&e.contains(We.renderer.domElement))&&!((navigator.hardwareConcurrency||4)<=3))try{if(await Nf(),!((t=window.THREE)!=null&&t.Scene))return;Is();let n=window.THREE,s=Math.max(1,e.clientWidth||640),a=Math.max(1,e.clientHeight||460),o=new n.Scene,i=new n.PerspectiveCamera(52,s/a,.1,1e3);i.position.z=46;let r=new n.WebGLRenderer({alpha:!0,antialias:!0});r.setPixelRatio(Math.min(2,window.devicePixelRatio||1)),r.setSize(s,a),e.appendChild(r.domElement);let l=900,c=new Float32Array(l*3);for(let h=0;h<l;h+=1){let g=h*3;c[g]=(Math.random()-.5)*90,c[g+1]=(Math.random()-.5)*40,c[g+2]=(Math.random()-.5)*24}let d=new n.BufferGeometry;d.setAttribute("position",new n.BufferAttribute(c,3));let u=new n.PointsMaterial({color:5101823,size:.25,transparent:!0,opacity:.26,depthWrite:!1}),p=new n.Points(d,u);o.add(p);let m=0,f=0,v=()=>{var $;m+=1;let h=Number((($=C.stats)==null?void 0:$.changePct)||0),g=Math.min(4,Math.max(.35,Math.abs(h)/2.2)),w=h>0?16758874:16739999;u.color.setHex(Math.abs(h)>1.5?w:5101823),p.rotation.y+=9e-4*g,p.rotation.x=Math.sin(m*.0015*g)*.08,p.position.y=Math.sin(m*.003*g)*.7,(!document.hidden||Date.now()-f>350)&&(r.render(o,i),f=Date.now()),We.raf=requestAnimationFrame(v)},b=()=>{let h=Math.max(1,e.clientWidth||640),g=Math.max(1,e.clientHeight||460);i.aspect=h/g,i.updateProjectionMatrix(),r.setSize(h,g)};window.addEventListener("resize",b,{passive:!0}),We={renderer:r,scene:o,camera:i,points:p,raf:0,host:e,resizeHandler:b},v()}catch{}}function rc(e){return di(e)*60}function lc(e){let t=di(e);return t<=1?60:t<=5?300:t<=15?900:t<=60?3600:t<=360?21600:86400}function cc(){let e=String(C.tokenFocusKey||"");if(!e)return null;let t=e.includes("|")?e.split("|")[0]:e;return W.tokens.find(n=>He(n)===e)||W.tokens.find(n=>String(n.symbol||"").toUpperCase()===String(t||"").toUpperCase())||null}function dc(){var a,o;let e=cc(),t=Number((e==null?void 0:e.price)||0);if(Number.isFinite(t)&&t>0)return t;let n=Number(((a=C.stats)==null?void 0:a.xrplSpot)||0);if(Number.isFinite(n)&&n>0)return n;let s=Number(((o=C.stats)==null?void 0:o.price)||0);return Number.isFinite(s)&&s>0?s:1}function pc(e,t=1,n=220){let s=Math.max(60,rc(e)),a=Math.floor(Date.now()/1e3),o=Math.floor(a/s)*s-n*s,i=Math.max(1e-6,Number(t)||1),r=[];for(let l=0;l<n;l+=1){let c=o+l*s,d=i,u=Math.sin((l+1)/9)*.004+Math.cos((l+3)/17)*.002;i=Math.max(1e-6,d*(1+u));let p=Math.max(d,i)*(1+Math.abs(u)*.55+.0015),m=Math.min(d,i)*Math.max(1e-6,1-(Math.abs(u)*.55+.0015));r.push({time:c,open:Number(d),high:Number(p),low:Number(m),close:Number(i),volume:Math.max(0,Math.round(Math.abs(u)*12e3+l%13*55))})}return r}function Vo(e){if(!e.length)return e;let t=[];for(let n=0;n<e.length;n+=1){let s=e[n],a=(s.open+s.high+s.low+s.close)/4,o=t[n-1],i=o?(o.open+o.close)/2:(s.open+s.close)/2,r=Math.max(s.high,i,a),l=Math.min(s.low,i,a);t.push({...s,open:i,high:r,low:l,close:a})}return t}function Go(e,t){let n=[],s=0;for(let a=0;a<e.length;a+=1)s+=e[a].close,a>=t&&(s-=e[a-t].close),a>=t-1&&n.push({time:e[a].time,value:s/t});return n}function _s(e,t){let n=[];if(!e.length)return n;let s=2/(t+1),a=e[0].close;for(let o=0;o<e.length;o+=1)a=o===0?e[o].close:e[o].close*s+a*(1-s),o>=t-1&&n.push({time:e[o].time,value:a});return n}function Rf(e,t){let n=[],s=t*(t+1)/2;for(let a=t-1;a<e.length;a+=1){let o=0;for(let i=0;i<t;i+=1)o+=e[a-i].close*(t-i);n.push({time:e[a].time,value:o/s})}return n}function Df(e,t=20,n=2){let s=Go(e,t),a=[],o=[];for(let i=t-1;i<e.length;i+=1){let r=e.slice(i-t+1,i+1),l=s[i-(t-1)].value,c=r.reduce((u,p)=>u+Math.pow(p.close-l,2),0)/t,d=Math.sqrt(c);a.push({time:e[i].time,value:l+d*n}),o.push({time:e[i].time,value:l-d*n})}return{upper:a,lower:o}}function If(e){let t=[],n=0,s=0;for(let a=0;a<e.length;a+=1){let o=(e[a].high+e[a].low+e[a].close)/3;n+=o*(e[a].volume||0),s+=e[a].volume||0,s>0&&t.push({time:e[a].time,value:n/s})}return t}function Ff(e,t=14){let n=[];if(e.length<=t)return n;let s=0,a=0;for(let r=1;r<=t;r+=1){let l=e[r].close-e[r-1].close;s+=l>0?l:0,a+=l<0?-l:0}let o=s/t,i=a/t;for(let r=t+1;r<e.length;r+=1){let l=e[r].close-e[r-1].close;o=(o*(t-1)+(l>0?l:0))/t,i=(i*(t-1)+(l<0?-l:0))/t;let c=i>0?o/i:100;n.push({time:e[r].time,value:100-100/(1+c)})}return n}function pi(e,t=14){let n=[];for(let o=0;o<e.length;o+=1){let i=o>0?e[o-1].close:e[o].close;n.push(Math.max(e[o].high-e[o].low,Math.abs(e[o].high-i),Math.abs(e[o].low-i)))}let s=[],a=n.slice(0,t).reduce((o,i)=>o+i,0)/Math.max(1,t);for(let o=t;o<e.length;o+=1)a=(a*(t-1)+n[o])/t,s.push({time:e[o].time,value:a});return s}function Of(e,t=14,n=3){let s=[];for(let o=t-1;o<e.length;o+=1){let i=e.slice(o-t+1,o+1),r=Math.max(...i.map(d=>d.high)),l=Math.min(...i.map(d=>d.low)),c=r!==l?(e[o].close-l)/(r-l)*100:50;s.push({time:e[o].time,value:c})}let a=[];for(let o=n-1;o<s.length;o+=1){let i=s.slice(o-n+1,o+1).reduce((r,l)=>r+l.value,0)/n;a.push({time:s[o].time,value:i})}return{k:s,d:a}}function Xf(e,t=12,n=26,s=9){let a=_s(e,t),o=_s(e,n),i=new Map(o.map(u=>[u.time,u.value])),r=a.filter(u=>i.has(u.time)).map(u=>({time:u.time,value:u.value-i.get(u.time)})),l=[];if(r.length){let u=2/(s+1),p=r[0].value;for(let m=0;m<r.length;m+=1)p=m===0?r[m].value:r[m].value*u+p*(1-u),m>=s-1&&l.push({time:r[m].time,value:p})}let c=new Map(l.map(u=>[u.time,u.value])),d=r.filter(u=>c.has(u.time)).map(u=>({time:u.time,value:u.value-c.get(u.time)}));return{line:r,signal:l,hist:d}}function uc(e,t=9,n=26,s=52){let a=u=>{let p=[];for(let m=u-1;m<e.length;m+=1){let f=e.slice(m-u+1,m+1);p.push({time:e[m].time,value:(Math.max(...f.map(v=>v.high))+Math.min(...f.map(v=>v.low)))/2})}return p},o=a(t),i=a(n),r=new Map(i.map(u=>[u.time,u.value])),l=o.filter(u=>r.has(u.time)).map(u=>({time:u.time,value:(u.value+r.get(u.time))/2})),c=a(s),d=e.map(u=>({time:u.time,value:u.close}));return{tenkan:o,kijun:i,senkouA:l,senkouB:c,chikou:d}}function Bf(e,t=20){let n=[],s=[],a=[];for(let o=t-1;o<e.length;o+=1){let i=e.slice(o-t+1,o+1),r=Math.max(...i.map(c=>c.high)),l=Math.min(...i.map(c=>c.low));n.push({time:e[o].time,value:r}),s.push({time:e[o].time,value:l}),a.push({time:e[o].time,value:(r+l)/2})}return{upper:n,lower:s,mid:a}}function Hf(e,t=20,n=2){let s=_s(e,t),a=pi(e,t),o=new Map(a.map(l=>[l.time,l.value])),i=[],r=[];return s.forEach(l=>{if(o.has(l.time)){let c=o.get(l.time)*n;i.push({time:l.time,value:l.value+c}),r.push({time:l.time,value:l.value-c})}}),{upper:i,lower:r,mid:s}}function zf(e){let t=[],n=[],s=0,a=0;for(let o=0;o<e.length;o+=1){if(o>0){let l=e[o-1];e[o].close>l.close&&(s+=e[o].volume||0),e[o].close<l.close&&(s-=e[o].volume||0)}let i=e[o].high-e[o].low||1,r=(e[o].close-e[o].low-(e[o].high-e[o].close))/i;a+=r*(e[o].volume||0),t.push({time:e[o].time,value:s}),n.push({time:e[o].time,value:a})}return{obv:t,adline:n}}function jf(e,t=14){if(e.length<t+2)return{adx:[],plusDi:[],minusDi:[]};let n=[],s=[],a=[];for(let p=1;p<e.length;p+=1){let m=e[p].high-e[p-1].high,f=e[p-1].low-e[p].low;s.push(m>f&&m>0?m:0),a.push(f>m&&f>0?f:0),n.push(Math.max(e[p].high-e[p].low,Math.abs(e[p].high-e[p-1].close),Math.abs(e[p].low-e[p-1].close)))}let o=n.slice(0,t).reduce((p,m)=>p+m,0),i=s.slice(0,t).reduce((p,m)=>p+m,0),r=a.slice(0,t).reduce((p,m)=>p+m,0),l=[],c=[],d=[];for(let p=t;p<n.length;p+=1){o=o-o/t+n[p],i=i-i/t+s[p],r=r-r/t+a[p];let m=o>0?100*i/o:0,f=o>0?100*r/o:0,v=m+f>0?100*Math.abs(m-f)/(m+f):0,b=e[p+1].time;l.push({time:b,value:m}),c.push({time:b,value:f}),d.push({time:b,value:v})}let u=[];if(d.length>=t){let p=d.slice(0,t).reduce((m,f)=>m+f.value,0)/t;for(let m=t;m<d.length;m+=1)p=(p*(t-1)+d[m].value)/t,u.push({time:d[m].time,value:p})}return{adx:u,plusDi:l,minusDi:c}}function Wf(e,t=14){let n=[],s=[];for(let a=t-1;a<e.length;a+=1){let o=e.slice(a-t+1,a+1),i=0,r=0;for(let d=1;d<o.length;d+=1)o[d].high>=o[i].high&&(i=d),o[d].low<=o[r].low&&(r=d);let l=t-1-i,c=t-1-r;n.push({time:e[a].time,value:(t-l)/t*100}),s.push({time:e[a].time,value:(t-c)/t*100})}return{up:n,down:s}}function Uf(e,t=14){let n=[],s=[];if(e.length<t+2)return{plus:n,minus:s};for(let a=t;a<e.length;a+=1){let o=0,i=0,r=0;for(let l=a-t+1;l<=a;l+=1){let c=e[l-1],d=e[l];o+=Math.max(d.high-d.low,Math.abs(d.high-c.close),Math.abs(d.low-c.close)),i+=Math.abs(d.high-c.low),r+=Math.abs(d.low-c.high)}n.push({time:e[a].time,value:o>0?i/o:0}),s.push({time:e[a].time,value:o>0?r/o:0})}return{plus:n,minus:s}}function qf(e,t=10,n=3){let s=pi(e,t),a=new Map(s.map(c=>[c.time,c.value])),o=[],i=0,r=0,l=!0;return e.forEach((c,d)=>{if(d===0||!a.has(c.time))return;let u=(c.high+c.low)/2,p=a.get(c.time),m=u+n*p,f=u-n*p;d>1&&(m>i&&e[d-1].close<=i&&(m=i),f<r&&e[d-1].close>=r&&(f=r));let v=c.close>m?!0:c.close<f?!1:l,b=v?f:m;o.push({time:c.time,value:b,trendUp:v?1:0}),i=m,r=f,l=v}),o}function Vf(e,t=14){let n=[];if(e.length<=t)return n;let s=e.map((a,o)=>{let i=(a.high+a.low+a.close)/3,r=o>0?(e[o-1].high+e[o-1].low+e[o-1].close)/3:i,l=i*(a.volume||0);return{time:a.time,pos:i>=r?l:0,neg:i<r?l:0}});for(let a=t;a<s.length;a+=1){let o=s.slice(a-t+1,a+1),i=o.reduce((c,d)=>c+d.pos,0),r=o.reduce((c,d)=>c+d.neg,0),l=r>0?i/r:100;n.push({time:s[a].time,value:100-100/(1+l)})}return n}function Gf(e,t=14){let n=[];for(let s=t-1;s<e.length;s+=1){let a=e.slice(s-t+1,s+1),o=Math.max(...a.map(l=>l.high)),i=Math.min(...a.map(l=>l.low)),r=o!==i?(o-e[s].close)/(o-i)*-100:-50;n.push({time:e[s].time,value:r})}return n}function Kf(e,t=20){let n=[],s=e.map(a=>({time:a.time,value:(a.high+a.low+a.close)/3}));for(let a=t-1;a<s.length;a+=1){let o=s.slice(a-t+1,a+1),i=o.reduce((c,d)=>c+d.value,0)/t,r=o.reduce((c,d)=>c+Math.abs(d.value-i),0)/t,l=r>0?(s[a].value-i)/(.015*r):0;n.push({time:s[a].time,value:l})}return n}function Jf(e){if(e.length<30)return[];let t=[],n=[];for(let o=1;o<e.length;o+=1){let i=e[o-1].close,r=Math.min(e[o].low,i),l=Math.max(e[o].high,i);t.push({time:e[o].time,value:e[o].close-r}),n.push({time:e[o].time,value:l-r})}let s=(o,i,r)=>o.slice(i-r+1,i+1).reduce((l,c)=>l+c.value,0),a=[];for(let o=27;o<t.length;o+=1){let i=s(t,o,7)/Math.max(1e-9,s(n,o,7)),r=s(t,o,14)/Math.max(1e-9,s(n,o,14)),l=s(t,o,28)/Math.max(1e-9,s(n,o,28));a.push({time:t[o].time,value:100*(4*i+2*r+l)/7})}return a}function Yf(e,t=20){let n=[],s=e.map(a=>{let o=a.high-a.low||1,i=(a.close-a.low-(a.high-a.close))/o;return{time:a.time,value:i*(a.volume||0),volume:a.volume||0}});for(let a=t-1;a<s.length;a+=1){let o=s.slice(a-t+1,a+1),i=o.reduce((l,c)=>l+c.value,0),r=o.reduce((l,c)=>l+c.volume,0);n.push({time:s[a].time,value:r>0?i/r:0})}return n}function Qf(e){return(Array.isArray(e)?e:[]).map(t=>({time:Number(t[0]),low:Number(t[1]),high:Number(t[2]),open:Number(t[3]),close:Number(t[4]),volume:Number(t[5])})).filter(t=>Number.isFinite(t.time)&&[t.open,t.high,t.low,t.close].every(Number.isFinite))}function Ko(e,t){let n=new Map;for(let s of e)n.set(s.time,s);for(let s of t)n.set(s.time,s);return Array.from(n.values()).sort((s,a)=>s.time-a.time)}async function Jo(e,t,n){let s=[],a=Math.floor(Date.now()/1e3),o=!1;for(let i=0;i<n;i+=1){let r=a-t*300,l=`https://api.exchange.coinbase.com/products/${e}/candles?granularity=${t}&start=${new Date(r*1e3).toISOString()}&end=${new Date(a*1e3).toISOString()}`,c;try{c=await Pt(l,{timeoutMs:1e4})}catch{break}let d=Qf(c);if(!d.length){o=!0;break}s.push(...d),a=r,i<n-1&&await Wm(jm)}return{candles:Ko(s,[]),reachedStart:o}}async function Zf(e,t,n){if(!e||!Number.isFinite(t)||!Number.isFinite(n)||n<=t)return[];try{let s=`https://api.coingecko.com/api/v3/coins/${e}/market_chart/range?vs_currency=usd&from=${t}&to=${n}`,a=await Pt(s,{timeoutMs:15e3});return(Array.isArray(a==null?void 0:a.prices)?a.prices:[]).map(([i,r])=>({time:Math.floor(Number(i)/1e3/86400)*86400,open:Number(r),high:Number(r),low:Number(r),close:Number(r),volume:0})).filter(i=>Number.isFinite(i.time)&&Number.isFinite(i.close)&&i.close>0).sort((i,r)=>i.time-r.time)}catch{return[]}}async function eh(e,t,n){var u;let s=lc(n),a=s===86400,o=`${zm}${e.id}:${s}`,i=ve(Q(o));if((u=i==null?void 0:i.candles)!=null&&u.length&&i.reachedStart){let p=await Jo(t,s,1),m=Ko(i.candles,p.candles);return Z(o,JSON.stringify({candles:m,reachedStart:!0,source:i.source,cachedAt:Date.now()})),{candles:m,source:i.source}}let l=await Jo(t,s,a?_l:Rl),c=l.candles,d=c.length?`Coinbase (${new Date(c[0].time*1e3).getUTCFullYear()}\u2013present, ${c.length} bars)`:"Coinbase";if(a&&l.reachedStart&&e.coingeckoId&&c.length){let p=c[0].time,m=await Zf(e.coingeckoId,0,p);m.length&&(c=Ko(m,c),d=`CoinGecko (${new Date(c[0].time*1e3).getUTCFullYear()}+) + Coinbase (${new Date(p*1e3).getUTCFullYear()}\u2013present)`)}else!a&&!l.reachedStart&&(d=`Coinbase (last ${c.length} bars \u2014 full inception history is daily/weekly/monthly only)`);return c.length&&Z(o,JSON.stringify({candles:c,reachedStart:l.reachedStart,source:d,cachedAt:Date.now()})),{candles:c,source:d}}var zo=new Map;async function mc(e,t){let n=`${e.id}:${t}`,s=Ms.get(n);if(s&&Date.now()-s.ts<6e4&&Array.isArray(s.data)&&s.data.length)return s.data;let a=zo.get(n);if(a)return a;let o=(async()=>{let i=[],r="",l=oc(e.ticker);if(l)try{let c=await eh(e,l,t);i=c.candles,r=c.source}catch{i=[]}if(!Array.isArray(i)||!i.length){let c=pc(t,dc());return Ms.set(n,{ts:Date.now(),data:c,sourceLabel:""}),c}return Ms.set(n,{ts:Date.now(),data:i,sourceLabel:r}),i})();zo.set(n,o);try{return await o}finally{zo.delete(n)}}async function th(){var u,p,m,f,v,b,h,g;let e=Aa(),t=await mc(e,C.interval),s=((u=Ms.get(`${e.id}:${C.interval}`))==null?void 0:u.sourceLabel)||String(((p=C.stats)==null?void 0:p.source)||"Coinbase + XRPL live"),a="pair",o=cc(),i=String((o==null?void 0:o.symbol)||"").toUpperCase(),r=o?He(o):`${e.symbol||"XRP"}|`;if(o&&i&&i!=="XRP"){let w=await Lf(o,C.interval);(m=w==null?void 0:w.candles)!=null&&m.length&&(t=w.candles,s=w.source,a=w.mode)}let l=String(e.symbol||"XRP").toUpperCase()==="XRP",c=Number((l?(f=C.stats)==null?void 0:f.xrplSpot:null)??((v=C.stats)==null?void 0:v.price)??0);if(a==="pair"&&Number.isFinite(c)&&c>0&&t.length){let w=Math.max(60,rc(C.interval)),k=Math.floor(Date.now()/1e3),$=Math.floor(k/w)*w,T=t[t.length-1];T.time===$?(T.high=Math.max(T.high,c),T.low=Math.min(T.low,c),T.close=c):T.time<$&&t.push({time:$,open:T.close,high:Math.max(T.close,c),low:Math.min(T.close,c),close:c,volume:0})}let d=Number((o==null?void 0:o.price)||0);if(a==="pair"&&o&&i&&i!=="XRP"&&Number.isFinite(d)&&d>0&&t.length){let w=Number((l?(b=C.stats)==null?void 0:b.xrplSpot:null)??((h=C.stats)==null?void 0:h.price)??((g=t[t.length-1])==null?void 0:g.close)??0);if(Number.isFinite(w)&&w>0){let k=d/w;Number.isFinite(k)&&k>0&&(t=t.map($=>({...$,open:$.open*k,high:$.high*k,low:$.low*k,close:$.close*k})),s="Coinbase pair + token spot proxy",a="token-proxy")}}return t.length||(t=pc(C.interval,dc()),s=o&&i!=="XRP"?"Synthetic fallback (token-focused)":"Synthetic fallback",a="fallback"),o&&i!=="XRP"&&(a==="pair"||a==="fallback")?Xo!==r&&(Xo=r,ge(`No market data found for ${o.symbol} yet \u2014 showing ${e.symbol||"XRP"} for reference.`)):r&&(Xo=""),C.chartType==="heikin_ashi"&&(t=Vo(t)),Af(t,{mode:a,source:s,tokenKey:r||"XRP|"}),t}function yl(e){if(!Array.isArray(e))return[];let t=e.map(s=>({time:Number(s.time),open:Number(s.open),high:Number(s.high),low:Number(s.low),close:Number(s.close),volume:Number(s.volume||0)})).filter(s=>Number.isFinite(s.time)&&Number.isFinite(s.open)&&Number.isFinite(s.high)&&Number.isFinite(s.low)&&Number.isFinite(s.close)&&s.time>0).sort((s,a)=>s.time-a.time),n=[];for(let s=0;s<t.length;s+=1){let a=t[s],o=n[n.length-1];o&&o.time===a.time?n[n.length-1]=a:n.push(a)}return n}function nh(e,t,n){var i;let s=Number(((i=e==null?void 0:e[e.length-1])==null?void 0:i.close)||0);if(!Number.isFinite(s)||s<=0)return 6;let o=Math.max(1e-12,Math.abs(Number(n)-Number(t)))/Math.max(1e-12,Math.abs(s));return s>=1e3?o<.01?4:2:s>=1?o<.01?6:4:s>=.01?o<.03?8:6:8}function sh(){if(ee.resizeObserver)try{ee.resizeObserver.disconnect()}catch{}ee.chart&&(ee.chart.remove(),ee={chart:null,volumeSeries:null,activeSeries:null,compareSeries:null,indicatorSeries:[],indicatorPriceLines:[],priceLines:[],resizeObserver:null,chartType:"",configKey:"",legendEl:null,renderLegend:null,ichimokuData:null,indicatorLegendItems:[],alertPriceLines:[]})}function wl(e,t){var d;let{addOverlay:n,addOsc:s,addOscHist:a,addPriceLevel:o}=t,i=(u,p)=>{var f,v;let m=Number((v=(f=C.indicatorSettings)==null?void 0:f[u])==null?void 0:v.length);return Number.isFinite(m)&&m>1?Math.min(500,Math.max(2,m)):p},r=(u,p,m)=>{var b,h;let f=(h=(b=C.indicatorSettings)==null?void 0:b[u])==null?void 0:h[p];if(f==null||f==="")return m;let v=(ai[u]||[]).find(g=>g.id===p);if((v==null?void 0:v.type)==="number"){let g=Number(f);return Number.isFinite(g)&&g>1?Math.min(500,Math.max(2,g)):m}return f},l=C.indicators;if(l.sma20&&n(Go(e,i("sma20",20)),r("sma20","color","#f1c40f"),1.2,!1,"SMA"),l.ema20&&n(_s(e,i("ema20",20)),r("ema20","color","#ffb86c"),1.2,!1,"EMA"),l.wma20&&n(Rf(e,i("wma20",20)),r("wma20","color","#bd93f9"),1.2,!1,"WMA"),l.vwap&&n(If(e),r("vwap","color","#80ffea"),1.2,!1,"VWAP"),l.bb20){let u=r("bb20","color","#ff79c6"),p=Df(e,i("bb20",20),2);n(p.upper,u,1,!0,"BB Upper"),n(p.lower,u,1,!0,"BB Lower")}if(l.ichimoku){let u=uc(e,r("ichimoku","tenkanLen",9),r("ichimoku","kijunLen",26),r("ichimoku","senkouBLen",52));n(u.tenkan,r("ichimoku","tenkanColor","#ffde59"),1.2,!1,"Tenkan"),n(u.kijun,r("ichimoku","kijunColor","#6ecbff"),1.2,!1,"Kijun"),n(u.senkouA,"rgba(70,255,160,0.8)",1,!0,"Senkou A"),n(u.senkouB,"rgba(255,120,120,0.8)",1,!0,"Senkou B"),n(u.chikou,"rgba(220,220,255,0.6)",.9,!0,"Chikou")}if(l.donchian){let u=r("donchian","color","#9cfb8c"),p=Bf(e,i("donchian",20));n(p.upper,u,1,!0,"Donchian Upper"),n(p.lower,u,1,!0,"Donchian Lower"),n(p.mid,"rgba(156,251,140,0.6)",1.2,!1,"Donchian Mid")}if(l.keltner){let u=r("keltner","color","#7ee7ff"),p=Hf(e,i("keltner",20),2);n(p.upper,u,1,!0,"Keltner Upper"),n(p.lower,u,1,!0,"Keltner Lower"),n(p.mid,"rgba(126,231,255,0.66)",1.2,!1,"Keltner Mid")}if(l.pivots&&e.length>=2){let u=e[e.length-2],p=(u.high+u.low+u.close)/3,m=2*p-u.low,f=2*p-u.high,v=p+(u.high-u.low),b=p-(u.high-u.low);o(p,"#f6f6f6","P"),o(m,"#61ffb0","R1"),o(f,"#ff8f8f","S1"),o(v,"rgba(97,255,176,0.6)","R2"),o(b,"rgba(255,143,143,0.6)","S2")}if(l.supertrend||l.sar||l.elderRay){let u=_s(e,14);if(l.supertrend&&n(qf(e,10,3),r("supertrend","color","#8bffde"),1.3,!1,"Supertrend"),l.sar&&n(u.map(p=>({time:p.time,value:p.value*.998})),r("sar","color","#ffaf7a"),1,!0,"SAR"),l.elderRay){let p=new Map(u.map(v=>[v.time,v.value])),m=e.filter(v=>p.has(v.time)).map(v=>({time:v.time,value:v.high-p.get(v.time)})),f=e.filter(v=>p.has(v.time)).map(v=>({time:v.time,value:v.low-p.get(v.time)}));s(m,r("elderRay","bullColor","#5fff9d"),"Elder Bull"),s(f,r("elderRay","bearColor","#ff9d9d"),"Elder Bear")}}if(l.rsi&&s(Ff(e,i("rsi",14)),r("rsi","color","#a6ff4d"),"RSI"),l.atr&&s(pi(e,i("atr",14)),r("atr","color","#ffb86c"),"ATR"),l.stdev){let u=Go(e,20),p=new Map(u.map(f=>[f.time,f.value])),m=e.filter(f=>p.has(f.time)).map(f=>({time:f.time,value:Math.abs(f.close-p.get(f.time))}));s(m,r("stdev","color","#b2a3ff"),"StdDev")}if(l.stoch){let u=Of(e,i("stoch",14),3);s(u.k,r("stoch","kColor","#9ee8ff"),"%K"),s(u.d,r("stoch","dColor","#ffd86b"),"%D")}if(l.macd){let u=Xf(e,r("macd","fastLen",12),r("macd","slowLen",26),r("macd","signalLen",9));s(u.line,r("macd","lineColor","#8fd9ff"),"MACD"),s(u.signal,r("macd","signalColor","#ffcf8e"),"Signal"),(d=u.hist)!=null&&d.length&&a(u.hist)}let c=zf(e);if(l.obv&&s(c.obv,r("obv","color","#8cf9ff"),"OBV"),l.adline&&s(c.adline,r("adline","color","#ffb7ff"),"A/D"),l.cmf&&s(Yf(e,i("cmf",20)),r("cmf","color","#f8ff87"),"CMF"),l.williamsr&&s(Gf(e,i("williamsr",14)),r("williamsr","color","#ff9adf"),"Williams %R"),l.cci&&s(Kf(e,i("cci",20)),r("cci","color","#b8ff8e"),"CCI"),l.mfi&&s(Vf(e,i("mfi",14)),r("mfi","color","#7bffd2"),"MFI"),l.uo&&s(Jf(e),r("uo","color","#ffd36f"),"UO"),l.adx){let u=jf(e,i("adx",14));s(u.adx,r("adx","adxColor","#9fd8ff"),"ADX"),s(u.plusDi,r("adx","plusColor","#73ffc0"),"+DI"),s(u.minusDi,r("adx","minusColor","#ff9797"),"-DI")}if(l.aroon){let u=Wf(e,i("aroon",14));s(u.up,r("aroon","upColor","#6cffb0"),"Aroon Up"),s(u.down,r("aroon","downColor","#ff8f8f"),"Aroon Down")}if(l.vortex){let u=Uf(e,i("vortex",14));s(u.plus.map(p=>({time:p.time,value:p.value*100})),r("vortex","plusColor","#d6a8ff"),"VI+"),s(u.minus.map(p=>({time:p.time,value:p.value*100})),r("vortex","minusColor","#ffb0f3"),"VI-")}}function ah(e){let t=e.querySelector(":scope > svg.xpd-ichimoku-cloud-svg");return t||(t=document.createElementNS("http://www.w3.org/2000/svg","svg"),t.setAttribute("class","xpd-ichimoku-cloud-svg"),e.appendChild(t)),t}function oh(e){var t;(t=e==null?void 0:e.querySelector(":scope > svg.xpd-ichimoku-cloud-svg"))==null||t.remove()}function fc(e,t,n,s,a){var b;if(!e||!t||!n)return;let o=n.clientWidth||0,i=n.clientHeight||0;if(!o||!i||!(s!=null&&s.length)||!(a!=null&&a.length))return;let r=ah(n);r.setAttribute("width",o),r.setAttribute("height",i),r.setAttribute("viewBox",`0 0 ${o} ${i}`);let l=((b=C.indicatorSettings)==null?void 0:b.ichimoku)||{},c=l.bullColor||"#46ffa0",d=l.bearColor||"#ff7878",u=new Map(a.map(h=>[h.time,h.value])),p=e.timeScale(),m=[];for(let h of s){let g=u.get(h.time);if(g==null)continue;let w=p.timeToCoordinate(h.time),k=t.priceToCoordinate(h.value),$=t.priceToCoordinate(g);w==null||k==null||$==null||m.push({x:w,ya:k,yb:$,bullish:h.value>=g})}let f="",v=0;for(let h=1;h<=m.length;h+=1){if(!(h===m.length||m[h].bullish!==m[v].bullish))continue;let w=m.slice(v,h);if(w.length>=2){let k=w.map(S=>`${S.x.toFixed(1)},${S.ya.toFixed(1)}`).join(" "),$=w.slice().reverse().map(S=>`${S.x.toFixed(1)},${S.yb.toFixed(1)}`).join(" "),T=w[0].bullish?c:d;f+=`<polygon points="${k} ${$}" fill="${y(T)}" opacity="0.22" />`}v=h}r.innerHTML=f}function xl(e,t,n,s){var i;if(!C.indicators.ichimoku){oh(s),ee.ichimokuData=null;return}let a=((i=C.indicatorSettings)==null?void 0:i.ichimoku)||{},o=uc(e,Number(a.tenkanLen)||9,Number(a.kijunLen)||26,Number(a.senkouBLen)||52);ee.ichimokuData={senkouA:o.senkouA,senkouB:o.senkouB},fc(t,n,s,o.senkouA,o.senkouB)}function Yo(){let e=ee.ichimokuData,t=document.getElementById("xpd-tv-widget");e&&ee.chart&&ee.activeSeries&&t&&fc(ee.chart,ee.activeSeries,t,e.senkouA,e.senkouB)}async function ih(){var n,s,a,o;let e=++Nn,t=document.getElementById("xpd-tv-widget");if(t){ee.chart||(t.innerHTML='<div class="xpd-loading">Loading full price history\u2026</div>');try{C.threeEnabled?_f():Is();let i=await th(),r=yl(i);if(e!==Nn)return;if(!r.length)throw new Error("No chart bars returned for selected pair/timeframe.");lh(r);let l=JSON.stringify({pair:C.pair,interval:C.interval,chartType:C.chartType,comparePair:C.comparePair,indicators:C.indicators,indicatorSettings:C.indicatorSettings,threeEnabled:C.threeEnabled});if(!C.comparePair&&!(C.drawings||[]).length&&ee.chart&&ee.configKey===l){let B=C.chartType==="heikin_ashi"?Vo(r):r;C.chartType==="line"||C.chartType==="area"?ee.activeSeries.setData(B.map(Y=>({time:Y.time,value:Y.close}))):ee.activeSeries.setData(B),ee.volumeSeries.setData(r.map(Y=>({time:Y.time,value:Y.volume||0,color:Y.close>=Y.open?"rgba(38,166,154,0.5)":"rgba(239,83,80,0.5)"})));let q=0,se=0,me=[];wl(r,{addOverlay:(Y,he,Ze,at,St)=>{let Rt=ee.indicatorSeries[q++];Y!=null&&Y.length&&(Rt==null||Rt.setData(Y),St&&Rt&&me.push({label:St,color:he,series:Rt,points:Y}))},addOsc:(Y,he,Ze)=>{let at=ee.indicatorSeries[q++];Y!=null&&Y.length&&(at==null||at.setData(Y),Ze&&at&&me.push({label:Ze,color:he,series:at,points:Y}))},addOscHist:Y=>{let he=ee.indicatorSeries[q++];Y!=null&&Y.length&&(he==null||he.setData(Y.map(Ze=>({time:Ze.time,value:Ze.value,color:Ze.value>=0?"rgba(99,255,157,0.45)":"rgba(255,126,126,0.45)"}))))},addPriceLevel:Y=>{let he=ee.indicatorPriceLines[se++];Number.isFinite(Y)&&(he==null||he.applyOptions({price:Y}))}}),ee.indicatorLegendItems=me,xl(r,ee.chart,ee.activeSeries,t),kl(ee.activeSeries);let Ne=r[r.length-1];(n=ee.renderLegend)==null||n.call(ee,Ne.open,Ne.high,Ne.low,Ne.close,Ne.volume);return}if(!await Ef())throw new Error("Chart library failed to load.");if(e!==Nn)return;let d=document.getElementById("xpd-tv-widget");if(!d||e!==Nn)return;let u=null;try{u=((s=ee.chart)==null?void 0:s.timeScale().getVisibleLogicalRange())||null}catch{}sh(),d.innerHTML="";let p=window.LightweightCharts,m=Math.max(320,d.clientWidth||((a=d.parentElement)==null?void 0:a.clientWidth)||320),f=Math.max(360,d.clientHeight||460),v=r.map(B=>B.low),b=r.map(B=>B.high),h=nh(r,Math.min(...v),Math.max(...b)),g={type:"price",precision:h,minMove:Math.pow(10,-h)},w="#26a69a",k="#ef5350",$=p.createChart(d,{width:m,height:f,layout:{background:{type:p.ColorType.Solid,color:"#131722"},textColor:"#d1d4dc"},grid:{vertLines:{color:"#242832"},horzLines:{color:"#242832"}},rightPriceScale:{borderColor:"rgba(197,203,206,0.3)"},leftPriceScale:{visible:!1,borderColor:"rgba(197,203,206,0.3)"},timeScale:{borderColor:"rgba(197,203,206,0.3)",timeVisible:!0,secondsVisible:!1},crosshair:{mode:p.CrosshairMode.Normal},handleScroll:!0,handleScale:!0}),T=C.chartType==="heikin_ashi"?Vo(r):r,S;if(C.chartType==="line")S=$.addLineSeries({color:"#2962ff",lineWidth:2,priceFormat:g}),S.setData(T.map(B=>({time:B.time,value:B.close})));else if(C.chartType==="area")S=$.addAreaSeries({lineColor:"#2962ff",topColor:"rgba(41,98,255,0.36)",bottomColor:"rgba(41,98,255,0.04)",lineWidth:2,priceFormat:g}),S.setData(T.map(B=>({time:B.time,value:B.close})));else if(C.chartType==="bars")S=$.addBarSeries({upColor:w,downColor:k,priceFormat:g}),S.setData(T);else{let B=C.chartType==="hollow_candles";S=$.addCandlestickSeries({upColor:B?"rgba(0,0,0,0)":w,downColor:k,borderUpColor:w,borderDownColor:k,wickUpColor:w,wickDownColor:k,borderVisible:!0,priceFormat:g}),S.setData(T)}let P=$.addHistogramSeries({priceFormat:{type:"volume"},priceScaleId:"vol"});$.priceScale("vol").applyOptions({scaleMargins:{top:.85,bottom:0}}),P.setData(r.map(B=>({time:B.time,value:B.volume||0,color:B.close>=B.open?"rgba(38,166,154,0.5)":"rgba(239,83,80,0.5)"})));let M=document.createElement("div");M.className="xpd-chart-legend",d.appendChild(M);let N=B=>Number.isFinite(B)?B.toFixed(h):"\u2014",_=(B,q,se,me,xe,Te)=>{let je=me>=B,De=(Te||[]).map(Ne=>`<span style="color:${y(Ne.color)}">${y(Ne.label)} <b>${N(Ne.value)}</b></span>`).join("");M.innerHTML=`
        <span>O <b>${N(B)}</b></span>
        <span>H <b>${N(q)}</b></span>
        <span>L <b>${N(se)}</b></span>
        <span class="${je?"xpd-legend-up":"xpd-legend-down"}">C <b>${N(me)}</b></span>
        ${xe!=null?`<span>Vol <b>${Be(xe)}</b></span>`:""}
        ${De}
      `},O=T[T.length-1],I=(o=r[r.length-1])==null?void 0:o.volume,D=()=>{if(!O)return;let B=O.open??O.value,q=O.high??O.value,se=O.low??O.value,me=O.close??O.value,xe=(ee.indicatorLegendItems||[]).map(Te=>{var je,De;return{label:Te.label,color:Te.color,value:(De=(je=Te.points)==null?void 0:je[Te.points.length-1])==null?void 0:De.value}}).filter(Te=>Number.isFinite(Te.value));_(B,q,se,me,I,xe)};D(),$.subscribeCrosshairMove(B=>{var Ne,Y;if(!B.time){D();return}let q=(Ne=B.seriesData)==null?void 0:Ne.get(S);if(!q){D();return}let se=(Y=B.seriesData)==null?void 0:Y.get(P),me=q.open??q.value,xe=q.high??q.value,Te=q.low??q.value,je=q.close??q.value,De=(ee.indicatorLegendItems||[]).map(he=>{var Ze,at;return{label:he.label,color:he.color,value:(at=(Ze=B.seriesData)==null?void 0:Ze.get(he.series))==null?void 0:at.value}}).filter(he=>Number.isFinite(he.value));_(me,xe,Te,je,se==null?void 0:se.value,De)});let F=!1,H=()=>{F||(F=!0,$.priceScale("osc").applyOptions({scaleMargins:{top:.65,bottom:.18}}))},A=[],z=[],te=[];wl(r,{addOverlay:(B,q,se=1.2,me=!1,xe="")=>{if(!(B!=null&&B.length))return;let Te=$.addLineSeries({color:q,lineWidth:se,lineStyle:me?p.LineStyle.Dashed:p.LineStyle.Solid,priceLineVisible:!1,lastValueVisible:!1});Te.setData(B),A.push(Te),xe&&te.push({label:xe,color:q,series:Te,points:B})},addOsc:(B,q,se="")=>{if(!(B!=null&&B.length))return;H();let me=$.addLineSeries({color:q,lineWidth:1.2,priceScaleId:"osc",title:se,priceLineVisible:!1,lastValueVisible:!1});me.setData(B),A.push(me),se&&te.push({label:se,color:q,series:me,points:B})},addOscHist:B=>{if(!(B!=null&&B.length))return;H();let q=$.addHistogramSeries({priceScaleId:"osc",priceLineVisible:!1,lastValueVisible:!1});q.setData(B.map(se=>({time:se.time,value:se.value,color:se.value>=0?"rgba(99,255,157,0.45)":"rgba(255,126,126,0.45)"}))),A.push(q)},addPriceLevel:(B,q,se="")=>{Number.isFinite(B)&&z.push(S.createPriceLine({price:B,color:q,lineWidth:1,lineStyle:p.LineStyle.Dashed,axisLabelVisible:!0,title:se}))}}),xl(r,$,S,d),$.timeScale().subscribeVisibleLogicalRangeChange(Yo);let ce=null;if(C.comparePair){let B=In.find(q=>q.id===C.comparePair);if(B){let q=yl(await mc(B,C.interval));if(e===Nn&&q.length){let se=q[0].close||1;ce=$.addLineSeries({color:"#ffd166",lineWidth:1.4,priceScaleId:"left",priceLineVisible:!1,lastValueVisible:!0,priceFormat:{type:"custom",formatter:me=>`${me>=0?"+":""}${me.toFixed(2)}%`,minMove:.01}}),$.priceScale("left").applyOptions({visible:!0,borderColor:"rgba(255,209,102,0.35)"}),ce.setData(q.map(me=>({time:me.time,value:(me.close/se-1)*100})))}}}else $.priceScale("left").applyOptions({visible:!1});if(e!==Nn){try{$.remove()}catch{}return}let G=(C.drawings||[]).filter(B=>Number.isFinite(B==null?void 0:B.price)).map(B=>S.createPriceLine({price:B.price,color:"#78e5ff",lineWidth:2,lineStyle:p.LineStyle.Dashed,axisLabelVisible:!0,title:"Line"}));if($.subscribeClick(B=>{if(C.drawingTool!=="hline"||!B.point)return;let q=S.coordinateToPrice(B.point.y);Number.isFinite(q)&&(C.drawings=[...C.drawings||[],{price:q}].slice(-50),G.push(S.createPriceLine({price:q,color:"#78e5ff",lineWidth:2,lineStyle:p.LineStyle.Dashed,axisLabelVisible:!0,title:"Line"})))}),u&&Number.isFinite(u.from)&&Number.isFinite(u.to))try{$.timeScale().setVisibleLogicalRange(u)}catch{$.timeScale().fitContent()}else $.timeScale().fitContent();let Se=new ResizeObserver(()=>{$.applyOptions({width:Math.max(320,d.clientWidth||320)}),Yo()});Se.observe(d),ee={chart:$,volumeSeries:P,activeSeries:S,compareSeries:ce,indicatorSeries:A,indicatorPriceLines:z,priceLines:G,resizeObserver:Se,chartType:C.chartType,configKey:l,legendEl:M,renderLegend:_,indicatorLegendItems:te,alertPriceLines:[]},kl(S)}catch(i){if(e!==Nn)return;if(C.error=(i==null?void 0:i.message)||"Could not initialize chart widget.",ee.chart){ge(C.error);return}let r=document.getElementById("xpd-tv-widget");r&&(r.innerHTML=`<div class="xpd-error">${y(C.error)}</div>`)}}}function hc(){let e=Q(Wo)==="1"?"0":"1";Z(Wo,e),U()}async function gc(e){In.some(t=>t.id===e)&&(C.pair=e,await Ds(),Lt(),U())}async function vc(e){C.interval=e,await Ds(),Lt(),U()}function bc(e){C.chartType=e,Lt(),U()}async function yc(){await Ds(),U()}function wc(e,t){e in C.indicators&&(C.indicators[e]=!!t,t&&(C.selectedIndicator=e,C.selectedEducationTab="indicator"),Lt(),U())}function xc(){C.indicatorMenuOpen=!C.indicatorMenuOpen,U()}function kc(){C.moreMenuOpen=!C.moreMenuOpen,U()}function $c(e){C.indicatorQuery=String(e||""),C.indicatorMenuOpen||(C.indicatorMenuOpen=!0),U()}function Sc(e){let t=String(e||"").trim();t in C.indicators&&(C.indicators[t]=!0,C.selectedIndicator=t,C.selectedEducationTab="indicator",Lt(),U())}function Tc(e){let t=String(e||"").trim();t in C.indicators&&(C.indicators[t]=!1,Lt(),U())}function rh(e){var s,a;if(C.settingsOpenFor!==e)return"";let t=C.indicatorSettings[e]||{},n=ai[e]||[];return`
    ...
    </div>`}function Cc(e){let t=String(e||"").trim();t in C.indicators&&(C.settingsOpenFor=C.settingsOpenFor===t?null:t,U())}function Pc(){C.settingsOpenFor=null,U()}function Lc(e){let t=String(e||"").trim();if(!(t in C.indicators))return;let n=C.indicatorSettings[t]||{},s={...n};for(let a of ai[t]||[]){let o=document.getElementById(`xpd-ind-${a.id}-${t}`);o&&(a.type==="number"?s[a.id]=Math.max(2,Math.min(500,Number(o.value)||n[a.id]||a.default)):s[a.id]=o.value)}C.indicatorSettings[t]=s,C.settingsOpenFor=null,U()}function Mc(e){let t=String(e||"").trim();delete C.indicatorSettings[t],C.settingsOpenFor=null,U()}function Ac(){Lt(),Bs(window.location.href),ae("Chart link copied.")}function Ec(){C.threeEnabled=!C.threeEnabled,Z(si,C.threeEnabled?"1":"0"),C.threeEnabled||Is(),U()}function Nc(e){let t=!!e;C.threeEnabled!==t&&(C.threeEnabled=t,Z(si,C.threeEnabled?"1":"0"),C.threeEnabled||Is(),U())}function _c(e){C.comparePair=e||"",Lt(),U()}function Rc(e){let t=String(e||"").trim();!t||!(t in C.indicators)||(C.indicators[t]=!0,C.selectedIndicator=t,U())}function Dc(e){let t=String(e||"none");Xl.some(n=>n.key===t)&&(C.drawingTool=t,C.educationHint=Gm[t]||"",U())}function Ea(){var e;return((e=C.chartMeta)==null?void 0:e.tokenKey)||C.tokenFocusKey||`${Aa().symbol||"XRP"}|`}function Ic(){var s,a;let e=Number((s=C.chartMeta)==null?void 0:s.last),t=prompt(`Alert me when ${((a=C.chartMeta)==null?void 0:a.symbol)||"price"} crosses:`,Number.isFinite(e)?e.toFixed(6):"");if(t==null)return;let n=Number(t);if(!Number.isFinite(n)||n<=0){ge("Enter a valid price.");return}C.alerts=[...C.alerts||[],{id:`alert_${Date.now()}`,tokenKey:Ea(),price:n,createdAt:new Date().toISOString()}],ii(),U(),ae(`Alert set at $${R(n,6)}`)}function Fc(e){C.alerts=(C.alerts||[]).filter(t=>t.id!==e),ii(),U()}function kl(e){if(!e)return;let t=window.LightweightCharts;for(let s of ee.alertPriceLines||[])try{e.removePriceLine(s)}catch{}let n=(C.alerts||[]).filter(s=>s.tokenKey===Ea());ee.alertPriceLines=n.map(s=>{var a;return e.createPriceLine({price:s.price,color:"#ffb703",lineWidth:2,lineStyle:((a=t==null?void 0:t.LineStyle)==null?void 0:a.Dotted)??2,axisLabelVisible:!0,title:"\u{1F514} Alert"})})}function lh(e){var r,l;if(e.length<2)return;let t=Ea(),n=(C.alerts||[]).filter(c=>c.tokenKey===t);if(!n.length)return;let s=e[e.length-2].close,a=e[e.length-1].close,o=[],i=!1;for(let c of n){let d=s<c.price&&a>=c.price,u=s>c.price&&a<=c.price;d||u?(ae(`\u{1F514} ${((r=C.chartMeta)==null?void 0:r.symbol)||"Price"} crossed $${R(c.price,6)} (${d?"\u2191":"\u2193"} now $${R(a,6)})`),i=!0,(l=document.querySelector(`.xpd-indicator-chip[data-alert-id="${c.id}"]`))==null||l.remove()):o.push(c)}i&&(C.alerts=[...(C.alerts||[]).filter(c=>c.tokenKey!==t),...o],ii())}function Oc(){let e=ee.activeSeries;if(e)for(let t of ee.priceLines||[])try{e.removePriceLine(t)}catch{}ee.priceLines=[],C.drawings=[]}function Na(e,t=0){var i;let n=(i=ee.chart)==null?void 0:i.timeScale();if(!n)return;let s=n.getVisibleLogicalRange();if(!s)return;let a=(s.to-s.from)*e,o=(s.to+s.from)/2+(s.to-s.from)*t;n.setVisibleLogicalRange({from:o-a/2,to:o+a/2})}function Xc(){Na(.8)}function Bc(){Na(1.25)}function Hc(){Na(1,-.2)}function zc(){Na(1,.2)}function jc(){C.educationCollapsed=!C.educationCollapsed,U()}function Wc(e){["indicator","psychology","practice"].includes(e)&&(C.selectedEducationTab=e,U())}function Uc(){let e=document.body.classList.contains("theme-gold");Cn(e?"cosmic":"gold"),U()}var $l=!1;function ch(){let e=document.getElementById("xpd-tv-widget");e&&ee.chart&&(ee.chart.applyOptions({width:Math.max(320,e.clientWidth||320),height:Math.max(320,e.clientHeight||460)}),Yo())}function qc(){var t;let e=document.querySelector(".xpd-chart-wrap");e&&($l||($l=!0,document.addEventListener("fullscreenchange",()=>{requestAnimationFrame(()=>requestAnimationFrame(ch))})),document.fullscreenElement?document.exitFullscreen():(t=e.requestFullscreen)==null||t.call(e))}function Vc(){let e=ee.chart;if(!e){ge("Chart image is not ready yet.");return}let t=e.takeScreenshot(),n=document.createElement("a");n.download=`xrpl-chart-${Date.now()}.png`,n.href=t.toDataURL("image/png"),n.click()}function Gc(){return C.tokenFocusKey||C.pair||"default"}function Kc(){var n;let e=ve(Q(Uo))||{},t=Gc();e[t]={interval:C.interval,chartType:C.chartType,comparePair:C.comparePair,indicators:C.indicators,indicatorSettings:C.indicatorSettings},Z(Uo,JSON.stringify(e)),ae(`Chart layout saved for ${((n=C.chartMeta)==null?void 0:n.symbol)||t}.`)}function Jc(){var s;let e=ve(Q(Uo))||{},t=Gc(),n=e[t];if(!n){ge(`No saved layout for ${((s=C.chartMeta)==null?void 0:s.symbol)||t} yet.`);return}C.interval=n.interval||C.interval,C.chartType=n.chartType||C.chartType,C.comparePair=n.comparePair||"",C.indicators={...C.indicators,...n.indicators||{}},C.indicatorSettings={...C.indicatorSettings,...n.indicatorSettings||{}},Lt(),U()}function _a(e){let t=String(e||"").trim();if(/^[0-9A-F]{40}$/i.test(t)){let n=t.replace(/(00)+$/g,"");if(/^[0-9A-F]+$/i.test(n)&&n.length%2===0)try{let s=new Uint8Array(n.length/2);for(let o=0;o<n.length;o+=2)s[o/2]=parseInt(n.slice(o,o+2),16);let a=new TextDecoder().decode(s).replace(/\0/g,"").trim();if(a)return a.toUpperCase()}catch{}}return t.toUpperCase()}function He(e){return`${e.symbol}|${e.issuer||""}`}function Cs(e){return encodeURIComponent(e).replace(/'/g,"%27")}function dh(e){var l,c,d,u,p,m,f,v,b,h;let t=_a(e.code||e.currency||""),n=String(e.issuer||((l=e.IssuingAccount)==null?void 0:l.account)||"").trim(),s=Number(e.price??((c=e.metrics)==null?void 0:c.price)??0),a=Number(e.marketcap??((d=e.metrics)==null?void 0:d.marketcap)??0),o=Number(((u=e.metrics)==null?void 0:u.volume_24h)??0),i=((m=(p=e.meta)==null?void 0:p.token)==null?void 0:m.name)||((f=e.IssuingAccount)==null?void 0:f.name)||t||"Unknown Token",r=Number(e.holders??((v=e.metrics)==null?void 0:v.holders)??((b=e.metrics)==null?void 0:b.trustlines)??0);return{symbol:t,name:i,issuer:n,tokenId:e.id||`${t}.${n}`,price:Number.isFinite(s)&&s>0?s:null,marketCap:Number.isFinite(a)&&a>0?a:null,volume24h:Number.isFinite(o)?o:null,holders:Number.isFinite(r)?r:null,change24h:null,verified:!!((h=e.IssuingAccount)!=null&&h.verified),score:Number(e.score||0)||null}}function ph(e){let t=_a((e==null?void 0:e.symbol)||""),n=String((e==null?void 0:e.name)||t||"Unknown Token"),s=Number((e==null?void 0:e.current_price)||0),a=Number((e==null?void 0:e.market_cap)||0),o=Number((e==null?void 0:e.total_volume)||0),i=Number((e==null?void 0:e.price_change_percentage_24h)||0);return{symbol:t,name:n,issuer:"",tokenId:`cg:${(e==null?void 0:e.id)||t}`,price:Number.isFinite(s)&&s>0?s:null,marketCap:Number.isFinite(a)&&a>0?a:null,volume24h:Number.isFinite(o)&&o>0?o:null,holders:null,change24h:Number.isFinite(i)?i:null,verified:!1,score:null}}function uh(e){var r;let t=_a((e==null?void 0:e.currency)||(e==null?void 0:e.token)||""),n=String((e==null?void 0:e.issuer)||(e==null?void 0:e.account)||"").trim(),s=String((e==null?void 0:e.name)||t||"Unknown Token"),a=Number((e==null?void 0:e.price)||((r=e==null?void 0:e.market)==null?void 0:r.price)||0),o=Number((e==null?void 0:e.marketcap)||(e==null?void 0:e.marketCap)||0),i=Number((e==null?void 0:e.volume24h)||(e==null?void 0:e.volume)||0);return{symbol:t,name:s,issuer:n,tokenId:`bithomp:${t}.${n||"na"}`,price:Number.isFinite(a)&&a>0?a:null,marketCap:Number.isFinite(o)&&o>0?o:null,volume24h:Number.isFinite(i)&&i>0?i:null,holders:Number.isFinite(Number((e==null?void 0:e.holders)||0))?Number((e==null?void 0:e.holders)||0):null,change24h:Number.isFinite(Number((e==null?void 0:e.change24h)||0))?Number((e==null?void 0:e.change24h)||0):null,verified:!!(e!=null&&e.verified),score:null}}function mh(e){let t=_a((e==null?void 0:e.symbol)||(e==null?void 0:e.currency)||""),n=String((e==null?void 0:e.issuer)||(e==null?void 0:e.issuerAddress)||"").trim(),s=String((e==null?void 0:e.name)||t||"Unknown Token"),a=Number((e==null?void 0:e.price)||0),o=Number((e==null?void 0:e.volume24h)||0);return{symbol:t,name:s,issuer:n,tokenId:`xrplto:${t}.${n||"na"}`,price:Number.isFinite(a)&&a>0?a:null,marketCap:Number.isFinite(Number((e==null?void 0:e.marketCap)||0))?Number((e==null?void 0:e.marketCap)||0):null,volume24h:Number.isFinite(o)&&o>0?o:null,holders:Number.isFinite(Number((e==null?void 0:e.holders)||0))?Number((e==null?void 0:e.holders)||0):null,change24h:Number.isFinite(Number((e==null?void 0:e.change24h)||0))?Number((e==null?void 0:e.change24h)||0):null,verified:!!(e!=null&&e.verified),score:null}}async function Yc(){var e,t,n,s,a,o;if(Pa()){W.loading=!0,W.error="";try{let i=Date.now(),r=cl.get("tokens");if(r&&i-r.ts<6e4){W.tokens=r.data,W.total=r.total||r.data.length,W.lastSyncAt=r.ts,W.filtered=ns(W.query,r.data),W.trending=Sl(r.data),W.loading=!1;return}let l=500,c=12,d=[];for(let T=1;T<=c;T+=1){let S=await Pt(`${Am}?page=${T}&limit=${l}`,{allowProxy:!1,timeoutMs:12e3});if(!Array.isArray(S)||!S.length||(d.push(...S),S.length<l))break}let u=d.map(dh).filter(T=>!!T.symbol&&!!T.issuer),p=[Pt(`${Em}?vs_currency=usd&order=market_cap_desc&per_page=250&page=1&sparkline=false`,{timeoutMs:12e3}).catch(()=>[]),Date.now()<(ul.xrplto||0)?Promise.resolve([]):Pt(_m,{timeoutMs:12e3,allowProxy:!1}).catch(T=>(String((T==null?void 0:T.message)||"").includes("429")&&(ul.xrplto=Date.now()+5*60*1e3),[]))];Rm&&p.push(Pt(Nm,{timeoutMs:12e3,allowProxy:!1}).catch(()=>[]));let[m,f,v=[]]=await Promise.all(p),b=Array.isArray(m)?m.map(ph).filter(T=>!!T.symbol):[],h=Array.isArray(v)?v.map(uh).filter(T=>!!T.symbol):[],g=Array.isArray(f)?f.map(mh).filter(T=>!!T.symbol):[],w={symbol:"XRP",name:"XRP Ledger Native",issuer:"",tokenId:"XRP",price:((e=Ce.data)==null?void 0:e.priceUsd)||((t=C.stats)==null?void 0:t.price)||null,marketCap:((n=Ce.data)==null?void 0:n.marketCap)||null,volume24h:((s=Ce.data)==null?void 0:s.volume24h)||null,holders:null,change24h:((a=Ce.data)==null?void 0:a.change24h)||((o=C.stats)==null?void 0:o.changePct)||null,verified:!0,score:1},k=new Map;[w,...u,...h,...g,...b].forEach(T=>{let S=He(T);k.has(S)||k.set(S,T)});let $=[...k.values()];cl.set("tokens",{ts:i,data:$,total:$.length}),W.tokens=$,W.total=$.length,W.lastSyncAt=i,W.filtered=ns(W.query,$),W.trending=Sl($)}catch(i){W.error=(i==null?void 0:i.message)||"Could not load XRPL token discovery data."}finally{W.loading=!1}}}function ns(e,t){let n=String(e||"").trim().toLowerCase(),s=W.filters||{type:"all",minCap:0,minVol:0,hasDex:!1};return t.filter(a=>{if(n&&!`${a.symbol} ${a.name} ${a.issuer} ${a.tokenId||""}`.toLowerCase().includes(n)||Number(s.minCap||0)>0&&Number(a.marketCap||0)<Number(s.minCap||0)||Number(s.minVol||0)>0&&Number(a.volume24h||0)<Number(s.minVol||0)||s.hasDex&&!(Number(a.volume24h||0)>0||Number(a.holders||0)>100))return!1;if(s.type&&s.type!=="all"){let o=String(a.symbol||"").toLowerCase(),i=String(a.name||"").toLowerCase(),r=/usd|usdc|usdt|rlusd|eur|gbp/.test(o)||/stable/.test(i),l=/meme|dog|cat|frog|shib|pepe/.test(o)||/meme/.test(i),c=/mpt/.test(o)||/multi-purpose/.test(i);if(s.type==="stablecoin"&&!r||s.type==="meme"&&!l||s.type==="mpt"&&!c||s.type==="standard"&&(r||l||c))return!1}return!0})}function Sl(e){return[...e].sort((t,n)=>{let s=Number(t.volume24h||0),a=Number(n.volume24h||0);if(a!==s)return a-s;let o=Number(t.marketCap||0);return Number(n.marketCap||0)-o}).slice(0,24)}async function Qc(e){if(Tt.loading=!0,Tt.error="",Tt.items=[],!e){Tt.loading=!1;return}try{let t=await gi(e,20);Tt.items=t||[]}catch(t){Tt.error=(t==null?void 0:t.message)||"Could not load recent transactions."}finally{Tt.loading=!1}}function Zc(e){W.query=e,Ls&&clearTimeout(Ls),Ls=setTimeout(()=>{W.listLimit=240,W.filtered=ns(W.query,W.tokens),U()},300)}function ed(e,t){W.filters={...W.filters,[e]:t},W.listLimit=240,W.filtered=ns(W.query,W.tokens),U()}function td(){Ls&&clearTimeout(Ls),W.query="",W.filters={type:"all",minCap:0,minVol:0,hasDex:!1},W.listLimit=240,W.filtered=ns("",W.tokens),U()}function nd(){W.listLimit=Math.min(5e3,Number(W.listLimit||240)+240),U()}function sd(){let e=W.filtered;W.listLimit=Math.min(5e3,Math.max(240,e.length)),U()}function ad(){W.listLimit=240,U()}function od(e){W.selectedTokenKey=e||"",U()}function id(e){let t=String(e||"").trim();if(!t)return;let n=ri();n.includes(t)||n.push(t),Ul(n),U()}function rd(e){let t=String(e||"").trim(),n=ri().filter(s=>s!==t);Ul(n),U()}async function Ra(e){let t=String(e||"").trim();if(!t)return;let n=String(t.includes("|")?t.split("|")[0]:t).toUpperCase(),s=t.includes("|")?W.tokens.find(o=>He(o)===t):W.tokens.find(o=>String(o.symbol||"").toUpperCase()===String(n||"").toUpperCase());W.selectedTokenKey=s?He(s):t.includes("|")?t:W.selectedTokenKey,C.tokenFocusKey=W.selectedTokenKey||t;let a={BTC:"BINANCE:BTCUSDT",ETH:"BINANCE:ETHUSDT",SOL:"BINANCE:SOLUSDT"};C.pair=a[n]||"BITSTAMP:XRPUSD",Lt(),U(),setTimeout(()=>Qm(),20),await Ds(),Lt(),U()}async function ld(e){return Ra(e)}async function cd(){await Yc(),U()}async function ui(){let e=document.getElementById("xpd-lookup-currency"),t=document.getElementById("xpd-lookup-issuer"),n=String((e==null?void 0:e.value)||"").trim().toUpperCase(),s=String((t==null?void 0:t.value)||"").trim();if(!n){ge("Enter a currency code first.");return}if(!s||!Fe(s)){ge("Enter a valid XRPL issuer address.");return}let a=`${n}|${s}`,o=W.tokens.find(i=>He(i)===a);o||(o={symbol:n,name:n,issuer:s,price:null,marketCap:null,volume24h:null,holders:null,tokenId:""},W.tokens=[...W.tokens,o],W.filtered=ns(W.query,W.tokens)),W.selectedTokenKey=a,e&&(e.value=""),t&&(t.value=""),await Ra(a)}async function dd(){var s,a;let e=String(((s=document.getElementById("xpd-lookup-currency"))==null?void 0:s.value)||"").trim().toUpperCase(),t=String(((a=document.getElementById("xpd-lookup-issuer"))==null?void 0:a.value)||"").trim();if(!e){ge("Enter a currency code first.");return}if(!t||!Fe(t)){ge("Enter a valid XRPL issuer address.");return}let n=`${e}|${t}`;await ui(),await li(n)}async function pd(){var t;let e=((t=Mt())==null?void 0:t.address)||"";await Qc(e),U()}async function Zn({silent:e=!1,force:t=!1}={}){var s;if(!t&&!Pa())return;let n=((s=Mt())==null?void 0:s.address)||"";e||ae("Refreshing XRPL dashboard data..."),await Promise.allSettled([Ds(),Zl(),Yc(),Qc(n),ec(n),tc(n),sc()]),U()}function ud(){return Zl()}function md(){var e;return ec(((e=Mt())==null?void 0:e.address)||"")}function fd(){var e;return tc(((e=Mt())==null?void 0:e.address)||"")}function hd(){return sc()}function gd(e){ae(`NFT ${e.slice(0,12)}... selected. Send flow can be wired to NFTokenCreateOffer.`)}function Rs(){let e=x("profile-metrics-row");if(!e)return;let t=!1,n=Object.values(Ke).reduce((u,p)=>u+((p==null?void 0:p.xrp)||0),0),s=vd(),a=Object.values(Ke).flatMap(u=>(u==null?void 0:u.tokens)||[]),o=Mt(),i=o?Ps[o.address]:null,r=(i==null?void 0:i.ownerCount)||0,l=Sa+r*Ta,c=o!=null&&o.createdAt?hh(new Date(o.createdAt)):"\u2014",d=(i==null?void 0:i.sequence)!=null?i.sequence:"\u2014";e.innerHTML=`
    ...
    <div class="pmetric pmetric-reserve" title="${r} owned objects \xD7 ${Ta} XRP + ${Sa} XRP base">
      ...
      <div class="pmetric-label">Reserved</div></div>`:""}`,o&&(!Ps[o.address]||Date.now()-Ps[o.address].fetchedAt>6e4)&&fh(o.address).then(()=>Rs())}async function fh(e){try{let t=await tt({method:"account_info",params:[{account:e,ledger_index:"validated"}]});t!=null&&t.account_data&&(Ps[e]={sequence:t.account_data.Sequence,ownerCount:t.account_data.OwnerCount||0,fetchedAt:Date.now()})}catch{}}function hh(e){let t=Math.floor((Date.now()-e.getTime())/864e5);if(t<1)return"Today";if(t<30)return`${t}d`;if(t<365)return`${Math.floor(t/30)}mo`;let n=Math.floor(t/365),s=Math.floor(t%365/30);return s?`${n}y ${s}mo`:`${n}y`}function vd(){var t;if(Array.isArray((t=window.__dashSeries)==null?void 0:t.marketPrice)){let n=window.__dashSeries.marketPrice.at(-1);if(n!=null&&Number.isFinite(n))return n}let e=document.getElementById("mkt-price");if(e){let n=parseFloat(e.textContent.replace("$",""));if(!isNaN(n))return n}return 0}function gh(){let e=re.length>0,t=Object.values(Ue).some(Boolean),n=!!de.bio,s=!!localStorage.getItem("naluxrp_last_backup_ts"),a=[e,t,n,s].filter(Boolean).length;return a===4?"":`
    ...
    </div>`:"",n=re.filter(a=>!Qn||a.label.toLowerCase().includes(Qn.toLowerCase())||a.address.toLowerCase().includes(Qn.toLowerCase())),s=n.map((a,o)=>vh(a,re.indexOf(a))).join("");e.innerHTML=t+(n.length?s:`<div class="wcard-empty">No wallets match "${y(Qn)}"</div>`)+`
    ...
    </div>`,La("stat-wallets-val",re.length)}function vh(e,t){let n=e.id===lt,s=!!e.watchOnly,a=Ke[e.address],o=Ps[e.address],r=!0||s,l=(o==null?void 0:o.ownerCount)||0,c=Sa+l*Ta,d=r?a?R(a.xrp,2):"\u2014":"\u2022\u2022\u2022\u2022",u=a&&r?Math.max(0,a.xrp-c):null,p=(a==null?void 0:a.tokens)||[],m=a!=null&&a.fetchedAt?jl(a.fetchedAt):null,f=e.address.slice(0,8)+"\u2026"+e.address.slice(-6),v=hi(e.address);return`
  <div class="wcard ${n?"wcard--active":""} ${s?"wcard--watch":""}" id="wallet-item-${e.id}" style="--i:${t}">
  ...
  </div>`}function kd(e){var n;let t=re[e];t&&(re.splice(e,1),Ns(),lt===t.id&&(lt=((n=re[0])==null?void 0:n.id)||null,lt&&Z(As,lt)),xt(),Ot(),wt("wallet_removed",t.label),bh(`Wallet "${t.label}" removed`,()=>{re.splice(e,0,t),Ns(),lt||(lt=t.id,Z(As,t.id)),xt(),Ot(),wt("wallet_created",t.label+" (restored)")},()=>{t.address&&ht(Zo+t.address)}))}function bh(e,t,n){let s=document.getElementById("undo-toast");s&&s.remove();let a=document.createElement("div");a.id="undo-toast",a.className="undo-toast",a.innerHTML=`<span class="undo-msg">${y(e)}</span><button class="undo-btn">Undo</button>`,document.body.appendChild(a),requestAnimationFrame(()=>a.classList.add("show"));let o=setTimeout(()=>{a.classList.remove("show"),setTimeout(()=>a.remove(),300),n==null||n()},5e3);a.querySelector(".undo-btn").addEventListener("click",()=>{clearTimeout(o),t(),a.classList.remove("show"),setTimeout(()=>a.remove(),300),ae("Wallet restored")})}function $d(e){var n,s;let t=x("inspect-addr");t&&(t.value=e),(n=window.switchTab)==null||n.call(window,document.querySelector('[data-tab="inspector"]'),"inspector"),(s=window.showDashboard)==null||s.call(window)}function Sd(e){_n=_n===e?null:e,_n&&!ln[e]&&(ln[e]="txns"),xt(),_n&&setTimeout(()=>fi(e,ln[e]),60)}function Td(e,t){ln[e]=t;let n=document.getElementById(`wcard-drawer-${e}`);n&&(n.querySelectorAll(".wdt-btn").forEach(s=>s.classList.toggle("active",s.textContent.toLowerCase().includes(t==="txns"?"trans":t==="nfts"?"nft":t==="orders"?"dex":"amm"))),fi(e,t))}async function fi(e,t){var a,o,i;let n=re.find(r=>r.id===e),s=document.getElementById(`wcard-drawer-body-${e}`);if(!(!n||!s)){s.innerHTML='<div class="wdd-loading"><div class="spinner"></div> Loading\u2026</div>';try{t==="txns"?s.innerHTML=yh(((a=ti[n.address])==null?void 0:a.txns)||await gi(n.address),n.address):t==="nfts"?s.innerHTML=wh(((o=Al[n.address])==null?void 0:o.nfts)||await Nh(n.address),n.address):t==="orders"?s.innerHTML=xh(((i=ni[n.address])==null?void 0:i.offers)||await _h(n.address),n.id,n.address):t==="amm"&&(s.innerHTML=await kh(n.address))}catch(r){s.innerHTML=`<div class="wdd-error">\u26A0\uFE0F ${y(r.message)}</div>`}}}function Cd(e){return{Payment:"\u{1F4B8}",OfferCreate:"\u{1F4CA}",OfferCancel:"\u2715",TrustSet:"\u{1F517}",NFTokenMint:"\u{1F3A8}",NFTokenBurn:"\u{1F525}",NFTokenCreateOffer:"\u{1F3AF}",NFTokenAcceptOffer:"\u2705",AMMCreate:"\u{1F30A}",AMMDeposit:"\u{1F4E5}",AMMWithdraw:"\u{1F4E4}",AMMVote:"\u{1F5F3}",AMMBid:"\u{1F4A1}",EscrowCreate:"\u23F3",EscrowFinish:"\u2705",EscrowCancel:"\u2715",AccountSet:"\u2699",SetRegularKey:"\u{1F511}",SignerListSet:"\u{1F4CB}"}[e]||"\u{1F4C4}"}function Qo(e){return e?typeof e=="string"?`${R(Number(e)/1e6,4)} XRP`:`${R(parseFloat(e.value||0),4)} ${(e.currency||"?").length>4?e.currency.slice(0,4)+"\u2026":e.currency}`:"\u2014"}function yh(e,t){return e!=null&&e.length?`<div class="wdd-tx-list">
  ...
  </div>`:'<div class="wdd-empty"><div class="wdd-empty-icon">\u{1F4CB}</div><div>No transactions yet.</div><div class="wdd-empty-sub">Fund with 10 XRP to activate.</div></div>'}function wh(e,t){return e!=null&&e.length?`<div class="wdd-nft-header"><span>${e.length} NFT${e.length>1?"s":""}</span>
    ...
    ${e.length>24?`<div class="wdd-more-note">${e.length-24} more on XRPScan</div>`:""}`:'<div class="wdd-empty"><div class="wdd-empty-icon">\u{1F3A8}</div><div>No NFTs in this wallet.</div></div>'}function xh(e,t,n){return e!=null&&e.length?`<div class="wdd-orders-header"><span>${e.length} open order${e.length>1?"s":""}</span></div>
    ...
    </div>`:'<div class="wdd-empty"><div class="wdd-empty-icon">\u{1F4CA}</div><div>No open DEX orders.</div></div>'}async function kh(e){try{let n=(ei[e]||[]).filter(s=>{var a;return((a=s.currency)==null?void 0:a.length)===40});return n.length?`<div class="wdd-amm-list">
    ...
    <div class="act-section-row">
      <div class="act-section">
        ...
        ${t.length?`<div class="act-timeline">${t.slice(0,20).map(s=>`
            <div class="act-entry">
              <div class="act-entry-icon">${Jm[s.type]||"\u25CF"}</div>
    ...
    <div class="settings-card settings-card--danger">
  ...
  </div>`}async function Sh(){var t;let e=x("profile-tab-analytics");if(e){e.innerHTML='<div class="analytics-grid"><div class="skeleton-card analytics-card--wide" style="height:80px"></div><div class="skeleton-card" style="height:160px"></div><div class="skeleton-card" style="height:160px"></div></div>';try{let n=Mt(),s=Object.values(Ke).reduce((r,l)=>r+((l==null?void 0:l.xrp)||0),0),a=vd(),o=Object.values(Ke).flatMap(r=>(r==null?void 0:r.tokens)||[]),i=[];if(n)try{i=((t=ti[n.address])==null?void 0:t.txns)||await gi(n.address,100)}catch{}e.innerHTML=`<div class="analytics-grid">
      ...
      <div class="analytics-card analytics-card--wide">
        ...
        ${n?Ch(i):'<div class="analytics-empty">Activate a wallet to see activity.</div>'}
      </div>
      ...
      <div class="analytics-card">
        ...
        ${i.length?Ph(i):'<div class="analytics-empty-chart"><div class="aec-icon">\u{1F4CA}</div><div>Transaction breakdown builds up as this wallet transacts.</div></div>'}
      </div>
      ...
      <div class="analytics-card">
        ...
        ${n&&i.length?Mh(i,n.address):`<div class="analytics-empty-chart"><div class="aec-icon">\u{1F4B0}</div><div>${n?"XRP flow needs at least one transaction to estimate.":"Activate a wallet to see XRP flow."}</div></div>`}
      </div>
      ...
      <div class="analytics-card">
        ...
        ${o.length?Lh(o):'<div class="analytics-empty-chart"><div class="aec-icon">\u{1FA99}</div><div>No token trustlines held by any wallet yet.</div></div>'}
      </div>
    </div>`}catch(n){ef(e,"analytics",n)}}}function Ld(e,t,n,s){if(e.length<2)return`<svg width="${t}" height="${n}"><line x1="0" y1="${n/2}" x2="${t}" y2="${n/2}" stroke="${s}" stroke-opacity=".2" stroke-width="1" stroke-dasharray="3 2"/></svg>`;let a=e.map(u=>u.xrp),o=Math.min(...a),i=Math.max(...a),r=i-o||1,l=a.map((u,p)=>`${3+p/(a.length-1)*(t-6)},${3+(1-(u-o)/r)*(n-6)}`),[c,d]=l[l.length-1].split(",");return`<svg width="${t}" height="${n}" viewBox="0 0 ${t} ${n}">
  ...
  </svg>`}function Th(e){let t=hi(e);if(t.length<2)return`<div class="analytics-empty-chart"><div class="aec-icon">\u{1F4CA}</div><div>Balance history builds up as you refresh your wallet over time.</div><div class="aec-sub">${t.length} snapshot${t.length!==1?"s":""} recorded.</div></div>`;let n=560,s=130,a=52,o=12,i=14,r=30,l=t.map(_=>_.xrp),c=t.map(_=>_.ts),d=Math.min(...l),u=Math.max(...l),p=u-d||1,m=c[0],f=c[c.length-1],v=f-m||1,b=_=>a+(_-m)/v*(n-a-o),h=_=>i+(1-(_-d)/p)*(s-i-r),g=t.map(_=>`${b(_.ts).toFixed(1)},${h(_.xrp).toFixed(1)}`),w=b(c[0]),k=b(c[c.length-1]),$=l[l.length-1]-l[0],T=$>=0,S=l[0]?Math.abs($/l[0]*100).toFixed(2):"0.00",P=T?"#00d4ff":"#ff5555",M=[d,(d+u)/2,u].map(_=>({v:_,y:h(_),l:R(_,2)})),N=[0,.5,1].map(_=>({x:a+_*(n-a-o),l:new Date(m+_*v).toLocaleDateString("en-US",{month:"short",day:"numeric"})}));return`
    ...
    <div class="balance-chart-wrap"><svg class="balance-chart-svg" viewBox="0 0 ${n} ${s}" preserveAspectRatio="none">
      ...
      <polyline points="${g.join(" ")}" fill="none" stroke="${P}" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
      ${t.map(_=>`<circle cx="${b(_.ts).toFixed(1)}" cy="${h(_.xrp).toFixed(1)}" r="2" fill="${P}" opacity=".7"/>`).join("")}
  ...
  </svg></div>`}function Ph(e){let t=new Map;e.forEach(a=>t.set(a.TransactionType||"?",(t.get(a.TransactionType||"?")||0)+1));let n=[...t.entries()].sort((a,o)=>o[1]-a[1]),s=e.length;return`<div class="tx-breakdown-list">${n.slice(0,8).map(([a,o])=>`<div class="txb-row"><div class="txb-icon">${Cd(a)}</div><div class="txb-type">${a}</div><div class="txb-bar-wrap"><div class="txb-bar" style="width:${(o/s*100).toFixed(0)}%"></div></div><div class="txb-count">${o}</div></div>`).join("")}</div>`}function Lh(e){let t=new Map;e.forEach(o=>{let i=Math.abs(parseFloat(o.balance||0));t.set(o.currency,(t.get(o.currency)||0)+i)});let n=[...t.entries()].sort((o,i)=>i[1]-o[1]).slice(0,8),s=n.reduce((o,[,i])=>o+i,0)||1,a=["#00fff0","#00d4ff","#bd93f9","#50fa7b","#ffb86c","#ff79c6","#f1fa8c","#ff5555"];return`<div class="token-alloc-list">${n.map(([o,i],r)=>{let l=(i/s*100).toFixed(1),c=a[r%a.length],d=o.length>4?o.slice(0,4)+"\u2026":o;return`<div class="ta-row"><div class="ta-swatch" style="background:${c}"></div><div class="ta-cur mono">${d}</div><div class="ta-bar-wrap"><div class="ta-bar" style="width:${l}%;background:${c}20;border-color:${c}55"></div></div><div class="ta-pct">${l}%</div></div>`}).join("")}</div>`}function Mh(e,t){let n=0,s=0;e.forEach(i=>{var c,d;if(i.TransactionType!=="Payment"||!((((c=i.metaData)==null?void 0:c.TransactionResult)||((d=i.meta)==null?void 0:d.TransactionResult))==="tesSUCCESS")||typeof i.Amount!="string")return;let l=Number(i.Amount)/1e6;i.Destination===t&&(n+=l),i.Account===t&&(s+=l)});let a=n-s,o=a>=0;return`<div class="xrp-flow-grid">
  ...
  <div class="xrf-note">Based on ${e.length} fetched Payment TXs. Excludes fees and DEX fills.</div>`}async function tt(e){var n,s;try{if(((n=X.wsConn)==null?void 0:n.readyState)===1){let{wsSend:a}=await import("./xrpl-6AERZ5KD.js"),o={command:e==null?void 0:e.method,...((s=e==null?void 0:e.params)==null?void 0:s[0])||{}},i=await a(o);if((i==null?void 0:i.status)==="error")throw new Error(i.error_message||i.error||"XRPL RPC error");return(i==null?void 0:i.result)||null}}catch{}let t=async a=>{let o=await fetch(a,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(e),mode:"cors"});if(!o.ok)throw new Error(`HTTP ${o.status}`);return(await o.json()).result};try{return await t(Pm)}catch{return await t(Lm)}}async function Fn(e){var t;try{let n=[],s;do{let l=await tt({method:"account_lines",params:[{account:e,ledger_index:"current",limit:400,...s?{marker:s}:{}}]});if(!l||l.error)break;n.push(...l.lines||[]),s=l.marker}while(s);let a=await tt({method:"account_info",params:[{account:e,ledger_index:"current"}]});if(a!=null&&a.error)return null;let o=Number(a.account_data.Balance)/1e6,i=n.map(l=>({currency:l.currency,issuer:l.account,balance:l.balance,limit:l.limit}));Ke[e]={xrp:o,tokens:i,fetchedAt:Date.now()},ei[e]=i,Eh(e,o);let r=document.getElementById("awb-balance");return r&&e===((t=Mt())==null?void 0:t.address)&&Jh(r.querySelector(".awb-xrp-num")||r,o,2,600),Ke[e]}catch{return null}}async function Ah(){await Promise.allSettled(re.map(e=>Fn(e.address))),xt(),Ot(),Rs()}function Eh(e,t){let n=Zo+e,s=ve(Q(n))||[],a=Date.now();s.length&&a-s[s.length-1].ts<5*6e4?s[s.length-1]={xrp:t,ts:a}:s.push({xrp:t,ts:a}),s.length>90&&s.splice(0,s.length-90),Z(n,JSON.stringify(s))}function hi(e){return ve(Q(Zo+e))||[]}async function gi(e,t=25){let n=await tt({method:"account_tx",params:[{account:e,limit:t,ledger_index_min:-1,ledger_index_max:-1}]}),s=((n==null?void 0:n.transactions)||[]).map(a=>a.tx||a.transaction||a);return ti[e]={txns:s,fetchedAt:Date.now()},s}async function Nh(e){let t=await tt({method:"account_nfts",params:[{account:e,limit:50}]}),n=(t==null?void 0:t.account_nfts)||[];return Al[e]={nfts:n,fetchedAt:Date.now()},n}async function _h(e){let t=await tt({method:"account_offers",params:[{account:e,limit:50}]}),n=(t==null?void 0:t.offers)||[];return ni[e]={offers:n,fetchedAt:Date.now()},n}async function Rh(e){let t=await tt({method:"account_info",params:[{account:e,ledger_index:"current"}]});return(t==null?void 0:t.account_data)||null}async function Dh(){let e=await tt({method:"ledger",params:[{ledger_index:"current"}]});return(e==null?void 0:e.ledger_current_index)||0}function Ih(e){let t=(e==null?void 0:e.engine_result)||"";return t==="tesSUCCESS"||t.startsWith("tes")||(e==null?void 0:e.engine_result_code)===0}function Fh(e){let t=(e==null?void 0:e.engine_result)||"";return Om[t]||(e==null?void 0:e.engine_result_message)||t||"Unknown error"}async function Oh(e,t,n){if(await Ma(),!window.xrpl)throw new Error("xrpl.js library not loaded. Cannot sign transactions.");let s=re.find(i=>i.id===e);if(!s)throw new Error("Wallet not found.");if(s.watchOnly)throw new Error("Watch-only wallets cannot sign transactions.");let a=await Hm(s,n),o;try{o=window.xrpl.Wallet.fromSeed(a,{algorithm:s.algo==="secp256k1"?"secp256k1":"ed25519"})}catch(i){throw new Error("Invalid seed phrase: "+i.message)}if(o.classicAddress!==s.address)throw new Error("Seed does not match this wallet address.");try{let[i,r]=await Promise.all([Rh(s.address),Dh()]);if(!i)throw new Error("Account not found on-chain. Fund with at least 10 XRP first (base reserve requirement).");let l={...t,Account:s.address,Fee:"12",Sequence:i.Sequence,LastLedgerSequence:r+20},{tx_blob:c,hash:d}=o.sign(l);return{...await tt({method:"submit",params:[{tx_blob:c}]}),tx_hash:d}}finally{}}async function Xh(e,t,n){return Oh(e,{TransactionType:"OfferCancel",OfferSequence:parseInt(t)},n)}function Bh(){if(x("send-modal-overlay"))return;let e=document.createElement("div");e.innerHTML=`
  <!-- Send -->
  ...
  <div class="generic-modal-overlay" id="token-details-modal">
    ...
    </div>`,document.body.appendChild(n),requestAnimationFrame(()=>requestAnimationFrame(()=>n.classList.add("show"))),n.addEventListener("click",a=>{a.target===n&&n.remove()})}function tp(e){Cn(e),Fs(),wt("theme_changed",e)}function np(e){Z("nalulf_pref_currency",e),Fs(),ae(`Display currency: ${e}`)}function sp(e){Z("nalulf_pref_network",e),Fs(),ae(`Default network: ${e}`)}function ap(e){Z("nalulf_pref_autolock",e),Fs(),ae(`Auto-lock: ${e} minutes`)}window._profileWipeAllData=()=>{confirm("Clear all profile, wallet list, social, and activity data? Encrypted wallet seeds saved on this device will be deleted.")&&(["nalulf_profile","nalulf_wallets","nalulf_social","nalulf_activity_log","nalulf_avatar_img","nalulf_banner_img","naluxrp_active_wallet"].forEach(e=>localStorage.removeItem(e)),re=[],Ue={},lt=null,Ke={},ei={},qo(),U(),oi("wallets"),ae("Local data cleared"))};function Vh(){var e,t,n;(e=x("profile-editor-modal"))==null||e.addEventListener("click",s=>{s.target===s.currentTarget&&Os()}),(t=x("wallet-creator-overlay"))==null||t.addEventListener("click",s=>{s.target===s.currentTarget&&Xs()}),(n=x("social-modal"))==null||n.addEventListener("click",s=>{s.target===s.currentTarget&&ss()})}function Gh(){let e=[{done:!!de.displayName&&de.displayName!=="Anonymous",label:"Display name"},{done:!!de.bio,label:"Bio"},{done:de.avatar!=="\u{1F30A}"||!!localStorage.getItem(cn),label:"Custom avatar"},{done:!!localStorage.getItem(Dn),label:"Custom banner"},{done:re.length>0,label:"Wallet added"},{done:Object.keys(Ue).length>=1,label:"Social connected"},{done:!!de.location,label:"Location set"},{done:!!de.website,label:"Website added"}],t=e.filter(n=>n.done).length;return{pct:Math.round(t/e.length*100),done:t,total:e.length,checks:e}}function Kh(){let e=document.getElementById("profile-completeness");if(!e)return;let{pct:t,checks:n}=Gh(),s=t===100?"#50fa7b":t>=60?"#00fff0":"#ffb86c",a=2*Math.PI*16,o=t/100*a,i=n.filter(r=>!r.done).map(r=>r.label);e.title=t===100?"Profile complete \u2713":`${t}% \u2014 Missing: ${i.join(", ")}`,e.innerHTML=`
    <div class="pc-wrap">
  ...
  `,document.body.appendChild(e);let t=()=>{e.style.display="none",e.removeAttribute("data-addr"),document.body.classList.remove("modal-open"),Us=!1,Et=!1};e.addEventListener("click",a=>{a.target===e&&t()}),(n=x("acctPeekClose"))==null||n.addEventListener("click",t),(s=x("acctPeekInspect"))==null||s.addEventListener("click",async()=>{let a=e.getAttribute("data-addr");a&&await vg(a),t()})}function fg(){xp||(xp=!0,document.addEventListener("click",e=>{var s,a;let t=(a=(s=e.target).closest)==null?void 0:a.call(s,"[data-addr]");if(!t)return;let n=t.getAttribute("data-addr");n&&(e.preventDefault(),gg(n))}))}function Ep(e){var r,l,c;if(!e||!((r=Ee==null?void 0:Ee.window)!=null&&r.length))return null;let t=0,n=0,s=0;for(let d of Ee.window)s+=Number(d.total||0),t+=Number(((l=d.byActorCreate)==null?void 0:l.get(e))||0),n+=Number(((c=d.byActorCancel)==null?void 0:c.get(e))||0);let a=t+n;if(!a)return null;let o=a?n/a:0,i=s?a/s:null;return{create:t,cancel:n,total:a,cancelRatio:o,share:i}}function hg(e){var o;let t=(o=At==null?void 0:At.acct)==null?void 0:o.get(e);if(!t||!t.intervals||t.intervals.length<6)return null;let n=fn(t.intervals),s=Ii(t.intervals);return!n||s==null?null:{cv:s/n,total:t.total||0}}async function gg(e){var i,r,l;if(!Fe(e))return;let t=document.getElementById("acctPeekOverlay");if(!t)return;t.style.display="flex",t.setAttribute("data-addr",e),document.body.classList.add("modal-open"),Us=!0,Et=!0,V("acctPeekAddr",e),V("acctPeekBal","\u2026"),V("acctPeekSeq","\u2026"),V("acctPeekOwner","\u2026"),V("acctPeekFlags","\u2026");let n=x("acctPeekNote"),s=x("acctPeekCtx");n&&(n.textContent="Fetching account_info\u2026"),s&&(s.textContent="Building context\u2026");let a=At.acct.get(e),o=((i=a==null?void 0:a.ledgers)==null?void 0:i.length)||0;try{if(!X.wsConn||X.wsConn.readyState!==1){n&&(n.textContent="Not connected to XRPL. Connect first.");return}let c=await Me({command:"account_info",account:e,ledger_index:"validated",strict:!0}),d=(r=c==null?void 0:c.result)==null?void 0:r.account_data,u=Number((d==null?void 0:d.Balance)??NaN),p=Number.isFinite(u)?u/1e6:null;if(V("acctPeekBal",p==null?"\u2014":`${p.toLocaleString(void 0,{maximumFractionDigits:6})} XRP`),V("acctPeekSeq",(d==null?void 0:d.Sequence)??"\u2014"),V("acctPeekOwner",(d==null?void 0:d.OwnerCount)??"\u2014"),V("acctPeekFlags",(d==null?void 0:d.Flags)!=null?`0x${Number(d.Flags).toString(16)}`:"\u2014"),n){let m=[];p!=null&&p>=eg&&m.push("Large balance (whale-sized).");let f=hg(e);f&&f.cv<.35&&f.total>10&&m.push(`Bot-like timing signal (CV ${f.cv.toFixed(2)}).`);let v=Ep(e);if(v){let h=Math.round(v.cancelRatio*100),g=v.share!=null?Math.round(v.share*100):null;m.push(`DEX activity: ${v.total} offer tx in window.`),m.push(`Creates ${v.create}, cancels ${v.cancel} (${h}% cancels).`),g!=null&&m.push(`~${g}% of window activity.`)}let b=le.byAddr.get(e);if(b){let h=qs(b.level);m.push(`Spam-defense: score ${(b.score*100).toFixed(0)}% \xB7 level L${b.level} \xB7 bond ${h.toLocaleString()} XRP.`),b.verifiedLedger!=null&&m.push(`Credential verified at ledger #${Number(b.verifiedLedger).toLocaleString()}.`)}o>=6&&m.push(`Shows up often in recent ledgers (${o} times).`),m.length||m.push("No obvious red flags from this quick read."),n.textContent=m.join(" ")}if(s){let m=(l=a==null?void 0:a.ledgers)==null?void 0:l.at(-1),f=Ep(e),v=f?`DEX window: ${f.total} (creates ${f.create}, cancels ${f.cancel})`:null,b=Nt.filter(k=>k.from===e||k.to===e).slice(0,3),h=b.length?`${b.length} whale tx in session (${b.map(k=>(k.amtXrp>=1e6?(k.amtXrp/1e6).toFixed(1)+"M":(k.amtXrp/1e3).toFixed(0)+"K")+" XRP").join(", ")})`:null,g=le.byAddr.get(e),w=g?`Spam-defense: L${g.level} \xB7 score ${Math.round(g.score*100)}%`:null;s.textContent=[m?`Last seen around ledger #${Number(m).toLocaleString()}`:"Not in recent window.",v,h,w].filter(Boolean).join(" \xB7 ")}}catch(c){n&&(n.textContent=`Lookup failed: ${String((c==null?void 0:c.message)||c)}`),s&&(s.textContent="\u2014")}}async function vg(e){if(!Fe(e))return;let t=document.querySelector('.dash-tab[data-tab="inspector"]'),n=document.getElementById("tab-inspector"),s=async()=>n&&n.style.display!=="none"?!0:(typeof window.switchTab=="function"&&t?window.switchTab(t,"inspector"):t==null||t.click(),await new Promise(o=>setTimeout(o,80)),n?n.style.display!=="none":!0);for(let o=0;o<6&&!await s();o++)await new Promise(r=>setTimeout(r,80));let a=document.getElementById("inspect-addr");a&&(a.value=e,a.focus()),await new Promise(o=>setTimeout(o,60)),typeof window.runInspect=="function"?window.runInspect():ge("Inspector not ready yet.")}function bg(){Ie(".net-btn[data-network]").forEach(e=>{e.addEventListener("click",()=>{let t=e.getAttribute("data-network");Ie(".net-btn").forEach(s=>{s.classList.toggle("active",s===e),s.setAttribute("aria-pressed",String(s===e))}),At.acct.clear(),js.window=[],js.totals=new Map,Ee.window=[],Ee.smoothCancelPerMin=null,Ee.smoothBurst=null,Xt.length=0,Ua.clear(),ze=0,Vt=0,ct=0,zs=0,Gt=!0,Va=0,Ni=!1,Ws=null,Et=!1,mn=0,ds=0,Ja=!1;let n=x("ledgerStreamTrack");n&&(n.innerHTML="",n.style.transform="translateX(0px)"),Zp(null,null),dv(),le.byAddr.clear(),le.selectedAddr=null,le.selectedProof=null,Oi(),au(),us(null),Ar(t),Ka({force:!0})})})}var Wa=[],yg=8,Ti=null,Ei=0,Hs=null;function wg(){let e=document.querySelector(".dashboard-metric-grid");if(!e)return;let t=e.closest(".dashboard-metrics")||e.parentElement;t&&t.classList.add("dashboard-sticky-strip"),e.innerHTML=`
  ...
  `}function xg(e){var v,b,h,g;let t=e.ledgerIndex?Number(e.ledgerIndex):null;V("d2-ledger-index",t?t.toLocaleString():"\u2014");let n=((v=e.latestLedger)==null?void 0:v.closeTimeSec)!=null?Number(e.latestLedger.closeTimeSec):null,s=x("d2-ledger-age");if(s&&(n!=null?(s.textContent=`${n<2?n.toFixed(2):n.toFixed(1)}s close`,s.style.color=n<=3?"#50fa7b":n<=6?"#ffb86c":"#ff6e6e"):(s.textContent="Waiting\u2026",s.style.color="")),n!=null&&(Wa.push(n),Wa.length>yg&&Wa.shift(),kg()),Ei=Date.now(),$g(),e.tps!=null){let w=Number(e.tps),k=x("d2-tps");k&&(k.textContent=w.toFixed(1),k.style.color=w<10?"rgba(255,255,255,.65)":w<40?"#50fa7b":w<80?"#ffb86c":"#ff6e6e");let $=x("d2-tps-trend");if($){let T=X.tpsHistory||[],S=T.length>2?(T.slice(-10).reduce((M,N)=>M+N,0)/Math.min(T.length,10)).toFixed(1):null,P=w<10?"Low":w<40?"Normal":w<80?"High":"Peak";$.textContent=S?`${P} \xB7 avg ${S}`:P,$.style.color=w<10?"rgba(255,255,255,.55)":w<40?"#50fa7b":w<80?"#ffb86c":"#ff6e6e"}}let a=(((b=e.latestLedger)==null?void 0:b.totalTx)??e.txPerLedger)||0,o=x("d2-tx-per-ledger");o&&(o.textContent=a>0?a.toLocaleString():"\u2014",o.style.color=a<10?"rgba(255,255,255,.65)":a<150?"#50fa7b":a<400?"#ffb86c":"#ff6e6e");let i=x("d2-tx-spread");i&&a>0&&(i.textContent=a<10?"Very light":a<50?"Light":a<150?"Normal":a<400?"High volume":"Very high volume",i.style.color=a<150?"":a<400?"#ffb86c":"#ff6e6e");let r=e.avgFee!=null?Number(e.avgFee):((h=e.latestLedger)==null?void 0:h.avgFee)!=null?Number(e.latestLedger.avgFee):null;if(r!=null){let w=Math.round(r*1e6),k=x("d2-fee-value");k&&(k.textContent=un(r),k.style.color=w<=15?"#50fa7b":w<=50?"rgba(255,255,255,.9)":w<=200?"#ffb86c":"#ff6e6e");let $=x("d2-fee-delta");if($)if(Ti!=null){let S=r/Ti;S>1.05?($.textContent="\u2191",$.style.color="#ff6e6e",$.title=`+${((S-1)*100).toFixed(0)}% vs prev ledger`):S<.95?($.textContent="\u2193",$.style.color="#50fa7b",$.title=`-${((1-S)*100).toFixed(0)}% vs prev ledger`):($.textContent="\u2192",$.style.color="rgba(255,255,255,.35)",$.title="Stable vs prev ledger")}else $.textContent="";Ti=r;let T=x("d2-fee-pressure");if(T){let S=w<=15?"Base fee":w<=50?`${w} drops`:w<=200?`${w} drops \xB7 Elevated`:`${w} drops \xB7 Surge`;T.textContent=S,T.style.color=w<=50?"":w<=200?"#ffb86c":"#ff6e6e"}}let l=e.successRate!=null?Number(e.successRate):((g=e.latestLedger)==null?void 0:g.successRate)!=null?Number(e.latestLedger.successRate):null;if(l!=null){let w=x("d2-success-rate");w&&(w.textContent=`${l.toFixed(1)}%`,w.style.color=l>=90?"#50fa7b":l>=75?"#ffb86c":"#ff6e6e");let k=x("d2-success-note");if(k){let $=(100-l).toFixed(1);k.textContent=l>=90?`${$}% failed \xB7 Normal`:l>=75?`${$}% failed \xB7 Watch`:`${$}% failed \xB7 Alert`,k.style.color=l>=90?"":l>=75?"#ffb86c":"#ff6e6e"}}let c=a>0?Math.min(100,a/500*100):null,d=x("d2-network-capacity"),u=x("d2-capacity-note");c!=null&&(d&&(d.textContent=`${c.toFixed(1)}%`,d.style.color=c<20?"rgba(255,255,255,.65)":c<50?"#50fa7b":c<80?"#ffb86c":"#ff6e6e"),u&&(u.textContent=c<20?"Low usage":c<50?"Moderate":c<80?"Heavy":"Near capacity",u.style.color=c<50?"":c<80?"#ffb86c":"#ff6e6e"));let p=e.txTypes||{},m=Object.entries(p).sort(([,w],[,k])=>k-w);if(m.length){let[w,k]=m[0],$=m.reduce((N,[,_])=>N+_,0)||1,T=(k/$*100).toFixed(0),S=typeof Dt<"u"?Dt:{},P=x("d2-dominant-type");P&&(P.textContent=w,P.style.color=S[w]||"rgba(255,255,255,.9)");let M=x("d2-dominance-score");if(M){let N=m[1];M.textContent=N?`${T}% \xB7 2nd: ${N[0]}`:`${T}% of txs`}}let f=x("stream-loading");f&&(f.style.display="none")}function kg(){let e=x("d2-close-sparkline");if(!e||!e.getContext)return;let t=Wa;if(t.length<2)return;let n=e.width,s=e.height,a=e.getContext("2d");a.clearRect(0,0,n,s);let o=Math.max(...t,4),i=Math.floor((n-(t.length-1))/t.length),r=1;t.forEach((l,c)=>{let d=Math.max(3,Math.round(l/o*(s-2))),u=c*(i+r),p=s-d,m=l<=3?"rgba(80,250,123,.80)":l<=6?"rgba(255,184,108,.80)":"rgba(255,110,110,.85)";a.fillStyle=m;let f=Math.min(2,i/2);a.beginPath(),a.moveTo(u+f,p),a.lineTo(u+i-f,p),a.quadraticCurveTo(u+i,p,u+i,p+f),a.lineTo(u+i,s),a.lineTo(u,s),a.lineTo(u,p+f),a.quadraticCurveTo(u,p,u+f,p),a.closePath(),a.fill(),c===t.length-1&&(a.fillStyle="rgba(255,255,255,.18)",a.fillRect(u,p,i,Math.min(3,d)))})}function $g(){if(Hs&&cancelAnimationFrame(Hs),!Kt())return;let e=0,t=n=>{if(!Kt()){Hs=null;return}if(n-e>=120){e=n;let s=x("d2-ledger-age-timer");if(s&&Ei>0){let a=(Date.now()-Ei)/1e3;s.textContent=`${a.toFixed(1)}s ago`,s.style.color=a<4?"rgba(255,255,255,.55)":a<7?"#ffb86c":"#ff6e6e",s.style.opacity=a>=7?(.6+.4*Math.sin(Date.now()/300)).toFixed(2):"1"}}Hs=requestAnimationFrame(t)};Hs=requestAnimationFrame(t)}function Sg(){let e=x("tx-mix");if(!e)return;let t=Object.entries(X.txMixAccum||{}).filter(([,s])=>s>0).sort(([,s],[,a])=>a-s).slice(0,10),n=t.reduce((s,[,a])=>s+a,0);n&&(e.innerHTML=t.map(([s,a])=>{let o=(a/n*100).toFixed(1),i=Dt[s]||"#6b7280";return`
      ...
      </div>`}).join(""))}var kt=class{constructor(t,n="#00fff0",s="area"){this.canvasId=t,this.canvas=x(t),this.color=n,this.mode=s}_resolveCanvas(){return this.canvas||(this.canvas=x(this.canvasId)),this.canvas}draw(t){let n=this._resolveCanvas();if(!n||!(t!=null&&t.length))return;let s=n.getContext("2d");if(!s)return;let a=n.width=n.offsetWidth||300,o=n.height=n.offsetHeight||180;if(s.clearRect(0,0,a,o),t.length<2)return;let i=Math.min(...t)*.9,r=Math.max(...t)*1.05||1,l=b=>1-(b-i)/(r-i||1),c={l:10,r:10,t:10,b:12},d=a-c.l-c.r,u=o-c.t-c.b,p=d/(t.length-1),m=t.map((b,h)=>[c.l+h*p,c.t+l(b)*u]),f=fn(t);if(f!=null){let b=c.t+l(f)*u;s.beginPath(),s.moveTo(c.l,b),s.lineTo(c.l+d,b),s.strokeStyle="rgba(255,255,255,0.16)",s.lineWidth=1,s.stroke()}if(t.length>=lp+2){let h=pg(t,lp).map((g,w)=>[c.l+w*p,c.t+l(g)*u]);s.beginPath(),h.forEach(([g,w],k)=>k===0?s.moveTo(g,w):s.lineTo(g,w)),s.strokeStyle="rgba(255,255,255,0.22)",s.lineWidth=1.5,s.stroke()}if(this.mode==="bar"){let b=Math.max(1,p-3);t.forEach((h,g)=>{let w=(1-l(h))*u,k=c.l+g*p-b/2,$=s.createLinearGradient(0,c.t,0,c.t+u);$.addColorStop(0,this.color),$.addColorStop(1,this.color+"33"),s.fillStyle=$,s.fillRect(k,c.t+u-w,b,w)});return}let v=s.createLinearGradient(0,c.t,0,c.t+u);v.addColorStop(0,this.color+"aa"),v.addColorStop(1,this.color+"11"),s.beginPath(),m.forEach(([b,h],g)=>g===0?s.moveTo(b,h):s.lineTo(b,h)),s.lineTo(m.at(-1)[0],c.t+u),s.lineTo(m[0][0],c.t+u),s.closePath(),s.fillStyle=v,s.fill(),s.beginPath(),m.forEach(([b,h],g)=>g===0?s.moveTo(b,h):s.lineTo(b,h)),s.strokeStyle=this.color,s.lineWidth=2,s.lineJoin="round",s.stroke()}},we={};function Tg(){we.tps=new kt("chart-tps","#50fa7b","area"),we.fee=new kt("chart-fee","#ffb86c","area"),we.tps2=new kt("chart-tps2","#50fa7b","bar"),we.fee2=new kt("chart-fee2","#ffb86c","area"),we.dexPressure=new kt("chart-dex-pressure","#00d4ff","bar"),we.nftMints=new kt("chart-nft-mints","#bd93f9","bar"),we.nftBurns=new kt("chart-nft-burns","#ff5555","bar"),we.autoBridge=new kt("chart-autobridge","#f1fa8c","bar"),we.marketPrice=new kt("chart-market-price","#50fa7b","area"),we.marketVol=new kt("chart-market-vol","#8be9fd","bar")}function Bt(e,t=Jt){let n=dg(e,t).filter(r=>Number.isFinite(r));if(!n.length)return{cur:null,avg:null,deltaPct:null,vol:null};let s=n.at(-1),a=fn(n),o=Ii(n),i=a&&a!==0?(s-a)/a*100:null;return{cur:s,avg:a,deltaPct:i,vol:o}}function Cg(){if(fp)return;fp=!0;let e=(t,n)=>{let s=x(t);if(!s)return;let a=s.closest(".widget-card"),o=a==null?void 0:a.querySelector(".widget-header");if(!o||document.getElementById(n))return;let i=document.createElement("div");i.className="trend-mini",i.id=n,i.innerHTML=`
    ...
    `,o.appendChild(i)};e("chart-tps","tpsTrendMini"),e("chart-fee","feeTrendMini"),e("chart-tps2","tpsTrendMini2"),e("chart-fee2","feeTrendMini2")}function Ba(e,t,n,s){let a=document.getElementById(e);if(!a)return;let o=(i,r)=>{let l=a.querySelector(`[data-k="${i}"]`);l&&(l.textContent=r)};if(t.cur==null){o("now","\u2014"),o("avg","\u2014"),o("delta","\u2014"),o("sigma","\u2014");return}o("now",`${Number(t.cur).toFixed(n)}${s}`),o("avg",t.avg!=null?`${Number(t.avg).toFixed(n)}${s}`:"\u2014"),o("delta",t.deltaPct==null?"\u2014":hn(t.deltaPct,0)),o("sigma",t.vol==null?"\u2014":`${Number(t.vol).toFixed(Math.max(0,n-1))}${s}`)}function Pg(){var n,s,a,o,i,r,l,c,d,u;(n=we.tps)==null||n.draw(X.tpsHistory),(s=we.fee)==null||s.draw(X.feeHistory),(a=we.tps2)==null||a.draw(X.tpsHistory),(o=we.fee2)==null||o.draw(X.feeHistory);let e=Bt(X.tpsHistory,Jt),t=Bt(X.feeHistory,Jt);Ba("tpsTrendMini",e,2,""),Ba("tpsTrendMini2",e,2,""),Ba("feeTrendMini",t,0,"d"),Ba("feeTrendMini2",t,0,"d"),(i=we.dexPressure)==null||i.draw(fe.dexPressure),(r=we.nftMints)==null||r.draw(fe.nftMints),(l=we.nftBurns)==null||l.draw(fe.nftBurns),(c=we.autoBridge)==null||c.draw(fe.autoBridge),(d=we.marketPrice)==null||d.draw(fe.marketPrice),(u=we.marketVol)==null||u.draw(fe.marketVol)}function Lg(){let e=x("ledger-log"),t=x("ledger-log-loading"),n=x("ledger-log-count");if(!e||!(X.ledgerLog||[]).length)return;t&&(t.style.display="none"),n&&(n.textContent=X.ledgerLog.length);let s=x("tab-network");!s||s.style.display==="none"||(e.innerHTML=`<div class="ledger-log-row log-head">
      ...
      </div>`).join(""))}var Xt=[],Ua=new Set,ze=0,Ha=null,zs=0,Vt=0,ct=0,Gt=!0,za=0,Et=!1,Va=0,Ni=!1,Ws=null,mn=0,ds=0,Ja=!1,Mg=.18;function Ag(){Eg(),Ng()}function Eg(){let e=x("ledgerStreamParticles");if(e){e.innerHTML="";for(let t=0;t<14;t++){let n=document.createElement("div");n.className="ledger-particle",n.style.left=Math.random()*100+"%",n.style.top=20+Math.random()*60+"%",n.style.animationDuration=6+Math.random()*8+"s",n.style.animationDelay=Math.random()*5+"s",e.appendChild(n)}}}function Ng(){if(Ha)return;let e=x("ledgerStreamShell");e&&(e.addEventListener("mouseenter",()=>{Et=!0}),e.addEventListener("mouseleave",()=>{Us||(Et=!1)}));let t=x("ledgerStreamTrack");t&&t.addEventListener("click",s=>{let a=s.target.closest("article.ledger-card");if(!a)return;let o=Number(a.dataset.ledgerIndex);Number.isFinite(o)&&(s.shiftKey?Ws===o?(Ws=null,Us||(Et=!1),Np()):(Ws=o,Et=!0,Np()):_g(o))});let n=s=>{zs||(zs=s);let a=Math.min(.05,(s-zs)/1e3);zs=s;let o=Kt()?x("ledgerStreamTrack"):null;if(o&&ze>0){if(Gt){let i=o.scrollWidth||0;if(i>100)ct=Math.floor(i/2),Gt=!1,za=0,ze>0&&(mn=ct/ze);else{za++,za>30&&(Gt=!1,za=0),Ha=requestAnimationFrame(n);return}}if(ct>0&&!Et&&Ja){let i=Math.min(1,a/Mg);Vt+=(ds-Vt)*i,Math.abs(ds-Vt)<.5&&(Vt=ds);let r=Vt%ct;o.style.transform=`translateX(${-r}px)`}if(!Et&&Math.floor(s/250)!==Math.floor((s-a*1e3)/250)){let i=Date.now(),r=o.querySelectorAll("article.ledger-card[data-arrival-ts]"),l=12e4;r.forEach(c=>{let d=i-Number(c.dataset.arrivalTs||i),u=Math.max(.52,1-d/l*.48);c.style.opacity=u.toFixed(3)})}if(Va>0){let i=Date.now()-Va>og;Ga(i)}}Ha=requestAnimationFrame(n)};Ha=requestAnimationFrame(n),window.addEventListener("resize",()=>{Gt=!0})}function Kp(){if(mn<=0||ct<=0||ze===0)return Vt;let e=x("ledgerStreamShell"),t=e&&e.offsetWidth||800,n=mn-14,a=(ze-1)*mn+n-t+18;a=Math.max(0,a);let i=Math.floor(Vt/ct)*ct+a;return i<Vt-2&&(i+=ct),i}function Ga(e,t){if(e===Ni)return;Ni=e;let n=x("ledgerStreamShell");if(!n)return;let s=n.querySelector(".stream-stall-overlay");e?(s||(s=document.createElement("div"),s.className="stream-stall-overlay",n.appendChild(s)),s.innerHTML=`<span class="stream-stall-dot"></span> ${y(t||"Waiting for ledgers\u2026")}`):s==null||s.remove()}function Np(){document.querySelectorAll(".ledger-card").forEach(e=>{let t=Number(e.dataset.ledgerIndex);e.classList.toggle("ledger-card--pinned",t===Ws)})}function _g(e){let t=document.querySelector('.dash-tab[data-tab="inspector"]');typeof window.switchTab=="function"&&t?window.switchTab(t,"inspector"):t==null||t.click();let n=document.getElementById("inspect-addr");n&&(n.placeholder=`Ledger #${e.toLocaleString()} \u2014 paste an address`,n.focus())}function Rg(){var t;let e=x("ledgerStreamShell");e&&(e.classList.remove("stream-reconnect-flash"),e.offsetWidth,e.classList.add("stream-reconnect-flash"),setTimeout(()=>e.classList.remove("stream-reconnect-flash"),1200),cg=((t=ls.at(-1))==null?void 0:t.li)??0,Dg())}function Dg(){let e=document.getElementById("reconnect-banner");if(!e){e=document.createElement("div"),e.id="reconnect-banner",e.className="reconnect-banner";let s=document.querySelector(".dashboard-col-main");s&&s.prepend(e)}e.style.display="",e.innerHTML=`
    ...
    <button onclick="document.getElementById('reconnect-banner').style.display='none'"
      style="margin-left:auto;background:none;border:none;color:inherit;opacity:.5;cursor:pointer;font-size:.9rem">\u2715</button>`;let t=3,n=setInterval(()=>{let s=document.getElementById("reconnect-countdown");if(s&&(s.textContent=t),t--,t<0){clearInterval(n);let a=document.getElementById("reconnect-banner");a&&(a.style.display="none")}},4e3)}function _p(){let e=x("ledgerStreamTrack"),t=x("ledgerStreamShell"),n=x("stream-loading");if(!e||!t)return;if(n&&(n.style.display="none"),Xt.length===0){e.innerHTML='<div style="padding:40px;opacity:.6">Waiting for ledgers\u2026</div>',ze=0,Gt=!0;return}let s=[...Xt].sort((o,i)=>o.ledgerIndex-i.ledgerIndex),a=s.map((o,i)=>Yp(o,{prevIndex:i>0?s[i-1].ledgerIndex:null}));e.innerHTML=a.concat(a).join(""),ze=s.length,Gt=!0,requestAnimationFrame(()=>{var i;let o=((i=x("ledgerStreamTrack"))==null?void 0:i.scrollWidth)||0;o>100&&(ct=Math.floor(o/2),mn=ze>0?ct/ze:0,ds=Kp(),Ja=!0,Gt=!1)})}function Ig(e){var f,v;if(!e)return;let t=Number(e.ledgerIndex??NaN);if(!Number.isFinite(t)||Ua.has(t))return;Ua.add(t),Xt.push(e);let n=0;if(Xt.length>pp){let b=Xt.splice(0,Xt.length-pp);b.forEach(h=>Ua.delete(h.ledgerIndex)),n=b.length}Va=Date.now(),Ga(!1),Og(e.avgFee!=null?Number(e.avgFee):null);let{auraClass:s,domColor:a}=Xg(e);Zp(s,a);let o=x("stream-loading");o&&(o.style.display="none");let i=x("ledgerStreamTrack");if(!i)return;if(ze===0){_p();return}let r=Xt.length>=2?Xt[Xt.length-2].ledgerIndex:0;if(t<r){_p();return}let l=ze,c=Yp(e),d=document.createElement("template");d.innerHTML=c;let u=d.content.firstElementChild,p=i.children[l];p?i.insertBefore(u,p):i.appendChild(u);let m=document.createElement("template");if(m.innerHTML=c,i.appendChild(m.content.firstElementChild),ze=l+1,n>0){for(let h=0;h<n;h++)(f=i.children[0])==null||f.remove();let b=ze-n;for(let h=0;h<n;h++)(v=i.children[b])==null||v.remove();ze-=n}Gt=!0,requestAnimationFrame(()=>{mn<=0&&ct>0&&ze>0&&(mn=ct/ze),ds=Kp(),Ja=!0})}var ps=[],Fg=20;function Og(e){e==null||!Number.isFinite(e)||(ps.push(e),ps.length>Fg&&ps.shift())}function Jp(){return ps.length===0?null:ps.reduce((e,t)=>e+t,0)/ps.length}function Yp(e,t={}){let{ledgerIndex:n,closeTimeSec:s,totalTx:a,txTypes:o,avgFee:i}=e,r=o||{},l=a??0,c=Object.entries(r).sort(([,I],[,D])=>D-I)[0],d=(c==null?void 0:c[0])||"Other",u=Qp(d),p=typeof Dt<"u"?Dt:{},m=I=>p[I]||"#6b7280",f=m(d),v=cs(f,.45)||f,b=cs(f,.14)||f,h=s==null?"\u2014":s<2?`${Number(s).toFixed(2)}s`:`${Number(s).toFixed(1)}s`,g=l>0&&s>0?(l/s).toFixed(1):null,w=i!=null?Number(i):null,k=w!=null?un(w):"\u2014",$=Jp(),T=w!=null&&$!=null&&w>$*3,S=t.prevIndex!=null?Number(n)-t.prevIndex-1:0,P=S>0?`<div class="stream-gap-badge" title="${S} ledger(s) missing">\xB7\xB7\xB7&nbsp;${S} gap</div>`:"",M=I=>l>0?`${(I/l*100).toFixed(1)}%`:"0%",N=(I,D,F)=>D?`<div class="ledger-type-row">
    ...
    </div>`:"",_=(r.AMMCreate||0)+(r.AMMDeposit||0)+(r.AMMWithdraw||0)+(r.AMMVote||0),O=Date.now();return`${P}<article class="ledger-card ledger-card--${u} ledger-card--entry${T?" ledger-card--fee-spike":""}"
  ...
  </article>`}function Qp(e){let t=String(e||"");return t==="Payment"?"payment":t.startsWith("Offer")?"offer":t.startsWith("NFToken")?"nft":t==="TrustSet"?"trust":t.startsWith("AMM")?"amm":"other"}function Xg(e){var o;let n=((o=Object.entries(e.txTypes||{}).sort(([,i],[,r])=>r-i)[0])==null?void 0:o[0])||"Other",s=Qp(n),a=Dt[n]||Dt.Other||"#6b7280";return{dominantTx:n,auraClass:s,domColor:a}}function Zp(e,t){let n=x("ledgerStreamShell");if(!n)return;if(!e||!t){n.style.removeProperty("--streamTintStrong"),n.style.removeProperty("--streamTintSoft"),n.style.removeProperty("--streamTintBorder");return}let s=cs(t,.16)||"rgba(0,255,240,0.14)",a=cs(t,.06)||"rgba(0,255,240,0.06)",o=cs(t,.22)||"rgba(0,255,240,0.22)";n.style.setProperty("--streamTintStrong",s),n.style.setProperty("--streamTintSoft",a),n.style.setProperty("--streamTintBorder",o),n.dataset.tint=e}function Bg(e){var b,h;let t=Array.isArray(e.recentTransactions)?e.recentTransactions.slice(0,Zh):[],n=e.txTypes||{},s=Number(e.ledgerIndex||0),a=Object.values(n).reduce((g,w)=>g+w,0)||1,o=0;for(let g of Object.values(n)){let w=g/a;o+=w*w}let i=Hg(t);zg(js,i);let r=jg(js.totals,i),l=Wg(js.totals),c=Ug(s,t),d=qg(s,(b=e.latestLedger)==null?void 0:b.closeTimeSec,t),u=Vg({txs:t,txTypes:n,dexPatterns:d}),p=r.filter(g=>g.count>=2).length,m=Gg({hhi:o,repeats:p,dex:d,bots:((h=c.bots)==null?void 0:h.length)||0,advanced:u}),f=Kg({friction:m,tps:Bt(X.tpsHistory),fee:Bt(X.feeHistory)}),v=Jg({s:e,txTypes:n,hhi:o,dexPatterns:d,behavior:c,friction:m,regime:f,breadcrumbs:r,clusters:l,advanced:u});return{s:e,txs:t,txTypes:n,hhi:o,behavior:c,dexPatterns:d,friction:m,regime:f,breadcrumbs:r,clusters:l,narratives:v,advanced:u}}function Hg(e){let t=new Map;for(let n of e){let s=n==null?void 0:n.account,a=n==null?void 0:n.destination;if(!s||!a)continue;let o=`${s}|${a}`;t.set(o,(t.get(o)||0)+1)}return t}function zg(e,t){e.window.unshift(t);for(let[n,s]of t.entries())e.totals.set(n,(e.totals.get(n)||0)+s);for(;e.window.length>e.maxLedgers;){let n=e.window.pop();for(let[s,a]of n.entries()){let o=(e.totals.get(s)||0)-a;o<=0?e.totals.delete(s):e.totals.set(s,o)}}}function jg(e,t){let s=[...e.entries()].map(([o,i])=>({k:o,c:i})).sort((o,i)=>i.c-o.c).filter(o=>o.c>=2);return(s.length?s:[...t.entries()].map(([o,i])=>({k:o,c:i}))).slice(0,10).map(({k:o,c:i})=>{let[r,l]=o.split("|");return{from:r,to:l,count:i}})}function Wg(e){let t=[...e.entries()].filter(([,i])=>i>=2),n=t.length?t:[...e.entries()],s=new Map;for(let[i]of n){let[r,l]=i.split("|");!r||!l||(s.has(r)||s.set(r,new Set),s.has(l)||s.set(l,new Set),s.get(r).add(l),s.get(l).add(r))}let a=new Set,o=[];for(let i of s.keys()){if(a.has(i))continue;let r=[i],l=[];for(a.add(i);r.length;){let u=r.pop();l.push(u);for(let p of s.get(u)||[])a.has(p)||(a.add(p),r.push(p))}if(l.length<2)continue;let c=l[0],d=-1;for(let u of l){let p=(s.get(u)||new Set).size;p>d&&(d=p,c=u)}o.push({members:l,size:l.length,hub:c})}return o.sort((i,r)=>r.size-i.size),o.slice(0,6)}function Ug(e,t){let n=new Map;for(let a of t){let o=a==null?void 0:a.account;o&&n.set(o,(n.get(o)||0)+1)}for(let[a,o]of n.entries()){At.acct.has(a)||At.acct.set(a,{ledgers:[],intervals:[],total:0});let i=At.acct.get(a),r=i.ledgers.at(-1);i.ledgers.push(e),r!=null&&e>r&&i.intervals.push(e-r),i.ledgers.length>30&&i.ledgers.shift(),i.intervals.length>29&&i.intervals.shift(),i.total+=o}let s=[];for(let[a,o]of At.acct.entries()){if(o.intervals.length<6)continue;let i=fn(o.intervals),r=Ii(o.intervals);if(!i||r==null)continue;let l=r/i;l<.35&&o.total>10&&s.push({acct:a,cv:l,total:o.total})}if(s.sort((a,o)=>a.cv-o.cv||o.total-a.total),e%50===0)for(let[a,o]of At.acct){let i=o.ledgers.at(-1)??e;e-i>1e3&&At.acct.delete(a)}return{bots:s.slice(0,6),uniqueActors:n.size}}function qg(e,t,n){var P;let s=0,a=0,o=new Map,i=new Map,r=new Map;for(let M of n){let N=M==null?void 0:M.type,_=M==null?void 0:M.account;_&&(N==="OfferCreate"?(s+=1,o.set(_,(o.get(_)||0)+1),i.set(_,(i.get(_)||0)+1)):N==="OfferCancel"&&(a+=1,o.set(_,(o.get(_)||0)+1),r.set(_,(r.get(_)||0)+1)))}let l=s+a,c=l?a/l:0,d=t!=null&&Number(t)>0?a/Number(t)*60:null;for(Ee.smoothCancelPerMin=Ap(Ee.smoothCancelPerMin,d,.45),Ee.window.unshift({li:e,closeTimeSec:t??null,create:s,cancel:a,total:l,cancelRatio:c,cancelsPerMin:Ee.smoothCancelPerMin,byActor:o,byActorCreate:i,byActorCancel:r});Ee.window.length>tg;)Ee.window.pop();let u={create:0,cancel:0,total:0},p=new Map,m=new Map,f=new Map;for(let M of Ee.window){u.create+=M.create,u.cancel+=M.cancel,u.total+=M.total;for(let[N,_]of M.byActor.entries())p.set(N,(p.get(N)||0)+_);for(let[N,_]of M.byActorCancel.entries())m.set(N,(m.get(N)||0)+_);for(let[N,_]of M.byActorCreate.entries())f.set(N,(f.get(N)||0)+_)}let v=Ci(p,5),b=Ci(m,5),h=Ci(f,5),g=u.total?(((P=v[0])==null?void 0:P.count)||0)/u.total:0,w=0;if(u.total)for(let M of p.values()){let N=M/u.total;w+=N*N}let k=Ee.window.map(M=>M.total).filter(Number.isFinite),$=fn(k)||0,T=$>0?(l-$)/$*100:null;Ee.smoothBurst=Ap(Ee.smoothBurst,T,.4);let S=[];return u.total>=$i&&c>=.65&&S.push("Lots of cancels (looks like quote-stuffing/spam)"),u.total>=$i&&g>=.35&&S.push("One actor dominates DEX activity"),u.total>=$i&&(Ee.smoothCancelPerMin||0)>=18&&S.push("Fast cancelling (high churn)"),Ee.smoothBurst!=null&&Math.abs(Ee.smoothBurst)>=45&&S.push("Sudden DEX burst"),{now:{li:e,create:s,cancel:a,total:l,cancelRatio:c,cancelsPerMin:Ee.smoothCancelPerMin},window:{...u,cancelRatio:u.total?u.cancel/u.total:0},topShare:g,actorHHI:w,burstPct:Ee.smoothBurst,topActor:v,topCanceller:b,topMaker:h,signals:S}}function Ci(e,t){return[...e.entries()].sort((n,s)=>s[1]-n[1]).slice(0,t).map(([n,s])=>({acct:n,count:s}))}function Vg({txs:e,txTypes:t,dexPatterns:n}){var H;let s=Number((t==null?void 0:t.OfferCreate)||0)+Number((t==null?void 0:t.OfferCancel)||0),a=Number((t==null?void 0:t.NFTokenMint)||0),o=Number((t==null?void 0:t.NFTokenBurn)||0),i=0,r=new Map,l=new Map;for(let A of e){if((A==null?void 0:A.type)!=="Payment")continue;let z=(A==null?void 0:A.paths)||(A==null?void 0:A.Paths),te=Array.isArray(z)&&z.length>0,oe=(A==null?void 0:A.sendmax)!=null||(A==null?void 0:A.SendMax)!=null,pe=(A==null?void 0:A.delivermax)!=null||(A==null?void 0:A.DeliverMax)!=null;if(!(te||oe||pe))continue;i+=1;let ne=A==null?void 0:A.account,ce=A==null?void 0:A.destination;if(ne&&r.set(ne,(r.get(ne)||0)+1),ne&&ce){let G=`${ne}|${ce}`;l.set(G,(l.get(G)||0)+1)}}let c=[...r.entries()].sort((A,z)=>z[1]-A[1]).slice(0,5).map(([A,z])=>({acct:A,count:z})),d=[...l.entries()].sort((A,z)=>z[1]-A[1]).slice(0,5).map(([A,z])=>{let[te,oe]=A.split("|");return{from:te,to:oe,count:z}}),u=(H=n==null?void 0:n.now)!=null&&H.total?Math.round((n.now.cancelRatio||0)*100):0,p=(n==null?void 0:n.topShare)!=null?Math.round(n.topShare*100):0,m=e.filter(A=>(A==null?void 0:A.type)==="Payment").map(A=>typeof(A==null?void 0:A.amountXrp)=="number"?A.amountXrp:null).filter(A=>A!=null&&A>0&&Number.isFinite(A)),f=[100,1e3,1e4],v=m.filter(A=>f.some(z=>Math.abs(A%z)<1e-9&&A/z>=1)).length,b=m.length>=5?Math.round(v/m.length*100):null,h=e.filter(A=>(A==null?void 0:A.type)==="Payment"&&(A==null?void 0:A.account)&&(A==null?void 0:A.destination)&&A.account===A.destination).length,g=Number((t==null?void 0:t.AMMCreate)||0),w=Number((t==null?void 0:t.AMMDeposit)||0),k=Number((t==null?void 0:t.AMMWithdraw)||0),$=Number((t==null?void 0:t.AMMVote)||0),T=Number((t==null?void 0:t.AMMBid)||0),S=Number((t==null?void 0:t.AMMDelete)||0),P=g+w+k+$+T+S,M=w-k,N=w+k>0?Math.round(w/(w+k)*100):null,_=new Set;for(let A of e)["AMMCreate","AMMDeposit","AMMWithdraw","AMMVote","AMMBid"].includes(A==null?void 0:A.type)&&(A!=null&&A.account)&&_.add(A.account);let O=_.size,I=0,D=0;for(let A of e)(A==null?void 0:A.type)==="Payment"&&Array.isArray(A==null?void 0:A.paths)&&A.paths.length>0&&(I+=A.paths.length,D++);let F=D>0?(I/D).toFixed(1):null;return{offerTotal:s,dexCancelPct:u,dexTopSharePct:p,mints:a,burns:o,pathPays:i,topPathActors:c,topPathPairs:d,roundnessIdx:b,selfTradeCount:h,ammCreate:g,ammDeposit:w,ammWithdraw:k,ammVote:$,ammBid:T,ammDelete:S,lpTotal:P,lpNetFlow:M,lpRatio:N,lpUniqueActors:O,avgPathDepth:F}}function Gg({hhi:e,repeats:t,dex:n,bots:s,advanced:a}){var h,g;let o=ke((e-.22)/.25,0,1)*22,i=ke((t-2)/6,0,1)*12,r=((h=n==null?void 0:n.window)==null?void 0:h.cancelRatio)??0,l=(n==null?void 0:n.topShare)??0,c=((g=n==null?void 0:n.now)==null?void 0:g.cancelsPerMin)??0,d=ke((r-.5)/.5,0,1)*18,u=ke((l-.25)/.5,0,1)*18,p=ke(c/25,0,1)*10,m=ke(s/6,0,1)*10,f=(a==null?void 0:a.roundnessIdx)!=null?ke((a.roundnessIdx-30)/40,0,1)*8:0,v=(a==null?void 0:a.selfTradeCount)>0?Math.min(8,a.selfTradeCount*4):0,b=(a==null?void 0:a.pathPays)!=null?ke(a.pathPays/30,0,1)*6:0;return Math.round(o+i+d+u+p+m+f+v+b)}function Kg({friction:e,tps:t,fee:n}){let s=(n==null?void 0:n.deltaPct)!=null&&Math.abs(n.deltaPct)>=35,a=(t==null?void 0:t.deltaPct)!=null&&Math.abs(t.deltaPct)>=25;return e>=75?"Manipulated":s||a?"Stressed":((t==null?void 0:t.cur)??0)>=12||((t==null?void 0:t.avg)??0)>=10?"Active":"Quiet"}function Jg({s:e,txTypes:t,hhi:n,dexPatterns:s,behavior:a,friction:o,regime:i,breadcrumbs:r,clusters:l,advanced:c}){var h,g,w,k,$;let d=[],u=Bt(X.tpsHistory,Jt),p=Bt(X.feeHistory,Jt),m=((h=Object.entries(t||{}).sort(([,T],[,S])=>S-T)[0])==null?void 0:h[0])||"\u2014",f=Number(e.txPerLedger||0);d.push({sentiment:i==="Manipulated"||i==="Stressed"?"warn":i==="Active"?"up":"ok",title:`Overall: ${i} \xB7 Risk score ${o}/100`,detail:"Heuristic score from concentration, repeats, DEX churn, bot-like timing, and routing indicators. It's a signal, not proof."}),d.push({sentiment:"ok",title:`Ledger snapshot: #${Number(e.ledgerIndex||0).toLocaleString()} \xB7 ${f} tx \xB7 most common: ${m}`,detail:`TPS ${os(u.cur,2)} (avg ${os(u.avg,2)} \xB7 ${hn(u.deltaPct,0)}). Fee ${p.cur!=null?un(p.cur):"\u2014"} (avg ${p.avg!=null?un(p.avg):"\u2014"} \xB7 ${hn(p.deltaPct,0)}).`});let v=n>=.35?"high":n>=.25?"medium":"low";if(d.push({sentiment:n>=.35?"warn":"ok",title:`Transaction mix: ${v} concentration (HHI ${n.toFixed(2)})`,detail:n>=.35?"A few tx types dominate. Patterns look \u201Cstronger,\u201D but can be misleading.":"Mix is broad. Strong signals usually come from behavior, not just tx type."}),s.window.total){let T=Math.round(s.window.cancelRatio*100),S=Math.round(s.topShare*100);d.push({sentiment:s.signals.length?"warn":"ok",title:`DEX monitor: ${s.window.total} offer tx (window) \xB7 cancels ${T}% \xB7 top actor ~${S}%`,detail:s.signals.length?`Signals: ${s.signals.join(" \xB7 ")}`:"No strong DEX-pattern signals right now.",addr:((g=s.topActor[0])==null?void 0:g.acct)||null})}let b=r.filter(T=>T.count>=2).length;if(b>=2&&d.push({sentiment:"new",title:`Repeating counterparties: ${b} recurring pair(s)`,detail:"Repeated interactions can be routing loops, bots, or coordinated flows. Click addresses for a quick read."}),l!=null&&l.length&&((w=l[0])==null?void 0:w.size)>=3&&d.push({sentiment:"new",title:`Cluster forming: ${l[0].size} wallets \xB7 hub ${j(l[0].hub)}`,detail:"Clusters are co-activity groups (not identity proof). Use as \u201Clikely related behavior.\u201D",addr:l[0].hub}),(k=a.bots)!=null&&k.length){let T=a.bots[0];d.push({sentiment:"warn",title:`Bot-like timing: ${a.bots.length} candidate(s)`,detail:`Low variance in repeated appearances. Top: ${j(T.acct)} (CV ${T.cv.toFixed(2)}).`,addr:T.acct})}if(c!=null&&c.pathPays){let T=($=c.topPathActors)==null?void 0:$[0];d.push({sentiment:c.pathPays>=18?"warn":"ok",title:`Autobridge-ish routing: ${c.pathPays} path payments (ledger sample)`,detail:T?`Most active routing wallet: ${j(T.acct)} (${T.count}).`:"Paths/SendMax/DeliverMax appear frequently in the sample.",addr:(T==null?void 0:T.acct)||null})}return c!=null&&c.selfTradeCount&&d.push({sentiment:"warn",title:`Self-transfer signal: ${c.selfTradeCount} payment(s) where sender = receiver`,detail:"Self-transfers can be benign (housekeeping) or used to fake activity. Treat as a watch signal."}),((c==null?void 0:c.roundnessIdx)??0)>=45&&d.push({sentiment:"warn",title:`Round-number bias: ${c.roundnessIdx}% of payments are exact multiples of 100/1,000/10,000`,detail:"Round-number bias often shows scripted behavior (bots) rather than human payments."}),d.slice(0,12)}function Yg(e){let t=x("d2-breadcrumb-list"),n=x("d2-breadcrumb-meta");if(!t)return;if(!e.length){t.innerHTML='<div class="gateway-item" style="opacity:.6">Watching for repeated interactions\u2026</div>',n&&(n.textContent="\u2014");return}let s=e.filter(a=>a.count>=2).length;n&&(n.textContent=s?`${s} repeats`:"Top interactions"),t.innerHTML=e.slice(0,10).map(a=>`
    <div class="gateway-item gateway-row">
    ...
    </div>`).join("")}function Qg(e){let t=x("d2-cluster-list"),n=x("d2-cluster-persistence");if(t){if(!e.length){t.innerHTML='<div class="gateway-item" style="opacity:.6">Building clusters\u2026 (needs repeated activity)</div>',n&&(n.textContent="\u2014");return}n&&(n.textContent=`${e.length} group${e.length!==1?"s":""}`),t.innerHTML=e.slice(0,6).map((s,a)=>{let i=`hsl(${(a*67+120)%360},70%,60%)`,r=s.members.slice(0,4);return`
      ...
      </div>`}).join("")}}function Zg(e){let t=x("d2-delta-narratives");if(!t)return;if(!e.length){t.innerHTML='<div class="gateway-item" style="opacity:.6">Building baseline \u2014 narratives appear after 1\u20132 ledgers\u2026</div>';return}let n={up:"#50fa7b",down:"#ff5555",new:"#00d4ff",warn:"#ffb86c",ok:"rgba(255,255,255,.85)"};t.innerHTML=e.map(s=>{let a=n[s.sentiment]||"rgba(255,255,255,.85)",o=s.addr&&Fe(s.addr)?`<button class="addr-link narrative-addr" data-addr="${y(s.addr)}">Peek</button>`:"";return`
  ...
  `,t?t.insertAdjacentElement("afterend",s):n?n.insertAdjacentElement("afterend",s):e.prepend(s)}function nv(){if(hp)return;hp=!0;let e=document.querySelector(".dashboard-col-main");if(!e)return;let t=document.createElement("section");t.className="widget-card",t.id="landscape-card",t.setAttribute("aria-label","Landscape brief"),t.innerHTML=`
  ...
  `,e.prepend(t)}function sv(e){var g,w,k,$,T,S,P,M,N,_,O,I,D,F,H;let t=x("landscape-badge");t&&(t.textContent=`${e.regime} \xB7 Risk ${e.friction}/100`);let n=e.s,s=e.txTypes||{},a=((g=Object.entries(s).sort(([,A],[,z])=>z-A)[0])==null?void 0:g[0])||"\u2014",o=Bt(X.tpsHistory,Jt),i=Bt(X.feeHistory,Jt),r=e.dexPatterns,l=(w=r==null?void 0:r.window)!=null&&w.total?Math.round(r.window.cancelRatio*100):0,c=x("landscape-text");if(c){let A=Number(n.ledgerIndex||0).toLocaleString(),z=Number(n.txPerLedger||0),te=((k=n.latestLedger)==null?void 0:k.closeTimeSec)!=null?Number(n.latestLedger.closeTimeSec).toFixed(2)+"s":"\u2014",oe=o.cur!=null?`${os(o.cur,2)} TPS`:"\u2014",pe=i.cur!=null?`${un(i.cur)} fee`:"\u2014",ie=n.successRate!=null?`${Number(n.successRate).toFixed(1)}% success`:"\u2014",ne=($=r==null?void 0:r.window)!=null&&$.total?`DEX offers are <b>${r.window.total}</b> (window), with <b>${l}% cancels</b>.`:"DEX offers look quiet right now.";c.innerHTML=`
      <b>Right now:</b> Ledger <b>#${A}</b> closed in <b>${te}</b> with <b>${z}</b> transactions.
      Network is at <b>${oe}</b>, with <b>${pe}</b>, and <b>${ie}</b>.
      Most common activity was <b>${y(a)}</b>. ${ne}
    `}let d=x("landscape-why"),u=x("landscape-watchlist"),p=x("landscape-now"),m=x("landscape-watch"),f=[],v=[],b=[];if(e.regime==="Manipulated"?b.push("Risk score is very high. Patterns like churn, loops, or single-actor dominance often correlate with manipulated activity."):e.regime==="Stressed"?b.push("The network is behaving \u201Cabnormally\u201D (spikes in TPS or fees). This can be organic bursts or bots pushing volume."):e.regime==="Active"?b.push("The network is busy. Patterns are easier to detect because there\u2019s more data per minute."):b.push("The network is quiet. Signals are weaker; a few bots can dominate a small sample."),(T=r==null?void 0:r.signals)!=null&&T.length&&b.push(`DEX churn signals: <b>${y(r.signals.join(" \xB7 "))}</b>. Heavy OfferCreate/Cancel churn can indicate quote-stuffing/spoofing-like behavior.`),((S=e.advanced)==null?void 0:S.selfTradeCount)>0&&b.push(`Detected <b>${e.advanced.selfTradeCount}</b> self-transfer payment(s) in the sample. Can be benign, but can also be used to fake activity.`),(((P=e.advanced)==null?void 0:P.roundnessIdx)??0)>=45&&b.push(`Round-number bias is high (<b>${e.advanced.roundnessIdx}%</b>). That often indicates automation rather than human behavior.`),((M=e.advanced)==null?void 0:M.pathPays)>=18&&b.push(`Path payments are heavy (<b>${e.advanced.pathPays}</b> in sample). Lots of routing can mean arbitrage bots or automated bridge traffic.`),d&&(d.innerHTML=b.map(A=>`<div class="landscape-row">${A}</div>`).join("")),f.push(`Overall mode: <b>${y(e.regime)}</b> (risk score <b>${e.friction}/100</b>).`),f.push(`Traffic: <b>${os(o.cur,2)}</b> TPS (avg ${os(o.avg,2)} \xB7 ${hn(o.deltaPct,0)}).`),f.push(`Fees: <b>${i.cur!=null?un(i.cur):"\u2014"}</b> (avg ${i.avg!=null?un(i.avg):"\u2014"} \xB7 ${hn(i.deltaPct,0)}).`),(N=r==null?void 0:r.window)!=null&&N.total){let A=(_=r.topActor)==null?void 0:_[0];f.push(`DEX activity: <b>${r.window.total}</b> offer tx (window) \xB7 cancels <b>${l}%</b> \xB7 churn <b>${os(r.now.cancelsPerMin,1)}</b>/min.`),A&&f.push(`Most active DEX wallet: <button class="addr-link mono" data-addr="${y(A.acct)}">${y(j(A.acct))}</button> (${A.count}).`)}else f.push("DEX activity: <b>quiet</b> (few OfferCreate/OfferCancel).");let h=e.breadcrumbs.filter(A=>A.count>=2).length;if(h&&v.push(`Repeating interactions: <b>${h}</b> pair(s) keep showing up.`),(I=(O=e.behavior)==null?void 0:O.bots)!=null&&I.length){let A=e.behavior.bots[0];v.push(`Bot-like timing: top candidate <button class="addr-link mono" data-addr="${y(A.acct)}">${y(j(A.acct))}</button> (CV ${A.cv.toFixed(2)}).`)}if((D=r==null?void 0:r.signals)!=null&&D.length&&v.push(`DEX signals: <b>${y(r.signals.join(" \xB7 "))}</b>`),(F=e.clusters)!=null&&F.length&&v.push(`Largest cluster: <b>${e.clusters[0].size}</b> wallets \xB7 hub <button class="addr-link mono" data-addr="${y(e.clusters[0].hub)}">${y(j(e.clusters[0].hub))}</button>.`),(H=e.advanced)!=null&&H.pathPays&&v.push(`Autobridge/path flow: <b>${e.advanced.pathPays}</b> path payments detected in sample.`),v.length||v.push("Nothing urgent stands out in the current window."),p&&(p.innerHTML=f.map(A=>`<div class="landscape-row">${A}</div>`).join("")),m&&(m.innerHTML=v.map(A=>`<div class="landscape-row">${A}</div>`).join("")),u){let A=av(e);u.innerHTML=A.length?A.map(z=>`
  ...
  `,e.prepend(t)}function iv(e){var p,m;if(!document.getElementById("dex-pattern-card"))return;let t=e.window.total||0,n=t?Math.round(e.window.cancelRatio*100):0,s=t?Math.round(e.topShare*100):0;V("dexp-badge",t?`${t} offer tx \xB7 ${n}% cancels`:"Quiet");let a=x("dexp-cancel-bar");a&&(a.style.width=`${ke(n,0,100)}%`),V("dexp-cancel-val",t?`${n}%`:"\u2014");let o=x("dexp-topshare-bar");o&&(o.style.width=`${ke(s,0,100)}%`),V("dexp-topshare-val",t?`${s}%`:"\u2014");let i=e.burstPct,r=i==null?0:Math.min(100,Math.abs(i)),l=x("dexp-burst-bar");l&&(l.style.width=`${r}%`),V("dexp-burst-val",i==null?"\u2014":hn(i,0)),V("dexp-cpm",e.now.cancelsPerMin==null?"\u2014":e.now.cancelsPerMin.toFixed(1)),V("dexp-hhi",t?e.actorHHI.toFixed(2):"\u2014"),V("dexp-totalwin",t?`${t}`:"\u2014");let c=x("dexp-signals");c&&(c.innerHTML=e.signals.length?e.signals.map(f=>`<span class="sig-pill warn">${y(f)}</span>`).join(""):'<span class="sig-pill ok">No strong DEX signals</span>');let d=x("dexp-cancellers");d&&(d.innerHTML=(p=e.topCanceller)!=null&&p.length?e.topCanceller.slice(0,5).map(f=>`
        ...
        <div class="dex-rowline">
          <button class="addr-link mono cut" data-addr="${y(f.acct)}">${y(j(f.acct))}</button>
          <span class="mono">${f.count}</span>
        </div>`).join(""):'<div style="opacity:.7">\u2014</div>')}function rv(){if(vp)return;vp=!0;let e=document.querySelector(".dashboard-col-main");if(!e)return;let t=document.createElement("section");t.className="widget-card",t.id="risk-card",t.setAttribute("aria-label","Risk panel"),t.innerHTML=`
    <div class="widget-header">
  ...
  `,t.querySelectorAll(".risk-box-toggle").forEach(n=>{var a;n.addEventListener("click",()=>{let o=n.getAttribute("data-target"),i=document.getElementById(o);if(!i)return;let r=n.getAttribute("aria-expanded")!=="false";n.setAttribute("aria-expanded",r?"false":"true"),i.classList.toggle("risk-collapsed",r),n.querySelector(".risk-box-chevron").textContent=r?"\u25B8":"\u25BE";try{localStorage.setItem("risk_collapsed_"+o,r?"1":"0")}catch{}});let s=n.getAttribute("data-target");try{localStorage.getItem("risk_collapsed_"+s)==="1"&&(n.setAttribute("aria-expanded","false"),(a=document.getElementById(s))==null||a.classList.add("risk-collapsed"),n.querySelector(".risk-box-chevron").textContent="\u25B8")}catch{}}),e.appendChild(t)}function lv(e){var r,l,c,d,u,p,m,f,v,b;if(!document.getElementById("risk-card"))return;V("risk-badge",`Risk ${e.friction}/100`),V("risk-regime",e.regime),V("risk-friction",`${e.friction}/100`);let t=[];e.hhi>=.35&&t.push({cls:"warn",t:"High concentration"}),e.breadcrumbs.filter(h=>h.count>=2).length>=3&&t.push({cls:"new",t:"Repeating counterparties"}),(l=(r=e.behavior)==null?void 0:r.bots)!=null&&l.length&&t.push({cls:"warn",t:"Bot-like timing"}),(d=(c=e.dexPatterns)==null?void 0:c.signals)!=null&&d.length&&t.push({cls:"warn",t:"DEX churn signals"}),((u=e.advanced)==null?void 0:u.selfTradeCount)>0&&t.push({cls:"warn",t:`Self-transfer: ${e.advanced.selfTradeCount}`}),(((p=e.advanced)==null?void 0:p.roundnessIdx)??0)>=45&&t.push({cls:"warn",t:`Round-number bias ${e.advanced.roundnessIdx}%`}),((m=e.advanced)==null?void 0:m.pathPays)>0&&t.push({cls:"warn",t:`Path flow: ${e.advanced.pathPays}`}),V("risk-signalcount",`${t.length}`);let n=x("risk-pills");n&&(n.innerHTML=t.length?t.map(h=>`<span class="sig-pill ${h.cls}">${y(h.t)}</span>`).join(""):'<span class="sig-pill ok">No elevated signals</span>');let s=x("risk-bots");if(s){let h=((f=e.behavior)==null?void 0:f.bots)||[];if(h.length){let g={};for(let k of h){let $=k.botType||"Periodic";g[$]||(g[$]=[]),g[$].push(k)}let w=["Market Maker","Arbitrage","Flood / Spam","Periodic"];s.innerHTML=w.filter(k=>g[k]).map(k=>{let $=g[k];return`<div class="bot-type-group">
          ...
          `).join("")}
        </div>`}).join("")}else s.innerHTML='<div style="opacity:.7;font-size:.84rem">No periodic bots detected yet</div>'}let a=x("risk-amm");if(a){let h=e.advanced||{},{ammCreate:g=0,ammDeposit:w=0,ammWithdraw:k=0,ammVote:$=0,ammBid:T=0,lpTotal:S=0,lpNetFlow:P=0,lpRatio:M,lpUniqueActors:N=0}=h;if(S===0)a.innerHTML='<div style="opacity:.6;font-size:.84rem">No AMM activity in this ledger</div>';else{let _=P>0?"#50fa7b":P<0?"#ff5555":"rgba(255,255,255,.5)";a.innerHTML=`
        <div class="amm-chips">
  ...
  `,e.appendChild(t),(s=x("spam-copy-hash"))==null||s.addEventListener("click",()=>{var i;return Dp(((i=x("spam-proof-hash"))==null?void 0:i.textContent)||"")}),(a=x("spam-copy-json"))==null||a.addEventListener("click",()=>{var i;return Dp(((i=x("spam-proof-json"))==null?void 0:i.textContent)||"")}),(o=x("spam-print-proof"))==null||o.addEventListener("click",$v),_renderBondSim()}window._toggleBondSim=function(){let e=x("spam-sim-panel");if(!e)return;let t=e.style.display!=="none";e.style.display=t?"none":"";let n=x("spam-sim-toggle");n&&(n.style.color=t?"":"#00d4ff")};window._renderBondSim=function(){let e=document.getElementById("sim-base"),t=document.getElementById("sim-growth"),n=document.getElementById("sim-table");if(!n)return;let s=Number((e==null?void 0:e.value)||ms),a=Number((t==null?void 0:t.value)||fs),o=fe.marketPrice.at(-1)??null;document.getElementById("sim-base-val")&&(document.getElementById("sim-base-val").textContent=s+" XRP"),document.getElementById("sim-growth-val")&&(document.getElementById("sim-growth-val").textContent=a+"\xD7");let i="";for(let r=0;r<=Gs;r++){let l=Math.round(s*a**r),c=o?"$"+(l*o).toLocaleString(void 0,{maximumFractionDigits:0}):"",d=r<3?"#50fa7b":r<6?"#ffb86c":"#ff5555";i+=`<div style="padding:5px;border-radius:6px;background:rgba(255,255,255,.03);border:1px solid rgba(255,255,255,.07)">
      ...
      ${c?`<div style="font-size:.62rem;opacity:.45">${c}</div>`:""}
          ...
          <div class="spam-card" data-spam-addr="${y(d.addr)}">
            ...
            <div class="spam-breakdown" id="spam-bd-${y(d.addr.slice(0,10))}" style="display:none">
              ${gv(d.breakdown,d.strikes)}
            </div>
          </div>`}).join(""):r.innerHTML=`<div class="spam-empty">No suspects flagged \u2014 allow-list has ${Wp.size} known-good entities.</div>`),_i||vv(),le.selectedAddr){let d=le.byAddr.get(le.selectedAddr);d?Xi(le.selectedAddr,d,e.s.ledgerIndex).then(u=>us(u)):us(null)}((l=document.getElementById("spam-sim-panel"))==null?void 0:l.style.display)!=="none"&&((c=window._renderBondSim)==null||c.call(window))}function hv(e){if(!(e!=null&&e.length))return"";let t=42,n=14,s=1,a=t/Math.max(1,e.length-1),o=e.map((l,c)=>`${(c*a).toFixed(1)},${(n-2-l/s*(n-4)).toFixed(1)}`).join(" "),i=e.at(-1)??0,r=i>=.7?"#ff5555":i>=.4?"#ffb86c":"#50fa7b";return`<svg width="${t}" height="${n}" xmlns="http://www.w3.org/2000/svg" style="overflow:visible">
    ...
    <circle cx="${((e.length-1)*a).toFixed(1)}" cy="${(n-2-i/s*(n-4)).toFixed(1)}"
      r="2" fill="${r}"/>
  </svg>`}function gv(e={},t=0){let n=[{label:"Bot timing",val:e.bot??0,desc:e.botType?`Type: ${e.botType}`:"Low variance in repeated ledger appearances"},{label:"DEX dominance",val:e.dexDom??0,desc:"Share of offer tx window controlled by this address"},{label:"Cancel pattern",val:e.cancelPat??0,desc:"Heavy OfferCancel activity relative to creates"},{label:"Ping-pong loop",val:e.pingPong??0,desc:"Bidirectional repeated payments between two addresses"},{label:"Path routing",val:e.pathRoute??0,desc:"High path-payment count \u2014 common in arb bots"},{label:"Self-transfer",val:e.selfTrade??0,desc:"Payments where sender = receiver"},{label:"Round-number pay",val:e.roundPay??0,desc:"Unusual bias toward exact round-number payment amounts"}].filter(s=>s.val>.001);return n.length?`
    ...
    `)}function bv(e){var o,i,r,l,c;le.allowList.size||Oi();let t=new Set;(((o=e.behavior)==null?void 0:o.bots)||[]).forEach(d=>t.add(d.acct)),(((i=e.dexPatterns)==null?void 0:i.topActor)||[]).forEach(d=>t.add(d.acct)),(((r=e.dexPatterns)==null?void 0:r.topCanceller)||[]).forEach(d=>t.add(d.acct)),(((l=e.dexPatterns)==null?void 0:l.topMaker)||[]).forEach(d=>t.add(d.acct)),(e.breadcrumbs||[]).forEach(d=>{t.add(d.from),t.add(d.to)}),(e.clusters||[]).forEach(d=>{t.add(d.hub),(d.members||[]).forEach(u=>t.add(u))}),(((c=e.advanced)==null?void 0:c.topPathActors)||[]).forEach(d=>t.add(d.acct));let n=Number(e.s.ledgerIndex||0)||null,s=e.txs||[],a=[];if(n&&n%50===0){let d=ja*24;for(let[u,p]of le.byAddr)n-(p.lastSeenLedger||0)>d&&le.byAddr.delete(u)}for(let d of t){if(!Fe(d)||Wp.has(d)||le.allowList.has(d))continue;let{score:u,breakdown:p}=wv(d,e),m=yv(p),f=le.byAddr.get(d)||{strikes:0,level:0,score:0,verifiedLedger:null,lastSeenLedger:null,scoreHistory:[],threatType:"Unknown",signalBreakdown:{}},v=f.strikes||0;u>=Hp?v+=1:u<=Pi&&(v=Math.max(0,v-1));let b=f.lastSeenLedger||n,h=n?n-b:0;if(h>ja&&u<Pi){let S=Math.floor(h/ja);v=Math.max(0,v-S)}let g=ke(Math.floor(v/Bp),0,Gs),w=[...f.scoreHistory||[],u].slice(-10),k=le.verifiedCache.get(d),$=f.verifiedLedger??(k==null?void 0:k.ledgerIndex)??null;$||($=xv(d,g,s,n),$&&kv(d,g,n));let T={score:u,strikes:v,level:g,verifiedLedger:$,lastSeenLedger:n,scoreHistory:w,threatType:m,signalBreakdown:p};le.byAddr.set(d,T),a.push({addr:d,score:u,strikes:v,level:g,verified:!!$,verifiedLedger:$,scoreHistory:w,threatType:m,breakdown:p})}return a.sort((d,u)=>u.level-d.level||u.score-d.score),a.slice(0,ig)}function yv(e){let{bot:t=0,dexDom:n=0,cancelPat:s=0,pingPong:a=0,pathRoute:o=0,selfTrade:i=0,roundPay:r=0}=e,l=n+s;return t>.25&&(e.botType==="Flood / Spam"||r>.05)?"Payment Flooder":t>.2&&l>.15?"DEX Bot":l>.3&&s>.1?"Quote Stuffer":a>.1?"Wash Trader":o>.1?"Arb Router":t>.2?"Periodic Bot":"Multi-Signal"}function wv(e,t){var m,f,v,b,h;let n={bot:0,botType:null,dexDom:0,cancelPat:0,pingPong:0,pathRoute:0,selfTrade:0,roundPay:0},s=(((m=t.behavior)==null?void 0:m.bots)||[]).find(g=>g.acct===e);if(s){let g=ke((.35-s.cv)/.35,0,1);n.bot=+(.4*(.5+.5*g)).toFixed(3),n.botType=s.botType||"Periodic"}let a=t.dexPatterns,o=((v=(f=a==null?void 0:a.topActor)==null?void 0:f[0])==null?void 0:v.acct)===e&&a.topShare||0;o>0&&(n.dexDom=+(.3*ke((o-.2)/.4,0,1)).toFixed(3));let i=((a==null?void 0:a.topCanceller)||[]).find(g=>g.acct===e);i&&(n.cancelPat=+(.2*ke(i.count/20,0,1)).toFixed(3));let r=t.breadcrumbs||[],l=r.find(g=>g.from===e&&g.to===e);l&&(n.selfTrade=+(.2*ke(l.count/20,0,1)).toFixed(3));let c=r[0];if(c&&(c.from===e||c.to===e)){let g=r.find(w=>w.from===c.to&&w.to===c.from);g&&g.count>=3&&c.count>=3&&(n.pingPong=.15)}let d=(((b=t.advanced)==null?void 0:b.topPathActors)||[]).find(g=>g.acct===e);d&&(n.pathRoute=+(.15*ke(d.count/25,0,1)).toFixed(3));let u=(h=t.advanced)==null?void 0:h.roundnessIdx;return u!=null&&u>=45&&(d||s)&&(n.roundPay=+(.1*ke((u-45)/35,0,1)).toFixed(3)),{score:ke(n.bot+n.dexDom+n.cancelPat+n.pingPong+n.pathRoute+n.selfTrade+n.roundPay,0,1),breakdown:n}}function xv(e,t,n,s){if(!(n!=null&&n.length))return null;let a=rs+t;for(let o of n)if((o==null?void 0:o.account)===e){if(o.type==="EscrowCreate"&&o.destination===e){let i=typeof o.amountXrp=="number"?o.amountXrp:null,r=qs(t);if(i!=null&&i>=r&&Ri(o.memos).startsWith(pn))return s}if(o.type==="Payment"&&o.destination===e&&Number(o.destinationTag)===a&&Ri(o.memos).startsWith(pn))return s}return null}async function kv(e,t,n){var a;let s=le.byAddr.get(e);if(s)try{let o=await Xi(e,s,n),i=pn+o.hash;if((((a=X.ledgerLog)==null?void 0:a.flatMap(c=>c.transactions||[]))||[]).some(c=>(c==null?void 0:c.account)!==e?!1:Ri(c.memos).startsWith(i))){let c=su();c[e]={ledgerIndex:n,hash:o.hash,level:t},mv(c),le.verifiedCache.set(e,{ledgerIndex:n,hash:o.hash}),ae(`\u2714 Credential verified for ${j(e)} at L${t}`)}}catch{}}function Ri(e){if(!Array.isArray(e))return"";let t=[];for(let n of e){let s=(n==null?void 0:n.Memo)||(n==null?void 0:n.memo)||null;if(!s)continue;let a=s.MemoData||s.memo_data||"";try{if(typeof a=="string"&&/^[0-9A-Fa-f]+$/.test(a)&&a.length%2===0){let o=Uint8Array.from(a.match(/../g),i=>parseInt(i,16));t.push(new TextDecoder().decode(o))}else typeof a=="string"&&t.push(a)}catch{}}return t.join(" ")}async function Xi(e,t,n){let s=t.level||0,a=qs(s),o=fe.marketPrice.at(-1)??null,i=o?(a*o).toFixed(2):null,r={hashAlgorithm:"SHA-512Half",ratchetMax:Gs,strikesToLevel:Bp,strikeUp:Hp,strikeDown:Pi,decayLedgers:ja,bondBaseXrp:ms,bondGrowthFactor:fs,bondRequiredXrp:a,bondRequiredUsd:i,credTagBase:rs,memoPrefix:pn,credentialTag:rs+s},l={v:2,hashAlg:"SHA-512Half",network:X.currentNetwork||"xrpl-mainnet",address:e,ledgerIndex:n!=null?Number(n):null,level:s,threatType:t.threatType||"Unknown",score:Number((t.score||0).toFixed(4)),strikes:Number(t.strikes||0),signalBreakdown:t.signalBreakdown||{},credential:{destinationTag:rs+s,memoFormat:pn+"<SHA-512Half-of-this-proof>",verifiedLedger:t.verifiedLedger??null},policy:r,note:"Generated by NaluXRP Spam Defense POC. Hash uses XRPL-native SHA-512Half (first 256 bits of SHA-512). A gateway or relayer policy can require the indicated bond/credential before providing service to this address.",generatedAt:new Date().toISOString()},c=JSON.stringify(l,Object.keys(l).sort(),0),d=await ug(c);l.credential.memoFormat=pn+d;let u=JSON.stringify(l,null,2);return{hash:d,canonicalJson:u,level:s,policy:r,threatType:t.threatType}}function $v(){let e=le.selectedProof;if(!e){ge("Generate a proof first using the Proof button.");return}let t=le.selectedAddr||"\u2014",n=fe.marketPrice.at(-1)??null,s=e.policy.bondRequiredXrp,a=n?` (~$${(s*n).toFixed(0)} USD)`:"",o=e.hash.startsWith("FALLBACK")?'<div style="padding:8px 12px;background:#fff3cd;border:1px solid #f0ad4e;border-radius:4px;margin-bottom:12px">\u26A0 Hash is non-cryptographic (SubtleCrypto unavailable). Do NOT use for enforcement.</div>':"",i=window.open("","_blank","width=760,height=660");i.document.write(`<!DOCTYPE html><html><head>
    ...
    </body></html>`),i.document.close()}var ou=null;function Sv(){if(Li)return;Li=!0;let e=document.querySelector('[aria-label="Pattern detection"]');if(!e){e=document.createElement("section"),e.className="widget-card",e.setAttribute("aria-label","Pattern detection");let t=document.querySelector(".dashboard-col-main");if(!t)return;let n=t.querySelector(".dashboard-metrics");n?n.insertAdjacentElement("afterend",e):t.prepend(e)}e.innerHTML=`
    <div class="widget-header">
    ...
    </div>`,ou=document.getElementById("pattern-donut-canvas")}function Tv(e,t){if(!Li)return;let n=typeof Dt<"u"?Dt:{},s=Object.entries(e||{}).filter(([,m])=>m>0).sort(([,m],[,f])=>f-m);if(!s.length)return;let a=s.reduce((m,[,f])=>m+f,0)||1,[o,i]=s[0],r=Math.round(i/a*100),l=s[1],c=x("pattern-badge");c&&(c.textContent=o+" \xB7 "+r+"%");let d=x("pattern-dom-type");if(d&&(d.textContent=o,d.style.color=n[o]||"rgba(255,255,255,.9)"),V("pattern-dom-pct",r+"% of ledger"),l){let m=Math.round(l[1]/a*100),f=x("pattern-2nd-type");f&&(f.textContent=l[0]+" ("+m+"%)",f.style.color=n[l[0]]||"rgba(255,255,255,.7)")}else V("pattern-2nd-type","\u2014");let u=x("pattern-hhi");u&&t!=null&&(u.textContent=t.toFixed(3),u.style.color=t>=.35?"#ff5555":t>=.25?"#ffb86c":"#50fa7b");let p=x("pattern-donut-center");p&&(p.innerHTML='<span style="color:'+(n[o]||"#fff")+';font-size:1.15rem">'+r+"%</span>"),Cv(s,a,n)}function Cv(e,t,n){let s=ou||x("pattern-donut-canvas");if(!(s!=null&&s.getContext))return;let a=s.getContext("2d"),o=s.width/2,i=s.height/2,r=Math.min(s.width,s.height)/2-6,l=r*.56;a.clearRect(0,0,s.width,s.height);let c=e.slice(0,7),d=e.slice(7).reduce((m,[,f])=>m+f,0),u=d>0?[...c,["Other",d]]:[...c],p=-Math.PI/2;for(let[m,f]of u){let v=f/t*Math.PI*2,b=cs(n[m]||"#6b7280",.88)||"#6b7280";a.beginPath(),a.moveTo(o+Math.cos(p)*l,i+Math.sin(p)*l),a.arc(o,i,r,p,p+v),a.arc(o,i,l,p+v,p,!0),a.closePath(),a.fillStyle=b,a.fill(),a.strokeStyle="rgba(0,8,20,0.85)",a.lineWidth=2,a.stroke(),p+=v}a.beginPath(),a.arc(o,i,l-1,0,Math.PI*2),a.fillStyle="rgba(0,21,36,0.94)",a.fill()}function Pv(e,t){let n=!1;for(let s of e){if((s==null?void 0:s.type)!=="Payment")continue;let a=typeof(s==null?void 0:s.amountXrp)=="number"?s.amountXrp:null;a==null||a<Xn.whaleTxXrp||(Nt.unshift({ts:Date.now(),ledgerIndex:t,from:s.account||"\u2014",to:s.destination||"\u2014",amtXrp:a,hash:s.hash||""}),Je.whaleCount++,n=!0)}if(n){for(;Nt.length>rg;)Nt.pop();Mv()}}function Lv(){if(Tp)return;Tp=!0;let e=document.querySelector(".dashboard-col-side");if(!e)return;let t=document.createElement("section");t.className="widget-card",t.id="whale-feed-card",t.setAttribute("aria-label","Whale alert feed"),t.innerHTML=`
    <div class="widget-header">
    ...
    </div>`,e.prepend(t)}function Mv(){let e=x("whale-feed-list");if(!e)return;let t=x("whale-badge");if(t&&(t.textContent=Nt.length?`${Nt.length} alerts`:"Watching\u2026"),!Nt.length){e.innerHTML='<div style="opacity:.5;font-size:.82rem;padding:8px 0">No whale transactions yet.</div>';return}e.innerHTML=Nt.slice(0,20).map(n=>{let s=n.amtXrp>=1e6?`${(n.amtXrp/1e6).toFixed(2)}M`:n.amtXrp>=1e3?`${(n.amtXrp/1e3).toFixed(0)}K`:n.amtXrp.toFixed(0),a=Math.floor((Date.now()-n.ts)/1e3),o=a<60?`${a}s`:a<3600?`${Math.floor(a/60)}m`:`${Math.floor(a/3600)}h`;return`<div style="border-bottom:1px solid rgba(255,255,255,.05);padding:7px 0">
    ...
    </div>`}).join("")}function Av(){if(Cp)return;Cp=!0;let e=document.querySelector(".dashboard-col-main");if(!e)return;let t=document.createElement("section");t.className="widget-card",t.id="network-health-card",t.setAttribute("aria-label","Network health"),t.innerHTML=`
    <div class="widget-header">
    ...
    <div style="display:flex;align-items:center;gap:16px;padding:8px 0 12px">
      ...
      </div>`}).join(""))}function Nv(){if(Pp)return;Pp=!0;let e=document.querySelector(".dashboard-col-side");if(!e)return;let t=document.createElement("section");t.className="widget-card",t.id="session-stats-card",t.setAttribute("aria-label","Session stats"),t.innerHTML=`
    <div class="widget-header">
    ...
    </div>`,e.appendChild(t)}function _v(){if(!document.getElementById("session-stats-card"))return;let e=Math.floor((Date.now()-Je.startTime)/6e4);V("ss-ledgers",Je.ledgersProcessed.toLocaleString()),V("ss-tx",Je.totalTx.toLocaleString()),V("ss-whales",Je.whaleCount),V("ss-feespikes",Je.feeSpikes),V("ss-bots",Je.botDetections),V("ss-dexalerts",Je.dexAlerts),V("ss-time",`${e}m`),V("ss-badge",`${Je.ledgersProcessed} ledgers`)}function Rv(e,t){var o,i,r,l,c,d,u,p;if(Up=t,Nt.length&&Nt[0].ledgerIndex===t){let m=Nt[0],f=m.amtXrp>=1e6?`${(m.amtXrp/1e6).toFixed(1)}M`:`${(m.amtXrp/1e3).toFixed(0)}K`;ae(`\u{1F40B} Whale: ${f} XRP  ${j(m.from)} \u2192 ${j(m.to)}`)}let n=Jp(),s=(o=X.feeHistory)==null?void 0:o.at(-1);s&&n&&s>n*Xn.feeSpikeMultiple&&(Je.feeSpikes++,ge(`\u{1F525} Fee spike: ${un(s)} (${Math.round(s/n)}\xD7 baseline)`));let a=(((i=e.behavior)==null?void 0:i.bots)||[]).filter(m=>m.cv<Xn.botCvThreshold&&m.total>8);a.length&&(Je.botDetections=Math.max(Je.botDetections,a.length),a[0].botType==="Flood / Spam"&&ge(`\u{1F916} Spam bot: ${j(a[0].acct)} (CV ${a[0].cv.toFixed(2)})`)),((l=(r=e.dexPatterns)==null?void 0:r.window)==null?void 0:l.cancelRatio)>=Xn.dexCancelAlert&&((d=(c=e.dexPatterns)==null?void 0:c.window)==null?void 0:d.total)>=20&&(Je.dexAlerts++,ge(`\u{1F9E0} DEX: ${Math.round(e.dexPatterns.window.cancelRatio*100)}% cancel ratio \u2014 possible quote-stuffing`)),((p=(u=e.clusters)==null?void 0:u[0])==null?void 0:p.size)>=Xn.clusterMinSize&&ae(`\u{1F578} Cluster: ${e.clusters[0].size} wallets around ${j(e.clusters[0].hub)}`),e.friction>=75&&e.regime==="Manipulated"&&ge(`\u26A0\uFE0F Risk score: ${e.friction}/100 \u2014 ${e.regime} regime`),Ev(e.s)}function Dv(){var n,s,a,o;if(Lp)return;Lp=!0;let e=document.createElement("button");e.id="customize-btn",e.className="customize-btn",e.setAttribute("aria-pressed","false"),e.innerHTML="\u2699 Customize",(n=document.querySelector(".dashboard-header"))==null||n.appendChild(e);let t=document.createElement("div");t.id="customize-panel",t.className="customize-panel",t.setAttribute("aria-label","Dashboard customizer"),t.innerHTML=`
    ...
    </div>`,document.body.appendChild(t),e.addEventListener("click",()=>Ip()),(s=document.getElementById("customize-close"))==null||s.addEventListener("click",()=>Ip(!1)),(a=document.getElementById("customize-reset"))==null||a.addEventListener("click",()=>{try{localStorage.removeItem(qa),localStorage.removeItem(hs)}catch{}Fp(),Di(),Bi()}),(o=document.getElementById("customize-export"))==null||o.addEventListener("click",()=>{var i;try{let r={order:JSON.parse(localStorage.getItem(qa)||"[]"),hidden:JSON.parse(localStorage.getItem(hs)||"[]"),alertConfig:Xn};(i=navigator.clipboard)==null||i.writeText(JSON.stringify(r,null,2)),ae("Config copied to clipboard")}catch{ge("Export failed")}}),Fp(),Di()}function Ip(e){var s;let t=document.getElementById("customize-panel"),n=document.getElementById("customize-btn");!t||!n||(On=e??!On,t.classList.toggle("customize-panel--open",On),n.setAttribute("aria-pressed",String(On)),n.textContent=On?"\u2715 Close":"\u2699 Customize",On&&Bi(),(s=document.querySelector(".dashboard-col-side"))==null||s.classList.toggle("customize-mode",On))}function Vs(){var e;return[...((e=document.querySelector(".dashboard-col-side"))==null?void 0:e.querySelectorAll(":scope > .widget-card"))||[]]}function gs(e){return e.id||e.getAttribute("aria-label")||""}function Iv(e){var t,n;return((n=(t=e.querySelector(".widget-title"))==null?void 0:t.textContent)==null?void 0:n.trim())||gs(e)}function Fp(){let e=document.querySelector(".dashboard-col-side");if(!e)return;let t;try{t=JSON.parse(localStorage.getItem(qa)||"null")}catch{t=null}if(!Array.isArray(t)||!t.length)return;let n=new Map(Vs().map(s=>[gs(s),s]));t.forEach(s=>{let a=n.get(s);a&&e.appendChild(a)})}function Di(){let e;try{e=JSON.parse(localStorage.getItem(hs)||"[]")}catch{e=[]}Vs().forEach(t=>t.classList.toggle("widget-hidden",e.includes(gs(t))))}function Fv(){try{localStorage.setItem(qa,JSON.stringify(Vs().map(e=>gs(e))))}catch{}}function Ov(e){let t;try{t=JSON.parse(localStorage.getItem(hs)||"[]")}catch{t=[]}t=t.includes(e)?t.filter(n=>n!==e):[...t,e];try{localStorage.setItem(hs,JSON.stringify(t))}catch{}Di(),Bi()}function Bi(){let e=document.getElementById("customize-list");if(!e)return;let t;try{t=JSON.parse(localStorage.getItem(hs)||"[]")}catch{t=[]}e.innerHTML="",Vs().forEach(n=>{var r;let s=gs(n),a=Iv(n),o=!t.includes(s),i=document.createElement("div");i.className="customize-row",i.setAttribute("draggable","true"),i.dataset.widgetId=s,i.innerHTML=`
      <span class="customize-drag-handle" title="Drag to reorder">\u283F</span>
      <span class="customize-row-title">${y(a)}</span>
      <button class="customize-vis-btn ${o?"vis-on":"vis-off"}" data-id="${y(s)}">${o?"\u{1F441} Visible":"\u{1F6AB} Hidden"}</button>`,i.addEventListener("dragstart",l=>{as=i,l.dataTransfer.effectAllowed="move",i.classList.add("customize-dragging")}),i.addEventListener("dragend",()=>{i.classList.remove("customize-dragging"),e.querySelectorAll(".customize-row").forEach(d=>d.classList.remove("customize-over"));let l=[...e.querySelectorAll(".customize-row")].map(d=>d.dataset.widgetId),c=document.querySelector(".dashboard-col-side");if(c){let d=new Map(Vs().map(u=>[gs(u),u]));l.forEach(u=>{let p=d.get(u);p&&c.appendChild(p)})}Fv()}),i.addEventListener("dragover",l=>{if(l.preventDefault(),l.dataTransfer.dropEffect="move",as&&as!==i){e.querySelectorAll(".customize-row").forEach(d=>d.classList.remove("customize-over")),i.classList.add("customize-over");let c=[...e.querySelectorAll(".customize-row")];c.indexOf(as)<c.indexOf(i)?e.insertBefore(as,i.nextSibling):e.insertBefore(as,i)}}),i.addEventListener("dragleave",()=>i.classList.remove("customize-over")),i.addEventListener("drop",l=>l.preventDefault()),(r=i.querySelector(".customize-vis-btn"))==null||r.addEventListener("click",()=>Ov(s)),e.appendChild(i)})}function Xv(){if(Mp)return;Mp=!0;let e=document.querySelector(".dashboard-header");if(!e||document.getElementById("global-pause-btn"))return;let t=document.createElement("button");t.id="global-pause-btn",t.className="global-pause-btn",t.setAttribute("aria-pressed","false"),t.title="Pause all updates \u2014 numbers stop changing so you can read",t.innerHTML="\u23F8 Live",t.addEventListener("click",()=>{qt=!qt,t.setAttribute("aria-pressed",String(qt)),t.innerHTML=qt?"\u25B6 Paused":"\u23F8 Live",t.classList.toggle("global-pause-btn--paused",qt),Et=qt&&!Us?qt:Et;let s=document.querySelector(".dashboard-sticky-strip");s&&s.classList.toggle("metrics-paused",qt)});let n=document.getElementById("customize-btn");n?e.insertBefore(t,n):e.appendChild(t)}var Op=!1;function Bv(){if(Op)return;Op=!0;let e=(t=0)=>{let n=document.querySelector("#risk-card .widget-header"),s=document.querySelector("#landscape-card .widget-header");if(!n&&!s&&t<20){setTimeout(()=>e(t+1),300);return}if(n&&!n.querySelector(".friction-sparkline-wrap")){let a=document.createElement("div");a.className="friction-sparkline-wrap",a.title="Risk score \u2014 last 30 ledgers",a.innerHTML='<canvas id="friction-sparkline-canvas" width="80" height="22"></canvas>',n.appendChild(a)}if(s&&!s.querySelector(".friction-sparkline-wrap")){let a=document.createElement("div");a.className="friction-sparkline-wrap",a.title="Risk score history",a.innerHTML='<canvas id="friction-sparkline-canvas-2" width="60" height="18"></canvas>',s.appendChild(a)}iu()};e()}function iu(){ls.length&&(Xp("friction-sparkline-canvas",80,22),Xp("friction-sparkline-canvas-2",60,18))}function Xp(e,t,n){let s=document.getElementById(e);if(!(s!=null&&s.getContext))return;let a=s.getContext("2d");a.clearRect(0,0,t,n);let o=ls;if(o.length<2)return;let i=100,r=t/(o.length-1),l=o.map((v,b)=>[b*r,n-2-v.friction/i*(n-4)]),c=n-2-60/i*(n-4);a.fillStyle="rgba(255,85,85,.07)",a.fillRect(0,0,t,c);let d=a.createLinearGradient(0,0,0,n);d.addColorStop(0,"rgba(255,184,108,.35)"),d.addColorStop(1,"rgba(255,184,108,.05)"),a.beginPath(),l.forEach(([v,b],h)=>h===0?a.moveTo(v,b):a.lineTo(v,b)),a.lineTo(l.at(-1)[0],n),a.lineTo(0,n),a.closePath(),a.fillStyle=d,a.fill();let u=o.at(-1).friction,p=u<26?"#50fa7b":u<61?"#ffb86c":"#ff5555";a.beginPath(),l.forEach(([v,b],h)=>h===0?a.moveTo(v,b):a.lineTo(v,b)),a.strokeStyle=p,a.lineWidth=1.5,a.lineJoin="round",a.stroke();let[m,f]=l.at(-1);a.beginPath(),a.arc(m,f,2.5,0,Math.PI*2),a.fillStyle=p,a.fill()}window.printLandscapeReport=function(){var i,r,l,c;if(!document.getElementById("landscape-card"))return;let t=((i=document.getElementById("d2-ledger-index"))==null?void 0:i.textContent)||"\u2014",n=((r=document.getElementById("landscape-badge"))==null?void 0:r.textContent)||"",s=new Date().toLocaleString(),a=window.open("","_blank","width=860,height=700");a.document.write(`<!DOCTYPE html><html><head>
  ...
  `;t.innerHTML=s+o+a+v}function Rb(e){var o;let t=document.getElementById("inspect-volconc-body");if(!t)return;let n={critical:"sev-critical",warn:"sev-warn",info:"sev-info",ok:"sev-ok"},s=e.signals.map(i=>`
    ...
    </div>`).join("");s.innerHTML=o+(n||"")}function Db(e){let t=[["Sample size",e.sampleSize],["Amount entropy",e.amountEntropy!=null?e.amountEntropy.toFixed(2)+" bits":"\u2014",e.amountEntropy!=null&&e.amountEntropy<2?"risk-text-high":""],["Counterparty entropy",e.counterpartyEntropy!=null?e.counterpartyEntropy.toFixed(2)+" bits":"\u2014"],["Time-of-day entropy",e.timeEntropy!=null?e.timeEntropy.toFixed(2)+" bits":"\u2014"],["Unique counterparties",e.uniqueCounterparties],["Verdict",e.verdict,e.verdict==="anomalous"?"risk-text-high":e.verdict==="elevated"?"risk-text-med":""]];eo("inspect-entropy-body",e,'<div class="wash-stat-row" style="margin-top:10px"><span>Metric</span><span class="mono" style="opacity:.45">Value</span></div>'+t.map(([n,s,a])=>`<div class="wash-stat-row"><span>${n}</span><span class="mono ${a||""}">${s}</span></div>`).join(""))}function Ib(e){var s;let t=[["Unique counterparties",e.uniqueCounterparties],["Zipf exponent (s)",e.zipfExponent!=null?e.zipfExponent.toFixed(3):"\u2014",e.zipfExponent!=null&&(e.zipfExponent<.4||e.zipfExponent>2.2)?"risk-text-high":""],["Fit quality (R\xB2)",e.rSquared!=null?e.rSquared.toFixed(3):"\u2014",e.rSquared!=null&&e.rSquared<.55?"risk-text-high":""],["Natural range","s \u2248 0.8\u20131.3, R\xB2 > 0.55"],["Verdict",e.verdict,e.verdict==="anomalous"?"risk-text-high":e.verdict==="elevated"?"risk-text-med":""]],n=((s=e.freqTable)==null?void 0:s.slice(0,10).map((a,o)=>{let i=e.freqTable[0]||1,r=(a/i*100).toFixed(0),l=e.freqTable[0]?(e.freqTable[0]/Math.pow(o+1,e.zipfExponent||1)).toFixed(1):0;return`<div class="wash-stat-row">
    ...
    </div>`).join("")}function Hb(e,t,n,s,a){let o=x("inspect-security-body");if(!o)return;let i=Object.entries(qe).filter(([,r])=>n&r).map(([r])=>r.replace("lsf",""));o.innerHTML=`
  ...
  `,to("badge-security",e.findings)}function zb(e,t,n,s){let a=x("inspect-drain-body");if(!a)return;let o={low:"#50fa7b",medium:"#ffb86c",high:"#ff8c42",critical:"#ff5555"},i={low:"\u2713",medium:"\u26A0",high:"\u26A0",critical:"\u26D4"};a.innerHTML=`
    ...
    <div class="drain-sub-section">
      ...
      ${t.map(r=>`
        <div class="drain-channel-row">
          <span class="mono">${j(r.Destination)}</span>
    ...
    <div class="drain-sub-section">
      ...
      ${n.slice(0,5).map(r=>`
        <div class="drain-channel-row">
          <span>${r.Destination?j(r.Destination):"self"}</span>
          <span>${R(Number(r.Amount||0)/1e6,2)} XRP</span>
          <span class="mono">${r.Condition?"conditional":r.FinishAfter?"time-locked":""}</span>
        </div>`).join("")}
    </div>`:""}
  `,gy("badge-drain",e.riskLevel)}function jb(e,t){let n=x("inspect-nft-body");n&&(n.innerHTML=`
    <div class="audit-items">
      ${e.flags.map(s=>Hn(s)).join("")}
    </div>
    ${t.length?`
    <div class="nft-grid">
      ${t.slice(0,12).map(s=>Wb(s)).join("")}
    </div>
    ${t.length>12?`<div class="nft-more">+${t.length-12} more NFTs</div>`:""}
    `:""}
  `,to("badge-nft",e.flags))}function Wb(e){let t=Number(e.Flags||0),n=!!(t&ru.lsfTransferable),s=!!(t&ru.lsfBurnable),a=e.NFTokenTaxon||0,o=e.TransferFee?`${(e.TransferFee/1e3).toFixed(1)}%`:"0%";return`
    <div class="nft-card">
    ...
    </div>`}function Ub(e){let t=x("inspect-wash-body");if(!t)return;let n=e.verdict==="clean"||e.verdict==="low-risk"?"#50fa7b":e.verdict==="suspicious"?"#ffb86c":"#ff5555";t.innerHTML=`
  ...
  `;let s=x("badge-wash");if(s){let a=e.verdict==="clean"||e.verdict==="low-risk"?"ok":e.verdict==="suspicious"?"warn":"crit";s.textContent=e.verdict.replace("-"," "),s.className="section-badge section-badge--"+a}}function Ks(e,t){return`<div class="wash-stat"><span class="wash-stat-label">${y(e)}</span><span class="wash-stat-val">${t}</span></div>`}function qb(e,t){let n=x("inspect-issuer-body");if(!n)return;let s=t.filter(a=>a.currency&&(a.currency.length===3||a.currency.length===40));n.innerHTML=`
    <div class="audit-items">
      ${e.signals.map(a=>Hn(a)).join("")}
    </div>
    ${s.length?`
  ...
  `,to("badge-issuer",e.signals)}function Vb(e,t){let n=x("inspect-amm-body");n&&(n.innerHTML=`
    <div class="audit-items">
  ...
  `,to("badge-amm",e.signals))}function Gb(e){let t=x("trust-count-badge");t&&(t.textContent=e.length);let n=x("inspect-trust-body");n&&(n.innerHTML=e.length?e.map(s=>{let a=s.freeze?'<span class="trustline-frozen">Frozen</span>':"",o=s.freeze_peer?'<span class="trustline-frozen trustline-frozen--peer">Issuer Frozen</span>':"",i=s.no_ripple?'<span class="trustline-norip">NoRipple</span>':"";return`
          <div class="trustline-row">
          ...
          </div>`}).join(""):'<div class="inspect-empty-note">No transactions found.</div>',e.length>s&&(n.innerHTML+=`<div class="tx-more">Showing ${s} of ${e.length} transactions</div>`)}function yu(e,t,n){let s=Number((n==null?void 0:n.totalIn)||0),a=Number((t==null?void 0:t.totalOut)||0),o=Number(e||0);if(s<=0&&a<=0)return'<div class="inspect-empty-note">No inbound or outbound XRP flow found in the analysed transaction history.</div>';let i=new Set(((t==null?void 0:t.blackHoleDests)||[]).map(k=>k.addr)),r=new Set(((t==null?void 0:t.exchangeDests)||[]).map(k=>k.addr)),l=new Set(((t==null?void 0:t.newWalletDests)||[]).map(k=>k.addr)),c=0,d=0,u=0,p=0;for(let k of(t==null?void 0:t.destinations)||[])i.has(k.addr)?c+=k.totalXrp:r.has(k.addr)?d+=k.totalXrp:l.has(k.addr)?u+=k.totalXrp:p+=k.totalXrp;let m=Math.max(s,a,o,1),f=k=>(k>0?Math.max(1.5,k/m*100):0).toFixed(1),v=[{label:"Black hole",xrp:c,color:vn.blackhole},{label:"Exchange",xrp:d,color:vn.exchange},{label:"New wallet",xrp:u,color:vn.newWallet},{label:"Other",xrp:p,color:vn.other}].filter(k=>k.xrp>0),b=a>0?Math.max(1.5,a/m*100):0,h=v.map(k=>`<div style="width:${(a>0?k.xrp/a*100:0).toFixed(1)}%;background:${k.color};height:100%" title="${y(k.label)}: ${R(k.xrp,2)} XRP"></div>`).join(""),g=(k,$,T,S,P)=>`
    <div style="display:flex;align-items:center;gap:10px;margin-bottom:8px">
      ...
      <div style="flex:1;height:16px;border-radius:5px;overflow:hidden;background:rgba(255,255,255,.05)">
        <div style="width:${T}%;height:100%;display:flex">${S||`<div style="width:100%;height:100%;background:${P}"></div>`}</div>
      </div>
          ...
          <div class="flow-dest-row">
            ...
            <div class="flow-dest-info">
              ...
              <div class="flow-dest-meta">
                ...
                ${c.txCount>1?`<span class="flow-dest-span">${wu(c.firstSeen,c.lastSeen)}</span>`:""}
              </div>
            </div>
          </div>`}).join("")}
    </div>
    ...
    <div class="flow-timeline">
      ${e.timeline.map(c=>{let d=new Date(c.ts*1e3).toLocaleDateString(),u=new Date(c.ts*1e3).toLocaleTimeString([],{hour:"2-digit",minute:"2-digit"}),p=c.amtXrp>0?`${R(c.amtXrp,2)} XRP`:c.amtToken?`${R(c.amtToken.value,2)} ${c.amtToken.currency}`:"\u2014",m=ys(c.dest),f=m?`<span class="flow-entity-badge flow-entity--${m.type}" style="font-size:.65rem">${y(m.name)}</span>`:"";return`
  ...
  `,a){let c=e.blackHoleDests.length||e.exchangeDests.length>2;a.textContent=`${e.uniqueDests} dests`,a.className=`section-badge section-badge--${c?"crit":e.uniqueDests>0?"warn":"ok"}`}}function wu(e,t){if(!e||!t)return"";let n=new Date(e*1e3).toLocaleDateString(),s=new Date(t*1e3).toLocaleDateString();return n===s?n:`${n} \u2013 ${s}`}function Yb(e,t){let n=x("inspect-issuer-connections-body");if(!n)return;let s=e.totalIssued,a=x("badge-issuer-connections");if(n.innerHTML=`
    <div class="audit-items">
  ...
  `,a){let o=e.signals.some(i=>i.sev==="critical")?"crit":e.signals.some(i=>i.sev==="warn")?"warn":e.signals.some(i=>i.sev==="info")?"neutral":"ok";a.className=`section-badge section-badge--${o}`,a.textContent=s>0?`${e.holderCount} holders`:"No issuance"}}function Qb(e){var d;let t=document.getElementById("inspect-fee-analysis-body");if(!t||!e)return;let n={critical:"sev-critical",warn:"sev-warn",info:"sev-info",ok:"sev-ok"},s=(e.signals||[]).map(u=>`
    ...
    </div>`;t.innerHTML=l+s+a+o;let c=document.getElementById("badge-fee-analysis");c&&(c.textContent=r?"Elevated":"Normal",c.className=`section-badge section-badge--${r?"warn":"ok"}`)}function Zb(e){var d,u;let t=document.getElementById("inspect-desttag-body");if(!t||!e)return;let n={critical:"sev-critical",warn:"sev-warn",info:"sev-info",ok:"sev-ok"},s=(e.signals||[]).map(p=>`
    ...
    ${e.selfRoutedCount?`<div class="wash-stat-row"><span>Self-routed payments</span><span class="mono risk-text-high">${e.selfRoutedCount}</span></div>`:""}`;if(n.innerHTML=o+i,s){let l=e.signals.some(d=>d.sev==="critical"),c=e.signals.some(d=>d.sev==="warn");s.textContent=l?"Critical":c?"Check":"Normal",s.className=`section-badge section-badge--${l?"crit":c?"warn":"ok"}`}}function ty(e){var r,l,c;let t=x("inspect-inbound-body");if(!t)return;let n={critical:"sev-critical",warn:"sev-warn",info:"sev-info",ok:"sev-ok"},s=(e.signals||[]).map(d=>`
    ...
    ${e.wallShare>.3?`<div class="wash-stat-row"><span>Largest single order share</span><span class="mono ${e.wallShare>.4?"risk-text-high":"risk-text-med"}">${(e.wallShare*100).toFixed(1)}%</span></div>`:""}`;n.innerHTML=a+o;let i=x("badge-livebook");if(i){let r=(e.signals||[]).some(c=>c.sev==="critical"),l=(e.signals||[]).some(c=>c.sev==="warn");i.textContent=r?"Wall order":l?"Check":"Normal",i.className=`section-badge section-badge--${r?"crit":l?"warn":"ok"}`}}function iy(e,...t){let n=x("inspect-risk-breakdown");if(!n)return;let s=Eb(e,...t);if(!s.length){n.innerHTML="";return}let a=Math.max(1,s.reduce((o,i)=>o+i.pts,0));n.innerHTML=`
    ...
    </div>`}function Hn({sev:e,label:t,detail:n}){return`
    <div class="audit-row audit-row--${e}">
      <span class="audit-icon">${{ok:"\u2713",info:"\u2139",warn:"\u26A0",critical:"\u26D4"}[e]||"\u2139"}</span>
      <div class="audit-text">
        <div class="audit-label">${y(t)}</div>
        ${n?`<div class="audit-detail">${y(n)}</div>`:""}
      </div>
    </div>`}function ji(e){return e<20?"risk-ok":e<45?"risk-medium":e<70?"risk-high":"risk-critical"}function ry(e,t,n){if(Wv.has(e.TransactionType))return"warn";if(e.TransactionType==="NFTokenCreateOffer"){let s=e.Amount;if(!s||typeof s=="string"&&Number(s)<1e6)return"critical"}return t!=null&&t.TransactionResult&&t.TransactionResult!=="tesSUCCESS"?"fail":"normal"}function ly(e,t){var s,a,o,i,r;let n=e.TransactionType;if(n==="Payment"){let l=e.Account===t?`\u2192 ${j(e.Destination)}`:`\u2190 ${j(e.Account)}`,c=typeof e.Amount=="string"?`${R(Number(e.Amount)/1e6,2)} XRP`:(s=e.Amount)!=null&&s.value?`${R(Number(e.Amount.value),2)} ${e.Amount.currency}`:"";return y(`${c} ${l}`)}if(n==="OfferCreate"){let l=typeof e.TakerPays=="string"?`${R(Number(e.TakerPays)/1e6,2)} XRP`:`${R(Number((a=e.TakerPays)==null?void 0:a.value),2)} ${(o=e.TakerPays)==null?void 0:o.currency}`,c=typeof e.TakerGets=="string"?`${R(Number(e.TakerGets)/1e6,2)} XRP`:`${R(Number((i=e.TakerGets)==null?void 0:i.value),2)} ${(r=e.TakerGets)==null?void 0:r.currency}`;return y(`${l} for ${c}`)}return n==="SetRegularKey"?y(`Key: ${e.RegularKey?j(e.RegularKey):"REMOVED"}`):n==="NFTokenMint"?y(`Taxon: ${e.NFTokenTaxon??"\u2014"}`):n==="NFTokenBurn"?y(`Token: ${e.NFTokenID?j(e.NFTokenID):"\u2014"}`):n==="AMMDeposit"?y("Pool deposit"):n==="AMMWithdraw"?y("LP withdrawal"):n==="EscrowCreate"?y(`${R(Number(e.Amount||0)/1e6,2)} XRP \u2192 ${j(e.Destination)}`):""}function cy(e){return{Payment:"payment",OfferCreate:"offer",OfferCancel:"offer",NFTokenMint:"nft",NFTokenBurn:"nft",NFTokenCreateOffer:"nft",NFTokenAcceptOffer:"nft",SetRegularKey:"auth",SignerListSet:"auth",AccountSet:"auth",AccountDelete:"auth",TrustSet:"trust",AMMCreate:"amm",AMMDeposit:"amm",AMMWithdraw:"amm",AMMVote:"amm",AMMBid:"amm",EscrowCreate:"escrow",EscrowFinish:"escrow",EscrowCancel:"escrow",PaymentChannelCreate:"channel",PaymentChannelFund:"channel",PaymentChannelClaim:"channel"}[e]||"other"}function yn(e){let t=(e==null?void 0:e.date)||(e==null?void 0:e.close_time)||(e==null?void 0:e.ledger_close_time);return t?Number(t)+pu:0}function Bn(e){if(!e||e.length!==40)return e||"";try{let t="";for(let n=0;n<e.length;n+=2){let s=parseInt(e.slice(n,n+2),16);if(s!==0){if(s<32||s>126)return e;t+=String.fromCharCode(s)}}return t||e}catch{return e}}function dy(e,t,n,s,a,o,i,r,l,c,d,u,p,m,f,v,b,h,g,w={}){var K,ue,be,Xe,ut,en,ca,hr,gr,vr,br,yr,wr;let{feeAnalysis:k=null,destTagAnalysis:$=null,pathDepthAnalysis:T=null,gatewayBalances:S=null,inboundFlowAnalysis:P=null,memoAnalysis:M=null,escrowDepthAnalysis:N=null,checkAnalysis:_=null,liveBookAnalysis:O=null,walletAgeDays:I=null,walletCreatedTs:D=null}=w,F=946684800,H=new Date().toLocaleString(),A=e.slice(0,10)+"\u2026"+e.slice(-8),z=s<20?"LOW":s<45?"MODERATE":s<70?"HIGH":"CRITICAL",te=s<20?"#50fa7b":s<45?"#ffb86c":s<70?"#ff8c42":"#ff5555",oe=f.filter(({tx:E})=>E.date!=null),pe=f.length.toLocaleString()+" transactions",ie="",ne=0;if(oe.length>=2){let E=oe[0].tx.date+F,Pe=oe[oe.length-1].tx.date+F;ne=Math.round((Pe-E)/86400);let tn=new Date(E*1e3).toLocaleDateString("en-US",{year:"numeric",month:"short",day:"numeric"}),ot=new Date(Pe*1e3).toLocaleDateString("en-US",{year:"numeric",month:"short",day:"numeric"});ie=`${tn} \u2013 ${ot} (${ne} days)`,pe=`${f.length.toLocaleString()} transactions from ${ie}`}let ce=[],G=(E,Pe,tn,ot,qn,mt={})=>ce.push({module:E,sev:Pe,headline:tn,detail:ot||"",hashes:qn||[],category:mt.category??null,confidence:mt.confidence??null,observed:mt.observed??[],alternativeExplanations:mt.alternativeExplanations??[],evidenceAgainstBenign:mt.evidenceAgainstBenign??[],classification:mt.classification??null});for(let E of a.findings||[])G("Security",E.sev,E.label,E.detail);G("Drain Risk",o.riskLevel==="low"?"ok":o.riskLevel==="medium"?"warn":"critical","Drain Risk Level: "+o.riskLevel.toUpperCase(),null);for(let E of o.signals||[])E.sev!=="ok"&&G("Drain Risk",E.sev,E.label,E.detail,E.hashes);for(let E of i.flags||[])E.sev!=="ok"&&G("NFT",E.sev,E.label,E.detail,E.hashes);r.verdict&&!["clean","low-risk"].includes(r.verdict)&&G("Wash Trading",r.score>=60?"critical":"warn",`Wash score ${r.score}/100 \u2014 ${r.verdict.replace("-"," ")}`,null);for(let E of r.signals||[])E.sev!=="ok"&&G("Wash Trading",E.sev,E.label,E.detail);for(let E of l.signals||[])E.sev!=="ok"&&G("Benford's Law",E.sev,E.label,E.detail);for(let E of c.signals||[])E.sev!=="ok"&&G("Volume Concentration",E.sev,E.label,E.detail);for(let E of(v==null?void 0:v.signals)||[])E.sev!=="ok"&&G("Shannon's Entropy",E.sev,E.label,E.detail);for(let E of(b==null?void 0:b.signals)||[])E.sev!=="ok"&&G("Zipf's Law",E.sev,E.label,E.detail);for(let E of(h==null?void 0:h.signals)||[])E.sev!=="ok"&&G("Time Series",E.sev,E.label,E.detail);for(let E of(g==null?void 0:g.signals)||[])E.sev!=="ok"&&G("Granger Causality",E.sev,E.label,E.detail);for(let E of d.signals||[])E.sev!=="ok"&&G("Token Issuer",E.sev,E.label,E.detail);for(let E of u.signals||[])E.sev!=="ok"&&G("AMM",E.sev,E.label,E.detail);(K=p.blackHoleDests)!=null&&K.length&&G("Fund Flow","critical",`Funds sent to ${p.blackHoleDests.length} black hole address(es)`,"These funds are permanently irrecoverable."),(ue=p.exchangeDests)!=null&&ue.length&&G("Fund Flow","warn",`${p.exchangeDests.length} known exchange(s) received funds`,p.exchangeDests.map(E=>E.entity.name).join(", ")),(be=p.newWalletDests)!=null&&be.length&&G("Fund Flow","critical",`${p.newWalletDests.length} brand-new wallet(s) received large XRP transfers`,"New wallets (Sequence < 10) receiving large amounts are a classic drain-mule pattern.");for(let E of m.signals||[])E.sev!=="ok"&&G("Issuer Connections",E.sev,E.label,E.detail);for(let E of(k==null?void 0:k.signals)||[])E.sev!=="ok"&&G("Fee Spikes",E.sev,E.label,E.detail,E.hashes);for(let E of($==null?void 0:$.signals)||[])E.sev!=="ok"&&G("Destination Tags",E.sev,E.label,E.detail);for(let E of(T==null?void 0:T.signals)||[])E.sev!=="ok"&&G("Path Payments",E.sev,E.label,E.detail,E.hashes);for(let E of(P==null?void 0:P.signals)||[])E.sev!=="ok"&&G("Inbound Flow",E.sev,E.label,E.detail);for(let E of(M==null?void 0:M.signals)||[])E.sev!=="ok"&&G("Memo Analysis",E.sev,E.label,E.detail);for(let E of(N==null?void 0:N.signals)||[])E.sev!=="ok"&&G("Escrow Depth",E.sev,E.label,E.detail);for(let E of(O==null?void 0:O.signals)||[])E.sev!=="ok"&&G("Live Order Book",E.sev,E.label,E.detail);let Se=ce.filter(E=>E.sev==="critical"),B=ce.filter(E=>E.sev==="warn");window._lastAllFindings=ce;let q=E=>{let Pe={critical:"background:rgba(255,85,85,.15);border:1px solid rgba(255,85,85,.35);color:#ff5555",warn:"background:rgba(255,184,108,.10);border:1px solid rgba(255,184,108,.30);color:#ffb86c",info:"background:rgba(120,180,255,.08);border:1px solid rgba(120,180,255,.18);color:rgba(120,180,255,.9)",ok:"background:rgba(80,250,123,.08);border:1px solid rgba(80,250,123,.22);color:#50fa7b"};return`<span style="padding:2px 8px;border-radius:999px;font-size:.68rem;font-weight:900;letter-spacing:.3px;text-transform:uppercase;${Pe[E]||Pe.info}">${E.toUpperCase()}</span>`};function se(){var ot,qn,mt,$n,xr,kr,$r,Sr,Tr,Cr,Pr,Lr;let E=[];E.push(`<strong>Address ${A}</strong> was inspected on ${H}. The account holds <strong>${R(n,4)} XRP</strong>. This report analyzed <strong>${pe}</strong>, plus all open on-chain objects (escrows, payment channels, trustlines, NFTs, AMM positions). The overall risk score is <strong style="color:${te}">${s}/100 \u2014 ${z}</strong>. <em style="opacity:.7">Risk scores reflect statistical patterns \u2014 not legal proof. A high score means unusual patterns were detected. Always verify before drawing conclusions.</em>`),Se.length&&E.push(`\u26A0\uFE0F The scan found <strong>${Se.length} critical issue${Se.length>1?"s":""}</strong> and <strong>${B.length} warning${B.length!==1?"s":""}</strong> \u2014 explained in plain English below.`);{let Le=o.riskLevel==="critical"||o.riskLevel==="high",ft=((ot=p.newWalletDests)==null?void 0:ot.length)>0,da=((qn=p.blackHoleDests)==null?void 0:qn.length)>0,pa=r.score>=60,fo=(k==null?void 0:k.verdict)==="elevated",ho=[l.verdict==="high-deviation",(v==null?void 0:v.verdict)==="anomalous",(b==null?void 0:b.verdict)==="anomalous"||(b==null?void 0:b.verdict)==="elevated",(h==null?void 0:h.verdict)==="bot-pattern",(g==null?void 0:g.verdict)==="causal-signal"].filter(Boolean).length>=2,Sn=null;if(Le&&ft)Sn="The key change and the transfers to freshly-created wallets aren't separate concerns \u2014 together they're the specific sequence a drain follows: take control of signing, then move funds somewhere that isn't the attacker's known address.";else if(Le&&da)Sn="A compromised-looking key change followed by funds reaching an address nobody controls is consistent with a drain where the funds are gone rather than just moved.";else if(pa&&fo)Sn="The order-cancellation pattern and the fee spikes reinforce each other: overpaying fees to guarantee same-ledger execution is how the cancel-before-fill pattern gets coordinated with a counterparty.";else if(pa&&ho)Sn="This isn't just one statistical test disagreeing with the others \u2014 the wash-trading signal from actual order behavior and the independent mathematical tests are pointing at the same conclusion from two different directions.";else if(Se.length+B.length>=3){let go=[...new Set(Se.concat(B).map(cm=>cm.module))];Sn=`${go.length} different analysis categories flagged this account (${go.slice(0,4).join(", ")}${go.length>4?", \u2026":""}) \u2014 any one alone could be circumstantial, but that many independent methods agreeing is the stronger signal here.`}Sn&&E.push(`<strong>\u{1F9E9} How these findings fit together:</strong> ${Sn}`)}if(o.riskLevel==="critical"?E.push(`<span style="color:#ff5555"><strong>\u{1F6A8} WALLET DRAIN RISK \u2014 CRITICAL</strong></span><br><strong>What was found:</strong> The account's security structure matches a known attack pattern \u2014 the master signing key has been disabled and replaced with a different key.<br><strong>What it means in plain English:</strong> If you did not personally do this, your wallet may have been taken over. An attacker who controls the replacement key can drain every XRP and token from the account.<br><strong>What to do right now:</strong> Stop sending any funds to this address. If it's your wallet, contact a security professional immediately.`):o.riskLevel==="high"&&E.push("<strong>\u26A0\uFE0F Elevated Drain Risk:</strong> Unusual security patterns found \u2014 possibly a key change followed by large outflows. See the Drain Risk section for exact transactions."),(mt=p.newWalletDests)!=null&&mt.length&&E.push(`<strong>\u{1F195} Brand-New Receiving Wallets:</strong> ${p.newWalletDests.length} of the top destinations are freshly-created wallets (fewer than 10 lifetime transactions) that received significant XRP. Creating a new disposable wallet to receive drained funds \u2014 then disappearing \u2014 is the most common drain attack pattern on XRPL.`),($n=p.blackHoleDests)!=null&&$n.length&&E.push('<span style="color:#ff5555"><strong>\u{1F573} Funds Sent to Uncontrolled Address:</strong></span> Some XRP reached a "black hole" \u2014 an address nobody controls. <strong>These funds cannot be recovered by anyone.</strong>'),(xr=p.exchangeDests)!=null&&xr.length){let Le=[...new Set(p.exchangeDests.map(ft=>ft.entity.name))].join(", ");E.push(`<strong>\u{1F4B1} Exchange Activity:</strong> Funds reached known exchange(s): <strong>${Le}</strong>. Total outflow tracked: ${R(p.totalOut,2)} XRP to ${p.uniqueDests} destination(s). This is often normal \u2014 people cash out to exchanges. It becomes a concern when combined with the security or timing signals above.`)}else p.totalOut>0&&E.push(`<strong>Outbound payments:</strong> ${R(p.totalOut,2)} XRP sent to ${p.uniqueDests} destination(s). None matched known exchange addresses.`);if(r.score>=60){let Le=r.stats,ft=Le.creates>0?(Le.cancels/Le.creates*100).toFixed(0):0;E.push(`<strong>\u{1F4CA} Wash Trading Signals (Score: ${r.score}/100 \u2014 ${r.verdict.replace("-"," ").toUpperCase()}):</strong><br><strong>What was found:</strong> Out of ${Le.creates} DEX offers placed, ${Le.cancels} (${ft}%) were cancelled before filling. Only ${Le.fills} actually filled.`+(Le.selfTrades>0?` ${Le.selfTrades} payment(s) were sent from and back to the same address.`:"")+"<br><strong>What it means:</strong> Placing orders and cancelling them before they fill inflates a token's visible trading activity without any real buying or selling. It makes a thin market look active to attract other traders.<br><strong>Caveat:</strong> Legitimate market makers do cancel many orders as prices move. This finding is strongest when combined with the self-trade and fee-spike signals.")}else r.score>=30?E.push(`<strong>Moderate trading signals</strong> (score ${r.score}/100): Some DEX patterns look unusual but not conclusive alone. See Wash Trading section for specifics.`):E.push(`<strong>\u2705 DEX activity looks normal</strong> (wash score ${r.score}/100). Cancel ratios, fill rates, and trade sizes are within organic ranges.`);(T==null?void 0:T.selfRoutedCount)>0&&E.push(`<strong>\u{1F504} Self-Routing Path Payments:</strong> ${T.selfRoutedCount} payment(s) where the sender and destination are the same address. Routing XRP through the DEX back to yourself creates trading volume on every intermediate pair with no net economic transfer \u2014 a DEX-specific wash trading technique that's harder to detect than simple self-trades.`),(T==null?void 0:T.roundTripCount)>=3&&E.push(`<strong>XRP\u2192IOU\u2192XRP round-trips:</strong> ${T.roundTripCount} path payments paid and received XRP through intermediate token pairs \u2014 generating DEX volume without changing economic position.`),(k==null?void 0:k.verdict)==="elevated"&&E.push(`<strong>\u{1F4B8} Fee Spike Pattern:</strong> ${k.spikeCount} transaction(s) paid more than 100\xD7 the normal fee. Bots often overpay fees to guarantee same-ledger execution alongside a counterparty \u2014 a coordination technique used in wash trading and front-running. Organic users almost never need fees this high.`);let Pe=[l.verdict==="high-deviation",(v==null?void 0:v.verdict)==="anomalous",(b==null?void 0:b.verdict)==="anomalous"||(b==null?void 0:b.verdict)==="elevated",(h==null?void 0:h.verdict)==="bot-pattern",(g==null?void 0:g.verdict)==="causal-signal"].filter(Boolean).length;if(Pe>=3?E.push(`<strong>\u{1F52C} Statistical Analysis \u2014 Multiple Engines Agree:</strong><br>${Pe} out of 5 independent mathematical tests found patterns inconsistent with human organic activity. These tests each use different mathematical approaches (number patterns, information theory, power laws, timing, causality) so they can't all be false alarms from the same data artifact.<br><strong>What it means:</strong> When unrelated statistical methods all flag the same account, the probability that all findings are coincidental false positives drops dramatically. This strongly suggests automated or coordinated activity, though it's not proof of fraud.`):Pe>=2?E.push(`<strong>Statistical analysis:</strong> ${Pe}/5 tests flagged unusual patterns. Multiple independent tests agreeing is a meaningful signal \u2014 see the Forensic Suite section.`):Pe===1?E.push("<strong>Statistical analysis:</strong> 1/5 tests flagged an unusual pattern. A single flag is a hypothesis to investigate further, not a conclusion."):f.length>=30&&E.push(`<strong>\u2705 All statistical tests normal:</strong> Benford's Law, entropy, Zipf's Law, time series, and Granger causality all returned results consistent with organic activity across ${f.length} transactions.`),l.verdict==="high-deviation"&&l.chiSq!=null&&E.push(`<strong>Benford's Law detail (\u03C7\xB2=${l.chiSq.toFixed(1)}):</strong> In real financial data, "1" appears as the first digit ~30% of the time and "9" only ~4.6%. Computer-generated amounts break this pattern. This wallet's amounts deviate significantly (\u03C7\xB2=${l.chiSq.toFixed(1)} exceeds the 99% confidence threshold of 20.09).`),m.totalIssued>0){let Le=(kr=m.topHolders)==null?void 0:kr[0],ft=Le?(Le.balance/m.totalIssued*100).toFixed(0):null,da=($r=S==null?void 0:S.result)!=null&&$r.obligations?Object.values(S.result.obligations).reduce((fo,ho)=>fo+Number(ho),0):null,pa=da?` (verified via gateway_balances: ${R(da,0)} total obligations)`:"";E.push(`<strong>\u{1FA99} Token Issuance:</strong> This account has issued tokens \u2014 <strong>${R(m.totalIssued,0)} outstanding</strong> across ${m.holderCount} holder(s)${pa}. `+(ft?`The largest single holder controls <strong>${ft}% of supply</strong>. `:"")+(ft&&Number(ft)>50?"Holding more than half the supply means one wallet could dump and collapse the token price. ":"")+((Sr=m.mirrorGroups)!=null&&Sr.length?`<strong>${m.mirrorGroups.length} cluster(s)</strong> of wallets each received identical token amounts \u2014 possible coordinated/insider wallets. `:"")+((Tr=m.createdAccts)!=null&&Tr.length?`This issuer also created ${m.createdAccts.length} wallet(s) \u2014 they may be controlled by the same entity. `:""))}let tn=(i.flags||[]).filter(Le=>Le.sev==="critical");if(tn.length&&E.push(`<strong>\u{1F3A8} NFT Risk:</strong> ${tn.length} critical NFT issue(s) \u2014 most commonly a zero-price sell offer. The most common XRPL NFT scam: a malicious dApp tricks the wallet owner into signing a transaction that creates a sell offer for 0 XRP, making the NFT free for anyone to take.`),P!=null&&P.structuredFlag)E.push(`<strong>\u{1F4E5} Structured Inbound Pattern:</strong> ${P.uniqueSources} source(s) funded this wallet \u2014 many payments arrive at near-identical amounts. Structured deposits deliberately break large transfers into smaller equal amounts to reduce traceability.`);else if((Cr=P==null?void 0:P.exchangeSrcs)!=null&&Cr.length){let Le=[...new Set(P.exchangeSrcs.map(ft=>ft.entity.name))].join(", ");E.push(`<strong>\u{1F4E5} Funding Sources:</strong> Wallet received funds from ${P.uniqueSources} source(s) \u2014 ${Le} among them. Total inbound: ${R(P.totalIn,2)} XRP.`)}return(Pr=M==null?void 0:M.scamMemos)!=null&&Pr.length&&E.push(`<strong>\u{1F4DD} Scam Memo Content Detected:</strong> ${M.scamMemos.length} transaction memo(s) contain text matching known scam patterns (airdrop claims, wallet verification requests, urgency language). These payments were likely sent by attackers attempting social engineering.`),(Lr=O==null?void 0:O.signals)!=null&&Lr.some(Le=>Le.sev==="critical")&&E.push("<strong>\u{1F4D6} Active Spoofing Detected Right Now:</strong> This wallet currently has an order that controls over 40% of the visible order book depth. Large orders placed without intent to fill \u2014 then quickly cancelled when approached \u2014 is spoofing. This is happening in the live order book at time of inspection."),($==null?void 0:$.riskPenalty)>0&&E.push("<strong>\u{1F3F7} Destination Tag Pattern:</strong> Payments to exchanges used an unusually wide variety of destination tags \u2014 each tag identifies a different customer account. This can indicate a service routing payments to many accounts, or deliberate spread of deposits across exchange accounts to reduce traceability."),Se.length===0&&B.length===0&&E.push(`<span style="color:#50fa7b"><strong>\u2705 No Elevated Signals Found</strong></span><br>All checks returned results within normal ranges across ${pe}. This does not guarantee the account is trustworthy \u2014 it means no identifiable red flags were found in the data analyzed.`),f.length<100&&E.push(`<em style="opacity:.6;font-size:.86em">Data coverage: ${pe}. Fewer than 100 transactions means some statistical tests above may not reach reliable conclusions \u2014 treat those specifically as weaker signal.</em>`),E}let me={Security:{icon:"\u{1F510}",desc:"Keys, flags, multisig, auth changes"},"Drain Risk":{icon:"\u26A0\uFE0F",desc:"Auth changes \u2192 large outflows, external key injection"},"Fund Flow":{icon:"\u{1F30A}",desc:"Exchange flows, black holes, new-wallet recipients, path routing"},NFT:{icon:"\u{1F3A8}",desc:"Zero-value offers, no-metadata tokens, burns"},"Wash Trading":{icon:"\u{1F4CA}",desc:"Cancel ratios, self-trades, order uniformity, burst patterns"},"Benford's Law":{icon:"\u{1F4D0}",desc:"First-digit natural distribution test on all amounts"},"Volume Concentration":{icon:"\u{1FAE7}",desc:"How many wallets drive token trading volume"},"Shannon's Entropy":{icon:"\u{1F500}",desc:"Randomness of amounts, counterparties, timing, tx types"},"Zipf's Law":{icon:"\u{1F4C8}",desc:"Counterparty frequency power-law distribution"},"Time Series":{icon:"\u{1F550}",desc:"Interval regularity, periodicity \u2014 bot vs human timing"},"Granger Causality":{icon:"\u{1F517}",desc:"Create\u2192cancel cycles, inflow\u2192outflow cycling"},"Token Issuer":{icon:"\u{1FA99}",desc:"Supply, freeze state, concentration"},AMM:{icon:"\u{1F4A7}",desc:"LP positions, pool TVL, ownership share"},"Issuer Connections":{icon:"\u{1F578}",desc:"Distribution patterns, mirror wallets, account creation chains"},"Fee Spikes":{icon:"\u{1F4B8}",desc:"Elevated fee transactions \u2014 coordination signal"},"Destination Tags":{icon:"\u{1F3F7}",desc:"Exchange sub-account routing patterns"},"Path Payments":{icon:"\u{1F504}",desc:"Circular routing, self-routing, deep-hop obfuscation"},"Inbound Flow":{icon:"\u{1F4E5}",desc:"Funding sources, exchange deposits, structured inbound patterns"},"Memo Analysis":{icon:"\u{1F4DD}",desc:"Scam patterns, coordination text, hex-decoded memo data"},"Escrow Depth":{icon:"\u{1F512}",desc:"Third-party escrows, maturity dates, conditional locks"},"Live Order Book":{icon:"\u{1F4D6}",desc:"Current spoofing detection \u2014 wall orders, book depth concentration"}},xe=["Security","Drain Risk","Fund Flow","NFT","Wash Trading","Benford's Law","Volume Concentration","Shannon's Entropy","Zipf's Law","Time Series","Granger Causality","Token Issuer","AMM","Issuer Connections","Fee Spikes","Destination Tags","Path Payments"],Te={};for(let E of xe)Te[E]=ce.filter(Pe=>Pe.module===E&&Pe.sev!=="ok"&&Pe.sev!=="info");let je=xe.filter(E=>Te[E].length>0).map(E=>{let Pe=me[E]||{icon:"\u{1F4CB}",desc:""},tn=Te[E].map(ot=>{var mt;let qn=(mt=ot.hashes)!=null&&mt.length?`
          <div style="margin-top:6px;display:flex;flex-wrap:wrap;gap:6px">
            ${ot.hashes.slice(0,5).map($n=>`
    ...
    <div class="report-wrap">
      ...
      <div class="report-section">
        ...
        <div class="report-narrative">
          ${Rt.map(E=>`<p style="margin-bottom:12px;line-height:1.7">${E}</p>`).join("")}
        </div>
      </div>
      ...
      <div class="report-section">
        ...
        <div style="margin-bottom:16px">${Oy(f,e)}</div>
        ${yu(n,p,P)}
      </div>
  ...
  `}function py(e,...t){e.innerHTML=dy(...t)}function uy(){let e=document.getElementById("tab-inspector");e&&(e.querySelector("[data-inspector-v2]")||(e.innerHTML=`
    <style>
  ...
  `))}function my(){if(document.getElementById("inspector-nav"))return;let e=document.createElement("nav");e.id="inspector-nav",e.setAttribute("aria-label","Inspector navigation"),e.innerHTML=`
  ...
  `;let t=document.getElementById("tab-inspector");t&&t.appendChild(e)}function fy(){if(document.getElementById("inspector-howto"))return;let e=document.createElement("div");e.id="inspector-howto",e.className="howto-overlay",e.style.display="none",e.innerHTML=`
  ...
  `).join(""))}function Sy(){let e=document.getElementById("isd-cap-grid");e&&(e.innerHTML=xy.map(t=>`
  ...
  `).join(""))}function Ki(){let e=document.getElementById("isd-wallets-section"),t=document.getElementById("isd-wallet-list");if(!e||!t)return;let n=ve(Q(yy))||[];if(!n.length){e.style.display="none";return}e.style.display="",t.innerHTML=n.map(s=>{let a=s.color||"#50fa7b",o=s.emoji||"\u{1F48E}",i=s.label||"Wallet",r=s.address||"",l=r?r.slice(0,8)+"\u2026"+r.slice(-6):"\u2014",c=s.testnet?'<span class="isd-wallet-testnet">TESTNET</span>':"";return`
    ...
    `}).join("")}function Ji(){let e=document.getElementById("isd-recent-section"),t=document.getElementById("isd-recent-list");if(!e||!t)return;let n=no();if(!n.length){e.style.display="none";return}e.style.display="",t.innerHTML=n.map((s,a)=>{let o=s.addr?s.addr.slice(0,10)+"\u2026"+s.addr.slice(-8):"\u2014",i=s.riskScore!=null?`<span class="isd-risk-pill isd-risk-pill--${Su(s.riskScore)}">${s.riskScore}</span>`:"";return`
    ...
    `}).join("")}function Ty(){Za(),window.addEventListener("xrpl-ledger",Cy),window.addEventListener("xrpl-connection",Za)}function Cy(e){Qa()&&Za(e.detail)}var Hi=null;function Py(){return Hi||(Hi={idx:document.getElementById("isd-ledger-idx"),age:document.getElementById("isd-ledger-age"),tps:document.getElementById("isd-tps"),tpsTrnd:document.getElementById("isd-tps-trend"),fee:document.getElementById("isd-fee"),feeLv:document.getElementById("isd-fee-level"),close:document.getElementById("isd-close-time"),dot:document.getElementById("isd-conn-dot"),connLbl:document.getElementById("isd-conn-label"),pill:document.getElementById("isd-conn-pill"),domTx:document.getElementById("isd-dom-tx"),domPct:document.getElementById("isd-dom-pct"),bar:document.getElementById("isd-fee-bar"),barLbl:document.getElementById("isd-fee-bar-label")})}function Za(){let{idx:e,age:t,tps:n,tpsTrnd:s,fee:a,feeLv:o,close:i,dot:r,connLbl:l,pill:c,domTx:d,domPct:u,bar:p,barLbl:m}=Py(),f=X.connectionState||"disconnected",v={connected:{label:"Connected",cls:"conn--live"},connecting:{label:"Connecting\u2026",cls:"conn--warn"},disconnected:{label:"Disconnected",cls:"conn--dead"}},b=v[f]||v.disconnected;r&&(r.className="isd-conn-dot"),l&&(l.textContent=b.label),c&&(c.className=`isd-conn-pill ${b.cls}`);let h=X.ledgerLog||[];if(h.length&&e){let T=h[0];if(e.textContent=Number(T.ledgerIndex||0).toLocaleString(),t&&(t.textContent=T.closeTimeSec!=="\u2014"?T.closeTimeSec+"s close":"\u2014"),i){let S=parseFloat(T.closeTimeSec);i.textContent=isNaN(S)?"\u2014":S.toFixed(1)}}let g=X.tpsHistory||[];if(g.length&&n){let T=g.slice(-5),S=T.reduce((P,M)=>P+M,0)/T.length;if(n.textContent=S.toFixed(1),s&&g.length>=6){let P=g.slice(-10,-5),M=P.reduce((_,O)=>_+O,0)/P.length,N=S-M;s.textContent=N>.5?"\u2191 rising":N<-.5?"\u2193 falling":"\u2192 stable",s.className=`isd-metric-sub ${N>.5?"isd-up":N<-.5?"isd-down":""}`}}let w=X.feeHistory||[];if(w.length&&a){let T=w.slice(-5),S=T.reduce((N,_)=>N+_,0)/T.length,P=S/1e6;a.textContent=S<5e3?S.toFixed(0)+" drops":P.toFixed(5)+" XRP";let M=S<20?{lbl:"Low",cls:"fee-low",pct:10}:S<100?{lbl:"Normal",cls:"fee-normal",pct:28}:S<500?{lbl:"Elevated",cls:"fee-elevated",pct:60}:S<2e3?{lbl:"High",cls:"fee-high",pct:82}:{lbl:"Congested",cls:"fee-congest",pct:100};o&&(o.textContent=M.lbl,o.className=`isd-metric-sub ${M.cls}`),p&&(p.style.width=M.pct+"%",p.className=`isd-fee-bar-fill ${M.cls}`),m&&(m.textContent=M.lbl,m.className=`isd-fee-bar-level ${M.cls}`)}let k=X.txMixAccum||{},$=Object.entries(k).filter(([,T])=>T>0).sort(([,T],[,S])=>S-T);if($.length&&d){let T=$.reduce((M,[,N])=>M+N,0),[S,P]=$[0];d.textContent=S,u&&(u.textContent=(P/T*100).toFixed(0)+"% of traffic")}}window.exportTxCSV=function(e){var l,c;if(!e||!e.length){alert("No transaction data to export. Run an inspection first.");return}let t=946684800,s=[["Hash","Date","Type","Account","Destination","Amount_XRP","Amount_Token","Currency","Fee_Drops","DestinationTag","Result","LedgerIndex"],...e.map(({tx:d,meta:u})=>{var h,g;let p=d.date?new Date((d.date+t)*1e3).toISOString():"",m=typeof d.Amount=="string"?(Number(d.Amount)/1e6).toFixed(6):"",f=(h=d.Amount)!=null&&h.value?d.Amount.value:"",v=((g=d.Amount)==null?void 0:g.currency)||(typeof d.Amount=="string"?"XRP":""),b=(u==null?void 0:u.TransactionResult)||"";return[d.hash||"",p,d.TransactionType||"",d.Account||"",d.Destination||"",m,f,v,d.Fee||"",d.DestinationTag??"",b,d.ledger_index||""]})].map(d=>d.map(u=>{let p=String(u);return p.includes(",")||p.includes('"')||p.includes(`
`)?'"'+p.replace(/"/g,'""')+'"':p}).join(",")).join(`
`),a=new Blob([s],{type:"text/csv;charset=utf-8;"}),o=URL.createObjectURL(a),i=document.createElement("a"),r=((c=(l=document.getElementById("inspect-addr-badge"))==null?void 0:l.dataset)==null?void 0:c.fullAddr)||"wallet";i.href=o,i.download=`naluxrp_${r.slice(0,10)}_${new Date().toISOString().slice(0,10)}.csv`,document.body.appendChild(i),i.click(),document.body.removeChild(i),URL.revokeObjectURL(o)};function Ly(e,t){let s=no().find(o=>o.addr===e);if(!s||s.riskScore==null||t==null)return null;let a=t-s.riskScore;return{prev:s.riskScore,curr:t,diff:a,ts:s.ts}}function My(e,t){let n=Ly(e,t);if(!n||Math.abs(n.diff)<2)return;let s=document.getElementById("inspect-risk-score");if(!s)return;let a=n.diff>0?`<span style="color:#ff5555;font-size:.7rem;font-weight:700"> \u2191${n.diff}</span>`:`<span style="color:#50fa7b;font-size:.7rem;font-weight:700"> \u2193${Math.abs(n.diff)}</span>`,o=so(n.ts);s.insertAdjacentHTML("afterend",`<span class="risk-score-diff" title="Changed from ${n.prev} \u2192 ${n.curr} since ${o}">${a} vs ${o}</span>`)}window._inspectMaxTx||(window._inspectMaxTx=5e3);window._debugBalanceDeltas=Zv;window._debugOfferLifecycles=bu;window.inspectorLoadAddr=function(e){let t=x("inspect-addr");t&&(t.value=e),bs()};window.inspectWalletAddr=function(e){var n,s;window.inspectorLoadAddr(e);let t=document.querySelector('[data-tab="inspector"]');t&&((n=window.switchTab)==null||n.call(window,t,"inspector")),(s=window.showDashboard)==null||s.call(window)};window.printInspectorReport=function(){var s,a;let e=document.getElementById("inspect-report-body");if(!e)return;let t=((a=(s=document.getElementById("inspect-addr-badge"))==null?void 0:s.dataset)==null?void 0:a.fullAddr)||"wallet",n=window.open("","_blank","width=900,height=700");n.document.write(`<!DOCTYPE html><html><head>
    ...
    ${e.innerHTML}
  </body></html>`),n.document.close()};window.exportInspectorReport=function(){var n;let e=document.getElementById("inspect-report-body");if(!e)return;let t=e.innerText||e.textContent||"";(n=navigator.clipboard)==null||n.writeText(t).then(()=>{let s=document.getElementById("report-export-btn");s&&(s.textContent="\u2713 Copied!",setTimeout(()=>{s.textContent="\u{1F4CB} Copy Report"},2e3))}).catch(()=>{let s=document.createRange();s.selectNodeContents(e);let a=window.getSelection();a.removeAllRanges(),a.addRange(s)})};window.inspectorClearHistory=function(){ht(Gi);let e=document.getElementById("isd-recent-section");e&&(e.style.display="none")};window.inspectorClearWatchlist=function(){ht(Qs),ea()};function no(){return ve(Q(Gi))||[]}function Ay(e,t,n=[]){let s=no();s=s.filter(o=>o.addr!==e);let a=n.filter(o=>o.sev==="critical"||o.sev==="warn").map(o=>o.module+":"+o.headline.slice(0,40)).sort().join("|");s.unshift({addr:e,riskScore:t,ts:Date.now(),fingerprint:a}),s=s.slice(0,12),Z(Gi,JSON.stringify(s))}function Zs(){return ve(Q(Qs))||[]}function Ey(e,t){let n=Zs().filter(s=>s.addr!==e);n.unshift({addr:e,label:t||j(e),addedTs:Date.now(),lastScore:null,lastTs:null}),Z(Qs,JSON.stringify(n.slice(0,50)))}function $u(e){Z(Qs,JSON.stringify(Zs().filter(t=>t.addr!==e)))}function Ui(e){return Zs().some(t=>t.addr===e)}function Ny(e,t){let n=Zs().map(s=>s.addr===e?{...s,lastScore:t,lastTs:Date.now()}:s);Z(Qs,JSON.stringify(n))}function so(e){let t=Date.now()-e;return t<6e4?"just now":t<36e5?Math.floor(t/6e4)+"m ago":t<864e5?Math.floor(t/36e5)+"h ago":Math.floor(t/864e5)+"d ago"}function Su(e){return ji(e).replace("risk-","")}var Yt=!1;function Tu(){Yt=localStorage.getItem(ku)==="true",Yi()}function Yi(){let e=document.getElementById("inspect-result");if(!e)return;e.classList.toggle("mode-advanced",Yt),e.classList.toggle("mode-simple",!Yt);let t=document.getElementById("analyst-mode-btn");t&&(t.textContent=Yt?"\u2697 Advanced":"\u{1F441} Simple",t.title=Yt?"Switch to Simple view":"Switch to Advanced (analyst) view",t.setAttribute("aria-pressed",String(Yt)))}window.toggleAnalystMode=function(){Yt=!Yt,localStorage.setItem(ku,Yt),Yi()};var _y=new Set(["section-overview","section-report"]),Ry=new Set(["section-security","section-drain","section-fundflow","section-inbound"]);function Dy(){let e=document.getElementById("inspect-result");if(!e)return;let t=[...e.querySelectorAll(".inspector-section")],n={crit:0,warn:1,neutral:2,ok:3,"":4},s=t.filter(i=>!_y.has(i.id)&&!Ry.has(i.id));s.sort((i,r)=>{let l=c=>{let d=c.querySelector(".section-badge");if(!d)return"";let u=d.className;return u.includes("crit")?"crit":u.includes("warn")?"warn":u.includes("neutral")?"neutral":u.includes("ok")?"ok":""};return(n[l(i)]??4)-(n[l(r)]??4)});let a=document.getElementById("section-inbound")||document.getElementById("section-drain");if(!a)return;let o=a;for(let i of s)o.after(i),o=i}function Iy(e,t,n,s){let a=document.getElementById("quick-verdict-body");if(!a)return;let o=t.filter(u=>u.sev==="critical"),i=t.filter(u=>u.sev==="warn"),r=e<20?"#50fa7b":e<45?"#ffb86c":e<70?"#ff8c42":"#ff5555",l=e<20?"Low Risk":e<45?"Moderate":e<70?"High Risk":"Critical",c="",d="";if(o.length===0&&i.length===0)c=`No elevated signals found across ${s.toLocaleString()} transactions${n!=null?` and ${n} days of history`:""}.`,d="This wallet appears to operate within normal parameters.";else{let u=o.slice(0,2).map(m=>m.headline).join("; "),p=i.slice(0,2).map(m=>m.headline).join("; ");c=o.length?`${o.length} critical issue${o.length>1?"s":""}: ${u}.`:`${i.length} warning${i.length>1?"s":""}: ${p}.`,d=o.length?"Review the highlighted sections below. Scroll to the Report for full recommendations.":"Review the flagged sections below for context before drawing conclusions."}a.innerHTML=`
    ...
    </div>`}function ea(){let e=document.getElementById("isd-watchlist-section"),t=document.getElementById("isd-watchlist-list");if(!e||!t)return;let n=Zs();if(!n.length){e.style.display="none";return}e.style.display="",t.innerHTML=n.map(s=>{let a=s.addr.slice(0,8)+"\u2026"+s.addr.slice(-6),o=s.lastScore!=null?`<span class="isd-risk-pill isd-risk-pill--${Su(s.lastScore)}">${s.lastScore}</span>`:"",i=s.lastTs?so(s.lastTs):"never checked";return`
    ...
    </div>`}function Pu(e,t){let n=new Map;for(let{tx:s,meta:a}of e){let o=s.Account===t,i=s.Destination===t;if(!o&&!i)continue;let r=o?s.Destination:s.Account;if(!r||r===t)continue;let l=yn(s);n.has(r)||n.set(r,{cnt:0,xrpOut:0,xrpIn:0,entity:ys(r),firstSeen:l,lastSeen:l});let c=n.get(r);c.cnt++,l&&(c.firstSeen=c.firstSeen?Math.min(c.firstSeen,l):l,c.lastSeen=Math.max(c.lastSeen,l));let d=(a==null?void 0:a.delivered_amount)||s.Amount,u=typeof d=="string"?Number(d)/1e6:0;o?c.xrpOut+=u:c.xrpIn+=u}return n}function Oy(e,t,n=15){let s=Pu(e,t),a=[...s.entries()].sort((r,l)=>l[1].xrpOut+l[1].xrpIn-(r[1].xrpOut+r[1].xrpIn)||l[1].cnt-r[1].cnt).slice(0,n);if(!a.length)return'<div class="inspect-empty-note">No counterparty interactions found.</div>';let o=Math.max(...a.map(([,r])=>r.xrpOut+r.xrpIn),1),i=a.map(([r,l],c)=>{var h;let d=l.xrpOut+l.xrpIn,u=Math.max(1.5,d/o*100),p=vn[(h=l.entity)==null?void 0:h.type]||vn.other,m=d>0?l.xrpOut/d:.5,f=m>.65?"\u2192 out":m<.35?"\u2190 in":"\u21C4 both",v=l.entity?`<span style="font-size:.64rem;color:${p};border:1px solid ${p};border-radius:999px;padding:1px 7px;margin-left:6px">${y(l.entity.name)}</span>`:"",b=wu(l.firstSeen,l.lastSeen);return`
    ...
    ${i}`}function Xy(e,t,n,s,a="inspect-network-map"){let o=document.getElementById(a);if(!o)return;let r=[...Pu(e,t).entries()].sort((S,P)=>P[1].xrpOut+P[1].xrpIn-(S[1].xrpOut+S[1].xrpIn)||P[1].cnt-S[1].cnt).slice(0,20);if(r.length<2){o.style.display="",o.innerHTML=`<div class="inspect-empty-note">${r.length===0?"No counterparty interactions found.":"Only one counterparty found \u2014 not enough to chart a network map."}</div>`;return}o.style.display="";let l=560,c=340,d=l/2,u=c/2,p=95,m=7,f=155,v=13,b=r[0][1].xrpOut+r[0][1].xrpIn||1,h=r[0][1].cnt||1,g=[{id:t,x:d,y:u,r:13,main:!0,label:j(t),color:"#00d4ff",xrpOut:0,xrpIn:0,cnt:0}];r.forEach(([S,P],M)=>{let N=M<m?p:f,_=M<m?m:v,I=(M<m?M:M-m)/_*2*Math.PI-Math.PI/2,D=P.xrpOut+P.xrpIn,F=Math.max(5,Math.min(14,4+D/b*10)),H=P.entity,A=vn[H==null?void 0:H.type]||vn.other,z=D>0?P.xrpOut/D:.5,te=z>.65?"out":z<.35?"in":"both";g.push({id:S,x:d+N*Math.cos(I),y:u+N*Math.sin(I),r:F,color:A,label:(H==null?void 0:H.name)||j(S),ent:H,xrpOut:P.xrpOut,xrpIn:P.xrpIn,cnt:P.cnt,dir:te,vol:D,ring:N})});let w=`<defs>
  ...
  </defs>`,k=g.slice(1).map(S=>{let P=S.vol/b,M=Math.max(.8,P*3),N=.12+P*.45,_=S.dir==="out"?"rgba(80,250,123,":S.dir==="in"?"rgba(0,212,255,":"rgba(255,184,108,",O=S.dir==="out"?`rgba(80,250,123,${N})`:S.dir==="in"?`rgba(0,212,255,${N})`:`rgba(255,184,108,${N})`,I=S.dir==="in"?"5,3":"none",D=`marker-end="url(#arrow-${S.dir})"`,F=S.x-d,H=S.y-u,A=Math.sqrt(F*F+H*H),z=(S.r+2)/A,te=d+F*(1-z),oe=u+H*(1-z),pe=`${S.xrpOut>0?"\u2192 "+R(S.xrpOut,2)+" XRP out":""}${S.xrpIn>0?(S.xrpOut>0?" / ":"")+"\u2190 "+R(S.xrpIn,2)+" XRP in":""}, ${S.cnt} tx`;return`<line x1="${d}" y1="${u}" x2="${te.toFixed(1)}" y2="${oe.toFixed(1)}"
      stroke="${O}" stroke-width="${M.toFixed(1)}" stroke-dasharray="${I}" ${D}>
      <title>${pe}</title></line>`}).join(""),$=g.map(S=>{var H,A;if(S.main){let z=j(S.id);return`<g>
    ...
    </div>`}function By(){let e=window._lastInspectResult,t=window._lastAllFindings||[];if(!e)return null;let n=t.length?t.map(a=>`- [${a.sev.toUpperCase()}] ${a.module}: ${a.headline}${a.detail?" \u2014 "+a.detail:""}`).join(`
...
You are acting as a security analyst explaining automated blockchain forensics findings to someone who isn't a blockchain expert. Write a clear, plain-English explanation of what this account's activity suggests. Synthesize the findings above into a coherent read of the account rather than restating them one by one \u2014 call out which ones reinforce each other and which are weak signals on their own. Be direct about how concerning (or not) this looks, and be skeptical of your own confidence where the evidence is thin rather than overstating it. Do not repeat the address or risk score back verbatim; the reader can already see those above your response.`}window.copyInspectorAnalysisForAi=function(){let e=document.getElementById("ai-explanation-body"),t=By();if(!t){e&&(e.innerHTML='<p style="font-size:.82rem;color:#ff5555">Run an inspection first.</p>');return}Bs(t)};window.exportInspectorJSON=function(){var o,i;let e=window._lastInspectResult;if(!e){alert("Run an inspection first.");return}let t=new Blob([JSON.stringify(e,null,2)],{type:"application/json"}),n=URL.createObjectURL(t),s=document.createElement("a"),a=((i=(o=document.getElementById("inspect-addr-badge"))==null?void 0:o.dataset)==null?void 0:i.fullAddr)||"wallet";s.href=n,s.download=`naluxrp_${a.slice(0,10)}_${new Date().toISOString().slice(0,10)}.json`,document.body.appendChild(s),s.click(),document.body.removeChild(s),URL.revokeObjectURL(n)};var Hy=6e4,zy=1e4,jy=12e4,Wy=8e3,Uy=12e4,qy=300,Xu="nalulf_net_baseline_v2",Vy=80,Gy=5,sa="/api/v1/validatorregistry",Bu="/api/v1/validator";var Ky=5*60*1e3,Hu=10*60*1e3,Lu=1e4,zu=8e3,tr=new Map,nr=new Map;var Zt={quorumTight:{w:3,label:"Quorum within 3 validators of failure threshold"},nUnlActive:{w:2,label:"Negative UNL active \u2014 validators currently being ignored"},amendVeto:{w:1,label:"Amendment veto clustering \u2014 protocol governance dispute"},feeSpike:{w:2,label:"Open ledger fee 10\xD7 minimum \u2014 DDoS / spam attack likely"},burnAnomaly:{w:2,label:"XRP burn rate z-score > 3\u03C3 \u2014 resource exhaustion pattern"},peerSaturate:{w:2,label:"Inbound peers > 80% of connections \u2014 Eclipse Attack risk"},eclipseRisk:{w:3,label:"Peer count < 6 \u2014 node highly vulnerable to isolation"},dexSpike:{w:1,label:"DEX volume > 3\xD7 AMM baseline \u2014 unusual event-driven flow"},reserveSpike:{w:1,label:"New account rate > 3\xD7 baseline \u2014 possible bot creation"},slowConverge:{w:2,label:"Consensus convergence > 6s \u2014 network agreement degraded"},lowProposers:{w:2,label:"Proposer count below quorum \u2014 validator participation low"},queuePressure:{w:2,label:"TX queue > 80% full \u2014 fee surge imminent"},spamLedger:{w:1,label:"Ledger > 2\xD7 expected size \u2014 ledger spam in progress"},ioStressed:{w:1,label:"Node IO latency > 5ms \u2014 storage or network I/O stress"},peerChurn:{w:1,label:"Elevated peer disconnect rate \u2014 DDoS or instability"},staleLedger:{w:3,label:"Ledger age > 10s \u2014 validation appears stalled"}},ju={MultiSign:{purpose:"Multi-signature authorization",intro:"rippled 0.31",desc:"Lets multiple keys jointly authorize one transaction. Essential for institutional custody and hardware-wallet setups.",impact:"New transaction: SignerListSet. All signers submit their signature; the last one broadcasts."},MultiSignReserve:{purpose:"Cheaper signer-list reserve",intro:"rippled 1.2",desc:"Cuts the owner reserve for SignerList objects from 5 owner-items (10 XRP) down to 1 owner-item (2 XRP).",impact:"Existing SignerLists do not gain the reduction automatically; delete and re-create the list."},DepositAuth:{purpose:"Block unsolicited incoming payments",intro:"rippled 0.90",desc:"An account can set lsfDepositAuth so it only receives payments explicitly pre-authorized via DepositPreauth.",impact:"Senders to un-authorized accounts receive tecNO_PERMISSION."},DeletableAccounts:{purpose:"Permanent account deletion + reserve reclaim",intro:"rippled 1.4",desc:"An account with no objects and sequence \u2265 (current ledger \u2212 256) can permanently delete itself and recover the base reserve.",impact:"New transaction: AccountDelete. Sends all XRP minus fees to a destination."},NegativeUNL:{purpose:"Fault-tolerant consensus during outages",intro:"rippled 1.6",desc:"When validators are persistently offline, the network may add them to the Negative UNL so they do not count against quorum.",impact:"Enables the network to survive planned outages of up to 20% of trusted validators."},Checks:{purpose:"Deferred, cancellable payments",intro:"rippled 1.0",desc:"The sender creates a Check; the recipient can later cash it up to the authorized amount or let it expire. The sender can cancel at any time.",impact:"New transactions: CheckCreate, CheckCash, CheckCancel. Each open Check uses one owner-reserve slot."},AMM:{purpose:"Native Automated Market Maker DEX",intro:"rippled 1.12",desc:"Adds a Constant-Product (x*y=k) AMM directly in the ledger. Anyone can deposit two assets to earn LP tokens and a share of swap fees.",impact:"New transactions: AMMCreate, AMMDeposit, AMMWithdraw, AMMVote, AMMBid, AMMDelete."},XChainBridge:{purpose:"Cross-chain bridge protocol",intro:"rippled 2.0",desc:"Lets assets move between XRPL Mainnet, sidechains, and EVM chains via a locking/minting bridge secured by Witness servers.",impact:"New ledger objects: Bridge, XChainOwnedCreateAccountClaimID, etc. Requires Witness infrastructure."},Clawback:{purpose:"Token-issuer recovery",intro:"rippled 1.12",desc:"Issuers who set lsfAllowTrustLineClawback before issuing tokens can claw back tokens from any holder.",impact:"Must be enabled on a fresh account before any trust lines are created."},NonFungibleTokensV1:{purpose:"Native NFT support",intro:"rippled 1.9",desc:"Adds NFTokenMint, NFTokenBurn, and offer-based transfer mechanics for non-fungible tokens stored in NFTokenPage objects.",impact:"Each NFTokenPage holds up to 32 tokens and costs one owner-reserve slot. Royalties up to 50%."},NonFungibleTokensV1_1:{purpose:"NFT V1 corrections",intro:"rippled 1.10",desc:"Fixes pagination bugs, transfer-fee edge cases, and minting with the URI field that were present in V1.",impact:"Breaking fix for some V1 edge cases. Wallets built for V1 should test V1_1 compatibility."},PayChan:{purpose:"Payment channels for streaming micropayments",intro:"rippled 0.33",desc:"Sender deposits XRP into a channel, then issues signed claims off-ledger. Recipient submits the highest claim at any time to settle on-ledger.",impact:"New transactions: PaymentChannelCreate, PaymentChannelFund, PaymentChannelClaim."},Escrow:{purpose:"Time-locked and condition-based XRP transfers",intro:"rippled 0.60",desc:"Lock XRP until a future time OR a cryptographic fulfillment (PREIMAGE-SHA-256) is revealed, enabling vesting schedules and atomic swaps.",impact:"New transactions: EscrowCreate, EscrowFinish, EscrowCancel. Locked XRP counts against reserves."},DisallowIncoming:{purpose:"Block unsolicited ledger-object creation",intro:"rippled 1.10",desc:"New account flags let you individually block incoming Trust Lines, Check objects, NFToken offers, and Payment Channels.",impact:"Four new AccountSet flags; existing incoming objects are unaffected."},ExpandedSignerList:{purpose:"Larger multi-sig signer lists",intro:"rippled 1.9.1",desc:"Increases the maximum signers per SignerList from 8 to 32, enabling more complex institutional multi-sig and DAO governance.",impact:"Reserve cost scales with signer count. Requires MultiSignReserve to be cost-effective."},OwnerPaysFee:{purpose:"Correct fee payer in PayChan",intro:"rippled 0.33",desc:"Fixes a spec inconsistency where the channel owner correctly pays the transaction fee when closing or expiring channels.",impact:"Purely a fee-accounting fix; no user-visible behavior changes."},fixMasterKeyAsRegularKey:{purpose:"Master-key mis-use bug fix",intro:"rippled 0.90",desc:"Prevents accounts from setting their master key as their regular key \u2014 an operation that could create an unusable account state.",impact:"No application changes needed; existing accounts are not affected."},TrustSetAuth:{purpose:"Authorized trust lines",intro:"rippled 0.30",desc:"Issuers can require explicit authorization before anyone can hold their token \u2014 a prerequisite for regulatory-grade stablecoins.",impact:"New flow: issuer sends TrustSet with tfSetfAuth to approve each holder."}},Mu=new Set(["xrpscan.com","xrpl.aesthetes.art","xrpkuwait.com","xrpgoat.com","xrp.vet","xrp.unic.ac.cy","xrp-validator.interledger.org","xpmarket.com","verum.eminence.im","validator.xrpl.robertswarthout.com","validator.xrpl-labs.com","validator.poli.usp.br","validator.gatehub.net","validator.aspired.nz","v2.xrpl-commons.org","tequ.dev","squidrouter.com","ripple.ittc.ku.edu","ripple.com","peersyst.cloud","onxrp.com","katczynski.net","jon-nilsen.no","ekiserrepe.es","cabbit.tech","bithomp.com","aureusox.com","arrington-xrp-capital.blockdaemon.com","anodos.finance","bitso.com","ripple.kenan-flagler.unc.edu","ripplevalidator.uwaterloo.ca","shadow.haas.berkeley.edu","www.bitrue.com","xrp-col.anu.edu.au"]),Jy=new Set(["nHBu3iuq1SQ9Z686pYwWYVKpScSMDWfpUJHdNEQRxn5XyETui7Db","nHDwBbubxJswoweWQKEgWLNRJv2hNRCTR4GGApJmbtCcbtYNSpdB","nHU2FpRbPrvVcyQQpkqrAUDJDTRHZpjij8DpKeSC481PYY9ikYkb","nHUbmg8QNzEGjHzgnt99e9YE2scU3DZGH7FsF6MCcK5eiPt3AtaH","nHUxBD1UPb383SdWgJx62GGQ7W2WKvgpUtUXLjiGGRRcPb3nbSXd","nHUP6rfQfgzg6tKga3k9ziEvtjwn1PB32gcr5dLcamqzmitszYv2","nHBT58yHyDdPdJ6gzaBMT7gqwTMpj5ERji1s9SvfKKtfoZUS89WX","nHBxsUzx3Bbf6J4yJ3fLQ3VizPtdREVwTJ6mdqkuDTjLcVbggVbk","nHUeUNSn3zce2xQZWNghQvd9WRH6FWEnCBKYVJu2vAizMxnXegfJ","nHUCAdca6VoWWYVdBH1bwCUQggEX2e5acQSqxM3DwyuhsFknxmh3","nHDDiwQBqXhEL1CFoRHdMXD33x9K7rpYJfniXxL7kFavpPd21EGe","nHBipbbREjNEiCs4hpy3K2489dRf27MPnxdivTTWKSd8ZUhfRvn8","nHDDe5uAdiv6RA59MA1oM4JLDtVSYKNShgjEqq1KsdJXZiR47CQT","nHBbiP5ua5dUqCTz5i5vd3ia9jg3KJthohDjgKxnc7LxtmnauW7Z","nHBQ3CT3EWYZ4uzbnL3k6TRf9bBPhWRFVcK1F5NjtwCBksMEt5yy","nHU16DF2kq7TmbR1Y5z8yKNXiLEf3oHT19HVpVXv7unFLfxa17nT","nHUC23NnutZyYeQxQbAbPUpKoVGj5aisBxf2zzcZzJ43fcw5rc9z","nHUgdMvuchx7AWG4ATMQdNNuMryo1SFoNptLCEVt2Dn7wEc625mF","nHUhQVE93dajM3srxubsEj1mK1gzRwJob14QSrJefY1FdLs6r7WJ","nHUU8xBczYzW6kZ6Ei9DsggzTJXRFkN3wE3FP5H4SLYzhbodeYcG","nHUGqooyfGqFkyH6uskbaEi6y2MjXjdA7QdbmyZ6p9etL5isRKLT","nHDp1ZXxEn7eo5YaUtiagaxSLwXudnKZDx68C96p4tdVLGLLLUFn","nHBcLEB4S6moQGrhMjJo1jbp58WL5psHY9EMDWNAtdqykUYiA1rF","nHUAECq1v1cKwn3NsYVyD7v6BNbfqyXmNVSF3e4XCVxPgBHRWkvv","nHUif4sukXu9pJGyyBaeVMwmE8L1fJ5KJj4X4ksgTKhgjG6k96s2","nHUVJR7SeT3nn6JPTz46JHqYRf7vX2if1sdTxnceywmSBWa167pt","nHUEYz4TtTv7yebjhY3aDib5KYPHnKjnY5mPYK5y4QuKdocwS5tD","nHUN5n2S3nQ8bzKm7bqeFMiQeDijh1LMgEocyNyQbb4mREazVdZ5","nHUgchANqM3giYSSvY5HsafFW6qxmG5jJ3CvPiv7n8gjNQuNm8Uz","nHDUqGoM7KR1pgbdYBRgKpGKdFLhpnMzVbECs8RE73RGZm3Va6MJ","nHUVxTi8XfXjaaJppw7mLSrYDRpkDpf8H9ypzgVKxfSXShcWwAoK","nHBveTxA1NaBj5AayRAU91f6YopuFWt9rmxfGaEh77a32Q6ZzzHc"]),Yy=new Set(["validator.pftperry.com","rip973.com","preaware.org","postfiat.org","pftmeech.xyz","pft.xbtseal.com","pft.wizbubba.xyz","pft.permanentupperclass.com","pft.g.money","pft.akirax.xyz","jollydinger.com","auri0x.io","app.w.ai"]);function Wu(e,t){let n=(t||"").toLowerCase().replace(/^www\./,"");return Jy.has(e)||Yy.has(n)?{chain:"test",isUnl:!1}:Mu.has(n)||Mu.has("www."+n)?{chain:"main",isUnl:!0}:{chain:"main",isUnl:!1}}var dr={"xrpscan.com":{label:"XRP Scan",domain:"xrpscan.com",chain:"main",category:"unl"},"xrpl.aesthetes.art":{label:"Aesthetes",domain:"xrpl.aesthetes.art",chain:"main",category:"unl"},"xrpkuwait.com":{label:"XRP Kuwait",domain:"xrpkuwait.com",chain:"main",category:"unl"},"xrpgoat.com":{label:"XRP Goat",domain:"xrpgoat.com",chain:"main",category:"unl"},"xrp.vet":{label:"XRP Vet",domain:"xrp.vet",chain:"main",category:"unl"},"xrp.unic.ac.cy":{label:"Univ. of Nicosia",domain:"xrp.unic.ac.cy",chain:"main",category:"unl"},"xrp-validator.interledger.org":{label:"Interledger",domain:"xrp-validator.interledger.org",chain:"main",category:"unl"},"xpmarket.com":{label:"XPMarket",domain:"xpmarket.com",chain:"main",category:"unl"},"verum.eminence.im":{label:"Eminence",domain:"verum.eminence.im",chain:"main",category:"unl"},"validator.xrpl.robertswarthout.com":{label:"R. Swarthout",domain:"validator.xrpl.robertswarthout.com",chain:"main",category:"unl"},"validator.xrpl-labs.com":{label:"XRPL Labs",domain:"validator.xrpl-labs.com",chain:"main",category:"unl"},"validator.poli.usp.br":{label:"USP",domain:"validator.poli.usp.br",chain:"main",category:"unl"},"validator.gatehub.net":{label:"Gatehub",domain:"validator.gatehub.net",chain:"main",category:"unl"},"validator.aspired.nz":{label:"Aspired NZ",domain:"validator.aspired.nz",chain:"main",category:"unl"},"v2.xrpl-commons.org":{label:"XRPL Commons",domain:"v2.xrpl-commons.org",chain:"main",category:"unl"},"tequ.dev":{label:"Tequ",domain:"tequ.dev",chain:"main",category:"unl"},"squidrouter.com":{label:"Squid Router",domain:"squidrouter.com",chain:"main",category:"unl"},"ripple.ittc.ku.edu":{label:"Univ. of Kansas",domain:"ripple.ittc.ku.edu",chain:"main",category:"unl"},"ripple.com":{label:"Ripple",domain:"ripple.com",chain:"main",category:"unl"},"peersyst.cloud":{label:"Peersyst",domain:"peersyst.cloud",chain:"main",category:"unl"},"onxrp.com":{label:"OnXRP",domain:"onxrp.com",chain:"main",category:"unl"},"katczynski.net":{label:"Katczynski",domain:"katczynski.net",chain:"main",category:"unl"},"jon-nilsen.no":{label:"Jon Nilsen",domain:"jon-nilsen.no",chain:"main",category:"unl"},"ekiserrepe.es":{label:"Ekiserrepe",domain:"ekiserrepe.es",chain:"main",category:"unl"},"cabbit.tech":{label:"Cabbit",domain:"cabbit.tech",chain:"main",category:"unl"},"bithomp.com":{label:"Bithomp",domain:"bithomp.com",chain:"main",category:"unl"},"aureusox.com":{label:"Aureus Ox",domain:"aureusox.com",chain:"main",category:"unl"},"arrington-xrp-capital.blockdaemon.com":{label:"Arrington / Blockdaemon",domain:"arrington-xrp-capital.blockdaemon.com",chain:"main",category:"unl"},"anodos.finance":{label:"Anodos Finance",domain:"anodos.finance",chain:"main",category:"unl"},"bitso.com":{label:"Bitso",domain:"bitso.com",chain:"main",category:"unl"},"ripple.kenan-flagler.unc.edu":{label:"UNC Kenan-Flagler",domain:"ripple.kenan-flagler.unc.edu",chain:"main",category:"unl"},"ripplevalidator.uwaterloo.ca":{label:"Univ. of Waterloo",domain:"ripplevalidator.uwaterloo.ca",chain:"main",category:"unl"},"shadow.haas.berkeley.edu":{label:"UC Berkeley Haas",domain:"shadow.haas.berkeley.edu",chain:"main",category:"unl"},"www.bitrue.com":{label:"Bitrue",domain:"www.bitrue.com",chain:"main",category:"unl"},"xrp-col.anu.edu.au":{label:"ANU",domain:"xrp-col.anu.edu.au",chain:"main",category:"unl"},"xrpval.rawsec.de":{label:"Rawsec",domain:"xrpval.rawsec.de",chain:"main",category:"other"},"xrplvl.carbonvibe.com":{label:"Carbon Vibe",domain:"xrplvl.carbonvibe.com",chain:"main",category:"other"},"xrplvalidator.alloy.ee":{label:"Alloy",domain:"xrplvalidator.alloy.ee",chain:"main",category:"other"},"xrpl.uni.lu":{label:"Univ. of Luxembourg",domain:"xrpl.uni.lu",chain:"main",category:"other"},"xrpl.to":{label:"XRPL.to",domain:"xrpl.to",chain:"main",category:"other"},"xrpl.su":{label:"XRPL.su",domain:"xrpl.su",chain:"main",category:"other"},"xrpl.sbivc.co.jp":{label:"SBI VC Trade",domain:"xrpl.sbivc.co.jp",chain:"main",category:"other"},"xrpl-verification.flare.network":{label:"Flare Network",domain:"xrpl-verification.flare.network",chain:"main",category:"other"},"xrpl-validator.7rev.dev":{label:"7Rev",domain:"xrpl-validator.7rev.dev",chain:"main",category:"other"},"xrp.teacopula.com":{label:"Teacopula",domain:"xrp.teacopula.com",chain:"main",category:"other"},"xrp.moneymindedapes.com":{label:"MoneyMindedApes",domain:"xrp.moneymindedapes.com",chain:"main",category:"other"},"xrp.hazza-systems.de":{label:"Hazza Systems",domain:"xrp.hazza-systems.de",chain:"main",category:"other"},"xrp.cs.uoregon.edu":{label:"Univ. of Oregon",domain:"xrp.cs.uoregon.edu",chain:"main",category:"other"},"xrp.bpsqn.com":{label:"BPSQN",domain:"xrp.bpsqn.com",chain:"main",category:"other"},"xrp-validator.grapedrop.xyz":{label:"Grapedrop",domain:"xrp-validator.grapedrop.xyz",chain:"main",category:"other"},"xaodao.io":{label:"XaoDAO",domain:"xaodao.io",chain:"main",category:"other"},"vl.xrpsalute.com":{label:"XRP Salute",domain:"vl.xrpsalute.com",chain:"main",category:"other"},"validator.xrpl.app":{label:"XRPL App",domain:"validator.xrpl.app",chain:"main",category:"other"},"validator.ukcbt.org":{label:"UKCBT",domain:"validator.ukcbt.org",chain:"main",category:"other"},"validator.sugarxrpl.com":{label:"SugarXRPL",domain:"validator.sugarxrpl.com",chain:"main",category:"other"},"validator.boscaern.digital":{label:"Boscaern",domain:"validator.boscaern.digital",chain:"main",category:"other"},"trimaera.tech":{label:"Trimaera",domain:"trimaera.tech",chain:"main",category:"other"},"textrp.io":{label:"TextRP",domain:"textrp.io",chain:"main",category:"other"},"tesbert.com":{label:"Tesbert",domain:"tesbert.com",chain:"main",category:"other"},"tachyon-xrpl-validator.github.io":{label:"Tachyon",domain:"tachyon-xrpl-validator.github.io",chain:"main",category:"other"},"solonation.io":{label:"SoloNation",domain:"solonation.io",chain:"main",category:"other"},"smokydrip.com":{label:"SmokyDrip",domain:"smokydrip.com",chain:"main",category:"other"},"rippled-validator.us":{label:"rippled-validator.us",domain:"rippled-validator.us",chain:"main",category:"other"},"rippleat.snt.uni.lu":{label:"Univ. Luxembourg (SNT)",domain:"rippleat.snt.uni.lu",chain:"main",category:"other"},"ripple.uni.lu":{label:"Univ. Luxembourg",domain:"ripple.uni.lu",chain:"main",category:"other"},"ripple.j2b.com":{label:"J2B",domain:"ripple.j2b.com",chain:"main",category:"other"},"rich-list.info":{label:"Rich List",domain:"rich-list.info",chain:"main",category:"other"},"proptoexchange.com":{label:"ProPtoExchange",domain:"proptoexchange.com",chain:"main",category:"other"},"printscierge.com":{label:"Printscierge",domain:"printscierge.com",chain:"main",category:"other"},"opulencex.io":{label:"OpulenceX",domain:"opulencex.io",chain:"main",category:"other"},"onledger.net":{label:"OnLedger",domain:"onledger.net",chain:"main",category:"other"},"oclost.art":{label:"Oclost",domain:"oclost.art",chain:"main",category:"other"},"managednetwork.us":{label:"ManagedNetwork",domain:"managednetwork.us",chain:"main",category:"other"},"joshuahamsa.com":{label:"Joshua Hamsa",domain:"joshuahamsa.com",chain:"main",category:"other"},"grimmsxrpflow.jwscott.net":{label:"Grimm XRP Flow",domain:"grimmsxrpflow.jwscott.net",chain:"main",category:"other"},"getlol.xyz":{label:"GetLol",domain:"getlol.xyz",chain:"main",category:"other"},"gen3labs.xyz":{label:"Gen3 Labs",domain:"gen3labs.xyz",chain:"main",category:"other"},"garveyvalid.com":{label:"Garvey",domain:"garveyvalid.com",chain:"main",category:"other"},"easynpl.kr":{label:"EasyNPL",domain:"easynpl.kr",chain:"main",category:"other"},"diseb.ewi.tudelft.nl":{label:"TU Delft",domain:"diseb.ewi.tudelft.nl",chain:"main",category:"other"},"datamossa.com":{label:"DataMossa",domain:"datamossa.com",chain:"main",category:"other"},"crypto.unibe.ch":{label:"Univ. of Bern",domain:"crypto.unibe.ch",chain:"main",category:"other"},"commonprefix.com":{label:"Common Prefix",domain:"commonprefix.com",chain:"main",category:"other"},"catalyze-research.com":{label:"Catalyze Research",domain:"catalyze-research.com",chain:"main",category:"other"},"catalog.org":{label:"Catalog",domain:"catalog.org",chain:"main",category:"other"},"blockchain.korea.ac.kr":{label:"Korea Univ.",domain:"blockchain.korea.ac.kr",chain:"main",category:"other"},"astatiumprotocol.com":{label:"Astatium Protocol",domain:"astatiumprotocol.com",chain:"main",category:"other"},"ladykxrpl.mywire.org":{label:"LadyK XRPL",domain:"LadyKXRPL.mywire.org",chain:"main",category:"other"},"eelap-p1201-xrp.abudhabi.nyu.edu":{label:"NYU Abu Dhabi",domain:"EELAP-P1201-XRP.ABUDHABI.NYU.EDU",chain:"main",category:"other"},"589.clouds.hspeed.ch":{label:"HSpeed",domain:"589.clouds.hspeed.ch",chain:"main",category:"other"},"validator.pftperry.com":{label:"PFT Perry",domain:"validator.pftperry.com",chain:"test",category:"other"},"rip973.com":{label:"rip973",domain:"rip973.com",chain:"test",category:"other"},"preaware.org":{label:"Preaware",domain:"preaware.org",chain:"test",category:"other"},"postfiat.org":{label:"PostFiat",domain:"postfiat.org",chain:"test",category:"other"},"pftmeech.xyz":{label:"PFT Meech",domain:"pftmeech.xyz",chain:"test",category:"other"},"pft.xbtseal.com":{label:"PFT XBT Seal",domain:"pft.xbtseal.com",chain:"test",category:"other"},"pft.wizbubba.xyz":{label:"PFT Wizbubba",domain:"pft.wizbubba.xyz",chain:"test",category:"other"},"pft.permanentupperclass.com":{label:"PFT Perm Upper Class",domain:"pft.permanentupperclass.com",chain:"test",category:"other"},"pft.g.money":{label:"PFT G.Money",domain:"pft.g.money",chain:"test",category:"other"},"pft.akirax.xyz":{label:"PFT Akirax",domain:"pft.akirax.xyz",chain:"test",category:"other"},"jollydinger.com":{label:"Jollydinger",domain:"jollydinger.com",chain:"test",category:"other"},"auri0x.io":{label:"Auri0x",domain:"auri0x.io",chain:"test",category:"other"},"app.w.ai":{label:"W.ai",domain:"app.w.ai",chain:"test",category:"other"}},co={nHB8QMKGt9VB4Vg71VszjBVQnDW3v3QudM4436zXRZgiuUBBSWJe:{lat:37.77,lng:-122.42,city:"San Francisco",org:"Ripple"},nHUon2tpyJEHHYGmxqNd3h3oGNQwNyX8PNS3aHe3bNpCrNXZlHo:{lat:37.77,lng:-122.41,city:"San Francisco",org:"Ripple"},nHUpwrafS45zmi6eT72XS5ijpkW5JwfL5mLdPhEibrqUvtRcMAjU:{lat:37.78,lng:-122.4,city:"San Francisco",org:"Ripple"},nHUkp7WhouVMobBUKGrV5FNqjsdD9zKP5jpGnnLfQXCMNe4dkDqo:{lat:37.76,lng:-122.43,city:"San Francisco",org:"Ripple"},nHUryiyDqEtyWVtFG24AAhaYjMf9FRLietZGBWYwUTojmugMsx3o:{lat:37.79,lng:-122.38,city:"San Francisco",org:"Ripple"},nHUpcmNsxAw47yt2ADDoNoQrzLyTJPgnyq16u6Qx2kRPA17oUNHz:{lat:37.8,lng:-122.39,city:"San Francisco",org:"Ripple"},nHUnhRJK3csknycNK5SXRFi8jvDp3sKoWvS9wKWLq1ATBBGgPBjp:{lat:37.75,lng:-122.44,city:"San Francisco",org:"Ripple"},nHUq9tJvk5QTDkwurB7EzbzkZ2uuoHjS3GKjP6pZiU3DJGnobNYK:{lat:39.04,lng:-77.49,city:"Ashburn, VA",org:"AWS (Coil)"},nHUvcCcmoH1FJMMC6NtF9KKA4LpCWhjsxk2reCQidsp5AHQ7QY9H:{lat:49.45,lng:11.08,city:"Nuremberg",org:"Hetzner (Gatehub)"},nHDH7bQJpVfDhVSqdui3Z8GPvKEBQpo6AKHcnXe21zoD4nABA6xj:{lat:52.37,lng:4.9,city:"Amsterdam",org:"GCP (XRPL Labs)"},nHUED59jjpQ5QbNtesAbB6Es3uUPv3c9Ri5MNNgfMv5t5Lhb5ndW:{lat:19.43,lng:-99.13,city:"Mexico City",org:"AWS (Bitso)"},nHBidG3pZK11zqjeVos6hFxTDPGYuqfRFZ5gu9b7tQFdB8nPZujG:{lat:35.69,lng:139.69,city:"Tokyo",org:"NTT (Digital Garage)"},nHDB2PAPYqF86j9j3c6w1F1ZqwvQfiWcFShZ9Pokg9q4ohNDSkAz:{lat:47.61,lng:-122.33,city:"Seattle, WA",org:"Azure (Arrington)"},nHUdphn3LXa31w5sLd39MQdPEKQNrNYL3DQFByijVXiNQ3G6BYBZ:{lat:1.35,lng:103.82,city:"Singapore",org:"AWS (Tokenize)"},nHUFCyRCrUjvtZmKiLeF8ReopzKuSkVzdl1VsMCqm75aqyohLYEg:{lat:48.86,lng:2.35,city:"Paris",org:"OVH (XRPL Commons)"},nHULqGBkJtWeNFjhTzYeAsHA3qKKS7HoBh8CV3BAGTGMZuepEhWC:{lat:40.71,lng:-74.01,city:"New York",org:"Equinix (Blockchain LLC)"},nHBdXSF6YHAHSZUk7rvox6jwbvvyqBnsWGcewBtq8x1XuH6KXKXr:{lat:37.79,lng:-122.4,city:"San Francisco",org:"Cloudflare (XRP Scan)"}},Au={"xrpscan.com":{lat:51.51,lng:-.13,city:"London",org:"XRPScan"},"xrpl.aesthetes.art":{lat:52.37,lng:4.9,city:"Amsterdam",org:"Aesthetes"},"xrpkuwait.com":{lat:29.37,lng:47.98,city:"Kuwait City",org:"XRP Kuwait"},"xrpgoat.com":{lat:39.04,lng:-77.49,city:"Ashburn, VA",org:"XRP Goat"},"xrp.vet":{lat:48.86,lng:2.35,city:"Paris",org:"XRP Vet"},"xrp.unic.ac.cy":{lat:35.17,lng:33.37,city:"Nicosia",org:"Univ. of Nicosia"},"xrp-validator.interledger.org":{lat:40.71,lng:-74.01,city:"New York",org:"Interledger Foundation"},"xpmarket.com":{lat:52.37,lng:4.9,city:"Amsterdam",org:"XPMarket"},"verum.eminence.im":{lat:51.51,lng:-.13,city:"London",org:"Eminence"},"validator.xrpl.robertswarthout.com":{lat:52.37,lng:4.9,city:"Amsterdam",org:"R. Swarthout"},"validator.xrpl-labs.com":{lat:52.37,lng:4.9,city:"Amsterdam",org:"XRPL Labs"},"validator.xrpl.app":{lat:52.37,lng:4.9,city:"Amsterdam",org:"XRPL App"},"validator.poli.usp.br":{lat:-23.55,lng:-46.63,city:"S\xE3o Paulo",org:"USP"},"validator.gatehub.net":{lat:46.05,lng:14.51,city:"Ljubljana",org:"Gatehub"},"validator.aspired.nz":{lat:-36.86,lng:174.76,city:"Auckland",org:"Aspired NZ"},"v2.xrpl-commons.org":{lat:48.86,lng:2.35,city:"Paris",org:"XRPL Commons"},"tequ.dev":{lat:60.17,lng:24.94,city:"Helsinki",org:"Tequ"},"squidrouter.com":{lat:37.77,lng:-122.42,city:"San Francisco",org:"Squid Router"},"ripple.ittc.ku.edu":{lat:38.97,lng:-95.24,city:"Lawrence, KS",org:"Univ. of Kansas"},"ripple.com":{lat:37.77,lng:-122.42,city:"San Francisco",org:"Ripple"},"peersyst.cloud":{lat:41.39,lng:2.15,city:"Barcelona",org:"Peersyst"},"onxrp.com":{lat:51.51,lng:-.13,city:"London",org:"OnXRP"},"katczynski.net":{lat:52.23,lng:21.01,city:"Warsaw",org:"Katczynski"},"jon-nilsen.no":{lat:59.91,lng:10.75,city:"Oslo",org:"Jon Nilsen"},"ekiserrepe.es":{lat:40.42,lng:-3.7,city:"Madrid",org:"Ekiserrepe"},"cabbit.tech":{lat:51.51,lng:-.13,city:"London",org:"Cabbit"},"bithomp.com":{lat:59.33,lng:18.07,city:"Stockholm",org:"Bithomp"},"aureusox.com":{lat:40.71,lng:-74.01,city:"New York",org:"Aureus Ox"},"arrington-xrp-capital.blockdaemon.com":{lat:40.71,lng:-74.01,city:"New York",org:"Blockdaemon"},"anodos.finance":{lat:37.98,lng:23.73,city:"Athens",org:"Anodos Finance"},"bitso.com":{lat:19.43,lng:-99.13,city:"Mexico City",org:"Bitso"},"ripple.kenan-flagler.unc.edu":{lat:35.9,lng:-79.05,city:"Chapel Hill, NC",org:"UNC Kenan-Flagler"},"ripplevalidator.uwaterloo.ca":{lat:43.47,lng:-80.54,city:"Waterloo, ON",org:"Univ. of Waterloo"},"shadow.haas.berkeley.edu":{lat:37.87,lng:-122.26,city:"Berkeley, CA",org:"UC Berkeley Haas"},"www.bitrue.com":{lat:1.35,lng:103.82,city:"Singapore",org:"Bitrue"},"xrp-col.anu.edu.au":{lat:-35.28,lng:149.13,city:"Canberra",org:"ANU"},"xrpval.rawsec.de":{lat:51.17,lng:10.45,city:"Germany",org:"Rawsec"},"xrplvl.carbonvibe.com":{lat:51.51,lng:-.13,city:"London",org:"Carbon Vibe"},"xrplvalidator.alloy.ee":{lat:59.44,lng:24.75,city:"Tallinn",org:"Alloy"},"xrpl.uni.lu":{lat:49.61,lng:6.13,city:"Luxembourg",org:"Univ. of Luxembourg"},"xrpl.to":{lat:48.86,lng:2.35,city:"Paris",org:"XRPL.to"},"xrpl.su":{lat:55.75,lng:37.62,city:"Moscow",org:"XRPL.su"},"xrpl.sbivc.co.jp":{lat:35.69,lng:139.69,city:"Tokyo",org:"SBI VC Trade"},"xrpl-verification.flare.network":{lat:51.51,lng:-.13,city:"London",org:"Flare Network"},"xrpl-validator.7rev.dev":{lat:52.52,lng:13.4,city:"Berlin",org:"7Rev"},"xrp.teacopula.com":{lat:39.04,lng:-77.49,city:"Ashburn, VA",org:"Teacopula"},"xrp.moneymindedapes.com":{lat:39.04,lng:-77.49,city:"Ashburn, VA",org:"MoneyMindedApes"},"xrp.hazza-systems.de":{lat:52.52,lng:13.4,city:"Berlin",org:"Hazza Systems"},"xrp.cs.uoregon.edu":{lat:44.05,lng:-123.08,city:"Eugene, OR",org:"Univ. of Oregon"},"xrp.bpsqn.com":{lat:37.77,lng:-122.42,city:"San Francisco",org:"BPSQN"},"xrp-validator.grapedrop.xyz":{lat:52.37,lng:4.9,city:"Amsterdam",org:"Grapedrop"},"xaodao.io":{lat:1.35,lng:103.82,city:"Singapore",org:"XaoDAO"},"vl.xrpsalute.com":{lat:40.71,lng:-74.01,city:"New York",org:"XRP Salute"},"validator.ukcbt.org":{lat:51.51,lng:-.13,city:"London",org:"UKCBT"},"validator.sugarxrpl.com":{lat:37.77,lng:-122.42,city:"San Francisco",org:"SugarXRPL"},"validator.boscaern.digital":{lat:53.33,lng:-6.25,city:"Dublin",org:"Boscaern"},"trimaera.tech":{lat:48.86,lng:2.35,city:"Paris",org:"Trimaera"},"textrp.io":{lat:1.35,lng:103.82,city:"Singapore",org:"TextRP"},"tesbert.com":{lat:39.04,lng:-77.49,city:"Ashburn, VA",org:"Tesbert"},"tachyon-xrpl-validator.github.io":{lat:37.77,lng:-122.42,city:"San Francisco",org:"Tachyon"},"solonation.io":{lat:1.35,lng:103.82,city:"Singapore",org:"SoloNation"},"smokydrip.com":{lat:39.04,lng:-77.49,city:"Ashburn, VA",org:"SmokyDrip"},"rippled-validator.us":{lat:39.04,lng:-77.49,city:"Ashburn, VA",org:"rippled-validator.us"},"rippleat.snt.uni.lu":{lat:49.61,lng:6.13,city:"Luxembourg",org:"Univ. of Luxembourg"},"ripple.uni.lu":{lat:49.61,lng:6.13,city:"Luxembourg",org:"Univ. of Luxembourg"},"ripple.j2b.com":{lat:37.77,lng:-122.42,city:"San Francisco",org:"J2B"},"rich-list.info":{lat:51.51,lng:-.13,city:"London",org:"Rich List"},"proptoexchange.com":{lat:39.04,lng:-77.49,city:"Ashburn, VA",org:"ProPtoExchange"},"printscierge.com":{lat:39.04,lng:-77.49,city:"Ashburn, VA",org:"Printscierge"},"opulencex.io":{lat:1.35,lng:103.82,city:"Singapore",org:"OpulenceX"},"onledger.net":{lat:52.37,lng:4.9,city:"Amsterdam",org:"OnLedger"},"oclost.art":{lat:48.86,lng:2.35,city:"Paris",org:"Oclost"},"managednetwork.us":{lat:39.04,lng:-77.49,city:"Ashburn, VA",org:"ManagedNetwork"},"joshuahamsa.com":{lat:37.77,lng:-122.42,city:"San Francisco",org:"Joshua Hamsa"},"grimmsxrpflow.jwscott.net":{lat:39.04,lng:-77.49,city:"Ashburn, VA",org:"Grimm XRP Flow"},"getlol.xyz":{lat:39.04,lng:-77.49,city:"Ashburn, VA",org:"GetLol"},"gen3labs.xyz":{lat:37.77,lng:-122.42,city:"San Francisco",org:"Gen3 Labs"},"garveyvalid.com":{lat:40.71,lng:-74.01,city:"New York",org:"Garvey"},"easynpl.kr":{lat:37.57,lng:126.98,city:"Seoul",org:"EasyNPL"},"diseb.ewi.tudelft.nl":{lat:52,lng:4.36,city:"Delft",org:"TU Delft"},"datamossa.com":{lat:48.86,lng:2.35,city:"Paris",org:"DataMossa"},"crypto.unibe.ch":{lat:46.95,lng:7.45,city:"Bern",org:"Univ. of Bern"},"commonprefix.com":{lat:37.98,lng:23.73,city:"Athens",org:"Common Prefix"},"catalyze-research.com":{lat:51.51,lng:-.13,city:"London",org:"Catalyze Research"},"catalog.org":{lat:37.77,lng:-122.42,city:"San Francisco",org:"Catalog"},"blockchain.korea.ac.kr":{lat:37.57,lng:126.98,city:"Seoul",org:"Korea Univ."},"astatiumprotocol.com":{lat:1.35,lng:103.82,city:"Singapore",org:"Astatium Protocol"},"ladykxrpl.mywire.org":{lat:39.04,lng:-77.49,city:"Ashburn, VA",org:"LadyK XRPL"},"eelap-p1201-xrp.abudhabi.nyu.edu":{lat:24.47,lng:54.37,city:"Abu Dhabi",org:"NYU Abu Dhabi"},"589.clouds.hspeed.ch":{lat:47.38,lng:8.54,city:"Zurich",org:"HSpeed"},"www.payonline.financial":{lat:55.75,lng:37.62,city:"Moscow",org:"PayOnline"}};function pr(e){if(!e)return null;let t=e.toLowerCase().replace(/^www\./,"");return Au[t]??Au["www."+t]??null}var Qy=[{lat:37.34,lng:-121.89,label:"s1.ripple.com",city:"San Jose, CA",org:"Ripple"},{lat:37.34,lng:-121.87,label:"s2.ripple.com",city:"San Jose, CA",org:"Ripple"},{lat:52.37,lng:4.91,label:"xrplcluster.com",city:"Amsterdam",org:"Cluster"},{lat:52.36,lng:4.89,label:"xrpl.ws",city:"Amsterdam",org:"Cluster"}],Re={nunl:{hex:"#ff5555",glow:"rgba(255,85,85,.4)",label:"Negative UNL"},both:{hex:"#50fa7b",glow:"rgba(80,250,123,.4)",label:"UNL + dUNL"},unl:{hex:"#00fff0",glow:"rgba(0,255,240,.35)",label:"UNL"},dunl:{hex:"#bd93f9",glow:"rgba(189,147,249,.4)",label:"dUNL only"},other:{hex:"#ffb86c",glow:"rgba(255,184,108,.4)",label:"Other"},pub:{hex:"#50fa7b",glow:"rgba(80,250,123,.4)",label:"Public Node"}},sr="https://api.xrpscan.com/api/v1/validatorregistry",$e=new Map,wn={},ro=0,Wn=!1,xn="fallback";function Uu(){if(!Wn){$e.clear();for(let[e,t]of Object.entries(dr)){let n=t.domain??e,s=Wu("",n),a=pr(n)??null;$e.set(e,{key:e,label:t.label,domain:n,domainVerified:!1,provider:t.provider??(a==null?void 0:a.org)??null,lists:t.lists??[],category:s.isUnl?"unl":"other",chain:s.chain,unl:s.isUnl,dunl:!1,geo:a,meta:{},agreement:{"1h":null,"24h":null,"30d":null}})}xn="fallback",ur({ok:!1,source:"fallback",error:"using hardcoded data \u2014 mount /api/v1 router"})}}var ar=0,Zy=5*60*1e3;function Eu(e,t){var s,a;let n=Array.isArray(e)?e:e.validators??e.data??[];if(!n.length)throw new Error("Empty validators array");$e.clear();for(let o of n){let i=o.key??o.validation_public_key??o.master_key??o.signing_key??null;if(!i)continue;let r=o.domain??null,l=r?r.toLowerCase().replace(/^www\./,""):null,c=o.unl===!0||o.unl===1||o.unl==="true",d=Wu(i,l),u=c||d.isUnl,p=d.chain,m=u?"unl":"other",f=Object.values(dr).find(w=>w.domain&&w.domain.toLowerCase().replace(/^www\./,"")===l),v=(f==null?void 0:f.label)??o.label??o.account_name??o.name??l??null??`${i.slice(0,8)}\u2026${i.slice(-6)}`,b=co[i]??pr(l)??null,g=(((s=o.geo)==null?void 0:s.lat)!=null&&((a=o.geo)==null?void 0:a.lng)!=null?o.geo:null)??b;$e.set(i,{key:i,label:v,domain:r??null,domainVerified:!!(o.domainVerified??o.domain_verified),provider:o.provider??(g==null?void 0:g.org)??(f==null?void 0:f.provider)??null,lists:Array.isArray(o.lists)?o.lists:[],category:m,chain:p,unl:u,dunl:!1,geo:g,version:o.version??o.build_version??null,baseFee:o.base_fee_xrp??o.base_fee??null,ownerReserve:o.reserve_inc_xrp??o.owner_reserve??null,meta:o.meta??{},agreement:o.agreement??{"1h":Qi(o.agreement_1h??o.agr_1h),"24h":Qi(o.agreement_24h??o.agr_24h),"30d":Qi(o.agreement_30d??o.agr_30d)}})}wn=e.lists??{},ro=Date.now(),Wn=!0,xn=t,ar=0,ur({ok:!0,count:$e.size,lists:wn,source:t})}function Qi(e){if(!e)return null;let t=Number(e.total??e.ledgers??0),n=Number(e.missed??0),s=t-n,a=t>0?(s/t*100).toFixed(1):null;return{total:t,missed:n,hit:s,score:a?`${a}%`:null,scoreRaw:e.score??null}}async function io(e=!1){let t=Date.now();if(!e&&Wn&&t-ro<Ky)return!0;if(!e&&!Wn&&t-ar<Zy)return!1;let n=typeof sa=="string"&&sa.startsWith("/api/"),s=location.protocol==="file:"||location.hostname==="127.0.0.1"||location.hostname==="localhost";if(!(n&&s))try{let a=new AbortController,o=setTimeout(()=>a.abort(),Lu),i=await fetch(sa,{signal:a.signal,headers:{Accept:"application/json"}});if(clearTimeout(o),!i.ok)throw new Error(`HTTP ${i.status}`);let r=await i.json();return Eu(r,"proxy"),!0}catch(a){console.warn("[registry] tier 1 (proxy) failed:",a.message)}try{let a=new AbortController,o=setTimeout(()=>a.abort(),Lu),i=await fetch(sr,{signal:a.signal});if(clearTimeout(o),!i.ok)throw new Error(`HTTP ${i.status}`);let r=await i.text(),l=JSON.parse(r);return Eu(l,"xrpscan"),!0}catch(a){console.warn("[registry] tier 2 (xrpscan direct) failed:",a.message),(a.message.includes("Failed to fetch")||a.message.includes("CORS"))&&console.warn("[registry] CORS blocked \u2014 mount the backend proxy route (see validatorregistry.js)")}return console.warn("[registry] all sources failed \u2014 showing",Object.keys(dr).length,"hardcoded validators"),ar=Date.now(),Wn||Uu(),ur({ok:!1,source:"fallback",error:"all sources failed \u2014 mount /api/v1 router"}),!1}window.debugRegistry=async function(){console.group("\u{1F50D} Registry debug"),console.log("Current source:",xn),console.log("Validators loaded:",$e.size),console.log("Registry ok:",Wn),console.log("Last fetch:",ro?new Date(ro).toLocaleTimeString():"never"),console.log(""),console.log("Testing proxy \u2192",sa);try{let e=await fetch(sa),t=await e.text();console.log("  Status:",e.status,"\u2014 body preview:",t.slice(0,300))}catch(e){console.warn("  Failed:",e.message)}console.log(""),console.log("Testing XRPScan direct \u2192",sr);try{let e=await fetch(sr),t=await e.text();console.log("  Status:",e.status,"\u2014 body preview:",t.slice(0,300))}catch(e){console.warn("  Failed:",e.message)}return console.groupEnd(),{source:xn,size:$e.size,ok:Wn}};function st(e){return $e.get(e)??{key:e,label:`${e.slice(0,10)}\u2026${e.slice(-6)}`,domain:null,provider:null,lists:[],category:"other",geo:co[e]??null,meta:{}}}function kn(e){var n;if(!e)return null;if(((n=e.geo)==null?void 0:n.lat)!=null)return e.geo;let t=co[e.key];return t||pr(e.domain)}function qu(){return[...$e.values()].filter(e=>(e.category==="unl"||e.category==="both")&&e.chain!=="test").map(e=>e.key)}function e0(){return[...$e.values()].filter(e=>(e.category==="dunl"||e.category==="both")&&e.chain!=="test").map(e=>e.key)}function t0(){return[...$e.values()].filter(e=>e.category==="other"&&e.chain!=="test").map(e=>e.key)}function n0(){return[...$e.values()].filter(e=>e.chain==="test").map(e=>e.key)}function ur({ok:e,count:t,lists:n,source:s,error:a}){let o=x("m1-registry-badge");if(o)if(e){let i=[...$e.values()].filter(c=>c.category==="unl").length,r=[...$e.values()].filter(c=>c.chain==="test").length,l=t-r;o.textContent=`${l} mainnet \xB7 ${i} UNL \xB7 ${r} testnet \xB7 live`,o.className="registry-badge registry-badge--ok"}else o.textContent=s==="fallback"?`Fallback data \xB7 ${$e.size} known \xB7 ${a??"endpoint unreachable"}`:"Refreshing\u2026",o.className="registry-badge registry-badge--warn"}var lo=null,Nu=!1,Zi=!1,_u=0,Ru=0,Du=0,er=0,Vu=!0,Qe=null,jn=null,ia=null,Ht=null,Oe={},ao=null,or={},Ye=null,Qt=[],oo=null,ir={},ta="unl",pt={fees:[],burnDrops:[],dexOffers:[],ammSwaps:[],newAccounts:[],converge:[],proposers:[],peerCounts:[],peerDiscon:[]};function Gu(){var t,n;if(Nu)return;Nu=!0,M0(),Uu(),io(!0),C0(),P0(),window.addEventListener("xrpl-connected",()=>{na(),ks()&&(aa({force:!0}),oa({force:!1}))}),window.addEventListener("xrpl-disconnected",()=>{rr(),cr(null)}),window.addEventListener("xrpl-connection",s=>{var a;((a=s==null?void 0:s.detail)==null?void 0:a.state)==="connecting"&&(rr(),cr(null,"Switching networks\u2026"))}),window.addEventListener("xrpl-ledger",s=>{$0(s.detail),ks()&&S0(s.detail)}),(t=x("btn-network-refresh"))==null||t.addEventListener("click",()=>{aa({force:!0}),io(!0),oa({force:!0})}),(n=document.querySelector('.dash-tab[data-tab="network"]'))==null||n.addEventListener("click",()=>{na(),aa({force:!0}),io(!1),oa({force:!1})});let e=x("tab-network");e&&new MutationObserver(na).observe(e,{attributes:!0,attributeFilter:["style","class"]}),document.addEventListener("visibilitychange",na)}function ks(){let e=x("tab-network"),t=e?e.style.display!=="none":!1;return Vu&&X.currentPage==="dashboard"&&X.currentTab==="network"&&t&&!document.hidden}function na(){ks()?s0():rr()}function Ku(e){Vu=!!e,na()}function s0(){lo||(aa({force:!1}),lo=setInterval(()=>{ks()&&aa({force:!1})},Hy))}function rr(){clearInterval(lo),lo=null}async function aa({force:e=!1}={}){var n;if(!ks()&&!e)return;let t=Date.now();if(!(!e&&(t-_u<zy||Zi||t<Ru))){Zi=!0,_u=t,Oe={},Iu(!0);try{await Promise.allSettled([io(!1),a0(),o0(),i0(),r0(),l0()]),c0(),m0(),f0(),h0(),x0(),cr({info:Qe,fee:jn,vals:ia}),A0()}catch(s){String((s==null?void 0:s.message)??"").toLowerCase().includes("too much load")&&(Ru=Date.now()+jy,(n=ge)==null||n("Rate-limited \u2014 backing off 2 min."))}finally{Iu(!1),Zi=!1}}}function Iu(e){var t;(t=x("btn-network-refresh"))==null||t.classList.toggle("spinning",e)}async function a0(){var n,s,a;let e=await Me({command:"server_info"});if(Qe=((n=e==null?void 0:e.result)==null?void 0:n.info)??null,!Qe)return;nt("converge",Number(((s=Qe.last_close)==null?void 0:s.converge_time_s)??0)),nt("proposers",Number(((a=Qe.last_close)==null?void 0:a.proposers)??0)),nt("peerCounts",Number(Qe.peers??0));let t=Number(Qe.peer_disconnects_resources??0);ao!==null&&t>ao&&nt("peerDiscon",t-ao),ao=t}async function o0(){var t;let e=await Me({command:"fee"});jn=(e==null?void 0:e.result)??null,((t=jn==null?void 0:jn.drops)==null?void 0:t.open_ledger_fee)!=null&&nt("fees",Number(jn.drops.open_ledger_fee))}async function i0(){try{let e=await Me({command:"validators"});ia=(e==null?void 0:e.result)??null}catch{ia=null}}async function r0(){var e;try{let t=await Me({command:"peers"});Ht=Array.isArray((e=t==null?void 0:t.result)==null?void 0:e.peers)?t.result.peers:null}catch{Ht=null}}async function l0(){var e;try{let t=await Me({command:"feature"});(e=t==null?void 0:t.result)!=null&&e.features&&(g0(t.result.features),Yu(t.result.features))}catch{}}function c0(){var M,N,_,O,I,D;let e=Qe,t=ia,n=(t==null?void 0:t.trusted_validator_keys)??[],s=qu(),a=e0(),o=n.length?n:s,i=a,r=Number((t==null?void 0:t.validation_quorum)??(e==null?void 0:e.validation_quorum)??0),l=o.length,c=l-r,d=l>0?r/l*100:0,u=o.filter(F=>$e.has(F)).length,p=l>0?Math.round(u/l*100):0,m=Number(((M=e==null?void 0:e.last_close)==null?void 0:M.converge_time_s)??0),f=Number(((N=e==null?void 0:e.last_close)==null?void 0:N.proposers)??0),v=r>0?Math.round(f/r*100):0,b=Array.isArray(e==null?void 0:e.negative_unl)?e.negative_unl:[],h=!!ia;c>=0&&c<=3&&(Oe.quorumTight=!0),b.length>0&&(Oe.nUnlActive=!0),m>6&&(Oe.slowConverge=!0),f>0&&r>0&&f<r&&(Oe.lowProposers=!0),J("m1-active",h?l:"\u2014"),J("m1-quorum",r>0?r:"\u2014"),J("m1-margin",h?c>=0?c:`\u2212${Math.abs(c)}`:"\u2014"),J("m1-overlap",h?`${p}%`:"\u2014"),J("m1-known",h?`${u} / ${l} identified`:"\u2014 (validators cmd unavailable)"),J("m1-proposers",((_=e==null?void 0:e.last_close)==null?void 0:_.proposers)!=null?f:"\u2014"),J("m1-particip",r>0&&((O=e==null?void 0:e.last_close)==null?void 0:O.proposers)!=null?`${v}%`:"\u2014"),J("m1-converge",((I=e==null?void 0:e.last_close)==null?void 0:I.converge_time_s)!=null?`${m.toFixed(2)}s`:"\u2014"),J("m1-converge-avg",ra("converge")>0?`avg ${ra("converge").toFixed(2)}s`:"\u2014"),$t("m1-qbar",d,d>90?"bar-danger":d>80?"bar-warn":"bar-ok"),$t("m1-obar",p,p<40?"bar-danger":p<70?"bar-warn":"bar-ok"),$t("m1-pbar",v,v<80?"bar-danger":v<95?"bar-warn":"bar-ok"),$t("m1-cvgbar",Math.min(100,m/10*100),m>6?"bar-danger":m>4?"bar-warn":"bar-ok"),u0({active:l,quorum:r,margin:c,nUnl:b,valsAvail:h});let g=(D=t==null?void 0:t.publisher_lists)==null?void 0:D[0],w=(wn==null?void 0:wn.ripple)??(wn==null?void 0:wn.xrplf)??null,k=(g==null?void 0:g.uri)??(w==null?void 0:w.uri)??"\u2014",$=(g==null?void 0:g.seq)??(w==null?void 0:w.seq)??"\u2014";if(J("m1-vl-uri",k),J("m1-vl-seq",$),g!=null&&g.expiration||w!=null&&w.expiration){let F=x("m1-vl-expiry");if(F){let H=(g==null?void 0:g.expiration)??(w==null?void 0:w.expiration),A=Math.floor((new Date(H)-Date.now())/864e5);F.textContent=A>0?`Expires ${A}d`:"\u26A0 EXPIRED",F.className=`expiry-pill ${A>30?"pill-ok":A>7?"pill-warn":"pill-bad"}`,F.style.display=""}}let T=x("m1-nunl-list");if(J("m1-nunl-count",b.length||"0"),T)if(!b.length)T.innerHTML='<div class="nunl-empty">\u2713 No validators on Negative UNL</div>';else{let F={};T.innerHTML=b.map(A=>{let z=st(A);return z.provider&&(F[z.provider]=(F[z.provider]||0)+1),`<div class="nunl-entry">
      ...
      <div class="vptext">
        <span class="vplabel">${y(Se??F.label??B)}</span>
    ...
    </div>`}let O="";M.forEach(I=>{if(!I.keys.length)return;let D=I.keys.some(z=>i.has(z)),F=I.keys.map((z,te)=>_(z,D?te:null)).join(""),H=`vgs-${Math.random().toString(36).slice(2,8)}`,A=!I.collapsed;O+=`
      <div class="vg-section ${I.cls??""}">
        ...
        ">
          <span class="vg-chevron">${A?"\u25BC":"\u25B6"}</span>
          <span class="vg-sec-title">${y(I.title)}</span>
        </button>
        <div id="${H}" class="vg-section-body" style="display:${A?"":"none"}">
          ${F}
        </div>
      </div>`}),O||(O='<div class="nunl-empty">No validators in this view.</div>'),o.innerHTML=P+O,J("m1-val-summary",N),o.querySelectorAll(".vg-tab").forEach(I=>{I.addEventListener("click",D=>{D.stopPropagation();let F=I.getAttribute("data-vgtab");F&&(ta=F,Ju(e,t,n,s,a))})})}async function d0(e){let t=tr.get(e);if(t&&Date.now()-t.cachedAt<Hu)return t.data;try{let n=new AbortController,s=setTimeout(()=>n.abort(),zu),a=await fetch(`${Bu}/${encodeURIComponent(e)}`,{signal:n.signal});if(clearTimeout(s),!a.ok)throw new Error(`HTTP ${a.status}`);let o=await a.json();return tr.set(e,{data:o,cachedAt:Date.now()}),o}catch{return null}}async function p0(e){let t=nr.get(e);if(t&&Date.now()-t.cachedAt<Hu)return t.data;try{let n=new AbortController,s=setTimeout(()=>n.abort(),zu),a=await fetch(`${Bu}/${encodeURIComponent(e)}/reports`,{signal:n.signal});if(clearTimeout(s),!a.ok)throw new Error(`HTTP ${a.status}`);let o=await a.json(),i=o.reports??o??[];return nr.set(e,{data:i,cachedAt:Date.now()}),i}catch{return[]}}window.focusValidator=async function(e){let t=st(e),n=kn(t);document.querySelectorAll(".vpill").forEach(o=>o.classList.remove("vp-active"));let s=document.querySelector(`.vpill[data-key="${CSS.escape(e)}"]`);if(s&&(s.classList.add("vp-active"),s.scrollIntoView({behavior:"smooth",block:"nearest"})),lr(e,t,null),d0(e).then(o=>{o&&lr(e,t,o)}),!n){let o=x("world-map-container");if(o){let i=o.querySelector(".wm-no-geo");i&&i.remove();let r=document.createElement("div");r.className="wm-no-geo",r.textContent=`\u{1F4CD} ${t.label} \u2014 geographic location unknown`,o.appendChild(r),setTimeout(()=>r.remove(),3500)}return}let a=x("world-map-container");a&&a.scrollIntoView({behavior:"smooth",block:"nearest"}),Ye&&(Ye.flyTo([n.lat,n.lng],6,{duration:1.2}),setTimeout(()=>{let o=ir[e];o&&o.openPopup()},1300))};function lr(e,t,n){var M,N,_,O,I;let s=x("amend-modal-overlay"),a=x("amend-modal-body");if(!s||!a)return;let o=n??{},i=t.label??o.label??o.account_name??e.slice(0,16)+"\u2026",r=t.domain??o.domain??null,l=t.chain??o.chain??"main",c=t.category??"other",d=Re[c]??Re.other,u=kn(t),p=t.unl||c==="unl"||c==="both",m=t.dunl||c==="dunl"||c==="both",f=t.domainVerified||o.domain_verified?"\u2713 Verified":r?"Unverified":"\u2014",v=t.agreement??o.agreement??{},b=!n&&!((M=t.agreement)!=null&&M["24h"]);function h(D,F){if(!F||!F.total)return`<div class="adm-mi"><span class="adm-mk">${D}</span><span class="adm-mv" style="opacity:.5">\u2014</span></div>`;let H=parseFloat(F.score)||0,A=H>=99?"color:#50fa7b":H>=95?"color:#ffb86c":"color:#ff5555";return`<div class="adm-mi">
      <span class="adm-mk">${D}</span>
      <span class="adm-mv mono" style="${A}">${F.score??"\u2014"}
        <span style="opacity:.55;font-size:10px;font-weight:400"> \xB7 ${F.missed??0} missed / ${F.total??0}</span>
      </span>
    </div>`}function g(D,F,H=!1){return!F&&F!==0?"":`<div class="adm-mi"><span class="adm-mk">${D}</span><span class="adm-mv ${H?"mono":""}">${y(String(F))}</span></div>`}let w=nr.get(e),k=((N=w==null?void 0:w.data)==null?void 0:N.slice(-14))??[],$=k.length?`<div class="adm-section">
        ...
        <div style="display:flex;gap:2px;align-items:flex-end;height:32px;margin-top:6px;">
          ${k.map(D=>{let F=Number(D.missed??D.miss??0),H=Number(D.total??D.ledgers??1),A=H>0?(H-F)/H*100:100,z=Math.round(4+A/100*28),te=A>=99?"#50fa7b":A>=95?"#ffb86c":"#ff5555";return`<div title="${D.date??""} \xB7 ${A.toFixed(1)}% (${F} missed)" style="flex:1;height:${z}px;background:${te};border-radius:2px 2px 0 0;opacity:.85;transition:opacity .15s" onmouseover="this.style.opacity=1" onmouseout="this.style.opacity=.85"></div>`}).join("")}
        </div>
    ...
    </div>`,s.style.display="flex",s.addEventListener("click",D=>{D.target===s&&window.closeAmendModal()},{once:!0})}window._loadValidatorReports=async function(e){var n;let t=st(e);await p0(e),lr(e,t,((n=tr.get(e))==null?void 0:n.data)??null)};function u0({active:e,quorum:t,margin:n,nUnl:s,valsAvail:a}){let o=x("m1-quorum-ring");if(!o)return;if(!a||!t||!e){o.innerHTML='<div style="opacity:.4;font-size:12px;text-align:center;padding:16px">Connect to view quorum</div>';return}let i=44,r=2*Math.PI*i,l=new Set(s),c=e-s.length,d=s.length,u=Math.max(0,e-t),p=t,m=n<=0?"#ff5555":n<=3?"#ffb86c":"#50fa7b",f=e>0?c/e:0,v=e>0?d/e:0,b=e>0?t/e:0,h=e>0?Math.max(0,n)/e:0,g=e>0?d/e:0;function w(k,$,T,S=8){if($<=0)return"";let P=k*r,M=$*r;return`<circle r="${i}" cx="50" cy="50" fill="none"
    ...
    <div class="qr-wrap">
    ...
    </div>`}function m0(){var F,H,A;let e=Qe,t=(e==null?void 0:e.server_state)??"unknown",n=(e==null?void 0:e.build_version)??"\u2014",s=Number((e==null?void 0:e.uptime)??0),a=e==null?void 0:e.network_id,o=Number((e==null?void 0:e.io_latency_ms)??0),i=String((e==null?void 0:e.jq_trans_overflow)??"0"),r=Number((e==null?void 0:e.peer_disconnects_resources)??0),l=Number((e==null?void 0:e.load_factor)??1),c=Number((e==null?void 0:e.load_factor_net)??1),d=Number((e==null?void 0:e.load_factor_server)??(e==null?void 0:e.load_factor_local)??1),u=Number(((F=e==null?void 0:e.validated_ledger)==null?void 0:F.age)??0),p=(H=e==null?void 0:e.validated_ledger)==null?void 0:H.seq,m=(e==null?void 0:e.complete_ledgers)??"",f=(e==null?void 0:e.state_accounting)??null;u>10&&(Oe.staleLedger=!0),o>5&&(Oe.ioStressed=!0),ra("peerDiscon")>5&&(Oe.peerChurn=!0);let v=x("m2-state");if(v){v.textContent=t;let z=["full","proposing","validating"].includes(t),te=["syncing","tracking","connected"].includes(t);v.className=`state-pill state-${z?"ok":te?"warn":"bad"}`}J("m2-version",n),J("m2-uptime",N0(s)),J("m2-netid",a===0?"0 (Mainnet)":a===1?"1 (Testnet)":a??"\u2014"),J("m2-ledger-seq",p!=null?Number(p).toLocaleString():"\u2014"),J("m2-ledger-age",u>0?`${u}s`:"< 1s"),J("m2-io-ms",o>0?`${o}ms`:"< 1ms"),J("m2-jq",i==="0"?"0 (clean)":`\u26A0 ${i}`),J("m2-discon",r.toLocaleString());let b=x("m2-ledger-age");b&&(b.className=`kv-v ${u>10?"text-danger":u>5?"text-warn":""}`);let h=Math.min(100,(l-1)/49*100);$t("m2-load-bar",h,l>5?"bar-danger":l>2?"bar-warn":"bar-ok"),J("m2-load-total",`${l.toFixed(2)}\xD7`),J("m2-load-net",`${c.toFixed(2)}\xD7`),J("m2-load-local",`${d.toFixed(2)}\xD7`);let g=d>c*1.5?"Local node stressed":c>d*1.5?"Network-wide stress":l>1.2?"Distributed":"Normal";J("m2-load-src",g);let w=X.tpsHistory.length?X.tpsHistory[X.tpsHistory.length-1]:null;J("m2-tps",w!=null?w.toFixed(1):"\u2014"),J("m2-txcount",((A=X.ledgerLog[0])==null?void 0:A.txCount)??"\u2014");let k=m==="entire ledger"||m.startsWith("32570"),$=k?100:E0(m);if(J("m2-ledger-range",m||"\u2014"),J("m2-hist-type",k?"Full History Node":"Pruned / Partial"),J("m2-hist-score",`${$}%`),$t("m2-hist-bar",$,$<30?"bar-danger":$<70?"bar-warn":"bar-ok"),f){let z=x("m2-state-acct");if(z){let te=["full","syncing","tracking","connected","disconnected"],oe=0,pe={};te.forEach(ie=>{var ne;pe[ie]=Number(((ne=f[ie])==null?void 0:ne.duration_us)??0),oe+=pe[ie]}),z.innerHTML=oe>0?te.map(ie=>{let ne=Math.round(pe[ie]/oe*100);return ne?`<div class="sa-row"><span class="sa-lbl">${ie}</span>
          <div class="bar-track sa-bar"><div class="bar-fill ${ie==="full"?"bar-ok":ie==="syncing"?"bar-warn":"bar-danger"}" style="width:${ne}%"></div></div>
          <span class="sa-pct">${ne}%</span></div>`:""}).join(""):'<span class="dim">No data</span>'}}let T=(e==null?void 0:e.peers)!=null?Number(e.peers):null,S=T!=null,P=0,M=0,N=!1;Ht&&(Ht.forEach(z=>{z.inbound===!0?P++:M++}),N=!0);let _=N&&P+M>0?Math.round(P/(P+M)*100):0,O=N?Ht.length:T??0,I=O<6?"HIGH":O<15?"MEDIUM":"LOW";O<6&&(Oe.eclipseRisk=!0),_>80&&(Oe.peerSaturate=!0),J("m2-peers",S?O:"\u2014"),J("m2-inbound",N?P:S?"\u2014 (cmd restricted)":"\u2014"),J("m2-outbound",N?M:S?"\u2014 (cmd restricted)":"\u2014"),J("m2-ib-pct",N?`${_}%`:"\u2014"),$t("m2-peer-bar",Math.min(100,O/21*100),O>18?"bar-danger":O>15?"bar-warn":"bar-ok"),$t("m2-ib-bar",_,_>80?"bar-danger":_>60?"bar-warn":"bar-ok");let D=x("m2-eclipse");D&&(D.textContent=I,D.className=`risk-badge risk-${I.toLowerCase()}`)}function f0(){var M,N,_,O;let e=jn,t=Number(((M=e==null?void 0:e.drops)==null?void 0:M.minimum_fee)??10),n=Number(((N=e==null?void 0:e.drops)==null?void 0:N.open_ledger_fee)??10),s=Number(((_=e==null?void 0:e.drops)==null?void 0:_.median_fee)??10),a=Number(((O=e==null?void 0:e.drops)==null?void 0:O.base_fee)??10),o=Number((e==null?void 0:e.current_ledger_size)??0),i=Number((e==null?void 0:e.expected_ledger_size)??1),r=Number((e==null?void 0:e.current_queue_size)??0),l=Number((e==null?void 0:e.max_queue_size)??1),c=l>0?Math.round(r/l*100):0,d=i>0?o/i:1,u=ra("fees"),p=u>0?Math.round((n-u)/u*100):0,m=Math.min(100,Math.round(Math.log2(Math.max(1,n/10))*14));n>t*10&&(Oe.feeSpike=!0),c>80&&(Oe.queuePressure=!0),d>2&&(Oe.spamLedger=!0);let f=pt.burnDrops.slice(-10),v=f.length?f.reduce((I,D)=>I+D,0)/f.length:0,b=L0(pt.burnDrops),h=ra("burnDrops"),g=b>0&&pt.burnDrops.length>5?((v-h)/b).toFixed(2):"0.00",w=Math.min(100,Math.abs(Number(g))*20);Math.abs(Number(g))>3&&(Oe.burnAnomaly=!0);let k=n>5e3?"Severe":n>500?"High":n>100?"Elevated":n>20?"Normal":"Minimal",T={Severe:"#ff5555",High:"#ff9955",Elevated:"#ffb86c",Normal:"#50fa7b",Minimal:"#6272a4"}[k]??"#50fa7b",S=x("m3-pressure");S&&(S.textContent=k,S.className=`pressure-badge p-${k.toLowerCase()}`),J("m3-open",`${n} drops`),J("m3-med",`${s} drops`),J("m3-base",`${a} drops`),J("m3-devpct",`${p>0?"+":""}${p}% vs baseline`),J("m3-spam",`${m} / 100`),J("m3-qsize",`${r} / ${l}`),J("m3-qpct",`${c}%`),J("m3-szratio",`${d.toFixed(2)}\xD7`),J("m3-curledger",`${o} txs`),J("m3-expledger",`${i} expected`),J("m3-burn",v>0?`${(v/1e6).toFixed(4)} XRP / ledger`:"\u2014"),J("m3-burnz",`z = ${g}`),$t("m3-spam-bar",m,m>70?"bar-danger":m>40?"bar-warn":"bar-ok"),$t("m3-q-bar",c,c>80?"bar-danger":c>50?"bar-warn":"bar-ok"),$t("m3-sz-bar",Math.min(100,d*50),d>2?"bar-danger":d>1.5?"bar-warn":"bar-ok"),$t("m3-burn-bar",w,w>60?"bar-danger":w>30?"bar-warn":"bar-ok");let P=x("m3-congestion-summary");if(P){let I=[];d>2&&I.push({icon:"\u{1F6A8}",txt:`Ledger ${d.toFixed(1)}\xD7 normal size \u2014 possible spam burst`,col:"#ff5555"}),c>80&&I.push({icon:"\u26A0",txt:`TX queue ${c}% full \u2014 fee surge imminent`,col:"#ffb86c"}),m>70&&I.push({icon:"\u26A0",txt:`Spam index ${m}/100 \u2014 elevated DDoS risk`,col:"#ffb86c"}),Math.abs(Number(g))>3&&I.push({icon:"\u{1F4C9}",txt:`Burn rate z=${g} \u2014 resource exhaustion pattern`,col:"#ff9955"}),p>200&&I.push({icon:"\u{1F4B8}",txt:`Open fee ${p}% above baseline \u2014 network stress`,col:"#ffb86c"}),P.innerHTML=I.length?I.map(D=>`<div class="cong-line"><span>${D.icon}</span><span style="color:${D.col}">${y(D.txt)}</span></div>`).join(""):'<div class="cong-clear"><span style="color:#50fa7b">\u2713</span> No congestion signals \u2014 network traffic is normal</div>'}}function h0(){var u,p;let e={},t=0;for(let m of $e.values()){if(m.chain==="test")continue;let f=m.version??"unknown";e[f]=(e[f]??0)+1,t++}let n={},s=0;if(Array.isArray(Ht))for(let m of Ht){let f=(m.version??"unknown").replace(/rippled-/i,"").split(" ")[0];n[f]=(n[f]??0)+1,s++}let a=x("m4-version-dist");if(a&&t>0){let m=Object.entries(e).sort((h,g)=>g[1]-h[1]),f=((u=m[0])==null?void 0:u[0])??"?",v=t>0?Math.round((((p=m[0])==null?void 0:p[1])??0)/t*100):0,b=["#00fff0","#50fa7b","#ffb86c","#bd93f9","#ff5555","#8be9fd"];a.innerHTML=m.slice(0,6).map(([h,g],w)=>{let k=Math.round(g/t*100),$=b[w%b.length],T=h.includes("beta")||h.includes("rc")||h.includes("RC");return`<div class="vd-row">
      ...
      ${l.length?`<div class="ap-near-bar">\u{1F4C8} ${l.length} amendment${l.length>1?"s":""} approaching 80% threshold</div>`:""}`,n.querySelectorAll(".ap-tab").forEach(u=>{u.onclick=()=>{ws=u.dataset.aptab,Yu(e)}})}let c=ws==="active"?a:ws==="vetoed"?i:ws==="all"?s.sort((d,u)=>d.enabled!==u.enabled?d.enabled?1:-1:d.vetoed!==u.vetoed?d.vetoed?1:-1:(u.count??0)-(d.count??0)):o;if(!c.length){t.innerHTML=`<div class="amend-empty">${ws==="vetoed"?"No vetoed amendments":"No data"}</div>`;return}t.innerHTML=c.map(d=>{var S;let u=d.count??0,p=d.threshold??28,m=Math.min(100,Math.round(u/p*100)),f=d.name??`${d.hash.slice(0,10)}...`,v=!!d.enabled,b=!!d.vetoed,h=!!d.majority,g=ju[f]??{},w=(S=pt.amendMomentum)==null?void 0:S[d.hash],k="";if(h&&!v&&d.majority){let P=Date.now()-new Date(d.majority).getTime(),M=P>0?Math.floor(P/864e5):0,N=Math.max(0,14-M),_=Math.min(100,Math.round(M/14*100));k=`<div class="ap-countdown">
    ...
    </div>`}).join("")}function g0(e){or={},Object.entries(e).forEach(([t,n])=>{or[t]={hash:t,...n}})}window.showAmendDetail=function(e){let t=or[e];if(!t)return;let n=t.name||`${e.slice(0,16)}...`,s=ju[n]||{},a=t.count??0,o=t.threshold??28,i=Math.min(100,Math.round(a/o*100)),r=t.enabled?"Active on Ledger":t.vetoed?"Vetoed":t.majority?"Majority Reached":"Voting in Progress",l=t.enabled?"adm-s-ok":t.vetoed?"adm-s-bad":t.majority?"adm-s-warn":"adm-s-info",c=t.enabled?"bar-ok":t.vetoed?"bar-danger":t.majority?"bar-warn":"bar-info",d=t.majority&&!t.enabled?`
    ...
    </div>`,u.style.display="flex",u.addEventListener("click",m=>{m.target===u&&window.closeAmendModal()},{once:!0}))};window.closeAmendModal=function(){let e=x("amend-modal-overlay");e&&(e.style.display="none")};function v0(e){if(window.L){e();return}if(!document.querySelector("#leaflet-css")){let n=document.createElement("link");n.id="leaflet-css",n.rel="stylesheet",n.href="https://cdnjs.cloudflare.com/ajax/libs/leaflet/1.9.4/leaflet.min.css",document.head.appendChild(n)}let t=document.createElement("script");t.src="https://cdnjs.cloudflare.com/ajax/libs/leaflet/1.9.4/leaflet.min.js",t.onload=e,document.head.appendChild(t)}function b0(e,t,n,s,a=!1){x("world-map-container")&&v0(()=>y0(e,t,n,s,a))}function y0(e,t,n,s,a=!1){let o=x("world-map-container");if(!o)return;let i=new Set(n||[]),r=new Set(e||[]),l=new Set(t||[]),c=X.currentNetwork||"xrpl-mainnet";if(Ye&&oo!==c&&(Ye.remove(),Ye=null,Qt=[],oo=null),!Ye){o.innerHTML="";let k=document.createElement("div");k.id="wm-leaflet",k.style.cssText="width:100%;height:440px;",o.appendChild(k),Ye=L.map("wm-leaflet",{center:[25,5],zoom:2,minZoom:1,maxZoom:12,zoomControl:!0,attributionControl:!0,worldCopyJump:!0}),L.tileLayer("https://{s}.basemaps.cartocdn.com/dark_all/{z}/{x}/{y}{r}.png",{attribution:'&copy; <a href="https://carto.com">CARTO</a> &copy; <a href="https://openstreetmap.org">OSM</a>',subdomains:"abcd",maxZoom:19}).addTo(Ye),oo=c}Qt.forEach(k=>{try{k.remove()}catch{}}),Qt=[];function d(k){return i.has(k)?"nunl":r.has(k)&&l.has(k)?"both":r.has(k)?"unl":l.has(k)?"dunl":"other"}ir={};let u={};for(let[k,$]of $e){let T=kn($);if(!(T!=null&&T.lat)||!(T!=null&&T.lng))continue;let S=`${(Math.round(T.lat*2)/2).toFixed(1)},${(Math.round(T.lng*2)/2).toFixed(1)}`;u[S]||(u[S]={lat:T.lat,lng:T.lng,keys:[],city:T.city,org:T.org}),u[S].keys.push(k)}if(Object.values(u).forEach(k=>{let $=k.keys.length,T=k.keys.map(d),S=["nunl","both","unl","dunl","other"].find(O=>T.includes(O))||"other",P=Re[S],M=$>5?13:$>2?10:7,N=L.divIcon({html:`<div class="wm-lmarker wm-lmarker-val ${S==="nunl"?"wm-lmarker-nunl":""} ${a?"wm-lmarker-ref":""}"
                  style="--mc:${P.hex};--mg:${P.glow};"
                  title="${k.keys.map(O=>st(O).label).join(", ")}">
        <div class="wm-lring"></div>
        <div class="wm-ldot" style="width:${M*2}px;height:${M*2}px;">${$>1?`<span>${$}</span>`:""}</div>
      </div>`,className:"",iconSize:[(M+8)*2,(M+8)*2],iconAnchor:[M+8,M+8]}),_=L.marker([k.lat,k.lng],{icon:N}).bindPopup(w0(k.keys,k.city,k.org,i,r,l,a),{maxWidth:380,className:"wm-popup-wrap"}).addTo(Ye);k.keys.forEach(O=>{ir[O]=_}),Qt.push(_)}),a){let k=L.control({position:"bottomleft"});k.onAdd=()=>{let $=L.DomUtil.create("div","wm-ref-banner");return $.innerHTML="\u{1F4E1} Reference positions \xB7 live validator list unavailable from endpoint",$},k.addTo(Ye),Qt.push(k)}let p=[...$e.keys()].filter(k=>{var T;return((T=$e.get(k).geo)==null?void 0:T.lat)!=null||co[k]}).length,m=$e.size-p;if(m>0){let k=L.control({position:"bottomright"});k.onAdd=()=>{let $=L.DomUtil.create("div","wm-unknown-ctrl");return $.innerHTML=`+ ${m} validators \xB7 location unknown`,$},k.addTo(Ye),Qt.push(k)}Qy.forEach(k=>{let $=L.divIcon({html:`<div class="wm-lmarker wm-lmarker-pub">
        <div class="wm-lring"></div>
    ...
    </div>`}).join(""),c=[...new Set(e.map(d=>{var p;let u=st(d);return u.provider??((p=kn(u))==null?void 0:p.org)??null}).filter(Boolean))];return`<div class="wm-popup-inner">
    ...
    </div>`}).join("")}function $0(e){var t,n,s,a,o,i,r,l,c,d;e&&(nt("burnDrops",(e.avgFee||0)*1e6*(e.txPerLedger??0)),nt("dexOffers",((t=e.txTypes)==null?void 0:t.OfferCreate)??0),nt("ammSwaps",(((n=e.txTypes)==null?void 0:n.AMMDeposit)??0)+(((s=e.txTypes)==null?void 0:s.AMMWithdraw)??0)+(((a=e.txTypes)==null?void 0:a.AMMBid)??0)),nt("newAccounts",((o=e.txTypes)==null?void 0:o.AccountSet)??0),nt("txPayment",((i=e.txTypes)==null?void 0:i.Payment)??0),nt("txNFT",(((r=e.txTypes)==null?void 0:r.NFTokenMint)??0)+(((l=e.txTypes)==null?void 0:l.NFTokenBurn)??0)+(((c=e.txTypes)==null?void 0:c.NFTokenCreateOffer)??0)+(((d=e.txTypes)==null?void 0:d.NFTokenAcceptOffer)??0)),nt("txLedger",e.txPerLedger??0),nt("tps",e.tps??(e.txPerLedger??0)/3.5),nt("closeTime",e.closeTime??3.5))}function S0(e){let t=X.tpsHistory.length?X.tpsHistory[X.tpsHistory.length-1]:null;J("m2-tps",t!=null?t.toFixed(1):"\u2014"),J("m2-txcount",e.txPerLedger??"\u2014"),e.successRate!=null&&J("m2-success",`${e.successRate.toFixed(0)}%`)}async function oa({force:e=!1}={}){if(!ks()&&!e)return;let t=Date.now();if(!e&&t-Du<Uy)return;Du=t;let n=x("latency-list");if(!n)return;let s=Mr[X.currentNetwork]??[],a=++er;n.innerHTML=s.map((i,r)=>`
  ...
  `,document.body.appendChild(e),e.addEventListener("click",t=>{t.target===e&&la()}),document.addEventListener("keydown",t=>{t.key==="Escape"&&e.classList.contains("show")&&la()})}function X0(e){let t=R0[e];if(!t)return;O0();let n=document.getElementById("learnModalOverlay"),s=document.getElementById("learnModalTitle"),a=document.getElementById("learnModalSub"),o=document.getElementById("learnModalBody"),i=document.getElementById("learnModalLinks"),r=document.getElementById("learnModalCtas");!n||!s||!a||!o||!i||!r||(s.textContent=t.title,a.textContent=t.subtitle||"",o.innerHTML=(t.sections||[]).map(l=>`
  ...
  `).join(""),n.classList.add("show"),document.body.classList.add("modal-open"))}function la(){var e;(e=document.getElementById("learnModalOverlay"))==null||e.classList.remove("show"),document.body.classList.remove("modal-open")}function B0(e){var t,n,s;if(e==="modal:close")return la();if(e==="auth:signup"){la(),(t=window.openAuth)==null||t.call(window,"signup");return}if(e==="auth:login"){la(),(n=window.openAuth)==null||n.call(window,"login");return}if(e.startsWith("topic:"))return X0(e.split(":")[1]);if(e.startsWith("scroll:")){let a=e.split(":")[1];(s=document.getElementById(a))==null||s.scrollIntoView({behavior:"smooth",block:"start"})}}function H0(){Qu||(Qu=!0,document.addEventListener("click",e=>{var s,a;let t=(a=(s=e.target).closest)==null?void 0:a.call(s,"[data-action]");if(!t)return;let n=t.getAttribute("data-action")||"";n&&(e.preventDefault(),B0(n))}))}function Zu(){var l,c,d,u,p;H0(),(l=document.querySelector(".landing-features"))==null||l.setAttribute("id","learn"),(c=document.querySelector(".landing-simple-value"))==null||c.setAttribute("id","use-cases"),(d=document.querySelector(".landing-cta"))==null||d.setAttribute("id","about"),(u=document.querySelector(".landing-tagline"))==null||u.classList.add("tagline-pill");let e=document.querySelector(".landing-stats-strip");e&&(e.classList.add("landing-learn-strip"),e.innerHTML=D0.map(m=>`
    ...
    `).join(""));let t=x("features-grid");t&&(t.innerHTML=I0.map(m=>`
    ...
    `).join(""));let n=document.querySelector(".landing-simple-value"),s=n==null?void 0:n.querySelector("h2");s&&(s.textContent="What you can do with NaluLF");let a=x("value-grid");a&&(a.innerHTML=F0.map(m=>`
