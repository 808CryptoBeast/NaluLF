import{a as Er,b as bo,c as Tn,d as It,e as x,f as Oe,g as y,h as Be,i as _,j as U,k as Q,l as Z,m as vt,n as ve,o as ae,p as ge,q as Ut,r as B,s as ma,v as Me,w as Nr}from"./chunk-R7KFE7J7.js";function Cn(e){Tn.includes(e)||(e="gold"),B.currentTheme=e,Tn.forEach(t=>document.body.classList.remove(`theme-${t}`)),document.body.classList.add(`theme-${e}`),Z(bo,e)}function yo(){let e=Tn.indexOf(B.currentTheme);Cn(Tn[(e+1)%Tn.length])}function Rr(){let e=Q(bo);Cn(Tn.includes(e)?e:"gold")}var _r={landing:"landing-page",dashboard:"dashboard",inspector:"inspector",profile:"dashboard"};function wo(e){document.body.classList.remove("modal-open"),Object.values(_r).forEach(i=>document.body.classList.remove(i)),document.body.classList.add(_r[e]||"dashboard");let t=x("landing"),n=x("dashboard"),s=x("profile-page");t&&(t.style.display=e==="landing"?"":"none"),n&&(n.style.display=e==="dashboard"?"":"none"),s&&(s.style.display=e==="profile"?"":"none");let a=e==="landing",o={landingActions:x("navbar-landing-actions"),dashActions:x("navbar-dash-actions"),navConn:x("navbar-conn"),cmdkHint:x("cmdk-hint"),helpBtn:x("help-trigger")};o.landingActions&&(o.landingActions.style.display=a?"":"none"),o.dashActions&&(o.dashActions.style.display=a?"none":""),o.navConn&&(o.navConn.style.display=a?"none":""),o.cmdkHint&&(o.cmdkHint.style.display=a?"none":""),o.helpBtn&&(o.helpBtn.style.display=a?"none":""),B.currentPage=e,window.scrollTo({top:0,behavior:"smooth"}),window.dispatchEvent(new CustomEvent("naluxrp:pagechange",{detail:{pageId:e}}))}function Pn(){wo("landing")}function Ln(){wo("dashboard")}function xo(){wo("profile")}function Mn(e,t){Oe(".dash-tab").forEach(n=>{n.classList.toggle("active",n===e),n.setAttribute("aria-selected",String(n===e))}),["stream","inspector","network"].forEach(n=>{let s=x(`tab-${n}`);s&&(s.style.display=n===t?"":"none")}),t==="inspector"?(document.body.classList.remove("dashboard"),document.body.classList.add("inspector")):(document.body.classList.remove("inspector"),document.body.classList.add("dashboard")),B.currentTab=t,window.dispatchEvent(new CustomEvent("naluxrp:tabchange",{detail:{tabId:t}}))}var Ir="naluxrp_tour_seen",sn=[{title:"Welcome to NaluLF \u{1F30A}",body:"A 20-second tour of the three things people miss most. Skip anytime."},{selector:"#cmdk-hint",title:"Jump anywhere, instantly",body:"Press <kbd>Ctrl</kbd>+<kbd>K</kbd> (or <kbd>/</kbd>) from any page. Paste an address in and it offers to inspect it directly \u2014 no need to navigate first."},{selector:"#dash-tab-inspector",title:"Inspect any wallet",body:"Full forensic suite \u2014 trust lines, fund flow, convergence signals, AI-assisted explanations \u2014 for any XRPL address, not just your own."},{selector:".user-chip",title:"Your Profile has more than wallets",body:"Portfolio analytics, activity history, and Project Intelligence \u2014 liquidity depth, holder concentration, and issuer-risk scoring for any token \u2014 all live there."}],tt=0,$o=!1,Cs=null,Ft=null;function Fr(){Q(Ir)||setTimeout(So,700)}function So(){$o||($o=!0,tt=0,bm(),To())}function bm(){if(x("tourOverlay"))return;let e=document.createElement("div");e.id="tourOverlay",e.className="tour-overlay",e.innerHTML='<div class="tour-card" id="tour-card"></div>',document.body.appendChild(e),e.addEventListener("click",t=>{t.target===e&&fa()})}function ko(e){if(!e)return null;let t=document.querySelector(e);if(!t)return null;let n=t.getBoundingClientRect();return n.width>0||n.height>0?t:null}function Or(){Cs==null||Cs.classList.remove("tour-highlight"),Cs=null}function To(){for(;tt<sn.length&&sn[tt].selector&&!ko(sn[tt].selector);)tt++;if(tt>=sn.length)return Co();let e=sn[tt],t=x("tourOverlay"),n=x("tour-card");t.classList.add("show"),Or();let s=ko(e.selector);s&&(s.scrollIntoView({block:"center",behavior:"smooth"}),s.classList.add("tour-highlight"),Cs=s),n.innerHTML=`
    ...
    </div>`}function W(){var g,v;let e=document.querySelector("#profile-page .profile-wrap");if(!e)return;let t=document.getElementById("xpd-tv-widget"),n=!!(t&&ee.chart);t&&t.remove();let s=document.getElementById("xpd-chart-atmosphere"),a=!!(s&&qe.renderer);s&&s.remove();let o=Et(),i=(o==null?void 0:o.address)||"",r=uf(),l=localStorage.getItem(dn),c=re.some(w=>!w.watchOnly),d=Q(Wo)==="1",u=(g=Je[i])==null?void 0:g.xrp,p=Object.values(Je).reduce((w,k)=>w+((k==null?void 0:k.xrp)||0),0),m=(v=Ce.data)!=null&&v.priceUsd?p*Ce.data.priceUsd:0,f=In.map(w=>`<option value="${y(w.id)}" ${P.pair===w.id?"selected":""}>${y(w.label)}</option>`).join(""),h=In.map(w=>`<option value="${y(w.id)}" ${P.comparePair===w.id?"selected":""}>${y(w.label)}</option>`).join(""),b=Xl.map(w=>`<option value="${y(w.value)}" ${P.interval===w.value?"selected":""}>${y(w.label)}</option>`).join("");if(e.innerHTML=`
              ...
              <div class="xpd-chart-toolbar">
                ...
                <div class="xpd-toolbar-group">
                  ...
                  <select class="xpd-input" onchange="setDrawingTool(this.value)">
                    ${Hl.map(w=>`<option value="${w.key}" ${P.drawingTool===w.key?"selected":""}>Draw: ${w.label}</option>`).join("")}
                  </select>
    ...
    </div>`,n){let w=document.getElementById("xpd-tv-widget");w&&w.replaceWith(t)}if(a){let w=document.getElementById("xpd-chart-atmosphere");w&&w.replaceWith(s)}fh(),Eh(),Nh(),fi(),Os()}function uf(){let e=String(B.currentNetwork||"").toLowerCase();return e.includes("testnet")?{label:"XRPL Testnet",kind:"testnet"}:e.includes("mainnet")?{label:"XRPL Mainnet",kind:"mainnet"}:e.includes("xahau")?{label:"Xahau Network",kind:"xahau"}:{label:`Network: ${y(B.currentNetwork||"Unknown")}`,kind:"unknown"}}function mf(){let e=String(P.indicatorQuery||"").trim().toLowerCase(),t=[{key:"trend",label:"Trend",icon:"\u{1F4C8}"},{key:"momentum",label:"Momentum",icon:"\u26A1"},{key:"volume",label:"Volume",icon:"\u{1F4CA}"},{key:"volatility",label:"Volatility",icon:"\u{1F32A}\uFE0F"},{key:"advanced",label:"Custom",icon:"\u{1F9E0}"}];return`
    <div class="xpd-indicator-menu-wrap">
      ...
      ${P.indicatorMenuOpen?`
        <div class="xpd-indicator-menu" role="menu" aria-label="Indicator menu">
          ...
          ${t.map(n=>{let s=(ef[n.key]||[]).filter(a=>{var i;return e?(((i=qt[a])==null?void 0:i.name)||a).toLowerCase().includes(e):!0});return s.length?`
    ...
    <div class="xpd-indicator-row">
      ${s.length?s.map(f=>{var h,b;return`<div class="xpd-indicator-chip-wrap"><div class="xpd-indicator-chip" title="${y(((h=qt[f])==null?void 0:h.what)||"")}"><span>${y(((b=qt[f])==null?void 0:b.name)||f)}</span><button class="xpd-mini-btn" onclick="event.stopPropagation(); openIndicatorSettings('${f}')">\u2699</button><button class="xpd-mini-btn" onclick="removeIndicator('${f}')">\u2715</button></div>${hh(f)}</div>`}).join(""):'<span class="xpd-empty">No indicators enabled. Use + Indicator.</span>'}
    </div>
    ${(()=>{let f=Na(),h=(P.alerts||[]).filter(b=>b.tokenKey===f);return h.length?`
      <div class="xpd-indicator-row">
        ${h.map(b=>`
    ...
    <p class="xpd-note">Professional chart controls: wheel zoom, hold-and-drag pan, horizontal price-line marking, and token-focused context ribbons for faster execution decisions.</p>`}function hf(){let e=P.selectedIndicator||"sma20",t=qt[e]||qt.sma20,n=tf[e]||null,s=P.educationCollapsed;return`
    <div class="xpd-edu-panel ${s?"collapsed":""}">
      ...
      ${s?"":`
        ...
        `:""}
      `}
    </div>`}function ct(e,t){return`<div class="xpd-edu-row"><span class="xpd-edu-label">${y(e)}</span><span class="xpd-edu-value">${y(t)}</span></div>`}function gf(){if(Ce.loading)return'<div class="xpd-loading">Loading XRP market snapshot...</div>';if(Ce.error)return`<div class="xpd-error">${y(Ce.error)}</div>`;let e=Ce.data;if(!e)return'<div class="xpd-empty">Market data is not available yet.</div>';let t=e.change24h>=0;return`
    <div class="xpd-market-grid">
      ...
      <article class="xpd-stat-card">
        ...
        <strong class="xpd-stat-value">$${ze(e.volume24h)}</strong>
      </article>
      <article class="xpd-stat-card">
        <span class="xpd-stat-label">Market Cap</span>
        <strong class="xpd-stat-value">$${ze(e.marketCap)}</strong>
      </article>
    </div>
    <div class="xpd-token-strip">
      ${Zm.map(n=>`<div class="xpd-token-pill" title="${y(`${n.symbol} ${n.name}`)}"><span class="sym xpd-pill-text">${n.symbol}</span><span class="xpd-pill-text">${y(n.name)}</span><span class="cap xpd-pill-text">${n.marketCap}</span></div>`).join("")}
    </div>
    <p class="xpd-note">Top XRPL token cards are static examples when direct DEX market-cap feeds are unavailable.</p>`}function vf(e){return e?bt.loading?'<div class="xpd-loading">Loading account NFTs...</div>':bt.error?`<div class="xpd-error">${y(bt.error)}</div>`:bt.items.length?`<div class="xpd-nft-grid">${bt.items.map(bf).join("")}</div>`:'<div class="xpd-empty">No NFTs found for this wallet.</div>':'<div class="xpd-empty">Select or create a wallet to load NFTs.</div>'}function bf(e){let t=`${e.id.slice(0,12)}...${e.id.slice(-10)}`;return`<article class="xpd-nft-card">
  ...
  </article>`}function yf(e){let t=Pf(e),n=Lf(),s=Mf();return`<div class="xpd-amm-columns">${t}${n}${s}</div>`}function li(){return(ve(Q(Fl))||[]).filter(Boolean)}function Vl(e){let t=[...new Set((e||[]).filter(Boolean))];Z(Fl,JSON.stringify(t))}function wf(e,t){return t.has(e)?t.get(e):j.tokens.find(s=>s.symbol===e)||null}function xf(){let e=j.query||"",t=li(),n=j.filtered,s=Math.max(120,Number(j.listLimit||240)),a=n.slice(0,s),o=j.trending.slice(0,14),i=new Map(j.tokens.map(c=>[Ue(c),c])),r=i.get(j.selectedTokenKey)||null,l=j.filters||{type:"all",minCap:0,minVol:0,hasDex:!1};return`
    <div class="xpd-token-grid">
      <div class="xpd-token-col">
        <div class="xpd-search-row">
          ...
          <datalist id="xpd-token-suggest">${j.tokens.slice(0,80).map(c=>`<option value="${y(c.symbol)}">${y(c.name)}</option>`).join("")}</datalist>
          <div class="xpd-note">Loaded ${ze(j.total||n.length)} issued tokens \xB7 showing ${ze(a.length)} of ${ze(n.length)}${j.lastSyncAt?` \xB7 synced ${new Date(j.lastSyncAt).toLocaleTimeString()}`:""}</div>
        ...
        ${j.error?`<div class="xpd-error">${y(j.error)}</div>`:""}
        ${!a.length&&!j.loading?`<div class="xpd-empty">No tokens match${e?` "${y(e)}"`:" the current filters"}. <button class="xpd-mini-btn" onclick="clearTokenFilters()">Clear search & filters</button></div>`:""}
        <div class="xpd-token-list">${a.map(c=>{let d=Ue(c),u=Ps(d),p=String(e||"").trim();return`
          <div class="xpd-token-row xpd-token-row--clickable" title="${y(`${c.symbol} ${c.name}`)}" onclick="openTokenOnChart(decodeURIComponent('${u}'))">
            <div class="xpd-token-main">
              <strong>${yl(c.symbol,p)}</strong>
              <span>${yl(c.name,p)}</span>
              ${c.issuer?`<span class="mono xpd-pill-text">${y(c.issuer)}</span>`:""}
            </div>
            <div class="xpd-token-actions">
              <span>${c.price!=null?`$${_(c.price,6)}`:"\u2014"}</span>
              ${Number.isFinite(c.holders)?`<span title="Holders">${ze(c.holders)} holders</span>`:""}
      ...
      <div class="xpd-token-col">
        ${r?`<div class="xpd-token-detail-card">
          ...
          <div class="pool-meta">Price: ${r.price!=null?`$${_(r.price,6)}`:"\u2014"} \xB7 24h Vol: ${r.volume24h!=null?`$${ze(r.volume24h)}`:"\u2014"}</div>
          <div class="pool-meta">Market Cap: ${r.marketCap!=null?`$${ze(r.marketCap)}`:"\u2014"} \xB7 Holders: ${r.holders!=null?ze(r.holders):"\u2014"}</div>
        ...
        <h3>Watchlist</h3>
        <div class="xpd-watchlist">${t.length?t.map(c=>{let d=wf(c,i),u=d?`${d.symbol} \xB7 ${d.name}`:c,p=(d==null?void 0:d.price)!=null?`$${_(d.price,6)}`:"\u2014",m=Ps(c);return`<div class="xpd-token-row xpd-token-row--clickable" onclick="openTokenOnChart(decodeURIComponent('${m}'))"><span>${y(u)}</span><div class="xpd-token-actions"><span>${p}</span><button class="xpd-mini-btn" onclick="event.stopPropagation(); openTokenOnChart(decodeURIComponent('${m}'))">Chart</button><button class="xpd-mini-btn" onclick="event.stopPropagation(); removeTokenFromWatchlist(decodeURIComponent('${m}'))">Remove</button></div></div>`}).join(""):'<div class="xpd-empty">No watchlist tokens yet.</div>'}</div>
        <h3>Trending</h3>
        <div class="xpd-watchlist">${o.length?o.map(c=>`<div class="xpd-token-row xpd-token-row--clickable" onclick="openTokenOnChart(decodeURIComponent('${Ps(Ue(c))}'))"><span>${y(c.symbol)} \xB7 ${y(c.name)}</span><span>${c.volume24h!=null?`$${ze(c.volume24h)} vol`:c.marketCap!=null?`$${ze(c.marketCap)} mcap`:"\u2014"}</span></div>`).join(""):'<div class="xpd-empty">No trending data.</div>'}</div>
      </div>
    </div>`}function Gl(){let e=document.getElementById("xpd-lookup-currency");if(!e){ge("Token Discovery hasn't loaded yet \u2014 give it a moment and try again.");return}e.scrollIntoView({behavior:"smooth",block:"center"}),setTimeout(()=>e.focus(),350)}async function ci(e){let t=String(e||"").trim();if(!t)return;let n=t.includes("|")?j.tokens.find(s=>Ue(s)===t):j.tokens.find(s=>String(s.symbol||"").toUpperCase()===t.toUpperCase());if(!(n!=null&&n.issuer)){ge("Project Intelligence needs a token with a known issuer.");return}Ke={loading:!0,error:"",data:null,tokenKey:Ue(n),expandedSubScore:""},W(),setTimeout(()=>{var s;return(s=document.getElementById("xpd-project-intel-section"))==null?void 0:s.scrollIntoView({behavior:"smooth",block:"start"})},30);try{Ke={loading:!1,error:"",data:await dl(n),tokenKey:Ue(n),expandedSubScore:""}}catch(s){Ke={loading:!1,error:(s==null?void 0:s.message)||"Could not load project intelligence.",data:null,tokenKey:Ue(n),expandedSubScore:""}}W()}function Kl(e){Ke.expandedSubScore=Ke.expandedSubScore===e?"":e,W()}function Jl(){Ke={loading:!1,error:"",data:null,tokenKey:"",expandedSubScore:""},W()}var Yl={liquidity:{label:"Liquidity",icon:"\u{1F4A7}"},distribution:{label:"Distribution",icon:"\u{1F9EE}"},marketQuality:{label:"Market Quality",icon:"\u{1F4CA}"},lpStability:{label:"LP Stability",icon:"\u{1F3E6}"},issuerRisk:{label:"Issuer Risk",icon:"\u{1F6E1}"}};function Ho(e){return e>=75?"#50fa7b":e>=50?"#f1fa8c":e>=25?"#ffb86c":"#ff5555"}function Ql(e){return e>=75?"STRONG":e>=50?"MODERATE":e>=25?"WEAK":"VERY WEAK"}function kf(){if(Ke.loading)return`<div class="xpd-section-head"><h2>\u{1F52C} Project Intelligence</h2></div>
      <div class="xpd-loading">Fetching AMM state, order-book depth, holder and LP concentration, and issuer flags\u2026</div>`;if(Ke.error)return`<div class="xpd-section-head"><h2>\u{1F52C} Project Intelligence</h2>
      <button class="xpd-action" onclick="closeProjectIntel()">\u2715 Close</button></div>
      <div class="xpd-error">${y(Ke.error)}</div>`;let e=Ke.data;if(!e)return"";let t=e.strength,n=Ho(t.overall),s=t.dimensionsLive.map(a=>{let o=Yl[a],i=t.subScores[a],r=Ke.expandedSubScore===a;return`
      <div class="pi-subscore ${r?"pi-subscore--open":""}" onclick="toggleProjectIntelSubScore('${a}')">
        ...
        ${r?`<div class="pi-subscore-detail">${Object.entries(i.inputs).map(([l,c])=>`
          <div class="pi-kv"><span>${y(di(l))}</span><span class="mono">${y(Zl(c))}</span></div>
        `).join("")}</div>`:""}
      </div>`}).join("");return`
    <div class="xpd-section-head">
    ...
    <div class="pi-header-card">
      ...
      <div class="pi-score-word" style="color:${n}">${Ql(t.overall)}</div>
    ...
    <div class="pi-cards-grid">
      ${$f(e)}
      ${gl("Holder Concentration",e.holders,"\u{1F465}")}
      ${gl("LP Token Concentration",e.lp,"\u{1F3E6}")}
      ${Sf(e.issuerRisk)}
    </div>`}function di(e){return e.replace(/([A-Z])/g," $1").replace(/^./,t=>t.toUpperCase()).trim()}function Zl(e){return e==null?"\u2014":typeof e=="boolean"?e?"Yes":"No":typeof e=="number"?Number.isInteger(e)?String(e):_(e,2):String(e)}function $f(e){var i;let t=e.amm,n=e.orderBook,s=t!=null&&t.exists?`
  ...
  `:'<div class="inspect-empty-note">No AMM pool found for this pair.</div>',a=(r,l)=>r!=null&&r.length?`
    ...
    ${r.map(c=>`<tr><td>${c.pct}%</td><td class="mono">${_(c.xrpAtOffer,1)}</td><td class="mono">${ze(c.tokenAtOffer)}${c.bookExhausted?' <span title="Visible order book fully consumed before reaching this price-impact level \u2014 real depth may be less than shown, book is thin.">\u26A0</span>':""}</td></tr>`).join("")}
  ...
  `:'<div class="inspect-empty-note">No live order book found for this pair.</div>';return`
    <div class="sec-card pi-card">
      ...
      <hr class="pi-hr" />
      ${o}
    </div>`}function gl(e,t,n){if(!(t!=null&&t.exists))return`
    <div class="sec-card pi-card">
    ...
    <div class="pi-holder-row">
      ...
      <span class="mono">${ze(a.balance)}</span>
      <span class="mono pi-holder-pct">${t.totalSampled>0?_(a.balance/t.totalSampled*100,1):"0.0"}%</span>
    </div>`).join("");return`
    <div class="sec-card pi-card">
      <div class="sec-card-hdr"><span class="sec-card-icon">${n}</span><div><div class="sec-card-title">${y(e)}</div><div class="sec-card-sub">${ze(t.holderCount)} holders${t.sampleOnly?" (sampled, capped)":""}</div></div></div>
    ...
    </div>`}function ec(){let e=Ke.data;e&&Ia(Tf(e))}function vl(e,t){if(!(e!=null&&e.length))return"";let n=e.map(s=>`    ${s.pct}% impact: ${_(s.xrpAtOffer,1)} XRP / ${ze(s.tokenAtOffer)} tokens${s.bookExhausted?" (book exhausted before this level \u2014 real depth may be less than shown)":""}`).join(`
`);return`  ${t}:
${n}`}function bl(e,t){let n=[`${e}:`];return t!=null&&t.exists?(n.push(`  Holder count: ${t.holderCount}${t.sampleOnly?" (sampled, capped)":""}`),n.push(`  Top 1 holds: ${_(t.top1Pct,1)}%`),n.push(`  Top 5 hold: ${_(t.top5Pct,1)}%`),n.push(`  Top 10 hold: ${_(t.top10Pct,1)}%`),(t.topHolders||[]).slice(0,10).forEach((s,a)=>{let o=t.totalSampled>0?_(s.balance/t.totalSampled*100,2):"0.00";n.push(`    #${a+1} ${s.address}: ${ze(s.balance)} (${o}%)`)}),n.join(`
`)):(n.push("  No data found."),n.join(`
`))}function Tf(e){var i;let t=e.strength,n=e.amm,s=e.orderBook,a=e.issuerRisk,o=[];if(o.push(`XRPL TOKEN ANALYSIS \u2014 ${e.token.symbol}${e.token.name?` (${e.token.name})`:""}`),o.push(`Issuer: ${e.token.issuer}`),o.push(`Currency code: ${e.token.currency}`),o.push(`Snapshot taken: ${new Date(e.fetchedAt).toISOString()}`),o.push(""),o.push(`OVERALL STRENGTH SCORE: ${t.overall}/100 (${Ql(t.overall)})`),o.push("Methodology note: this score covers only 5 point-in-time-computable dimensions (Liquidity, Distribution, Market Quality, LP Stability, Issuer Risk). Network Activity, Treasury Health, and Project Transparency are NOT included \u2014 they would require historical tracking this tool does not do."),o.push(""),o.push("SUB-SCORES:"),t.dimensionsLive.forEach(r=>{let l=Yl[r],c=t.subScores[r];o.push(`- ${l.label}: ${c.score}/100`),Object.entries(c.inputs||{}).forEach(([d,u])=>{o.push(`    ${di(d)}: ${Zl(u)}`)})}),o.push(""),o.push("LIQUIDITY \u2014 AMM POOL:"),n!=null&&n.exists?(o.push(`  XRP reserve: ${_(n.xrpReserve,2)}`),o.push(`  Token reserve: ${_(n.tokenReserve,2)}`),o.push(`  LP token supply: ${_(n.lpSupply,2)}`),o.push(`  Trading fee: ${_(n.tradingFeePct,3)}%`),n.auctionSlot&&o.push(`  Auction slot discounted fee: ${_(n.auctionSlot.discountedFeePct,3)}%`),(i=n.voteSlots)!=null&&i.length&&o.push(`  Fee-vote participants: ${n.voteSlots.length}`)):o.push("  No AMM pool found for this pair."),o.push(""),o.push("LIQUIDITY \u2014 LIVE ORDER BOOK (DEX):"),s!=null&&s.exists){o.push(`  Buy price: ${_(s.buyPriceXrp,6)} XRP`),o.push(`  Sell price: ${_(s.sellPriceXrp,6)} XRP`),o.push(`  Spread: ${s.spreadPct!=null?_(s.spreadPct,2)+"%":"\u2014"}`);let r=vl(s.buyDepth,"Depth buying with XRP"),l=vl(s.sellDepth,"Depth selling for XRP");r&&o.push(r),l&&o.push(l)}else o.push("  No live order book found for this pair.");return o.push(""),o.push(bl("HOLDER CONCENTRATION",e.holders)),o.push(""),o.push(bl("LP TOKEN CONCENTRATION",e.lp)),o.push(""),o.push("ISSUER RISK FLAGS:"),a!=null&&a.exists?(o.push(`  Clawback enabled: ${a.clawbackEnabled?"YES":"No"} \u2014 ${xt.clawbackEnabled}`),o.push(`  Global freeze active: ${a.globalFreeze?"YES":"No"} \u2014 ${xt.globalFreeze}`),o.push(`  Freeze-capable: ${a.freezeCapable?"YES":"No"} \u2014 ${xt.freezeCapable}`),o.push(`  Requires auth to hold: ${a.requireAuth?"YES":"No"} \u2014 ${xt.requireAuth}`),o.push(`  Issuer blackholed: ${a.blackholed?"YES":"No"} \u2014 ${xt.blackholed}`)):o.push("  Could not load issuer account state."),o.push(""),o.push("---"),o.push("Please analyze this XRPL token's on-chain data above. Explain in plain language what these metrics suggest about the token's liquidity health, holder/LP concentration risk, and issuer-side control risk. Point out anything that looks like a red flag or an unusually strong/weak signal, and note any limits in what this data can and can't tell me (e.g. it's a point-in-time snapshot, not history)."),o.join(`
`)}function yl(e,t){let n=String(e||""),s=String(t||"").trim();if(!s)return y(n);let a=n.toLowerCase().indexOf(s.toLowerCase());if(a<0)return y(n);let o=y(n.slice(0,a)),i=y(n.slice(a,a+s.length)),r=y(n.slice(a+s.length));return`${o}<mark class="xpd-hit">${i}</mark>${r}`}function Cf(e){var a,o;let t=Object.values(Je).reduce((i,r)=>i+((r==null?void 0:r.xrp)||0),0),n=(a=Ce.data)!=null&&a.priceUsd?t*Ce.data.priceUsd:0,s=Pt.items.slice(0,8);return`
    <div class="xpd-token-grid">
      <div class="xpd-token-col">
        <div class="xpd-market-grid">
    ...
    </div>`).join("")}</div></div>`:'<div class="xpd-amm-card"><h3>Your liquidity positions</h3><div class="xpd-empty">No AMM entries or LP-token balances detected for this wallet yet.</div></div>':'<div class="xpd-amm-card"><h3>Your liquidity positions</h3><div class="xpd-empty">No active wallet.</div></div>'}function Lf(){return Lt.loading?'<div class="xpd-amm-card"><h3>General pool explorer</h3><div class="xpd-loading">Loading amm_info for known pools...</div></div>':Lt.error?`<div class="xpd-amm-card"><h3>General pool explorer</h3><div class="xpd-error">${y(Lt.error)}</div></div>`:Lt.pools.length?`<div class="xpd-amm-card"><h3>General pool explorer</h3><div class="xpd-pool-list">${Lt.pools.map(e=>`
    <div class="xpd-pool-item">
  ...
  </div>`}function ze(e){return Number.isFinite(Number(e))?new Intl.NumberFormat("en-US",{notation:"compact",maximumFractionDigits:2}).format(Number(e)):"\u2014"}function ts(e){return typeof e=="string"?`${_(Number(e)/1e6,4)} XRP`:e&&typeof e=="object"?`${_(Number(e.value||0),4)} ${e.currency||"UNK"}`:"\u2014"}function Af(e){if(!e||typeof e!="string")return"";try{let t=e.trim();if(!/^[0-9A-Fa-f]+$/.test(t)||t.length%2!==0)return t;let n=new Uint8Array(t.length/2);for(let s=0;s<t.length;s+=2)n[s/2]=parseInt(t.slice(s,s+2),16);return new TextDecoder().decode(n)}catch{return""}}function wl(e){return e?e.startsWith("ipfs://")?`https://ipfs.io/ipfs/${e.slice(7)}`:e.startsWith("ar://")?`https://arweave.net/${e.slice(5)}`:e:""}async function Ef(e){let t=wl(Af(e.URI||e.uri||""));if(!t)return"";if(/\.(png|jpg|jpeg|gif|webp|svg)$/i.test(t))return t;try{let n=await fetch(t,{method:"GET"});if(!n.ok)return"";let s=await n.json(),a=(s==null?void 0:s.image)||(s==null?void 0:s.image_url)||(s==null?void 0:s.thumbnail);return wl(a||"")}catch{return""}}async function Mt(e,{timeoutMs:t=9e3,allowProxy:n=!0}={}){let s=async a=>{let o=typeof(AbortSignal==null?void 0:AbortSignal.timeout)=="function"?AbortSignal.timeout(t):void 0,i=await fetch(a,{method:"GET",mode:"cors",cache:"no-store",signal:o});if(!i.ok)throw new Error(`HTTP ${i.status}`);return await i.json()};try{return await s(e)}catch(a){if(!n)throw a;for(let o of Fm)try{return await s(o(e))}catch{}throw a}}async function tc(){var e;Ce.loading=!0,Ce.error="",W();try{let t=await Mt("https://api.exchange.coinbase.com/products/XRP-USD/ticker"),n=await Mt("https://api.exchange.coinbase.com/products/XRP-USD/candles?granularity=86400"),s=Array.isArray(n)&&n.length?n[0]:null,a=Number((t==null?void 0:t.price)||0),o=s?Number(s[3]||0):a,i=s?Number(s[2]||a):a,r=s?Number(s[1]||a):a,l=s?Number(s[5]||0):0;Ce.data={priceUsd:a,change24h:o?(a-o)/o*100:0,volume24h:l*a,marketCap:Number(((e=Ce.data)==null?void 0:e.marketCap)||0),high24h:i,low24h:r}}catch(t){Ce.error=(t==null?void 0:t.message)||"Could not load market data right now.",Ce.data=null}finally{Ce.loading=!1,W()}}async function nc(e){if(bt.loading=!0,bt.error="",bt.items=[],W(),!e){bt.loading=!1,W();return}try{let t,n=[];do{let a=await nt({method:"account_nfts",params:[{account:e,limit:100,...t?{marker:t}:{}}]});n.push(...(a==null?void 0:a.account_nfts)||[]),t=a==null?void 0:a.marker}while(t);let s=await Promise.all(n.slice(0,80).map(async a=>({id:a.NFTokenID||a.nf_token_id||"Unknown",image:await Ef(a)})));bt.items=s}catch(t){bt.error=(t==null?void 0:t.message)||"Could not load NFTs for this wallet."}finally{bt.loading=!1,W()}}async function sc(e){if(yt.loading=!0,yt.error="",yt.pools=[],W(),!e){yt.loading=!1,W();return}try{let t=[],n;do{let o=await nt({method:"account_objects",params:[{account:e,type:"amm",limit:200,...n?{marker:n}:{}}]});((o==null?void 0:o.account_objects)||[]).forEach(r=>{let l=ts(r.Asset||r.amount),c=ts(r.Asset2||r.amount2),d=l.split(" ").pop()||"AssetA",u=c.split(" ").pop()||"AssetB";t.push({pair:`${d}/${u}`,lpBalance:r.LPTokenBalance?ts(r.LPTokenBalance):"Not reported",estimatedValue:"Estimate unavailable",tradingFee:r.TradingFee!=null?`${r.TradingFee} bps`:"\u2014",tvl:"Unavailable"})}),n=o==null?void 0:o.marker}while(n);let s=await nt({method:"account_lines",params:[{account:e,limit:200}]});((s==null?void 0:s.lines)||[]).filter(o=>typeof o.currency=="string"&&o.currency.length>=16&&Number(o.balance)>0).forEach(o=>{t.push({pair:`LP Token ${o.currency.slice(0,8)}...`,lpBalance:`${_(Number(o.balance),4)} ${o.currency.slice(0,8)}...`,estimatedValue:"Estimate unavailable",tradingFee:"\u2014",tvl:"Unavailable"})}),yt.pools=t}catch(t){yt.error=(t==null?void 0:t.message)||"Could not load account AMM objects."}finally{yt.loading=!1,W()}}async function ac(e){try{let t=await nt({method:"amm_info",params:[{asset:e.asset,asset2:e.asset2}]}),n=t==null?void 0:t.amm;return n?{label:e.label,reserveA:ts(n.amount),reserveB:ts(n.amount2),tradingFee:String(n.trading_fee??"\u2014"),totalLp:ts(n.lp_token||n.lp_token_balance),tvl:Nf(n.amount,n.amount2)}:null}catch{return null}}function Nf(e,t){let n=a=>typeof a=="string"?Number(a)/1e6:a&&typeof a=="object"?Number(a.value||0):0,s=n(e)+n(t);return!Number.isFinite(s)||s<=0?"Unavailable":`${_(s,4)} (asset units)`}async function oc(){Lt.loading=!0,Lt.error="",W();try{let e=await Promise.all(sf.map(ac));Lt.pools=e.filter(Boolean)}catch(e){Lt.error=(e==null?void 0:e.message)||"Could not load AMM explorer data.",Lt.pools=[]}finally{Lt.loading=!1,W()}}async function ic(){var r,l,c,d;let e=(((r=document.getElementById("xpd-asset1-currency"))==null?void 0:r.value)||"").trim().toUpperCase(),t=(((l=document.getElementById("xpd-asset1-issuer"))==null?void 0:l.value)||"").trim(),n=(((c=document.getElementById("xpd-asset2-currency"))==null?void 0:c.value)||"").trim().toUpperCase(),s=(((d=document.getElementById("xpd-asset2-issuer"))==null?void 0:d.value)||"").trim();if(!e||!n){_e.error="Enter both asset currency codes first.",W();return}let a=e==="XRP"?{currency:"XRP"}:{currency:e,issuer:t},o=n==="XRP"?{currency:"XRP"}:{currency:n,issuer:s};if(e!=="XRP"&&!t||n!=="XRP"&&!s){_e.error="Issuer is required for non-XRP assets.",W();return}_e.loading=!0,_e.error="",_e.pool=null,W();let i=await ac({label:`${e}/${n}`,asset:a,asset2:o});_e.loading=!1,i?_e.pool=i:_e.error="Pool not found or unavailable on this network.",W()}function Ea(){return In.find(e=>e.id===P.pair)||In[0]}function pi(e){if(e==="D")return 1440;if(e==="W")return 10080;if(e==="M")return 43200;let t=Number(e);return Number.isFinite(t)&&t>0?t:60}function Rf(e){if(e==="M")return"W";if(e==="D"||e==="W")return e;let t=pi(e);for(let n of[5,15,60,240])if(t<=n)return String(n);return"D"}async function _f(e,t,n,s=200){var d;let a=t?`${e}.${t}`:e,o=Rf(n),i=Math.min(2e3,Math.max(20,Number(s)||200)),r=`https://api.onthedex.live/public/v1/ohlc?base=${encodeURIComponent(a)}&quote=XRP&interval=${o}&bars=${i}`,l=await Mt(r,{timeoutMs:1e4});return(Array.isArray((d=l==null?void 0:l.data)==null?void 0:d.ohlc)?l.data.ohlc:[]).map(u=>({time:Number(u.t),open:Number(u.o),high:Number(u.h),low:Number(u.l),close:Number(u.c),volume:Number(u.vb||0)})).filter(u=>Number.isFinite(u.time)&&[u.open,u.high,u.low,u.close].every(Number.isFinite)).sort((u,p)=>u.time-p.time)}function rc(e){return{xrpusd:"XRP-USD",XRPUSDT:"XRP-USD",ETHUSDT:"ETH-USD",BTCUSDT:"BTC-USD",SOLUSDT:"SOL-USD"}[e]||null}function Df(e){return{XRP:"XRP-USD",BTC:"BTC-USD",ETH:"ETH-USD",SOL:"SOL-USD",USDC:"USDC-USD"}[String(e||"").toUpperCase()]||null}var zo=new Map;async function If(e,t){if(!e)return null;let n=`${Ue(e)}:${t}`,s=zo.get(n);if(s)return s;let a=Ff(e,t);zo.set(n,a);try{return await a}finally{zo.delete(n)}}async function Ff(e,t){var o,i;let n=String(e.symbol||"").toUpperCase();if(!n||n==="XRP")return null;let s=Df(n);if(s)try{let r=dc(t),l=r===86400?Dl:Il,{candles:c,reachedStart:d}=await Yo(s,r,l);if(c.length){let u=d?`${new Date(c[0].time*1e3).getUTCFullYear()}\u2013present`:`last ${c.length} bars`;return{candles:c,source:`Coinbase direct (${s}, ${u})`,mode:"token-direct"}}}catch{}let a=String(e.issuer||"").trim();if(a)try{let r=await _f(n,a,t,2e3);if(r.length){let l=Number(((o=P.stats)==null?void 0:o.xrplSpot)||((i=P.stats)==null?void 0:i.price)||0);return{candles:l>0?r.map(d=>({time:d.time,open:d.open*l,high:d.high*l,low:d.low*l,close:d.close*l,volume:d.volume})):r,source:`OnTheDex XRPL DEX (${n}/XRP)`,mode:"token-direct"}}}catch{}return null}function Of(e,{mode:t="pair",source:n="Source pending",tokenKey:s=""}={}){let a=Array.isArray(e)?e:[];if(!a.length){P.chartMeta={tokenKey:s||P.tokenFocusKey||"XRP|",symbol:s&&s.split("|")[0]||"XRP",source:n,last:null,high:null,low:null,mode:t};return}let o=a[a.length-1],i=a.map(c=>Number(c.high)).filter(c=>Number.isFinite(c)),r=a.map(c=>Number(c.low)).filter(c=>Number.isFinite(c)),l=s||P.tokenFocusKey||"XRP|";P.chartMeta={tokenKey:l,symbol:l.split("|")[0]||"XRP",source:n,last:Number(o.close),high:i.length?Math.max(...i):Number(o.high),low:r.length?Math.min(...r):Number(o.low),mode:t}}async function Is(){var t;let e=Ea();P.loading=!0,P.error="";try{let n=rc(e.ticker);if(n){let s=await Mt(`https://api.exchange.coinbase.com/products/${n}/ticker`),a=await Mt(`https://api.exchange.coinbase.com/products/${n}/candles?granularity=86400`),o=Array.isArray(a)&&a.length?a[0]:null,i=Number(s.price||0),r=o?Number(o[3]):i;P.stats={price:i,high:o?Number(o[2]):i,low:o?Number(o[1]):i,changePct:r?(i-r)/r*100:0,baseSource:"Coinbase",source:"Coinbase"},await lc(),!Ce.data&&P.stats.price&&(Ce.data={priceUsd:P.stats.price,change24h:P.stats.changePct,volume24h:o?Number(o[5]||0)*P.stats.price:0,marketCap:Number(((t=Ce.data)==null?void 0:t.marketCap)||0)});return}throw new Error("Chart stats unavailable for selected pair.")}catch(n){P.error=(n==null?void 0:n.message)||"DEX chart stats unavailable right now."}finally{P.loading=!1}}async function lc(){var e,t,n;try{let s=await nt({method:"book_offers",params:[{taker_gets:{currency:"USD",issuer:"rhub8VRN55s94qWKDv6jmDy1pUykJzF3wq"},taker_pays:{currency:"XRP"},limit:1}]}),a=(e=s==null?void 0:s.offers)==null?void 0:e[0];if(!a)return;let o=Number(((t=a.TakerGets)==null?void 0:t.value)||0),i=typeof a.TakerPays=="string"?Number(a.TakerPays)/1e6:Number(((n=a.TakerPays)==null?void 0:n.value)||0);if(o>0&&i>0){let r=o/i;if(_l=Date.now(),P.stats||(P.stats={}),P.stats.xrplSpot=r,String(Ea().symbol||"XRP").toUpperCase()==="XRP"){P.stats.price=r;let l=P.stats.baseSource||P.stats.source||"Market feed";P.stats.source=`${l} + XRPL live`,Ce.data&&(Ce.data.priceUsd=r)}}}catch{}}async function Bf(){var e,t;return(e=window.LightweightCharts)!=null&&e.createChart?!0:(ka||(ka=new Promise((n,s)=>{let a=document.querySelector('script[data-lw-chart="1"]');if(a){a.addEventListener("load",()=>n(!0),{once:!0}),a.addEventListener("error",()=>s(new Error("Chart library failed to load.")),{once:!0});return}let o=document.createElement("script");o.src="https://unpkg.com/lightweight-charts@4.2.2/dist/lightweight-charts.standalone.production.js",o.async=!0,o.defer=!0,o.dataset.lwChart="1",o.onload=()=>n(!0),o.onerror=()=>s(new Error("Chart library failed to load.")),document.head.appendChild(o)}).finally(()=>{var n;(n=window.LightweightCharts)!=null&&n.createChart||(ka=null)})),await ka,!!((t=window.LightweightCharts)!=null&&t.createChart))}async function Xf(){var e,t;return(e=window.THREE)!=null&&e.Scene?!0:($a||($a=new Promise((n,s)=>{let a=document.querySelector('script[data-three-chart="1"]');if(a){a.addEventListener("load",()=>n(!0),{once:!0}),a.addEventListener("error",()=>s(new Error("Three.js failed to load.")),{once:!0});return}let o=document.createElement("script");o.src="https://unpkg.com/three@0.166.1/build/three.min.js",o.async=!0,o.defer=!0,o.dataset.threeChart="1",o.onload=()=>n(!0),o.onerror=()=>s(new Error("Three.js failed to load.")),document.head.appendChild(o)}).finally(()=>{var n;(n=window.THREE)!=null&&n.Scene||($a=null)})),await $a,!!((t=window.THREE)!=null&&t.Scene))}function Fs(){var e,t;if(qe.resizeHandler)try{window.removeEventListener("resize",qe.resizeHandler)}catch{}if(qe.raf&&cancelAnimationFrame(qe.raf),(t=(e=qe.renderer)==null?void 0:e.domElement)!=null&&t.parentElement)try{qe.renderer.domElement.parentElement.removeChild(qe.renderer.domElement)}catch{}if(qe.renderer)try{qe.renderer.dispose()}catch{}qe={renderer:null,scene:null,camera:null,points:null,raf:0,host:null,resizeHandler:null}}async function Hf(){var t;let e=document.getElementById("xpd-chart-atmosphere");if(e&&!(qe.renderer&&e.contains(qe.renderer.domElement))&&!((navigator.hardwareConcurrency||4)<=3))try{if(await Xf(),!((t=window.THREE)!=null&&t.Scene))return;Fs();let n=window.THREE,s=Math.max(1,e.clientWidth||640),a=Math.max(1,e.clientHeight||460),o=new n.Scene,i=new n.PerspectiveCamera(52,s/a,.1,1e3);i.position.z=46;let r=new n.WebGLRenderer({alpha:!0,antialias:!0});r.setPixelRatio(Math.min(2,window.devicePixelRatio||1)),r.setSize(s,a),e.appendChild(r.domElement);let l=900,c=new Float32Array(l*3);for(let g=0;g<l;g+=1){let v=g*3;c[v]=(Math.random()-.5)*90,c[v+1]=(Math.random()-.5)*40,c[v+2]=(Math.random()-.5)*24}let d=new n.BufferGeometry;d.setAttribute("position",new n.BufferAttribute(c,3));let u=new n.PointsMaterial({color:5101823,size:.25,transparent:!0,opacity:.26,depthWrite:!1}),p=new n.Points(d,u);o.add(p);let m=0,f=0,h=()=>{var $;m+=1;let g=Number((($=P.stats)==null?void 0:$.changePct)||0),v=Math.min(4,Math.max(.35,Math.abs(g)/2.2)),w=g>0?16758874:16739999;u.color.setHex(Math.abs(g)>1.5?w:5101823),p.rotation.y+=9e-4*v,p.rotation.x=Math.sin(m*.0015*v)*.08,p.position.y=Math.sin(m*.003*v)*.7,(!document.hidden||Date.now()-f>350)&&(r.render(o,i),f=Date.now()),qe.raf=requestAnimationFrame(h)},b=()=>{let g=Math.max(1,e.clientWidth||640),v=Math.max(1,e.clientHeight||460);i.aspect=g/v,i.updateProjectionMatrix(),r.setSize(g,v)};window.addEventListener("resize",b,{passive:!0}),qe={renderer:r,scene:o,camera:i,points:p,raf:0,host:e,resizeHandler:b},h()}catch{}}function cc(e){return pi(e)*60}function dc(e){let t=pi(e);return t<=1?60:t<=5?300:t<=15?900:t<=60?3600:t<=360?21600:86400}function pc(){let e=String(P.tokenFocusKey||"");if(!e)return null;let t=e.includes("|")?e.split("|")[0]:e;return j.tokens.find(n=>Ue(n)===e)||j.tokens.find(n=>String(n.symbol||"").toUpperCase()===String(t||"").toUpperCase())||null}function uc(){var a,o;let e=pc(),t=Number((e==null?void 0:e.price)||0);if(Number.isFinite(t)&&t>0)return t;let n=Number(((a=P.stats)==null?void 0:a.xrplSpot)||0);if(Number.isFinite(n)&&n>0)return n;let s=Number(((o=P.stats)==null?void 0:o.price)||0);return Number.isFinite(s)&&s>0?s:1}function mc(e,t=1,n=220){let s=Math.max(60,cc(e)),a=Math.floor(Date.now()/1e3),o=Math.floor(a/s)*s-n*s,i=Math.max(1e-6,Number(t)||1),r=[];for(let l=0;l<n;l+=1){let c=o+l*s,d=i,u=Math.sin((l+1)/9)*.004+Math.cos((l+3)/17)*.002;i=Math.max(1e-6,d*(1+u));let p=Math.max(d,i)*(1+Math.abs(u)*.55+.0015),m=Math.min(d,i)*Math.max(1e-6,1-(Math.abs(u)*.55+.0015));r.push({time:c,open:Number(d),high:Number(p),low:Number(m),close:Number(i),volume:Math.max(0,Math.round(Math.abs(u)*12e3+l%13*55))})}return r}function Go(e){if(!e.length)return e;let t=[];for(let n=0;n<e.length;n+=1){let s=e[n],a=(s.open+s.high+s.low+s.close)/4,o=t[n-1],i=o?(o.open+o.close)/2:(s.open+s.close)/2,r=Math.max(s.high,i,a),l=Math.min(s.low,i,a);t.push({...s,open:i,high:r,low:l,close:a})}return t}function Ko(e,t){let n=[],s=0;for(let a=0;a<e.length;a+=1)s+=e[a].close,a>=t&&(s-=e[a-t].close),a>=t-1&&n.push({time:e[a].time,value:s/t});return n}function _s(e,t){let n=[];if(!e.length)return n;let s=2/(t+1),a=e[0].close;for(let o=0;o<e.length;o+=1)a=o===0?e[o].close:e[o].close*s+a*(1-s),o>=t-1&&n.push({time:e[o].time,value:a});return n}function zf(e,t){let n=[],s=t*(t+1)/2;for(let a=t-1;a<e.length;a+=1){let o=0;for(let i=0;i<t;i+=1)o+=e[a-i].close*(t-i);n.push({time:e[a].time,value:o/s})}return n}function Uf(e,t=20,n=2){let s=Ko(e,t),a=[],o=[];for(let i=t-1;i<e.length;i+=1){let r=e.slice(i-t+1,i+1),l=s[i-(t-1)].value,c=r.reduce((u,p)=>u+Math.pow(p.close-l,2),0)/t,d=Math.sqrt(c);a.push({time:e[i].time,value:l+d*n}),o.push({time:e[i].time,value:l-d*n})}return{upper:a,lower:o}}function jf(e){let t=[],n=0,s=0;for(let a=0;a<e.length;a+=1){let o=(e[a].high+e[a].low+e[a].close)/3;n+=o*(e[a].volume||0),s+=e[a].volume||0,s>0&&t.push({time:e[a].time,value:n/s})}return t}function Wf(e,t=14){let n=[];if(e.length<=t)return n;let s=0,a=0;for(let r=1;r<=t;r+=1){let l=e[r].close-e[r-1].close;s+=l>0?l:0,a+=l<0?-l:0}let o=s/t,i=a/t;for(let r=t+1;r<e.length;r+=1){let l=e[r].close-e[r-1].close;o=(o*(t-1)+(l>0?l:0))/t,i=(i*(t-1)+(l<0?-l:0))/t;let c=i>0?o/i:100;n.push({time:e[r].time,value:100-100/(1+c)})}return n}function ui(e,t=14){let n=[];for(let o=0;o<e.length;o+=1){let i=o>0?e[o-1].close:e[o].close;n.push(Math.max(e[o].high-e[o].low,Math.abs(e[o].high-i),Math.abs(e[o].low-i)))}let s=[],a=n.slice(0,t).reduce((o,i)=>o+i,0)/Math.max(1,t);for(let o=t;o<e.length;o+=1)a=(a*(t-1)+n[o])/t,s.push({time:e[o].time,value:a});return s}function qf(e,t=14,n=3){let s=[];for(let o=t-1;o<e.length;o+=1){let i=e.slice(o-t+1,o+1),r=Math.max(...i.map(d=>d.high)),l=Math.min(...i.map(d=>d.low)),c=r!==l?(e[o].close-l)/(r-l)*100:50;s.push({time:e[o].time,value:c})}let a=[];for(let o=n-1;o<s.length;o+=1){let i=s.slice(o-n+1,o+1).reduce((r,l)=>r+l.value,0)/n;a.push({time:s[o].time,value:i})}return{k:s,d:a}}function Vf(e,t=12,n=26,s=9){let a=_s(e,t),o=_s(e,n),i=new Map(o.map(u=>[u.time,u.value])),r=a.filter(u=>i.has(u.time)).map(u=>({time:u.time,value:u.value-i.get(u.time)})),l=[];if(r.length){let u=2/(s+1),p=r[0].value;for(let m=0;m<r.length;m+=1)p=m===0?r[m].value:r[m].value*u+p*(1-u),m>=s-1&&l.push({time:r[m].time,value:p})}let c=new Map(l.map(u=>[u.time,u.value])),d=r.filter(u=>c.has(u.time)).map(u=>({time:u.time,value:u.value-c.get(u.time)}));return{line:r,signal:l,hist:d}}function fc(e,t=9,n=26,s=52){let a=u=>{let p=[];for(let m=u-1;m<e.length;m+=1){let f=e.slice(m-u+1,m+1);p.push({time:e[m].time,value:(Math.max(...f.map(h=>h.high))+Math.min(...f.map(h=>h.low)))/2})}return p},o=a(t),i=a(n),r=new Map(i.map(u=>[u.time,u.value])),l=o.filter(u=>r.has(u.time)).map(u=>({time:u.time,value:(u.value+r.get(u.time))/2})),c=a(s),d=e.map(u=>({time:u.time,value:u.close}));return{tenkan:o,kijun:i,senkouA:l,senkouB:c,chikou:d}}function Gf(e,t=20){let n=[],s=[],a=[];for(let o=t-1;o<e.length;o+=1){let i=e.slice(o-t+1,o+1),r=Math.max(...i.map(c=>c.high)),l=Math.min(...i.map(c=>c.low));n.push({time:e[o].time,value:r}),s.push({time:e[o].time,value:l}),a.push({time:e[o].time,value:(r+l)/2})}return{upper:n,lower:s,mid:a}}function Kf(e,t=20,n=2){let s=_s(e,t),a=ui(e,t),o=new Map(a.map(l=>[l.time,l.value])),i=[],r=[];return s.forEach(l=>{if(o.has(l.time)){let c=o.get(l.time)*n;i.push({time:l.time,value:l.value+c}),r.push({time:l.time,value:l.value-c})}}),{upper:i,lower:r,mid:s}}function Jf(e){let t=[],n=[],s=0,a=0;for(let o=0;o<e.length;o+=1){if(o>0){let l=e[o-1];e[o].close>l.close&&(s+=e[o].volume||0),e[o].close<l.close&&(s-=e[o].volume||0)}let i=e[o].high-e[o].low||1,r=(e[o].close-e[o].low-(e[o].high-e[o].close))/i;a+=r*(e[o].volume||0),t.push({time:e[o].time,value:s}),n.push({time:e[o].time,value:a})}return{obv:t,adline:n}}function Yf(e,t=14){if(e.length<t+2)return{adx:[],plusDi:[],minusDi:[]};let n=[],s=[],a=[];for(let p=1;p<e.length;p+=1){let m=e[p].high-e[p-1].high,f=e[p-1].low-e[p].low;s.push(m>f&&m>0?m:0),a.push(f>m&&f>0?f:0),n.push(Math.max(e[p].high-e[p].low,Math.abs(e[p].high-e[p-1].close),Math.abs(e[p].low-e[p-1].close)))}let o=n.slice(0,t).reduce((p,m)=>p+m,0),i=s.slice(0,t).reduce((p,m)=>p+m,0),r=a.slice(0,t).reduce((p,m)=>p+m,0),l=[],c=[],d=[];for(let p=t;p<n.length;p+=1){o=o-o/t+n[p],i=i-i/t+s[p],r=r-r/t+a[p];let m=o>0?100*i/o:0,f=o>0?100*r/o:0,h=m+f>0?100*Math.abs(m-f)/(m+f):0,b=e[p+1].time;l.push({time:b,value:m}),c.push({time:b,value:f}),d.push({time:b,value:h})}let u=[];if(d.length>=t){let p=d.slice(0,t).reduce((m,f)=>m+f.value,0)/t;for(let m=t;m<d.length;m+=1)p=(p*(t-1)+d[m].value)/t,u.push({time:d[m].time,value:p})}return{adx:u,plusDi:l,minusDi:c}}function Qf(e,t=14){let n=[],s=[];for(let a=t-1;a<e.length;a+=1){let o=e.slice(a-t+1,a+1),i=0,r=0;for(let d=1;d<o.length;d+=1)o[d].high>=o[i].high&&(i=d),o[d].low<=o[r].low&&(r=d);let l=t-1-i,c=t-1-r;n.push({time:e[a].time,value:(t-l)/t*100}),s.push({time:e[a].time,value:(t-c)/t*100})}return{up:n,down:s}}function Zf(e,t=14){let n=[],s=[];if(e.length<t+2)return{plus:n,minus:s};for(let a=t;a<e.length;a+=1){let o=0,i=0,r=0;for(let l=a-t+1;l<=a;l+=1){let c=e[l-1],d=e[l];o+=Math.max(d.high-d.low,Math.abs(d.high-c.close),Math.abs(d.low-c.close)),i+=Math.abs(d.high-c.low),r+=Math.abs(d.low-c.high)}n.push({time:e[a].time,value:o>0?i/o:0}),s.push({time:e[a].time,value:o>0?r/o:0})}return{plus:n,minus:s}}function eh(e,t=10,n=3){let s=ui(e,t),a=new Map(s.map(c=>[c.time,c.value])),o=[],i=0,r=0,l=!0;return e.forEach((c,d)=>{if(d===0||!a.has(c.time))return;let u=(c.high+c.low)/2,p=a.get(c.time),m=u+n*p,f=u-n*p;d>1&&(m>i&&e[d-1].close<=i&&(m=i),f<r&&e[d-1].close>=r&&(f=r));let h=c.close>m?!0:c.close<f?!1:l,b=h?f:m;o.push({time:c.time,value:b,trendUp:h?1:0}),i=m,r=f,l=h}),o}function th(e,t=14){let n=[];if(e.length<=t)return n;let s=e.map((a,o)=>{let i=(a.high+a.low+a.close)/3,r=o>0?(e[o-1].high+e[o-1].low+e[o-1].close)/3:i,l=i*(a.volume||0);return{time:a.time,pos:i>=r?l:0,neg:i<r?l:0}});for(let a=t;a<s.length;a+=1){let o=s.slice(a-t+1,a+1),i=o.reduce((c,d)=>c+d.pos,0),r=o.reduce((c,d)=>c+d.neg,0),l=r>0?i/r:100;n.push({time:s[a].time,value:100-100/(1+l)})}return n}function nh(e,t=14){let n=[];for(let s=t-1;s<e.length;s+=1){let a=e.slice(s-t+1,s+1),o=Math.max(...a.map(l=>l.high)),i=Math.min(...a.map(l=>l.low)),r=o!==i?(o-e[s].close)/(o-i)*-100:-50;n.push({time:e[s].time,value:r})}return n}function sh(e,t=20){let n=[],s=e.map(a=>({time:a.time,value:(a.high+a.low+a.close)/3}));for(let a=t-1;a<s.length;a+=1){let o=s.slice(a-t+1,a+1),i=o.reduce((c,d)=>c+d.value,0)/t,r=o.reduce((c,d)=>c+Math.abs(d.value-i),0)/t,l=r>0?(s[a].value-i)/(.015*r):0;n.push({time:s[a].time,value:l})}return n}function ah(e){if(e.length<30)return[];let t=[],n=[];for(let o=1;o<e.length;o+=1){let i=e[o-1].close,r=Math.min(e[o].low,i),l=Math.max(e[o].high,i);t.push({time:e[o].time,value:e[o].close-r}),n.push({time:e[o].time,value:l-r})}let s=(o,i,r)=>o.slice(i-r+1,i+1).reduce((l,c)=>l+c.value,0),a=[];for(let o=27;o<t.length;o+=1){let i=s(t,o,7)/Math.max(1e-9,s(n,o,7)),r=s(t,o,14)/Math.max(1e-9,s(n,o,14)),l=s(t,o,28)/Math.max(1e-9,s(n,o,28));a.push({time:t[o].time,value:100*(4*i+2*r+l)/7})}return a}function oh(e,t=20){let n=[],s=e.map(a=>{let o=a.high-a.low||1,i=(a.close-a.low-(a.high-a.close))/o;return{time:a.time,value:i*(a.volume||0),volume:a.volume||0}});for(let a=t-1;a<s.length;a+=1){let o=s.slice(a-t+1,a+1),i=o.reduce((l,c)=>l+c.value,0),r=o.reduce((l,c)=>l+c.volume,0);n.push({time:s[a].time,value:r>0?i/r:0})}return n}function ih(e){return(Array.isArray(e)?e:[]).map(t=>({time:Number(t[0]),low:Number(t[1]),high:Number(t[2]),open:Number(t[3]),close:Number(t[4]),volume:Number(t[5])})).filter(t=>Number.isFinite(t.time)&&[t.open,t.high,t.low,t.close].every(Number.isFinite))}function Jo(e,t){let n=new Map;for(let s of e)n.set(s.time,s);for(let s of t)n.set(s.time,s);return Array.from(n.values()).sort((s,a)=>s.time-a.time)}async function Yo(e,t,n){let s=[],a=Math.floor(Date.now()/1e3),o=!1;for(let i=0;i<n;i+=1){let r=a-t*300,l=`https://api.exchange.coinbase.com/products/${e}/candles?granularity=${t}&start=${new Date(r*1e3).toISOString()}&end=${new Date(a*1e3).toISOString()}`,c;try{c=await Mt(l,{timeoutMs:1e4})}catch{break}let d=ih(c);if(!d.length){o=!0;break}s.push(...d),a=r,i<n-1&&await Qm(Ym)}return{candles:Jo(s,[]),reachedStart:o}}async function rh(e,t,n){if(!e||!Number.isFinite(t)||!Number.isFinite(n)||n<=t)return[];try{let s=`https://api.coingecko.com/api/v3/coins/${e}/market_chart/range?vs_currency=usd&from=${t}&to=${n}`,a=await Mt(s,{timeoutMs:15e3});return(Array.isArray(a==null?void 0:a.prices)?a.prices:[]).map(([i,r])=>({time:Math.floor(Number(i)/1e3/86400)*86400,open:Number(r),high:Number(r),low:Number(r),close:Number(r),volume:0})).filter(i=>Number.isFinite(i.time)&&Number.isFinite(i.close)&&i.close>0).sort((i,r)=>i.time-r.time)}catch{return[]}}async function lh(e,t,n){var u;let s=dc(n),a=s===86400,o=`${Jm}${e.id}:${s}`,i=ve(Q(o));if((u=i==null?void 0:i.candles)!=null&&u.length&&i.reachedStart){let p=await Yo(t,s,1),m=Jo(i.candles,p.candles);return Z(o,JSON.stringify({candles:m,reachedStart:!0,source:i.source,cachedAt:Date.now()})),{candles:m,source:i.source}}let l=await Yo(t,s,a?Dl:Il),c=l.candles,d=c.length?`Coinbase (${new Date(c[0].time*1e3).getUTCFullYear()}\u2013present, ${c.length} bars)`:"Coinbase";if(a&&l.reachedStart&&e.coingeckoId&&c.length){let p=c[0].time,m=await rh(e.coingeckoId,0,p);m.length&&(c=Jo(m,c),d=`CoinGecko (${new Date(c[0].time*1e3).getUTCFullYear()}+) + Coinbase (${new Date(p*1e3).getUTCFullYear()}\u2013present)`)}else!a&&!l.reachedStart&&(d=`Coinbase (last ${c.length} bars \u2014 full inception history is daily/weekly/monthly only)`);return c.length&&Z(o,JSON.stringify({candles:c,reachedStart:l.reachedStart,source:d,cachedAt:Date.now()})),{candles:c,source:d}}var Uo=new Map;async function hc(e,t){let n=`${e.id}:${t}`,s=As.get(n);if(s&&Date.now()-s.ts<6e4&&Array.isArray(s.data)&&s.data.length)return s.data;let a=Uo.get(n);if(a)return a;let o=(async()=>{let i=[],r="",l=rc(e.ticker);if(l)try{let c=await lh(e,l,t);i=c.candles,r=c.source}catch{i=[]}if(!Array.isArray(i)||!i.length){let c=mc(t,uc());return As.set(n,{ts:Date.now(),data:c,sourceLabel:""}),c}return As.set(n,{ts:Date.now(),data:i,sourceLabel:r}),i})();Uo.set(n,o);try{return await o}finally{Uo.delete(n)}}async function ch(){var u,p,m,f,h,b,g,v;let e=Ea(),t=await hc(e,P.interval),s=((u=As.get(`${e.id}:${P.interval}`))==null?void 0:u.sourceLabel)||String(((p=P.stats)==null?void 0:p.source)||"Coinbase + XRPL live"),a="pair",o=pc(),i=String((o==null?void 0:o.symbol)||"").toUpperCase(),r=o?Ue(o):`${e.symbol||"XRP"}|`;if(o&&i&&i!=="XRP"){let w=await If(o,P.interval);(m=w==null?void 0:w.candles)!=null&&m.length&&(t=w.candles,s=w.source,a=w.mode)}let l=String(e.symbol||"XRP").toUpperCase()==="XRP",c=Number((l?(f=P.stats)==null?void 0:f.xrplSpot:null)??((h=P.stats)==null?void 0:h.price)??0);if(a==="pair"&&Number.isFinite(c)&&c>0&&t.length){let w=Math.max(60,cc(P.interval)),k=Math.floor(Date.now()/1e3),$=Math.floor(k/w)*w,T=t[t.length-1];T.time===$?(T.high=Math.max(T.high,c),T.low=Math.min(T.low,c),T.close=c):T.time<$&&t.push({time:$,open:T.close,high:Math.max(T.close,c),low:Math.min(T.close,c),close:c,volume:0})}let d=Number((o==null?void 0:o.price)||0);if(a==="pair"&&o&&i&&i!=="XRP"&&Number.isFinite(d)&&d>0&&t.length){let w=Number((l?(b=P.stats)==null?void 0:b.xrplSpot:null)??((g=P.stats)==null?void 0:g.price)??((v=t[t.length-1])==null?void 0:v.close)??0);if(Number.isFinite(w)&&w>0){let k=d/w;Number.isFinite(k)&&k>0&&(t=t.map($=>({...$,open:$.open*k,high:$.high*k,low:$.low*k,close:$.close*k})),s="Coinbase pair + token spot proxy",a="token-proxy")}}return t.length||(t=mc(P.interval,uc()),s=o&&i!=="XRP"?"Synthetic fallback (token-focused)":"Synthetic fallback",a="fallback"),o&&i!=="XRP"&&(a==="pair"||a==="fallback")?Xo!==r&&(Xo=r,ge(`No market data found for ${o.symbol} yet \u2014 showing ${e.symbol||"XRP"} for reference.`)):r&&(Xo=""),P.chartType==="heikin_ashi"&&(t=Go(t)),Of(t,{mode:a,source:s,tokenKey:r||"XRP|"}),t}function xl(e){if(!Array.isArray(e))return[];let t=e.map(s=>({time:Number(s.time),open:Number(s.open),high:Number(s.high),low:Number(s.low),close:Number(s.close),volume:Number(s.volume||0)})).filter(s=>Number.isFinite(s.time)&&Number.isFinite(s.open)&&Number.isFinite(s.high)&&Number.isFinite(s.low)&&Number.isFinite(s.close)&&s.time>0).sort((s,a)=>s.time-a.time),n=[];for(let s=0;s<t.length;s+=1){let a=t[s],o=n[n.length-1];o&&o.time===a.time?n[n.length-1]=a:n.push(a)}return n}function dh(e,t,n){var i;let s=Number(((i=e==null?void 0:e[e.length-1])==null?void 0:i.close)||0);if(!Number.isFinite(s)||s<=0)return 6;let o=Math.max(1e-12,Math.abs(Number(n)-Number(t)))/Math.max(1e-12,Math.abs(s));return s>=1e3?o<.01?4:2:s>=1?o<.01?6:4:s>=.01?o<.03?8:6:8}function ph(){if(ee.resizeObserver)try{ee.resizeObserver.disconnect()}catch{}ee.chart&&(ee.chart.remove(),ee={chart:null,volumeSeries:null,activeSeries:null,compareSeries:null,indicatorSeries:[],indicatorPriceLines:[],priceLines:[],resizeObserver:null,chartType:"",configKey:"",legendEl:null,renderLegend:null,ichimokuData:null,indicatorLegendItems:[],alertPriceLines:[]})}function kl(e,t){var d;let{addOverlay:n,addOsc:s,addOscHist:a,addPriceLevel:o}=t,i=(u,p)=>{var f,h;let m=Number((h=(f=P.indicatorSettings)==null?void 0:f[u])==null?void 0:h.length);return Number.isFinite(m)&&m>1?Math.min(500,Math.max(2,m)):p},r=(u,p,m)=>{var b,g;let f=(g=(b=P.indicatorSettings)==null?void 0:b[u])==null?void 0:g[p];if(f==null||f==="")return m;let h=(oi[u]||[]).find(v=>v.id===p);if((h==null?void 0:h.type)==="number"){let v=Number(f);return Number.isFinite(v)&&v>1?Math.min(500,Math.max(2,v)):m}return f},l=P.indicators;if(l.sma20&&n(Ko(e,i("sma20",20)),r("sma20","color","#f1c40f"),1.2,!1,"SMA"),l.ema20&&n(_s(e,i("ema20",20)),r("ema20","color","#ffb86c"),1.2,!1,"EMA"),l.wma20&&n(zf(e,i("wma20",20)),r("wma20","color","#bd93f9"),1.2,!1,"WMA"),l.vwap&&n(jf(e),r("vwap","color","#80ffea"),1.2,!1,"VWAP"),l.bb20){let u=r("bb20","color","#ff79c6"),p=Uf(e,i("bb20",20),2);n(p.upper,u,1,!0,"BB Upper"),n(p.lower,u,1,!0,"BB Lower")}if(l.ichimoku){let u=fc(e,r("ichimoku","tenkanLen",9),r("ichimoku","kijunLen",26),r("ichimoku","senkouBLen",52));n(u.tenkan,r("ichimoku","tenkanColor","#ffde59"),1.2,!1,"Tenkan"),n(u.kijun,r("ichimoku","kijunColor","#6ecbff"),1.2,!1,"Kijun"),n(u.senkouA,"rgba(70,255,160,0.8)",1,!0,"Senkou A"),n(u.senkouB,"rgba(255,120,120,0.8)",1,!0,"Senkou B"),n(u.chikou,"rgba(220,220,255,0.6)",.9,!0,"Chikou")}if(l.donchian){let u=r("donchian","color","#9cfb8c"),p=Gf(e,i("donchian",20));n(p.upper,u,1,!0,"Donchian Upper"),n(p.lower,u,1,!0,"Donchian Lower"),n(p.mid,"rgba(156,251,140,0.6)",1.2,!1,"Donchian Mid")}if(l.keltner){let u=r("keltner","color","#7ee7ff"),p=Kf(e,i("keltner",20),2);n(p.upper,u,1,!0,"Keltner Upper"),n(p.lower,u,1,!0,"Keltner Lower"),n(p.mid,"rgba(126,231,255,0.66)",1.2,!1,"Keltner Mid")}if(l.pivots&&e.length>=2){let u=e[e.length-2],p=(u.high+u.low+u.close)/3,m=2*p-u.low,f=2*p-u.high,h=p+(u.high-u.low),b=p-(u.high-u.low);o(p,"#f6f6f6","P"),o(m,"#61ffb0","R1"),o(f,"#ff8f8f","S1"),o(h,"rgba(97,255,176,0.6)","R2"),o(b,"rgba(255,143,143,0.6)","S2")}if(l.supertrend||l.sar||l.elderRay){let u=_s(e,14);if(l.supertrend&&n(eh(e,10,3),r("supertrend","color","#8bffde"),1.3,!1,"Supertrend"),l.sar&&n(u.map(p=>({time:p.time,value:p.value*.998})),r("sar","color","#ffaf7a"),1,!0,"SAR"),l.elderRay){let p=new Map(u.map(h=>[h.time,h.value])),m=e.filter(h=>p.has(h.time)).map(h=>({time:h.time,value:h.high-p.get(h.time)})),f=e.filter(h=>p.has(h.time)).map(h=>({time:h.time,value:h.low-p.get(h.time)}));s(m,r("elderRay","bullColor","#5fff9d"),"Elder Bull"),s(f,r("elderRay","bearColor","#ff9d9d"),"Elder Bear")}}if(l.rsi&&s(Wf(e,i("rsi",14)),r("rsi","color","#a6ff4d"),"RSI"),l.atr&&s(ui(e,i("atr",14)),r("atr","color","#ffb86c"),"ATR"),l.stdev){let u=Ko(e,20),p=new Map(u.map(f=>[f.time,f.value])),m=e.filter(f=>p.has(f.time)).map(f=>({time:f.time,value:Math.abs(f.close-p.get(f.time))}));s(m,r("stdev","color","#b2a3ff"),"StdDev")}if(l.stoch){let u=qf(e,i("stoch",14),3);s(u.k,r("stoch","kColor","#9ee8ff"),"%K"),s(u.d,r("stoch","dColor","#ffd86b"),"%D")}if(l.macd){let u=Vf(e,r("macd","fastLen",12),r("macd","slowLen",26),r("macd","signalLen",9));s(u.line,r("macd","lineColor","#8fd9ff"),"MACD"),s(u.signal,r("macd","signalColor","#ffcf8e"),"Signal"),(d=u.hist)!=null&&d.length&&a(u.hist)}let c=Jf(e);if(l.obv&&s(c.obv,r("obv","color","#8cf9ff"),"OBV"),l.adline&&s(c.adline,r("adline","color","#ffb7ff"),"A/D"),l.cmf&&s(oh(e,i("cmf",20)),r("cmf","color","#f8ff87"),"CMF"),l.williamsr&&s(nh(e,i("williamsr",14)),r("williamsr","color","#ff9adf"),"Williams %R"),l.cci&&s(sh(e,i("cci",20)),r("cci","color","#b8ff8e"),"CCI"),l.mfi&&s(th(e,i("mfi",14)),r("mfi","color","#7bffd2"),"MFI"),l.uo&&s(ah(e),r("uo","color","#ffd36f"),"UO"),l.adx){let u=Yf(e,i("adx",14));s(u.adx,r("adx","adxColor","#9fd8ff"),"ADX"),s(u.plusDi,r("adx","plusColor","#73ffc0"),"+DI"),s(u.minusDi,r("adx","minusColor","#ff9797"),"-DI")}if(l.aroon){let u=Qf(e,i("aroon",14));s(u.up,r("aroon","upColor","#6cffb0"),"Aroon Up"),s(u.down,r("aroon","downColor","#ff8f8f"),"Aroon Down")}if(l.vortex){let u=Zf(e,i("vortex",14));s(u.plus.map(p=>({time:p.time,value:p.value*100})),r("vortex","plusColor","#d6a8ff"),"VI+"),s(u.minus.map(p=>({time:p.time,value:p.value*100})),r("vortex","minusColor","#ffb0f3"),"VI-")}}function uh(e){let t=e.querySelector(":scope > svg.xpd-ichimoku-cloud-svg");return t||(t=document.createElementNS("http://www.w3.org/2000/svg","svg"),t.setAttribute("class","xpd-ichimoku-cloud-svg"),e.appendChild(t)),t}function mh(e){var t;(t=e==null?void 0:e.querySelector(":scope > svg.xpd-ichimoku-cloud-svg"))==null||t.remove()}function gc(e,t,n,s,a){var b;if(!e||!t||!n)return;let o=n.clientWidth||0,i=n.clientHeight||0;if(!o||!i||!(s!=null&&s.length)||!(a!=null&&a.length))return;let r=uh(n);r.setAttribute("width",o),r.setAttribute("height",i),r.setAttribute("viewBox",`0 0 ${o} ${i}`);let l=((b=P.indicatorSettings)==null?void 0:b.ichimoku)||{},c=l.bullColor||"#46ffa0",d=l.bearColor||"#ff7878",u=new Map(a.map(g=>[g.time,g.value])),p=e.timeScale(),m=[];for(let g of s){let v=u.get(g.time);if(v==null)continue;let w=p.timeToCoordinate(g.time),k=t.priceToCoordinate(g.value),$=t.priceToCoordinate(v);w==null||k==null||$==null||m.push({x:w,ya:k,yb:$,bullish:g.value>=v})}let f="",h=0;for(let g=1;g<=m.length;g+=1){if(!(g===m.length||m[g].bullish!==m[h].bullish))continue;let w=m.slice(h,g);if(w.length>=2){let k=w.map(S=>`${S.x.toFixed(1)},${S.ya.toFixed(1)}`).join(" "),$=w.slice().reverse().map(S=>`${S.x.toFixed(1)},${S.yb.toFixed(1)}`).join(" "),T=w[0].bullish?c:d;f+=`<polygon points="${k} ${$}" fill="${y(T)}" opacity="0.22" />`}h=g}r.innerHTML=f}function $l(e,t,n,s){var i;if(!P.indicators.ichimoku){mh(s),ee.ichimokuData=null;return}let a=((i=P.indicatorSettings)==null?void 0:i.ichimoku)||{},o=fc(e,Number(a.tenkanLen)||9,Number(a.kijunLen)||26,Number(a.senkouBLen)||52);ee.ichimokuData={senkouA:o.senkouA,senkouB:o.senkouB},gc(t,n,s,o.senkouA,o.senkouB)}function Qo(){let e=ee.ichimokuData,t=document.getElementById("xpd-tv-widget");e&&ee.chart&&ee.activeSeries&&t&&gc(ee.chart,ee.activeSeries,t,e.senkouA,e.senkouB)}async function fh(){var n,s,a,o;let e=++Nn,t=document.getElementById("xpd-tv-widget");if(t){ee.chart||(t.innerHTML='<div class="xpd-loading">Loading full price history\u2026</div>');try{P.threeEnabled?Hf():Fs();let i=await ch(),r=xl(i);if(e!==Nn)return;if(!r.length)throw new Error("No chart bars returned for selected pair/timeframe.");gh(r);let l=JSON.stringify({pair:P.pair,interval:P.interval,chartType:P.chartType,comparePair:P.comparePair,indicators:P.indicators,indicatorSettings:P.indicatorSettings,threeEnabled:P.threeEnabled});if(!P.comparePair&&!(P.drawings||[]).length&&ee.chart&&ee.configKey===l){let X=P.chartType==="heikin_ashi"?Go(r):r;P.chartType==="line"||P.chartType==="area"?ee.activeSeries.setData(X.map(Y=>({time:Y.time,value:Y.close}))):ee.activeSeries.setData(X),ee.volumeSeries.setData(r.map(Y=>({time:Y.time,value:Y.volume||0,color:Y.close>=Y.open?"rgba(38,166,154,0.5)":"rgba(239,83,80,0.5)"})));let q=0,se=0,me=[];kl(r,{addOverlay:(Y,he,et,it,Ct)=>{let Dt=ee.indicatorSeries[q++];Y!=null&&Y.length&&(Dt==null||Dt.setData(Y),Ct&&Dt&&me.push({label:Ct,color:he,series:Dt,points:Y}))},addOsc:(Y,he,et)=>{let it=ee.indicatorSeries[q++];Y!=null&&Y.length&&(it==null||it.setData(Y),et&&it&&me.push({label:et,color:he,series:it,points:Y}))},addOscHist:Y=>{let he=ee.indicatorSeries[q++];Y!=null&&Y.length&&(he==null||he.setData(Y.map(et=>({time:et.time,value:et.value,color:et.value>=0?"rgba(99,255,157,0.45)":"rgba(255,126,126,0.45)"}))))},addPriceLevel:Y=>{let he=ee.indicatorPriceLines[se++];Number.isFinite(Y)&&(he==null||he.applyOptions({price:Y}))}}),ee.indicatorLegendItems=me,$l(r,ee.chart,ee.activeSeries,t),Sl(ee.activeSeries);let Re=r[r.length-1];(n=ee.renderLegend)==null||n.call(ee,Re.open,Re.high,Re.low,Re.close,Re.volume);return}if(!await Bf())throw new Error("Chart library failed to load.");if(e!==Nn)return;let d=document.getElementById("xpd-tv-widget");if(!d||e!==Nn)return;let u=null;try{u=((s=ee.chart)==null?void 0:s.timeScale().getVisibleLogicalRange())||null}catch{}ph(),d.innerHTML="";let p=window.LightweightCharts,m=Math.max(320,d.clientWidth||((a=d.parentElement)==null?void 0:a.clientWidth)||320),f=Math.max(360,d.clientHeight||460),h=r.map(X=>X.low),b=r.map(X=>X.high),g=dh(r,Math.min(...h),Math.max(...b)),v={type:"price",precision:g,minMove:Math.pow(10,-g)},w="#26a69a",k="#ef5350",$=p.createChart(d,{width:m,height:f,layout:{background:{type:p.ColorType.Solid,color:"#131722"},textColor:"#d1d4dc"},grid:{vertLines:{color:"#242832"},horzLines:{color:"#242832"}},rightPriceScale:{borderColor:"rgba(197,203,206,0.3)"},leftPriceScale:{visible:!1,borderColor:"rgba(197,203,206,0.3)"},timeScale:{borderColor:"rgba(197,203,206,0.3)",timeVisible:!0,secondsVisible:!1},crosshair:{mode:p.CrosshairMode.Normal},handleScroll:!0,handleScale:!0}),T=P.chartType==="heikin_ashi"?Go(r):r,S;if(P.chartType==="line")S=$.addLineSeries({color:"#2962ff",lineWidth:2,priceFormat:v}),S.setData(T.map(X=>({time:X.time,value:X.close})));else if(P.chartType==="area")S=$.addAreaSeries({lineColor:"#2962ff",topColor:"rgba(41,98,255,0.36)",bottomColor:"rgba(41,98,255,0.04)",lineWidth:2,priceFormat:v}),S.setData(T.map(X=>({time:X.time,value:X.close})));else if(P.chartType==="bars")S=$.addBarSeries({upColor:w,downColor:k,priceFormat:v}),S.setData(T);else{let X=P.chartType==="hollow_candles";S=$.addCandlestickSeries({upColor:X?"rgba(0,0,0,0)":w,downColor:k,borderUpColor:w,borderDownColor:k,wickUpColor:w,wickDownColor:k,borderVisible:!0,priceFormat:v}),S.setData(T)}let M=$.addHistogramSeries({priceFormat:{type:"volume"},priceScaleId:"vol"});$.priceScale("vol").applyOptions({scaleMargins:{top:.85,bottom:0}}),M.setData(r.map(X=>({time:X.time,value:X.volume||0,color:X.close>=X.open?"rgba(38,166,154,0.5)":"rgba(239,83,80,0.5)"})));let C=document.createElement("div");C.className="xpd-chart-legend",d.appendChild(C);let A=X=>Number.isFinite(X)?X.toFixed(g):"\u2014",R=(X,q,se,me,xe,Te)=>{let We=me>=X,Ie=(Te||[]).map(Re=>`<span style="color:${y(Re.color)}">${y(Re.label)} <b>${A(Re.value)}</b></span>`).join("");C.innerHTML=`
        <span>O <b>${A(X)}</b></span>
        <span>H <b>${A(q)}</b></span>
        <span>L <b>${A(se)}</b></span>
        <span class="${We?"xpd-legend-up":"xpd-legend-down"}">C <b>${A(me)}</b></span>
        ${xe!=null?`<span>Vol <b>${ze(xe)}</b></span>`:""}
        ${Ie}
      `},O=T[T.length-1],I=(o=r[r.length-1])==null?void 0:o.volume,D=()=>{if(!O)return;let X=O.open??O.value,q=O.high??O.value,se=O.low??O.value,me=O.close??O.value,xe=(ee.indicatorLegendItems||[]).map(Te=>{var We,Ie;return{label:Te.label,color:Te.color,value:(Ie=(We=Te.points)==null?void 0:We[Te.points.length-1])==null?void 0:Ie.value}}).filter(Te=>Number.isFinite(Te.value));R(X,q,se,me,I,xe)};D(),$.subscribeCrosshairMove(X=>{var Re,Y;if(!X.time){D();return}let q=(Re=X.seriesData)==null?void 0:Re.get(S);if(!q){D();return}let se=(Y=X.seriesData)==null?void 0:Y.get(M),me=q.open??q.value,xe=q.high??q.value,Te=q.low??q.value,We=q.close??q.value,Ie=(ee.indicatorLegendItems||[]).map(he=>{var et,it;return{label:he.label,color:he.color,value:(it=(et=X.seriesData)==null?void 0:et.get(he.series))==null?void 0:it.value}}).filter(he=>Number.isFinite(he.value));R(me,xe,Te,We,se==null?void 0:se.value,Ie)});let F=!1,H=()=>{F||(F=!0,$.priceScale("osc").applyOptions({scaleMargins:{top:.65,bottom:.18}}))},E=[],z=[],te=[];kl(r,{addOverlay:(X,q,se=1.2,me=!1,xe="")=>{if(!(X!=null&&X.length))return;let Te=$.addLineSeries({color:q,lineWidth:se,lineStyle:me?p.LineStyle.Dashed:p.LineStyle.Solid,priceLineVisible:!1,lastValueVisible:!1});Te.setData(X),E.push(Te),xe&&te.push({label:xe,color:q,series:Te,points:X})},addOsc:(X,q,se="")=>{if(!(X!=null&&X.length))return;H();let me=$.addLineSeries({color:q,lineWidth:1.2,priceScaleId:"osc",title:se,priceLineVisible:!1,lastValueVisible:!1});me.setData(X),E.push(me),se&&te.push({label:se,color:q,series:me,points:X})},addOscHist:X=>{if(!(X!=null&&X.length))return;H();let q=$.addHistogramSeries({priceScaleId:"osc",priceLineVisible:!1,lastValueVisible:!1});q.setData(X.map(se=>({time:se.time,value:se.value,color:se.value>=0?"rgba(99,255,157,0.45)":"rgba(255,126,126,0.45)"}))),E.push(q)},addPriceLevel:(X,q,se="")=>{Number.isFinite(X)&&z.push(S.createPriceLine({price:X,color:q,lineWidth:1,lineStyle:p.LineStyle.Dashed,axisLabelVisible:!0,title:se}))}}),$l(r,$,S,d),$.timeScale().subscribeVisibleLogicalRangeChange(Qo);let ce=null;if(P.comparePair){let X=In.find(q=>q.id===P.comparePair);if(X){let q=xl(await hc(X,P.interval));if(e===Nn&&q.length){let se=q[0].close||1;ce=$.addLineSeries({color:"#ffd166",lineWidth:1.4,priceScaleId:"left",priceLineVisible:!1,lastValueVisible:!0,priceFormat:{type:"custom",formatter:me=>`${me>=0?"+":""}${me.toFixed(2)}%`,minMove:.01}}),$.priceScale("left").applyOptions({visible:!0,borderColor:"rgba(255,209,102,0.35)"}),ce.setData(q.map(me=>({time:me.time,value:(me.close/se-1)*100})))}}}else $.priceScale("left").applyOptions({visible:!1});if(e!==Nn){try{$.remove()}catch{}return}let G=(P.drawings||[]).filter(X=>Number.isFinite(X==null?void 0:X.price)).map(X=>S.createPriceLine({price:X.price,color:"#78e5ff",lineWidth:2,lineStyle:p.LineStyle.Dashed,axisLabelVisible:!0,title:"Line"}));if($.subscribeClick(X=>{if(P.drawingTool!=="hline"||!X.point)return;let q=S.coordinateToPrice(X.point.y);Number.isFinite(q)&&(P.drawings=[...P.drawings||[],{price:q}].slice(-50),G.push(S.createPriceLine({price:q,color:"#78e5ff",lineWidth:2,lineStyle:p.LineStyle.Dashed,axisLabelVisible:!0,title:"Line"})))}),u&&Number.isFinite(u.from)&&Number.isFinite(u.to))try{$.timeScale().setVisibleLogicalRange(u)}catch{$.timeScale().fitContent()}else $.timeScale().fitContent();let Se=new ResizeObserver(()=>{$.applyOptions({width:Math.max(320,d.clientWidth||320)}),Qo()});Se.observe(d),ee={chart:$,volumeSeries:M,activeSeries:S,compareSeries:ce,indicatorSeries:E,indicatorPriceLines:z,priceLines:G,resizeObserver:Se,chartType:P.chartType,configKey:l,legendEl:C,renderLegend:R,indicatorLegendItems:te,alertPriceLines:[]},Sl(S)}catch(i){if(e!==Nn)return;if(P.error=(i==null?void 0:i.message)||"Could not initialize chart widget.",ee.chart){ge(P.error);return}let r=document.getElementById("xpd-tv-widget");r&&(r.innerHTML=`<div class="xpd-error">${y(P.error)}</div>`)}}}function vc(){let e=Q(Wo)==="1"?"0":"1";Z(Wo,e),W()}async function bc(e){In.some(t=>t.id===e)&&(P.pair=e,await Is(),At(),W())}async function yc(e){P.interval=e,await Is(),At(),W()}function wc(e){P.chartType=e,At(),W()}async function xc(){await Is(),W()}function kc(e,t){e in P.indicators&&(P.indicators[e]=!!t,t&&(P.selectedIndicator=e,P.selectedEducationTab="indicator"),At(),W())}function $c(){P.indicatorMenuOpen=!P.indicatorMenuOpen,W()}function Sc(){P.moreMenuOpen=!P.moreMenuOpen,W()}function Tc(e){P.indicatorQuery=String(e||""),P.indicatorMenuOpen||(P.indicatorMenuOpen=!0),W()}function Cc(e){let t=String(e||"").trim();t in P.indicators&&(P.indicators[t]=!0,P.selectedIndicator=t,P.selectedEducationTab="indicator",At(),W())}function Pc(e){let t=String(e||"").trim();t in P.indicators&&(P.indicators[t]=!1,At(),W())}function hh(e){var s,a;if(P.settingsOpenFor!==e)return"";let t=P.indicatorSettings[e]||{},n=oi[e]||[];return`
    ...
    </div>`}function Lc(e){let t=String(e||"").trim();t in P.indicators&&(P.settingsOpenFor=P.settingsOpenFor===t?null:t,W())}function Mc(){P.settingsOpenFor=null,W()}function Ac(e){let t=String(e||"").trim();if(!(t in P.indicators))return;let n=P.indicatorSettings[t]||{},s={...n};for(let a of oi[t]||[]){let o=document.getElementById(`xpd-ind-${a.id}-${t}`);o&&(a.type==="number"?s[a.id]=Math.max(2,Math.min(500,Number(o.value)||n[a.id]||a.default)):s[a.id]=o.value)}P.indicatorSettings[t]=s,P.settingsOpenFor=null,W()}function Ec(e){let t=String(e||"").trim();delete P.indicatorSettings[t],P.settingsOpenFor=null,W()}function Nc(){At(),Hs(window.location.href),ae("Chart link copied.")}function Rc(){P.threeEnabled=!P.threeEnabled,Z(ai,P.threeEnabled?"1":"0"),P.threeEnabled||Fs(),W()}function _c(e){let t=!!e;P.threeEnabled!==t&&(P.threeEnabled=t,Z(ai,P.threeEnabled?"1":"0"),P.threeEnabled||Fs(),W())}function Dc(e){P.comparePair=e||"",At(),W()}function Ic(e){let t=String(e||"").trim();!t||!(t in P.indicators)||(P.indicators[t]=!0,P.selectedIndicator=t,W())}function Fc(e){let t=String(e||"none");Hl.some(n=>n.key===t)&&(P.drawingTool=t,P.educationHint=nf[t]||"",W())}function Na(){var e;return((e=P.chartMeta)==null?void 0:e.tokenKey)||P.tokenFocusKey||`${Ea().symbol||"XRP"}|`}function Oc(){var s,a;let e=Number((s=P.chartMeta)==null?void 0:s.last),t=prompt(`Alert me when ${((a=P.chartMeta)==null?void 0:a.symbol)||"price"} crosses:`,Number.isFinite(e)?e.toFixed(6):"");if(t==null)return;let n=Number(t);if(!Number.isFinite(n)||n<=0){ge("Enter a valid price.");return}P.alerts=[...P.alerts||[],{id:`alert_${Date.now()}`,tokenKey:Na(),price:n,createdAt:new Date().toISOString()}],ri(),W(),ae(`Alert set at $${_(n,6)}`)}function Bc(e){P.alerts=(P.alerts||[]).filter(t=>t.id!==e),ri(),W()}function Sl(e){if(!e)return;let t=window.LightweightCharts;for(let s of ee.alertPriceLines||[])try{e.removePriceLine(s)}catch{}let n=(P.alerts||[]).filter(s=>s.tokenKey===Na());ee.alertPriceLines=n.map(s=>{var a;return e.createPriceLine({price:s.price,color:"#ffb703",lineWidth:2,lineStyle:((a=t==null?void 0:t.LineStyle)==null?void 0:a.Dotted)??2,axisLabelVisible:!0,title:"\u{1F514} Alert"})})}function gh(e){var r,l;if(e.length<2)return;let t=Na(),n=(P.alerts||[]).filter(c=>c.tokenKey===t);if(!n.length)return;let s=e[e.length-2].close,a=e[e.length-1].close,o=[],i=!1;for(let c of n){let d=s<c.price&&a>=c.price,u=s>c.price&&a<=c.price;d||u?(ae(`\u{1F514} ${((r=P.chartMeta)==null?void 0:r.symbol)||"Price"} crossed $${_(c.price,6)} (${d?"\u2191":"\u2193"} now $${_(a,6)})`),i=!0,(l=document.querySelector(`.xpd-indicator-chip[data-alert-id="${c.id}"]`))==null||l.remove()):o.push(c)}i&&(P.alerts=[...(P.alerts||[]).filter(c=>c.tokenKey!==t),...o],ri())}function Xc(){let e=ee.activeSeries;if(e)for(let t of ee.priceLines||[])try{e.removePriceLine(t)}catch{}ee.priceLines=[],P.drawings=[]}function Ra(e,t=0){var i;let n=(i=ee.chart)==null?void 0:i.timeScale();if(!n)return;let s=n.getVisibleLogicalRange();if(!s)return;let a=(s.to-s.from)*e,o=(s.to+s.from)/2+(s.to-s.from)*t;n.setVisibleLogicalRange({from:o-a/2,to:o+a/2})}function Hc(){Ra(.8)}function zc(){Ra(1.25)}function Uc(){Ra(1,-.2)}function jc(){Ra(1,.2)}function Wc(){P.educationCollapsed=!P.educationCollapsed,W()}function qc(e){["indicator","psychology","practice"].includes(e)&&(P.selectedEducationTab=e,W())}function Vc(){let e=document.body.classList.contains("theme-gold");Cn(e?"cosmic":"gold"),W()}var Tl=!1;function vh(){let e=document.getElementById("xpd-tv-widget");e&&ee.chart&&(ee.chart.applyOptions({width:Math.max(320,e.clientWidth||320),height:Math.max(320,e.clientHeight||460)}),Qo())}function Gc(){var t;let e=document.querySelector(".xpd-chart-wrap");e&&(Tl||(Tl=!0,document.addEventListener("fullscreenchange",()=>{requestAnimationFrame(()=>requestAnimationFrame(vh))})),document.fullscreenElement?document.exitFullscreen():(t=e.requestFullscreen)==null||t.call(e))}function Kc(){let e=ee.chart;if(!e){ge("Chart image is not ready yet.");return}let t=e.takeScreenshot(),n=document.createElement("a");n.download=`xrpl-chart-${Date.now()}.png`,n.href=t.toDataURL("image/png"),n.click()}function Jc(){return P.tokenFocusKey||P.pair||"default"}function Yc(){var n;let e=ve(Q(qo))||{},t=Jc();e[t]={interval:P.interval,chartType:P.chartType,comparePair:P.comparePair,indicators:P.indicators,indicatorSettings:P.indicatorSettings},Z(qo,JSON.stringify(e)),ae(`Chart layout saved for ${((n=P.chartMeta)==null?void 0:n.symbol)||t}.`)}function Qc(){var s;let e=ve(Q(qo))||{},t=Jc(),n=e[t];if(!n){ge(`No saved layout for ${((s=P.chartMeta)==null?void 0:s.symbol)||t} yet.`);return}P.interval=n.interval||P.interval,P.chartType=n.chartType||P.chartType,P.comparePair=n.comparePair||"",P.indicators={...P.indicators,...n.indicators||{}},P.indicatorSettings={...P.indicatorSettings,...n.indicatorSettings||{}},At(),W()}function _a(e){let t=String(e||"").trim();if(/^[0-9A-F]{40}$/i.test(t)){let n=t.replace(/(00)+$/g,"");if(/^[0-9A-F]+$/i.test(n)&&n.length%2===0)try{let s=new Uint8Array(n.length/2);for(let o=0;o<n.length;o+=2)s[o/2]=parseInt(n.slice(o,o+2),16);let a=new TextDecoder().decode(s).replace(/\0/g,"").trim();if(a)return a.toUpperCase()}catch{}}return t.toUpperCase()}function Ue(e){return`${e.symbol}|${e.issuer||""}`}function Ps(e){return encodeURIComponent(e).replace(/'/g,"%27")}function bh(e){var l,c,d,u,p,m,f,h,b,g;let t=_a(e.code||e.currency||""),n=String(e.issuer||((l=e.IssuingAccount)==null?void 0:l.account)||"").trim(),s=Number(e.price??((c=e.metrics)==null?void 0:c.price)??0),a=Number(e.marketcap??((d=e.metrics)==null?void 0:d.marketcap)??0),o=Number(((u=e.metrics)==null?void 0:u.volume_24h)??0),i=((m=(p=e.meta)==null?void 0:p.token)==null?void 0:m.name)||((f=e.IssuingAccount)==null?void 0:f.name)||t||"Unknown Token",r=Number(e.holders??((h=e.metrics)==null?void 0:h.holders)??((b=e.metrics)==null?void 0:b.trustlines)??0);return{symbol:t,name:i,issuer:n,tokenId:e.id||`${t}.${n}`,price:Number.isFinite(s)&&s>0?s:null,marketCap:Number.isFinite(a)&&a>0?a:null,volume24h:Number.isFinite(o)?o:null,holders:Number.isFinite(r)?r:null,change24h:null,verified:!!((g=e.IssuingAccount)!=null&&g.verified),score:Number(e.score||0)||null}}function yh(e){let t=_a((e==null?void 0:e.symbol)||""),n=String((e==null?void 0:e.name)||t||"Unknown Token"),s=Number((e==null?void 0:e.current_price)||0),a=Number((e==null?void 0:e.market_cap)||0),o=Number((e==null?void 0:e.total_volume)||0),i=Number((e==null?void 0:e.price_change_percentage_24h)||0);return{symbol:t,name:n,issuer:"",tokenId:`cg:${(e==null?void 0:e.id)||t}`,price:Number.isFinite(s)&&s>0?s:null,marketCap:Number.isFinite(a)&&a>0?a:null,volume24h:Number.isFinite(o)&&o>0?o:null,holders:null,change24h:Number.isFinite(i)?i:null,verified:!1,score:null}}function wh(e){var r;let t=_a((e==null?void 0:e.currency)||(e==null?void 0:e.token)||""),n=String((e==null?void 0:e.issuer)||(e==null?void 0:e.account)||"").trim(),s=String((e==null?void 0:e.name)||t||"Unknown Token"),a=Number((e==null?void 0:e.price)||((r=e==null?void 0:e.market)==null?void 0:r.price)||0),o=Number((e==null?void 0:e.marketcap)||(e==null?void 0:e.marketCap)||0),i=Number((e==null?void 0:e.volume24h)||(e==null?void 0:e.volume)||0);return{symbol:t,name:s,issuer:n,tokenId:`bithomp:${t}.${n||"na"}`,price:Number.isFinite(a)&&a>0?a:null,marketCap:Number.isFinite(o)&&o>0?o:null,volume24h:Number.isFinite(i)&&i>0?i:null,holders:Number.isFinite(Number((e==null?void 0:e.holders)||0))?Number((e==null?void 0:e.holders)||0):null,change24h:Number.isFinite(Number((e==null?void 0:e.change24h)||0))?Number((e==null?void 0:e.change24h)||0):null,verified:!!(e!=null&&e.verified),score:null}}function xh(e){let t=_a((e==null?void 0:e.symbol)||(e==null?void 0:e.currency)||""),n=String((e==null?void 0:e.issuer)||(e==null?void 0:e.issuerAddress)||"").trim(),s=String((e==null?void 0:e.name)||t||"Unknown Token"),a=Number((e==null?void 0:e.price)||0),o=Number((e==null?void 0:e.volume24h)||0);return{symbol:t,name:s,issuer:n,tokenId:`xrplto:${t}.${n||"na"}`,price:Number.isFinite(a)&&a>0?a:null,marketCap:Number.isFinite(Number((e==null?void 0:e.marketCap)||0))?Number((e==null?void 0:e.marketCap)||0):null,volume24h:Number.isFinite(o)&&o>0?o:null,holders:Number.isFinite(Number((e==null?void 0:e.holders)||0))?Number((e==null?void 0:e.holders)||0):null,change24h:Number.isFinite(Number((e==null?void 0:e.change24h)||0))?Number((e==null?void 0:e.change24h)||0):null,verified:!!(e!=null&&e.verified),score:null}}async function Zc(){var e,t,n,s,a,o;if(La()){j.loading=!0,j.error="";try{let i=Date.now(),r=pl.get("tokens");if(r&&i-r.ts<6e4){j.tokens=r.data,j.total=r.total||r.data.length,j.lastSyncAt=r.ts,j.filtered=ss(j.query,r.data),j.trending=Cl(r.data),j.loading=!1;return}let l=500,c=12,d=[];for(let T=1;T<=c;T+=1){let S=await Mt(`${Om}?page=${T}&limit=${l}`,{allowProxy:!1,timeoutMs:12e3});if(!Array.isArray(S)||!S.length||(d.push(...S),S.length<l))break}let u=d.map(bh).filter(T=>!!T.symbol&&!!T.issuer),p=[Mt(`${Bm}?vs_currency=usd&order=market_cap_desc&per_page=250&page=1&sparkline=false`,{timeoutMs:12e3}).catch(()=>[]),Date.now()<(fl.xrplto||0)?Promise.resolve([]):Mt(Hm,{timeoutMs:12e3,allowProxy:!1}).catch(T=>(String((T==null?void 0:T.message)||"").includes("429")&&(fl.xrplto=Date.now()+5*60*1e3),[]))];zm&&p.push(Mt(Xm,{timeoutMs:12e3,allowProxy:!1}).catch(()=>[]));let[m,f,h=[]]=await Promise.all(p),b=Array.isArray(m)?m.map(yh).filter(T=>!!T.symbol):[],g=Array.isArray(h)?h.map(wh).filter(T=>!!T.symbol):[],v=Array.isArray(f)?f.map(xh).filter(T=>!!T.symbol):[],w={symbol:"XRP",name:"XRP Ledger Native",issuer:"",tokenId:"XRP",price:((e=Ce.data)==null?void 0:e.priceUsd)||((t=P.stats)==null?void 0:t.price)||null,marketCap:((n=Ce.data)==null?void 0:n.marketCap)||null,volume24h:((s=Ce.data)==null?void 0:s.volume24h)||null,holders:null,change24h:((a=Ce.data)==null?void 0:a.change24h)||((o=P.stats)==null?void 0:o.changePct)||null,verified:!0,score:1},k=new Map;[w,...u,...g,...v,...b].forEach(T=>{let S=Ue(T);k.has(S)||k.set(S,T)});let $=[...k.values()];pl.set("tokens",{ts:i,data:$,total:$.length}),j.tokens=$,j.total=$.length,j.lastSyncAt=i,j.filtered=ss(j.query,$),j.trending=Cl($)}catch(i){j.error=(i==null?void 0:i.message)||"Could not load XRPL token discovery data."}finally{j.loading=!1}}}function ss(e,t){let n=String(e||"").trim().toLowerCase(),s=j.filters||{type:"all",minCap:0,minVol:0,hasDex:!1};return t.filter(a=>{if(n&&!`${a.symbol} ${a.name} ${a.issuer} ${a.tokenId||""}`.toLowerCase().includes(n)||Number(s.minCap||0)>0&&Number(a.marketCap||0)<Number(s.minCap||0)||Number(s.minVol||0)>0&&Number(a.volume24h||0)<Number(s.minVol||0)||s.hasDex&&!(Number(a.volume24h||0)>0||Number(a.holders||0)>100))return!1;if(s.type&&s.type!=="all"){let o=String(a.symbol||"").toLowerCase(),i=String(a.name||"").toLowerCase(),r=/usd|usdc|usdt|rlusd|eur|gbp/.test(o)||/stable/.test(i),l=/meme|dog|cat|frog|shib|pepe/.test(o)||/meme/.test(i),c=/mpt/.test(o)||/multi-purpose/.test(i);if(s.type==="stablecoin"&&!r||s.type==="meme"&&!l||s.type==="mpt"&&!c||s.type==="standard"&&(r||l||c))return!1}return!0})}function Cl(e){return[...e].sort((t,n)=>{let s=Number(t.volume24h||0),a=Number(n.volume24h||0);if(a!==s)return a-s;let o=Number(t.marketCap||0);return Number(n.marketCap||0)-o}).slice(0,24)}async function ed(e){if(Pt.loading=!0,Pt.error="",Pt.items=[],!e){Pt.loading=!1;return}try{let t=await vi(e,20);Pt.items=t||[]}catch(t){Pt.error=(t==null?void 0:t.message)||"Could not load recent transactions."}finally{Pt.loading=!1}}function td(e){j.query=e,Ms&&clearTimeout(Ms),Ms=setTimeout(()=>{j.listLimit=240,j.filtered=ss(j.query,j.tokens),W()},300)}function nd(e,t){j.filters={...j.filters,[e]:t},j.listLimit=240,j.filtered=ss(j.query,j.tokens),W()}function sd(){Ms&&clearTimeout(Ms),j.query="",j.filters={type:"all",minCap:0,minVol:0,hasDex:!1},j.listLimit=240,j.filtered=ss("",j.tokens),W()}function ad(){j.listLimit=Math.min(5e3,Number(j.listLimit||240)+240),W()}function od(){let e=j.filtered;j.listLimit=Math.min(5e3,Math.max(240,e.length)),W()}function id(){j.listLimit=240,W()}function rd(e){j.selectedTokenKey=e||"",W()}function ld(e){let t=String(e||"").trim();if(!t)return;let n=li();n.includes(t)||n.push(t),Vl(n),W()}function cd(e){let t=String(e||"").trim(),n=li().filter(s=>s!==t);Vl(n),W()}async function Da(e){let t=String(e||"").trim();if(!t)return;let n=String(t.includes("|")?t.split("|")[0]:t).toUpperCase(),s=t.includes("|")?j.tokens.find(o=>Ue(o)===t):j.tokens.find(o=>String(o.symbol||"").toUpperCase()===String(n||"").toUpperCase());j.selectedTokenKey=s?Ue(s):t.includes("|")?t:j.selectedTokenKey,P.tokenFocusKey=j.selectedTokenKey||t;let a={BTC:"BINANCE:BTCUSDT",ETH:"BINANCE:ETHUSDT",SOL:"BINANCE:SOLUSDT"};P.pair=a[n]||"BITSTAMP:XRPUSD",At(),W(),setTimeout(()=>rf(),20),await Is(),At(),W()}async function dd(e){return Da(e)}async function pd(){await Zc(),W()}async function mi(){let e=document.getElementById("xpd-lookup-currency"),t=document.getElementById("xpd-lookup-issuer"),n=String((e==null?void 0:e.value)||"").trim().toUpperCase(),s=String((t==null?void 0:t.value)||"").trim();if(!n){ge("Enter a currency code first.");return}if(!s||!Be(s)){ge("Enter a valid XRPL issuer address.");return}let a=`${n}|${s}`,o=j.tokens.find(i=>Ue(i)===a);o||(o={symbol:n,name:n,issuer:s,price:null,marketCap:null,volume24h:null,holders:null,tokenId:""},j.tokens=[...j.tokens,o],j.filtered=ss(j.query,j.tokens)),j.selectedTokenKey=a,e&&(e.value=""),t&&(t.value=""),await Da(a)}async function ud(){var s,a;let e=String(((s=document.getElementById("xpd-lookup-currency"))==null?void 0:s.value)||"").trim().toUpperCase(),t=String(((a=document.getElementById("xpd-lookup-issuer"))==null?void 0:a.value)||"").trim();if(!e){ge("Enter a currency code first.");return}if(!t||!Be(t)){ge("Enter a valid XRPL issuer address.");return}let n=`${e}|${t}`;await mi(),await ci(n)}async function md(){var t;let e=((t=Et())==null?void 0:t.address)||"";await ed(e),W()}async function es({silent:e=!1,force:t=!1}={}){var s;if(!t&&!La())return;let n=((s=Et())==null?void 0:s.address)||"";e||ae("Refreshing XRPL dashboard data..."),await Promise.allSettled([Is(),tc(),Zc(),ed(n),nc(n),sc(n),oc()]),W()}function fd(){return tc()}function hd(){var e;return nc(((e=Et())==null?void 0:e.address)||"")}function gd(){var e;return sc(((e=Et())==null?void 0:e.address)||"")}function vd(){return oc()}function bd(e){ae(`NFT ${e.slice(0,12)}... selected. Send flow can be wired to NFTokenCreateOffer.`)}function Ds(){let e=x("profile-metrics-row");if(!e)return;let t=!1,n=Object.values(Je).reduce((u,p)=>u+((p==null?void 0:p.xrp)||0),0),s=yd(),a=Object.values(Je).flatMap(u=>(u==null?void 0:u.tokens)||[]),o=Et(),i=o?Ls[o.address]:null,r=(i==null?void 0:i.ownerCount)||0,l=Ta+r*Ca,c=o!=null&&o.createdAt?$h(new Date(o.createdAt)):"\u2014",d=(i==null?void 0:i.sequence)!=null?i.sequence:"\u2014";e.innerHTML=`
    ...
    <div class="pmetric pmetric-reserve" title="${r} owned objects \xD7 ${Ca} XRP + ${Ta} XRP base">
      ...
      <div class="pmetric-label">Reserved</div></div>`:""}`,o&&(!Ls[o.address]||Date.now()-Ls[o.address].fetchedAt>6e4)&&kh(o.address).then(()=>Ds())}async function kh(e){try{let t=await nt({method:"account_info",params:[{account:e,ledger_index:"validated"}]});t!=null&&t.account_data&&(Ls[e]={sequence:t.account_data.Sequence,ownerCount:t.account_data.OwnerCount||0,fetchedAt:Date.now()})}catch{}}function $h(e){let t=Math.floor((Date.now()-e.getTime())/864e5);if(t<1)return"Today";if(t<30)return`${t}d`;if(t<365)return`${Math.floor(t/30)}mo`;let n=Math.floor(t/365),s=Math.floor(t%365/30);return s?`${n}y ${s}mo`:`${n}y`}function yd(){var t;if(Array.isArray((t=window.__dashSeries)==null?void 0:t.marketPrice)){let n=window.__dashSeries.marketPrice.at(-1);if(n!=null&&Number.isFinite(n))return n}let e=document.getElementById("mkt-price");if(e){let n=parseFloat(e.textContent.replace("$",""));if(!isNaN(n))return n}return 0}function Sh(){let e=re.length>0,t=Object.values(Ve).some(Boolean),n=!!de.bio,s=!!localStorage.getItem("naluxrp_last_backup_ts"),a=[e,t,n,s].filter(Boolean).length;return a===4?"":`
  ...
  </div>`}function fi(){let e=x("profile-tab-social");if(!e)return;let t=Object.values(Ve).filter(Boolean).length;e.innerHTML=`
    ...
    <div class="social-grid">
      ${ns.map(n=>{let s=Ve[n.id]||"",a=!!s;return`<div class="social-card ${a?"social-card--connected":""}" id="social-item-${n.id}">
    ...
    </div>`:""}`,Ma("stat-socials-val",t)}function wd(e){let t=ns.find(l=>l.id===e);if(!t)return;let n=x("social-modal");if(!n)return;let s=x("social-modal-icon"),a=x("social-modal-title"),o=x("social-modal-sub"),i=x("social-modal-input"),r=x("social-modal-delete");s&&(s.className=`social-platform-icon-lg social-icon ${t.id}`,s.textContent=t.icon),a&&(a.textContent=`Connect ${t.label}`),o&&(o.textContent=`Enter your ${t.label} ${t.id==="discord"?"user ID or username":"username"}.`),i&&(i.value=Ve[e]||"",i.placeholder=`Your ${t.label} handle`),r&&(r.style.display=Ve[e]?"":"none"),n.dataset.platform=e,n.classList.add("show"),setTimeout(()=>i==null?void 0:i.focus(),80)}function xd(){let e=x("social-modal"),t=e==null?void 0:e.dataset.platform,n=x("social-modal-input");if(!t||!n)return;let s=n.value.trim().replace(/^@/,"");s?Ve[t]=s:delete Ve[t],jl(),fi(),as();let a=ns.find(o=>o.id===t);sg(),kt("social_connected",`${(a==null?void 0:a.label)||t} @${s||"(removed)"}`),ae(`${a==null?void 0:a.label} updated`)}function kd(){var t;let e=(t=x("social-modal"))==null?void 0:t.dataset.platform;e&&(delete Ve[e],jl(),fi(),as(),kt("social_removed",e),ae("Social connection removed"))}function $d(e){let t=ns.find(n=>n.id===e);t&&Ve[e]&&window.open(`${t.prefix}${Ve[e]}`,"_blank","noopener")}function as(){var e;(e=x("social-modal"))==null||e.classList.remove("show")}function $t(){let e=x("profile-tab-wallets");if(!e)return;if(re.length===0){e.innerHTML=Sh()+`
    ...
    </div>`:"",n=re.filter(a=>!Zn||a.label.toLowerCase().includes(Zn.toLowerCase())||a.address.toLowerCase().includes(Zn.toLowerCase())),s=n.map((a,o)=>Th(a,re.indexOf(a))).join("");e.innerHTML=t+(n.length?s:`<div class="wcard-empty">No wallets match "${y(Zn)}"</div>`)+`
    ...
    </div>`,Ma("stat-wallets-val",re.length)}function Th(e,t){let n=e.id===dt,s=!!e.watchOnly,a=Je[e.address],o=Ls[e.address],r=!0||s,l=(o==null?void 0:o.ownerCount)||0,c=Ta+l*Ca,d=r?a?_(a.xrp,2):"\u2014":"\u2022\u2022\u2022\u2022",u=a&&r?Math.max(0,a.xrp-c):null,p=(a==null?void 0:a.tokens)||[],m=a!=null&&a.fetchedAt?Wl(a.fetchedAt):null,f=e.address.slice(0,8)+"\u2026"+e.address.slice(-6),h=gi(e.address);return`
  <div class="wcard ${n?"wcard--active":""} ${s?"wcard--watch":""}" id="wallet-item-${e.id}" style="--i:${t}">
    <div class="wcard-top">
      ...
      <div class="wcard-balance-col">
        ${h.length>=2?`<div class="wcard-sparkline">${Ad(h,70,22,e.color||"#00fff0")}</div>`:""}
    ...
    ${p.length&&r?`<div class="wcard-token-row">
      ${p.slice(0,6).map(b=>{let g=b.currency.length>4?ki(b.currency)||b.currency.slice(0,4)+"\u2026":b.currency;return`<div class="wcard-token-chip" onclick="openTokenDetailsModal('${y(b.currency)}','${y(b.issuer)}','${y(e.address)}')" title="${y(b.currency)}">
    ...
    <div class="wcard-drawer" id="wcard-drawer-${e.id}">
      <div class="wcard-drawer-tabs">
        <button class="wdt-btn ${(cn[e.id]||"txns")==="txns"?"active":""}" onclick="switchWalletDrawerTab('${e.id}','txns')">\u{1F4CB} Transactions</button>
        <button class="wdt-btn ${(cn[e.id]||"txns")==="nfts"?"active":""}" onclick="switchWalletDrawerTab('${e.id}','nfts')">\u{1F3A8} NFTs</button>
        <button class="wdt-btn ${(cn[e.id]||"txns")==="orders"?"active":""}" onclick="switchWalletDrawerTab('${e.id}','orders')">\u{1F4CA} DEX</button>
        <button class="wdt-btn ${(cn[e.id]||"txns")==="amm"?"active":""}" onclick="switchWalletDrawerTab('${e.id}','amm')">\u{1F30A} AMM</button>
      </div>
      <div class="wcard-drawer-body" id="wcard-drawer-body-${e.id}">
        <div class="wdd-loading"><div class="spinner"></div> Loading\u2026</div>
      </div>
    </div>`:""}
  </div>`}function Sd(e){var n;let t=re[e];t&&(re.splice(e,1),Rs(),dt===t.id&&(dt=((n=re[0])==null?void 0:n.id)||null,dt&&Z(Es,dt)),$t(),Bt(),kt("wallet_removed",t.label),Ch(`Wallet "${t.label}" removed`,()=>{re.splice(e,0,t),Rs(),dt||(dt=t.id,Z(Es,t.id)),$t(),Bt(),kt("wallet_created",t.label+" (restored)")},()=>{t.address&&vt(ei+t.address)}))}function Ch(e,t,n){let s=document.getElementById("undo-toast");s&&s.remove();let a=document.createElement("div");a.id="undo-toast",a.className="undo-toast",a.innerHTML=`<span class="undo-msg">${y(e)}</span><button class="undo-btn">Undo</button>`,document.body.appendChild(a),requestAnimationFrame(()=>a.classList.add("show"));let o=setTimeout(()=>{a.classList.remove("show"),setTimeout(()=>a.remove(),300),n==null||n()},5e3);a.querySelector(".undo-btn").addEventListener("click",()=>{clearTimeout(o),t(),a.classList.remove("show"),setTimeout(()=>a.remove(),300),ae("Wallet restored")})}function Td(e){var n,s;let t=x("inspect-addr");t&&(t.value=e),(n=window.switchTab)==null||n.call(window,document.querySelector('[data-tab="inspector"]'),"inspector"),(s=window.showDashboard)==null||s.call(window)}function Cd(e){Rn=Rn===e?null:e,Rn&&!cn[e]&&(cn[e]="txns"),$t(),Rn&&setTimeout(()=>hi(e,cn[e]),60)}function Pd(e,t){cn[e]=t;let n=document.getElementById(`wcard-drawer-${e}`);n&&(n.querySelectorAll(".wdt-btn").forEach(s=>s.classList.toggle("active",s.textContent.toLowerCase().includes(t==="txns"?"trans":t==="nfts"?"nft":t==="orders"?"dex":"amm"))),hi(e,t))}async function hi(e,t){var a,o,i;let n=re.find(r=>r.id===e),s=document.getElementById(`wcard-drawer-body-${e}`);if(!(!n||!s)){s.innerHTML='<div class="wdd-loading"><div class="spinner"></div> Loading\u2026</div>';try{t==="txns"?s.innerHTML=Ph(((a=ni[n.address])==null?void 0:a.txns)||await vi(n.address),n.address):t==="nfts"?s.innerHTML=Lh(((o=Nl[n.address])==null?void 0:o.nfts)||await Xh(n.address),n.address):t==="orders"?s.innerHTML=Mh(((i=si[n.address])==null?void 0:i.offers)||await Hh(n.address),n.id,n.address):t==="amm"&&(s.innerHTML=await Ah(n.address))}catch(r){s.innerHTML=`<div class="wdd-error">\u26A0\uFE0F ${y(r.message)}</div>`}}}function Ld(e){return{Payment:"\u{1F4B8}",OfferCreate:"\u{1F4CA}",OfferCancel:"\u2715",TrustSet:"\u{1F517}",NFTokenMint:"\u{1F3A8}",NFTokenBurn:"\u{1F525}",NFTokenCreateOffer:"\u{1F3AF}",NFTokenAcceptOffer:"\u2705",AMMCreate:"\u{1F30A}",AMMDeposit:"\u{1F4E5}",AMMWithdraw:"\u{1F4E4}",AMMVote:"\u{1F5F3}",AMMBid:"\u{1F4A1}",EscrowCreate:"\u23F3",EscrowFinish:"\u2705",EscrowCancel:"\u2715",AccountSet:"\u2699",SetRegularKey:"\u{1F511}",SignerListSet:"\u{1F4CB}"}[e]||"\u{1F4C4}"}function Zo(e){return e?typeof e=="string"?`${_(Number(e)/1e6,4)} XRP`:`${_(parseFloat(e.value||0),4)} ${(e.currency||"?").length>4?e.currency.slice(0,4)+"\u2026":e.currency}`:"\u2014"}function Ph(e,t){return e!=null&&e.length?`<div class="wdd-tx-list">
    ${e.slice(0,25).map(n=>{var c,d;let s=n.TransactionType||"?",a=n.Account===t,o=!(((c=n.metaData)==null?void 0:c.TransactionResult)||((d=n.meta)==null?void 0:d.TransactionResult)||"").match(/^tec|^tem|^tef|^tel/),i=n.date?(n.date+946684800)*1e3:0,r=i?new Date(i).toLocaleDateString("en-US",{month:"short",day:"numeric",hour:"2-digit",minute:"2-digit"}):"\u2014",l=n.hash||n.tx_hash||"";return`<div class="wdd-tx-row ${o?"":"wdd-tx-failed"}">
        ...
        <div class="wdd-tx-body">
          ...
          <div class="wdd-tx-detail">
            ...
            ${n.Destination?`<span class="wdd-tx-dest mono">${Rl[n.Destination]||n.Destination.slice(0,8)+"\u2026"+n.Destination.slice(-5)}</span>`:""}
          </div>
        </div>
  ...
  </div>`:'<div class="wdd-empty"><div class="wdd-empty-icon">\u{1F4CB}</div><div>No transactions yet.</div><div class="wdd-empty-sub">Fund with 10 XRP to activate.</div></div>'}function Lh(e,t){return e!=null&&e.length?`<div class="wdd-nft-header"><span>${e.length} NFT${e.length>1?"s":""}</span>
    ...
    ${e.length>24?`<div class="wdd-more-note">${e.length-24} more on XRPScan</div>`:""}`:'<div class="wdd-empty"><div class="wdd-empty-icon">\u{1F3A8}</div><div>No NFTs in this wallet.</div></div>'}function Mh(e,t,n){return e!=null&&e.length?`<div class="wdd-orders-header"><span>${e.length} open order${e.length>1?"s":""}</span></div>
    ...
    </div>`:'<div class="wdd-empty"><div class="wdd-empty-icon">\u{1F4CA}</div><div>No open DEX orders.</div></div>'}async function Ah(e){try{let n=(ti[e]||[]).filter(s=>{var a;return((a=s.currency)==null?void 0:a.length)===40});return n.length?`<div class="wdd-amm-list">
    ...
    </div>`:'<div class="wdd-empty"><div class="wdd-empty-icon">\u{1F30A}</div><div>No AMM LP positions.</div><div class="wdd-empty-sub">Deposit into an AMM pool to earn fees.</div></div>'}catch(t){return`<div class="wdd-error">\u26A0\uFE0F ${y(t.message)}</div>`}}async function Md(e,t,n){let s=prompt("Optional seed to cancel this order (leave blank to use wallet password):");if(s!==null){n&&(n.disabled=!0,n.textContent="\u2026");try{let a=await Vh(e,t,s);if(jh(a)){ae("Order cancelled \u2713");let o=re.find(i=>i.id===e);o&&(delete si[o.address],hi(e,"orders"))}else Ut("Cancel failed: "+Wh(a)),n&&(n.disabled=!1,n.textContent="\u2715 Cancel")}catch(a){Ut(a.message),n&&(n.disabled=!1,n.textContent="\u2715 Cancel")}}}function Eh(){let e=x("profile-tab-activity");if(!e)return;let t=pf(),n=Et();e.innerHTML=`
    <div class="act-section-row">
      <div class="act-section">
        ...
        ${t.length?`<div class="act-timeline">${t.slice(0,20).map(s=>`
            <div class="act-entry">
              <div class="act-entry-icon">${af[s.type]||"\u25CF"}</div>
              <div class="act-entry-body">
                <div class="act-entry-detail">${y(s.detail)}</div>
                <div class="act-entry-time">${Wl(s.ts)}</div>
              </div>
    ...
    <div class="settings-card">
      ...
      <div class="settings-kv-list">
        ...
        <div class="settings-kv"><span class="settings-k">Vault created</span><span class="settings-v">${y((i=(o=Ge.vault)==null?void 0:o.identity)!=null&&i.createdAt?new Date(Ge.vault.identity.createdAt).toLocaleDateString():"\u2014")}</span></div>
    ...
    <div class="settings-card settings-card--danger">
  ...
  </div>`}async function Nh(){var t;let e=x("profile-tab-analytics");if(e){e.innerHTML='<div class="analytics-grid"><div class="skeleton-card analytics-card--wide" style="height:80px"></div><div class="skeleton-card" style="height:160px"></div><div class="skeleton-card" style="height:160px"></div></div>';try{let n=Et(),s=Object.values(Je).reduce((r,l)=>r+((l==null?void 0:l.xrp)||0),0),a=yd(),o=Object.values(Je).flatMap(r=>(r==null?void 0:r.tokens)||[]),i=[];if(n)try{i=((t=ni[n.address])==null?void 0:t.txns)||await vi(n.address,100)}catch{}e.innerHTML=`<div class="analytics-grid">
      <div class="analytics-card analytics-card--wide">
        ...
        <div class="portfolio-summary-row">
          ${re.length?re.map(r=>{let l=Je[r.address],c=l?_(l.xrp,2):"\u2014",d=l&&a?`$${_(l.xrp*a,2)}`:"",u=gi(r.address);return`<div class="portfolio-wallet-row">
                ...
                <div class="pwr-sparkline">${Ad(u,80,28,r.color||"#00fff0")}</div>
      ...
      <div class="analytics-card analytics-card--wide">
        ...
        ${n?_h(i):'<div class="analytics-empty">Activate a wallet to see activity.</div>'}
      </div>
      ...
      <div class="analytics-card">
        ...
        ${i.length?Dh(i):'<div class="analytics-empty-chart"><div class="aec-icon">\u{1F4CA}</div><div>Transaction breakdown builds up as this wallet transacts.</div></div>'}
      </div>
      ...
      <div class="analytics-card">
        ...
        ${n&&i.length?Fh(i,n.address):`<div class="analytics-empty-chart"><div class="aec-icon">\u{1F4B0}</div><div>${n?"XRP flow needs at least one transaction to estimate.":"Activate a wallet to see XRP flow."}</div></div>`}
      </div>
      ...
      <div class="analytics-card">
        ...
        ${o.length?Ih(o):'<div class="analytics-empty-chart"><div class="aec-icon">\u{1FA99}</div><div>No token trustlines held by any wallet yet.</div></div>'}
      </div>
    </div>`}catch(n){cf(e,"analytics",n)}}}function Ad(e,t,n,s){if(e.length<2)return`<svg width="${t}" height="${n}"><line x1="0" y1="${n/2}" x2="${t}" y2="${n/2}" stroke="${s}" stroke-opacity=".2" stroke-width="1" stroke-dasharray="3 2"/></svg>`;let a=e.map(u=>u.xrp),o=Math.min(...a),i=Math.max(...a),r=i-o||1,l=a.map((u,p)=>`${3+p/(a.length-1)*(t-6)},${3+(1-(u-o)/r)*(n-6)}`),[c,d]=l[l.length-1].split(",");return`<svg width="${t}" height="${n}" viewBox="0 0 ${t} ${n}">
  ...
  </svg>`}function Rh(e){let t=gi(e);if(t.length<2)return`<div class="analytics-empty-chart"><div class="aec-icon">\u{1F4CA}</div><div>Balance history builds up as you refresh your wallet over time.</div><div class="aec-sub">${t.length} snapshot${t.length!==1?"s":""} recorded.</div></div>`;let n=560,s=130,a=52,o=12,i=14,r=30,l=t.map(R=>R.xrp),c=t.map(R=>R.ts),d=Math.min(...l),u=Math.max(...l),p=u-d||1,m=c[0],f=c[c.length-1],h=f-m||1,b=R=>a+(R-m)/h*(n-a-o),g=R=>i+(1-(R-d)/p)*(s-i-r),v=t.map(R=>`${b(R.ts).toFixed(1)},${g(R.xrp).toFixed(1)}`),w=b(c[0]),k=b(c[c.length-1]),$=l[l.length-1]-l[0],T=$>=0,S=l[0]?Math.abs($/l[0]*100).toFixed(2):"0.00",M=T?"#00d4ff":"#ff5555",C=[d,(d+u)/2,u].map(R=>({v:R,y:g(R),l:_(R,2)})),A=[0,.5,1].map(R=>({x:a+R*(n-a-o),l:new Date(m+R*h).toLocaleDateString("en-US",{month:"short",day:"numeric"})}));return`
    ...
    <div class="balance-chart-wrap"><svg class="balance-chart-svg" viewBox="0 0 ${n} ${s}" preserveAspectRatio="none">
      ...
      ${t.map(R=>`<circle cx="${b(R.ts).toFixed(1)}" cy="${g(R.xrp).toFixed(1)}" r="2" fill="${M}" opacity=".7"/>`).join("")}
  ...
  </svg></div>`}function Dh(e){let t=new Map;e.forEach(a=>t.set(a.TransactionType||"?",(t.get(a.TransactionType||"?")||0)+1));let n=[...t.entries()].sort((a,o)=>o[1]-a[1]),s=e.length;return`<div class="tx-breakdown-list">${n.slice(0,8).map(([a,o])=>`<div class="txb-row"><div class="txb-icon">${Ld(a)}</div><div class="txb-type">${a}</div><div class="txb-bar-wrap"><div class="txb-bar" style="width:${(o/s*100).toFixed(0)}%"></div></div><div class="txb-count">${o}</div></div>`).join("")}</div>`}function Ih(e){let t=new Map;e.forEach(o=>{let i=Math.abs(parseFloat(o.balance||0));t.set(o.currency,(t.get(o.currency)||0)+i)});let n=[...t.entries()].sort((o,i)=>i[1]-o[1]).slice(0,8),s=n.reduce((o,[,i])=>o+i,0)||1,a=["#00fff0","#00d4ff","#bd93f9","#50fa7b","#ffb86c","#ff79c6","#f1fa8c","#ff5555"];return`<div class="token-alloc-list">${n.map(([o,i],r)=>{let l=(i/s*100).toFixed(1),c=a[r%a.length],d=o.length>4?o.slice(0,4)+"\u2026":o;return`<div class="ta-row"><div class="ta-swatch" style="background:${c}"></div><div class="ta-cur mono">${d}</div><div class="ta-bar-wrap"><div class="ta-bar" style="width:${l}%;background:${c}20;border-color:${c}55"></div></div><div class="ta-pct">${l}%</div></div>`}).join("")}</div>`}function Fh(e,t){let n=0,s=0;e.forEach(i=>{var c,d;if(i.TransactionType!=="Payment"||!((((c=i.metaData)==null?void 0:c.TransactionResult)||((d=i.meta)==null?void 0:d.TransactionResult))==="tesSUCCESS")||typeof i.Amount!="string")return;let l=Number(i.Amount)/1e6;i.Destination===t&&(n+=l),i.Account===t&&(s+=l)});let a=n-s,o=a>=0;return`<div class="xrp-flow-grid">
  ...
  <div class="xrf-note">Based on ${e.length} fetched Payment TXs. Excludes fees and DEX fills.</div>`}async function nt(e){var n,s;try{if(((n=B.wsConn)==null?void 0:n.readyState)===1){let{wsSend:a}=await import("./xrpl-6AERZ5KD.js"),o={command:e==null?void 0:e.method,...((s=e==null?void 0:e.params)==null?void 0:s[0])||{}},i=await a(o);if((i==null?void 0:i.status)==="error")throw new Error(i.error_message||i.error||"XRPL RPC error");return(i==null?void 0:i.result)||null}}catch{}let t=async a=>{let o=await fetch(a,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(e),mode:"cors"});if(!o.ok)throw new Error(`HTTP ${o.status}`);return(await o.json()).result};try{return await t(Dm)}catch{return await t(Im)}}async function Fn(e){var t;try{let n=[],s;do{let l=await nt({method:"account_lines",params:[{account:e,ledger_index:"current",limit:400,...s?{marker:s}:{}}]});if(!l||l.error)break;n.push(...l.lines||[]),s=l.marker}while(s);let a=await nt({method:"account_info",params:[{account:e,ledger_index:"current"}]});if(a!=null&&a.error)return null;let o=Number(a.account_data.Balance)/1e6,i=n.map(l=>({currency:l.currency,issuer:l.account,balance:l.balance,limit:l.limit}));Je[e]={xrp:o,tokens:i,fetchedAt:Date.now()},ti[e]=i,Bh(e,o);let r=document.getElementById("awb-balance");return r&&e===((t=Et())==null?void 0:t.address)&&ag(r.querySelector(".awb-xrp-num")||r,o,2,600),Je[e]}catch{return null}}async function Oh(){await Promise.allSettled(re.map(e=>Fn(e.address))),$t(),Bt(),Ds()}function Bh(e,t){let n=ei+e,s=ve(Q(n))||[],a=Date.now();s.length&&a-s[s.length-1].ts<5*6e4?s[s.length-1]={xrp:t,ts:a}:s.push({xrp:t,ts:a}),s.length>90&&s.splice(0,s.length-90),Z(n,JSON.stringify(s))}function gi(e){return ve(Q(ei+e))||[]}async function vi(e,t=25){let n=await nt({method:"account_tx",params:[{account:e,limit:t,ledger_index_min:-1,ledger_index_max:-1}]}),s=((n==null?void 0:n.transactions)||[]).map(a=>a.tx||a.transaction||a);return ni[e]={txns:s,fetchedAt:Date.now()},s}async function Xh(e){let t=await nt({method:"account_nfts",params:[{account:e,limit:50}]}),n=(t==null?void 0:t.account_nfts)||[];return Nl[e]={nfts:n,fetchedAt:Date.now()},n}async function Hh(e){let t=await nt({method:"account_offers",params:[{account:e,limit:50}]}),n=(t==null?void 0:t.offers)||[];return si[e]={offers:n,fetchedAt:Date.now()},n}async function zh(e){let t=await nt({method:"account_info",params:[{account:e,ledger_index:"current"}]});return(t==null?void 0:t.account_data)||null}async function Uh(){let e=await nt({method:"ledger",params:[{ledger_index:"current"}]});return(e==null?void 0:e.ledger_current_index)||0}function jh(e){let t=(e==null?void 0:e.engine_result)||"";return t==="tesSUCCESS"||t.startsWith("tes")||(e==null?void 0:e.engine_result_code)===0}function Wh(e){let t=(e==null?void 0:e.engine_result)||"";return qm[t]||(e==null?void 0:e.engine_result_message)||t||"Unknown error"}async function qh(e,t,n){if(await Aa(),!window.xrpl)throw new Error("xrpl.js library not loaded. Cannot sign transactions.");let s=re.find(i=>i.id===e);if(!s)throw new Error("Wallet not found.");if(s.watchOnly)throw new Error("Watch-only wallets cannot sign transactions.");let a=await Km(s,n),o;try{o=window.xrpl.Wallet.fromSeed(a,{algorithm:s.algo==="secp256k1"?"secp256k1":"ed25519"})}catch(i){throw new Error("Invalid seed phrase: "+i.message)}if(o.classicAddress!==s.address)throw new Error("Seed does not match this wallet address.");try{let[i,r]=await Promise.all([zh(s.address),Uh()]);if(!i)throw new Error("Account not found on-chain. Fund with at least 10 XRP first (base reserve requirement).");let l={...t,Account:s.address,Fee:"12",Sequence:i.Sequence,LastLedgerSequence:r+20},{tx_blob:c,hash:d}=o.sign(l);return{...await nt({method:"submit",params:[{tx_blob:c}]}),tx_hash:d}}finally{}}async function Vh(e,t,n){return qh(e,{TransactionType:"OfferCancel",OfferSequence:parseInt(t)},n)}function Gh(){if(x("send-modal-overlay"))return;let e=document.createElement("div");e.innerHTML=`
  <!-- Send -->
  ...
  <div class="generic-modal-overlay" id="token-details-modal">
  ...
  </div>`,document.body.appendChild(e),["send-modal-overlay","receive-modal-overlay","trustline-modal-overlay","import-address-modal","import-seed-modal","token-details-modal"].forEach(t=>{let n=document.getElementById(t);n==null||n.addEventListener("click",s=>{s.target===n&&(n.classList.remove("show"),n.style.display="")})})}function Ed(){var o;["displayName","handle","bio","location","website"].forEach(i=>{let r=x(`edit-${i}`);r&&(r.value=de[i]||"")});let e=x("editor-avatar-preview");if(e){let i=localStorage.getItem(dn);e.innerHTML=i?`<img src="${i}" class="profile-avatar-img"/>`:de.avatar||"\u{1F30A}"}let t=x("avatar-remove-btn");t&&(t.style.display=localStorage.getItem(dn)?"":"none");let n=x("editor-banner-preview");if(n){let i=localStorage.getItem(Dn);n.style.backgroundImage=i?`url(${i})`:"",n.style.backgroundSize="cover",n.style.backgroundPosition="center",Ns.forEach(r=>n.classList.remove(r)),i||n.classList.add(de.banner||"banner-ocean")}let s=x("avatar-picker-grid");s&&(s.innerHTML=Um.map(i=>`<div class="avatar-option ${de.avatar===i?"active":""}" onclick="selectAvatar('${i}')">${i}</div>`).join(""));let a=x("banner-picker-grid");a&&(a.innerHTML=Ns.map(i=>`<div class="banner-option ${i} ${de.banner===i?"active":""}" onclick="selectBanner('${i}')"></div>`).join("")),(o=x("profile-editor-modal"))==null||o.classList.add("show")}function Bs(){var e;(e=x("profile-editor-modal"))==null||e.classList.remove("show")}function Nd(){var e,t,n,s,a;de.displayName=((e=x("edit-displayName"))==null?void 0:e.value.trim())||de.displayName,de.handle=(((t=x("edit-handle"))==null?void 0:t.value.trim())||de.handle).replace(/^@/,"").replace(/\s+/g,"_").toLowerCase(),de.bio=((n=x("edit-bio"))==null?void 0:n.value.trim())||"",de.location=((s=x("edit-location"))==null?void 0:s.value.trim())||"",de.website=((a=x("edit-website"))==null?void 0:a.value.trim())||"",Ul(),kt("profile_saved","Profile details updated"),W(),Bs(),ae("Profile saved")}function Rd(e){localStorage.removeItem(dn),de.avatar=e,Oe(".avatar-option").forEach(s=>s.classList.toggle("active",s.textContent===e));let t=x("editor-avatar-preview");t&&(t.innerHTML=e);let n=x("avatar-remove-btn");n&&(n.style.display="none")}function _d(e){localStorage.removeItem(Dn),de.banner=e,Oe(".banner-option").forEach(n=>n.classList.toggle("active",n.classList.contains(e)));let t=x("editor-banner-preview");t&&(t.style.backgroundImage="",Ns.forEach(n=>t.classList.remove(n)),t.classList.add(e)),W()}function Dd(e){var s;let t=(s=e==null?void 0:e.files)==null?void 0:s[0];if(!t)return;if(t.size>2*1024*1024){ge("Image too large \u2014 max 2 MB");return}let n=new FileReader;n.onload=a=>{let o=new Image;o.onload=()=>{let i=document.createElement("canvas");i.width=i.height=200;let r=i.getContext("2d"),l=Math.min(o.width,o.height);r.drawImage(o,(o.width-l)/2,(o.height-l)/2,l,l,0,0,200,200);let c=i.toDataURL("image/jpeg",.85);localStorage.setItem(dn,c);let d=x("editor-avatar-preview");d&&(d.innerHTML=`<img src="${c}" class="profile-avatar-img"/>`);let u=x("avatar-remove-btn");u&&(u.style.display=""),W(),ae("Profile photo updated")},o.src=a.target.result},n.readAsDataURL(t),e.value=""}function Id(){localStorage.removeItem(dn);let e=x("editor-avatar-preview");e&&(e.innerHTML=de.avatar||"\u{1F30A}");let t=x("avatar-remove-btn");t&&(t.style.display="none"),W()}function Fd(e){var s;let t=(s=e==null?void 0:e.files)==null?void 0:s[0];if(!t)return;if(t.size>5*1024*1024){ge("Image too large \u2014 max 5 MB");return}let n=new FileReader;n.onload=a=>{let o=new Image;o.onload=()=>{let i=document.createElement("canvas");i.width=900,i.height=180;let r=i.getContext("2d"),l=Math.max(900/o.width,180/o.height);r.drawImage(o,(900-o.width*l)/2,(180-o.height*l)/2,o.width*l,o.height*l);let c=i.toDataURL("image/jpeg",.88);localStorage.setItem(Dn,c);let d=x("editor-banner-preview");d&&(d.style.backgroundImage=`url(${c})`,d.style.backgroundSize="cover",d.style.backgroundPosition="center",Ns.forEach(p=>d.classList.remove(p)));let u=x("banner-remove-btn");u&&(u.style.display=""),W(),ae("Banner updated")},o.src=a.target.result},n.readAsDataURL(t),e.value=""}function Od(){localStorage.removeItem(Dn);let e=x("editor-banner-preview");e&&(e.style.backgroundImage="",Ns.forEach(n=>e.classList.remove(n)),e.classList.add(de.banner||"banner-ocean"));let t=x("banner-remove-btn");t&&(t.style.display="none"),W()}function Kh(){let e=re.map(({id:n,label:s,address:a,algo:o,emoji:i,color:r,testnet:l,watchOnly:c,createdAt:d})=>({id:n,label:s,address:a,algo:o,emoji:i,color:r,testnet:l,watchOnly:c,createdAt:d})),t=document.createElement("a");t.href="data:application/json;charset=utf-8,"+encodeURIComponent(JSON.stringify(e,null,2)),t.download=`nalulf-wallets-${new Date().toISOString().slice(0,10)}.json`,t.click(),kt("backup_exported","Wallet addresses exported"),ae("Wallet addresses exported")}function Bd(){Kh()}function bi(){var e;wt=1,ye={algo:"ed25519",label:"",emoji:"\u{1F48E}",color:"#50fa7b",seed:"",address:"",passphrase:""},_n.clear(),yi(1),Yh(),Jh(),(e=x("wallet-creator-overlay"))==null||e.classList.add("show"),setTimeout(()=>{var t;return(t=x("wallet-label-input"))==null?void 0:t.focus()},80)}function Xs(){var e;(e=x("wallet-creator-overlay"))==null||e.classList.remove("show"),ye.seed=ye.address=ye.passphrase=""}function Jh(){let e=x("wizard-security-banner");e&&(e.innerHTML=`<div class="wsb-icon">\u{1F510}</div>
    ...
    </div>`)}async function Xd(){var e,t,n;if(wt===1){let s=(e=x("wallet-label-input"))==null?void 0:e.value.trim(),a=((t=x("wallet-pass-input"))==null?void 0:t.value)||"",o=((n=x("wallet-pass-confirm"))==null?void 0:n.value)||"";if(!s){ge("Enter a wallet name.");return}if(a.length<10){ge("Use a wallet password with at least 10 characters.");return}if(a!==o){ge("Wallet password confirmation does not match.");return}if(ye.label=s,ye.passphrase=a,!Qh())return;wt=2}else if(wt===2){if(_n.size<4){ge("Confirm all 4 security checkpoints first.");return}wt=3}else if(wt===3)try{await eg(),wt=4}catch{return}yi(wt)}function Hd(){if(wt<=1){Xs();return}wt--,yi(wt)}function yi(e){var a;[1,2,3,4].forEach(o=>{let i=document.querySelector(`.step-${o}`);i&&(i.classList.toggle("active",o===e),i.classList.toggle("done",o<e))}),Oe(".wizard-panel").forEach(o=>o.classList.remove("active")),(a=x(`wizard-panel-${e}`))==null||a.classList.add("active");let t=x("wizard-back-btn"),n=x("wizard-next-btn"),s=x("wizard-finish-btn");t&&(t.style.display=e===4?"none":"",t.textContent=e===1?"Cancel":"\u2190 Back"),n&&(n.style.display=e>=3?"none":""),s&&(s.style.display=e===3?"":"none")}function Yh(){let e=x("wallet-emoji-picker");e&&(e.innerHTML=jm.map(n=>`<div class="wallet-emoji-opt ${ye.emoji===n?"active":""}" onclick="selectWalletEmoji('${n}')">${n}</div>`).join(""));let t=x("wallet-color-picker");t&&(t.innerHTML=Wm.map(n=>`<div class="color-swatch ${ye.color===n?"active":""}" style="background:${n}" onclick="selectWalletColor('${n}')"></div>`).join(""))}function Qh(){var n;if(!((n=window.xrpl)!=null&&n.Wallet))return Ut("xrpl.js is not available yet. Please wait a moment and try again."),Aa().catch(()=>{}),!1;try{let s=window.xrpl.Wallet.generate(ye.algo==="ed25519"?"ed25519":"secp256k1");ye.seed=s.seed||"",ye.address=s.classicAddress}catch(s){return Ut("Failed to generate a valid XRPL wallet: "+((s==null?void 0:s.message)||"Unknown error")),!1}let e=x("wizard-seed-value"),t=x("wizard-address-value");return e&&(e.textContent=ye.seed),t&&(t.textContent=ye.address),_n.clear(),Oe(".security-check").forEach(s=>s.classList.remove("checked")),Oe(".check-box").forEach(s=>s.textContent=""),Zh(),qd(),e&&setTimeout(()=>e.classList.add("blur"),3e4),!0}function Zh(){let e=x("security-checklist-dynamic");if(!e)return;let t=[{icon:"\u270D\uFE0F",title:"Write it on paper right now",body:"Copy your seed phrase onto paper and store it in a safe place. This is your ONLY recovery option if you lose access to this device."},{icon:"\u{1F6AB}",title:"Never store it digitally",body:"No notes apps, emails, screenshots, or cloud drives. A device with a digital copy that gets hacked means instant loss of funds."},{icon:"\u{1F92B}",title:"Never share it with anyone",body:"No legitimate app, exchange, or support team will ever ask for your seed. Anyone who asks is attempting to steal your funds."},{icon:"\u{1F510}",title:"Use a strong unique password",body:"Your password protects the encrypted seed on this device. Use one you don't use anywhere else."}];e.innerHTML=t.map((n,s)=>`
    ...
    </div>`).join("")}async function eg(){var n;let e=await El(ye.seed,ye.passphrase),t={id:crypto.randomUUID(),label:ye.label,address:ye.address,algo:ye.algo,emoji:ye.emoji,color:ye.color,testnet:((n=x("wallet-testnet-check"))==null?void 0:n.checked)||!1,watchOnly:!1,encSeed:e,createdAt:new Date().toISOString()};re.push(t),Rs(),dt||(dt=t.id,Z(Es,t.id)),$t(),Bt(),Ma("wallet-success-address",ye.address),setTimeout(()=>{ye.seed="",ye.address="",ye.passphrase=""},100),kt("wallet_created",ye.label||"New XRPL Wallet"),ae("Wallet created and encrypted locally"),Fn(t.address).then(()=>$t())}function zd(e){ye.algo=e,Oe(".algo-card").forEach(t=>t.classList.toggle("active",t.dataset.algo===e))}function Ud(e){ye.emoji=e,Oe(".wallet-emoji-opt").forEach(t=>t.classList.toggle("active",t.textContent===e))}function jd(e){ye.color=e,Oe(".color-swatch").forEach(t=>t.classList.toggle("active",t.style.background===e||t.dataset.color===e))}function Wd(e){let t=document.querySelector(`.security-check-${e}`);if(!t)return;let n=t.querySelector(".check-box");_n.has(e)?(_n.delete(e),t.classList.remove("checked"),n&&(n.textContent="")):(_n.add(e),t.classList.add("checked"),n&&(n.textContent="\u2713")),qd()}function qd(){let e=x("wizard-next-btn");e&&wt===2&&(e.disabled=_n.size<4)}function Vd(){var t;(t=x("wizard-seed-value"))==null||t.classList.remove("blur");let e=x("seed-reveal-hint");e&&(e.style.display="none"),setTimeout(()=>{var n;return(n=x("wizard-seed-value"))==null?void 0:n.classList.add("blur")},3e4)}function Gd(){let e=x("wizard-seed-value");if(!e)return;Ia(e.textContent,3e4);let t=x("btn-copy-seed");t&&(t.textContent="Copied!",t.classList.add("copied"),setTimeout(()=>{t.textContent="Copy Seed",t.classList.remove("copied")},2e3))}function Kd(){let e=x("wizard-address-value")||x("wallet-success-address");if(!e)return;Ia(e.textContent);let t=x("btn-copy-addr");t&&(t.textContent="Copied!",t.classList.add("copied"),setTimeout(()=>{t.textContent="Copy",t.classList.remove("copied")},2e3))}function Jd(){let e=x("import-address-modal");if(!e)return;e.querySelector("#inp-import-address").value="",e.querySelector("#inp-import-label").value="";let t=e.querySelector("#import-address-error");t&&(t.textContent=""),e.classList.add("show"),setTimeout(()=>{var n;return(n=e.querySelector("#inp-import-address"))==null?void 0:n.focus()},80)}function wi(){var e;(e=x("import-address-modal"))==null||e.classList.remove("show")}function Yd(){var s,a;let e=(((s=x("inp-import-address"))==null?void 0:s.value)||"").trim(),t=(((a=x("inp-import-label"))==null?void 0:a.value)||"").trim()||"Watch Wallet",n=x("import-address-error");if(!Be(e)){n&&(n.textContent="Enter a valid XRPL address (starts with r\u2026)");return}if(re.find(o=>o.address===e)){n&&(n.textContent="This address is already in your list.");return}re.push({id:"watch_"+Date.now(),label:t,address:e,algo:"\u2014",emoji:"\u{1F441}",color:"#8be9fd",testnet:!1,createdAt:new Date().toISOString(),watchOnly:!0}),Rs(),kt("watch_added",`${t} (${e.slice(0,8)}\u2026)`),wi(),$t(),Bt(),Ds(),Fn(e).then(()=>{$t(),Ds()}),ae(`\u{1F441} Watch-only wallet added: ${t}`)}function Qd(){let e=x("import-seed-modal");if(!e)return;e.querySelector("#inp-import-seed").value="",e.querySelector("#inp-import-seed-pass").value="",e.querySelector("#inp-import-seed-pass-confirm").value="",e.querySelector("#inp-import-seed-label").value="";let t=e.querySelector("#import-seed-error");t&&(t.textContent=""),e.classList.add("show"),setTimeout(()=>{var n;return(n=e.querySelector("#inp-import-seed"))==null?void 0:n.focus()},80)}function xi(){var e;(e=x("import-seed-modal"))==null||e.classList.remove("show")}async function Zd(){var r,l,c,d,u;let e=(((r=x("inp-import-seed"))==null?void 0:r.value)||"").trim(),t=(((l=x("inp-import-seed-label"))==null?void 0:l.value)||"").trim()||"Imported Wallet",n=(((c=x("inp-import-seed-pass"))==null?void 0:c.value)||"").trim(),s=(((d=x("inp-import-seed-pass-confirm"))==null?void 0:d.value)||"").trim(),a=x("import-seed-error"),o=x("import-seed-btn"),i=p=>{a&&(a.textContent=p)};if(i(""),!e)return i("Enter your seed phrase.");if(n.length<10)return i("Use a wallet password with at least 10 characters.");if(n!==s)return i("Wallet password confirmation does not match.");if(await Aa(),!window.xrpl)return i("xrpl.js not loaded \u2014 cannot derive address from seed.");o&&(o.disabled=!0,o.textContent="Importing\u2026");try{let p=window.xrpl.Wallet.fromSeed(e),m=p.address,f=(u=p.algorithm)!=null&&u.toLowerCase().includes("ed")?"ed25519":"secp256k1";if(re.find(w=>w.address===m))return i("This address is already in your vault.");let h="imp_"+Date.now(),b="\u{1F511}",g="#bd93f9",v=await El(e,n);re.push({id:h,label:t,address:m,algo:f,emoji:b,color:g,testnet:!1,watchOnly:!1,encSeed:v,createdAt:new Date().toISOString()}),Rs(),kt("wallet_imported",`${t} (${m.slice(0,8)}\u2026)`),xi(),$t(),Bt(),Fn(m).then(()=>{$t(),Ds()}),ae(`\u{1F511} Wallet imported: ${t}`)}catch(p){i("Invalid seed: "+(p.message||"Could not derive wallet."))}finally{o&&(o.disabled=!1,o.textContent="Import Wallet \u2192");let p=document.getElementById("inp-import-seed");p&&(p.value="");let m=document.getElementById("inp-import-seed-pass");m&&(m.value="");let f=document.getElementById("inp-import-seed-pass-confirm");f&&(f.value="")}}function ep(e,t,n){var d;let s=x("token-details-modal");if(!s)return;let a=s.querySelector(".generic-modal");if(!a)return;let o=Je[n],i=(d=o==null?void 0:o.tokens)==null?void 0:d.find(u=>u.currency===e&&u.issuer===t),r=i?_(parseFloat(i.balance||0),6):"\u2014",l=i!=null&&i.limit?_(parseFloat(i.limit),2):"Unlimited",c=e.length>4&&ki(e)||e;a.innerHTML=`
    <div class="tdm-hdr">
    ...
    </div>`,s.classList.add("show")}function tp(){let e=x("token-details-modal");e&&(e.classList.remove("show"),e.style.display="")}function np(){var s;(s=document.getElementById("pub-profile-overlay"))==null||s.remove();let e=localStorage.getItem(dn),t=ns.filter(a=>Ve[a.id]),n=document.createElement("div");n.id="pub-profile-overlay",n.className="pub-profile-overlay",n.innerHTML=`
    <div class="pub-profile-modal">
      ...
      ${t.length?`<div class="pub-socials">${t.map(a=>`<span class="pub-social-badge"><span>${a.icon}</span><span>@${y(Ve[a.id])}</span></span>`).join("")}</div>`:'<div style="padding:0 20px 16px;font-size:.82rem;color:rgba(255,255,255,.3)">No social accounts connected yet.</div>'}
    ...
    </div>`,document.body.appendChild(n),requestAnimationFrame(()=>requestAnimationFrame(()=>n.classList.add("show"))),n.addEventListener("click",a=>{a.target===n&&n.remove()})}function sp(e){Cn(e),Os(),kt("theme_changed",e)}function ap(e){Z("nalulf_pref_currency",e),Os(),ae(`Display currency: ${e}`)}function op(e){Z("nalulf_pref_network",e),Os(),ae(`Default network: ${e}`)}function ip(e){Z("nalulf_pref_autolock",e),Os(),ae(`Auto-lock: ${e} minutes`)}window._profileWipeAllData=()=>{confirm("Clear all profile, wallet list, social, and activity data? Encrypted wallet seeds saved on this device will be deleted.")&&(["nalulf_profile","nalulf_wallets","nalulf_social","nalulf_activity_log","nalulf_avatar_img","nalulf_banner_img","naluxrp_active_wallet"].forEach(e=>localStorage.removeItem(e)),re=[],Ve={},dt=null,Je={},ti={},Vo(),W(),ii("wallets"),ae("Local data cleared"))};function tg(){var e,t,n;(e=x("profile-editor-modal"))==null||e.addEventListener("click",s=>{s.target===s.currentTarget&&Bs()}),(t=x("wallet-creator-overlay"))==null||t.addEventListener("click",s=>{s.target===s.currentTarget&&Xs()}),(n=x("social-modal"))==null||n.addEventListener("click",s=>{s.target===s.currentTarget&&as()})}function ng(){let e=[{done:!!de.displayName&&de.displayName!=="Anonymous",label:"Display name"},{done:!!de.bio,label:"Bio"},{done:de.avatar!=="\u{1F30A}"||!!localStorage.getItem(dn),label:"Custom avatar"},{done:!!localStorage.getItem(Dn),label:"Custom banner"},{done:re.length>0,label:"Wallet added"},{done:Object.keys(Ve).length>=1,label:"Social connected"},{done:!!de.location,label:"Location set"},{done:!!de.website,label:"Website added"}],t=e.filter(n=>n.done).length;return{pct:Math.round(t/e.length*100),done:t,total:e.length,checks:e}}function sg(){let e=document.getElementById("profile-completeness");if(!e)return;let{pct:t,checks:n}=ng(),s=t===100?"#50fa7b":t>=60?"#00fff0":"#ffb86c",a=2*Math.PI*16,o=t/100*a,i=n.filter(r=>!r.done).map(r=>r.label);e.title=t===100?"Profile complete \u2713":`${t}% \u2014 Missing: ${i.join(", ")}`,e.innerHTML=`
    <div class="pc-wrap">
  ...
  `,document.body.appendChild(e);let t=()=>{e.style.display="none",e.removeAttribute("data-addr"),document.body.classList.remove("modal-open"),qs=!1,Rt=!1};e.addEventListener("click",a=>{a.target===e&&t()}),(n=x("acctPeekClose"))==null||n.addEventListener("click",t),(s=x("acctPeekInspect"))==null||s.addEventListener("click",async()=>{let a=e.getAttribute("data-addr");a&&await Tg(a),t()})}function kg(){$p||($p=!0,document.addEventListener("click",e=>{var s,a;let t=(a=(s=e.target).closest)==null?void 0:a.call(s,"[data-addr]");if(!t)return;let n=t.getAttribute("data-addr");n&&(e.preventDefault(),Sg(n))}))}function Rp(e){var r,l,c;if(!e||!((r=Ee==null?void 0:Ee.window)!=null&&r.length))return null;let t=0,n=0,s=0;for(let d of Ee.window)s+=Number(d.total||0),t+=Number(((l=d.byActorCreate)==null?void 0:l.get(e))||0),n+=Number(((c=d.byActorCancel)==null?void 0:c.get(e))||0);let a=t+n;if(!a)return null;let o=a?n/a:0,i=s?a/s:null;return{create:t,cancel:n,total:a,cancelRatio:o,share:i}}function $g(e){var o;let t=(o=Nt==null?void 0:Nt.acct)==null?void 0:o.get(e);if(!t||!t.intervals||t.intervals.length<6)return null;let n=hn(t.intervals),s=Fi(t.intervals);return!n||s==null?null:{cv:s/n,total:t.total||0}}async function Sg(e){var i,r,l;if(!Be(e))return;let t=document.getElementById("acctPeekOverlay");if(!t)return;t.style.display="flex",t.setAttribute("data-addr",e),document.body.classList.add("modal-open"),qs=!0,Rt=!0,V("acctPeekAddr",e),V("acctPeekBal","\u2026"),V("acctPeekSeq","\u2026"),V("acctPeekOwner","\u2026"),V("acctPeekFlags","\u2026");let n=x("acctPeekNote"),s=x("acctPeekCtx");n&&(n.textContent="Fetching account_info\u2026"),s&&(s.textContent="Building context\u2026");let a=Nt.acct.get(e),o=((i=a==null?void 0:a.ledgers)==null?void 0:i.length)||0;try{if(!B.wsConn||B.wsConn.readyState!==1){n&&(n.textContent="Not connected to XRPL. Connect first.");return}let c=await Me({command:"account_info",account:e,ledger_index:"validated",strict:!0}),d=(r=c==null?void 0:c.result)==null?void 0:r.account_data,u=Number((d==null?void 0:d.Balance)??NaN),p=Number.isFinite(u)?u/1e6:null;if(V("acctPeekBal",p==null?"\u2014":`${p.toLocaleString(void 0,{maximumFractionDigits:6})} XRP`),V("acctPeekSeq",(d==null?void 0:d.Sequence)??"\u2014"),V("acctPeekOwner",(d==null?void 0:d.OwnerCount)??"\u2014"),V("acctPeekFlags",(d==null?void 0:d.Flags)!=null?`0x${Number(d.Flags).toString(16)}`:"\u2014"),n){let m=[];p!=null&&p>=lg&&m.push("Large balance (whale-sized).");let f=$g(e);f&&f.cv<.35&&f.total>10&&m.push(`Bot-like timing signal (CV ${f.cv.toFixed(2)}).`);let h=Rp(e);if(h){let g=Math.round(h.cancelRatio*100),v=h.share!=null?Math.round(h.share*100):null;m.push(`DEX activity: ${h.total} offer tx in window.`),m.push(`Creates ${h.create}, cancels ${h.cancel} (${g}% cancels).`),v!=null&&m.push(`~${v}% of window activity.`)}let b=le.byAddr.get(e);if(b){let g=Vs(b.level);m.push(`Spam-defense: score ${(b.score*100).toFixed(0)}% \xB7 level L${b.level} \xB7 bond ${g.toLocaleString()} XRP.`),b.verifiedLedger!=null&&m.push(`Credential verified at ledger #${Number(b.verifiedLedger).toLocaleString()}.`)}o>=6&&m.push(`Shows up often in recent ledgers (${o} times).`),m.length||m.push("No obvious red flags from this quick read."),n.textContent=m.join(" ")}if(s){let m=(l=a==null?void 0:a.ledgers)==null?void 0:l.at(-1),f=Rp(e),h=f?`DEX window: ${f.total} (creates ${f.create}, cancels ${f.cancel})`:null,b=_t.filter(k=>k.from===e||k.to===e).slice(0,3),g=b.length?`${b.length} whale tx in session (${b.map(k=>(k.amtXrp>=1e6?(k.amtXrp/1e6).toFixed(1)+"M":(k.amtXrp/1e3).toFixed(0)+"K")+" XRP").join(", ")})`:null,v=le.byAddr.get(e),w=v?`Spam-defense: L${v.level} \xB7 score ${Math.round(v.score*100)}%`:null;s.textContent=[m?`Last seen around ledger #${Number(m).toLocaleString()}`:"Not in recent window.",h,g,w].filter(Boolean).join(" \xB7 ")}}catch(c){n&&(n.textContent=`Lookup failed: ${String((c==null?void 0:c.message)||c)}`),s&&(s.textContent="\u2014")}}async function Tg(e){if(!Be(e))return;let t=document.querySelector('.dash-tab[data-tab="inspector"]'),n=document.getElementById("tab-inspector"),s=async()=>n&&n.style.display!=="none"?!0:(typeof window.switchTab=="function"&&t?window.switchTab(t,"inspector"):t==null||t.click(),await new Promise(o=>setTimeout(o,80)),n?n.style.display!=="none":!0);for(let o=0;o<6&&!await s();o++)await new Promise(r=>setTimeout(r,80));let a=document.getElementById("inspect-addr");a&&(a.value=e,a.focus()),await new Promise(o=>setTimeout(o,60)),typeof window.runInspect=="function"?window.runInspect():ge("Inspector not ready yet.")}function Cg(){Oe(".net-btn[data-network]").forEach(e=>{e.addEventListener("click",()=>{let t=e.getAttribute("data-network");Oe(".net-btn").forEach(s=>{s.classList.toggle("active",s===e),s.setAttribute("aria-pressed",String(s===e))}),Nt.acct.clear(),js.window=[],js.totals=new Map,Ee.window=[],Ee.smoothCancelPerMin=null,Ee.smoothBurst=null,Xt.length=0,qa.clear(),je=0,Gt=0,pt=0,Us=0,Kt=!0,Ga=0,Ri=!1,Ws=null,Rt=!1,fn=0,ps=0,Ya=!1;let n=x("ledgerStreamTrack");n&&(n.innerHTML="",n.style.transform="translateX(0px)"),tu(null,null),bv(),le.byAddr.clear(),le.selectedAddr=null,le.selectedProof=null,Bi(),iu(),ms(null),Nr(t),Ja({force:!0})})})}var Wa=[],Pg=8,Ci=null,Ni=0,zs=null;function Lg(){let e=document.querySelector(".dashboard-metric-grid");if(!e)return;let t=e.closest(".dashboard-metrics")||e.parentElement;t&&t.classList.add("dashboard-sticky-strip"),e.innerHTML=`
  ...
  `}function Mg(e){var h,b,g,v;let t=e.ledgerIndex?Number(e.ledgerIndex):null;V("d2-ledger-index",t?t.toLocaleString():"\u2014");let n=((h=e.latestLedger)==null?void 0:h.closeTimeSec)!=null?Number(e.latestLedger.closeTimeSec):null,s=x("d2-ledger-age");if(s&&(n!=null?(s.textContent=`${n<2?n.toFixed(2):n.toFixed(1)}s close`,s.style.color=n<=3?"#50fa7b":n<=6?"#ffb86c":"#ff6e6e"):(s.textContent="Waiting\u2026",s.style.color="")),n!=null&&(Wa.push(n),Wa.length>Pg&&Wa.shift(),Ag()),Ni=Date.now(),Eg(),e.tps!=null){let w=Number(e.tps),k=x("d2-tps");k&&(k.textContent=w.toFixed(1),k.style.color=w<10?"rgba(255,255,255,.65)":w<40?"#50fa7b":w<80?"#ffb86c":"#ff6e6e");let $=x("d2-tps-trend");if($){let T=B.tpsHistory||[],S=T.length>2?(T.slice(-10).reduce((C,A)=>C+A,0)/Math.min(T.length,10)).toFixed(1):null,M=w<10?"Low":w<40?"Normal":w<80?"High":"Peak";$.textContent=S?`${M} \xB7 avg ${S}`:M,$.style.color=w<10?"rgba(255,255,255,.55)":w<40?"#50fa7b":w<80?"#ffb86c":"#ff6e6e"}}let a=(((b=e.latestLedger)==null?void 0:b.totalTx)??e.txPerLedger)||0,o=x("d2-tx-per-ledger");o&&(o.textContent=a>0?a.toLocaleString():"\u2014",o.style.color=a<10?"rgba(255,255,255,.65)":a<150?"#50fa7b":a<400?"#ffb86c":"#ff6e6e");let i=x("d2-tx-spread");i&&a>0&&(i.textContent=a<10?"Very light":a<50?"Light":a<150?"Normal":a<400?"High volume":"Very high volume",i.style.color=a<150?"":a<400?"#ffb86c":"#ff6e6e");let r=e.avgFee!=null?Number(e.avgFee):((g=e.latestLedger)==null?void 0:g.avgFee)!=null?Number(e.latestLedger.avgFee):null;if(r!=null){let w=Math.round(r*1e6),k=x("d2-fee-value");k&&(k.textContent=mn(r),k.style.color=w<=15?"#50fa7b":w<=50?"rgba(255,255,255,.9)":w<=200?"#ffb86c":"#ff6e6e");let $=x("d2-fee-delta");if($)if(Ci!=null){let S=r/Ci;S>1.05?($.textContent="\u2191",$.style.color="#ff6e6e",$.title=`+${((S-1)*100).toFixed(0)}% vs prev ledger`):S<.95?($.textContent="\u2193",$.style.color="#50fa7b",$.title=`-${((1-S)*100).toFixed(0)}% vs prev ledger`):($.textContent="\u2192",$.style.color="rgba(255,255,255,.35)",$.title="Stable vs prev ledger")}else $.textContent="";Ci=r;let T=x("d2-fee-pressure");if(T){let S=w<=15?"Base fee":w<=50?`${w} drops`:w<=200?`${w} drops \xB7 Elevated`:`${w} drops \xB7 Surge`;T.textContent=S,T.style.color=w<=50?"":w<=200?"#ffb86c":"#ff6e6e"}}let l=e.successRate!=null?Number(e.successRate):((v=e.latestLedger)==null?void 0:v.successRate)!=null?Number(e.latestLedger.successRate):null;if(l!=null){let w=x("d2-success-rate");w&&(w.textContent=`${l.toFixed(1)}%`,w.style.color=l>=90?"#50fa7b":l>=75?"#ffb86c":"#ff6e6e");let k=x("d2-success-note");if(k){let $=(100-l).toFixed(1);k.textContent=l>=90?`${$}% failed \xB7 Normal`:l>=75?`${$}% failed \xB7 Watch`:`${$}% failed \xB7 Alert`,k.style.color=l>=90?"":l>=75?"#ffb86c":"#ff6e6e"}}let c=a>0?Math.min(100,a/500*100):null,d=x("d2-network-capacity"),u=x("d2-capacity-note");c!=null&&(d&&(d.textContent=`${c.toFixed(1)}%`,d.style.color=c<20?"rgba(255,255,255,.65)":c<50?"#50fa7b":c<80?"#ffb86c":"#ff6e6e"),u&&(u.textContent=c<20?"Low usage":c<50?"Moderate":c<80?"Heavy":"Near capacity",u.style.color=c<50?"":c<80?"#ffb86c":"#ff6e6e"));let p=e.txTypes||{},m=Object.entries(p).sort(([,w],[,k])=>k-w);if(m.length){let[w,k]=m[0],$=m.reduce((A,[,R])=>A+R,0)||1,T=(k/$*100).toFixed(0),S=typeof It<"u"?It:{},M=x("d2-dominant-type");M&&(M.textContent=w,M.style.color=S[w]||"rgba(255,255,255,.9)");let C=x("d2-dominance-score");if(C){let A=m[1];C.textContent=A?`${T}% \xB7 2nd: ${A[0]}`:`${T}% of txs`}}let f=x("stream-loading");f&&(f.style.display="none")}function Ag(){let e=x("d2-close-sparkline");if(!e||!e.getContext)return;let t=Wa;if(t.length<2)return;let n=e.width,s=e.height,a=e.getContext("2d");a.clearRect(0,0,n,s);let o=Math.max(...t,4),i=Math.floor((n-(t.length-1))/t.length),r=1;t.forEach((l,c)=>{let d=Math.max(3,Math.round(l/o*(s-2))),u=c*(i+r),p=s-d,m=l<=3?"rgba(80,250,123,.80)":l<=6?"rgba(255,184,108,.80)":"rgba(255,110,110,.85)";a.fillStyle=m;let f=Math.min(2,i/2);a.beginPath(),a.moveTo(u+f,p),a.lineTo(u+i-f,p),a.quadraticCurveTo(u+i,p,u+i,p+f),a.lineTo(u+i,s),a.lineTo(u,s),a.lineTo(u,p+f),a.quadraticCurveTo(u,p,u+f,p),a.closePath(),a.fill(),c===t.length-1&&(a.fillStyle="rgba(255,255,255,.18)",a.fillRect(u,p,i,Math.min(3,d)))})}function Eg(){if(zs&&cancelAnimationFrame(zs),!Jt())return;let e=0,t=n=>{if(!Jt()){zs=null;return}if(n-e>=120){e=n;let s=x("d2-ledger-age-timer");if(s&&Ni>0){let a=(Date.now()-Ni)/1e3;s.textContent=`${a.toFixed(1)}s ago`,s.style.color=a<4?"rgba(255,255,255,.55)":a<7?"#ffb86c":"#ff6e6e",s.style.opacity=a>=7?(.6+.4*Math.sin(Date.now()/300)).toFixed(2):"1"}}zs=requestAnimationFrame(t)};zs=requestAnimationFrame(t)}function Ng(){let e=x("tx-mix");if(!e)return;let t=Object.entries(B.txMixAccum||{}).filter(([,s])=>s>0).sort(([,s],[,a])=>a-s).slice(0,10),n=t.reduce((s,[,a])=>s+a,0);n&&(e.innerHTML=t.map(([s,a])=>{let o=(a/n*100).toFixed(1),i=It[s]||"#6b7280";return`
      ...
      </div>`}).join(""))}var St=class{constructor(t,n="#00fff0",s="area"){this.canvasId=t,this.canvas=x(t),this.color=n,this.mode=s}_resolveCanvas(){return this.canvas||(this.canvas=x(this.canvasId)),this.canvas}draw(t){let n=this._resolveCanvas();if(!n||!(t!=null&&t.length))return;let s=n.getContext("2d");if(!s)return;let a=n.width=n.offsetWidth||300,o=n.height=n.offsetHeight||180;if(s.clearRect(0,0,a,o),t.length<2)return;let i=Math.min(...t)*.9,r=Math.max(...t)*1.05||1,l=b=>1-(b-i)/(r-i||1),c={l:10,r:10,t:10,b:12},d=a-c.l-c.r,u=o-c.t-c.b,p=d/(t.length-1),m=t.map((b,g)=>[c.l+g*p,c.t+l(b)*u]),f=hn(t);if(f!=null){let b=c.t+l(f)*u;s.beginPath(),s.moveTo(c.l,b),s.lineTo(c.l+d,b),s.strokeStyle="rgba(255,255,255,0.16)",s.lineWidth=1,s.stroke()}if(t.length>=dp+2){let g=yg(t,dp).map((v,w)=>[c.l+w*p,c.t+l(v)*u]);s.beginPath(),g.forEach(([v,w],k)=>k===0?s.moveTo(v,w):s.lineTo(v,w)),s.strokeStyle="rgba(255,255,255,0.22)",s.lineWidth=1.5,s.stroke()}if(this.mode==="bar"){let b=Math.max(1,p-3);t.forEach((g,v)=>{let w=(1-l(g))*u,k=c.l+v*p-b/2,$=s.createLinearGradient(0,c.t,0,c.t+u);$.addColorStop(0,this.color),$.addColorStop(1,this.color+"33"),s.fillStyle=$,s.fillRect(k,c.t+u-w,b,w)});return}let h=s.createLinearGradient(0,c.t,0,c.t+u);h.addColorStop(0,this.color+"aa"),h.addColorStop(1,this.color+"11"),s.beginPath(),m.forEach(([b,g],v)=>v===0?s.moveTo(b,g):s.lineTo(b,g)),s.lineTo(m.at(-1)[0],c.t+u),s.lineTo(m[0][0],c.t+u),s.closePath(),s.fillStyle=h,s.fill(),s.beginPath(),m.forEach(([b,g],v)=>v===0?s.moveTo(b,g):s.lineTo(b,g)),s.strokeStyle=this.color,s.lineWidth=2,s.lineJoin="round",s.stroke()}},we={};function Rg(){we.tps=new St("chart-tps","#50fa7b","area"),we.fee=new St("chart-fee","#ffb86c","area"),we.tps2=new St("chart-tps2","#50fa7b","bar"),we.fee2=new St("chart-fee2","#ffb86c","area"),we.dexPressure=new St("chart-dex-pressure","#00d4ff","bar"),we.nftMints=new St("chart-nft-mints","#bd93f9","bar"),we.nftBurns=new St("chart-nft-burns","#ff5555","bar"),we.autoBridge=new St("chart-autobridge","#f1fa8c","bar"),we.marketPrice=new St("chart-market-price","#50fa7b","area"),we.marketVol=new St("chart-market-vol","#8be9fd","bar")}function Ht(e,t=Yt){let n=bg(e,t).filter(r=>Number.isFinite(r));if(!n.length)return{cur:null,avg:null,deltaPct:null,vol:null};let s=n.at(-1),a=hn(n),o=Fi(n),i=a&&a!==0?(s-a)/a*100:null;return{cur:s,avg:a,deltaPct:i,vol:o}}function _g(){if(gp)return;gp=!0;let e=(t,n)=>{let s=x(t);if(!s)return;let a=s.closest(".widget-card"),o=a==null?void 0:a.querySelector(".widget-header");if(!o||document.getElementById(n))return;let i=document.createElement("div");i.className="trend-mini",i.id=n,i.innerHTML=`
    ...
    `,o.appendChild(i)};e("chart-tps","tpsTrendMini"),e("chart-fee","feeTrendMini"),e("chart-tps2","tpsTrendMini2"),e("chart-fee2","feeTrendMini2")}function Ha(e,t,n,s){let a=document.getElementById(e);if(!a)return;let o=(i,r)=>{let l=a.querySelector(`[data-k="${i}"]`);l&&(l.textContent=r)};if(t.cur==null){o("now","\u2014"),o("avg","\u2014"),o("delta","\u2014"),o("sigma","\u2014");return}o("now",`${Number(t.cur).toFixed(n)}${s}`),o("avg",t.avg!=null?`${Number(t.avg).toFixed(n)}${s}`:"\u2014"),o("delta",t.deltaPct==null?"\u2014":gn(t.deltaPct,0)),o("sigma",t.vol==null?"\u2014":`${Number(t.vol).toFixed(Math.max(0,n-1))}${s}`)}function Dg(){var n,s,a,o,i,r,l,c,d,u;(n=we.tps)==null||n.draw(B.tpsHistory),(s=we.fee)==null||s.draw(B.feeHistory),(a=we.tps2)==null||a.draw(B.tpsHistory),(o=we.fee2)==null||o.draw(B.feeHistory);let e=Ht(B.tpsHistory,Yt),t=Ht(B.feeHistory,Yt);Ha("tpsTrendMini",e,2,""),Ha("tpsTrendMini2",e,2,""),Ha("feeTrendMini",t,0,"d"),Ha("feeTrendMini2",t,0,"d"),(i=we.dexPressure)==null||i.draw(fe.dexPressure),(r=we.nftMints)==null||r.draw(fe.nftMints),(l=we.nftBurns)==null||l.draw(fe.nftBurns),(c=we.autoBridge)==null||c.draw(fe.autoBridge),(d=we.marketPrice)==null||d.draw(fe.marketPrice),(u=we.marketVol)==null||u.draw(fe.marketVol)}function Ig(){let e=x("ledger-log"),t=x("ledger-log-loading"),n=x("ledger-log-count");if(!e||!(B.ledgerLog||[]).length)return;t&&(t.style.display="none"),n&&(n.textContent=B.ledgerLog.length);let s=x("tab-network");!s||s.style.display==="none"||(e.innerHTML=`<div class="ledger-log-row log-head">
      ...
      </div>`).join(""))}var Xt=[],qa=new Set,je=0,za=null,Us=0,Gt=0,pt=0,Kt=!0,Ua=0,Rt=!1,Ga=0,Ri=!1,Ws=null,fn=0,ps=0,Ya=!1,Fg=.18;function Og(){Bg(),Xg()}function Bg(){let e=x("ledgerStreamParticles");if(e){e.innerHTML="";for(let t=0;t<14;t++){let n=document.createElement("div");n.className="ledger-particle",n.style.left=Math.random()*100+"%",n.style.top=20+Math.random()*60+"%",n.style.animationDuration=6+Math.random()*8+"s",n.style.animationDelay=Math.random()*5+"s",e.appendChild(n)}}}function Xg(){if(za)return;let e=x("ledgerStreamShell");e&&(e.addEventListener("mouseenter",()=>{Rt=!0}),e.addEventListener("mouseleave",()=>{qs||(Rt=!1)}));let t=x("ledgerStreamTrack");t&&t.addEventListener("click",s=>{let a=s.target.closest("article.ledger-card");if(!a)return;let o=Number(a.dataset.ledgerIndex);Number.isFinite(o)&&(s.shiftKey?Ws===o?(Ws=null,qs||(Rt=!1),_p()):(Ws=o,Rt=!0,_p()):Hg(o))});let n=s=>{Us||(Us=s);let a=Math.min(.05,(s-Us)/1e3);Us=s;let o=Jt()?x("ledgerStreamTrack"):null;if(o&&je>0){if(Kt){let i=o.scrollWidth||0;if(i>100)pt=Math.floor(i/2),Kt=!1,Ua=0,je>0&&(fn=pt/je);else{Ua++,Ua>30&&(Kt=!1,Ua=0),za=requestAnimationFrame(n);return}}if(pt>0&&!Rt&&Ya){let i=Math.min(1,a/Fg);Gt+=(ps-Gt)*i,Math.abs(ps-Gt)<.5&&(Gt=ps);let r=Gt%pt;o.style.transform=`translateX(${-r}px)`}if(!Rt&&Math.floor(s/250)!==Math.floor((s-a*1e3)/250)){let i=Date.now(),r=o.querySelectorAll("article.ledger-card[data-arrival-ts]"),l=12e4;r.forEach(c=>{let d=i-Number(c.dataset.arrivalTs||i),u=Math.max(.52,1-d/l*.48);c.style.opacity=u.toFixed(3)})}if(Ga>0){let i=Date.now()-Ga>mg;Ka(i)}}za=requestAnimationFrame(n)};za=requestAnimationFrame(n),window.addEventListener("resize",()=>{Kt=!0})}function Yp(){if(fn<=0||pt<=0||je===0)return Gt;let e=x("ledgerStreamShell"),t=e&&e.offsetWidth||800,n=fn-14,a=(je-1)*fn+n-t+18;a=Math.max(0,a);let i=Math.floor(Gt/pt)*pt+a;return i<Gt-2&&(i+=pt),i}function Ka(e,t){if(e===Ri)return;Ri=e;let n=x("ledgerStreamShell");if(!n)return;let s=n.querySelector(".stream-stall-overlay");e?(s||(s=document.createElement("div"),s.className="stream-stall-overlay",n.appendChild(s)),s.innerHTML=`<span class="stream-stall-dot"></span> ${y(t||"Waiting for ledgers\u2026")}`):s==null||s.remove()}function _p(){document.querySelectorAll(".ledger-card").forEach(e=>{let t=Number(e.dataset.ledgerIndex);e.classList.toggle("ledger-card--pinned",t===Ws)})}function Hg(e){let t=document.querySelector('.dash-tab[data-tab="inspector"]');typeof window.switchTab=="function"&&t?window.switchTab(t,"inspector"):t==null||t.click();let n=document.getElementById("inspect-addr");n&&(n.placeholder=`Ledger #${e.toLocaleString()} \u2014 paste an address`,n.focus())}function zg(){var t;let e=x("ledgerStreamShell");e&&(e.classList.remove("stream-reconnect-flash"),e.offsetWidth,e.classList.add("stream-reconnect-flash"),setTimeout(()=>e.classList.remove("stream-reconnect-flash"),1200),vg=((t=cs.at(-1))==null?void 0:t.li)??0,Ug())}function Ug(){let e=document.getElementById("reconnect-banner");if(!e){e=document.createElement("div"),e.id="reconnect-banner",e.className="reconnect-banner";let s=document.querySelector(".dashboard-col-main");s&&s.prepend(e)}e.style.display="",e.innerHTML=`
    ...
    <button onclick="document.getElementById('reconnect-banner').style.display='none'"
      style="margin-left:auto;background:none;border:none;color:inherit;opacity:.5;cursor:pointer;font-size:.9rem">\u2715</button>`;let t=3,n=setInterval(()=>{let s=document.getElementById("reconnect-countdown");if(s&&(s.textContent=t),t--,t<0){clearInterval(n);let a=document.getElementById("reconnect-banner");a&&(a.style.display="none")}},4e3)}function Dp(){let e=x("ledgerStreamTrack"),t=x("ledgerStreamShell"),n=x("stream-loading");if(!e||!t)return;if(n&&(n.style.display="none"),Xt.length===0){e.innerHTML='<div style="padding:40px;opacity:.6">Waiting for ledgers\u2026</div>',je=0,Kt=!0;return}let s=[...Xt].sort((o,i)=>o.ledgerIndex-i.ledgerIndex),a=s.map((o,i)=>Zp(o,{prevIndex:i>0?s[i-1].ledgerIndex:null}));e.innerHTML=a.concat(a).join(""),je=s.length,Kt=!0,requestAnimationFrame(()=>{var i;let o=((i=x("ledgerStreamTrack"))==null?void 0:i.scrollWidth)||0;o>100&&(pt=Math.floor(o/2),fn=je>0?pt/je:0,ps=Yp(),Ya=!0,Kt=!1)})}function jg(e){var f,h;if(!e)return;let t=Number(e.ledgerIndex??NaN);if(!Number.isFinite(t)||qa.has(t))return;qa.add(t),Xt.push(e);let n=0;if(Xt.length>mp){let b=Xt.splice(0,Xt.length-mp);b.forEach(g=>qa.delete(g.ledgerIndex)),n=b.length}Ga=Date.now(),Ka(!1),qg(e.avgFee!=null?Number(e.avgFee):null);let{auraClass:s,domColor:a}=Vg(e);tu(s,a);let o=x("stream-loading");o&&(o.style.display="none");let i=x("ledgerStreamTrack");if(!i)return;if(je===0){Dp();return}let r=Xt.length>=2?Xt[Xt.length-2].ledgerIndex:0;if(t<r){Dp();return}let l=je,c=Zp(e),d=document.createElement("template");d.innerHTML=c;let u=d.content.firstElementChild,p=i.children[l];p?i.insertBefore(u,p):i.appendChild(u);let m=document.createElement("template");if(m.innerHTML=c,i.appendChild(m.content.firstElementChild),je=l+1,n>0){for(let g=0;g<n;g++)(f=i.children[0])==null||f.remove();let b=je-n;for(let g=0;g<n;g++)(h=i.children[b])==null||h.remove();je-=n}Kt=!0,requestAnimationFrame(()=>{fn<=0&&pt>0&&je>0&&(fn=pt/je),ps=Yp(),Ya=!0})}var us=[],Wg=20;function qg(e){e==null||!Number.isFinite(e)||(us.push(e),us.length>Wg&&us.shift())}function Qp(){return us.length===0?null:us.reduce((e,t)=>e+t,0)/us.length}function Zp(e,t={}){let{ledgerIndex:n,closeTimeSec:s,totalTx:a,txTypes:o,avgFee:i}=e,r=o||{},l=a??0,c=Object.entries(r).sort(([,I],[,D])=>D-I)[0],d=(c==null?void 0:c[0])||"Other",u=eu(d),p=typeof It<"u"?It:{},m=I=>p[I]||"#6b7280",f=m(d),h=ds(f,.45)||f,b=ds(f,.14)||f,g=s==null?"\u2014":s<2?`${Number(s).toFixed(2)}s`:`${Number(s).toFixed(1)}s`,v=l>0&&s>0?(l/s).toFixed(1):null,w=i!=null?Number(i):null,k=w!=null?mn(w):"\u2014",$=Qp(),T=w!=null&&$!=null&&w>$*3,S=t.prevIndex!=null?Number(n)-t.prevIndex-1:0,M=S>0?`<div class="stream-gap-badge" title="${S} ledger(s) missing">\xB7\xB7\xB7&nbsp;${S} gap</div>`:"",C=I=>l>0?`${(I/l*100).toFixed(1)}%`:"0%",A=(I,D,F)=>D?`<div class="ledger-type-row">
    ...
    <div class="ledger-card-inner">
      ...
      <div class="ledger-type-bars">
        ...
        ${R?A("AMM",R,m("AMMCreate")):""}
        ${A("EscrowCreate",r.EscrowCreate,"#6b7280")}
        ${(r.Other||0)>0?A("Other",r.Other,"#6b7280"):""}
      </div>
    </div>
  </article>`}function eu(e){let t=String(e||"");return t==="Payment"?"payment":t.startsWith("Offer")?"offer":t.startsWith("NFToken")?"nft":t==="TrustSet"?"trust":t.startsWith("AMM")?"amm":"other"}function Vg(e){var o;let n=((o=Object.entries(e.txTypes||{}).sort(([,i],[,r])=>r-i)[0])==null?void 0:o[0])||"Other",s=eu(n),a=It[n]||It.Other||"#6b7280";return{dominantTx:n,auraClass:s,domColor:a}}function tu(e,t){let n=x("ledgerStreamShell");if(!n)return;if(!e||!t){n.style.removeProperty("--streamTintStrong"),n.style.removeProperty("--streamTintSoft"),n.style.removeProperty("--streamTintBorder");return}let s=ds(t,.16)||"rgba(0,255,240,0.14)",a=ds(t,.06)||"rgba(0,255,240,0.06)",o=ds(t,.22)||"rgba(0,255,240,0.22)";n.style.setProperty("--streamTintStrong",s),n.style.setProperty("--streamTintSoft",a),n.style.setProperty("--streamTintBorder",o),n.dataset.tint=e}function Gg(e){var b,g;let t=Array.isArray(e.recentTransactions)?e.recentTransactions.slice(0,rg):[],n=e.txTypes||{},s=Number(e.ledgerIndex||0),a=Object.values(n).reduce((v,w)=>v+w,0)||1,o=0;for(let v of Object.values(n)){let w=v/a;o+=w*w}let i=Kg(t);Jg(js,i);let r=Yg(js.totals,i),l=Qg(js.totals),c=Zg(s,t),d=ev(s,(b=e.latestLedger)==null?void 0:b.closeTimeSec,t),u=tv({txs:t,txTypes:n,dexPatterns:d}),p=r.filter(v=>v.count>=2).length,m=nv({hhi:o,repeats:p,dex:d,bots:((g=c.bots)==null?void 0:g.length)||0,advanced:u}),f=sv({friction:m,tps:Ht(B.tpsHistory),fee:Ht(B.feeHistory)}),h=av({s:e,txTypes:n,hhi:o,dexPatterns:d,behavior:c,friction:m,regime:f,breadcrumbs:r,clusters:l,advanced:u});return{s:e,txs:t,txTypes:n,hhi:o,behavior:c,dexPatterns:d,friction:m,regime:f,breadcrumbs:r,clusters:l,narratives:h,advanced:u}}function Kg(e){let t=new Map;for(let n of e){let s=n==null?void 0:n.account,a=n==null?void 0:n.destination;if(!s||!a)continue;let o=`${s}|${a}`;t.set(o,(t.get(o)||0)+1)}return t}function Jg(e,t){e.window.unshift(t);for(let[n,s]of t.entries())e.totals.set(n,(e.totals.get(n)||0)+s);for(;e.window.length>e.maxLedgers;){let n=e.window.pop();for(let[s,a]of n.entries()){let o=(e.totals.get(s)||0)-a;o<=0?e.totals.delete(s):e.totals.set(s,o)}}}function Yg(e,t){let s=[...e.entries()].map(([o,i])=>({k:o,c:i})).sort((o,i)=>i.c-o.c).filter(o=>o.c>=2);return(s.length?s:[...t.entries()].map(([o,i])=>({k:o,c:i}))).slice(0,10).map(({k:o,c:i})=>{let[r,l]=o.split("|");return{from:r,to:l,count:i}})}function Qg(e){let t=[...e.entries()].filter(([,i])=>i>=2),n=t.length?t:[...e.entries()],s=new Map;for(let[i]of n){let[r,l]=i.split("|");!r||!l||(s.has(r)||s.set(r,new Set),s.has(l)||s.set(l,new Set),s.get(r).add(l),s.get(l).add(r))}let a=new Set,o=[];for(let i of s.keys()){if(a.has(i))continue;let r=[i],l=[];for(a.add(i);r.length;){let u=r.pop();l.push(u);for(let p of s.get(u)||[])a.has(p)||(a.add(p),r.push(p))}if(l.length<2)continue;let c=l[0],d=-1;for(let u of l){let p=(s.get(u)||new Set).size;p>d&&(d=p,c=u)}o.push({members:l,size:l.length,hub:c})}return o.sort((i,r)=>r.size-i.size),o.slice(0,6)}function Zg(e,t){let n=new Map;for(let a of t){let o=a==null?void 0:a.account;o&&n.set(o,(n.get(o)||0)+1)}for(let[a,o]of n.entries()){Nt.acct.has(a)||Nt.acct.set(a,{ledgers:[],intervals:[],total:0});let i=Nt.acct.get(a),r=i.ledgers.at(-1);i.ledgers.push(e),r!=null&&e>r&&i.intervals.push(e-r),i.ledgers.length>30&&i.ledgers.shift(),i.intervals.length>29&&i.intervals.shift(),i.total+=o}let s=[];for(let[a,o]of Nt.acct.entries()){if(o.intervals.length<6)continue;let i=hn(o.intervals),r=Fi(o.intervals);if(!i||r==null)continue;let l=r/i;l<.35&&o.total>10&&s.push({acct:a,cv:l,total:o.total})}if(s.sort((a,o)=>a.cv-o.cv||o.total-a.total),e%50===0)for(let[a,o]of Nt.acct){let i=o.ledgers.at(-1)??e;e-i>1e3&&Nt.acct.delete(a)}return{bots:s.slice(0,6),uniqueActors:n.size}}function ev(e,t,n){var M;let s=0,a=0,o=new Map,i=new Map,r=new Map;for(let C of n){let A=C==null?void 0:C.type,R=C==null?void 0:C.account;R&&(A==="OfferCreate"?(s+=1,o.set(R,(o.get(R)||0)+1),i.set(R,(i.get(R)||0)+1)):A==="OfferCancel"&&(a+=1,o.set(R,(o.get(R)||0)+1),r.set(R,(r.get(R)||0)+1)))}let l=s+a,c=l?a/l:0,d=t!=null&&Number(t)>0?a/Number(t)*60:null;for(Ee.smoothCancelPerMin=Np(Ee.smoothCancelPerMin,d,.45),Ee.window.unshift({li:e,closeTimeSec:t??null,create:s,cancel:a,total:l,cancelRatio:c,cancelsPerMin:Ee.smoothCancelPerMin,byActor:o,byActorCreate:i,byActorCancel:r});Ee.window.length>cg;)Ee.window.pop();let u={create:0,cancel:0,total:0},p=new Map,m=new Map,f=new Map;for(let C of Ee.window){u.create+=C.create,u.cancel+=C.cancel,u.total+=C.total;for(let[A,R]of C.byActor.entries())p.set(A,(p.get(A)||0)+R);for(let[A,R]of C.byActorCancel.entries())m.set(A,(m.get(A)||0)+R);for(let[A,R]of C.byActorCreate.entries())f.set(A,(f.get(A)||0)+R)}let h=Pi(p,5),b=Pi(m,5),g=Pi(f,5),v=u.total?(((M=h[0])==null?void 0:M.count)||0)/u.total:0,w=0;if(u.total)for(let C of p.values()){let A=C/u.total;w+=A*A}let k=Ee.window.map(C=>C.total).filter(Number.isFinite),$=hn(k)||0,T=$>0?(l-$)/$*100:null;Ee.smoothBurst=Np(Ee.smoothBurst,T,.4);let S=[];return u.total>=Si&&c>=.65&&S.push("Lots of cancels (looks like quote-stuffing/spam)"),u.total>=Si&&v>=.35&&S.push("One actor dominates DEX activity"),u.total>=Si&&(Ee.smoothCancelPerMin||0)>=18&&S.push("Fast cancelling (high churn)"),Ee.smoothBurst!=null&&Math.abs(Ee.smoothBurst)>=45&&S.push("Sudden DEX burst"),{now:{li:e,create:s,cancel:a,total:l,cancelRatio:c,cancelsPerMin:Ee.smoothCancelPerMin},window:{...u,cancelRatio:u.total?u.cancel/u.total:0},topShare:v,actorHHI:w,burstPct:Ee.smoothBurst,topActor:h,topCanceller:b,topMaker:g,signals:S}}function Pi(e,t){return[...e.entries()].sort((n,s)=>s[1]-n[1]).slice(0,t).map(([n,s])=>({acct:n,count:s}))}function tv({txs:e,txTypes:t,dexPatterns:n}){var H;let s=Number((t==null?void 0:t.OfferCreate)||0)+Number((t==null?void 0:t.OfferCancel)||0),a=Number((t==null?void 0:t.NFTokenMint)||0),o=Number((t==null?void 0:t.NFTokenBurn)||0),i=0,r=new Map,l=new Map;for(let E of e){if((E==null?void 0:E.type)!=="Payment")continue;let z=(E==null?void 0:E.paths)||(E==null?void 0:E.Paths),te=Array.isArray(z)&&z.length>0,oe=(E==null?void 0:E.sendmax)!=null||(E==null?void 0:E.SendMax)!=null,pe=(E==null?void 0:E.delivermax)!=null||(E==null?void 0:E.DeliverMax)!=null;if(!(te||oe||pe))continue;i+=1;let ne=E==null?void 0:E.account,ce=E==null?void 0:E.destination;if(ne&&r.set(ne,(r.get(ne)||0)+1),ne&&ce){let G=`${ne}|${ce}`;l.set(G,(l.get(G)||0)+1)}}let c=[...r.entries()].sort((E,z)=>z[1]-E[1]).slice(0,5).map(([E,z])=>({acct:E,count:z})),d=[...l.entries()].sort((E,z)=>z[1]-E[1]).slice(0,5).map(([E,z])=>{let[te,oe]=E.split("|");return{from:te,to:oe,count:z}}),u=(H=n==null?void 0:n.now)!=null&&H.total?Math.round((n.now.cancelRatio||0)*100):0,p=(n==null?void 0:n.topShare)!=null?Math.round(n.topShare*100):0,m=e.filter(E=>(E==null?void 0:E.type)==="Payment").map(E=>typeof(E==null?void 0:E.amountXrp)=="number"?E.amountXrp:null).filter(E=>E!=null&&E>0&&Number.isFinite(E)),f=[100,1e3,1e4],h=m.filter(E=>f.some(z=>Math.abs(E%z)<1e-9&&E/z>=1)).length,b=m.length>=5?Math.round(h/m.length*100):null,g=e.filter(E=>(E==null?void 0:E.type)==="Payment"&&(E==null?void 0:E.account)&&(E==null?void 0:E.destination)&&E.account===E.destination).length,v=Number((t==null?void 0:t.AMMCreate)||0),w=Number((t==null?void 0:t.AMMDeposit)||0),k=Number((t==null?void 0:t.AMMWithdraw)||0),$=Number((t==null?void 0:t.AMMVote)||0),T=Number((t==null?void 0:t.AMMBid)||0),S=Number((t==null?void 0:t.AMMDelete)||0),M=v+w+k+$+T+S,C=w-k,A=w+k>0?Math.round(w/(w+k)*100):null,R=new Set;for(let E of e)["AMMCreate","AMMDeposit","AMMWithdraw","AMMVote","AMMBid"].includes(E==null?void 0:E.type)&&(E!=null&&E.account)&&R.add(E.account);let O=R.size,I=0,D=0;for(let E of e)(E==null?void 0:E.type)==="Payment"&&Array.isArray(E==null?void 0:E.paths)&&E.paths.length>0&&(I+=E.paths.length,D++);let F=D>0?(I/D).toFixed(1):null;return{offerTotal:s,dexCancelPct:u,dexTopSharePct:p,mints:a,burns:o,pathPays:i,topPathActors:c,topPathPairs:d,roundnessIdx:b,selfTradeCount:g,ammCreate:v,ammDeposit:w,ammWithdraw:k,ammVote:$,ammBid:T,ammDelete:S,lpTotal:M,lpNetFlow:C,lpRatio:A,lpUniqueActors:O,avgPathDepth:F}}function nv({hhi:e,repeats:t,dex:n,bots:s,advanced:a}){var g,v;let o=ke((e-.22)/.25,0,1)*22,i=ke((t-2)/6,0,1)*12,r=((g=n==null?void 0:n.window)==null?void 0:g.cancelRatio)??0,l=(n==null?void 0:n.topShare)??0,c=((v=n==null?void 0:n.now)==null?void 0:v.cancelsPerMin)??0,d=ke((r-.5)/.5,0,1)*18,u=ke((l-.25)/.5,0,1)*18,p=ke(c/25,0,1)*10,m=ke(s/6,0,1)*10,f=(a==null?void 0:a.roundnessIdx)!=null?ke((a.roundnessIdx-30)/40,0,1)*8:0,h=(a==null?void 0:a.selfTradeCount)>0?Math.min(8,a.selfTradeCount*4):0,b=(a==null?void 0:a.pathPays)!=null?ke(a.pathPays/30,0,1)*6:0;return Math.round(o+i+d+u+p+m+f+h+b)}function sv({friction:e,tps:t,fee:n}){let s=(n==null?void 0:n.deltaPct)!=null&&Math.abs(n.deltaPct)>=35,a=(t==null?void 0:t.deltaPct)!=null&&Math.abs(t.deltaPct)>=25;return e>=75?"Manipulated":s||a?"Stressed":((t==null?void 0:t.cur)??0)>=12||((t==null?void 0:t.avg)??0)>=10?"Active":"Quiet"}function av({s:e,txTypes:t,hhi:n,dexPatterns:s,behavior:a,friction:o,regime:i,breadcrumbs:r,clusters:l,advanced:c}){var g,v,w,k,$;let d=[],u=Ht(B.tpsHistory,Yt),p=Ht(B.feeHistory,Yt),m=((g=Object.entries(t||{}).sort(([,T],[,S])=>S-T)[0])==null?void 0:g[0])||"\u2014",f=Number(e.txPerLedger||0);d.push({sentiment:i==="Manipulated"||i==="Stressed"?"warn":i==="Active"?"up":"ok",title:`Overall: ${i} \xB7 Risk score ${o}/100`,detail:"Heuristic score from concentration, repeats, DEX churn, bot-like timing, and routing indicators. It's a signal, not proof."}),d.push({sentiment:"ok",title:`Ledger snapshot: #${Number(e.ledgerIndex||0).toLocaleString()} \xB7 ${f} tx \xB7 most common: ${m}`,detail:`TPS ${is(u.cur,2)} (avg ${is(u.avg,2)} \xB7 ${gn(u.deltaPct,0)}). Fee ${p.cur!=null?mn(p.cur):"\u2014"} (avg ${p.avg!=null?mn(p.avg):"\u2014"} \xB7 ${gn(p.deltaPct,0)}).`});let h=n>=.35?"high":n>=.25?"medium":"low";if(d.push({sentiment:n>=.35?"warn":"ok",title:`Transaction mix: ${h} concentration (HHI ${n.toFixed(2)})`,detail:n>=.35?"A few tx types dominate. Patterns look \u201Cstronger,\u201D but can be misleading.":"Mix is broad. Strong signals usually come from behavior, not just tx type."}),s.window.total){let T=Math.round(s.window.cancelRatio*100),S=Math.round(s.topShare*100);d.push({sentiment:s.signals.length?"warn":"ok",title:`DEX monitor: ${s.window.total} offer tx (window) \xB7 cancels ${T}% \xB7 top actor ~${S}%`,detail:s.signals.length?`Signals: ${s.signals.join(" \xB7 ")}`:"No strong DEX-pattern signals right now.",addr:((v=s.topActor[0])==null?void 0:v.acct)||null})}let b=r.filter(T=>T.count>=2).length;if(b>=2&&d.push({sentiment:"new",title:`Repeating counterparties: ${b} recurring pair(s)`,detail:"Repeated interactions can be routing loops, bots, or coordinated flows. Click addresses for a quick read."}),l!=null&&l.length&&((w=l[0])==null?void 0:w.size)>=3&&d.push({sentiment:"new",title:`Cluster forming: ${l[0].size} wallets \xB7 hub ${U(l[0].hub)}`,detail:"Clusters are co-activity groups (not identity proof). Use as \u201Clikely related behavior.\u201D",addr:l[0].hub}),(k=a.bots)!=null&&k.length){let T=a.bots[0];d.push({sentiment:"warn",title:`Bot-like timing: ${a.bots.length} candidate(s)`,detail:`Low variance in repeated appearances. Top: ${U(T.acct)} (CV ${T.cv.toFixed(2)}).`,addr:T.acct})}if(c!=null&&c.pathPays){let T=($=c.topPathActors)==null?void 0:$[0];d.push({sentiment:c.pathPays>=18?"warn":"ok",title:`Autobridge-ish routing: ${c.pathPays} path payments (ledger sample)`,detail:T?`Most active routing wallet: ${U(T.acct)} (${T.count}).`:"Paths/SendMax/DeliverMax appear frequently in the sample.",addr:(T==null?void 0:T.acct)||null})}return c!=null&&c.selfTradeCount&&d.push({sentiment:"warn",title:`Self-transfer signal: ${c.selfTradeCount} payment(s) where sender = receiver`,detail:"Self-transfers can be benign (housekeeping) or used to fake activity. Treat as a watch signal."}),((c==null?void 0:c.roundnessIdx)??0)>=45&&d.push({sentiment:"warn",title:`Round-number bias: ${c.roundnessIdx}% of payments are exact multiples of 100/1,000/10,000`,detail:"Round-number bias often shows scripted behavior (bots) rather than human payments."}),d.slice(0,12)}function ov(e){let t=x("d2-breadcrumb-list"),n=x("d2-breadcrumb-meta");if(!t)return;if(!e.length){t.innerHTML='<div class="gateway-item" style="opacity:.6">Watching for repeated interactions\u2026</div>',n&&(n.textContent="\u2014");return}let s=e.filter(a=>a.count>=2).length;n&&(n.textContent=s?`${s} repeats`:"Top interactions"),t.innerHTML=e.slice(0,10).map(a=>`
    <div class="gateway-item gateway-row">
      <div class="gateway-left mono cut">
        <button class="addr-link mono cut gw-from" data-addr="${y(a.from)}">${y(U(a.from))}</button>
        <span class="gw-arrow">\u2192</span>
        <button class="addr-link mono cut gw-to" data-addr="${y(a.to)}">${y(U(a.to))}</button>
      </div>
      <span class="gw-count">${a.count}\xD7</span>
    </div>`).join("")}function iv(e){let t=x("d2-cluster-list"),n=x("d2-cluster-persistence");if(t){if(!e.length){t.innerHTML='<div class="gateway-item" style="opacity:.6">Building clusters\u2026 (needs repeated activity)</div>',n&&(n.textContent="\u2014");return}n&&(n.textContent=`${e.length} group${e.length!==1?"s":""}`),t.innerHTML=e.slice(0,6).map((s,a)=>{let i=`hsl(${(a*67+120)%360},70%,60%)`,r=s.members.slice(0,4);return`
      <div class="gateway-item cluster-item">
        ...
        <div class="cluster-preview">
          ...
          <button class="addr-chip mono" data-addr="${y(s.hub)}">${y(U(s.hub))}</button>
        </div>
        <div class="cluster-preview">
          <span class="cluster-chip-h">Members:</span>
          ${r.map(l=>`<button class="addr-chip mono" data-addr="${y(l)}">${y(U(l))}</button>`).join("")}
          ${s.members.length>r.length?`<span class="cluster-more">+${s.members.length-r.length}</span>`:""}
        </div>
      </div>`}).join("")}}function rv(e){let t=x("d2-delta-narratives");if(!t)return;if(!e.length){t.innerHTML='<div class="gateway-item" style="opacity:.6">Building baseline \u2014 narratives appear after 1\u20132 ledgers\u2026</div>';return}let n={up:"#50fa7b",down:"#ff5555",new:"#00d4ff",warn:"#ffb86c",ok:"rgba(255,255,255,.85)"};t.innerHTML=e.map(s=>{let a=n[s.sentiment]||"rgba(255,255,255,.85)",o=s.addr&&Be(s.addr)?`<button class="addr-link narrative-addr" data-addr="${y(s.addr)}">Peek</button>`:"";return`
  ...
  `,t?t.insertAdjacentElement("afterend",s):n?n.insertAdjacentElement("afterend",s):e.prepend(s)}function dv(){if(vp)return;vp=!0;let e=document.querySelector(".dashboard-col-main");if(!e)return;let t=document.createElement("section");t.className="widget-card",t.id="landscape-card",t.setAttribute("aria-label","Landscape brief"),t.innerHTML=`
  ...
  `,e.prepend(t)}function fv(e){var p,m;if(!document.getElementById("dex-pattern-card"))return;let t=e.window.total||0,n=t?Math.round(e.window.cancelRatio*100):0,s=t?Math.round(e.topShare*100):0;V("dexp-badge",t?`${t} offer tx \xB7 ${n}% cancels`:"Quiet");let a=x("dexp-cancel-bar");a&&(a.style.width=`${ke(n,0,100)}%`),V("dexp-cancel-val",t?`${n}%`:"\u2014");let o=x("dexp-topshare-bar");o&&(o.style.width=`${ke(s,0,100)}%`),V("dexp-topshare-val",t?`${s}%`:"\u2014");let i=e.burstPct,r=i==null?0:Math.min(100,Math.abs(i)),l=x("dexp-burst-bar");l&&(l.style.width=`${r}%`),V("dexp-burst-val",i==null?"\u2014":gn(i,0)),V("dexp-cpm",e.now.cancelsPerMin==null?"\u2014":e.now.cancelsPerMin.toFixed(1)),V("dexp-hhi",t?e.actorHHI.toFixed(2):"\u2014"),V("dexp-totalwin",t?`${t}`:"\u2014");let c=x("dexp-signals");c&&(c.innerHTML=e.signals.length?e.signals.map(f=>`<span class="sig-pill warn">${y(f)}</span>`).join(""):'<span class="sig-pill ok">No strong DEX signals</span>');let d=x("dexp-cancellers");d&&(d.innerHTML=(p=e.topCanceller)!=null&&p.length?e.topCanceller.slice(0,5).map(f=>`
        ...
        <div class="dex-rowline">
          <button class="addr-link mono cut" data-addr="${y(f.acct)}">${y(U(f.acct))}</button>
          <span class="mono">${f.count}</span>
        </div>`).join(""):'<div style="opacity:.7">\u2014</div>')}function hv(){if(yp)return;yp=!0;let e=document.querySelector(".dashboard-col-main");if(!e)return;let t=document.createElement("section");t.className="widget-card",t.id="risk-card",t.setAttribute("aria-label","Risk panel"),t.innerHTML=`
    <div class="widget-header">
  ...
  `,t.querySelectorAll(".risk-box-toggle").forEach(n=>{var a;n.addEventListener("click",()=>{let o=n.getAttribute("data-target"),i=document.getElementById(o);if(!i)return;let r=n.getAttribute("aria-expanded")!=="false";n.setAttribute("aria-expanded",r?"false":"true"),i.classList.toggle("risk-collapsed",r),n.querySelector(".risk-box-chevron").textContent=r?"\u25B8":"\u25BE";try{localStorage.setItem("risk_collapsed_"+o,r?"1":"0")}catch{}});let s=n.getAttribute("data-target");try{localStorage.getItem("risk_collapsed_"+s)==="1"&&(n.setAttribute("aria-expanded","false"),(a=document.getElementById(s))==null||a.classList.add("risk-collapsed"),n.querySelector(".risk-box-chevron").textContent="\u25B8")}catch{}}),e.appendChild(t)}function gv(e){var r,l,c,d,u,p,m,f,h,b;if(!document.getElementById("risk-card"))return;V("risk-badge",`Risk ${e.friction}/100`),V("risk-regime",e.regime),V("risk-friction",`${e.friction}/100`);let t=[];e.hhi>=.35&&t.push({cls:"warn",t:"High concentration"}),e.breadcrumbs.filter(g=>g.count>=2).length>=3&&t.push({cls:"new",t:"Repeating counterparties"}),(l=(r=e.behavior)==null?void 0:r.bots)!=null&&l.length&&t.push({cls:"warn",t:"Bot-like timing"}),(d=(c=e.dexPatterns)==null?void 0:c.signals)!=null&&d.length&&t.push({cls:"warn",t:"DEX churn signals"}),((u=e.advanced)==null?void 0:u.selfTradeCount)>0&&t.push({cls:"warn",t:`Self-transfer: ${e.advanced.selfTradeCount}`}),(((p=e.advanced)==null?void 0:p.roundnessIdx)??0)>=45&&t.push({cls:"warn",t:`Round-number bias ${e.advanced.roundnessIdx}%`}),((m=e.advanced)==null?void 0:m.pathPays)>0&&t.push({cls:"warn",t:`Path flow: ${e.advanced.pathPays}`}),V("risk-signalcount",`${t.length}`);let n=x("risk-pills");n&&(n.innerHTML=t.length?t.map(g=>`<span class="sig-pill ${g.cls}">${y(g.t)}</span>`).join(""):'<span class="sig-pill ok">No elevated signals</span>');let s=x("risk-bots");if(s){let g=((f=e.behavior)==null?void 0:f.bots)||[];if(g.length){let v={};for(let k of g){let $=k.botType||"Periodic";v[$]||(v[$]=[]),v[$].push(k)}let w=["Market Maker","Arbitrage","Flood / Spam","Periodic"];s.innerHTML=w.filter(k=>v[k]).map(k=>{let $=v[k];return`<div class="bot-type-group">
          ...
          `).join("")}
        </div>`}).join("")}else s.innerHTML='<div style="opacity:.7;font-size:.84rem">No periodic bots detected yet</div>'}let a=x("risk-amm");if(a){let g=e.advanced||{},{ammCreate:v=0,ammDeposit:w=0,ammWithdraw:k=0,ammVote:$=0,ammBid:T=0,lpTotal:S=0,lpNetFlow:M=0,lpRatio:C,lpUniqueActors:A=0}=g;if(S===0)a.innerHTML='<div style="opacity:.6;font-size:.84rem">No AMM activity in this ledger</div>';else{let R=M>0?"#50fa7b":M<0?"#ff5555":"rgba(255,255,255,.5)";a.innerHTML=`
        <div class="amm-chips">
        ...
        <div class="risk-row"><span>Total LP ops</span><span class="mono">${S}</span></div>`}}let o=x("risk-path");if(o){let g=e.advanced||{},v=(h=g.topPathActors)==null?void 0:h[0],w=(b=g.topPathActors)==null?void 0:b[1],k=g.selfTradeCount>0?"#ff5555":"rgba(255,255,255,.5)",$=(g.roundnessIdx??0)>=45?"#ff5555":(g.roundnessIdx??0)>=25?"#ffb86c":"rgba(255,255,255,.5)";o.innerHTML=`
      ...
      ${v?`<div class="risk-row"><span>Top router</span>
        <button class="addr-link mono cut" data-addr="${y(v.acct)}">${y(U(v.acct))}</button></div>
      ...
      ${w?`<div class="risk-row" style="opacity:.7"><span>2nd router</span>
        <button class="addr-link mono cut" data-addr="${y(w.acct)}">${y(U(w.acct))}</button></div>`:""}
      <div class="risk-row" style="margin-top:4px;border-top:1px solid rgba(255,255,255,.05);padding-top:8px">
        <span>Round-number %</span><span class="mono" style="color:${$}">${g.roundnessIdx!=null?g.roundnessIdx+"%":"\u2014"}</span></div>
      <div class="risk-row"><span>Self-transfers</span><span class="mono" style="color:${k}">${g.selfTradeCount??0}</span></div>`}let i=x("risk-notes");i&&(i.innerHTML=`
    ...
    `,e.prepend(t)}}}function bv(){fe.dexPressure=[],fe.nftMints=[],fe.nftBurns=[],fe.autoBridge=[],Ei.clear(),Object.keys(Ai).forEach(e=>delete Ai[e]),nu({offerTotal:null,dexCancelPct:null,dexTopSharePct:null,mints:null,burns:null,pathPays:null,topPathActors:[],topPathPairs:[]})}function rs(e,t,n){for(e.push(Number(t||0));e.length>n;)e.shift()}function yv(e){var n,s,a,o;let t=e==null?void 0:e.advanced;t&&(rs(fe.dexPressure,t.offerTotal,dg),rs(fe.nftMints,t.mints,up),rs(fe.nftBurns,t.burns,up),rs(fe.autoBridge,t.pathPays,pg),nu(t),(n=we.dexPressure)==null||n.draw(fe.dexPressure),(s=we.nftMints)==null||s.draw(fe.nftMints),(a=we.nftBurns)==null||a.draw(fe.nftBurns),(o=we.autoBridge)==null||o.draw(fe.autoBridge))}function nu(e){var t,n,s;if(document.getElementById("dex-pressure-card")&&(V("dexP-badge",e.offerTotal==null?"Waiting\u2026":`${e.offerTotal} offer tx`),V("dexP-now",e.offerTotal==null?"\u2014":e.offerTotal),V("dexP-cancel",e.dexCancelPct==null?"\u2014":`${e.dexCancelPct}%`),V("dexP-share",e.dexTopSharePct==null?"\u2014":`${e.dexTopSharePct}%`)),document.getElementById("autobridge-card")){V("ab-badge",e.pathPays==null?"Waiting\u2026":`${e.pathPays} path pays`),V("ab-now",e.pathPays==null?"\u2014":e.pathPays);let a=(t=e.topPathActors)==null?void 0:t[0];V("ab-top-actor",a?U(a.acct):"\u2014"),V("ab-pairs",(n=e.topPathPairs)!=null&&n.length?e.topPathPairs.length:"\u2014");let o=x("ab-top-pairs");o&&(o.innerHTML=(s=e.topPathPairs)!=null&&s.length?e.topPathPairs.map(i=>`
          <div class="dex-rowline">
            <span class="mono cut">${y(U(i.from))}</span>
            <span style="opacity:.7">\u2192</span>
            <span class="mono cut">${y(U(i.to))}</span>
            <span class="mono">${i.count}</span>
          </div>`).join(""):'<div style="opacity:.7">\u2014</div>')}if(document.getElementById("nft-mint-card")){let a=Number(e.mints||0)-Number(e.burns||0);V("nft-badge",e.mints==null&&e.burns==null?"Waiting\u2026":`${e.mints||0} mints \xB7 ${e.burns||0} burns`),V("nft-mints-now",e.mints==null?"\u2014":e.mints),V("nft-burns-now",e.burns==null?"\u2014":e.burns),V("nft-net-now",`${a}`)}}function Ja({force:e=!1}={}){if(!Jt()){Oi();return}pn&&!e||(pn&&(clearInterval(pn),pn=null),Ip(),pn=setInterval(()=>{Jt()&&Ip()},ug))}function Oi(){pn&&(clearInterval(pn),pn=null)}async function Ip(){var t,n,s,a,o,i,r,l,c,d;let e=++Ti;V("mkt-badge","Loading\u2026");try{let p=await fetch("https://api.exchange.coinbase.com/products/XRP-USD/candles?granularity=3600",{cache:"no-store"});if(!p.ok)throw new Error("market history failed");let m=await p.json();if(!Array.isArray(m)||m.length<10)throw new Error("no history");if(e!==Ti)return;let f=[...m].sort((k,$)=>Number(k[0])-Number($[0])),h=f.map(k=>Number(k[4])).filter(Number.isFinite),b=f.map(k=>Number(k[5])).filter(Number.isFinite);fe.marketPrice=h.slice(-Ba),fe.marketVol=b.slice(-Ba);let g=fe.marketPrice.at(-1),v=fe.marketPrice.length>24?fe.marketPrice.at(-25):fe.marketPrice.at(0),w=v&&g?(g-v)/v*100:null;V("mkt-badge",g?`$${g.toFixed(4)}`:"\u2014"),V("mkt-price",g?`$${g.toFixed(4)}`:"\u2014"),V("mkt-chg",w==null?"\u2014":gn(w,2)),V("mkt-upd",new Date().toLocaleTimeString()),(t=we.marketPrice)==null||t.draw(fe.marketPrice),(n=we.marketVol)==null||n.draw(fe.marketVol);return}catch{}try{let u=await fetch("https://api.coinpaprika.com/v1/tickers/xrp-xrp",{cache:"no-store"});if(!u.ok)throw new Error("tick failed");let p=await u.json();if(e!==Ti)return;let m=Number((a=(s=p==null?void 0:p.quotes)==null?void 0:s.USD)==null?void 0:a.price),f=Number((i=(o=p==null?void 0:p.quotes)==null?void 0:o.USD)==null?void 0:i.volume_24h),h=Number((l=(r=p==null?void 0:p.quotes)==null?void 0:r.USD)==null?void 0:l.percent_change_24h);Number.isFinite(m)&&(rs(fe.marketPrice,m,Ba),Number.isFinite(f)&&rs(fe.marketVol,f,Ba)),V("mkt-badge",Number.isFinite(m)?`$${m.toFixed(4)}`:"\u2014"),V("mkt-price",Number.isFinite(m)?`$${m.toFixed(4)}`:"\u2014"),V("mkt-chg",Number.isFinite(h)?`${h>=0?"\u2191":"\u2193"}${Math.abs(h).toFixed(2)}%`:"\u2014"),V("mkt-upd",new Date().toLocaleTimeString()),(c=we.marketPrice)==null||c.draw(fe.marketPrice),(d=we.marketVol)==null||d.draw(fe.marketVol)}catch{V("mkt-badge","Unavailable")}}function wv(){var n,s,a,o;if(Cp)return;Cp=!0;let e=document.querySelector(".dashboard-fullwidth");if(!e){e=document.createElement("div"),e.className="dashboard-fullwidth";let i=document.querySelector(".dashboard-columns");i?i.insertAdjacentElement("afterend",e):(n=document.querySelector(".dashboard-page"))==null||n.appendChild(e)}if(document.getElementById("spam-defense-card"))return;let t=document.createElement("section");t.className="widget-card",t.id="spam-defense-card",t.setAttribute("aria-label","Spam defense"),Bi(),iu(),t.innerHTML=`
  ...
  `,e.appendChild(t),(s=x("spam-copy-hash"))==null||s.addEventListener("click",()=>{var i;return Fp(((i=x("spam-proof-hash"))==null?void 0:i.textContent)||"")}),(a=x("spam-copy-json"))==null||a.addEventListener("click",()=>{var i;return Fp(((i=x("spam-proof-json"))==null?void 0:i.textContent)||"")}),(o=x("spam-print-proof"))==null||o.addEventListener("click",Ev),_renderBondSim()}window._toggleBondSim=function(){let e=x("spam-sim-panel");if(!e)return;let t=e.style.display!=="none";e.style.display=t?"none":"";let n=x("spam-sim-toggle");n&&(n.style.color=t?"":"#00d4ff")};window._renderBondSim=function(){let e=document.getElementById("sim-base"),t=document.getElementById("sim-growth"),n=document.getElementById("sim-table");if(!n)return;let s=Number((e==null?void 0:e.value)||fs),a=Number((t==null?void 0:t.value)||hs),o=fe.marketPrice.at(-1)??null;document.getElementById("sim-base-val")&&(document.getElementById("sim-base-val").textContent=s+" XRP"),document.getElementById("sim-growth-val")&&(document.getElementById("sim-growth-val").textContent=a+"\xD7");let i="";for(let r=0;r<=Ks;r++){let l=Math.round(s*a**r),c=o?"$"+(l*o).toLocaleString(void 0,{maximumFractionDigits:0}):"",d=r<3?"#50fa7b":r<6?"#ffb86c":"#ff5555";i+=`<div style="padding:5px;border-radius:6px;background:rgba(255,255,255,.03);border:1px solid rgba(255,255,255,.07)">
      ...
      ${c?`<div style="font-size:.62rem;opacity:.45">${c}</div>`:""}
          ...
          </div>`}).join(""):r.innerHTML=`<div class="spam-empty">No suspects flagged \u2014 allow-list has ${qp.size} known-good entities.</div>`),_i||Tv(),le.selectedAddr){let d=le.byAddr.get(le.selectedAddr);d?Xi(le.selectedAddr,d,e.s.ledgerIndex).then(u=>ms(u)):ms(null)}((l=document.getElementById("spam-sim-panel"))==null?void 0:l.style.display)!=="none"&&((c=window._renderBondSim)==null||c.call(window))}function $v(e){if(!(e!=null&&e.length))return"";let t=42,n=14,s=1,a=t/Math.max(1,e.length-1),o=e.map((l,c)=>`${(c*a).toFixed(1)},${(n-2-l/s*(n-4)).toFixed(1)}`).join(" "),i=e.at(-1)??0,r=i>=.7?"#ff5555":i>=.4?"#ffb86c":"#50fa7b";return`<svg width="${t}" height="${n}" xmlns="http://www.w3.org/2000/svg" style="overflow:visible">
    ...
    <div style="margin-top:8px;border-top:1px solid rgba(255,255,255,.06);padding-top:8px">
      ...
      <ul style="margin:8px 0 0 18px;opacity:.9">
        ...
        <li>Include a Memo that starts with <span class="mono">${un}</span> and then the proof hash.</li>
    ...
    `)}function Cv(e){var o,i,r,l,c;le.allowList.size||Bi();let t=new Set;(((o=e.behavior)==null?void 0:o.bots)||[]).forEach(d=>t.add(d.acct)),(((i=e.dexPatterns)==null?void 0:i.topActor)||[]).forEach(d=>t.add(d.acct)),(((r=e.dexPatterns)==null?void 0:r.topCanceller)||[]).forEach(d=>t.add(d.acct)),(((l=e.dexPatterns)==null?void 0:l.topMaker)||[]).forEach(d=>t.add(d.acct)),(e.breadcrumbs||[]).forEach(d=>{t.add(d.from),t.add(d.to)}),(e.clusters||[]).forEach(d=>{t.add(d.hub),(d.members||[]).forEach(u=>t.add(u))}),(((c=e.advanced)==null?void 0:c.topPathActors)||[]).forEach(d=>t.add(d.acct));let n=Number(e.s.ledgerIndex||0)||null,s=e.txs||[],a=[];if(n&&n%50===0){let d=ja*24;for(let[u,p]of le.byAddr)n-(p.lastSeenLedger||0)>d&&le.byAddr.delete(u)}for(let d of t){if(!Be(d)||qp.has(d)||le.allowList.has(d))continue;let{score:u,breakdown:p}=Lv(d,e),m=Pv(p),f=le.byAddr.get(d)||{strikes:0,level:0,score:0,verifiedLedger:null,lastSeenLedger:null,scoreHistory:[],threatType:"Unknown",signalBreakdown:{}},h=f.strikes||0;u>=Up?h+=1:u<=Li&&(h=Math.max(0,h-1));let b=f.lastSeenLedger||n,g=n?n-b:0;if(g>ja&&u<Li){let S=Math.floor(g/ja);h=Math.max(0,h-S)}let v=ke(Math.floor(h/zp),0,Ks),w=[...f.scoreHistory||[],u].slice(-10),k=le.verifiedCache.get(d),$=f.verifiedLedger??(k==null?void 0:k.ledgerIndex)??null;$||($=Mv(d,v,s,n),$&&Av(d,v,n));let T={score:u,strikes:h,level:v,verifiedLedger:$,lastSeenLedger:n,scoreHistory:w,threatType:m,signalBreakdown:p};le.byAddr.set(d,T),a.push({addr:d,score:u,strikes:h,level:v,verified:!!$,verifiedLedger:$,scoreHistory:w,threatType:m,breakdown:p})}return a.sort((d,u)=>u.level-d.level||u.score-d.score),a.slice(0,fg)}function Pv(e){let{bot:t=0,dexDom:n=0,cancelPat:s=0,pingPong:a=0,pathRoute:o=0,selfTrade:i=0,roundPay:r=0}=e,l=n+s;return t>.25&&(e.botType==="Flood / Spam"||r>.05)?"Payment Flooder":t>.2&&l>.15?"DEX Bot":l>.3&&s>.1?"Quote Stuffer":a>.1?"Wash Trader":o>.1?"Arb Router":t>.2?"Periodic Bot":"Multi-Signal"}function Lv(e,t){var m,f,h,b,g;let n={bot:0,botType:null,dexDom:0,cancelPat:0,pingPong:0,pathRoute:0,selfTrade:0,roundPay:0},s=(((m=t.behavior)==null?void 0:m.bots)||[]).find(v=>v.acct===e);if(s){let v=ke((.35-s.cv)/.35,0,1);n.bot=+(.4*(.5+.5*v)).toFixed(3),n.botType=s.botType||"Periodic"}let a=t.dexPatterns,o=((h=(f=a==null?void 0:a.topActor)==null?void 0:f[0])==null?void 0:h.acct)===e&&a.topShare||0;o>0&&(n.dexDom=+(.3*ke((o-.2)/.4,0,1)).toFixed(3));let i=((a==null?void 0:a.topCanceller)||[]).find(v=>v.acct===e);i&&(n.cancelPat=+(.2*ke(i.count/20,0,1)).toFixed(3));let r=t.breadcrumbs||[],l=r.find(v=>v.from===e&&v.to===e);l&&(n.selfTrade=+(.2*ke(l.count/20,0,1)).toFixed(3));let c=r[0];if(c&&(c.from===e||c.to===e)){let v=r.find(w=>w.from===c.to&&w.to===c.from);v&&v.count>=3&&c.count>=3&&(n.pingPong=.15)}let d=(((b=t.advanced)==null?void 0:b.topPathActors)||[]).find(v=>v.acct===e);d&&(n.pathRoute=+(.15*ke(d.count/25,0,1)).toFixed(3));let u=(g=t.advanced)==null?void 0:g.roundnessIdx;return u!=null&&u>=45&&(d||s)&&(n.roundPay=+(.1*ke((u-45)/35,0,1)).toFixed(3)),{score:ke(n.bot+n.dexDom+n.cancelPat+n.pingPong+n.pathRoute+n.selfTrade+n.roundPay,0,1),breakdown:n}}function Mv(e,t,n,s){if(!(n!=null&&n.length))return null;let a=ls+t;for(let o of n)if((o==null?void 0:o.account)===e){if(o.type==="EscrowCreate"&&o.destination===e){let i=typeof o.amountXrp=="number"?o.amountXrp:null,r=Vs(t);if(i!=null&&i>=r&&Di(o.memos).startsWith(un))return s}if(o.type==="Payment"&&o.destination===e&&Number(o.destinationTag)===a&&Di(o.memos).startsWith(un))return s}return null}async function Av(e,t,n){var a;let s=le.byAddr.get(e);if(s)try{let o=await Xi(e,s,n),i=un+o.hash;if((((a=B.ledgerLog)==null?void 0:a.flatMap(c=>c.transactions||[]))||[]).some(c=>(c==null?void 0:c.account)!==e?!1:Di(c.memos).startsWith(i))){let c=ou();c[e]={ledgerIndex:n,hash:o.hash,level:t},xv(c),le.verifiedCache.set(e,{ledgerIndex:n,hash:o.hash}),ae(`\u2714 Credential verified for ${U(e)} at L${t}`)}}catch{}}function Di(e){if(!Array.isArray(e))return"";let t=[];for(let n of e){let s=(n==null?void 0:n.Memo)||(n==null?void 0:n.memo)||null;if(!s)continue;let a=s.MemoData||s.memo_data||"";try{if(typeof a=="string"&&/^[0-9A-Fa-f]+$/.test(a)&&a.length%2===0){let o=Uint8Array.from(a.match(/../g),i=>parseInt(i,16));t.push(new TextDecoder().decode(o))}else typeof a=="string"&&t.push(a)}catch{}}return t.join(" ")}async function Xi(e,t,n){let s=t.level||0,a=Vs(s),o=fe.marketPrice.at(-1)??null,i=o?(a*o).toFixed(2):null,r={hashAlgorithm:"SHA-512Half",ratchetMax:Ks,strikesToLevel:zp,strikeUp:Up,strikeDown:Li,decayLedgers:ja,bondBaseXrp:fs,bondGrowthFactor:hs,bondRequiredXrp:a,bondRequiredUsd:i,credTagBase:ls,memoPrefix:un,credentialTag:ls+s},l={v:2,hashAlg:"SHA-512Half",network:B.currentNetwork||"xrpl-mainnet",address:e,ledgerIndex:n!=null?Number(n):null,level:s,threatType:t.threatType||"Unknown",score:Number((t.score||0).toFixed(4)),strikes:Number(t.strikes||0),signalBreakdown:t.signalBreakdown||{},credential:{destinationTag:ls+s,memoFormat:un+"<SHA-512Half-of-this-proof>",verifiedLedger:t.verifiedLedger??null},policy:r,note:"Generated by NaluXRP Spam Defense POC. Hash uses XRPL-native SHA-512Half (first 256 bits of SHA-512). A gateway or relayer policy can require the indicated bond/credential before providing service to this address.",generatedAt:new Date().toISOString()},c=JSON.stringify(l,Object.keys(l).sort(),0),d=await wg(c);l.credential.memoFormat=un+d;let u=JSON.stringify(l,null,2);return{hash:d,canonicalJson:u,level:s,policy:r,threatType:t.threatType}}function Ev(){let e=le.selectedProof;if(!e){ge("Generate a proof first using the Proof button.");return}let t=le.selectedAddr||"\u2014",n=fe.marketPrice.at(-1)??null,s=e.policy.bondRequiredXrp,a=n?` (~$${(s*n).toFixed(0)} USD)`:"",o=e.hash.startsWith("FALLBACK")?'<div style="padding:8px 12px;background:#fff3cd;border:1px solid #f0ad4e;border-radius:4px;margin-bottom:12px">\u26A0 Hash is non-cryptographic (SubtleCrypto unavailable). Do NOT use for enforcement.</div>':"",i=window.open("","_blank","width=760,height=660");i.document.write(`<!DOCTYPE html><html><head>
    ...
    <div class="section">
      ...
      <p style="font-size:.85rem"><b>Option A (Bond Escrow):</b> EscrowCreate from suspect address to itself,
        ${s.toLocaleString()} XRP, finish ~25,000 ledgers from now, memo = <code>${un}${e.hash}</code></p>
    ...
    </body></html>`),i.document.close()}var ru=null;function Nv(){if(Mi)return;Mi=!0;let e=document.querySelector('[aria-label="Pattern detection"]');if(!e){e=document.createElement("section"),e.className="widget-card",e.setAttribute("aria-label","Pattern detection");let t=document.querySelector(".dashboard-col-main");if(!t)return;let n=t.querySelector(".dashboard-metrics");n?n.insertAdjacentElement("afterend",e):t.prepend(e)}e.innerHTML=`
    <div class="widget-header">
    ...
    </div>`,ru=document.getElementById("pattern-donut-canvas")}function Rv(e,t){if(!Mi)return;let n=typeof It<"u"?It:{},s=Object.entries(e||{}).filter(([,m])=>m>0).sort(([,m],[,f])=>f-m);if(!s.length)return;let a=s.reduce((m,[,f])=>m+f,0)||1,[o,i]=s[0],r=Math.round(i/a*100),l=s[1],c=x("pattern-badge");c&&(c.textContent=o+" \xB7 "+r+"%");let d=x("pattern-dom-type");if(d&&(d.textContent=o,d.style.color=n[o]||"rgba(255,255,255,.9)"),V("pattern-dom-pct",r+"% of ledger"),l){let m=Math.round(l[1]/a*100),f=x("pattern-2nd-type");f&&(f.textContent=l[0]+" ("+m+"%)",f.style.color=n[l[0]]||"rgba(255,255,255,.7)")}else V("pattern-2nd-type","\u2014");let u=x("pattern-hhi");u&&t!=null&&(u.textContent=t.toFixed(3),u.style.color=t>=.35?"#ff5555":t>=.25?"#ffb86c":"#50fa7b");let p=x("pattern-donut-center");p&&(p.innerHTML='<span style="color:'+(n[o]||"#fff")+';font-size:1.15rem">'+r+"%</span>"),_v(s,a,n)}function _v(e,t,n){let s=ru||x("pattern-donut-canvas");if(!(s!=null&&s.getContext))return;let a=s.getContext("2d"),o=s.width/2,i=s.height/2,r=Math.min(s.width,s.height)/2-6,l=r*.56;a.clearRect(0,0,s.width,s.height);let c=e.slice(0,7),d=e.slice(7).reduce((m,[,f])=>m+f,0),u=d>0?[...c,["Other",d]]:[...c],p=-Math.PI/2;for(let[m,f]of u){let h=f/t*Math.PI*2,b=ds(n[m]||"#6b7280",.88)||"#6b7280";a.beginPath(),a.moveTo(o+Math.cos(p)*l,i+Math.sin(p)*l),a.arc(o,i,r,p,p+h),a.arc(o,i,l,p+h,p,!0),a.closePath(),a.fillStyle=b,a.fill(),a.strokeStyle="rgba(0,8,20,0.85)",a.lineWidth=2,a.stroke(),p+=h}a.beginPath(),a.arc(o,i,l-1,0,Math.PI*2),a.fillStyle="rgba(0,21,36,0.94)",a.fill()}function Dv(e,t){let n=!1;for(let s of e){if((s==null?void 0:s.type)!=="Payment")continue;let a=typeof(s==null?void 0:s.amountXrp)=="number"?s.amountXrp:null;a==null||a<Bn.whaleTxXrp||(_t.unshift({ts:Date.now(),ledgerIndex:t,from:s.account||"\u2014",to:s.destination||"\u2014",amtXrp:a,hash:s.hash||""}),Ye.whaleCount++,n=!0)}if(n){for(;_t.length>hg;)_t.pop();Fv()}}function Iv(){if(Pp)return;Pp=!0;let e=document.querySelector(".dashboard-col-side");if(!e)return;let t=document.createElement("section");t.className="widget-card",t.id="whale-feed-card",t.setAttribute("aria-label","Whale alert feed"),t.innerHTML=`
    <div class="widget-header">
    ...
    <div id="whale-feed-list" style="max-height:260px;overflow-y:auto">
    ...
    </div>`,e.prepend(t)}function Fv(){let e=x("whale-feed-list");if(!e)return;let t=x("whale-badge");if(t&&(t.textContent=_t.length?`${_t.length} alerts`:"Watching\u2026"),!_t.length){e.innerHTML='<div style="opacity:.5;font-size:.82rem;padding:8px 0">No whale transactions yet.</div>';return}e.innerHTML=_t.slice(0,20).map(n=>{let s=n.amtXrp>=1e6?`${(n.amtXrp/1e6).toFixed(2)}M`:n.amtXrp>=1e3?`${(n.amtXrp/1e3).toFixed(0)}K`:n.amtXrp.toFixed(0),a=Math.floor((Date.now()-n.ts)/1e3),o=a<60?`${a}s`:a<3600?`${Math.floor(a/60)}m`:`${Math.floor(a/3600)}h`;return`<div style="border-bottom:1px solid rgba(255,255,255,.05);padding:7px 0">
      ...
      <div style="display:flex;gap:4px;align-items:center;font-size:.74rem">
        <button class="addr-link mono cut" data-addr="${y(n.from)}" style="max-width:100px">${y(U(n.from))}</button>
        <span style="opacity:.5">\u2192</span>
        <button class="addr-link mono cut" data-addr="${y(n.to)}" style="max-width:100px">${y(U(n.to))}</button>
    ...
    </div>`}).join("")}function Ov(){if(Lp)return;Lp=!0;let e=document.querySelector(".dashboard-col-main");if(!e)return;let t=document.createElement("section");t.className="widget-card",t.id="network-health-card",t.setAttribute("aria-label","Network health"),t.innerHTML=`
    <div class="widget-header">
    ...
    <div style="display:flex;align-items:center;gap:16px;padding:8px 0 12px">
      ...
      </div>`}).join(""))}function Xv(){if(Mp)return;Mp=!0;let e=document.querySelector(".dashboard-col-side");if(!e)return;let t=document.createElement("section");t.className="widget-card",t.id="session-stats-card",t.setAttribute("aria-label","Session stats"),t.innerHTML=`
    <div class="widget-header">
    ...
    </div>`,e.appendChild(t)}function Hv(){if(!document.getElementById("session-stats-card"))return;let e=Math.floor((Date.now()-Ye.startTime)/6e4);V("ss-ledgers",Ye.ledgersProcessed.toLocaleString()),V("ss-tx",Ye.totalTx.toLocaleString()),V("ss-whales",Ye.whaleCount),V("ss-feespikes",Ye.feeSpikes),V("ss-bots",Ye.botDetections),V("ss-dexalerts",Ye.dexAlerts),V("ss-time",`${e}m`),V("ss-badge",`${Ye.ledgersProcessed} ledgers`)}function zv(e,t){var o,i,r,l,c,d,u,p;if(Vp=t,_t.length&&_t[0].ledgerIndex===t){let m=_t[0],f=m.amtXrp>=1e6?`${(m.amtXrp/1e6).toFixed(1)}M`:`${(m.amtXrp/1e3).toFixed(0)}K`;ae(`\u{1F40B} Whale: ${f} XRP  ${U(m.from)} \u2192 ${U(m.to)}`)}let n=Qp(),s=(o=B.feeHistory)==null?void 0:o.at(-1);s&&n&&s>n*Bn.feeSpikeMultiple&&(Ye.feeSpikes++,ge(`\u{1F525} Fee spike: ${mn(s)} (${Math.round(s/n)}\xD7 baseline)`));let a=(((i=e.behavior)==null?void 0:i.bots)||[]).filter(m=>m.cv<Bn.botCvThreshold&&m.total>8);a.length&&(Ye.botDetections=Math.max(Ye.botDetections,a.length),a[0].botType==="Flood / Spam"&&ge(`\u{1F916} Spam bot: ${U(a[0].acct)} (CV ${a[0].cv.toFixed(2)})`)),((l=(r=e.dexPatterns)==null?void 0:r.window)==null?void 0:l.cancelRatio)>=Bn.dexCancelAlert&&((d=(c=e.dexPatterns)==null?void 0:c.window)==null?void 0:d.total)>=20&&(Ye.dexAlerts++,ge(`\u{1F9E0} DEX: ${Math.round(e.dexPatterns.window.cancelRatio*100)}% cancel ratio \u2014 possible quote-stuffing`)),((p=(u=e.clusters)==null?void 0:u[0])==null?void 0:p.size)>=Bn.clusterMinSize&&ae(`\u{1F578} Cluster: ${e.clusters[0].size} wallets around ${U(e.clusters[0].hub)}`),e.friction>=75&&e.regime==="Manipulated"&&ge(`\u26A0\uFE0F Risk score: ${e.friction}/100 \u2014 ${e.regime} regime`),Bv(e.s)}function Uv(){var n,s,a,o;if(Ap)return;Ap=!0;let e=document.createElement("button");e.id="customize-btn",e.className="customize-btn",e.setAttribute("aria-pressed","false"),e.innerHTML="\u2699 Customize",(n=document.querySelector(".dashboard-header"))==null||n.appendChild(e);let t=document.createElement("div");t.id="customize-panel",t.className="customize-panel",t.setAttribute("aria-label","Dashboard customizer"),t.innerHTML=`
  ...
  `,e.appendChild(t);let n=s=>{var a;return(a=document.querySelector(`.dash-tab[data-tab="${s}"]`))==null?void 0:a.click()};t.addEventListener("click",s=>{let a=s.target.closest("button[data-go]");if(!a)return;let o=a.dataset.go;if(o==="stream"||o==="inspector"||o==="network"){n(o);return}n("stream"),setTimeout(()=>{var r;let i=o==="dex"?"dex-pattern-card":"risk-card";(r=document.getElementById(i))==null||r.scrollIntoView({behavior:"smooth",block:"start"})},80)})}function Jv(){var a,o;if(xp)return;xp=!0;let e=document.querySelector(".dashboard-header");if(!e||document.getElementById("compactToggleBtn"))return;let t=document.createElement("button");t.id="compactToggleBtn",t.type="button",t.className="dash-accordion-toggle",t.textContent="Compact: OFF",e.appendChild(t);let n=(i,r=!0)=>{if(document.body.classList.toggle("dash-accordion",i),t.textContent=i?"Compact: ON":"Compact: OFF",r)try{localStorage.setItem(pp,i?"1":"0")}catch{}if(i){let l=document.querySelector(".dashboard-col-side .widget-card");l&&l.classList.add("is-open")}else document.querySelectorAll(".dashboard-col-side .widget-card.is-open").forEach(l=>l.classList.remove("is-open"))},s=null;try{s=localStorage.getItem(pp)}catch{}n(s==="1"?!0:s==="0"?!1:((o=(a=window.matchMedia)==null?void 0:a.call(window,"(max-width: 600px)"))==null?void 0:o.matches)??!1,!1),t.addEventListener("click",()=>n(!document.body.classList.contains("dash-accordion"),!0))}function Yv(){if(kp)return;kp=!0;let e=document.querySelector(".dashboard-col-side");e&&e.addEventListener("click",t=>{var o,i;if(!document.body.classList.contains("dash-accordion"))return;let n=t.target;if((o=n==null?void 0:n.closest)!=null&&o.call(n,"button, a, input, textarea, select, kbd"))return;let s=(i=n==null?void 0:n.closest)==null?void 0:i.call(n,".widget-card");if(!s)return;let a=s.classList.contains("is-open");e.querySelectorAll(".widget-card.is-open").forEach(r=>{r!==s&&r.classList.remove("is-open")}),s.classList.toggle("is-open",!a)})}var Ne={lsfPasswordSpent:65536,lsfRequireDestTag:131072,lsfRequireAuth:262144,lsfDisallowXRP:524288,lsfDisableMaster:1048576,lsfNoFreeze:2097152,lsfGlobalFreeze:4194304,lsfDefaultRipple:8388608,lsfDepositAuth:16777216},cu={lsfBurnable:1,lsfOnlyXRP:2,lsfTrustLine:4,lsfTransferable:8},Qv=new Set(["SetRegularKey","SignerListSet","AccountSet","AccountDelete","EscrowCreate","PaymentChannelCreate","DepositPreauth"]),bn={blackhole:"#ff5555",exchange:"#00d4ff",newWallet:"#ff79c6",issuer:"#ffb86c",wallet:"#bd93f9",other:"#8be9fd"},Zv=.55,eb=.15,Gi=20,fu=946684800;function st({module:e,category:t=null,sev:n,confidence:s=null,headline:a,detail:o="",observed:i=[],alternativeExplanations:r=[],evidenceAgainstBenign:l=[],classification:c=null,hashes:d=[]}={}){return{module:e,category:t,sev:n,confidence:s,headline:a,label:a,detail:o,observed:i,alternativeExplanations:r,evidenceAgainstBenign:l,classification:c,hashes:d}}var tb=new Map([["rPVMhWBsfF9iMXYj3aAzJVkPDTFNSyWdKy",{name:"Bitstamp",type:"exchange"}],["rvYAfWj5gh67oV6fW32ZzP3Aw4Eubs59B",{name:"Bitstamp",type:"exchange"}],["rrpNnNLKrartuEqfJGpqyDwPj1BBN1ih7",{name:"Bitstamp",type:"exchange"}],["rN7n3473SaZBCG4dFL83w7PB9judJ7qdDo",{name:"Binance",type:"exchange"}],["rEb8TK3gBgk5auZkwc6sHnwrGVJH8DuaLh",{name:"Binance",type:"exchange"}],["rBKPS4oLSaV2KVVuHH8EpQqMGgGefGFQs7",{name:"Bitso",type:"exchange"}],["rfk5bwaKCoNU84fTzdqWQowqnNaZorDmiV",{name:"Gate.io",type:"exchange"}],["rGFuMiw48HdbnrUbkRYDTvT5i9imC5fvv9",{name:"Gate.io",type:"exchange"}],["rwYHCs2EYBMBvRXFmxDrCUSorPsuqCck7t",{name:"Kraken",type:"exchange"}],["rLHzPsX6oXkzU2qL12kHCH8G8cnZv1rBJh",{name:"Kraken",type:"exchange"}],["ra5nK24KXen9AHvsdFTKHSANinZseWnPcX",{name:"Uphold",type:"exchange"}],["rGWrZyax5eXbi5gs49MRZKkE9eKNL9p4B",{name:"Bittrex",type:"exchange"}],["rDsbeomae4FXwgQTJp9Rs64Qg9vDiTCdBv",{name:"Coinone",type:"exchange"}],["rHsMUQFzBb7S6GnQFVgNirqvHRcLpAn5dU",{name:"Bithumb",type:"exchange"}],["rMQ98K56yXJbDGv49ZSmW51sLn94Xe1mu1",{name:"Huobi",type:"exchange"}],["rHcFoo6a9qT5NHiVn1THwX3B4QF2VQKWZ",{name:"Huobi",type:"exchange"}],["rKiCet8SdvWxPXnAgYarFUXMh1zCPz432Y",{name:"Coinbase",type:"exchange"}],["rHb9CJAWyB4rj91VRWn96DkukG4bwdtyTh",{name:"Coinbase",type:"exchange"}],["r9mhdcT2K7FdCGDEPqfbMJwVXsXCqEr5bP",{name:"OKX",type:"exchange"}],["r32U8WFxhqEAVkKcTb1GGRR1VH2oaFdexN",{name:"OKX",type:"exchange"}],["r4GDFMLGJUKMjNEycBKPGnRSNXyNVLQLHi",{name:"Bybit",type:"exchange"}],["rBETszU65yYoFcYdRkiGqFaYmhZpHWC7sj",{name:"Bybit",type:"exchange"}],["rMWUykAmNQDaM9poSes8VLDZDDkEoutilities",{name:"KuCoin",type:"exchange"}],["rUA1S9qobBkxLqzdfGEzh5wm5KdLfbf8bx",{name:"KuCoin",type:"exchange"}],["rHtbQzmN4BDaEBnGSXp3AZaZAuZamNVsME",{name:"MEXC",type:"exchange"}],["rDN1gPWW3XQFXVJFQSiJxPHGZiRLMVSi7K",{name:"MEXC",type:"exchange"}],["rB3gZey7VWHoDokMt3tCiXBSRmaZi5xJi9",{name:"Crypto.com",type:"exchange"}],["rhub8VRN55s94qWKDv6jmDy1pUykJzF3wq",{name:"GateHub",type:"exchange"}],["razqnFn6FqBaYBdNaGnVzmGaNE6XPRQ9bG",{name:"GateHub",type:"exchange"}],["rGQdkxNBQeQC1WTQDQ2F2QoGBZxYcMxBBg",{name:"GateHub",type:"exchange"}],["rpXTzCuXtjiPDFysxq8uNmtZBe9Xo97JbW",{name:"Bitbank",type:"exchange"}],["rsuUjfWxrACCAwGQDsNeZUhpzXf1n1NK5Z",{name:"Bitbank",type:"exchange"}],["r9oxUGJqMfMEhGBxrMJnmNvVh1LKkMv7fz",{name:"Coincheck",type:"exchange"}],["rHb9CJAWyB4rj91VRWn96DkukG4bwdtyTh",{name:"Genesis (Black Hole)",type:"blackhole"}],["r9cZA1mLK5R5Am25ArfXFmqgNwjZgnfk59",{name:"Black Hole #2",type:"blackhole"}],["rHb9CJAWyB4rj91VRWn96DkukG4bwdtyTh",{name:"Genesis Wallet",type:"ripple"}],["rHb9CJAWyB4rj91VRWn96DkukG4bwdtyTh",{name:"Ripple Labs Ops",type:"ripple"}],["rPEPPER7kfTD9w2To4CQk6UCfuHM9c6GDY",{name:"XAMAN (XUMM)",type:"wallet"}],["rBj4eVRWn6mCELVTNkVFDfGNByE9VFTM3R",{name:"XAMAN",type:"wallet"}],["rHb9CJAWyB4rj91VRWn96DkukG4bwdtyTh",{name:"XRPL AMM Engine",type:"dex"}],["rsoLo2S1kiGeCcn6hCUXVrCpGMWLrRrLZz",{name:"SOLO Issuer",type:"issuer"}],["rcoreNywaoz2ZCVt2sc3JiEi7G7MpZxZgm",{name:"CORE Token",type:"issuer"}],["rhXo4TcWbLY4GqTSmscMpgZ1KMXFBi9V55",{name:"XRPL DeFi Pool",type:"issuer"}],["rHb9CJAWyB4rj91VRWn96DkukG4bwdtyTh",{name:"UNL Validator Set",type:"validator"}]]);function Hn(e){return tb.get(e)||null}var nb=null,ut=!1;var bs=null,du=!1,ji=!0;function Za(){return ji&&B.currentPage==="dashboard"&&B.currentTab==="inspector"&&!document.hidden}async function sb(e){let t=[s=>`https://corsproxy.io/?${encodeURIComponent(s)}`,s=>`https://api.allorigins.win/raw?url=${encodeURIComponent(s)}`],n=async s=>{let a=typeof(AbortSignal==null?void 0:AbortSignal.timeout)=="function"?AbortSignal.timeout(6e3):void 0,o=await fetch(s,{mode:"cors",cache:"no-store",signal:a});if(!o.ok)throw new Error(`HTTP ${o.status}`);return await o.json()};try{return await n(e)}catch{for(let s of t)try{return await n(s(e))}catch{}throw new Error("Price feed unavailable")}}async function ab(){if(du)return bs;du=!0;try{let e=await sb("https://api.exchange.coinbase.com/products/XRP-USD/ticker");bs=Number((e==null?void 0:e.price)||0)||null}catch{bs=null}return bs}function yn(e){if(!bs||!e)return"";let t=e*bs;return t>=1e6?` (~$${(t/1e6).toFixed(2)}M)`:t>=1e3?` (~$${(t/1e3).toFixed(1)}K)`:` (~$${t.toFixed(2)})`}var Ys=null;function hu(){return Ys||(Ys={input:()=>document.getElementById("inspect-addr"),err:document.getElementById("inspect-err"),result:document.getElementById("inspect-result"),empty:document.getElementById("inspect-empty"),loading:document.getElementById("inspect-loading"),loadMsg:document.getElementById("inspect-loading-msg"),warn:document.getElementById("inspect-warn"),badge:document.getElementById("inspect-addr-badge"),score:document.getElementById("inspect-risk-score"),label:document.getElementById("inspect-risk-label")},Ys)}function ob(){Ys=null,hu()}function gu(){var n,s,a,o,i;Sy(),Ty(),Cy(),(n=x("inspect-addr"))==null||n.addEventListener("keydown",r=>{r.key==="Enter"&&ys()}),(s=x("inspect-addr"))==null||s.addEventListener("paste",()=>{setTimeout(()=>{var l;let r=(l=x("inspect-addr"))==null?void 0:l.value.trim();r&&Be(r)&&ys()},60)});let e=r=>{let l=r==null?void 0:r.closest(".inspector-section");if(!l)return;let c=l.classList.toggle("collapsed");r.setAttribute("aria-expanded",String(!c))};(a=document.getElementById("tab-inspector"))==null||a.addEventListener("click",r=>{if(r.target.closest("button"))return;let l=r.target.closest(".section-header");l&&e(l)}),(o=document.getElementById("tab-inspector"))==null||o.addEventListener("keydown",r=>{var c,d;if(r.key!=="Enter"&&r.key!==" ")return;let l=(d=(c=r.target).closest)==null?void 0:d.call(c,".section-header");l&&(r.preventDefault(),e(l))}),(i=document.getElementById("inspector-nav"))==null||i.addEventListener("click",r=>{var d;let l=r.target.closest("[data-jump]");if(!l)return;let c=document.getElementById("section-"+l.dataset.jump);c&&(c.classList.remove("collapsed"),(d=c.querySelector(".section-header"))==null||d.setAttribute("aria-expanded","true"),c.scrollIntoView({behavior:"smooth",block:"start"})),Mu(l.dataset.jump)});let t=!1;window.addEventListener("scroll",()=>{Za()&&(t||(t=!0,requestAnimationFrame(()=>{Py(),t=!1})))},{passive:!0}),window.runInspect=ys,window.inspectorCopyAddr=My,window.showInspectorHowTo=Ay,window.hideInspectorHowTo=qi,ob(),_y(),window.addEventListener("naluxrp:tabchange",r=>{var l;((l=r.detail)==null?void 0:l.tabId)==="inspector"&&Za()&&(Yi(),Qi(),ta(),eo())})}function vu(e){ji=!!e,ji||(ut=!0)}async function ys(){var a,o,i,r,l,c,d,u,p,m,f,h,b,g,v;if(!Za())return;let e=hu(),t=((a=e.input())==null?void 0:a.value.trim())||"";if([e.err,e.result,e.empty,e.warn].forEach(w=>w&&(w.style.display="none")),ut=!0,!t){e.empty&&(e.empty.style.display="");return}if(!Be(t)){e.err&&(e.err.textContent=`\u26A0 Invalid address: ${y(t)}`,e.err.style.display="");return}if(B.connectionState!=="connected"){e.warn&&(e.warn.style.display="");return}nb=t,ut=!1;let n=w=>{e.loading&&(e.loading.style.display="",e.loadMsg&&(e.loadMsg.textContent=w))};n("Fetching account data\u2026");let s=w=>new Promise(k=>setTimeout(k,w));try{n("Fetching account data\u2026");let[w,k,$]=await Promise.all([Me({command:"account_info",account:t,ledger_index:"validated"}),Me({command:"account_offers",account:t,ledger_index:"validated"}),Me({command:"account_nfts",account:t,ledger_index:"validated"}).catch(()=>null)]);if(ut)return;let T=((o=w==null?void 0:w.result)==null?void 0:o.account_data)||{},S=((i=k==null?void 0:k.result)==null?void 0:i.offers)||[],M=((r=$==null?void 0:$.result)==null?void 0:r.account_nfts)||[];n("Fetching trustlines\u2026");let C=[],A,R=0;do{R++;let K={command:"account_lines",account:t,ledger_index:"validated",limit:400};A&&(K.marker=A);let ue=await Me(K).catch(()=>null);if(ut)return;let be=((l=ue==null?void 0:ue.result)==null?void 0:l.lines)||[];C.push(...be),A=((c=ue==null?void 0:ue.result)==null?void 0:c.marker)||null,R>1&&await s(50)}while(A&&C.length<4e3);n("Fetching account objects\u2026");let O=[],I,D=0;do{D++;let K={command:"account_objects",account:t,ledger_index:"validated",limit:400};I&&(K.marker=I);let ue=await Me(K).catch(()=>null);if(ut)return;let be=((d=ue==null?void 0:ue.result)==null?void 0:d.account_objects)||[];O.push(...be),I=((u=ue==null?void 0:ue.result)==null?void 0:u.marker)||null,D>1&&await s(50)}while(I&&O.length<2e3);n("Fetching token supply, AMM data & price\u2026");let F=15,H=C.filter(K=>K.currency&&Number(K.balance)!==0&&K.currency.startsWith("03")&&K.currency.length===40),[E,,...z]=await Promise.all([Me({command:"gateway_balances",account:t,ledger_index:"validated"}).catch(()=>null),ab(),...H.slice(0,F).map(K=>Me({command:"amm_info",amm_account:K.account,ledger_index:"validated"}).catch(()=>null))]);if(ut)return;let te=(E==null?void 0:E.result)||null,oe=new Map;H.slice(0,F).forEach((K,ue)=>{var be,He;(He=(be=z[ue])==null?void 0:be.result)!=null&&He.amm&&oe.set(K.currency,z[ue].result.amm)});let pe=400,ie=250,ne=window._inspectMaxTx||5e3,ce=Math.ceil(ne/pe),G=[],Se=new Set,X=K=>{var ue,be;for(let He of K||[]){let ft=((ue=He.tx_json)==null?void 0:ue.hash)||((be=He.tx)==null?void 0:be.hash)||He.hash||null;ft&&Se.has(ft)||(ft&&Se.add(ft),G.push(He))}},q={newestToOldestComplete:!1,oldestToNewestFetched:!1,hitTxCap:!1,hitPageCap:!1,fetchErrorOccurred:!1},se,me=0;for(let K=1;K<=ce&&G.length<ne;K++){if(me=K,ut)return;n(`Fetching transactions \u2014 page ${K} (${G.length.toLocaleString()} so far)\u2026`);let ue={command:"account_tx",account:t,limit:pe,ledger_index_min:-1,ledger_index_max:-1,forward:!1};se&&(ue.marker=se);let be=await Me(ue).catch(()=>null);if(ut)return;if(be==null&&(q.fetchErrorOccurred=!0),X((p=be==null?void 0:be.result)==null?void 0:p.transactions),se=((m=be==null?void 0:be.result)==null?void 0:m.marker)||null,!se)break;K<ce&&G.length<ne&&await s(ie)}if(q.hitTxCap=G.length>=ne,q.hitPageCap=!!se&&me>=ce,q.newestToOldestComplete=!se,G.length<ne){if(ut)return;n("Fetching oldest transactions (anchoring history start)\u2026");let K=await Me({command:"account_tx",account:t,limit:pe,ledger_index_min:-1,ledger_index_max:-1,forward:!0}).catch(()=>null);if(ut)return;K==null&&(q.fetchErrorOccurred=!0),X((f=K==null?void 0:K.result)==null?void 0:f.transactions),q.oldestToNewestFetched=K!=null&&!((h=K==null?void 0:K.result)!=null&&h.marker),await s(ie)}e.loading&&(e.loading.style.display="none");let xe=ib(G).sort((K,ue)=>(K.tx.date??0)-(ue.tx.date??0)),Te=946684800,We=null,Ie=null,Re=q.newestToOldestComplete||q.oldestToNewestFetched;if(xe.length>0){let K=xe[0].tx;K!=null&&K.date&&(Ie=(K.date+Te)*1e3,We=Math.floor((Date.now()-Ie)/864e5))}let Y=new Map;for(let{tx:K}of xe){if(K.TransactionType!=="OfferCreate"||!K.TakerPays||!K.TakerGets)continue;let ue=He=>typeof He=="string"?"XRP":`${He.currency}+${He.issuer||""}`,be=[ue(K.TakerPays),ue(K.TakerGets)].sort().join("\u2194");Y.set(be,(Y.get(be)||0)+1)}let he=null;if(Y.size>0){let K=[...Y.entries()].sort((tn,da)=>da[1]-tn[1])[0][0],[ue,be]=K.split("\u2194"),He=tn=>tn==="XRP"?{currency:"XRP"}:{currency:tn.split("+")[0],issuer:tn.split("+")[1]},ft=await Me({command:"book_offers",taker_pays:He(ue),taker_gets:He(be),limit:20,ledger_index:"validated"}).catch(()=>null);(g=(b=ft==null?void 0:ft.result)==null?void 0:b.offers)!=null&&g.length&&(he={pair:K,offers:ft.result.offers})}let et=[...new Set(xe.filter(({tx:K})=>K.TransactionType==="Payment"&&K.Account===t&&K.Destination).map(({tx:K})=>K.Destination))].slice(0,6),it=new Map;for(let K of et){if(ut)return;let ue=await Me({command:"account_info",account:K,ledger_index:"validated"}).catch(()=>null),be=(v=ue==null?void 0:ue.result)==null?void 0:v.account_data;be&&it.set(K,{sequence:be.Sequence||0,balance:Number(be.Balance||0)/1e6}),await s(80)}pb(t,T,C,S,M,O,xe,{gatewayBalances:te,ammInfoMap:oe,destAgeMap:it,walletAgeDays:We,walletCreatedTs:Ie,walletAgeVerified:Re,historyCoverage:q,liveOrderBook:he}),e.result&&(e.result.style.display="",Zi());let Ct=e.score?Number(e.score.textContent):null;Hy(t,isNaN(Ct)?null:Ct);let Dt=window._lastAllFindings||[];zy(t,isNaN(Ct)?null:Ct,Dt),Ky(t,Dt),Vi(t)&&jy(t,isNaN(Ct)?null:Ct),Vy()}catch(w){if(ut)return;e.loading&&(e.loading.style.display="none"),e.err&&(e.err.textContent=`Error: ${y(w.message)}`,e.err.style.display="")}}function ib(e){return e.map(t=>{let n=t.tx_json||t.tx||t.transaction||{},s=t.metadata||t.meta||{};return n.date==null&&t.date!=null&&(n.date=t.date),!n.hash&&t.hash&&(n.hash=t.hash),{tx:n,meta:s}})}function vn(e){if(e==null)return null;if(typeof e=="string")return Number(e)/1e6;let t=Number(e.value);return Number.isFinite(t)?t:null}function pu(e){return typeof e=="string"?"XRP":(e==null?void 0:e.currency)||null}function bu(e){return typeof e=="string"&&e.length===40&&e.startsWith("03")}function Ki(e,t,n){var a,o,i,r,l,c,d,u,p,m,f,h;let s={xrpDelta:0,tokenDeltas:[],tokenDeltaMap:new Map,lpDeltas:[],lpDeltaMap:new Map};if(!((a=t==null?void 0:t.AffectedNodes)!=null&&a.length))return s;for(let b of t.AffectedNodes){let g=b.CreatedNode,v=b.ModifiedNode,w=b.DeletedNode,k=g||v||w;if(k){if(k.LedgerEntryType==="AccountRoot"){if((((o=k.FinalFields)==null?void 0:o.Account)||((i=k.NewFields)==null?void 0:i.Account))!==n)continue;let T=Number(((r=k.FinalFields||k.NewFields)==null?void 0:r.Balance)??0),S=g?0:Number(((l=k.PreviousFields)==null?void 0:l.Balance)??T),M=(T-S)/1e6;M&&(s.xrpDelta+=M);continue}if(k.LedgerEntryType==="RippleState"){let $=k.FinalFields||k.NewFields,T=(c=$==null?void 0:$.LowLimit)==null?void 0:c.issuer,S=(d=$==null?void 0:$.HighLimit)==null?void 0:d.issuer,M=T===n;if(!M&&!(S===n))continue;let A=M?1:-1,R=M?S:T,O=(u=$==null?void 0:$.Balance)==null?void 0:u.currency,I=w?0:Number(((p=$==null?void 0:$.Balance)==null?void 0:p.value)??0),D=g?0:Number(((f=(m=k.PreviousFields)==null?void 0:m.Balance)==null?void 0:f.value)??(w?((h=$==null?void 0:$.Balance)==null?void 0:h.value)??0:I)),F=(I-D)*A;if(!F||!O)continue;let H=bu(O)?s.lpDeltaMap:s.tokenDeltaMap,E=`${O}.${R}`,z=H.get(E)||{currency:O,issuer:R,delta:0};z.delta+=F,H.set(E,z)}}}return s.tokenDeltas=[...s.tokenDeltaMap.values()],s.lpDeltas=[...s.lpDeltaMap.values()],delete s.tokenDeltaMap,delete s.lpDeltaMap,s}function yu(e,t){return e.map(({tx:n,meta:s})=>{let a=Ki(n,s,t);return{txHash:n.hash,date:n.date,type:n.TransactionType,result:(s==null?void 0:s.TransactionResult)||null,xrpDelta:a.xrpDelta,tokenDeltas:a.tokenDeltas,lpDeltas:a.lpDeltas}})}function wu(e,t,n){let s=yu(e,t),a=n,o=new Array(s.length);for(let i=s.length-1;i>=0;i--){let r=a;a-=s[i].xrpDelta,o[i]={...s[i],balanceBefore:a,balanceAfter:r}}return o}var rb=[86400,3*86400],lb=.5,cb=10;function xu(e,t,n,s={}){var d;let a=[],o=e.length,i=t.filter(({tx:u})=>["SetRegularKey","SignerListSet"].includes(u.TransactionType)).map(({tx:u})=>u.date).filter(u=>u!=null);for(let u of rb)for(let p=0;p<o;p++){let m=e[p];if(m.date==null||m.balanceBefore<=0)continue;let f=0,h=p,b=[];for(;h<o&&e[h].date!=null&&e[h].date-m.date<=u;)e[h].xrpDelta<0&&(f+=-e[h].xrpDelta,b.push(e[h])),h++;let g=m.balanceBefore>0?f/m.balanceBefore:0;g>=lb&&f>cb&&a.push({windowSec:u,startDate:m.date,endDate:((d=e[Math.min(h,o)-1])==null?void 0:d.date)??m.date,balanceAtStart:m.balanceBefore,totalOutflowXrp:f,pctOfBalanceMoved:g,startIdx:p,endIdx:Math.min(h,o)-1,triggeredByAuthChange:i.some(v=>v<=m.date&&m.date-v<=u)})}let r=300;a.sort((u,p)=>p.pctOfBalanceMoved-u.pctOfBalanceMoved);let l=[];for(let u of a)l.some(m=>m.windowSec===u.windowSec&&u.startDate<=m.endDate+r&&u.endDate>=m.startDate-r)||l.push(u);l.sort((u,p)=>u.startDate-p.startDate);let c=s.fetchErrorOccurred?"possibly-incomplete":"complete";return l.map(u=>({...u,dataCompleteness:c}))}function db(e,t,n,s){let a=t.slice(e.startIdx,e.endIdx+1).filter(C=>C.xrpDelta<0),o=new Set(a.map(C=>C.txHash)),i=n.filter(({tx:C})=>o.has(C.hash)&&C.TransactionType==="Payment"),r=new Set(n.filter(({tx:C})=>C.TransactionType==="Payment"&&C.Account===s&&C.date<e.startDate).map(({tx:C})=>C.Destination).filter(Boolean)),l=[...new Set(i.map(({tx:C})=>C.Destination).filter(Boolean))],c=l.filter(C=>!r.has(C)),d=l.length?c.length/l.length:null,u=new Map;for(let{tx:C}of i){let A=typeof C.Amount=="string"?Number(C.Amount)/1e6:0;u.set(C.Destination,(u.get(C.Destination)||0)+A)}let p=[...u.entries()].sort((C,A)=>A[1]-C[1]),m=e.totalOutflowXrp>0&&p[0]?p[0][1]/e.totalOutflowXrp:null,f=p.map(([C,A])=>({addr:C,xrp:A,entity:Hn(C)})),h=n.filter(({tx:C})=>C.TransactionType==="Payment"&&C.Account===s&&(C.date<e.startDate||C.date>e.endDate)&&typeof C.Amount=="string").map(({tx:C})=>Number(C.Amount)/1e6).filter(C=>C>0),b=C=>{let A=[...C].sort((R,O)=>R-O);return A.length?A[Math.floor(A.length/2)]:null},g=b(h),v=i.map(({tx:C})=>Number(C.Amount)/1e6).filter(C=>C>0),w=b(v),k=g&&w?w/g>=5:!1,$=new Map;for(let C of t.slice(e.startIdx,e.endIdx+1))for(let A of C.tokenDeltas){if(A.delta>=0)continue;let R=`${A.currency}.${A.issuer}`;$.set(R,($.get(R)||0)+-A.delta)}let T=[...$.entries()].map(([C,A])=>({key:C,amount:A})),M=t.filter(C=>C.date!=null&&C.date<e.startDate&&e.startDate-C.date<=172800).some(C=>C.xrpDelta>0&&C.tokenDeltas.some(A=>A.delta<0));return{...e,newRecipientPct:d,newDestCount:c.length,episodeDestCount:l.length,topDestShare:m,destinations:f.slice(0,5),transferSizeAnomaly:k,historicalMedianXrp:g,episodeMedianXrp:w,trustlineLiquidations:T,dexConversionPrecedingWithdrawal:M}}function pb(e,t,n,s,a,o,i,r={}){let{gatewayBalances:l=null,ammInfoMap:c=new Map,destAgeMap:d=new Map,walletAgeDays:u=null,walletCreatedTs:p=null,walletAgeVerified:m=!1,historyCoverage:f=null,liveOrderBook:h=null}=r,b=Number(t.Balance||0)/1e6,g=Number(t.OwnerCount||0),v=10+g*2,w=Number(t.Flags||0),k=t.Sequence??"\u2014",$=o.filter(Y=>Y.LedgerEntryType==="SignerList"),T=o.filter(Y=>Y.LedgerEntryType==="Escrow"),S=o.filter(Y=>Y.LedgerEntryType==="PayChannel"),M=o.filter(Y=>Y.LedgerEntryType==="DepositPreauth"),C=o.filter(Y=>Y.LedgerEntryType==="Check"),A=gb(t,w,$,i,f),R=Tu(t,w,$,i,S,T,e,b,f),O=yb(a,i,e),I=zb(h,e),D=Cu(i,e,f||{}),F=xb(D,e),H=Cb(i,e,n,D,F,I),E=Rb(t,n,w,i),z=_b(n,i,o,c,e),te=Pb(i),oe=Nb(i,e),pe=Lb(i,e),ie=Mb(i,e),ne=Ab(i),ce=Eb(i,e),G=ub(i,e,d),Se=Db(i),X=Ib(i,e),q=Fb(i,e),se=mb(i,e,n,l),me=Ob(i,e),xe=Bb(i,e),Te=Xb(o,i,e),We=Hb(o),Ie=jb(A,R,O,H,te,oe,pe,ie,ne,ce,Se);Qb(e,t,b,v,g,k,Ie,u,p,m),Zb(A,t,w,$,M),ey(R,S,T,C),ly(G,b,me),ty(O,a),sy(H),Wb(te),qb(oe),Vb(pe),Gb(ie),Kb(ne),Jb(ce),Yb(te,pe,ie,ne,ce),ay(E,n),cy(se,n),dy(Se),py(X),uy(q),oy(z,n),my(me),fy(xe),hy(Te),gy(We),vy(I),by(Ie,A,R,O,H,te,oe,pe,ie,ne,ce,Se,me,xe),iy(n),ry(i,e),mu(i),Yy(i,e,G,me),window._lastTxList=i,window._lastBalXrp=b,window._lastHistoryCoverage=f;let Re=x("inspect-report-body");Re&&($y(Re,e,t,b,Ie,A,R,O,H,te,oe,E,z,G,se,i,pe,ie,ne,ce,{feeAnalysis:Se,destTagAnalysis:X,pathDepthAnalysis:q,gatewayBalances:l,inboundFlowAnalysis:me,memoAnalysis:xe,escrowDepthAnalysis:Te,checkAnalysis:We,liveBookAnalysis:I,walletAgeDays:u,walletCreatedTs:p}),mu(i,"inspect-report-activity-chart"),Gy(Ie,window._lastAllFindings||[],u,i.length),window._lastInspectResult={addr:e,riskScore:Ie,walletAgeDays:u,walletAgeVerified:m,historyCoverage:f,txCount:i.length,findings:window._lastAllFindings||[],timestamp:new Date().toISOString()},Ru(),_u(e))}function ub(e,t,n=new Map){let s=new Map,a=[];for(let{tx:p,meta:m}of e){if(p.TransactionType!=="Payment"||p.Account!==t)continue;let f=p.Destination;if(!f)continue;let h=0,b=null,g=p.Amount;typeof g=="string"?h=Number(g)/1e6:g!=null&&g.value&&(b={value:Number(g.value),currency:Xn(g.currency),issuer:g.issuer});let v=Array.isArray(p.Paths)&&p.Paths.length>0,w=p.SendMax!=null,k=v||w,$=v?p.Paths.reduce((C,A)=>Math.max(C,(A||[]).length+1),1):k?2:1,T=ws(p),S={dest:f,amtXrp:h,amtToken:b,ts:T,isPathPay:k,hopCount:$,hash:p.hash||p.Hash||"",ledger:p.ledger_index||p.LedgerIndex||0,destTag:p.DestinationTag};a.push(S),s.has(f)||s.set(f,{addr:f,totalXrp:0,txCount:0,firstSeen:T,lastSeen:T,entity:Hn(f)||null,pathCount:0,maxHops:1,tokens:new Map});let M=s.get(f);if(M.totalXrp+=h,M.txCount++,M.lastSeen=Math.max(M.lastSeen,T),M.firstSeen=Math.min(M.firstSeen,T),k&&(M.pathCount++,M.maxHops=Math.max(M.maxHops,$)),b){let C=`${b.currency}.${U(b.issuer||"")}`;M.tokens.set(C,(M.tokens.get(C)||0)+b.value)}}let o=[...s.values()].sort((p,m)=>m.totalXrp-p.totalXrp||m.txCount-p.txCount).slice(0,10).map(p=>({...p,tokens:[...p.tokens.entries()].map(([m,f])=>({k:m,v:f}))})),i=o.reduce((p,m)=>p+m.totalXrp,0),r=a.filter(p=>p.isPathPay).length,l=o.filter(p=>{let m=n.get(p.addr);return m&&m.sequence<10&&p.totalXrp>10}),c=o.filter(p=>{var m;return((m=p.entity)==null?void 0:m.type)==="exchange"}),d=o.filter(p=>{var m;return((m=p.entity)==null?void 0:m.type)==="blackhole"});return{timeline:[...a].filter(p=>p.amtXrp>.01||p.amtToken).sort((p,m)=>p.ts-m.ts).slice(0,30),destinations:o,totalOut:i,totalPathPay:r,uniqueDests:s.size,exchangeDests:c,blackHoleDests:d,newWalletDests:l}}function mb(e,t,n,s=null){var T,S;let a=null;if(s!=null&&s.obligations){let M=Object.values(s.obligations);M.length===1?a=Number(M[0])||null:M.length>1&&(a=null)}let o=[],i=new Map,r=new Map,l=new Set,c=new Set(n.filter(M=>Number(M.balance)<0).map(M=>Xn(M.currency)));for(let{tx:M,meta:C}of e)if(M.Account===t&&M.TransactionType==="Payment"){((S=(T=C==null?void 0:C.AffectedNodes)==null?void 0:T.some)==null?void 0:S.call(T,O=>{var I,D,F;return((I=O.CreatedNode)==null?void 0:I.LedgerEntryType)==="AccountRoot"&&((F=(D=O.CreatedNode)==null?void 0:D.NewFields)==null?void 0:F.Account)===M.Destination}))&&M.Destination&&l.add(M.Destination);let R=M.Amount;if(typeof R=="object"&&(R!=null&&R.value)&&(R!=null&&R.currency)){let O=Xn(R.currency);if(c.has(O)){let I=Number(R.value),D=M.Destination;i.has(D)||(i.set(D,0),r.set(D,ws(M))),i.set(D,i.get(D)+I)}}}let d=[...i.entries()].sort((M,C)=>C[1]-M[1]),u=[];if(d.length>=3){let M=new Map;for(let[C,A]of d){if(A<=0)continue;let R=Math.pow(10,Math.floor(Math.log10(A))),I=(Math.round(A/R/.1)*.1*R).toPrecision(2);M.has(I)||M.set(I,[]),M.get(I).push({addr:C,amt:A})}for(let[,C]of M.entries())if(C.length>=3){let A=C.reduce((R,O)=>R+O.amt,0)/C.length;u.push({approxAmt:A,accounts:C}),o.push({sev:"warn",label:`${C.length} accounts each received ~${_(A,0)} tokens`,detail:"Highly similar token amounts suggest coordinated wallets, pre-arranged airdrop clusters, or sybil accounts."})}}let p=[...r.values()].sort();if(p.length>=5){let M=p[p.length-1]-p[0];M<3600&&p.length>=10&&o.push({sev:"warn",label:`${p.length} accounts funded within ${Math.ceil(M/60)} minutes`,detail:"Rapid token distribution to many wallets in a narrow time window. Matches pre-sale airdrop or coordinated distribution for wash trading."})}l.size>0&&o.push({sev:l.size>10?"warn":"info",label:`${l.size} account(s) created by this address`,detail:"This issuer funded the activation of these accounts. They may be controlled by the same entity."});let m=n.filter(M=>Number(M.balance)<0),f=a,h=m.reduce((M,C)=>M+Math.abs(Number(C.balance)),0),b=f??h,g=f==null&&m.length>0,v=g?` (based on ${m.length} visible trustlines \u2014 actual total supply may be higher if there are more holders)`:"",w=m.map(M=>({addr:M.account,balance:Math.abs(Number(M.balance)),currency:Xn(M.currency)})).sort((M,C)=>C.balance-M.balance).slice(0,10),k=f??h,$=k>0&&(f!=null||m.length>=50);if(w.length>=2&&$){let M=w[0].balance/k*100,C=f!=null?"":" (of visible sample)";M>50?o.push({sev:"critical",label:`Top holder controls ${M.toFixed(0)}%${C} of supply`,detail:`${U(w[0].addr)} holds ${_(w[0].balance,0)} of ${_(k,0)} total${v}. `+(f!=null?"Extreme dump risk \u2014 one wallet could sell everything.":"Check gateway_balances or a block explorer to confirm the full supply picture.")}):M>25&&o.push({sev:"warn",label:`Top holder controls ${M.toFixed(0)}%${C} of supply`,detail:`Large single-holder concentration${v}. Monitor for coordinated sell events.`});let R=w.slice(0,5).reduce((O,I)=>O+I.balance,0)/k*100;R>75&&o.push({sev:"warn",label:`Top 5 holders own ${R.toFixed(0)}%${C} of supply`,detail:`Supply heavily concentrated in a few wallets${v}. This pattern is common in pre-launch setups or tokens with limited real distribution.`})}else m.length>0&&!$&&o.push({sev:"info",label:`${m.length} trustline holder(s) visible \u2014 supply data limited`,detail:`Only ${m.length} trustlines returned by account_lines. The true holder count and total supply cannot be determined from this data alone. Use a block explorer (XRPScan, Bithomp) for a complete holder distribution.`});return o.length===0&&b===0&&o.push({sev:"info",label:"No token issuance detected",detail:"This account does not appear to be an active token issuer."}),{signals:o,totalIssued:b,holderCount:m.length,topHolders:w,mirrorGroups:u,createdAccts:[...l],distributions:d.slice(0,10),isSampleOnly:g}}var fb=new Set(["rrrrrrrrrrrrrrrrrrrrrhoLvTp","rrrrrrrrrrrrrrrrrrrrBZbvji","rrrrrrrrrrrrrrrrrNAMEtxvNvQ","rHb9CJAWyB4rj91VRWn96DkukG4bwdtyTh","r9cZA1mLK5R5Am25ArfXFmqgNwjZgnfk59"]);function ku(e){return!!e&&fb.has(e)}function $u(e,t,n=[],s=[]){let a=!!(t&Ne.lsfDisableMaster),o=(e==null?void 0:e.RegularKey)||"",i=Array.isArray(n)&&n.length>0,r=ku(o);return!!(a&&r&&!i)}function Su(e,t,n=[]){let s=!!(t&Ne.lsfDefaultRipple),a=!!(t&Ne.lsfRequireAuth),o=!!(t&Ne.lsfGlobalFreeze),i=!!(t&Ne.lsfNoFreeze),r=n.filter(({tx:c})=>c.TransactionType==="TrustSet").length,l=n.filter(({tx:c})=>{var d;return c.TransactionType==="Payment"&&typeof c.Amount=="object"&&((d=c.Amount)==null?void 0:d.currency)}).length;return s||a||o||i||r>=3||l>=5}var Fe={NORMAL:"Normal",REGULAR_KEY:"Regular-Key Controlled",MULTISIG:"Multisig Controlled",BLACKHOLED:"Blackholed",RECOVERABLE:"Recoverable",MISCONFIGURED:"Potentially Misconfigured",UNKNOWN:"Unknown"},zi=4;function hb(e,t,n,s,a={}){let o=!!(t&Ne.lsfDisableMaster),i=!!e.RegularKey,r=n.length>0,l=ku(e.RegularKey),c=s.filter(({tx:h})=>h.TransactionType==="AccountSet"&&h.Account===e.Account&&(h.SetFlag===zi||h.ClearFlag===zi)).map(({tx:h})=>({date:h.date,hash:h.hash,action:h.SetFlag===zi?"disabled":"enabled"})).sort((h,b)=>(h.date??0)-(b.date??0)),d=c.some((h,b)=>h.action==="enabled"&&c.slice(0,b).some(g=>g.action==="disabled")),u=n.filter(h=>(h.SignerEntries||[]).reduce((v,w)=>{var k;return v+Number(((k=w.SignerEntry)==null?void 0:k.SignerWeight)||0)},0)<Number(h.SignerQuorum||1)),p,m,f;return u.length?(p=Fe.MISCONFIGURED,m="blocked \u2014 quorum exceeds total signer weight, unreachable as configured",f=.9):r?(p=Fe.MULTISIG,m="controlled by signer quorum",f=.85):o&&i&&l?(p=Fe.BLACKHOLED,m="none \u2014 regular key points to a provably unusable address",f=.85):o&&!i?(p=Fe.BLACKHOLED,m="none \u2014 no working key exists",f=.75):o&&i&&d?(p=Fe.RECOVERABLE,m="proven historically \u2014 master key has been re-enabled from this state before",f=.7):o&&i?(p=Fe.REGULAR_KEY,m="possible \u2014 whoever holds the regular key can re-enable the master key or act directly",f=.6):o?(p=Fe.UNKNOWN,m="undetermined",f=.3):(p=Fe.NORMAL,m="full \u2014 master key is active",f=.9),a!=null&&a.fetchErrorOccurred&&!(a!=null&&a.newestToOldestComplete)&&(f=Math.min(f,.5)),{state:p,reversibility:m,confidence:f,masterDisabled:o,hasRegularKey:i,hasSignerList:r,masterKeyHistory:c,wasEverReenabled:d,misconfiguredSignerListCount:u.length}}function gb(e,t,n,s,a={}){let o=[],i=100,r=!!(t&Ne.lsfDisableMaster),l=!!e.RegularKey,c=n.length>0,d=$u(e,t,n,s),u=Su(e,t,s),p=hb(e,t,n,s,a);{let f={[Fe.BLACKHOLED]:"info",[Fe.MISCONFIGURED]:"critical",[Fe.REGULAR_KEY]:"info",[Fe.MULTISIG]:"info",[Fe.RECOVERABLE]:"info",[Fe.NORMAL]:"ok",[Fe.UNKNOWN]:"warn"};o.push(st({module:"Security",category:"security",sev:f[p.state]||"info",confidence:p.confidence,headline:`Account Control State: ${p.state}`,detail:`Reversibility: ${p.reversibility}`,observed:[`Master key: ${p.masterDisabled?"disabled":"active"}`,`Regular key: ${p.hasRegularKey?e.RegularKey:"not set"}`,`Signer list: ${p.hasSignerList?`${n.length} list(s)`:"none"}`,p.wasEverReenabled?"Master key has been re-enabled from a disabled state at least once in fetched history":null].filter(Boolean),classification:p.state===Fe.MISCONFIGURED?"Signer quorum cannot be reached with the current signer weights as configured \u2014 this account may be functionally stuck regardless of anyone's intent.":p.state===Fe.REGULAR_KEY?"A disabled master key with an active regular key is not the same as a locked/irreversible account \u2014 the regular key holder retains full control, including the ability to re-enable the master key.":null})),p.state===Fe.BLACKHOLED&&(i-=40),p.state===Fe.MISCONFIGURED&&(i-=30),d&&u&&o.push({sev:"warn",label:"Blackholed issuer caution",detail:"This account appears issuer-like and intentionally blackholed. Sending issued tokens back here may make them unrecoverable or effectively burn them."})}if(l){let f=s.find(({tx:b})=>b.TransactionType==="SetRegularKey"),h=f&&Date.now()/1e3-ws(f.tx)<86400*30;d?o.push({sev:"info",label:"Regular key points to blackhole address",detail:e.RegularKey}):h?(o.push({sev:"warn",label:"Regular key set recently",detail:`Key: ${e.RegularKey} \u2014 changed within 30 days. Verify you intended this.`}),i-=15):o.push({sev:"info",label:"Regular key active",detail:e.RegularKey})}n.forEach(f=>{let h=f.SignerEntries||[],b=f.SignerQuorum||1;o.push({sev:"info",label:`Multisig: ${h.length} signers, quorum ${b}`,detail:h.map(g=>{var v;return U(((v=g.SignerEntry)==null?void 0:v.Account)||"")}).join(", ")})}),t&Ne.lsfGlobalFreeze&&(o.push({sev:"warn",label:"Global Freeze active",detail:"This issuer has frozen all token balances."}),i-=10),t&Ne.lsfDepositAuth&&o.push({sev:"ok",label:"Deposit Authorization enabled",detail:"Only pre-authorized senders can deposit."}),t&Ne.lsfDefaultRipple&&o.push({sev:"info",label:"Default Ripple enabled",detail:"Balances can ripple through this account (issuer behaviour)."});let m=s.filter(({tx:f})=>f.TransactionType==="AccountDelete");return m.length&&(o.push({sev:"warn",label:`${m.length} AccountDelete attempt(s)`,detail:"Account deletion was attempted."}),i-=5),t&Ne.lsfRequireAuth&&o.push({sev:"info",label:"Require Auth enabled",detail:"This account must individually approve each trustline before it can hold a balance \u2014 restricts who can hold what it issues."}),t&Ne.lsfNoFreeze&&o.push({sev:"info",label:"No Freeze enabled",detail:"This account has permanently given up the ability to freeze trustlines \u2014 an irreversible choice, typically made to reassure holders."}),t&Ne.lsfRequireDestTag&&o.push({sev:"info",label:"Require Destination Tag enabled",detail:"Payments to this account must include a destination tag \u2014 common for exchange/custodial deposit accounts."}),t&Ne.lsfDisallowXRP&&o.push({sev:"info",label:"Disallow XRP flag set",detail:"A client-side hint requesting senders avoid sending XRP to this account. Not enforced by the protocol \u2014 XRP can still be sent."}),t&Ne.lsfPasswordSpent&&o.push({sev:"info",label:"Password Spent flag set",detail:"This account has already used its one free SetRegularKey transaction; further regular-key changes will cost the standard transaction fee."}),o.length===0&&o.push({sev:"ok",label:"No security issues detected",detail:"Master key active, no regular key or signer list overrides, no risky flags set."}),{findings:o,score:Math.max(0,i),controlState:p}}function vb(e,t,n,s,a,o){let i=[],r="low",l=!!(t&Ne.lsfDisableMaster),c=$u(e,t,n,s),d=Su(e,t,s);c?(i.push({sev:"info",label:"Intentional blackhole detected",detail:`Master key is disabled and regular key ${e.RegularKey} is a known blackhole address. This is typical for a permanently locked issuer/account, not a classic drain setup.`}),d&&i.push({sev:"warn",label:"Caution: sending assets back may burn them",detail:"Because this account appears to be an intentionally blackholed issuer, sending issued tokens back to it may strand or effectively burn those tokens."})):l&&e.RegularKey&&(i.push({sev:"critical",label:"Classic drain setup detected",detail:`Master key disabled. Regular key ${e.RegularKey} controls the account. If this key was set by an attacker, funds are at risk.`}),r="critical");let u=s.filter(({tx:m})=>m.TransactionType==="SetRegularKey"&&m.Account!==e.Account);if(!c&&u.length&&(i.push({sev:"critical",label:"Regular key set by external account",detail:`${u.length} key change(s) where sender \u2260 account owner. This is unusual.`}),r="critical"),a.length){let m=a.reduce((f,h)=>f+Number(h.Amount||0)/1e6,0);i.push({sev:"warn",label:`${a.length} open payment channel(s) \u2014 ${_(m,2)} XRP locked`,detail:`Destination(s): ${a.map(f=>U(f.Destination)).join(", ")}`}),r==="low"&&(r="medium")}if(o.length){let m=o.reduce((f,h)=>f+Number(h.Amount||0)/1e6,0);i.push({sev:"info",label:`${o.length} open escrow(s) \u2014 ${_(m,2)} XRP escrowed`,detail:`Escrow(s): ${o.map(f=>f.Destination?U(f.Destination):"self-escrow").join(", ")}`})}let p=s.filter(({tx:m})=>m.TransactionType==="DepositPreauth"&&m.Authorize);return p.length>5&&(i.push({sev:"warn",label:`${p.length} DepositPreauth grants issued`,detail:"Account pre-authorized many senders. Review if all are trusted."}),r==="low"&&(r="medium")),i.length===0&&i.push({sev:"ok",label:"No compromise-risk patterns detected",detail:"Auth structure looks intact."}),{signals:i,riskLevel:r}}function bb(e,t,n,s={}){let a=wu(e,t,n),i=xu(a,e,t,s).map(c=>db(c,a,e,t)),r=[],l="none";for(let c of i){let d=c.windowSec===86400?"24h":`${Math.round(c.windowSec/86400)}d`,u=[`${_(c.totalOutflowXrp,2)} XRP moved out (${(c.pctOfBalanceMoved*100).toFixed(0)}% of the ${_(c.balanceAtStart,2)} XRP balance at window start) within ${d}`,c.newRecipientPct!=null?`${(c.newRecipientPct*100).toFixed(0)}% of destinations (${c.newDestCount}/${c.episodeDestCount}) were first-time recipients`:null,c.topDestShare!=null?`${(c.topDestShare*100).toFixed(0)}% of the outflow went to a single destination`:null,c.transferSizeAnomaly?`Transfer sizes in this window are ${(c.episodeMedianXrp/c.historicalMedianXrp).toFixed(1)}x this account's own historical median`:null,c.trustlineLiquidations.length?`${c.trustlineLiquidations.length} token position(s) liquidated shortly before/during this window`:null,c.dexConversionPrecedingWithdrawal?"A token\u2192XRP conversion occurred in the 48h before this outflow began":null,c.triggeredByAuthChange?"A regular-key or signer-list change occurred immediately before this window":null].filter(Boolean),p=[];c.newRecipientPct!=null&&c.newRecipientPct>.7&&p.push("Nearly all destinations are first-time recipients, not established counterparties"),c.triggeredByAuthChange&&p.push("Outflow immediately follows an authorization change \u2014 the classic compromise-then-drain sequence"),c.dexConversionPrecedingWithdrawal&&c.trustlineLiquidations.length&&p.push("Assets were converted to XRP shortly before leaving, consistent with liquidating a position specifically to withdraw everything");let m=c.destinations.some(h=>h.entity),f=c.triggeredByAuthChange||c.pctOfBalanceMoved>=.9?"critical":"warn";f==="critical"?l="critical":l!=="critical"&&(l=l==="none"||l==="low"?"high":l),r.push(st({module:"Asset Drain Behavior",category:"security",sev:f,confidence:c.triggeredByAuthChange?.75:.5,headline:`${_(c.totalOutflowXrp,2)} XRP (${(c.pctOfBalanceMoved*100).toFixed(0)}% of balance) moved out within ${d}`,detail:"Sliding-window balance reconstruction flagged this as an unusually large, fast depletion.",observed:u,alternativeExplanations:["A planned, deliberate transfer by the account's own owner (exchange withdrawal, consolidation, moving to a new wallet)",m?"Destination is a known exchange or labeled entity, consistent with a routine cash-out":"Destination(s) not in the known-entity registry \u2014 inconclusive either way"],evidenceAgainstBenign:p,classification:c.triggeredByAuthChange?"Outflow following an authorization change is a strong compromise-and-drain signal, but ledger data alone cannot distinguish an attacker from an owner who changed their own key and then withdrew funds themselves.":"Large, fast depletion observed. This describes behavior, not intent \u2014 see Account Compromise Risk above for whether the account's access controls show separate signs of being compromised."}))}return r.length||r.push(st({module:"Asset Drain Behavior",category:"security",sev:"ok",headline:"No abnormal depletion detected",detail:"No window scanned showed a large, fast balance drop relative to this account's own history."})),{episodes:i,findings:r,severity:l}}var uu={low:0,medium:1,high:2,critical:3,none:-1};function Tu(e,t,n,s,a,o,i,r,l){let c=vb(e,t,n,s,a,o),d=bb(s,i,r,l),u=d.severity==="none"?"low":d.severity==="high"?"critical":d.severity,p=uu[u]>uu[c.riskLevel]?u:c.riskLevel;return{signals:[...c.signals,...d.findings],riskLevel:p,compromiseRiskLevel:c.riskLevel,assetDrainSeverity:d.severity,episodes:d.episodes}}function yb(e,t,n){let s=[],a=new Map(e.map(m=>[m.NFTokenID,m])),i=t.filter(({tx:m})=>m.TransactionType==="NFTokenCreateOffer"&&m.Account===n).filter(({tx:m})=>{let f=m.Amount;return f?typeof f=="string"?Number(f)<1e6:!1:!0});i.length&&s.push({sev:"critical",label:`${i.length} NFT offer(s) created for \u22641 XRP`,detail:"You created sell offers at near-zero price. This is a common NFT drain vector \u2014 attackers trick victims into listing their NFTs for free."});let r=t.filter(({tx:m})=>m.TransactionType==="NFTokenAcceptOffer"&&m.Account===n);r.length&&s.push({sev:"warn",label:`${r.length} NFT offer(s) accepted`,detail:"Review these transactions to confirm they were intentional sales/purchases."});let l=t.filter(({tx:m})=>m.TransactionType==="NFTokenBurn"&&m.Account===n);l.length&&s.push({sev:"warn",label:`${l.length} NFT(s) burned`,detail:"Burned NFTs cannot be recovered. Confirm these were intentional."});let c=t.filter(({tx:m})=>m.TransactionType==="NFTokenMint"&&m.Account===n),d=t.filter(({tx:m})=>m.TransactionType==="NFTokenCreateOffer"||m.TransactionType==="NFTokenAcceptOffer");c.length>0&&d.length>0&&s.push({sev:"info",label:`${c.length} NFT(s) minted \xB7 ${d.length} transfer event(s)`,detail:"This account has minting activity."});let u=e.filter(m=>m.TransferFee&&m.TransferFee>0);if(u.length){let m=u.reduce((f,h)=>f+h.TransferFee,0)/u.length;s.push({sev:"info",label:`${u.length} NFT(s) carry transfer fees (avg ${(m/1e3).toFixed(1)}%)`,detail:"These NFTs pay royalties on each transfer."})}let p=e.filter(m=>!m.URI);return p.length>2&&s.push({sev:"warn",label:`${p.length} NFT(s) have no URI / metadata`,detail:"NFTs without a URI may be spam or placeholder tokens used in scams."}),s.length===0&&e.length===0?s.push({sev:"ok",label:"No NFT activity detected",detail:"This account holds no NFTs."}):s.length===0&&s.push({sev:"ok",label:`${e.length} NFT(s) held \u2014 no risk signals`,detail:"NFT posture looks normal."}),{flags:s,nftCount:e.length,mintCount:c.length}}var Qa={tfPassive:65536,tfImmediateOrCancel:131072,tfFillOrKill:262144,tfSell:524288};function wb(e,t){var n;for(let s of(e==null?void 0:e.AffectedNodes)||[]){let a=s.CreatedNode;if((a==null?void 0:a.LedgerEntryType)==="Offer"&&((n=a.NewFields)==null?void 0:n.Account)===t)return a}return null}function Cu(e,t,n={}){var r,l,c,d,u,p,m;let s=new Map,a=[],o=n.newestToOldestComplete||n.oldestToNewestFetched?"complete":"possibly-truncated";e.forEach((f,h)=>{var A,R,O,I,D;let{tx:b,meta:g}=f;if(b.TransactionType!=="OfferCreate"||b.Account!==t||(g==null?void 0:g.TransactionResult)!=="tesSUCCESS")return;let v={currency:pu(b.TakerGets),issuer:typeof b.TakerGets=="object"?b.TakerGets.issuer:null,value:vn(b.TakerGets)},w={currency:pu(b.TakerPays),issuer:typeof b.TakerPays=="object"?b.TakerPays.issuer:null,value:vn(b.TakerPays)},k=wb(g,t),$=k?{gets:vn((A=k.NewFields)==null?void 0:A.TakerGets),pays:vn((R=k.NewFields)==null?void 0:R.TakerPays)}:null,T={gets:Math.max(0,(v.value??0)-(($==null?void 0:$.gets)??0)),pays:Math.max(0,(w.value??0)-(($==null?void 0:$.pays)??0))},S=[];for(let F of g.AffectedNodes||[]){let H=F.DeletedNode||F.ModifiedNode;if(!H||H.LedgerEntryType!=="Offer")continue;let E=(O=H.FinalFields)==null?void 0:O.Account;!E||E===t||S.push({account:E,gets:vn((I=H.FinalFields)==null?void 0:I.TakerGets),pays:vn((D=H.FinalFields)==null?void 0:D.TakerPays)})}let M=Number(b.Flags||0),C={offerId:`${t}:${b.Sequence}`,createHash:b.hash,createDate:b.date,createLedgerIndex:(k==null?void 0:k.LedgerIndex)||null,takerGetsOriginal:v,takerPaysOriginal:w,offerSequence:b.Sequence,replacesOfferSeq:b.OfferSequence||null,flags:{passive:!!(M&Qa.tfPassive),immediateOrCancel:!!(M&Qa.tfImmediateOrCancel),fillOrKill:!!(M&Qa.tfFillOrKill),sell:!!(M&Qa.tfSell)},expiration:b.Expiration||null,crossedAtCreation:T,counterpartiesAtCreation:S,restingAmount:$,status:k?"resting":"filled-immediately",consumedEvents:[],cancelHash:null,cancelDate:null,timeRestingSeconds:null,realizedFillPct:null,expiryUncertain:!1,dataCompleteness:o,_createIdx:h};s.set(C.offerId,C),a.push(C)});for(let f of a){if(!f.createLedgerIndex)continue;for(let g=f._createIdx+1;g<e.length;g++){let{tx:v,meta:w}=e[g];if((w==null?void 0:w.TransactionResult)!=="tesSUCCESS"&&(w==null?void 0:w.TransactionResult)!=="tecKILLED"&&!((r=w==null?void 0:w.AffectedNodes)!=null&&r.length))continue;let k=null;for(let $ of(w==null?void 0:w.AffectedNodes)||[]){let T=$.CreatedNode,S=$.ModifiedNode,M=$.DeletedNode,C=T||S||M;if(!(!C||C.LedgerEntryType!=="Offer")&&C.LedgerIndex===f.createLedgerIndex){k={node:C,kind:M?"deleted":S?"modified":"created"};break}}if(k){if(k.kind==="deleted"){let $=v.Account===t&&v.TransactionType==="OfferCancel"&&v.OfferSequence===f.offerSequence,T=v.Account===t&&v.TransactionType==="OfferCreate"&&v.OfferSequence===f.offerSequence;if($||T)f.status="cancelled",f.cancelHash=v.hash,f.cancelDate=v.date;else{let S=Ki(v,w,t);S.xrpDelta!==0||S.tokenDeltas.some(C=>C.delta!==0)?(f.status="consumed-later",f.consumedEvents.push({hash:v.hash,date:v.date,counterpartyAccount:v.Account!==t?v.Account:null})):(f.status="expired",f.expiryUncertain=!0)}f.timeRestingSeconds=(v.date??f.createDate)-f.createDate,f.dataCompleteness=f.dataCompleteness;break}if(k.kind==="modified"){let $=vn((l=k.node.FinalFields)==null?void 0:l.TakerGets),T=vn((c=k.node.FinalFields)==null?void 0:c.TakerPays);f.consumedEvents.push({hash:v.hash,date:v.date,counterpartyAccount:v.Account!==t?v.Account:null,gets:Math.max(0,(((d=f.restingAmount)==null?void 0:d.gets)??0)-($??0)),pays:Math.max(0,(((u=f.restingAmount)==null?void 0:u.pays)??0)-(T??0))}),f.restingAmount={gets:$,pays:T},f.status="partially-filled-then-resting"}}}if(f.status==="resting"||f.status==="partially-filled-then-resting"){let g=Math.floor(Date.now()/1e3)-fu,v=((m=(p=e[e.length-1])==null?void 0:p.tx)==null?void 0:m.date)??g;f.expiration!=null&&f.expiration<=v?(f.status="expired",f.expiryUncertain=!0):f.status="unknown-open",f.timeRestingSeconds=v-f.createDate,f.dataCompleteness}let h=f.consumedEvents.reduce((g,v)=>g+(v.gets||0),0),b=f.crossedAtCreation.gets+h;f.realizedFillPct=f.takerGetsOriginal.value?Math.min(100,b/f.takerGetsOriginal.value*100):null,delete f._createIdx}let i={total:a.length,filledImmediately:a.filter(f=>f.status==="filled-immediately").length,cancelled:a.filter(f=>f.status==="cancelled").length,consumedLater:a.filter(f=>f.status==="consumed-later").length,partiallyFilled:a.filter(f=>f.status==="partially-filled-then-resting").length,expired:a.filter(f=>f.status==="expired").length,unknownOpen:a.filter(f=>f.status==="unknown-open").length};return{byOfferId:s,list:a,stats:i}}function xb(e,t){let n=e.list,s=n.length,a=n.filter(v=>v.status==="filled-immediately").length,o=n.filter(v=>v.status==="resting"||v.status==="partially-filled-then-resting"||v.status==="unknown-open").length,i=n.filter(v=>v.status==="consumed-later").length,r=n.filter(v=>v.status==="cancelled").length,l=n.filter(v=>v.status==="expired").length,c=n.filter(v=>v.status==="unknown-open").length,d=n.map(v=>v.timeRestingSeconds).filter(v=>v!=null),u=d.length?d.reduce((v,w)=>v+w,0)/d.length:null,p=[...d].sort((v,w)=>v-w),m=p.length?p[Math.floor(p.length/2)]:null,f=n.map(v=>v.realizedFillPct).filter(v=>v!=null),h=f.length?f.reduce((v,w)=>v+w,0)/f.length:null,b=new Map;for(let v of n){let w=[v.takerGetsOriginal.currency||"?",v.takerPaysOriginal.currency||"?"].sort().join("\u2194"),k=b.get(w)||{created:0,filled:0,cancelled:0,fillPctSum:0,fillPctCount:0};k.created++,(v.status==="filled-immediately"||v.status==="consumed-later")&&k.filled++,v.status==="cancelled"&&k.cancelled++,v.realizedFillPct!=null&&(k.fillPctSum+=v.realizedFillPct,k.fillPctCount++),b.set(w,k)}for(let v of b.values())v.avgFillPct=v.fillPctCount?v.fillPctSum/v.fillPctCount:null;let g=[];if(s>=10){let v=r/s;h!=null&&h<5&&v>.5?g.push(st({module:"Offer Fill Rate",category:"liquidity",sev:"warn",confidence:.6,headline:`Low realized fill rate: ${h.toFixed(1)}% across ${s} offers`,detail:`${r} of ${s} offers were cancelled, most with minimal execution before cancellation.`,observed:[`${r} cancelled (${(v*100).toFixed(0)}%)`,`${i} consumed by a counterparty after resting`,`${l} expired/removed unfunded`,`${c} still open as of the last analyzed transaction`,`Average time resting before resolution: ${u!=null?u.toFixed(0)+"s":"unknown"}`],alternativeExplanations:["Active order management \u2014 repricing as the market moves","Automated market-making that requeues orders frequently"],evidenceAgainstBenign:h<1?["Realized fill percentage is near zero, not just below average"]:[],classification:"A low fill rate is observed. On its own this does not establish intent \u2014 see the Spoofing and Market-Maker Automation scores for further context."})):g.push(st({module:"Offer Fill Rate",category:"liquidity",sev:"ok",confidence:.7,headline:`${h!=null?h.toFixed(1)+"%":"Normal"} realized fill rate across ${s} offers`,detail:`${a} filled immediately, ${i} consumed after resting, ${r} cancelled, ${l} expired.`}))}else g.push(st({module:"Offer Fill Rate",category:"liquidity",sev:"info",headline:`Only ${s} offer(s) placed \u2014 insufficient sample for fill-rate analysis`,detail:"Need at least 10 OfferCreate transactions for a meaningful fill-rate read."}));return{createdCount:s,immediateFillCount:a,restingCount:o,laterConsumedCount:i,cancelledCount:r,expiredCount:l,unknownOpenCount:c,avgTimeRestingSeconds:u,medianTimeRestingSeconds:m,realizedFillPctOverall:h,byPair:b,findings:g}}function kb(e,t,n){let s=e.list,a=s.map(g=>g.createDate).filter(g=>g!=null).sort((g,v)=>g-v),o=g=>{if(!a.length)return 0;let v=1;for(let w=0;w<a.length;w++){let k=1;for(let $=w+1;$<a.length&&a[$]-a[w]<=g;$++)k++;v=Math.max(v,k)}return v},i={thirtySec:o(30),oneHour:o(3600)},r=s.map(g=>g.takerGetsOriginal.value).filter(g=>g!=null&&g>0),l=null;if(r.length>=Gi){let g=r.reduce((w,k)=>w+k,0)/r.length,v=Math.sqrt(r.reduce((w,k)=>w+(k-g)**2,0)/r.length);l=g>0?v/g:null}let c=[100,1e3,1e4,1e5],d=r.filter(g=>c.some(v=>Math.abs(g%v)<1e-6&&g/v>=1)).length,u=r.length?d/r.length:0,p=new Map;s.forEach(g=>{let v=[g.takerGetsOriginal.currency||"?",g.takerPaysOriginal.currency||"?"].sort().join("\u2194");p.set(v,(p.get(v)||0)+1)});let m=[...p.entries()].sort((g,v)=>v[1]-g[1])[0]||null,f=m&&s.length?m[1]/s.length:0,h=s.length?s.filter(g=>g.status==="cancelled").length/s.length:0,b=s.map(g=>g.timeRestingSeconds).filter(g=>g!=null);return{burstWindows:i,sizeCV:l,roundNumberPct:u,pairConcentration:f,dominantPair:m,cancelRatio:h,restingTimes:b,createdCount:s.length}}function $b(e,t,n,s){let a=[],o=0,i=n.filter(({tx:u})=>u.TransactionType==="Payment"),r=new Set(i.filter(({tx:u})=>u.Account===s&&u.Destination).map(({tx:u})=>u.Destination)),l=new Set(i.filter(({tx:u})=>u.Destination===s&&u.Account).map(({tx:u})=>u.Account)),c=[...r].filter(u=>l.has(u));if(c.length>0&&i.length>=Gi){let u=c.length/r.size;if(u>eb){let p=new Set;for(let f of t.list){for(let h of f.counterpartiesAtCreation)p.add(h.account);for(let h of f.consumedEvents)h.counterpartyAccount&&p.add(h.counterpartyAccount)}let m=c.filter(f=>p.has(f));a.push(st({module:"Wash Execution",category:"market-integrity",sev:"warn",confidence:m.length?.55:.4,headline:`${c.length} round-trip payment counterpart(s) detected`,detail:`${(u*100).toFixed(1)}% of payment recipients also sent back to this account.`,observed:[`${c.length} of ${r.size} outbound recipients also sent payments back`,m.length?`${m.length} of those also traded directly on the DEX with this account`:"No overlap found with DEX trading counterparties"],alternativeExplanations:["Ordinary reciprocal business/personal payments","Exchange deposit/withdrawal cycling through the same account"],evidenceAgainstBenign:m.length?["Payment round-trip AND direct DEX trading with the same counterparty(ies)"]:[],classification:"Round-trip payment pattern observed. Cannot confirm circular multi-account flow (A\u2192B\u2192C\u2192A) from this account's history alone \u2014 that would require the counterparties' own transaction histories."})),o+=m.length?25:15}}let d=i.filter(({tx:u})=>u.Account===s&&u.Destination===s);return d.length>0&&(a.push(st({module:"Wash Execution",category:"market-integrity",sev:"critical",confidence:.85,headline:`${d.length} self-payment(s): sender = receiver`,detail:"Payments where origin and destination are the same address.",observed:[`${d.length} Payment transaction(s) with Account === Destination`],alternativeExplanations:["A no-op transaction used to mark an account active, or to test a memo/path"],evidenceAgainstBenign:d.length>2?["Repeated, not a single isolated instance"]:[],classification:"Confirmed self-payment. Creates recorded volume with zero net economic transfer \u2014 this is a fact about the transaction, not an inference."})),o+=30),a.length||a.push(st({module:"Wash Execution",category:"market-integrity",sev:"ok",headline:"No wash-execution signals",detail:`${t.list.length} offers, ${d.length} self-payments \u2014 patterns look normal.`})),{score:Math.min(100,o),findings:a,stats:{roundTrip:c.length,selfTrades:d.length}}}function Sb(e,t,n,s,a){var u;let o=[],i=0,r=t.list,l=t.byOfferId,c=0,d=0;for(let p of r){if(!p.replacesOfferSeq)continue;let m=l.get(`${s}:${p.replacesOfferSeq}`);if(!m)continue;c++;let f=m.takerPaysOriginal.value&&m.takerGetsOriginal.value?m.takerPaysOriginal.value/m.takerGetsOriginal.value:null,h=p.takerPaysOriginal.value&&p.takerGetsOriginal.value?p.takerPaysOriginal.value/p.takerGetsOriginal.value:null;f&&h&&Math.abs(h-f)/f<.02&&d++}if(c>=5&&d/c>.6&&(o.push(st({module:"Spoofing",category:"market-integrity",sev:"warn",confidence:.45,headline:`${d} of ${c} order replacements kept nearly the same price`,detail:"Cancel-and-immediately-recreate at a near-identical price, repeated \u2014 a quote-management pattern worth a closer look.",observed:[`${c} create-and-replace chains found`,`${d} replaced within 2% of the prior price`],alternativeExplanations:["Routine order refresh/repricing by an active trader or market maker","Bumping sequence to avoid an unrelated conflict"],classification:"Replacement pattern observed. On its own this is common in both legitimate quote maintenance and layering \u2014 see Market-Maker Automation for the explanatory read."})),i+=15),r.length>=10){let p=r.filter(m=>m.takerGetsOriginal.currency==="XRP"&&m.takerGetsOriginal.value!=null);if(p.length>=10){let m=p.map(v=>v.takerGetsOriginal.value).sort((v,w)=>w-v),f=m[Math.floor(m.length*.05)]||0,h=p.filter(v=>v.takerGetsOriginal.value>=f),b=h.filter(v=>v.status==="cancelled"||v.status==="expired"),g=h.length>=5?b.length/h.length:0;g>=.95&&(o.push(st({module:"Spoofing",category:"market-integrity",sev:"warn",confidence:.3,headline:`${(g*100).toFixed(0)}% of this wallet's largest orders were cancelled without meaningful fill (own-history proxy)`,detail:`${b.length} of ${h.length} top-5%-by-this-wallet's-own-size orders cancelled or expired.`,observed:["Sizing is relative to this wallet's own order history, not current book depth",`${b.length}/${h.length} cancelled or expired without fill`],alternativeExplanations:["A large order sized appropriately for a genuinely deep, liquid market","Cancelled for unrelated reasons (funding change, strategy shift)"],classification:"Own-history size proxy only \u2014 true book-depth-relative sizing and price-distance-from-executable checks need historical order-book state this app cannot reliably obtain from public XRPL nodes. Treat as a weaker signal than a book-relative measurement would be."})),i+=10)}}if((u=a==null?void 0:a.signals)!=null&&u.length)for(let p of a.signals)(p.sev==="critical"||p.sev==="warn")&&(o.push(p),i+=p.sev==="critical"?20:10);return o.length||o.push(st({module:"Spoofing",category:"market-integrity",sev:"ok",headline:"No spoofing signals",detail:"No large-order cancel pattern, replacement pattern, or live book wall detected."})),{score:Math.min(100,i),findings:o}}function Tb(e,t,n,s,a){let o=[],i=!1,r=e.cancelRatio>Zv,l=e.sizeCV!=null&&e.sizeCV<.2,c=e.burstWindows.thirtySec>=8||e.burstWindows.oneHour>100,d=(a==null?void 0:a.realizedFillPctOverall)!=null&&a.realizedFillPctOverall>=5;return e.createdCount>=Gi&&r&&(l||c)?(i=!0,o.push(st({module:"Market-Maker Automation",category:"automation",sev:"info",confidence:d?.6:.4,headline:"Behavior consistent with automated market-making / quote maintenance",detail:`${(e.cancelRatio*100).toFixed(0)}% cancel ratio, ${e.sizeCV!=null?"CV "+e.sizeCV.toFixed(2):"no size-uniformity read"}, max ${e.burstWindows.thirtySec} offers/30s.`,observed:[`Cancel ratio: ${(e.cancelRatio*100).toFixed(0)}%`,e.sizeCV!=null?`Order-size coefficient of variation: ${e.sizeCV.toFixed(2)}`:null,`Burst: up to ${e.burstWindows.thirtySec} offers in 30s, ${e.burstWindows.oneHour} in 1h`,d?`Realized fill rate: ${a.realizedFillPctOverall.toFixed(1)}% \u2014 not zero, consistent with a working market-making strategy`:"Realized fill rate is low or unknown"].filter(Boolean),alternativeExplanations:["Spoofing/layering dressed up with uniform sizing to look automated"],evidenceAgainstBenign:d?[]:["Fill rate is low despite the high order volume \u2014 automation alone does not explain that combination"],classification:d?"High cancel/burst/uniformity plus a non-trivial realized fill rate is the expected signature of legitimate automated market-making. This explanation should reduce confidence in Wash Execution and Spoofing findings above, not add to them.":"High cancel/burst/uniformity WITHOUT meaningful fills is less consistent with genuine market-making \u2014 weigh the Spoofing and Wash Execution findings above accordingly."}))):o.push(st({module:"Market-Maker Automation",category:"automation",sev:"ok",headline:"No strong automation signature",detail:"Order behavior does not show the high-cancel/tight-sizing/burst pattern typical of automated market-making."})),{automationLikely:i,findings:o}}function Cb(e,t,n,s,a,o){let i=kb(s,e,t),r=$b(i,s,e,t),l=Sb(i,s,e,t,o),c=Tb(i,s,e,t,a),d=[...r.findings,...l.findings,...c.findings,...(a==null?void 0:a.findings)||[]],u=Math.min(100,r.score+l.score),p=u===0?"clean":u<25?"low-risk":u<50?"suspicious":"high-risk";return{signals:d,score:u,verdict:p,executionScore:r.score,spoofingScore:l.score,automationLikely:c.automationLikely,stats:{creates:s.list.length,cancels:s.list.filter(m=>m.status==="cancelled").length,fills:(a==null?void 0:a.immediateFillCount)??0,payments:e.filter(({tx:m})=>m.TransactionType==="Payment").length,roundTrip:r.stats.roundTrip,selfTrades:r.stats.selfTrades}}}function Pb(e){let t=[];for(let{tx:c}of e){let d=[c.Amount,c.TakerGets,c.TakerPays,c.SendMax,c.DeliverMin];for(let u of d){let p=typeof u=="string"?Number(u)/1e6:u!=null&&u.value?Number(u.value):null;p!=null&&p>0&&Number.isFinite(p)&&t.push(p)}}if(t.length<50)return{signals:[{sev:"info",label:"Insufficient data for Benford's Law",detail:`Need \u226550 monetary amounts, found ${t.length}.`}],chiSq:null,verdict:"insufficient",digitBreakdown:[],sampleSize:t.length};let n=[0,.301,.176,.125,.097,.079,.067,.058,.051,.046],s=new Array(10).fill(0);for(let c of t){let d=c.toFixed(6).replace(/^0+\.?0*/,""),u=parseInt(d[0],10);u>=1&&u<=9&&s[u]++}let a=t.length,o=0,i=[];for(let c=1;c<=9;c++){let d=s[c]/a,u=n[c];o+=a*Math.pow(d-u,2)/u,i.push({digit:c,obs:(d*100).toFixed(1),exp:(u*100).toFixed(1),delta:((d-u)*100).toFixed(1)})}let r=[],l;return o>20.09?(l="high-deviation",r.push({sev:"warn",label:`Benford's Law: significant deviation (\u03C7\xB2=${o.toFixed(1)})`,detail:`First-digit distribution deviates significantly from natural patterns (p<0.01, n=${a}). This is a statistical signature of fabricated or algorithmically generated transaction amounts.`})):o>15.51?(l="moderate-deviation",r.push({sev:"info",label:`Benford's Law: moderate deviation (\u03C7\xB2=${o.toFixed(1)})`,detail:`Some deviation from expected natural distribution (p<0.05, n=${a}). Worth monitoring alongside other signals.`})):(l="normal",r.push({sev:"ok",label:`Benford's Law: normal distribution (\u03C7\xB2=${o.toFixed(1)})`,detail:`First-digit distribution is consistent with organic transaction patterns (n=${a}).`})),{signals:r,chiSq:o,verdict:l,digitBreakdown:i,sampleSize:a}}function Lb(e,t){let s=[],a=[];for(let{tx:b}of e){let g=[b.Amount,b.TakerGets,b.TakerPays];for(let v of g){let w=typeof v=="string"?Number(v)/1e6:v!=null&&v.value?Number(v.value):null;w&&w>0&&Number.isFinite(w)&&a.push(w)}}let o=a.length>=30?(()=>{let b=new Array(12).fill(0);for(let g of a){let v=Math.min(11,Math.max(0,Math.floor(Math.log10(g+1)*2)));b[v]++}return Qs(b)})():null,i={};for(let{tx:b}of e){let g=b.Account===t?b.Destination:b.Account;g&&g!==t&&(i[g]=(i[g]||0)+1)}let r=Object.values(i),l=r.length>=3?Qs(r):null,c=new Array(24).fill(0),d=!1;for(let{tx:b}of e)if(b.date){let v=new Date((b.date+946684800)*1e3).getUTCHours();c[v]++,d=!0}let u=d&&e.length>=30?Qs(c):null,p={};for(let{tx:b}of e)p[b.TransactionType]=(p[b.TransactionType]||0)+1;let m=Qs(Object.values(p)),f="normal",h=0;if(o!==null&&(o<1.5?(f="low-entropy",h+=18,s.push({sev:"warn",label:`Amount entropy critically low (H=${o.toFixed(2)} bits)`,detail:"Transaction amounts are highly repetitive. A bot or scripted actor tends to reuse the same values. Organic wallets show entropy \u22652.4 bits across amount magnitudes."})):o<2.2?(h+=8,s.push({sev:"info",label:`Amount entropy below natural range (H=${o.toFixed(2)} bits)`,detail:"Some amount repetition detected. Could indicate automated activity mixed with organic transactions."})):o>4.5?(h+=10,s.push({sev:"info",label:`Amount entropy abnormally high (H=${o.toFixed(2)} bits)`,detail:"Transaction amounts are maximally varied \u2014 more than organic activity typically shows. This can indicate amounts were artificially randomized to evade Benford detection."})):s.push({sev:"ok",label:`Amount entropy normal (H=${o.toFixed(2)} bits)`,detail:"Transaction amount diversity is consistent with organic financial activity."})),l!==null&&(l<1&&r.length<4?(h+=14,s.push({sev:"warn",label:`Counterparty entropy very low (H=${l.toFixed(2)} bits)`,detail:"This wallet transacts with very few unique addresses and with high repetition \u2014 a structural signature of round-trip wash trading rings."})):l<2?(h+=5,s.push({sev:"info",label:`Counterparty entropy low (H=${l.toFixed(2)} bits)`,detail:"Most interactions are concentrated among a small set of counterparties."})):s.push({sev:"ok",label:`Counterparty diversity healthy (H=${l.toFixed(2)} bits)`,detail:"Counterparty distribution reflects diverse interaction patterns."})),u!==null){let b=Math.log2(24),g=u/b;g<.45?(h+=10,s.push({sev:"warn",label:`Time-of-day entropy low (H=${u.toFixed(2)} bits, ${(g*100).toFixed(0)}% of max)`,detail:"Transactions cluster heavily in a few hours of the day. Bots typically run at fixed UTC hours; organic users spread activity across the day."})):s.push({sev:"ok",label:`Time-of-day distribution natural (H=${u.toFixed(2)} bits)`,detail:"Transaction timing is distributed across hours in a pattern consistent with human activity."})}return s.length||s.push({sev:"info",label:"Insufficient data for entropy analysis",detail:`Need \u226530 transactions. Found ${e.length}.`}),h>=18?f="anomalous":h>=8&&(f="elevated"),{signals:s,verdict:f,riskPenalty:h,amountEntropy:o,counterpartyEntropy:l,timeEntropy:u,typeEntropy:m,uniqueCounterparties:r.length,sampleSize:e.length}}function Qs(e){let t=e.reduce((n,s)=>n+s,0);return t?-e.reduce((n,s)=>{if(!s)return n;let a=s/t;return n+a*Math.log2(a)},0):0}function Mb(e,t){let s=[],a={};for(let{tx:C}of e){let A=C.Account===t?C.Destination:C.Account;A&&A!==t&&(a[A]=(a[A]||0)+1)}let o=Object.values(a).sort((C,A)=>A-C);if(o.length<8)return{signals:[{sev:"info",label:`Insufficient counterparties for Zipf's Law (need \u22658, found ${o.length})`,detail:"Zipf analysis becomes meaningful with a broader counterparty network."}],verdict:"insufficient",zipfExponent:null,riskPenalty:0,freqTable:[],uniqueCounterparties:o.length};let i=o.length,r=0,l=0,c=0,d=0,u=o.map((C,A)=>({rank:A+1,freq:C,lx:Math.log(A+1),ly:Math.log(C)}));for(let{lx:C,ly:A}of u)r+=C,l+=A,c+=C*A,d+=C*C;let p=i*d-r*r,m=p!==0?(i*c-r*l)/p:null,f=m!==null?Math.abs(m):null,h=l/i,b=0,g=0,v=(l-m*r)/i;for(let{lx:C,ly:A}of u)b+=Math.pow(A-h,2),g+=Math.pow(A-(m*C+v),2);let w=b>0?1-g/b:0,k="normal",$=0;f!==null&&(w<.55?($+=12,s.push({sev:"warn",label:`Counterparty distribution doesn't follow Zipf's Law (R\xB2=${w.toFixed(2)})`,detail:`Natural networks follow a power-law rank-frequency relationship. This wallet's counterparty network has poor Zipf fit (R\xB2=${w.toFixed(2)}), suggesting artificial or script-driven interaction structure.`}),k="anomalous"):f<.4?($+=15,s.push({sev:"warn",label:`Zipf exponent too flat (s=${f.toFixed(2)}, expected 0.8\u20131.3)`,detail:"A very flat Zipf exponent means counterparties are used with surprisingly equal frequency. In organic networks, you transact far more often with a few key addresses. Flat distribution is consistent with round-trip wash trading rings."}),k="anomalous"):f>2.2?($+=10,s.push({sev:"warn",label:`Zipf exponent hyper-concentrated (s=${f.toFixed(2)}, expected 0.8\u20131.3)`,detail:"Extreme concentration on one or two counterparties with steep dropoff. While not unusual for simple wallets, combined with other signals this suggests coordinated narrow-ring activity."}),k="elevated"):s.push({sev:"ok",label:`Counterparty network follows Zipf's Law (s=${f.toFixed(2)}, R\xB2=${w.toFixed(2)})`,detail:"The rank-frequency distribution of counterparties follows the expected natural power-law pattern. This is consistent with organic wallet activity."}));let T={};for(let{tx:C}of e){let A=typeof C.Amount=="string"?Math.round(Number(C.Amount)/1e4)*10:null;A&&A>0&&(T[A]=(T[A]||0)+1)}let S=Object.values(T).sort((C,A)=>A-C),M=S.length?S[0]/S.reduce((C,A)=>C+A,0):0;return M>.45&&($+=8,s.push({sev:"warn",label:`Single amount dominates ${(M*100).toFixed(0)}% of transactions`,detail:"One transaction amount value accounts for nearly half of all payments. Round-number dominance is a hallmark of scripted or wash-trading activity."})),s.length||s.push({sev:"info",label:"Zipf analysis: no anomalies detected",detail:"Counterparty distribution consistent with natural activity."}),{signals:s,verdict:k,riskPenalty:$,zipfExponent:f,rSquared:w,freqTable:o.slice(0,12),uniqueCounterparties:o.length}}function Ab(e){let n=[];if(e.length<20)return{signals:[{sev:"info",label:`Insufficient transactions for time series analysis (need \u226520, found ${e.length})`,detail:"Time series analysis requires a longer transaction history."}],verdict:"insufficient",riskPenalty:0,intervalCV:null,autocorrelation:null,burstScore:null,periodicityScore:null};let a=e.filter(({tx:w})=>w.date!=null).map(({tx:w})=>(w.date+946684800)*1e3).sort((w,k)=>w-k);if(a.length<20)return{signals:[{sev:"info",label:"No timestamp data available",detail:"Time series requires date-stamped transactions."}],verdict:"insufficient",riskPenalty:0,intervalCV:null,autocorrelation:null,burstScore:null,periodicityScore:null};let o=[];for(let w=1;w<a.length;w++){let k=(a[w]-a[w-1])/1e3;k>0&&k<86400*30&&o.push(k)}let i=null;if(o.length>=5){let w=o.reduce(($,T)=>$+T,0)/o.length,k=Math.sqrt(o.reduce(($,T)=>$+Math.pow(T-w,2),0)/o.length);i=w>0?k/w:null}let r={};for(let w of a){let k=new Date(w).toISOString().slice(0,10);r[k]=(r[k]||0)+1}let l=Object.values(r),c=0;if(l.length>=4){let w=l.reduce((T,S)=>T+S,0)/l.length,k=Math.sqrt(l.reduce((T,S)=>T+Math.pow(S-w,2),0)/l.length),$=Math.max(...l);c=k>0?($-w)/k:0}let d=null;if(l.length>=6){let w=l.reduce((T,S)=>T+S,0)/l.length,k=l.map(T=>T-w),$=k.reduce((T,S)=>T+S*S,0);$>0&&(d=k.slice(0,-1).reduce((S,M,C)=>S+M*k[C+1],0)/$)}let u=new Array(7).fill(0);for(let w of a)u[new Date(w).getUTCDay()]++;let p=Qs(u),m=Math.log2(7),f=0;if(o.length>=10){let w=[...o].sort((T,S)=>T-S),k=w[Math.floor(w.length/2)];f=o.filter(T=>Math.abs(T-k)/k<.2).length/o.length}let h="normal",b=0;i!==null&&(i<.25?(b+=20,h="bot-pattern",n.push({sev:"warn",label:`Transaction intervals mechanically regular (CV=${i.toFixed(2)})`,detail:"The time gaps between transactions are too regular for human behavior (CV < 0.25). Organic wallets show irregular timing (CV 0.8\u20133.0). This pattern is a strong bot signature."})):i<.5?(b+=8,n.push({sev:"info",label:`Transaction timing somewhat regular (CV=${i.toFixed(2)})`,detail:"Interval regularity is below typical human variance. Could indicate scheduled automation."})):n.push({sev:"ok",label:`Transaction timing is irregular (CV=${i.toFixed(2)})`,detail:"Inter-transaction intervals show natural human-like variance."})),f>.55&&(b+=12,n.push({sev:"warn",label:`Strong periodicity detected (${(f*100).toFixed(0)}% of intervals near median)`,detail:"More than half of transaction intervals cluster around the same duration. This mechanical repetition is consistent with an automated script executing on a fixed schedule."})),c>3.5&&n.push({sev:"info",label:`Activity burst detected (peak day z-score=${c.toFixed(1)})`,detail:"One or more days had extreme transaction volume compared to baseline. Could indicate a coordinated pump event or account recovery sweep."}),d!==null&&d>.6&&(b+=6,n.push({sev:"info",label:`High day-to-day volume autocorrelation (\u03C1=${d.toFixed(2)})`,detail:"Transaction volume is strongly self-correlated \u2014 today's activity predicts tomorrow's. This is consistent with an automated routine that maintains a constant pace."}));let g=p/m;g<.7&&a.length>30&&(b+=6,n.push({sev:"info",label:`Day-of-week distribution concentrated (${(g*100).toFixed(0)}% of max entropy)`,detail:"Transactions cluster heavily on specific days. Automated systems often run every day (maximally flat) or skip weekends \u2014 both deviate from natural human patterns."})),n.length||n.push({sev:"ok",label:"No temporal anomalies detected",detail:"Transaction timing patterns are consistent with organic human activity."}),b>=20?h="bot-pattern":b>=8&&(h="elevated");let v=a.length>=2?Math.round((a[a.length-1]-a[0])/864e5):null;return{signals:n,verdict:h,riskPenalty:b,intervalCV:i,autocorrelation:d,burstScore:c,periodicityScore:f,dowEntropy:p,dowBins:u,dailyVolume:Object.entries(r).slice(-30),activeSpanDays:v,totalTimestamped:a.length}}function Eb(e,t){let s=[];if(e.length<20)return{signals:[{sev:"info",label:`Insufficient data for Granger causality analysis (need \u226520, found ${e.length})`,detail:"Granger causality requires enough temporal observations to test lead-lag relationships."}],verdict:"insufficient",riskPenalty:0,offerCancelCausality:null,inflowOutflowCausality:null};let o=12*3600*1e3,i=D=>D.date?Math.floor((D.date+946684800)*1e3/o):null,r={},l=D=>{r[D]||(r[D]={offerCreate:0,offerCancel:0,inflow:0,outflow:0,nftList:0,nftAccept:0})};for(let{tx:D,meta:F}of e){let H=i(D);if(H===null)continue;l(H);let E=r[H],z=D.TransactionType;z==="OfferCreate"?E.offerCreate++:z==="OfferCancel"&&E.offerCancel++,z==="NFTokenCreateOffer"?E.nftList++:z==="NFTokenAcceptOffer"&&E.nftAccept++;let te=(F==null?void 0:F.delivered_amount)||D.Amount,oe=typeof te=="string"?Number(te)/1e6:0;oe>0&&(D.Destination===t?E.inflow+=oe:D.Account===t&&(E.outflow+=oe))}let c=Object.keys(r).map(Number).sort((D,F)=>D-F);if(c.length<6)return{signals:[{sev:"info",label:"Insufficient temporal windows for Granger test",detail:"Need activity spread across multiple time windows."}],verdict:"insufficient",riskPenalty:0,offerCancelCausality:null,inflowOutflowCausality:null};let d=D=>c.map(F=>r[F][D]||0),u=(D,F,H=4)=>{let E=D.length,z=D.reduce((ce,G)=>ce+G,0)/E,te=F.reduce((ce,G)=>ce+G,0)/E,oe=D.map(ce=>ce-z),pe=F.map(ce=>ce-te),ie=Math.sqrt(oe.reduce((ce,G)=>ce+G*G,0)/E),ne=Math.sqrt(pe.reduce((ce,G)=>ce+G*G,0)/E);return!ie||!ne?Array(H+1).fill(0):Array.from({length:H+1},(ce,G)=>{let Se=0,X=0;for(let q=0;q+G<E;q++)Se+=oe[q]*pe[q+G],X++;return X>0?Se/(X*ie*ne):0})},p="normal",m=0,f=d("offerCreate"),h=d("offerCancel"),b=u(f,h),g=b.indexOf(Math.max(...b)),v=Math.max(...b),w={ccf:b,maxCorr:v,maxLag:g};v>.55&&g<=2?(m+=18,p="causal-signal",s.push({sev:"warn",label:`OfferCreate \u2192 OfferCancel Granger signal (\u03C1=${v.toFixed(2)}, lag=${g} window${g===1?"":"s"})`,detail:`Offer creation strongly predicts subsequent cancellation at lag ${g} (${g*12}h). This causal pattern is the mechanical signature of wash trading: create offers to inflate visible book activity, then cancel them. A leading correlation this strong at such short lag is unlikely in organic market-making.`})):v>.35?(m+=6,s.push({sev:"info",label:`Mild offer-cancel lead relationship (\u03C1=${v.toFixed(2)}, lag=${g})`,detail:"Some temporal link between creating and cancelling offers. Worth monitoring alongside other signals."})):s.push({sev:"ok",label:"No Granger signal between offer creation and cancellation",detail:"Offer creation and cancellation timing appear independent \u2014 no evidence of systematic cancel-to-create cycles."});let k=d("inflow"),$=d("outflow"),T=u(k,$),S=T.indexOf(Math.max(...T)),M=Math.max(...T),C={ccf:T,maxCorr:M,maxLag:S};M>.65&&S===0?(m+=12,s.push({sev:"warn",label:`Inflow and outflow move in perfect lockstep (\u03C1=${M.toFixed(2)} at lag 0)`,detail:"Funds entering and leaving the wallet in the same time window with high correlation at zero lag is consistent with pass-through or round-trip self-trading: money comes in and immediately goes back out."})):M>.55&&S<=1?(m+=8,s.push({sev:"info",label:`Inflow leads outflow (\u03C1=${M.toFixed(2)}, lag=${S})`,detail:"Incoming funds reliably precede outgoing funds at short lag. Could indicate legitimate management, but in conjunction with other signals suggests fund cycling."})):s.push({sev:"ok",label:"No suspicious inflow\u2192outflow Granger pattern",detail:"Inflow and outflow timing are not predictably linked, consistent with independent organic transaction activity."});let A=d("nftList"),R=d("nftAccept"),O=A.reduce((D,F)=>D+F,0),I=R.reduce((D,F)=>D+F,0);if(O>3&&I>3){let D=u(A,R),F=Math.max(...D),H=D.indexOf(F);F>.6&&H<=1&&(m+=8,s.push({sev:"warn",label:`NFT listing causes rapid acceptance (\u03C1=${F.toFixed(2)}, lag=${H})`,detail:"NFT sell offer creation is closely followed by acceptance. Combined with the NFT trap detection module, this timing pattern can indicate coordinated offer traps with a controlled accepting address."}))}return s.some(D=>D.sev==="warn"||D.sev==="critical")||s.length||s.push({sev:"ok",label:"No Granger causality anomalies detected",detail:"Temporal relationships between transaction types show no suspicious lead-lag patterns."}),m>=18?p="causal-signal":m>=8&&(p="elevated"),{signals:s,verdict:p,riskPenalty:m,offerCancelCausality:w,inflowOutflowCausality:C,windowCount:c.length}}function Nb(e,t){let n=new Map;for(let{tx:o}of e){let i=[o.TakerGets,o.Amount];for(let r of i){if(!r||typeof r!="object")continue;let l=r.currency,c=Number(r.value||0),d=o.Account;if(!l||!d||c<=0||!Number.isFinite(c))continue;n.has(l)||n.set(l,{senders:new Set,vol:0,trades:0});let u=n.get(l);u.senders.add(d),u.vol+=c,u.trades++}}let s=[],a=[];for(let[o,i]of n.entries()){if(i.trades<8)continue;let r=i.senders.size;a.push({currency:o,uniqueActors:r,vol:i.vol,trades:i.trades}),r<5?s.push({sev:"critical",label:`${o}: ${r} wallet(s) driving all volume`,detail:`${i.trades} trades totalling ${i.vol.toFixed(2)} ${o} from only ${r} address(es). Fewer than 5 unique actors generating most volume is a wash trading red flag.`}):r<10&&s.push({sev:"warn",label:`${o}: low actor diversity (${r} wallets, ${i.trades} trades)`,detail:`Volume concentrated among only ${r} addresses. Organic markets typically have broader participation.`})}return a.length?s.length||s.push({sev:"ok",label:"Volume concentration normal",detail:`${a.length} token(s) analysed \u2014 all have \u226510 unique trading participants.`}):s.push({sev:"info",label:"No IOU/token volume data",detail:"No token-denominated transactions found in history (XRP-only activity)."}),{signals:s,concentrations:a}}function Rb(e,t,n,s){let a=[],o=!!(n&Ne.lsfDefaultRipple)||t.some(p=>p.account===e.Account),i=t.filter(p=>Number(p.balance)<0),r=i.reduce((p,m)=>p+Math.abs(Number(m.balance)),0);i.length>0&&a.push({sev:"info",label:`Token issuer: ${i.length} outstanding currency lines`,detail:`Total outstanding: ${_(r,2)} across ${i.length} holder(s).`});let l=t.filter(p=>p.freeze),c=t.filter(p=>p.freeze_peer);l.length&&a.push({sev:"warn",label:`${l.length} trustline(s) frozen by this account`,detail:"This account has frozen specific trustlines."}),c.length&&a.push({sev:"critical",label:`${c.length} of your trustline(s) frozen by issuer`,detail:`Frozen currencies: ${c.map(p=>p.currency).join(", ")}. You cannot transfer these tokens.`}),n&Ne.lsfGlobalFreeze&&a.push({sev:"critical",label:"Global Freeze \u2014 all token transfers suspended",detail:"No holders can transfer tokens issued by this account."}),n&Ne.lsfNoFreeze&&a.push({sev:"ok",label:"NoFreeze flag set \u2014 issuer cannot freeze balances",detail:"Token holders are protected against future freeze actions."});let d=Number(e.Balance||0)/1e6,u=10+Number(e.OwnerCount||0)*2;return i.length>0&&d<u+1&&a.push({sev:"warn",label:"Issuer balance near reserve \u2014 possible black hole",detail:"Issuer with outstanding tokens has almost no XRP above reserve. Tokens may be stranded."}),a.length===0&&a.push({sev:"ok",label:"No token issuer flags",detail:"This account does not appear to be a token issuer."}),{signals:a,isIssuer:o,obligationCount:i.length}}function _b(e,t,n,s=new Map,a=null){var f,h,b;let o=[],i=[],r=e.filter(g=>g.currency&&Number(g.balance)!==0&&bu(g.currency)),l=t.filter(({tx:g})=>g.TransactionType==="AMMDeposit"),c=t.filter(({tx:g})=>g.TransactionType==="AMMWithdraw"),d=t.filter(({tx:g})=>g.TransactionType==="AMMCreate"),u=t.filter(({tx:g})=>g.TransactionType==="AMMVote"),p=t.filter(({tx:g})=>g.TransactionType==="AMMBid");if(r.forEach(g=>{let v=Number(g.balance),w=Number(g.limit);i.push({currency:g.currency,issuer:g.account,balance:v,limit:w})}),a)for(let g of i){let v=[...l,...c].filter(({tx:T,meta:S})=>{var M,C;return(C=(M=S==null?void 0:S.AffectedNodes)==null?void 0:M.some)==null?void 0:C.call(M,A=>{var R;return((R=A.CreatedNode||A.ModifiedNode||A.DeletedNode)==null?void 0:R.LedgerEntryType)==="RippleState"&&[A.CreatedNode,A.ModifiedNode,A.DeletedNode].some(O=>{var I,D,F,H;return((D=(I=O==null?void 0:O.FinalFields)==null?void 0:I.Balance)==null?void 0:D.currency)===g.currency||((H=(F=O==null?void 0:O.NewFields)==null?void 0:F.Balance)==null?void 0:H.currency)===g.currency})})}),w=0,k=[],$=[];for(let{tx:T,meta:S}of v){let M=Ki(T,S,a),C=M.lpDeltas.find(R=>R.currency===g.currency);if(!C)continue;let A={hash:T.hash,date:T.date,lpTokenDelta:C.delta,xrpDelta:M.xrpDelta,tokenDeltas:M.tokenDeltas};T.TransactionType==="AMMDeposit"?(k.push(A),w+=-M.xrpDelta):($.push(A),w-=-M.xrpDelta)}(k.length||$.length)&&(g.depositEvents=k,g.withdrawEvents=$,g.costBasisXrp=w>0?w:null)}if(i.length){o.push({sev:"info",label:`${i.length} LP token position(s)`,detail:`Active liquidity provider in ${i.length} AMM pool(s).`});for(let g of i){let v=s.get(g.currency);if(v){if(g.tvl=v.amount?Number(v.amount)/1e6:null,g.tvl2=(f=v.amount2)!=null&&f.value?Number(v.amount2.value):null,g.feeRate=v.trading_fee!=null?v.trading_fee/1e3:null,g.lpSupply=(h=v.lp_token)!=null&&h.value?Number(v.lp_token.value):null,g.lpSupply&&g.balance){let w=Math.abs(g.balance)/g.lpSupply*100;g.ownerPct=w,w>50&&o.push({sev:"warn",label:`Dominant AMM position: ${w.toFixed(0)}% of pool`,detail:`This account controls ${w.toFixed(0)}% of the LP token supply for pool ${U(g.currency)}. Withdrawing all at once would severely impact pool liquidity and anyone currently trading in it.`})}g.tvl!=null&&o.push({sev:"info",label:`Pool TVL: ${_(g.tvl,2)} XRP${g.tvl2?` + ${_(g.tvl2,2)} tokens`:""} \xB7 Fee: ${((b=g.feeRate)==null?void 0:b.toFixed(2))??"?"}%`,detail:`Actual pool context from amm_info. Your LP position represents ${g.ownerPct!=null?g.ownerPct.toFixed(1)+"% of the pool.":"an unknown share of the pool."}`})}}}return d.length&&o.push({sev:"info",label:`Created ${d.length} AMM pool(s)`,detail:"This account bootstrapped one or more liquidity pools."}),(l.length||c.length)&&o.push({sev:"info",label:`${l.length} deposit(s) \xB7 ${c.length} withdrawal(s)`,detail:"LP activity history."}),u.length&&o.push({sev:"info",label:`${u.length} AMM fee vote(s)`,detail:"This account has voted on AMM trading fee parameters."}),p.length&&o.push({sev:"info",label:`${p.length} continuous auction bid(s)`,detail:"Bid for the AMM auction slot (reduced fee trading window)."}),i.filter(g=>Math.abs(g.balance)>1e3).length&&o.push({sev:"warn",label:"Large LP positions \u2014 impermanent loss risk",detail:"Significant liquidity positions carry exposure to price divergence between pool assets."}),o.length===0&&o.push({sev:"ok",label:"No AMM positions",detail:"This account is not a liquidity provider."}),{signals:o,positions:i,deposits:l.length,withdrawals:c.length}}function Db(e){let t=[],s=e.filter(({tx:p})=>p.Fee&&Number(p.Fee)>0);if(s.length<10)return{signals:[],verdict:"insufficient",riskPenalty:0,avgFeeMultiplier:null,spikeCount:0,topFeeHashes:[]};let a=s.map(({tx:p})=>Number(p.Fee)/12),o=a.reduce((p,m)=>p+m,0)/a.length,r=s.filter(({tx:p})=>Number(p.Fee)/12>100).length,l=r/s.length,c=0,d="normal",u=[...s].sort((p,m)=>Number(m.tx.Fee)-Number(p.tx.Fee)).slice(0,5).map(({tx:p})=>({hash:p.hash,mult:(Number(p.Fee)/12).toFixed(0),fee:Number(p.Fee)}));return l>.15&&r>=5?(c=10,d="elevated",t.push({sev:"warn",label:`Fee spike pattern: ${r} txs paid >100x base fee (${(l*100).toFixed(0)}% of history)`,detail:`Average fee multiplier: ${o.toFixed(0)}x. In XRPL, bots often pay elevated fees to guarantee same-ledger execution as a counterparty \u2014 a technique used in coordinated wash trading and sandwich attacks. Organic users rarely pay more than 2\u20135x the base fee. Top hashes: ${u.slice(0,3).map(p=>U(p.hash)).join(", ")}.`,hashes:u.map(p=>p.hash)})):o>20?(c=4,t.push({sev:"info",label:`Elevated average fee (${o.toFixed(0)}x base fee)`,detail:"This wallet consistently pays above-average fees. Could indicate priority execution requirements or automated trading."})):t.push({sev:"ok",label:`Fee levels normal (avg ${o.toFixed(1)}x base fee)`,detail:"Transaction fees are within typical organic ranges."}),{signals:t,verdict:d,riskPenalty:c,avgFeeMultiplier:+o.toFixed(2),spikeCount:r,topFeeHashes:u}}function Ib(e,t){let n=[],s=new Map;for(let{tx:r}of e){if(r.TransactionType!=="Payment"||r.Account!==t)continue;let l=r.Destination,c=r.DestinationTag;l&&(s.has(l)||s.set(l,new Set),c!=null&&s.get(l).add(c))}let a=[...s.entries()].filter(([r])=>{let l=Hn(r);return(l==null?void 0:l.type)==="exchange"}),o=0,i=[];for(let[r,l]of s.entries()){let c=Hn(r),d=(c==null?void 0:c.name)||U(r),u=l.size,p=e.filter(({tx:m})=>m.Account===t&&m.Destination===r).length;i.push({dest:r,name:d,uniqueTags:u,txCount:p,tags:[...l].slice(0,10)}),u===1&&p>=5&&(c==null?void 0:c.type)==="exchange"?n.push({sev:"info",label:`${d}: ${p} payments all using tag ${[...l][0]}`,detail:`Single destination tag used across all ${p} payments to ${d}. This is the normal pattern for one person funding their own exchange account.`}):u>10&&(c==null?void 0:c.type)==="exchange"?(o=Math.max(o,8),n.push({sev:"warn",label:`${d}: ${u} different destination tags used`,detail:`${p} payments to ${d} used ${u} different tags \u2014 each tag typically identifies a different customer account. Funding many exchange sub-accounts can indicate either a service (legitimate) or coordinated deposit layering where funds are spread across many exchange wallets to avoid detection.`})):u===0&&p>=2&&(c==null?void 0:c.type)==="exchange"&&n.push({sev:"warn",label:`${d}: ${p} payments with no destination tag`,detail:"Payments to exchange addresses without a destination tag may not be credited. Most exchanges require a tag to identify which customer account receives the funds."})}return n.length===0&&s.size>0?n.push({sev:"ok",label:"Destination tag patterns normal",detail:"Payment routing tags are consistent with regular outbound payments."}):s.size===0&&n.push({sev:"info",label:"No outbound payments to analyse for destination tags",detail:"No outbound Payment transactions found in history."}),{signals:n,riskPenalty:o,tagProfiles:i}}function Fb(e,t){var c,d;let n=[],s=e.filter(({tx:u})=>u.TransactionType==="Payment"&&u.Account===t&&(Array.isArray(u.Paths)&&u.Paths.length>0||u.SendMax!=null));if(s.length===0)return{signals:[],riskPenalty:0,roundTripCount:0,deepHopCount:0,selfRoutedCount:0,noData:!0};let a=s.length<5?` (small sample: ${s.length} path payments found \u2014 patterns may not be statistically significant)`:"",o=s.filter(({tx:u})=>{let p=typeof u.Amount=="string",m=typeof u.SendMax=="string";return p&&m}),i=s.filter(({tx:u})=>Array.isArray(u.Paths)?u.Paths.some(p=>Array.isArray(p)&&p.length>=3):!1),r=s.filter(({tx:u})=>u.Destination===t),l=0;return o.length>=1&&(l+=12,n.push({sev:"warn",label:`${o.length} XRP\u2192IOU\u2192XRP round-trip path payments`,detail:`Sending XRP and receiving XRP via intermediate token pairs means the payment routes through the DEX and creates trading volume without changing economic position. ${o.length} occurrences suggests this is deliberate. This is the classic cross-currency wash-trading arb pattern on XRPL. Example hash: ${(d=(c=o[0])==null?void 0:c.tx)!=null&&d.hash?U(o[0].tx.hash):"N/A"}.`,hashes:o.slice(0,5).map(({tx:u})=>u.hash).filter(Boolean)})),i.length>=1&&(l+=6,n.push({sev:"info",label:`${i.length} path payments with \u22653 intermediate hops`,detail:"Deep routing chains (3+ hops) can indicate: legitimate arbitrage, liquidity optimization, or deliberate obfuscation of fund origin. Check each transaction for the intermediate issuers in the path."})),r.length>0&&(l+=15,n.push({sev:"critical",label:`${r.length} path payment(s) where sender = destination`,detail:`Money sent to your own address via a multi-hop path creates DEX trading volume with no net change in balance. This is a direct wash-trading technique: the path through the order book generates artificial volume on every intermediate pair. Hashes: ${r.slice(0,3).map(({tx:u})=>U(u.hash||"")).join(", ")}.`,hashes:r.slice(0,5).map(({tx:u})=>u.hash).filter(Boolean)})),n.length===0&&n.push({sev:"ok",label:`${s.length} path payment(s) \u2014 no suspicious routing patterns${a}`,detail:"No circular routing (XRP\u2192IOU\u2192XRP), self-routing, or unusual deep hop chains detected."}),{signals:n,riskPenalty:l,roundTripCount:o.length,deepHopCount:i.length,selfRoutedCount:r.length}}function Ob(e,t){var u;let n=new Map,s=[];for(let{tx:p,meta:m}of e){if(p.TransactionType!=="Payment"||p.Destination!==t)continue;let f=p.Account;if(!f||f===t)continue;let h=0,b=null,g=(m==null?void 0:m.delivered_amount)||p.Amount;typeof g=="string"?h=Number(g)/1e6:g!=null&&g.value&&(b={value:Number(g.value),currency:Xn(g.currency),issuer:g.issuer});let v=ws(p);s.push({src:f,amtXrp:h,amtToken:b,ts:v,hash:p.hash||"",destTag:p.DestinationTag}),n.has(f)||n.set(f,{addr:f,totalXrp:0,txCount:0,firstSeen:v,lastSeen:v,entity:Hn(f)||null});let w=n.get(f);w.totalXrp+=h,w.txCount++,w.lastSeen=Math.max(w.lastSeen,v),w.firstSeen=Math.min(w.firstSeen,v)}let a=[...n.values()].sort((p,m)=>m.totalXrp-p.totalXrp||m.txCount-p.txCount).slice(0,10),o=a.reduce((p,m)=>p+m.totalXrp,0),i=a.filter(p=>{var m;return((m=p.entity)==null?void 0:m.type)==="exchange"}),r={};for(let p of s){if(p.amtXrp<=0)continue;let m=Math.round(p.amtXrp/10)*10;r[m]=(r[m]||0)+1}let l=Object.entries(r).sort((p,m)=>m[1]-p[1])[0],c=l&&l[1]>=5&&l[1]/s.length>.4,d=[];if(i.length){let p=[...new Set(i.map(m=>m.entity.name))].join(", ");d.push({sev:"info",label:`Funding from ${i.length} known exchange(s): ${p}`,detail:`${_(i.reduce((m,f)=>m+f.totalXrp,0),2)} XRP received from exchange withdrawals \u2014 typical for a personal trading wallet.`})}if(c&&d.push({sev:"warn",label:`Structured inbound pattern: ${l[1]} payments near ~${l[0]} XRP`,detail:`Over 40% of inbound payments cluster around the same amount (~${l[0]} XRP). Structured deposits can indicate layering \u2014 deliberately splitting large amounts into smaller equal transfers to avoid detection.`}),n.size===1&&s.length>=5){let p=a[0];d.push({sev:"info",label:`Single funding source: all ${s.length} inbound payments from one address`,detail:`${((u=p.entity)==null?void 0:u.name)||U(p.addr)} is the sole funding source. This is normal for a personal wallet but notable for a wallet claiming broad community usage.`})}return!d.length&&s.length>0&&d.push({sev:"ok",label:`${s.length} inbound payment(s) from ${n.size} source(s)`,detail:`Total received: ${_(o,2)} XRP. No unusual inbound patterns.`}),s.length===0&&d.push({sev:"info",label:"No inbound payments found in analysed history",detail:"Wallet may be funded via DEX activity or in ledgers outside the analysed range."}),{signals:d,topSources:a,totalIn:o,uniqueSources:n.size,timeline:s.slice(-20).reverse(),exchangeSrcs:i,structuredFlag:!!c}}function Bb(e,t){var l,c;let n=[],s=[],a=[/airdrop/i,/claim.*reward/i,/free.*xrp/i,/verify.*wallet/i,/support.*team/i,/urgent/i,/suspended/i,/confirm.*seed/i,/your.*account.*hold/i,/unlock/i];for(let{tx:d}of e)if((l=d.Memos)!=null&&l.length)for(let u of d.Memos){let p=((c=u.Memo)==null?void 0:c.MemoData)||"";if(!p)continue;let m="";try{m=decodeURIComponent(p.replace(/../g,f=>"%"+f))}catch{m=p}if(!m||m===p)try{let f="";for(let h=0;h<p.length;h+=2){let b=parseInt(p.slice(h,h+2),16);b>=32&&b<127&&(f+=String.fromCharCode(b))}f.length>4&&(m=f)}catch{}s.push({tx:d.hash||"",type:d.TransactionType,sender:d.Account,text:m.slice(0,200),raw:p})}if(s.length===0)return{signals:[],allMemos:[],scamMemos:[],repeatedMemos:[]};let o=s.filter(d=>a.some(u=>u.test(d.text)));o.length&&n.push({sev:"critical",label:`${o.length} memo(s) match known scam patterns`,detail:`Memos containing phrases like "airdrop", "claim reward", "verify wallet", or "urgent" are used in social engineering attacks. These payments were likely sent to trick the recipient into taking action. Examples: ${o.slice(0,2).map(d=>'"'+d.text.slice(0,40)+'"').join(", ")}`});let i={};for(let d of s){let u=d.text.slice(0,50).trim().toLowerCase();u.length>3&&(i[u]=(i[u]||0)+1)}let r=Object.entries(i).filter(([,d])=>d>=3).sort((d,u)=>u[1]-d[1]);return r.length&&n.push({sev:"warn",label:`${r.length} memo text(s) repeated \u22653 times`,detail:`Identical memo text across multiple transactions suggests scripted or automated activity. Most repeated: "${r[0][0]}" (${r[0][1]}\xD7)`}),n.length||n.push({sev:"ok",label:`${s.length} memo(s) found \u2014 no suspicious patterns`,detail:"Memo content looks normal."}),{signals:n,allMemos:s,scamMemos:o,repeatedMemos:r.slice(0,5)}}function Xb(e,t,n){let s=e.filter(u=>u.LedgerEntryType==="Escrow");if(!s.length)return{signals:[],escrows:[],hasThirdParty:!1};let a=[],o=Math.floor(Date.now()/1e3),i=946684800,r=s.map(u=>{let p=u.Account||null,m=u.Destination||null,f=Number(u.Amount||0)/1e6,h=u.FinishAfter?u.FinishAfter+i:null,b=u.CancelAfter?u.CancelAfter+i:null,g=p&&p!==n&&m===n,v=p===n&&m===n,w=h?Math.ceil((h-o)/86400):null;return{creator:p,dest:m,amtXrp:f,finishAfter:h,cancelAfter:b,isThirdParty:g,isSelfEscrow:v,daysToFinish:w,conditional:!!u.Condition}}),l=r.filter(u=>u.isThirdParty),c=r.reduce((u,p)=>u+p.amtXrp,0);l.length&&a.push({sev:"warn",label:`${l.length} escrow(s) created by external account(s) \u2014 funds locked to this address`,detail:`${_(l.reduce((u,p)=>u+p.amtXrp,0),2)} XRP in escrows that an outside party controls. The creator sets the conditions. Escrows created by attackers just before a drain attempt have been observed in some compromise patterns \u2014 verify who created these.`});let d=r.filter(u=>u.daysToFinish!=null&&u.daysToFinish>=0&&u.daysToFinish<=7);return d.length&&a.push({sev:"info",label:`${d.length} escrow(s) mature within 7 days`,detail:`${_(d.reduce((u,p)=>u+p.amtXrp,0),2)} XRP will become claimable soon. If these are third-party escrows, the creator can claim funds once the condition is met.`}),a.length||a.push({sev:"ok",label:`${s.length} self-escrow(s) \u2014 ${_(c,2)} XRP locked`,detail:"All escrows appear to be self-controlled time-locks. No third-party escrow risk."}),{signals:a,escrows:r,hasThirdParty:l.length>0,totalLocked:c}}function Hb(e){let t=e.filter(l=>l.LedgerEntryType==="Check");if(!t.length)return{signals:[],checks:[]};let n=[],s=946684800,a=Math.floor(Date.now()/1e3),o=t.map(l=>{let c=typeof l.SendMax=="string"?Number(l.SendMax)/1e6:null,d=typeof l.SendMax=="object"?l.SendMax:null,u=l.Expiration?l.Expiration+s:null,p=(l.ledger_index,null),m=u&&u<a;return{sender:l.Account,dest:l.Destination,amtXrp:c,amtToken:d,expiry:u,expired:m,id:l.index||""}}),i=o.filter(l=>l.amtXrp&&l.amtXrp>100),r=o.filter(l=>l.expired);return i.length&&n.push({sev:"info",label:`${i.length} large uncashed check(s) \u2014 ${_(i.reduce((l,c)=>l+(c.amtXrp||0),0),2)} XRP pending`,detail:"Open checks can be cashed by the recipient at any time before expiry. Large uncashed checks represent a future outflow commitment."}),r.length&&n.push({sev:"info",label:`${r.length} expired check(s) \u2014 should be cancelled to reclaim reserve`,detail:"Expired checks still occupy owner reserve slots (2 XRP each). Cancelling them returns the reserved XRP."}),n.length||n.push({sev:"ok",label:`${t.length} check(s) found \u2014 no unusual patterns`,detail:"Check amounts are within normal range."}),{signals:n,checks:o}}function zb(e,t){var m,f,h;if(!e||!((m=e.offers)!=null&&m.length))return{signals:[],hasData:!1};let{pair:n,offers:s}=e,a=[],o=new Map;for(let b of s){let g=b.Account,v=typeof b.TakerGets=="string"?Number(b.TakerGets)/1e6:Number(((f=b.TakerGets)==null?void 0:f.value)||0);o.set(g,(o.get(g)||0)+v)}let i=[...o.values()].reduce((b,g)=>b+g,0),r=o.get(t)||0,l=i>0?r/i:0,d=[...s].sort((b,g)=>{var k,$;let v=typeof b.TakerGets=="string"?Number(b.TakerGets)/1e6:Number(((k=b.TakerGets)==null?void 0:k.value)||0);return(typeof g.TakerGets=="string"?Number(g.TakerGets)/1e6:Number((($=g.TakerGets)==null?void 0:$.value)||0))-v})[0],u=typeof(d==null?void 0:d.TakerGets)=="string"?Number(d.TakerGets)/1e6:Number(((h=d==null?void 0:d.TakerGets)==null?void 0:h.value)||0),p=i>0?u/i:0;return p>.4&&(d==null?void 0:d.Account)===t?a.push({sev:"critical",label:`Active wall order: this wallet controls ${(p*100).toFixed(0)}% of current book depth`,detail:`A single order from this address represents ${(p*100).toFixed(0)}% of the visible order book depth on pair ${n}. Large orders placed to make a market look deeper than it is \u2014 without intent to fill \u2014 is spoofing. This order is live right now.`}):p>.4&&a.push({sev:"warn",label:`Wall order present: ${(p*100).toFixed(0)}% of book depth in one order`,detail:`A single address controls ${(p*100).toFixed(0)}% of the current order book for pair ${n}. Wall orders dominate book depth and can be removed instantly \u2014 they create false liquidity signals.`}),l>.25&&a.push({sev:"info",label:`This wallet controls ${(l*100).toFixed(0)}% of current order book depth`,detail:`${_(r,2)} of ${_(i,2)} total book volume on pair ${n}.`}),a.length||a.push({sev:"ok",label:`Live order book looks normal (${s.length} orders, pair: ${n.split("\u2194").map(b=>b.split("+")[0]).join("\u2194")})`,detail:"No wall orders or unusual depth concentration detected in the current order book."}),{signals:a,hasData:!0,pair:n,offerCount:s.length,ourShare:l,wallShare:p}}function Ub(e,t,n,s,a,o,i,r,l,c,d,u,p,m){var h,b;return[{label:"Security",pts:Math.round((100-t.score)*.4),max:40,color:"#ff5555",icon:"\u{1F510}"},{label:"Drain Risk",pts:{low:0,medium:10,high:25,critical:35}[n.riskLevel]||0,max:35,color:"#ff5555",icon:"\u26A0\uFE0F"},{label:"Wash Trading",pts:Math.min(15,Math.round((a.score||0)*.15)),max:15,color:"#ffb86c",icon:"\u{1F4CA}"},{label:"NFT Risk",pts:Math.min(15,s.flags.filter(g=>g.sev==="critical").length*8+s.flags.filter(g=>g.sev==="warn").length*3),max:15,color:"#bd93f9",icon:"\u{1F3A8}"},{label:"Benford's",pts:(o==null?void 0:o.chiSq)>20.09?10:(o==null?void 0:o.chiSq)>15.51?5:0,max:10,color:"#f1fa8c",icon:"\u{1F4D0}"},{label:"Forensic Suite",pts:Math.min(20,Math.min(8,Math.round(((r==null?void 0:r.riskPenalty)||0)*.35))+Math.min(8,Math.round(((l==null?void 0:l.riskPenalty)||0)*.4))+Math.min(8,Math.round(((c==null?void 0:c.riskPenalty)||0)*.35))+Math.min(8,Math.round(((d==null?void 0:d.riskPenalty)||0)*.35))),max:20,color:"#00d4ff",icon:"\u{1F9EC}"},{label:"Vol Conc",pts:Math.min(10,(((h=i==null?void 0:i.signals)==null?void 0:h.filter(g=>g.sev==="critical").length)||0)*6+(((b=i==null?void 0:i.signals)==null?void 0:b.filter(g=>g.sev==="warn").length)||0)*3),max:10,color:"#ffb86c",icon:"\u{1FAE7}"},{label:"Fee Spikes",pts:Math.min(5,(u==null?void 0:u.riskPenalty)||0),max:5,color:"#ffb86c",icon:"\u{1F4B8}"}].filter(g=>g.pts>0)}function jb(e,t,n,s,a,o,i,r,l,c,d=null){let u=0;u+=Math.round((100-e.score)*.4),u+={low:0,medium:10,high:25,critical:35}[t.riskLevel]||0;let m=n.flags.filter(h=>h.sev==="critical").length,f=n.flags.filter(h=>h.sev==="warn").length;if(u+=Math.min(15,m*8+f*3),u+=Math.min(15,Math.round(s.score*.15)),(a==null?void 0:a.chiSq)!=null&&(a.chiSq>20.09?u+=10:a.chiSq>15.51&&(u+=5)),o!=null&&o.signals){let h=o.signals.filter(g=>g.sev==="critical").length,b=o.signals.filter(g=>g.sev==="warn").length;u+=Math.min(10,h*6+b*3)}return i!=null&&i.riskPenalty&&(u+=Math.min(8,Math.round(i.riskPenalty*.35))),r!=null&&r.riskPenalty&&(u+=Math.min(8,Math.round(r.riskPenalty*.4))),l!=null&&l.riskPenalty&&(u+=Math.min(8,Math.round(l.riskPenalty*.35))),c!=null&&c.riskPenalty&&(u+=Math.min(8,Math.round(c.riskPenalty*.35))),d!=null&&d.riskPenalty&&(u+=Math.min(5,d.riskPenalty)),Math.min(100,u)}function Wb(e){var b;let t=document.getElementById("inspect-benfords-body");if(!t)return;let n={critical:"sev-critical",warn:"sev-warn",info:"sev-info",ok:"sev-ok"},s=e.signals.map(g=>`
    ...
    <div class="benford-grid">
      ...
      ${e.digitBreakdown.map(g=>{let v=parseFloat(g.obs),w=parseFloat(g.exp),k=v-w,$=Math.abs(k)>5?"#ff5555":Math.abs(k)>2.5?"#ffb86c":"#50fa7b",T=`<div style="height:6px;border-radius:3px;background:rgba(255,255,255,.08);overflow:hidden">
          <div style="height:100%;width:${Math.min(100,v*3.3).toFixed(0)}%;background:${$};border-radius:3px"></div>
        </div>`;return`<div class="mono" style="text-align:center">${g.digit}</div>
                <div class="mono" style="color:${$}">${g.obs}%</div>
                <div class="mono" style="opacity:.6">${g.exp}%</div>
                <div>${T}</div>`}).join("")}
  ...
  `;t.innerHTML=s+o+a+h}function qb(e){var o;let t=document.getElementById("inspect-volconc-body");if(!t)return;let n={critical:"sev-critical",warn:"sev-warn",info:"sev-info",ok:"sev-ok"},s=e.signals.map(i=>`
    ...
    </div>`).join("");s.innerHTML=o+(n||"")}function Vb(e){let t=[["Sample size",e.sampleSize],["Amount entropy",e.amountEntropy!=null?e.amountEntropy.toFixed(2)+" bits":"\u2014",e.amountEntropy!=null&&e.amountEntropy<2?"risk-text-high":""],["Counterparty entropy",e.counterpartyEntropy!=null?e.counterpartyEntropy.toFixed(2)+" bits":"\u2014"],["Time-of-day entropy",e.timeEntropy!=null?e.timeEntropy.toFixed(2)+" bits":"\u2014"],["Unique counterparties",e.uniqueCounterparties],["Verdict",e.verdict,e.verdict==="anomalous"?"risk-text-high":e.verdict==="elevated"?"risk-text-med":""]];to("inspect-entropy-body",e,'<div class="wash-stat-row" style="margin-top:10px"><span>Metric</span><span class="mono" style="opacity:.45">Value</span></div>'+t.map(([n,s,a])=>`<div class="wash-stat-row"><span>${n}</span><span class="mono ${a||""}">${s}</span></div>`).join(""))}function Gb(e){var s;let t=[["Unique counterparties",e.uniqueCounterparties],["Zipf exponent (s)",e.zipfExponent!=null?e.zipfExponent.toFixed(3):"\u2014",e.zipfExponent!=null&&(e.zipfExponent<.4||e.zipfExponent>2.2)?"risk-text-high":""],["Fit quality (R\xB2)",e.rSquared!=null?e.rSquared.toFixed(3):"\u2014",e.rSquared!=null&&e.rSquared<.55?"risk-text-high":""],["Natural range","s \u2248 0.8\u20131.3, R\xB2 > 0.55"],["Verdict",e.verdict,e.verdict==="anomalous"?"risk-text-high":e.verdict==="elevated"?"risk-text-med":""]],n=((s=e.freqTable)==null?void 0:s.slice(0,10).map((a,o)=>{let i=e.freqTable[0]||1,r=(a/i*100).toFixed(0),l=e.freqTable[0]?(e.freqTable[0]/Math.pow(o+1,e.zipfExponent||1)).toFixed(1):0;return`<div class="wash-stat-row">
    ...
    ${g}`}function Qb(e,t,n,s,a,o,i,r=null,l=null,c=!1){let d=x("inspect-addr-badge");d&&(d.textContent=e.length>20?e.slice(0,10)+"\u2026"+e.slice(-8):e,d.title=e,d.dataset.fullAddr=e);let u=x("inspect-risk-score");u&&(u.textContent=i,u.className="irb-score-val "+Wi(i));let p=x("inspect-risk-label");p&&(p.textContent=i<20?"Low Risk":i<45?"Moderate":i<70?"High Risk":"Critical",p.className="irb-score-label "+Wi(i));let m=x("inspect-acct-grid");if(!m)return;let f=Math.max(0,n-s),h=Number(t.Flags||0),b=r!=null?r===0?"Created today":r===1?"1 day old":r<30?`${r} days old`:r<365?`${Math.floor(r/30)} months old`:`${(r/365).toFixed(1)} years old`:"\u2014",g=l?new Date(l).toLocaleDateString("en-US",{year:"numeric",month:"short",day:"numeric"}):null,v=g?c?`Created ${g}`:`Created ${g} (estimated \u2014 full history not confirmed)`:null,w=yn(n),k=yn(f),$=[{label:"XRP Balance",value:`${_(n,6)} XRP${w}`,mono:!0},{label:"Spendable",value:`${_(f,6)} XRP${k}`,mono:!0,note:`${s} XRP reserved`},{label:"Wallet Age",value:b,note:v,highlight:r!=null&&r<7?"new":null},{label:"Owner Count",value:a,note:`${a*2} XRP tied up`},{label:"Sequence",value:o,mono:!0},{label:"Regular Key",value:t.RegularKey?U(t.RegularKey):"None",warn:!!t.RegularKey,mono:!0},{label:"Master Key",value:h&Ne.lsfDisableMaster?"Disabled":"Active",warn:!!(h&Ne.lsfDisableMaster)}];m.innerHTML=$.map(T=>`
    ...
    <div class="audit-note">
      ...
      ${a.slice(0,8).map(d=>`<span class="mono">${U(d.Authorize||"")}</span>`).join(", ")}
      ${a.length>8?`+${a.length-8} more`:""}
    </div>`:""}
  `,no("badge-security",e.findings)}function ey(e,t,n,s){let a=x("inspect-drain-body");if(!a)return;let o={low:"#50fa7b",medium:"#ffb86c",high:"#ff8c42",critical:"#ff5555",none:"#50fa7b"},i={low:"\u2713",medium:"\u26A0",high:"\u26A0",critical:"\u26D4",none:"\u2713"},r=e.compromiseRiskLevel??e.riskLevel,l=e.assetDrainSeverity??"none";a.innerHTML=`
    ...
    <div class="drain-sub-section">
      ...
      ${t.map(c=>`
        <div class="drain-channel-row">
          <span class="mono">${U(c.Destination)}</span>
    ...
    <div class="drain-sub-section">
      ...
      ${n.slice(0,5).map(c=>`
        <div class="drain-channel-row">
          <span>${c.Destination?U(c.Destination):"self"}</span>
          <span>${_(Number(c.Amount||0)/1e6,2)} XRP</span>
          <span class="mono">${c.Condition?"conditional":c.FinishAfter?"time-locked":""}</span>
        </div>`).join("")}
    </div>`:""}
  `,Ly("badge-drain",e.riskLevel)}function ty(e,t){let n=x("inspect-nft-body");n&&(n.innerHTML=`
    <div class="audit-items">
      ${e.flags.map(s=>zn(s)).join("")}
    </div>
    ${t.length?`
    <div class="nft-grid">
      ${t.slice(0,12).map(s=>ny(s)).join("")}
    </div>
    ${t.length>12?`<div class="nft-more">+${t.length-12} more NFTs</div>`:""}
    `:""}
  `,no("badge-nft",e.flags))}function ny(e){let t=Number(e.Flags||0),n=!!(t&cu.lsfTransferable),s=!!(t&cu.lsfBurnable),a=e.NFTokenTaxon||0,o=e.TransferFee?`${(e.TransferFee/1e3).toFixed(1)}%`:"0%";return`
    <div class="nft-card">
    ...
    </div>`}function sy(e){let t=x("inspect-wash-body");if(!t)return;let n=e.verdict==="clean"||e.verdict==="low-risk"?"#50fa7b":e.verdict==="suspicious"?"#ffb86c":"#ff5555";t.innerHTML=`
  ...
  `;let s=x("badge-wash");if(s){let a=e.verdict==="clean"||e.verdict==="low-risk"?"ok":e.verdict==="suspicious"?"warn":"crit";s.textContent=e.verdict.replace("-"," "),s.className="section-badge section-badge--"+a}}function Js(e,t){return`<div class="wash-stat"><span class="wash-stat-label">${y(e)}</span><span class="wash-stat-val">${t}</span></div>`}function ay(e,t){let n=x("inspect-issuer-body");if(!n)return;let s=t.filter(a=>a.currency&&(a.currency.length===3||a.currency.length===40));n.innerHTML=`
    <div class="audit-items">
      ${e.signals.map(a=>zn(a)).join("")}
    </div>
    ${s.length?`
  ...
  `,no("badge-issuer",e.signals)}function oy(e,t){let n=x("inspect-amm-body");n&&(n.innerHTML=`
    <div class="audit-items">
  ...
  `,no("badge-amm",e.signals))}function iy(e){let t=x("trust-count-badge");t&&(t.textContent=e.length);let n=x("inspect-trust-body");n&&(n.innerHTML=e.length?e.map(s=>{let a=s.freeze?'<span class="trustline-frozen">Frozen</span>':"",o=s.freeze_peer?'<span class="trustline-frozen trustline-frozen--peer">Issuer Frozen</span>':"",i=s.no_ripple?'<span class="trustline-norip">NoRipple</span>':"";return`
          <div class="trustline-row">
          ...
          </div>`}).join(""):'<div class="inspect-empty-note">No transactions found.</div>',e.length>s&&(n.innerHTML+=`<div class="tx-more">Showing ${s} of ${e.length} transactions</div>`)}function Pu(e,t,n){let s=Number((n==null?void 0:n.totalIn)||0),a=Number((t==null?void 0:t.totalOut)||0),o=Number(e||0);if(s<=0&&a<=0)return'<div class="inspect-empty-note">No inbound or outbound XRP flow found in the analysed transaction history.</div>';let i=new Set(((t==null?void 0:t.blackHoleDests)||[]).map(k=>k.addr)),r=new Set(((t==null?void 0:t.exchangeDests)||[]).map(k=>k.addr)),l=new Set(((t==null?void 0:t.newWalletDests)||[]).map(k=>k.addr)),c=0,d=0,u=0,p=0;for(let k of(t==null?void 0:t.destinations)||[])i.has(k.addr)?c+=k.totalXrp:r.has(k.addr)?d+=k.totalXrp:l.has(k.addr)?u+=k.totalXrp:p+=k.totalXrp;let m=Math.max(s,a,o,1),f=k=>(k>0?Math.max(1.5,k/m*100):0).toFixed(1),h=[{label:"Black hole",xrp:c,color:bn.blackhole},{label:"Exchange",xrp:d,color:bn.exchange},{label:"New wallet",xrp:u,color:bn.newWallet},{label:"Other",xrp:p,color:bn.other}].filter(k=>k.xrp>0),b=a>0?Math.max(1.5,a/m*100):0,g=h.map(k=>`<div style="width:${(a>0?k.xrp/a*100:0).toFixed(1)}%;background:${k.color};height:100%" title="${y(k.label)}: ${_(k.xrp,2)} XRP"></div>`).join(""),v=(k,$,T,S,M)=>`
    ...
    </div>`,w=h.map(k=>`<span style="font-size:.66rem;color:${k.color};margin-right:12px">\u25CF ${y(k.label)} ${_(k.xrp,0)}</span>`).join("");return`
          ...
          <div class="flow-dest-row">
            ...
            <div class="flow-dest-info">
              <div class="flow-dest-top">
                <button class="addr-link mono cut flow-dest-addr" data-addr="${y(c.addr)}" title="${y(c.addr)}">${y(U(c.addr))}</button>
              ...
              <div class="flow-dest-meta">
                ...
                ${c.txCount>1?`<span class="flow-dest-span">${Lu(c.firstSeen,c.lastSeen)}</span>`:""}
              </div>
            </div>
          </div>`}).join("")}
    </div>
    ...
    <div class="flow-timeline">
      ${e.timeline.map(c=>{let d=new Date(c.ts*1e3).toLocaleDateString(),u=new Date(c.ts*1e3).toLocaleTimeString([],{hour:"2-digit",minute:"2-digit"}),p=c.amtXrp>0?`${_(c.amtXrp,2)} XRP`:c.amtToken?`${_(c.amtToken.value,2)} ${c.amtToken.currency}`:"\u2014",m=Hn(c.dest),f=m?`<span class="flow-entity-badge flow-entity--${m.type}" style="font-size:.65rem">${y(m.name)}</span>`:"";return`
          <div class="flow-tx-row">
            ...
            <button class="addr-link mono cut flow-tx-dest" data-addr="${y(c.dest)}" title="${y(c.dest)}">${y(U(c.dest))}</button>
            ${f}
            <span class="flow-tx-amt mono">${p}</span>
            ${c.isPathPay?`<span class="flow-path-tag">${c.hopCount}-hop</span>`:""}
          </div>`}).join("")}
    </div>
  `,a){let c=e.blackHoleDests.length||e.exchangeDests.length>2;a.textContent=`${e.uniqueDests} dests`,a.className=`section-badge section-badge--${c?"crit":e.uniqueDests>0?"warn":"ok"}`}}function Lu(e,t){if(!e||!t)return"";let n=new Date(e*1e3).toLocaleDateString(),s=new Date(t*1e3).toLocaleDateString();return n===s?n:`${n} \u2013 ${s}`}function cy(e,t){let n=x("inspect-issuer-connections-body");if(!n)return;let s=e.totalIssued,a=x("badge-issuer-connections");if(n.innerHTML=`
    <div class="audit-items">
    ...
    <div class="conn-holders">
      ${e.topHolders.map((o,i)=>{let r=s>0?o.balance/s*100:0,l=r>50?"#ff5555":r>25?"#ffb86c":r>10?"#f1fa8c":"#50fa7b";return`
          <div class="conn-holder-row">
            ...
            <button class="addr-link mono cut conn-holder-addr" data-addr="${y(o.addr)}" title="${y(o.addr)}">${y(U(o.addr))}</button>
    ...
    <div class="conn-created-list">
      ${e.createdAccts.slice(0,12).map(o=>`
        <button class="addr-chip mono" data-addr="${y(o)}" title="${y(o)}">${y(U(o))}</button>
      `).join("")}
        ...
        <div class="conn-mirror-group">
          ...
          <div class="conn-mirror-addrs">
            ${o.accounts.slice(0,8).map(i=>`
              <button class="addr-chip mono" data-addr="${y(i.addr)}" title="${y(i.addr)}">${y(U(i.addr))}</button>
            `).join("")}
  ...
  `,a){let o=e.signals.some(i=>i.sev==="critical")?"crit":e.signals.some(i=>i.sev==="warn")?"warn":e.signals.some(i=>i.sev==="info")?"neutral":"ok";a.className=`section-badge section-badge--${o}`,a.textContent=s>0?`${e.holderCount} holders`:"No issuance"}}function dy(e){var d;let t=document.getElementById("inspect-fee-analysis-body");if(!t||!e)return;let n={critical:"sev-critical",warn:"sev-warn",info:"sev-info",ok:"sev-ok"},s=(e.signals||[]).map(u=>`
    ...
    ${e.topFeeHashes.map(u=>`
      <div class="wash-stat-row">
        <a href="https://livenet.xrpl.org/transactions/${y(u.hash)}" target="_blank" rel="noopener"
           class="mono" style="font-size:.75rem;color:var(--accent);text-decoration:none">${U(u.hash)}</a>
    ...
    </div>`;t.innerHTML=l+s+a+o;let c=document.getElementById("badge-fee-analysis");c&&(c.textContent=r?"Elevated":"Normal",c.className=`section-badge section-badge--${r?"warn":"ok"}`)}function py(e){var d,u;let t=document.getElementById("inspect-desttag-body");if(!t||!e)return;let n={critical:"sev-critical",warn:"sev-warn",info:"sev-info",ok:"sev-ok"},s=(e.signals||[]).map(p=>`
    ...
    ${e.selfRoutedCount?`<div class="wash-stat-row"><span>Self-routed payments</span><span class="mono risk-text-high">${e.selfRoutedCount}</span></div>`:""}`;if(n.innerHTML=o+i,s){let l=e.signals.some(d=>d.sev==="critical"),c=e.signals.some(d=>d.sev==="warn");s.textContent=l?"Critical":c?"Check":"Normal",s.className=`section-badge section-badge--${l?"crit":c?"warn":"ok"}`}}function my(e){var r,l,c;let t=x("inspect-inbound-body");if(!t)return;let n={critical:"sev-critical",warn:"sev-warn",info:"sev-info",ok:"sev-ok"},s=(e.signals||[]).map(d=>`
    ...
    <div class="flow-dest-list">
      ${e.topSources.map((d,u)=>{let p=e.totalIn>0?(d.totalXrp/e.totalIn*100).toFixed(0):0,m=d.entity,f=m?`<span class="flow-entity-badge flow-entity--${m.type}">${y(m.name)}</span>`:"";return`<div class="flow-dest-row">
          ...
          <div class="flow-dest-info">
            <div class="flow-dest-top">
              <a href="https://xrpscan.com/account/${y(d.addr)}" target="_blank" rel="noopener" class="addr-link mono cut">${y(U(d.addr))}</a>
              ${f}
            </div>
            <div class="flow-bar-row">
    ...
    ${e.wallShare>.3?`<div class="wash-stat-row"><span>Largest single order share</span><span class="mono ${e.wallShare>.4?"risk-text-high":"risk-text-med"}">${(e.wallShare*100).toFixed(1)}%</span></div>`:""}`;n.innerHTML=a+o;let i=x("badge-livebook");if(i){let r=(e.signals||[]).some(c=>c.sev==="critical"),l=(e.signals||[]).some(c=>c.sev==="warn");i.textContent=r?"Wall order":l?"Check":"Normal",i.className=`section-badge section-badge--${r?"crit":l?"warn":"ok"}`}}function by(e,...t){let n=x("inspect-risk-breakdown");if(!n)return;let s=Ub(e,...t);if(!s.length){n.innerHTML="";return}let a=Math.max(1,s.reduce((o,i)=>o+i.pts,0));n.innerHTML=`
    ...
    <div class="report-wrap">
      ...
      <div class="report-section">
        ...
        <div class="report-narrative">
          ${Dt.map(N=>`<p style="margin-bottom:12px;line-height:1.7">${N}</p>`).join("")}
        </div>
      </div>
      ...
      <div class="report-section">
        ...
        <div style="margin-bottom:16px">${Jy(f,e)}</div>
        ${Pu(n,p,M)}
      </div>
      ...
      <div class="report-section">
        ...
        <div class="report-stats-grid">${Ie}</div>
      </div>
      ...
      <div class="report-section">
        ...
        <div class="report-findings">${We}</div>
      </div>`:`
      <div class="report-section">
  ...
  `}function $y(e,...t){e.innerHTML=ky(...t)}function Sy(){let e=document.getElementById("tab-inspector");e&&(e.querySelector("[data-inspector-v2]")||(e.innerHTML=`
    <style>
  ...
  `))}function Ty(){if(document.getElementById("inspector-nav"))return;let e=document.createElement("nav");e.id="inspector-nav",e.setAttribute("aria-label","Inspector navigation"),e.innerHTML=`
  ...
  `;let t=document.getElementById("tab-inspector");t&&t.appendChild(e)}function Cy(){if(document.getElementById("inspector-howto"))return;let e=document.createElement("div");e.id="inspector-howto",e.className="howto-overlay",e.style.display="none",e.innerHTML=`
  ...
  `).join(""))}function Iy(){let e=document.getElementById("isd-cap-grid");e&&(e.innerHTML=Ry.map(t=>`
  ...
  `).join(""))}function Yi(){let e=document.getElementById("isd-wallets-section"),t=document.getElementById("isd-wallet-list");if(!e||!t)return;let n=ve(Q(Ey))||[];if(!n.length){e.style.display="none";return}e.style.display="",t.innerHTML=n.map(s=>{let a=s.color||"#50fa7b",o=s.emoji||"\u{1F48E}",i=s.label||"Wallet",r=s.address||"",l=r?r.slice(0,8)+"\u2026"+r.slice(-6):"\u2014",c=s.testnet?'<span class="isd-wallet-testnet">TESTNET</span>':"";return`
    ...
    `}).join("")}function Qi(){let e=document.getElementById("isd-recent-section"),t=document.getElementById("isd-recent-list");if(!e||!t)return;let n=so();if(!n.length){e.style.display="none";return}e.style.display="",t.innerHTML=n.map((s,a)=>{let o=s.addr?s.addr.slice(0,10)+"\u2026"+s.addr.slice(-8):"\u2014",i=s.riskScore!=null?`<span class="isd-risk-pill isd-risk-pill--${Nu(s.riskScore)}">${s.riskScore}</span>`:"";return`
...
`),a=new Blob([s],{type:"text/csv;charset=utf-8;"}),o=URL.createObjectURL(a),i=document.createElement("a"),r=((c=(l=document.getElementById("inspect-addr-badge"))==null?void 0:l.dataset)==null?void 0:c.fullAddr)||"wallet";i.href=o,i.download=`naluxrp_${r.slice(0,10)}_${new Date().toISOString().slice(0,10)}.csv`,document.body.appendChild(i),i.click(),document.body.removeChild(i),URL.revokeObjectURL(o)};function Xy(e,t){let s=so().find(o=>o.addr===e);if(!s||s.riskScore==null||t==null)return null;let a=t-s.riskScore;return{prev:s.riskScore,curr:t,diff:a,ts:s.ts}}function Hy(e,t){let n=Xy(e,t);if(!n||Math.abs(n.diff)<2)return;let s=document.getElementById("inspect-risk-score");if(!s)return;let a=n.diff>0?`<span style="color:#ff5555;font-size:.7rem;font-weight:700"> \u2191${n.diff}</span>`:`<span style="color:#50fa7b;font-size:.7rem;font-weight:700"> \u2193${Math.abs(n.diff)}</span>`,o=ao(n.ts);s.insertAdjacentHTML("afterend",`<span class="risk-score-diff" title="Changed from ${n.prev} \u2192 ${n.curr} since ${o}">${a} vs ${o}</span>`)}window._inspectMaxTx||(window._inspectMaxTx=5e3);window._debugBalanceDeltas=yu;window._debugOfferLifecycles=Cu;window._debugReconstructBalanceHistory=wu;window._debugFindDrainEpisodes=xu;window._debugDrainRisk=Tu;window.inspectorLoadAddr=function(e){let t=x("inspect-addr");t&&(t.value=e),ys()};window.inspectWalletAddr=function(e){var n,s;window.inspectorLoadAddr(e);let t=document.querySelector('[data-tab="inspector"]');t&&((n=window.switchTab)==null||n.call(window,t,"inspector")),(s=window.showDashboard)==null||s.call(window)};window.printInspectorReport=function(){var s,a;let e=document.getElementById("inspect-report-body");if(!e)return;let t=((a=(s=document.getElementById("inspect-addr-badge"))==null?void 0:s.dataset)==null?void 0:a.fullAddr)||"wallet",n=window.open("","_blank","width=900,height=700");n.document.write(`<!DOCTYPE html><html><head>
    ...
    ${e.innerHTML}
  </body></html>`),n.document.close()};window.exportInspectorReport=function(){var n;let e=document.getElementById("inspect-report-body");if(!e)return;let t=e.innerText||e.textContent||"";(n=navigator.clipboard)==null||n.writeText(t).then(()=>{let s=document.getElementById("report-export-btn");s&&(s.textContent="\u2713 Copied!",setTimeout(()=>{s.textContent="\u{1F4CB} Copy Report"},2e3))}).catch(()=>{let s=document.createRange();s.selectNodeContents(e);let a=window.getSelection();a.removeAllRanges(),a.addRange(s)})};window.inspectorClearHistory=function(){vt(Ji);let e=document.getElementById("isd-recent-section");e&&(e.style.display="none")};window.inspectorClearWatchlist=function(){vt(Zs),ta()};function so(){return ve(Q(Ji))||[]}function zy(e,t,n=[]){let s=so();s=s.filter(o=>o.addr!==e);let a=n.filter(o=>o.sev==="critical"||o.sev==="warn").map(o=>o.module+":"+o.headline.slice(0,40)).sort().join("|");s.unshift({addr:e,riskScore:t,ts:Date.now(),fingerprint:a}),s=s.slice(0,12),Z(Ji,JSON.stringify(s))}function ea(){return ve(Q(Zs))||[]}function Uy(e,t){let n=ea().filter(s=>s.addr!==e);n.unshift({addr:e,label:t||U(e),addedTs:Date.now(),lastScore:null,lastTs:null}),Z(Zs,JSON.stringify(n.slice(0,50)))}function Eu(e){Z(Zs,JSON.stringify(ea().filter(t=>t.addr!==e)))}function Vi(e){return ea().some(t=>t.addr===e)}function jy(e,t){let n=ea().map(s=>s.addr===e?{...s,lastScore:t,lastTs:Date.now()}:s);Z(Zs,JSON.stringify(n))}function ao(e){let t=Date.now()-e;return t<6e4?"just now":t<36e5?Math.floor(t/6e4)+"m ago":t<864e5?Math.floor(t/36e5)+"h ago":Math.floor(t/864e5)+"d ago"}function Nu(e){return Wi(e).replace("risk-","")}var Qt=!1;function Ru(){Qt=localStorage.getItem(Au)==="true",Zi()}function Zi(){let e=document.getElementById("inspect-result");if(!e)return;e.classList.toggle("mode-advanced",Qt),e.classList.toggle("mode-simple",!Qt);let t=document.getElementById("analyst-mode-btn");t&&(t.textContent=Qt?"\u2697 Advanced":"\u{1F441} Simple",t.title=Qt?"Switch to Simple view":"Switch to Advanced (analyst) view",t.setAttribute("aria-pressed",String(Qt)))}window.toggleAnalystMode=function(){Qt=!Qt,localStorage.setItem(Au,Qt),Zi()};var Wy=new Set(["section-overview","section-report"]),qy=new Set(["section-security","section-drain","section-fundflow","section-inbound"]);function Vy(){let e=document.getElementById("inspect-result");if(!e)return;let t=[...e.querySelectorAll(".inspector-section")],n={crit:0,warn:1,neutral:2,ok:3,"":4},s=t.filter(i=>!Wy.has(i.id)&&!qy.has(i.id));s.sort((i,r)=>{let l=c=>{let d=c.querySelector(".section-badge");if(!d)return"";let u=d.className;return u.includes("crit")?"crit":u.includes("warn")?"warn":u.includes("neutral")?"neutral":u.includes("ok")?"ok":""};return(n[l(i)]??4)-(n[l(r)]??4)});let a=document.getElementById("section-inbound")||document.getElementById("section-drain");if(!a)return;let o=a;for(let i of s)o.after(i),o=i}function Gy(e,t,n,s){let a=document.getElementById("quick-verdict-body");if(!a)return;let o=t.filter(u=>u.sev==="critical"),i=t.filter(u=>u.sev==="warn"),r=e<20?"#50fa7b":e<45?"#ffb86c":e<70?"#ff8c42":"#ff5555",l=e<20?"Low Risk":e<45?"Moderate":e<70?"High Risk":"Critical",c="",d="";if(o.length===0&&i.length===0)c=`No elevated signals found across ${s.toLocaleString()} transactions${n!=null?` and ${n} days of history`:""}.`,d="This wallet appears to operate within normal parameters.";else{let u=o.slice(0,2).map(m=>m.headline).join("; "),p=i.slice(0,2).map(m=>m.headline).join("; ");c=o.length?`${o.length} critical issue${o.length>1?"s":""}: ${u}.`:`${i.length} warning${i.length>1?"s":""}: ${p}.`,d=o.length?"Review the highlighted sections below. Scroll to the Report for full recommendations.":"Review the flagged sections below for context before drawing conclusions."}a.innerHTML=`
    ...
    </div>`}function ta(){let e=document.getElementById("isd-watchlist-section"),t=document.getElementById("isd-watchlist-list");if(!e||!t)return;let n=ea();if(!n.length){e.style.display="none";return}e.style.display="",t.innerHTML=n.map(s=>{let a=s.addr.slice(0,8)+"\u2026"+s.addr.slice(-6),o=s.lastScore!=null?`<span class="isd-risk-pill isd-risk-pill--${Nu(s.lastScore)}">${s.lastScore}</span>`:"",i=s.lastTs?ao(s.lastTs):"never checked";return`
    ...
    <div style="overflow-x:auto;padding-bottom:4px">
      <svg width="${p}" height="${u}" xmlns="http://www.w3.org/2000/svg" style="display:block;min-width:${p}px">
        ${r.map(([,f],h)=>{var k;let b=Math.max(2,Math.round(f.count/l*u)),g=u-b,v=((k=Object.entries(f.types).sort(($,T)=>T[1]-$[1])[0])==null?void 0:k[0])||"Other",w=a[v]||o;return`<rect x="${h*(c+d)}" y="${g}" width="${c}" height="${b}"
            fill="${w}" opacity=".8" rx="1">
            <title>${r[h][0]}: ${f.count} tx (${v})</title></rect>`}).join("")}
      </svg>
    </div>
    <div style="display:flex;gap:8px;flex-wrap:wrap;margin-top:5px">
      ${Object.entries(a).slice(0,8).map(([f,h])=>`<span style="font-size:.62rem;color:${h};opacity:.7">\u25CF ${f}</span>`).join("")}
    </div>`}function Du(e,t){let n=new Map;for(let{tx:s,meta:a}of e){let o=s.Account===t,i=s.Destination===t;if(!o&&!i)continue;let r=o?s.Destination:s.Account;if(!r||r===t)continue;let l=ws(s);n.has(r)||n.set(r,{cnt:0,xrpOut:0,xrpIn:0,entity:Hn(r),firstSeen:l,lastSeen:l});let c=n.get(r);c.cnt++,l&&(c.firstSeen=c.firstSeen?Math.min(c.firstSeen,l):l,c.lastSeen=Math.max(c.lastSeen,l));let d=(a==null?void 0:a.delivered_amount)||s.Amount,u=typeof d=="string"?Number(d)/1e6:0;o?c.xrpOut+=u:c.xrpIn+=u}return n}function Jy(e,t,n=15){let s=Du(e,t),a=[...s.entries()].sort((r,l)=>l[1].xrpOut+l[1].xrpIn-(r[1].xrpOut+r[1].xrpIn)||l[1].cnt-r[1].cnt).slice(0,n);if(!a.length)return'<div class="inspect-empty-note">No counterparty interactions found.</div>';let o=Math.max(...a.map(([,r])=>r.xrpOut+r.xrpIn),1),i=a.map(([r,l],c)=>{var g;let d=l.xrpOut+l.xrpIn,u=Math.max(1.5,d/o*100),p=bn[(g=l.entity)==null?void 0:g.type]||bn.other,m=d>0?l.xrpOut/d:.5,f=m>.65?"\u2192 out":m<.35?"\u2190 in":"\u21C4 both",h=l.entity?`<span style="font-size:.64rem;color:${p};border:1px solid ${p};border-radius:999px;padding:1px 7px;margin-left:6px">${y(l.entity.name)}</span>`:"",b=Lu(l.firstSeen,l.lastSeen);return`
      <div style="display:flex;align-items:center;gap:10px;padding:6px 0;border-bottom:1px solid rgba(255,255,255,.05)">
        ...
        <div style="width:150px;flex-shrink:0;overflow:hidden">
          <div style="display:flex;align-items:center">
            <span class="mono" style="font-size:.76rem;color:rgba(255,255,255,.85)" title="${y(r)}">${y(U(r))}</span>
            ${h}
          </div>
    ...
    ${i}`}function Yy(e,t,n,s,a="inspect-network-map"){let o=document.getElementById(a);if(!o)return;let r=[...Du(e,t).entries()].sort((S,M)=>M[1].xrpOut+M[1].xrpIn-(S[1].xrpOut+S[1].xrpIn)||M[1].cnt-S[1].cnt).slice(0,20);if(r.length<2){o.style.display="",o.innerHTML=`<div class="inspect-empty-note">${r.length===0?"No counterparty interactions found.":"Only one counterparty found \u2014 not enough to chart a network map."}</div>`;return}o.style.display="";let l=560,c=340,d=l/2,u=c/2,p=95,m=7,f=155,h=13,b=r[0][1].xrpOut+r[0][1].xrpIn||1,g=r[0][1].cnt||1,v=[{id:t,x:d,y:u,r:13,main:!0,label:U(t),color:"#00d4ff",xrpOut:0,xrpIn:0,cnt:0}];r.forEach(([S,M],C)=>{let A=C<m?p:f,R=C<m?m:h,I=(C<m?C:C-m)/R*2*Math.PI-Math.PI/2,D=M.xrpOut+M.xrpIn,F=Math.max(5,Math.min(14,4+D/b*10)),H=M.entity,E=bn[H==null?void 0:H.type]||bn.other,z=D>0?M.xrpOut/D:.5,te=z>.65?"out":z<.35?"in":"both";v.push({id:S,x:d+A*Math.cos(I),y:u+A*Math.sin(I),r:F,color:E,label:(H==null?void 0:H.name)||U(S),ent:H,xrpOut:M.xrpOut,xrpIn:M.xrpIn,cnt:M.cnt,dir:te,vol:D,ring:A})});let w=`<defs>
    ...
    </div>`}function Qy(){let e=window._lastInspectResult,t=window._lastAllFindings||[];if(!e)return null;let n=t.length?t.map(a=>`- [${a.sev.toUpperCase()}] ${a.module}: ${a.headline}${a.detail?" \u2014 "+a.detail:""}`).join(`
...
You are acting as a security analyst explaining automated blockchain forensics findings to someone who isn't a blockchain expert. Write a clear, plain-English explanation of what this account's activity suggests. Synthesize the findings above into a coherent read of the account rather than restating them one by one \u2014 call out which ones reinforce each other and which are weak signals on their own. Be direct about how concerning (or not) this looks, and be skeptical of your own confidence where the evidence is thin rather than overstating it. Do not repeat the address or risk score back verbatim; the reader can already see those above your response.`}window.copyInspectorAnalysisForAi=function(){let e=document.getElementById("ai-explanation-body"),t=Qy();if(!t){e&&(e.innerHTML='<p style="font-size:.82rem;color:#ff5555">Run an inspection first.</p>');return}Hs(t)};window.exportInspectorJSON=function(){var o,i;let e=window._lastInspectResult;if(!e){alert("Run an inspection first.");return}let t=new Blob([JSON.stringify(e,null,2)],{type:"application/json"}),n=URL.createObjectURL(t),s=document.createElement("a"),a=((i=(o=document.getElementById("inspect-addr-badge"))==null?void 0:o.dataset)==null?void 0:i.fullAddr)||"wallet";s.href=n,s.download=`naluxrp_${a.slice(0,10)}_${new Date().toISOString().slice(0,10)}.json`,document.body.appendChild(s),s.click(),document.body.removeChild(s),URL.revokeObjectURL(n)};var Zy=6e4,e0=1e4,t0=12e4,n0=8e3,s0=12e4,a0=300,Vu="nalulf_net_baseline_v2",o0=80,i0=5,aa="/api/v1/validatorregistry",Gu="/api/v1/validator";var r0=5*60*1e3,Ku=10*60*1e3,Iu=1e4,Ju=8e3,sr=new Map,ar=new Map;var en={quorumTight:{w:3,label:"Quorum within 3 validators of failure threshold"},nUnlActive:{w:2,label:"Negative UNL active \u2014 validators currently being ignored"},amendVeto:{w:1,label:"Amendment veto clustering \u2014 protocol governance dispute"},feeSpike:{w:2,label:"Open ledger fee 10\xD7 minimum \u2014 DDoS / spam attack likely"},burnAnomaly:{w:2,label:"XRP burn rate z-score > 3\u03C3 \u2014 resource exhaustion pattern"},peerSaturate:{w:2,label:"Inbound peers > 80% of connections \u2014 Eclipse Attack risk"},eclipseRisk:{w:3,label:"Peer count < 6 \u2014 node highly vulnerable to isolation"},dexSpike:{w:1,label:"DEX volume > 3\xD7 AMM baseline \u2014 unusual event-driven flow"},reserveSpike:{w:1,label:"New account rate > 3\xD7 baseline \u2014 possible bot creation"},slowConverge:{w:2,label:"Consensus convergence > 6s \u2014 network agreement degraded"},lowProposers:{w:2,label:"Proposer count below quorum \u2014 validator participation low"},queuePressure:{w:2,label:"TX queue > 80% full \u2014 fee surge imminent"},spamLedger:{w:1,label:"Ledger > 2\xD7 expected size \u2014 ledger spam in progress"},ioStressed:{w:1,label:"Node IO latency > 5ms \u2014 storage or network I/O stress"},peerChurn:{w:1,label:"Elevated peer disconnect rate \u2014 DDoS or instability"},staleLedger:{w:3,label:"Ledger age > 10s \u2014 validation appears stalled"}},Yu={MultiSign:{purpose:"Multi-signature authorization",intro:"rippled 0.31",desc:"Lets multiple keys jointly authorize one transaction. Essential for institutional custody and hardware-wallet setups.",impact:"New transaction: SignerListSet. All signers submit their signature; the last one broadcasts."},MultiSignReserve:{purpose:"Cheaper signer-list reserve",intro:"rippled 1.2",desc:"Cuts the owner reserve for SignerList objects from 5 owner-items (10 XRP) down to 1 owner-item (2 XRP).",impact:"Existing SignerLists do not gain the reduction automatically; delete and re-create the list."},DepositAuth:{purpose:"Block unsolicited incoming payments",intro:"rippled 0.90",desc:"An account can set lsfDepositAuth so it only receives payments explicitly pre-authorized via DepositPreauth.",impact:"Senders to un-authorized accounts receive tecNO_PERMISSION."},DeletableAccounts:{purpose:"Permanent account deletion + reserve reclaim",intro:"rippled 1.4",desc:"An account with no objects and sequence \u2265 (current ledger \u2212 256) can permanently delete itself and recover the base reserve.",impact:"New transaction: AccountDelete. Sends all XRP minus fees to a destination."},NegativeUNL:{purpose:"Fault-tolerant consensus during outages",intro:"rippled 1.6",desc:"When validators are persistently offline, the network may add them to the Negative UNL so they do not count against quorum.",impact:"Enables the network to survive planned outages of up to 20% of trusted validators."},Checks:{purpose:"Deferred, cancellable payments",intro:"rippled 1.0",desc:"The sender creates a Check; the recipient can later cash it up to the authorized amount or let it expire. The sender can cancel at any time.",impact:"New transactions: CheckCreate, CheckCash, CheckCancel. Each open Check uses one owner-reserve slot."},AMM:{purpose:"Native Automated Market Maker DEX",intro:"rippled 1.12",desc:"Adds a Constant-Product (x*y=k) AMM directly in the ledger. Anyone can deposit two assets to earn LP tokens and a share of swap fees.",impact:"New transactions: AMMCreate, AMMDeposit, AMMWithdraw, AMMVote, AMMBid, AMMDelete."},XChainBridge:{purpose:"Cross-chain bridge protocol",intro:"rippled 2.0",desc:"Lets assets move between XRPL Mainnet, sidechains, and EVM chains via a locking/minting bridge secured by Witness servers.",impact:"New ledger objects: Bridge, XChainOwnedCreateAccountClaimID, etc. Requires Witness infrastructure."},Clawback:{purpose:"Token-issuer recovery",intro:"rippled 1.12",desc:"Issuers who set lsfAllowTrustLineClawback before issuing tokens can claw back tokens from any holder.",impact:"Must be enabled on a fresh account before any trust lines are created."},NonFungibleTokensV1:{purpose:"Native NFT support",intro:"rippled 1.9",desc:"Adds NFTokenMint, NFTokenBurn, and offer-based transfer mechanics for non-fungible tokens stored in NFTokenPage objects.",impact:"Each NFTokenPage holds up to 32 tokens and costs one owner-reserve slot. Royalties up to 50%."},NonFungibleTokensV1_1:{purpose:"NFT V1 corrections",intro:"rippled 1.10",desc:"Fixes pagination bugs, transfer-fee edge cases, and minting with the URI field that were present in V1.",impact:"Breaking fix for some V1 edge cases. Wallets built for V1 should test V1_1 compatibility."},PayChan:{purpose:"Payment channels for streaming micropayments",intro:"rippled 0.33",desc:"Sender deposits XRP into a channel, then issues signed claims off-ledger. Recipient submits the highest claim at any time to settle on-ledger.",impact:"New transactions: PaymentChannelCreate, PaymentChannelFund, PaymentChannelClaim."},Escrow:{purpose:"Time-locked and condition-based XRP transfers",intro:"rippled 0.60",desc:"Lock XRP until a future time OR a cryptographic fulfillment (PREIMAGE-SHA-256) is revealed, enabling vesting schedules and atomic swaps.",impact:"New transactions: EscrowCreate, EscrowFinish, EscrowCancel. Locked XRP counts against reserves."},DisallowIncoming:{purpose:"Block unsolicited ledger-object creation",intro:"rippled 1.10",desc:"New account flags let you individually block incoming Trust Lines, Check objects, NFToken offers, and Payment Channels.",impact:"Four new AccountSet flags; existing incoming objects are unaffected."},ExpandedSignerList:{purpose:"Larger multi-sig signer lists",intro:"rippled 1.9.1",desc:"Increases the maximum signers per SignerList from 8 to 32, enabling more complex institutional multi-sig and DAO governance.",impact:"Reserve cost scales with signer count. Requires MultiSignReserve to be cost-effective."},OwnerPaysFee:{purpose:"Correct fee payer in PayChan",intro:"rippled 0.33",desc:"Fixes a spec inconsistency where the channel owner correctly pays the transaction fee when closing or expiring channels.",impact:"Purely a fee-accounting fix; no user-visible behavior changes."},fixMasterKeyAsRegularKey:{purpose:"Master-key mis-use bug fix",intro:"rippled 0.90",desc:"Prevents accounts from setting their master key as their regular key \u2014 an operation that could create an unusable account state.",impact:"No application changes needed; existing accounts are not affected."},TrustSetAuth:{purpose:"Authorized trust lines",intro:"rippled 0.30",desc:"Issuers can require explicit authorization before anyone can hold their token \u2014 a prerequisite for regulatory-grade stablecoins.",impact:"New flow: issuer sends TrustSet with tfSetfAuth to approve each holder."}},Fu=new Set(["xrpscan.com","xrpl.aesthetes.art","xrpkuwait.com","xrpgoat.com","xrp.vet","xrp.unic.ac.cy","xrp-validator.interledger.org","xpmarket.com","verum.eminence.im","validator.xrpl.robertswarthout.com","validator.xrpl-labs.com","validator.poli.usp.br","validator.gatehub.net","validator.aspired.nz","v2.xrpl-commons.org","tequ.dev","squidrouter.com","ripple.ittc.ku.edu","ripple.com","peersyst.cloud","onxrp.com","katczynski.net","jon-nilsen.no","ekiserrepe.es","cabbit.tech","bithomp.com","aureusox.com","arrington-xrp-capital.blockdaemon.com","anodos.finance","bitso.com","ripple.kenan-flagler.unc.edu","ripplevalidator.uwaterloo.ca","shadow.haas.berkeley.edu","www.bitrue.com","xrp-col.anu.edu.au"]),l0=new Set(["nHBu3iuq1SQ9Z686pYwWYVKpScSMDWfpUJHdNEQRxn5XyETui7Db","nHDwBbubxJswoweWQKEgWLNRJv2hNRCTR4GGApJmbtCcbtYNSpdB","nHU2FpRbPrvVcyQQpkqrAUDJDTRHZpjij8DpKeSC481PYY9ikYkb","nHUbmg8QNzEGjHzgnt99e9YE2scU3DZGH7FsF6MCcK5eiPt3AtaH","nHUxBD1UPb383SdWgJx62GGQ7W2WKvgpUtUXLjiGGRRcPb3nbSXd","nHUP6rfQfgzg6tKga3k9ziEvtjwn1PB32gcr5dLcamqzmitszYv2","nHBT58yHyDdPdJ6gzaBMT7gqwTMpj5ERji1s9SvfKKtfoZUS89WX","nHBxsUzx3Bbf6J4yJ3fLQ3VizPtdREVwTJ6mdqkuDTjLcVbggVbk","nHUeUNSn3zce2xQZWNghQvd9WRH6FWEnCBKYVJu2vAizMxnXegfJ","nHUCAdca6VoWWYVdBH1bwCUQggEX2e5acQSqxM3DwyuhsFknxmh3","nHDDiwQBqXhEL1CFoRHdMXD33x9K7rpYJfniXxL7kFavpPd21EGe","nHBipbbREjNEiCs4hpy3K2489dRf27MPnxdivTTWKSd8ZUhfRvn8","nHDDe5uAdiv6RA59MA1oM4JLDtVSYKNShgjEqq1KsdJXZiR47CQT","nHBbiP5ua5dUqCTz5i5vd3ia9jg3KJthohDjgKxnc7LxtmnauW7Z","nHBQ3CT3EWYZ4uzbnL3k6TRf9bBPhWRFVcK1F5NjtwCBksMEt5yy","nHU16DF2kq7TmbR1Y5z8yKNXiLEf3oHT19HVpVXv7unFLfxa17nT","nHUC23NnutZyYeQxQbAbPUpKoVGj5aisBxf2zzcZzJ43fcw5rc9z","nHUgdMvuchx7AWG4ATMQdNNuMryo1SFoNptLCEVt2Dn7wEc625mF","nHUhQVE93dajM3srxubsEj1mK1gzRwJob14QSrJefY1FdLs6r7WJ","nHUU8xBczYzW6kZ6Ei9DsggzTJXRFkN3wE3FP5H4SLYzhbodeYcG","nHUGqooyfGqFkyH6uskbaEi6y2MjXjdA7QdbmyZ6p9etL5isRKLT","nHDp1ZXxEn7eo5YaUtiagaxSLwXudnKZDx68C96p4tdVLGLLLUFn","nHBcLEB4S6moQGrhMjJo1jbp58WL5psHY9EMDWNAtdqykUYiA1rF","nHUAECq1v1cKwn3NsYVyD7v6BNbfqyXmNVSF3e4XCVxPgBHRWkvv","nHUif4sukXu9pJGyyBaeVMwmE8L1fJ5KJj4X4ksgTKhgjG6k96s2","nHUVJR7SeT3nn6JPTz46JHqYRf7vX2if1sdTxnceywmSBWa167pt","nHUEYz4TtTv7yebjhY3aDib5KYPHnKjnY5mPYK5y4QuKdocwS5tD","nHUN5n2S3nQ8bzKm7bqeFMiQeDijh1LMgEocyNyQbb4mREazVdZ5","nHUgchANqM3giYSSvY5HsafFW6qxmG5jJ3CvPiv7n8gjNQuNm8Uz","nHDUqGoM7KR1pgbdYBRgKpGKdFLhpnMzVbECs8RE73RGZm3Va6MJ","nHUVxTi8XfXjaaJppw7mLSrYDRpkDpf8H9ypzgVKxfSXShcWwAoK","nHBveTxA1NaBj5AayRAU91f6YopuFWt9rmxfGaEh77a32Q6ZzzHc"]),c0=new Set(["validator.pftperry.com","rip973.com","preaware.org","postfiat.org","pftmeech.xyz","pft.xbtseal.com","pft.wizbubba.xyz","pft.permanentupperclass.com","pft.g.money","pft.akirax.xyz","jollydinger.com","auri0x.io","app.w.ai"]);function Qu(e,t){let n=(t||"").toLowerCase().replace(/^www\./,"");return l0.has(e)||c0.has(n)?{chain:"test",isUnl:!1}:Fu.has(n)||Fu.has("www."+n)?{chain:"main",isUnl:!0}:{chain:"main",isUnl:!1}}var ur={"xrpscan.com":{label:"XRP Scan",domain:"xrpscan.com",chain:"main",category:"unl"},"xrpl.aesthetes.art":{label:"Aesthetes",domain:"xrpl.aesthetes.art",chain:"main",category:"unl"},"xrpkuwait.com":{label:"XRP Kuwait",domain:"xrpkuwait.com",chain:"main",category:"unl"},"xrpgoat.com":{label:"XRP Goat",domain:"xrpgoat.com",chain:"main",category:"unl"},"xrp.vet":{label:"XRP Vet",domain:"xrp.vet",chain:"main",category:"unl"},"xrp.unic.ac.cy":{label:"Univ. of Nicosia",domain:"xrp.unic.ac.cy",chain:"main",category:"unl"},"xrp-validator.interledger.org":{label:"Interledger",domain:"xrp-validator.interledger.org",chain:"main",category:"unl"},"xpmarket.com":{label:"XPMarket",domain:"xpmarket.com",chain:"main",category:"unl"},"verum.eminence.im":{label:"Eminence",domain:"verum.eminence.im",chain:"main",category:"unl"},"validator.xrpl.robertswarthout.com":{label:"R. Swarthout",domain:"validator.xrpl.robertswarthout.com",chain:"main",category:"unl"},"validator.xrpl-labs.com":{label:"XRPL Labs",domain:"validator.xrpl-labs.com",chain:"main",category:"unl"},"validator.poli.usp.br":{label:"USP",domain:"validator.poli.usp.br",chain:"main",category:"unl"},"validator.gatehub.net":{label:"Gatehub",domain:"validator.gatehub.net",chain:"main",category:"unl"},"validator.aspired.nz":{label:"Aspired NZ",domain:"validator.aspired.nz",chain:"main",category:"unl"},"v2.xrpl-commons.org":{label:"XRPL Commons",domain:"v2.xrpl-commons.org",chain:"main",category:"unl"},"tequ.dev":{label:"Tequ",domain:"tequ.dev",chain:"main",category:"unl"},"squidrouter.com":{label:"Squid Router",domain:"squidrouter.com",chain:"main",category:"unl"},"ripple.ittc.ku.edu":{label:"Univ. of Kansas",domain:"ripple.ittc.ku.edu",chain:"main",category:"unl"},"ripple.com":{label:"Ripple",domain:"ripple.com",chain:"main",category:"unl"},"peersyst.cloud":{label:"Peersyst",domain:"peersyst.cloud",chain:"main",category:"unl"},"onxrp.com":{label:"OnXRP",domain:"onxrp.com",chain:"main",category:"unl"},"katczynski.net":{label:"Katczynski",domain:"katczynski.net",chain:"main",category:"unl"},"jon-nilsen.no":{label:"Jon Nilsen",domain:"jon-nilsen.no",chain:"main",category:"unl"},"ekiserrepe.es":{label:"Ekiserrepe",domain:"ekiserrepe.es",chain:"main",category:"unl"},"cabbit.tech":{label:"Cabbit",domain:"cabbit.tech",chain:"main",category:"unl"},"bithomp.com":{label:"Bithomp",domain:"bithomp.com",chain:"main",category:"unl"},"aureusox.com":{label:"Aureus Ox",domain:"aureusox.com",chain:"main",category:"unl"},"arrington-xrp-capital.blockdaemon.com":{label:"Arrington / Blockdaemon",domain:"arrington-xrp-capital.blockdaemon.com",chain:"main",category:"unl"},"anodos.finance":{label:"Anodos Finance",domain:"anodos.finance",chain:"main",category:"unl"},"bitso.com":{label:"Bitso",domain:"bitso.com",chain:"main",category:"unl"},"ripple.kenan-flagler.unc.edu":{label:"UNC Kenan-Flagler",domain:"ripple.kenan-flagler.unc.edu",chain:"main",category:"unl"},"ripplevalidator.uwaterloo.ca":{label:"Univ. of Waterloo",domain:"ripplevalidator.uwaterloo.ca",chain:"main",category:"unl"},"shadow.haas.berkeley.edu":{label:"UC Berkeley Haas",domain:"shadow.haas.berkeley.edu",chain:"main",category:"unl"},"www.bitrue.com":{label:"Bitrue",domain:"www.bitrue.com",chain:"main",category:"unl"},"xrp-col.anu.edu.au":{label:"ANU",domain:"xrp-col.anu.edu.au",chain:"main",category:"unl"},"xrpval.rawsec.de":{label:"Rawsec",domain:"xrpval.rawsec.de",chain:"main",category:"other"},"xrplvl.carbonvibe.com":{label:"Carbon Vibe",domain:"xrplvl.carbonvibe.com",chain:"main",category:"other"},"xrplvalidator.alloy.ee":{label:"Alloy",domain:"xrplvalidator.alloy.ee",chain:"main",category:"other"},"xrpl.uni.lu":{label:"Univ. of Luxembourg",domain:"xrpl.uni.lu",chain:"main",category:"other"},"xrpl.to":{label:"XRPL.to",domain:"xrpl.to",chain:"main",category:"other"},"xrpl.su":{label:"XRPL.su",domain:"xrpl.su",chain:"main",category:"other"},"xrpl.sbivc.co.jp":{label:"SBI VC Trade",domain:"xrpl.sbivc.co.jp",chain:"main",category:"other"},"xrpl-verification.flare.network":{label:"Flare Network",domain:"xrpl-verification.flare.network",chain:"main",category:"other"},"xrpl-validator.7rev.dev":{label:"7Rev",domain:"xrpl-validator.7rev.dev",chain:"main",category:"other"},"xrp.teacopula.com":{label:"Teacopula",domain:"xrp.teacopula.com",chain:"main",category:"other"},"xrp.moneymindedapes.com":{label:"MoneyMindedApes",domain:"xrp.moneymindedapes.com",chain:"main",category:"other"},"xrp.hazza-systems.de":{label:"Hazza Systems",domain:"xrp.hazza-systems.de",chain:"main",category:"other"},"xrp.cs.uoregon.edu":{label:"Univ. of Oregon",domain:"xrp.cs.uoregon.edu",chain:"main",category:"other"},"xrp.bpsqn.com":{label:"BPSQN",domain:"xrp.bpsqn.com",chain:"main",category:"other"},"xrp-validator.grapedrop.xyz":{label:"Grapedrop",domain:"xrp-validator.grapedrop.xyz",chain:"main",category:"other"},"xaodao.io":{label:"XaoDAO",domain:"xaodao.io",chain:"main",category:"other"},"vl.xrpsalute.com":{label:"XRP Salute",domain:"vl.xrpsalute.com",chain:"main",category:"other"},"validator.xrpl.app":{label:"XRPL App",domain:"validator.xrpl.app",chain:"main",category:"other"},"validator.ukcbt.org":{label:"UKCBT",domain:"validator.ukcbt.org",chain:"main",category:"other"},"validator.sugarxrpl.com":{label:"SugarXRPL",domain:"validator.sugarxrpl.com",chain:"main",category:"other"},"validator.boscaern.digital":{label:"Boscaern",domain:"validator.boscaern.digital",chain:"main",category:"other"},"trimaera.tech":{label:"Trimaera",domain:"trimaera.tech",chain:"main",category:"other"},"textrp.io":{label:"TextRP",domain:"textrp.io",chain:"main",category:"other"},"tesbert.com":{label:"Tesbert",domain:"tesbert.com",chain:"main",category:"other"},"tachyon-xrpl-validator.github.io":{label:"Tachyon",domain:"tachyon-xrpl-validator.github.io",chain:"main",category:"other"},"solonation.io":{label:"SoloNation",domain:"solonation.io",chain:"main",category:"other"},"smokydrip.com":{label:"SmokyDrip",domain:"smokydrip.com",chain:"main",category:"other"},"rippled-validator.us":{label:"rippled-validator.us",domain:"rippled-validator.us",chain:"main",category:"other"},"rippleat.snt.uni.lu":{label:"Univ. Luxembourg (SNT)",domain:"rippleat.snt.uni.lu",chain:"main",category:"other"},"ripple.uni.lu":{label:"Univ. Luxembourg",domain:"ripple.uni.lu",chain:"main",category:"other"},"ripple.j2b.com":{label:"J2B",domain:"ripple.j2b.com",chain:"main",category:"other"},"rich-list.info":{label:"Rich List",domain:"rich-list.info",chain:"main",category:"other"},"proptoexchange.com":{label:"ProPtoExchange",domain:"proptoexchange.com",chain:"main",category:"other"},"printscierge.com":{label:"Printscierge",domain:"printscierge.com",chain:"main",category:"other"},"opulencex.io":{label:"OpulenceX",domain:"opulencex.io",chain:"main",category:"other"},"onledger.net":{label:"OnLedger",domain:"onledger.net",chain:"main",category:"other"},"oclost.art":{label:"Oclost",domain:"oclost.art",chain:"main",category:"other"},"managednetwork.us":{label:"ManagedNetwork",domain:"managednetwork.us",chain:"main",category:"other"},"joshuahamsa.com":{label:"Joshua Hamsa",domain:"joshuahamsa.com",chain:"main",category:"other"},"grimmsxrpflow.jwscott.net":{label:"Grimm XRP Flow",domain:"grimmsxrpflow.jwscott.net",chain:"main",category:"other"},"getlol.xyz":{label:"GetLol",domain:"getlol.xyz",chain:"main",category:"other"},"gen3labs.xyz":{label:"Gen3 Labs",domain:"gen3labs.xyz",chain:"main",category:"other"},"garveyvalid.com":{label:"Garvey",domain:"garveyvalid.com",chain:"main",category:"other"},"easynpl.kr":{label:"EasyNPL",domain:"easynpl.kr",chain:"main",category:"other"},"diseb.ewi.tudelft.nl":{label:"TU Delft",domain:"diseb.ewi.tudelft.nl",chain:"main",category:"other"},"datamossa.com":{label:"DataMossa",domain:"datamossa.com",chain:"main",category:"other"},"crypto.unibe.ch":{label:"Univ. of Bern",domain:"crypto.unibe.ch",chain:"main",category:"other"},"commonprefix.com":{label:"Common Prefix",domain:"commonprefix.com",chain:"main",category:"other"},"catalyze-research.com":{label:"Catalyze Research",domain:"catalyze-research.com",chain:"main",category:"other"},"catalog.org":{label:"Catalog",domain:"catalog.org",chain:"main",category:"other"},"blockchain.korea.ac.kr":{label:"Korea Univ.",domain:"blockchain.korea.ac.kr",chain:"main",category:"other"},"astatiumprotocol.com":{label:"Astatium Protocol",domain:"astatiumprotocol.com",chain:"main",category:"other"},"ladykxrpl.mywire.org":{label:"LadyK XRPL",domain:"LadyKXRPL.mywire.org",chain:"main",category:"other"},"eelap-p1201-xrp.abudhabi.nyu.edu":{label:"NYU Abu Dhabi",domain:"EELAP-P1201-XRP.ABUDHABI.NYU.EDU",chain:"main",category:"other"},"589.clouds.hspeed.ch":{label:"HSpeed",domain:"589.clouds.hspeed.ch",chain:"main",category:"other"},"validator.pftperry.com":{label:"PFT Perry",domain:"validator.pftperry.com",chain:"test",category:"other"},"rip973.com":{label:"rip973",domain:"rip973.com",chain:"test",category:"other"},"preaware.org":{label:"Preaware",domain:"preaware.org",chain:"test",category:"other"},"postfiat.org":{label:"PostFiat",domain:"postfiat.org",chain:"test",category:"other"},"pftmeech.xyz":{label:"PFT Meech",domain:"pftmeech.xyz",chain:"test",category:"other"},"pft.xbtseal.com":{label:"PFT XBT Seal",domain:"pft.xbtseal.com",chain:"test",category:"other"},"pft.wizbubba.xyz":{label:"PFT Wizbubba",domain:"pft.wizbubba.xyz",chain:"test",category:"other"},"pft.permanentupperclass.com":{label:"PFT Perm Upper Class",domain:"pft.permanentupperclass.com",chain:"test",category:"other"},"pft.g.money":{label:"PFT G.Money",domain:"pft.g.money",chain:"test",category:"other"},"pft.akirax.xyz":{label:"PFT Akirax",domain:"pft.akirax.xyz",chain:"test",category:"other"},"jollydinger.com":{label:"Jollydinger",domain:"jollydinger.com",chain:"test",category:"other"},"auri0x.io":{label:"Auri0x",domain:"auri0x.io",chain:"test",category:"other"},"app.w.ai":{label:"W.ai",domain:"app.w.ai",chain:"test",category:"other"}},po={nHB8QMKGt9VB4Vg71VszjBVQnDW3v3QudM4436zXRZgiuUBBSWJe:{lat:37.77,lng:-122.42,city:"San Francisco",org:"Ripple"},nHUon2tpyJEHHYGmxqNd3h3oGNQwNyX8PNS3aHe3bNpCrNXZlHo:{lat:37.77,lng:-122.41,city:"San Francisco",org:"Ripple"},nHUpwrafS45zmi6eT72XS5ijpkW5JwfL5mLdPhEibrqUvtRcMAjU:{lat:37.78,lng:-122.4,city:"San Francisco",org:"Ripple"},nHUkp7WhouVMobBUKGrV5FNqjsdD9zKP5jpGnnLfQXCMNe4dkDqo:{lat:37.76,lng:-122.43,city:"San Francisco",org:"Ripple"},nHUryiyDqEtyWVtFG24AAhaYjMf9FRLietZGBWYwUTojmugMsx3o:{lat:37.79,lng:-122.38,city:"San Francisco",org:"Ripple"},nHUpcmNsxAw47yt2ADDoNoQrzLyTJPgnyq16u6Qx2kRPA17oUNHz:{lat:37.8,lng:-122.39,city:"San Francisco",org:"Ripple"},nHUnhRJK3csknycNK5SXRFi8jvDp3sKoWvS9wKWLq1ATBBGgPBjp:{lat:37.75,lng:-122.44,city:"San Francisco",org:"Ripple"},nHUq9tJvk5QTDkwurB7EzbzkZ2uuoHjS3GKjP6pZiU3DJGnobNYK:{lat:39.04,lng:-77.49,city:"Ashburn, VA",org:"AWS (Coil)"},nHUvcCcmoH1FJMMC6NtF9KKA4LpCWhjsxk2reCQidsp5AHQ7QY9H:{lat:49.45,lng:11.08,city:"Nuremberg",org:"Hetzner (Gatehub)"},nHDH7bQJpVfDhVSqdui3Z8GPvKEBQpo6AKHcnXe21zoD4nABA6xj:{lat:52.37,lng:4.9,city:"Amsterdam",org:"GCP (XRPL Labs)"},nHUED59jjpQ5QbNtesAbB6Es3uUPv3c9Ri5MNNgfMv5t5Lhb5ndW:{lat:19.43,lng:-99.13,city:"Mexico City",org:"AWS (Bitso)"},nHBidG3pZK11zqjeVos6hFxTDPGYuqfRFZ5gu9b7tQFdB8nPZujG:{lat:35.69,lng:139.69,city:"Tokyo",org:"NTT (Digital Garage)"},nHDB2PAPYqF86j9j3c6w1F1ZqwvQfiWcFShZ9Pokg9q4ohNDSkAz:{lat:47.61,lng:-122.33,city:"Seattle, WA",org:"Azure (Arrington)"},nHUdphn3LXa31w5sLd39MQdPEKQNrNYL3DQFByijVXiNQ3G6BYBZ:{lat:1.35,lng:103.82,city:"Singapore",org:"AWS (Tokenize)"},nHUFCyRCrUjvtZmKiLeF8ReopzKuSkVzdl1VsMCqm75aqyohLYEg:{lat:48.86,lng:2.35,city:"Paris",org:"OVH (XRPL Commons)"},nHULqGBkJtWeNFjhTzYeAsHA3qKKS7HoBh8CV3BAGTGMZuepEhWC:{lat:40.71,lng:-74.01,city:"New York",org:"Equinix (Blockchain LLC)"},nHBdXSF6YHAHSZUk7rvox6jwbvvyqBnsWGcewBtq8x1XuH6KXKXr:{lat:37.79,lng:-122.4,city:"San Francisco",org:"Cloudflare (XRP Scan)"}},Ou={"xrpscan.com":{lat:51.51,lng:-.13,city:"London",org:"XRPScan"},"xrpl.aesthetes.art":{lat:52.37,lng:4.9,city:"Amsterdam",org:"Aesthetes"},"xrpkuwait.com":{lat:29.37,lng:47.98,city:"Kuwait City",org:"XRP Kuwait"},"xrpgoat.com":{lat:39.04,lng:-77.49,city:"Ashburn, VA",org:"XRP Goat"},"xrp.vet":{lat:48.86,lng:2.35,city:"Paris",org:"XRP Vet"},"xrp.unic.ac.cy":{lat:35.17,lng:33.37,city:"Nicosia",org:"Univ. of Nicosia"},"xrp-validator.interledger.org":{lat:40.71,lng:-74.01,city:"New York",org:"Interledger Foundation"},"xpmarket.com":{lat:52.37,lng:4.9,city:"Amsterdam",org:"XPMarket"},"verum.eminence.im":{lat:51.51,lng:-.13,city:"London",org:"Eminence"},"validator.xrpl.robertswarthout.com":{lat:52.37,lng:4.9,city:"Amsterdam",org:"R. Swarthout"},"validator.xrpl-labs.com":{lat:52.37,lng:4.9,city:"Amsterdam",org:"XRPL Labs"},"validator.xrpl.app":{lat:52.37,lng:4.9,city:"Amsterdam",org:"XRPL App"},"validator.poli.usp.br":{lat:-23.55,lng:-46.63,city:"S\xE3o Paulo",org:"USP"},"validator.gatehub.net":{lat:46.05,lng:14.51,city:"Ljubljana",org:"Gatehub"},"validator.aspired.nz":{lat:-36.86,lng:174.76,city:"Auckland",org:"Aspired NZ"},"v2.xrpl-commons.org":{lat:48.86,lng:2.35,city:"Paris",org:"XRPL Commons"},"tequ.dev":{lat:60.17,lng:24.94,city:"Helsinki",org:"Tequ"},"squidrouter.com":{lat:37.77,lng:-122.42,city:"San Francisco",org:"Squid Router"},"ripple.ittc.ku.edu":{lat:38.97,lng:-95.24,city:"Lawrence, KS",org:"Univ. of Kansas"},"ripple.com":{lat:37.77,lng:-122.42,city:"San Francisco",org:"Ripple"},"peersyst.cloud":{lat:41.39,lng:2.15,city:"Barcelona",org:"Peersyst"},"onxrp.com":{lat:51.51,lng:-.13,city:"London",org:"OnXRP"},"katczynski.net":{lat:52.23,lng:21.01,city:"Warsaw",org:"Katczynski"},"jon-nilsen.no":{lat:59.91,lng:10.75,city:"Oslo",org:"Jon Nilsen"},"ekiserrepe.es":{lat:40.42,lng:-3.7,city:"Madrid",org:"Ekiserrepe"},"cabbit.tech":{lat:51.51,lng:-.13,city:"London",org:"Cabbit"},"bithomp.com":{lat:59.33,lng:18.07,city:"Stockholm",org:"Bithomp"},"aureusox.com":{lat:40.71,lng:-74.01,city:"New York",org:"Aureus Ox"},"arrington-xrp-capital.blockdaemon.com":{lat:40.71,lng:-74.01,city:"New York",org:"Blockdaemon"},"anodos.finance":{lat:37.98,lng:23.73,city:"Athens",org:"Anodos Finance"},"bitso.com":{lat:19.43,lng:-99.13,city:"Mexico City",org:"Bitso"},"ripple.kenan-flagler.unc.edu":{lat:35.9,lng:-79.05,city:"Chapel Hill, NC",org:"UNC Kenan-Flagler"},"ripplevalidator.uwaterloo.ca":{lat:43.47,lng:-80.54,city:"Waterloo, ON",org:"Univ. of Waterloo"},"shadow.haas.berkeley.edu":{lat:37.87,lng:-122.26,city:"Berkeley, CA",org:"UC Berkeley Haas"},"www.bitrue.com":{lat:1.35,lng:103.82,city:"Singapore",org:"Bitrue"},"xrp-col.anu.edu.au":{lat:-35.28,lng:149.13,city:"Canberra",org:"ANU"},"xrpval.rawsec.de":{lat:51.17,lng:10.45,city:"Germany",org:"Rawsec"},"xrplvl.carbonvibe.com":{lat:51.51,lng:-.13,city:"London",org:"Carbon Vibe"},"xrplvalidator.alloy.ee":{lat:59.44,lng:24.75,city:"Tallinn",org:"Alloy"},"xrpl.uni.lu":{lat:49.61,lng:6.13,city:"Luxembourg",org:"Univ. of Luxembourg"},"xrpl.to":{lat:48.86,lng:2.35,city:"Paris",org:"XRPL.to"},"xrpl.su":{lat:55.75,lng:37.62,city:"Moscow",org:"XRPL.su"},"xrpl.sbivc.co.jp":{lat:35.69,lng:139.69,city:"Tokyo",org:"SBI VC Trade"},"xrpl-verification.flare.network":{lat:51.51,lng:-.13,city:"London",org:"Flare Network"},"xrpl-validator.7rev.dev":{lat:52.52,lng:13.4,city:"Berlin",org:"7Rev"},"xrp.teacopula.com":{lat:39.04,lng:-77.49,city:"Ashburn, VA",org:"Teacopula"},"xrp.moneymindedapes.com":{lat:39.04,lng:-77.49,city:"Ashburn, VA",org:"MoneyMindedApes"},"xrp.hazza-systems.de":{lat:52.52,lng:13.4,city:"Berlin",org:"Hazza Systems"},"xrp.cs.uoregon.edu":{lat:44.05,lng:-123.08,city:"Eugene, OR",org:"Univ. of Oregon"},"xrp.bpsqn.com":{lat:37.77,lng:-122.42,city:"San Francisco",org:"BPSQN"},"xrp-validator.grapedrop.xyz":{lat:52.37,lng:4.9,city:"Amsterdam",org:"Grapedrop"},"xaodao.io":{lat:1.35,lng:103.82,city:"Singapore",org:"XaoDAO"},"vl.xrpsalute.com":{lat:40.71,lng:-74.01,city:"New York",org:"XRP Salute"},"validator.ukcbt.org":{lat:51.51,lng:-.13,city:"London",org:"UKCBT"},"validator.sugarxrpl.com":{lat:37.77,lng:-122.42,city:"San Francisco",org:"SugarXRPL"},"validator.boscaern.digital":{lat:53.33,lng:-6.25,city:"Dublin",org:"Boscaern"},"trimaera.tech":{lat:48.86,lng:2.35,city:"Paris",org:"Trimaera"},"textrp.io":{lat:1.35,lng:103.82,city:"Singapore",org:"TextRP"},"tesbert.com":{lat:39.04,lng:-77.49,city:"Ashburn, VA",org:"Tesbert"},"tachyon-xrpl-validator.github.io":{lat:37.77,lng:-122.42,city:"San Francisco",org:"Tachyon"},"solonation.io":{lat:1.35,lng:103.82,city:"Singapore",org:"SoloNation"},"smokydrip.com":{lat:39.04,lng:-77.49,city:"Ashburn, VA",org:"SmokyDrip"},"rippled-validator.us":{lat:39.04,lng:-77.49,city:"Ashburn, VA",org:"rippled-validator.us"},"rippleat.snt.uni.lu":{lat:49.61,lng:6.13,city:"Luxembourg",org:"Univ. of Luxembourg"},"ripple.uni.lu":{lat:49.61,lng:6.13,city:"Luxembourg",org:"Univ. of Luxembourg"},"ripple.j2b.com":{lat:37.77,lng:-122.42,city:"San Francisco",org:"J2B"},"rich-list.info":{lat:51.51,lng:-.13,city:"London",org:"Rich List"},"proptoexchange.com":{lat:39.04,lng:-77.49,city:"Ashburn, VA",org:"ProPtoExchange"},"printscierge.com":{lat:39.04,lng:-77.49,city:"Ashburn, VA",org:"Printscierge"},"opulencex.io":{lat:1.35,lng:103.82,city:"Singapore",org:"OpulenceX"},"onledger.net":{lat:52.37,lng:4.9,city:"Amsterdam",org:"OnLedger"},"oclost.art":{lat:48.86,lng:2.35,city:"Paris",org:"Oclost"},"managednetwork.us":{lat:39.04,lng:-77.49,city:"Ashburn, VA",org:"ManagedNetwork"},"joshuahamsa.com":{lat:37.77,lng:-122.42,city:"San Francisco",org:"Joshua Hamsa"},"grimmsxrpflow.jwscott.net":{lat:39.04,lng:-77.49,city:"Ashburn, VA",org:"Grimm XRP Flow"},"getlol.xyz":{lat:39.04,lng:-77.49,city:"Ashburn, VA",org:"GetLol"},"gen3labs.xyz":{lat:37.77,lng:-122.42,city:"San Francisco",org:"Gen3 Labs"},"garveyvalid.com":{lat:40.71,lng:-74.01,city:"New York",org:"Garvey"},"easynpl.kr":{lat:37.57,lng:126.98,city:"Seoul",org:"EasyNPL"},"diseb.ewi.tudelft.nl":{lat:52,lng:4.36,city:"Delft",org:"TU Delft"},"datamossa.com":{lat:48.86,lng:2.35,city:"Paris",org:"DataMossa"},"crypto.unibe.ch":{lat:46.95,lng:7.45,city:"Bern",org:"Univ. of Bern"},"commonprefix.com":{lat:37.98,lng:23.73,city:"Athens",org:"Common Prefix"},"catalyze-research.com":{lat:51.51,lng:-.13,city:"London",org:"Catalyze Research"},"catalog.org":{lat:37.77,lng:-122.42,city:"San Francisco",org:"Catalog"},"blockchain.korea.ac.kr":{lat:37.57,lng:126.98,city:"Seoul",org:"Korea Univ."},"astatiumprotocol.com":{lat:1.35,lng:103.82,city:"Singapore",org:"Astatium Protocol"},"ladykxrpl.mywire.org":{lat:39.04,lng:-77.49,city:"Ashburn, VA",org:"LadyK XRPL"},"eelap-p1201-xrp.abudhabi.nyu.edu":{lat:24.47,lng:54.37,city:"Abu Dhabi",org:"NYU Abu Dhabi"},"589.clouds.hspeed.ch":{lat:47.38,lng:8.54,city:"Zurich",org:"HSpeed"},"www.payonline.financial":{lat:55.75,lng:37.62,city:"Moscow",org:"PayOnline"}};function mr(e){if(!e)return null;let t=e.toLowerCase().replace(/^www\./,"");return Ou[t]??Ou["www."+t]??null}var d0=[{lat:37.34,lng:-121.89,label:"s1.ripple.com",city:"San Jose, CA",org:"Ripple"},{lat:37.34,lng:-121.87,label:"s2.ripple.com",city:"San Jose, CA",org:"Ripple"},{lat:52.37,lng:4.91,label:"xrplcluster.com",city:"Amsterdam",org:"Cluster"},{lat:52.36,lng:4.89,label:"xrpl.ws",city:"Amsterdam",org:"Cluster"}],De={nunl:{hex:"#ff5555",glow:"rgba(255,85,85,.4)",label:"Negative UNL"},both:{hex:"#50fa7b",glow:"rgba(80,250,123,.4)",label:"UNL + dUNL"},unl:{hex:"#00fff0",glow:"rgba(0,255,240,.35)",label:"UNL"},dunl:{hex:"#bd93f9",glow:"rgba(189,147,249,.4)",label:"dUNL only"},other:{hex:"#ffb86c",glow:"rgba(255,184,108,.4)",label:"Other"},pub:{hex:"#50fa7b",glow:"rgba(80,250,123,.4)",label:"Public Node"}},or="https://api.xrpscan.com/api/v1/validatorregistry",$e=new Map,wn={},lo=0,Wn=!1,xn="fallback";function Zu(){if(!Wn){$e.clear();for(let[e,t]of Object.entries(ur)){let n=t.domain??e,s=Qu("",n),a=mr(n)??null;$e.set(e,{key:e,label:t.label,domain:n,domainVerified:!1,provider:t.provider??(a==null?void 0:a.org)??null,lists:t.lists??[],category:s.isUnl?"unl":"other",chain:s.chain,unl:s.isUnl,dunl:!1,geo:a,meta:{},agreement:{"1h":null,"24h":null,"30d":null}})}xn="fallback",fr({ok:!1,source:"fallback",error:"using hardcoded data \u2014 mount /api/v1 router"})}}var ir=0,p0=5*60*1e3;function Bu(e,t){var s,a;let n=Array.isArray(e)?e:e.validators??e.data??[];if(!n.length)throw new Error("Empty validators array");$e.clear();for(let o of n){let i=o.key??o.validation_public_key??o.master_key??o.signing_key??null;if(!i)continue;let r=o.domain??null,l=r?r.toLowerCase().replace(/^www\./,""):null,c=o.unl===!0||o.unl===1||o.unl==="true",d=Qu(i,l),u=c||d.isUnl,p=d.chain,m=u?"unl":"other",f=Object.values(ur).find(w=>w.domain&&w.domain.toLowerCase().replace(/^www\./,"")===l),h=(f==null?void 0:f.label)??o.label??o.account_name??o.name??l??null??`${i.slice(0,8)}\u2026${i.slice(-6)}`,b=po[i]??mr(l)??null,v=(((s=o.geo)==null?void 0:s.lat)!=null&&((a=o.geo)==null?void 0:a.lng)!=null?o.geo:null)??b;$e.set(i,{key:i,label:h,domain:r??null,domainVerified:!!(o.domainVerified??o.domain_verified),provider:o.provider??(v==null?void 0:v.org)??(f==null?void 0:f.provider)??null,lists:Array.isArray(o.lists)?o.lists:[],category:m,chain:p,unl:u,dunl:!1,geo:v,version:o.version??o.build_version??null,baseFee:o.base_fee_xrp??o.base_fee??null,ownerReserve:o.reserve_inc_xrp??o.owner_reserve??null,meta:o.meta??{},agreement:o.agreement??{"1h":er(o.agreement_1h??o.agr_1h),"24h":er(o.agreement_24h??o.agr_24h),"30d":er(o.agreement_30d??o.agr_30d)}})}wn=e.lists??{},lo=Date.now(),Wn=!0,xn=t,ir=0,fr({ok:!0,count:$e.size,lists:wn,source:t})}function er(e){if(!e)return null;let t=Number(e.total??e.ledgers??0),n=Number(e.missed??0),s=t-n,a=t>0?(s/t*100).toFixed(1):null;return{total:t,missed:n,hit:s,score:a?`${a}%`:null,scoreRaw:e.score??null}}async function ro(e=!1){let t=Date.now();if(!e&&Wn&&t-lo<r0)return!0;if(!e&&!Wn&&t-ir<p0)return!1;let n=typeof aa=="string"&&aa.startsWith("/api/"),s=location.protocol==="file:"||location.hostname==="127.0.0.1"||location.hostname==="localhost";if(!(n&&s))try{let a=new AbortController,o=setTimeout(()=>a.abort(),Iu),i=await fetch(aa,{signal:a.signal,headers:{Accept:"application/json"}});if(clearTimeout(o),!i.ok)throw new Error(`HTTP ${i.status}`);let r=await i.json();return Bu(r,"proxy"),!0}catch(a){console.warn("[registry] tier 1 (proxy) failed:",a.message)}try{let a=new AbortController,o=setTimeout(()=>a.abort(),Iu),i=await fetch(or,{signal:a.signal});if(clearTimeout(o),!i.ok)throw new Error(`HTTP ${i.status}`);let r=await i.text(),l=JSON.parse(r);return Bu(l,"xrpscan"),!0}catch(a){console.warn("[registry] tier 2 (xrpscan direct) failed:",a.message),(a.message.includes("Failed to fetch")||a.message.includes("CORS"))&&console.warn("[registry] CORS blocked \u2014 mount the backend proxy route (see validatorregistry.js)")}return console.warn("[registry] all sources failed \u2014 showing",Object.keys(ur).length,"hardcoded validators"),ir=Date.now(),Wn||Zu(),fr({ok:!1,source:"fallback",error:"all sources failed \u2014 mount /api/v1 router"}),!1}window.debugRegistry=async function(){console.group("\u{1F50D} Registry debug"),console.log("Current source:",xn),console.log("Validators loaded:",$e.size),console.log("Registry ok:",Wn),console.log("Last fetch:",lo?new Date(lo).toLocaleTimeString():"never"),console.log(""),console.log("Testing proxy \u2192",aa);try{let e=await fetch(aa),t=await e.text();console.log("  Status:",e.status,"\u2014 body preview:",t.slice(0,300))}catch(e){console.warn("  Failed:",e.message)}console.log(""),console.log("Testing XRPScan direct \u2192",or);try{let e=await fetch(or),t=await e.text();console.log("  Status:",e.status,"\u2014 body preview:",t.slice(0,300))}catch(e){console.warn("  Failed:",e.message)}return console.groupEnd(),{source:xn,size:$e.size,ok:Wn}};function ot(e){return $e.get(e)??{key:e,label:`${e.slice(0,10)}\u2026${e.slice(-6)}`,domain:null,provider:null,lists:[],category:"other",geo:po[e]??null,meta:{}}}function kn(e){var n;if(!e)return null;if(((n=e.geo)==null?void 0:n.lat)!=null)return e.geo;let t=po[e.key];return t||mr(e.domain)}function em(){return[...$e.values()].filter(e=>(e.category==="unl"||e.category==="both")&&e.chain!=="test").map(e=>e.key)}function u0(){return[...$e.values()].filter(e=>(e.category==="dunl"||e.category==="both")&&e.chain!=="test").map(e=>e.key)}function m0(){return[...$e.values()].filter(e=>e.category==="other"&&e.chain!=="test").map(e=>e.key)}function f0(){return[...$e.values()].filter(e=>e.chain==="test").map(e=>e.key)}function fr({ok:e,count:t,lists:n,source:s,error:a}){let o=x("m1-registry-badge");if(o)if(e){let i=[...$e.values()].filter(c=>c.category==="unl").length,r=[...$e.values()].filter(c=>c.chain==="test").length,l=t-r;o.textContent=`${l} mainnet \xB7 ${i} UNL \xB7 ${r} testnet \xB7 live`,o.className="registry-badge registry-badge--ok"}else o.textContent=s==="fallback"?`Fallback data \xB7 ${$e.size} known \xB7 ${a??"endpoint unreachable"}`:"Refreshing\u2026",o.className="registry-badge registry-badge--warn"}var co=null,Xu=!1,tr=!1,Hu=0,zu=0,Uu=0,nr=0,tm=!0,Ze=null,jn=null,ra=null,zt=null,Xe={},oo=null,rr={},Qe=null,Zt=[],io=null,lr={},na="unl",mt={fees:[],burnDrops:[],dexOffers:[],ammSwaps:[],newAccounts:[],converge:[],proposers:[],peerCounts:[],peerDiscon:[]};function nm(){var t,n;if(Xu)return;Xu=!0,H0(),Zu(),ro(!0),O0(),B0(),window.addEventListener("xrpl-connected",()=>{sa(),$s()&&(oa({force:!0}),ia({force:!1}))}),window.addEventListener("xrpl-disconnected",()=>{cr(),pr(null)}),window.addEventListener("xrpl-connection",s=>{var a;((a=s==null?void 0:s.detail)==null?void 0:a.state)==="connecting"&&(cr(),pr(null,"Switching networks\u2026"))}),window.addEventListener("xrpl-ledger",s=>{D0(s.detail),$s()&&I0(s.detail)}),(t=x("btn-network-refresh"))==null||t.addEventListener("click",()=>{oa({force:!0}),ro(!0),ia({force:!0})}),(n=document.querySelector('.dash-tab[data-tab="network"]'))==null||n.addEventListener("click",()=>{sa(),oa({force:!0}),ro(!1),ia({force:!1})});let e=x("tab-network");e&&new MutationObserver(sa).observe(e,{attributes:!0,attributeFilter:["style","class"]}),document.addEventListener("visibilitychange",sa)}function $s(){let e=x("tab-network"),t=e?e.style.display!=="none":!1;return tm&&B.currentPage==="dashboard"&&B.currentTab==="network"&&t&&!document.hidden}function sa(){$s()?h0():cr()}function sm(e){tm=!!e,sa()}function h0(){co||(oa({force:!1}),co=setInterval(()=>{$s()&&oa({force:!1})},Zy))}function cr(){clearInterval(co),co=null}async function oa({force:e=!1}={}){var n;if(!$s()&&!e)return;let t=Date.now();if(!(!e&&(t-Hu<e0||tr||t<zu))){tr=!0,Hu=t,Xe={},ju(!0);try{await Promise.allSettled([ro(!1),g0(),v0(),b0(),y0(),w0()]),x0(),T0(),C0(),P0(),R0(),pr({info:Ze,fee:jn,vals:ra}),z0()}catch(s){String((s==null?void 0:s.message)??"").toLowerCase().includes("too much load")&&(zu=Date.now()+t0,(n=ge)==null||n("Rate-limited \u2014 backing off 2 min."))}finally{ju(!1),tr=!1}}}function ju(e){var t;(t=x("btn-network-refresh"))==null||t.classList.toggle("spinning",e)}async function g0(){var n,s,a;let e=await Me({command:"server_info"});if(Ze=((n=e==null?void 0:e.result)==null?void 0:n.info)??null,!Ze)return;at("converge",Number(((s=Ze.last_close)==null?void 0:s.converge_time_s)??0)),at("proposers",Number(((a=Ze.last_close)==null?void 0:a.proposers)??0)),at("peerCounts",Number(Ze.peers??0));let t=Number(Ze.peer_disconnects_resources??0);oo!==null&&t>oo&&at("peerDiscon",t-oo),oo=t}async function v0(){var t;let e=await Me({command:"fee"});jn=(e==null?void 0:e.result)??null,((t=jn==null?void 0:jn.drops)==null?void 0:t.open_ledger_fee)!=null&&at("fees",Number(jn.drops.open_ledger_fee))}async function b0(){try{let e=await Me({command:"validators"});ra=(e==null?void 0:e.result)??null}catch{ra=null}}async function y0(){var e;try{let t=await Me({command:"peers"});zt=Array.isArray((e=t==null?void 0:t.result)==null?void 0:e.peers)?t.result.peers:null}catch{zt=null}}async function w0(){var e;try{let t=await Me({command:"feature"});(e=t==null?void 0:t.result)!=null&&e.features&&(L0(t.result.features),om(t.result.features))}catch{}}function x0(){var C,A,R,O,I,D;let e=Ze,t=ra,n=(t==null?void 0:t.trusted_validator_keys)??[],s=em(),a=u0(),o=n.length?n:s,i=a,r=Number((t==null?void 0:t.validation_quorum)??(e==null?void 0:e.validation_quorum)??0),l=o.length,c=l-r,d=l>0?r/l*100:0,u=o.filter(F=>$e.has(F)).length,p=l>0?Math.round(u/l*100):0,m=Number(((C=e==null?void 0:e.last_close)==null?void 0:C.converge_time_s)??0),f=Number(((A=e==null?void 0:e.last_close)==null?void 0:A.proposers)??0),h=r>0?Math.round(f/r*100):0,b=Array.isArray(e==null?void 0:e.negative_unl)?e.negative_unl:[],g=!!ra;c>=0&&c<=3&&(Xe.quorumTight=!0),b.length>0&&(Xe.nUnlActive=!0),m>6&&(Xe.slowConverge=!0),f>0&&r>0&&f<r&&(Xe.lowProposers=!0),J("m1-active",g?l:"\u2014"),J("m1-quorum",r>0?r:"\u2014"),J("m1-margin",g?c>=0?c:`\u2212${Math.abs(c)}`:"\u2014"),J("m1-overlap",g?`${p}%`:"\u2014"),J("m1-known",g?`${u} / ${l} identified`:"\u2014 (validators cmd unavailable)"),J("m1-proposers",((R=e==null?void 0:e.last_close)==null?void 0:R.proposers)!=null?f:"\u2014"),J("m1-particip",r>0&&((O=e==null?void 0:e.last_close)==null?void 0:O.proposers)!=null?`${h}%`:"\u2014"),J("m1-converge",((I=e==null?void 0:e.last_close)==null?void 0:I.converge_time_s)!=null?`${m.toFixed(2)}s`:"\u2014"),J("m1-converge-avg",la("converge")>0?`avg ${la("converge").toFixed(2)}s`:"\u2014"),Tt("m1-qbar",d,d>90?"bar-danger":d>80?"bar-warn":"bar-ok"),Tt("m1-obar",p,p<40?"bar-danger":p<70?"bar-warn":"bar-ok"),Tt("m1-pbar",h,h<80?"bar-danger":h<95?"bar-warn":"bar-ok"),Tt("m1-cvgbar",Math.min(100,m/10*100),m>6?"bar-danger":m>4?"bar-warn":"bar-ok"),S0({active:l,quorum:r,margin:c,nUnl:b,valsAvail:g});let v=(D=t==null?void 0:t.publisher_lists)==null?void 0:D[0],w=(wn==null?void 0:wn.ripple)??(wn==null?void 0:wn.xrplf)??null,k=(v==null?void 0:v.uri)??(w==null?void 0:w.uri)??"\u2014",$=(v==null?void 0:v.seq)??(w==null?void 0:w.seq)??"\u2014";if(J("m1-vl-uri",k),J("m1-vl-seq",$),v!=null&&v.expiration||w!=null&&w.expiration){let F=x("m1-vl-expiry");if(F){let H=(v==null?void 0:v.expiration)??(w==null?void 0:w.expiration),E=Math.floor((new Date(H)-Date.now())/864e5);F.textContent=E>0?`Expires ${E}d`:"\u26A0 EXPIRED",F.className=`expiry-pill ${E>30?"pill-ok":E>7?"pill-warn":"pill-bad"}`,F.style.display=""}}let T=x("m1-nunl-list");if(J("m1-nunl-count",b.length||"0"),T)if(!b.length)T.innerHTML='<div class="nunl-empty">\u2713 No validators on Negative UNL</div>';else{let F={};T.innerHTML=b.map(E=>{let z=ot(E);return z.provider&&(F[z.provider]=(F[z.provider]||0)+1),`<div class="nunl-entry">
        ...
        </div>`}).join("");let H=Object.entries(F).sort((E,z)=>z[1]-E[1])[0];(H==null?void 0:H[1])>1&&(T.innerHTML+=`<div class="nunl-alert">\u26A0 ${H[1]} offline validators share <b>${y(H[0])}</b> \u2014 likely provider outage</div>`)}am(o,i,r,b,g);let S=Number((Ze==null?void 0:Ze.peers)??0);J("wm-stat-val",g?`${l} validators`:`${$e.size} in registry`),J("wm-stat-nunl",`${b.length} on nUNL`),J("wm-stat-peers",`${zt?zt.length:S} peers`);let M=[...$e.keys()];A0(o,i,b,zt,!g)}function am(e,t,n,s,a){let o=x("m1-val-grid");if(!o)return;let i=new Set(e),r=new Set(t),l=new Set(s),c=em(),d=f0(),u=m0(),p=e.length?e:c,m=[...$e.keys()],f=m.filter(I=>{var D;return(((D=$e.get(I))==null?void 0:D.chain)??"main")==="main"}),h=d,b=u,g=p.filter(I=>!!ot(I).domain),v=p.filter(I=>!ot(I).domain),w=b.filter(I=>!!ot(I).domain),k=b.filter(I=>!ot(I).domain),$=m.filter(I=>!!kn(ot(I))),T=[{id:"unl",label:"UNL",count:p.length,dot:"unl"},{id:"others",label:"Others",count:b.length,dot:"other"},{id:"all",label:"All",count:f.length,dot:null},{id:"test",label:"Testnet",count:h.length,dot:null}],S={unl:"#00fff0",dunl:"#bd93f9",both:"#50fa7b",nunl:"#ff5555",other:"#ffb86c"},M='<div class="vg-tabs" role="tablist">'+T.map(I=>`<button class="vg-tab ${na===I.id?"vg-tab--active":""}" data-vgtab="${I.id}">
        ${I.dot?`<span class="vg-tab-dot" style="background:${S[I.dot]}"></span>`:""}
        ${y(I.label)}
        <span class="vg-tab-count">${I.count}</span>
      </button>`).join("")+"</div>",C=[],A="";if(na==="unl"){let I=p.filter(E=>l.has(E)),D=g.filter(E=>!l.has(E)),F=v.filter(E=>!l.has(E));I.length&&C.push({title:`\u26A0 Negative UNL (${I.length})`,keys:I,cls:"vgs-warn"}),C.push({title:`Named UNL validators \xB7 ${D.length}`,keys:D}),F.length&&C.push({title:`Key-only UNL validators \xB7 ${F.length}`,keys:F,collapsed:!0}),p.length||C.push({title:"No UNL data",keys:[],notice:"Registry not loaded yet"});let H=a?"live rippled":`registry (${xn})`;A=`${p.length} trusted \xB7 quorum ${n} \xB7 ${s.length} on nUNL \xB7 source: ${H}`}else if(na==="others")C.push({title:`Named mainnet (non-UNL) \xB7 ${w.length}`,keys:w}),k.length&&C.push({title:`Key-only mainnet \xB7 ${k.length}`,keys:k,collapsed:!0}),A=`${b.length} mainnet validators not on UNL \xB7 source: ${xn}`;else if(na==="test"){let I=h.filter(F=>!!ot(F).domain),D=h.filter(F=>!ot(F).domain);I.length&&C.push({title:`Named testnet \xB7 ${I.length}`,keys:I}),D.length&&C.push({title:`Key-only testnet \xB7 ${D.length}`,keys:D,collapsed:!0}),A=`${h.length} testnet validators`}else C.push({title:`\u2B50 UNL \xB7 ${p.length}`,keys:p}),C.push({title:`Other mainnet \xB7 ${b.length}`,keys:b,collapsed:!0}),h.length&&C.push({title:`Testnet \xB7 ${h.length}`,keys:h,collapsed:!0}),A=`${f.length} mainnet \xB7 ${h.length} testnet \xB7 ${$.length} geo-located \xB7 source: ${xn}`;function R(I,D){var xe;let F=ot(I),H=l.has(I),E=i.has(I),z=r.has(I),te=F.chain==="test",oe,pe,ie;H?(oe="vp-nunl",pe="nUNL",ie=S.nunl):E&&z?(oe="vp-both",pe="UNL+dUNL",ie=S.both):E?(oe="vp-unl",pe="UNL",ie=S.unl):z?(oe="vp-dunl",pe="dUNL",ie=S.dunl):(oe="vp-other",pe="Other",ie=S.other);let ne=kn(F),ce=!!ne,G=ne?`\u{1F4CD} ${ne.city??""}`:"",Se=F.domain?F.domain.replace(/^www\./,"").replace(/^validator\./,"").replace(/^xrp\./,""):null,X=`${I.slice(0,8)}\u2026${I.slice(-6)}`,q=E&&D!=null?`<span class="vg-num">${D+1}</span>`:"",se=(xe=F.agreement)==null?void 0:xe["24h"],me=se!=null&&se.score?`<span class="vg-agr" style="color:${parseFloat(se.score)>=99?"#50fa7b":parseFloat(se.score)>=95?"#ffb86c":"#ff5555"}" title="24h agreement">${se.score}</span>`:"";return`<div class="vpill ${oe} ${ce?"vp-locatable":""}"
    ...
    </div>`}let O="";C.forEach(I=>{if(!I.keys.length)return;let D=I.keys.some(z=>i.has(z)),F=I.keys.map((z,te)=>R(z,D?te:null)).join(""),H=`vgs-${Math.random().toString(36).slice(2,8)}`,E=!I.collapsed;O+=`
      ...
      </div>`}),O||(O='<div class="nunl-empty">No validators in this view.</div>'),o.innerHTML=M+O,J("m1-val-summary",A),o.querySelectorAll(".vg-tab").forEach(I=>{I.addEventListener("click",D=>{D.stopPropagation();let F=I.getAttribute("data-vgtab");F&&(na=F,am(e,t,n,s,a))})})}async function k0(e){let t=sr.get(e);if(t&&Date.now()-t.cachedAt<Ku)return t.data;try{let n=new AbortController,s=setTimeout(()=>n.abort(),Ju),a=await fetch(`${Gu}/${encodeURIComponent(e)}`,{signal:n.signal});if(clearTimeout(s),!a.ok)throw new Error(`HTTP ${a.status}`);let o=await a.json();return sr.set(e,{data:o,cachedAt:Date.now()}),o}catch{return null}}async function $0(e){let t=ar.get(e);if(t&&Date.now()-t.cachedAt<Ku)return t.data;try{let n=new AbortController,s=setTimeout(()=>n.abort(),Ju),a=await fetch(`${Gu}/${encodeURIComponent(e)}/reports`,{signal:n.signal});if(clearTimeout(s),!a.ok)throw new Error(`HTTP ${a.status}`);let o=await a.json(),i=o.reports??o??[];return ar.set(e,{data:i,cachedAt:Date.now()}),i}catch{return[]}}window.focusValidator=async function(e){let t=ot(e),n=kn(t);document.querySelectorAll(".vpill").forEach(o=>o.classList.remove("vp-active"));let s=document.querySelector(`.vpill[data-key="${CSS.escape(e)}"]`);if(s&&(s.classList.add("vp-active"),s.scrollIntoView({behavior:"smooth",block:"nearest"})),dr(e,t,null),k0(e).then(o=>{o&&dr(e,t,o)}),!n){let o=x("world-map-container");if(o){let i=o.querySelector(".wm-no-geo");i&&i.remove();let r=document.createElement("div");r.className="wm-no-geo",r.textContent=`\u{1F4CD} ${t.label} \u2014 geographic location unknown`,o.appendChild(r),setTimeout(()=>r.remove(),3500)}return}let a=x("world-map-container");a&&a.scrollIntoView({behavior:"smooth",block:"nearest"}),Qe&&(Qe.flyTo([n.lat,n.lng],6,{duration:1.2}),setTimeout(()=>{let o=lr[e];o&&o.openPopup()},1300))};function dr(e,t,n){var C,A,R,O,I;let s=x("amend-modal-overlay"),a=x("amend-modal-body");if(!s||!a)return;let o=n??{},i=t.label??o.label??o.account_name??e.slice(0,16)+"\u2026",r=t.domain??o.domain??null,l=t.chain??o.chain??"main",c=t.category??"other",d=De[c]??De.other,u=kn(t),p=t.unl||c==="unl"||c==="both",m=t.dunl||c==="dunl"||c==="both",f=t.domainVerified||o.domain_verified?"\u2713 Verified":r?"Unverified":"\u2014",h=t.agreement??o.agreement??{},b=!n&&!((C=t.agreement)!=null&&C["24h"]);function g(D,F){if(!F||!F.total)return`<div class="adm-mi"><span class="adm-mk">${D}</span><span class="adm-mv" style="opacity:.5">\u2014</span></div>`;let H=parseFloat(F.score)||0,E=H>=99?"color:#50fa7b":H>=95?"color:#ffb86c":"color:#ff5555";return`<div class="adm-mi">
    ...
    </div>`}function v(D,F,H=!1){return!F&&F!==0?"":`<div class="adm-mi"><span class="adm-mk">${D}</span><span class="adm-mv ${H?"mono":""}">${y(String(F))}</span></div>`}let w=ar.get(e),k=((A=w==null?void 0:w.data)==null?void 0:A.slice(-14))??[],$=k.length?`<div class="adm-section">
    ...
    <div class="adm-section">
      ...
      ${g("1-hour",h["1h"]??((R=o.agreement)==null?void 0:R["1h"]))}
      ${g("24-hour",h["24h"]??((O=o.agreement)==null?void 0:O["24h"]))}
      ${g("30-day",h["30d"]??((I=o.agreement)==null?void 0:I["30d"]))}
    </div>
    ...
    </div>`,s.style.display="flex",s.addEventListener("click",D=>{D.target===s&&window.closeAmendModal()},{once:!0})}window._loadValidatorReports=async function(e){var n;let t=ot(e);await $0(e),dr(e,t,((n=sr.get(e))==null?void 0:n.data)??null)};function S0({active:e,quorum:t,margin:n,nUnl:s,valsAvail:a}){let o=x("m1-quorum-ring");if(!o)return;if(!a||!t||!e){o.innerHTML='<div style="opacity:.4;font-size:12px;text-align:center;padding:16px">Connect to view quorum</div>';return}let i=44,r=2*Math.PI*i,l=new Set(s),c=e-s.length,d=s.length,u=Math.max(0,e-t),p=t,m=n<=0?"#ff5555":n<=3?"#ffb86c":"#50fa7b",f=e>0?c/e:0,h=e>0?d/e:0,b=e>0?t/e:0,g=e>0?Math.max(0,n)/e:0,v=e>0?d/e:0;function w(k,$,T,S=8){if($<=0)return"";let M=k*r,C=$*r;return`<circle r="${i}" cx="50" cy="50" fill="none"
    ...
    <div class="qr-wrap">
    ...
    </div>`}function T0(){var F,H,E;let e=Ze,t=(e==null?void 0:e.server_state)??"unknown",n=(e==null?void 0:e.build_version)??"\u2014",s=Number((e==null?void 0:e.uptime)??0),a=e==null?void 0:e.network_id,o=Number((e==null?void 0:e.io_latency_ms)??0),i=String((e==null?void 0:e.jq_trans_overflow)??"0"),r=Number((e==null?void 0:e.peer_disconnects_resources)??0),l=Number((e==null?void 0:e.load_factor)??1),c=Number((e==null?void 0:e.load_factor_net)??1),d=Number((e==null?void 0:e.load_factor_server)??(e==null?void 0:e.load_factor_local)??1),u=Number(((F=e==null?void 0:e.validated_ledger)==null?void 0:F.age)??0),p=(H=e==null?void 0:e.validated_ledger)==null?void 0:H.seq,m=(e==null?void 0:e.complete_ledgers)??"",f=(e==null?void 0:e.state_accounting)??null;u>10&&(Xe.staleLedger=!0),o>5&&(Xe.ioStressed=!0),la("peerDiscon")>5&&(Xe.peerChurn=!0);let h=x("m2-state");if(h){h.textContent=t;let z=["full","proposing","validating"].includes(t),te=["syncing","tracking","connected"].includes(t);h.className=`state-pill state-${z?"ok":te?"warn":"bad"}`}J("m2-version",n),J("m2-uptime",j0(s)),J("m2-netid",a===0?"0 (Mainnet)":a===1?"1 (Testnet)":a??"\u2014"),J("m2-ledger-seq",p!=null?Number(p).toLocaleString():"\u2014"),J("m2-ledger-age",u>0?`${u}s`:"< 1s"),J("m2-io-ms",o>0?`${o}ms`:"< 1ms"),J("m2-jq",i==="0"?"0 (clean)":`\u26A0 ${i}`),J("m2-discon",r.toLocaleString());let b=x("m2-ledger-age");b&&(b.className=`kv-v ${u>10?"text-danger":u>5?"text-warn":""}`);let g=Math.min(100,(l-1)/49*100);Tt("m2-load-bar",g,l>5?"bar-danger":l>2?"bar-warn":"bar-ok"),J("m2-load-total",`${l.toFixed(2)}\xD7`),J("m2-load-net",`${c.toFixed(2)}\xD7`),J("m2-load-local",`${d.toFixed(2)}\xD7`);let v=d>c*1.5?"Local node stressed":c>d*1.5?"Network-wide stress":l>1.2?"Distributed":"Normal";J("m2-load-src",v);let w=B.tpsHistory.length?B.tpsHistory[B.tpsHistory.length-1]:null;J("m2-tps",w!=null?w.toFixed(1):"\u2014"),J("m2-txcount",((E=B.ledgerLog[0])==null?void 0:E.txCount)??"\u2014");let k=m==="entire ledger"||m.startsWith("32570"),$=k?100:U0(m);if(J("m2-ledger-range",m||"\u2014"),J("m2-hist-type",k?"Full History Node":"Pruned / Partial"),J("m2-hist-score",`${$}%`),Tt("m2-hist-bar",$,$<30?"bar-danger":$<70?"bar-warn":"bar-ok"),f){let z=x("m2-state-acct");if(z){let te=["full","syncing","tracking","connected","disconnected"],oe=0,pe={};te.forEach(ie=>{var ne;pe[ie]=Number(((ne=f[ie])==null?void 0:ne.duration_us)??0),oe+=pe[ie]}),z.innerHTML=oe>0?te.map(ie=>{let ne=Math.round(pe[ie]/oe*100);return ne?`<div class="sa-row"><span class="sa-lbl">${ie}</span>
          <div class="bar-track sa-bar"><div class="bar-fill ${ie==="full"?"bar-ok":ie==="syncing"?"bar-warn":"bar-danger"}" style="width:${ne}%"></div></div>
          <span class="sa-pct">${ne}%</span></div>`:""}).join(""):'<span class="dim">No data</span>'}}let T=(e==null?void 0:e.peers)!=null?Number(e.peers):null,S=T!=null,M=0,C=0,A=!1;zt&&(zt.forEach(z=>{z.inbound===!0?M++:C++}),A=!0);let R=A&&M+C>0?Math.round(M/(M+C)*100):0,O=A?zt.length:T??0,I=O<6?"HIGH":O<15?"MEDIUM":"LOW";O<6&&(Xe.eclipseRisk=!0),R>80&&(Xe.peerSaturate=!0),J("m2-peers",S?O:"\u2014"),J("m2-inbound",A?M:S?"\u2014 (cmd restricted)":"\u2014"),J("m2-outbound",A?C:S?"\u2014 (cmd restricted)":"\u2014"),J("m2-ib-pct",A?`${R}%`:"\u2014"),Tt("m2-peer-bar",Math.min(100,O/21*100),O>18?"bar-danger":O>15?"bar-warn":"bar-ok"),Tt("m2-ib-bar",R,R>80?"bar-danger":R>60?"bar-warn":"bar-ok");let D=x("m2-eclipse");D&&(D.textContent=I,D.className=`risk-badge risk-${I.toLowerCase()}`)}function C0(){var C,A,R,O;let e=jn,t=Number(((C=e==null?void 0:e.drops)==null?void 0:C.minimum_fee)??10),n=Number(((A=e==null?void 0:e.drops)==null?void 0:A.open_ledger_fee)??10),s=Number(((R=e==null?void 0:e.drops)==null?void 0:R.median_fee)??10),a=Number(((O=e==null?void 0:e.drops)==null?void 0:O.base_fee)??10),o=Number((e==null?void 0:e.current_ledger_size)??0),i=Number((e==null?void 0:e.expected_ledger_size)??1),r=Number((e==null?void 0:e.current_queue_size)??0),l=Number((e==null?void 0:e.max_queue_size)??1),c=l>0?Math.round(r/l*100):0,d=i>0?o/i:1,u=la("fees"),p=u>0?Math.round((n-u)/u*100):0,m=Math.min(100,Math.round(Math.log2(Math.max(1,n/10))*14));n>t*10&&(Xe.feeSpike=!0),c>80&&(Xe.queuePressure=!0),d>2&&(Xe.spamLedger=!0);let f=mt.burnDrops.slice(-10),h=f.length?f.reduce((I,D)=>I+D,0)/f.length:0,b=X0(mt.burnDrops),g=la("burnDrops"),v=b>0&&mt.burnDrops.length>5?((h-g)/b).toFixed(2):"0.00",w=Math.min(100,Math.abs(Number(v))*20);Math.abs(Number(v))>3&&(Xe.burnAnomaly=!0);let k=n>5e3?"Severe":n>500?"High":n>100?"Elevated":n>20?"Normal":"Minimal",T={Severe:"#ff5555",High:"#ff9955",Elevated:"#ffb86c",Normal:"#50fa7b",Minimal:"#6272a4"}[k]??"#50fa7b",S=x("m3-pressure");S&&(S.textContent=k,S.className=`pressure-badge p-${k.toLowerCase()}`),J("m3-open",`${n} drops`),J("m3-med",`${s} drops`),J("m3-base",`${a} drops`),J("m3-devpct",`${p>0?"+":""}${p}% vs baseline`),J("m3-spam",`${m} / 100`),J("m3-qsize",`${r} / ${l}`),J("m3-qpct",`${c}%`),J("m3-szratio",`${d.toFixed(2)}\xD7`),J("m3-curledger",`${o} txs`),J("m3-expledger",`${i} expected`),J("m3-burn",h>0?`${(h/1e6).toFixed(4)} XRP / ledger`:"\u2014"),J("m3-burnz",`z = ${v}`),Tt("m3-spam-bar",m,m>70?"bar-danger":m>40?"bar-warn":"bar-ok"),Tt("m3-q-bar",c,c>80?"bar-danger":c>50?"bar-warn":"bar-ok"),Tt("m3-sz-bar",Math.min(100,d*50),d>2?"bar-danger":d>1.5?"bar-warn":"bar-ok"),Tt("m3-burn-bar",w,w>60?"bar-danger":w>30?"bar-warn":"bar-ok");let M=x("m3-congestion-summary");if(M){let I=[];d>2&&I.push({icon:"\u{1F6A8}",txt:`Ledger ${d.toFixed(1)}\xD7 normal size \u2014 possible spam burst`,col:"#ff5555"}),c>80&&I.push({icon:"\u26A0",txt:`TX queue ${c}% full \u2014 fee surge imminent`,col:"#ffb86c"}),m>70&&I.push({icon:"\u26A0",txt:`Spam index ${m}/100 \u2014 elevated DDoS risk`,col:"#ffb86c"}),Math.abs(Number(v))>3&&I.push({icon:"\u{1F4C9}",txt:`Burn rate z=${v} \u2014 resource exhaustion pattern`,col:"#ff9955"}),p>200&&I.push({icon:"\u{1F4B8}",txt:`Open fee ${p}% above baseline \u2014 network stress`,col:"#ffb86c"}),M.innerHTML=I.length?I.map(D=>`<div class="cong-line"><span>${D.icon}</span><span style="color:${D.col}">${y(D.txt)}</span></div>`).join(""):'<div class="cong-clear"><span style="color:#50fa7b">\u2713</span> No congestion signals \u2014 network traffic is normal</div>'}}function P0(){var u,p;let e={},t=0;for(let m of $e.values()){if(m.chain==="test")continue;let f=m.version??"unknown";e[f]=(e[f]??0)+1,t++}let n={},s=0;if(Array.isArray(zt))for(let m of zt){let f=(m.version??"unknown").replace(/rippled-/i,"").split(" ")[0];n[f]=(n[f]??0)+1,s++}let a=x("m4-version-dist");if(a&&t>0){let m=Object.entries(e).sort((g,v)=>v[1]-g[1]),f=((u=m[0])==null?void 0:u[0])??"?",h=t>0?Math.round((((p=m[0])==null?void 0:p[1])??0)/t*100):0,b=["#00fff0","#50fa7b","#ffb86c","#bd93f9","#ff5555","#8be9fd"];a.innerHTML=m.slice(0,6).map(([g,v],w)=>{let k=Math.round(v/t*100),$=b[w%b.length],T=g.includes("beta")||g.includes("rc")||g.includes("RC");return`<div class="vd-row">
        <div class="vd-ver-label">
          <span style="color:${$};font-weight:600">${y(g)}</span>
      ...
      </div>`}).join("")+`<div class="vd-summary">${r} geo-located \xB7 <span style="color:${g}">${b}</span> (HHI ${h.toFixed(2)})</div>`}let c={};for(let m of $e.values()){if(m.chain==="test")continue;let f=kn(m),h=m.provider??(f==null?void 0:f.org)??"Unknown",b=h.match(/AWS|Amazon/i)?"AWS":h.match(/Azure|Microsoft/i)?"Azure":h.match(/GCP|Google/i)?"GCP":h.match(/Hetzner/i)?"Hetzner":h.match(/OVH/i)?"OVH":h.match(/Cloudflare/i)?"Cloudflare":h.match(/Equinix/i)?"Equinix":h.match(/NTT/i)?"NTT":h.match(/Ripple/i)?"Ripple":"Other";c[b]=(c[b]??0)+1}let d=x("m4-provider-dist");if(d){let m=Object.values(c).reduce((f,h)=>f+h,0);if(m>0){let f=Object.entries(c).sort((b,g)=>g[1]-b[1]),h=["#ff5555","#ffb86c","#50fa7b","#00fff0","#bd93f9","#8be9fd","#6272a4"];d.innerHTML=f.slice(0,7).map(([b,g],v)=>{let w=Math.round(g/m*100),k=h[v%h.length],$=w>33?"\u26A0 ":"";return`<div class="vd-row">
      ...
      ${l.length?`<div class="ap-near-bar">\u{1F4C8} ${l.length} amendment${l.length>1?"s":""} approaching 80% threshold</div>`:""}`,n.querySelectorAll(".ap-tab").forEach(u=>{u.onclick=()=>{xs=u.dataset.aptab,om(e)}})}let c=xs==="active"?a:xs==="vetoed"?i:xs==="all"?s.sort((d,u)=>d.enabled!==u.enabled?d.enabled?1:-1:d.vetoed!==u.vetoed?d.vetoed?1:-1:(u.count??0)-(d.count??0)):o;if(!c.length){t.innerHTML=`<div class="amend-empty">${xs==="vetoed"?"No vetoed amendments":"No data"}</div>`;return}t.innerHTML=c.map(d=>{var S;let u=d.count??0,p=d.threshold??28,m=Math.min(100,Math.round(u/p*100)),f=d.name??`${d.hash.slice(0,10)}...`,h=!!d.enabled,b=!!d.vetoed,g=!!d.majority,v=Yu[f]??{},w=(S=mt.amendMomentum)==null?void 0:S[d.hash],k="";if(g&&!h&&d.majority){let M=Date.now()-new Date(d.majority).getTime(),C=M>0?Math.floor(M/864e5):0,A=Math.max(0,14-C),R=Math.min(100,Math.round(C/14*100));k=`<div class="ap-countdown">
      ...
      </div>`}let $=h?"#50fa7b":b?"#ff5555":g?"#ffb86c":m>=80?"#8be9fd":"rgba(255,255,255,.3)",T=h?"Active":b?"Vetoed":g?"Majority":m>=80?"Near":"Voting";return`<div class="ap-row" onclick="window.showAmendDetail('${y(d.hash)}')">
      <div class="ap-row-main">
        ...
        ${h?`<div class="ap-active-note">\u2713 Running on all ledgers${v.intro?" \xB7 since "+v.intro:""}</div>`:`<div class="ap-vote-row">
          <div class="ap-vote-track">
            <div class="ap-vote-fill" style="width:${m}%;background:${$};opacity:${h?1:.75}"></div>
    ...
    </div>`}).join("")}function L0(e){rr={},Object.entries(e).forEach(([t,n])=>{rr[t]={hash:t,...n}})}window.showAmendDetail=function(e){let t=rr[e];if(!t)return;let n=t.name||`${e.slice(0,16)}...`,s=Yu[n]||{},a=t.count??0,o=t.threshold??28,i=Math.min(100,Math.round(a/o*100)),r=t.enabled?"Active on Ledger":t.vetoed?"Vetoed":t.majority?"Majority Reached":"Voting in Progress",l=t.enabled?"adm-s-ok":t.vetoed?"adm-s-bad":t.majority?"adm-s-warn":"adm-s-info",c=t.enabled?"bar-ok":t.vetoed?"bar-danger":t.majority?"bar-warn":"bar-info",d=t.majority&&!t.enabled?`
    ...
    <div class="adm-footer">
      ...
      <a class="adm-link" href="https://xrpl.org/consensus.html" target="_blank" rel="noopener noreferrer">Consensus Docs</a>
    </div>`,u.style.display="flex",u.addEventListener("click",m=>{m.target===u&&window.closeAmendModal()},{once:!0}))};window.closeAmendModal=function(){let e=x("amend-modal-overlay");e&&(e.style.display="none")};function M0(e){if(window.L){e();return}if(!document.querySelector("#leaflet-css")){let n=document.createElement("link");n.id="leaflet-css",n.rel="stylesheet",n.href="https://cdnjs.cloudflare.com/ajax/libs/leaflet/1.9.4/leaflet.min.css",document.head.appendChild(n)}let t=document.createElement("script");t.src="https://cdnjs.cloudflare.com/ajax/libs/leaflet/1.9.4/leaflet.min.js",t.onload=e,document.head.appendChild(t)}function A0(e,t,n,s,a=!1){x("world-map-container")&&M0(()=>E0(e,t,n,s,a))}function E0(e,t,n,s,a=!1){let o=x("world-map-container");if(!o)return;let i=new Set(n||[]),r=new Set(e||[]),l=new Set(t||[]),c=B.currentNetwork||"xrpl-mainnet";if(Qe&&io!==c&&(Qe.remove(),Qe=null,Zt=[],io=null),!Qe){o.innerHTML="";let k=document.createElement("div");k.id="wm-leaflet",k.style.cssText="width:100%;height:440px;",o.appendChild(k),Qe=L.map("wm-leaflet",{center:[25,5],zoom:2,minZoom:1,maxZoom:12,zoomControl:!0,attributionControl:!0,worldCopyJump:!0}),L.tileLayer("https://{s}.basemaps.cartocdn.com/dark_all/{z}/{x}/{y}{r}.png",{attribution:'&copy; <a href="https://carto.com">CARTO</a> &copy; <a href="https://openstreetmap.org">OSM</a>',subdomains:"abcd",maxZoom:19}).addTo(Qe),io=c}Zt.forEach(k=>{try{k.remove()}catch{}}),Zt=[];function d(k){return i.has(k)?"nunl":r.has(k)&&l.has(k)?"both":r.has(k)?"unl":l.has(k)?"dunl":"other"}lr={};let u={};for(let[k,$]of $e){let T=kn($);if(!(T!=null&&T.lat)||!(T!=null&&T.lng))continue;let S=`${(Math.round(T.lat*2)/2).toFixed(1)},${(Math.round(T.lng*2)/2).toFixed(1)}`;u[S]||(u[S]={lat:T.lat,lng:T.lng,keys:[],city:T.city,org:T.org}),u[S].keys.push(k)}if(Object.values(u).forEach(k=>{let $=k.keys.length,T=k.keys.map(d),S=["nunl","both","unl","dunl","other"].find(O=>T.includes(O))||"other",M=De[S],C=$>5?13:$>2?10:7,A=L.divIcon({html:`<div class="wm-lmarker wm-lmarker-val ${S==="nunl"?"wm-lmarker-nunl":""} ${a?"wm-lmarker-ref":""}"
      ...
      </div>`,className:"",iconSize:[(C+8)*2,(C+8)*2],iconAnchor:[C+8,C+8]}),R=L.marker([k.lat,k.lng],{icon:A}).bindPopup(N0(k.keys,k.city,k.org,i,r,l,a),{maxWidth:380,className:"wm-popup-wrap"}).addTo(Qe);k.keys.forEach(O=>{lr[O]=R}),Zt.push(R)}),a){let k=L.control({position:"bottomleft"});k.onAdd=()=>{let $=L.DomUtil.create("div","wm-ref-banner");return $.innerHTML="\u{1F4E1} Reference positions \xB7 live validator list unavailable from endpoint",$},k.addTo(Qe),Zt.push(k)}let p=[...$e.keys()].filter(k=>{var T;return((T=$e.get(k).geo)==null?void 0:T.lat)!=null||po[k]}).length,m=$e.size-p;if(m>0){let k=L.control({position:"bottomright"});k.onAdd=()=>{let $=L.DomUtil.create("div","wm-unknown-ctrl");return $.innerHTML=`+ ${m} validators \xB7 location unknown`,$},k.addTo(Qe),Zt.push(k)}d0.forEach(k=>{let $=L.divIcon({html:`<div class="wm-lmarker wm-lmarker-pub">
        <div class="wm-lring"></div>
        ...
        </div>`,{maxWidth:260,className:"wm-popup-wrap"}).addTo(Qe);Zt.push(T)});let f=Array.isArray(s)?s:[],h=f.filter(k=>k.inbound===!0).length,b=f.length-h,g=f.length>0?`${f.length} peers (${h}\u2193 ${b}\u2191)`:`${Number((Ze==null?void 0:Ze.peers)??0)} peers`,v=L.control({position:"topleft"});v.onAdd=()=>{let k=L.DomUtil.create("div","wm-legend-ctrl");return k.innerHTML=`
      <div class="wm-leg-row"><span class="wm-leg-dot" style="background:${De.unl.hex};box-shadow:0 0 5px ${De.unl.glow}"></span>UNL Validator</div>
      <div class="wm-leg-row"><span class="wm-leg-dot" style="background:${De.dunl.hex};box-shadow:0 0 5px ${De.dunl.glow}"></span>dUNL only</div>
      <div class="wm-leg-row"><span class="wm-leg-dot" style="background:${De.both.hex};box-shadow:0 0 5px ${De.both.glow}"></span>UNL + dUNL</div>
      <div class="wm-leg-row"><span class="wm-leg-dot" style="background:${De.other.hex};box-shadow:0 0 5px ${De.other.glow}"></span>Other validator</div>
      <div class="wm-leg-row"><span class="wm-leg-dot" style="background:${De.nunl.hex};box-shadow:0 0 5px ${De.nunl.glow}"></span>Negative UNL</div>
      <div class="wm-leg-row"><span class="wm-leg-dot" style="background:${De.pub.hex};box-shadow:0 0 5px ${De.pub.glow}"></span>Public Node</div>
      ...
      </div>`,k},v.addTo(Qe),Zt.push(v);let w=Zt.filter(k=>k&&typeof k.getLatLng=="function");if(w.length>=2)try{let k=L.latLngBounds(w.map($=>$.getLatLng()));k.isValid()&&Qe.fitBounds(k.pad(.15),{maxZoom:6})}catch{}try{window.dispatchEvent(new CustomEvent("nalulf-network-map",{detail:{map:Qe,networkId:io}}))}catch{}}function N0(e,t,n,s,a,o,i=!1){let r=e.length>1,l=e.map(d=>{let u=ot(d),p=s.has(d),m=a.has(d),f=o.has(d),h=d.slice(0,20)+"...",b,g;return p?(b=De.nunl.hex,g="Negative UNL"):m&&f?(b=De.both.hex,g="UNL + dUNL"):m?(b=De.unl.hex,g="UNL"):f?(b=De.dunl.hex,g="dUNL"):(b=De.other.hex,g="Other"),`<div class="wm-popup-val-row">
    ...
    <div class="wm-popup-vals">${l}</div>
      ...
      <div>
        ...
        <div class="adv-clear-sub">All ${Object.keys(en).length} threat indicators are nominal</div>
      </div>
    </div>`;else{let r=e.filter(u=>{var p;return(((p=en[u])==null?void 0:p.w)??1)>=3}),l=e.filter(u=>{var p;return(((p=en[u])==null?void 0:p.w)??1)===2}),c=e.filter(u=>{var p;return(((p=en[u])==null?void 0:p.w)??1)===1}),d=(u,p,m)=>p.length===0?"":`
      <div class="adv-group-title" style="color:${m}">${u} (${p.length})</div>
      ${p.map(f=>{let h=en[f]??{w:1,label:f},b=h.label.split(" \u2014 "),g=b[0],v=b[1]||"";return`<div class="adv-sig-card adv-sig-${h.w>=3?"critical":h.w>=2?"elevated":"monitor"}">
      ...
      <span class="hcs-total">of ${i.length} checks</span>`);let u={consensus:"Consensus Health",infra:"Node Infrastructure",ledger:"Ledger & Fees"};t.innerHTML=Object.entries(u).map(([p,m])=>{let f=i.filter(w=>w.group===p),h=f.map(w=>{let k=w.result.status,$=k==="ok"?"hc-ok":k==="watch"?"hc-warn":"hc-fail",T="\u25CF";return`<div class="hc-item ${$}">
    ...
    </div>`}).join("")}function D0(e){var t,n,s,a,o,i,r,l,c,d;e&&(at("burnDrops",(e.avgFee||0)*1e6*(e.txPerLedger??0)),at("dexOffers",((t=e.txTypes)==null?void 0:t.OfferCreate)??0),at("ammSwaps",(((n=e.txTypes)==null?void 0:n.AMMDeposit)??0)+(((s=e.txTypes)==null?void 0:s.AMMWithdraw)??0)+(((a=e.txTypes)==null?void 0:a.AMMBid)??0)),at("newAccounts",((o=e.txTypes)==null?void 0:o.AccountSet)??0),at("txPayment",((i=e.txTypes)==null?void 0:i.Payment)??0),at("txNFT",(((r=e.txTypes)==null?void 0:r.NFTokenMint)??0)+(((l=e.txTypes)==null?void 0:l.NFTokenBurn)??0)+(((c=e.txTypes)==null?void 0:c.NFTokenCreateOffer)??0)+(((d=e.txTypes)==null?void 0:d.NFTokenAcceptOffer)??0)),at("txLedger",e.txPerLedger??0),at("tps",e.tps??(e.txPerLedger??0)/3.5),at("closeTime",e.closeTime??3.5))}function I0(e){let t=B.tpsHistory.length?B.tpsHistory[B.tpsHistory.length-1]:null;J("m2-tps",t!=null?t.toFixed(1):"\u2014"),J("m2-txcount",e.txPerLedger??"\u2014"),e.successRate!=null&&J("m2-success",`${e.successRate.toFixed(0)}%`)}async function ia({force:e=!1}={}){if(!$s()&&!e)return;let t=Date.now();if(!e&&t-Uu<s0)return;Uu=t;let n=x("latency-list");if(!n)return;let s=Er[B.currentNetwork]??[],a=++nr;n.innerHTML=s.map((i,r)=>`
  ...
  `,document.body.appendChild(e),e.addEventListener("click",t=>{t.target===e&&ca()}),document.addEventListener("keydown",t=>{t.key==="Escape"&&e.classList.contains("show")&&ca()})}function Y0(e){let t=q0[e];if(!t)return;J0();let n=document.getElementById("learnModalOverlay"),s=document.getElementById("learnModalTitle"),a=document.getElementById("learnModalSub"),o=document.getElementById("learnModalBody"),i=document.getElementById("learnModalLinks"),r=document.getElementById("learnModalCtas");!n||!s||!a||!o||!i||!r||(s.textContent=t.title,a.textContent=t.subtitle||"",o.innerHTML=(t.sections||[]).map(l=>`
  ...
  `).join(""),n.classList.add("show"),document.body.classList.add("modal-open"))}function ca(){var e;(e=document.getElementById("learnModalOverlay"))==null||e.classList.remove("show"),document.body.classList.remove("modal-open")}function Q0(e){var t,n,s;if(e==="modal:close")return ca();if(e==="auth:signup"){ca(),(t=window.openAuth)==null||t.call(window,"signup");return}if(e==="auth:login"){ca(),(n=window.openAuth)==null||n.call(window,"login");return}if(e.startsWith("topic:"))return Y0(e.split(":")[1]);if(e.startsWith("scroll:")){let a=e.split(":")[1];(s=document.getElementById(a))==null||s.scrollIntoView({behavior:"smooth",block:"start"})}}function Z0(){im||(im=!0,document.addEventListener("click",e=>{var s,a;let t=(a=(s=e.target).closest)==null?void 0:a.call(s,"[data-action]");if(!t)return;let n=t.getAttribute("data-action")||"";n&&(e.preventDefault(),Q0(n))}))}function rm(){var l,c,d,u,p;Z0(),(l=document.querySelector(".landing-features"))==null||l.setAttribute("id","learn"),(c=document.querySelector(".landing-simple-value"))==null||c.setAttribute("id","use-cases"),(d=document.querySelector(".landing-cta"))==null||d.setAttribute("id","about"),(u=document.querySelector(".landing-tagline"))==null||u.classList.add("tagline-pill");let e=document.querySelector(".landing-stats-strip");e&&(e.classList.add("landing-learn-strip"),e.innerHTML=V0.map(m=>`
    ...
    `).join(""));let t=x("features-grid");t&&(t.innerHTML=G0.map(m=>`
    ...
    `).join(""));let n=document.querySelector(".landing-simple-value"),s=n==null?void 0:n.querySelector("h2");s&&(s.textContent="What you can do with NaluLF");let a=x("value-grid");a&&(a.innerHTML=K0.map(m=>`
    ...
    `)}function lm(){let e=new IntersectionObserver(t=>t.forEach(n=>{n.isIntersecting&&n.target.classList.add("visible")}),{threshold:.12});document.querySelectorAll(".reveal").forEach(t=>e.observe(t))}function cm(){let e=document.getElementById("particle-canvas");if(!e)return;let t=e.getContext("2d"),n,s,a=[],o=80,i=120;function r(){n=e.width=window.innerWidth,s=e.height=window.innerHeight}function l(){return{x:Math.random()*n,y:Math.random()*s,vx:(Math.random()-.5)*.4,vy:(Math.random()-.5)*.4,r:Math.random()*1.5+.5,alpha:Math.random()*.5+.1}}function c(){r(),a=Array.from({length:o},l)}function d(){return getComputedStyle(document.body).getPropertyValue("--accent-secondary").trim()||"#ffd700"}function u(){t.clearRect(0,0,n,s);let h=d();for(let b=0;b<a.length;b++)for(let g=b+1;g<a.length;g++){let v=a[b].x-a[g].x,w=a[b].y-a[g].y,k=Math.sqrt(v*v+w*w);k<i&&(t.beginPath(),t.moveTo(a[b].x,a[b].y),t.lineTo(a[g].x,a[g].y),t.strokeStyle=`rgba(255,255,255,${(1-k/i)*.06})`,t.lineWidth=1,t.stroke())}a.forEach(b=>{t.beginPath(),t.arc(b.x,b.y,b.r,0,Math.PI*2),t.fillStyle=`rgba(255,255,255,${b.alpha*.6})`,t.fill()})}function p(){a.forEach(h=>{h.x+=h.vx,h.y+=h.vy,(h.x<0||h.x>n)&&(h.vx*=-1),(h.y<0||h.y>s)&&(h.vy*=-1)})}let m;function f(){p(),u(),m=requestAnimationFrame(f)}c(),f(),document.addEventListener("visibilitychange",()=>{document.hidden?(m&&cancelAnimationFrame(m),m=null):!m&&B.currentPage==="landing"&&f()}),window.addEventListener("naluxrp:pagechange",h=>{var b;((b=h==null?void 0:h.detail)==null?void 0:b.pageId)!=="landing"?(m&&cancelAnimationFrame(m),m=null):m||f()}),window.addEventListener("resize",()=>{r(),a.forEach(h=>{h.x=Math.min(h.x,n),h.y=Math.min(h.y,s)})}),e.style.cssText=`
    position: fixed; inset: 0;
    width: 100%; height: 100%;
    pointer-events: none;
    z-index: 0; opacity: 0.4;
  `}function Ss(e){var t;(t=window.showProfile)==null||t.call(window),setTimeout(()=>e==null?void 0:e(),250)}var hr=[{label:"\u{1F30A} Live Stream",hint:"Dashboard \u2192 Stream tab",action:()=>Mn(document.querySelector('[data-tab="stream"]'),"stream")},{label:"\u{1F50D} Inspector",hint:"Dashboard \u2192 Inspector tab",action:()=>Mn(document.querySelector('[data-tab="inspector"]'),"inspector")},{label:"\u{1F4E1} Network Health",hint:"Dashboard \u2192 Network tab",action:()=>Mn(document.querySelector('[data-tab="network"]'),"network")},{label:"\u{1F464} Profile",hint:"View your profile",action:()=>{var e;return(e=window.showProfile)==null?void 0:e.call(window)}},{label:"\u{1F48E} Wallets",hint:"Profile \u2192 Wallets",action:()=>Ss(()=>{var e;return(e=window.switchProfileTab)==null?void 0:e.call(window,"wallets")})},{label:"\u{1F4CA} Portfolio Analytics",hint:"Profile \u2192 Balance history, heatmap, flow",action:()=>Ss(()=>{var e;return(e=window.switchProfileTab)==null?void 0:e.call(window,"analytics")})},{label:"\u{1F517} Social Links",hint:"Profile \u2192 Connect Discord, X, GitHub\u2026",action:()=>Ss(()=>{var e;return(e=window.switchProfileTab)==null?void 0:e.call(window,"social")})},{label:"\u{1F4DC} Activity Log",hint:"Profile \u2192 Recent account activity",action:()=>Ss(()=>{var e;return(e=window.switchProfileTab)==null?void 0:e.call(window,"activity")})},{label:"\u2699\uFE0F Settings",hint:"Profile \u2192 Preferences & AI Explanations",action:()=>Ss(()=>{var e;return(e=window.switchProfileTab)==null?void 0:e.call(window,"settings")})},{label:"\u{1F52C} Analyze a Project",hint:"Liquidity depth, holder/LP concentration, issuer risk",action:()=>Ss(()=>{var e;return(e=window.jumpToProjectIntelLookup)==null?void 0:e.call(window)})},{label:"\u{1F9ED} Replay App Tour",hint:"Retake the onboarding walkthrough",action:()=>{var e;(e=window.showDashboard)==null||e.call(window),setTimeout(()=>{var t;return(t=window.startTour)==null?void 0:t.call(window)},300)}},{label:"\u2753 Help & Glossary",hint:"Search app features and on-chain terms",action:()=>{var e;return(e=window.openHelp)==null?void 0:e.call(window)}},{label:"\u{1F511} Sign In",hint:"Open auth",action:()=>{var e;return(e=window._openAuth)==null?void 0:e.call(window,"login")}},{label:"\u2728 Sign Up",hint:"Create account",action:()=>{var e;return(e=window._openAuth)==null?void 0:e.call(window,"signup")}},{label:"\u{1F3E0} Landing Page",hint:"Go home",action:()=>{var e;return(e=window._goHome)==null?void 0:e.call(window)}},{label:"\u{1F3A8} Cycle Theme",hint:"gold \u2192 cosmic \u2192 starry \u2192",action:()=>{var e;return(e=window._cycleTheme)==null?void 0:e.call(window)}}];function ew(e){let t=e.trim();return Be(t)?[{label:`\u{1F50D} Inspect ${t.slice(0,8)}\u2026${t.slice(-6)}`,hint:"Run the full account inspection on this address",action:()=>{Mn(document.querySelector('[data-tab="inspector"]'),"inspector"),setTimeout(()=>{var s;let n=document.getElementById("inspect-addr");n&&(n.value=t),(s=window.runInspect)==null||s.call(window)},200)}}]:[]}var qn=0,uo=[...hr];function mo(e=""){let t=x("cmdkOverlay"),n=x("cmdkInput");!t||!n||(t.classList.add("show"),n.value=e||"",um(e),n.focus())}function Ts(){var e;(e=x("cmdkOverlay"))==null||e.classList.remove("show")}function pm(){let e=x("cmdkOverlay"),t=x("cmdkInput");!e||!t||(t.addEventListener("input",()=>um(t.value)),t.addEventListener("keydown",n=>{n.key==="ArrowDown"&&(n.preventDefault(),dm(1)),n.key==="ArrowUp"&&(n.preventDefault(),dm(-1)),n.key==="Enter"&&(n.preventDefault(),tw()),n.key==="Escape"&&Ts()}),e.addEventListener("click",n=>{n.target===e&&Ts()}))}function um(e=""){let t=x("cmdkList");if(!t)return;let n=e.toLowerCase().trim(),s=ew(e);uo=n?[...s,...hr.filter(a=>a.label.toLowerCase().includes(n)||a.hint.toLowerCase().includes(n))]:[...s,...hr],qn=0,t.innerHTML=uo.length?uo.map((a,o)=>`
        <button class="cmdk-item${o===0?" is-active":""}" data-index="${o}">
          <span class="cmdk-label">${y(a.label)}</span>
          <span class="cmdk-hint2">${y(a.hint)}</span>
        </button>`).join(""):'<div class="cmdk-section-label">No results</div>',t.querySelectorAll(".cmdk-item").forEach(a=>{a.addEventListener("click",()=>mm(Number(a.dataset.index)))})}function dm(e){var n,s,a;let t=Oe("#cmdkList .cmdk-item");t.length&&((n=t[qn])==null||n.classList.remove("is-active"),qn=(qn+e+t.length)%t.length,(s=t[qn])==null||s.classList.add("is-active"),(a=t[qn])==null||a.scrollIntoView({block:"nearest"}))}function mm(e){let t=uo[e];t&&(Ts(),t.action())}function tw(){mm(qn)}var fo=!1;function gr(){let e=B.currentPage,t=B.currentTab,n=e==="dashboard"&&t==="stream",s=e==="dashboard"&&t==="inspector",a=e==="dashboard"&&t==="network";Jp(n),vu(s),sm(a)}function fm(){fo||(Kp(),gu(),nm(),zl(),gr(),fo=!0)}window.openAuth=e=>No(e);window.closeAuth=()=>on();window.showAuthView=e=>an(e);window.authKeydown=e=>sl(e);window.submitSignIn=()=>_o();window.submitSignUp=()=>Do();window.refreshCaptcha=()=>Ur();window.showForgotView=()=>Gr();window.forgotRestoreFromFile=()=>Kr();window.forgotWipeConfirm=()=>Jr();window.forgotWipeExecute=()=>Yr();window.forgotBackToOptions=()=>Qr();window.submitSyncImport=()=>Io();window.exportVaultSyncCode=()=>Zr();window.syncImportFromFile=()=>el();window.signupNext=()=>Ro();window.signupBack=()=>zr();window.logout=()=>tl();window.goHome=()=>Pn();window.showLandingPage=()=>Pn();window.showDashboard=()=>Ln();window.showProfile=()=>xo();window.switchTab=(e,t)=>Mn(e,t);window.runInspect=()=>ys();window.closeCommandPalette=()=>Ts();window.openCmdk=()=>mo();window.setTheme=e=>Cn(e);window.cycleTheme=()=>yo();window.measureLatency=()=>ia();window.switchProfileTab=e=>ii(e);window.openProfileEditor=()=>Ed();window.closeProfileEditor=()=>Bs();window.saveProfileEditor=()=>Nd();window.selectAvatar=e=>Rd(e);window.selectBanner=e=>_d(e);window.uploadAvatarImage=e=>Dd(e);window.removeAvatarImage=()=>Id();window.uploadBannerImage=e=>Fd(e);window.removeBannerImage=()=>Od();window.prefSetTheme=e=>sp(e);window.setPrefCurrency=e=>ap(e);window.setPrefNetwork=e=>op(e);window.setPrefAutoLock=e=>ip(e);window.openPublicProfilePreview=()=>np();window.exportVaultBackup=()=>Bd();window.logActivity=(e,t)=>kt(e,t);window.toggleWalletDrawer=e=>Cd(e);window.switchWalletDrawerTab=(e,t)=>Pd(e,t);window.cancelOffer=(e,t,n)=>Md(e,t,n);window.fetchBalance=e=>Fn(e);window.setActiveWallet=e=>ql(e);window.openImportAddressModal=()=>Jd();window.closeImportAddressModal=()=>wi();window.importWatchOnlyWallet=()=>Yd();window.openImportSeedModal=()=>Qd();window.closeImportSeedModal=()=>xi();window.executeImportFromSeed=()=>Zd();window.openTokenDetailsModal=(e,t,n)=>ep(e,t,n);window.closeTokenDetailsModal=()=>tp();window.refreshXrplDashboard=()=>es();window.refreshMarketData=()=>fd();window.refreshNftGallery=()=>hd();window.refreshAmmPools=()=>gd();window.refreshPoolExplorer=()=>vd();window.loadCustomAmmPool=()=>ic();window.sendNft=e=>bd(e);window.toggleSeedBackupStatus=()=>vc();window.setDexPair=e=>bc(e);window.setDexInterval=e=>yc(e);window.setDexChartType=e=>wc(e);window.refreshDexChart=()=>xc();window.setComparePair=e=>Dc(e);window.toggleIndicator=(e,t)=>kc(e,t);window.toggleTerminalTheme=()=>Vc();window.toggleChartFullscreen=()=>Gc();window.exportChartPng=()=>Kc();window.saveChartLayoutPreset=()=>Yc();window.loadChartLayoutPreset=()=>Qc();window.setIndicatorFromDropdown=e=>Ic(e);window.toggleIndicatorMenu=()=>$c();window.toggleChartMoreMenu=()=>Sc();window.setIndicatorQuery=e=>Tc(e);window.addIndicatorFromMenu=e=>Cc(e);window.removeIndicator=e=>Pc(e);window.openIndicatorSettings=e=>Lc(e);window.closeIndicatorSettings=()=>Mc();window.applyIndicatorSettings=e=>Ac(e);window.resetIndicatorSettings=e=>Ec(e);window.copyChartLink=()=>Nc();window.toggleThreeEffects=()=>Rc();window.setThreeEffects=e=>_c(e);window.setDrawingTool=e=>Fc(e);window.clearAllDrawings=()=>Xc();window.addPriceAlert=()=>Oc();window.removePriceAlert=e=>Bc(e);window.zoomChartIn=()=>Hc();window.zoomChartOut=()=>zc();window.panChartLeft=()=>Uc();window.panChartRight=()=>jc();window.toggleEducationPanel=()=>Wc();window.selectEducationTab=e=>qc(e);window.searchTokens=e=>td(e);window.lookupIssuedAsset=()=>mi();window.lookupAndAnalyzeProject=()=>ud();window.addTokenToWatchlist=e=>ld(e);window.removeTokenFromWatchlist=e=>cd(e);window.openTokenOnChart=e=>Da(e);window.loadToken=e=>dd(e);window.refreshTokenDiscovery=()=>pd();window.refreshRecentTransactions=()=>md();window.setTokenFilter=(e,t)=>nd(e,t);window.clearTokenFilters=()=>sd();window.selectTokenDetails=e=>rd(e);window.openProjectIntel=e=>ci(e);window.jumpToProjectIntelLookup=()=>Gl();window.toggleProjectIntelSubScore=e=>Kl(e);window.copyProjectIntelForAi=()=>ec();window.closeProjectIntel=()=>Jl();window.showMoreIssuedTokens=()=>ad();window.showAllIssuedTokens=()=>od();window.resetIssuedTokenLimit=()=>id();window.openWalletCreator=()=>bi();window.closeWalletCreator=()=>Xs();window.wizardNext=()=>Xd();window.wizardBack=()=>Hd();window.selectAlgo=e=>zd(e);window.selectWalletEmoji=e=>Ud(e);window.selectWalletColor=e=>jd(e);window.toggleSecurityCheck=e=>Wd(e);window.revealSeed=()=>Vd();window.copySeed=()=>Gd();window.copyAddress=()=>Kd();window.copyToClipboard=e=>Hs(e);window.deleteWallet=e=>Sd(e);window.inspectWalletAddr=e=>Td(e);window.openSocialModal=e=>wd(e);window.closeSocialModal=()=>as();window.saveSocialModal=()=>xd();window.deleteSocial=()=>kd();window.viewSocial=e=>$d(e);window.connectXRPL=()=>import("./xrpl-6AERZ5KD.js").then(({connectXRPL:e})=>e());window._openAuth=No;window._goHome=Pn;window._cycleTheme=yo;window._showProfile=xo;window.startTour=()=>So();window.tourNext=()=>Br();window.tourPrev=()=>Xr();window.tourSkip=()=>fa();window.openHelp=()=>rp();window.closeHelp=()=>Oa();window.filterHelp=e=>$i(e);document.addEventListener("DOMContentLoaded",()=>{var e;console.log("\u{1F30A} NaluLF: booting\u2026"),Rr(),Pn(),rm(),lm(),cm(),pm(),lp(),nw(),window.addEventListener("naluxrp:pagechange",t=>{var s;let n=(s=t==null?void 0:t.detail)==null?void 0:s.pageId;(n==="dashboard"||n==="inspector"||n==="profile")&&fm(),fo&&gr()}),window.addEventListener("naluxrp:tabchange",()=>{fo&&gr()}),document.addEventListener("keydown",t=>{var s;let n=["INPUT","TEXTAREA"].includes((s=document.activeElement)==null?void 0:s.tagName);if((t.ctrlKey||t.metaKey)&&t.key==="k"){t.preventDefault(),mo();return}if(t.key==="/"&&!n){t.preventDefault(),mo();return}t.key==="Escape"&&(Ts(),on(),Bs(),Xs(),as(),fa(),Oa())}),(e=document.getElementById("auth-overlay"))==null||e.addEventListener("click",t=>{t.target===t.currentTarget&&on()}),nl()&&(fm(),Ln(),import("./xrpl-6AERZ5KD.js").then(({connectXRPL:t})=>t())),console.log("\u2705 NaluLF: ready")});function nw(){gm(),setInterval(()=>{document.hidden||gm()},3e4)}async function hm(e){let t=[s=>`https://corsproxy.io/?${encodeURIComponent(s)}`,s=>`https://api.allorigins.win/raw?url=${encodeURIComponent(s)}`],n=async s=>{let a=typeof(AbortSignal==null?void 0:AbortSignal.timeout)=="function"?AbortSignal.timeout(7e3):void 0,o=await fetch(s,{mode:"cors",cache:"no-store",signal:a});if(!o.ok)throw new Error(`HTTP ${o.status}`);return await o.json()};try{return await n(e)}catch{for(let s of t)try{return await n(s(e))}catch{}throw new Error("Price feed unreachable")}}async function gm(){try{let e=await hm("https://api.exchange.coinbase.com/products/XRP-USD/ticker"),t=await hm("https://api.exchange.coinbase.com/products/XRP-USD/candles?granularity=86400");if(e!=null&&e.price){let n=Number(e.price),s=Array.isArray(t)&&t.length?t[0]:null,a=s?Number(s[3]||n):n,o=a?(n-a)/a*100:0,i=document.getElementById("xrpPrice"),r=document.getElementById("xrpChange");if(i&&(i.textContent=`$${Number(n).toFixed(3)}`),r){let l=o>=0;r.textContent=`${l?"+":""}${Number(o).toFixed(2)}%`,r.className=`xrp-price-change ${Math.abs(o)<.1?"flat":l?"up":"down"}`}}}catch{}}
