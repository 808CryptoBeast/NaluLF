import{a as Dr,b as bo,c as Tn,d as Dt,e as w,f as Xe,g as y,h as He,i as _,j as z,k as Q,l as Z,m as vt,n as ge,o as ne,p as he,q as Wt,r as X,s as ma,v as Ee,w as Ir}from"./chunk-R7KFE7J7.js";function Cn(e){Tn.includes(e)||(e="gold"),X.currentTheme=e,Tn.forEach(t=>document.body.classList.remove(`theme-${t}`)),document.body.classList.add(`theme-${e}`),Z(bo,e)}function yo(){let e=Tn.indexOf(X.currentTheme);Cn(Tn[(e+1)%Tn.length])}function Fr(){let e=Q(bo);Cn(Tn.includes(e)?e:"gold")}var Or={landing:"landing-page",dashboard:"dashboard",inspector:"inspector",profile:"dashboard"};function wo(e){document.body.classList.remove("modal-open"),Object.values(Or).forEach(i=>document.body.classList.remove(i)),document.body.classList.add(Or[e]||"dashboard");let t=w("landing"),n=w("dashboard"),s=w("profile-page");t&&(t.style.display=e==="landing"?"":"none"),n&&(n.style.display=e==="dashboard"?"":"none"),s&&(s.style.display=e==="profile"?"":"none");let a=e==="landing",o={landingActions:w("navbar-landing-actions"),dashActions:w("navbar-dash-actions"),navConn:w("navbar-conn"),cmdkHint:w("cmdk-hint"),helpBtn:w("help-trigger")};o.landingActions&&(o.landingActions.style.display=a?"":"none"),o.dashActions&&(o.dashActions.style.display=a?"none":""),o.navConn&&(o.navConn.style.display=a?"none":""),o.cmdkHint&&(o.cmdkHint.style.display=a?"none":""),o.helpBtn&&(o.helpBtn.style.display=a?"none":""),X.currentPage=e,window.scrollTo({top:0,behavior:"smooth"}),window.dispatchEvent(new CustomEvent("naluxrp:pagechange",{detail:{pageId:e}}))}function Pn(){wo("landing")}function Mn(){wo("dashboard")}function xo(){wo("profile")}function Ln(e,t){Xe(".dash-tab").forEach(n=>{n.classList.toggle("active",n===e),n.setAttribute("aria-selected",String(n===e))}),["stream","inspector","network"].forEach(n=>{let s=w(`tab-${n}`);s&&(s.style.display=n===t?"":"none")}),t==="inspector"?(document.body.classList.remove("dashboard"),document.body.classList.add("inspector")):(document.body.classList.remove("inspector"),document.body.classList.add("dashboard")),X.currentTab=t,window.dispatchEvent(new CustomEvent("naluxrp:tabchange",{detail:{tabId:t}}))}var Xr="naluxrp_tour_seen",an=[{title:"Welcome to NaluLF \u{1F30A}",body:"A 20-second tour of the three things people miss most. Skip anytime."},{selector:"#cmdk-hint",title:"Jump anywhere, instantly",body:"Press <kbd>Ctrl</kbd>+<kbd>K</kbd> (or <kbd>/</kbd>) from any page. Paste an address in and it offers to inspect it directly \u2014 no need to navigate first."},{selector:"#dash-tab-inspector",title:"Inspect any wallet",body:"Full forensic suite \u2014 trust lines, fund flow, convergence signals, AI-assisted explanations \u2014 for any XRPL address, not just your own."},{selector:".user-chip",title:"Your Profile has more than wallets",body:"Portfolio analytics, activity history, and Project Intelligence \u2014 liquidity depth, holder concentration, and issuer-risk scoring for any token \u2014 all live there."}],st=0,$o=!1,Cs=null,It=null;function Hr(){Q(Xr)||setTimeout(So,700)}function So(){$o||($o=!0,st=0,$m(),To())}function $m(){if(w("tourOverlay"))return;let e=document.createElement("div");e.id="tourOverlay",e.className="tour-overlay",e.innerHTML='<div class="tour-card" id="tour-card"></div>',document.body.appendChild(e),e.addEventListener("click",t=>{t.target===e&&fa()})}function ko(e){if(!e)return null;let t=document.querySelector(e);if(!t)return null;let n=t.getBoundingClientRect();return n.width>0||n.height>0?t:null}function zr(){Cs==null||Cs.classList.remove("tour-highlight"),Cs=null}function To(){for(;st<an.length&&an[st].selector&&!ko(an[st].selector);)st++;if(st>=an.length)return Co();let e=an[st],t=w("tourOverlay"),n=w("tour-card");t.classList.add("show"),zr();let s=ko(e.selector);s&&(s.scrollIntoView({block:"center",behavior:"smooth"}),s.classList.add("tour-highlight"),Cs=s),n.innerHTML=`
  ...
  </div>`}function hf(){document.addEventListener("keydown",e=>{if(e.key==="Escape")for(let t of["profile-editor-modal","wallet-creator-overlay","social-modal","send-modal-overlay","receive-modal-overlay","trustline-modal-overlay","import-address-modal","import-seed-modal","token-details-modal","pub-profile-overlay"]){let n=w(t)||document.getElementById(t);if(n!=null&&n.classList.contains("show")||(n==null?void 0:n.style.display)==="flex"){n.classList.remove("show"),n.style.display==="flex"&&(n.style.display="none");return}}e.key==="k"&&(e.ctrlKey||e.metaKey)&&(e.preventDefault(),bi())})}function Vo(){var t,n;let e=ge(Q(Nl));e&&Object.assign(ce,e),Ke=ge(Q(Rl))||{},oe=ge(Q(El))||[],Fl=ge(Q(Bm))||{},M.alerts=ge(Q(Wl))||[],dt=Q(Es)||((t=oe[0])==null?void 0:t.id)||null,!ce.displayName&&((n=X.session)!=null&&n.name)&&(ce.displayName=X.session.name,ce.handle=X.session.name.toLowerCase().replace(/\s+/g,"_"),Vl())}function Vl(){Z(Nl,JSON.stringify(ce))}function Rs(){Z(El,JSON.stringify(oe))}function Gl(){Z(Rl,JSON.stringify(Ke))}function ri(){Z(Wl,JSON.stringify(M.alerts||[]))}function kt(e,t){let n=ge(Q(Uo))||[];n.unshift({type:e,detail:t,ts:Date.now()}),n.length>yl&&(n.length=yl),Z(Uo,JSON.stringify(n))}function gf(){return ge(Q(Uo))||[]}function Kl(e){let t=(Date.now()-e)/1e3;return t<60?"just now":t<3600?`${Math.floor(t/60)}m ago`:t<86400?`${Math.floor(t/3600)}h ago`:`${Math.floor(t/86400)}d ago`}function Et(){return oe.find(e=>e.id===dt)||oe[0]||null}function Jl(e){oe.find(t=>t.id===e)&&(dt=e,Z(Es,e),$t(),Ot(),window.dispatchEvent(new CustomEvent("naluxrp:active-wallet-changed",{detail:Et()})),ne("Active wallet switched"))}window.addEventListener("naluxrp:active-wallet-changed",e=>{let t=e.detail;if(!t)return;let n=w("inspect-addr");n&&!n.value&&(n.value=t.address),X.activeWalletAddress=t.address});function Ot(){var o;let e=w("active-wallet-bar");if(!e)return;let t=Et();if(!t){e.innerHTML='<div class="awb-empty">No wallet \u2014 <button class="awb-link" onclick="openWalletCreator()">create one</button></div>';return}let n=Ze[t.address],s=n?_(n.xrp,2)+" XRP":"\u2014 XRP",a=(o=n==null?void 0:n.tokens)!=null&&o.length?`\xB7 ${n.tokens.length} token${n.tokens.length>1?"s":""}`:"";e.innerHTML=`
    <div class="awb-left">
    ...
    </div>`}function j(){var h,v;let e=document.querySelector("#profile-page .profile-wrap");if(!e)return;let t=document.getElementById("xpd-tv-widget"),n=!!(t&&ee.chart);t&&t.remove();let s=document.getElementById("xpd-chart-atmosphere"),a=!!(s&&Ge.renderer);s&&s.remove();let o=Et(),i=(o==null?void 0:o.address)||"",r=vf(),l=localStorage.getItem(pn),c=oe.some(x=>!x.watchOnly),p=Q(jo)==="1",u=(h=Ze[i])==null?void 0:h.xrp,d=Object.values(Ze).reduce((x,k)=>x+((k==null?void 0:k.xrp)||0),0),m=(v=Te.data)!=null&&v.priceUsd?d*Te.data.priceUsd:0,f=In.map(x=>`<option value="${y(x.id)}" ${M.pair===x.id?"selected":""}>${y(x.label)}</option>`).join(""),g=In.map(x=>`<option value="${y(x.id)}" ${M.comparePair===x.id?"selected":""}>${y(x.label)}</option>`).join(""),b=Ul.map(x=>`<option value="${y(x.value)}" ${M.interval===x.value?"selected":""}>${y(x.label)}</option>`).join("");if(e.innerHTML=`
              ...
              <div class="xpd-chart-toolbar">
                ...
                <div class="xpd-toolbar-group">
                  ...
                  <select class="xpd-input" onchange="setDrawingTool(this.value)">
                    ${jl.map(x=>`<option value="${x.key}" ${M.drawingTool===x.key?"selected":""}>Draw: ${x.label}</option>`).join("")}
                  </select>
    ...
    <div class="xpd-indicator-menu-wrap">
      ...
      ${M.indicatorMenuOpen?`
        <div class="xpd-indicator-menu" role="menu" aria-label="Indicator menu">
          ...
          ${t.map(n=>{let s=(of[n.key]||[]).filter(a=>{var i;return e?(((i=qt[a])==null?void 0:i.name)||a).toLowerCase().includes(e):!0});return s.length?`
    ...
    <p class="xpd-note">Professional chart controls: wheel zoom, hold-and-drag pan, horizontal price-line marking, and token-focused context ribbons for faster execution decisions.</p>`}function wf(){let e=M.selectedIndicator||"sma20",t=qt[e]||qt.sma20,n=rf[e]||null,s=M.educationCollapsed;return`
    <div class="xpd-edu-panel ${s?"collapsed":""}">
      ...
      ${s?"":`
        ...
        `:""}
      `}
    </div>`}function ct(e,t){return`<div class="xpd-edu-row"><span class="xpd-edu-label">${y(e)}</span><span class="xpd-edu-value">${y(t)}</span></div>`}function xf(){if(Te.loading)return'<div class="xpd-loading">Loading XRP market snapshot...</div>';if(Te.error)return`<div class="xpd-error">${y(Te.error)}</div>`;let e=Te.data;if(!e)return'<div class="xpd-empty">Market data is not available yet.</div>';let t=e.change24h>=0;return`
    <div class="xpd-market-grid">
      ...
      <article class="xpd-stat-card">
        ...
        <strong class="xpd-stat-value">$${je(e.volume24h)}</strong>
      </article>
      <article class="xpd-stat-card">
        <span class="xpd-stat-label">Market Cap</span>
        <strong class="xpd-stat-value">$${je(e.marketCap)}</strong>
      </article>
    </div>
    ...
    <p class="xpd-note">Top XRPL token cards are static examples when direct DEX market-cap feeds are unavailable.</p>`}function kf(e){return e?bt.loading?'<div class="xpd-loading">Loading account NFTs...</div>':bt.error?`<div class="xpd-error">${y(bt.error)}</div>`:bt.items.length?`<div class="xpd-nft-grid">${bt.items.map($f).join("")}</div>`:'<div class="xpd-empty">No NFTs found for this wallet.</div>':'<div class="xpd-empty">Select or create a wallet to load NFTs.</div>'}function $f(e){let t=`${e.id.slice(0,12)}...${e.id.slice(-10)}`;return`<article class="xpd-nft-card">
  ...
  </article>`}function Sf(e){let t=Nf(e),n=Rf(),s=_f();return`<div class="xpd-amm-columns">${t}${n}${s}</div>`}function li(){return(ge(Q(Hl))||[]).filter(Boolean)}function Yl(e){let t=[...new Set((e||[]).filter(Boolean))];Z(Hl,JSON.stringify(t))}function Tf(e,t){return t.has(e)?t.get(e):U.tokens.find(s=>s.symbol===e)||null}function Cf(){let e=U.query||"",t=li(),n=U.filtered,s=Math.max(120,Number(U.listLimit||240)),a=n.slice(0,s),o=U.trending.slice(0,14),i=new Map(U.tokens.map(c=>[qe(c),c])),r=i.get(U.selectedTokenKey)||null,l=U.filters||{type:"all",minCap:0,minVol:0,hasDex:!1};return`
    <div class="xpd-token-grid">
      <div class="xpd-token-col">
        <div class="xpd-search-row">
          ...
          <div class="xpd-note">Loaded ${je(U.total||n.length)} issued tokens \xB7 showing ${je(a.length)} of ${je(n.length)}${U.lastSyncAt?` \xB7 synced ${new Date(U.lastSyncAt).toLocaleTimeString()}`:""}</div>
        ...
        <div class="xpd-token-list">${a.map(c=>{let p=qe(c),u=Ps(p),d=String(e||"").trim();return`
          <div class="xpd-token-row xpd-token-row--clickable" title="${y(`${c.symbol} ${c.name}`)}" onclick="openTokenOnChart(decodeURIComponent('${u}'))">
            <div class="xpd-token-main">
              <strong>${$l(c.symbol,d)}</strong>
              <span>${$l(c.name,d)}</span>
              ${c.issuer?`<span class="mono xpd-pill-text">${y(c.issuer)}</span>`:""}
            </div>
            <div class="xpd-token-actions">
              <span>${c.price!=null?`$${_(c.price,6)}`:"\u2014"}</span>
              ${Number.isFinite(c.holders)?`<span title="Holders">${je(c.holders)} holders</span>`:""}
      ...
      <div class="xpd-token-col">
        ${r?`<div class="xpd-token-detail-card">
          ...
          <div class="pool-meta">Price: ${r.price!=null?`$${_(r.price,6)}`:"\u2014"} \xB7 24h Vol: ${r.volume24h!=null?`$${je(r.volume24h)}`:"\u2014"}</div>
          <div class="pool-meta">Market Cap: ${r.marketCap!=null?`$${je(r.marketCap)}`:"\u2014"} \xB7 Holders: ${r.holders!=null?je(r.holders):"\u2014"}</div>
          <div class="xpd-row-actions">
            <button class="xpd-mini-btn" onclick="openTokenOnChart(decodeURIComponent('${Ps(qe(r))}'))">Switch Main Chart</button>
            ${r.issuer?`<button class="xpd-mini-btn" onclick="window.open('https://xrpscan.com/account/${y(r.issuer)}','_blank')">View Issuer</button>`:""}
            ${r.issuer?`<button class="xpd-mini-btn xpd-mini-btn--accent" onclick="openProjectIntel(decodeURIComponent('${Ps(qe(r))}'))">\u{1F52C} Project Strength</button>`:""}
          </div>
        </div>`:""}
        <h3>Watchlist</h3>
        <div class="xpd-watchlist">${t.length?t.map(c=>{let p=Tf(c,i),u=p?`${p.symbol} \xB7 ${p.name}`:c,d=(p==null?void 0:p.price)!=null?`$${_(p.price,6)}`:"\u2014",m=Ps(c);return`<div class="xpd-token-row xpd-token-row--clickable" onclick="openTokenOnChart(decodeURIComponent('${m}'))"><span>${y(u)}</span><div class="xpd-token-actions"><span>${d}</span><button class="xpd-mini-btn" onclick="event.stopPropagation(); openTokenOnChart(decodeURIComponent('${m}'))">Chart</button><button class="xpd-mini-btn" onclick="event.stopPropagation(); removeTokenFromWatchlist(decodeURIComponent('${m}'))">Remove</button></div></div>`}).join(""):'<div class="xpd-empty">No watchlist tokens yet.</div>'}</div>
        <h3>Trending</h3>
        <div class="xpd-watchlist">${o.length?o.map(c=>`<div class="xpd-token-row xpd-token-row--clickable" onclick="openTokenOnChart(decodeURIComponent('${Ps(qe(c))}'))"><span>${y(c.symbol)} \xB7 ${y(c.name)}</span><span>${c.volume24h!=null?`$${je(c.volume24h)} vol`:c.marketCap!=null?`$${je(c.marketCap)} mcap`:"\u2014"}</span></div>`).join(""):'<div class="xpd-empty">No trending data.</div>'}</div>
      </div>
    </div>`}function Ql(){let e=document.getElementById("xpd-lookup-currency");if(!e){he("Token Discovery hasn't loaded yet \u2014 give it a moment and try again.");return}e.scrollIntoView({behavior:"smooth",block:"center"}),setTimeout(()=>e.focus(),350)}async function ci(e){let t=String(e||"").trim();if(!t)return;let n=t.includes("|")?U.tokens.find(s=>qe(s)===t):U.tokens.find(s=>String(s.symbol||"").toUpperCase()===t.toUpperCase());if(!(n!=null&&n.issuer)){he("Project Intelligence needs a token with a known issuer.");return}Qe={loading:!0,error:"",data:null,tokenKey:qe(n),expandedSubScore:""},j(),setTimeout(()=>{var s;return(s=document.getElementById("xpd-project-intel-section"))==null?void 0:s.scrollIntoView({behavior:"smooth",block:"start"})},30);try{Qe={loading:!1,error:"",data:await fl(n),tokenKey:qe(n),expandedSubScore:""}}catch(s){Qe={loading:!1,error:(s==null?void 0:s.message)||"Could not load project intelligence.",data:null,tokenKey:qe(n),expandedSubScore:""}}j()}function Zl(e){Qe.expandedSubScore=Qe.expandedSubScore===e?"":e,j()}function ec(){Qe={loading:!1,error:"",data:null,tokenKey:"",expandedSubScore:""},j()}var tc={liquidity:{label:"Liquidity",icon:"\u{1F4A7}"},distribution:{label:"Distribution",icon:"\u{1F9EE}"},marketQuality:{label:"Market Quality",icon:"\u{1F4CA}"},lpStability:{label:"LP Stability",icon:"\u{1F3E6}"},issuerRisk:{label:"Issuer Risk",icon:"\u{1F6E1}"}};function Ho(e){return e>=75?"#50fa7b":e>=50?"#f1fa8c":e>=25?"#ffb86c":"#ff5555"}function nc(e){return e>=75?"STRONG":e>=50?"MODERATE":e>=25?"WEAK":"VERY WEAK"}function Pf(){if(Qe.loading)return`<div class="xpd-section-head"><h2>\u{1F52C} Project Intelligence</h2></div>
      ...
      <div class="xpd-error">${y(Qe.error)}</div>`;let e=Qe.data;if(!e)return"";let t=e.strength,n=Ho(t.overall),s=t.dimensionsLive.map(a=>{let o=tc[a],i=t.subScores[a],r=Qe.expandedSubScore===a;return`
      <div class="pi-subscore ${r?"pi-subscore--open":""}" onclick="toggleProjectIntelSubScore('${a}')">
        ...
        ${r?`<div class="pi-subscore-detail">${Object.entries(i.inputs).map(([l,c])=>`
          <div class="pi-kv"><span>${y(di(l))}</span><span class="mono">${y(sc(c))}</span></div>
        `).join("")}</div>`:""}
      </div>`}).join("");return`
    <div class="xpd-section-head">
    ...
    <div class="pi-header-card">
      ...
      <div class="pi-score-word" style="color:${n}">${nc(t.overall)}</div>
    ...
    <div class="pi-cards-grid">
      ${Mf(e)}
      ${wl("Holder Concentration",e.holders,"\u{1F465}")}
      ${wl("LP Token Concentration",e.lp,"\u{1F3E6}")}
      ${Lf(e.issuerRisk)}
    </div>`}function di(e){return e.replace(/([A-Z])/g," $1").replace(/^./,t=>t.toUpperCase()).trim()}function sc(e){return e==null?"\u2014":typeof e=="boolean"?e?"Yes":"No":typeof e=="number"?Number.isInteger(e)?String(e):_(e,2):String(e)}function Mf(e){var i;let t=e.amm,n=e.orderBook,s=t!=null&&t.exists?`
  ...
  `:'<div class="inspect-empty-note">No AMM pool found for this pair.</div>',a=(r,l)=>r!=null&&r.length?`
    ...
    ${r.map(c=>`<tr><td>${c.pct}%</td><td class="mono">${_(c.xrpAtOffer,1)}</td><td class="mono">${je(c.tokenAtOffer)}${c.bookExhausted?' <span title="Visible order book fully consumed before reaching this price-impact level \u2014 real depth may be less than shown, book is thin.">\u26A0</span>':""}</td></tr>`).join("")}
  ...
  `:'<div class="inspect-empty-note">No live order book found for this pair.</div>';return`
    <div class="sec-card pi-card">
      ...
      <hr class="pi-hr" />
      ${o}
    </div>`}function wl(e,t,n){if(!(t!=null&&t.exists))return`
    <div class="sec-card pi-card">
    ...
    <div class="pi-holder-row">
      ...
      <span class="mono">${je(a.balance)}</span>
      <span class="mono pi-holder-pct">${t.totalSampled>0?_(a.balance/t.totalSampled*100,1):"0.0"}%</span>
    </div>`).join("");return`
    <div class="sec-card pi-card">
      <div class="sec-card-hdr"><span class="sec-card-icon">${n}</span><div><div class="sec-card-title">${y(e)}</div><div class="sec-card-sub">${je(t.holderCount)} holders${t.sampleOnly?" (sampled, capped)":""}</div></div></div>
    ...
    </div>`}function ac(){let e=Qe.data;e&&Ia(Af(e))}function xl(e,t){if(!(e!=null&&e.length))return"";let n=e.map(s=>`    ${s.pct}% impact: ${_(s.xrpAtOffer,1)} XRP / ${je(s.tokenAtOffer)} tokens${s.bookExhausted?" (book exhausted before this level \u2014 real depth may be less than shown)":""}`).join(`
`);return`  ${t}:
${n}`}function kl(e,t){let n=[`${e}:`];return t!=null&&t.exists?(n.push(`  Holder count: ${t.holderCount}${t.sampleOnly?" (sampled, capped)":""}`),n.push(`  Top 1 holds: ${_(t.top1Pct,1)}%`),n.push(`  Top 5 hold: ${_(t.top5Pct,1)}%`),n.push(`  Top 10 hold: ${_(t.top10Pct,1)}%`),(t.topHolders||[]).slice(0,10).forEach((s,a)=>{let o=t.totalSampled>0?_(s.balance/t.totalSampled*100,2):"0.00";n.push(`    #${a+1} ${s.address}: ${je(s.balance)} (${o}%)`)}),n.join(`
`)):(n.push("  No data found."),n.join(`
`))}function Af(e){var i;let t=e.strength,n=e.amm,s=e.orderBook,a=e.issuerRisk,o=[];if(o.push(`XRPL TOKEN ANALYSIS \u2014 ${e.token.symbol}${e.token.name?` (${e.token.name})`:""}`),o.push(`Issuer: ${e.token.issuer}`),o.push(`Currency code: ${e.token.currency}`),o.push(`Snapshot taken: ${new Date(e.fetchedAt).toISOString()}`),o.push(""),o.push(`OVERALL STRENGTH SCORE: ${t.overall}/100 (${nc(t.overall)})`),o.push("Methodology note: this score covers only 5 point-in-time-computable dimensions (Liquidity, Distribution, Market Quality, LP Stability, Issuer Risk). Network Activity, Treasury Health, and Project Transparency are NOT included \u2014 they would require historical tracking this tool does not do."),o.push(""),o.push("SUB-SCORES:"),t.dimensionsLive.forEach(r=>{let l=tc[r],c=t.subScores[r];o.push(`- ${l.label}: ${c.score}/100`),Object.entries(c.inputs||{}).forEach(([p,u])=>{o.push(`    ${di(p)}: ${sc(u)}`)})}),o.push(""),o.push("LIQUIDITY \u2014 AMM POOL:"),n!=null&&n.exists?(o.push(`  XRP reserve: ${_(n.xrpReserve,2)}`),o.push(`  Token reserve: ${_(n.tokenReserve,2)}`),o.push(`  LP token supply: ${_(n.lpSupply,2)}`),o.push(`  Trading fee: ${_(n.tradingFeePct,3)}%`),n.auctionSlot&&o.push(`  Auction slot discounted fee: ${_(n.auctionSlot.discountedFeePct,3)}%`),(i=n.voteSlots)!=null&&i.length&&o.push(`  Fee-vote participants: ${n.voteSlots.length}`)):o.push("  No AMM pool found for this pair."),o.push(""),o.push("LIQUIDITY \u2014 LIVE ORDER BOOK (DEX):"),s!=null&&s.exists){o.push(`  Buy price: ${_(s.buyPriceXrp,6)} XRP`),o.push(`  Sell price: ${_(s.sellPriceXrp,6)} XRP`),o.push(`  Spread: ${s.spreadPct!=null?_(s.spreadPct,2)+"%":"\u2014"}`);let r=xl(s.buyDepth,"Depth buying with XRP"),l=xl(s.sellDepth,"Depth selling for XRP");r&&o.push(r),l&&o.push(l)}else o.push("  No live order book found for this pair.");return o.push(""),o.push(kl("HOLDER CONCENTRATION",e.holders)),o.push(""),o.push(kl("LP TOKEN CONCENTRATION",e.lp)),o.push(""),o.push("ISSUER RISK FLAGS:"),a!=null&&a.exists?(o.push(`  Clawback enabled: ${a.clawbackEnabled?"YES":"No"} \u2014 ${xt.clawbackEnabled}`),o.push(`  Global freeze active: ${a.globalFreeze?"YES":"No"} \u2014 ${xt.globalFreeze}`),o.push(`  Freeze-capable: ${a.freezeCapable?"YES":"No"} \u2014 ${xt.freezeCapable}`),o.push(`  Requires auth to hold: ${a.requireAuth?"YES":"No"} \u2014 ${xt.requireAuth}`),o.push(`  Issuer blackholed: ${a.blackholed?"YES":"No"} \u2014 ${xt.blackholed}`)):o.push("  Could not load issuer account state."),o.push(""),o.push("---"),o.push("Please analyze this XRPL token's on-chain data above. Explain in plain language what these metrics suggest about the token's liquidity health, holder/LP concentration risk, and issuer-side control risk. Point out anything that looks like a red flag or an unusually strong/weak signal, and note any limits in what this data can and can't tell me (e.g. it's a point-in-time snapshot, not history)."),o.join(`
`)}function $l(e,t){let n=String(e||""),s=String(t||"").trim();if(!s)return y(n);let a=n.toLowerCase().indexOf(s.toLowerCase());if(a<0)return y(n);let o=y(n.slice(0,a)),i=y(n.slice(a,a+s.length)),r=y(n.slice(a+s.length));return`${o}<mark class="xpd-hit">${i}</mark>${r}`}function Ef(e){var a,o;let t=Object.values(Ze).reduce((i,r)=>i+((r==null?void 0:r.xrp)||0),0),n=(a=Te.data)!=null&&a.priceUsd?t*Te.data.priceUsd:0,s=Pt.items.slice(0,8);return`
    <div class="xpd-token-grid">
      <div class="xpd-token-col">
        <div class="xpd-market-grid">
    ...
    </div>`}function Nf(e){return e?yt.loading?'<div class="xpd-amm-card"><h3>Your liquidity positions</h3><div class="xpd-loading">Loading account_objects and LP balances...</div></div>':yt.error?`<div class="xpd-amm-card"><h3>Your liquidity positions</h3><div class="xpd-error">${y(yt.error)}</div></div>`:yt.pools.length?`<div class="xpd-amm-card"><h3>Your liquidity positions</h3><div class="xpd-pool-list">${yt.pools.map(t=>`
    ...
    </div>`).join("")}</div></div>`:'<div class="xpd-amm-card"><h3>Your liquidity positions</h3><div class="xpd-empty">No AMM entries or LP-token balances detected for this wallet yet.</div></div>':'<div class="xpd-amm-card"><h3>Your liquidity positions</h3><div class="xpd-empty">No active wallet.</div></div>'}function Rf(){return Mt.loading?'<div class="xpd-amm-card"><h3>General pool explorer</h3><div class="xpd-loading">Loading amm_info for known pools...</div></div>':Mt.error?`<div class="xpd-amm-card"><h3>General pool explorer</h3><div class="xpd-error">${y(Mt.error)}</div></div>`:Mt.pools.length?`<div class="xpd-amm-card"><h3>General pool explorer</h3><div class="xpd-pool-list">${Mt.pools.map(e=>`
    <div class="xpd-pool-item">
    ...
    </div>`).join("")}</div></div>`:'<div class="xpd-amm-card"><h3>General pool explorer</h3><div class="xpd-empty">No seeded pools returned on this network.</div></div>'}function _f(){return`<div class="xpd-amm-card">
  ...
  </div>`}function je(e){return Number.isFinite(Number(e))?new Intl.NumberFormat("en-US",{notation:"compact",maximumFractionDigits:2}).format(Number(e)):"\u2014"}function ns(e){return typeof e=="string"?`${_(Number(e)/1e6,4)} XRP`:e&&typeof e=="object"?`${_(Number(e.value||0),4)} ${e.currency||"UNK"}`:"\u2014"}function Df(e){if(!e||typeof e!="string")return"";try{let t=e.trim();if(!/^[0-9A-Fa-f]+$/.test(t)||t.length%2!==0)return t;let n=new Uint8Array(t.length/2);for(let s=0;s<t.length;s+=2)n[s/2]=parseInt(t.slice(s,s+2),16);return new TextDecoder().decode(n)}catch{return""}}function Sl(e){return e?e.startsWith("ipfs://")?`https://ipfs.io/ipfs/${e.slice(7)}`:e.startsWith("ar://")?`https://arweave.net/${e.slice(5)}`:e:""}async function If(e){let t=Sl(Df(e.URI||e.uri||""));if(!t)return"";if(/\.(png|jpg|jpeg|gif|webp|svg)$/i.test(t))return t;try{let n=await fetch(t,{method:"GET"});if(!n.ok)return"";let s=await n.json(),a=(s==null?void 0:s.image)||(s==null?void 0:s.image_url)||(s==null?void 0:s.thumbnail);return Sl(a||"")}catch{return""}}async function Lt(e,{timeoutMs:t=9e3,allowProxy:n=!0}={}){let s=async a=>{let o=typeof(AbortSignal==null?void 0:AbortSignal.timeout)=="function"?AbortSignal.timeout(t):void 0,i=await fetch(a,{method:"GET",mode:"cors",cache:"no-store",signal:o});if(!i.ok)throw new Error(`HTTP ${i.status}`);return await i.json()};try{return await s(e)}catch(a){if(!n)throw a;for(let o of zm)try{return await s(o(e))}catch{}throw a}}async function oc(){var e;Te.loading=!0,Te.error="",j();try{let t=await Lt("https://api.exchange.coinbase.com/products/XRP-USD/ticker"),n=await Lt("https://api.exchange.coinbase.com/products/XRP-USD/candles?granularity=86400"),s=Array.isArray(n)&&n.length?n[0]:null,a=Number((t==null?void 0:t.price)||0),o=s?Number(s[3]||0):a,i=s?Number(s[2]||a):a,r=s?Number(s[1]||a):a,l=s?Number(s[5]||0):0;Te.data={priceUsd:a,change24h:o?(a-o)/o*100:0,volume24h:l*a,marketCap:Number(((e=Te.data)==null?void 0:e.marketCap)||0),high24h:i,low24h:r}}catch(t){Te.error=(t==null?void 0:t.message)||"Could not load market data right now.",Te.data=null}finally{Te.loading=!1,j()}}async function ic(e){if(bt.loading=!0,bt.error="",bt.items=[],j(),!e){bt.loading=!1,j();return}try{let t,n=[];do{let a=await at({method:"account_nfts",params:[{account:e,limit:100,...t?{marker:t}:{}}]});n.push(...(a==null?void 0:a.account_nfts)||[]),t=a==null?void 0:a.marker}while(t);let s=await Promise.all(n.slice(0,80).map(async a=>({id:a.NFTokenID||a.nf_token_id||"Unknown",image:await If(a)})));bt.items=s}catch(t){bt.error=(t==null?void 0:t.message)||"Could not load NFTs for this wallet."}finally{bt.loading=!1,j()}}async function rc(e){if(yt.loading=!0,yt.error="",yt.pools=[],j(),!e){yt.loading=!1,j();return}try{let t=[],n;do{let o=await at({method:"account_objects",params:[{account:e,type:"amm",limit:200,...n?{marker:n}:{}}]});((o==null?void 0:o.account_objects)||[]).forEach(r=>{let l=ns(r.Asset||r.amount),c=ns(r.Asset2||r.amount2),p=l.split(" ").pop()||"AssetA",u=c.split(" ").pop()||"AssetB";t.push({pair:`${p}/${u}`,lpBalance:r.LPTokenBalance?ns(r.LPTokenBalance):"Not reported",estimatedValue:"Estimate unavailable",tradingFee:r.TradingFee!=null?`${r.TradingFee} bps`:"\u2014",tvl:"Unavailable"})}),n=o==null?void 0:o.marker}while(n);let s=await at({method:"account_lines",params:[{account:e,limit:200}]});((s==null?void 0:s.lines)||[]).filter(o=>typeof o.currency=="string"&&o.currency.length>=16&&Number(o.balance)>0).forEach(o=>{t.push({pair:`LP Token ${o.currency.slice(0,8)}...`,lpBalance:`${_(Number(o.balance),4)} ${o.currency.slice(0,8)}...`,estimatedValue:"Estimate unavailable",tradingFee:"\u2014",tvl:"Unavailable"})}),yt.pools=t}catch(t){yt.error=(t==null?void 0:t.message)||"Could not load account AMM objects."}finally{yt.loading=!1,j()}}async function lc(e){try{let t=await at({method:"amm_info",params:[{asset:e.asset,asset2:e.asset2}]}),n=t==null?void 0:t.amm;return n?{label:e.label,reserveA:ns(n.amount),reserveB:ns(n.amount2),tradingFee:String(n.trading_fee??"\u2014"),totalLp:ns(n.lp_token||n.lp_token_balance),tvl:Ff(n.amount,n.amount2)}:null}catch{return null}}function Ff(e,t){let n=a=>typeof a=="string"?Number(a)/1e6:a&&typeof a=="object"?Number(a.value||0):0,s=n(e)+n(t);return!Number.isFinite(s)||s<=0?"Unavailable":`${_(s,4)} (asset units)`}async function cc(){Mt.loading=!0,Mt.error="",j();try{let e=await Promise.all(cf.map(lc));Mt.pools=e.filter(Boolean)}catch(e){Mt.error=(e==null?void 0:e.message)||"Could not load AMM explorer data.",Mt.pools=[]}finally{Mt.loading=!1,j()}}async function dc(){var r,l,c,p;let e=(((r=document.getElementById("xpd-asset1-currency"))==null?void 0:r.value)||"").trim().toUpperCase(),t=(((l=document.getElementById("xpd-asset1-issuer"))==null?void 0:l.value)||"").trim(),n=(((c=document.getElementById("xpd-asset2-currency"))==null?void 0:c.value)||"").trim().toUpperCase(),s=(((p=document.getElementById("xpd-asset2-issuer"))==null?void 0:p.value)||"").trim();if(!e||!n){Fe.error="Enter both asset currency codes first.",j();return}let a=e==="XRP"?{currency:"XRP"}:{currency:e,issuer:t},o=n==="XRP"?{currency:"XRP"}:{currency:n,issuer:s};if(e!=="XRP"&&!t||n!=="XRP"&&!s){Fe.error="Issuer is required for non-XRP assets.",j();return}Fe.loading=!0,Fe.error="",Fe.pool=null,j();let i=await lc({label:`${e}/${n}`,asset:a,asset2:o});Fe.loading=!1,i?Fe.pool=i:Fe.error="Pool not found or unavailable on this network.",j()}function Ea(){return In.find(e=>e.id===M.pair)||In[0]}function pi(e){if(e==="D")return 1440;if(e==="W")return 10080;if(e==="M")return 43200;let t=Number(e);return Number.isFinite(t)&&t>0?t:60}function Of(e){if(e==="M")return"W";if(e==="D"||e==="W")return e;let t=pi(e);for(let n of[5,15,60,240])if(t<=n)return String(n);return"D"}async function Bf(e,t,n,s=200){var p;let a=t?`${e}.${t}`:e,o=Of(n),i=Math.min(2e3,Math.max(20,Number(s)||200)),r=`https://api.onthedex.live/public/v1/ohlc?base=${encodeURIComponent(a)}&quote=XRP&interval=${o}&bars=${i}`,l=await Lt(r,{timeoutMs:1e4});return(Array.isArray((p=l==null?void 0:l.data)==null?void 0:p.ohlc)?l.data.ohlc:[]).map(u=>({time:Number(u.t),open:Number(u.o),high:Number(u.h),low:Number(u.l),close:Number(u.c),volume:Number(u.vb||0)})).filter(u=>Number.isFinite(u.time)&&[u.open,u.high,u.low,u.close].every(Number.isFinite)).sort((u,d)=>u.time-d.time)}function pc(e){return{xrpusd:"XRP-USD",XRPUSDT:"XRP-USD",ETHUSDT:"ETH-USD",BTCUSDT:"BTC-USD",SOLUSDT:"SOL-USD"}[e]||null}function Xf(e){return{XRP:"XRP-USD",BTC:"BTC-USD",ETH:"ETH-USD",SOL:"SOL-USD",USDC:"USDC-USD"}[String(e||"").toUpperCase()]||null}var zo=new Map;async function Hf(e,t){if(!e)return null;let n=`${qe(e)}:${t}`,s=zo.get(n);if(s)return s;let a=zf(e,t);zo.set(n,a);try{return await a}finally{zo.delete(n)}}async function zf(e,t){var o,i;let n=String(e.symbol||"").toUpperCase();if(!n||n==="XRP")return null;let s=Xf(n);if(s)try{let r=fc(t),l=r===86400?Bl:Xl,{candles:c,reachedStart:p}=await Yo(s,r,l);if(c.length){let u=p?`${new Date(c[0].time*1e3).getUTCFullYear()}\u2013present`:`last ${c.length} bars`;return{candles:c,source:`Coinbase direct (${s}, ${u})`,mode:"token-direct"}}}catch{}let a=String(e.issuer||"").trim();if(a)try{let r=await Bf(n,a,t,2e3);if(r.length){let l=Number(((o=M.stats)==null?void 0:o.xrplSpot)||((i=M.stats)==null?void 0:i.price)||0);return{candles:l>0?r.map(p=>({time:p.time,open:p.open*l,high:p.high*l,low:p.low*l,close:p.close*l,volume:p.volume})):r,source:`OnTheDex XRPL DEX (${n}/XRP)`,mode:"token-direct"}}}catch{}return null}function Wf(e,{mode:t="pair",source:n="Source pending",tokenKey:s=""}={}){let a=Array.isArray(e)?e:[];if(!a.length){M.chartMeta={tokenKey:s||M.tokenFocusKey||"XRP|",symbol:s&&s.split("|")[0]||"XRP",source:n,last:null,high:null,low:null,mode:t};return}let o=a[a.length-1],i=a.map(c=>Number(c.high)).filter(c=>Number.isFinite(c)),r=a.map(c=>Number(c.low)).filter(c=>Number.isFinite(c)),l=s||M.tokenFocusKey||"XRP|";M.chartMeta={tokenKey:l,symbol:l.split("|")[0]||"XRP",source:n,last:Number(o.close),high:i.length?Math.max(...i):Number(o.high),low:r.length?Math.min(...r):Number(o.low),mode:t}}async function Is(){var t;let e=Ea();M.loading=!0,M.error="";try{let n=pc(e.ticker);if(n){let s=await Lt(`https://api.exchange.coinbase.com/products/${n}/ticker`),a=await Lt(`https://api.exchange.coinbase.com/products/${n}/candles?granularity=86400`),o=Array.isArray(a)&&a.length?a[0]:null,i=Number(s.price||0),r=o?Number(o[3]):i;M.stats={price:i,high:o?Number(o[2]):i,low:o?Number(o[1]):i,changePct:r?(i-r)/r*100:0,baseSource:"Coinbase",source:"Coinbase"},await uc(),!Te.data&&M.stats.price&&(Te.data={priceUsd:M.stats.price,change24h:M.stats.changePct,volume24h:o?Number(o[5]||0)*M.stats.price:0,marketCap:Number(((t=Te.data)==null?void 0:t.marketCap)||0)});return}throw new Error("Chart stats unavailable for selected pair.")}catch(n){M.error=(n==null?void 0:n.message)||"DEX chart stats unavailable right now."}finally{M.loading=!1}}async function uc(){var e,t,n;try{let s=await at({method:"book_offers",params:[{taker_gets:{currency:"USD",issuer:"rhub8VRN55s94qWKDv6jmDy1pUykJzF3wq"},taker_pays:{currency:"XRP"},limit:1}]}),a=(e=s==null?void 0:s.offers)==null?void 0:e[0];if(!a)return;let o=Number(((t=a.TakerGets)==null?void 0:t.value)||0),i=typeof a.TakerPays=="string"?Number(a.TakerPays)/1e6:Number(((n=a.TakerPays)==null?void 0:n.value)||0);if(o>0&&i>0){let r=o/i;if(Ol=Date.now(),M.stats||(M.stats={}),M.stats.xrplSpot=r,String(Ea().symbol||"XRP").toUpperCase()==="XRP"){M.stats.price=r;let l=M.stats.baseSource||M.stats.source||"Market feed";M.stats.source=`${l} + XRPL live`,Te.data&&(Te.data.priceUsd=r)}}}catch{}}async function Uf(){var e,t;return(e=window.LightweightCharts)!=null&&e.createChart?!0:(ka||(ka=new Promise((n,s)=>{let a=document.querySelector('script[data-lw-chart="1"]');if(a){a.addEventListener("load",()=>n(!0),{once:!0}),a.addEventListener("error",()=>s(new Error("Chart library failed to load.")),{once:!0});return}let o=document.createElement("script");o.src="https://unpkg.com/lightweight-charts@4.2.2/dist/lightweight-charts.standalone.production.js",o.async=!0,o.defer=!0,o.dataset.lwChart="1",o.onload=()=>n(!0),o.onerror=()=>s(new Error("Chart library failed to load.")),document.head.appendChild(o)}).finally(()=>{var n;(n=window.LightweightCharts)!=null&&n.createChart||(ka=null)})),await ka,!!((t=window.LightweightCharts)!=null&&t.createChart))}async function jf(){var e,t;return(e=window.THREE)!=null&&e.Scene?!0:($a||($a=new Promise((n,s)=>{let a=document.querySelector('script[data-three-chart="1"]');if(a){a.addEventListener("load",()=>n(!0),{once:!0}),a.addEventListener("error",()=>s(new Error("Three.js failed to load.")),{once:!0});return}let o=document.createElement("script");o.src="https://unpkg.com/three@0.166.1/build/three.min.js",o.async=!0,o.defer=!0,o.dataset.threeChart="1",o.onload=()=>n(!0),o.onerror=()=>s(new Error("Three.js failed to load.")),document.head.appendChild(o)}).finally(()=>{var n;(n=window.THREE)!=null&&n.Scene||($a=null)})),await $a,!!((t=window.THREE)!=null&&t.Scene))}function Fs(){var e,t;if(Ge.resizeHandler)try{window.removeEventListener("resize",Ge.resizeHandler)}catch{}if(Ge.raf&&cancelAnimationFrame(Ge.raf),(t=(e=Ge.renderer)==null?void 0:e.domElement)!=null&&t.parentElement)try{Ge.renderer.domElement.parentElement.removeChild(Ge.renderer.domElement)}catch{}if(Ge.renderer)try{Ge.renderer.dispose()}catch{}Ge={renderer:null,scene:null,camera:null,points:null,raf:0,host:null,resizeHandler:null}}async function qf(){var t;let e=document.getElementById("xpd-chart-atmosphere");if(e&&!(Ge.renderer&&e.contains(Ge.renderer.domElement))&&!((navigator.hardwareConcurrency||4)<=3))try{if(await jf(),!((t=window.THREE)!=null&&t.Scene))return;Fs();let n=window.THREE,s=Math.max(1,e.clientWidth||640),a=Math.max(1,e.clientHeight||460),o=new n.Scene,i=new n.PerspectiveCamera(52,s/a,.1,1e3);i.position.z=46;let r=new n.WebGLRenderer({alpha:!0,antialias:!0});r.setPixelRatio(Math.min(2,window.devicePixelRatio||1)),r.setSize(s,a),e.appendChild(r.domElement);let l=900,c=new Float32Array(l*3);for(let h=0;h<l;h+=1){let v=h*3;c[v]=(Math.random()-.5)*90,c[v+1]=(Math.random()-.5)*40,c[v+2]=(Math.random()-.5)*24}let p=new n.BufferGeometry;p.setAttribute("position",new n.BufferAttribute(c,3));let u=new n.PointsMaterial({color:5101823,size:.25,transparent:!0,opacity:.26,depthWrite:!1}),d=new n.Points(p,u);o.add(d);let m=0,f=0,g=()=>{var T;m+=1;let h=Number(((T=M.stats)==null?void 0:T.changePct)||0),v=Math.min(4,Math.max(.35,Math.abs(h)/2.2)),x=h>0?16758874:16739999;u.color.setHex(Math.abs(h)>1.5?x:5101823),d.rotation.y+=9e-4*v,d.rotation.x=Math.sin(m*.0015*v)*.08,d.position.y=Math.sin(m*.003*v)*.7,(!document.hidden||Date.now()-f>350)&&(r.render(o,i),f=Date.now()),Ge.raf=requestAnimationFrame(g)},b=()=>{let h=Math.max(1,e.clientWidth||640),v=Math.max(1,e.clientHeight||460);i.aspect=h/v,i.updateProjectionMatrix(),r.setSize(h,v)};window.addEventListener("resize",b,{passive:!0}),Ge={renderer:r,scene:o,camera:i,points:d,raf:0,host:e,resizeHandler:b},g()}catch{}}function mc(e){return pi(e)*60}function fc(e){let t=pi(e);return t<=1?60:t<=5?300:t<=15?900:t<=60?3600:t<=360?21600:86400}function hc(){let e=String(M.tokenFocusKey||"");if(!e)return null;let t=e.includes("|")?e.split("|")[0]:e;return U.tokens.find(n=>qe(n)===e)||U.tokens.find(n=>String(n.symbol||"").toUpperCase()===String(t||"").toUpperCase())||null}function gc(){var a,o;let e=hc(),t=Number((e==null?void 0:e.price)||0);if(Number.isFinite(t)&&t>0)return t;let n=Number(((a=M.stats)==null?void 0:a.xrplSpot)||0);if(Number.isFinite(n)&&n>0)return n;let s=Number(((o=M.stats)==null?void 0:o.price)||0);return Number.isFinite(s)&&s>0?s:1}function vc(e,t=1,n=220){let s=Math.max(60,mc(e)),a=Math.floor(Date.now()/1e3),o=Math.floor(a/s)*s-n*s,i=Math.max(1e-6,Number(t)||1),r=[];for(let l=0;l<n;l+=1){let c=o+l*s,p=i,u=Math.sin((l+1)/9)*.004+Math.cos((l+3)/17)*.002;i=Math.max(1e-6,p*(1+u));let d=Math.max(p,i)*(1+Math.abs(u)*.55+.0015),m=Math.min(p,i)*Math.max(1e-6,1-(Math.abs(u)*.55+.0015));r.push({time:c,open:Number(p),high:Number(d),low:Number(m),close:Number(i),volume:Math.max(0,Math.round(Math.abs(u)*12e3+l%13*55))})}return r}function Go(e){if(!e.length)return e;let t=[];for(let n=0;n<e.length;n+=1){let s=e[n],a=(s.open+s.high+s.low+s.close)/4,o=t[n-1],i=o?(o.open+o.close)/2:(s.open+s.close)/2,r=Math.max(s.high,i,a),l=Math.min(s.low,i,a);t.push({...s,open:i,high:r,low:l,close:a})}return t}function Ko(e,t){let n=[],s=0;for(let a=0;a<e.length;a+=1)s+=e[a].close,a>=t&&(s-=e[a-t].close),a>=t-1&&n.push({time:e[a].time,value:s/t});return n}function _s(e,t){let n=[];if(!e.length)return n;let s=2/(t+1),a=e[0].close;for(let o=0;o<e.length;o+=1)a=o===0?e[o].close:e[o].close*s+a*(1-s),o>=t-1&&n.push({time:e[o].time,value:a});return n}function Vf(e,t){let n=[],s=t*(t+1)/2;for(let a=t-1;a<e.length;a+=1){let o=0;for(let i=0;i<t;i+=1)o+=e[a-i].close*(t-i);n.push({time:e[a].time,value:o/s})}return n}function Gf(e,t=20,n=2){let s=Ko(e,t),a=[],o=[];for(let i=t-1;i<e.length;i+=1){let r=e.slice(i-t+1,i+1),l=s[i-(t-1)].value,c=r.reduce((u,d)=>u+Math.pow(d.close-l,2),0)/t,p=Math.sqrt(c);a.push({time:e[i].time,value:l+p*n}),o.push({time:e[i].time,value:l-p*n})}return{upper:a,lower:o}}function Kf(e){let t=[],n=0,s=0;for(let a=0;a<e.length;a+=1){let o=(e[a].high+e[a].low+e[a].close)/3;n+=o*(e[a].volume||0),s+=e[a].volume||0,s>0&&t.push({time:e[a].time,value:n/s})}return t}function Jf(e,t=14){let n=[];if(e.length<=t)return n;let s=0,a=0;for(let r=1;r<=t;r+=1){let l=e[r].close-e[r-1].close;s+=l>0?l:0,a+=l<0?-l:0}let o=s/t,i=a/t;for(let r=t+1;r<e.length;r+=1){let l=e[r].close-e[r-1].close;o=(o*(t-1)+(l>0?l:0))/t,i=(i*(t-1)+(l<0?-l:0))/t;let c=i>0?o/i:100;n.push({time:e[r].time,value:100-100/(1+c)})}return n}function ui(e,t=14){let n=[];for(let o=0;o<e.length;o+=1){let i=o>0?e[o-1].close:e[o].close;n.push(Math.max(e[o].high-e[o].low,Math.abs(e[o].high-i),Math.abs(e[o].low-i)))}let s=[],a=n.slice(0,t).reduce((o,i)=>o+i,0)/Math.max(1,t);for(let o=t;o<e.length;o+=1)a=(a*(t-1)+n[o])/t,s.push({time:e[o].time,value:a});return s}function Yf(e,t=14,n=3){let s=[];for(let o=t-1;o<e.length;o+=1){let i=e.slice(o-t+1,o+1),r=Math.max(...i.map(p=>p.high)),l=Math.min(...i.map(p=>p.low)),c=r!==l?(e[o].close-l)/(r-l)*100:50;s.push({time:e[o].time,value:c})}let a=[];for(let o=n-1;o<s.length;o+=1){let i=s.slice(o-n+1,o+1).reduce((r,l)=>r+l.value,0)/n;a.push({time:s[o].time,value:i})}return{k:s,d:a}}function Qf(e,t=12,n=26,s=9){let a=_s(e,t),o=_s(e,n),i=new Map(o.map(u=>[u.time,u.value])),r=a.filter(u=>i.has(u.time)).map(u=>({time:u.time,value:u.value-i.get(u.time)})),l=[];if(r.length){let u=2/(s+1),d=r[0].value;for(let m=0;m<r.length;m+=1)d=m===0?r[m].value:r[m].value*u+d*(1-u),m>=s-1&&l.push({time:r[m].time,value:d})}let c=new Map(l.map(u=>[u.time,u.value])),p=r.filter(u=>c.has(u.time)).map(u=>({time:u.time,value:u.value-c.get(u.time)}));return{line:r,signal:l,hist:p}}function bc(e,t=9,n=26,s=52){let a=u=>{let d=[];for(let m=u-1;m<e.length;m+=1){let f=e.slice(m-u+1,m+1);d.push({time:e[m].time,value:(Math.max(...f.map(g=>g.high))+Math.min(...f.map(g=>g.low)))/2})}return d},o=a(t),i=a(n),r=new Map(i.map(u=>[u.time,u.value])),l=o.filter(u=>r.has(u.time)).map(u=>({time:u.time,value:(u.value+r.get(u.time))/2})),c=a(s),p=e.map(u=>({time:u.time,value:u.close}));return{tenkan:o,kijun:i,senkouA:l,senkouB:c,chikou:p}}function Zf(e,t=20){let n=[],s=[],a=[];for(let o=t-1;o<e.length;o+=1){let i=e.slice(o-t+1,o+1),r=Math.max(...i.map(c=>c.high)),l=Math.min(...i.map(c=>c.low));n.push({time:e[o].time,value:r}),s.push({time:e[o].time,value:l}),a.push({time:e[o].time,value:(r+l)/2})}return{upper:n,lower:s,mid:a}}function eh(e,t=20,n=2){let s=_s(e,t),a=ui(e,t),o=new Map(a.map(l=>[l.time,l.value])),i=[],r=[];return s.forEach(l=>{if(o.has(l.time)){let c=o.get(l.time)*n;i.push({time:l.time,value:l.value+c}),r.push({time:l.time,value:l.value-c})}}),{upper:i,lower:r,mid:s}}function th(e){let t=[],n=[],s=0,a=0;for(let o=0;o<e.length;o+=1){if(o>0){let l=e[o-1];e[o].close>l.close&&(s+=e[o].volume||0),e[o].close<l.close&&(s-=e[o].volume||0)}let i=e[o].high-e[o].low||1,r=(e[o].close-e[o].low-(e[o].high-e[o].close))/i;a+=r*(e[o].volume||0),t.push({time:e[o].time,value:s}),n.push({time:e[o].time,value:a})}return{obv:t,adline:n}}function nh(e,t=14){if(e.length<t+2)return{adx:[],plusDi:[],minusDi:[]};let n=[],s=[],a=[];for(let d=1;d<e.length;d+=1){let m=e[d].high-e[d-1].high,f=e[d-1].low-e[d].low;s.push(m>f&&m>0?m:0),a.push(f>m&&f>0?f:0),n.push(Math.max(e[d].high-e[d].low,Math.abs(e[d].high-e[d-1].close),Math.abs(e[d].low-e[d-1].close)))}let o=n.slice(0,t).reduce((d,m)=>d+m,0),i=s.slice(0,t).reduce((d,m)=>d+m,0),r=a.slice(0,t).reduce((d,m)=>d+m,0),l=[],c=[],p=[];for(let d=t;d<n.length;d+=1){o=o-o/t+n[d],i=i-i/t+s[d],r=r-r/t+a[d];let m=o>0?100*i/o:0,f=o>0?100*r/o:0,g=m+f>0?100*Math.abs(m-f)/(m+f):0,b=e[d+1].time;l.push({time:b,value:m}),c.push({time:b,value:f}),p.push({time:b,value:g})}let u=[];if(p.length>=t){let d=p.slice(0,t).reduce((m,f)=>m+f.value,0)/t;for(let m=t;m<p.length;m+=1)d=(d*(t-1)+p[m].value)/t,u.push({time:p[m].time,value:d})}return{adx:u,plusDi:l,minusDi:c}}function sh(e,t=14){let n=[],s=[];for(let a=t-1;a<e.length;a+=1){let o=e.slice(a-t+1,a+1),i=0,r=0;for(let p=1;p<o.length;p+=1)o[p].high>=o[i].high&&(i=p),o[p].low<=o[r].low&&(r=p);let l=t-1-i,c=t-1-r;n.push({time:e[a].time,value:(t-l)/t*100}),s.push({time:e[a].time,value:(t-c)/t*100})}return{up:n,down:s}}function ah(e,t=14){let n=[],s=[];if(e.length<t+2)return{plus:n,minus:s};for(let a=t;a<e.length;a+=1){let o=0,i=0,r=0;for(let l=a-t+1;l<=a;l+=1){let c=e[l-1],p=e[l];o+=Math.max(p.high-p.low,Math.abs(p.high-c.close),Math.abs(p.low-c.close)),i+=Math.abs(p.high-c.low),r+=Math.abs(p.low-c.high)}n.push({time:e[a].time,value:o>0?i/o:0}),s.push({time:e[a].time,value:o>0?r/o:0})}return{plus:n,minus:s}}function oh(e,t=10,n=3){let s=ui(e,t),a=new Map(s.map(c=>[c.time,c.value])),o=[],i=0,r=0,l=!0;return e.forEach((c,p)=>{if(p===0||!a.has(c.time))return;let u=(c.high+c.low)/2,d=a.get(c.time),m=u+n*d,f=u-n*d;p>1&&(m>i&&e[p-1].close<=i&&(m=i),f<r&&e[p-1].close>=r&&(f=r));let g=c.close>m?!0:c.close<f?!1:l,b=g?f:m;o.push({time:c.time,value:b,trendUp:g?1:0}),i=m,r=f,l=g}),o}function ih(e,t=14){let n=[];if(e.length<=t)return n;let s=e.map((a,o)=>{let i=(a.high+a.low+a.close)/3,r=o>0?(e[o-1].high+e[o-1].low+e[o-1].close)/3:i,l=i*(a.volume||0);return{time:a.time,pos:i>=r?l:0,neg:i<r?l:0}});for(let a=t;a<s.length;a+=1){let o=s.slice(a-t+1,a+1),i=o.reduce((c,p)=>c+p.pos,0),r=o.reduce((c,p)=>c+p.neg,0),l=r>0?i/r:100;n.push({time:s[a].time,value:100-100/(1+l)})}return n}function rh(e,t=14){let n=[];for(let s=t-1;s<e.length;s+=1){let a=e.slice(s-t+1,s+1),o=Math.max(...a.map(l=>l.high)),i=Math.min(...a.map(l=>l.low)),r=o!==i?(o-e[s].close)/(o-i)*-100:-50;n.push({time:e[s].time,value:r})}return n}function lh(e,t=20){let n=[],s=e.map(a=>({time:a.time,value:(a.high+a.low+a.close)/3}));for(let a=t-1;a<s.length;a+=1){let o=s.slice(a-t+1,a+1),i=o.reduce((c,p)=>c+p.value,0)/t,r=o.reduce((c,p)=>c+Math.abs(p.value-i),0)/t,l=r>0?(s[a].value-i)/(.015*r):0;n.push({time:s[a].time,value:l})}return n}function ch(e){if(e.length<30)return[];let t=[],n=[];for(let o=1;o<e.length;o+=1){let i=e[o-1].close,r=Math.min(e[o].low,i),l=Math.max(e[o].high,i);t.push({time:e[o].time,value:e[o].close-r}),n.push({time:e[o].time,value:l-r})}let s=(o,i,r)=>o.slice(i-r+1,i+1).reduce((l,c)=>l+c.value,0),a=[];for(let o=27;o<t.length;o+=1){let i=s(t,o,7)/Math.max(1e-9,s(n,o,7)),r=s(t,o,14)/Math.max(1e-9,s(n,o,14)),l=s(t,o,28)/Math.max(1e-9,s(n,o,28));a.push({time:t[o].time,value:100*(4*i+2*r+l)/7})}return a}function dh(e,t=20){let n=[],s=e.map(a=>{let o=a.high-a.low||1,i=(a.close-a.low-(a.high-a.close))/o;return{time:a.time,value:i*(a.volume||0),volume:a.volume||0}});for(let a=t-1;a<s.length;a+=1){let o=s.slice(a-t+1,a+1),i=o.reduce((l,c)=>l+c.value,0),r=o.reduce((l,c)=>l+c.volume,0);n.push({time:s[a].time,value:r>0?i/r:0})}return n}function ph(e){return(Array.isArray(e)?e:[]).map(t=>({time:Number(t[0]),low:Number(t[1]),high:Number(t[2]),open:Number(t[3]),close:Number(t[4]),volume:Number(t[5])})).filter(t=>Number.isFinite(t.time)&&[t.open,t.high,t.low,t.close].every(Number.isFinite))}function Jo(e,t){let n=new Map;for(let s of e)n.set(s.time,s);for(let s of t)n.set(s.time,s);return Array.from(n.values()).sort((s,a)=>s.time-a.time)}async function Yo(e,t,n){let s=[],a=Math.floor(Date.now()/1e3),o=!1;for(let i=0;i<n;i+=1){let r=a-t*300,l=`https://api.exchange.coinbase.com/products/${e}/candles?granularity=${t}&start=${new Date(r*1e3).toISOString()}&end=${new Date(a*1e3).toISOString()}`,c;try{c=await Lt(l,{timeoutMs:1e4})}catch{break}let p=ph(c);if(!p.length){o=!0;break}s.push(...p),a=r,i<n-1&&await sf(nf)}return{candles:Jo(s,[]),reachedStart:o}}async function uh(e,t,n){if(!e||!Number.isFinite(t)||!Number.isFinite(n)||n<=t)return[];try{let s=`https://api.coingecko.com/api/v3/coins/${e}/market_chart/range?vs_currency=usd&from=${t}&to=${n}`,a=await Lt(s,{timeoutMs:15e3});return(Array.isArray(a==null?void 0:a.prices)?a.prices:[]).map(([i,r])=>({time:Math.floor(Number(i)/1e3/86400)*86400,open:Number(r),high:Number(r),low:Number(r),close:Number(r),volume:0})).filter(i=>Number.isFinite(i.time)&&Number.isFinite(i.close)&&i.close>0).sort((i,r)=>i.time-r.time)}catch{return[]}}async function mh(e,t,n){var u;let s=fc(n),a=s===86400,o=`${tf}${e.id}:${s}`,i=ge(Q(o));if((u=i==null?void 0:i.candles)!=null&&u.length&&i.reachedStart){let d=await Yo(t,s,1),m=Jo(i.candles,d.candles);return Z(o,JSON.stringify({candles:m,reachedStart:!0,source:i.source,cachedAt:Date.now()})),{candles:m,source:i.source}}let l=await Yo(t,s,a?Bl:Xl),c=l.candles,p=c.length?`Coinbase (${new Date(c[0].time*1e3).getUTCFullYear()}\u2013present, ${c.length} bars)`:"Coinbase";if(a&&l.reachedStart&&e.coingeckoId&&c.length){let d=c[0].time,m=await uh(e.coingeckoId,0,d);m.length&&(c=Jo(m,c),p=`CoinGecko (${new Date(c[0].time*1e3).getUTCFullYear()}+) + Coinbase (${new Date(d*1e3).getUTCFullYear()}\u2013present)`)}else!a&&!l.reachedStart&&(p=`Coinbase (last ${c.length} bars \u2014 full inception history is daily/weekly/monthly only)`);return c.length&&Z(o,JSON.stringify({candles:c,reachedStart:l.reachedStart,source:p,cachedAt:Date.now()})),{candles:c,source:p}}var Wo=new Map;async function yc(e,t){let n=`${e.id}:${t}`,s=As.get(n);if(s&&Date.now()-s.ts<6e4&&Array.isArray(s.data)&&s.data.length)return s.data;let a=Wo.get(n);if(a)return a;let o=(async()=>{let i=[],r="",l=pc(e.ticker);if(l)try{let c=await mh(e,l,t);i=c.candles,r=c.source}catch{i=[]}if(!Array.isArray(i)||!i.length){let c=vc(t,gc());return As.set(n,{ts:Date.now(),data:c,sourceLabel:""}),c}return As.set(n,{ts:Date.now(),data:i,sourceLabel:r}),i})();Wo.set(n,o);try{return await o}finally{Wo.delete(n)}}async function fh(){var u,d,m,f,g,b,h,v;let e=Ea(),t=await yc(e,M.interval),s=((u=As.get(`${e.id}:${M.interval}`))==null?void 0:u.sourceLabel)||String(((d=M.stats)==null?void 0:d.source)||"Coinbase + XRPL live"),a="pair",o=hc(),i=String((o==null?void 0:o.symbol)||"").toUpperCase(),r=o?qe(o):`${e.symbol||"XRP"}|`;if(o&&i&&i!=="XRP"){let x=await Hf(o,M.interval);(m=x==null?void 0:x.candles)!=null&&m.length&&(t=x.candles,s=x.source,a=x.mode)}let l=String(e.symbol||"XRP").toUpperCase()==="XRP",c=Number((l?(f=M.stats)==null?void 0:f.xrplSpot:null)??((g=M.stats)==null?void 0:g.price)??0);if(a==="pair"&&Number.isFinite(c)&&c>0&&t.length){let x=Math.max(60,mc(M.interval)),k=Math.floor(Date.now()/1e3),T=Math.floor(k/x)*x,S=t[t.length-1];S.time===T?(S.high=Math.max(S.high,c),S.low=Math.min(S.low,c),S.close=c):S.time<T&&t.push({time:T,open:S.close,high:Math.max(S.close,c),low:Math.min(S.close,c),close:c,volume:0})}let p=Number((o==null?void 0:o.price)||0);if(a==="pair"&&o&&i&&i!=="XRP"&&Number.isFinite(p)&&p>0&&t.length){let x=Number((l?(b=M.stats)==null?void 0:b.xrplSpot:null)??((h=M.stats)==null?void 0:h.price)??((v=t[t.length-1])==null?void 0:v.close)??0);if(Number.isFinite(x)&&x>0){let k=p/x;Number.isFinite(k)&&k>0&&(t=t.map(T=>({...T,open:T.open*k,high:T.high*k,low:T.low*k,close:T.close*k})),s="Coinbase pair + token spot proxy",a="token-proxy")}}return t.length||(t=vc(M.interval,gc()),s=o&&i!=="XRP"?"Synthetic fallback (token-focused)":"Synthetic fallback",a="fallback"),o&&i!=="XRP"&&(a==="pair"||a==="fallback")?Xo!==r&&(Xo=r,he(`No market data found for ${o.symbol} yet \u2014 showing ${e.symbol||"XRP"} for reference.`)):r&&(Xo=""),M.chartType==="heikin_ashi"&&(t=Go(t)),Wf(t,{mode:a,source:s,tokenKey:r||"XRP|"}),t}function Tl(e){if(!Array.isArray(e))return[];let t=e.map(s=>({time:Number(s.time),open:Number(s.open),high:Number(s.high),low:Number(s.low),close:Number(s.close),volume:Number(s.volume||0)})).filter(s=>Number.isFinite(s.time)&&Number.isFinite(s.open)&&Number.isFinite(s.high)&&Number.isFinite(s.low)&&Number.isFinite(s.close)&&s.time>0).sort((s,a)=>s.time-a.time),n=[];for(let s=0;s<t.length;s+=1){let a=t[s],o=n[n.length-1];o&&o.time===a.time?n[n.length-1]=a:n.push(a)}return n}function hh(e,t,n){var i;let s=Number(((i=e==null?void 0:e[e.length-1])==null?void 0:i.close)||0);if(!Number.isFinite(s)||s<=0)return 6;let o=Math.max(1e-12,Math.abs(Number(n)-Number(t)))/Math.max(1e-12,Math.abs(s));return s>=1e3?o<.01?4:2:s>=1?o<.01?6:4:s>=.01?o<.03?8:6:8}function gh(){if(ee.resizeObserver)try{ee.resizeObserver.disconnect()}catch{}ee.chart&&(ee.chart.remove(),ee={chart:null,volumeSeries:null,activeSeries:null,compareSeries:null,indicatorSeries:[],indicatorPriceLines:[],priceLines:[],resizeObserver:null,chartType:"",configKey:"",legendEl:null,renderLegend:null,ichimokuData:null,indicatorLegendItems:[],alertPriceLines:[]})}function Cl(e,t){var p;let{addOverlay:n,addOsc:s,addOscHist:a,addPriceLevel:o}=t,i=(u,d)=>{var f,g;let m=Number((g=(f=M.indicatorSettings)==null?void 0:f[u])==null?void 0:g.length);return Number.isFinite(m)&&m>1?Math.min(500,Math.max(2,m)):d},r=(u,d,m)=>{var b,h;let f=(h=(b=M.indicatorSettings)==null?void 0:b[u])==null?void 0:h[d];if(f==null||f==="")return m;let g=(oi[u]||[]).find(v=>v.id===d);if((g==null?void 0:g.type)==="number"){let v=Number(f);return Number.isFinite(v)&&v>1?Math.min(500,Math.max(2,v)):m}return f},l=M.indicators;if(l.sma20&&n(Ko(e,i("sma20",20)),r("sma20","color","#f1c40f"),1.2,!1,"SMA"),l.ema20&&n(_s(e,i("ema20",20)),r("ema20","color","#ffb86c"),1.2,!1,"EMA"),l.wma20&&n(Vf(e,i("wma20",20)),r("wma20","color","#bd93f9"),1.2,!1,"WMA"),l.vwap&&n(Kf(e),r("vwap","color","#80ffea"),1.2,!1,"VWAP"),l.bb20){let u=r("bb20","color","#ff79c6"),d=Gf(e,i("bb20",20),2);n(d.upper,u,1,!0,"BB Upper"),n(d.lower,u,1,!0,"BB Lower")}if(l.ichimoku){let u=bc(e,r("ichimoku","tenkanLen",9),r("ichimoku","kijunLen",26),r("ichimoku","senkouBLen",52));n(u.tenkan,r("ichimoku","tenkanColor","#ffde59"),1.2,!1,"Tenkan"),n(u.kijun,r("ichimoku","kijunColor","#6ecbff"),1.2,!1,"Kijun"),n(u.senkouA,"rgba(70,255,160,0.8)",1,!0,"Senkou A"),n(u.senkouB,"rgba(255,120,120,0.8)",1,!0,"Senkou B"),n(u.chikou,"rgba(220,220,255,0.6)",.9,!0,"Chikou")}if(l.donchian){let u=r("donchian","color","#9cfb8c"),d=Zf(e,i("donchian",20));n(d.upper,u,1,!0,"Donchian Upper"),n(d.lower,u,1,!0,"Donchian Lower"),n(d.mid,"rgba(156,251,140,0.6)",1.2,!1,"Donchian Mid")}if(l.keltner){let u=r("keltner","color","#7ee7ff"),d=eh(e,i("keltner",20),2);n(d.upper,u,1,!0,"Keltner Upper"),n(d.lower,u,1,!0,"Keltner Lower"),n(d.mid,"rgba(126,231,255,0.66)",1.2,!1,"Keltner Mid")}if(l.pivots&&e.length>=2){let u=e[e.length-2],d=(u.high+u.low+u.close)/3,m=2*d-u.low,f=2*d-u.high,g=d+(u.high-u.low),b=d-(u.high-u.low);o(d,"#f6f6f6","P"),o(m,"#61ffb0","R1"),o(f,"#ff8f8f","S1"),o(g,"rgba(97,255,176,0.6)","R2"),o(b,"rgba(255,143,143,0.6)","S2")}if(l.supertrend||l.sar||l.elderRay){let u=_s(e,14);if(l.supertrend&&n(oh(e,10,3),r("supertrend","color","#8bffde"),1.3,!1,"Supertrend"),l.sar&&n(u.map(d=>({time:d.time,value:d.value*.998})),r("sar","color","#ffaf7a"),1,!0,"SAR"),l.elderRay){let d=new Map(u.map(g=>[g.time,g.value])),m=e.filter(g=>d.has(g.time)).map(g=>({time:g.time,value:g.high-d.get(g.time)})),f=e.filter(g=>d.has(g.time)).map(g=>({time:g.time,value:g.low-d.get(g.time)}));s(m,r("elderRay","bullColor","#5fff9d"),"Elder Bull"),s(f,r("elderRay","bearColor","#ff9d9d"),"Elder Bear")}}if(l.rsi&&s(Jf(e,i("rsi",14)),r("rsi","color","#a6ff4d"),"RSI"),l.atr&&s(ui(e,i("atr",14)),r("atr","color","#ffb86c"),"ATR"),l.stdev){let u=Ko(e,20),d=new Map(u.map(f=>[f.time,f.value])),m=e.filter(f=>d.has(f.time)).map(f=>({time:f.time,value:Math.abs(f.close-d.get(f.time))}));s(m,r("stdev","color","#b2a3ff"),"StdDev")}if(l.stoch){let u=Yf(e,i("stoch",14),3);s(u.k,r("stoch","kColor","#9ee8ff"),"%K"),s(u.d,r("stoch","dColor","#ffd86b"),"%D")}if(l.macd){let u=Qf(e,r("macd","fastLen",12),r("macd","slowLen",26),r("macd","signalLen",9));s(u.line,r("macd","lineColor","#8fd9ff"),"MACD"),s(u.signal,r("macd","signalColor","#ffcf8e"),"Signal"),(p=u.hist)!=null&&p.length&&a(u.hist)}let c=th(e);if(l.obv&&s(c.obv,r("obv","color","#8cf9ff"),"OBV"),l.adline&&s(c.adline,r("adline","color","#ffb7ff"),"A/D"),l.cmf&&s(dh(e,i("cmf",20)),r("cmf","color","#f8ff87"),"CMF"),l.williamsr&&s(rh(e,i("williamsr",14)),r("williamsr","color","#ff9adf"),"Williams %R"),l.cci&&s(lh(e,i("cci",20)),r("cci","color","#b8ff8e"),"CCI"),l.mfi&&s(ih(e,i("mfi",14)),r("mfi","color","#7bffd2"),"MFI"),l.uo&&s(ch(e),r("uo","color","#ffd36f"),"UO"),l.adx){let u=nh(e,i("adx",14));s(u.adx,r("adx","adxColor","#9fd8ff"),"ADX"),s(u.plusDi,r("adx","plusColor","#73ffc0"),"+DI"),s(u.minusDi,r("adx","minusColor","#ff9797"),"-DI")}if(l.aroon){let u=sh(e,i("aroon",14));s(u.up,r("aroon","upColor","#6cffb0"),"Aroon Up"),s(u.down,r("aroon","downColor","#ff8f8f"),"Aroon Down")}if(l.vortex){let u=ah(e,i("vortex",14));s(u.plus.map(d=>({time:d.time,value:d.value*100})),r("vortex","plusColor","#d6a8ff"),"VI+"),s(u.minus.map(d=>({time:d.time,value:d.value*100})),r("vortex","minusColor","#ffb0f3"),"VI-")}}function vh(e){let t=e.querySelector(":scope > svg.xpd-ichimoku-cloud-svg");return t||(t=document.createElementNS("http://www.w3.org/2000/svg","svg"),t.setAttribute("class","xpd-ichimoku-cloud-svg"),e.appendChild(t)),t}function bh(e){var t;(t=e==null?void 0:e.querySelector(":scope > svg.xpd-ichimoku-cloud-svg"))==null||t.remove()}function wc(e,t,n,s,a){var b;if(!e||!t||!n)return;let o=n.clientWidth||0,i=n.clientHeight||0;if(!o||!i||!(s!=null&&s.length)||!(a!=null&&a.length))return;let r=vh(n);r.setAttribute("width",o),r.setAttribute("height",i),r.setAttribute("viewBox",`0 0 ${o} ${i}`);let l=((b=M.indicatorSettings)==null?void 0:b.ichimoku)||{},c=l.bullColor||"#46ffa0",p=l.bearColor||"#ff7878",u=new Map(a.map(h=>[h.time,h.value])),d=e.timeScale(),m=[];for(let h of s){let v=u.get(h.time);if(v==null)continue;let x=d.timeToCoordinate(h.time),k=t.priceToCoordinate(h.value),T=t.priceToCoordinate(v);x==null||k==null||T==null||m.push({x,ya:k,yb:T,bullish:h.value>=v})}let f="",g=0;for(let h=1;h<=m.length;h+=1){if(!(h===m.length||m[h].bullish!==m[g].bullish))continue;let x=m.slice(g,h);if(x.length>=2){let k=x.map($=>`${$.x.toFixed(1)},${$.ya.toFixed(1)}`).join(" "),T=x.slice().reverse().map($=>`${$.x.toFixed(1)},${$.yb.toFixed(1)}`).join(" "),S=x[0].bullish?c:p;f+=`<polygon points="${k} ${T}" fill="${y(S)}" opacity="0.22" />`}g=h}r.innerHTML=f}function Pl(e,t,n,s){var i;if(!M.indicators.ichimoku){bh(s),ee.ichimokuData=null;return}let a=((i=M.indicatorSettings)==null?void 0:i.ichimoku)||{},o=bc(e,Number(a.tenkanLen)||9,Number(a.kijunLen)||26,Number(a.senkouBLen)||52);ee.ichimokuData={senkouA:o.senkouA,senkouB:o.senkouB},wc(t,n,s,o.senkouA,o.senkouB)}function Qo(){let e=ee.ichimokuData,t=document.getElementById("xpd-tv-widget");e&&ee.chart&&ee.activeSeries&&t&&wc(ee.chart,ee.activeSeries,t,e.senkouA,e.senkouB)}async function yh(){var n,s,a,o;let e=++Nn,t=document.getElementById("xpd-tv-widget");if(t){ee.chart||(t.innerHTML='<div class="xpd-loading">Loading full price history\u2026</div>');try{M.threeEnabled?qf():Fs();let i=await fh(),r=Tl(i);if(e!==Nn)return;if(!r.length)throw new Error("No chart bars returned for selected pair/timeframe.");xh(r);let l=JSON.stringify({pair:M.pair,interval:M.interval,chartType:M.chartType,comparePair:M.comparePair,indicators:M.indicators,indicatorSettings:M.indicatorSettings,threeEnabled:M.threeEnabled});if(!M.comparePair&&!(M.drawings||[]).length&&ee.chart&&ee.configKey===l){let B=M.chartType==="heikin_ashi"?Go(r):r;M.chartType==="line"||M.chartType==="area"?ee.activeSeries.setData(B.map(Y=>({time:Y.time,value:Y.close}))):ee.activeSeries.setData(B),ee.volumeSeries.setData(r.map(Y=>({time:Y.time,value:Y.volume||0,color:Y.close>=Y.open?"rgba(38,166,154,0.5)":"rgba(239,83,80,0.5)"})));let q=0,J=0,ue=[];Cl(r,{addOverlay:(Y,Ce,Je,$e,Ct)=>{let zt=ee.indicatorSeries[q++];Y!=null&&Y.length&&(zt==null||zt.setData(Y),Ct&&zt&&ue.push({label:Ct,color:Ce,series:zt,points:Y}))},addOsc:(Y,Ce,Je)=>{let $e=ee.indicatorSeries[q++];Y!=null&&Y.length&&($e==null||$e.setData(Y),Je&&$e&&ue.push({label:Je,color:Ce,series:$e,points:Y}))},addOscHist:Y=>{let Ce=ee.indicatorSeries[q++];Y!=null&&Y.length&&(Ce==null||Ce.setData(Y.map(Je=>({time:Je.time,value:Je.value,color:Je.value>=0?"rgba(99,255,157,0.45)":"rgba(255,126,126,0.45)"}))))},addPriceLevel:Y=>{let Ce=ee.indicatorPriceLines[J++];Number.isFinite(Y)&&(Ce==null||Ce.applyOptions({price:Y}))}}),ee.indicatorLegendItems=ue,Pl(r,ee.chart,ee.activeSeries,t),Ml(ee.activeSeries);let Ie=r[r.length-1];(n=ee.renderLegend)==null||n.call(ee,Ie.open,Ie.high,Ie.low,Ie.close,Ie.volume);return}if(!await Uf())throw new Error("Chart library failed to load.");if(e!==Nn)return;let p=document.getElementById("xpd-tv-widget");if(!p||e!==Nn)return;let u=null;try{u=((s=ee.chart)==null?void 0:s.timeScale().getVisibleLogicalRange())||null}catch{}gh(),p.innerHTML="";let d=window.LightweightCharts,m=Math.max(320,p.clientWidth||((a=p.parentElement)==null?void 0:a.clientWidth)||320),f=Math.max(360,p.clientHeight||460),g=r.map(B=>B.low),b=r.map(B=>B.high),h=hh(r,Math.min(...g),Math.max(...b)),v={type:"price",precision:h,minMove:Math.pow(10,-h)},x="#26a69a",k="#ef5350",T=d.createChart(p,{width:m,height:f,layout:{background:{type:d.ColorType.Solid,color:"#131722"},textColor:"#d1d4dc"},grid:{vertLines:{color:"#242832"},horzLines:{color:"#242832"}},rightPriceScale:{borderColor:"rgba(197,203,206,0.3)"},leftPriceScale:{visible:!1,borderColor:"rgba(197,203,206,0.3)"},timeScale:{borderColor:"rgba(197,203,206,0.3)",timeVisible:!0,secondsVisible:!1},crosshair:{mode:d.CrosshairMode.Normal},handleScroll:!0,handleScale:!0}),S=M.chartType==="heikin_ashi"?Go(r):r,$;if(M.chartType==="line")$=T.addLineSeries({color:"#2962ff",lineWidth:2,priceFormat:v}),$.setData(S.map(B=>({time:B.time,value:B.close})));else if(M.chartType==="area")$=T.addAreaSeries({lineColor:"#2962ff",topColor:"rgba(41,98,255,0.36)",bottomColor:"rgba(41,98,255,0.04)",lineWidth:2,priceFormat:v}),$.setData(S.map(B=>({time:B.time,value:B.close})));else if(M.chartType==="bars")$=T.addBarSeries({upColor:x,downColor:k,priceFormat:v}),$.setData(S);else{let B=M.chartType==="hollow_candles";$=T.addCandlestickSeries({upColor:B?"rgba(0,0,0,0)":x,downColor:k,borderUpColor:x,borderDownColor:k,wickUpColor:x,wickDownColor:k,borderVisible:!0,priceFormat:v}),$.setData(S)}let E=T.addHistogramSeries({priceFormat:{type:"volume"},priceScaleId:"vol"});T.priceScale("vol").applyOptions({scaleMargins:{top:.85,bottom:0}}),E.setData(r.map(B=>({time:B.time,value:B.volume||0,color:B.close>=B.open?"rgba(38,166,154,0.5)":"rgba(239,83,80,0.5)"})));let C=document.createElement("div");C.className="xpd-chart-legend",p.appendChild(C);let P=B=>Number.isFinite(B)?B.toFixed(h):"\u2014",R=(B,q,J,ue,ke,Me)=>{let We=ue>=B,De=(Me||[]).map(Ie=>`<span style="color:${y(Ie.color)}">${y(Ie.label)} <b>${P(Ie.value)}</b></span>`).join("");C.innerHTML=`
        <span>O <b>${P(B)}</b></span>
        <span>H <b>${P(q)}</b></span>
        <span>L <b>${P(J)}</b></span>
        <span class="${We?"xpd-legend-up":"xpd-legend-down"}">C <b>${P(ue)}</b></span>
        ${ke!=null?`<span>Vol <b>${je(ke)}</b></span>`:""}
        ${De}
      `},O=S[S.length-1],D=(o=r[r.length-1])==null?void 0:o.volume,I=()=>{if(!O)return;let B=O.open??O.value,q=O.high??O.value,J=O.low??O.value,ue=O.close??O.value,ke=(ee.indicatorLegendItems||[]).map(Me=>{var We,De;return{label:Me.label,color:Me.color,value:(De=(We=Me.points)==null?void 0:We[Me.points.length-1])==null?void 0:De.value}}).filter(Me=>Number.isFinite(Me.value));R(B,q,J,ue,D,ke)};I(),T.subscribeCrosshairMove(B=>{var Ie,Y;if(!B.time){I();return}let q=(Ie=B.seriesData)==null?void 0:Ie.get($);if(!q){I();return}let J=(Y=B.seriesData)==null?void 0:Y.get(E),ue=q.open??q.value,ke=q.high??q.value,Me=q.low??q.value,We=q.close??q.value,De=(ee.indicatorLegendItems||[]).map(Ce=>{var Je,$e;return{label:Ce.label,color:Ce.color,value:($e=(Je=B.seriesData)==null?void 0:Je.get(Ce.series))==null?void 0:$e.value}}).filter(Ce=>Number.isFinite(Ce.value));R(ue,ke,Me,We,J==null?void 0:J.value,De)});let F=!1,H=()=>{F||(F=!0,T.priceScale("osc").applyOptions({scaleMargins:{top:.65,bottom:.18}}))},N=[],W=[],se=[];Cl(r,{addOverlay:(B,q,J=1.2,ue=!1,ke="")=>{if(!(B!=null&&B.length))return;let Me=T.addLineSeries({color:q,lineWidth:J,lineStyle:ue?d.LineStyle.Dashed:d.LineStyle.Solid,priceLineVisible:!1,lastValueVisible:!1});Me.setData(B),N.push(Me),ke&&se.push({label:ke,color:q,series:Me,points:B})},addOsc:(B,q,J="")=>{if(!(B!=null&&B.length))return;H();let ue=T.addLineSeries({color:q,lineWidth:1.2,priceScaleId:"osc",title:J,priceLineVisible:!1,lastValueVisible:!1});ue.setData(B),N.push(ue),J&&se.push({label:J,color:q,series:ue,points:B})},addOscHist:B=>{if(!(B!=null&&B.length))return;H();let q=T.addHistogramSeries({priceScaleId:"osc",priceLineVisible:!1,lastValueVisible:!1});q.setData(B.map(J=>({time:J.time,value:J.value,color:J.value>=0?"rgba(99,255,157,0.45)":"rgba(255,126,126,0.45)"}))),N.push(q)},addPriceLevel:(B,q,J="")=>{Number.isFinite(B)&&W.push($.createPriceLine({price:B,color:q,lineWidth:1,lineStyle:d.LineStyle.Dashed,axisLabelVisible:!0,title:J}))}}),Pl(r,T,$,p),T.timeScale().subscribeVisibleLogicalRangeChange(Qo);let de=null;if(M.comparePair){let B=In.find(q=>q.id===M.comparePair);if(B){let q=Tl(await yc(B,M.interval));if(e===Nn&&q.length){let J=q[0].close||1;de=T.addLineSeries({color:"#ffd166",lineWidth:1.4,priceScaleId:"left",priceLineVisible:!1,lastValueVisible:!0,priceFormat:{type:"custom",formatter:ue=>`${ue>=0?"+":""}${ue.toFixed(2)}%`,minMove:.01}}),T.priceScale("left").applyOptions({visible:!0,borderColor:"rgba(255,209,102,0.35)"}),de.setData(q.map(ue=>({time:ue.time,value:(ue.close/J-1)*100})))}}}else T.priceScale("left").applyOptions({visible:!1});if(e!==Nn){try{T.remove()}catch{}return}let le=(M.drawings||[]).filter(B=>Number.isFinite(B==null?void 0:B.price)).map(B=>$.createPriceLine({price:B.price,color:"#78e5ff",lineWidth:2,lineStyle:d.LineStyle.Dashed,axisLabelVisible:!0,title:"Line"}));if(T.subscribeClick(B=>{if(M.drawingTool!=="hline"||!B.point)return;let q=$.coordinateToPrice(B.point.y);Number.isFinite(q)&&(M.drawings=[...M.drawings||[],{price:q}].slice(-50),le.push($.createPriceLine({price:q,color:"#78e5ff",lineWidth:2,lineStyle:d.LineStyle.Dashed,axisLabelVisible:!0,title:"Line"})))}),u&&Number.isFinite(u.from)&&Number.isFinite(u.to))try{T.timeScale().setVisibleLogicalRange(u)}catch{T.timeScale().fitContent()}else T.timeScale().fitContent();let Pe=new ResizeObserver(()=>{T.applyOptions({width:Math.max(320,p.clientWidth||320)}),Qo()});Pe.observe(p),ee={chart:T,volumeSeries:E,activeSeries:$,compareSeries:de,indicatorSeries:N,indicatorPriceLines:W,priceLines:le,resizeObserver:Pe,chartType:M.chartType,configKey:l,legendEl:C,renderLegend:R,indicatorLegendItems:se,alertPriceLines:[]},Ml($)}catch(i){if(e!==Nn)return;if(M.error=(i==null?void 0:i.message)||"Could not initialize chart widget.",ee.chart){he(M.error);return}let r=document.getElementById("xpd-tv-widget");r&&(r.innerHTML=`<div class="xpd-error">${y(M.error)}</div>`)}}}function xc(){let e=Q(jo)==="1"?"0":"1";Z(jo,e),j()}async function kc(e){In.some(t=>t.id===e)&&(M.pair=e,await Is(),At(),j())}async function $c(e){M.interval=e,await Is(),At(),j()}function Sc(e){M.chartType=e,At(),j()}async function Tc(){await Is(),j()}function Cc(e,t){e in M.indicators&&(M.indicators[e]=!!t,t&&(M.selectedIndicator=e,M.selectedEducationTab="indicator"),At(),j())}function Pc(){M.indicatorMenuOpen=!M.indicatorMenuOpen,j()}function Mc(){M.moreMenuOpen=!M.moreMenuOpen,j()}function Lc(e){M.indicatorQuery=String(e||""),M.indicatorMenuOpen||(M.indicatorMenuOpen=!0),j()}function Ac(e){let t=String(e||"").trim();t in M.indicators&&(M.indicators[t]=!0,M.selectedIndicator=t,M.selectedEducationTab="indicator",At(),j())}function Ec(e){let t=String(e||"").trim();t in M.indicators&&(M.indicators[t]=!1,At(),j())}function wh(e){var s,a;if(M.settingsOpenFor!==e)return"";let t=M.indicatorSettings[e]||{},n=oi[e]||[];return`
    ...
    </div>`}function Nc(e){let t=String(e||"").trim();t in M.indicators&&(M.settingsOpenFor=M.settingsOpenFor===t?null:t,j())}function Rc(){M.settingsOpenFor=null,j()}function _c(e){let t=String(e||"").trim();if(!(t in M.indicators))return;let n=M.indicatorSettings[t]||{},s={...n};for(let a of oi[t]||[]){let o=document.getElementById(`xpd-ind-${a.id}-${t}`);o&&(a.type==="number"?s[a.id]=Math.max(2,Math.min(500,Number(o.value)||n[a.id]||a.default)):s[a.id]=o.value)}M.indicatorSettings[t]=s,M.settingsOpenFor=null,j()}function Dc(e){let t=String(e||"").trim();delete M.indicatorSettings[t],M.settingsOpenFor=null,j()}function Ic(){At(),Hs(window.location.href),ne("Chart link copied.")}function Fc(){M.threeEnabled=!M.threeEnabled,Z(ai,M.threeEnabled?"1":"0"),M.threeEnabled||Fs(),j()}function Oc(e){let t=!!e;M.threeEnabled!==t&&(M.threeEnabled=t,Z(ai,M.threeEnabled?"1":"0"),M.threeEnabled||Fs(),j())}function Bc(e){M.comparePair=e||"",At(),j()}function Xc(e){let t=String(e||"").trim();!t||!(t in M.indicators)||(M.indicators[t]=!0,M.selectedIndicator=t,j())}function Hc(e){let t=String(e||"none");jl.some(n=>n.key===t)&&(M.drawingTool=t,M.educationHint=lf[t]||"",j())}function Na(){var e;return((e=M.chartMeta)==null?void 0:e.tokenKey)||M.tokenFocusKey||`${Ea().symbol||"XRP"}|`}function zc(){var s,a;let e=Number((s=M.chartMeta)==null?void 0:s.last),t=prompt(`Alert me when ${((a=M.chartMeta)==null?void 0:a.symbol)||"price"} crosses:`,Number.isFinite(e)?e.toFixed(6):"");if(t==null)return;let n=Number(t);if(!Number.isFinite(n)||n<=0){he("Enter a valid price.");return}M.alerts=[...M.alerts||[],{id:`alert_${Date.now()}`,tokenKey:Na(),price:n,createdAt:new Date().toISOString()}],ri(),j(),ne(`Alert set at $${_(n,6)}`)}function Wc(e){M.alerts=(M.alerts||[]).filter(t=>t.id!==e),ri(),j()}function Ml(e){if(!e)return;let t=window.LightweightCharts;for(let s of ee.alertPriceLines||[])try{e.removePriceLine(s)}catch{}let n=(M.alerts||[]).filter(s=>s.tokenKey===Na());ee.alertPriceLines=n.map(s=>{var a;return e.createPriceLine({price:s.price,color:"#ffb703",lineWidth:2,lineStyle:((a=t==null?void 0:t.LineStyle)==null?void 0:a.Dotted)??2,axisLabelVisible:!0,title:"\u{1F514} Alert"})})}function xh(e){var r,l;if(e.length<2)return;let t=Na(),n=(M.alerts||[]).filter(c=>c.tokenKey===t);if(!n.length)return;let s=e[e.length-2].close,a=e[e.length-1].close,o=[],i=!1;for(let c of n){let p=s<c.price&&a>=c.price,u=s>c.price&&a<=c.price;p||u?(ne(`\u{1F514} ${((r=M.chartMeta)==null?void 0:r.symbol)||"Price"} crossed $${_(c.price,6)} (${p?"\u2191":"\u2193"} now $${_(a,6)})`),i=!0,(l=document.querySelector(`.xpd-indicator-chip[data-alert-id="${c.id}"]`))==null||l.remove()):o.push(c)}i&&(M.alerts=[...(M.alerts||[]).filter(c=>c.tokenKey!==t),...o],ri())}function Uc(){let e=ee.activeSeries;if(e)for(let t of ee.priceLines||[])try{e.removePriceLine(t)}catch{}ee.priceLines=[],M.drawings=[]}function Ra(e,t=0){var i;let n=(i=ee.chart)==null?void 0:i.timeScale();if(!n)return;let s=n.getVisibleLogicalRange();if(!s)return;let a=(s.to-s.from)*e,o=(s.to+s.from)/2+(s.to-s.from)*t;n.setVisibleLogicalRange({from:o-a/2,to:o+a/2})}function jc(){Ra(.8)}function qc(){Ra(1.25)}function Vc(){Ra(1,-.2)}function Gc(){Ra(1,.2)}function Kc(){M.educationCollapsed=!M.educationCollapsed,j()}function Jc(e){["indicator","psychology","practice"].includes(e)&&(M.selectedEducationTab=e,j())}function Yc(){let e=document.body.classList.contains("theme-gold");Cn(e?"cosmic":"gold"),j()}var Ll=!1;function kh(){let e=document.getElementById("xpd-tv-widget");e&&ee.chart&&(ee.chart.applyOptions({width:Math.max(320,e.clientWidth||320),height:Math.max(320,e.clientHeight||460)}),Qo())}function Qc(){var t;let e=document.querySelector(".xpd-chart-wrap");e&&(Ll||(Ll=!0,document.addEventListener("fullscreenchange",()=>{requestAnimationFrame(()=>requestAnimationFrame(kh))})),document.fullscreenElement?document.exitFullscreen():(t=e.requestFullscreen)==null||t.call(e))}function Zc(){let e=ee.chart;if(!e){he("Chart image is not ready yet.");return}let t=e.takeScreenshot(),n=document.createElement("a");n.download=`xrpl-chart-${Date.now()}.png`,n.href=t.toDataURL("image/png"),n.click()}function ed(){return M.tokenFocusKey||M.pair||"default"}function td(){var n;let e=ge(Q(qo))||{},t=ed();e[t]={interval:M.interval,chartType:M.chartType,comparePair:M.comparePair,indicators:M.indicators,indicatorSettings:M.indicatorSettings},Z(qo,JSON.stringify(e)),ne(`Chart layout saved for ${((n=M.chartMeta)==null?void 0:n.symbol)||t}.`)}function nd(){var s;let e=ge(Q(qo))||{},t=ed(),n=e[t];if(!n){he(`No saved layout for ${((s=M.chartMeta)==null?void 0:s.symbol)||t} yet.`);return}M.interval=n.interval||M.interval,M.chartType=n.chartType||M.chartType,M.comparePair=n.comparePair||"",M.indicators={...M.indicators,...n.indicators||{}},M.indicatorSettings={...M.indicatorSettings,...n.indicatorSettings||{}},At(),j()}function _a(e){let t=String(e||"").trim();if(/^[0-9A-F]{40}$/i.test(t)){let n=t.replace(/(00)+$/g,"");if(/^[0-9A-F]+$/i.test(n)&&n.length%2===0)try{let s=new Uint8Array(n.length/2);for(let o=0;o<n.length;o+=2)s[o/2]=parseInt(n.slice(o,o+2),16);let a=new TextDecoder().decode(s).replace(/\0/g,"").trim();if(a)return a.toUpperCase()}catch{}}return t.toUpperCase()}function qe(e){return`${e.symbol}|${e.issuer||""}`}function Ps(e){return encodeURIComponent(e).replace(/'/g,"%27")}function $h(e){var l,c,p,u,d,m,f,g,b,h;let t=_a(e.code||e.currency||""),n=String(e.issuer||((l=e.IssuingAccount)==null?void 0:l.account)||"").trim(),s=Number(e.price??((c=e.metrics)==null?void 0:c.price)??0),a=Number(e.marketcap??((p=e.metrics)==null?void 0:p.marketcap)??0),o=Number(((u=e.metrics)==null?void 0:u.volume_24h)??0),i=((m=(d=e.meta)==null?void 0:d.token)==null?void 0:m.name)||((f=e.IssuingAccount)==null?void 0:f.name)||t||"Unknown Token",r=Number(e.holders??((g=e.metrics)==null?void 0:g.holders)??((b=e.metrics)==null?void 0:b.trustlines)??0);return{symbol:t,name:i,issuer:n,tokenId:e.id||`${t}.${n}`,price:Number.isFinite(s)&&s>0?s:null,marketCap:Number.isFinite(a)&&a>0?a:null,volume24h:Number.isFinite(o)?o:null,holders:Number.isFinite(r)?r:null,change24h:null,verified:!!((h=e.IssuingAccount)!=null&&h.verified),score:Number(e.score||0)||null}}function Sh(e){let t=_a((e==null?void 0:e.symbol)||""),n=String((e==null?void 0:e.name)||t||"Unknown Token"),s=Number((e==null?void 0:e.current_price)||0),a=Number((e==null?void 0:e.market_cap)||0),o=Number((e==null?void 0:e.total_volume)||0),i=Number((e==null?void 0:e.price_change_percentage_24h)||0);return{symbol:t,name:n,issuer:"",tokenId:`cg:${(e==null?void 0:e.id)||t}`,price:Number.isFinite(s)&&s>0?s:null,marketCap:Number.isFinite(a)&&a>0?a:null,volume24h:Number.isFinite(o)&&o>0?o:null,holders:null,change24h:Number.isFinite(i)?i:null,verified:!1,score:null}}function Th(e){var r;let t=_a((e==null?void 0:e.currency)||(e==null?void 0:e.token)||""),n=String((e==null?void 0:e.issuer)||(e==null?void 0:e.account)||"").trim(),s=String((e==null?void 0:e.name)||t||"Unknown Token"),a=Number((e==null?void 0:e.price)||((r=e==null?void 0:e.market)==null?void 0:r.price)||0),o=Number((e==null?void 0:e.marketcap)||(e==null?void 0:e.marketCap)||0),i=Number((e==null?void 0:e.volume24h)||(e==null?void 0:e.volume)||0);return{symbol:t,name:s,issuer:n,tokenId:`bithomp:${t}.${n||"na"}`,price:Number.isFinite(a)&&a>0?a:null,marketCap:Number.isFinite(o)&&o>0?o:null,volume24h:Number.isFinite(i)&&i>0?i:null,holders:Number.isFinite(Number((e==null?void 0:e.holders)||0))?Number((e==null?void 0:e.holders)||0):null,change24h:Number.isFinite(Number((e==null?void 0:e.change24h)||0))?Number((e==null?void 0:e.change24h)||0):null,verified:!!(e!=null&&e.verified),score:null}}function Ch(e){let t=_a((e==null?void 0:e.symbol)||(e==null?void 0:e.currency)||""),n=String((e==null?void 0:e.issuer)||(e==null?void 0:e.issuerAddress)||"").trim(),s=String((e==null?void 0:e.name)||t||"Unknown Token"),a=Number((e==null?void 0:e.price)||0),o=Number((e==null?void 0:e.volume24h)||0);return{symbol:t,name:s,issuer:n,tokenId:`xrplto:${t}.${n||"na"}`,price:Number.isFinite(a)&&a>0?a:null,marketCap:Number.isFinite(Number((e==null?void 0:e.marketCap)||0))?Number((e==null?void 0:e.marketCap)||0):null,volume24h:Number.isFinite(o)&&o>0?o:null,holders:Number.isFinite(Number((e==null?void 0:e.holders)||0))?Number((e==null?void 0:e.holders)||0):null,change24h:Number.isFinite(Number((e==null?void 0:e.change24h)||0))?Number((e==null?void 0:e.change24h)||0):null,verified:!!(e!=null&&e.verified),score:null}}async function sd(){var e,t,n,s,a,o;if(Ma()){U.loading=!0,U.error="";try{let i=Date.now(),r=hl.get("tokens");if(r&&i-r.ts<6e4){U.tokens=r.data,U.total=r.total||r.data.length,U.lastSyncAt=r.ts,U.filtered=as(U.query,r.data),U.trending=Al(r.data),U.loading=!1;return}let l=500,c=12,p=[];for(let S=1;S<=c;S+=1){let $=await Lt(`${Wm}?page=${S}&limit=${l}`,{allowProxy:!1,timeoutMs:12e3});if(!Array.isArray($)||!$.length||(p.push(...$),$.length<l))break}let u=p.map($h).filter(S=>!!S.symbol&&!!S.issuer),d=[Lt(`${Um}?vs_currency=usd&order=market_cap_desc&per_page=250&page=1&sparkline=false`,{timeoutMs:12e3}).catch(()=>[]),Date.now()<(bl.xrplto||0)?Promise.resolve([]):Lt(qm,{timeoutMs:12e3,allowProxy:!1}).catch(S=>(String((S==null?void 0:S.message)||"").includes("429")&&(bl.xrplto=Date.now()+5*60*1e3),[]))];Vm&&d.push(Lt(jm,{timeoutMs:12e3,allowProxy:!1}).catch(()=>[]));let[m,f,g=[]]=await Promise.all(d),b=Array.isArray(m)?m.map(Sh).filter(S=>!!S.symbol):[],h=Array.isArray(g)?g.map(Th).filter(S=>!!S.symbol):[],v=Array.isArray(f)?f.map(Ch).filter(S=>!!S.symbol):[],x={symbol:"XRP",name:"XRP Ledger Native",issuer:"",tokenId:"XRP",price:((e=Te.data)==null?void 0:e.priceUsd)||((t=M.stats)==null?void 0:t.price)||null,marketCap:((n=Te.data)==null?void 0:n.marketCap)||null,volume24h:((s=Te.data)==null?void 0:s.volume24h)||null,holders:null,change24h:((a=Te.data)==null?void 0:a.change24h)||((o=M.stats)==null?void 0:o.changePct)||null,verified:!0,score:1},k=new Map;[x,...u,...h,...v,...b].forEach(S=>{let $=qe(S);k.has($)||k.set($,S)});let T=[...k.values()];hl.set("tokens",{ts:i,data:T,total:T.length}),U.tokens=T,U.total=T.length,U.lastSyncAt=i,U.filtered=as(U.query,T),U.trending=Al(T)}catch(i){U.error=(i==null?void 0:i.message)||"Could not load XRPL token discovery data."}finally{U.loading=!1}}}function as(e,t){let n=String(e||"").trim().toLowerCase(),s=U.filters||{type:"all",minCap:0,minVol:0,hasDex:!1};return t.filter(a=>{if(n&&!`${a.symbol} ${a.name} ${a.issuer} ${a.tokenId||""}`.toLowerCase().includes(n)||Number(s.minCap||0)>0&&Number(a.marketCap||0)<Number(s.minCap||0)||Number(s.minVol||0)>0&&Number(a.volume24h||0)<Number(s.minVol||0)||s.hasDex&&!(Number(a.volume24h||0)>0||Number(a.holders||0)>100))return!1;if(s.type&&s.type!=="all"){let o=String(a.symbol||"").toLowerCase(),i=String(a.name||"").toLowerCase(),r=/usd|usdc|usdt|rlusd|eur|gbp/.test(o)||/stable/.test(i),l=/meme|dog|cat|frog|shib|pepe/.test(o)||/meme/.test(i),c=/mpt/.test(o)||/multi-purpose/.test(i);if(s.type==="stablecoin"&&!r||s.type==="meme"&&!l||s.type==="mpt"&&!c||s.type==="standard"&&(r||l||c))return!1}return!0})}function Al(e){return[...e].sort((t,n)=>{let s=Number(t.volume24h||0),a=Number(n.volume24h||0);if(a!==s)return a-s;let o=Number(t.marketCap||0);return Number(n.marketCap||0)-o}).slice(0,24)}async function ad(e){if(Pt.loading=!0,Pt.error="",Pt.items=[],!e){Pt.loading=!1;return}try{let t=await vi(e,20);Pt.items=t||[]}catch(t){Pt.error=(t==null?void 0:t.message)||"Could not load recent transactions."}finally{Pt.loading=!1}}function od(e){U.query=e,Ls&&clearTimeout(Ls),Ls=setTimeout(()=>{U.listLimit=240,U.filtered=as(U.query,U.tokens),j()},300)}function id(e,t){U.filters={...U.filters,[e]:t},U.listLimit=240,U.filtered=as(U.query,U.tokens),j()}function rd(){Ls&&clearTimeout(Ls),U.query="",U.filters={type:"all",minCap:0,minVol:0,hasDex:!1},U.listLimit=240,U.filtered=as("",U.tokens),j()}function ld(){U.listLimit=Math.min(5e3,Number(U.listLimit||240)+240),j()}function cd(){let e=U.filtered;U.listLimit=Math.min(5e3,Math.max(240,e.length)),j()}function dd(){U.listLimit=240,j()}function pd(e){U.selectedTokenKey=e||"",j()}function ud(e){let t=String(e||"").trim();if(!t)return;let n=li();n.includes(t)||n.push(t),Yl(n),j()}function md(e){let t=String(e||"").trim(),n=li().filter(s=>s!==t);Yl(n),j()}async function Da(e){let t=String(e||"").trim();if(!t)return;let n=String(t.includes("|")?t.split("|")[0]:t).toUpperCase(),s=t.includes("|")?U.tokens.find(o=>qe(o)===t):U.tokens.find(o=>String(o.symbol||"").toUpperCase()===String(n||"").toUpperCase());U.selectedTokenKey=s?qe(s):t.includes("|")?t:U.selectedTokenKey,M.tokenFocusKey=U.selectedTokenKey||t;let a={BTC:"BINANCE:BTCUSDT",ETH:"BINANCE:ETHUSDT",SOL:"BINANCE:SOLUSDT"};M.pair=a[n]||"BITSTAMP:XRPUSD",At(),j(),setTimeout(()=>uf(),20),await Is(),At(),j()}async function fd(e){return Da(e)}async function hd(){await sd(),j()}async function mi(){let e=document.getElementById("xpd-lookup-currency"),t=document.getElementById("xpd-lookup-issuer"),n=String((e==null?void 0:e.value)||"").trim().toUpperCase(),s=String((t==null?void 0:t.value)||"").trim();if(!n){he("Enter a currency code first.");return}if(!s||!He(s)){he("Enter a valid XRPL issuer address.");return}let a=`${n}|${s}`,o=U.tokens.find(i=>qe(i)===a);o||(o={symbol:n,name:n,issuer:s,price:null,marketCap:null,volume24h:null,holders:null,tokenId:""},U.tokens=[...U.tokens,o],U.filtered=as(U.query,U.tokens)),U.selectedTokenKey=a,e&&(e.value=""),t&&(t.value=""),await Da(a)}async function gd(){var s,a;let e=String(((s=document.getElementById("xpd-lookup-currency"))==null?void 0:s.value)||"").trim().toUpperCase(),t=String(((a=document.getElementById("xpd-lookup-issuer"))==null?void 0:a.value)||"").trim();if(!e){he("Enter a currency code first.");return}if(!t||!He(t)){he("Enter a valid XRPL issuer address.");return}let n=`${e}|${t}`;await mi(),await ci(n)}async function vd(){var t;let e=((t=Et())==null?void 0:t.address)||"";await ad(e),j()}async function ts({silent:e=!1,force:t=!1}={}){var s;if(!t&&!Ma())return;let n=((s=Et())==null?void 0:s.address)||"";e||ne("Refreshing XRPL dashboard data..."),await Promise.allSettled([Is(),oc(),sd(),ad(n),ic(n),rc(n),cc()]),j()}function bd(){return oc()}function yd(){var e;return ic(((e=Et())==null?void 0:e.address)||"")}function wd(){var e;return rc(((e=Et())==null?void 0:e.address)||"")}function xd(){return cc()}function kd(e){ne(`NFT ${e.slice(0,12)}... selected. Send flow can be wired to NFTokenCreateOffer.`)}function Ds(){let e=w("profile-metrics-row");if(!e)return;let t=!1,n=Object.values(Ze).reduce((u,d)=>u+((d==null?void 0:d.xrp)||0),0),s=$d(),a=Object.values(Ze).flatMap(u=>(u==null?void 0:u.tokens)||[]),o=Et(),i=o?Ms[o.address]:null,r=(i==null?void 0:i.ownerCount)||0,l=Ta+r*Ca,c=o!=null&&o.createdAt?Mh(new Date(o.createdAt)):"\u2014",p=(i==null?void 0:i.sequence)!=null?i.sequence:"\u2014";e.innerHTML=`
    ...
    <div class="pmetric pmetric-reserve" title="${r} owned objects \xD7 ${Ca} XRP + ${Ta} XRP base">
      ...
      <div class="pmetric-label">Reserved</div></div>`:""}`,o&&(!Ms[o.address]||Date.now()-Ms[o.address].fetchedAt>6e4)&&Ph(o.address).then(()=>Ds())}async function Ph(e){try{let t=await at({method:"account_info",params:[{account:e,ledger_index:"validated"}]});t!=null&&t.account_data&&(Ms[e]={sequence:t.account_data.Sequence,ownerCount:t.account_data.OwnerCount||0,fetchedAt:Date.now()})}catch{}}function Mh(e){let t=Math.floor((Date.now()-e.getTime())/864e5);if(t<1)return"Today";if(t<30)return`${t}d`;if(t<365)return`${Math.floor(t/30)}mo`;let n=Math.floor(t/365),s=Math.floor(t%365/30);return s?`${n}y ${s}mo`:`${n}y`}function $d(){var t;if(Array.isArray((t=window.__dashSeries)==null?void 0:t.marketPrice)){let n=window.__dashSeries.marketPrice.at(-1);if(n!=null&&Number.isFinite(n))return n}let e=document.getElementById("mkt-price");if(e){let n=parseFloat(e.textContent.replace("$",""));if(!isNaN(n))return n}return 0}function Lh(){let e=oe.length>0,t=Object.values(Ke).some(Boolean),n=!!ce.bio,s=!!localStorage.getItem("naluxrp_last_backup_ts"),a=[e,t,n,s].filter(Boolean).length;return a===4?"":`
  ...
  </div>`}function fi(){let e=w("profile-tab-social");if(!e)return;let t=Object.values(Ke).filter(Boolean).length;e.innerHTML=`
    ...
    <div class="social-grid">
      ${ss.map(n=>{let s=Ke[n.id]||"",a=!!s;return`<div class="social-card ${a?"social-card--connected":""}" id="social-item-${n.id}">
    ...
    ${t?`<div class="social-preview-row">
    ...
    </div>`:""}`,La("stat-socials-val",t)}function Sd(e){let t=ss.find(l=>l.id===e);if(!t)return;let n=w("social-modal");if(!n)return;let s=w("social-modal-icon"),a=w("social-modal-title"),o=w("social-modal-sub"),i=w("social-modal-input"),r=w("social-modal-delete");s&&(s.className=`social-platform-icon-lg social-icon ${t.id}`,s.textContent=t.icon),a&&(a.textContent=`Connect ${t.label}`),o&&(o.textContent=`Enter your ${t.label} ${t.id==="discord"?"user ID or username":"username"}.`),i&&(i.value=Ke[e]||"",i.placeholder=`Your ${t.label} handle`),r&&(r.style.display=Ke[e]?"":"none"),n.dataset.platform=e,n.classList.add("show"),setTimeout(()=>i==null?void 0:i.focus(),80)}function Td(){let e=w("social-modal"),t=e==null?void 0:e.dataset.platform,n=w("social-modal-input");if(!t||!n)return;let s=n.value.trim().replace(/^@/,"");s?Ke[t]=s:delete Ke[t],Gl(),fi(),os();let a=ss.find(o=>o.id===t);lg(),kt("social_connected",`${(a==null?void 0:a.label)||t} @${s||"(removed)"}`),ne(`${a==null?void 0:a.label} updated`)}function Cd(){var t;let e=(t=w("social-modal"))==null?void 0:t.dataset.platform;e&&(delete Ke[e],Gl(),fi(),os(),kt("social_removed",e),ne("Social connection removed"))}function Pd(e){let t=ss.find(n=>n.id===e);t&&Ke[e]&&window.open(`${t.prefix}${Ke[e]}`,"_blank","noopener")}function os(){var e;(e=w("social-modal"))==null||e.classList.remove("show")}function $t(){let e=w("profile-tab-wallets");if(!e)return;if(oe.length===0){e.innerHTML=Lh()+`
      ...
      </div>`,La("stat-wallets-val",0);return}let t=oe.length>3?`
    ...
    </div>`:"",n=oe.filter(a=>!es||a.label.toLowerCase().includes(es.toLowerCase())||a.address.toLowerCase().includes(es.toLowerCase())),s=n.map((a,o)=>Ah(a,oe.indexOf(a))).join("");e.innerHTML=t+(n.length?s:`<div class="wcard-empty">No wallets match "${y(es)}"</div>`)+`
    ...
    </div>`,La("stat-wallets-val",oe.length)}function Ah(e,t){let n=e.id===dt,s=!!e.watchOnly,a=Ze[e.address],o=Ms[e.address],r=!0||s,l=(o==null?void 0:o.ownerCount)||0,c=Ta+l*Ca,p=r?a?_(a.xrp,2):"\u2014":"\u2022\u2022\u2022\u2022",u=a&&r?Math.max(0,a.xrp-c):null,d=(a==null?void 0:a.tokens)||[],m=a!=null&&a.fetchedAt?Kl(a.fetchedAt):null,f=e.address.slice(0,8)+"\u2026"+e.address.slice(-6),g=gi(e.address);return`
  <div class="wcard ${n?"wcard--active":""} ${s?"wcard--watch":""}" id="wallet-item-${e.id}" style="--i:${t}">
    <div class="wcard-top">
      ...
      <div class="wcard-balance-col">
        ${g.length>=2?`<div class="wcard-sparkline">${_d(g,70,22,e.color||"#00fff0")}</div>`:""}
  ...
  </div>`}function Md(e){var n;let t=oe[e];t&&(oe.splice(e,1),Rs(),dt===t.id&&(dt=((n=oe[0])==null?void 0:n.id)||null,dt&&Z(Es,dt)),$t(),Ot(),kt("wallet_removed",t.label),Eh(`Wallet "${t.label}" removed`,()=>{oe.splice(e,0,t),Rs(),dt||(dt=t.id,Z(Es,t.id)),$t(),Ot(),kt("wallet_created",t.label+" (restored)")},()=>{t.address&&vt(ei+t.address)}))}function Eh(e,t,n){let s=document.getElementById("undo-toast");s&&s.remove();let a=document.createElement("div");a.id="undo-toast",a.className="undo-toast",a.innerHTML=`<span class="undo-msg">${y(e)}</span><button class="undo-btn">Undo</button>`,document.body.appendChild(a),requestAnimationFrame(()=>a.classList.add("show"));let o=setTimeout(()=>{a.classList.remove("show"),setTimeout(()=>a.remove(),300),n==null||n()},5e3);a.querySelector(".undo-btn").addEventListener("click",()=>{clearTimeout(o),t(),a.classList.remove("show"),setTimeout(()=>a.remove(),300),ne("Wallet restored")})}function Ld(e){var n,s;let t=w("inspect-addr");t&&(t.value=e),(n=window.switchTab)==null||n.call(window,document.querySelector('[data-tab="inspector"]'),"inspector"),(s=window.showDashboard)==null||s.call(window)}function Ad(e){Rn=Rn===e?null:e,Rn&&!dn[e]&&(dn[e]="txns"),$t(),Rn&&setTimeout(()=>hi(e,dn[e]),60)}function Ed(e,t){dn[e]=t;let n=document.getElementById(`wcard-drawer-${e}`);n&&(n.querySelectorAll(".wdt-btn").forEach(s=>s.classList.toggle("active",s.textContent.toLowerCase().includes(t==="txns"?"trans":t==="nfts"?"nft":t==="orders"?"dex":"amm"))),hi(e,t))}async function hi(e,t){var a,o,i;let n=oe.find(r=>r.id===e),s=document.getElementById(`wcard-drawer-body-${e}`);if(!(!n||!s)){s.innerHTML='<div class="wdd-loading"><div class="spinner"></div> Loading\u2026</div>';try{t==="txns"?s.innerHTML=Nh(((a=ni[n.address])==null?void 0:a.txns)||await vi(n.address),n.address):t==="nfts"?s.innerHTML=Rh(((o=Il[n.address])==null?void 0:o.nfts)||await jh(n.address),n.address):t==="orders"?s.innerHTML=_h(((i=si[n.address])==null?void 0:i.offers)||await qh(n.address),n.id,n.address):t==="amm"&&(s.innerHTML=await Dh(n.address))}catch(r){s.innerHTML=`<div class="wdd-error">\u26A0\uFE0F ${y(r.message)}</div>`}}}function Nd(e){return{Payment:"\u{1F4B8}",OfferCreate:"\u{1F4CA}",OfferCancel:"\u2715",TrustSet:"\u{1F517}",NFTokenMint:"\u{1F3A8}",NFTokenBurn:"\u{1F525}",NFTokenCreateOffer:"\u{1F3AF}",NFTokenAcceptOffer:"\u2705",AMMCreate:"\u{1F30A}",AMMDeposit:"\u{1F4E5}",AMMWithdraw:"\u{1F4E4}",AMMVote:"\u{1F5F3}",AMMBid:"\u{1F4A1}",EscrowCreate:"\u23F3",EscrowFinish:"\u2705",EscrowCancel:"\u2715",AccountSet:"\u2699",SetRegularKey:"\u{1F511}",SignerListSet:"\u{1F4CB}"}[e]||"\u{1F4C4}"}function Zo(e){return e?typeof e=="string"?`${_(Number(e)/1e6,4)} XRP`:`${_(parseFloat(e.value||0),4)} ${(e.currency||"?").length>4?e.currency.slice(0,4)+"\u2026":e.currency}`:"\u2014"}function Nh(e,t){return e!=null&&e.length?`<div class="wdd-tx-list">
    ${e.slice(0,25).map(n=>{var c,p;let s=n.TransactionType||"?",a=n.Account===t,o=!(((c=n.metaData)==null?void 0:c.TransactionResult)||((p=n.meta)==null?void 0:p.TransactionResult)||"").match(/^tec|^tem|^tef|^tel/),i=n.date?(n.date+946684800)*1e3:0,r=i?new Date(i).toLocaleDateString("en-US",{month:"short",day:"numeric",hour:"2-digit",minute:"2-digit"}):"\u2014",l=n.hash||n.tx_hash||"";return`<div class="wdd-tx-row ${o?"":"wdd-tx-failed"}">
        <div class="wdd-tx-icon">${Nd(s)}</div>
        <div class="wdd-tx-body">
          ...
          <div class="wdd-tx-detail">
            ...
            ${n.Destination?`<span class="wdd-tx-dest mono">${Fl[n.Destination]||n.Destination.slice(0,8)+"\u2026"+n.Destination.slice(-5)}</span>`:""}
          </div>
        </div>
  ...
  </div>`:'<div class="wdd-empty"><div class="wdd-empty-icon">\u{1F4CB}</div><div>No transactions yet.</div><div class="wdd-empty-sub">Fund with 10 XRP to activate.</div></div>'}function Rh(e,t){return e!=null&&e.length?`<div class="wdd-nft-header"><span>${e.length} NFT${e.length>1?"s":""}</span>
    ...
    ${e.length>24?`<div class="wdd-more-note">${e.length-24} more on XRPScan</div>`:""}`:'<div class="wdd-empty"><div class="wdd-empty-icon">\u{1F3A8}</div><div>No NFTs in this wallet.</div></div>'}function _h(e,t,n){return e!=null&&e.length?`<div class="wdd-orders-header"><span>${e.length} open order${e.length>1?"s":""}</span></div>
    ...
    </div>`:'<div class="wdd-empty"><div class="wdd-empty-icon">\u{1F4CA}</div><div>No open DEX orders.</div></div>'}async function Dh(e){try{let n=(ti[e]||[]).filter(s=>{var a;return((a=s.currency)==null?void 0:a.length)===40});return n.length?`<div class="wdd-amm-list">
    ...
    </div>`:'<div class="wdd-empty"><div class="wdd-empty-icon">\u{1F30A}</div><div>No AMM LP positions.</div><div class="wdd-empty-sub">Deposit into an AMM pool to earn fees.</div></div>'}catch(t){return`<div class="wdd-error">\u26A0\uFE0F ${y(t.message)}</div>`}}async function Rd(e,t,n){let s=prompt("Optional seed to cancel this order (leave blank to use wallet password):");if(s!==null){n&&(n.disabled=!0,n.textContent="\u2026");try{let a=await Qh(e,t,s);if(Kh(a)){ne("Order cancelled \u2713");let o=oe.find(i=>i.id===e);o&&(delete si[o.address],hi(e,"orders"))}else Wt("Cancel failed: "+Jh(a)),n&&(n.disabled=!1,n.textContent="\u2715 Cancel")}catch(a){Wt(a.message),n&&(n.disabled=!1,n.textContent="\u2715 Cancel")}}}function Ih(){let e=w("profile-tab-activity");if(!e)return;let t=gf(),n=Et();e.innerHTML=`
        ...
        ${t.length?`<div class="act-timeline">${t.slice(0,20).map(s=>`
            <div class="act-entry">
              ...
              <div class="act-entry-body">
                ...
                <div class="act-entry-time">${Kl(s.ts)}</div>
              </div>
    ...
    <div class="settings-card settings-card--danger">
  ...
  </div>`}async function Fh(){var t;let e=w("profile-tab-analytics");if(e){e.innerHTML='<div class="analytics-grid"><div class="skeleton-card analytics-card--wide" style="height:80px"></div><div class="skeleton-card" style="height:160px"></div><div class="skeleton-card" style="height:160px"></div></div>';try{let n=Et(),s=Object.values(Ze).reduce((r,l)=>r+((l==null?void 0:l.xrp)||0),0),a=$d(),o=Object.values(Ze).flatMap(r=>(r==null?void 0:r.tokens)||[]),i=[];if(n)try{i=((t=ni[n.address])==null?void 0:t.txns)||await vi(n.address,100)}catch{}e.innerHTML=`<div class="analytics-grid">
      <div class="analytics-card analytics-card--wide">
        ...
        <div class="portfolio-summary-row">
          ${oe.length?oe.map(r=>{let l=Ze[r.address],c=l?_(l.xrp,2):"\u2014",p=l&&a?`$${_(l.xrp*a,2)}`:"",u=gi(r.address);return`<div class="portfolio-wallet-row">
                ...
                <div class="pwr-sparkline">${_d(u,80,28,r.color||"#00fff0")}</div>
      ...
      <div class="analytics-card analytics-card--wide">
        ...
        ${n?Bh(i):'<div class="analytics-empty">Activate a wallet to see activity.</div>'}
      </div>
      ...
      <div class="analytics-card">
        ...
        ${n&&i.length?zh(i,n.address):`<div class="analytics-empty-chart"><div class="aec-icon">\u{1F4B0}</div><div>${n?"XRP flow needs at least one transaction to estimate.":"Activate a wallet to see XRP flow."}</div></div>`}
      </div>
      ...
      <div class="analytics-card">
        ...
        ${o.length?Hh(o):'<div class="analytics-empty-chart"><div class="aec-icon">\u{1FA99}</div><div>No token trustlines held by any wallet yet.</div></div>'}
      </div>
    </div>`}catch(n){ff(e,"analytics",n)}}}function _d(e,t,n,s){if(e.length<2)return`<svg width="${t}" height="${n}"><line x1="0" y1="${n/2}" x2="${t}" y2="${n/2}" stroke="${s}" stroke-opacity=".2" stroke-width="1" stroke-dasharray="3 2"/></svg>`;let a=e.map(u=>u.xrp),o=Math.min(...a),i=Math.max(...a),r=i-o||1,l=a.map((u,d)=>`${3+d/(a.length-1)*(t-6)},${3+(1-(u-o)/r)*(n-6)}`),[c,p]=l[l.length-1].split(",");return`<svg width="${t}" height="${n}" viewBox="0 0 ${t} ${n}">
  ...
  </svg>`}function Oh(e){let t=gi(e);if(t.length<2)return`<div class="analytics-empty-chart"><div class="aec-icon">\u{1F4CA}</div><div>Balance history builds up as you refresh your wallet over time.</div><div class="aec-sub">${t.length} snapshot${t.length!==1?"s":""} recorded.</div></div>`;let n=560,s=130,a=52,o=12,i=14,r=30,l=t.map(R=>R.xrp),c=t.map(R=>R.ts),p=Math.min(...l),u=Math.max(...l),d=u-p||1,m=c[0],f=c[c.length-1],g=f-m||1,b=R=>a+(R-m)/g*(n-a-o),h=R=>i+(1-(R-p)/d)*(s-i-r),v=t.map(R=>`${b(R.ts).toFixed(1)},${h(R.xrp).toFixed(1)}`),x=b(c[0]),k=b(c[c.length-1]),T=l[l.length-1]-l[0],S=T>=0,$=l[0]?Math.abs(T/l[0]*100).toFixed(2):"0.00",E=S?"#00d4ff":"#ff5555",C=[p,(p+u)/2,u].map(R=>({v:R,y:h(R),l:_(R,2)})),P=[0,.5,1].map(R=>({x:a+R*(n-a-o),l:new Date(m+R*g).toLocaleDateString("en-US",{month:"short",day:"numeric"})}));return`
    ...
    <div class="balance-chart-wrap"><svg class="balance-chart-svg" viewBox="0 0 ${n} ${s}" preserveAspectRatio="none">
      ...
      <polyline points="${v.join(" ")}" fill="none" stroke="${E}" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
      ${t.map(R=>`<circle cx="${b(R.ts).toFixed(1)}" cy="${h(R.xrp).toFixed(1)}" r="2" fill="${E}" opacity=".7"/>`).join("")}
  ...
  </svg></div>`}function Xh(e){let t=new Map;e.forEach(a=>t.set(a.TransactionType||"?",(t.get(a.TransactionType||"?")||0)+1));let n=[...t.entries()].sort((a,o)=>o[1]-a[1]),s=e.length;return`<div class="tx-breakdown-list">${n.slice(0,8).map(([a,o])=>`<div class="txb-row"><div class="txb-icon">${Nd(a)}</div><div class="txb-type">${a}</div><div class="txb-bar-wrap"><div class="txb-bar" style="width:${(o/s*100).toFixed(0)}%"></div></div><div class="txb-count">${o}</div></div>`).join("")}</div>`}function Hh(e){let t=new Map;e.forEach(o=>{let i=Math.abs(parseFloat(o.balance||0));t.set(o.currency,(t.get(o.currency)||0)+i)});let n=[...t.entries()].sort((o,i)=>i[1]-o[1]).slice(0,8),s=n.reduce((o,[,i])=>o+i,0)||1,a=["#00fff0","#00d4ff","#bd93f9","#50fa7b","#ffb86c","#ff79c6","#f1fa8c","#ff5555"];return`<div class="token-alloc-list">${n.map(([o,i],r)=>{let l=(i/s*100).toFixed(1),c=a[r%a.length],p=o.length>4?o.slice(0,4)+"\u2026":o;return`<div class="ta-row"><div class="ta-swatch" style="background:${c}"></div><div class="ta-cur mono">${p}</div><div class="ta-bar-wrap"><div class="ta-bar" style="width:${l}%;background:${c}20;border-color:${c}55"></div></div><div class="ta-pct">${l}%</div></div>`}).join("")}</div>`}function zh(e,t){let n=0,s=0;e.forEach(i=>{var c,p;if(i.TransactionType!=="Payment"||!((((c=i.metaData)==null?void 0:c.TransactionResult)||((p=i.meta)==null?void 0:p.TransactionResult))==="tesSUCCESS")||typeof i.Amount!="string")return;let l=Number(i.Amount)/1e6;i.Destination===t&&(n+=l),i.Account===t&&(s+=l)});let a=n-s,o=a>=0;return`<div class="xrp-flow-grid">
  ...
  <div class="xrf-note">Based on ${e.length} fetched Payment TXs. Excludes fees and DEX fills.</div>`}async function at(e){var n,s;try{if(((n=X.wsConn)==null?void 0:n.readyState)===1){let{wsSend:a}=await import("./xrpl-6AERZ5KD.js"),o={command:e==null?void 0:e.method,...((s=e==null?void 0:e.params)==null?void 0:s[0])||{}},i=await a(o);if((i==null?void 0:i.status)==="error")throw new Error(i.error_message||i.error||"XRPL RPC error");return(i==null?void 0:i.result)||null}}catch{}let t=async a=>{let o=await fetch(a,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(e),mode:"cors"});if(!o.ok)throw new Error(`HTTP ${o.status}`);return(await o.json()).result};try{return await t(Xm)}catch{return await t(Hm)}}async function Fn(e){var t;try{let n=[],s;do{let l=await at({method:"account_lines",params:[{account:e,ledger_index:"current",limit:400,...s?{marker:s}:{}}]});if(!l||l.error)break;n.push(...l.lines||[]),s=l.marker}while(s);let a=await at({method:"account_info",params:[{account:e,ledger_index:"current"}]});if(a!=null&&a.error)return null;let o=Number(a.account_data.Balance)/1e6,i=n.map(l=>({currency:l.currency,issuer:l.account,balance:l.balance,limit:l.limit}));Ze[e]={xrp:o,tokens:i,fetchedAt:Date.now()},ti[e]=i,Uh(e,o);let r=document.getElementById("awb-balance");return r&&e===((t=Et())==null?void 0:t.address)&&cg(r.querySelector(".awb-xrp-num")||r,o,2,600),Ze[e]}catch{return null}}async function Wh(){await Promise.allSettled(oe.map(e=>Fn(e.address))),$t(),Ot(),Ds()}function Uh(e,t){let n=ei+e,s=ge(Q(n))||[],a=Date.now();s.length&&a-s[s.length-1].ts<5*6e4?s[s.length-1]={xrp:t,ts:a}:s.push({xrp:t,ts:a}),s.length>90&&s.splice(0,s.length-90),Z(n,JSON.stringify(s))}function gi(e){return ge(Q(ei+e))||[]}async function vi(e,t=25){let n=await at({method:"account_tx",params:[{account:e,limit:t,ledger_index_min:-1,ledger_index_max:-1}]}),s=((n==null?void 0:n.transactions)||[]).map(a=>a.tx||a.transaction||a);return ni[e]={txns:s,fetchedAt:Date.now()},s}async function jh(e){let t=await at({method:"account_nfts",params:[{account:e,limit:50}]}),n=(t==null?void 0:t.account_nfts)||[];return Il[e]={nfts:n,fetchedAt:Date.now()},n}async function qh(e){let t=await at({method:"account_offers",params:[{account:e,limit:50}]}),n=(t==null?void 0:t.offers)||[];return si[e]={offers:n,fetchedAt:Date.now()},n}async function Vh(e){let t=await at({method:"account_info",params:[{account:e,ledger_index:"current"}]});return(t==null?void 0:t.account_data)||null}async function Gh(){let e=await at({method:"ledger",params:[{ledger_index:"current"}]});return(e==null?void 0:e.ledger_current_index)||0}function Kh(e){let t=(e==null?void 0:e.engine_result)||"";return t==="tesSUCCESS"||t.startsWith("tes")||(e==null?void 0:e.engine_result_code)===0}function Jh(e){let t=(e==null?void 0:e.engine_result)||"";return Ym[t]||(e==null?void 0:e.engine_result_message)||t||"Unknown error"}async function Yh(e,t,n){if(await Aa(),!window.xrpl)throw new Error("xrpl.js library not loaded. Cannot sign transactions.");let s=oe.find(i=>i.id===e);if(!s)throw new Error("Wallet not found.");if(s.watchOnly)throw new Error("Watch-only wallets cannot sign transactions.");let a=await ef(s,n),o;try{o=window.xrpl.Wallet.fromSeed(a,{algorithm:s.algo==="secp256k1"?"secp256k1":"ed25519"})}catch(i){throw new Error("Invalid seed phrase: "+i.message)}if(o.classicAddress!==s.address)throw new Error("Seed does not match this wallet address.");try{let[i,r]=await Promise.all([Vh(s.address),Gh()]);if(!i)throw new Error("Account not found on-chain. Fund with at least 10 XRP first (base reserve requirement).");let l={...t,Account:s.address,Fee:"12",Sequence:i.Sequence,LastLedgerSequence:r+20},{tx_blob:c,hash:p}=o.sign(l);return{...await at({method:"submit",params:[{tx_blob:c}]}),tx_hash:p}}finally{}}async function Qh(e,t,n){return Yh(e,{TransactionType:"OfferCancel",OfferSequence:parseInt(t)},n)}function Zh(){if(w("send-modal-overlay"))return;let e=document.createElement("div");e.innerHTML=`
  <!-- Send -->
  ...
  <div class="generic-modal-overlay" id="token-details-modal">
  ...
  </div>`,document.body.appendChild(e),["send-modal-overlay","receive-modal-overlay","trustline-modal-overlay","import-address-modal","import-seed-modal","token-details-modal"].forEach(t=>{let n=document.getElementById(t);n==null||n.addEventListener("click",s=>{s.target===n&&(n.classList.remove("show"),n.style.display="")})})}function Dd(){var o;["displayName","handle","bio","location","website"].forEach(i=>{let r=w(`edit-${i}`);r&&(r.value=ce[i]||"")});let e=w("editor-avatar-preview");if(e){let i=localStorage.getItem(pn);e.innerHTML=i?`<img src="${i}" class="profile-avatar-img"/>`:ce.avatar||"\u{1F30A}"}let t=w("avatar-remove-btn");t&&(t.style.display=localStorage.getItem(pn)?"":"none");let n=w("editor-banner-preview");if(n){let i=localStorage.getItem(Dn);n.style.backgroundImage=i?`url(${i})`:"",n.style.backgroundSize="cover",n.style.backgroundPosition="center",Ns.forEach(r=>n.classList.remove(r)),i||n.classList.add(ce.banner||"banner-ocean")}let s=w("avatar-picker-grid");s&&(s.innerHTML=Gm.map(i=>`<div class="avatar-option ${ce.avatar===i?"active":""}" onclick="selectAvatar('${i}')">${i}</div>`).join(""));let a=w("banner-picker-grid");a&&(a.innerHTML=Ns.map(i=>`<div class="banner-option ${i} ${ce.banner===i?"active":""}" onclick="selectBanner('${i}')"></div>`).join("")),(o=w("profile-editor-modal"))==null||o.classList.add("show")}function Bs(){var e;(e=w("profile-editor-modal"))==null||e.classList.remove("show")}function Id(){var e,t,n,s,a;ce.displayName=((e=w("edit-displayName"))==null?void 0:e.value.trim())||ce.displayName,ce.handle=(((t=w("edit-handle"))==null?void 0:t.value.trim())||ce.handle).replace(/^@/,"").replace(/\s+/g,"_").toLowerCase(),ce.bio=((n=w("edit-bio"))==null?void 0:n.value.trim())||"",ce.location=((s=w("edit-location"))==null?void 0:s.value.trim())||"",ce.website=((a=w("edit-website"))==null?void 0:a.value.trim())||"",Vl(),kt("profile_saved","Profile details updated"),j(),Bs(),ne("Profile saved")}function Fd(e){localStorage.removeItem(pn),ce.avatar=e,Xe(".avatar-option").forEach(s=>s.classList.toggle("active",s.textContent===e));let t=w("editor-avatar-preview");t&&(t.innerHTML=e);let n=w("avatar-remove-btn");n&&(n.style.display="none")}function Od(e){localStorage.removeItem(Dn),ce.banner=e,Xe(".banner-option").forEach(n=>n.classList.toggle("active",n.classList.contains(e)));let t=w("editor-banner-preview");t&&(t.style.backgroundImage="",Ns.forEach(n=>t.classList.remove(n)),t.classList.add(e)),j()}function Bd(e){var s;let t=(s=e==null?void 0:e.files)==null?void 0:s[0];if(!t)return;if(t.size>2*1024*1024){he("Image too large \u2014 max 2 MB");return}let n=new FileReader;n.onload=a=>{let o=new Image;o.onload=()=>{let i=document.createElement("canvas");i.width=i.height=200;let r=i.getContext("2d"),l=Math.min(o.width,o.height);r.drawImage(o,(o.width-l)/2,(o.height-l)/2,l,l,0,0,200,200);let c=i.toDataURL("image/jpeg",.85);localStorage.setItem(pn,c);let p=w("editor-avatar-preview");p&&(p.innerHTML=`<img src="${c}" class="profile-avatar-img"/>`);let u=w("avatar-remove-btn");u&&(u.style.display=""),j(),ne("Profile photo updated")},o.src=a.target.result},n.readAsDataURL(t),e.value=""}function Xd(){localStorage.removeItem(pn);let e=w("editor-avatar-preview");e&&(e.innerHTML=ce.avatar||"\u{1F30A}");let t=w("avatar-remove-btn");t&&(t.style.display="none"),j()}function Hd(e){var s;let t=(s=e==null?void 0:e.files)==null?void 0:s[0];if(!t)return;if(t.size>5*1024*1024){he("Image too large \u2014 max 5 MB");return}let n=new FileReader;n.onload=a=>{let o=new Image;o.onload=()=>{let i=document.createElement("canvas");i.width=900,i.height=180;let r=i.getContext("2d"),l=Math.max(900/o.width,180/o.height);r.drawImage(o,(900-o.width*l)/2,(180-o.height*l)/2,o.width*l,o.height*l);let c=i.toDataURL("image/jpeg",.88);localStorage.setItem(Dn,c);let p=w("editor-banner-preview");p&&(p.style.backgroundImage=`url(${c})`,p.style.backgroundSize="cover",p.style.backgroundPosition="center",Ns.forEach(d=>p.classList.remove(d)));let u=w("banner-remove-btn");u&&(u.style.display=""),j(),ne("Banner updated")},o.src=a.target.result},n.readAsDataURL(t),e.value=""}function zd(){localStorage.removeItem(Dn);let e=w("editor-banner-preview");e&&(e.style.backgroundImage="",Ns.forEach(n=>e.classList.remove(n)),e.classList.add(ce.banner||"banner-ocean"));let t=w("banner-remove-btn");t&&(t.style.display="none"),j()}function eg(){let e=oe.map(({id:n,label:s,address:a,algo:o,emoji:i,color:r,testnet:l,watchOnly:c,createdAt:p})=>({id:n,label:s,address:a,algo:o,emoji:i,color:r,testnet:l,watchOnly:c,createdAt:p})),t=document.createElement("a");t.href="data:application/json;charset=utf-8,"+encodeURIComponent(JSON.stringify(e,null,2)),t.download=`nalulf-wallets-${new Date().toISOString().slice(0,10)}.json`,t.click(),kt("backup_exported","Wallet addresses exported"),ne("Wallet addresses exported")}function Wd(){eg()}function bi(){var e;wt=1,be={algo:"ed25519",label:"",emoji:"\u{1F48E}",color:"#50fa7b",seed:"",address:"",passphrase:""},_n.clear(),yi(1),ng(),tg(),(e=w("wallet-creator-overlay"))==null||e.classList.add("show"),setTimeout(()=>{var t;return(t=w("wallet-label-input"))==null?void 0:t.focus()},80)}function Xs(){var e;(e=w("wallet-creator-overlay"))==null||e.classList.remove("show"),be.seed=be.address=be.passphrase=""}function tg(){let e=w("wizard-security-banner");e&&(e.innerHTML=`<div class="wsb-icon">\u{1F510}</div>
    ...
    </div>`).join("")}async function og(){var n;let e=await Dl(be.seed,be.passphrase),t={id:crypto.randomUUID(),label:be.label,address:be.address,algo:be.algo,emoji:be.emoji,color:be.color,testnet:((n=w("wallet-testnet-check"))==null?void 0:n.checked)||!1,watchOnly:!1,encSeed:e,createdAt:new Date().toISOString()};oe.push(t),Rs(),dt||(dt=t.id,Z(Es,t.id)),$t(),Ot(),La("wallet-success-address",be.address),setTimeout(()=>{be.seed="",be.address="",be.passphrase=""},100),kt("wallet_created",be.label||"New XRPL Wallet"),ne("Wallet created and encrypted locally"),Fn(t.address).then(()=>$t())}function qd(e){be.algo=e,Xe(".algo-card").forEach(t=>t.classList.toggle("active",t.dataset.algo===e))}function Vd(e){be.emoji=e,Xe(".wallet-emoji-opt").forEach(t=>t.classList.toggle("active",t.textContent===e))}function Gd(e){be.color=e,Xe(".color-swatch").forEach(t=>t.classList.toggle("active",t.style.background===e||t.dataset.color===e))}function Kd(e){let t=document.querySelector(`.security-check-${e}`);if(!t)return;let n=t.querySelector(".check-box");_n.has(e)?(_n.delete(e),t.classList.remove("checked"),n&&(n.textContent="")):(_n.add(e),t.classList.add("checked"),n&&(n.textContent="\u2713")),Jd()}function Jd(){let e=w("wizard-next-btn");e&&wt===2&&(e.disabled=_n.size<4)}function Yd(){var t;(t=w("wizard-seed-value"))==null||t.classList.remove("blur");let e=w("seed-reveal-hint");e&&(e.style.display="none"),setTimeout(()=>{var n;return(n=w("wizard-seed-value"))==null?void 0:n.classList.add("blur")},3e4)}function Qd(){let e=w("wizard-seed-value");if(!e)return;Ia(e.textContent,3e4);let t=w("btn-copy-seed");t&&(t.textContent="Copied!",t.classList.add("copied"),setTimeout(()=>{t.textContent="Copy Seed",t.classList.remove("copied")},2e3))}function Zd(){let e=w("wizard-address-value")||w("wallet-success-address");if(!e)return;Ia(e.textContent);let t=w("btn-copy-addr");t&&(t.textContent="Copied!",t.classList.add("copied"),setTimeout(()=>{t.textContent="Copy",t.classList.remove("copied")},2e3))}function ep(){let e=w("import-address-modal");if(!e)return;e.querySelector("#inp-import-address").value="",e.querySelector("#inp-import-label").value="";let t=e.querySelector("#import-address-error");t&&(t.textContent=""),e.classList.add("show"),setTimeout(()=>{var n;return(n=e.querySelector("#inp-import-address"))==null?void 0:n.focus()},80)}function wi(){var e;(e=w("import-address-modal"))==null||e.classList.remove("show")}function tp(){var s,a;let e=(((s=w("inp-import-address"))==null?void 0:s.value)||"").trim(),t=(((a=w("inp-import-label"))==null?void 0:a.value)||"").trim()||"Watch Wallet",n=w("import-address-error");if(!He(e)){n&&(n.textContent="Enter a valid XRPL address (starts with r\u2026)");return}if(oe.find(o=>o.address===e)){n&&(n.textContent="This address is already in your list.");return}oe.push({id:"watch_"+Date.now(),label:t,address:e,algo:"\u2014",emoji:"\u{1F441}",color:"#8be9fd",testnet:!1,createdAt:new Date().toISOString(),watchOnly:!0}),Rs(),kt("watch_added",`${t} (${e.slice(0,8)}\u2026)`),wi(),$t(),Ot(),Ds(),Fn(e).then(()=>{$t(),Ds()}),ne(`\u{1F441} Watch-only wallet added: ${t}`)}function np(){let e=w("import-seed-modal");if(!e)return;e.querySelector("#inp-import-seed").value="",e.querySelector("#inp-import-seed-pass").value="",e.querySelector("#inp-import-seed-pass-confirm").value="",e.querySelector("#inp-import-seed-label").value="";let t=e.querySelector("#import-seed-error");t&&(t.textContent=""),e.classList.add("show"),setTimeout(()=>{var n;return(n=e.querySelector("#inp-import-seed"))==null?void 0:n.focus()},80)}function xi(){var e;(e=w("import-seed-modal"))==null||e.classList.remove("show")}async function sp(){var r,l,c,p,u;let e=(((r=w("inp-import-seed"))==null?void 0:r.value)||"").trim(),t=(((l=w("inp-import-seed-label"))==null?void 0:l.value)||"").trim()||"Imported Wallet",n=(((c=w("inp-import-seed-pass"))==null?void 0:c.value)||"").trim(),s=(((p=w("inp-import-seed-pass-confirm"))==null?void 0:p.value)||"").trim(),a=w("import-seed-error"),o=w("import-seed-btn"),i=d=>{a&&(a.textContent=d)};if(i(""),!e)return i("Enter your seed phrase.");if(n.length<10)return i("Use a wallet password with at least 10 characters.");if(n!==s)return i("Wallet password confirmation does not match.");if(await Aa(),!window.xrpl)return i("xrpl.js not loaded \u2014 cannot derive address from seed.");o&&(o.disabled=!0,o.textContent="Importing\u2026");try{let d=window.xrpl.Wallet.fromSeed(e),m=d.address,f=(u=d.algorithm)!=null&&u.toLowerCase().includes("ed")?"ed25519":"secp256k1";if(oe.find(x=>x.address===m))return i("This address is already in your vault.");let g="imp_"+Date.now(),b="\u{1F511}",h="#bd93f9",v=await Dl(e,n);oe.push({id:g,label:t,address:m,algo:f,emoji:b,color:h,testnet:!1,watchOnly:!1,encSeed:v,createdAt:new Date().toISOString()}),Rs(),kt("wallet_imported",`${t} (${m.slice(0,8)}\u2026)`),xi(),$t(),Ot(),Fn(m).then(()=>{$t(),Ds()}),ne(`\u{1F511} Wallet imported: ${t}`)}catch(d){i("Invalid seed: "+(d.message||"Could not derive wallet."))}finally{o&&(o.disabled=!1,o.textContent="Import Wallet \u2192");let d=document.getElementById("inp-import-seed");d&&(d.value="");let m=document.getElementById("inp-import-seed-pass");m&&(m.value="");let f=document.getElementById("inp-import-seed-pass-confirm");f&&(f.value="")}}function ap(e,t,n){var p;let s=w("token-details-modal");if(!s)return;let a=s.querySelector(".generic-modal");if(!a)return;let o=Ze[n],i=(p=o==null?void 0:o.tokens)==null?void 0:p.find(u=>u.currency===e&&u.issuer===t),r=i?_(parseFloat(i.balance||0),6):"\u2014",l=i!=null&&i.limit?_(parseFloat(i.limit),2):"Unlimited",c=e.length>4&&ki(e)||e;a.innerHTML=`
    <div class="tdm-hdr">
    ...
    </div>`,s.classList.add("show")}function op(){let e=w("token-details-modal");e&&(e.classList.remove("show"),e.style.display="")}function ip(){var s;(s=document.getElementById("pub-profile-overlay"))==null||s.remove();let e=localStorage.getItem(pn),t=ss.filter(a=>Ke[a.id]),n=document.createElement("div");n.id="pub-profile-overlay",n.className="pub-profile-overlay",n.innerHTML=`
    <div class="pub-profile-modal">
      <div class="pub-banner ${ce.banner||"banner-ocean"}" ${localStorage.getItem(Dn)?`style="background-image:url(${localStorage.getItem(Dn)});background-size:cover;background-position:center;"`:""}>
      </div>
      <div class="pub-hdr">
    ...
    </div>`,document.body.appendChild(n),requestAnimationFrame(()=>requestAnimationFrame(()=>n.classList.add("show"))),n.addEventListener("click",a=>{a.target===n&&n.remove()})}function rp(e){Cn(e),Os(),kt("theme_changed",e)}function lp(e){Z("nalulf_pref_currency",e),Os(),ne(`Display currency: ${e}`)}function cp(e){Z("nalulf_pref_network",e),Os(),ne(`Default network: ${e}`)}function dp(e){Z("nalulf_pref_autolock",e),Os(),ne(`Auto-lock: ${e} minutes`)}window._profileWipeAllData=()=>{confirm("Clear all profile, wallet list, social, and activity data? Encrypted wallet seeds saved on this device will be deleted.")&&(["nalulf_profile","nalulf_wallets","nalulf_social","nalulf_activity_log","nalulf_avatar_img","nalulf_banner_img","naluxrp_active_wallet"].forEach(e=>localStorage.removeItem(e)),oe=[],Ke={},dt=null,Ze={},ti={},Vo(),j(),ii("wallets"),ne("Local data cleared"))};function ig(){var e,t,n;(e=w("profile-editor-modal"))==null||e.addEventListener("click",s=>{s.target===s.currentTarget&&Bs()}),(t=w("wallet-creator-overlay"))==null||t.addEventListener("click",s=>{s.target===s.currentTarget&&Xs()}),(n=w("social-modal"))==null||n.addEventListener("click",s=>{s.target===s.currentTarget&&os()})}function rg(){let e=[{done:!!ce.displayName&&ce.displayName!=="Anonymous",label:"Display name"},{done:!!ce.bio,label:"Bio"},{done:ce.avatar!=="\u{1F30A}"||!!localStorage.getItem(pn),label:"Custom avatar"},{done:!!localStorage.getItem(Dn),label:"Custom banner"},{done:oe.length>0,label:"Wallet added"},{done:Object.keys(Ke).length>=1,label:"Social connected"},{done:!!ce.location,label:"Location set"},{done:!!ce.website,label:"Website added"}],t=e.filter(n=>n.done).length;return{pct:Math.round(t/e.length*100),done:t,total:e.length,checks:e}}function lg(){let e=document.getElementById("profile-completeness");if(!e)return;let{pct:t,checks:n}=rg(),s=t===100?"#50fa7b":t>=60?"#00fff0":"#ffb86c",a=2*Math.PI*16,o=t/100*a,i=n.filter(r=>!r.done).map(r=>r.label);e.title=t===100?"Profile complete \u2713":`${t}% \u2014 Missing: ${i.join(", ")}`,e.innerHTML=`
    <div class="pc-wrap">
  ...
  `}function _g(e){var g,b,h,v;let t=e.ledgerIndex?Number(e.ledgerIndex):null;V("d2-ledger-index",t?t.toLocaleString():"\u2014");let n=((g=e.latestLedger)==null?void 0:g.closeTimeSec)!=null?Number(e.latestLedger.closeTimeSec):null,s=w("d2-ledger-age");if(s&&(n!=null?(s.textContent=`${n<2?n.toFixed(2):n.toFixed(1)}s close`,s.style.color=n<=3?"#50fa7b":n<=6?"#ffb86c":"#ff6e6e"):(s.textContent="Waiting\u2026",s.style.color="")),n!=null&&(ja.push(n),ja.length>Ng&&ja.shift(),Dg()),Ni=Date.now(),Ig(),e.tps!=null){let x=Number(e.tps),k=w("d2-tps");k&&(k.textContent=x.toFixed(1),k.style.color=x<10?"rgba(255,255,255,.65)":x<40?"#50fa7b":x<80?"#ffb86c":"#ff6e6e");let T=w("d2-tps-trend");if(T){let S=X.tpsHistory||[],$=S.length>2?(S.slice(-10).reduce((C,P)=>C+P,0)/Math.min(S.length,10)).toFixed(1):null,E=x<10?"Low":x<40?"Normal":x<80?"High":"Peak";T.textContent=$?`${E} \xB7 avg ${$}`:E,T.style.color=x<10?"rgba(255,255,255,.55)":x<40?"#50fa7b":x<80?"#ffb86c":"#ff6e6e"}}let a=(((b=e.latestLedger)==null?void 0:b.totalTx)??e.txPerLedger)||0,o=w("d2-tx-per-ledger");o&&(o.textContent=a>0?a.toLocaleString():"\u2014",o.style.color=a<10?"rgba(255,255,255,.65)":a<150?"#50fa7b":a<400?"#ffb86c":"#ff6e6e");let i=w("d2-tx-spread");i&&a>0&&(i.textContent=a<10?"Very light":a<50?"Light":a<150?"Normal":a<400?"High volume":"Very high volume",i.style.color=a<150?"":a<400?"#ffb86c":"#ff6e6e");let r=e.avgFee!=null?Number(e.avgFee):((h=e.latestLedger)==null?void 0:h.avgFee)!=null?Number(e.latestLedger.avgFee):null;if(r!=null){let x=Math.round(r*1e6),k=w("d2-fee-value");k&&(k.textContent=fn(r),k.style.color=x<=15?"#50fa7b":x<=50?"rgba(255,255,255,.9)":x<=200?"#ffb86c":"#ff6e6e");let T=w("d2-fee-delta");if(T)if(Ci!=null){let $=r/Ci;$>1.05?(T.textContent="\u2191",T.style.color="#ff6e6e",T.title=`+${(($-1)*100).toFixed(0)}% vs prev ledger`):$<.95?(T.textContent="\u2193",T.style.color="#50fa7b",T.title=`-${((1-$)*100).toFixed(0)}% vs prev ledger`):(T.textContent="\u2192",T.style.color="rgba(255,255,255,.35)",T.title="Stable vs prev ledger")}else T.textContent="";Ci=r;let S=w("d2-fee-pressure");if(S){let $=x<=15?"Base fee":x<=50?`${x} drops`:x<=200?`${x} drops \xB7 Elevated`:`${x} drops \xB7 Surge`;S.textContent=$,S.style.color=x<=50?"":x<=200?"#ffb86c":"#ff6e6e"}}let l=e.successRate!=null?Number(e.successRate):((v=e.latestLedger)==null?void 0:v.successRate)!=null?Number(e.latestLedger.successRate):null;if(l!=null){let x=w("d2-success-rate");x&&(x.textContent=`${l.toFixed(1)}%`,x.style.color=l>=90?"#50fa7b":l>=75?"#ffb86c":"#ff6e6e");let k=w("d2-success-note");if(k){let T=(100-l).toFixed(1);k.textContent=l>=90?`${T}% failed \xB7 Normal`:l>=75?`${T}% failed \xB7 Watch`:`${T}% failed \xB7 Alert`,k.style.color=l>=90?"":l>=75?"#ffb86c":"#ff6e6e"}}let c=a>0?Math.min(100,a/500*100):null,p=w("d2-network-capacity"),u=w("d2-capacity-note");c!=null&&(p&&(p.textContent=`${c.toFixed(1)}%`,p.style.color=c<20?"rgba(255,255,255,.65)":c<50?"#50fa7b":c<80?"#ffb86c":"#ff6e6e"),u&&(u.textContent=c<20?"Low usage":c<50?"Moderate":c<80?"Heavy":"Near capacity",u.style.color=c<50?"":c<80?"#ffb86c":"#ff6e6e"));let d=e.txTypes||{},m=Object.entries(d).sort(([,x],[,k])=>k-x);if(m.length){let[x,k]=m[0],T=m.reduce((P,[,R])=>P+R,0)||1,S=(k/T*100).toFixed(0),$=typeof Dt<"u"?Dt:{},E=w("d2-dominant-type");E&&(E.textContent=x,E.style.color=$[x]||"rgba(255,255,255,.9)");let C=w("d2-dominance-score");if(C){let P=m[1];C.textContent=P?`${S}% \xB7 2nd: ${P[0]}`:`${S}% of txs`}}let f=w("stream-loading");f&&(f.style.display="none")}function Dg(){let e=w("d2-close-sparkline");if(!e||!e.getContext)return;let t=ja;if(t.length<2)return;let n=e.width,s=e.height,a=e.getContext("2d");a.clearRect(0,0,n,s);let o=Math.max(...t,4),i=Math.floor((n-(t.length-1))/t.length),r=1;t.forEach((l,c)=>{let p=Math.max(3,Math.round(l/o*(s-2))),u=c*(i+r),d=s-p,m=l<=3?"rgba(80,250,123,.80)":l<=6?"rgba(255,184,108,.80)":"rgba(255,110,110,.85)";a.fillStyle=m;let f=Math.min(2,i/2);a.beginPath(),a.moveTo(u+f,d),a.lineTo(u+i-f,d),a.quadraticCurveTo(u+i,d,u+i,d+f),a.lineTo(u+i,s),a.lineTo(u,s),a.lineTo(u,d+f),a.quadraticCurveTo(u,d,u+f,d),a.closePath(),a.fill(),c===t.length-1&&(a.fillStyle="rgba(255,255,255,.18)",a.fillRect(u,d,i,Math.min(3,p)))})}function Ig(){if(zs&&cancelAnimationFrame(zs),!Jt())return;let e=0,t=n=>{if(!Jt()){zs=null;return}if(n-e>=120){e=n;let s=w("d2-ledger-age-timer");if(s&&Ni>0){let a=(Date.now()-Ni)/1e3;s.textContent=`${a.toFixed(1)}s ago`,s.style.color=a<4?"rgba(255,255,255,.55)":a<7?"#ffb86c":"#ff6e6e",s.style.opacity=a>=7?(.6+.4*Math.sin(Date.now()/300)).toFixed(2):"1"}}zs=requestAnimationFrame(t)};zs=requestAnimationFrame(t)}function Fg(){let e=w("tx-mix");if(!e)return;let t=Object.entries(X.txMixAccum||{}).filter(([,s])=>s>0).sort(([,s],[,a])=>a-s).slice(0,10),n=t.reduce((s,[,a])=>s+a,0);n&&(e.innerHTML=t.map(([s,a])=>{let o=(a/n*100).toFixed(1),i=Dt[s]||"#6b7280";return`
    ...
    `,o.appendChild(i)};e("chart-tps","tpsTrendMini"),e("chart-fee","feeTrendMini"),e("chart-tps2","tpsTrendMini2"),e("chart-fee2","feeTrendMini2")}function Ha(e,t,n,s){let a=document.getElementById(e);if(!a)return;let o=(i,r)=>{let l=a.querySelector(`[data-k="${i}"]`);l&&(l.textContent=r)};if(t.cur==null){o("now","\u2014"),o("avg","\u2014"),o("delta","\u2014"),o("sigma","\u2014");return}o("now",`${Number(t.cur).toFixed(n)}${s}`),o("avg",t.avg!=null?`${Number(t.avg).toFixed(n)}${s}`:"\u2014"),o("delta",t.deltaPct==null?"\u2014":vn(t.deltaPct,0)),o("sigma",t.vol==null?"\u2014":`${Number(t.vol).toFixed(Math.max(0,n-1))}${s}`)}function Xg(){var n,s,a,o,i,r,l,c,p,u;(n=ye.tps)==null||n.draw(X.tpsHistory),(s=ye.fee)==null||s.draw(X.feeHistory),(a=ye.tps2)==null||a.draw(X.tpsHistory),(o=ye.fee2)==null||o.draw(X.feeHistory);let e=Xt(X.tpsHistory,Yt),t=Xt(X.feeHistory,Yt);Ha("tpsTrendMini",e,2,""),Ha("tpsTrendMini2",e,2,""),Ha("feeTrendMini",t,0,"d"),Ha("feeTrendMini2",t,0,"d"),(i=ye.dexPressure)==null||i.draw(fe.dexPressure),(r=ye.nftMints)==null||r.draw(fe.nftMints),(l=ye.nftBurns)==null||l.draw(fe.nftBurns),(c=ye.autoBridge)==null||c.draw(fe.autoBridge),(p=ye.marketPrice)==null||p.draw(fe.marketPrice),(u=ye.marketVol)==null||u.draw(fe.marketVol)}function Hg(){let e=w("ledger-log"),t=w("ledger-log-loading"),n=w("ledger-log-count");if(!e||!(X.ledgerLog||[]).length)return;t&&(t.style.display="none"),n&&(n.textContent=X.ledgerLog.length);let s=w("tab-network");!s||s.style.display==="none"||(e.innerHTML=`<div class="ledger-log-row log-head">
      ...
      </div>`).join(""))}var Bt=[],qa=new Set,Ve=0,za=null,Ws=0,Gt=0,pt=0,Kt=!0,Wa=0,Rt=!1,Ga=0,Ri=!1,js=null,hn=0,us=0,Ya=!1,zg=.18;function Wg(){Ug(),jg()}function Ug(){let e=w("ledgerStreamParticles");if(e){e.innerHTML="";for(let t=0;t<14;t++){let n=document.createElement("div");n.className="ledger-particle",n.style.left=Math.random()*100+"%",n.style.top=20+Math.random()*60+"%",n.style.animationDuration=6+Math.random()*8+"s",n.style.animationDelay=Math.random()*5+"s",e.appendChild(n)}}}function jg(){if(za)return;let e=w("ledgerStreamShell");e&&(e.addEventListener("mouseenter",()=>{Rt=!0}),e.addEventListener("mouseleave",()=>{qs||(Rt=!1)}));let t=w("ledgerStreamTrack");t&&t.addEventListener("click",s=>{let a=s.target.closest("article.ledger-card");if(!a)return;let o=Number(a.dataset.ledgerIndex);Number.isFinite(o)&&(s.shiftKey?js===o?(js=null,qs||(Rt=!1),Op()):(js=o,Rt=!0,Op()):qg(o))});let n=s=>{Ws||(Ws=s);let a=Math.min(.05,(s-Ws)/1e3);Ws=s;let o=Jt()?w("ledgerStreamTrack"):null;if(o&&Ve>0){if(Kt){let i=o.scrollWidth||0;if(i>100)pt=Math.floor(i/2),Kt=!1,Wa=0,Ve>0&&(hn=pt/Ve);else{Wa++,Wa>30&&(Kt=!1,Wa=0),za=requestAnimationFrame(n);return}}if(pt>0&&!Rt&&Ya){let i=Math.min(1,a/zg);Gt+=(us-Gt)*i,Math.abs(us-Gt)<.5&&(Gt=us);let r=Gt%pt;o.style.transform=`translateX(${-r}px)`}if(!Rt&&Math.floor(s/250)!==Math.floor((s-a*1e3)/250)){let i=Date.now(),r=o.querySelectorAll("article.ledger-card[data-arrival-ts]"),l=12e4;r.forEach(c=>{let p=i-Number(c.dataset.arrivalTs||i),u=Math.max(.52,1-p/l*.48);c.style.opacity=u.toFixed(3)})}if(Ga>0){let i=Date.now()-Ga>bg;Ka(i)}}za=requestAnimationFrame(n)};za=requestAnimationFrame(n),window.addEventListener("resize",()=>{Kt=!0})}function tu(){if(hn<=0||pt<=0||Ve===0)return Gt;let e=w("ledgerStreamShell"),t=e&&e.offsetWidth||800,n=hn-14,a=(Ve-1)*hn+n-t+18;a=Math.max(0,a);let i=Math.floor(Gt/pt)*pt+a;return i<Gt-2&&(i+=pt),i}function Ka(e,t){if(e===Ri)return;Ri=e;let n=w("ledgerStreamShell");if(!n)return;let s=n.querySelector(".stream-stall-overlay");e?(s||(s=document.createElement("div"),s.className="stream-stall-overlay",n.appendChild(s)),s.innerHTML=`<span class="stream-stall-dot"></span> ${y(t||"Waiting for ledgers\u2026")}`):s==null||s.remove()}function Op(){document.querySelectorAll(".ledger-card").forEach(e=>{let t=Number(e.dataset.ledgerIndex);e.classList.toggle("ledger-card--pinned",t===js)})}function qg(e){let t=document.querySelector('.dash-tab[data-tab="inspector"]');typeof window.switchTab=="function"&&t?window.switchTab(t,"inspector"):t==null||t.click();let n=document.getElementById("inspect-addr");n&&(n.placeholder=`Ledger #${e.toLocaleString()} \u2014 paste an address`,n.focus())}function Vg(){var t;let e=w("ledgerStreamShell");e&&(e.classList.remove("stream-reconnect-flash"),e.offsetWidth,e.classList.add("stream-reconnect-flash"),setTimeout(()=>e.classList.remove("stream-reconnect-flash"),1200),kg=((t=ds.at(-1))==null?void 0:t.li)??0,Gg())}function Gg(){let e=document.getElementById("reconnect-banner");if(!e){e=document.createElement("div"),e.id="reconnect-banner",e.className="reconnect-banner";let s=document.querySelector(".dashboard-col-main");s&&s.prepend(e)}e.style.display="",e.innerHTML=`
    ...
    <button onclick="document.getElementById('reconnect-banner').style.display='none'"
      style="margin-left:auto;background:none;border:none;color:inherit;opacity:.5;cursor:pointer;font-size:.9rem">\u2715</button>`;let t=3,n=setInterval(()=>{let s=document.getElementById("reconnect-countdown");if(s&&(s.textContent=t),t--,t<0){clearInterval(n);let a=document.getElementById("reconnect-banner");a&&(a.style.display="none")}},4e3)}function Bp(){let e=w("ledgerStreamTrack"),t=w("ledgerStreamShell"),n=w("stream-loading");if(!e||!t)return;if(n&&(n.style.display="none"),Bt.length===0){e.innerHTML='<div style="padding:40px;opacity:.6">Waiting for ledgers\u2026</div>',Ve=0,Kt=!0;return}let s=[...Bt].sort((o,i)=>o.ledgerIndex-i.ledgerIndex),a=s.map((o,i)=>su(o,{prevIndex:i>0?s[i-1].ledgerIndex:null}));e.innerHTML=a.concat(a).join(""),Ve=s.length,Kt=!0,requestAnimationFrame(()=>{var i;let o=((i=w("ledgerStreamTrack"))==null?void 0:i.scrollWidth)||0;o>100&&(pt=Math.floor(o/2),hn=Ve>0?pt/Ve:0,us=tu(),Ya=!0,Kt=!1)})}function Kg(e){var f,g;if(!e)return;let t=Number(e.ledgerIndex??NaN);if(!Number.isFinite(t)||qa.has(t))return;qa.add(t),Bt.push(e);let n=0;if(Bt.length>vp){let b=Bt.splice(0,Bt.length-vp);b.forEach(h=>qa.delete(h.ledgerIndex)),n=b.length}Ga=Date.now(),Ka(!1),Yg(e.avgFee!=null?Number(e.avgFee):null);let{auraClass:s,domColor:a}=Qg(e);ou(s,a);let o=w("stream-loading");o&&(o.style.display="none");let i=w("ledgerStreamTrack");if(!i)return;if(Ve===0){Bp();return}let r=Bt.length>=2?Bt[Bt.length-2].ledgerIndex:0;if(t<r){Bp();return}let l=Ve,c=su(e),p=document.createElement("template");p.innerHTML=c;let u=p.content.firstElementChild,d=i.children[l];d?i.insertBefore(u,d):i.appendChild(u);let m=document.createElement("template");if(m.innerHTML=c,i.appendChild(m.content.firstElementChild),Ve=l+1,n>0){for(let h=0;h<n;h++)(f=i.children[0])==null||f.remove();let b=Ve-n;for(let h=0;h<n;h++)(g=i.children[b])==null||g.remove();Ve-=n}Kt=!0,requestAnimationFrame(()=>{hn<=0&&pt>0&&Ve>0&&(hn=pt/Ve),us=tu(),Ya=!0})}var ms=[],Jg=20;function Yg(e){e==null||!Number.isFinite(e)||(ms.push(e),ms.length>Jg&&ms.shift())}function nu(){return ms.length===0?null:ms.reduce((e,t)=>e+t,0)/ms.length}function su(e,t={}){let{ledgerIndex:n,closeTimeSec:s,totalTx:a,txTypes:o,avgFee:i}=e,r=o||{},l=a??0,c=Object.entries(r).sort(([,D],[,I])=>I-D)[0],p=(c==null?void 0:c[0])||"Other",u=au(p),d=typeof Dt<"u"?Dt:{},m=D=>d[D]||"#6b7280",f=m(p),g=ps(f,.45)||f,b=ps(f,.14)||f,h=s==null?"\u2014":s<2?`${Number(s).toFixed(2)}s`:`${Number(s).toFixed(1)}s`,v=l>0&&s>0?(l/s).toFixed(1):null,x=i!=null?Number(i):null,k=x!=null?fn(x):"\u2014",T=nu(),S=x!=null&&T!=null&&x>T*3,$=t.prevIndex!=null?Number(n)-t.prevIndex-1:0,E=$>0?`<div class="stream-gap-badge" title="${$} ledger(s) missing">\xB7\xB7\xB7&nbsp;${$} gap</div>`:"",C=D=>l>0?`${(D/l*100).toFixed(1)}%`:"0%",P=(D,I,F)=>I?`<div class="ledger-type-row">
    ...
    </div>`:"",R=(r.AMMCreate||0)+(r.AMMDeposit||0)+(r.AMMWithdraw||0)+(r.AMMVote||0),O=Date.now();return`${E}<article class="ledger-card ledger-card--${u} ledger-card--entry${S?" ledger-card--fee-spike":""}"
  ...
  </article>`}function au(e){let t=String(e||"");return t==="Payment"?"payment":t.startsWith("Offer")?"offer":t.startsWith("NFToken")?"nft":t==="TrustSet"?"trust":t.startsWith("AMM")?"amm":"other"}function Qg(e){var o;let n=((o=Object.entries(e.txTypes||{}).sort(([,i],[,r])=>r-i)[0])==null?void 0:o[0])||"Other",s=au(n),a=Dt[n]||Dt.Other||"#6b7280";return{dominantTx:n,auraClass:s,domColor:a}}function ou(e,t){let n=w("ledgerStreamShell");if(!n)return;if(!e||!t){n.style.removeProperty("--streamTintStrong"),n.style.removeProperty("--streamTintSoft"),n.style.removeProperty("--streamTintBorder");return}let s=ps(t,.16)||"rgba(0,255,240,0.14)",a=ps(t,.06)||"rgba(0,255,240,0.06)",o=ps(t,.22)||"rgba(0,255,240,0.22)";n.style.setProperty("--streamTintStrong",s),n.style.setProperty("--streamTintSoft",a),n.style.setProperty("--streamTintBorder",o),n.dataset.tint=e}function Zg(e){var b,h;let t=Array.isArray(e.recentTransactions)?e.recentTransactions.slice(0,ug):[],n=e.txTypes||{},s=Number(e.ledgerIndex||0),a=Object.values(n).reduce((v,x)=>v+x,0)||1,o=0;for(let v of Object.values(n)){let x=v/a;o+=x*x}let i=ev(t);tv(Us,i);let r=nv(Us.totals,i),l=sv(Us.totals),c=av(s,t),p=ov(s,(b=e.latestLedger)==null?void 0:b.closeTimeSec,t),u=iv({txs:t,txTypes:n,dexPatterns:p}),d=r.filter(v=>v.count>=2).length,m=rv({hhi:o,repeats:d,dex:p,bots:((h=c.bots)==null?void 0:h.length)||0,advanced:u}),f=lv({friction:m,tps:Xt(X.tpsHistory),fee:Xt(X.feeHistory)}),g=cv({s:e,txTypes:n,hhi:o,dexPatterns:p,behavior:c,friction:m,regime:f,breadcrumbs:r,clusters:l,advanced:u});return{s:e,txs:t,txTypes:n,hhi:o,behavior:c,dexPatterns:p,friction:m,regime:f,breadcrumbs:r,clusters:l,narratives:g,advanced:u}}function ev(e){let t=new Map;for(let n of e){let s=n==null?void 0:n.account,a=n==null?void 0:n.destination;if(!s||!a)continue;let o=`${s}|${a}`;t.set(o,(t.get(o)||0)+1)}return t}function tv(e,t){e.window.unshift(t);for(let[n,s]of t.entries())e.totals.set(n,(e.totals.get(n)||0)+s);for(;e.window.length>e.maxLedgers;){let n=e.window.pop();for(let[s,a]of n.entries()){let o=(e.totals.get(s)||0)-a;o<=0?e.totals.delete(s):e.totals.set(s,o)}}}function nv(e,t){let s=[...e.entries()].map(([o,i])=>({k:o,c:i})).sort((o,i)=>i.c-o.c).filter(o=>o.c>=2);return(s.length?s:[...t.entries()].map(([o,i])=>({k:o,c:i}))).slice(0,10).map(({k:o,c:i})=>{let[r,l]=o.split("|");return{from:r,to:l,count:i}})}function sv(e){let t=[...e.entries()].filter(([,i])=>i>=2),n=t.length?t:[...e.entries()],s=new Map;for(let[i]of n){let[r,l]=i.split("|");!r||!l||(s.has(r)||s.set(r,new Set),s.has(l)||s.set(l,new Set),s.get(r).add(l),s.get(l).add(r))}let a=new Set,o=[];for(let i of s.keys()){if(a.has(i))continue;let r=[i],l=[];for(a.add(i);r.length;){let u=r.pop();l.push(u);for(let d of s.get(u)||[])a.has(d)||(a.add(d),r.push(d))}if(l.length<2)continue;let c=l[0],p=-1;for(let u of l){let d=(s.get(u)||new Set).size;d>p&&(p=d,c=u)}o.push({members:l,size:l.length,hub:c})}return o.sort((i,r)=>r.size-i.size),o.slice(0,6)}function av(e,t){let n=new Map;for(let a of t){let o=a==null?void 0:a.account;o&&n.set(o,(n.get(o)||0)+1)}for(let[a,o]of n.entries()){Nt.acct.has(a)||Nt.acct.set(a,{ledgers:[],intervals:[],total:0});let i=Nt.acct.get(a),r=i.ledgers.at(-1);i.ledgers.push(e),r!=null&&e>r&&i.intervals.push(e-r),i.ledgers.length>30&&i.ledgers.shift(),i.intervals.length>29&&i.intervals.shift(),i.total+=o}let s=[];for(let[a,o]of Nt.acct.entries()){if(o.intervals.length<6)continue;let i=gn(o.intervals),r=Fi(o.intervals);if(!i||r==null)continue;let l=r/i;l<.35&&o.total>10&&s.push({acct:a,cv:l,total:o.total})}if(s.sort((a,o)=>a.cv-o.cv||o.total-a.total),e%50===0)for(let[a,o]of Nt.acct){let i=o.ledgers.at(-1)??e;e-i>1e3&&Nt.acct.delete(a)}return{bots:s.slice(0,6),uniqueActors:n.size}}function ov(e,t,n){var E;let s=0,a=0,o=new Map,i=new Map,r=new Map;for(let C of n){let P=C==null?void 0:C.type,R=C==null?void 0:C.account;R&&(P==="OfferCreate"?(s+=1,o.set(R,(o.get(R)||0)+1),i.set(R,(i.get(R)||0)+1)):P==="OfferCancel"&&(a+=1,o.set(R,(o.get(R)||0)+1),r.set(R,(r.get(R)||0)+1)))}let l=s+a,c=l?a/l:0,p=t!=null&&Number(t)>0?a/Number(t)*60:null;for(Re.smoothCancelPerMin=Ip(Re.smoothCancelPerMin,p,.45),Re.window.unshift({li:e,closeTimeSec:t??null,create:s,cancel:a,total:l,cancelRatio:c,cancelsPerMin:Re.smoothCancelPerMin,byActor:o,byActorCreate:i,byActorCancel:r});Re.window.length>fg;)Re.window.pop();let u={create:0,cancel:0,total:0},d=new Map,m=new Map,f=new Map;for(let C of Re.window){u.create+=C.create,u.cancel+=C.cancel,u.total+=C.total;for(let[P,R]of C.byActor.entries())d.set(P,(d.get(P)||0)+R);for(let[P,R]of C.byActorCancel.entries())m.set(P,(m.get(P)||0)+R);for(let[P,R]of C.byActorCreate.entries())f.set(P,(f.get(P)||0)+R)}let g=Pi(d,5),b=Pi(m,5),h=Pi(f,5),v=u.total?(((E=g[0])==null?void 0:E.count)||0)/u.total:0,x=0;if(u.total)for(let C of d.values()){let P=C/u.total;x+=P*P}let k=Re.window.map(C=>C.total).filter(Number.isFinite),T=gn(k)||0,S=T>0?(l-T)/T*100:null;Re.smoothBurst=Ip(Re.smoothBurst,S,.4);let $=[];return u.total>=Si&&c>=.65&&$.push("Lots of cancels (looks like quote-stuffing/spam)"),u.total>=Si&&v>=.35&&$.push("One actor dominates DEX activity"),u.total>=Si&&(Re.smoothCancelPerMin||0)>=18&&$.push("Fast cancelling (high churn)"),Re.smoothBurst!=null&&Math.abs(Re.smoothBurst)>=45&&$.push("Sudden DEX burst"),{now:{li:e,create:s,cancel:a,total:l,cancelRatio:c,cancelsPerMin:Re.smoothCancelPerMin},window:{...u,cancelRatio:u.total?u.cancel/u.total:0},topShare:v,actorHHI:x,burstPct:Re.smoothBurst,topActor:g,topCanceller:b,topMaker:h,signals:$}}function Pi(e,t){return[...e.entries()].sort((n,s)=>s[1]-n[1]).slice(0,t).map(([n,s])=>({acct:n,count:s}))}function iv({txs:e,txTypes:t,dexPatterns:n}){var H;let s=Number((t==null?void 0:t.OfferCreate)||0)+Number((t==null?void 0:t.OfferCancel)||0),a=Number((t==null?void 0:t.NFTokenMint)||0),o=Number((t==null?void 0:t.NFTokenBurn)||0),i=0,r=new Map,l=new Map;for(let N of e){if((N==null?void 0:N.type)!=="Payment")continue;let W=(N==null?void 0:N.paths)||(N==null?void 0:N.Paths),se=Array.isArray(W)&&W.length>0,re=(N==null?void 0:N.sendmax)!=null||(N==null?void 0:N.SendMax)!=null,pe=(N==null?void 0:N.delivermax)!=null||(N==null?void 0:N.DeliverMax)!=null;if(!(se||re||pe))continue;i+=1;let te=N==null?void 0:N.account,de=N==null?void 0:N.destination;if(te&&r.set(te,(r.get(te)||0)+1),te&&de){let le=`${te}|${de}`;l.set(le,(l.get(le)||0)+1)}}let c=[...r.entries()].sort((N,W)=>W[1]-N[1]).slice(0,5).map(([N,W])=>({acct:N,count:W})),p=[...l.entries()].sort((N,W)=>W[1]-N[1]).slice(0,5).map(([N,W])=>{let[se,re]=N.split("|");return{from:se,to:re,count:W}}),u=(H=n==null?void 0:n.now)!=null&&H.total?Math.round((n.now.cancelRatio||0)*100):0,d=(n==null?void 0:n.topShare)!=null?Math.round(n.topShare*100):0,m=e.filter(N=>(N==null?void 0:N.type)==="Payment").map(N=>typeof(N==null?void 0:N.amountXrp)=="number"?N.amountXrp:null).filter(N=>N!=null&&N>0&&Number.isFinite(N)),f=[100,1e3,1e4],g=m.filter(N=>f.some(W=>Math.abs(N%W)<1e-9&&N/W>=1)).length,b=m.length>=5?Math.round(g/m.length*100):null,h=e.filter(N=>(N==null?void 0:N.type)==="Payment"&&(N==null?void 0:N.account)&&(N==null?void 0:N.destination)&&N.account===N.destination).length,v=Number((t==null?void 0:t.AMMCreate)||0),x=Number((t==null?void 0:t.AMMDeposit)||0),k=Number((t==null?void 0:t.AMMWithdraw)||0),T=Number((t==null?void 0:t.AMMVote)||0),S=Number((t==null?void 0:t.AMMBid)||0),$=Number((t==null?void 0:t.AMMDelete)||0),E=v+x+k+T+S+$,C=x-k,P=x+k>0?Math.round(x/(x+k)*100):null,R=new Set;for(let N of e)["AMMCreate","AMMDeposit","AMMWithdraw","AMMVote","AMMBid"].includes(N==null?void 0:N.type)&&(N!=null&&N.account)&&R.add(N.account);let O=R.size,D=0,I=0;for(let N of e)(N==null?void 0:N.type)==="Payment"&&Array.isArray(N==null?void 0:N.paths)&&N.paths.length>0&&(D+=N.paths.length,I++);let F=I>0?(D/I).toFixed(1):null;return{offerTotal:s,dexCancelPct:u,dexTopSharePct:d,mints:a,burns:o,pathPays:i,topPathActors:c,topPathPairs:p,roundnessIdx:b,selfTradeCount:h,ammCreate:v,ammDeposit:x,ammWithdraw:k,ammVote:T,ammBid:S,ammDelete:$,lpTotal:E,lpNetFlow:C,lpRatio:P,lpUniqueActors:O,avgPathDepth:F}}function rv({hhi:e,repeats:t,dex:n,bots:s,advanced:a}){var h,v;let o=we((e-.22)/.25,0,1)*22,i=we((t-2)/6,0,1)*12,r=((h=n==null?void 0:n.window)==null?void 0:h.cancelRatio)??0,l=(n==null?void 0:n.topShare)??0,c=((v=n==null?void 0:n.now)==null?void 0:v.cancelsPerMin)??0,p=we((r-.5)/.5,0,1)*18,u=we((l-.25)/.5,0,1)*18,d=we(c/25,0,1)*10,m=we(s/6,0,1)*10,f=(a==null?void 0:a.roundnessIdx)!=null?we((a.roundnessIdx-30)/40,0,1)*8:0,g=(a==null?void 0:a.selfTradeCount)>0?Math.min(8,a.selfTradeCount*4):0,b=(a==null?void 0:a.pathPays)!=null?we(a.pathPays/30,0,1)*6:0;return Math.round(o+i+p+u+d+m+f+g+b)}function lv({friction:e,tps:t,fee:n}){let s=(n==null?void 0:n.deltaPct)!=null&&Math.abs(n.deltaPct)>=35,a=(t==null?void 0:t.deltaPct)!=null&&Math.abs(t.deltaPct)>=25;return e>=75?"Manipulated":s||a?"Stressed":((t==null?void 0:t.cur)??0)>=12||((t==null?void 0:t.avg)??0)>=10?"Active":"Quiet"}function cv({s:e,txTypes:t,hhi:n,dexPatterns:s,behavior:a,friction:o,regime:i,breadcrumbs:r,clusters:l,advanced:c}){var h,v,x,k,T;let p=[],u=Xt(X.tpsHistory,Yt),d=Xt(X.feeHistory,Yt),m=((h=Object.entries(t||{}).sort(([,S],[,$])=>$-S)[0])==null?void 0:h[0])||"\u2014",f=Number(e.txPerLedger||0);p.push({sentiment:i==="Manipulated"||i==="Stressed"?"warn":i==="Active"?"up":"ok",title:`Overall: ${i} \xB7 Risk score ${o}/100`,detail:"Heuristic score from concentration, repeats, DEX churn, bot-like timing, and routing indicators. It's a signal, not proof."}),p.push({sentiment:"ok",title:`Ledger snapshot: #${Number(e.ledgerIndex||0).toLocaleString()} \xB7 ${f} tx \xB7 most common: ${m}`,detail:`TPS ${rs(u.cur,2)} (avg ${rs(u.avg,2)} \xB7 ${vn(u.deltaPct,0)}). Fee ${d.cur!=null?fn(d.cur):"\u2014"} (avg ${d.avg!=null?fn(d.avg):"\u2014"} \xB7 ${vn(d.deltaPct,0)}).`});let g=n>=.35?"high":n>=.25?"medium":"low";if(p.push({sentiment:n>=.35?"warn":"ok",title:`Transaction mix: ${g} concentration (HHI ${n.toFixed(2)})`,detail:n>=.35?"A few tx types dominate. Patterns look \u201Cstronger,\u201D but can be misleading.":"Mix is broad. Strong signals usually come from behavior, not just tx type."}),s.window.total){let S=Math.round(s.window.cancelRatio*100),$=Math.round(s.topShare*100);p.push({sentiment:s.signals.length?"warn":"ok",title:`DEX monitor: ${s.window.total} offer tx (window) \xB7 cancels ${S}% \xB7 top actor ~${$}%`,detail:s.signals.length?`Signals: ${s.signals.join(" \xB7 ")}`:"No strong DEX-pattern signals right now.",addr:((v=s.topActor[0])==null?void 0:v.acct)||null})}let b=r.filter(S=>S.count>=2).length;if(b>=2&&p.push({sentiment:"new",title:`Repeating counterparties: ${b} recurring pair(s)`,detail:"Repeated interactions can be routing loops, bots, or coordinated flows. Click addresses for a quick read."}),l!=null&&l.length&&((x=l[0])==null?void 0:x.size)>=3&&p.push({sentiment:"new",title:`Cluster forming: ${l[0].size} wallets \xB7 hub ${z(l[0].hub)}`,detail:"Clusters are co-activity groups (not identity proof). Use as \u201Clikely related behavior.\u201D",addr:l[0].hub}),(k=a.bots)!=null&&k.length){let S=a.bots[0];p.push({sentiment:"warn",title:`Bot-like timing: ${a.bots.length} candidate(s)`,detail:`Low variance in repeated appearances. Top: ${z(S.acct)} (CV ${S.cv.toFixed(2)}).`,addr:S.acct})}if(c!=null&&c.pathPays){let S=(T=c.topPathActors)==null?void 0:T[0];p.push({sentiment:c.pathPays>=18?"warn":"ok",title:`Autobridge-ish routing: ${c.pathPays} path payments (ledger sample)`,detail:S?`Most active routing wallet: ${z(S.acct)} (${S.count}).`:"Paths/SendMax/DeliverMax appear frequently in the sample.",addr:(S==null?void 0:S.acct)||null})}return c!=null&&c.selfTradeCount&&p.push({sentiment:"warn",title:`Self-transfer signal: ${c.selfTradeCount} payment(s) where sender = receiver`,detail:"Self-transfers can be benign (housekeeping) or used to fake activity. Treat as a watch signal."}),((c==null?void 0:c.roundnessIdx)??0)>=45&&p.push({sentiment:"warn",title:`Round-number bias: ${c.roundnessIdx}% of payments are exact multiples of 100/1,000/10,000`,detail:"Round-number bias often shows scripted behavior (bots) rather than human payments."}),p.slice(0,12)}function dv(e){let t=w("d2-breadcrumb-list"),n=w("d2-breadcrumb-meta");if(!t)return;if(!e.length){t.innerHTML='<div class="gateway-item" style="opacity:.6">Watching for repeated interactions\u2026</div>',n&&(n.textContent="\u2014");return}let s=e.filter(a=>a.count>=2).length;n&&(n.textContent=s?`${s} repeats`:"Top interactions"),t.innerHTML=e.slice(0,10).map(a=>`
    <div class="gateway-item gateway-row">
    ...
    </div>`).join("")}function pv(e){let t=w("d2-cluster-list"),n=w("d2-cluster-persistence");if(t){if(!e.length){t.innerHTML='<div class="gateway-item" style="opacity:.6">Building clusters\u2026 (needs repeated activity)</div>',n&&(n.textContent="\u2014");return}n&&(n.textContent=`${e.length} group${e.length!==1?"s":""}`),t.innerHTML=e.slice(0,6).map((s,a)=>{let i=`hsl(${(a*67+120)%360},70%,60%)`,r=s.members.slice(0,4);return`
      ...
      </div>`}).join("")}}function uv(e){let t=w("d2-delta-narratives");if(!t)return;if(!e.length){t.innerHTML='<div class="gateway-item" style="opacity:.6">Building baseline \u2014 narratives appear after 1\u20132 ledgers\u2026</div>';return}let n={up:"#50fa7b",down:"#ff5555",new:"#00d4ff",warn:"#ffb86c",ok:"rgba(255,255,255,.85)"};t.innerHTML=e.map(s=>{let a=n[s.sentiment]||"rgba(255,255,255,.85)",o=s.addr&&He(s.addr)?`<button class="addr-link narrative-addr" data-addr="${y(s.addr)}">Peek</button>`:"";return`
  ...
  `,t?t.insertAdjacentElement("afterend",s):n?n.insertAdjacentElement("afterend",s):e.prepend(s)}function hv(){if(xp)return;xp=!0;let e=document.querySelector(".dashboard-col-main");if(!e)return;let t=document.createElement("section");t.className="widget-card",t.id="landscape-card",t.setAttribute("aria-label","Landscape brief"),t.innerHTML=`
  ...
  `,e.prepend(t)}function gv(e){var v,x,k,T,S,$,E,C,P,R,O,D,I,F,H;let t=w("landscape-badge");t&&(t.textContent=`${e.regime} \xB7 Risk ${e.friction}/100`);let n=e.s,s=e.txTypes||{},a=((v=Object.entries(s).sort(([,N],[,W])=>W-N)[0])==null?void 0:v[0])||"\u2014",o=Xt(X.tpsHistory,Yt),i=Xt(X.feeHistory,Yt),r=e.dexPatterns,l=(x=r==null?void 0:r.window)!=null&&x.total?Math.round(r.window.cancelRatio*100):0,c=w("landscape-text");if(c){let N=Number(n.ledgerIndex||0).toLocaleString(),W=Number(n.txPerLedger||0),se=((k=n.latestLedger)==null?void 0:k.closeTimeSec)!=null?Number(n.latestLedger.closeTimeSec).toFixed(2)+"s":"\u2014",re=o.cur!=null?`${rs(o.cur,2)} TPS`:"\u2014",pe=i.cur!=null?`${fn(i.cur)} fee`:"\u2014",ae=n.successRate!=null?`${Number(n.successRate).toFixed(1)}% success`:"\u2014",te=(T=r==null?void 0:r.window)!=null&&T.total?`DEX offers are <b>${r.window.total}</b> (window), with <b>${l}% cancels</b>.`:"DEX offers look quiet right now.";c.innerHTML=`
  ...
  `,e.prepend(t)}function yv(e){var d,m;if(!document.getElementById("dex-pattern-card"))return;let t=e.window.total||0,n=t?Math.round(e.window.cancelRatio*100):0,s=t?Math.round(e.topShare*100):0;V("dexp-badge",t?`${t} offer tx \xB7 ${n}% cancels`:"Quiet");let a=w("dexp-cancel-bar");a&&(a.style.width=`${we(n,0,100)}%`),V("dexp-cancel-val",t?`${n}%`:"\u2014");let o=w("dexp-topshare-bar");o&&(o.style.width=`${we(s,0,100)}%`),V("dexp-topshare-val",t?`${s}%`:"\u2014");let i=e.burstPct,r=i==null?0:Math.min(100,Math.abs(i)),l=w("dexp-burst-bar");l&&(l.style.width=`${r}%`),V("dexp-burst-val",i==null?"\u2014":vn(i,0)),V("dexp-cpm",e.now.cancelsPerMin==null?"\u2014":e.now.cancelsPerMin.toFixed(1)),V("dexp-hhi",t?e.actorHHI.toFixed(2):"\u2014"),V("dexp-totalwin",t?`${t}`:"\u2014");let c=w("dexp-signals");c&&(c.innerHTML=e.signals.length?e.signals.map(f=>`<span class="sig-pill warn">${y(f)}</span>`).join(""):'<span class="sig-pill ok">No strong DEX signals</span>');let p=w("dexp-cancellers");p&&(p.innerHTML=(d=e.topCanceller)!=null&&d.length?e.topCanceller.slice(0,5).map(f=>`
        ...
        <div class="dex-rowline">
          <button class="addr-link mono cut" data-addr="${y(f.acct)}">${y(z(f.acct))}</button>
          <span class="mono">${f.count}</span>
        </div>`).join(""):'<div style="opacity:.7">\u2014</div>')}function wv(){if($p)return;$p=!0;let e=document.querySelector(".dashboard-col-main");if(!e)return;let t=document.createElement("section");t.className="widget-card",t.id="risk-card",t.setAttribute("aria-label","Risk panel"),t.innerHTML=`
    <div class="widget-header">
  ...
  `,t.querySelectorAll(".risk-box-toggle").forEach(n=>{var a;n.addEventListener("click",()=>{let o=n.getAttribute("data-target"),i=document.getElementById(o);if(!i)return;let r=n.getAttribute("aria-expanded")!=="false";n.setAttribute("aria-expanded",r?"false":"true"),i.classList.toggle("risk-collapsed",r),n.querySelector(".risk-box-chevron").textContent=r?"\u25B8":"\u25BE";try{localStorage.setItem("risk_collapsed_"+o,r?"1":"0")}catch{}});let s=n.getAttribute("data-target");try{localStorage.getItem("risk_collapsed_"+s)==="1"&&(n.setAttribute("aria-expanded","false"),(a=document.getElementById(s))==null||a.classList.add("risk-collapsed"),n.querySelector(".risk-box-chevron").textContent="\u25B8")}catch{}}),e.appendChild(t)}function xv(e){var r,l,c,p,u,d,m,f,g,b;if(!document.getElementById("risk-card"))return;V("risk-badge",`Risk ${e.friction}/100`),V("risk-regime",e.regime),V("risk-friction",`${e.friction}/100`);let t=[];e.hhi>=.35&&t.push({cls:"warn",t:"High concentration"}),e.breadcrumbs.filter(h=>h.count>=2).length>=3&&t.push({cls:"new",t:"Repeating counterparties"}),(l=(r=e.behavior)==null?void 0:r.bots)!=null&&l.length&&t.push({cls:"warn",t:"Bot-like timing"}),(p=(c=e.dexPatterns)==null?void 0:c.signals)!=null&&p.length&&t.push({cls:"warn",t:"DEX churn signals"}),((u=e.advanced)==null?void 0:u.selfTradeCount)>0&&t.push({cls:"warn",t:`Self-transfer: ${e.advanced.selfTradeCount}`}),(((d=e.advanced)==null?void 0:d.roundnessIdx)??0)>=45&&t.push({cls:"warn",t:`Round-number bias ${e.advanced.roundnessIdx}%`}),((m=e.advanced)==null?void 0:m.pathPays)>0&&t.push({cls:"warn",t:`Path flow: ${e.advanced.pathPays}`}),V("risk-signalcount",`${t.length}`);let n=w("risk-pills");n&&(n.innerHTML=t.length?t.map(h=>`<span class="sig-pill ${h.cls}">${y(h.t)}</span>`).join(""):'<span class="sig-pill ok">No elevated signals</span>');let s=w("risk-bots");if(s){let h=((f=e.behavior)==null?void 0:f.bots)||[];if(h.length){let v={};for(let k of h){let T=k.botType||"Periodic";v[T]||(v[T]=[]),v[T].push(k)}let x=["Market Maker","Arbitrage","Flood / Spam","Periodic"];s.innerHTML=x.filter(k=>v[k]).map(k=>{let T=v[k];return`<div class="bot-type-group">
          ...
          `).join("")}
        </div>`}).join("")}else s.innerHTML='<div style="opacity:.7;font-size:.84rem">No periodic bots detected yet</div>'}let a=w("risk-amm");if(a){let h=e.advanced||{},{ammCreate:v=0,ammDeposit:x=0,ammWithdraw:k=0,ammVote:T=0,ammBid:S=0,lpTotal:$=0,lpNetFlow:E=0,lpRatio:C,lpUniqueActors:P=0}=h;if($===0)a.innerHTML='<div style="opacity:.6;font-size:.84rem">No AMM activity in this ledger</div>';else{let R=E>0?"#50fa7b":E<0?"#ff5555":"rgba(255,255,255,.5)";a.innerHTML=`
        <div class="amm-chips">
  ...
  `,e.appendChild(t),(s=w("spam-copy-hash"))==null||s.addEventListener("click",()=>{var i;return Hp(((i=w("spam-proof-hash"))==null?void 0:i.textContent)||"")}),(a=w("spam-copy-json"))==null||a.addEventListener("click",()=>{var i;return Hp(((i=w("spam-proof-json"))==null?void 0:i.textContent)||"")}),(o=w("spam-print-proof"))==null||o.addEventListener("click",Iv),_renderBondSim()}window._toggleBondSim=function(){let e=w("spam-sim-panel");if(!e)return;let t=e.style.display!=="none";e.style.display=t?"none":"";let n=w("spam-sim-toggle");n&&(n.style.color=t?"":"#00d4ff")};window._renderBondSim=function(){let e=document.getElementById("sim-base"),t=document.getElementById("sim-growth"),n=document.getElementById("sim-table");if(!n)return;let s=Number((e==null?void 0:e.value)||hs),a=Number((t==null?void 0:t.value)||gs),o=fe.marketPrice.at(-1)??null;document.getElementById("sim-base-val")&&(document.getElementById("sim-base-val").textContent=s+" XRP"),document.getElementById("sim-growth-val")&&(document.getElementById("sim-growth-val").textContent=a+"\xD7");let i="";for(let r=0;r<=Ks;r++){let l=Math.round(s*a**r),c=o?"$"+(l*o).toLocaleString(void 0,{maximumFractionDigits:0}):"",p=r<3?"#50fa7b":r<6?"#ffb86c":"#ff5555";i+=`<div style="padding:5px;border-radius:6px;background:rgba(255,255,255,.03);border:1px solid rgba(255,255,255,.07)">
      ...
      ${c?`<div style="font-size:.62rem;opacity:.45">${c}</div>`:""}
    </div>`}n.innerHTML=i};async function Hp(e){try{await navigator.clipboard.writeText(String(e||"")),ne("Copied")}catch{he("Copy failed (browser blocked clipboard).")}}function Vs(e){let t=we(Number(e)||0,0,Ks);return Math.round(hs*gs**t)}function Bi(){try{let e=JSON.parse(localStorage.getItem(Kp)||"[]");ie.allowList=new Set(e)}catch{ie.allowList=new Set}}function ru(){try{localStorage.setItem(Kp,JSON.stringify([...ie.allowList]))}catch{}}function lu(e){He(e)&&(ie.allowList.add(e),ru(),ie.byAddr.delete(e),ne(`${z(e)} added to allow-list \u2014 will no longer be flagged`))}window._spamAllowAddr=lu;function cu(){try{return JSON.parse(localStorage.getItem(Gp)||"{}")}catch{return{}}}function Cv(e){try{localStorage.setItem(Gp,JSON.stringify(e))}catch{}}function du(){let e=cu();for(let[t,n]of Object.entries(e))ie.verifiedCache.set(t,n)}window.exportSpamReputation=function(){let e=[...ie.byAddr.entries()].map(([o,i])=>({addr:o,level:i.level,strikes:i.strikes,score:+(i.score||0).toFixed(4),threatType:i.threatType||"Unknown",verified:!!i.verifiedLedger,verifiedLedger:i.verifiedLedger??null,lastSeen:i.lastSeenLedger??null})),t={v:2,network:X.currentNetwork||"xrpl-mainnet",exportedAt:new Date().toISOString(),allowList:[...ie.allowList],suspects:e,policy:{bondBaseXrp:hs,bondGrowth:gs,ratchetMax:Ks}},n=new Blob([JSON.stringify(t,null,2)],{type:"application/json"}),s=URL.createObjectURL(n),a=document.createElement("a");a.href=s,a.download=`naluxrp_reputation_${new Date().toISOString().slice(0,10)}.json`,document.body.appendChild(a),a.click(),document.body.removeChild(a),URL.revokeObjectURL(s),ne("Reputation list exported")};window.importSpamReputation=function(e){if(!e)return;let t=new FileReader;t.onload=n=>{var s;try{let a=JSON.parse(n.target.result);if(!a.suspects)throw new Error("Invalid format");let o=0;for(let i of a.suspects){if(!He(i.addr))continue;let r=ie.byAddr.get(i.addr)||{};ie.byAddr.set(i.addr,{...r,level:i.level??0,strikes:i.strikes??0,score:i.score??0,threatType:i.threatType??"Unknown",verifiedLedger:i.verifiedLedger??null,lastSeenLedger:i.lastSeen??null,scoreHistory:[],signalBreakdown:{}}),o++}if((s=a.allowList)!=null&&s.length){for(let i of a.allowList)He(i)&&ie.allowList.add(i);ru()}ne(`Imported ${o} reputation entries`)}catch(a){he("Import failed: "+a.message)}},t.readAsText(e)};function Pv(e){var l,c;if(!document.getElementById("spam-defense-card"))return;let t=Ev(e),n=t.reduce((p,u)=>Math.max(p,u.level),0),s=t.filter(p=>p.verified).length,a=fe.marketPrice.at(-1)??null,o=t.reduce((p,u)=>p+Vs(u.level),0),i=a?`~$${(o*a).toLocaleString(void 0,{maximumFractionDigits:0})}`:`${o} XRP`;V("spam-count",t.length),V("spam-maxlvl",`L${n}`),V("spam-verified",s),V("spam-allowcount",ie.allowList.size),V("spam-bondusd",i),V("spam-badge",t.length?`${t.length} tracked \xB7 max L${n}`:"Quiet");let r=w("spam-list");if(r&&(t.length?r.innerHTML=t.map(p=>{let u=Vs(p.level),d=a?` (~$${(u*a).toFixed(0)})`:"",m=p.level>=6?"#ff5555":p.level>=3?"#ffb86c":"#50fa7b",f=p.score>=.7?"#ff5555":p.score>=.4?"#ffb86c":"#50fa7b",g={"Payment Flooder":"#ff5555","Quote Stuffer":"#ff5555","Wash Trader":"#ff5555","DEX Bot":"#ffb86c","Arb Router":"#00d4ff","Periodic Bot":"#bd93f9"}[p.threatType]||"rgba(255,255,255,.6)",b=p.verified?`<span class="spam-cred-chip">\u2714 L${p.level} verified</span>`:"",h=Mv(p.scoreHistory||[]);return`
          <div class="spam-card" data-spam-addr="${y(p.addr)}">
            ...
            <div class="spam-breakdown" id="spam-bd-${y(p.addr.slice(0,10))}" style="display:none">
              ${Lv(p.breakdown,p.strikes)}
            </div>
          </div>`}).join(""):r.innerHTML=`<div class="spam-empty">No suspects flagged \u2014 allow-list has ${Jp.size} known-good entities.</div>`),_i||Av(),ie.selectedAddr){let p=ie.byAddr.get(ie.selectedAddr);p?Xi(ie.selectedAddr,p,e.s.ledgerIndex).then(u=>fs(u)):fs(null)}((l=document.getElementById("spam-sim-panel"))==null?void 0:l.style.display)!=="none"&&((c=window._renderBondSim)==null||c.call(window))}function Mv(e){if(!(e!=null&&e.length))return"";let t=42,n=14,s=1,a=t/Math.max(1,e.length-1),o=e.map((l,c)=>`${(c*a).toFixed(1)},${(n-2-l/s*(n-4)).toFixed(1)}`).join(" "),i=e.at(-1)??0,r=i>=.7?"#ff5555":i>=.4?"#ffb86c":"#50fa7b";return`<svg width="${t}" height="${n}" xmlns="http://www.w3.org/2000/svg" style="overflow:visible">
    ...
    </div>`:'<div style="opacity:.5;font-size:.78rem;padding:6px 0">No significant signal breakdown available yet.</div>'}var _i=!1;function Av(){_i||(_i=!0,document.addEventListener("click",e=>{var a,o,i,r;let t=(o=(a=e.target).closest)==null?void 0:o.call(a,"button[data-action][data-spam-addr]");if(!t)return;let n=t.getAttribute("data-action"),s=t.getAttribute("data-spam-addr");if(s){if(n==="proof"){let l=ie.byAddr.get(s);if(!l)return;ie.selectedAddr=s;let c=w("spam-proof");if(c){c.style.display="";let p=w("spam-proof-hash");p&&(p.textContent="Computing SHA-512Half\u2026")}Xi(s,l,((r=(i=X.ledgerLog)==null?void 0:i[0])==null?void 0:r.ledgerIndex)||null).then(p=>{ie.selectedProof=p,fs(p)}).catch(p=>he("Proof build failed: "+p.message));return}if(n==="clear"){ie.byAddr.delete(s),ie.selectedAddr===s&&fs(null),ne("Cleared from session");return}if(n==="allow"){lu(s),ie.byAddr.delete(s),ie.selectedAddr===s&&fs(null);return}if(n==="expand"){let l=s.slice(0,10),c=document.getElementById("spam-bd-"+l);if(!c)return;let p=c.style.display!=="none";c.style.display=p?"none":"",t.textContent=p?"\u25BE Detail":"\u25B4 Hide";return}}}))}function fs(e){let t=w("spam-proof");if(!t)return;if(!e){t.style.display="none";return}t.style.display="",V("spam-proof-hash",e.hash);let n=w("spam-proof-json");n&&(n.textContent=e.canonicalJson);let s=w("spam-cred-step");s&&(s.innerHTML=`
      <div style="opacity:.9">
    ...
    `)}function Ev(e){var o,i,r,l,c;ie.allowList.size||Bi();let t=new Set;(((o=e.behavior)==null?void 0:o.bots)||[]).forEach(p=>t.add(p.acct)),(((i=e.dexPatterns)==null?void 0:i.topActor)||[]).forEach(p=>t.add(p.acct)),(((r=e.dexPatterns)==null?void 0:r.topCanceller)||[]).forEach(p=>t.add(p.acct)),(((l=e.dexPatterns)==null?void 0:l.topMaker)||[]).forEach(p=>t.add(p.acct)),(e.breadcrumbs||[]).forEach(p=>{t.add(p.from),t.add(p.to)}),(e.clusters||[]).forEach(p=>{t.add(p.hub),(p.members||[]).forEach(u=>t.add(u))}),(((c=e.advanced)==null?void 0:c.topPathActors)||[]).forEach(p=>t.add(p.acct));let n=Number(e.s.ledgerIndex||0)||null,s=e.txs||[],a=[];if(n&&n%50===0){let p=Ua*24;for(let[u,d]of ie.byAddr)n-(d.lastSeenLedger||0)>p&&ie.byAddr.delete(u)}for(let p of t){if(!He(p)||Jp.has(p)||ie.allowList.has(p))continue;let{score:u,breakdown:d}=Rv(p,e),m=Nv(d),f=ie.byAddr.get(p)||{strikes:0,level:0,score:0,verifiedLedger:null,lastSeenLedger:null,scoreHistory:[],threatType:"Unknown",signalBreakdown:{}},g=f.strikes||0;u>=Vp?g+=1:u<=Mi&&(g=Math.max(0,g-1));let b=f.lastSeenLedger||n,h=n?n-b:0;if(h>Ua&&u<Mi){let $=Math.floor(h/Ua);g=Math.max(0,g-$)}let v=we(Math.floor(g/qp),0,Ks),x=[...f.scoreHistory||[],u].slice(-10),k=ie.verifiedCache.get(p),T=f.verifiedLedger??(k==null?void 0:k.ledgerIndex)??null;T||(T=_v(p,v,s,n),T&&Dv(p,v,n));let S={score:u,strikes:g,level:v,verifiedLedger:T,lastSeenLedger:n,scoreHistory:x,threatType:m,signalBreakdown:d};ie.byAddr.set(p,S),a.push({addr:p,score:u,strikes:g,level:v,verified:!!T,verifiedLedger:T,scoreHistory:x,threatType:m,breakdown:d})}return a.sort((p,u)=>u.level-p.level||u.score-p.score),a.slice(0,yg)}function Nv(e){let{bot:t=0,dexDom:n=0,cancelPat:s=0,pingPong:a=0,pathRoute:o=0,selfTrade:i=0,roundPay:r=0}=e,l=n+s;return t>.25&&(e.botType==="Flood / Spam"||r>.05)?"Payment Flooder":t>.2&&l>.15?"DEX Bot":l>.3&&s>.1?"Quote Stuffer":a>.1?"Wash Trader":o>.1?"Arb Router":t>.2?"Periodic Bot":"Multi-Signal"}function Rv(e,t){var m,f,g,b,h;let n={bot:0,botType:null,dexDom:0,cancelPat:0,pingPong:0,pathRoute:0,selfTrade:0,roundPay:0},s=(((m=t.behavior)==null?void 0:m.bots)||[]).find(v=>v.acct===e);if(s){let v=we((.35-s.cv)/.35,0,1);n.bot=+(.4*(.5+.5*v)).toFixed(3),n.botType=s.botType||"Periodic"}let a=t.dexPatterns,o=((g=(f=a==null?void 0:a.topActor)==null?void 0:f[0])==null?void 0:g.acct)===e&&a.topShare||0;o>0&&(n.dexDom=+(.3*we((o-.2)/.4,0,1)).toFixed(3));let i=((a==null?void 0:a.topCanceller)||[]).find(v=>v.acct===e);i&&(n.cancelPat=+(.2*we(i.count/20,0,1)).toFixed(3));let r=t.breadcrumbs||[],l=r.find(v=>v.from===e&&v.to===e);l&&(n.selfTrade=+(.2*we(l.count/20,0,1)).toFixed(3));let c=r[0];if(c&&(c.from===e||c.to===e)){let v=r.find(x=>x.from===c.to&&x.to===c.from);v&&v.count>=3&&c.count>=3&&(n.pingPong=.15)}let p=(((b=t.advanced)==null?void 0:b.topPathActors)||[]).find(v=>v.acct===e);p&&(n.pathRoute=+(.15*we(p.count/25,0,1)).toFixed(3));let u=(h=t.advanced)==null?void 0:h.roundnessIdx;return u!=null&&u>=45&&(p||s)&&(n.roundPay=+(.1*we((u-45)/35,0,1)).toFixed(3)),{score:we(n.bot+n.dexDom+n.cancelPat+n.pingPong+n.pathRoute+n.selfTrade+n.roundPay,0,1),breakdown:n}}function _v(e,t,n,s){if(!(n!=null&&n.length))return null;let a=cs+t;for(let o of n)if((o==null?void 0:o.account)===e){if(o.type==="EscrowCreate"&&o.destination===e){let i=typeof o.amountXrp=="number"?o.amountXrp:null,r=Vs(t);if(i!=null&&i>=r&&Di(o.memos).startsWith(mn))return s}if(o.type==="Payment"&&o.destination===e&&Number(o.destinationTag)===a&&Di(o.memos).startsWith(mn))return s}return null}async function Dv(e,t,n){var a;let s=ie.byAddr.get(e);if(s)try{let o=await Xi(e,s,n),i=mn+o.hash;if((((a=X.ledgerLog)==null?void 0:a.flatMap(c=>c.transactions||[]))||[]).some(c=>(c==null?void 0:c.account)!==e?!1:Di(c.memos).startsWith(i))){let c=cu();c[e]={ledgerIndex:n,hash:o.hash,level:t},Cv(c),ie.verifiedCache.set(e,{ledgerIndex:n,hash:o.hash}),ne(`\u2714 Credential verified for ${z(e)} at L${t}`)}}catch{}}function Di(e){if(!Array.isArray(e))return"";let t=[];for(let n of e){let s=(n==null?void 0:n.Memo)||(n==null?void 0:n.memo)||null;if(!s)continue;let a=s.MemoData||s.memo_data||"";try{if(typeof a=="string"&&/^[0-9A-Fa-f]+$/.test(a)&&a.length%2===0){let o=Uint8Array.from(a.match(/../g),i=>parseInt(i,16));t.push(new TextDecoder().decode(o))}else typeof a=="string"&&t.push(a)}catch{}}return t.join(" ")}async function Xi(e,t,n){let s=t.level||0,a=Vs(s),o=fe.marketPrice.at(-1)??null,i=o?(a*o).toFixed(2):null,r={hashAlgorithm:"SHA-512Half",ratchetMax:Ks,strikesToLevel:qp,strikeUp:Vp,strikeDown:Mi,decayLedgers:Ua,bondBaseXrp:hs,bondGrowthFactor:gs,bondRequiredXrp:a,bondRequiredUsd:i,credTagBase:cs,memoPrefix:mn,credentialTag:cs+s},l={v:2,hashAlg:"SHA-512Half",network:X.currentNetwork||"xrpl-mainnet",address:e,ledgerIndex:n!=null?Number(n):null,level:s,threatType:t.threatType||"Unknown",score:Number((t.score||0).toFixed(4)),strikes:Number(t.strikes||0),signalBreakdown:t.signalBreakdown||{},credential:{destinationTag:cs+s,memoFormat:mn+"<SHA-512Half-of-this-proof>",verifiedLedger:t.verifiedLedger??null},policy:r,note:"Generated by NaluXRP Spam Defense POC. Hash uses XRPL-native SHA-512Half (first 256 bits of SHA-512). A gateway or relayer policy can require the indicated bond/credential before providing service to this address.",generatedAt:new Date().toISOString()},c=JSON.stringify(l,Object.keys(l).sort(),0),p=await Tg(c);l.credential.memoFormat=mn+p;let u=JSON.stringify(l,null,2);return{hash:p,canonicalJson:u,level:s,policy:r,threatType:t.threatType}}function Iv(){let e=ie.selectedProof;if(!e){he("Generate a proof first using the Proof button.");return}let t=ie.selectedAddr||"\u2014",n=fe.marketPrice.at(-1)??null,s=e.policy.bondRequiredXrp,a=n?` (~$${(s*n).toFixed(0)} USD)`:"",o=e.hash.startsWith("FALLBACK")?'<div style="padding:8px 12px;background:#fff3cd;border:1px solid #f0ad4e;border-radius:4px;margin-bottom:12px">\u26A0 Hash is non-cryptographic (SubtleCrypto unavailable). Do NOT use for enforcement.</div>':"",i=window.open("","_blank","width=760,height=660");i.document.write(`<!DOCTYPE html><html><head>
    ...
    </body></html>`),i.document.close()}var pu=null;function Fv(){if(Li)return;Li=!0;let e=document.querySelector('[aria-label="Pattern detection"]');if(!e){e=document.createElement("section"),e.className="widget-card",e.setAttribute("aria-label","Pattern detection");let t=document.querySelector(".dashboard-col-main");if(!t)return;let n=t.querySelector(".dashboard-metrics");n?n.insertAdjacentElement("afterend",e):t.prepend(e)}e.innerHTML=`
    <div class="widget-header">
    ...
    </div>`,e.prepend(t)}function zv(){let e=w("whale-feed-list");if(!e)return;let t=w("whale-badge");if(t&&(t.textContent=_t.length?`${_t.length} alerts`:"Watching\u2026"),!_t.length){e.innerHTML='<div style="opacity:.5;font-size:.82rem;padding:8px 0">No whale transactions yet.</div>';return}e.innerHTML=_t.slice(0,20).map(n=>{let s=n.amtXrp>=1e6?`${(n.amtXrp/1e6).toFixed(2)}M`:n.amtXrp>=1e3?`${(n.amtXrp/1e3).toFixed(0)}K`:n.amtXrp.toFixed(0),a=Math.floor((Date.now()-n.ts)/1e3),o=a<60?`${a}s`:a<3600?`${Math.floor(a/60)}m`:`${Math.floor(a/3600)}h`;return`<div style="border-bottom:1px solid rgba(255,255,255,.05);padding:7px 0">
    ...
    </div>`}).join("")}function Wv(){if(Np)return;Np=!0;let e=document.querySelector(".dashboard-col-main");if(!e)return;let t=document.createElement("section");t.className="widget-card",t.id="network-health-card",t.setAttribute("aria-label","Network health"),t.innerHTML=`
    <div class="widget-header">
    ...
    <div style="display:flex;align-items:center;gap:16px;padding:8px 0 12px">
      ...
      </div>`}).join(""))}function jv(){if(Rp)return;Rp=!0;let e=document.querySelector(".dashboard-col-side");if(!e)return;let t=document.createElement("section");t.className="widget-card",t.id="session-stats-card",t.setAttribute("aria-label","Session stats"),t.innerHTML=`
    <div class="widget-header">
    ...
    </div>`,e.appendChild(t)}function qv(){if(!document.getElementById("session-stats-card"))return;let e=Math.floor((Date.now()-et.startTime)/6e4);V("ss-ledgers",et.ledgersProcessed.toLocaleString()),V("ss-tx",et.totalTx.toLocaleString()),V("ss-whales",et.whaleCount),V("ss-feespikes",et.feeSpikes),V("ss-bots",et.botDetections),V("ss-dexalerts",et.dexAlerts),V("ss-time",`${e}m`),V("ss-badge",`${et.ledgersProcessed} ledgers`)}function Vv(e,t){var o,i,r,l,c,p,u,d;if(Yp=t,_t.length&&_t[0].ledgerIndex===t){let m=_t[0],f=m.amtXrp>=1e6?`${(m.amtXrp/1e6).toFixed(1)}M`:`${(m.amtXrp/1e3).toFixed(0)}K`;ne(`\u{1F40B} Whale: ${f} XRP  ${z(m.from)} \u2192 ${z(m.to)}`)}let n=nu(),s=(o=X.feeHistory)==null?void 0:o.at(-1);s&&n&&s>n*Bn.feeSpikeMultiple&&(et.feeSpikes++,he(`\u{1F525} Fee spike: ${fn(s)} (${Math.round(s/n)}\xD7 baseline)`));let a=(((i=e.behavior)==null?void 0:i.bots)||[]).filter(m=>m.cv<Bn.botCvThreshold&&m.total>8);a.length&&(et.botDetections=Math.max(et.botDetections,a.length),a[0].botType==="Flood / Spam"&&he(`\u{1F916} Spam bot: ${z(a[0].acct)} (CV ${a[0].cv.toFixed(2)})`)),((l=(r=e.dexPatterns)==null?void 0:r.window)==null?void 0:l.cancelRatio)>=Bn.dexCancelAlert&&((p=(c=e.dexPatterns)==null?void 0:c.window)==null?void 0:p.total)>=20&&(et.dexAlerts++,he(`\u{1F9E0} DEX: ${Math.round(e.dexPatterns.window.cancelRatio*100)}% cancel ratio \u2014 possible quote-stuffing`)),((d=(u=e.clusters)==null?void 0:u[0])==null?void 0:d.size)>=Bn.clusterMinSize&&ne(`\u{1F578} Cluster: ${e.clusters[0].size} wallets around ${z(e.clusters[0].hub)}`),e.friction>=75&&e.regime==="Manipulated"&&he(`\u26A0\uFE0F Risk score: ${e.friction}/100 \u2014 ${e.regime} regime`),Uv(e.s)}function Gv(){var n,s,a,o;if(_p)return;_p=!0;let e=document.createElement("button");e.id="customize-btn",e.className="customize-btn",e.setAttribute("aria-pressed","false"),e.innerHTML="\u2699 Customize",(n=document.querySelector(".dashboard-header"))==null||n.appendChild(e);let t=document.createElement("div");t.id="customize-panel",t.className="customize-panel",t.setAttribute("aria-label","Dashboard customizer"),t.innerHTML=`
  ...
  `;t.innerHTML=s+o+a+g}function cy(e){var o;let t=document.getElementById("inspect-volconc-body");if(!t)return;let n={critical:"sev-critical",warn:"sev-warn",info:"sev-info",ok:"sev-ok"},s=e.signals.map(i=>`
    ...
    </div>`).join("");s.innerHTML=o+(n||"")}function dy(e){let t=[["Sample size",e.sampleSize],["Amount entropy",e.amountEntropy!=null?e.amountEntropy.toFixed(2)+" bits":"\u2014",e.amountEntropy!=null&&e.amountEntropy<2?"risk-text-high":""],["Counterparty entropy",e.counterpartyEntropy!=null?e.counterpartyEntropy.toFixed(2)+" bits":"\u2014"],["Time-of-day entropy",e.timeEntropy!=null?e.timeEntropy.toFixed(2)+" bits":"\u2014"],["Unique counterparties",e.uniqueCounterparties],["Verdict",e.verdict,e.verdict==="anomalous"?"risk-text-high":e.verdict==="elevated"?"risk-text-med":""]];to("inspect-entropy-body",e,'<div class="wash-stat-row" style="margin-top:10px"><span>Metric</span><span class="mono" style="opacity:.45">Value</span></div>'+t.map(([n,s,a])=>`<div class="wash-stat-row"><span>${n}</span><span class="mono ${a||""}">${s}</span></div>`).join(""))}function py(e){var s;let t=[["Unique counterparties",e.uniqueCounterparties],["Zipf exponent (s)",e.zipfExponent!=null?e.zipfExponent.toFixed(3):"\u2014",e.zipfExponent!=null&&(e.zipfExponent<.4||e.zipfExponent>2.2)?"risk-text-high":""],["Fit quality (R\xB2)",e.rSquared!=null?e.rSquared.toFixed(3):"\u2014",e.rSquared!=null&&e.rSquared<.55?"risk-text-high":""],["Natural range","s \u2248 0.8\u20131.3, R\xB2 > 0.55"],["Verdict",e.verdict,e.verdict==="anomalous"?"risk-text-high":e.verdict==="elevated"?"risk-text-med":""]],n=((s=e.freqTable)==null?void 0:s.slice(0,10).map((a,o)=>{let i=e.freqTable[0]||1,r=(a/i*100).toFixed(0),l=e.freqTable[0]?(e.freqTable[0]/Math.pow(o+1,e.zipfExponent||1)).toFixed(1):0;return`<div class="wash-stat-row">
    ...
    ${h}`}function hy(e,t,n,s,a,o,i,r=null,l=null,c=!1){let p=w("inspect-addr-badge");p&&(p.textContent=e.length>20?e.slice(0,10)+"\u2026"+e.slice(-8):e,p.title=e,p.dataset.fullAddr=e);let u=w("inspect-risk-score");u&&(u.textContent=i,u.className="irb-score-val "+Vi(i));let d=w("inspect-risk-label");d&&(d.textContent=i<20?"Low Risk":i<45?"Moderate":i<70?"High Risk":"Critical",d.className="irb-score-label "+Vi(i));let m=w("inspect-acct-grid");if(!m)return;let f=Math.max(0,n-s),g=Number(t.Flags||0),b=r!=null?r===0?"Created today":r===1?"1 day old":r<30?`${r} days old`:r<365?`${Math.floor(r/30)} months old`:`${(r/365).toFixed(1)} years old`:"\u2014",h=l?new Date(l).toLocaleDateString("en-US",{year:"numeric",month:"short",day:"numeric"}):null,v=h?c?`Created ${h}`:`Created ${h} (estimated \u2014 full history not confirmed)`:null,x=yn(n),k=yn(f),T=[{label:"XRP Balance",value:`${_(n,6)} XRP${x}`,mono:!0},{label:"Spendable",value:`${_(f,6)} XRP${k}`,mono:!0,note:`${s} XRP reserved`},{label:"Wallet Age",value:b,note:v,highlight:r!=null&&r<7?"new":null},{label:"Owner Count",value:a,note:`${a*2} XRP tied up`},{label:"Sequence",value:o,mono:!0},{label:"Regular Key",value:t.RegularKey?z(t.RegularKey):"None",warn:!!t.RegularKey,mono:!0},{label:"Master Key",value:g&_e.lsfDisableMaster?"Disabled":"Active",warn:!!(g&_e.lsfDisableMaster)}];m.innerHTML=T.map(S=>`
  ...
  `,no("badge-security",e.findings)}function vy(e,t,n,s){let a=w("inspect-drain-body");if(!a)return;let o={low:"#50fa7b",medium:"#ffb86c",high:"#ff8c42",critical:"#ff5555",none:"#50fa7b"},i={low:"\u2713",medium:"\u26A0",high:"\u26A0",critical:"\u26D4",none:"\u2713"},r=e.compromiseRiskLevel??e.riskLevel,l=e.assetDrainSeverity??"none";a.innerHTML=`
  ...
  `,jy("badge-drain",e.riskLevel)}function by(e,t){let n=w("inspect-nft-body");n&&(n.innerHTML=`
    <div class="audit-items">
      ${e.flags.map(s=>zn(s)).join("")}
    </div>
    ${t.length?`
    <div class="nft-grid">
      ${t.slice(0,12).map(s=>yy(s)).join("")}
    </div>
    ${t.length>12?`<div class="nft-more">+${t.length-12} more NFTs</div>`:""}
    `:""}
  `,no("badge-nft",e.flags))}function yy(e){let t=Number(e.Flags||0),n=!!(t&mu.lsfTransferable),s=!!(t&mu.lsfBurnable),a=e.NFTokenTaxon||0,o=e.TransferFee?`${(e.TransferFee/1e3).toFixed(1)}%`:"0%";return`
    <div class="nft-card">
    ...
    </div>`}function wy(e){let t=w("inspect-wash-body");if(!t)return;let n=e.verdict==="clean"||e.verdict==="low-risk"?"#50fa7b":e.verdict==="suspicious"?"#ffb86c":"#ff5555";t.innerHTML=`
  ...
  `;let s=w("badge-wash");if(s){let a=e.verdict==="clean"||e.verdict==="low-risk"?"ok":e.verdict==="suspicious"?"warn":"crit";s.textContent=e.verdict.replace("-"," "),s.className="section-badge section-badge--"+a}}function Js(e,t){return`<div class="wash-stat"><span class="wash-stat-label">${y(e)}</span><span class="wash-stat-val">${t}</span></div>`}function xy(e,t){let n=w("inspect-issuer-body");if(!n)return;let s=t.filter(a=>a.currency&&(a.currency.length===3||a.currency.length===40));n.innerHTML=`
    <div class="audit-items">
      ${e.signals.map(a=>zn(a)).join("")}
    </div>
    ${s.length?`
  ...
  `,no("badge-issuer",e.signals)}function ky(e,t){let n=w("inspect-amm-body");n&&(n.innerHTML=`
    <div class="audit-items">
  ...
  `,no("badge-amm",e.signals))}function $y(e){let t=w("trust-count-badge");t&&(t.textContent=e.length);let n=w("inspect-trust-body");n&&(n.innerHTML=e.length?e.map(s=>{let a=s.freeze?'<span class="trustline-frozen">Frozen</span>':"",o=s.freeze_peer?'<span class="trustline-frozen trustline-frozen--peer">Issuer Frozen</span>':"",i=s.no_ripple?'<span class="trustline-norip">NoRipple</span>':"";return`
          <div class="trustline-row">
          ...
          </div>`}).join(""):'<div class="inspect-empty-note">No transactions found.</div>',e.length>s&&(n.innerHTML+=`<div class="tx-more">Showing ${s} of ${e.length} transactions</div>`)}function Nu(e,t,n){let s=Number((n==null?void 0:n.totalIn)||0),a=Number((t==null?void 0:t.totalOut)||0),o=Number(e||0);if(s<=0&&a<=0)return'<div class="inspect-empty-note">No inbound or outbound XRP flow found in the analysed transaction history.</div>';let i=new Set(((t==null?void 0:t.blackHoleDests)||[]).map(k=>k.addr)),r=new Set(((t==null?void 0:t.exchangeDests)||[]).map(k=>k.addr)),l=new Set(((t==null?void 0:t.newWalletDests)||[]).map(k=>k.addr)),c=0,p=0,u=0,d=0;for(let k of(t==null?void 0:t.destinations)||[])i.has(k.addr)?c+=k.totalXrp:r.has(k.addr)?p+=k.totalXrp:l.has(k.addr)?u+=k.totalXrp:d+=k.totalXrp;let m=Math.max(s,a,o,1),f=k=>(k>0?Math.max(1.5,k/m*100):0).toFixed(1),g=[{label:"Black hole",xrp:c,color:bn.blackhole},{label:"Exchange",xrp:p,color:bn.exchange},{label:"New wallet",xrp:u,color:bn.newWallet},{label:"Other",xrp:d,color:bn.other}].filter(k=>k.xrp>0),b=a>0?Math.max(1.5,a/m*100):0,h=g.map(k=>`<div style="width:${(a>0?k.xrp/a*100:0).toFixed(1)}%;background:${k.color};height:100%" title="${y(k.label)}: ${_(k.xrp,2)} XRP"></div>`).join(""),v=(k,T,S,$,E)=>`
          ...
          <div class="flow-dest-row">
            ...
            <div class="flow-dest-info">
              ...
              <div class="flow-dest-meta">
                ...
                ${c.txCount>1?`<span class="flow-dest-span">${Ru(c.firstSeen,c.lastSeen)}</span>`:""}
              </div>
            </div>
          </div>`}).join("")}
    </div>
  ...
  `,a){let c=e.blackHoleDests.length||e.exchangeDests.length>2;a.textContent=`${e.uniqueDests} dests`,a.className=`section-badge section-badge--${c?"crit":e.uniqueDests>0?"warn":"ok"}`}}function Ru(e,t){if(!e||!t)return"";let n=new Date(e*1e3).toLocaleDateString(),s=new Date(t*1e3).toLocaleDateString();return n===s?n:`${n} \u2013 ${s}`}function Cy(e,t){let n=w("inspect-issuer-connections-body");if(!n)return;let s=e.totalIssued,a=w("badge-issuer-connections");if(n.innerHTML=`
    <div class="audit-items">
  ...
  `,a){let o=e.signals.some(i=>i.sev==="critical")?"crit":e.signals.some(i=>i.sev==="warn")?"warn":e.signals.some(i=>i.sev==="info")?"neutral":"ok";a.className=`section-badge section-badge--${o}`,a.textContent=s>0?`${e.holderCount} holders`:"No issuance"}}function Py(e){var p;let t=document.getElementById("inspect-fee-analysis-body");if(!t||!e)return;let n={critical:"sev-critical",warn:"sev-warn",info:"sev-info",ok:"sev-ok"},s=(e.signals||[]).map(u=>`
    ...
    </div>`;t.innerHTML=l+s+a+o;let c=document.getElementById("badge-fee-analysis");c&&(c.textContent=r?"Elevated":"Normal",c.className=`section-badge section-badge--${r?"warn":"ok"}`)}function My(e){var p,u;let t=document.getElementById("inspect-desttag-body");if(!t||!e)return;let n={critical:"sev-critical",warn:"sev-warn",info:"sev-info",ok:"sev-ok"},s=(e.signals||[]).map(d=>`
    ...
    ${e.selfRoutedCount?`<div class="wash-stat-row"><span>Self-routed payments</span><span class="mono risk-text-high">${e.selfRoutedCount}</span></div>`:""}`;if(n.innerHTML=o+i,s){let l=e.signals.some(p=>p.sev==="critical"),c=e.signals.some(p=>p.sev==="warn");s.textContent=l?"Critical":c?"Check":"Normal",s.className=`section-badge section-badge--${l?"crit":c?"warn":"ok"}`}}function Ay(e){var r,l,c;let t=w("inspect-inbound-body");if(!t)return;let n={critical:"sev-critical",warn:"sev-warn",info:"sev-info",ok:"sev-ok"},s=(e.signals||[]).map(p=>`
    ...
    <div class="flow-dest-list">
      ${e.topSources.map((p,u)=>{let d=e.totalIn>0?(p.totalXrp/e.totalIn*100).toFixed(0):0,m=p.entity,f=m?`<span class="flow-entity-badge flow-entity--${m.type}">${y(m.name)}</span>`:"";return`<div class="flow-dest-row">
          ...
          <div class="flow-dest-info">
            <div class="flow-dest-top">
              <a href="https://xrpscan.com/account/${y(p.addr)}" target="_blank" rel="noopener" class="addr-link mono cut">${y(z(p.addr))}</a>
              ${f}
            </div>
            <div class="flow-bar-row">
    ...
    ${e.wallShare>.3?`<div class="wash-stat-row"><span>Largest single order share</span><span class="mono ${e.wallShare>.4?"risk-text-high":"risk-text-med"}">${(e.wallShare*100).toFixed(1)}%</span></div>`:""}`;n.innerHTML=a+o;let i=w("badge-livebook");if(i){let r=(e.signals||[]).some(c=>c.sev==="critical"),l=(e.signals||[]).some(c=>c.sev==="warn");i.textContent=r?"Wall order":l?"Check":"Normal",i.className=`section-badge section-badge--${r?"crit":l?"warn":"ok"}`}}function Dy(e,...t){let n=w("inspect-risk-breakdown");if(!n)return;let s=ny(e,...t);if(!s.length){n.innerHTML="";return}let a=Math.max(1,s.reduce((o,i)=>o+i.pts,0));n.innerHTML=`
  ...
  `}function Xy(e,...t){e.innerHTML=By(...t)}function Hy(){let e=document.getElementById("tab-inspector");e&&(e.querySelector("[data-inspector-v2]")||(e.innerHTML=`
    <style>
  ...
  `))}function zy(){if(document.getElementById("inspector-nav"))return;let e=document.createElement("nav");e.id="inspector-nav",e.setAttribute("aria-label","Inspector navigation"),e.innerHTML=`
  ...
  `;let t=document.getElementById("tab-inspector");t&&t.appendChild(e)}function Wy(){if(document.getElementById("inspector-howto"))return;let e=document.createElement("div");e.id="inspector-howto",e.className="howto-overlay",e.style.display="none",e.innerHTML=`
  ...
  `).join(""))}function Zy(){let e=document.getElementById("isd-cap-grid");e&&(e.innerHTML=Jy.map(t=>`
  ...
  `).join(""))}function Zi(){let e=document.getElementById("isd-wallets-section"),t=document.getElementById("isd-wallet-list");if(!e||!t)return;let n=ge(Q(Gy))||[];if(!n.length){e.style.display="none";return}e.style.display="",t.innerHTML=n.map(s=>{let a=s.color||"#50fa7b",o=s.emoji||"\u{1F48E}",i=s.label||"Wallet",r=s.address||"",l=r?r.slice(0,8)+"\u2026"+r.slice(-6):"\u2014",c=s.testnet?'<span class="isd-wallet-testnet">TESTNET</span>':"";return`
    ...
    `}).join("")}function er(){let e=document.getElementById("isd-recent-section"),t=document.getElementById("isd-recent-list");if(!e||!t)return;let n=so();if(!n.length){e.style.display="none";return}e.style.display="",t.innerHTML=n.map((s,a)=>{let o=s.addr?s.addr.slice(0,10)+"\u2026"+s.addr.slice(-8):"\u2014",i=s.riskScore!=null?`<span class="isd-risk-pill isd-risk-pill--${Fu(s.riskScore)}">${s.riskScore}</span>`:"";return`
    ...
    `}).join("")}function e0(){eo(),window.addEventListener("xrpl-ledger",t0),window.addEventListener("xrpl-connection",eo)}function t0(e){Za()&&eo(e.detail)}var Wi=null;function n0(){return Wi||(Wi={idx:document.getElementById("isd-ledger-idx"),age:document.getElementById("isd-ledger-age"),tps:document.getElementById("isd-tps"),tpsTrnd:document.getElementById("isd-tps-trend"),fee:document.getElementById("isd-fee"),feeLv:document.getElementById("isd-fee-level"),close:document.getElementById("isd-close-time"),dot:document.getElementById("isd-conn-dot"),connLbl:document.getElementById("isd-conn-label"),pill:document.getElementById("isd-conn-pill"),domTx:document.getElementById("isd-dom-tx"),domPct:document.getElementById("isd-dom-pct"),bar:document.getElementById("isd-fee-bar"),barLbl:document.getElementById("isd-fee-bar-label")})}function eo(){let{idx:e,age:t,tps:n,tpsTrnd:s,fee:a,feeLv:o,close:i,dot:r,connLbl:l,pill:c,domTx:p,domPct:u,bar:d,barLbl:m}=n0(),f=X.connectionState||"disconnected",g={connected:{label:"Connected",cls:"conn--live"},connecting:{label:"Connecting\u2026",cls:"conn--warn"},disconnected:{label:"Disconnected",cls:"conn--dead"}},b=g[f]||g.disconnected;r&&(r.className="isd-conn-dot"),l&&(l.textContent=b.label),c&&(c.className=`isd-conn-pill ${b.cls}`);let h=X.ledgerLog||[];if(h.length&&e){let S=h[0];if(e.textContent=Number(S.ledgerIndex||0).toLocaleString(),t&&(t.textContent=S.closeTimeSec!=="\u2014"?S.closeTimeSec+"s close":"\u2014"),i){let $=parseFloat(S.closeTimeSec);i.textContent=isNaN($)?"\u2014":$.toFixed(1)}}let v=X.tpsHistory||[];if(v.length&&n){let S=v.slice(-5),$=S.reduce((E,C)=>E+C,0)/S.length;if(n.textContent=$.toFixed(1),s&&v.length>=6){let E=v.slice(-10,-5),C=E.reduce((R,O)=>R+O,0)/E.length,P=$-C;s.textContent=P>.5?"\u2191 rising":P<-.5?"\u2193 falling":"\u2192 stable",s.className=`isd-metric-sub ${P>.5?"isd-up":P<-.5?"isd-down":""}`}}let x=X.feeHistory||[];if(x.length&&a){let S=x.slice(-5),$=S.reduce((P,R)=>P+R,0)/S.length,E=$/1e6;a.textContent=$<5e3?$.toFixed(0)+" drops":E.toFixed(5)+" XRP";let C=$<20?{lbl:"Low",cls:"fee-low",pct:10}:$<100?{lbl:"Normal",cls:"fee-normal",pct:28}:$<500?{lbl:"Elevated",cls:"fee-elevated",pct:60}:$<2e3?{lbl:"High",cls:"fee-high",pct:82}:{lbl:"Congested",cls:"fee-congest",pct:100};o&&(o.textContent=C.lbl,o.className=`isd-metric-sub ${C.cls}`),d&&(d.style.width=C.pct+"%",d.className=`isd-fee-bar-fill ${C.cls}`),m&&(m.textContent=C.lbl,m.className=`isd-fee-bar-level ${C.cls}`)}let k=X.txMixAccum||{},T=Object.entries(k).filter(([,S])=>S>0).sort(([,S],[,$])=>$-S);if(T.length&&p){let S=T.reduce((C,[,P])=>C+P,0),[$,E]=T[0];p.textContent=$,u&&(u.textContent=(E/S*100).toFixed(0)+"% of traffic")}}window.exportTxCSV=function(e){var l,c;if(!e||!e.length){alert("No transaction data to export. Run an inspection first.");return}let t=946684800,s=[["Hash","Date","Type","Account","Destination","Amount_XRP","Amount_Token","Currency","Fee_Drops","DestinationTag","Result","LedgerIndex"],...e.map(({tx:p,meta:u})=>{var h,v;let d=p.date?new Date((p.date+t)*1e3).toISOString():"",m=typeof p.Amount=="string"?(Number(p.Amount)/1e6).toFixed(6):"",f=(h=p.Amount)!=null&&h.value?p.Amount.value:"",g=((v=p.Amount)==null?void 0:v.currency)||(typeof p.Amount=="string"?"XRP":""),b=(u==null?void 0:u.TransactionResult)||"";return[p.hash||"",d,p.TransactionType||"",p.Account||"",p.Destination||"",m,f,g,p.Fee||"",p.DestinationTag??"",b,p.ledger_index||""]})].map(p=>p.map(u=>{let d=String(u);return d.includes(",")||d.includes('"')||d.includes(`
`)?'"'+d.replace(/"/g,'""')+'"':d}).join(",")).join(`
`),a=new Blob([s],{type:"text/csv;charset=utf-8;"}),o=URL.createObjectURL(a),i=document.createElement("a"),r=((c=(l=document.getElementById("inspect-addr-badge"))==null?void 0:l.dataset)==null?void 0:c.fullAddr)||"wallet";i.href=o,i.download=`naluxrp_${r.slice(0,10)}_${new Date().toISOString().slice(0,10)}.csv`,document.body.appendChild(i),i.click(),document.body.removeChild(i),URL.revokeObjectURL(o)};function s0(e,t){let s=so().find(o=>o.addr===e);if(!s||s.riskScore==null||t==null)return null;let a=t-s.riskScore;return{prev:s.riskScore,curr:t,diff:a,ts:s.ts}}function a0(e,t){let n=s0(e,t);if(!n||Math.abs(n.diff)<2)return;let s=document.getElementById("inspect-risk-score");if(!s)return;let a=n.diff>0?`<span style="color:#ff5555;font-size:.7rem;font-weight:700"> \u2191${n.diff}</span>`:`<span style="color:#50fa7b;font-size:.7rem;font-weight:700"> \u2193${Math.abs(n.diff)}</span>`,o=ao(n.ts);s.insertAdjacentHTML("afterend",`<span class="risk-score-diff" title="Changed from ${n.prev} \u2192 ${n.curr} since ${o}">${a} vs ${o}</span>`)}window._inspectMaxTx||(window._inspectMaxTx=5e3);window._debugBalanceDeltas=$u;window._debugOfferLifecycles=Au;window._debugReconstructBalanceHistory=Su;window._debugFindDrainEpisodes=Tu;window._debugDrainRisk=Lu;window.inspectorLoadAddr=function(e){let t=w("inspect-addr");t&&(t.value=e),ws()};window.inspectWalletAddr=function(e){var n,s;window.inspectorLoadAddr(e);let t=document.querySelector('[data-tab="inspector"]');t&&((n=window.switchTab)==null||n.call(window,t,"inspector")),(s=window.showDashboard)==null||s.call(window)};window.printInspectorReport=function(){var s,a;let e=document.getElementById("inspect-report-body");if(!e)return;let t=((a=(s=document.getElementById("inspect-addr-badge"))==null?void 0:s.dataset)==null?void 0:a.fullAddr)||"wallet",n=window.open("","_blank","width=900,height=700");n.document.write(`<!DOCTYPE html><html><head>
    ...
    ${e.innerHTML}
  </body></html>`),n.document.close()};window.exportInspectorReport=function(){var n;let e=document.getElementById("inspect-report-body");if(!e)return;let t=e.innerText||e.textContent||"";(n=navigator.clipboard)==null||n.writeText(t).then(()=>{let s=document.getElementById("report-export-btn");s&&(s.textContent="\u2713 Copied!",setTimeout(()=>{s.textContent="\u{1F4CB} Copy Report"},2e3))}).catch(()=>{let s=document.createRange();s.selectNodeContents(e);let a=window.getSelection();a.removeAllRanges(),a.addRange(s)})};window.inspectorClearHistory=function(){vt(Qi);let e=document.getElementById("isd-recent-section");e&&(e.style.display="none")};window.inspectorClearWatchlist=function(){vt(Zs),ta()};function so(){return ge(Q(Qi))||[]}function o0(e,t,n=[]){let s=so();s=s.filter(o=>o.addr!==e);let a=n.filter(o=>o.sev==="critical"||o.sev==="warn").map(o=>o.module+":"+o.headline.slice(0,40)).sort().join("|");s.unshift({addr:e,riskScore:t,ts:Date.now(),fingerprint:a}),s=s.slice(0,12),Z(Qi,JSON.stringify(s))}function ea(){return ge(Q(Zs))||[]}function i0(e,t){let n=ea().filter(s=>s.addr!==e);n.unshift({addr:e,label:t||z(e),addedTs:Date.now(),lastScore:null,lastTs:null}),Z(Zs,JSON.stringify(n.slice(0,50)))}function Iu(e){Z(Zs,JSON.stringify(ea().filter(t=>t.addr!==e)))}function Ki(e){return ea().some(t=>t.addr===e)}function r0(e,t){let n=ea().map(s=>s.addr===e?{...s,lastScore:t,lastTs:Date.now()}:s);Z(Zs,JSON.stringify(n))}function ao(e){let t=Date.now()-e;return t<6e4?"just now":t<36e5?Math.floor(t/6e4)+"m ago":t<864e5?Math.floor(t/36e5)+"h ago":Math.floor(t/864e5)+"d ago"}function Fu(e){return Vi(e).replace("risk-","")}var Zt=!1;function Ou(){Zt=localStorage.getItem(Du)==="true",tr()}function tr(){let e=document.getElementById("inspect-result");if(!e)return;e.classList.toggle("mode-advanced",Zt),e.classList.toggle("mode-simple",!Zt);let t=document.getElementById("analyst-mode-btn");t&&(t.textContent=Zt?"\u2697 Advanced":"\u{1F441} Simple",t.title=Zt?"Switch to Simple view":"Switch to Advanced (analyst) view",t.setAttribute("aria-pressed",String(Zt)))}window.toggleAnalystMode=function(){Zt=!Zt,localStorage.setItem(Du,Zt),tr()};var l0=new Set(["section-overview","section-report"]),c0=new Set(["section-security","section-drain","section-fundflow","section-inbound"]);function d0(){let e=document.getElementById("inspect-result");if(!e)return;let t=[...e.querySelectorAll(".inspector-section")],n={crit:0,warn:1,neutral:2,ok:3,"":4},s=t.filter(i=>!l0.has(i.id)&&!c0.has(i.id));s.sort((i,r)=>{let l=c=>{let p=c.querySelector(".section-badge");if(!p)return"";let u=p.className;return u.includes("crit")?"crit":u.includes("warn")?"warn":u.includes("neutral")?"neutral":u.includes("ok")?"ok":""};return(n[l(i)]??4)-(n[l(r)]??4)});let a=document.getElementById("section-inbound")||document.getElementById("section-drain");if(!a)return;let o=a;for(let i of s)o.after(i),o=i}function p0(e){let t=(e||[]).filter(s=>s.confidence!=null);if(!t.length)return null;let n=t.reduce((s,a)=>s+a.confidence,0)/t.length;return n>=.7?"Strong":n>=.4?"Moderate":"Weak"}function u0(e,t,n,s,a={},o=!1,i=null){let r=document.getElementById("quick-verdict-body");if(!r)return;let l=t.filter(E=>E.sev==="critical"),c=t.filter(E=>E.sev==="warn"),p=e<20?"#50fa7b":e<45?"#ffb86c":e<70?"#ff8c42":"#ff5555",u=e<20?"Low Risk":e<45?"Moderate":e<70?"High Risk":"Critical",d=(E,C)=>(C.confidence??.5)-(E.confidence??.5),m=[...l].sort(d),f=[...c].sort(d),g="",b="";if(l.length===0&&c.length===0)g=`No elevated signals found across ${s.toLocaleString()} transactions${n!=null?` and ${n} days of history`:""}.`,b="This wallet appears to operate within normal parameters.";else{let E=m.slice(0,2).map(P=>P.headline).join("; "),C=f.slice(0,2).map(P=>P.headline).join("; ");g=l.length?`${l.length} critical issue${l.length>1?"s":""}: ${E}.`:`${c.length} warning${c.length>1?"s":""}: ${C}.`,b=l.length?"Review the highlighted sections below. Scroll to the Report for full recommendations.":"Review the flagged sections below for context before drawing conclusions."}let h=qi.map(E=>({cat:E,...a[E]})).filter(E=>E.score>0).sort((E,C)=>C.score-E.score),v=E=>E<20?"#50fa7b":E<45?"#ffb86c":E<70?"#ff8c42":"#ff5555",x={Strong:"#50fa7b",Moderate:"#ffb86c",Weak:"#ff8c42"},k=h.length?`
    <div style="margin-top:10px;padding-top:10px;border-top:1px solid rgba(255,255,255,.06)">
      ...
      <div style="display:flex;flex-direction:column;gap:4px">
        ${h.map(E=>{let C=p0(E.findings);return`
          <div style="display:flex;align-items:center;gap:8px;font-size:.76rem">
            <span style="width:150px;color:rgba(255,255,255,.6);flex-shrink:0">${y(sy[E.cat])}</span>
            <div style="flex:1;height:5px;border-radius:3px;background:rgba(255,255,255,.06);overflow:hidden">
              <div style="width:${E.score}%;height:100%;background:${v(E.score)};border-radius:3px"></div>
            </div>
            <span class="mono" style="color:${v(E.score)};width:28px;text-align:right;flex-shrink:0">${E.score}</span>
    ...
    </div>`}function ta(){let e=document.getElementById("isd-watchlist-section"),t=document.getElementById("isd-watchlist-list");if(!e||!t)return;let n=ea();if(!n.length){e.style.display="none";return}e.style.display="",t.innerHTML=n.map(s=>{let a=s.addr.slice(0,8)+"\u2026"+s.addr.slice(-6),o=s.lastScore!=null?`<span class="isd-risk-pill isd-risk-pill--${Fu(s.lastScore)}">${s.lastScore}</span>`:"",i=s.lastTs?ao(s.lastTs):"never checked";return`
    ...
    </div>`}function Xu(e,t){let n=new Map;for(let{tx:s,meta:a}of e){let o=s.Account===t,i=s.Destination===t;if(!o&&!i)continue;let r=o?s.Destination:s.Account;if(!r||r===t)continue;let l=Wn(s);n.has(r)||n.set(r,{cnt:0,xrpOut:0,xrpIn:0,entity:Hn(r),firstSeen:l,lastSeen:l});let c=n.get(r);c.cnt++,l&&(c.firstSeen=c.firstSeen?Math.min(c.firstSeen,l):l,c.lastSeen=Math.max(c.lastSeen,l));let p=(a==null?void 0:a.delivered_amount)||s.Amount,u=typeof p=="string"?Number(p)/1e6:0;o?c.xrpOut+=u:c.xrpIn+=u}return n}function f0(e,t,n=15){let s=Xu(e,t),a=[...s.entries()].sort((r,l)=>l[1].xrpOut+l[1].xrpIn-(r[1].xrpOut+r[1].xrpIn)||l[1].cnt-r[1].cnt).slice(0,n);if(!a.length)return'<div class="inspect-empty-note">No counterparty interactions found.</div>';let o=Math.max(...a.map(([,r])=>r.xrpOut+r.xrpIn),1),i=a.map(([r,l],c)=>{var h;let p=l.xrpOut+l.xrpIn,u=Math.max(1.5,p/o*100),d=bn[(h=l.entity)==null?void 0:h.type]||bn.other,m=p>0?l.xrpOut/p:.5,f=m>.65?"\u2192 out":m<.35?"\u2190 in":"\u21C4 both",g=l.entity?`<span style="font-size:.64rem;color:${d};border:1px solid ${d};border-radius:999px;padding:1px 7px;margin-left:6px">${y(l.entity.name)}</span>`:"",b=Ru(l.firstSeen,l.lastSeen);return`
    ...
    ${i}`}function h0(e,t,n,s,a="inspect-network-map"){let o=document.getElementById(a);if(!o)return;let r=[...Xu(e,t).entries()].sort(($,E)=>E[1].xrpOut+E[1].xrpIn-($[1].xrpOut+$[1].xrpIn)||E[1].cnt-$[1].cnt).slice(0,20);if(r.length<2){o.style.display="",o.innerHTML=`<div class="inspect-empty-note">${r.length===0?"No counterparty interactions found.":"Only one counterparty found \u2014 not enough to chart a network map."}</div>`;return}o.style.display="";let l=560,c=340,p=l/2,u=c/2,d=95,m=7,f=155,g=13,b=r[0][1].xrpOut+r[0][1].xrpIn||1,h=r[0][1].cnt||1,v=[{id:t,x:p,y:u,r:13,main:!0,label:z(t),color:"#00d4ff",xrpOut:0,xrpIn:0,cnt:0}];r.forEach(([$,E],C)=>{let P=C<m?d:f,R=C<m?m:g,D=(C<m?C:C-m)/R*2*Math.PI-Math.PI/2,I=E.xrpOut+E.xrpIn,F=Math.max(5,Math.min(14,4+I/b*10)),H=E.entity,N=bn[H==null?void 0:H.type]||bn.other,W=I>0?E.xrpOut/I:.5,se=W>.65?"out":W<.35?"in":"both";v.push({id:$,x:p+P*Math.cos(D),y:u+P*Math.sin(D),r:F,color:N,label:(H==null?void 0:H.name)||z($),ent:H,xrpOut:E.xrpOut,xrpIn:E.xrpIn,cnt:E.cnt,dir:se,vol:I,ring:P})});let x=`<defs>
  ...
  </defs>`,k=v.slice(1).map($=>{let E=$.vol/b,C=Math.max(.8,E*3),P=.12+E*.45,R=$.dir==="out"?"rgba(80,250,123,":$.dir==="in"?"rgba(0,212,255,":"rgba(255,184,108,",O=$.dir==="out"?`rgba(80,250,123,${P})`:$.dir==="in"?`rgba(0,212,255,${P})`:`rgba(255,184,108,${P})`,D=$.dir==="in"?"5,3":"none",I=`marker-end="url(#arrow-${$.dir})"`,F=$.x-p,H=$.y-u,N=Math.sqrt(F*F+H*H),W=($.r+2)/N,se=p+F*(1-W),re=u+H*(1-W),pe=`${$.xrpOut>0?"\u2192 "+_($.xrpOut,2)+" XRP out":""}${$.xrpIn>0?($.xrpOut>0?" / ":"")+"\u2190 "+_($.xrpIn,2)+" XRP in":""}, ${$.cnt} tx`;return`<line x1="${p}" y1="${u}" x2="${se.toFixed(1)}" y2="${re.toFixed(1)}"
      stroke="${O}" stroke-width="${C.toFixed(1)}" stroke-dasharray="${D}" ${I}>
      <title>${pe}</title></line>`}).join(""),T=v.map($=>{var H,N;if($.main){let W=z($.id);return`<g>
        ...
        <text x="${p}" y="${u+4}" text-anchor="middle" font-size="6.5" fill="#00d4ff" font-weight="800">${y(W)}</text>
    ...
    </div>`}function g0(){let e=window._lastInspectResult,t=window._lastAllFindings||[];if(!e)return null;let n=t.length?t.map(a=>`- [${a.sev.toUpperCase()}] ${a.module}: ${a.headline}${a.detail?" \u2014 "+a.detail:""}`).join(`
...
You are acting as a security analyst explaining automated blockchain forensics findings to someone who isn't a blockchain expert. Write a clear, plain-English explanation of what this account's activity suggests. Synthesize the findings above into a coherent read of the account rather than restating them one by one \u2014 call out which ones reinforce each other and which are weak signals on their own. Be direct about how concerning (or not) this looks, and be skeptical of your own confidence where the evidence is thin rather than overstating it. Do not repeat the address or risk score back verbatim; the reader can already see those above your response.`}window.copyInspectorAnalysisForAi=function(){let e=document.getElementById("ai-explanation-body"),t=g0();if(!t){e&&(e.innerHTML='<p style="font-size:.82rem;color:#ff5555">Run an inspection first.</p>');return}Hs(t)};window.exportInspectorJSON=function(){var o,i;let e=window._lastInspectResult;if(!e){alert("Run an inspection first.");return}let t=new Blob([JSON.stringify(e,null,2)],{type:"application/json"}),n=URL.createObjectURL(t),s=document.createElement("a"),a=((i=(o=document.getElementById("inspect-addr-badge"))==null?void 0:o.dataset)==null?void 0:i.fullAddr)||"wallet";s.href=n,s.download=`naluxrp_${a.slice(0,10)}_${new Date().toISOString().slice(0,10)}.json`,document.body.appendChild(s),s.click(),document.body.removeChild(s),URL.revokeObjectURL(n)};var v0=6e4,b0=1e4,y0=12e4,w0=8e3,x0=12e4,k0=300,Qu="nalulf_net_baseline_v2",$0=80,S0=5,aa="/api/v1/validatorregistry",Zu="/api/v1/validator";var T0=5*60*1e3,em=10*60*1e3,Hu=1e4,tm=8e3,or=new Map,ir=new Map;var tn={quorumTight:{w:3,label:"Quorum within 3 validators of failure threshold"},nUnlActive:{w:2,label:"Negative UNL active \u2014 validators currently being ignored"},amendVeto:{w:1,label:"Amendment veto clustering \u2014 protocol governance dispute"},feeSpike:{w:2,label:"Open ledger fee 10\xD7 minimum \u2014 DDoS / spam attack likely"},burnAnomaly:{w:2,label:"XRP burn rate z-score > 3\u03C3 \u2014 resource exhaustion pattern"},peerSaturate:{w:2,label:"Inbound peers > 80% of connections \u2014 Eclipse Attack risk"},eclipseRisk:{w:3,label:"Peer count < 6 \u2014 node highly vulnerable to isolation"},dexSpike:{w:1,label:"DEX volume > 3\xD7 AMM baseline \u2014 unusual event-driven flow"},reserveSpike:{w:1,label:"New account rate > 3\xD7 baseline \u2014 possible bot creation"},slowConverge:{w:2,label:"Consensus convergence > 6s \u2014 network agreement degraded"},lowProposers:{w:2,label:"Proposer count below quorum \u2014 validator participation low"},queuePressure:{w:2,label:"TX queue > 80% full \u2014 fee surge imminent"},spamLedger:{w:1,label:"Ledger > 2\xD7 expected size \u2014 ledger spam in progress"},ioStressed:{w:1,label:"Node IO latency > 5ms \u2014 storage or network I/O stress"},peerChurn:{w:1,label:"Elevated peer disconnect rate \u2014 DDoS or instability"},staleLedger:{w:3,label:"Ledger age > 10s \u2014 validation appears stalled"}},nm={MultiSign:{purpose:"Multi-signature authorization",intro:"rippled 0.31",desc:"Lets multiple keys jointly authorize one transaction. Essential for institutional custody and hardware-wallet setups.",impact:"New transaction: SignerListSet. All signers submit their signature; the last one broadcasts."},MultiSignReserve:{purpose:"Cheaper signer-list reserve",intro:"rippled 1.2",desc:"Cuts the owner reserve for SignerList objects from 5 owner-items (10 XRP) down to 1 owner-item (2 XRP).",impact:"Existing SignerLists do not gain the reduction automatically; delete and re-create the list."},DepositAuth:{purpose:"Block unsolicited incoming payments",intro:"rippled 0.90",desc:"An account can set lsfDepositAuth so it only receives payments explicitly pre-authorized via DepositPreauth.",impact:"Senders to un-authorized accounts receive tecNO_PERMISSION."},DeletableAccounts:{purpose:"Permanent account deletion + reserve reclaim",intro:"rippled 1.4",desc:"An account with no objects and sequence \u2265 (current ledger \u2212 256) can permanently delete itself and recover the base reserve.",impact:"New transaction: AccountDelete. Sends all XRP minus fees to a destination."},NegativeUNL:{purpose:"Fault-tolerant consensus during outages",intro:"rippled 1.6",desc:"When validators are persistently offline, the network may add them to the Negative UNL so they do not count against quorum.",impact:"Enables the network to survive planned outages of up to 20% of trusted validators."},Checks:{purpose:"Deferred, cancellable payments",intro:"rippled 1.0",desc:"The sender creates a Check; the recipient can later cash it up to the authorized amount or let it expire. The sender can cancel at any time.",impact:"New transactions: CheckCreate, CheckCash, CheckCancel. Each open Check uses one owner-reserve slot."},AMM:{purpose:"Native Automated Market Maker DEX",intro:"rippled 1.12",desc:"Adds a Constant-Product (x*y=k) AMM directly in the ledger. Anyone can deposit two assets to earn LP tokens and a share of swap fees.",impact:"New transactions: AMMCreate, AMMDeposit, AMMWithdraw, AMMVote, AMMBid, AMMDelete."},XChainBridge:{purpose:"Cross-chain bridge protocol",intro:"rippled 2.0",desc:"Lets assets move between XRPL Mainnet, sidechains, and EVM chains via a locking/minting bridge secured by Witness servers.",impact:"New ledger objects: Bridge, XChainOwnedCreateAccountClaimID, etc. Requires Witness infrastructure."},Clawback:{purpose:"Token-issuer recovery",intro:"rippled 1.12",desc:"Issuers who set lsfAllowTrustLineClawback before issuing tokens can claw back tokens from any holder.",impact:"Must be enabled on a fresh account before any trust lines are created."},NonFungibleTokensV1:{purpose:"Native NFT support",intro:"rippled 1.9",desc:"Adds NFTokenMint, NFTokenBurn, and offer-based transfer mechanics for non-fungible tokens stored in NFTokenPage objects.",impact:"Each NFTokenPage holds up to 32 tokens and costs one owner-reserve slot. Royalties up to 50%."},NonFungibleTokensV1_1:{purpose:"NFT V1 corrections",intro:"rippled 1.10",desc:"Fixes pagination bugs, transfer-fee edge cases, and minting with the URI field that were present in V1.",impact:"Breaking fix for some V1 edge cases. Wallets built for V1 should test V1_1 compatibility."},PayChan:{purpose:"Payment channels for streaming micropayments",intro:"rippled 0.33",desc:"Sender deposits XRP into a channel, then issues signed claims off-ledger. Recipient submits the highest claim at any time to settle on-ledger.",impact:"New transactions: PaymentChannelCreate, PaymentChannelFund, PaymentChannelClaim."},Escrow:{purpose:"Time-locked and condition-based XRP transfers",intro:"rippled 0.60",desc:"Lock XRP until a future time OR a cryptographic fulfillment (PREIMAGE-SHA-256) is revealed, enabling vesting schedules and atomic swaps.",impact:"New transactions: EscrowCreate, EscrowFinish, EscrowCancel. Locked XRP counts against reserves."},DisallowIncoming:{purpose:"Block unsolicited ledger-object creation",intro:"rippled 1.10",desc:"New account flags let you individually block incoming Trust Lines, Check objects, NFToken offers, and Payment Channels.",impact:"Four new AccountSet flags; existing incoming objects are unaffected."},ExpandedSignerList:{purpose:"Larger multi-sig signer lists",intro:"rippled 1.9.1",desc:"Increases the maximum signers per SignerList from 8 to 32, enabling more complex institutional multi-sig and DAO governance.",impact:"Reserve cost scales with signer count. Requires MultiSignReserve to be cost-effective."},OwnerPaysFee:{purpose:"Correct fee payer in PayChan",intro:"rippled 0.33",desc:"Fixes a spec inconsistency where the channel owner correctly pays the transaction fee when closing or expiring channels.",impact:"Purely a fee-accounting fix; no user-visible behavior changes."},fixMasterKeyAsRegularKey:{purpose:"Master-key mis-use bug fix",intro:"rippled 0.90",desc:"Prevents accounts from setting their master key as their regular key \u2014 an operation that could create an unusable account state.",impact:"No application changes needed; existing accounts are not affected."},TrustSetAuth:{purpose:"Authorized trust lines",intro:"rippled 0.30",desc:"Issuers can require explicit authorization before anyone can hold their token \u2014 a prerequisite for regulatory-grade stablecoins.",impact:"New flow: issuer sends TrustSet with tfSetfAuth to approve each holder."}},zu=new Set(["xrpscan.com","xrpl.aesthetes.art","xrpkuwait.com","xrpgoat.com","xrp.vet","xrp.unic.ac.cy","xrp-validator.interledger.org","xpmarket.com","verum.eminence.im","validator.xrpl.robertswarthout.com","validator.xrpl-labs.com","validator.poli.usp.br","validator.gatehub.net","validator.aspired.nz","v2.xrpl-commons.org","tequ.dev","squidrouter.com","ripple.ittc.ku.edu","ripple.com","peersyst.cloud","onxrp.com","katczynski.net","jon-nilsen.no","ekiserrepe.es","cabbit.tech","bithomp.com","aureusox.com","arrington-xrp-capital.blockdaemon.com","anodos.finance","bitso.com","ripple.kenan-flagler.unc.edu","ripplevalidator.uwaterloo.ca","shadow.haas.berkeley.edu","www.bitrue.com","xrp-col.anu.edu.au"]),C0=new Set(["nHBu3iuq1SQ9Z686pYwWYVKpScSMDWfpUJHdNEQRxn5XyETui7Db","nHDwBbubxJswoweWQKEgWLNRJv2hNRCTR4GGApJmbtCcbtYNSpdB","nHU2FpRbPrvVcyQQpkqrAUDJDTRHZpjij8DpKeSC481PYY9ikYkb","nHUbmg8QNzEGjHzgnt99e9YE2scU3DZGH7FsF6MCcK5eiPt3AtaH","nHUxBD1UPb383SdWgJx62GGQ7W2WKvgpUtUXLjiGGRRcPb3nbSXd","nHUP6rfQfgzg6tKga3k9ziEvtjwn1PB32gcr5dLcamqzmitszYv2","nHBT58yHyDdPdJ6gzaBMT7gqwTMpj5ERji1s9SvfKKtfoZUS89WX","nHBxsUzx3Bbf6J4yJ3fLQ3VizPtdREVwTJ6mdqkuDTjLcVbggVbk","nHUeUNSn3zce2xQZWNghQvd9WRH6FWEnCBKYVJu2vAizMxnXegfJ","nHUCAdca6VoWWYVdBH1bwCUQggEX2e5acQSqxM3DwyuhsFknxmh3","nHDDiwQBqXhEL1CFoRHdMXD33x9K7rpYJfniXxL7kFavpPd21EGe","nHBipbbREjNEiCs4hpy3K2489dRf27MPnxdivTTWKSd8ZUhfRvn8","nHDDe5uAdiv6RA59MA1oM4JLDtVSYKNShgjEqq1KsdJXZiR47CQT","nHBbiP5ua5dUqCTz5i5vd3ia9jg3KJthohDjgKxnc7LxtmnauW7Z","nHBQ3CT3EWYZ4uzbnL3k6TRf9bBPhWRFVcK1F5NjtwCBksMEt5yy","nHU16DF2kq7TmbR1Y5z8yKNXiLEf3oHT19HVpVXv7unFLfxa17nT","nHUC23NnutZyYeQxQbAbPUpKoVGj5aisBxf2zzcZzJ43fcw5rc9z","nHUgdMvuchx7AWG4ATMQdNNuMryo1SFoNptLCEVt2Dn7wEc625mF","nHUhQVE93dajM3srxubsEj1mK1gzRwJob14QSrJefY1FdLs6r7WJ","nHUU8xBczYzW6kZ6Ei9DsggzTJXRFkN3wE3FP5H4SLYzhbodeYcG","nHUGqooyfGqFkyH6uskbaEi6y2MjXjdA7QdbmyZ6p9etL5isRKLT","nHDp1ZXxEn7eo5YaUtiagaxSLwXudnKZDx68C96p4tdVLGLLLUFn","nHBcLEB4S6moQGrhMjJo1jbp58WL5psHY9EMDWNAtdqykUYiA1rF","nHUAECq1v1cKwn3NsYVyD7v6BNbfqyXmNVSF3e4XCVxPgBHRWkvv","nHUif4sukXu9pJGyyBaeVMwmE8L1fJ5KJj4X4ksgTKhgjG6k96s2","nHUVJR7SeT3nn6JPTz46JHqYRf7vX2if1sdTxnceywmSBWa167pt","nHUEYz4TtTv7yebjhY3aDib5KYPHnKjnY5mPYK5y4QuKdocwS5tD","nHUN5n2S3nQ8bzKm7bqeFMiQeDijh1LMgEocyNyQbb4mREazVdZ5","nHUgchANqM3giYSSvY5HsafFW6qxmG5jJ3CvPiv7n8gjNQuNm8Uz","nHDUqGoM7KR1pgbdYBRgKpGKdFLhpnMzVbECs8RE73RGZm3Va6MJ","nHUVxTi8XfXjaaJppw7mLSrYDRpkDpf8H9ypzgVKxfSXShcWwAoK","nHBveTxA1NaBj5AayRAU91f6YopuFWt9rmxfGaEh77a32Q6ZzzHc"]),P0=new Set(["validator.pftperry.com","rip973.com","preaware.org","postfiat.org","pftmeech.xyz","pft.xbtseal.com","pft.wizbubba.xyz","pft.permanentupperclass.com","pft.g.money","pft.akirax.xyz","jollydinger.com","auri0x.io","app.w.ai"]);function sm(e,t){let n=(t||"").toLowerCase().replace(/^www\./,"");return C0.has(e)||P0.has(n)?{chain:"test",isUnl:!1}:zu.has(n)||zu.has("www."+n)?{chain:"main",isUnl:!0}:{chain:"main",isUnl:!1}}var fr={"xrpscan.com":{label:"XRP Scan",domain:"xrpscan.com",chain:"main",category:"unl"},"xrpl.aesthetes.art":{label:"Aesthetes",domain:"xrpl.aesthetes.art",chain:"main",category:"unl"},"xrpkuwait.com":{label:"XRP Kuwait",domain:"xrpkuwait.com",chain:"main",category:"unl"},"xrpgoat.com":{label:"XRP Goat",domain:"xrpgoat.com",chain:"main",category:"unl"},"xrp.vet":{label:"XRP Vet",domain:"xrp.vet",chain:"main",category:"unl"},"xrp.unic.ac.cy":{label:"Univ. of Nicosia",domain:"xrp.unic.ac.cy",chain:"main",category:"unl"},"xrp-validator.interledger.org":{label:"Interledger",domain:"xrp-validator.interledger.org",chain:"main",category:"unl"},"xpmarket.com":{label:"XPMarket",domain:"xpmarket.com",chain:"main",category:"unl"},"verum.eminence.im":{label:"Eminence",domain:"verum.eminence.im",chain:"main",category:"unl"},"validator.xrpl.robertswarthout.com":{label:"R. Swarthout",domain:"validator.xrpl.robertswarthout.com",chain:"main",category:"unl"},"validator.xrpl-labs.com":{label:"XRPL Labs",domain:"validator.xrpl-labs.com",chain:"main",category:"unl"},"validator.poli.usp.br":{label:"USP",domain:"validator.poli.usp.br",chain:"main",category:"unl"},"validator.gatehub.net":{label:"Gatehub",domain:"validator.gatehub.net",chain:"main",category:"unl"},"validator.aspired.nz":{label:"Aspired NZ",domain:"validator.aspired.nz",chain:"main",category:"unl"},"v2.xrpl-commons.org":{label:"XRPL Commons",domain:"v2.xrpl-commons.org",chain:"main",category:"unl"},"tequ.dev":{label:"Tequ",domain:"tequ.dev",chain:"main",category:"unl"},"squidrouter.com":{label:"Squid Router",domain:"squidrouter.com",chain:"main",category:"unl"},"ripple.ittc.ku.edu":{label:"Univ. of Kansas",domain:"ripple.ittc.ku.edu",chain:"main",category:"unl"},"ripple.com":{label:"Ripple",domain:"ripple.com",chain:"main",category:"unl"},"peersyst.cloud":{label:"Peersyst",domain:"peersyst.cloud",chain:"main",category:"unl"},"onxrp.com":{label:"OnXRP",domain:"onxrp.com",chain:"main",category:"unl"},"katczynski.net":{label:"Katczynski",domain:"katczynski.net",chain:"main",category:"unl"},"jon-nilsen.no":{label:"Jon Nilsen",domain:"jon-nilsen.no",chain:"main",category:"unl"},"ekiserrepe.es":{label:"Ekiserrepe",domain:"ekiserrepe.es",chain:"main",category:"unl"},"cabbit.tech":{label:"Cabbit",domain:"cabbit.tech",chain:"main",category:"unl"},"bithomp.com":{label:"Bithomp",domain:"bithomp.com",chain:"main",category:"unl"},"aureusox.com":{label:"Aureus Ox",domain:"aureusox.com",chain:"main",category:"unl"},"arrington-xrp-capital.blockdaemon.com":{label:"Arrington / Blockdaemon",domain:"arrington-xrp-capital.blockdaemon.com",chain:"main",category:"unl"},"anodos.finance":{label:"Anodos Finance",domain:"anodos.finance",chain:"main",category:"unl"},"bitso.com":{label:"Bitso",domain:"bitso.com",chain:"main",category:"unl"},"ripple.kenan-flagler.unc.edu":{label:"UNC Kenan-Flagler",domain:"ripple.kenan-flagler.unc.edu",chain:"main",category:"unl"},"ripplevalidator.uwaterloo.ca":{label:"Univ. of Waterloo",domain:"ripplevalidator.uwaterloo.ca",chain:"main",category:"unl"},"shadow.haas.berkeley.edu":{label:"UC Berkeley Haas",domain:"shadow.haas.berkeley.edu",chain:"main",category:"unl"},"www.bitrue.com":{label:"Bitrue",domain:"www.bitrue.com",chain:"main",category:"unl"},"xrp-col.anu.edu.au":{label:"ANU",domain:"xrp-col.anu.edu.au",chain:"main",category:"unl"},"xrpval.rawsec.de":{label:"Rawsec",domain:"xrpval.rawsec.de",chain:"main",category:"other"},"xrplvl.carbonvibe.com":{label:"Carbon Vibe",domain:"xrplvl.carbonvibe.com",chain:"main",category:"other"},"xrplvalidator.alloy.ee":{label:"Alloy",domain:"xrplvalidator.alloy.ee",chain:"main",category:"other"},"xrpl.uni.lu":{label:"Univ. of Luxembourg",domain:"xrpl.uni.lu",chain:"main",category:"other"},"xrpl.to":{label:"XRPL.to",domain:"xrpl.to",chain:"main",category:"other"},"xrpl.su":{label:"XRPL.su",domain:"xrpl.su",chain:"main",category:"other"},"xrpl.sbivc.co.jp":{label:"SBI VC Trade",domain:"xrpl.sbivc.co.jp",chain:"main",category:"other"},"xrpl-verification.flare.network":{label:"Flare Network",domain:"xrpl-verification.flare.network",chain:"main",category:"other"},"xrpl-validator.7rev.dev":{label:"7Rev",domain:"xrpl-validator.7rev.dev",chain:"main",category:"other"},"xrp.teacopula.com":{label:"Teacopula",domain:"xrp.teacopula.com",chain:"main",category:"other"},"xrp.moneymindedapes.com":{label:"MoneyMindedApes",domain:"xrp.moneymindedapes.com",chain:"main",category:"other"},"xrp.hazza-systems.de":{label:"Hazza Systems",domain:"xrp.hazza-systems.de",chain:"main",category:"other"},"xrp.cs.uoregon.edu":{label:"Univ. of Oregon",domain:"xrp.cs.uoregon.edu",chain:"main",category:"other"},"xrp.bpsqn.com":{label:"BPSQN",domain:"xrp.bpsqn.com",chain:"main",category:"other"},"xrp-validator.grapedrop.xyz":{label:"Grapedrop",domain:"xrp-validator.grapedrop.xyz",chain:"main",category:"other"},"xaodao.io":{label:"XaoDAO",domain:"xaodao.io",chain:"main",category:"other"},"vl.xrpsalute.com":{label:"XRP Salute",domain:"vl.xrpsalute.com",chain:"main",category:"other"},"validator.xrpl.app":{label:"XRPL App",domain:"validator.xrpl.app",chain:"main",category:"other"},"validator.ukcbt.org":{label:"UKCBT",domain:"validator.ukcbt.org",chain:"main",category:"other"},"validator.sugarxrpl.com":{label:"SugarXRPL",domain:"validator.sugarxrpl.com",chain:"main",category:"other"},"validator.boscaern.digital":{label:"Boscaern",domain:"validator.boscaern.digital",chain:"main",category:"other"},"trimaera.tech":{label:"Trimaera",domain:"trimaera.tech",chain:"main",category:"other"},"textrp.io":{label:"TextRP",domain:"textrp.io",chain:"main",category:"other"},"tesbert.com":{label:"Tesbert",domain:"tesbert.com",chain:"main",category:"other"},"tachyon-xrpl-validator.github.io":{label:"Tachyon",domain:"tachyon-xrpl-validator.github.io",chain:"main",category:"other"},"solonation.io":{label:"SoloNation",domain:"solonation.io",chain:"main",category:"other"},"smokydrip.com":{label:"SmokyDrip",domain:"smokydrip.com",chain:"main",category:"other"},"rippled-validator.us":{label:"rippled-validator.us",domain:"rippled-validator.us",chain:"main",category:"other"},"rippleat.snt.uni.lu":{label:"Univ. Luxembourg (SNT)",domain:"rippleat.snt.uni.lu",chain:"main",category:"other"},"ripple.uni.lu":{label:"Univ. Luxembourg",domain:"ripple.uni.lu",chain:"main",category:"other"},"ripple.j2b.com":{label:"J2B",domain:"ripple.j2b.com",chain:"main",category:"other"},"rich-list.info":{label:"Rich List",domain:"rich-list.info",chain:"main",category:"other"},"proptoexchange.com":{label:"ProPtoExchange",domain:"proptoexchange.com",chain:"main",category:"other"},"printscierge.com":{label:"Printscierge",domain:"printscierge.com",chain:"main",category:"other"},"opulencex.io":{label:"OpulenceX",domain:"opulencex.io",chain:"main",category:"other"},"onledger.net":{label:"OnLedger",domain:"onledger.net",chain:"main",category:"other"},"oclost.art":{label:"Oclost",domain:"oclost.art",chain:"main",category:"other"},"managednetwork.us":{label:"ManagedNetwork",domain:"managednetwork.us",chain:"main",category:"other"},"joshuahamsa.com":{label:"Joshua Hamsa",domain:"joshuahamsa.com",chain:"main",category:"other"},"grimmsxrpflow.jwscott.net":{label:"Grimm XRP Flow",domain:"grimmsxrpflow.jwscott.net",chain:"main",category:"other"},"getlol.xyz":{label:"GetLol",domain:"getlol.xyz",chain:"main",category:"other"},"gen3labs.xyz":{label:"Gen3 Labs",domain:"gen3labs.xyz",chain:"main",category:"other"},"garveyvalid.com":{label:"Garvey",domain:"garveyvalid.com",chain:"main",category:"other"},"easynpl.kr":{label:"EasyNPL",domain:"easynpl.kr",chain:"main",category:"other"},"diseb.ewi.tudelft.nl":{label:"TU Delft",domain:"diseb.ewi.tudelft.nl",chain:"main",category:"other"},"datamossa.com":{label:"DataMossa",domain:"datamossa.com",chain:"main",category:"other"},"crypto.unibe.ch":{label:"Univ. of Bern",domain:"crypto.unibe.ch",chain:"main",category:"other"},"commonprefix.com":{label:"Common Prefix",domain:"commonprefix.com",chain:"main",category:"other"},"catalyze-research.com":{label:"Catalyze Research",domain:"catalyze-research.com",chain:"main",category:"other"},"catalog.org":{label:"Catalog",domain:"catalog.org",chain:"main",category:"other"},"blockchain.korea.ac.kr":{label:"Korea Univ.",domain:"blockchain.korea.ac.kr",chain:"main",category:"other"},"astatiumprotocol.com":{label:"Astatium Protocol",domain:"astatiumprotocol.com",chain:"main",category:"other"},"ladykxrpl.mywire.org":{label:"LadyK XRPL",domain:"LadyKXRPL.mywire.org",chain:"main",category:"other"},"eelap-p1201-xrp.abudhabi.nyu.edu":{label:"NYU Abu Dhabi",domain:"EELAP-P1201-XRP.ABUDHABI.NYU.EDU",chain:"main",category:"other"},"589.clouds.hspeed.ch":{label:"HSpeed",domain:"589.clouds.hspeed.ch",chain:"main",category:"other"},"validator.pftperry.com":{label:"PFT Perry",domain:"validator.pftperry.com",chain:"test",category:"other"},"rip973.com":{label:"rip973",domain:"rip973.com",chain:"test",category:"other"},"preaware.org":{label:"Preaware",domain:"preaware.org",chain:"test",category:"other"},"postfiat.org":{label:"PostFiat",domain:"postfiat.org",chain:"test",category:"other"},"pftmeech.xyz":{label:"PFT Meech",domain:"pftmeech.xyz",chain:"test",category:"other"},"pft.xbtseal.com":{label:"PFT XBT Seal",domain:"pft.xbtseal.com",chain:"test",category:"other"},"pft.wizbubba.xyz":{label:"PFT Wizbubba",domain:"pft.wizbubba.xyz",chain:"test",category:"other"},"pft.permanentupperclass.com":{label:"PFT Perm Upper Class",domain:"pft.permanentupperclass.com",chain:"test",category:"other"},"pft.g.money":{label:"PFT G.Money",domain:"pft.g.money",chain:"test",category:"other"},"pft.akirax.xyz":{label:"PFT Akirax",domain:"pft.akirax.xyz",chain:"test",category:"other"},"jollydinger.com":{label:"Jollydinger",domain:"jollydinger.com",chain:"test",category:"other"},"auri0x.io":{label:"Auri0x",domain:"auri0x.io",chain:"test",category:"other"},"app.w.ai":{label:"W.ai",domain:"app.w.ai",chain:"test",category:"other"}},po={nHB8QMKGt9VB4Vg71VszjBVQnDW3v3QudM4436zXRZgiuUBBSWJe:{lat:37.77,lng:-122.42,city:"San Francisco",org:"Ripple"},nHUon2tpyJEHHYGmxqNd3h3oGNQwNyX8PNS3aHe3bNpCrNXZlHo:{lat:37.77,lng:-122.41,city:"San Francisco",org:"Ripple"},nHUpwrafS45zmi6eT72XS5ijpkW5JwfL5mLdPhEibrqUvtRcMAjU:{lat:37.78,lng:-122.4,city:"San Francisco",org:"Ripple"},nHUkp7WhouVMobBUKGrV5FNqjsdD9zKP5jpGnnLfQXCMNe4dkDqo:{lat:37.76,lng:-122.43,city:"San Francisco",org:"Ripple"},nHUryiyDqEtyWVtFG24AAhaYjMf9FRLietZGBWYwUTojmugMsx3o:{lat:37.79,lng:-122.38,city:"San Francisco",org:"Ripple"},nHUpcmNsxAw47yt2ADDoNoQrzLyTJPgnyq16u6Qx2kRPA17oUNHz:{lat:37.8,lng:-122.39,city:"San Francisco",org:"Ripple"},nHUnhRJK3csknycNK5SXRFi8jvDp3sKoWvS9wKWLq1ATBBGgPBjp:{lat:37.75,lng:-122.44,city:"San Francisco",org:"Ripple"},nHUq9tJvk5QTDkwurB7EzbzkZ2uuoHjS3GKjP6pZiU3DJGnobNYK:{lat:39.04,lng:-77.49,city:"Ashburn, VA",org:"AWS (Coil)"},nHUvcCcmoH1FJMMC6NtF9KKA4LpCWhjsxk2reCQidsp5AHQ7QY9H:{lat:49.45,lng:11.08,city:"Nuremberg",org:"Hetzner (Gatehub)"},nHDH7bQJpVfDhVSqdui3Z8GPvKEBQpo6AKHcnXe21zoD4nABA6xj:{lat:52.37,lng:4.9,city:"Amsterdam",org:"GCP (XRPL Labs)"},nHUED59jjpQ5QbNtesAbB6Es3uUPv3c9Ri5MNNgfMv5t5Lhb5ndW:{lat:19.43,lng:-99.13,city:"Mexico City",org:"AWS (Bitso)"},nHBidG3pZK11zqjeVos6hFxTDPGYuqfRFZ5gu9b7tQFdB8nPZujG:{lat:35.69,lng:139.69,city:"Tokyo",org:"NTT (Digital Garage)"},nHDB2PAPYqF86j9j3c6w1F1ZqwvQfiWcFShZ9Pokg9q4ohNDSkAz:{lat:47.61,lng:-122.33,city:"Seattle, WA",org:"Azure (Arrington)"},nHUdphn3LXa31w5sLd39MQdPEKQNrNYL3DQFByijVXiNQ3G6BYBZ:{lat:1.35,lng:103.82,city:"Singapore",org:"AWS (Tokenize)"},nHUFCyRCrUjvtZmKiLeF8ReopzKuSkVzdl1VsMCqm75aqyohLYEg:{lat:48.86,lng:2.35,city:"Paris",org:"OVH (XRPL Commons)"},nHULqGBkJtWeNFjhTzYeAsHA3qKKS7HoBh8CV3BAGTGMZuepEhWC:{lat:40.71,lng:-74.01,city:"New York",org:"Equinix (Blockchain LLC)"},nHBdXSF6YHAHSZUk7rvox6jwbvvyqBnsWGcewBtq8x1XuH6KXKXr:{lat:37.79,lng:-122.4,city:"San Francisco",org:"Cloudflare (XRP Scan)"}},Wu={"xrpscan.com":{lat:51.51,lng:-.13,city:"London",org:"XRPScan"},"xrpl.aesthetes.art":{lat:52.37,lng:4.9,city:"Amsterdam",org:"Aesthetes"},"xrpkuwait.com":{lat:29.37,lng:47.98,city:"Kuwait City",org:"XRP Kuwait"},"xrpgoat.com":{lat:39.04,lng:-77.49,city:"Ashburn, VA",org:"XRP Goat"},"xrp.vet":{lat:48.86,lng:2.35,city:"Paris",org:"XRP Vet"},"xrp.unic.ac.cy":{lat:35.17,lng:33.37,city:"Nicosia",org:"Univ. of Nicosia"},"xrp-validator.interledger.org":{lat:40.71,lng:-74.01,city:"New York",org:"Interledger Foundation"},"xpmarket.com":{lat:52.37,lng:4.9,city:"Amsterdam",org:"XPMarket"},"verum.eminence.im":{lat:51.51,lng:-.13,city:"London",org:"Eminence"},"validator.xrpl.robertswarthout.com":{lat:52.37,lng:4.9,city:"Amsterdam",org:"R. Swarthout"},"validator.xrpl-labs.com":{lat:52.37,lng:4.9,city:"Amsterdam",org:"XRPL Labs"},"validator.xrpl.app":{lat:52.37,lng:4.9,city:"Amsterdam",org:"XRPL App"},"validator.poli.usp.br":{lat:-23.55,lng:-46.63,city:"S\xE3o Paulo",org:"USP"},"validator.gatehub.net":{lat:46.05,lng:14.51,city:"Ljubljana",org:"Gatehub"},"validator.aspired.nz":{lat:-36.86,lng:174.76,city:"Auckland",org:"Aspired NZ"},"v2.xrpl-commons.org":{lat:48.86,lng:2.35,city:"Paris",org:"XRPL Commons"},"tequ.dev":{lat:60.17,lng:24.94,city:"Helsinki",org:"Tequ"},"squidrouter.com":{lat:37.77,lng:-122.42,city:"San Francisco",org:"Squid Router"},"ripple.ittc.ku.edu":{lat:38.97,lng:-95.24,city:"Lawrence, KS",org:"Univ. of Kansas"},"ripple.com":{lat:37.77,lng:-122.42,city:"San Francisco",org:"Ripple"},"peersyst.cloud":{lat:41.39,lng:2.15,city:"Barcelona",org:"Peersyst"},"onxrp.com":{lat:51.51,lng:-.13,city:"London",org:"OnXRP"},"katczynski.net":{lat:52.23,lng:21.01,city:"Warsaw",org:"Katczynski"},"jon-nilsen.no":{lat:59.91,lng:10.75,city:"Oslo",org:"Jon Nilsen"},"ekiserrepe.es":{lat:40.42,lng:-3.7,city:"Madrid",org:"Ekiserrepe"},"cabbit.tech":{lat:51.51,lng:-.13,city:"London",org:"Cabbit"},"bithomp.com":{lat:59.33,lng:18.07,city:"Stockholm",org:"Bithomp"},"aureusox.com":{lat:40.71,lng:-74.01,city:"New York",org:"Aureus Ox"},"arrington-xrp-capital.blockdaemon.com":{lat:40.71,lng:-74.01,city:"New York",org:"Blockdaemon"},"anodos.finance":{lat:37.98,lng:23.73,city:"Athens",org:"Anodos Finance"},"bitso.com":{lat:19.43,lng:-99.13,city:"Mexico City",org:"Bitso"},"ripple.kenan-flagler.unc.edu":{lat:35.9,lng:-79.05,city:"Chapel Hill, NC",org:"UNC Kenan-Flagler"},"ripplevalidator.uwaterloo.ca":{lat:43.47,lng:-80.54,city:"Waterloo, ON",org:"Univ. of Waterloo"},"shadow.haas.berkeley.edu":{lat:37.87,lng:-122.26,city:"Berkeley, CA",org:"UC Berkeley Haas"},"www.bitrue.com":{lat:1.35,lng:103.82,city:"Singapore",org:"Bitrue"},"xrp-col.anu.edu.au":{lat:-35.28,lng:149.13,city:"Canberra",org:"ANU"},"xrpval.rawsec.de":{lat:51.17,lng:10.45,city:"Germany",org:"Rawsec"},"xrplvl.carbonvibe.com":{lat:51.51,lng:-.13,city:"London",org:"Carbon Vibe"},"xrplvalidator.alloy.ee":{lat:59.44,lng:24.75,city:"Tallinn",org:"Alloy"},"xrpl.uni.lu":{lat:49.61,lng:6.13,city:"Luxembourg",org:"Univ. of Luxembourg"},"xrpl.to":{lat:48.86,lng:2.35,city:"Paris",org:"XRPL.to"},"xrpl.su":{lat:55.75,lng:37.62,city:"Moscow",org:"XRPL.su"},"xrpl.sbivc.co.jp":{lat:35.69,lng:139.69,city:"Tokyo",org:"SBI VC Trade"},"xrpl-verification.flare.network":{lat:51.51,lng:-.13,city:"London",org:"Flare Network"},"xrpl-validator.7rev.dev":{lat:52.52,lng:13.4,city:"Berlin",org:"7Rev"},"xrp.teacopula.com":{lat:39.04,lng:-77.49,city:"Ashburn, VA",org:"Teacopula"},"xrp.moneymindedapes.com":{lat:39.04,lng:-77.49,city:"Ashburn, VA",org:"MoneyMindedApes"},"xrp.hazza-systems.de":{lat:52.52,lng:13.4,city:"Berlin",org:"Hazza Systems"},"xrp.cs.uoregon.edu":{lat:44.05,lng:-123.08,city:"Eugene, OR",org:"Univ. of Oregon"},"xrp.bpsqn.com":{lat:37.77,lng:-122.42,city:"San Francisco",org:"BPSQN"},"xrp-validator.grapedrop.xyz":{lat:52.37,lng:4.9,city:"Amsterdam",org:"Grapedrop"},"xaodao.io":{lat:1.35,lng:103.82,city:"Singapore",org:"XaoDAO"},"vl.xrpsalute.com":{lat:40.71,lng:-74.01,city:"New York",org:"XRP Salute"},"validator.ukcbt.org":{lat:51.51,lng:-.13,city:"London",org:"UKCBT"},"validator.sugarxrpl.com":{lat:37.77,lng:-122.42,city:"San Francisco",org:"SugarXRPL"},"validator.boscaern.digital":{lat:53.33,lng:-6.25,city:"Dublin",org:"Boscaern"},"trimaera.tech":{lat:48.86,lng:2.35,city:"Paris",org:"Trimaera"},"textrp.io":{lat:1.35,lng:103.82,city:"Singapore",org:"TextRP"},"tesbert.com":{lat:39.04,lng:-77.49,city:"Ashburn, VA",org:"Tesbert"},"tachyon-xrpl-validator.github.io":{lat:37.77,lng:-122.42,city:"San Francisco",org:"Tachyon"},"solonation.io":{lat:1.35,lng:103.82,city:"Singapore",org:"SoloNation"},"smokydrip.com":{lat:39.04,lng:-77.49,city:"Ashburn, VA",org:"SmokyDrip"},"rippled-validator.us":{lat:39.04,lng:-77.49,city:"Ashburn, VA",org:"rippled-validator.us"},"rippleat.snt.uni.lu":{lat:49.61,lng:6.13,city:"Luxembourg",org:"Univ. of Luxembourg"},"ripple.uni.lu":{lat:49.61,lng:6.13,city:"Luxembourg",org:"Univ. of Luxembourg"},"ripple.j2b.com":{lat:37.77,lng:-122.42,city:"San Francisco",org:"J2B"},"rich-list.info":{lat:51.51,lng:-.13,city:"London",org:"Rich List"},"proptoexchange.com":{lat:39.04,lng:-77.49,city:"Ashburn, VA",org:"ProPtoExchange"},"printscierge.com":{lat:39.04,lng:-77.49,city:"Ashburn, VA",org:"Printscierge"},"opulencex.io":{lat:1.35,lng:103.82,city:"Singapore",org:"OpulenceX"},"onledger.net":{lat:52.37,lng:4.9,city:"Amsterdam",org:"OnLedger"},"oclost.art":{lat:48.86,lng:2.35,city:"Paris",org:"Oclost"},"managednetwork.us":{lat:39.04,lng:-77.49,city:"Ashburn, VA",org:"ManagedNetwork"},"joshuahamsa.com":{lat:37.77,lng:-122.42,city:"San Francisco",org:"Joshua Hamsa"},"grimmsxrpflow.jwscott.net":{lat:39.04,lng:-77.49,city:"Ashburn, VA",org:"Grimm XRP Flow"},"getlol.xyz":{lat:39.04,lng:-77.49,city:"Ashburn, VA",org:"GetLol"},"gen3labs.xyz":{lat:37.77,lng:-122.42,city:"San Francisco",org:"Gen3 Labs"},"garveyvalid.com":{lat:40.71,lng:-74.01,city:"New York",org:"Garvey"},"easynpl.kr":{lat:37.57,lng:126.98,city:"Seoul",org:"EasyNPL"},"diseb.ewi.tudelft.nl":{lat:52,lng:4.36,city:"Delft",org:"TU Delft"},"datamossa.com":{lat:48.86,lng:2.35,city:"Paris",org:"DataMossa"},"crypto.unibe.ch":{lat:46.95,lng:7.45,city:"Bern",org:"Univ. of Bern"},"commonprefix.com":{lat:37.98,lng:23.73,city:"Athens",org:"Common Prefix"},"catalyze-research.com":{lat:51.51,lng:-.13,city:"London",org:"Catalyze Research"},"catalog.org":{lat:37.77,lng:-122.42,city:"San Francisco",org:"Catalog"},"blockchain.korea.ac.kr":{lat:37.57,lng:126.98,city:"Seoul",org:"Korea Univ."},"astatiumprotocol.com":{lat:1.35,lng:103.82,city:"Singapore",org:"Astatium Protocol"},"ladykxrpl.mywire.org":{lat:39.04,lng:-77.49,city:"Ashburn, VA",org:"LadyK XRPL"},"eelap-p1201-xrp.abudhabi.nyu.edu":{lat:24.47,lng:54.37,city:"Abu Dhabi",org:"NYU Abu Dhabi"},"589.clouds.hspeed.ch":{lat:47.38,lng:8.54,city:"Zurich",org:"HSpeed"},"www.payonline.financial":{lat:55.75,lng:37.62,city:"Moscow",org:"PayOnline"}};function hr(e){if(!e)return null;let t=e.toLowerCase().replace(/^www\./,"");return Wu[t]??Wu["www."+t]??null}var M0=[{lat:37.34,lng:-121.89,label:"s1.ripple.com",city:"San Jose, CA",org:"Ripple"},{lat:37.34,lng:-121.87,label:"s2.ripple.com",city:"San Jose, CA",org:"Ripple"},{lat:52.37,lng:4.91,label:"xrplcluster.com",city:"Amsterdam",org:"Cluster"},{lat:52.36,lng:4.89,label:"xrpl.ws",city:"Amsterdam",org:"Cluster"}],Oe={nunl:{hex:"#ff5555",glow:"rgba(255,85,85,.4)",label:"Negative UNL"},both:{hex:"#50fa7b",glow:"rgba(80,250,123,.4)",label:"UNL + dUNL"},unl:{hex:"#00fff0",glow:"rgba(0,255,240,.35)",label:"UNL"},dunl:{hex:"#bd93f9",glow:"rgba(189,147,249,.4)",label:"dUNL only"},other:{hex:"#ffb86c",glow:"rgba(255,184,108,.4)",label:"Other"},pub:{hex:"#50fa7b",glow:"rgba(80,250,123,.4)",label:"Public Node"}},rr="https://api.xrpscan.com/api/v1/validatorregistry",xe=new Map,wn={},lo=0,qn=!1,xn="fallback";function am(){if(!qn){xe.clear();for(let[e,t]of Object.entries(fr)){let n=t.domain??e,s=sm("",n),a=hr(n)??null;xe.set(e,{key:e,label:t.label,domain:n,domainVerified:!1,provider:t.provider??(a==null?void 0:a.org)??null,lists:t.lists??[],category:s.isUnl?"unl":"other",chain:s.chain,unl:s.isUnl,dunl:!1,geo:a,meta:{},agreement:{"1h":null,"24h":null,"30d":null}})}xn="fallback",gr({ok:!1,source:"fallback",error:"using hardcoded data \u2014 mount /api/v1 router"})}}var lr=0,L0=5*60*1e3;function Uu(e,t){var s,a;let n=Array.isArray(e)?e:e.validators??e.data??[];if(!n.length)throw new Error("Empty validators array");xe.clear();for(let o of n){let i=o.key??o.validation_public_key??o.master_key??o.signing_key??null;if(!i)continue;let r=o.domain??null,l=r?r.toLowerCase().replace(/^www\./,""):null,c=o.unl===!0||o.unl===1||o.unl==="true",p=sm(i,l),u=c||p.isUnl,d=p.chain,m=u?"unl":"other",f=Object.values(fr).find(x=>x.domain&&x.domain.toLowerCase().replace(/^www\./,"")===l),g=(f==null?void 0:f.label)??o.label??o.account_name??o.name??l??null??`${i.slice(0,8)}\u2026${i.slice(-6)}`,b=po[i]??hr(l)??null,v=(((s=o.geo)==null?void 0:s.lat)!=null&&((a=o.geo)==null?void 0:a.lng)!=null?o.geo:null)??b;xe.set(i,{key:i,label:g,domain:r??null,domainVerified:!!(o.domainVerified??o.domain_verified),provider:o.provider??(v==null?void 0:v.org)??(f==null?void 0:f.provider)??null,lists:Array.isArray(o.lists)?o.lists:[],category:m,chain:d,unl:u,dunl:!1,geo:v,version:o.version??o.build_version??null,baseFee:o.base_fee_xrp??o.base_fee??null,ownerReserve:o.reserve_inc_xrp??o.owner_reserve??null,meta:o.meta??{},agreement:o.agreement??{"1h":nr(o.agreement_1h??o.agr_1h),"24h":nr(o.agreement_24h??o.agr_24h),"30d":nr(o.agreement_30d??o.agr_30d)}})}wn=e.lists??{},lo=Date.now(),qn=!0,xn=t,lr=0,gr({ok:!0,count:xe.size,lists:wn,source:t})}function nr(e){if(!e)return null;let t=Number(e.total??e.ledgers??0),n=Number(e.missed??0),s=t-n,a=t>0?(s/t*100).toFixed(1):null;return{total:t,missed:n,hit:s,score:a?`${a}%`:null,scoreRaw:e.score??null}}async function ro(e=!1){let t=Date.now();if(!e&&qn&&t-lo<T0)return!0;if(!e&&!qn&&t-lr<L0)return!1;let n=typeof aa=="string"&&aa.startsWith("/api/"),s=location.protocol==="file:"||location.hostname==="127.0.0.1"||location.hostname==="localhost";if(!(n&&s))try{let a=new AbortController,o=setTimeout(()=>a.abort(),Hu),i=await fetch(aa,{signal:a.signal,headers:{Accept:"application/json"}});if(clearTimeout(o),!i.ok)throw new Error(`HTTP ${i.status}`);let r=await i.json();return Uu(r,"proxy"),!0}catch(a){console.warn("[registry] tier 1 (proxy) failed:",a.message)}try{let a=new AbortController,o=setTimeout(()=>a.abort(),Hu),i=await fetch(rr,{signal:a.signal});if(clearTimeout(o),!i.ok)throw new Error(`HTTP ${i.status}`);let r=await i.text(),l=JSON.parse(r);return Uu(l,"xrpscan"),!0}catch(a){console.warn("[registry] tier 2 (xrpscan direct) failed:",a.message),(a.message.includes("Failed to fetch")||a.message.includes("CORS"))&&console.warn("[registry] CORS blocked \u2014 mount the backend proxy route (see validatorregistry.js)")}return console.warn("[registry] all sources failed \u2014 showing",Object.keys(fr).length,"hardcoded validators"),lr=Date.now(),qn||am(),gr({ok:!1,source:"fallback",error:"all sources failed \u2014 mount /api/v1 router"}),!1}window.debugRegistry=async function(){console.group("\u{1F50D} Registry debug"),console.log("Current source:",xn),console.log("Validators loaded:",xe.size),console.log("Registry ok:",qn),console.log("Last fetch:",lo?new Date(lo).toLocaleTimeString():"never"),console.log(""),console.log("Testing proxy \u2192",aa);try{let e=await fetch(aa),t=await e.text();console.log("  Status:",e.status,"\u2014 body preview:",t.slice(0,300))}catch(e){console.warn("  Failed:",e.message)}console.log(""),console.log("Testing XRPScan direct \u2192",rr);try{let e=await fetch(rr),t=await e.text();console.log("  Status:",e.status,"\u2014 body preview:",t.slice(0,300))}catch(e){console.warn("  Failed:",e.message)}return console.groupEnd(),{source:xn,size:xe.size,ok:qn}};function it(e){return xe.get(e)??{key:e,label:`${e.slice(0,10)}\u2026${e.slice(-6)}`,domain:null,provider:null,lists:[],category:"other",geo:po[e]??null,meta:{}}}function kn(e){var n;if(!e)return null;if(((n=e.geo)==null?void 0:n.lat)!=null)return e.geo;let t=po[e.key];return t||hr(e.domain)}function om(){return[...xe.values()].filter(e=>(e.category==="unl"||e.category==="both")&&e.chain!=="test").map(e=>e.key)}function A0(){return[...xe.values()].filter(e=>(e.category==="dunl"||e.category==="both")&&e.chain!=="test").map(e=>e.key)}function E0(){return[...xe.values()].filter(e=>e.category==="other"&&e.chain!=="test").map(e=>e.key)}function N0(){return[...xe.values()].filter(e=>e.chain==="test").map(e=>e.key)}function gr({ok:e,count:t,lists:n,source:s,error:a}){let o=w("m1-registry-badge");if(o)if(e){let i=[...xe.values()].filter(c=>c.category==="unl").length,r=[...xe.values()].filter(c=>c.chain==="test").length,l=t-r;o.textContent=`${l} mainnet \xB7 ${i} UNL \xB7 ${r} testnet \xB7 live`,o.className="registry-badge registry-badge--ok"}else o.textContent=s==="fallback"?`Fallback data \xB7 ${xe.size} known \xB7 ${a??"endpoint unreachable"}`:"Refreshing\u2026",o.className="registry-badge registry-badge--warn"}var co=null,ju=!1,sr=!1,qu=0,Vu=0,Gu=0,ar=0,im=!0,nt=null,jn=null,ra=null,Ht=null,ze={},oo=null,cr={},tt=null,en=[],io=null,dr={},na="unl",mt={fees:[],burnDrops:[],dexOffers:[],ammSwaps:[],newAccounts:[],converge:[],proposers:[],peerCounts:[],peerDiscon:[]};function rm(){var t,n;if(ju)return;ju=!0,ow(),am(),ro(!0),nw(),sw(),window.addEventListener("xrpl-connected",()=>{sa(),$s()&&(oa({force:!0}),ia({force:!1}))}),window.addEventListener("xrpl-disconnected",()=>{pr(),mr(null)}),window.addEventListener("xrpl-connection",s=>{var a;((a=s==null?void 0:s.detail)==null?void 0:a.state)==="connecting"&&(pr(),mr(null,"Switching networks\u2026"))}),window.addEventListener("xrpl-ledger",s=>{Z0(s.detail),$s()&&ew(s.detail)}),(t=w("btn-network-refresh"))==null||t.addEventListener("click",()=>{oa({force:!0}),ro(!0),ia({force:!0})}),(n=document.querySelector('.dash-tab[data-tab="network"]'))==null||n.addEventListener("click",()=>{sa(),oa({force:!0}),ro(!1),ia({force:!1})});let e=w("tab-network");e&&new MutationObserver(sa).observe(e,{attributes:!0,attributeFilter:["style","class"]}),document.addEventListener("visibilitychange",sa)}function $s(){let e=w("tab-network"),t=e?e.style.display!=="none":!1;return im&&X.currentPage==="dashboard"&&X.currentTab==="network"&&t&&!document.hidden}function sa(){$s()?R0():pr()}function lm(e){im=!!e,sa()}function R0(){co||(oa({force:!1}),co=setInterval(()=>{$s()&&oa({force:!1})},v0))}function pr(){clearInterval(co),co=null}async function oa({force:e=!1}={}){var n;if(!$s()&&!e)return;let t=Date.now();if(!(!e&&(t-qu<b0||sr||t<Vu))){sr=!0,qu=t,ze={},Ku(!0);try{await Promise.allSettled([ro(!1),_0(),D0(),I0(),F0(),O0()]),B0(),W0(),U0(),j0(),Y0(),mr({info:nt,fee:jn,vals:ra}),iw()}catch(s){String((s==null?void 0:s.message)??"").toLowerCase().includes("too much load")&&(Vu=Date.now()+y0,(n=he)==null||n("Rate-limited \u2014 backing off 2 min."))}finally{Ku(!1),sr=!1}}}function Ku(e){var t;(t=w("btn-network-refresh"))==null||t.classList.toggle("spinning",e)}async function _0(){var n,s,a;let e=await Ee({command:"server_info"});if(nt=((n=e==null?void 0:e.result)==null?void 0:n.info)??null,!nt)return;ot("converge",Number(((s=nt.last_close)==null?void 0:s.converge_time_s)??0)),ot("proposers",Number(((a=nt.last_close)==null?void 0:a.proposers)??0)),ot("peerCounts",Number(nt.peers??0));let t=Number(nt.peer_disconnects_resources??0);oo!==null&&t>oo&&ot("peerDiscon",t-oo),oo=t}async function D0(){var t;let e=await Ee({command:"fee"});jn=(e==null?void 0:e.result)??null,((t=jn==null?void 0:jn.drops)==null?void 0:t.open_ledger_fee)!=null&&ot("fees",Number(jn.drops.open_ledger_fee))}async function I0(){try{let e=await Ee({command:"validators"});ra=(e==null?void 0:e.result)??null}catch{ra=null}}async function F0(){var e;try{let t=await Ee({command:"peers"});Ht=Array.isArray((e=t==null?void 0:t.result)==null?void 0:e.peers)?t.result.peers:null}catch{Ht=null}}async function O0(){var e;try{let t=await Ee({command:"feature"});(e=t==null?void 0:t.result)!=null&&e.features&&(q0(t.result.features),dm(t.result.features))}catch{}}function B0(){var C,P,R,O,D,I;let e=nt,t=ra,n=(t==null?void 0:t.trusted_validator_keys)??[],s=om(),a=A0(),o=n.length?n:s,i=a,r=Number((t==null?void 0:t.validation_quorum)??(e==null?void 0:e.validation_quorum)??0),l=o.length,c=l-r,p=l>0?r/l*100:0,u=o.filter(F=>xe.has(F)).length,d=l>0?Math.round(u/l*100):0,m=Number(((C=e==null?void 0:e.last_close)==null?void 0:C.converge_time_s)??0),f=Number(((P=e==null?void 0:e.last_close)==null?void 0:P.proposers)??0),g=r>0?Math.round(f/r*100):0,b=Array.isArray(e==null?void 0:e.negative_unl)?e.negative_unl:[],h=!!ra;c>=0&&c<=3&&(ze.quorumTight=!0),b.length>0&&(ze.nUnlActive=!0),m>6&&(ze.slowConverge=!0),f>0&&r>0&&f<r&&(ze.lowProposers=!0),K("m1-active",h?l:"\u2014"),K("m1-quorum",r>0?r:"\u2014"),K("m1-margin",h?c>=0?c:`\u2212${Math.abs(c)}`:"\u2014"),K("m1-overlap",h?`${d}%`:"\u2014"),K("m1-known",h?`${u} / ${l} identified`:"\u2014 (validators cmd unavailable)"),K("m1-proposers",((R=e==null?void 0:e.last_close)==null?void 0:R.proposers)!=null?f:"\u2014"),K("m1-particip",r>0&&((O=e==null?void 0:e.last_close)==null?void 0:O.proposers)!=null?`${g}%`:"\u2014"),K("m1-converge",((D=e==null?void 0:e.last_close)==null?void 0:D.converge_time_s)!=null?`${m.toFixed(2)}s`:"\u2014"),K("m1-converge-avg",la("converge")>0?`avg ${la("converge").toFixed(2)}s`:"\u2014"),Tt("m1-qbar",p,p>90?"bar-danger":p>80?"bar-warn":"bar-ok"),Tt("m1-obar",d,d<40?"bar-danger":d<70?"bar-warn":"bar-ok"),Tt("m1-pbar",g,g<80?"bar-danger":g<95?"bar-warn":"bar-ok"),Tt("m1-cvgbar",Math.min(100,m/10*100),m>6?"bar-danger":m>4?"bar-warn":"bar-ok"),z0({active:l,quorum:r,margin:c,nUnl:b,valsAvail:h});let v=(I=t==null?void 0:t.publisher_lists)==null?void 0:I[0],x=(wn==null?void 0:wn.ripple)??(wn==null?void 0:wn.xrplf)??null,k=(v==null?void 0:v.uri)??(x==null?void 0:x.uri)??"\u2014",T=(v==null?void 0:v.seq)??(x==null?void 0:x.seq)??"\u2014";if(K("m1-vl-uri",k),K("m1-vl-seq",T),v!=null&&v.expiration||x!=null&&x.expiration){let F=w("m1-vl-expiry");if(F){let H=(v==null?void 0:v.expiration)??(x==null?void 0:x.expiration),N=Math.floor((new Date(H)-Date.now())/864e5);F.textContent=N>0?`Expires ${N}d`:"\u26A0 EXPIRED",F.className=`expiry-pill ${N>30?"pill-ok":N>7?"pill-warn":"pill-bad"}`,F.style.display=""}}let S=w("m1-nunl-list");if(K("m1-nunl-count",b.length||"0"),S)if(!b.length)S.innerHTML='<div class="nunl-empty">\u2713 No validators on Negative UNL</div>';else{let F={};S.innerHTML=b.map(N=>{let W=it(N);return W.provider&&(F[W.provider]=(F[W.provider]||0)+1),`<div class="nunl-entry">
        ...
        </div>`}).join("");let H=Object.entries(F).sort((N,W)=>W[1]-N[1])[0];(H==null?void 0:H[1])>1&&(S.innerHTML+=`<div class="nunl-alert">\u26A0 ${H[1]} offline validators share <b>${y(H[0])}</b> \u2014 likely provider outage</div>`)}cm(o,i,r,b,h);let $=Number((nt==null?void 0:nt.peers)??0);K("wm-stat-val",h?`${l} validators`:`${xe.size} in registry`),K("wm-stat-nunl",`${b.length} on nUNL`),K("wm-stat-peers",`${Ht?Ht.length:$} peers`);let E=[...xe.keys()];G0(o,i,b,Ht,!h)}function cm(e,t,n,s,a){let o=w("m1-val-grid");if(!o)return;let i=new Set(e),r=new Set(t),l=new Set(s),c=om(),p=N0(),u=E0(),d=e.length?e:c,m=[...xe.keys()],f=m.filter(D=>{var I;return(((I=xe.get(D))==null?void 0:I.chain)??"main")==="main"}),g=p,b=u,h=d.filter(D=>!!it(D).domain),v=d.filter(D=>!it(D).domain),x=b.filter(D=>!!it(D).domain),k=b.filter(D=>!it(D).domain),T=m.filter(D=>!!kn(it(D))),S=[{id:"unl",label:"UNL",count:d.length,dot:"unl"},{id:"others",label:"Others",count:b.length,dot:"other"},{id:"all",label:"All",count:f.length,dot:null},{id:"test",label:"Testnet",count:g.length,dot:null}],$={unl:"#00fff0",dunl:"#bd93f9",both:"#50fa7b",nunl:"#ff5555",other:"#ffb86c"},E='<div class="vg-tabs" role="tablist">'+S.map(D=>`<button class="vg-tab ${na===D.id?"vg-tab--active":""}" data-vgtab="${D.id}">
        ${D.dot?`<span class="vg-tab-dot" style="background:${$[D.dot]}"></span>`:""}
        ${y(D.label)}
        <span class="vg-tab-count">${D.count}</span>
      </button>`).join("")+"</div>",C=[],P="";if(na==="unl"){let D=d.filter(N=>l.has(N)),I=h.filter(N=>!l.has(N)),F=v.filter(N=>!l.has(N));D.length&&C.push({title:`\u26A0 Negative UNL (${D.length})`,keys:D,cls:"vgs-warn"}),C.push({title:`Named UNL validators \xB7 ${I.length}`,keys:I}),F.length&&C.push({title:`Key-only UNL validators \xB7 ${F.length}`,keys:F,collapsed:!0}),d.length||C.push({title:"No UNL data",keys:[],notice:"Registry not loaded yet"});let H=a?"live rippled":`registry (${xn})`;P=`${d.length} trusted \xB7 quorum ${n} \xB7 ${s.length} on nUNL \xB7 source: ${H}`}else if(na==="others")C.push({title:`Named mainnet (non-UNL) \xB7 ${x.length}`,keys:x}),k.length&&C.push({title:`Key-only mainnet \xB7 ${k.length}`,keys:k,collapsed:!0}),P=`${b.length} mainnet validators not on UNL \xB7 source: ${xn}`;else if(na==="test"){let D=g.filter(F=>!!it(F).domain),I=g.filter(F=>!it(F).domain);D.length&&C.push({title:`Named testnet \xB7 ${D.length}`,keys:D}),I.length&&C.push({title:`Key-only testnet \xB7 ${I.length}`,keys:I,collapsed:!0}),P=`${g.length} testnet validators`}else C.push({title:`\u2B50 UNL \xB7 ${d.length}`,keys:d}),C.push({title:`Other mainnet \xB7 ${b.length}`,keys:b,collapsed:!0}),g.length&&C.push({title:`Testnet \xB7 ${g.length}`,keys:g,collapsed:!0}),P=`${f.length} mainnet \xB7 ${g.length} testnet \xB7 ${T.length} geo-located \xB7 source: ${xn}`;function R(D,I){var ke;let F=it(D),H=l.has(D),N=i.has(D),W=r.has(D),se=F.chain==="test",re,pe,ae;H?(re="vp-nunl",pe="nUNL",ae=$.nunl):N&&W?(re="vp-both",pe="UNL+dUNL",ae=$.both):N?(re="vp-unl",pe="UNL",ae=$.unl):W?(re="vp-dunl",pe="dUNL",ae=$.dunl):(re="vp-other",pe="Other",ae=$.other);let te=kn(F),de=!!te,le=te?`\u{1F4CD} ${te.city??""}`:"",Pe=F.domain?F.domain.replace(/^www\./,"").replace(/^validator\./,"").replace(/^xrp\./,""):null,B=`${D.slice(0,8)}\u2026${D.slice(-6)}`,q=N&&I!=null?`<span class="vg-num">${I+1}</span>`:"",J=(ke=F.agreement)==null?void 0:ke["24h"],ue=J!=null&&J.score?`<span class="vg-agr" style="color:${parseFloat(J.score)>=99?"#50fa7b":parseFloat(J.score)>=95?"#ffb86c":"#ff5555"}" title="24h agreement">${J.score}</span>`:"";return`<div class="vpill ${re} ${de?"vp-locatable":""}"
      ...
      </div>`}),O||(O='<div class="nunl-empty">No validators in this view.</div>'),o.innerHTML=E+O,K("m1-val-summary",P),o.querySelectorAll(".vg-tab").forEach(D=>{D.addEventListener("click",I=>{I.stopPropagation();let F=D.getAttribute("data-vgtab");F&&(na=F,cm(e,t,n,s,a))})})}async function X0(e){let t=or.get(e);if(t&&Date.now()-t.cachedAt<em)return t.data;try{let n=new AbortController,s=setTimeout(()=>n.abort(),tm),a=await fetch(`${Zu}/${encodeURIComponent(e)}`,{signal:n.signal});if(clearTimeout(s),!a.ok)throw new Error(`HTTP ${a.status}`);let o=await a.json();return or.set(e,{data:o,cachedAt:Date.now()}),o}catch{return null}}async function H0(e){let t=ir.get(e);if(t&&Date.now()-t.cachedAt<em)return t.data;try{let n=new AbortController,s=setTimeout(()=>n.abort(),tm),a=await fetch(`${Zu}/${encodeURIComponent(e)}/reports`,{signal:n.signal});if(clearTimeout(s),!a.ok)throw new Error(`HTTP ${a.status}`);let o=await a.json(),i=o.reports??o??[];return ir.set(e,{data:i,cachedAt:Date.now()}),i}catch{return[]}}window.focusValidator=async function(e){let t=it(e),n=kn(t);document.querySelectorAll(".vpill").forEach(o=>o.classList.remove("vp-active"));let s=document.querySelector(`.vpill[data-key="${CSS.escape(e)}"]`);if(s&&(s.classList.add("vp-active"),s.scrollIntoView({behavior:"smooth",block:"nearest"})),ur(e,t,null),X0(e).then(o=>{o&&ur(e,t,o)}),!n){let o=w("world-map-container");if(o){let i=o.querySelector(".wm-no-geo");i&&i.remove();let r=document.createElement("div");r.className="wm-no-geo",r.textContent=`\u{1F4CD} ${t.label} \u2014 geographic location unknown`,o.appendChild(r),setTimeout(()=>r.remove(),3500)}return}let a=w("world-map-container");a&&a.scrollIntoView({behavior:"smooth",block:"nearest"}),tt&&(tt.flyTo([n.lat,n.lng],6,{duration:1.2}),setTimeout(()=>{let o=dr[e];o&&o.openPopup()},1300))};function ur(e,t,n){var C,P,R,O,D;let s=w("amend-modal-overlay"),a=w("amend-modal-body");if(!s||!a)return;let o=n??{},i=t.label??o.label??o.account_name??e.slice(0,16)+"\u2026",r=t.domain??o.domain??null,l=t.chain??o.chain??"main",c=t.category??"other",p=Oe[c]??Oe.other,u=kn(t),d=t.unl||c==="unl"||c==="both",m=t.dunl||c==="dunl"||c==="both",f=t.domainVerified||o.domain_verified?"\u2713 Verified":r?"Unverified":"\u2014",g=t.agreement??o.agreement??{},b=!n&&!((C=t.agreement)!=null&&C["24h"]);function h(I,F){if(!F||!F.total)return`<div class="adm-mi"><span class="adm-mk">${I}</span><span class="adm-mv" style="opacity:.5">\u2014</span></div>`;let H=parseFloat(F.score)||0,N=H>=99?"color:#50fa7b":H>=95?"color:#ffb86c":"color:#ff5555";return`<div class="adm-mi">
    ...
    </div>`}function v(I,F,H=!1){return!F&&F!==0?"":`<div class="adm-mi"><span class="adm-mk">${I}</span><span class="adm-mv ${H?"mono":""}">${y(String(F))}</span></div>`}let x=ir.get(e),k=((P=x==null?void 0:x.data)==null?void 0:P.slice(-14))??[],T=k.length?`<div class="adm-section">
    ...
    </div>`,s.style.display="flex",s.addEventListener("click",I=>{I.target===s&&window.closeAmendModal()},{once:!0})}window._loadValidatorReports=async function(e){var n;let t=it(e);await H0(e),ur(e,t,((n=or.get(e))==null?void 0:n.data)??null)};function z0({active:e,quorum:t,margin:n,nUnl:s,valsAvail:a}){let o=w("m1-quorum-ring");if(!o)return;if(!a||!t||!e){o.innerHTML='<div style="opacity:.4;font-size:12px;text-align:center;padding:16px">Connect to view quorum</div>';return}let i=44,r=2*Math.PI*i,l=new Set(s),c=e-s.length,p=s.length,u=Math.max(0,e-t),d=t,m=n<=0?"#ff5555":n<=3?"#ffb86c":"#50fa7b",f=e>0?c/e:0,g=e>0?p/e:0,b=e>0?t/e:0,h=e>0?Math.max(0,n)/e:0,v=e>0?p/e:0;function x(k,T,S,$=8){if(T<=0)return"";let E=k*r,C=T*r;return`<circle r="${i}" cx="50" cy="50" fill="none"
    ...
    <div class="qr-wrap">
      ...
      <div class="qr-legend">
    ...
    </div>`}function W0(){var F,H,N;let e=nt,t=(e==null?void 0:e.server_state)??"unknown",n=(e==null?void 0:e.build_version)??"\u2014",s=Number((e==null?void 0:e.uptime)??0),a=e==null?void 0:e.network_id,o=Number((e==null?void 0:e.io_latency_ms)??0),i=String((e==null?void 0:e.jq_trans_overflow)??"0"),r=Number((e==null?void 0:e.peer_disconnects_resources)??0),l=Number((e==null?void 0:e.load_factor)??1),c=Number((e==null?void 0:e.load_factor_net)??1),p=Number((e==null?void 0:e.load_factor_server)??(e==null?void 0:e.load_factor_local)??1),u=Number(((F=e==null?void 0:e.validated_ledger)==null?void 0:F.age)??0),d=(H=e==null?void 0:e.validated_ledger)==null?void 0:H.seq,m=(e==null?void 0:e.complete_ledgers)??"",f=(e==null?void 0:e.state_accounting)??null;u>10&&(ze.staleLedger=!0),o>5&&(ze.ioStressed=!0),la("peerDiscon")>5&&(ze.peerChurn=!0);let g=w("m2-state");if(g){g.textContent=t;let W=["full","proposing","validating"].includes(t),se=["syncing","tracking","connected"].includes(t);g.className=`state-pill state-${W?"ok":se?"warn":"bad"}`}K("m2-version",n),K("m2-uptime",lw(s)),K("m2-netid",a===0?"0 (Mainnet)":a===1?"1 (Testnet)":a??"\u2014"),K("m2-ledger-seq",d!=null?Number(d).toLocaleString():"\u2014"),K("m2-ledger-age",u>0?`${u}s`:"< 1s"),K("m2-io-ms",o>0?`${o}ms`:"< 1ms"),K("m2-jq",i==="0"?"0 (clean)":`\u26A0 ${i}`),K("m2-discon",r.toLocaleString());let b=w("m2-ledger-age");b&&(b.className=`kv-v ${u>10?"text-danger":u>5?"text-warn":""}`);let h=Math.min(100,(l-1)/49*100);Tt("m2-load-bar",h,l>5?"bar-danger":l>2?"bar-warn":"bar-ok"),K("m2-load-total",`${l.toFixed(2)}\xD7`),K("m2-load-net",`${c.toFixed(2)}\xD7`),K("m2-load-local",`${p.toFixed(2)}\xD7`);let v=p>c*1.5?"Local node stressed":c>p*1.5?"Network-wide stress":l>1.2?"Distributed":"Normal";K("m2-load-src",v);let x=X.tpsHistory.length?X.tpsHistory[X.tpsHistory.length-1]:null;K("m2-tps",x!=null?x.toFixed(1):"\u2014"),K("m2-txcount",((N=X.ledgerLog[0])==null?void 0:N.txCount)??"\u2014");let k=m==="entire ledger"||m.startsWith("32570"),T=k?100:rw(m);if(K("m2-ledger-range",m||"\u2014"),K("m2-hist-type",k?"Full History Node":"Pruned / Partial"),K("m2-hist-score",`${T}%`),Tt("m2-hist-bar",T,T<30?"bar-danger":T<70?"bar-warn":"bar-ok"),f){let W=w("m2-state-acct");if(W){let se=["full","syncing","tracking","connected","disconnected"],re=0,pe={};se.forEach(ae=>{var te;pe[ae]=Number(((te=f[ae])==null?void 0:te.duration_us)??0),re+=pe[ae]}),W.innerHTML=re>0?se.map(ae=>{let te=Math.round(pe[ae]/re*100);return te?`<div class="sa-row"><span class="sa-lbl">${ae}</span>
          <div class="bar-track sa-bar"><div class="bar-fill ${ae==="full"?"bar-ok":ae==="syncing"?"bar-warn":"bar-danger"}" style="width:${te}%"></div></div>
          <span class="sa-pct">${te}%</span></div>`:""}).join(""):'<span class="dim">No data</span>'}}let S=(e==null?void 0:e.peers)!=null?Number(e.peers):null,$=S!=null,E=0,C=0,P=!1;Ht&&(Ht.forEach(W=>{W.inbound===!0?E++:C++}),P=!0);let R=P&&E+C>0?Math.round(E/(E+C)*100):0,O=P?Ht.length:S??0,D=O<6?"HIGH":O<15?"MEDIUM":"LOW";O<6&&(ze.eclipseRisk=!0),R>80&&(ze.peerSaturate=!0),K("m2-peers",$?O:"\u2014"),K("m2-inbound",P?E:$?"\u2014 (cmd restricted)":"\u2014"),K("m2-outbound",P?C:$?"\u2014 (cmd restricted)":"\u2014"),K("m2-ib-pct",P?`${R}%`:"\u2014"),Tt("m2-peer-bar",Math.min(100,O/21*100),O>18?"bar-danger":O>15?"bar-warn":"bar-ok"),Tt("m2-ib-bar",R,R>80?"bar-danger":R>60?"bar-warn":"bar-ok");let I=w("m2-eclipse");I&&(I.textContent=D,I.className=`risk-badge risk-${D.toLowerCase()}`)}function U0(){var C,P,R,O;let e=jn,t=Number(((C=e==null?void 0:e.drops)==null?void 0:C.minimum_fee)??10),n=Number(((P=e==null?void 0:e.drops)==null?void 0:P.open_ledger_fee)??10),s=Number(((R=e==null?void 0:e.drops)==null?void 0:R.median_fee)??10),a=Number(((O=e==null?void 0:e.drops)==null?void 0:O.base_fee)??10),o=Number((e==null?void 0:e.current_ledger_size)??0),i=Number((e==null?void 0:e.expected_ledger_size)??1),r=Number((e==null?void 0:e.current_queue_size)??0),l=Number((e==null?void 0:e.max_queue_size)??1),c=l>0?Math.round(r/l*100):0,p=i>0?o/i:1,u=la("fees"),d=u>0?Math.round((n-u)/u*100):0,m=Math.min(100,Math.round(Math.log2(Math.max(1,n/10))*14));n>t*10&&(ze.feeSpike=!0),c>80&&(ze.queuePressure=!0),p>2&&(ze.spamLedger=!0);let f=mt.burnDrops.slice(-10),g=f.length?f.reduce((D,I)=>D+I,0)/f.length:0,b=aw(mt.burnDrops),h=la("burnDrops"),v=b>0&&mt.burnDrops.length>5?((g-h)/b).toFixed(2):"0.00",x=Math.min(100,Math.abs(Number(v))*20);Math.abs(Number(v))>3&&(ze.burnAnomaly=!0);let k=n>5e3?"Severe":n>500?"High":n>100?"Elevated":n>20?"Normal":"Minimal",S={Severe:"#ff5555",High:"#ff9955",Elevated:"#ffb86c",Normal:"#50fa7b",Minimal:"#6272a4"}[k]??"#50fa7b",$=w("m3-pressure");$&&($.textContent=k,$.className=`pressure-badge p-${k.toLowerCase()}`),K("m3-open",`${n} drops`),K("m3-med",`${s} drops`),K("m3-base",`${a} drops`),K("m3-devpct",`${d>0?"+":""}${d}% vs baseline`),K("m3-spam",`${m} / 100`),K("m3-qsize",`${r} / ${l}`),K("m3-qpct",`${c}%`),K("m3-szratio",`${p.toFixed(2)}\xD7`),K("m3-curledger",`${o} txs`),K("m3-expledger",`${i} expected`),K("m3-burn",g>0?`${(g/1e6).toFixed(4)} XRP / ledger`:"\u2014"),K("m3-burnz",`z = ${v}`),Tt("m3-spam-bar",m,m>70?"bar-danger":m>40?"bar-warn":"bar-ok"),Tt("m3-q-bar",c,c>80?"bar-danger":c>50?"bar-warn":"bar-ok"),Tt("m3-sz-bar",Math.min(100,p*50),p>2?"bar-danger":p>1.5?"bar-warn":"bar-ok"),Tt("m3-burn-bar",x,x>60?"bar-danger":x>30?"bar-warn":"bar-ok");let E=w("m3-congestion-summary");if(E){let D=[];p>2&&D.push({icon:"\u{1F6A8}",txt:`Ledger ${p.toFixed(1)}\xD7 normal size \u2014 possible spam burst`,col:"#ff5555"}),c>80&&D.push({icon:"\u26A0",txt:`TX queue ${c}% full \u2014 fee surge imminent`,col:"#ffb86c"}),m>70&&D.push({icon:"\u26A0",txt:`Spam index ${m}/100 \u2014 elevated DDoS risk`,col:"#ffb86c"}),Math.abs(Number(v))>3&&D.push({icon:"\u{1F4C9}",txt:`Burn rate z=${v} \u2014 resource exhaustion pattern`,col:"#ff9955"}),d>200&&D.push({icon:"\u{1F4B8}",txt:`Open fee ${d}% above baseline \u2014 network stress`,col:"#ffb86c"}),E.innerHTML=D.length?D.map(I=>`<div class="cong-line"><span>${I.icon}</span><span style="color:${I.col}">${y(I.txt)}</span></div>`).join(""):'<div class="cong-clear"><span style="color:#50fa7b">\u2713</span> No congestion signals \u2014 network traffic is normal</div>'}}function j0(){var u,d;let e={},t=0;for(let m of xe.values()){if(m.chain==="test")continue;let f=m.version??"unknown";e[f]=(e[f]??0)+1,t++}let n={},s=0;if(Array.isArray(Ht))for(let m of Ht){let f=(m.version??"unknown").replace(/rippled-/i,"").split(" ")[0];n[f]=(n[f]??0)+1,s++}let a=w("m4-version-dist");if(a&&t>0){let m=Object.entries(e).sort((h,v)=>v[1]-h[1]),f=((u=m[0])==null?void 0:u[0])??"?",g=t>0?Math.round((((d=m[0])==null?void 0:d[1])??0)/t*100):0,b=["#00fff0","#50fa7b","#ffb86c","#bd93f9","#ff5555","#8be9fd"];a.innerHTML=m.slice(0,6).map(([h,v],x)=>{let k=Math.round(v/t*100),T=b[x%b.length],S=h.includes("beta")||h.includes("rc")||h.includes("RC");return`<div class="vd-row">
        ...
        </div>`}).join("")}}}var xs="pending";function dm(e){let t=w("amendment-list");if(!t)return;let n=w("amend-pipeline-header"),s=Object.entries(e).map(([p,u])=>({hash:p,...u})),a=s.filter(p=>p.enabled),o=s.filter(p=>!p.enabled&&!p.vetoed).sort((p,u)=>(u.count??0)-(p.count??0)),i=s.filter(p=>p.vetoed),r=o.filter(p=>p.majority),l=o.filter(p=>!p.majority&&(p.count??0)>=(p.threshold??28)*.8);if(o.some(p=>(p.count??0)<(p.threshold??28)*.5)&&(ze.amendVeto=!0),n){let p=[{id:"pending",label:"Voting",count:o.length,color:"#8be9fd"},{id:"active",label:"Active",count:a.length,color:"#50fa7b"},{id:"vetoed",label:"Vetoed",count:i.length,color:"#ff5555"},{id:"all",label:"All",count:s.length,color:null}];n.innerHTML=`
      <div class="ap-tabs">
        ${p.map(u=>`
      ...
      ${l.length?`<div class="ap-near-bar">\u{1F4C8} ${l.length} amendment${l.length>1?"s":""} approaching 80% threshold</div>`:""}`,n.querySelectorAll(".ap-tab").forEach(u=>{u.onclick=()=>{xs=u.dataset.aptab,dm(e)}})}let c=xs==="active"?a:xs==="vetoed"?i:xs==="all"?s.sort((p,u)=>p.enabled!==u.enabled?p.enabled?1:-1:p.vetoed!==u.vetoed?p.vetoed?1:-1:(u.count??0)-(p.count??0)):o;if(!c.length){t.innerHTML=`<div class="amend-empty">${xs==="vetoed"?"No vetoed amendments":"No data"}</div>`;return}t.innerHTML=c.map(p=>{var $;let u=p.count??0,d=p.threshold??28,m=Math.min(100,Math.round(u/d*100)),f=p.name??`${p.hash.slice(0,10)}...`,g=!!p.enabled,b=!!p.vetoed,h=!!p.majority,v=nm[f]??{},x=($=mt.amendMomentum)==null?void 0:$[p.hash],k="";if(h&&!g&&p.majority){let E=Date.now()-new Date(p.majority).getTime(),C=E>0?Math.floor(E/864e5):0,P=Math.max(0,14-C),R=Math.min(100,Math.round(C/14*100));k=`<div class="ap-countdown">
    ...
    </div>`}).join("")}function q0(e){cr={},Object.entries(e).forEach(([t,n])=>{cr[t]={hash:t,...n}})}window.showAmendDetail=function(e){let t=cr[e];if(!t)return;let n=t.name||`${e.slice(0,16)}...`,s=nm[n]||{},a=t.count??0,o=t.threshold??28,i=Math.min(100,Math.round(a/o*100)),r=t.enabled?"Active on Ledger":t.vetoed?"Vetoed":t.majority?"Majority Reached":"Voting in Progress",l=t.enabled?"adm-s-ok":t.vetoed?"adm-s-bad":t.majority?"adm-s-warn":"adm-s-info",c=t.enabled?"bar-ok":t.vetoed?"bar-danger":t.majority?"bar-warn":"bar-info",p=t.majority&&!t.enabled?`
    ...
    <div class="adm-footer">
      ...
      <a class="adm-link" href="https://xrpl.org/consensus.html" target="_blank" rel="noopener noreferrer">Consensus Docs</a>
    </div>`,u.style.display="flex",u.addEventListener("click",m=>{m.target===u&&window.closeAmendModal()},{once:!0}))};window.closeAmendModal=function(){let e=w("amend-modal-overlay");e&&(e.style.display="none")};function V0(e){if(window.L){e();return}if(!document.querySelector("#leaflet-css")){let n=document.createElement("link");n.id="leaflet-css",n.rel="stylesheet",n.href="https://cdnjs.cloudflare.com/ajax/libs/leaflet/1.9.4/leaflet.min.css",document.head.appendChild(n)}let t=document.createElement("script");t.src="https://cdnjs.cloudflare.com/ajax/libs/leaflet/1.9.4/leaflet.min.js",t.onload=e,document.head.appendChild(t)}function G0(e,t,n,s,a=!1){w("world-map-container")&&V0(()=>K0(e,t,n,s,a))}function K0(e,t,n,s,a=!1){let o=w("world-map-container");if(!o)return;let i=new Set(n||[]),r=new Set(e||[]),l=new Set(t||[]),c=X.currentNetwork||"xrpl-mainnet";if(tt&&io!==c&&(tt.remove(),tt=null,en=[],io=null),!tt){o.innerHTML="";let k=document.createElement("div");k.id="wm-leaflet",k.style.cssText="width:100%;height:440px;",o.appendChild(k),tt=L.map("wm-leaflet",{center:[25,5],zoom:2,minZoom:1,maxZoom:12,zoomControl:!0,attributionControl:!0,worldCopyJump:!0}),L.tileLayer("https://{s}.basemaps.cartocdn.com/dark_all/{z}/{x}/{y}{r}.png",{attribution:'&copy; <a href="https://carto.com">CARTO</a> &copy; <a href="https://openstreetmap.org">OSM</a>',subdomains:"abcd",maxZoom:19}).addTo(tt),io=c}en.forEach(k=>{try{k.remove()}catch{}}),en=[];function p(k){return i.has(k)?"nunl":r.has(k)&&l.has(k)?"both":r.has(k)?"unl":l.has(k)?"dunl":"other"}dr={};let u={};for(let[k,T]of xe){let S=kn(T);if(!(S!=null&&S.lat)||!(S!=null&&S.lng))continue;let $=`${(Math.round(S.lat*2)/2).toFixed(1)},${(Math.round(S.lng*2)/2).toFixed(1)}`;u[$]||(u[$]={lat:S.lat,lng:S.lng,keys:[],city:S.city,org:S.org}),u[$].keys.push(k)}if(Object.values(u).forEach(k=>{let T=k.keys.length,S=k.keys.map(p),$=["nunl","both","unl","dunl","other"].find(O=>S.includes(O))||"other",E=Oe[$],C=T>5?13:T>2?10:7,P=L.divIcon({html:`<div class="wm-lmarker wm-lmarker-val ${$==="nunl"?"wm-lmarker-nunl":""} ${a?"wm-lmarker-ref":""}"
      ...
      </div>`,className:"",iconSize:[(C+8)*2,(C+8)*2],iconAnchor:[C+8,C+8]}),R=L.marker([k.lat,k.lng],{icon:P}).bindPopup(J0(k.keys,k.city,k.org,i,r,l,a),{maxWidth:380,className:"wm-popup-wrap"}).addTo(tt);k.keys.forEach(O=>{dr[O]=R}),en.push(R)}),a){let k=L.control({position:"bottomleft"});k.onAdd=()=>{let T=L.DomUtil.create("div","wm-ref-banner");return T.innerHTML="\u{1F4E1} Reference positions \xB7 live validator list unavailable from endpoint",T},k.addTo(tt),en.push(k)}let d=[...xe.keys()].filter(k=>{var S;return((S=xe.get(k).geo)==null?void 0:S.lat)!=null||po[k]}).length,m=xe.size-d;if(m>0){let k=L.control({position:"bottomright"});k.onAdd=()=>{let T=L.DomUtil.create("div","wm-unknown-ctrl");return T.innerHTML=`+ ${m} validators \xB7 location unknown`,T},k.addTo(tt),en.push(k)}M0.forEach(k=>{let T=L.divIcon({html:`<div class="wm-lmarker wm-lmarker-pub">
        <div class="wm-lring"></div>
        ...
        </div>`,{maxWidth:260,className:"wm-popup-wrap"}).addTo(tt);en.push(S)});let f=Array.isArray(s)?s:[],g=f.filter(k=>k.inbound===!0).length,b=f.length-g,h=f.length>0?`${f.length} peers (${g}\u2193 ${b}\u2191)`:`${Number((nt==null?void 0:nt.peers)??0)} peers`,v=L.control({position:"topleft"});v.onAdd=()=>{let k=L.DomUtil.create("div","wm-legend-ctrl");return k.innerHTML=`
      ...
      </div>`,k},v.addTo(tt),en.push(v);let x=en.filter(k=>k&&typeof k.getLatLng=="function");if(x.length>=2)try{let k=L.latLngBounds(x.map(T=>T.getLatLng()));k.isValid()&&tt.fitBounds(k.pad(.15),{maxZoom:6})}catch{}try{window.dispatchEvent(new CustomEvent("nalulf-network-map",{detail:{map:tt,networkId:io}}))}catch{}}function J0(e,t,n,s,a,o,i=!1){let r=e.length>1,l=e.map(p=>{let u=it(p),d=s.has(p),m=a.has(p),f=o.has(p),g=p.slice(0,20)+"...",b,h;return d?(b=Oe.nunl.hex,h="Negative UNL"):m&&f?(b=Oe.both.hex,h="UNL + dUNL"):m?(b=Oe.unl.hex,h="UNL"):f?(b=Oe.dunl.hex,h="dUNL"):(b=Oe.other.hex,h="Other"),`<div class="wm-popup-val-row">
    ...
    </div>`}).join(""),c=[...new Set(e.map(p=>{var d;let u=it(p);return u.provider??((d=kn(u))==null?void 0:d.org)??null}).filter(Boolean))];return`<div class="wm-popup-inner">
    ...
    </div>`}).join("")}function Z0(e){var t,n,s,a,o,i,r,l,c,p;e&&(ot("burnDrops",(e.avgFee||0)*1e6*(e.txPerLedger??0)),ot("dexOffers",((t=e.txTypes)==null?void 0:t.OfferCreate)??0),ot("ammSwaps",(((n=e.txTypes)==null?void 0:n.AMMDeposit)??0)+(((s=e.txTypes)==null?void 0:s.AMMWithdraw)??0)+(((a=e.txTypes)==null?void 0:a.AMMBid)??0)),ot("newAccounts",((o=e.txTypes)==null?void 0:o.AccountSet)??0),ot("txPayment",((i=e.txTypes)==null?void 0:i.Payment)??0),ot("txNFT",(((r=e.txTypes)==null?void 0:r.NFTokenMint)??0)+(((l=e.txTypes)==null?void 0:l.NFTokenBurn)??0)+(((c=e.txTypes)==null?void 0:c.NFTokenCreateOffer)??0)+(((p=e.txTypes)==null?void 0:p.NFTokenAcceptOffer)??0)),ot("txLedger",e.txPerLedger??0),ot("tps",e.tps??(e.txPerLedger??0)/3.5),ot("closeTime",e.closeTime??3.5))}function ew(e){let t=X.tpsHistory.length?X.tpsHistory[X.tpsHistory.length-1]:null;K("m2-tps",t!=null?t.toFixed(1):"\u2014"),K("m2-txcount",e.txPerLedger??"\u2014"),e.successRate!=null&&K("m2-success",`${e.successRate.toFixed(0)}%`)}async function ia({force:e=!1}={}){if(!$s()&&!e)return;let t=Date.now();if(!e&&t-Gu<x0)return;Gu=t;let n=w("latency-list");if(!n)return;let s=Dr[X.currentNetwork]??[],a=++ar;n.innerHTML=s.map((i,r)=>`
  ...
  `,document.body.appendChild(e),e.addEventListener("click",t=>{t.target===e&&ca()}),document.addEventListener("keydown",t=>{t.key==="Escape"&&e.classList.contains("show")&&ca()})}function hw(e){let t=dw[e];if(!t)return;fw();let n=document.getElementById("learnModalOverlay"),s=document.getElementById("learnModalTitle"),a=document.getElementById("learnModalSub"),o=document.getElementById("learnModalBody"),i=document.getElementById("learnModalLinks"),r=document.getElementById("learnModalCtas");!n||!s||!a||!o||!i||!r||(s.textContent=t.title,a.textContent=t.subtitle||"",o.innerHTML=(t.sections||[]).map(l=>`
  ...
  `).join(""),n.classList.add("show"),document.body.classList.add("modal-open"))}function ca(){var e;(e=document.getElementById("learnModalOverlay"))==null||e.classList.remove("show"),document.body.classList.remove("modal-open")}function gw(e){var t,n,s;if(e==="modal:close")return ca();if(e==="auth:signup"){ca(),(t=window.openAuth)==null||t.call(window,"signup");return}if(e==="auth:login"){ca(),(n=window.openAuth)==null||n.call(window,"login");return}if(e.startsWith("topic:"))return hw(e.split(":")[1]);if(e.startsWith("scroll:")){let a=e.split(":")[1];(s=document.getElementById(a))==null||s.scrollIntoView({behavior:"smooth",block:"start"})}}function vw(){pm||(pm=!0,document.addEventListener("click",e=>{var s,a;let t=(a=(s=e.target).closest)==null?void 0:a.call(s,"[data-action]");if(!t)return;let n=t.getAttribute("data-action")||"";n&&(e.preventDefault(),gw(n))}))}function um(){var l,c,p,u,d;vw(),(l=document.querySelector(".landing-features"))==null||l.setAttribute("id","learn"),(c=document.querySelector(".landing-simple-value"))==null||c.setAttribute("id","use-cases"),(p=document.querySelector(".landing-cta"))==null||p.setAttribute("id","about"),(u=document.querySelector(".landing-tagline"))==null||u.classList.add("tagline-pill");let e=document.querySelector(".landing-stats-strip");e&&(e.classList.add("landing-learn-strip"),e.innerHTML=pw.map(m=>`
    ...
    `).join(""));let t=w("features-grid");t&&(t.innerHTML=uw.map(m=>`
    ...
    `).join(""));let n=document.querySelector(".landing-simple-value"),s=n==null?void 0:n.querySelector("h2");s&&(s.textContent="What you can do with NaluLF");let a=w("value-grid");a&&(a.innerHTML=mw.map(m=>`
    ...
    `)}function mm(){let e=new IntersectionObserver(t=>t.forEach(n=>{n.isIntersecting&&n.target.classList.add("visible")}),{threshold:.12});document.querySelectorAll(".reveal").forEach(t=>e.observe(t))}function fm(){let e=document.getElementById("particle-canvas");if(!e)return;let t=e.getContext("2d"),n,s,a=[],o=80,i=120;function r(){n=e.width=window.innerWidth,s=e.height=window.innerHeight}function l(){return{x:Math.random()*n,y:Math.random()*s,vx:(Math.random()-.5)*.4,vy:(Math.random()-.5)*.4,r:Math.random()*1.5+.5,alpha:Math.random()*.5+.1}}function c(){r(),a=Array.from({length:o},l)}function p(){return getComputedStyle(document.body).getPropertyValue("--accent-secondary").trim()||"#ffd700"}function u(){t.clearRect(0,0,n,s);let g=p();for(let b=0;b<a.length;b++)for(let h=b+1;h<a.length;h++){let v=a[b].x-a[h].x,x=a[b].y-a[h].y,k=Math.sqrt(v*v+x*x);k<i&&(t.beginPath(),t.moveTo(a[b].x,a[b].y),t.lineTo(a[h].x,a[h].y),t.strokeStyle=`rgba(255,255,255,${(1-k/i)*.06})`,t.lineWidth=1,t.stroke())}a.forEach(b=>{t.beginPath(),t.arc(b.x,b.y,b.r,0,Math.PI*2),t.fillStyle=`rgba(255,255,255,${b.alpha*.6})`,t.fill()})}function d(){a.forEach(g=>{g.x+=g.vx,g.y+=g.vy,(g.x<0||g.x>n)&&(g.vx*=-1),(g.y<0||g.y>s)&&(g.vy*=-1)})}let m;function f(){d(),u(),m=requestAnimationFrame(f)}c(),f(),document.addEventListener("visibilitychange",()=>{document.hidden?(m&&cancelAnimationFrame(m),m=null):!m&&X.currentPage==="landing"&&f()}),window.addEventListener("naluxrp:pagechange",g=>{var b;((b=g==null?void 0:g.detail)==null?void 0:b.pageId)!=="landing"?(m&&cancelAnimationFrame(m),m=null):m||f()}),window.addEventListener("resize",()=>{r(),a.forEach(g=>{g.x=Math.min(g.x,n),g.y=Math.min(g.y,s)})}),e.style.cssText=`
    position: fixed; inset: 0;
    width: 100%; height: 100%;
    pointer-events: none;
    z-index: 0; opacity: 0.4;
  `}function Ss(e){var t;(t=window.showProfile)==null||t.call(window),setTimeout(()=>e==null?void 0:e(),250)}var vr=[{label:"\u{1F30A} Live Stream",hint:"Dashboard \u2192 Stream tab",action:()=>Ln(document.querySelector('[data-tab="stream"]'),"stream")},{label:"\u{1F50D} Inspector",hint:"Dashboard \u2192 Inspector tab",action:()=>Ln(document.querySelector('[data-tab="inspector"]'),"inspector")},{label:"\u{1F4E1} Network Health",hint:"Dashboard \u2192 Network tab",action:()=>Ln(document.querySelector('[data-tab="network"]'),"network")},{label:"\u{1F464} Profile",hint:"View your profile",action:()=>{var e;return(e=window.showProfile)==null?void 0:e.call(window)}},{label:"\u{1F48E} Wallets",hint:"Profile \u2192 Wallets",action:()=>Ss(()=>{var e;return(e=window.switchProfileTab)==null?void 0:e.call(window,"wallets")})},{label:"\u{1F4CA} Portfolio Analytics",hint:"Profile \u2192 Balance history, heatmap, flow",action:()=>Ss(()=>{var e;return(e=window.switchProfileTab)==null?void 0:e.call(window,"analytics")})},{label:"\u{1F517} Social Links",hint:"Profile \u2192 Connect Discord, X, GitHub\u2026",action:()=>Ss(()=>{var e;return(e=window.switchProfileTab)==null?void 0:e.call(window,"social")})},{label:"\u{1F4DC} Activity Log",hint:"Profile \u2192 Recent account activity",action:()=>Ss(()=>{var e;return(e=window.switchProfileTab)==null?void 0:e.call(window,"activity")})},{label:"\u2699\uFE0F Settings",hint:"Profile \u2192 Preferences & AI Explanations",action:()=>Ss(()=>{var e;return(e=window.switchProfileTab)==null?void 0:e.call(window,"settings")})},{label:"\u{1F52C} Analyze a Project",hint:"Liquidity depth, holder/LP concentration, issuer risk",action:()=>Ss(()=>{var e;return(e=window.jumpToProjectIntelLookup)==null?void 0:e.call(window)})},{label:"\u{1F9ED} Replay App Tour",hint:"Retake the onboarding walkthrough",action:()=>{var e;(e=window.showDashboard)==null||e.call(window),setTimeout(()=>{var t;return(t=window.startTour)==null?void 0:t.call(window)},300)}},{label:"\u2753 Help & Glossary",hint:"Search app features and on-chain terms",action:()=>{var e;return(e=window.openHelp)==null?void 0:e.call(window)}},{label:"\u{1F511} Sign In",hint:"Open auth",action:()=>{var e;return(e=window._openAuth)==null?void 0:e.call(window,"login")}},{label:"\u2728 Sign Up",hint:"Create account",action:()=>{var e;return(e=window._openAuth)==null?void 0:e.call(window,"signup")}},{label:"\u{1F3E0} Landing Page",hint:"Go home",action:()=>{var e;return(e=window._goHome)==null?void 0:e.call(window)}},{label:"\u{1F3A8} Cycle Theme",hint:"gold \u2192 cosmic \u2192 starry \u2192",action:()=>{var e;return(e=window._cycleTheme)==null?void 0:e.call(window)}}];function bw(e){let t=e.trim();return He(t)?[{label:`\u{1F50D} Inspect ${t.slice(0,8)}\u2026${t.slice(-6)}`,hint:"Run the full account inspection on this address",action:()=>{Ln(document.querySelector('[data-tab="inspector"]'),"inspector"),setTimeout(()=>{var s;let n=document.getElementById("inspect-addr");n&&(n.value=t),(s=window.runInspect)==null||s.call(window)},200)}}]:[]}var Vn=0,uo=[...vr];function mo(e=""){let t=w("cmdkOverlay"),n=w("cmdkInput");!t||!n||(t.classList.add("show"),n.value=e||"",vm(e),n.focus())}function Ts(){var e;(e=w("cmdkOverlay"))==null||e.classList.remove("show")}function gm(){let e=w("cmdkOverlay"),t=w("cmdkInput");!e||!t||(t.addEventListener("input",()=>vm(t.value)),t.addEventListener("keydown",n=>{n.key==="ArrowDown"&&(n.preventDefault(),hm(1)),n.key==="ArrowUp"&&(n.preventDefault(),hm(-1)),n.key==="Enter"&&(n.preventDefault(),yw()),n.key==="Escape"&&Ts()}),e.addEventListener("click",n=>{n.target===e&&Ts()}))}function vm(e=""){let t=w("cmdkList");if(!t)return;let n=e.toLowerCase().trim(),s=bw(e);uo=n?[...s,...vr.filter(a=>a.label.toLowerCase().includes(n)||a.hint.toLowerCase().includes(n))]:[...s,...vr],Vn=0,t.innerHTML=uo.length?uo.map((a,o)=>`
        <button class="cmdk-item${o===0?" is-active":""}" data-index="${o}">
          <span class="cmdk-label">${y(a.label)}</span>
          <span class="cmdk-hint2">${y(a.hint)}</span>
        </button>`).join(""):'<div class="cmdk-section-label">No results</div>',t.querySelectorAll(".cmdk-item").forEach(a=>{a.addEventListener("click",()=>bm(Number(a.dataset.index)))})}function hm(e){var n,s,a;let t=Xe("#cmdkList .cmdk-item");t.length&&((n=t[Vn])==null||n.classList.remove("is-active"),Vn=(Vn+e+t.length)%t.length,(s=t[Vn])==null||s.classList.add("is-active"),(a=t[Vn])==null||a.scrollIntoView({block:"nearest"}))}function bm(e){let t=uo[e];t&&(Ts(),t.action())}function yw(){bm(Vn)}var fo=!1;function br(){let e=X.currentPage,t=X.currentTab,n=e==="dashboard"&&t==="stream",s=e==="dashboard"&&t==="inspector",a=e==="dashboard"&&t==="network";eu(n),xu(s),lm(a)}function ym(){fo||(Zp(),wu(),rm(),ql(),br(),fo=!0)}window.openAuth=e=>No(e);window.closeAuth=()=>rn();window.showAuthView=e=>on(e);window.authKeydown=e=>rl(e);window.submitSignIn=()=>_o();window.submitSignUp=()=>Do();window.refreshCaptcha=()=>Vr();window.showForgotView=()=>Qr();window.forgotRestoreFromFile=()=>Zr();window.forgotWipeConfirm=()=>el();window.forgotWipeExecute=()=>tl();window.forgotBackToOptions=()=>nl();window.submitSyncImport=()=>Io();window.exportVaultSyncCode=()=>sl();window.syncImportFromFile=()=>al();window.signupNext=()=>Ro();window.signupBack=()=>qr();window.logout=()=>ol();window.goHome=()=>Pn();window.showLandingPage=()=>Pn();window.showDashboard=()=>Mn();window.showProfile=()=>xo();window.switchTab=(e,t)=>Ln(e,t);window.runInspect=()=>ws();window.closeCommandPalette=()=>Ts();window.openCmdk=()=>mo();window.setTheme=e=>Cn(e);window.cycleTheme=()=>yo();window.measureLatency=()=>ia();window.switchProfileTab=e=>ii(e);window.openProfileEditor=()=>Dd();window.closeProfileEditor=()=>Bs();window.saveProfileEditor=()=>Id();window.selectAvatar=e=>Fd(e);window.selectBanner=e=>Od(e);window.uploadAvatarImage=e=>Bd(e);window.removeAvatarImage=()=>Xd();window.uploadBannerImage=e=>Hd(e);window.removeBannerImage=()=>zd();window.prefSetTheme=e=>rp(e);window.setPrefCurrency=e=>lp(e);window.setPrefNetwork=e=>cp(e);window.setPrefAutoLock=e=>dp(e);window.openPublicProfilePreview=()=>ip();window.exportVaultBackup=()=>Wd();window.logActivity=(e,t)=>kt(e,t);window.toggleWalletDrawer=e=>Ad(e);window.switchWalletDrawerTab=(e,t)=>Ed(e,t);window.cancelOffer=(e,t,n)=>Rd(e,t,n);window.fetchBalance=e=>Fn(e);window.setActiveWallet=e=>Jl(e);window.openImportAddressModal=()=>ep();window.closeImportAddressModal=()=>wi();window.importWatchOnlyWallet=()=>tp();window.openImportSeedModal=()=>np();window.closeImportSeedModal=()=>xi();window.executeImportFromSeed=()=>sp();window.openTokenDetailsModal=(e,t,n)=>ap(e,t,n);window.closeTokenDetailsModal=()=>op();window.refreshXrplDashboard=()=>ts();window.refreshMarketData=()=>bd();window.refreshNftGallery=()=>yd();window.refreshAmmPools=()=>wd();window.refreshPoolExplorer=()=>xd();window.loadCustomAmmPool=()=>dc();window.sendNft=e=>kd(e);window.toggleSeedBackupStatus=()=>xc();window.setDexPair=e=>kc(e);window.setDexInterval=e=>$c(e);window.setDexChartType=e=>Sc(e);window.refreshDexChart=()=>Tc();window.setComparePair=e=>Bc(e);window.toggleIndicator=(e,t)=>Cc(e,t);window.toggleTerminalTheme=()=>Yc();window.toggleChartFullscreen=()=>Qc();window.exportChartPng=()=>Zc();window.saveChartLayoutPreset=()=>td();window.loadChartLayoutPreset=()=>nd();window.setIndicatorFromDropdown=e=>Xc(e);window.toggleIndicatorMenu=()=>Pc();window.toggleChartMoreMenu=()=>Mc();window.setIndicatorQuery=e=>Lc(e);window.addIndicatorFromMenu=e=>Ac(e);window.removeIndicator=e=>Ec(e);window.openIndicatorSettings=e=>Nc(e);window.closeIndicatorSettings=()=>Rc();window.applyIndicatorSettings=e=>_c(e);window.resetIndicatorSettings=e=>Dc(e);window.copyChartLink=()=>Ic();window.toggleThreeEffects=()=>Fc();window.setThreeEffects=e=>Oc(e);window.setDrawingTool=e=>Hc(e);window.clearAllDrawings=()=>Uc();window.addPriceAlert=()=>zc();window.removePriceAlert=e=>Wc(e);window.zoomChartIn=()=>jc();window.zoomChartOut=()=>qc();window.panChartLeft=()=>Vc();window.panChartRight=()=>Gc();window.toggleEducationPanel=()=>Kc();window.selectEducationTab=e=>Jc(e);window.searchTokens=e=>od(e);window.lookupIssuedAsset=()=>mi();window.lookupAndAnalyzeProject=()=>gd();window.addTokenToWatchlist=e=>ud(e);window.removeTokenFromWatchlist=e=>md(e);window.openTokenOnChart=e=>Da(e);window.loadToken=e=>fd(e);window.refreshTokenDiscovery=()=>hd();window.refreshRecentTransactions=()=>vd();window.setTokenFilter=(e,t)=>id(e,t);window.clearTokenFilters=()=>rd();window.selectTokenDetails=e=>pd(e);window.openProjectIntel=e=>ci(e);window.jumpToProjectIntelLookup=()=>Ql();window.toggleProjectIntelSubScore=e=>Zl(e);window.copyProjectIntelForAi=()=>ac();window.closeProjectIntel=()=>ec();window.showMoreIssuedTokens=()=>ld();window.showAllIssuedTokens=()=>cd();window.resetIssuedTokenLimit=()=>dd();window.openWalletCreator=()=>bi();window.closeWalletCreator=()=>Xs();window.wizardNext=()=>Ud();window.wizardBack=()=>jd();window.selectAlgo=e=>qd(e);window.selectWalletEmoji=e=>Vd(e);window.selectWalletColor=e=>Gd(e);window.toggleSecurityCheck=e=>Kd(e);window.revealSeed=()=>Yd();window.copySeed=()=>Qd();window.copyAddress=()=>Zd();window.copyToClipboard=e=>Hs(e);window.deleteWallet=e=>Md(e);window.inspectWalletAddr=e=>Ld(e);window.openSocialModal=e=>Sd(e);window.closeSocialModal=()=>os();window.saveSocialModal=()=>Td();window.deleteSocial=()=>Cd();window.viewSocial=e=>Pd(e);window.connectXRPL=()=>import("./xrpl-6AERZ5KD.js").then(({connectXRPL:e})=>e());window._openAuth=No;window._goHome=Pn;window._cycleTheme=yo;window._showProfile=xo;window.startTour=()=>So();window.tourNext=()=>Wr();window.tourPrev=()=>Ur();window.tourSkip=()=>fa();window.openHelp=()=>pp();window.closeHelp=()=>Oa();window.filterHelp=e=>$i(e);document.addEventListener("DOMContentLoaded",()=>{var e;console.log("\u{1F30A} NaluLF: booting\u2026"),Fr(),Pn(),um(),mm(),fm(),gm(),up(),ww(),window.addEventListener("naluxrp:pagechange",t=>{var s;let n=(s=t==null?void 0:t.detail)==null?void 0:s.pageId;(n==="dashboard"||n==="inspector"||n==="profile")&&ym(),fo&&br()}),window.addEventListener("naluxrp:tabchange",()=>{fo&&br()}),document.addEventListener("keydown",t=>{var s;let n=["INPUT","TEXTAREA"].includes((s=document.activeElement)==null?void 0:s.tagName);if((t.ctrlKey||t.metaKey)&&t.key==="k"){t.preventDefault(),mo();return}if(t.key==="/"&&!n){t.preventDefault(),mo();return}t.key==="Escape"&&(Ts(),rn(),Bs(),Xs(),os(),fa(),Oa())}),(e=document.getElementById("auth-overlay"))==null||e.addEventListener("click",t=>{t.target===t.currentTarget&&rn()}),il()&&(ym(),Mn(),import("./xrpl-6AERZ5KD.js").then(({connectXRPL:t})=>t())),console.log("\u2705 NaluLF: ready")});function ww(){xm(),setInterval(()=>{document.hidden||xm()},3e4)}async function wm(e){let t=[s=>`https://corsproxy.io/?${encodeURIComponent(s)}`,s=>`https://api.allorigins.win/raw?url=${encodeURIComponent(s)}`],n=async s=>{let a=typeof(AbortSignal==null?void 0:AbortSignal.timeout)=="function"?AbortSignal.timeout(7e3):void 0,o=await fetch(s,{mode:"cors",cache:"no-store",signal:a});if(!o.ok)throw new Error(`HTTP ${o.status}`);return await o.json()};try{return await n(e)}catch{for(let s of t)try{return await n(s(e))}catch{}throw new Error("Price feed unreachable")}}async function xm(){try{let e=await wm("https://api.exchange.coinbase.com/products/XRP-USD/ticker"),t=await wm("https://api.exchange.coinbase.com/products/XRP-USD/candles?granularity=86400");if(e!=null&&e.price){let n=Number(e.price),s=Array.isArray(t)&&t.length?t[0]:null,a=s?Number(s[3]||n):n,o=a?(n-a)/a*100:0,i=document.getElementById("xrpPrice"),r=document.getElementById("xrpChange");if(i&&(i.textContent=`$${Number(n).toFixed(3)}`),r){let l=o>=0;r.textContent=`${l?"+":""}${Number(o).toFixed(2)}%`,r.className=`xrp-price-change ${Math.abs(o)<.1?"flat":l?"up":"down"}`}}}catch{}}
