import{a as Gi,b as za,c as cn,d as Tt,e as y,f as De,g as b,h as ze,i as I,j as W,k as Z,l as te,m as lt,n as ve,o as se,p as be,q as At,r as X,s as Us,v as Ae,w as Ki}from"./chunk-R7KFE7J7.js";function dn(e){cn.includes(e)||(e="gold"),X.currentTheme=e,cn.forEach(t=>document.body.classList.remove(`theme-${t}`)),document.body.classList.add(`theme-${e}`),te(za,e)}function Ua(){let e=cn.indexOf(X.currentTheme);dn(cn[(e+1)%cn.length])}function Ji(){let e=Z(za);dn(cn.includes(e)?e:"gold")}var Yi={landing:"landing-page",dashboard:"dashboard",inspector:"inspector",profile:"dashboard"};function Wa(e){document.body.classList.remove("modal-open"),Object.values(Yi).forEach(i=>document.body.classList.remove(i)),document.body.classList.add(Yi[e]||"dashboard");let t=y("landing"),n=y("dashboard"),s=y("profile-page");t&&(t.style.display=e==="landing"?"":"none"),n&&(n.style.display=e==="dashboard"?"":"none"),s&&(s.style.display=e==="profile"?"":"none");let a=e==="landing",o={landingActions:y("navbar-landing-actions"),dashActions:y("navbar-dash-actions"),navConn:y("navbar-conn"),cmdkHint:y("cmdk-hint")};o.landingActions&&(o.landingActions.style.display=a?"":"none"),o.dashActions&&(o.dashActions.style.display=a?"none":""),o.navConn&&(o.navConn.style.display=a?"none":""),o.cmdkHint&&(o.cmdkHint.style.display=a?"none":""),X.currentPage=e,window.scrollTo({top:0,behavior:"smooth"}),window.dispatchEvent(new CustomEvent("naluxrp:pagechange",{detail:{pageId:e}}))}function pn(){Wa("landing")}function un(){Wa("dashboard")}function ja(){Wa("profile")}function En(e,t){De(".dash-tab").forEach(n=>{n.classList.toggle("active",n===e),n.setAttribute("aria-selected",String(n===e))}),["stream","inspector","network"].forEach(n=>{let s=y(`tab-${n}`);s&&(s.style.display=n===t?"":"none")}),t==="inspector"?(document.body.classList.remove("dashboard"),document.body.classList.add("inspector")):(document.body.classList.remove("inspector"),document.body.classList.add("dashboard")),X.currentTab=t,window.dispatchEvent(new CustomEvent("naluxrp:tabchange",{detail:{tabId:t}}))}var Ct="naluxrp_vault_meta",Nt="naluxrp_vault_data",Nn="naluxrp_session",Va="nalulf_used_names",Ga="nalulf_used_emails",Ka="nalulf_used_domains",qa=15e4,Ws="naluxrp_v2",Ue={_key:null,_vault:null,_lockTimer:null,AUTO_LOCK_MS:30*60*1e3,get isUnlocked(){return this._key!==null&&this._vault!==null},get vault(){return this._vault},hasVault(){return!!Z(Ct)&&!!Z(Nt)},async create(e,t,n,s){let a=crypto.getRandomValues(new Uint8Array(32));this._key=await this._deriveKey(e,a);let o=(s||t).toLowerCase().replace(/[^a-z0-9_]/g,"");return this._vault={checksum:Ws,identity:{name:t,email:n,domain:o,createdAt:new Date().toISOString()},profile:{},wallets:[],social:{}},te(Ct,JSON.stringify({salt:Array.from(a),iterations:qa,version:Ws})),await this._persist(),this._startLockTimer(),this._vault},async unlock(e){let t=ve(Z(Ct));if(!t)throw new Error("No account found. Create one first.");this._key=await this._deriveKey(e,new Uint8Array(t.salt));let n;try{let s=ve(Z(Nt));if(!s)throw new Error("missing");n=await this._decrypt(s)}catch{throw this._key=null,new Error("Incorrect password. Please try again.")}if((n==null?void 0:n.checksum)!==Ws)throw this._key=null,new Error("Account data corrupted. Restore from backup.");return this._vault=n,this._startLockTimer(),this._vault},async update(e){if(!this.isUnlocked)throw new Error("Sign in to continue.");e(this._vault),await this._persist()},lock(){this._key=null,this._vault=null,clearTimeout(this._lockTimer),this._lockTimer=null},resetTimer(){this.isUnlocked&&this._startLockTimer()},async changePassword(e){if(!this.isUnlocked)throw new Error("Sign in first.");let t=crypto.getRandomValues(new Uint8Array(32));this._key=await this._deriveKey(e,t),te(Ct,JSON.stringify({salt:Array.from(t),iterations:qa,version:Ws})),await this._persist()},async exportBlob(){if(!this.isUnlocked)throw new Error("Sign in before exporting.");let e={vault:ve(Z(Nt)),meta:ve(Z(Ct)),exportedAt:new Date().toISOString()},t=URL.createObjectURL(new Blob([JSON.stringify(e,null,2)],{type:"application/json"}));Object.assign(document.createElement("a"),{href:t,download:`naluxrp-backup-${Date.now()}.json`}).click(),URL.revokeObjectURL(t)},async _deriveKey(e,t){let n=new TextEncoder,s=await crypto.subtle.importKey("raw",n.encode(e),"PBKDF2",!1,["deriveKey"]);return crypto.subtle.deriveKey({name:"PBKDF2",salt:t,iterations:qa,hash:"SHA-256"},s,{name:"AES-GCM",length:256},!1,["encrypt","decrypt"])},async _encrypt(e){let t=crypto.getRandomValues(new Uint8Array(12)),n=new TextEncoder,s=await crypto.subtle.encrypt({name:"AES-GCM",iv:t},this._key,n.encode(JSON.stringify(e)));return{iv:Array.from(t),cipher:Array.from(new Uint8Array(s))}},async _decrypt(e){let t=new TextDecoder,n=await crypto.subtle.decrypt({name:"AES-GCM",iv:new Uint8Array(e.iv)},this._key,new Uint8Array(e.cipher).buffer);return JSON.parse(t.decode(n))},async _persist(){!this._key||!this._vault||te(Nt,JSON.stringify(await this._encrypt(this._vault)))},_startLockTimer(){clearTimeout(this._lockTimer),this._lockTimer=setTimeout(()=>{this.lock(),window.dispatchEvent(new CustomEvent("naluxrp:vault-locked"))},this.AUTO_LOCK_MS)}},Qe=1;function Ya(e){var t;Ue.hasVault()?Wt(e||"login"):Wt("welcome"),(t=y("auth-overlay"))==null||t.classList.add("show")}function jt(){var e;(e=y("auth-overlay"))==null||e.classList.remove("show"),qt(),Qe=1,mn(1)}function Wt(e){var s,a,o,i,r;Ks(".auth-view").forEach(l=>l.classList.remove("active")),(s=y(`auth-view-${e}`))==null||s.classList.add("active"),(a=y("auth-overlay"))==null||a.setAttribute("data-view",e);let t=["welcome","forgot","sync","celebrate","syncaware"].includes(e),n=y("auth-tab-row");n&&(n.style.display=t?"none":""),(o=y("tab-login-btn"))==null||o.classList.toggle("active",e==="login"),(i=y("tab-signup-btn"))==null||i.classList.toggle("active",e==="signup"),(r=y("tab-sync-btn"))==null||r.classList.toggle("active",e==="sync"),e==="signup"&&(Qe=1,mn(1),An()),qt()}function mn(e){[1,2,3].forEach(s=>{let a=y(`signup-step-${s}`);a&&(a.style.display=s===e?"":"none");let o=y(`signup-dot-${s}`);o&&(o.classList.toggle("active",s===e),o.classList.toggle("done",s<e))});let t=["","Step 1 of 3 \u2014 Identity","Step 2 of 3 \u2014 Security","Step 3 of 3 \u2014 Sync setup"],n=y("signup-step-label");n&&(n.textContent=t[e]||"")}function Qa(){var e,t,n,s,a,o;if(qt(),Qe===1){let i=((e=y("inp-signup-name"))==null?void 0:e.value.trim())||"",r=((t=y("inp-signup-email"))==null?void 0:t.value.trim())||"",l=((n=y("inp-signup-domain"))==null?void 0:n.value.trim())||"";if(!i||i.length<3)return Pe("Display name must be at least 3 characters.");if(nr(i))return Pe(`"${i}" is already in use on this device.`);if(!r||!r.includes("@"))return Pe("Enter a valid email address.");if(sr(r))return Pe("That email is already registered on this device.");if(l&&ar(l))return Pe(`@${l} is already taken on this device.`);if(l&&!/^[a-z0-9_]{2,30}$/.test(l))return Pe("Handle: 2-30 lowercase letters, numbers, underscores only.");Qe=2,mn(2),An(),setTimeout(()=>{var c;return(c=y("inp-signup-pass"))==null?void 0:c.focus()},80)}else if(Qe===2){let i=((s=y("inp-signup-pass"))==null?void 0:s.value)||"",r=((a=y("inp-signup-confirm"))==null?void 0:a.value)||"";if(!i||i.length<8)return Pe("Password must be at least 8 characters.");if(!hr(i))return Pe("Add uppercase, lowercase, and a number.");if(i!==r)return Pe("Passwords do not match.");if(!tr())return An(),Pe("Type the word from the image exactly.");Qe=3,mn(3);let l=y("syncaware-name"),c=((o=y("inp-signup-name"))==null?void 0:o.value.trim())||"there";l&&(l.textContent=c.split(" ")[0])}}function Zi(){Qe>1&&(Qe--,mn(Qe),qt(),Qe===1&&setTimeout(()=>{var e;return(e=y("inp-signup-name"))==null?void 0:e.focus()},80))}var Qi=["XRPL","LEDGER","VAULT","CRYPTO","BLOCK","TOKEN","CHAIN","WAVE","ATLAS","FORGE","NEXUS","ORBIT","PRISM","DELTA","NOVA","SONIC","PIXEL","GHOST","FLARE","SPARK","TITAN","LUNAR","STORM","PROXY","CIPHER","RELAY","PULSE","SCOUT"],Ja="";function An(){Ja=Qi[Math.floor(Math.random()*Qi.length)];let e=document.getElementById("captcha-canvas"),t=y("inp-captcha");if(t&&(t.value=""),!e)return;let n=e.getContext("2d"),s=e.width,a=e.height;n.clearRect(0,0,s,a),n.fillStyle="#080f1e",n.fillRect(0,0,s,a),n.strokeStyle="rgba(0,255,240,.05)",n.lineWidth=1;for(let r=0;r<s;r+=18)n.beginPath(),n.moveTo(r,0),n.lineTo(r,a),n.stroke();for(let r=0;r<a;r+=18)n.beginPath(),n.moveTo(0,r),n.lineTo(s,r),n.stroke();for(let r=0;r<55;r++)n.fillStyle=`rgba(${Math.random()>.5?"0,255,240":"160,180,255"},${(Math.random()*.22+.05).toFixed(2)})`,n.beginPath(),n.arc(Math.random()*s,Math.random()*a,Math.random()*2+.5,0,Math.PI*2),n.fill();for(let r=0;r<4;r++)n.strokeStyle=`rgba(0,255,240,${(Math.random()*.1+.03).toFixed(2)})`,n.lineWidth=1,n.beginPath(),n.moveTo(0,Math.random()*a),n.bezierCurveTo(s*.3,Math.random()*a,s*.7,Math.random()*a,s,Math.random()*a),n.stroke();let o=Ja.split(""),i=(s-o.length*26)/2+8;o.forEach((r,l)=>{let c=i+l*26+(Math.random()*8-4),d=a/2+8+(Math.random()*10-5);n.save(),n.translate(c,d),n.rotate(Math.random()*.35-.175),n.shadowColor="rgba(0,255,240,.5)",n.shadowBlur=8,n.fillStyle=`rgb(${Math.random()>.4?"180,255,240":"140,200,255"})`,n.font=`bold ${24+Math.random()*4}px 'JetBrains Mono','Courier New',monospace`,n.fillText(r,0,0),n.restore()})}function er(){An()}function tr(){var e;return(((e=y("inp-captcha"))==null?void 0:e.value)||"").trim().toUpperCase()===Ja}function nr(e){return(ve(Z(Va))||[]).some(t=>t.toLowerCase()===e.toLowerCase())}function sr(e){return(ve(Z(Ga))||[]).some(t=>t.toLowerCase()===e.toLowerCase())}function ar(e){return(ve(Z(Ka))||[]).some(t=>t.toLowerCase()===e.toLowerCase())}function ru(e,t,n){let s=ve(Z(Va))||[],a=ve(Z(Ga))||[],o=ve(Z(Ka))||[];s.includes(e.toLowerCase())||s.push(e.toLowerCase()),a.includes(t.toLowerCase())||a.push(t.toLowerCase()),n&&!o.includes(n.toLowerCase())&&o.push(n.toLowerCase()),te(Va,JSON.stringify(s)),te(Ga,JSON.stringify(a)),te(Ka,JSON.stringify(o))}async function Za(){var s,a,o;let e=((s=y("inp-login-email"))==null?void 0:s.value.trim())||"",t=((a=y("inp-login-pass"))==null?void 0:a.value)||"";if(qt(),!e)return Pe("Enter your email address.");if(!t)return Pe("Enter your password.");let n=y("signin-btn");js(n,!0,"Signing in\u2026");try{let i=await Ue.unlock(t);X.session={name:i.identity.name,email:i.identity.email,domain:i.identity.domain||""},te(Nn,JSON.stringify(X.session)),jt(),Gs(X.session),un(),Us(),window.dispatchEvent(new CustomEvent("naluxrp:vault-ready",{detail:Ue.vault})),du()}catch(i){Pe(i.message),(o=y("auth-modal-inner"))==null||o.classList.add("shake"),setTimeout(()=>{var r;return(r=y("auth-modal-inner"))==null?void 0:r.classList.remove("shake")},500)}finally{js(n,!1,"Sign In \u2192")}}async function eo(){var i,r,l,c,d;let e=((i=y("inp-signup-name"))==null?void 0:i.value.trim())||"",t=((r=y("inp-signup-email"))==null?void 0:r.value.trim())||"",n=((l=y("inp-signup-domain"))==null?void 0:l.value.trim())||e.toLowerCase().replace(/[^a-z0-9_]/g,"_"),s=((c=y("inp-signup-pass"))==null?void 0:c.value)||"",a=((d=y("inp-signup-confirm"))==null?void 0:d.value)||"";if(qt(),!s||s.length<8)return Pe("Password must be at least 8 characters.");if(!hr(s))return Pe("Add uppercase, lowercase, and a number.");if(s!==a)return Pe("Passwords do not match.");if(!tr())return An(),Qe=2,mn(2),Pe("Type the word from the image exactly.");let o=y("signup-btn");js(o,!0,"Creating vault\u2026");try{await Ue.create(s,e,t,n),ru(e,t,n),X.session={name:e,email:t,domain:n},te(Nn,JSON.stringify(X.session)),Gs(X.session),lu(e,()=>{jt(),un(),Us(),window.dispatchEvent(new CustomEvent("naluxrp:vault-ready",{detail:Ue.vault})),setTimeout(pu,3500)})}catch(u){Pe(u.message),An(),Qe=2,mn(2)}finally{js(o,!1,"Create Account \u2192")}}function lu(e,t){Wt("celebrate");let n=y("celebrate-name");n&&(n.textContent=e.split(" ")[0]);let s=setTimeout(t,2800),a=y("celebrate-continue-btn");a&&(a.onclick=()=>{clearTimeout(s),t()})}function or(){Wt("forgot"),Ks(".forgot-step").forEach(t=>t.style.display="none");let e=y("forgot-step-options");e&&(e.style.display="")}function ir(){let e=document.createElement("input");e.type="file",e.accept=".json,application/json",e.onchange=async t=>{let n=t.target.files[0];if(n)try{let s=await n.text(),a=JSON.parse(s);if(!(a!=null&&a.vault)||!(a!=null&&a.meta))throw new Error("Invalid backup file.");te(Nt,JSON.stringify(a.vault)),te(Ct,JSON.stringify(a.meta)),se("Backup restored \u2014 sign in with your original password."),Wt("login")}catch(s){At("Could not read backup: "+s.message)}},e.click()}function rr(){Ks(".forgot-step").forEach(n=>n.style.display="none");let e=y("forgot-step-wipe");e&&(e.style.display="");let t=y("inp-wipe-confirm");t&&(t.value="")}function lr(){var t;if((((t=y("inp-wipe-confirm"))==null?void 0:t.value.trim())||"")!=="DELETE")return Pe("Type DELETE exactly.");lt(Ct),lt(Nt),lt(Nn),Ue.lock(),X.session=null,se("Account cleared. Create a new one."),jt(),Wt("signup"),window.dispatchEvent(new Event("naluxrp:logout"))}function cr(){Ks(".forgot-step").forEach(t=>t.style.display="none");let e=y("forgot-step-options");e&&(e.style.display=""),qt()}function dr(){let e=Z(Nt),t=Z(Ct);if(!e||!t){At("No vault to export.");return}let n=btoa(JSON.stringify({vault:JSON.parse(e),meta:JSON.parse(t)})),s=document.createElement("div");s.id="sync-code-overlay",s.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,.92);backdrop-filter:blur(14px);z-index:99999;display:flex;align-items:center;justify-content:center;padding:20px;",s.innerHTML=`<div style="background:#0d1829;border:1.5px solid rgba(0,255,240,.22);border-radius:22px;padding:28px;max-width:500px;width:100%;box-shadow:0 28px 70px rgba(0,0,0,.95);"><div style="font-size:1rem;font-weight:900;margin-bottom:6px;color:#00fff0;">\u{1F4F1} Vault Sync Code</div><p style="font-size:.82rem;color:rgba(255,255,255,.55);margin-bottom:16px;line-height:1.6;">On your new device open NaluLF \u2192 <strong style="color:rgba(255,255,255,.8)">\u{1F4F1} New Device</strong> tab, paste this code and enter your password.</p><textarea readonly id="sync-code-output" style="width:100%;height:110px;background:#060e1a;border:1px solid rgba(255,255,255,.12);border-radius:10px;color:rgba(0,255,240,.85);font-family:monospace;font-size:.7rem;padding:10px;resize:none;box-sizing:border-box;" spellcheck="false">${n}</textarea><div style="display:flex;gap:10px;margin-top:14px;justify-content:flex-end;"><button onclick="document.getElementById('sync-code-overlay').remove()" style="padding:9px 16px;background:rgba(255,255,255,.06);border:1px solid rgba(255,255,255,.12);border-radius:9px;color:rgba(255,255,255,.65);font-size:.85rem;font-weight:700;cursor:pointer;font-family:inherit;">Close</button><button onclick="navigator.clipboard.writeText(document.getElementById('sync-code-output').value).then(()=>{this.textContent='\u2713 Copied!';setTimeout(()=>this.textContent='Copy Code',2000)})" style="padding:9px 18px;background:linear-gradient(135deg,#00d4ff,#00fff0);border:none;border-radius:9px;color:#000;font-size:.85rem;font-weight:900;cursor:pointer;font-family:inherit;">Copy Code</button></div></div>`,document.body.appendChild(s),s.addEventListener("click",a=>{a.target===s&&s.remove()})}async function to(){var s,a;let e=((s=y("inp-sync-code"))==null?void 0:s.value.trim())||"",t=((a=y("inp-sync-pass"))==null?void 0:a.value)||"";if(qt(),!e)return Pe("Paste your vault sync code or load a backup file first.");if(!t)return Pe("Enter the password from your original device.");let n=document.querySelector("#auth-view-sync .auth-submit-btn");n&&(n.disabled=!0,n.textContent="Importing\u2026");try{let o;try{o=JSON.parse(atob(e))}catch{try{o=JSON.parse(e)}catch{throw new Error("Invalid sync code. Paste the full code from your other device.")}}if(!(o!=null&&o.vault)||!(o!=null&&o.meta))throw new Error("Invalid sync code format \u2014 make sure you copied the entire code.");te(Nt,JSON.stringify(o.vault)),te(Ct,JSON.stringify(o.meta));let i=await Ue.unlock(t);X.session={name:i.identity.name,email:i.identity.email,domain:i.identity.domain||""},te(Nn,JSON.stringify(X.session)),jt(),Gs(X.session),un(),Us(),window.dispatchEvent(new CustomEvent("naluxrp:vault-ready",{detail:Ue.vault})),se("\u2705 Account imported to this device!")}catch(o){let i=o.message.includes("decrypt")||o.message.includes("Incorrect");Pe(i?"Wrong password \u2014 use the password from your original device.":"Could not import: "+o.message),lt(Nt),lt(Ct)}finally{n&&(n.disabled=!1,n.textContent="Import & Sign In \u2192")}}function pr(){let e=document.createElement("input");e.type="file",e.accept=".json,application/json",e.onchange=async t=>{var s;let n=t.target.files[0];if(n)try{let a=await n.text(),o=JSON.parse(a);if(!(o!=null&&o.vault)||!(o!=null&&o.meta))throw new Error("Invalid backup file format.");let i=y("inp-sync-code");i&&(i.value=btoa(JSON.stringify({vault:o.vault,meta:o.meta})));let r=y("sync-file-feedback");r&&(r.textContent=`\u2713 File loaded: ${n.name}`,r.style.color="#50fa7b"),(s=y("inp-sync-pass"))==null||s.focus()}catch(a){At("Could not read backup: "+a.message)}},e.click()}function ur(){Ue.lock(),X.session=null,lt(Nn),pn(),window.dispatchEvent(new Event("naluxrp:logout"))}function mr(){let e=ve(Z(Nn));return e!=null&&e.email&&Ue.hasVault()?(X.session=e,Gs(e),!0):!1}function cu(){if(y("vault-lock-banner"))return;let e=document.createElement("div");e.id="vault-lock-banner",e.className="vault-lock-banner",e.innerHTML=`<span class="vlb-icon">\u{1F512}</span><span class="vlb-text">Vault locked for security after 30 min of inactivity.</span><button class="vlb-btn" onclick="openAuth('login')">Unlock \u2192</button><button class="vlb-close" onclick="this.closest('.vault-lock-banner').remove()" title="Dismiss">\u2715</button>`,document.body.prepend(e),requestAnimationFrame(()=>e.classList.add("show"))}function du(){let e=y("vault-lock-banner");e&&(e.classList.remove("show"),setTimeout(()=>e.remove(),300))}function pu(){if(y("backup-reminder-banner")||!Ue.hasVault())return;let e=document.createElement("div");e.id="backup-reminder-banner",e.className="backup-reminder-banner",e.innerHTML=`<span class="brb-icon">\u26A0\uFE0F</span><div class="brb-body"><strong>Back up your vault</strong> \u2014 you'll lose access if browser storage is cleared. <button class="brb-btn" onclick="window.exportVaultBackup?.()">Export Backup</button></div><button class="brb-close" onclick="this.closest('.backup-reminder-banner').remove()">\u2715</button>`;let t=document.getElementById("profile-page");t?t.prepend(e):document.body.prepend(e),requestAnimationFrame(()=>e.classList.add("show"))}function fr(e){var n;let t=((n=y("auth-overlay"))==null?void 0:n.getAttribute("data-view"))||"login";if(e.key==="Enter"&&(t==="login"&&Za(),t==="signup"&&(Qe<3?Qa():eo()),t==="sync"&&to()),e.key==="Tab"){let s=y("auth-modal-inner");if(!s)return;let a=Array.from(s.querySelectorAll("button:not([disabled]),input,textarea,select")).filter(r=>r.offsetParent!==null);if(!a.length)return;let o=a[0],i=a[a.length-1];e.shiftKey&&document.activeElement===o&&(e.preventDefault(),i.focus()),!e.shiftKey&&document.activeElement===i&&(e.preventDefault(),o.focus())}}function qs(e){let t=y(e);t==null||t.classList.add("valid"),t==null||t.classList.remove("invalid")}function fn(e){let t=y(e);t==null||t.classList.add("invalid"),t==null||t.classList.remove("valid")}function Vs(e){let t=y(e);t==null||t.classList.remove("valid","invalid")}window.validateSignupName=()=>{var s;let e=((s=y("inp-signup-name"))==null?void 0:s.value.trim())||"",t=y("hint-signup-name");if(!e){Vs("inp-signup-name"),t&&(t.textContent="");return}if(e.length<3){fn("inp-signup-name"),t&&(t.textContent="At least 3 characters");return}if(nr(e)){fn("inp-signup-name"),t&&(t.textContent="Already in use on this device");return}qs("inp-signup-name"),t&&(t.textContent="\u2713 Looks good!");let n=y("inp-signup-domain");n&&!n.dataset.manuallyEdited&&(n.value=e.toLowerCase().replace(/[^a-z0-9]/g,"_").replace(/_+/g,"_").replace(/^_|_$/g,""),window.validateSignupDomain())};window.validateSignupEmail=()=>{var n;let e=((n=y("inp-signup-email"))==null?void 0:n.value.trim())||"",t=y("hint-signup-email");if(!e){Vs("inp-signup-email"),t&&(t.textContent="");return}if(!e.includes("@")||!e.includes(".")){fn("inp-signup-email"),t&&(t.textContent="Enter a valid email");return}if(sr(e)){fn("inp-signup-email"),t&&(t.textContent="Already registered on this device");return}qs("inp-signup-email"),t&&(t.textContent="\u2713 Available")};window.validateSignupDomain=()=>{var s;let e=((s=y("inp-signup-domain"))==null?void 0:s.value.trim())||"",t=y("hint-signup-domain"),n=y("inp-signup-domain");if(!e){Vs("inp-signup-domain"),t&&(t.textContent="");return}if(!/^[a-z0-9_]{2,30}$/.test(e)){fn("inp-signup-domain"),t&&(t.textContent="2-30 chars: a-z, 0-9, underscore only");return}if(ar(e)){fn("inp-signup-domain"),t&&(t.textContent="Already taken on this device");return}qs("inp-signup-domain"),t&&(t.textContent=`\u2713 @${e}`),n&&(n.dataset.manuallyEdited="1")};window.validateLoginEmail=()=>{var t;let e=((t=y("inp-login-email"))==null?void 0:t.value.trim())||"";if(!e)return Vs("inp-login-email");e.includes("@")?qs("inp-login-email"):fn("inp-login-email")};window.switchSyncMethod=function(e){var i,r;let t=e==="code";(i=document.getElementById("sync-method-code"))==null||i.classList.toggle("sync-method-card--active",t),(r=document.getElementById("sync-method-file"))==null||r.classList.toggle("sync-method-card--active",!t);let n=document.getElementById("sync-code-section"),s=document.getElementById("sync-file-section"),a=document.getElementById("sync-method-code-steps"),o=document.getElementById("sync-method-file-steps");n&&(n.style.display=t?"":"none"),s&&(s.style.display=t?"none":""),a&&(a.style.display=t?"":"none"),o&&(o.style.display=t?"none":"")};window.togglePwVisibility=function(e,t){let n=y(e);if(!n)return;let s=n.type==="password";n.type=s?"text":"password",t.textContent=s?"\u{1F648}":"\u{1F441}"};window.updatePwStrength=function(e){let t=y("pw-strength-fill"),n=y("pw-strength-label");if(!t||!n)return;let s=0;e.length>=8&&s++,/[A-Z]/.test(e)&&s++,/[a-z]/.test(e)&&s++,/[0-9]/.test(e)&&s++,/[^A-Za-z0-9]/.test(e)&&s++;let a=[{w:"0%",bg:"transparent",txt:""},{w:"20%",bg:"#ff5555",txt:"Very weak"},{w:"40%",bg:"#ff8c42",txt:"Weak"},{w:"60%",bg:"#ffb86c",txt:"Fair"},{w:"80%",bg:"#00d4ff",txt:"Good"},{w:"100%",bg:"#50fa7b",txt:"Strong \u2713"}],o=a[s]||a[0];t.style.width=o.w,t.style.background=o.bg,n.textContent=o.txt,n.style.color=o.bg};function hr(e){return/[A-Z]/.test(e)&&/[a-z]/.test(e)&&/[0-9]/.test(e)}function Gs(e){let t=y("user-avatar"),n=y("user-name");t&&(t.textContent=e.name.charAt(0).toUpperCase()),n&&(n.textContent=e.name)}function Pe(e){let t=y("auth-error");t&&(t.textContent=e,t.style.display="")}function qt(){let e=y("auth-error");e&&(e.textContent="")}function js(e,t,n){e&&(e.disabled=t,e.textContent=n)}function Ks(e){return Array.from(document.querySelectorAll(e))}["click","keydown","mousemove","touchstart"].forEach(e=>document.addEventListener(e,()=>Ue.resetTimer(),{passive:!0}));window.addEventListener("naluxrp:vault-locked",()=>{X.vaultLocked=!0,cu()});var uu=180,Ft=12,gr=5,vr="naluxrp_compact_mode",mu=1e5,fu=18,no=16,hu=96,br=96,gu=96,vu=5*6e4,Js=72,yr=80,bu=1e4,yu=20,fs=8,Gr=3,Kr=.7,io=.35,ta=12,zn=10,Un=2,In=61e3,Gt="NALU-SPAM-PROOF:",Jr="naluxrp_spam_verified",Yr="naluxrp_spam_allowlist",Qr=new Set(["rPVMhWBsfF9iMXYj3aAzJVkPDTFNSyWdKy","rvYAfWj5gh67oV6fW32ZzP3Aw4Eubs59B","rrpNnNLKrartuEqfJGpqyDwPj1BBN1ih7","rN7n3473SaZBCG4dFL83w7PB9judJ7qdDo","rEb8TK3gBgk5auZkwc6sHnwrGVJH8DuaLh","rBKPS4oLSaV2KVVuHH8EpQqMGgGefGFQs7","rfk5bwaKCoNU84fTzdqWQowqnNaZorDmiV","rGFuMiw48HdbnrUbkRYDTvT5i9imC5fvv9","rwYHCs2EYBMBvRXFmxDrCUSorPsuqCck7t","rLHzPsX6oXkzU2qL12kHCH8G8cnZv1rBJh","ra5nK24KXen9AHvsdFTKHSANinZseWnPcX","rGWrZyax5eXbi5gs49MRZKkE9eKNL9p4B","rHsMUQFzBb7S6GnQFVgNirqvHRcLpAn5dU","rDsbeomae4FXwgQTJp9Rs64Qg9vDiTCdBv","rMQ98K56yXJbDGv49ZSmW51sLn94Xe1mu1","rKiCet8SdvWxPXnAgYarFUXMh1zCPz432Y","r9mhdcT2K7FdCGDEPqfbMJwVXsXCqEr5bP","r4GDFMLGJUKMjNEycBKPGnRSNXyNVLQLHi","rUA1S9qobBkxLqzdfGEzh5wm5KdLfbf8bx","rHtbQzmN4BDaEBnGSXp3AZaZAuZamNVsME","rhub8VRN55s94qWKDv6jmDy1pUykJzF3wq","razqnFn6FqBaYBdNaGnVzmGaNE6XPRQ9bG","rHb9CJAWyB4rj91VRWn96DkukG4bwdtyTh","r9cZA1mLK5R5Am25ArfXFmqgNwjZgnfk59","rPEPPER7kfTD9w2To4CQk6UCfuHM9c6GDY","rsoLo2S1kiGeCcn6hCUXVrCpGMWLrRrLZz"]),he={dexPressure:[],nftMints:[],nftBurns:[],autoBridge:[],marketPrice:[],marketVol:[]},Vt=null,so=0,vt={acct:new Map},cs={window:[],totals:new Map,maxLedgers:12},Ee={window:[],smoothCancelPerMin:null,smoothBurst:null},oe={byAddr:new Map,selectedAddr:null,selectedProof:null,allowList:new Set,verifiedCache:new Map},wr=!1,xr=!1,kr=!1,ro=!1,$r=!1,Sr=!1,Tr=!1,Cr=!1,Mr=!1,Lr=!1,Pr=!1,Er=!1,Ar=!1,Nr=!1,_r=!1,Rr=!1,Dr=!1,Ir=!1,hn=!1,ps=!1,lo={};var co=new Map;function Ys(e,t,n=2){let s=co.get(e)??-999;return Number(t)-s<n?!1:(co.set(e,Number(t)),!0)}var We={ledgersProcessed:0,startTime:Date.now(),totalTx:0,whaleCount:0,feeSpikes:0,botDetections:0,dexAlerts:0},yt=[],wu=40,gn={whaleTxXrp:1e5,feeSpikeMultiple:5,botCvThreshold:.2,dexCancelAlert:.75,clusterMinSize:5},Zr=0,aa="naluxrp_widget_order",Wn="naluxrp_widget_hidden",_n=null,_t=!1,Fr=!1,el=!0;function It(){return el&&X.currentPage==="dashboard"&&X.currentTab==="stream"&&!document.hidden}var Fn=[],xu=30,ku=0;function tl(){Au(),_u(),km(),Tm(),Bu(),Uu(),mm(),fm(),Xu(),Cu(),Mu(),Fm(),hm(),bm(),wm(),Hm(),Um(),jm(),It()&&ia(),Qm(),Zm(),Gm(),ef(),tf(),nf(),window.addEventListener("xrpl-connection",e=>{var n;!!((n=e==null?void 0:e.detail)!=null&&n.connected)&&Vu()}),window.addEventListener("xrpl-ledger",e=>{if(!It())return;let t=e.detail,n=Number(t.ledgerIndex||0);We.ledgersProcessed++,We.totalTx+=Number(t.txPerLedger||0),["risk-badge","risk-regime","risk-friction","risk-signalcount","landscape-badge","dexp-badge","dexP-badge","ab-badge","nft-badge","whale-badge","ss-badge","health-badge","pattern-badge"].forEach(a=>delete lo[a]),Ru(t),Ou(),Fu(),Hu(),Ku(t.latestLedger),Om(t.recentTransactions||[],n);let s=Zu(t);for(Fn.push({li:n,friction:s.friction,regime:s.regime});Fn.length>xu;)Fn.shift();hl(),!_t&&(Ys("breadcrumbs",n,1)&&dm(s.breadcrumbs),Ys("clusters",n,2)&&pm(s.clusters),Ys("narratives",n,2)&&um(s.narratives),Ys("landscape",n,3)&&gm(s),Bm(t.txTypes,s.hhi),ym(s.dexPatterns),xm(s),Sm(s),Mm(s),qm(),n-Zr>=8&&Vm(s,n))}),document.addEventListener("visibilitychange",()=>{It()?ia():vo()})}function nl(e){el=!!e,It()?ia():vo()}function V(e,t){let n=y(e);n&&(n.textContent=String(t))}function ke(e,t,n){return Math.max(t,Math.min(n,e))}function Yt(e){return e!=null&&e.length?e.reduce((t,n)=>t+n,0)/e.length:null}function go(e){if(!e||e.length<2)return null;let t=Yt(e),n=Yt(e.map(s=>(s-t)**2));return Math.sqrt(n)}function $u(e,t){return e!=null&&e.length?e.slice(Math.max(0,e.length-t)):[]}function Su(e,t){let n=[];for(let s=0;s<e.length;s++){let a=Math.max(0,s-t+1);n.push(Yt(e.slice(a,s+1)))}return n}function Qt(e,t=0){return e==null||!Number.isFinite(e)?"\u2014":`${e>=0?"\u2191":"\u2193"}${Math.abs(e).toFixed(t)}%`}function Rn(e,t=2){return e==null||!Number.isFinite(e)?"\u2014":Number(e).toFixed(t)}function Kt(e){if(e==null||!Number.isFinite(e))return"\u2014";let t=Number(e);return t===0?"0 XRP":t>=1e3?`${t.toLocaleString(void 0,{maximumFractionDigits:2})} XRP`:t>=1?`${t.toFixed(4)} XRP`:t>=.01?`${t.toFixed(5)} XRP`:`${t.toFixed(6)} XRP`}function Bn(e,t=1){if(!e)return null;let n=ke(Number(t),0,1),s=String(e).trim();if(s.startsWith("rgba("))return s;if(s.startsWith("rgb(")){let a=s.match(/^rgb\(\s*([0-9]+)\s*,\s*([0-9]+)\s*,\s*([0-9]+)\s*\)$/i);if(!a)return null;let o=ke(Number(a[1]),0,255),i=ke(Number(a[2]),0,255),r=ke(Number(a[3]),0,255);return`rgba(${o},${i},${r},${n})`}if(s[0]==="#"){let a=s.slice(1);if(a.length===3&&(a=a.split("").map(l=>l+l).join("")),a.length!==6)return null;let o=parseInt(a.slice(0,2),16),i=parseInt(a.slice(2,4),16),r=parseInt(a.slice(4,6),16);return[o,i,r].every(Number.isFinite)?`rgba(${o},${i},${r},${n})`:null}return null}function Br(e,t,n=.45){return t==null||!Number.isFinite(t)?e:e==null||!Number.isFinite(e)?t:e*(1-n)+t*n}async function Tu(e){if(typeof crypto<"u"&&crypto.subtle){let n=new TextEncoder().encode(e),s=await crypto.subtle.digest("SHA-512",n),a=new Uint8Array(s,0,32);return Array.from(a).map(o=>o.toString(16).padStart(2,"0")).join("")}let t=0x811c9dc5n;for(let n=0;n<e.length;n++)t^=BigInt(e.charCodeAt(n)),t=BigInt.asUintN(32,t*0x01000193n);return"FALLBACK-NON-CRYPTO-"+t.toString(16).padStart(8,"0").repeat(4).slice(0,44)}function Cu(){var n,s;if(Er||(Er=!0,document.getElementById("acctPeekOverlay")))return;let e=document.createElement("div");e.id="acctPeekOverlay",e.className="acct-peek-overlay",e.style.display="none",e.innerHTML=`
  ...
  `,document.body.appendChild(e);let t=()=>{e.style.display="none",e.removeAttribute("data-addr"),document.body.classList.remove("modal-open"),ps=!1,bt=!1};e.addEventListener("click",a=>{a.target===e&&t()}),(n=y("acctPeekClose"))==null||n.addEventListener("click",t),(s=y("acctPeekInspect"))==null||s.addEventListener("click",async()=>{let a=e.getAttribute("data-addr");a&&await Eu(a),t()})}function Mu(){Pr||(Pr=!0,document.addEventListener("click",e=>{var s,a;let t=(a=(s=e.target).closest)==null?void 0:a.call(s,"[data-addr]");if(!t)return;let n=t.getAttribute("data-addr");n&&(e.preventDefault(),Pu(n))}))}function Xr(e){var r,l,c;if(!e||!((r=Ee==null?void 0:Ee.window)!=null&&r.length))return null;let t=0,n=0,s=0;for(let d of Ee.window)s+=Number(d.total||0),t+=Number(((l=d.byActorCreate)==null?void 0:l.get(e))||0),n+=Number(((c=d.byActorCancel)==null?void 0:c.get(e))||0);let a=t+n;if(!a)return null;let o=a?n/a:0,i=s?a/s:null;return{create:t,cancel:n,total:a,cancelRatio:o,share:i}}function Lu(e){var o;let t=(o=vt==null?void 0:vt.acct)==null?void 0:o.get(e);if(!t||!t.intervals||t.intervals.length<6)return null;let n=Yt(t.intervals),s=go(t.intervals);return!n||s==null?null:{cv:s/n,total:t.total||0}}async function Pu(e){var i,r,l;if(!ze(e))return;let t=document.getElementById("acctPeekOverlay");if(!t)return;t.style.display="flex",t.setAttribute("data-addr",e),document.body.classList.add("modal-open"),ps=!0,bt=!0,V("acctPeekAddr",e),V("acctPeekBal","\u2026"),V("acctPeekSeq","\u2026"),V("acctPeekOwner","\u2026"),V("acctPeekFlags","\u2026");let n=y("acctPeekNote"),s=y("acctPeekCtx");n&&(n.textContent="Fetching account_info\u2026"),s&&(s.textContent="Building context\u2026");let a=vt.acct.get(e),o=((i=a==null?void 0:a.ledgers)==null?void 0:i.length)||0;try{if(!X.wsConn||X.wsConn.readyState!==1){n&&(n.textContent="Not connected to XRPL. Connect first.");return}let c=await Ae({command:"account_info",account:e,ledger_index:"validated",strict:!0}),d=(r=c==null?void 0:c.result)==null?void 0:r.account_data,u=Number((d==null?void 0:d.Balance)??NaN),p=Number.isFinite(u)?u/1e6:null;if(V("acctPeekBal",p==null?"\u2014":`${p.toLocaleString(void 0,{maximumFractionDigits:6})} XRP`),V("acctPeekSeq",(d==null?void 0:d.Sequence)??"\u2014"),V("acctPeekOwner",(d==null?void 0:d.OwnerCount)??"\u2014"),V("acctPeekFlags",(d==null?void 0:d.Flags)!=null?`0x${Number(d.Flags).toString(16)}`:"\u2014"),n){let m=[];p!=null&&p>=mu&&m.push("Large balance (whale-sized).");let f=Lu(e);f&&f.cv<.35&&f.total>10&&m.push(`Bot-like timing signal (CV ${f.cv.toFixed(2)}).`);let g=Xr(e);if(g){let w=Math.round(g.cancelRatio*100),k=g.share!=null?Math.round(g.share*100):null;m.push(`DEX activity: ${g.total} offer tx in window.`),m.push(`Creates ${g.create}, cancels ${g.cancel} (${w}% cancels).`),k!=null&&m.push(`~${k}% of window activity.`)}let h=oe.byAddr.get(e);if(h){let w=us(h.level);m.push(`Spam-defense: score ${(h.score*100).toFixed(0)}% \xB7 level L${h.level} \xB7 bond ${w.toLocaleString()} XRP.`),h.verifiedLedger!=null&&m.push(`Credential verified at ledger #${Number(h.verifiedLedger).toLocaleString()}.`)}o>=6&&m.push(`Shows up often in recent ledgers (${o} times).`),m.length||m.push("No obvious red flags from this quick read."),n.textContent=m.join(" ")}if(s){let m=(l=a==null?void 0:a.ledgers)==null?void 0:l.at(-1),f=Xr(e),g=f?`DEX window: ${f.total} (creates ${f.create}, cancels ${f.cancel})`:null,h=yt.filter(x=>x.from===e||x.to===e).slice(0,3),w=h.length?`${h.length} whale tx in session (${h.map(x=>(x.amtXrp>=1e6?(x.amtXrp/1e6).toFixed(1)+"M":(x.amtXrp/1e3).toFixed(0)+"K")+" XRP").join(", ")})`:null,k=oe.byAddr.get(e),v=k?`Spam-defense: L${k.level} \xB7 score ${Math.round(k.score*100)}%`:null;s.textContent=[m?`Last seen around ledger #${Number(m).toLocaleString()}`:"Not in recent window.",g,w,v].filter(Boolean).join(" \xB7 ")}}catch(c){n&&(n.textContent=`Lookup failed: ${String((c==null?void 0:c.message)||c)}`),s&&(s.textContent="\u2014")}}async function Eu(e){if(!ze(e))return;let t=document.querySelector('.dash-tab[data-tab="inspector"]'),n=document.getElementById("tab-inspector"),s=async()=>n&&n.style.display!=="none"?!0:(typeof window.switchTab=="function"&&t?window.switchTab(t,"inspector"):t==null||t.click(),await new Promise(o=>setTimeout(o,80)),n?n.style.display!=="none":!0);for(let o=0;o<6&&!await s();o++)await new Promise(r=>setTimeout(r,80));let a=document.getElementById("inspect-addr");a&&(a.value=e,a.focus()),await new Promise(o=>setTimeout(o,60)),typeof window.runInspect=="function"?window.runInspect():be("Inspector not ready yet.")}function Au(){De(".net-btn[data-network]").forEach(e=>{e.addEventListener("click",()=>{let t=e.getAttribute("data-network");De(".net-btn").forEach(s=>{s.classList.toggle("active",s===e),s.setAttribute("aria-pressed",String(s===e))}),vt.acct.clear(),cs.window=[],cs.totals=new Map,Ee.window=[],Ee.smoothCancelPerMin=null,Ee.smoothBurst=null,Mt.length=0,sa.clear(),Be=0,Rt=0,Ze=0,ls=0,Dt=!0,oa=0,uo=!1,ds=null,bt=!1,Jt=0,Xn=0,ra=!1;let n=y("ledgerStreamTrack");n&&(n.innerHTML="",n.style.transform="translateX(0px)"),ll(null,null),$m(),oe.byAddr.clear(),oe.selectedAddr=null,oe.selectedProof=null,bo(),ml(),Hn(null),Ki(t),ia({force:!0})})})}var na=[],Nu=8,ao=null,po=0,rs=null;function _u(){let e=document.querySelector(".dashboard-metric-grid");if(!e)return;let t=e.closest(".dashboard-metrics")||e.parentElement;t&&t.classList.add("dashboard-sticky-strip"),e.innerHTML=`
  ...
  `}function Ru(e){var g,h,w,k;let t=e.ledgerIndex?Number(e.ledgerIndex):null;V("d2-ledger-index",t?t.toLocaleString():"\u2014");let n=((g=e.latestLedger)==null?void 0:g.closeTimeSec)!=null?Number(e.latestLedger.closeTimeSec):null,s=y("d2-ledger-age");if(s&&(n!=null?(s.textContent=`${n<2?n.toFixed(2):n.toFixed(1)}s close`,s.style.color=n<=3?"#50fa7b":n<=6?"#ffb86c":"#ff6e6e"):(s.textContent="Waiting\u2026",s.style.color="")),n!=null&&(na.push(n),na.length>Nu&&na.shift(),Du()),po=Date.now(),Iu(),e.tps!=null){let v=Number(e.tps),x=y("d2-tps");x&&(x.textContent=v.toFixed(1),x.style.color=v<10?"rgba(255,255,255,.65)":v<40?"#50fa7b":v<80?"#ffb86c":"#ff6e6e");let S=y("d2-tps-trend");if(S){let T=X.tpsHistory||[],$=T.length>2?(T.slice(-10).reduce((M,N)=>M+N,0)/Math.min(T.length,10)).toFixed(1):null,P=v<10?"Low":v<40?"Normal":v<80?"High":"Peak";S.textContent=$?`${P} \xB7 avg ${$}`:P,S.style.color=v<10?"rgba(255,255,255,.55)":v<40?"#50fa7b":v<80?"#ffb86c":"#ff6e6e"}}let a=(((h=e.latestLedger)==null?void 0:h.totalTx)??e.txPerLedger)||0,o=y("d2-tx-per-ledger");o&&(o.textContent=a>0?a.toLocaleString():"\u2014",o.style.color=a<10?"rgba(255,255,255,.65)":a<150?"#50fa7b":a<400?"#ffb86c":"#ff6e6e");let i=y("d2-tx-spread");i&&a>0&&(i.textContent=a<10?"Very light":a<50?"Light":a<150?"Normal":a<400?"High volume":"Very high volume",i.style.color=a<150?"":a<400?"#ffb86c":"#ff6e6e");let r=e.avgFee!=null?Number(e.avgFee):((w=e.latestLedger)==null?void 0:w.avgFee)!=null?Number(e.latestLedger.avgFee):null;if(r!=null){let v=Math.round(r*1e6),x=y("d2-fee-value");x&&(x.textContent=Kt(r),x.style.color=v<=15?"#50fa7b":v<=50?"rgba(255,255,255,.9)":v<=200?"#ffb86c":"#ff6e6e");let S=y("d2-fee-delta");if(S)if(ao!=null){let $=r/ao;$>1.05?(S.textContent="\u2191",S.style.color="#ff6e6e",S.title=`+${(($-1)*100).toFixed(0)}% vs prev ledger`):$<.95?(S.textContent="\u2193",S.style.color="#50fa7b",S.title=`-${((1-$)*100).toFixed(0)}% vs prev ledger`):(S.textContent="\u2192",S.style.color="rgba(255,255,255,.35)",S.title="Stable vs prev ledger")}else S.textContent="";ao=r;let T=y("d2-fee-pressure");if(T){let $=v<=15?"Base fee":v<=50?`${v} drops`:v<=200?`${v} drops \xB7 Elevated`:`${v} drops \xB7 Surge`;T.textContent=$,T.style.color=v<=50?"":v<=200?"#ffb86c":"#ff6e6e"}}let l=e.successRate!=null?Number(e.successRate):((k=e.latestLedger)==null?void 0:k.successRate)!=null?Number(e.latestLedger.successRate):null;if(l!=null){let v=y("d2-success-rate");v&&(v.textContent=`${l.toFixed(1)}%`,v.style.color=l>=90?"#50fa7b":l>=75?"#ffb86c":"#ff6e6e");let x=y("d2-success-note");if(x){let S=(100-l).toFixed(1);x.textContent=l>=90?`${S}% failed \xB7 Normal`:l>=75?`${S}% failed \xB7 Watch`:`${S}% failed \xB7 Alert`,x.style.color=l>=90?"":l>=75?"#ffb86c":"#ff6e6e"}}let c=a>0?Math.min(100,a/500*100):null,d=y("d2-network-capacity"),u=y("d2-capacity-note");c!=null&&(d&&(d.textContent=`${c.toFixed(1)}%`,d.style.color=c<20?"rgba(255,255,255,.65)":c<50?"#50fa7b":c<80?"#ffb86c":"#ff6e6e"),u&&(u.textContent=c<20?"Low usage":c<50?"Moderate":c<80?"Heavy":"Near capacity",u.style.color=c<50?"":c<80?"#ffb86c":"#ff6e6e"));let p=e.txTypes||{},m=Object.entries(p).sort(([,v],[,x])=>x-v);if(m.length){let[v,x]=m[0],S=m.reduce((N,[,_])=>N+_,0)||1,T=(x/S*100).toFixed(0),$=typeof Tt<"u"?Tt:{},P=y("d2-dominant-type");P&&(P.textContent=v,P.style.color=$[v]||"rgba(255,255,255,.9)");let M=y("d2-dominance-score");if(M){let N=m[1];M.textContent=N?`${T}% \xB7 2nd: ${N[0]}`:`${T}% of txs`}}let f=y("stream-loading");f&&(f.style.display="none")}function Du(){let e=y("d2-close-sparkline");if(!e||!e.getContext)return;let t=na;if(t.length<2)return;let n=e.width,s=e.height,a=e.getContext("2d");a.clearRect(0,0,n,s);let o=Math.max(...t,4),i=Math.floor((n-(t.length-1))/t.length),r=1;t.forEach((l,c)=>{let d=Math.max(3,Math.round(l/o*(s-2))),u=c*(i+r),p=s-d,m=l<=3?"rgba(80,250,123,.80)":l<=6?"rgba(255,184,108,.80)":"rgba(255,110,110,.85)";a.fillStyle=m;let f=Math.min(2,i/2);a.beginPath(),a.moveTo(u+f,p),a.lineTo(u+i-f,p),a.quadraticCurveTo(u+i,p,u+i,p+f),a.lineTo(u+i,s),a.lineTo(u,s),a.lineTo(u,p+f),a.quadraticCurveTo(u,p,u+f,p),a.closePath(),a.fill(),c===t.length-1&&(a.fillStyle="rgba(255,255,255,.18)",a.fillRect(u,p,i,Math.min(3,d)))})}function Iu(){if(rs&&cancelAnimationFrame(rs),!It())return;let e=0,t=n=>{if(!It()){rs=null;return}if(n-e>=120){e=n;let s=y("d2-ledger-age-timer");if(s&&po>0){let a=(Date.now()-po)/1e3;s.textContent=`${a.toFixed(1)}s ago`,s.style.color=a<4?"rgba(255,255,255,.55)":a<7?"#ffb86c":"#ff6e6e",s.style.opacity=a>=7?(.6+.4*Math.sin(Date.now()/300)).toFixed(2):"1"}}rs=requestAnimationFrame(t)};rs=requestAnimationFrame(t)}function Fu(){let e=y("tx-mix");if(!e)return;let t=Object.entries(X.txMixAccum||{}).filter(([,s])=>s>0).sort(([,s],[,a])=>a-s).slice(0,10),n=t.reduce((s,[,a])=>s+a,0);n&&(e.innerHTML=t.map(([s,a])=>{let o=(a/n*100).toFixed(1),i=Tt[s]||"#6b7280";return`
      ...
      </div>`}).join(""))}var ct=class{constructor(t,n="#00fff0",s="area"){this.canvasId=t,this.canvas=y(t),this.color=n,this.mode=s}_resolveCanvas(){return this.canvas||(this.canvas=y(this.canvasId)),this.canvas}draw(t){let n=this._resolveCanvas();if(!n||!(t!=null&&t.length))return;let s=n.getContext("2d");if(!s)return;let a=n.width=n.offsetWidth||300,o=n.height=n.offsetHeight||180;if(s.clearRect(0,0,a,o),t.length<2)return;let i=Math.min(...t)*.9,r=Math.max(...t)*1.05||1,l=h=>1-(h-i)/(r-i||1),c={l:10,r:10,t:10,b:12},d=a-c.l-c.r,u=o-c.t-c.b,p=d/(t.length-1),m=t.map((h,w)=>[c.l+w*p,c.t+l(h)*u]),f=Yt(t);if(f!=null){let h=c.t+l(f)*u;s.beginPath(),s.moveTo(c.l,h),s.lineTo(c.l+d,h),s.strokeStyle="rgba(255,255,255,0.16)",s.lineWidth=1,s.stroke()}if(t.length>=gr+2){let w=Su(t,gr).map((k,v)=>[c.l+v*p,c.t+l(k)*u]);s.beginPath(),w.forEach(([k,v],x)=>x===0?s.moveTo(k,v):s.lineTo(k,v)),s.strokeStyle="rgba(255,255,255,0.22)",s.lineWidth=1.5,s.stroke()}if(this.mode==="bar"){let h=Math.max(1,p-3);t.forEach((w,k)=>{let v=(1-l(w))*u,x=c.l+k*p-h/2,S=s.createLinearGradient(0,c.t,0,c.t+u);S.addColorStop(0,this.color),S.addColorStop(1,this.color+"33"),s.fillStyle=S,s.fillRect(x,c.t+u-v,h,v)});return}let g=s.createLinearGradient(0,c.t,0,c.t+u);g.addColorStop(0,this.color+"aa"),g.addColorStop(1,this.color+"11"),s.beginPath(),m.forEach(([h,w],k)=>k===0?s.moveTo(h,w):s.lineTo(h,w)),s.lineTo(m.at(-1)[0],c.t+u),s.lineTo(m[0][0],c.t+u),s.closePath(),s.fillStyle=g,s.fill(),s.beginPath(),m.forEach(([h,w],k)=>k===0?s.moveTo(h,w):s.lineTo(h,w)),s.strokeStyle=this.color,s.lineWidth=2,s.lineJoin="round",s.stroke()}},ye={};function Bu(){ye.tps=new ct("chart-tps","#50fa7b","area"),ye.fee=new ct("chart-fee","#ffb86c","area"),ye.tps2=new ct("chart-tps2","#50fa7b","bar"),ye.fee2=new ct("chart-fee2","#ffb86c","area"),ye.dexPressure=new ct("chart-dex-pressure","#00d4ff","bar"),ye.nftMints=new ct("chart-nft-mints","#bd93f9","bar"),ye.nftBurns=new ct("chart-nft-burns","#ff5555","bar"),ye.autoBridge=new ct("chart-autobridge","#f1fa8c","bar"),ye.marketPrice=new ct("chart-market-price","#50fa7b","area"),ye.marketVol=new ct("chart-market-vol","#8be9fd","bar")}function Lt(e,t=Ft){let n=$u(e,t).filter(r=>Number.isFinite(r));if(!n.length)return{cur:null,avg:null,deltaPct:null,vol:null};let s=n.at(-1),a=Yt(n),o=go(n),i=a&&a!==0?(s-a)/a*100:null;return{cur:s,avg:a,deltaPct:i,vol:o}}function Xu(){if(kr)return;kr=!0;let e=(t,n)=>{let s=y(t);if(!s)return;let a=s.closest(".widget-card"),o=a==null?void 0:a.querySelector(".widget-header");if(!o||document.getElementById(n))return;let i=document.createElement("div");i.className="trend-mini",i.id=n,i.innerHTML=`
    ...
    `,o.appendChild(i)};e("chart-tps","tpsTrendMini"),e("chart-fee","feeTrendMini"),e("chart-tps2","tpsTrendMini2"),e("chart-fee2","feeTrendMini2")}function Qs(e,t,n,s){let a=document.getElementById(e);if(!a)return;let o=(i,r)=>{let l=a.querySelector(`[data-k="${i}"]`);l&&(l.textContent=r)};if(t.cur==null){o("now","\u2014"),o("avg","\u2014"),o("delta","\u2014"),o("sigma","\u2014");return}o("now",`${Number(t.cur).toFixed(n)}${s}`),o("avg",t.avg!=null?`${Number(t.avg).toFixed(n)}${s}`:"\u2014"),o("delta",t.deltaPct==null?"\u2014":Qt(t.deltaPct,0)),o("sigma",t.vol==null?"\u2014":`${Number(t.vol).toFixed(Math.max(0,n-1))}${s}`)}function Ou(){var n,s,a,o,i,r,l,c,d,u;(n=ye.tps)==null||n.draw(X.tpsHistory),(s=ye.fee)==null||s.draw(X.feeHistory),(a=ye.tps2)==null||a.draw(X.tpsHistory),(o=ye.fee2)==null||o.draw(X.feeHistory);let e=Lt(X.tpsHistory,Ft),t=Lt(X.feeHistory,Ft);Qs("tpsTrendMini",e,2,""),Qs("tpsTrendMini2",e,2,""),Qs("feeTrendMini",t,0,"d"),Qs("feeTrendMini2",t,0,"d"),(i=ye.dexPressure)==null||i.draw(he.dexPressure),(r=ye.nftMints)==null||r.draw(he.nftMints),(l=ye.nftBurns)==null||l.draw(he.nftBurns),(c=ye.autoBridge)==null||c.draw(he.autoBridge),(d=ye.marketPrice)==null||d.draw(he.marketPrice),(u=ye.marketVol)==null||u.draw(he.marketVol)}function Hu(){let e=y("ledger-log"),t=y("ledger-log-loading"),n=y("ledger-log-count");if(!e||!(X.ledgerLog||[]).length)return;t&&(t.style.display="none"),n&&(n.textContent=X.ledgerLog.length);let s=y("tab-network");!s||s.style.display==="none"||(e.innerHTML=`<div class="ledger-log-row log-head">
      ...
      </div>`).join(""))}var Mt=[],sa=new Set,Be=0,Zs=null,ls=0,Rt=0,Ze=0,Dt=!0,ea=0,bt=!1,oa=0,uo=!1,ds=null,Jt=0,Xn=0,ra=!1,zu=.18;function Uu(){Wu(),ju()}function Wu(){let e=y("ledgerStreamParticles");if(e){e.innerHTML="";for(let t=0;t<14;t++){let n=document.createElement("div");n.className="ledger-particle",n.style.left=Math.random()*100+"%",n.style.top=20+Math.random()*60+"%",n.style.animationDuration=6+Math.random()*8+"s",n.style.animationDelay=Math.random()*5+"s",e.appendChild(n)}}}function ju(){if(Zs)return;let e=y("ledgerStreamShell");e&&(e.addEventListener("mouseenter",()=>{bt=!0}),e.addEventListener("mouseleave",()=>{ps||(bt=!1)}));let t=y("ledgerStreamTrack");t&&t.addEventListener("click",s=>{let a=s.target.closest("article.ledger-card");if(!a)return;let o=Number(a.dataset.ledgerIndex);Number.isFinite(o)&&(s.shiftKey?ds===o?(ds=null,ps||(bt=!1),Or()):(ds=o,bt=!0,Or()):qu(o))});let n=s=>{ls||(ls=s);let a=Math.min(.05,(s-ls)/1e3);ls=s;let o=It()?y("ledgerStreamTrack"):null;if(o&&Be>0){if(Dt){let i=o.scrollWidth||0;if(i>100)Ze=Math.floor(i/2),Dt=!1,ea=0,Be>0&&(Jt=Ze/Be);else{ea++,ea>30&&(Dt=!1,ea=0),Zs=requestAnimationFrame(n);return}}if(Ze>0&&!bt&&ra){let i=Math.min(1,a/zu);Rt+=(Xn-Rt)*i,Math.abs(Xn-Rt)<.5&&(Rt=Xn);let r=Rt%Ze;o.style.transform=`translateX(${-r}px)`}if(!bt&&Math.floor(s/250)!==Math.floor((s-a*1e3)/250)){let i=Date.now(),r=o.querySelectorAll("article.ledger-card[data-arrival-ts]"),l=12e4;r.forEach(c=>{let d=i-Number(c.dataset.arrivalTs||i),u=Math.max(.52,1-d/l*.48);c.style.opacity=u.toFixed(3)})}if(oa>0){let i=Date.now()-oa>bu;al(i)}}Zs=requestAnimationFrame(n)};Zs=requestAnimationFrame(n),window.addEventListener("resize",()=>{Dt=!0})}function sl(){if(Jt<=0||Ze<=0||Be===0)return Rt;let e=y("ledgerStreamShell"),t=e&&e.offsetWidth||800,n=Jt-14,a=(Be-1)*Jt+n-t+18;a=Math.max(0,a);let i=Math.floor(Rt/Ze)*Ze+a;return i<Rt-2&&(i+=Ze),i}function al(e){if(e===uo)return;uo=e;let t=y("ledgerStreamShell");if(!t)return;let n=t.querySelector(".stream-stall-overlay");e?n||(n=document.createElement("div"),n.className="stream-stall-overlay",n.innerHTML='<span class="stream-stall-dot"></span> Waiting for ledgers\u2026',t.appendChild(n)):n==null||n.remove()}function Or(){document.querySelectorAll(".ledger-card").forEach(e=>{let t=Number(e.dataset.ledgerIndex);e.classList.toggle("ledger-card--pinned",t===ds)})}function qu(e){let t=document.querySelector('.dash-tab[data-tab="inspector"]');typeof window.switchTab=="function"&&t?window.switchTab(t,"inspector"):t==null||t.click();let n=document.getElementById("inspect-addr");n&&(n.placeholder=`Ledger #${e.toLocaleString()} \u2014 paste an address`,n.focus())}function Vu(){var t;let e=y("ledgerStreamShell");e&&(e.classList.remove("stream-reconnect-flash"),e.offsetWidth,e.classList.add("stream-reconnect-flash"),setTimeout(()=>e.classList.remove("stream-reconnect-flash"),1200),ku=((t=Fn.at(-1))==null?void 0:t.li)??0,Gu())}function Gu(){let e=document.getElementById("reconnect-banner");if(!e){e=document.createElement("div"),e.id="reconnect-banner",e.className="reconnect-banner";let s=document.querySelector(".dashboard-col-main");s&&s.prepend(e)}e.style.display="",e.innerHTML=`
    ...
    <button onclick="document.getElementById('reconnect-banner').style.display='none'"
      style="margin-left:auto;background:none;border:none;color:inherit;opacity:.5;cursor:pointer;font-size:.9rem">\u2715</button>`;let t=3,n=setInterval(()=>{let s=document.getElementById("reconnect-countdown");if(s&&(s.textContent=t),t--,t<0){clearInterval(n);let a=document.getElementById("reconnect-banner");a&&(a.style.display="none")}},4e3)}function Hr(){let e=y("ledgerStreamTrack"),t=y("ledgerStreamShell"),n=y("stream-loading");if(!e||!t)return;if(n&&(n.style.display="none"),Mt.length===0){e.innerHTML='<div style="padding:40px;opacity:.6">Waiting for ledgers\u2026</div>',Be=0,Dt=!0;return}let s=[...Mt].sort((o,i)=>o.ledgerIndex-i.ledgerIndex),a=s.map((o,i)=>il(o,{prevIndex:i>0?s[i-1].ledgerIndex:null}));e.innerHTML=a.concat(a).join(""),Be=s.length,Dt=!0,requestAnimationFrame(()=>{var i;let o=((i=y("ledgerStreamTrack"))==null?void 0:i.scrollWidth)||0;o>100&&(Ze=Math.floor(o/2),Jt=Be>0?Ze/Be:0,Xn=sl(),ra=!0,Dt=!1)})}function Ku(e){var f,g;if(!e)return;let t=Number(e.ledgerIndex??NaN);if(!Number.isFinite(t)||sa.has(t))return;sa.add(t),Mt.push(e);let n=0;if(Mt.length>yr){let h=Mt.splice(0,Mt.length-yr);h.forEach(w=>sa.delete(w.ledgerIndex)),n=h.length}oa=Date.now(),al(!1),Yu(e.avgFee!=null?Number(e.avgFee):null);let{auraClass:s,domColor:a}=Qu(e);ll(s,a);let o=y("stream-loading");o&&(o.style.display="none");let i=y("ledgerStreamTrack");if(!i)return;if(Be===0){Hr();return}let r=Mt.length>=2?Mt[Mt.length-2].ledgerIndex:0;if(t<r){Hr();return}let l=Be,c=il(e),d=document.createElement("template");d.innerHTML=c;let u=d.content.firstElementChild,p=i.children[l];p?i.insertBefore(u,p):i.appendChild(u);let m=document.createElement("template");if(m.innerHTML=c,i.appendChild(m.content.firstElementChild),Be=l+1,n>0){for(let w=0;w<n;w++)(f=i.children[0])==null||f.remove();let h=Be-n;for(let w=0;w<n;w++)(g=i.children[h])==null||g.remove();Be-=n}Dt=!0,requestAnimationFrame(()=>{Jt<=0&&Ze>0&&Be>0&&(Jt=Ze/Be),Xn=sl(),ra=!0})}var On=[],Ju=20;function Yu(e){e==null||!Number.isFinite(e)||(On.push(e),On.length>Ju&&On.shift())}function ol(){return On.length===0?null:On.reduce((e,t)=>e+t,0)/On.length}function il(e,t={}){let{ledgerIndex:n,closeTimeSec:s,totalTx:a,txTypes:o,avgFee:i}=e,r=o||{},l=a??0,c=Object.entries(r).sort(([,D],[,R])=>R-D)[0],d=(c==null?void 0:c[0])||"Other",u=rl(d),p=typeof Tt<"u"?Tt:{},m=D=>p[D]||"#6b7280",f=m(d),g=Bn(f,.45)||f,h=Bn(f,.14)||f,w=s==null?"\u2014":s<2?`${Number(s).toFixed(2)}s`:`${Number(s).toFixed(1)}s`,k=l>0&&s>0?(l/s).toFixed(1):null,v=i!=null?Number(i):null,x=v!=null?Kt(v):"\u2014",S=ol(),T=v!=null&&S!=null&&v>S*3,$=t.prevIndex!=null?Number(n)-t.prevIndex-1:0,P=$>0?`<div class="stream-gap-badge" title="${$} ledger(s) missing">\xB7\xB7\xB7&nbsp;${$} gap</div>`:"",M=D=>l>0?`${(D/l*100).toFixed(1)}%`:"0%",N=(D,R,F)=>R?`<div class="ledger-type-row">
      <span class="ledger-type-label cut">${b(D)}</span>
    ...
    data-arrival-ts="${O}"
    style="border-color:${g};box-shadow:0 0 22px ${h};flex-shrink:0">
    <div class="ledger-card-inner">
      <div class="ledger-card-header">
        <span class="ledger-id">#${(n||0).toLocaleString()}</span>
        <div class="ledger-meta">
          <span class="ledger-tag cut" style="border-color:${g};color:${f}">${b(d)}</span>
  ...
  </article>`}function rl(e){let t=String(e||"");return t==="Payment"?"payment":t.startsWith("Offer")?"offer":t.startsWith("NFToken")?"nft":t==="TrustSet"?"trust":t.startsWith("AMM")?"amm":"other"}function Qu(e){var o;let n=((o=Object.entries(e.txTypes||{}).sort(([,i],[,r])=>r-i)[0])==null?void 0:o[0])||"Other",s=rl(n),a=Tt[n]||Tt.Other||"#6b7280";return{dominantTx:n,auraClass:s,domColor:a}}function ll(e,t){let n=y("ledgerStreamShell");if(!n)return;if(!e||!t){n.style.removeProperty("--streamTintStrong"),n.style.removeProperty("--streamTintSoft"),n.style.removeProperty("--streamTintBorder");return}let s=Bn(t,.16)||"rgba(0,255,240,0.14)",a=Bn(t,.06)||"rgba(0,255,240,0.06)",o=Bn(t,.22)||"rgba(0,255,240,0.22)";n.style.setProperty("--streamTintStrong",s),n.style.setProperty("--streamTintSoft",a),n.style.setProperty("--streamTintBorder",o),n.dataset.tint=e}function Zu(e){var h,w;let t=Array.isArray(e.recentTransactions)?e.recentTransactions.slice(0,uu):[],n=e.txTypes||{},s=Number(e.ledgerIndex||0),a=Object.values(n).reduce((k,v)=>k+v,0)||1,o=0;for(let k of Object.values(n)){let v=k/a;o+=v*v}let i=em(t);tm(cs,i);let r=nm(cs.totals,i),l=sm(cs.totals),c=am(s,t),d=om(s,(h=e.latestLedger)==null?void 0:h.closeTimeSec,t),u=im({txs:t,txTypes:n,dexPatterns:d}),p=r.filter(k=>k.count>=2).length,m=rm({hhi:o,repeats:p,dex:d,bots:((w=c.bots)==null?void 0:w.length)||0,advanced:u}),f=lm({friction:m,tps:Lt(X.tpsHistory),fee:Lt(X.feeHistory)}),g=cm({s:e,txTypes:n,hhi:o,dexPatterns:d,behavior:c,friction:m,regime:f,breadcrumbs:r,clusters:l,advanced:u});return{s:e,txs:t,txTypes:n,hhi:o,behavior:c,dexPatterns:d,friction:m,regime:f,breadcrumbs:r,clusters:l,narratives:g,advanced:u}}function em(e){let t=new Map;for(let n of e){let s=n==null?void 0:n.account,a=n==null?void 0:n.destination;if(!s||!a)continue;let o=`${s}|${a}`;t.set(o,(t.get(o)||0)+1)}return t}function tm(e,t){e.window.unshift(t);for(let[n,s]of t.entries())e.totals.set(n,(e.totals.get(n)||0)+s);for(;e.window.length>e.maxLedgers;){let n=e.window.pop();for(let[s,a]of n.entries()){let o=(e.totals.get(s)||0)-a;o<=0?e.totals.delete(s):e.totals.set(s,o)}}}function nm(e,t){let s=[...e.entries()].map(([o,i])=>({k:o,c:i})).sort((o,i)=>i.c-o.c).filter(o=>o.c>=2);return(s.length?s:[...t.entries()].map(([o,i])=>({k:o,c:i}))).slice(0,10).map(({k:o,c:i})=>{let[r,l]=o.split("|");return{from:r,to:l,count:i}})}function sm(e){let t=[...e.entries()].filter(([,i])=>i>=2),n=t.length?t:[...e.entries()],s=new Map;for(let[i]of n){let[r,l]=i.split("|");!r||!l||(s.has(r)||s.set(r,new Set),s.has(l)||s.set(l,new Set),s.get(r).add(l),s.get(l).add(r))}let a=new Set,o=[];for(let i of s.keys()){if(a.has(i))continue;let r=[i],l=[];for(a.add(i);r.length;){let u=r.pop();l.push(u);for(let p of s.get(u)||[])a.has(p)||(a.add(p),r.push(p))}if(l.length<2)continue;let c=l[0],d=-1;for(let u of l){let p=(s.get(u)||new Set).size;p>d&&(d=p,c=u)}o.push({members:l,size:l.length,hub:c})}return o.sort((i,r)=>r.size-i.size),o.slice(0,6)}function am(e,t){let n=new Map;for(let a of t){let o=a==null?void 0:a.account;o&&n.set(o,(n.get(o)||0)+1)}for(let[a,o]of n.entries()){vt.acct.has(a)||vt.acct.set(a,{ledgers:[],intervals:[],total:0});let i=vt.acct.get(a),r=i.ledgers.at(-1);i.ledgers.push(e),r!=null&&e>r&&i.intervals.push(e-r),i.ledgers.length>30&&i.ledgers.shift(),i.intervals.length>29&&i.intervals.shift(),i.total+=o}let s=[];for(let[a,o]of vt.acct.entries()){if(o.intervals.length<6)continue;let i=Yt(o.intervals),r=go(o.intervals);if(!i||r==null)continue;let l=r/i;l<.35&&o.total>10&&s.push({acct:a,cv:l,total:o.total})}if(s.sort((a,o)=>a.cv-o.cv||o.total-a.total),e%50===0)for(let[a,o]of vt.acct){let i=o.ledgers.at(-1)??e;e-i>1e3&&vt.acct.delete(a)}return{bots:s.slice(0,6),uniqueActors:n.size}}function om(e,t,n){var P;let s=0,a=0,o=new Map,i=new Map,r=new Map;for(let M of n){let N=M==null?void 0:M.type,_=M==null?void 0:M.account;_&&(N==="OfferCreate"?(s+=1,o.set(_,(o.get(_)||0)+1),i.set(_,(i.get(_)||0)+1)):N==="OfferCancel"&&(a+=1,o.set(_,(o.get(_)||0)+1),r.set(_,(r.get(_)||0)+1)))}let l=s+a,c=l?a/l:0,d=t!=null&&Number(t)>0?a/Number(t)*60:null;for(Ee.smoothCancelPerMin=Br(Ee.smoothCancelPerMin,d,.45),Ee.window.unshift({li:e,closeTimeSec:t??null,create:s,cancel:a,total:l,cancelRatio:c,cancelsPerMin:Ee.smoothCancelPerMin,byActor:o,byActorCreate:i,byActorCancel:r});Ee.window.length>fu;)Ee.window.pop();let u={create:0,cancel:0,total:0},p=new Map,m=new Map,f=new Map;for(let M of Ee.window){u.create+=M.create,u.cancel+=M.cancel,u.total+=M.total;for(let[N,_]of M.byActor.entries())p.set(N,(p.get(N)||0)+_);for(let[N,_]of M.byActorCancel.entries())m.set(N,(m.get(N)||0)+_);for(let[N,_]of M.byActorCreate.entries())f.set(N,(f.get(N)||0)+_)}let g=oo(p,5),h=oo(m,5),w=oo(f,5),k=u.total?(((P=g[0])==null?void 0:P.count)||0)/u.total:0,v=0;if(u.total)for(let M of p.values()){let N=M/u.total;v+=N*N}let x=Ee.window.map(M=>M.total).filter(Number.isFinite),S=Yt(x)||0,T=S>0?(l-S)/S*100:null;Ee.smoothBurst=Br(Ee.smoothBurst,T,.4);let $=[];return u.total>=no&&c>=.65&&$.push("Lots of cancels (looks like quote-stuffing/spam)"),u.total>=no&&k>=.35&&$.push("One actor dominates DEX activity"),u.total>=no&&(Ee.smoothCancelPerMin||0)>=18&&$.push("Fast cancelling (high churn)"),Ee.smoothBurst!=null&&Math.abs(Ee.smoothBurst)>=45&&$.push("Sudden DEX burst"),{now:{li:e,create:s,cancel:a,total:l,cancelRatio:c,cancelsPerMin:Ee.smoothCancelPerMin},window:{...u,cancelRatio:u.total?u.cancel/u.total:0},topShare:k,actorHHI:v,burstPct:Ee.smoothBurst,topActor:g,topCanceller:h,topMaker:w,signals:$}}function oo(e,t){return[...e.entries()].sort((n,s)=>s[1]-n[1]).slice(0,t).map(([n,s])=>({acct:n,count:s}))}function im({txs:e,txTypes:t,dexPatterns:n}){var H;let s=Number((t==null?void 0:t.OfferCreate)||0)+Number((t==null?void 0:t.OfferCancel)||0),a=Number((t==null?void 0:t.NFTokenMint)||0),o=Number((t==null?void 0:t.NFTokenBurn)||0),i=0,r=new Map,l=new Map;for(let A of e){if((A==null?void 0:A.type)!=="Payment")continue;let U=(A==null?void 0:A.paths)||(A==null?void 0:A.Paths),Q=Array.isArray(U)&&U.length>0,ae=(A==null?void 0:A.sendmax)!=null||(A==null?void 0:A.SendMax)!=null,ce=(A==null?void 0:A.delivermax)!=null||(A==null?void 0:A.DeliverMax)!=null;if(!(Q||ae||ce))continue;i+=1;let ne=A==null?void 0:A.account,fe=A==null?void 0:A.destination;if(ne&&r.set(ne,(r.get(ne)||0)+1),ne&&fe){let K=`${ne}|${fe}`;l.set(K,(l.get(K)||0)+1)}}let c=[...r.entries()].sort((A,U)=>U[1]-A[1]).slice(0,5).map(([A,U])=>({acct:A,count:U})),d=[...l.entries()].sort((A,U)=>U[1]-A[1]).slice(0,5).map(([A,U])=>{let[Q,ae]=A.split("|");return{from:Q,to:ae,count:U}}),u=(H=n==null?void 0:n.now)!=null&&H.total?Math.round((n.now.cancelRatio||0)*100):0,p=(n==null?void 0:n.topShare)!=null?Math.round(n.topShare*100):0,m=e.filter(A=>(A==null?void 0:A.type)==="Payment").map(A=>typeof(A==null?void 0:A.amountXrp)=="number"?A.amountXrp:null).filter(A=>A!=null&&A>0&&Number.isFinite(A)),f=[100,1e3,1e4],g=m.filter(A=>f.some(U=>Math.abs(A%U)<1e-9&&A/U>=1)).length,h=m.length>=5?Math.round(g/m.length*100):null,w=e.filter(A=>(A==null?void 0:A.type)==="Payment"&&(A==null?void 0:A.account)&&(A==null?void 0:A.destination)&&A.account===A.destination).length,k=Number((t==null?void 0:t.AMMCreate)||0),v=Number((t==null?void 0:t.AMMDeposit)||0),x=Number((t==null?void 0:t.AMMWithdraw)||0),S=Number((t==null?void 0:t.AMMVote)||0),T=Number((t==null?void 0:t.AMMBid)||0),$=Number((t==null?void 0:t.AMMDelete)||0),P=k+v+x+S+T+$,M=v-x,N=v+x>0?Math.round(v/(v+x)*100):null,_=new Set;for(let A of e)["AMMCreate","AMMDeposit","AMMWithdraw","AMMVote","AMMBid"].includes(A==null?void 0:A.type)&&(A!=null&&A.account)&&_.add(A.account);let O=_.size,D=0,R=0;for(let A of e)(A==null?void 0:A.type)==="Payment"&&Array.isArray(A==null?void 0:A.paths)&&A.paths.length>0&&(D+=A.paths.length,R++);let F=R>0?(D/R).toFixed(1):null;return{offerTotal:s,dexCancelPct:u,dexTopSharePct:p,mints:a,burns:o,pathPays:i,topPathActors:c,topPathPairs:d,roundnessIdx:h,selfTradeCount:w,ammCreate:k,ammDeposit:v,ammWithdraw:x,ammVote:S,ammBid:T,ammDelete:$,lpTotal:P,lpNetFlow:M,lpRatio:N,lpUniqueActors:O,avgPathDepth:F}}function rm({hhi:e,repeats:t,dex:n,bots:s,advanced:a}){var w,k;let o=ke((e-.22)/.25,0,1)*22,i=ke((t-2)/6,0,1)*12,r=((w=n==null?void 0:n.window)==null?void 0:w.cancelRatio)??0,l=(n==null?void 0:n.topShare)??0,c=((k=n==null?void 0:n.now)==null?void 0:k.cancelsPerMin)??0,d=ke((r-.5)/.5,0,1)*18,u=ke((l-.25)/.5,0,1)*18,p=ke(c/25,0,1)*10,m=ke(s/6,0,1)*10,f=(a==null?void 0:a.roundnessIdx)!=null?ke((a.roundnessIdx-30)/40,0,1)*8:0,g=(a==null?void 0:a.selfTradeCount)>0?Math.min(8,a.selfTradeCount*4):0,h=(a==null?void 0:a.pathPays)!=null?ke(a.pathPays/30,0,1)*6:0;return Math.round(o+i+d+u+p+m+f+g+h)}function lm({friction:e,tps:t,fee:n}){let s=(n==null?void 0:n.deltaPct)!=null&&Math.abs(n.deltaPct)>=35,a=(t==null?void 0:t.deltaPct)!=null&&Math.abs(t.deltaPct)>=25;return e>=75?"Manipulated":s||a?"Stressed":((t==null?void 0:t.cur)??0)>=12||((t==null?void 0:t.avg)??0)>=10?"Active":"Quiet"}function cm({s:e,txTypes:t,hhi:n,dexPatterns:s,behavior:a,friction:o,regime:i,breadcrumbs:r,clusters:l,advanced:c}){var w,k,v,x,S;let d=[],u=Lt(X.tpsHistory,Ft),p=Lt(X.feeHistory,Ft),m=((w=Object.entries(t||{}).sort(([,T],[,$])=>$-T)[0])==null?void 0:w[0])||"\u2014",f=Number(e.txPerLedger||0);d.push({sentiment:i==="Manipulated"||i==="Stressed"?"warn":i==="Active"?"up":"ok",title:`Overall: ${i} \xB7 Risk score ${o}/100`,detail:"Heuristic score from concentration, repeats, DEX churn, bot-like timing, and routing indicators. It's a signal, not proof."}),d.push({sentiment:"ok",title:`Ledger snapshot: #${Number(e.ledgerIndex||0).toLocaleString()} \xB7 ${f} tx \xB7 most common: ${m}`,detail:`TPS ${Rn(u.cur,2)} (avg ${Rn(u.avg,2)} \xB7 ${Qt(u.deltaPct,0)}). Fee ${p.cur!=null?Kt(p.cur):"\u2014"} (avg ${p.avg!=null?Kt(p.avg):"\u2014"} \xB7 ${Qt(p.deltaPct,0)}).`});let g=n>=.35?"high":n>=.25?"medium":"low";if(d.push({sentiment:n>=.35?"warn":"ok",title:`Transaction mix: ${g} concentration (HHI ${n.toFixed(2)})`,detail:n>=.35?"A few tx types dominate. Patterns look \u201Cstronger,\u201D but can be misleading.":"Mix is broad. Strong signals usually come from behavior, not just tx type."}),s.window.total){let T=Math.round(s.window.cancelRatio*100),$=Math.round(s.topShare*100);d.push({sentiment:s.signals.length?"warn":"ok",title:`DEX monitor: ${s.window.total} offer tx (window) \xB7 cancels ${T}% \xB7 top actor ~${$}%`,detail:s.signals.length?`Signals: ${s.signals.join(" \xB7 ")}`:"No strong DEX-pattern signals right now.",addr:((k=s.topActor[0])==null?void 0:k.acct)||null})}let h=r.filter(T=>T.count>=2).length;if(h>=2&&d.push({sentiment:"new",title:`Repeating counterparties: ${h} recurring pair(s)`,detail:"Repeated interactions can be routing loops, bots, or coordinated flows. Click addresses for a quick read."}),l!=null&&l.length&&((v=l[0])==null?void 0:v.size)>=3&&d.push({sentiment:"new",title:`Cluster forming: ${l[0].size} wallets \xB7 hub ${W(l[0].hub)}`,detail:"Clusters are co-activity groups (not identity proof). Use as \u201Clikely related behavior.\u201D",addr:l[0].hub}),(x=a.bots)!=null&&x.length){let T=a.bots[0];d.push({sentiment:"warn",title:`Bot-like timing: ${a.bots.length} candidate(s)`,detail:`Low variance in repeated appearances. Top: ${W(T.acct)} (CV ${T.cv.toFixed(2)}).`,addr:T.acct})}if(c!=null&&c.pathPays){let T=(S=c.topPathActors)==null?void 0:S[0];d.push({sentiment:c.pathPays>=18?"warn":"ok",title:`Autobridge-ish routing: ${c.pathPays} path payments (ledger sample)`,detail:T?`Most active routing wallet: ${W(T.acct)} (${T.count}).`:"Paths/SendMax/DeliverMax appear frequently in the sample.",addr:(T==null?void 0:T.acct)||null})}return c!=null&&c.selfTradeCount&&d.push({sentiment:"warn",title:`Self-transfer signal: ${c.selfTradeCount} payment(s) where sender = receiver`,detail:"Self-transfers can be benign (housekeeping) or used to fake activity. Treat as a watch signal."}),((c==null?void 0:c.roundnessIdx)??0)>=45&&d.push({sentiment:"warn",title:`Round-number bias: ${c.roundnessIdx}% of payments are exact multiples of 100/1,000/10,000`,detail:"Round-number bias often shows scripted behavior (bots) rather than human payments."}),d.slice(0,12)}function dm(e){let t=y("d2-breadcrumb-list"),n=y("d2-breadcrumb-meta");if(!t)return;if(!e.length){t.innerHTML='<div class="gateway-item" style="opacity:.6">Watching for repeated interactions\u2026</div>',n&&(n.textContent="\u2014");return}let s=e.filter(a=>a.count>=2).length;n&&(n.textContent=s?`${s} repeats`:"Top interactions"),t.innerHTML=e.slice(0,10).map(a=>`
    <div class="gateway-item gateway-row">
      <div class="gateway-left mono cut">
        <button class="addr-link mono cut gw-from" data-addr="${b(a.from)}">${b(W(a.from))}</button>
        <span class="gw-arrow">\u2192</span>
        <button class="addr-link mono cut gw-to" data-addr="${b(a.to)}">${b(W(a.to))}</button>
      </div>
      <span class="gw-count">${a.count}\xD7</span>
    </div>`).join("")}function pm(e){let t=y("d2-cluster-list"),n=y("d2-cluster-persistence");if(t){if(!e.length){t.innerHTML='<div class="gateway-item" style="opacity:.6">Building clusters\u2026 (needs repeated activity)</div>',n&&(n.textContent="\u2014");return}n&&(n.textContent=`${e.length} group${e.length!==1?"s":""}`),t.innerHTML=e.slice(0,6).map((s,a)=>{let i=`hsl(${(a*67+120)%360},70%,60%)`,r=s.members.slice(0,4);return`
      <div class="gateway-item cluster-item">
        ...
        <div class="cluster-preview">
          ...
          <button class="addr-chip mono" data-addr="${b(s.hub)}">${b(W(s.hub))}</button>
        </div>
        <div class="cluster-preview">
          <span class="cluster-chip-h">Members:</span>
          ${r.map(l=>`<button class="addr-chip mono" data-addr="${b(l)}">${b(W(l))}</button>`).join("")}
          ${s.members.length>r.length?`<span class="cluster-more">+${s.members.length-r.length}</span>`:""}
        </div>
      </div>`}).join("")}}function um(e){let t=y("d2-delta-narratives");if(!t)return;if(!e.length){t.innerHTML='<div class="gateway-item" style="opacity:.6">Building baseline \u2014 narratives appear after 1\u20132 ledgers\u2026</div>';return}let n={up:"#50fa7b",down:"#ff5555",new:"#00d4ff",warn:"#ffb86c",ok:"rgba(255,255,255,.85)"};t.innerHTML=e.map(s=>{let a=n[s.sentiment]||"rgba(255,255,255,.85)",o=s.addr&&ze(s.addr)?`<button class="addr-link narrative-addr" data-addr="${b(s.addr)}">Peek</button>`:"";return`
  ...
  `,e.prepend(t)}function gm(e){var k,v,x,S,T,$,P,M,N,_,O,D,R,F,H;let t=y("landscape-badge");t&&(t.textContent=`${e.regime} \xB7 Risk ${e.friction}/100`);let n=e.s,s=e.txTypes||{},a=((k=Object.entries(s).sort(([,A],[,U])=>U-A)[0])==null?void 0:k[0])||"\u2014",o=Lt(X.tpsHistory,Ft),i=Lt(X.feeHistory,Ft),r=e.dexPatterns,l=(v=r==null?void 0:r.window)!=null&&v.total?Math.round(r.window.cancelRatio*100):0,c=y("landscape-text");if(c){let A=Number(n.ledgerIndex||0).toLocaleString(),U=Number(n.txPerLedger||0),Q=((x=n.latestLedger)==null?void 0:x.closeTimeSec)!=null?Number(n.latestLedger.closeTimeSec).toFixed(2)+"s":"\u2014",ae=o.cur!=null?`${Rn(o.cur,2)} TPS`:"\u2014",ce=i.cur!=null?`${Kt(i.cur)} fee`:"\u2014",de=n.successRate!=null?`${Number(n.successRate).toFixed(1)}% success`:"\u2014",ne=(S=r==null?void 0:r.window)!=null&&S.total?`DEX offers are <b>${r.window.total}</b> (window), with <b>${l}% cancels</b>.`:"DEX offers look quiet right now.";c.innerHTML=`
      <b>Right now:</b> Ledger <b>#${A}</b> closed in <b>${Q}</b> with <b>${U}</b> transactions.
      Network is at <b>${ae}</b>, with <b>${ce}</b>, and <b>${de}</b>.
      Most common activity was <b>${b(a)}</b>. ${ne}
    `}let d=y("landscape-why"),u=y("landscape-watchlist"),p=y("landscape-now"),m=y("landscape-watch"),f=[],g=[],h=[];if(e.regime==="Manipulated"?h.push("Risk score is very high. Patterns like churn, loops, or single-actor dominance often correlate with manipulated activity."):e.regime==="Stressed"?h.push("The network is behaving \u201Cabnormally\u201D (spikes in TPS or fees). This can be organic bursts or bots pushing volume."):e.regime==="Active"?h.push("The network is busy. Patterns are easier to detect because there\u2019s more data per minute."):h.push("The network is quiet. Signals are weaker; a few bots can dominate a small sample."),(T=r==null?void 0:r.signals)!=null&&T.length&&h.push(`DEX churn signals: <b>${b(r.signals.join(" \xB7 "))}</b>. Heavy OfferCreate/Cancel churn can indicate quote-stuffing/spoofing-like behavior.`),(($=e.advanced)==null?void 0:$.selfTradeCount)>0&&h.push(`Detected <b>${e.advanced.selfTradeCount}</b> self-transfer payment(s) in the sample. Can be benign, but can also be used to fake activity.`),(((P=e.advanced)==null?void 0:P.roundnessIdx)??0)>=45&&h.push(`Round-number bias is high (<b>${e.advanced.roundnessIdx}%</b>). That often indicates automation rather than human behavior.`),((M=e.advanced)==null?void 0:M.pathPays)>=18&&h.push(`Path payments are heavy (<b>${e.advanced.pathPays}</b> in sample). Lots of routing can mean arbitrage bots or automated bridge traffic.`),d&&(d.innerHTML=h.map(A=>`<div class="landscape-row">${A}</div>`).join("")),f.push(`Overall mode: <b>${b(e.regime)}</b> (risk score <b>${e.friction}/100</b>).`),f.push(`Traffic: <b>${Rn(o.cur,2)}</b> TPS (avg ${Rn(o.avg,2)} \xB7 ${Qt(o.deltaPct,0)}).`),f.push(`Fees: <b>${i.cur!=null?Kt(i.cur):"\u2014"}</b> (avg ${i.avg!=null?Kt(i.avg):"\u2014"} \xB7 ${Qt(i.deltaPct,0)}).`),(N=r==null?void 0:r.window)!=null&&N.total){let A=(_=r.topActor)==null?void 0:_[0];f.push(`DEX activity: <b>${r.window.total}</b> offer tx (window) \xB7 cancels <b>${l}%</b> \xB7 churn <b>${Rn(r.now.cancelsPerMin,1)}</b>/min.`),A&&f.push(`Most active DEX wallet: <button class="addr-link mono" data-addr="${b(A.acct)}">${b(W(A.acct))}</button> (${A.count}).`)}else f.push("DEX activity: <b>quiet</b> (few OfferCreate/OfferCancel).");let w=e.breadcrumbs.filter(A=>A.count>=2).length;if(w&&g.push(`Repeating interactions: <b>${w}</b> pair(s) keep showing up.`),(D=(O=e.behavior)==null?void 0:O.bots)!=null&&D.length){let A=e.behavior.bots[0];g.push(`Bot-like timing: top candidate <button class="addr-link mono" data-addr="${b(A.acct)}">${b(W(A.acct))}</button> (CV ${A.cv.toFixed(2)}).`)}if((R=r==null?void 0:r.signals)!=null&&R.length&&g.push(`DEX signals: <b>${b(r.signals.join(" \xB7 "))}</b>`),(F=e.clusters)!=null&&F.length&&g.push(`Largest cluster: <b>${e.clusters[0].size}</b> wallets \xB7 hub <button class="addr-link mono" data-addr="${b(e.clusters[0].hub)}">${b(W(e.clusters[0].hub))}</button>.`),(H=e.advanced)!=null&&H.pathPays&&g.push(`Autobridge/path flow: <b>${e.advanced.pathPays}</b> path payments detected in sample.`),g.length||g.push("Nothing urgent stands out in the current window."),p&&(p.innerHTML=f.map(A=>`<div class="landscape-row">${A}</div>`).join("")),m&&(m.innerHTML=g.map(A=>`<div class="landscape-row">${A}</div>`).join("")),u){let A=vm(e);u.innerHTML=A.length?A.map(U=>`
        <div class="landscape-watchitem">
          <button class="addr-link mono cut" data-addr="${b(U.addr)}">${b(W(U.addr))}</button>
          <div class="landscape-watchwhy">${U.why}</div>
        </div>
      `).join(""):'<div style="opacity:.75">No clear \u201Ctop suspect\u201D yet \u2014 need a few more ledgers to build a baseline.</div>'}}function vm(e){var i,r,l,c,d,u,p,m;let t=[],n=(f,g)=>{!f||!ze(f)||t.some(h=>h.addr===f)||t.push({addr:f,why:g})};if((r=(i=e.behavior)==null?void 0:i.bots)!=null&&r.length){let f=e.behavior.bots[0];n(f.acct,`Bot-like timing (CV <span class="mono">${f.cv.toFixed(2)}</span>). High regularity is common in spam & automation.`)}let s=e.dexPatterns;if((l=s==null?void 0:s.topActor)!=null&&l.length){let f=s.topActor[0],g=s.topShare!=null?Math.round(s.topShare*100):null,h=((c=s.now)==null?void 0:c.cancelsPerMin)!=null?s.now.cancelsPerMin.toFixed(1):"\u2014";g!=null&&g>=25&&n(f.acct,`Dominates DEX activity (~<span class="mono">${g}%</span> share). Cancels/min <span class="mono">${h}</span> \u2014 watch for quote-stuffing/spoofing.`)}if((d=s==null?void 0:s.topCanceller)!=null&&d.length){let f=s.topCanceller[0];f.count>=6&&n(f.acct,`Top canceller (<span class="mono">${f.count}</span>). Heavy cancels can be a manipulation signal.`)}let a=e.breadcrumbs||[],o=a[0];if(o!=null&&o.from&&(o!=null&&o.to)){let f=a.find(g=>g.from===o.to&&g.to===o.from);f&&f.count>=3&&o.count>=3?(n(o.from,`Ping\u2011pong loop with ${W(o.to)} (<span class="mono">${o.count}\xD7</span> / <span class="mono">${f.count}\xD7</span>). Can be wash-like routing.`),n(o.to,`Ping\u2011pong loop with ${W(o.from)} (<span class="mono">${f.count}\xD7</span> / <span class="mono">${o.count}\xD7</span>).`)):o.count>=10&&n(o.from,`Repeated counterparty flow to ${W(o.to)} (<span class="mono">${o.count}\xD7</span>). Persistent repetition often indicates automation.`)}if((u=e.clusters)!=null&&u.length&&e.clusters[0].size>=3&&n(e.clusters[0].hub,`Cluster hub of <span class="mono">${e.clusters[0].size}</span> wallets. Coordination is a common feature of wash/loop tactics.`),(m=(p=e.advanced)==null?void 0:p.topPathActors)!=null&&m.length){let f=e.advanced.topPathActors[0];f.count>=6&&n(f.acct,`Heavy path\u2011payment routing (<span class="mono">${f.count}</span>). Often correlates with arbitrage bots.`)}return t.slice(0,6)}function bm(){if(Sr)return;Sr=!0;let e=document.querySelector(".dashboard-col-side");if(!e)return;let t=document.createElement("section");t.className="widget-card",t.id="dex-pattern-card",t.setAttribute("aria-label","DEX pattern monitor"),t.innerHTML=`
    <div class="widget-header">
  ...
  `,e.prepend(t)}function ym(e){var p,m;if(!document.getElementById("dex-pattern-card"))return;let t=e.window.total||0,n=t?Math.round(e.window.cancelRatio*100):0,s=t?Math.round(e.topShare*100):0;V("dexp-badge",t?`${t} offer tx \xB7 ${n}% cancels`:"Quiet");let a=y("dexp-cancel-bar");a&&(a.style.width=`${ke(n,0,100)}%`),V("dexp-cancel-val",t?`${n}%`:"\u2014");let o=y("dexp-topshare-bar");o&&(o.style.width=`${ke(s,0,100)}%`),V("dexp-topshare-val",t?`${s}%`:"\u2014");let i=e.burstPct,r=i==null?0:Math.min(100,Math.abs(i)),l=y("dexp-burst-bar");l&&(l.style.width=`${r}%`),V("dexp-burst-val",i==null?"\u2014":Qt(i,0)),V("dexp-cpm",e.now.cancelsPerMin==null?"\u2014":e.now.cancelsPerMin.toFixed(1)),V("dexp-hhi",t?e.actorHHI.toFixed(2):"\u2014"),V("dexp-totalwin",t?`${t}`:"\u2014");let c=y("dexp-signals");c&&(c.innerHTML=e.signals.length?e.signals.map(f=>`<span class="sig-pill warn">${b(f)}</span>`).join(""):'<span class="sig-pill ok">No strong DEX signals</span>');let d=y("dexp-cancellers");d&&(d.innerHTML=(p=e.topCanceller)!=null&&p.length?e.topCanceller.slice(0,5).map(f=>`
        ...
        <div class="dex-rowline">
          <button class="addr-link mono cut" data-addr="${b(f.acct)}">${b(W(f.acct))}</button>
          <span class="mono">${f.count}</span>
        </div>`).join(""):'<div style="opacity:.7">\u2014</div>')}function wm(){if(Tr)return;Tr=!0;let e=document.querySelector(".dashboard-col-main");if(!e)return;let t=document.createElement("section");t.className="widget-card",t.id="risk-card",t.setAttribute("aria-label","Risk panel"),t.innerHTML=`
    <div class="widget-header">
  ...
  `,t.querySelectorAll(".risk-box-toggle").forEach(n=>{var a;n.addEventListener("click",()=>{let o=n.getAttribute("data-target"),i=document.getElementById(o);if(!i)return;let r=n.getAttribute("aria-expanded")!=="false";n.setAttribute("aria-expanded",r?"false":"true"),i.classList.toggle("risk-collapsed",r),n.querySelector(".risk-box-chevron").textContent=r?"\u25B8":"\u25BE";try{localStorage.setItem("risk_collapsed_"+o,r?"1":"0")}catch{}});let s=n.getAttribute("data-target");try{localStorage.getItem("risk_collapsed_"+s)==="1"&&(n.setAttribute("aria-expanded","false"),(a=document.getElementById(s))==null||a.classList.add("risk-collapsed"),n.querySelector(".risk-box-chevron").textContent="\u25B8")}catch{}}),e.appendChild(t)}function xm(e){var r,l,c,d,u,p,m,f,g,h;if(!document.getElementById("risk-card"))return;V("risk-badge",`Risk ${e.friction}/100`),V("risk-regime",e.regime),V("risk-friction",`${e.friction}/100`);let t=[];e.hhi>=.35&&t.push({cls:"warn",t:"High concentration"}),e.breadcrumbs.filter(w=>w.count>=2).length>=3&&t.push({cls:"new",t:"Repeating counterparties"}),(l=(r=e.behavior)==null?void 0:r.bots)!=null&&l.length&&t.push({cls:"warn",t:"Bot-like timing"}),(d=(c=e.dexPatterns)==null?void 0:c.signals)!=null&&d.length&&t.push({cls:"warn",t:"DEX churn signals"}),((u=e.advanced)==null?void 0:u.selfTradeCount)>0&&t.push({cls:"warn",t:`Self-transfer: ${e.advanced.selfTradeCount}`}),(((p=e.advanced)==null?void 0:p.roundnessIdx)??0)>=45&&t.push({cls:"warn",t:`Round-number bias ${e.advanced.roundnessIdx}%`}),((m=e.advanced)==null?void 0:m.pathPays)>0&&t.push({cls:"warn",t:`Path flow: ${e.advanced.pathPays}`}),V("risk-signalcount",`${t.length}`);let n=y("risk-pills");n&&(n.innerHTML=t.length?t.map(w=>`<span class="sig-pill ${w.cls}">${b(w.t)}</span>`).join(""):'<span class="sig-pill ok">No elevated signals</span>');let s=y("risk-bots");if(s){let w=((f=e.behavior)==null?void 0:f.bots)||[];if(w.length){let k={};for(let x of w){let S=x.botType||"Periodic";k[S]||(k[S]=[]),k[S].push(x)}let v=["Market Maker","Arbitrage","Flood / Spam","Periodic"];s.innerHTML=v.filter(x=>k[x]).map(x=>{let S=k[x];return`<div class="bot-type-group">
          ...
          ${S.map($=>`
            ...
            ${$.botDesc?`<div class="bot-desc">${b($.botDesc)}</div>`:""}
          `).join("")}
        </div>`}).join("")}else s.innerHTML='<div style="opacity:.7;font-size:.84rem">No periodic bots detected yet</div>'}let a=y("risk-amm");if(a){let w=e.advanced||{},{ammCreate:k=0,ammDeposit:v=0,ammWithdraw:x=0,ammVote:S=0,ammBid:T=0,lpTotal:$=0,lpNetFlow:P=0,lpRatio:M,lpUniqueActors:N=0}=w;if($===0)a.innerHTML='<div style="opacity:.6;font-size:.84rem">No AMM activity in this ledger</div>';else{let _=P>0?"#50fa7b":P<0?"#ff5555":"rgba(255,255,255,.5)";a.innerHTML=`
        <div class="amm-chips">
          ${k?`<span class="amm-chip amm-create">\u{1F195} Create \xD7${k}</span>`:""}
          ${v?`<span class="amm-chip amm-dep">\u2193 Deposit \xD7${v}</span>`:""}
        ...
        <div class="risk-row"><span>Total LP ops</span><span class="mono">${$}</span></div>`}}let o=y("risk-path");if(o){let w=e.advanced||{},k=(g=w.topPathActors)==null?void 0:g[0],v=(h=w.topPathActors)==null?void 0:h[1],x=w.selfTradeCount>0?"#ff5555":"rgba(255,255,255,.5)",S=(w.roundnessIdx??0)>=45?"#ff5555":(w.roundnessIdx??0)>=25?"#ffb86c":"rgba(255,255,255,.5)";o.innerHTML=`
      ...
      ${k?`<div class="risk-row"><span>Top router</span>
        <button class="addr-link mono cut" data-addr="${b(k.acct)}">${b(W(k.acct))}</button></div>
        <div class="risk-row" style="opacity:.75"><span style="padding-left:8px">\u21B3 count</span><span class="mono">${k.count}</span></div>`:""}
      ${v?`<div class="risk-row" style="opacity:.7"><span>2nd router</span>
        <button class="addr-link mono cut" data-addr="${b(v.acct)}">${b(W(v.acct))}</button></div>`:""}
    ...
    `,e.prepend(t)}}}function $m(){he.dexPressure=[],he.nftMints=[],he.nftBurns=[],he.autoBridge=[],co.clear(),Object.keys(lo).forEach(e=>delete lo[e]),cl({offerTotal:null,dexCancelPct:null,dexTopSharePct:null,mints:null,burns:null,pathPays:null,topPathActors:[],topPathPairs:[]})}function Dn(e,t,n){for(e.push(Number(t||0));e.length>n;)e.shift()}function Sm(e){var n,s,a,o;let t=e==null?void 0:e.advanced;t&&(Dn(he.dexPressure,t.offerTotal,hu),Dn(he.nftMints,t.mints,br),Dn(he.nftBurns,t.burns,br),Dn(he.autoBridge,t.pathPays,gu),cl(t),(n=ye.dexPressure)==null||n.draw(he.dexPressure),(s=ye.nftMints)==null||s.draw(he.nftMints),(a=ye.nftBurns)==null||a.draw(he.nftBurns),(o=ye.autoBridge)==null||o.draw(he.autoBridge))}function cl(e){var t,n,s;if(document.getElementById("dex-pressure-card")&&(V("dexP-badge",e.offerTotal==null?"Waiting\u2026":`${e.offerTotal} offer tx`),V("dexP-now",e.offerTotal==null?"\u2014":e.offerTotal),V("dexP-cancel",e.dexCancelPct==null?"\u2014":`${e.dexCancelPct}%`),V("dexP-share",e.dexTopSharePct==null?"\u2014":`${e.dexTopSharePct}%`)),document.getElementById("autobridge-card")){V("ab-badge",e.pathPays==null?"Waiting\u2026":`${e.pathPays} path pays`),V("ab-now",e.pathPays==null?"\u2014":e.pathPays);let a=(t=e.topPathActors)==null?void 0:t[0];V("ab-top-actor",a?W(a.acct):"\u2014"),V("ab-pairs",(n=e.topPathPairs)!=null&&n.length?e.topPathPairs.length:"\u2014");let o=y("ab-top-pairs");o&&(o.innerHTML=(s=e.topPathPairs)!=null&&s.length?e.topPathPairs.map(i=>`
          <div class="dex-rowline">
            <span class="mono cut">${b(W(i.from))}</span>
            <span style="opacity:.7">\u2192</span>
            <span class="mono cut">${b(W(i.to))}</span>
            <span class="mono">${i.count}</span>
          </div>`).join(""):'<div style="opacity:.7">\u2014</div>')}if(document.getElementById("nft-mint-card")){let a=Number(e.mints||0)-Number(e.burns||0);V("nft-badge",e.mints==null&&e.burns==null?"Waiting\u2026":`${e.mints||0} mints \xB7 ${e.burns||0} burns`),V("nft-mints-now",e.mints==null?"\u2014":e.mints),V("nft-burns-now",e.burns==null?"\u2014":e.burns),V("nft-net-now",`${a}`)}}function ia({force:e=!1}={}){if(!It()){vo();return}Vt&&!e||(Vt&&(clearInterval(Vt),Vt=null),zr(),Vt=setInterval(()=>{It()&&zr()},vu))}function vo(){Vt&&(clearInterval(Vt),Vt=null)}async function zr(){var t,n,s,a,o,i,r,l,c,d;let e=++so;V("mkt-badge","Loading\u2026");try{let p=await fetch("https://api.exchange.coinbase.com/products/XRP-USD/candles?granularity=3600",{cache:"no-store"});if(!p.ok)throw new Error("market history failed");let m=await p.json();if(!Array.isArray(m)||m.length<10)throw new Error("no history");if(e!==so)return;let f=[...m].sort((x,S)=>Number(x[0])-Number(S[0])),g=f.map(x=>Number(x[4])).filter(Number.isFinite),h=f.map(x=>Number(x[5])).filter(Number.isFinite);he.marketPrice=g.slice(-Js),he.marketVol=h.slice(-Js);let w=he.marketPrice.at(-1),k=he.marketPrice.length>24?he.marketPrice.at(-25):he.marketPrice.at(0),v=k&&w?(w-k)/k*100:null;V("mkt-badge",w?`$${w.toFixed(4)}`:"\u2014"),V("mkt-price",w?`$${w.toFixed(4)}`:"\u2014"),V("mkt-chg",v==null?"\u2014":Qt(v,2)),V("mkt-upd",new Date().toLocaleTimeString()),(t=ye.marketPrice)==null||t.draw(he.marketPrice),(n=ye.marketVol)==null||n.draw(he.marketVol);return}catch{}try{let u=await fetch("https://api.coinpaprika.com/v1/tickers/xrp-xrp",{cache:"no-store"});if(!u.ok)throw new Error("tick failed");let p=await u.json();if(e!==so)return;let m=Number((a=(s=p==null?void 0:p.quotes)==null?void 0:s.USD)==null?void 0:a.price),f=Number((i=(o=p==null?void 0:p.quotes)==null?void 0:o.USD)==null?void 0:i.volume_24h),g=Number((l=(r=p==null?void 0:p.quotes)==null?void 0:r.USD)==null?void 0:l.percent_change_24h);Number.isFinite(m)&&(Dn(he.marketPrice,m,Js),Number.isFinite(f)&&Dn(he.marketVol,f,Js)),V("mkt-badge",Number.isFinite(m)?`$${m.toFixed(4)}`:"\u2014"),V("mkt-price",Number.isFinite(m)?`$${m.toFixed(4)}`:"\u2014"),V("mkt-chg",Number.isFinite(g)?`${g>=0?"\u2191":"\u2193"}${Math.abs(g).toFixed(2)}%`:"\u2014"),V("mkt-upd",new Date().toLocaleTimeString()),(c=ye.marketPrice)==null||c.draw(he.marketPrice),(d=ye.marketVol)==null||d.draw(he.marketVol)}catch{V("mkt-badge","Unavailable")}}function Tm(){var n,s,a,o;if(Nr)return;Nr=!0;let e=document.querySelector(".dashboard-fullwidth");if(!e){e=document.createElement("div"),e.className="dashboard-fullwidth";let i=document.querySelector(".dashboard-columns");i?i.insertAdjacentElement("afterend",e):(n=document.querySelector(".dashboard-page"))==null||n.appendChild(e)}if(document.getElementById("spam-defense-card"))return;let t=document.createElement("section");t.className="widget-card",t.id="spam-defense-card",t.setAttribute("aria-label","Spam defense"),bo(),ml(),t.innerHTML=`
  ...
  `,e.appendChild(t),(s=y("spam-copy-hash"))==null||s.addEventListener("click",()=>{var i;return Ur(((i=y("spam-proof-hash"))==null?void 0:i.textContent)||"")}),(a=y("spam-copy-json"))==null||a.addEventListener("click",()=>{var i;return Ur(((i=y("spam-proof-json"))==null?void 0:i.textContent)||"")}),(o=y("spam-print-proof"))==null||o.addEventListener("click",Im),_renderBondSim()}window._toggleBondSim=function(){let e=y("spam-sim-panel");if(!e)return;let t=e.style.display!=="none";e.style.display=t?"none":"";let n=y("spam-sim-toggle");n&&(n.style.color=t?"":"#00d4ff")};window._renderBondSim=function(){let e=document.getElementById("sim-base"),t=document.getElementById("sim-growth"),n=document.getElementById("sim-table");if(!n)return;let s=Number((e==null?void 0:e.value)||zn),a=Number((t==null?void 0:t.value)||Un),o=he.marketPrice.at(-1)??null;document.getElementById("sim-base-val")&&(document.getElementById("sim-base-val").textContent=s+" XRP"),document.getElementById("sim-growth-val")&&(document.getElementById("sim-growth-val").textContent=a+"\xD7");let i="";for(let r=0;r<=fs;r++){let l=Math.round(s*a**r),c=o?"$"+(l*o).toLocaleString(void 0,{maximumFractionDigits:0}):"",d=r<3?"#50fa7b":r<6?"#ffb86c":"#ff5555";i+=`<div style="padding:5px;border-radius:6px;background:rgba(255,255,255,.03);border:1px solid rgba(255,255,255,.07)">
    ...
    </div>`}n.innerHTML=i};async function Ur(e){try{await navigator.clipboard.writeText(String(e||"")),se("Copied")}catch{be("Copy failed (browser blocked clipboard).")}}function us(e){let t=ke(Number(e)||0,0,fs);return Math.round(zn*Un**t)}function bo(){try{let e=JSON.parse(localStorage.getItem(Yr)||"[]");oe.allowList=new Set(e)}catch{oe.allowList=new Set}}function dl(){try{localStorage.setItem(Yr,JSON.stringify([...oe.allowList]))}catch{}}function pl(e){ze(e)&&(oe.allowList.add(e),dl(),oe.byAddr.delete(e),se(`${W(e)} added to allow-list \u2014 will no longer be flagged`))}window._spamAllowAddr=pl;function ul(){try{return JSON.parse(localStorage.getItem(Jr)||"{}")}catch{return{}}}function Cm(e){try{localStorage.setItem(Jr,JSON.stringify(e))}catch{}}function ml(){let e=ul();for(let[t,n]of Object.entries(e))oe.verifiedCache.set(t,n)}window.exportSpamReputation=function(){let e=[...oe.byAddr.entries()].map(([o,i])=>({addr:o,level:i.level,strikes:i.strikes,score:+(i.score||0).toFixed(4),threatType:i.threatType||"Unknown",verified:!!i.verifiedLedger,verifiedLedger:i.verifiedLedger??null,lastSeen:i.lastSeenLedger??null})),t={v:2,network:X.currentNetwork||"xrpl-mainnet",exportedAt:new Date().toISOString(),allowList:[...oe.allowList],suspects:e,policy:{bondBaseXrp:zn,bondGrowth:Un,ratchetMax:fs}},n=new Blob([JSON.stringify(t,null,2)],{type:"application/json"}),s=URL.createObjectURL(n),a=document.createElement("a");a.href=s,a.download=`naluxrp_reputation_${new Date().toISOString().slice(0,10)}.json`,document.body.appendChild(a),a.click(),document.body.removeChild(a),URL.revokeObjectURL(s),se("Reputation list exported")};window.importSpamReputation=function(e){if(!e)return;let t=new FileReader;t.onload=n=>{var s;try{let a=JSON.parse(n.target.result);if(!a.suspects)throw new Error("Invalid format");let o=0;for(let i of a.suspects){if(!ze(i.addr))continue;let r=oe.byAddr.get(i.addr)||{};oe.byAddr.set(i.addr,{...r,level:i.level??0,strikes:i.strikes??0,score:i.score??0,threatType:i.threatType??"Unknown",verifiedLedger:i.verifiedLedger??null,lastSeenLedger:i.lastSeen??null,scoreHistory:[],signalBreakdown:{}}),o++}if((s=a.allowList)!=null&&s.length){for(let i of a.allowList)ze(i)&&oe.allowList.add(i);dl()}se(`Imported ${o} reputation entries`)}catch(a){be("Import failed: "+a.message)}},t.readAsText(e)};function Mm(e){var l,c;if(!document.getElementById("spam-defense-card"))return;let t=Am(e),n=t.reduce((d,u)=>Math.max(d,u.level),0),s=t.filter(d=>d.verified).length,a=he.marketPrice.at(-1)??null,o=t.reduce((d,u)=>d+us(u.level),0),i=a?`~$${(o*a).toLocaleString(void 0,{maximumFractionDigits:0})}`:`${o} XRP`;V("spam-count",t.length),V("spam-maxlvl",`L${n}`),V("spam-verified",s),V("spam-allowcount",oe.allowList.size),V("spam-bondusd",i),V("spam-badge",t.length?`${t.length} tracked \xB7 max L${n}`:"Quiet");let r=y("spam-list");if(r&&(t.length?r.innerHTML=t.map(d=>{let u=us(d.level),p=a?` (~$${(u*a).toFixed(0)})`:"",m=d.level>=6?"#ff5555":d.level>=3?"#ffb86c":"#50fa7b",f=d.score>=.7?"#ff5555":d.score>=.4?"#ffb86c":"#50fa7b",g={"Payment Flooder":"#ff5555","Quote Stuffer":"#ff5555","Wash Trader":"#ff5555","DEX Bot":"#ffb86c","Arb Router":"#00d4ff","Periodic Bot":"#bd93f9"}[d.threatType]||"rgba(255,255,255,.6)",h=d.verified?`<span class="spam-cred-chip">\u2714 L${d.level} verified</span>`:"",w=Lm(d.scoreHistory||[]);return`
          <div class="spam-card" data-spam-addr="${b(d.addr)}">
            <div class="spam-card-top">
              <button class="addr-link mono spam-card-addr" data-addr="${b(d.addr)}">${b(W(d.addr))}</button>
              <div class="spam-card-actions">
                <button class="spam-btn" data-action="expand"  data-spam-addr="${b(d.addr)}">\u25BE Detail</button>
                <button class="spam-btn" data-action="proof"   data-spam-addr="${b(d.addr)}">Proof</button>
                <button class="spam-btn" data-action="allow"   data-spam-addr="${b(d.addr)}" title="Trust this address permanently">\u2713 Allow</button>
                <button class="spam-btn spam-btn-clear" data-action="clear" data-spam-addr="${b(d.addr)}">\u2715</button>
              </div>
            </div>
            <div class="spam-card-meta">
              ...
              <span class="spam-meta-chip" style="color:${g}">${b(d.threatType)}</span>
            ...
            <div class="spam-breakdown" id="spam-bd-${b(d.addr.slice(0,10))}" style="display:none">
              ${Pm(d.breakdown,d.strikes)}
            </div>
          </div>`}).join(""):r.innerHTML=`<div class="spam-empty">No suspects flagged \u2014 allow-list has ${Qr.size} known-good entities.</div>`),mo||Em(),oe.selectedAddr){let d=oe.byAddr.get(oe.selectedAddr);d?yo(oe.selectedAddr,d,e.s.ledgerIndex).then(u=>Hn(u)):Hn(null)}((l=document.getElementById("spam-sim-panel"))==null?void 0:l.style.display)!=="none"&&((c=window._renderBondSim)==null||c.call(window))}function Lm(e){if(!(e!=null&&e.length))return"";let t=42,n=14,s=1,a=t/Math.max(1,e.length-1),o=e.map((l,c)=>`${(c*a).toFixed(1)},${(n-2-l/s*(n-4)).toFixed(1)}`).join(" "),i=e.at(-1)??0,r=i>=.7?"#ff5555":i>=.4?"#ffb86c":"#50fa7b";return`<svg width="${t}" height="${n}" xmlns="http://www.w3.org/2000/svg" style="overflow:visible">
    ...
    <circle cx="${((e.length-1)*a).toFixed(1)}" cy="${(n-2-i/s*(n-4)).toFixed(1)}"
      r="2" fill="${r}"/>
  </svg>`}function Pm(e={},t=0){let n=[{label:"Bot timing",val:e.bot??0,desc:e.botType?`Type: ${e.botType}`:"Low variance in repeated ledger appearances"},{label:"DEX dominance",val:e.dexDom??0,desc:"Share of offer tx window controlled by this address"},{label:"Cancel pattern",val:e.cancelPat??0,desc:"Heavy OfferCancel activity relative to creates"},{label:"Ping-pong loop",val:e.pingPong??0,desc:"Bidirectional repeated payments between two addresses"},{label:"Path routing",val:e.pathRoute??0,desc:"High path-payment count \u2014 common in arb bots"},{label:"Self-transfer",val:e.selfTrade??0,desc:"Payments where sender = receiver"},{label:"Round-number pay",val:e.roundPay??0,desc:"Unusual bias toward exact round-number payment amounts"}].filter(s=>s.val>.001);return n.length?`
    ...
    </div>`:'<div style="opacity:.5;font-size:.78rem;padding:6px 0">No significant signal breakdown available yet.</div>'}var mo=!1;function Em(){mo||(mo=!0,document.addEventListener("click",e=>{var a,o,i,r;let t=(o=(a=e.target).closest)==null?void 0:o.call(a,"button[data-action][data-spam-addr]");if(!t)return;let n=t.getAttribute("data-action"),s=t.getAttribute("data-spam-addr");if(s){if(n==="proof"){let l=oe.byAddr.get(s);if(!l)return;oe.selectedAddr=s;let c=y("spam-proof");if(c){c.style.display="";let d=y("spam-proof-hash");d&&(d.textContent="Computing SHA-512Half\u2026")}yo(s,l,((r=(i=X.ledgerLog)==null?void 0:i[0])==null?void 0:r.ledgerIndex)||null).then(d=>{oe.selectedProof=d,Hn(d)}).catch(d=>be("Proof build failed: "+d.message));return}if(n==="clear"){oe.byAddr.delete(s),oe.selectedAddr===s&&Hn(null),se("Cleared from session");return}if(n==="allow"){pl(s),oe.byAddr.delete(s),oe.selectedAddr===s&&Hn(null);return}if(n==="expand"){let l=s.slice(0,10),c=document.getElementById("spam-bd-"+l);if(!c)return;let d=c.style.display!=="none";c.style.display=d?"none":"",t.textContent=d?"\u25BE Detail":"\u25B4 Hide";return}}}))}function Hn(e){let t=y("spam-proof");if(!t)return;if(!e){t.style.display="none";return}t.style.display="",V("spam-proof-hash",e.hash);let n=y("spam-proof-json");n&&(n.textContent=e.canonicalJson);let s=y("spam-cred-step");s&&(s.innerHTML=`
      <div style="opacity:.9">
    ...
    `)}function Am(e){var o,i,r,l,c;oe.allowList.size||bo();let t=new Set;(((o=e.behavior)==null?void 0:o.bots)||[]).forEach(d=>t.add(d.acct)),(((i=e.dexPatterns)==null?void 0:i.topActor)||[]).forEach(d=>t.add(d.acct)),(((r=e.dexPatterns)==null?void 0:r.topCanceller)||[]).forEach(d=>t.add(d.acct)),(((l=e.dexPatterns)==null?void 0:l.topMaker)||[]).forEach(d=>t.add(d.acct)),(e.breadcrumbs||[]).forEach(d=>{t.add(d.from),t.add(d.to)}),(e.clusters||[]).forEach(d=>{t.add(d.hub),(d.members||[]).forEach(u=>t.add(u))}),(((c=e.advanced)==null?void 0:c.topPathActors)||[]).forEach(d=>t.add(d.acct));let n=Number(e.s.ledgerIndex||0)||null,s=e.txs||[],a=[];if(n&&n%50===0){let d=ta*24;for(let[u,p]of oe.byAddr)n-(p.lastSeenLedger||0)>d&&oe.byAddr.delete(u)}for(let d of t){if(!ze(d)||Qr.has(d)||oe.allowList.has(d))continue;let{score:u,breakdown:p}=_m(d,e),m=Nm(p),f=oe.byAddr.get(d)||{strikes:0,level:0,score:0,verifiedLedger:null,lastSeenLedger:null,scoreHistory:[],threatType:"Unknown",signalBreakdown:{}},g=f.strikes||0;u>=Kr?g+=1:u<=io&&(g=Math.max(0,g-1));let h=f.lastSeenLedger||n,w=n?n-h:0;if(w>ta&&u<io){let $=Math.floor(w/ta);g=Math.max(0,g-$)}let k=ke(Math.floor(g/Gr),0,fs),v=[...f.scoreHistory||[],u].slice(-10),x=oe.verifiedCache.get(d),S=f.verifiedLedger??(x==null?void 0:x.ledgerIndex)??null;S||(S=Rm(d,k,s,n),S&&Dm(d,k,n));let T={score:u,strikes:g,level:k,verifiedLedger:S,lastSeenLedger:n,scoreHistory:v,threatType:m,signalBreakdown:p};oe.byAddr.set(d,T),a.push({addr:d,score:u,strikes:g,level:k,verified:!!S,verifiedLedger:S,scoreHistory:v,threatType:m,breakdown:p})}return a.sort((d,u)=>u.level-d.level||u.score-d.score),a.slice(0,yu)}function Nm(e){let{bot:t=0,dexDom:n=0,cancelPat:s=0,pingPong:a=0,pathRoute:o=0,selfTrade:i=0,roundPay:r=0}=e,l=n+s;return t>.25&&(e.botType==="Flood / Spam"||r>.05)?"Payment Flooder":t>.2&&l>.15?"DEX Bot":l>.3&&s>.1?"Quote Stuffer":a>.1?"Wash Trader":o>.1?"Arb Router":t>.2?"Periodic Bot":"Multi-Signal"}function _m(e,t){var m,f,g,h,w;let n={bot:0,botType:null,dexDom:0,cancelPat:0,pingPong:0,pathRoute:0,selfTrade:0,roundPay:0},s=(((m=t.behavior)==null?void 0:m.bots)||[]).find(k=>k.acct===e);if(s){let k=ke((.35-s.cv)/.35,0,1);n.bot=+(.4*(.5+.5*k)).toFixed(3),n.botType=s.botType||"Periodic"}let a=t.dexPatterns,o=((g=(f=a==null?void 0:a.topActor)==null?void 0:f[0])==null?void 0:g.acct)===e&&a.topShare||0;o>0&&(n.dexDom=+(.3*ke((o-.2)/.4,0,1)).toFixed(3));let i=((a==null?void 0:a.topCanceller)||[]).find(k=>k.acct===e);i&&(n.cancelPat=+(.2*ke(i.count/20,0,1)).toFixed(3));let r=t.breadcrumbs||[],l=r.find(k=>k.from===e&&k.to===e);l&&(n.selfTrade=+(.2*ke(l.count/20,0,1)).toFixed(3));let c=r[0];if(c&&(c.from===e||c.to===e)){let k=r.find(v=>v.from===c.to&&v.to===c.from);k&&k.count>=3&&c.count>=3&&(n.pingPong=.15)}let d=(((h=t.advanced)==null?void 0:h.topPathActors)||[]).find(k=>k.acct===e);d&&(n.pathRoute=+(.15*ke(d.count/25,0,1)).toFixed(3));let u=(w=t.advanced)==null?void 0:w.roundnessIdx;return u!=null&&u>=45&&(d||s)&&(n.roundPay=+(.1*ke((u-45)/35,0,1)).toFixed(3)),{score:ke(n.bot+n.dexDom+n.cancelPat+n.pingPong+n.pathRoute+n.selfTrade+n.roundPay,0,1),breakdown:n}}function Rm(e,t,n,s){if(!(n!=null&&n.length))return null;let a=In+t;for(let o of n)if((o==null?void 0:o.account)===e){if(o.type==="EscrowCreate"&&o.destination===e){let i=typeof o.amountXrp=="number"?o.amountXrp:null,r=us(t);if(i!=null&&i>=r&&fo(o.memos).startsWith(Gt))return s}if(o.type==="Payment"&&o.destination===e&&Number(o.destinationTag)===a&&fo(o.memos).startsWith(Gt))return s}return null}async function Dm(e,t,n){var a;let s=oe.byAddr.get(e);if(s)try{let o=await yo(e,s,n),i=Gt+o.hash;if((((a=X.ledgerLog)==null?void 0:a.flatMap(c=>c.transactions||[]))||[]).some(c=>(c==null?void 0:c.account)!==e?!1:fo(c.memos).startsWith(i))){let c=ul();c[e]={ledgerIndex:n,hash:o.hash,level:t},Cm(c),oe.verifiedCache.set(e,{ledgerIndex:n,hash:o.hash}),se(`\u2714 Credential verified for ${W(e)} at L${t}`)}}catch{}}function fo(e){if(!Array.isArray(e))return"";let t=[];for(let n of e){let s=(n==null?void 0:n.Memo)||(n==null?void 0:n.memo)||null;if(!s)continue;let a=s.MemoData||s.memo_data||"";try{if(typeof a=="string"&&/^[0-9A-Fa-f]+$/.test(a)&&a.length%2===0){let o=Uint8Array.from(a.match(/../g),i=>parseInt(i,16));t.push(new TextDecoder().decode(o))}else typeof a=="string"&&t.push(a)}catch{}}return t.join(" ")}async function yo(e,t,n){let s=t.level||0,a=us(s),o=he.marketPrice.at(-1)??null,i=o?(a*o).toFixed(2):null,r={hashAlgorithm:"SHA-512Half",ratchetMax:fs,strikesToLevel:Gr,strikeUp:Kr,strikeDown:io,decayLedgers:ta,bondBaseXrp:zn,bondGrowthFactor:Un,bondRequiredXrp:a,bondRequiredUsd:i,credTagBase:In,memoPrefix:Gt,credentialTag:In+s},l={v:2,hashAlg:"SHA-512Half",network:X.currentNetwork||"xrpl-mainnet",address:e,ledgerIndex:n!=null?Number(n):null,level:s,threatType:t.threatType||"Unknown",score:Number((t.score||0).toFixed(4)),strikes:Number(t.strikes||0),signalBreakdown:t.signalBreakdown||{},credential:{destinationTag:In+s,memoFormat:Gt+"<SHA-512Half-of-this-proof>",verifiedLedger:t.verifiedLedger??null},policy:r,note:"Generated by NaluXRP Spam Defense POC. Hash uses XRPL-native SHA-512Half (first 256 bits of SHA-512). A gateway or relayer policy can require the indicated bond/credential before providing service to this address.",generatedAt:new Date().toISOString()},c=JSON.stringify(l,Object.keys(l).sort(),0),d=await Tu(c);l.credential.memoFormat=Gt+d;let u=JSON.stringify(l,null,2);return{hash:d,canonicalJson:u,level:s,policy:r,threatType:t.threatType}}function Im(){let e=oe.selectedProof;if(!e){be("Generate a proof first using the Proof button.");return}let t=oe.selectedAddr||"\u2014",n=he.marketPrice.at(-1)??null,s=e.policy.bondRequiredXrp,a=n?` (~$${(s*n).toFixed(0)} USD)`:"",o=e.hash.startsWith("FALLBACK")?'<div style="padding:8px 12px;background:#fff3cd;border:1px solid #f0ad4e;border-radius:4px;margin-bottom:12px">\u26A0 Hash is non-cryptographic (SubtleCrypto unavailable). Do NOT use for enforcement.</div>':"",i=window.open("","_blank","width=760,height=660");i.document.write(`<!DOCTYPE html><html><head>
    ...
    </body></html>`),i.document.close()}var fl=null;function Fm(){if(ro)return;ro=!0;let e=document.querySelector('[aria-label="Pattern detection"]');if(!e){e=document.createElement("section"),e.className="widget-card",e.setAttribute("aria-label","Pattern detection");let t=document.querySelector(".dashboard-col-main");if(!t)return;let n=t.querySelector(".dashboard-metrics");n?n.insertAdjacentElement("afterend",e):t.prepend(e)}e.innerHTML=`
    <div class="widget-header">
    ...
    </div>`,fl=document.getElementById("pattern-donut-canvas")}function Bm(e,t){if(!ro)return;let n=typeof Tt<"u"?Tt:{},s=Object.entries(e||{}).filter(([,m])=>m>0).sort(([,m],[,f])=>f-m);if(!s.length)return;let a=s.reduce((m,[,f])=>m+f,0)||1,[o,i]=s[0],r=Math.round(i/a*100),l=s[1],c=y("pattern-badge");c&&(c.textContent=o+" \xB7 "+r+"%");let d=y("pattern-dom-type");if(d&&(d.textContent=o,d.style.color=n[o]||"rgba(255,255,255,.9)"),V("pattern-dom-pct",r+"% of ledger"),l){let m=Math.round(l[1]/a*100),f=y("pattern-2nd-type");f&&(f.textContent=l[0]+" ("+m+"%)",f.style.color=n[l[0]]||"rgba(255,255,255,.7)")}else V("pattern-2nd-type","\u2014");let u=y("pattern-hhi");u&&t!=null&&(u.textContent=t.toFixed(3),u.style.color=t>=.35?"#ff5555":t>=.25?"#ffb86c":"#50fa7b");let p=y("pattern-donut-center");p&&(p.innerHTML='<span style="color:'+(n[o]||"#fff")+';font-size:1.15rem">'+r+"%</span>"),Xm(s,a,n)}function Xm(e,t,n){let s=fl||y("pattern-donut-canvas");if(!(s!=null&&s.getContext))return;let a=s.getContext("2d"),o=s.width/2,i=s.height/2,r=Math.min(s.width,s.height)/2-6,l=r*.56;a.clearRect(0,0,s.width,s.height);let c=e.slice(0,7),d=e.slice(7).reduce((m,[,f])=>m+f,0),u=d>0?[...c,["Other",d]]:[...c],p=-Math.PI/2;for(let[m,f]of u){let g=f/t*Math.PI*2,h=Bn(n[m]||"#6b7280",.88)||"#6b7280";a.beginPath(),a.moveTo(o+Math.cos(p)*l,i+Math.sin(p)*l),a.arc(o,i,r,p,p+g),a.arc(o,i,l,p+g,p,!0),a.closePath(),a.fillStyle=h,a.fill(),a.strokeStyle="rgba(0,8,20,0.85)",a.lineWidth=2,a.stroke(),p+=g}a.beginPath(),a.arc(o,i,l-1,0,Math.PI*2),a.fillStyle="rgba(0,21,36,0.94)",a.fill()}function Om(e,t){let n=!1;for(let s of e){if((s==null?void 0:s.type)!=="Payment")continue;let a=typeof(s==null?void 0:s.amountXrp)=="number"?s.amountXrp:null;a==null||a<gn.whaleTxXrp||(yt.unshift({ts:Date.now(),ledgerIndex:t,from:s.account||"\u2014",to:s.destination||"\u2014",amtXrp:a,hash:s.hash||""}),We.whaleCount++,n=!0)}if(n){for(;yt.length>wu;)yt.pop();zm()}}function Hm(){if(_r)return;_r=!0;let e=document.querySelector(".dashboard-col-side");if(!e)return;let t=document.createElement("section");t.className="widget-card",t.id="whale-feed-card",t.setAttribute("aria-label","Whale alert feed"),t.innerHTML=`
    <div class="widget-header">
    ...
    <div id="whale-feed-list" style="max-height:260px;overflow-y:auto">
    ...
    </div>`,e.prepend(t)}function zm(){let e=y("whale-feed-list");if(!e)return;let t=y("whale-badge");if(t&&(t.textContent=yt.length?`${yt.length} alerts`:"Watching\u2026"),!yt.length){e.innerHTML='<div style="opacity:.5;font-size:.82rem;padding:8px 0">No whale transactions yet.</div>';return}e.innerHTML=yt.slice(0,20).map(n=>{let s=n.amtXrp>=1e6?`${(n.amtXrp/1e6).toFixed(2)}M`:n.amtXrp>=1e3?`${(n.amtXrp/1e3).toFixed(0)}K`:n.amtXrp.toFixed(0),a=Math.floor((Date.now()-n.ts)/1e3),o=a<60?`${a}s`:a<3600?`${Math.floor(a/60)}m`:`${Math.floor(a/3600)}h`;return`<div style="border-bottom:1px solid rgba(255,255,255,.05);padding:7px 0">
      ...
      <div style="display:flex;gap:4px;align-items:center;font-size:.74rem">
        <button class="addr-link mono cut" data-addr="${b(n.from)}" style="max-width:100px">${b(W(n.from))}</button>
        <span style="opacity:.5">\u2192</span>
        <button class="addr-link mono cut" data-addr="${b(n.to)}" style="max-width:100px">${b(W(n.to))}</button>
    ...
    </div>`}).join("")}function Um(){if(Rr)return;Rr=!0;let e=document.querySelector(".dashboard-col-main");if(!e)return;let t=document.createElement("section");t.className="widget-card",t.id="network-health-card",t.setAttribute("aria-label","Network health"),t.innerHTML=`
    <div class="widget-header">
    ...
    <div style="display:flex;align-items:center;gap:16px;padding:8px 0 12px">
      ...
      </div>`}).join(""))}function jm(){if(Dr)return;Dr=!0;let e=document.querySelector(".dashboard-col-side");if(!e)return;let t=document.createElement("section");t.className="widget-card",t.id="session-stats-card",t.setAttribute("aria-label","Session stats"),t.innerHTML=`
    <div class="widget-header">
    ...
    </div>`,e.appendChild(t)}function qm(){if(!document.getElementById("session-stats-card"))return;let e=Math.floor((Date.now()-We.startTime)/6e4);V("ss-ledgers",We.ledgersProcessed.toLocaleString()),V("ss-tx",We.totalTx.toLocaleString()),V("ss-whales",We.whaleCount),V("ss-feespikes",We.feeSpikes),V("ss-bots",We.botDetections),V("ss-dexalerts",We.dexAlerts),V("ss-time",`${e}m`),V("ss-badge",`${We.ledgersProcessed} ledgers`)}function Vm(e,t){var o,i,r,l,c,d,u,p;if(Zr=t,yt.length&&yt[0].ledgerIndex===t){let m=yt[0],f=m.amtXrp>=1e6?`${(m.amtXrp/1e6).toFixed(1)}M`:`${(m.amtXrp/1e3).toFixed(0)}K`;se(`\u{1F40B} Whale: ${f} XRP  ${W(m.from)} \u2192 ${W(m.to)}`)}let n=ol(),s=(o=X.feeHistory)==null?void 0:o.at(-1);s&&n&&s>n*gn.feeSpikeMultiple&&(We.feeSpikes++,be(`\u{1F525} Fee spike: ${Kt(s)} (${Math.round(s/n)}\xD7 baseline)`));let a=(((i=e.behavior)==null?void 0:i.bots)||[]).filter(m=>m.cv<gn.botCvThreshold&&m.total>8);a.length&&(We.botDetections=Math.max(We.botDetections,a.length),a[0].botType==="Flood / Spam"&&be(`\u{1F916} Spam bot: ${W(a[0].acct)} (CV ${a[0].cv.toFixed(2)})`)),((l=(r=e.dexPatterns)==null?void 0:r.window)==null?void 0:l.cancelRatio)>=gn.dexCancelAlert&&((d=(c=e.dexPatterns)==null?void 0:c.window)==null?void 0:d.total)>=20&&(We.dexAlerts++,be(`\u{1F9E0} DEX: ${Math.round(e.dexPatterns.window.cancelRatio*100)}% cancel ratio \u2014 possible quote-stuffing`)),((p=(u=e.clusters)==null?void 0:u[0])==null?void 0:p.size)>=gn.clusterMinSize&&se(`\u{1F578} Cluster: ${e.clusters[0].size} wallets around ${W(e.clusters[0].hub)}`),e.friction>=75&&e.regime==="Manipulated"&&be(`\u26A0\uFE0F Risk score: ${e.friction}/100 \u2014 ${e.regime} regime`),Wm(e.s)}function Gm(){var n,s,a,o;if(Ir)return;Ir=!0;let e=document.createElement("button");e.id="customize-btn",e.className="customize-btn",e.setAttribute("aria-pressed","false"),e.innerHTML="\u2699 Customize",(n=document.querySelector(".dashboard-header"))==null||n.appendChild(e);let t=document.createElement("div");t.id="customize-panel",t.className="customize-panel",t.setAttribute("aria-label","Dashboard customizer"),t.innerHTML=`
    ...
    </div>`,document.body.appendChild(t),e.addEventListener("click",()=>Wr()),(s=document.getElementById("customize-close"))==null||s.addEventListener("click",()=>Wr(!1)),(a=document.getElementById("customize-reset"))==null||a.addEventListener("click",()=>{try{localStorage.removeItem(aa),localStorage.removeItem(Wn)}catch{}jr(),ho(),wo()}),(o=document.getElementById("customize-export"))==null||o.addEventListener("click",()=>{var i;try{let r={order:JSON.parse(localStorage.getItem(aa)||"[]"),hidden:JSON.parse(localStorage.getItem(Wn)||"[]"),alertConfig:gn};(i=navigator.clipboard)==null||i.writeText(JSON.stringify(r,null,2)),se("Config copied to clipboard")}catch{be("Export failed")}}),jr(),ho()}function Wr(e){var s;let t=document.getElementById("customize-panel"),n=document.getElementById("customize-btn");!t||!n||(hn=e??!hn,t.classList.toggle("customize-panel--open",hn),n.setAttribute("aria-pressed",String(hn)),n.textContent=hn?"\u2715 Close":"\u2699 Customize",hn&&wo(),(s=document.querySelector(".dashboard-col-side"))==null||s.classList.toggle("customize-mode",hn))}function ms(){var e;return[...((e=document.querySelector(".dashboard-col-side"))==null?void 0:e.querySelectorAll(":scope > .widget-card"))||[]]}function jn(e){return e.id||e.getAttribute("aria-label")||""}function Km(e){var t,n;return((n=(t=e.querySelector(".widget-title"))==null?void 0:t.textContent)==null?void 0:n.trim())||jn(e)}function jr(){let e=document.querySelector(".dashboard-col-side");if(!e)return;let t;try{t=JSON.parse(localStorage.getItem(aa)||"null")}catch{t=null}if(!Array.isArray(t)||!t.length)return;let n=new Map(ms().map(s=>[jn(s),s]));t.forEach(s=>{let a=n.get(s);a&&e.appendChild(a)})}function ho(){let e;try{e=JSON.parse(localStorage.getItem(Wn)||"[]")}catch{e=[]}ms().forEach(t=>t.classList.toggle("widget-hidden",e.includes(jn(t))))}function Jm(){try{localStorage.setItem(aa,JSON.stringify(ms().map(e=>jn(e))))}catch{}}function Ym(e){let t;try{t=JSON.parse(localStorage.getItem(Wn)||"[]")}catch{t=[]}t=t.includes(e)?t.filter(n=>n!==e):[...t,e];try{localStorage.setItem(Wn,JSON.stringify(t))}catch{}ho(),wo()}function wo(){let e=document.getElementById("customize-list");if(!e)return;let t;try{t=JSON.parse(localStorage.getItem(Wn)||"[]")}catch{t=[]}e.innerHTML="",ms().forEach(n=>{var r;let s=jn(n),a=Km(n),o=!t.includes(s),i=document.createElement("div");i.className="customize-row",i.setAttribute("draggable","true"),i.dataset.widgetId=s,i.innerHTML=`
      <span class="customize-drag-handle" title="Drag to reorder">\u283F</span>
      <span class="customize-row-title">${b(a)}</span>
      <button class="customize-vis-btn ${o?"vis-on":"vis-off"}" data-id="${b(s)}">${o?"\u{1F441} Visible":"\u{1F6AB} Hidden"}</button>`,i.addEventListener("dragstart",l=>{_n=i,l.dataTransfer.effectAllowed="move",i.classList.add("customize-dragging")}),i.addEventListener("dragend",()=>{i.classList.remove("customize-dragging"),e.querySelectorAll(".customize-row").forEach(d=>d.classList.remove("customize-over"));let l=[...e.querySelectorAll(".customize-row")].map(d=>d.dataset.widgetId),c=document.querySelector(".dashboard-col-side");if(c){let d=new Map(ms().map(u=>[jn(u),u]));l.forEach(u=>{let p=d.get(u);p&&c.appendChild(p)})}Jm()}),i.addEventListener("dragover",l=>{if(l.preventDefault(),l.dataTransfer.dropEffect="move",_n&&_n!==i){e.querySelectorAll(".customize-row").forEach(d=>d.classList.remove("customize-over")),i.classList.add("customize-over");let c=[...e.querySelectorAll(".customize-row")];c.indexOf(_n)<c.indexOf(i)?e.insertBefore(_n,i.nextSibling):e.insertBefore(_n,i)}}),i.addEventListener("dragleave",()=>i.classList.remove("customize-over")),i.addEventListener("drop",l=>l.preventDefault()),(r=i.querySelector(".customize-vis-btn"))==null||r.addEventListener("click",()=>Ym(s)),e.appendChild(i)})}function Qm(){if(Fr)return;Fr=!0;let e=document.querySelector(".dashboard-header");if(!e||document.getElementById("global-pause-btn"))return;let t=document.createElement("button");t.id="global-pause-btn",t.className="global-pause-btn",t.setAttribute("aria-pressed","false"),t.title="Pause all updates \u2014 numbers stop changing so you can read",t.innerHTML="\u23F8 Live",t.addEventListener("click",()=>{_t=!_t,t.setAttribute("aria-pressed",String(_t)),t.innerHTML=_t?"\u25B6 Paused":"\u23F8 Live",t.classList.toggle("global-pause-btn--paused",_t),bt=_t&&!ps?_t:bt;let s=document.querySelector(".dashboard-sticky-strip");s&&s.classList.toggle("metrics-paused",_t)});let n=document.getElementById("customize-btn");n?e.insertBefore(t,n):e.appendChild(t)}var qr=!1;function Zm(){if(qr)return;qr=!0;let e=(t=0)=>{let n=document.querySelector("#risk-card .widget-header"),s=document.querySelector("#landscape-card .widget-header");if(!n&&!s&&t<20){setTimeout(()=>e(t+1),300);return}if(n&&!n.querySelector(".friction-sparkline-wrap")){let a=document.createElement("div");a.className="friction-sparkline-wrap",a.title="Risk score \u2014 last 30 ledgers",a.innerHTML='<canvas id="friction-sparkline-canvas" width="80" height="22"></canvas>',n.appendChild(a)}if(s&&!s.querySelector(".friction-sparkline-wrap")){let a=document.createElement("div");a.className="friction-sparkline-wrap",a.title="Risk score history",a.innerHTML='<canvas id="friction-sparkline-canvas-2" width="60" height="18"></canvas>',s.appendChild(a)}hl()};e()}function hl(){Fn.length&&(Vr("friction-sparkline-canvas",80,22),Vr("friction-sparkline-canvas-2",60,18))}function Vr(e,t,n){let s=document.getElementById(e);if(!(s!=null&&s.getContext))return;let a=s.getContext("2d");a.clearRect(0,0,t,n);let o=Fn;if(o.length<2)return;let i=100,r=t/(o.length-1),l=o.map((g,h)=>[h*r,n-2-g.friction/i*(n-4)]),c=n-2-60/i*(n-4);a.fillStyle="rgba(255,85,85,.07)",a.fillRect(0,0,t,c);let d=a.createLinearGradient(0,0,0,n);d.addColorStop(0,"rgba(255,184,108,.35)"),d.addColorStop(1,"rgba(255,184,108,.05)"),a.beginPath(),l.forEach(([g,h],w)=>w===0?a.moveTo(g,h):a.lineTo(g,h)),a.lineTo(l.at(-1)[0],n),a.lineTo(0,n),a.closePath(),a.fillStyle=d,a.fill();let u=o.at(-1).friction,p=u<26?"#50fa7b":u<61?"#ffb86c":"#ff5555";a.beginPath(),l.forEach(([g,h],w)=>w===0?a.moveTo(g,h):a.lineTo(g,h)),a.strokeStyle=p,a.lineWidth=1.5,a.lineJoin="round",a.stroke();let[m,f]=l.at(-1);a.beginPath(),a.arc(m,f,2.5,0,Math.PI*2),a.fillStyle=p,a.fill()}window.printLandscapeReport=function(){var i,r,l,c;if(!document.getElementById("landscape-card"))return;let t=((i=document.getElementById("d2-ledger-index"))==null?void 0:i.textContent)||"\u2014",n=((r=document.getElementById("landscape-badge"))==null?void 0:r.textContent)||"",s=new Date().toLocaleString(),a=window.open("","_blank","width=860,height=700");a.document.write(`<!DOCTYPE html><html><head>
  ...
  `,e.appendChild(t);let n=s=>{var a;return(a=document.querySelector(`.dash-tab[data-tab="${s}"]`))==null?void 0:a.click()};t.addEventListener("click",s=>{let a=s.target.closest("button[data-go]");if(!a)return;let o=a.dataset.go;if(o==="stream"||o==="inspector"||o==="network"){n(o);return}n("stream"),setTimeout(()=>{var r;let i=o==="dex"?"dex-pattern-card":"risk-card";(r=document.getElementById(i))==null||r.scrollIntoView({behavior:"smooth",block:"start"})},80)})}function tf(){var a,o;if(Mr)return;Mr=!0;let e=document.querySelector(".dashboard-header");if(!e||document.getElementById("compactToggleBtn"))return;let t=document.createElement("button");t.id="compactToggleBtn",t.type="button",t.className="dash-accordion-toggle",t.textContent="Compact: OFF",e.appendChild(t);let n=(i,r=!0)=>{if(document.body.classList.toggle("dash-accordion",i),t.textContent=i?"Compact: ON":"Compact: OFF",r)try{localStorage.setItem(vr,i?"1":"0")}catch{}if(i){let l=document.querySelector(".dashboard-col-side .widget-card");l&&l.classList.add("is-open")}else document.querySelectorAll(".dashboard-col-side .widget-card.is-open").forEach(l=>l.classList.remove("is-open"))},s=null;try{s=localStorage.getItem(vr)}catch{}n(s==="1"?!0:s==="0"?!1:((o=(a=window.matchMedia)==null?void 0:a.call(window,"(max-width: 600px)"))==null?void 0:o.matches)??!1,!1),t.addEventListener("click",()=>n(!document.body.classList.contains("dash-accordion"),!0))}function nf(){if(Lr)return;Lr=!0;let e=document.querySelector(".dashboard-col-side");e&&e.addEventListener("click",t=>{var o,i;if(!document.body.classList.contains("dash-accordion"))return;let n=t.target;if((o=n==null?void 0:n.closest)!=null&&o.call(n,"button, a, input, textarea, select, kbd"))return;let s=(i=n==null?void 0:n.closest)==null?void 0:i.call(n,".widget-card");if(!s)return;let a=s.classList.contains("is-open");e.querySelectorAll(".widget-card.is-open").forEach(r=>{r!==s&&r.classList.remove("is-open")}),s.classList.toggle("is-open",!a)})}var Xe={lsfPasswordSpent:65536,lsfRequireDestTag:131072,lsfRequireAuth:262144,lsfDisallowXRP:524288,lsfDisableMaster:1048576,lsfNoFreeze:2097152,lsfGlobalFreeze:4194304,lsfDefaultRipple:8388608,lsfDepositAuth:16777216},gl={lsfBurnable:1,lsfOnlyXRP:2,lsfTrustLine:4,lsfTransferable:8},sf=new Set(["SetRegularKey","SignerListSet","AccountSet","AccountDelete","EscrowCreate","PaymentChannelCreate","DepositPreauth"]),vl=.55,af=.15,qn=20,of=946684800,rf=new Map([["rPVMhWBsfF9iMXYj3aAzJVkPDTFNSyWdKy",{name:"Bitstamp",type:"exchange"}],["rvYAfWj5gh67oV6fW32ZzP3Aw4Eubs59B",{name:"Bitstamp",type:"exchange"}],["rrpNnNLKrartuEqfJGpqyDwPj1BBN1ih7",{name:"Bitstamp",type:"exchange"}],["rN7n3473SaZBCG4dFL83w7PB9judJ7qdDo",{name:"Binance",type:"exchange"}],["rEb8TK3gBgk5auZkwc6sHnwrGVJH8DuaLh",{name:"Binance",type:"exchange"}],["rBKPS4oLSaV2KVVuHH8EpQqMGgGefGFQs7",{name:"Bitso",type:"exchange"}],["rfk5bwaKCoNU84fTzdqWQowqnNaZorDmiV",{name:"Gate.io",type:"exchange"}],["rGFuMiw48HdbnrUbkRYDTvT5i9imC5fvv9",{name:"Gate.io",type:"exchange"}],["rwYHCs2EYBMBvRXFmxDrCUSorPsuqCck7t",{name:"Kraken",type:"exchange"}],["rLHzPsX6oXkzU2qL12kHCH8G8cnZv1rBJh",{name:"Kraken",type:"exchange"}],["ra5nK24KXen9AHvsdFTKHSANinZseWnPcX",{name:"Uphold",type:"exchange"}],["rGWrZyax5eXbi5gs49MRZKkE9eKNL9p4B",{name:"Bittrex",type:"exchange"}],["rDsbeomae4FXwgQTJp9Rs64Qg9vDiTCdBv",{name:"Coinone",type:"exchange"}],["rHsMUQFzBb7S6GnQFVgNirqvHRcLpAn5dU",{name:"Bithumb",type:"exchange"}],["rMQ98K56yXJbDGv49ZSmW51sLn94Xe1mu1",{name:"Huobi",type:"exchange"}],["rHcFoo6a9qT5NHiVn1THwX3B4QF2VQKWZ",{name:"Huobi",type:"exchange"}],["rKiCet8SdvWxPXnAgYarFUXMh1zCPz432Y",{name:"Coinbase",type:"exchange"}],["rHb9CJAWyB4rj91VRWn96DkukG4bwdtyTh",{name:"Coinbase",type:"exchange"}],["r9mhdcT2K7FdCGDEPqfbMJwVXsXCqEr5bP",{name:"OKX",type:"exchange"}],["r32U8WFxhqEAVkKcTb1GGRR1VH2oaFdexN",{name:"OKX",type:"exchange"}],["r4GDFMLGJUKMjNEycBKPGnRSNXyNVLQLHi",{name:"Bybit",type:"exchange"}],["rBETszU65yYoFcYdRkiGqFaYmhZpHWC7sj",{name:"Bybit",type:"exchange"}],["rMWUykAmNQDaM9poSes8VLDZDDkEoutilities",{name:"KuCoin",type:"exchange"}],["rUA1S9qobBkxLqzdfGEzh5wm5KdLfbf8bx",{name:"KuCoin",type:"exchange"}],["rHtbQzmN4BDaEBnGSXp3AZaZAuZamNVsME",{name:"MEXC",type:"exchange"}],["rDN1gPWW3XQFXVJFQSiJxPHGZiRLMVSi7K",{name:"MEXC",type:"exchange"}],["rB3gZey7VWHoDokMt3tCiXBSRmaZi5xJi9",{name:"Crypto.com",type:"exchange"}],["rhub8VRN55s94qWKDv6jmDy1pUykJzF3wq",{name:"GateHub",type:"exchange"}],["razqnFn6FqBaYBdNaGnVzmGaNE6XPRQ9bG",{name:"GateHub",type:"exchange"}],["rGQdkxNBQeQC1WTQDQ2F2QoGBZxYcMxBBg",{name:"GateHub",type:"exchange"}],["rpXTzCuXtjiPDFysxq8uNmtZBe9Xo97JbW",{name:"Bitbank",type:"exchange"}],["rsuUjfWxrACCAwGQDsNeZUhpzXf1n1NK5Z",{name:"Bitbank",type:"exchange"}],["r9oxUGJqMfMEhGBxrMJnmNvVh1LKkMv7fz",{name:"Coincheck",type:"exchange"}],["rHb9CJAWyB4rj91VRWn96DkukG4bwdtyTh",{name:"Genesis (Black Hole)",type:"blackhole"}],["r9cZA1mLK5R5Am25ArfXFmqgNwjZgnfk59",{name:"Black Hole #2",type:"blackhole"}],["rHb9CJAWyB4rj91VRWn96DkukG4bwdtyTh",{name:"Genesis Wallet",type:"ripple"}],["rHb9CJAWyB4rj91VRWn96DkukG4bwdtyTh",{name:"Ripple Labs Ops",type:"ripple"}],["rPEPPER7kfTD9w2To4CQk6UCfuHM9c6GDY",{name:"XAMAN (XUMM)",type:"wallet"}],["rBj4eVRWn6mCELVTNkVFDfGNByE9VFTM3R",{name:"XAMAN",type:"wallet"}],["rHb9CJAWyB4rj91VRWn96DkukG4bwdtyTh",{name:"XRPL AMM Engine",type:"dex"}],["rsoLo2S1kiGeCcn6hCUXVrCpGMWLrRrLZz",{name:"SOLO Issuer",type:"issuer"}],["rcoreNywaoz2ZCVt2sc3JiEi7G7MpZxZgm",{name:"CORE Token",type:"issuer"}],["rhXo4TcWbLY4GqTSmscMpgZ1KMXFBi9V55",{name:"XRPL DeFi Pool",type:"issuer"}],["rHb9CJAWyB4rj91VRWn96DkukG4bwdtyTh",{name:"UNL Validator Set",type:"validator"}]]);function Kn(e){return rf.get(e)||null}var lf=null,et=!1;var Vn=null,bl=!1,ko=!0;function la(){return ko&&X.currentPage==="dashboard"&&X.currentTab==="inspector"&&!document.hidden}async function cf(e){let t=[s=>`https://corsproxy.io/?${encodeURIComponent(s)}`,s=>`https://api.allorigins.win/raw?url=${encodeURIComponent(s)}`],n=async s=>{let a=typeof(AbortSignal==null?void 0:AbortSignal.timeout)=="function"?AbortSignal.timeout(6e3):void 0,o=await fetch(s,{mode:"cors",cache:"no-store",signal:a});if(!o.ok)throw new Error(`HTTP ${o.status}`);return await o.json()};try{return await n(e)}catch{for(let s of t)try{return await n(s(e))}catch{}throw new Error("Price feed unavailable")}}async function df(){if(bl)return Vn;bl=!0;try{let e=await cf("https://api.exchange.coinbase.com/products/XRP-USD/ticker");Vn=Number((e==null?void 0:e.price)||0)||null}catch{Vn=null}return Vn}function en(e){if(!Vn||!e)return"";let t=e*Vn;return t>=1e6?` (~$${(t/1e6).toFixed(2)}M)`:t>=1e3?` (~$${(t/1e3).toFixed(1)}K)`:` (~$${t.toFixed(2)})`}var gs=null;function xl(){return gs||(gs={input:()=>document.getElementById("inspect-addr"),err:document.getElementById("inspect-err"),result:document.getElementById("inspect-result"),empty:document.getElementById("inspect-empty"),loading:document.getElementById("inspect-loading"),loadMsg:document.getElementById("inspect-loading-msg"),warn:document.getElementById("inspect-warn"),badge:document.getElementById("inspect-addr-badge"),score:document.getElementById("inspect-risk-score"),label:document.getElementById("inspect-risk-label")},gs)}function pf(){gs=null,xl()}function kl(){var t,n,s,a;wh(),xh(),kh(),(t=y("inspect-addr"))==null||t.addEventListener("keydown",o=>{o.key==="Enter"&&Gn()}),(n=y("inspect-addr"))==null||n.addEventListener("paste",()=>{setTimeout(()=>{var i;let o=(i=y("inspect-addr"))==null?void 0:i.value.trim();o&&ze(o)&&Gn()},60)}),(s=document.getElementById("tab-inspector"))==null||s.addEventListener("click",o=>{var r;let i=o.target.closest(".section-header");i&&((r=i.closest(".inspector-section"))==null||r.classList.toggle("collapsed"))}),(a=document.getElementById("inspector-nav"))==null||a.addEventListener("click",o=>{let i=o.target.closest("[data-jump]");if(!i)return;let r=document.getElementById("section-"+i.dataset.jump);r&&(r.classList.remove("collapsed"),r.scrollIntoView({behavior:"smooth",block:"start"})),Ml(i.dataset.jump)});let e=!1;window.addEventListener("scroll",()=>{la()&&(e||(e=!0,requestAnimationFrame(()=>{$h(),e=!1})))},{passive:!0}),window.runInspect=Gn,window.inspectorCopyAddr=Th,window.showInspectorHowTo=Ch,window.hideInspectorHowTo=So,pf(),Eh(),window.addEventListener("naluxrp:tabchange",o=>{var i;((i=o.detail)==null?void 0:i.tabId)==="inspector"&&la()&&(Mo(),Lo(),ws(),ca())})}function $l(e){ko=!!e,ko||(et=!0)}async function Gn(){var a,o,i,r,l,c,d,u,p,m,f,g,h,w;if(!la())return;let e=xl(),t=((a=e.input())==null?void 0:a.value.trim())||"";if([e.err,e.result,e.empty,e.warn].forEach(k=>k&&(k.style.display="none")),et=!0,!t){e.empty&&(e.empty.style.display="");return}if(!ze(t)){e.err&&(e.err.textContent=`\u26A0 Invalid address: ${b(t)}`,e.err.style.display="");return}if(X.connectionState!=="connected"){e.warn&&(e.warn.style.display="");return}lf=t,et=!1;let n=k=>{e.loading&&(e.loading.style.display="",e.loadMsg&&(e.loadMsg.textContent=k))};n("Fetching account data\u2026");let s=k=>new Promise(v=>setTimeout(v,k));try{n("Fetching account data\u2026");let[k,v,x]=await Promise.all([Ae({command:"account_info",account:t,ledger_index:"validated"}),Ae({command:"account_offers",account:t,ledger_index:"validated"}),Ae({command:"account_nfts",account:t,ledger_index:"validated"}).catch(()=>null)]);if(et)return;let S=((o=k==null?void 0:k.result)==null?void 0:o.account_data)||{},T=((i=v==null?void 0:v.result)==null?void 0:i.offers)||[],$=((r=x==null?void 0:x.result)==null?void 0:r.account_nfts)||[];n("Fetching trustlines\u2026");let P=[],M,N=0;do{N++;let z={command:"account_lines",account:t,ledger_index:"validated",limit:400};M&&(z.marker=M);let Y=await Ae(z).catch(()=>null);if(et)return;let me=((l=Y==null?void 0:Y.result)==null?void 0:l.lines)||[];P.push(...me),M=((c=Y==null?void 0:Y.result)==null?void 0:c.marker)||null,N>1&&await s(50)}while(M&&P.length<4e3);n("Fetching account objects\u2026");let _=[],O,D=0;do{D++;let z={command:"account_objects",account:t,ledger_index:"validated",limit:400};O&&(z.marker=O);let Y=await Ae(z).catch(()=>null);if(et)return;let me=((d=Y==null?void 0:Y.result)==null?void 0:d.account_objects)||[];_.push(...me),O=((u=Y==null?void 0:Y.result)==null?void 0:u.marker)||null,D>1&&await s(50)}while(O&&_.length<2e3);n("Fetching token supply, AMM data & price\u2026");let R=P.filter(z=>z.currency&&(z.currency.startsWith("03")||z.currency.length===40)),[F,,...H]=await Promise.all([Ae({command:"gateway_balances",account:t,ledger_index:"validated"}).catch(()=>null),df(),...R.slice(0,5).map(z=>Ae({command:"amm_info",asset:{currency:"XRP"},asset2:{currency:z.currency,issuer:z.account},ledger_index:"validated"}).catch(()=>null))]);if(et)return;let A=(F==null?void 0:F.result)||null,U=new Map;R.slice(0,5).forEach((z,Y)=>{var me,Re;(Re=(me=H[Y])==null?void 0:me.result)!=null&&Re.amm&&U.set(z.currency,H[Y].result.amm)});let Q=400,ae=250,ce=window._inspectMaxTx||5e3,de=Math.ceil(ce/Q),ne=[],fe=new Set,K=z=>{var Y,me;for(let Re of z||[]){let Fe=((Y=Re.tx_json)==null?void 0:Y.hash)||((me=Re.tx)==null?void 0:me.hash)||Re.hash||null;Fe&&fe.has(Fe)||(Fe&&fe.add(Fe),ne.push(Re))}},xe;for(let z=1;z<=de&&ne.length<ce;z++){if(et)return;n(`Fetching transactions \u2014 page ${z} (${ne.length.toLocaleString()} so far)\u2026`);let Y={command:"account_tx",account:t,limit:Q,ledger_index_min:-1,ledger_index_max:-1,forward:!1};xe&&(Y.marker=xe);let me=await Ae(Y).catch(()=>null);if(et)return;if(K((p=me==null?void 0:me.result)==null?void 0:p.transactions),xe=((m=me==null?void 0:me.result)==null?void 0:m.marker)||null,!xe)break;z<de&&ne.length<ce&&await s(ae)}if(ne.length<ce){if(et)return;n("Fetching oldest transactions (anchoring history start)\u2026");let z=await Ae({command:"account_tx",account:t,limit:Q,ledger_index_min:-1,ledger_index_max:-1,forward:!0}).catch(()=>null);if(et)return;K((f=z==null?void 0:z.result)==null?void 0:f.transactions),await s(ae)}e.loading&&(e.loading.style.display="none");let B=uf(ne).sort((z,Y)=>(z.tx.date??0)-(Y.tx.date??0)),J=946684800,re=null,pe=null;if(B.length>0){let z=B[0].tx;z!=null&&z.date&&(pe=(z.date+J)*1e3,re=Math.floor((Date.now()-pe)/864e5))}let Se=new Map;for(let{tx:z}of B){if(z.TransactionType!=="OfferCreate"||!z.TakerPays||!z.TakerGets)continue;let Y=Re=>typeof Re=="string"?"XRP":`${Re.currency}+${Re.issuer||""}`,me=[Y(z.TakerPays),Y(z.TakerGets)].sort().join("\u2194");Se.set(me,(Se.get(me)||0)+1)}let ge=null;if(Se.size>0){let z=[...Se.entries()].sort((zt,Os)=>Os[1]-zt[1])[0][0],[Y,me]=z.split("\u2194"),Re=zt=>zt==="XRP"?{currency:"XRP"}:{currency:zt.split("+")[0],issuer:zt.split("+")[1]},Fe=await Ae({command:"book_offers",taker_pays:Re(Y),taker_gets:Re(me),limit:20,ledger_index:"validated"}).catch(()=>null);(h=(g=Fe==null?void 0:Fe.result)==null?void 0:g.offers)!=null&&h.length&&(ge={pair:z,offers:Fe.result.offers})}let ot=[...new Set(B.filter(({tx:z})=>z.TransactionType==="Payment"&&z.Account===t&&z.Destination).map(({tx:z})=>z.Destination))].slice(0,6),it=new Map;for(let z of ot){if(et)return;let Y=await Ae({command:"account_info",account:z,ledger_index:"validated"}).catch(()=>null),me=(w=Y==null?void 0:Y.result)==null?void 0:w.account_data;me&&it.set(z,{sequence:me.Sequence||0,balance:Number(me.Balance||0)/1e6}),await s(80)}mf(t,S,P,T,$,_,B,{gatewayBalances:A,ammInfoMap:U,destAgeMap:it,walletAgeDays:re,walletCreatedTs:pe,liveOrderBook:ge}),e.result&&(e.result.style.display="",Po());let Ce=e.score?Number(e.score.textContent):null;Fh(t,isNaN(Ce)?null:Ce);let ue=window._lastAllFindings||[];Bh(t,isNaN(Ce)?null:Ce,ue),jh(t,ue),To(t)&&Oh(t,isNaN(Ce)?null:Ce),Uh()}catch(k){if(et)return;e.loading&&(e.loading.style.display="none"),e.err&&(e.err.textContent=`Error: ${b(k.message)}`,e.err.style.display="")}}function uf(e){return e.map(t=>{let n=t.tx_json||t.tx||t.transaction||{},s=t.metadata||t.meta||{};return n.date==null&&t.date!=null&&(n.date=t.date),!n.hash&&t.hash&&(n.hash=t.hash),{tx:n,meta:s}})}function mf(e,t,n,s,a,o,i,r={}){let{gatewayBalances:l=null,ammInfoMap:c=new Map,destAgeMap:d=new Map,walletAgeDays:u=null,walletCreatedTs:p=null,liveOrderBook:m=null}=r,f=Number(t.Balance||0)/1e6,g=Number(t.OwnerCount||0),h=10+g*2,w=Number(t.Flags||0),k=t.Sequence??"\u2014",v=o.filter(ge=>ge.LedgerEntryType==="SignerList"),x=o.filter(ge=>ge.LedgerEntryType==="Escrow"),S=o.filter(ge=>ge.LedgerEntryType==="PayChannel"),T=o.filter(ge=>ge.LedgerEntryType==="DepositPreauth"),$=o.filter(ge=>ge.LedgerEntryType==="Check"),P=bf(t,w,v,i),M=yf(t,w,v,i,S,x),N=wf(a,i,e),_=xf(i,e,n),O=Lf(t,n,w,i),D=Pf(n,i,o,c),R=kf(i),F=Mf(i,e),H=$f(i,e),A=Sf(i,e),U=Tf(i),Q=Cf(i,e),ae=ff(i,e,d),ce=Ef(i),de=Af(i,e),ne=Nf(i,e),fe=hf(i,e,n,l),K=_f(i,e),xe=Rf(i,e),B=Df(o,i,e),J=If(o),re=Ff(m,e),pe=Xf(P,M,N,_,R,F,H,A,U,Q,ce);Vf(e,t,f,h,g,k,pe,u,p),Gf(P,t,w,v,T),Kf(M,S,x,$),sh(ae,f,K),Jf(N,a),Qf(_),Of(R),Hf(F),zf(H),Uf(A),Wf(U),jf(Q),qf(R,H,A,U,Q),Zf(O,n),oh(fe,n),ih(ce),rh(de),lh(ne),eh(D,n),ch(K),dh(xe),ph(B),uh(J),mh(re),fh(pe,P,M,N,_,R,F,H,A,U,Q,ce,K,xe),th(n),nh(i,e),yl(i),wl(i,e,ae,K),window._lastTxList=i;let Se=y("inspect-report-body");Se&&(yh(Se,e,t,f,pe,P,M,N,_,R,F,O,D,ae,fe,i,H,A,U,Q,{feeAnalysis:ce,destTagAnalysis:de,pathDepthAnalysis:ne,gatewayBalances:l,inboundFlowAnalysis:K,memoAnalysis:xe,escrowDepthAnalysis:B,checkAnalysis:J,liveBookAnalysis:re,walletAgeDays:u,walletCreatedTs:p}),yl(i,"inspect-report-activity-chart"),wl(i,e,ae,K,"inspect-report-network-map"),Wh(pe,window._lastAllFindings||[],u,i.length),window._lastInspectResult={addr:e,riskScore:pe,walletAgeDays:u,txCount:i.length,findings:window._lastAllFindings||[],timestamp:new Date().toISOString()},Al(),Nl(e))}function ff(e,t,n=new Map){let s=new Map,a=[];for(let{tx:p,meta:m}of e){if(p.TransactionType!=="Payment"||p.Account!==t)continue;let f=p.Destination;if(!f)continue;let g=0,h=null,w=p.Amount;typeof w=="string"?g=Number(w)/1e6:w!=null&&w.value&&(h={value:Number(w.value),currency:vn(w.currency),issuer:w.issuer});let k=Array.isArray(p.Paths)&&p.Paths.length>0,v=p.SendMax!=null,x=k||v,S=k?p.Paths.reduce((M,N)=>Math.max(M,(N||[]).length+1),1):x?2:1,T=Bt(p),$={dest:f,amtXrp:g,amtToken:h,ts:T,isPathPay:x,hopCount:S,hash:p.hash||p.Hash||"",ledger:p.ledger_index||p.LedgerIndex||0,destTag:p.DestinationTag};a.push($),s.has(f)||s.set(f,{addr:f,totalXrp:0,txCount:0,firstSeen:T,lastSeen:T,entity:Kn(f)||null,pathCount:0,maxHops:1,tokens:new Map});let P=s.get(f);if(P.totalXrp+=g,P.txCount++,P.lastSeen=Math.max(P.lastSeen,T),P.firstSeen=Math.min(P.firstSeen,T),x&&(P.pathCount++,P.maxHops=Math.max(P.maxHops,S)),h){let M=`${h.currency}.${W(h.issuer||"")}`;P.tokens.set(M,(P.tokens.get(M)||0)+h.value)}}let o=[...s.values()].sort((p,m)=>m.totalXrp-p.totalXrp||m.txCount-p.txCount).slice(0,10).map(p=>({...p,tokens:[...p.tokens.entries()].map(([m,f])=>({k:m,v:f}))})),i=o.reduce((p,m)=>p+m.totalXrp,0),r=a.filter(p=>p.isPathPay).length,l=o.filter(p=>{let m=n.get(p.addr);return m&&m.sequence<10&&p.totalXrp>10}),c=o.filter(p=>{var m;return((m=p.entity)==null?void 0:m.type)==="exchange"}),d=o.filter(p=>{var m;return((m=p.entity)==null?void 0:m.type)==="blackhole"});return{timeline:[...a].filter(p=>p.amtXrp>.01||p.amtToken).sort((p,m)=>p.ts-m.ts).slice(0,30),destinations:o,totalOut:i,totalPathPay:r,uniqueDests:s.size,exchangeDests:c,blackHoleDests:d,newWalletDests:l}}function hf(e,t,n,s=null){var T,$;let a=null;if(s!=null&&s.obligations){let P=Object.values(s.obligations);P.length===1?a=Number(P[0])||null:P.length>1&&(a=null)}let o=[],i=new Map,r=new Map,l=new Set,c=new Set(n.filter(P=>Number(P.balance)<0).map(P=>vn(P.currency)));for(let{tx:P,meta:M}of e)if(P.Account===t&&P.TransactionType==="Payment"){(($=(T=M==null?void 0:M.AffectedNodes)==null?void 0:T.some)==null?void 0:$.call(T,O=>{var D,R,F;return((D=O.CreatedNode)==null?void 0:D.LedgerEntryType)==="AccountRoot"&&((F=(R=O.CreatedNode)==null?void 0:R.NewFields)==null?void 0:F.Account)===P.Destination}))&&P.Destination&&l.add(P.Destination);let _=P.Amount;if(typeof _=="object"&&(_!=null&&_.value)&&(_!=null&&_.currency)){let O=vn(_.currency);if(c.has(O)){let D=Number(_.value),R=P.Destination;i.has(R)||(i.set(R,0),r.set(R,Bt(P))),i.set(R,i.get(R)+D)}}}let d=[...i.entries()].sort((P,M)=>M[1]-P[1]),u=[];if(d.length>=3){let P=new Map;for(let[M,N]of d){if(N<=0)continue;let _=Math.pow(10,Math.floor(Math.log10(N))),D=(Math.round(N/_/.1)*.1*_).toPrecision(2);P.has(D)||P.set(D,[]),P.get(D).push({addr:M,amt:N})}for(let[,M]of P.entries())if(M.length>=3){let N=M.reduce((_,O)=>_+O.amt,0)/M.length;u.push({approxAmt:N,accounts:M}),o.push({sev:"warn",label:`${M.length} accounts each received ~${I(N,0)} tokens`,detail:"Highly similar token amounts suggest coordinated wallets, pre-arranged airdrop clusters, or sybil accounts."})}}let p=[...r.values()].sort();if(p.length>=5){let P=p[p.length-1]-p[0];P<3600&&p.length>=10&&o.push({sev:"warn",label:`${p.length} accounts funded within ${Math.ceil(P/60)} minutes`,detail:"Rapid token distribution to many wallets in a narrow time window. Matches pre-sale airdrop or coordinated distribution for wash trading."})}l.size>0&&o.push({sev:l.size>10?"warn":"info",label:`${l.size} account(s) created by this address`,detail:"This issuer funded the activation of these accounts. They may be controlled by the same entity."});let m=n.filter(P=>Number(P.balance)<0),f=a,g=m.reduce((P,M)=>P+Math.abs(Number(M.balance)),0),h=f??g,w=f==null&&m.length>0,k=w?` (based on ${m.length} visible trustlines \u2014 actual total supply may be higher if there are more holders)`:"",v=m.map(P=>({addr:P.account,balance:Math.abs(Number(P.balance)),currency:vn(P.currency)})).sort((P,M)=>M.balance-P.balance).slice(0,10),x=f??g,S=x>0&&(f!=null||m.length>=50);if(v.length>=2&&S){let P=v[0].balance/x*100,M=f!=null?"":" (of visible sample)";P>50?o.push({sev:"critical",label:`Top holder controls ${P.toFixed(0)}%${M} of supply`,detail:`${W(v[0].addr)} holds ${I(v[0].balance,0)} of ${I(x,0)} total${k}. `+(f!=null?"Extreme dump risk \u2014 one wallet could sell everything.":"Check gateway_balances or a block explorer to confirm the full supply picture.")}):P>25&&o.push({sev:"warn",label:`Top holder controls ${P.toFixed(0)}%${M} of supply`,detail:`Large single-holder concentration${k}. Monitor for coordinated sell events.`});let _=v.slice(0,5).reduce((O,D)=>O+D.balance,0)/x*100;_>75&&o.push({sev:"warn",label:`Top 5 holders own ${_.toFixed(0)}%${M} of supply`,detail:`Supply heavily concentrated in a few wallets${k}. This pattern is common in pre-launch setups or tokens with limited real distribution.`})}else m.length>0&&!S&&o.push({sev:"info",label:`${m.length} trustline holder(s) visible \u2014 supply data limited`,detail:`Only ${m.length} trustlines returned by account_lines. The true holder count and total supply cannot be determined from this data alone. Use a block explorer (XRPScan, Bithomp) for a complete holder distribution.`});return o.length===0&&h===0&&o.push({sev:"info",label:"No token issuance detected",detail:"This account does not appear to be an active token issuer."}),{signals:o,totalIssued:h,holderCount:m.length,topHolders:v,mirrorGroups:u,createdAccts:[...l],distributions:d.slice(0,10),isSampleOnly:w}}var gf=new Set(["rrrrrrrrrrrrrrrrrrrrrhoLvTp","rrrrrrrrrrrrrrrrrrrrBZbvji","rrrrrrrrrrrrrrrrrNAMEtxvNvQ","rHb9CJAWyB4rj91VRWn96DkukG4bwdtyTh","r9cZA1mLK5R5Am25ArfXFmqgNwjZgnfk59"]);function vf(e){return!!e&&gf.has(e)}function Sl(e,t,n=[],s=[]){let a=!!(t&Xe.lsfDisableMaster),o=(e==null?void 0:e.RegularKey)||"",i=Array.isArray(n)&&n.length>0,r=vf(o);return!!(a&&r&&!i)}function Tl(e,t,n=[]){let s=!!(t&Xe.lsfDefaultRipple),a=!!(t&Xe.lsfRequireAuth),o=!!(t&Xe.lsfGlobalFreeze),i=!!(t&Xe.lsfNoFreeze),r=n.filter(({tx:c})=>c.TransactionType==="TrustSet").length,l=n.filter(({tx:c})=>{var d;return c.TransactionType==="Payment"&&typeof c.Amount=="object"&&((d=c.Amount)==null?void 0:d.currency)}).length;return s||a||o||i||r>=3||l>=5}function bf(e,t,n,s){let a=[],o=100,i=!!(t&Xe.lsfDisableMaster),r=!!e.RegularKey,l=n.length>0,c=Sl(e,t,n,s),d=Tl(e,t,s);if(i&&!r&&!l?(a.push({sev:"critical",label:"Master key disabled \u2014 no fallback",detail:"Account cannot sign transactions. Funds are inaccessible."}),o-=40):c?(a.push({sev:"info",label:"Intentional blackhole pattern detected",detail:`Master key is disabled and regular key ${e.RegularKey} is a known blackhole address. This usually indicates the account was intentionally locked, not compromised.`}),d&&a.push({sev:"warn",label:"Blackholed issuer caution",detail:"This account appears issuer-like and intentionally blackholed. Sending issued tokens back here may make them unrecoverable or effectively burn them."})):i&&a.push({sev:"info",label:"Master key disabled",detail:"Signing via regular key or multisig only."}),r){let p=s.find(({tx:f})=>f.TransactionType==="SetRegularKey"),m=p&&Date.now()/1e3-Bt(p.tx)<86400*30;c?a.push({sev:"info",label:"Regular key points to blackhole address",detail:e.RegularKey}):m?(a.push({sev:"warn",label:"Regular key set recently",detail:`Key: ${e.RegularKey} \u2014 changed within 30 days. Verify you intended this.`}),o-=15):a.push({sev:"info",label:"Regular key active",detail:e.RegularKey})}n.forEach(p=>{let m=p.SignerEntries||[],f=p.SignerQuorum||1;a.push({sev:"info",label:`Multisig: ${m.length} signers, quorum ${f}`,detail:m.map(g=>{var h;return W(((h=g.SignerEntry)==null?void 0:h.Account)||"")}).join(", ")})}),t&Xe.lsfGlobalFreeze&&(a.push({sev:"warn",label:"Global Freeze active",detail:"This issuer has frozen all token balances."}),o-=10),t&Xe.lsfDepositAuth&&a.push({sev:"ok",label:"Deposit Authorization enabled",detail:"Only pre-authorized senders can deposit."}),t&Xe.lsfDefaultRipple&&a.push({sev:"info",label:"Default Ripple enabled",detail:"Balances can ripple through this account (issuer behaviour)."});let u=s.filter(({tx:p})=>p.TransactionType==="AccountDelete");return u.length&&(a.push({sev:"warn",label:`${u.length} AccountDelete attempt(s)`,detail:"Account deletion was attempted."}),o-=5),{findings:a,score:Math.max(0,o)}}function yf(e,t,n,s,a,o){let i=[],r="low",l=!!(t&Xe.lsfDisableMaster),c=Sl(e,t,n,s),d=Tl(e,t,s);c?(i.push({sev:"info",label:"Intentional blackhole detected",detail:`Master key is disabled and regular key ${e.RegularKey} is a known blackhole address. This is typical for a permanently locked issuer/account, not a classic drain setup.`}),d&&i.push({sev:"warn",label:"Caution: sending assets back may burn them",detail:"Because this account appears to be an intentionally blackholed issuer, sending issued tokens back to it may strand or effectively burn those tokens."})):l&&e.RegularKey&&(i.push({sev:"critical",label:"Classic drain setup detected",detail:`Master key disabled. Regular key ${e.RegularKey} controls the account. If this key was set by an attacker, funds are at risk.`}),r="critical");let u=s.filter(({tx:f})=>f.TransactionType==="SetRegularKey"&&f.Account!==e.Account);!c&&u.length&&(i.push({sev:"critical",label:"Regular key set by external account",detail:`${u.length} key change(s) where sender \u2260 account owner. This is unusual.`}),r="critical");let p=s.filter(({tx:f})=>["SetRegularKey","SignerListSet"].includes(f.TransactionType));if(!c&&p.length>0){let f=Bt(p[0].tx),g=s.filter(({tx:h})=>{if(h.TransactionType!=="Payment"||h.Account!==e.Account)return!1;let w=Bt(h);return w>f&&w<f+3600*48});if(g.length>0){let h=g.reduce((w,{tx:k})=>{let v=k.Amount;return typeof v=="string"?w+Number(v)/1e6:w},0);h>10&&(i.push({sev:"critical",label:`${I(h,2)} XRP sent within 48h of auth change`,detail:`${g.length} payment(s) shortly after key/signer modification. Pattern matches drain attack.`}),r="critical")}}if(a.length){let f=a.reduce((g,h)=>g+Number(h.Amount||0)/1e6,0);i.push({sev:"warn",label:`${a.length} open payment channel(s) \u2014 ${I(f,2)} XRP locked`,detail:`Destination(s): ${a.map(g=>W(g.Destination)).join(", ")}`}),r==="low"&&(r="medium")}if(o.length){let f=o.reduce((g,h)=>g+Number(h.Amount||0)/1e6,0);i.push({sev:"info",label:`${o.length} open escrow(s) \u2014 ${I(f,2)} XRP escrowed`,detail:`Escrow(s): ${o.map(g=>g.Destination?W(g.Destination):"self-escrow").join(", ")}`})}let m=s.filter(({tx:f})=>f.TransactionType==="DepositPreauth"&&f.Authorize);return m.length>5&&(i.push({sev:"warn",label:`${m.length} DepositPreauth grants issued`,detail:"Account pre-authorized many senders. Review if all are trusted."}),r==="low"&&(r="medium")),i.length===0&&i.push({sev:"ok",label:"No drain patterns detected",detail:"Auth structure looks intact."}),{signals:i,riskLevel:r}}function wf(e,t,n){let s=[],a=new Map(e.map(m=>[m.NFTokenID,m])),i=t.filter(({tx:m})=>m.TransactionType==="NFTokenCreateOffer"&&m.Account===n).filter(({tx:m})=>{let f=m.Amount;return f?typeof f=="string"?Number(f)<1e6:!1:!0});i.length&&s.push({sev:"critical",label:`${i.length} NFT offer(s) created for \u22641 XRP`,detail:"You created sell offers at near-zero price. This is a common NFT drain vector \u2014 attackers trick victims into listing their NFTs for free."});let r=t.filter(({tx:m})=>m.TransactionType==="NFTokenAcceptOffer"&&m.Account===n);r.length&&s.push({sev:"warn",label:`${r.length} NFT offer(s) accepted`,detail:"Review these transactions to confirm they were intentional sales/purchases."});let l=t.filter(({tx:m})=>m.TransactionType==="NFTokenBurn"&&m.Account===n);l.length&&s.push({sev:"warn",label:`${l.length} NFT(s) burned`,detail:"Burned NFTs cannot be recovered. Confirm these were intentional."});let c=t.filter(({tx:m})=>m.TransactionType==="NFTokenMint"&&m.Account===n),d=t.filter(({tx:m})=>m.TransactionType==="NFTokenCreateOffer"||m.TransactionType==="NFTokenAcceptOffer");c.length>0&&d.length>0&&s.push({sev:"info",label:`${c.length} NFT(s) minted \xB7 ${d.length} transfer event(s)`,detail:"This account has minting activity."});let u=e.filter(m=>m.TransferFee&&m.TransferFee>0);if(u.length){let m=u.reduce((f,g)=>f+g.TransferFee,0)/u.length;s.push({sev:"info",label:`${u.length} NFT(s) carry transfer fees (avg ${(m/1e3).toFixed(1)}%)`,detail:"These NFTs pay royalties on each transfer."})}let p=e.filter(m=>!m.URI);return p.length>2&&s.push({sev:"warn",label:`${p.length} NFT(s) have no URI / metadata`,detail:"NFTs without a URI may be spam or placeholder tokens used in scams."}),s.length===0&&e.length===0?s.push({sev:"ok",label:"No NFT activity detected",detail:"This account holds no NFTs."}):s.length===0&&s.push({sev:"ok",label:`${e.length} NFT(s) held \u2014 no risk signals`,detail:"NFT posture looks normal."}),{flags:s,nftCount:e.length,mintCount:c.length}}function xf(e,t,n){let s=[],a=0,o=e.filter(({tx:v})=>v.TransactionType==="OfferCreate"),i=e.filter(({tx:v})=>v.TransactionType==="OfferCancel"),r=o.filter(({meta:v})=>{var x,S;return(S=(x=v==null?void 0:v.AffectedNodes)==null?void 0:x.some)==null?void 0:S.call(x,T=>{var $;return(($=T.DeletedNode)==null?void 0:$.LedgerEntryType)==="Offer"})}),l=e.filter(({tx:v})=>v.TransactionType==="Payment"),c=o.length>0?i.length/o.length:0;o.length>=qn&&c>vl&&(s.push({sev:"warn",label:`High cancel ratio: ${(c*100).toFixed(1)}%`,detail:`${i.length} cancels vs ${o.length} creates. Threshold: ${(vl*100).toFixed(0)}%. May indicate layering / spoofing.`}),a+=25);let d=new Set(l.filter(({tx:v})=>v.Account===t&&v.Destination).map(({tx:v})=>v.Destination)),u=new Set(l.filter(({tx:v})=>v.Destination===t&&v.Account).map(({tx:v})=>v.Account)),p=[...d].filter(v=>u.has(v));if(p.length>0&&l.length>=qn){let v=p.length/d.size;v>af&&(s.push({sev:"warn",label:`${p.length} round-trip counterpart(s) detected`,detail:`${(v*100).toFixed(1)}% of payment recipients also sent back to this account. Possible wash-trade cycle.`}),a+=20)}let m=new Map;o.forEach(({tx:v})=>{if(!v.TakerPays||!v.TakerGets)return;let x=T=>typeof T=="string"?"XRP":`${T.currency}.${W(T.issuer||"")}`,S=[x(v.TakerPays),x(v.TakerGets)].sort().join("\u2194");m.set(S,(m.get(S)||0)+1)});let f=[...m.entries()].sort((v,x)=>x[1]-v[1])[0];if(f&&o.length>=qn){let v=f[1]/o.length;v>.7&&(s.push({sev:"warn",label:`${(v*100).toFixed(0)}% of offers on single pair: ${f[0]}`,detail:`${f[1]} of ${o.length} offers on one pair. High concentration is a wash trading signal.`}),a+=20)}let g=o.length>0?r.length/o.length:0;if(o.length>=qn&&g<.05&&(s.push({sev:"warn",label:`Very low fill rate: ${(g*100).toFixed(1)}%`,detail:`Only ${r.length} of ${o.length} offers filled. Placing orders never intended to execute.`}),a+=15),o.length>=5){let v=o.map(({tx:S})=>Bt(S)).sort(),x=1;for(let S=0;S<v.length;S++){let T=1;for(let $=S+1;$<v.length&&v[$]-v[S]<=30;$++)T++;x=Math.max(x,T)}x>=8&&(s.push({sev:"warn",label:`Burst activity: ${x} offers within 30 seconds`,detail:"Rapid automated trading pattern detected."}),a+=10)}let h=l.filter(({tx:v})=>v.Account===t&&v.Destination===t);if(h.length>0&&(s.push({sev:"critical",label:`${h.length} self-trade(s): sender = receiver`,detail:"Payments where origin and destination are the same address. Classic wash-trading indicator \u2014 creates artificial volume with zero economic transfer."}),a+=30),o.length>=10){let v=o.map(({tx:P})=>{let M=P.TakerGets;return typeof M=="string"?Number(M)/1e6:null}).filter(P=>P!=null),x=v.sort((P,M)=>M-P)[Math.floor(v.length*.05)]||0,S=o.filter(({tx:P})=>{let M=P.TakerGets;return typeof M=="string"&&Number(M)/1e6>=x}),T=S.filter(({meta:P})=>{var M,N;return!((N=(M=P==null?void 0:P.AffectedNodes)==null?void 0:M.some)!=null&&N.call(M,_=>{var O;return((O=_.DeletedNode)==null?void 0:O.LedgerEntryType)==="Offer"}))}),$=S.length>=5?T.length/S.length:0;$>=.95?(s.push({sev:"critical",label:`Spoofing pattern: ${($*100).toFixed(0)}% of large orders cancelled`,detail:`${T.length} of ${S.length} top-5% size orders were cancelled without execution. \u226595% cancel rate on large orders strongly implies fake order book depth (spoofing).`}),a+=30):$>=.8&&(s.push({sev:"warn",label:`Elevated large-order cancel rate: ${($*100).toFixed(0)}%`,detail:`${T.length}/${S.length} large orders cancelled. Watch for spoofing behaviour.`}),a+=15)}if(o.length>=qn){let v=o.map(({tx:x})=>{let S=x.TakerGets;return typeof S=="string"?Number(S)/1e6:S!=null&&S.value?Number(S.value):null}).filter(x=>x!=null&&x>0);if(v.length>=qn){let x=v.reduce(($,P)=>$+P,0)/v.length,S=Math.sqrt(v.reduce(($,P)=>$+(P-x)**2,0)/v.length),T=x>0?S/x:null;T!==null&&T<.05?(s.push({sev:"critical",label:`Robotic trade uniformity (CV ${T.toFixed(3)})`,detail:`${(T*100).toFixed(1)}% coefficient of variation across ${v.length} offer sizes. Near-identical sizes indicate bot-generated fake volume (natural markets show CV \u2265 0.5).`}),a+=25):T!==null&&T<.2&&(s.push({sev:"warn",label:`Unusually uniform trade sizes (CV ${T.toFixed(3)})`,detail:`Only ${(T*100).toFixed(1)}% variation in offer sizes \u2014 suspiciously low for organic activity.`}),a+=10)}}let w=[...o,...l].map(({tx:v})=>{let x=v.TakerGets||v.Amount;return typeof x=="string"?Number(x)/1e6:x!=null&&x.value?Number(x.value):null}).filter(v=>v!=null&&v>0&&Number.isFinite(v));if(w.length>=10){let v=[100,1e3,1e4,1e5],x=w.filter(T=>v.some($=>Math.abs(T%$)<1e-6&&T/$>=1)).length,S=x/w.length;S>.45&&(s.push({sev:"warn",label:`Round-number bias: ${(S*100).toFixed(0)}% of amounts at exact multiples`,detail:`${x}/${w.length} trade / payment amounts are exact multiples of 100, 1,000, or 10,000. Statistical excess of round numbers is a signature of bot-generated activity.`}),a+=12)}if(o.length>=5){let v=o.map(({tx:S})=>Bt(S)).sort((S,T)=>S-T),x=0;for(let S=0;S<v.length;S++){let T=1;for(let $=S+1;$<v.length&&v[$]-v[S]<=3600;$++)T++;T>x&&(x=T)}if(x>100)s.push({sev:"critical",label:`Hourly burst: ${x} offers within 60 minutes`,detail:">100 OfferCreate txs in a single hour is a strong bot-pump indicator, especially in typically illiquid token markets."}),a+=20;else if(x>=8){let S=v,T=1;for(let $=0;$<S.length;$++){let P=1;for(let M=$+1;M<S.length&&S[M]-S[$]<=30;M++)P++;P>T&&(T=P)}T>=8&&(s.push({sev:"warn",label:`Rapid burst: ${T} offers within 30 seconds`,detail:"Automated trading pattern \u2014 bursts at this speed exceed human capability."}),a+=10)}}let k=a===0?"clean":a<25?"low-risk":a<50?"suspicious":"high-risk";return s.length===0&&s.push({sev:"ok",label:"No wash trading signals",detail:`${o.length} offers \xB7 ${i.length} cancels \xB7 ${h.length} self-trades \u2014 patterns look normal.`}),{signals:s,score:a,verdict:k,stats:{creates:o.length,cancels:i.length,fills:r.length,payments:l.length,roundTrip:p.length,selfTrades:h.length}}}function kf(e){let t=[];for(let{tx:c}of e){let d=[c.Amount,c.TakerGets,c.TakerPays,c.SendMax,c.DeliverMin];for(let u of d){let p=typeof u=="string"?Number(u)/1e6:u!=null&&u.value?Number(u.value):null;p!=null&&p>0&&Number.isFinite(p)&&t.push(p)}}if(t.length<50)return{signals:[{sev:"info",label:"Insufficient data for Benford's Law",detail:`Need \u226550 monetary amounts, found ${t.length}.`}],chiSq:null,verdict:"insufficient",digitBreakdown:[],sampleSize:t.length};let n=[0,.301,.176,.125,.097,.079,.067,.058,.051,.046],s=new Array(10).fill(0);for(let c of t){let d=c.toFixed(6).replace(/^0+\.?0*/,""),u=parseInt(d[0],10);u>=1&&u<=9&&s[u]++}let a=t.length,o=0,i=[];for(let c=1;c<=9;c++){let d=s[c]/a,u=n[c];o+=a*Math.pow(d-u,2)/u,i.push({digit:c,obs:(d*100).toFixed(1),exp:(u*100).toFixed(1),delta:((d-u)*100).toFixed(1)})}let r=[],l;return o>20.09?(l="high-deviation",r.push({sev:"warn",label:`Benford's Law: significant deviation (\u03C7\xB2=${o.toFixed(1)})`,detail:`First-digit distribution deviates significantly from natural patterns (p<0.01, n=${a}). This is a statistical signature of fabricated or algorithmically generated transaction amounts.`})):o>15.51?(l="moderate-deviation",r.push({sev:"info",label:`Benford's Law: moderate deviation (\u03C7\xB2=${o.toFixed(1)})`,detail:`Some deviation from expected natural distribution (p<0.05, n=${a}). Worth monitoring alongside other signals.`})):(l="normal",r.push({sev:"ok",label:`Benford's Law: normal distribution (\u03C7\xB2=${o.toFixed(1)})`,detail:`First-digit distribution is consistent with organic transaction patterns (n=${a}).`})),{signals:r,chiSq:o,verdict:l,digitBreakdown:i,sampleSize:a}}function $f(e,t){let s=[],a=[];for(let{tx:h}of e){let w=[h.Amount,h.TakerGets,h.TakerPays];for(let k of w){let v=typeof k=="string"?Number(k)/1e6:k!=null&&k.value?Number(k.value):null;v&&v>0&&Number.isFinite(v)&&a.push(v)}}let o=a.length>=30?(()=>{let h=new Array(12).fill(0);for(let w of a){let k=Math.min(11,Math.max(0,Math.floor(Math.log10(w+1)*2)));h[k]++}return vs(h)})():null,i={};for(let{tx:h}of e){let w=h.Account===t?h.Destination:h.Account;w&&w!==t&&(i[w]=(i[w]||0)+1)}let r=Object.values(i),l=r.length>=3?vs(r):null,c=new Array(24).fill(0),d=!1;for(let{tx:h}of e)if(h.date){let k=new Date((h.date+946684800)*1e3).getUTCHours();c[k]++,d=!0}let u=d&&e.length>=30?vs(c):null,p={};for(let{tx:h}of e)p[h.TransactionType]=(p[h.TransactionType]||0)+1;let m=vs(Object.values(p)),f="normal",g=0;if(o!==null&&(o<1.5?(f="low-entropy",g+=18,s.push({sev:"warn",label:`Amount entropy critically low (H=${o.toFixed(2)} bits)`,detail:"Transaction amounts are highly repetitive. A bot or scripted actor tends to reuse the same values. Organic wallets show entropy \u22652.4 bits across amount magnitudes."})):o<2.2?(g+=8,s.push({sev:"info",label:`Amount entropy below natural range (H=${o.toFixed(2)} bits)`,detail:"Some amount repetition detected. Could indicate automated activity mixed with organic transactions."})):o>4.5?(g+=10,s.push({sev:"info",label:`Amount entropy abnormally high (H=${o.toFixed(2)} bits)`,detail:"Transaction amounts are maximally varied \u2014 more than organic activity typically shows. This can indicate amounts were artificially randomized to evade Benford detection."})):s.push({sev:"ok",label:`Amount entropy normal (H=${o.toFixed(2)} bits)`,detail:"Transaction amount diversity is consistent with organic financial activity."})),l!==null&&(l<1&&r.length<4?(g+=14,s.push({sev:"warn",label:`Counterparty entropy very low (H=${l.toFixed(2)} bits)`,detail:"This wallet transacts with very few unique addresses and with high repetition \u2014 a structural signature of round-trip wash trading rings."})):l<2?(g+=5,s.push({sev:"info",label:`Counterparty entropy low (H=${l.toFixed(2)} bits)`,detail:"Most interactions are concentrated among a small set of counterparties."})):s.push({sev:"ok",label:`Counterparty diversity healthy (H=${l.toFixed(2)} bits)`,detail:"Counterparty distribution reflects diverse interaction patterns."})),u!==null){let h=Math.log2(24),w=u/h;w<.45?(g+=10,s.push({sev:"warn",label:`Time-of-day entropy low (H=${u.toFixed(2)} bits, ${(w*100).toFixed(0)}% of max)`,detail:"Transactions cluster heavily in a few hours of the day. Bots typically run at fixed UTC hours; organic users spread activity across the day."})):s.push({sev:"ok",label:`Time-of-day distribution natural (H=${u.toFixed(2)} bits)`,detail:"Transaction timing is distributed across hours in a pattern consistent with human activity."})}return s.length||s.push({sev:"info",label:"Insufficient data for entropy analysis",detail:`Need \u226530 transactions. Found ${e.length}.`}),g>=18?f="anomalous":g>=8&&(f="elevated"),{signals:s,verdict:f,riskPenalty:g,amountEntropy:o,counterpartyEntropy:l,timeEntropy:u,typeEntropy:m,uniqueCounterparties:r.length,sampleSize:e.length}}function vs(e){let t=e.reduce((n,s)=>n+s,0);return t?-e.reduce((n,s)=>{if(!s)return n;let a=s/t;return n+a*Math.log2(a)},0):0}function Sf(e,t){let s=[],a={};for(let{tx:M}of e){let N=M.Account===t?M.Destination:M.Account;N&&N!==t&&(a[N]=(a[N]||0)+1)}let o=Object.values(a).sort((M,N)=>N-M);if(o.length<8)return{signals:[{sev:"info",label:`Insufficient counterparties for Zipf's Law (need \u22658, found ${o.length})`,detail:"Zipf analysis becomes meaningful with a broader counterparty network."}],verdict:"insufficient",zipfExponent:null,riskPenalty:0,freqTable:[],uniqueCounterparties:o.length};let i=o.length,r=0,l=0,c=0,d=0,u=o.map((M,N)=>({rank:N+1,freq:M,lx:Math.log(N+1),ly:Math.log(M)}));for(let{lx:M,ly:N}of u)r+=M,l+=N,c+=M*N,d+=M*M;let p=i*d-r*r,m=p!==0?(i*c-r*l)/p:null,f=m!==null?Math.abs(m):null,g=l/i,h=0,w=0,k=(l-m*r)/i;for(let{lx:M,ly:N}of u)h+=Math.pow(N-g,2),w+=Math.pow(N-(m*M+k),2);let v=h>0?1-w/h:0,x="normal",S=0;f!==null&&(v<.55?(S+=12,s.push({sev:"warn",label:`Counterparty distribution doesn't follow Zipf's Law (R\xB2=${v.toFixed(2)})`,detail:`Natural networks follow a power-law rank-frequency relationship. This wallet's counterparty network has poor Zipf fit (R\xB2=${v.toFixed(2)}), suggesting artificial or script-driven interaction structure.`}),x="anomalous"):f<.4?(S+=15,s.push({sev:"warn",label:`Zipf exponent too flat (s=${f.toFixed(2)}, expected 0.8\u20131.3)`,detail:"A very flat Zipf exponent means counterparties are used with surprisingly equal frequency. In organic networks, you transact far more often with a few key addresses. Flat distribution is consistent with round-trip wash trading rings."}),x="anomalous"):f>2.2?(S+=10,s.push({sev:"warn",label:`Zipf exponent hyper-concentrated (s=${f.toFixed(2)}, expected 0.8\u20131.3)`,detail:"Extreme concentration on one or two counterparties with steep dropoff. While not unusual for simple wallets, combined with other signals this suggests coordinated narrow-ring activity."}),x="elevated"):s.push({sev:"ok",label:`Counterparty network follows Zipf's Law (s=${f.toFixed(2)}, R\xB2=${v.toFixed(2)})`,detail:"The rank-frequency distribution of counterparties follows the expected natural power-law pattern. This is consistent with organic wallet activity."}));let T={};for(let{tx:M}of e){let N=typeof M.Amount=="string"?Math.round(Number(M.Amount)/1e4)*10:null;N&&N>0&&(T[N]=(T[N]||0)+1)}let $=Object.values(T).sort((M,N)=>N-M),P=$.length?$[0]/$.reduce((M,N)=>M+N,0):0;return P>.45&&(S+=8,s.push({sev:"warn",label:`Single amount dominates ${(P*100).toFixed(0)}% of transactions`,detail:"One transaction amount value accounts for nearly half of all payments. Round-number dominance is a hallmark of scripted or wash-trading activity."})),s.length||s.push({sev:"info",label:"Zipf analysis: no anomalies detected",detail:"Counterparty distribution consistent with natural activity."}),{signals:s,verdict:x,riskPenalty:S,zipfExponent:f,rSquared:v,freqTable:o.slice(0,12),uniqueCounterparties:o.length}}function Tf(e){let n=[];if(e.length<20)return{signals:[{sev:"info",label:`Insufficient transactions for time series analysis (need \u226520, found ${e.length})`,detail:"Time series analysis requires a longer transaction history."}],verdict:"insufficient",riskPenalty:0,intervalCV:null,autocorrelation:null,burstScore:null,periodicityScore:null};let a=e.filter(({tx:v})=>v.date!=null).map(({tx:v})=>(v.date+946684800)*1e3).sort((v,x)=>v-x);if(a.length<20)return{signals:[{sev:"info",label:"No timestamp data available",detail:"Time series requires date-stamped transactions."}],verdict:"insufficient",riskPenalty:0,intervalCV:null,autocorrelation:null,burstScore:null,periodicityScore:null};let o=[];for(let v=1;v<a.length;v++){let x=(a[v]-a[v-1])/1e3;x>0&&x<86400*30&&o.push(x)}let i=null;if(o.length>=5){let v=o.reduce((S,T)=>S+T,0)/o.length,x=Math.sqrt(o.reduce((S,T)=>S+Math.pow(T-v,2),0)/o.length);i=v>0?x/v:null}let r={};for(let v of a){let x=new Date(v).toISOString().slice(0,10);r[x]=(r[x]||0)+1}let l=Object.values(r),c=0;if(l.length>=4){let v=l.reduce((T,$)=>T+$,0)/l.length,x=Math.sqrt(l.reduce((T,$)=>T+Math.pow($-v,2),0)/l.length),S=Math.max(...l);c=x>0?(S-v)/x:0}let d=null;if(l.length>=6){let v=l.reduce((T,$)=>T+$,0)/l.length,x=l.map(T=>T-v),S=x.reduce((T,$)=>T+$*$,0);S>0&&(d=x.slice(0,-1).reduce(($,P,M)=>$+P*x[M+1],0)/S)}let u=new Array(7).fill(0);for(let v of a)u[new Date(v).getUTCDay()]++;let p=vs(u),m=Math.log2(7),f=0;if(o.length>=10){let v=[...o].sort((T,$)=>T-$),x=v[Math.floor(v.length/2)];f=o.filter(T=>Math.abs(T-x)/x<.2).length/o.length}let g="normal",h=0;i!==null&&(i<.25?(h+=20,g="bot-pattern",n.push({sev:"warn",label:`Transaction intervals mechanically regular (CV=${i.toFixed(2)})`,detail:"The time gaps between transactions are too regular for human behavior (CV < 0.25). Organic wallets show irregular timing (CV 0.8\u20133.0). This pattern is a strong bot signature."})):i<.5?(h+=8,n.push({sev:"info",label:`Transaction timing somewhat regular (CV=${i.toFixed(2)})`,detail:"Interval regularity is below typical human variance. Could indicate scheduled automation."})):n.push({sev:"ok",label:`Transaction timing is irregular (CV=${i.toFixed(2)})`,detail:"Inter-transaction intervals show natural human-like variance."})),f>.55&&(h+=12,n.push({sev:"warn",label:`Strong periodicity detected (${(f*100).toFixed(0)}% of intervals near median)`,detail:"More than half of transaction intervals cluster around the same duration. This mechanical repetition is consistent with an automated script executing on a fixed schedule."})),c>3.5&&n.push({sev:"info",label:`Activity burst detected (peak day z-score=${c.toFixed(1)})`,detail:"One or more days had extreme transaction volume compared to baseline. Could indicate a coordinated pump event or account recovery sweep."}),d!==null&&d>.6&&(h+=6,n.push({sev:"info",label:`High day-to-day volume autocorrelation (\u03C1=${d.toFixed(2)})`,detail:"Transaction volume is strongly self-correlated \u2014 today's activity predicts tomorrow's. This is consistent with an automated routine that maintains a constant pace."}));let w=p/m;w<.7&&a.length>30&&(h+=6,n.push({sev:"info",label:`Day-of-week distribution concentrated (${(w*100).toFixed(0)}% of max entropy)`,detail:"Transactions cluster heavily on specific days. Automated systems often run every day (maximally flat) or skip weekends \u2014 both deviate from natural human patterns."})),n.length||n.push({sev:"ok",label:"No temporal anomalies detected",detail:"Transaction timing patterns are consistent with organic human activity."}),h>=20?g="bot-pattern":h>=8&&(g="elevated");let k=a.length>=2?Math.round((a[a.length-1]-a[0])/864e5):null;return{signals:n,verdict:g,riskPenalty:h,intervalCV:i,autocorrelation:d,burstScore:c,periodicityScore:f,dowEntropy:p,dowBins:u,dailyVolume:Object.entries(r).slice(-30),activeSpanDays:k,totalTimestamped:a.length}}function Cf(e,t){let s=[];if(e.length<20)return{signals:[{sev:"info",label:`Insufficient data for Granger causality analysis (need \u226520, found ${e.length})`,detail:"Granger causality requires enough temporal observations to test lead-lag relationships."}],verdict:"insufficient",riskPenalty:0,offerCancelCausality:null,inflowOutflowCausality:null};let o=12*3600*1e3,i=R=>R.date?Math.floor((R.date+946684800)*1e3/o):null,r={},l=R=>{r[R]||(r[R]={offerCreate:0,offerCancel:0,inflow:0,outflow:0,nftList:0,nftAccept:0})};for(let{tx:R,meta:F}of e){let H=i(R);if(H===null)continue;l(H);let A=r[H],U=R.TransactionType;U==="OfferCreate"?A.offerCreate++:U==="OfferCancel"&&A.offerCancel++,U==="NFTokenCreateOffer"?A.nftList++:U==="NFTokenAcceptOffer"&&A.nftAccept++;let Q=(F==null?void 0:F.delivered_amount)||R.Amount,ae=typeof Q=="string"?Number(Q)/1e6:0;ae>0&&(R.Destination===t?A.inflow+=ae:R.Account===t&&(A.outflow+=ae))}let c=Object.keys(r).map(Number).sort((R,F)=>R-F);if(c.length<6)return{signals:[{sev:"info",label:"Insufficient temporal windows for Granger test",detail:"Need activity spread across multiple time windows."}],verdict:"insufficient",riskPenalty:0,offerCancelCausality:null,inflowOutflowCausality:null};let d=R=>c.map(F=>r[F][R]||0),u=(R,F,H=4)=>{let A=R.length,U=R.reduce((fe,K)=>fe+K,0)/A,Q=F.reduce((fe,K)=>fe+K,0)/A,ae=R.map(fe=>fe-U),ce=F.map(fe=>fe-Q),de=Math.sqrt(ae.reduce((fe,K)=>fe+K*K,0)/A),ne=Math.sqrt(ce.reduce((fe,K)=>fe+K*K,0)/A);return!de||!ne?Array(H+1).fill(0):Array.from({length:H+1},(fe,K)=>{let xe=0,B=0;for(let J=0;J+K<A;J++)xe+=ae[J]*ce[J+K],B++;return B>0?xe/(B*de*ne):0})},p="normal",m=0,f=d("offerCreate"),g=d("offerCancel"),h=u(f,g),w=h.indexOf(Math.max(...h)),k=Math.max(...h),v={ccf:h,maxCorr:k,maxLag:w};k>.55&&w<=2?(m+=18,p="causal-signal",s.push({sev:"warn",label:`OfferCreate \u2192 OfferCancel Granger signal (\u03C1=${k.toFixed(2)}, lag=${w} window${w===1?"":"s"})`,detail:`Offer creation strongly predicts subsequent cancellation at lag ${w} (${w*12}h). This causal pattern is the mechanical signature of wash trading: create offers to inflate visible book activity, then cancel them. A leading correlation this strong at such short lag is unlikely in organic market-making.`})):k>.35?(m+=6,s.push({sev:"info",label:`Mild offer-cancel lead relationship (\u03C1=${k.toFixed(2)}, lag=${w})`,detail:"Some temporal link between creating and cancelling offers. Worth monitoring alongside other signals."})):s.push({sev:"ok",label:"No Granger signal between offer creation and cancellation",detail:"Offer creation and cancellation timing appear independent \u2014 no evidence of systematic cancel-to-create cycles."});let x=d("inflow"),S=d("outflow"),T=u(x,S),$=T.indexOf(Math.max(...T)),P=Math.max(...T),M={ccf:T,maxCorr:P,maxLag:$};P>.65&&$===0?(m+=12,s.push({sev:"warn",label:`Inflow and outflow move in perfect lockstep (\u03C1=${P.toFixed(2)} at lag 0)`,detail:"Funds entering and leaving the wallet in the same time window with high correlation at zero lag is consistent with pass-through or round-trip self-trading: money comes in and immediately goes back out."})):P>.55&&$<=1?(m+=8,s.push({sev:"info",label:`Inflow leads outflow (\u03C1=${P.toFixed(2)}, lag=${$})`,detail:"Incoming funds reliably precede outgoing funds at short lag. Could indicate legitimate management, but in conjunction with other signals suggests fund cycling."})):s.push({sev:"ok",label:"No suspicious inflow\u2192outflow Granger pattern",detail:"Inflow and outflow timing are not predictably linked, consistent with independent organic transaction activity."});let N=d("nftList"),_=d("nftAccept"),O=N.reduce((R,F)=>R+F,0),D=_.reduce((R,F)=>R+F,0);if(O>3&&D>3){let R=u(N,_),F=Math.max(...R),H=R.indexOf(F);F>.6&&H<=1&&(m+=8,s.push({sev:"warn",label:`NFT listing causes rapid acceptance (\u03C1=${F.toFixed(2)}, lag=${H})`,detail:"NFT sell offer creation is closely followed by acceptance. Combined with the NFT trap detection module, this timing pattern can indicate coordinated offer traps with a controlled accepting address."}))}return s.some(R=>R.sev==="warn"||R.sev==="critical")||s.length||s.push({sev:"ok",label:"No Granger causality anomalies detected",detail:"Temporal relationships between transaction types show no suspicious lead-lag patterns."}),m>=18?p="causal-signal":m>=8&&(p="elevated"),{signals:s,verdict:p,riskPenalty:m,offerCancelCausality:v,inflowOutflowCausality:M,windowCount:c.length}}function Mf(e,t){let n=new Map;for(let{tx:o}of e){let i=[o.TakerGets,o.Amount];for(let r of i){if(!r||typeof r!="object")continue;let l=r.currency,c=Number(r.value||0),d=o.Account;if(!l||!d||c<=0||!Number.isFinite(c))continue;n.has(l)||n.set(l,{senders:new Set,vol:0,trades:0});let u=n.get(l);u.senders.add(d),u.vol+=c,u.trades++}}let s=[],a=[];for(let[o,i]of n.entries()){if(i.trades<8)continue;let r=i.senders.size;a.push({currency:o,uniqueActors:r,vol:i.vol,trades:i.trades}),r<5?s.push({sev:"critical",label:`${o}: ${r} wallet(s) driving all volume`,detail:`${i.trades} trades totalling ${i.vol.toFixed(2)} ${o} from only ${r} address(es). Fewer than 5 unique actors generating most volume is a wash trading red flag.`}):r<10&&s.push({sev:"warn",label:`${o}: low actor diversity (${r} wallets, ${i.trades} trades)`,detail:`Volume concentrated among only ${r} addresses. Organic markets typically have broader participation.`})}return a.length?s.length||s.push({sev:"ok",label:"Volume concentration normal",detail:`${a.length} token(s) analysed \u2014 all have \u226510 unique trading participants.`}):s.push({sev:"info",label:"No IOU/token volume data",detail:"No token-denominated transactions found in history (XRP-only activity)."}),{signals:s,concentrations:a}}function Lf(e,t,n,s){let a=[],o=!!(n&Xe.lsfDefaultRipple)||t.some(p=>p.account===e.Account),i=t.filter(p=>Number(p.balance)<0),r=i.reduce((p,m)=>p+Math.abs(Number(m.balance)),0);i.length>0&&a.push({sev:"info",label:`Token issuer: ${i.length} outstanding currency lines`,detail:`Total outstanding: ${I(r,2)} across ${i.length} holder(s).`});let l=t.filter(p=>p.freeze),c=t.filter(p=>p.freeze_peer);l.length&&a.push({sev:"warn",label:`${l.length} trustline(s) frozen by this account`,detail:"This account has frozen specific trustlines."}),c.length&&a.push({sev:"critical",label:`${c.length} of your trustline(s) frozen by issuer`,detail:`Frozen currencies: ${c.map(p=>p.currency).join(", ")}. You cannot transfer these tokens.`}),n&Xe.lsfGlobalFreeze&&a.push({sev:"critical",label:"Global Freeze \u2014 all token transfers suspended",detail:"No holders can transfer tokens issued by this account."}),n&Xe.lsfNoFreeze&&a.push({sev:"ok",label:"NoFreeze flag set \u2014 issuer cannot freeze balances",detail:"Token holders are protected against future freeze actions."});let d=Number(e.Balance||0)/1e6,u=10+Number(e.OwnerCount||0)*2;return i.length>0&&d<u+1&&a.push({sev:"warn",label:"Issuer balance near reserve \u2014 possible black hole",detail:"Issuer with outstanding tokens has almost no XRP above reserve. Tokens may be stranded."}),a.length===0&&a.push({sev:"ok",label:"No token issuer flags",detail:"This account does not appear to be a token issuer."}),{signals:a,isIssuer:o,obligationCount:i.length}}function Pf(e,t,n,s=new Map){var m,f,g;let a=[],o=[],i=e.filter(h=>h.currency&&(h.currency.startsWith("03")||h.currency.length===40)),r=t.filter(({tx:h})=>h.TransactionType==="AMMDeposit"),l=t.filter(({tx:h})=>h.TransactionType==="AMMWithdraw"),c=t.filter(({tx:h})=>h.TransactionType==="AMMCreate"),d=t.filter(({tx:h})=>h.TransactionType==="AMMVote"),u=t.filter(({tx:h})=>h.TransactionType==="AMMBid");if(i.forEach(h=>{let w=Number(h.balance),k=Number(h.limit);o.push({currency:h.currency,issuer:h.account,balance:w,limit:k})}),o.length){a.push({sev:"info",label:`${o.length} LP token position(s)`,detail:`Active liquidity provider in ${o.length} AMM pool(s).`});for(let h of o){let w=s.get(h.currency);if(w){if(h.tvl=w.amount?Number(w.amount)/1e6:null,h.tvl2=(m=w.amount2)!=null&&m.value?Number(w.amount2.value):null,h.feeRate=w.trading_fee!=null?w.trading_fee/1e3:null,h.lpSupply=(f=w.lp_token)!=null&&f.value?Number(w.lp_token.value):null,h.lpSupply&&h.balance){let k=Math.abs(h.balance)/h.lpSupply*100;h.ownerPct=k,k>50&&a.push({sev:"warn",label:`Dominant AMM position: ${k.toFixed(0)}% of pool`,detail:`This account controls ${k.toFixed(0)}% of the LP token supply for pool ${W(h.currency)}. Withdrawing all at once would severely impact pool liquidity and anyone currently trading in it.`})}h.tvl!=null&&a.push({sev:"info",label:`Pool TVL: ${I(h.tvl,2)} XRP${h.tvl2?` + ${I(h.tvl2,2)} tokens`:""} \xB7 Fee: ${((g=h.feeRate)==null?void 0:g.toFixed(2))??"?"}%`,detail:`Actual pool context from amm_info. Your LP position represents ${h.ownerPct!=null?h.ownerPct.toFixed(1)+"% of the pool.":"an unknown share of the pool."}`})}}}return c.length&&a.push({sev:"info",label:`Created ${c.length} AMM pool(s)`,detail:"This account bootstrapped one or more liquidity pools."}),(r.length||l.length)&&a.push({sev:"info",label:`${r.length} deposit(s) \xB7 ${l.length} withdrawal(s)`,detail:"LP activity history."}),d.length&&a.push({sev:"info",label:`${d.length} AMM fee vote(s)`,detail:"This account has voted on AMM trading fee parameters."}),u.length&&a.push({sev:"info",label:`${u.length} continuous auction bid(s)`,detail:"Bid for the AMM auction slot (reduced fee trading window)."}),o.filter(h=>Math.abs(h.balance)>1e3).length&&a.push({sev:"warn",label:"Large LP positions \u2014 impermanent loss risk",detail:"Significant liquidity positions carry exposure to price divergence between pool assets."}),a.length===0&&a.push({sev:"ok",label:"No AMM positions",detail:"This account is not a liquidity provider."}),{signals:a,positions:o,deposits:r.length,withdrawals:l.length}}function Ef(e){let t=[],s=e.filter(({tx:p})=>p.Fee&&Number(p.Fee)>0);if(s.length<10)return{signals:[],verdict:"insufficient",riskPenalty:0,avgFeeMultiplier:null,spikeCount:0,topFeeHashes:[]};let a=s.map(({tx:p})=>Number(p.Fee)/12),o=a.reduce((p,m)=>p+m,0)/a.length,r=s.filter(({tx:p})=>Number(p.Fee)/12>100).length,l=r/s.length,c=0,d="normal",u=[...s].sort((p,m)=>Number(m.tx.Fee)-Number(p.tx.Fee)).slice(0,5).map(({tx:p})=>({hash:p.hash,mult:(Number(p.Fee)/12).toFixed(0),fee:Number(p.Fee)}));return l>.15&&r>=5?(c=10,d="elevated",t.push({sev:"warn",label:`Fee spike pattern: ${r} txs paid >100x base fee (${(l*100).toFixed(0)}% of history)`,detail:`Average fee multiplier: ${o.toFixed(0)}x. In XRPL, bots often pay elevated fees to guarantee same-ledger execution as a counterparty \u2014 a technique used in coordinated wash trading and sandwich attacks. Organic users rarely pay more than 2\u20135x the base fee. Top hashes: ${u.slice(0,3).map(p=>W(p.hash)).join(", ")}.`,hashes:u.map(p=>p.hash)})):o>20?(c=4,t.push({sev:"info",label:`Elevated average fee (${o.toFixed(0)}x base fee)`,detail:"This wallet consistently pays above-average fees. Could indicate priority execution requirements or automated trading."})):t.push({sev:"ok",label:`Fee levels normal (avg ${o.toFixed(1)}x base fee)`,detail:"Transaction fees are within typical organic ranges."}),{signals:t,verdict:d,riskPenalty:c,avgFeeMultiplier:+o.toFixed(2),spikeCount:r,topFeeHashes:u}}function Af(e,t){let n=[],s=new Map;for(let{tx:r}of e){if(r.TransactionType!=="Payment"||r.Account!==t)continue;let l=r.Destination,c=r.DestinationTag;l&&(s.has(l)||s.set(l,new Set),c!=null&&s.get(l).add(c))}let a=[...s.entries()].filter(([r])=>{let l=Kn(r);return(l==null?void 0:l.type)==="exchange"}),o=0,i=[];for(let[r,l]of s.entries()){let c=Kn(r),d=(c==null?void 0:c.name)||W(r),u=l.size,p=e.filter(({tx:m})=>m.Account===t&&m.Destination===r).length;i.push({dest:r,name:d,uniqueTags:u,txCount:p,tags:[...l].slice(0,10)}),u===1&&p>=5&&(c==null?void 0:c.type)==="exchange"?n.push({sev:"info",label:`${d}: ${p} payments all using tag ${[...l][0]}`,detail:`Single destination tag used across all ${p} payments to ${d}. This is the normal pattern for one person funding their own exchange account.`}):u>10&&(c==null?void 0:c.type)==="exchange"?(o=Math.max(o,8),n.push({sev:"warn",label:`${d}: ${u} different destination tags used`,detail:`${p} payments to ${d} used ${u} different tags \u2014 each tag typically identifies a different customer account. Funding many exchange sub-accounts can indicate either a service (legitimate) or coordinated deposit layering where funds are spread across many exchange wallets to avoid detection.`})):u===0&&p>=2&&(c==null?void 0:c.type)==="exchange"&&n.push({sev:"warn",label:`${d}: ${p} payments with no destination tag`,detail:"Payments to exchange addresses without a destination tag may not be credited. Most exchanges require a tag to identify which customer account receives the funds."})}return n.length===0&&s.size>0?n.push({sev:"ok",label:"Destination tag patterns normal",detail:"Payment routing tags are consistent with regular outbound payments."}):s.size===0&&n.push({sev:"info",label:"No outbound payments to analyse for destination tags",detail:"No outbound Payment transactions found in history."}),{signals:n,riskPenalty:o,tagProfiles:i}}function Nf(e,t){var c,d;let n=[],s=e.filter(({tx:u})=>u.TransactionType==="Payment"&&u.Account===t&&(Array.isArray(u.Paths)&&u.Paths.length>0||u.SendMax!=null));if(s.length===0)return{signals:[],riskPenalty:0,roundTripCount:0,deepHopCount:0,selfRoutedCount:0,noData:!0};let a=s.length<5?` (small sample: ${s.length} path payments found \u2014 patterns may not be statistically significant)`:"",o=s.filter(({tx:u})=>{let p=typeof u.Amount=="string",m=typeof u.SendMax=="string";return p&&m}),i=s.filter(({tx:u})=>Array.isArray(u.Paths)?u.Paths.some(p=>Array.isArray(p)&&p.length>=3):!1),r=s.filter(({tx:u})=>u.Destination===t),l=0;return o.length>=1&&(l+=12,n.push({sev:"warn",label:`${o.length} XRP\u2192IOU\u2192XRP round-trip path payments`,detail:`Sending XRP and receiving XRP via intermediate token pairs means the payment routes through the DEX and creates trading volume without changing economic position. ${o.length} occurrences suggests this is deliberate. This is the classic cross-currency wash-trading arb pattern on XRPL. Example hash: ${(d=(c=o[0])==null?void 0:c.tx)!=null&&d.hash?W(o[0].tx.hash):"N/A"}.`,hashes:o.slice(0,5).map(({tx:u})=>u.hash).filter(Boolean)})),i.length>=1&&(l+=6,n.push({sev:"info",label:`${i.length} path payments with \u22653 intermediate hops`,detail:"Deep routing chains (3+ hops) can indicate: legitimate arbitrage, liquidity optimization, or deliberate obfuscation of fund origin. Check each transaction for the intermediate issuers in the path."})),r.length>0&&(l+=15,n.push({sev:"critical",label:`${r.length} path payment(s) where sender = destination`,detail:`Money sent to your own address via a multi-hop path creates DEX trading volume with no net change in balance. This is a direct wash-trading technique: the path through the order book generates artificial volume on every intermediate pair. Hashes: ${r.slice(0,3).map(({tx:u})=>W(u.hash||"")).join(", ")}.`,hashes:r.slice(0,5).map(({tx:u})=>u.hash).filter(Boolean)})),n.length===0&&n.push({sev:"ok",label:`${s.length} path payment(s) \u2014 no suspicious routing patterns${a}`,detail:"No circular routing (XRP\u2192IOU\u2192XRP), self-routing, or unusual deep hop chains detected."}),{signals:n,riskPenalty:l,roundTripCount:o.length,deepHopCount:i.length,selfRoutedCount:r.length}}function _f(e,t){var u;let n=new Map,s=[];for(let{tx:p,meta:m}of e){if(p.TransactionType!=="Payment"||p.Destination!==t)continue;let f=p.Account;if(!f||f===t)continue;let g=0,h=null,w=(m==null?void 0:m.delivered_amount)||p.Amount;typeof w=="string"?g=Number(w)/1e6:w!=null&&w.value&&(h={value:Number(w.value),currency:vn(w.currency),issuer:w.issuer});let k=Bt(p);s.push({src:f,amtXrp:g,amtToken:h,ts:k,hash:p.hash||"",destTag:p.DestinationTag}),n.has(f)||n.set(f,{addr:f,totalXrp:0,txCount:0,firstSeen:k,lastSeen:k,entity:Kn(f)||null});let v=n.get(f);v.totalXrp+=g,v.txCount++,v.lastSeen=Math.max(v.lastSeen,k),v.firstSeen=Math.min(v.firstSeen,k)}let a=[...n.values()].sort((p,m)=>m.totalXrp-p.totalXrp||m.txCount-p.txCount).slice(0,10),o=a.reduce((p,m)=>p+m.totalXrp,0),i=a.filter(p=>{var m;return((m=p.entity)==null?void 0:m.type)==="exchange"}),r={};for(let p of s){if(p.amtXrp<=0)continue;let m=Math.round(p.amtXrp/10)*10;r[m]=(r[m]||0)+1}let l=Object.entries(r).sort((p,m)=>m[1]-p[1])[0],c=l&&l[1]>=5&&l[1]/s.length>.4,d=[];if(i.length){let p=[...new Set(i.map(m=>m.entity.name))].join(", ");d.push({sev:"info",label:`Funding from ${i.length} known exchange(s): ${p}`,detail:`${I(i.reduce((m,f)=>m+f.totalXrp,0),2)} XRP received from exchange withdrawals \u2014 typical for a personal trading wallet.`})}if(c&&d.push({sev:"warn",label:`Structured inbound pattern: ${l[1]} payments near ~${l[0]} XRP`,detail:`Over 40% of inbound payments cluster around the same amount (~${l[0]} XRP). Structured deposits can indicate layering \u2014 deliberately splitting large amounts into smaller equal transfers to avoid detection.`}),n.size===1&&s.length>=5){let p=a[0];d.push({sev:"info",label:`Single funding source: all ${s.length} inbound payments from one address`,detail:`${((u=p.entity)==null?void 0:u.name)||W(p.addr)} is the sole funding source. This is normal for a personal wallet but notable for a wallet claiming broad community usage.`})}return!d.length&&s.length>0&&d.push({sev:"ok",label:`${s.length} inbound payment(s) from ${n.size} source(s)`,detail:`Total received: ${I(o,2)} XRP. No unusual inbound patterns.`}),s.length===0&&d.push({sev:"info",label:"No inbound payments found in analysed history",detail:"Wallet may be funded via DEX activity or in ledgers outside the analysed range."}),{signals:d,topSources:a,totalIn:o,uniqueSources:n.size,timeline:s.slice(-20).reverse(),exchangeSrcs:i,structuredFlag:!!c}}function Rf(e,t){var l,c;let n=[],s=[],a=[/airdrop/i,/claim.*reward/i,/free.*xrp/i,/verify.*wallet/i,/support.*team/i,/urgent/i,/suspended/i,/confirm.*seed/i,/your.*account.*hold/i,/unlock/i];for(let{tx:d}of e)if((l=d.Memos)!=null&&l.length)for(let u of d.Memos){let p=((c=u.Memo)==null?void 0:c.MemoData)||"";if(!p)continue;let m="";try{m=decodeURIComponent(p.replace(/../g,f=>"%"+f))}catch{m=p}if(!m||m===p)try{let f="";for(let g=0;g<p.length;g+=2){let h=parseInt(p.slice(g,g+2),16);h>=32&&h<127&&(f+=String.fromCharCode(h))}f.length>4&&(m=f)}catch{}s.push({tx:d.hash||"",type:d.TransactionType,sender:d.Account,text:m.slice(0,200),raw:p})}if(s.length===0)return{signals:[],allMemos:[],scamMemos:[],repeatedMemos:[]};let o=s.filter(d=>a.some(u=>u.test(d.text)));o.length&&n.push({sev:"critical",label:`${o.length} memo(s) match known scam patterns`,detail:`Memos containing phrases like "airdrop", "claim reward", "verify wallet", or "urgent" are used in social engineering attacks. These payments were likely sent to trick the recipient into taking action. Examples: ${o.slice(0,2).map(d=>'"'+d.text.slice(0,40)+'"').join(", ")}`});let i={};for(let d of s){let u=d.text.slice(0,50).trim().toLowerCase();u.length>3&&(i[u]=(i[u]||0)+1)}let r=Object.entries(i).filter(([,d])=>d>=3).sort((d,u)=>u[1]-d[1]);return r.length&&n.push({sev:"warn",label:`${r.length} memo text(s) repeated \u22653 times`,detail:`Identical memo text across multiple transactions suggests scripted or automated activity. Most repeated: "${r[0][0]}" (${r[0][1]}\xD7)`}),n.length||n.push({sev:"ok",label:`${s.length} memo(s) found \u2014 no suspicious patterns`,detail:"Memo content looks normal."}),{signals:n,allMemos:s,scamMemos:o,repeatedMemos:r.slice(0,5)}}function Df(e,t,n){let s=e.filter(u=>u.LedgerEntryType==="Escrow");if(!s.length)return{signals:[],escrows:[],hasThirdParty:!1};let a=[],o=Math.floor(Date.now()/1e3),i=946684800,r=s.map(u=>{let p=u.Account||null,m=u.Destination||null,f=Number(u.Amount||0)/1e6,g=u.FinishAfter?u.FinishAfter+i:null,h=u.CancelAfter?u.CancelAfter+i:null,w=p&&p!==n&&m===n,k=p===n&&m===n,v=g?Math.ceil((g-o)/86400):null;return{creator:p,dest:m,amtXrp:f,finishAfter:g,cancelAfter:h,isThirdParty:w,isSelfEscrow:k,daysToFinish:v,conditional:!!u.Condition}}),l=r.filter(u=>u.isThirdParty),c=r.reduce((u,p)=>u+p.amtXrp,0);l.length&&a.push({sev:"warn",label:`${l.length} escrow(s) created by external account(s) \u2014 funds locked to this address`,detail:`${I(l.reduce((u,p)=>u+p.amtXrp,0),2)} XRP in escrows that an outside party controls. The creator sets the conditions. Escrows created by attackers just before a drain attempt have been observed in some compromise patterns \u2014 verify who created these.`});let d=r.filter(u=>u.daysToFinish!=null&&u.daysToFinish>=0&&u.daysToFinish<=7);return d.length&&a.push({sev:"info",label:`${d.length} escrow(s) mature within 7 days`,detail:`${I(d.reduce((u,p)=>u+p.amtXrp,0),2)} XRP will become claimable soon. If these are third-party escrows, the creator can claim funds once the condition is met.`}),a.length||a.push({sev:"ok",label:`${s.length} self-escrow(s) \u2014 ${I(c,2)} XRP locked`,detail:"All escrows appear to be self-controlled time-locks. No third-party escrow risk."}),{signals:a,escrows:r,hasThirdParty:l.length>0,totalLocked:c}}function If(e){let t=e.filter(l=>l.LedgerEntryType==="Check");if(!t.length)return{signals:[],checks:[]};let n=[],s=946684800,a=Math.floor(Date.now()/1e3),o=t.map(l=>{let c=typeof l.SendMax=="string"?Number(l.SendMax)/1e6:null,d=typeof l.SendMax=="object"?l.SendMax:null,u=l.Expiration?l.Expiration+s:null,p=(l.ledger_index,null),m=u&&u<a;return{sender:l.Account,dest:l.Destination,amtXrp:c,amtToken:d,expiry:u,expired:m,id:l.index||""}}),i=o.filter(l=>l.amtXrp&&l.amtXrp>100),r=o.filter(l=>l.expired);return i.length&&n.push({sev:"info",label:`${i.length} large uncashed check(s) \u2014 ${I(i.reduce((l,c)=>l+(c.amtXrp||0),0),2)} XRP pending`,detail:"Open checks can be cashed by the recipient at any time before expiry. Large uncashed checks represent a future outflow commitment."}),r.length&&n.push({sev:"info",label:`${r.length} expired check(s) \u2014 should be cancelled to reclaim reserve`,detail:"Expired checks still occupy owner reserve slots (2 XRP each). Cancelling them returns the reserved XRP."}),n.length||n.push({sev:"ok",label:`${t.length} check(s) found \u2014 no unusual patterns`,detail:"Check amounts are within normal range."}),{signals:n,checks:o}}function Ff(e,t){var m,f,g;if(!e||!((m=e.offers)!=null&&m.length))return{signals:[],hasData:!1};let{pair:n,offers:s}=e,a=[],o=new Map;for(let h of s){let w=h.Account,k=typeof h.TakerGets=="string"?Number(h.TakerGets)/1e6:Number(((f=h.TakerGets)==null?void 0:f.value)||0);o.set(w,(o.get(w)||0)+k)}let i=[...o.values()].reduce((h,w)=>h+w,0),r=o.get(t)||0,l=i>0?r/i:0,d=[...s].sort((h,w)=>{var x,S;let k=typeof h.TakerGets=="string"?Number(h.TakerGets)/1e6:Number(((x=h.TakerGets)==null?void 0:x.value)||0);return(typeof w.TakerGets=="string"?Number(w.TakerGets)/1e6:Number(((S=w.TakerGets)==null?void 0:S.value)||0))-k})[0],u=typeof(d==null?void 0:d.TakerGets)=="string"?Number(d.TakerGets)/1e6:Number(((g=d==null?void 0:d.TakerGets)==null?void 0:g.value)||0),p=i>0?u/i:0;return p>.4&&(d==null?void 0:d.Account)===t?a.push({sev:"critical",label:`Active wall order: this wallet controls ${(p*100).toFixed(0)}% of current book depth`,detail:`A single order from this address represents ${(p*100).toFixed(0)}% of the visible order book depth on pair ${n}. Large orders placed to make a market look deeper than it is \u2014 without intent to fill \u2014 is spoofing. This order is live right now.`}):p>.4&&a.push({sev:"warn",label:`Wall order present: ${(p*100).toFixed(0)}% of book depth in one order`,detail:`A single address controls ${(p*100).toFixed(0)}% of the current order book for pair ${n}. Wall orders dominate book depth and can be removed instantly \u2014 they create false liquidity signals.`}),l>.25&&a.push({sev:"info",label:`This wallet controls ${(l*100).toFixed(0)}% of current order book depth`,detail:`${I(r,2)} of ${I(i,2)} total book volume on pair ${n}.`}),a.length||a.push({sev:"ok",label:`Live order book looks normal (${s.length} orders, pair: ${n.split("\u2194").map(h=>h.split("+")[0]).join("\u2194")})`,detail:"No wall orders or unusual depth concentration detected in the current order book."}),{signals:a,hasData:!0,pair:n,offerCount:s.length,ourShare:l,wallShare:p}}function Bf(e,t,n,s,a,o,i,r,l,c,d,u,p,m){var g,h;return[{label:"Security",pts:Math.round((100-t.score)*.4),max:40,color:"#ff5555",icon:"\u{1F510}"},{label:"Drain Risk",pts:{low:0,medium:10,high:25,critical:35}[n.riskLevel]||0,max:35,color:"#ff5555",icon:"\u26A0\uFE0F"},{label:"Wash Trading",pts:Math.min(15,Math.round((a.score||0)*.15)),max:15,color:"#ffb86c",icon:"\u{1F4CA}"},{label:"NFT Risk",pts:Math.min(15,s.flags.filter(w=>w.sev==="critical").length*8+s.flags.filter(w=>w.sev==="warn").length*3),max:15,color:"#bd93f9",icon:"\u{1F3A8}"},{label:"Benford's",pts:(o==null?void 0:o.chiSq)>20.09?10:(o==null?void 0:o.chiSq)>15.51?5:0,max:10,color:"#f1fa8c",icon:"\u{1F4D0}"},{label:"Forensic Suite",pts:Math.min(20,Math.min(8,Math.round(((r==null?void 0:r.riskPenalty)||0)*.35))+Math.min(8,Math.round(((l==null?void 0:l.riskPenalty)||0)*.4))+Math.min(8,Math.round(((c==null?void 0:c.riskPenalty)||0)*.35))+Math.min(8,Math.round(((d==null?void 0:d.riskPenalty)||0)*.35))),max:20,color:"#00d4ff",icon:"\u{1F9EC}"},{label:"Vol Conc",pts:Math.min(10,(((g=i==null?void 0:i.signals)==null?void 0:g.filter(w=>w.sev==="critical").length)||0)*6+(((h=i==null?void 0:i.signals)==null?void 0:h.filter(w=>w.sev==="warn").length)||0)*3),max:10,color:"#ffb86c",icon:"\u{1FAE7}"},{label:"Fee Spikes",pts:Math.min(5,(u==null?void 0:u.riskPenalty)||0),max:5,color:"#ffb86c",icon:"\u{1F4B8}"}].filter(w=>w.pts>0)}function Xf(e,t,n,s,a,o,i,r,l,c,d=null){let u=0;u+=Math.round((100-e.score)*.4),u+={low:0,medium:10,high:25,critical:35}[t.riskLevel]||0;let m=n.flags.filter(g=>g.sev==="critical").length,f=n.flags.filter(g=>g.sev==="warn").length;if(u+=Math.min(15,m*8+f*3),u+=Math.min(15,Math.round(s.score*.15)),(a==null?void 0:a.chiSq)!=null&&(a.chiSq>20.09?u+=10:a.chiSq>15.51&&(u+=5)),o!=null&&o.signals){let g=o.signals.filter(w=>w.sev==="critical").length,h=o.signals.filter(w=>w.sev==="warn").length;u+=Math.min(10,g*6+h*3)}return i!=null&&i.riskPenalty&&(u+=Math.min(8,Math.round(i.riskPenalty*.35))),r!=null&&r.riskPenalty&&(u+=Math.min(8,Math.round(r.riskPenalty*.4))),l!=null&&l.riskPenalty&&(u+=Math.min(8,Math.round(l.riskPenalty*.35))),c!=null&&c.riskPenalty&&(u+=Math.min(8,Math.round(c.riskPenalty*.35))),d!=null&&d.riskPenalty&&(u+=Math.min(5,d.riskPenalty)),Math.min(100,u)}function Of(e){var h;let t=document.getElementById("inspect-benfords-body");if(!t)return;let n={critical:"sev-critical",warn:"sev-warn",info:"sev-info",ok:"sev-ok"},s=e.signals.map(w=>`
    <div class="finding finding--${w.sev}">
      <span class="finding-sev ${n[w.sev]||""}">${w.sev.toUpperCase()}</span>
      <div class="finding-body">
        <div class="finding-label">${b(w.label)}</div>
        <div class="finding-detail">${b(w.detail)}</div>
      </div>
    ...
    <div class="benford-grid">
      ...
      ${e.digitBreakdown.map(w=>{let k=parseFloat(w.obs),v=parseFloat(w.exp),x=k-v,S=Math.abs(x)>5?"#ff5555":Math.abs(x)>2.5?"#ffb86c":"#50fa7b",T=`<div style="height:6px;border-radius:3px;background:rgba(255,255,255,.08);overflow:hidden">
  ...
  `;t.innerHTML=s+o+a+g}function Hf(e){var o;let t=document.getElementById("inspect-volconc-body");if(!t)return;let n={critical:"sev-critical",warn:"sev-warn",info:"sev-info",ok:"sev-ok"},s=e.signals.map(i=>`
    ...
    </div>`).join("");s.innerHTML=o+(n||"")}function zf(e){let t=[["Sample size",e.sampleSize],["Amount entropy",e.amountEntropy!=null?e.amountEntropy.toFixed(2)+" bits":"\u2014",e.amountEntropy!=null&&e.amountEntropy<2?"risk-text-high":""],["Counterparty entropy",e.counterpartyEntropy!=null?e.counterpartyEntropy.toFixed(2)+" bits":"\u2014"],["Time-of-day entropy",e.timeEntropy!=null?e.timeEntropy.toFixed(2)+" bits":"\u2014"],["Unique counterparties",e.uniqueCounterparties],["Verdict",e.verdict,e.verdict==="anomalous"?"risk-text-high":e.verdict==="elevated"?"risk-text-med":""]];da("inspect-entropy-body",e,'<div class="wash-stat-row" style="margin-top:10px"><span>Metric</span><span class="mono" style="opacity:.45">Value</span></div>'+t.map(([n,s,a])=>`<div class="wash-stat-row"><span>${n}</span><span class="mono ${a||""}">${s}</span></div>`).join(""))}function Uf(e){var s;let t=[["Unique counterparties",e.uniqueCounterparties],["Zipf exponent (s)",e.zipfExponent!=null?e.zipfExponent.toFixed(3):"\u2014",e.zipfExponent!=null&&(e.zipfExponent<.4||e.zipfExponent>2.2)?"risk-text-high":""],["Fit quality (R\xB2)",e.rSquared!=null?e.rSquared.toFixed(3):"\u2014",e.rSquared!=null&&e.rSquared<.55?"risk-text-high":""],["Natural range","s \u2248 0.8\u20131.3, R\xB2 > 0.55"],["Verdict",e.verdict,e.verdict==="anomalous"?"risk-text-high":e.verdict==="elevated"?"risk-text-med":""]],n=((s=e.freqTable)==null?void 0:s.slice(0,10).map((a,o)=>{let i=e.freqTable[0]||1,r=(a/i*100).toFixed(0),l=e.freqTable[0]?(e.freqTable[0]/Math.pow(o+1,e.zipfExponent||1)).toFixed(1):0;return`<div class="wash-stat-row">
    ...
    </div>`},a=[["Time windows",e.windowCount||"\u2014"],["OfferCreate\u2192Cancel \u03C1",t?t.maxCorr.toFixed(3):"\u2014",t&&t.maxCorr>.55?"risk-text-high":""],["OC lag",t?`${t.maxLag} window${t.maxLag===1?"":"s"} (${t.maxLag*12}h)`:"\u2014"],["Inflow\u2192Outflow \u03C1",n?n.maxCorr.toFixed(3):"\u2014",n&&n.maxCorr>.65?"risk-text-high":""],["IO lag",n?`${n.maxLag} window${n.maxLag===1?"":"s"}`:"\u2014"],["Verdict",e.verdict,e.verdict==="causal-signal"?"risk-text-high":e.verdict==="elevated"?"risk-text-med":""]];da("inspect-granger-body",e,a.map(([o,i,r])=>`<div class="wash-stat-row" style="margin-top:${o==="Time windows"?10:0}px"><span>${o}</span><span class="mono ${r||""}">${i}</span></div>`).join("")+s(t==null?void 0:t.ccf,"OFFER-CREATE \u2192 CANCEL CROSS-CORRELATION")+s(n==null?void 0:n.ccf,"INFLOW \u2192 OUTFLOW CROSS-CORRELATION"))}function qf(e,t,n,s,a){let o=document.getElementById("inspect-forensic-suite-body");if(!o)return;let i=(k,v=25)=>{if(!k||k.verdict==="insufficient")return null;if(k.chiSq!=null)return k.verdict==="high-deviation"?{val:v,cls:"risk-text-high",label:"HIGH DEVIATION"}:k.verdict==="moderate-deviation"?{val:Math.round(v*.5),cls:"risk-text-med",label:"MODERATE"}:{val:0,cls:"",label:"NORMAL"};let x=k.riskPenalty||0;return x>=18?{val:v,cls:"risk-text-high",label:"ANOMALOUS"}:x>=8?{val:Math.round(v*.5),cls:"risk-text-med",label:"ELEVATED"}:{val:0,cls:"",label:"NORMAL"}},r=[{name:"Benford's Law",icon:"\u{1F4D0}",desc:"First-digit digit distribution vs log-uniform expected",s:i(e)},{name:"Shannon's Entropy",icon:"\u{1F500}",desc:"Randomness of amounts, counterparties, time-of-day, tx types",s:i(t)},{name:"Zipf's Law",icon:"\u{1F4C8}",desc:"Counterparty rank-frequency power-law fit",s:i(n)},{name:"Time Series",icon:"\u{1F550}",desc:"Interval regularity, periodicity, burst detection, autocorrelation",s:i(s)},{name:"Granger Causality",icon:"\u{1F517}",desc:"Lead-lag temporal causality: create\u2192cancel, inflow\u2192outflow",s:i(a)}],l=r.some(k=>k.s&&k.s.val>0),c=r.filter(k=>{var v;return((v=k.s)==null?void 0:v.cls)==="risk-text-high"}).length,d=r.filter(k=>{var v;return((v=k.s)==null?void 0:v.cls)==="risk-text-med"}).length,u=r.filter(k=>!k.s).length,p,m,f;c>=3?(p="STRONG MANIPULATION SIGNALS \u2014 Multiple independent engines converging on anomalous patterns.",m="#ff5555",f="\u{1F6A8}"):c>=2||c>=1&&d>=2?(p="SIGNIFICANT ANOMALIES \u2014 At least two engines detect non-organic behavior. Cross-reference with Wash Trading and Drain Risk.",m="#ff5555",f="\u26A0\uFE0F"):c>=1||d>=2?(p="ELEVATED RISK \u2014 One or more engines flag behavioral anomalies. Investigate the specific modules for detail.",m="#ffb86c",f="\u26A0\uFE0F"):!l&&u<3?(p="NO ANOMALIES \u2014 All five engines return results consistent with organic financial activity.",m="#50fa7b",f="\u2705"):(p="INSUFFICIENT DATA \u2014 More transaction history needed for a reliable multi-engine assessment.",m="rgba(255,255,255,.4)",f="\u{1F4CA}");let g=r.map(k=>{let v=!k.s,x=v?"rgba(255,255,255,.25)":k.s.val===0?"#50fa7b":k.s.cls==="risk-text-high"?"#ff5555":"#ffb86c",S=v?"NO DATA":k.s.label,T=v?0:k.s.val===0?4:k.s.cls==="risk-text-high"?100:55;return`<div style="background:rgba(255,255,255,.025);border:1px solid rgba(255,255,255,.07);border-radius:12px;padding:14px 14px 12px">
    ...
    </div>`}function Vf(e,t,n,s,a,o,i,r=null,l=null){let c=y("inspect-addr-badge");c&&(c.textContent=e.length>20?e.slice(0,10)+"\u2026"+e.slice(-8):e,c.title=e,c.dataset.fullAddr=e);let d=y("inspect-risk-score");d&&(d.textContent=i,d.className="irb-score-val "+$o(i));let u=y("inspect-risk-label");u&&(u.textContent=i<20?"Low Risk":i<45?"Moderate":i<70?"High Risk":"Critical",u.className="irb-score-label "+$o(i));let p=y("inspect-acct-grid");if(!p)return;let m=Math.max(0,n-s),f=Number(t.Flags||0),g=r!=null?r===0?"Created today":r===1?"1 day old":r<30?`${r} days old`:r<365?`${Math.floor(r/30)} months old`:`${(r/365).toFixed(1)} years old`:"\u2014",h=l?new Date(l).toLocaleDateString("en-US",{year:"numeric",month:"short",day:"numeric"}):null,w=en(n),k=en(m),v=[{label:"XRP Balance",value:`${I(n,6)} XRP${w}`,mono:!0},{label:"Spendable",value:`${I(m,6)} XRP${k}`,mono:!0,note:`${s} XRP reserved`},{label:"Wallet Age",value:g,note:h?`Created ${h}`:null,highlight:r!=null&&r<7?"new":null},{label:"Owner Count",value:a,note:`${a*2} XRP tied up`},{label:"Sequence",value:o,mono:!0},{label:"Regular Key",value:t.RegularKey?W(t.RegularKey):"None",warn:!!t.RegularKey,mono:!0},{label:"Master Key",value:f&Xe.lsfDisableMaster?"Disabled":"Active",warn:!!(f&Xe.lsfDisableMaster)}];p.innerHTML=v.map(x=>`
    <div class="acct-cell ${x.warn?"acct-cell--warn":""} ${x.highlight==="new"?"acct-cell--new":""}">
      <div class="acct-cell-label">${b(x.label)}</div>
      <div class="acct-cell-value ${x.mono?"mono":""}">${b(String(x.value))}</div>
      ${x.note?`<div class="acct-cell-note">${b(x.note)}</div>`:""}
      ${x.highlight==="new"?'<div class="acct-cell-new-badge">\u26A0 New wallet</div>':""}
    </div>`).join("")}function Gf(e,t,n,s,a){let o=y("inspect-security-body");if(!o)return;let i=Object.entries(Xe).filter(([,r])=>n&r).map(([r])=>r.replace("lsf",""));o.innerHTML=`
        ...
        <div class="signer-entries">
          ${(r.SignerEntries||[]).map(l=>{var c,d;return`
            <div class="signer-entry">
              <span class="signer-addr mono">${b(((c=l.SignerEntry)==null?void 0:c.Account)||"\u2014")}</span>
    ...
    <div class="audit-note">
      ...
      ${a.slice(0,8).map(r=>`<span class="mono">${W(r.Authorize||"")}</span>`).join(", ")}
      ${a.length>8?`+${a.length-8} more`:""}
    </div>`:""}
  `,pa("badge-security",e.findings)}function Kf(e,t,n,s){let a=y("inspect-drain-body");if(!a)return;let o={low:"#50fa7b",medium:"#ffb86c",high:"#ff8c42",critical:"#ff5555"},i={low:"\u2713",medium:"\u26A0",high:"\u26A0",critical:"\u26D4"};a.innerHTML=`
    ...
    <div class="drain-sub-section">
      ...
      ${t.map(r=>`
        <div class="drain-channel-row">
          <span class="mono">${W(r.Destination)}</span>
          <span>${I(Number(r.Amount||0)/1e6,2)} XRP allocated</span>
          <span>${I(Number(r.Balance||0)/1e6,2)} XRP claimed</span>
        </div>`).join("")}
    </div>`:""}
    ${n.length?`
    <div class="drain-sub-section">
      ...
      ${n.slice(0,5).map(r=>`
        <div class="drain-channel-row">
          <span>${r.Destination?W(r.Destination):"self"}</span>
          <span>${I(Number(r.Amount||0)/1e6,2)} XRP</span>
          <span class="mono">${r.Condition?"conditional":r.FinishAfter?"time-locked":""}</span>
        </div>`).join("")}
    </div>`:""}
  `,Sh("badge-drain",e.riskLevel)}function Jf(e,t){let n=y("inspect-nft-body");n&&(n.innerHTML=`
    <div class="audit-items">
      ${e.flags.map(s=>bn(s)).join("")}
    </div>
    ${t.length?`
    <div class="nft-grid">
      ${t.slice(0,12).map(s=>Yf(s)).join("")}
    </div>
    ${t.length>12?`<div class="nft-more">+${t.length-12} more NFTs</div>`:""}
    `:""}
  `,pa("badge-nft",e.flags))}function Yf(e){let t=Number(e.Flags||0),n=!!(t&gl.lsfTransferable),s=!!(t&gl.lsfBurnable),a=e.NFTokenTaxon||0,o=e.TransferFee?`${(e.TransferFee/1e3).toFixed(1)}%`:"0%";return`
    <div class="nft-card">
    ...
    </div>`}function Qf(e){let t=y("inspect-wash-body");if(!t)return;let n=e.verdict==="clean"||e.verdict==="low-risk"?"#50fa7b":e.verdict==="suspicious"?"#ffb86c":"#ff5555";t.innerHTML=`
      ...
      ${s.slice(0,10).map(a=>`
        <div class="trustline-row">
          ...
          <span class="trustline-balance ${Number(a.balance)<0?"trustline-owed":""} mono">
            ${Number(a.balance)<0?"\u25BC ":""}${I(Math.abs(Number(a.balance)),2)}
  ...
  `,pa("badge-issuer",e.signals)}function eh(e,t){let n=y("inspect-amm-body");n&&(n.innerHTML=`
    <div class="audit-items">
      ...
      ${e.positions.map(s=>`
        <div class="amm-position-card">
          ...
          <div class="amm-position-meta">
            ...
            <span class="amm-position-balance">${I(Math.abs(s.balance),4)} LP tokens</span>
          </div>
        </div>`).join("")}
    </div>`:""}
  `,pa("badge-amm",e.signals))}function th(e){let t=y("trust-count-badge");t&&(t.textContent=e.length);let n=y("inspect-trust-body");n&&(n.innerHTML=e.length?e.map(s=>{let a=s.freeze?'<span class="trustline-frozen">Frozen</span>':"",o=s.freeze_peer?'<span class="trustline-frozen trustline-frozen--peer">Issuer Frozen</span>':"",i=s.no_ripple?'<span class="trustline-norip">NoRipple</span>':"";return`
          <div class="trustline-row">
          ...
          </div>`}).join(""):'<div class="inspect-empty-note">No transactions found.</div>',e.length>s&&(n.innerHTML+=`<div class="tx-more">Showing ${s} of ${e.length} transactions</div>`)}function Cl(e,t,n){let s=Number((n==null?void 0:n.totalIn)||0),a=Number((t==null?void 0:t.totalOut)||0),o=Number(e||0);if(s<=0&&a<=0)return"";let i=new Set(((t==null?void 0:t.blackHoleDests)||[]).map(x=>x.addr)),r=new Set(((t==null?void 0:t.exchangeDests)||[]).map(x=>x.addr)),l=new Set(((t==null?void 0:t.newWalletDests)||[]).map(x=>x.addr)),c=0,d=0,u=0,p=0;for(let x of(t==null?void 0:t.destinations)||[])i.has(x.addr)?c+=x.totalXrp:r.has(x.addr)?d+=x.totalXrp:l.has(x.addr)?u+=x.totalXrp:p+=x.totalXrp;let m=Math.max(s,a,o,1),f=x=>(x>0?Math.max(1.5,x/m*100):0).toFixed(1),g=[{label:"Black hole",xrp:c,color:"#ff5555"},{label:"Exchange",xrp:d,color:"#00d4ff"},{label:"New wallet",xrp:u,color:"#ffb86c"},{label:"Other",xrp:p,color:"rgba(255,255,255,.28)"}].filter(x=>x.xrp>0),h=a>0?Math.max(1.5,a/m*100):0,w=g.map(x=>`<div style="width:${(a>0?x.xrp/a*100:0).toFixed(1)}%;background:${x.color};height:100%" title="${b(x.label)}: ${I(x.xrp,2)} XRP"></div>`).join(""),k=(x,S,T,$,P)=>`
    <div style="display:flex;align-items:center;gap:10px;margin-bottom:8px">
      ...
      <div class="mono" style="width:92px;text-align:right;font-size:.75rem;color:rgba(255,255,255,.75);flex-shrink:0">${I(S,2)} XRP</div>
    </div>`,v=g.map(x=>`<span style="font-size:.66rem;color:${x.color};margin-right:12px">\u25CF ${b(x.label)} ${I(x.xrp,0)}</span>`).join("");return`
    ...
    <div class="flow-summary">
      ...
      <div class="flow-stat"><span>Total XRP out</span><b class="mono">${I(e.totalOut,2)}</b></div>
    ...
    <div class="flow-dest-list">
      ${e.destinations.map((c,d)=>{var g,h,w,k;let u=e.totalOut>0?c.totalXrp/e.totalOut*100:0,p=c.entity?`<span class="flow-entity-badge flow-entity--${c.entity.type}">${b(c.entity.name)}</span>`:"",m=c.pathCount>0?`<span class="flow-path-badge">${c.maxHops}-hop path \xD7${c.pathCount}</span>`:"",f=c.tokens.slice(0,2).map(v=>`<span class="flow-token-chip">${b(v.k.split(".")[0])}</span>`).join("");return`
          <div class="flow-dest-row">
            <div class="flow-dest-rank ${((g=c.entity)==null?void 0:g.type)==="exchange"?"flow-rank--exchange":((h=c.entity)==null?void 0:h.type)==="blackhole"?"flow-rank--blackhole":""}">${d+1}</div>
            <div class="flow-dest-info">
              <div class="flow-dest-top">
                <button class="addr-link mono cut flow-dest-addr" data-addr="${b(c.addr)}" title="${b(c.addr)}">${b(W(c.addr))}</button>
                <a href="https://xrpscan.com/account/${b(c.addr)}" target="_blank" rel="noopener" class="tx-explorer-link" title="View on XRPScan">\u{1F50D}</a>
                ${p}${m}${f}
              </div>
              ...
              <div class="flow-dest-meta">
                <span class="mono">${I(c.totalXrp,2)} XRP</span>
                <span class="flow-dest-cnt">${c.txCount} tx</span>
                ${c.txCount>1?`<span class="flow-dest-span">${ah(c.firstSeen,c.lastSeen)}</span>`:""}
              </div>
            </div>
          </div>`}).join("")}
    </div>
    ...
    <div class="flow-timeline">
      ${e.timeline.map(c=>{let d=new Date(c.ts*1e3).toLocaleDateString(),u=new Date(c.ts*1e3).toLocaleTimeString([],{hour:"2-digit",minute:"2-digit"}),p=c.amtXrp>0?`${I(c.amtXrp,2)} XRP`:c.amtToken?`${I(c.amtToken.value,2)} ${c.amtToken.currency}`:"\u2014",m=Kn(c.dest),f=m?`<span class="flow-entity-badge flow-entity--${m.type}" style="font-size:.65rem">${b(m.name)}</span>`:"";return`
          <div class="flow-tx-row">
            <span class="flow-tx-date">${d} ${u}</span>
            <button class="addr-link mono cut flow-tx-dest" data-addr="${b(c.dest)}" title="${b(c.dest)}">${b(W(c.dest))}</button>
            ${f}
            <span class="flow-tx-amt mono">${p}</span>
            ${c.isPathPay?`<span class="flow-path-tag">${c.hopCount}-hop</span>`:""}
          </div>`}).join("")}
    </div>
  `,a){let c=e.blackHoleDests.length||e.exchangeDests.length>2;a.textContent=`${e.uniqueDests} dests`,a.className=`section-badge section-badge--${c?"crit":e.uniqueDests>0?"warn":"ok"}`}}function ah(e,t){if(!e||!t)return"";let n=new Date(e*1e3).toLocaleDateString(),s=new Date(t*1e3).toLocaleDateString();return n===s?n:`${n} \u2013 ${s}`}function oh(e,t){let n=y("inspect-issuer-connections-body");if(!n)return;let s=e.totalIssued,a=y("badge-issuer-connections");if(n.innerHTML=`
    <div class="audit-items">
    ...
    <div class="conn-stats">
      <div class="conn-stat"><span>Total Supply</span><b class="mono">${I(s,0)}</b></div>
    ...
    <div class="conn-holders">
      ${e.topHolders.map((o,i)=>{let r=s>0?o.balance/s*100:0,l=r>50?"#ff5555":r>25?"#ffb86c":r>10?"#f1fa8c":"#50fa7b";return`
          <div class="conn-holder-row">
            ...
            <button class="addr-link mono cut conn-holder-addr" data-addr="${b(o.addr)}" title="${b(o.addr)}">${b(W(o.addr))}</button>
            ...
            <span class="mono conn-holder-amt">${I(o.balance,0)} ${b(o.currency.slice(0,8))}</span>
          </div>`}).join("")}
    </div>`:""}
    ...
    <div class="conn-created-list">
      ${e.createdAccts.slice(0,12).map(o=>`
        <button class="addr-chip mono" data-addr="${b(o)}" title="${b(o)}">${b(W(o))}</button>
      `).join("")}
    ...
    <div class="conn-mirror-list">
      ${e.mirrorGroups.map(o=>`
        <div class="conn-mirror-group">
          <div class="conn-mirror-h">~${I(o.approxAmt,0)} tokens \xB7 ${o.accounts.length} wallets</div>
          <div class="conn-mirror-addrs">
            ${o.accounts.slice(0,8).map(i=>`
              <button class="addr-chip mono" data-addr="${b(i.addr)}" title="${b(i.addr)}">${b(W(i.addr))}</button>
            `).join("")}
  ...
  `,a){let o=e.signals.some(i=>i.sev==="critical")?"crit":e.signals.some(i=>i.sev==="warn")?"warn":e.signals.some(i=>i.sev==="info")?"neutral":"ok";a.className=`section-badge section-badge--${o}`,a.textContent=s>0?`${e.holderCount} holders`:"No issuance"}}function ih(e){var c;let t=document.getElementById("inspect-fee-analysis-body");if(!t||!e)return;let n={critical:"sev-critical",warn:"sev-warn",info:"sev-info",ok:"sev-ok"},s=(e.signals||[]).map(d=>`
    <div class="finding finding--${d.sev}">
      <span class="finding-sev ${n[d.sev]||""}">${d.sev.toUpperCase()}</span>
      <div class="finding-body">
        <div class="finding-label">${b(d.label)}</div>
        <div class="finding-detail">${b(d.detail)}</div>
      </div>
    ...
    ${e.selfRoutedCount?`<div class="wash-stat-row"><span>Self-routed payments</span><span class="mono risk-text-high">${e.selfRoutedCount}</span></div>`:""}`;if(n.innerHTML=o+i,s){let l=e.signals.some(d=>d.sev==="critical"),c=e.signals.some(d=>d.sev==="warn");s.textContent=l?"Critical":c?"Check":"Normal",s.className=`section-badge section-badge--${l?"crit":c?"warn":"ok"}`}}function ch(e){var r,l,c;let t=y("inspect-inbound-body");if(!t)return;let n={critical:"sev-critical",warn:"sev-warn",info:"sev-info",ok:"sev-ok"},s=(e.signals||[]).map(d=>`
    <div class="finding finding--${d.sev}">
      <span class="finding-sev ${n[d.sev]||""}">${d.sev.toUpperCase()}</span>
    ...
    <div class="flow-summary" style="margin-top:10px">
      ...
      <div class="flow-stat"><span>Total XRP received</span><b class="mono">${I(e.totalIn,2)}</b></div>
    ...
    <div class="flow-dest-list">
      ${e.topSources.map((d,u)=>{let p=e.totalIn>0?(d.totalXrp/e.totalIn*100).toFixed(0):0,m=d.entity,f=m?`<span class="flow-entity-badge flow-entity--${m.type}">${b(m.name)}</span>`:"";return`<div class="flow-dest-row">
          <div class="flow-dest-rank">${u+1}</div>
          <div class="flow-dest-info">
            <div class="flow-dest-top">
              <a href="https://xrpscan.com/account/${b(d.addr)}" target="_blank" rel="noopener" class="addr-link mono cut">${b(W(d.addr))}</a>
              ${f}
            </div>
            <div class="flow-bar-row">
    ...
    <div class="wash-stat-row" style="flex-direction:column;align-items:flex-start;gap:2px;padding:6px 0;border-bottom:1px solid rgba(255,255,255,.05)">
      <div style="font-size:.72rem;color:rgba(255,255,255,.35)">${b(l.type)} \xB7 <a href="https://livenet.xrpl.org/transactions/${b(l.tx)}" target="_blank" rel="noopener" style="color:var(--accent);text-decoration:none">${W(l.tx)}</a></div>
      <div style="font-size:.82rem;word-break:break-all;color:rgba(255,255,255,.75)">${b(l.text.slice(0,120))}${l.text.length>120?"\u2026":""}</div>
    </div>`).join("");n.innerHTML=a+`<div style="margin-top:10px;font-size:.72rem;color:rgba(255,255,255,.4);text-transform:uppercase;letter-spacing:.08em;margin-bottom:4px">MEMO CONTENTS (${e.allMemos.length} found)</div>`+o;let i=y("badge-memos");if(i){let l=(e.signals||[]).some(d=>d.sev==="critical"),c=(e.signals||[]).some(d=>d.sev==="warn");i.textContent=l?"Scam text":c?"Patterns":"Normal",i.className=`section-badge section-badge--${l?"crit":c?"warn":"ok"}`}}function ph(e){var l;let t=y("section-escrow-depth"),n=y("inspect-escrow-depth-body");if(!e||!((l=e.escrows)!=null&&l.length)){t&&(t.style.display="none");return}if(t&&(t.style.display=""),!n)return;let s={critical:"sev-critical",warn:"sev-warn",info:"sev-info",ok:"sev-ok"},a=(e.signals||[]).map(c=>`
    ...
    <div class="wash-stat-row">
      ...
      <span class="mono">${I(c.amtXrp,2)} XRP${en(c.amtXrp)}</span>
    ...
    <div class="wash-stat-row">
      ...
      <span class="mono">${l.amtXrp!=null?I(l.amtXrp,2)+" XRP"+en(l.amtXrp):(((c=l.amtToken)==null?void 0:c.value)||"?")+" "+((d=l.amtToken)==null?void 0:d.currency)}</span>
      <span style="font-size:.72rem;${l.expired?"color:#ff5555":"opacity:.55"}">${l.expired?"Expired":"Open"}</span>
    </div>`}).join("");n.innerHTML=a+`<div style="margin-top:10px">${o}</div>`;let i=y("badge-checks");i&&(i.textContent=`${e.checks.length} check${e.checks.length!==1?"s":""}`,i.className="section-badge section-badge--neutral")}function mh(e){let t=y("section-livebook"),n=y("inspect-livebook-body");if(!(e!=null&&e.hasData)){t&&(t.style.display="none");return}if(t&&(t.style.display=""),!n)return;let s={critical:"sev-critical",warn:"sev-warn",info:"sev-info",ok:"sev-ok"},a=(e.signals||[]).map(r=>`
    ...
    ${e.wallShare>.3?`<div class="wash-stat-row"><span>Largest single order share</span><span class="mono ${e.wallShare>.4?"risk-text-high":"risk-text-med"}">${(e.wallShare*100).toFixed(1)}%</span></div>`:""}`;n.innerHTML=a+o;let i=y("badge-livebook");if(i){let r=(e.signals||[]).some(c=>c.sev==="critical"),l=(e.signals||[]).some(c=>c.sev==="warn");i.textContent=r?"Wall order":l?"Check":"Normal",i.className=`section-badge section-badge--${r?"crit":l?"warn":"ok"}`}}function fh(e,...t){let n=y("inspect-risk-breakdown");if(!n)return;let s=Bf(e,...t);if(!s.length){n.innerHTML="";return}let a=Math.max(1,s.reduce((o,i)=>o+i.pts,0));n.innerHTML=`
      ...
      <div class="audit-text">
        ...
        <div class="report-module">
          <div class="report-module-h">
            <span style="margin-right:6px">${Me.icon}</span>${b(E)}
            <span style="font-size:.72rem;font-weight:400;opacity:.45;margin-left:8px">${b(Me.desc)}</span>
          </div>
          ${Ut}
        </div>`}).join(""),it=[{k:"Address",v:e,mono:!0},{k:"Balance",v:I(n,4)+" XRP"+en(n),mono:!0},{k:"Wallet Age",v:D!=null?(D<1?"Created today":D+" days")+(R?" \u2014 created "+new Date(R).toLocaleDateString("en-US",{year:"numeric",month:"short",day:"numeric"}):""):"\u2014"},{k:"Risk Score",v:s+"/100 \u2014 "+U,color:Q},{k:"Transactions Analyzed",v:f.length+(de?" \xB7 "+de:"")},{k:"Activity Span",v:ne>0?ne+" days":"unknown"},{k:"Outbound Destinations",v:p.uniqueDests+" addresses received funds"},{k:"Total XRP Sent Out",v:I(p.totalOut,2)+" XRP",mono:!0},{k:"New-Wallet Recipients",v:(((Ei=p.newWalletDests)==null?void 0:Ei.length)||0)+((Ai=p.newWalletDests)!=null&&Ai.length?" \u26A0":" \u2014 none"),color:(Ni=p.newWalletDests)!=null&&Ni.length?"#ff5555":null},{k:"Wash Trading Score",v:(r.score||0)+"/100 \u2014 "+(r.verdict||"\u2014").replace("-"," ")+(r.score<25?" \u2713":r.score<50?" \u26A0 moderate":" \u{1F6A8} elevated")},{k:"Fee Spike Count (>100\xD7 base)",v:((x==null?void 0:x.spikeCount)??"N/A")+((x==null?void 0:x.spikeCount)>5?" \u26A0":""),mono:!0},{k:"Benford \u03C7\xB2 (normal \u2264 15.5)",v:l.chiSq!=null?l.chiSq.toFixed(2)+" \u2014 "+l.verdict.replace("-"," "):"insufficient data",mono:!0},{k:"Amount Entropy (natural 2.4\u20134.2)",v:(g==null?void 0:g.amountEntropy)!=null?g.amountEntropy.toFixed(2)+" bits":"N/A",mono:!0},{k:"Zipf Exponent (natural 0.8\u20131.3)",v:(h==null?void 0:h.zipfExponent)!=null?h.zipfExponent.toFixed(3)+"  R\xB2="+((_i=h.rSquared)==null?void 0:_i.toFixed(2)):"N/A",mono:!0},{k:"Timing Regularity CV (bot < 0.25)",v:(w==null?void 0:w.intervalCV)!=null?w.intervalCV.toFixed(3)+(w.intervalCV<.25?" \u26A0 bot-level":" \u2713"):"N/A",mono:!0},{k:"Granger OC Correlation",v:((Ri=k==null?void 0:k.offerCancelCausality)==null?void 0:Ri.maxCorr)!=null?k.offerCancelCausality.maxCorr.toFixed(3)+(k.offerCancelCausality.maxCorr>.55?" \u26A0":" \u2713"):"N/A",mono:!0},{k:"XRP\u2192IOU\u2192XRP Round-Trips",v:((T==null?void 0:T.roundTripCount)??0)+((T==null?void 0:T.roundTripCount)>=3?" \u26A0":""),mono:!0},{k:"Token Holders",v:m.holderCount>0?m.holderCount+" wallets hold tokens from this issuer":"Not a token issuer"},{k:"Critical Findings",v:xe.length+(xe.length===0?" \u2014 none":""),color:xe.length>0?"#ff5555":"#50fa7b"},{k:"Warnings",v:B.length+(B.length===0?" \u2014 none":""),color:B.length>0?"#ffb86c":"#50fa7b"}].map(E=>`
    ...
    </div>`).join(""),Ce={critical:"rgba(255,85,85,.08)",warn:"rgba(255,184,108,.06)",info:"rgba(120,180,255,.05)",ok:"rgba(80,250,123,.05)"},ue={critical:"rgba(255,85,85,.25)",warn:"rgba(255,184,108,.20)",info:"rgba(120,180,255,.15)",ok:"rgba(80,250,123,.15)"},z=[];(o.riskLevel==="critical"||o.riskLevel==="high")&&z.push({icon:"\u{1F534}",sev:"critical",text:"If this is your wallet: stop sending funds here immediately. The account's security keys match a known drain attack pattern. Contact a security professional or the XRPL community before taking any action."}),(Di=p.newWalletDests)!=null&&Di.length&&z.push({icon:"\u26A0\uFE0F",sev:"critical",text:`${p.newWalletDests.length} brand-new wallet(s) received large XRP transfers. This is a classic drain pattern. If this was unexpected, the funds have likely already been moved further down the chain.`}),(Ii=p.blackHoleDests)!=null&&Ii.length&&z.push({icon:"\u26D4",sev:"critical",text:"Funds sent to black hole addresses are gone permanently. No exchange, no support team, and no legal action can retrieve them."}),(Fi=p.exchangeDests)!=null&&Fi.length&&z.push({icon:"\u{1F4B1}",sev:"warn",text:`If this was a drain: contact ${[...new Set(p.exchangeDests.map(E=>E.entity.name))].join(", ")} exchange support immediately with the transaction hashes from the Fund Flow section. Act within hours \u2014 exchanges can sometimes freeze funds quickly but not after they've been withdrawn.`}),r.score>=60&&z.push({icon:"\u{1F4CA}",sev:"warn",text:"Significant wash trading signals detected. If you're a market maker: high cancel ratios are normal for your role \u2014 review the self-trade and self-routing signals specifically. If you're a token holder or researcher: this pattern suggests the token's apparent volume may be artificial."}),(T==null?void 0:T.selfRoutedCount)>0&&z.push({icon:"\u{1F504}",sev:"warn",text:`${T.selfRoutedCount} path payment(s) routed XRP from and back to the same address through the DEX. This creates artificial trading volume on every intermediate pair. Check the Path Payments section for specific transaction hashes.`}),(Bi=m.mirrorGroups)!=null&&Bi.length&&z.push({icon:"\u{1F578}",sev:"warn",text:"Mirror wallet clusters found. If you are the issuer, determine whether these are genuine holders or insider accounts used to create the appearance of broader distribution. These wallets could coordinate a sell-off."}),(Xi=i.flags)!=null&&Xi.some(E=>E.sev==="critical")&&z.push({icon:"\u{1F3A8}",sev:"critical",text:"Zero-value NFT offer detected. If you didn't intentionally list your NFT for free: identify what website or app you used around the time this transaction was signed, and revoke any approvals it has."}),(x==null?void 0:x.verdict)==="elevated"&&z.push({icon:"\u{1F4B8}",sev:"info",text:`${x.spikeCount} transactions paid >100\xD7 normal fees. Check the Fee Spikes section to see if these align with moments of concentrated trading \u2014 elevated fees often mark coordinated activity windows.`}),z.length===0&&z.push({icon:"\u2705",sev:"ok",text:"No immediate actions required. The account shows no identifiable red flags. Continue monitoring as activity grows \u2014 some patterns only become statistically significant with more data."});let Y=z.map(E=>`
    <div style="background:${Ce[E.sev]||Ce.info};border:1px solid ${ue[E.sev]||ue.info};border-radius:10px;padding:12px 14px;margin-bottom:8px;display:flex;gap:12px;align-items:flex-start">
    ...
    <div style="display:grid;grid-template-columns:repeat(auto-fill,minmax(260px,1fr));gap:8px;margin-top:10px">
      ${[["Benford's Law","In organic financial data, amounts starting with '1' appear ~30% of the time. Computer-generated amounts often break this law."],["Shannon's Entropy","Measures how 'predictable' transaction amounts and partners are. Bots repeat the same amounts; humans don't."],["Zipf's Law","Natural networks have a few heavy relationships and many light ones. Wash rings show unnaturally equal relationships."],["Time Series CV","Coefficient of Variation of gaps between transactions. Humans: >0.8 (irregular). Bots: <0.3 (clock-like)."],["Granger Causality","Tests if one event type systematically causes another \u2014 e.g., every offer creation is followed by a cancellation at a predictable lag."],["Interval CV","The regularity of timing between transactions. Very low = mechanical/automated. Very high = erratic/bursty."],["Gateway Balances","The XRPL API command that returns the true outstanding obligations of a token issuer \u2014 more accurate than just reading trustlines."],["Destination Tag","A number attached to a payment that identifies the recipient sub-account at an exchange. Like a bank account reference number."],["Path Payment","An XRPL payment that routes through intermediate DEX pairs. Can create trading volume on pairs the sender never intended to trade."],["XRP Round-Trip","A path payment that starts and ends in XRP, routed through IOU pairs. Creates DEX volume with no net economic transfer."],["Fee Multiplier","XRPL's base transaction fee is 12 drops (~$0.000001). Paying 100\xD7 means paying 1,200 drops \u2014 bots do this for guaranteed same-ledger execution."]].map(([E,Me])=>`
        <div style="background:rgba(255,255,255,.03);border-radius:8px;padding:10px 12px;border:1px solid rgba(255,255,255,.05)">
          ...
          <div style="font-size:.74rem;color:rgba(255,255,255,.42);line-height:1.5">${b(Me)}</div>
        </div>`).join("")}
    </div>`,Fe=re();return`
    <div class="report-wrap">
      ...
      <div class="report-cover">
        <div class="report-cover-left">
          ...
          <div style="font-size:.75rem;color:rgba(255,255,255,.38);margin-top:4px">Coverage: ${b(ce)}</div>
        </div>
  ...
  `}function yh(e,...t){e.innerHTML=bh(...t)}function wh(){let e=document.getElementById("tab-inspector");e&&(e.querySelector("[data-inspector-v2]")||(e.innerHTML=`
    <style>
  ...
  `))}function xh(){if(document.getElementById("inspector-nav"))return;let e=document.createElement("nav");e.id="inspector-nav",e.setAttribute("aria-label","Inspector navigation"),e.innerHTML=`
  ...
  `;let t=document.getElementById("tab-inspector");t&&t.appendChild(e)}function kh(){if(document.getElementById("inspector-howto"))return;let e=document.createElement("div");e.id="inspector-howto",e.className="howto-overlay",e.style.display="none",e.innerHTML=`
  ...
  `).join(""))}function Nh(){let e=document.getElementById("isd-cap-grid");e&&(e.innerHTML=Ph.map(t=>`
  ...
  `).join(""))}function Mo(){let e=document.getElementById("isd-wallets-section"),t=document.getElementById("isd-wallet-list");if(!e||!t)return;let n=ve(Z(Mh))||[];if(!n.length){e.style.display="none";return}e.style.display="",t.innerHTML=n.map(s=>{let a=s.color||"#50fa7b",o=s.emoji||"\u{1F48E}",i=s.label||"Wallet",r=s.address||"",l=r?r.slice(0,8)+"\u2026"+r.slice(-6):"\u2014",c=s.testnet?'<span class="isd-wallet-testnet">TESTNET</span>':"";return`
      <button class="isd-wallet-card" onclick="inspectorLoadAddr('${b(r)}')" type="button">
        ...
        <div class="isd-wallet-info">
          <div class="isd-wallet-name">${b(i)} ${c}</div>
          <div class="isd-wallet-addr mono">${l}</div>
        </div>
        <div class="isd-wallet-inspect">Inspect \u2192</div>
      </button>
    `}).join("")}function Lo(){let e=document.getElementById("isd-recent-section"),t=document.getElementById("isd-recent-list");if(!e||!t)return;let n=ua();if(!n.length){e.style.display="none";return}e.style.display="",t.innerHTML=n.map((s,a)=>{let o=s.addr?s.addr.slice(0,10)+"\u2026"+s.addr.slice(-8):"\u2014",i=s.riskScore!=null?`<span class="isd-risk-pill isd-risk-pill--${El(s.riskScore)}">${s.riskScore}</span>`:"";return`
    ...
    `}).join("")}function _h(){ca(),window.addEventListener("xrpl-ledger",Rh),window.addEventListener("xrpl-connection",ca)}function Rh(e){la()&&ca(e.detail)}var xo=null;function Dh(){return xo||(xo={idx:document.getElementById("isd-ledger-idx"),age:document.getElementById("isd-ledger-age"),tps:document.getElementById("isd-tps"),tpsTrnd:document.getElementById("isd-tps-trend"),fee:document.getElementById("isd-fee"),feeLv:document.getElementById("isd-fee-level"),close:document.getElementById("isd-close-time"),dot:document.getElementById("isd-conn-dot"),connLbl:document.getElementById("isd-conn-label"),pill:document.getElementById("isd-conn-pill"),domTx:document.getElementById("isd-dom-tx"),domPct:document.getElementById("isd-dom-pct"),bar:document.getElementById("isd-fee-bar"),barLbl:document.getElementById("isd-fee-bar-label")})}function ca(){let{idx:e,age:t,tps:n,tpsTrnd:s,fee:a,feeLv:o,close:i,dot:r,connLbl:l,pill:c,domTx:d,domPct:u,bar:p,barLbl:m}=Dh(),f=X.connectionState||"disconnected",g={connected:{label:"Connected",cls:"conn--live"},connecting:{label:"Connecting\u2026",cls:"conn--warn"},disconnected:{label:"Disconnected",cls:"conn--dead"}},h=g[f]||g.disconnected;r&&(r.className="isd-conn-dot"),l&&(l.textContent=h.label),c&&(c.className=`isd-conn-pill ${h.cls}`);let w=X.ledgerLog||[];if(w.length&&e){let T=w[0];if(e.textContent=Number(T.ledgerIndex||0).toLocaleString(),t&&(t.textContent=T.closeTimeSec!=="\u2014"?T.closeTimeSec+"s close":"\u2014"),i){let $=parseFloat(T.closeTimeSec);i.textContent=isNaN($)?"\u2014":$.toFixed(1)}}let k=X.tpsHistory||[];if(k.length&&n){let T=k.slice(-5),$=T.reduce((P,M)=>P+M,0)/T.length;if(n.textContent=$.toFixed(1),s&&k.length>=6){let P=k.slice(-10,-5),M=P.reduce((_,O)=>_+O,0)/P.length,N=$-M;s.textContent=N>.5?"\u2191 rising":N<-.5?"\u2193 falling":"\u2192 stable",s.className=`isd-metric-sub ${N>.5?"isd-up":N<-.5?"isd-down":""}`}}let v=X.feeHistory||[];if(v.length&&a){let T=v.slice(-5),$=T.reduce((N,_)=>N+_,0)/T.length,P=$/1e6;a.textContent=$<5e3?$.toFixed(0)+" drops":P.toFixed(5)+" XRP";let M=$<20?{lbl:"Low",cls:"fee-low",pct:10}:$<100?{lbl:"Normal",cls:"fee-normal",pct:28}:$<500?{lbl:"Elevated",cls:"fee-elevated",pct:60}:$<2e3?{lbl:"High",cls:"fee-high",pct:82}:{lbl:"Congested",cls:"fee-congest",pct:100};o&&(o.textContent=M.lbl,o.className=`isd-metric-sub ${M.cls}`),p&&(p.style.width=M.pct+"%",p.className=`isd-fee-bar-fill ${M.cls}`),m&&(m.textContent=M.lbl,m.className=`isd-fee-bar-level ${M.cls}`)}let x=X.txMixAccum||{},S=Object.entries(x).filter(([,T])=>T>0).sort(([,T],[,$])=>$-T);if(S.length&&d){let T=S.reduce((M,[,N])=>M+N,0),[$,P]=S[0];d.textContent=$,u&&(u.textContent=(P/T*100).toFixed(0)+"% of traffic")}}window.exportTxCSV=function(e){var l,c;if(!e||!e.length){alert("No transaction data to export. Run an inspection first.");return}let t=946684800,s=[["Hash","Date","Type","Account","Destination","Amount_XRP","Amount_Token","Currency","Fee_Drops","DestinationTag","Result","LedgerIndex"],...e.map(({tx:d,meta:u})=>{var w,k;let p=d.date?new Date((d.date+t)*1e3).toISOString():"",m=typeof d.Amount=="string"?(Number(d.Amount)/1e6).toFixed(6):"",f=(w=d.Amount)!=null&&w.value?d.Amount.value:"",g=((k=d.Amount)==null?void 0:k.currency)||(typeof d.Amount=="string"?"XRP":""),h=(u==null?void 0:u.TransactionResult)||"";return[d.hash||"",p,d.TransactionType||"",d.Account||"",d.Destination||"",m,f,g,d.Fee||"",d.DestinationTag??"",h,d.ledger_index||""]})].map(d=>d.map(u=>{let p=String(u);return p.includes(",")||p.includes('"')||p.includes(`
`)?'"'+p.replace(/"/g,'""')+'"':p}).join(",")).join(`
`),a=new Blob([s],{type:"text/csv;charset=utf-8;"}),o=URL.createObjectURL(a),i=document.createElement("a"),r=((c=(l=document.getElementById("inspect-addr-badge"))==null?void 0:l.dataset)==null?void 0:c.fullAddr)||"wallet";i.href=o,i.download=`naluxrp_${r.slice(0,10)}_${new Date().toISOString().slice(0,10)}.csv`,document.body.appendChild(i),i.click(),document.body.removeChild(i),URL.revokeObjectURL(o)};function Ih(e,t){let s=ua().find(o=>o.addr===e);if(!s||s.riskScore==null||t==null)return null;let a=t-s.riskScore;return{prev:s.riskScore,curr:t,diff:a,ts:s.ts}}function Fh(e,t){let n=Ih(e,t);if(!n||Math.abs(n.diff)<2)return;let s=document.getElementById("inspect-risk-score");if(!s)return;let a=n.diff>0?`<span style="color:#ff5555;font-size:.7rem;font-weight:700"> \u2191${n.diff}</span>`:`<span style="color:#50fa7b;font-size:.7rem;font-weight:700"> \u2193${Math.abs(n.diff)}</span>`,o=ma(n.ts);s.insertAdjacentHTML("afterend",`<span class="risk-score-diff" title="Changed from ${n.prev} \u2192 ${n.curr} since ${o}">${a} vs ${o}</span>`)}window._inspectMaxTx||(window._inspectMaxTx=5e3);window.inspectorLoadAddr=function(e){let t=y("inspect-addr");t&&(t.value=e),Gn()};window.inspectWalletAddr=function(e){var n,s;window.inspectorLoadAddr(e);let t=document.querySelector('[data-tab="inspector"]');t&&((n=window.switchTab)==null||n.call(window,t,"inspector")),(s=window.showDashboard)==null||s.call(window)};window.printInspectorReport=function(){var s,a;let e=document.getElementById("inspect-report-body");if(!e)return;let t=((a=(s=document.getElementById("inspect-addr-badge"))==null?void 0:s.dataset)==null?void 0:a.fullAddr)||"wallet",n=window.open("","_blank","width=900,height=700");n.document.write(`<!DOCTYPE html><html><head>
    ...
    ${e.innerHTML}
  </body></html>`),n.document.close()};window.exportInspectorReport=function(){var n;let e=document.getElementById("inspect-report-body");if(!e)return;let t=e.innerText||e.textContent||"";(n=navigator.clipboard)==null||n.writeText(t).then(()=>{let s=document.getElementById("report-export-btn");s&&(s.textContent="\u2713 Copied!",setTimeout(()=>{s.textContent="\u{1F4CB} Copy Report"},2e3))}).catch(()=>{let s=document.createRange();s.selectNodeContents(e);let a=window.getSelection();a.removeAllRanges(),a.addRange(s)})};window.inspectorClearHistory=function(){lt(Co);let e=document.getElementById("isd-recent-section");e&&(e.style.display="none")};window.inspectorClearWatchlist=function(){lt(bs),ws()};function ua(){return ve(Z(Co))||[]}function Bh(e,t,n=[]){let s=ua();s=s.filter(o=>o.addr!==e);let a=n.filter(o=>o.sev==="critical"||o.sev==="warn").map(o=>o.module+":"+o.headline.slice(0,40)).sort().join("|");s.unshift({addr:e,riskScore:t,ts:Date.now(),fingerprint:a}),s=s.slice(0,12),te(Co,JSON.stringify(s))}function ys(){return ve(Z(bs))||[]}function Xh(e,t){let n=ys().filter(s=>s.addr!==e);n.unshift({addr:e,label:t||W(e),addedTs:Date.now(),lastScore:null,lastTs:null}),te(bs,JSON.stringify(n.slice(0,50)))}function Pl(e){te(bs,JSON.stringify(ys().filter(t=>t.addr!==e)))}function To(e){return ys().some(t=>t.addr===e)}function Oh(e,t){let n=ys().map(s=>s.addr===e?{...s,lastScore:t,lastTs:Date.now()}:s);te(bs,JSON.stringify(n))}function ma(e){let t=Date.now()-e;return t<6e4?"just now":t<36e5?Math.floor(t/6e4)+"m ago":t<864e5?Math.floor(t/36e5)+"h ago":Math.floor(t/864e5)+"d ago"}function El(e){return $o(e).replace("risk-","")}var Zt=!1;function Al(){Zt=localStorage.getItem(Ll)==="true",Po()}function Po(){let e=document.getElementById("inspect-result");if(!e)return;e.classList.toggle("mode-advanced",Zt),e.classList.toggle("mode-simple",!Zt);let t=document.getElementById("analyst-mode-btn");t&&(t.textContent=Zt?"\u2697 Advanced":"\u{1F441} Simple",t.title=Zt?"Switch to Simple view":"Switch to Advanced (analyst) view")}window.toggleAnalystMode=function(){Zt=!Zt,localStorage.setItem(Ll,Zt),Po()};var Hh=new Set(["section-overview","section-report"]),zh=new Set(["section-security","section-drain","section-fundflow","section-inbound"]);function Uh(){let e=document.getElementById("inspect-result");if(!e)return;let t=[...e.querySelectorAll(".inspector-section")],n={crit:0,warn:1,neutral:2,ok:3,"":4},s=t.filter(i=>!Hh.has(i.id)&&!zh.has(i.id));s.sort((i,r)=>{let l=c=>{let d=c.querySelector(".section-badge");if(!d)return"";let u=d.className;return u.includes("crit")?"crit":u.includes("warn")?"warn":u.includes("neutral")?"neutral":u.includes("ok")?"ok":""};return(n[l(i)]??4)-(n[l(r)]??4)});let a=document.getElementById("section-inbound")||document.getElementById("section-drain");if(!a)return;let o=a;for(let i of s)o.after(i),o=i}function Wh(e,t,n,s){let a=document.getElementById("quick-verdict-body");if(!a)return;let o=t.filter(u=>u.sev==="critical"),i=t.filter(u=>u.sev==="warn"),r=e<20?"#50fa7b":e<45?"#ffb86c":e<70?"#ff8c42":"#ff5555",l=e<20?"Low Risk":e<45?"Moderate":e<70?"High Risk":"Critical",c="",d="";if(o.length===0&&i.length===0)c=`No elevated signals found across ${s.toLocaleString()} transactions${n!=null?` and ${n} days of history`:""}.`,d="This wallet appears to operate within normal parameters.";else{let u=o.slice(0,2).map(m=>m.headline).join("; "),p=i.slice(0,2).map(m=>m.headline).join("; ");c=o.length?`${o.length} critical issue${o.length>1?"s":""}: ${u}.`:`${i.length} warning${i.length>1?"s":""}: ${p}.`,d=o.length?"Review the highlighted sections below. Scroll to the Report for full recommendations.":"Review the flagged sections below for context before drawing conclusions."}a.innerHTML=`
    <div style="display:flex;align-items:flex-start;gap:16px;flex-wrap:wrap">
      ...
      <div style="flex:1;min-width:200px">
        <div style="font-size:.92rem;color:rgba(255,255,255,.88);line-height:1.6;margin-bottom:6px">${b(c)}</div>
        <div style="font-size:.8rem;color:rgba(255,255,255,.45);line-height:1.5">${b(d)}</div>
        ${o.length||i.length?`
    ...
    <div style="background:rgba(255,184,108,.07);border:1px solid rgba(255,184,108,.25);border-radius:10px;
    ...
    </div>`}function ws(){let e=document.getElementById("isd-watchlist-section"),t=document.getElementById("isd-watchlist-list");if(!e||!t)return;let n=ys();if(!n.length){e.style.display="none";return}e.style.display="",t.innerHTML=n.map(s=>{let a=s.addr.slice(0,8)+"\u2026"+s.addr.slice(-6),o=s.lastScore!=null?`<span class="isd-risk-pill isd-risk-pill--${El(s.lastScore)}">${s.lastScore}</span>`:"",i=s.lastTs?ma(s.lastTs):"never checked";return`
      ...
      </div>`}).join("")}window._removeFromWatchlistUI=function(e){Pl(e),ws()};function Nl(e){let t=document.getElementById("watchlist-btn");if(!t)return;let n=To(e);t.textContent=n?"\u2605 Watching":"\u2606 Watch",t.title=n?"Remove from watchlist":"Add to watchlist",t.style.color=n?"#ffb86c":"",t.onclick=()=>{To(e)?Pl(e):Xh(e,null),Nl(e),ws()}}function yl(e,t="inspect-activity-chart"){let n=document.getElementById(t);if(!n||!e.length)return;let s=946684800,a={Payment:"#50fa7b",OfferCreate:"#00d4ff",OfferCancel:"#8be9fd",NFTokenMint:"#bd93f9",NFTokenCreateOffer:"#bd93f9",NFTokenAcceptOffer:"#ff79c6",AMMDeposit:"#ffb86c",AMMWithdraw:"#ffb86c",AMMCreate:"#ffb86c",SetRegularKey:"#ff5555",SignerListSet:"#ff5555",AccountSet:"#f1fa8c"},o="rgba(255,255,255,.25)",i={};for(let{tx:f}of e){if(!f.date)continue;let g=new Date((f.date+s)*1e3),h=new Date(g.getFullYear(),0,1),w=Math.ceil(((g-h)/864e5+h.getDay()+1)/7),k=`${g.getFullYear()}-${String(w).padStart(2,"0")}`;i[k]||(i[k]={count:0,types:{}}),i[k].count++;let v=f.TransactionType||"Other";i[k].types[v]=(i[k].types[v]||0)+1}let r=Object.entries(i).sort((f,g)=>f[0].localeCompare(g[0]));if(r.length<2){n.innerHTML='<div style="opacity:.4;font-size:.8rem;padding:10px 0">Not enough dated transactions for timeline.</div>';return}let l=Math.max(...r.map(([,f])=>f.count),1),c=Math.max(3,Math.min(16,Math.floor(600/r.length))),d=1,u=60,p=r.length*(c+d),m=r.map(([f,g])=>{var x;let h=Math.max(2,Math.round(g.count/l*u)),w=u-h,k=((x=Object.entries(g.types).sort((S,T)=>T[1]-S[1])[0])==null?void 0:x[0])||"Other",v=a[k]||o;return`<rect x="0" y="${w}" width="${c}" height="${h}" fill="${v}" opacity=".8" rx="1">
      <title>${f}: ${g.count} tx (dominant: ${k})</title></rect>`}).join("");n.innerHTML=`
    ...
    <div style="overflow-x:auto;padding-bottom:4px">
      <svg width="${p}" height="${u}" xmlns="http://www.w3.org/2000/svg" style="display:block;min-width:${p}px">
        ${r.map(([,f],g)=>{var x;let h=Math.max(2,Math.round(f.count/l*u)),w=u-h,k=((x=Object.entries(f.types).sort((S,T)=>T[1]-S[1])[0])==null?void 0:x[0])||"Other",v=a[k]||o;return`<rect x="${g*(c+d)}" y="${w}" width="${c}" height="${h}"
            fill="${v}" opacity=".8" rx="1">
            <title>${r[g][0]}: ${f.count} tx (${k})</title></rect>`}).join("")}
      </svg>
    </div>
    <div style="display:flex;gap:8px;flex-wrap:wrap;margin-top:5px">
      ${Object.entries(a).slice(0,8).map(([f,g])=>`<span style="font-size:.62rem;color:${g};opacity:.7">\u25CF ${f}</span>`).join("")}
    </div>`}function wl(e,t,n,s,a="inspect-network-map"){let o=document.getElementById(a);if(!o)return;let i=new Map;for(let{tx:$,meta:P}of e){let M=$.Account===t,N=$.Destination===t;if(!M&&!N)continue;let _=M?$.Destination:$.Account;if(!_||_===t)continue;i.has(_)||i.set(_,{cnt:0,xrpOut:0,xrpIn:0,entity:Kn(_)});let O=i.get(_);O.cnt++;let D=(P==null?void 0:P.delivered_amount)||$.Amount,R=typeof D=="string"?Number(D)/1e6:0;M?O.xrpOut+=R:O.xrpIn+=R}let r=[...i.entries()].sort(($,P)=>P[1].xrpOut+P[1].xrpIn-($[1].xrpOut+$[1].xrpIn)||P[1].cnt-$[1].cnt).slice(0,20);if(r.length<2){o.style.display="none";return}o.style.display="";let l=560,c=340,d=l/2,u=c/2,p=95,m=7,f=155,g=13,h=r[0][1].xrpOut+r[0][1].xrpIn||1,w=r[0][1].cnt||1,k=[{id:t,x:d,y:u,r:13,main:!0,label:"YOU",color:"#00d4ff",xrpOut:0,xrpIn:0,cnt:0}];r.forEach(([$,P],M)=>{let N=M<m?p:f,_=M<m?m:g,D=(M<m?M:M-m)/_*2*Math.PI-Math.PI/2,R=P.xrpOut+P.xrpIn,F=Math.max(5,Math.min(14,4+R/h*10)),H=P.entity,A=(H==null?void 0:H.type)==="exchange"?"#00d4ff":(H==null?void 0:H.type)==="blackhole"?"#ff5555":(H==null?void 0:H.type)==="issuer"?"#ffb86c":(H==null?void 0:H.type)==="wallet"?"#bd93f9":"#8be9fd",U=R>0?P.xrpOut/R:.5,Q=U>.65?"out":U<.35?"in":"both";k.push({id:$,x:d+N*Math.cos(D),y:u+N*Math.sin(D),r:F,color:A,label:(H==null?void 0:H.name)||W($),ent:H,xrpOut:P.xrpOut,xrpIn:P.xrpIn,cnt:P.cnt,dir:Q,vol:R,ring:N})});let v=`<defs>
    ...
    <filter id="glow-red">
  ...
  </defs>`,x=k.slice(1).map($=>{let P=$.vol/h,M=Math.max(.8,P*3),N=.12+P*.45,_=$.dir==="out"?"rgba(80,250,123,":$.dir==="in"?"rgba(0,212,255,":"rgba(255,184,108,",O=$.dir==="out"?`rgba(80,250,123,${N})`:$.dir==="in"?`rgba(0,212,255,${N})`:`rgba(255,184,108,${N})`,D=$.dir==="in"?"5,3":"none",R=`marker-end="url(#arrow-${$.dir})"`,F=$.x-d,H=$.y-u,A=Math.sqrt(F*F+H*H),U=($.r+2)/A,Q=d+F*(1-U),ae=u+H*(1-U),ce=`${$.xrpOut>0?"\u2192 "+I($.xrpOut,2)+" XRP out":""}${$.xrpIn>0?($.xrpOut>0?" / ":"")+"\u2190 "+I($.xrpIn,2)+" XRP in":""}, ${$.cnt} tx`;return`<line x1="${d}" y1="${u}" x2="${Q.toFixed(1)}" y2="${ae.toFixed(1)}"
      stroke="${O}" stroke-width="${M.toFixed(1)}" stroke-dasharray="${D}" ${R}>
      <title>${ce}</title></line>`}).join(""),S=k.map($=>{var H,A;if($.main)return`
      <circle cx="${d}" cy="${u}" r="13" fill="rgba(0,212,255,.2)" stroke="#00d4ff" stroke-width="2"/>
      <circle cx="${d}" cy="${u}" r="13" fill="rgba(0,212,255,.15)"/>
      <text x="${d}" y="${u+4}" text-anchor="middle" font-size="8" fill="#00d4ff" font-weight="800">YOU</text>`;let P=((H=$.ent)==null?void 0:H.type)==="blackhole",M=((A=$.ent)==null?void 0:A.type)==="exchange",N=P?'filter="url(#glow-red)"':"",_=$.dir==="out"?"rgba(80,250,123,.5)":$.dir==="in"?"rgba(0,212,255,.5)":"rgba(255,184,108,.5)",O=1.5,D=$.label.length>14?$.label.slice(0,14)+"\u2026":$.label,R=$.vol>0?$.xrpOut>0&&$.xrpIn>0?`\u21C4 ${I($.vol,0)} XRP`:$.xrpOut>0?`\u2192 ${I($.xrpOut,0)} XRP`:`\u2190 ${I($.xrpIn,0)} XRP`:`${$.cnt} tx`,F=$.id+($.ent?" ("+$.ent.name+")":"")+" | "+($.xrpOut>0?"Sent: "+I($.xrpOut,2)+" XRP"+en($.xrpOut)+" | ":"")+($.xrpIn>0?"Received: "+I($.xrpIn,2)+" XRP"+en($.xrpIn)+" | ":"")+"Interactions: "+$.cnt;return`<g style="cursor:pointer" onclick="inspectorLoadAddr('${$.id}')">
      <title>${F}</title>
      ...
      <circle cx="${$.x}" cy="${$.y}" r="${$.r}" fill="${$.color}" opacity=".1" stroke="${_}" stroke-width="${O}"/>
      <text x="${$.x}" y="${$.y+3.5}" text-anchor="middle" font-size="${$.ring===p?7.5:6.5}"
        fill="${$.color}" font-weight="700" opacity=".95">${b(D)}</text>
      <text x="${$.x}" y="${$.y+$.r+10}" text-anchor="middle" font-size="6"
        fill="rgba(255,255,255,.4)">${b(R)}</text>
    </g>`}).join(""),T=`
    ...
    <div style="display:flex;gap:12px;margin-top:8px;flex-wrap:wrap;align-items:center">
    ...
    </div>`}let O="";M.forEach(D=>{if(!D.keys.length)return;let R=D.keys.some(U=>i.has(U)),F=D.keys.map((U,Q)=>_(U,R?Q:null)).join(""),H=`vgs-${Math.random().toString(36).slice(2,8)}`,A=!D.collapsed;O+=`
      <div class="vg-section ${D.cls??""}">
        ...
        ">
          ...
          <span class="vg-sec-title">${b(D.title)}</span>
        </button>
        <div id="${H}" class="vg-section-body" style="display:${A?"":"none"}">
          ${F}
        </div>
      </div>`}),O||(O='<div class="nunl-empty">No validators in this view.</div>'),o.innerHTML=P+O,G("m1-val-summary",N),o.querySelectorAll(".vg-tab").forEach(D=>{D.addEventListener("click",R=>{R.stopPropagation();let F=D.getAttribute("data-vgtab");F&&(xs=F,sc(e,t,n,s,a))})})}async function hg(e){let t=No.get(e);if(t&&Date.now()-t.cachedAt<Vl)return t.data;try{let n=new AbortController,s=setTimeout(()=>n.abort(),Gl),a=await fetch(`${ql}/${encodeURIComponent(e)}`,{signal:n.signal});if(clearTimeout(s),!a.ok)throw new Error(`HTTP ${a.status}`);let o=await a.json();return No.set(e,{data:o,cachedAt:Date.now()}),o}catch{return null}}async function gg(e){let t=_o.get(e);if(t&&Date.now()-t.cachedAt<Vl)return t.data;try{let n=new AbortController,s=setTimeout(()=>n.abort(),Gl),a=await fetch(`${ql}/${encodeURIComponent(e)}/reports`,{signal:n.signal});if(clearTimeout(s),!a.ok)throw new Error(`HTTP ${a.status}`);let o=await a.json(),i=o.reports??o??[];return _o.set(e,{data:i,cachedAt:Date.now()}),i}catch{return[]}}window.focusValidator=async function(e){let t=Ke(e),n=sn(t);document.querySelectorAll(".vpill").forEach(o=>o.classList.remove("vp-active"));let s=document.querySelector(`.vpill[data-key="${CSS.escape(e)}"]`);if(s&&(s.classList.add("vp-active"),s.scrollIntoView({behavior:"smooth",block:"nearest"})),Bo(e,t,null),hg(e).then(o=>{o&&Bo(e,t,o)}),!n){let o=y("world-map-container");if(o){let i=o.querySelector(".wm-no-geo");i&&i.remove();let r=document.createElement("div");r.className="wm-no-geo",r.textContent=`\u{1F4CD} ${t.label} \u2014 geographic location unknown`,o.appendChild(r),setTimeout(()=>r.remove(),3500)}return}let a=y("world-map-container");a&&a.scrollIntoView({behavior:"smooth",block:"nearest"}),je&&(je.flyTo([n.lat,n.lng],6,{duration:1.2}),setTimeout(()=>{let o=Fo[e];o&&o.openPopup()},1300))};function Bo(e,t,n){var M,N,_,O,D;let s=y("amend-modal-overlay"),a=y("amend-modal-body");if(!s||!a)return;let o=n??{},i=t.label??o.label??o.account_name??e.slice(0,16)+"\u2026",r=t.domain??o.domain??null,l=t.chain??o.chain??"main",c=t.category??"other",d=Ne[c]??Ne.other,u=sn(t),p=t.unl||c==="unl"||c==="both",m=t.dunl||c==="dunl"||c==="both",f=t.domainVerified||o.domain_verified?"\u2713 Verified":r?"Unverified":"\u2014",g=t.agreement??o.agreement??{},h=!n&&!((M=t.agreement)!=null&&M["24h"]);function w(R,F){if(!F||!F.total)return`<div class="adm-mi"><span class="adm-mk">${R}</span><span class="adm-mv" style="opacity:.5">\u2014</span></div>`;let H=parseFloat(F.score)||0,A=H>=99?"color:#50fa7b":H>=95?"color:#ffb86c":"color:#ff5555";return`<div class="adm-mi">
    ...
    </div>`}function k(R,F,H=!1){return!F&&F!==0?"":`<div class="adm-mi"><span class="adm-mk">${R}</span><span class="adm-mv ${H?"mono":""}">${b(String(F))}</span></div>`}let v=_o.get(e),x=((N=v==null?void 0:v.data)==null?void 0:N.slice(-14))??[],S=x.length?`<div class="adm-section">
    ...
    <div class="adm-header" style="border-bottom:1px solid rgba(255,255,255,.08);padding-bottom:12px;margin-bottom:12px;">
      <div class="adm-title-row" style="display:flex;align-items:flex-start;gap:10px;margin-bottom:6px;">
        <div style="flex:1">
          <h2 class="adm-title" style="color:${d.hex};margin:0;font-size:17px;font-weight:700">${b(i)}</h2>
    ...
    <div class="adm-section">
      ...
      ${w("1-hour",g["1h"]??((_=o.agreement)==null?void 0:_["1h"]))}
      ${w("24-hour",g["24h"]??((O=o.agreement)==null?void 0:O["24h"]))}
      ${w("30-day",g["30d"]??((D=o.agreement)==null?void 0:D["30d"]))}
    </div>
    ...
    </div>`,s.style.display="flex",s.addEventListener("click",R=>{R.target===s&&window.closeAmendModal()},{once:!0})}window._loadValidatorReports=async function(e){var n;let t=Ke(e);await gg(e),Bo(e,t,((n=No.get(e))==null?void 0:n.data)??null)};function vg({active:e,quorum:t,margin:n,nUnl:s,valsAvail:a}){let o=y("m1-quorum-ring");if(!o)return;if(!a||!t||!e){o.innerHTML='<div style="opacity:.4;font-size:12px;text-align:center;padding:16px">Connect to view quorum</div>';return}let i=44,r=2*Math.PI*i,l=new Set(s),c=e-s.length,d=s.length,u=Math.max(0,e-t),p=t,m=n<=0?"#ff5555":n<=3?"#ffb86c":"#50fa7b",f=e>0?c/e:0,g=e>0?d/e:0,h=e>0?t/e:0,w=e>0?Math.max(0,n)/e:0,k=e>0?d/e:0;function v(x,S,T,$=8){if(S<=0)return"";let P=x*r,M=S*r;return`<circle r="${i}" cx="50" cy="50" fill="none"
    ...
    <div class="qr-wrap">
    ...
    </div>`}function bg(){var F,H,A;let e=qe,t=(e==null?void 0:e.server_state)??"unknown",n=(e==null?void 0:e.build_version)??"\u2014",s=Number((e==null?void 0:e.uptime)??0),a=e==null?void 0:e.network_id,o=Number((e==null?void 0:e.io_latency_ms)??0),i=String((e==null?void 0:e.jq_trans_overflow)??"0"),r=Number((e==null?void 0:e.peer_disconnects_resources)??0),l=Number((e==null?void 0:e.load_factor)??1),c=Number((e==null?void 0:e.load_factor_net)??1),d=Number((e==null?void 0:e.load_factor_server)??(e==null?void 0:e.load_factor_local)??1),u=Number(((F=e==null?void 0:e.validated_ledger)==null?void 0:F.age)??0),p=(H=e==null?void 0:e.validated_ledger)==null?void 0:H.seq,m=(e==null?void 0:e.complete_ledgers)??"",f=(e==null?void 0:e.state_accounting)??null;u>10&&(Ie.staleLedger=!0),o>5&&(Ie.ioStressed=!0),Ms("peerDiscon")>5&&(Ie.peerChurn=!0);let g=y("m2-state");if(g){g.textContent=t;let U=["full","proposing","validating"].includes(t),Q=["syncing","tracking","connected"].includes(t);g.className=`state-pill state-${U?"ok":Q?"warn":"bad"}`}G("m2-version",n),G("m2-uptime",Fg(s)),G("m2-netid",a===0?"0 (Mainnet)":a===1?"1 (Testnet)":a??"\u2014"),G("m2-ledger-seq",p!=null?Number(p).toLocaleString():"\u2014"),G("m2-ledger-age",u>0?`${u}s`:"< 1s"),G("m2-io-ms",o>0?`${o}ms`:"< 1ms"),G("m2-jq",i==="0"?"0 (clean)":`\u26A0 ${i}`),G("m2-discon",r.toLocaleString());let h=y("m2-ledger-age");h&&(h.className=`kv-v ${u>10?"text-danger":u>5?"text-warn":""}`);let w=Math.min(100,(l-1)/49*100);dt("m2-load-bar",w,l>5?"bar-danger":l>2?"bar-warn":"bar-ok"),G("m2-load-total",`${l.toFixed(2)}\xD7`),G("m2-load-net",`${c.toFixed(2)}\xD7`),G("m2-load-local",`${d.toFixed(2)}\xD7`);let k=d>c*1.5?"Local node stressed":c>d*1.5?"Network-wide stress":l>1.2?"Distributed":"Normal";G("m2-load-src",k);let v=X.tpsHistory.length?X.tpsHistory[X.tpsHistory.length-1]:null;G("m2-tps",v!=null?v.toFixed(1):"\u2014"),G("m2-txcount",((A=X.ledgerLog[0])==null?void 0:A.txCount)??"\u2014");let x=m==="entire ledger"||m.startsWith("32570"),S=x?100:Ig(m);if(G("m2-ledger-range",m||"\u2014"),G("m2-hist-type",x?"Full History Node":"Pruned / Partial"),G("m2-hist-score",`${S}%`),dt("m2-hist-bar",S,S<30?"bar-danger":S<70?"bar-warn":"bar-ok"),f){let U=y("m2-state-acct");if(U){let Q=["full","syncing","tracking","connected","disconnected"],ae=0,ce={};Q.forEach(de=>{var ne;ce[de]=Number(((ne=f[de])==null?void 0:ne.duration_us)??0),ae+=ce[de]}),U.innerHTML=ae>0?Q.map(de=>{let ne=Math.round(ce[de]/ae*100);return ne?`<div class="sa-row"><span class="sa-lbl">${de}</span>
          <div class="bar-track sa-bar"><div class="bar-fill ${de==="full"?"bar-ok":de==="syncing"?"bar-warn":"bar-danger"}" style="width:${ne}%"></div></div>
          <span class="sa-pct">${ne}%</span></div>`:""}).join(""):'<span class="dim">No data</span>'}}let T=(e==null?void 0:e.peers)!=null?Number(e.peers):null,$=T!=null,P=0,M=0,N=!1;Pt&&(Pt.forEach(U=>{U.inbound===!0?P++:M++}),N=!0);let _=N&&P+M>0?Math.round(P/(P+M)*100):0,O=N?Pt.length:T??0,D=O<6?"HIGH":O<15?"MEDIUM":"LOW";O<6&&(Ie.eclipseRisk=!0),_>80&&(Ie.peerSaturate=!0),G("m2-peers",$?O:"\u2014"),G("m2-inbound",N?P:$?"\u2014 (cmd restricted)":"\u2014"),G("m2-outbound",N?M:$?"\u2014 (cmd restricted)":"\u2014"),G("m2-ib-pct",N?`${_}%`:"\u2014"),dt("m2-peer-bar",Math.min(100,O/21*100),O>18?"bar-danger":O>15?"bar-warn":"bar-ok"),dt("m2-ib-bar",_,_>80?"bar-danger":_>60?"bar-warn":"bar-ok");let R=y("m2-eclipse");R&&(R.textContent=D,R.className=`risk-badge risk-${D.toLowerCase()}`)}function yg(){var M,N,_,O;let e=wn,t=Number(((M=e==null?void 0:e.drops)==null?void 0:M.minimum_fee)??10),n=Number(((N=e==null?void 0:e.drops)==null?void 0:N.open_ledger_fee)??10),s=Number(((_=e==null?void 0:e.drops)==null?void 0:_.median_fee)??10),a=Number(((O=e==null?void 0:e.drops)==null?void 0:O.base_fee)??10),o=Number((e==null?void 0:e.current_ledger_size)??0),i=Number((e==null?void 0:e.expected_ledger_size)??1),r=Number((e==null?void 0:e.current_queue_size)??0),l=Number((e==null?void 0:e.max_queue_size)??1),c=l>0?Math.round(r/l*100):0,d=i>0?o/i:1,u=Ms("fees"),p=u>0?Math.round((n-u)/u*100):0,m=Math.min(100,Math.round(Math.log2(Math.max(1,n/10))*14));n>t*10&&(Ie.feeSpike=!0),c>80&&(Ie.queuePressure=!0),d>2&&(Ie.spamLedger=!0);let f=tt.burnDrops.slice(-10),g=f.length?f.reduce((D,R)=>D+R,0)/f.length:0,h=_g(tt.burnDrops),w=Ms("burnDrops"),k=h>0&&tt.burnDrops.length>5?((g-w)/h).toFixed(2):"0.00",v=Math.min(100,Math.abs(Number(k))*20);Math.abs(Number(k))>3&&(Ie.burnAnomaly=!0);let x=n>5e3?"Severe":n>500?"High":n>100?"Elevated":n>20?"Normal":"Minimal",T={Severe:"#ff5555",High:"#ff9955",Elevated:"#ffb86c",Normal:"#50fa7b",Minimal:"#6272a4"}[x]??"#50fa7b",$=y("m3-pressure");$&&($.textContent=x,$.className=`pressure-badge p-${x.toLowerCase()}`),G("m3-open",`${n} drops`),G("m3-med",`${s} drops`),G("m3-base",`${a} drops`),G("m3-devpct",`${p>0?"+":""}${p}% vs baseline`),G("m3-spam",`${m} / 100`),G("m3-qsize",`${r} / ${l}`),G("m3-qpct",`${c}%`),G("m3-szratio",`${d.toFixed(2)}\xD7`),G("m3-curledger",`${o} txs`),G("m3-expledger",`${i} expected`),G("m3-burn",g>0?`${(g/1e6).toFixed(4)} XRP / ledger`:"\u2014"),G("m3-burnz",`z = ${k}`),dt("m3-spam-bar",m,m>70?"bar-danger":m>40?"bar-warn":"bar-ok"),dt("m3-q-bar",c,c>80?"bar-danger":c>50?"bar-warn":"bar-ok"),dt("m3-sz-bar",Math.min(100,d*50),d>2?"bar-danger":d>1.5?"bar-warn":"bar-ok"),dt("m3-burn-bar",v,v>60?"bar-danger":v>30?"bar-warn":"bar-ok");let P=y("m3-congestion-summary");if(P){let D=[];d>2&&D.push({icon:"\u{1F6A8}",txt:`Ledger ${d.toFixed(1)}\xD7 normal size \u2014 possible spam burst`,col:"#ff5555"}),c>80&&D.push({icon:"\u26A0",txt:`TX queue ${c}% full \u2014 fee surge imminent`,col:"#ffb86c"}),m>70&&D.push({icon:"\u26A0",txt:`Spam index ${m}/100 \u2014 elevated DDoS risk`,col:"#ffb86c"}),Math.abs(Number(k))>3&&D.push({icon:"\u{1F4C9}",txt:`Burn rate z=${k} \u2014 resource exhaustion pattern`,col:"#ff9955"}),p>200&&D.push({icon:"\u{1F4B8}",txt:`Open fee ${p}% above baseline \u2014 network stress`,col:"#ffb86c"}),P.innerHTML=D.length?D.map(R=>`<div class="cong-line"><span>${R.icon}</span><span style="color:${R.col}">${b(R.txt)}</span></div>`).join(""):'<div class="cong-clear"><span style="color:#50fa7b">\u2713</span> No congestion signals \u2014 network traffic is normal</div>'}}function wg(){var u,p;let e={},t=0;for(let m of $e.values()){if(m.chain==="test")continue;let f=m.version??"unknown";e[f]=(e[f]??0)+1,t++}let n={},s=0;if(Array.isArray(Pt))for(let m of Pt){let f=(m.version??"unknown").replace(/rippled-/i,"").split(" ")[0];n[f]=(n[f]??0)+1,s++}let a=y("m4-version-dist");if(a&&t>0){let m=Object.entries(e).sort((w,k)=>k[1]-w[1]),f=((u=m[0])==null?void 0:u[0])??"?",g=t>0?Math.round((((p=m[0])==null?void 0:p[1])??0)/t*100):0,h=["#00fff0","#50fa7b","#ffb86c","#bd93f9","#ff5555","#8be9fd"];a.innerHTML=m.slice(0,6).map(([w,k],v)=>{let x=Math.round(k/t*100),S=h[v%h.length],T=w.includes("beta")||w.includes("rc")||w.includes("RC");return`<div class="vd-row">
        <div class="vd-ver-label">
          <span style="color:${S};font-weight:600">${b(w)}</span>
      ...
      </div>`}).join("")+`<div class="vd-summary">${t} validators \xB7 ${m.length} versions \xB7 ${g}% on latest (${b(f)})</div>`}let o={"North America":0,Europe:0,"Asia Pacific":0,"Middle East":0,"South America":0,Other:0};function i(m,f){return m>15&&f<-30?"North America":m>-60&&f<-30?"South America":m>35&&f>-30&&f<60?"Europe":m>10&&f>=60&&f<150||m>=-40&&f>=110?"Asia Pacific":m>10&&m<40&&f>=30&&f<70?"Middle East":"Other"}let r=0;for(let m of $e.values()){if(m.chain==="test")continue;let f=sn(m);if(!(f!=null&&f.lat))continue;let g=i(f.lat,f.lng);o[g]=(o[g]??0)+1,r++}let l=y("m4-geo-dist");if(l&&r>0){let m={"North America":"#00fff0",Europe:"#50fa7b","Asia Pacific":"#bd93f9","Middle East":"#ffb86c","South America":"#8be9fd",Other:"#6272a4"},f=Object.entries(o).filter(([,k])=>k>0).sort((k,v)=>v[1]-k[1]),g=f.reduce((k,[,v])=>k+(v/r)**2,0),h=g>.4?"Concentrated":g>.25?"Moderate":"Distributed",w=g>.4?"#ff5555":g>.25?"#ffb86c":"#50fa7b";l.innerHTML=f.map(([k,v])=>{let x=Math.round(v/r*100),S=m[k]??"#6272a4";return`<div class="vd-row">
        <span class="vd-ver-label" style="color:${S};font-weight:600">${b(k)}</span>
        <div class="vd-bar-wrap">
          <div class="vd-bar-fill" style="width:${x}%;background:${S};opacity:.65"></div>
        </div>
        <span class="vd-count">${v} <span style="opacity:.5">(${x}%)</span></span>
      </div>`}).join("")+`<div class="vd-summary">${r} geo-located \xB7 <span style="color:${w}">${h}</span> (HHI ${g.toFixed(2)})</div>`}let c={};for(let m of $e.values()){if(m.chain==="test")continue;let f=sn(m),g=m.provider??(f==null?void 0:f.org)??"Unknown",h=g.match(/AWS|Amazon/i)?"AWS":g.match(/Azure|Microsoft/i)?"Azure":g.match(/GCP|Google/i)?"GCP":g.match(/Hetzner/i)?"Hetzner":g.match(/OVH/i)?"OVH":g.match(/Cloudflare/i)?"Cloudflare":g.match(/Equinix/i)?"Equinix":g.match(/NTT/i)?"NTT":g.match(/Ripple/i)?"Ripple":"Other";c[h]=(c[h]??0)+1}let d=y("m4-provider-dist");if(d){let m=Object.values(c).reduce((f,g)=>f+g,0);if(m>0){let f=Object.entries(c).sort((h,w)=>w[1]-h[1]),g=["#ff5555","#ffb86c","#50fa7b","#00fff0","#bd93f9","#8be9fd","#6272a4"];d.innerHTML=f.slice(0,7).map(([h,w],k)=>{let v=Math.round(w/m*100),x=g[k%g.length],S=v>33?"\u26A0 ":"";return`<div class="vd-row">
          <span class="vd-ver-label" style="color:${x};font-weight:600">${S}${b(h)}</span>
          <div class="vd-bar-wrap">
            <div class="vd-bar-fill" style="width:${v}%;background:${x};opacity:.7;${v>33?"box-shadow:0 0 6px "+x+"88":""}"></div>
          </div>
          <span class="vd-count">${w} <span style="opacity:.5">(${v}%)</span></span>
        </div>`}).join("")}}}var Jn="pending";function ac(e){let t=y("amendment-list");if(!t)return;let n=y("amend-pipeline-header"),s=Object.entries(e).map(([d,u])=>({hash:d,...u})),a=s.filter(d=>d.enabled),o=s.filter(d=>!d.enabled&&!d.vetoed).sort((d,u)=>(u.count??0)-(d.count??0)),i=s.filter(d=>d.vetoed),r=o.filter(d=>d.majority),l=o.filter(d=>!d.majority&&(d.count??0)>=(d.threshold??28)*.8);if(o.some(d=>(d.count??0)<(d.threshold??28)*.5)&&(Ie.amendVeto=!0),n){let d=[{id:"pending",label:"Voting",count:o.length,color:"#8be9fd"},{id:"active",label:"Active",count:a.length,color:"#50fa7b"},{id:"vetoed",label:"Vetoed",count:i.length,color:"#ff5555"},{id:"all",label:"All",count:s.length,color:null}];n.innerHTML=`
      <div class="ap-tabs">
        ${d.map(u=>`
      ...
      ${l.length?`<div class="ap-near-bar">\u{1F4C8} ${l.length} amendment${l.length>1?"s":""} approaching 80% threshold</div>`:""}`,n.querySelectorAll(".ap-tab").forEach(u=>{u.onclick=()=>{Jn=u.dataset.aptab,ac(e)}})}let c=Jn==="active"?a:Jn==="vetoed"?i:Jn==="all"?s.sort((d,u)=>d.enabled!==u.enabled?d.enabled?1:-1:d.vetoed!==u.vetoed?d.vetoed?1:-1:(u.count??0)-(d.count??0)):o;if(!c.length){t.innerHTML=`<div class="amend-empty">${Jn==="vetoed"?"No vetoed amendments":"No data"}</div>`;return}t.innerHTML=c.map(d=>{var $;let u=d.count??0,p=d.threshold??28,m=Math.min(100,Math.round(u/p*100)),f=d.name??`${d.hash.slice(0,10)}...`,g=!!d.enabled,h=!!d.vetoed,w=!!d.majority,k=Kl[f]??{},v=($=tt.amendMomentum)==null?void 0:$[d.hash],x="";if(w&&!g&&d.majority){let P=Date.now()-new Date(d.majority).getTime(),M=P>0?Math.floor(P/864e5):0,N=Math.max(0,14-M),_=Math.min(100,Math.round(M/14*100));x=`<div class="ap-countdown">
      ...
      </div>`}let S=g?"#50fa7b":h?"#ff5555":w?"#ffb86c":m>=80?"#8be9fd":"rgba(255,255,255,.3)",T=g?"Active":h?"Vetoed":w?"Majority":m>=80?"Near":"Voting";return`<div class="ap-row" onclick="window.showAmendDetail('${b(d.hash)}')">
      <div class="ap-row-main">
        ...
        ${k.purpose?`<div class="ap-purpose">${b(k.purpose)}</div>`:""}
        ${g?`<div class="ap-active-note">\u2713 Running on all ledgers${k.intro?" \xB7 since "+k.intro:""}</div>`:`<div class="ap-vote-row">
          <div class="ap-vote-track">
            <div class="ap-vote-fill" style="width:${m}%;background:${S};opacity:${g?1:.75}"></div>
    ...
    </div>`}).join("")}function xg(e){Io={},Object.entries(e).forEach(([t,n])=>{Io[t]={hash:t,...n}})}window.showAmendDetail=function(e){let t=Io[e];if(!t)return;let n=t.name||`${e.slice(0,16)}...`,s=Kl[n]||{},a=t.count??0,o=t.threshold??28,i=Math.min(100,Math.round(a/o*100)),r=t.enabled?"Active on Ledger":t.vetoed?"Vetoed":t.majority?"Majority Reached":"Voting in Progress",l=t.enabled?"adm-s-ok":t.vetoed?"adm-s-bad":t.majority?"adm-s-warn":"adm-s-info",c=t.enabled?"bar-ok":t.vetoed?"bar-danger":t.majority?"bar-warn":"bar-info",d=t.majority&&!t.enabled?`
    ...
    <div class="adm-footer">
      ...
      <a class="adm-link" href="https://xrpl.org/consensus.html" target="_blank" rel="noopener noreferrer">Consensus Docs</a>
    </div>`,u.style.display="flex",u.addEventListener("click",m=>{m.target===u&&window.closeAmendModal()},{once:!0}))};window.closeAmendModal=function(){let e=y("amend-modal-overlay");e&&(e.style.display="none")};function kg(e){if(window.L){e();return}if(!document.querySelector("#leaflet-css")){let n=document.createElement("link");n.id="leaflet-css",n.rel="stylesheet",n.href="https://cdnjs.cloudflare.com/ajax/libs/leaflet/1.9.4/leaflet.min.css",document.head.appendChild(n)}let t=document.createElement("script");t.src="https://cdnjs.cloudflare.com/ajax/libs/leaflet/1.9.4/leaflet.min.js",t.onload=e,document.head.appendChild(t)}function $g(e,t,n,s,a=!1){y("world-map-container")&&kg(()=>Sg(e,t,n,s,a))}function Sg(e,t,n,s,a=!1){let o=y("world-map-container");if(!o)return;let i=new Set(n||[]),r=new Set(e||[]),l=new Set(t||[]),c=X.currentNetwork||"xrpl-mainnet";if(je&&ha!==c&&(je.remove(),je=null,Xt=[],ha=null),!je){o.innerHTML="";let x=document.createElement("div");x.id="wm-leaflet",x.style.cssText="width:100%;height:440px;",o.appendChild(x),je=L.map("wm-leaflet",{center:[25,5],zoom:2,minZoom:1,maxZoom:12,zoomControl:!0,attributionControl:!0,worldCopyJump:!0}),L.tileLayer("https://{s}.basemaps.cartocdn.com/dark_all/{z}/{x}/{y}{r}.png",{attribution:'&copy; <a href="https://carto.com">CARTO</a> &copy; <a href="https://openstreetmap.org">OSM</a>',subdomains:"abcd",maxZoom:19}).addTo(je),ha=c}Xt.forEach(x=>{try{x.remove()}catch{}}),Xt=[];function d(x){return i.has(x)?"nunl":r.has(x)&&l.has(x)?"both":r.has(x)?"unl":l.has(x)?"dunl":"other"}Fo={};let u={};for(let[x,S]of $e){let T=sn(S);if(!(T!=null&&T.lat)||!(T!=null&&T.lng))continue;let $=`${(Math.round(T.lat*2)/2).toFixed(1)},${(Math.round(T.lng*2)/2).toFixed(1)}`;u[$]||(u[$]={lat:T.lat,lng:T.lng,keys:[],city:T.city,org:T.org}),u[$].keys.push(x)}if(Object.values(u).forEach(x=>{let S=x.keys.length,T=x.keys.map(d),$=["nunl","both","unl","dunl","other"].find(O=>T.includes(O))||"other",P=Ne[$],M=S>5?13:S>2?10:7,N=L.divIcon({html:`<div class="wm-lmarker wm-lmarker-val ${$==="nunl"?"wm-lmarker-nunl":""} ${a?"wm-lmarker-ref":""}"
                  style="--mc:${P.hex};--mg:${P.glow};"
                  title="${x.keys.map(O=>Ke(O).label).join(", ")}">
        <div class="wm-lring"></div>
        <div class="wm-ldot" style="width:${M*2}px;height:${M*2}px;">${S>1?`<span>${S}</span>`:""}</div>
      </div>`,className:"",iconSize:[(M+8)*2,(M+8)*2],iconAnchor:[M+8,M+8]}),_=L.marker([x.lat,x.lng],{icon:N}).bindPopup(Tg(x.keys,x.city,x.org,i,r,l,a),{maxWidth:380,className:"wm-popup-wrap"}).addTo(je);x.keys.forEach(O=>{Fo[O]=_}),Xt.push(_)}),a){let x=L.control({position:"bottomleft"});x.onAdd=()=>{let S=L.DomUtil.create("div","wm-ref-banner");return S.innerHTML="\u{1F4E1} Reference positions \xB7 live validator list unavailable from endpoint",S},x.addTo(je),Xt.push(x)}let p=[...$e.keys()].filter(x=>{var T;return((T=$e.get(x).geo)==null?void 0:T.lat)!=null||ya[x]}).length,m=$e.size-p;if(m>0){let x=L.control({position:"bottomright"});x.onAdd=()=>{let S=L.DomUtil.create("div","wm-unknown-ctrl");return S.innerHTML=`+ ${m} validators \xB7 location unknown`,S},x.addTo(je),Xt.push(x)}sg.forEach(x=>{let S=L.divIcon({html:`<div class="wm-lmarker wm-lmarker-pub">
        <div class="wm-lring"></div>
        ...
        <div class="wm-popup-inner">
          ...
          <div class="wm-popup-name">${b(x.label)}</div>
          <div class="wm-popup-row"><span class="wm-popup-key">Location</span><span>\u{1F4CD} ${b(x.city)}</span></div>
          <div class="wm-popup-row"><span class="wm-popup-key">Operator</span><span>${b(x.org)}</span></div>
          <div class="wm-popup-row"><span class="wm-popup-key">Type</span><span>Full history node</span></div>
        </div>`,{maxWidth:260,className:"wm-popup-wrap"}).addTo(je);Xt.push(T)});let f=Array.isArray(s)?s:[],g=f.filter(x=>x.inbound===!0).length,h=f.length-g,w=f.length>0?`${f.length} peers (${g}\u2193 ${h}\u2191)`:`${Number((qe==null?void 0:qe.peers)??0)} peers`,k=L.control({position:"topleft"});k.onAdd=()=>{let x=L.DomUtil.create("div","wm-legend-ctrl");return x.innerHTML=`
      ...
      </div>`,x},k.addTo(je),Xt.push(k);let v=Xt.filter(x=>x&&typeof x.getLatLng=="function");if(v.length>=2)try{let x=L.latLngBounds(v.map(S=>S.getLatLng()));x.isValid()&&je.fitBounds(x.pad(.15),{maxZoom:6})}catch{}try{window.dispatchEvent(new CustomEvent("nalulf-network-map",{detail:{map:je,networkId:ha}}))}catch{}}function Tg(e,t,n,s,a,o,i=!1){let r=e.length>1,l=e.map(d=>{let u=Ke(d),p=s.has(d),m=a.has(d),f=o.has(d),g=d.slice(0,20)+"...",h,w;return p?(h=Ne.nunl.hex,w="Negative UNL"):m&&f?(h=Ne.both.hex,w="UNL + dUNL"):m?(h=Ne.unl.hex,w="UNL"):f?(h=Ne.dunl.hex,w="dUNL"):(h=Ne.other.hex,w="Other"),`<div class="wm-popup-val-row">
      ...
      <div class="wm-popup-val-info">
        ...
        <span class="wm-popup-val-key"
              onclick="navigator.clipboard?.writeText('${b(d)}');this.textContent='\u2713 Copied!';setTimeout(()=>this.textContent='${b(g)}',1400)"
              title="Click to copy full key">${b(g)}</span>
    ...
    </div>`}).join(""),c=[...new Set(e.map(d=>{var p;let u=Ke(d);return u.provider??((p=sn(u))==null?void 0:p.org)??null}).filter(Boolean))];return`<div class="wm-popup-inner">
    <div class="wm-popup-loc-row">
      <span class="wm-popup-loc-icon">\u{1F4CD}</span>
      <div>
        <div class="wm-popup-name">${b(t||"Unknown Location")}</div>
        ${c.map(d=>`<div class="wm-popup-org">${b(d)}</div>`).join("")}
      </div>
    </div>
    ...
    <div class="wm-popup-vals">${l}</div>
  </div>`}var Yn=[];function Cg(){let e=Object.keys(Ie),t=e.reduce((r,l)=>{var c;return r+(((c=Ot[l])==null?void 0:c.w)??1)},0),n=t>=Zh;for(e.forEach(r=>{var l,c;Yn.find(d=>d.key===r&&Date.now()-d.ts<3e5)||Yn.push({key:r,label:((l=Ot[r])==null?void 0:l.label)??r,ts:Date.now(),weight:((c=Ot[r])==null?void 0:c.w)??1})});Yn.length>20;)Yn.shift();let s=y("adversarial-alert");s&&(s.classList.toggle("adv-active",n),s.classList.toggle("adv-inactive",!n));let a=y("adversarial-score");if(a){let r=t===0?"All Clear":t<3?"Monitor":t<5?"Elevated":t<10?"High":"Critical",l=t===0?"#50fa7b":t<3?"#8be9fd":t<5?"#ffb86c":t<10?"#ff9955":"#ff5555";a.innerHTML=`<span style="color:${l};font-weight:700">${r}</span>
    ...
    </div>`;else{let r=e.filter(u=>{var p;return(((p=Ot[u])==null?void 0:p.w)??1)>=3}),l=e.filter(u=>{var p;return(((p=Ot[u])==null?void 0:p.w)??1)===2}),c=e.filter(u=>{var p;return(((p=Ot[u])==null?void 0:p.w)??1)===1}),d=(u,p,m)=>p.length===0?"":`
      <div class="adv-group-title" style="color:${m}">${u} (${p.length})</div>
      ${p.map(f=>{let g=Ot[f]??{w:1,label:f},h=g.label.split(" \u2014 "),w=h[0],k=h[1]||"";return`<div class="adv-sig-card adv-sig-${g.w>=3?"critical":g.w>=2?"elevated":"monitor"}">
          <div class="adv-sig-top">
            <span class="adv-sig-dot" style="background:${m}"></span>
            <span class="adv-sig-title">${b(w)}</span>
            <span class="adv-sig-badge" style="border-color:${m}44;color:${m}">W${g.w}</span>
          </div>
          ${k?`<div class="adv-sig-detail">${b(k)}</div>`:""}
        </div>`}).join("")}`;o.innerHTML=d("Critical",r,"#ff5555")+d("Elevated",l,"#ffb86c")+d("Monitor",c,"#8be9fd")}let i=y("adversarial-history");if(i&&Yn.length){let r=Date.now();i.innerHTML=Yn.slice(-8).reverse().map(l=>{let c=Math.round((r-l.ts)/6e4),d=e.includes(l.key);return`<div class="adv-hist-row ${d?"adv-hist-active":"adv-hist-resolved"}">
      ...
      <span class="hcs-total">of ${i.length} checks</span>`);let u={consensus:"Consensus Health",infra:"Node Infrastructure",ledger:"Ledger & Fees"};t.innerHTML=Object.entries(u).map(([p,m])=>{let f=i.filter(v=>v.group===p),g=f.map(v=>{let x=v.result.status,S=x==="ok"?"hc-ok":x==="watch"?"hc-warn":"hc-fail",T="\u25CF";return`<div class="hc-item ${S}">
        <div class="hc-item-top">
          <span class="hc-dot" style="background:${x==="ok"?"#50fa7b":x==="watch"?"#ffb86c":"#ff5555"}"></span>
          <span class="hc-label">${b(v.icon)} ${b(v.label)}</span>
          <span class="hc-value">${b(v.result.value)}</span>
        </div>
        <div class="hc-note">${b(v.result.note)}</div>
      </div>`}).join(""),h=f.filter(v=>v.result.status==="ok").length;return`<div class="hc-group ${f.filter(v=>v.result.status==="alert").length>0?"hcg-alert":h===f.length?"hcg-ok":"hcg-watch"}">
      <div class="hc-group-title">${b(m)}
        <span class="hcg-badge">${h}/${f.length}</span>
      </div>
      <div class="hc-group-items">${g}</div>
    </div>`}).join("")}function Lg(e){var t,n,s,a,o,i,r,l,c,d;e&&(Ge("burnDrops",(e.avgFee||0)*1e6*(e.txPerLedger??0)),Ge("dexOffers",((t=e.txTypes)==null?void 0:t.OfferCreate)??0),Ge("ammSwaps",(((n=e.txTypes)==null?void 0:n.AMMDeposit)??0)+(((s=e.txTypes)==null?void 0:s.AMMWithdraw)??0)+(((a=e.txTypes)==null?void 0:a.AMMBid)??0)),Ge("newAccounts",((o=e.txTypes)==null?void 0:o.AccountSet)??0),Ge("txPayment",((i=e.txTypes)==null?void 0:i.Payment)??0),Ge("txNFT",(((r=e.txTypes)==null?void 0:r.NFTokenMint)??0)+(((l=e.txTypes)==null?void 0:l.NFTokenBurn)??0)+(((c=e.txTypes)==null?void 0:c.NFTokenCreateOffer)??0)+(((d=e.txTypes)==null?void 0:d.NFTokenAcceptOffer)??0)),Ge("txLedger",e.txPerLedger??0),Ge("tps",e.tps??(e.txPerLedger??0)/3.5),Ge("closeTime",e.closeTime??3.5))}function Pg(e){let t=X.tpsHistory.length?X.tpsHistory[X.tpsHistory.length-1]:null;G("m2-tps",t!=null?t.toFixed(1):"\u2014"),G("m2-txcount",e.txPerLedger??"\u2014"),e.successRate!=null&&G("m2-success",`${e.successRate.toFixed(0)}%`)}async function Ts({force:e=!1}={}){if(!Qn()&&!e)return;let t=Date.now();if(!e&&t-Ol<Jh)return;Ol=t;let n=y("latency-list");if(!n)return;let s=Gi[X.currentNetwork]??[],a=++Hl;n.innerHTML=s.map((o,i)=>`
    ...
    </div>`).join("");for(let o=0;o<s.length;o++){if(a!==Hl)return;await Eg(s[o],o),await Bg(Yh)}}async function Eg(e,t){var i;let n=y(`lat-val-${t}`),s=y(`lat-bar-${t}`),a=y(`lat-row-${t}`);n&&(n.textContent="...");let o=performance.now();try{let r=new WebSocket(e.url);await new Promise((d,u)=>{let p=setTimeout(()=>u(),Kh);r.onopen=()=>{clearTimeout(p),d()},r.onerror=()=>{clearTimeout(p),u()}});let l=Math.round(performance.now()-o);try{r.close()}catch{}let c=l<100?"lat-fast":l<300?"lat-med":"lat-slow";n&&(n.textContent=`${l}ms`,n.className=`lat-val ${c}`),s&&(s.style.width=`${Math.min(100,l/600*100)}%`),a==null||a.classList.toggle("lat-active",((i=X.wsConn)==null?void 0:i.url)===e.url)}catch{n&&(n.textContent="timeout",n.className="lat-val lat-slow")}}function Ag(){if(document.getElementById("vg-tab-styles"))return;let e=document.createElement("style");e.id="vg-tab-styles",e.textContent=`
  ...
  `,document.getElementById("net-panel-styles")||document.head.appendChild(s)}function Ge(e,t){tt[e]||(tt[e]=[]),tt[e].push(Number(t)),tt[e].length>Qh&&tt[e].shift()}function Ms(e){let t=tt[e]??[];return t.length?t.reduce((n,s)=>n+s,0)/t.length:0}function _g(e){if(e.length<2)return 0;let t=e.reduce((n,s)=>n+s,0)/e.length;return Math.sqrt(e.reduce((n,s)=>n+(s-t)**2,0)/e.length)}function Rg(){try{let e=localStorage.getItem(jl);if(!e)return;let t=JSON.parse(e);Object.keys(tt).forEach(n=>{Array.isArray(t[n])&&(tt[n]=t[n])})}catch{}}function Dg(){try{localStorage.setItem(jl,JSON.stringify(tt))}catch{}}function G(e,t){let n=y(e);n&&(n.textContent=t??"\u2014")}function dt(e,t,n){let s=y(e);s&&(s.style.width=`${Math.min(100,Math.max(0,Number(t)||0))}%`,s.className=`bar-fill ${n??""}`)}function Ig(e){if(!e)return 0;let t=e.match(/(\d+)-(\d+)/);if(!t)return 10;let n=Number(t[2])-Number(t[1]);return n>1e7?95:n>1e6?70:n>1e5?40:15}function Fg(e){if(!e)return"\u2014";let t=Math.floor(e/86400),n=Math.floor(e%86400/3600),s=Math.floor(e%3600/60);return t>0?`${t}d ${n}h`:n>0?`${n}h ${s}m`:`${s}m`}function Bg(e){return new Promise(t=>setTimeout(t,e))}var yc="nalulf_wallets",wc="nalulf_profile",xc="nalulf_social",Es="naluxrp_active_wallet",on="nalulf_avatar_img",Tn="nalulf_banner_img",Go="nalulf_activity_log",oi="nalulf_balhist_",Xg="nalulf_addr_book",Og="https://xrplcluster.com/",Hg="https://s2.ripple.com:51234/",zg=[e=>`https://corsproxy.io/?${encodeURIComponent(e)}`,e=>`https://api.allorigins.win/raw?url=${encodeURIComponent(e)}`],Ug="https://api.xrpscan.com/api/v1/tokens",Wg="https://api.coingecko.com/api/v3/coins/markets",jg="https://bithomp.com/api/v2/tokens",qg="https://api.xrpl.to/api/tokens",Vg=!1,Sa=10,Ta=2,Gg=["\u{1F30A}","\u{1F40B}","\u{1F409}","\u{1F98B}","\u{1F981}","\u{1F43A}","\u{1F98A}","\u{1F43B}","\u{1F43C}","\u{1F985}","\u{1F42C}","\u{1F988}","\u{1F419}","\u{1F991}","\u{1F9FF}","\u{1F33A}","\u{1F338}","\u{1F340}","\u26A1","\u{1F525}","\u{1F48E}","\u{1F319}","\u2B50","\u{1F3AF}","\u{1F9E0}","\u{1F52E}","\u{1F6F8}","\u{1F5FA}","\u{1F3D4}","\u{1F3AD}","\u{1F3DB}"],Kg=["\u{1F48E}","\u{1F3E6}","\u{1F510}","\u{1F511}","\u{1F4B0}","\u{1F30A}","\u26A1","\u{1F680}","\u{1F319}","\u2B50","\u{1F3F4}\u200D\u2620\uFE0F","\u{1F3AF}","\u{1F9E0}","\u{1F52E}"],Jg=["#50fa7b","#00d4ff","#ffb86c","#bd93f9","#ff79c6","#f1fa8c","#ff5555","#00fff0","#ff6b6b","#a78bfa"],As=["banner-ocean","banner-neon","banner-gold","banner-cosmic","banner-sunset","banner-aurora"],ns=[{id:"discord",label:"Discord",icon:"\u{1F4AC}",prefix:"https://discord.com/users/"},{id:"twitter",label:"X / Twitter",icon:"\u{1D54F}",prefix:"https://x.com/"},{id:"linkedin",label:"LinkedIn",icon:"in",prefix:"https://linkedin.com/in/"},{id:"github",label:"GitHub",icon:"\u2325",prefix:"https://github.com/"},{id:"telegram",label:"Telegram",icon:"\u2708",prefix:"https://t.me/"},{id:"facebook",label:"Facebook",icon:"f",prefix:"https://facebook.com/"},{id:"tiktok",label:"TikTok",icon:"\u266A",prefix:"https://tiktok.com/@"}],Yg={tecNO_DST:"Destination account does not exist \u2014 fund it with 10 XRP first.",tecINSUF_RESERVE_LINE:"Insufficient reserve to add another trustline.",tecINSUF_RESERVE_OFFER:"Insufficient reserve to place a DEX order.",tecUNFUNDED_PAYMENT:"Insufficient balance (including reserve).",tecDST_TAG_NEEDED:"This destination requires a Destination Tag.",tecNO_PERMISSION:"Account has DepositAuth enabled \u2014 destination must preauthorize.",temBAD_AMOUNT:"Invalid amount.",temBAD_CURRENCY:"Invalid currency code.",temBAD_ISSUER:"Invalid issuer address.",tefPAST_SEQ:"Sequence number already used \u2014 please retry.",terQUEUED:"Transaction queued \u2014 will be included in a future ledger."},Qg="https://cdn.jsdelivr.net/npm/xrpl@4.2.5/build/xrpl-latest-min.js",Ca=21e4,wa=null;function zo(e){return btoa(String.fromCharCode(...e))}function Uo(e){let t=atob(e),n=new Uint8Array(t.length);for(let s=0;s<t.length;s+=1)n[s]=t.charCodeAt(s);return n}async function Ea(){var e,t;return(e=window.xrpl)!=null&&e.Wallet?!0:(wa||(wa=new Promise((n,s)=>{let a=document.querySelector('script[data-xrpl-lib="1"]');if(a){a.addEventListener("load",()=>n(!0),{once:!0}),a.addEventListener("error",()=>s(new Error("Failed to load xrpl.js")),{once:!0});return}let o=document.createElement("script");o.src=Qg,o.async=!0,o.defer=!0,o.dataset.xrplLib="1",o.onload=()=>n(!0),o.onerror=()=>s(new Error("Failed to load xrpl.js")),document.head.appendChild(o)}).finally(()=>{var n;(n=window.xrpl)!=null&&n.Wallet||(wa=null)})),await wa,!!((t=window.xrpl)!=null&&t.Wallet))}async function kc(e,t,n=Ca){let s=new TextEncoder,a=await crypto.subtle.importKey("raw",s.encode(e),{name:"PBKDF2"},!1,["deriveKey"]);return crypto.subtle.deriveKey({name:"PBKDF2",hash:"SHA-256",salt:t,iterations:n},a,{name:"AES-GCM",length:256},!1,["encrypt","decrypt"])}async function $c(e,t){let n=new TextEncoder,s=crypto.getRandomValues(new Uint8Array(16)),a=crypto.getRandomValues(new Uint8Array(12)),o=await kc(t,s,Ca),i=await crypto.subtle.encrypt({name:"AES-GCM",iv:a},o,n.encode(e));return{v:1,kdf:"PBKDF2-SHA256",iter:Ca,alg:"AES-GCM-256",salt:zo(s),iv:zo(a),ct:zo(new Uint8Array(i))}}async function Zg(e,t){if(!(e!=null&&e.ct)||!(e!=null&&e.salt)||!(e!=null&&e.iv))throw new Error("Wallet seed blob is invalid.");let n=await kc(t,Uo(e.salt),e.iter||Ca),s=await crypto.subtle.decrypt({name:"AES-GCM",iv:Uo(e.iv)},n,Uo(e.ct));return new TextDecoder().decode(s)}async function ev(e,t){let n=(t||"").trim();if(n)return n;if(e!=null&&e.encSeed){let a=prompt("Enter your wallet password to decrypt and sign this transaction:");if(!a)throw new Error("Wallet password is required to sign.");try{return await Zg(e.encSeed,a)}catch{throw new Error("Could not decrypt wallet seed. Check your wallet password and try again.")}}let s=prompt("Enter the wallet seed to sign this transaction (used once, not stored):");if(!s)throw new Error("Seed phrase is required to sign transactions.");return s.trim()}var le={displayName:"",handle:"",bio:"",location:"",website:"",avatar:"\u{1F30A}",banner:"banner-ocean",joinedDate:new Date().toISOString(),domain:""},ie=[],He={},st=null,Ve={},ii={},ri={},Sc={},li={},Ls={},Tc={},Te={loading:!1,data:null,error:""},ut={loading:!1,items:[],error:""},mt={loading:!1,pools:[],error:""},xt={loading:!1,pools:[],error:""},_e={loading:!1,pool:null,error:""},C={pair:"BITSTAMP:XRPUSD",interval:"15",chartType:"candles",stats:null,loading:!1,error:"",comparePair:"",indicators:{sma20:!0,ema20:!1,wma20:!1,bb20:!1,vwap:!1,ichimoku:!1,macd:!1,rsi:!1,atr:!1,adx:!1,aroon:!1,cci:!1,williamsr:!1,mfi:!1,obv:!1,adline:!1,cmf:!1,stoch:!1,uo:!1,stdev:!1,donchian:!1,keltner:!1,supertrend:!1,pivots:!1,sar:!1,vortex:!1,elderRay:!1},tokenFocusKey:"",drawingTool:"none",drawings:[],alerts:[],indicatorMenuOpen:!1,moreMenuOpen:!1,indicatorQuery:"",indicatorSettings:{},settingsOpenFor:null,threeEnabled:!0,selectedIndicator:"sma20",selectedEducationTab:"indicator",educationCollapsed:!1,educationHint:"",chartMeta:{tokenKey:"XRP|",symbol:"XRP",source:"Coinbase + XRPL live",last:null,high:null,low:null,mode:"pair"}},j={loading:!1,tokens:[],filtered:[],trending:[],error:"",query:"",total:0,lastSyncAt:0,filters:{type:"all",minCap:0,minVol:0,hasDex:!1},selectedTokenKey:"",listLimit:240},wt={loading:!1,items:[],error:""},ic=new Map,xa=null,ka=null,rc=!1,lc=0,Cc=0,Wo=null,cc={xrplto:0},ee={chart:null,volumeSeries:null,activeSeries:null,compareSeries:null,indicatorSeries:[],indicatorPriceLines:[],priceLines:[],resizeObserver:null,chartType:"",configKey:"",legendEl:null,renderLegend:null,ichimokuData:null,indicatorLegendItems:[],alertPriceLines:[]},Oe={renderer:null,scene:null,camera:null,points:null,raf:0,host:null,resizeHandler:null},Ps=new Map,kn=0,jo="",tv="naluxrp_hist_v1_",Mc=60,Lc=25,nv=200,sv=e=>new Promise(t=>setTimeout(t,e)),Ko="naluxrp_seed_backed_up",Pc="naluxrp_token_watchlist",Jo="naluxrp_chart_layout",Ec="naluxrp_selected_token",ci="naluxrp_chart_3d",Ac="naluxrp_price_alerts";function Ma(){return X.currentPage==="profile"&&!document.hidden}var av=[{symbol:"XRP",name:"XRP Ledger Native",marketCap:"$124.3B",source:"CoinGecko"},{symbol:"RLUSD",name:"Ripple USD",marketCap:"$312.0M",source:"Static sample"},{symbol:"SOLOGENIC",name:"Sologenic",marketCap:"$96.4M",source:"Static sample"}],Cn=[{id:"BITSTAMP:XRPUSD",label:"XRP / USD (Coinbase + XRPL)",source:"coinbase",ticker:"xrpusd",symbol:"XRP",coingeckoId:"ripple"},{id:"BINANCE:XRPUSDT",label:"XRP / USD (Coinbase mirror)",source:"coinbase",ticker:"XRPUSDT",symbol:"XRP",coingeckoId:"ripple"},{id:"BINANCE:ETHUSDT",label:"ETH / USD (Coinbase)",source:"coinbase",ticker:"ETHUSDT",symbol:"ETH",coingeckoId:"ethereum"},{id:"BINANCE:BTCUSDT",label:"BTC / USD (Coinbase)",source:"coinbase",ticker:"BTCUSDT",symbol:"BTC",coingeckoId:"bitcoin"},{id:"BINANCE:SOLUSDT",label:"SOL / USD (Coinbase)",source:"coinbase",ticker:"SOLUSDT",symbol:"SOL",coingeckoId:"solana"}],Nc=[{value:"1",label:"1m"},{value:"3",label:"3m"},{value:"5",label:"5m"},{value:"15",label:"15m"},{value:"30",label:"30m"},{value:"60",label:"1h"},{value:"120",label:"2h"},{value:"240",label:"4h"},{value:"D",label:"1D"},{value:"W",label:"1W"},{value:"M",label:"1M"}];var _c=[{key:"none",label:"Cursor"},{key:"hline",label:"Horizontal Line"}],ov={trend:["sma20","ema20","wma20","ichimoku","adx","aroon","sar","supertrend","vortex","elderRay","macd"],momentum:["rsi","stoch","cci","williamsr","mfi","uo"],volume:["obv","adline","cmf","vwap"],volatility:["bb20","keltner","atr","donchian","stdev"],advanced:["pivots"]},Ht={sma20:{name:"SMA 20",what:"Simple average of closing prices over 20 periods.",purpose:"Baseline trend smoothing.",apply:"Use slope and price relation for trend confirmation.",mistake:"Assuming one crossover equals full trend reversal.",bias:"Check higher timeframe trend first."},ema20:{name:"EMA 20",what:"Weighted moving average that reacts faster.",purpose:"Track momentum shifts early.",apply:"Use with structure breaks for continuation entries.",mistake:"Overtrading every touch.",bias:"Wait for confirmation candle close."},wma20:{name:"WMA 20",what:"Linear weighted average favoring recent closes.",purpose:"Balance noise and reactivity.",apply:"Useful for dynamic pullback zones.",mistake:"Treating it as support in chop.",bias:"Confirm with volatility context."},ichimoku:{name:"Ichimoku Cloud",what:"Multi-line trend, momentum, and support/resistance framework.",purpose:"One-glance regime detection.",apply:"Favor trades aligned with cloud direction and conversion/base line confluence.",mistake:"Ignoring lagging span context.",bias:"Only take signals in clear trend phases."},macd:{name:"MACD",what:"Difference between fast and slow EMAs with signal line.",purpose:"Momentum and trend acceleration.",apply:"Use histogram contraction/expansion and line cross with structure.",mistake:"Late entries from isolated crosses.",bias:"Match cross direction with market structure."},rsi:{name:"RSI",what:"Relative strength oscillator from 0-100.",purpose:"Momentum strength and exhaustion.",apply:"40-80 bull range, 20-60 bear range is often more useful than 30/70 alone.",mistake:"Shorting every overbought reading in uptrends.",bias:"Use RSI with trend filters and divergence context."},stoch:{name:"Stochastic",what:"Close location relative to recent range.",purpose:"Short-term momentum turns.",apply:"Best in ranges or pullbacks within trend.",mistake:"Treating every cross as signal.",bias:"Require structure or support/resistance confluence."},cci:{name:"CCI",what:"Deviation from statistical mean.",purpose:"Identify cyclical overextensions.",apply:"Look for trend-aligned re-entry after reset.",mistake:"Using fixed thresholds in all regimes.",bias:"Adapt thresholds to volatility."},williamsr:{name:"Williams %R",what:"Inverse stochastic oscillator.",purpose:"Range extremes and momentum snapbacks.",apply:"Use with market regime filter.",mistake:"Fading trends blindly.",bias:"Avoid countertrend trades without invalidation levels."},mfi:{name:"MFI",what:"Volume-weighted RSI style oscillator.",purpose:"Money flow pressure.",apply:"Combine with volume spikes for conviction.",mistake:"Ignoring thin liquidity distortions.",bias:"Cross-check on multiple venues when possible."},uo:{name:"Ultimate Oscillator",what:"Weighted momentum across multiple windows.",purpose:"Reduce single-window false signals.",apply:"Divergences can be strong with structure breaks.",mistake:"Using without trend filter.",bias:"Require two independent confirmations."},obv:{name:"On Balance Volume",what:"Cumulative signed volume.",purpose:"Volume pressure trend.",apply:"Look for OBV breaks before price breaks.",mistake:"Trusting OBV in sparse data periods.",bias:"Check liquidity quality first."},adline:{name:"Accumulation/Distribution",what:"Volume flow using close location in candle.",purpose:"Detect stealth accumulation/distribution.",apply:"Use for divergence against price trend.",mistake:"Ignoring wick distortions.",bias:"Validate with average volume regime."},cmf:{name:"Chaikin Money Flow",what:"Normalized accumulation/distribution over window.",purpose:"Money flow bias.",apply:"Sustained above/below zero is more meaningful than single crosses.",mistake:"Reacting to one-bar flips.",bias:"Use persistence thresholds."},vwap:{name:"VWAP",what:"Volume weighted average price.",purpose:"Institutional execution benchmark.",apply:"Use as intraday mean reversion or trend continuation anchor.",mistake:"Ignoring session resets.",bias:"Define session context explicitly."},bb20:{name:"Bollinger Bands",what:"Moving average with standard deviation envelopes.",purpose:"Volatility expansion/contraction.",apply:"Squeezes can precede breakouts; walks indicate trend.",mistake:"Assuming every upper-band touch is sell.",bias:"Pair with trend and volume confirmation."},keltner:{name:"Keltner Channel",what:"EMA center with ATR-based envelopes.",purpose:"Trend-aware volatility channel.",apply:"Break/hold beyond band can mark trend strength.",mistake:"Using fixed ATR multiplier everywhere.",bias:"Tune per asset volatility."},atr:{name:"ATR",what:"Average true range.",purpose:"Position sizing and stop calibration.",apply:"Use ATR multiples for stops/targets.",mistake:"Using fixed pip stops in all regimes.",bias:"Normalize risk by volatility."},donchian:{name:"Donchian Channels",what:"Highest high / lowest low bands.",purpose:"Breakout systems.",apply:"Use channel breaks with trend filter.",mistake:"Ignoring false breakout environment.",bias:"Wait for close confirmation."},stdev:{name:"Standard Deviation",what:"Dispersion of price from mean.",purpose:"Volatility regime shifts.",apply:"Expand risk controls during high dispersion.",mistake:"Mistaking volatility for direction.",bias:"Separate volatility from trend."},adx:{name:"ADX",what:"Trend strength metric independent of direction.",purpose:"Regime filter.",apply:"Use +DI/-DI with ADX slope.",mistake:"Trading direction off ADX alone.",bias:"Combine with directional structure."},aroon:{name:"Aroon",what:"Time since highs/lows.",purpose:"Trend emergence detection.",apply:"Aroon up/down crosses near extremes can flag regime shifts.",mistake:"Using in high-noise micro ranges.",bias:"Require multi-candle confirmation."},pivots:{name:"Pivot Points",what:"Session-based support/resistance levels.",purpose:"Map likely reaction zones.",apply:"Use confluence with order flow and trend.",mistake:"Treating pivots as guaranteed reversal levels.",bias:"Plan invalidation before entry."},sar:{name:"Parabolic SAR",what:"Trailing stop indicator with acceleration factor.",purpose:"Trend trailing and stop logic.",apply:"Works best in persistent trends.",mistake:"Using in sideways chop.",bias:"Filter with ADX or structure."},supertrend:{name:"Supertrend",what:"ATR-based trend-following overlay.",purpose:"Trend direction and trailing stop.",apply:"Follow flips when volatility supports continuation.",mistake:"Chasing every flip in range.",bias:"Use higher timeframe confirmation."},vortex:{name:"Vortex",what:"Positive/negative trend movement lines.",purpose:"Trend turning points.",apply:"Crosses with expansion can mark trend shifts.",mistake:"Ignoring low-liquidity noise.",bias:"Confirm with volume and structure."},elderRay:{name:"Elder Ray",what:"Bull/Bear power versus EMA baseline.",purpose:"Pressure around trend mean.",apply:"Look for divergence and trend continuation.",mistake:"Using without baseline trend direction.",bias:"Anchor decisions to trend context."}},di={sma20:[{id:"length",label:"Length",type:"number",default:20},{id:"color",label:"Color",type:"color",default:"#f1c40f"}],ema20:[{id:"length",label:"Length",type:"number",default:20},{id:"color",label:"Color",type:"color",default:"#ffb86c"}],wma20:[{id:"length",label:"Length",type:"number",default:20},{id:"color",label:"Color",type:"color",default:"#bd93f9"}],vwap:[{id:"color",label:"Color",type:"color",default:"#80ffea"}],bb20:[{id:"length",label:"Length",type:"number",default:20},{id:"color",label:"Band Color",type:"color",default:"#ff79c6"}],ichimoku:[{id:"tenkanLen",label:"Tenkan Length",type:"number",default:9},{id:"kijunLen",label:"Kijun Length",type:"number",default:26},{id:"senkouBLen",label:"Senkou B Length",type:"number",default:52},{id:"tenkanColor",label:"Tenkan Color",type:"color",default:"#ffde59"},{id:"kijunColor",label:"Kijun Color",type:"color",default:"#6ecbff"},{id:"bullColor",label:"Cloud Bull Color",type:"color",default:"#46ffa0"},{id:"bearColor",label:"Cloud Bear Color",type:"color",default:"#ff7878"}],donchian:[{id:"length",label:"Length",type:"number",default:20},{id:"color",label:"Color",type:"color",default:"#9cfb8c"}],keltner:[{id:"length",label:"Length",type:"number",default:20},{id:"color",label:"Color",type:"color",default:"#7ee7ff"}],supertrend:[{id:"color",label:"Color",type:"color",default:"#8bffde"}],sar:[{id:"color",label:"Color",type:"color",default:"#ffaf7a"}],elderRay:[{id:"bullColor",label:"Bull Color",type:"color",default:"#5fff9d"},{id:"bearColor",label:"Bear Color",type:"color",default:"#ff9d9d"}],rsi:[{id:"length",label:"Length",type:"number",default:14},{id:"color",label:"Color",type:"color",default:"#a6ff4d"}],atr:[{id:"length",label:"Length",type:"number",default:14},{id:"color",label:"Color",type:"color",default:"#ffb86c"}],stdev:[{id:"color",label:"Color",type:"color",default:"#b2a3ff"}],stoch:[{id:"length",label:"Length",type:"number",default:14},{id:"kColor",label:"%K Color",type:"color",default:"#9ee8ff"},{id:"dColor",label:"%D Color",type:"color",default:"#ffd86b"}],macd:[{id:"fastLen",label:"Fast Length",type:"number",default:12},{id:"slowLen",label:"Slow Length",type:"number",default:26},{id:"signalLen",label:"Signal Length",type:"number",default:9},{id:"lineColor",label:"MACD Color",type:"color",default:"#8fd9ff"},{id:"signalColor",label:"Signal Color",type:"color",default:"#ffcf8e"}],obv:[{id:"color",label:"Color",type:"color",default:"#8cf9ff"}],adline:[{id:"color",label:"Color",type:"color",default:"#ffb7ff"}],cmf:[{id:"length",label:"Length",type:"number",default:20},{id:"color",label:"Color",type:"color",default:"#f8ff87"}],williamsr:[{id:"length",label:"Length",type:"number",default:14},{id:"color",label:"Color",type:"color",default:"#ff9adf"}],cci:[{id:"length",label:"Length",type:"number",default:20},{id:"color",label:"Color",type:"color",default:"#b8ff8e"}],mfi:[{id:"length",label:"Length",type:"number",default:14},{id:"color",label:"Color",type:"color",default:"#7bffd2"}],uo:[{id:"color",label:"Color",type:"color",default:"#ffd36f"}],adx:[{id:"length",label:"Length",type:"number",default:14},{id:"adxColor",label:"ADX Color",type:"color",default:"#9fd8ff"},{id:"plusColor",label:"+DI Color",type:"color",default:"#73ffc0"},{id:"minusColor",label:"-DI Color",type:"color",default:"#ff9797"}],aroon:[{id:"length",label:"Length",type:"number",default:14},{id:"upColor",label:"Up Color",type:"color",default:"#6cffb0"},{id:"downColor",label:"Down Color",type:"color",default:"#ff8f8f"}],vortex:[{id:"length",label:"Length",type:"number",default:14},{id:"plusColor",label:"VI+ Color",type:"color",default:"#d6a8ff"},{id:"minusColor",label:"VI- Color",type:"color",default:"#ffb0f3"}]},iv={sma20:{creator:"Early quantitative analysts (1900s tape reading era)",era:"Formalized in the early 20th century",math:"Arithmetic mean of the last N closes.",context:"Designed to smooth noisy tape data for trend direction visibility.",regime:"Best in directional trends, weaker in mean-reverting chop."},ema20:{creator:"Modern technical analysts adapting exponential smoothing",era:"Popularized in 1960s-1980s",math:"Recursive weighted mean with alpha = 2/(N+1).",context:"Improves responsiveness versus SMA while preserving trend structure.",regime:"Useful for pullback entries in trending environments."},ichimoku:{creator:"Goichi Hosoda",era:"Developed pre-WW2, published 1969",math:"Median-price lines (9/26/52) plus shifted cloud projections.",context:"Built as a full market regime system: trend, momentum, support/resistance in one frame.",regime:"Most reliable when cloud slope and price acceptance align."},macd:{creator:"Gerald Appel",era:"Late 1970s",math:"MACD = EMA(12)-EMA(26), signal=EMA(9) of MACD, histogram=spread.",context:"Tracks trend acceleration/deceleration, not just direction.",regime:"Strong in trend transitions, noisy in low-volatility ranges."},rsi:{creator:"J. Welles Wilder Jr.",era:"1978",math:"RSI = 100 - 100/(1+RS), RS = avg gain / avg loss.",context:"Measures internal momentum pressure rather than price level alone.",regime:"Range shifts (bull/bear RSI zones) matter more than static 30/70."},adx:{creator:"J. Welles Wilder Jr.",era:"1978",math:"Smoothed directional movement (+DI/-DI) transformed into trend-strength index.",context:"Separates trend strength from trend direction.",regime:"Filter trades: momentum systems improve when ADX slope rises."},aroon:{creator:"Tushar Chande",era:"1995",math:"Time since recent high/low scaled to 0-100.",context:"Focuses on trend freshness instead of pure magnitude.",regime:"Good at identifying emergent trend phases and late-trend fatigue."},cci:{creator:"Donald Lambert",era:"1980",math:"Deviation of typical price from moving average normalized by mean deviation.",context:"Originally commodity cycle tool for identifying statistical extremes.",regime:"Works better with volatility-aware thresholds than fixed +/-100."},williamsr:{creator:"Larry Williams",era:"1970s",math:"Position of close within rolling high-low range, scaled negative.",context:"Fast oscillator for short-horizon exhaustion and reversion timing.",regime:"Most effective in bounded ranges; trend filters prevent fade traps."},mfi:{creator:"Gene Quong and Avrum Soudack",era:"1989",math:"RSI-style transform using typical price * volume money flow.",context:"Adds participation/volume dimension to momentum analysis.",regime:"Useful where volume quality is high; weaker on fragmented liquidity."},obv:{creator:"Joseph Granville",era:"1963",math:"Cumulative signed volume based on close direction.",context:"Detects accumulation/distribution before obvious price moves.",regime:"Best when confirmed with structure breaks and volume regime shifts."},vwap:{creator:"Institutional execution desks",era:"1980s electronic execution era",math:"Cumulative price*volume divided by cumulative volume.",context:"Execution benchmark and intraday fair-value reference.",regime:"Most meaningful intraday and around session anchor resets."},bb20:{creator:"John Bollinger",era:"1980s",math:"SMA +/- k * standard deviation.",context:"Captures volatility contraction/expansion around a mean.",regime:"Band walks imply trend persistence; squeezes imply potential expansion."},atr:{creator:"J. Welles Wilder Jr.",era:"1978",math:"Smoothed average of true range components.",context:"Volatility unit for risk sizing and adaptive stops.",regime:"Risk engine input rather than directional signal."},donchian:{creator:"Richard Donchian",era:"1940s-1950s",math:"Rolling highest-high and lowest-low channels.",context:"Classic breakout trend-following framework.",regime:"Performs in sustained directional moves, whipsaws in compression."},supertrend:{creator:"Olivier Seban",era:"2009",math:"ATR envelope with trend-state switching logic.",context:"Simplifies trend-following and stop-trailing into one overlay.",regime:"Good in clean trends; combine with structure/ADX in chop."},vortex:{creator:"Etienne Botes and Douglas Siepman",era:"2010",math:"Normalized positive/negative movement vectors over rolling true range.",context:"Detects trend emergence and directional dominance shifts.",regime:"Improves when paired with volatility and liquidity filters."}},rv={hline:"Horizontal levels represent reaction zones. Respect zone width and liquidity sweeps."},lv=[{label:"XRP/USD (Bitstamp)",asset:{currency:"XRP"},asset2:{currency:"USD",issuer:"rhub8VRN55s94qWKDv6jmDy1pUykJzF3wq"}},{label:"XRP/EUR (Bitstamp)",asset:{currency:"XRP"},asset2:{currency:"EUR",issuer:"rhub8VRN55s94qWKDv6jmDy1pUykJzF3wq"}},{label:"XRP/USDC (Gatehub)",asset:{currency:"XRP"},asset2:{currency:"USDC",issuer:"rKveEyR1SrkWbJX214xcfH43ZsoGMb3PEv"}}],Rc="wallets",$n=null,an={},Zn="",ft=1,we={algo:"ed25519",label:"",emoji:"\u{1F48E}",color:"#50fa7b",seed:"",address:"",passphrase:""},Sn=new Set,dc=60,cv={wallet_created:"\u{1F48E}",wallet_removed:"\u{1F5D1}",social_connected:"\u{1F517}",social_removed:"\u2715",profile_saved:"\u270F\uFE0F",trustline_added:"\u{1F517}",sent:"\u2B06",received:"\u2B07",vault_created:"\u{1F510}",backup_exported:"\u{1F4C2}",theme_changed:"\u{1F3A8}",wallet_imported:"\u{1F511}",watch_added:"\u{1F441}"};function Dc(){Qo(),qb(),mv(),C.threeEnabled=Z(ci)!=="0",dv(),Ea().catch(()=>{be("Could not preload xrpl.js. Wallet generation/signing will require network access when used.")}),q(),Yo("wallets"),Et(),Zb(),uv(),Ma()&&es({silent:!0}),window.addEventListener("naluxrp:pagechange",e=>{var t;((t=e==null?void 0:e.detail)==null?void 0:t.pageId)==="profile"?es({silent:!0}):Oe.raf&&Is()}),document.addEventListener("click",e=>{var s;let t=document.querySelector(".xpd-indicator-menu-wrap");t&&!t.contains(e.target)&&C.indicatorMenuOpen&&(C.indicatorMenuOpen=!1,q());let n=document.querySelector(".xpd-more-menu-wrap");if(n&&!n.contains(e.target)&&C.moreMenuOpen&&(C.moreMenuOpen=!1,q()),C.settingsOpenFor){let a=(s=document.querySelector(".xpd-indicator-settings"))==null?void 0:s.closest(".xpd-indicator-chip-wrap");a&&!a.contains(e.target)&&(C.settingsOpenFor=null,q())}}),window.addEventListener("naluxrp:vault-ready",()=>{Qo(),q(),Yo(Rc),Et(),Ib(),es({silent:!0,force:!0})}),window.addEventListener("naluxrp:vault-locked",()=>{q(),es({silent:!0,force:!0})}),document.addEventListener("visibilitychange",()=>{if(Ma()&&!document.hidden&&ie.length){let e=ie.filter(t=>{let n=Ve[t.address];return!n||Date.now()-n.fetchedAt>3e5});e.length&&Promise.all(e.map(t=>Mn(t.address))).then(()=>{at(),Et()})}})}function dv(){let e=new URLSearchParams(window.location.search),t=e.get("pair")||"",n=e.get("tf")||"",s=e.get("token")||Z(Ec)||"",a=e.get("ind")||"";if(t&&Cn.some(o=>o.id===t)&&(C.pair=t),n&&Nc.some(o=>o.value===n)&&(C.interval=n),a){let o=new Set(a.split(",").map(i=>i.trim()).filter(Boolean));Object.keys(C.indicators).forEach(i=>{C.indicators[i]=o.has(i)})}s&&(C.tokenFocusKey=s,j.selectedTokenKey=s)}function $t(){let e=new URLSearchParams(window.location.search);e.set("pair",C.pair||"BITSTAMP:XRPUSD"),e.set("tf",C.interval||"15"),C.tokenFocusKey?e.set("token",C.tokenFocusKey):e.delete("token");let t=Object.entries(C.indicators).filter(([,s])=>!!s).map(([s])=>s).join(",");t?e.set("ind",t):e.delete("ind");let n=`${window.location.pathname}?${e.toString()}${window.location.hash||""}`;window.history.replaceState(null,"",n),C.tokenFocusKey&&te(Ec,C.tokenFocusKey)}function pv(){let e=document.getElementById("xpd-chart-section");e&&e.scrollIntoView({behavior:"smooth",block:"start"})}function uv(){rc||(rc=!0,window.addEventListener("xrpl-ledger",()=>{let e=Date.now();e-lc<5e3||(lc=e,X.currentPage==="profile"&&document.querySelector("#profile-page .profile-wrap .xrpl-profile-dashboard")&&Kc().then(()=>{if(Date.now()-Cc>15e3)return;let n=document.activeElement;n&&/^(INPUT|TEXTAREA|SELECT)$/.test(n.tagName)||C.moreMenuOpen||C.indicatorMenuOpen||(Ps.clear(),q())}).catch(()=>{}))}))}function pi(e){Rc=e,De(".ptab-btn").forEach(t=>t.classList.toggle("active",t.dataset.tab===e)),Yo(e)}function Yo(e){try{switch(e){case"wallets":at();break;case"social":Ia();break;case"activity":gp();break;case"settings":as();break;case"analytics":vp();break;case"security":Eb();break}}catch(t){let n=y(`profile-tab-${e}`);n&&Ic(n,e,t),console.error(`Profile tab "${e}" error:`,t)}["wallets","social","activity","settings","analytics","security"].forEach(t=>{let n=y(`profile-tab-${t}`);n&&(n.style.display=t===e?"":"none")})}function Ic(e,t,n){e.innerHTML=`<div class="tab-error-card">
  ...
  </div>`}function mv(){document.addEventListener("keydown",e=>{if(e.key==="Escape")for(let t of["profile-editor-modal","wallet-creator-overlay","social-modal","send-modal-overlay","receive-modal-overlay","trustline-modal-overlay","import-address-modal","import-seed-modal","token-details-modal","pub-profile-overlay"]){let n=y(t)||document.getElementById(t);if(n!=null&&n.classList.contains("show")||(n==null?void 0:n.style.display)==="flex"){n.classList.remove("show"),n.style.display==="flex"&&(n.style.display="none");return}}e.key==="k"&&(e.ctrlKey||e.metaKey)&&(e.preventDefault(),yi())})}function Qo(){var t,n;let e=ve(Z(wc));e&&Object.assign(le,e),He=ve(Z(xc))||{},ie=ve(Z(yc))||[],Tc=ve(Z(Xg))||{},C.alerts=ve(Z(Ac))||[],st=Z(Es)||((t=ie[0])==null?void 0:t.id)||null,!le.displayName&&((n=X.session)!=null&&n.name)&&(le.displayName=X.session.name,le.handle=X.session.name.toLowerCase().replace(/\s+/g,"_"),Fc())}function Fc(){te(wc,JSON.stringify(le))}function Ns(){te(yc,JSON.stringify(ie))}function Bc(){te(xc,JSON.stringify(He))}function ui(){te(Ac,JSON.stringify(C.alerts||[]))}function gt(e,t){let n=ve(Z(Go))||[];n.unshift({type:e,detail:t,ts:Date.now()}),n.length>dc&&(n.length=dc),te(Go,JSON.stringify(n))}function fv(){return ve(Z(Go))||[]}function Xc(e){let t=(Date.now()-e)/1e3;return t<60?"just now":t<3600?`${Math.floor(t/60)}m ago`:t<86400?`${Math.floor(t/3600)}h ago`:`${Math.floor(t/86400)}d ago`}function St(){return ie.find(e=>e.id===st)||ie[0]||null}function Oc(e){ie.find(t=>t.id===e)&&(st=e,te(Es,e),at(),Et(),window.dispatchEvent(new CustomEvent("naluxrp:active-wallet-changed",{detail:St()})),se("Active wallet switched"))}window.addEventListener("naluxrp:active-wallet-changed",e=>{let t=e.detail;if(!t)return;let n=y("inspect-addr");n&&!n.value&&(n.value=t.address),X.activeWalletAddress=t.address});function Et(){var o;let e=y("active-wallet-bar");if(!e)return;let t=St();if(!t){e.innerHTML='<div class="awb-empty">No wallet \u2014 <button class="awb-link" onclick="openWalletCreator()">create one</button></div>';return}let n=Ve[t.address],s=n?I(n.xrp,2)+" XRP":"\u2014 XRP",a=(o=n==null?void 0:n.tokens)!=null&&o.length?`\xB7 ${n.tokens.length} token${n.tokens.length>1?"s":""}`:"";e.innerHTML=`
    <div class="awb-left">
    ...
    </div>`}function q(){var w,k;let e=document.querySelector("#profile-page .profile-wrap");if(!e)return;let t=document.getElementById("xpd-tv-widget"),n=!!(t&&ee.chart);t&&t.remove();let s=document.getElementById("xpd-chart-atmosphere"),a=!!(s&&Oe.renderer);s&&s.remove();let o=St(),i=(o==null?void 0:o.address)||"",r=hv(),l=localStorage.getItem(on),c=ie.some(v=>!v.watchOnly),d=Z(Ko)==="1",u=(w=Ve[i])==null?void 0:w.xrp,p=Object.values(Ve).reduce((v,x)=>v+((x==null?void 0:x.xrp)||0),0),m=(k=Te.data)!=null&&k.priceUsd?p*Te.data.priceUsd:0,f=Cn.map(v=>`<option value="${b(v.id)}" ${C.pair===v.id?"selected":""}>${b(v.label)}</option>`).join(""),g=Cn.map(v=>`<option value="${b(v.id)}" ${C.comparePair===v.id?"selected":""}>${b(v.label)}</option>`).join(""),h=Nc.map(v=>`<option value="${b(v.value)}" ${C.interval===v.value?"selected":""}>${b(v.label)}</option>`).join("");if(e.innerHTML=`
        ...
        <aside class="xpd-profile-card" aria-label="Profile identity">
          ...
          <div class="xpd-profile-list">
            ...
            <div class="xpd-item-row">
              ...
              <span class="xpd-item-value">${Number.isFinite(u)?`${I(u,4)} XRP`:"\u2014"}</span>
            </div>
            <div class="xpd-item-row">
          ...
          <div class="xpd-sidebar-snapshot">
            ...
            <div class="xpd-sidebar-snapshot-row">
              <span>Est. USD</span>
              <strong>${m?`$${I(m,2)}`:"\u2014"}</strong>
            </div>
            <div class="xpd-sidebar-snapshot-row">
              <span>Wallets</span>
              <strong>${ie.length}</strong>
            </div>
          </div>
        </aside>
              ...
              <div class="xpd-chart-toolbar">
                ...
                <div class="xpd-toolbar-group">
                  ...
                  <select class="xpd-input" onchange="setDrawingTool(this.value)">
                    ${_c.map(v=>`<option value="${v.key}" ${C.drawingTool===v.key?"selected":""}>Draw: ${v.label}</option>`).join("")}
                  </select>
    ...
    </div>`,n){let v=document.getElementById("xpd-tv-widget");v&&v.replaceWith(t)}if(a){let v=document.getElementById("xpd-chart-atmosphere");v&&v.replaceWith(s)}mb(),gp(),vp(),Ia(),as()}function hv(){let e=String(X.currentNetwork||"").toLowerCase();return e.includes("testnet")?{label:"XRPL Testnet",kind:"testnet"}:e.includes("mainnet")?{label:"XRPL Mainnet",kind:"mainnet"}:e.includes("xahau")?{label:"Xahau Network",kind:"xahau"}:{label:`Network: ${b(X.currentNetwork||"Unknown")}`,kind:"unknown"}}function gv(){let e=String(C.indicatorQuery||"").trim().toLowerCase(),t=[{key:"trend",label:"Trend",icon:"\u{1F4C8}"},{key:"momentum",label:"Momentum",icon:"\u26A1"},{key:"volume",label:"Volume",icon:"\u{1F4CA}"},{key:"volatility",label:"Volatility",icon:"\u{1F32A}\uFE0F"},{key:"advanced",label:"Custom",icon:"\u{1F9E0}"}];return`
    <div class="xpd-indicator-menu-wrap">
      ...
      ${C.indicatorMenuOpen?`
        <div class="xpd-indicator-menu" role="menu" aria-label="Indicator menu">
          ...
          ${t.map(n=>{let s=(ov[n.key]||[]).filter(a=>{var i;return e?(((i=Ht[a])==null?void 0:i.name)||a).toLowerCase().includes(e):!0});return s.length?`
    ...
    <div class="xpd-chart-stats">
      ...
      ${i?`<div class="xpd-pill" title="Token focus">Token Focus: ${b(i.symbol)} ${i.price!=null?`($${I(i.price,6)})`:""}</div>`:""}
    </div>
    <div class="xpd-indicator-row">
      ${s.length?s.map(f=>{var g,h;return`<div class="xpd-indicator-chip-wrap"><div class="xpd-indicator-chip" title="${b(((g=Ht[f])==null?void 0:g.what)||"")}"><span>${b(((h=Ht[f])==null?void 0:h.name)||f)}</span><button class="xpd-mini-btn" onclick="event.stopPropagation(); openIndicatorSettings('${f}')">\u2699</button><button class="xpd-mini-btn" onclick="removeIndicator('${f}')">\u2715</button></div>${fb(f)}</div>`}).join(""):'<span class="xpd-empty">No indicators enabled. Use + Indicator.</span>'}
    </div>
    ${(()=>{let f=Na(),g=(C.alerts||[]).filter(h=>h.tokenKey===f);return g.length?`
      <div class="xpd-indicator-row">
        ${g.map(h=>`
          <div class="xpd-indicator-chip" data-alert-id="${b(h.id)}" title="Notify when price crosses $${I(h.price,6)}">
            <span>\u{1F514} $${I(h.price,6)}</span>
    ...
    <p class="xpd-note">Professional chart controls: wheel zoom, hold-and-drag pan, horizontal price-line marking, and token-focused context ribbons for faster execution decisions.</p>`}function bv(){let e=C.selectedIndicator||"sma20",t=Ht[e]||Ht.sma20,n=iv[e]||null,s=C.educationCollapsed;return`
    <div class="xpd-edu-panel ${s?"collapsed":""}">
      ...
      ${s?"":`
        ...
        `:""}
      `}
    </div>`}function nt(e,t){return`<div class="xpd-edu-row"><span class="xpd-edu-label">${b(e)}</span><span class="xpd-edu-value">${b(t)}</span></div>`}function yv(){if(Te.loading)return'<div class="xpd-loading">Loading XRP market snapshot...</div>';if(Te.error)return`<div class="xpd-error">${b(Te.error)}</div>`;let e=Te.data;if(!e)return'<div class="xpd-empty">Market data is not available yet.</div>';let t=e.change24h>=0;return`
    <div class="xpd-market-grid">
      <article class="xpd-stat-card">
        <span class="xpd-stat-label">XRP Price</span>
        <strong class="xpd-stat-value">$${I(e.priceUsd,4)}</strong>
      </article>
      <article class="xpd-stat-card">
        <span class="xpd-stat-label">24h Change</span>
        <strong class="xpd-stat-value ${t?"up":"down"}">${t?"+":""}${I(e.change24h,2)}%</strong>
      </article>
      <article class="xpd-stat-card">
    ...
    <div class="xpd-token-strip">
      ${av.map(n=>`<div class="xpd-token-pill" title="${b(`${n.symbol} ${n.name}`)}"><span class="sym xpd-pill-text">${n.symbol}</span><span class="xpd-pill-text">${b(n.name)}</span><span class="cap xpd-pill-text">${n.marketCap}</span></div>`).join("")}
    </div>
    <p class="xpd-note">Top XRPL token cards are static examples when direct DEX market-cap feeds are unavailable.</p>`}function wv(e){return e?ut.loading?'<div class="xpd-loading">Loading account NFTs...</div>':ut.error?`<div class="xpd-error">${b(ut.error)}</div>`:ut.items.length?`<div class="xpd-nft-grid">${ut.items.map(xv).join("")}</div>`:'<div class="xpd-empty">No NFTs found for this wallet.</div>':'<div class="xpd-empty">Select or create a wallet to load NFTs.</div>'}function xv(e){let t=`${e.id.slice(0,12)}...${e.id.slice(-10)}`;return`<article class="xpd-nft-card">
  ...
  </article>`}function kv(e){let t=Cv(e),n=Mv(),s=Lv();return`<div class="xpd-amm-columns">${t}${n}${s}</div>`}function mi(){return(ve(Z(Pc))||[]).filter(Boolean)}function Hc(e){let t=[...new Set((e||[]).filter(Boolean))];te(Pc,JSON.stringify(t))}function $v(e,t){return t.has(e)?t.get(e):j.tokens.find(s=>s.symbol===e)||null}function Sv(){let e=j.query||"",t=mi(),n=j.filtered.length?j.filtered:j.tokens,s=Math.max(120,Number(j.listLimit||240)),a=n.slice(0,s),o=j.trending.slice(0,14),i=new Map(j.tokens.map(c=>[ht(c),c])),r=i.get(j.selectedTokenKey)||null,l=j.filters||{type:"all",minCap:0,minVol:0,hasDex:!1};return`
    <div class="xpd-token-grid">
      <div class="xpd-token-col">
        <div class="xpd-search-row">
          ...
          <datalist id="xpd-token-suggest">${j.tokens.slice(0,80).map(c=>`<option value="${b(c.symbol)}">${b(c.name)}</option>`).join("")}</datalist>
        ...
        ${j.error?`<div class="xpd-error">${b(j.error)}</div>`:""}
        <div class="xpd-token-list">${a.map(c=>{let d=ht(c),u=encodeURIComponent(d),p=String(e||"").trim();return`
          <div class="xpd-token-row xpd-token-row--clickable" title="${b(`${c.symbol} ${c.name}`)}" onclick="openTokenOnChart(decodeURIComponent('${u}'))">
            <div class="xpd-token-main">
              <strong>${pc(c.symbol,p)}</strong>
              <span>${pc(c.name,p)}</span>
              ${c.issuer?`<span class="mono xpd-pill-text">${b(c.issuer)}</span>`:""}
            </div>
            <div class="xpd-token-actions">
              <span>${c.price!=null?`$${I(c.price,6)}`:"\u2014"}</span>
      ...
      <div class="xpd-token-col">
        ${r?`<div class="xpd-token-detail-card">
          ...
          <div class="pool-meta">Price: ${r.price!=null?`$${I(r.price,6)}`:"\u2014"} \xB7 24h Vol: ${r.volume24h!=null?`$${pt(r.volume24h)}`:"\u2014"}</div>
        ...
        <h3>Watchlist</h3>
        <div class="xpd-watchlist">${t.length?t.map(c=>{let d=$v(c,i),u=d?`${d.symbol} \xB7 ${d.name}`:c,p=(d==null?void 0:d.price)!=null?`$${I(d.price,6)}`:"\u2014",m=encodeURIComponent(c);return`<div class="xpd-token-row xpd-token-row--clickable" onclick="openTokenOnChart(decodeURIComponent('${m}'))"><span>${b(u)}</span><div class="xpd-token-actions"><span>${p}</span><button class="xpd-mini-btn" onclick="event.stopPropagation(); openTokenOnChart(decodeURIComponent('${m}'))">Chart</button><button class="xpd-mini-btn" onclick="event.stopPropagation(); removeTokenFromWatchlist(decodeURIComponent('${m}'))">Remove</button></div></div>`}).join(""):'<div class="xpd-empty">No watchlist tokens yet.</div>'}</div>
        <h3>Trending</h3>
        <div class="xpd-watchlist">${o.length?o.map(c=>`<div class="xpd-token-row xpd-token-row--clickable" onclick="openTokenOnChart(decodeURIComponent('${encodeURIComponent(ht(c))}'))"><span>${b(c.symbol)} \xB7 ${b(c.name)}</span><span>${c.volume24h!=null?`$${pt(c.volume24h)} vol`:c.marketCap!=null?`$${pt(c.marketCap)} mcap`:"\u2014"}</span></div>`).join(""):'<div class="xpd-empty">No trending data.</div>'}</div>
      </div>
    </div>`}function pc(e,t){let n=String(e||""),s=String(t||"").trim();if(!s)return b(n);let a=n.toLowerCase().indexOf(s.toLowerCase());if(a<0)return b(n);let o=b(n.slice(0,a)),i=b(n.slice(a,a+s.length)),r=b(n.slice(a+s.length));return`${o}<mark class="xpd-hit">${i}</mark>${r}`}function Tv(e){var a,o;let t=Object.values(Ve).reduce((i,r)=>i+((r==null?void 0:r.xrp)||0),0),n=(a=Te.data)!=null&&a.priceUsd?t*Te.data.priceUsd:0,s=wt.items.slice(0,8);return`
    <div class="xpd-token-grid">
      <div class="xpd-token-col">
        <div class="xpd-market-grid">
          <article class="xpd-stat-card xpd-token-row--clickable" onclick="openTokenOnChart('XRP')"><span class="xpd-stat-label">Portfolio XRP</span><strong class="xpd-stat-value">${I(t,4)}</strong></article>
          <article class="xpd-stat-card"><span class="xpd-stat-label">Portfolio USD</span><strong class="xpd-stat-value">${n?`$${I(n,2)}`:"\u2014"}</strong></article>
          <article class="xpd-stat-card"><span class="xpd-stat-label">Wallets</span><strong class="xpd-stat-value">${ie.length}</strong></article>
    ...
    </div>`}function Cv(e){return e?mt.loading?'<div class="xpd-amm-card"><h3>Your liquidity positions</h3><div class="xpd-loading">Loading account_objects and LP balances...</div></div>':mt.error?`<div class="xpd-amm-card"><h3>Your liquidity positions</h3><div class="xpd-error">${b(mt.error)}</div></div>`:mt.pools.length?`<div class="xpd-amm-card"><h3>Your liquidity positions</h3><div class="xpd-pool-list">${mt.pools.map(t=>`
    ...
    </div>`).join("")}</div></div>`:'<div class="xpd-amm-card"><h3>Your liquidity positions</h3><div class="xpd-empty">No AMM entries or LP-token balances detected for this wallet yet.</div></div>':'<div class="xpd-amm-card"><h3>Your liquidity positions</h3><div class="xpd-empty">No active wallet.</div></div>'}function Mv(){return xt.loading?'<div class="xpd-amm-card"><h3>General pool explorer</h3><div class="xpd-loading">Loading amm_info for known pools...</div></div>':xt.error?`<div class="xpd-amm-card"><h3>General pool explorer</h3><div class="xpd-error">${b(xt.error)}</div></div>`:xt.pools.length?`<div class="xpd-amm-card"><h3>General pool explorer</h3><div class="xpd-pool-list">${xt.pools.map(e=>`
    <div class="xpd-pool-item">
    ...
    ${_e.pool?`<div class="xpd-pool-item">
      ...
      <div class="xpd-pool-row"><span class="xpd-pool-row-label">TVL</span><span class="xpd-pool-row-value">${b(_e.pool.tvl||"Unavailable")}</span></div>
  ...
  </div>`}function pt(e){return Number.isFinite(Number(e))?new Intl.NumberFormat("en-US",{notation:"compact",maximumFractionDigits:2}).format(Number(e)):"\u2014"}function ts(e){return typeof e=="string"?`${I(Number(e)/1e6,4)} XRP`:e&&typeof e=="object"?`${I(Number(e.value||0),4)} ${e.currency||"UNK"}`:"\u2014"}function Pv(e){if(!e||typeof e!="string")return"";try{let t=e.trim();if(!/^[0-9A-Fa-f]+$/.test(t)||t.length%2!==0)return t;let n=new Uint8Array(t.length/2);for(let s=0;s<t.length;s+=2)n[s/2]=parseInt(t.slice(s,s+2),16);return new TextDecoder().decode(n)}catch{return""}}function uc(e){return e?e.startsWith("ipfs://")?`https://ipfs.io/ipfs/${e.slice(7)}`:e.startsWith("ar://")?`https://arweave.net/${e.slice(5)}`:e:""}async function Ev(e){let t=uc(Pv(e.URI||e.uri||""));if(!t)return"";if(/\.(png|jpg|jpeg|gif|webp|svg)$/i.test(t))return t;try{let n=await fetch(t,{method:"GET"});if(!n.ok)return"";let s=await n.json(),a=(s==null?void 0:s.image)||(s==null?void 0:s.image_url)||(s==null?void 0:s.thumbnail);return uc(a||"")}catch{return""}}async function kt(e,{timeoutMs:t=9e3,allowProxy:n=!0}={}){let s=async a=>{let o=typeof(AbortSignal==null?void 0:AbortSignal.timeout)=="function"?AbortSignal.timeout(t):void 0,i=await fetch(a,{method:"GET",mode:"cors",cache:"no-store",signal:o});if(!i.ok)throw new Error(`HTTP ${i.status}`);return await i.json()};try{return await s(e)}catch(a){if(!n)throw a;for(let o of zg)try{return await s(o(e))}catch{}throw a}}async function zc(){var e;Te.loading=!0,Te.error="",q();try{let t=await kt("https://api.exchange.coinbase.com/products/XRP-USD/ticker"),n=await kt("https://api.exchange.coinbase.com/products/XRP-USD/candles?granularity=86400"),s=Array.isArray(n)&&n.length?n[0]:null,a=Number((t==null?void 0:t.price)||0),o=s?Number(s[3]||0):a,i=s?Number(s[2]||a):a,r=s?Number(s[1]||a):a,l=s?Number(s[5]||0):0;Te.data={priceUsd:a,change24h:o?(a-o)/o*100:0,volume24h:l*a,marketCap:Number(((e=Te.data)==null?void 0:e.marketCap)||0),high24h:i,low24h:r}}catch(t){Te.error=(t==null?void 0:t.message)||"Could not load market data right now.",Te.data=null}finally{Te.loading=!1,q()}}async function Uc(e){if(ut.loading=!0,ut.error="",ut.items=[],q(),!e){ut.loading=!1,q();return}try{let t,n=[];do{let a=await Je({method:"account_nfts",params:[{account:e,limit:100,...t?{marker:t}:{}}]});n.push(...(a==null?void 0:a.account_nfts)||[]),t=a==null?void 0:a.marker}while(t);let s=await Promise.all(n.slice(0,80).map(async a=>({id:a.NFTokenID||a.nf_token_id||"Unknown",image:await Ev(a)})));ut.items=s}catch(t){ut.error=(t==null?void 0:t.message)||"Could not load NFTs for this wallet."}finally{ut.loading=!1,q()}}async function Wc(e){if(mt.loading=!0,mt.error="",mt.pools=[],q(),!e){mt.loading=!1,q();return}try{let t=[],n;do{let o=await Je({method:"account_objects",params:[{account:e,type:"amm",limit:200,...n?{marker:n}:{}}]});((o==null?void 0:o.account_objects)||[]).forEach(r=>{let l=ts(r.Asset||r.amount),c=ts(r.Asset2||r.amount2),d=l.split(" ").pop()||"AssetA",u=c.split(" ").pop()||"AssetB";t.push({pair:`${d}/${u}`,lpBalance:r.LPTokenBalance?ts(r.LPTokenBalance):"Not reported",estimatedValue:"Estimate unavailable",tradingFee:r.TradingFee!=null?`${r.TradingFee} bps`:"\u2014",tvl:"Unavailable"})}),n=o==null?void 0:o.marker}while(n);let s=await Je({method:"account_lines",params:[{account:e,limit:200}]});((s==null?void 0:s.lines)||[]).filter(o=>typeof o.currency=="string"&&o.currency.length>=16&&Number(o.balance)>0).forEach(o=>{t.push({pair:`LP Token ${o.currency.slice(0,8)}...`,lpBalance:`${I(Number(o.balance),4)} ${o.currency.slice(0,8)}...`,estimatedValue:"Estimate unavailable",tradingFee:"\u2014",tvl:"Unavailable"})}),mt.pools=t}catch(t){mt.error=(t==null?void 0:t.message)||"Could not load account AMM objects."}finally{mt.loading=!1,q()}}async function jc(e){try{let t=await Je({method:"amm_info",params:[{asset:e.asset,asset2:e.asset2}]}),n=t==null?void 0:t.amm;return n?{label:e.label,reserveA:ts(n.amount),reserveB:ts(n.amount2),tradingFee:String(n.trading_fee??"\u2014"),totalLp:ts(n.lp_token||n.lp_token_balance),tvl:Av(n.amount,n.amount2)}:null}catch{return null}}function Av(e,t){let n=a=>typeof a=="string"?Number(a)/1e6:a&&typeof a=="object"?Number(a.value||0):0,s=n(e)+n(t);return!Number.isFinite(s)||s<=0?"Unavailable":`${I(s,4)} (asset units)`}async function qc(){xt.loading=!0,xt.error="",q();try{let e=await Promise.all(lv.map(jc));xt.pools=e.filter(Boolean)}catch(e){xt.error=(e==null?void 0:e.message)||"Could not load AMM explorer data.",xt.pools=[]}finally{xt.loading=!1,q()}}async function Vc(){var r,l,c,d;let e=(((r=document.getElementById("xpd-asset1-currency"))==null?void 0:r.value)||"").trim().toUpperCase(),t=(((l=document.getElementById("xpd-asset1-issuer"))==null?void 0:l.value)||"").trim(),n=(((c=document.getElementById("xpd-asset2-currency"))==null?void 0:c.value)||"").trim().toUpperCase(),s=(((d=document.getElementById("xpd-asset2-issuer"))==null?void 0:d.value)||"").trim();if(!e||!n){_e.error="Enter both asset currency codes first.",q();return}let a=e==="XRP"?{currency:"XRP"}:{currency:e,issuer:t},o=n==="XRP"?{currency:"XRP"}:{currency:n,issuer:s};if(e!=="XRP"&&!t||n!=="XRP"&&!s){_e.error="Issuer is required for non-XRP assets.",q();return}_e.loading=!0,_e.error="",_e.pool=null,q();let i=await jc({label:`${e}/${n}`,asset:a,asset2:o});_e.loading=!1,i?_e.pool=i:_e.error="Pool not found or unavailable on this network.",q()}function Aa(){return Cn.find(e=>e.id===C.pair)||Cn[0]}function fi(e){if(e==="D")return 1440;if(e==="W")return 10080;if(e==="M")return 43200;let t=Number(e);return Number.isFinite(t)&&t>0?t:60}function Nv(e){if(e==="M")return"W";if(e==="D"||e==="W")return e;let t=fi(e);for(let n of[5,15,60,240])if(t<=n)return String(n);return"D"}async function _v(e,t,n,s=200){var d;let a=t?`${e}.${t}`:e,o=Nv(n),i=Math.min(2e3,Math.max(20,Number(s)||200)),r=`https://api.onthedex.live/public/v1/ohlc?base=${encodeURIComponent(a)}&quote=XRP&interval=${o}&bars=${i}`,l=await kt(r,{timeoutMs:1e4});return(Array.isArray((d=l==null?void 0:l.data)==null?void 0:d.ohlc)?l.data.ohlc:[]).map(u=>({time:Number(u.t),open:Number(u.o),high:Number(u.h),low:Number(u.l),close:Number(u.c),volume:Number(u.vb||0)})).filter(u=>Number.isFinite(u.time)&&[u.open,u.high,u.low,u.close].every(Number.isFinite)).sort((u,p)=>u.time-p.time)}function Gc(e){return{xrpusd:"XRP-USD",XRPUSDT:"XRP-USD",ETHUSDT:"ETH-USD",BTCUSDT:"BTC-USD",SOLUSDT:"SOL-USD"}[e]||null}function Rv(e){return{XRP:"XRP-USD",BTC:"BTC-USD",ETH:"ETH-USD",SOL:"SOL-USD",USDC:"USDC-USD"}[String(e||"").toUpperCase()]||null}var qo=new Map;async function Dv(e,t){if(!e)return null;let n=`${ht(e)}:${t}`,s=qo.get(n);if(s)return s;let a=Iv(e,t);qo.set(n,a);try{return await a}finally{qo.delete(n)}}async function Iv(e,t){var o,i;let n=String(e.symbol||"").toUpperCase();if(!n||n==="XRP")return null;let s=Rv(n);if(s)try{let r=Yc(t),l=r===86400?Mc:Lc,{candles:c,reachedStart:d}=await ni(s,r,l);if(c.length){let u=d?`${new Date(c[0].time*1e3).getUTCFullYear()}\u2013present`:`last ${c.length} bars`;return{candles:c,source:`Coinbase direct (${s}, ${u})`,mode:"token-direct"}}}catch{}let a=String(e.issuer||"").trim();if(a)try{let r=await _v(n,a,t,2e3);if(r.length){let l=Number(((o=C.stats)==null?void 0:o.xrplSpot)||((i=C.stats)==null?void 0:i.price)||0);return{candles:l>0?r.map(d=>({time:d.time,open:d.open*l,high:d.high*l,low:d.low*l,close:d.close*l,volume:d.volume})):r,source:`OnTheDex XRPL DEX (${n}/XRP)`,mode:"token-direct"}}}catch{}return null}function Fv(e,{mode:t="pair",source:n="Source pending",tokenKey:s=""}={}){let a=Array.isArray(e)?e:[];if(!a.length){C.chartMeta={tokenKey:s||C.tokenFocusKey||"XRP|",symbol:s&&s.split("|")[0]||"XRP",source:n,last:null,high:null,low:null,mode:t};return}let o=a[a.length-1],i=a.map(c=>Number(c.high)).filter(c=>Number.isFinite(c)),r=a.map(c=>Number(c.low)).filter(c=>Number.isFinite(c)),l=s||C.tokenFocusKey||"XRP|";C.chartMeta={tokenKey:l,symbol:l.split("|")[0]||"XRP",source:n,last:Number(o.close),high:i.length?Math.max(...i):Number(o.high),low:r.length?Math.min(...r):Number(o.low),mode:t}}async function Ds(){var t;let e=Aa();C.loading=!0,C.error="";try{let n=Gc(e.ticker);if(n){let s=await kt(`https://api.exchange.coinbase.com/products/${n}/ticker`),a=await kt(`https://api.exchange.coinbase.com/products/${n}/candles?granularity=86400`),o=Array.isArray(a)&&a.length?a[0]:null,i=Number(s.price||0),r=o?Number(o[3]):i;C.stats={price:i,high:o?Number(o[2]):i,low:o?Number(o[1]):i,changePct:r?(i-r)/r*100:0,baseSource:"Coinbase",source:"Coinbase"},await Kc(),!Te.data&&C.stats.price&&(Te.data={priceUsd:C.stats.price,change24h:C.stats.changePct,volume24h:o?Number(o[5]||0)*C.stats.price:0,marketCap:Number(((t=Te.data)==null?void 0:t.marketCap)||0)});return}throw new Error("Chart stats unavailable for selected pair.")}catch(n){C.error=(n==null?void 0:n.message)||"DEX chart stats unavailable right now."}finally{C.loading=!1}}async function Kc(){var e,t,n;try{let s=await Je({method:"book_offers",params:[{taker_gets:{currency:"USD",issuer:"rhub8VRN55s94qWKDv6jmDy1pUykJzF3wq"},taker_pays:{currency:"XRP"},limit:1}]}),a=(e=s==null?void 0:s.offers)==null?void 0:e[0];if(!a)return;let o=Number(((t=a.TakerGets)==null?void 0:t.value)||0),i=typeof a.TakerPays=="string"?Number(a.TakerPays)/1e6:Number(((n=a.TakerPays)==null?void 0:n.value)||0);if(o>0&&i>0){let r=o/i;if(Cc=Date.now(),C.stats||(C.stats={}),C.stats.xrplSpot=r,String(Aa().symbol||"XRP").toUpperCase()==="XRP"){C.stats.price=r;let l=C.stats.baseSource||C.stats.source||"Market feed";C.stats.source=`${l} + XRPL live`,Te.data&&(Te.data.priceUsd=r)}}}catch{}}async function Bv(){var e,t;return(e=window.LightweightCharts)!=null&&e.createChart?!0:(xa||(xa=new Promise((n,s)=>{let a=document.querySelector('script[data-lw-chart="1"]');if(a){a.addEventListener("load",()=>n(!0),{once:!0}),a.addEventListener("error",()=>s(new Error("Chart library failed to load.")),{once:!0});return}let o=document.createElement("script");o.src="https://unpkg.com/lightweight-charts@4.2.2/dist/lightweight-charts.standalone.production.js",o.async=!0,o.defer=!0,o.dataset.lwChart="1",o.onload=()=>n(!0),o.onerror=()=>s(new Error("Chart library failed to load.")),document.head.appendChild(o)}).finally(()=>{var n;(n=window.LightweightCharts)!=null&&n.createChart||(xa=null)})),await xa,!!((t=window.LightweightCharts)!=null&&t.createChart))}async function Xv(){var e,t;return(e=window.THREE)!=null&&e.Scene?!0:(ka||(ka=new Promise((n,s)=>{let a=document.querySelector('script[data-three-chart="1"]');if(a){a.addEventListener("load",()=>n(!0),{once:!0}),a.addEventListener("error",()=>s(new Error("Three.js failed to load.")),{once:!0});return}let o=document.createElement("script");o.src="https://unpkg.com/three@0.166.1/build/three.min.js",o.async=!0,o.defer=!0,o.dataset.threeChart="1",o.onload=()=>n(!0),o.onerror=()=>s(new Error("Three.js failed to load.")),document.head.appendChild(o)}).finally(()=>{var n;(n=window.THREE)!=null&&n.Scene||(ka=null)})),await ka,!!((t=window.THREE)!=null&&t.Scene))}function Is(){var e,t;if(Oe.resizeHandler)try{window.removeEventListener("resize",Oe.resizeHandler)}catch{}if(Oe.raf&&cancelAnimationFrame(Oe.raf),(t=(e=Oe.renderer)==null?void 0:e.domElement)!=null&&t.parentElement)try{Oe.renderer.domElement.parentElement.removeChild(Oe.renderer.domElement)}catch{}if(Oe.renderer)try{Oe.renderer.dispose()}catch{}Oe={renderer:null,scene:null,camera:null,points:null,raf:0,host:null,resizeHandler:null}}async function Ov(){var t;let e=document.getElementById("xpd-chart-atmosphere");if(e&&!(Oe.renderer&&e.contains(Oe.renderer.domElement))&&!((navigator.hardwareConcurrency||4)<=3))try{if(await Xv(),!((t=window.THREE)!=null&&t.Scene))return;Is();let n=window.THREE,s=Math.max(1,e.clientWidth||640),a=Math.max(1,e.clientHeight||460),o=new n.Scene,i=new n.PerspectiveCamera(52,s/a,.1,1e3);i.position.z=46;let r=new n.WebGLRenderer({alpha:!0,antialias:!0});r.setPixelRatio(Math.min(2,window.devicePixelRatio||1)),r.setSize(s,a),e.appendChild(r.domElement);let l=900,c=new Float32Array(l*3);for(let w=0;w<l;w+=1){let k=w*3;c[k]=(Math.random()-.5)*90,c[k+1]=(Math.random()-.5)*40,c[k+2]=(Math.random()-.5)*24}let d=new n.BufferGeometry;d.setAttribute("position",new n.BufferAttribute(c,3));let u=new n.PointsMaterial({color:5101823,size:.25,transparent:!0,opacity:.26,depthWrite:!1}),p=new n.Points(d,u);o.add(p);let m=0,f=0,g=()=>{var S;m+=1;let w=Number(((S=C.stats)==null?void 0:S.changePct)||0),k=Math.min(4,Math.max(.35,Math.abs(w)/2.2)),v=w>0?16758874:16739999;u.color.setHex(Math.abs(w)>1.5?v:5101823),p.rotation.y+=9e-4*k,p.rotation.x=Math.sin(m*.0015*k)*.08,p.position.y=Math.sin(m*.003*k)*.7,(!document.hidden||Date.now()-f>350)&&(r.render(o,i),f=Date.now()),Oe.raf=requestAnimationFrame(g)},h=()=>{let w=Math.max(1,e.clientWidth||640),k=Math.max(1,e.clientHeight||460);i.aspect=w/k,i.updateProjectionMatrix(),r.setSize(w,k)};window.addEventListener("resize",h,{passive:!0}),Oe={renderer:r,scene:o,camera:i,points:p,raf:0,host:e,resizeHandler:h},g()}catch{}}function Jc(e){return fi(e)*60}function Yc(e){let t=fi(e);return t<=1?60:t<=5?300:t<=15?900:t<=60?3600:t<=360?21600:86400}function Qc(){let e=String(C.tokenFocusKey||"");if(!e)return null;let t=e.includes("|")?e.split("|")[0]:e;return j.tokens.find(n=>ht(n)===e)||j.tokens.find(n=>String(n.symbol||"").toUpperCase()===String(t||"").toUpperCase())||null}function Zc(){var a,o;let e=Qc(),t=Number((e==null?void 0:e.price)||0);if(Number.isFinite(t)&&t>0)return t;let n=Number(((a=C.stats)==null?void 0:a.xrplSpot)||0);if(Number.isFinite(n)&&n>0)return n;let s=Number(((o=C.stats)==null?void 0:o.price)||0);return Number.isFinite(s)&&s>0?s:1}function ed(e,t=1,n=220){let s=Math.max(60,Jc(e)),a=Math.floor(Date.now()/1e3),o=Math.floor(a/s)*s-n*s,i=Math.max(1e-6,Number(t)||1),r=[];for(let l=0;l<n;l+=1){let c=o+l*s,d=i,u=Math.sin((l+1)/9)*.004+Math.cos((l+3)/17)*.002;i=Math.max(1e-6,d*(1+u));let p=Math.max(d,i)*(1+Math.abs(u)*.55+.0015),m=Math.min(d,i)*Math.max(1e-6,1-(Math.abs(u)*.55+.0015));r.push({time:c,open:Number(d),high:Number(p),low:Number(m),close:Number(i),volume:Math.max(0,Math.round(Math.abs(u)*12e3+l%13*55))})}return r}function Zo(e){if(!e.length)return e;let t=[];for(let n=0;n<e.length;n+=1){let s=e[n],a=(s.open+s.high+s.low+s.close)/4,o=t[n-1],i=o?(o.open+o.close)/2:(s.open+s.close)/2,r=Math.max(s.high,i,a),l=Math.min(s.low,i,a);t.push({...s,open:i,high:r,low:l,close:a})}return t}function ei(e,t){let n=[],s=0;for(let a=0;a<e.length;a+=1)s+=e[a].close,a>=t&&(s-=e[a-t].close),a>=t-1&&n.push({time:e[a].time,value:s/t});return n}function _s(e,t){let n=[];if(!e.length)return n;let s=2/(t+1),a=e[0].close;for(let o=0;o<e.length;o+=1)a=o===0?e[o].close:e[o].close*s+a*(1-s),o>=t-1&&n.push({time:e[o].time,value:a});return n}function Hv(e,t){let n=[],s=t*(t+1)/2;for(let a=t-1;a<e.length;a+=1){let o=0;for(let i=0;i<t;i+=1)o+=e[a-i].close*(t-i);n.push({time:e[a].time,value:o/s})}return n}function zv(e,t=20,n=2){let s=ei(e,t),a=[],o=[];for(let i=t-1;i<e.length;i+=1){let r=e.slice(i-t+1,i+1),l=s[i-(t-1)].value,c=r.reduce((u,p)=>u+Math.pow(p.close-l,2),0)/t,d=Math.sqrt(c);a.push({time:e[i].time,value:l+d*n}),o.push({time:e[i].time,value:l-d*n})}return{upper:a,lower:o}}function Uv(e){let t=[],n=0,s=0;for(let a=0;a<e.length;a+=1){let o=(e[a].high+e[a].low+e[a].close)/3;n+=o*(e[a].volume||0),s+=e[a].volume||0,s>0&&t.push({time:e[a].time,value:n/s})}return t}function Wv(e,t=14){let n=[];if(e.length<=t)return n;let s=0,a=0;for(let r=1;r<=t;r+=1){let l=e[r].close-e[r-1].close;s+=l>0?l:0,a+=l<0?-l:0}let o=s/t,i=a/t;for(let r=t+1;r<e.length;r+=1){let l=e[r].close-e[r-1].close;o=(o*(t-1)+(l>0?l:0))/t,i=(i*(t-1)+(l<0?-l:0))/t;let c=i>0?o/i:100;n.push({time:e[r].time,value:100-100/(1+c)})}return n}function hi(e,t=14){let n=[];for(let o=0;o<e.length;o+=1){let i=o>0?e[o-1].close:e[o].close;n.push(Math.max(e[o].high-e[o].low,Math.abs(e[o].high-i),Math.abs(e[o].low-i)))}let s=[],a=n.slice(0,t).reduce((o,i)=>o+i,0)/Math.max(1,t);for(let o=t;o<e.length;o+=1)a=(a*(t-1)+n[o])/t,s.push({time:e[o].time,value:a});return s}function jv(e,t=14,n=3){let s=[];for(let o=t-1;o<e.length;o+=1){let i=e.slice(o-t+1,o+1),r=Math.max(...i.map(d=>d.high)),l=Math.min(...i.map(d=>d.low)),c=r!==l?(e[o].close-l)/(r-l)*100:50;s.push({time:e[o].time,value:c})}let a=[];for(let o=n-1;o<s.length;o+=1){let i=s.slice(o-n+1,o+1).reduce((r,l)=>r+l.value,0)/n;a.push({time:s[o].time,value:i})}return{k:s,d:a}}function qv(e,t=12,n=26,s=9){let a=_s(e,t),o=_s(e,n),i=new Map(o.map(u=>[u.time,u.value])),r=a.filter(u=>i.has(u.time)).map(u=>({time:u.time,value:u.value-i.get(u.time)})),l=[];if(r.length){let u=2/(s+1),p=r[0].value;for(let m=0;m<r.length;m+=1)p=m===0?r[m].value:r[m].value*u+p*(1-u),m>=s-1&&l.push({time:r[m].time,value:p})}let c=new Map(l.map(u=>[u.time,u.value])),d=r.filter(u=>c.has(u.time)).map(u=>({time:u.time,value:u.value-c.get(u.time)}));return{line:r,signal:l,hist:d}}function td(e,t=9,n=26,s=52){let a=u=>{let p=[];for(let m=u-1;m<e.length;m+=1){let f=e.slice(m-u+1,m+1);p.push({time:e[m].time,value:(Math.max(...f.map(g=>g.high))+Math.min(...f.map(g=>g.low)))/2})}return p},o=a(t),i=a(n),r=new Map(i.map(u=>[u.time,u.value])),l=o.filter(u=>r.has(u.time)).map(u=>({time:u.time,value:(u.value+r.get(u.time))/2})),c=a(s),d=e.map(u=>({time:u.time,value:u.close}));return{tenkan:o,kijun:i,senkouA:l,senkouB:c,chikou:d}}function Vv(e,t=20){let n=[],s=[],a=[];for(let o=t-1;o<e.length;o+=1){let i=e.slice(o-t+1,o+1),r=Math.max(...i.map(c=>c.high)),l=Math.min(...i.map(c=>c.low));n.push({time:e[o].time,value:r}),s.push({time:e[o].time,value:l}),a.push({time:e[o].time,value:(r+l)/2})}return{upper:n,lower:s,mid:a}}function Gv(e,t=20,n=2){let s=_s(e,t),a=hi(e,t),o=new Map(a.map(l=>[l.time,l.value])),i=[],r=[];return s.forEach(l=>{if(o.has(l.time)){let c=o.get(l.time)*n;i.push({time:l.time,value:l.value+c}),r.push({time:l.time,value:l.value-c})}}),{upper:i,lower:r,mid:s}}function Kv(e){let t=[],n=[],s=0,a=0;for(let o=0;o<e.length;o+=1){if(o>0){let l=e[o-1];e[o].close>l.close&&(s+=e[o].volume||0),e[o].close<l.close&&(s-=e[o].volume||0)}let i=e[o].high-e[o].low||1,r=(e[o].close-e[o].low-(e[o].high-e[o].close))/i;a+=r*(e[o].volume||0),t.push({time:e[o].time,value:s}),n.push({time:e[o].time,value:a})}return{obv:t,adline:n}}function Jv(e,t=14){if(e.length<t+2)return{adx:[],plusDi:[],minusDi:[]};let n=[],s=[],a=[];for(let p=1;p<e.length;p+=1){let m=e[p].high-e[p-1].high,f=e[p-1].low-e[p].low;s.push(m>f&&m>0?m:0),a.push(f>m&&f>0?f:0),n.push(Math.max(e[p].high-e[p].low,Math.abs(e[p].high-e[p-1].close),Math.abs(e[p].low-e[p-1].close)))}let o=n.slice(0,t).reduce((p,m)=>p+m,0),i=s.slice(0,t).reduce((p,m)=>p+m,0),r=a.slice(0,t).reduce((p,m)=>p+m,0),l=[],c=[],d=[];for(let p=t;p<n.length;p+=1){o=o-o/t+n[p],i=i-i/t+s[p],r=r-r/t+a[p];let m=o>0?100*i/o:0,f=o>0?100*r/o:0,g=m+f>0?100*Math.abs(m-f)/(m+f):0,h=e[p+1].time;l.push({time:h,value:m}),c.push({time:h,value:f}),d.push({time:h,value:g})}let u=[];if(d.length>=t){let p=d.slice(0,t).reduce((m,f)=>m+f.value,0)/t;for(let m=t;m<d.length;m+=1)p=(p*(t-1)+d[m].value)/t,u.push({time:d[m].time,value:p})}return{adx:u,plusDi:l,minusDi:c}}function Yv(e,t=14){let n=[],s=[];for(let a=t-1;a<e.length;a+=1){let o=e.slice(a-t+1,a+1),i=0,r=0;for(let d=1;d<o.length;d+=1)o[d].high>=o[i].high&&(i=d),o[d].low<=o[r].low&&(r=d);let l=t-1-i,c=t-1-r;n.push({time:e[a].time,value:(t-l)/t*100}),s.push({time:e[a].time,value:(t-c)/t*100})}return{up:n,down:s}}function Qv(e,t=14){let n=[],s=[];if(e.length<t+2)return{plus:n,minus:s};for(let a=t;a<e.length;a+=1){let o=0,i=0,r=0;for(let l=a-t+1;l<=a;l+=1){let c=e[l-1],d=e[l];o+=Math.max(d.high-d.low,Math.abs(d.high-c.close),Math.abs(d.low-c.close)),i+=Math.abs(d.high-c.low),r+=Math.abs(d.low-c.high)}n.push({time:e[a].time,value:o>0?i/o:0}),s.push({time:e[a].time,value:o>0?r/o:0})}return{plus:n,minus:s}}function Zv(e,t=10,n=3){let s=hi(e,t),a=new Map(s.map(c=>[c.time,c.value])),o=[],i=0,r=0,l=!0;return e.forEach((c,d)=>{if(d===0||!a.has(c.time))return;let u=(c.high+c.low)/2,p=a.get(c.time),m=u+n*p,f=u-n*p;d>1&&(m>i&&e[d-1].close<=i&&(m=i),f<r&&e[d-1].close>=r&&(f=r));let g=c.close>m?!0:c.close<f?!1:l,h=g?f:m;o.push({time:c.time,value:h,trendUp:g?1:0}),i=m,r=f,l=g}),o}function eb(e,t=14){let n=[];if(e.length<=t)return n;let s=e.map((a,o)=>{let i=(a.high+a.low+a.close)/3,r=o>0?(e[o-1].high+e[o-1].low+e[o-1].close)/3:i,l=i*(a.volume||0);return{time:a.time,pos:i>=r?l:0,neg:i<r?l:0}});for(let a=t;a<s.length;a+=1){let o=s.slice(a-t+1,a+1),i=o.reduce((c,d)=>c+d.pos,0),r=o.reduce((c,d)=>c+d.neg,0),l=r>0?i/r:100;n.push({time:s[a].time,value:100-100/(1+l)})}return n}function tb(e,t=14){let n=[];for(let s=t-1;s<e.length;s+=1){let a=e.slice(s-t+1,s+1),o=Math.max(...a.map(l=>l.high)),i=Math.min(...a.map(l=>l.low)),r=o!==i?(o-e[s].close)/(o-i)*-100:-50;n.push({time:e[s].time,value:r})}return n}function nb(e,t=20){let n=[],s=e.map(a=>({time:a.time,value:(a.high+a.low+a.close)/3}));for(let a=t-1;a<s.length;a+=1){let o=s.slice(a-t+1,a+1),i=o.reduce((c,d)=>c+d.value,0)/t,r=o.reduce((c,d)=>c+Math.abs(d.value-i),0)/t,l=r>0?(s[a].value-i)/(.015*r):0;n.push({time:s[a].time,value:l})}return n}function sb(e){if(e.length<30)return[];let t=[],n=[];for(let o=1;o<e.length;o+=1){let i=e[o-1].close,r=Math.min(e[o].low,i),l=Math.max(e[o].high,i);t.push({time:e[o].time,value:e[o].close-r}),n.push({time:e[o].time,value:l-r})}let s=(o,i,r)=>o.slice(i-r+1,i+1).reduce((l,c)=>l+c.value,0),a=[];for(let o=27;o<t.length;o+=1){let i=s(t,o,7)/Math.max(1e-9,s(n,o,7)),r=s(t,o,14)/Math.max(1e-9,s(n,o,14)),l=s(t,o,28)/Math.max(1e-9,s(n,o,28));a.push({time:t[o].time,value:100*(4*i+2*r+l)/7})}return a}function ab(e,t=20){let n=[],s=e.map(a=>{let o=a.high-a.low||1,i=(a.close-a.low-(a.high-a.close))/o;return{time:a.time,value:i*(a.volume||0),volume:a.volume||0}});for(let a=t-1;a<s.length;a+=1){let o=s.slice(a-t+1,a+1),i=o.reduce((l,c)=>l+c.value,0),r=o.reduce((l,c)=>l+c.volume,0);n.push({time:s[a].time,value:r>0?i/r:0})}return n}function ob(e){return(Array.isArray(e)?e:[]).map(t=>({time:Number(t[0]),low:Number(t[1]),high:Number(t[2]),open:Number(t[3]),close:Number(t[4]),volume:Number(t[5])})).filter(t=>Number.isFinite(t.time)&&[t.open,t.high,t.low,t.close].every(Number.isFinite))}function ti(e,t){let n=new Map;for(let s of e)n.set(s.time,s);for(let s of t)n.set(s.time,s);return Array.from(n.values()).sort((s,a)=>s.time-a.time)}async function ni(e,t,n){let s=[],a=Math.floor(Date.now()/1e3),o=!1;for(let i=0;i<n;i+=1){let r=a-t*300,l=`https://api.exchange.coinbase.com/products/${e}/candles?granularity=${t}&start=${new Date(r*1e3).toISOString()}&end=${new Date(a*1e3).toISOString()}`,c;try{c=await kt(l,{timeoutMs:1e4})}catch{break}let d=ob(c);if(!d.length){o=!0;break}s.push(...d),a=r,i<n-1&&await sv(nv)}return{candles:ti(s,[]),reachedStart:o}}async function ib(e,t,n){if(!e||!Number.isFinite(t)||!Number.isFinite(n)||n<=t)return[];try{let s=`https://api.coingecko.com/api/v3/coins/${e}/market_chart/range?vs_currency=usd&from=${t}&to=${n}`,a=await kt(s,{timeoutMs:15e3});return(Array.isArray(a==null?void 0:a.prices)?a.prices:[]).map(([i,r])=>({time:Math.floor(Number(i)/1e3/86400)*86400,open:Number(r),high:Number(r),low:Number(r),close:Number(r),volume:0})).filter(i=>Number.isFinite(i.time)&&Number.isFinite(i.close)&&i.close>0).sort((i,r)=>i.time-r.time)}catch{return[]}}async function rb(e,t,n){var u;let s=Yc(n),a=s===86400,o=`${tv}${e.id}:${s}`,i=ve(Z(o));if((u=i==null?void 0:i.candles)!=null&&u.length&&i.reachedStart){let p=await ni(t,s,1),m=ti(i.candles,p.candles);return te(o,JSON.stringify({candles:m,reachedStart:!0,source:i.source,cachedAt:Date.now()})),{candles:m,source:i.source}}let l=await ni(t,s,a?Mc:Lc),c=l.candles,d=c.length?`Coinbase (${new Date(c[0].time*1e3).getUTCFullYear()}\u2013present, ${c.length} bars)`:"Coinbase";if(a&&l.reachedStart&&e.coingeckoId&&c.length){let p=c[0].time,m=await ib(e.coingeckoId,0,p);m.length&&(c=ti(m,c),d=`CoinGecko (${new Date(c[0].time*1e3).getUTCFullYear()}+) + Coinbase (${new Date(p*1e3).getUTCFullYear()}\u2013present)`)}else!a&&!l.reachedStart&&(d=`Coinbase (last ${c.length} bars \u2014 full inception history is daily/weekly/monthly only)`);return c.length&&te(o,JSON.stringify({candles:c,reachedStart:l.reachedStart,source:d,cachedAt:Date.now()})),{candles:c,source:d}}var Vo=new Map;async function nd(e,t){let n=`${e.id}:${t}`,s=Ps.get(n);if(s&&Date.now()-s.ts<6e4&&Array.isArray(s.data)&&s.data.length)return s.data;let a=Vo.get(n);if(a)return a;let o=(async()=>{let i=[],r="",l=Gc(e.ticker);if(l)try{let c=await rb(e,l,t);i=c.candles,r=c.source}catch{i=[]}if(!Array.isArray(i)||!i.length){let c=ed(t,Zc());return Ps.set(n,{ts:Date.now(),data:c,sourceLabel:""}),c}return Ps.set(n,{ts:Date.now(),data:i,sourceLabel:r}),i})();Vo.set(n,o);try{return await o}finally{Vo.delete(n)}}async function lb(){var u,p,m,f,g,h,w,k;let e=Aa(),t=await nd(e,C.interval),s=((u=Ps.get(`${e.id}:${C.interval}`))==null?void 0:u.sourceLabel)||String(((p=C.stats)==null?void 0:p.source)||"Coinbase + XRPL live"),a="pair",o=Qc(),i=String((o==null?void 0:o.symbol)||"").toUpperCase(),r=o?ht(o):`${e.symbol||"XRP"}|`;if(o&&i&&i!=="XRP"){let v=await Dv(o,C.interval);(m=v==null?void 0:v.candles)!=null&&m.length&&(t=v.candles,s=v.source,a=v.mode)}let l=String(e.symbol||"XRP").toUpperCase()==="XRP",c=Number((l?(f=C.stats)==null?void 0:f.xrplSpot:null)??((g=C.stats)==null?void 0:g.price)??0);if(a==="pair"&&Number.isFinite(c)&&c>0&&t.length){let v=Math.max(60,Jc(C.interval)),x=Math.floor(Date.now()/1e3),S=Math.floor(x/v)*v,T=t[t.length-1];T.time===S?(T.high=Math.max(T.high,c),T.low=Math.min(T.low,c),T.close=c):T.time<S&&t.push({time:S,open:T.close,high:Math.max(T.close,c),low:Math.min(T.close,c),close:c,volume:0})}let d=Number((o==null?void 0:o.price)||0);if(a==="pair"&&o&&i&&i!=="XRP"&&Number.isFinite(d)&&d>0&&t.length){let v=Number((l?(h=C.stats)==null?void 0:h.xrplSpot:null)??((w=C.stats)==null?void 0:w.price)??((k=t[t.length-1])==null?void 0:k.close)??0);if(Number.isFinite(v)&&v>0){let x=d/v;Number.isFinite(x)&&x>0&&(t=t.map(S=>({...S,open:S.open*x,high:S.high*x,low:S.low*x,close:S.close*x})),s="Coinbase pair + token spot proxy",a="token-proxy")}}return t.length||(t=ed(C.interval,Zc()),s=o&&i!=="XRP"?"Synthetic fallback (token-focused)":"Synthetic fallback",a="fallback"),o&&i!=="XRP"&&(a==="pair"||a==="fallback")?jo!==r&&(jo=r,be(`No market data found for ${o.symbol} yet \u2014 showing ${e.symbol||"XRP"} for reference.`)):r&&(jo=""),C.chartType==="heikin_ashi"&&(t=Zo(t)),Fv(t,{mode:a,source:s,tokenKey:r||"XRP|"}),t}function mc(e){if(!Array.isArray(e))return[];let t=e.map(s=>({time:Number(s.time),open:Number(s.open),high:Number(s.high),low:Number(s.low),close:Number(s.close),volume:Number(s.volume||0)})).filter(s=>Number.isFinite(s.time)&&Number.isFinite(s.open)&&Number.isFinite(s.high)&&Number.isFinite(s.low)&&Number.isFinite(s.close)&&s.time>0).sort((s,a)=>s.time-a.time),n=[];for(let s=0;s<t.length;s+=1){let a=t[s],o=n[n.length-1];o&&o.time===a.time?n[n.length-1]=a:n.push(a)}return n}function cb(e,t,n){var i;let s=Number(((i=e==null?void 0:e[e.length-1])==null?void 0:i.close)||0);if(!Number.isFinite(s)||s<=0)return 6;let o=Math.max(1e-12,Math.abs(Number(n)-Number(t)))/Math.max(1e-12,Math.abs(s));return s>=1e3?o<.01?4:2:s>=1?o<.01?6:4:s>=.01?o<.03?8:6:8}function db(){if(ee.resizeObserver)try{ee.resizeObserver.disconnect()}catch{}ee.chart&&(ee.chart.remove(),ee={chart:null,volumeSeries:null,activeSeries:null,compareSeries:null,indicatorSeries:[],indicatorPriceLines:[],priceLines:[],resizeObserver:null,chartType:"",configKey:"",legendEl:null,renderLegend:null,ichimokuData:null,indicatorLegendItems:[],alertPriceLines:[]})}function fc(e,t){var d;let{addOverlay:n,addOsc:s,addOscHist:a,addPriceLevel:o}=t,i=(u,p)=>{var f,g;let m=Number((g=(f=C.indicatorSettings)==null?void 0:f[u])==null?void 0:g.length);return Number.isFinite(m)&&m>1?Math.min(500,Math.max(2,m)):p},r=(u,p,m)=>{var h,w;let f=(w=(h=C.indicatorSettings)==null?void 0:h[u])==null?void 0:w[p];if(f==null||f==="")return m;let g=(di[u]||[]).find(k=>k.id===p);if((g==null?void 0:g.type)==="number"){let k=Number(f);return Number.isFinite(k)&&k>1?Math.min(500,Math.max(2,k)):m}return f},l=C.indicators;if(l.sma20&&n(ei(e,i("sma20",20)),r("sma20","color","#f1c40f"),1.2,!1,"SMA"),l.ema20&&n(_s(e,i("ema20",20)),r("ema20","color","#ffb86c"),1.2,!1,"EMA"),l.wma20&&n(Hv(e,i("wma20",20)),r("wma20","color","#bd93f9"),1.2,!1,"WMA"),l.vwap&&n(Uv(e),r("vwap","color","#80ffea"),1.2,!1,"VWAP"),l.bb20){let u=r("bb20","color","#ff79c6"),p=zv(e,i("bb20",20),2);n(p.upper,u,1,!0,"BB Upper"),n(p.lower,u,1,!0,"BB Lower")}if(l.ichimoku){let u=td(e,r("ichimoku","tenkanLen",9),r("ichimoku","kijunLen",26),r("ichimoku","senkouBLen",52));n(u.tenkan,r("ichimoku","tenkanColor","#ffde59"),1.2,!1,"Tenkan"),n(u.kijun,r("ichimoku","kijunColor","#6ecbff"),1.2,!1,"Kijun"),n(u.senkouA,"rgba(70,255,160,0.8)",1,!0,"Senkou A"),n(u.senkouB,"rgba(255,120,120,0.8)",1,!0,"Senkou B"),n(u.chikou,"rgba(220,220,255,0.6)",.9,!0,"Chikou")}if(l.donchian){let u=r("donchian","color","#9cfb8c"),p=Vv(e,i("donchian",20));n(p.upper,u,1,!0,"Donchian Upper"),n(p.lower,u,1,!0,"Donchian Lower"),n(p.mid,"rgba(156,251,140,0.6)",1.2,!1,"Donchian Mid")}if(l.keltner){let u=r("keltner","color","#7ee7ff"),p=Gv(e,i("keltner",20),2);n(p.upper,u,1,!0,"Keltner Upper"),n(p.lower,u,1,!0,"Keltner Lower"),n(p.mid,"rgba(126,231,255,0.66)",1.2,!1,"Keltner Mid")}if(l.pivots&&e.length>=2){let u=e[e.length-2],p=(u.high+u.low+u.close)/3,m=2*p-u.low,f=2*p-u.high,g=p+(u.high-u.low),h=p-(u.high-u.low);o(p,"#f6f6f6","P"),o(m,"#61ffb0","R1"),o(f,"#ff8f8f","S1"),o(g,"rgba(97,255,176,0.6)","R2"),o(h,"rgba(255,143,143,0.6)","S2")}if(l.supertrend||l.sar||l.elderRay){let u=_s(e,14);if(l.supertrend&&n(Zv(e,10,3),r("supertrend","color","#8bffde"),1.3,!1,"Supertrend"),l.sar&&n(u.map(p=>({time:p.time,value:p.value*.998})),r("sar","color","#ffaf7a"),1,!0,"SAR"),l.elderRay){let p=new Map(u.map(g=>[g.time,g.value])),m=e.filter(g=>p.has(g.time)).map(g=>({time:g.time,value:g.high-p.get(g.time)})),f=e.filter(g=>p.has(g.time)).map(g=>({time:g.time,value:g.low-p.get(g.time)}));s(m,r("elderRay","bullColor","#5fff9d"),"Elder Bull"),s(f,r("elderRay","bearColor","#ff9d9d"),"Elder Bear")}}if(l.rsi&&s(Wv(e,i("rsi",14)),r("rsi","color","#a6ff4d"),"RSI"),l.atr&&s(hi(e,i("atr",14)),r("atr","color","#ffb86c"),"ATR"),l.stdev){let u=ei(e,20),p=new Map(u.map(f=>[f.time,f.value])),m=e.filter(f=>p.has(f.time)).map(f=>({time:f.time,value:Math.abs(f.close-p.get(f.time))}));s(m,r("stdev","color","#b2a3ff"),"StdDev")}if(l.stoch){let u=jv(e,i("stoch",14),3);s(u.k,r("stoch","kColor","#9ee8ff"),"%K"),s(u.d,r("stoch","dColor","#ffd86b"),"%D")}if(l.macd){let u=qv(e,r("macd","fastLen",12),r("macd","slowLen",26),r("macd","signalLen",9));s(u.line,r("macd","lineColor","#8fd9ff"),"MACD"),s(u.signal,r("macd","signalColor","#ffcf8e"),"Signal"),(d=u.hist)!=null&&d.length&&a(u.hist)}let c=Kv(e);if(l.obv&&s(c.obv,r("obv","color","#8cf9ff"),"OBV"),l.adline&&s(c.adline,r("adline","color","#ffb7ff"),"A/D"),l.cmf&&s(ab(e,i("cmf",20)),r("cmf","color","#f8ff87"),"CMF"),l.williamsr&&s(tb(e,i("williamsr",14)),r("williamsr","color","#ff9adf"),"Williams %R"),l.cci&&s(nb(e,i("cci",20)),r("cci","color","#b8ff8e"),"CCI"),l.mfi&&s(eb(e,i("mfi",14)),r("mfi","color","#7bffd2"),"MFI"),l.uo&&s(sb(e),r("uo","color","#ffd36f"),"UO"),l.adx){let u=Jv(e,i("adx",14));s(u.adx,r("adx","adxColor","#9fd8ff"),"ADX"),s(u.plusDi,r("adx","plusColor","#73ffc0"),"+DI"),s(u.minusDi,r("adx","minusColor","#ff9797"),"-DI")}if(l.aroon){let u=Yv(e,i("aroon",14));s(u.up,r("aroon","upColor","#6cffb0"),"Aroon Up"),s(u.down,r("aroon","downColor","#ff8f8f"),"Aroon Down")}if(l.vortex){let u=Qv(e,i("vortex",14));s(u.plus.map(p=>({time:p.time,value:p.value*100})),r("vortex","plusColor","#d6a8ff"),"VI+"),s(u.minus.map(p=>({time:p.time,value:p.value*100})),r("vortex","minusColor","#ffb0f3"),"VI-")}}function pb(e){let t=e.querySelector(":scope > svg.xpd-ichimoku-cloud-svg");return t||(t=document.createElementNS("http://www.w3.org/2000/svg","svg"),t.setAttribute("class","xpd-ichimoku-cloud-svg"),e.appendChild(t)),t}function ub(e){var t;(t=e==null?void 0:e.querySelector(":scope > svg.xpd-ichimoku-cloud-svg"))==null||t.remove()}function sd(e,t,n,s,a){var h;if(!e||!t||!n)return;let o=n.clientWidth||0,i=n.clientHeight||0;if(!o||!i||!(s!=null&&s.length)||!(a!=null&&a.length))return;let r=pb(n);r.setAttribute("width",o),r.setAttribute("height",i),r.setAttribute("viewBox",`0 0 ${o} ${i}`);let l=((h=C.indicatorSettings)==null?void 0:h.ichimoku)||{},c=l.bullColor||"#46ffa0",d=l.bearColor||"#ff7878",u=new Map(a.map(w=>[w.time,w.value])),p=e.timeScale(),m=[];for(let w of s){let k=u.get(w.time);if(k==null)continue;let v=p.timeToCoordinate(w.time),x=t.priceToCoordinate(w.value),S=t.priceToCoordinate(k);v==null||x==null||S==null||m.push({x:v,ya:x,yb:S,bullish:w.value>=k})}let f="",g=0;for(let w=1;w<=m.length;w+=1){if(!(w===m.length||m[w].bullish!==m[g].bullish))continue;let v=m.slice(g,w);if(v.length>=2){let x=v.map($=>`${$.x.toFixed(1)},${$.ya.toFixed(1)}`).join(" "),S=v.slice().reverse().map($=>`${$.x.toFixed(1)},${$.yb.toFixed(1)}`).join(" "),T=v[0].bullish?c:d;f+=`<polygon points="${x} ${S}" fill="${b(T)}" opacity="0.22" />`}g=w}r.innerHTML=f}function hc(e,t,n,s){var i;if(!C.indicators.ichimoku){ub(s),ee.ichimokuData=null;return}let a=((i=C.indicatorSettings)==null?void 0:i.ichimoku)||{},o=td(e,Number(a.tenkanLen)||9,Number(a.kijunLen)||26,Number(a.senkouBLen)||52);ee.ichimokuData={senkouA:o.senkouA,senkouB:o.senkouB},sd(t,n,s,o.senkouA,o.senkouB)}function si(){let e=ee.ichimokuData,t=document.getElementById("xpd-tv-widget");e&&ee.chart&&ee.activeSeries&&t&&sd(ee.chart,ee.activeSeries,t,e.senkouA,e.senkouB)}async function mb(){var n,s,a,o;let e=++kn,t=document.getElementById("xpd-tv-widget");if(t){ee.chart||(t.innerHTML='<div class="xpd-loading">Loading full price history\u2026</div>');try{C.threeEnabled?Ov():Is();let i=await lb(),r=mc(i);if(e!==kn)return;if(!r.length)throw new Error("No chart bars returned for selected pair/timeframe.");hb(r);let l=JSON.stringify({pair:C.pair,interval:C.interval,chartType:C.chartType,comparePair:C.comparePair,indicators:C.indicators,indicatorSettings:C.indicatorSettings,threeEnabled:C.threeEnabled});if(!C.comparePair&&!(C.drawings||[]).length&&ee.chart&&ee.configKey===l){let B=C.chartType==="heikin_ashi"?Zo(r):r;C.chartType==="line"||C.chartType==="area"?ee.activeSeries.setData(B.map(ue=>({time:ue.time,value:ue.close}))):ee.activeSeries.setData(B),ee.volumeSeries.setData(r.map(ue=>({time:ue.time,value:ue.volume||0,color:ue.close>=ue.open?"rgba(38,166,154,0.5)":"rgba(239,83,80,0.5)"})));let J=0,re=0,pe=[];fc(r,{addOverlay:(ue,z,Y,me,Re)=>{let Fe=ee.indicatorSeries[J++];ue!=null&&ue.length&&(Fe==null||Fe.setData(ue),Re&&Fe&&pe.push({label:Re,color:z,series:Fe,points:ue}))},addOsc:(ue,z,Y)=>{let me=ee.indicatorSeries[J++];ue!=null&&ue.length&&(me==null||me.setData(ue),Y&&me&&pe.push({label:Y,color:z,series:me,points:ue}))},addOscHist:ue=>{let z=ee.indicatorSeries[J++];ue!=null&&ue.length&&(z==null||z.setData(ue.map(Y=>({time:Y.time,value:Y.value,color:Y.value>=0?"rgba(99,255,157,0.45)":"rgba(255,126,126,0.45)"}))))},addPriceLevel:ue=>{let z=ee.indicatorPriceLines[re++];Number.isFinite(ue)&&(z==null||z.applyOptions({price:ue}))}}),ee.indicatorLegendItems=pe,hc(r,ee.chart,ee.activeSeries,t),gc(ee.activeSeries);let Ce=r[r.length-1];(n=ee.renderLegend)==null||n.call(ee,Ce.open,Ce.high,Ce.low,Ce.close,Ce.volume);return}if(!await Bv())throw new Error("Chart library failed to load.");if(e!==kn)return;let d=document.getElementById("xpd-tv-widget");if(!d||e!==kn)return;let u=null;try{u=((s=ee.chart)==null?void 0:s.timeScale().getVisibleLogicalRange())||null}catch{}db(),d.innerHTML="";let p=window.LightweightCharts,m=Math.max(320,d.clientWidth||((a=d.parentElement)==null?void 0:a.clientWidth)||320),f=Math.max(360,d.clientHeight||460),g=r.map(B=>B.low),h=r.map(B=>B.high),w=cb(r,Math.min(...g),Math.max(...h)),k={type:"price",precision:w,minMove:Math.pow(10,-w)},v="#26a69a",x="#ef5350",S=p.createChart(d,{width:m,height:f,layout:{background:{type:p.ColorType.Solid,color:"#131722"},textColor:"#d1d4dc"},grid:{vertLines:{color:"#242832"},horzLines:{color:"#242832"}},rightPriceScale:{borderColor:"rgba(197,203,206,0.3)"},leftPriceScale:{visible:!1,borderColor:"rgba(197,203,206,0.3)"},timeScale:{borderColor:"rgba(197,203,206,0.3)",timeVisible:!0,secondsVisible:!1},crosshair:{mode:p.CrosshairMode.Normal},handleScroll:!0,handleScale:!0}),T=C.chartType==="heikin_ashi"?Zo(r):r,$;if(C.chartType==="line")$=S.addLineSeries({color:"#2962ff",lineWidth:2,priceFormat:k}),$.setData(T.map(B=>({time:B.time,value:B.close})));else if(C.chartType==="area")$=S.addAreaSeries({lineColor:"#2962ff",topColor:"rgba(41,98,255,0.36)",bottomColor:"rgba(41,98,255,0.04)",lineWidth:2,priceFormat:k}),$.setData(T.map(B=>({time:B.time,value:B.close})));else if(C.chartType==="bars")$=S.addBarSeries({upColor:v,downColor:x,priceFormat:k}),$.setData(T);else{let B=C.chartType==="hollow_candles";$=S.addCandlestickSeries({upColor:B?"rgba(0,0,0,0)":v,downColor:x,borderUpColor:v,borderDownColor:x,wickUpColor:v,wickDownColor:x,borderVisible:!0,priceFormat:k}),$.setData(T)}let P=S.addHistogramSeries({priceFormat:{type:"volume"},priceScaleId:"vol"});S.priceScale("vol").applyOptions({scaleMargins:{top:.85,bottom:0}}),P.setData(r.map(B=>({time:B.time,value:B.volume||0,color:B.close>=B.open?"rgba(38,166,154,0.5)":"rgba(239,83,80,0.5)"})));let M=document.createElement("div");M.className="xpd-chart-legend",d.appendChild(M);let N=B=>Number.isFinite(B)?B.toFixed(w):"\u2014",_=(B,J,re,pe,Se,ge)=>{let ot=pe>=B,it=(ge||[]).map(Ce=>`<span style="color:${b(Ce.color)}">${b(Ce.label)} <b>${N(Ce.value)}</b></span>`).join("");M.innerHTML=`
        <span>O <b>${N(B)}</b></span>
        <span>H <b>${N(J)}</b></span>
        ...
        ${it}
      `},O=T[T.length-1],D=(o=r[r.length-1])==null?void 0:o.volume,R=()=>{if(!O)return;let B=O.open??O.value,J=O.high??O.value,re=O.low??O.value,pe=O.close??O.value,Se=(ee.indicatorLegendItems||[]).map(ge=>{var ot,it;return{label:ge.label,color:ge.color,value:(it=(ot=ge.points)==null?void 0:ot[ge.points.length-1])==null?void 0:it.value}}).filter(ge=>Number.isFinite(ge.value));_(B,J,re,pe,D,Se)};R(),S.subscribeCrosshairMove(B=>{var Ce,ue;if(!B.time){R();return}let J=(Ce=B.seriesData)==null?void 0:Ce.get($);if(!J){R();return}let re=(ue=B.seriesData)==null?void 0:ue.get(P),pe=J.open??J.value,Se=J.high??J.value,ge=J.low??J.value,ot=J.close??J.value,it=(ee.indicatorLegendItems||[]).map(z=>{var Y,me;return{label:z.label,color:z.color,value:(me=(Y=B.seriesData)==null?void 0:Y.get(z.series))==null?void 0:me.value}}).filter(z=>Number.isFinite(z.value));_(pe,Se,ge,ot,re==null?void 0:re.value,it)});let F=!1,H=()=>{F||(F=!0,S.priceScale("osc").applyOptions({scaleMargins:{top:.65,bottom:.18}}))},A=[],U=[],Q=[];fc(r,{addOverlay:(B,J,re=1.2,pe=!1,Se="")=>{if(!(B!=null&&B.length))return;let ge=S.addLineSeries({color:J,lineWidth:re,lineStyle:pe?p.LineStyle.Dashed:p.LineStyle.Solid,priceLineVisible:!1,lastValueVisible:!1});ge.setData(B),A.push(ge),Se&&Q.push({label:Se,color:J,series:ge,points:B})},addOsc:(B,J,re="")=>{if(!(B!=null&&B.length))return;H();let pe=S.addLineSeries({color:J,lineWidth:1.2,priceScaleId:"osc",title:re,priceLineVisible:!1,lastValueVisible:!1});pe.setData(B),A.push(pe),re&&Q.push({label:re,color:J,series:pe,points:B})},addOscHist:B=>{if(!(B!=null&&B.length))return;H();let J=S.addHistogramSeries({priceScaleId:"osc",priceLineVisible:!1,lastValueVisible:!1});J.setData(B.map(re=>({time:re.time,value:re.value,color:re.value>=0?"rgba(99,255,157,0.45)":"rgba(255,126,126,0.45)"}))),A.push(J)},addPriceLevel:(B,J,re="")=>{Number.isFinite(B)&&U.push($.createPriceLine({price:B,color:J,lineWidth:1,lineStyle:p.LineStyle.Dashed,axisLabelVisible:!0,title:re}))}}),hc(r,S,$,d),S.timeScale().subscribeVisibleLogicalRangeChange(si);let fe=null;if(C.comparePair){let B=Cn.find(J=>J.id===C.comparePair);if(B){let J=mc(await nd(B,C.interval));if(e===kn&&J.length){let re=J[0].close||1;fe=S.addLineSeries({color:"#ffd166",lineWidth:1.4,priceScaleId:"left",priceLineVisible:!1,lastValueVisible:!0,priceFormat:{type:"custom",formatter:pe=>`${pe>=0?"+":""}${pe.toFixed(2)}%`,minMove:.01}}),S.priceScale("left").applyOptions({visible:!0,borderColor:"rgba(255,209,102,0.35)"}),fe.setData(J.map(pe=>({time:pe.time,value:(pe.close/re-1)*100})))}}}else S.priceScale("left").applyOptions({visible:!1});if(e!==kn){try{S.remove()}catch{}return}let K=(C.drawings||[]).filter(B=>Number.isFinite(B==null?void 0:B.price)).map(B=>$.createPriceLine({price:B.price,color:"#78e5ff",lineWidth:2,lineStyle:p.LineStyle.Dashed,axisLabelVisible:!0,title:"Line"}));if(S.subscribeClick(B=>{if(C.drawingTool!=="hline"||!B.point)return;let J=$.coordinateToPrice(B.point.y);Number.isFinite(J)&&(C.drawings=[...C.drawings||[],{price:J}].slice(-50),K.push($.createPriceLine({price:J,color:"#78e5ff",lineWidth:2,lineStyle:p.LineStyle.Dashed,axisLabelVisible:!0,title:"Line"})))}),u&&Number.isFinite(u.from)&&Number.isFinite(u.to))try{S.timeScale().setVisibleLogicalRange(u)}catch{S.timeScale().fitContent()}else S.timeScale().fitContent();let xe=new ResizeObserver(()=>{S.applyOptions({width:Math.max(320,d.clientWidth||320)}),si()});xe.observe(d),ee={chart:S,volumeSeries:P,activeSeries:$,compareSeries:fe,indicatorSeries:A,indicatorPriceLines:U,priceLines:K,resizeObserver:xe,chartType:C.chartType,configKey:l,legendEl:M,renderLegend:_,indicatorLegendItems:Q,alertPriceLines:[]},gc($)}catch(i){if(e!==kn)return;if(C.error=(i==null?void 0:i.message)||"Could not initialize chart widget.",ee.chart){be(C.error);return}let r=document.getElementById("xpd-tv-widget");r&&(r.innerHTML=`<div class="xpd-error">${b(C.error)}</div>`)}}}function ad(){let e=Z(Ko)==="1"?"0":"1";te(Ko,e),q()}async function od(e){Cn.some(t=>t.id===e)&&(C.pair=e,await Ds(),$t(),q())}async function id(e){C.interval=e,await Ds(),$t(),q()}function rd(e){C.chartType=e,$t(),q()}async function ld(){await Ds(),q()}function cd(e,t){e in C.indicators&&(C.indicators[e]=!!t,t&&(C.selectedIndicator=e,C.selectedEducationTab="indicator"),$t(),q())}function dd(){C.indicatorMenuOpen=!C.indicatorMenuOpen,q()}function pd(){C.moreMenuOpen=!C.moreMenuOpen,q()}function ud(e){C.indicatorQuery=String(e||""),C.indicatorMenuOpen||(C.indicatorMenuOpen=!0),q()}function md(e){let t=String(e||"").trim();t in C.indicators&&(C.indicators[t]=!0,C.selectedIndicator=t,C.selectedEducationTab="indicator",$t(),q())}function fd(e){let t=String(e||"").trim();t in C.indicators&&(C.indicators[t]=!1,$t(),q())}function fb(e){var s,a;if(C.settingsOpenFor!==e)return"";let t=C.indicatorSettings[e]||{},n=di[e]||[];return`
    ...
    </div>`}function hd(e){let t=String(e||"").trim();t in C.indicators&&(C.settingsOpenFor=C.settingsOpenFor===t?null:t,q())}function gd(){C.settingsOpenFor=null,q()}function vd(e){let t=String(e||"").trim();if(!(t in C.indicators))return;let n=C.indicatorSettings[t]||{},s={...n};for(let a of di[t]||[]){let o=document.getElementById(`xpd-ind-${a.id}-${t}`);o&&(a.type==="number"?s[a.id]=Math.max(2,Math.min(500,Number(o.value)||n[a.id]||a.default)):s[a.id]=o.value)}C.indicatorSettings[t]=s,C.settingsOpenFor=null,q()}function bd(e){let t=String(e||"").trim();delete C.indicatorSettings[t],C.settingsOpenFor=null,q()}function yd(){$t(),$i(window.location.href),se("Chart link copied.")}function wd(){C.threeEnabled=!C.threeEnabled,te(ci,C.threeEnabled?"1":"0"),C.threeEnabled||Is(),q()}function xd(e){let t=!!e;C.threeEnabled!==t&&(C.threeEnabled=t,te(ci,C.threeEnabled?"1":"0"),C.threeEnabled||Is(),q())}function kd(e){C.comparePair=e||"",$t(),q()}function $d(e){let t=String(e||"").trim();!t||!(t in C.indicators)||(C.indicators[t]=!0,C.selectedIndicator=t,q())}function Sd(e){let t=String(e||"none");_c.some(n=>n.key===t)&&(C.drawingTool=t,C.educationHint=rv[t]||"",q())}function Na(){var e;return((e=C.chartMeta)==null?void 0:e.tokenKey)||C.tokenFocusKey||`${Aa().symbol||"XRP"}|`}function Td(){var s,a;let e=Number((s=C.chartMeta)==null?void 0:s.last),t=prompt(`Alert me when ${((a=C.chartMeta)==null?void 0:a.symbol)||"price"} crosses:`,Number.isFinite(e)?e.toFixed(6):"");if(t==null)return;let n=Number(t);if(!Number.isFinite(n)||n<=0){be("Enter a valid price.");return}C.alerts=[...C.alerts||[],{id:`alert_${Date.now()}`,tokenKey:Na(),price:n,createdAt:new Date().toISOString()}],ui(),q(),se(`Alert set at $${I(n,6)}`)}function Cd(e){C.alerts=(C.alerts||[]).filter(t=>t.id!==e),ui(),q()}function gc(e){if(!e)return;let t=window.LightweightCharts;for(let s of ee.alertPriceLines||[])try{e.removePriceLine(s)}catch{}let n=(C.alerts||[]).filter(s=>s.tokenKey===Na());ee.alertPriceLines=n.map(s=>{var a;return e.createPriceLine({price:s.price,color:"#ffb703",lineWidth:2,lineStyle:((a=t==null?void 0:t.LineStyle)==null?void 0:a.Dotted)??2,axisLabelVisible:!0,title:"\u{1F514} Alert"})})}function hb(e){var r,l;if(e.length<2)return;let t=Na(),n=(C.alerts||[]).filter(c=>c.tokenKey===t);if(!n.length)return;let s=e[e.length-2].close,a=e[e.length-1].close,o=[],i=!1;for(let c of n){let d=s<c.price&&a>=c.price,u=s>c.price&&a<=c.price;d||u?(se(`\u{1F514} ${((r=C.chartMeta)==null?void 0:r.symbol)||"Price"} crossed $${I(c.price,6)} (${d?"\u2191":"\u2193"} now $${I(a,6)})`),i=!0,(l=document.querySelector(`.xpd-indicator-chip[data-alert-id="${c.id}"]`))==null||l.remove()):o.push(c)}i&&(C.alerts=[...(C.alerts||[]).filter(c=>c.tokenKey!==t),...o],ui())}function Md(){let e=ee.activeSeries;if(e)for(let t of ee.priceLines||[])try{e.removePriceLine(t)}catch{}ee.priceLines=[],C.drawings=[]}function _a(e,t=0){var i;let n=(i=ee.chart)==null?void 0:i.timeScale();if(!n)return;let s=n.getVisibleLogicalRange();if(!s)return;let a=(s.to-s.from)*e,o=(s.to+s.from)/2+(s.to-s.from)*t;n.setVisibleLogicalRange({from:o-a/2,to:o+a/2})}function Ld(){_a(.8)}function Pd(){_a(1.25)}function Ed(){_a(1,-.2)}function Ad(){_a(1,.2)}function Nd(){C.educationCollapsed=!C.educationCollapsed,q()}function _d(e){["indicator","psychology","practice"].includes(e)&&(C.selectedEducationTab=e,q())}function Rd(){let e=document.body.classList.contains("theme-gold");dn(e?"cosmic":"gold"),q()}var vc=!1;function gb(){let e=document.getElementById("xpd-tv-widget");e&&ee.chart&&(ee.chart.applyOptions({width:Math.max(320,e.clientWidth||320),height:Math.max(320,e.clientHeight||460)}),si())}function Dd(){var t;let e=document.querySelector(".xpd-chart-wrap");e&&(vc||(vc=!0,document.addEventListener("fullscreenchange",()=>{requestAnimationFrame(()=>requestAnimationFrame(gb))})),document.fullscreenElement?document.exitFullscreen():(t=e.requestFullscreen)==null||t.call(e))}function Id(){let e=ee.chart;if(!e){be("Chart image is not ready yet.");return}let t=e.takeScreenshot(),n=document.createElement("a");n.download=`xrpl-chart-${Date.now()}.png`,n.href=t.toDataURL("image/png"),n.click()}function Fd(){return C.tokenFocusKey||C.pair||"default"}function Bd(){var n;let e=ve(Z(Jo))||{},t=Fd();e[t]={interval:C.interval,chartType:C.chartType,comparePair:C.comparePair,indicators:C.indicators,indicatorSettings:C.indicatorSettings},te(Jo,JSON.stringify(e)),se(`Chart layout saved for ${((n=C.chartMeta)==null?void 0:n.symbol)||t}.`)}function Xd(){var s;let e=ve(Z(Jo))||{},t=Fd(),n=e[t];if(!n){be(`No saved layout for ${((s=C.chartMeta)==null?void 0:s.symbol)||t} yet.`);return}C.interval=n.interval||C.interval,C.chartType=n.chartType||C.chartType,C.comparePair=n.comparePair||"",C.indicators={...C.indicators,...n.indicators||{}},C.indicatorSettings={...C.indicatorSettings,...n.indicatorSettings||{}},$t(),q()}function Ra(e){let t=String(e||"").trim();if(/^[0-9A-F]{40}$/i.test(t)){let n=t.replace(/(00)+$/g,"");if(/^[0-9A-F]+$/i.test(n)&&n.length%2===0)try{let s=new Uint8Array(n.length/2);for(let o=0;o<n.length;o+=2)s[o/2]=parseInt(n.slice(o,o+2),16);let a=new TextDecoder().decode(s).replace(/\0/g,"").trim();if(a)return a.toUpperCase()}catch{}}return t.toUpperCase()}function ht(e){return`${e.symbol}|${e.issuer||""}`}function vb(e){var l,c,d,u,p,m,f,g,h,w;let t=Ra(e.code||e.currency||""),n=String(e.issuer||((l=e.IssuingAccount)==null?void 0:l.account)||"").trim(),s=Number(e.price??((c=e.metrics)==null?void 0:c.price)??0),a=Number(e.marketcap??((d=e.metrics)==null?void 0:d.marketcap)??0),o=Number(((u=e.metrics)==null?void 0:u.volume_24h)??0),i=((m=(p=e.meta)==null?void 0:p.token)==null?void 0:m.name)||((f=e.IssuingAccount)==null?void 0:f.name)||t||"Unknown Token",r=Number(e.holders??((g=e.metrics)==null?void 0:g.holders)??((h=e.metrics)==null?void 0:h.trustlines)??0);return{symbol:t,name:i,issuer:n,tokenId:e.id||`${t}.${n}`,price:Number.isFinite(s)&&s>0?s:null,marketCap:Number.isFinite(a)&&a>0?a:null,volume24h:Number.isFinite(o)?o:null,holders:Number.isFinite(r)?r:null,change24h:null,verified:!!((w=e.IssuingAccount)!=null&&w.verified),score:Number(e.score||0)||null}}function bb(e){let t=Ra((e==null?void 0:e.symbol)||""),n=String((e==null?void 0:e.name)||t||"Unknown Token"),s=Number((e==null?void 0:e.current_price)||0),a=Number((e==null?void 0:e.market_cap)||0),o=Number((e==null?void 0:e.total_volume)||0),i=Number((e==null?void 0:e.price_change_percentage_24h)||0);return{symbol:t,name:n,issuer:"",tokenId:`cg:${(e==null?void 0:e.id)||t}`,price:Number.isFinite(s)&&s>0?s:null,marketCap:Number.isFinite(a)&&a>0?a:null,volume24h:Number.isFinite(o)&&o>0?o:null,holders:null,change24h:Number.isFinite(i)?i:null,verified:!1,score:null}}function yb(e){var r;let t=Ra((e==null?void 0:e.currency)||(e==null?void 0:e.token)||""),n=String((e==null?void 0:e.issuer)||(e==null?void 0:e.account)||"").trim(),s=String((e==null?void 0:e.name)||t||"Unknown Token"),a=Number((e==null?void 0:e.price)||((r=e==null?void 0:e.market)==null?void 0:r.price)||0),o=Number((e==null?void 0:e.marketcap)||(e==null?void 0:e.marketCap)||0),i=Number((e==null?void 0:e.volume24h)||(e==null?void 0:e.volume)||0);return{symbol:t,name:s,issuer:n,tokenId:`bithomp:${t}.${n||"na"}`,price:Number.isFinite(a)&&a>0?a:null,marketCap:Number.isFinite(o)&&o>0?o:null,volume24h:Number.isFinite(i)&&i>0?i:null,holders:Number.isFinite(Number((e==null?void 0:e.holders)||0))?Number((e==null?void 0:e.holders)||0):null,change24h:Number.isFinite(Number((e==null?void 0:e.change24h)||0))?Number((e==null?void 0:e.change24h)||0):null,verified:!!(e!=null&&e.verified),score:null}}function wb(e){let t=Ra((e==null?void 0:e.symbol)||(e==null?void 0:e.currency)||""),n=String((e==null?void 0:e.issuer)||(e==null?void 0:e.issuerAddress)||"").trim(),s=String((e==null?void 0:e.name)||t||"Unknown Token"),a=Number((e==null?void 0:e.price)||0),o=Number((e==null?void 0:e.volume24h)||0);return{symbol:t,name:s,issuer:n,tokenId:`xrplto:${t}.${n||"na"}`,price:Number.isFinite(a)&&a>0?a:null,marketCap:Number.isFinite(Number((e==null?void 0:e.marketCap)||0))?Number((e==null?void 0:e.marketCap)||0):null,volume24h:Number.isFinite(o)&&o>0?o:null,holders:Number.isFinite(Number((e==null?void 0:e.holders)||0))?Number((e==null?void 0:e.holders)||0):null,change24h:Number.isFinite(Number((e==null?void 0:e.change24h)||0))?Number((e==null?void 0:e.change24h)||0):null,verified:!!(e!=null&&e.verified),score:null}}async function Od(){var e,t,n,s,a,o;if(Ma()){j.loading=!0,j.error="";try{let i=Date.now(),r=ic.get("tokens");if(r&&i-r.ts<6e4){j.tokens=r.data,j.total=r.total||r.data.length,j.lastSyncAt=r.ts,j.filtered=La(j.query,r.data),j.trending=bc(r.data),j.loading=!1;return}let l=500,c=12,d=[];for(let T=1;T<=c;T+=1){let $=await kt(`${Ug}?page=${T}&limit=${l}`,{allowProxy:!1,timeoutMs:12e3});if(!Array.isArray($)||!$.length||(d.push(...$),$.length<l))break}let u=d.map(vb).filter(T=>!!T.symbol&&!!T.issuer),p=[kt(`${Wg}?vs_currency=usd&order=market_cap_desc&per_page=250&page=1&sparkline=false`,{timeoutMs:12e3}).catch(()=>[]),Date.now()<(cc.xrplto||0)?Promise.resolve([]):kt(qg,{timeoutMs:12e3,allowProxy:!1}).catch(T=>(String((T==null?void 0:T.message)||"").includes("429")&&(cc.xrplto=Date.now()+5*60*1e3),[]))];Vg&&p.push(kt(jg,{timeoutMs:12e3,allowProxy:!1}).catch(()=>[]));let[m,f,g=[]]=await Promise.all(p),h=Array.isArray(m)?m.map(bb).filter(T=>!!T.symbol):[],w=Array.isArray(g)?g.map(yb).filter(T=>!!T.symbol):[],k=Array.isArray(f)?f.map(wb).filter(T=>!!T.symbol):[],v={symbol:"XRP",name:"XRP Ledger Native",issuer:"",tokenId:"XRP",price:((e=Te.data)==null?void 0:e.priceUsd)||((t=C.stats)==null?void 0:t.price)||null,marketCap:((n=Te.data)==null?void 0:n.marketCap)||null,volume24h:((s=Te.data)==null?void 0:s.volume24h)||null,holders:null,change24h:((a=Te.data)==null?void 0:a.change24h)||((o=C.stats)==null?void 0:o.changePct)||null,verified:!0,score:1},x=new Map;[v,...u,...w,...k,...h].forEach(T=>{let $=ht(T);x.has($)||x.set($,T)});let S=[...x.values()];ic.set("tokens",{ts:i,data:S,total:S.length}),j.tokens=S,j.total=S.length,j.lastSyncAt=i,j.filtered=La(j.query,S),j.trending=bc(S)}catch(i){j.error=(i==null?void 0:i.message)||"Could not load XRPL token discovery data."}finally{j.loading=!1}}}function La(e,t){let n=String(e||"").trim().toLowerCase(),s=j.filters||{type:"all",minCap:0,minVol:0,hasDex:!1};return t.filter(a=>{if(n&&!`${a.symbol} ${a.name} ${a.issuer} ${a.tokenId||""}`.toLowerCase().includes(n)||Number(s.minCap||0)>0&&Number(a.marketCap||0)<Number(s.minCap||0)||Number(s.minVol||0)>0&&Number(a.volume24h||0)<Number(s.minVol||0)||s.hasDex&&!(Number(a.volume24h||0)>0||Number(a.holders||0)>100))return!1;if(s.type&&s.type!=="all"){let o=String(a.symbol||"").toLowerCase(),i=String(a.name||"").toLowerCase(),r=/usd|usdc|usdt|rlusd|eur|gbp/.test(o)||/stable/.test(i),l=/meme|dog|cat|frog|shib|pepe/.test(o)||/meme/.test(i),c=/mpt/.test(o)||/multi-purpose/.test(i);if(s.type==="stablecoin"&&!r||s.type==="meme"&&!l||s.type==="mpt"&&!c||s.type==="standard"&&(r||l||c))return!1}return!0})}function bc(e){return[...e].sort((t,n)=>{let s=Number(t.volume24h||0),a=Number(n.volume24h||0);if(a!==s)return a-s;let o=Number(t.marketCap||0);return Number(n.marketCap||0)-o}).slice(0,24)}async function Hd(e){if(wt.loading=!0,wt.error="",wt.items=[],!e){wt.loading=!1;return}try{let t=await bi(e,20);wt.items=t||[]}catch(t){wt.error=(t==null?void 0:t.message)||"Could not load recent transactions."}finally{wt.loading=!1}}function zd(e){j.query=e,Wo&&clearTimeout(Wo),Wo=setTimeout(()=>{j.listLimit=240,j.filtered=La(j.query,j.tokens),q()},300)}function Ud(e,t){j.filters={...j.filters,[e]:t},j.listLimit=240,j.filtered=La(j.query,j.tokens),q()}function Wd(){j.listLimit=Math.min(5e3,Number(j.listLimit||240)+240),q()}function jd(){let e=j.filtered.length?j.filtered:j.tokens;j.listLimit=Math.min(5e3,Math.max(240,e.length)),q()}function qd(){j.listLimit=240,q()}function Vd(e){j.selectedTokenKey=e||"",q()}function Gd(e){let t=String(e||"").trim();if(!t)return;let n=mi();n.includes(t)||n.push(t),Hc(n),q()}function Kd(e){let t=String(e||"").trim(),n=mi().filter(s=>s!==t);Hc(n),q()}async function Da(e){let t=String(e||"").trim();if(!t)return;let n=String(t.includes("|")?t.split("|")[0]:t).toUpperCase(),s=t.includes("|")?j.tokens.find(o=>ht(o)===t):j.tokens.find(o=>String(o.symbol||"").toUpperCase()===String(n||"").toUpperCase());j.selectedTokenKey=s?ht(s):t.includes("|")?t:j.selectedTokenKey,C.tokenFocusKey=j.selectedTokenKey||t;let a={BTC:"BINANCE:BTCUSDT",ETH:"BINANCE:ETHUSDT",SOL:"BINANCE:SOLUSDT"};C.pair=a[n]||"BITSTAMP:XRPUSD",$t(),q(),setTimeout(()=>pv(),20),await Ds(),$t(),q()}async function Jd(e){return Da(e)}async function Yd(){await Od(),q()}async function Qd(){let e=document.getElementById("xpd-lookup-currency"),t=document.getElementById("xpd-lookup-issuer"),n=String((e==null?void 0:e.value)||"").trim().toUpperCase(),s=String((t==null?void 0:t.value)||"").trim();if(!n){be("Enter a currency code first.");return}if(!s||!ze(s)){be("Enter a valid XRPL issuer address.");return}let a=`${n}|${s}`,o=j.tokens.find(i=>ht(i)===a);o||(o={symbol:n,name:n,issuer:s,price:null,marketCap:null,volume24h:null,holders:null,tokenId:""},j.tokens=[...j.tokens,o]),j.selectedTokenKey=a,e&&(e.value=""),t&&(t.value=""),await Da(a)}async function Zd(){var t;let e=((t=St())==null?void 0:t.address)||"";await Hd(e),q()}async function es({silent:e=!1,force:t=!1}={}){var s;if(!t&&!Ma())return;let n=((s=St())==null?void 0:s.address)||"";e||se("Refreshing XRPL dashboard data..."),await Promise.allSettled([Ds(),zc(),Od(),Hd(n),Uc(n),Wc(n),qc()]),q()}function ep(){return zc()}function tp(){var e;return Uc(((e=St())==null?void 0:e.address)||"")}function np(){var e;return Wc(((e=St())==null?void 0:e.address)||"")}function sp(){return qc()}function ap(e){se(`NFT ${e.slice(0,12)}... selected. Send flow can be wired to NFTokenCreateOffer.`)}function Rs(){let e=y("profile-metrics-row");if(!e)return;let t=!1,n=Object.values(Ve).reduce((u,p)=>u+((p==null?void 0:p.xrp)||0),0),s=op(),a=Object.values(Ve).flatMap(u=>(u==null?void 0:u.tokens)||[]),o=St(),i=o?Ls[o.address]:null,r=(i==null?void 0:i.ownerCount)||0,l=Sa+r*Ta,c=o!=null&&o.createdAt?kb(new Date(o.createdAt)):"\u2014",d=(i==null?void 0:i.sequence)!=null?i.sequence:"\u2014";e.innerHTML=`
    <div class="pmetric"><div class="pmetric-val">${t?"\u2022\u2022\u2022\u2022":I(n,2)}</div><div class="pmetric-label">Total XRP</div></div>
    ...
    <div class="pmetric pmetric-reserve" title="${r} owned objects \xD7 ${Ta} XRP + ${Sa} XRP base">
      ...
      <div class="pmetric-label">Reserved</div></div>`:""}`,o&&(!Ls[o.address]||Date.now()-Ls[o.address].fetchedAt>6e4)&&xb(o.address).then(()=>Rs())}async function xb(e){try{let t=await Je({method:"account_info",params:[{account:e,ledger_index:"validated"}]});t!=null&&t.account_data&&(Ls[e]={sequence:t.account_data.Sequence,ownerCount:t.account_data.OwnerCount||0,fetchedAt:Date.now()})}catch{}}function kb(e){let t=Math.floor((Date.now()-e.getTime())/864e5);if(t<1)return"Today";if(t<30)return`${t}d`;if(t<365)return`${Math.floor(t/30)}mo`;let n=Math.floor(t/365),s=Math.floor(t%365/30);return s?`${n}y ${s}mo`:`${n}y`}function op(){var t;if(Array.isArray((t=window.__dashSeries)==null?void 0:t.marketPrice)){let n=window.__dashSeries.marketPrice.at(-1);if(n!=null&&Number.isFinite(n))return n}let e=document.getElementById("mkt-price");if(e){let n=parseFloat(e.textContent.replace("$",""));if(!isNaN(n))return n}return 0}function $b(){let e=ie.length>0,t=Object.values(He).some(Boolean),n=!!le.bio,s=!!localStorage.getItem("naluxrp_last_backup_ts"),a=[e,t,n,s].filter(Boolean).length;return a===4?"":`
  ...
  </div>`}function Ia(){let e=y("profile-tab-social");if(!e)return;let t=Object.values(He).filter(Boolean).length;e.innerHTML=`
    ...
    ${t?`<div class="social-preview-row">
    ...
    </div>`:""}`,Pa("stat-socials-val",t)}function ip(e){let t=ns.find(l=>l.id===e);if(!t)return;let n=y("social-modal");if(!n)return;let s=y("social-modal-icon"),a=y("social-modal-title"),o=y("social-modal-sub"),i=y("social-modal-input"),r=y("social-modal-delete");s&&(s.className=`social-platform-icon-lg social-icon ${t.id}`,s.textContent=t.icon),a&&(a.textContent=`Connect ${t.label}`),o&&(o.textContent=`Enter your ${t.label} ${t.id==="discord"?"user ID or username":"username"}.`),i&&(i.value=He[e]||"",i.placeholder=`Your ${t.label} handle`),r&&(r.style.display=He[e]?"":"none"),n.dataset.platform=e,n.classList.add("show"),setTimeout(()=>i==null?void 0:i.focus(),80)}function rp(){let e=y("social-modal"),t=e==null?void 0:e.dataset.platform,n=y("social-modal-input");if(!t||!n)return;let s=n.value.trim().replace(/^@/,"");s?He[t]=s:delete He[t],Bc(),Ia(),ss();let a=ns.find(o=>o.id===t);ty(),gt("social_connected",`${(a==null?void 0:a.label)||t} @${s||"(removed)"}`),se(`${a==null?void 0:a.label} updated`)}function lp(){var t;let e=(t=y("social-modal"))==null?void 0:t.dataset.platform;e&&(delete He[e],Bc(),Ia(),ss(),gt("social_removed",e),se("Social connection removed"))}function cp(e){let t=ns.find(n=>n.id===e);t&&He[e]&&window.open(`${t.prefix}${He[e]}`,"_blank","noopener")}function ss(){var e;(e=y("social-modal"))==null||e.classList.remove("show")}function at(){let e=y("profile-tab-wallets");if(!e)return;if(ie.length===0){e.innerHTML=$b()+`
      ...
      </div>`,Pa("stat-wallets-val",0);return}let t=ie.length>3?`
    ...
    </div>`:"",n=ie.filter(a=>!Zn||a.label.toLowerCase().includes(Zn.toLowerCase())||a.address.toLowerCase().includes(Zn.toLowerCase())),s=n.map((a,o)=>Sb(a,ie.indexOf(a))).join("");e.innerHTML=t+(n.length?s:`<div class="wcard-empty">No wallets match "${b(Zn)}"</div>`)+`
    ...
    </div>`,Pa("stat-wallets-val",ie.length)}function Sb(e,t){let n=e.id===st,s=!!e.watchOnly,a=Ve[e.address],o=Ls[e.address],r=!0||s,l=(o==null?void 0:o.ownerCount)||0,c=Sa+l*Ta,d=r?a?I(a.xrp,2):"\u2014":"\u2022\u2022\u2022\u2022",u=a&&r?Math.max(0,a.xrp-c):null,p=(a==null?void 0:a.tokens)||[],m=a!=null&&a.fetchedAt?Xc(a.fetchedAt):null,f=e.address.slice(0,8)+"\u2026"+e.address.slice(-6),g=vi(e.address);return`
  <div class="wcard ${n?"wcard--active":""} ${s?"wcard--watch":""}" id="wallet-item-${e.id}" style="--i:${t}">
    <div class="wcard-top">
      ...
      <div class="wcard-balance-col">
        ${g.length>=2?`<div class="wcard-sparkline">${bp(g,70,22,e.color||"#00fff0")}</div>`:""}
        <div class="wcard-xrp ${r?"":"wcard-balance-locked"}">${d} <span class="wcard-xrp-label">XRP</span></div>
        ${u!==null&&r?`<div class="wcard-avail" title="${c} XRP reserved">${I(u,2)} avail.</div>`:""}
    ...
    ${p.length&&r?`<div class="wcard-token-row">
      ${p.slice(0,6).map(h=>{let w=h.currency.length>4?Ti(h.currency)||h.currency.slice(0,4)+"\u2026":h.currency;return`<div class="wcard-token-chip" onclick="openTokenDetailsModal('${b(h.currency)}','${b(h.issuer)}','${b(e.address)}')" title="${b(h.currency)}">
          <span class="wcard-token-cur">${b(w)}</span>
          <span class="wcard-token-bal">${I(parseFloat(h.balance||0),4)}</span>
        </div>`}).join("")}
  ...
  </div>`}function dp(e){var n;let t=ie[e];t&&(ie.splice(e,1),Ns(),st===t.id&&(st=((n=ie[0])==null?void 0:n.id)||null,st&&te(Es,st)),at(),Et(),gt("wallet_removed",t.label),Tb(`Wallet "${t.label}" removed`,()=>{ie.splice(e,0,t),Ns(),st||(st=t.id,te(Es,t.id)),at(),Et(),gt("wallet_created",t.label+" (restored)")},()=>{t.address&&lt(oi+t.address)}))}function Tb(e,t,n){let s=document.getElementById("undo-toast");s&&s.remove();let a=document.createElement("div");a.id="undo-toast",a.className="undo-toast",a.innerHTML=`<span class="undo-msg">${b(e)}</span><button class="undo-btn">Undo</button>`,document.body.appendChild(a),requestAnimationFrame(()=>a.classList.add("show"));let o=setTimeout(()=>{a.classList.remove("show"),setTimeout(()=>a.remove(),300),n==null||n()},5e3);a.querySelector(".undo-btn").addEventListener("click",()=>{clearTimeout(o),t(),a.classList.remove("show"),setTimeout(()=>a.remove(),300),se("Wallet restored")})}function pp(e){var n,s;let t=y("inspect-addr");t&&(t.value=e),(n=window.switchTab)==null||n.call(window,document.querySelector('[data-tab="inspector"]'),"inspector"),(s=window.showDashboard)==null||s.call(window)}function up(e){$n=$n===e?null:e,$n&&!an[e]&&(an[e]="txns"),at(),$n&&setTimeout(()=>gi(e,an[e]),60)}function mp(e,t){an[e]=t;let n=document.getElementById(`wcard-drawer-${e}`);n&&(n.querySelectorAll(".wdt-btn").forEach(s=>s.classList.toggle("active",s.textContent.toLowerCase().includes(t==="txns"?"trans":t==="nfts"?"nft":t==="orders"?"dex":"amm"))),gi(e,t))}async function gi(e,t){var a,o,i;let n=ie.find(r=>r.id===e),s=document.getElementById(`wcard-drawer-body-${e}`);if(!(!n||!s)){s.innerHTML='<div class="wdd-loading"><div class="spinner"></div> Loading\u2026</div>';try{t==="txns"?s.innerHTML=Cb(((a=ri[n.address])==null?void 0:a.txns)||await bi(n.address),n.address):t==="nfts"?s.innerHTML=Mb(((o=Sc[n.address])==null?void 0:o.nfts)||await Bb(n.address),n.address):t==="orders"?s.innerHTML=Lb(((i=li[n.address])==null?void 0:i.offers)||await Xb(n.address),n.id,n.address):t==="amm"&&(s.innerHTML=await Pb(n.address))}catch(r){s.innerHTML=`<div class="wdd-error">\u26A0\uFE0F ${b(r.message)}</div>`}}}function fp(e){return{Payment:"\u{1F4B8}",OfferCreate:"\u{1F4CA}",OfferCancel:"\u2715",TrustSet:"\u{1F517}",NFTokenMint:"\u{1F3A8}",NFTokenBurn:"\u{1F525}",NFTokenCreateOffer:"\u{1F3AF}",NFTokenAcceptOffer:"\u2705",AMMCreate:"\u{1F30A}",AMMDeposit:"\u{1F4E5}",AMMWithdraw:"\u{1F4E4}",AMMVote:"\u{1F5F3}",AMMBid:"\u{1F4A1}",EscrowCreate:"\u23F3",EscrowFinish:"\u2705",EscrowCancel:"\u2715",AccountSet:"\u2699",SetRegularKey:"\u{1F511}",SignerListSet:"\u{1F4CB}"}[e]||"\u{1F4C4}"}function ai(e){return e?typeof e=="string"?`${I(Number(e)/1e6,4)} XRP`:`${I(parseFloat(e.value||0),4)} ${(e.currency||"?").length>4?e.currency.slice(0,4)+"\u2026":e.currency}`:"\u2014"}function Cb(e,t){return e!=null&&e.length?`<div class="wdd-tx-list">
    ${e.slice(0,25).map(n=>{var c,d;let s=n.TransactionType||"?",a=n.Account===t,o=!(((c=n.metaData)==null?void 0:c.TransactionResult)||((d=n.meta)==null?void 0:d.TransactionResult)||"").match(/^tec|^tem|^tef|^tel/),i=n.date?(n.date+946684800)*1e3:0,r=i?new Date(i).toLocaleDateString("en-US",{month:"short",day:"numeric",hour:"2-digit",minute:"2-digit"}):"\u2014",l=n.hash||n.tx_hash||"";return`<div class="wdd-tx-row ${o?"":"wdd-tx-failed"}">
        <div class="wdd-tx-icon">${fp(s)}</div>
        <div class="wdd-tx-body">
          ...
          <div class="wdd-tx-detail">
            ...
            ${n.Destination?`<span class="wdd-tx-dest mono">${Tc[n.Destination]||n.Destination.slice(0,8)+"\u2026"+n.Destination.slice(-5)}</span>`:""}
          </div>
        </div>
  ...
  </div>`:'<div class="wdd-empty"><div class="wdd-empty-icon">\u{1F4CB}</div><div>No transactions yet.</div><div class="wdd-empty-sub">Fund with 10 XRP to activate.</div></div>'}function Mb(e,t){return e!=null&&e.length?`<div class="wdd-nft-header"><span>${e.length} NFT${e.length>1?"s":""}</span>
    ...
    </div>`:'<div class="wdd-empty"><div class="wdd-empty-icon">\u{1F4CA}</div><div>No open DEX orders.</div></div>'}async function Pb(e){try{let n=(ii[e]||[]).filter(s=>{var a;return((a=s.currency)==null?void 0:a.length)===40});return n.length?`<div class="wdd-amm-list">
      ${n.map(s=>{let a=s.currency,o=I(parseFloat(s.balance||0),6);return`<div class="wdd-amm-row">
    ...
    </div>`:'<div class="wdd-empty"><div class="wdd-empty-icon">\u{1F30A}</div><div>No AMM LP positions.</div><div class="wdd-empty-sub">Deposit into an AMM pool to earn fees.</div></div>'}catch(t){return`<div class="wdd-error">\u26A0\uFE0F ${b(t.message)}</div>`}}async function hp(e,t,n){let s=prompt("Optional seed to cancel this order (leave blank to use wallet password):");n&&(n.disabled=!0,n.textContent="\u2026");try{let a=await jb(e,t,s);if(zb(a)){se("Order cancelled \u2713");let o=ie.find(i=>i.id===e);o&&(delete li[o.address],gi(e,"orders"))}else At("Cancel failed: "+Ub(a)),n&&(n.disabled=!1,n.textContent="\u2715 Cancel")}catch(a){At(a.message),n&&(n.disabled=!1,n.textContent="\u2715 Cancel")}}function gp(){let e=y("profile-tab-activity");if(!e)return;let t=fv(),n=St();e.innerHTML=`
    <div class="act-section-row">
      <div class="act-section">
        ...
        ${t.length?`<div class="act-timeline">${t.slice(0,20).map(s=>`
            <div class="act-entry">
              <div class="act-entry-icon">${cv[s.type]||"\u25CF"}</div>
              <div class="act-entry-body">
                <div class="act-entry-detail">${b(s.detail)}</div>
                <div class="act-entry-time">${Xc(s.ts)}</div>
              </div>
    ...
    </div>`}function as(){var o,i;let e=y("profile-tab-settings");if(!e)return;let t=["gold","cosmic","starry","hawaiian"],n=Z("nalulf_pref_currency")||"XRP",s=Z("nalulf_pref_network")||"mainnet",a=Z("nalulf_pref_autolock")||"30";e.innerHTML=`<div class="settings-grid">
    ...
    <div class="settings-card">
      ...
      <div class="settings-kv-list">
        ...
        <div class="settings-kv"><span class="settings-k">Wallets</span><span class="settings-v">${ie.length} stored</span></div>
      </div>
    </div>
  ...
  </div>`}function Eb(){let e=y("profile-tab-security");e&&(e.innerHTML=`<div class="sec-grid">
    <div class="sec-card">
    ...
    <div class="sec-card">
  ...
  </div>`)}async function vp(){var t;let e=y("profile-tab-analytics");if(e){e.innerHTML='<div class="analytics-grid"><div class="skeleton-card analytics-card--wide" style="height:80px"></div><div class="skeleton-card" style="height:160px"></div><div class="skeleton-card" style="height:160px"></div></div>';try{let n=St(),s=Object.values(Ve).reduce((r,l)=>r+((l==null?void 0:l.xrp)||0),0),a=op(),o=Object.values(Ve).flatMap(r=>(r==null?void 0:r.tokens)||[]),i=[];if(n)try{i=((t=ri[n.address])==null?void 0:t.txns)||await bi(n.address,100)}catch{}e.innerHTML=`<div class="analytics-grid">
      <div class="analytics-card analytics-card--wide">
        <div class="analytics-card-hdr"><span class="analytics-card-title">\u{1F4BC} Portfolio Summary</span>
          <span class="analytics-badge">${ie.length} wallet${ie.length!==1?"s":""}</span></div>
        <div class="portfolio-summary-row">
          ${ie.length?ie.map(r=>{let l=Ve[r.address],c=l?I(l.xrp,2):"\u2014",d=l&&a?`$${I(l.xrp*a,2)}`:"",u=vi(r.address);return`<div class="portfolio-wallet-row">
                ...
                <div class="pwr-sparkline">${bp(u,80,28,r.color||"#00fff0")}</div>
        ...
        <div class="portfolio-totals">
          <div class="ptotal"><span class="ptotal-label">Total XRP</span><span class="ptotal-val">${I(s,4)}</span></div>
          ${a?`<div class="ptotal"><span class="ptotal-label">Est. USD</span><span class="ptotal-val ptotal-usd">$${I(s*a,2)}</span></div>`:""}
          <div class="ptotal"><span class="ptotal-label">Tokens</span><span class="ptotal-val">${o.length}</span></div>
          <div class="ptotal"><span class="ptotal-label">Wallets</span><span class="ptotal-val">${ie.length}</span></div>
        </div>
      </div>
      ...
      <div class="analytics-card analytics-card--wide">
        ...
        ${n?Nb(i):'<div class="analytics-empty">Activate a wallet to see activity.</div>'}
      </div>
    ...
    </div>`}catch(n){Ic(e,"analytics",n)}}}function bp(e,t,n,s){if(e.length<2)return`<svg width="${t}" height="${n}"><line x1="0" y1="${n/2}" x2="${t}" y2="${n/2}" stroke="${s}" stroke-opacity=".2" stroke-width="1" stroke-dasharray="3 2"/></svg>`;let a=e.map(u=>u.xrp),o=Math.min(...a),i=Math.max(...a),r=i-o||1,l=a.map((u,p)=>`${3+p/(a.length-1)*(t-6)},${3+(1-(u-o)/r)*(n-6)}`),[c,d]=l[l.length-1].split(",");return`<svg width="${t}" height="${n}" viewBox="0 0 ${t} ${n}">
  ...
  </svg>`}function Ab(e){let t=vi(e);if(t.length<2)return`<div class="analytics-empty-chart"><div class="aec-icon">\u{1F4CA}</div><div>Balance history builds up as you refresh your wallet over time.</div><div class="aec-sub">${t.length} snapshot${t.length!==1?"s":""} recorded.</div></div>`;let n=560,s=130,a=52,o=12,i=14,r=30,l=t.map(_=>_.xrp),c=t.map(_=>_.ts),d=Math.min(...l),u=Math.max(...l),p=u-d||1,m=c[0],f=c[c.length-1],g=f-m||1,h=_=>a+(_-m)/g*(n-a-o),w=_=>i+(1-(_-d)/p)*(s-i-r),k=t.map(_=>`${h(_.ts).toFixed(1)},${w(_.xrp).toFixed(1)}`),v=h(c[0]),x=h(c[c.length-1]),S=l[l.length-1]-l[0],T=S>=0,$=l[0]?Math.abs(S/l[0]*100).toFixed(2):"0.00",P=T?"#00d4ff":"#ff5555",M=[d,(d+u)/2,u].map(_=>({v:_,y:w(_),l:I(_,2)})),N=[0,.5,1].map(_=>({x:a+_*(n-a-o),l:new Date(m+_*g).toLocaleDateString("en-US",{month:"short",day:"numeric"})}));return`
    <div class="balance-chart-meta">
      <div class="bcm-current">${I(l[l.length-1],4)} XRP</div>
    ...
    <div class="balance-chart-wrap"><svg class="balance-chart-svg" viewBox="0 0 ${n} ${s}" preserveAspectRatio="none">
      ...
      <path d="M${v.toFixed(1)},${s-r} L${k.join(" L")} L${x.toFixed(1)},${s-r} Z" fill="url(#bg${e.slice(-4)})"/>
    ...
    </svg></div>`}function Nb(e){let t=new Map;e.forEach(f=>{f.date&&t.set(new Date((f.date+946684800)*1e3).toISOString().slice(0,10),(t.get(new Date((f.date+946684800)*1e3).toISOString().slice(0,10))||0)+1)});let n=26,s=12,a=2,o=new Date,i=Array.from({length:n*7},(f,g)=>{let h=new Date(o);return h.setDate(h.getDate()-(n*7-1-g)),h}),r=Array.from({length:n},(f,g)=>i.slice(g*7,g*7+7)),l=Math.max(1,...t.values()),c=n*(s+a)+30,d=7*(s+a)+28,u=f=>f===0?"rgba(255,255,255,.07)":`rgb(0,${Math.round(85+f*170)},${Math.round(119+f*121)})`,p=[],m=-1;return r.forEach((f,g)=>{var w;let h=(w=f[0])==null?void 0:w.getMonth();h!==m&&(m=h,p.push({wi:g,l:f[0].toLocaleDateString("en-US",{month:"short"})}))}),`<div class="heatmap-meta"><span>${e.length} tx \xB7 ${t.size} active days</span>
  ...
  <div class="heatmap-scroll"><svg class="heatmap-svg" viewBox="0 0 ${c} ${d}" width="${c}" height="${d}">
    ...
    ${r.map((f,g)=>f.map((h,w)=>{let k=h.toISOString().slice(0,10),v=t.get(k)||0;return`<rect x="${26+g*(s+a)}" y="${16+w*(s+a)}" width="${s}" height="${s}" rx="2" fill="${u(v/l)}" opacity="${v>0?.9:.25}"><title>${k}: ${v} tx</title></rect>`}).join("")).join("")}
  </svg></div>`}function _b(e){let t=new Map;e.forEach(a=>t.set(a.TransactionType||"?",(t.get(a.TransactionType||"?")||0)+1));let n=[...t.entries()].sort((a,o)=>o[1]-a[1]),s=e.length;return`<div class="tx-breakdown-list">${n.slice(0,8).map(([a,o])=>`<div class="txb-row"><div class="txb-icon">${fp(a)}</div><div class="txb-type">${a}</div><div class="txb-bar-wrap"><div class="txb-bar" style="width:${(o/s*100).toFixed(0)}%"></div></div><div class="txb-count">${o}</div></div>`).join("")}</div>`}function Rb(e){let t=new Map;e.forEach(o=>{let i=Math.abs(parseFloat(o.balance||0));t.set(o.currency,(t.get(o.currency)||0)+i)});let n=[...t.entries()].sort((o,i)=>i[1]-o[1]).slice(0,8),s=n.reduce((o,[,i])=>o+i,0)||1,a=["#00fff0","#00d4ff","#bd93f9","#50fa7b","#ffb86c","#ff79c6","#f1fa8c","#ff5555"];return`<div class="token-alloc-list">${n.map(([o,i],r)=>{let l=(i/s*100).toFixed(1),c=a[r%a.length],d=o.length>4?o.slice(0,4)+"\u2026":o;return`<div class="ta-row"><div class="ta-swatch" style="background:${c}"></div><div class="ta-cur mono">${d}</div><div class="ta-bar-wrap"><div class="ta-bar" style="width:${l}%;background:${c}20;border-color:${c}55"></div></div><div class="ta-pct">${l}%</div></div>`}).join("")}</div>`}function Db(e,t){let n=0,s=0;e.forEach(i=>{var c,d;if(i.TransactionType!=="Payment"||!((((c=i.metaData)==null?void 0:c.TransactionResult)||((d=i.meta)==null?void 0:d.TransactionResult))==="tesSUCCESS")||typeof i.Amount!="string")return;let l=Number(i.Amount)/1e6;i.Destination===t&&(n+=l),i.Account===t&&(s+=l)});let a=n-s,o=a>=0;return`<div class="xrp-flow-grid">
    <div class="xrf-item xrf-in"><div class="xrf-label">\u2193 Inflow</div><div class="xrf-val">${I(n,4)} XRP</div></div>
    <div class="xrf-item xrf-out"><div class="xrf-label">\u2191 Outflow</div><div class="xrf-val">${I(s,4)} XRP</div></div>
    <div class="xrf-item ${o?"xrf-pos":"xrf-neg"}"><div class="xrf-label">Net</div><div class="xrf-val">${o?"+":""}${I(a,4)} XRP</div></div>
  </div>
  <div class="xrf-note">Based on ${e.length} fetched Payment TXs. Excludes fees and DEX fills.</div>`}async function Je(e){var n,s;try{if(((n=X.wsConn)==null?void 0:n.readyState)===1){let{wsSend:a}=await import("./xrpl-6AERZ5KD.js"),o={command:e==null?void 0:e.method,...((s=e==null?void 0:e.params)==null?void 0:s[0])||{}},i=await a(o);if((i==null?void 0:i.status)==="error")throw new Error(i.error_message||i.error||"XRPL RPC error");return(i==null?void 0:i.result)||null}}catch{}let t=async a=>{let o=await fetch(a,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(e),mode:"cors"});if(!o.ok)throw new Error(`HTTP ${o.status}`);return(await o.json()).result};try{return await t(Og)}catch{return await t(Hg)}}async function Mn(e){var t;try{let n=[],s;do{let l=await Je({method:"account_lines",params:[{account:e,ledger_index:"current",limit:400,...s?{marker:s}:{}}]});if(!l||l.error)break;n.push(...l.lines||[]),s=l.marker}while(s);let a=await Je({method:"account_info",params:[{account:e,ledger_index:"current"}]});if(a!=null&&a.error)return null;let o=Number(a.account_data.Balance)/1e6,i=n.map(l=>({currency:l.currency,issuer:l.account,balance:l.balance,limit:l.limit}));Ve[e]={xrp:o,tokens:i,fetchedAt:Date.now()},ii[e]=i,Fb(e,o);let r=document.getElementById("awb-balance");return r&&e===((t=St())==null?void 0:t.address)&&ny(r.querySelector(".awb-xrp-num")||r,o,2,600),Ve[e]}catch{return null}}async function Ib(){await Promise.allSettled(ie.map(e=>Mn(e.address))),at(),Et(),Rs()}function Fb(e,t){let n=oi+e,s=ve(Z(n))||[],a=Date.now();s.length&&a-s[s.length-1].ts<5*6e4?s[s.length-1]={xrp:t,ts:a}:s.push({xrp:t,ts:a}),s.length>90&&s.splice(0,s.length-90),te(n,JSON.stringify(s))}function vi(e){return ve(Z(oi+e))||[]}async function bi(e,t=25){let n=await Je({method:"account_tx",params:[{account:e,limit:t,ledger_index_min:-1,ledger_index_max:-1}]}),s=((n==null?void 0:n.transactions)||[]).map(a=>a.tx||a.transaction||a);return ri[e]={txns:s,fetchedAt:Date.now()},s}async function Bb(e){let t=await Je({method:"account_nfts",params:[{account:e,limit:50}]}),n=(t==null?void 0:t.account_nfts)||[];return Sc[e]={nfts:n,fetchedAt:Date.now()},n}async function Xb(e){let t=await Je({method:"account_offers",params:[{account:e,limit:50}]}),n=(t==null?void 0:t.offers)||[];return li[e]={offers:n,fetchedAt:Date.now()},n}async function Ob(e){let t=await Je({method:"account_info",params:[{account:e,ledger_index:"current"}]});return(t==null?void 0:t.account_data)||null}async function Hb(){let e=await Je({method:"ledger",params:[{ledger_index:"current"}]});return(e==null?void 0:e.ledger_current_index)||0}function zb(e){let t=(e==null?void 0:e.engine_result)||"";return t==="tesSUCCESS"||t.startsWith("tes")||(e==null?void 0:e.engine_result_code)===0}function Ub(e){let t=(e==null?void 0:e.engine_result)||"";return Yg[t]||(e==null?void 0:e.engine_result_message)||t||"Unknown error"}async function Wb(e,t,n){if(await Ea(),!window.xrpl)throw new Error("xrpl.js library not loaded. Cannot sign transactions.");let s=ie.find(i=>i.id===e);if(!s)throw new Error("Wallet not found.");if(s.watchOnly)throw new Error("Watch-only wallets cannot sign transactions.");let a=await ev(s,n),o;try{o=window.xrpl.Wallet.fromSeed(a,{algorithm:s.algo==="secp256k1"?"secp256k1":"ed25519"})}catch(i){throw new Error("Invalid seed phrase: "+i.message)}if(o.classicAddress!==s.address)throw new Error("Seed does not match this wallet address.");try{let[i,r]=await Promise.all([Ob(s.address),Hb()]);if(!i)throw new Error("Account not found on-chain. Fund with at least 10 XRP first (base reserve requirement).");let l={...t,Account:s.address,Fee:"12",Sequence:i.Sequence,LastLedgerSequence:r+20},{tx_blob:c,hash:d}=o.sign(l);return{...await Je({method:"submit",params:[{tx_blob:c}]}),tx_hash:d}}finally{}}async function jb(e,t,n){return Wb(e,{TransactionType:"OfferCancel",OfferSequence:parseInt(t)},n)}function qb(){if(y("send-modal-overlay"))return;let e=document.createElement("div");e.innerHTML=`
  <!-- Send -->
  ...
  <div class="generic-modal-overlay" id="token-details-modal">
  ...
  </div>`,document.body.appendChild(e),["send-modal-overlay","receive-modal-overlay","trustline-modal-overlay","import-address-modal","import-seed-modal","token-details-modal"].forEach(t=>{let n=document.getElementById(t);n==null||n.addEventListener("click",s=>{s.target===n&&(n.classList.remove("show"),n.style.display="")})})}function yp(){var o;["displayName","handle","bio","location","website"].forEach(i=>{let r=y(`edit-${i}`);r&&(r.value=le[i]||"")});let e=y("editor-avatar-preview");if(e){let i=localStorage.getItem(on);e.innerHTML=i?`<img src="${i}" class="profile-avatar-img"/>`:le.avatar||"\u{1F30A}"}let t=y("avatar-remove-btn");t&&(t.style.display=localStorage.getItem(on)?"":"none");let n=y("editor-banner-preview");if(n){let i=localStorage.getItem(Tn);n.style.backgroundImage=i?`url(${i})`:"",n.style.backgroundSize="cover",n.style.backgroundPosition="center",As.forEach(r=>n.classList.remove(r)),i||n.classList.add(le.banner||"banner-ocean")}let s=y("avatar-picker-grid");s&&(s.innerHTML=Gg.map(i=>`<div class="avatar-option ${le.avatar===i?"active":""}" onclick="selectAvatar('${i}')">${i}</div>`).join(""));let a=y("banner-picker-grid");a&&(a.innerHTML=As.map(i=>`<div class="banner-option ${i} ${le.banner===i?"active":""}" onclick="selectBanner('${i}')"></div>`).join("")),(o=y("profile-editor-modal"))==null||o.classList.add("show")}function Fs(){var e;(e=y("profile-editor-modal"))==null||e.classList.remove("show")}function wp(){var e,t,n,s,a;le.displayName=((e=y("edit-displayName"))==null?void 0:e.value.trim())||le.displayName,le.handle=(((t=y("edit-handle"))==null?void 0:t.value.trim())||le.handle).replace(/^@/,"").replace(/\s+/g,"_").toLowerCase(),le.bio=((n=y("edit-bio"))==null?void 0:n.value.trim())||"",le.location=((s=y("edit-location"))==null?void 0:s.value.trim())||"",le.website=((a=y("edit-website"))==null?void 0:a.value.trim())||"",Fc(),gt("profile_saved","Profile details updated"),q(),Fs(),se("Profile saved")}function xp(e){localStorage.removeItem(on),le.avatar=e,De(".avatar-option").forEach(s=>s.classList.toggle("active",s.textContent===e));let t=y("editor-avatar-preview");t&&(t.innerHTML=e);let n=y("avatar-remove-btn");n&&(n.style.display="none")}function kp(e){localStorage.removeItem(Tn),le.banner=e,De(".banner-option").forEach(n=>n.classList.toggle("active",n.classList.contains(e)));let t=y("editor-banner-preview");t&&(t.style.backgroundImage="",As.forEach(n=>t.classList.remove(n)),t.classList.add(e)),q()}function $p(e){var s;let t=(s=e==null?void 0:e.files)==null?void 0:s[0];if(!t)return;if(t.size>2*1024*1024){be("Image too large \u2014 max 2 MB");return}let n=new FileReader;n.onload=a=>{let o=new Image;o.onload=()=>{let i=document.createElement("canvas");i.width=i.height=200;let r=i.getContext("2d"),l=Math.min(o.width,o.height);r.drawImage(o,(o.width-l)/2,(o.height-l)/2,l,l,0,0,200,200);let c=i.toDataURL("image/jpeg",.85);localStorage.setItem(on,c);let d=y("editor-avatar-preview");d&&(d.innerHTML=`<img src="${c}" class="profile-avatar-img"/>`);let u=y("avatar-remove-btn");u&&(u.style.display=""),q(),se("Profile photo updated")},o.src=a.target.result},n.readAsDataURL(t),e.value=""}function Sp(){localStorage.removeItem(on);let e=y("editor-avatar-preview");e&&(e.innerHTML=le.avatar||"\u{1F30A}");let t=y("avatar-remove-btn");t&&(t.style.display="none"),q()}function Tp(e){var s;let t=(s=e==null?void 0:e.files)==null?void 0:s[0];if(!t)return;if(t.size>5*1024*1024){be("Image too large \u2014 max 5 MB");return}let n=new FileReader;n.onload=a=>{let o=new Image;o.onload=()=>{let i=document.createElement("canvas");i.width=900,i.height=180;let r=i.getContext("2d"),l=Math.max(900/o.width,180/o.height);r.drawImage(o,(900-o.width*l)/2,(180-o.height*l)/2,o.width*l,o.height*l);let c=i.toDataURL("image/jpeg",.88);localStorage.setItem(Tn,c);let d=y("editor-banner-preview");d&&(d.style.backgroundImage=`url(${c})`,d.style.backgroundSize="cover",d.style.backgroundPosition="center",As.forEach(p=>d.classList.remove(p)));let u=y("banner-remove-btn");u&&(u.style.display=""),q(),se("Banner updated")},o.src=a.target.result},n.readAsDataURL(t),e.value=""}function Cp(){localStorage.removeItem(Tn);let e=y("editor-banner-preview");e&&(e.style.backgroundImage="",As.forEach(n=>e.classList.remove(n)),e.classList.add(le.banner||"banner-ocean"));let t=y("banner-remove-btn");t&&(t.style.display="none"),q()}function Vb(){let e=ie.map(({id:n,label:s,address:a,algo:o,emoji:i,color:r,testnet:l,watchOnly:c,createdAt:d})=>({id:n,label:s,address:a,algo:o,emoji:i,color:r,testnet:l,watchOnly:c,createdAt:d})),t=document.createElement("a");t.href="data:application/json;charset=utf-8,"+encodeURIComponent(JSON.stringify(e,null,2)),t.download=`nalulf-wallets-${new Date().toISOString().slice(0,10)}.json`,t.click(),gt("backup_exported","Wallet addresses exported"),se("Wallet addresses exported")}function Mp(){Vb()}function yi(){var e;ft=1,we={algo:"ed25519",label:"",emoji:"\u{1F48E}",color:"#50fa7b",seed:"",address:"",passphrase:""},Sn.clear(),wi(1),Kb(),Gb(),(e=y("wallet-creator-overlay"))==null||e.classList.add("show"),setTimeout(()=>{var t;return(t=y("wallet-label-input"))==null?void 0:t.focus()},80)}function Bs(){var e;(e=y("wallet-creator-overlay"))==null||e.classList.remove("show"),we.seed=we.address=we.passphrase=""}function Gb(){let e=y("wizard-security-banner");e&&(e.innerHTML=`<div class="wsb-icon">\u{1F510}</div>
    ...
    </div>`).join("")}async function Qb(){var n;let e=await $c(we.seed,we.passphrase),t={id:crypto.randomUUID(),label:we.label,address:we.address,algo:we.algo,emoji:we.emoji,color:we.color,testnet:((n=y("wallet-testnet-check"))==null?void 0:n.checked)||!1,watchOnly:!1,encSeed:e,createdAt:new Date().toISOString()};ie.push(t),Ns(),st||(st=t.id,te(Es,t.id)),at(),Et(),Pa("wallet-success-address",we.address),setTimeout(()=>{we.seed="",we.address="",we.passphrase=""},100),gt("wallet_created",we.label||"New XRPL Wallet"),se("Wallet created and encrypted locally"),Mn(t.address).then(()=>at())}function Ep(e){we.algo=e,De(".algo-card").forEach(t=>t.classList.toggle("active",t.dataset.algo===e))}function Ap(e){we.emoji=e,De(".wallet-emoji-opt").forEach(t=>t.classList.toggle("active",t.textContent===e))}function Np(e){we.color=e,De(".color-swatch").forEach(t=>t.classList.toggle("active",t.style.background===e||t.dataset.color===e))}function _p(e){let t=document.querySelector(`.security-check-${e}`);if(!t)return;let n=t.querySelector(".check-box");Sn.has(e)?(Sn.delete(e),t.classList.remove("checked"),n&&(n.textContent="")):(Sn.add(e),t.classList.add("checked"),n&&(n.textContent="\u2713")),Rp()}function Rp(){let e=y("wizard-next-btn");e&&ft===2&&(e.disabled=Sn.size<4)}function Dp(){var t;(t=y("wizard-seed-value"))==null||t.classList.remove("blur");let e=y("seed-reveal-hint");e&&(e.style.display="none"),setTimeout(()=>{var n;return(n=y("wizard-seed-value"))==null?void 0:n.classList.add("blur")},3e4)}function Ip(){let e=y("wizard-seed-value");if(!e)return;Si(e.textContent,3e4);let t=y("btn-copy-seed");t&&(t.textContent="Copied!",t.classList.add("copied"),setTimeout(()=>{t.textContent="Copy Seed",t.classList.remove("copied")},2e3))}function Fp(){let e=y("wizard-address-value")||y("wallet-success-address");if(!e)return;Si(e.textContent);let t=y("btn-copy-addr");t&&(t.textContent="Copied!",t.classList.add("copied"),setTimeout(()=>{t.textContent="Copy",t.classList.remove("copied")},2e3))}function Bp(){let e=y("import-address-modal");if(!e)return;e.querySelector("#inp-import-address").value="",e.querySelector("#inp-import-label").value="";let t=e.querySelector("#import-address-error");t&&(t.textContent=""),e.classList.add("show"),setTimeout(()=>{var n;return(n=e.querySelector("#inp-import-address"))==null?void 0:n.focus()},80)}function xi(){var e;(e=y("import-address-modal"))==null||e.classList.remove("show")}function Xp(){var s,a;let e=(((s=y("inp-import-address"))==null?void 0:s.value)||"").trim(),t=(((a=y("inp-import-label"))==null?void 0:a.value)||"").trim()||"Watch Wallet",n=y("import-address-error");if(!ze(e)){n&&(n.textContent="Enter a valid XRPL address (starts with r\u2026)");return}if(ie.find(o=>o.address===e)){n&&(n.textContent="This address is already in your list.");return}ie.push({id:"watch_"+Date.now(),label:t,address:e,algo:"\u2014",emoji:"\u{1F441}",color:"#8be9fd",testnet:!1,createdAt:new Date().toISOString(),watchOnly:!0}),Ns(),gt("watch_added",`${t} (${e.slice(0,8)}\u2026)`),xi(),at(),Et(),Rs(),Mn(e).then(()=>{at(),Rs()}),se(`\u{1F441} Watch-only wallet added: ${t}`)}function Op(){let e=y("import-seed-modal");if(!e)return;e.querySelector("#inp-import-seed").value="",e.querySelector("#inp-import-seed-pass").value="",e.querySelector("#inp-import-seed-pass-confirm").value="",e.querySelector("#inp-import-seed-label").value="";let t=e.querySelector("#import-seed-error");t&&(t.textContent=""),e.classList.add("show"),setTimeout(()=>{var n;return(n=e.querySelector("#inp-import-seed"))==null?void 0:n.focus()},80)}function ki(){var e;(e=y("import-seed-modal"))==null||e.classList.remove("show")}async function Hp(){var r,l,c,d,u;let e=(((r=y("inp-import-seed"))==null?void 0:r.value)||"").trim(),t=(((l=y("inp-import-seed-label"))==null?void 0:l.value)||"").trim()||"Imported Wallet",n=(((c=y("inp-import-seed-pass"))==null?void 0:c.value)||"").trim(),s=(((d=y("inp-import-seed-pass-confirm"))==null?void 0:d.value)||"").trim(),a=y("import-seed-error"),o=y("import-seed-btn"),i=p=>{a&&(a.textContent=p)};if(i(""),!e)return i("Enter your seed phrase.");if(n.length<10)return i("Use a wallet password with at least 10 characters.");if(n!==s)return i("Wallet password confirmation does not match.");if(await Ea(),!window.xrpl)return i("xrpl.js not loaded \u2014 cannot derive address from seed.");o&&(o.disabled=!0,o.textContent="Importing\u2026");try{let p=window.xrpl.Wallet.fromSeed(e),m=p.address,f=(u=p.algorithm)!=null&&u.toLowerCase().includes("ed")?"ed25519":"secp256k1";if(ie.find(v=>v.address===m))return i("This address is already in your vault.");let g="imp_"+Date.now(),h="\u{1F511}",w="#bd93f9",k=await $c(e,n);ie.push({id:g,label:t,address:m,algo:f,emoji:h,color:w,testnet:!1,watchOnly:!1,encSeed:k,createdAt:new Date().toISOString()}),Ns(),gt("wallet_imported",`${t} (${m.slice(0,8)}\u2026)`),ki(),at(),Et(),Mn(m).then(()=>{at(),Rs()}),se(`\u{1F511} Wallet imported: ${t}`)}catch(p){i("Invalid seed: "+(p.message||"Could not derive wallet."))}finally{o&&(o.disabled=!1,o.textContent="Import Wallet \u2192");let p=document.getElementById("inp-import-seed");p&&(p.value="");let m=document.getElementById("inp-import-seed-pass");m&&(m.value="");let f=document.getElementById("inp-import-seed-pass-confirm");f&&(f.value="")}}function zp(e,t,n){var d;let s=y("token-details-modal");if(!s)return;let a=s.querySelector(".generic-modal");if(!a)return;let o=Ve[n],i=(d=o==null?void 0:o.tokens)==null?void 0:d.find(u=>u.currency===e&&u.issuer===t),r=i?I(parseFloat(i.balance||0),6):"\u2014",l=i!=null&&i.limit?I(parseFloat(i.limit),2):"Unlimited",c=e.length>4&&Ti(e)||e;a.innerHTML=`
    <div class="tdm-hdr">
      <div class="tdm-title"><span class="tdm-icon">\u{1FA99}</span><span class="tdm-cur">${b(c)}</span>
        ${c!==e?`<span class="tdm-hex mono">${b(e)}</span>`:""}</div>
    ...
    </div>`,s.classList.add("show")}function Up(){let e=y("token-details-modal");e&&(e.classList.remove("show"),e.style.display="")}function Wp(){var s;(s=document.getElementById("pub-profile-overlay"))==null||s.remove();let e=localStorage.getItem(on),t=ns.filter(a=>He[a.id]),n=document.createElement("div");n.id="pub-profile-overlay",n.className="pub-profile-overlay",n.innerHTML=`
    ...
    </div>`,document.body.appendChild(n),requestAnimationFrame(()=>requestAnimationFrame(()=>n.classList.add("show"))),n.addEventListener("click",a=>{a.target===n&&n.remove()})}function jp(e){dn(e),as(),gt("theme_changed",e)}function qp(e){te("nalulf_pref_currency",e),as(),se(`Display currency: ${e}`)}function Vp(e){te("nalulf_pref_network",e),as(),se(`Default network: ${e}`)}function Gp(e){te("nalulf_pref_autolock",e),as(),se(`Auto-lock: ${e} minutes`)}window._profileWipeAllData=()=>{confirm("Clear all profile, wallet list, social, and activity data? Encrypted wallet seeds saved on this device will be deleted.")&&(["nalulf_profile","nalulf_wallets","nalulf_social","nalulf_activity_log","nalulf_avatar_img","nalulf_banner_img","naluxrp_active_wallet"].forEach(e=>localStorage.removeItem(e)),ie=[],He={},st=null,Ve={},ii={},Qo(),q(),pi("wallets"),se("Local data cleared"))};function Zb(){var e,t,n;(e=y("profile-editor-modal"))==null||e.addEventListener("click",s=>{s.target===s.currentTarget&&Fs()}),(t=y("wallet-creator-overlay"))==null||t.addEventListener("click",s=>{s.target===s.currentTarget&&Bs()}),(n=y("social-modal"))==null||n.addEventListener("click",s=>{s.target===s.currentTarget&&ss()})}function ey(){let e=[{done:!!le.displayName&&le.displayName!=="Anonymous",label:"Display name"},{done:!!le.bio,label:"Bio"},{done:le.avatar!=="\u{1F30A}"||!!localStorage.getItem(on),label:"Custom avatar"},{done:!!localStorage.getItem(Tn),label:"Custom banner"},{done:ie.length>0,label:"Wallet added"},{done:Object.keys(He).length>=1,label:"Social connected"},{done:!!le.location,label:"Location set"},{done:!!le.website,label:"Website added"}],t=e.filter(n=>n.done).length;return{pct:Math.round(t/e.length*100),done:t,total:e.length,checks:e}}function ty(){let e=document.getElementById("profile-completeness");if(!e)return;let{pct:t,checks:n}=ey(),s=t===100?"#50fa7b":t>=60?"#00fff0":"#ffb86c",a=2*Math.PI*16,o=t/100*a,i=n.filter(r=>!r.done).map(r=>r.label);e.title=t===100?"Profile complete \u2713":`${t}% \u2014 Missing: ${i.join(", ")}`,e.innerHTML=`
    <div class="pc-wrap">
  ...
  `,document.body.appendChild(e),e.addEventListener("click",t=>{t.target===e&&Xs()}),document.addEventListener("keydown",t=>{t.key==="Escape"&&e.classList.contains("show")&&Xs()})}function ly(e){let t=sy[e];if(!t)return;ry();let n=document.getElementById("learnModalOverlay"),s=document.getElementById("learnModalTitle"),a=document.getElementById("learnModalSub"),o=document.getElementById("learnModalBody"),i=document.getElementById("learnModalLinks"),r=document.getElementById("learnModalCtas");!n||!s||!a||!o||!i||!r||(s.textContent=t.title,a.textContent=t.subtitle||"",o.innerHTML=(t.sections||[]).map(l=>`
    <section class="learn-sec">
      <h4>${b(l.heading||"")}</h4>
      ${(l.paragraphs||[]).map(c=>`<p>${b(c)}</p>`).join("")}
      ${l.bullets&&l.bullets.length?`<ul>${l.bullets.map(c=>`<li>${b(c)}</li>`).join("")}</ul>`:""}
    </section>
  ...
  `).join(""),n.classList.add("show"),document.body.classList.add("modal-open"))}function Xs(){var e;(e=document.getElementById("learnModalOverlay"))==null||e.classList.remove("show"),document.body.classList.remove("modal-open")}function cy(e){var t,n,s;if(e==="modal:close")return Xs();if(e==="auth:signup"){Xs(),(t=window.openAuth)==null||t.call(window,"signup");return}if(e==="auth:login"){Xs(),(n=window.openAuth)==null||n.call(window,"login");return}if(e.startsWith("topic:"))return ly(e.split(":")[1]);if(e.startsWith("scroll:")){let a=e.split(":")[1];(s=document.getElementById(a))==null||s.scrollIntoView({behavior:"smooth",block:"start"})}}function dy(){Kp||(Kp=!0,document.addEventListener("click",e=>{var s,a;let t=(a=(s=e.target).closest)==null?void 0:a.call(s,"[data-action]");if(!t)return;let n=t.getAttribute("data-action")||"";n&&(e.preventDefault(),cy(n))}))}function Jp(){var l,c,d,u,p;dy(),(l=document.querySelector(".landing-features"))==null||l.setAttribute("id","learn"),(c=document.querySelector(".landing-simple-value"))==null||c.setAttribute("id","use-cases"),(d=document.querySelector(".landing-cta"))==null||d.setAttribute("id","about"),(u=document.querySelector(".landing-tagline"))==null||u.classList.add("tagline-pill");let e=document.querySelector(".landing-stats-strip");e&&(e.classList.add("landing-learn-strip"),e.innerHTML=ay.map(m=>`
    ...
    `).join(""));let t=y("features-grid");t&&(t.innerHTML=oy.map(m=>`
    ...
    `).join(""));let n=document.querySelector(".landing-simple-value"),s=n==null?void 0:n.querySelector("h2");s&&(s.textContent="What you can do with NaluLF");let a=y("value-grid");a&&(a.innerHTML=iy.map(m=>`
    ...
    `)}function Yp(){let e=new IntersectionObserver(t=>t.forEach(n=>{n.isIntersecting&&n.target.classList.add("visible")}),{threshold:.12});document.querySelectorAll(".reveal").forEach(t=>e.observe(t))}function Qp(){let e=document.getElementById("particle-canvas");if(!e)return;let t=e.getContext("2d"),n,s,a=[],o=80,i=120;function r(){n=e.width=window.innerWidth,s=e.height=window.innerHeight}function l(){return{x:Math.random()*n,y:Math.random()*s,vx:(Math.random()-.5)*.4,vy:(Math.random()-.5)*.4,r:Math.random()*1.5+.5,alpha:Math.random()*.5+.1}}function c(){r(),a=Array.from({length:o},l)}function d(){return getComputedStyle(document.body).getPropertyValue("--accent-secondary").trim()||"#ffd700"}function u(){t.clearRect(0,0,n,s);let g=d();for(let h=0;h<a.length;h++)for(let w=h+1;w<a.length;w++){let k=a[h].x-a[w].x,v=a[h].y-a[w].y,x=Math.sqrt(k*k+v*v);x<i&&(t.beginPath(),t.moveTo(a[h].x,a[h].y),t.lineTo(a[w].x,a[w].y),t.strokeStyle=`rgba(255,255,255,${(1-x/i)*.06})`,t.lineWidth=1,t.stroke())}a.forEach(h=>{t.beginPath(),t.arc(h.x,h.y,h.r,0,Math.PI*2),t.fillStyle=`rgba(255,255,255,${h.alpha*.6})`,t.fill()})}function p(){a.forEach(g=>{g.x+=g.vx,g.y+=g.vy,(g.x<0||g.x>n)&&(g.vx*=-1),(g.y<0||g.y>s)&&(g.vy*=-1)})}let m;function f(){p(),u(),m=requestAnimationFrame(f)}c(),f(),document.addEventListener("visibilitychange",()=>{document.hidden?(m&&cancelAnimationFrame(m),m=null):m||f()}),window.addEventListener("resize",()=>{r(),a.forEach(g=>{g.x=Math.min(g.x,n),g.y=Math.min(g.y,s)})}),e.style.cssText=`
    position: fixed; inset: 0;
    width: 100%; height: 100%;
    pointer-events: none;
    z-index: 0; opacity: 0.4;
  `}var Ci=[{label:"\u{1F30A} Live Stream",hint:"Dashboard \u2192 Stream tab",action:()=>En(document.querySelector('[data-tab="stream"]'),"stream")},{label:"\u{1F50D} Inspector",hint:"Dashboard \u2192 Inspector tab",action:()=>En(document.querySelector('[data-tab="inspector"]'),"inspector")},{label:"\u{1F4E1} Network Health",hint:"Dashboard \u2192 Network tab",action:()=>En(document.querySelector('[data-tab="network"]'),"network")},{label:"\u{1F511} Sign In",hint:"Open auth",action:()=>{var e;return(e=window._openAuth)==null?void 0:e.call(window,"login")}},{label:"\u2728 Sign Up",hint:"Create account",action:()=>{var e;return(e=window._openAuth)==null?void 0:e.call(window,"signup")}},{label:"\u{1F3E0} Landing Page",hint:"Go home",action:()=>{var e;return(e=window._goHome)==null?void 0:e.call(window)}},{label:"\u{1F3A8} Cycle Theme",hint:"gold \u2192 cosmic \u2192 starry \u2192",action:()=>{var e;return(e=window._cycleTheme)==null?void 0:e.call(window)}}],Ln=0,Fa=[...Ci];function Mi(e=""){let t=y("cmdkOverlay"),n=y("cmdkInput");!t||!n||(t.classList.add("show"),n.value=e||"",tu(e),n.focus())}function os(){var e;(e=y("cmdkOverlay"))==null||e.classList.remove("show")}function eu(){let e=y("cmdkOverlay"),t=y("cmdkInput");!e||!t||(t.addEventListener("input",()=>tu(t.value)),t.addEventListener("keydown",n=>{n.key==="ArrowDown"&&(n.preventDefault(),Zp(1)),n.key==="ArrowUp"&&(n.preventDefault(),Zp(-1)),n.key==="Enter"&&(n.preventDefault(),py()),n.key==="Escape"&&os()}),e.addEventListener("click",n=>{n.target===e&&os()}))}function tu(e=""){let t=y("cmdkList");if(!t)return;let n=e.toLowerCase().trim();Fa=n?Ci.filter(s=>s.label.toLowerCase().includes(n)||s.hint.toLowerCase().includes(n)):[...Ci],Ln=0,t.innerHTML=Fa.length?Fa.map((s,a)=>`
        <button class="cmdk-item${a===0?" is-active":""}" data-index="${a}">
          <span class="cmdk-label">${b(s.label)}</span>
          <span class="cmdk-hint2">${b(s.hint)}</span>
        </button>`).join(""):'<div class="cmdk-section-label">No results</div>',t.querySelectorAll(".cmdk-item").forEach(s=>{s.addEventListener("click",()=>nu(Number(s.dataset.index)))})}function Zp(e){var n,s,a;let t=De("#cmdkList .cmdk-item");t.length&&((n=t[Ln])==null||n.classList.remove("is-active"),Ln=(Ln+e+t.length)%t.length,(s=t[Ln])==null||s.classList.add("is-active"),(a=t[Ln])==null||a.scrollIntoView({block:"nearest"}))}function nu(e){let t=Fa[e];t&&(os(),t.action())}function py(){nu(Ln)}var Ba=!1;function Li(){let e=X.currentPage,t=X.currentTab,n=e==="dashboard"&&t==="stream",s=e==="dashboard"&&t==="inspector",a=e==="dashboard"&&t==="network";nl(n),$l(s),tc(a)}function su(){Ba||(tl(),kl(),ec(),Dc(),Li(),Ba=!0)}window.openAuth=e=>Ya(e);window.closeAuth=()=>jt();window.showAuthView=e=>Wt(e);window.authKeydown=e=>fr(e);window.submitSignIn=()=>Za();window.submitSignUp=()=>eo();window.refreshCaptcha=()=>er();window.showForgotView=()=>or();window.forgotRestoreFromFile=()=>ir();window.forgotWipeConfirm=()=>rr();window.forgotWipeExecute=()=>lr();window.forgotBackToOptions=()=>cr();window.submitSyncImport=()=>to();window.exportVaultSyncCode=()=>dr();window.syncImportFromFile=()=>pr();window.signupNext=()=>Qa();window.signupBack=()=>Zi();window.logout=()=>ur();window.goHome=()=>pn();window.showLandingPage=()=>pn();window.showDashboard=()=>un();window.showProfile=()=>ja();window.switchTab=(e,t)=>En(e,t);window.runInspect=()=>Gn();window.closeCommandPalette=()=>os();window.setTheme=e=>dn(e);window.cycleTheme=()=>Ua();window.measureLatency=()=>Ts();window.switchProfileTab=e=>pi(e);window.openProfileEditor=()=>yp();window.closeProfileEditor=()=>Fs();window.saveProfileEditor=()=>wp();window.selectAvatar=e=>xp(e);window.selectBanner=e=>kp(e);window.uploadAvatarImage=e=>$p(e);window.removeAvatarImage=()=>Sp();window.uploadBannerImage=e=>Tp(e);window.removeBannerImage=()=>Cp();window.prefSetTheme=e=>jp(e);window.setPrefCurrency=e=>qp(e);window.setPrefNetwork=e=>Vp(e);window.setPrefAutoLock=e=>Gp(e);window.openPublicProfilePreview=()=>Wp();window.exportVaultBackup=()=>Mp();window.logActivity=(e,t)=>gt(e,t);window.toggleWalletDrawer=e=>up(e);window.switchWalletDrawerTab=(e,t)=>mp(e,t);window.cancelOffer=(e,t,n)=>hp(e,t,n);window.fetchBalance=e=>Mn(e);window.setActiveWallet=e=>Oc(e);window.openImportAddressModal=()=>Bp();window.closeImportAddressModal=()=>xi();window.importWatchOnlyWallet=()=>Xp();window.openImportSeedModal=()=>Op();window.closeImportSeedModal=()=>ki();window.executeImportFromSeed=()=>Hp();window.openTokenDetailsModal=(e,t,n)=>zp(e,t,n);window.closeTokenDetailsModal=()=>Up();window.refreshXrplDashboard=()=>es();window.refreshMarketData=()=>ep();window.refreshNftGallery=()=>tp();window.refreshAmmPools=()=>np();window.refreshPoolExplorer=()=>sp();window.loadCustomAmmPool=()=>Vc();window.sendNft=e=>ap(e);window.toggleSeedBackupStatus=()=>ad();window.setDexPair=e=>od(e);window.setDexInterval=e=>id(e);window.setDexChartType=e=>rd(e);window.refreshDexChart=()=>ld();window.setComparePair=e=>kd(e);window.toggleIndicator=(e,t)=>cd(e,t);window.toggleTerminalTheme=()=>Rd();window.toggleChartFullscreen=()=>Dd();window.exportChartPng=()=>Id();window.saveChartLayoutPreset=()=>Bd();window.loadChartLayoutPreset=()=>Xd();window.setIndicatorFromDropdown=e=>$d(e);window.toggleIndicatorMenu=()=>dd();window.toggleChartMoreMenu=()=>pd();window.setIndicatorQuery=e=>ud(e);window.addIndicatorFromMenu=e=>md(e);window.removeIndicator=e=>fd(e);window.openIndicatorSettings=e=>hd(e);window.closeIndicatorSettings=()=>gd();window.applyIndicatorSettings=e=>vd(e);window.resetIndicatorSettings=e=>bd(e);window.copyChartLink=()=>yd();window.toggleThreeEffects=()=>wd();window.setThreeEffects=e=>xd(e);window.setDrawingTool=e=>Sd(e);window.clearAllDrawings=()=>Md();window.addPriceAlert=()=>Td();window.removePriceAlert=e=>Cd(e);window.zoomChartIn=()=>Ld();window.zoomChartOut=()=>Pd();window.panChartLeft=()=>Ed();window.panChartRight=()=>Ad();window.toggleEducationPanel=()=>Nd();window.selectEducationTab=e=>_d(e);window.searchTokens=e=>zd(e);window.lookupIssuedAsset=()=>Qd();window.addTokenToWatchlist=e=>Gd(e);window.removeTokenFromWatchlist=e=>Kd(e);window.openTokenOnChart=e=>Da(e);window.loadToken=e=>Jd(e);window.refreshTokenDiscovery=()=>Yd();window.refreshRecentTransactions=()=>Zd();window.setTokenFilter=(e,t)=>Ud(e,t);window.selectTokenDetails=e=>Vd(e);window.showMoreIssuedTokens=()=>Wd();window.showAllIssuedTokens=()=>jd();window.resetIssuedTokenLimit=()=>qd();window.openWalletCreator=()=>yi();window.closeWalletCreator=()=>Bs();window.wizardNext=()=>Lp();window.wizardBack=()=>Pp();window.selectAlgo=e=>Ep(e);window.selectWalletEmoji=e=>Ap(e);window.selectWalletColor=e=>Np(e);window.toggleSecurityCheck=e=>_p(e);window.revealSeed=()=>Dp();window.copySeed=()=>Ip();window.copyAddress=()=>Fp();window.copyToClipboard=e=>$i(e);window.deleteWallet=e=>dp(e);window.inspectWalletAddr=e=>pp(e);window.openSocialModal=e=>ip(e);window.closeSocialModal=()=>ss();window.saveSocialModal=()=>rp();window.deleteSocial=()=>lp();window.viewSocial=e=>cp(e);window._openAuth=Ya;window._goHome=pn;window._cycleTheme=Ua;window._showProfile=ja;document.addEventListener("DOMContentLoaded",()=>{var e;console.log("\u{1F30A} NaluLF: booting\u2026"),Ji(),pn(),Jp(),Yp(),Qp(),eu(),uy(),window.addEventListener("naluxrp:pagechange",t=>{var s;let n=(s=t==null?void 0:t.detail)==null?void 0:s.pageId;(n==="dashboard"||n==="inspector"||n==="profile")&&su(),Ba&&Li()}),window.addEventListener("naluxrp:tabchange",()=>{Ba&&Li()}),document.addEventListener("keydown",t=>{var s;let n=["INPUT","TEXTAREA"].includes((s=document.activeElement)==null?void 0:s.tagName);if((t.ctrlKey||t.metaKey)&&t.key==="k"){t.preventDefault(),Mi();return}if(t.key==="/"&&!n){t.preventDefault(),Mi();return}t.key==="Escape"&&(os(),jt(),Fs(),Bs(),ss())}),(e=document.getElementById("auth-overlay"))==null||e.addEventListener("click",t=>{t.target===t.currentTarget&&jt()}),mr()&&(su(),un(),import("./xrpl-6AERZ5KD.js").then(({connectXRPL:t})=>t())),console.log("\u2705 NaluLF: ready")});function uy(){ou(),setInterval(()=>{document.hidden||ou()},3e4)}async function au(e){let t=[s=>`https://corsproxy.io/?${encodeURIComponent(s)}`,s=>`https://api.allorigins.win/raw?url=${encodeURIComponent(s)}`],n=async s=>{let a=typeof(AbortSignal==null?void 0:AbortSignal.timeout)=="function"?AbortSignal.timeout(7e3):void 0,o=await fetch(s,{mode:"cors",cache:"no-store",signal:a});if(!o.ok)throw new Error(`HTTP ${o.status}`);return await o.json()};try{return await n(e)}catch{for(let s of t)try{return await n(s(e))}catch{}throw new Error("Price feed unreachable")}}async function ou(){try{let e=await au("https://api.exchange.coinbase.com/products/XRP-USD/ticker"),t=await au("https://api.exchange.coinbase.com/products/XRP-USD/candles?granularity=86400");if(e!=null&&e.price){let n=Number(e.price),s=Array.isArray(t)&&t.length?t[0]:null,a=s?Number(s[3]||n):n,o=a?(n-a)/a*100:0,i=document.getElementById("xrpPrice"),r=document.getElementById("xrpChange");if(i&&(i.textContent=`$${Number(n).toFixed(3)}`),r){let l=o>=0;r.textContent=`${l?"+":""}${Number(o).toFixed(2)}%`,r.className=`xrp-price-change ${Math.abs(o)<.1?"flat":l?"up":"down"}`}}}catch{}}
