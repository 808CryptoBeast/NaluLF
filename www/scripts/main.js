import{a as Rr,b as bo,c as Tn,d as It,e as w,f as Be,g as y,h as Xe,i as _,j as W,k as Q,l as Z,m as vt,n as ve,o as ae,p as ge,q as Wt,r as X,s as ma,v as Ae,w as _r}from"./chunk-R7KFE7J7.js";function Cn(e){Tn.includes(e)||(e="gold"),X.currentTheme=e,Tn.forEach(t=>document.body.classList.remove(`theme-${t}`)),document.body.classList.add(`theme-${e}`),Z(bo,e)}function yo(){let e=Tn.indexOf(X.currentTheme);Cn(Tn[(e+1)%Tn.length])}function Dr(){let e=Q(bo);Cn(Tn.includes(e)?e:"gold")}var Ir={landing:"landing-page",dashboard:"dashboard",inspector:"inspector",profile:"dashboard"};function wo(e){document.body.classList.remove("modal-open"),Object.values(Ir).forEach(i=>document.body.classList.remove(i)),document.body.classList.add(Ir[e]||"dashboard");let t=w("landing"),n=w("dashboard"),s=w("profile-page");t&&(t.style.display=e==="landing"?"":"none"),n&&(n.style.display=e==="dashboard"?"":"none"),s&&(s.style.display=e==="profile"?"":"none");let a=e==="landing",o={landingActions:w("navbar-landing-actions"),dashActions:w("navbar-dash-actions"),navConn:w("navbar-conn"),cmdkHint:w("cmdk-hint"),helpBtn:w("help-trigger")};o.landingActions&&(o.landingActions.style.display=a?"":"none"),o.dashActions&&(o.dashActions.style.display=a?"none":""),o.navConn&&(o.navConn.style.display=a?"none":""),o.cmdkHint&&(o.cmdkHint.style.display=a?"none":""),o.helpBtn&&(o.helpBtn.style.display=a?"none":""),X.currentPage=e,window.scrollTo({top:0,behavior:"smooth"}),window.dispatchEvent(new CustomEvent("naluxrp:pagechange",{detail:{pageId:e}}))}function Pn(){wo("landing")}function Mn(){wo("dashboard")}function xo(){wo("profile")}function Ln(e,t){Be(".dash-tab").forEach(n=>{n.classList.toggle("active",n===e),n.setAttribute("aria-selected",String(n===e))}),["stream","inspector","network"].forEach(n=>{let s=w(`tab-${n}`);s&&(s.style.display=n===t?"":"none")}),t==="inspector"?(document.body.classList.remove("dashboard"),document.body.classList.add("inspector")):(document.body.classList.remove("inspector"),document.body.classList.add("dashboard")),X.currentTab=t,window.dispatchEvent(new CustomEvent("naluxrp:tabchange",{detail:{tabId:t}}))}var Or="naluxrp_tour_seen",an=[{title:"Welcome to NaluLF \u{1F30A}",body:"A 20-second tour of the three things people miss most. Skip anytime."},{selector:"#cmdk-hint",title:"Jump anywhere, instantly",body:"Press <kbd>Ctrl</kbd>+<kbd>K</kbd> (or <kbd>/</kbd>) from any page. Paste an address in and it offers to inspect it directly \u2014 no need to navigate first."},{selector:"#dash-tab-inspector",title:"Inspect any wallet",body:"Full forensic suite \u2014 trust lines, fund flow, convergence signals, AI-assisted explanations \u2014 for any XRPL address, not just your own."},{selector:".user-chip",title:"Your Profile has more than wallets",body:"Portfolio analytics, activity history, and Project Intelligence \u2014 liquidity depth, holder concentration, and issuer-risk scoring for any token \u2014 all live there."}],nt=0,$o=!1,Cs=null,Ft=null;function Br(){Q(Or)||setTimeout(So,700)}function So(){$o||($o=!0,nt=0,xm(),To())}function xm(){if(w("tourOverlay"))return;let e=document.createElement("div");e.id="tourOverlay",e.className="tour-overlay",e.innerHTML='<div class="tour-card" id="tour-card"></div>',document.body.appendChild(e),e.addEventListener("click",t=>{t.target===e&&fa()})}function ko(e){if(!e)return null;let t=document.querySelector(e);if(!t)return null;let n=t.getBoundingClientRect();return n.width>0||n.height>0?t:null}function Xr(){Cs==null||Cs.classList.remove("tour-highlight"),Cs=null}function To(){for(;nt<an.length&&an[nt].selector&&!ko(an[nt].selector);)nt++;if(nt>=an.length)return Co();let e=an[nt],t=w("tourOverlay"),n=w("tour-card");t.classList.add("show"),Xr();let s=ko(e.selector);s&&(s.scrollIntoView({block:"center",behavior:"smooth"}),s.classList.add("tour-highlight"),Cs=s),n.innerHTML=`
    ...
    </div>`}function j(){var h,g;let e=document.querySelector("#profile-page .profile-wrap");if(!e)return;let t=document.getElementById("xpd-tv-widget"),n=!!(t&&ee.chart);t&&t.remove();let s=document.getElementById("xpd-chart-atmosphere"),a=!!(s&&Ve.renderer);s&&s.remove();let o=Et(),i=(o==null?void 0:o.address)||"",r=hf(),l=localStorage.getItem(pn),c=le.some(x=>!x.watchOnly),p=Q(jo)==="1",u=(h=Ye[i])==null?void 0:h.xrp,d=Object.values(Ye).reduce((x,k)=>x+((k==null?void 0:k.xrp)||0),0),m=(g=Pe.data)!=null&&g.priceUsd?d*Pe.data.priceUsd:0,f=In.map(x=>`<option value="${y(x.id)}" ${M.pair===x.id?"selected":""}>${y(x.label)}</option>`).join(""),v=In.map(x=>`<option value="${y(x.id)}" ${M.comparePair===x.id?"selected":""}>${y(x.label)}</option>`).join(""),b=zl.map(x=>`<option value="${y(x.value)}" ${M.interval===x.value?"selected":""}>${y(x.label)}</option>`).join("");if(e.innerHTML=`
              ...
              <div class="xpd-chart-toolbar">
                ...
                <div class="xpd-toolbar-group">
                  ...
                  <select class="xpd-input" onchange="setDrawingTool(this.value)">
                    ${Wl.map(x=>`<option value="${x.key}" ${M.drawingTool===x.key?"selected":""}>Draw: ${x.label}</option>`).join("")}
                  </select>
    ...
    </div>`,n){let x=document.getElementById("xpd-tv-widget");x&&x.replaceWith(t)}if(a){let x=document.getElementById("xpd-chart-atmosphere");x&&x.replaceWith(s)}vh(),_h(),Dh(),fi(),Os()}function hf(){let e=String(X.currentNetwork||"").toLowerCase();return e.includes("testnet")?{label:"XRPL Testnet",kind:"testnet"}:e.includes("mainnet")?{label:"XRPL Mainnet",kind:"mainnet"}:e.includes("xahau")?{label:"Xahau Network",kind:"xahau"}:{label:`Network: ${y(X.currentNetwork||"Unknown")}`,kind:"unknown"}}function gf(){let e=String(M.indicatorQuery||"").trim().toLowerCase(),t=[{key:"trend",label:"Trend",icon:"\u{1F4C8}"},{key:"momentum",label:"Momentum",icon:"\u26A1"},{key:"volume",label:"Volume",icon:"\u{1F4CA}"},{key:"volatility",label:"Volatility",icon:"\u{1F32A}\uFE0F"},{key:"advanced",label:"Custom",icon:"\u{1F9E0}"}];return`
    <div class="xpd-indicator-menu-wrap">
      ...
      ${M.indicatorMenuOpen?`
        <div class="xpd-indicator-menu" role="menu" aria-label="Indicator menu">
          ...
          ${t.map(n=>{let s=(sf[n.key]||[]).filter(a=>{var i;return e?(((i=qt[a])==null?void 0:i.name)||a).toLowerCase().includes(e):!0});return s.length?`
    ...
    <p class="xpd-note">Professional chart controls: wheel zoom, hold-and-drag pan, horizontal price-line marking, and token-focused context ribbons for faster execution decisions.</p>`}function bf(){let e=M.selectedIndicator||"sma20",t=qt[e]||qt.sma20,n=af[e]||null,s=M.educationCollapsed;return`
    <div class="xpd-edu-panel ${s?"collapsed":""}">
      ...
      ${s?"":`
        ...
        `:""}
      `}
    </div>`}function ct(e,t){return`<div class="xpd-edu-row"><span class="xpd-edu-label">${y(e)}</span><span class="xpd-edu-value">${y(t)}</span></div>`}function yf(){if(Pe.loading)return'<div class="xpd-loading">Loading XRP market snapshot...</div>';if(Pe.error)return`<div class="xpd-error">${y(Pe.error)}</div>`;let e=Pe.data;if(!e)return'<div class="xpd-empty">Market data is not available yet.</div>';let t=e.change24h>=0;return`
    ...
    <div class="xpd-token-strip">
      ${nf.map(n=>`<div class="xpd-token-pill" title="${y(`${n.symbol} ${n.name}`)}"><span class="sym xpd-pill-text">${n.symbol}</span><span class="xpd-pill-text">${y(n.name)}</span><span class="cap xpd-pill-text">${n.marketCap}</span></div>`).join("")}
    </div>
    <p class="xpd-note">Top XRPL token cards are static examples when direct DEX market-cap feeds are unavailable.</p>`}function wf(e){return e?bt.loading?'<div class="xpd-loading">Loading account NFTs...</div>':bt.error?`<div class="xpd-error">${y(bt.error)}</div>`:bt.items.length?`<div class="xpd-nft-grid">${bt.items.map(xf).join("")}</div>`:'<div class="xpd-empty">No NFTs found for this wallet.</div>':'<div class="xpd-empty">Select or create a wallet to load NFTs.</div>'}function xf(e){let t=`${e.id.slice(0,12)}...${e.id.slice(-10)}`;return`<article class="xpd-nft-card">
  ...
  </article>`}function kf(e){let t=Af(e),n=Ef(),s=Nf();return`<div class="xpd-amm-columns">${t}${n}${s}</div>`}function li(){return(ve(Q(Bl))||[]).filter(Boolean)}function Kl(e){let t=[...new Set((e||[]).filter(Boolean))];Z(Bl,JSON.stringify(t))}function $f(e,t){return t.has(e)?t.get(e):U.tokens.find(s=>s.symbol===e)||null}function Sf(){let e=U.query||"",t=li(),n=U.filtered,s=Math.max(120,Number(U.listLimit||240)),a=n.slice(0,s),o=U.trending.slice(0,14),i=new Map(U.tokens.map(c=>[Ue(c),c])),r=i.get(U.selectedTokenKey)||null,l=U.filters||{type:"all",minCap:0,minVol:0,hasDex:!1};return`
    <div class="xpd-token-grid">
        ...
        <div class="xpd-token-list">${a.map(c=>{let p=Ue(c),u=Ps(p),d=String(e||"").trim();return`
          <div class="xpd-token-row xpd-token-row--clickable" title="${y(`${c.symbol} ${c.name}`)}" onclick="openTokenOnChart(decodeURIComponent('${u}'))">
            <div class="xpd-token-main">
              <strong>${xl(c.symbol,d)}</strong>
              <span>${xl(c.name,d)}</span>
    ...
    </div>`}function Jl(){let e=document.getElementById("xpd-lookup-currency");if(!e){ge("Token Discovery hasn't loaded yet \u2014 give it a moment and try again.");return}e.scrollIntoView({behavior:"smooth",block:"center"}),setTimeout(()=>e.focus(),350)}async function ci(e){let t=String(e||"").trim();if(!t)return;let n=t.includes("|")?U.tokens.find(s=>Ue(s)===t):U.tokens.find(s=>String(s.symbol||"").toUpperCase()===t.toUpperCase());if(!(n!=null&&n.issuer)){ge("Project Intelligence needs a token with a known issuer.");return}Je={loading:!0,error:"",data:null,tokenKey:Ue(n),expandedSubScore:""},j(),setTimeout(()=>{var s;return(s=document.getElementById("xpd-project-intel-section"))==null?void 0:s.scrollIntoView({behavior:"smooth",block:"start"})},30);try{Je={loading:!1,error:"",data:await ul(n),tokenKey:Ue(n),expandedSubScore:""}}catch(s){Je={loading:!1,error:(s==null?void 0:s.message)||"Could not load project intelligence.",data:null,tokenKey:Ue(n),expandedSubScore:""}}j()}function Yl(e){Je.expandedSubScore=Je.expandedSubScore===e?"":e,j()}function Ql(){Je={loading:!1,error:"",data:null,tokenKey:"",expandedSubScore:""},j()}var Zl={liquidity:{label:"Liquidity",icon:"\u{1F4A7}"},distribution:{label:"Distribution",icon:"\u{1F9EE}"},marketQuality:{label:"Market Quality",icon:"\u{1F4CA}"},lpStability:{label:"LP Stability",icon:"\u{1F3E6}"},issuerRisk:{label:"Issuer Risk",icon:"\u{1F6E1}"}};function Ho(e){return e>=75?"#50fa7b":e>=50?"#f1fa8c":e>=25?"#ffb86c":"#ff5555"}function ec(e){return e>=75?"STRONG":e>=50?"MODERATE":e>=25?"WEAK":"VERY WEAK"}function Tf(){if(Je.loading)return`<div class="xpd-section-head"><h2>\u{1F52C} Project Intelligence</h2></div>
      ...
      <div class="xpd-error">${y(Je.error)}</div>`;let e=Je.data;if(!e)return"";let t=e.strength,n=Ho(t.overall),s=t.dimensionsLive.map(a=>{let o=Zl[a],i=t.subScores[a],r=Je.expandedSubScore===a;return`
      <div class="pi-subscore ${r?"pi-subscore--open":""}" onclick="toggleProjectIntelSubScore('${a}')">
        ...
        ${r?`<div class="pi-subscore-detail">${Object.entries(i.inputs).map(([l,c])=>`
          <div class="pi-kv"><span>${y(di(l))}</span><span class="mono">${y(tc(c))}</span></div>
        `).join("")}</div>`:""}
      </div>`}).join("");return`
    <div class="xpd-section-head">
    ...
    <div class="pi-header-card">
      ...
      <div class="pi-score-word" style="color:${n}">${ec(t.overall)}</div>
    ...
    <div class="pi-cards-grid">
      ${Cf(e)}
      ${bl("Holder Concentration",e.holders,"\u{1F465}")}
      ${bl("LP Token Concentration",e.lp,"\u{1F3E6}")}
      ${Pf(e.issuerRisk)}
    </div>`}function di(e){return e.replace(/([A-Z])/g," $1").replace(/^./,t=>t.toUpperCase()).trim()}function tc(e){return e==null?"\u2014":typeof e=="boolean"?e?"Yes":"No":typeof e=="number"?Number.isInteger(e)?String(e):_(e,2):String(e)}function Cf(e){var i;let t=e.amm,n=e.orderBook,s=t!=null&&t.exists?`
  ...
  `:'<div class="inspect-empty-note">No live order book found for this pair.</div>';return`
    <div class="sec-card pi-card">
      ...
      <hr class="pi-hr" />
      ${o}
    </div>`}function bl(e,t,n){if(!(t!=null&&t.exists))return`
    <div class="sec-card pi-card">
    ...
    </div>`}function nc(){let e=Je.data;e&&Ia(Mf(e))}function yl(e,t){if(!(e!=null&&e.length))return"";let n=e.map(s=>`    ${s.pct}% impact: ${_(s.xrpAtOffer,1)} XRP / ${We(s.tokenAtOffer)} tokens${s.bookExhausted?" (book exhausted before this level \u2014 real depth may be less than shown)":""}`).join(`
`);return`  ${t}:
${n}`}function wl(e,t){let n=[`${e}:`];return t!=null&&t.exists?(n.push(`  Holder count: ${t.holderCount}${t.sampleOnly?" (sampled, capped)":""}`),n.push(`  Top 1 holds: ${_(t.top1Pct,1)}%`),n.push(`  Top 5 hold: ${_(t.top5Pct,1)}%`),n.push(`  Top 10 hold: ${_(t.top10Pct,1)}%`),(t.topHolders||[]).slice(0,10).forEach((s,a)=>{let o=t.totalSampled>0?_(s.balance/t.totalSampled*100,2):"0.00";n.push(`    #${a+1} ${s.address}: ${We(s.balance)} (${o}%)`)}),n.join(`
`)):(n.push("  No data found."),n.join(`
`))}function Mf(e){var i;let t=e.strength,n=e.amm,s=e.orderBook,a=e.issuerRisk,o=[];if(o.push(`XRPL TOKEN ANALYSIS \u2014 ${e.token.symbol}${e.token.name?` (${e.token.name})`:""}`),o.push(`Issuer: ${e.token.issuer}`),o.push(`Currency code: ${e.token.currency}`),o.push(`Snapshot taken: ${new Date(e.fetchedAt).toISOString()}`),o.push(""),o.push(`OVERALL STRENGTH SCORE: ${t.overall}/100 (${ec(t.overall)})`),o.push("Methodology note: this score covers only 5 point-in-time-computable dimensions (Liquidity, Distribution, Market Quality, LP Stability, Issuer Risk). Network Activity, Treasury Health, and Project Transparency are NOT included \u2014 they would require historical tracking this tool does not do."),o.push(""),o.push("SUB-SCORES:"),t.dimensionsLive.forEach(r=>{let l=Zl[r],c=t.subScores[r];o.push(`- ${l.label}: ${c.score}/100`),Object.entries(c.inputs||{}).forEach(([p,u])=>{o.push(`    ${di(p)}: ${tc(u)}`)})}),o.push(""),o.push("LIQUIDITY \u2014 AMM POOL:"),n!=null&&n.exists?(o.push(`  XRP reserve: ${_(n.xrpReserve,2)}`),o.push(`  Token reserve: ${_(n.tokenReserve,2)}`),o.push(`  LP token supply: ${_(n.lpSupply,2)}`),o.push(`  Trading fee: ${_(n.tradingFeePct,3)}%`),n.auctionSlot&&o.push(`  Auction slot discounted fee: ${_(n.auctionSlot.discountedFeePct,3)}%`),(i=n.voteSlots)!=null&&i.length&&o.push(`  Fee-vote participants: ${n.voteSlots.length}`)):o.push("  No AMM pool found for this pair."),o.push(""),o.push("LIQUIDITY \u2014 LIVE ORDER BOOK (DEX):"),s!=null&&s.exists){o.push(`  Buy price: ${_(s.buyPriceXrp,6)} XRP`),o.push(`  Sell price: ${_(s.sellPriceXrp,6)} XRP`),o.push(`  Spread: ${s.spreadPct!=null?_(s.spreadPct,2)+"%":"\u2014"}`);let r=yl(s.buyDepth,"Depth buying with XRP"),l=yl(s.sellDepth,"Depth selling for XRP");r&&o.push(r),l&&o.push(l)}else o.push("  No live order book found for this pair.");return o.push(""),o.push(wl("HOLDER CONCENTRATION",e.holders)),o.push(""),o.push(wl("LP TOKEN CONCENTRATION",e.lp)),o.push(""),o.push("ISSUER RISK FLAGS:"),a!=null&&a.exists?(o.push(`  Clawback enabled: ${a.clawbackEnabled?"YES":"No"} \u2014 ${xt.clawbackEnabled}`),o.push(`  Global freeze active: ${a.globalFreeze?"YES":"No"} \u2014 ${xt.globalFreeze}`),o.push(`  Freeze-capable: ${a.freezeCapable?"YES":"No"} \u2014 ${xt.freezeCapable}`),o.push(`  Requires auth to hold: ${a.requireAuth?"YES":"No"} \u2014 ${xt.requireAuth}`),o.push(`  Issuer blackholed: ${a.blackholed?"YES":"No"} \u2014 ${xt.blackholed}`)):o.push("  Could not load issuer account state."),o.push(""),o.push("---"),o.push("Please analyze this XRPL token's on-chain data above. Explain in plain language what these metrics suggest about the token's liquidity health, holder/LP concentration risk, and issuer-side control risk. Point out anything that looks like a red flag or an unusually strong/weak signal, and note any limits in what this data can and can't tell me (e.g. it's a point-in-time snapshot, not history)."),o.join(`
`)}function xl(e,t){let n=String(e||""),s=String(t||"").trim();if(!s)return y(n);let a=n.toLowerCase().indexOf(s.toLowerCase());if(a<0)return y(n);let o=y(n.slice(0,a)),i=y(n.slice(a,a+s.length)),r=y(n.slice(a+s.length));return`${o}<mark class="xpd-hit">${i}</mark>${r}`}function Lf(e){var a,o;let t=Object.values(Ye).reduce((i,r)=>i+((r==null?void 0:r.xrp)||0),0),n=(a=Pe.data)!=null&&a.priceUsd?t*Pe.data.priceUsd:0,s=Pt.items.slice(0,8);return`
    <div class="xpd-token-grid">
      <div class="xpd-token-col">
        <div class="xpd-market-grid">
          ...
          <article class="xpd-stat-card"><span class="xpd-stat-label">Wallets</span><strong class="xpd-stat-value">${le.length}</strong></article>
    ...
    </div>`}function Af(e){return e?yt.loading?'<div class="xpd-amm-card"><h3>Your liquidity positions</h3><div class="xpd-loading">Loading account_objects and LP balances...</div></div>':yt.error?`<div class="xpd-amm-card"><h3>Your liquidity positions</h3><div class="xpd-error">${y(yt.error)}</div></div>`:yt.pools.length?`<div class="xpd-amm-card"><h3>Your liquidity positions</h3><div class="xpd-pool-list">${yt.pools.map(t=>`
    ...
    </div>`).join("")}</div></div>`:'<div class="xpd-amm-card"><h3>Your liquidity positions</h3><div class="xpd-empty">No AMM entries or LP-token balances detected for this wallet yet.</div></div>':'<div class="xpd-amm-card"><h3>Your liquidity positions</h3><div class="xpd-empty">No active wallet.</div></div>'}function Ef(){return Mt.loading?'<div class="xpd-amm-card"><h3>General pool explorer</h3><div class="xpd-loading">Loading amm_info for known pools...</div></div>':Mt.error?`<div class="xpd-amm-card"><h3>General pool explorer</h3><div class="xpd-error">${y(Mt.error)}</div></div>`:Mt.pools.length?`<div class="xpd-amm-card"><h3>General pool explorer</h3><div class="xpd-pool-list">${Mt.pools.map(e=>`
    <div class="xpd-pool-item">
    ...
    ${De.pool?`<div class="xpd-pool-item">
      ...
      <div class="xpd-pool-row"><span class="xpd-pool-row-label">TVL</span><span class="xpd-pool-row-value">${y(De.pool.tvl||"Unavailable")}</span></div>
  ...
  </div>`}function We(e){return Number.isFinite(Number(e))?new Intl.NumberFormat("en-US",{notation:"compact",maximumFractionDigits:2}).format(Number(e)):"\u2014"}function ns(e){return typeof e=="string"?`${_(Number(e)/1e6,4)} XRP`:e&&typeof e=="object"?`${_(Number(e.value||0),4)} ${e.currency||"UNK"}`:"\u2014"}function Rf(e){if(!e||typeof e!="string")return"";try{let t=e.trim();if(!/^[0-9A-Fa-f]+$/.test(t)||t.length%2!==0)return t;let n=new Uint8Array(t.length/2);for(let s=0;s<t.length;s+=2)n[s/2]=parseInt(t.slice(s,s+2),16);return new TextDecoder().decode(n)}catch{return""}}function kl(e){return e?e.startsWith("ipfs://")?`https://ipfs.io/ipfs/${e.slice(7)}`:e.startsWith("ar://")?`https://arweave.net/${e.slice(5)}`:e:""}async function _f(e){let t=kl(Rf(e.URI||e.uri||""));if(!t)return"";if(/\.(png|jpg|jpeg|gif|webp|svg)$/i.test(t))return t;try{let n=await fetch(t,{method:"GET"});if(!n.ok)return"";let s=await n.json(),a=(s==null?void 0:s.image)||(s==null?void 0:s.image_url)||(s==null?void 0:s.thumbnail);return kl(a||"")}catch{return""}}async function Lt(e,{timeoutMs:t=9e3,allowProxy:n=!0}={}){let s=async a=>{let o=typeof(AbortSignal==null?void 0:AbortSignal.timeout)=="function"?AbortSignal.timeout(t):void 0,i=await fetch(a,{method:"GET",mode:"cors",cache:"no-store",signal:o});if(!i.ok)throw new Error(`HTTP ${i.status}`);return await i.json()};try{return await s(e)}catch(a){if(!n)throw a;for(let o of Xm)try{return await s(o(e))}catch{}throw a}}async function sc(){var e;Pe.loading=!0,Pe.error="",j();try{let t=await Lt("https://api.exchange.coinbase.com/products/XRP-USD/ticker"),n=await Lt("https://api.exchange.coinbase.com/products/XRP-USD/candles?granularity=86400"),s=Array.isArray(n)&&n.length?n[0]:null,a=Number((t==null?void 0:t.price)||0),o=s?Number(s[3]||0):a,i=s?Number(s[2]||a):a,r=s?Number(s[1]||a):a,l=s?Number(s[5]||0):0;Pe.data={priceUsd:a,change24h:o?(a-o)/o*100:0,volume24h:l*a,marketCap:Number(((e=Pe.data)==null?void 0:e.marketCap)||0),high24h:i,low24h:r}}catch(t){Pe.error=(t==null?void 0:t.message)||"Could not load market data right now.",Pe.data=null}finally{Pe.loading=!1,j()}}async function ac(e){if(bt.loading=!0,bt.error="",bt.items=[],j(),!e){bt.loading=!1,j();return}try{let t,n=[];do{let a=await st({method:"account_nfts",params:[{account:e,limit:100,...t?{marker:t}:{}}]});n.push(...(a==null?void 0:a.account_nfts)||[]),t=a==null?void 0:a.marker}while(t);let s=await Promise.all(n.slice(0,80).map(async a=>({id:a.NFTokenID||a.nf_token_id||"Unknown",image:await _f(a)})));bt.items=s}catch(t){bt.error=(t==null?void 0:t.message)||"Could not load NFTs for this wallet."}finally{bt.loading=!1,j()}}async function oc(e){if(yt.loading=!0,yt.error="",yt.pools=[],j(),!e){yt.loading=!1,j();return}try{let t=[],n;do{let o=await st({method:"account_objects",params:[{account:e,type:"amm",limit:200,...n?{marker:n}:{}}]});((o==null?void 0:o.account_objects)||[]).forEach(r=>{let l=ns(r.Asset||r.amount),c=ns(r.Asset2||r.amount2),p=l.split(" ").pop()||"AssetA",u=c.split(" ").pop()||"AssetB";t.push({pair:`${p}/${u}`,lpBalance:r.LPTokenBalance?ns(r.LPTokenBalance):"Not reported",estimatedValue:"Estimate unavailable",tradingFee:r.TradingFee!=null?`${r.TradingFee} bps`:"\u2014",tvl:"Unavailable"})}),n=o==null?void 0:o.marker}while(n);let s=await st({method:"account_lines",params:[{account:e,limit:200}]});((s==null?void 0:s.lines)||[]).filter(o=>typeof o.currency=="string"&&o.currency.length>=16&&Number(o.balance)>0).forEach(o=>{t.push({pair:`LP Token ${o.currency.slice(0,8)}...`,lpBalance:`${_(Number(o.balance),4)} ${o.currency.slice(0,8)}...`,estimatedValue:"Estimate unavailable",tradingFee:"\u2014",tvl:"Unavailable"})}),yt.pools=t}catch(t){yt.error=(t==null?void 0:t.message)||"Could not load account AMM objects."}finally{yt.loading=!1,j()}}async function ic(e){try{let t=await st({method:"amm_info",params:[{asset:e.asset,asset2:e.asset2}]}),n=t==null?void 0:t.amm;return n?{label:e.label,reserveA:ns(n.amount),reserveB:ns(n.amount2),tradingFee:String(n.trading_fee??"\u2014"),totalLp:ns(n.lp_token||n.lp_token_balance),tvl:Df(n.amount,n.amount2)}:null}catch{return null}}function Df(e,t){let n=a=>typeof a=="string"?Number(a)/1e6:a&&typeof a=="object"?Number(a.value||0):0,s=n(e)+n(t);return!Number.isFinite(s)||s<=0?"Unavailable":`${_(s,4)} (asset units)`}async function rc(){Mt.loading=!0,Mt.error="",j();try{let e=await Promise.all(rf.map(ic));Mt.pools=e.filter(Boolean)}catch(e){Mt.error=(e==null?void 0:e.message)||"Could not load AMM explorer data.",Mt.pools=[]}finally{Mt.loading=!1,j()}}async function lc(){var r,l,c,p;let e=(((r=document.getElementById("xpd-asset1-currency"))==null?void 0:r.value)||"").trim().toUpperCase(),t=(((l=document.getElementById("xpd-asset1-issuer"))==null?void 0:l.value)||"").trim(),n=(((c=document.getElementById("xpd-asset2-currency"))==null?void 0:c.value)||"").trim().toUpperCase(),s=(((p=document.getElementById("xpd-asset2-issuer"))==null?void 0:p.value)||"").trim();if(!e||!n){De.error="Enter both asset currency codes first.",j();return}let a=e==="XRP"?{currency:"XRP"}:{currency:e,issuer:t},o=n==="XRP"?{currency:"XRP"}:{currency:n,issuer:s};if(e!=="XRP"&&!t||n!=="XRP"&&!s){De.error="Issuer is required for non-XRP assets.",j();return}De.loading=!0,De.error="",De.pool=null,j();let i=await ic({label:`${e}/${n}`,asset:a,asset2:o});De.loading=!1,i?De.pool=i:De.error="Pool not found or unavailable on this network.",j()}function Ea(){return In.find(e=>e.id===M.pair)||In[0]}function pi(e){if(e==="D")return 1440;if(e==="W")return 10080;if(e==="M")return 43200;let t=Number(e);return Number.isFinite(t)&&t>0?t:60}function If(e){if(e==="M")return"W";if(e==="D"||e==="W")return e;let t=pi(e);for(let n of[5,15,60,240])if(t<=n)return String(n);return"D"}async function Ff(e,t,n,s=200){var p;let a=t?`${e}.${t}`:e,o=If(n),i=Math.min(2e3,Math.max(20,Number(s)||200)),r=`https://api.onthedex.live/public/v1/ohlc?base=${encodeURIComponent(a)}&quote=XRP&interval=${o}&bars=${i}`,l=await Lt(r,{timeoutMs:1e4});return(Array.isArray((p=l==null?void 0:l.data)==null?void 0:p.ohlc)?l.data.ohlc:[]).map(u=>({time:Number(u.t),open:Number(u.o),high:Number(u.h),low:Number(u.l),close:Number(u.c),volume:Number(u.vb||0)})).filter(u=>Number.isFinite(u.time)&&[u.open,u.high,u.low,u.close].every(Number.isFinite)).sort((u,d)=>u.time-d.time)}function cc(e){return{xrpusd:"XRP-USD",XRPUSDT:"XRP-USD",ETHUSDT:"ETH-USD",BTCUSDT:"BTC-USD",SOLUSDT:"SOL-USD"}[e]||null}function Of(e){return{XRP:"XRP-USD",BTC:"BTC-USD",ETH:"ETH-USD",SOL:"SOL-USD",USDC:"USDC-USD"}[String(e||"").toUpperCase()]||null}var zo=new Map;async function Bf(e,t){if(!e)return null;let n=`${Ue(e)}:${t}`,s=zo.get(n);if(s)return s;let a=Xf(e,t);zo.set(n,a);try{return await a}finally{zo.delete(n)}}async function Xf(e,t){var o,i;let n=String(e.symbol||"").toUpperCase();if(!n||n==="XRP")return null;let s=Of(n);if(s)try{let r=uc(t),l=r===86400?Fl:Ol,{candles:c,reachedStart:p}=await Yo(s,r,l);if(c.length){let u=p?`${new Date(c[0].time*1e3).getUTCFullYear()}\u2013present`:`last ${c.length} bars`;return{candles:c,source:`Coinbase direct (${s}, ${u})`,mode:"token-direct"}}}catch{}let a=String(e.issuer||"").trim();if(a)try{let r=await Ff(n,a,t,2e3);if(r.length){let l=Number(((o=M.stats)==null?void 0:o.xrplSpot)||((i=M.stats)==null?void 0:i.price)||0);return{candles:l>0?r.map(p=>({time:p.time,open:p.open*l,high:p.high*l,low:p.low*l,close:p.close*l,volume:p.volume})):r,source:`OnTheDex XRPL DEX (${n}/XRP)`,mode:"token-direct"}}}catch{}return null}function Hf(e,{mode:t="pair",source:n="Source pending",tokenKey:s=""}={}){let a=Array.isArray(e)?e:[];if(!a.length){M.chartMeta={tokenKey:s||M.tokenFocusKey||"XRP|",symbol:s&&s.split("|")[0]||"XRP",source:n,last:null,high:null,low:null,mode:t};return}let o=a[a.length-1],i=a.map(c=>Number(c.high)).filter(c=>Number.isFinite(c)),r=a.map(c=>Number(c.low)).filter(c=>Number.isFinite(c)),l=s||M.tokenFocusKey||"XRP|";M.chartMeta={tokenKey:l,symbol:l.split("|")[0]||"XRP",source:n,last:Number(o.close),high:i.length?Math.max(...i):Number(o.high),low:r.length?Math.min(...r):Number(o.low),mode:t}}async function Is(){var t;let e=Ea();M.loading=!0,M.error="";try{let n=cc(e.ticker);if(n){let s=await Lt(`https://api.exchange.coinbase.com/products/${n}/ticker`),a=await Lt(`https://api.exchange.coinbase.com/products/${n}/candles?granularity=86400`),o=Array.isArray(a)&&a.length?a[0]:null,i=Number(s.price||0),r=o?Number(o[3]):i;M.stats={price:i,high:o?Number(o[2]):i,low:o?Number(o[1]):i,changePct:r?(i-r)/r*100:0,baseSource:"Coinbase",source:"Coinbase"},await dc(),!Pe.data&&M.stats.price&&(Pe.data={priceUsd:M.stats.price,change24h:M.stats.changePct,volume24h:o?Number(o[5]||0)*M.stats.price:0,marketCap:Number(((t=Pe.data)==null?void 0:t.marketCap)||0)});return}throw new Error("Chart stats unavailable for selected pair.")}catch(n){M.error=(n==null?void 0:n.message)||"DEX chart stats unavailable right now."}finally{M.loading=!1}}async function dc(){var e,t,n;try{let s=await st({method:"book_offers",params:[{taker_gets:{currency:"USD",issuer:"rhub8VRN55s94qWKDv6jmDy1pUykJzF3wq"},taker_pays:{currency:"XRP"},limit:1}]}),a=(e=s==null?void 0:s.offers)==null?void 0:e[0];if(!a)return;let o=Number(((t=a.TakerGets)==null?void 0:t.value)||0),i=typeof a.TakerPays=="string"?Number(a.TakerPays)/1e6:Number(((n=a.TakerPays)==null?void 0:n.value)||0);if(o>0&&i>0){let r=o/i;if(Il=Date.now(),M.stats||(M.stats={}),M.stats.xrplSpot=r,String(Ea().symbol||"XRP").toUpperCase()==="XRP"){M.stats.price=r;let l=M.stats.baseSource||M.stats.source||"Market feed";M.stats.source=`${l} + XRPL live`,Pe.data&&(Pe.data.priceUsd=r)}}}catch{}}async function zf(){var e,t;return(e=window.LightweightCharts)!=null&&e.createChart?!0:(ka||(ka=new Promise((n,s)=>{let a=document.querySelector('script[data-lw-chart="1"]');if(a){a.addEventListener("load",()=>n(!0),{once:!0}),a.addEventListener("error",()=>s(new Error("Chart library failed to load.")),{once:!0});return}let o=document.createElement("script");o.src="https://unpkg.com/lightweight-charts@4.2.2/dist/lightweight-charts.standalone.production.js",o.async=!0,o.defer=!0,o.dataset.lwChart="1",o.onload=()=>n(!0),o.onerror=()=>s(new Error("Chart library failed to load.")),document.head.appendChild(o)}).finally(()=>{var n;(n=window.LightweightCharts)!=null&&n.createChart||(ka=null)})),await ka,!!((t=window.LightweightCharts)!=null&&t.createChart))}async function Wf(){var e,t;return(e=window.THREE)!=null&&e.Scene?!0:($a||($a=new Promise((n,s)=>{let a=document.querySelector('script[data-three-chart="1"]');if(a){a.addEventListener("load",()=>n(!0),{once:!0}),a.addEventListener("error",()=>s(new Error("Three.js failed to load.")),{once:!0});return}let o=document.createElement("script");o.src="https://unpkg.com/three@0.166.1/build/three.min.js",o.async=!0,o.defer=!0,o.dataset.threeChart="1",o.onload=()=>n(!0),o.onerror=()=>s(new Error("Three.js failed to load.")),document.head.appendChild(o)}).finally(()=>{var n;(n=window.THREE)!=null&&n.Scene||($a=null)})),await $a,!!((t=window.THREE)!=null&&t.Scene))}function Fs(){var e,t;if(Ve.resizeHandler)try{window.removeEventListener("resize",Ve.resizeHandler)}catch{}if(Ve.raf&&cancelAnimationFrame(Ve.raf),(t=(e=Ve.renderer)==null?void 0:e.domElement)!=null&&t.parentElement)try{Ve.renderer.domElement.parentElement.removeChild(Ve.renderer.domElement)}catch{}if(Ve.renderer)try{Ve.renderer.dispose()}catch{}Ve={renderer:null,scene:null,camera:null,points:null,raf:0,host:null,resizeHandler:null}}async function Uf(){var t;let e=document.getElementById("xpd-chart-atmosphere");if(e&&!(Ve.renderer&&e.contains(Ve.renderer.domElement))&&!((navigator.hardwareConcurrency||4)<=3))try{if(await Wf(),!((t=window.THREE)!=null&&t.Scene))return;Fs();let n=window.THREE,s=Math.max(1,e.clientWidth||640),a=Math.max(1,e.clientHeight||460),o=new n.Scene,i=new n.PerspectiveCamera(52,s/a,.1,1e3);i.position.z=46;let r=new n.WebGLRenderer({alpha:!0,antialias:!0});r.setPixelRatio(Math.min(2,window.devicePixelRatio||1)),r.setSize(s,a),e.appendChild(r.domElement);let l=900,c=new Float32Array(l*3);for(let h=0;h<l;h+=1){let g=h*3;c[g]=(Math.random()-.5)*90,c[g+1]=(Math.random()-.5)*40,c[g+2]=(Math.random()-.5)*24}let p=new n.BufferGeometry;p.setAttribute("position",new n.BufferAttribute(c,3));let u=new n.PointsMaterial({color:5101823,size:.25,transparent:!0,opacity:.26,depthWrite:!1}),d=new n.Points(p,u);o.add(d);let m=0,f=0,v=()=>{var T;m+=1;let h=Number(((T=M.stats)==null?void 0:T.changePct)||0),g=Math.min(4,Math.max(.35,Math.abs(h)/2.2)),x=h>0?16758874:16739999;u.color.setHex(Math.abs(h)>1.5?x:5101823),d.rotation.y+=9e-4*g,d.rotation.x=Math.sin(m*.0015*g)*.08,d.position.y=Math.sin(m*.003*g)*.7,(!document.hidden||Date.now()-f>350)&&(r.render(o,i),f=Date.now()),Ve.raf=requestAnimationFrame(v)},b=()=>{let h=Math.max(1,e.clientWidth||640),g=Math.max(1,e.clientHeight||460);i.aspect=h/g,i.updateProjectionMatrix(),r.setSize(h,g)};window.addEventListener("resize",b,{passive:!0}),Ve={renderer:r,scene:o,camera:i,points:d,raf:0,host:e,resizeHandler:b},v()}catch{}}function pc(e){return pi(e)*60}function uc(e){let t=pi(e);return t<=1?60:t<=5?300:t<=15?900:t<=60?3600:t<=360?21600:86400}function mc(){let e=String(M.tokenFocusKey||"");if(!e)return null;let t=e.includes("|")?e.split("|")[0]:e;return U.tokens.find(n=>Ue(n)===e)||U.tokens.find(n=>String(n.symbol||"").toUpperCase()===String(t||"").toUpperCase())||null}function fc(){var a,o;let e=mc(),t=Number((e==null?void 0:e.price)||0);if(Number.isFinite(t)&&t>0)return t;let n=Number(((a=M.stats)==null?void 0:a.xrplSpot)||0);if(Number.isFinite(n)&&n>0)return n;let s=Number(((o=M.stats)==null?void 0:o.price)||0);return Number.isFinite(s)&&s>0?s:1}function hc(e,t=1,n=220){let s=Math.max(60,pc(e)),a=Math.floor(Date.now()/1e3),o=Math.floor(a/s)*s-n*s,i=Math.max(1e-6,Number(t)||1),r=[];for(let l=0;l<n;l+=1){let c=o+l*s,p=i,u=Math.sin((l+1)/9)*.004+Math.cos((l+3)/17)*.002;i=Math.max(1e-6,p*(1+u));let d=Math.max(p,i)*(1+Math.abs(u)*.55+.0015),m=Math.min(p,i)*Math.max(1e-6,1-(Math.abs(u)*.55+.0015));r.push({time:c,open:Number(p),high:Number(d),low:Number(m),close:Number(i),volume:Math.max(0,Math.round(Math.abs(u)*12e3+l%13*55))})}return r}function Go(e){if(!e.length)return e;let t=[];for(let n=0;n<e.length;n+=1){let s=e[n],a=(s.open+s.high+s.low+s.close)/4,o=t[n-1],i=o?(o.open+o.close)/2:(s.open+s.close)/2,r=Math.max(s.high,i,a),l=Math.min(s.low,i,a);t.push({...s,open:i,high:r,low:l,close:a})}return t}function Ko(e,t){let n=[],s=0;for(let a=0;a<e.length;a+=1)s+=e[a].close,a>=t&&(s-=e[a-t].close),a>=t-1&&n.push({time:e[a].time,value:s/t});return n}function _s(e,t){let n=[];if(!e.length)return n;let s=2/(t+1),a=e[0].close;for(let o=0;o<e.length;o+=1)a=o===0?e[o].close:e[o].close*s+a*(1-s),o>=t-1&&n.push({time:e[o].time,value:a});return n}function jf(e,t){let n=[],s=t*(t+1)/2;for(let a=t-1;a<e.length;a+=1){let o=0;for(let i=0;i<t;i+=1)o+=e[a-i].close*(t-i);n.push({time:e[a].time,value:o/s})}return n}function qf(e,t=20,n=2){let s=Ko(e,t),a=[],o=[];for(let i=t-1;i<e.length;i+=1){let r=e.slice(i-t+1,i+1),l=s[i-(t-1)].value,c=r.reduce((u,d)=>u+Math.pow(d.close-l,2),0)/t,p=Math.sqrt(c);a.push({time:e[i].time,value:l+p*n}),o.push({time:e[i].time,value:l-p*n})}return{upper:a,lower:o}}function Vf(e){let t=[],n=0,s=0;for(let a=0;a<e.length;a+=1){let o=(e[a].high+e[a].low+e[a].close)/3;n+=o*(e[a].volume||0),s+=e[a].volume||0,s>0&&t.push({time:e[a].time,value:n/s})}return t}function Gf(e,t=14){let n=[];if(e.length<=t)return n;let s=0,a=0;for(let r=1;r<=t;r+=1){let l=e[r].close-e[r-1].close;s+=l>0?l:0,a+=l<0?-l:0}let o=s/t,i=a/t;for(let r=t+1;r<e.length;r+=1){let l=e[r].close-e[r-1].close;o=(o*(t-1)+(l>0?l:0))/t,i=(i*(t-1)+(l<0?-l:0))/t;let c=i>0?o/i:100;n.push({time:e[r].time,value:100-100/(1+c)})}return n}function ui(e,t=14){let n=[];for(let o=0;o<e.length;o+=1){let i=o>0?e[o-1].close:e[o].close;n.push(Math.max(e[o].high-e[o].low,Math.abs(e[o].high-i),Math.abs(e[o].low-i)))}let s=[],a=n.slice(0,t).reduce((o,i)=>o+i,0)/Math.max(1,t);for(let o=t;o<e.length;o+=1)a=(a*(t-1)+n[o])/t,s.push({time:e[o].time,value:a});return s}function Kf(e,t=14,n=3){let s=[];for(let o=t-1;o<e.length;o+=1){let i=e.slice(o-t+1,o+1),r=Math.max(...i.map(p=>p.high)),l=Math.min(...i.map(p=>p.low)),c=r!==l?(e[o].close-l)/(r-l)*100:50;s.push({time:e[o].time,value:c})}let a=[];for(let o=n-1;o<s.length;o+=1){let i=s.slice(o-n+1,o+1).reduce((r,l)=>r+l.value,0)/n;a.push({time:s[o].time,value:i})}return{k:s,d:a}}function Jf(e,t=12,n=26,s=9){let a=_s(e,t),o=_s(e,n),i=new Map(o.map(u=>[u.time,u.value])),r=a.filter(u=>i.has(u.time)).map(u=>({time:u.time,value:u.value-i.get(u.time)})),l=[];if(r.length){let u=2/(s+1),d=r[0].value;for(let m=0;m<r.length;m+=1)d=m===0?r[m].value:r[m].value*u+d*(1-u),m>=s-1&&l.push({time:r[m].time,value:d})}let c=new Map(l.map(u=>[u.time,u.value])),p=r.filter(u=>c.has(u.time)).map(u=>({time:u.time,value:u.value-c.get(u.time)}));return{line:r,signal:l,hist:p}}function gc(e,t=9,n=26,s=52){let a=u=>{let d=[];for(let m=u-1;m<e.length;m+=1){let f=e.slice(m-u+1,m+1);d.push({time:e[m].time,value:(Math.max(...f.map(v=>v.high))+Math.min(...f.map(v=>v.low)))/2})}return d},o=a(t),i=a(n),r=new Map(i.map(u=>[u.time,u.value])),l=o.filter(u=>r.has(u.time)).map(u=>({time:u.time,value:(u.value+r.get(u.time))/2})),c=a(s),p=e.map(u=>({time:u.time,value:u.close}));return{tenkan:o,kijun:i,senkouA:l,senkouB:c,chikou:p}}function Yf(e,t=20){let n=[],s=[],a=[];for(let o=t-1;o<e.length;o+=1){let i=e.slice(o-t+1,o+1),r=Math.max(...i.map(c=>c.high)),l=Math.min(...i.map(c=>c.low));n.push({time:e[o].time,value:r}),s.push({time:e[o].time,value:l}),a.push({time:e[o].time,value:(r+l)/2})}return{upper:n,lower:s,mid:a}}function Qf(e,t=20,n=2){let s=_s(e,t),a=ui(e,t),o=new Map(a.map(l=>[l.time,l.value])),i=[],r=[];return s.forEach(l=>{if(o.has(l.time)){let c=o.get(l.time)*n;i.push({time:l.time,value:l.value+c}),r.push({time:l.time,value:l.value-c})}}),{upper:i,lower:r,mid:s}}function Zf(e){let t=[],n=[],s=0,a=0;for(let o=0;o<e.length;o+=1){if(o>0){let l=e[o-1];e[o].close>l.close&&(s+=e[o].volume||0),e[o].close<l.close&&(s-=e[o].volume||0)}let i=e[o].high-e[o].low||1,r=(e[o].close-e[o].low-(e[o].high-e[o].close))/i;a+=r*(e[o].volume||0),t.push({time:e[o].time,value:s}),n.push({time:e[o].time,value:a})}return{obv:t,adline:n}}function eh(e,t=14){if(e.length<t+2)return{adx:[],plusDi:[],minusDi:[]};let n=[],s=[],a=[];for(let d=1;d<e.length;d+=1){let m=e[d].high-e[d-1].high,f=e[d-1].low-e[d].low;s.push(m>f&&m>0?m:0),a.push(f>m&&f>0?f:0),n.push(Math.max(e[d].high-e[d].low,Math.abs(e[d].high-e[d-1].close),Math.abs(e[d].low-e[d-1].close)))}let o=n.slice(0,t).reduce((d,m)=>d+m,0),i=s.slice(0,t).reduce((d,m)=>d+m,0),r=a.slice(0,t).reduce((d,m)=>d+m,0),l=[],c=[],p=[];for(let d=t;d<n.length;d+=1){o=o-o/t+n[d],i=i-i/t+s[d],r=r-r/t+a[d];let m=o>0?100*i/o:0,f=o>0?100*r/o:0,v=m+f>0?100*Math.abs(m-f)/(m+f):0,b=e[d+1].time;l.push({time:b,value:m}),c.push({time:b,value:f}),p.push({time:b,value:v})}let u=[];if(p.length>=t){let d=p.slice(0,t).reduce((m,f)=>m+f.value,0)/t;for(let m=t;m<p.length;m+=1)d=(d*(t-1)+p[m].value)/t,u.push({time:p[m].time,value:d})}return{adx:u,plusDi:l,minusDi:c}}function th(e,t=14){let n=[],s=[];for(let a=t-1;a<e.length;a+=1){let o=e.slice(a-t+1,a+1),i=0,r=0;for(let p=1;p<o.length;p+=1)o[p].high>=o[i].high&&(i=p),o[p].low<=o[r].low&&(r=p);let l=t-1-i,c=t-1-r;n.push({time:e[a].time,value:(t-l)/t*100}),s.push({time:e[a].time,value:(t-c)/t*100})}return{up:n,down:s}}function nh(e,t=14){let n=[],s=[];if(e.length<t+2)return{plus:n,minus:s};for(let a=t;a<e.length;a+=1){let o=0,i=0,r=0;for(let l=a-t+1;l<=a;l+=1){let c=e[l-1],p=e[l];o+=Math.max(p.high-p.low,Math.abs(p.high-c.close),Math.abs(p.low-c.close)),i+=Math.abs(p.high-c.low),r+=Math.abs(p.low-c.high)}n.push({time:e[a].time,value:o>0?i/o:0}),s.push({time:e[a].time,value:o>0?r/o:0})}return{plus:n,minus:s}}function sh(e,t=10,n=3){let s=ui(e,t),a=new Map(s.map(c=>[c.time,c.value])),o=[],i=0,r=0,l=!0;return e.forEach((c,p)=>{if(p===0||!a.has(c.time))return;let u=(c.high+c.low)/2,d=a.get(c.time),m=u+n*d,f=u-n*d;p>1&&(m>i&&e[p-1].close<=i&&(m=i),f<r&&e[p-1].close>=r&&(f=r));let v=c.close>m?!0:c.close<f?!1:l,b=v?f:m;o.push({time:c.time,value:b,trendUp:v?1:0}),i=m,r=f,l=v}),o}function ah(e,t=14){let n=[];if(e.length<=t)return n;let s=e.map((a,o)=>{let i=(a.high+a.low+a.close)/3,r=o>0?(e[o-1].high+e[o-1].low+e[o-1].close)/3:i,l=i*(a.volume||0);return{time:a.time,pos:i>=r?l:0,neg:i<r?l:0}});for(let a=t;a<s.length;a+=1){let o=s.slice(a-t+1,a+1),i=o.reduce((c,p)=>c+p.pos,0),r=o.reduce((c,p)=>c+p.neg,0),l=r>0?i/r:100;n.push({time:s[a].time,value:100-100/(1+l)})}return n}function oh(e,t=14){let n=[];for(let s=t-1;s<e.length;s+=1){let a=e.slice(s-t+1,s+1),o=Math.max(...a.map(l=>l.high)),i=Math.min(...a.map(l=>l.low)),r=o!==i?(o-e[s].close)/(o-i)*-100:-50;n.push({time:e[s].time,value:r})}return n}function ih(e,t=20){let n=[],s=e.map(a=>({time:a.time,value:(a.high+a.low+a.close)/3}));for(let a=t-1;a<s.length;a+=1){let o=s.slice(a-t+1,a+1),i=o.reduce((c,p)=>c+p.value,0)/t,r=o.reduce((c,p)=>c+Math.abs(p.value-i),0)/t,l=r>0?(s[a].value-i)/(.015*r):0;n.push({time:s[a].time,value:l})}return n}function rh(e){if(e.length<30)return[];let t=[],n=[];for(let o=1;o<e.length;o+=1){let i=e[o-1].close,r=Math.min(e[o].low,i),l=Math.max(e[o].high,i);t.push({time:e[o].time,value:e[o].close-r}),n.push({time:e[o].time,value:l-r})}let s=(o,i,r)=>o.slice(i-r+1,i+1).reduce((l,c)=>l+c.value,0),a=[];for(let o=27;o<t.length;o+=1){let i=s(t,o,7)/Math.max(1e-9,s(n,o,7)),r=s(t,o,14)/Math.max(1e-9,s(n,o,14)),l=s(t,o,28)/Math.max(1e-9,s(n,o,28));a.push({time:t[o].time,value:100*(4*i+2*r+l)/7})}return a}function lh(e,t=20){let n=[],s=e.map(a=>{let o=a.high-a.low||1,i=(a.close-a.low-(a.high-a.close))/o;return{time:a.time,value:i*(a.volume||0),volume:a.volume||0}});for(let a=t-1;a<s.length;a+=1){let o=s.slice(a-t+1,a+1),i=o.reduce((l,c)=>l+c.value,0),r=o.reduce((l,c)=>l+c.volume,0);n.push({time:s[a].time,value:r>0?i/r:0})}return n}function ch(e){return(Array.isArray(e)?e:[]).map(t=>({time:Number(t[0]),low:Number(t[1]),high:Number(t[2]),open:Number(t[3]),close:Number(t[4]),volume:Number(t[5])})).filter(t=>Number.isFinite(t.time)&&[t.open,t.high,t.low,t.close].every(Number.isFinite))}function Jo(e,t){let n=new Map;for(let s of e)n.set(s.time,s);for(let s of t)n.set(s.time,s);return Array.from(n.values()).sort((s,a)=>s.time-a.time)}async function Yo(e,t,n){let s=[],a=Math.floor(Date.now()/1e3),o=!1;for(let i=0;i<n;i+=1){let r=a-t*300,l=`https://api.exchange.coinbase.com/products/${e}/candles?granularity=${t}&start=${new Date(r*1e3).toISOString()}&end=${new Date(a*1e3).toISOString()}`,c;try{c=await Lt(l,{timeoutMs:1e4})}catch{break}let p=ch(c);if(!p.length){o=!0;break}s.push(...p),a=r,i<n-1&&await tf(ef)}return{candles:Jo(s,[]),reachedStart:o}}async function dh(e,t,n){if(!e||!Number.isFinite(t)||!Number.isFinite(n)||n<=t)return[];try{let s=`https://api.coingecko.com/api/v3/coins/${e}/market_chart/range?vs_currency=usd&from=${t}&to=${n}`,a=await Lt(s,{timeoutMs:15e3});return(Array.isArray(a==null?void 0:a.prices)?a.prices:[]).map(([i,r])=>({time:Math.floor(Number(i)/1e3/86400)*86400,open:Number(r),high:Number(r),low:Number(r),close:Number(r),volume:0})).filter(i=>Number.isFinite(i.time)&&Number.isFinite(i.close)&&i.close>0).sort((i,r)=>i.time-r.time)}catch{return[]}}async function ph(e,t,n){var u;let s=uc(n),a=s===86400,o=`${Zm}${e.id}:${s}`,i=ve(Q(o));if((u=i==null?void 0:i.candles)!=null&&u.length&&i.reachedStart){let d=await Yo(t,s,1),m=Jo(i.candles,d.candles);return Z(o,JSON.stringify({candles:m,reachedStart:!0,source:i.source,cachedAt:Date.now()})),{candles:m,source:i.source}}let l=await Yo(t,s,a?Fl:Ol),c=l.candles,p=c.length?`Coinbase (${new Date(c[0].time*1e3).getUTCFullYear()}\u2013present, ${c.length} bars)`:"Coinbase";if(a&&l.reachedStart&&e.coingeckoId&&c.length){let d=c[0].time,m=await dh(e.coingeckoId,0,d);m.length&&(c=Jo(m,c),p=`CoinGecko (${new Date(c[0].time*1e3).getUTCFullYear()}+) + Coinbase (${new Date(d*1e3).getUTCFullYear()}\u2013present)`)}else!a&&!l.reachedStart&&(p=`Coinbase (last ${c.length} bars \u2014 full inception history is daily/weekly/monthly only)`);return c.length&&Z(o,JSON.stringify({candles:c,reachedStart:l.reachedStart,source:p,cachedAt:Date.now()})),{candles:c,source:p}}var Wo=new Map;async function vc(e,t){let n=`${e.id}:${t}`,s=As.get(n);if(s&&Date.now()-s.ts<6e4&&Array.isArray(s.data)&&s.data.length)return s.data;let a=Wo.get(n);if(a)return a;let o=(async()=>{let i=[],r="",l=cc(e.ticker);if(l)try{let c=await ph(e,l,t);i=c.candles,r=c.source}catch{i=[]}if(!Array.isArray(i)||!i.length){let c=hc(t,fc());return As.set(n,{ts:Date.now(),data:c,sourceLabel:""}),c}return As.set(n,{ts:Date.now(),data:i,sourceLabel:r}),i})();Wo.set(n,o);try{return await o}finally{Wo.delete(n)}}async function uh(){var u,d,m,f,v,b,h,g;let e=Ea(),t=await vc(e,M.interval),s=((u=As.get(`${e.id}:${M.interval}`))==null?void 0:u.sourceLabel)||String(((d=M.stats)==null?void 0:d.source)||"Coinbase + XRPL live"),a="pair",o=mc(),i=String((o==null?void 0:o.symbol)||"").toUpperCase(),r=o?Ue(o):`${e.symbol||"XRP"}|`;if(o&&i&&i!=="XRP"){let x=await Bf(o,M.interval);(m=x==null?void 0:x.candles)!=null&&m.length&&(t=x.candles,s=x.source,a=x.mode)}let l=String(e.symbol||"XRP").toUpperCase()==="XRP",c=Number((l?(f=M.stats)==null?void 0:f.xrplSpot:null)??((v=M.stats)==null?void 0:v.price)??0);if(a==="pair"&&Number.isFinite(c)&&c>0&&t.length){let x=Math.max(60,pc(M.interval)),k=Math.floor(Date.now()/1e3),T=Math.floor(k/x)*x,S=t[t.length-1];S.time===T?(S.high=Math.max(S.high,c),S.low=Math.min(S.low,c),S.close=c):S.time<T&&t.push({time:T,open:S.close,high:Math.max(S.close,c),low:Math.min(S.close,c),close:c,volume:0})}let p=Number((o==null?void 0:o.price)||0);if(a==="pair"&&o&&i&&i!=="XRP"&&Number.isFinite(p)&&p>0&&t.length){let x=Number((l?(b=M.stats)==null?void 0:b.xrplSpot:null)??((h=M.stats)==null?void 0:h.price)??((g=t[t.length-1])==null?void 0:g.close)??0);if(Number.isFinite(x)&&x>0){let k=p/x;Number.isFinite(k)&&k>0&&(t=t.map(T=>({...T,open:T.open*k,high:T.high*k,low:T.low*k,close:T.close*k})),s="Coinbase pair + token spot proxy",a="token-proxy")}}return t.length||(t=hc(M.interval,fc()),s=o&&i!=="XRP"?"Synthetic fallback (token-focused)":"Synthetic fallback",a="fallback"),o&&i!=="XRP"&&(a==="pair"||a==="fallback")?Xo!==r&&(Xo=r,ge(`No market data found for ${o.symbol} yet \u2014 showing ${e.symbol||"XRP"} for reference.`)):r&&(Xo=""),M.chartType==="heikin_ashi"&&(t=Go(t)),Hf(t,{mode:a,source:s,tokenKey:r||"XRP|"}),t}function $l(e){if(!Array.isArray(e))return[];let t=e.map(s=>({time:Number(s.time),open:Number(s.open),high:Number(s.high),low:Number(s.low),close:Number(s.close),volume:Number(s.volume||0)})).filter(s=>Number.isFinite(s.time)&&Number.isFinite(s.open)&&Number.isFinite(s.high)&&Number.isFinite(s.low)&&Number.isFinite(s.close)&&s.time>0).sort((s,a)=>s.time-a.time),n=[];for(let s=0;s<t.length;s+=1){let a=t[s],o=n[n.length-1];o&&o.time===a.time?n[n.length-1]=a:n.push(a)}return n}function mh(e,t,n){var i;let s=Number(((i=e==null?void 0:e[e.length-1])==null?void 0:i.close)||0);if(!Number.isFinite(s)||s<=0)return 6;let o=Math.max(1e-12,Math.abs(Number(n)-Number(t)))/Math.max(1e-12,Math.abs(s));return s>=1e3?o<.01?4:2:s>=1?o<.01?6:4:s>=.01?o<.03?8:6:8}function fh(){if(ee.resizeObserver)try{ee.resizeObserver.disconnect()}catch{}ee.chart&&(ee.chart.remove(),ee={chart:null,volumeSeries:null,activeSeries:null,compareSeries:null,indicatorSeries:[],indicatorPriceLines:[],priceLines:[],resizeObserver:null,chartType:"",configKey:"",legendEl:null,renderLegend:null,ichimokuData:null,indicatorLegendItems:[],alertPriceLines:[]})}function Sl(e,t){var p;let{addOverlay:n,addOsc:s,addOscHist:a,addPriceLevel:o}=t,i=(u,d)=>{var f,v;let m=Number((v=(f=M.indicatorSettings)==null?void 0:f[u])==null?void 0:v.length);return Number.isFinite(m)&&m>1?Math.min(500,Math.max(2,m)):d},r=(u,d,m)=>{var b,h;let f=(h=(b=M.indicatorSettings)==null?void 0:b[u])==null?void 0:h[d];if(f==null||f==="")return m;let v=(oi[u]||[]).find(g=>g.id===d);if((v==null?void 0:v.type)==="number"){let g=Number(f);return Number.isFinite(g)&&g>1?Math.min(500,Math.max(2,g)):m}return f},l=M.indicators;if(l.sma20&&n(Ko(e,i("sma20",20)),r("sma20","color","#f1c40f"),1.2,!1,"SMA"),l.ema20&&n(_s(e,i("ema20",20)),r("ema20","color","#ffb86c"),1.2,!1,"EMA"),l.wma20&&n(jf(e,i("wma20",20)),r("wma20","color","#bd93f9"),1.2,!1,"WMA"),l.vwap&&n(Vf(e),r("vwap","color","#80ffea"),1.2,!1,"VWAP"),l.bb20){let u=r("bb20","color","#ff79c6"),d=qf(e,i("bb20",20),2);n(d.upper,u,1,!0,"BB Upper"),n(d.lower,u,1,!0,"BB Lower")}if(l.ichimoku){let u=gc(e,r("ichimoku","tenkanLen",9),r("ichimoku","kijunLen",26),r("ichimoku","senkouBLen",52));n(u.tenkan,r("ichimoku","tenkanColor","#ffde59"),1.2,!1,"Tenkan"),n(u.kijun,r("ichimoku","kijunColor","#6ecbff"),1.2,!1,"Kijun"),n(u.senkouA,"rgba(70,255,160,0.8)",1,!0,"Senkou A"),n(u.senkouB,"rgba(255,120,120,0.8)",1,!0,"Senkou B"),n(u.chikou,"rgba(220,220,255,0.6)",.9,!0,"Chikou")}if(l.donchian){let u=r("donchian","color","#9cfb8c"),d=Yf(e,i("donchian",20));n(d.upper,u,1,!0,"Donchian Upper"),n(d.lower,u,1,!0,"Donchian Lower"),n(d.mid,"rgba(156,251,140,0.6)",1.2,!1,"Donchian Mid")}if(l.keltner){let u=r("keltner","color","#7ee7ff"),d=Qf(e,i("keltner",20),2);n(d.upper,u,1,!0,"Keltner Upper"),n(d.lower,u,1,!0,"Keltner Lower"),n(d.mid,"rgba(126,231,255,0.66)",1.2,!1,"Keltner Mid")}if(l.pivots&&e.length>=2){let u=e[e.length-2],d=(u.high+u.low+u.close)/3,m=2*d-u.low,f=2*d-u.high,v=d+(u.high-u.low),b=d-(u.high-u.low);o(d,"#f6f6f6","P"),o(m,"#61ffb0","R1"),o(f,"#ff8f8f","S1"),o(v,"rgba(97,255,176,0.6)","R2"),o(b,"rgba(255,143,143,0.6)","S2")}if(l.supertrend||l.sar||l.elderRay){let u=_s(e,14);if(l.supertrend&&n(sh(e,10,3),r("supertrend","color","#8bffde"),1.3,!1,"Supertrend"),l.sar&&n(u.map(d=>({time:d.time,value:d.value*.998})),r("sar","color","#ffaf7a"),1,!0,"SAR"),l.elderRay){let d=new Map(u.map(v=>[v.time,v.value])),m=e.filter(v=>d.has(v.time)).map(v=>({time:v.time,value:v.high-d.get(v.time)})),f=e.filter(v=>d.has(v.time)).map(v=>({time:v.time,value:v.low-d.get(v.time)}));s(m,r("elderRay","bullColor","#5fff9d"),"Elder Bull"),s(f,r("elderRay","bearColor","#ff9d9d"),"Elder Bear")}}if(l.rsi&&s(Gf(e,i("rsi",14)),r("rsi","color","#a6ff4d"),"RSI"),l.atr&&s(ui(e,i("atr",14)),r("atr","color","#ffb86c"),"ATR"),l.stdev){let u=Ko(e,20),d=new Map(u.map(f=>[f.time,f.value])),m=e.filter(f=>d.has(f.time)).map(f=>({time:f.time,value:Math.abs(f.close-d.get(f.time))}));s(m,r("stdev","color","#b2a3ff"),"StdDev")}if(l.stoch){let u=Kf(e,i("stoch",14),3);s(u.k,r("stoch","kColor","#9ee8ff"),"%K"),s(u.d,r("stoch","dColor","#ffd86b"),"%D")}if(l.macd){let u=Jf(e,r("macd","fastLen",12),r("macd","slowLen",26),r("macd","signalLen",9));s(u.line,r("macd","lineColor","#8fd9ff"),"MACD"),s(u.signal,r("macd","signalColor","#ffcf8e"),"Signal"),(p=u.hist)!=null&&p.length&&a(u.hist)}let c=Zf(e);if(l.obv&&s(c.obv,r("obv","color","#8cf9ff"),"OBV"),l.adline&&s(c.adline,r("adline","color","#ffb7ff"),"A/D"),l.cmf&&s(lh(e,i("cmf",20)),r("cmf","color","#f8ff87"),"CMF"),l.williamsr&&s(oh(e,i("williamsr",14)),r("williamsr","color","#ff9adf"),"Williams %R"),l.cci&&s(ih(e,i("cci",20)),r("cci","color","#b8ff8e"),"CCI"),l.mfi&&s(ah(e,i("mfi",14)),r("mfi","color","#7bffd2"),"MFI"),l.uo&&s(rh(e),r("uo","color","#ffd36f"),"UO"),l.adx){let u=eh(e,i("adx",14));s(u.adx,r("adx","adxColor","#9fd8ff"),"ADX"),s(u.plusDi,r("adx","plusColor","#73ffc0"),"+DI"),s(u.minusDi,r("adx","minusColor","#ff9797"),"-DI")}if(l.aroon){let u=th(e,i("aroon",14));s(u.up,r("aroon","upColor","#6cffb0"),"Aroon Up"),s(u.down,r("aroon","downColor","#ff8f8f"),"Aroon Down")}if(l.vortex){let u=nh(e,i("vortex",14));s(u.plus.map(d=>({time:d.time,value:d.value*100})),r("vortex","plusColor","#d6a8ff"),"VI+"),s(u.minus.map(d=>({time:d.time,value:d.value*100})),r("vortex","minusColor","#ffb0f3"),"VI-")}}function hh(e){let t=e.querySelector(":scope > svg.xpd-ichimoku-cloud-svg");return t||(t=document.createElementNS("http://www.w3.org/2000/svg","svg"),t.setAttribute("class","xpd-ichimoku-cloud-svg"),e.appendChild(t)),t}function gh(e){var t;(t=e==null?void 0:e.querySelector(":scope > svg.xpd-ichimoku-cloud-svg"))==null||t.remove()}function bc(e,t,n,s,a){var b;if(!e||!t||!n)return;let o=n.clientWidth||0,i=n.clientHeight||0;if(!o||!i||!(s!=null&&s.length)||!(a!=null&&a.length))return;let r=hh(n);r.setAttribute("width",o),r.setAttribute("height",i),r.setAttribute("viewBox",`0 0 ${o} ${i}`);let l=((b=M.indicatorSettings)==null?void 0:b.ichimoku)||{},c=l.bullColor||"#46ffa0",p=l.bearColor||"#ff7878",u=new Map(a.map(h=>[h.time,h.value])),d=e.timeScale(),m=[];for(let h of s){let g=u.get(h.time);if(g==null)continue;let x=d.timeToCoordinate(h.time),k=t.priceToCoordinate(h.value),T=t.priceToCoordinate(g);x==null||k==null||T==null||m.push({x,ya:k,yb:T,bullish:h.value>=g})}let f="",v=0;for(let h=1;h<=m.length;h+=1){if(!(h===m.length||m[h].bullish!==m[v].bullish))continue;let x=m.slice(v,h);if(x.length>=2){let k=x.map($=>`${$.x.toFixed(1)},${$.ya.toFixed(1)}`).join(" "),T=x.slice().reverse().map($=>`${$.x.toFixed(1)},${$.yb.toFixed(1)}`).join(" "),S=x[0].bullish?c:p;f+=`<polygon points="${k} ${T}" fill="${y(S)}" opacity="0.22" />`}v=h}r.innerHTML=f}function Tl(e,t,n,s){var i;if(!M.indicators.ichimoku){gh(s),ee.ichimokuData=null;return}let a=((i=M.indicatorSettings)==null?void 0:i.ichimoku)||{},o=gc(e,Number(a.tenkanLen)||9,Number(a.kijunLen)||26,Number(a.senkouBLen)||52);ee.ichimokuData={senkouA:o.senkouA,senkouB:o.senkouB},bc(t,n,s,o.senkouA,o.senkouB)}function Qo(){let e=ee.ichimokuData,t=document.getElementById("xpd-tv-widget");e&&ee.chart&&ee.activeSeries&&t&&bc(ee.chart,ee.activeSeries,t,e.senkouA,e.senkouB)}async function vh(){var n,s,a,o;let e=++Nn,t=document.getElementById("xpd-tv-widget");if(t){ee.chart||(t.innerHTML='<div class="xpd-loading">Loading full price history\u2026</div>');try{M.threeEnabled?Uf():Fs();let i=await uh(),r=$l(i);if(e!==Nn)return;if(!r.length)throw new Error("No chart bars returned for selected pair/timeframe.");yh(r);let l=JSON.stringify({pair:M.pair,interval:M.interval,chartType:M.chartType,comparePair:M.comparePair,indicators:M.indicators,indicatorSettings:M.indicatorSettings,threeEnabled:M.threeEnabled});if(!M.comparePair&&!(M.drawings||[]).length&&ee.chart&&ee.configKey===l){let H=M.chartType==="heikin_ashi"?Go(r):r;M.chartType==="line"||M.chartType==="area"?ee.activeSeries.setData(H.map(Y=>({time:Y.time,value:Y.close}))):ee.activeSeries.setData(H),ee.volumeSeries.setData(r.map(Y=>({time:Y.time,value:Y.volume||0,color:Y.close>=Y.open?"rgba(38,166,154,0.5)":"rgba(239,83,80,0.5)"})));let q=0,se=0,me=[];Sl(r,{addOverlay:(Y,he,tt,it,Ct)=>{let Dt=ee.indicatorSeries[q++];Y!=null&&Y.length&&(Dt==null||Dt.setData(Y),Ct&&Dt&&me.push({label:Ct,color:he,series:Dt,points:Y}))},addOsc:(Y,he,tt)=>{let it=ee.indicatorSeries[q++];Y!=null&&Y.length&&(it==null||it.setData(Y),tt&&it&&me.push({label:tt,color:he,series:it,points:Y}))},addOscHist:Y=>{let he=ee.indicatorSeries[q++];Y!=null&&Y.length&&(he==null||he.setData(Y.map(tt=>({time:tt.time,value:tt.value,color:tt.value>=0?"rgba(99,255,157,0.45)":"rgba(255,126,126,0.45)"}))))},addPriceLevel:Y=>{let he=ee.indicatorPriceLines[se++];Number.isFinite(Y)&&(he==null||he.applyOptions({price:Y}))}}),ee.indicatorLegendItems=me,Tl(r,ee.chart,ee.activeSeries,t),Cl(ee.activeSeries);let _e=r[r.length-1];(n=ee.renderLegend)==null||n.call(ee,_e.open,_e.high,_e.low,_e.close,_e.volume);return}if(!await zf())throw new Error("Chart library failed to load.");if(e!==Nn)return;let p=document.getElementById("xpd-tv-widget");if(!p||e!==Nn)return;let u=null;try{u=((s=ee.chart)==null?void 0:s.timeScale().getVisibleLogicalRange())||null}catch{}fh(),p.innerHTML="";let d=window.LightweightCharts,m=Math.max(320,p.clientWidth||((a=p.parentElement)==null?void 0:a.clientWidth)||320),f=Math.max(360,p.clientHeight||460),v=r.map(H=>H.low),b=r.map(H=>H.high),h=mh(r,Math.min(...v),Math.max(...b)),g={type:"price",precision:h,minMove:Math.pow(10,-h)},x="#26a69a",k="#ef5350",T=d.createChart(p,{width:m,height:f,layout:{background:{type:d.ColorType.Solid,color:"#131722"},textColor:"#d1d4dc"},grid:{vertLines:{color:"#242832"},horzLines:{color:"#242832"}},rightPriceScale:{borderColor:"rgba(197,203,206,0.3)"},leftPriceScale:{visible:!1,borderColor:"rgba(197,203,206,0.3)"},timeScale:{borderColor:"rgba(197,203,206,0.3)",timeVisible:!0,secondsVisible:!1},crosshair:{mode:d.CrosshairMode.Normal},handleScroll:!0,handleScale:!0}),S=M.chartType==="heikin_ashi"?Go(r):r,$;if(M.chartType==="line")$=T.addLineSeries({color:"#2962ff",lineWidth:2,priceFormat:g}),$.setData(S.map(H=>({time:H.time,value:H.close})));else if(M.chartType==="area")$=T.addAreaSeries({lineColor:"#2962ff",topColor:"rgba(41,98,255,0.36)",bottomColor:"rgba(41,98,255,0.04)",lineWidth:2,priceFormat:g}),$.setData(S.map(H=>({time:H.time,value:H.close})));else if(M.chartType==="bars")$=T.addBarSeries({upColor:x,downColor:k,priceFormat:g}),$.setData(S);else{let H=M.chartType==="hollow_candles";$=T.addCandlestickSeries({upColor:H?"rgba(0,0,0,0)":x,downColor:k,borderUpColor:x,borderDownColor:k,wickUpColor:x,wickDownColor:k,borderVisible:!0,priceFormat:g}),$.setData(S)}let N=T.addHistogramSeries({priceFormat:{type:"volume"},priceScaleId:"vol"});T.priceScale("vol").applyOptions({scaleMargins:{top:.85,bottom:0}}),N.setData(r.map(H=>({time:H.time,value:H.volume||0,color:H.close>=H.open?"rgba(38,166,154,0.5)":"rgba(239,83,80,0.5)"})));let C=document.createElement("div");C.className="xpd-chart-legend",p.appendChild(C);let P=H=>Number.isFinite(H)?H.toFixed(h):"\u2014",R=(H,q,se,me,xe,Ce)=>{let qe=me>=H,Fe=(Ce||[]).map(_e=>`<span style="color:${y(_e.color)}">${y(_e.label)} <b>${P(_e.value)}</b></span>`).join("");C.innerHTML=`
        <span>O <b>${P(H)}</b></span>
        <span>H <b>${P(q)}</b></span>
        ...
        ${Fe}
      `},O=S[S.length-1],D=(o=r[r.length-1])==null?void 0:o.volume,I=()=>{if(!O)return;let H=O.open??O.value,q=O.high??O.value,se=O.low??O.value,me=O.close??O.value,xe=(ee.indicatorLegendItems||[]).map(Ce=>{var qe,Fe;return{label:Ce.label,color:Ce.color,value:(Fe=(qe=Ce.points)==null?void 0:qe[Ce.points.length-1])==null?void 0:Fe.value}}).filter(Ce=>Number.isFinite(Ce.value));R(H,q,se,me,D,xe)};I(),T.subscribeCrosshairMove(H=>{var _e,Y;if(!H.time){I();return}let q=(_e=H.seriesData)==null?void 0:_e.get($);if(!q){I();return}let se=(Y=H.seriesData)==null?void 0:Y.get(N),me=q.open??q.value,xe=q.high??q.value,Ce=q.low??q.value,qe=q.close??q.value,Fe=(ee.indicatorLegendItems||[]).map(he=>{var tt,it;return{label:he.label,color:he.color,value:(it=(tt=H.seriesData)==null?void 0:tt.get(he.series))==null?void 0:it.value}}).filter(he=>Number.isFinite(he.value));R(me,xe,Ce,qe,se==null?void 0:se.value,Fe)});let F=!1,B=()=>{F||(F=!0,T.priceScale("osc").applyOptions({scaleMargins:{top:.65,bottom:.18}}))},E=[],z=[],te=[];Sl(r,{addOverlay:(H,q,se=1.2,me=!1,xe="")=>{if(!(H!=null&&H.length))return;let Ce=T.addLineSeries({color:q,lineWidth:se,lineStyle:me?d.LineStyle.Dashed:d.LineStyle.Solid,priceLineVisible:!1,lastValueVisible:!1});Ce.setData(H),E.push(Ce),xe&&te.push({label:xe,color:q,series:Ce,points:H})},addOsc:(H,q,se="")=>{if(!(H!=null&&H.length))return;B();let me=T.addLineSeries({color:q,lineWidth:1.2,priceScaleId:"osc",title:se,priceLineVisible:!1,lastValueVisible:!1});me.setData(H),E.push(me),se&&te.push({label:se,color:q,series:me,points:H})},addOscHist:H=>{if(!(H!=null&&H.length))return;B();let q=T.addHistogramSeries({priceScaleId:"osc",priceLineVisible:!1,lastValueVisible:!1});q.setData(H.map(se=>({time:se.time,value:se.value,color:se.value>=0?"rgba(99,255,157,0.45)":"rgba(255,126,126,0.45)"}))),E.push(q)},addPriceLevel:(H,q,se="")=>{Number.isFinite(H)&&z.push($.createPriceLine({price:H,color:q,lineWidth:1,lineStyle:d.LineStyle.Dashed,axisLabelVisible:!0,title:se}))}}),Tl(r,T,$,p),T.timeScale().subscribeVisibleLogicalRangeChange(Qo);let re=null;if(M.comparePair){let H=In.find(q=>q.id===M.comparePair);if(H){let q=$l(await vc(H,M.interval));if(e===Nn&&q.length){let se=q[0].close||1;re=T.addLineSeries({color:"#ffd166",lineWidth:1.4,priceScaleId:"left",priceLineVisible:!1,lastValueVisible:!0,priceFormat:{type:"custom",formatter:me=>`${me>=0?"+":""}${me.toFixed(2)}%`,minMove:.01}}),T.priceScale("left").applyOptions({visible:!0,borderColor:"rgba(255,209,102,0.35)"}),re.setData(q.map(me=>({time:me.time,value:(me.close/se-1)*100})))}}}else T.priceScale("left").applyOptions({visible:!1});if(e!==Nn){try{T.remove()}catch{}return}let G=(M.drawings||[]).filter(H=>Number.isFinite(H==null?void 0:H.price)).map(H=>$.createPriceLine({price:H.price,color:"#78e5ff",lineWidth:2,lineStyle:d.LineStyle.Dashed,axisLabelVisible:!0,title:"Line"}));if(T.subscribeClick(H=>{if(M.drawingTool!=="hline"||!H.point)return;let q=$.coordinateToPrice(H.point.y);Number.isFinite(q)&&(M.drawings=[...M.drawings||[],{price:q}].slice(-50),G.push($.createPriceLine({price:q,color:"#78e5ff",lineWidth:2,lineStyle:d.LineStyle.Dashed,axisLabelVisible:!0,title:"Line"})))}),u&&Number.isFinite(u.from)&&Number.isFinite(u.to))try{T.timeScale().setVisibleLogicalRange(u)}catch{T.timeScale().fitContent()}else T.timeScale().fitContent();let Se=new ResizeObserver(()=>{T.applyOptions({width:Math.max(320,p.clientWidth||320)}),Qo()});Se.observe(p),ee={chart:T,volumeSeries:N,activeSeries:$,compareSeries:re,indicatorSeries:E,indicatorPriceLines:z,priceLines:G,resizeObserver:Se,chartType:M.chartType,configKey:l,legendEl:C,renderLegend:R,indicatorLegendItems:te,alertPriceLines:[]},Cl($)}catch(i){if(e!==Nn)return;if(M.error=(i==null?void 0:i.message)||"Could not initialize chart widget.",ee.chart){ge(M.error);return}let r=document.getElementById("xpd-tv-widget");r&&(r.innerHTML=`<div class="xpd-error">${y(M.error)}</div>`)}}}function yc(){let e=Q(jo)==="1"?"0":"1";Z(jo,e),j()}async function wc(e){In.some(t=>t.id===e)&&(M.pair=e,await Is(),At(),j())}async function xc(e){M.interval=e,await Is(),At(),j()}function kc(e){M.chartType=e,At(),j()}async function $c(){await Is(),j()}function Sc(e,t){e in M.indicators&&(M.indicators[e]=!!t,t&&(M.selectedIndicator=e,M.selectedEducationTab="indicator"),At(),j())}function Tc(){M.indicatorMenuOpen=!M.indicatorMenuOpen,j()}function Cc(){M.moreMenuOpen=!M.moreMenuOpen,j()}function Pc(e){M.indicatorQuery=String(e||""),M.indicatorMenuOpen||(M.indicatorMenuOpen=!0),j()}function Mc(e){let t=String(e||"").trim();t in M.indicators&&(M.indicators[t]=!0,M.selectedIndicator=t,M.selectedEducationTab="indicator",At(),j())}function Lc(e){let t=String(e||"").trim();t in M.indicators&&(M.indicators[t]=!1,At(),j())}function bh(e){var s,a;if(M.settingsOpenFor!==e)return"";let t=M.indicatorSettings[e]||{},n=oi[e]||[];return`
    ...
    </div>`}function Ac(e){let t=String(e||"").trim();t in M.indicators&&(M.settingsOpenFor=M.settingsOpenFor===t?null:t,j())}function Ec(){M.settingsOpenFor=null,j()}function Nc(e){let t=String(e||"").trim();if(!(t in M.indicators))return;let n=M.indicatorSettings[t]||{},s={...n};for(let a of oi[t]||[]){let o=document.getElementById(`xpd-ind-${a.id}-${t}`);o&&(a.type==="number"?s[a.id]=Math.max(2,Math.min(500,Number(o.value)||n[a.id]||a.default)):s[a.id]=o.value)}M.indicatorSettings[t]=s,M.settingsOpenFor=null,j()}function Rc(e){let t=String(e||"").trim();delete M.indicatorSettings[t],M.settingsOpenFor=null,j()}function _c(){At(),Hs(window.location.href),ae("Chart link copied.")}function Dc(){M.threeEnabled=!M.threeEnabled,Z(ai,M.threeEnabled?"1":"0"),M.threeEnabled||Fs(),j()}function Ic(e){let t=!!e;M.threeEnabled!==t&&(M.threeEnabled=t,Z(ai,M.threeEnabled?"1":"0"),M.threeEnabled||Fs(),j())}function Fc(e){M.comparePair=e||"",At(),j()}function Oc(e){let t=String(e||"").trim();!t||!(t in M.indicators)||(M.indicators[t]=!0,M.selectedIndicator=t,j())}function Bc(e){let t=String(e||"none");Wl.some(n=>n.key===t)&&(M.drawingTool=t,M.educationHint=of[t]||"",j())}function Na(){var e;return((e=M.chartMeta)==null?void 0:e.tokenKey)||M.tokenFocusKey||`${Ea().symbol||"XRP"}|`}function Xc(){var s,a;let e=Number((s=M.chartMeta)==null?void 0:s.last),t=prompt(`Alert me when ${((a=M.chartMeta)==null?void 0:a.symbol)||"price"} crosses:`,Number.isFinite(e)?e.toFixed(6):"");if(t==null)return;let n=Number(t);if(!Number.isFinite(n)||n<=0){ge("Enter a valid price.");return}M.alerts=[...M.alerts||[],{id:`alert_${Date.now()}`,tokenKey:Na(),price:n,createdAt:new Date().toISOString()}],ri(),j(),ae(`Alert set at $${_(n,6)}`)}function Hc(e){M.alerts=(M.alerts||[]).filter(t=>t.id!==e),ri(),j()}function Cl(e){if(!e)return;let t=window.LightweightCharts;for(let s of ee.alertPriceLines||[])try{e.removePriceLine(s)}catch{}let n=(M.alerts||[]).filter(s=>s.tokenKey===Na());ee.alertPriceLines=n.map(s=>{var a;return e.createPriceLine({price:s.price,color:"#ffb703",lineWidth:2,lineStyle:((a=t==null?void 0:t.LineStyle)==null?void 0:a.Dotted)??2,axisLabelVisible:!0,title:"\u{1F514} Alert"})})}function yh(e){var r,l;if(e.length<2)return;let t=Na(),n=(M.alerts||[]).filter(c=>c.tokenKey===t);if(!n.length)return;let s=e[e.length-2].close,a=e[e.length-1].close,o=[],i=!1;for(let c of n){let p=s<c.price&&a>=c.price,u=s>c.price&&a<=c.price;p||u?(ae(`\u{1F514} ${((r=M.chartMeta)==null?void 0:r.symbol)||"Price"} crossed $${_(c.price,6)} (${p?"\u2191":"\u2193"} now $${_(a,6)})`),i=!0,(l=document.querySelector(`.xpd-indicator-chip[data-alert-id="${c.id}"]`))==null||l.remove()):o.push(c)}i&&(M.alerts=[...(M.alerts||[]).filter(c=>c.tokenKey!==t),...o],ri())}function zc(){let e=ee.activeSeries;if(e)for(let t of ee.priceLines||[])try{e.removePriceLine(t)}catch{}ee.priceLines=[],M.drawings=[]}function Ra(e,t=0){var i;let n=(i=ee.chart)==null?void 0:i.timeScale();if(!n)return;let s=n.getVisibleLogicalRange();if(!s)return;let a=(s.to-s.from)*e,o=(s.to+s.from)/2+(s.to-s.from)*t;n.setVisibleLogicalRange({from:o-a/2,to:o+a/2})}function Wc(){Ra(.8)}function Uc(){Ra(1.25)}function jc(){Ra(1,-.2)}function qc(){Ra(1,.2)}function Vc(){M.educationCollapsed=!M.educationCollapsed,j()}function Gc(e){["indicator","psychology","practice"].includes(e)&&(M.selectedEducationTab=e,j())}function Kc(){let e=document.body.classList.contains("theme-gold");Cn(e?"cosmic":"gold"),j()}var Pl=!1;function wh(){let e=document.getElementById("xpd-tv-widget");e&&ee.chart&&(ee.chart.applyOptions({width:Math.max(320,e.clientWidth||320),height:Math.max(320,e.clientHeight||460)}),Qo())}function Jc(){var t;let e=document.querySelector(".xpd-chart-wrap");e&&(Pl||(Pl=!0,document.addEventListener("fullscreenchange",()=>{requestAnimationFrame(()=>requestAnimationFrame(wh))})),document.fullscreenElement?document.exitFullscreen():(t=e.requestFullscreen)==null||t.call(e))}function Yc(){let e=ee.chart;if(!e){ge("Chart image is not ready yet.");return}let t=e.takeScreenshot(),n=document.createElement("a");n.download=`xrpl-chart-${Date.now()}.png`,n.href=t.toDataURL("image/png"),n.click()}function Qc(){return M.tokenFocusKey||M.pair||"default"}function Zc(){var n;let e=ve(Q(qo))||{},t=Qc();e[t]={interval:M.interval,chartType:M.chartType,comparePair:M.comparePair,indicators:M.indicators,indicatorSettings:M.indicatorSettings},Z(qo,JSON.stringify(e)),ae(`Chart layout saved for ${((n=M.chartMeta)==null?void 0:n.symbol)||t}.`)}function ed(){var s;let e=ve(Q(qo))||{},t=Qc(),n=e[t];if(!n){ge(`No saved layout for ${((s=M.chartMeta)==null?void 0:s.symbol)||t} yet.`);return}M.interval=n.interval||M.interval,M.chartType=n.chartType||M.chartType,M.comparePair=n.comparePair||"",M.indicators={...M.indicators,...n.indicators||{}},M.indicatorSettings={...M.indicatorSettings,...n.indicatorSettings||{}},At(),j()}function _a(e){let t=String(e||"").trim();if(/^[0-9A-F]{40}$/i.test(t)){let n=t.replace(/(00)+$/g,"");if(/^[0-9A-F]+$/i.test(n)&&n.length%2===0)try{let s=new Uint8Array(n.length/2);for(let o=0;o<n.length;o+=2)s[o/2]=parseInt(n.slice(o,o+2),16);let a=new TextDecoder().decode(s).replace(/\0/g,"").trim();if(a)return a.toUpperCase()}catch{}}return t.toUpperCase()}function Ue(e){return`${e.symbol}|${e.issuer||""}`}function Ps(e){return encodeURIComponent(e).replace(/'/g,"%27")}function xh(e){var l,c,p,u,d,m,f,v,b,h;let t=_a(e.code||e.currency||""),n=String(e.issuer||((l=e.IssuingAccount)==null?void 0:l.account)||"").trim(),s=Number(e.price??((c=e.metrics)==null?void 0:c.price)??0),a=Number(e.marketcap??((p=e.metrics)==null?void 0:p.marketcap)??0),o=Number(((u=e.metrics)==null?void 0:u.volume_24h)??0),i=((m=(d=e.meta)==null?void 0:d.token)==null?void 0:m.name)||((f=e.IssuingAccount)==null?void 0:f.name)||t||"Unknown Token",r=Number(e.holders??((v=e.metrics)==null?void 0:v.holders)??((b=e.metrics)==null?void 0:b.trustlines)??0);return{symbol:t,name:i,issuer:n,tokenId:e.id||`${t}.${n}`,price:Number.isFinite(s)&&s>0?s:null,marketCap:Number.isFinite(a)&&a>0?a:null,volume24h:Number.isFinite(o)?o:null,holders:Number.isFinite(r)?r:null,change24h:null,verified:!!((h=e.IssuingAccount)!=null&&h.verified),score:Number(e.score||0)||null}}function kh(e){let t=_a((e==null?void 0:e.symbol)||""),n=String((e==null?void 0:e.name)||t||"Unknown Token"),s=Number((e==null?void 0:e.current_price)||0),a=Number((e==null?void 0:e.market_cap)||0),o=Number((e==null?void 0:e.total_volume)||0),i=Number((e==null?void 0:e.price_change_percentage_24h)||0);return{symbol:t,name:n,issuer:"",tokenId:`cg:${(e==null?void 0:e.id)||t}`,price:Number.isFinite(s)&&s>0?s:null,marketCap:Number.isFinite(a)&&a>0?a:null,volume24h:Number.isFinite(o)&&o>0?o:null,holders:null,change24h:Number.isFinite(i)?i:null,verified:!1,score:null}}function $h(e){var r;let t=_a((e==null?void 0:e.currency)||(e==null?void 0:e.token)||""),n=String((e==null?void 0:e.issuer)||(e==null?void 0:e.account)||"").trim(),s=String((e==null?void 0:e.name)||t||"Unknown Token"),a=Number((e==null?void 0:e.price)||((r=e==null?void 0:e.market)==null?void 0:r.price)||0),o=Number((e==null?void 0:e.marketcap)||(e==null?void 0:e.marketCap)||0),i=Number((e==null?void 0:e.volume24h)||(e==null?void 0:e.volume)||0);return{symbol:t,name:s,issuer:n,tokenId:`bithomp:${t}.${n||"na"}`,price:Number.isFinite(a)&&a>0?a:null,marketCap:Number.isFinite(o)&&o>0?o:null,volume24h:Number.isFinite(i)&&i>0?i:null,holders:Number.isFinite(Number((e==null?void 0:e.holders)||0))?Number((e==null?void 0:e.holders)||0):null,change24h:Number.isFinite(Number((e==null?void 0:e.change24h)||0))?Number((e==null?void 0:e.change24h)||0):null,verified:!!(e!=null&&e.verified),score:null}}function Sh(e){let t=_a((e==null?void 0:e.symbol)||(e==null?void 0:e.currency)||""),n=String((e==null?void 0:e.issuer)||(e==null?void 0:e.issuerAddress)||"").trim(),s=String((e==null?void 0:e.name)||t||"Unknown Token"),a=Number((e==null?void 0:e.price)||0),o=Number((e==null?void 0:e.volume24h)||0);return{symbol:t,name:s,issuer:n,tokenId:`xrplto:${t}.${n||"na"}`,price:Number.isFinite(a)&&a>0?a:null,marketCap:Number.isFinite(Number((e==null?void 0:e.marketCap)||0))?Number((e==null?void 0:e.marketCap)||0):null,volume24h:Number.isFinite(o)&&o>0?o:null,holders:Number.isFinite(Number((e==null?void 0:e.holders)||0))?Number((e==null?void 0:e.holders)||0):null,change24h:Number.isFinite(Number((e==null?void 0:e.change24h)||0))?Number((e==null?void 0:e.change24h)||0):null,verified:!!(e!=null&&e.verified),score:null}}async function td(){var e,t,n,s,a,o;if(Ma()){U.loading=!0,U.error="";try{let i=Date.now(),r=ml.get("tokens");if(r&&i-r.ts<6e4){U.tokens=r.data,U.total=r.total||r.data.length,U.lastSyncAt=r.ts,U.filtered=as(U.query,r.data),U.trending=Ml(r.data),U.loading=!1;return}let l=500,c=12,p=[];for(let S=1;S<=c;S+=1){let $=await Lt(`${Hm}?page=${S}&limit=${l}`,{allowProxy:!1,timeoutMs:12e3});if(!Array.isArray($)||!$.length||(p.push(...$),$.length<l))break}let u=p.map(xh).filter(S=>!!S.symbol&&!!S.issuer),d=[Lt(`${zm}?vs_currency=usd&order=market_cap_desc&per_page=250&page=1&sparkline=false`,{timeoutMs:12e3}).catch(()=>[]),Date.now()<(gl.xrplto||0)?Promise.resolve([]):Lt(Um,{timeoutMs:12e3,allowProxy:!1}).catch(S=>(String((S==null?void 0:S.message)||"").includes("429")&&(gl.xrplto=Date.now()+5*60*1e3),[]))];jm&&d.push(Lt(Wm,{timeoutMs:12e3,allowProxy:!1}).catch(()=>[]));let[m,f,v=[]]=await Promise.all(d),b=Array.isArray(m)?m.map(kh).filter(S=>!!S.symbol):[],h=Array.isArray(v)?v.map($h).filter(S=>!!S.symbol):[],g=Array.isArray(f)?f.map(Sh).filter(S=>!!S.symbol):[],x={symbol:"XRP",name:"XRP Ledger Native",issuer:"",tokenId:"XRP",price:((e=Pe.data)==null?void 0:e.priceUsd)||((t=M.stats)==null?void 0:t.price)||null,marketCap:((n=Pe.data)==null?void 0:n.marketCap)||null,volume24h:((s=Pe.data)==null?void 0:s.volume24h)||null,holders:null,change24h:((a=Pe.data)==null?void 0:a.change24h)||((o=M.stats)==null?void 0:o.changePct)||null,verified:!0,score:1},k=new Map;[x,...u,...h,...g,...b].forEach(S=>{let $=Ue(S);k.has($)||k.set($,S)});let T=[...k.values()];ml.set("tokens",{ts:i,data:T,total:T.length}),U.tokens=T,U.total=T.length,U.lastSyncAt=i,U.filtered=as(U.query,T),U.trending=Ml(T)}catch(i){U.error=(i==null?void 0:i.message)||"Could not load XRPL token discovery data."}finally{U.loading=!1}}}function as(e,t){let n=String(e||"").trim().toLowerCase(),s=U.filters||{type:"all",minCap:0,minVol:0,hasDex:!1};return t.filter(a=>{if(n&&!`${a.symbol} ${a.name} ${a.issuer} ${a.tokenId||""}`.toLowerCase().includes(n)||Number(s.minCap||0)>0&&Number(a.marketCap||0)<Number(s.minCap||0)||Number(s.minVol||0)>0&&Number(a.volume24h||0)<Number(s.minVol||0)||s.hasDex&&!(Number(a.volume24h||0)>0||Number(a.holders||0)>100))return!1;if(s.type&&s.type!=="all"){let o=String(a.symbol||"").toLowerCase(),i=String(a.name||"").toLowerCase(),r=/usd|usdc|usdt|rlusd|eur|gbp/.test(o)||/stable/.test(i),l=/meme|dog|cat|frog|shib|pepe/.test(o)||/meme/.test(i),c=/mpt/.test(o)||/multi-purpose/.test(i);if(s.type==="stablecoin"&&!r||s.type==="meme"&&!l||s.type==="mpt"&&!c||s.type==="standard"&&(r||l||c))return!1}return!0})}function Ml(e){return[...e].sort((t,n)=>{let s=Number(t.volume24h||0),a=Number(n.volume24h||0);if(a!==s)return a-s;let o=Number(t.marketCap||0);return Number(n.marketCap||0)-o}).slice(0,24)}async function nd(e){if(Pt.loading=!0,Pt.error="",Pt.items=[],!e){Pt.loading=!1;return}try{let t=await vi(e,20);Pt.items=t||[]}catch(t){Pt.error=(t==null?void 0:t.message)||"Could not load recent transactions."}finally{Pt.loading=!1}}function sd(e){U.query=e,Ls&&clearTimeout(Ls),Ls=setTimeout(()=>{U.listLimit=240,U.filtered=as(U.query,U.tokens),j()},300)}function ad(e,t){U.filters={...U.filters,[e]:t},U.listLimit=240,U.filtered=as(U.query,U.tokens),j()}function od(){Ls&&clearTimeout(Ls),U.query="",U.filters={type:"all",minCap:0,minVol:0,hasDex:!1},U.listLimit=240,U.filtered=as("",U.tokens),j()}function id(){U.listLimit=Math.min(5e3,Number(U.listLimit||240)+240),j()}function rd(){let e=U.filtered;U.listLimit=Math.min(5e3,Math.max(240,e.length)),j()}function ld(){U.listLimit=240,j()}function cd(e){U.selectedTokenKey=e||"",j()}function dd(e){let t=String(e||"").trim();if(!t)return;let n=li();n.includes(t)||n.push(t),Kl(n),j()}function pd(e){let t=String(e||"").trim(),n=li().filter(s=>s!==t);Kl(n),j()}async function Da(e){let t=String(e||"").trim();if(!t)return;let n=String(t.includes("|")?t.split("|")[0]:t).toUpperCase(),s=t.includes("|")?U.tokens.find(o=>Ue(o)===t):U.tokens.find(o=>String(o.symbol||"").toUpperCase()===String(n||"").toUpperCase());U.selectedTokenKey=s?Ue(s):t.includes("|")?t:U.selectedTokenKey,M.tokenFocusKey=U.selectedTokenKey||t;let a={BTC:"BINANCE:BTCUSDT",ETH:"BINANCE:ETHUSDT",SOL:"BINANCE:SOLUSDT"};M.pair=a[n]||"BITSTAMP:XRPUSD",At(),j(),setTimeout(()=>df(),20),await Is(),At(),j()}async function ud(e){return Da(e)}async function md(){await td(),j()}async function mi(){let e=document.getElementById("xpd-lookup-currency"),t=document.getElementById("xpd-lookup-issuer"),n=String((e==null?void 0:e.value)||"").trim().toUpperCase(),s=String((t==null?void 0:t.value)||"").trim();if(!n){ge("Enter a currency code first.");return}if(!s||!Xe(s)){ge("Enter a valid XRPL issuer address.");return}let a=`${n}|${s}`,o=U.tokens.find(i=>Ue(i)===a);o||(o={symbol:n,name:n,issuer:s,price:null,marketCap:null,volume24h:null,holders:null,tokenId:""},U.tokens=[...U.tokens,o],U.filtered=as(U.query,U.tokens)),U.selectedTokenKey=a,e&&(e.value=""),t&&(t.value=""),await Da(a)}async function fd(){var s,a;let e=String(((s=document.getElementById("xpd-lookup-currency"))==null?void 0:s.value)||"").trim().toUpperCase(),t=String(((a=document.getElementById("xpd-lookup-issuer"))==null?void 0:a.value)||"").trim();if(!e){ge("Enter a currency code first.");return}if(!t||!Xe(t)){ge("Enter a valid XRPL issuer address.");return}let n=`${e}|${t}`;await mi(),await ci(n)}async function hd(){var t;let e=((t=Et())==null?void 0:t.address)||"";await nd(e),j()}async function ts({silent:e=!1,force:t=!1}={}){var s;if(!t&&!Ma())return;let n=((s=Et())==null?void 0:s.address)||"";e||ae("Refreshing XRPL dashboard data..."),await Promise.allSettled([Is(),sc(),td(),nd(n),ac(n),oc(n),rc()]),j()}function gd(){return sc()}function vd(){var e;return ac(((e=Et())==null?void 0:e.address)||"")}function bd(){var e;return oc(((e=Et())==null?void 0:e.address)||"")}function yd(){return rc()}function wd(e){ae(`NFT ${e.slice(0,12)}... selected. Send flow can be wired to NFTokenCreateOffer.`)}function Ds(){let e=w("profile-metrics-row");if(!e)return;let t=!1,n=Object.values(Ye).reduce((u,d)=>u+((d==null?void 0:d.xrp)||0),0),s=xd(),a=Object.values(Ye).flatMap(u=>(u==null?void 0:u.tokens)||[]),o=Et(),i=o?Ms[o.address]:null,r=(i==null?void 0:i.ownerCount)||0,l=Ta+r*Ca,c=o!=null&&o.createdAt?Ch(new Date(o.createdAt)):"\u2014",p=(i==null?void 0:i.sequence)!=null?i.sequence:"\u2014";e.innerHTML=`
    ...
    ${t?`<div class="social-preview-row">
    ...
    </div>`:""}`,La("stat-socials-val",t)}function kd(e){let t=ss.find(l=>l.id===e);if(!t)return;let n=w("social-modal");if(!n)return;let s=w("social-modal-icon"),a=w("social-modal-title"),o=w("social-modal-sub"),i=w("social-modal-input"),r=w("social-modal-delete");s&&(s.className=`social-platform-icon-lg social-icon ${t.id}`,s.textContent=t.icon),a&&(a.textContent=`Connect ${t.label}`),o&&(o.textContent=`Enter your ${t.label} ${t.id==="discord"?"user ID or username":"username"}.`),i&&(i.value=Ge[e]||"",i.placeholder=`Your ${t.label} handle`),r&&(r.style.display=Ge[e]?"":"none"),n.dataset.platform=e,n.classList.add("show"),setTimeout(()=>i==null?void 0:i.focus(),80)}function $d(){let e=w("social-modal"),t=e==null?void 0:e.dataset.platform,n=w("social-modal-input");if(!t||!n)return;let s=n.value.trim().replace(/^@/,"");s?Ge[t]=s:delete Ge[t],ql(),fi(),os();let a=ss.find(o=>o.id===t);ig(),kt("social_connected",`${(a==null?void 0:a.label)||t} @${s||"(removed)"}`),ae(`${a==null?void 0:a.label} updated`)}function Sd(){var t;let e=(t=w("social-modal"))==null?void 0:t.dataset.platform;e&&(delete Ge[e],ql(),fi(),os(),kt("social_removed",e),ae("Social connection removed"))}function Td(e){let t=ss.find(n=>n.id===e);t&&Ge[e]&&window.open(`${t.prefix}${Ge[e]}`,"_blank","noopener")}function os(){var e;(e=w("social-modal"))==null||e.classList.remove("show")}function $t(){let e=w("profile-tab-wallets");if(!e)return;if(le.length===0){e.innerHTML=Ph()+`
      ...
      </div>`,La("stat-wallets-val",0);return}let t=le.length>3?`
    ...
    </div>`:"",n=le.filter(a=>!es||a.label.toLowerCase().includes(es.toLowerCase())||a.address.toLowerCase().includes(es.toLowerCase())),s=n.map((a,o)=>Mh(a,le.indexOf(a))).join("");e.innerHTML=t+(n.length?s:`<div class="wcard-empty">No wallets match "${y(es)}"</div>`)+`
    ...
    </div>`,La("stat-wallets-val",le.length)}function Mh(e,t){let n=e.id===dt,s=!!e.watchOnly,a=Ye[e.address],o=Ms[e.address],r=!0||s,l=(o==null?void 0:o.ownerCount)||0,c=Ta+l*Ca,p=r?a?_(a.xrp,2):"\u2014":"\u2022\u2022\u2022\u2022",u=a&&r?Math.max(0,a.xrp-c):null,d=(a==null?void 0:a.tokens)||[],m=a!=null&&a.fetchedAt?Vl(a.fetchedAt):null,f=e.address.slice(0,8)+"\u2026"+e.address.slice(-6),v=gi(e.address);return`
  <div class="wcard ${n?"wcard--active":""} ${s?"wcard--watch":""}" id="wallet-item-${e.id}" style="--i:${t}">
    <div class="wcard-top">
      ...
      <div class="wcard-balance-col">
        ${v.length>=2?`<div class="wcard-sparkline">${Nd(v,70,22,e.color||"#00fff0")}</div>`:""}
  ...
  </div>`}function Cd(e){var n;let t=le[e];t&&(le.splice(e,1),Rs(),dt===t.id&&(dt=((n=le[0])==null?void 0:n.id)||null,dt&&Z(Es,dt)),$t(),Bt(),kt("wallet_removed",t.label),Lh(`Wallet "${t.label}" removed`,()=>{le.splice(e,0,t),Rs(),dt||(dt=t.id,Z(Es,t.id)),$t(),Bt(),kt("wallet_created",t.label+" (restored)")},()=>{t.address&&vt(ei+t.address)}))}function Lh(e,t,n){let s=document.getElementById("undo-toast");s&&s.remove();let a=document.createElement("div");a.id="undo-toast",a.className="undo-toast",a.innerHTML=`<span class="undo-msg">${y(e)}</span><button class="undo-btn">Undo</button>`,document.body.appendChild(a),requestAnimationFrame(()=>a.classList.add("show"));let o=setTimeout(()=>{a.classList.remove("show"),setTimeout(()=>a.remove(),300),n==null||n()},5e3);a.querySelector(".undo-btn").addEventListener("click",()=>{clearTimeout(o),t(),a.classList.remove("show"),setTimeout(()=>a.remove(),300),ae("Wallet restored")})}function Pd(e){var n,s;let t=w("inspect-addr");t&&(t.value=e),(n=window.switchTab)==null||n.call(window,document.querySelector('[data-tab="inspector"]'),"inspector"),(s=window.showDashboard)==null||s.call(window)}function Md(e){Rn=Rn===e?null:e,Rn&&!dn[e]&&(dn[e]="txns"),$t(),Rn&&setTimeout(()=>hi(e,dn[e]),60)}function Ld(e,t){dn[e]=t;let n=document.getElementById(`wcard-drawer-${e}`);n&&(n.querySelectorAll(".wdt-btn").forEach(s=>s.classList.toggle("active",s.textContent.toLowerCase().includes(t==="txns"?"trans":t==="nfts"?"nft":t==="orders"?"dex":"amm"))),hi(e,t))}async function hi(e,t){var a,o,i;let n=le.find(r=>r.id===e),s=document.getElementById(`wcard-drawer-body-${e}`);if(!(!n||!s)){s.innerHTML='<div class="wdd-loading"><div class="spinner"></div> Loading\u2026</div>';try{t==="txns"?s.innerHTML=Ah(((a=ni[n.address])==null?void 0:a.txns)||await vi(n.address),n.address):t==="nfts"?s.innerHTML=Eh(((o=_l[n.address])==null?void 0:o.nfts)||await Wh(n.address),n.address):t==="orders"?s.innerHTML=Nh(((i=si[n.address])==null?void 0:i.offers)||await Uh(n.address),n.id,n.address):t==="amm"&&(s.innerHTML=await Rh(n.address))}catch(r){s.innerHTML=`<div class="wdd-error">\u26A0\uFE0F ${y(r.message)}</div>`}}}function Ad(e){return{Payment:"\u{1F4B8}",OfferCreate:"\u{1F4CA}",OfferCancel:"\u2715",TrustSet:"\u{1F517}",NFTokenMint:"\u{1F3A8}",NFTokenBurn:"\u{1F525}",NFTokenCreateOffer:"\u{1F3AF}",NFTokenAcceptOffer:"\u2705",AMMCreate:"\u{1F30A}",AMMDeposit:"\u{1F4E5}",AMMWithdraw:"\u{1F4E4}",AMMVote:"\u{1F5F3}",AMMBid:"\u{1F4A1}",EscrowCreate:"\u23F3",EscrowFinish:"\u2705",EscrowCancel:"\u2715",AccountSet:"\u2699",SetRegularKey:"\u{1F511}",SignerListSet:"\u{1F4CB}"}[e]||"\u{1F4C4}"}function Zo(e){return e?typeof e=="string"?`${_(Number(e)/1e6,4)} XRP`:`${_(parseFloat(e.value||0),4)} ${(e.currency||"?").length>4?e.currency.slice(0,4)+"\u2026":e.currency}`:"\u2014"}function Ah(e,t){return e!=null&&e.length?`<div class="wdd-tx-list">
    ${e.slice(0,25).map(n=>{var c,p;let s=n.TransactionType||"?",a=n.Account===t,o=!(((c=n.metaData)==null?void 0:c.TransactionResult)||((p=n.meta)==null?void 0:p.TransactionResult)||"").match(/^tec|^tem|^tef|^tel/),i=n.date?(n.date+946684800)*1e3:0,r=i?new Date(i).toLocaleDateString("en-US",{month:"short",day:"numeric",hour:"2-digit",minute:"2-digit"}):"\u2014",l=n.hash||n.tx_hash||"";return`<div class="wdd-tx-row ${o?"":"wdd-tx-failed"}">
        <div class="wdd-tx-icon">${Ad(s)}</div>
    ...
    </div>`:'<div class="wdd-empty"><div class="wdd-empty-icon">\u{1F4CA}</div><div>No open DEX orders.</div></div>'}async function Rh(e){try{let n=(ti[e]||[]).filter(s=>{var a;return((a=s.currency)==null?void 0:a.length)===40});return n.length?`<div class="wdd-amm-list">
    ...
    </div>`:'<div class="wdd-empty"><div class="wdd-empty-icon">\u{1F30A}</div><div>No AMM LP positions.</div><div class="wdd-empty-sub">Deposit into an AMM pool to earn fees.</div></div>'}catch(t){return`<div class="wdd-error">\u26A0\uFE0F ${y(t.message)}</div>`}}async function Ed(e,t,n){let s=prompt("Optional seed to cancel this order (leave blank to use wallet password):");if(s!==null){n&&(n.disabled=!0,n.textContent="\u2026");try{let a=await Jh(e,t,s);if(Vh(a)){ae("Order cancelled \u2713");let o=le.find(i=>i.id===e);o&&(delete si[o.address],hi(e,"orders"))}else Wt("Cancel failed: "+Gh(a)),n&&(n.disabled=!1,n.textContent="\u2715 Cancel")}catch(a){Wt(a.message),n&&(n.disabled=!1,n.textContent="\u2715 Cancel")}}}function _h(){let e=w("profile-tab-activity");if(!e)return;let t=ff(),n=Et();e.innerHTML=`
        ...
        ${t.length?`<div class="act-timeline">${t.slice(0,20).map(s=>`
            <div class="act-entry">
              ...
              <div class="act-entry-body">
                ...
                <div class="act-entry-time">${Vl(s.ts)}</div>
              </div>
    ...
    <div class="settings-card">
      ...
      <div class="settings-kv-list">
        ...
        <div class="settings-kv"><span class="settings-k">Wallets</span><span class="settings-v">${le.length} stored</span></div>
      </div>
    </div>
    ...
    <div class="settings-card settings-card--danger">
  ...
  </div>`}async function Dh(){var t;let e=w("profile-tab-analytics");if(e){e.innerHTML='<div class="analytics-grid"><div class="skeleton-card analytics-card--wide" style="height:80px"></div><div class="skeleton-card" style="height:160px"></div><div class="skeleton-card" style="height:160px"></div></div>';try{let n=Et(),s=Object.values(Ye).reduce((r,l)=>r+((l==null?void 0:l.xrp)||0),0),a=xd(),o=Object.values(Ye).flatMap(r=>(r==null?void 0:r.tokens)||[]),i=[];if(n)try{i=((t=ni[n.address])==null?void 0:t.txns)||await vi(n.address,100)}catch{}e.innerHTML=`<div class="analytics-grid">
      <div class="analytics-card analytics-card--wide">
        <div class="analytics-card-hdr"><span class="analytics-card-title">\u{1F4BC} Portfolio Summary</span>
          <span class="analytics-badge">${le.length} wallet${le.length!==1?"s":""}</span></div>
        <div class="portfolio-summary-row">
          ${le.length?le.map(r=>{let l=Ye[r.address],c=l?_(l.xrp,2):"\u2014",p=l&&a?`$${_(l.xrp*a,2)}`:"",u=gi(r.address);return`<div class="portfolio-wallet-row">
                ...
                <div class="pwr-sparkline">${Nd(u,80,28,r.color||"#00fff0")}</div>
        ...
        <div class="portfolio-totals">
          ...
          <div class="ptotal"><span class="ptotal-label">Wallets</span><span class="ptotal-val">${le.length}</span></div>
        </div>
      </div>
      ...
      <div class="analytics-card analytics-card--wide">
        ...
        ${n?Fh(i):'<div class="analytics-empty">Activate a wallet to see activity.</div>'}
      </div>
      ...
      <div class="analytics-card">
        ...
        ${i.length?Oh(i):'<div class="analytics-empty-chart"><div class="aec-icon">\u{1F4CA}</div><div>Transaction breakdown builds up as this wallet transacts.</div></div>'}
      </div>
      ...
      <div class="analytics-card">
        ...
        ${n&&i.length?Xh(i,n.address):`<div class="analytics-empty-chart"><div class="aec-icon">\u{1F4B0}</div><div>${n?"XRP flow needs at least one transaction to estimate.":"Activate a wallet to see XRP flow."}</div></div>`}
      </div>
    ...
    </div>`}catch(n){uf(e,"analytics",n)}}}function Nd(e,t,n,s){if(e.length<2)return`<svg width="${t}" height="${n}"><line x1="0" y1="${n/2}" x2="${t}" y2="${n/2}" stroke="${s}" stroke-opacity=".2" stroke-width="1" stroke-dasharray="3 2"/></svg>`;let a=e.map(u=>u.xrp),o=Math.min(...a),i=Math.max(...a),r=i-o||1,l=a.map((u,d)=>`${3+d/(a.length-1)*(t-6)},${3+(1-(u-o)/r)*(n-6)}`),[c,p]=l[l.length-1].split(",");return`<svg width="${t}" height="${n}" viewBox="0 0 ${t} ${n}">
  ...
  </svg>`}function Ih(e){let t=gi(e);if(t.length<2)return`<div class="analytics-empty-chart"><div class="aec-icon">\u{1F4CA}</div><div>Balance history builds up as you refresh your wallet over time.</div><div class="aec-sub">${t.length} snapshot${t.length!==1?"s":""} recorded.</div></div>`;let n=560,s=130,a=52,o=12,i=14,r=30,l=t.map(R=>R.xrp),c=t.map(R=>R.ts),p=Math.min(...l),u=Math.max(...l),d=u-p||1,m=c[0],f=c[c.length-1],v=f-m||1,b=R=>a+(R-m)/v*(n-a-o),h=R=>i+(1-(R-p)/d)*(s-i-r),g=t.map(R=>`${b(R.ts).toFixed(1)},${h(R.xrp).toFixed(1)}`),x=b(c[0]),k=b(c[c.length-1]),T=l[l.length-1]-l[0],S=T>=0,$=l[0]?Math.abs(T/l[0]*100).toFixed(2):"0.00",N=S?"#00d4ff":"#ff5555",C=[p,(p+u)/2,u].map(R=>({v:R,y:h(R),l:_(R,2)})),P=[0,.5,1].map(R=>({x:a+R*(n-a-o),l:new Date(m+R*v).toLocaleDateString("en-US",{month:"short",day:"numeric"})}));return`
    ...
    <div class="balance-chart-wrap"><svg class="balance-chart-svg" viewBox="0 0 ${n} ${s}" preserveAspectRatio="none">
      ...
      <path d="M${x.toFixed(1)},${s-r} L${g.join(" L")} L${k.toFixed(1)},${s-r} Z" fill="url(#bg${e.slice(-4)})"/>
      <polyline points="${g.join(" ")}" fill="none" stroke="${N}" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
    ...
    </svg></div>`}function Fh(e){if(!e.length)return'<div class="analytics-empty-chart"><div class="aec-icon">\u{1F4C5}</div><div>Activity heatmap fills in as this wallet transacts.</div></div>';let t=new Map;e.forEach(f=>{f.date&&t.set(new Date((f.date+946684800)*1e3).toISOString().slice(0,10),(t.get(new Date((f.date+946684800)*1e3).toISOString().slice(0,10))||0)+1)});let n=26,s=12,a=2,o=new Date,i=Array.from({length:n*7},(f,v)=>{let b=new Date(o);return b.setDate(b.getDate()-(n*7-1-v)),b}),r=Array.from({length:n},(f,v)=>i.slice(v*7,v*7+7)),l=Math.max(1,...t.values()),c=n*(s+a)+30,p=7*(s+a)+28,u=f=>f===0?"rgba(255,255,255,.07)":`rgb(0,${Math.round(85+f*170)},${Math.round(119+f*121)})`,d=[],m=-1;return r.forEach((f,v)=>{var h;let b=(h=f[0])==null?void 0:h.getMonth();b!==m&&(m=b,d.push({wi:v,l:f[0].toLocaleDateString("en-US",{month:"short"})}))}),`<div class="heatmap-meta"><span>${e.length} tx \xB7 ${t.size} active days</span>
  ...
  <div class="heatmap-scroll"><svg class="heatmap-svg" viewBox="0 0 ${c} ${p}" width="${c}" height="${p}">
    ${d.map(({wi:f,l:v})=>`<text x="${26+f*(s+a)}" y="10" font-size="9" fill="rgba(255,255,255,.38)" font-family="Outfit,sans-serif">${v}</text>`).join("")}
    ...
    ${r.map((f,v)=>f.map((b,h)=>{let g=b.toISOString().slice(0,10),x=t.get(g)||0;return`<rect x="${26+v*(s+a)}" y="${16+h*(s+a)}" width="${s}" height="${s}" rx="2" fill="${u(x/l)}" opacity="${x>0?.9:.25}"><title>${g}: ${x} tx</title></rect>`}).join("")).join("")}
  </svg></div>`}function Oh(e){let t=new Map;e.forEach(a=>t.set(a.TransactionType||"?",(t.get(a.TransactionType||"?")||0)+1));let n=[...t.entries()].sort((a,o)=>o[1]-a[1]),s=e.length;return`<div class="tx-breakdown-list">${n.slice(0,8).map(([a,o])=>`<div class="txb-row"><div class="txb-icon">${Ad(a)}</div><div class="txb-type">${a}</div><div class="txb-bar-wrap"><div class="txb-bar" style="width:${(o/s*100).toFixed(0)}%"></div></div><div class="txb-count">${o}</div></div>`).join("")}</div>`}function Bh(e){let t=new Map;e.forEach(o=>{let i=Math.abs(parseFloat(o.balance||0));t.set(o.currency,(t.get(o.currency)||0)+i)});let n=[...t.entries()].sort((o,i)=>i[1]-o[1]).slice(0,8),s=n.reduce((o,[,i])=>o+i,0)||1,a=["#00fff0","#00d4ff","#bd93f9","#50fa7b","#ffb86c","#ff79c6","#f1fa8c","#ff5555"];return`<div class="token-alloc-list">${n.map(([o,i],r)=>{let l=(i/s*100).toFixed(1),c=a[r%a.length],p=o.length>4?o.slice(0,4)+"\u2026":o;return`<div class="ta-row"><div class="ta-swatch" style="background:${c}"></div><div class="ta-cur mono">${p}</div><div class="ta-bar-wrap"><div class="ta-bar" style="width:${l}%;background:${c}20;border-color:${c}55"></div></div><div class="ta-pct">${l}%</div></div>`}).join("")}</div>`}function Xh(e,t){let n=0,s=0;e.forEach(i=>{var c,p;if(i.TransactionType!=="Payment"||!((((c=i.metaData)==null?void 0:c.TransactionResult)||((p=i.meta)==null?void 0:p.TransactionResult))==="tesSUCCESS")||typeof i.Amount!="string")return;let l=Number(i.Amount)/1e6;i.Destination===t&&(n+=l),i.Account===t&&(s+=l)});let a=n-s,o=a>=0;return`<div class="xrp-flow-grid">
  ...
  <div class="xrf-note">Based on ${e.length} fetched Payment TXs. Excludes fees and DEX fills.</div>`}async function st(e){var n,s;try{if(((n=X.wsConn)==null?void 0:n.readyState)===1){let{wsSend:a}=await import("./xrpl-6AERZ5KD.js"),o={command:e==null?void 0:e.method,...((s=e==null?void 0:e.params)==null?void 0:s[0])||{}},i=await a(o);if((i==null?void 0:i.status)==="error")throw new Error(i.error_message||i.error||"XRPL RPC error");return(i==null?void 0:i.result)||null}}catch{}let t=async a=>{let o=await fetch(a,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(e),mode:"cors"});if(!o.ok)throw new Error(`HTTP ${o.status}`);return(await o.json()).result};try{return await t(Om)}catch{return await t(Bm)}}async function Fn(e){var t;try{let n=[],s;do{let l=await st({method:"account_lines",params:[{account:e,ledger_index:"current",limit:400,...s?{marker:s}:{}}]});if(!l||l.error)break;n.push(...l.lines||[]),s=l.marker}while(s);let a=await st({method:"account_info",params:[{account:e,ledger_index:"current"}]});if(a!=null&&a.error)return null;let o=Number(a.account_data.Balance)/1e6,i=n.map(l=>({currency:l.currency,issuer:l.account,balance:l.balance,limit:l.limit}));Ye[e]={xrp:o,tokens:i,fetchedAt:Date.now()},ti[e]=i,zh(e,o);let r=document.getElementById("awb-balance");return r&&e===((t=Et())==null?void 0:t.address)&&rg(r.querySelector(".awb-xrp-num")||r,o,2,600),Ye[e]}catch{return null}}async function Hh(){await Promise.allSettled(le.map(e=>Fn(e.address))),$t(),Bt(),Ds()}function zh(e,t){let n=ei+e,s=ve(Q(n))||[],a=Date.now();s.length&&a-s[s.length-1].ts<5*6e4?s[s.length-1]={xrp:t,ts:a}:s.push({xrp:t,ts:a}),s.length>90&&s.splice(0,s.length-90),Z(n,JSON.stringify(s))}function gi(e){return ve(Q(ei+e))||[]}async function vi(e,t=25){let n=await st({method:"account_tx",params:[{account:e,limit:t,ledger_index_min:-1,ledger_index_max:-1}]}),s=((n==null?void 0:n.transactions)||[]).map(a=>a.tx||a.transaction||a);return ni[e]={txns:s,fetchedAt:Date.now()},s}async function Wh(e){let t=await st({method:"account_nfts",params:[{account:e,limit:50}]}),n=(t==null?void 0:t.account_nfts)||[];return _l[e]={nfts:n,fetchedAt:Date.now()},n}async function Uh(e){let t=await st({method:"account_offers",params:[{account:e,limit:50}]}),n=(t==null?void 0:t.offers)||[];return si[e]={offers:n,fetchedAt:Date.now()},n}async function jh(e){let t=await st({method:"account_info",params:[{account:e,ledger_index:"current"}]});return(t==null?void 0:t.account_data)||null}async function qh(){let e=await st({method:"ledger",params:[{ledger_index:"current"}]});return(e==null?void 0:e.ledger_current_index)||0}function Vh(e){let t=(e==null?void 0:e.engine_result)||"";return t==="tesSUCCESS"||t.startsWith("tes")||(e==null?void 0:e.engine_result_code)===0}function Gh(e){let t=(e==null?void 0:e.engine_result)||"";return Km[t]||(e==null?void 0:e.engine_result_message)||t||"Unknown error"}async function Kh(e,t,n){if(await Aa(),!window.xrpl)throw new Error("xrpl.js library not loaded. Cannot sign transactions.");let s=le.find(i=>i.id===e);if(!s)throw new Error("Wallet not found.");if(s.watchOnly)throw new Error("Watch-only wallets cannot sign transactions.");let a=await Qm(s,n),o;try{o=window.xrpl.Wallet.fromSeed(a,{algorithm:s.algo==="secp256k1"?"secp256k1":"ed25519"})}catch(i){throw new Error("Invalid seed phrase: "+i.message)}if(o.classicAddress!==s.address)throw new Error("Seed does not match this wallet address.");try{let[i,r]=await Promise.all([jh(s.address),qh()]);if(!i)throw new Error("Account not found on-chain. Fund with at least 10 XRP first (base reserve requirement).");let l={...t,Account:s.address,Fee:"12",Sequence:i.Sequence,LastLedgerSequence:r+20},{tx_blob:c,hash:p}=o.sign(l);return{...await st({method:"submit",params:[{tx_blob:c}]}),tx_hash:p}}finally{}}async function Jh(e,t,n){return Kh(e,{TransactionType:"OfferCancel",OfferSequence:parseInt(t)},n)}function Yh(){if(w("send-modal-overlay"))return;let e=document.createElement("div");e.innerHTML=`
  <!-- Send -->
  ...
  <div class="generic-modal-overlay" id="token-details-modal">
  ...
  </div>`,document.body.appendChild(e),["send-modal-overlay","receive-modal-overlay","trustline-modal-overlay","import-address-modal","import-seed-modal","token-details-modal"].forEach(t=>{let n=document.getElementById(t);n==null||n.addEventListener("click",s=>{s.target===n&&(n.classList.remove("show"),n.style.display="")})})}function Rd(){var o;["displayName","handle","bio","location","website"].forEach(i=>{let r=w(`edit-${i}`);r&&(r.value=de[i]||"")});let e=w("editor-avatar-preview");if(e){let i=localStorage.getItem(pn);e.innerHTML=i?`<img src="${i}" class="profile-avatar-img"/>`:de.avatar||"\u{1F30A}"}let t=w("avatar-remove-btn");t&&(t.style.display=localStorage.getItem(pn)?"":"none");let n=w("editor-banner-preview");if(n){let i=localStorage.getItem(Dn);n.style.backgroundImage=i?`url(${i})`:"",n.style.backgroundSize="cover",n.style.backgroundPosition="center",Ns.forEach(r=>n.classList.remove(r)),i||n.classList.add(de.banner||"banner-ocean")}let s=w("avatar-picker-grid");s&&(s.innerHTML=qm.map(i=>`<div class="avatar-option ${de.avatar===i?"active":""}" onclick="selectAvatar('${i}')">${i}</div>`).join(""));let a=w("banner-picker-grid");a&&(a.innerHTML=Ns.map(i=>`<div class="banner-option ${i} ${de.banner===i?"active":""}" onclick="selectBanner('${i}')"></div>`).join("")),(o=w("profile-editor-modal"))==null||o.classList.add("show")}function Bs(){var e;(e=w("profile-editor-modal"))==null||e.classList.remove("show")}function _d(){var e,t,n,s,a;de.displayName=((e=w("edit-displayName"))==null?void 0:e.value.trim())||de.displayName,de.handle=(((t=w("edit-handle"))==null?void 0:t.value.trim())||de.handle).replace(/^@/,"").replace(/\s+/g,"_").toLowerCase(),de.bio=((n=w("edit-bio"))==null?void 0:n.value.trim())||"",de.location=((s=w("edit-location"))==null?void 0:s.value.trim())||"",de.website=((a=w("edit-website"))==null?void 0:a.value.trim())||"",jl(),kt("profile_saved","Profile details updated"),j(),Bs(),ae("Profile saved")}function Dd(e){localStorage.removeItem(pn),de.avatar=e,Be(".avatar-option").forEach(s=>s.classList.toggle("active",s.textContent===e));let t=w("editor-avatar-preview");t&&(t.innerHTML=e);let n=w("avatar-remove-btn");n&&(n.style.display="none")}function Id(e){localStorage.removeItem(Dn),de.banner=e,Be(".banner-option").forEach(n=>n.classList.toggle("active",n.classList.contains(e)));let t=w("editor-banner-preview");t&&(t.style.backgroundImage="",Ns.forEach(n=>t.classList.remove(n)),t.classList.add(e)),j()}function Fd(e){var s;let t=(s=e==null?void 0:e.files)==null?void 0:s[0];if(!t)return;if(t.size>2*1024*1024){ge("Image too large \u2014 max 2 MB");return}let n=new FileReader;n.onload=a=>{let o=new Image;o.onload=()=>{let i=document.createElement("canvas");i.width=i.height=200;let r=i.getContext("2d"),l=Math.min(o.width,o.height);r.drawImage(o,(o.width-l)/2,(o.height-l)/2,l,l,0,0,200,200);let c=i.toDataURL("image/jpeg",.85);localStorage.setItem(pn,c);let p=w("editor-avatar-preview");p&&(p.innerHTML=`<img src="${c}" class="profile-avatar-img"/>`);let u=w("avatar-remove-btn");u&&(u.style.display=""),j(),ae("Profile photo updated")},o.src=a.target.result},n.readAsDataURL(t),e.value=""}function Od(){localStorage.removeItem(pn);let e=w("editor-avatar-preview");e&&(e.innerHTML=de.avatar||"\u{1F30A}");let t=w("avatar-remove-btn");t&&(t.style.display="none"),j()}function Bd(e){var s;let t=(s=e==null?void 0:e.files)==null?void 0:s[0];if(!t)return;if(t.size>5*1024*1024){ge("Image too large \u2014 max 5 MB");return}let n=new FileReader;n.onload=a=>{let o=new Image;o.onload=()=>{let i=document.createElement("canvas");i.width=900,i.height=180;let r=i.getContext("2d"),l=Math.max(900/o.width,180/o.height);r.drawImage(o,(900-o.width*l)/2,(180-o.height*l)/2,o.width*l,o.height*l);let c=i.toDataURL("image/jpeg",.88);localStorage.setItem(Dn,c);let p=w("editor-banner-preview");p&&(p.style.backgroundImage=`url(${c})`,p.style.backgroundSize="cover",p.style.backgroundPosition="center",Ns.forEach(d=>p.classList.remove(d)));let u=w("banner-remove-btn");u&&(u.style.display=""),j(),ae("Banner updated")},o.src=a.target.result},n.readAsDataURL(t),e.value=""}function Xd(){localStorage.removeItem(Dn);let e=w("editor-banner-preview");e&&(e.style.backgroundImage="",Ns.forEach(n=>e.classList.remove(n)),e.classList.add(de.banner||"banner-ocean"));let t=w("banner-remove-btn");t&&(t.style.display="none"),j()}function Qh(){let e=le.map(({id:n,label:s,address:a,algo:o,emoji:i,color:r,testnet:l,watchOnly:c,createdAt:p})=>({id:n,label:s,address:a,algo:o,emoji:i,color:r,testnet:l,watchOnly:c,createdAt:p})),t=document.createElement("a");t.href="data:application/json;charset=utf-8,"+encodeURIComponent(JSON.stringify(e,null,2)),t.download=`nalulf-wallets-${new Date().toISOString().slice(0,10)}.json`,t.click(),kt("backup_exported","Wallet addresses exported"),ae("Wallet addresses exported")}function Hd(){Qh()}function bi(){var e;wt=1,ye={algo:"ed25519",label:"",emoji:"\u{1F48E}",color:"#50fa7b",seed:"",address:"",passphrase:""},_n.clear(),yi(1),eg(),Zh(),(e=w("wallet-creator-overlay"))==null||e.classList.add("show"),setTimeout(()=>{var t;return(t=w("wallet-label-input"))==null?void 0:t.focus()},80)}function Xs(){var e;(e=w("wallet-creator-overlay"))==null||e.classList.remove("show"),ye.seed=ye.address=ye.passphrase=""}function Zh(){let e=w("wizard-security-banner");e&&(e.innerHTML=`<div class="wsb-icon">\u{1F510}</div>
    ...
    </div>`).join("")}async function sg(){var n;let e=await Rl(ye.seed,ye.passphrase),t={id:crypto.randomUUID(),label:ye.label,address:ye.address,algo:ye.algo,emoji:ye.emoji,color:ye.color,testnet:((n=w("wallet-testnet-check"))==null?void 0:n.checked)||!1,watchOnly:!1,encSeed:e,createdAt:new Date().toISOString()};le.push(t),Rs(),dt||(dt=t.id,Z(Es,t.id)),$t(),Bt(),La("wallet-success-address",ye.address),setTimeout(()=>{ye.seed="",ye.address="",ye.passphrase=""},100),kt("wallet_created",ye.label||"New XRPL Wallet"),ae("Wallet created and encrypted locally"),Fn(t.address).then(()=>$t())}function Ud(e){ye.algo=e,Be(".algo-card").forEach(t=>t.classList.toggle("active",t.dataset.algo===e))}function jd(e){ye.emoji=e,Be(".wallet-emoji-opt").forEach(t=>t.classList.toggle("active",t.textContent===e))}function qd(e){ye.color=e,Be(".color-swatch").forEach(t=>t.classList.toggle("active",t.style.background===e||t.dataset.color===e))}function Vd(e){let t=document.querySelector(`.security-check-${e}`);if(!t)return;let n=t.querySelector(".check-box");_n.has(e)?(_n.delete(e),t.classList.remove("checked"),n&&(n.textContent="")):(_n.add(e),t.classList.add("checked"),n&&(n.textContent="\u2713")),Gd()}function Gd(){let e=w("wizard-next-btn");e&&wt===2&&(e.disabled=_n.size<4)}function Kd(){var t;(t=w("wizard-seed-value"))==null||t.classList.remove("blur");let e=w("seed-reveal-hint");e&&(e.style.display="none"),setTimeout(()=>{var n;return(n=w("wizard-seed-value"))==null?void 0:n.classList.add("blur")},3e4)}function Jd(){let e=w("wizard-seed-value");if(!e)return;Ia(e.textContent,3e4);let t=w("btn-copy-seed");t&&(t.textContent="Copied!",t.classList.add("copied"),setTimeout(()=>{t.textContent="Copy Seed",t.classList.remove("copied")},2e3))}function Yd(){let e=w("wizard-address-value")||w("wallet-success-address");if(!e)return;Ia(e.textContent);let t=w("btn-copy-addr");t&&(t.textContent="Copied!",t.classList.add("copied"),setTimeout(()=>{t.textContent="Copy",t.classList.remove("copied")},2e3))}function Qd(){let e=w("import-address-modal");if(!e)return;e.querySelector("#inp-import-address").value="",e.querySelector("#inp-import-label").value="";let t=e.querySelector("#import-address-error");t&&(t.textContent=""),e.classList.add("show"),setTimeout(()=>{var n;return(n=e.querySelector("#inp-import-address"))==null?void 0:n.focus()},80)}function wi(){var e;(e=w("import-address-modal"))==null||e.classList.remove("show")}function Zd(){var s,a;let e=(((s=w("inp-import-address"))==null?void 0:s.value)||"").trim(),t=(((a=w("inp-import-label"))==null?void 0:a.value)||"").trim()||"Watch Wallet",n=w("import-address-error");if(!Xe(e)){n&&(n.textContent="Enter a valid XRPL address (starts with r\u2026)");return}if(le.find(o=>o.address===e)){n&&(n.textContent="This address is already in your list.");return}le.push({id:"watch_"+Date.now(),label:t,address:e,algo:"\u2014",emoji:"\u{1F441}",color:"#8be9fd",testnet:!1,createdAt:new Date().toISOString(),watchOnly:!0}),Rs(),kt("watch_added",`${t} (${e.slice(0,8)}\u2026)`),wi(),$t(),Bt(),Ds(),Fn(e).then(()=>{$t(),Ds()}),ae(`\u{1F441} Watch-only wallet added: ${t}`)}function ep(){let e=w("import-seed-modal");if(!e)return;e.querySelector("#inp-import-seed").value="",e.querySelector("#inp-import-seed-pass").value="",e.querySelector("#inp-import-seed-pass-confirm").value="",e.querySelector("#inp-import-seed-label").value="";let t=e.querySelector("#import-seed-error");t&&(t.textContent=""),e.classList.add("show"),setTimeout(()=>{var n;return(n=e.querySelector("#inp-import-seed"))==null?void 0:n.focus()},80)}function xi(){var e;(e=w("import-seed-modal"))==null||e.classList.remove("show")}async function tp(){var r,l,c,p,u;let e=(((r=w("inp-import-seed"))==null?void 0:r.value)||"").trim(),t=(((l=w("inp-import-seed-label"))==null?void 0:l.value)||"").trim()||"Imported Wallet",n=(((c=w("inp-import-seed-pass"))==null?void 0:c.value)||"").trim(),s=(((p=w("inp-import-seed-pass-confirm"))==null?void 0:p.value)||"").trim(),a=w("import-seed-error"),o=w("import-seed-btn"),i=d=>{a&&(a.textContent=d)};if(i(""),!e)return i("Enter your seed phrase.");if(n.length<10)return i("Use a wallet password with at least 10 characters.");if(n!==s)return i("Wallet password confirmation does not match.");if(await Aa(),!window.xrpl)return i("xrpl.js not loaded \u2014 cannot derive address from seed.");o&&(o.disabled=!0,o.textContent="Importing\u2026");try{let d=window.xrpl.Wallet.fromSeed(e),m=d.address,f=(u=d.algorithm)!=null&&u.toLowerCase().includes("ed")?"ed25519":"secp256k1";if(le.find(x=>x.address===m))return i("This address is already in your vault.");let v="imp_"+Date.now(),b="\u{1F511}",h="#bd93f9",g=await Rl(e,n);le.push({id:v,label:t,address:m,algo:f,emoji:b,color:h,testnet:!1,watchOnly:!1,encSeed:g,createdAt:new Date().toISOString()}),Rs(),kt("wallet_imported",`${t} (${m.slice(0,8)}\u2026)`),xi(),$t(),Bt(),Fn(m).then(()=>{$t(),Ds()}),ae(`\u{1F511} Wallet imported: ${t}`)}catch(d){i("Invalid seed: "+(d.message||"Could not derive wallet."))}finally{o&&(o.disabled=!1,o.textContent="Import Wallet \u2192");let d=document.getElementById("inp-import-seed");d&&(d.value="");let m=document.getElementById("inp-import-seed-pass");m&&(m.value="");let f=document.getElementById("inp-import-seed-pass-confirm");f&&(f.value="")}}function np(e,t,n){var p;let s=w("token-details-modal");if(!s)return;let a=s.querySelector(".generic-modal");if(!a)return;let o=Ye[n],i=(p=o==null?void 0:o.tokens)==null?void 0:p.find(u=>u.currency===e&&u.issuer===t),r=i?_(parseFloat(i.balance||0),6):"\u2014",l=i!=null&&i.limit?_(parseFloat(i.limit),2):"Unlimited",c=e.length>4&&ki(e)||e;a.innerHTML=`
    <div class="tdm-hdr">
    ...
    </div>`,s.classList.add("show")}function sp(){let e=w("token-details-modal");e&&(e.classList.remove("show"),e.style.display="")}function ap(){var s;(s=document.getElementById("pub-profile-overlay"))==null||s.remove();let e=localStorage.getItem(pn),t=ss.filter(a=>Ge[a.id]),n=document.createElement("div");n.id="pub-profile-overlay",n.className="pub-profile-overlay",n.innerHTML=`
    ...
    </div>`,document.body.appendChild(n),requestAnimationFrame(()=>requestAnimationFrame(()=>n.classList.add("show"))),n.addEventListener("click",a=>{a.target===n&&n.remove()})}function op(e){Cn(e),Os(),kt("theme_changed",e)}function ip(e){Z("nalulf_pref_currency",e),Os(),ae(`Display currency: ${e}`)}function rp(e){Z("nalulf_pref_network",e),Os(),ae(`Default network: ${e}`)}function lp(e){Z("nalulf_pref_autolock",e),Os(),ae(`Auto-lock: ${e} minutes`)}window._profileWipeAllData=()=>{confirm("Clear all profile, wallet list, social, and activity data? Encrypted wallet seeds saved on this device will be deleted.")&&(["nalulf_profile","nalulf_wallets","nalulf_social","nalulf_activity_log","nalulf_avatar_img","nalulf_banner_img","naluxrp_active_wallet"].forEach(e=>localStorage.removeItem(e)),le=[],Ge={},dt=null,Ye={},ti={},Vo(),j(),ii("wallets"),ae("Local data cleared"))};function ag(){var e,t,n;(e=w("profile-editor-modal"))==null||e.addEventListener("click",s=>{s.target===s.currentTarget&&Bs()}),(t=w("wallet-creator-overlay"))==null||t.addEventListener("click",s=>{s.target===s.currentTarget&&Xs()}),(n=w("social-modal"))==null||n.addEventListener("click",s=>{s.target===s.currentTarget&&os()})}function og(){let e=[{done:!!de.displayName&&de.displayName!=="Anonymous",label:"Display name"},{done:!!de.bio,label:"Bio"},{done:de.avatar!=="\u{1F30A}"||!!localStorage.getItem(pn),label:"Custom avatar"},{done:!!localStorage.getItem(Dn),label:"Custom banner"},{done:le.length>0,label:"Wallet added"},{done:Object.keys(Ge).length>=1,label:"Social connected"},{done:!!de.location,label:"Location set"},{done:!!de.website,label:"Website added"}],t=e.filter(n=>n.done).length;return{pct:Math.round(t/e.length*100),done:t,total:e.length,checks:e}}function ig(){let e=document.getElementById("profile-completeness");if(!e)return;let{pct:t,checks:n}=og(),s=t===100?"#50fa7b":t>=60?"#00fff0":"#ffb86c",a=2*Math.PI*16,o=t/100*a,i=n.filter(r=>!r.done).map(r=>r.label);e.title=t===100?"Profile complete \u2713":`${t}% \u2014 Missing: ${i.join(", ")}`,e.innerHTML=`
    <div class="pc-wrap">
  ...
  `,document.body.appendChild(e);let t=()=>{e.style.display="none",e.removeAttribute("data-addr"),document.body.classList.remove("modal-open"),qs=!1,Rt=!1};e.addEventListener("click",a=>{a.target===e&&t()}),(n=w("acctPeekClose"))==null||n.addEventListener("click",t),(s=w("acctPeekInspect"))==null||s.addEventListener("click",async()=>{let a=e.getAttribute("data-addr");a&&await Mg(a),t()})}function Tg(){Tp||(Tp=!0,document.addEventListener("click",e=>{var s,a;let t=(a=(s=e.target).closest)==null?void 0:a.call(s,"[data-addr]");if(!t)return;let n=t.getAttribute("data-addr");n&&(e.preventDefault(),Pg(n))}))}function Dp(e){var r,l,c;if(!e||!((r=Ne==null?void 0:Ne.window)!=null&&r.length))return null;let t=0,n=0,s=0;for(let p of Ne.window)s+=Number(p.total||0),t+=Number(((l=p.byActorCreate)==null?void 0:l.get(e))||0),n+=Number(((c=p.byActorCancel)==null?void 0:c.get(e))||0);let a=t+n;if(!a)return null;let o=a?n/a:0,i=s?a/s:null;return{create:t,cancel:n,total:a,cancelRatio:o,share:i}}function Cg(e){var o;let t=(o=Nt==null?void 0:Nt.acct)==null?void 0:o.get(e);if(!t||!t.intervals||t.intervals.length<6)return null;let n=gn(t.intervals),s=Fi(t.intervals);return!n||s==null?null:{cv:s/n,total:t.total||0}}async function Pg(e){var i,r,l;if(!Xe(e))return;let t=document.getElementById("acctPeekOverlay");if(!t)return;t.style.display="flex",t.setAttribute("data-addr",e),document.body.classList.add("modal-open"),qs=!0,Rt=!0,V("acctPeekAddr",e),V("acctPeekBal","\u2026"),V("acctPeekSeq","\u2026"),V("acctPeekOwner","\u2026"),V("acctPeekFlags","\u2026");let n=w("acctPeekNote"),s=w("acctPeekCtx");n&&(n.textContent="Fetching account_info\u2026"),s&&(s.textContent="Building context\u2026");let a=Nt.acct.get(e),o=((i=a==null?void 0:a.ledgers)==null?void 0:i.length)||0;try{if(!X.wsConn||X.wsConn.readyState!==1){n&&(n.textContent="Not connected to XRPL. Connect first.");return}let c=await Ae({command:"account_info",account:e,ledger_index:"validated",strict:!0}),p=(r=c==null?void 0:c.result)==null?void 0:r.account_data,u=Number((p==null?void 0:p.Balance)??NaN),d=Number.isFinite(u)?u/1e6:null;if(V("acctPeekBal",d==null?"\u2014":`${d.toLocaleString(void 0,{maximumFractionDigits:6})} XRP`),V("acctPeekSeq",(p==null?void 0:p.Sequence)??"\u2014"),V("acctPeekOwner",(p==null?void 0:p.OwnerCount)??"\u2014"),V("acctPeekFlags",(p==null?void 0:p.Flags)!=null?`0x${Number(p.Flags).toString(16)}`:"\u2014"),n){let m=[];d!=null&&d>=pg&&m.push("Large balance (whale-sized).");let f=Cg(e);f&&f.cv<.35&&f.total>10&&m.push(`Bot-like timing signal (CV ${f.cv.toFixed(2)}).`);let v=Dp(e);if(v){let h=Math.round(v.cancelRatio*100),g=v.share!=null?Math.round(v.share*100):null;m.push(`DEX activity: ${v.total} offer tx in window.`),m.push(`Creates ${v.create}, cancels ${v.cancel} (${h}% cancels).`),g!=null&&m.push(`~${g}% of window activity.`)}let b=ce.byAddr.get(e);if(b){let h=Vs(b.level);m.push(`Spam-defense: score ${(b.score*100).toFixed(0)}% \xB7 level L${b.level} \xB7 bond ${h.toLocaleString()} XRP.`),b.verifiedLedger!=null&&m.push(`Credential verified at ledger #${Number(b.verifiedLedger).toLocaleString()}.`)}o>=6&&m.push(`Shows up often in recent ledgers (${o} times).`),m.length||m.push("No obvious red flags from this quick read."),n.textContent=m.join(" ")}if(s){let m=(l=a==null?void 0:a.ledgers)==null?void 0:l.at(-1),f=Dp(e),v=f?`DEX window: ${f.total} (creates ${f.create}, cancels ${f.cancel})`:null,b=_t.filter(k=>k.from===e||k.to===e).slice(0,3),h=b.length?`${b.length} whale tx in session (${b.map(k=>(k.amtXrp>=1e6?(k.amtXrp/1e6).toFixed(1)+"M":(k.amtXrp/1e3).toFixed(0)+"K")+" XRP").join(", ")})`:null,g=ce.byAddr.get(e),x=g?`Spam-defense: L${g.level} \xB7 score ${Math.round(g.score*100)}%`:null;s.textContent=[m?`Last seen around ledger #${Number(m).toLocaleString()}`:"Not in recent window.",v,h,x].filter(Boolean).join(" \xB7 ")}}catch(c){n&&(n.textContent=`Lookup failed: ${String((c==null?void 0:c.message)||c)}`),s&&(s.textContent="\u2014")}}async function Mg(e){if(!Xe(e))return;let t=document.querySelector('.dash-tab[data-tab="inspector"]'),n=document.getElementById("tab-inspector"),s=async()=>n&&n.style.display!=="none"?!0:(typeof window.switchTab=="function"&&t?window.switchTab(t,"inspector"):t==null||t.click(),await new Promise(o=>setTimeout(o,80)),n?n.style.display!=="none":!0);for(let o=0;o<6&&!await s();o++)await new Promise(r=>setTimeout(r,80));let a=document.getElementById("inspect-addr");a&&(a.value=e,a.focus()),await new Promise(o=>setTimeout(o,60)),typeof window.runInspect=="function"?window.runInspect():ge("Inspector not ready yet.")}function Lg(){Be(".net-btn[data-network]").forEach(e=>{e.addEventListener("click",()=>{let t=e.getAttribute("data-network");Be(".net-btn").forEach(s=>{s.classList.toggle("active",s===e),s.setAttribute("aria-pressed",String(s===e))}),Nt.acct.clear(),Us.window=[],Us.totals=new Map,Ne.window=[],Ne.smoothCancelPerMin=null,Ne.smoothBurst=null,Xt.length=0,qa.clear(),je=0,Gt=0,pt=0,Ws=0,Kt=!0,Ga=0,Ri=!1,js=null,Rt=!1,hn=0,us=0,Ya=!1;let n=w("ledgerStreamTrack");n&&(n.innerHTML="",n.style.transform="translateX(0px)"),su(null,null),xv(),ce.byAddr.clear(),ce.selectedAddr=null,ce.selectedProof=null,Bi(),lu(),fs(null),_r(t),Ja({force:!0})})})}var ja=[],Ag=8,Ci=null,Ni=0,zs=null;function Eg(){let e=document.querySelector(".dashboard-metric-grid");if(!e)return;let t=e.closest(".dashboard-metrics")||e.parentElement;t&&t.classList.add("dashboard-sticky-strip"),e.innerHTML=`
  ...
  `}function Ng(e){var v,b,h,g;let t=e.ledgerIndex?Number(e.ledgerIndex):null;V("d2-ledger-index",t?t.toLocaleString():"\u2014");let n=((v=e.latestLedger)==null?void 0:v.closeTimeSec)!=null?Number(e.latestLedger.closeTimeSec):null,s=w("d2-ledger-age");if(s&&(n!=null?(s.textContent=`${n<2?n.toFixed(2):n.toFixed(1)}s close`,s.style.color=n<=3?"#50fa7b":n<=6?"#ffb86c":"#ff6e6e"):(s.textContent="Waiting\u2026",s.style.color="")),n!=null&&(ja.push(n),ja.length>Ag&&ja.shift(),Rg()),Ni=Date.now(),_g(),e.tps!=null){let x=Number(e.tps),k=w("d2-tps");k&&(k.textContent=x.toFixed(1),k.style.color=x<10?"rgba(255,255,255,.65)":x<40?"#50fa7b":x<80?"#ffb86c":"#ff6e6e");let T=w("d2-tps-trend");if(T){let S=X.tpsHistory||[],$=S.length>2?(S.slice(-10).reduce((C,P)=>C+P,0)/Math.min(S.length,10)).toFixed(1):null,N=x<10?"Low":x<40?"Normal":x<80?"High":"Peak";T.textContent=$?`${N} \xB7 avg ${$}`:N,T.style.color=x<10?"rgba(255,255,255,.55)":x<40?"#50fa7b":x<80?"#ffb86c":"#ff6e6e"}}let a=(((b=e.latestLedger)==null?void 0:b.totalTx)??e.txPerLedger)||0,o=w("d2-tx-per-ledger");o&&(o.textContent=a>0?a.toLocaleString():"\u2014",o.style.color=a<10?"rgba(255,255,255,.65)":a<150?"#50fa7b":a<400?"#ffb86c":"#ff6e6e");let i=w("d2-tx-spread");i&&a>0&&(i.textContent=a<10?"Very light":a<50?"Light":a<150?"Normal":a<400?"High volume":"Very high volume",i.style.color=a<150?"":a<400?"#ffb86c":"#ff6e6e");let r=e.avgFee!=null?Number(e.avgFee):((h=e.latestLedger)==null?void 0:h.avgFee)!=null?Number(e.latestLedger.avgFee):null;if(r!=null){let x=Math.round(r*1e6),k=w("d2-fee-value");k&&(k.textContent=fn(r),k.style.color=x<=15?"#50fa7b":x<=50?"rgba(255,255,255,.9)":x<=200?"#ffb86c":"#ff6e6e");let T=w("d2-fee-delta");if(T)if(Ci!=null){let $=r/Ci;$>1.05?(T.textContent="\u2191",T.style.color="#ff6e6e",T.title=`+${(($-1)*100).toFixed(0)}% vs prev ledger`):$<.95?(T.textContent="\u2193",T.style.color="#50fa7b",T.title=`-${((1-$)*100).toFixed(0)}% vs prev ledger`):(T.textContent="\u2192",T.style.color="rgba(255,255,255,.35)",T.title="Stable vs prev ledger")}else T.textContent="";Ci=r;let S=w("d2-fee-pressure");if(S){let $=x<=15?"Base fee":x<=50?`${x} drops`:x<=200?`${x} drops \xB7 Elevated`:`${x} drops \xB7 Surge`;S.textContent=$,S.style.color=x<=50?"":x<=200?"#ffb86c":"#ff6e6e"}}let l=e.successRate!=null?Number(e.successRate):((g=e.latestLedger)==null?void 0:g.successRate)!=null?Number(e.latestLedger.successRate):null;if(l!=null){let x=w("d2-success-rate");x&&(x.textContent=`${l.toFixed(1)}%`,x.style.color=l>=90?"#50fa7b":l>=75?"#ffb86c":"#ff6e6e");let k=w("d2-success-note");if(k){let T=(100-l).toFixed(1);k.textContent=l>=90?`${T}% failed \xB7 Normal`:l>=75?`${T}% failed \xB7 Watch`:`${T}% failed \xB7 Alert`,k.style.color=l>=90?"":l>=75?"#ffb86c":"#ff6e6e"}}let c=a>0?Math.min(100,a/500*100):null,p=w("d2-network-capacity"),u=w("d2-capacity-note");c!=null&&(p&&(p.textContent=`${c.toFixed(1)}%`,p.style.color=c<20?"rgba(255,255,255,.65)":c<50?"#50fa7b":c<80?"#ffb86c":"#ff6e6e"),u&&(u.textContent=c<20?"Low usage":c<50?"Moderate":c<80?"Heavy":"Near capacity",u.style.color=c<50?"":c<80?"#ffb86c":"#ff6e6e"));let d=e.txTypes||{},m=Object.entries(d).sort(([,x],[,k])=>k-x);if(m.length){let[x,k]=m[0],T=m.reduce((P,[,R])=>P+R,0)||1,S=(k/T*100).toFixed(0),$=typeof It<"u"?It:{},N=w("d2-dominant-type");N&&(N.textContent=x,N.style.color=$[x]||"rgba(255,255,255,.9)");let C=w("d2-dominance-score");if(C){let P=m[1];C.textContent=P?`${S}% \xB7 2nd: ${P[0]}`:`${S}% of txs`}}let f=w("stream-loading");f&&(f.style.display="none")}function Rg(){let e=w("d2-close-sparkline");if(!e||!e.getContext)return;let t=ja;if(t.length<2)return;let n=e.width,s=e.height,a=e.getContext("2d");a.clearRect(0,0,n,s);let o=Math.max(...t,4),i=Math.floor((n-(t.length-1))/t.length),r=1;t.forEach((l,c)=>{let p=Math.max(3,Math.round(l/o*(s-2))),u=c*(i+r),d=s-p,m=l<=3?"rgba(80,250,123,.80)":l<=6?"rgba(255,184,108,.80)":"rgba(255,110,110,.85)";a.fillStyle=m;let f=Math.min(2,i/2);a.beginPath(),a.moveTo(u+f,d),a.lineTo(u+i-f,d),a.quadraticCurveTo(u+i,d,u+i,d+f),a.lineTo(u+i,s),a.lineTo(u,s),a.lineTo(u,d+f),a.quadraticCurveTo(u,d,u+f,d),a.closePath(),a.fill(),c===t.length-1&&(a.fillStyle="rgba(255,255,255,.18)",a.fillRect(u,d,i,Math.min(3,p)))})}function _g(){if(zs&&cancelAnimationFrame(zs),!Jt())return;let e=0,t=n=>{if(!Jt()){zs=null;return}if(n-e>=120){e=n;let s=w("d2-ledger-age-timer");if(s&&Ni>0){let a=(Date.now()-Ni)/1e3;s.textContent=`${a.toFixed(1)}s ago`,s.style.color=a<4?"rgba(255,255,255,.55)":a<7?"#ffb86c":"#ff6e6e",s.style.opacity=a>=7?(.6+.4*Math.sin(Date.now()/300)).toFixed(2):"1"}}zs=requestAnimationFrame(t)};zs=requestAnimationFrame(t)}function Dg(){let e=w("tx-mix");if(!e)return;let t=Object.entries(X.txMixAccum||{}).filter(([,s])=>s>0).sort(([,s],[,a])=>a-s).slice(0,10),n=t.reduce((s,[,a])=>s+a,0);n&&(e.innerHTML=t.map(([s,a])=>{let o=(a/n*100).toFixed(1),i=It[s]||"#6b7280";return`
      ...
      </div>`}).join(""))}var St=class{constructor(t,n="#00fff0",s="area"){this.canvasId=t,this.canvas=w(t),this.color=n,this.mode=s}_resolveCanvas(){return this.canvas||(this.canvas=w(this.canvasId)),this.canvas}draw(t){let n=this._resolveCanvas();if(!n||!(t!=null&&t.length))return;let s=n.getContext("2d");if(!s)return;let a=n.width=n.offsetWidth||300,o=n.height=n.offsetHeight||180;if(s.clearRect(0,0,a,o),t.length<2)return;let i=Math.min(...t)*.9,r=Math.max(...t)*1.05||1,l=b=>1-(b-i)/(r-i||1),c={l:10,r:10,t:10,b:12},p=a-c.l-c.r,u=o-c.t-c.b,d=p/(t.length-1),m=t.map((b,h)=>[c.l+h*d,c.t+l(b)*u]),f=gn(t);if(f!=null){let b=c.t+l(f)*u;s.beginPath(),s.moveTo(c.l,b),s.lineTo(c.l+p,b),s.strokeStyle="rgba(255,255,255,0.16)",s.lineWidth=1,s.stroke()}if(t.length>=up+2){let h=kg(t,up).map((g,x)=>[c.l+x*d,c.t+l(g)*u]);s.beginPath(),h.forEach(([g,x],k)=>k===0?s.moveTo(g,x):s.lineTo(g,x)),s.strokeStyle="rgba(255,255,255,0.22)",s.lineWidth=1.5,s.stroke()}if(this.mode==="bar"){let b=Math.max(1,d-3);t.forEach((h,g)=>{let x=(1-l(h))*u,k=c.l+g*d-b/2,T=s.createLinearGradient(0,c.t,0,c.t+u);T.addColorStop(0,this.color),T.addColorStop(1,this.color+"33"),s.fillStyle=T,s.fillRect(k,c.t+u-x,b,x)});return}let v=s.createLinearGradient(0,c.t,0,c.t+u);v.addColorStop(0,this.color+"aa"),v.addColorStop(1,this.color+"11"),s.beginPath(),m.forEach(([b,h],g)=>g===0?s.moveTo(b,h):s.lineTo(b,h)),s.lineTo(m.at(-1)[0],c.t+u),s.lineTo(m[0][0],c.t+u),s.closePath(),s.fillStyle=v,s.fill(),s.beginPath(),m.forEach(([b,h],g)=>g===0?s.moveTo(b,h):s.lineTo(b,h)),s.strokeStyle=this.color,s.lineWidth=2,s.lineJoin="round",s.stroke()}},we={};function Ig(){we.tps=new St("chart-tps","#50fa7b","area"),we.fee=new St("chart-fee","#ffb86c","area"),we.tps2=new St("chart-tps2","#50fa7b","bar"),we.fee2=new St("chart-fee2","#ffb86c","area"),we.dexPressure=new St("chart-dex-pressure","#00d4ff","bar"),we.nftMints=new St("chart-nft-mints","#bd93f9","bar"),we.nftBurns=new St("chart-nft-burns","#ff5555","bar"),we.autoBridge=new St("chart-autobridge","#f1fa8c","bar"),we.marketPrice=new St("chart-market-price","#50fa7b","area"),we.marketVol=new St("chart-market-vol","#8be9fd","bar")}function Ht(e,t=Yt){let n=xg(e,t).filter(r=>Number.isFinite(r));if(!n.length)return{cur:null,avg:null,deltaPct:null,vol:null};let s=n.at(-1),a=gn(n),o=Fi(n),i=a&&a!==0?(s-a)/a*100:null;return{cur:s,avg:a,deltaPct:i,vol:o}}function Fg(){if(bp)return;bp=!0;let e=(t,n)=>{let s=w(t);if(!s)return;let a=s.closest(".widget-card"),o=a==null?void 0:a.querySelector(".widget-header");if(!o||document.getElementById(n))return;let i=document.createElement("div");i.className="trend-mini",i.id=n,i.innerHTML=`
    ...
    `,o.appendChild(i)};e("chart-tps","tpsTrendMini"),e("chart-fee","feeTrendMini"),e("chart-tps2","tpsTrendMini2"),e("chart-fee2","feeTrendMini2")}function Ha(e,t,n,s){let a=document.getElementById(e);if(!a)return;let o=(i,r)=>{let l=a.querySelector(`[data-k="${i}"]`);l&&(l.textContent=r)};if(t.cur==null){o("now","\u2014"),o("avg","\u2014"),o("delta","\u2014"),o("sigma","\u2014");return}o("now",`${Number(t.cur).toFixed(n)}${s}`),o("avg",t.avg!=null?`${Number(t.avg).toFixed(n)}${s}`:"\u2014"),o("delta",t.deltaPct==null?"\u2014":vn(t.deltaPct,0)),o("sigma",t.vol==null?"\u2014":`${Number(t.vol).toFixed(Math.max(0,n-1))}${s}`)}function Og(){var n,s,a,o,i,r,l,c,p,u;(n=we.tps)==null||n.draw(X.tpsHistory),(s=we.fee)==null||s.draw(X.feeHistory),(a=we.tps2)==null||a.draw(X.tpsHistory),(o=we.fee2)==null||o.draw(X.feeHistory);let e=Ht(X.tpsHistory,Yt),t=Ht(X.feeHistory,Yt);Ha("tpsTrendMini",e,2,""),Ha("tpsTrendMini2",e,2,""),Ha("feeTrendMini",t,0,"d"),Ha("feeTrendMini2",t,0,"d"),(i=we.dexPressure)==null||i.draw(fe.dexPressure),(r=we.nftMints)==null||r.draw(fe.nftMints),(l=we.nftBurns)==null||l.draw(fe.nftBurns),(c=we.autoBridge)==null||c.draw(fe.autoBridge),(p=we.marketPrice)==null||p.draw(fe.marketPrice),(u=we.marketVol)==null||u.draw(fe.marketVol)}function Bg(){let e=w("ledger-log"),t=w("ledger-log-loading"),n=w("ledger-log-count");if(!e||!(X.ledgerLog||[]).length)return;t&&(t.style.display="none"),n&&(n.textContent=X.ledgerLog.length);let s=w("tab-network");!s||s.style.display==="none"||(e.innerHTML=`<div class="ledger-log-row log-head">
      ...
      </div>`).join(""))}var Xt=[],qa=new Set,je=0,za=null,Ws=0,Gt=0,pt=0,Kt=!0,Wa=0,Rt=!1,Ga=0,Ri=!1,js=null,hn=0,us=0,Ya=!1,Xg=.18;function Hg(){zg(),Wg()}function zg(){let e=w("ledgerStreamParticles");if(e){e.innerHTML="";for(let t=0;t<14;t++){let n=document.createElement("div");n.className="ledger-particle",n.style.left=Math.random()*100+"%",n.style.top=20+Math.random()*60+"%",n.style.animationDuration=6+Math.random()*8+"s",n.style.animationDelay=Math.random()*5+"s",e.appendChild(n)}}}function Wg(){if(za)return;let e=w("ledgerStreamShell");e&&(e.addEventListener("mouseenter",()=>{Rt=!0}),e.addEventListener("mouseleave",()=>{qs||(Rt=!1)}));let t=w("ledgerStreamTrack");t&&t.addEventListener("click",s=>{let a=s.target.closest("article.ledger-card");if(!a)return;let o=Number(a.dataset.ledgerIndex);Number.isFinite(o)&&(s.shiftKey?js===o?(js=null,qs||(Rt=!1),Ip()):(js=o,Rt=!0,Ip()):Ug(o))});let n=s=>{Ws||(Ws=s);let a=Math.min(.05,(s-Ws)/1e3);Ws=s;let o=Jt()?w("ledgerStreamTrack"):null;if(o&&je>0){if(Kt){let i=o.scrollWidth||0;if(i>100)pt=Math.floor(i/2),Kt=!1,Wa=0,je>0&&(hn=pt/je);else{Wa++,Wa>30&&(Kt=!1,Wa=0),za=requestAnimationFrame(n);return}}if(pt>0&&!Rt&&Ya){let i=Math.min(1,a/Xg);Gt+=(us-Gt)*i,Math.abs(us-Gt)<.5&&(Gt=us);let r=Gt%pt;o.style.transform=`translateX(${-r}px)`}if(!Rt&&Math.floor(s/250)!==Math.floor((s-a*1e3)/250)){let i=Date.now(),r=o.querySelectorAll("article.ledger-card[data-arrival-ts]"),l=12e4;r.forEach(c=>{let p=i-Number(c.dataset.arrivalTs||i),u=Math.max(.52,1-p/l*.48);c.style.opacity=u.toFixed(3)})}if(Ga>0){let i=Date.now()-Ga>gg;Ka(i)}}za=requestAnimationFrame(n)};za=requestAnimationFrame(n),window.addEventListener("resize",()=>{Kt=!0})}function Zp(){if(hn<=0||pt<=0||je===0)return Gt;let e=w("ledgerStreamShell"),t=e&&e.offsetWidth||800,n=hn-14,a=(je-1)*hn+n-t+18;a=Math.max(0,a);let i=Math.floor(Gt/pt)*pt+a;return i<Gt-2&&(i+=pt),i}function Ka(e,t){if(e===Ri)return;Ri=e;let n=w("ledgerStreamShell");if(!n)return;let s=n.querySelector(".stream-stall-overlay");e?(s||(s=document.createElement("div"),s.className="stream-stall-overlay",n.appendChild(s)),s.innerHTML=`<span class="stream-stall-dot"></span> ${y(t||"Waiting for ledgers\u2026")}`):s==null||s.remove()}function Ip(){document.querySelectorAll(".ledger-card").forEach(e=>{let t=Number(e.dataset.ledgerIndex);e.classList.toggle("ledger-card--pinned",t===js)})}function Ug(e){let t=document.querySelector('.dash-tab[data-tab="inspector"]');typeof window.switchTab=="function"&&t?window.switchTab(t,"inspector"):t==null||t.click();let n=document.getElementById("inspect-addr");n&&(n.placeholder=`Ledger #${e.toLocaleString()} \u2014 paste an address`,n.focus())}function jg(){var t;let e=w("ledgerStreamShell");e&&(e.classList.remove("stream-reconnect-flash"),e.offsetWidth,e.classList.add("stream-reconnect-flash"),setTimeout(()=>e.classList.remove("stream-reconnect-flash"),1200),wg=((t=ds.at(-1))==null?void 0:t.li)??0,qg())}function qg(){let e=document.getElementById("reconnect-banner");if(!e){e=document.createElement("div"),e.id="reconnect-banner",e.className="reconnect-banner";let s=document.querySelector(".dashboard-col-main");s&&s.prepend(e)}e.style.display="",e.innerHTML=`
    ...
    <button onclick="document.getElementById('reconnect-banner').style.display='none'"
      style="margin-left:auto;background:none;border:none;color:inherit;opacity:.5;cursor:pointer;font-size:.9rem">\u2715</button>`;let t=3,n=setInterval(()=>{let s=document.getElementById("reconnect-countdown");if(s&&(s.textContent=t),t--,t<0){clearInterval(n);let a=document.getElementById("reconnect-banner");a&&(a.style.display="none")}},4e3)}function Fp(){let e=w("ledgerStreamTrack"),t=w("ledgerStreamShell"),n=w("stream-loading");if(!e||!t)return;if(n&&(n.style.display="none"),Xt.length===0){e.innerHTML='<div style="padding:40px;opacity:.6">Waiting for ledgers\u2026</div>',je=0,Kt=!0;return}let s=[...Xt].sort((o,i)=>o.ledgerIndex-i.ledgerIndex),a=s.map((o,i)=>tu(o,{prevIndex:i>0?s[i-1].ledgerIndex:null}));e.innerHTML=a.concat(a).join(""),je=s.length,Kt=!0,requestAnimationFrame(()=>{var i;let o=((i=w("ledgerStreamTrack"))==null?void 0:i.scrollWidth)||0;o>100&&(pt=Math.floor(o/2),hn=je>0?pt/je:0,us=Zp(),Ya=!0,Kt=!1)})}function Vg(e){var f,v;if(!e)return;let t=Number(e.ledgerIndex??NaN);if(!Number.isFinite(t)||qa.has(t))return;qa.add(t),Xt.push(e);let n=0;if(Xt.length>hp){let b=Xt.splice(0,Xt.length-hp);b.forEach(h=>qa.delete(h.ledgerIndex)),n=b.length}Ga=Date.now(),Ka(!1),Kg(e.avgFee!=null?Number(e.avgFee):null);let{auraClass:s,domColor:a}=Jg(e);su(s,a);let o=w("stream-loading");o&&(o.style.display="none");let i=w("ledgerStreamTrack");if(!i)return;if(je===0){Fp();return}let r=Xt.length>=2?Xt[Xt.length-2].ledgerIndex:0;if(t<r){Fp();return}let l=je,c=tu(e),p=document.createElement("template");p.innerHTML=c;let u=p.content.firstElementChild,d=i.children[l];d?i.insertBefore(u,d):i.appendChild(u);let m=document.createElement("template");if(m.innerHTML=c,i.appendChild(m.content.firstElementChild),je=l+1,n>0){for(let h=0;h<n;h++)(f=i.children[0])==null||f.remove();let b=je-n;for(let h=0;h<n;h++)(v=i.children[b])==null||v.remove();je-=n}Kt=!0,requestAnimationFrame(()=>{hn<=0&&pt>0&&je>0&&(hn=pt/je),us=Zp(),Ya=!0})}var ms=[],Gg=20;function Kg(e){e==null||!Number.isFinite(e)||(ms.push(e),ms.length>Gg&&ms.shift())}function eu(){return ms.length===0?null:ms.reduce((e,t)=>e+t,0)/ms.length}function tu(e,t={}){let{ledgerIndex:n,closeTimeSec:s,totalTx:a,txTypes:o,avgFee:i}=e,r=o||{},l=a??0,c=Object.entries(r).sort(([,D],[,I])=>I-D)[0],p=(c==null?void 0:c[0])||"Other",u=nu(p),d=typeof It<"u"?It:{},m=D=>d[D]||"#6b7280",f=m(p),v=ps(f,.45)||f,b=ps(f,.14)||f,h=s==null?"\u2014":s<2?`${Number(s).toFixed(2)}s`:`${Number(s).toFixed(1)}s`,g=l>0&&s>0?(l/s).toFixed(1):null,x=i!=null?Number(i):null,k=x!=null?fn(x):"\u2014",T=eu(),S=x!=null&&T!=null&&x>T*3,$=t.prevIndex!=null?Number(n)-t.prevIndex-1:0,N=$>0?`<div class="stream-gap-badge" title="${$} ledger(s) missing">\xB7\xB7\xB7&nbsp;${$} gap</div>`:"",C=D=>l>0?`${(D/l*100).toFixed(1)}%`:"0%",P=(D,I,F)=>I?`<div class="ledger-type-row">
    ...
    <div class="ledger-card-inner">
      <div class="ledger-card-header">
        ...
        <div class="ledger-meta">
          <span class="ledger-tag cut" style="border-color:${v};color:${f}">${y(p)}</span>
  ...
  </article>`}function nu(e){let t=String(e||"");return t==="Payment"?"payment":t.startsWith("Offer")?"offer":t.startsWith("NFToken")?"nft":t==="TrustSet"?"trust":t.startsWith("AMM")?"amm":"other"}function Jg(e){var o;let n=((o=Object.entries(e.txTypes||{}).sort(([,i],[,r])=>r-i)[0])==null?void 0:o[0])||"Other",s=nu(n),a=It[n]||It.Other||"#6b7280";return{dominantTx:n,auraClass:s,domColor:a}}function su(e,t){let n=w("ledgerStreamShell");if(!n)return;if(!e||!t){n.style.removeProperty("--streamTintStrong"),n.style.removeProperty("--streamTintSoft"),n.style.removeProperty("--streamTintBorder");return}let s=ps(t,.16)||"rgba(0,255,240,0.14)",a=ps(t,.06)||"rgba(0,255,240,0.06)",o=ps(t,.22)||"rgba(0,255,240,0.22)";n.style.setProperty("--streamTintStrong",s),n.style.setProperty("--streamTintSoft",a),n.style.setProperty("--streamTintBorder",o),n.dataset.tint=e}function Yg(e){var b,h;let t=Array.isArray(e.recentTransactions)?e.recentTransactions.slice(0,dg):[],n=e.txTypes||{},s=Number(e.ledgerIndex||0),a=Object.values(n).reduce((g,x)=>g+x,0)||1,o=0;for(let g of Object.values(n)){let x=g/a;o+=x*x}let i=Qg(t);Zg(Us,i);let r=ev(Us.totals,i),l=tv(Us.totals),c=nv(s,t),p=sv(s,(b=e.latestLedger)==null?void 0:b.closeTimeSec,t),u=av({txs:t,txTypes:n,dexPatterns:p}),d=r.filter(g=>g.count>=2).length,m=ov({hhi:o,repeats:d,dex:p,bots:((h=c.bots)==null?void 0:h.length)||0,advanced:u}),f=iv({friction:m,tps:Ht(X.tpsHistory),fee:Ht(X.feeHistory)}),v=rv({s:e,txTypes:n,hhi:o,dexPatterns:p,behavior:c,friction:m,regime:f,breadcrumbs:r,clusters:l,advanced:u});return{s:e,txs:t,txTypes:n,hhi:o,behavior:c,dexPatterns:p,friction:m,regime:f,breadcrumbs:r,clusters:l,narratives:v,advanced:u}}function Qg(e){let t=new Map;for(let n of e){let s=n==null?void 0:n.account,a=n==null?void 0:n.destination;if(!s||!a)continue;let o=`${s}|${a}`;t.set(o,(t.get(o)||0)+1)}return t}function Zg(e,t){e.window.unshift(t);for(let[n,s]of t.entries())e.totals.set(n,(e.totals.get(n)||0)+s);for(;e.window.length>e.maxLedgers;){let n=e.window.pop();for(let[s,a]of n.entries()){let o=(e.totals.get(s)||0)-a;o<=0?e.totals.delete(s):e.totals.set(s,o)}}}function ev(e,t){let s=[...e.entries()].map(([o,i])=>({k:o,c:i})).sort((o,i)=>i.c-o.c).filter(o=>o.c>=2);return(s.length?s:[...t.entries()].map(([o,i])=>({k:o,c:i}))).slice(0,10).map(({k:o,c:i})=>{let[r,l]=o.split("|");return{from:r,to:l,count:i}})}function tv(e){let t=[...e.entries()].filter(([,i])=>i>=2),n=t.length?t:[...e.entries()],s=new Map;for(let[i]of n){let[r,l]=i.split("|");!r||!l||(s.has(r)||s.set(r,new Set),s.has(l)||s.set(l,new Set),s.get(r).add(l),s.get(l).add(r))}let a=new Set,o=[];for(let i of s.keys()){if(a.has(i))continue;let r=[i],l=[];for(a.add(i);r.length;){let u=r.pop();l.push(u);for(let d of s.get(u)||[])a.has(d)||(a.add(d),r.push(d))}if(l.length<2)continue;let c=l[0],p=-1;for(let u of l){let d=(s.get(u)||new Set).size;d>p&&(p=d,c=u)}o.push({members:l,size:l.length,hub:c})}return o.sort((i,r)=>r.size-i.size),o.slice(0,6)}function nv(e,t){let n=new Map;for(let a of t){let o=a==null?void 0:a.account;o&&n.set(o,(n.get(o)||0)+1)}for(let[a,o]of n.entries()){Nt.acct.has(a)||Nt.acct.set(a,{ledgers:[],intervals:[],total:0});let i=Nt.acct.get(a),r=i.ledgers.at(-1);i.ledgers.push(e),r!=null&&e>r&&i.intervals.push(e-r),i.ledgers.length>30&&i.ledgers.shift(),i.intervals.length>29&&i.intervals.shift(),i.total+=o}let s=[];for(let[a,o]of Nt.acct.entries()){if(o.intervals.length<6)continue;let i=gn(o.intervals),r=Fi(o.intervals);if(!i||r==null)continue;let l=r/i;l<.35&&o.total>10&&s.push({acct:a,cv:l,total:o.total})}if(s.sort((a,o)=>a.cv-o.cv||o.total-a.total),e%50===0)for(let[a,o]of Nt.acct){let i=o.ledgers.at(-1)??e;e-i>1e3&&Nt.acct.delete(a)}return{bots:s.slice(0,6),uniqueActors:n.size}}function sv(e,t,n){var N;let s=0,a=0,o=new Map,i=new Map,r=new Map;for(let C of n){let P=C==null?void 0:C.type,R=C==null?void 0:C.account;R&&(P==="OfferCreate"?(s+=1,o.set(R,(o.get(R)||0)+1),i.set(R,(i.get(R)||0)+1)):P==="OfferCancel"&&(a+=1,o.set(R,(o.get(R)||0)+1),r.set(R,(r.get(R)||0)+1)))}let l=s+a,c=l?a/l:0,p=t!=null&&Number(t)>0?a/Number(t)*60:null;for(Ne.smoothCancelPerMin=_p(Ne.smoothCancelPerMin,p,.45),Ne.window.unshift({li:e,closeTimeSec:t??null,create:s,cancel:a,total:l,cancelRatio:c,cancelsPerMin:Ne.smoothCancelPerMin,byActor:o,byActorCreate:i,byActorCancel:r});Ne.window.length>ug;)Ne.window.pop();let u={create:0,cancel:0,total:0},d=new Map,m=new Map,f=new Map;for(let C of Ne.window){u.create+=C.create,u.cancel+=C.cancel,u.total+=C.total;for(let[P,R]of C.byActor.entries())d.set(P,(d.get(P)||0)+R);for(let[P,R]of C.byActorCancel.entries())m.set(P,(m.get(P)||0)+R);for(let[P,R]of C.byActorCreate.entries())f.set(P,(f.get(P)||0)+R)}let v=Pi(d,5),b=Pi(m,5),h=Pi(f,5),g=u.total?(((N=v[0])==null?void 0:N.count)||0)/u.total:0,x=0;if(u.total)for(let C of d.values()){let P=C/u.total;x+=P*P}let k=Ne.window.map(C=>C.total).filter(Number.isFinite),T=gn(k)||0,S=T>0?(l-T)/T*100:null;Ne.smoothBurst=_p(Ne.smoothBurst,S,.4);let $=[];return u.total>=Si&&c>=.65&&$.push("Lots of cancels (looks like quote-stuffing/spam)"),u.total>=Si&&g>=.35&&$.push("One actor dominates DEX activity"),u.total>=Si&&(Ne.smoothCancelPerMin||0)>=18&&$.push("Fast cancelling (high churn)"),Ne.smoothBurst!=null&&Math.abs(Ne.smoothBurst)>=45&&$.push("Sudden DEX burst"),{now:{li:e,create:s,cancel:a,total:l,cancelRatio:c,cancelsPerMin:Ne.smoothCancelPerMin},window:{...u,cancelRatio:u.total?u.cancel/u.total:0},topShare:g,actorHHI:x,burstPct:Ne.smoothBurst,topActor:v,topCanceller:b,topMaker:h,signals:$}}function Pi(e,t){return[...e.entries()].sort((n,s)=>s[1]-n[1]).slice(0,t).map(([n,s])=>({acct:n,count:s}))}function av({txs:e,txTypes:t,dexPatterns:n}){var B;let s=Number((t==null?void 0:t.OfferCreate)||0)+Number((t==null?void 0:t.OfferCancel)||0),a=Number((t==null?void 0:t.NFTokenMint)||0),o=Number((t==null?void 0:t.NFTokenBurn)||0),i=0,r=new Map,l=new Map;for(let E of e){if((E==null?void 0:E.type)!=="Payment")continue;let z=(E==null?void 0:E.paths)||(E==null?void 0:E.Paths),te=Array.isArray(z)&&z.length>0,oe=(E==null?void 0:E.sendmax)!=null||(E==null?void 0:E.SendMax)!=null,pe=(E==null?void 0:E.delivermax)!=null||(E==null?void 0:E.DeliverMax)!=null;if(!(te||oe||pe))continue;i+=1;let ne=E==null?void 0:E.account,re=E==null?void 0:E.destination;if(ne&&r.set(ne,(r.get(ne)||0)+1),ne&&re){let G=`${ne}|${re}`;l.set(G,(l.get(G)||0)+1)}}let c=[...r.entries()].sort((E,z)=>z[1]-E[1]).slice(0,5).map(([E,z])=>({acct:E,count:z})),p=[...l.entries()].sort((E,z)=>z[1]-E[1]).slice(0,5).map(([E,z])=>{let[te,oe]=E.split("|");return{from:te,to:oe,count:z}}),u=(B=n==null?void 0:n.now)!=null&&B.total?Math.round((n.now.cancelRatio||0)*100):0,d=(n==null?void 0:n.topShare)!=null?Math.round(n.topShare*100):0,m=e.filter(E=>(E==null?void 0:E.type)==="Payment").map(E=>typeof(E==null?void 0:E.amountXrp)=="number"?E.amountXrp:null).filter(E=>E!=null&&E>0&&Number.isFinite(E)),f=[100,1e3,1e4],v=m.filter(E=>f.some(z=>Math.abs(E%z)<1e-9&&E/z>=1)).length,b=m.length>=5?Math.round(v/m.length*100):null,h=e.filter(E=>(E==null?void 0:E.type)==="Payment"&&(E==null?void 0:E.account)&&(E==null?void 0:E.destination)&&E.account===E.destination).length,g=Number((t==null?void 0:t.AMMCreate)||0),x=Number((t==null?void 0:t.AMMDeposit)||0),k=Number((t==null?void 0:t.AMMWithdraw)||0),T=Number((t==null?void 0:t.AMMVote)||0),S=Number((t==null?void 0:t.AMMBid)||0),$=Number((t==null?void 0:t.AMMDelete)||0),N=g+x+k+T+S+$,C=x-k,P=x+k>0?Math.round(x/(x+k)*100):null,R=new Set;for(let E of e)["AMMCreate","AMMDeposit","AMMWithdraw","AMMVote","AMMBid"].includes(E==null?void 0:E.type)&&(E!=null&&E.account)&&R.add(E.account);let O=R.size,D=0,I=0;for(let E of e)(E==null?void 0:E.type)==="Payment"&&Array.isArray(E==null?void 0:E.paths)&&E.paths.length>0&&(D+=E.paths.length,I++);let F=I>0?(D/I).toFixed(1):null;return{offerTotal:s,dexCancelPct:u,dexTopSharePct:d,mints:a,burns:o,pathPays:i,topPathActors:c,topPathPairs:p,roundnessIdx:b,selfTradeCount:h,ammCreate:g,ammDeposit:x,ammWithdraw:k,ammVote:T,ammBid:S,ammDelete:$,lpTotal:N,lpNetFlow:C,lpRatio:P,lpUniqueActors:O,avgPathDepth:F}}function ov({hhi:e,repeats:t,dex:n,bots:s,advanced:a}){var h,g;let o=ke((e-.22)/.25,0,1)*22,i=ke((t-2)/6,0,1)*12,r=((h=n==null?void 0:n.window)==null?void 0:h.cancelRatio)??0,l=(n==null?void 0:n.topShare)??0,c=((g=n==null?void 0:n.now)==null?void 0:g.cancelsPerMin)??0,p=ke((r-.5)/.5,0,1)*18,u=ke((l-.25)/.5,0,1)*18,d=ke(c/25,0,1)*10,m=ke(s/6,0,1)*10,f=(a==null?void 0:a.roundnessIdx)!=null?ke((a.roundnessIdx-30)/40,0,1)*8:0,v=(a==null?void 0:a.selfTradeCount)>0?Math.min(8,a.selfTradeCount*4):0,b=(a==null?void 0:a.pathPays)!=null?ke(a.pathPays/30,0,1)*6:0;return Math.round(o+i+p+u+d+m+f+v+b)}function iv({friction:e,tps:t,fee:n}){let s=(n==null?void 0:n.deltaPct)!=null&&Math.abs(n.deltaPct)>=35,a=(t==null?void 0:t.deltaPct)!=null&&Math.abs(t.deltaPct)>=25;return e>=75?"Manipulated":s||a?"Stressed":((t==null?void 0:t.cur)??0)>=12||((t==null?void 0:t.avg)??0)>=10?"Active":"Quiet"}function rv({s:e,txTypes:t,hhi:n,dexPatterns:s,behavior:a,friction:o,regime:i,breadcrumbs:r,clusters:l,advanced:c}){var h,g,x,k,T;let p=[],u=Ht(X.tpsHistory,Yt),d=Ht(X.feeHistory,Yt),m=((h=Object.entries(t||{}).sort(([,S],[,$])=>$-S)[0])==null?void 0:h[0])||"\u2014",f=Number(e.txPerLedger||0);p.push({sentiment:i==="Manipulated"||i==="Stressed"?"warn":i==="Active"?"up":"ok",title:`Overall: ${i} \xB7 Risk score ${o}/100`,detail:"Heuristic score from concentration, repeats, DEX churn, bot-like timing, and routing indicators. It's a signal, not proof."}),p.push({sentiment:"ok",title:`Ledger snapshot: #${Number(e.ledgerIndex||0).toLocaleString()} \xB7 ${f} tx \xB7 most common: ${m}`,detail:`TPS ${rs(u.cur,2)} (avg ${rs(u.avg,2)} \xB7 ${vn(u.deltaPct,0)}). Fee ${d.cur!=null?fn(d.cur):"\u2014"} (avg ${d.avg!=null?fn(d.avg):"\u2014"} \xB7 ${vn(d.deltaPct,0)}).`});let v=n>=.35?"high":n>=.25?"medium":"low";if(p.push({sentiment:n>=.35?"warn":"ok",title:`Transaction mix: ${v} concentration (HHI ${n.toFixed(2)})`,detail:n>=.35?"A few tx types dominate. Patterns look \u201Cstronger,\u201D but can be misleading.":"Mix is broad. Strong signals usually come from behavior, not just tx type."}),s.window.total){let S=Math.round(s.window.cancelRatio*100),$=Math.round(s.topShare*100);p.push({sentiment:s.signals.length?"warn":"ok",title:`DEX monitor: ${s.window.total} offer tx (window) \xB7 cancels ${S}% \xB7 top actor ~${$}%`,detail:s.signals.length?`Signals: ${s.signals.join(" \xB7 ")}`:"No strong DEX-pattern signals right now.",addr:((g=s.topActor[0])==null?void 0:g.acct)||null})}let b=r.filter(S=>S.count>=2).length;if(b>=2&&p.push({sentiment:"new",title:`Repeating counterparties: ${b} recurring pair(s)`,detail:"Repeated interactions can be routing loops, bots, or coordinated flows. Click addresses for a quick read."}),l!=null&&l.length&&((x=l[0])==null?void 0:x.size)>=3&&p.push({sentiment:"new",title:`Cluster forming: ${l[0].size} wallets \xB7 hub ${W(l[0].hub)}`,detail:"Clusters are co-activity groups (not identity proof). Use as \u201Clikely related behavior.\u201D",addr:l[0].hub}),(k=a.bots)!=null&&k.length){let S=a.bots[0];p.push({sentiment:"warn",title:`Bot-like timing: ${a.bots.length} candidate(s)`,detail:`Low variance in repeated appearances. Top: ${W(S.acct)} (CV ${S.cv.toFixed(2)}).`,addr:S.acct})}if(c!=null&&c.pathPays){let S=(T=c.topPathActors)==null?void 0:T[0];p.push({sentiment:c.pathPays>=18?"warn":"ok",title:`Autobridge-ish routing: ${c.pathPays} path payments (ledger sample)`,detail:S?`Most active routing wallet: ${W(S.acct)} (${S.count}).`:"Paths/SendMax/DeliverMax appear frequently in the sample.",addr:(S==null?void 0:S.acct)||null})}return c!=null&&c.selfTradeCount&&p.push({sentiment:"warn",title:`Self-transfer signal: ${c.selfTradeCount} payment(s) where sender = receiver`,detail:"Self-transfers can be benign (housekeeping) or used to fake activity. Treat as a watch signal."}),((c==null?void 0:c.roundnessIdx)??0)>=45&&p.push({sentiment:"warn",title:`Round-number bias: ${c.roundnessIdx}% of payments are exact multiples of 100/1,000/10,000`,detail:"Round-number bias often shows scripted behavior (bots) rather than human payments."}),p.slice(0,12)}function lv(e){let t=w("d2-breadcrumb-list"),n=w("d2-breadcrumb-meta");if(!t)return;if(!e.length){t.innerHTML='<div class="gateway-item" style="opacity:.6">Watching for repeated interactions\u2026</div>',n&&(n.textContent="\u2014");return}let s=e.filter(a=>a.count>=2).length;n&&(n.textContent=s?`${s} repeats`:"Top interactions"),t.innerHTML=e.slice(0,10).map(a=>`
    <div class="gateway-item gateway-row">
    ...
    </div>`).join("")}function cv(e){let t=w("d2-cluster-list"),n=w("d2-cluster-persistence");if(t){if(!e.length){t.innerHTML='<div class="gateway-item" style="opacity:.6">Building clusters\u2026 (needs repeated activity)</div>',n&&(n.textContent="\u2014");return}n&&(n.textContent=`${e.length} group${e.length!==1?"s":""}`),t.innerHTML=e.slice(0,6).map((s,a)=>{let i=`hsl(${(a*67+120)%360},70%,60%)`,r=s.members.slice(0,4);return`
      ...
      </div>`}).join("")}}function dv(e){let t=w("d2-delta-narratives");if(!t)return;if(!e.length){t.innerHTML='<div class="gateway-item" style="opacity:.6">Building baseline \u2014 narratives appear after 1\u20132 ledgers\u2026</div>';return}let n={up:"#50fa7b",down:"#ff5555",new:"#00d4ff",warn:"#ffb86c",ok:"rgba(255,255,255,.85)"};t.innerHTML=e.map(s=>{let a=n[s.sentiment]||"rgba(255,255,255,.85)",o=s.addr&&Xe(s.addr)?`<button class="addr-link narrative-addr" data-addr="${y(s.addr)}">Peek</button>`:"";return`
  ...
  `,t?t.insertAdjacentElement("afterend",s):n?n.insertAdjacentElement("afterend",s):e.prepend(s)}function mv(){if(yp)return;yp=!0;let e=document.querySelector(".dashboard-col-main");if(!e)return;let t=document.createElement("section");t.className="widget-card",t.id="landscape-card",t.setAttribute("aria-label","Landscape brief"),t.innerHTML=`
  ...
  `,e.prepend(t)}function vv(e){var d,m;if(!document.getElementById("dex-pattern-card"))return;let t=e.window.total||0,n=t?Math.round(e.window.cancelRatio*100):0,s=t?Math.round(e.topShare*100):0;V("dexp-badge",t?`${t} offer tx \xB7 ${n}% cancels`:"Quiet");let a=w("dexp-cancel-bar");a&&(a.style.width=`${ke(n,0,100)}%`),V("dexp-cancel-val",t?`${n}%`:"\u2014");let o=w("dexp-topshare-bar");o&&(o.style.width=`${ke(s,0,100)}%`),V("dexp-topshare-val",t?`${s}%`:"\u2014");let i=e.burstPct,r=i==null?0:Math.min(100,Math.abs(i)),l=w("dexp-burst-bar");l&&(l.style.width=`${r}%`),V("dexp-burst-val",i==null?"\u2014":vn(i,0)),V("dexp-cpm",e.now.cancelsPerMin==null?"\u2014":e.now.cancelsPerMin.toFixed(1)),V("dexp-hhi",t?e.actorHHI.toFixed(2):"\u2014"),V("dexp-totalwin",t?`${t}`:"\u2014");let c=w("dexp-signals");c&&(c.innerHTML=e.signals.length?e.signals.map(f=>`<span class="sig-pill warn">${y(f)}</span>`).join(""):'<span class="sig-pill ok">No strong DEX signals</span>');let p=w("dexp-cancellers");p&&(p.innerHTML=(d=e.topCanceller)!=null&&d.length?e.topCanceller.slice(0,5).map(f=>`
        ...
        <div class="dex-rowline">
          <button class="addr-link mono cut" data-addr="${y(f.acct)}">${y(W(f.acct))}</button>
          <span class="mono">${f.count}</span>
        </div>`).join(""):'<div style="opacity:.7">\u2014</div>')}function bv(){if(xp)return;xp=!0;let e=document.querySelector(".dashboard-col-main");if(!e)return;let t=document.createElement("section");t.className="widget-card",t.id="risk-card",t.setAttribute("aria-label","Risk panel"),t.innerHTML=`
    <div class="widget-header">
  ...
  `,t.querySelectorAll(".risk-box-toggle").forEach(n=>{var a;n.addEventListener("click",()=>{let o=n.getAttribute("data-target"),i=document.getElementById(o);if(!i)return;let r=n.getAttribute("aria-expanded")!=="false";n.setAttribute("aria-expanded",r?"false":"true"),i.classList.toggle("risk-collapsed",r),n.querySelector(".risk-box-chevron").textContent=r?"\u25B8":"\u25BE";try{localStorage.setItem("risk_collapsed_"+o,r?"1":"0")}catch{}});let s=n.getAttribute("data-target");try{localStorage.getItem("risk_collapsed_"+s)==="1"&&(n.setAttribute("aria-expanded","false"),(a=document.getElementById(s))==null||a.classList.add("risk-collapsed"),n.querySelector(".risk-box-chevron").textContent="\u25B8")}catch{}}),e.appendChild(t)}function yv(e){var r,l,c,p,u,d,m,f,v,b;if(!document.getElementById("risk-card"))return;V("risk-badge",`Risk ${e.friction}/100`),V("risk-regime",e.regime),V("risk-friction",`${e.friction}/100`);let t=[];e.hhi>=.35&&t.push({cls:"warn",t:"High concentration"}),e.breadcrumbs.filter(h=>h.count>=2).length>=3&&t.push({cls:"new",t:"Repeating counterparties"}),(l=(r=e.behavior)==null?void 0:r.bots)!=null&&l.length&&t.push({cls:"warn",t:"Bot-like timing"}),(p=(c=e.dexPatterns)==null?void 0:c.signals)!=null&&p.length&&t.push({cls:"warn",t:"DEX churn signals"}),((u=e.advanced)==null?void 0:u.selfTradeCount)>0&&t.push({cls:"warn",t:`Self-transfer: ${e.advanced.selfTradeCount}`}),(((d=e.advanced)==null?void 0:d.roundnessIdx)??0)>=45&&t.push({cls:"warn",t:`Round-number bias ${e.advanced.roundnessIdx}%`}),((m=e.advanced)==null?void 0:m.pathPays)>0&&t.push({cls:"warn",t:`Path flow: ${e.advanced.pathPays}`}),V("risk-signalcount",`${t.length}`);let n=w("risk-pills");n&&(n.innerHTML=t.length?t.map(h=>`<span class="sig-pill ${h.cls}">${y(h.t)}</span>`).join(""):'<span class="sig-pill ok">No elevated signals</span>');let s=w("risk-bots");if(s){let h=((f=e.behavior)==null?void 0:f.bots)||[];if(h.length){let g={};for(let k of h){let T=k.botType||"Periodic";g[T]||(g[T]=[]),g[T].push(k)}let x=["Market Maker","Arbitrage","Flood / Spam","Periodic"];s.innerHTML=x.filter(k=>g[k]).map(k=>{let T=g[k];return`<div class="bot-type-group">
          ...
          `).join("")}
        </div>`}).join("")}else s.innerHTML='<div style="opacity:.7;font-size:.84rem">No periodic bots detected yet</div>'}let a=w("risk-amm");if(a){let h=e.advanced||{},{ammCreate:g=0,ammDeposit:x=0,ammWithdraw:k=0,ammVote:T=0,ammBid:S=0,lpTotal:$=0,lpNetFlow:N=0,lpRatio:C,lpUniqueActors:P=0}=h;if($===0)a.innerHTML='<div style="opacity:.6;font-size:.84rem">No AMM activity in this ledger</div>';else{let R=N>0?"#50fa7b":N<0?"#ff5555":"rgba(255,255,255,.5)";a.innerHTML=`
        <div class="amm-chips">
        ...
        <div class="risk-row"><span>Total LP ops</span><span class="mono">${$}</span></div>`}}let o=w("risk-path");if(o){let h=e.advanced||{},g=(v=h.topPathActors)==null?void 0:v[0],x=(b=h.topPathActors)==null?void 0:b[1],k=h.selfTradeCount>0?"#ff5555":"rgba(255,255,255,.5)",T=(h.roundnessIdx??0)>=45?"#ff5555":(h.roundnessIdx??0)>=25?"#ffb86c":"rgba(255,255,255,.5)";o.innerHTML=`
      ...
      ${g?`<div class="risk-row"><span>Top router</span>
        <button class="addr-link mono cut" data-addr="${y(g.acct)}">${y(W(g.acct))}</button></div>
  ...
  `,e.appendChild(t),(s=w("spam-copy-hash"))==null||s.addEventListener("click",()=>{var i;return Bp(((i=w("spam-proof-hash"))==null?void 0:i.textContent)||"")}),(a=w("spam-copy-json"))==null||a.addEventListener("click",()=>{var i;return Bp(((i=w("spam-proof-json"))==null?void 0:i.textContent)||"")}),(o=w("spam-print-proof"))==null||o.addEventListener("click",_v),_renderBondSim()}window._toggleBondSim=function(){let e=w("spam-sim-panel");if(!e)return;let t=e.style.display!=="none";e.style.display=t?"none":"";let n=w("spam-sim-toggle");n&&(n.style.color=t?"":"#00d4ff")};window._renderBondSim=function(){let e=document.getElementById("sim-base"),t=document.getElementById("sim-growth"),n=document.getElementById("sim-table");if(!n)return;let s=Number((e==null?void 0:e.value)||hs),a=Number((t==null?void 0:t.value)||gs),o=fe.marketPrice.at(-1)??null;document.getElementById("sim-base-val")&&(document.getElementById("sim-base-val").textContent=s+" XRP"),document.getElementById("sim-growth-val")&&(document.getElementById("sim-growth-val").textContent=a+"\xD7");let i="";for(let r=0;r<=Ks;r++){let l=Math.round(s*a**r),c=o?"$"+(l*o).toLocaleString(void 0,{maximumFractionDigits:0}):"",p=r<3?"#50fa7b":r<6?"#ffb86c":"#ff5555";i+=`<div style="padding:5px;border-radius:6px;background:rgba(255,255,255,.03);border:1px solid rgba(255,255,255,.07)">
      ...
      ${c?`<div style="font-size:.62rem;opacity:.45">${c}</div>`:""}
    </div>`}n.innerHTML=i};async function Bp(e){try{await navigator.clipboard.writeText(String(e||"")),ae("Copied")}catch{ge("Copy failed (browser blocked clipboard).")}}function Vs(e){let t=ke(Number(e)||0,0,Ks);return Math.round(hs*gs**t)}function Bi(){try{let e=JSON.parse(localStorage.getItem(Vp)||"[]");ce.allowList=new Set(e)}catch{ce.allowList=new Set}}function ou(){try{localStorage.setItem(Vp,JSON.stringify([...ce.allowList]))}catch{}}function iu(e){Xe(e)&&(ce.allowList.add(e),ou(),ce.byAddr.delete(e),ae(`${W(e)} added to allow-list \u2014 will no longer be flagged`))}window._spamAllowAddr=iu;function ru(){try{return JSON.parse(localStorage.getItem(qp)||"{}")}catch{return{}}}function Sv(e){try{localStorage.setItem(qp,JSON.stringify(e))}catch{}}function lu(){let e=ru();for(let[t,n]of Object.entries(e))ce.verifiedCache.set(t,n)}window.exportSpamReputation=function(){let e=[...ce.byAddr.entries()].map(([o,i])=>({addr:o,level:i.level,strikes:i.strikes,score:+(i.score||0).toFixed(4),threatType:i.threatType||"Unknown",verified:!!i.verifiedLedger,verifiedLedger:i.verifiedLedger??null,lastSeen:i.lastSeenLedger??null})),t={v:2,network:X.currentNetwork||"xrpl-mainnet",exportedAt:new Date().toISOString(),allowList:[...ce.allowList],suspects:e,policy:{bondBaseXrp:hs,bondGrowth:gs,ratchetMax:Ks}},n=new Blob([JSON.stringify(t,null,2)],{type:"application/json"}),s=URL.createObjectURL(n),a=document.createElement("a");a.href=s,a.download=`naluxrp_reputation_${new Date().toISOString().slice(0,10)}.json`,document.body.appendChild(a),a.click(),document.body.removeChild(a),URL.revokeObjectURL(s),ae("Reputation list exported")};window.importSpamReputation=function(e){if(!e)return;let t=new FileReader;t.onload=n=>{var s;try{let a=JSON.parse(n.target.result);if(!a.suspects)throw new Error("Invalid format");let o=0;for(let i of a.suspects){if(!Xe(i.addr))continue;let r=ce.byAddr.get(i.addr)||{};ce.byAddr.set(i.addr,{...r,level:i.level??0,strikes:i.strikes??0,score:i.score??0,threatType:i.threatType??"Unknown",verifiedLedger:i.verifiedLedger??null,lastSeenLedger:i.lastSeen??null,scoreHistory:[],signalBreakdown:{}}),o++}if((s=a.allowList)!=null&&s.length){for(let i of a.allowList)Xe(i)&&ce.allowList.add(i);ou()}ae(`Imported ${o} reputation entries`)}catch(a){ge("Import failed: "+a.message)}},t.readAsText(e)};function Tv(e){var l,c;if(!document.getElementById("spam-defense-card"))return;let t=Lv(e),n=t.reduce((p,u)=>Math.max(p,u.level),0),s=t.filter(p=>p.verified).length,a=fe.marketPrice.at(-1)??null,o=t.reduce((p,u)=>p+Vs(u.level),0),i=a?`~$${(o*a).toLocaleString(void 0,{maximumFractionDigits:0})}`:`${o} XRP`;V("spam-count",t.length),V("spam-maxlvl",`L${n}`),V("spam-verified",s),V("spam-allowcount",ce.allowList.size),V("spam-bondusd",i),V("spam-badge",t.length?`${t.length} tracked \xB7 max L${n}`:"Quiet");let r=w("spam-list");if(r&&(t.length?r.innerHTML=t.map(p=>{let u=Vs(p.level),d=a?` (~$${(u*a).toFixed(0)})`:"",m=p.level>=6?"#ff5555":p.level>=3?"#ffb86c":"#50fa7b",f=p.score>=.7?"#ff5555":p.score>=.4?"#ffb86c":"#50fa7b",v={"Payment Flooder":"#ff5555","Quote Stuffer":"#ff5555","Wash Trader":"#ff5555","DEX Bot":"#ffb86c","Arb Router":"#00d4ff","Periodic Bot":"#bd93f9"}[p.threatType]||"rgba(255,255,255,.6)",b=p.verified?`<span class="spam-cred-chip">\u2714 L${p.level} verified</span>`:"",h=Cv(p.scoreHistory||[]);return`
          <div class="spam-card" data-spam-addr="${y(p.addr)}">
            ...
            <div class="spam-card-meta">
              ...
              <span class="spam-meta-chip" style="color:${v}">${y(p.threatType)}</span>
            ...
            <div class="spam-breakdown" id="spam-bd-${y(p.addr.slice(0,10))}" style="display:none">
              ${Pv(p.breakdown,p.strikes)}
            </div>
          </div>`}).join(""):r.innerHTML=`<div class="spam-empty">No suspects flagged \u2014 allow-list has ${Gp.size} known-good entities.</div>`),_i||Mv(),ce.selectedAddr){let p=ce.byAddr.get(ce.selectedAddr);p?Xi(ce.selectedAddr,p,e.s.ledgerIndex).then(u=>fs(u)):fs(null)}((l=document.getElementById("spam-sim-panel"))==null?void 0:l.style.display)!=="none"&&((c=window._renderBondSim)==null||c.call(window))}function Cv(e){if(!(e!=null&&e.length))return"";let t=42,n=14,s=1,a=t/Math.max(1,e.length-1),o=e.map((l,c)=>`${(c*a).toFixed(1)},${(n-2-l/s*(n-4)).toFixed(1)}`).join(" "),i=e.at(-1)??0,r=i>=.7?"#ff5555":i>=.4?"#ffb86c":"#50fa7b";return`<svg width="${t}" height="${n}" xmlns="http://www.w3.org/2000/svg" style="overflow:visible">
    ...
    <circle cx="${((e.length-1)*a).toFixed(1)}" cy="${(n-2-i/s*(n-4)).toFixed(1)}"
      r="2" fill="${r}"/>
  </svg>`}function Pv(e={},t=0){let n=[{label:"Bot timing",val:e.bot??0,desc:e.botType?`Type: ${e.botType}`:"Low variance in repeated ledger appearances"},{label:"DEX dominance",val:e.dexDom??0,desc:"Share of offer tx window controlled by this address"},{label:"Cancel pattern",val:e.cancelPat??0,desc:"Heavy OfferCancel activity relative to creates"},{label:"Ping-pong loop",val:e.pingPong??0,desc:"Bidirectional repeated payments between two addresses"},{label:"Path routing",val:e.pathRoute??0,desc:"High path-payment count \u2014 common in arb bots"},{label:"Self-transfer",val:e.selfTrade??0,desc:"Payments where sender = receiver"},{label:"Round-number pay",val:e.roundPay??0,desc:"Unusual bias toward exact round-number payment amounts"}].filter(s=>s.val>.001);return n.length?`
    ...
    </div>`:'<div style="opacity:.5;font-size:.78rem;padding:6px 0">No significant signal breakdown available yet.</div>'}var _i=!1;function Mv(){_i||(_i=!0,document.addEventListener("click",e=>{var a,o,i,r;let t=(o=(a=e.target).closest)==null?void 0:o.call(a,"button[data-action][data-spam-addr]");if(!t)return;let n=t.getAttribute("data-action"),s=t.getAttribute("data-spam-addr");if(s){if(n==="proof"){let l=ce.byAddr.get(s);if(!l)return;ce.selectedAddr=s;let c=w("spam-proof");if(c){c.style.display="";let p=w("spam-proof-hash");p&&(p.textContent="Computing SHA-512Half\u2026")}Xi(s,l,((r=(i=X.ledgerLog)==null?void 0:i[0])==null?void 0:r.ledgerIndex)||null).then(p=>{ce.selectedProof=p,fs(p)}).catch(p=>ge("Proof build failed: "+p.message));return}if(n==="clear"){ce.byAddr.delete(s),ce.selectedAddr===s&&fs(null),ae("Cleared from session");return}if(n==="allow"){iu(s),ce.byAddr.delete(s),ce.selectedAddr===s&&fs(null);return}if(n==="expand"){let l=s.slice(0,10),c=document.getElementById("spam-bd-"+l);if(!c)return;let p=c.style.display!=="none";c.style.display=p?"none":"",t.textContent=p?"\u25BE Detail":"\u25B4 Hide";return}}}))}function fs(e){let t=w("spam-proof");if(!t)return;if(!e){t.style.display="none";return}t.style.display="",V("spam-proof-hash",e.hash);let n=w("spam-proof-json");n&&(n.textContent=e.canonicalJson);let s=w("spam-cred-step");s&&(s.innerHTML=`
      <div style="opacity:.9">
    ...
    `)}function Lv(e){var o,i,r,l,c;ce.allowList.size||Bi();let t=new Set;(((o=e.behavior)==null?void 0:o.bots)||[]).forEach(p=>t.add(p.acct)),(((i=e.dexPatterns)==null?void 0:i.topActor)||[]).forEach(p=>t.add(p.acct)),(((r=e.dexPatterns)==null?void 0:r.topCanceller)||[]).forEach(p=>t.add(p.acct)),(((l=e.dexPatterns)==null?void 0:l.topMaker)||[]).forEach(p=>t.add(p.acct)),(e.breadcrumbs||[]).forEach(p=>{t.add(p.from),t.add(p.to)}),(e.clusters||[]).forEach(p=>{t.add(p.hub),(p.members||[]).forEach(u=>t.add(u))}),(((c=e.advanced)==null?void 0:c.topPathActors)||[]).forEach(p=>t.add(p.acct));let n=Number(e.s.ledgerIndex||0)||null,s=e.txs||[],a=[];if(n&&n%50===0){let p=Ua*24;for(let[u,d]of ce.byAddr)n-(d.lastSeenLedger||0)>p&&ce.byAddr.delete(u)}for(let p of t){if(!Xe(p)||Gp.has(p)||ce.allowList.has(p))continue;let{score:u,breakdown:d}=Ev(p,e),m=Av(d),f=ce.byAddr.get(p)||{strikes:0,level:0,score:0,verifiedLedger:null,lastSeenLedger:null,scoreHistory:[],threatType:"Unknown",signalBreakdown:{}},v=f.strikes||0;u>=jp?v+=1:u<=Mi&&(v=Math.max(0,v-1));let b=f.lastSeenLedger||n,h=n?n-b:0;if(h>Ua&&u<Mi){let $=Math.floor(h/Ua);v=Math.max(0,v-$)}let g=ke(Math.floor(v/Up),0,Ks),x=[...f.scoreHistory||[],u].slice(-10),k=ce.verifiedCache.get(p),T=f.verifiedLedger??(k==null?void 0:k.ledgerIndex)??null;T||(T=Nv(p,g,s,n),T&&Rv(p,g,n));let S={score:u,strikes:v,level:g,verifiedLedger:T,lastSeenLedger:n,scoreHistory:x,threatType:m,signalBreakdown:d};ce.byAddr.set(p,S),a.push({addr:p,score:u,strikes:v,level:g,verified:!!T,verifiedLedger:T,scoreHistory:x,threatType:m,breakdown:d})}return a.sort((p,u)=>u.level-p.level||u.score-p.score),a.slice(0,vg)}function Av(e){let{bot:t=0,dexDom:n=0,cancelPat:s=0,pingPong:a=0,pathRoute:o=0,selfTrade:i=0,roundPay:r=0}=e,l=n+s;return t>.25&&(e.botType==="Flood / Spam"||r>.05)?"Payment Flooder":t>.2&&l>.15?"DEX Bot":l>.3&&s>.1?"Quote Stuffer":a>.1?"Wash Trader":o>.1?"Arb Router":t>.2?"Periodic Bot":"Multi-Signal"}function Ev(e,t){var m,f,v,b,h;let n={bot:0,botType:null,dexDom:0,cancelPat:0,pingPong:0,pathRoute:0,selfTrade:0,roundPay:0},s=(((m=t.behavior)==null?void 0:m.bots)||[]).find(g=>g.acct===e);if(s){let g=ke((.35-s.cv)/.35,0,1);n.bot=+(.4*(.5+.5*g)).toFixed(3),n.botType=s.botType||"Periodic"}let a=t.dexPatterns,o=((v=(f=a==null?void 0:a.topActor)==null?void 0:f[0])==null?void 0:v.acct)===e&&a.topShare||0;o>0&&(n.dexDom=+(.3*ke((o-.2)/.4,0,1)).toFixed(3));let i=((a==null?void 0:a.topCanceller)||[]).find(g=>g.acct===e);i&&(n.cancelPat=+(.2*ke(i.count/20,0,1)).toFixed(3));let r=t.breadcrumbs||[],l=r.find(g=>g.from===e&&g.to===e);l&&(n.selfTrade=+(.2*ke(l.count/20,0,1)).toFixed(3));let c=r[0];if(c&&(c.from===e||c.to===e)){let g=r.find(x=>x.from===c.to&&x.to===c.from);g&&g.count>=3&&c.count>=3&&(n.pingPong=.15)}let p=(((b=t.advanced)==null?void 0:b.topPathActors)||[]).find(g=>g.acct===e);p&&(n.pathRoute=+(.15*ke(p.count/25,0,1)).toFixed(3));let u=(h=t.advanced)==null?void 0:h.roundnessIdx;return u!=null&&u>=45&&(p||s)&&(n.roundPay=+(.1*ke((u-45)/35,0,1)).toFixed(3)),{score:ke(n.bot+n.dexDom+n.cancelPat+n.pingPong+n.pathRoute+n.selfTrade+n.roundPay,0,1),breakdown:n}}function Nv(e,t,n,s){if(!(n!=null&&n.length))return null;let a=cs+t;for(let o of n)if((o==null?void 0:o.account)===e){if(o.type==="EscrowCreate"&&o.destination===e){let i=typeof o.amountXrp=="number"?o.amountXrp:null,r=Vs(t);if(i!=null&&i>=r&&Di(o.memos).startsWith(mn))return s}if(o.type==="Payment"&&o.destination===e&&Number(o.destinationTag)===a&&Di(o.memos).startsWith(mn))return s}return null}async function Rv(e,t,n){var a;let s=ce.byAddr.get(e);if(s)try{let o=await Xi(e,s,n),i=mn+o.hash;if((((a=X.ledgerLog)==null?void 0:a.flatMap(c=>c.transactions||[]))||[]).some(c=>(c==null?void 0:c.account)!==e?!1:Di(c.memos).startsWith(i))){let c=ru();c[e]={ledgerIndex:n,hash:o.hash,level:t},Sv(c),ce.verifiedCache.set(e,{ledgerIndex:n,hash:o.hash}),ae(`\u2714 Credential verified for ${W(e)} at L${t}`)}}catch{}}function Di(e){if(!Array.isArray(e))return"";let t=[];for(let n of e){let s=(n==null?void 0:n.Memo)||(n==null?void 0:n.memo)||null;if(!s)continue;let a=s.MemoData||s.memo_data||"";try{if(typeof a=="string"&&/^[0-9A-Fa-f]+$/.test(a)&&a.length%2===0){let o=Uint8Array.from(a.match(/../g),i=>parseInt(i,16));t.push(new TextDecoder().decode(o))}else typeof a=="string"&&t.push(a)}catch{}}return t.join(" ")}async function Xi(e,t,n){let s=t.level||0,a=Vs(s),o=fe.marketPrice.at(-1)??null,i=o?(a*o).toFixed(2):null,r={hashAlgorithm:"SHA-512Half",ratchetMax:Ks,strikesToLevel:Up,strikeUp:jp,strikeDown:Mi,decayLedgers:Ua,bondBaseXrp:hs,bondGrowthFactor:gs,bondRequiredXrp:a,bondRequiredUsd:i,credTagBase:cs,memoPrefix:mn,credentialTag:cs+s},l={v:2,hashAlg:"SHA-512Half",network:X.currentNetwork||"xrpl-mainnet",address:e,ledgerIndex:n!=null?Number(n):null,level:s,threatType:t.threatType||"Unknown",score:Number((t.score||0).toFixed(4)),strikes:Number(t.strikes||0),signalBreakdown:t.signalBreakdown||{},credential:{destinationTag:cs+s,memoFormat:mn+"<SHA-512Half-of-this-proof>",verifiedLedger:t.verifiedLedger??null},policy:r,note:"Generated by NaluXRP Spam Defense POC. Hash uses XRPL-native SHA-512Half (first 256 bits of SHA-512). A gateway or relayer policy can require the indicated bond/credential before providing service to this address.",generatedAt:new Date().toISOString()},c=JSON.stringify(l,Object.keys(l).sort(),0),p=await $g(c);l.credential.memoFormat=mn+p;let u=JSON.stringify(l,null,2);return{hash:p,canonicalJson:u,level:s,policy:r,threatType:t.threatType}}function _v(){let e=ce.selectedProof;if(!e){ge("Generate a proof first using the Proof button.");return}let t=ce.selectedAddr||"\u2014",n=fe.marketPrice.at(-1)??null,s=e.policy.bondRequiredXrp,a=n?` (~$${(s*n).toFixed(0)} USD)`:"",o=e.hash.startsWith("FALLBACK")?'<div style="padding:8px 12px;background:#fff3cd;border:1px solid #f0ad4e;border-radius:4px;margin-bottom:12px">\u26A0 Hash is non-cryptographic (SubtleCrypto unavailable). Do NOT use for enforcement.</div>':"",i=window.open("","_blank","width=760,height=660");i.document.write(`<!DOCTYPE html><html><head>
    ...
    </body></html>`),i.document.close()}var cu=null;function Dv(){if(Li)return;Li=!0;let e=document.querySelector('[aria-label="Pattern detection"]');if(!e){e=document.createElement("section"),e.className="widget-card",e.setAttribute("aria-label","Pattern detection");let t=document.querySelector(".dashboard-col-main");if(!t)return;let n=t.querySelector(".dashboard-metrics");n?n.insertAdjacentElement("afterend",e):t.prepend(e)}e.innerHTML=`
    <div class="widget-header">
    ...
    </div>`,cu=document.getElementById("pattern-donut-canvas")}function Iv(e,t){if(!Li)return;let n=typeof It<"u"?It:{},s=Object.entries(e||{}).filter(([,m])=>m>0).sort(([,m],[,f])=>f-m);if(!s.length)return;let a=s.reduce((m,[,f])=>m+f,0)||1,[o,i]=s[0],r=Math.round(i/a*100),l=s[1],c=w("pattern-badge");c&&(c.textContent=o+" \xB7 "+r+"%");let p=w("pattern-dom-type");if(p&&(p.textContent=o,p.style.color=n[o]||"rgba(255,255,255,.9)"),V("pattern-dom-pct",r+"% of ledger"),l){let m=Math.round(l[1]/a*100),f=w("pattern-2nd-type");f&&(f.textContent=l[0]+" ("+m+"%)",f.style.color=n[l[0]]||"rgba(255,255,255,.7)")}else V("pattern-2nd-type","\u2014");let u=w("pattern-hhi");u&&t!=null&&(u.textContent=t.toFixed(3),u.style.color=t>=.35?"#ff5555":t>=.25?"#ffb86c":"#50fa7b");let d=w("pattern-donut-center");d&&(d.innerHTML='<span style="color:'+(n[o]||"#fff")+';font-size:1.15rem">'+r+"%</span>"),Fv(s,a,n)}function Fv(e,t,n){let s=cu||w("pattern-donut-canvas");if(!(s!=null&&s.getContext))return;let a=s.getContext("2d"),o=s.width/2,i=s.height/2,r=Math.min(s.width,s.height)/2-6,l=r*.56;a.clearRect(0,0,s.width,s.height);let c=e.slice(0,7),p=e.slice(7).reduce((m,[,f])=>m+f,0),u=p>0?[...c,["Other",p]]:[...c],d=-Math.PI/2;for(let[m,f]of u){let v=f/t*Math.PI*2,b=ps(n[m]||"#6b7280",.88)||"#6b7280";a.beginPath(),a.moveTo(o+Math.cos(d)*l,i+Math.sin(d)*l),a.arc(o,i,r,d,d+v),a.arc(o,i,l,d+v,d,!0),a.closePath(),a.fillStyle=b,a.fill(),a.strokeStyle="rgba(0,8,20,0.85)",a.lineWidth=2,a.stroke(),d+=v}a.beginPath(),a.arc(o,i,l-1,0,Math.PI*2),a.fillStyle="rgba(0,21,36,0.94)",a.fill()}function Ov(e,t){let n=!1;for(let s of e){if((s==null?void 0:s.type)!=="Payment")continue;let a=typeof(s==null?void 0:s.amountXrp)=="number"?s.amountXrp:null;a==null||a<Bn.whaleTxXrp||(_t.unshift({ts:Date.now(),ledgerIndex:t,from:s.account||"\u2014",to:s.destination||"\u2014",amtXrp:a,hash:s.hash||""}),Qe.whaleCount++,n=!0)}if(n){for(;_t.length>bg;)_t.pop();Xv()}}function Bv(){if(Lp)return;Lp=!0;let e=document.querySelector(".dashboard-col-side");if(!e)return;let t=document.createElement("section");t.className="widget-card",t.id="whale-feed-card",t.setAttribute("aria-label","Whale alert feed"),t.innerHTML=`
    <div class="widget-header">
    ...
    </div>`,e.prepend(t)}function Xv(){let e=w("whale-feed-list");if(!e)return;let t=w("whale-badge");if(t&&(t.textContent=_t.length?`${_t.length} alerts`:"Watching\u2026"),!_t.length){e.innerHTML='<div style="opacity:.5;font-size:.82rem;padding:8px 0">No whale transactions yet.</div>';return}e.innerHTML=_t.slice(0,20).map(n=>{let s=n.amtXrp>=1e6?`${(n.amtXrp/1e6).toFixed(2)}M`:n.amtXrp>=1e3?`${(n.amtXrp/1e3).toFixed(0)}K`:n.amtXrp.toFixed(0),a=Math.floor((Date.now()-n.ts)/1e3),o=a<60?`${a}s`:a<3600?`${Math.floor(a/60)}m`:`${Math.floor(a/3600)}h`;return`<div style="border-bottom:1px solid rgba(255,255,255,.05);padding:7px 0">
    ...
    </div>`}).join("")}function Hv(){if(Ap)return;Ap=!0;let e=document.querySelector(".dashboard-col-main");if(!e)return;let t=document.createElement("section");t.className="widget-card",t.id="network-health-card",t.setAttribute("aria-label","Network health"),t.innerHTML=`
    <div class="widget-header">
    ...
    <div style="display:flex;align-items:center;gap:16px;padding:8px 0 12px">
      ...
      </div>`}).join(""))}function Wv(){if(Ep)return;Ep=!0;let e=document.querySelector(".dashboard-col-side");if(!e)return;let t=document.createElement("section");t.className="widget-card",t.id="session-stats-card",t.setAttribute("aria-label","Session stats"),t.innerHTML=`
    <div class="widget-header">
    ...
    </div>`,document.body.appendChild(t),e.addEventListener("click",()=>Xp()),(s=document.getElementById("customize-close"))==null||s.addEventListener("click",()=>Xp(!1)),(a=document.getElementById("customize-reset"))==null||a.addEventListener("click",()=>{try{localStorage.removeItem(Va),localStorage.removeItem(vs)}catch{}Hp(),Ii(),Hi()}),(o=document.getElementById("customize-export"))==null||o.addEventListener("click",()=>{var i;try{let r={order:JSON.parse(localStorage.getItem(Va)||"[]"),hidden:JSON.parse(localStorage.getItem(vs)||"[]"),alertConfig:Bn};(i=navigator.clipboard)==null||i.writeText(JSON.stringify(r,null,2)),ae("Config copied to clipboard")}catch{ge("Export failed")}}),Hp(),Ii()}function Xp(e){var s;let t=document.getElementById("customize-panel"),n=document.getElementById("customize-btn");!t||!n||(On=e??!On,t.classList.toggle("customize-panel--open",On),n.setAttribute("aria-pressed",String(On)),n.textContent=On?"\u2715 Close":"\u2699 Customize",On&&Hi(),(s=document.querySelector(".dashboard-col-side"))==null||s.classList.toggle("customize-mode",On))}function Gs(){var e;return[...((e=document.querySelector(".dashboard-col-side"))==null?void 0:e.querySelectorAll(":scope > .widget-card"))||[]]}function bs(e){return e.id||e.getAttribute("aria-label")||""}function Vv(e){var t,n;return((n=(t=e.querySelector(".widget-title"))==null?void 0:t.textContent)==null?void 0:n.trim())||bs(e)}function Hp(){let e=document.querySelector(".dashboard-col-side");if(!e)return;let t;try{t=JSON.parse(localStorage.getItem(Va)||"null")}catch{t=null}if(!Array.isArray(t)||!t.length)return;let n=new Map(Gs().map(s=>[bs(s),s]));t.forEach(s=>{let a=n.get(s);a&&e.appendChild(a)})}function Ii(){let e;try{e=JSON.parse(localStorage.getItem(vs)||"[]")}catch{e=[]}Gs().forEach(t=>t.classList.toggle("widget-hidden",e.includes(bs(t))))}function Gv(){try{localStorage.setItem(Va,JSON.stringify(Gs().map(e=>bs(e))))}catch{}}function Kv(e){let t;try{t=JSON.parse(localStorage.getItem(vs)||"[]")}catch{t=[]}t=t.includes(e)?t.filter(n=>n!==e):[...t,e];try{localStorage.setItem(vs,JSON.stringify(t))}catch{}Ii(),Hi()}function Hi(){let e=document.getElementById("customize-list");if(!e)return;let t;try{t=JSON.parse(localStorage.getItem(vs)||"[]")}catch{t=[]}e.innerHTML="",Gs().forEach(n=>{var r;let s=bs(n),a=Vv(n),o=!t.includes(s),i=document.createElement("div");i.className="customize-row",i.setAttribute("draggable","true"),i.dataset.widgetId=s,i.innerHTML=`
      <span class="customize-drag-handle" title="Drag to reorder">\u283F</span>
      <span class="customize-row-title">${y(a)}</span>
      <button class="customize-vis-btn ${o?"vis-on":"vis-off"}" data-id="${y(s)}">${o?"\u{1F441} Visible":"\u{1F6AB} Hidden"}</button>`,i.addEventListener("dragstart",l=>{is=i,l.dataTransfer.effectAllowed="move",i.classList.add("customize-dragging")}),i.addEventListener("dragend",()=>{i.classList.remove("customize-dragging"),e.querySelectorAll(".customize-row").forEach(p=>p.classList.remove("customize-over"));let l=[...e.querySelectorAll(".customize-row")].map(p=>p.dataset.widgetId),c=document.querySelector(".dashboard-col-side");if(c){let p=new Map(Gs().map(u=>[bs(u),u]));l.forEach(u=>{let d=p.get(u);d&&c.appendChild(d)})}Gv()}),i.addEventListener("dragover",l=>{if(l.preventDefault(),l.dataTransfer.dropEffect="move",is&&is!==i){e.querySelectorAll(".customize-row").forEach(p=>p.classList.remove("customize-over")),i.classList.add("customize-over");let c=[...e.querySelectorAll(".customize-row")];c.indexOf(is)<c.indexOf(i)?e.insertBefore(is,i.nextSibling):e.insertBefore(is,i)}}),i.addEventListener("dragleave",()=>i.classList.remove("customize-over")),i.addEventListener("drop",l=>l.preventDefault()),(r=i.querySelector(".customize-vis-btn"))==null||r.addEventListener("click",()=>Kv(s)),e.appendChild(i)})}function Jv(){if(Rp)return;Rp=!0;let e=document.querySelector(".dashboard-header");if(!e||document.getElementById("global-pause-btn"))return;let t=document.createElement("button");t.id="global-pause-btn",t.className="global-pause-btn",t.setAttribute("aria-pressed","false"),t.title="Pause all updates \u2014 numbers stop changing so you can read",t.innerHTML="\u23F8 Live",t.addEventListener("click",()=>{Vt=!Vt,t.setAttribute("aria-pressed",String(Vt)),t.innerHTML=Vt?"\u25B6 Paused":"\u23F8 Live",t.classList.toggle("global-pause-btn--paused",Vt),Rt=Vt&&!qs?Vt:Rt;let s=document.querySelector(".dashboard-sticky-strip");s&&s.classList.toggle("metrics-paused",Vt)});let n=document.getElementById("customize-btn");n?e.insertBefore(t,n):e.appendChild(t)}var zp=!1;function Yv(){if(zp)return;zp=!0;let e=(t=0)=>{let n=document.querySelector("#risk-card .widget-header"),s=document.querySelector("#landscape-card .widget-header");if(!n&&!s&&t<20){setTimeout(()=>e(t+1),300);return}if(n&&!n.querySelector(".friction-sparkline-wrap")){let a=document.createElement("div");a.className="friction-sparkline-wrap",a.title="Risk score \u2014 last 30 ledgers",a.innerHTML='<canvas id="friction-sparkline-canvas" width="80" height="22"></canvas>',n.appendChild(a)}if(s&&!s.querySelector(".friction-sparkline-wrap")){let a=document.createElement("div");a.className="friction-sparkline-wrap",a.title="Risk score history",a.innerHTML='<canvas id="friction-sparkline-canvas-2" width="60" height="18"></canvas>',s.appendChild(a)}du()};e()}function du(){ds.length&&(Wp("friction-sparkline-canvas",80,22),Wp("friction-sparkline-canvas-2",60,18))}function Wp(e,t,n){let s=document.getElementById(e);if(!(s!=null&&s.getContext))return;let a=s.getContext("2d");a.clearRect(0,0,t,n);let o=ds;if(o.length<2)return;let i=100,r=t/(o.length-1),l=o.map((v,b)=>[b*r,n-2-v.friction/i*(n-4)]),c=n-2-60/i*(n-4);a.fillStyle="rgba(255,85,85,.07)",a.fillRect(0,0,t,c);let p=a.createLinearGradient(0,0,0,n);p.addColorStop(0,"rgba(255,184,108,.35)"),p.addColorStop(1,"rgba(255,184,108,.05)"),a.beginPath(),l.forEach(([v,b],h)=>h===0?a.moveTo(v,b):a.lineTo(v,b)),a.lineTo(l.at(-1)[0],n),a.lineTo(0,n),a.closePath(),a.fillStyle=p,a.fill();let u=o.at(-1).friction,d=u<26?"#50fa7b":u<61?"#ffb86c":"#ff5555";a.beginPath(),l.forEach(([v,b],h)=>h===0?a.moveTo(v,b):a.lineTo(v,b)),a.strokeStyle=d,a.lineWidth=1.5,a.lineJoin="round",a.stroke();let[m,f]=l.at(-1);a.beginPath(),a.arc(m,f,2.5,0,Math.PI*2),a.fillStyle=d,a.fill()}window.printLandscapeReport=function(){var i,r,l,c;if(!document.getElementById("landscape-card"))return;let t=((i=document.getElementById("d2-ledger-index"))==null?void 0:i.textContent)||"\u2014",n=((r=document.getElementById("landscape-badge"))==null?void 0:r.textContent)||"",s=new Date().toLocaleString(),a=window.open("","_blank","width=860,height=700");a.document.write(`<!DOCTYPE html><html><head>
  ...
  `,e.appendChild(t);let n=s=>{var a;return(a=document.querySelector(`.dash-tab[data-tab="${s}"]`))==null?void 0:a.click()};t.addEventListener("click",s=>{let a=s.target.closest("button[data-go]");if(!a)return;let o=a.dataset.go;if(o==="stream"||o==="inspector"||o==="network"){n(o);return}n("stream"),setTimeout(()=>{var r;let i=o==="dex"?"dex-pattern-card":"risk-card";(r=document.getElementById(i))==null||r.scrollIntoView({behavior:"smooth",block:"start"})},80)})}function Zv(){var a,o;if($p)return;$p=!0;let e=document.querySelector(".dashboard-header");if(!e||document.getElementById("compactToggleBtn"))return;let t=document.createElement("button");t.id="compactToggleBtn",t.type="button",t.className="dash-accordion-toggle",t.textContent="Compact: OFF",e.appendChild(t);let n=(i,r=!0)=>{if(document.body.classList.toggle("dash-accordion",i),t.textContent=i?"Compact: ON":"Compact: OFF",r)try{localStorage.setItem(mp,i?"1":"0")}catch{}if(i){let l=document.querySelector(".dashboard-col-side .widget-card");l&&l.classList.add("is-open")}else document.querySelectorAll(".dashboard-col-side .widget-card.is-open").forEach(l=>l.classList.remove("is-open"))},s=null;try{s=localStorage.getItem(mp)}catch{}n(s==="1"?!0:s==="0"?!1:((o=(a=window.matchMedia)==null?void 0:a.call(window,"(max-width: 600px)"))==null?void 0:o.matches)??!1,!1),t.addEventListener("click",()=>n(!document.body.classList.contains("dash-accordion"),!0))}function eb(){if(Sp)return;Sp=!0;let e=document.querySelector(".dashboard-col-side");e&&e.addEventListener("click",t=>{var o,i;if(!document.body.classList.contains("dash-accordion"))return;let n=t.target;if((o=n==null?void 0:n.closest)!=null&&o.call(n,"button, a, input, textarea, select, kbd"))return;let s=(i=n==null?void 0:n.closest)==null?void 0:i.call(n,".widget-card");if(!s)return;let a=s.classList.contains("is-open");e.querySelectorAll(".widget-card.is-open").forEach(r=>{r!==s&&r.classList.remove("is-open")}),s.classList.toggle("is-open",!a)})}var Re={lsfPasswordSpent:65536,lsfRequireDestTag:131072,lsfRequireAuth:262144,lsfDisallowXRP:524288,lsfDisableMaster:1048576,lsfNoFreeze:2097152,lsfGlobalFreeze:4194304,lsfDefaultRipple:8388608,lsfDepositAuth:16777216},pu={lsfBurnable:1,lsfOnlyXRP:2,lsfTrustLine:4,lsfTransferable:8},tb=new Set(["SetRegularKey","SignerListSet","AccountSet","AccountDelete","EscrowCreate","PaymentChannelCreate","DepositPreauth"]),bn={blackhole:"#ff5555",exchange:"#00d4ff",newWallet:"#ff79c6",issuer:"#ffb86c",wallet:"#bd93f9",other:"#8be9fd"},nb=.55,sb=.15,Ji=20,gu=946684800;function Te({module:e,category:t=null,sev:n,confidence:s=null,headline:a,detail:o="",observed:i=[],alternativeExplanations:r=[],evidenceAgainstBenign:l=[],classification:c=null,hashes:p=[]}={}){return{module:e,category:t,sev:n,confidence:s,headline:a,label:a,detail:o,observed:i,alternativeExplanations:r,evidenceAgainstBenign:l,classification:c,hashes:p}}var ab=new Map([["rPVMhWBsfF9iMXYj3aAzJVkPDTFNSyWdKy",{name:"Bitstamp",type:"exchange"}],["rvYAfWj5gh67oV6fW32ZzP3Aw4Eubs59B",{name:"Bitstamp",type:"exchange"}],["rrpNnNLKrartuEqfJGpqyDwPj1BBN1ih7",{name:"Bitstamp",type:"exchange"}],["rN7n3473SaZBCG4dFL83w7PB9judJ7qdDo",{name:"Binance",type:"exchange"}],["rEb8TK3gBgk5auZkwc6sHnwrGVJH8DuaLh",{name:"Binance",type:"exchange"}],["rBKPS4oLSaV2KVVuHH8EpQqMGgGefGFQs7",{name:"Bitso",type:"exchange"}],["rfk5bwaKCoNU84fTzdqWQowqnNaZorDmiV",{name:"Gate.io",type:"exchange"}],["rGFuMiw48HdbnrUbkRYDTvT5i9imC5fvv9",{name:"Gate.io",type:"exchange"}],["rwYHCs2EYBMBvRXFmxDrCUSorPsuqCck7t",{name:"Kraken",type:"exchange"}],["rLHzPsX6oXkzU2qL12kHCH8G8cnZv1rBJh",{name:"Kraken",type:"exchange"}],["ra5nK24KXen9AHvsdFTKHSANinZseWnPcX",{name:"Uphold",type:"exchange"}],["rGWrZyax5eXbi5gs49MRZKkE9eKNL9p4B",{name:"Bittrex",type:"exchange"}],["rDsbeomae4FXwgQTJp9Rs64Qg9vDiTCdBv",{name:"Coinone",type:"exchange"}],["rHsMUQFzBb7S6GnQFVgNirqvHRcLpAn5dU",{name:"Bithumb",type:"exchange"}],["rMQ98K56yXJbDGv49ZSmW51sLn94Xe1mu1",{name:"Huobi",type:"exchange"}],["rHcFoo6a9qT5NHiVn1THwX3B4QF2VQKWZ",{name:"Huobi",type:"exchange"}],["rKiCet8SdvWxPXnAgYarFUXMh1zCPz432Y",{name:"Coinbase",type:"exchange"}],["rHb9CJAWyB4rj91VRWn96DkukG4bwdtyTh",{name:"Coinbase",type:"exchange"}],["r9mhdcT2K7FdCGDEPqfbMJwVXsXCqEr5bP",{name:"OKX",type:"exchange"}],["r32U8WFxhqEAVkKcTb1GGRR1VH2oaFdexN",{name:"OKX",type:"exchange"}],["r4GDFMLGJUKMjNEycBKPGnRSNXyNVLQLHi",{name:"Bybit",type:"exchange"}],["rBETszU65yYoFcYdRkiGqFaYmhZpHWC7sj",{name:"Bybit",type:"exchange"}],["rMWUykAmNQDaM9poSes8VLDZDDkEoutilities",{name:"KuCoin",type:"exchange"}],["rUA1S9qobBkxLqzdfGEzh5wm5KdLfbf8bx",{name:"KuCoin",type:"exchange"}],["rHtbQzmN4BDaEBnGSXp3AZaZAuZamNVsME",{name:"MEXC",type:"exchange"}],["rDN1gPWW3XQFXVJFQSiJxPHGZiRLMVSi7K",{name:"MEXC",type:"exchange"}],["rB3gZey7VWHoDokMt3tCiXBSRmaZi5xJi9",{name:"Crypto.com",type:"exchange"}],["rhub8VRN55s94qWKDv6jmDy1pUykJzF3wq",{name:"GateHub",type:"exchange"}],["razqnFn6FqBaYBdNaGnVzmGaNE6XPRQ9bG",{name:"GateHub",type:"exchange"}],["rGQdkxNBQeQC1WTQDQ2F2QoGBZxYcMxBBg",{name:"GateHub",type:"exchange"}],["rpXTzCuXtjiPDFysxq8uNmtZBe9Xo97JbW",{name:"Bitbank",type:"exchange"}],["rsuUjfWxrACCAwGQDsNeZUhpzXf1n1NK5Z",{name:"Bitbank",type:"exchange"}],["r9oxUGJqMfMEhGBxrMJnmNvVh1LKkMv7fz",{name:"Coincheck",type:"exchange"}],["rHb9CJAWyB4rj91VRWn96DkukG4bwdtyTh",{name:"Genesis (Black Hole)",type:"blackhole"}],["r9cZA1mLK5R5Am25ArfXFmqgNwjZgnfk59",{name:"Black Hole #2",type:"blackhole"}],["rHb9CJAWyB4rj91VRWn96DkukG4bwdtyTh",{name:"Genesis Wallet",type:"ripple"}],["rHb9CJAWyB4rj91VRWn96DkukG4bwdtyTh",{name:"Ripple Labs Ops",type:"ripple"}],["rPEPPER7kfTD9w2To4CQk6UCfuHM9c6GDY",{name:"XAMAN (XUMM)",type:"wallet"}],["rBj4eVRWn6mCELVTNkVFDfGNByE9VFTM3R",{name:"XAMAN",type:"wallet"}],["rHb9CJAWyB4rj91VRWn96DkukG4bwdtyTh",{name:"XRPL AMM Engine",type:"dex"}],["rsoLo2S1kiGeCcn6hCUXVrCpGMWLrRrLZz",{name:"SOLO Issuer",type:"issuer"}],["rcoreNywaoz2ZCVt2sc3JiEi7G7MpZxZgm",{name:"CORE Token",type:"issuer"}],["rhXo4TcWbLY4GqTSmscMpgZ1KMXFBi9V55",{name:"XRPL DeFi Pool",type:"issuer"}],["rHb9CJAWyB4rj91VRWn96DkukG4bwdtyTh",{name:"UNL Validator Set",type:"validator"}]]);function Hn(e){return ab.get(e)||null}var ob=null,ut=!1;var ys=null,uu=!1,Ui=!0;function Za(){return Ui&&X.currentPage==="dashboard"&&X.currentTab==="inspector"&&!document.hidden}async function ib(e){let t=[s=>`https://corsproxy.io/?${encodeURIComponent(s)}`,s=>`https://api.allorigins.win/raw?url=${encodeURIComponent(s)}`],n=async s=>{let a=typeof(AbortSignal==null?void 0:AbortSignal.timeout)=="function"?AbortSignal.timeout(6e3):void 0,o=await fetch(s,{mode:"cors",cache:"no-store",signal:a});if(!o.ok)throw new Error(`HTTP ${o.status}`);return await o.json()};try{return await n(e)}catch{for(let s of t)try{return await n(s(e))}catch{}throw new Error("Price feed unavailable")}}async function rb(){if(uu)return ys;uu=!0;try{let e=await ib("https://api.exchange.coinbase.com/products/XRP-USD/ticker");ys=Number((e==null?void 0:e.price)||0)||null}catch{ys=null}return ys}function yn(e){if(!ys||!e)return"";let t=e*ys;return t>=1e6?` (~$${(t/1e6).toFixed(2)}M)`:t>=1e3?` (~$${(t/1e3).toFixed(1)}K)`:` (~$${t.toFixed(2)})`}var Ys=null;function vu(){return Ys||(Ys={input:()=>document.getElementById("inspect-addr"),err:document.getElementById("inspect-err"),result:document.getElementById("inspect-result"),empty:document.getElementById("inspect-empty"),loading:document.getElementById("inspect-loading"),loadMsg:document.getElementById("inspect-loading-msg"),warn:document.getElementById("inspect-warn"),badge:document.getElementById("inspect-addr-badge"),score:document.getElementById("inspect-risk-score"),label:document.getElementById("inspect-risk-label")},Ys)}function lb(){Ys=null,vu()}function bu(){var n,s,a,o,i;By(),Xy(),Hy(),(n=w("inspect-addr"))==null||n.addEventListener("keydown",r=>{r.key==="Enter"&&ws()}),(s=w("inspect-addr"))==null||s.addEventListener("paste",()=>{setTimeout(()=>{var l;let r=(l=w("inspect-addr"))==null?void 0:l.value.trim();r&&Xe(r)&&ws()},60)});let e=r=>{let l=r==null?void 0:r.closest(".inspector-section");if(!l)return;let c=l.classList.toggle("collapsed");r.setAttribute("aria-expanded",String(!c))};(a=document.getElementById("tab-inspector"))==null||a.addEventListener("click",r=>{if(r.target.closest("button"))return;let l=r.target.closest(".section-header");l&&e(l)}),(o=document.getElementById("tab-inspector"))==null||o.addEventListener("keydown",r=>{var c,p;if(r.key!=="Enter"&&r.key!==" ")return;let l=(p=(c=r.target).closest)==null?void 0:p.call(c,".section-header");l&&(r.preventDefault(),e(l))}),(i=document.getElementById("inspector-nav"))==null||i.addEventListener("click",r=>{var p;let l=r.target.closest("[data-jump]");if(!l)return;let c=document.getElementById("section-"+l.dataset.jump);c&&(c.classList.remove("collapsed"),(p=c.querySelector(".section-header"))==null||p.setAttribute("aria-expanded","true"),c.scrollIntoView({behavior:"smooth",block:"start"})),Nu(l.dataset.jump)});let t=!1;window.addEventListener("scroll",()=>{Za()&&(t||(t=!0,requestAnimationFrame(()=>{zy(),t=!1})))},{passive:!0}),window.runInspect=ws,window.inspectorCopyAddr=Uy,window.showInspectorHowTo=jy,window.hideInspectorHowTo=Gi,lb(),Ky(),window.addEventListener("naluxrp:tabchange",r=>{var l;((l=r.detail)==null?void 0:l.tabId)==="inspector"&&Za()&&(Zi(),er(),ta(),eo())})}function yu(e){Ui=!!e,Ui||(ut=!0)}async function ws(){var a,o,i,r,l,c,p,u,d,m,f,v,b,h,g;if(!Za())return;let e=vu(),t=((a=e.input())==null?void 0:a.value.trim())||"";if([e.err,e.result,e.empty,e.warn].forEach(x=>x&&(x.style.display="none")),ut=!0,!t){e.empty&&(e.empty.style.display="");return}if(!Xe(t)){e.err&&(e.err.textContent=`\u26A0 Invalid address: ${y(t)}`,e.err.style.display="");return}if(X.connectionState!=="connected"){e.warn&&(e.warn.style.display="");return}ob=t,ut=!1;let n=x=>{e.loading&&(e.loading.style.display="",e.loadMsg&&(e.loadMsg.textContent=x))};n("Fetching account data\u2026");let s=x=>new Promise(k=>setTimeout(k,x));try{n("Fetching account data\u2026");let[x,k,T]=await Promise.all([Ae({command:"account_info",account:t,ledger_index:"validated"}),Ae({command:"account_offers",account:t,ledger_index:"validated"}),Ae({command:"account_nfts",account:t,ledger_index:"validated"}).catch(()=>null)]);if(ut)return;let S=((o=x==null?void 0:x.result)==null?void 0:o.account_data)||{},$=((i=k==null?void 0:k.result)==null?void 0:i.offers)||[],N=((r=T==null?void 0:T.result)==null?void 0:r.account_nfts)||[];n("Fetching trustlines\u2026");let C=[],P,R=0;do{R++;let K={command:"account_lines",account:t,ledger_index:"validated",limit:400};P&&(K.marker=P);let ue=await Ae(K).catch(()=>null);if(ut)return;let be=((l=ue==null?void 0:ue.result)==null?void 0:l.lines)||[];C.push(...be),P=((c=ue==null?void 0:ue.result)==null?void 0:c.marker)||null,R>1&&await s(50)}while(P&&C.length<4e3);n("Fetching account objects\u2026");let O=[],D,I=0;do{I++;let K={command:"account_objects",account:t,ledger_index:"validated",limit:400};D&&(K.marker=D);let ue=await Ae(K).catch(()=>null);if(ut)return;let be=((p=ue==null?void 0:ue.result)==null?void 0:p.account_objects)||[];O.push(...be),D=((u=ue==null?void 0:ue.result)==null?void 0:u.marker)||null,I>1&&await s(50)}while(D&&O.length<2e3);n("Fetching token supply, AMM data & price\u2026");let F=15,B=C.filter(K=>K.currency&&Number(K.balance)!==0&&K.currency.startsWith("03")&&K.currency.length===40),[E,,...z]=await Promise.all([Ae({command:"gateway_balances",account:t,ledger_index:"validated"}).catch(()=>null),rb(),...B.slice(0,F).map(K=>Ae({command:"amm_info",amm_account:K.account,ledger_index:"validated"}).catch(()=>null))]);if(ut)return;let te=(E==null?void 0:E.result)||null,oe=new Map;B.slice(0,F).forEach((K,ue)=>{var be,ze;(ze=(be=z[ue])==null?void 0:be.result)!=null&&ze.amm&&oe.set(K.currency,z[ue].result.amm)});let pe=400,ie=250,ne=window._inspectMaxTx||5e3,re=Math.ceil(ne/pe),G=[],Se=new Set,H=K=>{var ue,be;for(let ze of K||[]){let ft=((ue=ze.tx_json)==null?void 0:ue.hash)||((be=ze.tx)==null?void 0:be.hash)||ze.hash||null;ft&&Se.has(ft)||(ft&&Se.add(ft),G.push(ze))}},q={newestToOldestComplete:!1,oldestToNewestFetched:!1,hitTxCap:!1,hitPageCap:!1,fetchErrorOccurred:!1},se,me=0;for(let K=1;K<=re&&G.length<ne;K++){if(me=K,ut)return;n(`Fetching transactions \u2014 page ${K} (${G.length.toLocaleString()} so far)\u2026`);let ue={command:"account_tx",account:t,limit:pe,ledger_index_min:-1,ledger_index_max:-1,forward:!1};se&&(ue.marker=se);let be=await Ae(ue).catch(()=>null);if(ut)return;if(be==null&&(q.fetchErrorOccurred=!0),H((d=be==null?void 0:be.result)==null?void 0:d.transactions),se=((m=be==null?void 0:be.result)==null?void 0:m.marker)||null,!se)break;K<re&&G.length<ne&&await s(ie)}if(q.hitTxCap=G.length>=ne,q.hitPageCap=!!se&&me>=re,q.newestToOldestComplete=!se,G.length<ne){if(ut)return;n("Fetching oldest transactions (anchoring history start)\u2026");let K=await Ae({command:"account_tx",account:t,limit:pe,ledger_index_min:-1,ledger_index_max:-1,forward:!0}).catch(()=>null);if(ut)return;K==null&&(q.fetchErrorOccurred=!0),H((f=K==null?void 0:K.result)==null?void 0:f.transactions),q.oldestToNewestFetched=K!=null&&!((v=K==null?void 0:K.result)!=null&&v.marker),await s(ie)}e.loading&&(e.loading.style.display="none");let xe=cb(G).sort((K,ue)=>(K.tx.date??0)-(ue.tx.date??0)),Ce=946684800,qe=null,Fe=null,_e=q.newestToOldestComplete||q.oldestToNewestFetched;if(xe.length>0){let K=xe[0].tx;K!=null&&K.date&&(Fe=(K.date+Ce)*1e3,qe=Math.floor((Date.now()-Fe)/864e5))}let Y=new Map;for(let{tx:K}of xe){if(K.TransactionType!=="OfferCreate"||!K.TakerPays||!K.TakerGets)continue;let ue=ze=>typeof ze=="string"?"XRP":`${ze.currency}+${ze.issuer||""}`,be=[ue(K.TakerPays),ue(K.TakerGets)].sort().join("\u2194");Y.set(be,(Y.get(be)||0)+1)}let he=null;if(Y.size>0){let K=[...Y.entries()].sort((nn,da)=>da[1]-nn[1])[0][0],[ue,be]=K.split("\u2194"),ze=nn=>nn==="XRP"?{currency:"XRP"}:{currency:nn.split("+")[0],issuer:nn.split("+")[1]},ft=await Ae({command:"book_offers",taker_pays:ze(ue),taker_gets:ze(be),limit:20,ledger_index:"validated"}).catch(()=>null);(h=(b=ft==null?void 0:ft.result)==null?void 0:b.offers)!=null&&h.length&&(he={pair:K,offers:ft.result.offers})}let tt=[...new Set(xe.filter(({tx:K})=>K.TransactionType==="Payment"&&K.Account===t&&K.Destination).map(({tx:K})=>K.Destination))].slice(0,6),it=new Map;for(let K of tt){if(ut)return;let ue=await Ae({command:"account_info",account:K,ledger_index:"validated"}).catch(()=>null),be=(g=ue==null?void 0:ue.result)==null?void 0:g.account_data;be&&it.set(K,{sequence:be.Sequence||0,balance:Number(be.Balance||0)/1e6}),await s(80)}fb(t,S,C,$,N,O,xe,{gatewayBalances:te,ammInfoMap:oe,destAgeMap:it,walletAgeDays:qe,walletCreatedTs:Fe,walletAgeVerified:_e,historyCoverage:q,liveOrderBook:he}),e.result&&(e.result.style.display="",tr());let Ct=e.score?Number(e.score.textContent):null;n0(t,isNaN(Ct)?null:Ct);let Dt=window._lastAllFindings||[];s0(t,isNaN(Ct)?null:Ct,Dt),d0(t,Dt),Ki(t)&&o0(t,isNaN(Ct)?null:Ct),l0()}catch(x){if(ut)return;e.loading&&(e.loading.style.display="none"),e.err&&(e.err.textContent=`Error: ${y(x.message)}`,e.err.style.display="")}}function cb(e){return e.map(t=>{let n=t.tx_json||t.tx||t.transaction||{},s=t.metadata||t.meta||{};return n.date==null&&t.date!=null&&(n.date=t.date),!n.hash&&t.hash&&(n.hash=t.hash),{tx:n,meta:s}})}function Qt(e){if(e==null)return null;if(typeof e=="string")return Number(e)/1e6;let t=Number(e.value);return Number.isFinite(t)?t:null}function ji(e){return typeof e=="string"?"XRP":(e==null?void 0:e.currency)||null}function wu(e){return typeof e=="string"&&e.length===40&&e.startsWith("03")}function Yi(e,t,n){var a,o,i,r,l,c,p,u,d,m,f,v;let s={xrpDelta:0,tokenDeltas:[],tokenDeltaMap:new Map,lpDeltas:[],lpDeltaMap:new Map};if(!((a=t==null?void 0:t.AffectedNodes)!=null&&a.length))return s;for(let b of t.AffectedNodes){let h=b.CreatedNode,g=b.ModifiedNode,x=b.DeletedNode,k=h||g||x;if(k){if(k.LedgerEntryType==="AccountRoot"){if((((o=k.FinalFields)==null?void 0:o.Account)||((i=k.NewFields)==null?void 0:i.Account))!==n)continue;let S=Number(((r=k.FinalFields||k.NewFields)==null?void 0:r.Balance)??0),$=h?0:Number(((l=k.PreviousFields)==null?void 0:l.Balance)??S),N=(S-$)/1e6;N&&(s.xrpDelta+=N);continue}if(k.LedgerEntryType==="RippleState"){let T=k.FinalFields||k.NewFields,S=(c=T==null?void 0:T.LowLimit)==null?void 0:c.issuer,$=(p=T==null?void 0:T.HighLimit)==null?void 0:p.issuer,N=S===n;if(!N&&!($===n))continue;let P=N?1:-1,R=N?$:S,O=(u=T==null?void 0:T.Balance)==null?void 0:u.currency,D=x?0:Number(((d=T==null?void 0:T.Balance)==null?void 0:d.value)??0),I=h?0:Number(((f=(m=k.PreviousFields)==null?void 0:m.Balance)==null?void 0:f.value)??(x?((v=T==null?void 0:T.Balance)==null?void 0:v.value)??0:D)),F=(D-I)*P;if(!F||!O)continue;let B=wu(O)?s.lpDeltaMap:s.tokenDeltaMap,E=`${O}.${R}`,z=B.get(E)||{currency:O,issuer:R,delta:0};z.delta+=F,B.set(E,z)}}}return s.tokenDeltas=[...s.tokenDeltaMap.values()],s.lpDeltas=[...s.lpDeltaMap.values()],delete s.tokenDeltaMap,delete s.lpDeltaMap,s}function xu(e,t){return e.map(({tx:n,meta:s})=>{let a=Yi(n,s,t);return{txHash:n.hash,date:n.date,type:n.TransactionType,result:(s==null?void 0:s.TransactionResult)||null,xrpDelta:a.xrpDelta,tokenDeltas:a.tokenDeltas,lpDeltas:a.lpDeltas}})}function ku(e,t,n){let s=xu(e,t),a=n,o=new Array(s.length);for(let i=s.length-1;i>=0;i--){let r=a;a-=s[i].xrpDelta,o[i]={...s[i],balanceBefore:a,balanceAfter:r}}return o}var db=[86400,3*86400],pb=.5,ub=10;function $u(e,t,n,s={}){var p;let a=[],o=e.length,i=t.filter(({tx:u})=>["SetRegularKey","SignerListSet"].includes(u.TransactionType)).map(({tx:u})=>u.date).filter(u=>u!=null);for(let u of db)for(let d=0;d<o;d++){let m=e[d];if(m.date==null||m.balanceBefore<=0)continue;let f=0,v=d,b=[];for(;v<o&&e[v].date!=null&&e[v].date-m.date<=u;)e[v].xrpDelta<0&&(f+=-e[v].xrpDelta,b.push(e[v])),v++;let h=m.balanceBefore>0?f/m.balanceBefore:0;h>=pb&&f>ub&&a.push({windowSec:u,startDate:m.date,endDate:((p=e[Math.min(v,o)-1])==null?void 0:p.date)??m.date,balanceAtStart:m.balanceBefore,totalOutflowXrp:f,pctOfBalanceMoved:h,startIdx:d,endIdx:Math.min(v,o)-1,triggeredByAuthChange:i.some(g=>g<=m.date&&m.date-g<=u)})}let r=300;a.sort((u,d)=>d.pctOfBalanceMoved-u.pctOfBalanceMoved);let l=[];for(let u of a)l.some(m=>m.windowSec===u.windowSec&&u.startDate<=m.endDate+r&&u.endDate>=m.startDate-r)||l.push(u);l.sort((u,d)=>u.startDate-d.startDate);let c=s.fetchErrorOccurred?"possibly-incomplete":"complete";return l.map(u=>({...u,dataCompleteness:c}))}function mb(e,t,n,s){let a=t.slice(e.startIdx,e.endIdx+1).filter(C=>C.xrpDelta<0),o=new Set(a.map(C=>C.txHash)),i=n.filter(({tx:C})=>o.has(C.hash)&&C.TransactionType==="Payment"),r=new Set(n.filter(({tx:C})=>C.TransactionType==="Payment"&&C.Account===s&&C.date<e.startDate).map(({tx:C})=>C.Destination).filter(Boolean)),l=[...new Set(i.map(({tx:C})=>C.Destination).filter(Boolean))],c=l.filter(C=>!r.has(C)),p=l.length?c.length/l.length:null,u=new Map;for(let{tx:C}of i){let P=typeof C.Amount=="string"?Number(C.Amount)/1e6:0;u.set(C.Destination,(u.get(C.Destination)||0)+P)}let d=[...u.entries()].sort((C,P)=>P[1]-C[1]),m=e.totalOutflowXrp>0&&d[0]?d[0][1]/e.totalOutflowXrp:null,f=d.map(([C,P])=>({addr:C,xrp:P,entity:Hn(C)})),v=n.filter(({tx:C})=>C.TransactionType==="Payment"&&C.Account===s&&(C.date<e.startDate||C.date>e.endDate)&&typeof C.Amount=="string").map(({tx:C})=>Number(C.Amount)/1e6).filter(C=>C>0),b=C=>{let P=[...C].sort((R,O)=>R-O);return P.length?P[Math.floor(P.length/2)]:null},h=b(v),g=i.map(({tx:C})=>Number(C.Amount)/1e6).filter(C=>C>0),x=b(g),k=h&&x?x/h>=5:!1,T=new Map;for(let C of t.slice(e.startIdx,e.endIdx+1))for(let P of C.tokenDeltas){if(P.delta>=0)continue;let R=`${P.currency}.${P.issuer}`;T.set(R,(T.get(R)||0)+-P.delta)}let S=[...T.entries()].map(([C,P])=>({key:C,amount:P})),N=t.filter(C=>C.date!=null&&C.date<e.startDate&&e.startDate-C.date<=172800).some(C=>C.xrpDelta>0&&C.tokenDeltas.some(P=>P.delta<0));return{...e,newRecipientPct:p,newDestCount:c.length,episodeDestCount:l.length,topDestShare:m,destinations:f.slice(0,5),transferSizeAnomaly:k,historicalMedianXrp:h,episodeMedianXrp:x,trustlineLiquidations:S,dexConversionPrecedingWithdrawal:N}}function fb(e,t,n,s,a,o,i,r={}){let{gatewayBalances:l=null,ammInfoMap:c=new Map,destAgeMap:p=new Map,walletAgeDays:u=null,walletCreatedTs:d=null,walletAgeVerified:m=!1,historyCoverage:f=null,liveOrderBook:v=null}=r,b=Number(t.Balance||0)/1e6,h=Number(t.OwnerCount||0),g=10+h*2,x=Number(t.Flags||0),k=t.Sequence??"\u2014",T=o.filter(Y=>Y.LedgerEntryType==="SignerList"),S=o.filter(Y=>Y.LedgerEntryType==="Escrow"),$=o.filter(Y=>Y.LedgerEntryType==="PayChannel"),N=o.filter(Y=>Y.LedgerEntryType==="DepositPreauth"),C=o.filter(Y=>Y.LedgerEntryType==="Check"),P=yb(t,x,T,i,f),R=Pu(t,x,T,i,$,S,e,b,f),O=kb(a,i,e),D=Zb(v,e),I=Mu(i,e,f||{}),F=Sb(I,e),B=Lb(i,e,n,I,F,D),E=Ub(t,n,x,i),z=jb(n,i,o,c,e),te=_b(i),oe=Wb(i,e),pe=Db(i,e),ie=Ib(i,e),ne=Fb(i),re=Ob(i,e),G=hb(i,e,p),Se=qb(i),H=Vb(i,e),q=Gb(i,e),se=gb(i,e,n,l),me=Kb(i,e),xe=Jb(i,e),Ce=Yb(o,i,e),qe=Qb(o),Fe=oy(P,R,O,B,te,oe,pe,ie,ne,re,Se);my(e,t,b,g,h,k,Fe,u,d,m),fy(P,t,x,T,N),hy(R,$,S,C),$y(G,b,me),gy(O,a),by(B),iy(te),ry(oe),ly(pe),cy(ie),dy(ne),py(re),uy(te,pe,ie,ne,re),yy(E,n),Sy(se,n),Ty(Se),Cy(H),Py(q),wy(z,n),My(me),Ly(xe),Ay(Ce),Ey(qe),Ny(D),Ry(Fe,P,R,O,B,te,oe,pe,ie,ne,re,Se,me,xe),xy(n),ky(i,e),hu(i),u0(i,e,G,me),window._lastTxList=i,window._lastBalXrp=b,window._lastHistoryCoverage=f;let _e=w("inspect-report-body");_e&&(Oy(_e,e,t,b,Fe,P,R,O,B,te,oe,E,z,G,se,i,pe,ie,ne,re,{feeAnalysis:Se,destTagAnalysis:H,pathDepthAnalysis:q,gatewayBalances:l,inboundFlowAnalysis:me,memoAnalysis:xe,escrowDepthAnalysis:Ce,checkAnalysis:qe,liveBookAnalysis:D,walletAgeDays:u,walletCreatedTs:d}),hu(i,"inspect-report-activity-chart"),c0(Fe,window._lastAllFindings||[],u,i.length,window._lastCategoryRisk||{}),window._lastInspectResult={addr:e,riskScore:Fe,walletAgeDays:u,walletAgeVerified:m,historyCoverage:f,txCount:i.length,findings:window._lastAllFindings||[],timestamp:new Date().toISOString()},Iu(),Fu(e))}function hb(e,t,n=new Map){let s=new Map,a=[];for(let{tx:d,meta:m}of e){if(d.TransactionType!=="Payment"||d.Account!==t)continue;let f=d.Destination;if(!f)continue;let v=0,b=null,h=d.Amount;typeof h=="string"?v=Number(h)/1e6:h!=null&&h.value&&(b={value:Number(h.value),currency:Xn(h.currency),issuer:h.issuer});let g=Array.isArray(d.Paths)&&d.Paths.length>0,x=d.SendMax!=null,k=g||x,T=g?d.Paths.reduce((C,P)=>Math.max(C,(P||[]).length+1),1):k?2:1,S=Wn(d),$={dest:f,amtXrp:v,amtToken:b,ts:S,isPathPay:k,hopCount:T,hash:d.hash||d.Hash||"",ledger:d.ledger_index||d.LedgerIndex||0,destTag:d.DestinationTag};a.push($),s.has(f)||s.set(f,{addr:f,totalXrp:0,txCount:0,firstSeen:S,lastSeen:S,entity:Hn(f)||null,pathCount:0,maxHops:1,tokens:new Map});let N=s.get(f);if(N.totalXrp+=v,N.txCount++,N.lastSeen=Math.max(N.lastSeen,S),N.firstSeen=Math.min(N.firstSeen,S),k&&(N.pathCount++,N.maxHops=Math.max(N.maxHops,T)),b){let C=`${b.currency}.${W(b.issuer||"")}`;N.tokens.set(C,(N.tokens.get(C)||0)+b.value)}}let o=[...s.values()].sort((d,m)=>m.totalXrp-d.totalXrp||m.txCount-d.txCount).slice(0,10).map(d=>({...d,tokens:[...d.tokens.entries()].map(([m,f])=>({k:m,v:f}))})),i=o.reduce((d,m)=>d+m.totalXrp,0),r=a.filter(d=>d.isPathPay).length,l=o.filter(d=>{let m=n.get(d.addr);return m&&m.sequence<10&&d.totalXrp>10}),c=o.filter(d=>{var m;return((m=d.entity)==null?void 0:m.type)==="exchange"}),p=o.filter(d=>{var m;return((m=d.entity)==null?void 0:m.type)==="blackhole"});return{timeline:[...a].filter(d=>d.amtXrp>.01||d.amtToken).sort((d,m)=>d.ts-m.ts).slice(0,30),destinations:o,totalOut:i,totalPathPay:r,uniqueDests:s.size,exchangeDests:c,blackHoleDests:p,newWalletDests:l}}function gb(e,t,n,s=null){var N,C;let a=null;if(s!=null&&s.obligations){let P=Object.values(s.obligations);P.length===1?a=Number(P[0])||null:P.length>1&&(a=null)}let o=[],i=new Map,r=new Map,l=new Set,c=new Set(n.filter(P=>Number(P.balance)<0).map(P=>Xn(P.currency)));for(let{tx:P,meta:R}of e)if(P.Account===t&&P.TransactionType==="Payment"){((C=(N=R==null?void 0:R.AffectedNodes)==null?void 0:N.some)==null?void 0:C.call(N,I=>{var F,B,E;return((F=I.CreatedNode)==null?void 0:F.LedgerEntryType)==="AccountRoot"&&((E=(B=I.CreatedNode)==null?void 0:B.NewFields)==null?void 0:E.Account)===P.Destination}))&&P.Destination&&l.add(P.Destination);let D=P.Amount;if(typeof D=="object"&&(D!=null&&D.value)&&(D!=null&&D.currency)){let I=Xn(D.currency);if(c.has(I)){let F=Number(D.value),B=P.Destination;i.has(B)||(i.set(B,0),r.set(B,Wn(P))),i.set(B,i.get(B)+F)}}}let p=[...i.entries()].sort((P,R)=>R[1]-P[1]),u=[];if(p.length>=3){let P=new Map;for(let[R,O]of p){if(O<=0)continue;let D=Math.pow(10,Math.floor(Math.log10(O))),F=(Math.round(O/D/.1)*.1*D).toPrecision(2);P.has(F)||P.set(F,[]),P.get(F).push({addr:R,amt:O})}for(let[,R]of P.entries())if(R.length>=3){let O=R.reduce((D,I)=>D+I.amt,0)/R.length;u.push({approxAmt:O,accounts:R}),o.push({sev:"warn",label:`${R.length} accounts each received ~${_(O,0)} tokens`,detail:"Highly similar token amounts suggest coordinated wallets, pre-arranged airdrop clusters, or sybil accounts."})}}let d=[...r.values()].sort();if(d.length>=5){let P=d[d.length-1]-d[0];P<3600&&d.length>=10&&o.push({sev:"warn",label:`${d.length} accounts funded within ${Math.ceil(P/60)} minutes`,detail:"Rapid token distribution to many wallets in a narrow time window. Matches pre-sale airdrop or coordinated distribution for wash trading."})}l.size>0&&o.push({sev:l.size>10?"warn":"info",label:`${l.size} account(s) created by this address`,detail:"This issuer funded the activation of these accounts. They may be controlled by the same entity."});let m=n.filter(P=>Number(P.balance)<0),f=a,v=m.reduce((P,R)=>P+Math.abs(Number(R.balance)),0),b=f??v,h=f==null&&m.length>0,g=h?` (based on ${m.length} visible trustlines \u2014 actual total supply may be higher if there are more holders)`:"",x=m.map(P=>({addr:P.account,balance:Math.abs(Number(P.balance)),currency:Xn(P.currency)})).sort((P,R)=>R.balance-P.balance).slice(0,10),k=new Set;for(let{tx:P}of e){if(P.TransactionType!=="Payment")continue;let R=P.Amount;typeof R!="object"||!(R!=null&&R.currency)||(P.Account===t&&P.Destination&&k.add(P.Destination),P.Destination===t&&P.Account&&k.add(P.Account))}x.forEach(P=>{P.activeWithIssuer=k.has(P.addr)});let T=x.filter(P=>P.activeWithIssuer).length;x.length>=3&&o.push(Te({module:"Issuer Connections",category:"issuer",sev:"info",confidence:.35,headline:`${T} of top ${x.length} holders have transacted directly with the issuer`,detail:`${x.length-T} show no direct payment activity with this issuer in the fetched history.`,observed:[`Direct-contact holders: ${T}/${x.length}`,"Measures direct issuer contact only \u2014 holders active via DEX trades or peer-to-peer transfers are not visible from this account's own history alone"],classification:"This distinguishes holders who have engaged with the issuer directly from those who haven't \u2014 it is not a general on-chain activity/dormancy check."}));let S=f??v,$=S>0&&(f!=null||m.length>=50);if(x.length>=2&&$){let P=x[0].balance/S*100,R=f!=null?"":" (of visible sample)";P>50?o.push({sev:"critical",label:`Top holder controls ${P.toFixed(0)}%${R} of supply`,detail:`${W(x[0].addr)} holds ${_(x[0].balance,0)} of ${_(S,0)} total${g}. `+(f!=null?"Extreme dump risk \u2014 one wallet could sell everything.":"Check gateway_balances or a block explorer to confirm the full supply picture.")}):P>25&&o.push({sev:"warn",label:`Top holder controls ${P.toFixed(0)}%${R} of supply`,detail:`Large single-holder concentration${g}. Monitor for coordinated sell events.`});let D=x.slice(0,5).reduce((I,F)=>I+F.balance,0)/S*100;D>75&&o.push({sev:"warn",label:`Top 5 holders own ${D.toFixed(0)}%${R} of supply`,detail:`Supply heavily concentrated in a few wallets${g}. This pattern is common in pre-launch setups or tokens with limited real distribution.`})}else m.length>0&&!$&&o.push({sev:"info",label:`${m.length} trustline holder(s) visible \u2014 supply data limited`,detail:`Only ${m.length} trustlines returned by account_lines. The true holder count and total supply cannot be determined from this data alone. Use a block explorer (XRPScan, Bithomp) for a complete holder distribution.`});return o.length===0&&b===0&&o.push({sev:"info",label:"No token issuance detected",detail:"This account does not appear to be an active token issuer."}),{signals:o,totalIssued:b,holderCount:m.length,topHolders:x,mirrorGroups:u,createdAccts:[...l],distributions:p.slice(0,10),isSampleOnly:h}}var vb=new Set(["rrrrrrrrrrrrrrrrrrrrrhoLvTp","rrrrrrrrrrrrrrrrrrrrBZbvji","rrrrrrrrrrrrrrrrrNAMEtxvNvQ","rHb9CJAWyB4rj91VRWn96DkukG4bwdtyTh","r9cZA1mLK5R5Am25ArfXFmqgNwjZgnfk59"]);function Su(e){return!!e&&vb.has(e)}function Tu(e,t,n=[],s=[]){let a=!!(t&Re.lsfDisableMaster),o=(e==null?void 0:e.RegularKey)||"",i=Array.isArray(n)&&n.length>0,r=Su(o);return!!(a&&r&&!i)}function Cu(e,t,n=[]){let s=!!(t&Re.lsfDefaultRipple),a=!!(t&Re.lsfRequireAuth),o=!!(t&Re.lsfGlobalFreeze),i=!!(t&Re.lsfNoFreeze),r=n.filter(({tx:c})=>c.TransactionType==="TrustSet").length,l=n.filter(({tx:c})=>{var p;return c.TransactionType==="Payment"&&typeof c.Amount=="object"&&((p=c.Amount)==null?void 0:p.currency)}).length;return s||a||o||i||r>=3||l>=5}var Oe={NORMAL:"Normal",REGULAR_KEY:"Regular-Key Controlled",MULTISIG:"Multisig Controlled",BLACKHOLED:"Blackholed",RECOVERABLE:"Recoverable",MISCONFIGURED:"Potentially Misconfigured",UNKNOWN:"Unknown"},zi=4;function bb(e,t,n,s,a={}){let o=!!(t&Re.lsfDisableMaster),i=!!e.RegularKey,r=n.length>0,l=Su(e.RegularKey),c=s.filter(({tx:v})=>v.TransactionType==="AccountSet"&&v.Account===e.Account&&(v.SetFlag===zi||v.ClearFlag===zi)).map(({tx:v})=>({date:v.date,hash:v.hash,action:v.SetFlag===zi?"disabled":"enabled"})).sort((v,b)=>(v.date??0)-(b.date??0)),p=c.some((v,b)=>v.action==="enabled"&&c.slice(0,b).some(h=>h.action==="disabled")),u=n.filter(v=>(v.SignerEntries||[]).reduce((g,x)=>{var k;return g+Number(((k=x.SignerEntry)==null?void 0:k.SignerWeight)||0)},0)<Number(v.SignerQuorum||1)),d,m,f;return u.length?(d=Oe.MISCONFIGURED,m="blocked \u2014 quorum exceeds total signer weight, unreachable as configured",f=.9):r?(d=Oe.MULTISIG,m="controlled by signer quorum",f=.85):o&&i&&l?(d=Oe.BLACKHOLED,m="none \u2014 regular key points to a provably unusable address",f=.85):o&&!i?(d=Oe.BLACKHOLED,m="none \u2014 no working key exists",f=.75):o&&i&&p?(d=Oe.RECOVERABLE,m="proven historically \u2014 master key has been re-enabled from this state before",f=.7):o&&i?(d=Oe.REGULAR_KEY,m="possible \u2014 whoever holds the regular key can re-enable the master key or act directly",f=.6):o?(d=Oe.UNKNOWN,m="undetermined",f=.3):(d=Oe.NORMAL,m="full \u2014 master key is active",f=.9),a!=null&&a.fetchErrorOccurred&&!(a!=null&&a.newestToOldestComplete)&&(f=Math.min(f,.5)),{state:d,reversibility:m,confidence:f,masterDisabled:o,hasRegularKey:i,hasSignerList:r,masterKeyHistory:c,wasEverReenabled:p,misconfiguredSignerListCount:u.length}}function yb(e,t,n,s,a={}){let o=[],i=100,r=!!(t&Re.lsfDisableMaster),l=!!e.RegularKey,c=n.length>0,p=Tu(e,t,n,s),u=Cu(e,t,s),d=bb(e,t,n,s,a);{let f={[Oe.BLACKHOLED]:"info",[Oe.MISCONFIGURED]:"critical",[Oe.REGULAR_KEY]:"info",[Oe.MULTISIG]:"info",[Oe.RECOVERABLE]:"info",[Oe.NORMAL]:"ok",[Oe.UNKNOWN]:"warn"};o.push(Te({module:"Security",category:"security",sev:f[d.state]||"info",confidence:d.confidence,headline:`Account Control State: ${d.state}`,detail:`Reversibility: ${d.reversibility}`,observed:[`Master key: ${d.masterDisabled?"disabled":"active"}`,`Regular key: ${d.hasRegularKey?e.RegularKey:"not set"}`,`Signer list: ${d.hasSignerList?`${n.length} list(s)`:"none"}`,d.wasEverReenabled?"Master key has been re-enabled from a disabled state at least once in fetched history":null].filter(Boolean),classification:d.state===Oe.MISCONFIGURED?"Signer quorum cannot be reached with the current signer weights as configured \u2014 this account may be functionally stuck regardless of anyone's intent.":d.state===Oe.REGULAR_KEY?"A disabled master key with an active regular key is not the same as a locked/irreversible account \u2014 the regular key holder retains full control, including the ability to re-enable the master key.":null})),d.state===Oe.BLACKHOLED&&(i-=40),d.state===Oe.MISCONFIGURED&&(i-=30),p&&u&&o.push({sev:"warn",label:"Blackholed issuer caution",detail:"This account appears issuer-like and intentionally blackholed. Sending issued tokens back here may make them unrecoverable or effectively burn them."})}if(l){let f=s.find(({tx:b})=>b.TransactionType==="SetRegularKey"),v=f&&Date.now()/1e3-Wn(f.tx)<86400*30;p?o.push({sev:"info",label:"Regular key points to blackhole address",detail:e.RegularKey}):v?(o.push({sev:"warn",label:"Regular key set recently",detail:`Key: ${e.RegularKey} \u2014 changed within 30 days. Verify you intended this.`}),i-=15):o.push({sev:"info",label:"Regular key active",detail:e.RegularKey})}n.forEach(f=>{let v=f.SignerEntries||[],b=f.SignerQuorum||1;o.push({sev:"info",label:`Multisig: ${v.length} signers, quorum ${b}`,detail:v.map(h=>{var g;return W(((g=h.SignerEntry)==null?void 0:g.Account)||"")}).join(", ")})}),t&Re.lsfGlobalFreeze&&(o.push({sev:"warn",label:"Global Freeze active",detail:"This issuer has frozen all token balances."}),i-=10),t&Re.lsfDepositAuth&&o.push({sev:"ok",label:"Deposit Authorization enabled",detail:"Only pre-authorized senders can deposit."}),t&Re.lsfDefaultRipple&&o.push({sev:"info",label:"Default Ripple enabled",detail:"Balances can ripple through this account (issuer behaviour)."});let m=s.filter(({tx:f})=>f.TransactionType==="AccountDelete");return m.length&&(o.push({sev:"warn",label:`${m.length} AccountDelete attempt(s)`,detail:"Account deletion was attempted."}),i-=5),t&Re.lsfRequireAuth&&o.push({sev:"info",label:"Require Auth enabled",detail:"This account must individually approve each trustline before it can hold a balance \u2014 restricts who can hold what it issues."}),t&Re.lsfNoFreeze&&o.push({sev:"info",label:"No Freeze enabled",detail:"This account has permanently given up the ability to freeze trustlines \u2014 an irreversible choice, typically made to reassure holders."}),t&Re.lsfRequireDestTag&&o.push({sev:"info",label:"Require Destination Tag enabled",detail:"Payments to this account must include a destination tag \u2014 common for exchange/custodial deposit accounts."}),t&Re.lsfDisallowXRP&&o.push({sev:"info",label:"Disallow XRP flag set",detail:"A client-side hint requesting senders avoid sending XRP to this account. Not enforced by the protocol \u2014 XRP can still be sent."}),t&Re.lsfPasswordSpent&&o.push({sev:"info",label:"Password Spent flag set",detail:"This account has already used its one free SetRegularKey transaction; further regular-key changes will cost the standard transaction fee."}),o.length===0&&o.push({sev:"ok",label:"No security issues detected",detail:"Master key active, no regular key or signer list overrides, no risky flags set."}),{findings:o,score:Math.max(0,i),controlState:d}}function wb(e,t,n,s,a,o){let i=[],r="low",l=!!(t&Re.lsfDisableMaster),c=Tu(e,t,n,s),p=Cu(e,t,s);c?(i.push({sev:"info",label:"Intentional blackhole detected",detail:`Master key is disabled and regular key ${e.RegularKey} is a known blackhole address. This is typical for a permanently locked issuer/account, not a classic drain setup.`}),p&&i.push({sev:"warn",label:"Caution: sending assets back may burn them",detail:"Because this account appears to be an intentionally blackholed issuer, sending issued tokens back to it may strand or effectively burn those tokens."})):l&&e.RegularKey&&(i.push({sev:"critical",label:"Classic drain setup detected",detail:`Master key disabled. Regular key ${e.RegularKey} controls the account. If this key was set by an attacker, funds are at risk.`}),r="critical");let u=s.filter(({tx:m})=>m.TransactionType==="SetRegularKey"&&m.Account!==e.Account);if(!c&&u.length&&(i.push({sev:"critical",label:"Regular key set by external account",detail:`${u.length} key change(s) where sender \u2260 account owner. This is unusual.`}),r="critical"),a.length){let m=a.reduce((f,v)=>f+Number(v.Amount||0)/1e6,0);i.push({sev:"warn",label:`${a.length} open payment channel(s) \u2014 ${_(m,2)} XRP locked`,detail:`Destination(s): ${a.map(f=>W(f.Destination)).join(", ")}`}),r==="low"&&(r="medium")}if(o.length){let m=o.reduce((f,v)=>f+Number(v.Amount||0)/1e6,0);i.push({sev:"info",label:`${o.length} open escrow(s) \u2014 ${_(m,2)} XRP escrowed`,detail:`Escrow(s): ${o.map(f=>f.Destination?W(f.Destination):"self-escrow").join(", ")}`})}let d=s.filter(({tx:m})=>m.TransactionType==="DepositPreauth"&&m.Authorize);return d.length>5&&(i.push({sev:"warn",label:`${d.length} DepositPreauth grants issued`,detail:"Account pre-authorized many senders. Review if all are trusted."}),r==="low"&&(r="medium")),i.length===0&&i.push({sev:"ok",label:"No compromise-risk patterns detected",detail:"Auth structure looks intact."}),{signals:i,riskLevel:r}}function xb(e,t,n,s={}){let a=ku(e,t,n),i=$u(a,e,t,s).map(c=>mb(c,a,e,t)),r=[],l="none";for(let c of i){let p=c.windowSec===86400?"24h":`${Math.round(c.windowSec/86400)}d`,u=[`${_(c.totalOutflowXrp,2)} XRP moved out (${(c.pctOfBalanceMoved*100).toFixed(0)}% of the ${_(c.balanceAtStart,2)} XRP balance at window start) within ${p}`,c.newRecipientPct!=null?`${(c.newRecipientPct*100).toFixed(0)}% of destinations (${c.newDestCount}/${c.episodeDestCount}) were first-time recipients`:null,c.topDestShare!=null?`${(c.topDestShare*100).toFixed(0)}% of the outflow went to a single destination`:null,c.transferSizeAnomaly?`Transfer sizes in this window are ${(c.episodeMedianXrp/c.historicalMedianXrp).toFixed(1)}x this account's own historical median`:null,c.trustlineLiquidations.length?`${c.trustlineLiquidations.length} token position(s) liquidated shortly before/during this window`:null,c.dexConversionPrecedingWithdrawal?"A token\u2192XRP conversion occurred in the 48h before this outflow began":null,c.triggeredByAuthChange?"A regular-key or signer-list change occurred immediately before this window":null].filter(Boolean),d=[];c.newRecipientPct!=null&&c.newRecipientPct>.7&&d.push("Nearly all destinations are first-time recipients, not established counterparties"),c.triggeredByAuthChange&&d.push("Outflow immediately follows an authorization change \u2014 the classic compromise-then-drain sequence"),c.dexConversionPrecedingWithdrawal&&c.trustlineLiquidations.length&&d.push("Assets were converted to XRP shortly before leaving, consistent with liquidating a position specifically to withdraw everything");let m=c.destinations.some(v=>v.entity),f=c.triggeredByAuthChange||c.pctOfBalanceMoved>=.9?"critical":"warn";f==="critical"?l="critical":l!=="critical"&&(l=l==="none"||l==="low"?"high":l),r.push(Te({module:"Asset Drain Behavior",category:"security",sev:f,confidence:c.triggeredByAuthChange?.75:.5,headline:`${_(c.totalOutflowXrp,2)} XRP (${(c.pctOfBalanceMoved*100).toFixed(0)}% of balance) moved out within ${p}`,detail:"Sliding-window balance reconstruction flagged this as an unusually large, fast depletion.",observed:u,alternativeExplanations:["A planned, deliberate transfer by the account's own owner (exchange withdrawal, consolidation, moving to a new wallet)",m?"Destination is a known exchange or labeled entity, consistent with a routine cash-out":"Destination(s) not in the known-entity registry \u2014 inconclusive either way"],evidenceAgainstBenign:d,classification:c.triggeredByAuthChange?"Outflow following an authorization change is a strong compromise-and-drain signal, but ledger data alone cannot distinguish an attacker from an owner who changed their own key and then withdrew funds themselves.":"Large, fast depletion observed. This describes behavior, not intent \u2014 see Account Compromise Risk above for whether the account's access controls show separate signs of being compromised."}))}return r.length||r.push(Te({module:"Asset Drain Behavior",category:"security",sev:"ok",headline:"No abnormal depletion detected",detail:"No window scanned showed a large, fast balance drop relative to this account's own history."})),{episodes:i,findings:r,severity:l}}var mu={low:0,medium:1,high:2,critical:3,none:-1};function Pu(e,t,n,s,a,o,i,r,l){let c=wb(e,t,n,s,a,o),p=xb(s,i,r,l),u=p.severity==="none"?"low":p.severity==="high"?"critical":p.severity,d=mu[u]>mu[c.riskLevel]?u:c.riskLevel;return{signals:[...c.signals,...p.findings],riskLevel:d,compromiseRiskLevel:c.riskLevel,assetDrainSeverity:p.severity,episodes:p.episodes}}function kb(e,t,n){let s=[],a=new Map(e.map(m=>[m.NFTokenID,m])),i=t.filter(({tx:m})=>m.TransactionType==="NFTokenCreateOffer"&&m.Account===n).filter(({tx:m})=>{let f=m.Amount;return f?typeof f=="string"?Number(f)<1e6:!1:!0});i.length&&s.push({sev:"critical",label:`${i.length} NFT offer(s) created for \u22641 XRP`,detail:"You created sell offers at near-zero price. This is a common NFT drain vector \u2014 attackers trick victims into listing their NFTs for free."});let r=t.filter(({tx:m})=>m.TransactionType==="NFTokenAcceptOffer"&&m.Account===n);r.length&&s.push({sev:"warn",label:`${r.length} NFT offer(s) accepted`,detail:"Review these transactions to confirm they were intentional sales/purchases."});let l=t.filter(({tx:m})=>m.TransactionType==="NFTokenBurn"&&m.Account===n);l.length&&s.push({sev:"warn",label:`${l.length} NFT(s) burned`,detail:"Burned NFTs cannot be recovered. Confirm these were intentional."});let c=t.filter(({tx:m})=>m.TransactionType==="NFTokenMint"&&m.Account===n),p=t.filter(({tx:m})=>m.TransactionType==="NFTokenCreateOffer"||m.TransactionType==="NFTokenAcceptOffer");c.length>0&&p.length>0&&s.push({sev:"info",label:`${c.length} NFT(s) minted \xB7 ${p.length} transfer event(s)`,detail:"This account has minting activity."});let u=e.filter(m=>m.TransferFee&&m.TransferFee>0);if(u.length){let m=u.reduce((f,v)=>f+v.TransferFee,0)/u.length;s.push({sev:"info",label:`${u.length} NFT(s) carry transfer fees (avg ${(m/1e3).toFixed(1)}%)`,detail:"These NFTs pay royalties on each transfer."})}let d=e.filter(m=>!m.URI);return d.length>2&&s.push({sev:"warn",label:`${d.length} NFT(s) have no URI / metadata`,detail:"NFTs without a URI may be spam or placeholder tokens used in scams."}),s.length===0&&e.length===0?s.push({sev:"ok",label:"No NFT activity detected",detail:"This account holds no NFTs."}):s.length===0&&s.push({sev:"ok",label:`${e.length} NFT(s) held \u2014 no risk signals`,detail:"NFT posture looks normal."}),{flags:s,nftCount:e.length,mintCount:c.length}}var Qa={tfPassive:65536,tfImmediateOrCancel:131072,tfFillOrKill:262144,tfSell:524288};function $b(e,t){var n;for(let s of(e==null?void 0:e.AffectedNodes)||[]){let a=s.CreatedNode;if((a==null?void 0:a.LedgerEntryType)==="Offer"&&((n=a.NewFields)==null?void 0:n.Account)===t)return a}return null}function Mu(e,t,n={}){var r,l,c,p,u,d,m;let s=new Map,a=[],o=n.newestToOldestComplete||n.oldestToNewestFetched?"complete":"possibly-truncated";e.forEach((f,v)=>{var P,R,O,D,I;let{tx:b,meta:h}=f;if(b.TransactionType!=="OfferCreate"||b.Account!==t||(h==null?void 0:h.TransactionResult)!=="tesSUCCESS")return;let g={currency:ji(b.TakerGets),issuer:typeof b.TakerGets=="object"?b.TakerGets.issuer:null,value:Qt(b.TakerGets)},x={currency:ji(b.TakerPays),issuer:typeof b.TakerPays=="object"?b.TakerPays.issuer:null,value:Qt(b.TakerPays)},k=$b(h,t),T=k?{gets:Qt((P=k.NewFields)==null?void 0:P.TakerGets),pays:Qt((R=k.NewFields)==null?void 0:R.TakerPays)}:null,S={gets:Math.max(0,(g.value??0)-((T==null?void 0:T.gets)??0)),pays:Math.max(0,(x.value??0)-((T==null?void 0:T.pays)??0))},$=[];for(let F of h.AffectedNodes||[]){let B=F.DeletedNode||F.ModifiedNode;if(!B||B.LedgerEntryType!=="Offer")continue;let E=(O=B.FinalFields)==null?void 0:O.Account;!E||E===t||$.push({account:E,gets:Qt((D=B.FinalFields)==null?void 0:D.TakerGets),pays:Qt((I=B.FinalFields)==null?void 0:I.TakerPays)})}let N=Number(b.Flags||0),C={offerId:`${t}:${b.Sequence}`,createHash:b.hash,createDate:b.date,createLedgerIndex:(k==null?void 0:k.LedgerIndex)||null,takerGetsOriginal:g,takerPaysOriginal:x,offerSequence:b.Sequence,replacesOfferSeq:b.OfferSequence||null,flags:{passive:!!(N&Qa.tfPassive),immediateOrCancel:!!(N&Qa.tfImmediateOrCancel),fillOrKill:!!(N&Qa.tfFillOrKill),sell:!!(N&Qa.tfSell)},expiration:b.Expiration||null,crossedAtCreation:S,counterpartiesAtCreation:$,restingAmount:T,status:k?"resting":"filled-immediately",consumedEvents:[],cancelHash:null,cancelDate:null,timeRestingSeconds:null,realizedFillPct:null,expiryUncertain:!1,dataCompleteness:o,_createIdx:v};s.set(C.offerId,C),a.push(C)});for(let f of a){if(!f.createLedgerIndex)continue;for(let h=f._createIdx+1;h<e.length;h++){let{tx:g,meta:x}=e[h];if((x==null?void 0:x.TransactionResult)!=="tesSUCCESS"&&(x==null?void 0:x.TransactionResult)!=="tecKILLED"&&!((r=x==null?void 0:x.AffectedNodes)!=null&&r.length))continue;let k=null;for(let T of(x==null?void 0:x.AffectedNodes)||[]){let S=T.CreatedNode,$=T.ModifiedNode,N=T.DeletedNode,C=S||$||N;if(!(!C||C.LedgerEntryType!=="Offer")&&C.LedgerIndex===f.createLedgerIndex){k={node:C,kind:N?"deleted":$?"modified":"created"};break}}if(k){if(k.kind==="deleted"){let T=g.Account===t&&g.TransactionType==="OfferCancel"&&g.OfferSequence===f.offerSequence,S=g.Account===t&&g.TransactionType==="OfferCreate"&&g.OfferSequence===f.offerSequence;if(T||S)f.status="cancelled",f.cancelHash=g.hash,f.cancelDate=g.date;else{let $=Yi(g,x,t);$.xrpDelta!==0||$.tokenDeltas.some(C=>C.delta!==0)?(f.status="consumed-later",f.consumedEvents.push({hash:g.hash,date:g.date,counterpartyAccount:g.Account!==t?g.Account:null})):(f.status="expired",f.expiryUncertain=!0)}f.timeRestingSeconds=(g.date??f.createDate)-f.createDate,f.dataCompleteness=f.dataCompleteness;break}if(k.kind==="modified"){let T=Qt((l=k.node.FinalFields)==null?void 0:l.TakerGets),S=Qt((c=k.node.FinalFields)==null?void 0:c.TakerPays);f.consumedEvents.push({hash:g.hash,date:g.date,counterpartyAccount:g.Account!==t?g.Account:null,gets:Math.max(0,(((p=f.restingAmount)==null?void 0:p.gets)??0)-(T??0)),pays:Math.max(0,(((u=f.restingAmount)==null?void 0:u.pays)??0)-(S??0))}),f.restingAmount={gets:T,pays:S},f.status="partially-filled-then-resting"}}}if(f.status==="resting"||f.status==="partially-filled-then-resting"){let h=Math.floor(Date.now()/1e3)-gu,g=((m=(d=e[e.length-1])==null?void 0:d.tx)==null?void 0:m.date)??h;f.expiration!=null&&f.expiration<=g?(f.status="expired",f.expiryUncertain=!0):f.status="unknown-open",f.timeRestingSeconds=g-f.createDate,f.dataCompleteness}let v=f.consumedEvents.reduce((h,g)=>h+(g.gets||0),0),b=f.crossedAtCreation.gets+v;f.realizedFillPct=f.takerGetsOriginal.value?Math.min(100,b/f.takerGetsOriginal.value*100):null,delete f._createIdx}let i={total:a.length,filledImmediately:a.filter(f=>f.status==="filled-immediately").length,cancelled:a.filter(f=>f.status==="cancelled").length,consumedLater:a.filter(f=>f.status==="consumed-later").length,partiallyFilled:a.filter(f=>f.status==="partially-filled-then-resting").length,expired:a.filter(f=>f.status==="expired").length,unknownOpen:a.filter(f=>f.status==="unknown-open").length};return{byOfferId:s,list:a,stats:i}}function Sb(e,t){let n=e.list,s=n.length,a=n.filter(g=>g.status==="filled-immediately").length,o=n.filter(g=>g.status==="resting"||g.status==="partially-filled-then-resting"||g.status==="unknown-open").length,i=n.filter(g=>g.status==="consumed-later").length,r=n.filter(g=>g.status==="cancelled").length,l=n.filter(g=>g.status==="expired").length,c=n.filter(g=>g.status==="unknown-open").length,p=n.map(g=>g.timeRestingSeconds).filter(g=>g!=null),u=p.length?p.reduce((g,x)=>g+x,0)/p.length:null,d=[...p].sort((g,x)=>g-x),m=d.length?d[Math.floor(d.length/2)]:null,f=n.map(g=>g.realizedFillPct).filter(g=>g!=null),v=f.length?f.reduce((g,x)=>g+x,0)/f.length:null,b=new Map;for(let g of n){let x=[g.takerGetsOriginal.currency||"?",g.takerPaysOriginal.currency||"?"].sort().join("\u2194"),k=b.get(x)||{created:0,filled:0,cancelled:0,fillPctSum:0,fillPctCount:0};k.created++,(g.status==="filled-immediately"||g.status==="consumed-later")&&k.filled++,g.status==="cancelled"&&k.cancelled++,g.realizedFillPct!=null&&(k.fillPctSum+=g.realizedFillPct,k.fillPctCount++),b.set(x,k)}for(let g of b.values())g.avgFillPct=g.fillPctCount?g.fillPctSum/g.fillPctCount:null;let h=[];if(s>=10){let g=r/s;v!=null&&v<5&&g>.5?h.push(Te({module:"Offer Fill Rate",category:"liquidity",sev:"warn",confidence:.6,headline:`Low realized fill rate: ${v.toFixed(1)}% across ${s} offers`,detail:`${r} of ${s} offers were cancelled, most with minimal execution before cancellation.`,observed:[`${r} cancelled (${(g*100).toFixed(0)}%)`,`${i} consumed by a counterparty after resting`,`${l} expired/removed unfunded`,`${c} still open as of the last analyzed transaction`,`Average time resting before resolution: ${u!=null?u.toFixed(0)+"s":"unknown"}`],alternativeExplanations:["Active order management \u2014 repricing as the market moves","Automated market-making that requeues orders frequently"],evidenceAgainstBenign:v<1?["Realized fill percentage is near zero, not just below average"]:[],classification:"A low fill rate is observed. On its own this does not establish intent \u2014 see the Spoofing and Market-Maker Automation scores for further context."})):h.push(Te({module:"Offer Fill Rate",category:"liquidity",sev:"ok",confidence:.7,headline:`${v!=null?v.toFixed(1)+"%":"Normal"} realized fill rate across ${s} offers`,detail:`${a} filled immediately, ${i} consumed after resting, ${r} cancelled, ${l} expired.`}))}else h.push(Te({module:"Offer Fill Rate",category:"liquidity",sev:"info",headline:`Only ${s} offer(s) placed \u2014 insufficient sample for fill-rate analysis`,detail:"Need at least 10 OfferCreate transactions for a meaningful fill-rate read."}));return{createdCount:s,immediateFillCount:a,restingCount:o,laterConsumedCount:i,cancelledCount:r,expiredCount:l,unknownOpenCount:c,avgTimeRestingSeconds:u,medianTimeRestingSeconds:m,realizedFillPctOverall:v,byPair:b,findings:h}}function Tb(e,t,n){let s=e.list,a=s.map(h=>h.createDate).filter(h=>h!=null).sort((h,g)=>h-g),o=h=>{if(!a.length)return 0;let g=1;for(let x=0;x<a.length;x++){let k=1;for(let T=x+1;T<a.length&&a[T]-a[x]<=h;T++)k++;g=Math.max(g,k)}return g},i={thirtySec:o(30),oneHour:o(3600)},r=s.map(h=>h.takerGetsOriginal.value).filter(h=>h!=null&&h>0),l=null;if(r.length>=Ji){let h=r.reduce((x,k)=>x+k,0)/r.length,g=Math.sqrt(r.reduce((x,k)=>x+(k-h)**2,0)/r.length);l=h>0?g/h:null}let c=[100,1e3,1e4,1e5],p=r.filter(h=>c.some(g=>Math.abs(h%g)<1e-6&&h/g>=1)).length,u=r.length?p/r.length:0,d=new Map;s.forEach(h=>{let g=[h.takerGetsOriginal.currency||"?",h.takerPaysOriginal.currency||"?"].sort().join("\u2194");d.set(g,(d.get(g)||0)+1)});let m=[...d.entries()].sort((h,g)=>g[1]-h[1])[0]||null,f=m&&s.length?m[1]/s.length:0,v=s.length?s.filter(h=>h.status==="cancelled").length/s.length:0,b=s.map(h=>h.timeRestingSeconds).filter(h=>h!=null);return{burstWindows:i,sizeCV:l,roundNumberPct:u,pairConcentration:f,dominantPair:m,cancelRatio:v,restingTimes:b,createdCount:s.length}}function Cb(e,t,n,s){let a=[],o=0,i=n.filter(({tx:u})=>u.TransactionType==="Payment"),r=new Set(i.filter(({tx:u})=>u.Account===s&&u.Destination).map(({tx:u})=>u.Destination)),l=new Set(i.filter(({tx:u})=>u.Destination===s&&u.Account).map(({tx:u})=>u.Account)),c=[...r].filter(u=>l.has(u));if(c.length>0&&i.length>=Ji){let u=c.length/r.size;if(u>sb){let d=new Set;for(let f of t.list){for(let v of f.counterpartiesAtCreation)d.add(v.account);for(let v of f.consumedEvents)v.counterpartyAccount&&d.add(v.counterpartyAccount)}let m=c.filter(f=>d.has(f));a.push(Te({module:"Wash Execution",category:"market-integrity",sev:"warn",confidence:m.length?.55:.4,headline:`${c.length} round-trip payment counterpart(s) detected`,detail:`${(u*100).toFixed(1)}% of payment recipients also sent back to this account.`,observed:[`${c.length} of ${r.size} outbound recipients also sent payments back`,m.length?`${m.length} of those also traded directly on the DEX with this account`:"No overlap found with DEX trading counterparties"],alternativeExplanations:["Ordinary reciprocal business/personal payments","Exchange deposit/withdrawal cycling through the same account"],evidenceAgainstBenign:m.length?["Payment round-trip AND direct DEX trading with the same counterparty(ies)"]:[],classification:"Round-trip payment pattern observed. Cannot confirm circular multi-account flow (A\u2192B\u2192C\u2192A) from this account's history alone \u2014 that would require the counterparties' own transaction histories."})),o+=m.length?25:15}}let p=i.filter(({tx:u})=>u.Account===s&&u.Destination===s);return p.length>0&&(a.push(Te({module:"Wash Execution",category:"market-integrity",sev:"critical",confidence:.85,headline:`${p.length} self-payment(s): sender = receiver`,detail:"Payments where origin and destination are the same address.",observed:[`${p.length} Payment transaction(s) with Account === Destination`],alternativeExplanations:["A no-op transaction used to mark an account active, or to test a memo/path"],evidenceAgainstBenign:p.length>2?["Repeated, not a single isolated instance"]:[],classification:"Confirmed self-payment. Creates recorded volume with zero net economic transfer \u2014 this is a fact about the transaction, not an inference."})),o+=30),a.length||a.push(Te({module:"Wash Execution",category:"market-integrity",sev:"ok",headline:"No wash-execution signals",detail:`${t.list.length} offers, ${p.length} self-payments \u2014 patterns look normal.`})),{score:Math.min(100,o),findings:a,stats:{roundTrip:c.length,selfTrades:p.length}}}function Pb(e,t,n,s,a){var u;let o=[],i=0,r=t.list,l=t.byOfferId,c=0,p=0;for(let d of r){if(!d.replacesOfferSeq)continue;let m=l.get(`${s}:${d.replacesOfferSeq}`);if(!m)continue;c++;let f=m.takerPaysOriginal.value&&m.takerGetsOriginal.value?m.takerPaysOriginal.value/m.takerGetsOriginal.value:null,v=d.takerPaysOriginal.value&&d.takerGetsOriginal.value?d.takerPaysOriginal.value/d.takerGetsOriginal.value:null;f&&v&&Math.abs(v-f)/f<.02&&p++}if(c>=5&&p/c>.6&&(o.push(Te({module:"Spoofing",category:"market-integrity",sev:"warn",confidence:.45,headline:`${p} of ${c} order replacements kept nearly the same price`,detail:"Cancel-and-immediately-recreate at a near-identical price, repeated \u2014 a quote-management pattern worth a closer look.",observed:[`${c} create-and-replace chains found`,`${p} replaced within 2% of the prior price`],alternativeExplanations:["Routine order refresh/repricing by an active trader or market maker","Bumping sequence to avoid an unrelated conflict"],classification:"Replacement pattern observed. On its own this is common in both legitimate quote maintenance and layering \u2014 see Market-Maker Automation for the explanatory read."})),i+=15),r.length>=10){let d=r.filter(m=>m.takerGetsOriginal.currency==="XRP"&&m.takerGetsOriginal.value!=null);if(d.length>=10){let m=d.map(g=>g.takerGetsOriginal.value).sort((g,x)=>x-g),f=m[Math.floor(m.length*.05)]||0,v=d.filter(g=>g.takerGetsOriginal.value>=f),b=v.filter(g=>g.status==="cancelled"||g.status==="expired"),h=v.length>=5?b.length/v.length:0;h>=.95&&(o.push(Te({module:"Spoofing",category:"market-integrity",sev:"warn",confidence:.3,headline:`${(h*100).toFixed(0)}% of this wallet's largest orders were cancelled without meaningful fill (own-history proxy)`,detail:`${b.length} of ${v.length} top-5%-by-this-wallet's-own-size orders cancelled or expired.`,observed:["Sizing is relative to this wallet's own order history, not current book depth",`${b.length}/${v.length} cancelled or expired without fill`],alternativeExplanations:["A large order sized appropriately for a genuinely deep, liquid market","Cancelled for unrelated reasons (funding change, strategy shift)"],classification:"Own-history size proxy only \u2014 true book-depth-relative sizing and price-distance-from-executable checks need historical order-book state this app cannot reliably obtain from public XRPL nodes. Treat as a weaker signal than a book-relative measurement would be."})),i+=10)}}if((u=a==null?void 0:a.signals)!=null&&u.length)for(let d of a.signals)(d.sev==="critical"||d.sev==="warn")&&(o.push(d),i+=d.sev==="critical"?20:10);return o.length||o.push(Te({module:"Spoofing",category:"market-integrity",sev:"ok",headline:"No spoofing signals",detail:"No large-order cancel pattern, replacement pattern, or live book wall detected."})),{score:Math.min(100,i),findings:o}}function Mb(e,t,n,s,a){let o=[],i=!1,r=e.cancelRatio>nb,l=e.sizeCV!=null&&e.sizeCV<.2,c=e.burstWindows.thirtySec>=8||e.burstWindows.oneHour>100,p=(a==null?void 0:a.realizedFillPctOverall)!=null&&a.realizedFillPctOverall>=5;return e.createdCount>=Ji&&r&&(l||c)?(i=!0,o.push(Te({module:"Market-Maker Automation",category:"automation",sev:"info",confidence:p?.6:.4,headline:"Behavior consistent with automated market-making / quote maintenance",detail:`${(e.cancelRatio*100).toFixed(0)}% cancel ratio, ${e.sizeCV!=null?"CV "+e.sizeCV.toFixed(2):"no size-uniformity read"}, max ${e.burstWindows.thirtySec} offers/30s.`,observed:[`Cancel ratio: ${(e.cancelRatio*100).toFixed(0)}%`,e.sizeCV!=null?`Order-size coefficient of variation: ${e.sizeCV.toFixed(2)}`:null,`Burst: up to ${e.burstWindows.thirtySec} offers in 30s, ${e.burstWindows.oneHour} in 1h`,p?`Realized fill rate: ${a.realizedFillPctOverall.toFixed(1)}% \u2014 not zero, consistent with a working market-making strategy`:"Realized fill rate is low or unknown"].filter(Boolean),alternativeExplanations:["Spoofing/layering dressed up with uniform sizing to look automated"],evidenceAgainstBenign:p?[]:["Fill rate is low despite the high order volume \u2014 automation alone does not explain that combination"],classification:p?"High cancel/burst/uniformity plus a non-trivial realized fill rate is the expected signature of legitimate automated market-making. This explanation should reduce confidence in Wash Execution and Spoofing findings above, not add to them.":"High cancel/burst/uniformity WITHOUT meaningful fills is less consistent with genuine market-making \u2014 weigh the Spoofing and Wash Execution findings above accordingly."}))):o.push(Te({module:"Market-Maker Automation",category:"automation",sev:"ok",headline:"No strong automation signature",detail:"Order behavior does not show the high-cancel/tight-sizing/burst pattern typical of automated market-making."})),{automationLikely:i,findings:o}}function Lb(e,t,n,s,a,o){let i=Tb(s,e,t),r=Cb(i,s,e,t),l=Pb(i,s,e,t,o),c=Mb(i,s,e,t,a),p=[...r.findings,...l.findings,...c.findings,...(a==null?void 0:a.findings)||[]],u=Math.min(100,r.score+l.score),d=u===0?"clean":u<25?"low-risk":u<50?"suspicious":"high-risk";return{signals:p,score:u,verdict:d,executionScore:r.score,spoofingScore:l.score,automationLikely:c.automationLikely,stats:{creates:s.list.length,cancels:s.list.filter(m=>m.status==="cancelled").length,fills:(a==null?void 0:a.immediateFillCount)??0,payments:e.filter(({tx:m})=>m.TransactionType==="Payment").length,roundTrip:r.stats.roundTrip,selfTrades:r.stats.selfTrades}}}var Ab=[0,.301,.176,.125,.097,.079,.067,.058,.051,.046];function Eb(e){let t=new Map;for(let{tx:n}of e){let s=n.TransactionType==="Payment"?"Payment":n.TransactionType==="OfferCreate"||n.TransactionType==="OfferCancel"?"Offer":null;if(!s)continue;let a=[n.Amount,n.TakerGets,n.TakerPays,n.SendMax,n.DeliverMin];for(let o of a){let i=ji(o),r=Qt(o);if(r==null||r<=0||!Number.isFinite(r)||!i)continue;let l=`${i}|${s}`;t.has(l)||t.set(l,{currency:i,txClass:s,values:[]}),t.get(l).values.push(r)}}return t}function Nb(e){let t=e.length,n=[];if(t<50)return{level:"LOW",reasons:[`Only ${t} observations in this group (need \u226550)`],n:t};let s=[...e].sort((u,d)=>u-d),a=s[0],o=s[s.length-1],i=a>0?Math.log10(o/a):0,r=[100,1e3,1e4,1e5],c=e.filter(u=>r.some(d=>Math.abs(u%d)<1e-6&&u/d>=1)).length/t,p="HIGH";return i<1?(p="LOW",n.push(`Values span only ${i.toFixed(1)} orders of magnitude \u2014 Benford needs a wide spread to be meaningful`)):i<2&&(p="MEDIUM",n.push(`Narrow magnitude spread (${i.toFixed(1)} orders of magnitude)`)),c>.5?(p="LOW",n.push(`${(c*100).toFixed(0)}% round-number amounts \u2014 suggests fixed lot sizes or tick constraints, not organically-generated values`)):c>.25&&p==="HIGH"&&(p="MEDIUM",n.push(`${(c*100).toFixed(0)}% round-number amounts`)),t<100&&p==="HIGH"&&(p="MEDIUM",n.push(`Sample size (${t}) clears the minimum but is still modest`)),n.length||n.push("Sufficient sample size, wide magnitude spread, low round-number concentration"),{level:p,reasons:n,magnitudeSpread:i,roundPct:c,n:t}}function Rb(e){let t=e.length,n=new Array(10).fill(0);for(let o of e){let i=o.toFixed(6).replace(/^0+\.?0*/,""),r=parseInt(i[0],10);r>=1&&r<=9&&n[r]++}let s=0,a=[];for(let o=1;o<=9;o++){let i=n[o]/t,r=Ab[o];s+=t*Math.pow(i-r,2)/r,a.push({digit:o,obs:(i*100).toFixed(1),exp:(r*100).toFixed(1),delta:((i-r)*100).toFixed(1)})}return{chiSq:s,digitBreakdown:a,n:t}}function Lu(e){if((e==null?void 0:e.chiSq)==null)return 0;let t={HIGH:1,MEDIUM:.5,LOW:.15}[e.overallApplicability]??.15;return Math.min(10,e.chiSq/20.09*10)*t}function _b(e){let t=Eb(e),n=[];for(let[i,r]of t){if(r.values.length<50)continue;let l=Nb(r.values),c=Rb(r.values);n.push({key:i,currency:r.currency,txClass:r.txClass,...c,applicability:l})}if(n.sort((i,r)=>r.n-i.n),!n.length)return{signals:[{sev:"info",label:"Insufficient data for Benford's Law",detail:"No single currency/transaction-class group reached the 50-observation minimum \u2014 amounts are too fragmented across assets to test any one distribution meaningfully."}],results:[],overallApplicability:"LOW",chiSq:null,verdict:"insufficient",digitBreakdown:[],sampleSize:0};let s=n.map(i=>Te({module:"Benford's Law",category:"market-integrity",sev:i.applicability.level==="LOW"?"info":i.chiSq>20.09?"warn":"ok",confidence:{HIGH:.7,MEDIUM:.4,LOW:.15}[i.applicability.level],headline:`${i.currency==="XRP"?"XRP":W(i.currency)} ${i.txClass} amounts: \u03C7\xB2=${i.chiSq.toFixed(1)}, Applicability ${i.applicability.level}`,detail:`n=${i.n} observations`,observed:[`Benford Applicability: ${i.applicability.level}`,...i.applicability.reasons,`Chi-square statistic: ${i.chiSq.toFixed(2)} (critical values: 15.51 at p<0.05, 20.09 at p<0.01)`],classification:i.applicability.level==="LOW"?"Benford's Law is not reliably applicable to this group (narrow magnitude spread and/or high round-number concentration) \u2014 a deviation here says nothing about whether amounts were fabricated.":i.chiSq>20.09?"Amount-generation pattern is non-natural under this model. This describes the shape of the distribution, not a conclusion about intent \u2014 fixed pricing tiers, algorithmic strategies, and token denomination conventions are common legitimate causes of Benford deviation.":"First-digit distribution is consistent with organic, unconstrained amount generation."})),a=n[0],o=n.some(i=>i.applicability.level==="HIGH")?"HIGH":n.some(i=>i.applicability.level==="MEDIUM")?"MEDIUM":"LOW";return{signals:s,results:n,overallApplicability:o,chiSq:a.chiSq,verdict:a.chiSq>20.09?"high-deviation":a.chiSq>15.51?"moderate-deviation":"normal",digitBreakdown:a.digitBreakdown,sampleSize:a.n}}function Db(e,t){let s=[],a=[];for(let{tx:b}of e){let h=[b.Amount,b.TakerGets,b.TakerPays];for(let g of h){let x=typeof g=="string"?Number(g)/1e6:g!=null&&g.value?Number(g.value):null;x&&x>0&&Number.isFinite(x)&&a.push(x)}}let o=a.length>=30?(()=>{let b=new Array(12).fill(0);for(let h of a){let g=Math.min(11,Math.max(0,Math.floor(Math.log10(h+1)*2)));b[g]++}return Qs(b)})():null,i={};for(let{tx:b}of e){let h=b.Account===t?b.Destination:b.Account;h&&h!==t&&(i[h]=(i[h]||0)+1)}let r=Object.values(i),l=r.length>=3?Qs(r):null,c=new Array(24).fill(0),p=!1;for(let{tx:b}of e)if(b.date){let g=new Date((b.date+946684800)*1e3).getUTCHours();c[g]++,p=!0}let u=p&&e.length>=30?Qs(c):null,d={};for(let{tx:b}of e)d[b.TransactionType]=(d[b.TransactionType]||0)+1;let m=Qs(Object.values(d)),f="normal",v=0;if(o!==null&&(o<1.5?(f="low-entropy",v+=18,s.push({sev:"warn",label:`Amount entropy critically low (H=${o.toFixed(2)} bits)`,detail:"Transaction amounts are highly repetitive. A bot or scripted actor tends to reuse the same values. Organic wallets show entropy \u22652.4 bits across amount magnitudes."})):o<2.2?(v+=8,s.push({sev:"info",label:`Amount entropy below natural range (H=${o.toFixed(2)} bits)`,detail:"Some amount repetition detected. Could indicate automated activity mixed with organic transactions."})):o>4.5?(v+=10,s.push({sev:"info",label:`Amount entropy abnormally high (H=${o.toFixed(2)} bits)`,detail:"Transaction amounts are maximally varied \u2014 more than organic activity typically shows. This can indicate amounts were artificially randomized to evade Benford detection."})):s.push({sev:"ok",label:`Amount entropy normal (H=${o.toFixed(2)} bits)`,detail:"Transaction amount diversity is consistent with organic financial activity."})),l!==null&&(l<1&&r.length<4?(v+=14,s.push({sev:"warn",label:`Counterparty entropy very low (H=${l.toFixed(2)} bits)`,detail:"This wallet transacts with very few unique addresses and with high repetition \u2014 a structural signature of round-trip wash trading rings."})):l<2?(v+=5,s.push({sev:"info",label:`Counterparty entropy low (H=${l.toFixed(2)} bits)`,detail:"Most interactions are concentrated among a small set of counterparties."})):s.push({sev:"ok",label:`Counterparty diversity healthy (H=${l.toFixed(2)} bits)`,detail:"Counterparty distribution reflects diverse interaction patterns."})),u!==null){let b=Math.log2(24),h=u/b;h<.45?(v+=10,s.push({sev:"warn",label:`Time-of-day entropy low (H=${u.toFixed(2)} bits, ${(h*100).toFixed(0)}% of max)`,detail:"Transactions cluster heavily in a few hours of the day. Bots typically run at fixed UTC hours; organic users spread activity across the day."})):s.push({sev:"ok",label:`Time-of-day distribution natural (H=${u.toFixed(2)} bits)`,detail:"Transaction timing is distributed across hours in a pattern consistent with human activity."})}return s.length||s.push({sev:"info",label:"Insufficient data for entropy analysis",detail:`Need \u226530 transactions. Found ${e.length}.`}),v>=18?f="anomalous":v>=8&&(f="elevated"),{signals:s,verdict:f,riskPenalty:v,amountEntropy:o,counterpartyEntropy:l,timeEntropy:u,typeEntropy:m,uniqueCounterparties:r.length,sampleSize:e.length}}function Qs(e){let t=e.reduce((n,s)=>n+s,0);return t?-e.reduce((n,s)=>{if(!s)return n;let a=s/t;return n+a*Math.log2(a)},0):0}function Ib(e,t){let s=[],a={};for(let{tx:C}of e){let P=C.Account===t?C.Destination:C.Account;P&&P!==t&&(a[P]=(a[P]||0)+1)}let o=Object.values(a).sort((C,P)=>P-C);if(o.length<8)return{signals:[{sev:"info",label:`Insufficient counterparties for Zipf's Law (need \u22658, found ${o.length})`,detail:"Zipf analysis becomes meaningful with a broader counterparty network."}],verdict:"insufficient",zipfExponent:null,riskPenalty:0,freqTable:[],uniqueCounterparties:o.length};let i=o.length,r=0,l=0,c=0,p=0,u=o.map((C,P)=>({rank:P+1,freq:C,lx:Math.log(P+1),ly:Math.log(C)}));for(let{lx:C,ly:P}of u)r+=C,l+=P,c+=C*P,p+=C*C;let d=i*p-r*r,m=d!==0?(i*c-r*l)/d:null,f=m!==null?Math.abs(m):null,v=l/i,b=0,h=0,g=(l-m*r)/i;for(let{lx:C,ly:P}of u)b+=Math.pow(P-v,2),h+=Math.pow(P-(m*C+g),2);let x=b>0?1-h/b:0,k="normal",T=0;f!==null&&(x<.55?(T+=12,s.push({sev:"warn",label:`Counterparty distribution doesn't follow Zipf's Law (R\xB2=${x.toFixed(2)})`,detail:`Natural networks follow a power-law rank-frequency relationship. This wallet's counterparty network has poor Zipf fit (R\xB2=${x.toFixed(2)}), suggesting artificial or script-driven interaction structure.`}),k="anomalous"):f<.4?(T+=15,s.push({sev:"warn",label:`Zipf exponent too flat (s=${f.toFixed(2)}, expected 0.8\u20131.3)`,detail:"A very flat Zipf exponent means counterparties are used with surprisingly equal frequency. In organic networks, you transact far more often with a few key addresses. Flat distribution is consistent with round-trip wash trading rings."}),k="anomalous"):f>2.2?(T+=10,s.push({sev:"warn",label:`Zipf exponent hyper-concentrated (s=${f.toFixed(2)}, expected 0.8\u20131.3)`,detail:"Extreme concentration on one or two counterparties with steep dropoff. While not unusual for simple wallets, combined with other signals this suggests coordinated narrow-ring activity."}),k="elevated"):s.push({sev:"ok",label:`Counterparty network follows Zipf's Law (s=${f.toFixed(2)}, R\xB2=${x.toFixed(2)})`,detail:"The rank-frequency distribution of counterparties follows the expected natural power-law pattern. This is consistent with organic wallet activity."}));let S={};for(let{tx:C}of e){let P=typeof C.Amount=="string"?Math.round(Number(C.Amount)/1e4)*10:null;P&&P>0&&(S[P]=(S[P]||0)+1)}let $=Object.values(S).sort((C,P)=>P-C),N=$.length?$[0]/$.reduce((C,P)=>C+P,0):0;return N>.45&&(T+=8,s.push({sev:"warn",label:`Single amount dominates ${(N*100).toFixed(0)}% of transactions`,detail:"One transaction amount value accounts for nearly half of all payments. Round-number dominance is a hallmark of scripted or wash-trading activity."})),s.length||s.push({sev:"info",label:"Zipf analysis: no anomalies detected",detail:"Counterparty distribution consistent with natural activity."}),{signals:s,verdict:k,riskPenalty:T,zipfExponent:f,rSquared:x,freqTable:o.slice(0,12),uniqueCounterparties:o.length}}function Fb(e){if(e.length<20)return{signals:[{sev:"info",label:`Insufficient transactions for time series analysis (need \u226520, found ${e.length})`,detail:"Time series analysis requires a longer transaction history."}],verdict:"insufficient",riskPenalty:0,intervalCV:null,autocorrelation:null,burstScore:null,periodicityScore:null};let s=e.filter(({tx:S})=>S.date!=null).map(({tx:S})=>(S.date+946684800)*1e3).sort((S,$)=>S-$);if(s.length<20)return{signals:[{sev:"info",label:"No timestamp data available",detail:"Time series requires date-stamped transactions."}],verdict:"insufficient",riskPenalty:0,intervalCV:null,autocorrelation:null,burstScore:null,periodicityScore:null};let a=[];for(let S=1;S<s.length;S++){let $=(s[S]-s[S-1])/1e3;$>0&&$<86400*30&&a.push($)}let o=null;if(a.length>=5){let S=a.reduce((N,C)=>N+C,0)/a.length,$=Math.sqrt(a.reduce((N,C)=>N+Math.pow(C-S,2),0)/a.length);o=S>0?$/S:null}let i={};for(let S of s){let $=new Date(S).toISOString().slice(0,10);i[$]=(i[$]||0)+1}let r=Object.values(i),l=0;if(r.length>=4){let S=r.reduce((C,P)=>C+P,0)/r.length,$=Math.sqrt(r.reduce((C,P)=>C+Math.pow(P-S,2),0)/r.length),N=Math.max(...r);l=$>0?(N-S)/$:0}let c=null;if(r.length>=6){let S=r.reduce((C,P)=>C+P,0)/r.length,$=r.map(C=>C-S),N=$.reduce((C,P)=>C+P*P,0);N>0&&(c=$.slice(0,-1).reduce((P,R,O)=>P+R*$[O+1],0)/N)}let p=new Array(7).fill(0);for(let S of s)p[new Date(S).getUTCDay()]++;let u=Qs(p),d=Math.log2(7),m=0;if(a.length>=10){let S=[...a].sort((C,P)=>C-P),$=S[Math.floor(S.length/2)];m=a.filter(C=>Math.abs(C-$)/$<.2).length/a.length}let f=Object.entries(i).sort((S,$)=>S[0].localeCompare($[0])),v=null;if(f.length>=8){let S=Math.floor(f.length/2),$=f.slice(0,S),N=f.slice(S),C=D=>D.reduce((I,[,F])=>I+F,0)/D.length,P=C($),R=C(N),O=P>0&&R>0?Math.max(P,R)/Math.min(P,R):null;O!=null&&O>=3&&(v={transitionDate:N[0][0],beforeRate:P,afterRate:R,ratio:O,direction:R>P?"increase":"decrease"})}let b=0;o!==null&&(b+=Math.max(0,(.6-o)/.6)*60),b+=m*40,b=Math.min(100,Math.round(b));let h=[],g="normal",x=0;if(b>=60?(h.push({sev:"info",label:`Automation Probability: ${b}% (interval CV=${o!=null?o.toFixed(2):"\u2014"}, periodicity=${(m*100).toFixed(0)}%)`,detail:"Transaction timing is consistent with scripted/automated execution. This describes HOW the account operates, not whether it's risky \u2014 automation alone is common and legitimate (market makers, subscription payments, scheduled treasury operations)."}),x+=6):b>=30?h.push({sev:"ok",label:`Automation Probability: ${b}%`,detail:"Some timing regularity, within a range common to both scheduled tools and habitual human usage."}):h.push({sev:"ok",label:`Automation Probability: ${b}%`,detail:"Transaction timing shows natural, human-like variance."}),v&&(x+=4,h.push({sev:"info",label:`Regime Change detected around ${v.transitionDate}`,detail:`Daily transaction rate ${v.direction}d roughly ${v.ratio.toFixed(1)}x (${v.beforeRate.toFixed(1)} \u2192 ${v.afterRate.toFixed(1)} tx/day). A simple split-half comparison, not a formal changepoint test \u2014 treat the transition date as approximate.`})),l>3.5){let S=f.length?f.reduce(($,N)=>N[1]>$[1]?N:$)[0]:null;h.push({sev:"info",label:`Burst Event: peak day z-score ${l.toFixed(1)}${S?` (${S})`:""}`,detail:"One day had extreme transaction volume relative to this account's own baseline. Consistent with a coordinated event, an account-recovery sweep, or simply a busy day \u2014 timing and other signals (Fund Flow, Fee Spikes) provide the context this alone can't."})}c!==null&&c>.6&&(x+=4,h.push({sev:"info",label:`Volume Autocorrelation: HIGH (\u03C1=${c.toFixed(2)})`,detail:"Day-to-day transaction volume is strongly self-correlated \u2014 consistent with a routine that maintains a steady pace, not inherently risky on its own."}));let k=u/d;k<.7&&s.length>30&&h.push({sev:"info",label:`Unusual Relative to Account Baseline: day-of-week activity concentrated (${(k*100).toFixed(0)}% of max entropy)`,detail:"Transactions cluster on specific days of the week relative to this account's own history. Both maximally-flat (every day) and business-hours-only patterns can produce this \u2014 direction matters more than the raw number."}),h.length<=1&&b<30&&h.push({sev:"ok",label:"No temporal anomalies detected",detail:"Transaction timing patterns are consistent with organic human activity."}),x>=10&&(g="elevated");let T=s.length>=2?Math.round((s[s.length-1]-s[0])/864e5):null;return{signals:h,verdict:g,riskPenalty:x,intervalCV:o,autocorrelation:c,burstScore:l,periodicityScore:m,automationProbability:b,regimeChange:v,dowEntropy:u,dowBins:p,dailyVolume:Object.entries(i).slice(-30),activeSpanDays:T,totalTimestamped:s.length}}function Ob(e,t){let s=[];if(e.length<20)return{signals:[{sev:"info",label:`Insufficient data for offer/flow coupling analysis (need \u226520, found ${e.length})`,detail:"Testing for lead-lag correlation requires enough temporal observations."}],verdict:"insufficient",riskPenalty:0,offerCancelCausality:null,inflowOutflowCausality:null};let o=12*3600*1e3,i=I=>I.date?Math.floor((I.date+946684800)*1e3/o):null,r={},l=I=>{r[I]||(r[I]={offerCreate:0,offerCancel:0,inflow:0,outflow:0,nftList:0,nftAccept:0})};for(let{tx:I,meta:F}of e){let B=i(I);if(B===null)continue;l(B);let E=r[B],z=I.TransactionType;z==="OfferCreate"?E.offerCreate++:z==="OfferCancel"&&E.offerCancel++,z==="NFTokenCreateOffer"?E.nftList++:z==="NFTokenAcceptOffer"&&E.nftAccept++;let te=(F==null?void 0:F.delivered_amount)||I.Amount,oe=typeof te=="string"?Number(te)/1e6:0;oe>0&&(I.Destination===t?E.inflow+=oe:I.Account===t&&(E.outflow+=oe))}let c=Object.keys(r).map(Number).sort((I,F)=>I-F);if(c.length<6)return{signals:[{sev:"info",label:"Insufficient temporal windows for coupling analysis",detail:"Need activity spread across multiple time windows."}],verdict:"insufficient",riskPenalty:0,offerCancelCausality:null,inflowOutflowCausality:null};let p=I=>c.map(F=>r[F][I]||0),u=(I,F,B=4)=>{let E=I.length,z=I.reduce((re,G)=>re+G,0)/E,te=F.reduce((re,G)=>re+G,0)/E,oe=I.map(re=>re-z),pe=F.map(re=>re-te),ie=Math.sqrt(oe.reduce((re,G)=>re+G*G,0)/E),ne=Math.sqrt(pe.reduce((re,G)=>re+G*G,0)/E);return!ie||!ne?Array(B+1).fill(0):Array.from({length:B+1},(re,G)=>{let Se=0,H=0;for(let q=0;q+G<E;q++)Se+=oe[q]*pe[q+G],H++;return H>0?Se/(H*ie*ne):0})},d="normal",m=0,f=p("offerCreate"),v=p("offerCancel"),b=u(f,v),h=b.indexOf(Math.max(...b)),g=Math.max(...b),x={ccf:b,maxCorr:g,maxLag:h};g>.55&&h<=2?(m+=18,d="strong-coupling",s.push(Te({module:"Offer Coupling",category:"market-integrity",sev:"warn",confidence:.4,headline:`Offer Creation/Cancellation Coupling: HIGH (\u03C1=${g.toFixed(2)}, lag=${h} window${h===1?"":"s"})`,detail:`Offer creation and cancellation are strongly correlated ${h} window(s) apart (${h*12}h).`,observed:[`Cross-correlation \u03C1=${g.toFixed(2)} at a ${h}-window lag`,"Correlation, not a causality test \u2014 no autoregressive model or significance test was run"],alternativeExplanations:["Active order management/repricing that naturally pairs creates with cancels","A market maker's normal quote-refresh cycle"],classification:"Statistical coupling observed between offer creation and cancellation timing. This is the kind of pattern wash trading can produce, but correlation at a lag is not proof of it \u2014 see Wash Execution and Spoofing for behavior-level evidence."}))):g>.35?(m+=6,s.push(Te({module:"Offer Coupling",category:"market-integrity",sev:"info",confidence:.25,headline:`Offer Creation/Cancellation Coupling: MODERATE (\u03C1=${g.toFixed(2)}, lag=${h})`,detail:"A mild temporal link between creating and cancelling offers."}))):s.push({sev:"ok",label:"Offer Creation/Cancellation Coupling: LOW",detail:"Offer creation and cancellation timing appear independent."});let k=p("inflow"),T=p("outflow"),S=u(k,T),$=S.indexOf(Math.max(...S)),N=Math.max(...S),C={ccf:S,maxCorr:N,maxLag:$};N>.65&&$===0?(m+=12,s.push(Te({module:"Offer Coupling",category:"market-integrity",sev:"warn",confidence:.4,headline:`Inflow/Outflow Contemporaneous Correlation: HIGH (\u03C1=${N.toFixed(2)})`,detail:"Funds entering and leaving the wallet in the same 12h window are strongly correlated.",observed:[`Zero-lag correlation \u03C1=${N.toFixed(2)} \u2014 same-window co-movement, not a lead-lag relationship`,"A lag-0 result cannot show which direction (if either) leads the other"],alternativeExplanations:["Pass-through/consolidation behavior (an intermediary account by design)","Routine deposit-then-forward operational pattern"],classification:"Same-window co-movement between inflow and outflow, not a demonstrated lead-lag pattern. Consistent with pass-through/round-trip activity, but zero lag means the data alone cannot establish which value moved first."}))):N>.55&&$<=1?(m+=8,s.push(Te({module:"Offer Coupling",category:"market-integrity",sev:"info",confidence:.3,headline:`Inflow/Outflow Coupling: MODERATE (\u03C1=${N.toFixed(2)}, lag=${$})`,detail:"Incoming funds are correlated with outgoing funds at a short lag."}))):s.push({sev:"ok",label:"Inflow/Outflow Coupling: LOW",detail:"Inflow and outflow timing are not predictably linked."});let P=p("nftList"),R=p("nftAccept"),O=P.reduce((I,F)=>I+F,0),D=R.reduce((I,F)=>I+F,0);if(O>3&&D>3){let I=u(P,R),F=Math.max(...I),B=I.indexOf(F);F>.6&&B<=1&&(m+=8,s.push(Te({module:"Offer Coupling",category:"market-integrity",sev:"warn",confidence:.3,headline:`NFT Listing/Acceptance Coupling: HIGH (\u03C1=${F.toFixed(2)}, lag=${B})`,detail:"NFT sell-offer creation is closely correlated with acceptance timing.",alternativeExplanations:["A pre-arranged legitimate sale between known parties"],classification:"Timing coupling only \u2014 combined with the NFT trap detection module's own evidence, this can support (but does not by itself prove) a coordinated-acceptance pattern."})))}return s.some(I=>I.sev==="warn"||I.sev==="critical")||s.length||s.push({sev:"ok",label:"No coupling anomalies detected",detail:"Temporal relationships between transaction types show no notable lead-lag or contemporaneous correlation."}),m>=18?d="strong-coupling":m>=8&&(d="elevated"),{signals:s,verdict:d,riskPenalty:m,offerCancelCausality:x,inflowOutflowCausality:C,windowCount:c.length}}function Bb(e){if(!e)return"";try{let t="";for(let n=0;n<e.length;n+=2){let s=parseInt(e.slice(n,n+2),16);s>=32&&s<127&&(t+=String.fromCharCode(s))}return t.length>4?t.toLowerCase().trim():""}catch{return""}}function Xb(e){let t=Array.from({length:e},(a,o)=>o),n=a=>t[a]===a?a:t[a]=n(t[a]);return{find:n,union:(a,o)=>{let i=n(a),r=n(o);i!==r&&(t[i]=r)}}}function Hb(e){let t=e.length,{find:n,union:s}=Xb(t);for(let o=0;o<t;o++)for(let i=o+1;i<t;i++){let r=e[o],l=e[i];if(r.memos.size&&[...r.memos].some(d=>l.memos.has(d))){s(o,i);continue}let p=0;for(let d of r.timestamps)for(let m of l.timestamps)Math.abs(d-m)<=30&&p++;let u=Math.min(r.timestamps.length,l.timestamps.length);p>=3&&p>=u*.5&&s(o,i)}let a=new Map;for(let o=0;o<t;o++){let i=n(o);a.has(i)||a.set(i,[]),a.get(i).push(e[o])}return[...a.values()]}function zb(e){let t=e.reduce((l,c)=>l+c,0);if(t<=0||!e.length)return null;let n=e.map(l=>l/t).sort((l,c)=>c-l),s=n.reduce((l,c)=>l+c*c,0)*1e4,a=[...e].sort((l,c)=>l-c),o=a.length,i=0;a.forEach((l,c)=>{i+=(c+1)*l});let r=o>1&&t>0?Math.max(0,2*i/(o*t)-(o+1)/o):0;return{hhi:s,gini:r,top1Share:n[0]||0,top5Share:n.slice(0,5).reduce((l,c)=>l+c,0),effectiveParticipants:s>0?1e4/s:o}}var fu=200;function Wb(e,t){let n=new Map;for(let{tx:o}of e){let i=[o.TakerGets,o.Amount],r=(o.Memos||[]).map(l=>{var c;return Bb(((c=l.Memo)==null?void 0:c.MemoData)||"")}).filter(Boolean);for(let l of i){if(!l||typeof l!="object")continue;let c=l.currency,p=Number(l.value||0),u=o.Account;if(!c||!u||p<=0||!Number.isFinite(p))continue;n.has(c)||n.set(c,{senderMap:new Map,vol:0,trades:0});let d=n.get(c);d.vol+=p,d.trades++,d.senderMap.has(u)||d.senderMap.set(u,{sender:u,vol:0,memos:new Set,timestamps:[]});let m=d.senderMap.get(u);m.vol+=p,m.timestamps.push(Wn(o));for(let f of r)m.memos.add(f)}}let s=[],a=[];for(let[o,i]of n.entries()){if(i.trades<8)continue;let r=[...i.senderMap.values()],l=r.length,c=l>fu,p=c?r.map(f=>[f]):Hb(r),u=p.map(f=>f.reduce((v,b)=>v+b.vol,0)),d=zb(u);if(!d)continue;let m=l-p.length;a.push({currency:o,rawActorCount:l,estimatedActorClusters:p.length,vol:i.vol,trades:i.trades,...d}),d.hhi>1500&&s.push(Te({module:"Volume Concentration",category:"market-integrity",sev:d.hhi>2500?"critical":"warn",confidence:c?.3:m>0?.45:.3,headline:`${o}: ~${p.length} estimated economic actor(s) (${l} raw addresses), HHI ${Math.round(d.hhi)}`,detail:`${i.trades} trades totalling ${_(i.vol,2)} ${o}.`,observed:[`Raw distinct addresses: ${l}`,c?`Address count exceeded the clustering cap (${fu}) for this pass \u2014 shown as raw addresses, not clustered`:m>0?`${m} address(es) merged into fewer likely-same-controller clusters via shared memo text or synchronized timing`:"No clustering signal found \u2014 each address treated as a separate actor",`HHI: ${Math.round(d.hhi)} (${d.hhi>2500?"highly concentrated":"moderately concentrated"} by standard antitrust bands: <1500 unconcentrated, 1500-2500 moderate, >2500 high)`,`Gini coefficient: ${d.gini.toFixed(2)}`,`Top-1 actor share: ${(d.top1Share*100).toFixed(0)}% \xB7 Top-5: ${(d.top5Share*100).toFixed(0)}%`,`Effective participant count (10000/HHI): ${d.effectiveParticipants.toFixed(1)}`],alternativeExplanations:m>0?["One legitimate market participant operating multiple wallets for ordinary reasons (custody segregation, accounting)"]:["A genuinely thin, low-participation market rather than coordinated activity"],classification:"Clustering here is best-effort \u2014 shared memo text or tightly synchronized timing only. It cannot detect a shared funding source or off-chain relationships between addresses, so the true number of distinct economic actors may be lower than shown, not higher."}))}return a.length?s.length||s.push({sev:"ok",label:"Volume concentration normal",detail:`${a.length} token(s) analysed \u2014 all show broad, unconcentrated participation (HHI < 1500).`}):s.push({sev:"info",label:"No IOU/token volume data",detail:"No token-denominated transactions found in history (XRP-only activity)."}),{signals:s,concentrations:a}}function Ub(e,t,n,s){let a=[],o=!!(n&Re.lsfDefaultRipple)||t.some(h=>h.account===e.Account),i=t.filter(h=>Number(h.balance)<0),r=i.reduce((h,g)=>h+Math.abs(Number(g.balance)),0);i.length>0&&a.push({sev:"info",label:`Token issuer: ${i.length} outstanding currency lines`,detail:`Total outstanding: ${_(r,2)} across ${i.length} holder(s).`});let l=t.filter(h=>h.freeze),c=t.filter(h=>h.freeze_peer);l.length&&a.push({sev:"warn",label:`${l.length} trustline(s) frozen by this account`,detail:"This account has frozen specific trustlines."}),c.length&&a.push({sev:"critical",label:`${c.length} of your trustline(s) frozen by issuer`,detail:`Frozen currencies: ${c.map(h=>h.currency).join(", ")}. You cannot transfer these tokens.`}),n&Re.lsfGlobalFreeze&&a.push({sev:"critical",label:"Global Freeze \u2014 all token transfers suspended",detail:"No holders can transfer tokens issued by this account."}),n&Re.lsfNoFreeze&&a.push({sev:"ok",label:"NoFreeze flag set \u2014 issuer cannot freeze balances",detail:"Token holders are protected against future freeze actions."});let p={requireAuth:2,noFreeze:6,globalFreeze:7,defaultRipple:8,depositAuth:9},u=s.filter(({tx:h})=>h.TransactionType==="AccountSet"&&h.Account===e.Account&&(h.SetFlag!=null||h.ClearFlag!=null)).map(({tx:h})=>({date:h.date,hash:h.hash,setFlag:h.SetFlag??null,clearFlag:h.ClearFlag??null})).sort((h,g)=>(h.date??0)-(g.date??0)),d=h=>u.filter(g=>g.setFlag===h||g.clearFlag===h).length,m=d(p.globalFreeze),f=d(p.requireAuth);if(m>0){let h=u.filter(g=>g.setFlag===p.globalFreeze||g.clearFlag===p.globalFreeze).slice(-1)[0];a.push(Te({module:"Token Issuer",category:"issuer",sev:m>1?"warn":"info",confidence:.5,headline:`Global Freeze toggled ${m} time(s) in fetched history`,detail:`Most recent change: ${h.setFlag!=null?"frozen":"unfrozen"}.`,observed:[`${m} AccountSet transaction(s) setting or clearing Global Freeze`],alternativeExplanations:["A brief, disclosed freeze for a migration, exploit response, or contract upgrade"],classification:m>1?"Repeated freeze/unfreeze cycles show the issuer actively exercises this control, not just holds it theoretically \u2014 worth understanding why, from the project's own communications.":"A single freeze event in this account's history \u2014 check whether it was disclosed and time-bound."}))}f>0&&a.push({sev:"info",label:`Require Auth toggled ${f} time(s) in fetched history`,detail:"The issuer has changed whether new trustlines require its approval at least once."});let v=Number(e.Balance||0)/1e6,b=10+Number(e.OwnerCount||0)*2;return i.length>0&&v<b+1&&a.push({sev:"warn",label:"Issuer balance near reserve \u2014 possible black hole",detail:"Issuer with outstanding tokens has almost no XRP above reserve. Tokens may be stranded."}),a.length===0&&a.push({sev:"ok",label:"No token issuer flags",detail:"This account does not appear to be a token issuer."}),{signals:a,isIssuer:o,obligationCount:i.length,issuerFlagHistory:u}}function jb(e,t,n,s=new Map,a=null){var f,v,b;let o=[],i=[],r=e.filter(h=>h.currency&&Number(h.balance)!==0&&wu(h.currency)),l=t.filter(({tx:h})=>h.TransactionType==="AMMDeposit"),c=t.filter(({tx:h})=>h.TransactionType==="AMMWithdraw"),p=t.filter(({tx:h})=>h.TransactionType==="AMMCreate"),u=t.filter(({tx:h})=>h.TransactionType==="AMMVote"),d=t.filter(({tx:h})=>h.TransactionType==="AMMBid");if(r.forEach(h=>{let g=Number(h.balance),x=Number(h.limit);i.push({currency:h.currency,issuer:h.account,balance:g,limit:x})}),a)for(let h of i){let g=[...l,...c].filter(({tx:S,meta:$})=>{var N,C;return(C=(N=$==null?void 0:$.AffectedNodes)==null?void 0:N.some)==null?void 0:C.call(N,P=>{var R;return((R=P.CreatedNode||P.ModifiedNode||P.DeletedNode)==null?void 0:R.LedgerEntryType)==="RippleState"&&[P.CreatedNode,P.ModifiedNode,P.DeletedNode].some(O=>{var D,I,F,B;return((I=(D=O==null?void 0:O.FinalFields)==null?void 0:D.Balance)==null?void 0:I.currency)===h.currency||((B=(F=O==null?void 0:O.NewFields)==null?void 0:F.Balance)==null?void 0:B.currency)===h.currency})})}),x=0,k=[],T=[];for(let{tx:S,meta:$}of g){let N=Yi(S,$,a),C=N.lpDeltas.find(R=>R.currency===h.currency);if(!C)continue;let P={hash:S.hash,date:S.date,lpTokenDelta:C.delta,xrpDelta:N.xrpDelta,tokenDeltas:N.tokenDeltas};S.TransactionType==="AMMDeposit"?(k.push(P),x+=-N.xrpDelta):(T.push(P),x-=-N.xrpDelta)}(k.length||T.length)&&(h.depositEvents=k,h.withdrawEvents=T,h.costBasisXrp=x>0?x:null)}if(i.length){o.push({sev:"info",label:`${i.length} LP token position(s)`,detail:`Active liquidity provider in ${i.length} AMM pool(s).`});for(let h of i){let g=s.get(h.currency);if(g){if(h.tvl=g.amount?Number(g.amount)/1e6:null,h.tvl2=(f=g.amount2)!=null&&f.value?Number(g.amount2.value):null,h.feeRate=g.trading_fee!=null?g.trading_fee/1e3:null,h.lpSupply=(v=g.lp_token)!=null&&v.value?Number(g.lp_token.value):null,h.lpSupply&&h.balance){let x=Math.abs(h.balance)/h.lpSupply*100;h.ownerPct=x,x>50&&o.push({sev:"warn",label:`Dominant AMM position: ${x.toFixed(0)}% of pool`,detail:`This account controls ${x.toFixed(0)}% of the LP token supply for pool ${W(h.currency)}. Withdrawing all at once would severely impact pool liquidity and anyone currently trading in it.`})}h.tvl!=null&&o.push({sev:"info",label:`Pool TVL: ${_(h.tvl,2)} XRP${h.tvl2?` + ${_(h.tvl2,2)} tokens`:""} \xB7 Fee: ${((b=h.feeRate)==null?void 0:b.toFixed(2))??"?"}%`,detail:`Actual pool context from amm_info. Your LP position represents ${h.ownerPct!=null?h.ownerPct.toFixed(1)+"% of the pool.":"an unknown share of the pool."}`})}}}return p.length&&o.push({sev:"info",label:`Created ${p.length} AMM pool(s)`,detail:"This account bootstrapped one or more liquidity pools."}),(l.length||c.length)&&o.push({sev:"info",label:`${l.length} deposit(s) \xB7 ${c.length} withdrawal(s)`,detail:"LP activity history."}),u.length&&o.push({sev:"info",label:`${u.length} AMM fee vote(s)`,detail:"This account has voted on AMM trading fee parameters."}),d.length&&o.push({sev:"info",label:`${d.length} continuous auction bid(s)`,detail:"Bid for the AMM auction slot (reduced fee trading window)."}),i.filter(h=>Math.abs(h.balance)>1e3).length&&o.push({sev:"warn",label:"Large LP positions \u2014 impermanent loss risk",detail:"Significant liquidity positions carry exposure to price divergence between pool assets."}),o.length===0&&o.push({sev:"ok",label:"No AMM positions",detail:"This account is not a liquidity provider."}),{signals:o,positions:i,deposits:l.length,withdrawals:c.length}}function qb(e){let t=[],s=e.filter(({tx:d})=>d.Fee&&Number(d.Fee)>0);if(s.length<10)return{signals:[],verdict:"insufficient",riskPenalty:0,avgFeeMultiplier:null,spikeCount:0,topFeeHashes:[]};let a=s.map(({tx:d})=>Number(d.Fee)/12),o=a.reduce((d,m)=>d+m,0)/a.length,r=s.filter(({tx:d})=>Number(d.Fee)/12>100).length,l=r/s.length,c=0,p="normal",u=[...s].sort((d,m)=>Number(m.tx.Fee)-Number(d.tx.Fee)).slice(0,5).map(({tx:d})=>({hash:d.hash,mult:(Number(d.Fee)/12).toFixed(0),fee:Number(d.Fee)}));return l>.15&&r>=5?(c=10,p="elevated",t.push({sev:"warn",label:`Fee spike pattern: ${r} txs paid >100x base fee (${(l*100).toFixed(0)}% of history)`,detail:`Average fee multiplier: ${o.toFixed(0)}x. In XRPL, bots often pay elevated fees to guarantee same-ledger execution as a counterparty \u2014 a technique used in coordinated wash trading and sandwich attacks. Organic users rarely pay more than 2\u20135x the base fee. Top hashes: ${u.slice(0,3).map(d=>W(d.hash)).join(", ")}.`,hashes:u.map(d=>d.hash)})):o>20?(c=4,t.push({sev:"info",label:`Elevated average fee (${o.toFixed(0)}x base fee)`,detail:"This wallet consistently pays above-average fees. Could indicate priority execution requirements or automated trading."})):t.push({sev:"ok",label:`Fee levels normal (avg ${o.toFixed(1)}x base fee)`,detail:"Transaction fees are within typical organic ranges."}),{signals:t,verdict:p,riskPenalty:c,avgFeeMultiplier:+o.toFixed(2),spikeCount:r,topFeeHashes:u}}function Vb(e,t){let n=[],s=new Map;for(let{tx:p}of e){if(p.TransactionType!=="Payment"||p.Account!==t)continue;let u=p.Destination,d=p.DestinationTag;u&&(s.has(u)||s.set(u,new Set),d!=null&&s.get(u).add(d))}let a=[...s.entries()].filter(([p])=>{let u=Hn(p);return(u==null?void 0:u.type)==="exchange"}),o=e.filter(({tx:p})=>p.TransactionType==="Payment"&&p.Account===t&&p.Destination).length,i=e.filter(({tx:p})=>p.TransactionType==="Payment"&&p.Account===t&&p.Destination&&p.DestinationTag!=null).length,r=o>0?i/o*100:null,l=0,c=[];for(let[p,u]of s.entries()){let d=Hn(p),m=(d==null?void 0:d.name)||W(p),f=u.size,v=e.filter(({tx:h})=>h.Account===t&&h.Destination===p).length,b=!d&&f>=8&&v>=10;c.push({dest:p,name:m,uniqueTags:f,txCount:v,looksCustodial:b,tags:[...u].slice(0,10)}),f===1&&v>=5&&(d==null?void 0:d.type)==="exchange"?n.push({sev:"info",label:`${m}: ${v} payments all using tag ${[...u][0]}`,detail:`Single destination tag used across all ${v} payments to ${m}. This is the normal pattern for one person funding their own exchange account.`}):f>10&&(d==null?void 0:d.type)==="exchange"?(l=Math.max(l,8),n.push({sev:"warn",label:`${m}: ${f} different destination tags used`,detail:`${v} payments to ${m} used ${f} different tags \u2014 each tag typically identifies a different customer account. Funding many exchange sub-accounts can indicate either a service (legitimate) or coordinated deposit layering where funds are spread across many exchange wallets to avoid detection.`})):f===0&&v>=2&&(d==null?void 0:d.type)==="exchange"?n.push({sev:"warn",label:`${m}: ${v} payments with no destination tag`,detail:"Payments to exchange addresses without a destination tag may not be credited. Most exchanges require a tag to identify which customer account receives the funds."}):b&&n.push(Te({module:"Destination Tags",category:"counterparty",sev:"info",confidence:.4,headline:`${W(p)}: unlabeled destination behaves like a custodial service (${f} distinct tags, ${v} payments)`,detail:"Not in the known-entity registry, but its tag-usage pattern matches an exchange/custodial routing scheme.",observed:[`${f} distinct destination tags across ${v} payments`,"Pattern matches per-customer sub-account routing, whoever operates it"],alternativeExplanations:["An exchange or custodial service not yet in this app's known-entity registry","A payment processor or merchant service using tags as invoice/order references"],classification:"Behavioral inference from tag-usage shape only \u2014 not a confirmed entity identification."}))}return r!=null&&o>=10&&n.push({sev:"ok",label:`Destination Tag usage: ${r.toFixed(0)}% of outbound payments (${i}/${o})`,detail:"Overall tag-usage rate across all outbound payments \u2014 context for the per-destination findings above, not a signal on its own."}),n.length===0&&s.size>0?n.push({sev:"ok",label:"Destination tag patterns normal",detail:"Payment routing tags are consistent with regular outbound payments."}):s.size===0&&n.push({sev:"info",label:"No outbound payments to analyse for destination tags",detail:"No outbound Payment transactions found in history."}),{signals:n,riskPenalty:l,tagProfiles:c}}function Gb(e,t){var c,p;let n=[],s=e.filter(({tx:u})=>u.TransactionType==="Payment"&&u.Account===t&&(Array.isArray(u.Paths)&&u.Paths.length>0||u.SendMax!=null));if(s.length===0)return{signals:[],riskPenalty:0,roundTripCount:0,deepHopCount:0,selfRoutedCount:0,noData:!0};let a=s.length<5?` (small sample: ${s.length} path payments found \u2014 patterns may not be statistically significant)`:"",o=s.filter(({tx:u})=>{let d=typeof u.Amount=="string",m=typeof u.SendMax=="string";return d&&m}),i=s.filter(({tx:u})=>Array.isArray(u.Paths)?u.Paths.some(d=>Array.isArray(d)&&d.length>=3):!1),r=s.filter(({tx:u})=>u.Destination===t),l=0;return o.length>=1&&(l+=12,n.push({sev:"warn",label:`${o.length} XRP\u2192IOU\u2192XRP round-trip path payments`,detail:`Sending XRP and receiving XRP via intermediate token pairs means the payment routes through the DEX and creates trading volume without changing economic position. ${o.length} occurrences suggests this is deliberate. This is the classic cross-currency wash-trading arb pattern on XRPL. Example hash: ${(p=(c=o[0])==null?void 0:c.tx)!=null&&p.hash?W(o[0].tx.hash):"N/A"}.`,hashes:o.slice(0,5).map(({tx:u})=>u.hash).filter(Boolean)})),i.length>=1&&(l+=6,n.push({sev:"info",label:`${i.length} path payments with \u22653 intermediate hops`,detail:"Deep routing chains (3+ hops) can indicate: legitimate arbitrage, liquidity optimization, or deliberate obfuscation of fund origin. Check each transaction for the intermediate issuers in the path."})),r.length>0&&(l+=15,n.push({sev:"critical",label:`${r.length} path payment(s) where sender = destination`,detail:`Money sent to your own address via a multi-hop path creates DEX trading volume with no net change in balance. This is a direct wash-trading technique: the path through the order book generates artificial volume on every intermediate pair. Hashes: ${r.slice(0,3).map(({tx:u})=>W(u.hash||"")).join(", ")}.`,hashes:r.slice(0,5).map(({tx:u})=>u.hash).filter(Boolean)})),n.length===0&&n.push({sev:"ok",label:`${s.length} path payment(s) \u2014 no suspicious routing patterns${a}`,detail:"No circular routing (XRP\u2192IOU\u2192XRP), self-routing, or unusual deep hop chains detected."}),{signals:n,riskPenalty:l,roundTripCount:o.length,deepHopCount:i.length,selfRoutedCount:r.length}}function Kb(e,t){var u;let n=new Map,s=[];for(let{tx:d,meta:m}of e){if(d.TransactionType!=="Payment"||d.Destination!==t)continue;let f=d.Account;if(!f||f===t)continue;let v=0,b=null,h=(m==null?void 0:m.delivered_amount)||d.Amount;typeof h=="string"?v=Number(h)/1e6:h!=null&&h.value&&(b={value:Number(h.value),currency:Xn(h.currency),issuer:h.issuer});let g=Wn(d);s.push({src:f,amtXrp:v,amtToken:b,ts:g,hash:d.hash||"",destTag:d.DestinationTag}),n.has(f)||n.set(f,{addr:f,totalXrp:0,txCount:0,firstSeen:g,lastSeen:g,entity:Hn(f)||null});let x=n.get(f);x.totalXrp+=v,x.txCount++,x.lastSeen=Math.max(x.lastSeen,g),x.firstSeen=Math.min(x.firstSeen,g)}let a=[...n.values()].sort((d,m)=>m.totalXrp-d.totalXrp||m.txCount-d.txCount).slice(0,10),o=a.reduce((d,m)=>d+m.totalXrp,0),i=a.filter(d=>{var m;return((m=d.entity)==null?void 0:m.type)==="exchange"}),r={};for(let d of s){if(d.amtXrp<=0)continue;let m=Math.round(d.amtXrp/10)*10;r[m]=(r[m]||0)+1}let l=Object.entries(r).sort((d,m)=>m[1]-d[1])[0],c=l&&l[1]>=5&&l[1]/s.length>.4,p=[];if(i.length){let d=[...new Set(i.map(m=>m.entity.name))].join(", ");p.push({sev:"info",label:`Funding from ${i.length} known exchange(s): ${d}`,detail:`${_(i.reduce((m,f)=>m+f.totalXrp,0),2)} XRP received from exchange withdrawals \u2014 typical for a personal trading wallet.`})}if(c&&p.push({sev:"warn",label:`Structured inbound pattern: ${l[1]} payments near ~${l[0]} XRP`,detail:`Over 40% of inbound payments cluster around the same amount (~${l[0]} XRP). Structured deposits can indicate layering \u2014 deliberately splitting large amounts into smaller equal transfers to avoid detection.`}),n.size===1&&s.length>=5){let d=a[0];p.push({sev:"info",label:`Single funding source: all ${s.length} inbound payments from one address`,detail:`${((u=d.entity)==null?void 0:u.name)||W(d.addr)} is the sole funding source. This is normal for a personal wallet but notable for a wallet claiming broad community usage.`})}return!p.length&&s.length>0&&p.push({sev:"ok",label:`${s.length} inbound payment(s) from ${n.size} source(s)`,detail:`Total received: ${_(o,2)} XRP. No unusual inbound patterns.`}),s.length===0&&p.push({sev:"info",label:"No inbound payments found in analysed history",detail:"Wallet may be funded via DEX activity or in ledgers outside the analysed range."}),{signals:p,topSources:a,totalIn:o,uniqueSources:n.size,timeline:s.slice(-20).reverse(),exchangeSrcs:i,structuredFlag:!!c}}function Jb(e,t){var c,p;let n=[],s=[],a=[/airdrop/i,/claim.*reward/i,/free.*xrp/i,/verify.*wallet/i,/support.*team/i,/urgent/i,/suspended/i,/confirm.*seed/i,/your.*account.*hold/i,/unlock/i];for(let{tx:u}of e)if((c=u.Memos)!=null&&c.length)for(let d of u.Memos){let m=((p=d.Memo)==null?void 0:p.MemoData)||"";if(!m)continue;let f="";try{f=decodeURIComponent(m.replace(/../g,b=>"%"+b))}catch{f=m}if(!f||f===m)try{let b="";for(let h=0;h<m.length;h+=2){let g=parseInt(m.slice(h,h+2),16);g>=32&&g<127&&(b+=String.fromCharCode(g))}b.length>4&&(f=b)}catch{}let v=u.Account===t?u.Destination:u.Account;s.push({tx:u.hash||"",type:u.TransactionType,sender:u.Account,counterparty:v,date:u.date,text:f.slice(0,200),raw:m})}if(s.length===0)return{signals:[],allMemos:[],scamMemos:[],repeatedMemos:[],fingerprints:[]};let o=s.filter(u=>a.some(d=>d.test(u.text)));o.length&&n.push({sev:"critical",label:`${o.length} memo(s) match known scam patterns`,detail:`Memos containing phrases like "airdrop", "claim reward", "verify wallet", or "urgent" are used in social engineering attacks. These payments were likely sent to trick the recipient into taking action. Examples: ${o.slice(0,2).map(u=>'"'+u.text.slice(0,40)+'"').join(", ")}`});let i=new Map;for(let u of s){let d=u.text.slice(0,50).trim().toLowerCase();d.length<=3||(i.has(d)||i.set(d,[]),i.get(d).push(u))}let r=[...i.entries()].filter(([,u])=>u.length>=3).map(([u,d])=>{let m=[...new Set(d.map(b=>b.type))],f=new Set(d.map(b=>b.counterparty).filter(Boolean)),v=new Set(d.map(b=>b.sender));return{text:u,count:d.length,types:m,counterpartyCount:f.size,senderCount:v.size,crossAccount:v.size>1,occurrences:d}}).sort((u,d)=>d.count-u.count);for(let u of r.slice(0,5)){let d=Math.min(.9,.3+u.count*.05+(u.crossAccount?.15:0));n.push(Te({module:"Memo Analysis",category:"automation",sev:"info",confidence:d,headline:`Automation Fingerprint Detected: "${u.text.slice(0,40)}" \u2014 ${Math.round(d*100)}% confidence`,detail:`Appears ${u.count} time(s) across ${u.counterpartyCount} counterpart(y/ies) and ${u.types.length} transaction type(s).`,observed:[`${u.count} occurrences`,`Transaction types: ${u.types.join(", ")}`,`Distinct counterparties: ${u.counterpartyCount}`,u.crossAccount?`Sent by ${u.senderCount} different accounts, not just this one \u2014 likely shared tooling/infrastructure rather than something unique to this wallet`:"Only sent by this account in the fetched history"],alternativeExplanations:["Standard software/bot signature (exchange withdrawal tooling, a trading bot's build tag, issuer distribution tooling)","A recurring invoice or reference code used for ordinary bookkeeping"],classification:"Repeated identical memo text is a fingerprint of shared tooling or a scripted process, not inherently suspicious on its own \u2014 useful for identifying infrastructure, bots, or coordinated actors, but needs other evidence to say which."}))}let l=[...new Set(s.filter(u=>/\bv?\d+\.\d+(\.\d+)?\b/i.test(u.text)).map(u=>u.text))];return l.length>=2&&n.push({sev:"info",label:`${l.length} distinct version-like memo tag(s) observed`,detail:`Tags: ${l.slice(0,5).join(", ")}. Consistent with an automated tool's memo tag being bumped across software versions over time.`}),n.length||n.push({sev:"ok",label:`${s.length} memo(s) found \u2014 no suspicious patterns`,detail:"Memo content looks normal."}),{signals:n,allMemos:s,scamMemos:o,repeatedMemos:r.slice(0,5).map(u=>[u.text,u.count]),fingerprints:r}}function Yb(e,t,n){let s=e.filter(u=>u.LedgerEntryType==="Escrow");if(!s.length)return{signals:[],escrows:[],hasThirdParty:!1};let a=[],o=Math.floor(Date.now()/1e3),i=946684800,r=s.map(u=>{let d=u.Account||null,m=u.Destination||null,f=Number(u.Amount||0)/1e6,v=u.FinishAfter?u.FinishAfter+i:null,b=u.CancelAfter?u.CancelAfter+i:null,h=d&&d!==n&&m===n,g=d===n&&m===n,x=v?Math.ceil((v-o)/86400):null;return{creator:d,dest:m,amtXrp:f,finishAfter:v,cancelAfter:b,isThirdParty:h,isSelfEscrow:g,daysToFinish:x,conditional:!!u.Condition}}),l=r.filter(u=>u.isThirdParty),c=r.reduce((u,d)=>u+d.amtXrp,0);l.length&&a.push({sev:"warn",label:`${l.length} escrow(s) created by external account(s) \u2014 funds locked to this address`,detail:`${_(l.reduce((u,d)=>u+d.amtXrp,0),2)} XRP in escrows that an outside party controls. The creator sets the conditions. Escrows created by attackers just before a drain attempt have been observed in some compromise patterns \u2014 verify who created these.`});let p=r.filter(u=>u.daysToFinish!=null&&u.daysToFinish>=0&&u.daysToFinish<=7);return p.length&&a.push({sev:"info",label:`${p.length} escrow(s) mature within 7 days`,detail:`${_(p.reduce((u,d)=>u+d.amtXrp,0),2)} XRP will become claimable soon. If these are third-party escrows, the creator can claim funds once the condition is met.`}),a.length||a.push({sev:"ok",label:`${s.length} self-escrow(s) \u2014 ${_(c,2)} XRP locked`,detail:"All escrows appear to be self-controlled time-locks. No third-party escrow risk."}),{signals:a,escrows:r,hasThirdParty:l.length>0,totalLocked:c}}function Qb(e){let t=e.filter(l=>l.LedgerEntryType==="Check");if(!t.length)return{signals:[],checks:[]};let n=[],s=946684800,a=Math.floor(Date.now()/1e3),o=t.map(l=>{let c=typeof l.SendMax=="string"?Number(l.SendMax)/1e6:null,p=typeof l.SendMax=="object"?l.SendMax:null,u=l.Expiration?l.Expiration+s:null,d=(l.ledger_index,null),m=u&&u<a;return{sender:l.Account,dest:l.Destination,amtXrp:c,amtToken:p,expiry:u,expired:m,id:l.index||""}}),i=o.filter(l=>l.amtXrp&&l.amtXrp>100),r=o.filter(l=>l.expired);return i.length&&n.push({sev:"info",label:`${i.length} large uncashed check(s) \u2014 ${_(i.reduce((l,c)=>l+(c.amtXrp||0),0),2)} XRP pending`,detail:"Open checks can be cashed by the recipient at any time before expiry. Large uncashed checks represent a future outflow commitment."}),r.length&&n.push({sev:"info",label:`${r.length} expired check(s) \u2014 should be cancelled to reclaim reserve`,detail:"Expired checks still occupy owner reserve slots (2 XRP each). Cancelling them returns the reserved XRP."}),n.length||n.push({sev:"ok",label:`${t.length} check(s) found \u2014 no unusual patterns`,detail:"Check amounts are within normal range."}),{signals:n,checks:o}}function Zb(e,t){var m,f,v;if(!e||!((m=e.offers)!=null&&m.length))return{signals:[],hasData:!1};let{pair:n,offers:s}=e,a=[],o=new Map;for(let b of s){let h=b.Account,g=typeof b.TakerGets=="string"?Number(b.TakerGets)/1e6:Number(((f=b.TakerGets)==null?void 0:f.value)||0);o.set(h,(o.get(h)||0)+g)}let i=[...o.values()].reduce((b,h)=>b+h,0),r=o.get(t)||0,l=i>0?r/i:0,p=[...s].sort((b,h)=>{var k,T;let g=typeof b.TakerGets=="string"?Number(b.TakerGets)/1e6:Number(((k=b.TakerGets)==null?void 0:k.value)||0);return(typeof h.TakerGets=="string"?Number(h.TakerGets)/1e6:Number(((T=h.TakerGets)==null?void 0:T.value)||0))-g})[0],u=typeof(p==null?void 0:p.TakerGets)=="string"?Number(p.TakerGets)/1e6:Number(((v=p==null?void 0:p.TakerGets)==null?void 0:v.value)||0),d=i>0?u/i:0;return d>.4&&(p==null?void 0:p.Account)===t?a.push({sev:"critical",label:`Active wall order: this wallet controls ${(d*100).toFixed(0)}% of current book depth`,detail:`A single order from this address represents ${(d*100).toFixed(0)}% of the visible order book depth on pair ${n}. Large orders placed to make a market look deeper than it is \u2014 without intent to fill \u2014 is spoofing. This order is live right now.`}):d>.4&&a.push({sev:"warn",label:`Wall order present: ${(d*100).toFixed(0)}% of book depth in one order`,detail:`A single address controls ${(d*100).toFixed(0)}% of the current order book for pair ${n}. Wall orders dominate book depth and can be removed instantly \u2014 they create false liquidity signals.`}),l>.25&&a.push({sev:"info",label:`This wallet controls ${(l*100).toFixed(0)}% of current order book depth`,detail:`${_(r,2)} of ${_(i,2)} total book volume on pair ${n}.`}),a.length||a.push({sev:"ok",label:`Live order book looks normal (${s.length} orders, pair: ${n.split("\u2194").map(b=>b.split("+")[0]).join("\u2194")})`,detail:"No wall orders or unusual depth concentration detected in the current order book."}),{signals:a,hasData:!0,pair:n,offerCount:s.length,ourShare:l,wallShare:d}}function ey(e,t,n,s,a,o,i,r,l,c,p,u,d,m){var v,b;return[{label:"Security",pts:Math.round((100-t.score)*.4),max:40,color:"#ff5555",icon:"\u{1F510}"},{label:"Drain Risk",pts:{low:0,medium:10,high:25,critical:35}[n.riskLevel]||0,max:35,color:"#ff5555",icon:"\u26A0\uFE0F"},{label:"Wash Trading",pts:Math.min(15,Math.round((a.score||0)*.15)),max:15,color:"#ffb86c",icon:"\u{1F4CA}"},{label:"NFT Risk",pts:Math.min(15,s.flags.filter(h=>h.sev==="critical").length*8+s.flags.filter(h=>h.sev==="warn").length*3),max:15,color:"#bd93f9",icon:"\u{1F3A8}"},{label:"Benford's",pts:Math.round(Lu(o)),max:10,color:"#f1fa8c",icon:"\u{1F4D0}"},{label:"Forensic Suite",pts:Math.min(20,Math.min(8,Math.round(((r==null?void 0:r.riskPenalty)||0)*.35))+Math.min(8,Math.round(((l==null?void 0:l.riskPenalty)||0)*.4))+Math.min(8,Math.round(((c==null?void 0:c.riskPenalty)||0)*.35))+Math.min(8,Math.round(((p==null?void 0:p.riskPenalty)||0)*.35))),max:20,color:"#00d4ff",icon:"\u{1F9EC}"},{label:"Vol Conc",pts:Math.min(10,(((v=i==null?void 0:i.signals)==null?void 0:v.filter(h=>h.sev==="critical").length)||0)*6+(((b=i==null?void 0:i.signals)==null?void 0:b.filter(h=>h.sev==="warn").length)||0)*3),max:10,color:"#ffb86c",icon:"\u{1FAE7}"},{label:"Fee Spikes",pts:Math.min(5,(u==null?void 0:u.riskPenalty)||0),max:5,color:"#ffb86c",icon:"\u{1F4B8}"}].filter(h=>h.pts>0)}var qi=["security","market-integrity","counterparty","issuer","liquidity","automation"],ty={security:"Security Risk","market-integrity":"Market Integrity Risk",counterparty:"Counterparty Risk",issuer:"Issuer Risk",liquidity:"Liquidity Risk",automation:"Automation Probability"},ny={Security:"security","Drain Risk":"security",NFT:"security","Wash Trading":"market-integrity","Benford's Law":"market-integrity","Offer/Flow Coupling":"market-integrity","Volume Concentration":"market-integrity","Shannon's Entropy":"market-integrity","Zipf's Law":"market-integrity","Time Series":"market-integrity","Live Order Book":"market-integrity","Token Issuer":"issuer","Issuer Connections":"issuer",AMM:"liquidity","Fund Flow":"counterparty","Destination Tags":"counterparty","Path Payments":"counterparty","Inbound Flow":"counterparty","Escrow Depth":"counterparty","Fee Spikes":"automation","Memo Analysis":"automation"},sy={critical:40,warn:15,info:3,ok:0};function ay(e){let t={};for(let n of qi)t[n]={score:0,findings:[]};for(let n of e){if(n.sev==="ok"||!n.sev)continue;let s=n.category||ny[n.module]||"security";if(!t[s])continue;let a=n.confidence??.5;t[s].score+=(sy[n.sev]??0)*a,t[s].findings.push(n)}for(let n of qi)t[n].score=Math.round(Math.min(100,t[n].score));return t}function oy(e,t,n,s,a,o,i,r,l,c,p=null){let u=0;u+=Math.round((100-e.score)*.4),u+={low:0,medium:10,high:25,critical:35}[t.riskLevel]||0;let m=n.flags.filter(v=>v.sev==="critical").length,f=n.flags.filter(v=>v.sev==="warn").length;if(u+=Math.min(15,m*8+f*3),u+=Math.min(15,Math.round(s.score*.15)),u+=Lu(a),o!=null&&o.signals){let v=o.signals.filter(h=>h.sev==="critical").length,b=o.signals.filter(h=>h.sev==="warn").length;u+=Math.min(10,v*6+b*3)}return i!=null&&i.riskPenalty&&(u+=Math.min(8,Math.round(i.riskPenalty*.35))),r!=null&&r.riskPenalty&&(u+=Math.min(8,Math.round(r.riskPenalty*.4))),l!=null&&l.riskPenalty&&(u+=Math.min(8,Math.round(l.riskPenalty*.35))),c!=null&&c.riskPenalty&&(u+=Math.min(8,Math.round(c.riskPenalty*.35))),p!=null&&p.riskPenalty&&(u+=Math.min(5,p.riskPenalty)),Math.round(Math.min(100,u))}function iy(e){var b;let t=document.getElementById("inspect-benfords-body");if(!t)return;let n={critical:"sev-critical",warn:"sev-warn",info:"sev-info",ok:"sev-ok"},s=e.signals.map(h=>`
    ...
    <div class="benford-grid">
      ...
      ${e.digitBreakdown.map(h=>{let g=parseFloat(h.obs),x=parseFloat(h.exp),k=g-x,T=Math.abs(k)>5?"#ff5555":Math.abs(k)>2.5?"#ffb86c":"#50fa7b",S=`<div style="height:6px;border-radius:3px;background:rgba(255,255,255,.08);overflow:hidden">
          <div style="height:100%;width:${Math.min(100,g*3.3).toFixed(0)}%;background:${T};border-radius:3px"></div>
  ...
  `;t.innerHTML=s+o+a+v}function ry(e){var o;let t=document.getElementById("inspect-volconc-body");if(!t)return;let n={critical:"sev-critical",warn:"sev-warn",info:"sev-info",ok:"sev-ok"},s=e.signals.map(i=>`
    ...
    </div>`).join("");s.innerHTML=o+(n||"")}function ly(e){let t=[["Sample size",e.sampleSize],["Amount entropy",e.amountEntropy!=null?e.amountEntropy.toFixed(2)+" bits":"\u2014",e.amountEntropy!=null&&e.amountEntropy<2?"risk-text-high":""],["Counterparty entropy",e.counterpartyEntropy!=null?e.counterpartyEntropy.toFixed(2)+" bits":"\u2014"],["Time-of-day entropy",e.timeEntropy!=null?e.timeEntropy.toFixed(2)+" bits":"\u2014"],["Unique counterparties",e.uniqueCounterparties],["Verdict",e.verdict,e.verdict==="anomalous"?"risk-text-high":e.verdict==="elevated"?"risk-text-med":""]];to("inspect-entropy-body",e,'<div class="wash-stat-row" style="margin-top:10px"><span>Metric</span><span class="mono" style="opacity:.45">Value</span></div>'+t.map(([n,s,a])=>`<div class="wash-stat-row"><span>${n}</span><span class="mono ${a||""}">${s}</span></div>`).join(""))}function cy(e){var s;let t=[["Unique counterparties",e.uniqueCounterparties],["Zipf exponent (s)",e.zipfExponent!=null?e.zipfExponent.toFixed(3):"\u2014",e.zipfExponent!=null&&(e.zipfExponent<.4||e.zipfExponent>2.2)?"risk-text-high":""],["Fit quality (R\xB2)",e.rSquared!=null?e.rSquared.toFixed(3):"\u2014",e.rSquared!=null&&e.rSquared<.55?"risk-text-high":""],["Natural range","s \u2248 0.8\u20131.3, R\xB2 > 0.55"],["Verdict",e.verdict,e.verdict==="anomalous"?"risk-text-high":e.verdict==="elevated"?"risk-text-med":""]],n=((s=e.freqTable)==null?void 0:s.slice(0,10).map((a,o)=>{let i=e.freqTable[0]||1,r=(a/i*100).toFixed(0),l=e.freqTable[0]?(e.freqTable[0]/Math.pow(o+1,e.zipfExponent||1)).toFixed(1):0;return`<div class="wash-stat-row">
    ...
    </div>`},a=[["Time windows",e.windowCount||"\u2014"],["OfferCreate\u2194Cancel \u03C1",t?t.maxCorr.toFixed(3):"\u2014",t&&t.maxCorr>.55?"risk-text-high":""],["OC lag",t?`${t.maxLag} window${t.maxLag===1?"":"s"} (${t.maxLag*12}h)`:"\u2014"],["Inflow\u2194Outflow \u03C1",n?n.maxCorr.toFixed(3):"\u2014",n&&n.maxCorr>.65?"risk-text-high":""],["IO lag",n?`${n.maxLag} window${n.maxLag===1?"":"s"}`:"\u2014"],["Verdict",e.verdict,e.verdict==="strong-coupling"?"risk-text-high":e.verdict==="elevated"?"risk-text-med":""]];to("inspect-granger-body",e,a.map(([o,i,r])=>`<div class="wash-stat-row" style="margin-top:${o==="Time windows"?10:0}px"><span>${o}</span><span class="mono ${r||""}">${i}</span></div>`).join("")+s(t==null?void 0:t.ccf,"OFFER-CREATE \u2194 CANCEL CROSS-CORRELATION")+s(n==null?void 0:n.ccf,"INFLOW \u2194 OUTFLOW CROSS-CORRELATION"))}function uy(e,t,n,s,a){let o=document.getElementById("inspect-forensic-suite-body");if(!o)return;let i=(g,x=25)=>{if(!g||g.verdict==="insufficient")return null;if(g.chiSq!=null)return g.verdict==="high-deviation"?{val:x,cls:"risk-text-high",label:"HIGH DEVIATION"}:g.verdict==="moderate-deviation"?{val:Math.round(x*.5),cls:"risk-text-med",label:"MODERATE"}:{val:0,cls:"",label:"NORMAL"};let k=g.riskPenalty||0;return k>=18?{val:x,cls:"risk-text-high",label:"ANOMALOUS"}:k>=8?{val:Math.round(x*.5),cls:"risk-text-med",label:"ELEVATED"}:{val:0,cls:"",label:"NORMAL"}},r=[{name:"Benford's Law",icon:"\u{1F4D0}",desc:"First-digit digit distribution vs log-uniform expected",s:i(e)},{name:"Shannon's Entropy",icon:"\u{1F500}",desc:"Randomness of amounts, counterparties, time-of-day, tx types",s:i(t)},{name:"Zipf's Law",icon:"\u{1F4C8}",desc:"Counterparty rank-frequency power-law fit",s:i(n)},{name:"Time Series",icon:"\u{1F550}",desc:"Interval regularity, periodicity, burst detection, autocorrelation",s:i(s)},{name:"Offer/Flow Coupling",icon:"\u{1F517}",desc:"Cross-correlation, not causality: offer create\u2194cancel, inflow\u2194outflow",s:i(a)}],l=r.some(g=>g.s&&g.s.val>0),c=r.filter(g=>{var x;return((x=g.s)==null?void 0:x.cls)==="risk-text-high"}).length,p=r.filter(g=>{var x;return((x=g.s)==null?void 0:x.cls)==="risk-text-med"}).length,u=r.filter(g=>!g.s).length,d,m,f;c>=3?(d="STRONG MANIPULATION SIGNALS \u2014 Multiple independent engines converging on anomalous patterns.",m="#ff5555",f="\u{1F6A8}"):c>=2||c>=1&&p>=2?(d="SIGNIFICANT ANOMALIES \u2014 At least two engines detect non-organic behavior. Cross-reference with Wash Trading and Drain Risk.",m="#ff5555",f="\u26A0\uFE0F"):c>=1||p>=2?(d="ELEVATED RISK \u2014 One or more engines flag behavioral anomalies. Investigate the specific modules for detail.",m="#ffb86c",f="\u26A0\uFE0F"):!l&&u<3?(d="NO ANOMALIES \u2014 All five engines return results consistent with organic financial activity.",m="#50fa7b",f="\u2705"):(d="INSUFFICIENT DATA \u2014 More transaction history needed for a reliable multi-engine assessment.",m="rgba(255,255,255,.4)",f="\u{1F4CA}");let v=r.map(g=>{let x=!g.s,k=x?"rgba(255,255,255,.25)":g.s.val===0?"#50fa7b":g.s.cls==="risk-text-high"?"#ff5555":"#ffb86c",T=x?"NO DATA":g.s.label,S=x?0:g.s.val===0?4:g.s.cls==="risk-text-high"?100:55;return`<div style="background:rgba(255,255,255,.025);border:1px solid rgba(255,255,255,.07);border-radius:12px;padding:14px 14px 12px">
    ...
    ${h}`}function my(e,t,n,s,a,o,i,r=null,l=null,c=!1){let p=w("inspect-addr-badge");p&&(p.textContent=e.length>20?e.slice(0,10)+"\u2026"+e.slice(-8):e,p.title=e,p.dataset.fullAddr=e);let u=w("inspect-risk-score");u&&(u.textContent=i,u.className="irb-score-val "+Vi(i));let d=w("inspect-risk-label");d&&(d.textContent=i<20?"Low Risk":i<45?"Moderate":i<70?"High Risk":"Critical",d.className="irb-score-label "+Vi(i));let m=w("inspect-acct-grid");if(!m)return;let f=Math.max(0,n-s),v=Number(t.Flags||0),b=r!=null?r===0?"Created today":r===1?"1 day old":r<30?`${r} days old`:r<365?`${Math.floor(r/30)} months old`:`${(r/365).toFixed(1)} years old`:"\u2014",h=l?new Date(l).toLocaleDateString("en-US",{year:"numeric",month:"short",day:"numeric"}):null,g=h?c?`Created ${h}`:`Created ${h} (estimated \u2014 full history not confirmed)`:null,x=yn(n),k=yn(f),T=[{label:"XRP Balance",value:`${_(n,6)} XRP${x}`,mono:!0},{label:"Spendable",value:`${_(f,6)} XRP${k}`,mono:!0,note:`${s} XRP reserved`},{label:"Wallet Age",value:b,note:g,highlight:r!=null&&r<7?"new":null},{label:"Owner Count",value:a,note:`${a*2} XRP tied up`},{label:"Sequence",value:o,mono:!0},{label:"Regular Key",value:t.RegularKey?W(t.RegularKey):"None",warn:!!t.RegularKey,mono:!0},{label:"Master Key",value:v&Re.lsfDisableMaster?"Disabled":"Active",warn:!!(v&Re.lsfDisableMaster)}];m.innerHTML=T.map(S=>`
  ...
  `,no("badge-security",e.findings)}function hy(e,t,n,s){let a=w("inspect-drain-body");if(!a)return;let o={low:"#50fa7b",medium:"#ffb86c",high:"#ff8c42",critical:"#ff5555",none:"#50fa7b"},i={low:"\u2713",medium:"\u26A0",high:"\u26A0",critical:"\u26D4",none:"\u2713"},r=e.compromiseRiskLevel??e.riskLevel,l=e.assetDrainSeverity??"none";a.innerHTML=`
  ...
  `,Wy("badge-drain",e.riskLevel)}function gy(e,t){let n=w("inspect-nft-body");n&&(n.innerHTML=`
    <div class="audit-items">
      ${e.flags.map(s=>zn(s)).join("")}
    </div>
    ${t.length?`
    <div class="nft-grid">
      ${t.slice(0,12).map(s=>vy(s)).join("")}
    </div>
    ${t.length>12?`<div class="nft-more">+${t.length-12} more NFTs</div>`:""}
    `:""}
  `,no("badge-nft",e.flags))}function vy(e){let t=Number(e.Flags||0),n=!!(t&pu.lsfTransferable),s=!!(t&pu.lsfBurnable),a=e.NFTokenTaxon||0,o=e.TransferFee?`${(e.TransferFee/1e3).toFixed(1)}%`:"0%";return`
    <div class="nft-card">
    ...
    </div>`}function by(e){let t=w("inspect-wash-body");if(!t)return;let n=e.verdict==="clean"||e.verdict==="low-risk"?"#50fa7b":e.verdict==="suspicious"?"#ffb86c":"#ff5555";t.innerHTML=`
  ...
  `;let s=w("badge-wash");if(s){let a=e.verdict==="clean"||e.verdict==="low-risk"?"ok":e.verdict==="suspicious"?"warn":"crit";s.textContent=e.verdict.replace("-"," "),s.className="section-badge section-badge--"+a}}function Js(e,t){return`<div class="wash-stat"><span class="wash-stat-label">${y(e)}</span><span class="wash-stat-val">${t}</span></div>`}function yy(e,t){let n=w("inspect-issuer-body");if(!n)return;let s=t.filter(a=>a.currency&&(a.currency.length===3||a.currency.length===40));n.innerHTML=`
    <div class="audit-items">
      ${e.signals.map(a=>zn(a)).join("")}
    </div>
    ${s.length?`
  ...
  `,no("badge-issuer",e.signals)}function wy(e,t){let n=w("inspect-amm-body");n&&(n.innerHTML=`
    <div class="audit-items">
  ...
  `,no("badge-amm",e.signals))}function xy(e){let t=w("trust-count-badge");t&&(t.textContent=e.length);let n=w("inspect-trust-body");n&&(n.innerHTML=e.length?e.map(s=>{let a=s.freeze?'<span class="trustline-frozen">Frozen</span>':"",o=s.freeze_peer?'<span class="trustline-frozen trustline-frozen--peer">Issuer Frozen</span>':"",i=s.no_ripple?'<span class="trustline-norip">NoRipple</span>':"";return`
          <div class="trustline-row">
          ...
          </div>`}).join(""):'<div class="inspect-empty-note">No transactions found.</div>',e.length>s&&(n.innerHTML+=`<div class="tx-more">Showing ${s} of ${e.length} transactions</div>`)}function Au(e,t,n){let s=Number((n==null?void 0:n.totalIn)||0),a=Number((t==null?void 0:t.totalOut)||0),o=Number(e||0);if(s<=0&&a<=0)return'<div class="inspect-empty-note">No inbound or outbound XRP flow found in the analysed transaction history.</div>';let i=new Set(((t==null?void 0:t.blackHoleDests)||[]).map(k=>k.addr)),r=new Set(((t==null?void 0:t.exchangeDests)||[]).map(k=>k.addr)),l=new Set(((t==null?void 0:t.newWalletDests)||[]).map(k=>k.addr)),c=0,p=0,u=0,d=0;for(let k of(t==null?void 0:t.destinations)||[])i.has(k.addr)?c+=k.totalXrp:r.has(k.addr)?p+=k.totalXrp:l.has(k.addr)?u+=k.totalXrp:d+=k.totalXrp;let m=Math.max(s,a,o,1),f=k=>(k>0?Math.max(1.5,k/m*100):0).toFixed(1),v=[{label:"Black hole",xrp:c,color:bn.blackhole},{label:"Exchange",xrp:p,color:bn.exchange},{label:"New wallet",xrp:u,color:bn.newWallet},{label:"Other",xrp:d,color:bn.other}].filter(k=>k.xrp>0),b=a>0?Math.max(1.5,a/m*100):0,h=v.map(k=>`<div style="width:${(a>0?k.xrp/a*100:0).toFixed(1)}%;background:${k.color};height:100%" title="${y(k.label)}: ${_(k.xrp,2)} XRP"></div>`).join(""),g=(k,T,S,$,N)=>`
    ...
    </div>`,x=v.map(k=>`<span style="font-size:.66rem;color:${k.color};margin-right:12px">\u25CF ${y(k.label)} ${_(k.xrp,0)}</span>`).join("");return`
          ...
          <div class="flow-dest-row">
            ...
            <div class="flow-dest-info">
              ...
              <div class="flow-dest-meta">
                ...
                ${c.txCount>1?`<span class="flow-dest-span">${Eu(c.firstSeen,c.lastSeen)}</span>`:""}
              </div>
            </div>
          </div>`}).join("")}
    </div>
  ...
  `,a){let c=e.blackHoleDests.length||e.exchangeDests.length>2;a.textContent=`${e.uniqueDests} dests`,a.className=`section-badge section-badge--${c?"crit":e.uniqueDests>0?"warn":"ok"}`}}function Eu(e,t){if(!e||!t)return"";let n=new Date(e*1e3).toLocaleDateString(),s=new Date(t*1e3).toLocaleDateString();return n===s?n:`${n} \u2013 ${s}`}function Sy(e,t){let n=w("inspect-issuer-connections-body");if(!n)return;let s=e.totalIssued,a=w("badge-issuer-connections");if(n.innerHTML=`
    <div class="audit-items">
  ...
  `,a){let o=e.signals.some(i=>i.sev==="critical")?"crit":e.signals.some(i=>i.sev==="warn")?"warn":e.signals.some(i=>i.sev==="info")?"neutral":"ok";a.className=`section-badge section-badge--${o}`,a.textContent=s>0?`${e.holderCount} holders`:"No issuance"}}function Ty(e){var p;let t=document.getElementById("inspect-fee-analysis-body");if(!t||!e)return;let n={critical:"sev-critical",warn:"sev-warn",info:"sev-info",ok:"sev-ok"},s=(e.signals||[]).map(u=>`
    ...
    </div>`;t.innerHTML=l+s+a+o;let c=document.getElementById("badge-fee-analysis");c&&(c.textContent=r?"Elevated":"Normal",c.className=`section-badge section-badge--${r?"warn":"ok"}`)}function Cy(e){var p,u;let t=document.getElementById("inspect-desttag-body");if(!t||!e)return;let n={critical:"sev-critical",warn:"sev-warn",info:"sev-info",ok:"sev-ok"},s=(e.signals||[]).map(d=>`
    ...
    ${e.selfRoutedCount?`<div class="wash-stat-row"><span>Self-routed payments</span><span class="mono risk-text-high">${e.selfRoutedCount}</span></div>`:""}`;if(n.innerHTML=o+i,s){let l=e.signals.some(p=>p.sev==="critical"),c=e.signals.some(p=>p.sev==="warn");s.textContent=l?"Critical":c?"Check":"Normal",s.className=`section-badge section-badge--${l?"crit":c?"warn":"ok"}`}}function My(e){var r,l,c;let t=w("inspect-inbound-body");if(!t)return;let n={critical:"sev-critical",warn:"sev-warn",info:"sev-info",ok:"sev-ok"},s=(e.signals||[]).map(p=>`
    ...
    ${e.wallShare>.3?`<div class="wash-stat-row"><span>Largest single order share</span><span class="mono ${e.wallShare>.4?"risk-text-high":"risk-text-med"}">${(e.wallShare*100).toFixed(1)}%</span></div>`:""}`;n.innerHTML=a+o;let i=w("badge-livebook");if(i){let r=(e.signals||[]).some(c=>c.sev==="critical"),l=(e.signals||[]).some(c=>c.sev==="warn");i.textContent=r?"Wall order":l?"Check":"Normal",i.className=`section-badge section-badge--${r?"crit":l?"warn":"ok"}`}}function Ry(e,...t){let n=w("inspect-risk-breakdown");if(!n)return;let s=ey(e,...t);if(!s.length){n.innerHTML="";return}let a=Math.max(1,s.reduce((o,i)=>o+i.pts,0));n.innerHTML=`
    ...
    <div class="report-wrap">
      ...
      <div class="report-section">
        ...
        <div style="margin-bottom:16px">${p0(f,e)}</div>
        ${Au(n,d,N)}
      </div>
  ...
  `}function Oy(e,...t){e.innerHTML=Fy(...t)}function By(){let e=document.getElementById("tab-inspector");e&&(e.querySelector("[data-inspector-v2]")||(e.innerHTML=`
    <style>
  ...
  `;let t=document.getElementById("tab-inspector");t&&t.appendChild(e)}function Hy(){if(document.getElementById("inspector-howto"))return;let e=document.createElement("div");e.id="inspector-howto",e.className="howto-overlay",e.style.display="none",e.innerHTML=`
  ...
  `).join(""))}function Yy(){let e=document.getElementById("isd-cap-grid");e&&(e.innerHTML=Gy.map(t=>`
  ...
  `).join(""))}function Zi(){let e=document.getElementById("isd-wallets-section"),t=document.getElementById("isd-wallet-list");if(!e||!t)return;let n=ve(Q(qy))||[];if(!n.length){e.style.display="none";return}e.style.display="",t.innerHTML=n.map(s=>{let a=s.color||"#50fa7b",o=s.emoji||"\u{1F48E}",i=s.label||"Wallet",r=s.address||"",l=r?r.slice(0,8)+"\u2026"+r.slice(-6):"\u2014",c=s.testnet?'<span class="isd-wallet-testnet">TESTNET</span>':"";return`
    ...
    `}).join("")}function er(){let e=document.getElementById("isd-recent-section"),t=document.getElementById("isd-recent-list");if(!e||!t)return;let n=so();if(!n.length){e.style.display="none";return}e.style.display="",t.innerHTML=n.map((s,a)=>{let o=s.addr?s.addr.slice(0,10)+"\u2026"+s.addr.slice(-8):"\u2014",i=s.riskScore!=null?`<span class="isd-risk-pill isd-risk-pill--${Du(s.riskScore)}">${s.riskScore}</span>`:"";return`
    ...
    `}).join("")}function Qy(){eo(),window.addEventListener("xrpl-ledger",Zy),window.addEventListener("xrpl-connection",eo)}function Zy(e){Za()&&eo(e.detail)}var Wi=null;function e0(){return Wi||(Wi={idx:document.getElementById("isd-ledger-idx"),age:document.getElementById("isd-ledger-age"),tps:document.getElementById("isd-tps"),tpsTrnd:document.getElementById("isd-tps-trend"),fee:document.getElementById("isd-fee"),feeLv:document.getElementById("isd-fee-level"),close:document.getElementById("isd-close-time"),dot:document.getElementById("isd-conn-dot"),connLbl:document.getElementById("isd-conn-label"),pill:document.getElementById("isd-conn-pill"),domTx:document.getElementById("isd-dom-tx"),domPct:document.getElementById("isd-dom-pct"),bar:document.getElementById("isd-fee-bar"),barLbl:document.getElementById("isd-fee-bar-label")})}function eo(){let{idx:e,age:t,tps:n,tpsTrnd:s,fee:a,feeLv:o,close:i,dot:r,connLbl:l,pill:c,domTx:p,domPct:u,bar:d,barLbl:m}=e0(),f=X.connectionState||"disconnected",v={connected:{label:"Connected",cls:"conn--live"},connecting:{label:"Connecting\u2026",cls:"conn--warn"},disconnected:{label:"Disconnected",cls:"conn--dead"}},b=v[f]||v.disconnected;r&&(r.className="isd-conn-dot"),l&&(l.textContent=b.label),c&&(c.className=`isd-conn-pill ${b.cls}`);let h=X.ledgerLog||[];if(h.length&&e){let S=h[0];if(e.textContent=Number(S.ledgerIndex||0).toLocaleString(),t&&(t.textContent=S.closeTimeSec!=="\u2014"?S.closeTimeSec+"s close":"\u2014"),i){let $=parseFloat(S.closeTimeSec);i.textContent=isNaN($)?"\u2014":$.toFixed(1)}}let g=X.tpsHistory||[];if(g.length&&n){let S=g.slice(-5),$=S.reduce((N,C)=>N+C,0)/S.length;if(n.textContent=$.toFixed(1),s&&g.length>=6){let N=g.slice(-10,-5),C=N.reduce((R,O)=>R+O,0)/N.length,P=$-C;s.textContent=P>.5?"\u2191 rising":P<-.5?"\u2193 falling":"\u2192 stable",s.className=`isd-metric-sub ${P>.5?"isd-up":P<-.5?"isd-down":""}`}}let x=X.feeHistory||[];if(x.length&&a){let S=x.slice(-5),$=S.reduce((P,R)=>P+R,0)/S.length,N=$/1e6;a.textContent=$<5e3?$.toFixed(0)+" drops":N.toFixed(5)+" XRP";let C=$<20?{lbl:"Low",cls:"fee-low",pct:10}:$<100?{lbl:"Normal",cls:"fee-normal",pct:28}:$<500?{lbl:"Elevated",cls:"fee-elevated",pct:60}:$<2e3?{lbl:"High",cls:"fee-high",pct:82}:{lbl:"Congested",cls:"fee-congest",pct:100};o&&(o.textContent=C.lbl,o.className=`isd-metric-sub ${C.cls}`),d&&(d.style.width=C.pct+"%",d.className=`isd-fee-bar-fill ${C.cls}`),m&&(m.textContent=C.lbl,m.className=`isd-fee-bar-level ${C.cls}`)}let k=X.txMixAccum||{},T=Object.entries(k).filter(([,S])=>S>0).sort(([,S],[,$])=>$-S);if(T.length&&p){let S=T.reduce((C,[,P])=>C+P,0),[$,N]=T[0];p.textContent=$,u&&(u.textContent=(N/S*100).toFixed(0)+"% of traffic")}}window.exportTxCSV=function(e){var l,c;if(!e||!e.length){alert("No transaction data to export. Run an inspection first.");return}let t=946684800,s=[["Hash","Date","Type","Account","Destination","Amount_XRP","Amount_Token","Currency","Fee_Drops","DestinationTag","Result","LedgerIndex"],...e.map(({tx:p,meta:u})=>{var h,g;let d=p.date?new Date((p.date+t)*1e3).toISOString():"",m=typeof p.Amount=="string"?(Number(p.Amount)/1e6).toFixed(6):"",f=(h=p.Amount)!=null&&h.value?p.Amount.value:"",v=((g=p.Amount)==null?void 0:g.currency)||(typeof p.Amount=="string"?"XRP":""),b=(u==null?void 0:u.TransactionResult)||"";return[p.hash||"",d,p.TransactionType||"",p.Account||"",p.Destination||"",m,f,v,p.Fee||"",p.DestinationTag??"",b,p.ledger_index||""]})].map(p=>p.map(u=>{let d=String(u);return d.includes(",")||d.includes('"')||d.includes(`
`)?'"'+d.replace(/"/g,'""')+'"':d}).join(",")).join(`
`),a=new Blob([s],{type:"text/csv;charset=utf-8;"}),o=URL.createObjectURL(a),i=document.createElement("a"),r=((c=(l=document.getElementById("inspect-addr-badge"))==null?void 0:l.dataset)==null?void 0:c.fullAddr)||"wallet";i.href=o,i.download=`naluxrp_${r.slice(0,10)}_${new Date().toISOString().slice(0,10)}.csv`,document.body.appendChild(i),i.click(),document.body.removeChild(i),URL.revokeObjectURL(o)};function t0(e,t){let s=so().find(o=>o.addr===e);if(!s||s.riskScore==null||t==null)return null;let a=t-s.riskScore;return{prev:s.riskScore,curr:t,diff:a,ts:s.ts}}function n0(e,t){let n=t0(e,t);if(!n||Math.abs(n.diff)<2)return;let s=document.getElementById("inspect-risk-score");if(!s)return;let a=n.diff>0?`<span style="color:#ff5555;font-size:.7rem;font-weight:700"> \u2191${n.diff}</span>`:`<span style="color:#50fa7b;font-size:.7rem;font-weight:700"> \u2193${Math.abs(n.diff)}</span>`,o=ao(n.ts);s.insertAdjacentHTML("afterend",`<span class="risk-score-diff" title="Changed from ${n.prev} \u2192 ${n.curr} since ${o}">${a} vs ${o}</span>`)}window._inspectMaxTx||(window._inspectMaxTx=5e3);window._debugBalanceDeltas=xu;window._debugOfferLifecycles=Mu;window._debugReconstructBalanceHistory=ku;window._debugFindDrainEpisodes=$u;window._debugDrainRisk=Pu;window.inspectorLoadAddr=function(e){let t=w("inspect-addr");t&&(t.value=e),ws()};window.inspectWalletAddr=function(e){var n,s;window.inspectorLoadAddr(e);let t=document.querySelector('[data-tab="inspector"]');t&&((n=window.switchTab)==null||n.call(window,t,"inspector")),(s=window.showDashboard)==null||s.call(window)};window.printInspectorReport=function(){var s,a;let e=document.getElementById("inspect-report-body");if(!e)return;let t=((a=(s=document.getElementById("inspect-addr-badge"))==null?void 0:s.dataset)==null?void 0:a.fullAddr)||"wallet",n=window.open("","_blank","width=900,height=700");n.document.write(`<!DOCTYPE html><html><head>
    ...
    ${e.innerHTML}
  </body></html>`),n.document.close()};window.exportInspectorReport=function(){var n;let e=document.getElementById("inspect-report-body");if(!e)return;let t=e.innerText||e.textContent||"";(n=navigator.clipboard)==null||n.writeText(t).then(()=>{let s=document.getElementById("report-export-btn");s&&(s.textContent="\u2713 Copied!",setTimeout(()=>{s.textContent="\u{1F4CB} Copy Report"},2e3))}).catch(()=>{let s=document.createRange();s.selectNodeContents(e);let a=window.getSelection();a.removeAllRanges(),a.addRange(s)})};window.inspectorClearHistory=function(){vt(Qi);let e=document.getElementById("isd-recent-section");e&&(e.style.display="none")};window.inspectorClearWatchlist=function(){vt(Zs),ta()};function so(){return ve(Q(Qi))||[]}function s0(e,t,n=[]){let s=so();s=s.filter(o=>o.addr!==e);let a=n.filter(o=>o.sev==="critical"||o.sev==="warn").map(o=>o.module+":"+o.headline.slice(0,40)).sort().join("|");s.unshift({addr:e,riskScore:t,ts:Date.now(),fingerprint:a}),s=s.slice(0,12),Z(Qi,JSON.stringify(s))}function ea(){return ve(Q(Zs))||[]}function a0(e,t){let n=ea().filter(s=>s.addr!==e);n.unshift({addr:e,label:t||W(e),addedTs:Date.now(),lastScore:null,lastTs:null}),Z(Zs,JSON.stringify(n.slice(0,50)))}function _u(e){Z(Zs,JSON.stringify(ea().filter(t=>t.addr!==e)))}function Ki(e){return ea().some(t=>t.addr===e)}function o0(e,t){let n=ea().map(s=>s.addr===e?{...s,lastScore:t,lastTs:Date.now()}:s);Z(Zs,JSON.stringify(n))}function ao(e){let t=Date.now()-e;return t<6e4?"just now":t<36e5?Math.floor(t/6e4)+"m ago":t<864e5?Math.floor(t/36e5)+"h ago":Math.floor(t/864e5)+"d ago"}function Du(e){return Vi(e).replace("risk-","")}var Zt=!1;function Iu(){Zt=localStorage.getItem(Ru)==="true",tr()}function tr(){let e=document.getElementById("inspect-result");if(!e)return;e.classList.toggle("mode-advanced",Zt),e.classList.toggle("mode-simple",!Zt);let t=document.getElementById("analyst-mode-btn");t&&(t.textContent=Zt?"\u2697 Advanced":"\u{1F441} Simple",t.title=Zt?"Switch to Simple view":"Switch to Advanced (analyst) view",t.setAttribute("aria-pressed",String(Zt)))}window.toggleAnalystMode=function(){Zt=!Zt,localStorage.setItem(Ru,Zt),tr()};var i0=new Set(["section-overview","section-report"]),r0=new Set(["section-security","section-drain","section-fundflow","section-inbound"]);function l0(){let e=document.getElementById("inspect-result");if(!e)return;let t=[...e.querySelectorAll(".inspector-section")],n={crit:0,warn:1,neutral:2,ok:3,"":4},s=t.filter(i=>!i0.has(i.id)&&!r0.has(i.id));s.sort((i,r)=>{let l=c=>{let p=c.querySelector(".section-badge");if(!p)return"";let u=p.className;return u.includes("crit")?"crit":u.includes("warn")?"warn":u.includes("neutral")?"neutral":u.includes("ok")?"ok":""};return(n[l(i)]??4)-(n[l(r)]??4)});let a=document.getElementById("section-inbound")||document.getElementById("section-drain");if(!a)return;let o=a;for(let i of s)o.after(i),o=i}function c0(e,t,n,s,a={}){let o=document.getElementById("quick-verdict-body");if(!o)return;let i=t.filter(g=>g.sev==="critical"),r=t.filter(g=>g.sev==="warn"),l=e<20?"#50fa7b":e<45?"#ffb86c":e<70?"#ff8c42":"#ff5555",c=e<20?"Low Risk":e<45?"Moderate":e<70?"High Risk":"Critical",p=(g,x)=>(x.confidence??.5)-(g.confidence??.5),u=[...i].sort(p),d=[...r].sort(p),m="",f="";if(i.length===0&&r.length===0)m=`No elevated signals found across ${s.toLocaleString()} transactions${n!=null?` and ${n} days of history`:""}.`,f="This wallet appears to operate within normal parameters.";else{let g=u.slice(0,2).map(k=>k.headline).join("; "),x=d.slice(0,2).map(k=>k.headline).join("; ");m=i.length?`${i.length} critical issue${i.length>1?"s":""}: ${g}.`:`${r.length} warning${r.length>1?"s":""}: ${x}.`,f=i.length?"Review the highlighted sections below. Scroll to the Report for full recommendations.":"Review the flagged sections below for context before drawing conclusions."}let v=qi.map(g=>({cat:g,...a[g]})).filter(g=>g.score>0).sort((g,x)=>x.score-g.score),b=g=>g<20?"#50fa7b":g<45?"#ffb86c":g<70?"#ff8c42":"#ff5555",h=v.length?`
      ...
      <div style="display:flex;flex-direction:column;gap:4px">
        ${v.map(g=>`
          <div style="display:flex;align-items:center;gap:8px;font-size:.76rem">
            <span style="width:150px;color:rgba(255,255,255,.6);flex-shrink:0">${y(ty[g.cat])}</span>
            <div style="flex:1;height:5px;border-radius:3px;background:rgba(255,255,255,.06);overflow:hidden">
              <div style="width:${g.score}%;height:100%;background:${b(g.score)};border-radius:3px"></div>
            </div>
            <span class="mono" style="color:${b(g.score)};width:28px;text-align:right;flex-shrink:0">${g.score}</span>
          </div>`).join("")}
      </div>
    </div>`:"";o.innerHTML=`
    <div style="display:flex;align-items:flex-start;gap:16px;flex-wrap:wrap">
      <div style="text-align:center;flex-shrink:0">
        <div style="font-size:2.2rem;font-weight:900;color:${l};line-height:1">${e}</div>
        <div style="font-size:.65rem;font-weight:800;color:${l};letter-spacing:.1em;text-transform:uppercase">${c}</div>
      </div>
      <div style="flex:1;min-width:200px">
        <div style="font-size:.92rem;color:rgba(255,255,255,.88);line-height:1.6;margin-bottom:6px">${y(m)}</div>
        <div style="font-size:.8rem;color:rgba(255,255,255,.45);line-height:1.5">${y(f)}</div>
        ${i.length||r.length?`
        <div style="display:flex;gap:8px;margin-top:8px;flex-wrap:wrap">
          ${i.length?`<span style="background:rgba(255,85,85,.12);border:1px solid rgba(255,85,85,.3);color:#ff5555;border-radius:999px;padding:2px 10px;font-size:.72rem;font-weight:700">${i.length} Critical</span>`:""}
          ${r.length?`<span style="background:rgba(255,184,108,.10);border:1px solid rgba(255,184,108,.25);color:#ffb86c;border-radius:999px;padding:2px 10px;font-size:.72rem;font-weight:700">${r.length} Warnings</span>`:""}
    ...
    </div>`}function ta(){let e=document.getElementById("isd-watchlist-section"),t=document.getElementById("isd-watchlist-list");if(!e||!t)return;let n=ea();if(!n.length){e.style.display="none";return}e.style.display="",t.innerHTML=n.map(s=>{let a=s.addr.slice(0,8)+"\u2026"+s.addr.slice(-6),o=s.lastScore!=null?`<span class="isd-risk-pill isd-risk-pill--${Du(s.lastScore)}">${s.lastScore}</span>`:"",i=s.lastTs?ao(s.lastTs):"never checked";return`
    ...
    <div style="overflow-x:auto;padding-bottom:4px">
      <svg width="${d}" height="${u}" xmlns="http://www.w3.org/2000/svg" style="display:block;min-width:${d}px">
        ${r.map(([,f],v)=>{var k;let b=Math.max(2,Math.round(f.count/l*u)),h=u-b,g=((k=Object.entries(f.types).sort((T,S)=>S[1]-T[1])[0])==null?void 0:k[0])||"Other",x=a[g]||o;return`<rect x="${v*(c+p)}" y="${h}" width="${c}" height="${b}"
    ...
    </div>`}function Ou(e,t){let n=new Map;for(let{tx:s,meta:a}of e){let o=s.Account===t,i=s.Destination===t;if(!o&&!i)continue;let r=o?s.Destination:s.Account;if(!r||r===t)continue;let l=Wn(s);n.has(r)||n.set(r,{cnt:0,xrpOut:0,xrpIn:0,entity:Hn(r),firstSeen:l,lastSeen:l});let c=n.get(r);c.cnt++,l&&(c.firstSeen=c.firstSeen?Math.min(c.firstSeen,l):l,c.lastSeen=Math.max(c.lastSeen,l));let p=(a==null?void 0:a.delivered_amount)||s.Amount,u=typeof p=="string"?Number(p)/1e6:0;o?c.xrpOut+=u:c.xrpIn+=u}return n}function p0(e,t,n=15){let s=Ou(e,t),a=[...s.entries()].sort((r,l)=>l[1].xrpOut+l[1].xrpIn-(r[1].xrpOut+r[1].xrpIn)||l[1].cnt-r[1].cnt).slice(0,n);if(!a.length)return'<div class="inspect-empty-note">No counterparty interactions found.</div>';let o=Math.max(...a.map(([,r])=>r.xrpOut+r.xrpIn),1),i=a.map(([r,l],c)=>{var h;let p=l.xrpOut+l.xrpIn,u=Math.max(1.5,p/o*100),d=bn[(h=l.entity)==null?void 0:h.type]||bn.other,m=p>0?l.xrpOut/p:.5,f=m>.65?"\u2192 out":m<.35?"\u2190 in":"\u21C4 both",v=l.entity?`<span style="font-size:.64rem;color:${d};border:1px solid ${d};border-radius:999px;padding:1px 7px;margin-left:6px">${y(l.entity.name)}</span>`:"",b=Eu(l.firstSeen,l.lastSeen);return`
    ...
    ${i}`}function u0(e,t,n,s,a="inspect-network-map"){let o=document.getElementById(a);if(!o)return;let r=[...Ou(e,t).entries()].sort(($,N)=>N[1].xrpOut+N[1].xrpIn-($[1].xrpOut+$[1].xrpIn)||N[1].cnt-$[1].cnt).slice(0,20);if(r.length<2){o.style.display="",o.innerHTML=`<div class="inspect-empty-note">${r.length===0?"No counterparty interactions found.":"Only one counterparty found \u2014 not enough to chart a network map."}</div>`;return}o.style.display="";let l=560,c=340,p=l/2,u=c/2,d=95,m=7,f=155,v=13,b=r[0][1].xrpOut+r[0][1].xrpIn||1,h=r[0][1].cnt||1,g=[{id:t,x:p,y:u,r:13,main:!0,label:W(t),color:"#00d4ff",xrpOut:0,xrpIn:0,cnt:0}];r.forEach(([$,N],C)=>{let P=C<m?d:f,R=C<m?m:v,D=(C<m?C:C-m)/R*2*Math.PI-Math.PI/2,I=N.xrpOut+N.xrpIn,F=Math.max(5,Math.min(14,4+I/b*10)),B=N.entity,E=bn[B==null?void 0:B.type]||bn.other,z=I>0?N.xrpOut/I:.5,te=z>.65?"out":z<.35?"in":"both";g.push({id:$,x:p+P*Math.cos(D),y:u+P*Math.sin(D),r:F,color:E,label:(B==null?void 0:B.name)||W($),ent:B,xrpOut:N.xrpOut,xrpIn:N.xrpIn,cnt:N.cnt,dir:te,vol:I,ring:P})});let x=`<defs>
    ...
    </div>`}function m0(){let e=window._lastInspectResult,t=window._lastAllFindings||[];if(!e)return null;let n=t.length?t.map(a=>`- [${a.sev.toUpperCase()}] ${a.module}: ${a.headline}${a.detail?" \u2014 "+a.detail:""}`).join(`
...
You are acting as a security analyst explaining automated blockchain forensics findings to someone who isn't a blockchain expert. Write a clear, plain-English explanation of what this account's activity suggests. Synthesize the findings above into a coherent read of the account rather than restating them one by one \u2014 call out which ones reinforce each other and which are weak signals on their own. Be direct about how concerning (or not) this looks, and be skeptical of your own confidence where the evidence is thin rather than overstating it. Do not repeat the address or risk score back verbatim; the reader can already see those above your response.`}window.copyInspectorAnalysisForAi=function(){let e=document.getElementById("ai-explanation-body"),t=m0();if(!t){e&&(e.innerHTML='<p style="font-size:.82rem;color:#ff5555">Run an inspection first.</p>');return}Hs(t)};window.exportInspectorJSON=function(){var o,i;let e=window._lastInspectResult;if(!e){alert("Run an inspection first.");return}let t=new Blob([JSON.stringify(e,null,2)],{type:"application/json"}),n=URL.createObjectURL(t),s=document.createElement("a"),a=((i=(o=document.getElementById("inspect-addr-badge"))==null?void 0:o.dataset)==null?void 0:i.fullAddr)||"wallet";s.href=n,s.download=`naluxrp_${a.slice(0,10)}_${new Date().toISOString().slice(0,10)}.json`,document.body.appendChild(s),s.click(),document.body.removeChild(s),URL.revokeObjectURL(n)};var f0=6e4,h0=1e4,g0=12e4,v0=8e3,b0=12e4,y0=300,Ju="nalulf_net_baseline_v2",w0=80,x0=5,aa="/api/v1/validatorregistry",Yu="/api/v1/validator";var k0=5*60*1e3,Qu=10*60*1e3,Bu=1e4,Zu=8e3,or=new Map,ir=new Map;var tn={quorumTight:{w:3,label:"Quorum within 3 validators of failure threshold"},nUnlActive:{w:2,label:"Negative UNL active \u2014 validators currently being ignored"},amendVeto:{w:1,label:"Amendment veto clustering \u2014 protocol governance dispute"},feeSpike:{w:2,label:"Open ledger fee 10\xD7 minimum \u2014 DDoS / spam attack likely"},burnAnomaly:{w:2,label:"XRP burn rate z-score > 3\u03C3 \u2014 resource exhaustion pattern"},peerSaturate:{w:2,label:"Inbound peers > 80% of connections \u2014 Eclipse Attack risk"},eclipseRisk:{w:3,label:"Peer count < 6 \u2014 node highly vulnerable to isolation"},dexSpike:{w:1,label:"DEX volume > 3\xD7 AMM baseline \u2014 unusual event-driven flow"},reserveSpike:{w:1,label:"New account rate > 3\xD7 baseline \u2014 possible bot creation"},slowConverge:{w:2,label:"Consensus convergence > 6s \u2014 network agreement degraded"},lowProposers:{w:2,label:"Proposer count below quorum \u2014 validator participation low"},queuePressure:{w:2,label:"TX queue > 80% full \u2014 fee surge imminent"},spamLedger:{w:1,label:"Ledger > 2\xD7 expected size \u2014 ledger spam in progress"},ioStressed:{w:1,label:"Node IO latency > 5ms \u2014 storage or network I/O stress"},peerChurn:{w:1,label:"Elevated peer disconnect rate \u2014 DDoS or instability"},staleLedger:{w:3,label:"Ledger age > 10s \u2014 validation appears stalled"}},em={MultiSign:{purpose:"Multi-signature authorization",intro:"rippled 0.31",desc:"Lets multiple keys jointly authorize one transaction. Essential for institutional custody and hardware-wallet setups.",impact:"New transaction: SignerListSet. All signers submit their signature; the last one broadcasts."},MultiSignReserve:{purpose:"Cheaper signer-list reserve",intro:"rippled 1.2",desc:"Cuts the owner reserve for SignerList objects from 5 owner-items (10 XRP) down to 1 owner-item (2 XRP).",impact:"Existing SignerLists do not gain the reduction automatically; delete and re-create the list."},DepositAuth:{purpose:"Block unsolicited incoming payments",intro:"rippled 0.90",desc:"An account can set lsfDepositAuth so it only receives payments explicitly pre-authorized via DepositPreauth.",impact:"Senders to un-authorized accounts receive tecNO_PERMISSION."},DeletableAccounts:{purpose:"Permanent account deletion + reserve reclaim",intro:"rippled 1.4",desc:"An account with no objects and sequence \u2265 (current ledger \u2212 256) can permanently delete itself and recover the base reserve.",impact:"New transaction: AccountDelete. Sends all XRP minus fees to a destination."},NegativeUNL:{purpose:"Fault-tolerant consensus during outages",intro:"rippled 1.6",desc:"When validators are persistently offline, the network may add them to the Negative UNL so they do not count against quorum.",impact:"Enables the network to survive planned outages of up to 20% of trusted validators."},Checks:{purpose:"Deferred, cancellable payments",intro:"rippled 1.0",desc:"The sender creates a Check; the recipient can later cash it up to the authorized amount or let it expire. The sender can cancel at any time.",impact:"New transactions: CheckCreate, CheckCash, CheckCancel. Each open Check uses one owner-reserve slot."},AMM:{purpose:"Native Automated Market Maker DEX",intro:"rippled 1.12",desc:"Adds a Constant-Product (x*y=k) AMM directly in the ledger. Anyone can deposit two assets to earn LP tokens and a share of swap fees.",impact:"New transactions: AMMCreate, AMMDeposit, AMMWithdraw, AMMVote, AMMBid, AMMDelete."},XChainBridge:{purpose:"Cross-chain bridge protocol",intro:"rippled 2.0",desc:"Lets assets move between XRPL Mainnet, sidechains, and EVM chains via a locking/minting bridge secured by Witness servers.",impact:"New ledger objects: Bridge, XChainOwnedCreateAccountClaimID, etc. Requires Witness infrastructure."},Clawback:{purpose:"Token-issuer recovery",intro:"rippled 1.12",desc:"Issuers who set lsfAllowTrustLineClawback before issuing tokens can claw back tokens from any holder.",impact:"Must be enabled on a fresh account before any trust lines are created."},NonFungibleTokensV1:{purpose:"Native NFT support",intro:"rippled 1.9",desc:"Adds NFTokenMint, NFTokenBurn, and offer-based transfer mechanics for non-fungible tokens stored in NFTokenPage objects.",impact:"Each NFTokenPage holds up to 32 tokens and costs one owner-reserve slot. Royalties up to 50%."},NonFungibleTokensV1_1:{purpose:"NFT V1 corrections",intro:"rippled 1.10",desc:"Fixes pagination bugs, transfer-fee edge cases, and minting with the URI field that were present in V1.",impact:"Breaking fix for some V1 edge cases. Wallets built for V1 should test V1_1 compatibility."},PayChan:{purpose:"Payment channels for streaming micropayments",intro:"rippled 0.33",desc:"Sender deposits XRP into a channel, then issues signed claims off-ledger. Recipient submits the highest claim at any time to settle on-ledger.",impact:"New transactions: PaymentChannelCreate, PaymentChannelFund, PaymentChannelClaim."},Escrow:{purpose:"Time-locked and condition-based XRP transfers",intro:"rippled 0.60",desc:"Lock XRP until a future time OR a cryptographic fulfillment (PREIMAGE-SHA-256) is revealed, enabling vesting schedules and atomic swaps.",impact:"New transactions: EscrowCreate, EscrowFinish, EscrowCancel. Locked XRP counts against reserves."},DisallowIncoming:{purpose:"Block unsolicited ledger-object creation",intro:"rippled 1.10",desc:"New account flags let you individually block incoming Trust Lines, Check objects, NFToken offers, and Payment Channels.",impact:"Four new AccountSet flags; existing incoming objects are unaffected."},ExpandedSignerList:{purpose:"Larger multi-sig signer lists",intro:"rippled 1.9.1",desc:"Increases the maximum signers per SignerList from 8 to 32, enabling more complex institutional multi-sig and DAO governance.",impact:"Reserve cost scales with signer count. Requires MultiSignReserve to be cost-effective."},OwnerPaysFee:{purpose:"Correct fee payer in PayChan",intro:"rippled 0.33",desc:"Fixes a spec inconsistency where the channel owner correctly pays the transaction fee when closing or expiring channels.",impact:"Purely a fee-accounting fix; no user-visible behavior changes."},fixMasterKeyAsRegularKey:{purpose:"Master-key mis-use bug fix",intro:"rippled 0.90",desc:"Prevents accounts from setting their master key as their regular key \u2014 an operation that could create an unusable account state.",impact:"No application changes needed; existing accounts are not affected."},TrustSetAuth:{purpose:"Authorized trust lines",intro:"rippled 0.30",desc:"Issuers can require explicit authorization before anyone can hold their token \u2014 a prerequisite for regulatory-grade stablecoins.",impact:"New flow: issuer sends TrustSet with tfSetfAuth to approve each holder."}},Xu=new Set(["xrpscan.com","xrpl.aesthetes.art","xrpkuwait.com","xrpgoat.com","xrp.vet","xrp.unic.ac.cy","xrp-validator.interledger.org","xpmarket.com","verum.eminence.im","validator.xrpl.robertswarthout.com","validator.xrpl-labs.com","validator.poli.usp.br","validator.gatehub.net","validator.aspired.nz","v2.xrpl-commons.org","tequ.dev","squidrouter.com","ripple.ittc.ku.edu","ripple.com","peersyst.cloud","onxrp.com","katczynski.net","jon-nilsen.no","ekiserrepe.es","cabbit.tech","bithomp.com","aureusox.com","arrington-xrp-capital.blockdaemon.com","anodos.finance","bitso.com","ripple.kenan-flagler.unc.edu","ripplevalidator.uwaterloo.ca","shadow.haas.berkeley.edu","www.bitrue.com","xrp-col.anu.edu.au"]),$0=new Set(["nHBu3iuq1SQ9Z686pYwWYVKpScSMDWfpUJHdNEQRxn5XyETui7Db","nHDwBbubxJswoweWQKEgWLNRJv2hNRCTR4GGApJmbtCcbtYNSpdB","nHU2FpRbPrvVcyQQpkqrAUDJDTRHZpjij8DpKeSC481PYY9ikYkb","nHUbmg8QNzEGjHzgnt99e9YE2scU3DZGH7FsF6MCcK5eiPt3AtaH","nHUxBD1UPb383SdWgJx62GGQ7W2WKvgpUtUXLjiGGRRcPb3nbSXd","nHUP6rfQfgzg6tKga3k9ziEvtjwn1PB32gcr5dLcamqzmitszYv2","nHBT58yHyDdPdJ6gzaBMT7gqwTMpj5ERji1s9SvfKKtfoZUS89WX","nHBxsUzx3Bbf6J4yJ3fLQ3VizPtdREVwTJ6mdqkuDTjLcVbggVbk","nHUeUNSn3zce2xQZWNghQvd9WRH6FWEnCBKYVJu2vAizMxnXegfJ","nHUCAdca6VoWWYVdBH1bwCUQggEX2e5acQSqxM3DwyuhsFknxmh3","nHDDiwQBqXhEL1CFoRHdMXD33x9K7rpYJfniXxL7kFavpPd21EGe","nHBipbbREjNEiCs4hpy3K2489dRf27MPnxdivTTWKSd8ZUhfRvn8","nHDDe5uAdiv6RA59MA1oM4JLDtVSYKNShgjEqq1KsdJXZiR47CQT","nHBbiP5ua5dUqCTz5i5vd3ia9jg3KJthohDjgKxnc7LxtmnauW7Z","nHBQ3CT3EWYZ4uzbnL3k6TRf9bBPhWRFVcK1F5NjtwCBksMEt5yy","nHU16DF2kq7TmbR1Y5z8yKNXiLEf3oHT19HVpVXv7unFLfxa17nT","nHUC23NnutZyYeQxQbAbPUpKoVGj5aisBxf2zzcZzJ43fcw5rc9z","nHUgdMvuchx7AWG4ATMQdNNuMryo1SFoNptLCEVt2Dn7wEc625mF","nHUhQVE93dajM3srxubsEj1mK1gzRwJob14QSrJefY1FdLs6r7WJ","nHUU8xBczYzW6kZ6Ei9DsggzTJXRFkN3wE3FP5H4SLYzhbodeYcG","nHUGqooyfGqFkyH6uskbaEi6y2MjXjdA7QdbmyZ6p9etL5isRKLT","nHDp1ZXxEn7eo5YaUtiagaxSLwXudnKZDx68C96p4tdVLGLLLUFn","nHBcLEB4S6moQGrhMjJo1jbp58WL5psHY9EMDWNAtdqykUYiA1rF","nHUAECq1v1cKwn3NsYVyD7v6BNbfqyXmNVSF3e4XCVxPgBHRWkvv","nHUif4sukXu9pJGyyBaeVMwmE8L1fJ5KJj4X4ksgTKhgjG6k96s2","nHUVJR7SeT3nn6JPTz46JHqYRf7vX2if1sdTxnceywmSBWa167pt","nHUEYz4TtTv7yebjhY3aDib5KYPHnKjnY5mPYK5y4QuKdocwS5tD","nHUN5n2S3nQ8bzKm7bqeFMiQeDijh1LMgEocyNyQbb4mREazVdZ5","nHUgchANqM3giYSSvY5HsafFW6qxmG5jJ3CvPiv7n8gjNQuNm8Uz","nHDUqGoM7KR1pgbdYBRgKpGKdFLhpnMzVbECs8RE73RGZm3Va6MJ","nHUVxTi8XfXjaaJppw7mLSrYDRpkDpf8H9ypzgVKxfSXShcWwAoK","nHBveTxA1NaBj5AayRAU91f6YopuFWt9rmxfGaEh77a32Q6ZzzHc"]),S0=new Set(["validator.pftperry.com","rip973.com","preaware.org","postfiat.org","pftmeech.xyz","pft.xbtseal.com","pft.wizbubba.xyz","pft.permanentupperclass.com","pft.g.money","pft.akirax.xyz","jollydinger.com","auri0x.io","app.w.ai"]);function tm(e,t){let n=(t||"").toLowerCase().replace(/^www\./,"");return $0.has(e)||S0.has(n)?{chain:"test",isUnl:!1}:Xu.has(n)||Xu.has("www."+n)?{chain:"main",isUnl:!0}:{chain:"main",isUnl:!1}}var fr={"xrpscan.com":{label:"XRP Scan",domain:"xrpscan.com",chain:"main",category:"unl"},"xrpl.aesthetes.art":{label:"Aesthetes",domain:"xrpl.aesthetes.art",chain:"main",category:"unl"},"xrpkuwait.com":{label:"XRP Kuwait",domain:"xrpkuwait.com",chain:"main",category:"unl"},"xrpgoat.com":{label:"XRP Goat",domain:"xrpgoat.com",chain:"main",category:"unl"},"xrp.vet":{label:"XRP Vet",domain:"xrp.vet",chain:"main",category:"unl"},"xrp.unic.ac.cy":{label:"Univ. of Nicosia",domain:"xrp.unic.ac.cy",chain:"main",category:"unl"},"xrp-validator.interledger.org":{label:"Interledger",domain:"xrp-validator.interledger.org",chain:"main",category:"unl"},"xpmarket.com":{label:"XPMarket",domain:"xpmarket.com",chain:"main",category:"unl"},"verum.eminence.im":{label:"Eminence",domain:"verum.eminence.im",chain:"main",category:"unl"},"validator.xrpl.robertswarthout.com":{label:"R. Swarthout",domain:"validator.xrpl.robertswarthout.com",chain:"main",category:"unl"},"validator.xrpl-labs.com":{label:"XRPL Labs",domain:"validator.xrpl-labs.com",chain:"main",category:"unl"},"validator.poli.usp.br":{label:"USP",domain:"validator.poli.usp.br",chain:"main",category:"unl"},"validator.gatehub.net":{label:"Gatehub",domain:"validator.gatehub.net",chain:"main",category:"unl"},"validator.aspired.nz":{label:"Aspired NZ",domain:"validator.aspired.nz",chain:"main",category:"unl"},"v2.xrpl-commons.org":{label:"XRPL Commons",domain:"v2.xrpl-commons.org",chain:"main",category:"unl"},"tequ.dev":{label:"Tequ",domain:"tequ.dev",chain:"main",category:"unl"},"squidrouter.com":{label:"Squid Router",domain:"squidrouter.com",chain:"main",category:"unl"},"ripple.ittc.ku.edu":{label:"Univ. of Kansas",domain:"ripple.ittc.ku.edu",chain:"main",category:"unl"},"ripple.com":{label:"Ripple",domain:"ripple.com",chain:"main",category:"unl"},"peersyst.cloud":{label:"Peersyst",domain:"peersyst.cloud",chain:"main",category:"unl"},"onxrp.com":{label:"OnXRP",domain:"onxrp.com",chain:"main",category:"unl"},"katczynski.net":{label:"Katczynski",domain:"katczynski.net",chain:"main",category:"unl"},"jon-nilsen.no":{label:"Jon Nilsen",domain:"jon-nilsen.no",chain:"main",category:"unl"},"ekiserrepe.es":{label:"Ekiserrepe",domain:"ekiserrepe.es",chain:"main",category:"unl"},"cabbit.tech":{label:"Cabbit",domain:"cabbit.tech",chain:"main",category:"unl"},"bithomp.com":{label:"Bithomp",domain:"bithomp.com",chain:"main",category:"unl"},"aureusox.com":{label:"Aureus Ox",domain:"aureusox.com",chain:"main",category:"unl"},"arrington-xrp-capital.blockdaemon.com":{label:"Arrington / Blockdaemon",domain:"arrington-xrp-capital.blockdaemon.com",chain:"main",category:"unl"},"anodos.finance":{label:"Anodos Finance",domain:"anodos.finance",chain:"main",category:"unl"},"bitso.com":{label:"Bitso",domain:"bitso.com",chain:"main",category:"unl"},"ripple.kenan-flagler.unc.edu":{label:"UNC Kenan-Flagler",domain:"ripple.kenan-flagler.unc.edu",chain:"main",category:"unl"},"ripplevalidator.uwaterloo.ca":{label:"Univ. of Waterloo",domain:"ripplevalidator.uwaterloo.ca",chain:"main",category:"unl"},"shadow.haas.berkeley.edu":{label:"UC Berkeley Haas",domain:"shadow.haas.berkeley.edu",chain:"main",category:"unl"},"www.bitrue.com":{label:"Bitrue",domain:"www.bitrue.com",chain:"main",category:"unl"},"xrp-col.anu.edu.au":{label:"ANU",domain:"xrp-col.anu.edu.au",chain:"main",category:"unl"},"xrpval.rawsec.de":{label:"Rawsec",domain:"xrpval.rawsec.de",chain:"main",category:"other"},"xrplvl.carbonvibe.com":{label:"Carbon Vibe",domain:"xrplvl.carbonvibe.com",chain:"main",category:"other"},"xrplvalidator.alloy.ee":{label:"Alloy",domain:"xrplvalidator.alloy.ee",chain:"main",category:"other"},"xrpl.uni.lu":{label:"Univ. of Luxembourg",domain:"xrpl.uni.lu",chain:"main",category:"other"},"xrpl.to":{label:"XRPL.to",domain:"xrpl.to",chain:"main",category:"other"},"xrpl.su":{label:"XRPL.su",domain:"xrpl.su",chain:"main",category:"other"},"xrpl.sbivc.co.jp":{label:"SBI VC Trade",domain:"xrpl.sbivc.co.jp",chain:"main",category:"other"},"xrpl-verification.flare.network":{label:"Flare Network",domain:"xrpl-verification.flare.network",chain:"main",category:"other"},"xrpl-validator.7rev.dev":{label:"7Rev",domain:"xrpl-validator.7rev.dev",chain:"main",category:"other"},"xrp.teacopula.com":{label:"Teacopula",domain:"xrp.teacopula.com",chain:"main",category:"other"},"xrp.moneymindedapes.com":{label:"MoneyMindedApes",domain:"xrp.moneymindedapes.com",chain:"main",category:"other"},"xrp.hazza-systems.de":{label:"Hazza Systems",domain:"xrp.hazza-systems.de",chain:"main",category:"other"},"xrp.cs.uoregon.edu":{label:"Univ. of Oregon",domain:"xrp.cs.uoregon.edu",chain:"main",category:"other"},"xrp.bpsqn.com":{label:"BPSQN",domain:"xrp.bpsqn.com",chain:"main",category:"other"},"xrp-validator.grapedrop.xyz":{label:"Grapedrop",domain:"xrp-validator.grapedrop.xyz",chain:"main",category:"other"},"xaodao.io":{label:"XaoDAO",domain:"xaodao.io",chain:"main",category:"other"},"vl.xrpsalute.com":{label:"XRP Salute",domain:"vl.xrpsalute.com",chain:"main",category:"other"},"validator.xrpl.app":{label:"XRPL App",domain:"validator.xrpl.app",chain:"main",category:"other"},"validator.ukcbt.org":{label:"UKCBT",domain:"validator.ukcbt.org",chain:"main",category:"other"},"validator.sugarxrpl.com":{label:"SugarXRPL",domain:"validator.sugarxrpl.com",chain:"main",category:"other"},"validator.boscaern.digital":{label:"Boscaern",domain:"validator.boscaern.digital",chain:"main",category:"other"},"trimaera.tech":{label:"Trimaera",domain:"trimaera.tech",chain:"main",category:"other"},"textrp.io":{label:"TextRP",domain:"textrp.io",chain:"main",category:"other"},"tesbert.com":{label:"Tesbert",domain:"tesbert.com",chain:"main",category:"other"},"tachyon-xrpl-validator.github.io":{label:"Tachyon",domain:"tachyon-xrpl-validator.github.io",chain:"main",category:"other"},"solonation.io":{label:"SoloNation",domain:"solonation.io",chain:"main",category:"other"},"smokydrip.com":{label:"SmokyDrip",domain:"smokydrip.com",chain:"main",category:"other"},"rippled-validator.us":{label:"rippled-validator.us",domain:"rippled-validator.us",chain:"main",category:"other"},"rippleat.snt.uni.lu":{label:"Univ. Luxembourg (SNT)",domain:"rippleat.snt.uni.lu",chain:"main",category:"other"},"ripple.uni.lu":{label:"Univ. Luxembourg",domain:"ripple.uni.lu",chain:"main",category:"other"},"ripple.j2b.com":{label:"J2B",domain:"ripple.j2b.com",chain:"main",category:"other"},"rich-list.info":{label:"Rich List",domain:"rich-list.info",chain:"main",category:"other"},"proptoexchange.com":{label:"ProPtoExchange",domain:"proptoexchange.com",chain:"main",category:"other"},"printscierge.com":{label:"Printscierge",domain:"printscierge.com",chain:"main",category:"other"},"opulencex.io":{label:"OpulenceX",domain:"opulencex.io",chain:"main",category:"other"},"onledger.net":{label:"OnLedger",domain:"onledger.net",chain:"main",category:"other"},"oclost.art":{label:"Oclost",domain:"oclost.art",chain:"main",category:"other"},"managednetwork.us":{label:"ManagedNetwork",domain:"managednetwork.us",chain:"main",category:"other"},"joshuahamsa.com":{label:"Joshua Hamsa",domain:"joshuahamsa.com",chain:"main",category:"other"},"grimmsxrpflow.jwscott.net":{label:"Grimm XRP Flow",domain:"grimmsxrpflow.jwscott.net",chain:"main",category:"other"},"getlol.xyz":{label:"GetLol",domain:"getlol.xyz",chain:"main",category:"other"},"gen3labs.xyz":{label:"Gen3 Labs",domain:"gen3labs.xyz",chain:"main",category:"other"},"garveyvalid.com":{label:"Garvey",domain:"garveyvalid.com",chain:"main",category:"other"},"easynpl.kr":{label:"EasyNPL",domain:"easynpl.kr",chain:"main",category:"other"},"diseb.ewi.tudelft.nl":{label:"TU Delft",domain:"diseb.ewi.tudelft.nl",chain:"main",category:"other"},"datamossa.com":{label:"DataMossa",domain:"datamossa.com",chain:"main",category:"other"},"crypto.unibe.ch":{label:"Univ. of Bern",domain:"crypto.unibe.ch",chain:"main",category:"other"},"commonprefix.com":{label:"Common Prefix",domain:"commonprefix.com",chain:"main",category:"other"},"catalyze-research.com":{label:"Catalyze Research",domain:"catalyze-research.com",chain:"main",category:"other"},"catalog.org":{label:"Catalog",domain:"catalog.org",chain:"main",category:"other"},"blockchain.korea.ac.kr":{label:"Korea Univ.",domain:"blockchain.korea.ac.kr",chain:"main",category:"other"},"astatiumprotocol.com":{label:"Astatium Protocol",domain:"astatiumprotocol.com",chain:"main",category:"other"},"ladykxrpl.mywire.org":{label:"LadyK XRPL",domain:"LadyKXRPL.mywire.org",chain:"main",category:"other"},"eelap-p1201-xrp.abudhabi.nyu.edu":{label:"NYU Abu Dhabi",domain:"EELAP-P1201-XRP.ABUDHABI.NYU.EDU",chain:"main",category:"other"},"589.clouds.hspeed.ch":{label:"HSpeed",domain:"589.clouds.hspeed.ch",chain:"main",category:"other"},"validator.pftperry.com":{label:"PFT Perry",domain:"validator.pftperry.com",chain:"test",category:"other"},"rip973.com":{label:"rip973",domain:"rip973.com",chain:"test",category:"other"},"preaware.org":{label:"Preaware",domain:"preaware.org",chain:"test",category:"other"},"postfiat.org":{label:"PostFiat",domain:"postfiat.org",chain:"test",category:"other"},"pftmeech.xyz":{label:"PFT Meech",domain:"pftmeech.xyz",chain:"test",category:"other"},"pft.xbtseal.com":{label:"PFT XBT Seal",domain:"pft.xbtseal.com",chain:"test",category:"other"},"pft.wizbubba.xyz":{label:"PFT Wizbubba",domain:"pft.wizbubba.xyz",chain:"test",category:"other"},"pft.permanentupperclass.com":{label:"PFT Perm Upper Class",domain:"pft.permanentupperclass.com",chain:"test",category:"other"},"pft.g.money":{label:"PFT G.Money",domain:"pft.g.money",chain:"test",category:"other"},"pft.akirax.xyz":{label:"PFT Akirax",domain:"pft.akirax.xyz",chain:"test",category:"other"},"jollydinger.com":{label:"Jollydinger",domain:"jollydinger.com",chain:"test",category:"other"},"auri0x.io":{label:"Auri0x",domain:"auri0x.io",chain:"test",category:"other"},"app.w.ai":{label:"W.ai",domain:"app.w.ai",chain:"test",category:"other"}},po={nHB8QMKGt9VB4Vg71VszjBVQnDW3v3QudM4436zXRZgiuUBBSWJe:{lat:37.77,lng:-122.42,city:"San Francisco",org:"Ripple"},nHUon2tpyJEHHYGmxqNd3h3oGNQwNyX8PNS3aHe3bNpCrNXZlHo:{lat:37.77,lng:-122.41,city:"San Francisco",org:"Ripple"},nHUpwrafS45zmi6eT72XS5ijpkW5JwfL5mLdPhEibrqUvtRcMAjU:{lat:37.78,lng:-122.4,city:"San Francisco",org:"Ripple"},nHUkp7WhouVMobBUKGrV5FNqjsdD9zKP5jpGnnLfQXCMNe4dkDqo:{lat:37.76,lng:-122.43,city:"San Francisco",org:"Ripple"},nHUryiyDqEtyWVtFG24AAhaYjMf9FRLietZGBWYwUTojmugMsx3o:{lat:37.79,lng:-122.38,city:"San Francisco",org:"Ripple"},nHUpcmNsxAw47yt2ADDoNoQrzLyTJPgnyq16u6Qx2kRPA17oUNHz:{lat:37.8,lng:-122.39,city:"San Francisco",org:"Ripple"},nHUnhRJK3csknycNK5SXRFi8jvDp3sKoWvS9wKWLq1ATBBGgPBjp:{lat:37.75,lng:-122.44,city:"San Francisco",org:"Ripple"},nHUq9tJvk5QTDkwurB7EzbzkZ2uuoHjS3GKjP6pZiU3DJGnobNYK:{lat:39.04,lng:-77.49,city:"Ashburn, VA",org:"AWS (Coil)"},nHUvcCcmoH1FJMMC6NtF9KKA4LpCWhjsxk2reCQidsp5AHQ7QY9H:{lat:49.45,lng:11.08,city:"Nuremberg",org:"Hetzner (Gatehub)"},nHDH7bQJpVfDhVSqdui3Z8GPvKEBQpo6AKHcnXe21zoD4nABA6xj:{lat:52.37,lng:4.9,city:"Amsterdam",org:"GCP (XRPL Labs)"},nHUED59jjpQ5QbNtesAbB6Es3uUPv3c9Ri5MNNgfMv5t5Lhb5ndW:{lat:19.43,lng:-99.13,city:"Mexico City",org:"AWS (Bitso)"},nHBidG3pZK11zqjeVos6hFxTDPGYuqfRFZ5gu9b7tQFdB8nPZujG:{lat:35.69,lng:139.69,city:"Tokyo",org:"NTT (Digital Garage)"},nHDB2PAPYqF86j9j3c6w1F1ZqwvQfiWcFShZ9Pokg9q4ohNDSkAz:{lat:47.61,lng:-122.33,city:"Seattle, WA",org:"Azure (Arrington)"},nHUdphn3LXa31w5sLd39MQdPEKQNrNYL3DQFByijVXiNQ3G6BYBZ:{lat:1.35,lng:103.82,city:"Singapore",org:"AWS (Tokenize)"},nHUFCyRCrUjvtZmKiLeF8ReopzKuSkVzdl1VsMCqm75aqyohLYEg:{lat:48.86,lng:2.35,city:"Paris",org:"OVH (XRPL Commons)"},nHULqGBkJtWeNFjhTzYeAsHA3qKKS7HoBh8CV3BAGTGMZuepEhWC:{lat:40.71,lng:-74.01,city:"New York",org:"Equinix (Blockchain LLC)"},nHBdXSF6YHAHSZUk7rvox6jwbvvyqBnsWGcewBtq8x1XuH6KXKXr:{lat:37.79,lng:-122.4,city:"San Francisco",org:"Cloudflare (XRP Scan)"}},Hu={"xrpscan.com":{lat:51.51,lng:-.13,city:"London",org:"XRPScan"},"xrpl.aesthetes.art":{lat:52.37,lng:4.9,city:"Amsterdam",org:"Aesthetes"},"xrpkuwait.com":{lat:29.37,lng:47.98,city:"Kuwait City",org:"XRP Kuwait"},"xrpgoat.com":{lat:39.04,lng:-77.49,city:"Ashburn, VA",org:"XRP Goat"},"xrp.vet":{lat:48.86,lng:2.35,city:"Paris",org:"XRP Vet"},"xrp.unic.ac.cy":{lat:35.17,lng:33.37,city:"Nicosia",org:"Univ. of Nicosia"},"xrp-validator.interledger.org":{lat:40.71,lng:-74.01,city:"New York",org:"Interledger Foundation"},"xpmarket.com":{lat:52.37,lng:4.9,city:"Amsterdam",org:"XPMarket"},"verum.eminence.im":{lat:51.51,lng:-.13,city:"London",org:"Eminence"},"validator.xrpl.robertswarthout.com":{lat:52.37,lng:4.9,city:"Amsterdam",org:"R. Swarthout"},"validator.xrpl-labs.com":{lat:52.37,lng:4.9,city:"Amsterdam",org:"XRPL Labs"},"validator.xrpl.app":{lat:52.37,lng:4.9,city:"Amsterdam",org:"XRPL App"},"validator.poli.usp.br":{lat:-23.55,lng:-46.63,city:"S\xE3o Paulo",org:"USP"},"validator.gatehub.net":{lat:46.05,lng:14.51,city:"Ljubljana",org:"Gatehub"},"validator.aspired.nz":{lat:-36.86,lng:174.76,city:"Auckland",org:"Aspired NZ"},"v2.xrpl-commons.org":{lat:48.86,lng:2.35,city:"Paris",org:"XRPL Commons"},"tequ.dev":{lat:60.17,lng:24.94,city:"Helsinki",org:"Tequ"},"squidrouter.com":{lat:37.77,lng:-122.42,city:"San Francisco",org:"Squid Router"},"ripple.ittc.ku.edu":{lat:38.97,lng:-95.24,city:"Lawrence, KS",org:"Univ. of Kansas"},"ripple.com":{lat:37.77,lng:-122.42,city:"San Francisco",org:"Ripple"},"peersyst.cloud":{lat:41.39,lng:2.15,city:"Barcelona",org:"Peersyst"},"onxrp.com":{lat:51.51,lng:-.13,city:"London",org:"OnXRP"},"katczynski.net":{lat:52.23,lng:21.01,city:"Warsaw",org:"Katczynski"},"jon-nilsen.no":{lat:59.91,lng:10.75,city:"Oslo",org:"Jon Nilsen"},"ekiserrepe.es":{lat:40.42,lng:-3.7,city:"Madrid",org:"Ekiserrepe"},"cabbit.tech":{lat:51.51,lng:-.13,city:"London",org:"Cabbit"},"bithomp.com":{lat:59.33,lng:18.07,city:"Stockholm",org:"Bithomp"},"aureusox.com":{lat:40.71,lng:-74.01,city:"New York",org:"Aureus Ox"},"arrington-xrp-capital.blockdaemon.com":{lat:40.71,lng:-74.01,city:"New York",org:"Blockdaemon"},"anodos.finance":{lat:37.98,lng:23.73,city:"Athens",org:"Anodos Finance"},"bitso.com":{lat:19.43,lng:-99.13,city:"Mexico City",org:"Bitso"},"ripple.kenan-flagler.unc.edu":{lat:35.9,lng:-79.05,city:"Chapel Hill, NC",org:"UNC Kenan-Flagler"},"ripplevalidator.uwaterloo.ca":{lat:43.47,lng:-80.54,city:"Waterloo, ON",org:"Univ. of Waterloo"},"shadow.haas.berkeley.edu":{lat:37.87,lng:-122.26,city:"Berkeley, CA",org:"UC Berkeley Haas"},"www.bitrue.com":{lat:1.35,lng:103.82,city:"Singapore",org:"Bitrue"},"xrp-col.anu.edu.au":{lat:-35.28,lng:149.13,city:"Canberra",org:"ANU"},"xrpval.rawsec.de":{lat:51.17,lng:10.45,city:"Germany",org:"Rawsec"},"xrplvl.carbonvibe.com":{lat:51.51,lng:-.13,city:"London",org:"Carbon Vibe"},"xrplvalidator.alloy.ee":{lat:59.44,lng:24.75,city:"Tallinn",org:"Alloy"},"xrpl.uni.lu":{lat:49.61,lng:6.13,city:"Luxembourg",org:"Univ. of Luxembourg"},"xrpl.to":{lat:48.86,lng:2.35,city:"Paris",org:"XRPL.to"},"xrpl.su":{lat:55.75,lng:37.62,city:"Moscow",org:"XRPL.su"},"xrpl.sbivc.co.jp":{lat:35.69,lng:139.69,city:"Tokyo",org:"SBI VC Trade"},"xrpl-verification.flare.network":{lat:51.51,lng:-.13,city:"London",org:"Flare Network"},"xrpl-validator.7rev.dev":{lat:52.52,lng:13.4,city:"Berlin",org:"7Rev"},"xrp.teacopula.com":{lat:39.04,lng:-77.49,city:"Ashburn, VA",org:"Teacopula"},"xrp.moneymindedapes.com":{lat:39.04,lng:-77.49,city:"Ashburn, VA",org:"MoneyMindedApes"},"xrp.hazza-systems.de":{lat:52.52,lng:13.4,city:"Berlin",org:"Hazza Systems"},"xrp.cs.uoregon.edu":{lat:44.05,lng:-123.08,city:"Eugene, OR",org:"Univ. of Oregon"},"xrp.bpsqn.com":{lat:37.77,lng:-122.42,city:"San Francisco",org:"BPSQN"},"xrp-validator.grapedrop.xyz":{lat:52.37,lng:4.9,city:"Amsterdam",org:"Grapedrop"},"xaodao.io":{lat:1.35,lng:103.82,city:"Singapore",org:"XaoDAO"},"vl.xrpsalute.com":{lat:40.71,lng:-74.01,city:"New York",org:"XRP Salute"},"validator.ukcbt.org":{lat:51.51,lng:-.13,city:"London",org:"UKCBT"},"validator.sugarxrpl.com":{lat:37.77,lng:-122.42,city:"San Francisco",org:"SugarXRPL"},"validator.boscaern.digital":{lat:53.33,lng:-6.25,city:"Dublin",org:"Boscaern"},"trimaera.tech":{lat:48.86,lng:2.35,city:"Paris",org:"Trimaera"},"textrp.io":{lat:1.35,lng:103.82,city:"Singapore",org:"TextRP"},"tesbert.com":{lat:39.04,lng:-77.49,city:"Ashburn, VA",org:"Tesbert"},"tachyon-xrpl-validator.github.io":{lat:37.77,lng:-122.42,city:"San Francisco",org:"Tachyon"},"solonation.io":{lat:1.35,lng:103.82,city:"Singapore",org:"SoloNation"},"smokydrip.com":{lat:39.04,lng:-77.49,city:"Ashburn, VA",org:"SmokyDrip"},"rippled-validator.us":{lat:39.04,lng:-77.49,city:"Ashburn, VA",org:"rippled-validator.us"},"rippleat.snt.uni.lu":{lat:49.61,lng:6.13,city:"Luxembourg",org:"Univ. of Luxembourg"},"ripple.uni.lu":{lat:49.61,lng:6.13,city:"Luxembourg",org:"Univ. of Luxembourg"},"ripple.j2b.com":{lat:37.77,lng:-122.42,city:"San Francisco",org:"J2B"},"rich-list.info":{lat:51.51,lng:-.13,city:"London",org:"Rich List"},"proptoexchange.com":{lat:39.04,lng:-77.49,city:"Ashburn, VA",org:"ProPtoExchange"},"printscierge.com":{lat:39.04,lng:-77.49,city:"Ashburn, VA",org:"Printscierge"},"opulencex.io":{lat:1.35,lng:103.82,city:"Singapore",org:"OpulenceX"},"onledger.net":{lat:52.37,lng:4.9,city:"Amsterdam",org:"OnLedger"},"oclost.art":{lat:48.86,lng:2.35,city:"Paris",org:"Oclost"},"managednetwork.us":{lat:39.04,lng:-77.49,city:"Ashburn, VA",org:"ManagedNetwork"},"joshuahamsa.com":{lat:37.77,lng:-122.42,city:"San Francisco",org:"Joshua Hamsa"},"grimmsxrpflow.jwscott.net":{lat:39.04,lng:-77.49,city:"Ashburn, VA",org:"Grimm XRP Flow"},"getlol.xyz":{lat:39.04,lng:-77.49,city:"Ashburn, VA",org:"GetLol"},"gen3labs.xyz":{lat:37.77,lng:-122.42,city:"San Francisco",org:"Gen3 Labs"},"garveyvalid.com":{lat:40.71,lng:-74.01,city:"New York",org:"Garvey"},"easynpl.kr":{lat:37.57,lng:126.98,city:"Seoul",org:"EasyNPL"},"diseb.ewi.tudelft.nl":{lat:52,lng:4.36,city:"Delft",org:"TU Delft"},"datamossa.com":{lat:48.86,lng:2.35,city:"Paris",org:"DataMossa"},"crypto.unibe.ch":{lat:46.95,lng:7.45,city:"Bern",org:"Univ. of Bern"},"commonprefix.com":{lat:37.98,lng:23.73,city:"Athens",org:"Common Prefix"},"catalyze-research.com":{lat:51.51,lng:-.13,city:"London",org:"Catalyze Research"},"catalog.org":{lat:37.77,lng:-122.42,city:"San Francisco",org:"Catalog"},"blockchain.korea.ac.kr":{lat:37.57,lng:126.98,city:"Seoul",org:"Korea Univ."},"astatiumprotocol.com":{lat:1.35,lng:103.82,city:"Singapore",org:"Astatium Protocol"},"ladykxrpl.mywire.org":{lat:39.04,lng:-77.49,city:"Ashburn, VA",org:"LadyK XRPL"},"eelap-p1201-xrp.abudhabi.nyu.edu":{lat:24.47,lng:54.37,city:"Abu Dhabi",org:"NYU Abu Dhabi"},"589.clouds.hspeed.ch":{lat:47.38,lng:8.54,city:"Zurich",org:"HSpeed"},"www.payonline.financial":{lat:55.75,lng:37.62,city:"Moscow",org:"PayOnline"}};function hr(e){if(!e)return null;let t=e.toLowerCase().replace(/^www\./,"");return Hu[t]??Hu["www."+t]??null}var T0=[{lat:37.34,lng:-121.89,label:"s1.ripple.com",city:"San Jose, CA",org:"Ripple"},{lat:37.34,lng:-121.87,label:"s2.ripple.com",city:"San Jose, CA",org:"Ripple"},{lat:52.37,lng:4.91,label:"xrplcluster.com",city:"Amsterdam",org:"Cluster"},{lat:52.36,lng:4.89,label:"xrpl.ws",city:"Amsterdam",org:"Cluster"}],Ie={nunl:{hex:"#ff5555",glow:"rgba(255,85,85,.4)",label:"Negative UNL"},both:{hex:"#50fa7b",glow:"rgba(80,250,123,.4)",label:"UNL + dUNL"},unl:{hex:"#00fff0",glow:"rgba(0,255,240,.35)",label:"UNL"},dunl:{hex:"#bd93f9",glow:"rgba(189,147,249,.4)",label:"dUNL only"},other:{hex:"#ffb86c",glow:"rgba(255,184,108,.4)",label:"Other"},pub:{hex:"#50fa7b",glow:"rgba(80,250,123,.4)",label:"Public Node"}},rr="https://api.xrpscan.com/api/v1/validatorregistry",$e=new Map,wn={},lo=0,qn=!1,xn="fallback";function nm(){if(!qn){$e.clear();for(let[e,t]of Object.entries(fr)){let n=t.domain??e,s=tm("",n),a=hr(n)??null;$e.set(e,{key:e,label:t.label,domain:n,domainVerified:!1,provider:t.provider??(a==null?void 0:a.org)??null,lists:t.lists??[],category:s.isUnl?"unl":"other",chain:s.chain,unl:s.isUnl,dunl:!1,geo:a,meta:{},agreement:{"1h":null,"24h":null,"30d":null}})}xn="fallback",gr({ok:!1,source:"fallback",error:"using hardcoded data \u2014 mount /api/v1 router"})}}var lr=0,C0=5*60*1e3;function zu(e,t){var s,a;let n=Array.isArray(e)?e:e.validators??e.data??[];if(!n.length)throw new Error("Empty validators array");$e.clear();for(let o of n){let i=o.key??o.validation_public_key??o.master_key??o.signing_key??null;if(!i)continue;let r=o.domain??null,l=r?r.toLowerCase().replace(/^www\./,""):null,c=o.unl===!0||o.unl===1||o.unl==="true",p=tm(i,l),u=c||p.isUnl,d=p.chain,m=u?"unl":"other",f=Object.values(fr).find(x=>x.domain&&x.domain.toLowerCase().replace(/^www\./,"")===l),v=(f==null?void 0:f.label)??o.label??o.account_name??o.name??l??null??`${i.slice(0,8)}\u2026${i.slice(-6)}`,b=po[i]??hr(l)??null,g=(((s=o.geo)==null?void 0:s.lat)!=null&&((a=o.geo)==null?void 0:a.lng)!=null?o.geo:null)??b;$e.set(i,{key:i,label:v,domain:r??null,domainVerified:!!(o.domainVerified??o.domain_verified),provider:o.provider??(g==null?void 0:g.org)??(f==null?void 0:f.provider)??null,lists:Array.isArray(o.lists)?o.lists:[],category:m,chain:d,unl:u,dunl:!1,geo:g,version:o.version??o.build_version??null,baseFee:o.base_fee_xrp??o.base_fee??null,ownerReserve:o.reserve_inc_xrp??o.owner_reserve??null,meta:o.meta??{},agreement:o.agreement??{"1h":nr(o.agreement_1h??o.agr_1h),"24h":nr(o.agreement_24h??o.agr_24h),"30d":nr(o.agreement_30d??o.agr_30d)}})}wn=e.lists??{},lo=Date.now(),qn=!0,xn=t,lr=0,gr({ok:!0,count:$e.size,lists:wn,source:t})}function nr(e){if(!e)return null;let t=Number(e.total??e.ledgers??0),n=Number(e.missed??0),s=t-n,a=t>0?(s/t*100).toFixed(1):null;return{total:t,missed:n,hit:s,score:a?`${a}%`:null,scoreRaw:e.score??null}}async function ro(e=!1){let t=Date.now();if(!e&&qn&&t-lo<k0)return!0;if(!e&&!qn&&t-lr<C0)return!1;let n=typeof aa=="string"&&aa.startsWith("/api/"),s=location.protocol==="file:"||location.hostname==="127.0.0.1"||location.hostname==="localhost";if(!(n&&s))try{let a=new AbortController,o=setTimeout(()=>a.abort(),Bu),i=await fetch(aa,{signal:a.signal,headers:{Accept:"application/json"}});if(clearTimeout(o),!i.ok)throw new Error(`HTTP ${i.status}`);let r=await i.json();return zu(r,"proxy"),!0}catch(a){console.warn("[registry] tier 1 (proxy) failed:",a.message)}try{let a=new AbortController,o=setTimeout(()=>a.abort(),Bu),i=await fetch(rr,{signal:a.signal});if(clearTimeout(o),!i.ok)throw new Error(`HTTP ${i.status}`);let r=await i.text(),l=JSON.parse(r);return zu(l,"xrpscan"),!0}catch(a){console.warn("[registry] tier 2 (xrpscan direct) failed:",a.message),(a.message.includes("Failed to fetch")||a.message.includes("CORS"))&&console.warn("[registry] CORS blocked \u2014 mount the backend proxy route (see validatorregistry.js)")}return console.warn("[registry] all sources failed \u2014 showing",Object.keys(fr).length,"hardcoded validators"),lr=Date.now(),qn||nm(),gr({ok:!1,source:"fallback",error:"all sources failed \u2014 mount /api/v1 router"}),!1}window.debugRegistry=async function(){console.group("\u{1F50D} Registry debug"),console.log("Current source:",xn),console.log("Validators loaded:",$e.size),console.log("Registry ok:",qn),console.log("Last fetch:",lo?new Date(lo).toLocaleTimeString():"never"),console.log(""),console.log("Testing proxy \u2192",aa);try{let e=await fetch(aa),t=await e.text();console.log("  Status:",e.status,"\u2014 body preview:",t.slice(0,300))}catch(e){console.warn("  Failed:",e.message)}console.log(""),console.log("Testing XRPScan direct \u2192",rr);try{let e=await fetch(rr),t=await e.text();console.log("  Status:",e.status,"\u2014 body preview:",t.slice(0,300))}catch(e){console.warn("  Failed:",e.message)}return console.groupEnd(),{source:xn,size:$e.size,ok:qn}};function ot(e){return $e.get(e)??{key:e,label:`${e.slice(0,10)}\u2026${e.slice(-6)}`,domain:null,provider:null,lists:[],category:"other",geo:po[e]??null,meta:{}}}function kn(e){var n;if(!e)return null;if(((n=e.geo)==null?void 0:n.lat)!=null)return e.geo;let t=po[e.key];return t||hr(e.domain)}function sm(){return[...$e.values()].filter(e=>(e.category==="unl"||e.category==="both")&&e.chain!=="test").map(e=>e.key)}function P0(){return[...$e.values()].filter(e=>(e.category==="dunl"||e.category==="both")&&e.chain!=="test").map(e=>e.key)}function M0(){return[...$e.values()].filter(e=>e.category==="other"&&e.chain!=="test").map(e=>e.key)}function L0(){return[...$e.values()].filter(e=>e.chain==="test").map(e=>e.key)}function gr({ok:e,count:t,lists:n,source:s,error:a}){let o=w("m1-registry-badge");if(o)if(e){let i=[...$e.values()].filter(c=>c.category==="unl").length,r=[...$e.values()].filter(c=>c.chain==="test").length,l=t-r;o.textContent=`${l} mainnet \xB7 ${i} UNL \xB7 ${r} testnet \xB7 live`,o.className="registry-badge registry-badge--ok"}else o.textContent=s==="fallback"?`Fallback data \xB7 ${$e.size} known \xB7 ${a??"endpoint unreachable"}`:"Refreshing\u2026",o.className="registry-badge registry-badge--warn"}var co=null,Wu=!1,sr=!1,Uu=0,ju=0,qu=0,ar=0,am=!0,et=null,jn=null,ra=null,zt=null,He={},oo=null,cr={},Ze=null,en=[],io=null,dr={},na="unl",mt={fees:[],burnDrops:[],dexOffers:[],ammSwaps:[],newAccounts:[],converge:[],proposers:[],peerCounts:[],peerDiscon:[]};function om(){var t,n;if(Wu)return;Wu=!0,nw(),nm(),ro(!0),Z0(),ew(),window.addEventListener("xrpl-connected",()=>{sa(),$s()&&(oa({force:!0}),ia({force:!1}))}),window.addEventListener("xrpl-disconnected",()=>{pr(),mr(null)}),window.addEventListener("xrpl-connection",s=>{var a;((a=s==null?void 0:s.detail)==null?void 0:a.state)==="connecting"&&(pr(),mr(null,"Switching networks\u2026"))}),window.addEventListener("xrpl-ledger",s=>{J0(s.detail),$s()&&Y0(s.detail)}),(t=w("btn-network-refresh"))==null||t.addEventListener("click",()=>{oa({force:!0}),ro(!0),ia({force:!0})}),(n=document.querySelector('.dash-tab[data-tab="network"]'))==null||n.addEventListener("click",()=>{sa(),oa({force:!0}),ro(!1),ia({force:!1})});let e=w("tab-network");e&&new MutationObserver(sa).observe(e,{attributes:!0,attributeFilter:["style","class"]}),document.addEventListener("visibilitychange",sa)}function $s(){let e=w("tab-network"),t=e?e.style.display!=="none":!1;return am&&X.currentPage==="dashboard"&&X.currentTab==="network"&&t&&!document.hidden}function sa(){$s()?A0():pr()}function im(e){am=!!e,sa()}function A0(){co||(oa({force:!1}),co=setInterval(()=>{$s()&&oa({force:!1})},f0))}function pr(){clearInterval(co),co=null}async function oa({force:e=!1}={}){var n;if(!$s()&&!e)return;let t=Date.now();if(!(!e&&(t-Uu<h0||sr||t<ju))){sr=!0,Uu=t,He={},Vu(!0);try{await Promise.allSettled([ro(!1),E0(),N0(),R0(),_0(),D0()]),I0(),X0(),H0(),z0(),G0(),mr({info:et,fee:jn,vals:ra}),sw()}catch(s){String((s==null?void 0:s.message)??"").toLowerCase().includes("too much load")&&(ju=Date.now()+g0,(n=ge)==null||n("Rate-limited \u2014 backing off 2 min."))}finally{Vu(!1),sr=!1}}}function Vu(e){var t;(t=w("btn-network-refresh"))==null||t.classList.toggle("spinning",e)}async function E0(){var n,s,a;let e=await Ae({command:"server_info"});if(et=((n=e==null?void 0:e.result)==null?void 0:n.info)??null,!et)return;at("converge",Number(((s=et.last_close)==null?void 0:s.converge_time_s)??0)),at("proposers",Number(((a=et.last_close)==null?void 0:a.proposers)??0)),at("peerCounts",Number(et.peers??0));let t=Number(et.peer_disconnects_resources??0);oo!==null&&t>oo&&at("peerDiscon",t-oo),oo=t}async function N0(){var t;let e=await Ae({command:"fee"});jn=(e==null?void 0:e.result)??null,((t=jn==null?void 0:jn.drops)==null?void 0:t.open_ledger_fee)!=null&&at("fees",Number(jn.drops.open_ledger_fee))}async function R0(){try{let e=await Ae({command:"validators"});ra=(e==null?void 0:e.result)??null}catch{ra=null}}async function _0(){var e;try{let t=await Ae({command:"peers"});zt=Array.isArray((e=t==null?void 0:t.result)==null?void 0:e.peers)?t.result.peers:null}catch{zt=null}}async function D0(){var e;try{let t=await Ae({command:"feature"});(e=t==null?void 0:t.result)!=null&&e.features&&(W0(t.result.features),lm(t.result.features))}catch{}}function I0(){var C,P,R,O,D,I;let e=et,t=ra,n=(t==null?void 0:t.trusted_validator_keys)??[],s=sm(),a=P0(),o=n.length?n:s,i=a,r=Number((t==null?void 0:t.validation_quorum)??(e==null?void 0:e.validation_quorum)??0),l=o.length,c=l-r,p=l>0?r/l*100:0,u=o.filter(F=>$e.has(F)).length,d=l>0?Math.round(u/l*100):0,m=Number(((C=e==null?void 0:e.last_close)==null?void 0:C.converge_time_s)??0),f=Number(((P=e==null?void 0:e.last_close)==null?void 0:P.proposers)??0),v=r>0?Math.round(f/r*100):0,b=Array.isArray(e==null?void 0:e.negative_unl)?e.negative_unl:[],h=!!ra;c>=0&&c<=3&&(He.quorumTight=!0),b.length>0&&(He.nUnlActive=!0),m>6&&(He.slowConverge=!0),f>0&&r>0&&f<r&&(He.lowProposers=!0),J("m1-active",h?l:"\u2014"),J("m1-quorum",r>0?r:"\u2014"),J("m1-margin",h?c>=0?c:`\u2212${Math.abs(c)}`:"\u2014"),J("m1-overlap",h?`${d}%`:"\u2014"),J("m1-known",h?`${u} / ${l} identified`:"\u2014 (validators cmd unavailable)"),J("m1-proposers",((R=e==null?void 0:e.last_close)==null?void 0:R.proposers)!=null?f:"\u2014"),J("m1-particip",r>0&&((O=e==null?void 0:e.last_close)==null?void 0:O.proposers)!=null?`${v}%`:"\u2014"),J("m1-converge",((D=e==null?void 0:e.last_close)==null?void 0:D.converge_time_s)!=null?`${m.toFixed(2)}s`:"\u2014"),J("m1-converge-avg",la("converge")>0?`avg ${la("converge").toFixed(2)}s`:"\u2014"),Tt("m1-qbar",p,p>90?"bar-danger":p>80?"bar-warn":"bar-ok"),Tt("m1-obar",d,d<40?"bar-danger":d<70?"bar-warn":"bar-ok"),Tt("m1-pbar",v,v<80?"bar-danger":v<95?"bar-warn":"bar-ok"),Tt("m1-cvgbar",Math.min(100,m/10*100),m>6?"bar-danger":m>4?"bar-warn":"bar-ok"),B0({active:l,quorum:r,margin:c,nUnl:b,valsAvail:h});let g=(I=t==null?void 0:t.publisher_lists)==null?void 0:I[0],x=(wn==null?void 0:wn.ripple)??(wn==null?void 0:wn.xrplf)??null,k=(g==null?void 0:g.uri)??(x==null?void 0:x.uri)??"\u2014",T=(g==null?void 0:g.seq)??(x==null?void 0:x.seq)??"\u2014";if(J("m1-vl-uri",k),J("m1-vl-seq",T),g!=null&&g.expiration||x!=null&&x.expiration){let F=w("m1-vl-expiry");if(F){let B=(g==null?void 0:g.expiration)??(x==null?void 0:x.expiration),E=Math.floor((new Date(B)-Date.now())/864e5);F.textContent=E>0?`Expires ${E}d`:"\u26A0 EXPIRED",F.className=`expiry-pill ${E>30?"pill-ok":E>7?"pill-warn":"pill-bad"}`,F.style.display=""}}let S=w("m1-nunl-list");if(J("m1-nunl-count",b.length||"0"),S)if(!b.length)S.innerHTML='<div class="nunl-empty">\u2713 No validators on Negative UNL</div>';else{let F={};S.innerHTML=b.map(E=>{let z=ot(E);return z.provider&&(F[z.provider]=(F[z.provider]||0)+1),`<div class="nunl-entry">
        ...
        </div>`}).join("");let B=Object.entries(F).sort((E,z)=>z[1]-E[1])[0];(B==null?void 0:B[1])>1&&(S.innerHTML+=`<div class="nunl-alert">\u26A0 ${B[1]} offline validators share <b>${y(B[0])}</b> \u2014 likely provider outage</div>`)}rm(o,i,r,b,h);let $=Number((et==null?void 0:et.peers)??0);J("wm-stat-val",h?`${l} validators`:`${$e.size} in registry`),J("wm-stat-nunl",`${b.length} on nUNL`),J("wm-stat-peers",`${zt?zt.length:$} peers`);let N=[...$e.keys()];j0(o,i,b,zt,!h)}function rm(e,t,n,s,a){let o=w("m1-val-grid");if(!o)return;let i=new Set(e),r=new Set(t),l=new Set(s),c=sm(),p=L0(),u=M0(),d=e.length?e:c,m=[...$e.keys()],f=m.filter(D=>{var I;return(((I=$e.get(D))==null?void 0:I.chain)??"main")==="main"}),v=p,b=u,h=d.filter(D=>!!ot(D).domain),g=d.filter(D=>!ot(D).domain),x=b.filter(D=>!!ot(D).domain),k=b.filter(D=>!ot(D).domain),T=m.filter(D=>!!kn(ot(D))),S=[{id:"unl",label:"UNL",count:d.length,dot:"unl"},{id:"others",label:"Others",count:b.length,dot:"other"},{id:"all",label:"All",count:f.length,dot:null},{id:"test",label:"Testnet",count:v.length,dot:null}],$={unl:"#00fff0",dunl:"#bd93f9",both:"#50fa7b",nunl:"#ff5555",other:"#ffb86c"},N='<div class="vg-tabs" role="tablist">'+S.map(D=>`<button class="vg-tab ${na===D.id?"vg-tab--active":""}" data-vgtab="${D.id}">
        ${D.dot?`<span class="vg-tab-dot" style="background:${$[D.dot]}"></span>`:""}
        ${y(D.label)}
        <span class="vg-tab-count">${D.count}</span>
      </button>`).join("")+"</div>",C=[],P="";if(na==="unl"){let D=d.filter(E=>l.has(E)),I=h.filter(E=>!l.has(E)),F=g.filter(E=>!l.has(E));D.length&&C.push({title:`\u26A0 Negative UNL (${D.length})`,keys:D,cls:"vgs-warn"}),C.push({title:`Named UNL validators \xB7 ${I.length}`,keys:I}),F.length&&C.push({title:`Key-only UNL validators \xB7 ${F.length}`,keys:F,collapsed:!0}),d.length||C.push({title:"No UNL data",keys:[],notice:"Registry not loaded yet"});let B=a?"live rippled":`registry (${xn})`;P=`${d.length} trusted \xB7 quorum ${n} \xB7 ${s.length} on nUNL \xB7 source: ${B}`}else if(na==="others")C.push({title:`Named mainnet (non-UNL) \xB7 ${x.length}`,keys:x}),k.length&&C.push({title:`Key-only mainnet \xB7 ${k.length}`,keys:k,collapsed:!0}),P=`${b.length} mainnet validators not on UNL \xB7 source: ${xn}`;else if(na==="test"){let D=v.filter(F=>!!ot(F).domain),I=v.filter(F=>!ot(F).domain);D.length&&C.push({title:`Named testnet \xB7 ${D.length}`,keys:D}),I.length&&C.push({title:`Key-only testnet \xB7 ${I.length}`,keys:I,collapsed:!0}),P=`${v.length} testnet validators`}else C.push({title:`\u2B50 UNL \xB7 ${d.length}`,keys:d}),C.push({title:`Other mainnet \xB7 ${b.length}`,keys:b,collapsed:!0}),v.length&&C.push({title:`Testnet \xB7 ${v.length}`,keys:v,collapsed:!0}),P=`${f.length} mainnet \xB7 ${v.length} testnet \xB7 ${T.length} geo-located \xB7 source: ${xn}`;function R(D,I){var xe;let F=ot(D),B=l.has(D),E=i.has(D),z=r.has(D),te=F.chain==="test",oe,pe,ie;B?(oe="vp-nunl",pe="nUNL",ie=$.nunl):E&&z?(oe="vp-both",pe="UNL+dUNL",ie=$.both):E?(oe="vp-unl",pe="UNL",ie=$.unl):z?(oe="vp-dunl",pe="dUNL",ie=$.dunl):(oe="vp-other",pe="Other",ie=$.other);let ne=kn(F),re=!!ne,G=ne?`\u{1F4CD} ${ne.city??""}`:"",Se=F.domain?F.domain.replace(/^www\./,"").replace(/^validator\./,"").replace(/^xrp\./,""):null,H=`${D.slice(0,8)}\u2026${D.slice(-6)}`,q=E&&I!=null?`<span class="vg-num">${I+1}</span>`:"",se=(xe=F.agreement)==null?void 0:xe["24h"],me=se!=null&&se.score?`<span class="vg-agr" style="color:${parseFloat(se.score)>=99?"#50fa7b":parseFloat(se.score)>=95?"#ffb86c":"#ff5555"}" title="24h agreement">${se.score}</span>`:"";return`<div class="vpill ${oe} ${re?"vp-locatable":""}"
      ...
      </div>`}),O||(O='<div class="nunl-empty">No validators in this view.</div>'),o.innerHTML=N+O,J("m1-val-summary",P),o.querySelectorAll(".vg-tab").forEach(D=>{D.addEventListener("click",I=>{I.stopPropagation();let F=D.getAttribute("data-vgtab");F&&(na=F,rm(e,t,n,s,a))})})}async function F0(e){let t=or.get(e);if(t&&Date.now()-t.cachedAt<Qu)return t.data;try{let n=new AbortController,s=setTimeout(()=>n.abort(),Zu),a=await fetch(`${Yu}/${encodeURIComponent(e)}`,{signal:n.signal});if(clearTimeout(s),!a.ok)throw new Error(`HTTP ${a.status}`);let o=await a.json();return or.set(e,{data:o,cachedAt:Date.now()}),o}catch{return null}}async function O0(e){let t=ir.get(e);if(t&&Date.now()-t.cachedAt<Qu)return t.data;try{let n=new AbortController,s=setTimeout(()=>n.abort(),Zu),a=await fetch(`${Yu}/${encodeURIComponent(e)}/reports`,{signal:n.signal});if(clearTimeout(s),!a.ok)throw new Error(`HTTP ${a.status}`);let o=await a.json(),i=o.reports??o??[];return ir.set(e,{data:i,cachedAt:Date.now()}),i}catch{return[]}}window.focusValidator=async function(e){let t=ot(e),n=kn(t);document.querySelectorAll(".vpill").forEach(o=>o.classList.remove("vp-active"));let s=document.querySelector(`.vpill[data-key="${CSS.escape(e)}"]`);if(s&&(s.classList.add("vp-active"),s.scrollIntoView({behavior:"smooth",block:"nearest"})),ur(e,t,null),F0(e).then(o=>{o&&ur(e,t,o)}),!n){let o=w("world-map-container");if(o){let i=o.querySelector(".wm-no-geo");i&&i.remove();let r=document.createElement("div");r.className="wm-no-geo",r.textContent=`\u{1F4CD} ${t.label} \u2014 geographic location unknown`,o.appendChild(r),setTimeout(()=>r.remove(),3500)}return}let a=w("world-map-container");a&&a.scrollIntoView({behavior:"smooth",block:"nearest"}),Ze&&(Ze.flyTo([n.lat,n.lng],6,{duration:1.2}),setTimeout(()=>{let o=dr[e];o&&o.openPopup()},1300))};function ur(e,t,n){var C,P,R,O,D;let s=w("amend-modal-overlay"),a=w("amend-modal-body");if(!s||!a)return;let o=n??{},i=t.label??o.label??o.account_name??e.slice(0,16)+"\u2026",r=t.domain??o.domain??null,l=t.chain??o.chain??"main",c=t.category??"other",p=Ie[c]??Ie.other,u=kn(t),d=t.unl||c==="unl"||c==="both",m=t.dunl||c==="dunl"||c==="both",f=t.domainVerified||o.domain_verified?"\u2713 Verified":r?"Unverified":"\u2014",v=t.agreement??o.agreement??{},b=!n&&!((C=t.agreement)!=null&&C["24h"]);function h(I,F){if(!F||!F.total)return`<div class="adm-mi"><span class="adm-mk">${I}</span><span class="adm-mv" style="opacity:.5">\u2014</span></div>`;let B=parseFloat(F.score)||0,E=B>=99?"color:#50fa7b":B>=95?"color:#ffb86c":"color:#ff5555";return`<div class="adm-mi">
    ...
    </div>`}function g(I,F,B=!1){return!F&&F!==0?"":`<div class="adm-mi"><span class="adm-mk">${I}</span><span class="adm-mv ${B?"mono":""}">${y(String(F))}</span></div>`}let x=ir.get(e),k=((P=x==null?void 0:x.data)==null?void 0:P.slice(-14))??[],T=k.length?`<div class="adm-section">
    ...
    <div class="adm-section">
      ...
      ${h("1-hour",v["1h"]??((R=o.agreement)==null?void 0:R["1h"]))}
      ${h("24-hour",v["24h"]??((O=o.agreement)==null?void 0:O["24h"]))}
      ${h("30-day",v["30d"]??((D=o.agreement)==null?void 0:D["30d"]))}
    </div>
    ...
    </div>`,s.style.display="flex",s.addEventListener("click",I=>{I.target===s&&window.closeAmendModal()},{once:!0})}window._loadValidatorReports=async function(e){var n;let t=ot(e);await O0(e),ur(e,t,((n=or.get(e))==null?void 0:n.data)??null)};function B0({active:e,quorum:t,margin:n,nUnl:s,valsAvail:a}){let o=w("m1-quorum-ring");if(!o)return;if(!a||!t||!e){o.innerHTML='<div style="opacity:.4;font-size:12px;text-align:center;padding:16px">Connect to view quorum</div>';return}let i=44,r=2*Math.PI*i,l=new Set(s),c=e-s.length,p=s.length,u=Math.max(0,e-t),d=t,m=n<=0?"#ff5555":n<=3?"#ffb86c":"#50fa7b",f=e>0?c/e:0,v=e>0?p/e:0,b=e>0?t/e:0,h=e>0?Math.max(0,n)/e:0,g=e>0?p/e:0;function x(k,T,S,$=8){if(T<=0)return"";let N=k*r,C=T*r;return`<circle r="${i}" cx="50" cy="50" fill="none"
    ...
    <div class="qr-wrap">
      ...
      ${l.length?`<div class="ap-near-bar">\u{1F4C8} ${l.length} amendment${l.length>1?"s":""} approaching 80% threshold</div>`:""}`,n.querySelectorAll(".ap-tab").forEach(u=>{u.onclick=()=>{xs=u.dataset.aptab,lm(e)}})}let c=xs==="active"?a:xs==="vetoed"?i:xs==="all"?s.sort((p,u)=>p.enabled!==u.enabled?p.enabled?1:-1:p.vetoed!==u.vetoed?p.vetoed?1:-1:(u.count??0)-(p.count??0)):o;if(!c.length){t.innerHTML=`<div class="amend-empty">${xs==="vetoed"?"No vetoed amendments":"No data"}</div>`;return}t.innerHTML=c.map(p=>{var $;let u=p.count??0,d=p.threshold??28,m=Math.min(100,Math.round(u/d*100)),f=p.name??`${p.hash.slice(0,10)}...`,v=!!p.enabled,b=!!p.vetoed,h=!!p.majority,g=em[f]??{},x=($=mt.amendMomentum)==null?void 0:$[p.hash],k="";if(h&&!v&&p.majority){let N=Date.now()-new Date(p.majority).getTime(),C=N>0?Math.floor(N/864e5):0,P=Math.max(0,14-C),R=Math.min(100,Math.round(C/14*100));k=`<div class="ap-countdown">
      ...
      </div>`}let T=v?"#50fa7b":b?"#ff5555":h?"#ffb86c":m>=80?"#8be9fd":"rgba(255,255,255,.3)",S=v?"Active":b?"Vetoed":h?"Majority":m>=80?"Near":"Voting";return`<div class="ap-row" onclick="window.showAmendDetail('${y(p.hash)}')">
      <div class="ap-row-main">
        ...
        ${v?`<div class="ap-active-note">\u2713 Running on all ledgers${g.intro?" \xB7 since "+g.intro:""}</div>`:`<div class="ap-vote-row">
          <div class="ap-vote-track">
            <div class="ap-vote-fill" style="width:${m}%;background:${T};opacity:${v?1:.75}"></div>
    ...
    </div>`}).join("")}function W0(e){cr={},Object.entries(e).forEach(([t,n])=>{cr[t]={hash:t,...n}})}window.showAmendDetail=function(e){let t=cr[e];if(!t)return;let n=t.name||`${e.slice(0,16)}...`,s=em[n]||{},a=t.count??0,o=t.threshold??28,i=Math.min(100,Math.round(a/o*100)),r=t.enabled?"Active on Ledger":t.vetoed?"Vetoed":t.majority?"Majority Reached":"Voting in Progress",l=t.enabled?"adm-s-ok":t.vetoed?"adm-s-bad":t.majority?"adm-s-warn":"adm-s-info",c=t.enabled?"bar-ok":t.vetoed?"bar-danger":t.majority?"bar-warn":"bar-info",p=t.majority&&!t.enabled?`
    ...
    <div class="adm-footer">
      ...
      <a class="adm-link" href="https://xrpl.org/consensus.html" target="_blank" rel="noopener noreferrer">Consensus Docs</a>
      ...
      </div>`,className:"",iconSize:[(C+8)*2,(C+8)*2],iconAnchor:[C+8,C+8]}),R=L.marker([k.lat,k.lng],{icon:P}).bindPopup(V0(k.keys,k.city,k.org,i,r,l,a),{maxWidth:380,className:"wm-popup-wrap"}).addTo(Ze);k.keys.forEach(O=>{dr[O]=R}),en.push(R)}),a){let k=L.control({position:"bottomleft"});k.onAdd=()=>{let T=L.DomUtil.create("div","wm-ref-banner");return T.innerHTML="\u{1F4E1} Reference positions \xB7 live validator list unavailable from endpoint",T},k.addTo(Ze),en.push(k)}let d=[...$e.keys()].filter(k=>{var S;return((S=$e.get(k).geo)==null?void 0:S.lat)!=null||po[k]}).length,m=$e.size-d;if(m>0){let k=L.control({position:"bottomright"});k.onAdd=()=>{let T=L.DomUtil.create("div","wm-unknown-ctrl");return T.innerHTML=`+ ${m} validators \xB7 location unknown`,T},k.addTo(Ze),en.push(k)}T0.forEach(k=>{let T=L.divIcon({html:`<div class="wm-lmarker wm-lmarker-pub">
        <div class="wm-lring"></div>
        ...
        </div>`,{maxWidth:260,className:"wm-popup-wrap"}).addTo(Ze);en.push(S)});let f=Array.isArray(s)?s:[],v=f.filter(k=>k.inbound===!0).length,b=f.length-v,h=f.length>0?`${f.length} peers (${v}\u2193 ${b}\u2191)`:`${Number((et==null?void 0:et.peers)??0)} peers`,g=L.control({position:"topleft"});g.onAdd=()=>{let k=L.DomUtil.create("div","wm-legend-ctrl");return k.innerHTML=`
      ...
      </div>`,k},g.addTo(Ze),en.push(g);let x=en.filter(k=>k&&typeof k.getLatLng=="function");if(x.length>=2)try{let k=L.latLngBounds(x.map(T=>T.getLatLng()));k.isValid()&&Ze.fitBounds(k.pad(.15),{maxZoom:6})}catch{}try{window.dispatchEvent(new CustomEvent("nalulf-network-map",{detail:{map:Ze,networkId:io}}))}catch{}}function V0(e,t,n,s,a,o,i=!1){let r=e.length>1,l=e.map(p=>{let u=ot(p),d=s.has(p),m=a.has(p),f=o.has(p),v=p.slice(0,20)+"...",b,h;return d?(b=Ie.nunl.hex,h="Negative UNL"):m&&f?(b=Ie.both.hex,h="UNL + dUNL"):m?(b=Ie.unl.hex,h="UNL"):f?(b=Ie.dunl.hex,h="dUNL"):(b=Ie.other.hex,h="Other"),`<div class="wm-popup-val-row">
      ...
      <div class="wm-popup-val-info">
        ...
        <span class="wm-popup-val-key"
              onclick="navigator.clipboard?.writeText('${y(p)}');this.textContent='\u2713 Copied!';setTimeout(()=>this.textContent='${y(v)}',1400)"
    ...
    <div class="wm-popup-vals">${l}</div>
      ...
      ${d.map(f=>{let v=tn[f]??{w:1,label:f},b=v.label.split(" \u2014 "),h=b[0],g=b[1]||"";return`<div class="adv-sig-card adv-sig-${v.w>=3?"critical":v.w>=2?"elevated":"monitor"}">
      ...
      <span class="hcs-total">of ${i.length} checks</span>`);let u={consensus:"Consensus Health",infra:"Node Infrastructure",ledger:"Ledger & Fees"};t.innerHTML=Object.entries(u).map(([d,m])=>{let f=i.filter(x=>x.group===d),v=f.map(x=>{let k=x.result.status,T=k==="ok"?"hc-ok":k==="watch"?"hc-warn":"hc-fail",S="\u25CF";return`<div class="hc-item ${T}">
    ...
    </div>`}).join("")}function J0(e){var t,n,s,a,o,i,r,l,c,p;e&&(at("burnDrops",(e.avgFee||0)*1e6*(e.txPerLedger??0)),at("dexOffers",((t=e.txTypes)==null?void 0:t.OfferCreate)??0),at("ammSwaps",(((n=e.txTypes)==null?void 0:n.AMMDeposit)??0)+(((s=e.txTypes)==null?void 0:s.AMMWithdraw)??0)+(((a=e.txTypes)==null?void 0:a.AMMBid)??0)),at("newAccounts",((o=e.txTypes)==null?void 0:o.AccountSet)??0),at("txPayment",((i=e.txTypes)==null?void 0:i.Payment)??0),at("txNFT",(((r=e.txTypes)==null?void 0:r.NFTokenMint)??0)+(((l=e.txTypes)==null?void 0:l.NFTokenBurn)??0)+(((c=e.txTypes)==null?void 0:c.NFTokenCreateOffer)??0)+(((p=e.txTypes)==null?void 0:p.NFTokenAcceptOffer)??0)),at("txLedger",e.txPerLedger??0),at("tps",e.tps??(e.txPerLedger??0)/3.5),at("closeTime",e.closeTime??3.5))}function Y0(e){let t=X.tpsHistory.length?X.tpsHistory[X.tpsHistory.length-1]:null;J("m2-tps",t!=null?t.toFixed(1):"\u2014"),J("m2-txcount",e.txPerLedger??"\u2014"),e.successRate!=null&&J("m2-success",`${e.successRate.toFixed(0)}%`)}async function ia({force:e=!1}={}){if(!$s()&&!e)return;let t=Date.now();if(!e&&t-qu<b0)return;qu=t;let n=w("latency-list");if(!n)return;let s=Rr[X.currentNetwork]??[],a=++ar;n.innerHTML=s.map((i,r)=>`
  ...
  `,document.body.appendChild(e),e.addEventListener("click",t=>{t.target===e&&ca()}),document.addEventListener("keydown",t=>{t.key==="Escape"&&e.classList.contains("show")&&ca()})}function uw(e){let t=rw[e];if(!t)return;pw();let n=document.getElementById("learnModalOverlay"),s=document.getElementById("learnModalTitle"),a=document.getElementById("learnModalSub"),o=document.getElementById("learnModalBody"),i=document.getElementById("learnModalLinks"),r=document.getElementById("learnModalCtas");!n||!s||!a||!o||!i||!r||(s.textContent=t.title,a.textContent=t.subtitle||"",o.innerHTML=(t.sections||[]).map(l=>`
  ...
  `).join(""),n.classList.add("show"),document.body.classList.add("modal-open"))}function ca(){var e;(e=document.getElementById("learnModalOverlay"))==null||e.classList.remove("show"),document.body.classList.remove("modal-open")}function mw(e){var t,n,s;if(e==="modal:close")return ca();if(e==="auth:signup"){ca(),(t=window.openAuth)==null||t.call(window,"signup");return}if(e==="auth:login"){ca(),(n=window.openAuth)==null||n.call(window,"login");return}if(e.startsWith("topic:"))return uw(e.split(":")[1]);if(e.startsWith("scroll:")){let a=e.split(":")[1];(s=document.getElementById(a))==null||s.scrollIntoView({behavior:"smooth",block:"start"})}}function fw(){cm||(cm=!0,document.addEventListener("click",e=>{var s,a;let t=(a=(s=e.target).closest)==null?void 0:a.call(s,"[data-action]");if(!t)return;let n=t.getAttribute("data-action")||"";n&&(e.preventDefault(),mw(n))}))}function dm(){var l,c,p,u,d;fw(),(l=document.querySelector(".landing-features"))==null||l.setAttribute("id","learn"),(c=document.querySelector(".landing-simple-value"))==null||c.setAttribute("id","use-cases"),(p=document.querySelector(".landing-cta"))==null||p.setAttribute("id","about"),(u=document.querySelector(".landing-tagline"))==null||u.classList.add("tagline-pill");let e=document.querySelector(".landing-stats-strip");e&&(e.classList.add("landing-learn-strip"),e.innerHTML=lw.map(m=>`
    ...
    `).join(""));let t=w("features-grid");t&&(t.innerHTML=cw.map(m=>`
    ...
    `).join(""));let n=document.querySelector(".landing-simple-value"),s=n==null?void 0:n.querySelector("h2");s&&(s.textContent="What you can do with NaluLF");let a=w("value-grid");a&&(a.innerHTML=dw.map(m=>`
    ...
    `)}function pm(){let e=new IntersectionObserver(t=>t.forEach(n=>{n.isIntersecting&&n.target.classList.add("visible")}),{threshold:.12});document.querySelectorAll(".reveal").forEach(t=>e.observe(t))}function um(){let e=document.getElementById("particle-canvas");if(!e)return;let t=e.getContext("2d"),n,s,a=[],o=80,i=120;function r(){n=e.width=window.innerWidth,s=e.height=window.innerHeight}function l(){return{x:Math.random()*n,y:Math.random()*s,vx:(Math.random()-.5)*.4,vy:(Math.random()-.5)*.4,r:Math.random()*1.5+.5,alpha:Math.random()*.5+.1}}function c(){r(),a=Array.from({length:o},l)}function p(){return getComputedStyle(document.body).getPropertyValue("--accent-secondary").trim()||"#ffd700"}function u(){t.clearRect(0,0,n,s);let v=p();for(let b=0;b<a.length;b++)for(let h=b+1;h<a.length;h++){let g=a[b].x-a[h].x,x=a[b].y-a[h].y,k=Math.sqrt(g*g+x*x);k<i&&(t.beginPath(),t.moveTo(a[b].x,a[b].y),t.lineTo(a[h].x,a[h].y),t.strokeStyle=`rgba(255,255,255,${(1-k/i)*.06})`,t.lineWidth=1,t.stroke())}a.forEach(b=>{t.beginPath(),t.arc(b.x,b.y,b.r,0,Math.PI*2),t.fillStyle=`rgba(255,255,255,${b.alpha*.6})`,t.fill()})}function d(){a.forEach(v=>{v.x+=v.vx,v.y+=v.vy,(v.x<0||v.x>n)&&(v.vx*=-1),(v.y<0||v.y>s)&&(v.vy*=-1)})}let m;function f(){d(),u(),m=requestAnimationFrame(f)}c(),f(),document.addEventListener("visibilitychange",()=>{document.hidden?(m&&cancelAnimationFrame(m),m=null):!m&&X.currentPage==="landing"&&f()}),window.addEventListener("naluxrp:pagechange",v=>{var b;((b=v==null?void 0:v.detail)==null?void 0:b.pageId)!=="landing"?(m&&cancelAnimationFrame(m),m=null):m||f()}),window.addEventListener("resize",()=>{r(),a.forEach(v=>{v.x=Math.min(v.x,n),v.y=Math.min(v.y,s)})}),e.style.cssText=`
    position: fixed; inset: 0;
    width: 100%; height: 100%;
    pointer-events: none;
    z-index: 0; opacity: 0.4;
  `}function Ss(e){var t;(t=window.showProfile)==null||t.call(window),setTimeout(()=>e==null?void 0:e(),250)}var vr=[{label:"\u{1F30A} Live Stream",hint:"Dashboard \u2192 Stream tab",action:()=>Ln(document.querySelector('[data-tab="stream"]'),"stream")},{label:"\u{1F50D} Inspector",hint:"Dashboard \u2192 Inspector tab",action:()=>Ln(document.querySelector('[data-tab="inspector"]'),"inspector")},{label:"\u{1F4E1} Network Health",hint:"Dashboard \u2192 Network tab",action:()=>Ln(document.querySelector('[data-tab="network"]'),"network")},{label:"\u{1F464} Profile",hint:"View your profile",action:()=>{var e;return(e=window.showProfile)==null?void 0:e.call(window)}},{label:"\u{1F48E} Wallets",hint:"Profile \u2192 Wallets",action:()=>Ss(()=>{var e;return(e=window.switchProfileTab)==null?void 0:e.call(window,"wallets")})},{label:"\u{1F4CA} Portfolio Analytics",hint:"Profile \u2192 Balance history, heatmap, flow",action:()=>Ss(()=>{var e;return(e=window.switchProfileTab)==null?void 0:e.call(window,"analytics")})},{label:"\u{1F517} Social Links",hint:"Profile \u2192 Connect Discord, X, GitHub\u2026",action:()=>Ss(()=>{var e;return(e=window.switchProfileTab)==null?void 0:e.call(window,"social")})},{label:"\u{1F4DC} Activity Log",hint:"Profile \u2192 Recent account activity",action:()=>Ss(()=>{var e;return(e=window.switchProfileTab)==null?void 0:e.call(window,"activity")})},{label:"\u2699\uFE0F Settings",hint:"Profile \u2192 Preferences & AI Explanations",action:()=>Ss(()=>{var e;return(e=window.switchProfileTab)==null?void 0:e.call(window,"settings")})},{label:"\u{1F52C} Analyze a Project",hint:"Liquidity depth, holder/LP concentration, issuer risk",action:()=>Ss(()=>{var e;return(e=window.jumpToProjectIntelLookup)==null?void 0:e.call(window)})},{label:"\u{1F9ED} Replay App Tour",hint:"Retake the onboarding walkthrough",action:()=>{var e;(e=window.showDashboard)==null||e.call(window),setTimeout(()=>{var t;return(t=window.startTour)==null?void 0:t.call(window)},300)}},{label:"\u2753 Help & Glossary",hint:"Search app features and on-chain terms",action:()=>{var e;return(e=window.openHelp)==null?void 0:e.call(window)}},{label:"\u{1F511} Sign In",hint:"Open auth",action:()=>{var e;return(e=window._openAuth)==null?void 0:e.call(window,"login")}},{label:"\u2728 Sign Up",hint:"Create account",action:()=>{var e;return(e=window._openAuth)==null?void 0:e.call(window,"signup")}},{label:"\u{1F3E0} Landing Page",hint:"Go home",action:()=>{var e;return(e=window._goHome)==null?void 0:e.call(window)}},{label:"\u{1F3A8} Cycle Theme",hint:"gold \u2192 cosmic \u2192 starry \u2192",action:()=>{var e;return(e=window._cycleTheme)==null?void 0:e.call(window)}}];function hw(e){let t=e.trim();return Xe(t)?[{label:`\u{1F50D} Inspect ${t.slice(0,8)}\u2026${t.slice(-6)}`,hint:"Run the full account inspection on this address",action:()=>{Ln(document.querySelector('[data-tab="inspector"]'),"inspector"),setTimeout(()=>{var s;let n=document.getElementById("inspect-addr");n&&(n.value=t),(s=window.runInspect)==null||s.call(window)},200)}}]:[]}var Vn=0,uo=[...vr];function mo(e=""){let t=w("cmdkOverlay"),n=w("cmdkInput");!t||!n||(t.classList.add("show"),n.value=e||"",hm(e),n.focus())}function Ts(){var e;(e=w("cmdkOverlay"))==null||e.classList.remove("show")}function fm(){let e=w("cmdkOverlay"),t=w("cmdkInput");!e||!t||(t.addEventListener("input",()=>hm(t.value)),t.addEventListener("keydown",n=>{n.key==="ArrowDown"&&(n.preventDefault(),mm(1)),n.key==="ArrowUp"&&(n.preventDefault(),mm(-1)),n.key==="Enter"&&(n.preventDefault(),gw()),n.key==="Escape"&&Ts()}),e.addEventListener("click",n=>{n.target===e&&Ts()}))}function hm(e=""){let t=w("cmdkList");if(!t)return;let n=e.toLowerCase().trim(),s=hw(e);uo=n?[...s,...vr.filter(a=>a.label.toLowerCase().includes(n)||a.hint.toLowerCase().includes(n))]:[...s,...vr],Vn=0,t.innerHTML=uo.length?uo.map((a,o)=>`
        <button class="cmdk-item${o===0?" is-active":""}" data-index="${o}">
          <span class="cmdk-label">${y(a.label)}</span>
          <span class="cmdk-hint2">${y(a.hint)}</span>
        </button>`).join(""):'<div class="cmdk-section-label">No results</div>',t.querySelectorAll(".cmdk-item").forEach(a=>{a.addEventListener("click",()=>gm(Number(a.dataset.index)))})}function mm(e){var n,s,a;let t=Be("#cmdkList .cmdk-item");t.length&&((n=t[Vn])==null||n.classList.remove("is-active"),Vn=(Vn+e+t.length)%t.length,(s=t[Vn])==null||s.classList.add("is-active"),(a=t[Vn])==null||a.scrollIntoView({block:"nearest"}))}function gm(e){let t=uo[e];t&&(Ts(),t.action())}function gw(){gm(Vn)}var fo=!1;function br(){let e=X.currentPage,t=X.currentTab,n=e==="dashboard"&&t==="stream",s=e==="dashboard"&&t==="inspector",a=e==="dashboard"&&t==="network";Qp(n),yu(s),im(a)}function vm(){fo||(Yp(),bu(),om(),Ul(),br(),fo=!0)}window.openAuth=e=>No(e);window.closeAuth=()=>rn();window.showAuthView=e=>on(e);window.authKeydown=e=>ol(e);window.submitSignIn=()=>_o();window.submitSignUp=()=>Do();window.refreshCaptcha=()=>jr();window.showForgotView=()=>Jr();window.forgotRestoreFromFile=()=>Yr();window.forgotWipeConfirm=()=>Qr();window.forgotWipeExecute=()=>Zr();window.forgotBackToOptions=()=>el();window.submitSyncImport=()=>Io();window.exportVaultSyncCode=()=>tl();window.syncImportFromFile=()=>nl();window.signupNext=()=>Ro();window.signupBack=()=>Ur();window.logout=()=>sl();window.goHome=()=>Pn();window.showLandingPage=()=>Pn();window.showDashboard=()=>Mn();window.showProfile=()=>xo();window.switchTab=(e,t)=>Ln(e,t);window.runInspect=()=>ws();window.closeCommandPalette=()=>Ts();window.openCmdk=()=>mo();window.setTheme=e=>Cn(e);window.cycleTheme=()=>yo();window.measureLatency=()=>ia();window.switchProfileTab=e=>ii(e);window.openProfileEditor=()=>Rd();window.closeProfileEditor=()=>Bs();window.saveProfileEditor=()=>_d();window.selectAvatar=e=>Dd(e);window.selectBanner=e=>Id(e);window.uploadAvatarImage=e=>Fd(e);window.removeAvatarImage=()=>Od();window.uploadBannerImage=e=>Bd(e);window.removeBannerImage=()=>Xd();window.prefSetTheme=e=>op(e);window.setPrefCurrency=e=>ip(e);window.setPrefNetwork=e=>rp(e);window.setPrefAutoLock=e=>lp(e);window.openPublicProfilePreview=()=>ap();window.exportVaultBackup=()=>Hd();window.logActivity=(e,t)=>kt(e,t);window.toggleWalletDrawer=e=>Md(e);window.switchWalletDrawerTab=(e,t)=>Ld(e,t);window.cancelOffer=(e,t,n)=>Ed(e,t,n);window.fetchBalance=e=>Fn(e);window.setActiveWallet=e=>Gl(e);window.openImportAddressModal=()=>Qd();window.closeImportAddressModal=()=>wi();window.importWatchOnlyWallet=()=>Zd();window.openImportSeedModal=()=>ep();window.closeImportSeedModal=()=>xi();window.executeImportFromSeed=()=>tp();window.openTokenDetailsModal=(e,t,n)=>np(e,t,n);window.closeTokenDetailsModal=()=>sp();window.refreshXrplDashboard=()=>ts();window.refreshMarketData=()=>gd();window.refreshNftGallery=()=>vd();window.refreshAmmPools=()=>bd();window.refreshPoolExplorer=()=>yd();window.loadCustomAmmPool=()=>lc();window.sendNft=e=>wd(e);window.toggleSeedBackupStatus=()=>yc();window.setDexPair=e=>wc(e);window.setDexInterval=e=>xc(e);window.setDexChartType=e=>kc(e);window.refreshDexChart=()=>$c();window.setComparePair=e=>Fc(e);window.toggleIndicator=(e,t)=>Sc(e,t);window.toggleTerminalTheme=()=>Kc();window.toggleChartFullscreen=()=>Jc();window.exportChartPng=()=>Yc();window.saveChartLayoutPreset=()=>Zc();window.loadChartLayoutPreset=()=>ed();window.setIndicatorFromDropdown=e=>Oc(e);window.toggleIndicatorMenu=()=>Tc();window.toggleChartMoreMenu=()=>Cc();window.setIndicatorQuery=e=>Pc(e);window.addIndicatorFromMenu=e=>Mc(e);window.removeIndicator=e=>Lc(e);window.openIndicatorSettings=e=>Ac(e);window.closeIndicatorSettings=()=>Ec();window.applyIndicatorSettings=e=>Nc(e);window.resetIndicatorSettings=e=>Rc(e);window.copyChartLink=()=>_c();window.toggleThreeEffects=()=>Dc();window.setThreeEffects=e=>Ic(e);window.setDrawingTool=e=>Bc(e);window.clearAllDrawings=()=>zc();window.addPriceAlert=()=>Xc();window.removePriceAlert=e=>Hc(e);window.zoomChartIn=()=>Wc();window.zoomChartOut=()=>Uc();window.panChartLeft=()=>jc();window.panChartRight=()=>qc();window.toggleEducationPanel=()=>Vc();window.selectEducationTab=e=>Gc(e);window.searchTokens=e=>sd(e);window.lookupIssuedAsset=()=>mi();window.lookupAndAnalyzeProject=()=>fd();window.addTokenToWatchlist=e=>dd(e);window.removeTokenFromWatchlist=e=>pd(e);window.openTokenOnChart=e=>Da(e);window.loadToken=e=>ud(e);window.refreshTokenDiscovery=()=>md();window.refreshRecentTransactions=()=>hd();window.setTokenFilter=(e,t)=>ad(e,t);window.clearTokenFilters=()=>od();window.selectTokenDetails=e=>cd(e);window.openProjectIntel=e=>ci(e);window.jumpToProjectIntelLookup=()=>Jl();window.toggleProjectIntelSubScore=e=>Yl(e);window.copyProjectIntelForAi=()=>nc();window.closeProjectIntel=()=>Ql();window.showMoreIssuedTokens=()=>id();window.showAllIssuedTokens=()=>rd();window.resetIssuedTokenLimit=()=>ld();window.openWalletCreator=()=>bi();window.closeWalletCreator=()=>Xs();window.wizardNext=()=>zd();window.wizardBack=()=>Wd();window.selectAlgo=e=>Ud(e);window.selectWalletEmoji=e=>jd(e);window.selectWalletColor=e=>qd(e);window.toggleSecurityCheck=e=>Vd(e);window.revealSeed=()=>Kd();window.copySeed=()=>Jd();window.copyAddress=()=>Yd();window.copyToClipboard=e=>Hs(e);window.deleteWallet=e=>Cd(e);window.inspectWalletAddr=e=>Pd(e);window.openSocialModal=e=>kd(e);window.closeSocialModal=()=>os();window.saveSocialModal=()=>$d();window.deleteSocial=()=>Sd();window.viewSocial=e=>Td(e);window.connectXRPL=()=>import("./xrpl-6AERZ5KD.js").then(({connectXRPL:e})=>e());window._openAuth=No;window._goHome=Pn;window._cycleTheme=yo;window._showProfile=xo;window.startTour=()=>So();window.tourNext=()=>Hr();window.tourPrev=()=>zr();window.tourSkip=()=>fa();window.openHelp=()=>cp();window.closeHelp=()=>Oa();window.filterHelp=e=>$i(e);document.addEventListener("DOMContentLoaded",()=>{var e;console.log("\u{1F30A} NaluLF: booting\u2026"),Dr(),Pn(),dm(),pm(),um(),fm(),dp(),vw(),window.addEventListener("naluxrp:pagechange",t=>{var s;let n=(s=t==null?void 0:t.detail)==null?void 0:s.pageId;(n==="dashboard"||n==="inspector"||n==="profile")&&vm(),fo&&br()}),window.addEventListener("naluxrp:tabchange",()=>{fo&&br()}),document.addEventListener("keydown",t=>{var s;let n=["INPUT","TEXTAREA"].includes((s=document.activeElement)==null?void 0:s.tagName);if((t.ctrlKey||t.metaKey)&&t.key==="k"){t.preventDefault(),mo();return}if(t.key==="/"&&!n){t.preventDefault(),mo();return}t.key==="Escape"&&(Ts(),rn(),Bs(),Xs(),os(),fa(),Oa())}),(e=document.getElementById("auth-overlay"))==null||e.addEventListener("click",t=>{t.target===t.currentTarget&&rn()}),al()&&(vm(),Mn(),import("./xrpl-6AERZ5KD.js").then(({connectXRPL:t})=>t())),console.log("\u2705 NaluLF: ready")});function vw(){ym(),setInterval(()=>{document.hidden||ym()},3e4)}async function bm(e){let t=[s=>`https://corsproxy.io/?${encodeURIComponent(s)}`,s=>`https://api.allorigins.win/raw?url=${encodeURIComponent(s)}`],n=async s=>{let a=typeof(AbortSignal==null?void 0:AbortSignal.timeout)=="function"?AbortSignal.timeout(7e3):void 0,o=await fetch(s,{mode:"cors",cache:"no-store",signal:a});if(!o.ok)throw new Error(`HTTP ${o.status}`);return await o.json()};try{return await n(e)}catch{for(let s of t)try{return await n(s(e))}catch{}throw new Error("Price feed unreachable")}}async function ym(){try{let e=await bm("https://api.exchange.coinbase.com/products/XRP-USD/ticker"),t=await bm("https://api.exchange.coinbase.com/products/XRP-USD/candles?granularity=86400");if(e!=null&&e.price){let n=Number(e.price),s=Array.isArray(t)&&t.length?t[0]:null,a=s?Number(s[3]||n):n,o=a?(n-a)/a*100:0,i=document.getElementById("xrpPrice"),r=document.getElementById("xrpChange");if(i&&(i.textContent=`$${Number(n).toFixed(3)}`),r){let l=o>=0;r.textContent=`${l?"+":""}${Number(o).toFixed(2)}%`,r.className=`xrp-price-change ${Math.abs(o)<.1?"flat":l?"up":"down"}`}}}catch{}}
