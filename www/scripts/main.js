import{a as Ir,b as yo,c as Cn,d as It,e as w,f as Xe,g as y,h as He,i as _,j as z,k as Q,l as Z,m as bt,n as ge,o as ne,p as he,q as jt,r as X,s as fa,v as Ee,w as Fr}from"./chunk-R7KFE7J7.js";function Pn(e){Cn.includes(e)||(e="gold"),X.currentTheme=e,Cn.forEach(t=>document.body.classList.remove(`theme-${t}`)),document.body.classList.add(`theme-${e}`),Z(yo,e)}function wo(){let e=Cn.indexOf(X.currentTheme);Pn(Cn[(e+1)%Cn.length])}function Or(){let e=Q(yo);Pn(Cn.includes(e)?e:"gold")}var Br={landing:"landing-page",dashboard:"dashboard",inspector:"inspector",profile:"dashboard"};function xo(e){document.body.classList.remove("modal-open"),Object.values(Br).forEach(i=>document.body.classList.remove(i)),document.body.classList.add(Br[e]||"dashboard");let t=w("landing"),n=w("dashboard"),s=w("profile-page");t&&(t.style.display=e==="landing"?"":"none"),n&&(n.style.display=e==="dashboard"?"":"none"),s&&(s.style.display=e==="profile"?"":"none");let a=e==="landing",o={landingActions:w("navbar-landing-actions"),dashActions:w("navbar-dash-actions"),navConn:w("navbar-conn"),cmdkHint:w("cmdk-hint"),helpBtn:w("help-trigger")};o.landingActions&&(o.landingActions.style.display=a?"":"none"),o.dashActions&&(o.dashActions.style.display=a?"none":""),o.navConn&&(o.navConn.style.display=a?"none":""),o.cmdkHint&&(o.cmdkHint.style.display=a?"none":""),o.helpBtn&&(o.helpBtn.style.display=a?"none":""),X.currentPage=e,window.scrollTo({top:0,behavior:"smooth"}),window.dispatchEvent(new CustomEvent("naluxrp:pagechange",{detail:{pageId:e}}))}function Mn(){xo("landing")}function Ln(){xo("dashboard")}function ko(){xo("profile")}function An(e,t){Xe(".dash-tab").forEach(n=>{n.classList.toggle("active",n===e),n.setAttribute("aria-selected",String(n===e))}),["stream","inspector","network"].forEach(n=>{let s=w(`tab-${n}`);s&&(s.style.display=n===t?"":"none")}),t==="inspector"?(document.body.classList.remove("dashboard"),document.body.classList.add("inspector")):(document.body.classList.remove("inspector"),document.body.classList.add("dashboard")),X.currentTab=t,window.dispatchEvent(new CustomEvent("naluxrp:tabchange",{detail:{tabId:t}}))}var Hr="naluxrp_tour_seen",on=[{title:"Welcome to NaluLF \u{1F30A}",body:"A 20-second tour of the three things people miss most. Skip anytime."},{selector:"#cmdk-hint",title:"Jump anywhere, instantly",body:"Press <kbd>Ctrl</kbd>+<kbd>K</kbd> (or <kbd>/</kbd>) from any page. Paste an address in and it offers to inspect it directly \u2014 no need to navigate first."},{selector:"#dash-tab-inspector",title:"Inspect any wallet",body:"Full forensic suite \u2014 trust lines, fund flow, convergence signals, AI-assisted explanations \u2014 for any XRPL address, not just your own."},{selector:".user-chip",title:"Your Profile has more than wallets",body:"Portfolio analytics, activity history, and Project Intelligence \u2014 liquidity depth, holder concentration, and issuer-risk scoring for any token \u2014 all live there."}],st=0,So=!1,Ps=null,Ft=null;function zr(){Q(Hr)||setTimeout(To,700)}function To(){So||(So=!0,st=0,Sm(),Co())}function Sm(){if(w("tourOverlay"))return;let e=document.createElement("div");e.id="tourOverlay",e.className="tour-overlay",e.innerHTML='<div class="tour-card" id="tour-card"></div>',document.body.appendChild(e),e.addEventListener("click",t=>{t.target===e&&ha()})}function $o(e){if(!e)return null;let t=document.querySelector(e);if(!t)return null;let n=t.getBoundingClientRect();return n.width>0||n.height>0?t:null}function Wr(){Ps==null||Ps.classList.remove("tour-highlight"),Ps=null}function Co(){for(;st<on.length&&on[st].selector&&!$o(on[st].selector);)st++;if(st>=on.length)return Po();let e=on[st],t=w("tourOverlay"),n=w("tour-card");t.classList.add("show"),Wr();let s=$o(e.selector);s&&(s.scrollIntoView({block:"center",behavior:"smooth"}),s.classList.add("tour-highlight"),Ps=s),n.innerHTML=`
    ...
    </div>`}function U(){var h,b;let e=document.querySelector("#profile-page .profile-wrap");if(!e)return;let t=document.getElementById("xpd-tv-widget"),n=!!(t&&ee.chart);t&&t.remove();let s=document.getElementById("xpd-chart-atmosphere"),a=!!(s&&Ge.renderer);s&&s.remove();let o=Et(),i=(o==null?void 0:o.address)||"",r=vf(),l=localStorage.getItem(un),c=oe.some(x=>!x.watchOnly),u=Q(qo)==="1",p=(h=Ze[i])==null?void 0:h.xrp,d=Object.values(Ze).reduce((x,k)=>x+((k==null?void 0:k.xrp)||0),0),m=(b=Te.data)!=null&&b.priceUsd?d*Te.data.priceUsd:0,f=Fn.map(x=>`<option value="${y(x.id)}" ${M.pair===x.id?"selected":""}>${y(x.label)}</option>`).join(""),g=Fn.map(x=>`<option value="${y(x.id)}" ${M.comparePair===x.id?"selected":""}>${y(x.label)}</option>`).join(""),v=Ul.map(x=>`<option value="${y(x.value)}" ${M.interval===x.value?"selected":""}>${y(x.label)}</option>`).join("");if(e.innerHTML=`
        ...
        <aside class="xpd-profile-card" aria-label="Profile identity">
          ...
          <div class="xpd-profile-list">
            ...
            <div class="xpd-item-row">
              ...
              <span class="xpd-item-value">${Number.isFinite(p)?`${_(p,4)} XRP`:"\u2014"}</span>
            </div>
            <div class="xpd-item-row">
              ...
              <div class="xpd-chart-toolbar">
                ...
                <div class="xpd-toolbar-group">
                  ...
                  <select class="xpd-input" onchange="setDrawingTool(this.value)">
                    ${ql.map(x=>`<option value="${x.key}" ${M.drawingTool===x.key?"selected":""}>Draw: ${x.label}</option>`).join("")}
                  </select>
    ...
    </div>`,n){let x=document.getElementById("xpd-tv-widget");x&&x.replaceWith(t)}if(a){let x=document.getElementById("xpd-chart-atmosphere");x&&x.replaceWith(s)}wh(),Fh(),Oh(),hi(),Bs()}function vf(){let e=String(X.currentNetwork||"").toLowerCase();return e.includes("testnet")?{label:"XRPL Testnet",kind:"testnet"}:e.includes("mainnet")?{label:"XRPL Mainnet",kind:"mainnet"}:e.includes("xahau")?{label:"Xahau Network",kind:"xahau"}:{label:`Network: ${y(X.currentNetwork||"Unknown")}`,kind:"unknown"}}function yf(){let e=String(M.indicatorQuery||"").trim().toLowerCase(),t=[{key:"trend",label:"Trend",icon:"\u{1F4C8}"},{key:"momentum",label:"Momentum",icon:"\u26A1"},{key:"volume",label:"Volume",icon:"\u{1F4CA}"},{key:"volatility",label:"Volatility",icon:"\u{1F32A}\uFE0F"},{key:"advanced",label:"Custom",icon:"\u{1F9E0}"}];return`
    <div class="xpd-indicator-menu-wrap">
      ...
      ${M.indicatorMenuOpen?`
        <div class="xpd-indicator-menu" role="menu" aria-label="Indicator menu">
          ...
          ${t.map(n=>{let s=(rf[n.key]||[]).filter(a=>{var i;return e?(((i=Vt[a])==null?void 0:i.name)||a).toLowerCase().includes(e):!0});return s.length?`
      ...
      `:""}
    </div>`}function wf(){var m;let e=M.stats,t=((m=X.wsConn)==null?void 0:m.readyState)===1,n=M.chartMeta||{},s=Object.entries(M.indicators).filter(([,f])=>!!f).map(([f])=>f),a=String(M.tokenFocusKey||""),o=a.includes("|")?a.split("|")[0]:a,i=j.tokens.find(f=>qe(f)===a)||j.tokens.find(f=>String(f.symbol||"").toUpperCase()===String(o||"").toUpperCase())||null,r=!!i&&String(i.symbol||"").toUpperCase()!=="XRP"&&Number.isFinite(Number(i.price||0)),l=Number.isFinite(Number(n.last))?Number(n.last):r?Number(i.price||0):e==null?void 0:e.price,c=Number.isFinite(Number(n.high))?Number(n.high):e==null?void 0:e.high,u=Number.isFinite(Number(n.low))?Number(n.low):e==null?void 0:e.low,p=i?`${String(i.symbol||"").toUpperCase()}${i.issuer?` \xB7 ${i.issuer.slice(0,10)}...`:""}`:String(n.symbol||"XRP").toUpperCase(),d=String(n.source||(r?"Coinbase + token proxy":(e==null?void 0:e.source)||"Source pending"));return`
    ...
    ${(()=>{let f=Ra(),g=(M.alerts||[]).filter(v=>v.tokenKey===f);return g.length?`
      <div class="xpd-indicator-row">
        ${g.map(v=>`
    ...
    <div class="xpd-chart-wrap">
      <div class="xpd-chart-active-head">
        <div class="xpd-chart-active-left">
          ...
          <strong class="xpd-chart-active-token" title="${y(p)}">${y(p)}</strong>
        </div>
    ...
    <p class="xpd-note">Professional chart controls: wheel zoom, hold-and-drag pan, horizontal price-line marking, and token-focused context ribbons for faster execution decisions.</p>`}function xf(){let e=M.selectedIndicator||"sma20",t=Vt[e]||Vt.sma20,n=lf[e]||null,s=M.educationCollapsed;return`
    <div class="xpd-edu-panel ${s?"collapsed":""}">
      ...
      ${s?"":`
        ...
        `:""}
      `}
    </div>`}function ct(e,t){return`<div class="xpd-edu-row"><span class="xpd-edu-label">${y(e)}</span><span class="xpd-edu-value">${y(t)}</span></div>`}function kf(){if(Te.loading)return'<div class="xpd-loading">Loading XRP market snapshot...</div>';if(Te.error)return`<div class="xpd-error">${y(Te.error)}</div>`;let e=Te.data;if(!e)return'<div class="xpd-empty">Market data is not available yet.</div>';let t=e.change24h>=0;return`
    ...
    <div class="xpd-token-strip">
      ${of.map(n=>`<div class="xpd-token-pill" title="${y(`${n.symbol} ${n.name}`)}"><span class="sym xpd-pill-text">${n.symbol}</span><span class="xpd-pill-text">${y(n.name)}</span><span class="cap xpd-pill-text">${n.marketCap}</span></div>`).join("")}
    </div>
    <p class="xpd-note">Top XRPL token cards are static examples when direct DEX market-cap feeds are unavailable.</p>`}function $f(e){return e?vt.loading?'<div class="xpd-loading">Loading account NFTs...</div>':vt.error?`<div class="xpd-error">${y(vt.error)}</div>`:vt.items.length?`<div class="xpd-nft-grid">${vt.items.map(Sf).join("")}</div>`:'<div class="xpd-empty">No NFTs found for this wallet.</div>':'<div class="xpd-empty">Select or create a wallet to load NFTs.</div>'}function Sf(e){let t=`${e.id.slice(0,12)}...${e.id.slice(-10)}`;return`<article class="xpd-nft-card">
  ...
  </article>`}function Tf(e){let t=Rf(e),n=_f(),s=Df();return`<div class="xpd-amm-columns">${t}${n}${s}</div>`}function ci(){return(ge(Q(zl))||[]).filter(Boolean)}function Ql(e){let t=[...new Set((e||[]).filter(Boolean))];Z(zl,JSON.stringify(t))}function Cf(e,t){return t.has(e)?t.get(e):j.tokens.find(s=>s.symbol===e)||null}function Pf(){let e=j.query||"",t=ci(),n=j.filtered,s=Math.max(120,Number(j.listLimit||240)),a=n.slice(0,s),o=j.trending.slice(0,14),i=new Map(j.tokens.map(c=>[qe(c),c])),r=i.get(j.selectedTokenKey)||null,l=j.filters||{type:"all",minCap:0,minVol:0,hasDex:!1};return`
    <div class="xpd-token-grid">
      <div class="xpd-token-col">
        <div class="xpd-search-row">
          ...
          <div class="xpd-note">Loaded ${Ue(j.total||n.length)} issued tokens \xB7 showing ${Ue(a.length)} of ${Ue(n.length)}${j.lastSyncAt?` \xB7 synced ${new Date(j.lastSyncAt).toLocaleTimeString()}`:""}</div>
        ...
        <div class="xpd-token-list">${a.map(c=>{let u=qe(c),p=Ms(u),d=String(e||"").trim();return`
          <div class="xpd-token-row xpd-token-row--clickable" title="${y(`${c.symbol} ${c.name}`)}" onclick="openTokenOnChart(decodeURIComponent('${p}'))">
            <div class="xpd-token-main">
              <strong>${Sl(c.symbol,d)}</strong>
              <span>${Sl(c.name,d)}</span>
            ...
            <div class="xpd-token-actions">
              ...
              <button class="xpd-mini-btn" onclick="event.stopPropagation(); addTokenToWatchlist(decodeURIComponent('${p}'))">Watch</button>
              <button class="xpd-mini-btn" onclick="event.stopPropagation(); openTokenOnChart(decodeURIComponent('${p}'))">Chart</button>
              <button class="xpd-mini-btn" onclick="event.stopPropagation(); selectTokenDetails(decodeURIComponent('${p}'))">Details</button>
              ${c.issuer?`<button class="xpd-mini-btn xpd-mini-btn--accent" onclick="event.stopPropagation(); openProjectIntel(decodeURIComponent('${p}'))" title="Project Strength \u2014 liquidity depth, holder/LP concentration, issuer risk">\u{1F52C} Strength</button>`:""}
            </div>
          </div>`}).join("")}</div>
      </div>
      <div class="xpd-token-col">
        ${r?`<div class="xpd-token-detail-card">
          ...
          <div class="xpd-row-actions">
            <button class="xpd-mini-btn" onclick="openTokenOnChart(decodeURIComponent('${Ms(qe(r))}'))">Switch Main Chart</button>
            ${r.issuer?`<button class="xpd-mini-btn" onclick="window.open('https://xrpscan.com/account/${y(r.issuer)}','_blank')">View Issuer</button>`:""}
            ${r.issuer?`<button class="xpd-mini-btn xpd-mini-btn--accent" onclick="openProjectIntel(decodeURIComponent('${Ms(qe(r))}'))">\u{1F52C} Project Strength</button>`:""}
          </div>
        </div>`:""}
        <h3>Watchlist</h3>
        <div class="xpd-watchlist">${t.length?t.map(c=>{let u=Cf(c,i),p=u?`${u.symbol} \xB7 ${u.name}`:c,d=(u==null?void 0:u.price)!=null?`$${_(u.price,6)}`:"\u2014",m=Ms(c);return`<div class="xpd-token-row xpd-token-row--clickable" onclick="openTokenOnChart(decodeURIComponent('${m}'))"><span>${y(p)}</span><div class="xpd-token-actions"><span>${d}</span><button class="xpd-mini-btn" onclick="event.stopPropagation(); openTokenOnChart(decodeURIComponent('${m}'))">Chart</button><button class="xpd-mini-btn" onclick="event.stopPropagation(); removeTokenFromWatchlist(decodeURIComponent('${m}'))">Remove</button></div></div>`}).join(""):'<div class="xpd-empty">No watchlist tokens yet.</div>'}</div>
        <h3>Trending</h3>
        <div class="xpd-watchlist">${o.length?o.map(c=>`<div class="xpd-token-row xpd-token-row--clickable" onclick="openTokenOnChart(decodeURIComponent('${Ms(qe(c))}'))"><span>${y(c.symbol)} \xB7 ${y(c.name)}</span><span>${c.volume24h!=null?`$${Ue(c.volume24h)} vol`:c.marketCap!=null?`$${Ue(c.marketCap)} mcap`:"\u2014"}</span></div>`).join(""):'<div class="xpd-empty">No trending data.</div>'}</div>
      </div>
    </div>`}function Zl(){let e=document.getElementById("xpd-lookup-currency");if(!e){he("Token Discovery hasn't loaded yet \u2014 give it a moment and try again.");return}e.scrollIntoView({behavior:"smooth",block:"center"}),setTimeout(()=>e.focus(),350)}async function di(e){let t=String(e||"").trim();if(!t)return;let n=t.includes("|")?j.tokens.find(s=>qe(s)===t):j.tokens.find(s=>String(s.symbol||"").toUpperCase()===t.toUpperCase());if(!(n!=null&&n.issuer)){he("Project Intelligence needs a token with a known issuer.");return}Qe={loading:!0,error:"",data:null,tokenKey:qe(n),expandedSubScore:""},U(),setTimeout(()=>{var s;return(s=document.getElementById("xpd-project-intel-section"))==null?void 0:s.scrollIntoView({behavior:"smooth",block:"start"})},30);try{Qe={loading:!1,error:"",data:await hl(n),tokenKey:qe(n),expandedSubScore:""}}catch(s){Qe={loading:!1,error:(s==null?void 0:s.message)||"Could not load project intelligence.",data:null,tokenKey:qe(n),expandedSubScore:""}}U()}function ec(e){Qe.expandedSubScore=Qe.expandedSubScore===e?"":e,U()}function tc(){Qe={loading:!1,error:"",data:null,tokenKey:"",expandedSubScore:""},U()}var nc={liquidity:{label:"Liquidity",icon:"\u{1F4A7}"},distribution:{label:"Distribution",icon:"\u{1F9EE}"},marketQuality:{label:"Market Quality",icon:"\u{1F4CA}"},lpStability:{label:"LP Stability",icon:"\u{1F3E6}"},issuerRisk:{label:"Issuer Risk",icon:"\u{1F6E1}"}};function zo(e){return e>=75?"#50fa7b":e>=50?"#f1fa8c":e>=25?"#ffb86c":"#ff5555"}function sc(e){return e>=75?"STRONG":e>=50?"MODERATE":e>=25?"WEAK":"VERY WEAK"}function Mf(){if(Qe.loading)return`<div class="xpd-section-head"><h2>\u{1F52C} Project Intelligence</h2></div>
      ...
      <div class="xpd-error">${y(Qe.error)}</div>`;let e=Qe.data;if(!e)return"";let t=e.strength,n=zo(t.overall),s=t.dimensionsLive.map(a=>{let o=nc[a],i=t.subScores[a],r=Qe.expandedSubScore===a;return`
      <div class="pi-subscore ${r?"pi-subscore--open":""}" onclick="toggleProjectIntelSubScore('${a}')">
        <div class="pi-subscore-row">
          ...
          <span class="pi-subscore-val" style="color:${zo(i.score)}">${i.score}</span>
        </div>
        <div class="pi-subscore-bar"><div class="pi-subscore-fill" style="width:${i.score}%;background:${zo(i.score)}"></div></div>
        ${r?`<div class="pi-subscore-detail">${Object.entries(i.inputs).map(([l,c])=>`
          <div class="pi-kv"><span>${y(pi(l))}</span><span class="mono">${y(ac(c))}</span></div>
        `).join("")}</div>`:""}
      </div>`}).join("");return`
    <div class="xpd-section-head">
    ...
    <div class="pi-header-card">
      ...
      <div class="pi-score-word" style="color:${n}">${sc(t.overall)}</div>
    ...
    <div class="pi-cards-grid">
      ${Lf(e)}
      ${xl("Holder Concentration",e.holders,"\u{1F465}")}
      ${xl("LP Token Concentration",e.lp,"\u{1F3E6}")}
      ${Af(e.issuerRisk)}
    </div>`}function pi(e){return e.replace(/([A-Z])/g," $1").replace(/^./,t=>t.toUpperCase()).trim()}function ac(e){return e==null?"\u2014":typeof e=="boolean"?e?"Yes":"No":typeof e=="number"?Number.isInteger(e)?String(e):_(e,2):String(e)}function Lf(e){var i;let t=e.amm,n=e.orderBook,s=t!=null&&t.exists?`
  ...
  `:'<div class="inspect-empty-note">No live order book found for this pair.</div>';return`
    <div class="sec-card pi-card">
      ...
      <hr class="pi-hr" />
      ${o}
    </div>`}function xl(e,t,n){if(!(t!=null&&t.exists))return`
    <div class="sec-card pi-card">
    ...
    <div class="finding finding--${s?a?"ok":"warn":"ok"}">
      ...
      <div class="finding-body">
        <div class="finding-label">${pi(n)}</div>
    ...
    </div>`}function oc(){let e=Qe.data;e&&Fa(Ef(e))}function kl(e,t){if(!(e!=null&&e.length))return"";let n=e.map(s=>`    ${s.pct}% impact: ${_(s.xrpAtOffer,1)} XRP / ${Ue(s.tokenAtOffer)} tokens${s.bookExhausted?" (book exhausted before this level \u2014 real depth may be less than shown)":""}`).join(`
`);return`  ${t}:
${n}`}function $l(e,t){let n=[`${e}:`];return t!=null&&t.exists?(n.push(`  Holder count: ${t.holderCount}${t.sampleOnly?" (sampled, capped)":""}`),n.push(`  Top 1 holds: ${_(t.top1Pct,1)}%`),n.push(`  Top 5 hold: ${_(t.top5Pct,1)}%`),n.push(`  Top 10 hold: ${_(t.top10Pct,1)}%`),(t.topHolders||[]).slice(0,10).forEach((s,a)=>{let o=t.totalSampled>0?_(s.balance/t.totalSampled*100,2):"0.00";n.push(`    #${a+1} ${s.address}: ${Ue(s.balance)} (${o}%)`)}),n.join(`
`)):(n.push("  No data found."),n.join(`
`))}function Ef(e){var i;let t=e.strength,n=e.amm,s=e.orderBook,a=e.issuerRisk,o=[];if(o.push(`XRPL TOKEN ANALYSIS \u2014 ${e.token.symbol}${e.token.name?` (${e.token.name})`:""}`),o.push(`Issuer: ${e.token.issuer}`),o.push(`Currency code: ${e.token.currency}`),o.push(`Snapshot taken: ${new Date(e.fetchedAt).toISOString()}`),o.push(""),o.push(`OVERALL STRENGTH SCORE: ${t.overall}/100 (${sc(t.overall)})`),o.push("Methodology note: this score covers only 5 point-in-time-computable dimensions (Liquidity, Distribution, Market Quality, LP Stability, Issuer Risk). Network Activity, Treasury Health, and Project Transparency are NOT included \u2014 they would require historical tracking this tool does not do."),o.push(""),o.push("SUB-SCORES:"),t.dimensionsLive.forEach(r=>{let l=nc[r],c=t.subScores[r];o.push(`- ${l.label}: ${c.score}/100`),Object.entries(c.inputs||{}).forEach(([u,p])=>{o.push(`    ${pi(u)}: ${ac(p)}`)})}),o.push(""),o.push("LIQUIDITY \u2014 AMM POOL:"),n!=null&&n.exists?(o.push(`  XRP reserve: ${_(n.xrpReserve,2)}`),o.push(`  Token reserve: ${_(n.tokenReserve,2)}`),o.push(`  LP token supply: ${_(n.lpSupply,2)}`),o.push(`  Trading fee: ${_(n.tradingFeePct,3)}%`),n.auctionSlot&&o.push(`  Auction slot discounted fee: ${_(n.auctionSlot.discountedFeePct,3)}%`),(i=n.voteSlots)!=null&&i.length&&o.push(`  Fee-vote participants: ${n.voteSlots.length}`)):o.push("  No AMM pool found for this pair."),o.push(""),o.push("LIQUIDITY \u2014 LIVE ORDER BOOK (DEX):"),s!=null&&s.exists){o.push(`  Buy price: ${_(s.buyPriceXrp,6)} XRP`),o.push(`  Sell price: ${_(s.sellPriceXrp,6)} XRP`),o.push(`  Spread: ${s.spreadPct!=null?_(s.spreadPct,2)+"%":"\u2014"}`);let r=kl(s.buyDepth,"Depth buying with XRP"),l=kl(s.sellDepth,"Depth selling for XRP");r&&o.push(r),l&&o.push(l)}else o.push("  No live order book found for this pair.");return o.push(""),o.push($l("HOLDER CONCENTRATION",e.holders)),o.push(""),o.push($l("LP TOKEN CONCENTRATION",e.lp)),o.push(""),o.push("ISSUER RISK FLAGS:"),a!=null&&a.exists?(o.push(`  Clawback enabled: ${a.clawbackEnabled?"YES":"No"} \u2014 ${xt.clawbackEnabled}`),o.push(`  Global freeze active: ${a.globalFreeze?"YES":"No"} \u2014 ${xt.globalFreeze}`),o.push(`  Freeze-capable: ${a.freezeCapable?"YES":"No"} \u2014 ${xt.freezeCapable}`),o.push(`  Requires auth to hold: ${a.requireAuth?"YES":"No"} \u2014 ${xt.requireAuth}`),o.push(`  Issuer blackholed: ${a.blackholed?"YES":"No"} \u2014 ${xt.blackholed}`)):o.push("  Could not load issuer account state."),o.push(""),o.push("---"),o.push("Please analyze this XRPL token's on-chain data above. Explain in plain language what these metrics suggest about the token's liquidity health, holder/LP concentration risk, and issuer-side control risk. Point out anything that looks like a red flag or an unusually strong/weak signal, and note any limits in what this data can and can't tell me (e.g. it's a point-in-time snapshot, not history)."),o.join(`
`)}function Sl(e,t){let n=String(e||""),s=String(t||"").trim();if(!s)return y(n);let a=n.toLowerCase().indexOf(s.toLowerCase());if(a<0)return y(n);let o=y(n.slice(0,a)),i=y(n.slice(a,a+s.length)),r=y(n.slice(a+s.length));return`${o}<mark class="xpd-hit">${i}</mark>${r}`}function Nf(e){var a,o;let t=Object.values(Ze).reduce((i,r)=>i+((r==null?void 0:r.xrp)||0),0),n=(a=Te.data)!=null&&a.priceUsd?t*Te.data.priceUsd:0,s=Pt.items.slice(0,8);return`
    <div class="xpd-token-grid">
      <div class="xpd-token-col">
        <div class="xpd-market-grid">
    ...
    </div>`}function Rf(e){return e?yt.loading?'<div class="xpd-amm-card"><h3>Your liquidity positions</h3><div class="xpd-loading">Loading account_objects and LP balances...</div></div>':yt.error?`<div class="xpd-amm-card"><h3>Your liquidity positions</h3><div class="xpd-error">${y(yt.error)}</div></div>`:yt.pools.length?`<div class="xpd-amm-card"><h3>Your liquidity positions</h3><div class="xpd-pool-list">${yt.pools.map(t=>`
    ...
    </div>`).join("")}</div></div>`:'<div class="xpd-amm-card"><h3>Your liquidity positions</h3><div class="xpd-empty">No AMM entries or LP-token balances detected for this wallet yet.</div></div>':'<div class="xpd-amm-card"><h3>Your liquidity positions</h3><div class="xpd-empty">No active wallet.</div></div>'}function _f(){return Mt.loading?'<div class="xpd-amm-card"><h3>General pool explorer</h3><div class="xpd-loading">Loading amm_info for known pools...</div></div>':Mt.error?`<div class="xpd-amm-card"><h3>General pool explorer</h3><div class="xpd-error">${y(Mt.error)}</div></div>`:Mt.pools.length?`<div class="xpd-amm-card"><h3>General pool explorer</h3><div class="xpd-pool-list">${Mt.pools.map(e=>`
    <div class="xpd-pool-item">
    ...
    </div>`).join("")}</div></div>`:'<div class="xpd-amm-card"><h3>General pool explorer</h3><div class="xpd-empty">No seeded pools returned on this network.</div></div>'}function Df(){return`<div class="xpd-amm-card">
  ...
  </div>`}function Ue(e){return Number.isFinite(Number(e))?new Intl.NumberFormat("en-US",{notation:"compact",maximumFractionDigits:2}).format(Number(e)):"\u2014"}function ss(e){return typeof e=="string"?`${_(Number(e)/1e6,4)} XRP`:e&&typeof e=="object"?`${_(Number(e.value||0),4)} ${e.currency||"UNK"}`:"\u2014"}function If(e){if(!e||typeof e!="string")return"";try{let t=e.trim();if(!/^[0-9A-Fa-f]+$/.test(t)||t.length%2!==0)return t;let n=new Uint8Array(t.length/2);for(let s=0;s<t.length;s+=2)n[s/2]=parseInt(t.slice(s,s+2),16);return new TextDecoder().decode(n)}catch{return""}}function Tl(e){return e?e.startsWith("ipfs://")?`https://ipfs.io/ipfs/${e.slice(7)}`:e.startsWith("ar://")?`https://arweave.net/${e.slice(5)}`:e:""}async function Ff(e){let t=Tl(If(e.URI||e.uri||""));if(!t)return"";if(/\.(png|jpg|jpeg|gif|webp|svg)$/i.test(t))return t;try{let n=await fetch(t,{method:"GET"});if(!n.ok)return"";let s=await n.json(),a=(s==null?void 0:s.image)||(s==null?void 0:s.image_url)||(s==null?void 0:s.thumbnail);return Tl(a||"")}catch{return""}}async function Lt(e,{timeoutMs:t=9e3,allowProxy:n=!0}={}){let s=async a=>{let o=typeof(AbortSignal==null?void 0:AbortSignal.timeout)=="function"?AbortSignal.timeout(t):void 0,i=await fetch(a,{method:"GET",mode:"cors",cache:"no-store",signal:o});if(!i.ok)throw new Error(`HTTP ${i.status}`);return await i.json()};try{return await s(e)}catch(a){if(!n)throw a;for(let o of Wm)try{return await s(o(e))}catch{}throw a}}async function ic(){var e;Te.loading=!0,Te.error="",U();try{let t=await Lt("https://api.exchange.coinbase.com/products/XRP-USD/ticker"),n=await Lt("https://api.exchange.coinbase.com/products/XRP-USD/candles?granularity=86400"),s=Array.isArray(n)&&n.length?n[0]:null,a=Number((t==null?void 0:t.price)||0),o=s?Number(s[3]||0):a,i=s?Number(s[2]||a):a,r=s?Number(s[1]||a):a,l=s?Number(s[5]||0):0;Te.data={priceUsd:a,change24h:o?(a-o)/o*100:0,volume24h:l*a,marketCap:Number(((e=Te.data)==null?void 0:e.marketCap)||0),high24h:i,low24h:r}}catch(t){Te.error=(t==null?void 0:t.message)||"Could not load market data right now.",Te.data=null}finally{Te.loading=!1,U()}}async function rc(e){if(vt.loading=!0,vt.error="",vt.items=[],U(),!e){vt.loading=!1,U();return}try{let t,n=[];do{let a=await at({method:"account_nfts",params:[{account:e,limit:100,...t?{marker:t}:{}}]});n.push(...(a==null?void 0:a.account_nfts)||[]),t=a==null?void 0:a.marker}while(t);let s=await Promise.all(n.slice(0,80).map(async a=>({id:a.NFTokenID||a.nf_token_id||"Unknown",image:await Ff(a)})));vt.items=s}catch(t){vt.error=(t==null?void 0:t.message)||"Could not load NFTs for this wallet."}finally{vt.loading=!1,U()}}async function lc(e){if(yt.loading=!0,yt.error="",yt.pools=[],U(),!e){yt.loading=!1,U();return}try{let t=[],n;do{let o=await at({method:"account_objects",params:[{account:e,type:"amm",limit:200,...n?{marker:n}:{}}]});((o==null?void 0:o.account_objects)||[]).forEach(r=>{let l=ss(r.Asset||r.amount),c=ss(r.Asset2||r.amount2),u=l.split(" ").pop()||"AssetA",p=c.split(" ").pop()||"AssetB";t.push({pair:`${u}/${p}`,lpBalance:r.LPTokenBalance?ss(r.LPTokenBalance):"Not reported",estimatedValue:"Estimate unavailable",tradingFee:r.TradingFee!=null?`${r.TradingFee} bps`:"\u2014",tvl:"Unavailable"})}),n=o==null?void 0:o.marker}while(n);let s=await at({method:"account_lines",params:[{account:e,limit:200}]});((s==null?void 0:s.lines)||[]).filter(o=>typeof o.currency=="string"&&o.currency.length>=16&&Number(o.balance)>0).forEach(o=>{t.push({pair:`LP Token ${o.currency.slice(0,8)}...`,lpBalance:`${_(Number(o.balance),4)} ${o.currency.slice(0,8)}...`,estimatedValue:"Estimate unavailable",tradingFee:"\u2014",tvl:"Unavailable"})}),yt.pools=t}catch(t){yt.error=(t==null?void 0:t.message)||"Could not load account AMM objects."}finally{yt.loading=!1,U()}}async function cc(e){try{let t=await at({method:"amm_info",params:[{asset:e.asset,asset2:e.asset2}]}),n=t==null?void 0:t.amm;return n?{label:e.label,reserveA:ss(n.amount),reserveB:ss(n.amount2),tradingFee:String(n.trading_fee??"\u2014"),totalLp:ss(n.lp_token||n.lp_token_balance),tvl:Of(n.amount,n.amount2)}:null}catch{return null}}function Of(e,t){let n=a=>typeof a=="string"?Number(a)/1e6:a&&typeof a=="object"?Number(a.value||0):0,s=n(e)+n(t);return!Number.isFinite(s)||s<=0?"Unavailable":`${_(s,4)} (asset units)`}async function dc(){Mt.loading=!0,Mt.error="",U();try{let e=await Promise.all(df.map(cc));Mt.pools=e.filter(Boolean)}catch(e){Mt.error=(e==null?void 0:e.message)||"Could not load AMM explorer data.",Mt.pools=[]}finally{Mt.loading=!1,U()}}async function pc(){var r,l,c,u;let e=(((r=document.getElementById("xpd-asset1-currency"))==null?void 0:r.value)||"").trim().toUpperCase(),t=(((l=document.getElementById("xpd-asset1-issuer"))==null?void 0:l.value)||"").trim(),n=(((c=document.getElementById("xpd-asset2-currency"))==null?void 0:c.value)||"").trim().toUpperCase(),s=(((u=document.getElementById("xpd-asset2-issuer"))==null?void 0:u.value)||"").trim();if(!e||!n){Fe.error="Enter both asset currency codes first.",U();return}let a=e==="XRP"?{currency:"XRP"}:{currency:e,issuer:t},o=n==="XRP"?{currency:"XRP"}:{currency:n,issuer:s};if(e!=="XRP"&&!t||n!=="XRP"&&!s){Fe.error="Issuer is required for non-XRP assets.",U();return}Fe.loading=!0,Fe.error="",Fe.pool=null,U();let i=await cc({label:`${e}/${n}`,asset:a,asset2:o});Fe.loading=!1,i?Fe.pool=i:Fe.error="Pool not found or unavailable on this network.",U()}function Na(){return Fn.find(e=>e.id===M.pair)||Fn[0]}function ui(e){if(e==="D")return 1440;if(e==="W")return 10080;if(e==="M")return 43200;let t=Number(e);return Number.isFinite(t)&&t>0?t:60}function Bf(e){if(e==="M")return"W";if(e==="D"||e==="W")return e;let t=ui(e);for(let n of[5,15,60,240])if(t<=n)return String(n);return"D"}async function Xf(e,t,n,s=200){var u;let a=t?`${e}.${t}`:e,o=Bf(n),i=Math.min(2e3,Math.max(20,Number(s)||200)),r=`https://api.onthedex.live/public/v1/ohlc?base=${encodeURIComponent(a)}&quote=XRP&interval=${o}&bars=${i}`,l=await Lt(r,{timeoutMs:1e4});return(Array.isArray((u=l==null?void 0:l.data)==null?void 0:u.ohlc)?l.data.ohlc:[]).map(p=>({time:Number(p.t),open:Number(p.o),high:Number(p.h),low:Number(p.l),close:Number(p.c),volume:Number(p.vb||0)})).filter(p=>Number.isFinite(p.time)&&[p.open,p.high,p.low,p.close].every(Number.isFinite)).sort((p,d)=>p.time-d.time)}function uc(e){return{xrpusd:"XRP-USD",XRPUSDT:"XRP-USD",ETHUSDT:"ETH-USD",BTCUSDT:"BTC-USD",SOLUSDT:"SOL-USD"}[e]||null}function Hf(e){return{XRP:"XRP-USD",BTC:"BTC-USD",ETH:"ETH-USD",SOL:"SOL-USD",USDC:"USDC-USD"}[String(e||"").toUpperCase()]||null}var Wo=new Map;async function zf(e,t){if(!e)return null;let n=`${qe(e)}:${t}`,s=Wo.get(n);if(s)return s;let a=Wf(e,t);Wo.set(n,a);try{return await a}finally{Wo.delete(n)}}async function Wf(e,t){var o,i;let n=String(e.symbol||"").toUpperCase();if(!n||n==="XRP")return null;let s=Hf(n);if(s)try{let r=hc(t),l=r===86400?Xl:Hl,{candles:c,reachedStart:u}=await Qo(s,r,l);if(c.length){let p=u?`${new Date(c[0].time*1e3).getUTCFullYear()}\u2013present`:`last ${c.length} bars`;return{candles:c,source:`Coinbase direct (${s}, ${p})`,mode:"token-direct"}}}catch{}let a=String(e.issuer||"").trim();if(a)try{let r=await Xf(n,a,t,2e3);if(r.length){let l=Number(((o=M.stats)==null?void 0:o.xrplSpot)||((i=M.stats)==null?void 0:i.price)||0);return{candles:l>0?r.map(u=>({time:u.time,open:u.open*l,high:u.high*l,low:u.low*l,close:u.close*l,volume:u.volume})):r,source:`OnTheDex XRPL DEX (${n}/XRP)`,mode:"token-direct"}}}catch{}return null}function jf(e,{mode:t="pair",source:n="Source pending",tokenKey:s=""}={}){let a=Array.isArray(e)?e:[];if(!a.length){M.chartMeta={tokenKey:s||M.tokenFocusKey||"XRP|",symbol:s&&s.split("|")[0]||"XRP",source:n,last:null,high:null,low:null,mode:t};return}let o=a[a.length-1],i=a.map(c=>Number(c.high)).filter(c=>Number.isFinite(c)),r=a.map(c=>Number(c.low)).filter(c=>Number.isFinite(c)),l=s||M.tokenFocusKey||"XRP|";M.chartMeta={tokenKey:l,symbol:l.split("|")[0]||"XRP",source:n,last:Number(o.close),high:i.length?Math.max(...i):Number(o.high),low:r.length?Math.min(...r):Number(o.low),mode:t}}async function Fs(){var t;let e=Na();M.loading=!0,M.error="";try{let n=uc(e.ticker);if(n){let s=await Lt(`https://api.exchange.coinbase.com/products/${n}/ticker`),a=await Lt(`https://api.exchange.coinbase.com/products/${n}/candles?granularity=86400`),o=Array.isArray(a)&&a.length?a[0]:null,i=Number(s.price||0),r=o?Number(o[3]):i;M.stats={price:i,high:o?Number(o[2]):i,low:o?Number(o[1]):i,changePct:r?(i-r)/r*100:0,baseSource:"Coinbase",source:"Coinbase"},await mc(),!Te.data&&M.stats.price&&(Te.data={priceUsd:M.stats.price,change24h:M.stats.changePct,volume24h:o?Number(o[5]||0)*M.stats.price:0,marketCap:Number(((t=Te.data)==null?void 0:t.marketCap)||0)});return}throw new Error("Chart stats unavailable for selected pair.")}catch(n){M.error=(n==null?void 0:n.message)||"DEX chart stats unavailable right now."}finally{M.loading=!1}}async function mc(){var e,t,n;try{let s=await at({method:"book_offers",params:[{taker_gets:{currency:"USD",issuer:"rhub8VRN55s94qWKDv6jmDy1pUykJzF3wq"},taker_pays:{currency:"XRP"},limit:1}]}),a=(e=s==null?void 0:s.offers)==null?void 0:e[0];if(!a)return;let o=Number(((t=a.TakerGets)==null?void 0:t.value)||0),i=typeof a.TakerPays=="string"?Number(a.TakerPays)/1e6:Number(((n=a.TakerPays)==null?void 0:n.value)||0);if(o>0&&i>0){let r=o/i;if(Bl=Date.now(),M.stats||(M.stats={}),M.stats.xrplSpot=r,String(Na().symbol||"XRP").toUpperCase()==="XRP"){M.stats.price=r;let l=M.stats.baseSource||M.stats.source||"Market feed";M.stats.source=`${l} + XRPL live`,Te.data&&(Te.data.priceUsd=r)}}}catch{}}async function Uf(){var e,t;return(e=window.LightweightCharts)!=null&&e.createChart?!0:($a||($a=new Promise((n,s)=>{let a=document.querySelector('script[data-lw-chart="1"]');if(a){a.addEventListener("load",()=>n(!0),{once:!0}),a.addEventListener("error",()=>s(new Error("Chart library failed to load.")),{once:!0});return}let o=document.createElement("script");o.src="https://unpkg.com/lightweight-charts@4.2.2/dist/lightweight-charts.standalone.production.js",o.async=!0,o.defer=!0,o.dataset.lwChart="1",o.onload=()=>n(!0),o.onerror=()=>s(new Error("Chart library failed to load.")),document.head.appendChild(o)}).finally(()=>{var n;(n=window.LightweightCharts)!=null&&n.createChart||($a=null)})),await $a,!!((t=window.LightweightCharts)!=null&&t.createChart))}async function qf(){var e,t;return(e=window.THREE)!=null&&e.Scene?!0:(Sa||(Sa=new Promise((n,s)=>{let a=document.querySelector('script[data-three-chart="1"]');if(a){a.addEventListener("load",()=>n(!0),{once:!0}),a.addEventListener("error",()=>s(new Error("Three.js failed to load.")),{once:!0});return}let o=document.createElement("script");o.src="https://unpkg.com/three@0.166.1/build/three.min.js",o.async=!0,o.defer=!0,o.dataset.threeChart="1",o.onload=()=>n(!0),o.onerror=()=>s(new Error("Three.js failed to load.")),document.head.appendChild(o)}).finally(()=>{var n;(n=window.THREE)!=null&&n.Scene||(Sa=null)})),await Sa,!!((t=window.THREE)!=null&&t.Scene))}function Os(){var e,t;if(Ge.resizeHandler)try{window.removeEventListener("resize",Ge.resizeHandler)}catch{}if(Ge.raf&&cancelAnimationFrame(Ge.raf),(t=(e=Ge.renderer)==null?void 0:e.domElement)!=null&&t.parentElement)try{Ge.renderer.domElement.parentElement.removeChild(Ge.renderer.domElement)}catch{}if(Ge.renderer)try{Ge.renderer.dispose()}catch{}Ge={renderer:null,scene:null,camera:null,points:null,raf:0,host:null,resizeHandler:null}}async function Vf(){var t;let e=document.getElementById("xpd-chart-atmosphere");if(e&&!(Ge.renderer&&e.contains(Ge.renderer.domElement))&&!((navigator.hardwareConcurrency||4)<=3))try{if(await qf(),!((t=window.THREE)!=null&&t.Scene))return;Os();let n=window.THREE,s=Math.max(1,e.clientWidth||640),a=Math.max(1,e.clientHeight||460),o=new n.Scene,i=new n.PerspectiveCamera(52,s/a,.1,1e3);i.position.z=46;let r=new n.WebGLRenderer({alpha:!0,antialias:!0});r.setPixelRatio(Math.min(2,window.devicePixelRatio||1)),r.setSize(s,a),e.appendChild(r.domElement);let l=900,c=new Float32Array(l*3);for(let h=0;h<l;h+=1){let b=h*3;c[b]=(Math.random()-.5)*90,c[b+1]=(Math.random()-.5)*40,c[b+2]=(Math.random()-.5)*24}let u=new n.BufferGeometry;u.setAttribute("position",new n.BufferAttribute(c,3));let p=new n.PointsMaterial({color:5101823,size:.25,transparent:!0,opacity:.26,depthWrite:!1}),d=new n.Points(u,p);o.add(d);let m=0,f=0,g=()=>{var T;m+=1;let h=Number(((T=M.stats)==null?void 0:T.changePct)||0),b=Math.min(4,Math.max(.35,Math.abs(h)/2.2)),x=h>0?16758874:16739999;p.color.setHex(Math.abs(h)>1.5?x:5101823),d.rotation.y+=9e-4*b,d.rotation.x=Math.sin(m*.0015*b)*.08,d.position.y=Math.sin(m*.003*b)*.7,(!document.hidden||Date.now()-f>350)&&(r.render(o,i),f=Date.now()),Ge.raf=requestAnimationFrame(g)},v=()=>{let h=Math.max(1,e.clientWidth||640),b=Math.max(1,e.clientHeight||460);i.aspect=h/b,i.updateProjectionMatrix(),r.setSize(h,b)};window.addEventListener("resize",v,{passive:!0}),Ge={renderer:r,scene:o,camera:i,points:d,raf:0,host:e,resizeHandler:v},g()}catch{}}function fc(e){return ui(e)*60}function hc(e){let t=ui(e);return t<=1?60:t<=5?300:t<=15?900:t<=60?3600:t<=360?21600:86400}function gc(){let e=String(M.tokenFocusKey||"");if(!e)return null;let t=e.includes("|")?e.split("|")[0]:e;return j.tokens.find(n=>qe(n)===e)||j.tokens.find(n=>String(n.symbol||"").toUpperCase()===String(t||"").toUpperCase())||null}function bc(){var a,o;let e=gc(),t=Number((e==null?void 0:e.price)||0);if(Number.isFinite(t)&&t>0)return t;let n=Number(((a=M.stats)==null?void 0:a.xrplSpot)||0);if(Number.isFinite(n)&&n>0)return n;let s=Number(((o=M.stats)==null?void 0:o.price)||0);return Number.isFinite(s)&&s>0?s:1}function vc(e,t=1,n=220){let s=Math.max(60,fc(e)),a=Math.floor(Date.now()/1e3),o=Math.floor(a/s)*s-n*s,i=Math.max(1e-6,Number(t)||1),r=[];for(let l=0;l<n;l+=1){let c=o+l*s,u=i,p=Math.sin((l+1)/9)*.004+Math.cos((l+3)/17)*.002;i=Math.max(1e-6,u*(1+p));let d=Math.max(u,i)*(1+Math.abs(p)*.55+.0015),m=Math.min(u,i)*Math.max(1e-6,1-(Math.abs(p)*.55+.0015));r.push({time:c,open:Number(u),high:Number(d),low:Number(m),close:Number(i),volume:Math.max(0,Math.round(Math.abs(p)*12e3+l%13*55))})}return r}function Ko(e){if(!e.length)return e;let t=[];for(let n=0;n<e.length;n+=1){let s=e[n],a=(s.open+s.high+s.low+s.close)/4,o=t[n-1],i=o?(o.open+o.close)/2:(s.open+s.close)/2,r=Math.max(s.high,i,a),l=Math.min(s.low,i,a);t.push({...s,open:i,high:r,low:l,close:a})}return t}function Jo(e,t){let n=[],s=0;for(let a=0;a<e.length;a+=1)s+=e[a].close,a>=t&&(s-=e[a-t].close),a>=t-1&&n.push({time:e[a].time,value:s/t});return n}function Ds(e,t){let n=[];if(!e.length)return n;let s=2/(t+1),a=e[0].close;for(let o=0;o<e.length;o+=1)a=o===0?e[o].close:e[o].close*s+a*(1-s),o>=t-1&&n.push({time:e[o].time,value:a});return n}function Gf(e,t){let n=[],s=t*(t+1)/2;for(let a=t-1;a<e.length;a+=1){let o=0;for(let i=0;i<t;i+=1)o+=e[a-i].close*(t-i);n.push({time:e[a].time,value:o/s})}return n}function Kf(e,t=20,n=2){let s=Jo(e,t),a=[],o=[];for(let i=t-1;i<e.length;i+=1){let r=e.slice(i-t+1,i+1),l=s[i-(t-1)].value,c=r.reduce((p,d)=>p+Math.pow(d.close-l,2),0)/t,u=Math.sqrt(c);a.push({time:e[i].time,value:l+u*n}),o.push({time:e[i].time,value:l-u*n})}return{upper:a,lower:o}}function Jf(e){let t=[],n=0,s=0;for(let a=0;a<e.length;a+=1){let o=(e[a].high+e[a].low+e[a].close)/3;n+=o*(e[a].volume||0),s+=e[a].volume||0,s>0&&t.push({time:e[a].time,value:n/s})}return t}function Yf(e,t=14){let n=[];if(e.length<=t)return n;let s=0,a=0;for(let r=1;r<=t;r+=1){let l=e[r].close-e[r-1].close;s+=l>0?l:0,a+=l<0?-l:0}let o=s/t,i=a/t;for(let r=t+1;r<e.length;r+=1){let l=e[r].close-e[r-1].close;o=(o*(t-1)+(l>0?l:0))/t,i=(i*(t-1)+(l<0?-l:0))/t;let c=i>0?o/i:100;n.push({time:e[r].time,value:100-100/(1+c)})}return n}function mi(e,t=14){let n=[];for(let o=0;o<e.length;o+=1){let i=o>0?e[o-1].close:e[o].close;n.push(Math.max(e[o].high-e[o].low,Math.abs(e[o].high-i),Math.abs(e[o].low-i)))}let s=[],a=n.slice(0,t).reduce((o,i)=>o+i,0)/Math.max(1,t);for(let o=t;o<e.length;o+=1)a=(a*(t-1)+n[o])/t,s.push({time:e[o].time,value:a});return s}function Qf(e,t=14,n=3){let s=[];for(let o=t-1;o<e.length;o+=1){let i=e.slice(o-t+1,o+1),r=Math.max(...i.map(u=>u.high)),l=Math.min(...i.map(u=>u.low)),c=r!==l?(e[o].close-l)/(r-l)*100:50;s.push({time:e[o].time,value:c})}let a=[];for(let o=n-1;o<s.length;o+=1){let i=s.slice(o-n+1,o+1).reduce((r,l)=>r+l.value,0)/n;a.push({time:s[o].time,value:i})}return{k:s,d:a}}function Zf(e,t=12,n=26,s=9){let a=Ds(e,t),o=Ds(e,n),i=new Map(o.map(p=>[p.time,p.value])),r=a.filter(p=>i.has(p.time)).map(p=>({time:p.time,value:p.value-i.get(p.time)})),l=[];if(r.length){let p=2/(s+1),d=r[0].value;for(let m=0;m<r.length;m+=1)d=m===0?r[m].value:r[m].value*p+d*(1-p),m>=s-1&&l.push({time:r[m].time,value:d})}let c=new Map(l.map(p=>[p.time,p.value])),u=r.filter(p=>c.has(p.time)).map(p=>({time:p.time,value:p.value-c.get(p.time)}));return{line:r,signal:l,hist:u}}function yc(e,t=9,n=26,s=52){let a=p=>{let d=[];for(let m=p-1;m<e.length;m+=1){let f=e.slice(m-p+1,m+1);d.push({time:e[m].time,value:(Math.max(...f.map(g=>g.high))+Math.min(...f.map(g=>g.low)))/2})}return d},o=a(t),i=a(n),r=new Map(i.map(p=>[p.time,p.value])),l=o.filter(p=>r.has(p.time)).map(p=>({time:p.time,value:(p.value+r.get(p.time))/2})),c=a(s),u=e.map(p=>({time:p.time,value:p.close}));return{tenkan:o,kijun:i,senkouA:l,senkouB:c,chikou:u}}function eh(e,t=20){let n=[],s=[],a=[];for(let o=t-1;o<e.length;o+=1){let i=e.slice(o-t+1,o+1),r=Math.max(...i.map(c=>c.high)),l=Math.min(...i.map(c=>c.low));n.push({time:e[o].time,value:r}),s.push({time:e[o].time,value:l}),a.push({time:e[o].time,value:(r+l)/2})}return{upper:n,lower:s,mid:a}}function th(e,t=20,n=2){let s=Ds(e,t),a=mi(e,t),o=new Map(a.map(l=>[l.time,l.value])),i=[],r=[];return s.forEach(l=>{if(o.has(l.time)){let c=o.get(l.time)*n;i.push({time:l.time,value:l.value+c}),r.push({time:l.time,value:l.value-c})}}),{upper:i,lower:r,mid:s}}function nh(e){let t=[],n=[],s=0,a=0;for(let o=0;o<e.length;o+=1){if(o>0){let l=e[o-1];e[o].close>l.close&&(s+=e[o].volume||0),e[o].close<l.close&&(s-=e[o].volume||0)}let i=e[o].high-e[o].low||1,r=(e[o].close-e[o].low-(e[o].high-e[o].close))/i;a+=r*(e[o].volume||0),t.push({time:e[o].time,value:s}),n.push({time:e[o].time,value:a})}return{obv:t,adline:n}}function sh(e,t=14){if(e.length<t+2)return{adx:[],plusDi:[],minusDi:[]};let n=[],s=[],a=[];for(let d=1;d<e.length;d+=1){let m=e[d].high-e[d-1].high,f=e[d-1].low-e[d].low;s.push(m>f&&m>0?m:0),a.push(f>m&&f>0?f:0),n.push(Math.max(e[d].high-e[d].low,Math.abs(e[d].high-e[d-1].close),Math.abs(e[d].low-e[d-1].close)))}let o=n.slice(0,t).reduce((d,m)=>d+m,0),i=s.slice(0,t).reduce((d,m)=>d+m,0),r=a.slice(0,t).reduce((d,m)=>d+m,0),l=[],c=[],u=[];for(let d=t;d<n.length;d+=1){o=o-o/t+n[d],i=i-i/t+s[d],r=r-r/t+a[d];let m=o>0?100*i/o:0,f=o>0?100*r/o:0,g=m+f>0?100*Math.abs(m-f)/(m+f):0,v=e[d+1].time;l.push({time:v,value:m}),c.push({time:v,value:f}),u.push({time:v,value:g})}let p=[];if(u.length>=t){let d=u.slice(0,t).reduce((m,f)=>m+f.value,0)/t;for(let m=t;m<u.length;m+=1)d=(d*(t-1)+u[m].value)/t,p.push({time:u[m].time,value:d})}return{adx:p,plusDi:l,minusDi:c}}function ah(e,t=14){let n=[],s=[];for(let a=t-1;a<e.length;a+=1){let o=e.slice(a-t+1,a+1),i=0,r=0;for(let u=1;u<o.length;u+=1)o[u].high>=o[i].high&&(i=u),o[u].low<=o[r].low&&(r=u);let l=t-1-i,c=t-1-r;n.push({time:e[a].time,value:(t-l)/t*100}),s.push({time:e[a].time,value:(t-c)/t*100})}return{up:n,down:s}}function oh(e,t=14){let n=[],s=[];if(e.length<t+2)return{plus:n,minus:s};for(let a=t;a<e.length;a+=1){let o=0,i=0,r=0;for(let l=a-t+1;l<=a;l+=1){let c=e[l-1],u=e[l];o+=Math.max(u.high-u.low,Math.abs(u.high-c.close),Math.abs(u.low-c.close)),i+=Math.abs(u.high-c.low),r+=Math.abs(u.low-c.high)}n.push({time:e[a].time,value:o>0?i/o:0}),s.push({time:e[a].time,value:o>0?r/o:0})}return{plus:n,minus:s}}function ih(e,t=10,n=3){let s=mi(e,t),a=new Map(s.map(c=>[c.time,c.value])),o=[],i=0,r=0,l=!0;return e.forEach((c,u)=>{if(u===0||!a.has(c.time))return;let p=(c.high+c.low)/2,d=a.get(c.time),m=p+n*d,f=p-n*d;u>1&&(m>i&&e[u-1].close<=i&&(m=i),f<r&&e[u-1].close>=r&&(f=r));let g=c.close>m?!0:c.close<f?!1:l,v=g?f:m;o.push({time:c.time,value:v,trendUp:g?1:0}),i=m,r=f,l=g}),o}function rh(e,t=14){let n=[];if(e.length<=t)return n;let s=e.map((a,o)=>{let i=(a.high+a.low+a.close)/3,r=o>0?(e[o-1].high+e[o-1].low+e[o-1].close)/3:i,l=i*(a.volume||0);return{time:a.time,pos:i>=r?l:0,neg:i<r?l:0}});for(let a=t;a<s.length;a+=1){let o=s.slice(a-t+1,a+1),i=o.reduce((c,u)=>c+u.pos,0),r=o.reduce((c,u)=>c+u.neg,0),l=r>0?i/r:100;n.push({time:s[a].time,value:100-100/(1+l)})}return n}function lh(e,t=14){let n=[];for(let s=t-1;s<e.length;s+=1){let a=e.slice(s-t+1,s+1),o=Math.max(...a.map(l=>l.high)),i=Math.min(...a.map(l=>l.low)),r=o!==i?(o-e[s].close)/(o-i)*-100:-50;n.push({time:e[s].time,value:r})}return n}function ch(e,t=20){let n=[],s=e.map(a=>({time:a.time,value:(a.high+a.low+a.close)/3}));for(let a=t-1;a<s.length;a+=1){let o=s.slice(a-t+1,a+1),i=o.reduce((c,u)=>c+u.value,0)/t,r=o.reduce((c,u)=>c+Math.abs(u.value-i),0)/t,l=r>0?(s[a].value-i)/(.015*r):0;n.push({time:s[a].time,value:l})}return n}function dh(e){if(e.length<30)return[];let t=[],n=[];for(let o=1;o<e.length;o+=1){let i=e[o-1].close,r=Math.min(e[o].low,i),l=Math.max(e[o].high,i);t.push({time:e[o].time,value:e[o].close-r}),n.push({time:e[o].time,value:l-r})}let s=(o,i,r)=>o.slice(i-r+1,i+1).reduce((l,c)=>l+c.value,0),a=[];for(let o=27;o<t.length;o+=1){let i=s(t,o,7)/Math.max(1e-9,s(n,o,7)),r=s(t,o,14)/Math.max(1e-9,s(n,o,14)),l=s(t,o,28)/Math.max(1e-9,s(n,o,28));a.push({time:t[o].time,value:100*(4*i+2*r+l)/7})}return a}function ph(e,t=20){let n=[],s=e.map(a=>{let o=a.high-a.low||1,i=(a.close-a.low-(a.high-a.close))/o;return{time:a.time,value:i*(a.volume||0),volume:a.volume||0}});for(let a=t-1;a<s.length;a+=1){let o=s.slice(a-t+1,a+1),i=o.reduce((l,c)=>l+c.value,0),r=o.reduce((l,c)=>l+c.volume,0);n.push({time:s[a].time,value:r>0?i/r:0})}return n}function uh(e){return(Array.isArray(e)?e:[]).map(t=>({time:Number(t[0]),low:Number(t[1]),high:Number(t[2]),open:Number(t[3]),close:Number(t[4]),volume:Number(t[5])})).filter(t=>Number.isFinite(t.time)&&[t.open,t.high,t.low,t.close].every(Number.isFinite))}function Yo(e,t){let n=new Map;for(let s of e)n.set(s.time,s);for(let s of t)n.set(s.time,s);return Array.from(n.values()).sort((s,a)=>s.time-a.time)}async function Qo(e,t,n){let s=[],a=Math.floor(Date.now()/1e3),o=!1;for(let i=0;i<n;i+=1){let r=a-t*300,l=`https://api.exchange.coinbase.com/products/${e}/candles?granularity=${t}&start=${new Date(r*1e3).toISOString()}&end=${new Date(a*1e3).toISOString()}`,c;try{c=await Lt(l,{timeoutMs:1e4})}catch{break}let u=uh(c);if(!u.length){o=!0;break}s.push(...u),a=r,i<n-1&&await af(sf)}return{candles:Yo(s,[]),reachedStart:o}}async function mh(e,t,n){if(!e||!Number.isFinite(t)||!Number.isFinite(n)||n<=t)return[];try{let s=`https://api.coingecko.com/api/v3/coins/${e}/market_chart/range?vs_currency=usd&from=${t}&to=${n}`,a=await Lt(s,{timeoutMs:15e3});return(Array.isArray(a==null?void 0:a.prices)?a.prices:[]).map(([i,r])=>({time:Math.floor(Number(i)/1e3/86400)*86400,open:Number(r),high:Number(r),low:Number(r),close:Number(r),volume:0})).filter(i=>Number.isFinite(i.time)&&Number.isFinite(i.close)&&i.close>0).sort((i,r)=>i.time-r.time)}catch{return[]}}async function fh(e,t,n){var p;let s=hc(n),a=s===86400,o=`${nf}${e.id}:${s}`,i=ge(Q(o));if((p=i==null?void 0:i.candles)!=null&&p.length&&i.reachedStart){let d=await Qo(t,s,1),m=Yo(i.candles,d.candles);return Z(o,JSON.stringify({candles:m,reachedStart:!0,source:i.source,cachedAt:Date.now()})),{candles:m,source:i.source}}let l=await Qo(t,s,a?Xl:Hl),c=l.candles,u=c.length?`Coinbase (${new Date(c[0].time*1e3).getUTCFullYear()}\u2013present, ${c.length} bars)`:"Coinbase";if(a&&l.reachedStart&&e.coingeckoId&&c.length){let d=c[0].time,m=await mh(e.coingeckoId,0,d);m.length&&(c=Yo(m,c),u=`CoinGecko (${new Date(c[0].time*1e3).getUTCFullYear()}+) + Coinbase (${new Date(d*1e3).getUTCFullYear()}\u2013present)`)}else!a&&!l.reachedStart&&(u=`Coinbase (last ${c.length} bars \u2014 full inception history is daily/weekly/monthly only)`);return c.length&&Z(o,JSON.stringify({candles:c,reachedStart:l.reachedStart,source:u,cachedAt:Date.now()})),{candles:c,source:u}}var jo=new Map;async function wc(e,t){let n=`${e.id}:${t}`,s=Es.get(n);if(s&&Date.now()-s.ts<6e4&&Array.isArray(s.data)&&s.data.length)return s.data;let a=jo.get(n);if(a)return a;let o=(async()=>{let i=[],r="",l=uc(e.ticker);if(l)try{let c=await fh(e,l,t);i=c.candles,r=c.source}catch{i=[]}if(!Array.isArray(i)||!i.length){let c=vc(t,bc());return Es.set(n,{ts:Date.now(),data:c,sourceLabel:""}),c}return Es.set(n,{ts:Date.now(),data:i,sourceLabel:r}),i})();jo.set(n,o);try{return await o}finally{jo.delete(n)}}async function hh(){var p,d,m,f,g,v,h,b;let e=Na(),t=await wc(e,M.interval),s=((p=Es.get(`${e.id}:${M.interval}`))==null?void 0:p.sourceLabel)||String(((d=M.stats)==null?void 0:d.source)||"Coinbase + XRPL live"),a="pair",o=gc(),i=String((o==null?void 0:o.symbol)||"").toUpperCase(),r=o?qe(o):`${e.symbol||"XRP"}|`;if(o&&i&&i!=="XRP"){let x=await zf(o,M.interval);(m=x==null?void 0:x.candles)!=null&&m.length&&(t=x.candles,s=x.source,a=x.mode)}let l=String(e.symbol||"XRP").toUpperCase()==="XRP",c=Number((l?(f=M.stats)==null?void 0:f.xrplSpot:null)??((g=M.stats)==null?void 0:g.price)??0);if(a==="pair"&&Number.isFinite(c)&&c>0&&t.length){let x=Math.max(60,fc(M.interval)),k=Math.floor(Date.now()/1e3),T=Math.floor(k/x)*x,S=t[t.length-1];S.time===T?(S.high=Math.max(S.high,c),S.low=Math.min(S.low,c),S.close=c):S.time<T&&t.push({time:T,open:S.close,high:Math.max(S.close,c),low:Math.min(S.close,c),close:c,volume:0})}let u=Number((o==null?void 0:o.price)||0);if(a==="pair"&&o&&i&&i!=="XRP"&&Number.isFinite(u)&&u>0&&t.length){let x=Number((l?(v=M.stats)==null?void 0:v.xrplSpot:null)??((h=M.stats)==null?void 0:h.price)??((b=t[t.length-1])==null?void 0:b.close)??0);if(Number.isFinite(x)&&x>0){let k=u/x;Number.isFinite(k)&&k>0&&(t=t.map(T=>({...T,open:T.open*k,high:T.high*k,low:T.low*k,close:T.close*k})),s="Coinbase pair + token spot proxy",a="token-proxy")}}return t.length||(t=vc(M.interval,bc()),s=o&&i!=="XRP"?"Synthetic fallback (token-focused)":"Synthetic fallback",a="fallback"),o&&i!=="XRP"&&(a==="pair"||a==="fallback")?Ho!==r&&(Ho=r,he(`No market data found for ${o.symbol} yet \u2014 showing ${e.symbol||"XRP"} for reference.`)):r&&(Ho=""),M.chartType==="heikin_ashi"&&(t=Ko(t)),jf(t,{mode:a,source:s,tokenKey:r||"XRP|"}),t}function Cl(e){if(!Array.isArray(e))return[];let t=e.map(s=>({time:Number(s.time),open:Number(s.open),high:Number(s.high),low:Number(s.low),close:Number(s.close),volume:Number(s.volume||0)})).filter(s=>Number.isFinite(s.time)&&Number.isFinite(s.open)&&Number.isFinite(s.high)&&Number.isFinite(s.low)&&Number.isFinite(s.close)&&s.time>0).sort((s,a)=>s.time-a.time),n=[];for(let s=0;s<t.length;s+=1){let a=t[s],o=n[n.length-1];o&&o.time===a.time?n[n.length-1]=a:n.push(a)}return n}function gh(e,t,n){var i;let s=Number(((i=e==null?void 0:e[e.length-1])==null?void 0:i.close)||0);if(!Number.isFinite(s)||s<=0)return 6;let o=Math.max(1e-12,Math.abs(Number(n)-Number(t)))/Math.max(1e-12,Math.abs(s));return s>=1e3?o<.01?4:2:s>=1?o<.01?6:4:s>=.01?o<.03?8:6:8}function bh(){if(ee.resizeObserver)try{ee.resizeObserver.disconnect()}catch{}ee.chart&&(ee.chart.remove(),ee={chart:null,volumeSeries:null,activeSeries:null,compareSeries:null,indicatorSeries:[],indicatorPriceLines:[],priceLines:[],resizeObserver:null,chartType:"",configKey:"",legendEl:null,renderLegend:null,ichimokuData:null,indicatorLegendItems:[],alertPriceLines:[]})}function Pl(e,t){var u;let{addOverlay:n,addOsc:s,addOscHist:a,addPriceLevel:o}=t,i=(p,d)=>{var f,g;let m=Number((g=(f=M.indicatorSettings)==null?void 0:f[p])==null?void 0:g.length);return Number.isFinite(m)&&m>1?Math.min(500,Math.max(2,m)):d},r=(p,d,m)=>{var v,h;let f=(h=(v=M.indicatorSettings)==null?void 0:v[p])==null?void 0:h[d];if(f==null||f==="")return m;let g=(ii[p]||[]).find(b=>b.id===d);if((g==null?void 0:g.type)==="number"){let b=Number(f);return Number.isFinite(b)&&b>1?Math.min(500,Math.max(2,b)):m}return f},l=M.indicators;if(l.sma20&&n(Jo(e,i("sma20",20)),r("sma20","color","#f1c40f"),1.2,!1,"SMA"),l.ema20&&n(Ds(e,i("ema20",20)),r("ema20","color","#ffb86c"),1.2,!1,"EMA"),l.wma20&&n(Gf(e,i("wma20",20)),r("wma20","color","#bd93f9"),1.2,!1,"WMA"),l.vwap&&n(Jf(e),r("vwap","color","#80ffea"),1.2,!1,"VWAP"),l.bb20){let p=r("bb20","color","#ff79c6"),d=Kf(e,i("bb20",20),2);n(d.upper,p,1,!0,"BB Upper"),n(d.lower,p,1,!0,"BB Lower")}if(l.ichimoku){let p=yc(e,r("ichimoku","tenkanLen",9),r("ichimoku","kijunLen",26),r("ichimoku","senkouBLen",52));n(p.tenkan,r("ichimoku","tenkanColor","#ffde59"),1.2,!1,"Tenkan"),n(p.kijun,r("ichimoku","kijunColor","#6ecbff"),1.2,!1,"Kijun"),n(p.senkouA,"rgba(70,255,160,0.8)",1,!0,"Senkou A"),n(p.senkouB,"rgba(255,120,120,0.8)",1,!0,"Senkou B"),n(p.chikou,"rgba(220,220,255,0.6)",.9,!0,"Chikou")}if(l.donchian){let p=r("donchian","color","#9cfb8c"),d=eh(e,i("donchian",20));n(d.upper,p,1,!0,"Donchian Upper"),n(d.lower,p,1,!0,"Donchian Lower"),n(d.mid,"rgba(156,251,140,0.6)",1.2,!1,"Donchian Mid")}if(l.keltner){let p=r("keltner","color","#7ee7ff"),d=th(e,i("keltner",20),2);n(d.upper,p,1,!0,"Keltner Upper"),n(d.lower,p,1,!0,"Keltner Lower"),n(d.mid,"rgba(126,231,255,0.66)",1.2,!1,"Keltner Mid")}if(l.pivots&&e.length>=2){let p=e[e.length-2],d=(p.high+p.low+p.close)/3,m=2*d-p.low,f=2*d-p.high,g=d+(p.high-p.low),v=d-(p.high-p.low);o(d,"#f6f6f6","P"),o(m,"#61ffb0","R1"),o(f,"#ff8f8f","S1"),o(g,"rgba(97,255,176,0.6)","R2"),o(v,"rgba(255,143,143,0.6)","S2")}if(l.supertrend||l.sar||l.elderRay){let p=Ds(e,14);if(l.supertrend&&n(ih(e,10,3),r("supertrend","color","#8bffde"),1.3,!1,"Supertrend"),l.sar&&n(p.map(d=>({time:d.time,value:d.value*.998})),r("sar","color","#ffaf7a"),1,!0,"SAR"),l.elderRay){let d=new Map(p.map(g=>[g.time,g.value])),m=e.filter(g=>d.has(g.time)).map(g=>({time:g.time,value:g.high-d.get(g.time)})),f=e.filter(g=>d.has(g.time)).map(g=>({time:g.time,value:g.low-d.get(g.time)}));s(m,r("elderRay","bullColor","#5fff9d"),"Elder Bull"),s(f,r("elderRay","bearColor","#ff9d9d"),"Elder Bear")}}if(l.rsi&&s(Yf(e,i("rsi",14)),r("rsi","color","#a6ff4d"),"RSI"),l.atr&&s(mi(e,i("atr",14)),r("atr","color","#ffb86c"),"ATR"),l.stdev){let p=Jo(e,20),d=new Map(p.map(f=>[f.time,f.value])),m=e.filter(f=>d.has(f.time)).map(f=>({time:f.time,value:Math.abs(f.close-d.get(f.time))}));s(m,r("stdev","color","#b2a3ff"),"StdDev")}if(l.stoch){let p=Qf(e,i("stoch",14),3);s(p.k,r("stoch","kColor","#9ee8ff"),"%K"),s(p.d,r("stoch","dColor","#ffd86b"),"%D")}if(l.macd){let p=Zf(e,r("macd","fastLen",12),r("macd","slowLen",26),r("macd","signalLen",9));s(p.line,r("macd","lineColor","#8fd9ff"),"MACD"),s(p.signal,r("macd","signalColor","#ffcf8e"),"Signal"),(u=p.hist)!=null&&u.length&&a(p.hist)}let c=nh(e);if(l.obv&&s(c.obv,r("obv","color","#8cf9ff"),"OBV"),l.adline&&s(c.adline,r("adline","color","#ffb7ff"),"A/D"),l.cmf&&s(ph(e,i("cmf",20)),r("cmf","color","#f8ff87"),"CMF"),l.williamsr&&s(lh(e,i("williamsr",14)),r("williamsr","color","#ff9adf"),"Williams %R"),l.cci&&s(ch(e,i("cci",20)),r("cci","color","#b8ff8e"),"CCI"),l.mfi&&s(rh(e,i("mfi",14)),r("mfi","color","#7bffd2"),"MFI"),l.uo&&s(dh(e),r("uo","color","#ffd36f"),"UO"),l.adx){let p=sh(e,i("adx",14));s(p.adx,r("adx","adxColor","#9fd8ff"),"ADX"),s(p.plusDi,r("adx","plusColor","#73ffc0"),"+DI"),s(p.minusDi,r("adx","minusColor","#ff9797"),"-DI")}if(l.aroon){let p=ah(e,i("aroon",14));s(p.up,r("aroon","upColor","#6cffb0"),"Aroon Up"),s(p.down,r("aroon","downColor","#ff8f8f"),"Aroon Down")}if(l.vortex){let p=oh(e,i("vortex",14));s(p.plus.map(d=>({time:d.time,value:d.value*100})),r("vortex","plusColor","#d6a8ff"),"VI+"),s(p.minus.map(d=>({time:d.time,value:d.value*100})),r("vortex","minusColor","#ffb0f3"),"VI-")}}function vh(e){let t=e.querySelector(":scope > svg.xpd-ichimoku-cloud-svg");return t||(t=document.createElementNS("http://www.w3.org/2000/svg","svg"),t.setAttribute("class","xpd-ichimoku-cloud-svg"),e.appendChild(t)),t}function yh(e){var t;(t=e==null?void 0:e.querySelector(":scope > svg.xpd-ichimoku-cloud-svg"))==null||t.remove()}function xc(e,t,n,s,a){var v;if(!e||!t||!n)return;let o=n.clientWidth||0,i=n.clientHeight||0;if(!o||!i||!(s!=null&&s.length)||!(a!=null&&a.length))return;let r=vh(n);r.setAttribute("width",o),r.setAttribute("height",i),r.setAttribute("viewBox",`0 0 ${o} ${i}`);let l=((v=M.indicatorSettings)==null?void 0:v.ichimoku)||{},c=l.bullColor||"#46ffa0",u=l.bearColor||"#ff7878",p=new Map(a.map(h=>[h.time,h.value])),d=e.timeScale(),m=[];for(let h of s){let b=p.get(h.time);if(b==null)continue;let x=d.timeToCoordinate(h.time),k=t.priceToCoordinate(h.value),T=t.priceToCoordinate(b);x==null||k==null||T==null||m.push({x,ya:k,yb:T,bullish:h.value>=b})}let f="",g=0;for(let h=1;h<=m.length;h+=1){if(!(h===m.length||m[h].bullish!==m[g].bullish))continue;let x=m.slice(g,h);if(x.length>=2){let k=x.map($=>`${$.x.toFixed(1)},${$.ya.toFixed(1)}`).join(" "),T=x.slice().reverse().map($=>`${$.x.toFixed(1)},${$.yb.toFixed(1)}`).join(" "),S=x[0].bullish?c:u;f+=`<polygon points="${k} ${T}" fill="${y(S)}" opacity="0.22" />`}g=h}r.innerHTML=f}function Ml(e,t,n,s){var i;if(!M.indicators.ichimoku){yh(s),ee.ichimokuData=null;return}let a=((i=M.indicatorSettings)==null?void 0:i.ichimoku)||{},o=yc(e,Number(a.tenkanLen)||9,Number(a.kijunLen)||26,Number(a.senkouBLen)||52);ee.ichimokuData={senkouA:o.senkouA,senkouB:o.senkouB},xc(t,n,s,o.senkouA,o.senkouB)}function Zo(){let e=ee.ichimokuData,t=document.getElementById("xpd-tv-widget");e&&ee.chart&&ee.activeSeries&&t&&xc(ee.chart,ee.activeSeries,t,e.senkouA,e.senkouB)}async function wh(){var n,s,a,o;let e=++Rn,t=document.getElementById("xpd-tv-widget");if(t){ee.chart||(t.innerHTML='<div class="xpd-loading">Loading full price history\u2026</div>');try{M.threeEnabled?Vf():Os();let i=await hh(),r=Cl(i);if(e!==Rn)return;if(!r.length)throw new Error("No chart bars returned for selected pair/timeframe.");kh(r);let l=JSON.stringify({pair:M.pair,interval:M.interval,chartType:M.chartType,comparePair:M.comparePair,indicators:M.indicators,indicatorSettings:M.indicatorSettings,threeEnabled:M.threeEnabled});if(!M.comparePair&&!(M.drawings||[]).length&&ee.chart&&ee.configKey===l){let B=M.chartType==="heikin_ashi"?Ko(r):r;M.chartType==="line"||M.chartType==="area"?ee.activeSeries.setData(B.map(Y=>({time:Y.time,value:Y.close}))):ee.activeSeries.setData(B),ee.volumeSeries.setData(r.map(Y=>({time:Y.time,value:Y.volume||0,color:Y.close>=Y.open?"rgba(38,166,154,0.5)":"rgba(239,83,80,0.5)"})));let q=0,J=0,ue=[];Pl(r,{addOverlay:(Y,Ce,Je,$e,Ct)=>{let Wt=ee.indicatorSeries[q++];Y!=null&&Y.length&&(Wt==null||Wt.setData(Y),Ct&&Wt&&ue.push({label:Ct,color:Ce,series:Wt,points:Y}))},addOsc:(Y,Ce,Je)=>{let $e=ee.indicatorSeries[q++];Y!=null&&Y.length&&($e==null||$e.setData(Y),Je&&$e&&ue.push({label:Je,color:Ce,series:$e,points:Y}))},addOscHist:Y=>{let Ce=ee.indicatorSeries[q++];Y!=null&&Y.length&&(Ce==null||Ce.setData(Y.map(Je=>({time:Je.time,value:Je.value,color:Je.value>=0?"rgba(99,255,157,0.45)":"rgba(255,126,126,0.45)"}))))},addPriceLevel:Y=>{let Ce=ee.indicatorPriceLines[J++];Number.isFinite(Y)&&(Ce==null||Ce.applyOptions({price:Y}))}}),ee.indicatorLegendItems=ue,Ml(r,ee.chart,ee.activeSeries,t),Ll(ee.activeSeries);let Ie=r[r.length-1];(n=ee.renderLegend)==null||n.call(ee,Ie.open,Ie.high,Ie.low,Ie.close,Ie.volume);return}if(!await Uf())throw new Error("Chart library failed to load.");if(e!==Rn)return;let u=document.getElementById("xpd-tv-widget");if(!u||e!==Rn)return;let p=null;try{p=((s=ee.chart)==null?void 0:s.timeScale().getVisibleLogicalRange())||null}catch{}bh(),u.innerHTML="";let d=window.LightweightCharts,m=Math.max(320,u.clientWidth||((a=u.parentElement)==null?void 0:a.clientWidth)||320),f=Math.max(360,u.clientHeight||460),g=r.map(B=>B.low),v=r.map(B=>B.high),h=gh(r,Math.min(...g),Math.max(...v)),b={type:"price",precision:h,minMove:Math.pow(10,-h)},x="#26a69a",k="#ef5350",T=d.createChart(u,{width:m,height:f,layout:{background:{type:d.ColorType.Solid,color:"#131722"},textColor:"#d1d4dc"},grid:{vertLines:{color:"#242832"},horzLines:{color:"#242832"}},rightPriceScale:{borderColor:"rgba(197,203,206,0.3)"},leftPriceScale:{visible:!1,borderColor:"rgba(197,203,206,0.3)"},timeScale:{borderColor:"rgba(197,203,206,0.3)",timeVisible:!0,secondsVisible:!1},crosshair:{mode:d.CrosshairMode.Normal},handleScroll:!0,handleScale:!0}),S=M.chartType==="heikin_ashi"?Ko(r):r,$;if(M.chartType==="line")$=T.addLineSeries({color:"#2962ff",lineWidth:2,priceFormat:b}),$.setData(S.map(B=>({time:B.time,value:B.close})));else if(M.chartType==="area")$=T.addAreaSeries({lineColor:"#2962ff",topColor:"rgba(41,98,255,0.36)",bottomColor:"rgba(41,98,255,0.04)",lineWidth:2,priceFormat:b}),$.setData(S.map(B=>({time:B.time,value:B.close})));else if(M.chartType==="bars")$=T.addBarSeries({upColor:x,downColor:k,priceFormat:b}),$.setData(S);else{let B=M.chartType==="hollow_candles";$=T.addCandlestickSeries({upColor:B?"rgba(0,0,0,0)":x,downColor:k,borderUpColor:x,borderDownColor:k,wickUpColor:x,wickDownColor:k,borderVisible:!0,priceFormat:b}),$.setData(S)}let E=T.addHistogramSeries({priceFormat:{type:"volume"},priceScaleId:"vol"});T.priceScale("vol").applyOptions({scaleMargins:{top:.85,bottom:0}}),E.setData(r.map(B=>({time:B.time,value:B.volume||0,color:B.close>=B.open?"rgba(38,166,154,0.5)":"rgba(239,83,80,0.5)"})));let C=document.createElement("div");C.className="xpd-chart-legend",u.appendChild(C);let P=B=>Number.isFinite(B)?B.toFixed(h):"\u2014",R=(B,q,J,ue,ke,Me)=>{let We=ue>=B,De=(Me||[]).map(Ie=>`<span style="color:${y(Ie.color)}">${y(Ie.label)} <b>${P(Ie.value)}</b></span>`).join("");C.innerHTML=`
        <span>O <b>${P(B)}</b></span>
        <span>H <b>${P(q)}</b></span>
        <span>L <b>${P(J)}</b></span>
        <span class="${We?"xpd-legend-up":"xpd-legend-down"}">C <b>${P(ue)}</b></span>
        ${ke!=null?`<span>Vol <b>${Ue(ke)}</b></span>`:""}
        ${De}
      `},O=S[S.length-1],D=(o=r[r.length-1])==null?void 0:o.volume,I=()=>{if(!O)return;let B=O.open??O.value,q=O.high??O.value,J=O.low??O.value,ue=O.close??O.value,ke=(ee.indicatorLegendItems||[]).map(Me=>{var We,De;return{label:Me.label,color:Me.color,value:(De=(We=Me.points)==null?void 0:We[Me.points.length-1])==null?void 0:De.value}}).filter(Me=>Number.isFinite(Me.value));R(B,q,J,ue,D,ke)};I(),T.subscribeCrosshairMove(B=>{var Ie,Y;if(!B.time){I();return}let q=(Ie=B.seriesData)==null?void 0:Ie.get($);if(!q){I();return}let J=(Y=B.seriesData)==null?void 0:Y.get(E),ue=q.open??q.value,ke=q.high??q.value,Me=q.low??q.value,We=q.close??q.value,De=(ee.indicatorLegendItems||[]).map(Ce=>{var Je,$e;return{label:Ce.label,color:Ce.color,value:($e=(Je=B.seriesData)==null?void 0:Je.get(Ce.series))==null?void 0:$e.value}}).filter(Ce=>Number.isFinite(Ce.value));R(ue,ke,Me,We,J==null?void 0:J.value,De)});let F=!1,H=()=>{F||(F=!0,T.priceScale("osc").applyOptions({scaleMargins:{top:.65,bottom:.18}}))},N=[],W=[],se=[];Pl(r,{addOverlay:(B,q,J=1.2,ue=!1,ke="")=>{if(!(B!=null&&B.length))return;let Me=T.addLineSeries({color:q,lineWidth:J,lineStyle:ue?d.LineStyle.Dashed:d.LineStyle.Solid,priceLineVisible:!1,lastValueVisible:!1});Me.setData(B),N.push(Me),ke&&se.push({label:ke,color:q,series:Me,points:B})},addOsc:(B,q,J="")=>{if(!(B!=null&&B.length))return;H();let ue=T.addLineSeries({color:q,lineWidth:1.2,priceScaleId:"osc",title:J,priceLineVisible:!1,lastValueVisible:!1});ue.setData(B),N.push(ue),J&&se.push({label:J,color:q,series:ue,points:B})},addOscHist:B=>{if(!(B!=null&&B.length))return;H();let q=T.addHistogramSeries({priceScaleId:"osc",priceLineVisible:!1,lastValueVisible:!1});q.setData(B.map(J=>({time:J.time,value:J.value,color:J.value>=0?"rgba(99,255,157,0.45)":"rgba(255,126,126,0.45)"}))),N.push(q)},addPriceLevel:(B,q,J="")=>{Number.isFinite(B)&&W.push($.createPriceLine({price:B,color:q,lineWidth:1,lineStyle:d.LineStyle.Dashed,axisLabelVisible:!0,title:J}))}}),Ml(r,T,$,u),T.timeScale().subscribeVisibleLogicalRangeChange(Zo);let de=null;if(M.comparePair){let B=Fn.find(q=>q.id===M.comparePair);if(B){let q=Cl(await wc(B,M.interval));if(e===Rn&&q.length){let J=q[0].close||1;de=T.addLineSeries({color:"#ffd166",lineWidth:1.4,priceScaleId:"left",priceLineVisible:!1,lastValueVisible:!0,priceFormat:{type:"custom",formatter:ue=>`${ue>=0?"+":""}${ue.toFixed(2)}%`,minMove:.01}}),T.priceScale("left").applyOptions({visible:!0,borderColor:"rgba(255,209,102,0.35)"}),de.setData(q.map(ue=>({time:ue.time,value:(ue.close/J-1)*100})))}}}else T.priceScale("left").applyOptions({visible:!1});if(e!==Rn){try{T.remove()}catch{}return}let le=(M.drawings||[]).filter(B=>Number.isFinite(B==null?void 0:B.price)).map(B=>$.createPriceLine({price:B.price,color:"#78e5ff",lineWidth:2,lineStyle:d.LineStyle.Dashed,axisLabelVisible:!0,title:"Line"}));if(T.subscribeClick(B=>{if(M.drawingTool!=="hline"||!B.point)return;let q=$.coordinateToPrice(B.point.y);Number.isFinite(q)&&(M.drawings=[...M.drawings||[],{price:q}].slice(-50),le.push($.createPriceLine({price:q,color:"#78e5ff",lineWidth:2,lineStyle:d.LineStyle.Dashed,axisLabelVisible:!0,title:"Line"})))}),p&&Number.isFinite(p.from)&&Number.isFinite(p.to))try{T.timeScale().setVisibleLogicalRange(p)}catch{T.timeScale().fitContent()}else T.timeScale().fitContent();let Pe=new ResizeObserver(()=>{T.applyOptions({width:Math.max(320,u.clientWidth||320)}),Zo()});Pe.observe(u),ee={chart:T,volumeSeries:E,activeSeries:$,compareSeries:de,indicatorSeries:N,indicatorPriceLines:W,priceLines:le,resizeObserver:Pe,chartType:M.chartType,configKey:l,legendEl:C,renderLegend:R,indicatorLegendItems:se,alertPriceLines:[]},Ll($)}catch(i){if(e!==Rn)return;if(M.error=(i==null?void 0:i.message)||"Could not initialize chart widget.",ee.chart){he(M.error);return}let r=document.getElementById("xpd-tv-widget");r&&(r.innerHTML=`<div class="xpd-error">${y(M.error)}</div>`)}}}function kc(){let e=Q(qo)==="1"?"0":"1";Z(qo,e),U()}async function $c(e){Fn.some(t=>t.id===e)&&(M.pair=e,await Fs(),At(),U())}async function Sc(e){M.interval=e,await Fs(),At(),U()}function Tc(e){M.chartType=e,At(),U()}async function Cc(){await Fs(),U()}function Pc(e,t){e in M.indicators&&(M.indicators[e]=!!t,t&&(M.selectedIndicator=e,M.selectedEducationTab="indicator"),At(),U())}function Mc(){M.indicatorMenuOpen=!M.indicatorMenuOpen,U()}function Lc(){M.moreMenuOpen=!M.moreMenuOpen,U()}function Ac(e){M.indicatorQuery=String(e||""),M.indicatorMenuOpen||(M.indicatorMenuOpen=!0),U()}function Ec(e){let t=String(e||"").trim();t in M.indicators&&(M.indicators[t]=!0,M.selectedIndicator=t,M.selectedEducationTab="indicator",At(),U())}function Nc(e){let t=String(e||"").trim();t in M.indicators&&(M.indicators[t]=!1,At(),U())}function xh(e){var s,a;if(M.settingsOpenFor!==e)return"";let t=M.indicatorSettings[e]||{},n=ii[e]||[];return`
    ...
    </div>`}function Rc(e){let t=String(e||"").trim();t in M.indicators&&(M.settingsOpenFor=M.settingsOpenFor===t?null:t,U())}function _c(){M.settingsOpenFor=null,U()}function Dc(e){let t=String(e||"").trim();if(!(t in M.indicators))return;let n=M.indicatorSettings[t]||{},s={...n};for(let a of ii[t]||[]){let o=document.getElementById(`xpd-ind-${a.id}-${t}`);o&&(a.type==="number"?s[a.id]=Math.max(2,Math.min(500,Number(o.value)||n[a.id]||a.default)):s[a.id]=o.value)}M.indicatorSettings[t]=s,M.settingsOpenFor=null,U()}function Ic(e){let t=String(e||"").trim();delete M.indicatorSettings[t],M.settingsOpenFor=null,U()}function Fc(){At(),zs(window.location.href),ne("Chart link copied.")}function Oc(){M.threeEnabled=!M.threeEnabled,Z(oi,M.threeEnabled?"1":"0"),M.threeEnabled||Os(),U()}function Bc(e){let t=!!e;M.threeEnabled!==t&&(M.threeEnabled=t,Z(oi,M.threeEnabled?"1":"0"),M.threeEnabled||Os(),U())}function Xc(e){M.comparePair=e||"",At(),U()}function Hc(e){let t=String(e||"").trim();!t||!(t in M.indicators)||(M.indicators[t]=!0,M.selectedIndicator=t,U())}function zc(e){let t=String(e||"none");ql.some(n=>n.key===t)&&(M.drawingTool=t,M.educationHint=cf[t]||"",U())}function Ra(){var e;return((e=M.chartMeta)==null?void 0:e.tokenKey)||M.tokenFocusKey||`${Na().symbol||"XRP"}|`}function Wc(){var s,a;let e=Number((s=M.chartMeta)==null?void 0:s.last),t=prompt(`Alert me when ${((a=M.chartMeta)==null?void 0:a.symbol)||"price"} crosses:`,Number.isFinite(e)?e.toFixed(6):"");if(t==null)return;let n=Number(t);if(!Number.isFinite(n)||n<=0){he("Enter a valid price.");return}M.alerts=[...M.alerts||[],{id:`alert_${Date.now()}`,tokenKey:Ra(),price:n,createdAt:new Date().toISOString()}],li(),U(),ne(`Alert set at $${_(n,6)}`)}function jc(e){M.alerts=(M.alerts||[]).filter(t=>t.id!==e),li(),U()}function Ll(e){if(!e)return;let t=window.LightweightCharts;for(let s of ee.alertPriceLines||[])try{e.removePriceLine(s)}catch{}let n=(M.alerts||[]).filter(s=>s.tokenKey===Ra());ee.alertPriceLines=n.map(s=>{var a;return e.createPriceLine({price:s.price,color:"#ffb703",lineWidth:2,lineStyle:((a=t==null?void 0:t.LineStyle)==null?void 0:a.Dotted)??2,axisLabelVisible:!0,title:"\u{1F514} Alert"})})}function kh(e){var r,l;if(e.length<2)return;let t=Ra(),n=(M.alerts||[]).filter(c=>c.tokenKey===t);if(!n.length)return;let s=e[e.length-2].close,a=e[e.length-1].close,o=[],i=!1;for(let c of n){let u=s<c.price&&a>=c.price,p=s>c.price&&a<=c.price;u||p?(ne(`\u{1F514} ${((r=M.chartMeta)==null?void 0:r.symbol)||"Price"} crossed $${_(c.price,6)} (${u?"\u2191":"\u2193"} now $${_(a,6)})`),i=!0,(l=document.querySelector(`.xpd-indicator-chip[data-alert-id="${c.id}"]`))==null||l.remove()):o.push(c)}i&&(M.alerts=[...(M.alerts||[]).filter(c=>c.tokenKey!==t),...o],li())}function Uc(){let e=ee.activeSeries;if(e)for(let t of ee.priceLines||[])try{e.removePriceLine(t)}catch{}ee.priceLines=[],M.drawings=[]}function _a(e,t=0){var i;let n=(i=ee.chart)==null?void 0:i.timeScale();if(!n)return;let s=n.getVisibleLogicalRange();if(!s)return;let a=(s.to-s.from)*e,o=(s.to+s.from)/2+(s.to-s.from)*t;n.setVisibleLogicalRange({from:o-a/2,to:o+a/2})}function qc(){_a(.8)}function Vc(){_a(1.25)}function Gc(){_a(1,-.2)}function Kc(){_a(1,.2)}function Jc(){M.educationCollapsed=!M.educationCollapsed,U()}function Yc(e){["indicator","psychology","practice"].includes(e)&&(M.selectedEducationTab=e,U())}function Qc(){let e=document.body.classList.contains("theme-gold");Pn(e?"cosmic":"gold"),U()}var Al=!1;function $h(){let e=document.getElementById("xpd-tv-widget");e&&ee.chart&&(ee.chart.applyOptions({width:Math.max(320,e.clientWidth||320),height:Math.max(320,e.clientHeight||460)}),Zo())}function Zc(){var t;let e=document.querySelector(".xpd-chart-wrap");e&&(Al||(Al=!0,document.addEventListener("fullscreenchange",()=>{requestAnimationFrame(()=>requestAnimationFrame($h))})),document.fullscreenElement?document.exitFullscreen():(t=e.requestFullscreen)==null||t.call(e))}function ed(){let e=ee.chart;if(!e){he("Chart image is not ready yet.");return}let t=e.takeScreenshot(),n=document.createElement("a");n.download=`xrpl-chart-${Date.now()}.png`,n.href=t.toDataURL("image/png"),n.click()}function td(){return M.tokenFocusKey||M.pair||"default"}function nd(){var n;let e=ge(Q(Vo))||{},t=td();e[t]={interval:M.interval,chartType:M.chartType,comparePair:M.comparePair,indicators:M.indicators,indicatorSettings:M.indicatorSettings},Z(Vo,JSON.stringify(e)),ne(`Chart layout saved for ${((n=M.chartMeta)==null?void 0:n.symbol)||t}.`)}function sd(){var s;let e=ge(Q(Vo))||{},t=td(),n=e[t];if(!n){he(`No saved layout for ${((s=M.chartMeta)==null?void 0:s.symbol)||t} yet.`);return}M.interval=n.interval||M.interval,M.chartType=n.chartType||M.chartType,M.comparePair=n.comparePair||"",M.indicators={...M.indicators,...n.indicators||{}},M.indicatorSettings={...M.indicatorSettings,...n.indicatorSettings||{}},At(),U()}function Da(e){let t=String(e||"").trim();if(/^[0-9A-F]{40}$/i.test(t)){let n=t.replace(/(00)+$/g,"");if(/^[0-9A-F]+$/i.test(n)&&n.length%2===0)try{let s=new Uint8Array(n.length/2);for(let o=0;o<n.length;o+=2)s[o/2]=parseInt(n.slice(o,o+2),16);let a=new TextDecoder().decode(s).replace(/\0/g,"").trim();if(a)return a.toUpperCase()}catch{}}return t.toUpperCase()}function qe(e){return`${e.symbol}|${e.issuer||""}`}function Ms(e){return encodeURIComponent(e).replace(/'/g,"%27")}function Sh(e){var l,c,u,p,d,m,f,g,v,h;let t=Da(e.code||e.currency||""),n=String(e.issuer||((l=e.IssuingAccount)==null?void 0:l.account)||"").trim(),s=Number(e.price??((c=e.metrics)==null?void 0:c.price)??0),a=Number(e.marketcap??((u=e.metrics)==null?void 0:u.marketcap)??0),o=Number(((p=e.metrics)==null?void 0:p.volume_24h)??0),i=((m=(d=e.meta)==null?void 0:d.token)==null?void 0:m.name)||((f=e.IssuingAccount)==null?void 0:f.name)||t||"Unknown Token",r=Number(e.holders??((g=e.metrics)==null?void 0:g.holders)??((v=e.metrics)==null?void 0:v.trustlines)??0);return{symbol:t,name:i,issuer:n,tokenId:e.id||`${t}.${n}`,price:Number.isFinite(s)&&s>0?s:null,marketCap:Number.isFinite(a)&&a>0?a:null,volume24h:Number.isFinite(o)?o:null,holders:Number.isFinite(r)?r:null,change24h:null,verified:!!((h=e.IssuingAccount)!=null&&h.verified),score:Number(e.score||0)||null}}function Th(e){let t=Da((e==null?void 0:e.symbol)||""),n=String((e==null?void 0:e.name)||t||"Unknown Token"),s=Number((e==null?void 0:e.current_price)||0),a=Number((e==null?void 0:e.market_cap)||0),o=Number((e==null?void 0:e.total_volume)||0),i=Number((e==null?void 0:e.price_change_percentage_24h)||0);return{symbol:t,name:n,issuer:"",tokenId:`cg:${(e==null?void 0:e.id)||t}`,price:Number.isFinite(s)&&s>0?s:null,marketCap:Number.isFinite(a)&&a>0?a:null,volume24h:Number.isFinite(o)&&o>0?o:null,holders:null,change24h:Number.isFinite(i)?i:null,verified:!1,score:null}}function Ch(e){var r;let t=Da((e==null?void 0:e.currency)||(e==null?void 0:e.token)||""),n=String((e==null?void 0:e.issuer)||(e==null?void 0:e.account)||"").trim(),s=String((e==null?void 0:e.name)||t||"Unknown Token"),a=Number((e==null?void 0:e.price)||((r=e==null?void 0:e.market)==null?void 0:r.price)||0),o=Number((e==null?void 0:e.marketcap)||(e==null?void 0:e.marketCap)||0),i=Number((e==null?void 0:e.volume24h)||(e==null?void 0:e.volume)||0);return{symbol:t,name:s,issuer:n,tokenId:`bithomp:${t}.${n||"na"}`,price:Number.isFinite(a)&&a>0?a:null,marketCap:Number.isFinite(o)&&o>0?o:null,volume24h:Number.isFinite(i)&&i>0?i:null,holders:Number.isFinite(Number((e==null?void 0:e.holders)||0))?Number((e==null?void 0:e.holders)||0):null,change24h:Number.isFinite(Number((e==null?void 0:e.change24h)||0))?Number((e==null?void 0:e.change24h)||0):null,verified:!!(e!=null&&e.verified),score:null}}function Ph(e){let t=Da((e==null?void 0:e.symbol)||(e==null?void 0:e.currency)||""),n=String((e==null?void 0:e.issuer)||(e==null?void 0:e.issuerAddress)||"").trim(),s=String((e==null?void 0:e.name)||t||"Unknown Token"),a=Number((e==null?void 0:e.price)||0),o=Number((e==null?void 0:e.volume24h)||0);return{symbol:t,name:s,issuer:n,tokenId:`xrplto:${t}.${n||"na"}`,price:Number.isFinite(a)&&a>0?a:null,marketCap:Number.isFinite(Number((e==null?void 0:e.marketCap)||0))?Number((e==null?void 0:e.marketCap)||0):null,volume24h:Number.isFinite(o)&&o>0?o:null,holders:Number.isFinite(Number((e==null?void 0:e.holders)||0))?Number((e==null?void 0:e.holders)||0):null,change24h:Number.isFinite(Number((e==null?void 0:e.change24h)||0))?Number((e==null?void 0:e.change24h)||0):null,verified:!!(e!=null&&e.verified),score:null}}async function ad(){var e,t,n,s,a,o;if(La()){j.loading=!0,j.error="";try{let i=Date.now(),r=gl.get("tokens");if(r&&i-r.ts<6e4){j.tokens=r.data,j.total=r.total||r.data.length,j.lastSyncAt=r.ts,j.filtered=os(j.query,r.data),j.trending=El(r.data),j.loading=!1;return}let l=500,c=12,u=[];for(let S=1;S<=c;S+=1){let $=await Lt(`${jm}?page=${S}&limit=${l}`,{allowProxy:!1,timeoutMs:12e3});if(!Array.isArray($)||!$.length||(u.push(...$),$.length<l))break}let p=u.map(Sh).filter(S=>!!S.symbol&&!!S.issuer),d=[Lt(`${Um}?vs_currency=usd&order=market_cap_desc&per_page=250&page=1&sparkline=false`,{timeoutMs:12e3}).catch(()=>[]),Date.now()<(yl.xrplto||0)?Promise.resolve([]):Lt(Vm,{timeoutMs:12e3,allowProxy:!1}).catch(S=>(String((S==null?void 0:S.message)||"").includes("429")&&(yl.xrplto=Date.now()+5*60*1e3),[]))];Gm&&d.push(Lt(qm,{timeoutMs:12e3,allowProxy:!1}).catch(()=>[]));let[m,f,g=[]]=await Promise.all(d),v=Array.isArray(m)?m.map(Th).filter(S=>!!S.symbol):[],h=Array.isArray(g)?g.map(Ch).filter(S=>!!S.symbol):[],b=Array.isArray(f)?f.map(Ph).filter(S=>!!S.symbol):[],x={symbol:"XRP",name:"XRP Ledger Native",issuer:"",tokenId:"XRP",price:((e=Te.data)==null?void 0:e.priceUsd)||((t=M.stats)==null?void 0:t.price)||null,marketCap:((n=Te.data)==null?void 0:n.marketCap)||null,volume24h:((s=Te.data)==null?void 0:s.volume24h)||null,holders:null,change24h:((a=Te.data)==null?void 0:a.change24h)||((o=M.stats)==null?void 0:o.changePct)||null,verified:!0,score:1},k=new Map;[x,...p,...h,...b,...v].forEach(S=>{let $=qe(S);k.has($)||k.set($,S)});let T=[...k.values()];gl.set("tokens",{ts:i,data:T,total:T.length}),j.tokens=T,j.total=T.length,j.lastSyncAt=i,j.filtered=os(j.query,T),j.trending=El(T)}catch(i){j.error=(i==null?void 0:i.message)||"Could not load XRPL token discovery data."}finally{j.loading=!1}}}function os(e,t){let n=String(e||"").trim().toLowerCase(),s=j.filters||{type:"all",minCap:0,minVol:0,hasDex:!1};return t.filter(a=>{if(n&&!`${a.symbol} ${a.name} ${a.issuer} ${a.tokenId||""}`.toLowerCase().includes(n)||Number(s.minCap||0)>0&&Number(a.marketCap||0)<Number(s.minCap||0)||Number(s.minVol||0)>0&&Number(a.volume24h||0)<Number(s.minVol||0)||s.hasDex&&!(Number(a.volume24h||0)>0||Number(a.holders||0)>100))return!1;if(s.type&&s.type!=="all"){let o=String(a.symbol||"").toLowerCase(),i=String(a.name||"").toLowerCase(),r=/usd|usdc|usdt|rlusd|eur|gbp/.test(o)||/stable/.test(i),l=/meme|dog|cat|frog|shib|pepe/.test(o)||/meme/.test(i),c=/mpt/.test(o)||/multi-purpose/.test(i);if(s.type==="stablecoin"&&!r||s.type==="meme"&&!l||s.type==="mpt"&&!c||s.type==="standard"&&(r||l||c))return!1}return!0})}function El(e){return[...e].sort((t,n)=>{let s=Number(t.volume24h||0),a=Number(n.volume24h||0);if(a!==s)return a-s;let o=Number(t.marketCap||0);return Number(n.marketCap||0)-o}).slice(0,24)}async function od(e){if(Pt.loading=!0,Pt.error="",Pt.items=[],!e){Pt.loading=!1;return}try{let t=await vi(e,20);Pt.items=t||[]}catch(t){Pt.error=(t==null?void 0:t.message)||"Could not load recent transactions."}finally{Pt.loading=!1}}function id(e){j.query=e,As&&clearTimeout(As),As=setTimeout(()=>{j.listLimit=240,j.filtered=os(j.query,j.tokens),U()},300)}function rd(e,t){j.filters={...j.filters,[e]:t},j.listLimit=240,j.filtered=os(j.query,j.tokens),U()}function ld(){As&&clearTimeout(As),j.query="",j.filters={type:"all",minCap:0,minVol:0,hasDex:!1},j.listLimit=240,j.filtered=os("",j.tokens),U()}function cd(){j.listLimit=Math.min(5e3,Number(j.listLimit||240)+240),U()}function dd(){let e=j.filtered;j.listLimit=Math.min(5e3,Math.max(240,e.length)),U()}function pd(){j.listLimit=240,U()}function ud(e){j.selectedTokenKey=e||"",U()}function md(e){let t=String(e||"").trim();if(!t)return;let n=ci();n.includes(t)||n.push(t),Ql(n),U()}function fd(e){let t=String(e||"").trim(),n=ci().filter(s=>s!==t);Ql(n),U()}async function Ia(e){let t=String(e||"").trim();if(!t)return;let n=String(t.includes("|")?t.split("|")[0]:t).toUpperCase(),s=t.includes("|")?j.tokens.find(o=>qe(o)===t):j.tokens.find(o=>String(o.symbol||"").toUpperCase()===String(n||"").toUpperCase());j.selectedTokenKey=s?qe(s):t.includes("|")?t:j.selectedTokenKey,M.tokenFocusKey=j.selectedTokenKey||t;let a={BTC:"BINANCE:BTCUSDT",ETH:"BINANCE:ETHUSDT",SOL:"BINANCE:SOLUSDT"};M.pair=a[n]||"BITSTAMP:XRPUSD",At(),U(),setTimeout(()=>mf(),20),await Fs(),At(),U()}async function hd(e){return Ia(e)}async function gd(){await ad(),U()}async function fi(){let e=document.getElementById("xpd-lookup-currency"),t=document.getElementById("xpd-lookup-issuer"),n=String((e==null?void 0:e.value)||"").trim().toUpperCase(),s=String((t==null?void 0:t.value)||"").trim();if(!n){he("Enter a currency code first.");return}if(!s||!He(s)){he("Enter a valid XRPL issuer address.");return}let a=`${n}|${s}`,o=j.tokens.find(i=>qe(i)===a);o||(o={symbol:n,name:n,issuer:s,price:null,marketCap:null,volume24h:null,holders:null,tokenId:""},j.tokens=[...j.tokens,o],j.filtered=os(j.query,j.tokens)),j.selectedTokenKey=a,e&&(e.value=""),t&&(t.value=""),await Ia(a)}async function bd(){var s,a;let e=String(((s=document.getElementById("xpd-lookup-currency"))==null?void 0:s.value)||"").trim().toUpperCase(),t=String(((a=document.getElementById("xpd-lookup-issuer"))==null?void 0:a.value)||"").trim();if(!e){he("Enter a currency code first.");return}if(!t||!He(t)){he("Enter a valid XRPL issuer address.");return}let n=`${e}|${t}`;await fi(),await di(n)}async function vd(){var t;let e=((t=Et())==null?void 0:t.address)||"";await od(e),U()}async function ns({silent:e=!1,force:t=!1}={}){var s;if(!t&&!La())return;let n=((s=Et())==null?void 0:s.address)||"";e||ne("Refreshing XRPL dashboard data..."),await Promise.allSettled([Fs(),ic(),ad(),od(n),rc(n),lc(n),dc()]),U()}function yd(){return ic()}function wd(){var e;return rc(((e=Et())==null?void 0:e.address)||"")}function xd(){var e;return lc(((e=Et())==null?void 0:e.address)||"")}function kd(){return dc()}function $d(e){ne(`NFT ${e.slice(0,12)}... selected. Send flow can be wired to NFTokenCreateOffer.`)}function Is(){let e=w("profile-metrics-row");if(!e)return;let t=!1,n=Object.values(Ze).reduce((p,d)=>p+((d==null?void 0:d.xrp)||0),0),s=Sd(),a=Object.values(Ze).flatMap(p=>(p==null?void 0:p.tokens)||[]),o=Et(),i=o?Ls[o.address]:null,r=(i==null?void 0:i.ownerCount)||0,l=Ca+r*Pa,c=o!=null&&o.createdAt?Lh(new Date(o.createdAt)):"\u2014",u=(i==null?void 0:i.sequence)!=null?i.sequence:"\u2014";e.innerHTML=`
    ...
    <div class="pmetric pmetric-reserve" title="${r} owned objects \xD7 ${Pa} XRP + ${Ca} XRP base">
      <div class="pmetric-val pmetric-reserve-val">${l} XRP</div>
      <div class="pmetric-label">Reserved</div></div>`:""}`,o&&(!Ls[o.address]||Date.now()-Ls[o.address].fetchedAt>6e4)&&Mh(o.address).then(()=>Is())}async function Mh(e){try{let t=await at({method:"account_info",params:[{account:e,ledger_index:"validated"}]});t!=null&&t.account_data&&(Ls[e]={sequence:t.account_data.Sequence,ownerCount:t.account_data.OwnerCount||0,fetchedAt:Date.now()})}catch{}}function Lh(e){let t=Math.floor((Date.now()-e.getTime())/864e5);if(t<1)return"Today";if(t<30)return`${t}d`;if(t<365)return`${Math.floor(t/30)}mo`;let n=Math.floor(t/365),s=Math.floor(t%365/30);return s?`${n}y ${s}mo`:`${n}y`}function Sd(){var t;if(Array.isArray((t=window.__dashSeries)==null?void 0:t.marketPrice)){let n=window.__dashSeries.marketPrice.at(-1);if(n!=null&&Number.isFinite(n))return n}let e=document.getElementById("mkt-price");if(e){let n=parseFloat(e.textContent.replace("$",""));if(!isNaN(n))return n}return 0}function Ah(){let e=oe.length>0,t=Object.values(Ke).some(Boolean),n=!!ce.bio,s=!!localStorage.getItem("naluxrp_last_backup_ts"),a=[e,t,n,s].filter(Boolean).length;return a===4?"":`
    <div class="onboarding-card">
      ...
      <div class="onb-items">
        ${Ta("\u{1F48E}","Generate your first XRPL wallet","Encrypted with AES-256-GCM, never leaves this device.",e,"openWalletCreator()")}
        ${Ta("\u{1F517}","Connect a social account","Link Discord, X, GitHub, or any platform.",t,"switchProfileTab('social')")}
        ${Ta("\u270F\uFE0F","Add a bio","Tell people who you are.",n,"openProfileEditor()")}
        ${Ta("\u{1F4BE}","Export an encrypted backup","Protect against device loss.",s,"exportVaultBackup()")}
      </div>
    </div>`}function Ta(e,t,n,s,a){return`<div class="onb-item ${s?"onb-item--done":""}" ${s?"":` onclick="${a}"`}>
  ...
  </div>`}function hi(){let e=w("profile-tab-social");if(!e)return;let t=Object.values(Ke).filter(Boolean).length;e.innerHTML=`
    ...
    <div class="social-grid">
      ${as.map(n=>{let s=Ke[n.id]||"",a=!!s;return`<div class="social-card ${a?"social-card--connected":""}" id="social-item-${n.id}">
    ...
    </div>`:""}`,Aa("stat-socials-val",t)}function Td(e){let t=as.find(l=>l.id===e);if(!t)return;let n=w("social-modal");if(!n)return;let s=w("social-modal-icon"),a=w("social-modal-title"),o=w("social-modal-sub"),i=w("social-modal-input"),r=w("social-modal-delete");s&&(s.className=`social-platform-icon-lg social-icon ${t.id}`,s.textContent=t.icon),a&&(a.textContent=`Connect ${t.label}`),o&&(o.textContent=`Enter your ${t.label} ${t.id==="discord"?"user ID or username":"username"}.`),i&&(i.value=Ke[e]||"",i.placeholder=`Your ${t.label} handle`),r&&(r.style.display=Ke[e]?"":"none"),n.dataset.platform=e,n.classList.add("show"),setTimeout(()=>i==null?void 0:i.focus(),80)}function Cd(){let e=w("social-modal"),t=e==null?void 0:e.dataset.platform,n=w("social-modal-input");if(!t||!n)return;let s=n.value.trim().replace(/^@/,"");s?Ke[t]=s:delete Ke[t],Kl(),hi(),is();let a=as.find(o=>o.id===t);cg(),kt("social_connected",`${(a==null?void 0:a.label)||t} @${s||"(removed)"}`),ne(`${a==null?void 0:a.label} updated`)}function Pd(){var t;let e=(t=w("social-modal"))==null?void 0:t.dataset.platform;e&&(delete Ke[e],Kl(),hi(),is(),kt("social_removed",e),ne("Social connection removed"))}function Md(e){let t=as.find(n=>n.id===e);t&&Ke[e]&&window.open(`${t.prefix}${Ke[e]}`,"_blank","noopener")}function is(){var e;(e=w("social-modal"))==null||e.classList.remove("show")}function $t(){let e=w("profile-tab-wallets");if(!e)return;if(oe.length===0){e.innerHTML=Ah()+`
    ...
    </div>`:"",n=oe.filter(a=>!ts||a.label.toLowerCase().includes(ts.toLowerCase())||a.address.toLowerCase().includes(ts.toLowerCase())),s=n.map((a,o)=>Eh(a,oe.indexOf(a))).join("");e.innerHTML=t+(n.length?s:`<div class="wcard-empty">No wallets match "${y(ts)}"</div>`)+`
    ...
    </div>`,Aa("stat-wallets-val",oe.length)}function Eh(e,t){let n=e.id===dt,s=!!e.watchOnly,a=Ze[e.address],o=Ls[e.address],r=!0||s,l=(o==null?void 0:o.ownerCount)||0,c=Ca+l*Pa,u=r?a?_(a.xrp,2):"\u2014":"\u2022\u2022\u2022\u2022",p=a&&r?Math.max(0,a.xrp-c):null,d=(a==null?void 0:a.tokens)||[],m=a!=null&&a.fetchedAt?Jl(a.fetchedAt):null,f=e.address.slice(0,8)+"\u2026"+e.address.slice(-6),g=bi(e.address);return`
  <div class="wcard ${n?"wcard--active":""} ${s?"wcard--watch":""}" id="wallet-item-${e.id}" style="--i:${t}">
    <div class="wcard-top">
      ...
      <div class="wcard-balance-col">
        ${g.length>=2?`<div class="wcard-sparkline">${Dd(g,70,22,e.color||"#00fff0")}</div>`:""}
        <div class="wcard-xrp ${r?"":"wcard-balance-locked"}">${u} <span class="wcard-xrp-label">XRP</span></div>
        ${p!==null&&r?`<div class="wcard-avail" title="${c} XRP reserved">${_(p,2)} avail.</div>`:""}
    ...
    ${o?`<div class="wcard-reserve-row">
      ...
      <span class="wcard-reserve-sub">${l} object${l!==1?"s":""} \xB7 base ${Ca} + ${l}\xD7${Pa}</span>
    </div>`:""}

    ${d.length&&r?`<div class="wcard-token-row">
      ${d.slice(0,6).map(v=>{let h=v.currency.length>4?$i(v.currency)||v.currency.slice(0,4)+"\u2026":v.currency;return`<div class="wcard-token-chip" onclick="openTokenDetailsModal('${y(v.currency)}','${y(v.issuer)}','${y(e.address)}')" title="${y(v.currency)}">
  ...
  </div>`}function Ld(e){var n;let t=oe[e];t&&(oe.splice(e,1),_s(),dt===t.id&&(dt=((n=oe[0])==null?void 0:n.id)||null,dt&&Z(Ns,dt)),$t(),Bt(),kt("wallet_removed",t.label),Nh(`Wallet "${t.label}" removed`,()=>{oe.splice(e,0,t),_s(),dt||(dt=t.id,Z(Ns,t.id)),$t(),Bt(),kt("wallet_created",t.label+" (restored)")},()=>{t.address&&bt(ti+t.address)}))}function Nh(e,t,n){let s=document.getElementById("undo-toast");s&&s.remove();let a=document.createElement("div");a.id="undo-toast",a.className="undo-toast",a.innerHTML=`<span class="undo-msg">${y(e)}</span><button class="undo-btn">Undo</button>`,document.body.appendChild(a),requestAnimationFrame(()=>a.classList.add("show"));let o=setTimeout(()=>{a.classList.remove("show"),setTimeout(()=>a.remove(),300),n==null||n()},5e3);a.querySelector(".undo-btn").addEventListener("click",()=>{clearTimeout(o),t(),a.classList.remove("show"),setTimeout(()=>a.remove(),300),ne("Wallet restored")})}function Ad(e){var n,s;let t=w("inspect-addr");t&&(t.value=e),(n=window.switchTab)==null||n.call(window,document.querySelector('[data-tab="inspector"]'),"inspector"),(s=window.showDashboard)==null||s.call(window)}function Ed(e){_n=_n===e?null:e,_n&&!pn[e]&&(pn[e]="txns"),$t(),_n&&setTimeout(()=>gi(e,pn[e]),60)}function Nd(e,t){pn[e]=t;let n=document.getElementById(`wcard-drawer-${e}`);n&&(n.querySelectorAll(".wdt-btn").forEach(s=>s.classList.toggle("active",s.textContent.toLowerCase().includes(t==="txns"?"trans":t==="nfts"?"nft":t==="orders"?"dex":"amm"))),gi(e,t))}async function gi(e,t){var a,o,i;let n=oe.find(r=>r.id===e),s=document.getElementById(`wcard-drawer-body-${e}`);if(!(!n||!s)){s.innerHTML='<div class="wdd-loading"><div class="spinner"></div> Loading\u2026</div>';try{t==="txns"?s.innerHTML=Rh(((a=si[n.address])==null?void 0:a.txns)||await vi(n.address),n.address):t==="nfts"?s.innerHTML=_h(((o=Fl[n.address])==null?void 0:o.nfts)||await qh(n.address),n.address):t==="orders"?s.innerHTML=Dh(((i=ai[n.address])==null?void 0:i.offers)||await Vh(n.address),n.id,n.address):t==="amm"&&(s.innerHTML=await Ih(n.address))}catch(r){s.innerHTML=`<div class="wdd-error">\u26A0\uFE0F ${y(r.message)}</div>`}}}function Rd(e){return{Payment:"\u{1F4B8}",OfferCreate:"\u{1F4CA}",OfferCancel:"\u2715",TrustSet:"\u{1F517}",NFTokenMint:"\u{1F3A8}",NFTokenBurn:"\u{1F525}",NFTokenCreateOffer:"\u{1F3AF}",NFTokenAcceptOffer:"\u2705",AMMCreate:"\u{1F30A}",AMMDeposit:"\u{1F4E5}",AMMWithdraw:"\u{1F4E4}",AMMVote:"\u{1F5F3}",AMMBid:"\u{1F4A1}",EscrowCreate:"\u23F3",EscrowFinish:"\u2705",EscrowCancel:"\u2715",AccountSet:"\u2699",SetRegularKey:"\u{1F511}",SignerListSet:"\u{1F4CB}"}[e]||"\u{1F4C4}"}function ei(e){return e?typeof e=="string"?`${_(Number(e)/1e6,4)} XRP`:`${_(parseFloat(e.value||0),4)} ${(e.currency||"?").length>4?e.currency.slice(0,4)+"\u2026":e.currency}`:"\u2014"}function Rh(e,t){return e!=null&&e.length?`<div class="wdd-tx-list">
    ${e.slice(0,25).map(n=>{var c,u;let s=n.TransactionType||"?",a=n.Account===t,o=!(((c=n.metaData)==null?void 0:c.TransactionResult)||((u=n.meta)==null?void 0:u.TransactionResult)||"").match(/^tec|^tem|^tef|^tel/),i=n.date?(n.date+946684800)*1e3:0,r=i?new Date(i).toLocaleDateString("en-US",{month:"short",day:"numeric",hour:"2-digit",minute:"2-digit"}):"\u2014",l=n.hash||n.tx_hash||"";return`<div class="wdd-tx-row ${o?"":"wdd-tx-failed"}">
        <div class="wdd-tx-icon">${Rd(s)}</div>
        <div class="wdd-tx-body">
          ...
          <div class="wdd-tx-detail">
            ${n.Amount?`<span class="wdd-tx-amount">${ei(n.Amount)}</span>`:""}
            ${n.Destination?`<span class="wdd-tx-dest mono">${Ol[n.Destination]||n.Destination.slice(0,8)+"\u2026"+n.Destination.slice(-5)}</span>`:""}
          </div>
        </div>
  ...
  </div>`:'<div class="wdd-empty"><div class="wdd-empty-icon">\u{1F4CB}</div><div>No transactions yet.</div><div class="wdd-empty-sub">Fund with 10 XRP to activate.</div></div>'}function _h(e,t){return e!=null&&e.length?`<div class="wdd-nft-header"><span>${e.length} NFT${e.length>1?"s":""}</span>
    ...
    <div class="wdd-nft-grid">
      ${e.slice(0,24).map(n=>{var i;let s=n.nft_serial??((i=n.NFTokenID)==null?void 0:i.slice(-6))??"?",a=n.URI&&$i(n.URI)||"",o=a.startsWith("ipfs://")?`https://cloudflare-ipfs.com/ipfs/${a.slice(7)}`:"";return`<div class="wdd-nft-card">
    ...
    ${e.length>24?`<div class="wdd-more-note">${e.length-24} more on XRPScan</div>`:""}`:'<div class="wdd-empty"><div class="wdd-empty-icon">\u{1F3A8}</div><div>No NFTs in this wallet.</div></div>'}function Dh(e,t,n){return e!=null&&e.length?`<div class="wdd-orders-header"><span>${e.length} open order${e.length>1?"s":""}</span></div>
    <div class="wdd-orders-list">
      ${e.map(s=>`<div class="wdd-order-row">
        ...
        <div class="wdd-order-pair">
          <span class="wdd-order-gets">${ei(s.TakerGets)}</span>
          <span class="wdd-order-arrow">\u21C4</span>
          <span class="wdd-order-pays">${ei(s.TakerPays)}</span>
        </div>
        <div class="wdd-order-seq mono">Seq #${s.seq||"?"}</div>
        <button class="wdd-order-cancel" onclick="cancelOffer('${t}',${s.seq},this)">\u2715 Cancel</button>
      </div>`).join("")}
    </div>`:'<div class="wdd-empty"><div class="wdd-empty-icon">\u{1F4CA}</div><div>No open DEX orders.</div></div>'}async function Ih(e){try{let n=(ni[e]||[]).filter(s=>{var a;return((a=s.currency)==null?void 0:a.length)===40});return n.length?`<div class="wdd-amm-list">
    ...
    </div>`:'<div class="wdd-empty"><div class="wdd-empty-icon">\u{1F30A}</div><div>No AMM LP positions.</div><div class="wdd-empty-sub">Deposit into an AMM pool to earn fees.</div></div>'}catch(t){return`<div class="wdd-error">\u26A0\uFE0F ${y(t.message)}</div>`}}async function _d(e,t,n){let s=prompt("Optional seed to cancel this order (leave blank to use wallet password):");if(s!==null){n&&(n.disabled=!0,n.textContent="\u2026");try{let a=await Zh(e,t,s);if(Jh(a)){ne("Order cancelled \u2713");let o=oe.find(i=>i.id===e);o&&(delete ai[o.address],gi(e,"orders"))}else jt("Cancel failed: "+Yh(a)),n&&(n.disabled=!1,n.textContent="\u2715 Cancel")}catch(a){jt(a.message),n&&(n.disabled=!1,n.textContent="\u2715 Cancel")}}}function Fh(){let e=w("profile-tab-activity");if(!e)return;let t=bf(),n=Et();e.innerHTML=`
    <div class="act-section-row">
      <div class="act-section">
        ...
        ${t.length?`<div class="act-timeline">${t.slice(0,20).map(s=>`
            <div class="act-entry">
              <div class="act-entry-icon">${pf[s.type]||"\u25CF"}</div>
    ...
    <div class="settings-card">
      ...
      <div class="settings-kv-list">
        ...
        <div class="settings-kv"><span class="settings-k">Vault created</span><span class="settings-v">${y((i=(o=Ye.vault)==null?void 0:o.identity)!=null&&i.createdAt?new Date(Ye.vault.identity.createdAt).toLocaleDateString():"\u2014")}</span></div>
    ...
    <div class="settings-card settings-card--danger">
  ...
  </div>`}async function Oh(){var t;let e=w("profile-tab-analytics");if(e){e.innerHTML='<div class="analytics-grid"><div class="skeleton-card analytics-card--wide" style="height:80px"></div><div class="skeleton-card" style="height:160px"></div><div class="skeleton-card" style="height:160px"></div></div>';try{let n=Et(),s=Object.values(Ze).reduce((r,l)=>r+((l==null?void 0:l.xrp)||0),0),a=Sd(),o=Object.values(Ze).flatMap(r=>(r==null?void 0:r.tokens)||[]),i=[];if(n)try{i=((t=si[n.address])==null?void 0:t.txns)||await vi(n.address,100)}catch{}e.innerHTML=`<div class="analytics-grid">
      <div class="analytics-card analytics-card--wide">
        ...
        <div class="portfolio-summary-row">
          ${oe.length?oe.map(r=>{let l=Ze[r.address],c=l?_(l.xrp,2):"\u2014",u=l&&a?`$${_(l.xrp*a,2)}`:"",p=bi(r.address);return`<div class="portfolio-wallet-row">
                ...
                <div class="pwr-sparkline">${Dd(p,80,28,r.color||"#00fff0")}</div>
      ...
      <div class="analytics-card analytics-card--wide">
        ...
        ${n?Xh(i):'<div class="analytics-empty">Activate a wallet to see activity.</div>'}
      </div>
      ...
      <div class="analytics-card">
        ...
        ${i.length?Hh(i):'<div class="analytics-empty-chart"><div class="aec-icon">\u{1F4CA}</div><div>Transaction breakdown builds up as this wallet transacts.</div></div>'}
      </div>
      ...
      <div class="analytics-card">
        ...
        ${n&&i.length?Wh(i,n.address):`<div class="analytics-empty-chart"><div class="aec-icon">\u{1F4B0}</div><div>${n?"XRP flow needs at least one transaction to estimate.":"Activate a wallet to see XRP flow."}</div></div>`}
      </div>
      ...
      <div class="analytics-card">
        ...
        ${o.length?zh(o):'<div class="analytics-empty-chart"><div class="aec-icon">\u{1FA99}</div><div>No token trustlines held by any wallet yet.</div></div>'}
      </div>
    </div>`}catch(n){hf(e,"analytics",n)}}}function Dd(e,t,n,s){if(e.length<2)return`<svg width="${t}" height="${n}"><line x1="0" y1="${n/2}" x2="${t}" y2="${n/2}" stroke="${s}" stroke-opacity=".2" stroke-width="1" stroke-dasharray="3 2"/></svg>`;let a=e.map(p=>p.xrp),o=Math.min(...a),i=Math.max(...a),r=i-o||1,l=a.map((p,d)=>`${3+d/(a.length-1)*(t-6)},${3+(1-(p-o)/r)*(n-6)}`),[c,u]=l[l.length-1].split(",");return`<svg width="${t}" height="${n}" viewBox="0 0 ${t} ${n}">
  ...
  </svg>`}function Bh(e){let t=bi(e);if(t.length<2)return`<div class="analytics-empty-chart"><div class="aec-icon">\u{1F4CA}</div><div>Balance history builds up as you refresh your wallet over time.</div><div class="aec-sub">${t.length} snapshot${t.length!==1?"s":""} recorded.</div></div>`;let n=560,s=130,a=52,o=12,i=14,r=30,l=t.map(R=>R.xrp),c=t.map(R=>R.ts),u=Math.min(...l),p=Math.max(...l),d=p-u||1,m=c[0],f=c[c.length-1],g=f-m||1,v=R=>a+(R-m)/g*(n-a-o),h=R=>i+(1-(R-u)/d)*(s-i-r),b=t.map(R=>`${v(R.ts).toFixed(1)},${h(R.xrp).toFixed(1)}`),x=v(c[0]),k=v(c[c.length-1]),T=l[l.length-1]-l[0],S=T>=0,$=l[0]?Math.abs(T/l[0]*100).toFixed(2):"0.00",E=S?"#00d4ff":"#ff5555",C=[u,(u+p)/2,p].map(R=>({v:R,y:h(R),l:_(R,2)})),P=[0,.5,1].map(R=>({x:a+R*(n-a-o),l:new Date(m+R*g).toLocaleDateString("en-US",{month:"short",day:"numeric"})}));return`
  ...
  <div class="heatmap-scroll"><svg class="heatmap-svg" viewBox="0 0 ${c} ${u}" width="${c}" height="${u}">
    ...
    ${r.map((f,g)=>f.map((v,h)=>{let b=v.toISOString().slice(0,10),x=t.get(b)||0;return`<rect x="${26+g*(s+a)}" y="${16+h*(s+a)}" width="${s}" height="${s}" rx="2" fill="${p(x/l)}" opacity="${x>0?.9:.25}"><title>${b}: ${x} tx</title></rect>`}).join("")).join("")}
  </svg></div>`}function Hh(e){let t=new Map;e.forEach(a=>t.set(a.TransactionType||"?",(t.get(a.TransactionType||"?")||0)+1));let n=[...t.entries()].sort((a,o)=>o[1]-a[1]),s=e.length;return`<div class="tx-breakdown-list">${n.slice(0,8).map(([a,o])=>`<div class="txb-row"><div class="txb-icon">${Rd(a)}</div><div class="txb-type">${a}</div><div class="txb-bar-wrap"><div class="txb-bar" style="width:${(o/s*100).toFixed(0)}%"></div></div><div class="txb-count">${o}</div></div>`).join("")}</div>`}function zh(e){let t=new Map;e.forEach(o=>{let i=Math.abs(parseFloat(o.balance||0));t.set(o.currency,(t.get(o.currency)||0)+i)});let n=[...t.entries()].sort((o,i)=>i[1]-o[1]).slice(0,8),s=n.reduce((o,[,i])=>o+i,0)||1,a=["#00fff0","#00d4ff","#bd93f9","#50fa7b","#ffb86c","#ff79c6","#f1fa8c","#ff5555"];return`<div class="token-alloc-list">${n.map(([o,i],r)=>{let l=(i/s*100).toFixed(1),c=a[r%a.length],u=o.length>4?o.slice(0,4)+"\u2026":o;return`<div class="ta-row"><div class="ta-swatch" style="background:${c}"></div><div class="ta-cur mono">${u}</div><div class="ta-bar-wrap"><div class="ta-bar" style="width:${l}%;background:${c}20;border-color:${c}55"></div></div><div class="ta-pct">${l}%</div></div>`}).join("")}</div>`}function Wh(e,t){let n=0,s=0;e.forEach(i=>{var c,u;if(i.TransactionType!=="Payment"||!((((c=i.metaData)==null?void 0:c.TransactionResult)||((u=i.meta)==null?void 0:u.TransactionResult))==="tesSUCCESS")||typeof i.Amount!="string")return;let l=Number(i.Amount)/1e6;i.Destination===t&&(n+=l),i.Account===t&&(s+=l)});let a=n-s,o=a>=0;return`<div class="xrp-flow-grid">
  ...
  <div class="xrf-note">Based on ${e.length} fetched Payment TXs. Excludes fees and DEX fills.</div>`}async function at(e){var n,s;try{if(((n=X.wsConn)==null?void 0:n.readyState)===1){let{wsSend:a}=await import("./xrpl-6AERZ5KD.js"),o={command:e==null?void 0:e.method,...((s=e==null?void 0:e.params)==null?void 0:s[0])||{}},i=await a(o);if((i==null?void 0:i.status)==="error")throw new Error(i.error_message||i.error||"XRPL RPC error");return(i==null?void 0:i.result)||null}}catch{}let t=async a=>{let o=await fetch(a,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(e),mode:"cors"});if(!o.ok)throw new Error(`HTTP ${o.status}`);return(await o.json()).result};try{return await t(Hm)}catch{return await t(zm)}}async function On(e){var t;try{let n=[],s;do{let l=await at({method:"account_lines",params:[{account:e,ledger_index:"current",limit:400,...s?{marker:s}:{}}]});if(!l||l.error)break;n.push(...l.lines||[]),s=l.marker}while(s);let a=await at({method:"account_info",params:[{account:e,ledger_index:"current"}]});if(a!=null&&a.error)return null;let o=Number(a.account_data.Balance)/1e6,i=n.map(l=>({currency:l.currency,issuer:l.account,balance:l.balance,limit:l.limit}));Ze[e]={xrp:o,tokens:i,fetchedAt:Date.now()},ni[e]=i,Uh(e,o);let r=document.getElementById("awb-balance");return r&&e===((t=Et())==null?void 0:t.address)&&dg(r.querySelector(".awb-xrp-num")||r,o,2,600),Ze[e]}catch{return null}}async function jh(){await Promise.allSettled(oe.map(e=>On(e.address))),$t(),Bt(),Is()}function Uh(e,t){let n=ti+e,s=ge(Q(n))||[],a=Date.now();s.length&&a-s[s.length-1].ts<5*6e4?s[s.length-1]={xrp:t,ts:a}:s.push({xrp:t,ts:a}),s.length>90&&s.splice(0,s.length-90),Z(n,JSON.stringify(s))}function bi(e){return ge(Q(ti+e))||[]}async function vi(e,t=25){let n=await at({method:"account_tx",params:[{account:e,limit:t,ledger_index_min:-1,ledger_index_max:-1}]}),s=((n==null?void 0:n.transactions)||[]).map(a=>a.tx||a.transaction||a);return si[e]={txns:s,fetchedAt:Date.now()},s}async function qh(e){let t=await at({method:"account_nfts",params:[{account:e,limit:50}]}),n=(t==null?void 0:t.account_nfts)||[];return Fl[e]={nfts:n,fetchedAt:Date.now()},n}async function Vh(e){let t=await at({method:"account_offers",params:[{account:e,limit:50}]}),n=(t==null?void 0:t.offers)||[];return ai[e]={offers:n,fetchedAt:Date.now()},n}async function Gh(e){let t=await at({method:"account_info",params:[{account:e,ledger_index:"current"}]});return(t==null?void 0:t.account_data)||null}async function Kh(){let e=await at({method:"ledger",params:[{ledger_index:"current"}]});return(e==null?void 0:e.ledger_current_index)||0}function Jh(e){let t=(e==null?void 0:e.engine_result)||"";return t==="tesSUCCESS"||t.startsWith("tes")||(e==null?void 0:e.engine_result_code)===0}function Yh(e){let t=(e==null?void 0:e.engine_result)||"";return Qm[t]||(e==null?void 0:e.engine_result_message)||t||"Unknown error"}async function Qh(e,t,n){if(await Ea(),!window.xrpl)throw new Error("xrpl.js library not loaded. Cannot sign transactions.");let s=oe.find(i=>i.id===e);if(!s)throw new Error("Wallet not found.");if(s.watchOnly)throw new Error("Watch-only wallets cannot sign transactions.");let a=await tf(s,n),o;try{o=window.xrpl.Wallet.fromSeed(a,{algorithm:s.algo==="secp256k1"?"secp256k1":"ed25519"})}catch(i){throw new Error("Invalid seed phrase: "+i.message)}if(o.classicAddress!==s.address)throw new Error("Seed does not match this wallet address.");try{let[i,r]=await Promise.all([Gh(s.address),Kh()]);if(!i)throw new Error("Account not found on-chain. Fund with at least 10 XRP first (base reserve requirement).");let l={...t,Account:s.address,Fee:"12",Sequence:i.Sequence,LastLedgerSequence:r+20},{tx_blob:c,hash:u}=o.sign(l);return{...await at({method:"submit",params:[{tx_blob:c}]}),tx_hash:u}}finally{}}async function Zh(e,t,n){return Qh(e,{TransactionType:"OfferCancel",OfferSequence:parseInt(t)},n)}function eg(){if(w("send-modal-overlay"))return;let e=document.createElement("div");e.innerHTML=`
  <!-- Send -->
  ...
  <div class="generic-modal-overlay" id="token-details-modal">
  ...
  </div>`,document.body.appendChild(e),["send-modal-overlay","receive-modal-overlay","trustline-modal-overlay","import-address-modal","import-seed-modal","token-details-modal"].forEach(t=>{let n=document.getElementById(t);n==null||n.addEventListener("click",s=>{s.target===n&&(n.classList.remove("show"),n.style.display="")})})}function Id(){var o;["displayName","handle","bio","location","website"].forEach(i=>{let r=w(`edit-${i}`);r&&(r.value=ce[i]||"")});let e=w("editor-avatar-preview");if(e){let i=localStorage.getItem(un);e.innerHTML=i?`<img src="${i}" class="profile-avatar-img"/>`:ce.avatar||"\u{1F30A}"}let t=w("avatar-remove-btn");t&&(t.style.display=localStorage.getItem(un)?"":"none");let n=w("editor-banner-preview");if(n){let i=localStorage.getItem(In);n.style.backgroundImage=i?`url(${i})`:"",n.style.backgroundSize="cover",n.style.backgroundPosition="center",Rs.forEach(r=>n.classList.remove(r)),i||n.classList.add(ce.banner||"banner-ocean")}let s=w("avatar-picker-grid");s&&(s.innerHTML=Km.map(i=>`<div class="avatar-option ${ce.avatar===i?"active":""}" onclick="selectAvatar('${i}')">${i}</div>`).join(""));let a=w("banner-picker-grid");a&&(a.innerHTML=Rs.map(i=>`<div class="banner-option ${i} ${ce.banner===i?"active":""}" onclick="selectBanner('${i}')"></div>`).join("")),(o=w("profile-editor-modal"))==null||o.classList.add("show")}function Xs(){var e;(e=w("profile-editor-modal"))==null||e.classList.remove("show")}function Fd(){var e,t,n,s,a;ce.displayName=((e=w("edit-displayName"))==null?void 0:e.value.trim())||ce.displayName,ce.handle=(((t=w("edit-handle"))==null?void 0:t.value.trim())||ce.handle).replace(/^@/,"").replace(/\s+/g,"_").toLowerCase(),ce.bio=((n=w("edit-bio"))==null?void 0:n.value.trim())||"",ce.location=((s=w("edit-location"))==null?void 0:s.value.trim())||"",ce.website=((a=w("edit-website"))==null?void 0:a.value.trim())||"",Gl(),kt("profile_saved","Profile details updated"),U(),Xs(),ne("Profile saved")}function Od(e){localStorage.removeItem(un),ce.avatar=e,Xe(".avatar-option").forEach(s=>s.classList.toggle("active",s.textContent===e));let t=w("editor-avatar-preview");t&&(t.innerHTML=e);let n=w("avatar-remove-btn");n&&(n.style.display="none")}function Bd(e){localStorage.removeItem(In),ce.banner=e,Xe(".banner-option").forEach(n=>n.classList.toggle("active",n.classList.contains(e)));let t=w("editor-banner-preview");t&&(t.style.backgroundImage="",Rs.forEach(n=>t.classList.remove(n)),t.classList.add(e)),U()}function Xd(e){var s;let t=(s=e==null?void 0:e.files)==null?void 0:s[0];if(!t)return;if(t.size>2*1024*1024){he("Image too large \u2014 max 2 MB");return}let n=new FileReader;n.onload=a=>{let o=new Image;o.onload=()=>{let i=document.createElement("canvas");i.width=i.height=200;let r=i.getContext("2d"),l=Math.min(o.width,o.height);r.drawImage(o,(o.width-l)/2,(o.height-l)/2,l,l,0,0,200,200);let c=i.toDataURL("image/jpeg",.85);localStorage.setItem(un,c);let u=w("editor-avatar-preview");u&&(u.innerHTML=`<img src="${c}" class="profile-avatar-img"/>`);let p=w("avatar-remove-btn");p&&(p.style.display=""),U(),ne("Profile photo updated")},o.src=a.target.result},n.readAsDataURL(t),e.value=""}function Hd(){localStorage.removeItem(un);let e=w("editor-avatar-preview");e&&(e.innerHTML=ce.avatar||"\u{1F30A}");let t=w("avatar-remove-btn");t&&(t.style.display="none"),U()}function zd(e){var s;let t=(s=e==null?void 0:e.files)==null?void 0:s[0];if(!t)return;if(t.size>5*1024*1024){he("Image too large \u2014 max 5 MB");return}let n=new FileReader;n.onload=a=>{let o=new Image;o.onload=()=>{let i=document.createElement("canvas");i.width=900,i.height=180;let r=i.getContext("2d"),l=Math.max(900/o.width,180/o.height);r.drawImage(o,(900-o.width*l)/2,(180-o.height*l)/2,o.width*l,o.height*l);let c=i.toDataURL("image/jpeg",.88);localStorage.setItem(In,c);let u=w("editor-banner-preview");u&&(u.style.backgroundImage=`url(${c})`,u.style.backgroundSize="cover",u.style.backgroundPosition="center",Rs.forEach(d=>u.classList.remove(d)));let p=w("banner-remove-btn");p&&(p.style.display=""),U(),ne("Banner updated")},o.src=a.target.result},n.readAsDataURL(t),e.value=""}function Wd(){localStorage.removeItem(In);let e=w("editor-banner-preview");e&&(e.style.backgroundImage="",Rs.forEach(n=>e.classList.remove(n)),e.classList.add(ce.banner||"banner-ocean"));let t=w("banner-remove-btn");t&&(t.style.display="none"),U()}function tg(){let e=oe.map(({id:n,label:s,address:a,algo:o,emoji:i,color:r,testnet:l,watchOnly:c,createdAt:u})=>({id:n,label:s,address:a,algo:o,emoji:i,color:r,testnet:l,watchOnly:c,createdAt:u})),t=document.createElement("a");t.href="data:application/json;charset=utf-8,"+encodeURIComponent(JSON.stringify(e,null,2)),t.download=`nalulf-wallets-${new Date().toISOString().slice(0,10)}.json`,t.click(),kt("backup_exported","Wallet addresses exported"),ne("Wallet addresses exported")}function jd(){tg()}function yi(){var e;wt=1,ve={algo:"ed25519",label:"",emoji:"\u{1F48E}",color:"#50fa7b",seed:"",address:"",passphrase:""},Dn.clear(),wi(1),sg(),ng(),(e=w("wallet-creator-overlay"))==null||e.classList.add("show"),setTimeout(()=>{var t;return(t=w("wallet-label-input"))==null?void 0:t.focus()},80)}function Hs(){var e;(e=w("wallet-creator-overlay"))==null||e.classList.remove("show"),ve.seed=ve.address=ve.passphrase=""}function ng(){let e=w("wizard-security-banner");e&&(e.innerHTML=`<div class="wsb-icon">\u{1F510}</div>
    ...
    </div>`).join("")}async function ig(){var n;let e=await Il(ve.seed,ve.passphrase),t={id:crypto.randomUUID(),label:ve.label,address:ve.address,algo:ve.algo,emoji:ve.emoji,color:ve.color,testnet:((n=w("wallet-testnet-check"))==null?void 0:n.checked)||!1,watchOnly:!1,encSeed:e,createdAt:new Date().toISOString()};oe.push(t),_s(),dt||(dt=t.id,Z(Ns,t.id)),$t(),Bt(),Aa("wallet-success-address",ve.address),setTimeout(()=>{ve.seed="",ve.address="",ve.passphrase=""},100),kt("wallet_created",ve.label||"New XRPL Wallet"),ne("Wallet created and encrypted locally"),On(t.address).then(()=>$t())}function Vd(e){ve.algo=e,Xe(".algo-card").forEach(t=>t.classList.toggle("active",t.dataset.algo===e))}function Gd(e){ve.emoji=e,Xe(".wallet-emoji-opt").forEach(t=>t.classList.toggle("active",t.textContent===e))}function Kd(e){ve.color=e,Xe(".color-swatch").forEach(t=>t.classList.toggle("active",t.style.background===e||t.dataset.color===e))}function Jd(e){let t=document.querySelector(`.security-check-${e}`);if(!t)return;let n=t.querySelector(".check-box");Dn.has(e)?(Dn.delete(e),t.classList.remove("checked"),n&&(n.textContent="")):(Dn.add(e),t.classList.add("checked"),n&&(n.textContent="\u2713")),Yd()}function Yd(){let e=w("wizard-next-btn");e&&wt===2&&(e.disabled=Dn.size<4)}function Qd(){var t;(t=w("wizard-seed-value"))==null||t.classList.remove("blur");let e=w("seed-reveal-hint");e&&(e.style.display="none"),setTimeout(()=>{var n;return(n=w("wizard-seed-value"))==null?void 0:n.classList.add("blur")},3e4)}function Zd(){let e=w("wizard-seed-value");if(!e)return;Fa(e.textContent,3e4);let t=w("btn-copy-seed");t&&(t.textContent="Copied!",t.classList.add("copied"),setTimeout(()=>{t.textContent="Copy Seed",t.classList.remove("copied")},2e3))}function ep(){let e=w("wizard-address-value")||w("wallet-success-address");if(!e)return;Fa(e.textContent);let t=w("btn-copy-addr");t&&(t.textContent="Copied!",t.classList.add("copied"),setTimeout(()=>{t.textContent="Copy",t.classList.remove("copied")},2e3))}function tp(){let e=w("import-address-modal");if(!e)return;e.querySelector("#inp-import-address").value="",e.querySelector("#inp-import-label").value="";let t=e.querySelector("#import-address-error");t&&(t.textContent=""),e.classList.add("show"),setTimeout(()=>{var n;return(n=e.querySelector("#inp-import-address"))==null?void 0:n.focus()},80)}function xi(){var e;(e=w("import-address-modal"))==null||e.classList.remove("show")}function np(){var s,a;let e=(((s=w("inp-import-address"))==null?void 0:s.value)||"").trim(),t=(((a=w("inp-import-label"))==null?void 0:a.value)||"").trim()||"Watch Wallet",n=w("import-address-error");if(!He(e)){n&&(n.textContent="Enter a valid XRPL address (starts with r\u2026)");return}if(oe.find(o=>o.address===e)){n&&(n.textContent="This address is already in your list.");return}oe.push({id:"watch_"+Date.now(),label:t,address:e,algo:"\u2014",emoji:"\u{1F441}",color:"#8be9fd",testnet:!1,createdAt:new Date().toISOString(),watchOnly:!0}),_s(),kt("watch_added",`${t} (${e.slice(0,8)}\u2026)`),xi(),$t(),Bt(),Is(),On(e).then(()=>{$t(),Is()}),ne(`\u{1F441} Watch-only wallet added: ${t}`)}function sp(){let e=w("import-seed-modal");if(!e)return;e.querySelector("#inp-import-seed").value="",e.querySelector("#inp-import-seed-pass").value="",e.querySelector("#inp-import-seed-pass-confirm").value="",e.querySelector("#inp-import-seed-label").value="";let t=e.querySelector("#import-seed-error");t&&(t.textContent=""),e.classList.add("show"),setTimeout(()=>{var n;return(n=e.querySelector("#inp-import-seed"))==null?void 0:n.focus()},80)}function ki(){var e;(e=w("import-seed-modal"))==null||e.classList.remove("show")}async function ap(){var r,l,c,u,p;let e=(((r=w("inp-import-seed"))==null?void 0:r.value)||"").trim(),t=(((l=w("inp-import-seed-label"))==null?void 0:l.value)||"").trim()||"Imported Wallet",n=(((c=w("inp-import-seed-pass"))==null?void 0:c.value)||"").trim(),s=(((u=w("inp-import-seed-pass-confirm"))==null?void 0:u.value)||"").trim(),a=w("import-seed-error"),o=w("import-seed-btn"),i=d=>{a&&(a.textContent=d)};if(i(""),!e)return i("Enter your seed phrase.");if(n.length<10)return i("Use a wallet password with at least 10 characters.");if(n!==s)return i("Wallet password confirmation does not match.");if(await Ea(),!window.xrpl)return i("xrpl.js not loaded \u2014 cannot derive address from seed.");o&&(o.disabled=!0,o.textContent="Importing\u2026");try{let d=window.xrpl.Wallet.fromSeed(e),m=d.address,f=(p=d.algorithm)!=null&&p.toLowerCase().includes("ed")?"ed25519":"secp256k1";if(oe.find(x=>x.address===m))return i("This address is already in your vault.");let g="imp_"+Date.now(),v="\u{1F511}",h="#bd93f9",b=await Il(e,n);oe.push({id:g,label:t,address:m,algo:f,emoji:v,color:h,testnet:!1,watchOnly:!1,encSeed:b,createdAt:new Date().toISOString()}),_s(),kt("wallet_imported",`${t} (${m.slice(0,8)}\u2026)`),ki(),$t(),Bt(),On(m).then(()=>{$t(),Is()}),ne(`\u{1F511} Wallet imported: ${t}`)}catch(d){i("Invalid seed: "+(d.message||"Could not derive wallet."))}finally{o&&(o.disabled=!1,o.textContent="Import Wallet \u2192");let d=document.getElementById("inp-import-seed");d&&(d.value="");let m=document.getElementById("inp-import-seed-pass");m&&(m.value="");let f=document.getElementById("inp-import-seed-pass-confirm");f&&(f.value="")}}function op(e,t,n){var u;let s=w("token-details-modal");if(!s)return;let a=s.querySelector(".generic-modal");if(!a)return;let o=Ze[n],i=(u=o==null?void 0:o.tokens)==null?void 0:u.find(p=>p.currency===e&&p.issuer===t),r=i?_(parseFloat(i.balance||0),6):"\u2014",l=i!=null&&i.limit?_(parseFloat(i.limit),2):"Unlimited",c=e.length>4&&$i(e)||e;a.innerHTML=`
    <div class="tdm-hdr">
    ...
    </div>`,s.classList.add("show")}function ip(){let e=w("token-details-modal");e&&(e.classList.remove("show"),e.style.display="")}function rp(){var s;(s=document.getElementById("pub-profile-overlay"))==null||s.remove();let e=localStorage.getItem(un),t=as.filter(a=>Ke[a.id]),n=document.createElement("div");n.id="pub-profile-overlay",n.className="pub-profile-overlay",n.innerHTML=`
    <div class="pub-profile-modal">
      ...
      ${t.length?`<div class="pub-socials">${t.map(a=>`<span class="pub-social-badge"><span>${a.icon}</span><span>@${y(Ke[a.id])}</span></span>`).join("")}</div>`:'<div style="padding:0 20px 16px;font-size:.82rem;color:rgba(255,255,255,.3)">No social accounts connected yet.</div>'}
    ...
    </div>`,document.body.appendChild(n),requestAnimationFrame(()=>requestAnimationFrame(()=>n.classList.add("show"))),n.addEventListener("click",a=>{a.target===n&&n.remove()})}function lp(e){Pn(e),Bs(),kt("theme_changed",e)}function cp(e){Z("nalulf_pref_currency",e),Bs(),ne(`Display currency: ${e}`)}function dp(e){Z("nalulf_pref_network",e),Bs(),ne(`Default network: ${e}`)}function pp(e){Z("nalulf_pref_autolock",e),Bs(),ne(`Auto-lock: ${e} minutes`)}window._profileWipeAllData=()=>{confirm("Clear all profile, wallet list, social, and activity data? Encrypted wallet seeds saved on this device will be deleted.")&&(["nalulf_profile","nalulf_wallets","nalulf_social","nalulf_activity_log","nalulf_avatar_img","nalulf_banner_img","naluxrp_active_wallet"].forEach(e=>localStorage.removeItem(e)),oe=[],Ke={},dt=null,Ze={},ni={},Go(),U(),ri("wallets"),ne("Local data cleared"))};function rg(){var e,t,n;(e=w("profile-editor-modal"))==null||e.addEventListener("click",s=>{s.target===s.currentTarget&&Xs()}),(t=w("wallet-creator-overlay"))==null||t.addEventListener("click",s=>{s.target===s.currentTarget&&Hs()}),(n=w("social-modal"))==null||n.addEventListener("click",s=>{s.target===s.currentTarget&&is()})}function lg(){let e=[{done:!!ce.displayName&&ce.displayName!=="Anonymous",label:"Display name"},{done:!!ce.bio,label:"Bio"},{done:ce.avatar!=="\u{1F30A}"||!!localStorage.getItem(un),label:"Custom avatar"},{done:!!localStorage.getItem(In),label:"Custom banner"},{done:oe.length>0,label:"Wallet added"},{done:Object.keys(Ke).length>=1,label:"Social connected"},{done:!!ce.location,label:"Location set"},{done:!!ce.website,label:"Website added"}],t=e.filter(n=>n.done).length;return{pct:Math.round(t/e.length*100),done:t,total:e.length,checks:e}}function cg(){let e=document.getElementById("profile-completeness");if(!e)return;let{pct:t,checks:n}=lg(),s=t===100?"#50fa7b":t>=60?"#00fff0":"#ffb86c",a=2*Math.PI*16,o=t/100*a,i=n.filter(r=>!r.done).map(r=>r.label);e.title=t===100?"Profile complete \u2713":`${t}% \u2014 Missing: ${i.join(", ")}`,e.innerHTML=`
    <div class="pc-wrap">
  ...
  `,document.body.appendChild(e);let t=()=>{e.style.display="none",e.removeAttribute("data-addr"),document.body.classList.remove("modal-open"),Vs=!1,Rt=!1};e.addEventListener("click",a=>{a.target===e&&t()}),(n=w("acctPeekClose"))==null||n.addEventListener("click",t),(s=w("acctPeekInspect"))==null||s.addEventListener("click",async()=>{let a=e.getAttribute("data-addr");a&&await Eg(a),t()})}function Mg(){Mp||(Mp=!0,document.addEventListener("click",e=>{var s,a;let t=(a=(s=e.target).closest)==null?void 0:a.call(s,"[data-addr]");if(!t)return;let n=t.getAttribute("data-addr");n&&(e.preventDefault(),Ag(n))}))}function Op(e){var r,l,c;if(!e||!((r=Re==null?void 0:Re.window)!=null&&r.length))return null;let t=0,n=0,s=0;for(let u of Re.window)s+=Number(u.total||0),t+=Number(((l=u.byActorCreate)==null?void 0:l.get(e))||0),n+=Number(((c=u.byActorCancel)==null?void 0:c.get(e))||0);let a=t+n;if(!a)return null;let o=a?n/a:0,i=s?a/s:null;return{create:t,cancel:n,total:a,cancelRatio:o,share:i}}function Lg(e){var o;let t=(o=Nt==null?void 0:Nt.acct)==null?void 0:o.get(e);if(!t||!t.intervals||t.intervals.length<6)return null;let n=bn(t.intervals),s=Oi(t.intervals);return!n||s==null?null:{cv:s/n,total:t.total||0}}async function Ag(e){var i,r,l;if(!He(e))return;let t=document.getElementById("acctPeekOverlay");if(!t)return;t.style.display="flex",t.setAttribute("data-addr",e),document.body.classList.add("modal-open"),Vs=!0,Rt=!0,V("acctPeekAddr",e),V("acctPeekBal","\u2026"),V("acctPeekSeq","\u2026"),V("acctPeekOwner","\u2026"),V("acctPeekFlags","\u2026");let n=w("acctPeekNote"),s=w("acctPeekCtx");n&&(n.textContent="Fetching account_info\u2026"),s&&(s.textContent="Building context\u2026");let a=Nt.acct.get(e),o=((i=a==null?void 0:a.ledgers)==null?void 0:i.length)||0;try{if(!X.wsConn||X.wsConn.readyState!==1){n&&(n.textContent="Not connected to XRPL. Connect first.");return}let c=await Ee({command:"account_info",account:e,ledger_index:"validated",strict:!0}),u=(r=c==null?void 0:c.result)==null?void 0:r.account_data,p=Number((u==null?void 0:u.Balance)??NaN),d=Number.isFinite(p)?p/1e6:null;if(V("acctPeekBal",d==null?"\u2014":`${d.toLocaleString(void 0,{maximumFractionDigits:6})} XRP`),V("acctPeekSeq",(u==null?void 0:u.Sequence)??"\u2014"),V("acctPeekOwner",(u==null?void 0:u.OwnerCount)??"\u2014"),V("acctPeekFlags",(u==null?void 0:u.Flags)!=null?`0x${Number(u.Flags).toString(16)}`:"\u2014"),n){let m=[];d!=null&&d>=fg&&m.push("Large balance (whale-sized).");let f=Lg(e);f&&f.cv<.35&&f.total>10&&m.push(`Bot-like timing signal (CV ${f.cv.toFixed(2)}).`);let g=Op(e);if(g){let h=Math.round(g.cancelRatio*100),b=g.share!=null?Math.round(g.share*100):null;m.push(`DEX activity: ${g.total} offer tx in window.`),m.push(`Creates ${g.create}, cancels ${g.cancel} (${h}% cancels).`),b!=null&&m.push(`~${b}% of window activity.`)}let v=ie.byAddr.get(e);if(v){let h=Gs(v.level);m.push(`Spam-defense: score ${(v.score*100).toFixed(0)}% \xB7 level L${v.level} \xB7 bond ${h.toLocaleString()} XRP.`),v.verifiedLedger!=null&&m.push(`Credential verified at ledger #${Number(v.verifiedLedger).toLocaleString()}.`)}o>=6&&m.push(`Shows up often in recent ledgers (${o} times).`),m.length||m.push("No obvious red flags from this quick read."),n.textContent=m.join(" ")}if(s){let m=(l=a==null?void 0:a.ledgers)==null?void 0:l.at(-1),f=Op(e),g=f?`DEX window: ${f.total} (creates ${f.create}, cancels ${f.cancel})`:null,v=_t.filter(k=>k.from===e||k.to===e).slice(0,3),h=v.length?`${v.length} whale tx in session (${v.map(k=>(k.amtXrp>=1e6?(k.amtXrp/1e6).toFixed(1)+"M":(k.amtXrp/1e3).toFixed(0)+"K")+" XRP").join(", ")})`:null,b=ie.byAddr.get(e),x=b?`Spam-defense: L${b.level} \xB7 score ${Math.round(b.score*100)}%`:null;s.textContent=[m?`Last seen around ledger #${Number(m).toLocaleString()}`:"Not in recent window.",g,h,x].filter(Boolean).join(" \xB7 ")}}catch(c){n&&(n.textContent=`Lookup failed: ${String((c==null?void 0:c.message)||c)}`),s&&(s.textContent="\u2014")}}async function Eg(e){if(!He(e))return;let t=document.querySelector('.dash-tab[data-tab="inspector"]'),n=document.getElementById("tab-inspector"),s=async()=>n&&n.style.display!=="none"?!0:(typeof window.switchTab=="function"&&t?window.switchTab(t,"inspector"):t==null||t.click(),await new Promise(o=>setTimeout(o,80)),n?n.style.display!=="none":!0);for(let o=0;o<6&&!await s();o++)await new Promise(r=>setTimeout(r,80));let a=document.getElementById("inspect-addr");a&&(a.value=e,a.focus()),await new Promise(o=>setTimeout(o,60)),typeof window.runInspect=="function"?window.runInspect():he("Inspector not ready yet.")}function Ng(){Xe(".net-btn[data-network]").forEach(e=>{e.addEventListener("click",()=>{let t=e.getAttribute("data-network");Xe(".net-btn").forEach(s=>{s.classList.toggle("active",s===e),s.setAttribute("aria-pressed",String(s===e))}),Nt.acct.clear(),Us.window=[],Us.totals=new Map,Re.window=[],Re.smoothCancelPerMin=null,Re.smoothBurst=null,Xt.length=0,Va.clear(),Ve=0,Kt=0,pt=0,js=0,Jt=!0,Ka=0,_i=!1,qs=null,Rt=!1,gn=0,ms=0,Qa=!1;let n=w("ledgerStreamTrack");n&&(n.innerHTML="",n.style.transform="translateX(0px)"),iu(null,null),Sb(),ie.byAddr.clear(),ie.selectedAddr=null,ie.selectedProof=null,Xi(),pu(),hs(null),Fr(t),Ya({force:!0})})})}var qa=[],Rg=8,Pi=null,Ri=0,Ws=null;function _g(){let e=document.querySelector(".dashboard-metric-grid");if(!e)return;let t=e.closest(".dashboard-metrics")||e.parentElement;t&&t.classList.add("dashboard-sticky-strip"),e.innerHTML=`
  ...
  `}function Dg(e){var g,v,h,b;let t=e.ledgerIndex?Number(e.ledgerIndex):null;V("d2-ledger-index",t?t.toLocaleString():"\u2014");let n=((g=e.latestLedger)==null?void 0:g.closeTimeSec)!=null?Number(e.latestLedger.closeTimeSec):null,s=w("d2-ledger-age");if(s&&(n!=null?(s.textContent=`${n<2?n.toFixed(2):n.toFixed(1)}s close`,s.style.color=n<=3?"#50fa7b":n<=6?"#ffb86c":"#ff6e6e"):(s.textContent="Waiting\u2026",s.style.color="")),n!=null&&(qa.push(n),qa.length>Rg&&qa.shift(),Ig()),Ri=Date.now(),Fg(),e.tps!=null){let x=Number(e.tps),k=w("d2-tps");k&&(k.textContent=x.toFixed(1),k.style.color=x<10?"rgba(255,255,255,.65)":x<40?"#50fa7b":x<80?"#ffb86c":"#ff6e6e");let T=w("d2-tps-trend");if(T){let S=X.tpsHistory||[],$=S.length>2?(S.slice(-10).reduce((C,P)=>C+P,0)/Math.min(S.length,10)).toFixed(1):null,E=x<10?"Low":x<40?"Normal":x<80?"High":"Peak";T.textContent=$?`${E} \xB7 avg ${$}`:E,T.style.color=x<10?"rgba(255,255,255,.55)":x<40?"#50fa7b":x<80?"#ffb86c":"#ff6e6e"}}let a=(((v=e.latestLedger)==null?void 0:v.totalTx)??e.txPerLedger)||0,o=w("d2-tx-per-ledger");o&&(o.textContent=a>0?a.toLocaleString():"\u2014",o.style.color=a<10?"rgba(255,255,255,.65)":a<150?"#50fa7b":a<400?"#ffb86c":"#ff6e6e");let i=w("d2-tx-spread");i&&a>0&&(i.textContent=a<10?"Very light":a<50?"Light":a<150?"Normal":a<400?"High volume":"Very high volume",i.style.color=a<150?"":a<400?"#ffb86c":"#ff6e6e");let r=e.avgFee!=null?Number(e.avgFee):((h=e.latestLedger)==null?void 0:h.avgFee)!=null?Number(e.latestLedger.avgFee):null;if(r!=null){let x=Math.round(r*1e6),k=w("d2-fee-value");k&&(k.textContent=hn(r),k.style.color=x<=15?"#50fa7b":x<=50?"rgba(255,255,255,.9)":x<=200?"#ffb86c":"#ff6e6e");let T=w("d2-fee-delta");if(T)if(Pi!=null){let $=r/Pi;$>1.05?(T.textContent="\u2191",T.style.color="#ff6e6e",T.title=`+${(($-1)*100).toFixed(0)}% vs prev ledger`):$<.95?(T.textContent="\u2193",T.style.color="#50fa7b",T.title=`-${((1-$)*100).toFixed(0)}% vs prev ledger`):(T.textContent="\u2192",T.style.color="rgba(255,255,255,.35)",T.title="Stable vs prev ledger")}else T.textContent="";Pi=r;let S=w("d2-fee-pressure");if(S){let $=x<=15?"Base fee":x<=50?`${x} drops`:x<=200?`${x} drops \xB7 Elevated`:`${x} drops \xB7 Surge`;S.textContent=$,S.style.color=x<=50?"":x<=200?"#ffb86c":"#ff6e6e"}}let l=e.successRate!=null?Number(e.successRate):((b=e.latestLedger)==null?void 0:b.successRate)!=null?Number(e.latestLedger.successRate):null;if(l!=null){let x=w("d2-success-rate");x&&(x.textContent=`${l.toFixed(1)}%`,x.style.color=l>=90?"#50fa7b":l>=75?"#ffb86c":"#ff6e6e");let k=w("d2-success-note");if(k){let T=(100-l).toFixed(1);k.textContent=l>=90?`${T}% failed \xB7 Normal`:l>=75?`${T}% failed \xB7 Watch`:`${T}% failed \xB7 Alert`,k.style.color=l>=90?"":l>=75?"#ffb86c":"#ff6e6e"}}let c=a>0?Math.min(100,a/500*100):null,u=w("d2-network-capacity"),p=w("d2-capacity-note");c!=null&&(u&&(u.textContent=`${c.toFixed(1)}%`,u.style.color=c<20?"rgba(255,255,255,.65)":c<50?"#50fa7b":c<80?"#ffb86c":"#ff6e6e"),p&&(p.textContent=c<20?"Low usage":c<50?"Moderate":c<80?"Heavy":"Near capacity",p.style.color=c<50?"":c<80?"#ffb86c":"#ff6e6e"));let d=e.txTypes||{},m=Object.entries(d).sort(([,x],[,k])=>k-x);if(m.length){let[x,k]=m[0],T=m.reduce((P,[,R])=>P+R,0)||1,S=(k/T*100).toFixed(0),$=typeof It<"u"?It:{},E=w("d2-dominant-type");E&&(E.textContent=x,E.style.color=$[x]||"rgba(255,255,255,.9)");let C=w("d2-dominance-score");if(C){let P=m[1];C.textContent=P?`${S}% \xB7 2nd: ${P[0]}`:`${S}% of txs`}}let f=w("stream-loading");f&&(f.style.display="none")}function Ig(){let e=w("d2-close-sparkline");if(!e||!e.getContext)return;let t=qa;if(t.length<2)return;let n=e.width,s=e.height,a=e.getContext("2d");a.clearRect(0,0,n,s);let o=Math.max(...t,4),i=Math.floor((n-(t.length-1))/t.length),r=1;t.forEach((l,c)=>{let u=Math.max(3,Math.round(l/o*(s-2))),p=c*(i+r),d=s-u,m=l<=3?"rgba(80,250,123,.80)":l<=6?"rgba(255,184,108,.80)":"rgba(255,110,110,.85)";a.fillStyle=m;let f=Math.min(2,i/2);a.beginPath(),a.moveTo(p+f,d),a.lineTo(p+i-f,d),a.quadraticCurveTo(p+i,d,p+i,d+f),a.lineTo(p+i,s),a.lineTo(p,s),a.lineTo(p,d+f),a.quadraticCurveTo(p,d,p+f,d),a.closePath(),a.fill(),c===t.length-1&&(a.fillStyle="rgba(255,255,255,.18)",a.fillRect(p,d,i,Math.min(3,u)))})}function Fg(){if(Ws&&cancelAnimationFrame(Ws),!Yt())return;let e=0,t=n=>{if(!Yt()){Ws=null;return}if(n-e>=120){e=n;let s=w("d2-ledger-age-timer");if(s&&Ri>0){let a=(Date.now()-Ri)/1e3;s.textContent=`${a.toFixed(1)}s ago`,s.style.color=a<4?"rgba(255,255,255,.55)":a<7?"#ffb86c":"#ff6e6e",s.style.opacity=a>=7?(.6+.4*Math.sin(Date.now()/300)).toFixed(2):"1"}}Ws=requestAnimationFrame(t)};Ws=requestAnimationFrame(t)}function Og(){let e=w("tx-mix");if(!e)return;let t=Object.entries(X.txMixAccum||{}).filter(([,s])=>s>0).sort(([,s],[,a])=>a-s).slice(0,10),n=t.reduce((s,[,a])=>s+a,0);n&&(e.innerHTML=t.map(([s,a])=>{let o=(a/n*100).toFixed(1),i=It[s]||"#6b7280";return`
      ...
      </div>`}).join(""))}var St=class{constructor(t,n="#00fff0",s="area"){this.canvasId=t,this.canvas=w(t),this.color=n,this.mode=s}_resolveCanvas(){return this.canvas||(this.canvas=w(this.canvasId)),this.canvas}draw(t){let n=this._resolveCanvas();if(!n||!(t!=null&&t.length))return;let s=n.getContext("2d");if(!s)return;let a=n.width=n.offsetWidth||300,o=n.height=n.offsetHeight||180;if(s.clearRect(0,0,a,o),t.length<2)return;let i=Math.min(...t)*.9,r=Math.max(...t)*1.05||1,l=v=>1-(v-i)/(r-i||1),c={l:10,r:10,t:10,b:12},u=a-c.l-c.r,p=o-c.t-c.b,d=u/(t.length-1),m=t.map((v,h)=>[c.l+h*d,c.t+l(v)*p]),f=bn(t);if(f!=null){let v=c.t+l(f)*p;s.beginPath(),s.moveTo(c.l,v),s.lineTo(c.l+u,v),s.strokeStyle="rgba(255,255,255,0.16)",s.lineWidth=1,s.stroke()}if(t.length>=hp+2){let h=Tg(t,hp).map((b,x)=>[c.l+x*d,c.t+l(b)*p]);s.beginPath(),h.forEach(([b,x],k)=>k===0?s.moveTo(b,x):s.lineTo(b,x)),s.strokeStyle="rgba(255,255,255,0.22)",s.lineWidth=1.5,s.stroke()}if(this.mode==="bar"){let v=Math.max(1,d-3);t.forEach((h,b)=>{let x=(1-l(h))*p,k=c.l+b*d-v/2,T=s.createLinearGradient(0,c.t,0,c.t+p);T.addColorStop(0,this.color),T.addColorStop(1,this.color+"33"),s.fillStyle=T,s.fillRect(k,c.t+p-x,v,x)});return}let g=s.createLinearGradient(0,c.t,0,c.t+p);g.addColorStop(0,this.color+"aa"),g.addColorStop(1,this.color+"11"),s.beginPath(),m.forEach(([v,h],b)=>b===0?s.moveTo(v,h):s.lineTo(v,h)),s.lineTo(m.at(-1)[0],c.t+p),s.lineTo(m[0][0],c.t+p),s.closePath(),s.fillStyle=g,s.fill(),s.beginPath(),m.forEach(([v,h],b)=>b===0?s.moveTo(v,h):s.lineTo(v,h)),s.strokeStyle=this.color,s.lineWidth=2,s.lineJoin="round",s.stroke()}},ye={};function Bg(){ye.tps=new St("chart-tps","#50fa7b","area"),ye.fee=new St("chart-fee","#ffb86c","area"),ye.tps2=new St("chart-tps2","#50fa7b","bar"),ye.fee2=new St("chart-fee2","#ffb86c","area"),ye.dexPressure=new St("chart-dex-pressure","#00d4ff","bar"),ye.nftMints=new St("chart-nft-mints","#bd93f9","bar"),ye.nftBurns=new St("chart-nft-burns","#ff5555","bar"),ye.autoBridge=new St("chart-autobridge","#f1fa8c","bar"),ye.marketPrice=new St("chart-market-price","#50fa7b","area"),ye.marketVol=new St("chart-market-vol","#8be9fd","bar")}function Ht(e,t=Qt){let n=Sg(e,t).filter(r=>Number.isFinite(r));if(!n.length)return{cur:null,avg:null,deltaPct:null,vol:null};let s=n.at(-1),a=bn(n),o=Oi(n),i=a&&a!==0?(s-a)/a*100:null;return{cur:s,avg:a,deltaPct:i,vol:o}}function Xg(){if(xp)return;xp=!0;let e=(t,n)=>{let s=w(t);if(!s)return;let a=s.closest(".widget-card"),o=a==null?void 0:a.querySelector(".widget-header");if(!o||document.getElementById(n))return;let i=document.createElement("div");i.className="trend-mini",i.id=n,i.innerHTML=`
    ...
    `,o.appendChild(i)};e("chart-tps","tpsTrendMini"),e("chart-fee","feeTrendMini"),e("chart-tps2","tpsTrendMini2"),e("chart-fee2","feeTrendMini2")}function za(e,t,n,s){let a=document.getElementById(e);if(!a)return;let o=(i,r)=>{let l=a.querySelector(`[data-k="${i}"]`);l&&(l.textContent=r)};if(t.cur==null){o("now","\u2014"),o("avg","\u2014"),o("delta","\u2014"),o("sigma","\u2014");return}o("now",`${Number(t.cur).toFixed(n)}${s}`),o("avg",t.avg!=null?`${Number(t.avg).toFixed(n)}${s}`:"\u2014"),o("delta",t.deltaPct==null?"\u2014":vn(t.deltaPct,0)),o("sigma",t.vol==null?"\u2014":`${Number(t.vol).toFixed(Math.max(0,n-1))}${s}`)}function Hg(){var n,s,a,o,i,r,l,c,u,p;(n=ye.tps)==null||n.draw(X.tpsHistory),(s=ye.fee)==null||s.draw(X.feeHistory),(a=ye.tps2)==null||a.draw(X.tpsHistory),(o=ye.fee2)==null||o.draw(X.feeHistory);let e=Ht(X.tpsHistory,Qt),t=Ht(X.feeHistory,Qt);za("tpsTrendMini",e,2,""),za("tpsTrendMini2",e,2,""),za("feeTrendMini",t,0,"d"),za("feeTrendMini2",t,0,"d"),(i=ye.dexPressure)==null||i.draw(fe.dexPressure),(r=ye.nftMints)==null||r.draw(fe.nftMints),(l=ye.nftBurns)==null||l.draw(fe.nftBurns),(c=ye.autoBridge)==null||c.draw(fe.autoBridge),(u=ye.marketPrice)==null||u.draw(fe.marketPrice),(p=ye.marketVol)==null||p.draw(fe.marketVol)}function zg(){let e=w("ledger-log"),t=w("ledger-log-loading"),n=w("ledger-log-count");if(!e||!(X.ledgerLog||[]).length)return;t&&(t.style.display="none"),n&&(n.textContent=X.ledgerLog.length);let s=w("tab-network");!s||s.style.display==="none"||(e.innerHTML=`<div class="ledger-log-row log-head">
      ...
      </div>`).join(""))}var Xt=[],Va=new Set,Ve=0,Wa=null,js=0,Kt=0,pt=0,Jt=!0,ja=0,Rt=!1,Ka=0,_i=!1,qs=null,gn=0,ms=0,Qa=!1,Wg=.18;function jg(){Ug(),qg()}function Ug(){let e=w("ledgerStreamParticles");if(e){e.innerHTML="";for(let t=0;t<14;t++){let n=document.createElement("div");n.className="ledger-particle",n.style.left=Math.random()*100+"%",n.style.top=20+Math.random()*60+"%",n.style.animationDuration=6+Math.random()*8+"s",n.style.animationDelay=Math.random()*5+"s",e.appendChild(n)}}}function qg(){if(Wa)return;let e=w("ledgerStreamShell");e&&(e.addEventListener("mouseenter",()=>{Rt=!0}),e.addEventListener("mouseleave",()=>{Vs||(Rt=!1)}));let t=w("ledgerStreamTrack");t&&t.addEventListener("click",s=>{let a=s.target.closest("article.ledger-card");if(!a)return;let o=Number(a.dataset.ledgerIndex);Number.isFinite(o)&&(s.shiftKey?qs===o?(qs=null,Vs||(Rt=!1),Bp()):(qs=o,Rt=!0,Bp()):Vg(o))});let n=s=>{js||(js=s);let a=Math.min(.05,(s-js)/1e3);js=s;let o=Yt()?w("ledgerStreamTrack"):null;if(o&&Ve>0){if(Jt){let i=o.scrollWidth||0;if(i>100)pt=Math.floor(i/2),Jt=!1,ja=0,Ve>0&&(gn=pt/Ve);else{ja++,ja>30&&(Jt=!1,ja=0),Wa=requestAnimationFrame(n);return}}if(pt>0&&!Rt&&Qa){let i=Math.min(1,a/Wg);Kt+=(ms-Kt)*i,Math.abs(ms-Kt)<.5&&(Kt=ms);let r=Kt%pt;o.style.transform=`translateX(${-r}px)`}if(!Rt&&Math.floor(s/250)!==Math.floor((s-a*1e3)/250)){let i=Date.now(),r=o.querySelectorAll("article.ledger-card[data-arrival-ts]"),l=12e4;r.forEach(c=>{let u=i-Number(c.dataset.arrivalTs||i),p=Math.max(.52,1-u/l*.48);c.style.opacity=p.toFixed(3)})}if(Ka>0){let i=Date.now()-Ka>yg;Ja(i)}}Wa=requestAnimationFrame(n)};Wa=requestAnimationFrame(n),window.addEventListener("resize",()=>{Jt=!0})}function nu(){if(gn<=0||pt<=0||Ve===0)return Kt;let e=w("ledgerStreamShell"),t=e&&e.offsetWidth||800,n=gn-14,a=(Ve-1)*gn+n-t+18;a=Math.max(0,a);let i=Math.floor(Kt/pt)*pt+a;return i<Kt-2&&(i+=pt),i}function Ja(e,t){if(e===_i)return;_i=e;let n=w("ledgerStreamShell");if(!n)return;let s=n.querySelector(".stream-stall-overlay");e?(s||(s=document.createElement("div"),s.className="stream-stall-overlay",n.appendChild(s)),s.innerHTML=`<span class="stream-stall-dot"></span> ${y(t||"Waiting for ledgers\u2026")}`):s==null||s.remove()}function Bp(){document.querySelectorAll(".ledger-card").forEach(e=>{let t=Number(e.dataset.ledgerIndex);e.classList.toggle("ledger-card--pinned",t===qs)})}function Vg(e){let t=document.querySelector('.dash-tab[data-tab="inspector"]');typeof window.switchTab=="function"&&t?window.switchTab(t,"inspector"):t==null||t.click();let n=document.getElementById("inspect-addr");n&&(n.placeholder=`Ledger #${e.toLocaleString()} \u2014 paste an address`,n.focus())}function Gg(){var t;let e=w("ledgerStreamShell");e&&(e.classList.remove("stream-reconnect-flash"),e.offsetWidth,e.classList.add("stream-reconnect-flash"),setTimeout(()=>e.classList.remove("stream-reconnect-flash"),1200),$g=((t=ps.at(-1))==null?void 0:t.li)??0,Kg())}function Kg(){let e=document.getElementById("reconnect-banner");if(!e){e=document.createElement("div"),e.id="reconnect-banner",e.className="reconnect-banner";let s=document.querySelector(".dashboard-col-main");s&&s.prepend(e)}e.style.display="",e.innerHTML=`
    ...
    <button onclick="document.getElementById('reconnect-banner').style.display='none'"
      style="margin-left:auto;background:none;border:none;color:inherit;opacity:.5;cursor:pointer;font-size:.9rem">\u2715</button>`;let t=3,n=setInterval(()=>{let s=document.getElementById("reconnect-countdown");if(s&&(s.textContent=t),t--,t<0){clearInterval(n);let a=document.getElementById("reconnect-banner");a&&(a.style.display="none")}},4e3)}function Xp(){let e=w("ledgerStreamTrack"),t=w("ledgerStreamShell"),n=w("stream-loading");if(!e||!t)return;if(n&&(n.style.display="none"),Xt.length===0){e.innerHTML='<div style="padding:40px;opacity:.6">Waiting for ledgers\u2026</div>',Ve=0,Jt=!0;return}let s=[...Xt].sort((o,i)=>o.ledgerIndex-i.ledgerIndex),a=s.map((o,i)=>au(o,{prevIndex:i>0?s[i-1].ledgerIndex:null}));e.innerHTML=a.concat(a).join(""),Ve=s.length,Jt=!0,requestAnimationFrame(()=>{var i;let o=((i=w("ledgerStreamTrack"))==null?void 0:i.scrollWidth)||0;o>100&&(pt=Math.floor(o/2),gn=Ve>0?pt/Ve:0,ms=nu(),Qa=!0,Jt=!1)})}function Jg(e){var f,g;if(!e)return;let t=Number(e.ledgerIndex??NaN);if(!Number.isFinite(t)||Va.has(t))return;Va.add(t),Xt.push(e);let n=0;if(Xt.length>vp){let v=Xt.splice(0,Xt.length-vp);v.forEach(h=>Va.delete(h.ledgerIndex)),n=v.length}Ka=Date.now(),Ja(!1),Qg(e.avgFee!=null?Number(e.avgFee):null);let{auraClass:s,domColor:a}=Zg(e);iu(s,a);let o=w("stream-loading");o&&(o.style.display="none");let i=w("ledgerStreamTrack");if(!i)return;if(Ve===0){Xp();return}let r=Xt.length>=2?Xt[Xt.length-2].ledgerIndex:0;if(t<r){Xp();return}let l=Ve,c=au(e),u=document.createElement("template");u.innerHTML=c;let p=u.content.firstElementChild,d=i.children[l];d?i.insertBefore(p,d):i.appendChild(p);let m=document.createElement("template");if(m.innerHTML=c,i.appendChild(m.content.firstElementChild),Ve=l+1,n>0){for(let h=0;h<n;h++)(f=i.children[0])==null||f.remove();let v=Ve-n;for(let h=0;h<n;h++)(g=i.children[v])==null||g.remove();Ve-=n}Jt=!0,requestAnimationFrame(()=>{gn<=0&&pt>0&&Ve>0&&(gn=pt/Ve),ms=nu(),Qa=!0})}var fs=[],Yg=20;function Qg(e){e==null||!Number.isFinite(e)||(fs.push(e),fs.length>Yg&&fs.shift())}function su(){return fs.length===0?null:fs.reduce((e,t)=>e+t,0)/fs.length}function au(e,t={}){let{ledgerIndex:n,closeTimeSec:s,totalTx:a,txTypes:o,avgFee:i}=e,r=o||{},l=a??0,c=Object.entries(r).sort(([,D],[,I])=>I-D)[0],u=(c==null?void 0:c[0])||"Other",p=ou(u),d=typeof It<"u"?It:{},m=D=>d[D]||"#6b7280",f=m(u),g=us(f,.45)||f,v=us(f,.14)||f,h=s==null?"\u2014":s<2?`${Number(s).toFixed(2)}s`:`${Number(s).toFixed(1)}s`,b=l>0&&s>0?(l/s).toFixed(1):null,x=i!=null?Number(i):null,k=x!=null?hn(x):"\u2014",T=su(),S=x!=null&&T!=null&&x>T*3,$=t.prevIndex!=null?Number(n)-t.prevIndex-1:0,E=$>0?`<div class="stream-gap-badge" title="${$} ledger(s) missing">\xB7\xB7\xB7&nbsp;${$} gap</div>`:"",C=D=>l>0?`${(D/l*100).toFixed(1)}%`:"0%",P=(D,I,F)=>I?`<div class="ledger-type-row">
    ...
    </div>`:"",R=(r.AMMCreate||0)+(r.AMMDeposit||0)+(r.AMMWithdraw||0)+(r.AMMVote||0),O=Date.now();return`${E}<article class="ledger-card ledger-card--${p} ledger-card--entry${S?" ledger-card--fee-spike":""}"
  ...
  </article>`}function ou(e){let t=String(e||"");return t==="Payment"?"payment":t.startsWith("Offer")?"offer":t.startsWith("NFToken")?"nft":t==="TrustSet"?"trust":t.startsWith("AMM")?"amm":"other"}function Zg(e){var o;let n=((o=Object.entries(e.txTypes||{}).sort(([,i],[,r])=>r-i)[0])==null?void 0:o[0])||"Other",s=ou(n),a=It[n]||It.Other||"#6b7280";return{dominantTx:n,auraClass:s,domColor:a}}function iu(e,t){let n=w("ledgerStreamShell");if(!n)return;if(!e||!t){n.style.removeProperty("--streamTintStrong"),n.style.removeProperty("--streamTintSoft"),n.style.removeProperty("--streamTintBorder");return}let s=us(t,.16)||"rgba(0,255,240,0.14)",a=us(t,.06)||"rgba(0,255,240,0.06)",o=us(t,.22)||"rgba(0,255,240,0.22)";n.style.setProperty("--streamTintStrong",s),n.style.setProperty("--streamTintSoft",a),n.style.setProperty("--streamTintBorder",o),n.dataset.tint=e}function eb(e){var v,h;let t=Array.isArray(e.recentTransactions)?e.recentTransactions.slice(0,mg):[],n=e.txTypes||{},s=Number(e.ledgerIndex||0),a=Object.values(n).reduce((b,x)=>b+x,0)||1,o=0;for(let b of Object.values(n)){let x=b/a;o+=x*x}let i=tb(t);nb(Us,i);let r=sb(Us.totals,i),l=ab(Us.totals),c=ob(s,t),u=ib(s,(v=e.latestLedger)==null?void 0:v.closeTimeSec,t),p=rb({txs:t,txTypes:n,dexPatterns:u}),d=r.filter(b=>b.count>=2).length,m=lb({hhi:o,repeats:d,dex:u,bots:((h=c.bots)==null?void 0:h.length)||0,advanced:p}),f=cb({friction:m,tps:Ht(X.tpsHistory),fee:Ht(X.feeHistory)}),g=db({s:e,txTypes:n,hhi:o,dexPatterns:u,behavior:c,friction:m,regime:f,breadcrumbs:r,clusters:l,advanced:p});return{s:e,txs:t,txTypes:n,hhi:o,behavior:c,dexPatterns:u,friction:m,regime:f,breadcrumbs:r,clusters:l,narratives:g,advanced:p}}function tb(e){let t=new Map;for(let n of e){let s=n==null?void 0:n.account,a=n==null?void 0:n.destination;if(!s||!a)continue;let o=`${s}|${a}`;t.set(o,(t.get(o)||0)+1)}return t}function nb(e,t){e.window.unshift(t);for(let[n,s]of t.entries())e.totals.set(n,(e.totals.get(n)||0)+s);for(;e.window.length>e.maxLedgers;){let n=e.window.pop();for(let[s,a]of n.entries()){let o=(e.totals.get(s)||0)-a;o<=0?e.totals.delete(s):e.totals.set(s,o)}}}function sb(e,t){let s=[...e.entries()].map(([o,i])=>({k:o,c:i})).sort((o,i)=>i.c-o.c).filter(o=>o.c>=2);return(s.length?s:[...t.entries()].map(([o,i])=>({k:o,c:i}))).slice(0,10).map(({k:o,c:i})=>{let[r,l]=o.split("|");return{from:r,to:l,count:i}})}function ab(e){let t=[...e.entries()].filter(([,i])=>i>=2),n=t.length?t:[...e.entries()],s=new Map;for(let[i]of n){let[r,l]=i.split("|");!r||!l||(s.has(r)||s.set(r,new Set),s.has(l)||s.set(l,new Set),s.get(r).add(l),s.get(l).add(r))}let a=new Set,o=[];for(let i of s.keys()){if(a.has(i))continue;let r=[i],l=[];for(a.add(i);r.length;){let p=r.pop();l.push(p);for(let d of s.get(p)||[])a.has(d)||(a.add(d),r.push(d))}if(l.length<2)continue;let c=l[0],u=-1;for(let p of l){let d=(s.get(p)||new Set).size;d>u&&(u=d,c=p)}o.push({members:l,size:l.length,hub:c})}return o.sort((i,r)=>r.size-i.size),o.slice(0,6)}function ob(e,t){let n=new Map;for(let a of t){let o=a==null?void 0:a.account;o&&n.set(o,(n.get(o)||0)+1)}for(let[a,o]of n.entries()){Nt.acct.has(a)||Nt.acct.set(a,{ledgers:[],intervals:[],total:0});let i=Nt.acct.get(a),r=i.ledgers.at(-1);i.ledgers.push(e),r!=null&&e>r&&i.intervals.push(e-r),i.ledgers.length>30&&i.ledgers.shift(),i.intervals.length>29&&i.intervals.shift(),i.total+=o}let s=[];for(let[a,o]of Nt.acct.entries()){if(o.intervals.length<6)continue;let i=bn(o.intervals),r=Oi(o.intervals);if(!i||r==null)continue;let l=r/i;l<.35&&o.total>10&&s.push({acct:a,cv:l,total:o.total})}if(s.sort((a,o)=>a.cv-o.cv||o.total-a.total),e%50===0)for(let[a,o]of Nt.acct){let i=o.ledgers.at(-1)??e;e-i>1e3&&Nt.acct.delete(a)}return{bots:s.slice(0,6),uniqueActors:n.size}}function ib(e,t,n){var E;let s=0,a=0,o=new Map,i=new Map,r=new Map;for(let C of n){let P=C==null?void 0:C.type,R=C==null?void 0:C.account;R&&(P==="OfferCreate"?(s+=1,o.set(R,(o.get(R)||0)+1),i.set(R,(i.get(R)||0)+1)):P==="OfferCancel"&&(a+=1,o.set(R,(o.get(R)||0)+1),r.set(R,(r.get(R)||0)+1)))}let l=s+a,c=l?a/l:0,u=t!=null&&Number(t)>0?a/Number(t)*60:null;for(Re.smoothCancelPerMin=Fp(Re.smoothCancelPerMin,u,.45),Re.window.unshift({li:e,closeTimeSec:t??null,create:s,cancel:a,total:l,cancelRatio:c,cancelsPerMin:Re.smoothCancelPerMin,byActor:o,byActorCreate:i,byActorCancel:r});Re.window.length>hg;)Re.window.pop();let p={create:0,cancel:0,total:0},d=new Map,m=new Map,f=new Map;for(let C of Re.window){p.create+=C.create,p.cancel+=C.cancel,p.total+=C.total;for(let[P,R]of C.byActor.entries())d.set(P,(d.get(P)||0)+R);for(let[P,R]of C.byActorCancel.entries())m.set(P,(m.get(P)||0)+R);for(let[P,R]of C.byActorCreate.entries())f.set(P,(f.get(P)||0)+R)}let g=Mi(d,5),v=Mi(m,5),h=Mi(f,5),b=p.total?(((E=g[0])==null?void 0:E.count)||0)/p.total:0,x=0;if(p.total)for(let C of d.values()){let P=C/p.total;x+=P*P}let k=Re.window.map(C=>C.total).filter(Number.isFinite),T=bn(k)||0,S=T>0?(l-T)/T*100:null;Re.smoothBurst=Fp(Re.smoothBurst,S,.4);let $=[];return p.total>=Ti&&c>=.65&&$.push("Lots of cancels (looks like quote-stuffing/spam)"),p.total>=Ti&&b>=.35&&$.push("One actor dominates DEX activity"),p.total>=Ti&&(Re.smoothCancelPerMin||0)>=18&&$.push("Fast cancelling (high churn)"),Re.smoothBurst!=null&&Math.abs(Re.smoothBurst)>=45&&$.push("Sudden DEX burst"),{now:{li:e,create:s,cancel:a,total:l,cancelRatio:c,cancelsPerMin:Re.smoothCancelPerMin},window:{...p,cancelRatio:p.total?p.cancel/p.total:0},topShare:b,actorHHI:x,burstPct:Re.smoothBurst,topActor:g,topCanceller:v,topMaker:h,signals:$}}function Mi(e,t){return[...e.entries()].sort((n,s)=>s[1]-n[1]).slice(0,t).map(([n,s])=>({acct:n,count:s}))}function rb({txs:e,txTypes:t,dexPatterns:n}){var H;let s=Number((t==null?void 0:t.OfferCreate)||0)+Number((t==null?void 0:t.OfferCancel)||0),a=Number((t==null?void 0:t.NFTokenMint)||0),o=Number((t==null?void 0:t.NFTokenBurn)||0),i=0,r=new Map,l=new Map;for(let N of e){if((N==null?void 0:N.type)!=="Payment")continue;let W=(N==null?void 0:N.paths)||(N==null?void 0:N.Paths),se=Array.isArray(W)&&W.length>0,re=(N==null?void 0:N.sendmax)!=null||(N==null?void 0:N.SendMax)!=null,pe=(N==null?void 0:N.delivermax)!=null||(N==null?void 0:N.DeliverMax)!=null;if(!(se||re||pe))continue;i+=1;let te=N==null?void 0:N.account,de=N==null?void 0:N.destination;if(te&&r.set(te,(r.get(te)||0)+1),te&&de){let le=`${te}|${de}`;l.set(le,(l.get(le)||0)+1)}}let c=[...r.entries()].sort((N,W)=>W[1]-N[1]).slice(0,5).map(([N,W])=>({acct:N,count:W})),u=[...l.entries()].sort((N,W)=>W[1]-N[1]).slice(0,5).map(([N,W])=>{let[se,re]=N.split("|");return{from:se,to:re,count:W}}),p=(H=n==null?void 0:n.now)!=null&&H.total?Math.round((n.now.cancelRatio||0)*100):0,d=(n==null?void 0:n.topShare)!=null?Math.round(n.topShare*100):0,m=e.filter(N=>(N==null?void 0:N.type)==="Payment").map(N=>typeof(N==null?void 0:N.amountXrp)=="number"?N.amountXrp:null).filter(N=>N!=null&&N>0&&Number.isFinite(N)),f=[100,1e3,1e4],g=m.filter(N=>f.some(W=>Math.abs(N%W)<1e-9&&N/W>=1)).length,v=m.length>=5?Math.round(g/m.length*100):null,h=e.filter(N=>(N==null?void 0:N.type)==="Payment"&&(N==null?void 0:N.account)&&(N==null?void 0:N.destination)&&N.account===N.destination).length,b=Number((t==null?void 0:t.AMMCreate)||0),x=Number((t==null?void 0:t.AMMDeposit)||0),k=Number((t==null?void 0:t.AMMWithdraw)||0),T=Number((t==null?void 0:t.AMMVote)||0),S=Number((t==null?void 0:t.AMMBid)||0),$=Number((t==null?void 0:t.AMMDelete)||0),E=b+x+k+T+S+$,C=x-k,P=x+k>0?Math.round(x/(x+k)*100):null,R=new Set;for(let N of e)["AMMCreate","AMMDeposit","AMMWithdraw","AMMVote","AMMBid"].includes(N==null?void 0:N.type)&&(N!=null&&N.account)&&R.add(N.account);let O=R.size,D=0,I=0;for(let N of e)(N==null?void 0:N.type)==="Payment"&&Array.isArray(N==null?void 0:N.paths)&&N.paths.length>0&&(D+=N.paths.length,I++);let F=I>0?(D/I).toFixed(1):null;return{offerTotal:s,dexCancelPct:p,dexTopSharePct:d,mints:a,burns:o,pathPays:i,topPathActors:c,topPathPairs:u,roundnessIdx:v,selfTradeCount:h,ammCreate:b,ammDeposit:x,ammWithdraw:k,ammVote:T,ammBid:S,ammDelete:$,lpTotal:E,lpNetFlow:C,lpRatio:P,lpUniqueActors:O,avgPathDepth:F}}function lb({hhi:e,repeats:t,dex:n,bots:s,advanced:a}){var h,b;let o=we((e-.22)/.25,0,1)*22,i=we((t-2)/6,0,1)*12,r=((h=n==null?void 0:n.window)==null?void 0:h.cancelRatio)??0,l=(n==null?void 0:n.topShare)??0,c=((b=n==null?void 0:n.now)==null?void 0:b.cancelsPerMin)??0,u=we((r-.5)/.5,0,1)*18,p=we((l-.25)/.5,0,1)*18,d=we(c/25,0,1)*10,m=we(s/6,0,1)*10,f=(a==null?void 0:a.roundnessIdx)!=null?we((a.roundnessIdx-30)/40,0,1)*8:0,g=(a==null?void 0:a.selfTradeCount)>0?Math.min(8,a.selfTradeCount*4):0,v=(a==null?void 0:a.pathPays)!=null?we(a.pathPays/30,0,1)*6:0;return Math.round(o+i+u+p+d+m+f+g+v)}function cb({friction:e,tps:t,fee:n}){let s=(n==null?void 0:n.deltaPct)!=null&&Math.abs(n.deltaPct)>=35,a=(t==null?void 0:t.deltaPct)!=null&&Math.abs(t.deltaPct)>=25;return e>=75?"Manipulated":s||a?"Stressed":((t==null?void 0:t.cur)??0)>=12||((t==null?void 0:t.avg)??0)>=10?"Active":"Quiet"}function db({s:e,txTypes:t,hhi:n,dexPatterns:s,behavior:a,friction:o,regime:i,breadcrumbs:r,clusters:l,advanced:c}){var h,b,x,k,T;let u=[],p=Ht(X.tpsHistory,Qt),d=Ht(X.feeHistory,Qt),m=((h=Object.entries(t||{}).sort(([,S],[,$])=>$-S)[0])==null?void 0:h[0])||"\u2014",f=Number(e.txPerLedger||0);u.push({sentiment:i==="Manipulated"||i==="Stressed"?"warn":i==="Active"?"up":"ok",title:`Overall: ${i} \xB7 Risk score ${o}/100`,detail:"Heuristic score from concentration, repeats, DEX churn, bot-like timing, and routing indicators. It's a signal, not proof."}),u.push({sentiment:"ok",title:`Ledger snapshot: #${Number(e.ledgerIndex||0).toLocaleString()} \xB7 ${f} tx \xB7 most common: ${m}`,detail:`TPS ${ls(p.cur,2)} (avg ${ls(p.avg,2)} \xB7 ${vn(p.deltaPct,0)}). Fee ${d.cur!=null?hn(d.cur):"\u2014"} (avg ${d.avg!=null?hn(d.avg):"\u2014"} \xB7 ${vn(d.deltaPct,0)}).`});let g=n>=.35?"high":n>=.25?"medium":"low";if(u.push({sentiment:n>=.35?"warn":"ok",title:`Transaction mix: ${g} concentration (HHI ${n.toFixed(2)})`,detail:n>=.35?"A few tx types dominate. Patterns look \u201Cstronger,\u201D but can be misleading.":"Mix is broad. Strong signals usually come from behavior, not just tx type."}),s.window.total){let S=Math.round(s.window.cancelRatio*100),$=Math.round(s.topShare*100);u.push({sentiment:s.signals.length?"warn":"ok",title:`DEX monitor: ${s.window.total} offer tx (window) \xB7 cancels ${S}% \xB7 top actor ~${$}%`,detail:s.signals.length?`Signals: ${s.signals.join(" \xB7 ")}`:"No strong DEX-pattern signals right now.",addr:((b=s.topActor[0])==null?void 0:b.acct)||null})}let v=r.filter(S=>S.count>=2).length;if(v>=2&&u.push({sentiment:"new",title:`Repeating counterparties: ${v} recurring pair(s)`,detail:"Repeated interactions can be routing loops, bots, or coordinated flows. Click addresses for a quick read."}),l!=null&&l.length&&((x=l[0])==null?void 0:x.size)>=3&&u.push({sentiment:"new",title:`Cluster forming: ${l[0].size} wallets \xB7 hub ${z(l[0].hub)}`,detail:"Clusters are co-activity groups (not identity proof). Use as \u201Clikely related behavior.\u201D",addr:l[0].hub}),(k=a.bots)!=null&&k.length){let S=a.bots[0];u.push({sentiment:"warn",title:`Bot-like timing: ${a.bots.length} candidate(s)`,detail:`Low variance in repeated appearances. Top: ${z(S.acct)} (CV ${S.cv.toFixed(2)}).`,addr:S.acct})}if(c!=null&&c.pathPays){let S=(T=c.topPathActors)==null?void 0:T[0];u.push({sentiment:c.pathPays>=18?"warn":"ok",title:`Autobridge-ish routing: ${c.pathPays} path payments (ledger sample)`,detail:S?`Most active routing wallet: ${z(S.acct)} (${S.count}).`:"Paths/SendMax/DeliverMax appear frequently in the sample.",addr:(S==null?void 0:S.acct)||null})}return c!=null&&c.selfTradeCount&&u.push({sentiment:"warn",title:`Self-transfer signal: ${c.selfTradeCount} payment(s) where sender = receiver`,detail:"Self-transfers can be benign (housekeeping) or used to fake activity. Treat as a watch signal."}),((c==null?void 0:c.roundnessIdx)??0)>=45&&u.push({sentiment:"warn",title:`Round-number bias: ${c.roundnessIdx}% of payments are exact multiples of 100/1,000/10,000`,detail:"Round-number bias often shows scripted behavior (bots) rather than human payments."}),u.slice(0,12)}function pb(e){let t=w("d2-breadcrumb-list"),n=w("d2-breadcrumb-meta");if(!t)return;if(!e.length){t.innerHTML='<div class="gateway-item" style="opacity:.6">Watching for repeated interactions\u2026</div>',n&&(n.textContent="\u2014");return}let s=e.filter(a=>a.count>=2).length;n&&(n.textContent=s?`${s} repeats`:"Top interactions"),t.innerHTML=e.slice(0,10).map(a=>`
    <div class="gateway-item gateway-row">
    ...
    </div>`).join("")}function ub(e){let t=w("d2-cluster-list"),n=w("d2-cluster-persistence");if(t){if(!e.length){t.innerHTML='<div class="gateway-item" style="opacity:.6">Building clusters\u2026 (needs repeated activity)</div>',n&&(n.textContent="\u2014");return}n&&(n.textContent=`${e.length} group${e.length!==1?"s":""}`),t.innerHTML=e.slice(0,6).map((s,a)=>{let i=`hsl(${(a*67+120)%360},70%,60%)`,r=s.members.slice(0,4);return`
      ...
      </div>`}).join("")}}function mb(e){let t=w("d2-delta-narratives");if(!t)return;if(!e.length){t.innerHTML='<div class="gateway-item" style="opacity:.6">Building baseline \u2014 narratives appear after 1\u20132 ledgers\u2026</div>';return}let n={up:"#50fa7b",down:"#ff5555",new:"#00d4ff",warn:"#ffb86c",ok:"rgba(255,255,255,.85)"};t.innerHTML=e.map(s=>{let a=n[s.sentiment]||"rgba(255,255,255,.85)",o=s.addr&&He(s.addr)?`<button class="addr-link narrative-addr" data-addr="${y(s.addr)}">Peek</button>`:"";return`
  ...
  `,t?t.insertAdjacentElement("afterend",s):n?n.insertAdjacentElement("afterend",s):e.prepend(s)}function gb(){if(kp)return;kp=!0;let e=document.querySelector(".dashboard-col-main");if(!e)return;let t=document.createElement("section");t.className="widget-card",t.id="landscape-card",t.setAttribute("aria-label","Landscape brief"),t.innerHTML=`
  ...
  `,t.querySelectorAll(".risk-box-toggle").forEach(n=>{var a;n.addEventListener("click",()=>{let o=n.getAttribute("data-target"),i=document.getElementById(o);if(!i)return;let r=n.getAttribute("aria-expanded")!=="false";n.setAttribute("aria-expanded",r?"false":"true"),i.classList.toggle("risk-collapsed",r),n.querySelector(".risk-box-chevron").textContent=r?"\u25B8":"\u25BE";try{localStorage.setItem("risk_collapsed_"+o,r?"1":"0")}catch{}});let s=n.getAttribute("data-target");try{localStorage.getItem("risk_collapsed_"+s)==="1"&&(n.setAttribute("aria-expanded","false"),(a=document.getElementById(s))==null||a.classList.add("risk-collapsed"),n.querySelector(".risk-box-chevron").textContent="\u25B8")}catch{}}),e.appendChild(t)}function kb(e){var r,l,c,u,p,d,m,f,g,v;if(!document.getElementById("risk-card"))return;V("risk-badge",`Risk ${e.friction}/100`),V("risk-regime",e.regime),V("risk-friction",`${e.friction}/100`);let t=[];e.hhi>=.35&&t.push({cls:"warn",t:"High concentration"}),e.breadcrumbs.filter(h=>h.count>=2).length>=3&&t.push({cls:"new",t:"Repeating counterparties"}),(l=(r=e.behavior)==null?void 0:r.bots)!=null&&l.length&&t.push({cls:"warn",t:"Bot-like timing"}),(u=(c=e.dexPatterns)==null?void 0:c.signals)!=null&&u.length&&t.push({cls:"warn",t:"DEX churn signals"}),((p=e.advanced)==null?void 0:p.selfTradeCount)>0&&t.push({cls:"warn",t:`Self-transfer: ${e.advanced.selfTradeCount}`}),(((d=e.advanced)==null?void 0:d.roundnessIdx)??0)>=45&&t.push({cls:"warn",t:`Round-number bias ${e.advanced.roundnessIdx}%`}),((m=e.advanced)==null?void 0:m.pathPays)>0&&t.push({cls:"warn",t:`Path flow: ${e.advanced.pathPays}`}),V("risk-signalcount",`${t.length}`);let n=w("risk-pills");n&&(n.innerHTML=t.length?t.map(h=>`<span class="sig-pill ${h.cls}">${y(h.t)}</span>`).join(""):'<span class="sig-pill ok">No elevated signals</span>');let s=w("risk-bots");if(s){let h=((f=e.behavior)==null?void 0:f.bots)||[];if(h.length){let b={};for(let k of h){let T=k.botType||"Periodic";b[T]||(b[T]=[]),b[T].push(k)}let x=["Market Maker","Arbitrage","Flood / Spam","Periodic"];s.innerHTML=x.filter(k=>b[k]).map(k=>{let T=b[k];return`<div class="bot-type-group">
    ...
    `,e.prepend(t)}}}function Sb(){fe.dexPressure=[],fe.nftMints=[],fe.nftBurns=[],fe.autoBridge=[],Ni.clear(),Object.keys(Ei).forEach(e=>delete Ei[e]),ru({offerTotal:null,dexCancelPct:null,dexTopSharePct:null,mints:null,burns:null,pathPays:null,topPathActors:[],topPathPairs:[]})}function cs(e,t,n){for(e.push(Number(t||0));e.length>n;)e.shift()}function Tb(e){var n,s,a,o;let t=e==null?void 0:e.advanced;t&&(cs(fe.dexPressure,t.offerTotal,gg),cs(fe.nftMints,t.mints,bp),cs(fe.nftBurns,t.burns,bp),cs(fe.autoBridge,t.pathPays,bg),ru(t),(n=ye.dexPressure)==null||n.draw(fe.dexPressure),(s=ye.nftMints)==null||s.draw(fe.nftMints),(a=ye.nftBurns)==null||a.draw(fe.nftBurns),(o=ye.autoBridge)==null||o.draw(fe.autoBridge))}function ru(e){var t,n,s;if(document.getElementById("dex-pressure-card")&&(V("dexP-badge",e.offerTotal==null?"Waiting\u2026":`${e.offerTotal} offer tx`),V("dexP-now",e.offerTotal==null?"\u2014":e.offerTotal),V("dexP-cancel",e.dexCancelPct==null?"\u2014":`${e.dexCancelPct}%`),V("dexP-share",e.dexTopSharePct==null?"\u2014":`${e.dexTopSharePct}%`)),document.getElementById("autobridge-card")){V("ab-badge",e.pathPays==null?"Waiting\u2026":`${e.pathPays} path pays`),V("ab-now",e.pathPays==null?"\u2014":e.pathPays);let a=(t=e.topPathActors)==null?void 0:t[0];V("ab-top-actor",a?z(a.acct):"\u2014"),V("ab-pairs",(n=e.topPathPairs)!=null&&n.length?e.topPathPairs.length:"\u2014");let o=w("ab-top-pairs");o&&(o.innerHTML=(s=e.topPathPairs)!=null&&s.length?e.topPathPairs.map(i=>`
          <div class="dex-rowline">
            <span class="mono cut">${y(z(i.from))}</span>
            <span style="opacity:.7">\u2192</span>
            <span class="mono cut">${y(z(i.to))}</span>
            <span class="mono">${i.count}</span>
          </div>`).join(""):'<div style="opacity:.7">\u2014</div>')}if(document.getElementById("nft-mint-card")){let a=Number(e.mints||0)-Number(e.burns||0);V("nft-badge",e.mints==null&&e.burns==null?"Waiting\u2026":`${e.mints||0} mints \xB7 ${e.burns||0} burns`),V("nft-mints-now",e.mints==null?"\u2014":e.mints),V("nft-burns-now",e.burns==null?"\u2014":e.burns),V("nft-net-now",`${a}`)}}function Ya({force:e=!1}={}){if(!Yt()){Bi();return}mn&&!e||(mn&&(clearInterval(mn),mn=null),Hp(),mn=setInterval(()=>{Yt()&&Hp()},vg))}function Bi(){mn&&(clearInterval(mn),mn=null)}async function Hp(){var t,n,s,a,o,i,r,l,c,u;let e=++Ci;V("mkt-badge","Loading\u2026");try{let d=await fetch("https://api.exchange.coinbase.com/products/XRP-USD/candles?granularity=3600",{cache:"no-store"});if(!d.ok)throw new Error("market history failed");let m=await d.json();if(!Array.isArray(m)||m.length<10)throw new Error("no history");if(e!==Ci)return;let f=[...m].sort((k,T)=>Number(k[0])-Number(T[0])),g=f.map(k=>Number(k[4])).filter(Number.isFinite),v=f.map(k=>Number(k[5])).filter(Number.isFinite);fe.marketPrice=g.slice(-Xa),fe.marketVol=v.slice(-Xa);let h=fe.marketPrice.at(-1),b=fe.marketPrice.length>24?fe.marketPrice.at(-25):fe.marketPrice.at(0),x=b&&h?(h-b)/b*100:null;V("mkt-badge",h?`$${h.toFixed(4)}`:"\u2014"),V("mkt-price",h?`$${h.toFixed(4)}`:"\u2014"),V("mkt-chg",x==null?"\u2014":vn(x,2)),V("mkt-upd",new Date().toLocaleTimeString()),(t=ye.marketPrice)==null||t.draw(fe.marketPrice),(n=ye.marketVol)==null||n.draw(fe.marketVol);return}catch{}try{let p=await fetch("https://api.coinpaprika.com/v1/tickers/xrp-xrp",{cache:"no-store"});if(!p.ok)throw new Error("tick failed");let d=await p.json();if(e!==Ci)return;let m=Number((a=(s=d==null?void 0:d.quotes)==null?void 0:s.USD)==null?void 0:a.price),f=Number((i=(o=d==null?void 0:d.quotes)==null?void 0:o.USD)==null?void 0:i.volume_24h),g=Number((l=(r=d==null?void 0:d.quotes)==null?void 0:r.USD)==null?void 0:l.percent_change_24h);Number.isFinite(m)&&(cs(fe.marketPrice,m,Xa),Number.isFinite(f)&&cs(fe.marketVol,f,Xa)),V("mkt-badge",Number.isFinite(m)?`$${m.toFixed(4)}`:"\u2014"),V("mkt-price",Number.isFinite(m)?`$${m.toFixed(4)}`:"\u2014"),V("mkt-chg",Number.isFinite(g)?`${g>=0?"\u2191":"\u2193"}${Math.abs(g).toFixed(2)}%`:"\u2014"),V("mkt-upd",new Date().toLocaleTimeString()),(c=ye.marketPrice)==null||c.draw(fe.marketPrice),(u=ye.marketVol)==null||u.draw(fe.marketVol)}catch{V("mkt-badge","Unavailable")}}function Cb(){var n,s,a,o;if(Ep)return;Ep=!0;let e=document.querySelector(".dashboard-fullwidth");if(!e){e=document.createElement("div"),e.className="dashboard-fullwidth";let i=document.querySelector(".dashboard-columns");i?i.insertAdjacentElement("afterend",e):(n=document.querySelector(".dashboard-page"))==null||n.appendChild(e)}if(document.getElementById("spam-defense-card"))return;let t=document.createElement("section");t.className="widget-card",t.id="spam-defense-card",t.setAttribute("aria-label","Spam defense"),Xi(),pu(),t.innerHTML=`
  ...
  `,e.appendChild(t),(s=w("spam-copy-hash"))==null||s.addEventListener("click",()=>{var i;return zp(((i=w("spam-proof-hash"))==null?void 0:i.textContent)||"")}),(a=w("spam-copy-json"))==null||a.addEventListener("click",()=>{var i;return zp(((i=w("spam-proof-json"))==null?void 0:i.textContent)||"")}),(o=w("spam-print-proof"))==null||o.addEventListener("click",Fb),_renderBondSim()}window._toggleBondSim=function(){let e=w("spam-sim-panel");if(!e)return;let t=e.style.display!=="none";e.style.display=t?"none":"";let n=w("spam-sim-toggle");n&&(n.style.color=t?"":"#00d4ff")};window._renderBondSim=function(){let e=document.getElementById("sim-base"),t=document.getElementById("sim-growth"),n=document.getElementById("sim-table");if(!n)return;let s=Number((e==null?void 0:e.value)||gs),a=Number((t==null?void 0:t.value)||bs),o=fe.marketPrice.at(-1)??null;document.getElementById("sim-base-val")&&(document.getElementById("sim-base-val").textContent=s+" XRP"),document.getElementById("sim-growth-val")&&(document.getElementById("sim-growth-val").textContent=a+"\xD7");let i="";for(let r=0;r<=Js;r++){let l=Math.round(s*a**r),c=o?"$"+(l*o).toLocaleString(void 0,{maximumFractionDigits:0}):"",u=r<3?"#50fa7b":r<6?"#ffb86c":"#ff5555";i+=`<div style="padding:5px;border-radius:6px;background:rgba(255,255,255,.03);border:1px solid rgba(255,255,255,.07)">
      ...
      ${c?`<div style="font-size:.62rem;opacity:.45">${c}</div>`:""}
    </div>`}n.innerHTML=i};async function zp(e){try{await navigator.clipboard.writeText(String(e||"")),ne("Copied")}catch{he("Copy failed (browser blocked clipboard).")}}function Gs(e){let t=we(Number(e)||0,0,Js);return Math.round(gs*bs**t)}function Xi(){try{let e=JSON.parse(localStorage.getItem(Jp)||"[]");ie.allowList=new Set(e)}catch{ie.allowList=new Set}}function lu(){try{localStorage.setItem(Jp,JSON.stringify([...ie.allowList]))}catch{}}function cu(e){He(e)&&(ie.allowList.add(e),lu(),ie.byAddr.delete(e),ne(`${z(e)} added to allow-list \u2014 will no longer be flagged`))}window._spamAllowAddr=cu;function du(){try{return JSON.parse(localStorage.getItem(Kp)||"{}")}catch{return{}}}function Pb(e){try{localStorage.setItem(Kp,JSON.stringify(e))}catch{}}function pu(){let e=du();for(let[t,n]of Object.entries(e))ie.verifiedCache.set(t,n)}window.exportSpamReputation=function(){let e=[...ie.byAddr.entries()].map(([o,i])=>({addr:o,level:i.level,strikes:i.strikes,score:+(i.score||0).toFixed(4),threatType:i.threatType||"Unknown",verified:!!i.verifiedLedger,verifiedLedger:i.verifiedLedger??null,lastSeen:i.lastSeenLedger??null})),t={v:2,network:X.currentNetwork||"xrpl-mainnet",exportedAt:new Date().toISOString(),allowList:[...ie.allowList],suspects:e,policy:{bondBaseXrp:gs,bondGrowth:bs,ratchetMax:Js}},n=new Blob([JSON.stringify(t,null,2)],{type:"application/json"}),s=URL.createObjectURL(n),a=document.createElement("a");a.href=s,a.download=`naluxrp_reputation_${new Date().toISOString().slice(0,10)}.json`,document.body.appendChild(a),a.click(),document.body.removeChild(a),URL.revokeObjectURL(s),ne("Reputation list exported")};window.importSpamReputation=function(e){if(!e)return;let t=new FileReader;t.onload=n=>{var s;try{let a=JSON.parse(n.target.result);if(!a.suspects)throw new Error("Invalid format");let o=0;for(let i of a.suspects){if(!He(i.addr))continue;let r=ie.byAddr.get(i.addr)||{};ie.byAddr.set(i.addr,{...r,level:i.level??0,strikes:i.strikes??0,score:i.score??0,threatType:i.threatType??"Unknown",verifiedLedger:i.verifiedLedger??null,lastSeenLedger:i.lastSeen??null,scoreHistory:[],signalBreakdown:{}}),o++}if((s=a.allowList)!=null&&s.length){for(let i of a.allowList)He(i)&&ie.allowList.add(i);lu()}ne(`Imported ${o} reputation entries`)}catch(a){he("Import failed: "+a.message)}},t.readAsText(e)};function Mb(e){var l,c;if(!document.getElementById("spam-defense-card"))return;let t=Nb(e),n=t.reduce((u,p)=>Math.max(u,p.level),0),s=t.filter(u=>u.verified).length,a=fe.marketPrice.at(-1)??null,o=t.reduce((u,p)=>u+Gs(p.level),0),i=a?`~$${(o*a).toLocaleString(void 0,{maximumFractionDigits:0})}`:`${o} XRP`;V("spam-count",t.length),V("spam-maxlvl",`L${n}`),V("spam-verified",s),V("spam-allowcount",ie.allowList.size),V("spam-bondusd",i),V("spam-badge",t.length?`${t.length} tracked \xB7 max L${n}`:"Quiet");let r=w("spam-list");if(r&&(t.length?r.innerHTML=t.map(u=>{let p=Gs(u.level),d=a?` (~$${(p*a).toFixed(0)})`:"",m=u.level>=6?"#ff5555":u.level>=3?"#ffb86c":"#50fa7b",f=u.score>=.7?"#ff5555":u.score>=.4?"#ffb86c":"#50fa7b",g={"Payment Flooder":"#ff5555","Quote Stuffer":"#ff5555","Wash Trader":"#ff5555","DEX Bot":"#ffb86c","Arb Router":"#00d4ff","Periodic Bot":"#bd93f9"}[u.threatType]||"rgba(255,255,255,.6)",v=u.verified?`<span class="spam-cred-chip">\u2714 L${u.level} verified</span>`:"",h=Lb(u.scoreHistory||[]);return`
          <div class="spam-card" data-spam-addr="${y(u.addr)}">
            ...
            <div class="spam-card-meta">
              ...
              <span class="spam-meta-chip">Bond <b>${p>=1e3?(p/1e3).toFixed(1)+"k":p} XRP${d}</b></span>
              ${v}
            ...
            <div class="spam-breakdown" id="spam-bd-${y(u.addr.slice(0,10))}" style="display:none">
              ${Ab(u.breakdown,u.strikes)}
            </div>
          </div>`}).join(""):r.innerHTML=`<div class="spam-empty">No suspects flagged \u2014 allow-list has ${Yp.size} known-good entities.</div>`),Di||Eb(),ie.selectedAddr){let u=ie.byAddr.get(ie.selectedAddr);u?Hi(ie.selectedAddr,u,e.s.ledgerIndex).then(p=>hs(p)):hs(null)}((l=document.getElementById("spam-sim-panel"))==null?void 0:l.style.display)!=="none"&&((c=window._renderBondSim)==null||c.call(window))}function Lb(e){if(!(e!=null&&e.length))return"";let t=42,n=14,s=1,a=t/Math.max(1,e.length-1),o=e.map((l,c)=>`${(c*a).toFixed(1)},${(n-2-l/s*(n-4)).toFixed(1)}`).join(" "),i=e.at(-1)??0,r=i>=.7?"#ff5555":i>=.4?"#ffb86c":"#50fa7b";return`<svg width="${t}" height="${n}" xmlns="http://www.w3.org/2000/svg" style="overflow:visible">
    ...
    <circle cx="${((e.length-1)*a).toFixed(1)}" cy="${(n-2-i/s*(n-4)).toFixed(1)}"
      r="2" fill="${r}"/>
  </svg>`}function Ab(e={},t=0){let n=[{label:"Bot timing",val:e.bot??0,desc:e.botType?`Type: ${e.botType}`:"Low variance in repeated ledger appearances"},{label:"DEX dominance",val:e.dexDom??0,desc:"Share of offer tx window controlled by this address"},{label:"Cancel pattern",val:e.cancelPat??0,desc:"Heavy OfferCancel activity relative to creates"},{label:"Ping-pong loop",val:e.pingPong??0,desc:"Bidirectional repeated payments between two addresses"},{label:"Path routing",val:e.pathRoute??0,desc:"High path-payment count \u2014 common in arb bots"},{label:"Self-transfer",val:e.selfTrade??0,desc:"Payments where sender = receiver"},{label:"Round-number pay",val:e.roundPay??0,desc:"Unusual bias toward exact round-number payment amounts"}].filter(s=>s.val>.001);return n.length?`
    ...
    </div>`:'<div style="opacity:.5;font-size:.78rem;padding:6px 0">No significant signal breakdown available yet.</div>'}var Di=!1;function Eb(){Di||(Di=!0,document.addEventListener("click",e=>{var a,o,i,r;let t=(o=(a=e.target).closest)==null?void 0:o.call(a,"button[data-action][data-spam-addr]");if(!t)return;let n=t.getAttribute("data-action"),s=t.getAttribute("data-spam-addr");if(s){if(n==="proof"){let l=ie.byAddr.get(s);if(!l)return;ie.selectedAddr=s;let c=w("spam-proof");if(c){c.style.display="";let u=w("spam-proof-hash");u&&(u.textContent="Computing SHA-512Half\u2026")}Hi(s,l,((r=(i=X.ledgerLog)==null?void 0:i[0])==null?void 0:r.ledgerIndex)||null).then(u=>{ie.selectedProof=u,hs(u)}).catch(u=>he("Proof build failed: "+u.message));return}if(n==="clear"){ie.byAddr.delete(s),ie.selectedAddr===s&&hs(null),ne("Cleared from session");return}if(n==="allow"){cu(s),ie.byAddr.delete(s),ie.selectedAddr===s&&hs(null);return}if(n==="expand"){let l=s.slice(0,10),c=document.getElementById("spam-bd-"+l);if(!c)return;let u=c.style.display!=="none";c.style.display=u?"none":"",t.textContent=u?"\u25BE Detail":"\u25B4 Hide";return}}}))}function hs(e){let t=w("spam-proof");if(!t)return;if(!e){t.style.display="none";return}t.style.display="",V("spam-proof-hash",e.hash);let n=w("spam-proof-json");n&&(n.textContent=e.canonicalJson);let s=w("spam-cred-step");s&&(s.innerHTML=`
      <div style="opacity:.9">
    ...
    `)}function Nb(e){var o,i,r,l,c;ie.allowList.size||Xi();let t=new Set;(((o=e.behavior)==null?void 0:o.bots)||[]).forEach(u=>t.add(u.acct)),(((i=e.dexPatterns)==null?void 0:i.topActor)||[]).forEach(u=>t.add(u.acct)),(((r=e.dexPatterns)==null?void 0:r.topCanceller)||[]).forEach(u=>t.add(u.acct)),(((l=e.dexPatterns)==null?void 0:l.topMaker)||[]).forEach(u=>t.add(u.acct)),(e.breadcrumbs||[]).forEach(u=>{t.add(u.from),t.add(u.to)}),(e.clusters||[]).forEach(u=>{t.add(u.hub),(u.members||[]).forEach(p=>t.add(p))}),(((c=e.advanced)==null?void 0:c.topPathActors)||[]).forEach(u=>t.add(u.acct));let n=Number(e.s.ledgerIndex||0)||null,s=e.txs||[],a=[];if(n&&n%50===0){let u=Ua*24;for(let[p,d]of ie.byAddr)n-(d.lastSeenLedger||0)>u&&ie.byAddr.delete(p)}for(let u of t){if(!He(u)||Yp.has(u)||ie.allowList.has(u))continue;let{score:p,breakdown:d}=_b(u,e),m=Rb(d),f=ie.byAddr.get(u)||{strikes:0,level:0,score:0,verifiedLedger:null,lastSeenLedger:null,scoreHistory:[],threatType:"Unknown",signalBreakdown:{}},g=f.strikes||0;p>=Gp?g+=1:p<=Li&&(g=Math.max(0,g-1));let v=f.lastSeenLedger||n,h=n?n-v:0;if(h>Ua&&p<Li){let $=Math.floor(h/Ua);g=Math.max(0,g-$)}let b=we(Math.floor(g/Vp),0,Js),x=[...f.scoreHistory||[],p].slice(-10),k=ie.verifiedCache.get(u),T=f.verifiedLedger??(k==null?void 0:k.ledgerIndex)??null;T||(T=Db(u,b,s,n),T&&Ib(u,b,n));let S={score:p,strikes:g,level:b,verifiedLedger:T,lastSeenLedger:n,scoreHistory:x,threatType:m,signalBreakdown:d};ie.byAddr.set(u,S),a.push({addr:u,score:p,strikes:g,level:b,verified:!!T,verifiedLedger:T,scoreHistory:x,threatType:m,breakdown:d})}return a.sort((u,p)=>p.level-u.level||p.score-u.score),a.slice(0,wg)}function Rb(e){let{bot:t=0,dexDom:n=0,cancelPat:s=0,pingPong:a=0,pathRoute:o=0,selfTrade:i=0,roundPay:r=0}=e,l=n+s;return t>.25&&(e.botType==="Flood / Spam"||r>.05)?"Payment Flooder":t>.2&&l>.15?"DEX Bot":l>.3&&s>.1?"Quote Stuffer":a>.1?"Wash Trader":o>.1?"Arb Router":t>.2?"Periodic Bot":"Multi-Signal"}function _b(e,t){var m,f,g,v,h;let n={bot:0,botType:null,dexDom:0,cancelPat:0,pingPong:0,pathRoute:0,selfTrade:0,roundPay:0},s=(((m=t.behavior)==null?void 0:m.bots)||[]).find(b=>b.acct===e);if(s){let b=we((.35-s.cv)/.35,0,1);n.bot=+(.4*(.5+.5*b)).toFixed(3),n.botType=s.botType||"Periodic"}let a=t.dexPatterns,o=((g=(f=a==null?void 0:a.topActor)==null?void 0:f[0])==null?void 0:g.acct)===e&&a.topShare||0;o>0&&(n.dexDom=+(.3*we((o-.2)/.4,0,1)).toFixed(3));let i=((a==null?void 0:a.topCanceller)||[]).find(b=>b.acct===e);i&&(n.cancelPat=+(.2*we(i.count/20,0,1)).toFixed(3));let r=t.breadcrumbs||[],l=r.find(b=>b.from===e&&b.to===e);l&&(n.selfTrade=+(.2*we(l.count/20,0,1)).toFixed(3));let c=r[0];if(c&&(c.from===e||c.to===e)){let b=r.find(x=>x.from===c.to&&x.to===c.from);b&&b.count>=3&&c.count>=3&&(n.pingPong=.15)}let u=(((v=t.advanced)==null?void 0:v.topPathActors)||[]).find(b=>b.acct===e);u&&(n.pathRoute=+(.15*we(u.count/25,0,1)).toFixed(3));let p=(h=t.advanced)==null?void 0:h.roundnessIdx;return p!=null&&p>=45&&(u||s)&&(n.roundPay=+(.1*we((p-45)/35,0,1)).toFixed(3)),{score:we(n.bot+n.dexDom+n.cancelPat+n.pingPong+n.pathRoute+n.selfTrade+n.roundPay,0,1),breakdown:n}}function Db(e,t,n,s){if(!(n!=null&&n.length))return null;let a=ds+t;for(let o of n)if((o==null?void 0:o.account)===e){if(o.type==="EscrowCreate"&&o.destination===e){let i=typeof o.amountXrp=="number"?o.amountXrp:null,r=Gs(t);if(i!=null&&i>=r&&Ii(o.memos).startsWith(fn))return s}if(o.type==="Payment"&&o.destination===e&&Number(o.destinationTag)===a&&Ii(o.memos).startsWith(fn))return s}return null}async function Ib(e,t,n){var a;let s=ie.byAddr.get(e);if(s)try{let o=await Hi(e,s,n),i=fn+o.hash;if((((a=X.ledgerLog)==null?void 0:a.flatMap(c=>c.transactions||[]))||[]).some(c=>(c==null?void 0:c.account)!==e?!1:Ii(c.memos).startsWith(i))){let c=du();c[e]={ledgerIndex:n,hash:o.hash,level:t},Pb(c),ie.verifiedCache.set(e,{ledgerIndex:n,hash:o.hash}),ne(`\u2714 Credential verified for ${z(e)} at L${t}`)}}catch{}}function Ii(e){if(!Array.isArray(e))return"";let t=[];for(let n of e){let s=(n==null?void 0:n.Memo)||(n==null?void 0:n.memo)||null;if(!s)continue;let a=s.MemoData||s.memo_data||"";try{if(typeof a=="string"&&/^[0-9A-Fa-f]+$/.test(a)&&a.length%2===0){let o=Uint8Array.from(a.match(/../g),i=>parseInt(i,16));t.push(new TextDecoder().decode(o))}else typeof a=="string"&&t.push(a)}catch{}}return t.join(" ")}async function Hi(e,t,n){let s=t.level||0,a=Gs(s),o=fe.marketPrice.at(-1)??null,i=o?(a*o).toFixed(2):null,r={hashAlgorithm:"SHA-512Half",ratchetMax:Js,strikesToLevel:Vp,strikeUp:Gp,strikeDown:Li,decayLedgers:Ua,bondBaseXrp:gs,bondGrowthFactor:bs,bondRequiredXrp:a,bondRequiredUsd:i,credTagBase:ds,memoPrefix:fn,credentialTag:ds+s},l={v:2,hashAlg:"SHA-512Half",network:X.currentNetwork||"xrpl-mainnet",address:e,ledgerIndex:n!=null?Number(n):null,level:s,threatType:t.threatType||"Unknown",score:Number((t.score||0).toFixed(4)),strikes:Number(t.strikes||0),signalBreakdown:t.signalBreakdown||{},credential:{destinationTag:ds+s,memoFormat:fn+"<SHA-512Half-of-this-proof>",verifiedLedger:t.verifiedLedger??null},policy:r,note:"Generated by NaluXRP Spam Defense POC. Hash uses XRPL-native SHA-512Half (first 256 bits of SHA-512). A gateway or relayer policy can require the indicated bond/credential before providing service to this address.",generatedAt:new Date().toISOString()},c=JSON.stringify(l,Object.keys(l).sort(),0),u=await Cg(c);l.credential.memoFormat=fn+u;let p=JSON.stringify(l,null,2);return{hash:u,canonicalJson:p,level:s,policy:r,threatType:t.threatType}}function Fb(){let e=ie.selectedProof;if(!e){he("Generate a proof first using the Proof button.");return}let t=ie.selectedAddr||"\u2014",n=fe.marketPrice.at(-1)??null,s=e.policy.bondRequiredXrp,a=n?` (~$${(s*n).toFixed(0)} USD)`:"",o=e.hash.startsWith("FALLBACK")?'<div style="padding:8px 12px;background:#fff3cd;border:1px solid #f0ad4e;border-radius:4px;margin-bottom:12px">\u26A0 Hash is non-cryptographic (SubtleCrypto unavailable). Do NOT use for enforcement.</div>':"",i=window.open("","_blank","width=760,height=660");i.document.write(`<!DOCTYPE html><html><head>
    ...
    </body></html>`),i.document.close()}var uu=null;function Ob(){if(Ai)return;Ai=!0;let e=document.querySelector('[aria-label="Pattern detection"]');if(!e){e=document.createElement("section"),e.className="widget-card",e.setAttribute("aria-label","Pattern detection");let t=document.querySelector(".dashboard-col-main");if(!t)return;let n=t.querySelector(".dashboard-metrics");n?n.insertAdjacentElement("afterend",e):t.prepend(e)}e.innerHTML=`
    <div class="widget-header">
    ...
    </div>`,uu=document.getElementById("pattern-donut-canvas")}function Bb(e,t){if(!Ai)return;let n=typeof It<"u"?It:{},s=Object.entries(e||{}).filter(([,m])=>m>0).sort(([,m],[,f])=>f-m);if(!s.length)return;let a=s.reduce((m,[,f])=>m+f,0)||1,[o,i]=s[0],r=Math.round(i/a*100),l=s[1],c=w("pattern-badge");c&&(c.textContent=o+" \xB7 "+r+"%");let u=w("pattern-dom-type");if(u&&(u.textContent=o,u.style.color=n[o]||"rgba(255,255,255,.9)"),V("pattern-dom-pct",r+"% of ledger"),l){let m=Math.round(l[1]/a*100),f=w("pattern-2nd-type");f&&(f.textContent=l[0]+" ("+m+"%)",f.style.color=n[l[0]]||"rgba(255,255,255,.7)")}else V("pattern-2nd-type","\u2014");let p=w("pattern-hhi");p&&t!=null&&(p.textContent=t.toFixed(3),p.style.color=t>=.35?"#ff5555":t>=.25?"#ffb86c":"#50fa7b");let d=w("pattern-donut-center");d&&(d.innerHTML='<span style="color:'+(n[o]||"#fff")+';font-size:1.15rem">'+r+"%</span>"),Xb(s,a,n)}function Xb(e,t,n){let s=uu||w("pattern-donut-canvas");if(!(s!=null&&s.getContext))return;let a=s.getContext("2d"),o=s.width/2,i=s.height/2,r=Math.min(s.width,s.height)/2-6,l=r*.56;a.clearRect(0,0,s.width,s.height);let c=e.slice(0,7),u=e.slice(7).reduce((m,[,f])=>m+f,0),p=u>0?[...c,["Other",u]]:[...c],d=-Math.PI/2;for(let[m,f]of p){let g=f/t*Math.PI*2,v=us(n[m]||"#6b7280",.88)||"#6b7280";a.beginPath(),a.moveTo(o+Math.cos(d)*l,i+Math.sin(d)*l),a.arc(o,i,r,d,d+g),a.arc(o,i,l,d+g,d,!0),a.closePath(),a.fillStyle=v,a.fill(),a.strokeStyle="rgba(0,8,20,0.85)",a.lineWidth=2,a.stroke(),d+=g}a.beginPath(),a.arc(o,i,l-1,0,Math.PI*2),a.fillStyle="rgba(0,21,36,0.94)",a.fill()}function Hb(e,t){let n=!1;for(let s of e){if((s==null?void 0:s.type)!=="Payment")continue;let a=typeof(s==null?void 0:s.amountXrp)=="number"?s.amountXrp:null;a==null||a<Xn.whaleTxXrp||(_t.unshift({ts:Date.now(),ledgerIndex:t,from:s.account||"\u2014",to:s.destination||"\u2014",amtXrp:a,hash:s.hash||""}),et.whaleCount++,n=!0)}if(n){for(;_t.length>xg;)_t.pop();Wb()}}function zb(){if(Np)return;Np=!0;let e=document.querySelector(".dashboard-col-side");if(!e)return;let t=document.createElement("section");t.className="widget-card",t.id="whale-feed-card",t.setAttribute("aria-label","Whale alert feed"),t.innerHTML=`
    <div class="widget-header">
    ...
    </div>`,e.prepend(t)}function Wb(){let e=w("whale-feed-list");if(!e)return;let t=w("whale-badge");if(t&&(t.textContent=_t.length?`${_t.length} alerts`:"Watching\u2026"),!_t.length){e.innerHTML='<div style="opacity:.5;font-size:.82rem;padding:8px 0">No whale transactions yet.</div>';return}e.innerHTML=_t.slice(0,20).map(n=>{let s=n.amtXrp>=1e6?`${(n.amtXrp/1e6).toFixed(2)}M`:n.amtXrp>=1e3?`${(n.amtXrp/1e3).toFixed(0)}K`:n.amtXrp.toFixed(0),a=Math.floor((Date.now()-n.ts)/1e3),o=a<60?`${a}s`:a<3600?`${Math.floor(a/60)}m`:`${Math.floor(a/3600)}h`;return`<div style="border-bottom:1px solid rgba(255,255,255,.05);padding:7px 0">
    ...
    </div>`}).join("")}function jb(){if(Rp)return;Rp=!0;let e=document.querySelector(".dashboard-col-main");if(!e)return;let t=document.createElement("section");t.className="widget-card",t.id="network-health-card",t.setAttribute("aria-label","Network health"),t.innerHTML=`
    <div class="widget-header">
    ...
    <div style="display:flex;align-items:center;gap:16px;padding:8px 0 12px">
      ...
      </div>`}).join(""))}function qb(){if(_p)return;_p=!0;let e=document.querySelector(".dashboard-col-side");if(!e)return;let t=document.createElement("section");t.className="widget-card",t.id="session-stats-card",t.setAttribute("aria-label","Session stats"),t.innerHTML=`
    <div class="widget-header">
    ...
    </div>`,e.appendChild(t)}function Vb(){if(!document.getElementById("session-stats-card"))return;let e=Math.floor((Date.now()-et.startTime)/6e4);V("ss-ledgers",et.ledgersProcessed.toLocaleString()),V("ss-tx",et.totalTx.toLocaleString()),V("ss-whales",et.whaleCount),V("ss-feespikes",et.feeSpikes),V("ss-bots",et.botDetections),V("ss-dexalerts",et.dexAlerts),V("ss-time",`${e}m`),V("ss-badge",`${et.ledgersProcessed} ledgers`)}function Gb(e,t){var o,i,r,l,c,u,p,d;if(Qp=t,_t.length&&_t[0].ledgerIndex===t){let m=_t[0],f=m.amtXrp>=1e6?`${(m.amtXrp/1e6).toFixed(1)}M`:`${(m.amtXrp/1e3).toFixed(0)}K`;ne(`\u{1F40B} Whale: ${f} XRP  ${z(m.from)} \u2192 ${z(m.to)}`)}let n=su(),s=(o=X.feeHistory)==null?void 0:o.at(-1);s&&n&&s>n*Xn.feeSpikeMultiple&&(et.feeSpikes++,he(`\u{1F525} Fee spike: ${hn(s)} (${Math.round(s/n)}\xD7 baseline)`));let a=(((i=e.behavior)==null?void 0:i.bots)||[]).filter(m=>m.cv<Xn.botCvThreshold&&m.total>8);a.length&&(et.botDetections=Math.max(et.botDetections,a.length),a[0].botType==="Flood / Spam"&&he(`\u{1F916} Spam bot: ${z(a[0].acct)} (CV ${a[0].cv.toFixed(2)})`)),((l=(r=e.dexPatterns)==null?void 0:r.window)==null?void 0:l.cancelRatio)>=Xn.dexCancelAlert&&((u=(c=e.dexPatterns)==null?void 0:c.window)==null?void 0:u.total)>=20&&(et.dexAlerts++,he(`\u{1F9E0} DEX: ${Math.round(e.dexPatterns.window.cancelRatio*100)}% cancel ratio \u2014 possible quote-stuffing`)),((d=(p=e.clusters)==null?void 0:p[0])==null?void 0:d.size)>=Xn.clusterMinSize&&ne(`\u{1F578} Cluster: ${e.clusters[0].size} wallets around ${z(e.clusters[0].hub)}`),e.friction>=75&&e.regime==="Manipulated"&&he(`\u26A0\uFE0F Risk score: ${e.friction}/100 \u2014 ${e.regime} regime`),Ub(e.s)}function Kb(){var n,s,a,o;if(Dp)return;Dp=!0;let e=document.createElement("button");e.id="customize-btn",e.className="customize-btn",e.setAttribute("aria-pressed","false"),e.innerHTML="\u2699 Customize",(n=document.querySelector(".dashboard-header"))==null||n.appendChild(e);let t=document.createElement("div");t.id="customize-panel",t.className="customize-panel",t.setAttribute("aria-label","Dashboard customizer"),t.innerHTML=`
    ...
    </div>`,document.body.appendChild(t),e.addEventListener("click",()=>Wp()),(s=document.getElementById("customize-close"))==null||s.addEventListener("click",()=>Wp(!1)),(a=document.getElementById("customize-reset"))==null||a.addEventListener("click",()=>{try{localStorage.removeItem(Ga),localStorage.removeItem(vs)}catch{}jp(),Fi(),zi()}),(o=document.getElementById("customize-export"))==null||o.addEventListener("click",()=>{var i;try{let r={order:JSON.parse(localStorage.getItem(Ga)||"[]"),hidden:JSON.parse(localStorage.getItem(vs)||"[]"),alertConfig:Xn};(i=navigator.clipboard)==null||i.writeText(JSON.stringify(r,null,2)),ne("Config copied to clipboard")}catch{he("Export failed")}}),jp(),Fi()}function Wp(e){var s;let t=document.getElementById("customize-panel"),n=document.getElementById("customize-btn");!t||!n||(Bn=e??!Bn,t.classList.toggle("customize-panel--open",Bn),n.setAttribute("aria-pressed",String(Bn)),n.textContent=Bn?"\u2715 Close":"\u2699 Customize",Bn&&zi(),(s=document.querySelector(".dashboard-col-side"))==null||s.classList.toggle("customize-mode",Bn))}function Ks(){var e;return[...((e=document.querySelector(".dashboard-col-side"))==null?void 0:e.querySelectorAll(":scope > .widget-card"))||[]]}function ys(e){return e.id||e.getAttribute("aria-label")||""}function Jb(e){var t,n;return((n=(t=e.querySelector(".widget-title"))==null?void 0:t.textContent)==null?void 0:n.trim())||ys(e)}function jp(){let e=document.querySelector(".dashboard-col-side");if(!e)return;let t;try{t=JSON.parse(localStorage.getItem(Ga)||"null")}catch{t=null}if(!Array.isArray(t)||!t.length)return;let n=new Map(Ks().map(s=>[ys(s),s]));t.forEach(s=>{let a=n.get(s);a&&e.appendChild(a)})}function Fi(){let e;try{e=JSON.parse(localStorage.getItem(vs)||"[]")}catch{e=[]}Ks().forEach(t=>t.classList.toggle("widget-hidden",e.includes(ys(t))))}function Yb(){try{localStorage.setItem(Ga,JSON.stringify(Ks().map(e=>ys(e))))}catch{}}function Qb(e){let t;try{t=JSON.parse(localStorage.getItem(vs)||"[]")}catch{t=[]}t=t.includes(e)?t.filter(n=>n!==e):[...t,e];try{localStorage.setItem(vs,JSON.stringify(t))}catch{}Fi(),zi()}function zi(){let e=document.getElementById("customize-list");if(!e)return;let t;try{t=JSON.parse(localStorage.getItem(vs)||"[]")}catch{t=[]}e.innerHTML="",Ks().forEach(n=>{var r;let s=ys(n),a=Jb(n),o=!t.includes(s),i=document.createElement("div");i.className="customize-row",i.setAttribute("draggable","true"),i.dataset.widgetId=s,i.innerHTML=`
      <span class="customize-drag-handle" title="Drag to reorder">\u283F</span>
      <span class="customize-row-title">${y(a)}</span>
      <button class="customize-vis-btn ${o?"vis-on":"vis-off"}" data-id="${y(s)}">${o?"\u{1F441} Visible":"\u{1F6AB} Hidden"}</button>`,i.addEventListener("dragstart",l=>{rs=i,l.dataTransfer.effectAllowed="move",i.classList.add("customize-dragging")}),i.addEventListener("dragend",()=>{i.classList.remove("customize-dragging"),e.querySelectorAll(".customize-row").forEach(u=>u.classList.remove("customize-over"));let l=[...e.querySelectorAll(".customize-row")].map(u=>u.dataset.widgetId),c=document.querySelector(".dashboard-col-side");if(c){let u=new Map(Ks().map(p=>[ys(p),p]));l.forEach(p=>{let d=u.get(p);d&&c.appendChild(d)})}Yb()}),i.addEventListener("dragover",l=>{if(l.preventDefault(),l.dataTransfer.dropEffect="move",rs&&rs!==i){e.querySelectorAll(".customize-row").forEach(u=>u.classList.remove("customize-over")),i.classList.add("customize-over");let c=[...e.querySelectorAll(".customize-row")];c.indexOf(rs)<c.indexOf(i)?e.insertBefore(rs,i.nextSibling):e.insertBefore(rs,i)}}),i.addEventListener("dragleave",()=>i.classList.remove("customize-over")),i.addEventListener("drop",l=>l.preventDefault()),(r=i.querySelector(".customize-vis-btn"))==null||r.addEventListener("click",()=>Qb(s)),e.appendChild(i)})}function Zb(){if(Ip)return;Ip=!0;let e=document.querySelector(".dashboard-header");if(!e||document.getElementById("global-pause-btn"))return;let t=document.createElement("button");t.id="global-pause-btn",t.className="global-pause-btn",t.setAttribute("aria-pressed","false"),t.title="Pause all updates \u2014 numbers stop changing so you can read",t.innerHTML="\u23F8 Live",t.addEventListener("click",()=>{Gt=!Gt,t.setAttribute("aria-pressed",String(Gt)),t.innerHTML=Gt?"\u25B6 Paused":"\u23F8 Live",t.classList.toggle("global-pause-btn--paused",Gt),Rt=Gt&&!Vs?Gt:Rt;let s=document.querySelector(".dashboard-sticky-strip");s&&s.classList.toggle("metrics-paused",Gt)});let n=document.getElementById("customize-btn");n?e.insertBefore(t,n):e.appendChild(t)}var Up=!1;function ev(){if(Up)return;Up=!0;let e=(t=0)=>{let n=document.querySelector("#risk-card .widget-header"),s=document.querySelector("#landscape-card .widget-header");if(!n&&!s&&t<20){setTimeout(()=>e(t+1),300);return}if(n&&!n.querySelector(".friction-sparkline-wrap")){let a=document.createElement("div");a.className="friction-sparkline-wrap",a.title="Risk score \u2014 last 30 ledgers",a.innerHTML='<canvas id="friction-sparkline-canvas" width="80" height="22"></canvas>',n.appendChild(a)}if(s&&!s.querySelector(".friction-sparkline-wrap")){let a=document.createElement("div");a.className="friction-sparkline-wrap",a.title="Risk score history",a.innerHTML='<canvas id="friction-sparkline-canvas-2" width="60" height="18"></canvas>',s.appendChild(a)}mu()};e()}function mu(){ps.length&&(qp("friction-sparkline-canvas",80,22),qp("friction-sparkline-canvas-2",60,18))}function qp(e,t,n){let s=document.getElementById(e);if(!(s!=null&&s.getContext))return;let a=s.getContext("2d");a.clearRect(0,0,t,n);let o=ps;if(o.length<2)return;let i=100,r=t/(o.length-1),l=o.map((g,v)=>[v*r,n-2-g.friction/i*(n-4)]),c=n-2-60/i*(n-4);a.fillStyle="rgba(255,85,85,.07)",a.fillRect(0,0,t,c);let u=a.createLinearGradient(0,0,0,n);u.addColorStop(0,"rgba(255,184,108,.35)"),u.addColorStop(1,"rgba(255,184,108,.05)"),a.beginPath(),l.forEach(([g,v],h)=>h===0?a.moveTo(g,v):a.lineTo(g,v)),a.lineTo(l.at(-1)[0],n),a.lineTo(0,n),a.closePath(),a.fillStyle=u,a.fill();let p=o.at(-1).friction,d=p<26?"#50fa7b":p<61?"#ffb86c":"#ff5555";a.beginPath(),l.forEach(([g,v],h)=>h===0?a.moveTo(g,v):a.lineTo(g,v)),a.strokeStyle=d,a.lineWidth=1.5,a.lineJoin="round",a.stroke();let[m,f]=l.at(-1);a.beginPath(),a.arc(m,f,2.5,0,Math.PI*2),a.fillStyle=d,a.fill()}window.printLandscapeReport=function(){var i,r,l,c;if(!document.getElementById("landscape-card"))return;let t=((i=document.getElementById("d2-ledger-index"))==null?void 0:i.textContent)||"\u2014",n=((r=document.getElementById("landscape-badge"))==null?void 0:r.textContent)||"",s=new Date().toLocaleString(),a=window.open("","_blank","width=860,height=700");a.document.write(`<!DOCTYPE html><html><head>
  ...
  `,e.appendChild(t);let n=s=>{var a;return(a=document.querySelector(`.dash-tab[data-tab="${s}"]`))==null?void 0:a.click()};t.addEventListener("click",s=>{let a=s.target.closest("button[data-go]");if(!a)return;let o=a.dataset.go;if(o==="stream"||o==="inspector"||o==="network"){n(o);return}n("stream"),setTimeout(()=>{var r;let i=o==="dex"?"dex-pattern-card":"risk-card";(r=document.getElementById(i))==null||r.scrollIntoView({behavior:"smooth",block:"start"})},80)})}function nv(){var a,o;if(Cp)return;Cp=!0;let e=document.querySelector(".dashboard-header");if(!e||document.getElementById("compactToggleBtn"))return;let t=document.createElement("button");t.id="compactToggleBtn",t.type="button",t.className="dash-accordion-toggle",t.textContent="Compact: OFF",e.appendChild(t);let n=(i,r=!0)=>{if(document.body.classList.toggle("dash-accordion",i),t.textContent=i?"Compact: ON":"Compact: OFF",r)try{localStorage.setItem(gp,i?"1":"0")}catch{}if(i){let l=document.querySelector(".dashboard-col-side .widget-card");l&&l.classList.add("is-open")}else document.querySelectorAll(".dashboard-col-side .widget-card.is-open").forEach(l=>l.classList.remove("is-open"))},s=null;try{s=localStorage.getItem(gp)}catch{}n(s==="1"?!0:s==="0"?!1:((o=(a=window.matchMedia)==null?void 0:a.call(window,"(max-width: 600px)"))==null?void 0:o.matches)??!1,!1),t.addEventListener("click",()=>n(!document.body.classList.contains("dash-accordion"),!0))}function sv(){if(Pp)return;Pp=!0;let e=document.querySelector(".dashboard-col-side");e&&e.addEventListener("click",t=>{var o,i;if(!document.body.classList.contains("dash-accordion"))return;let n=t.target;if((o=n==null?void 0:n.closest)!=null&&o.call(n,"button, a, input, textarea, select, kbd"))return;let s=(i=n==null?void 0:n.closest)==null?void 0:i.call(n,".widget-card");if(!s)return;let a=s.classList.contains("is-open");e.querySelectorAll(".widget-card.is-open").forEach(r=>{r!==s&&r.classList.remove("is-open")}),s.classList.toggle("is-open",!a)})}var _e={lsfPasswordSpent:65536,lsfRequireDestTag:131072,lsfRequireAuth:262144,lsfDisallowXRP:524288,lsfDisableMaster:1048576,lsfNoFreeze:2097152,lsfGlobalFreeze:4194304,lsfDefaultRipple:8388608,lsfDepositAuth:16777216},fu={lsfBurnable:1,lsfOnlyXRP:2,lsfTrustLine:4,lsfTransferable:8},av=new Set(["SetRegularKey","SignerListSet","AccountSet","AccountDelete","EscrowCreate","PaymentChannelCreate","DepositPreauth"]),yn={blackhole:"#ff5555",exchange:"#00d4ff",newWallet:"#ff79c6",issuer:"#ffb86c",wallet:"#bd93f9",other:"#8be9fd"},ov=.55,iv=.15,Yi=20,yu=946684800;function Se({module:e,category:t=null,sev:n,confidence:s=null,headline:a,detail:o="",observed:i=[],alternativeExplanations:r=[],evidenceAgainstBenign:l=[],classification:c=null,hashes:u=[]}={}){return{module:e,category:t,sev:n,confidence:s,headline:a,label:a,detail:o,observed:i,alternativeExplanations:r,evidenceAgainstBenign:l,classification:c,hashes:u}}var rv=new Map([["rPVMhWBsfF9iMXYj3aAzJVkPDTFNSyWdKy",{name:"Bitstamp",type:"exchange"}],["rvYAfWj5gh67oV6fW32ZzP3Aw4Eubs59B",{name:"Bitstamp",type:"exchange"}],["rrpNnNLKrartuEqfJGpqyDwPj1BBN1ih7",{name:"Bitstamp",type:"exchange"}],["rN7n3473SaZBCG4dFL83w7PB9judJ7qdDo",{name:"Binance",type:"exchange"}],["rEb8TK3gBgk5auZkwc6sHnwrGVJH8DuaLh",{name:"Binance",type:"exchange"}],["rBKPS4oLSaV2KVVuHH8EpQqMGgGefGFQs7",{name:"Bitso",type:"exchange"}],["rfk5bwaKCoNU84fTzdqWQowqnNaZorDmiV",{name:"Gate.io",type:"exchange"}],["rGFuMiw48HdbnrUbkRYDTvT5i9imC5fvv9",{name:"Gate.io",type:"exchange"}],["rwYHCs2EYBMBvRXFmxDrCUSorPsuqCck7t",{name:"Kraken",type:"exchange"}],["rLHzPsX6oXkzU2qL12kHCH8G8cnZv1rBJh",{name:"Kraken",type:"exchange"}],["ra5nK24KXen9AHvsdFTKHSANinZseWnPcX",{name:"Uphold",type:"exchange"}],["rGWrZyax5eXbi5gs49MRZKkE9eKNL9p4B",{name:"Bittrex",type:"exchange"}],["rDsbeomae4FXwgQTJp9Rs64Qg9vDiTCdBv",{name:"Coinone",type:"exchange"}],["rHsMUQFzBb7S6GnQFVgNirqvHRcLpAn5dU",{name:"Bithumb",type:"exchange"}],["rMQ98K56yXJbDGv49ZSmW51sLn94Xe1mu1",{name:"Huobi",type:"exchange"}],["rHcFoo6a9qT5NHiVn1THwX3B4QF2VQKWZ",{name:"Huobi",type:"exchange"}],["rKiCet8SdvWxPXnAgYarFUXMh1zCPz432Y",{name:"Coinbase",type:"exchange"}],["rHb9CJAWyB4rj91VRWn96DkukG4bwdtyTh",{name:"Coinbase",type:"exchange"}],["r9mhdcT2K7FdCGDEPqfbMJwVXsXCqEr5bP",{name:"OKX",type:"exchange"}],["r32U8WFxhqEAVkKcTb1GGRR1VH2oaFdexN",{name:"OKX",type:"exchange"}],["r4GDFMLGJUKMjNEycBKPGnRSNXyNVLQLHi",{name:"Bybit",type:"exchange"}],["rBETszU65yYoFcYdRkiGqFaYmhZpHWC7sj",{name:"Bybit",type:"exchange"}],["rMWUykAmNQDaM9poSes8VLDZDDkEoutilities",{name:"KuCoin",type:"exchange"}],["rUA1S9qobBkxLqzdfGEzh5wm5KdLfbf8bx",{name:"KuCoin",type:"exchange"}],["rHtbQzmN4BDaEBnGSXp3AZaZAuZamNVsME",{name:"MEXC",type:"exchange"}],["rDN1gPWW3XQFXVJFQSiJxPHGZiRLMVSi7K",{name:"MEXC",type:"exchange"}],["rB3gZey7VWHoDokMt3tCiXBSRmaZi5xJi9",{name:"Crypto.com",type:"exchange"}],["rhub8VRN55s94qWKDv6jmDy1pUykJzF3wq",{name:"GateHub",type:"exchange"}],["razqnFn6FqBaYBdNaGnVzmGaNE6XPRQ9bG",{name:"GateHub",type:"exchange"}],["rGQdkxNBQeQC1WTQDQ2F2QoGBZxYcMxBBg",{name:"GateHub",type:"exchange"}],["rpXTzCuXtjiPDFysxq8uNmtZBe9Xo97JbW",{name:"Bitbank",type:"exchange"}],["rsuUjfWxrACCAwGQDsNeZUhpzXf1n1NK5Z",{name:"Bitbank",type:"exchange"}],["r9oxUGJqMfMEhGBxrMJnmNvVh1LKkMv7fz",{name:"Coincheck",type:"exchange"}],["rHb9CJAWyB4rj91VRWn96DkukG4bwdtyTh",{name:"Genesis (Black Hole)",type:"blackhole"}],["r9cZA1mLK5R5Am25ArfXFmqgNwjZgnfk59",{name:"Black Hole #2",type:"blackhole"}],["rHb9CJAWyB4rj91VRWn96DkukG4bwdtyTh",{name:"Genesis Wallet",type:"ripple"}],["rHb9CJAWyB4rj91VRWn96DkukG4bwdtyTh",{name:"Ripple Labs Ops",type:"ripple"}],["rPEPPER7kfTD9w2To4CQk6UCfuHM9c6GDY",{name:"XAMAN (XUMM)",type:"wallet"}],["rBj4eVRWn6mCELVTNkVFDfGNByE9VFTM3R",{name:"XAMAN",type:"wallet"}],["rHb9CJAWyB4rj91VRWn96DkukG4bwdtyTh",{name:"XRPL AMM Engine",type:"dex"}],["rsoLo2S1kiGeCcn6hCUXVrCpGMWLrRrLZz",{name:"SOLO Issuer",type:"issuer"}],["rcoreNywaoz2ZCVt2sc3JiEi7G7MpZxZgm",{name:"CORE Token",type:"issuer"}],["rhXo4TcWbLY4GqTSmscMpgZ1KMXFBi9V55",{name:"XRPL DeFi Pool",type:"issuer"}],["rHb9CJAWyB4rj91VRWn96DkukG4bwdtyTh",{name:"UNL Validator Set",type:"validator"}]]);function zn(e){return rv.get(e)||null}var lv=null,ut=!1;var ws=null,hu=!1,Ui=!0;function eo(){return Ui&&X.currentPage==="dashboard"&&X.currentTab==="inspector"&&!document.hidden}async function cv(e){let t=[s=>`https://corsproxy.io/?${encodeURIComponent(s)}`,s=>`https://api.allorigins.win/raw?url=${encodeURIComponent(s)}`],n=async s=>{let a=typeof(AbortSignal==null?void 0:AbortSignal.timeout)=="function"?AbortSignal.timeout(6e3):void 0,o=await fetch(s,{mode:"cors",cache:"no-store",signal:a});if(!o.ok)throw new Error(`HTTP ${o.status}`);return await o.json()};try{return await n(e)}catch{for(let s of t)try{return await n(s(e))}catch{}throw new Error("Price feed unavailable")}}async function dv(){if(hu)return ws;hu=!0;try{let e=await cv("https://api.exchange.coinbase.com/products/XRP-USD/ticker");ws=Number((e==null?void 0:e.price)||0)||null}catch{ws=null}return ws}function wn(e){if(!ws||!e)return"";let t=e*ws;return t>=1e6?` (~$${(t/1e6).toFixed(2)}M)`:t>=1e3?` (~$${(t/1e3).toFixed(1)}K)`:` (~$${t.toFixed(2)})`}var Qs=null;function wu(){return Qs||(Qs={input:()=>document.getElementById("inspect-addr"),err:document.getElementById("inspect-err"),result:document.getElementById("inspect-result"),empty:document.getElementById("inspect-empty"),loading:document.getElementById("inspect-loading"),loadMsg:document.getElementById("inspect-loading-msg"),warn:document.getElementById("inspect-warn"),badge:document.getElementById("inspect-addr-badge"),score:document.getElementById("inspect-risk-score"),label:document.getElementById("inspect-risk-label")},Qs)}function pv(){Qs=null,wu()}function xu(){var n,s,a,o,i;zy(),Wy(),jy(),(n=w("inspect-addr"))==null||n.addEventListener("keydown",r=>{r.key==="Enter"&&xs()}),(s=w("inspect-addr"))==null||s.addEventListener("paste",()=>{setTimeout(()=>{var l;let r=(l=w("inspect-addr"))==null?void 0:l.value.trim();r&&He(r)&&xs()},60)});let e=r=>{let l=r==null?void 0:r.closest(".inspector-section");if(!l)return;let c=l.classList.toggle("collapsed");r.setAttribute("aria-expanded",String(!c))};(a=document.getElementById("tab-inspector"))==null||a.addEventListener("click",r=>{if(r.target.closest("button"))return;let l=r.target.closest(".section-header");l&&e(l)}),(o=document.getElementById("tab-inspector"))==null||o.addEventListener("keydown",r=>{var c,u;if(r.key!=="Enter"&&r.key!==" ")return;let l=(u=(c=r.target).closest)==null?void 0:u.call(c,".section-header");l&&(r.preventDefault(),e(l))}),(i=document.getElementById("inspector-nav"))==null||i.addEventListener("click",r=>{var u;let l=r.target.closest("[data-jump]");if(!l)return;let c=document.getElementById("section-"+l.dataset.jump);c&&(c.classList.remove("collapsed"),(u=c.querySelector(".section-header"))==null||u.setAttribute("aria-expanded","true"),c.scrollIntoView({behavior:"smooth",block:"start"})),Du(l.dataset.jump)});let t=!1;window.addEventListener("scroll",()=>{eo()&&(t||(t=!0,requestAnimationFrame(()=>{Uy(),t=!1})))},{passive:!0}),window.runInspect=xs,window.inspectorCopyAddr=Vy,window.showInspectorHowTo=Gy,window.hideInspectorHowTo=Ki,pv(),Qy(),window.addEventListener("naluxrp:tabchange",r=>{var l;((l=r.detail)==null?void 0:l.tabId)==="inspector"&&eo()&&(er(),tr(),na(),to())})}function ku(e){Ui=!!e,Ui||(ut=!0)}async function xs(){var a,o,i,r,l,c,u,p,d,m,f,g,v,h,b;if(!eo())return;let e=wu(),t=((a=e.input())==null?void 0:a.value.trim())||"";if([e.err,e.result,e.empty,e.warn].forEach(x=>x&&(x.style.display="none")),ut=!0,!t){e.empty&&(e.empty.style.display="");return}if(!He(t)){e.err&&(e.err.textContent=`\u26A0 Invalid address: ${y(t)}`,e.err.style.display="");return}if(X.connectionState!=="connected"){e.warn&&(e.warn.style.display="");return}lv=t,ut=!1;let n=x=>{e.loading&&(e.loading.style.display="",e.loadMsg&&(e.loadMsg.textContent=x))};n("Fetching account data\u2026");let s=x=>new Promise(k=>setTimeout(k,x));try{n("Fetching account data\u2026");let[x,k,T]=await Promise.all([Ee({command:"account_info",account:t,ledger_index:"validated"}),Ee({command:"account_offers",account:t,ledger_index:"validated"}),Ee({command:"account_nfts",account:t,ledger_index:"validated"}).catch(()=>null)]);if(ut)return;let S=((o=x==null?void 0:x.result)==null?void 0:o.account_data)||{},$=((i=k==null?void 0:k.result)==null?void 0:i.offers)||[],E=((r=T==null?void 0:T.result)==null?void 0:r.account_nfts)||[];n("Fetching trustlines\u2026");let C=[],P,R=0;do{R++;let G={command:"account_lines",account:t,ledger_index:"validated",limit:400};P&&(G.marker=P);let me=await Ee(G).catch(()=>null);if(ut)return;let be=((l=me==null?void 0:me.result)==null?void 0:l.lines)||[];C.push(...be),P=((c=me==null?void 0:me.result)==null?void 0:c.marker)||null,R>1&&await s(50)}while(P&&C.length<4e3);n("Fetching account objects\u2026");let O=[],D,I=0;do{I++;let G={command:"account_objects",account:t,ledger_index:"validated",limit:400};D&&(G.marker=D);let me=await Ee(G).catch(()=>null);if(ut)return;let be=((u=me==null?void 0:me.result)==null?void 0:u.account_objects)||[];O.push(...be),D=((p=me==null?void 0:me.result)==null?void 0:p.marker)||null,I>1&&await s(50)}while(D&&O.length<2e3);n("Fetching token supply, AMM data & price\u2026");let F=15,H=C.filter(G=>G.currency&&Number(G.balance)!==0&&G.currency.startsWith("03")&&G.currency.length===40),[N,,...W]=await Promise.all([Ee({command:"gateway_balances",account:t,ledger_index:"validated"}).catch(()=>null),dv(),...H.slice(0,F).map(G=>Ee({command:"amm_info",amm_account:G.account,ledger_index:"validated"}).catch(()=>null))]);if(ut)return;let se=(N==null?void 0:N.result)||null,re=new Map;H.slice(0,F).forEach((G,me)=>{var be,je;(je=(be=W[me])==null?void 0:be.result)!=null&&je.amm&&re.set(G.currency,W[me].result.amm)});let pe=400,ae=250,te=window._inspectMaxTx||5e3,de=Math.ceil(te/pe),le=[],Pe=new Set,B=G=>{var me,be;for(let je of G||[]){let ft=((me=je.tx_json)==null?void 0:me.hash)||((be=je.tx)==null?void 0:be.hash)||je.hash||null;ft&&Pe.has(ft)||(ft&&Pe.add(ft),le.push(je))}},q={newestToOldestComplete:!1,oldestToNewestFetched:!1,hitTxCap:!1,hitPageCap:!1,fetchErrorOccurred:!1},J,ue=0;for(let G=1;G<=de&&le.length<te;G++){if(ue=G,ut)return;n(`Fetching transactions \u2014 page ${G} (${le.length.toLocaleString()} so far)\u2026`);let me={command:"account_tx",account:t,limit:pe,ledger_index_min:-1,ledger_index_max:-1,forward:!1};J&&(me.marker=J);let be=await Ee(me).catch(()=>null);if(ut)return;if(be==null&&(q.fetchErrorOccurred=!0),B((d=be==null?void 0:be.result)==null?void 0:d.transactions),J=((m=be==null?void 0:be.result)==null?void 0:m.marker)||null,!J)break;G<de&&le.length<te&&await s(ae)}if(q.hitTxCap=le.length>=te,q.hitPageCap=!!J&&ue>=de,q.newestToOldestComplete=!J,le.length<te){if(ut)return;n("Fetching oldest transactions (anchoring history start)\u2026");let G=await Ee({command:"account_tx",account:t,limit:pe,ledger_index_min:-1,ledger_index_max:-1,forward:!0}).catch(()=>null);if(ut)return;G==null&&(q.fetchErrorOccurred=!0),B((f=G==null?void 0:G.result)==null?void 0:f.transactions),q.oldestToNewestFetched=G!=null&&!((g=G==null?void 0:G.result)!=null&&g.marker),await s(ae)}e.loading&&(e.loading.style.display="none");let ke=uv(le).sort((G,me)=>(G.tx.date??0)-(me.tx.date??0)),Me=946684800,We=null,De=null,Ie=q.newestToOldestComplete||q.oldestToNewestFetched;if(ke.length>0){let G=ke[0].tx;G!=null&&G.date&&(De=(G.date+Me)*1e3,We=Math.floor((Date.now()-De)/864e5))}let Y=new Map;for(let{tx:G}of ke){if(G.TransactionType!=="OfferCreate"||!G.TakerPays||!G.TakerGets)continue;let me=je=>typeof je=="string"?"XRP":`${je.currency}+${je.issuer||""}`,be=[me(G.TakerPays),me(G.TakerGets)].sort().join("\u2194");Y.set(be,(Y.get(be)||0)+1)}let Ce=null;if(Y.size>0){let G=[...Y.entries()].sort((sn,pa)=>pa[1]-sn[1])[0][0],[me,be]=G.split("\u2194"),je=sn=>sn==="XRP"?{currency:"XRP"}:{currency:sn.split("+")[0],issuer:sn.split("+")[1]},ft=await Ee({command:"book_offers",taker_pays:je(me),taker_gets:je(be),limit:20,ledger_index:"validated"}).catch(()=>null);(h=(v=ft==null?void 0:ft.result)==null?void 0:v.offers)!=null&&h.length&&(Ce={pair:G,offers:ft.result.offers})}let Je=[...new Set(ke.filter(({tx:G})=>G.TransactionType==="Payment"&&G.Account===t&&G.Destination).map(({tx:G})=>G.Destination))].slice(0,6),$e=new Map;for(let G of Je){if(ut)return;let me=await Ee({command:"account_info",account:G,ledger_index:"validated"}).catch(()=>null),be=(b=me==null?void 0:me.result)==null?void 0:b.account_data;be&&$e.set(G,{sequence:be.Sequence||0,balance:Number(be.Balance||0)/1e6}),await s(80)}bv(t,S,C,$,E,O,ke,{gatewayBalances:se,ammInfoMap:re,destAgeMap:$e,walletAgeDays:We,walletCreatedTs:De,walletAgeVerified:Ie,historyCoverage:q,liveOrderBook:Ce}),e.result&&(e.result.style.display="",nr());let Ct=e.score?Number(e.score.textContent):null;o0(t,isNaN(Ct)?null:Ct);let Wt=window._lastAllFindings||[];i0(t,isNaN(Ct)?null:Ct,Wt),f0(t,Wt),Ji(t)&&l0(t,isNaN(Ct)?null:Ct),p0()}catch(x){if(ut)return;e.loading&&(e.loading.style.display="none"),e.err&&(e.err.textContent=`Error: ${y(x.message)}`,e.err.style.display="")}}function uv(e){return e.map(t=>{let n=t.tx_json||t.tx||t.transaction||{},s=t.metadata||t.meta||{};return n.date==null&&t.date!=null&&(n.date=t.date),!n.hash&&t.hash&&(n.hash=t.hash),{tx:n,meta:s}})}function Zt(e){if(e==null)return null;if(typeof e=="string")return Number(e)/1e6;let t=Number(e.value);return Number.isFinite(t)?t:null}function qi(e){return typeof e=="string"?"XRP":(e==null?void 0:e.currency)||null}function $u(e){return typeof e=="string"&&e.length===40&&e.startsWith("03")}function Qi(e,t,n){var a,o,i,r,l,c,u,p,d,m,f,g;let s={xrpDelta:0,tokenDeltas:[],tokenDeltaMap:new Map,lpDeltas:[],lpDeltaMap:new Map};if(!((a=t==null?void 0:t.AffectedNodes)!=null&&a.length))return s;for(let v of t.AffectedNodes){let h=v.CreatedNode,b=v.ModifiedNode,x=v.DeletedNode,k=h||b||x;if(k){if(k.LedgerEntryType==="AccountRoot"){if((((o=k.FinalFields)==null?void 0:o.Account)||((i=k.NewFields)==null?void 0:i.Account))!==n)continue;let S=Number(((r=k.FinalFields||k.NewFields)==null?void 0:r.Balance)??0),$=h?0:Number(((l=k.PreviousFields)==null?void 0:l.Balance)??S),E=(S-$)/1e6;E&&(s.xrpDelta+=E);continue}if(k.LedgerEntryType==="RippleState"){let T=k.FinalFields||k.NewFields,S=(c=T==null?void 0:T.LowLimit)==null?void 0:c.issuer,$=(u=T==null?void 0:T.HighLimit)==null?void 0:u.issuer,E=S===n;if(!E&&!($===n))continue;let P=E?1:-1,R=E?$:S,O=(p=T==null?void 0:T.Balance)==null?void 0:p.currency,D=x?0:Number(((d=T==null?void 0:T.Balance)==null?void 0:d.value)??0),I=h?0:Number(((f=(m=k.PreviousFields)==null?void 0:m.Balance)==null?void 0:f.value)??(x?((g=T==null?void 0:T.Balance)==null?void 0:g.value)??0:D)),F=(D-I)*P;if(!F||!O)continue;let H=$u(O)?s.lpDeltaMap:s.tokenDeltaMap,N=`${O}.${R}`,W=H.get(N)||{currency:O,issuer:R,delta:0};W.delta+=F,H.set(N,W)}}}return s.tokenDeltas=[...s.tokenDeltaMap.values()],s.lpDeltas=[...s.lpDeltaMap.values()],delete s.tokenDeltaMap,delete s.lpDeltaMap,s}function Su(e,t){return e.map(({tx:n,meta:s})=>{let a=Qi(n,s,t);return{txHash:n.hash,date:n.date,type:n.TransactionType,result:(s==null?void 0:s.TransactionResult)||null,xrpDelta:a.xrpDelta,tokenDeltas:a.tokenDeltas,lpDeltas:a.lpDeltas}})}function Tu(e,t,n){let s=Su(e,t),a=n,o=new Array(s.length);for(let i=s.length-1;i>=0;i--){let r=a;a-=s[i].xrpDelta,o[i]={...s[i],balanceBefore:a,balanceAfter:r}}return o}var mv=[86400,3*86400],fv=.5,hv=10;function Cu(e,t,n,s={}){var u;let a=[],o=e.length,i=t.filter(({tx:p})=>["SetRegularKey","SignerListSet"].includes(p.TransactionType)).map(({tx:p})=>p.date).filter(p=>p!=null);for(let p of mv)for(let d=0;d<o;d++){let m=e[d];if(m.date==null||m.balanceBefore<=0)continue;let f=0,g=d,v=[];for(;g<o&&e[g].date!=null&&e[g].date-m.date<=p;)e[g].xrpDelta<0&&(f+=-e[g].xrpDelta,v.push(e[g])),g++;let h=m.balanceBefore>0?f/m.balanceBefore:0;h>=fv&&f>hv&&a.push({windowSec:p,startDate:m.date,endDate:((u=e[Math.min(g,o)-1])==null?void 0:u.date)??m.date,balanceAtStart:m.balanceBefore,totalOutflowXrp:f,pctOfBalanceMoved:h,startIdx:d,endIdx:Math.min(g,o)-1,triggeredByAuthChange:i.some(b=>b<=m.date&&m.date-b<=p)})}let r=300;a.sort((p,d)=>d.pctOfBalanceMoved-p.pctOfBalanceMoved);let l=[];for(let p of a)l.some(m=>m.windowSec===p.windowSec&&p.startDate<=m.endDate+r&&p.endDate>=m.startDate-r)||l.push(p);l.sort((p,d)=>p.startDate-d.startDate);let c=s.fetchErrorOccurred?"possibly-incomplete":"complete";return l.map(p=>({...p,dataCompleteness:c}))}function gv(e,t,n,s){let a=t.slice(e.startIdx,e.endIdx+1).filter(C=>C.xrpDelta<0),o=new Set(a.map(C=>C.txHash)),i=n.filter(({tx:C})=>o.has(C.hash)&&C.TransactionType==="Payment"),r=new Set(n.filter(({tx:C})=>C.TransactionType==="Payment"&&C.Account===s&&C.date<e.startDate).map(({tx:C})=>C.Destination).filter(Boolean)),l=[...new Set(i.map(({tx:C})=>C.Destination).filter(Boolean))],c=l.filter(C=>!r.has(C)),u=l.length?c.length/l.length:null,p=new Map;for(let{tx:C}of i){let P=typeof C.Amount=="string"?Number(C.Amount)/1e6:0;p.set(C.Destination,(p.get(C.Destination)||0)+P)}let d=[...p.entries()].sort((C,P)=>P[1]-C[1]),m=e.totalOutflowXrp>0&&d[0]?d[0][1]/e.totalOutflowXrp:null,f=d.map(([C,P])=>({addr:C,xrp:P,entity:zn(C)})),g=n.filter(({tx:C})=>C.TransactionType==="Payment"&&C.Account===s&&(C.date<e.startDate||C.date>e.endDate)&&typeof C.Amount=="string").map(({tx:C})=>Number(C.Amount)/1e6).filter(C=>C>0),v=C=>{let P=[...C].sort((R,O)=>R-O);return P.length?P[Math.floor(P.length/2)]:null},h=v(g),b=i.map(({tx:C})=>Number(C.Amount)/1e6).filter(C=>C>0),x=v(b),k=h&&x?x/h>=5:!1,T=new Map;for(let C of t.slice(e.startIdx,e.endIdx+1))for(let P of C.tokenDeltas){if(P.delta>=0)continue;let R=`${P.currency}.${P.issuer}`;T.set(R,(T.get(R)||0)+-P.delta)}let S=[...T.entries()].map(([C,P])=>({key:C,amount:P})),E=t.filter(C=>C.date!=null&&C.date<e.startDate&&e.startDate-C.date<=172800).some(C=>C.xrpDelta>0&&C.tokenDeltas.some(P=>P.delta<0));return{...e,newRecipientPct:u,newDestCount:c.length,episodeDestCount:l.length,topDestShare:m,destinations:f.slice(0,5),transferSizeAnomaly:k,historicalMedianXrp:h,episodeMedianXrp:x,trustlineLiquidations:S,dexConversionPrecedingWithdrawal:E}}function bv(e,t,n,s,a,o,i,r={}){let{gatewayBalances:l=null,ammInfoMap:c=new Map,destAgeMap:u=new Map,walletAgeDays:p=null,walletCreatedTs:d=null,walletAgeVerified:m=!1,historyCoverage:f=null,liveOrderBook:g=null}=r,v=Number(t.Balance||0)/1e6,h=Number(t.OwnerCount||0),b=10+h*2,x=Number(t.Flags||0),k=t.Sequence??"\u2014",T=o.filter(Y=>Y.LedgerEntryType==="SignerList"),S=o.filter(Y=>Y.LedgerEntryType==="Escrow"),$=o.filter(Y=>Y.LedgerEntryType==="PayChannel"),E=o.filter(Y=>Y.LedgerEntryType==="DepositPreauth"),C=o.filter(Y=>Y.LedgerEntryType==="Check"),P=kv(t,x,T,i,f),R=Au(t,x,T,i,$,S,e,v,f),O=Tv(a,i,e),D=ny(g,e),I=Eu(i,e,f||{}),F=Pv(I,e),H=Nv(i,e,n,I,F,D),N=Vv(t,n,x,i),W=Gv(n,i,o,c,e),se=Fv(i),re=qv(i,e),pe=Ov(i,e),ae=Bv(i,e),te=Xv(i),de=Hv(i,e),le=vv(i,e,u),Pe=Kv(i),B=Jv(i,e),q=Yv(i,e),J=yv(i,e,n,l),ue=Qv(i,e),ke=Zv(i,e),Me=ey(o,i,e),We=ty(o),De=ly(P,R,O,H,se,re,pe,ae,te,de,Pe);gy(e,t,v,b,h,k,De,p,d,m),by(P,t,x,T,E),vy(R,$,S,C),Cy(le,v,ue),yy(O,a),xy(H),cy(se),dy(re),py(pe),uy(ae),my(te),fy(de),hy(se,pe,ae,te,de),ky(N,n),Py(J,n),My(Pe),Ly(B),Ay(q),$y(W,n),Ey(ue),Ny(ke),Ry(Me),_y(We),Dy(D),Iy(De,P,R,O,H,se,re,pe,ae,te,de,Pe,ue,ke),Sy(n),Ty(i,e),vu(i),g0(i,e,le,ue),window._lastTxList=i,window._lastBalXrp=v,window._lastHistoryCoverage=f;let Ie=w("inspect-report-body");Ie&&(Hy(Ie,e,t,v,De,P,R,O,H,se,re,N,W,le,J,i,pe,ae,te,de,{feeAnalysis:Pe,destTagAnalysis:B,pathDepthAnalysis:q,gatewayBalances:l,inboundFlowAnalysis:ue,memoAnalysis:ke,escrowDepthAnalysis:Me,checkAnalysis:We,liveBookAnalysis:D,walletAgeDays:p,walletCreatedTs:d,walletAgeVerified:m,historyCoverage:f}),vu(i,"inspect-report-activity-chart"),m0(De,window._lastAllFindings||[],p,i.length,window._lastCategoryRisk||{},m,f),window._lastInspectResult={addr:e,riskScore:De,walletAgeDays:p,walletAgeVerified:m,historyCoverage:f,txCount:i.length,findings:window._lastAllFindings||[],timestamp:new Date().toISOString()},Bu(),Xu(e))}function vv(e,t,n=new Map){let s=new Map,a=[];for(let{tx:d,meta:m}of e){if(d.TransactionType!=="Payment"||d.Account!==t)continue;let f=d.Destination;if(!f)continue;let g=0,v=null,h=d.Amount;typeof h=="string"?g=Number(h)/1e6:h!=null&&h.value&&(v={value:Number(h.value),currency:Hn(h.currency),issuer:h.issuer});let b=Array.isArray(d.Paths)&&d.Paths.length>0,x=d.SendMax!=null,k=b||x,T=b?d.Paths.reduce((C,P)=>Math.max(C,(P||[]).length+1),1):k?2:1,S=jn(d),$={dest:f,amtXrp:g,amtToken:v,ts:S,isPathPay:k,hopCount:T,hash:d.hash||d.Hash||"",ledger:d.ledger_index||d.LedgerIndex||0,destTag:d.DestinationTag};a.push($),s.has(f)||s.set(f,{addr:f,totalXrp:0,txCount:0,firstSeen:S,lastSeen:S,entity:zn(f)||null,pathCount:0,maxHops:1,tokens:new Map});let E=s.get(f);if(E.totalXrp+=g,E.txCount++,E.lastSeen=Math.max(E.lastSeen,S),E.firstSeen=Math.min(E.firstSeen,S),k&&(E.pathCount++,E.maxHops=Math.max(E.maxHops,T)),v){let C=`${v.currency}.${z(v.issuer||"")}`;E.tokens.set(C,(E.tokens.get(C)||0)+v.value)}}let o=[...s.values()].sort((d,m)=>m.totalXrp-d.totalXrp||m.txCount-d.txCount).slice(0,10).map(d=>({...d,tokens:[...d.tokens.entries()].map(([m,f])=>({k:m,v:f}))})),i=o.reduce((d,m)=>d+m.totalXrp,0),r=a.filter(d=>d.isPathPay).length,l=o.filter(d=>{let m=n.get(d.addr);return m&&m.sequence<10&&d.totalXrp>10}),c=o.filter(d=>{var m;return((m=d.entity)==null?void 0:m.type)==="exchange"}),u=o.filter(d=>{var m;return((m=d.entity)==null?void 0:m.type)==="blackhole"});return{timeline:[...a].filter(d=>d.amtXrp>.01||d.amtToken).sort((d,m)=>d.ts-m.ts).slice(0,30),destinations:o,totalOut:i,totalPathPay:r,uniqueDests:s.size,exchangeDests:c,blackHoleDests:u,newWalletDests:l}}function yv(e,t,n,s=null){var E,C;let a=null;if(s!=null&&s.obligations){let P=Object.values(s.obligations);P.length===1?a=Number(P[0])||null:P.length>1&&(a=null)}let o=[],i=new Map,r=new Map,l=new Set,c=new Set(n.filter(P=>Number(P.balance)<0).map(P=>Hn(P.currency)));for(let{tx:P,meta:R}of e)if(P.Account===t&&P.TransactionType==="Payment"){((C=(E=R==null?void 0:R.AffectedNodes)==null?void 0:E.some)==null?void 0:C.call(E,I=>{var F,H,N;return((F=I.CreatedNode)==null?void 0:F.LedgerEntryType)==="AccountRoot"&&((N=(H=I.CreatedNode)==null?void 0:H.NewFields)==null?void 0:N.Account)===P.Destination}))&&P.Destination&&l.add(P.Destination);let D=P.Amount;if(typeof D=="object"&&(D!=null&&D.value)&&(D!=null&&D.currency)){let I=Hn(D.currency);if(c.has(I)){let F=Number(D.value),H=P.Destination;i.has(H)||(i.set(H,0),r.set(H,jn(P))),i.set(H,i.get(H)+F)}}}let u=[...i.entries()].sort((P,R)=>R[1]-P[1]),p=[];if(u.length>=3){let P=new Map;for(let[R,O]of u){if(O<=0)continue;let D=Math.pow(10,Math.floor(Math.log10(O))),F=(Math.round(O/D/.1)*.1*D).toPrecision(2);P.has(F)||P.set(F,[]),P.get(F).push({addr:R,amt:O})}for(let[,R]of P.entries())if(R.length>=3){let O=R.reduce((D,I)=>D+I.amt,0)/R.length;p.push({approxAmt:O,accounts:R}),o.push({sev:"warn",label:`${R.length} accounts each received ~${_(O,0)} tokens`,detail:"Highly similar token amounts suggest coordinated wallets, pre-arranged airdrop clusters, or sybil accounts."})}}let d=[...r.values()].sort();if(d.length>=5){let P=d[d.length-1]-d[0];P<3600&&d.length>=10&&o.push({sev:"warn",label:`${d.length} accounts funded within ${Math.ceil(P/60)} minutes`,detail:"Rapid token distribution to many wallets in a narrow time window. Matches pre-sale airdrop or coordinated distribution for wash trading."})}l.size>0&&o.push({sev:l.size>10?"warn":"info",label:`${l.size} account(s) created by this address`,detail:"This issuer funded the activation of these accounts. They may be controlled by the same entity."});let m=n.filter(P=>Number(P.balance)<0),f=a,g=m.reduce((P,R)=>P+Math.abs(Number(R.balance)),0),v=f??g,h=f==null&&m.length>0,b=h?` (based on ${m.length} visible trustlines \u2014 actual total supply may be higher if there are more holders)`:"",x=m.map(P=>({addr:P.account,balance:Math.abs(Number(P.balance)),currency:Hn(P.currency)})).sort((P,R)=>R.balance-P.balance).slice(0,10),k=new Set;for(let{tx:P}of e){if(P.TransactionType!=="Payment")continue;let R=P.Amount;typeof R!="object"||!(R!=null&&R.currency)||(P.Account===t&&P.Destination&&k.add(P.Destination),P.Destination===t&&P.Account&&k.add(P.Account))}x.forEach(P=>{P.activeWithIssuer=k.has(P.addr)});let T=x.filter(P=>P.activeWithIssuer).length;x.length>=3&&o.push(Se({module:"Issuer Connections",category:"issuer",sev:"info",confidence:.35,headline:`${T} of top ${x.length} holders have transacted directly with the issuer`,detail:`${x.length-T} show no direct payment activity with this issuer in the fetched history.`,observed:[`Direct-contact holders: ${T}/${x.length}`,"Measures direct issuer contact only \u2014 holders active via DEX trades or peer-to-peer transfers are not visible from this account's own history alone"],classification:"This distinguishes holders who have engaged with the issuer directly from those who haven't \u2014 it is not a general on-chain activity/dormancy check."}));let S=f??g,$=S>0&&(f!=null||m.length>=50);if(x.length>=2&&$){let P=x[0].balance/S*100,R=f!=null?"":" (of visible sample)";P>50?o.push({sev:"critical",label:`Top holder controls ${P.toFixed(0)}%${R} of supply`,detail:`${z(x[0].addr)} holds ${_(x[0].balance,0)} of ${_(S,0)} total${b}. `+(f!=null?"Extreme dump risk \u2014 one wallet could sell everything.":"Check gateway_balances or a block explorer to confirm the full supply picture.")}):P>25&&o.push({sev:"warn",label:`Top holder controls ${P.toFixed(0)}%${R} of supply`,detail:`Large single-holder concentration${b}. Monitor for coordinated sell events.`});let D=x.slice(0,5).reduce((I,F)=>I+F.balance,0)/S*100;D>75&&o.push({sev:"warn",label:`Top 5 holders own ${D.toFixed(0)}%${R} of supply`,detail:`Supply heavily concentrated in a few wallets${b}. This pattern is common in pre-launch setups or tokens with limited real distribution.`})}else m.length>0&&!$&&o.push({sev:"info",label:`${m.length} trustline holder(s) visible \u2014 supply data limited`,detail:`Only ${m.length} trustlines returned by account_lines. The true holder count and total supply cannot be determined from this data alone. Use a block explorer (XRPScan, Bithomp) for a complete holder distribution.`});return o.length===0&&v===0&&o.push({sev:"info",label:"No token issuance detected",detail:"This account does not appear to be an active token issuer."}),{signals:o,totalIssued:v,holderCount:m.length,topHolders:x,mirrorGroups:p,createdAccts:[...l],distributions:u.slice(0,10),isSampleOnly:h}}var wv=new Set(["rrrrrrrrrrrrrrrrrrrrrhoLvTp","rrrrrrrrrrrrrrrrrrrrBZbvji","rrrrrrrrrrrrrrrrrNAMEtxvNvQ","rHb9CJAWyB4rj91VRWn96DkukG4bwdtyTh","r9cZA1mLK5R5Am25ArfXFmqgNwjZgnfk59"]);function Pu(e){return!!e&&wv.has(e)}function Mu(e,t,n=[],s=[]){let a=!!(t&_e.lsfDisableMaster),o=(e==null?void 0:e.RegularKey)||"",i=Array.isArray(n)&&n.length>0,r=Pu(o);return!!(a&&r&&!i)}function Lu(e,t,n=[]){let s=!!(t&_e.lsfDefaultRipple),a=!!(t&_e.lsfRequireAuth),o=!!(t&_e.lsfGlobalFreeze),i=!!(t&_e.lsfNoFreeze),r=n.filter(({tx:c})=>c.TransactionType==="TrustSet").length,l=n.filter(({tx:c})=>{var u;return c.TransactionType==="Payment"&&typeof c.Amount=="object"&&((u=c.Amount)==null?void 0:u.currency)}).length;return s||a||o||i||r>=3||l>=5}var Be={NORMAL:"Normal",REGULAR_KEY:"Regular-Key Controlled",MULTISIG:"Multisig Controlled",BLACKHOLED:"Blackholed",RECOVERABLE:"Recoverable",MISCONFIGURED:"Potentially Misconfigured",UNKNOWN:"Unknown"},Wi=4;function xv(e,t,n,s,a={}){let o=!!(t&_e.lsfDisableMaster),i=!!e.RegularKey,r=n.length>0,l=Pu(e.RegularKey),c=s.filter(({tx:g})=>g.TransactionType==="AccountSet"&&g.Account===e.Account&&(g.SetFlag===Wi||g.ClearFlag===Wi)).map(({tx:g})=>({date:g.date,hash:g.hash,action:g.SetFlag===Wi?"disabled":"enabled"})).sort((g,v)=>(g.date??0)-(v.date??0)),u=c.some((g,v)=>g.action==="enabled"&&c.slice(0,v).some(h=>h.action==="disabled")),p=n.filter(g=>(g.SignerEntries||[]).reduce((b,x)=>{var k;return b+Number(((k=x.SignerEntry)==null?void 0:k.SignerWeight)||0)},0)<Number(g.SignerQuorum||1)),d,m,f;return p.length?(d=Be.MISCONFIGURED,m="blocked \u2014 quorum exceeds total signer weight, unreachable as configured",f=.9):r?(d=Be.MULTISIG,m="controlled by signer quorum",f=.85):o&&i&&l?(d=Be.BLACKHOLED,m="none \u2014 regular key points to a provably unusable address",f=.85):o&&!i?(d=Be.BLACKHOLED,m="none \u2014 no working key exists",f=.75):o&&i&&u?(d=Be.RECOVERABLE,m="proven historically \u2014 master key has been re-enabled from this state before",f=.7):o&&i?(d=Be.REGULAR_KEY,m="possible \u2014 whoever holds the regular key can re-enable the master key or act directly",f=.6):o?(d=Be.UNKNOWN,m="undetermined",f=.3):(d=Be.NORMAL,m="full \u2014 master key is active",f=.9),a!=null&&a.fetchErrorOccurred&&!(a!=null&&a.newestToOldestComplete)&&(f=Math.min(f,.5)),{state:d,reversibility:m,confidence:f,masterDisabled:o,hasRegularKey:i,hasSignerList:r,masterKeyHistory:c,wasEverReenabled:u,misconfiguredSignerListCount:p.length}}function kv(e,t,n,s,a={}){let o=[],i=100,r=!!(t&_e.lsfDisableMaster),l=!!e.RegularKey,c=n.length>0,u=Mu(e,t,n,s),p=Lu(e,t,s),d=xv(e,t,n,s,a);{let f={[Be.BLACKHOLED]:"info",[Be.MISCONFIGURED]:"critical",[Be.REGULAR_KEY]:"info",[Be.MULTISIG]:"info",[Be.RECOVERABLE]:"info",[Be.NORMAL]:"ok",[Be.UNKNOWN]:"warn"};o.push(Se({module:"Security",category:"security",sev:f[d.state]||"info",confidence:d.confidence,headline:`Account Control State: ${d.state}`,detail:`Reversibility: ${d.reversibility}`,observed:[`Master key: ${d.masterDisabled?"disabled":"active"}`,`Regular key: ${d.hasRegularKey?e.RegularKey:"not set"}`,`Signer list: ${d.hasSignerList?`${n.length} list(s)`:"none"}`,d.wasEverReenabled?"Master key has been re-enabled from a disabled state at least once in fetched history":null].filter(Boolean),classification:d.state===Be.MISCONFIGURED?"Signer quorum cannot be reached with the current signer weights as configured \u2014 this account may be functionally stuck regardless of anyone's intent.":d.state===Be.REGULAR_KEY?"A disabled master key with an active regular key is not the same as a locked/irreversible account \u2014 the regular key holder retains full control, including the ability to re-enable the master key.":null})),d.state===Be.BLACKHOLED&&(i-=40),d.state===Be.MISCONFIGURED&&(i-=30),u&&p&&o.push({sev:"warn",label:"Blackholed issuer caution",detail:"This account appears issuer-like and intentionally blackholed. Sending issued tokens back here may make them unrecoverable or effectively burn them."})}if(l){let f=s.find(({tx:v})=>v.TransactionType==="SetRegularKey"),g=f&&Date.now()/1e3-jn(f.tx)<86400*30;u?o.push({sev:"info",label:"Regular key points to blackhole address",detail:e.RegularKey}):g?(o.push({sev:"warn",label:"Regular key set recently",detail:`Key: ${e.RegularKey} \u2014 changed within 30 days. Verify you intended this.`}),i-=15):o.push({sev:"info",label:"Regular key active",detail:e.RegularKey})}n.forEach(f=>{let g=f.SignerEntries||[],v=f.SignerQuorum||1;o.push({sev:"info",label:`Multisig: ${g.length} signers, quorum ${v}`,detail:g.map(h=>{var b;return z(((b=h.SignerEntry)==null?void 0:b.Account)||"")}).join(", ")})}),t&_e.lsfGlobalFreeze&&(o.push({sev:"warn",label:"Global Freeze active",detail:"This issuer has frozen all token balances."}),i-=10),t&_e.lsfDepositAuth&&o.push({sev:"ok",label:"Deposit Authorization enabled",detail:"Only pre-authorized senders can deposit."}),t&_e.lsfDefaultRipple&&o.push({sev:"info",label:"Default Ripple enabled",detail:"Balances can ripple through this account (issuer behaviour)."});let m=s.filter(({tx:f})=>f.TransactionType==="AccountDelete");return m.length&&(o.push({sev:"warn",label:`${m.length} AccountDelete attempt(s)`,detail:"Account deletion was attempted."}),i-=5),t&_e.lsfRequireAuth&&o.push({sev:"info",label:"Require Auth enabled",detail:"This account must individually approve each trustline before it can hold a balance \u2014 restricts who can hold what it issues."}),t&_e.lsfNoFreeze&&o.push({sev:"info",label:"No Freeze enabled",detail:"This account has permanently given up the ability to freeze trustlines \u2014 an irreversible choice, typically made to reassure holders."}),t&_e.lsfRequireDestTag&&o.push({sev:"info",label:"Require Destination Tag enabled",detail:"Payments to this account must include a destination tag \u2014 common for exchange/custodial deposit accounts."}),t&_e.lsfDisallowXRP&&o.push({sev:"info",label:"Disallow XRP flag set",detail:"A client-side hint requesting senders avoid sending XRP to this account. Not enforced by the protocol \u2014 XRP can still be sent."}),t&_e.lsfPasswordSpent&&o.push({sev:"info",label:"Password Spent flag set",detail:"This account has already used its one free SetRegularKey transaction; further regular-key changes will cost the standard transaction fee."}),o.length===0&&o.push({sev:"ok",label:"No security issues detected",detail:"Master key active, no regular key or signer list overrides, no risky flags set."}),{findings:o,score:Math.max(0,i),controlState:d}}function $v(e,t,n,s,a,o){let i=[],r="low",l=!!(t&_e.lsfDisableMaster),c=Mu(e,t,n,s),u=Lu(e,t,s);c?(i.push({sev:"info",label:"Intentional blackhole detected",detail:`Master key is disabled and regular key ${e.RegularKey} is a known blackhole address. This is typical for a permanently locked issuer/account, not a classic drain setup.`}),u&&i.push({sev:"warn",label:"Caution: sending assets back may burn them",detail:"Because this account appears to be an intentionally blackholed issuer, sending issued tokens back to it may strand or effectively burn those tokens."})):l&&e.RegularKey&&(i.push({sev:"critical",label:"Classic drain setup detected",detail:`Master key disabled. Regular key ${e.RegularKey} controls the account. If this key was set by an attacker, funds are at risk.`}),r="critical");let p=s.filter(({tx:m})=>m.TransactionType==="SetRegularKey"&&m.Account!==e.Account);if(!c&&p.length&&(i.push({sev:"critical",label:"Regular key set by external account",detail:`${p.length} key change(s) where sender \u2260 account owner. This is unusual.`}),r="critical"),a.length){let m=a.reduce((f,g)=>f+Number(g.Amount||0)/1e6,0);i.push({sev:"warn",label:`${a.length} open payment channel(s) \u2014 ${_(m,2)} XRP locked`,detail:`Destination(s): ${a.map(f=>z(f.Destination)).join(", ")}`}),r==="low"&&(r="medium")}if(o.length){let m=o.reduce((f,g)=>f+Number(g.Amount||0)/1e6,0);i.push({sev:"info",label:`${o.length} open escrow(s) \u2014 ${_(m,2)} XRP escrowed`,detail:`Escrow(s): ${o.map(f=>f.Destination?z(f.Destination):"self-escrow").join(", ")}`})}let d=s.filter(({tx:m})=>m.TransactionType==="DepositPreauth"&&m.Authorize);return d.length>5&&(i.push({sev:"warn",label:`${d.length} DepositPreauth grants issued`,detail:"Account pre-authorized many senders. Review if all are trusted."}),r==="low"&&(r="medium")),i.length===0&&i.push({sev:"ok",label:"No compromise-risk patterns detected",detail:"Auth structure looks intact."}),{signals:i,riskLevel:r}}function Sv(e,t,n,s={}){let a=Tu(e,t,n),i=Cu(a,e,t,s).map(c=>gv(c,a,e,t)),r=[],l="none";for(let c of i){let u=c.windowSec===86400?"24h":`${Math.round(c.windowSec/86400)}d`,p=[`${_(c.totalOutflowXrp,2)} XRP moved out (${(c.pctOfBalanceMoved*100).toFixed(0)}% of the ${_(c.balanceAtStart,2)} XRP balance at window start) within ${u}`,c.newRecipientPct!=null?`${(c.newRecipientPct*100).toFixed(0)}% of destinations (${c.newDestCount}/${c.episodeDestCount}) were first-time recipients`:null,c.topDestShare!=null?`${(c.topDestShare*100).toFixed(0)}% of the outflow went to a single destination`:null,c.transferSizeAnomaly?`Transfer sizes in this window are ${(c.episodeMedianXrp/c.historicalMedianXrp).toFixed(1)}x this account's own historical median`:null,c.trustlineLiquidations.length?`${c.trustlineLiquidations.length} token position(s) liquidated shortly before/during this window`:null,c.dexConversionPrecedingWithdrawal?"A token\u2192XRP conversion occurred in the 48h before this outflow began":null,c.triggeredByAuthChange?"A regular-key or signer-list change occurred immediately before this window":null].filter(Boolean),d=[];c.newRecipientPct!=null&&c.newRecipientPct>.7&&d.push("Nearly all destinations are first-time recipients, not established counterparties"),c.triggeredByAuthChange&&d.push("Outflow immediately follows an authorization change \u2014 the classic compromise-then-drain sequence"),c.dexConversionPrecedingWithdrawal&&c.trustlineLiquidations.length&&d.push("Assets were converted to XRP shortly before leaving, consistent with liquidating a position specifically to withdraw everything");let m=c.destinations.some(g=>g.entity),f=c.triggeredByAuthChange||c.pctOfBalanceMoved>=.9?"critical":"warn";f==="critical"?l="critical":l!=="critical"&&(l=l==="none"||l==="low"?"high":l),r.push(Se({module:"Asset Drain Behavior",category:"security",sev:f,confidence:c.triggeredByAuthChange?.75:.5,headline:`${_(c.totalOutflowXrp,2)} XRP (${(c.pctOfBalanceMoved*100).toFixed(0)}% of balance) moved out within ${u}`,detail:"Sliding-window balance reconstruction flagged this as an unusually large, fast depletion.",observed:p,alternativeExplanations:["A planned, deliberate transfer by the account's own owner (exchange withdrawal, consolidation, moving to a new wallet)",m?"Destination is a known exchange or labeled entity, consistent with a routine cash-out":"Destination(s) not in the known-entity registry \u2014 inconclusive either way"],evidenceAgainstBenign:d,classification:c.triggeredByAuthChange?"Outflow following an authorization change is a strong compromise-and-drain signal, but ledger data alone cannot distinguish an attacker from an owner who changed their own key and then withdrew funds themselves.":"Large, fast depletion observed. This describes behavior, not intent \u2014 see Account Compromise Risk above for whether the account's access controls show separate signs of being compromised."}))}return r.length||r.push(Se({module:"Asset Drain Behavior",category:"security",sev:"ok",headline:"No abnormal depletion detected",detail:"No window scanned showed a large, fast balance drop relative to this account's own history."})),{episodes:i,findings:r,severity:l}}var gu={low:0,medium:1,high:2,critical:3,none:-1};function Au(e,t,n,s,a,o,i,r,l){let c=$v(e,t,n,s,a,o),u=Sv(s,i,r,l),p=u.severity==="none"?"low":u.severity==="high"?"critical":u.severity,d=gu[p]>gu[c.riskLevel]?p:c.riskLevel;return{signals:[...c.signals,...u.findings],riskLevel:d,compromiseRiskLevel:c.riskLevel,assetDrainSeverity:u.severity,episodes:u.episodes}}function Tv(e,t,n){let s=[],a=new Map(e.map(m=>[m.NFTokenID,m])),i=t.filter(({tx:m})=>m.TransactionType==="NFTokenCreateOffer"&&m.Account===n).filter(({tx:m})=>{let f=m.Amount;return f?typeof f=="string"?Number(f)<1e6:!1:!0});i.length&&s.push({sev:"critical",label:`${i.length} NFT offer(s) created for \u22641 XRP`,detail:"You created sell offers at near-zero price. This is a common NFT drain vector \u2014 attackers trick victims into listing their NFTs for free."});let r=t.filter(({tx:m})=>m.TransactionType==="NFTokenAcceptOffer"&&m.Account===n);r.length&&s.push({sev:"warn",label:`${r.length} NFT offer(s) accepted`,detail:"Review these transactions to confirm they were intentional sales/purchases."});let l=t.filter(({tx:m})=>m.TransactionType==="NFTokenBurn"&&m.Account===n);l.length&&s.push({sev:"warn",label:`${l.length} NFT(s) burned`,detail:"Burned NFTs cannot be recovered. Confirm these were intentional."});let c=t.filter(({tx:m})=>m.TransactionType==="NFTokenMint"&&m.Account===n),u=t.filter(({tx:m})=>m.TransactionType==="NFTokenCreateOffer"||m.TransactionType==="NFTokenAcceptOffer");c.length>0&&u.length>0&&s.push({sev:"info",label:`${c.length} NFT(s) minted \xB7 ${u.length} transfer event(s)`,detail:"This account has minting activity."});let p=e.filter(m=>m.TransferFee&&m.TransferFee>0);if(p.length){let m=p.reduce((f,g)=>f+g.TransferFee,0)/p.length;s.push({sev:"info",label:`${p.length} NFT(s) carry transfer fees (avg ${(m/1e3).toFixed(1)}%)`,detail:"These NFTs pay royalties on each transfer."})}let d=e.filter(m=>!m.URI);return d.length>2&&s.push({sev:"warn",label:`${d.length} NFT(s) have no URI / metadata`,detail:"NFTs without a URI may be spam or placeholder tokens used in scams."}),s.length===0&&e.length===0?s.push({sev:"ok",label:"No NFT activity detected",detail:"This account holds no NFTs."}):s.length===0&&s.push({sev:"ok",label:`${e.length} NFT(s) held \u2014 no risk signals`,detail:"NFT posture looks normal."}),{flags:s,nftCount:e.length,mintCount:c.length}}var Za={tfPassive:65536,tfImmediateOrCancel:131072,tfFillOrKill:262144,tfSell:524288};function Cv(e,t){var n;for(let s of(e==null?void 0:e.AffectedNodes)||[]){let a=s.CreatedNode;if((a==null?void 0:a.LedgerEntryType)==="Offer"&&((n=a.NewFields)==null?void 0:n.Account)===t)return a}return null}function Eu(e,t,n={}){var r,l,c,u,p,d,m;let s=new Map,a=[],o=n.newestToOldestComplete||n.oldestToNewestFetched?"complete":"possibly-truncated";e.forEach((f,g)=>{var P,R,O,D,I;let{tx:v,meta:h}=f;if(v.TransactionType!=="OfferCreate"||v.Account!==t||(h==null?void 0:h.TransactionResult)!=="tesSUCCESS")return;let b={currency:qi(v.TakerGets),issuer:typeof v.TakerGets=="object"?v.TakerGets.issuer:null,value:Zt(v.TakerGets)},x={currency:qi(v.TakerPays),issuer:typeof v.TakerPays=="object"?v.TakerPays.issuer:null,value:Zt(v.TakerPays)},k=Cv(h,t),T=k?{gets:Zt((P=k.NewFields)==null?void 0:P.TakerGets),pays:Zt((R=k.NewFields)==null?void 0:R.TakerPays)}:null,S={gets:Math.max(0,(b.value??0)-((T==null?void 0:T.gets)??0)),pays:Math.max(0,(x.value??0)-((T==null?void 0:T.pays)??0))},$=[];for(let F of h.AffectedNodes||[]){let H=F.DeletedNode||F.ModifiedNode;if(!H||H.LedgerEntryType!=="Offer")continue;let N=(O=H.FinalFields)==null?void 0:O.Account;!N||N===t||$.push({account:N,gets:Zt((D=H.FinalFields)==null?void 0:D.TakerGets),pays:Zt((I=H.FinalFields)==null?void 0:I.TakerPays)})}let E=Number(v.Flags||0),C={offerId:`${t}:${v.Sequence}`,createHash:v.hash,createDate:v.date,createLedgerIndex:(k==null?void 0:k.LedgerIndex)||null,takerGetsOriginal:b,takerPaysOriginal:x,offerSequence:v.Sequence,replacesOfferSeq:v.OfferSequence||null,flags:{passive:!!(E&Za.tfPassive),immediateOrCancel:!!(E&Za.tfImmediateOrCancel),fillOrKill:!!(E&Za.tfFillOrKill),sell:!!(E&Za.tfSell)},expiration:v.Expiration||null,crossedAtCreation:S,counterpartiesAtCreation:$,restingAmount:T,status:k?"resting":"filled-immediately",consumedEvents:[],cancelHash:null,cancelDate:null,timeRestingSeconds:null,realizedFillPct:null,expiryUncertain:!1,dataCompleteness:o,_createIdx:g};s.set(C.offerId,C),a.push(C)});for(let f of a){if(!f.createLedgerIndex)continue;for(let h=f._createIdx+1;h<e.length;h++){let{tx:b,meta:x}=e[h];if((x==null?void 0:x.TransactionResult)!=="tesSUCCESS"&&(x==null?void 0:x.TransactionResult)!=="tecKILLED"&&!((r=x==null?void 0:x.AffectedNodes)!=null&&r.length))continue;let k=null;for(let T of(x==null?void 0:x.AffectedNodes)||[]){let S=T.CreatedNode,$=T.ModifiedNode,E=T.DeletedNode,C=S||$||E;if(!(!C||C.LedgerEntryType!=="Offer")&&C.LedgerIndex===f.createLedgerIndex){k={node:C,kind:E?"deleted":$?"modified":"created"};break}}if(k){if(k.kind==="deleted"){let T=b.Account===t&&b.TransactionType==="OfferCancel"&&b.OfferSequence===f.offerSequence,S=b.Account===t&&b.TransactionType==="OfferCreate"&&b.OfferSequence===f.offerSequence;if(T||S)f.status="cancelled",f.cancelHash=b.hash,f.cancelDate=b.date;else{let $=Qi(b,x,t);$.xrpDelta!==0||$.tokenDeltas.some(C=>C.delta!==0)?(f.status="consumed-later",f.consumedEvents.push({hash:b.hash,date:b.date,counterpartyAccount:b.Account!==t?b.Account:null})):(f.status="expired",f.expiryUncertain=!0)}f.timeRestingSeconds=(b.date??f.createDate)-f.createDate,f.dataCompleteness=f.dataCompleteness;break}if(k.kind==="modified"){let T=Zt((l=k.node.FinalFields)==null?void 0:l.TakerGets),S=Zt((c=k.node.FinalFields)==null?void 0:c.TakerPays);f.consumedEvents.push({hash:b.hash,date:b.date,counterpartyAccount:b.Account!==t?b.Account:null,gets:Math.max(0,(((u=f.restingAmount)==null?void 0:u.gets)??0)-(T??0)),pays:Math.max(0,(((p=f.restingAmount)==null?void 0:p.pays)??0)-(S??0))}),f.restingAmount={gets:T,pays:S},f.status="partially-filled-then-resting"}}}if(f.status==="resting"||f.status==="partially-filled-then-resting"){let h=Math.floor(Date.now()/1e3)-yu,b=((m=(d=e[e.length-1])==null?void 0:d.tx)==null?void 0:m.date)??h;f.expiration!=null&&f.expiration<=b?(f.status="expired",f.expiryUncertain=!0):f.status="unknown-open",f.timeRestingSeconds=b-f.createDate,f.dataCompleteness}let g=f.consumedEvents.reduce((h,b)=>h+(b.gets||0),0),v=f.crossedAtCreation.gets+g;f.realizedFillPct=f.takerGetsOriginal.value?Math.min(100,v/f.takerGetsOriginal.value*100):null,delete f._createIdx}let i={total:a.length,filledImmediately:a.filter(f=>f.status==="filled-immediately").length,cancelled:a.filter(f=>f.status==="cancelled").length,consumedLater:a.filter(f=>f.status==="consumed-later").length,partiallyFilled:a.filter(f=>f.status==="partially-filled-then-resting").length,expired:a.filter(f=>f.status==="expired").length,unknownOpen:a.filter(f=>f.status==="unknown-open").length};return{byOfferId:s,list:a,stats:i}}function Pv(e,t){let n=e.list,s=n.length,a=n.filter(b=>b.status==="filled-immediately").length,o=n.filter(b=>b.status==="resting"||b.status==="partially-filled-then-resting"||b.status==="unknown-open").length,i=n.filter(b=>b.status==="consumed-later").length,r=n.filter(b=>b.status==="cancelled").length,l=n.filter(b=>b.status==="expired").length,c=n.filter(b=>b.status==="unknown-open").length,u=n.map(b=>b.timeRestingSeconds).filter(b=>b!=null),p=u.length?u.reduce((b,x)=>b+x,0)/u.length:null,d=[...u].sort((b,x)=>b-x),m=d.length?d[Math.floor(d.length/2)]:null,f=n.map(b=>b.realizedFillPct).filter(b=>b!=null),g=f.length?f.reduce((b,x)=>b+x,0)/f.length:null,v=new Map;for(let b of n){let x=[b.takerGetsOriginal.currency||"?",b.takerPaysOriginal.currency||"?"].sort().join("\u2194"),k=v.get(x)||{created:0,filled:0,cancelled:0,fillPctSum:0,fillPctCount:0};k.created++,(b.status==="filled-immediately"||b.status==="consumed-later")&&k.filled++,b.status==="cancelled"&&k.cancelled++,b.realizedFillPct!=null&&(k.fillPctSum+=b.realizedFillPct,k.fillPctCount++),v.set(x,k)}for(let b of v.values())b.avgFillPct=b.fillPctCount?b.fillPctSum/b.fillPctCount:null;let h=[];if(s>=10){let b=r/s;g!=null&&g<5&&b>.5?h.push(Se({module:"Offer Fill Rate",category:"liquidity",sev:"warn",confidence:.6,headline:`Low realized fill rate: ${g.toFixed(1)}% across ${s} offers`,detail:`${r} of ${s} offers were cancelled, most with minimal execution before cancellation.`,observed:[`${r} cancelled (${(b*100).toFixed(0)}%)`,`${i} consumed by a counterparty after resting`,`${l} expired/removed unfunded`,`${c} still open as of the last analyzed transaction`,`Average time resting before resolution: ${p!=null?p.toFixed(0)+"s":"unknown"}`],alternativeExplanations:["Active order management \u2014 repricing as the market moves","Automated market-making that requeues orders frequently"],evidenceAgainstBenign:g<1?["Realized fill percentage is near zero, not just below average"]:[],classification:"A low fill rate is observed. On its own this does not establish intent \u2014 see the Spoofing and Market-Maker Automation scores for further context."})):h.push(Se({module:"Offer Fill Rate",category:"liquidity",sev:"ok",confidence:.7,headline:`${g!=null?g.toFixed(1)+"%":"Normal"} realized fill rate across ${s} offers`,detail:`${a} filled immediately, ${i} consumed after resting, ${r} cancelled, ${l} expired.`}))}else h.push(Se({module:"Offer Fill Rate",category:"liquidity",sev:"info",headline:`Only ${s} offer(s) placed \u2014 insufficient sample for fill-rate analysis`,detail:"Need at least 10 OfferCreate transactions for a meaningful fill-rate read."}));return{createdCount:s,immediateFillCount:a,restingCount:o,laterConsumedCount:i,cancelledCount:r,expiredCount:l,unknownOpenCount:c,avgTimeRestingSeconds:p,medianTimeRestingSeconds:m,realizedFillPctOverall:g,byPair:v,findings:h}}function Mv(e,t,n){let s=e.list,a=s.map(h=>h.createDate).filter(h=>h!=null).sort((h,b)=>h-b),o=h=>{if(!a.length)return 0;let b=1;for(let x=0;x<a.length;x++){let k=1;for(let T=x+1;T<a.length&&a[T]-a[x]<=h;T++)k++;b=Math.max(b,k)}return b},i={thirtySec:o(30),oneHour:o(3600)},r=s.map(h=>h.takerGetsOriginal.value).filter(h=>h!=null&&h>0),l=null;if(r.length>=Yi){let h=r.reduce((x,k)=>x+k,0)/r.length,b=Math.sqrt(r.reduce((x,k)=>x+(k-h)**2,0)/r.length);l=h>0?b/h:null}let c=[100,1e3,1e4,1e5],u=r.filter(h=>c.some(b=>Math.abs(h%b)<1e-6&&h/b>=1)).length,p=r.length?u/r.length:0,d=new Map;s.forEach(h=>{let b=[h.takerGetsOriginal.currency||"?",h.takerPaysOriginal.currency||"?"].sort().join("\u2194");d.set(b,(d.get(b)||0)+1)});let m=[...d.entries()].sort((h,b)=>b[1]-h[1])[0]||null,f=m&&s.length?m[1]/s.length:0,g=s.length?s.filter(h=>h.status==="cancelled").length/s.length:0,v=s.map(h=>h.timeRestingSeconds).filter(h=>h!=null);return{burstWindows:i,sizeCV:l,roundNumberPct:p,pairConcentration:f,dominantPair:m,cancelRatio:g,restingTimes:v,createdCount:s.length}}function Lv(e,t,n,s){let a=[],o=0,i=n.filter(({tx:p})=>p.TransactionType==="Payment"),r=new Set(i.filter(({tx:p})=>p.Account===s&&p.Destination).map(({tx:p})=>p.Destination)),l=new Set(i.filter(({tx:p})=>p.Destination===s&&p.Account).map(({tx:p})=>p.Account)),c=[...r].filter(p=>l.has(p));if(c.length>0&&i.length>=Yi){let p=c.length/r.size;if(p>iv){let d=new Set;for(let f of t.list){for(let g of f.counterpartiesAtCreation)d.add(g.account);for(let g of f.consumedEvents)g.counterpartyAccount&&d.add(g.counterpartyAccount)}let m=c.filter(f=>d.has(f));a.push(Se({module:"Wash Execution",category:"market-integrity",sev:"warn",confidence:m.length?.55:.4,headline:`${c.length} round-trip payment counterpart(s) detected`,detail:`${(p*100).toFixed(1)}% of payment recipients also sent back to this account.`,observed:[`${c.length} of ${r.size} outbound recipients also sent payments back`,m.length?`${m.length} of those also traded directly on the DEX with this account`:"No overlap found with DEX trading counterparties"],alternativeExplanations:["Ordinary reciprocal business/personal payments","Exchange deposit/withdrawal cycling through the same account"],evidenceAgainstBenign:m.length?["Payment round-trip AND direct DEX trading with the same counterparty(ies)"]:[],classification:"Round-trip payment pattern observed. Cannot confirm circular multi-account flow (A\u2192B\u2192C\u2192A) from this account's history alone \u2014 that would require the counterparties' own transaction histories."})),o+=m.length?25:15}}let u=i.filter(({tx:p})=>p.Account===s&&p.Destination===s);return u.length>0&&(a.push(Se({module:"Wash Execution",category:"market-integrity",sev:"critical",confidence:.85,headline:`${u.length} self-payment(s): sender = receiver`,detail:"Payments where origin and destination are the same address.",observed:[`${u.length} Payment transaction(s) with Account === Destination`],alternativeExplanations:["A no-op transaction used to mark an account active, or to test a memo/path"],evidenceAgainstBenign:u.length>2?["Repeated, not a single isolated instance"]:[],classification:"Confirmed self-payment. Creates recorded volume with zero net economic transfer \u2014 this is a fact about the transaction, not an inference."})),o+=30),a.length||a.push(Se({module:"Wash Execution",category:"market-integrity",sev:"ok",headline:"No wash-execution signals",detail:`${t.list.length} offers, ${u.length} self-payments \u2014 patterns look normal.`})),{score:Math.min(100,o),findings:a,stats:{roundTrip:c.length,selfTrades:u.length}}}function Av(e,t,n,s,a){var p;let o=[],i=0,r=t.list,l=t.byOfferId,c=0,u=0;for(let d of r){if(!d.replacesOfferSeq)continue;let m=l.get(`${s}:${d.replacesOfferSeq}`);if(!m)continue;c++;let f=m.takerPaysOriginal.value&&m.takerGetsOriginal.value?m.takerPaysOriginal.value/m.takerGetsOriginal.value:null,g=d.takerPaysOriginal.value&&d.takerGetsOriginal.value?d.takerPaysOriginal.value/d.takerGetsOriginal.value:null;f&&g&&Math.abs(g-f)/f<.02&&u++}if(c>=5&&u/c>.6&&(o.push(Se({module:"Spoofing",category:"market-integrity",sev:"warn",confidence:.45,headline:`${u} of ${c} order replacements kept nearly the same price`,detail:"Cancel-and-immediately-recreate at a near-identical price, repeated \u2014 a quote-management pattern worth a closer look.",observed:[`${c} create-and-replace chains found`,`${u} replaced within 2% of the prior price`],alternativeExplanations:["Routine order refresh/repricing by an active trader or market maker","Bumping sequence to avoid an unrelated conflict"],classification:"Replacement pattern observed. On its own this is common in both legitimate quote maintenance and layering \u2014 see Market-Maker Automation for the explanatory read."})),i+=15),r.length>=10){let d=r.filter(m=>m.takerGetsOriginal.currency==="XRP"&&m.takerGetsOriginal.value!=null);if(d.length>=10){let m=d.map(b=>b.takerGetsOriginal.value).sort((b,x)=>x-b),f=m[Math.floor(m.length*.05)]||0,g=d.filter(b=>b.takerGetsOriginal.value>=f),v=g.filter(b=>b.status==="cancelled"||b.status==="expired"),h=g.length>=5?v.length/g.length:0;h>=.95&&(o.push(Se({module:"Spoofing",category:"market-integrity",sev:"warn",confidence:.3,headline:`${(h*100).toFixed(0)}% of this wallet's largest orders were cancelled without meaningful fill (own-history proxy)`,detail:`${v.length} of ${g.length} top-5%-by-this-wallet's-own-size orders cancelled or expired.`,observed:["Sizing is relative to this wallet's own order history, not current book depth",`${v.length}/${g.length} cancelled or expired without fill`],alternativeExplanations:["A large order sized appropriately for a genuinely deep, liquid market","Cancelled for unrelated reasons (funding change, strategy shift)"],classification:"Own-history size proxy only \u2014 true book-depth-relative sizing and price-distance-from-executable checks need historical order-book state this app cannot reliably obtain from public XRPL nodes. Treat as a weaker signal than a book-relative measurement would be."})),i+=10)}}if((p=a==null?void 0:a.signals)!=null&&p.length)for(let d of a.signals)(d.sev==="critical"||d.sev==="warn")&&(o.push(d),i+=d.sev==="critical"?20:10);return o.length||o.push(Se({module:"Spoofing",category:"market-integrity",sev:"ok",headline:"No spoofing signals",detail:"No large-order cancel pattern, replacement pattern, or live book wall detected."})),{score:Math.min(100,i),findings:o}}function Ev(e,t,n,s,a){let o=[],i=!1,r=e.cancelRatio>ov,l=e.sizeCV!=null&&e.sizeCV<.2,c=e.burstWindows.thirtySec>=8||e.burstWindows.oneHour>100,u=(a==null?void 0:a.realizedFillPctOverall)!=null&&a.realizedFillPctOverall>=5;return e.createdCount>=Yi&&r&&(l||c)?(i=!0,o.push(Se({module:"Market-Maker Automation",category:"automation",sev:"info",confidence:u?.6:.4,headline:"Behavior consistent with automated market-making / quote maintenance",detail:`${(e.cancelRatio*100).toFixed(0)}% cancel ratio, ${e.sizeCV!=null?"CV "+e.sizeCV.toFixed(2):"no size-uniformity read"}, max ${e.burstWindows.thirtySec} offers/30s.`,observed:[`Cancel ratio: ${(e.cancelRatio*100).toFixed(0)}%`,e.sizeCV!=null?`Order-size coefficient of variation: ${e.sizeCV.toFixed(2)}`:null,`Burst: up to ${e.burstWindows.thirtySec} offers in 30s, ${e.burstWindows.oneHour} in 1h`,u?`Realized fill rate: ${a.realizedFillPctOverall.toFixed(1)}% \u2014 not zero, consistent with a working market-making strategy`:"Realized fill rate is low or unknown"].filter(Boolean),alternativeExplanations:["Spoofing/layering dressed up with uniform sizing to look automated"],evidenceAgainstBenign:u?[]:["Fill rate is low despite the high order volume \u2014 automation alone does not explain that combination"],classification:u?"High cancel/burst/uniformity plus a non-trivial realized fill rate is the expected signature of legitimate automated market-making. This explanation should reduce confidence in Wash Execution and Spoofing findings above, not add to them.":"High cancel/burst/uniformity WITHOUT meaningful fills is less consistent with genuine market-making \u2014 weigh the Spoofing and Wash Execution findings above accordingly."}))):o.push(Se({module:"Market-Maker Automation",category:"automation",sev:"ok",headline:"No strong automation signature",detail:"Order behavior does not show the high-cancel/tight-sizing/burst pattern typical of automated market-making."})),{automationLikely:i,findings:o}}function Nv(e,t,n,s,a,o){let i=Mv(s,e,t),r=Lv(i,s,e,t),l=Av(i,s,e,t,o),c=Ev(i,s,e,t,a),u=[...r.findings,...l.findings,...c.findings,...(a==null?void 0:a.findings)||[]],p=Math.min(100,r.score+l.score),d=p===0?"clean":p<25?"low-risk":p<50?"suspicious":"high-risk";return{signals:u,score:p,verdict:d,executionScore:r.score,spoofingScore:l.score,automationLikely:c.automationLikely,stats:{creates:s.list.length,cancels:s.list.filter(m=>m.status==="cancelled").length,fills:(a==null?void 0:a.immediateFillCount)??0,payments:e.filter(({tx:m})=>m.TransactionType==="Payment").length,roundTrip:r.stats.roundTrip,selfTrades:r.stats.selfTrades}}}var Rv=[0,.301,.176,.125,.097,.079,.067,.058,.051,.046];function _v(e){let t=new Map;for(let{tx:n}of e){let s=n.TransactionType==="Payment"?"Payment":n.TransactionType==="OfferCreate"||n.TransactionType==="OfferCancel"?"Offer":null;if(!s)continue;let a=[n.Amount,n.TakerGets,n.TakerPays,n.SendMax,n.DeliverMin];for(let o of a){let i=qi(o),r=Zt(o);if(r==null||r<=0||!Number.isFinite(r)||!i)continue;let l=`${i}|${s}`;t.has(l)||t.set(l,{currency:i,txClass:s,values:[]}),t.get(l).values.push(r)}}return t}function Dv(e){let t=e.length,n=[];if(t<50)return{level:"LOW",reasons:[`Only ${t} observations in this group (need \u226550)`],n:t};let s=[...e].sort((p,d)=>p-d),a=s[0],o=s[s.length-1],i=a>0?Math.log10(o/a):0,r=[100,1e3,1e4,1e5],c=e.filter(p=>r.some(d=>Math.abs(p%d)<1e-6&&p/d>=1)).length/t,u="HIGH";return i<1?(u="LOW",n.push(`Values span only ${i.toFixed(1)} orders of magnitude \u2014 Benford needs a wide spread to be meaningful`)):i<2&&(u="MEDIUM",n.push(`Narrow magnitude spread (${i.toFixed(1)} orders of magnitude)`)),c>.5?(u="LOW",n.push(`${(c*100).toFixed(0)}% round-number amounts \u2014 suggests fixed lot sizes or tick constraints, not organically-generated values`)):c>.25&&u==="HIGH"&&(u="MEDIUM",n.push(`${(c*100).toFixed(0)}% round-number amounts`)),t<100&&u==="HIGH"&&(u="MEDIUM",n.push(`Sample size (${t}) clears the minimum but is still modest`)),n.length||n.push("Sufficient sample size, wide magnitude spread, low round-number concentration"),{level:u,reasons:n,magnitudeSpread:i,roundPct:c,n:t}}function Iv(e){let t=e.length,n=new Array(10).fill(0);for(let o of e){let i=o.toFixed(6).replace(/^0+\.?0*/,""),r=parseInt(i[0],10);r>=1&&r<=9&&n[r]++}let s=0,a=[];for(let o=1;o<=9;o++){let i=n[o]/t,r=Rv[o];s+=t*Math.pow(i-r,2)/r,a.push({digit:o,obs:(i*100).toFixed(1),exp:(r*100).toFixed(1),delta:((i-r)*100).toFixed(1)})}return{chiSq:s,digitBreakdown:a,n:t}}function Nu(e){if((e==null?void 0:e.chiSq)==null)return 0;let t={HIGH:1,MEDIUM:.5,LOW:.15}[e.overallApplicability]??.15;return Math.min(10,e.chiSq/20.09*10)*t}function Fv(e){let t=_v(e),n=[];for(let[i,r]of t){if(r.values.length<50)continue;let l=Dv(r.values),c=Iv(r.values);n.push({key:i,currency:r.currency,txClass:r.txClass,...c,applicability:l})}if(n.sort((i,r)=>r.n-i.n),!n.length)return{signals:[{sev:"info",label:"Insufficient data for Benford's Law",detail:"No single currency/transaction-class group reached the 50-observation minimum \u2014 amounts are too fragmented across assets to test any one distribution meaningfully."}],results:[],overallApplicability:"LOW",chiSq:null,verdict:"insufficient",digitBreakdown:[],sampleSize:0};let s=n.map(i=>Se({module:"Benford's Law",category:"market-integrity",sev:i.applicability.level==="LOW"?"info":i.chiSq>20.09?"warn":"ok",confidence:{HIGH:.7,MEDIUM:.4,LOW:.15}[i.applicability.level],headline:`${i.currency==="XRP"?"XRP":z(i.currency)} ${i.txClass} amounts: \u03C7\xB2=${i.chiSq.toFixed(1)}, Applicability ${i.applicability.level}`,detail:`n=${i.n} observations`,observed:[`Benford Applicability: ${i.applicability.level}`,...i.applicability.reasons,`Chi-square statistic: ${i.chiSq.toFixed(2)} (critical values: 15.51 at p<0.05, 20.09 at p<0.01)`],classification:i.applicability.level==="LOW"?"Benford's Law is not reliably applicable to this group (narrow magnitude spread and/or high round-number concentration) \u2014 a deviation here says nothing about whether amounts were fabricated.":i.chiSq>20.09?"Amount-generation pattern is non-natural under this model. This describes the shape of the distribution, not a conclusion about intent \u2014 fixed pricing tiers, algorithmic strategies, and token denomination conventions are common legitimate causes of Benford deviation.":"First-digit distribution is consistent with organic, unconstrained amount generation."})),a=n[0],o=n.some(i=>i.applicability.level==="HIGH")?"HIGH":n.some(i=>i.applicability.level==="MEDIUM")?"MEDIUM":"LOW";return{signals:s,results:n,overallApplicability:o,chiSq:a.chiSq,verdict:a.chiSq>20.09?"high-deviation":a.chiSq>15.51?"moderate-deviation":"normal",digitBreakdown:a.digitBreakdown,sampleSize:a.n}}function Ov(e,t){let s=[],a=[];for(let{tx:v}of e){let h=[v.Amount,v.TakerGets,v.TakerPays];for(let b of h){let x=typeof b=="string"?Number(b)/1e6:b!=null&&b.value?Number(b.value):null;x&&x>0&&Number.isFinite(x)&&a.push(x)}}let o=a.length>=30?(()=>{let v=new Array(12).fill(0);for(let h of a){let b=Math.min(11,Math.max(0,Math.floor(Math.log10(h+1)*2)));v[b]++}return Zs(v)})():null,i={};for(let{tx:v}of e){let h=v.Account===t?v.Destination:v.Account;h&&h!==t&&(i[h]=(i[h]||0)+1)}let r=Object.values(i),l=r.length>=3?Zs(r):null,c=new Array(24).fill(0),u=!1;for(let{tx:v}of e)if(v.date){let b=new Date((v.date+946684800)*1e3).getUTCHours();c[b]++,u=!0}let p=u&&e.length>=30?Zs(c):null,d={};for(let{tx:v}of e)d[v.TransactionType]=(d[v.TransactionType]||0)+1;let m=Zs(Object.values(d)),f="normal",g=0;if(o!==null&&(o<1.5?(f="low-entropy",g+=18,s.push({sev:"warn",label:`Amount entropy critically low (H=${o.toFixed(2)} bits)`,detail:"Transaction amounts are highly repetitive. A bot or scripted actor tends to reuse the same values. Organic wallets show entropy \u22652.4 bits across amount magnitudes."})):o<2.2?(g+=8,s.push({sev:"info",label:`Amount entropy below natural range (H=${o.toFixed(2)} bits)`,detail:"Some amount repetition detected. Could indicate automated activity mixed with organic transactions."})):o>4.5?(g+=10,s.push({sev:"info",label:`Amount entropy abnormally high (H=${o.toFixed(2)} bits)`,detail:"Transaction amounts are maximally varied \u2014 more than organic activity typically shows. This can indicate amounts were artificially randomized to evade Benford detection."})):s.push({sev:"ok",label:`Amount entropy normal (H=${o.toFixed(2)} bits)`,detail:"Transaction amount diversity is consistent with organic financial activity."})),l!==null&&(l<1&&r.length<4?(g+=14,s.push({sev:"warn",label:`Counterparty entropy very low (H=${l.toFixed(2)} bits)`,detail:"This wallet transacts with very few unique addresses and with high repetition \u2014 a structural signature of round-trip wash trading rings."})):l<2?(g+=5,s.push({sev:"info",label:`Counterparty entropy low (H=${l.toFixed(2)} bits)`,detail:"Most interactions are concentrated among a small set of counterparties."})):s.push({sev:"ok",label:`Counterparty diversity healthy (H=${l.toFixed(2)} bits)`,detail:"Counterparty distribution reflects diverse interaction patterns."})),p!==null){let v=Math.log2(24),h=p/v;h<.45?(g+=10,s.push({sev:"warn",label:`Time-of-day entropy low (H=${p.toFixed(2)} bits, ${(h*100).toFixed(0)}% of max)`,detail:"Transactions cluster heavily in a few hours of the day. Bots typically run at fixed UTC hours; organic users spread activity across the day."})):s.push({sev:"ok",label:`Time-of-day distribution natural (H=${p.toFixed(2)} bits)`,detail:"Transaction timing is distributed across hours in a pattern consistent with human activity."})}return s.length||s.push({sev:"info",label:"Insufficient data for entropy analysis",detail:`Need \u226530 transactions. Found ${e.length}.`}),g>=18?f="anomalous":g>=8&&(f="elevated"),{signals:s,verdict:f,riskPenalty:g,amountEntropy:o,counterpartyEntropy:l,timeEntropy:p,typeEntropy:m,uniqueCounterparties:r.length,sampleSize:e.length}}function Zs(e){let t=e.reduce((n,s)=>n+s,0);return t?-e.reduce((n,s)=>{if(!s)return n;let a=s/t;return n+a*Math.log2(a)},0):0}function Bv(e,t){let s=[],a={};for(let{tx:C}of e){let P=C.Account===t?C.Destination:C.Account;P&&P!==t&&(a[P]=(a[P]||0)+1)}let o=Object.values(a).sort((C,P)=>P-C);if(o.length<8)return{signals:[{sev:"info",label:`Insufficient counterparties for Zipf's Law (need \u22658, found ${o.length})`,detail:"Zipf analysis becomes meaningful with a broader counterparty network."}],verdict:"insufficient",zipfExponent:null,riskPenalty:0,freqTable:[],uniqueCounterparties:o.length};let i=o.length,r=0,l=0,c=0,u=0,p=o.map((C,P)=>({rank:P+1,freq:C,lx:Math.log(P+1),ly:Math.log(C)}));for(let{lx:C,ly:P}of p)r+=C,l+=P,c+=C*P,u+=C*C;let d=i*u-r*r,m=d!==0?(i*c-r*l)/d:null,f=m!==null?Math.abs(m):null,g=l/i,v=0,h=0,b=(l-m*r)/i;for(let{lx:C,ly:P}of p)v+=Math.pow(P-g,2),h+=Math.pow(P-(m*C+b),2);let x=v>0?1-h/v:0,k="normal",T=0;f!==null&&(x<.55?(T+=12,s.push({sev:"warn",label:`Counterparty distribution doesn't follow Zipf's Law (R\xB2=${x.toFixed(2)})`,detail:`Natural networks follow a power-law rank-frequency relationship. This wallet's counterparty network has poor Zipf fit (R\xB2=${x.toFixed(2)}), suggesting artificial or script-driven interaction structure.`}),k="anomalous"):f<.4?(T+=15,s.push({sev:"warn",label:`Zipf exponent too flat (s=${f.toFixed(2)}, expected 0.8\u20131.3)`,detail:"A very flat Zipf exponent means counterparties are used with surprisingly equal frequency. In organic networks, you transact far more often with a few key addresses. Flat distribution is consistent with round-trip wash trading rings."}),k="anomalous"):f>2.2?(T+=10,s.push({sev:"warn",label:`Zipf exponent hyper-concentrated (s=${f.toFixed(2)}, expected 0.8\u20131.3)`,detail:"Extreme concentration on one or two counterparties with steep dropoff. While not unusual for simple wallets, combined with other signals this suggests coordinated narrow-ring activity."}),k="elevated"):s.push({sev:"ok",label:`Counterparty network follows Zipf's Law (s=${f.toFixed(2)}, R\xB2=${x.toFixed(2)})`,detail:"The rank-frequency distribution of counterparties follows the expected natural power-law pattern. This is consistent with organic wallet activity."}));let S={};for(let{tx:C}of e){let P=typeof C.Amount=="string"?Math.round(Number(C.Amount)/1e4)*10:null;P&&P>0&&(S[P]=(S[P]||0)+1)}let $=Object.values(S).sort((C,P)=>P-C),E=$.length?$[0]/$.reduce((C,P)=>C+P,0):0;return E>.45&&(T+=8,s.push({sev:"warn",label:`Single amount dominates ${(E*100).toFixed(0)}% of transactions`,detail:"One transaction amount value accounts for nearly half of all payments. Round-number dominance is a hallmark of scripted or wash-trading activity."})),s.length||s.push({sev:"info",label:"Zipf analysis: no anomalies detected",detail:"Counterparty distribution consistent with natural activity."}),{signals:s,verdict:k,riskPenalty:T,zipfExponent:f,rSquared:x,freqTable:o.slice(0,12),uniqueCounterparties:o.length}}function Xv(e){if(e.length<20)return{signals:[{sev:"info",label:`Insufficient transactions for time series analysis (need \u226520, found ${e.length})`,detail:"Time series analysis requires a longer transaction history."}],verdict:"insufficient",riskPenalty:0,intervalCV:null,autocorrelation:null,burstScore:null,periodicityScore:null};let s=e.filter(({tx:S})=>S.date!=null).map(({tx:S})=>(S.date+946684800)*1e3).sort((S,$)=>S-$);if(s.length<20)return{signals:[{sev:"info",label:"No timestamp data available",detail:"Time series requires date-stamped transactions."}],verdict:"insufficient",riskPenalty:0,intervalCV:null,autocorrelation:null,burstScore:null,periodicityScore:null};let a=[];for(let S=1;S<s.length;S++){let $=(s[S]-s[S-1])/1e3;$>0&&$<86400*30&&a.push($)}let o=null;if(a.length>=5){let S=a.reduce((E,C)=>E+C,0)/a.length,$=Math.sqrt(a.reduce((E,C)=>E+Math.pow(C-S,2),0)/a.length);o=S>0?$/S:null}let i={};for(let S of s){let $=new Date(S).toISOString().slice(0,10);i[$]=(i[$]||0)+1}let r=Object.values(i),l=0;if(r.length>=4){let S=r.reduce((C,P)=>C+P,0)/r.length,$=Math.sqrt(r.reduce((C,P)=>C+Math.pow(P-S,2),0)/r.length),E=Math.max(...r);l=$>0?(E-S)/$:0}let c=null;if(r.length>=6){let S=r.reduce((C,P)=>C+P,0)/r.length,$=r.map(C=>C-S),E=$.reduce((C,P)=>C+P*P,0);E>0&&(c=$.slice(0,-1).reduce((P,R,O)=>P+R*$[O+1],0)/E)}let u=new Array(7).fill(0);for(let S of s)u[new Date(S).getUTCDay()]++;let p=Zs(u),d=Math.log2(7),m=0;if(a.length>=10){let S=[...a].sort((C,P)=>C-P),$=S[Math.floor(S.length/2)];m=a.filter(C=>Math.abs(C-$)/$<.2).length/a.length}let f=Object.entries(i).sort((S,$)=>S[0].localeCompare($[0])),g=null;if(f.length>=8){let S=Math.floor(f.length/2),$=f.slice(0,S),E=f.slice(S),C=D=>D.reduce((I,[,F])=>I+F,0)/D.length,P=C($),R=C(E),O=P>0&&R>0?Math.max(P,R)/Math.min(P,R):null;O!=null&&O>=3&&(g={transitionDate:E[0][0],beforeRate:P,afterRate:R,ratio:O,direction:R>P?"increase":"decrease"})}let v=0;o!==null&&(v+=Math.max(0,(.6-o)/.6)*60),v+=m*40,v=Math.min(100,Math.round(v));let h=[],b="normal",x=0;if(v>=60?(h.push({sev:"info",label:`Automation Probability: ${v}% (interval CV=${o!=null?o.toFixed(2):"\u2014"}, periodicity=${(m*100).toFixed(0)}%)`,detail:"Transaction timing is consistent with scripted/automated execution. This describes HOW the account operates, not whether it's risky \u2014 automation alone is common and legitimate (market makers, subscription payments, scheduled treasury operations)."}),x+=6):v>=30?h.push({sev:"ok",label:`Automation Probability: ${v}%`,detail:"Some timing regularity, within a range common to both scheduled tools and habitual human usage."}):h.push({sev:"ok",label:`Automation Probability: ${v}%`,detail:"Transaction timing shows natural, human-like variance."}),g&&(x+=4,h.push({sev:"info",label:`Regime Change detected around ${g.transitionDate}`,detail:`Daily transaction rate ${g.direction}d roughly ${g.ratio.toFixed(1)}x (${g.beforeRate.toFixed(1)} \u2192 ${g.afterRate.toFixed(1)} tx/day). A simple split-half comparison, not a formal changepoint test \u2014 treat the transition date as approximate.`})),l>3.5){let S=f.length?f.reduce(($,E)=>E[1]>$[1]?E:$)[0]:null;h.push({sev:"info",label:`Burst Event: peak day z-score ${l.toFixed(1)}${S?` (${S})`:""}`,detail:"One day had extreme transaction volume relative to this account's own baseline. Consistent with a coordinated event, an account-recovery sweep, or simply a busy day \u2014 timing and other signals (Fund Flow, Fee Spikes) provide the context this alone can't."})}c!==null&&c>.6&&(x+=4,h.push({sev:"info",label:`Volume Autocorrelation: HIGH (\u03C1=${c.toFixed(2)})`,detail:"Day-to-day transaction volume is strongly self-correlated \u2014 consistent with a routine that maintains a steady pace, not inherently risky on its own."}));let k=p/d;k<.7&&s.length>30&&h.push({sev:"info",label:`Unusual Relative to Account Baseline: day-of-week activity concentrated (${(k*100).toFixed(0)}% of max entropy)`,detail:"Transactions cluster on specific days of the week relative to this account's own history. Both maximally-flat (every day) and business-hours-only patterns can produce this \u2014 direction matters more than the raw number."}),h.length<=1&&v<30&&h.push({sev:"ok",label:"No temporal anomalies detected",detail:"Transaction timing patterns are consistent with organic human activity."}),x>=10&&(b="elevated");let T=s.length>=2?Math.round((s[s.length-1]-s[0])/864e5):null;return{signals:h,verdict:b,riskPenalty:x,intervalCV:o,autocorrelation:c,burstScore:l,periodicityScore:m,automationProbability:v,regimeChange:g,dowEntropy:p,dowBins:u,dailyVolume:Object.entries(i).slice(-30),activeSpanDays:T,totalTimestamped:s.length}}function Hv(e,t){let s=[];if(e.length<20)return{signals:[{sev:"info",label:`Insufficient data for offer/flow coupling analysis (need \u226520, found ${e.length})`,detail:"Testing for lead-lag correlation requires enough temporal observations."}],verdict:"insufficient",riskPenalty:0,offerCancelCausality:null,inflowOutflowCausality:null};let o=12*3600*1e3,i=I=>I.date?Math.floor((I.date+946684800)*1e3/o):null,r={},l=I=>{r[I]||(r[I]={offerCreate:0,offerCancel:0,inflow:0,outflow:0,nftList:0,nftAccept:0})};for(let{tx:I,meta:F}of e){let H=i(I);if(H===null)continue;l(H);let N=r[H],W=I.TransactionType;W==="OfferCreate"?N.offerCreate++:W==="OfferCancel"&&N.offerCancel++,W==="NFTokenCreateOffer"?N.nftList++:W==="NFTokenAcceptOffer"&&N.nftAccept++;let se=(F==null?void 0:F.delivered_amount)||I.Amount,re=typeof se=="string"?Number(se)/1e6:0;re>0&&(I.Destination===t?N.inflow+=re:I.Account===t&&(N.outflow+=re))}let c=Object.keys(r).map(Number).sort((I,F)=>I-F);if(c.length<6)return{signals:[{sev:"info",label:"Insufficient temporal windows for coupling analysis",detail:"Need activity spread across multiple time windows."}],verdict:"insufficient",riskPenalty:0,offerCancelCausality:null,inflowOutflowCausality:null};let u=I=>c.map(F=>r[F][I]||0),p=(I,F,H=4)=>{let N=I.length,W=I.reduce((de,le)=>de+le,0)/N,se=F.reduce((de,le)=>de+le,0)/N,re=I.map(de=>de-W),pe=F.map(de=>de-se),ae=Math.sqrt(re.reduce((de,le)=>de+le*le,0)/N),te=Math.sqrt(pe.reduce((de,le)=>de+le*le,0)/N);return!ae||!te?Array(H+1).fill(0):Array.from({length:H+1},(de,le)=>{let Pe=0,B=0;for(let q=0;q+le<N;q++)Pe+=re[q]*pe[q+le],B++;return B>0?Pe/(B*ae*te):0})},d="normal",m=0,f=u("offerCreate"),g=u("offerCancel"),v=p(f,g),h=v.indexOf(Math.max(...v)),b=Math.max(...v),x={ccf:v,maxCorr:b,maxLag:h};b>.55&&h<=2?(m+=18,d="strong-coupling",s.push(Se({module:"Offer Coupling",category:"market-integrity",sev:"warn",confidence:.4,headline:`Offer Creation/Cancellation Coupling: HIGH (\u03C1=${b.toFixed(2)}, lag=${h} window${h===1?"":"s"})`,detail:`Offer creation and cancellation are strongly correlated ${h} window(s) apart (${h*12}h).`,observed:[`Cross-correlation \u03C1=${b.toFixed(2)} at a ${h}-window lag`,"Correlation, not a causality test \u2014 no autoregressive model or significance test was run"],alternativeExplanations:["Active order management/repricing that naturally pairs creates with cancels","A market maker's normal quote-refresh cycle"],classification:"Statistical coupling observed between offer creation and cancellation timing. This is the kind of pattern wash trading can produce, but correlation at a lag is not proof of it \u2014 see Wash Execution and Spoofing for behavior-level evidence."}))):b>.35?(m+=6,s.push(Se({module:"Offer Coupling",category:"market-integrity",sev:"info",confidence:.25,headline:`Offer Creation/Cancellation Coupling: MODERATE (\u03C1=${b.toFixed(2)}, lag=${h})`,detail:"A mild temporal link between creating and cancelling offers."}))):s.push({sev:"ok",label:"Offer Creation/Cancellation Coupling: LOW",detail:"Offer creation and cancellation timing appear independent."});let k=u("inflow"),T=u("outflow"),S=p(k,T),$=S.indexOf(Math.max(...S)),E=Math.max(...S),C={ccf:S,maxCorr:E,maxLag:$};E>.65&&$===0?(m+=12,s.push(Se({module:"Offer Coupling",category:"market-integrity",sev:"warn",confidence:.4,headline:`Inflow/Outflow Contemporaneous Correlation: HIGH (\u03C1=${E.toFixed(2)})`,detail:"Funds entering and leaving the wallet in the same 12h window are strongly correlated.",observed:[`Zero-lag correlation \u03C1=${E.toFixed(2)} \u2014 same-window co-movement, not a lead-lag relationship`,"A lag-0 result cannot show which direction (if either) leads the other"],alternativeExplanations:["Pass-through/consolidation behavior (an intermediary account by design)","Routine deposit-then-forward operational pattern"],classification:"Same-window co-movement between inflow and outflow, not a demonstrated lead-lag pattern. Consistent with pass-through/round-trip activity, but zero lag means the data alone cannot establish which value moved first."}))):E>.55&&$<=1?(m+=8,s.push(Se({module:"Offer Coupling",category:"market-integrity",sev:"info",confidence:.3,headline:`Inflow/Outflow Coupling: MODERATE (\u03C1=${E.toFixed(2)}, lag=${$})`,detail:"Incoming funds are correlated with outgoing funds at a short lag."}))):s.push({sev:"ok",label:"Inflow/Outflow Coupling: LOW",detail:"Inflow and outflow timing are not predictably linked."});let P=u("nftList"),R=u("nftAccept"),O=P.reduce((I,F)=>I+F,0),D=R.reduce((I,F)=>I+F,0);if(O>3&&D>3){let I=p(P,R),F=Math.max(...I),H=I.indexOf(F);F>.6&&H<=1&&(m+=8,s.push(Se({module:"Offer Coupling",category:"market-integrity",sev:"warn",confidence:.3,headline:`NFT Listing/Acceptance Coupling: HIGH (\u03C1=${F.toFixed(2)}, lag=${H})`,detail:"NFT sell-offer creation is closely correlated with acceptance timing.",alternativeExplanations:["A pre-arranged legitimate sale between known parties"],classification:"Timing coupling only \u2014 combined with the NFT trap detection module's own evidence, this can support (but does not by itself prove) a coordinated-acceptance pattern."})))}return s.some(I=>I.sev==="warn"||I.sev==="critical")||s.length||s.push({sev:"ok",label:"No coupling anomalies detected",detail:"Temporal relationships between transaction types show no notable lead-lag or contemporaneous correlation."}),m>=18?d="strong-coupling":m>=8&&(d="elevated"),{signals:s,verdict:d,riskPenalty:m,offerCancelCausality:x,inflowOutflowCausality:C,windowCount:c.length}}function zv(e){if(!e)return"";try{let t="";for(let n=0;n<e.length;n+=2){let s=parseInt(e.slice(n,n+2),16);s>=32&&s<127&&(t+=String.fromCharCode(s))}return t.length>4?t.toLowerCase().trim():""}catch{return""}}function Wv(e){let t=Array.from({length:e},(a,o)=>o),n=a=>t[a]===a?a:t[a]=n(t[a]);return{find:n,union:(a,o)=>{let i=n(a),r=n(o);i!==r&&(t[i]=r)}}}function jv(e){let t=e.length,{find:n,union:s}=Wv(t);for(let o=0;o<t;o++)for(let i=o+1;i<t;i++){let r=e[o],l=e[i];if(r.memos.size&&[...r.memos].some(d=>l.memos.has(d))){s(o,i);continue}let u=0;for(let d of r.timestamps)for(let m of l.timestamps)Math.abs(d-m)<=30&&u++;let p=Math.min(r.timestamps.length,l.timestamps.length);u>=3&&u>=p*.5&&s(o,i)}let a=new Map;for(let o=0;o<t;o++){let i=n(o);a.has(i)||a.set(i,[]),a.get(i).push(e[o])}return[...a.values()]}function Uv(e){let t=e.reduce((l,c)=>l+c,0);if(t<=0||!e.length)return null;let n=e.map(l=>l/t).sort((l,c)=>c-l),s=n.reduce((l,c)=>l+c*c,0)*1e4,a=[...e].sort((l,c)=>l-c),o=a.length,i=0;a.forEach((l,c)=>{i+=(c+1)*l});let r=o>1&&t>0?Math.max(0,2*i/(o*t)-(o+1)/o):0;return{hhi:s,gini:r,top1Share:n[0]||0,top5Share:n.slice(0,5).reduce((l,c)=>l+c,0),effectiveParticipants:s>0?1e4/s:o}}var bu=200;function qv(e,t){let n=new Map;for(let{tx:o}of e){let i=[o.TakerGets,o.Amount],r=(o.Memos||[]).map(l=>{var c;return zv(((c=l.Memo)==null?void 0:c.MemoData)||"")}).filter(Boolean);for(let l of i){if(!l||typeof l!="object")continue;let c=l.currency,u=Number(l.value||0),p=o.Account;if(!c||!p||u<=0||!Number.isFinite(u))continue;n.has(c)||n.set(c,{senderMap:new Map,vol:0,trades:0});let d=n.get(c);d.vol+=u,d.trades++,d.senderMap.has(p)||d.senderMap.set(p,{sender:p,vol:0,memos:new Set,timestamps:[]});let m=d.senderMap.get(p);m.vol+=u,m.timestamps.push(jn(o));for(let f of r)m.memos.add(f)}}let s=[],a=[];for(let[o,i]of n.entries()){if(i.trades<8)continue;let r=[...i.senderMap.values()],l=r.length,c=l>bu,u=c?r.map(f=>[f]):jv(r),p=u.map(f=>f.reduce((g,v)=>g+v.vol,0)),d=Uv(p);if(!d)continue;let m=l-u.length;a.push({currency:o,rawActorCount:l,estimatedActorClusters:u.length,vol:i.vol,trades:i.trades,...d}),d.hhi>1500&&s.push(Se({module:"Volume Concentration",category:"market-integrity",sev:d.hhi>2500?"critical":"warn",confidence:c?.3:m>0?.45:.3,headline:`${o}: ~${u.length} estimated economic actor(s) (${l} raw addresses), HHI ${Math.round(d.hhi)}`,detail:`${i.trades} trades totalling ${_(i.vol,2)} ${o}.`,observed:[`Raw distinct addresses: ${l}`,c?`Address count exceeded the clustering cap (${bu}) for this pass \u2014 shown as raw addresses, not clustered`:m>0?`${m} address(es) merged into fewer likely-same-controller clusters via shared memo text or synchronized timing`:"No clustering signal found \u2014 each address treated as a separate actor",`HHI: ${Math.round(d.hhi)} (${d.hhi>2500?"highly concentrated":"moderately concentrated"} by standard antitrust bands: <1500 unconcentrated, 1500-2500 moderate, >2500 high)`,`Gini coefficient: ${d.gini.toFixed(2)}`,`Top-1 actor share: ${(d.top1Share*100).toFixed(0)}% \xB7 Top-5: ${(d.top5Share*100).toFixed(0)}%`,`Effective participant count (10000/HHI): ${d.effectiveParticipants.toFixed(1)}`],alternativeExplanations:m>0?["One legitimate market participant operating multiple wallets for ordinary reasons (custody segregation, accounting)"]:["A genuinely thin, low-participation market rather than coordinated activity"],classification:"Clustering here is best-effort \u2014 shared memo text or tightly synchronized timing only. It cannot detect a shared funding source or off-chain relationships between addresses, so the true number of distinct economic actors may be lower than shown, not higher."}))}return a.length?s.length||s.push({sev:"ok",label:"Volume concentration normal",detail:`${a.length} token(s) analysed \u2014 all show broad, unconcentrated participation (HHI < 1500).`}):s.push({sev:"info",label:"No IOU/token volume data",detail:"No token-denominated transactions found in history (XRP-only activity)."}),{signals:s,concentrations:a}}function Vv(e,t,n,s){let a=[],o=!!(n&_e.lsfDefaultRipple)||t.some(h=>h.account===e.Account),i=t.filter(h=>Number(h.balance)<0),r=i.reduce((h,b)=>h+Math.abs(Number(b.balance)),0);i.length>0&&a.push({sev:"info",label:`Token issuer: ${i.length} outstanding currency lines`,detail:`Total outstanding: ${_(r,2)} across ${i.length} holder(s).`});let l=t.filter(h=>h.freeze),c=t.filter(h=>h.freeze_peer);l.length&&a.push({sev:"warn",label:`${l.length} trustline(s) frozen by this account`,detail:"This account has frozen specific trustlines."}),c.length&&a.push({sev:"critical",label:`${c.length} of your trustline(s) frozen by issuer`,detail:`Frozen currencies: ${c.map(h=>h.currency).join(", ")}. You cannot transfer these tokens.`}),n&_e.lsfGlobalFreeze&&a.push({sev:"critical",label:"Global Freeze \u2014 all token transfers suspended",detail:"No holders can transfer tokens issued by this account."}),n&_e.lsfNoFreeze&&a.push({sev:"ok",label:"NoFreeze flag set \u2014 issuer cannot freeze balances",detail:"Token holders are protected against future freeze actions."});let u={requireAuth:2,noFreeze:6,globalFreeze:7,defaultRipple:8,depositAuth:9},p=s.filter(({tx:h})=>h.TransactionType==="AccountSet"&&h.Account===e.Account&&(h.SetFlag!=null||h.ClearFlag!=null)).map(({tx:h})=>({date:h.date,hash:h.hash,setFlag:h.SetFlag??null,clearFlag:h.ClearFlag??null})).sort((h,b)=>(h.date??0)-(b.date??0)),d=h=>p.filter(b=>b.setFlag===h||b.clearFlag===h).length,m=d(u.globalFreeze),f=d(u.requireAuth);if(m>0){let h=p.filter(b=>b.setFlag===u.globalFreeze||b.clearFlag===u.globalFreeze).slice(-1)[0];a.push(Se({module:"Token Issuer",category:"issuer",sev:m>1?"warn":"info",confidence:.5,headline:`Global Freeze toggled ${m} time(s) in fetched history`,detail:`Most recent change: ${h.setFlag!=null?"frozen":"unfrozen"}.`,observed:[`${m} AccountSet transaction(s) setting or clearing Global Freeze`],alternativeExplanations:["A brief, disclosed freeze for a migration, exploit response, or contract upgrade"],classification:m>1?"Repeated freeze/unfreeze cycles show the issuer actively exercises this control, not just holds it theoretically \u2014 worth understanding why, from the project's own communications.":"A single freeze event in this account's history \u2014 check whether it was disclosed and time-bound."}))}f>0&&a.push({sev:"info",label:`Require Auth toggled ${f} time(s) in fetched history`,detail:"The issuer has changed whether new trustlines require its approval at least once."});let g=Number(e.Balance||0)/1e6,v=10+Number(e.OwnerCount||0)*2;return i.length>0&&g<v+1&&a.push({sev:"warn",label:"Issuer balance near reserve \u2014 possible black hole",detail:"Issuer with outstanding tokens has almost no XRP above reserve. Tokens may be stranded."}),a.length===0&&a.push({sev:"ok",label:"No token issuer flags",detail:"This account does not appear to be a token issuer."}),{signals:a,isIssuer:o,obligationCount:i.length,issuerFlagHistory:p}}function Gv(e,t,n,s=new Map,a=null){var f,g,v;let o=[],i=[],r=e.filter(h=>h.currency&&Number(h.balance)!==0&&$u(h.currency)),l=t.filter(({tx:h})=>h.TransactionType==="AMMDeposit"),c=t.filter(({tx:h})=>h.TransactionType==="AMMWithdraw"),u=t.filter(({tx:h})=>h.TransactionType==="AMMCreate"),p=t.filter(({tx:h})=>h.TransactionType==="AMMVote"),d=t.filter(({tx:h})=>h.TransactionType==="AMMBid");if(r.forEach(h=>{let b=Number(h.balance),x=Number(h.limit);i.push({currency:h.currency,issuer:h.account,balance:b,limit:x})}),a)for(let h of i){let b=[...l,...c].filter(({tx:S,meta:$})=>{var E,C;return(C=(E=$==null?void 0:$.AffectedNodes)==null?void 0:E.some)==null?void 0:C.call(E,P=>{var R;return((R=P.CreatedNode||P.ModifiedNode||P.DeletedNode)==null?void 0:R.LedgerEntryType)==="RippleState"&&[P.CreatedNode,P.ModifiedNode,P.DeletedNode].some(O=>{var D,I,F,H;return((I=(D=O==null?void 0:O.FinalFields)==null?void 0:D.Balance)==null?void 0:I.currency)===h.currency||((H=(F=O==null?void 0:O.NewFields)==null?void 0:F.Balance)==null?void 0:H.currency)===h.currency})})}),x=0,k=[],T=[];for(let{tx:S,meta:$}of b){let E=Qi(S,$,a),C=E.lpDeltas.find(R=>R.currency===h.currency);if(!C)continue;let P={hash:S.hash,date:S.date,lpTokenDelta:C.delta,xrpDelta:E.xrpDelta,tokenDeltas:E.tokenDeltas};S.TransactionType==="AMMDeposit"?(k.push(P),x+=-E.xrpDelta):(T.push(P),x-=-E.xrpDelta)}(k.length||T.length)&&(h.depositEvents=k,h.withdrawEvents=T,h.costBasisXrp=x>0?x:null)}if(i.length){o.push({sev:"info",label:`${i.length} LP token position(s)`,detail:`Active liquidity provider in ${i.length} AMM pool(s).`});for(let h of i){let b=s.get(h.currency);if(b){if(h.tvl=b.amount?Number(b.amount)/1e6:null,h.tvl2=(f=b.amount2)!=null&&f.value?Number(b.amount2.value):null,h.feeRate=b.trading_fee!=null?b.trading_fee/1e3:null,h.lpSupply=(g=b.lp_token)!=null&&g.value?Number(b.lp_token.value):null,h.lpSupply&&h.balance){let x=Math.abs(h.balance)/h.lpSupply*100;h.ownerPct=x,x>50&&o.push({sev:"warn",label:`Dominant AMM position: ${x.toFixed(0)}% of pool`,detail:`This account controls ${x.toFixed(0)}% of the LP token supply for pool ${z(h.currency)}. Withdrawing all at once would severely impact pool liquidity and anyone currently trading in it.`})}h.tvl!=null&&o.push({sev:"info",label:`Pool TVL: ${_(h.tvl,2)} XRP${h.tvl2?` + ${_(h.tvl2,2)} tokens`:""} \xB7 Fee: ${((v=h.feeRate)==null?void 0:v.toFixed(2))??"?"}%`,detail:`Actual pool context from amm_info. Your LP position represents ${h.ownerPct!=null?h.ownerPct.toFixed(1)+"% of the pool.":"an unknown share of the pool."}`})}}}return u.length&&o.push({sev:"info",label:`Created ${u.length} AMM pool(s)`,detail:"This account bootstrapped one or more liquidity pools."}),(l.length||c.length)&&o.push({sev:"info",label:`${l.length} deposit(s) \xB7 ${c.length} withdrawal(s)`,detail:"LP activity history."}),p.length&&o.push({sev:"info",label:`${p.length} AMM fee vote(s)`,detail:"This account has voted on AMM trading fee parameters."}),d.length&&o.push({sev:"info",label:`${d.length} continuous auction bid(s)`,detail:"Bid for the AMM auction slot (reduced fee trading window)."}),i.filter(h=>Math.abs(h.balance)>1e3).length&&o.push({sev:"warn",label:"Large LP positions \u2014 impermanent loss risk",detail:"Significant liquidity positions carry exposure to price divergence between pool assets."}),o.length===0&&o.push({sev:"ok",label:"No AMM positions",detail:"This account is not a liquidity provider."}),{signals:o,positions:i,deposits:l.length,withdrawals:c.length}}function Kv(e){let t=[],s=e.filter(({tx:d})=>d.Fee&&Number(d.Fee)>0);if(s.length<10)return{signals:[],verdict:"insufficient",riskPenalty:0,avgFeeMultiplier:null,spikeCount:0,topFeeHashes:[]};let a=s.map(({tx:d})=>Number(d.Fee)/12),o=a.reduce((d,m)=>d+m,0)/a.length,r=s.filter(({tx:d})=>Number(d.Fee)/12>100).length,l=r/s.length,c=0,u="normal",p=[...s].sort((d,m)=>Number(m.tx.Fee)-Number(d.tx.Fee)).slice(0,5).map(({tx:d})=>({hash:d.hash,mult:(Number(d.Fee)/12).toFixed(0),fee:Number(d.Fee)}));return l>.15&&r>=5?(c=10,u="elevated",t.push({sev:"warn",label:`Fee spike pattern: ${r} txs paid >100x base fee (${(l*100).toFixed(0)}% of history)`,detail:`Average fee multiplier: ${o.toFixed(0)}x. In XRPL, bots often pay elevated fees to guarantee same-ledger execution as a counterparty \u2014 a technique used in coordinated wash trading and sandwich attacks. Organic users rarely pay more than 2\u20135x the base fee. Top hashes: ${p.slice(0,3).map(d=>z(d.hash)).join(", ")}.`,hashes:p.map(d=>d.hash)})):o>20?(c=4,t.push({sev:"info",label:`Elevated average fee (${o.toFixed(0)}x base fee)`,detail:"This wallet consistently pays above-average fees. Could indicate priority execution requirements or automated trading."})):t.push({sev:"ok",label:`Fee levels normal (avg ${o.toFixed(1)}x base fee)`,detail:"Transaction fees are within typical organic ranges."}),{signals:t,verdict:u,riskPenalty:c,avgFeeMultiplier:+o.toFixed(2),spikeCount:r,topFeeHashes:p}}function Jv(e,t){let n=[],s=new Map;for(let{tx:u}of e){if(u.TransactionType!=="Payment"||u.Account!==t)continue;let p=u.Destination,d=u.DestinationTag;p&&(s.has(p)||s.set(p,new Set),d!=null&&s.get(p).add(d))}let a=[...s.entries()].filter(([u])=>{let p=zn(u);return(p==null?void 0:p.type)==="exchange"}),o=e.filter(({tx:u})=>u.TransactionType==="Payment"&&u.Account===t&&u.Destination).length,i=e.filter(({tx:u})=>u.TransactionType==="Payment"&&u.Account===t&&u.Destination&&u.DestinationTag!=null).length,r=o>0?i/o*100:null,l=0,c=[];for(let[u,p]of s.entries()){let d=zn(u),m=(d==null?void 0:d.name)||z(u),f=p.size,g=e.filter(({tx:h})=>h.Account===t&&h.Destination===u).length,v=!d&&f>=8&&g>=10;c.push({dest:u,name:m,uniqueTags:f,txCount:g,looksCustodial:v,tags:[...p].slice(0,10)}),f===1&&g>=5&&(d==null?void 0:d.type)==="exchange"?n.push({sev:"info",label:`${m}: ${g} payments all using tag ${[...p][0]}`,detail:`Single destination tag used across all ${g} payments to ${m}. This is the normal pattern for one person funding their own exchange account.`}):f>10&&(d==null?void 0:d.type)==="exchange"?(l=Math.max(l,8),n.push({sev:"warn",label:`${m}: ${f} different destination tags used`,detail:`${g} payments to ${m} used ${f} different tags \u2014 each tag typically identifies a different customer account. Funding many exchange sub-accounts can indicate either a service (legitimate) or coordinated deposit layering where funds are spread across many exchange wallets to avoid detection.`})):f===0&&g>=2&&(d==null?void 0:d.type)==="exchange"?n.push({sev:"warn",label:`${m}: ${g} payments with no destination tag`,detail:"Payments to exchange addresses without a destination tag may not be credited. Most exchanges require a tag to identify which customer account receives the funds."}):v&&n.push(Se({module:"Destination Tags",category:"counterparty",sev:"info",confidence:.4,headline:`${z(u)}: unlabeled destination behaves like a custodial service (${f} distinct tags, ${g} payments)`,detail:"Not in the known-entity registry, but its tag-usage pattern matches an exchange/custodial routing scheme.",observed:[`${f} distinct destination tags across ${g} payments`,"Pattern matches per-customer sub-account routing, whoever operates it"],alternativeExplanations:["An exchange or custodial service not yet in this app's known-entity registry","A payment processor or merchant service using tags as invoice/order references"],classification:"Behavioral inference from tag-usage shape only \u2014 not a confirmed entity identification."}))}return r!=null&&o>=10&&n.push({sev:"ok",label:`Destination Tag usage: ${r.toFixed(0)}% of outbound payments (${i}/${o})`,detail:"Overall tag-usage rate across all outbound payments \u2014 context for the per-destination findings above, not a signal on its own."}),n.length===0&&s.size>0?n.push({sev:"ok",label:"Destination tag patterns normal",detail:"Payment routing tags are consistent with regular outbound payments."}):s.size===0&&n.push({sev:"info",label:"No outbound payments to analyse for destination tags",detail:"No outbound Payment transactions found in history."}),{signals:n,riskPenalty:l,tagProfiles:c}}function Yv(e,t){var c,u;let n=[],s=e.filter(({tx:p})=>p.TransactionType==="Payment"&&p.Account===t&&(Array.isArray(p.Paths)&&p.Paths.length>0||p.SendMax!=null));if(s.length===0)return{signals:[],riskPenalty:0,roundTripCount:0,deepHopCount:0,selfRoutedCount:0,noData:!0};let a=s.length<5?` (small sample: ${s.length} path payments found \u2014 patterns may not be statistically significant)`:"",o=s.filter(({tx:p})=>{let d=typeof p.Amount=="string",m=typeof p.SendMax=="string";return d&&m}),i=s.filter(({tx:p})=>Array.isArray(p.Paths)?p.Paths.some(d=>Array.isArray(d)&&d.length>=3):!1),r=s.filter(({tx:p})=>p.Destination===t),l=0;return o.length>=1&&(l+=12,n.push({sev:"warn",label:`${o.length} XRP\u2192IOU\u2192XRP round-trip path payments`,detail:`Sending XRP and receiving XRP via intermediate token pairs means the payment routes through the DEX and creates trading volume without changing economic position. ${o.length} occurrences suggests this is deliberate. This is the classic cross-currency wash-trading arb pattern on XRPL. Example hash: ${(u=(c=o[0])==null?void 0:c.tx)!=null&&u.hash?z(o[0].tx.hash):"N/A"}.`,hashes:o.slice(0,5).map(({tx:p})=>p.hash).filter(Boolean)})),i.length>=1&&(l+=6,n.push({sev:"info",label:`${i.length} path payments with \u22653 intermediate hops`,detail:"Deep routing chains (3+ hops) can indicate: legitimate arbitrage, liquidity optimization, or deliberate obfuscation of fund origin. Check each transaction for the intermediate issuers in the path."})),r.length>0&&(l+=15,n.push({sev:"critical",label:`${r.length} path payment(s) where sender = destination`,detail:`Money sent to your own address via a multi-hop path creates DEX trading volume with no net change in balance. This is a direct wash-trading technique: the path through the order book generates artificial volume on every intermediate pair. Hashes: ${r.slice(0,3).map(({tx:p})=>z(p.hash||"")).join(", ")}.`,hashes:r.slice(0,5).map(({tx:p})=>p.hash).filter(Boolean)})),n.length===0&&n.push({sev:"ok",label:`${s.length} path payment(s) \u2014 no suspicious routing patterns${a}`,detail:"No circular routing (XRP\u2192IOU\u2192XRP), self-routing, or unusual deep hop chains detected."}),{signals:n,riskPenalty:l,roundTripCount:o.length,deepHopCount:i.length,selfRoutedCount:r.length}}function Qv(e,t){var p;let n=new Map,s=[];for(let{tx:d,meta:m}of e){if(d.TransactionType!=="Payment"||d.Destination!==t)continue;let f=d.Account;if(!f||f===t)continue;let g=0,v=null,h=(m==null?void 0:m.delivered_amount)||d.Amount;typeof h=="string"?g=Number(h)/1e6:h!=null&&h.value&&(v={value:Number(h.value),currency:Hn(h.currency),issuer:h.issuer});let b=jn(d);s.push({src:f,amtXrp:g,amtToken:v,ts:b,hash:d.hash||"",destTag:d.DestinationTag}),n.has(f)||n.set(f,{addr:f,totalXrp:0,txCount:0,firstSeen:b,lastSeen:b,entity:zn(f)||null});let x=n.get(f);x.totalXrp+=g,x.txCount++,x.lastSeen=Math.max(x.lastSeen,b),x.firstSeen=Math.min(x.firstSeen,b)}let a=[...n.values()].sort((d,m)=>m.totalXrp-d.totalXrp||m.txCount-d.txCount).slice(0,10),o=a.reduce((d,m)=>d+m.totalXrp,0),i=a.filter(d=>{var m;return((m=d.entity)==null?void 0:m.type)==="exchange"}),r={};for(let d of s){if(d.amtXrp<=0)continue;let m=Math.round(d.amtXrp/10)*10;r[m]=(r[m]||0)+1}let l=Object.entries(r).sort((d,m)=>m[1]-d[1])[0],c=l&&l[1]>=5&&l[1]/s.length>.4,u=[];if(i.length){let d=[...new Set(i.map(m=>m.entity.name))].join(", ");u.push({sev:"info",label:`Funding from ${i.length} known exchange(s): ${d}`,detail:`${_(i.reduce((m,f)=>m+f.totalXrp,0),2)} XRP received from exchange withdrawals \u2014 typical for a personal trading wallet.`})}if(c&&u.push({sev:"warn",label:`Structured inbound pattern: ${l[1]} payments near ~${l[0]} XRP`,detail:`Over 40% of inbound payments cluster around the same amount (~${l[0]} XRP). Structured deposits can indicate layering \u2014 deliberately splitting large amounts into smaller equal transfers to avoid detection.`}),n.size===1&&s.length>=5){let d=a[0];u.push({sev:"info",label:`Single funding source: all ${s.length} inbound payments from one address`,detail:`${((p=d.entity)==null?void 0:p.name)||z(d.addr)} is the sole funding source. This is normal for a personal wallet but notable for a wallet claiming broad community usage.`})}return!u.length&&s.length>0&&u.push({sev:"ok",label:`${s.length} inbound payment(s) from ${n.size} source(s)`,detail:`Total received: ${_(o,2)} XRP. No unusual inbound patterns.`}),s.length===0&&u.push({sev:"info",label:"No inbound payments found in analysed history",detail:"Wallet may be funded via DEX activity or in ledgers outside the analysed range."}),{signals:u,topSources:a,totalIn:o,uniqueSources:n.size,timeline:s.slice(-20).reverse(),exchangeSrcs:i,structuredFlag:!!c}}function Zv(e,t){var c,u;let n=[],s=[],a=[/airdrop/i,/claim.*reward/i,/free.*xrp/i,/verify.*wallet/i,/support.*team/i,/urgent/i,/suspended/i,/confirm.*seed/i,/your.*account.*hold/i,/unlock/i];for(let{tx:p}of e)if((c=p.Memos)!=null&&c.length)for(let d of p.Memos){let m=((u=d.Memo)==null?void 0:u.MemoData)||"";if(!m)continue;let f="";try{f=decodeURIComponent(m.replace(/../g,v=>"%"+v))}catch{f=m}if(!f||f===m)try{let v="";for(let h=0;h<m.length;h+=2){let b=parseInt(m.slice(h,h+2),16);b>=32&&b<127&&(v+=String.fromCharCode(b))}v.length>4&&(f=v)}catch{}let g=p.Account===t?p.Destination:p.Account;s.push({tx:p.hash||"",type:p.TransactionType,sender:p.Account,counterparty:g,date:p.date,text:f.slice(0,200),raw:m})}if(s.length===0)return{signals:[],allMemos:[],scamMemos:[],repeatedMemos:[],fingerprints:[]};let o=s.filter(p=>a.some(d=>d.test(p.text)));o.length&&n.push({sev:"critical",label:`${o.length} memo(s) match known scam patterns`,detail:`Memos containing phrases like "airdrop", "claim reward", "verify wallet", or "urgent" are used in social engineering attacks. These payments were likely sent to trick the recipient into taking action. Examples: ${o.slice(0,2).map(p=>'"'+p.text.slice(0,40)+'"').join(", ")}`});let i=new Map;for(let p of s){let d=p.text.slice(0,50).trim().toLowerCase();d.length<=3||(i.has(d)||i.set(d,[]),i.get(d).push(p))}let r=[...i.entries()].filter(([,p])=>p.length>=3).map(([p,d])=>{let m=[...new Set(d.map(v=>v.type))],f=new Set(d.map(v=>v.counterparty).filter(Boolean)),g=new Set(d.map(v=>v.sender));return{text:p,count:d.length,types:m,counterpartyCount:f.size,senderCount:g.size,crossAccount:g.size>1,occurrences:d}}).sort((p,d)=>d.count-p.count);for(let p of r.slice(0,5)){let d=Math.min(.9,.3+p.count*.05+(p.crossAccount?.15:0));n.push(Se({module:"Memo Analysis",category:"automation",sev:"info",confidence:d,headline:`Automation Fingerprint Detected: "${p.text.slice(0,40)}" \u2014 ${Math.round(d*100)}% confidence`,detail:`Appears ${p.count} time(s) across ${p.counterpartyCount} counterpart(y/ies) and ${p.types.length} transaction type(s).`,observed:[`${p.count} occurrences`,`Transaction types: ${p.types.join(", ")}`,`Distinct counterparties: ${p.counterpartyCount}`,p.crossAccount?`Sent by ${p.senderCount} different accounts, not just this one \u2014 likely shared tooling/infrastructure rather than something unique to this wallet`:"Only sent by this account in the fetched history"],alternativeExplanations:["Standard software/bot signature (exchange withdrawal tooling, a trading bot's build tag, issuer distribution tooling)","A recurring invoice or reference code used for ordinary bookkeeping"],classification:"Repeated identical memo text is a fingerprint of shared tooling or a scripted process, not inherently suspicious on its own \u2014 useful for identifying infrastructure, bots, or coordinated actors, but needs other evidence to say which."}))}let l=[...new Set(s.filter(p=>/\bv?\d+\.\d+(\.\d+)?\b/i.test(p.text)).map(p=>p.text))];return l.length>=2&&n.push({sev:"info",label:`${l.length} distinct version-like memo tag(s) observed`,detail:`Tags: ${l.slice(0,5).join(", ")}. Consistent with an automated tool's memo tag being bumped across software versions over time.`}),n.length||n.push({sev:"ok",label:`${s.length} memo(s) found \u2014 no suspicious patterns`,detail:"Memo content looks normal."}),{signals:n,allMemos:s,scamMemos:o,repeatedMemos:r.slice(0,5).map(p=>[p.text,p.count]),fingerprints:r}}function ey(e,t,n){let s=e.filter(p=>p.LedgerEntryType==="Escrow");if(!s.length)return{signals:[],escrows:[],hasThirdParty:!1};let a=[],o=Math.floor(Date.now()/1e3),i=946684800,r=s.map(p=>{let d=p.Account||null,m=p.Destination||null,f=Number(p.Amount||0)/1e6,g=p.FinishAfter?p.FinishAfter+i:null,v=p.CancelAfter?p.CancelAfter+i:null,h=d&&d!==n&&m===n,b=d===n&&m===n,x=g?Math.ceil((g-o)/86400):null;return{creator:d,dest:m,amtXrp:f,finishAfter:g,cancelAfter:v,isThirdParty:h,isSelfEscrow:b,daysToFinish:x,conditional:!!p.Condition}}),l=r.filter(p=>p.isThirdParty),c=r.reduce((p,d)=>p+d.amtXrp,0);l.length&&a.push({sev:"warn",label:`${l.length} escrow(s) created by external account(s) \u2014 funds locked to this address`,detail:`${_(l.reduce((p,d)=>p+d.amtXrp,0),2)} XRP in escrows that an outside party controls. The creator sets the conditions. Escrows created by attackers just before a drain attempt have been observed in some compromise patterns \u2014 verify who created these.`});let u=r.filter(p=>p.daysToFinish!=null&&p.daysToFinish>=0&&p.daysToFinish<=7);return u.length&&a.push({sev:"info",label:`${u.length} escrow(s) mature within 7 days`,detail:`${_(u.reduce((p,d)=>p+d.amtXrp,0),2)} XRP will become claimable soon. If these are third-party escrows, the creator can claim funds once the condition is met.`}),a.length||a.push({sev:"ok",label:`${s.length} self-escrow(s) \u2014 ${_(c,2)} XRP locked`,detail:"All escrows appear to be self-controlled time-locks. No third-party escrow risk."}),{signals:a,escrows:r,hasThirdParty:l.length>0,totalLocked:c}}function ty(e){let t=e.filter(l=>l.LedgerEntryType==="Check");if(!t.length)return{signals:[],checks:[]};let n=[],s=946684800,a=Math.floor(Date.now()/1e3),o=t.map(l=>{let c=typeof l.SendMax=="string"?Number(l.SendMax)/1e6:null,u=typeof l.SendMax=="object"?l.SendMax:null,p=l.Expiration?l.Expiration+s:null,d=(l.ledger_index,null),m=p&&p<a;return{sender:l.Account,dest:l.Destination,amtXrp:c,amtToken:u,expiry:p,expired:m,id:l.index||""}}),i=o.filter(l=>l.amtXrp&&l.amtXrp>100),r=o.filter(l=>l.expired);return i.length&&n.push({sev:"info",label:`${i.length} large uncashed check(s) \u2014 ${_(i.reduce((l,c)=>l+(c.amtXrp||0),0),2)} XRP pending`,detail:"Open checks can be cashed by the recipient at any time before expiry. Large uncashed checks represent a future outflow commitment."}),r.length&&n.push({sev:"info",label:`${r.length} expired check(s) \u2014 should be cancelled to reclaim reserve`,detail:"Expired checks still occupy owner reserve slots (2 XRP each). Cancelling them returns the reserved XRP."}),n.length||n.push({sev:"ok",label:`${t.length} check(s) found \u2014 no unusual patterns`,detail:"Check amounts are within normal range."}),{signals:n,checks:o}}function ny(e,t){var m,f,g;if(!e||!((m=e.offers)!=null&&m.length))return{signals:[],hasData:!1};let{pair:n,offers:s}=e,a=[],o=new Map;for(let v of s){let h=v.Account,b=typeof v.TakerGets=="string"?Number(v.TakerGets)/1e6:Number(((f=v.TakerGets)==null?void 0:f.value)||0);o.set(h,(o.get(h)||0)+b)}let i=[...o.values()].reduce((v,h)=>v+h,0),r=o.get(t)||0,l=i>0?r/i:0,u=[...s].sort((v,h)=>{var k,T;let b=typeof v.TakerGets=="string"?Number(v.TakerGets)/1e6:Number(((k=v.TakerGets)==null?void 0:k.value)||0);return(typeof h.TakerGets=="string"?Number(h.TakerGets)/1e6:Number(((T=h.TakerGets)==null?void 0:T.value)||0))-b})[0],p=typeof(u==null?void 0:u.TakerGets)=="string"?Number(u.TakerGets)/1e6:Number(((g=u==null?void 0:u.TakerGets)==null?void 0:g.value)||0),d=i>0?p/i:0;return d>.4&&(u==null?void 0:u.Account)===t?a.push({sev:"critical",label:`Active wall order: this wallet controls ${(d*100).toFixed(0)}% of current book depth`,detail:`A single order from this address represents ${(d*100).toFixed(0)}% of the visible order book depth on pair ${n}. Large orders placed to make a market look deeper than it is \u2014 without intent to fill \u2014 is spoofing. This order is live right now.`}):d>.4&&a.push({sev:"warn",label:`Wall order present: ${(d*100).toFixed(0)}% of book depth in one order`,detail:`A single address controls ${(d*100).toFixed(0)}% of the current order book for pair ${n}. Wall orders dominate book depth and can be removed instantly \u2014 they create false liquidity signals.`}),l>.25&&a.push({sev:"info",label:`This wallet controls ${(l*100).toFixed(0)}% of current order book depth`,detail:`${_(r,2)} of ${_(i,2)} total book volume on pair ${n}.`}),a.length||a.push({sev:"ok",label:`Live order book looks normal (${s.length} orders, pair: ${n.split("\u2194").map(v=>v.split("+")[0]).join("\u2194")})`,detail:"No wall orders or unusual depth concentration detected in the current order book."}),{signals:a,hasData:!0,pair:n,offerCount:s.length,ourShare:l,wallShare:d}}function sy(e,t,n,s,a,o,i,r,l,c,u,p,d,m){var g,v;return[{label:"Security",pts:Math.round((100-t.score)*.4),max:40,color:"#ff5555",icon:"\u{1F510}"},{label:"Drain Risk",pts:{low:0,medium:10,high:25,critical:35}[n.riskLevel]||0,max:35,color:"#ff5555",icon:"\u26A0\uFE0F"},{label:"Wash Trading",pts:Math.min(15,Math.round((a.score||0)*.15)),max:15,color:"#ffb86c",icon:"\u{1F4CA}"},{label:"NFT Risk",pts:Math.min(15,s.flags.filter(h=>h.sev==="critical").length*8+s.flags.filter(h=>h.sev==="warn").length*3),max:15,color:"#bd93f9",icon:"\u{1F3A8}"},{label:"Benford's",pts:Math.round(Nu(o)),max:10,color:"#f1fa8c",icon:"\u{1F4D0}"},{label:"Forensic Suite",pts:Math.min(20,Math.min(8,Math.round(((r==null?void 0:r.riskPenalty)||0)*.35))+Math.min(8,Math.round(((l==null?void 0:l.riskPenalty)||0)*.4))+Math.min(8,Math.round(((c==null?void 0:c.riskPenalty)||0)*.35))+Math.min(8,Math.round(((u==null?void 0:u.riskPenalty)||0)*.35))),max:20,color:"#00d4ff",icon:"\u{1F9EC}"},{label:"Vol Conc",pts:Math.min(10,(((g=i==null?void 0:i.signals)==null?void 0:g.filter(h=>h.sev==="critical").length)||0)*6+(((v=i==null?void 0:i.signals)==null?void 0:v.filter(h=>h.sev==="warn").length)||0)*3),max:10,color:"#ffb86c",icon:"\u{1FAE7}"},{label:"Fee Spikes",pts:Math.min(5,(p==null?void 0:p.riskPenalty)||0),max:5,color:"#ffb86c",icon:"\u{1F4B8}"}].filter(h=>h.pts>0)}var Vi=["security","market-integrity","counterparty","issuer","liquidity","automation"],ay={security:"Security Risk","market-integrity":"Market Integrity Risk",counterparty:"Counterparty Risk",issuer:"Issuer Risk",liquidity:"Liquidity Risk",automation:"Automation Probability"},oy={Security:"security","Drain Risk":"security",NFT:"security","Wash Trading":"market-integrity","Benford's Law":"market-integrity","Offer/Flow Coupling":"market-integrity","Volume Concentration":"market-integrity","Shannon's Entropy":"market-integrity","Zipf's Law":"market-integrity","Time Series":"market-integrity","Live Order Book":"market-integrity","Token Issuer":"issuer","Issuer Connections":"issuer",AMM:"liquidity","Fund Flow":"counterparty","Destination Tags":"counterparty","Path Payments":"counterparty","Inbound Flow":"counterparty","Escrow Depth":"counterparty","Fee Spikes":"automation","Memo Analysis":"automation"},iy={critical:40,warn:15,info:3,ok:0};function ry(e){let t={};for(let n of Vi)t[n]={score:0,findings:[]};for(let n of e){if(n.sev==="ok"||!n.sev)continue;let s=n.category||oy[n.module]||"security";if(!t[s])continue;let a=n.confidence??.5;t[s].score+=(iy[n.sev]??0)*a,t[s].findings.push(n)}for(let n of Vi)t[n].score=Math.round(Math.min(100,t[n].score));return t}function ly(e,t,n,s,a,o,i,r,l,c,u=null){let p=0;p+=Math.round((100-e.score)*.4),p+={low:0,medium:10,high:25,critical:35}[t.riskLevel]||0;let m=n.flags.filter(g=>g.sev==="critical").length,f=n.flags.filter(g=>g.sev==="warn").length;if(p+=Math.min(15,m*8+f*3),p+=Math.min(15,Math.round(s.score*.15)),p+=Nu(a),o!=null&&o.signals){let g=o.signals.filter(h=>h.sev==="critical").length,v=o.signals.filter(h=>h.sev==="warn").length;p+=Math.min(10,g*6+v*3)}return i!=null&&i.riskPenalty&&(p+=Math.min(8,Math.round(i.riskPenalty*.35))),r!=null&&r.riskPenalty&&(p+=Math.min(8,Math.round(r.riskPenalty*.4))),l!=null&&l.riskPenalty&&(p+=Math.min(8,Math.round(l.riskPenalty*.35))),c!=null&&c.riskPenalty&&(p+=Math.min(8,Math.round(c.riskPenalty*.35))),u!=null&&u.riskPenalty&&(p+=Math.min(5,u.riskPenalty)),Math.round(Math.min(100,p))}function cy(e){var g;let t=document.getElementById("inspect-benfords-body");if(!t)return;let n=e.signals.map(Dt).join(""),s=(g=e.digitBreakdown)!=null&&g.length?`
    ...
    </p>`):o==="moderate-deviation"?(l="\u26A0",d="rgba(255,184,108,.05)",m="rgba(255,184,108,.20)",p=`<p class="benford-explain-result">
    ...
    </p>`):o==="normal"&&(l="\u2705",d="rgba(80,250,123,.04)",m="rgba(80,250,123,.15)",p=`<p class="benford-explain-result">
  ...
  `;t.innerHTML=n+a+s+f}function dy(e){var a;let t=document.getElementById("inspect-volconc-body");if(!t)return;let n=e.signals.map(Dt).join(""),s=(a=e.concentrations)!=null&&a.length?`
    ...
    </div>`}).join(""))||"";no("inspect-zipf-body",e,t.map(([a,o,i])=>`<div class="wash-stat-row" style="margin-top:${a==="Unique counterparties"?10:0}px"><span>${a}</span><span class="mono ${i||""}">${o}</span></div>`).join("")+(n?`<div style="margin-top:14px;opacity:.75;font-size:.72rem;letter-spacing:.08em;color:rgba(255,255,255,.45);margin-bottom:6px">COUNTERPARTY RANK\u2013FREQUENCY</div>${n}`:""))}function my(e){let t=[["Transactions timed",e.totalTimestamped||"\u2014"],["Active span",e.activeSpanDays!=null?e.activeSpanDays+" days":"\u2014"],["Interval CV",e.intervalCV!=null?e.intervalCV.toFixed(3):"\u2014",e.intervalCV!=null&&e.intervalCV<.5?"risk-text-high":""],["Periodicity score",e.periodicityScore!=null?(e.periodicityScore*100).toFixed(0)+"%":"\u2014",e.periodicityScore>.55?"risk-text-high":""],["Burst score (z)",e.burstScore!=null?e.burstScore.toFixed(2):"\u2014"],["Lag-1 autocorrelation",e.autocorrelation!=null?e.autocorrelation.toFixed(3):"\u2014",e.autocorrelation>.6?"risk-text-med":""],["Day-of-week entropy",e.dowEntropy!=null?e.dowEntropy.toFixed(2)+" bits":"\u2014"],["Verdict",e.verdict,e.verdict==="elevated"?"risk-text-med":""]],n=["Sun","Mon","Tue","Wed","Thu","Fri","Sat"],s=e.dowBins?Math.max(...e.dowBins,1):1,a=e.dowBins?`
    ...
    </div>`:"";no("inspect-timeseries-body",e,t.map(([o,i,r])=>`<div class="wash-stat-row" style="margin-top:${o==="Transactions timed"?10:0}px"><span>${o}</span><span class="mono ${r||""}">${i}</span></div>`).join("")+a)}function fy(e){let t=e.offerCancelCausality,n=e.inflowOutflowCausality,s=(o,i)=>{if(!(o!=null&&o.length))return"";let r=Math.max(.01,...o.map(Math.abs));return`<div style="margin-top:12px;opacity:.75;font-size:.72rem;letter-spacing:.08em;color:rgba(255,255,255,.45);margin-bottom:6px">${i}</div>
    <div style="display:flex;gap:4px;align-items:flex-end;height:40px">
      ${o.map((l,c)=>{let u=(Math.abs(l)/r*36).toFixed(0),p=l>.5?"rgba(255,85,85,.7)":l>.3?"rgba(255,184,108,.6)":"rgba(0,212,255,.3)";return`<div style="flex:1;display:flex;flex-direction:column;align-items:center;gap:3px">
          <div style="width:100%;height:${u}px;background:${p};border-radius:2px 2px 0 0;min-height:2px"></div>
          <div style="font-size:.6rem;opacity:.5">L${c}</div>
        </div>`}).join("")}
    </div>`},a=[["Time windows",e.windowCount||"\u2014"],["OfferCreate\u2194Cancel \u03C1",t?t.maxCorr.toFixed(3):"\u2014",t&&t.maxCorr>.55?"risk-text-high":""],["OC lag",t?`${t.maxLag} window${t.maxLag===1?"":"s"} (${t.maxLag*12}h)`:"\u2014"],["Inflow\u2194Outflow \u03C1",n?n.maxCorr.toFixed(3):"\u2014",n&&n.maxCorr>.65?"risk-text-high":""],["IO lag",n?`${n.maxLag} window${n.maxLag===1?"":"s"}`:"\u2014"],["Verdict",e.verdict,e.verdict==="strong-coupling"?"risk-text-high":e.verdict==="elevated"?"risk-text-med":""]];no("inspect-granger-body",e,a.map(([o,i,r])=>`<div class="wash-stat-row" style="margin-top:${o==="Time windows"?10:0}px"><span>${o}</span><span class="mono ${r||""}">${i}</span></div>`).join("")+s(t==null?void 0:t.ccf,"OFFER-CREATE \u2194 CANCEL CROSS-CORRELATION")+s(n==null?void 0:n.ccf,"INFLOW \u2194 OUTFLOW CROSS-CORRELATION"))}function hy(e,t,n,s,a){let o=document.getElementById("inspect-forensic-suite-body");if(!o)return;let i=(b,x=25)=>{if(!b||b.verdict==="insufficient")return null;if(b.chiSq!=null)return b.verdict==="high-deviation"?{val:x,cls:"risk-text-high",label:"HIGH DEVIATION"}:b.verdict==="moderate-deviation"?{val:Math.round(x*.5),cls:"risk-text-med",label:"MODERATE"}:{val:0,cls:"",label:"NORMAL"};let k=b.riskPenalty||0;return k>=18?{val:x,cls:"risk-text-high",label:"ANOMALOUS"}:k>=8?{val:Math.round(x*.5),cls:"risk-text-med",label:"ELEVATED"}:{val:0,cls:"",label:"NORMAL"}},r=[{name:"Benford's Law",icon:"\u{1F4D0}",desc:"First-digit digit distribution vs log-uniform expected",s:i(e)},{name:"Shannon's Entropy",icon:"\u{1F500}",desc:"Randomness of amounts, counterparties, time-of-day, tx types",s:i(t)},{name:"Zipf's Law",icon:"\u{1F4C8}",desc:"Counterparty rank-frequency power-law fit",s:i(n)},{name:"Time Series",icon:"\u{1F550}",desc:"Interval regularity, periodicity, burst detection, autocorrelation",s:i(s)},{name:"Offer/Flow Coupling",icon:"\u{1F517}",desc:"Cross-correlation, not causality: offer create\u2194cancel, inflow\u2194outflow",s:i(a)}],l=r.some(b=>b.s&&b.s.val>0),c=r.filter(b=>{var x;return((x=b.s)==null?void 0:x.cls)==="risk-text-high"}).length,u=r.filter(b=>{var x;return((x=b.s)==null?void 0:x.cls)==="risk-text-med"}).length,p=r.filter(b=>!b.s).length,d,m,f;c>=3?(d="STRONG MANIPULATION SIGNALS \u2014 Multiple independent engines converging on anomalous patterns.",m="#ff5555",f="\u{1F6A8}"):c>=2||c>=1&&u>=2?(d="SIGNIFICANT ANOMALIES \u2014 At least two engines detect non-organic behavior. Cross-reference with Wash Trading and Drain Risk.",m="#ff5555",f="\u26A0\uFE0F"):c>=1||u>=2?(d="ELEVATED RISK \u2014 One or more engines flag behavioral anomalies. Investigate the specific modules for detail.",m="#ffb86c",f="\u26A0\uFE0F"):!l&&p<3?(d="NO ANOMALIES \u2014 All five engines return results consistent with organic financial activity.",m="#50fa7b",f="\u2705"):(d="INSUFFICIENT DATA \u2014 More transaction history needed for a reliable multi-engine assessment.",m="rgba(255,255,255,.4)",f="\u{1F4CA}");let g=r.map(b=>{let x=!b.s,k=x?"rgba(255,255,255,.25)":b.s.val===0?"#50fa7b":b.s.cls==="risk-text-high"?"#ff5555":"#ffb86c",T=x?"NO DATA":b.s.label,S=x?0:b.s.val===0?4:b.s.cls==="risk-text-high"?100:55;return`<div style="background:rgba(255,255,255,.025);border:1px solid rgba(255,255,255,.07);border-radius:12px;padding:14px 14px 12px">
    ...
    <div class="signer-list-block">
      ...
      ${s.map(u=>`
        <div class="signer-entries">
          ${(u.SignerEntries||[]).map(p=>{var d,m;return`
            <div class="signer-entry">
              <span class="signer-addr mono">${y(((d=p.SignerEntry)==null?void 0:d.Account)||"\u2014")}</span>
              <span class="signer-weight">weight ${((m=p.SignerEntry)==null?void 0:m.SignerWeight)||1}</span>
            </div>`}).join("")}
  ...
  `,so("badge-security",e.findings)}function vy(e,t,n,s){let a=w("inspect-drain-body");if(!a)return;let o={low:"#50fa7b",medium:"#ffb86c",high:"#ff8c42",critical:"#ff5555",none:"#50fa7b"},i={low:"\u2713",medium:"\u26A0",high:"\u26A0",critical:"\u26D4",none:"\u2713"},r=e.compromiseRiskLevel??e.riskLevel,l=e.assetDrainSeverity??"none";a.innerHTML=`
  ...
  `,qy("badge-drain",e.riskLevel)}function yy(e,t){let n=w("inspect-nft-body");n&&(n.innerHTML=`
    <div class="audit-items">
    ...
    `:""}
  `,so("badge-nft",e.flags))}function wy(e){let t=Number(e.Flags||0),n=!!(t&fu.lsfTransferable),s=!!(t&fu.lsfBurnable),a=e.NFTokenTaxon||0,o=e.TransferFee?`${(e.TransferFee/1e3).toFixed(1)}%`:"0%";return`
    <div class="nft-card">
  ...
  `;let s=w("badge-wash");if(s){let a=e.verdict==="clean"||e.verdict==="low-risk"?"ok":e.verdict==="suspicious"?"warn":"crit";s.textContent=e.verdict.replace("-"," "),s.className="section-badge section-badge--"+a}}function Ys(e,t){return`<div class="wash-stat"><span class="wash-stat-label">${y(e)}</span><span class="wash-stat-val">${t}</span></div>`}function ky(e,t){let n=w("inspect-issuer-body");if(!n)return;let s=t.filter(a=>a.currency&&(a.currency.length===3||a.currency.length===40));n.innerHTML=`
    <div class="audit-items">
      ${e.signals.map(a=>Wn(a)).join("")}
    </div>
    ${s.length?`
  ...
  `,so("badge-issuer",e.signals)}function $y(e,t){let n=w("inspect-amm-body");n&&(n.innerHTML=`
    <div class="audit-items">
  ...
  `,so("badge-amm",e.signals))}function Sy(e){let t=w("trust-count-badge");t&&(t.textContent=e.length);let n=w("inspect-trust-body");n&&(n.innerHTML=e.length?e.map(s=>{let a=s.freeze?'<span class="trustline-frozen">Frozen</span>':"",o=s.freeze_peer?'<span class="trustline-frozen trustline-frozen--peer">Issuer Frozen</span>':"",i=s.no_ripple?'<span class="trustline-norip">NoRipple</span>':"";return`
          <div class="trustline-row">
          ...
          </div>`}).join(""):'<div class="inspect-empty-note">No transactions found.</div>',e.length>s&&(n.innerHTML+=`<div class="tx-more">Showing ${s} of ${e.length} transactions</div>`)}function Ru(e,t,n){let s=Number((n==null?void 0:n.totalIn)||0),a=Number((t==null?void 0:t.totalOut)||0),o=Number(e||0);if(s<=0&&a<=0)return'<div class="inspect-empty-note">No inbound or outbound XRP flow found in the analysed transaction history.</div>';let i=new Set(((t==null?void 0:t.blackHoleDests)||[]).map(k=>k.addr)),r=new Set(((t==null?void 0:t.exchangeDests)||[]).map(k=>k.addr)),l=new Set(((t==null?void 0:t.newWalletDests)||[]).map(k=>k.addr)),c=0,u=0,p=0,d=0;for(let k of(t==null?void 0:t.destinations)||[])i.has(k.addr)?c+=k.totalXrp:r.has(k.addr)?u+=k.totalXrp:l.has(k.addr)?p+=k.totalXrp:d+=k.totalXrp;let m=Math.max(s,a,o,1),f=k=>(k>0?Math.max(1.5,k/m*100):0).toFixed(1),g=[{label:"Black hole",xrp:c,color:yn.blackhole},{label:"Exchange",xrp:u,color:yn.exchange},{label:"New wallet",xrp:p,color:yn.newWallet},{label:"Other",xrp:d,color:yn.other}].filter(k=>k.xrp>0),v=a>0?Math.max(1.5,a/m*100):0,h=g.map(k=>`<div style="width:${(a>0?k.xrp/a*100:0).toFixed(1)}%;background:${k.color};height:100%" title="${y(k.label)}: ${_(k.xrp,2)} XRP"></div>`).join(""),b=(k,T,S,$,E)=>`
          ...
          <div class="flow-dest-row">
            ...
            <div class="flow-dest-info">
              ...
              <div class="flow-bar-row">
                <div class="flow-dest-bar"><div class="flow-dest-fill" style="width:${Math.min(100,p).toFixed(1)}%;background:${((h=c.entity)==null?void 0:h.type)==="exchange"?"#00d4ff":((b=c.entity)==null?void 0:b.type)==="blackhole"?"#ff5555":"rgba(80,250,123,.7)"}"></div></div>
                <span class="mono flow-dest-pct">${p.toFixed(0)}%</span>
              </div>
              <div class="flow-dest-meta">
                <span class="mono">${_(c.totalXrp,2)} XRP</span>
                <span class="flow-dest-cnt">${c.txCount} tx</span>
                ${c.txCount>1?`<span class="flow-dest-span">${_u(c.firstSeen,c.lastSeen)}</span>`:""}
              </div>
            </div>
          </div>`}).join("")}
    </div>
    ...
    <div class="flow-timeline">
      ${e.timeline.map(c=>{let u=new Date(c.ts*1e3).toLocaleDateString(),p=new Date(c.ts*1e3).toLocaleTimeString([],{hour:"2-digit",minute:"2-digit"}),d=c.amtXrp>0?`${_(c.amtXrp,2)} XRP`:c.amtToken?`${_(c.amtToken.value,2)} ${c.amtToken.currency}`:"\u2014",m=zn(c.dest),f=m?`<span class="flow-entity-badge flow-entity--${m.type}" style="font-size:.65rem">${y(m.name)}</span>`:"";return`
          <div class="flow-tx-row">
            <span class="flow-tx-date">${u} ${p}</span>
  ...
  `,a){let c=e.blackHoleDests.length||e.exchangeDests.length>2;a.textContent=`${e.uniqueDests} dests`,a.className=`section-badge section-badge--${c?"crit":e.uniqueDests>0?"warn":"ok"}`}}function _u(e,t){if(!e||!t)return"";let n=new Date(e*1e3).toLocaleDateString(),s=new Date(t*1e3).toLocaleDateString();return n===s?n:`${n} \u2013 ${s}`}function Py(e,t){let n=w("inspect-issuer-connections-body");if(!n)return;let s=e.totalIssued,a=w("badge-issuer-connections");if(n.innerHTML=`
    <div class="audit-items">
  ...
  `,a){let o=e.signals.some(i=>i.sev==="critical")?"crit":e.signals.some(i=>i.sev==="warn")?"warn":e.signals.some(i=>i.sev==="info")?"neutral":"ok";a.className=`section-badge section-badge--${o}`,a.textContent=s>0?`${e.holderCount} holders`:"No issuance"}}function My(e){var c;let t=document.getElementById("inspect-fee-analysis-body");if(!t||!e)return;let n=(e.signals||[]).map(Dt).join(""),s=e.avgFeeMultiplier!=null?`
    ...
    ${e.tagProfiles.slice(0,8).map(p=>`
      ...
      </div>`).join("")}`:"",a=document.getElementById("section-desttag"),o=(e.signals||[]).some(p=>p.sev==="warn"||p.sev==="critical"),i=((u=e.tagProfiles)==null?void 0:u.length)>0;a&&(a.style.display="");let r=!o&&!i?`
    <div class="finding finding--ok">
      <span class="finding-sev sev-ok">OK</span>
      <div class="finding-body">
    ...
    ${e.selfRoutedCount?`<div class="wash-stat-row"><span>Self-routed payments</span><span class="mono risk-text-high">${e.selfRoutedCount}</span></div>`:""}`;if(n.innerHTML=a+o,s){let r=e.signals.some(c=>c.sev==="critical"),l=e.signals.some(c=>c.sev==="warn");s.textContent=r?"Critical":l?"Check":"Normal",s.className=`section-badge section-badge--${r?"crit":l?"warn":"ok"}`}}function Ey(e){var i,r,l;let t=w("inspect-inbound-body");if(!t)return;let n=(e.signals||[]).map(Dt).join(""),s=`
    ...
    <div class="flow-dest-list">
      ${e.topSources.map((c,u)=>{let p=e.totalIn>0?(c.totalXrp/e.totalIn*100).toFixed(0):0,d=c.entity,m=d?`<span class="flow-entity-badge flow-entity--${d.type}">${y(d.name)}</span>`:"";return`<div class="flow-dest-row">
          ...
          <div class="flow-dest-info">
            ...
            <div class="flow-bar-row">
              <div class="flow-dest-bar"><div class="flow-dest-fill" style="width:${Math.min(100,p)}%;background:${(d==null?void 0:d.type)==="exchange"?"#00d4ff":"rgba(80,250,123,.7)"}"></div></div>
    ...
    </div>`}).join("");n.innerHTML=s+`<div style="margin-top:10px">${a}</div>`;let o=w("badge-checks");o&&(o.textContent=`${e.checks.length} check${e.checks.length!==1?"s":""}`,o.className="section-badge section-badge--neutral")}function Dy(e){let t=w("section-livebook"),n=w("inspect-livebook-body");if(t&&(t.style.display=""),!n)return;if(!(e!=null&&e.hasData)){n.innerHTML='<div class="inspect-empty-note">No live order book activity found for this wallet.</div>';let i=w("badge-livebook");i&&(i.textContent="None",i.className="section-badge section-badge--neutral");return}let s=(e.signals||[]).map(Dt).join(""),a=`
    <div class="wash-stat-row" style="margin-top:10px">
    ...
    ${e.wallShare>.3?`<div class="wash-stat-row"><span>Largest single order share</span><span class="mono ${e.wallShare>.4?"risk-text-high":"risk-text-med"}">${(e.wallShare*100).toFixed(1)}%</span></div>`:""}`;n.innerHTML=s+a;let o=w("badge-livebook");if(o){let i=(e.signals||[]).some(l=>l.sev==="critical"),r=(e.signals||[]).some(l=>l.sev==="warn");o.textContent=i?"Wall order":r?"Check":"Normal",o.className=`section-badge section-badge--${i?"crit":r?"warn":"ok"}`}}function Iy(e,...t){let n=w("inspect-risk-breakdown");if(!n)return;let s=sy(e,...t);if(!s.length){n.innerHTML="";return}let a=Math.max(1,s.reduce((o,i)=>o+i.pts,0));n.innerHTML=`
    ...
    </div>`}function Wn({sev:e,label:t,detail:n,confidence:s,observed:a,alternativeExplanations:o,evidenceAgainstBenign:i,classification:r}){let l={ok:"\u2713",info:"\u2139",warn:"\u26A0",critical:"\u26D4"},c=(u,p)=>p&&p.length?`<div class="audit-evidence-group">
         <div class="audit-evidence-title">${y(u)}</div>
         <ul class="audit-evidence-list">${p.map(d=>`<li>${y(d)}</li>`).join("")}</ul>
       </div>`:"";return`
    ...
    </div>`).join(""),Ce={critical:"rgba(255,85,85,.08)",warn:"rgba(255,184,108,.06)",info:"rgba(120,180,255,.05)",ok:"rgba(80,250,123,.05)"},Je={critical:"rgba(255,85,85,.25)",warn:"rgba(255,184,108,.20)",info:"rgba(120,180,255,.15)",ok:"rgba(80,250,123,.15)"},$e=[];(o.riskLevel==="critical"||o.riskLevel==="high")&&$e.push({icon:"\u{1F534}",sev:"critical",text:"If this is your wallet: stop sending funds here immediately. The account's security keys match a known drain attack pattern. Contact a security professional or the XRPL community before taking any action."}),($r=d.newWalletDests)!=null&&$r.length&&$e.push({icon:"\u26A0\uFE0F",sev:"critical",text:`${d.newWalletDests.length} brand-new wallet(s) received large XRP transfers. This is a classic drain pattern. If this was unexpected, the funds have likely already been moved further down the chain.`}),(Sr=d.blackHoleDests)!=null&&Sr.length&&$e.push({icon:"\u26D4",sev:"critical",text:"Funds sent to black hole addresses are gone permanently. No exchange, no support team, and no legal action can retrieve them."}),(Tr=d.exchangeDests)!=null&&Tr.length&&$e.push({icon:"\u{1F4B1}",sev:"warn",text:`If this was a drain: contact ${[...new Set(d.exchangeDests.map(A=>A.entity.name))].join(", ")} exchange support immediately with the transaction hashes from the Fund Flow section. Act within hours \u2014 exchanges can sometimes freeze funds quickly but not after they've been withdrawn.`}),r.score>=60&&$e.push({icon:"\u{1F4CA}",sev:"warn",text:"Significant wash trading signals detected. If you're a market maker: high cancel ratios are normal for your role \u2014 review the self-trade and self-routing signals specifically. If you're a token holder or researcher: this pattern suggests the token's apparent volume may be artificial."}),(S==null?void 0:S.selfRoutedCount)>0&&$e.push({icon:"\u{1F504}",sev:"warn",text:`${S.selfRoutedCount} path payment(s) routed XRP from and back to the same address through the DEX. This creates artificial trading volume on every intermediate pair. Check the Path Payments section for specific transaction hashes.`}),(Cr=m.mirrorGroups)!=null&&Cr.length&&$e.push({icon:"\u{1F578}",sev:"warn",text:"Mirror wallet clusters found. If you are the issuer, determine whether these are genuine holders or insider accounts used to create the appearance of broader distribution. These wallets could coordinate a sell-off."}),(Pr=i.flags)!=null&&Pr.some(A=>A.sev==="critical")&&$e.push({icon:"\u{1F3A8}",sev:"critical",text:"Zero-value NFT offer detected. If you didn't intentionally list your NFT for free: identify what website or app you used around the time this transaction was signed, and revoke any approvals it has."}),(k==null?void 0:k.verdict)==="elevated"&&$e.push({icon:"\u{1F4B8}",sev:"info",text:`${k.spikeCount} transactions paid >100\xD7 normal fees. Check the Fee Spikes section to see if these align with moments of concentrated trading \u2014 elevated fees often mark coordinated activity windows.`}),$e.length===0&&$e.push({icon:"\u2705",sev:"ok",text:"No immediate actions required. The account shows no identifiable red flags. Continue monitoring as activity grows \u2014 some patterns only become statistically significant with more data."});let Ct=$e.map(A=>`
    <div style="background:${Ce[A.sev]||Ce.info};border:1px solid ${Je[A.sev]||Je.info};border-radius:10px;padding:12px 14px;margin-bottom:8px;display:flex;gap:12px;align-items:flex-start">
    ...
    <div class="report-wrap">
      ...
      <div class="report-section">
        ...
        <div style="margin-bottom:16px">${h0(f,e)}</div>
        ${Ru(n,d,E)}
      </div>
  ...
  `}function Hy(e,...t){e.innerHTML=Xy(...t)}function zy(){let e=document.getElementById("tab-inspector");e&&(e.querySelector("[data-inspector-v2]")||(e.innerHTML=`
    <style>
  ...
  `))}function Wy(){if(document.getElementById("inspector-nav"))return;let e=document.createElement("nav");e.id="inspector-nav",e.setAttribute("aria-label","Inspector navigation"),e.innerHTML=`
  ...
  `;let t=document.getElementById("tab-inspector");t&&t.appendChild(e)}function jy(){if(document.getElementById("inspector-howto"))return;let e=document.createElement("div");e.id="inspector-howto",e.className="howto-overlay",e.style.display="none",e.innerHTML=`
  ...
  `).join(""))}function e0(){let e=document.getElementById("isd-cap-grid");e&&(e.innerHTML=Yy.map(t=>`
  ...
  `).join(""))}function er(){let e=document.getElementById("isd-wallets-section"),t=document.getElementById("isd-wallet-list");if(!e||!t)return;let n=ge(Q(Ky))||[];if(!n.length){e.style.display="none";return}e.style.display="",t.innerHTML=n.map(s=>{let a=s.color||"#50fa7b",o=s.emoji||"\u{1F48E}",i=s.label||"Wallet",r=s.address||"",l=r?r.slice(0,8)+"\u2026"+r.slice(-6):"\u2014",c=s.testnet?'<span class="isd-wallet-testnet">TESTNET</span>':"";return`
    ...
    `}).join("")}function tr(){let e=document.getElementById("isd-recent-section"),t=document.getElementById("isd-recent-list");if(!e||!t)return;let n=ao();if(!n.length){e.style.display="none";return}e.style.display="",t.innerHTML=n.map((s,a)=>{let o=s.addr?s.addr.slice(0,10)+"\u2026"+s.addr.slice(-8):"\u2014",i=s.riskScore!=null?`<span class="isd-risk-pill isd-risk-pill--${Ou(s.riskScore)}">${s.riskScore}</span>`:"";return`
      <button class="isd-recent-row" onclick="inspectorLoadAddr('${y(s.addr)}')" type="button">
        ...
        <div class="isd-recent-right">
          ${i}
          <span class="isd-recent-time">${oo(s.ts)}</span>
        </div>
      </button>
    `}).join("")}function t0(){to(),window.addEventListener("xrpl-ledger",n0),window.addEventListener("xrpl-connection",to)}function n0(e){eo()&&to(e.detail)}var ji=null;function s0(){return ji||(ji={idx:document.getElementById("isd-ledger-idx"),age:document.getElementById("isd-ledger-age"),tps:document.getElementById("isd-tps"),tpsTrnd:document.getElementById("isd-tps-trend"),fee:document.getElementById("isd-fee"),feeLv:document.getElementById("isd-fee-level"),close:document.getElementById("isd-close-time"),dot:document.getElementById("isd-conn-dot"),connLbl:document.getElementById("isd-conn-label"),pill:document.getElementById("isd-conn-pill"),domTx:document.getElementById("isd-dom-tx"),domPct:document.getElementById("isd-dom-pct"),bar:document.getElementById("isd-fee-bar"),barLbl:document.getElementById("isd-fee-bar-label")})}function to(){let{idx:e,age:t,tps:n,tpsTrnd:s,fee:a,feeLv:o,close:i,dot:r,connLbl:l,pill:c,domTx:u,domPct:p,bar:d,barLbl:m}=s0(),f=X.connectionState||"disconnected",g={connected:{label:"Connected",cls:"conn--live"},connecting:{label:"Connecting\u2026",cls:"conn--warn"},disconnected:{label:"Disconnected",cls:"conn--dead"}},v=g[f]||g.disconnected;r&&(r.className="isd-conn-dot"),l&&(l.textContent=v.label),c&&(c.className=`isd-conn-pill ${v.cls}`);let h=X.ledgerLog||[];if(h.length&&e){let S=h[0];if(e.textContent=Number(S.ledgerIndex||0).toLocaleString(),t&&(t.textContent=S.closeTimeSec!=="\u2014"?S.closeTimeSec+"s close":"\u2014"),i){let $=parseFloat(S.closeTimeSec);i.textContent=isNaN($)?"\u2014":$.toFixed(1)}}let b=X.tpsHistory||[];if(b.length&&n){let S=b.slice(-5),$=S.reduce((E,C)=>E+C,0)/S.length;if(n.textContent=$.toFixed(1),s&&b.length>=6){let E=b.slice(-10,-5),C=E.reduce((R,O)=>R+O,0)/E.length,P=$-C;s.textContent=P>.5?"\u2191 rising":P<-.5?"\u2193 falling":"\u2192 stable",s.className=`isd-metric-sub ${P>.5?"isd-up":P<-.5?"isd-down":""}`}}let x=X.feeHistory||[];if(x.length&&a){let S=x.slice(-5),$=S.reduce((P,R)=>P+R,0)/S.length,E=$/1e6;a.textContent=$<5e3?$.toFixed(0)+" drops":E.toFixed(5)+" XRP";let C=$<20?{lbl:"Low",cls:"fee-low",pct:10}:$<100?{lbl:"Normal",cls:"fee-normal",pct:28}:$<500?{lbl:"Elevated",cls:"fee-elevated",pct:60}:$<2e3?{lbl:"High",cls:"fee-high",pct:82}:{lbl:"Congested",cls:"fee-congest",pct:100};o&&(o.textContent=C.lbl,o.className=`isd-metric-sub ${C.cls}`),d&&(d.style.width=C.pct+"%",d.className=`isd-fee-bar-fill ${C.cls}`),m&&(m.textContent=C.lbl,m.className=`isd-fee-bar-level ${C.cls}`)}let k=X.txMixAccum||{},T=Object.entries(k).filter(([,S])=>S>0).sort(([,S],[,$])=>$-S);if(T.length&&u){let S=T.reduce((C,[,P])=>C+P,0),[$,E]=T[0];u.textContent=$,p&&(p.textContent=(E/S*100).toFixed(0)+"% of traffic")}}window.exportTxCSV=function(e){var l,c;if(!e||!e.length){alert("No transaction data to export. Run an inspection first.");return}let t=946684800,s=[["Hash","Date","Type","Account","Destination","Amount_XRP","Amount_Token","Currency","Fee_Drops","DestinationTag","Result","LedgerIndex"],...e.map(({tx:u,meta:p})=>{var h,b;let d=u.date?new Date((u.date+t)*1e3).toISOString():"",m=typeof u.Amount=="string"?(Number(u.Amount)/1e6).toFixed(6):"",f=(h=u.Amount)!=null&&h.value?u.Amount.value:"",g=((b=u.Amount)==null?void 0:b.currency)||(typeof u.Amount=="string"?"XRP":""),v=(p==null?void 0:p.TransactionResult)||"";return[u.hash||"",d,u.TransactionType||"",u.Account||"",u.Destination||"",m,f,g,u.Fee||"",u.DestinationTag??"",v,u.ledger_index||""]})].map(u=>u.map(p=>{let d=String(p);return d.includes(",")||d.includes('"')||d.includes(`
`)?'"'+d.replace(/"/g,'""')+'"':d}).join(",")).join(`
`),a=new Blob([s],{type:"text/csv;charset=utf-8;"}),o=URL.createObjectURL(a),i=document.createElement("a"),r=((c=(l=document.getElementById("inspect-addr-badge"))==null?void 0:l.dataset)==null?void 0:c.fullAddr)||"wallet";i.href=o,i.download=`naluxrp_${r.slice(0,10)}_${new Date().toISOString().slice(0,10)}.csv`,document.body.appendChild(i),i.click(),document.body.removeChild(i),URL.revokeObjectURL(o)};function a0(e,t){let s=ao().find(o=>o.addr===e);if(!s||s.riskScore==null||t==null)return null;let a=t-s.riskScore;return{prev:s.riskScore,curr:t,diff:a,ts:s.ts}}function o0(e,t){let n=a0(e,t);if(!n||Math.abs(n.diff)<2)return;let s=document.getElementById("inspect-risk-score");if(!s)return;let a=n.diff>0?`<span style="color:#ff5555;font-size:.7rem;font-weight:700"> \u2191${n.diff}</span>`:`<span style="color:#50fa7b;font-size:.7rem;font-weight:700"> \u2193${Math.abs(n.diff)}</span>`,o=oo(n.ts);s.insertAdjacentHTML("afterend",`<span class="risk-score-diff" title="Changed from ${n.prev} \u2192 ${n.curr} since ${o}">${a} vs ${o}</span>`)}window._inspectMaxTx||(window._inspectMaxTx=5e3);window._debugBalanceDeltas=Su;window._debugOfferLifecycles=Eu;window._debugReconstructBalanceHistory=Tu;window._debugFindDrainEpisodes=Cu;window._debugDrainRisk=Au;window.inspectorLoadAddr=function(e){let t=w("inspect-addr");t&&(t.value=e),xs()};window.inspectWalletAddr=function(e){var n,s;window.inspectorLoadAddr(e);let t=document.querySelector('[data-tab="inspector"]');t&&((n=window.switchTab)==null||n.call(window,t,"inspector")),(s=window.showDashboard)==null||s.call(window)};window.printInspectorReport=function(){var s,a;let e=document.getElementById("inspect-report-body");if(!e)return;let t=((a=(s=document.getElementById("inspect-addr-badge"))==null?void 0:s.dataset)==null?void 0:a.fullAddr)||"wallet",n=window.open("","_blank","width=900,height=700");n.document.write(`<!DOCTYPE html><html><head>
    ...
    ${e.innerHTML}
  </body></html>`),n.document.close()};window.exportInspectorReport=function(){var n;let e=document.getElementById("inspect-report-body");if(!e)return;let t=e.innerText||e.textContent||"";(n=navigator.clipboard)==null||n.writeText(t).then(()=>{let s=document.getElementById("report-export-btn");s&&(s.textContent="\u2713 Copied!",setTimeout(()=>{s.textContent="\u{1F4CB} Copy Report"},2e3))}).catch(()=>{let s=document.createRange();s.selectNodeContents(e);let a=window.getSelection();a.removeAllRanges(),a.addRange(s)})};window.inspectorClearHistory=function(){bt(Zi);let e=document.getElementById("isd-recent-section");e&&(e.style.display="none")};window.inspectorClearWatchlist=function(){bt(ea),na()};function ao(){return ge(Q(Zi))||[]}function i0(e,t,n=[]){let s=ao();s=s.filter(o=>o.addr!==e);let a=n.filter(o=>o.sev==="critical"||o.sev==="warn").map(o=>o.module+":"+o.headline.slice(0,40)).sort().join("|");s.unshift({addr:e,riskScore:t,ts:Date.now(),fingerprint:a}),s=s.slice(0,12),Z(Zi,JSON.stringify(s))}function ta(){return ge(Q(ea))||[]}function r0(e,t){let n=ta().filter(s=>s.addr!==e);n.unshift({addr:e,label:t||z(e),addedTs:Date.now(),lastScore:null,lastTs:null}),Z(ea,JSON.stringify(n.slice(0,50)))}function Fu(e){Z(ea,JSON.stringify(ta().filter(t=>t.addr!==e)))}function Ji(e){return ta().some(t=>t.addr===e)}function l0(e,t){let n=ta().map(s=>s.addr===e?{...s,lastScore:t,lastTs:Date.now()}:s);Z(ea,JSON.stringify(n))}function oo(e){let t=Date.now()-e;return t<6e4?"just now":t<36e5?Math.floor(t/6e4)+"m ago":t<864e5?Math.floor(t/36e5)+"h ago":Math.floor(t/864e5)+"d ago"}function Ou(e){return Gi(e).replace("risk-","")}var en=!1;function Bu(){en=localStorage.getItem(Iu)==="true",nr()}function nr(){let e=document.getElementById("inspect-result");if(!e)return;e.classList.toggle("mode-advanced",en),e.classList.toggle("mode-simple",!en);let t=document.getElementById("analyst-mode-btn");t&&(t.textContent=en?"\u2697 Advanced":"\u{1F441} Simple",t.title=en?"Switch to Simple view":"Switch to Advanced (analyst) view",t.setAttribute("aria-pressed",String(en)))}window.toggleAnalystMode=function(){en=!en,localStorage.setItem(Iu,en),nr()};var c0=new Set(["section-overview","section-report"]),d0=new Set(["section-security","section-drain","section-fundflow","section-inbound"]);function p0(){let e=document.getElementById("inspect-result");if(!e)return;let t=[...e.querySelectorAll(".inspector-section")],n={crit:0,warn:1,neutral:2,ok:3,"":4},s=t.filter(i=>!c0.has(i.id)&&!d0.has(i.id));s.sort((i,r)=>{let l=c=>{let u=c.querySelector(".section-badge");if(!u)return"";let p=u.className;return p.includes("crit")?"crit":p.includes("warn")?"warn":p.includes("neutral")?"neutral":p.includes("ok")?"ok":""};return(n[l(i)]??4)-(n[l(r)]??4)});let a=document.getElementById("section-inbound")||document.getElementById("section-drain");if(!a)return;let o=a;for(let i of s)o.after(i),o=i}function u0(e){let t=(e||[]).filter(s=>s.confidence!=null);if(!t.length)return null;let n=t.reduce((s,a)=>s+a.confidence,0)/t.length;return n>=.7?"Strong":n>=.4?"Moderate":"Weak"}function m0(e,t,n,s,a={},o=!1,i=null){let r=document.getElementById("quick-verdict-body");if(!r)return;let l=t.filter(E=>E.sev==="critical"),c=t.filter(E=>E.sev==="warn"),u=e<20?"#50fa7b":e<45?"#ffb86c":e<70?"#ff8c42":"#ff5555",p=e<20?"Low Risk":e<45?"Moderate":e<70?"High Risk":"Critical",d=(E,C)=>(C.confidence??.5)-(E.confidence??.5),m=[...l].sort(d),f=[...c].sort(d),g="",v="";if(l.length===0&&c.length===0)g=`No elevated signals found across ${s.toLocaleString()} transactions${n!=null?` and ${n} days of history`:""}.`,v="This wallet appears to operate within normal parameters.";else{let E=m.slice(0,2).map(P=>P.headline).join("; "),C=f.slice(0,2).map(P=>P.headline).join("; ");g=l.length?`${l.length} critical issue${l.length>1?"s":""}: ${E}.`:`${c.length} warning${c.length>1?"s":""}: ${C}.`,v=l.length?"Review the highlighted sections below. Scroll to the Report for full recommendations.":"Review the flagged sections below for context before drawing conclusions."}let h=Vi.map(E=>({cat:E,...a[E]})).filter(E=>E.score>0).sort((E,C)=>C.score-E.score),b=E=>E<20?"#50fa7b":E<45?"#ffb86c":E<70?"#ff8c42":"#ff5555",x={Strong:"#50fa7b",Moderate:"#ffb86c",Weak:"#ff8c42"},k=h.length?`
    <div style="margin-top:10px;padding-top:10px;border-top:1px solid rgba(255,255,255,.06)">
      ...
      <div style="display:flex;flex-direction:column;gap:4px">
        ${h.map(E=>{let C=u0(E.findings);return`
          <div style="display:flex;align-items:center;gap:8px;font-size:.76rem">
            <span style="width:150px;color:rgba(255,255,255,.6);flex-shrink:0">${y(ay[E.cat])}</span>
    ...
    <div style="display:flex;align-items:flex-start;gap:16px;flex-wrap:wrap">
      <div style="text-align:center;flex-shrink:0">
        ...
        <div style="font-size:.65rem;font-weight:800;color:${u};letter-spacing:.1em;text-transform:uppercase">${p}</div>
      </div>
    ...
    ${k}
    ${$}`}function f0(e,t){let n=document.getElementById("change-banner");if(!n)return;n.style.display="none";let a=ao().find(p=>p.addr===e);if(!(a!=null&&a.fingerprint))return;let o=new Set(t.filter(p=>p.sev==="critical"||p.sev==="warn").map(p=>p.module+":"+p.headline.slice(0,40))),i=new Set((a.fingerprint||"").split("|").filter(Boolean)),r=[...o].filter(p=>!i.has(p)),l=[...i].filter(p=>!o.has(p));if(!r.length&&!l.length)return;let c=oo(a.ts),u=[];r.length&&u.push(`<span style="color:#ff5555">+${r.length} new finding${r.length>1?"s":""}</span>`),l.length&&u.push(`<span style="color:#50fa7b">${l.length} resolved</span>`),n.style.display="",n.innerHTML=`
    <div style="background:rgba(255,184,108,.07);border:1px solid rgba(255,184,108,.25);border-radius:10px;
      ...
      <span style="font-size:.84rem;color:rgba(255,255,255,.75)">
        ...
        ${r.length?"\u2014 "+r.slice(0,2).map(p=>p.split(":")[1]).join("; "):""}
      </span>
    ...
    </div>`}function na(){let e=document.getElementById("isd-watchlist-section"),t=document.getElementById("isd-watchlist-list");if(!e||!t)return;let n=ta();if(!n.length){e.style.display="none";return}e.style.display="",t.innerHTML=n.map(s=>{let a=s.addr.slice(0,8)+"\u2026"+s.addr.slice(-6),o=s.lastScore!=null?`<span class="isd-risk-pill isd-risk-pill--${Ou(s.lastScore)}">${s.lastScore}</span>`:"",i=s.lastTs?oo(s.lastTs):"never checked";return`
    ...
    <div style="overflow-x:auto;padding-bottom:4px">
      <svg width="${d}" height="${p}" xmlns="http://www.w3.org/2000/svg" style="display:block;min-width:${d}px">
        ${r.map(([,f],g)=>{var k;let v=Math.max(2,Math.round(f.count/l*p)),h=p-v,b=((k=Object.entries(f.types).sort((T,S)=>S[1]-T[1])[0])==null?void 0:k[0])||"Other",x=a[b]||o;return`<rect x="${g*(c+u)}" y="${h}" width="${c}" height="${v}"
    ...
    <div style="display:flex;gap:8px;flex-wrap:wrap;margin-top:5px">
    ...
    </div>`}function Hu(e,t){let n=new Map;for(let{tx:s,meta:a}of e){let o=s.Account===t,i=s.Destination===t;if(!o&&!i)continue;let r=o?s.Destination:s.Account;if(!r||r===t)continue;let l=jn(s);n.has(r)||n.set(r,{cnt:0,xrpOut:0,xrpIn:0,entity:zn(r),firstSeen:l,lastSeen:l});let c=n.get(r);c.cnt++,l&&(c.firstSeen=c.firstSeen?Math.min(c.firstSeen,l):l,c.lastSeen=Math.max(c.lastSeen,l));let u=(a==null?void 0:a.delivered_amount)||s.Amount,p=typeof u=="string"?Number(u)/1e6:0;o?c.xrpOut+=p:c.xrpIn+=p}return n}function h0(e,t,n=15){let s=Hu(e,t),a=[...s.entries()].sort((r,l)=>l[1].xrpOut+l[1].xrpIn-(r[1].xrpOut+r[1].xrpIn)||l[1].cnt-r[1].cnt).slice(0,n);if(!a.length)return'<div class="inspect-empty-note">No counterparty interactions found.</div>';let o=Math.max(...a.map(([,r])=>r.xrpOut+r.xrpIn),1),i=a.map(([r,l],c)=>{var h;let u=l.xrpOut+l.xrpIn,p=Math.max(1.5,u/o*100),d=yn[(h=l.entity)==null?void 0:h.type]||yn.other,m=u>0?l.xrpOut/u:.5,f=m>.65?"\u2192 out":m<.35?"\u2190 in":"\u21C4 both",g=l.entity?`<span style="font-size:.64rem;color:${d};border:1px solid ${d};border-radius:999px;padding:1px 7px;margin-left:6px">${y(l.entity.name)}</span>`:"",v=_u(l.firstSeen,l.lastSeen);return`
      <div style="display:flex;align-items:center;gap:10px;padding:6px 0;border-bottom:1px solid rgba(255,255,255,.05)">
        ...
        <div style="flex:1;height:10px;border-radius:4px;overflow:hidden;background:rgba(255,255,255,.05)">
          <div style="width:${p.toFixed(1)}%;height:100%;background:${d}"></div>
        </div>
    ...
    ${i}`}function g0(e,t,n,s,a="inspect-network-map"){let o=document.getElementById(a);if(!o)return;let r=[...Hu(e,t).entries()].sort(($,E)=>E[1].xrpOut+E[1].xrpIn-($[1].xrpOut+$[1].xrpIn)||E[1].cnt-$[1].cnt).slice(0,20);if(r.length<2){o.style.display="",o.innerHTML=`<div class="inspect-empty-note">${r.length===0?"No counterparty interactions found.":"Only one counterparty found \u2014 not enough to chart a network map."}</div>`;return}o.style.display="";let l=560,c=340,u=l/2,p=c/2,d=95,m=7,f=155,g=13,v=r[0][1].xrpOut+r[0][1].xrpIn||1,h=r[0][1].cnt||1,b=[{id:t,x:u,y:p,r:13,main:!0,label:z(t),color:"#00d4ff",xrpOut:0,xrpIn:0,cnt:0}];r.forEach(([$,E],C)=>{let P=C<m?d:f,R=C<m?m:g,D=(C<m?C:C-m)/R*2*Math.PI-Math.PI/2,I=E.xrpOut+E.xrpIn,F=Math.max(5,Math.min(14,4+I/v*10)),H=E.entity,N=yn[H==null?void 0:H.type]||yn.other,W=I>0?E.xrpOut/I:.5,se=W>.65?"out":W<.35?"in":"both";b.push({id:$,x:u+P*Math.cos(D),y:p+P*Math.sin(D),r:F,color:N,label:(H==null?void 0:H.name)||z($),ent:H,xrpOut:E.xrpOut,xrpIn:E.xrpIn,cnt:E.cnt,dir:se,vol:I,ring:P})});let x=`<defs>
  ...
  </defs>`,k=b.slice(1).map($=>{let E=$.vol/v,C=Math.max(.8,E*3),P=.12+E*.45,R=$.dir==="out"?"rgba(80,250,123,":$.dir==="in"?"rgba(0,212,255,":"rgba(255,184,108,",O=$.dir==="out"?`rgba(80,250,123,${P})`:$.dir==="in"?`rgba(0,212,255,${P})`:`rgba(255,184,108,${P})`,D=$.dir==="in"?"5,3":"none",I=`marker-end="url(#arrow-${$.dir})"`,F=$.x-u,H=$.y-p,N=Math.sqrt(F*F+H*H),W=($.r+2)/N,se=u+F*(1-W),re=p+H*(1-W),pe=`${$.xrpOut>0?"\u2192 "+_($.xrpOut,2)+" XRP out":""}${$.xrpIn>0?($.xrpOut>0?" / ":"")+"\u2190 "+_($.xrpIn,2)+" XRP in":""}, ${$.cnt} tx`;return`<line x1="${u}" y1="${p}" x2="${se.toFixed(1)}" y2="${re.toFixed(1)}"
      stroke="${O}" stroke-width="${C.toFixed(1)}" stroke-dasharray="${D}" ${I}>
      <title>${pe}</title></line>`}).join(""),T=b.map($=>{var H,N;if($.main){let W=z($.id);return`<g>
        <title>Inspected account: ${y($.id)}</title>
        <circle cx="${u}" cy="${p}" r="13" fill="rgba(0,212,255,.2)" stroke="#00d4ff" stroke-width="2"/>
        <circle cx="${u}" cy="${p}" r="13" fill="rgba(0,212,255,.15)"/>
        <text x="${u}" y="${p+4}" text-anchor="middle" font-size="6.5" fill="#00d4ff" font-weight="800">${y(W)}</text>
        <text x="${u}" y="${p+13+10}" text-anchor="middle" font-size="6"
    ...
    <text x="${u}" y="${p-d-8}" text-anchor="middle" font-size="6"
      fill="rgba(255,255,255,.15)" font-style="italic">inner ring</text>
    <text x="${u}" y="${p-f-8}" text-anchor="middle" font-size="6"
    ...
    </div>`}function b0(){let e=window._lastInspectResult,t=window._lastAllFindings||[];if(!e)return null;let n=t.length?t.map(a=>`- [${a.sev.toUpperCase()}] ${a.module}: ${a.headline}${a.detail?" \u2014 "+a.detail:""}`).join(`
...
You are acting as a security analyst explaining automated blockchain forensics findings to someone who isn't a blockchain expert. Write a clear, plain-English explanation of what this account's activity suggests. Synthesize the findings above into a coherent read of the account rather than restating them one by one \u2014 call out which ones reinforce each other and which are weak signals on their own. Be direct about how concerning (or not) this looks, and be skeptical of your own confidence where the evidence is thin rather than overstating it. Do not repeat the address or risk score back verbatim; the reader can already see those above your response.`}window.copyInspectorAnalysisForAi=function(){let e=document.getElementById("ai-explanation-body"),t=b0();if(!t){e&&(e.innerHTML='<p style="font-size:.82rem;color:#ff5555">Run an inspection first.</p>');return}zs(t)};window.exportInspectorJSON=function(){var o,i;let e=window._lastInspectResult;if(!e){alert("Run an inspection first.");return}let t=new Blob([JSON.stringify(e,null,2)],{type:"application/json"}),n=URL.createObjectURL(t),s=document.createElement("a"),a=((i=(o=document.getElementById("inspect-addr-badge"))==null?void 0:o.dataset)==null?void 0:i.fullAddr)||"wallet";s.href=n,s.download=`naluxrp_${a.slice(0,10)}_${new Date().toISOString().slice(0,10)}.json`,document.body.appendChild(s),s.click(),document.body.removeChild(s),URL.revokeObjectURL(n)};var v0=6e4,y0=1e4,w0=12e4,x0=8e3,k0=12e4,$0=300,Zu="nalulf_net_baseline_v2",S0=80,T0=5,oa="/api/v1/validatorregistry",em="/api/v1/validator";var C0=5*60*1e3,tm=10*60*1e3,zu=1e4,nm=8e3,ir=new Map,rr=new Map;var nn={quorumTight:{w:3,label:"Quorum within 3 validators of failure threshold"},nUnlActive:{w:2,label:"Negative UNL active \u2014 validators currently being ignored"},amendVeto:{w:1,label:"Amendment veto clustering \u2014 protocol governance dispute"},feeSpike:{w:2,label:"Open ledger fee 10\xD7 minimum \u2014 DDoS / spam attack likely"},burnAnomaly:{w:2,label:"XRP burn rate z-score > 3\u03C3 \u2014 resource exhaustion pattern"},peerSaturate:{w:2,label:"Inbound peers > 80% of connections \u2014 Eclipse Attack risk"},eclipseRisk:{w:3,label:"Peer count < 6 \u2014 node highly vulnerable to isolation"},dexSpike:{w:1,label:"DEX volume > 3\xD7 AMM baseline \u2014 unusual event-driven flow"},reserveSpike:{w:1,label:"New account rate > 3\xD7 baseline \u2014 possible bot creation"},slowConverge:{w:2,label:"Consensus convergence > 6s \u2014 network agreement degraded"},lowProposers:{w:2,label:"Proposer count below quorum \u2014 validator participation low"},queuePressure:{w:2,label:"TX queue > 80% full \u2014 fee surge imminent"},spamLedger:{w:1,label:"Ledger > 2\xD7 expected size \u2014 ledger spam in progress"},ioStressed:{w:1,label:"Node IO latency > 5ms \u2014 storage or network I/O stress"},peerChurn:{w:1,label:"Elevated peer disconnect rate \u2014 DDoS or instability"},staleLedger:{w:3,label:"Ledger age > 10s \u2014 validation appears stalled"}},sm={MultiSign:{purpose:"Multi-signature authorization",intro:"rippled 0.31",desc:"Lets multiple keys jointly authorize one transaction. Essential for institutional custody and hardware-wallet setups.",impact:"New transaction: SignerListSet. All signers submit their signature; the last one broadcasts."},MultiSignReserve:{purpose:"Cheaper signer-list reserve",intro:"rippled 1.2",desc:"Cuts the owner reserve for SignerList objects from 5 owner-items (10 XRP) down to 1 owner-item (2 XRP).",impact:"Existing SignerLists do not gain the reduction automatically; delete and re-create the list."},DepositAuth:{purpose:"Block unsolicited incoming payments",intro:"rippled 0.90",desc:"An account can set lsfDepositAuth so it only receives payments explicitly pre-authorized via DepositPreauth.",impact:"Senders to un-authorized accounts receive tecNO_PERMISSION."},DeletableAccounts:{purpose:"Permanent account deletion + reserve reclaim",intro:"rippled 1.4",desc:"An account with no objects and sequence \u2265 (current ledger \u2212 256) can permanently delete itself and recover the base reserve.",impact:"New transaction: AccountDelete. Sends all XRP minus fees to a destination."},NegativeUNL:{purpose:"Fault-tolerant consensus during outages",intro:"rippled 1.6",desc:"When validators are persistently offline, the network may add them to the Negative UNL so they do not count against quorum.",impact:"Enables the network to survive planned outages of up to 20% of trusted validators."},Checks:{purpose:"Deferred, cancellable payments",intro:"rippled 1.0",desc:"The sender creates a Check; the recipient can later cash it up to the authorized amount or let it expire. The sender can cancel at any time.",impact:"New transactions: CheckCreate, CheckCash, CheckCancel. Each open Check uses one owner-reserve slot."},AMM:{purpose:"Native Automated Market Maker DEX",intro:"rippled 1.12",desc:"Adds a Constant-Product (x*y=k) AMM directly in the ledger. Anyone can deposit two assets to earn LP tokens and a share of swap fees.",impact:"New transactions: AMMCreate, AMMDeposit, AMMWithdraw, AMMVote, AMMBid, AMMDelete."},XChainBridge:{purpose:"Cross-chain bridge protocol",intro:"rippled 2.0",desc:"Lets assets move between XRPL Mainnet, sidechains, and EVM chains via a locking/minting bridge secured by Witness servers.",impact:"New ledger objects: Bridge, XChainOwnedCreateAccountClaimID, etc. Requires Witness infrastructure."},Clawback:{purpose:"Token-issuer recovery",intro:"rippled 1.12",desc:"Issuers who set lsfAllowTrustLineClawback before issuing tokens can claw back tokens from any holder.",impact:"Must be enabled on a fresh account before any trust lines are created."},NonFungibleTokensV1:{purpose:"Native NFT support",intro:"rippled 1.9",desc:"Adds NFTokenMint, NFTokenBurn, and offer-based transfer mechanics for non-fungible tokens stored in NFTokenPage objects.",impact:"Each NFTokenPage holds up to 32 tokens and costs one owner-reserve slot. Royalties up to 50%."},NonFungibleTokensV1_1:{purpose:"NFT V1 corrections",intro:"rippled 1.10",desc:"Fixes pagination bugs, transfer-fee edge cases, and minting with the URI field that were present in V1.",impact:"Breaking fix for some V1 edge cases. Wallets built for V1 should test V1_1 compatibility."},PayChan:{purpose:"Payment channels for streaming micropayments",intro:"rippled 0.33",desc:"Sender deposits XRP into a channel, then issues signed claims off-ledger. Recipient submits the highest claim at any time to settle on-ledger.",impact:"New transactions: PaymentChannelCreate, PaymentChannelFund, PaymentChannelClaim."},Escrow:{purpose:"Time-locked and condition-based XRP transfers",intro:"rippled 0.60",desc:"Lock XRP until a future time OR a cryptographic fulfillment (PREIMAGE-SHA-256) is revealed, enabling vesting schedules and atomic swaps.",impact:"New transactions: EscrowCreate, EscrowFinish, EscrowCancel. Locked XRP counts against reserves."},DisallowIncoming:{purpose:"Block unsolicited ledger-object creation",intro:"rippled 1.10",desc:"New account flags let you individually block incoming Trust Lines, Check objects, NFToken offers, and Payment Channels.",impact:"Four new AccountSet flags; existing incoming objects are unaffected."},ExpandedSignerList:{purpose:"Larger multi-sig signer lists",intro:"rippled 1.9.1",desc:"Increases the maximum signers per SignerList from 8 to 32, enabling more complex institutional multi-sig and DAO governance.",impact:"Reserve cost scales with signer count. Requires MultiSignReserve to be cost-effective."},OwnerPaysFee:{purpose:"Correct fee payer in PayChan",intro:"rippled 0.33",desc:"Fixes a spec inconsistency where the channel owner correctly pays the transaction fee when closing or expiring channels.",impact:"Purely a fee-accounting fix; no user-visible behavior changes."},fixMasterKeyAsRegularKey:{purpose:"Master-key mis-use bug fix",intro:"rippled 0.90",desc:"Prevents accounts from setting their master key as their regular key \u2014 an operation that could create an unusable account state.",impact:"No application changes needed; existing accounts are not affected."},TrustSetAuth:{purpose:"Authorized trust lines",intro:"rippled 0.30",desc:"Issuers can require explicit authorization before anyone can hold their token \u2014 a prerequisite for regulatory-grade stablecoins.",impact:"New flow: issuer sends TrustSet with tfSetfAuth to approve each holder."}},Wu=new Set(["xrpscan.com","xrpl.aesthetes.art","xrpkuwait.com","xrpgoat.com","xrp.vet","xrp.unic.ac.cy","xrp-validator.interledger.org","xpmarket.com","verum.eminence.im","validator.xrpl.robertswarthout.com","validator.xrpl-labs.com","validator.poli.usp.br","validator.gatehub.net","validator.aspired.nz","v2.xrpl-commons.org","tequ.dev","squidrouter.com","ripple.ittc.ku.edu","ripple.com","peersyst.cloud","onxrp.com","katczynski.net","jon-nilsen.no","ekiserrepe.es","cabbit.tech","bithomp.com","aureusox.com","arrington-xrp-capital.blockdaemon.com","anodos.finance","bitso.com","ripple.kenan-flagler.unc.edu","ripplevalidator.uwaterloo.ca","shadow.haas.berkeley.edu","www.bitrue.com","xrp-col.anu.edu.au"]),P0=new Set(["nHBu3iuq1SQ9Z686pYwWYVKpScSMDWfpUJHdNEQRxn5XyETui7Db","nHDwBbubxJswoweWQKEgWLNRJv2hNRCTR4GGApJmbtCcbtYNSpdB","nHU2FpRbPrvVcyQQpkqrAUDJDTRHZpjij8DpKeSC481PYY9ikYkb","nHUbmg8QNzEGjHzgnt99e9YE2scU3DZGH7FsF6MCcK5eiPt3AtaH","nHUxBD1UPb383SdWgJx62GGQ7W2WKvgpUtUXLjiGGRRcPb3nbSXd","nHUP6rfQfgzg6tKga3k9ziEvtjwn1PB32gcr5dLcamqzmitszYv2","nHBT58yHyDdPdJ6gzaBMT7gqwTMpj5ERji1s9SvfKKtfoZUS89WX","nHBxsUzx3Bbf6J4yJ3fLQ3VizPtdREVwTJ6mdqkuDTjLcVbggVbk","nHUeUNSn3zce2xQZWNghQvd9WRH6FWEnCBKYVJu2vAizMxnXegfJ","nHUCAdca6VoWWYVdBH1bwCUQggEX2e5acQSqxM3DwyuhsFknxmh3","nHDDiwQBqXhEL1CFoRHdMXD33x9K7rpYJfniXxL7kFavpPd21EGe","nHBipbbREjNEiCs4hpy3K2489dRf27MPnxdivTTWKSd8ZUhfRvn8","nHDDe5uAdiv6RA59MA1oM4JLDtVSYKNShgjEqq1KsdJXZiR47CQT","nHBbiP5ua5dUqCTz5i5vd3ia9jg3KJthohDjgKxnc7LxtmnauW7Z","nHBQ3CT3EWYZ4uzbnL3k6TRf9bBPhWRFVcK1F5NjtwCBksMEt5yy","nHU16DF2kq7TmbR1Y5z8yKNXiLEf3oHT19HVpVXv7unFLfxa17nT","nHUC23NnutZyYeQxQbAbPUpKoVGj5aisBxf2zzcZzJ43fcw5rc9z","nHUgdMvuchx7AWG4ATMQdNNuMryo1SFoNptLCEVt2Dn7wEc625mF","nHUhQVE93dajM3srxubsEj1mK1gzRwJob14QSrJefY1FdLs6r7WJ","nHUU8xBczYzW6kZ6Ei9DsggzTJXRFkN3wE3FP5H4SLYzhbodeYcG","nHUGqooyfGqFkyH6uskbaEi6y2MjXjdA7QdbmyZ6p9etL5isRKLT","nHDp1ZXxEn7eo5YaUtiagaxSLwXudnKZDx68C96p4tdVLGLLLUFn","nHBcLEB4S6moQGrhMjJo1jbp58WL5psHY9EMDWNAtdqykUYiA1rF","nHUAECq1v1cKwn3NsYVyD7v6BNbfqyXmNVSF3e4XCVxPgBHRWkvv","nHUif4sukXu9pJGyyBaeVMwmE8L1fJ5KJj4X4ksgTKhgjG6k96s2","nHUVJR7SeT3nn6JPTz46JHqYRf7vX2if1sdTxnceywmSBWa167pt","nHUEYz4TtTv7yebjhY3aDib5KYPHnKjnY5mPYK5y4QuKdocwS5tD","nHUN5n2S3nQ8bzKm7bqeFMiQeDijh1LMgEocyNyQbb4mREazVdZ5","nHUgchANqM3giYSSvY5HsafFW6qxmG5jJ3CvPiv7n8gjNQuNm8Uz","nHDUqGoM7KR1pgbdYBRgKpGKdFLhpnMzVbECs8RE73RGZm3Va6MJ","nHUVxTi8XfXjaaJppw7mLSrYDRpkDpf8H9ypzgVKxfSXShcWwAoK","nHBveTxA1NaBj5AayRAU91f6YopuFWt9rmxfGaEh77a32Q6ZzzHc"]),M0=new Set(["validator.pftperry.com","rip973.com","preaware.org","postfiat.org","pftmeech.xyz","pft.xbtseal.com","pft.wizbubba.xyz","pft.permanentupperclass.com","pft.g.money","pft.akirax.xyz","jollydinger.com","auri0x.io","app.w.ai"]);function am(e,t){let n=(t||"").toLowerCase().replace(/^www\./,"");return P0.has(e)||M0.has(n)?{chain:"test",isUnl:!1}:Wu.has(n)||Wu.has("www."+n)?{chain:"main",isUnl:!0}:{chain:"main",isUnl:!1}}var hr={"xrpscan.com":{label:"XRP Scan",domain:"xrpscan.com",chain:"main",category:"unl"},"xrpl.aesthetes.art":{label:"Aesthetes",domain:"xrpl.aesthetes.art",chain:"main",category:"unl"},"xrpkuwait.com":{label:"XRP Kuwait",domain:"xrpkuwait.com",chain:"main",category:"unl"},"xrpgoat.com":{label:"XRP Goat",domain:"xrpgoat.com",chain:"main",category:"unl"},"xrp.vet":{label:"XRP Vet",domain:"xrp.vet",chain:"main",category:"unl"},"xrp.unic.ac.cy":{label:"Univ. of Nicosia",domain:"xrp.unic.ac.cy",chain:"main",category:"unl"},"xrp-validator.interledger.org":{label:"Interledger",domain:"xrp-validator.interledger.org",chain:"main",category:"unl"},"xpmarket.com":{label:"XPMarket",domain:"xpmarket.com",chain:"main",category:"unl"},"verum.eminence.im":{label:"Eminence",domain:"verum.eminence.im",chain:"main",category:"unl"},"validator.xrpl.robertswarthout.com":{label:"R. Swarthout",domain:"validator.xrpl.robertswarthout.com",chain:"main",category:"unl"},"validator.xrpl-labs.com":{label:"XRPL Labs",domain:"validator.xrpl-labs.com",chain:"main",category:"unl"},"validator.poli.usp.br":{label:"USP",domain:"validator.poli.usp.br",chain:"main",category:"unl"},"validator.gatehub.net":{label:"Gatehub",domain:"validator.gatehub.net",chain:"main",category:"unl"},"validator.aspired.nz":{label:"Aspired NZ",domain:"validator.aspired.nz",chain:"main",category:"unl"},"v2.xrpl-commons.org":{label:"XRPL Commons",domain:"v2.xrpl-commons.org",chain:"main",category:"unl"},"tequ.dev":{label:"Tequ",domain:"tequ.dev",chain:"main",category:"unl"},"squidrouter.com":{label:"Squid Router",domain:"squidrouter.com",chain:"main",category:"unl"},"ripple.ittc.ku.edu":{label:"Univ. of Kansas",domain:"ripple.ittc.ku.edu",chain:"main",category:"unl"},"ripple.com":{label:"Ripple",domain:"ripple.com",chain:"main",category:"unl"},"peersyst.cloud":{label:"Peersyst",domain:"peersyst.cloud",chain:"main",category:"unl"},"onxrp.com":{label:"OnXRP",domain:"onxrp.com",chain:"main",category:"unl"},"katczynski.net":{label:"Katczynski",domain:"katczynski.net",chain:"main",category:"unl"},"jon-nilsen.no":{label:"Jon Nilsen",domain:"jon-nilsen.no",chain:"main",category:"unl"},"ekiserrepe.es":{label:"Ekiserrepe",domain:"ekiserrepe.es",chain:"main",category:"unl"},"cabbit.tech":{label:"Cabbit",domain:"cabbit.tech",chain:"main",category:"unl"},"bithomp.com":{label:"Bithomp",domain:"bithomp.com",chain:"main",category:"unl"},"aureusox.com":{label:"Aureus Ox",domain:"aureusox.com",chain:"main",category:"unl"},"arrington-xrp-capital.blockdaemon.com":{label:"Arrington / Blockdaemon",domain:"arrington-xrp-capital.blockdaemon.com",chain:"main",category:"unl"},"anodos.finance":{label:"Anodos Finance",domain:"anodos.finance",chain:"main",category:"unl"},"bitso.com":{label:"Bitso",domain:"bitso.com",chain:"main",category:"unl"},"ripple.kenan-flagler.unc.edu":{label:"UNC Kenan-Flagler",domain:"ripple.kenan-flagler.unc.edu",chain:"main",category:"unl"},"ripplevalidator.uwaterloo.ca":{label:"Univ. of Waterloo",domain:"ripplevalidator.uwaterloo.ca",chain:"main",category:"unl"},"shadow.haas.berkeley.edu":{label:"UC Berkeley Haas",domain:"shadow.haas.berkeley.edu",chain:"main",category:"unl"},"www.bitrue.com":{label:"Bitrue",domain:"www.bitrue.com",chain:"main",category:"unl"},"xrp-col.anu.edu.au":{label:"ANU",domain:"xrp-col.anu.edu.au",chain:"main",category:"unl"},"xrpval.rawsec.de":{label:"Rawsec",domain:"xrpval.rawsec.de",chain:"main",category:"other"},"xrplvl.carbonvibe.com":{label:"Carbon Vibe",domain:"xrplvl.carbonvibe.com",chain:"main",category:"other"},"xrplvalidator.alloy.ee":{label:"Alloy",domain:"xrplvalidator.alloy.ee",chain:"main",category:"other"},"xrpl.uni.lu":{label:"Univ. of Luxembourg",domain:"xrpl.uni.lu",chain:"main",category:"other"},"xrpl.to":{label:"XRPL.to",domain:"xrpl.to",chain:"main",category:"other"},"xrpl.su":{label:"XRPL.su",domain:"xrpl.su",chain:"main",category:"other"},"xrpl.sbivc.co.jp":{label:"SBI VC Trade",domain:"xrpl.sbivc.co.jp",chain:"main",category:"other"},"xrpl-verification.flare.network":{label:"Flare Network",domain:"xrpl-verification.flare.network",chain:"main",category:"other"},"xrpl-validator.7rev.dev":{label:"7Rev",domain:"xrpl-validator.7rev.dev",chain:"main",category:"other"},"xrp.teacopula.com":{label:"Teacopula",domain:"xrp.teacopula.com",chain:"main",category:"other"},"xrp.moneymindedapes.com":{label:"MoneyMindedApes",domain:"xrp.moneymindedapes.com",chain:"main",category:"other"},"xrp.hazza-systems.de":{label:"Hazza Systems",domain:"xrp.hazza-systems.de",chain:"main",category:"other"},"xrp.cs.uoregon.edu":{label:"Univ. of Oregon",domain:"xrp.cs.uoregon.edu",chain:"main",category:"other"},"xrp.bpsqn.com":{label:"BPSQN",domain:"xrp.bpsqn.com",chain:"main",category:"other"},"xrp-validator.grapedrop.xyz":{label:"Grapedrop",domain:"xrp-validator.grapedrop.xyz",chain:"main",category:"other"},"xaodao.io":{label:"XaoDAO",domain:"xaodao.io",chain:"main",category:"other"},"vl.xrpsalute.com":{label:"XRP Salute",domain:"vl.xrpsalute.com",chain:"main",category:"other"},"validator.xrpl.app":{label:"XRPL App",domain:"validator.xrpl.app",chain:"main",category:"other"},"validator.ukcbt.org":{label:"UKCBT",domain:"validator.ukcbt.org",chain:"main",category:"other"},"validator.sugarxrpl.com":{label:"SugarXRPL",domain:"validator.sugarxrpl.com",chain:"main",category:"other"},"validator.boscaern.digital":{label:"Boscaern",domain:"validator.boscaern.digital",chain:"main",category:"other"},"trimaera.tech":{label:"Trimaera",domain:"trimaera.tech",chain:"main",category:"other"},"textrp.io":{label:"TextRP",domain:"textrp.io",chain:"main",category:"other"},"tesbert.com":{label:"Tesbert",domain:"tesbert.com",chain:"main",category:"other"},"tachyon-xrpl-validator.github.io":{label:"Tachyon",domain:"tachyon-xrpl-validator.github.io",chain:"main",category:"other"},"solonation.io":{label:"SoloNation",domain:"solonation.io",chain:"main",category:"other"},"smokydrip.com":{label:"SmokyDrip",domain:"smokydrip.com",chain:"main",category:"other"},"rippled-validator.us":{label:"rippled-validator.us",domain:"rippled-validator.us",chain:"main",category:"other"},"rippleat.snt.uni.lu":{label:"Univ. Luxembourg (SNT)",domain:"rippleat.snt.uni.lu",chain:"main",category:"other"},"ripple.uni.lu":{label:"Univ. Luxembourg",domain:"ripple.uni.lu",chain:"main",category:"other"},"ripple.j2b.com":{label:"J2B",domain:"ripple.j2b.com",chain:"main",category:"other"},"rich-list.info":{label:"Rich List",domain:"rich-list.info",chain:"main",category:"other"},"proptoexchange.com":{label:"ProPtoExchange",domain:"proptoexchange.com",chain:"main",category:"other"},"printscierge.com":{label:"Printscierge",domain:"printscierge.com",chain:"main",category:"other"},"opulencex.io":{label:"OpulenceX",domain:"opulencex.io",chain:"main",category:"other"},"onledger.net":{label:"OnLedger",domain:"onledger.net",chain:"main",category:"other"},"oclost.art":{label:"Oclost",domain:"oclost.art",chain:"main",category:"other"},"managednetwork.us":{label:"ManagedNetwork",domain:"managednetwork.us",chain:"main",category:"other"},"joshuahamsa.com":{label:"Joshua Hamsa",domain:"joshuahamsa.com",chain:"main",category:"other"},"grimmsxrpflow.jwscott.net":{label:"Grimm XRP Flow",domain:"grimmsxrpflow.jwscott.net",chain:"main",category:"other"},"getlol.xyz":{label:"GetLol",domain:"getlol.xyz",chain:"main",category:"other"},"gen3labs.xyz":{label:"Gen3 Labs",domain:"gen3labs.xyz",chain:"main",category:"other"},"garveyvalid.com":{label:"Garvey",domain:"garveyvalid.com",chain:"main",category:"other"},"easynpl.kr":{label:"EasyNPL",domain:"easynpl.kr",chain:"main",category:"other"},"diseb.ewi.tudelft.nl":{label:"TU Delft",domain:"diseb.ewi.tudelft.nl",chain:"main",category:"other"},"datamossa.com":{label:"DataMossa",domain:"datamossa.com",chain:"main",category:"other"},"crypto.unibe.ch":{label:"Univ. of Bern",domain:"crypto.unibe.ch",chain:"main",category:"other"},"commonprefix.com":{label:"Common Prefix",domain:"commonprefix.com",chain:"main",category:"other"},"catalyze-research.com":{label:"Catalyze Research",domain:"catalyze-research.com",chain:"main",category:"other"},"catalog.org":{label:"Catalog",domain:"catalog.org",chain:"main",category:"other"},"blockchain.korea.ac.kr":{label:"Korea Univ.",domain:"blockchain.korea.ac.kr",chain:"main",category:"other"},"astatiumprotocol.com":{label:"Astatium Protocol",domain:"astatiumprotocol.com",chain:"main",category:"other"},"ladykxrpl.mywire.org":{label:"LadyK XRPL",domain:"LadyKXRPL.mywire.org",chain:"main",category:"other"},"eelap-p1201-xrp.abudhabi.nyu.edu":{label:"NYU Abu Dhabi",domain:"EELAP-P1201-XRP.ABUDHABI.NYU.EDU",chain:"main",category:"other"},"589.clouds.hspeed.ch":{label:"HSpeed",domain:"589.clouds.hspeed.ch",chain:"main",category:"other"},"validator.pftperry.com":{label:"PFT Perry",domain:"validator.pftperry.com",chain:"test",category:"other"},"rip973.com":{label:"rip973",domain:"rip973.com",chain:"test",category:"other"},"preaware.org":{label:"Preaware",domain:"preaware.org",chain:"test",category:"other"},"postfiat.org":{label:"PostFiat",domain:"postfiat.org",chain:"test",category:"other"},"pftmeech.xyz":{label:"PFT Meech",domain:"pftmeech.xyz",chain:"test",category:"other"},"pft.xbtseal.com":{label:"PFT XBT Seal",domain:"pft.xbtseal.com",chain:"test",category:"other"},"pft.wizbubba.xyz":{label:"PFT Wizbubba",domain:"pft.wizbubba.xyz",chain:"test",category:"other"},"pft.permanentupperclass.com":{label:"PFT Perm Upper Class",domain:"pft.permanentupperclass.com",chain:"test",category:"other"},"pft.g.money":{label:"PFT G.Money",domain:"pft.g.money",chain:"test",category:"other"},"pft.akirax.xyz":{label:"PFT Akirax",domain:"pft.akirax.xyz",chain:"test",category:"other"},"jollydinger.com":{label:"Jollydinger",domain:"jollydinger.com",chain:"test",category:"other"},"auri0x.io":{label:"Auri0x",domain:"auri0x.io",chain:"test",category:"other"},"app.w.ai":{label:"W.ai",domain:"app.w.ai",chain:"test",category:"other"}},uo={nHB8QMKGt9VB4Vg71VszjBVQnDW3v3QudM4436zXRZgiuUBBSWJe:{lat:37.77,lng:-122.42,city:"San Francisco",org:"Ripple"},nHUon2tpyJEHHYGmxqNd3h3oGNQwNyX8PNS3aHe3bNpCrNXZlHo:{lat:37.77,lng:-122.41,city:"San Francisco",org:"Ripple"},nHUpwrafS45zmi6eT72XS5ijpkW5JwfL5mLdPhEibrqUvtRcMAjU:{lat:37.78,lng:-122.4,city:"San Francisco",org:"Ripple"},nHUkp7WhouVMobBUKGrV5FNqjsdD9zKP5jpGnnLfQXCMNe4dkDqo:{lat:37.76,lng:-122.43,city:"San Francisco",org:"Ripple"},nHUryiyDqEtyWVtFG24AAhaYjMf9FRLietZGBWYwUTojmugMsx3o:{lat:37.79,lng:-122.38,city:"San Francisco",org:"Ripple"},nHUpcmNsxAw47yt2ADDoNoQrzLyTJPgnyq16u6Qx2kRPA17oUNHz:{lat:37.8,lng:-122.39,city:"San Francisco",org:"Ripple"},nHUnhRJK3csknycNK5SXRFi8jvDp3sKoWvS9wKWLq1ATBBGgPBjp:{lat:37.75,lng:-122.44,city:"San Francisco",org:"Ripple"},nHUq9tJvk5QTDkwurB7EzbzkZ2uuoHjS3GKjP6pZiU3DJGnobNYK:{lat:39.04,lng:-77.49,city:"Ashburn, VA",org:"AWS (Coil)"},nHUvcCcmoH1FJMMC6NtF9KKA4LpCWhjsxk2reCQidsp5AHQ7QY9H:{lat:49.45,lng:11.08,city:"Nuremberg",org:"Hetzner (Gatehub)"},nHDH7bQJpVfDhVSqdui3Z8GPvKEBQpo6AKHcnXe21zoD4nABA6xj:{lat:52.37,lng:4.9,city:"Amsterdam",org:"GCP (XRPL Labs)"},nHUED59jjpQ5QbNtesAbB6Es3uUPv3c9Ri5MNNgfMv5t5Lhb5ndW:{lat:19.43,lng:-99.13,city:"Mexico City",org:"AWS (Bitso)"},nHBidG3pZK11zqjeVos6hFxTDPGYuqfRFZ5gu9b7tQFdB8nPZujG:{lat:35.69,lng:139.69,city:"Tokyo",org:"NTT (Digital Garage)"},nHDB2PAPYqF86j9j3c6w1F1ZqwvQfiWcFShZ9Pokg9q4ohNDSkAz:{lat:47.61,lng:-122.33,city:"Seattle, WA",org:"Azure (Arrington)"},nHUdphn3LXa31w5sLd39MQdPEKQNrNYL3DQFByijVXiNQ3G6BYBZ:{lat:1.35,lng:103.82,city:"Singapore",org:"AWS (Tokenize)"},nHUFCyRCrUjvtZmKiLeF8ReopzKuSkVzdl1VsMCqm75aqyohLYEg:{lat:48.86,lng:2.35,city:"Paris",org:"OVH (XRPL Commons)"},nHULqGBkJtWeNFjhTzYeAsHA3qKKS7HoBh8CV3BAGTGMZuepEhWC:{lat:40.71,lng:-74.01,city:"New York",org:"Equinix (Blockchain LLC)"},nHBdXSF6YHAHSZUk7rvox6jwbvvyqBnsWGcewBtq8x1XuH6KXKXr:{lat:37.79,lng:-122.4,city:"San Francisco",org:"Cloudflare (XRP Scan)"}},ju={"xrpscan.com":{lat:51.51,lng:-.13,city:"London",org:"XRPScan"},"xrpl.aesthetes.art":{lat:52.37,lng:4.9,city:"Amsterdam",org:"Aesthetes"},"xrpkuwait.com":{lat:29.37,lng:47.98,city:"Kuwait City",org:"XRP Kuwait"},"xrpgoat.com":{lat:39.04,lng:-77.49,city:"Ashburn, VA",org:"XRP Goat"},"xrp.vet":{lat:48.86,lng:2.35,city:"Paris",org:"XRP Vet"},"xrp.unic.ac.cy":{lat:35.17,lng:33.37,city:"Nicosia",org:"Univ. of Nicosia"},"xrp-validator.interledger.org":{lat:40.71,lng:-74.01,city:"New York",org:"Interledger Foundation"},"xpmarket.com":{lat:52.37,lng:4.9,city:"Amsterdam",org:"XPMarket"},"verum.eminence.im":{lat:51.51,lng:-.13,city:"London",org:"Eminence"},"validator.xrpl.robertswarthout.com":{lat:52.37,lng:4.9,city:"Amsterdam",org:"R. Swarthout"},"validator.xrpl-labs.com":{lat:52.37,lng:4.9,city:"Amsterdam",org:"XRPL Labs"},"validator.xrpl.app":{lat:52.37,lng:4.9,city:"Amsterdam",org:"XRPL App"},"validator.poli.usp.br":{lat:-23.55,lng:-46.63,city:"S\xE3o Paulo",org:"USP"},"validator.gatehub.net":{lat:46.05,lng:14.51,city:"Ljubljana",org:"Gatehub"},"validator.aspired.nz":{lat:-36.86,lng:174.76,city:"Auckland",org:"Aspired NZ"},"v2.xrpl-commons.org":{lat:48.86,lng:2.35,city:"Paris",org:"XRPL Commons"},"tequ.dev":{lat:60.17,lng:24.94,city:"Helsinki",org:"Tequ"},"squidrouter.com":{lat:37.77,lng:-122.42,city:"San Francisco",org:"Squid Router"},"ripple.ittc.ku.edu":{lat:38.97,lng:-95.24,city:"Lawrence, KS",org:"Univ. of Kansas"},"ripple.com":{lat:37.77,lng:-122.42,city:"San Francisco",org:"Ripple"},"peersyst.cloud":{lat:41.39,lng:2.15,city:"Barcelona",org:"Peersyst"},"onxrp.com":{lat:51.51,lng:-.13,city:"London",org:"OnXRP"},"katczynski.net":{lat:52.23,lng:21.01,city:"Warsaw",org:"Katczynski"},"jon-nilsen.no":{lat:59.91,lng:10.75,city:"Oslo",org:"Jon Nilsen"},"ekiserrepe.es":{lat:40.42,lng:-3.7,city:"Madrid",org:"Ekiserrepe"},"cabbit.tech":{lat:51.51,lng:-.13,city:"London",org:"Cabbit"},"bithomp.com":{lat:59.33,lng:18.07,city:"Stockholm",org:"Bithomp"},"aureusox.com":{lat:40.71,lng:-74.01,city:"New York",org:"Aureus Ox"},"arrington-xrp-capital.blockdaemon.com":{lat:40.71,lng:-74.01,city:"New York",org:"Blockdaemon"},"anodos.finance":{lat:37.98,lng:23.73,city:"Athens",org:"Anodos Finance"},"bitso.com":{lat:19.43,lng:-99.13,city:"Mexico City",org:"Bitso"},"ripple.kenan-flagler.unc.edu":{lat:35.9,lng:-79.05,city:"Chapel Hill, NC",org:"UNC Kenan-Flagler"},"ripplevalidator.uwaterloo.ca":{lat:43.47,lng:-80.54,city:"Waterloo, ON",org:"Univ. of Waterloo"},"shadow.haas.berkeley.edu":{lat:37.87,lng:-122.26,city:"Berkeley, CA",org:"UC Berkeley Haas"},"www.bitrue.com":{lat:1.35,lng:103.82,city:"Singapore",org:"Bitrue"},"xrp-col.anu.edu.au":{lat:-35.28,lng:149.13,city:"Canberra",org:"ANU"},"xrpval.rawsec.de":{lat:51.17,lng:10.45,city:"Germany",org:"Rawsec"},"xrplvl.carbonvibe.com":{lat:51.51,lng:-.13,city:"London",org:"Carbon Vibe"},"xrplvalidator.alloy.ee":{lat:59.44,lng:24.75,city:"Tallinn",org:"Alloy"},"xrpl.uni.lu":{lat:49.61,lng:6.13,city:"Luxembourg",org:"Univ. of Luxembourg"},"xrpl.to":{lat:48.86,lng:2.35,city:"Paris",org:"XRPL.to"},"xrpl.su":{lat:55.75,lng:37.62,city:"Moscow",org:"XRPL.su"},"xrpl.sbivc.co.jp":{lat:35.69,lng:139.69,city:"Tokyo",org:"SBI VC Trade"},"xrpl-verification.flare.network":{lat:51.51,lng:-.13,city:"London",org:"Flare Network"},"xrpl-validator.7rev.dev":{lat:52.52,lng:13.4,city:"Berlin",org:"7Rev"},"xrp.teacopula.com":{lat:39.04,lng:-77.49,city:"Ashburn, VA",org:"Teacopula"},"xrp.moneymindedapes.com":{lat:39.04,lng:-77.49,city:"Ashburn, VA",org:"MoneyMindedApes"},"xrp.hazza-systems.de":{lat:52.52,lng:13.4,city:"Berlin",org:"Hazza Systems"},"xrp.cs.uoregon.edu":{lat:44.05,lng:-123.08,city:"Eugene, OR",org:"Univ. of Oregon"},"xrp.bpsqn.com":{lat:37.77,lng:-122.42,city:"San Francisco",org:"BPSQN"},"xrp-validator.grapedrop.xyz":{lat:52.37,lng:4.9,city:"Amsterdam",org:"Grapedrop"},"xaodao.io":{lat:1.35,lng:103.82,city:"Singapore",org:"XaoDAO"},"vl.xrpsalute.com":{lat:40.71,lng:-74.01,city:"New York",org:"XRP Salute"},"validator.ukcbt.org":{lat:51.51,lng:-.13,city:"London",org:"UKCBT"},"validator.sugarxrpl.com":{lat:37.77,lng:-122.42,city:"San Francisco",org:"SugarXRPL"},"validator.boscaern.digital":{lat:53.33,lng:-6.25,city:"Dublin",org:"Boscaern"},"trimaera.tech":{lat:48.86,lng:2.35,city:"Paris",org:"Trimaera"},"textrp.io":{lat:1.35,lng:103.82,city:"Singapore",org:"TextRP"},"tesbert.com":{lat:39.04,lng:-77.49,city:"Ashburn, VA",org:"Tesbert"},"tachyon-xrpl-validator.github.io":{lat:37.77,lng:-122.42,city:"San Francisco",org:"Tachyon"},"solonation.io":{lat:1.35,lng:103.82,city:"Singapore",org:"SoloNation"},"smokydrip.com":{lat:39.04,lng:-77.49,city:"Ashburn, VA",org:"SmokyDrip"},"rippled-validator.us":{lat:39.04,lng:-77.49,city:"Ashburn, VA",org:"rippled-validator.us"},"rippleat.snt.uni.lu":{lat:49.61,lng:6.13,city:"Luxembourg",org:"Univ. of Luxembourg"},"ripple.uni.lu":{lat:49.61,lng:6.13,city:"Luxembourg",org:"Univ. of Luxembourg"},"ripple.j2b.com":{lat:37.77,lng:-122.42,city:"San Francisco",org:"J2B"},"rich-list.info":{lat:51.51,lng:-.13,city:"London",org:"Rich List"},"proptoexchange.com":{lat:39.04,lng:-77.49,city:"Ashburn, VA",org:"ProPtoExchange"},"printscierge.com":{lat:39.04,lng:-77.49,city:"Ashburn, VA",org:"Printscierge"},"opulencex.io":{lat:1.35,lng:103.82,city:"Singapore",org:"OpulenceX"},"onledger.net":{lat:52.37,lng:4.9,city:"Amsterdam",org:"OnLedger"},"oclost.art":{lat:48.86,lng:2.35,city:"Paris",org:"Oclost"},"managednetwork.us":{lat:39.04,lng:-77.49,city:"Ashburn, VA",org:"ManagedNetwork"},"joshuahamsa.com":{lat:37.77,lng:-122.42,city:"San Francisco",org:"Joshua Hamsa"},"grimmsxrpflow.jwscott.net":{lat:39.04,lng:-77.49,city:"Ashburn, VA",org:"Grimm XRP Flow"},"getlol.xyz":{lat:39.04,lng:-77.49,city:"Ashburn, VA",org:"GetLol"},"gen3labs.xyz":{lat:37.77,lng:-122.42,city:"San Francisco",org:"Gen3 Labs"},"garveyvalid.com":{lat:40.71,lng:-74.01,city:"New York",org:"Garvey"},"easynpl.kr":{lat:37.57,lng:126.98,city:"Seoul",org:"EasyNPL"},"diseb.ewi.tudelft.nl":{lat:52,lng:4.36,city:"Delft",org:"TU Delft"},"datamossa.com":{lat:48.86,lng:2.35,city:"Paris",org:"DataMossa"},"crypto.unibe.ch":{lat:46.95,lng:7.45,city:"Bern",org:"Univ. of Bern"},"commonprefix.com":{lat:37.98,lng:23.73,city:"Athens",org:"Common Prefix"},"catalyze-research.com":{lat:51.51,lng:-.13,city:"London",org:"Catalyze Research"},"catalog.org":{lat:37.77,lng:-122.42,city:"San Francisco",org:"Catalog"},"blockchain.korea.ac.kr":{lat:37.57,lng:126.98,city:"Seoul",org:"Korea Univ."},"astatiumprotocol.com":{lat:1.35,lng:103.82,city:"Singapore",org:"Astatium Protocol"},"ladykxrpl.mywire.org":{lat:39.04,lng:-77.49,city:"Ashburn, VA",org:"LadyK XRPL"},"eelap-p1201-xrp.abudhabi.nyu.edu":{lat:24.47,lng:54.37,city:"Abu Dhabi",org:"NYU Abu Dhabi"},"589.clouds.hspeed.ch":{lat:47.38,lng:8.54,city:"Zurich",org:"HSpeed"},"www.payonline.financial":{lat:55.75,lng:37.62,city:"Moscow",org:"PayOnline"}};function gr(e){if(!e)return null;let t=e.toLowerCase().replace(/^www\./,"");return ju[t]??ju["www."+t]??null}var L0=[{lat:37.34,lng:-121.89,label:"s1.ripple.com",city:"San Jose, CA",org:"Ripple"},{lat:37.34,lng:-121.87,label:"s2.ripple.com",city:"San Jose, CA",org:"Ripple"},{lat:52.37,lng:4.91,label:"xrplcluster.com",city:"Amsterdam",org:"Cluster"},{lat:52.36,lng:4.89,label:"xrpl.ws",city:"Amsterdam",org:"Cluster"}],Oe={nunl:{hex:"#ff5555",glow:"rgba(255,85,85,.4)",label:"Negative UNL"},both:{hex:"#50fa7b",glow:"rgba(80,250,123,.4)",label:"UNL + dUNL"},unl:{hex:"#00fff0",glow:"rgba(0,255,240,.35)",label:"UNL"},dunl:{hex:"#bd93f9",glow:"rgba(189,147,249,.4)",label:"dUNL only"},other:{hex:"#ffb86c",glow:"rgba(255,184,108,.4)",label:"Other"},pub:{hex:"#50fa7b",glow:"rgba(80,250,123,.4)",label:"Public Node"}},lr="https://api.xrpscan.com/api/v1/validatorregistry",xe=new Map,xn={},co=0,Vn=!1,kn="fallback";function om(){if(!Vn){xe.clear();for(let[e,t]of Object.entries(hr)){let n=t.domain??e,s=am("",n),a=gr(n)??null;xe.set(e,{key:e,label:t.label,domain:n,domainVerified:!1,provider:t.provider??(a==null?void 0:a.org)??null,lists:t.lists??[],category:s.isUnl?"unl":"other",chain:s.chain,unl:s.isUnl,dunl:!1,geo:a,meta:{},agreement:{"1h":null,"24h":null,"30d":null}})}kn="fallback",br({ok:!1,source:"fallback",error:"using hardcoded data \u2014 mount /api/v1 router"})}}var cr=0,A0=5*60*1e3;function Uu(e,t){var s,a;let n=Array.isArray(e)?e:e.validators??e.data??[];if(!n.length)throw new Error("Empty validators array");xe.clear();for(let o of n){let i=o.key??o.validation_public_key??o.master_key??o.signing_key??null;if(!i)continue;let r=o.domain??null,l=r?r.toLowerCase().replace(/^www\./,""):null,c=o.unl===!0||o.unl===1||o.unl==="true",u=am(i,l),p=c||u.isUnl,d=u.chain,m=p?"unl":"other",f=Object.values(hr).find(x=>x.domain&&x.domain.toLowerCase().replace(/^www\./,"")===l),g=(f==null?void 0:f.label)??o.label??o.account_name??o.name??l??null??`${i.slice(0,8)}\u2026${i.slice(-6)}`,v=uo[i]??gr(l)??null,b=(((s=o.geo)==null?void 0:s.lat)!=null&&((a=o.geo)==null?void 0:a.lng)!=null?o.geo:null)??v;xe.set(i,{key:i,label:g,domain:r??null,domainVerified:!!(o.domainVerified??o.domain_verified),provider:o.provider??(b==null?void 0:b.org)??(f==null?void 0:f.provider)??null,lists:Array.isArray(o.lists)?o.lists:[],category:m,chain:d,unl:p,dunl:!1,geo:b,version:o.version??o.build_version??null,baseFee:o.base_fee_xrp??o.base_fee??null,ownerReserve:o.reserve_inc_xrp??o.owner_reserve??null,meta:o.meta??{},agreement:o.agreement??{"1h":sr(o.agreement_1h??o.agr_1h),"24h":sr(o.agreement_24h??o.agr_24h),"30d":sr(o.agreement_30d??o.agr_30d)}})}xn=e.lists??{},co=Date.now(),Vn=!0,kn=t,cr=0,br({ok:!0,count:xe.size,lists:xn,source:t})}function sr(e){if(!e)return null;let t=Number(e.total??e.ledgers??0),n=Number(e.missed??0),s=t-n,a=t>0?(s/t*100).toFixed(1):null;return{total:t,missed:n,hit:s,score:a?`${a}%`:null,scoreRaw:e.score??null}}async function lo(e=!1){let t=Date.now();if(!e&&Vn&&t-co<C0)return!0;if(!e&&!Vn&&t-cr<A0)return!1;let n=typeof oa=="string"&&oa.startsWith("/api/"),s=location.protocol==="file:"||location.hostname==="127.0.0.1"||location.hostname==="localhost";if(!(n&&s))try{let a=new AbortController,o=setTimeout(()=>a.abort(),zu),i=await fetch(oa,{signal:a.signal,headers:{Accept:"application/json"}});if(clearTimeout(o),!i.ok)throw new Error(`HTTP ${i.status}`);let r=await i.json();return Uu(r,"proxy"),!0}catch(a){console.warn("[registry] tier 1 (proxy) failed:",a.message)}try{let a=new AbortController,o=setTimeout(()=>a.abort(),zu),i=await fetch(lr,{signal:a.signal});if(clearTimeout(o),!i.ok)throw new Error(`HTTP ${i.status}`);let r=await i.text(),l=JSON.parse(r);return Uu(l,"xrpscan"),!0}catch(a){console.warn("[registry] tier 2 (xrpscan direct) failed:",a.message),(a.message.includes("Failed to fetch")||a.message.includes("CORS"))&&console.warn("[registry] CORS blocked \u2014 mount the backend proxy route (see validatorregistry.js)")}return console.warn("[registry] all sources failed \u2014 showing",Object.keys(hr).length,"hardcoded validators"),cr=Date.now(),Vn||om(),br({ok:!1,source:"fallback",error:"all sources failed \u2014 mount /api/v1 router"}),!1}window.debugRegistry=async function(){console.group("\u{1F50D} Registry debug"),console.log("Current source:",kn),console.log("Validators loaded:",xe.size),console.log("Registry ok:",Vn),console.log("Last fetch:",co?new Date(co).toLocaleTimeString():"never"),console.log(""),console.log("Testing proxy \u2192",oa);try{let e=await fetch(oa),t=await e.text();console.log("  Status:",e.status,"\u2014 body preview:",t.slice(0,300))}catch(e){console.warn("  Failed:",e.message)}console.log(""),console.log("Testing XRPScan direct \u2192",lr);try{let e=await fetch(lr),t=await e.text();console.log("  Status:",e.status,"\u2014 body preview:",t.slice(0,300))}catch(e){console.warn("  Failed:",e.message)}return console.groupEnd(),{source:kn,size:xe.size,ok:Vn}};function it(e){return xe.get(e)??{key:e,label:`${e.slice(0,10)}\u2026${e.slice(-6)}`,domain:null,provider:null,lists:[],category:"other",geo:uo[e]??null,meta:{}}}function $n(e){var n;if(!e)return null;if(((n=e.geo)==null?void 0:n.lat)!=null)return e.geo;let t=uo[e.key];return t||gr(e.domain)}function im(){return[...xe.values()].filter(e=>(e.category==="unl"||e.category==="both")&&e.chain!=="test").map(e=>e.key)}function E0(){return[...xe.values()].filter(e=>(e.category==="dunl"||e.category==="both")&&e.chain!=="test").map(e=>e.key)}function N0(){return[...xe.values()].filter(e=>e.category==="other"&&e.chain!=="test").map(e=>e.key)}function R0(){return[...xe.values()].filter(e=>e.chain==="test").map(e=>e.key)}function br({ok:e,count:t,lists:n,source:s,error:a}){let o=w("m1-registry-badge");if(o)if(e){let i=[...xe.values()].filter(c=>c.category==="unl").length,r=[...xe.values()].filter(c=>c.chain==="test").length,l=t-r;o.textContent=`${l} mainnet \xB7 ${i} UNL \xB7 ${r} testnet \xB7 live`,o.className="registry-badge registry-badge--ok"}else o.textContent=s==="fallback"?`Fallback data \xB7 ${xe.size} known \xB7 ${a??"endpoint unreachable"}`:"Refreshing\u2026",o.className="registry-badge registry-badge--warn"}var po=null,qu=!1,ar=!1,Vu=0,Gu=0,Ku=0,or=0,rm=!0,nt=null,qn=null,la=null,zt=null,ze={},io=null,dr={},tt=null,tn=[],ro=null,pr={},sa="unl",mt={fees:[],burnDrops:[],dexOffers:[],ammSwaps:[],newAccounts:[],converge:[],proposers:[],peerCounts:[],peerDiscon:[]};function lm(){var t,n;if(qu)return;qu=!0,iw(),om(),lo(!0),sw(),aw(),window.addEventListener("xrpl-connected",()=>{aa(),Ss()&&(ia({force:!0}),ra({force:!1}))}),window.addEventListener("xrpl-disconnected",()=>{ur(),fr(null)}),window.addEventListener("xrpl-connection",s=>{var a;((a=s==null?void 0:s.detail)==null?void 0:a.state)==="connecting"&&(ur(),fr(null,"Switching networks\u2026"))}),window.addEventListener("xrpl-ledger",s=>{ew(s.detail),Ss()&&tw(s.detail)}),(t=w("btn-network-refresh"))==null||t.addEventListener("click",()=>{ia({force:!0}),lo(!0),ra({force:!0})}),(n=document.querySelector('.dash-tab[data-tab="network"]'))==null||n.addEventListener("click",()=>{aa(),ia({force:!0}),lo(!1),ra({force:!1})});let e=w("tab-network");e&&new MutationObserver(aa).observe(e,{attributes:!0,attributeFilter:["style","class"]}),document.addEventListener("visibilitychange",aa)}function Ss(){let e=w("tab-network"),t=e?e.style.display!=="none":!1;return rm&&X.currentPage==="dashboard"&&X.currentTab==="network"&&t&&!document.hidden}function aa(){Ss()?_0():ur()}function cm(e){rm=!!e,aa()}function _0(){po||(ia({force:!1}),po=setInterval(()=>{Ss()&&ia({force:!1})},v0))}function ur(){clearInterval(po),po=null}async function ia({force:e=!1}={}){var n;if(!Ss()&&!e)return;let t=Date.now();if(!(!e&&(t-Vu<y0||ar||t<Gu))){ar=!0,Vu=t,ze={},Ju(!0);try{await Promise.allSettled([lo(!1),D0(),I0(),F0(),O0(),B0()]),X0(),j0(),U0(),q0(),Q0(),fr({info:nt,fee:qn,vals:la}),rw()}catch(s){String((s==null?void 0:s.message)??"").toLowerCase().includes("too much load")&&(Gu=Date.now()+w0,(n=he)==null||n("Rate-limited \u2014 backing off 2 min."))}finally{Ju(!1),ar=!1}}}function Ju(e){var t;(t=w("btn-network-refresh"))==null||t.classList.toggle("spinning",e)}async function D0(){var n,s,a;let e=await Ee({command:"server_info"});if(nt=((n=e==null?void 0:e.result)==null?void 0:n.info)??null,!nt)return;ot("converge",Number(((s=nt.last_close)==null?void 0:s.converge_time_s)??0)),ot("proposers",Number(((a=nt.last_close)==null?void 0:a.proposers)??0)),ot("peerCounts",Number(nt.peers??0));let t=Number(nt.peer_disconnects_resources??0);io!==null&&t>io&&ot("peerDiscon",t-io),io=t}async function I0(){var t;let e=await Ee({command:"fee"});qn=(e==null?void 0:e.result)??null,((t=qn==null?void 0:qn.drops)==null?void 0:t.open_ledger_fee)!=null&&ot("fees",Number(qn.drops.open_ledger_fee))}async function F0(){try{let e=await Ee({command:"validators"});la=(e==null?void 0:e.result)??null}catch{la=null}}async function O0(){var e;try{let t=await Ee({command:"peers"});zt=Array.isArray((e=t==null?void 0:t.result)==null?void 0:e.peers)?t.result.peers:null}catch{zt=null}}async function B0(){var e;try{let t=await Ee({command:"feature"});(e=t==null?void 0:t.result)!=null&&e.features&&(V0(t.result.features),pm(t.result.features))}catch{}}function X0(){var C,P,R,O,D,I;let e=nt,t=la,n=(t==null?void 0:t.trusted_validator_keys)??[],s=im(),a=E0(),o=n.length?n:s,i=a,r=Number((t==null?void 0:t.validation_quorum)??(e==null?void 0:e.validation_quorum)??0),l=o.length,c=l-r,u=l>0?r/l*100:0,p=o.filter(F=>xe.has(F)).length,d=l>0?Math.round(p/l*100):0,m=Number(((C=e==null?void 0:e.last_close)==null?void 0:C.converge_time_s)??0),f=Number(((P=e==null?void 0:e.last_close)==null?void 0:P.proposers)??0),g=r>0?Math.round(f/r*100):0,v=Array.isArray(e==null?void 0:e.negative_unl)?e.negative_unl:[],h=!!la;c>=0&&c<=3&&(ze.quorumTight=!0),v.length>0&&(ze.nUnlActive=!0),m>6&&(ze.slowConverge=!0),f>0&&r>0&&f<r&&(ze.lowProposers=!0),K("m1-active",h?l:"\u2014"),K("m1-quorum",r>0?r:"\u2014"),K("m1-margin",h?c>=0?c:`\u2212${Math.abs(c)}`:"\u2014"),K("m1-overlap",h?`${d}%`:"\u2014"),K("m1-known",h?`${p} / ${l} identified`:"\u2014 (validators cmd unavailable)"),K("m1-proposers",((R=e==null?void 0:e.last_close)==null?void 0:R.proposers)!=null?f:"\u2014"),K("m1-particip",r>0&&((O=e==null?void 0:e.last_close)==null?void 0:O.proposers)!=null?`${g}%`:"\u2014"),K("m1-converge",((D=e==null?void 0:e.last_close)==null?void 0:D.converge_time_s)!=null?`${m.toFixed(2)}s`:"\u2014"),K("m1-converge-avg",ca("converge")>0?`avg ${ca("converge").toFixed(2)}s`:"\u2014"),Tt("m1-qbar",u,u>90?"bar-danger":u>80?"bar-warn":"bar-ok"),Tt("m1-obar",d,d<40?"bar-danger":d<70?"bar-warn":"bar-ok"),Tt("m1-pbar",g,g<80?"bar-danger":g<95?"bar-warn":"bar-ok"),Tt("m1-cvgbar",Math.min(100,m/10*100),m>6?"bar-danger":m>4?"bar-warn":"bar-ok"),W0({active:l,quorum:r,margin:c,nUnl:v,valsAvail:h});let b=(I=t==null?void 0:t.publisher_lists)==null?void 0:I[0],x=(xn==null?void 0:xn.ripple)??(xn==null?void 0:xn.xrplf)??null,k=(b==null?void 0:b.uri)??(x==null?void 0:x.uri)??"\u2014",T=(b==null?void 0:b.seq)??(x==null?void 0:x.seq)??"\u2014";if(K("m1-vl-uri",k),K("m1-vl-seq",T),b!=null&&b.expiration||x!=null&&x.expiration){let F=w("m1-vl-expiry");if(F){let H=(b==null?void 0:b.expiration)??(x==null?void 0:x.expiration),N=Math.floor((new Date(H)-Date.now())/864e5);F.textContent=N>0?`Expires ${N}d`:"\u26A0 EXPIRED",F.className=`expiry-pill ${N>30?"pill-ok":N>7?"pill-warn":"pill-bad"}`,F.style.display=""}}let S=w("m1-nunl-list");if(K("m1-nunl-count",v.length||"0"),S)if(!v.length)S.innerHTML='<div class="nunl-empty">\u2713 No validators on Negative UNL</div>';else{let F={};S.innerHTML=v.map(N=>{let W=it(N);return W.provider&&(F[W.provider]=(F[W.provider]||0)+1),`<div class="nunl-entry">
    ...
    </div>`}let O="";C.forEach(D=>{if(!D.keys.length)return;let I=D.keys.some(W=>i.has(W)),F=D.keys.map((W,se)=>R(W,I?se:null)).join(""),H=`vgs-${Math.random().toString(36).slice(2,8)}`,N=!D.collapsed;O+=`
      ...
      </div>`}),O||(O='<div class="nunl-empty">No validators in this view.</div>'),o.innerHTML=E+O,K("m1-val-summary",P),o.querySelectorAll(".vg-tab").forEach(D=>{D.addEventListener("click",I=>{I.stopPropagation();let F=D.getAttribute("data-vgtab");F&&(sa=F,dm(e,t,n,s,a))})})}async function H0(e){let t=ir.get(e);if(t&&Date.now()-t.cachedAt<tm)return t.data;try{let n=new AbortController,s=setTimeout(()=>n.abort(),nm),a=await fetch(`${em}/${encodeURIComponent(e)}`,{signal:n.signal});if(clearTimeout(s),!a.ok)throw new Error(`HTTP ${a.status}`);let o=await a.json();return ir.set(e,{data:o,cachedAt:Date.now()}),o}catch{return null}}async function z0(e){let t=rr.get(e);if(t&&Date.now()-t.cachedAt<tm)return t.data;try{let n=new AbortController,s=setTimeout(()=>n.abort(),nm),a=await fetch(`${em}/${encodeURIComponent(e)}/reports`,{signal:n.signal});if(clearTimeout(s),!a.ok)throw new Error(`HTTP ${a.status}`);let o=await a.json(),i=o.reports??o??[];return rr.set(e,{data:i,cachedAt:Date.now()}),i}catch{return[]}}window.focusValidator=async function(e){let t=it(e),n=$n(t);document.querySelectorAll(".vpill").forEach(o=>o.classList.remove("vp-active"));let s=document.querySelector(`.vpill[data-key="${CSS.escape(e)}"]`);if(s&&(s.classList.add("vp-active"),s.scrollIntoView({behavior:"smooth",block:"nearest"})),mr(e,t,null),H0(e).then(o=>{o&&mr(e,t,o)}),!n){let o=w("world-map-container");if(o){let i=o.querySelector(".wm-no-geo");i&&i.remove();let r=document.createElement("div");r.className="wm-no-geo",r.textContent=`\u{1F4CD} ${t.label} \u2014 geographic location unknown`,o.appendChild(r),setTimeout(()=>r.remove(),3500)}return}let a=w("world-map-container");a&&a.scrollIntoView({behavior:"smooth",block:"nearest"}),tt&&(tt.flyTo([n.lat,n.lng],6,{duration:1.2}),setTimeout(()=>{let o=pr[e];o&&o.openPopup()},1300))};function mr(e,t,n){var C,P,R,O,D;let s=w("amend-modal-overlay"),a=w("amend-modal-body");if(!s||!a)return;let o=n??{},i=t.label??o.label??o.account_name??e.slice(0,16)+"\u2026",r=t.domain??o.domain??null,l=t.chain??o.chain??"main",c=t.category??"other",u=Oe[c]??Oe.other,p=$n(t),d=t.unl||c==="unl"||c==="both",m=t.dunl||c==="dunl"||c==="both",f=t.domainVerified||o.domain_verified?"\u2713 Verified":r?"Unverified":"\u2014",g=t.agreement??o.agreement??{},v=!n&&!((C=t.agreement)!=null&&C["24h"]);function h(I,F){if(!F||!F.total)return`<div class="adm-mi"><span class="adm-mk">${I}</span><span class="adm-mv" style="opacity:.5">\u2014</span></div>`;let H=parseFloat(F.score)||0,N=H>=99?"color:#50fa7b":H>=95?"color:#ffb86c":"color:#ff5555";return`<div class="adm-mi">
      ...
      <span class="adm-mv mono" style="${N}">${F.score??"\u2014"}
    ...
    </div>`}function b(I,F,H=!1){return!F&&F!==0?"":`<div class="adm-mi"><span class="adm-mk">${I}</span><span class="adm-mv ${H?"mono":""}">${y(String(F))}</span></div>`}let x=rr.get(e),k=((P=x==null?void 0:x.data)==null?void 0:P.slice(-14))??[],T=k.length?`<div class="adm-section">
        ...
        <div style="display:flex;gap:2px;align-items:flex-end;height:32px;margin-top:6px;">
          ${k.map(I=>{let F=Number(I.missed??I.miss??0),H=Number(I.total??I.ledgers??1),N=H>0?(H-F)/H*100:100,W=Math.round(4+N/100*28),se=N>=99?"#50fa7b":N>=95?"#ffb86c":"#ff5555";return`<div title="${I.date??""} \xB7 ${N.toFixed(1)}% (${F} missed)" style="flex:1;height:${W}px;background:${se};border-radius:2px 2px 0 0;opacity:.85;transition:opacity .15s" onmouseover="this.style.opacity=1" onmouseout="this.style.opacity=.85"></div>`}).join("")}
        </div>
    ...
    <div class="adm-section">
      ...
      ${p?b("Location",[p.city,p.country].filter(Boolean).join(", ")||"\u2014"):""}
      ${p!=null&&p.org?b("Provider",p.org):""}
    ...
    <div class="adm-footer" style="display:flex;gap:10px;margin-top:12px;padding-top:10px;border-top:1px solid rgba(255,255,255,.07)">
      ...
      ${(p==null?void 0:p.lat)!=null?`<button class="adm-link" style="background:none;border:none;cursor:pointer;color:inherit;padding:0" onclick="window.closeAmendModal();setTimeout(()=>window.focusValidator('${y(e)}'),200)">\u{1F4CD} Show on map</button>`:""}
    </div>`,s.style.display="flex",s.addEventListener("click",I=>{I.target===s&&window.closeAmendModal()},{once:!0})}window._loadValidatorReports=async function(e){var n;let t=it(e);await z0(e),mr(e,t,((n=ir.get(e))==null?void 0:n.data)??null)};function W0({active:e,quorum:t,margin:n,nUnl:s,valsAvail:a}){let o=w("m1-quorum-ring");if(!o)return;if(!a||!t||!e){o.innerHTML='<div style="opacity:.4;font-size:12px;text-align:center;padding:16px">Connect to view quorum</div>';return}let i=44,r=2*Math.PI*i,l=new Set(s),c=e-s.length,u=s.length,p=Math.max(0,e-t),d=t,m=n<=0?"#ff5555":n<=3?"#ffb86c":"#50fa7b",f=e>0?c/e:0,g=e>0?u/e:0,v=e>0?t/e:0,h=e>0?Math.max(0,n)/e:0,b=e>0?u/e:0;function x(k,T,S,$=8){if(T<=0)return"";let E=k*r,C=T*r;return`<circle r="${i}" cx="50" cy="50" fill="none"
    ...
    <div class="qr-wrap">
      ...
      <div class="qr-legend">
    ...
    </div>`}function j0(){var F,H,N;let e=nt,t=(e==null?void 0:e.server_state)??"unknown",n=(e==null?void 0:e.build_version)??"\u2014",s=Number((e==null?void 0:e.uptime)??0),a=e==null?void 0:e.network_id,o=Number((e==null?void 0:e.io_latency_ms)??0),i=String((e==null?void 0:e.jq_trans_overflow)??"0"),r=Number((e==null?void 0:e.peer_disconnects_resources)??0),l=Number((e==null?void 0:e.load_factor)??1),c=Number((e==null?void 0:e.load_factor_net)??1),u=Number((e==null?void 0:e.load_factor_server)??(e==null?void 0:e.load_factor_local)??1),p=Number(((F=e==null?void 0:e.validated_ledger)==null?void 0:F.age)??0),d=(H=e==null?void 0:e.validated_ledger)==null?void 0:H.seq,m=(e==null?void 0:e.complete_ledgers)??"",f=(e==null?void 0:e.state_accounting)??null;p>10&&(ze.staleLedger=!0),o>5&&(ze.ioStressed=!0),ca("peerDiscon")>5&&(ze.peerChurn=!0);let g=w("m2-state");if(g){g.textContent=t;let W=["full","proposing","validating"].includes(t),se=["syncing","tracking","connected"].includes(t);g.className=`state-pill state-${W?"ok":se?"warn":"bad"}`}K("m2-version",n),K("m2-uptime",cw(s)),K("m2-netid",a===0?"0 (Mainnet)":a===1?"1 (Testnet)":a??"\u2014"),K("m2-ledger-seq",d!=null?Number(d).toLocaleString():"\u2014"),K("m2-ledger-age",p>0?`${p}s`:"< 1s"),K("m2-io-ms",o>0?`${o}ms`:"< 1ms"),K("m2-jq",i==="0"?"0 (clean)":`\u26A0 ${i}`),K("m2-discon",r.toLocaleString());let v=w("m2-ledger-age");v&&(v.className=`kv-v ${p>10?"text-danger":p>5?"text-warn":""}`);let h=Math.min(100,(l-1)/49*100);Tt("m2-load-bar",h,l>5?"bar-danger":l>2?"bar-warn":"bar-ok"),K("m2-load-total",`${l.toFixed(2)}\xD7`),K("m2-load-net",`${c.toFixed(2)}\xD7`),K("m2-load-local",`${u.toFixed(2)}\xD7`);let b=u>c*1.5?"Local node stressed":c>u*1.5?"Network-wide stress":l>1.2?"Distributed":"Normal";K("m2-load-src",b);let x=X.tpsHistory.length?X.tpsHistory[X.tpsHistory.length-1]:null;K("m2-tps",x!=null?x.toFixed(1):"\u2014"),K("m2-txcount",((N=X.ledgerLog[0])==null?void 0:N.txCount)??"\u2014");let k=m==="entire ledger"||m.startsWith("32570"),T=k?100:lw(m);if(K("m2-ledger-range",m||"\u2014"),K("m2-hist-type",k?"Full History Node":"Pruned / Partial"),K("m2-hist-score",`${T}%`),Tt("m2-hist-bar",T,T<30?"bar-danger":T<70?"bar-warn":"bar-ok"),f){let W=w("m2-state-acct");if(W){let se=["full","syncing","tracking","connected","disconnected"],re=0,pe={};se.forEach(ae=>{var te;pe[ae]=Number(((te=f[ae])==null?void 0:te.duration_us)??0),re+=pe[ae]}),W.innerHTML=re>0?se.map(ae=>{let te=Math.round(pe[ae]/re*100);return te?`<div class="sa-row"><span class="sa-lbl">${ae}</span>
          <div class="bar-track sa-bar"><div class="bar-fill ${ae==="full"?"bar-ok":ae==="syncing"?"bar-warn":"bar-danger"}" style="width:${te}%"></div></div>
          <span class="sa-pct">${te}%</span></div>`:""}).join(""):'<span class="dim">No data</span>'}}let S=(e==null?void 0:e.peers)!=null?Number(e.peers):null,$=S!=null,E=0,C=0,P=!1;zt&&(zt.forEach(W=>{W.inbound===!0?E++:C++}),P=!0);let R=P&&E+C>0?Math.round(E/(E+C)*100):0,O=P?zt.length:S??0,D=O<6?"HIGH":O<15?"MEDIUM":"LOW";O<6&&(ze.eclipseRisk=!0),R>80&&(ze.peerSaturate=!0),K("m2-peers",$?O:"\u2014"),K("m2-inbound",P?E:$?"\u2014 (cmd restricted)":"\u2014"),K("m2-outbound",P?C:$?"\u2014 (cmd restricted)":"\u2014"),K("m2-ib-pct",P?`${R}%`:"\u2014"),Tt("m2-peer-bar",Math.min(100,O/21*100),O>18?"bar-danger":O>15?"bar-warn":"bar-ok"),Tt("m2-ib-bar",R,R>80?"bar-danger":R>60?"bar-warn":"bar-ok");let I=w("m2-eclipse");I&&(I.textContent=D,I.className=`risk-badge risk-${D.toLowerCase()}`)}function U0(){var C,P,R,O;let e=qn,t=Number(((C=e==null?void 0:e.drops)==null?void 0:C.minimum_fee)??10),n=Number(((P=e==null?void 0:e.drops)==null?void 0:P.open_ledger_fee)??10),s=Number(((R=e==null?void 0:e.drops)==null?void 0:R.median_fee)??10),a=Number(((O=e==null?void 0:e.drops)==null?void 0:O.base_fee)??10),o=Number((e==null?void 0:e.current_ledger_size)??0),i=Number((e==null?void 0:e.expected_ledger_size)??1),r=Number((e==null?void 0:e.current_queue_size)??0),l=Number((e==null?void 0:e.max_queue_size)??1),c=l>0?Math.round(r/l*100):0,u=i>0?o/i:1,p=ca("fees"),d=p>0?Math.round((n-p)/p*100):0,m=Math.min(100,Math.round(Math.log2(Math.max(1,n/10))*14));n>t*10&&(ze.feeSpike=!0),c>80&&(ze.queuePressure=!0),u>2&&(ze.spamLedger=!0);let f=mt.burnDrops.slice(-10),g=f.length?f.reduce((D,I)=>D+I,0)/f.length:0,v=ow(mt.burnDrops),h=ca("burnDrops"),b=v>0&&mt.burnDrops.length>5?((g-h)/v).toFixed(2):"0.00",x=Math.min(100,Math.abs(Number(b))*20);Math.abs(Number(b))>3&&(ze.burnAnomaly=!0);let k=n>5e3?"Severe":n>500?"High":n>100?"Elevated":n>20?"Normal":"Minimal",S={Severe:"#ff5555",High:"#ff9955",Elevated:"#ffb86c",Normal:"#50fa7b",Minimal:"#6272a4"}[k]??"#50fa7b",$=w("m3-pressure");$&&($.textContent=k,$.className=`pressure-badge p-${k.toLowerCase()}`),K("m3-open",`${n} drops`),K("m3-med",`${s} drops`),K("m3-base",`${a} drops`),K("m3-devpct",`${d>0?"+":""}${d}% vs baseline`),K("m3-spam",`${m} / 100`),K("m3-qsize",`${r} / ${l}`),K("m3-qpct",`${c}%`),K("m3-szratio",`${u.toFixed(2)}\xD7`),K("m3-curledger",`${o} txs`),K("m3-expledger",`${i} expected`),K("m3-burn",g>0?`${(g/1e6).toFixed(4)} XRP / ledger`:"\u2014"),K("m3-burnz",`z = ${b}`),Tt("m3-spam-bar",m,m>70?"bar-danger":m>40?"bar-warn":"bar-ok"),Tt("m3-q-bar",c,c>80?"bar-danger":c>50?"bar-warn":"bar-ok"),Tt("m3-sz-bar",Math.min(100,u*50),u>2?"bar-danger":u>1.5?"bar-warn":"bar-ok"),Tt("m3-burn-bar",x,x>60?"bar-danger":x>30?"bar-warn":"bar-ok");let E=w("m3-congestion-summary");if(E){let D=[];u>2&&D.push({icon:"\u{1F6A8}",txt:`Ledger ${u.toFixed(1)}\xD7 normal size \u2014 possible spam burst`,col:"#ff5555"}),c>80&&D.push({icon:"\u26A0",txt:`TX queue ${c}% full \u2014 fee surge imminent`,col:"#ffb86c"}),m>70&&D.push({icon:"\u26A0",txt:`Spam index ${m}/100 \u2014 elevated DDoS risk`,col:"#ffb86c"}),Math.abs(Number(b))>3&&D.push({icon:"\u{1F4C9}",txt:`Burn rate z=${b} \u2014 resource exhaustion pattern`,col:"#ff9955"}),d>200&&D.push({icon:"\u{1F4B8}",txt:`Open fee ${d}% above baseline \u2014 network stress`,col:"#ffb86c"}),E.innerHTML=D.length?D.map(I=>`<div class="cong-line"><span>${I.icon}</span><span style="color:${I.col}">${y(I.txt)}</span></div>`).join(""):'<div class="cong-clear"><span style="color:#50fa7b">\u2713</span> No congestion signals \u2014 network traffic is normal</div>'}}function q0(){var p,d;let e={},t=0;for(let m of xe.values()){if(m.chain==="test")continue;let f=m.version??"unknown";e[f]=(e[f]??0)+1,t++}let n={},s=0;if(Array.isArray(zt))for(let m of zt){let f=(m.version??"unknown").replace(/rippled-/i,"").split(" ")[0];n[f]=(n[f]??0)+1,s++}let a=w("m4-version-dist");if(a&&t>0){let m=Object.entries(e).sort((h,b)=>b[1]-h[1]),f=((p=m[0])==null?void 0:p[0])??"?",g=t>0?Math.round((((d=m[0])==null?void 0:d[1])??0)/t*100):0,v=["#00fff0","#50fa7b","#ffb86c","#bd93f9","#ff5555","#8be9fd"];a.innerHTML=m.slice(0,6).map(([h,b],x)=>{let k=Math.round(b/t*100),T=v[x%v.length],S=h.includes("beta")||h.includes("rc")||h.includes("RC");return`<div class="vd-row">
        ...
        </div>`}).join("")}}}var ks="pending";function pm(e){let t=w("amendment-list");if(!t)return;let n=w("amend-pipeline-header"),s=Object.entries(e).map(([u,p])=>({hash:u,...p})),a=s.filter(u=>u.enabled),o=s.filter(u=>!u.enabled&&!u.vetoed).sort((u,p)=>(p.count??0)-(u.count??0)),i=s.filter(u=>u.vetoed),r=o.filter(u=>u.majority),l=o.filter(u=>!u.majority&&(u.count??0)>=(u.threshold??28)*.8);if(o.some(u=>(u.count??0)<(u.threshold??28)*.5)&&(ze.amendVeto=!0),n){let u=[{id:"pending",label:"Voting",count:o.length,color:"#8be9fd"},{id:"active",label:"Active",count:a.length,color:"#50fa7b"},{id:"vetoed",label:"Vetoed",count:i.length,color:"#ff5555"},{id:"all",label:"All",count:s.length,color:null}];n.innerHTML=`
      <div class="ap-tabs">
        ${u.map(p=>`
          <button class="ap-tab ${ks===p.id?"ap-tab--active":""}" data-aptab="${p.id}">
            ${p.color?`<span style="display:inline-block;width:7px;height:7px;border-radius:50%;background:${p.color};margin-right:5px;vertical-align:middle"></span>`:""}
            ${p.label}
            <span class="ap-tab-count">${p.count}</span>
          </button>`).join("")}
      </div>
      ...
      ${l.length?`<div class="ap-near-bar">\u{1F4C8} ${l.length} amendment${l.length>1?"s":""} approaching 80% threshold</div>`:""}`,n.querySelectorAll(".ap-tab").forEach(p=>{p.onclick=()=>{ks=p.dataset.aptab,pm(e)}})}let c=ks==="active"?a:ks==="vetoed"?i:ks==="all"?s.sort((u,p)=>u.enabled!==p.enabled?u.enabled?1:-1:u.vetoed!==p.vetoed?u.vetoed?1:-1:(p.count??0)-(u.count??0)):o;if(!c.length){t.innerHTML=`<div class="amend-empty">${ks==="vetoed"?"No vetoed amendments":"No data"}</div>`;return}t.innerHTML=c.map(u=>{var $;let p=u.count??0,d=u.threshold??28,m=Math.min(100,Math.round(p/d*100)),f=u.name??`${u.hash.slice(0,10)}...`,g=!!u.enabled,v=!!u.vetoed,h=!!u.majority,b=sm[f]??{},x=($=mt.amendMomentum)==null?void 0:$[u.hash],k="";if(h&&!g&&u.majority){let E=Date.now()-new Date(u.majority).getTime(),C=E>0?Math.floor(E/864e5):0,P=Math.max(0,14-C),R=Math.min(100,Math.round(C/14*100));k=`<div class="ap-countdown">
      ...
      <div class="ap-row-main">
        ...
        ${g?`<div class="ap-active-note">\u2713 Running on all ledgers${b.intro?" \xB7 since "+b.intro:""}</div>`:`<div class="ap-vote-row">
          ...
          <span class="ap-vote-label">${p}/${d} <span style="opacity:.5">(${m}%)</span></span>
        </div>`}
        ${k}
      </div>
    </div>`}).join("")}function V0(e){dr={},Object.entries(e).forEach(([t,n])=>{dr[t]={hash:t,...n}})}window.showAmendDetail=function(e){let t=dr[e];if(!t)return;let n=t.name||`${e.slice(0,16)}...`,s=sm[n]||{},a=t.count??0,o=t.threshold??28,i=Math.min(100,Math.round(a/o*100)),r=t.enabled?"Active on Ledger":t.vetoed?"Vetoed":t.majority?"Majority Reached":"Voting in Progress",l=t.enabled?"adm-s-ok":t.vetoed?"adm-s-bad":t.majority?"adm-s-warn":"adm-s-info",c=t.enabled?"bar-ok":t.vetoed?"bar-danger":t.majority?"bar-warn":"bar-info",u=t.majority&&!t.enabled?`
    ...
    </div>`:"",p=w("amend-modal-overlay"),d=w("amend-modal-body");!p||!d||(d.innerHTML=`
    ...
    <div class="adm-footer">
    ...
    </div>`,p.style.display="flex",p.addEventListener("click",m=>{m.target===p&&window.closeAmendModal()},{once:!0}))};window.closeAmendModal=function(){let e=w("amend-modal-overlay");e&&(e.style.display="none")};function G0(e){if(window.L){e();return}if(!document.querySelector("#leaflet-css")){let n=document.createElement("link");n.id="leaflet-css",n.rel="stylesheet",n.href="https://cdnjs.cloudflare.com/ajax/libs/leaflet/1.9.4/leaflet.min.css",document.head.appendChild(n)}let t=document.createElement("script");t.src="https://cdnjs.cloudflare.com/ajax/libs/leaflet/1.9.4/leaflet.min.js",t.onload=e,document.head.appendChild(t)}function K0(e,t,n,s,a=!1){w("world-map-container")&&G0(()=>J0(e,t,n,s,a))}function J0(e,t,n,s,a=!1){let o=w("world-map-container");if(!o)return;let i=new Set(n||[]),r=new Set(e||[]),l=new Set(t||[]),c=X.currentNetwork||"xrpl-mainnet";if(tt&&ro!==c&&(tt.remove(),tt=null,tn=[],ro=null),!tt){o.innerHTML="";let k=document.createElement("div");k.id="wm-leaflet",k.style.cssText="width:100%;height:440px;",o.appendChild(k),tt=L.map("wm-leaflet",{center:[25,5],zoom:2,minZoom:1,maxZoom:12,zoomControl:!0,attributionControl:!0,worldCopyJump:!0}),L.tileLayer("https://{s}.basemaps.cartocdn.com/dark_all/{z}/{x}/{y}{r}.png",{attribution:'&copy; <a href="https://carto.com">CARTO</a> &copy; <a href="https://openstreetmap.org">OSM</a>',subdomains:"abcd",maxZoom:19}).addTo(tt),ro=c}tn.forEach(k=>{try{k.remove()}catch{}}),tn=[];function u(k){return i.has(k)?"nunl":r.has(k)&&l.has(k)?"both":r.has(k)?"unl":l.has(k)?"dunl":"other"}pr={};let p={};for(let[k,T]of xe){let S=$n(T);if(!(S!=null&&S.lat)||!(S!=null&&S.lng))continue;let $=`${(Math.round(S.lat*2)/2).toFixed(1)},${(Math.round(S.lng*2)/2).toFixed(1)}`;p[$]||(p[$]={lat:S.lat,lng:S.lng,keys:[],city:S.city,org:S.org}),p[$].keys.push(k)}if(Object.values(p).forEach(k=>{let T=k.keys.length,S=k.keys.map(u),$=["nunl","both","unl","dunl","other"].find(O=>S.includes(O))||"other",E=Oe[$],C=T>5?13:T>2?10:7,P=L.divIcon({html:`<div class="wm-lmarker wm-lmarker-val ${$==="nunl"?"wm-lmarker-nunl":""} ${a?"wm-lmarker-ref":""}"
      ...
      </div>`,className:"",iconSize:[(C+8)*2,(C+8)*2],iconAnchor:[C+8,C+8]}),R=L.marker([k.lat,k.lng],{icon:P}).bindPopup(Y0(k.keys,k.city,k.org,i,r,l,a),{maxWidth:380,className:"wm-popup-wrap"}).addTo(tt);k.keys.forEach(O=>{pr[O]=R}),tn.push(R)}),a){let k=L.control({position:"bottomleft"});k.onAdd=()=>{let T=L.DomUtil.create("div","wm-ref-banner");return T.innerHTML="\u{1F4E1} Reference positions \xB7 live validator list unavailable from endpoint",T},k.addTo(tt),tn.push(k)}let d=[...xe.keys()].filter(k=>{var S;return((S=xe.get(k).geo)==null?void 0:S.lat)!=null||uo[k]}).length,m=xe.size-d;if(m>0){let k=L.control({position:"bottomright"});k.onAdd=()=>{let T=L.DomUtil.create("div","wm-unknown-ctrl");return T.innerHTML=`+ ${m} validators \xB7 location unknown`,T},k.addTo(tt),tn.push(k)}L0.forEach(k=>{let T=L.divIcon({html:`<div class="wm-lmarker wm-lmarker-pub">
        <div class="wm-lring"></div>
      ...
      <div class="wm-popup-val-info">
        ...
        <div class="wm-popup-val-tags">
          ...
          ${p.provider?`<span class="wm-popup-prov">${y(p.provider)}</span>`:""}
        </div>
      </div>
    </div>`}).join(""),c=[...new Set(e.map(u=>{var d;let p=it(u);return p.provider??((d=$n(p))==null?void 0:d.org)??null}).filter(Boolean))];return`<div class="wm-popup-inner">
    ...
    <div class="wm-popup-vals">${l}</div>
    ...
    </div>`;else{let r=e.filter(p=>{var d;return(((d=nn[p])==null?void 0:d.w)??1)>=3}),l=e.filter(p=>{var d;return(((d=nn[p])==null?void 0:d.w)??1)===2}),c=e.filter(p=>{var d;return(((d=nn[p])==null?void 0:d.w)??1)===1}),u=(p,d,m)=>d.length===0?"":`
      <div class="adv-group-title" style="color:${m}">${p} (${d.length})</div>
      ${d.map(f=>{let g=nn[f]??{w:1,label:f},v=g.label.split(" \u2014 "),h=v[0],b=v[1]||"";return`<div class="adv-sig-card adv-sig-${g.w>=3?"critical":g.w>=2?"elevated":"monitor"}">
      ...
      <span class="hcs-total">of ${i.length} checks</span>`);let p={consensus:"Consensus Health",infra:"Node Infrastructure",ledger:"Ledger & Fees"};t.innerHTML=Object.entries(p).map(([d,m])=>{let f=i.filter(x=>x.group===d),g=f.map(x=>{let k=x.result.status,T=k==="ok"?"hc-ok":k==="watch"?"hc-warn":"hc-fail",S="\u25CF";return`<div class="hc-item ${T}">
    ...
    </div>`}).join("")}function ew(e){var t,n,s,a,o,i,r,l,c,u;e&&(ot("burnDrops",(e.avgFee||0)*1e6*(e.txPerLedger??0)),ot("dexOffers",((t=e.txTypes)==null?void 0:t.OfferCreate)??0),ot("ammSwaps",(((n=e.txTypes)==null?void 0:n.AMMDeposit)??0)+(((s=e.txTypes)==null?void 0:s.AMMWithdraw)??0)+(((a=e.txTypes)==null?void 0:a.AMMBid)??0)),ot("newAccounts",((o=e.txTypes)==null?void 0:o.AccountSet)??0),ot("txPayment",((i=e.txTypes)==null?void 0:i.Payment)??0),ot("txNFT",(((r=e.txTypes)==null?void 0:r.NFTokenMint)??0)+(((l=e.txTypes)==null?void 0:l.NFTokenBurn)??0)+(((c=e.txTypes)==null?void 0:c.NFTokenCreateOffer)??0)+(((u=e.txTypes)==null?void 0:u.NFTokenAcceptOffer)??0)),ot("txLedger",e.txPerLedger??0),ot("tps",e.tps??(e.txPerLedger??0)/3.5),ot("closeTime",e.closeTime??3.5))}function tw(e){let t=X.tpsHistory.length?X.tpsHistory[X.tpsHistory.length-1]:null;K("m2-tps",t!=null?t.toFixed(1):"\u2014"),K("m2-txcount",e.txPerLedger??"\u2014"),e.successRate!=null&&K("m2-success",`${e.successRate.toFixed(0)}%`)}async function ra({force:e=!1}={}){if(!Ss()&&!e)return;let t=Date.now();if(!e&&t-Ku<k0)return;Ku=t;let n=w("latency-list");if(!n)return;let s=Ir[X.currentNetwork]??[],a=++or;n.innerHTML=s.map((i,r)=>`
  ...
  `,document.body.appendChild(e),e.addEventListener("click",t=>{t.target===e&&da()}),document.addEventListener("keydown",t=>{t.key==="Escape"&&e.classList.contains("show")&&da()})}function gw(e){let t=pw[e];if(!t)return;hw();let n=document.getElementById("learnModalOverlay"),s=document.getElementById("learnModalTitle"),a=document.getElementById("learnModalSub"),o=document.getElementById("learnModalBody"),i=document.getElementById("learnModalLinks"),r=document.getElementById("learnModalCtas");!n||!s||!a||!o||!i||!r||(s.textContent=t.title,a.textContent=t.subtitle||"",o.innerHTML=(t.sections||[]).map(l=>`
  ...
  `).join(""),n.classList.add("show"),document.body.classList.add("modal-open"))}function da(){var e;(e=document.getElementById("learnModalOverlay"))==null||e.classList.remove("show"),document.body.classList.remove("modal-open")}function bw(e){var t,n,s;if(e==="modal:close")return da();if(e==="auth:signup"){da(),(t=window.openAuth)==null||t.call(window,"signup");return}if(e==="auth:login"){da(),(n=window.openAuth)==null||n.call(window,"login");return}if(e.startsWith("topic:"))return gw(e.split(":")[1]);if(e.startsWith("scroll:")){let a=e.split(":")[1];(s=document.getElementById(a))==null||s.scrollIntoView({behavior:"smooth",block:"start"})}}function vw(){um||(um=!0,document.addEventListener("click",e=>{var s,a;let t=(a=(s=e.target).closest)==null?void 0:a.call(s,"[data-action]");if(!t)return;let n=t.getAttribute("data-action")||"";n&&(e.preventDefault(),bw(n))}))}function mm(){var l,c,u,p,d;vw(),(l=document.querySelector(".landing-features"))==null||l.setAttribute("id","learn"),(c=document.querySelector(".landing-simple-value"))==null||c.setAttribute("id","use-cases"),(u=document.querySelector(".landing-cta"))==null||u.setAttribute("id","about"),(p=document.querySelector(".landing-tagline"))==null||p.classList.add("tagline-pill");let e=document.querySelector(".landing-stats-strip");e&&(e.classList.add("landing-learn-strip"),e.innerHTML=uw.map(m=>`
    ...
    `).join(""));let t=w("features-grid");t&&(t.innerHTML=mw.map(m=>`
    ...
    `).join(""));let n=document.querySelector(".landing-simple-value"),s=n==null?void 0:n.querySelector("h2");s&&(s.textContent="What you can do with NaluLF");let a=w("value-grid");a&&(a.innerHTML=fw.map(m=>`
    ...
    `)}function fm(){let e=new IntersectionObserver(t=>t.forEach(n=>{n.isIntersecting&&n.target.classList.add("visible")}),{threshold:.12});document.querySelectorAll(".reveal").forEach(t=>e.observe(t))}function hm(){let e=document.getElementById("particle-canvas");if(!e)return;let t=e.getContext("2d"),n,s,a=[],o=80,i=120;function r(){n=e.width=window.innerWidth,s=e.height=window.innerHeight}function l(){return{x:Math.random()*n,y:Math.random()*s,vx:(Math.random()-.5)*.4,vy:(Math.random()-.5)*.4,r:Math.random()*1.5+.5,alpha:Math.random()*.5+.1}}function c(){r(),a=Array.from({length:o},l)}function u(){return getComputedStyle(document.body).getPropertyValue("--accent-secondary").trim()||"#ffd700"}function p(){t.clearRect(0,0,n,s);let g=u();for(let v=0;v<a.length;v++)for(let h=v+1;h<a.length;h++){let b=a[v].x-a[h].x,x=a[v].y-a[h].y,k=Math.sqrt(b*b+x*x);k<i&&(t.beginPath(),t.moveTo(a[v].x,a[v].y),t.lineTo(a[h].x,a[h].y),t.strokeStyle=`rgba(255,255,255,${(1-k/i)*.06})`,t.lineWidth=1,t.stroke())}a.forEach(v=>{t.beginPath(),t.arc(v.x,v.y,v.r,0,Math.PI*2),t.fillStyle=`rgba(255,255,255,${v.alpha*.6})`,t.fill()})}function d(){a.forEach(g=>{g.x+=g.vx,g.y+=g.vy,(g.x<0||g.x>n)&&(g.vx*=-1),(g.y<0||g.y>s)&&(g.vy*=-1)})}let m;function f(){d(),p(),m=requestAnimationFrame(f)}c(),f(),document.addEventListener("visibilitychange",()=>{document.hidden?(m&&cancelAnimationFrame(m),m=null):!m&&X.currentPage==="landing"&&f()}),window.addEventListener("naluxrp:pagechange",g=>{var v;((v=g==null?void 0:g.detail)==null?void 0:v.pageId)!=="landing"?(m&&cancelAnimationFrame(m),m=null):m||f()}),window.addEventListener("resize",()=>{r(),a.forEach(g=>{g.x=Math.min(g.x,n),g.y=Math.min(g.y,s)})}),e.style.cssText=`
    position: fixed; inset: 0;
    width: 100%; height: 100%;
    pointer-events: none;
    z-index: 0; opacity: 0.4;
  `}function Ts(e){var t;(t=window.showProfile)==null||t.call(window),setTimeout(()=>e==null?void 0:e(),250)}var vr=[{label:"\u{1F30A} Live Stream",hint:"Dashboard \u2192 Stream tab",action:()=>An(document.querySelector('[data-tab="stream"]'),"stream")},{label:"\u{1F50D} Inspector",hint:"Dashboard \u2192 Inspector tab",action:()=>An(document.querySelector('[data-tab="inspector"]'),"inspector")},{label:"\u{1F4E1} Network Health",hint:"Dashboard \u2192 Network tab",action:()=>An(document.querySelector('[data-tab="network"]'),"network")},{label:"\u{1F464} Profile",hint:"View your profile",action:()=>{var e;return(e=window.showProfile)==null?void 0:e.call(window)}},{label:"\u{1F48E} Wallets",hint:"Profile \u2192 Wallets",action:()=>Ts(()=>{var e;return(e=window.switchProfileTab)==null?void 0:e.call(window,"wallets")})},{label:"\u{1F4CA} Portfolio Analytics",hint:"Profile \u2192 Balance history, heatmap, flow",action:()=>Ts(()=>{var e;return(e=window.switchProfileTab)==null?void 0:e.call(window,"analytics")})},{label:"\u{1F517} Social Links",hint:"Profile \u2192 Connect Discord, X, GitHub\u2026",action:()=>Ts(()=>{var e;return(e=window.switchProfileTab)==null?void 0:e.call(window,"social")})},{label:"\u{1F4DC} Activity Log",hint:"Profile \u2192 Recent account activity",action:()=>Ts(()=>{var e;return(e=window.switchProfileTab)==null?void 0:e.call(window,"activity")})},{label:"\u2699\uFE0F Settings",hint:"Profile \u2192 Preferences & AI Explanations",action:()=>Ts(()=>{var e;return(e=window.switchProfileTab)==null?void 0:e.call(window,"settings")})},{label:"\u{1F52C} Analyze a Project",hint:"Liquidity depth, holder/LP concentration, issuer risk",action:()=>Ts(()=>{var e;return(e=window.jumpToProjectIntelLookup)==null?void 0:e.call(window)})},{label:"\u{1F9ED} Replay App Tour",hint:"Retake the onboarding walkthrough",action:()=>{var e;(e=window.showDashboard)==null||e.call(window),setTimeout(()=>{var t;return(t=window.startTour)==null?void 0:t.call(window)},300)}},{label:"\u2753 Help & Glossary",hint:"Search app features and on-chain terms",action:()=>{var e;return(e=window.openHelp)==null?void 0:e.call(window)}},{label:"\u{1F511} Sign In",hint:"Open auth",action:()=>{var e;return(e=window._openAuth)==null?void 0:e.call(window,"login")}},{label:"\u2728 Sign Up",hint:"Create account",action:()=>{var e;return(e=window._openAuth)==null?void 0:e.call(window,"signup")}},{label:"\u{1F3E0} Landing Page",hint:"Go home",action:()=>{var e;return(e=window._goHome)==null?void 0:e.call(window)}},{label:"\u{1F3A8} Cycle Theme",hint:"gold \u2192 cosmic \u2192 starry \u2192",action:()=>{var e;return(e=window._cycleTheme)==null?void 0:e.call(window)}}];function yw(e){let t=e.trim();return He(t)?[{label:`\u{1F50D} Inspect ${t.slice(0,8)}\u2026${t.slice(-6)}`,hint:"Run the full account inspection on this address",action:()=>{An(document.querySelector('[data-tab="inspector"]'),"inspector"),setTimeout(()=>{var s;let n=document.getElementById("inspect-addr");n&&(n.value=t),(s=window.runInspect)==null||s.call(window)},200)}}]:[]}var Gn=0,mo=[...vr];function fo(e=""){let t=w("cmdkOverlay"),n=w("cmdkInput");!t||!n||(t.classList.add("show"),n.value=e||"",vm(e),n.focus())}function Cs(){var e;(e=w("cmdkOverlay"))==null||e.classList.remove("show")}function bm(){let e=w("cmdkOverlay"),t=w("cmdkInput");!e||!t||(t.addEventListener("input",()=>vm(t.value)),t.addEventListener("keydown",n=>{n.key==="ArrowDown"&&(n.preventDefault(),gm(1)),n.key==="ArrowUp"&&(n.preventDefault(),gm(-1)),n.key==="Enter"&&(n.preventDefault(),ww()),n.key==="Escape"&&Cs()}),e.addEventListener("click",n=>{n.target===e&&Cs()}))}function vm(e=""){let t=w("cmdkList");if(!t)return;let n=e.toLowerCase().trim(),s=yw(e);mo=n?[...s,...vr.filter(a=>a.label.toLowerCase().includes(n)||a.hint.toLowerCase().includes(n))]:[...s,...vr],Gn=0,t.innerHTML=mo.length?mo.map((a,o)=>`
        <button class="cmdk-item${o===0?" is-active":""}" data-index="${o}">
          <span class="cmdk-label">${y(a.label)}</span>
          <span class="cmdk-hint2">${y(a.hint)}</span>
        </button>`).join(""):'<div class="cmdk-section-label">No results</div>',t.querySelectorAll(".cmdk-item").forEach(a=>{a.addEventListener("click",()=>ym(Number(a.dataset.index)))})}function gm(e){var n,s,a;let t=Xe("#cmdkList .cmdk-item");t.length&&((n=t[Gn])==null||n.classList.remove("is-active"),Gn=(Gn+e+t.length)%t.length,(s=t[Gn])==null||s.classList.add("is-active"),(a=t[Gn])==null||a.scrollIntoView({block:"nearest"}))}function ym(e){let t=mo[e];t&&(Cs(),t.action())}function ww(){ym(Gn)}var ho=!1;function yr(){let e=X.currentPage,t=X.currentTab,n=e==="dashboard"&&t==="stream",s=e==="dashboard"&&t==="inspector",a=e==="dashboard"&&t==="network";tu(n),ku(s),cm(a)}function wm(){ho||(eu(),xu(),lm(),Vl(),yr(),ho=!0)}window.openAuth=e=>Ro(e);window.closeAuth=()=>ln();window.showAuthView=e=>rn(e);window.authKeydown=e=>ll(e);window.submitSignIn=()=>Do();window.submitSignUp=()=>Io();window.refreshCaptcha=()=>Gr();window.showForgotView=()=>Zr();window.forgotRestoreFromFile=()=>el();window.forgotWipeConfirm=()=>tl();window.forgotWipeExecute=()=>nl();window.forgotBackToOptions=()=>sl();window.submitSyncImport=()=>Fo();window.exportVaultSyncCode=()=>al();window.syncImportFromFile=()=>ol();window.signupNext=()=>_o();window.signupBack=()=>Vr();window.logout=()=>il();window.goHome=()=>Mn();window.showLandingPage=()=>Mn();window.showDashboard=()=>Ln();window.showProfile=()=>ko();window.switchTab=(e,t)=>An(e,t);window.runInspect=()=>xs();window.closeCommandPalette=()=>Cs();window.openCmdk=()=>fo();window.setTheme=e=>Pn(e);window.cycleTheme=()=>wo();window.measureLatency=()=>ra();window.switchProfileTab=e=>ri(e);window.openProfileEditor=()=>Id();window.closeProfileEditor=()=>Xs();window.saveProfileEditor=()=>Fd();window.selectAvatar=e=>Od(e);window.selectBanner=e=>Bd(e);window.uploadAvatarImage=e=>Xd(e);window.removeAvatarImage=()=>Hd();window.uploadBannerImage=e=>zd(e);window.removeBannerImage=()=>Wd();window.prefSetTheme=e=>lp(e);window.setPrefCurrency=e=>cp(e);window.setPrefNetwork=e=>dp(e);window.setPrefAutoLock=e=>pp(e);window.openPublicProfilePreview=()=>rp();window.exportVaultBackup=()=>jd();window.logActivity=(e,t)=>kt(e,t);window.toggleWalletDrawer=e=>Ed(e);window.switchWalletDrawerTab=(e,t)=>Nd(e,t);window.cancelOffer=(e,t,n)=>_d(e,t,n);window.fetchBalance=e=>On(e);window.setActiveWallet=e=>Yl(e);window.openImportAddressModal=()=>tp();window.closeImportAddressModal=()=>xi();window.importWatchOnlyWallet=()=>np();window.openImportSeedModal=()=>sp();window.closeImportSeedModal=()=>ki();window.executeImportFromSeed=()=>ap();window.openTokenDetailsModal=(e,t,n)=>op(e,t,n);window.closeTokenDetailsModal=()=>ip();window.refreshXrplDashboard=()=>ns();window.refreshMarketData=()=>yd();window.refreshNftGallery=()=>wd();window.refreshAmmPools=()=>xd();window.refreshPoolExplorer=()=>kd();window.loadCustomAmmPool=()=>pc();window.sendNft=e=>$d(e);window.toggleSeedBackupStatus=()=>kc();window.setDexPair=e=>$c(e);window.setDexInterval=e=>Sc(e);window.setDexChartType=e=>Tc(e);window.refreshDexChart=()=>Cc();window.setComparePair=e=>Xc(e);window.toggleIndicator=(e,t)=>Pc(e,t);window.toggleTerminalTheme=()=>Qc();window.toggleChartFullscreen=()=>Zc();window.exportChartPng=()=>ed();window.saveChartLayoutPreset=()=>nd();window.loadChartLayoutPreset=()=>sd();window.setIndicatorFromDropdown=e=>Hc(e);window.toggleIndicatorMenu=()=>Mc();window.toggleChartMoreMenu=()=>Lc();window.setIndicatorQuery=e=>Ac(e);window.addIndicatorFromMenu=e=>Ec(e);window.removeIndicator=e=>Nc(e);window.openIndicatorSettings=e=>Rc(e);window.closeIndicatorSettings=()=>_c();window.applyIndicatorSettings=e=>Dc(e);window.resetIndicatorSettings=e=>Ic(e);window.copyChartLink=()=>Fc();window.toggleThreeEffects=()=>Oc();window.setThreeEffects=e=>Bc(e);window.setDrawingTool=e=>zc(e);window.clearAllDrawings=()=>Uc();window.addPriceAlert=()=>Wc();window.removePriceAlert=e=>jc(e);window.zoomChartIn=()=>qc();window.zoomChartOut=()=>Vc();window.panChartLeft=()=>Gc();window.panChartRight=()=>Kc();window.toggleEducationPanel=()=>Jc();window.selectEducationTab=e=>Yc(e);window.searchTokens=e=>id(e);window.lookupIssuedAsset=()=>fi();window.lookupAndAnalyzeProject=()=>bd();window.addTokenToWatchlist=e=>md(e);window.removeTokenFromWatchlist=e=>fd(e);window.openTokenOnChart=e=>Ia(e);window.loadToken=e=>hd(e);window.refreshTokenDiscovery=()=>gd();window.refreshRecentTransactions=()=>vd();window.setTokenFilter=(e,t)=>rd(e,t);window.clearTokenFilters=()=>ld();window.selectTokenDetails=e=>ud(e);window.openProjectIntel=e=>di(e);window.jumpToProjectIntelLookup=()=>Zl();window.toggleProjectIntelSubScore=e=>ec(e);window.copyProjectIntelForAi=()=>oc();window.closeProjectIntel=()=>tc();window.showMoreIssuedTokens=()=>cd();window.showAllIssuedTokens=()=>dd();window.resetIssuedTokenLimit=()=>pd();window.openWalletCreator=()=>yi();window.closeWalletCreator=()=>Hs();window.wizardNext=()=>Ud();window.wizardBack=()=>qd();window.selectAlgo=e=>Vd(e);window.selectWalletEmoji=e=>Gd(e);window.selectWalletColor=e=>Kd(e);window.toggleSecurityCheck=e=>Jd(e);window.revealSeed=()=>Qd();window.copySeed=()=>Zd();window.copyAddress=()=>ep();window.copyToClipboard=e=>zs(e);window.deleteWallet=e=>Ld(e);window.inspectWalletAddr=e=>Ad(e);window.openSocialModal=e=>Td(e);window.closeSocialModal=()=>is();window.saveSocialModal=()=>Cd();window.deleteSocial=()=>Pd();window.viewSocial=e=>Md(e);window.connectXRPL=()=>import("./xrpl-6AERZ5KD.js").then(({connectXRPL:e})=>e());window._openAuth=Ro;window._goHome=Mn;window._cycleTheme=wo;window._showProfile=ko;window.startTour=()=>To();window.tourNext=()=>jr();window.tourPrev=()=>Ur();window.tourSkip=()=>ha();window.openHelp=()=>up();window.closeHelp=()=>Ba();window.filterHelp=e=>Si(e);document.addEventListener("DOMContentLoaded",()=>{var e;console.log("\u{1F30A} NaluLF: booting\u2026"),Or(),Mn(),mm(),fm(),hm(),bm(),mp(),xw(),window.addEventListener("naluxrp:pagechange",t=>{var s;let n=(s=t==null?void 0:t.detail)==null?void 0:s.pageId;(n==="dashboard"||n==="inspector"||n==="profile")&&wm(),ho&&yr()}),window.addEventListener("naluxrp:tabchange",()=>{ho&&yr()}),document.addEventListener("keydown",t=>{var s;let n=["INPUT","TEXTAREA"].includes((s=document.activeElement)==null?void 0:s.tagName);if((t.ctrlKey||t.metaKey)&&t.key==="k"){t.preventDefault(),fo();return}if(t.key==="/"&&!n){t.preventDefault(),fo();return}t.key==="Escape"&&(Cs(),ln(),Xs(),Hs(),is(),ha(),Ba())}),(e=document.getElementById("auth-overlay"))==null||e.addEventListener("click",t=>{t.target===t.currentTarget&&ln()}),rl()&&(wm(),Ln(),import("./xrpl-6AERZ5KD.js").then(({connectXRPL:t})=>t())),console.log("\u2705 NaluLF: ready")});function xw(){km(),setInterval(()=>{document.hidden||km()},3e4)}async function xm(e){let t=[s=>`https://corsproxy.io/?${encodeURIComponent(s)}`,s=>`https://api.allorigins.win/raw?url=${encodeURIComponent(s)}`],n=async s=>{let a=typeof(AbortSignal==null?void 0:AbortSignal.timeout)=="function"?AbortSignal.timeout(7e3):void 0,o=await fetch(s,{mode:"cors",cache:"no-store",signal:a});if(!o.ok)throw new Error(`HTTP ${o.status}`);return await o.json()};try{return await n(e)}catch{for(let s of t)try{return await n(s(e))}catch{}throw new Error("Price feed unreachable")}}async function km(){try{let e=await xm("https://api.exchange.coinbase.com/products/XRP-USD/ticker"),t=await xm("https://api.exchange.coinbase.com/products/XRP-USD/candles?granularity=86400");if(e!=null&&e.price){let n=Number(e.price),s=Array.isArray(t)&&t.length?t[0]:null,a=s?Number(s[3]||n):n,o=a?(n-a)/a*100:0,i=document.getElementById("xrpPrice"),r=document.getElementById("xrpChange");if(i&&(i.textContent=`$${Number(n).toFixed(3)}`),r){let l=o>=0;r.textContent=`${l?"+":""}${Number(o).toFixed(2)}%`,r.className=`xrp-price-change ${Math.abs(o)<.1?"flat":l?"up":"down"}`}}}catch{}}
